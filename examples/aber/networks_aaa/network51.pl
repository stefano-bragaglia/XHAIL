...
component("YGR060W",212).
component("YGL012W",197).
component("YOL086C",361).
component("YMR303C",331).
component("YGL256W",207).
component("YDL168W",132).
component("YBR145W",100).
component("YPL231W",398).
component("YGL001C",194).
component("YML056C",314).
component("YLR432W",311).
component("YHR216W",238).
component("YAR075W",84).
component("YAR073W",83).
component("YDR127W",146).
component("YJR139C",272).
component("YOR136W",369).
component("YDL066W",125).
component("YIL155C",244).
component("YPR191W",420).
component("YOR065W",365).
component("YJL166W",258).
component("YHR001W-A",229).
component("YGR183C",219).
component("YFR033C",191).
component("YDR529C",171).
component("YBL045C",88).
component("Q0105",18).
component("YJR078W",265).
component("YJR025C",260).
component("YBL098W",90).
component("YMR015C",319).
component("YDR402C",164).
component("YJR104C",268).
component("YHR008C",230).
component("YER070W",180).
component("YDL168W",133).
component("YPL276W",406).
component("YPL275W",405).
component("YOR388C",388).
component("YGL154C",204).
component("YOR323C",380).
component("YMR170C",326).
component("YMR169C",325).
component("YBR166C",103).
component("YNL280C",346).
component("YER014W",177).
component("YMR118C",323).
component("YLR164W",299).
component("YLL041C",294).
component("YKL148C",281).
component("YJL045W",248).
component("YDR178W",152).
component("YJR051W",262).
component("YEL047C",174).
component("YOR375C",387).
component("YDL215C",135).
component("YAL062W",82).
component("U99_",79).
component("YBR035C",93).
component("YKR080W",292).
component("YER023W",178).
component("YOR236W",378).
component("YGR204W",220).
component("U62_",60).
component("YKL150W",282).
component("YIL043C",240).
component("YPL017C",391).
component("YFL018C",185).
component("YPL273W",404).
component("YLL062C",295).
component("U47_",54).
component("YDL033C",123).
component("YKL024C",275).
component("YPR074C",413).
component("YBR117C",99).
component("YCL009C",114).
component("YMR062C",321).
component("YPL231W",399).
component("YPL001W",390).
component("YPL231W",400).
component("YGR147C",216).
component("YDL040C",124).
component("YPL028W",392).
component("YPR001W",408).
component("YNR001C",350).
component("YDL182W",134).
component("YNL117W",338).
component("YIR031C",246).
component("YNL029C",333).
component("YIL085C",241).
component("YLR209C",300).
component("YMR300C",330).
component("YER055C",179).
component("YDR354W",160) :- not remove_orf("YDR354W",160).
component("YFR047C",192).
component("YJR133W",271).
component("YML022W",312).
component("YDR441C",167).
component("YDR399W",162).
component("YNL256W",343).
component("YDR127W",147).
component("YLR303W",306).
component("YJR130C",270).
component("YLR303W",307).
component("YDR035W",140).
component("YBR249C",107).
component("YBR256C",108).
component("YHR137W",233).
component("YGL202W",205).
component("YLR027C",296).
component("YKL106W",278).
component("YKL104C",277).
component("YGR019W",209).
component("U64_",61).
component("U51_",56).
component("YJR148W",273).
component("YGL253W",206).
component("YFR053C",193).
component("YMR205C",328).
component("YGR240C",221).
component("YDR248C",155).
component("YCR036W",121).
component("YCL040W",116).
component("YJR105W",269).
component("U16_",31).
component("U15_",28).
component("U96_",77).
component("YKL001C",274).
component("YML070W",315).
component("YFL053W",187).
component("YHL032C",227).
component("U83_",72).
component("U82_",71).
component("YMR208W",329).
component("YOR347C",385).
component("YAL038W",81).
component("YPR121W",415).
component("YPL258C",402).
component("YOL055C",358).
component("U1_",40).
component("YNL267W",345).
component("YLR305C",308).
component("YFR019W",189).
component("YDR208W",153).
component("YDR127W",148).
component("U21_",45).
component("U20_",44).
component("YDR300C",158).
component("YCR012W",118).
component("U18_",37).
component("U76_",69).
component("YDR226W",154).
component("YDR454C",168).
component("YOL061W",360).
component("YKL181W",283).
component("YHL011C",225).
component("YER099C",183).
component("YBL068W",89).
component("YOR143C",370).
component("YGR007W",208).
component("YLR328W",309).
component("YCL050C",117).
component("YPR190C",419).
component("YPR187W",418).
component("YPR110C",414).
component("YPR010C",409).
component("YOR341W",384).
component("YOR340C",383).
component("YOR224C",377).
component("YOR210W",376).
component("YOR207C",374).
component("YOR151C",371).
component("YOR116C",368).
component("YOL005C",355).
component("YNR003C",351).
component("YNL248C",342).
component("YNL151C",341).
component("YNL113W",337).
component("YKL144C",280).
component("YJR063W",263).
component("YJL148W",256).
component("YJL140W",255).
component("YIL021W",239).
component("YHR143W-A",234).
component("YGL070C",202).
component("YFL036W",186).
component("YDR404C",165).
component("YDR156W",151).
component("YDR045C",141).
component("YDL150W",130).
component("YDL140C",129).
component("YBR154C",102).
component("YPR175W",417).
component("YPL167C",395).
component("YOR330C",381).
component("YOL115W",363).
component("YNL299W",348).
component("YNL262W",344).
component("YNL102W",336).
component("YJR043C",261).
component("YJR006W",259).
component("YJL090C",250).
component("YIL139C",243).
component("YEL055C",175).
component("YDR419W",166).
component("YDR121W",145).
component("YDL102W",128).
component("YCR014C",119).
component("YBR278W",110).
component("YBL035C",86).
component("YKL035W",276).
component("YHL012W",226).
component("YDR058C",144).
component("YDL086W",127).
component("YOL011W",356).
component("YMR008C",318).
component("YMR006C",317).
component("U101_",19).
component("YBL015W",85).
component("U84_",73).
component("YPR073C",411).
component("YHR215W",237).
component("YDL024C",122).
component("YBR093C",97).
component("YBR092C",96).
component("YPL228W",397).
component("YMR180C",327).
component("YDL236W",137).
component("YJL155C",257).
component("YPR073C",412).
component("YOR208W",375).
component("YNL053W",335).
component("YMR036C",320).
component("YIR026C",245).
component("YIL113W",242).
component("YFR028C",190).
component("YER075C",181).
component("YDL230W",136).
component("YBR276C",109).
component("U34_",52).
component("U30_",51).
component("U25_",50).
component("U24_",49).
component("YOR360C",386).
component("YKR031C",289).
component("YLR286C",304).
component("YOR190W",372).
component("YLR300W",305).
component("YGR282C",224).
component("YDR261C",156).
component("YDR400W",163).
component("YML035C",313).
component("YJL070C",249).
component("YBR284W",111).
component("YNL045W",334).
component("YGL037C",199).
component("YBR208C",104).
component("U53_",57).
component("YIR032C",247).
component("YMR120C",324).
component("YHR144C",235).
component("YBR153W",101).
component("YDL238C",138).
component("YNL141W",339).
component("YLR245C",303).
component("YJL126W",252).
component("YBR111C",98).
component("YER005W",176).
component("YLR231C",301).
component("U88_",74).
component("YLR134W",298).
component("YLR044C",297).
component("YGR087C",213).
component("YDR380W",161).
component("YDL080C",126).
component("U98_",78).
component("YKL184W",286).
component("YNR043W",354).
component("U93_",76).
component("U54_",58).
component("YKL211C",287) :- not remove_orf("YKL211C",287).
component("YGR170W",218).
component("YDR294C",157).
component("YNR033W",353).
component("YKL211C",288) :- not remove_orf("YKL211C",288).
component("YER090W",288) :- not remove_orf("YER090W",288).
component("YER090W",182) :- not remove_orf("YER090W",182).
component("YDR127W",149).
component("YPL281C",407).
component("YOR393W",389).
component("YMR323W",332).
component("YHR174W",236).
component("YGR254W",223).
component("YGL026C",198) :- not remove_orf("YGL026C",198).
component("YGR155W",217).
component("YNL316C",349).
component("YKL182W",284).
component("YPL212C",396).
component("YNL292W",347).
component("YGL063W",201).
component("YFL001W",184).
component("YDR127W",150).
component("YGL148W",203).
component("YAL012W",80).
component("YBR019C",91).
component("YDR050C",143).
component("YDR007W",139) :- not remove_orf("YDR007W",139).
component("YOR095C",367).
component("YGL001C",195).
component("YMR105C",322).
component("YKL127W",279).
component("YPR060C",410).
component("YPL104W",394).
component("YLL018C",293).
component("YHR091C",232).
component("YDR341C",159).
component("YOL097C",362).
component("YOR335C",382).
component("YGR094W",214).
component("YGR244C",222).
component("U89_",75).
component("YJL101C",251).
component("YJR103W",267).
component("YBL039C",87).
component("YOL058W",359).
component("YBR208C",105).
component("YHR074W",231).
component("YOR303W",379).
component("YGL062W",200).
component("YBR218C",106).
component("YPL231W",401).
component("YNR016C",352).
component("YKL182W",285).
component("YGR037C",210).
component("YOR005C",364).
component("YDL164C",131).
component("YPR138C",416).
component("YPL265W",403).
component("YPL036W",393).
component("YOR192C",373).
component("YOR071C",366).
component("YOL020W",357) :- not remove_orf("YOL020W",357).
component("YNL142W",340).
component("YML123C",316).
component("YLR348C",310).
component("YLR237W",302).
component("YKR053C",291).
component("YKR039W",290) :- not remove_orf("YKR039W",290).
component("YJR095W",266).
component("YJR077C",264).
component("YJL134W",254).
component("YJL129C",253).
component("YHL036W",228).
component("YGR121C",215).
component("YGR055W",211).
component("YGL008C",196).
component("YFL055W",188).
component("YEL017C-A",173).
component("YDR536W",172).
component("YDR508C",170).
component("YDR503C",169).
component("YDR046C",142) :- not remove_orf("YDR046C",142).
component("YCR024C-A",120).
component("YCL025C",115).
component("YBR298C",113).
component("YBR291C",112).
component("YBR069C",95) :- not remove_orf("YBR069C",95).
component("YBR068C",94) :- not remove_orf("YBR068C",94).
component("YBR021W",92).
component("U79_",70).
component("U75_",68).
component("U74_",67).
component("U73_",66).
...
catalyst(6160,330).
catalyst(3870,179).
catalyst(3620,160) :- not remove_reaction(3620,160).
catalyst(2190,192).
catalyst(5550,271).
catalyst(5650,312).
catalyst(5650,167).
...
catalyst(2300,76).
catalyst(3460,58).
catalyst(3600,287) :- not remove_reaction(3600,287).
catalyst(6900,218).
catalyst(8781,157).
catalyst(8782,157).
catalyst(2550,353).
catalyst(3630,288) :- not remove_reaction(3630,288).
catalyst(3630,182) :- not remove_reaction(3630,182).
catalyst(3740,149).
catalyst(8231,407).
catalyst(8232,407).
catalyst(8231,389).
...
catalyst(8231,223).
catalyst(8232,223).
catalyst(3590,198) :- not remove_reaction(3590,198).
catalyst(10910,198) :- not remove_reaction(10910,198).
catalyst(4570,217).
catalyst(3680,349).
catalyst(7141,284).
catalyst(7142,284).
...
catalyst(8281,143).
catalyst(8282,143).
catalyst(3610,139) :- not remove_reaction(3610,139).
catalyst(7921,367).
catalyst(7922,367).
catalyst(6370,195).
catalyst(7861,322).
...
catalyst(190,302).
catalyst(6560,291).
catalyst(771,290) :- not remove_reaction(771,290).
catalyst(772,290) :- not remove_reaction(772,290).
catalyst(781,290) :- not remove_reaction(781,290).
catalyst(782,290) :- not remove_reaction(782,290).
...
catalyst(881,290) :- not remove_reaction(881,290).
catalyst(882,290) :- not remove_reaction(882,290).
catalyst(1191,290) :- not remove_reaction(1191,290).
catalyst(1192,290) :- not remove_reaction(1192,290).
catalyst(1250,266).
catalyst(1581,264).
catalyst(1582,264).
catalyst(6560,254).
...
catalyst(1501,112).
catalyst(1502,112).
catalyst(771,95) :- not remove_reaction(771,95).
catalyst(772,95) :- not remove_reaction(772,95).
catalyst(801,95) :- not remove_reaction(801,95).
catalyst(802,95) :- not remove_reaction(802,95).
catalyst(811,95) :- not remove_reaction(811,95).
catalyst(812,95) :- not remove_reaction(812,95).
...
catalyst(831,94) :- not remove_reaction(831,94).
catalyst(832,94) :- not remove_reaction(832,94).
catalyst(841,94) :- not remove_reaction(841,94).
catalyst(842,94) :- not remove_reaction(842,94).
catalyst(620,92).
catalyst(2830,70).
catalyst(2920,68).
catalyst(2920,67).
