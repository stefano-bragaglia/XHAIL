...
component("YNL280C",573).
component("YGR060W",341).
component("YGL012W",316).
component("YKR009C",470).
component("YOL086C",596).
component("YMR303C",547).
...
component("YJR159W",446).
component("YGL001C",313).
component("YIL094C",392).
component("YHR063C",375).
component("YBR153W",162).
component("YML056C",519).
component("YLR432W",515).
component("YHR216W",386).
component("YAR075W",130).
component("YAR073W",129).
component("YDR127W",230).
component("YJR139C",443).
component("YOL126C",600).
component("YDL078C",194).
component("YKL029C",450).
component("YOR136W",610).
component("YNL037C",551).
component("YDL066W",193).
component("YLR355C",512).
component("YML086C",521).
component("YIL155C",397).
component("YPR191W",677).
component("YOR065W",605).
component("YJL166W",421).
component("YHR001W-A",367).
...
component("YKL026C",449).
component("YIR037W",404).
component("YBR244W",171).
component("YJR078W",434).
component("YJR025C",428).
component("YGR255C",361).
component("U108_",22).
component("YBL098W",139).
component("YMR015C",527).
component("YDR402C",257).
component("YGL055W",321).
component("YGR175C",349).
component("YJR104C",437).
component("YHR008C",368).
component("YJL026W",405).
component("YGR180C",351).
component("YER070W",285).
component("U35_",84).
component("YDL168W",208).
component("YDR158W",238).
component("YPL276W",658).
component("YPL275W",657).
component("YOR388C",635).
component("YOR374W",632).
component("YER073W",286).
component("YGL154C",327).
component("U55_",95).
component("YOR323C",624).
component("YMR170C",535).
component("YMR169C",534).
component("U2_",81).
component("YBR221C",170).
component("U52_",92).
component("YBR166C",165).
component("YNL280C",574).
component("YGL012W",317).
component("U57_",96).
component("YDR044W",221).
component("YER014W",274).
component("YKR009C",471).
component("YIL160C",399).
component("YGL205W",330).
component("YMR118C",532).
component("YLR164W",496).
component("YLL041C",479).
component("YKL148C",459).
component("YKL141W",457).
component("YJL045W",406).
component("YDR178W",239).
component("YJR051W",430).
component("YEL047C",269).
component("YOR375C",633).
component("YDL215C",211).
component("YAL062W",127).
component("U99_",123).
component("YBR035C",148).
component("YHR037W",372).
component("YKR080W",475).
component("YER023W",275).
component("YOR236W",621).
component("YGR204W",354).
component("YLR142W",491).
component("U62_",99).
component("YKL150W",460).
component("YIL043C",388).
component("YHR042W",373).
component("YFR030W",308).
component("YPL017C",638).
component("YFL018C",300).
component("YER042W",277).
component("YJR137C",442).
component("YPL266W",655).
component("YML110C",523).
component("YBR034C",147).
component("YPL273W",656).
component("YLL062C",482).
component("U47_",89).
component("YER091C",291).
component("YJR073C",432).
component("YDL033C",191).
component("YOL096C",597).
component("YLR172C",497).
component("YDR019C",217).
component("YDR408C",259).
component("YBL013W",131).
component("YKL024C",448).
component("YPR074C",669).
component("YBR117C",157).
component("YLR354C",511).
component("YGR043C",339).
component("YCL009C",180).
component("YMR062C",529).
component("YNL071W",554).
component("YNR008W",581).
component("YPL231W",650).
component("YER061C",283).
component("U86_",114).
component("YPL001W",637).
component("YDR148C",236).
component("YOR377W",634).
component("YGR177C",350).
component("YPL231W",651).
component("YGR147C",346).
component("YDL040C",192).
component("YPL028W",639).
component("YGL017W",318).
component("YPR001W",660).
component("YNR001C",579).
component("YDL182W",209).
component("YDL131W",200).
component("YNL117W",558).
component("YIR031C",402).
component("YDR307W",250).
component("YNL029C",550).
component("YIL085C",391).
component("YMR261C",542).
component("YML100W",522).
component("YBR126C",159).
component("YNL192W",565).
component("YBR038W",150).
component("YBR023C",146).
component("YLR209C",498).
component("U104_",21).
component("YOR209C",618).
component("YMR300C",546).
component("YER055C",279).
component("YDR354W",253) :- not remove_orf("YDR354W",253).
component("YFR047C",310).
component("YJR133W",441).
component("YLR209C",499).
component("YML022W",516).
component("YDR441C",261).
component("YDR399W",255).
component("YJL167W",422).
component("YNL256W",568).
component("YDR127W",231).
component("YLR303W",505).
component("YGR012W",336).
component("YJR130C",440).
component("YLR303W",506).
component("YDR035W",219).
component("YBR249C",172).
component("YOL143C",602).
component("YBR256C",173).
component("YHR137W",380).
component("YGL202W",329).
component("YLR027C",483).
component("YKL106W",454).
component("YKL104C",453).
component("YGR019W",337).
component("YLR089C",487).
component("U64_",100).
component("U61_",98).
component("U51_",91).
component("YJR148W",444).
component("YIL116W",395).
component("YGL253W",333).
component("YFR053C",311).
component("YOL136C",601).
component("YIL107C",393).
component("YMR205C",537).
component("YGR240C",357).
component("YDR248C",243).
component("YCR036W",188).
component("YCL040W",183).
component("YJR105W",438).
component("U16_",42).
component("U15_",38).
component("U96_",121).
component("YKL001C",447).
component("YML070W",520).
component("YFL053W",303).
component("YHL032C",365).
component("U83_",112).
component("U82_",111).
component("U81_",110).
component("YMR208W",538).
component("YOR347C",629).
component("YAL038W",126).
component("YNR012W",582).
component("YPR121W",672).
component("YPL258C",653).
component("YOL055C",593).
component("U1_",62).
component("YDR009W",216).
component("YBR020W",144).
component("YNL267W",571).
component("YLR305C",508).
...
component("YKL067W",452).
component("YDR454C",262).
component("YOL061W",595).
component("YKL181W",462).
component("YHL011C",363).
component("YER099C",293).
component("YBL068W",138).
component("YOR143C",612).
component("YBR018C",141).
component("YGR007W",335).
component("YLR328W",509).
component("YKR002W",469).
component("YDL103C",198).
component("YJR010W",427).
component("YCL050C",184).
component("YPR190C",676).
component("YPR187W",675).
component("YPR110C",671).
component("YPR010C",662).
component("YOR341W",628).
component("YOR340C",627).
component("YOR224C",620).
component("YOR210W",619).
component("YOR207C",616).
component("YOR151C",613).
component("YOR116C",608).
component("YOL005C",588).
component("YNR003C",580).
component("YNL248C",567).
component("YNL151C",562).
component("YNL113W",557).
component("YKL144C",458).
component("YJR063W",431).
component("YJL148W",418).
component("YJL140W",417).
component("YIL021W",387).
component("YHR143W-A",381).
...
component("YPR175W",674).
component("YPL167C",646).
component("YOR330C",625).
component("YOL115W",599).
component("YNL299W",576).
component("YNL262W",570).
component("YNL102W",556).
component("YJR043C",429).
component("YJR006W",426).
component("YJL090C",410).
component("YIL139C",396).
...
component("YKL035W",451).
component("YHL012W",364).
component("YHR123W",379).
component("YDL142C",204).
component("YER026C",276).
component("YCL004W",179).
component("YJL068C",407).
component("YDR058C",226).
component("YNR034W",585).
component("YHR163W",383).
component("YGR248W",359).
component("YCR073W-A",189).
component("YDL086W",196).
component("YOL011W",590).
component("YMR008C",526).
component("YMR006C",525).
component("U101_",19).
component("YBL015W",132).
component("YJL068C",408).
component("YPL072W",642).
component("YOR124C",609).
component("YNL186W",564).
component("YMR304W",548).
component("YMR223W",540).
component("YKR098C",477).
component("YJL197W",423).
component("YIL156W",398).
...
component("U84_",113).
component("YPR073C",667).
component("YHR215W",385).
component("YDL024C",190).
component("YBR093C",155).
component("YBR092C",154).
component("YAR071W",128).
component("YIL053W",390).
component("YER062C",284).
component("YHR046C",374).
component("YGR208W",356).
component("YPL228W",648).
component("YMR180C",536).
component("YDL236W",213).
component("YJL155C",420).
component("YPR073C",668).
component("YOR208W",617).
component("YNL053W",553).
component("YMR036C",528).
component("YIR026C",400).
component("YIL113W",394).
...
component("U25_",79).
component("U24_",78).
component("YOR360C",631).
component("YGL248W",332).
component("YKR031C",472).
component("YLR286C",503).
component("YJR153W",445).
component("YOR190W",614).
component("YLR300W",504).
component("YGR282C",362).
component("YDR261C",245).
component("YDR400W",256).
component("U23_",77).
component("YML035C",517).
component("YJL070C",409).
component("YBR284W",176).
component("U102_",20).
component("YNL045W",552).
component("YLR160C",495).
component("YLR158C",494).
component("YLR157C",493).
component("YLR155C",492).
component("YDR321W",251).
component("YGL037C",320).
component("YDR242W",242).
component("YBR208C",167).
component("YMR281W",545).
component("U53_",93).
component("YIR032C",403).
component("YIR029W",401).
component("YPR062W",666).
component("YMR120C",533).
component("YHR144C",382).
component("YNL141W",559).
component("YBR153W",163).
component("YDL238C",214).
component("YNL141W",560).
component("YLR245C",502).
component("YML035C",518).
component("YJL126W",413).
component("U44_",87).
component("U87_",115).
component("YMR267W",543).
component("YBR011C",140).
component("YBR111C",156).
component("YCL030C",182).
component("YER005W",273).
component("YIL048W",389).
component("YER166W",296).
component("YDR093W",228).
component("YAL026C",125).
component("YLR231C",500).
component("U88_",116).
component("YLR134W",489).
component("YLR044C",484).
component("YGR087C",342).
component("YDR380W",254).
component("YDL080C",195).
component("U98_",122).
component("YMR250W",541).
component("YKL184W",465).
component("YNR043W",586).
component("U93_",120).
component("YDR047W",224).
component("U54_",94).
component("YKL211C",466) :- not remove_orf("YKL211C",466).
component("YNL169C",563).
component("YGR170W",348).
component("YNL256W",569).
component("YDR294C",247).
component("YEL046C",268).
component("YNR033W",584).
...
component("YPL281C",659).
component("YOR393W",636).
component("YMR323W",549).
component("YHR174W",384).
component("YGR254W",360).
component("YGL026C",319) :- not remove_orf("YGL026C",319).
component("YGR155W",347).
component("YLR304C",507).
component("YJL200C",424).
component("YNL316C",577).
component("YKL182W",463).
component("YPL212C",647).
component("YNL292W",575).
component("YGL063W",323).
component("YFL001W",298).
component("YPR002W",661).
component("YDR127W",234).
component("YGL148W",326).
component("YER086W",288).
component("YLR359W",513).
component("YAL012W",124).
component("YFR055W",312).
component("YJL121C",412).
component("YBR019C",142).
component("YBR019C",143).
component("YDR050C",225).
component("YDR007W",215) :- not remove_orf("YDR007W",215).
component("YOR095C",607).
component("YER003C",272).
component("YBR196C",166).
component("YGL001C",314).
component("U14_",32).
component("YKL152C",461).
component("YMR105C",530).
component("YKL127W",455).
component("YEL058W",271).
component("YPR060C",665).
component("YHR072W",376).
component("YJL153C",419).
component("YPL097W",643).
component("YGR185C",353).
component("YHR011W",369).
component("YDR023W",218).
component("YPL104W",644).
component("YLL018C",478).
component("YPR081C",670).
component("YBR121C",158).
component("YHR020W",371).
component("YER087W",289).
component("YNL247W",566).
component("YOL033W",592).
component("YHR091C",378).
component("YDR341C",252).
component("YOL097C",598).
component("YPR047W",664).
component("YLR060W",485).
component("YFL022C",301).
component("YPR033C",663).
component("YHR019C",370).
component("YPL160W",645).
component("YLR382C",514).
component("YNL073W",555).
component("YDR037W",220).
component("YOR335C",626).
component("YGR094W",344).
component("YOR142W",611).
component("YGR244C",358).
component("U89_",117).
component("YOR241W",622).
component("YMR113W",531).
component("YKL132C",456).
component("YJL101C",411).
component("U92_",119).
component("YGL234W",331).
component("U91_",118).
component("YDL141W",202).
component("YDL141W",203).
component("YJR103W",436).
component("YBL039C",134).
component("YGR204W",355).
component("YOL058W",594).
component("YBR208C",168).
component("YHR074W",377).
component("YMR217W",539).
component("YOR303W",623).
component("YJR109C",439).
component("YJL130C",415).
component("YGL062W",322).
component("YBR218C",169).
component("YPL231W",652).
component("YNR016C",583).
component("YKL182W",464).
component("YGR037C",338).
component("YOR005C",604).
component("YDL164C",206).
component("YOL010W",589).
component("YPR138C",673).
component("YPL265W",654).
component("YPL057C",641).
component("YPL036W",640).
component("YOR348C",630).
component("YOR192C",615).
component("YOR071C",606).
component("YOL156W",603).
component("YOL020W",591) :- not remove_orf("YOL020W",591).
component("YNR056C",587).
component("YNL318C",578).
component("YNL268W",572).
component("YNL142W",561).
component("YMR272C",544).
component("YML123C",524).
component("YLR348C",510).
component("YLR237W",501).
component("YLR138W",490).
component("YLR100C",488).
component("YLR081W",486).
component("YLL061W",481).
component("YLL043W",480).
component("YKR093W",476).
component("YKR053C",474).
component("YKR039W",473) :- not remove_orf("YKR039W",473).
component("YKL217W",468).
component("YJR095W",435).
component("YJR077C",433).
component("YJL219W",425).
component("YJL134W",416).
component("YJL129C",414).
component("YHL036W",366).
...
catalyst(941,591) :- not remove_reaction(941,591).
catalyst(942,591) :- not remove_reaction(942,591).
catalyst(700,587).
catalyst(1200,578).
catalyst(761,572).
catalyst(762,572).
...
catalyst(640,476).
catalyst(6560,474).
catalyst(761,473) :- not remove_reaction(761,473).
catalyst(762,473) :- not remove_reaction(762,473).
catalyst(771,473) :- not remove_reaction(771,473).
catalyst(772,473) :- not remove_reaction(772,473).
catalyst(781,473) :- not remove_reaction(781,473).
catalyst(782,473) :- not remove_reaction(782,473).
catalyst(791,473) :- not remove_reaction(791,473).
catalyst(792,473) :- not remove_reaction(792,473).
catalyst(801,473) :- not remove_reaction(801,473).
catalyst(802,473) :- not remove_reaction(802,473).
catalyst(811,473) :- not remove_reaction(811,473).
catalyst(812,473) :- not remove_reaction(812,473).
catalyst(821,473) :- not remove_reaction(821,473).
catalyst(822,473) :- not remove_reaction(822,473).
catalyst(831,473) :- not remove_reaction(831,473).
catalyst(832,473) :- not remove_reaction(832,473).
catalyst(841,473) :- not remove_reaction(841,473).
catalyst(842,473) :- not remove_reaction(842,473).
catalyst(861,473) :- not remove_reaction(861,473).
catalyst(862,473) :- not remove_reaction(862,473).
catalyst(881,473) :- not remove_reaction(881,473).
catalyst(882,473) :- not remove_reaction(882,473).
catalyst(901,473) :- not remove_reaction(901,473).
catalyst(902,473) :- not remove_reaction(902,473).
catalyst(911,473) :- not remove_reaction(911,473).
catalyst(912,473) :- not remove_reaction(912,473).
catalyst(941,473) :- not remove_reaction(941,473).
catalyst(942,473) :- not remove_reaction(942,473).
catalyst(1191,473) :- not remove_reaction(1191,473).
catalyst(1192,473) :- not remove_reaction(1192,473).
catalyst(1021,468).
catalyst(1022,468).
catalyst(1250,435).
catalyst(1581,433).
