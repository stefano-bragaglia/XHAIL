...
component("YGR060W",245).
component("YGL012W",229).
component("YOL086C",417).
component("YMR303C",385).
component("YGL256W",240).
component("YDL168W",147).
component("YBR145W",113).
component("YPL231W",460).
component("YBR149W",114).
component("YGL001C",226).
component("YHR063C",266).
component("YML056C",364).
component("YLR432W",360).
component("YHR216W",274).
component("YAR075W",95).
component("YAR073W",94).
component("YDR127W",163).
component("YJR139C",314).
component("YOR136W",427).
component("YDL066W",139).
component("YML086C",366).
component("YIL155C",282).
component("YPR191W",483).
component("YOR065W",422).
component("YJL166W",298).
component("YHR001W-A",263).
component("YGR183C",253).
component("YFR033C",222).
component("YDR529C",190).
component("YBL045C",99).
component("Q0105",18).
component("YJR078W",307).
component("YJR025C",302).
component("YBL098W",102).
component("YMR015C",370).
component("YDR402C",182).
component("YJR104C",310).
component("YHR008C",264).
component("YER070W",205).
component("U35_",59).
component("YDL168W",148).
component("YPL276W",468).
component("YPL275W",467).
component("YOR388C",449).
component("YGL154C",236).
component("U55_",66).
component("YOR323C",439).
component("YMR170C",378).
component("YMR169C",377).
component("U2_",56).
component("YBR166C",117).
component("YNL280C",402).
component("YER014W",197).
component("YMR118C",375).
component("YLR164W",346).
component("YLL041C",340).
component("YKL148C",324).
component("YJL045W",287).
component("YDR178W",169).
component("YJR051W",304).
component("YEL047C",194).
component("YOR375C",447).
component("YDL215C",150).
component("YAL062W",93).
component("U99_",89).
component("YBR035C",105).
component("YKR080W",337).
component("YER023W",198).
component("YOR236W",436).
component("YGR204W",254).
component("U62_",68).
component("YKL150W",325).
component("YIL043C",276).
component("YHR042W",265).
component("YPL017C",452).
component("YFL018C",215).
component("YPL273W",466).
component("YLL062C",342).
component("U47_",61).
component("YDL033C",137).
component("YOL096C",418).
component("YDR408C",184).
component("YKL024C",317).
component("YPR074C",476).
component("YBR117C",112).
component("YCL009C",128).
component("YMR062C",372).
component("YPL231W",461).
component("U86_",82).
component("YPL001W",451).
component("YOR377W",448).
component("YGR177C",252).
component("YPL231W",462).
component("YGR147C",249).
component("YDL040C",138).
component("YPL028W",453).
component("YPR001W",470).
component("YNR001C",406).
component("YDL182W",149).
component("YNL117W",393).
component("YIR031C",285).
component("YNL029C",388).
component("YIL085C",279).
component("YLR209C",347).
component("YMR300C",384).
component("YER055C",200).
component("YDR354W",178) :- not remove_orf("YDR354W",178).
component("YFR047C",223).
component("YJR133W",313).
component("YLR209C",348).
component("YML022W",361).
component("YDR441C",186).
component("YDR399W",180).
component("YNL256W",399).
component("YDR127W",164).
component("YLR303W",354).
component("YJR130C",312).
component("YLR303W",355).
component("YDR035W",155).
component("YBR249C",121).
component("YBR256C",122).
component("YHR137W",269).
component("YGL202W",238).
component("YLR027C",343).
component("YKL106W",320).
component("YKL104C",319).
component("YGR019W",242).
component("U64_",69).
component("U51_",63).
component("YJR148W",315).
component("YGL253W",239).
component("YFR053C",224).
component("YMR205C",380).
component("YGR240C",255).
component("YDR248C",173).
component("YCR036W",135).
component("YCL040W",130).
component("YJR105W",311).
component("U16_",34).
component("U15_",31).
component("U96_",87).
component("YKL001C",316).
component("YML070W",365).
component("YFL053W",217).
component("YHL032C",261).
component("U83_",80).
component("U82_",79).
component("YMR208W",381).
component("YOR347C",444).
component("YAL038W",92).
component("YPR121W",478).
component("YPL258C",464).
component("YOL055C",414).
component("U1_",43).
component("YNL267W",401).
component("YLR305C",357).
component("YFR019W",220).
component("YDR208W",170).
component("YDR127W",165).
component("U21_",49).
component("U20_",47).
component("YDR300C",176).
component("YCR012W",132).
component("U18_",40).
component("U76_",77).
component("YER170W",213).
component("YDR226W",171).
component("YDR454C",187).
component("YOL061W",416).
component("YKL181W",327).
component("YHL011C",259).
component("YER099C",209).
component("YBL068W",101).
component("YOR143C",428).
component("YGR007W",241).
component("YLR328W",358).
component("YCL050C",131).
component("YPR190C",482).
component("YPR187W",481).
component("YPR110C",477).
component("YPR010C",472).
component("YOR341W",443).
component("YOR340C",442).
component("YOR224C",435).
component("YOR210W",434).
component("YOR207C",432).
component("YOR151C",429).
component("YOR116C",425).
component("YOL005C",411).
component("YNR003C",407).
component("YNL248C",398).
component("YNL151C",396).
component("YNL113W",392).
component("YKL144C",323).
component("YJR063W",305).
component("YJL148W",296).
component("YJL140W",295).
component("YIL021W",275).
component("YHR143W-A",270).
component("YGL070C",234).
component("YFL036W",216).
component("YDR404C",183).
component("YDR156W",168).
component("YDR045C",156).
component("YDL150W",145).
component("YDL140C",144).
component("YBR154C",116).
component("YPR175W",480).
component("YPL167C",457).
component("YOR330C",440).
component("YOL115W",420).
component("YNL299W",404).
component("YNL262W",400).
component("YNL102W",391).
component("YJR043C",303).
component("YJR006W",301).
component("YJL090C",290).
component("YIL139C",281).
component("YEL055C",195).
component("YDR419W",185).
component("YDR121W",162).
component("YDL102W",142).
component("YCR014C",133).
component("YBR278W",124).
component("YBL035C",97).
component("YKL035W",318).
component("YHL012W",260).
component("YER026C",199).
component("YDR058C",159).
component("YDL086W",141).
component("YOL011W",412).
component("YMR008C",369).
component("YMR006C",368).
component("U101_",19).
component("YBL015W",96).
component("YJL068C",288).
component("YPL072W",455).
component("YOR124C",426).
component("YNL186W",397).
component("YMR304W",386).
component("YMR223W",382).
component("YKR098C",338).
component("YJL197W",299).
component("YIL156W",283).
component("YFR010W",219).
component("YER151C",211).
component("YER144C",210).
component("YER098W",208).
component("YDR069C",160).
component("YDL122W",143).
component("YBR058C",106).
component("YBL067C",100).
component("U84_",81).
component("YPR073C",474).
component("YHR215W",273).
component("YDL024C",136).
component("YBR093C",110).
component("YBR092C",109).
component("YIL053W",278).
component("YER062C",204).
component("YPL228W",459).
component("YMR180C",379).
component("YDL236W",152).
component("YJL155C",297).
component("YPR073C",475).
component("YOR208W",433).
component("YNL053W",390).
component("YMR036C",371).
component("YIR026C",284).
component("YIL113W",280).
component("YFR028C",221).
component("YER075C",206).
component("YDL230W",151).
component("YBR276C",123).
component("U34_",58).
component("U30_",57).
component("U25_",55).
component("U24_",54).
component("YOR360C",446).
component("YKR031C",334).
component("YLR286C",352).
component("YOR190W",430).
component("YLR300W",353).
component("YGR282C",258).
component("YDR261C",174).
component("YDR400W",181).
component("U23_",53).
component("YML035C",362).
component("YJL070C",289).
component("YBR284W",125).
component("U102_",20).
component("YNL045W",389).
component("YGL037C",231).
component("YDR242W",172).
component("YBR208C",118).
component("U53_",64).
component("YIR032C",286).
component("YMR120C",376).
component("YHR144C",271).
component("YBR153W",115).
component("YDL238C",153).
component("YNL141W",394).
component("YLR245C",351).
component("YML035C",363).
component("YJL126W",292).
component("U87_",83).
component("YBR111C",111).
component("YER005W",196).
component("YIL048W",277).
component("YER166W",212).
component("YDR093W",161).
component("YAL026C",91).
component("YLR231C",349).
component("U88_",84).
component("YLR134W",345).
component("YLR044C",344).
component("YGR087C",246).
component("YDR380W",179).
component("YDL080C",140).
component("U98_",88).
component("YKL184W",330).
component("YNR043W",410).
component("U93_",86).
component("U54_",65).
component("YKL211C",331) :- not remove_orf("YKL211C",331).
component("YGR170W",251).
component("YDR294C",175).
component("YEL046C",193).
component("YNR033W",409).
component("YKL211C",332) :- not remove_orf("YKL211C",332).
component("YER090W",332) :- not remove_orf("YER090W",332).
component("YER090W",207) :- not remove_orf("YER090W",207).
component("YDR127W",166).
component("YPL281C",469).
component("YOR393W",450).
component("YMR323W",387).
component("YHR174W",272).
component("YGR254W",257).
component("YGL026C",230) :- not remove_orf("YGL026C",230).
component("YGR155W",250).
component("YLR304C",356).
component("YJL200C",300).
component("YNL316C",405).
component("YKL182W",328).
component("YPL212C",458).
component("YNL292W",403).
component("YGL063W",233).
component("YFL001W",214).
component("YPR002W",471).
component("YDR127W",167).
component("YGL148W",235).
component("YAL012W",90).
component("YFR055W",225).
component("YBR019C",103).
component("YDR050C",158).
component("YDR007W",154) :- not remove_orf("YDR007W",154).
component("YOR095C",424).
component("YGL001C",227).
component("YKL152C",326).
component("YMR105C",373).
component("YKL127W",321).
component("YPR060C",473).
component("YPL104W",456).
component("YLL018C",339).
component("YHR091C",268).
component("YDR341C",177).
component("YOL097C",419).
component("YOR335C",441).
component("YGR094W",247).
component("YGR244C",256).
component("U89_",85).
component("YOR241W",437).
component("YMR113W",374).
component("YKL132C",322).
component("YJL101C",291).
component("YJR103W",309).
component("YBL039C",98).
component("YOL058W",415).
component("YBR208C",119).
component("YHR074W",267).
component("YOR303W",438).
component("YGL062W",232).
component("YBR218C",120).
component("YPL231W",463).
component("YNR016C",408).
component("YKL182W",329).
component("YGR037C",243).
component("YOR005C",421).
component("YDL164C",146).
component("YPR138C",479).
component("YPL265W",465).
component("YPL036W",454).
component("YOR348C",445).
component("YOR192C",431).
component("YOR071C",423).
component("YOL020W",413) :- not remove_orf("YOL020W",413).
component("YNL142W",395).
component("YMR272C",383).
component("YML123C",367).
component("YLR348C",359).
component("YLR237W",350).
component("YLL061W",341).
component("YKR053C",336).
component("YKR039W",335) :- not remove_orf("YKR039W",335).
component("YKL217W",333).
component("YJR095W",308).
component("YJR077C",306).
component("YJL134W",294).
component("YJL129C",293).
component("YHL036W",262).
component("YGR121C",248).
component("YGR055W",244).
component("YGL186C",237).
component("YGL008C",228).
component("YFL055W",218).
component("YER060W-A",203).
component("YER060W",202).
component("YER056C",201).
component("YEL017C-A",192).
component("YDR536W",191).
component("YDR508C",189).
component("YDR503C",188).
component("YDR046C",157) :- not remove_orf("YDR046C",157).
component("YCR024C-A",134).
component("YCL025C",129).
component("YBR298C",127).
component("YBR291C",126).
component("YBR069C",108) :- not remove_orf("YBR069C",108).
component("YBR068C",107) :- not remove_orf("YBR068C",107).
component("YBR021W",104).
component("U79_",78).
component("U75_",76).
component("U74_",75).
component("U73_",74).
...
catalyst(6160,384).
catalyst(3870,200).
catalyst(3620,178) :- not remove_reaction(3620,178).
catalyst(2190,223).
catalyst(5550,313).
catalyst(5791,348).
catalyst(5792,348).
...
catalyst(2300,86).
catalyst(3460,65).
catalyst(3600,331) :- not remove_reaction(3600,331).
catalyst(6900,251).
catalyst(8781,175).
catalyst(8782,175).
catalyst(4560,193).
catalyst(2550,409).
catalyst(3630,332) :- not remove_reaction(3630,332).
catalyst(3630,207) :- not remove_reaction(3630,207).
catalyst(3740,166).
catalyst(8231,469).
catalyst(8232,469).
catalyst(8231,450).
...
catalyst(8231,257).
catalyst(8232,257).
catalyst(3590,230) :- not remove_reaction(3590,230).
catalyst(10910,230) :- not remove_reaction(10910,230).
catalyst(4570,250).
catalyst(8181,356).
catalyst(8182,356).
catalyst(8181,300).
...
catalyst(8281,158).
catalyst(8282,158).
catalyst(3610,154) :- not remove_reaction(3610,154).
catalyst(7921,424).
catalyst(7922,424).
catalyst(6370,227).
catalyst(8251,326).
...
catalyst(941,413) :- not remove_reaction(941,413).
catalyst(942,413) :- not remove_reaction(942,413).
catalyst(371,395).
catalyst(372,395).
catalyst(6620,383).
catalyst(341,367).
...
catalyst(750,341).
catalyst(6560,336).
catalyst(771,335) :- not remove_reaction(771,335).
catalyst(772,335) :- not remove_reaction(772,335).
catalyst(781,335) :- not remove_reaction(781,335).
catalyst(782,335) :- not remove_reaction(782,335).
catalyst(791,335) :- not remove_reaction(791,335).
catalyst(792,335) :- not remove_reaction(792,335).
catalyst(801,335) :- not remove_reaction(801,335).
catalyst(802,335) :- not remove_reaction(802,335).
catalyst(811,335) :- not remove_reaction(811,335).
catalyst(812,335) :- not remove_reaction(812,335).
catalyst(831,335) :- not remove_reaction(831,335).
catalyst(832,335) :- not remove_reaction(832,335).
catalyst(841,335) :- not remove_reaction(841,335).
catalyst(842,335) :- not remove_reaction(842,335).
catalyst(861,335) :- not remove_reaction(861,335).
catalyst(862,335) :- not remove_reaction(862,335).
catalyst(881,335) :- not remove_reaction(881,335).
catalyst(882,335) :- not remove_reaction(882,335).
catalyst(941,335) :- not remove_reaction(941,335).
catalyst(942,335) :- not remove_reaction(942,335).
catalyst(1191,335) :- not remove_reaction(1191,335).
catalyst(1192,335) :- not remove_reaction(1192,335).
catalyst(1021,333).
catalyst(1022,333).
catalyst(1250,308).
catalyst(1581,306).
...
catalyst(1501,126).
catalyst(1502,126).
catalyst(771,108) :- not remove_reaction(771,108).
catalyst(772,108) :- not remove_reaction(772,108).
...
catalyst(831,107) :- not remove_reaction(831,107).
catalyst(832,107) :- not remove_reaction(832,107).
catalyst(841,107) :- not remove_reaction(841,107).
catalyst(842,107) :- not remove_reaction(842,107).
