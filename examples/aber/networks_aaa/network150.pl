...
component("YLR056W",658).
component("YGR060W",459).
component("YGL012W",427).
component("YKR009C",641).
component("YOL086C",813).
component("YMR303C",750).
component("YMR083W",721).
component("YGL256W",451).
component("YDL168W",281).
component("YBR145W",210).
component("YPL231W",892).
component("YBR265W",229).
component("U46_",118).
component("YBR149W",211).
component("YBR149W",212).
component("YJR159W",609).
component("YGL001C",424).
component("YIL094C",537).
component("YHR063C",509).
component("YBR153W",213).
component("YML056C",705).
component("YLR432W",697).
component("YHR216W",527).
component("YAR075W",172).
component("YAR073W",171).
component("YCL030C",239).
component("YDR127W",313).
component("YJR139C",603).
component("YOL126C",818).
component("YKL085W",619).
component("YDL078C",262).
component("YKL029C",614).
component("YOR136W",834).
component("YNL037C",755).
component("YDL066W",261).
component("YNL241C",771).
component("YOL059W",811).
component("YDL022W",255).
component("YLR355C",693).
component("YIL074C",535).
component("YER081W",394).
component("YML054C",704).
component("YDL174C",283).
component("YML086C",708).
component("YIL155C",543).
component("YPR191W",929).
component("YOR065W",825).
component("YJL166W",574).
component("YHR001W-A",498).
component("YGR183C",474).
component("YFR033C",420).
component("YDR529C",360).
component("YBL045C",178).
component("Q0105",18).
component("YGR088W",462).
component("YDR256C",328).
component("YKL026C",613).
component("YIR037W",554).
component("YBR244W",225).
component("YJR078W",594).
component("YJR025C",586).
component("YGR255C",486).
component("U108_",23).
component("YBL098W",182).
component("YMR015C",718).
component("YHR007C",499).
component("YDR402C",348).
component("YGL055W",434).
component("YGR175C",471).
component("YJR104C",597).
component("YHR008C",500).
component("YJL026W",557).
component("YIL066C",534).
component("YGR180C",473).
component("YER070W",391).
component("U38_",113).
component("U36_",112).
component("U35_",111).
component("YDL168W",282).
component("YDR158W",321).
component("YBR006W",185).
component("YPL276W",904).
component("YPL275W",903).
component("YOR388C",868).
component("YOR374W",865).
component("YER073W",392).
component("U68_",135).
component("YGL154C",442).
component("U55_",127).
component("YOR323C",856).
component("YMR170C",731).
component("YMR169C",730).
component("U2_",106).
component("YER178W",407).
component("YBR221C",223).
component("YIL125W",541).
component("U52_",124).
component("YBR166C",216).
component("YNL280C",782).
component("YGL012W",428).
component("YKL182W",631).
component("U57_",129).
component("YKL216W",638).
component("YDR044W",300).
component("YER014W",375).
component("YKR009C",642).
component("YIL160C",545).
component("YGL205W",445).
component("YMR118C",726).
component("YLR164W",671).
component("YLL041C",651).
component("YKL148C",626).
component("YKL141W",624).
component("YJL045W",558).
component("YDR178W",322).
component("YJR051W",589).
component("YEL047C",369).
component("YDL215C",287).
component("YOR375C",866).
component("YDL215C",288).
component("YAL062W",169).
component("U99_",163).
component("YBR035C",195).
component("YMR189W",733).
component("U56_",128).
component("YHR037W",506).
component("YKR080W",646).
component("YER023W",377).
component("YPL023C",872).
component("YGL125W",439).
component("YOR236W",849).
component("YGR204W",478).
component("YLR142W",666).
component("U63_",133).
component("U62_",132).
component("YOR356W",863).
component("YKL150W",627).
component("YIL043C",531).
component("YHR042W",507).
component("YOR221C",847).
component("YML120C",712).
component("YKL192C",635).
component("YKL055C",616).
component("YER061C",386).
component("YGR234W",481).
component("YFR030W",419).
component("YPL017C",871).
component("YFL018C",411).
component("YPL091W",877).
component("YDR353W",343).
component("YER042W",379).
component("YJR137C",602).
component("YPL266W",899).
component("YML110C",711).
component("YBR034C",194).
component("YPL273W",901).
component("YLL062C",654).
component("YDR410C",351).
component("U47_",119).
component("YER091C",399).
component("YJR073C",592).
component("YDR120C",311).
component("YDL033C",257).
component("YOL096C",814).
component("YLR172C",672).
component("YDR019C",296).
component("YBR176W",217).
component("YDR408C",350).
component("YMR120C",727).
component("YBL013W",173).
component("YKL024C",612).
component("YPR074C",918).
component("YBR117C",206).
component("YLR354C",692).
component("YGR043C",457).
component("YMR108W",724).
component("YCL009C",237).
component("YMR062C",720).
component("YNL071W",758).
component("YNR008W",789).
component("YIL160C",546).
component("YNL277W",780).
component("YFL017C",410).
component("YPL231W",893).
component("YER061C",387).
component("U86_",151).
component("YPL001W",870).
component("YMR296C",748).
component("YDR062W",306).
component("YDL052C",260).
component("U8_",155).
component("YDR148C",319).
component("YOR377W",867).
component("YGR177C",472).
component("YPL231W",894).
component("YGR147C",467).
component("YDL040C",258).
component("YPL028W",873).
component("YLR195C",673).
component("YGL017W",429).
component("YPR001W",906).
component("YNR001C",787).
component("YCR005C",244).
component("YDL182W",284).
component("YDL131W",272).
component("YNL117W",762).
component("YIR031C",552).
component("YOR321W",855).
component("YJR143C",604).
component("YGR199W",477).
component("YDR307W",337).
component("YDL095W",267).
component("YDL093W",266).
component("YAL023C",166).
component("YOR103C",829).
component("YOR085W",827).
component("YMR149W",729).
component("YML019W",700).
component("YJL002C",555).
component("YEL002C",364).
component("YDL232W",290).
component("YCL043C",242).
component("YNL029C",754).
component("YIL085C",536).
component("YMR261C",742).
component("YML100W",709).
component("YBR126C",209).
component("YNL192W",770).
component("YBR038W",197).
component("YBR023C",193).
component("YMR306W",752).
component("YLR342W",690).
component("YGR032W",455).
component("YLR209C",674).
component("U104_",21).
component("YMR271C",744).
component("YML106W",710).
component("YOR209C",845).
component("YMR300C",749).
component("YER055C",382).
component("YDR354W",344) :- not remove_orf("YDR354W",344).
component("YFR047C",421).
component("YJR133W",601).
component("YLR209C",675).
component("YML022W",701).
component("YDR441C",354).
component("YDR399W",346).
component("YPR176C",926).
component("YPL172C",884).
component("YNR041C",795).
component("YMR101C",722).
component("YDL090C",265).
component("YBR003W",184).
component("YBR002C",183).
component("YJL167W",575).
component("YJL167W",576).
component("YNL256W",774).
component("YPR069C",915).
component("YDR127W",314).
component("YLR303W",682).
component("YGR012W",453).
component("YJR130C",600).
component("YLR303W",683).
component("YDR035W",298).
component("YBR249C",226).
component("YOR274W",851).
component("YOL143C",821).
component("YBR256C",228).
component("YHR137W",518).
component("YGL202W",444).
component("YLR027C",655).
component("YKL106W",621).
component("YOL140W",820).
component("YKL104C",620).
component("YGR019W",454).
component("YLR089C",661).
component("U64_",134).
component("U61_",131).
component("U51_",123).
component("YJR148W",605).
component("YHR208W",525).
component("YOR184W",840).
component("YNR058W",799).
component("YIL116W",540).
component("YGL253W",450).
component("YFR053C",422).
component("YOL136C",819).
component("YIL107C",538).
component("YMR013C",717).
component("YMR205C",735).
component("YGR240C",482).
component("YDR248C",327).
component("YCR036W",250).
component("YGR194C",476).
component("YCL040W",241).
component("YJR105W",598).
component("U16_",58).
component("U15_",52).
component("YPL188W",886).
component("YJR049C",588).
component("YEL041W",367).
component("U96_",161).
component("YKL001C",610).
component("YDR236C",325).
component("YML070W",707).
component("YFL053W",414).
component("YHL032C",496).
component("YLR133W",663).
component("YDR531W",362).
component("U83_",149).
component("U82_",148).
component("U81_",147).
component("YMR208W",736).
component("YPL203W",887).
component("YOR061W",824).
component("YKL166C",629).
component("YJL164C",573).
component("YIL035C",530).
component("YHR205W",524).
component("YHR102W",516).
component("YGL019W",430).
component("YHR025W",505).
component("YOR347C",861).
component("YAL038W",168).
component("YNR012W",790).
component("YPR121W",922).
component("YPL258C",896).
component("YOL055C",807).
component("YPL214C",890).
component("U1_",81).
component("YDR009W",295).
component("YBR020W",191).
component("YNL267W",778).
component("YLR305C",685).
component("YFR019W",417).
component("YDR208W",323).
component("YDR127W",315).
component("U21_",92).
component("U20_",89).
component("YDR147W",318).
component("YDR300C",336).
component("YCR012W",245).
component("YER052C",380).
component("YER069W",390).
component("U18_",73).
component("U17_",66).
component("U76_",143).
component("YMR220W",738).
component("YER170W",406).
component("YDR226W",324).
component("YKL067W",618).
component("YOL055C",808).
component("YDR454C",355).
component("YJR057W",590).
component("YOL061W",812).
component("YKL181W",630).
component("YHL011C",493).
component("YER099C",401).
component("YBL068W",181).
component("YOR143C",836).
component("YNL256W",775).
component("YLR328W",688).
component("YBR018C",187).
component("YBR018C",188).
component("YGR007W",452).
component("YLR328W",689).
component("YKR002W",640).
component("YDL103C",270).
component("U94_",160).
component("YJR010W",584).
component("YGL130W",440).
component("YDR530C",361).
component("YCL050C",243).
component("YPR190C",928).
component("YPR187W",927).
component("YPR110C",920).
component("YPR010C",909).
component("YOR341W",860).
component("YOR340C",859).
component("YOR224C",848).
component("YOR210W",846).
component("YOR207C",843).
component("YOR151C",837).
component("YOR116C",830).
component("YOL005C",801).
component("YNR003C",788).
component("YNL248C",773).
component("YNL151C",767).
component("YNL113W",761).
component("YKL144C",625).
component("YJR063W",591).
component("YJL148W",570).
component("YJL140W",569).
component("YIL021W",529).
component("YHR143W-A",519).
component("YGL070C",437).
component("YFL036W",413).
component("YDR404C",349).
component("YDR156W",320).
component("YDR045C",301).
component("YDL150W",279).
component("YDL140C",274).
component("YBR154C",215).
component("YPR175W",925).
component("YPL167C",883).
component("YOR330C",857).
component("YOL115W",817).
component("YNL299W",784).
component("YNL262W",777).
component("YNL102W",760).
component("YJR043C",587).
component("YJR006W",583).
component("YJL090C",562).
component("YIL139C",542).
component("YEL055C",370).
component("YDR419W",352).
component("YDR121W",312).
component("YDL102W",269).
component("YCR014C",246).
component("YBR278W",231).
component("YBL035C",175).
component("YKL035W",615).
component("YHL012W",494).
component("YHR123W",517).
component("YPR113W",921).
component("YBR243C",224).
component("YNL130C",763).
component("YDL142C",278).
component("YPL148C",881).
component("YER026C",378).
component("YCL004W",236).
component("YGR286C",490).
component("YJL068C",559).
component("YDR058C",305).
component("YNR034W",794).
component("YHR163W",521).
component("YGR248W",484).
component("YCR073W-A",252).
component("YDL086W",264).
component("YOL011W",803).
component("YMR008C",715).
component("YMR006C",714).
component("U105_",22).
component("U101_",19).
component("YBL015W",174).
component("YJL068C",560).
component("YPL072W",876).
component("YOR124C",831).
component("YNL186W",769).
component("YMR304W",751).
component("YMR223W",739).
component("YKR098C",649).
component("YJL197W",577).
component("YIL156W",544).
component("YFR010W",416).
component("YER151C",404).
component("YER144C",403).
component("YER098W",400).
component("YDR069C",307).
component("YDL122W",271).
component("YBR058C",198).
component("YBL067C",180).
component("YDR272W",331).
component("U84_",150).
component("YDR481C",356).
component("YLR377C",695).
component("YDR074W",308).
component("YPL179W",885).
component("YNR032W",792).
component("YML057W",706).
component("YML016C",699).
component("YLR433C",698).
component("YGR123C",465).
component("YER133W",402).
component("YER089C",397).
component("YDR436W",353).
component("YDR075W",309).
component("YDL188C",285).
component("YDL134C",273).
component("YDL047W",259).
component("YDL006W",253).
component("YBR125C",208).
component("YBL056W",179).
component("YPR073C",916).
component("YHR215W",526).
component("YDL024C",256).
component("YBR093C",204).
component("YBR092C",203).
component("YAR071W",170).
component("YIL053W",533).
component("YER062C",388).
component("YHR046C",508).
component("U9_",164).
component("YGR208W",480).
component("YPL228W",891).
component("YMR180C",732).
component("YDL236W",291).
component("YJL155C",572).
component("YPR073C",917).
component("YOR208W",844).
component("YNL053W",757).
component("YMR036C",719).
component("YIR026C",549).
component("YIL113W",539).
component("YFR028C",418).
component("YER075C",393).
component("YDL230W",289).
component("YBR276C",230).
component("U34_",110).
component("U33_",109).
component("U32_",108).
component("U30_",107).
...
component("U25_",103).
component("U24_",102).
component("YPL268W",900).
component("YOR360C",864).
component("YGL248W",449).
component("YKR031C",643).
component("YPL206C",888).
component("YGL027C",432).
component("YLR286C",680).
component("YJR153W",607).
component("YJL221C",582).
component("YJL216C",580).
component("YIL172C",548).
component("YGR292W",492).
component("YGR287C",491).
component("YBR299W",235).
component("YBR184W",218).
component("YOR190W",841).
component("YLR300W",681).
component("YGR282C",489).
component("YDR261C",329).
component("YDR400W",347).
component("U23_",101).
component("YML035C",702).
component("YJL070C",561).
component("YBR284W",232).
component("U102_",20).
component("YNL045W",756).
component("YLR160C",670).
component("YLR158C",669).
component("YLR157C",668).
component("YLR155C",667).
component("YDR321W",338).
component("YGL037C",433).
component("YMR293C",747).
component("YDR242W",326).
component("YLR308W",687).
component("YLR307W",686).
component("YBR208C",220).
component("YMR281W",746).
component("U53_",125).
component("YIR027C",550).
component("YPL111W",880).
component("YIR032C",553).
component("YIR029W",551).
component("YPR062W",914).
component("YMR120C",728).
component("YLR028C",656).
component("YHR144C",520).
component("YGR267C",488).
component("YNL141W",764).
component("YBR153W",214).
component("YDL238C",292).
component("YNL141W",765).
component("YLR245C",678).
component("YML035C",703).
component("YBR084W",201).
component("YJL126W",565).
component("U44_",117).
component("YDL100C",268).
component("U87_",152).
component("U40_",115).
component("YMR267W",743).
component("YBR011C",186).
component("YHR201C",523).
component("YBR111C",205).
component("YBR252W",227).
component("YCL030C",240).
component("YER005W",374).
component("YIL048W",532).
component("YER166W",405).
component("YDR093W",310).
component("YAL026C",167).
component("YLR231C",676).
component("U88_",153).
component("YLR134W",664).
component("YLR044C",657).
component("YGR087C",461).
component("YDR380W",345).
component("YDL080C",263).
component("U98_",162).
component("YMR250W",741).
component("YKL184W",634).
component("YOR128C",832).
component("YEL021W",366).
component("YNR043W",796).
component("U93_",159).
component("YDR047W",303).
component("U54_",126).
component("YKL211C",636) :- not remove_orf("YKL211C",636).
component("YKR097W",648).
component("YOL052C",806).
component("YNL169C",768).
component("YGR170W",469).
component("YKL060C",617).
component("YNL256W",776).
component("YDR294C",333).
component("YEL046C",368).
component("YNR033W",793).
component("YPR006C",908).
component("YER065C",389).
component("YKL211C",637) :- not remove_orf("YKL211C",637).
component("YER090W",637) :- not remove_orf("YER090W",637).
component("YER090W",398) :- not remove_orf("YER090W",398).
component("YDR127W",316).
component("YPL281C",905).
component("YOR393W",869).
component("YMR323W",753).
component("YHR174W",522).
component("YGR254W",485).
component("YPL262W",897).
component("YGL026C",431) :- not remove_orf("YGL026C",431).
component("YGR155W",468).
component("YLR304C",684).
component("YJL200C",578).
component("YNL316C",785).
component("YKL182W",632).
component("YPL212C",889).
component("YNL292W",783).
component("YGL063W",436).
component("YFL001W",408).
component("YOR278W",852).
component("YPR002W",907).
component("U49_",120).
component("YJR016C",585).
component("YCR053W",251).
component("YDR127W",317).
component("YGL148W",441).
component("YIL168W",547).
component("YER086W",395).
component("YLR359W",694).
component("YAL012W",165).
component("YFR055W",423).
component("YJL005W",556).
component("YOR176W",839).
component("YJL121C",564).
component("YBR019C",189).
component("YBR019C",190).
component("YDR050C",304).
component("YDR007W",294) :- not remove_orf("YDR007W",294).
component("YOR095C",828).
component("YER003C",373).
component("YBR196C",219).
component("YGL001C",425).
component("U14_",44).
component("YOL056W",809).
component("YKL152C",628).
component("YDL021W",254).
component("YMR105C",723).
component("YKL127W",622).
component("YEL058W",371).
component("YPR060C",913).
component("YHR072W",510).
component("YJL153C",571).
component("YPL097W",878).
component("YGR185C",475).
component("YGR264C",487).
component("YGR171C",470).
component("YHR011W",501).
component("YDR023W",297).
component("YPL104W",879).
component("YLL018C",650).
component("YPR081C",919).
component("YBR121C",207).
component("YHR020W",504).
component("YER087W",396).
component("YNL247W",772).
component("YOL033W",805).
component("YGL245W",448).
component("YHR091C",512).
component("YDR341C",339).
component("YOL097C",815).
component("YDR268W",330).
component("YPR047W",912).
component("YLR060W",659).
component("YFL022C",412).
component("YPR033C",910).
component("YHR019C",502).
component("YCR024C",247).
component("YHR019C",503).
component("YPL160W",882).
component("YLR382C",696).
component("YNL073W",759).
component("YDR037W",299).
component("YOR335C",858).
component("YGR094W",463).
component("YOR317W",854).
component("YMR246W",740).
component("YIL009W",528).
component("YER015W",376).
component("YOR142W",835).
component("YGR244C",483).
component("YPR035W",911).
component("U89_",154).
component("YOR241W",850).
component("YMR113W",725).
component("YKL132C",623).
component("YJL101C",563).
component("U92_",158).
component("YGL234W",446).
component("U91_",157).
component("U90_",156).
component("YNR057C",798).
component("YDL141W",275).
component("YDL141W",276).
component("YGL234W",447).
component("YDL141W",277).
component("YJR103W",596).
component("YBL039C",176).
component("YGR204W",479).
component("YBR084W",202).
component("YOL058W",810).
component("YBR208C",221).
component("YHR074W",511).
component("YMR217W",737).
component("YGR061C",460).
component("YPR145W",924).
component("YGR124W",466).
component("YOR303W",853).
component("YJR109C",599).
component("YJL130C",567).
component("YGL062W",435).
component("YBR218C",222).
component("YPL231W",895).
component("YNR016C",791).
component("YKL182W",633).
component("YGR037C",456).
component("YOR005C",823).
component("YDL164C",280).
component("YOL010W",802).
component("YPR138C",923).
component("YPL274W",902).
component("YPL265W",898).
component("YPL057C",875).
component("YPL036W",874).
component("YOR348C",862).
component("YOR192C",842).
component("YOR171C",838).
component("YOR130C",833).
component("YOR071C",826).
component("YOL156W",822).
component("YOL103W",816).
component("YOL020W",804) :- not remove_orf("YOL020W",804).
component("YNR072W",800).
component("YNR056C",797).
component("YNL318C",786).
component("YNL268W",779).
component("YNL142W",766).
component("YMR272C",745).
component("YMR202W",734).
component("YMR011W",716).
component("YML123C",713).
component("YLR348C",691).
component("YLR260W",679).
component("YLR237W",677).
component("YLR138W",665).
component("YLR100C",662).
component("YLR081W",660).
component("YLL061W",653).
component("YLL043W",652).
component("YKR093W",647).
component("YKR053C",645).
component("YKR039W",644) :- not remove_orf("YKR039W",644).
component("YKL217W",639).
component("YKL004W",611).
component("YJR158W",608).
component("YJR152W",606).
component("YJR095W",595).
component("YJR077C",593).
component("YJL219W",581).
component("YJL214W",579).
component("YJL134W",568).
component("YJL129C",566).
component("YHR096C",515).
component("YHR094C",514).
component("YHR092C",513).
component("YHL036W",497).
component("YHL016C",495).
component("YGR121C",464).
component("YGR055W",458).
component("YGL186C",443).
component("YGL077C",438).
component("YGL008C",426).
component("YFL055W",415).
component("YFL011W",409).
component("YER060W-A",385).
component("YER060W",384).
component("YER056C",383).
component("YER053C",381).
component("YEL069C",372).
component("YEL017C-A",365).
component("YDR536W",363).
component("YDR508C",359).
component("YDR503C",358).
component("YDR497C",357).
component("YDR345C",342).
component("YDR343C",341).
component("YDR342C",340).
component("YDR297W",335).
component("YDR294C",334).
component("YDR284C",332).
component("YDR046C",302) :- not remove_orf("YDR046C",302).
component("YDL245C",293).
component("YDL210W",286).
component("YCR032W",249).
component("YCR024C-A",248).
component("YCL025C",238).
component("YBR298C",234).
component("YBR291C",233).
component("YBR069C",200) :- not remove_orf("YBR069C",200).
component("YBR068C",199) :- not remove_orf("YBR068C",199).
component("YBR036C",196).
component("YBR021W",192).
component("YBL042C",177).
component("U7_",146).
component("U79_",145).
component("U78_",144).
component("U75_",142).
...
catalyst(6160,749).
catalyst(3870,382).
catalyst(3620,344) :- not remove_reaction(3620,344).
catalyst(2110,421).
catalyst(2190,421).
catalyst(5550,601).
catalyst(5791,675).
...
catalyst(1960,303).
catalyst(3460,126).
catalyst(3600,636) :- not remove_reaction(3600,636).
catalyst(8000,648).
catalyst(3941,806).
catalyst(3942,806).
catalyst(6890,768).
...
catalyst(8020,908).
catalyst(8020,389).
catalyst(1890,637) :- not remove_reaction(1890,637).
catalyst(3630,637) :- not remove_reaction(3630,637).
catalyst(1890,398) :- not remove_reaction(1890,398).
catalyst(3630,398) :- not remove_reaction(3630,398).
catalyst(3740,316).
catalyst(8231,905).
catalyst(8232,905).
catalyst(8231,869).
...
catalyst(8051,897).
catalyst(8052,897).
catalyst(3590,431) :- not remove_reaction(3590,431).
catalyst(10910,431) :- not remove_reaction(10910,431).
catalyst(4570,468).
catalyst(8181,684).
catalyst(8182,684).
catalyst(8181,578).
...
catalyst(8281,304).
catalyst(8282,304).
catalyst(3610,294) :- not remove_reaction(3610,294).
catalyst(7921,828).
catalyst(7922,828).
catalyst(7841,373).
catalyst(7842,373).
...
catalyst(1210,822).
catalyst(1160,816).
catalyst(801,804) :- not remove_reaction(801,804).
catalyst(802,804) :- not remove_reaction(802,804).
catalyst(811,804) :- not remove_reaction(811,804).
catalyst(812,804) :- not remove_reaction(812,804).
catalyst(831,804) :- not remove_reaction(831,804).
catalyst(832,804) :- not remove_reaction(832,804).
catalyst(901,804) :- not remove_reaction(901,804).
catalyst(902,804) :- not remove_reaction(902,804).
catalyst(941,804) :- not remove_reaction(941,804).
catalyst(942,804) :- not remove_reaction(942,804).
catalyst(1170,800).
catalyst(1210,800).
catalyst(700,797).
catalyst(1200,786).
...
catalyst(650,647).
catalyst(6560,645).
catalyst(761,644) :- not remove_reaction(761,644).
catalyst(762,644) :- not remove_reaction(762,644).
catalyst(771,644) :- not remove_reaction(771,644).
catalyst(772,644) :- not remove_reaction(772,644).
catalyst(781,644) :- not remove_reaction(781,644).
catalyst(782,644) :- not remove_reaction(782,644).
catalyst(791,644) :- not remove_reaction(791,644).
catalyst(792,644) :- not remove_reaction(792,644).
catalyst(801,644) :- not remove_reaction(801,644).
catalyst(802,644) :- not remove_reaction(802,644).
catalyst(811,644) :- not remove_reaction(811,644).
catalyst(812,644) :- not remove_reaction(812,644).
catalyst(821,644) :- not remove_reaction(821,644).
catalyst(822,644) :- not remove_reaction(822,644).
catalyst(831,644) :- not remove_reaction(831,644).
catalyst(832,644) :- not remove_reaction(832,644).
catalyst(841,644) :- not remove_reaction(841,644).
catalyst(842,644) :- not remove_reaction(842,644).
catalyst(861,644) :- not remove_reaction(861,644).
catalyst(862,644) :- not remove_reaction(862,644).
catalyst(881,644) :- not remove_reaction(881,644).
catalyst(882,644) :- not remove_reaction(882,644).
catalyst(901,644) :- not remove_reaction(901,644).
catalyst(902,644) :- not remove_reaction(902,644).
catalyst(911,644) :- not remove_reaction(911,644).
catalyst(912,644) :- not remove_reaction(912,644).
catalyst(921,644) :- not remove_reaction(921,644).
catalyst(922,644) :- not remove_reaction(922,644).
catalyst(941,644) :- not remove_reaction(941,644).
catalyst(942,644) :- not remove_reaction(942,644).
catalyst(1191,644) :- not remove_reaction(1191,644).
catalyst(1192,644) :- not remove_reaction(1192,644).
catalyst(1021,639).
catalyst(1022,639).
catalyst(6610,611).
catalyst(1170,608).
...
catalyst(6550,334).
catalyst(6690,332).
catalyst(791,302) :- not remove_reaction(791,302).
catalyst(792,302) :- not remove_reaction(792,302).
catalyst(801,302) :- not remove_reaction(801,302).
catalyst(802,302) :- not remove_reaction(802,302).
catalyst(811,302) :- not remove_reaction(811,302).
catalyst(812,302) :- not remove_reaction(812,302).
catalyst(831,302) :- not remove_reaction(831,302).
catalyst(832,302) :- not remove_reaction(832,302).
catalyst(841,302) :- not remove_reaction(841,302).
catalyst(842,302) :- not remove_reaction(842,302).
catalyst(861,302) :- not remove_reaction(861,302).
catalyst(862,302) :- not remove_reaction(862,302).
catalyst(901,302) :- not remove_reaction(901,302).
catalyst(902,302) :- not remove_reaction(902,302).
catalyst(1170,293).
catalyst(1210,293).
catalyst(690,286).
catalyst(730,286).
...
catalyst(1511,233).
catalyst(1512,233).
catalyst(771,200) :- not remove_reaction(771,200).
catalyst(772,200) :- not remove_reaction(772,200).
catalyst(791,200) :- not remove_reaction(791,200).
catalyst(792,200) :- not remove_reaction(792,200).
catalyst(801,200) :- not remove_reaction(801,200).
catalyst(802,200) :- not remove_reaction(802,200).
catalyst(811,200) :- not remove_reaction(811,200).
catalyst(812,200) :- not remove_reaction(812,200).
catalyst(861,200) :- not remove_reaction(861,200).
catalyst(862,200) :- not remove_reaction(862,200).
catalyst(901,200) :- not remove_reaction(901,200).
catalyst(902,200) :- not remove_reaction(902,200).
catalyst(791,199) :- not remove_reaction(791,199).
catalyst(792,199) :- not remove_reaction(792,199).
catalyst(801,199) :- not remove_reaction(801,199).
catalyst(802,199) :- not remove_reaction(802,199).
catalyst(811,199) :- not remove_reaction(811,199).
catalyst(812,199) :- not remove_reaction(812,199).
catalyst(831,199) :- not remove_reaction(831,199).
catalyst(832,199) :- not remove_reaction(832,199).
catalyst(841,199) :- not remove_reaction(841,199).
catalyst(842,199) :- not remove_reaction(842,199).
catalyst(861,199) :- not remove_reaction(861,199).
catalyst(862,199) :- not remove_reaction(862,199).
catalyst(901,199) :- not remove_reaction(901,199).
catalyst(902,199) :- not remove_reaction(902,199).
catalyst(6600,196).
catalyst(620,192).
catalyst(540,177).
catalyst(6960,146).
...
modifiable_enzyme(636).
modifiable_enzyme(637).
modifiable_enzyme(398).
modifiable_enzyme(431).
modifiable_enzyme(294).
modifiable_enzyme(804).
modifiable_enzyme(644).
modifiable_enzyme(302).
modifiable_enzyme(200).
modifiable_enzyme(199).
