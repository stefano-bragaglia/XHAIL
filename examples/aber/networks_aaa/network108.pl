...
component("YNL280C",614).
component("YGR060W",365).
component("YGL012W",340).
component("YKR009C",503).
component("YOL086C",642).
component("YMR303C",587).
component("YMR083W",568).
component("YGL256W",358).
component("YDL168W",222).
component("YBR145W",166).
component("YPL231W",701).
component("U46_",90).
component("YBR149W",167).
component("YJR159W",475).
component("YGL001C",337).
component("YIL094C",419).
component("YHR063C",402).
component("YBR153W",168).
component("YML056C",555).
component("YLR432W",549).
component("YHR216W",413).
component("YAR075W",133).
component("YAR073W",132).
component("YDR127W",247).
component("YJR139C",471).
component("YOL126C",647).
component("YDL078C",205).
component("YKL029C",480).
component("YOR136W",657).
component("YNL037C",591).
component("YDL066W",204).
component("YNL241C",606).
component("YOL059W",640).
component("YDL022W",199).
component("YLR355C",546).
component("YML086C",558).
component("YIL155C",425).
component("YPR191W",729).
component("YOR065W",652).
component("YJL166W",449).
component("YHR001W-A",394).
component("YGR183C",377).
component("YFR033C",333).
component("YDR529C",285).
component("YBL045C",139).
component("Q0105",18).
component("YGR088W",367).
component("YDR256C",261).
component("YKL026C",479).
component("YIR037W",432).
component("YBR244W",178).
component("YJR078W",462).
component("YJR025C",456).
component("YGR255C",387).
component("U108_",22).
component("YBL098W",143).
component("YMR015C",565).
component("YDR402C",275).
component("YGL055W",345).
component("YGR175C",374).
component("YJR104C",465).
component("YHR008C",395).
component("YJL026W",433).
component("YGR180C",376).
component("YER070W",307).
component("U35_",86).
component("YDL168W",223).
component("YDR158W",255).
component("YPL276W",710).
component("YPL275W",709).
component("YOR388C",685).
component("YOR374W",682).
component("YER073W",308).
component("YGL154C",351).
component("U55_",97).
component("YOR323C",674).
component("YMR170C",574).
component("YMR169C",573).
component("U2_",83).
component("YBR221C",176).
component("YIL125W",423).
component("U52_",94).
component("YBR166C",171).
component("YNL280C",615).
component("YGL012W",341).
component("U57_",98).
component("YKL216W",500).
component("YDR044W",237).
component("YER014W",295).
component("YKR009C",504).
component("YIL160C",427).
component("YGL205W",354).
component("YMR118C",571).
component("YLR164W",529).
component("YLL041C",512).
component("YKL148C",490).
component("YKL141W",488).
component("YJL045W",434).
component("YDR178W",256).
component("YJR051W",458).
component("YEL047C",290).
component("YOR375C",683).
component("YDL215C",227).
component("YAL062W",130).
component("U99_",125).
component("YBR035C",153).
component("YHR037W",399).
component("YKR080W",508).
component("YER023W",296).
component("YOR236W",670).
component("YGR204W",380).
component("YLR142W",524).
component("U62_",101).
component("YKL150W",491).
component("YIL043C",415).
component("YHR042W",400).
component("YOR221C",668).
component("YML120C",561).
component("YKL192C",497).
component("YKL055C",482).
component("YER061C",304).
component("YFR030W",332).
component("YPL017C",688).
component("YFL018C",324).
component("YER042W",298).
component("YJR137C",470).
component("YPL266W",707).
component("YML110C",560).
component("YBR034C",152).
component("YPL273W",708).
component("YLL062C",515).
component("U47_",91).
component("YER091C",314).
component("YJR073C",460).
component("YDL033C",201).
component("YOL096C",643).
component("YLR172C",530).
component("YDR019C",233).
component("YDR408C",277).
component("YBL013W",134).
component("YKL024C",478).
component("YPR074C",721).
component("YBR117C",162).
component("YLR354C",545).
component("YGR043C",363).
component("YCL009C",187).
component("YMR062C",567).
component("YNL071W",594).
component("YNR008W",622).
component("YPL231W",702).
component("YER061C",305).
component("U86_",116).
component("YPL001W",687).
component("YDR148C",253).
component("YOR377W",684).
component("YGR177C",375).
component("YPL231W",703).
component("YGR147C",371).
component("YDL040C",202).
component("YPL028W",689).
component("YGL017W",342).
component("YPR001W",712).
component("YNR001C",620).
component("YDL182W",224).
component("YDL131W",214).
component("YNL117W",598).
component("YIR031C",430).
component("YOR321W",673).
component("YJR143C",472).
component("YGR199W",379).
component("YDR307W",268).
component("YDL095W",209).
component("YDL093W",208).
component("YAL023C",127).
component("YNL029C",590).
component("YIL085C",418).
component("YMR261C",581).
component("YML100W",559).
component("YBR126C",165).
component("YNL192W",605).
component("YBR038W",155).
component("YBR023C",151).
component("YLR209C",531).
component("U104_",21).
component("YOR209C",666).
component("YMR300C",586).
component("YER055C",300).
component("YDR354W",271) :- not remove_orf("YDR354W",271).
component("YFR047C",334).
component("YJR133W",469).
component("YLR209C",532).
component("YML022W",552).
component("YDR441C",280).
component("YDR399W",273).
component("YJL167W",450).
component("YNL256W",609).
component("YDR127W",248).
component("YLR303W",538).
component("YGR012W",360).
component("YJR130C",468).
component("YLR303W",539).
component("YDR035W",235).
component("YBR249C",179).
component("YOL143C",649).
component("YBR256C",180).
component("YHR137W",407).
component("YGL202W",353).
component("YLR027C",516).
component("YKL106W",485).
component("YKL104C",484).
component("YGR019W",361).
component("YLR089C",520).
component("U64_",102).
component("U61_",100).
component("U51_",93).
component("YJR148W",473).
component("YOR184W",661).
component("YNR058W",630).
component("YIL116W",422).
component("YGL253W",357).
component("YFR053C",335).
component("YOL136C",648).
component("YIL107C",420).
component("YMR205C",576).
component("YGR240C",383).
component("YDR248C",260).
component("YCR036W",195).
component("YCL040W",190).
component("YJR105W",466).
component("U16_",44).
component("U15_",39).
component("U96_",123).
component("YKL001C",476).
component("YML070W",557).
component("YFL053W",327).
component("YHL032C",392).
component("YDR531W",286).
component("U83_",114).
component("U82_",113).
component("U81_",112).
component("YMR208W",577).
component("YOR347C",679).
component("YAL038W",129).
component("YNR012W",623).
component("YPR121W",724).
component("YPL258C",705).
component("YOL055C",637).
component("U1_",64).
component("YDR009W",232).
component("YBR020W",149).
component("YNL267W",612).
component("YLR305C",541).
component("YFR019W",330).
component("YDR208W",257).
component("YDR127W",249).
component("U21_",73).
component("U20_",71).
component("YDR147W",252).
component("YDR300C",267).
component("YCR012W",192).
component("U18_",57).
component("U17_",51).
component("U76_",110).
component("YER170W",321).
component("YDR226W",258).
component("YKL067W",483).
component("YDR454C",281).
component("YOL061W",641).
component("YKL181W",493).
component("YHL011C",390).
component("YER099C",316).
component("YBL068W",142).
component("YOR143C",659).
component("YLR328W",542).
component("YBR018C",145).
component("YBR018C",146).
component("YGR007W",359).
component("YLR328W",543).
component("YKR002W",502).
component("YDL103C",212).
component("YJR010W",455).
component("YCL050C",191).
component("YPR190C",728).
component("YPR187W",727).
component("YPR110C",723).
component("YPR010C",714).
component("YOR341W",678).
component("YOR340C",677).
component("YOR224C",669).
component("YOR210W",667).
component("YOR207C",664).
component("YOR151C",660).
component("YOR116C",655).
component("YOL005C",631).
component("YNR003C",621).
component("YNL248C",608).
component("YNL151C",602).
component("YNL113W",597).
component("YKL144C",489).
component("YJR063W",459).
component("YJL148W",446).
component("YJL140W",445).
component("YIL021W",414).
component("YHR143W-A",408).
component("YGL070C",348).
component("YFL036W",326).
component("YDR404C",276).
component("YDR156W",254).
component("YDR045C",238).
component("YDL150W",220).
component("YDL140C",216).
component("YBR154C",170).
component("YPR175W",726).
component("YPL167C",697).
component("YOR330C",675).
component("YOL115W",646).
component("YNL299W",617).
component("YNL262W",611).
component("YNL102W",596).
component("YJR043C",457).
component("YJR006W",454).
component("YJL090C",438).
component("YIL139C",424).
component("YEL055C",291).
component("YDR419W",278).
component("YDR121W",246).
component("YDL102W",211).
component("YCR014C",193).
component("YBR278W",182).
component("YBL035C",136).
component("YKL035W",481).
component("YHL012W",391).
component("YHR123W",406).
component("YBR243C",177).
component("YDL142C",219).
component("YER026C",297).
component("YCL004W",186).
component("YJL068C",435).
component("YDR058C",242).
component("YNR034W",627).
component("YHR163W",410).
component("YGR248W",385).
component("YCR073W-A",196).
component("YDL086W",207).
component("YOL011W",633).
component("YMR008C",564).
component("YMR006C",563).
component("U101_",19).
component("YBL015W",135).
component("YJL068C",436).
component("YPL072W",692).
component("YOR124C",656).
component("YNL186W",604).
component("YMR304W",588).
component("YMR223W",579).
component("YKR098C",510).
component("YJL197W",451).
component("YIL156W",426).
component("YFR010W",329).
component("YER151C",319).
component("YER144C",318).
component("YER098W",315).
component("YDR069C",243).
component("YDL122W",213).
component("YBR058C",156).
component("YBL067C",141).
component("YDR272W",263).
component("U84_",115).
component("YPL179W",698).
component("YNR032W",625).
component("YML057W",556).
component("YML016C",551).
component("YLR433C",550).
component("YGR123C",370).
component("YER133W",317).
component("YER089C",312).
component("YDR436W",279).
component("YDR075W",244).
component("YDL188C",225).
component("YDL134C",215).
component("YDL047W",203).
component("YDL006W",197).
component("YBR125C",164).
component("YBL056W",140).
component("YPR073C",719).
component("YHR215W",412).
component("YDL024C",200).
component("YBR093C",160).
component("YBR092C",159).
component("YAR071W",131).
component("YIL053W",417).
component("YER062C",306).
component("YHR046C",401).
component("YGR208W",382).
component("YPL228W",700).
component("YMR180C",575).
component("YDL236W",229).
component("YJL155C",448).
component("YPR073C",720).
component("YOR208W",665).
component("YNL053W",593).
component("YMR036C",566).
component("YIR026C",428).
component("YIL113W",421).
component("YFR028C",331).
component("YER075C",309).
component("YDL230W",228).
component("YBR276C",181).
component("U34_",85).
component("U30_",84).
component("U27_",82).
component("U25_",81).
component("U24_",80).
component("YOR360C",681).
component("YGL248W",356).
component("YKR031C",505).
component("YLR286C",536).
component("YJR153W",474).
component("YOR190W",662).
component("YLR300W",537).
component("YGR282C",389).
component("YDR261C",262).
component("YDR400W",274).
component("U23_",79).
component("YML035C",553).
component("YJL070C",437).
component("YBR284W",183).
component("U102_",20).
component("YNL045W",592).
component("YLR160C",528).
component("YLR158C",527).
component("YLR157C",526).
component("YLR155C",525).
component("YDR321W",269).
component("YGL037C",344).
component("YMR293C",585).
component("YDR242W",259).
component("YBR208C",173).
component("YMR281W",584).
component("U53_",95).
component("YPL111W",695).
component("YIR032C",431).
component("YIR029W",429).
component("YPR062W",718).
component("YMR120C",572).
component("YHR144C",409).
component("YGR267C",388).
component("YNL141W",599).
component("YBR153W",169).
component("YDL238C",230).
component("YNL141W",600).
component("YLR245C",535).
component("YML035C",554).
component("YJL126W",441).
component("U44_",89).
component("YDL100C",210).
component("U87_",117).
component("YMR267W",582).
component("YBR011C",144).
component("YBR111C",161).
component("YCL030C",189).
component("YER005W",294).
component("YIL048W",416).
component("YER166W",320).
component("YDR093W",245).
component("YAL026C",128).
component("YLR231C",533).
component("U88_",118).
component("YLR134W",522).
component("YLR044C",517).
component("YGR087C",366).
component("YDR380W",272).
component("YDL080C",206).
component("U98_",124).
component("YMR250W",580).
component("YKL184W",496).
component("YNR043W",628).
component("U93_",122).
component("YDR047W",240).
component("U54_",96).
component("YKL211C",498) :- not remove_orf("YKL211C",498).
component("YOL052C",636).
component("YNL169C",603).
component("YGR170W",373).
component("YNL256W",610).
component("YDR294C",264).
component("YEL046C",289).
component("YNR033W",626).
component("YKL211C",499) :- not remove_orf("YKL211C",499).
component("YER090W",499) :- not remove_orf("YER090W",499).
component("YER090W",313) :- not remove_orf("YER090W",313).
component("YDR127W",250).
component("YPL281C",711).
component("YOR393W",686).
component("YMR323W",589).
component("YHR174W",411).
component("YGR254W",386).
component("YGL026C",343) :- not remove_orf("YGL026C",343).
component("YGR155W",372).
component("YLR304C",540).
component("YJL200C",452).
component("YNL316C",618).
component("YKL182W",494).
component("YPL212C",699).
component("YNL292W",616).
component("YGL063W",347).
component("YFL001W",322).
component("YPR002W",713).
component("YDR127W",251).
component("YGL148W",350).
component("YER086W",310).
component("YLR359W",547).
component("YAL012W",126).
component("YFR055W",336).
component("YJL121C",440).
component("YBR019C",147).
component("YBR019C",148).
component("YDR050C",241).
component("YDR007W",231) :- not remove_orf("YDR007W",231).
component("YOR095C",654).
component("YER003C",293).
component("YBR196C",172).
component("YGL001C",338).
component("U14_",33).
component("YOL056W",638).
component("YKL152C",492).
component("YDL021W",198).
component("YMR105C",569).
component("YKL127W",486).
component("YEL058W",292).
component("YPR060C",717).
component("YHR072W",403).
component("YJL153C",447).
component("YPL097W",693).
component("YGR185C",378).
component("YHR011W",396).
component("YDR023W",234).
component("YPL104W",694).
component("YLL018C",511).
component("YPR081C",722).
component("YBR121C",163).
component("YHR020W",398).
component("YER087W",311).
component("YNL247W",607).
component("YOL033W",635).
component("YHR091C",405).
component("YDR341C",270).
component("YOL097C",644).
component("YPR047W",716).
component("YLR060W",518).
component("YFL022C",325).
component("YPR033C",715).
component("YHR019C",397).
component("YPL160W",696).
component("YLR382C",548).
component("YNL073W",595).
component("YDR037W",236).
component("YOR335C",676).
component("YGR094W",368).
component("YOR142W",658).
component("YGR244C",384).
component("U89_",119).
component("YOR241W",671).
component("YMR113W",570).
component("YKL132C",487).
component("YJL101C",439).
component("U92_",121).
component("YGL234W",355).
component("U91_",120).
component("YDL141W",217).
component("YDL141W",218).
component("YJR103W",464).
component("YBL039C",137).
component("YGR204W",381).
component("YOL058W",639).
component("YBR208C",174).
component("YHR074W",404).
component("YMR217W",578).
component("YOR303W",672).
component("YJR109C",467).
component("YJL130C",443).
component("YGL062W",346).
component("YBR218C",175).
component("YPL231W",704).
component("YNR016C",624).
component("YKL182W",495).
component("YGR037C",362).
component("YOR005C",651).
component("YDL164C",221).
component("YOL010W",632).
component("YPR138C",725).
component("YPL265W",706).
component("YPL057C",691).
component("YPL036W",690).
component("YOR348C",680).
component("YOR192C",663).
component("YOR071C",653).
component("YOL156W",650).
component("YOL103W",645).
component("YOL020W",634) :- not remove_orf("YOL020W",634).
component("YNR056C",629).
component("YNL318C",619).
component("YNL268W",613).
component("YNL142W",601).
component("YMR272C",583).
component("YML123C",562).
component("YLR348C",544).
component("YLR237W",534).
component("YLR138W",523).
component("YLR100C",521).
component("YLR081W",519).
component("YLL061W",514).
component("YLL043W",513).
component("YKR093W",509).
component("YKR053C",507).
component("YKR039W",506) :- not remove_orf("YKR039W",506).
component("YKL217W",501).
component("YKL004W",477).
component("YJR095W",463).
component("YJR077C",461).
component("YJL219W",453).
component("YJL134W",444).
component("YJL129C",442).
component("YHL036W",393).
component("YGR121C",369).
component("YGR055W",364).
component("YGL186C",352).
component("YGL077C",349).
component("YGL008C",339).
component("YFL055W",328).
component("YFL011W",323).
component("YER060W-A",303).
component("YER060W",302).
component("YER056C",301).
component("YER053C",299).
component("YEL017C-A",288).
component("YDR536W",287).
component("YDR508C",284).
component("YDR503C",283).
component("YDR497C",282).
component("YDR297W",266).
component("YDR294C",265).
component("YDR046C",239) :- not remove_orf("YDR046C",239).
component("YDL210W",226).
component("YCR024C-A",194).
component("YCL025C",188).
component("YBR298C",185).
component("YBR291C",184).
component("YBR069C",158) :- not remove_orf("YBR069C",158).
component("YBR068C",157) :- not remove_orf("YBR068C",157).
component("YBR036C",154).
...
catalyst(6160,586).
catalyst(3870,300).
catalyst(3620,271) :- not remove_reaction(3620,271).
catalyst(2110,334).
catalyst(2190,334).
catalyst(5550,469).
catalyst(5791,532).
...
catalyst(1960,240).
catalyst(3460,96).
catalyst(3600,498) :- not remove_reaction(3600,498).
catalyst(3941,636).
catalyst(3942,636).
catalyst(6890,603).
catalyst(6900,373).
...
catalyst(4560,289).
catalyst(2550,626).
catalyst(1890,499) :- not remove_reaction(1890,499).
catalyst(3630,499) :- not remove_reaction(3630,499).
catalyst(1890,313) :- not remove_reaction(1890,313).
catalyst(3630,313) :- not remove_reaction(3630,313).
catalyst(3740,250).
catalyst(8231,711).
catalyst(8232,711).
catalyst(8231,686).
...
catalyst(8231,386).
catalyst(8232,386).
catalyst(3590,343) :- not remove_reaction(3590,343).
catalyst(10910,343) :- not remove_reaction(10910,343).
catalyst(4570,372).
catalyst(8181,540).
catalyst(8182,540).
catalyst(8181,452).
...
catalyst(8281,241).
catalyst(8282,241).
catalyst(3610,231) :- not remove_reaction(3610,231).
catalyst(7921,654).
catalyst(7922,654).
catalyst(7841,293).
catalyst(7842,293).
...
catalyst(1200,650).
catalyst(1160,645).
catalyst(801,634) :- not remove_reaction(801,634).
catalyst(802,634) :- not remove_reaction(802,634).
catalyst(811,634) :- not remove_reaction(811,634).
catalyst(812,634) :- not remove_reaction(812,634).
catalyst(831,634) :- not remove_reaction(831,634).
catalyst(832,634) :- not remove_reaction(832,634).
catalyst(901,634) :- not remove_reaction(901,634).
catalyst(902,634) :- not remove_reaction(902,634).
catalyst(941,634) :- not remove_reaction(941,634).
catalyst(942,634) :- not remove_reaction(942,634).
catalyst(700,629).
catalyst(1200,619).
catalyst(761,613).
catalyst(762,613).
...
catalyst(640,509).
catalyst(6560,507).
catalyst(761,506) :- not remove_reaction(761,506).
catalyst(762,506) :- not remove_reaction(762,506).
catalyst(771,506) :- not remove_reaction(771,506).
catalyst(772,506) :- not remove_reaction(772,506).
catalyst(781,506) :- not remove_reaction(781,506).
catalyst(782,506) :- not remove_reaction(782,506).
catalyst(791,506) :- not remove_reaction(791,506).
catalyst(792,506) :- not remove_reaction(792,506).
catalyst(801,506) :- not remove_reaction(801,506).
catalyst(802,506) :- not remove_reaction(802,506).
catalyst(811,506) :- not remove_reaction(811,506).
catalyst(812,506) :- not remove_reaction(812,506).
catalyst(821,506) :- not remove_reaction(821,506).
catalyst(822,506) :- not remove_reaction(822,506).
catalyst(831,506) :- not remove_reaction(831,506).
catalyst(832,506) :- not remove_reaction(832,506).
catalyst(841,506) :- not remove_reaction(841,506).
catalyst(842,506) :- not remove_reaction(842,506).
catalyst(861,506) :- not remove_reaction(861,506).
catalyst(862,506) :- not remove_reaction(862,506).
catalyst(881,506) :- not remove_reaction(881,506).
catalyst(882,506) :- not remove_reaction(882,506).
catalyst(901,506) :- not remove_reaction(901,506).
catalyst(902,506) :- not remove_reaction(902,506).
catalyst(911,506) :- not remove_reaction(911,506).
catalyst(912,506) :- not remove_reaction(912,506).
catalyst(941,506) :- not remove_reaction(941,506).
catalyst(942,506) :- not remove_reaction(942,506).
catalyst(1191,506) :- not remove_reaction(1191,506).
catalyst(1192,506) :- not remove_reaction(1192,506).
catalyst(1021,501).
catalyst(1022,501).
catalyst(6610,477).
catalyst(1250,463).
...
catalyst(831,239) :- not remove_reaction(831,239).
catalyst(832,239) :- not remove_reaction(832,239).
catalyst(841,239) :- not remove_reaction(841,239).
catalyst(842,239) :- not remove_reaction(842,239).
...
catalyst(1511,184).
catalyst(1512,184).
catalyst(771,158) :- not remove_reaction(771,158).
catalyst(772,158) :- not remove_reaction(772,158).
...
catalyst(791,157) :- not remove_reaction(791,157).
catalyst(792,157) :- not remove_reaction(792,157).
catalyst(801,157) :- not remove_reaction(801,157).
catalyst(802,157) :- not remove_reaction(802,157).
catalyst(811,157) :- not remove_reaction(811,157).
catalyst(812,157) :- not remove_reaction(812,157).
catalyst(831,157) :- not remove_reaction(831,157).
catalyst(832,157) :- not remove_reaction(832,157).
catalyst(841,157) :- not remove_reaction(841,157).
catalyst(842,157) :- not remove_reaction(842,157).
catalyst(861,157) :- not remove_reaction(861,157).
catalyst(862,157) :- not remove_reaction(862,157).
catalyst(901,157) :- not remove_reaction(901,157).
catalyst(902,157) :- not remove_reaction(902,157).
catalyst(6600,154).
catalyst(620,150).
catalyst(540,138).
catalyst(2830,111).
