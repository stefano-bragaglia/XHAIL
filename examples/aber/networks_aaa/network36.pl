...
component("YGR060W",169).
component("YGL012W",157).
component("YOL086C",278).
component("YMR303C",256).
component("YGL256W",165).
component("YDL168W",104).
component("YBR145W",80).
component("YPL231W",303).
component("YGL001C",154).
component("YML056C",243).
component("YLR432W",240).
component("YHR216W",186).
component("YAR075W",68).
component("YAR073W",67).
component("YDR127W",115).
component("YJR139C",213).
component("YOR136W",283).
component("YIL155C",190).
component("YJR078W",207).
component("YJR025C",203).
component("YMR015C",247).
component("YDR402C",129).
component("YJR104C",210).
component("YHR008C",180).
component("YER070W",142).
component("YDL168W",105).
component("YGL154C",163).
component("YOR323C",291).
component("YMR170C",252).
component("YMR169C",251).
component("YBR166C",82).
component("YER014W",139).
component("YMR118C",250).
component("YLR164W",234).
component("YLL041C",230).
component("YKL148C",221).
component("YJL045W",194).
component("YDR178W",121).
component("YJR051W",204).
component("YEL047C",137).
component("YOR375C",296).
component("YDL215C",106).
component("YAL062W",66).
component("YER023W",140).
component("YOR236W",290).
component("YGR204W",175).
component("U62_",48).
component("YPL017C",299).
component("YFL018C",146).
component("U47_",42).
component("YKL024C",216).
component("YPR074C",315).
component("YBR117C",79).
component("YCL009C",92).
component("YPL231W",304).
component("YPL001W",298).
component("YPL231W",305).
component("YPL028W",300).
component("YPR001W",310).
component("YNR001C",268).
component("YNL117W",262).
component("YIR031C",192).
component("YNL029C",258).
component("YIL085C",188).
component("YLR209C",235).
component("YER055C",141).
component("YDR354W",125) :- not remove_orf("YDR354W",125).
component("YFR047C",152).
component("YJR133W",212).
component("YML022W",241).
component("YDR441C",131).
component("YDR399W",127).
component("YDR127W",116).
component("YJR130C",211).
component("YDR035W",111).
component("YBR249C",86).
component("YBR256C",87).
component("YHR137W",182).
component("YLR027C",231).
component("YKL106W",218).
component("YGR019W",167).
component("U64_",49).
component("U51_",44).
component("YJR148W",214).
component("YGL253W",164).
component("YFR053C",153).
component("YMR205C",254).
component("YGR240C",176).
component("YCR036W",97).
component("YCL040W",94).
component("U16_",25).
component("U15_",23).
component("YKL001C",215).
component("YML070W",244).
component("YFL053W",148).
component("U83_",59).
component("U82_",58).
component("YMR208W",255).
component("YOR347C",295).
component("YAL038W",65).
component("YPR121W",317).
component("YPL258C",307).
component("YOL055C",275).
component("U1_",33).
component("YNL267W",266).
component("YLR305C",239).
component("YFR019W",150).
component("YDR208W",122).
component("YDR127W",117).
component("U20_",36).
component("YDR300C",124).
component("U18_",30).
component("U76_",57).
component("YDR454C",132).
component("YOL061W",277).
component("YKL181W",222).
component("YHL011C",178).
component("YER099C",145).
component("YBL068W",71).
component("YOR143C",284).
component("YGR007W",166).
component("YCL050C",95).
component("YPR190C",320).
component("YPR187W",319).
component("YPR110C",316).
component("YPR010C",311).
component("YOR341W",294).
component("YOR340C",293).
component("YOR224C",289).
component("YOR210W",288).
component("YOR207C",286).
component("YOR151C",285).
component("YOR116C",282).
component("YOL005C",272).
component("YNR003C",269).
component("YNL248C",265).
component("YNL151C",264).
component("YNL113W",261).
component("YKL144C",220).
component("YJR063W",205).
component("YJL148W",201).
component("YJL140W",200).
component("YIL021W",187).
component("YHR143W-A",183).
component("YGL070C",161).
component("YFL036W",147).
component("YDR404C",130).
component("YDR156W",120).
component("YDR045C",112).
component("YDL150W",102).
component("YDL140C",101).
component("YBR154C",81).
component("YKL035W",217).
component("YHL012W",179).
component("YDR058C",114).
component("YDL086W",100).
component("YOL011W",273).
component("YMR008C",246).
component("YMR006C",245).
component("U101_",18).
component("YBL015W",69).
component("U84_",60).
component("YPR073C",313).
component("YHR215W",185).
component("YDL024C",98).
component("YBR093C",77).
component("YBR092C",76).
component("YPL228W",302).
component("YMR180C",253).
component("YDL236W",108).
component("YJL155C",202).
component("YPR073C",314).
component("YOR208W",287).
component("YNL053W",260).
component("YMR036C",248).
component("YIR026C",191).
component("YIL113W",189).
component("YFR028C",151).
component("YER075C",143).
component("YDL230W",107).
component("YBR276C",88).
component("U34_",40).
component("U30_",39).
component("U24_",38).
component("YKR031C",227).
component("YLR286C",238).
component("YDR400W",128).
component("YML035C",242).
component("YJL070C",195).
component("YBR284W",89).
component("YNL045W",259).
component("YGL037C",159).
component("YBR208C",83).
component("U53_",45).
component("YIR032C",193).
component("YDL238C",109).
component("YLR245C",237).
component("YJL126W",197).
component("YBR111C",78).
component("YER005W",138).
component("YLR231C",236).
component("U88_",61).
component("YLR134W",233).
component("YLR044C",232).
component("YGR087C",170).
component("YDR380W",126).
component("YDL080C",99).
component("U93_",63).
component("U54_",46).
component("YKL211C",225) :- not remove_orf("YKL211C",225).
component("YGR170W",174).
component("YDR294C",123).
component("YNR033W",271).
...
component("YPL281C",309).
component("YOR393W",297).
component("YMR323W",257).
component("YHR174W",184).
component("YGR254W",177).
component("YGL026C",158) :- not remove_orf("YGL026C",158).
component("YGR155W",173).
component("YNL316C",267).
component("YKL182W",223).
component("YDR127W",119).
component("YGL148W",162).
component("YAL012W",64).
component("YBR019C",72).
component("YDR007W",110) :- not remove_orf("YDR007W",110).
component("YOR095C",281).
component("YGL001C",155).
component("YMR105C",249).
component("YKL127W",219).
component("YPR060C",312).
component("YOL097C",279).
component("YOR335C",292).
component("YGR094W",171).
component("U89_",62).
component("YJL101C",196).
component("YJR103W",209).
component("YBL039C",70).
component("YOL058W",276).
component("YBR208C",84).
component("YHR074W",181).
component("YGL062W",160).
component("YBR218C",85).
component("YPL231W",306).
component("YNR016C",270).
component("YKL182W",224).
component("YGR037C",168).
component("YOR005C",280).
component("YDL164C",103).
component("YPR138C",318).
component("YPL265W",308).
component("YPL036W",301).
component("YOL020W",274) :- not remove_orf("YOL020W",274).
component("YNL142W",263).
component("YKR053C",229).
component("YKR039W",228) :- not remove_orf("YKR039W",228).
component("YJR095W",208).
component("YJR077C",206).
component("YJL134W",199).
component("YJL129C",198).
component("YGR121C",172).
component("YGL008C",156).
component("YFL055W",149).
component("YEL017C-A",136).
component("YDR536W",135).
component("YDR508C",134).
component("YDR503C",133).
component("YDR046C",113) :- not remove_orf("YDR046C",113).
component("YCR024C-A",96).
component("YCL025C",93).
component("YBR298C",91).
component("YBR291C",90).
component("YBR069C",75) :- not remove_orf("YBR069C",75).
component("YBR068C",74) :- not remove_orf("YBR068C",74).
component("YBR021W",73).
component("U75_",56).
component("U74_",55).
component("U73_",54).
component("U72_",53).
...
catalyst(5612,235).
catalyst(3870,141).
catalyst(3620,125) :- not remove_reaction(3620,125).
catalyst(2190,152).
catalyst(5550,212).
catalyst(5650,241).
catalyst(5650,131).
...
catalyst(2300,63).
catalyst(3460,46).
catalyst(3600,225) :- not remove_reaction(3600,225).
catalyst(6900,174).
catalyst(8781,123).
catalyst(8782,123).
catalyst(2550,271).
...
catalyst(8231,177).
catalyst(8232,177).
catalyst(3590,158) :- not remove_reaction(3590,158).
catalyst(10910,158) :- not remove_reaction(10910,158).
catalyst(4570,173).
catalyst(3680,267).
catalyst(7141,223).
catalyst(7142,223).
...
catalyst(8711,72).
catalyst(8712,72).
catalyst(3610,110) :- not remove_reaction(3610,110).
catalyst(7921,281).
catalyst(7922,281).
catalyst(6370,155).
catalyst(7861,249).
...
catalyst(781,228) :- not remove_reaction(781,228).
catalyst(782,228) :- not remove_reaction(782,228).
...
catalyst(881,228) :- not remove_reaction(881,228).
catalyst(882,228) :- not remove_reaction(882,228).
catalyst(1191,228) :- not remove_reaction(1191,228).
catalyst(1192,228) :- not remove_reaction(1192,228).
catalyst(1250,208).
catalyst(1581,206).
catalyst(1582,206).
catalyst(6560,199).
...
catalyst(1501,90).
catalyst(1502,90).
catalyst(771,75) :- not remove_reaction(771,75).
catalyst(772,75) :- not remove_reaction(772,75).
...
catalyst(831,74) :- not remove_reaction(831,74).
catalyst(832,74) :- not remove_reaction(832,74).
catalyst(620,73).
catalyst(2920,56).
catalyst(2920,55).
catalyst(2920,54).
