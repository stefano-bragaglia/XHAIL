...
component("YNL280C",657).
component("YLR056W",550).
component("YGR060W",390).
component("YGL012W",363).
component("YKR009C",534).
component("YOL086C",685).
component("YMR303C",627).
component("YMR083W",605).
component("YGL256W",382).
component("YDL168W",237).
component("YBR145W",181).
component("YPL231W",747).
component("U46_",101).
component("YBR149W",182).
component("YJR159W",505).
component("YGL001C",360).
component("YIL094C",448).
component("YHR063C",431).
component("YBR153W",183).
component("YML056C",592).
component("YLR432W",585).
component("YHR216W",442).
component("YAR075W",146).
component("YAR073W",145).
component("YDR127W",264).
component("YJR139C",500).
component("YOL126C",690).
component("YDL078C",220).
component("YKL029C",510).
component("YOR136W",700).
component("YNL037C",632).
component("YDL066W",219).
component("YNL241C",647).
component("YOL059W",683).
component("YDL022W",214).
component("YLR355C",582).
component("YML054C",591).
component("YDL174C",239).
component("YML086C",595).
component("YIL155C",454).
component("YPR191W",777).
component("YOR065W",695).
component("YJL166W",478).
component("YHR001W-A",421).
component("YGR183C",402).
component("YFR033C",356).
component("YDR529C",305).
component("YBL045C",152).
component("Q0105",18).
component("YGR088W",392).
component("YDR256C",279).
component("YKL026C",509).
component("YIR037W",461).
component("YBR244W",193).
component("YJR078W",491).
component("YJR025C",485).
component("YGR255C",414).
component("U108_",22).
component("YBL098W",156).
component("YMR015C",602).
component("YHR007C",422).
component("YDR402C",294).
component("YGL055W",368).
component("YGR175C",399).
component("YJR104C",494).
component("YHR008C",423).
component("YJL026W",462).
component("YGR180C",401).
component("YER070W",328).
component("U35_",97).
component("YDL168W",238).
component("YDR158W",272).
component("YBR006W",157).
component("YPL276W",758).
component("YPL275W",757).
component("YOR388C",730).
component("YOR374W",727).
component("YER073W",329).
component("U68_",114).
component("YGL154C",375).
component("U55_",108).
component("YOR323C",719).
component("YMR170C",613).
component("YMR169C",612).
component("U2_",93).
component("YER178W",343).
component("YBR221C",191).
component("YIL125W",452).
component("U52_",105).
component("YBR166C",186).
component("YNL280C",658).
component("YGL012W",364).
component("U57_",109).
component("YKL216W",531).
component("YDR044W",254).
component("YER014W",316).
component("YKR009C",535).
component("YIL160C",456).
component("YGL205W",378).
component("YMR118C",609).
component("YLR164W",563).
component("YLL041C",543).
component("YKL148C",521).
component("YKL141W",519).
component("YJL045W",463).
component("YDR178W",273).
component("YJR051W",487).
component("YEL047C",311).
component("YDL215C",243).
component("YOR375C",728).
component("YDL215C",244).
component("YAL062W",143).
component("U99_",138).
component("YBR035C",167).
component("YHR037W",428).
component("YKR080W",539).
component("YER023W",317).
component("YOR236W",714).
component("YGR204W",406).
component("YLR142W",558).
component("U62_",112).
component("YKL150W",522).
component("YIL043C",444).
component("YHR042W",429).
component("YOR221C",712).
component("YML120C",598).
component("YKL192C",528).
component("YKL055C",512).
component("YER061C",325).
component("YGR234W",409).
component("YFR030W",355).
component("YPL017C",733).
component("YFL018C",347).
component("YER042W",319).
component("YJR137C",499).
component("YPL266W",754).
component("YML110C",597).
component("YBR034C",166).
component("YPL273W",755).
component("YLL062C",546).
component("YDR410C",297).
component("U47_",102).
component("YER091C",335).
component("YJR073C",489).
component("YDL033C",216).
component("YOL096C",686).
component("YLR172C",564).
component("YDR019C",250).
component("YDR408C",296).
component("YMR120C",610).
component("YBL013W",147).
component("YKL024C",508).
component("YPR074C",769).
component("YBR117C",177).
component("YLR354C",581).
component("YGR043C",388).
component("YMR108W",607).
component("YCL009C",202).
component("YMR062C",604).
component("YNL071W",635).
component("YNR008W",665).
component("YNL277W",656).
component("YFL017C",346).
component("YPL231W",748).
component("YER061C",326).
component("U86_",128).
component("YPL001W",732).
component("YDR148C",270).
component("YOR377W",729).
component("YGR177C",400).
component("YPL231W",749).
component("YGR147C",396).
component("YDL040C",217).
component("YPL028W",734).
component("YGL017W",365).
component("YPR001W",760).
component("YNR001C",663).
component("YDL182W",240).
component("YDL131W",229).
component("YNL117W",639).
component("YIR031C",459).
component("YOR321W",718).
component("YJR143C",501).
component("YGR199W",405).
component("YDR307W",287).
component("YDL095W",224).
component("YDL093W",223).
component("YAL023C",140).
component("YNL029C",631).
component("YIL085C",447).
component("YMR261C",621).
component("YML100W",596).
component("YBR126C",180).
component("YNL192W",646).
component("YBR038W",169).
component("YBR023C",165).
component("YMR306W",629).
component("YLR342W",579).
component("YGR032W",386).
component("YLR209C",565).
component("U104_",21).
component("YOR209C",710).
component("YMR300C",626).
component("YER055C",321).
component("YDR354W",290) :- not remove_orf("YDR354W",290).
component("YFR047C",357).
component("YJR133W",498).
component("YLR209C",566).
component("YML022W",588).
component("YDR441C",300).
component("YDR399W",292).
component("YJL167W",479).
component("YNL256W",650).
component("YDR127W",265).
component("YLR303W",573).
component("YGR012W",384).
component("YJR130C",497).
component("YLR303W",574).
component("YDR035W",252).
component("YBR249C",194).
component("YOL143C",692).
component("YBR256C",195).
component("YHR137W",436).
component("YGL202W",377).
component("YLR027C",547).
component("YKL106W",516).
component("YKL104C",515).
component("YGR019W",385).
component("YLR089C",553).
component("U64_",113).
component("U61_",111).
component("U51_",104).
component("YJR148W",502).
component("YOR184W",705).
component("YNR058W",673).
component("YIL116W",451).
component("YGL253W",381).
component("YFR053C",358).
component("YOL136C",691).
component("YIL107C",449).
component("YMR205C",615).
component("YGR240C",410).
component("YDR248C",278).
component("YCR036W",210).
component("YGR194C",404).
component("YCL040W",205).
component("YJR105W",495).
component("U16_",49).
component("U15_",44).
component("U96_",136).
component("YKL001C",506).
component("YDR236C",276).
component("YML070W",594).
component("YFL053W",350).
component("YHL032C",419).
component("YLR133W",555).
component("YDR531W",307).
component("U83_",126).
component("U82_",125).
component("U81_",124).
component("YMR208W",616).
component("YHR025W",427).
component("YOR347C",724).
component("YAL038W",142).
component("YNR012W",666).
component("YPR121W",772).
component("YPL258C",751).
component("YOL055C",680).
component("U1_",72).
component("YDR009W",249).
component("YBR020W",163).
component("YNL267W",654).
component("YLR305C",576).
component("YFR019W",353).
component("YDR208W",274).
component("YDR127W",266).
component("U21_",82).
component("U20_",79).
component("YDR147W",269).
component("YDR300C",286).
component("YCR012W",207).
component("U18_",64).
component("U17_",57).
component("U76_",122).
component("YMR220W",618).
component("YER170W",342).
component("YDR226W",275).
component("YKL067W",514).
component("YDR454C",301).
component("YOL061W",684).
component("YKL181W",524).
component("YHL011C",417).
component("YER099C",337).
component("YBL068W",155).
component("YOR143C",702).
component("YNL256W",651).
component("YLR328W",577).
component("YBR018C",159).
component("YBR018C",160).
component("YGR007W",383).
component("YLR328W",578).
component("YKR002W",533).
component("YDL103C",227).
component("YJR010W",484).
component("YGL130W",373).
component("YDR530C",306).
component("YCL050C",206).
component("YPR190C",776).
component("YPR187W",775).
component("YPR110C",771).
component("YPR010C",762).
component("YOR341W",723).
component("YOR340C",722).
component("YOR224C",713).
component("YOR210W",711).
component("YOR207C",708).
component("YOR151C",703).
component("YOR116C",698).
component("YOL005C",674).
component("YNR003C",664).
component("YNL248C",649).
component("YNL151C",643).
component("YNL113W",638).
component("YKL144C",520).
component("YJR063W",488).
component("YJL148W",475).
component("YJL140W",474).
component("YIL021W",443).
component("YHR143W-A",437).
component("YGL070C",371).
component("YFL036W",349).
component("YDR404C",295).
component("YDR156W",271).
component("YDR045C",255).
component("YDL150W",235).
component("YDL140C",231).
component("YBR154C",185).
component("YPR175W",774).
component("YPL167C",742).
component("YOR330C",720).
component("YOL115W",689).
component("YNL299W",660).
component("YNL262W",653).
component("YNL102W",637).
component("YJR043C",486).
component("YJR006W",483).
component("YJL090C",467).
component("YIL139C",453).
component("YEL055C",312).
component("YDR419W",298).
component("YDR121W",263).
component("YDL102W",226).
component("YCR014C",208).
component("YBR278W",197).
component("YBL035C",149).
component("YKL035W",511).
component("YHL012W",418).
component("YHR123W",435).
component("YBR243C",192).
component("YDL142C",234).
component("YER026C",318).
component("YCL004W",201).
component("YJL068C",464).
component("YDR058C",259).
component("YNR034W",670).
component("YHR163W",439).
component("YGR248W",412).
component("YCR073W-A",211).
component("YDL086W",222).
component("YOL011W",676).
component("YMR008C",601).
component("YMR006C",600).
component("U101_",19).
component("YBL015W",148).
component("YJL068C",465).
component("YPL072W",737).
component("YOR124C",699).
component("YNL186W",645).
component("YMR304W",628).
component("YMR223W",619).
component("YKR098C",541).
component("YJL197W",480).
component("YIL156W",455).
component("YFR010W",352).
component("YER151C",340).
component("YER144C",339).
component("YER098W",336).
component("YDR069C",260).
component("YDL122W",228).
component("YBR058C",170).
component("YBL067C",154).
component("YDR272W",282).
component("U84_",127).
component("YPL179W",743).
component("YNR032W",668).
component("YML057W",593).
component("YML016C",587).
component("YLR433C",586).
component("YGR123C",395).
component("YER133W",338).
component("YER089C",333).
component("YDR436W",299).
component("YDR075W",261).
component("YDL188C",241).
component("YDL134C",230).
component("YDL047W",218).
component("YDL006W",212).
component("YBR125C",179).
component("YBL056W",153).
component("YPR073C",767).
component("YHR215W",441).
component("YDL024C",215).
component("YBR093C",175).
component("YBR092C",174).
component("YAR071W",144).
component("YIL053W",446).
component("YER062C",327).
component("YHR046C",430).
component("YGR208W",408).
component("YPL228W",746).
component("YMR180C",614).
component("YDL236W",246).
component("YJL155C",477).
component("YPR073C",768).
component("YOR208W",709).
component("YNL053W",634).
component("YMR036C",603).
component("YIR026C",457).
component("YIL113W",450).
component("YFR028C",354).
component("YER075C",330).
component("YDL230W",245).
component("YBR276C",196).
component("U34_",96).
component("U33_",95).
component("U30_",94).
component("U28_",92).
...
component("U25_",90).
component("U24_",89).
component("YOR360C",726).
component("YGL248W",380).
component("YKR031C",536).
component("YPL206C",744).
component("YLR286C",571).
component("YJR153W",504).
component("YOR190W",706).
component("YLR300W",572).
component("YGR282C",416).
component("YDR261C",280).
component("YDR400W",293).
component("U23_",88).
component("YML035C",589).
component("YJL070C",466).
component("YBR284W",198).
component("U102_",20).
component("YNL045W",633).
component("YLR160C",562).
component("YLR158C",561).
component("YLR157C",560).
component("YLR155C",559).
component("YDR321W",288).
component("YGL037C",367).
component("YMR293C",625).
component("YDR242W",277).
component("YBR208C",188).
component("YMR281W",624).
component("U53_",106).
component("YPL111W",740).
component("YIR032C",460).
component("YIR029W",458).
component("YPR062W",766).
component("YMR120C",611).
component("YLR028C",548).
component("YHR144C",438).
component("YGR267C",415).
component("YNL141W",640).
component("YBR153W",184).
component("YDL238C",247).
component("YNL141W",641).
component("YLR245C",569).
component("YML035C",590).
component("YJL126W",470).
component("U44_",100).
component("YDL100C",225).
component("U87_",129).
component("YMR267W",622).
component("YBR011C",158).
component("YBR111C",176).
component("YCL030C",204).
component("YER005W",315).
component("YIL048W",445).
component("YER166W",341).
component("YDR093W",262).
component("YAL026C",141).
component("YLR231C",567).
component("U88_",130).
component("YLR134W",556).
component("YLR044C",549).
component("YGR087C",391).
component("YDR380W",291).
component("YDL080C",221).
component("U98_",137).
component("YMR250W",620).
component("YKL184W",527).
component("YNR043W",671).
component("U93_",135).
component("YDR047W",257).
component("U54_",107).
component("YKL211C",529) :- not remove_orf("YKL211C",529).
component("YOL052C",679).
component("YNL169C",644).
component("YGR170W",398).
component("YKL060C",513).
component("YNL256W",652).
component("YDR294C",283).
component("YEL046C",310).
component("YNR033W",669).
component("YKL211C",530) :- not remove_orf("YKL211C",530).
component("YER090W",530) :- not remove_orf("YER090W",530).
component("YER090W",334) :- not remove_orf("YER090W",334).
component("YDR127W",267).
component("YPL281C",759).
component("YOR393W",731).
component("YMR323W",630).
component("YHR174W",440).
component("YGR254W",413).
component("YPL262W",752).
component("YGL026C",366) :- not remove_orf("YGL026C",366).
component("YGR155W",397).
component("YLR304C",575).
component("YJL200C",481).
component("YNL316C",661).
component("YKL182W",525).
component("YPL212C",745).
component("YNL292W",659).
component("YGL063W",370).
component("YFL001W",344).
component("YOR278W",716).
component("YPR002W",761).
component("YDR127W",268).
component("YGL148W",374).
component("YER086W",331).
component("YLR359W",583).
component("YAL012W",139).
component("YFR055W",359).
component("YJL121C",469).
component("YBR019C",161).
component("YBR019C",162).
component("YDR050C",258).
component("YDR007W",248) :- not remove_orf("YDR007W",248).
component("YOR095C",697).
component("YER003C",314).
component("YBR196C",187).
component("YGL001C",361).
component("U14_",37).
component("YOL056W",681).
component("YKL152C",523).
component("YDL021W",213).
component("YMR105C",606).
component("YKL127W",517).
component("YEL058W",313).
component("YPR060C",765).
component("YHR072W",432).
component("YJL153C",476).
component("YPL097W",738).
component("YGR185C",403).
component("YHR011W",424).
component("YDR023W",251).
component("YPL104W",739).
component("YLL018C",542).
component("YPR081C",770).
component("YBR121C",178).
component("YHR020W",426).
component("YER087W",332).
component("YNL247W",648).
component("YOL033W",678).
component("YHR091C",434).
component("YDR341C",289).
component("YOL097C",687).
component("YDR268W",281).
component("YPR047W",764).
component("YLR060W",551).
component("YFL022C",348).
component("YPR033C",763).
component("YHR019C",425).
component("YPL160W",741).
component("YLR382C",584).
component("YNL073W",636).
component("YDR037W",253).
component("YOR335C",721).
component("YGR094W",393).
component("YOR142W",701).
component("YGR244C",411).
component("U89_",131).
component("YOR241W",715).
component("YMR113W",608).
component("YKL132C",518).
component("YJL101C",468).
component("U92_",134).
component("YGL234W",379).
component("U91_",133).
component("U90_",132).
component("YDL141W",232).
component("YDL141W",233).
component("YJR103W",493).
component("YBL039C",150).
component("YGR204W",407).
component("YBR084W",173).
component("YOL058W",682).
component("YBR208C",189).
component("YHR074W",433).
component("YMR217W",617).
component("YOR303W",717).
component("YJR109C",496).
component("YJL130C",472).
component("YGL062W",369).
component("YBR218C",190).
component("YPL231W",750).
component("YNR016C",667).
component("YKL182W",526).
component("YGR037C",387).
component("YOR005C",694).
component("YDL164C",236).
component("YOL010W",675).
component("YPR138C",773).
component("YPL274W",756).
component("YPL265W",753).
component("YPL057C",736).
component("YPL036W",735).
component("YOR348C",725).
component("YOR192C",707).
component("YOR171C",704).
component("YOR071C",696).
component("YOL156W",693).
component("YOL103W",688).
component("YOL020W",677) :- not remove_orf("YOL020W",677).
component("YNR056C",672).
component("YNL318C",662).
component("YNL268W",655).
component("YNL142W",642).
component("YMR272C",623).
component("YML123C",599).
component("YLR348C",580).
component("YLR260W",570).
component("YLR237W",568).
component("YLR138W",557).
component("YLR100C",554).
component("YLR081W",552).
component("YLL061W",545).
component("YLL043W",544).
component("YKR093W",540).
component("YKR053C",538).
component("YKR039W",537) :- not remove_orf("YKR039W",537).
component("YKL217W",532).
component("YKL004W",507).
component("YJR152W",503).
component("YJR095W",492).
component("YJR077C",490).
component("YJL219W",482).
component("YJL134W",473).
component("YJL129C",471).
component("YHL036W",420).
component("YGR121C",394).
component("YGR055W",389).
component("YGL186C",376).
component("YGL077C",372).
component("YGL008C",362).
component("YFL055W",351).
component("YFL011W",345).
component("YER060W-A",324).
component("YER060W",323).
component("YER056C",322).
component("YER053C",320).
component("YEL017C-A",309).
component("YDR536W",308).
component("YDR508C",304).
component("YDR503C",303).
component("YDR497C",302).
component("YDR297W",285).
component("YDR294C",284).
component("YDR046C",256) :- not remove_orf("YDR046C",256).
component("YDL210W",242).
component("YCR024C-A",209).
component("YCL025C",203).
component("YBR298C",200).
component("YBR291C",199).
component("YBR069C",172) :- not remove_orf("YBR069C",172).
component("YBR068C",171) :- not remove_orf("YBR068C",171).
component("YBR036C",168).
component("YBR021W",164).
component("YBL042C",151).
component("U79_",123).
component("U75_",121).
component("U74_",120).
component("U73_",119).
...
catalyst(6160,626).
catalyst(3870,321).
catalyst(3620,290) :- not remove_reaction(3620,290).
catalyst(2110,357).
catalyst(2190,357).
catalyst(5550,498).
catalyst(5791,566).
...
catalyst(1960,257).
catalyst(3460,107).
catalyst(3600,529) :- not remove_reaction(3600,529).
catalyst(3941,679).
catalyst(3942,679).
catalyst(6890,644).
catalyst(6900,398).
...
catalyst(4560,310).
catalyst(2550,669).
catalyst(1890,530) :- not remove_reaction(1890,530).
catalyst(3630,530) :- not remove_reaction(3630,530).
catalyst(1890,334) :- not remove_reaction(1890,334).
catalyst(3630,334) :- not remove_reaction(3630,334).
catalyst(3740,267).
catalyst(8231,759).
catalyst(8232,759).
catalyst(8231,731).
...
catalyst(8051,752).
catalyst(8052,752).
catalyst(3590,366) :- not remove_reaction(3590,366).
catalyst(10910,366) :- not remove_reaction(10910,366).
catalyst(4570,397).
catalyst(8181,575).
catalyst(8182,575).
catalyst(8181,481).
...
catalyst(8281,258).
catalyst(8282,258).
catalyst(3610,248) :- not remove_reaction(3610,248).
catalyst(7921,697).
catalyst(7922,697).
catalyst(7841,314).
catalyst(7842,314).
...
catalyst(640,540).
catalyst(6560,538).
catalyst(761,537) :- not remove_reaction(761,537).
catalyst(762,537) :- not remove_reaction(762,537).
catalyst(771,537) :- not remove_reaction(771,537).
catalyst(772,537) :- not remove_reaction(772,537).
catalyst(781,537) :- not remove_reaction(781,537).
catalyst(782,537) :- not remove_reaction(782,537).
catalyst(791,537) :- not remove_reaction(791,537).
catalyst(792,537) :- not remove_reaction(792,537).
catalyst(801,537) :- not remove_reaction(801,537).
catalyst(802,537) :- not remove_reaction(802,537).
catalyst(811,537) :- not remove_reaction(811,537).
catalyst(812,537) :- not remove_reaction(812,537).
catalyst(821,537) :- not remove_reaction(821,537).
catalyst(822,537) :- not remove_reaction(822,537).
catalyst(831,537) :- not remove_reaction(831,537).
catalyst(832,537) :- not remove_reaction(832,537).
catalyst(841,537) :- not remove_reaction(841,537).
catalyst(842,537) :- not remove_reaction(842,537).
catalyst(861,537) :- not remove_reaction(861,537).
catalyst(862,537) :- not remove_reaction(862,537).
catalyst(881,537) :- not remove_reaction(881,537).
catalyst(882,537) :- not remove_reaction(882,537).
catalyst(901,537) :- not remove_reaction(901,537).
catalyst(902,537) :- not remove_reaction(902,537).
catalyst(911,537) :- not remove_reaction(911,537).
catalyst(912,537) :- not remove_reaction(912,537).
catalyst(941,537) :- not remove_reaction(941,537).
catalyst(942,537) :- not remove_reaction(942,537).
catalyst(1191,537) :- not remove_reaction(1191,537).
catalyst(1192,537) :- not remove_reaction(1192,537).
catalyst(1021,532).
catalyst(1022,532).
catalyst(6610,507).
catalyst(170,503).
...
catalyst(861,256) :- not remove_reaction(861,256).
catalyst(862,256) :- not remove_reaction(862,256).
...
catalyst(1511,199).
catalyst(1512,199).
catalyst(771,172) :- not remove_reaction(771,172).
catalyst(772,172) :- not remove_reaction(772,172).
catalyst(791,172) :- not remove_reaction(791,172).
catalyst(792,172) :- not remove_reaction(792,172).
catalyst(801,172) :- not remove_reaction(801,172).
catalyst(802,172) :- not remove_reaction(802,172).
catalyst(811,172) :- not remove_reaction(811,172).
catalyst(812,172) :- not remove_reaction(812,172).
catalyst(861,172) :- not remove_reaction(861,172).
catalyst(862,172) :- not remove_reaction(862,172).
catalyst(901,172) :- not remove_reaction(901,172).
catalyst(902,172) :- not remove_reaction(902,172).
catalyst(791,171) :- not remove_reaction(791,171).
catalyst(792,171) :- not remove_reaction(792,171).
catalyst(801,171) :- not remove_reaction(801,171).
catalyst(802,171) :- not remove_reaction(802,171).
catalyst(811,171) :- not remove_reaction(811,171).
catalyst(812,171) :- not remove_reaction(812,171).
catalyst(831,171) :- not remove_reaction(831,171).
catalyst(832,171) :- not remove_reaction(832,171).
catalyst(841,171) :- not remove_reaction(841,171).
catalyst(842,171) :- not remove_reaction(842,171).
catalyst(861,171) :- not remove_reaction(861,171).
catalyst(862,171) :- not remove_reaction(862,171).
catalyst(901,171) :- not remove_reaction(901,171).
catalyst(902,171) :- not remove_reaction(902,171).
catalyst(6600,168).
catalyst(620,164).
catalyst(540,151).
catalyst(2830,123).
