...
component("YGR060W",252).
component("YGL012W",235).
component("YOL086C",432).
component("YMR303C",399).
component("YGL256W",246).
component("YDL168W",148).
component("YBR145W",114).
component("YPL231W",475).
component("YBR149W",115).
component("YGL001C",232).
component("YHR063C",275).
component("YML056C",378).
component("YLR432W",374).
component("YHR216W",283).
component("YAR075W",96).
component("YAR073W",95).
component("YDR127W",164).
component("YJR139C",323).
component("YKL029C",327).
component("YOR136W",442).
component("YDL066W",140).
component("YML086C",380).
component("YIL155C",291).
component("YPR191W",499).
component("YOR065W",437).
component("YJL166W",307).
component("YHR001W-A",272).
component("YGR183C",261).
component("YFR033C",228).
component("YDR529C",193).
component("YBL045C",100).
component("Q0105",18).
component("YGR088W",254).
component("YDR256C",176).
component("YJR078W",316).
component("YJR025C",311).
component("YBL098W",103).
component("YMR015C",384).
component("YDR402C",185).
component("YJR104C",319).
component("YHR008C",273).
component("YER070W",210).
component("U35_",59).
component("YDL168W",149).
component("YPL276W",483).
component("YPL275W",482).
component("YOR388C",464).
component("YGL154C",242).
component("U55_",66).
component("YOR323C",454).
component("YMR170C",392).
component("YMR169C",391).
component("U2_",56).
component("YBR166C",118).
component("YNL280C",417).
component("YER014W",202).
component("YMR118C",389).
component("YLR164W",359).
component("YLL041C",350).
component("YKL148C",334).
component("YJL045W",296).
component("YDR178W",171).
component("YJR051W",313).
component("YEL047C",197).
component("YOR375C",462).
component("YDL215C",151).
component("YAL062W",93).
component("U99_",89).
component("YBR035C",106).
component("YKR080W",347).
component("YER023W",203).
component("YOR236W",451).
component("YGR204W",262).
component("U62_",68).
component("YKL150W",335).
component("YIL043C",285).
component("YHR042W",274).
component("YPL017C",467).
component("YFL018C",220).
component("YPL273W",481).
component("YLL062C",352).
component("U47_",61).
component("YDL033C",138).
component("YOL096C",433).
component("YDR408C",187).
component("YKL024C",326).
component("YPR074C",492).
component("YBR117C",113).
component("YLR354C",373).
component("YGR043C",250).
component("YCL009C",129).
component("YMR062C",386).
component("YPL231W",476).
component("U86_",82).
component("YPL001W",466).
component("YOR377W",463).
component("YGR177C",260).
component("YPL231W",477).
component("YGR147C",257).
component("YDL040C",139).
component("YPL028W",468).
component("YPR001W",485).
component("YNR001C",421).
component("YDL182W",150).
component("YNL117W",407).
component("YIR031C",294).
component("YNL029C",402).
component("YIL085C",288).
component("YLR209C",360).
component("YMR300C",398).
component("YER055C",205).
component("YDR354W",181) :- not remove_orf("YDR354W",181).
component("YFR047C",229).
component("YJR133W",322).
component("YLR209C",361).
component("YML022W",375).
component("YDR441C",189).
component("YDR399W",183).
component("YNL256W",413).
component("YDR127W",165).
component("YLR303W",367).
component("YJR130C",321).
component("YLR303W",368).
component("YDR035W",156).
component("YBR249C",122).
component("YBR256C",123).
component("YHR137W",278).
component("YGL202W",244).
component("YLR027C",353).
component("YKL106W",330).
component("YKL104C",329).
component("YGR019W",248).
component("U64_",69).
component("U51_",63).
component("YJR148W",324).
component("YGL253W",245).
component("YFR053C",230).
component("YMR205C",394).
component("YGR240C",264).
component("YDR248C",175).
component("YCR036W",136).
component("YCL040W",131).
component("YJR105W",320).
component("U16_",34).
component("U15_",31).
component("U96_",87).
component("YKL001C",325).
component("YML070W",379).
component("YFL053W",223).
component("YHL032C",270).
component("U83_",80).
component("U82_",79).
component("YMR208W",395).
component("YOR347C",459).
component("YAL038W",92).
component("YPR121W",494).
component("YPL258C",479).
component("YOL055C",429).
component("U1_",43).
component("YNL267W",415).
component("YLR305C",370).
component("YFR019W",226).
component("YDR208W",172).
component("YDR127W",166).
component("U21_",49).
component("U20_",47).
component("YDR147W",169).
component("YDR300C",179).
component("YCR012W",133).
component("U18_",40).
component("U76_",77).
component("YER170W",218).
component("YDR226W",173).
component("YDR454C",190).
component("YOL061W",431).
component("YKL181W",337).
component("YHL011C",268).
component("YER099C",214).
component("YBL068W",102).
component("YOR143C",443).
component("YGR007W",247).
component("YLR328W",371).
component("YCL050C",132).
component("YPR190C",498).
component("YPR187W",497).
component("YPR110C",493).
component("YPR010C",487).
component("YOR341W",458).
component("YOR340C",457).
component("YOR224C",450).
component("YOR210W",449).
component("YOR207C",447).
component("YOR151C",444).
component("YOR116C",440).
component("YOL005C",426).
component("YNR003C",422).
component("YNL248C",412).
component("YNL151C",410).
component("YNL113W",406).
component("YKL144C",333).
component("YJR063W",314).
component("YJL148W",305).
component("YJL140W",304).
component("YIL021W",284).
component("YHR143W-A",279).
component("YGL070C",240).
component("YFL036W",222).
component("YDR404C",186).
component("YDR156W",170).
component("YDR045C",157).
component("YDL150W",146).
component("YDL140C",145).
component("YBR154C",117).
component("YPR175W",496).
component("YPL167C",472).
component("YOR330C",455).
component("YOL115W",435).
component("YNL299W",419).
component("YNL262W",414).
component("YNL102W",405).
component("YJR043C",312).
component("YJR006W",310).
component("YJL090C",299).
component("YIL139C",290).
component("YEL055C",198).
component("YDR419W",188).
component("YDR121W",163).
component("YDL102W",143).
component("YCR014C",134).
component("YBR278W",125).
component("YBL035C",98).
component("YKL035W",328).
component("YHL012W",269).
component("YER026C",204).
component("YDR058C",160).
component("YDL086W",142).
component("YOL011W",427).
component("YMR008C",383).
component("YMR006C",382).
component("U101_",19).
component("YBL015W",97).
component("YJL068C",297).
component("YPL072W",470).
component("YOR124C",441).
component("YNL186W",411).
component("YMR304W",400).
component("YMR223W",396).
component("YKR098C",348).
component("YJL197W",308).
component("YIL156W",292).
component("YFR010W",225).
component("YER151C",216).
component("YER144C",215).
component("YER098W",213).
component("YDR069C",161).
component("YDL122W",144).
component("YBR058C",107).
component("YBL067C",101).
component("U84_",81).
component("YPR073C",490).
component("YHR215W",282).
component("YDL024C",137).
component("YBR093C",111).
component("YBR092C",110).
component("YAR071W",94).
component("YIL053W",287).
component("YER062C",209).
component("YGR208W",263).
component("YPL228W",474).
component("YMR180C",393).
component("YDL236W",153).
component("YJL155C",306).
component("YPR073C",491).
component("YOR208W",448).
component("YNL053W",404).
component("YMR036C",385).
component("YIR026C",293).
component("YIL113W",289).
component("YFR028C",227).
component("YER075C",211).
component("YDL230W",152).
component("YBR276C",124).
component("U34_",58).
component("U30_",57).
component("U25_",55).
component("U24_",54).
component("YOR360C",461).
component("YKR031C",344).
component("YLR286C",365).
component("YOR190W",445).
component("YLR300W",366).
component("YGR282C",267).
component("YDR261C",177).
component("YDR400W",184).
component("U23_",53).
component("YML035C",376).
component("YJL070C",298).
component("YBR284W",126).
component("U102_",20).
component("YNL045W",403).
component("YGL037C",237).
component("YDR242W",174).
component("YBR208C",119).
component("U53_",64).
component("YIR032C",295).
component("YMR120C",390).
component("YHR144C",280).
component("YBR153W",116).
component("YDL238C",154).
component("YNL141W",408).
component("YLR245C",364).
component("YML035C",377).
component("YJL126W",301).
component("U87_",83).
component("YBR111C",112).
component("YER005W",201).
component("YIL048W",286).
component("YER166W",217).
component("YDR093W",162).
component("YAL026C",91).
component("YLR231C",362).
component("U88_",84).
component("YLR134W",357).
component("YLR044C",354).
component("YGR087C",253).
component("YDR380W",182).
component("YDL080C",141).
component("U98_",88).
component("YKL184W",340).
component("YNR043W",425).
component("U93_",86).
component("U54_",65).
component("YKL211C",341) :- not remove_orf("YKL211C",341).
component("YGR170W",259).
component("YDR294C",178).
component("YEL046C",196).
component("YNR033W",424).
component("YKL211C",342) :- not remove_orf("YKL211C",342).
component("YER090W",342) :- not remove_orf("YER090W",342).
component("YER090W",212) :- not remove_orf("YER090W",212).
component("YDR127W",167).
component("YPL281C",484).
component("YOR393W",465).
component("YMR323W",401).
component("YHR174W",281).
component("YGR254W",266).
component("YGL026C",236) :- not remove_orf("YGL026C",236).
component("YGR155W",258).
component("YLR304C",369).
component("YJL200C",309).
component("YNL316C",420).
component("YKL182W",338).
component("YPL212C",473).
component("YNL292W",418).
component("YGL063W",239).
component("YFL001W",219).
component("YPR002W",486).
component("YDR127W",168).
component("YGL148W",241).
component("YAL012W",90).
component("YFR055W",231).
component("YBR019C",104).
component("YDR050C",159).
component("YDR007W",155) :- not remove_orf("YDR007W",155).
component("YOR095C",439).
component("YER003C",200).
component("YGL001C",233).
component("YKL152C",336).
component("YMR105C",387).
component("YKL127W",331).
component("YEL058W",199).
component("YPR060C",489).
component("YPL104W",471).
component("YLL018C",349).
component("YHR091C",277).
component("YDR341C",180).
component("YOL097C",434).
component("YPR047W",488).
component("YLR060W",355).
component("YFL022C",221).
component("YOR335C",456).
component("YGR094W",255).
component("YGR244C",265).
component("U89_",85).
component("YOR241W",452).
component("YMR113W",388).
component("YKL132C",332).
component("YJL101C",300).
component("YJR103W",318).
component("YBL039C",99).
component("YOL058W",430).
component("YBR208C",120).
component("YHR074W",276).
component("YOR303W",453).
component("YGL062W",238).
component("YBR218C",121).
component("YPL231W",478).
component("YNR016C",423).
component("YKL182W",339).
component("YGR037C",249).
component("YOR005C",436).
component("YDL164C",147).
component("YPR138C",495).
component("YPL265W",480).
component("YPL036W",469).
component("YOR348C",460).
component("YOR192C",446).
component("YOR071C",438).
component("YOL020W",428) :- not remove_orf("YOL020W",428).
component("YNL268W",416).
component("YNL142W",409).
component("YMR272C",397).
component("YML123C",381).
component("YLR348C",372).
component("YLR237W",363).
component("YLR138W",358).
component("YLR100C",356).
component("YLL061W",351).
component("YKR053C",346).
component("YKR039W",345) :- not remove_orf("YKR039W",345).
component("YKL217W",343).
component("YJR095W",317).
component("YJR077C",315).
component("YJL134W",303).
component("YJL129C",302).
component("YHL036W",271).
component("YGR121C",256).
component("YGR055W",251).
component("YGL186C",243).
component("YGL008C",234).
component("YFL055W",224).
component("YER060W-A",208).
component("YER060W",207).
component("YER056C",206).
component("YEL017C-A",195).
component("YDR536W",194).
component("YDR508C",192).
component("YDR503C",191).
component("YDR046C",158) :- not remove_orf("YDR046C",158).
component("YCR024C-A",135).
component("YCL025C",130).
component("YBR298C",128).
component("YBR291C",127).
component("YBR069C",109) :- not remove_orf("YBR069C",109).
component("YBR068C",108) :- not remove_orf("YBR068C",108).
component("YBR021W",105).
component("U79_",78).
component("U75_",76).
component("U74_",75).
component("U73_",74).
...
catalyst(6160,398).
catalyst(3870,205).
catalyst(3620,181) :- not remove_reaction(3620,181).
catalyst(2190,229).
catalyst(5550,322).
catalyst(5791,361).
catalyst(5792,361).
...
catalyst(2300,86).
catalyst(3460,65).
catalyst(3600,341) :- not remove_reaction(3600,341).
catalyst(6900,259).
catalyst(8781,178).
catalyst(8782,178).
catalyst(4560,196).
...
catalyst(3630,212) :- not remove_reaction(3630,212).
catalyst(3740,167).
catalyst(8231,484).
catalyst(8232,484).
catalyst(8231,465).
...
catalyst(8231,266).
catalyst(8232,266).
catalyst(3590,236) :- not remove_reaction(3590,236).
catalyst(10910,236) :- not remove_reaction(10910,236).
catalyst(4570,258).
catalyst(8181,369).
catalyst(8182,369).
catalyst(8181,309).
...
catalyst(190,446).
catalyst(190,438).
catalyst(801,428) :- not remove_reaction(801,428).
catalyst(802,428) :- not remove_reaction(802,428).
catalyst(811,428) :- not remove_reaction(811,428).
catalyst(812,428) :- not remove_reaction(812,428).
catalyst(831,428) :- not remove_reaction(831,428).
catalyst(832,428) :- not remove_reaction(832,428).
catalyst(941,428) :- not remove_reaction(941,428).
catalyst(942,428) :- not remove_reaction(942,428).
catalyst(761,416).
catalyst(762,416).
catalyst(371,409).
catalyst(372,409).
...
catalyst(750,351).
catalyst(6560,346).
catalyst(761,345) :- not remove_reaction(761,345).
catalyst(762,345) :- not remove_reaction(762,345).
catalyst(771,345) :- not remove_reaction(771,345).
catalyst(772,345) :- not remove_reaction(772,345).
catalyst(781,345) :- not remove_reaction(781,345).
catalyst(782,345) :- not remove_reaction(782,345).
...
catalyst(861,345) :- not remove_reaction(861,345).
catalyst(862,345) :- not remove_reaction(862,345).
catalyst(881,345) :- not remove_reaction(881,345).
catalyst(882,345) :- not remove_reaction(882,345).
catalyst(941,345) :- not remove_reaction(941,345).
catalyst(942,345) :- not remove_reaction(942,345).
catalyst(1191,345) :- not remove_reaction(1191,345).
catalyst(1192,345) :- not remove_reaction(1192,345).
catalyst(1021,343).
catalyst(1022,343).
catalyst(1250,317).
catalyst(1581,315).
...
catalyst(1511,127).
catalyst(1512,127).
catalyst(771,109) :- not remove_reaction(771,109).
catalyst(772,109) :- not remove_reaction(772,109).
catalyst(791,109) :- not remove_reaction(791,109).
catalyst(792,109) :- not remove_reaction(792,109).
...
catalyst(861,109) :- not remove_reaction(861,109).
catalyst(862,109) :- not remove_reaction(862,109).
catalyst(791,108) :- not remove_reaction(791,108).
catalyst(792,108) :- not remove_reaction(792,108).
catalyst(801,108) :- not remove_reaction(801,108).
catalyst(802,108) :- not remove_reaction(802,108).
catalyst(811,108) :- not remove_reaction(811,108).
catalyst(812,108) :- not remove_reaction(812,108).
catalyst(831,108) :- not remove_reaction(831,108).
catalyst(832,108) :- not remove_reaction(832,108).
catalyst(841,108) :- not remove_reaction(841,108).
catalyst(842,108) :- not remove_reaction(842,108).
catalyst(861,108) :- not remove_reaction(861,108).
catalyst(862,108) :- not remove_reaction(862,108).
catalyst(620,105).
catalyst(2830,78).
catalyst(2920,76).
catalyst(2920,75).
