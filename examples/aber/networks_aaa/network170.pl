...
component("YNL280C",872).
component("YLR056W",734).
component("YGR060W",515).
component("YGL012W",480).
component("YKR009C",714).
component("YOL086C",907).
component("YMR303C",838).
component("YMR083W",807).
component("YGL256W",507).
component("YDL168W",319).
component("YBR145W",241).
component("YPL231W",993).
component("YBR265W",260).
component("U46_",137).
component("YBR149W",242).
component("YBR149W",243).
component("YJR159W",678).
component("YGL001C",477).
component("YIL094C",599).
component("YHR063C",569).
component("U45_",136).
component("YBR153W",244).
component("YML056C",788).
component("YLR432W",777).
component("YHR216W",589).
component("YAR075W",197).
component("YAR073W",196).
component("YCL030C",270).
component("YDR127W",357).
component("YJR139C",672).
component("YML075C",791).
component("YLR450W",780).
component("YOL126C",913).
component("YKL085W",688).
component("YDL078C",299).
component("YKL029C",683).
component("YOR136W",930).
component("YNL037C",843).
component("YDL066W",297).
component("YHR183W",584).
component("YGR256W",545).
component("YNL241C",862).
component("YOL059W",904).
component("YDL022W",290).
component("YLR355C",772).
component("YIL074C",597).
component("YER081W",443).
component("YML054C",787).
component("YDL174C",322).
component("YML086C",792).
component("YIL155C",607).
component("YPR191W",1034).
component("YOR065W",920).
component("YJL166W",643).
component("YHR001W-A",557).
component("YGR183C",532).
component("YFR033C",473).
component("YDR529C",407).
component("YBL045C",204).
component("Q0105",18).
component("YGR088W",518).
component("YDR256C",374).
component("YKL026C",682).
component("YIR037W",621).
component("YBR244W",256).
component("YJR078W",663).
component("U58_",149).
component("YJR025C",655).
component("U107_",26).
component("YGR255C",544).
component("U108_",27).
component("YBL098W",208).
component("YMR015C",803).
component("YHR007C",558).
component("YDR402C",395).
component("YGL055W",487).
component("YGR175C",529).
component("YJR104C",666).
component("YHR008C",559).
component("YJL026W",624).
component("YIL066C",596).
component("YGR180C",531).
component("YER070W",440).
component("U38_",129).
component("U36_",128).
component("U35_",127).
component("YDL168W",320).
component("YDR158W",365).
component("YBR006W",212).
component("YPL276W",1005).
component("YPL275W",1004).
component("YOR388C",968).
component("YOR374W",965).
component("YER073W",441).
component("U68_",156).
component("YGL154C",496).
component("YBR115C",235).
component("U55_",146).
component("YER069W",438).
component("YOR323C",955).
component("YMR170C",818).
component("YMR169C",817).
component("U2_",121).
component("YER178W",457).
component("YBR221C",254).
component("YIL125W",604).
component("U52_",143).
component("YBR166C",247).
component("YNL280C",873).
component("YGL012W",481).
component("YKL182W",702).
component("U57_",148).
component("YKL216W",711).
component("YDR044W",340).
component("YER014W",423).
component("YKR009C",715).
component("YIL160C",609).
component("YGL205W",501).
component("YMR118C",812).
component("YLR164W",749).
component("YLL041C",726).
component("YKL148C",696).
component("YKL141W",694).
component("YJL045W",625).
component("YDR178W",367).
component("YJR051W",658).
component("YEL047C",417).
component("YDL171C",321).
component("YDL215C",326).
component("YOR375C",966).
component("YDL215C",327).
component("YAL062W",193).
component("U99_",187).
component("YBR035C",222).
component("YMR189W",820).
component("U56_",147).
component("YNR050C",888).
component("YHR037W",565).
component("YKR080W",719).
component("YER023W",425).
component("YPL023C",972).
component("YGL125W",493).
component("YOR236W",947).
component("YGR204W",536).
component("YLR142W",743).
component("U63_",153).
component("U62_",152).
component("YOR356W",963).
component("YHR068W",570).
component("YKL150W",697).
component("YIL043C",593).
component("YHR042W",566).
component("YOR221C",944).
component("YML120C",796).
component("YKL192C",706).
component("YKL055C",685).
component("YER061C",434).
component("YBR046C",225).
component("YMR145C",815).
component("YML120C",797).
component("YKL192C",707).
component("YDL085W",301).
component("YGR234W",539).
component("YFR030W",472).
component("YPL017C",971).
component("YFL018C",462).
component("YPL091W",977).
component("YDR353W",389).
component("YER042W",427).
component("YPR167C",1028).
component("YJR137C",671).
component("YNL052W",845).
component("YMR256C",829).
component("YLR395C",776).
component("YLR038C",732).
component("YIL111W",601).
component("YHR051W",568).
component("YGL191W",499).
component("YGL187C",498).
component("YDL067C",298).
component("Q0275",20).
component("Q0250",19).
component("YPL266W",1000).
component("YML110C",795).
component("YBR034C",221).
component("YPL273W",1002).
component("YLL062C",729).
component("YDR410C",398).
component("YOL096C",908).
component("U47_",138).
component("YER091C",448).
component("YJR073C",661).
component("YGR157W",526).
component("YDR120C",355).
component("YML008C",781).
component("YDL033C",292).
component("YOL096C",909).
component("YLR172C",750).
component("YDR019C",336).
component("YBR176W",248).
component("YDR408C",397).
component("YMR120C",813).
component("YBL013W",198).
component("YJL130C",635).
component("YKL024C",681).
component("YPR074C",1020).
component("YBR117C",236).
component("YLR354C",771).
component("YGR043C",513).
component("YMR108W",810).
component("YCL009C",268).
component("YMR062C",806).
component("YNL071W",847).
component("YNR008W",880).
component("YIL160C",610).
component("YNL277W",871).
component("YDR232W",370).
component("YFL017C",461).
component("YPL231W",994).
component("YER061C",435).
component("U86_",175).
component("YPL001W",970).
component("YMR296C",836).
component("YDR062W",348).
component("YDL052C",295).
component("U8_",179).
component("YDR148C",363).
component("YOR377W",967).
component("YGR177C",530).
component("YPL231W",995).
component("YGR147C",524).
component("YDL040C",293).
component("YPL028W",973).
component("YLR195C",751).
component("YGL017W",482).
component("YPR001W",1007).
component("YNR001C",878).
component("YCR005C",279).
component("YNL104C",850).
component("YDL182W",323).
component("YDL131W",310).
component("YNL117W",852).
component("YIR031C",619).
component("YOR321W",954).
component("YJR143C",673).
component("YGR199W",535).
component("YDR307W",383).
component("YDL095W",305).
component("YDL093W",304).
component("YAL023C",190).
component("YOR103C",924).
component("YOR085W",922).
component("YMR149W",816).
component("YML019W",783).
component("YJL002C",622).
component("YEL002C",411).
component("YDL232W",329).
component("YCL043C",274).
component("YNL029C",842).
component("YIL085C",598).
component("YMR261C",830).
component("YML100W",793).
component("YBR126C",240).
component("YNL192W",860).
component("YBR038W",224).
component("YBR023C",220).
component("YMR306W",840).
component("YLR342W",769).
component("YGR032W",511).
component("YPR183W",1031).
component("YLR209C",752).
component("U104_",24).
component("U103_",23).
component("YMR271C",832).
component("YML106W",794).
component("YOR209C",942).
component("YMR300C",837).
component("YER055C",430).
component("YDR354W",390) :- not remove_orf("YDR354W",390).
component("YFR047C",474).
component("YJR133W",670).
component("YLR209C",753).
component("YML022W",784).
component("YDR441C",401).
component("YDR399W",393).
component("YPR176C",1030).
component("YPL172C",985).
component("YNR041C",886).
component("YMR101C",808).
component("YDL090C",303).
component("YBR003W",211).
component("YBR002C",210).
component("YJL167W",644).
component("YJL167W",645).
component("YNL256W",865).
component("YPR069C",1017).
component("YDR127W",358).
component("YLR146C",744).
component("YLR303W",760).
component("YGR012W",509).
component("YJR130C",669).
component("YLR303W",761).
component("YDR035W",338).
component("YBR249C",257).
component("YOR274W",950).
component("YOL143C",916).
component("YBR256C",259).
component("YHR137W",579).
component("YGL202W",500).
component("YLR027C",730).
component("YKL106W",690).
component("YOL140W",915).
component("YLR438W",779).
component("YKL104C",689).
component("YGR019W",510).
component("YLR089C",738).
component("YDR111C",354).
component("U64_",154).
component("U61_",151).
component("U51_",142).
component("YJR148W",674).
component("YHR208W",587).
component("YFL030W",464).
component("YOR184W",936).
component("YNR058W",891).
component("YIL116W",603).
component("YGL253W",506).
component("YFR053C",475).
component("YOL136C",914).
component("YIL107C",600).
component("YMR013C",802).
component("YMR205C",822).
component("YGR240C",540).
component("YDR248C",373).
component("YCR036W",285).
component("YGR194C",534).
component("YCL040W",273).
component("YJR105W",667).
component("U16_",69).
component("U15_",61).
component("YPL188W",987).
component("YJR049C",657).
component("YEL041W",415).
component("U96_",185).
component("YKL001C",679).
component("YDR236C",371).
component("YML070W",790).
component("YFL053W",466).
component("YHL032C",555).
component("YLR133W",740).
component("YDR531W",409).
component("U83_",172).
component("U82_",171).
component("U81_",170).
component("YMR208W",823).
component("YPL203W",988).
component("YOR061W",919).
component("YKL166C",699).
component("YJL164C",642).
component("YIL035C",592).
component("YHR205W",586).
component("YHR102W",577).
component("YGL019W",483).
component("YHR025W",564).
component("YOR347C",961).
component("YAL038W",192).
component("YNR012W",881).
component("YPR121W",1025).
component("YPL258C",997).
component("YOL055C",900).
component("YPL214C",991).
component("U1_",94).
component("YDR009W",335).
component("YBR020W",218).
component("YNL267W",869).
component("YLR305C",763).
component("YFR019W",469).
component("YDR208W",368).
component("YDR127W",359).
component("U21_",107).
component("U20_",102).
component("YDR147W",362).
component("YDR300C",382).
component("YCR012W",280).
component("YER052C",428).
component("YER069W",439).
component("U19_",93).
component("U18_",85).
component("U17_",78).
component("U76_",165).
component("YMR220W",825).
component("YER170W",456).
component("YDR226W",369).
component("YKL067W",687).
component("YOL055C",901).
component("YDR454C",402).
component("YJR057W",659).
component("YOL061W",905).
component("YKL181W",701).
component("YHL011C",552).
component("YER099C",450).
component("YBL068W",207).
component("YOR143C",932).
component("YNL256W",866).
component("YLR328W",767).
component("YBR018C",214).
component("YBR018C",215).
component("YGR007W",508).
component("YLR328W",768).
component("YKR002W",713).
component("U80_",169).
component("YDL103C",308).
component("U94_",184).
component("YJR010W",653).
component("YCL050C",275).
component("YGL130W",494).
component("YDR530C",408).
component("YCL050C",276).
component("YPR190C",1033).
component("YPR187W",1032).
component("YPR110C",1023).
component("YPR010C",1010).
component("YOR341W",960).
component("YOR340C",959).
component("YOR224C",946).
component("YOR210W",943).
component("YOR207C",940).
component("YOR151C",933).
component("YOR116C",925).
component("YOL005C",893).
component("YNR003C",879).
component("YNL248C",864).
component("YNL151C",857).
component("YNL113W",851).
component("YKL144C",695).
component("YJR063W",660).
component("YJL148W",639).
component("YJL140W",638).
component("YIL021W",591).
component("YHR143W-A",580).
component("YGL070C",491).
component("YFL036W",465).
component("YDR404C",396).
component("YDR156W",364).
component("YDR045C",341).
component("YDL150W",317).
component("YDL140C",312).
component("YBR154C",246).
component("YPR175W",1029).
component("YPL167C",984).
component("YOR330C",956).
component("YOL115W",912).
component("YNL299W",875).
component("YNL262W",868).
component("YNL102W",849).
component("YJR043C",656).
component("YJR006W",652).
component("YJL090C",629).
component("YIL139C",606).
component("YEL055C",418).
component("YDR419W",399).
component("YDR121W",356).
component("YDL102W",307).
component("YCR014C",281).
component("YBR278W",262).
component("YBL035C",201).
component("YKL035W",684).
component("YHL012W",553).
component("YHR123W",578).
component("YPR113W",1024).
component("YBR243C",255).
component("YNL130C",853).
component("YDL142C",316).
component("YPL148C",982).
component("YER026C",426).
component("YCL004W",267).
component("YOR251C",949).
component("YGR286C",549).
component("YJL068C",626).
component("YDR058C",346).
component("YNR034W",885).
component("YHR163W",582).
component("YGR248W",542).
component("YCR073W-A",287).
component("YDL086W",302).
component("YOL011W",895).
component("YMR008C",800).
component("YMR006C",799).
component("U105_",25).
component("U101_",21).
component("YBL015W",199).
component("YJL068C",627).
component("YPL072W",976).
component("YOR124C",926).
component("YNL186W",859).
component("YMR304W",839).
component("YMR223W",826).
component("YKR098C",723).
component("YJL197W",646).
component("YIL156W",608).
component("YFR010W",468).
component("YER151C",454).
component("YER144C",453).
component("YER098W",449).
component("YDR069C",349).
component("YDL122W",309).
component("YBR058C",226).
component("YBL067C",206).
component("YDR272W",377).
component("U84_",173).
component("YDR481C",403).
component("YLR377C",774).
component("YDR074W",350).
component("YFR025C",470).
component("YPL179W",986).
component("YNR032W",883).
component("YML057W",789).
component("YML016C",782).
component("YLR433C",778).
component("YGR123C",521).
component("YER133W",452).
component("YER089C",446).
component("YDR436W",400).
component("YDR075W",351).
component("YDL188C",324).
component("YDL134C",311).
component("YDL047W",294).
component("YDL006W",288).
component("YBR125C",239).
component("YBL056W",205).
component("YPR073C",1018).
component("YHR215W",588).
component("YDL024C",291).
component("YBR093C",233).
component("YBR092C",232).
component("YAR071W",195).
component("YIL053W",595).
component("YER062C",436).
component("YHR046C",567).
component("U9_",188).
component("YGR208W",538).
component("YPL228W",992).
component("YMR180C",819).
component("YDL236W",330).
component("YJL155C",641).
component("YPR073C",1019).
component("YOR208W",941).
component("YNL053W",846).
component("YMR036C",805).
component("YIR026C",615).
component("YIL113W",602).
component("YFR028C",471).
component("YER075C",442).
component("YDL230W",328).
...
component("U25_",118).
component("U24_",117).
component("YOL064C",906).
component("YPL268W",1001).
component("YOR360C",964).
component("YGL248W",505).
component("YKR031C",716).
component("YPL206C",989).
component("YGL027C",485).
component("YLR286C",758).
component("YJR153W",676).
component("YJL221C",651).
component("YJL216C",649).
component("YIL172C",614).
component("YGR292W",551).
component("YGR287C",550).
component("YBR299W",266).
component("YBR184W",249).
component("YIL162W",611).
component("YPR026W",1011).
component("YDR001C",333).
component("YBR001C",209).
component("YOR190W",938).
component("YLR300W",759).
component("YGR282C",548).
component("YDR261C",375).
component("YDR400W",394).
component("U23_",116).
component("YML035C",785).
component("YJL070C",628).
component("YBR284W",263).
component("U102_",22).
component("YNL045W",844).
component("YLR160C",748).
component("YLR158C",747).
component("YLR157C",746).
component("YLR155C",745).
component("YDR321W",384).
component("YGL037C",486).
component("U43_",134).
component("U42_",133).
component("YMR293C",835).
component("YDR242W",372).
component("YLR308W",766).
component("YLR307W",765).
component("YBR208C",251).
component("YMR281W",834).
component("U53_",144).
component("YIR027C",616).
component("YPL111W",980).
component("YIR032C",620).
component("YIR029W",618).
component("YPR062W",1016).
component("YMR120C",814).
component("YLR028C",731).
component("YHR144C",581).
component("YGR267C",547).
component("YCL030C",271).
component("YNL141W",854).
component("YBL033C",200).
component("YBR153W",245).
component("YDL238C",331).
component("YNL141W",855).
component("YLR245C",756).
component("YML035C",786).
component("YBR084W",230).
component("YJL126W",633).
component("U44_",135).
component("YDL100C",306).
component("U87_",176).
component("U40_",131).
component("YMR267W",831).
component("YBR011C",213).
component("YHR201C",585).
component("YBR111C",234).
component("YBR252W",258).
component("YCL030C",272).
component("YPR080W",1021).
component("YOR187W",937).
component("YOR133W",929).
component("YLR069C",736).
component("YKR084C",720).
component("YKL173W",700).
component("YJL102W",631).
component("YDR385W",392).
component("YBR118W",237).
component("YER005W",422).
component("YLL001W",724).
component("YIL048W",594).
component("YER166W",455).
component("YDR093W",353).
component("YAL026C",191).
component("YLR231C",754).
component("U88_",177).
component("YLR134W",741).
component("YLR044C",733).
component("YGR087C",517).
component("YDR380W",391).
component("YDL080C",300).
component("U98_",186).
component("YMR250W",828).
component("YKL184W",705).
component("YOR128C",927).
component("YEL021W",414).
component("YNR043W",887).
component("U93_",183).
component("YDR047W",343).
component("U54_",145).
component("YKL211C",709) :- not remove_orf("YKL211C",709).
component("YKR097W",722).
component("YOL052C",899).
component("YNL169C",858).
component("YGR170W",527).
component("YKL060C",686).
component("YNL256W",867).
component("YDR294C",379).
component("YEL046C",416).
component("YNR033W",884).
component("YPR006C",1009).
component("YER065C",437).
component("YKL211C",710) :- not remove_orf("YKL211C",710).
component("YER090W",710) :- not remove_orf("YER090W",710).
component("YER090W",447) :- not remove_orf("YER090W",447).
component("YDR127W",360).
component("YPL281C",1006).
component("YOR393W",969).
component("YMR323W",841).
component("YHR174W",583).
component("YGR254W",543).
component("YPL262W",998).
component("YGL026C",484) :- not remove_orf("YGL026C",484).
component("YGR155W",525).
component("YLR304C",762).
component("YJL200C",647).
component("YNL316C",876).
component("YKL182W",703).
component("YPL212C",990).
component("YNL292W",874).
component("YGL063W",490).
component("YFL001W",459).
component("YOR278W",951).
component("YPR002W",1008).
component("U49_",139).
component("YJR016C",654).
component("YCR053W",286).
component("YDR127W",361).
component("YGL148W",495).
component("YIL168W",613).
component("YIL167W",612).
component("YCL064C",277).
component("YER086W",444).
component("YCL064C",278).
component("YLR359W",773).
component("YAL012W",189).
component("YFR055W",476).
component("YJL005W",623).
component("YOR176W",935).
component("YJL121C",632).
component("YBR019C",216).
component("YBR019C",217).
component("YDR050C",344).
component("YDR007W",334) :- not remove_orf("YDR007W",334).
component("YOR095C",923).
component("YER003C",421).
component("YBR196C",250).
component("YGL001C",478).
component("U14_",53).
component("YOL056W",902).
component("YKL152C",698).
component("YDL021W",289).
component("YMR105C",809).
component("YKL127W",692).
component("YEL058W",419).
component("YPR060C",1015).
component("YHR072W",571).
component("YJL153C",640).
component("YPL097W",978).
component("YGR185C",533).
component("YGR264C",546).
component("YGR171C",528).
component("YHR011W",560).
component("YDR023W",337).
component("YPL104W",979).
component("YLL018C",725).
component("YPR081C",1022).
component("YBR121C",238).
component("YHR020W",563).
component("YER087W",445).
component("YNL247W",863).
component("YOL033W",897).
component("YGL245W",504).
component("YHR091C",573).
component("YDR341C",385).
component("YOL097C",910).
component("YDR268W",376).
component("YPR047W",1014).
component("YLR060W",735).
component("YFL022C",463).
component("YPR033C",1012).
component("YHR019C",561).
component("YCR024C",282).
component("YHR019C",562).
component("YPL160W",983).
component("YLR382C",775).
component("YNL073W",848).
component("YDR037W",339).
component("YOR335C",957).
component("YGR094W",519).
component("YOR317W",953).
component("YMR246W",827).
component("YIL009W",590).
component("YER015W",424).
component("YOR142W",931).
component("YGR244C",541).
component("YPR035W",1013).
component("U89_",178).
component("YOR241W",948).
component("YMR113W",811).
component("YKL132C",693).
component("YOR339C",958).
component("YMR022W",804).
component("YLR306W",764).
component("YKL210W",708).
component("YGR133W",523).
component("YGL058W",488).
component("YER100W",451).
component("YEL012W",412).
component("YDR177W",366).
component("YDR092W",352).
component("YDR059C",347).
component("YDR054C",345).
component("YDL064W",296).
component("YBR082C",229).
component("YJL101C",630).
component("YOL049W",898).
component("U92_",182).
component("YAR015W",194).
component("YGL234W",502).
component("YER183C",458).
component("U91_",181).
component("U90_",180).
component("YNR057C",890).
component("YDL141W",313).
component("YDL141W",314).
component("YGL234W",503).
component("YDL141W",315).
component("YJR103W",665).
component("YBL039C",202).
component("YGR204W",537).
component("YBR084W",231).
component("YNL220W",861).
component("YOL058W",903).
component("YBR208C",252).
component("YHR074W",572).
component("YMR217W",824).
component("YGR061C",516).
component("YPR145W",1027).
component("YGR124W",522).
component("YOR303W",952).
component("YJR109C",668).
component("YJL130C",636).
component("YGL062W",489).
component("YBR218C",253).
component("YPL231W",996).
component("YNR016C",882).
component("YKL182W",704).
component("YGR037C",512).
component("YOR005C",918).
component("YDL164C",318).
component("YOL010W",894).
component("YPR138C",1026).
component("YPL274W",1003).
component("YPL265W",999).
component("YPL134C",981).
component("YPL057C",975).
component("YPL036W",974).
component("YOR348C",962).
component("YOR222W",945).
component("YOR192C",939).
component("YOR171C",934).
component("YOR130C",928).
component("YOR071C",921).
component("YOL156W",917).
component("YOL103W",911).
component("YOL020W",896) :- not remove_orf("YOL020W",896).
component("YNR072W",892).
component("YNR056C",889).
component("YNL318C",877).
component("YNL268W",870).
component("YNL142W",856).
component("YMR272C",833).
component("YMR202W",821).
component("YMR011W",801).
component("YML123C",798).
component("YLR348C",770).
component("YLR260W",757).
component("YLR237W",755).
component("YLR138W",742).
component("YLR100C",739).
component("YLR081W",737).
component("YLL061W",728).
component("YLL043W",727).
component("YKR093W",721).
component("YKR053C",718).
component("YKR039W",717) :- not remove_orf("YKR039W",717).
component("YKL217W",712).
component("YKL120W",691).
component("YKL004W",680).
component("YJR158W",677).
component("YJR152W",675).
component("YJR095W",664).
component("YJR077C",662).
component("YJL219W",650).
component("YJL214W",648).
component("YJL134W",637).
component("YJL129C",634).
component("YIR028W",617).
component("YIL134W",605).
component("YHR096C",576).
component("YHR094C",575).
component("YHR092C",574).
component("YHL036W",556).
component("YHL016C",554).
component("YGR121C",520).
component("YGR055W",514).
component("YGL186C",497).
component("YGL077C",492).
component("YGL008C",479).
component("YFL055W",467).
component("YFL011W",460).
component("YER060W-A",433).
component("YER060W",432).
component("YER056C",431).
component("YER053C",429).
component("YEL069C",420).
component("YEL017C-A",413).
component("YDR536W",410).
component("YDR508C",406).
component("YDR503C",405).
component("YDR497C",404).
component("YDR345C",388).
component("YDR343C",387).
component("YDR342C",386).
component("YDR297W",381).
component("YDR294C",380).
component("YDR284C",378).
component("YDR046C",342) :- not remove_orf("YDR046C",342).
component("YDL245C",332).
component("YDL210W",325).
component("YCR032W",284).
component("YCR024C-A",283).
component("YCL025C",269).
component("YBR298C",265).
component("YBR291C",264).
component("YBR069C",228) :- not remove_orf("YBR069C",228).
component("YBR068C",227) :- not remove_orf("YBR068C",227).
component("YBR036C",223).
component("YBR021W",219).
component("YBL042C",203).
component("U85_",174).
component("U7_",168).
component("U79_",167).
component("U78_",166).
...
catalyst(6160,837).
catalyst(3870,430).
catalyst(3620,390) :- not remove_reaction(3620,390).
catalyst(2110,474).
catalyst(2190,474).
catalyst(5550,670).
catalyst(5791,753).
...
catalyst(1960,343).
catalyst(3460,145).
catalyst(3600,709) :- not remove_reaction(3600,709).
catalyst(8000,722).
catalyst(3941,899).
catalyst(3942,899).
catalyst(6890,858).
...
catalyst(8020,1009).
catalyst(8020,437).
catalyst(1890,710) :- not remove_reaction(1890,710).
catalyst(3630,710) :- not remove_reaction(3630,710).
catalyst(1890,447) :- not remove_reaction(1890,447).
catalyst(3630,447) :- not remove_reaction(3630,447).
catalyst(3740,360).
catalyst(8231,1006).
catalyst(8232,1006).
catalyst(8231,969).
...
catalyst(8051,998).
catalyst(8052,998).
catalyst(3590,484) :- not remove_reaction(3590,484).
catalyst(10910,484) :- not remove_reaction(10910,484).
catalyst(4570,525).
catalyst(8181,762).
catalyst(8182,762).
catalyst(8181,647).
...
catalyst(8281,344).
catalyst(8282,344).
catalyst(3610,334) :- not remove_reaction(3610,334).
catalyst(7921,923).
catalyst(7922,923).
catalyst(7841,421).
catalyst(7842,421).
...
catalyst(1210,917).
catalyst(1160,911).
catalyst(801,896) :- not remove_reaction(801,896).
catalyst(802,896) :- not remove_reaction(802,896).
catalyst(811,896) :- not remove_reaction(811,896).
catalyst(812,896) :- not remove_reaction(812,896).
catalyst(831,896) :- not remove_reaction(831,896).
catalyst(832,896) :- not remove_reaction(832,896).
catalyst(901,896) :- not remove_reaction(901,896).
catalyst(902,896) :- not remove_reaction(902,896).
catalyst(941,896) :- not remove_reaction(941,896).
catalyst(942,896) :- not remove_reaction(942,896).
catalyst(1170,892).
catalyst(1180,892).
catalyst(1210,892).
catalyst(700,889).
...
catalyst(650,721).
catalyst(6560,718).
catalyst(761,717) :- not remove_reaction(761,717).
catalyst(762,717) :- not remove_reaction(762,717).
catalyst(771,717) :- not remove_reaction(771,717).
catalyst(772,717) :- not remove_reaction(772,717).
catalyst(781,717) :- not remove_reaction(781,717).
catalyst(782,717) :- not remove_reaction(782,717).
catalyst(791,717) :- not remove_reaction(791,717).
catalyst(792,717) :- not remove_reaction(792,717).
catalyst(801,717) :- not remove_reaction(801,717).
catalyst(802,717) :- not remove_reaction(802,717).
catalyst(811,717) :- not remove_reaction(811,717).
catalyst(812,717) :- not remove_reaction(812,717).
catalyst(821,717) :- not remove_reaction(821,717).
catalyst(822,717) :- not remove_reaction(822,717).
catalyst(831,717) :- not remove_reaction(831,717).
catalyst(832,717) :- not remove_reaction(832,717).
catalyst(841,717) :- not remove_reaction(841,717).
catalyst(842,717) :- not remove_reaction(842,717).
catalyst(861,717) :- not remove_reaction(861,717).
catalyst(862,717) :- not remove_reaction(862,717).
catalyst(881,717) :- not remove_reaction(881,717).
catalyst(882,717) :- not remove_reaction(882,717).
catalyst(901,717) :- not remove_reaction(901,717).
catalyst(902,717) :- not remove_reaction(902,717).
catalyst(911,717) :- not remove_reaction(911,717).
catalyst(912,717) :- not remove_reaction(912,717).
catalyst(921,717) :- not remove_reaction(921,717).
catalyst(922,717) :- not remove_reaction(922,717).
catalyst(941,717) :- not remove_reaction(941,717).
catalyst(942,717) :- not remove_reaction(942,717).
catalyst(1191,717) :- not remove_reaction(1191,717).
catalyst(1192,717) :- not remove_reaction(1192,717).
catalyst(390,712).
catalyst(1021,712).
catalyst(1022,712).
catalyst(1521,691).
...
catalyst(6550,380).
catalyst(6690,378).
catalyst(791,342) :- not remove_reaction(791,342).
catalyst(792,342) :- not remove_reaction(792,342).
catalyst(801,342) :- not remove_reaction(801,342).
catalyst(802,342) :- not remove_reaction(802,342).
catalyst(811,342) :- not remove_reaction(811,342).
catalyst(812,342) :- not remove_reaction(812,342).
catalyst(831,342) :- not remove_reaction(831,342).
catalyst(832,342) :- not remove_reaction(832,342).
catalyst(841,342) :- not remove_reaction(841,342).
catalyst(842,342) :- not remove_reaction(842,342).
catalyst(861,342) :- not remove_reaction(861,342).
catalyst(862,342) :- not remove_reaction(862,342).
catalyst(901,342) :- not remove_reaction(901,342).
catalyst(902,342) :- not remove_reaction(902,342).
catalyst(1170,332).
catalyst(1180,332).
catalyst(1210,332).
catalyst(690,325).
...
catalyst(1511,264).
catalyst(1512,264).
catalyst(771,228) :- not remove_reaction(771,228).
catalyst(772,228) :- not remove_reaction(772,228).
...
catalyst(861,228) :- not remove_reaction(861,228).
catalyst(862,228) :- not remove_reaction(862,228).
catalyst(901,228) :- not remove_reaction(901,228).
catalyst(902,228) :- not remove_reaction(902,228).
catalyst(791,227) :- not remove_reaction(791,227).
catalyst(792,227) :- not remove_reaction(792,227).
catalyst(801,227) :- not remove_reaction(801,227).
catalyst(802,227) :- not remove_reaction(802,227).
catalyst(811,227) :- not remove_reaction(811,227).
catalyst(812,227) :- not remove_reaction(812,227).
catalyst(831,227) :- not remove_reaction(831,227).
catalyst(832,227) :- not remove_reaction(832,227).
catalyst(841,227) :- not remove_reaction(841,227).
catalyst(842,227) :- not remove_reaction(842,227).
catalyst(861,227) :- not remove_reaction(861,227).
catalyst(862,227) :- not remove_reaction(862,227).
catalyst(901,227) :- not remove_reaction(901,227).
catalyst(902,227) :- not remove_reaction(902,227).
catalyst(6600,223).
catalyst(620,219).
catalyst(540,203).
catalyst(2660,174).
...
modifiable_enzyme(390).
modifiable_enzyme(709).
modifiable_enzyme(710).
modifiable_enzyme(447).
modifiable_enzyme(484).
modifiable_enzyme(334).
modifiable_enzyme(896).
modifiable_enzyme(717).
modifiable_enzyme(342).
modifiable_enzyme(228).
modifiable_enzyme(227).
