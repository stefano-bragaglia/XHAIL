...
component("YGL012W",82).
component("YGL001C",81).
component("YDR127W",57).
component("YJR139C",110).
component("YOR136W",145).
component("YIL155C",97).
component("YJR078W",107).
component("YJR025C",104).
component("YMR015C",126).
component("YGL154C",86).
component("YMR170C",128).
component("YMR169C",127).
component("YBR166C",40).
component("YER014W",73).
component("YEL047C",72).
component("YOR375C",154).
component("YAL062W",30).
component("U62_",26).
component("YPR074C",163).
component("YBR117C",38).
component("YPL231W",157).
component("YLR209C",120).
component("YDR354W",66) :- not remove_orf("YDR354W",66).
component("YFR047C",79).
component("YJR133W",109).
component("YDR127W",58).
component("YJR130C",108).
component("YDR035W",53).
component("YBR249C",41).
component("YBR256C",42).
component("YHR137W",92).
component("YLR027C",119).
component("YKL106W",112).
component("YGL253W",87).
component("YFR053C",80).
component("YCR036W",46).
component("YKL001C",111).
component("U83_",28).
component("YNL267W",136).
component("YLR305C",124).
component("YFR019W",78).
component("YDR208W",63).
component("YDR127W",59).
component("U20_",21).
component("YDR300C",65).
component("U76_",27).
component("YDR454C",68).
component("YOL061W",141).
component("YKL181W",114).
component("YHL011C",91).
component("YER099C",75).
component("YBL068W",31).
component("YOR143C",146).
component("YPR190C",167).
component("YPR187W",166).
component("YPR110C",164).
component("YPR010C",160).
component("YOR341W",153).
component("YOR340C",152).
component("YOR224C",150).
component("YOR210W",149).
component("YOR207C",148).
component("YOR151C",147).
component("YOR116C",144).
component("YOL005C",139).
component("YNR003C",138).
component("YNL248C",135).
component("YNL151C",134).
component("YNL113W",132).
component("YKL144C",113).
component("YJR063W",105).
component("YJL148W",102).
component("YJL140W",101).
component("YIL021W",96).
component("YHR143W-A",93).
component("YGL070C",84).
component("YFL036W",76).
component("YDR404C",67).
component("YDR156W",62).
component("YDR045C",54).
component("YDL150W",49).
component("YDL140C",48).
component("YBR154C",39).
component("YDR058C",56).
component("U84_",29).
component("YPR073C",162).
component("YHR215W",95).
component("YDL024C",47).
component("YBR093C",36).
component("YBR092C",35).
component("YPL228W",156).
component("YMR180C",129).
component("YDL236W",50).
component("YJL155C",103).
component("U30_",23).
component("YLR286C",123).
component("YML035C",125).
component("YJL070C",98).
component("YBR284W",43).
component("YNL045W",131).
component("U53_",24).
component("YDL238C",51).
component("YLR245C",122).
component("YJL126W",99).
component("YBR111C",37).
component("YLR231C",121).
component("U54_",25).
component("YKL211C",115) :- not remove_orf("YKL211C",115).
component("YDR294C",64).
component("YKL211C",116) :- not remove_orf("YKL211C",116).
component("YER090W",116) :- not remove_orf("YER090W",116).
component("YER090W",74) :- not remove_orf("YER090W",74).
component("YDR127W",60).
component("YPL281C",159).
component("YOR393W",155).
component("YMR323W",130).
component("YHR174W",94).
component("YGR254W",90).
component("YGL026C",83) :- not remove_orf("YGL026C",83).
component("YNL316C",137).
component("YDR127W",61).
component("YGL148W",85).
component("YDR007W",52) :- not remove_orf("YDR007W",52).
component("YOR095C",143).
component("YPR060C",161).
component("YOL097C",142).
component("YOR335C",151).
component("YGR094W",88).
component("YPR138C",165).
component("YPL265W",158).
component("YOL020W",140) :- not remove_orf("YOL020W",140).
component("YNL142W",133).
component("YKR053C",118).
component("YKR039W",117) :- not remove_orf("YKR039W",117).
component("YJR077C",106).
component("YJL134W",100).
component("YGR121C",89).
component("YFL055W",77).
component("YDR536W",71).
component("YDR508C",70).
component("YDR503C",69).
component("YDR046C",55) :- not remove_orf("YDR046C",55).
component("YCL025C",45).
component("YBR291C",44).
component("YBR069C",34) :- not remove_orf("YBR069C",34).
component("YBR068C",33) :- not remove_orf("YBR068C",33).
component("YBR021W",32).
component("U228_",22).
component("U206_",20).
component("U202_",19).
component("U168_",18).
...
catalyst(3500,121).
catalyst(3460,25).
catalyst(3600,115) :- not remove_reaction(3600,115).
catalyst(8781,64).
catalyst(8782,64).
catalyst(3630,116) :- not remove_reaction(3630,116).
catalyst(3630,74) :- not remove_reaction(3630,74).
catalyst(3740,60).
catalyst(8231,159).
catalyst(8232,159).
catalyst(8231,155).
...
catalyst(8231,90).
catalyst(8232,90).
catalyst(3590,83) :- not remove_reaction(3590,83).
catalyst(10910,83) :- not remove_reaction(10910,83).
catalyst(3680,137).
catalyst(3750,61).
catalyst(3700,85).
catalyst(3610,52) :- not remove_reaction(3610,52).
catalyst(7921,143).
catalyst(7922,143).
catalyst(3690,161).
catalyst(8671,142).
...
catalyst(372,133).
catalyst(6560,118).
catalyst(781,117) :- not remove_reaction(781,117).
catalyst(782,117) :- not remove_reaction(782,117).
...
catalyst(881,117) :- not remove_reaction(881,117).
catalyst(882,117) :- not remove_reaction(882,117).
catalyst(1191,117) :- not remove_reaction(1191,117).
catalyst(1192,117) :- not remove_reaction(1192,117).
catalyst(1581,106).
catalyst(1582,106).
catalyst(6560,100).
catalyst(371,89).
