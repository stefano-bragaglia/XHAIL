...
component("YGR060W",503).
component("YGL012W",468).
component("YKR009C",696).
component("YOL086C",888).
component("YMR303C",819).
component("YMR083W",788).
component("YGL256W",495).
...
component("YKL148C",678).
component("YKL141W",676).
component("YJL045W",608).
component("YDR178W",356).
component("YJR051W",640).
component("YEL047C",406).
component("YDL171C",312).
component("YDL215C",317).
component("YOR375C",946).
...
component("U56_",142).
component("YNR050C",869).
component("YHR037W",551).
component("YKR080W",701).
component("YER023W",414).
component("YPL023C",952).
component("YGL125W",481).
component("YOR236W",927).
component("YGR204W",523).
component("YLR142W",725).
component("U63_",148).
component("U62_",147).
component("YOR356W",943).
component("YKL150W",679).
component("YIL043C",577).
component("YHR042W",552).
component("YOR221C",924).
component("YML120C",777).
component("YKL192C",688).
component("YKL055C",667).
...
component("YGR234W",526).
component("YFR030W",460).
component("YPL017C",951).
component("YFL018C",450).
component("YPL091W",957).
component("YDR353W",378).
component("YER042W",416).
component("YPR167C",1007).
component("YJR137C",653).
component("YNL052W",826).
component("YMR256C",810).
component("YLR395C",758).
component("YLR038C",714).
component("YIL111W",585).
component("YHR051W",554).
component("YGL191W",487).
component("YGL187C",486).
component("YDL067C",289).
component("Q0275",20).
component("Q0250",19).
component("YPL266W",980).
component("YML110C",776).
component("YBR034C",215).
component("YPL273W",982).
component("YLL062C",711).
component("YDR410C",387).
component("U47_",133).
component("YER091C",436).
component("YJR073C",643).
component("YDR120C",344).
component("YML008C",762).
...
component("YLR354C",753).
component("YGR043C",501).
component("YMR108W",791).
component("YCL009C",262).
component("YMR062C",787).
component("YNL071W",828).
component("YNR008W",861).
component("YIL160C",594).
component("YNL277W",852).
component("YDR232W",359).
component("YFL017C",449).
component("YPL231W",974).
component("YER061C",424).
component("U86_",170).
component("YPL001W",950).
component("YMR296C",817).
component("YDR062W",338).
component("YDL052C",286).
component("U8_",174).
component("YDR148C",352).
component("YOR377W",947).
component("YGR177C",517).
component("YPL231W",975).
component("YGR147C",512).
component("YDL040C",284).
component("YPL028W",953).
component("YLR195C",733).
component("YGL017W",470).
component("YPR001W",987).
component("YNR001C",859).
component("YCR005C",270).
component("YNL104C",831).
component("YDL182W",314).
component("YDL131W",301).
component("YNL117W",833).
component("YIR031C",602).
component("YOR321W",934).
component("YJR143C",655).
component("YGR199W",522).
component("YDR307W",372).
component("YDL095W",296).
component("YDL093W",295).
component("YAL023C",185).
component("YOR103C",904).
component("YOR085W",902).
component("YMR149W",797).
component("YML019W",764).
component("YJL002C",605).
component("YEL002C",400).
component("YDL232W",320).
component("YCL043C",267).
component("YNL029C",823).
component("YIL085C",582).
component("YMR261C",811).
component("YML100W",774).
component("YBR126C",234).
component("YNL192W",841).
component("YBR038W",218).
component("YBR023C",214).
component("YMR306W",821).
component("YLR342W",751).
component("YGR032W",499).
component("YPR183W",1010).
component("YLR209C",734).
component("U104_",23).
component("YMR271C",813).
component("YML106W",775).
component("YOR209C",922).
component("YMR300C",818).
component("YER055C",419).
component("YDR354W",379) :- not remove_orf("YDR354W",379).
component("YFR047C",462).
component("YJR133W",652).
component("YLR209C",735).
component("YML022W",765).
component("YDR441C",390).
component("YDR399W",382).
component("YPR176C",1009).
component("YPL172C",965).
component("YNR041C",867).
component("YMR101C",789).
component("YDL090C",294).
component("YBR003W",205).
component("YBR002C",204).
component("YJL167W",626).
component("YJL167W",627).
component("YNL256W",846).
component("YPR069C",996).
component("YDR127W",347).
component("YLR146C",726).
component("YLR303W",742).
component("YGR012W",497).
component("YJR130C",651).
...
component("YLR027C",712).
component("YKL106W",672).
component("YOL140W",895).
component("YKL104C",671).
component("YGR019W",498).
component("YLR089C",720).
component("U64_",149).
component("U61_",146).
component("U51_",137).
component("YJR148W",656).
component("YHR208W",571).
component("YFL030W",452).
component("YOR184W",916).
component("YNR058W",872).
component("YIL116W",587).
component("YGL253W",494).
component("YFR053C",463).
component("YOL136C",894).
component("YIL107C",584).
component("YMR013C",783).
component("YMR205C",803).
component("YGR240C",527).
component("YDR248C",362).
component("YCR036W",276).
component("YGR194C",521).
component("YCL040W",266).
component("YJR105W",649).
component("U16_",66).
component("U15_",58).
component("YPL188W",967).
component("YJR049C",639).
component("YEL041W",404).
component("U96_",180).
component("YKL001C",661).
component("YDR236C",360).
component("YML070W",771).
component("YFL053W",454).
component("YHL032C",541).
component("YLR133W",722).
...
component("YPR190C",1012).
component("YPR187W",1011).
component("YPR110C",1002).
component("YPR010C",990).
component("YOR341W",940).
component("YOR340C",939).
component("YOR224C",926).
component("YOR210W",923).
component("YOR207C",920).
component("YOR151C",913).
component("YOR116C",905).
component("YOL005C",874).
component("YNR003C",860).
component("YNL248C",845).
component("YNL151C",838).
component("YNL113W",832).
component("YKL144C",677).
...
component("YHR046C",553).
component("U9_",183).
component("YGR208W",525).
component("YPL228W",972).
component("YMR180C",800).
component("YDL236W",321).
component("YJL155C",623).
component("YPR073C",998).
component("YOR208W",921).
component("YNL053W",827).
component("YMR036C",786).
component("YIR026C",598).
component("YIL113W",586).
...
component("U25_",115).
component("U24_",114).
component("YOL064C",887).
component("YPL268W",981).
component("YOR360C",944).
component("YGL248W",493).
component("YKR031C",698).
component("YPL206C",969).
component("YGL027C",473).
component("YLR286C",740).
component("YJR153W",658).
component("YJL221C",633).
component("YJL216C",631).
component("YIL172C",597).
component("YGR292W",537).
component("YGR287C",536).
component("YBR299W",260).
component("YBR184W",243).
component("YIL162W",595).
component("YOR190W",918).
component("YLR300W",741).
component("YGR282C",534).
component("YDR261C",364).
component("YDR400W",383).
component("U23_",113).
component("YML035C",766).
component("YJL070C",611).
...
component("YKL184W",687).
component("YOR128C",907).
...
component("YOL052C",880).
component("YNL169C",839).
component("YGR170W",514).
component("YKL060C",668).
component("YNL256W",848).
component("YDR294C",368).
component("YEL046C",405).
component("YNR033W",865).
component("YPR006C",989).
...
component("YPL160W",963).
component("YLR382C",757).
component("YNL073W",829).
component("YDR037W",329).
component("YOR335C",937).
component("YGR094W",507).
component("YOR317W",933).
component("YMR246W",808).
component("YIL009W",574).
component("YER015W",413).
component("YOR142W",911).
component("YGR244C",528).
component("YPR035W",992).
component("U89_",173).
component("YOR241W",928).
component("YMR113W",792).
component("YKL132C",675).
component("YOR339C",938).
component("YMR022W",785).
component("YLR306W",746).
component("YKL210W",690).
component("YGR133W",511).
component("YGL058W",476).
component("YER100W",439).
component("YEL012W",401).
component("YDR177W",355).
component("YDR092W",342).
component("YDR059C",337).
component("YDR054C",335).
component("YDL064W",287).
component("YBR082C",223).
component("YJL101C",613).
component("YOL049W",879).
component("U92_",177).
component("YAR015W",189).
component("YGL234W",490).
component("YER183C",446).
component("U91_",176).
component("U90_",175).
component("YNR057C",871).
...
component("YNL220W",842).
component("YOL058W",884).
component("YBR208C",246).
component("YHR074W",557).
component("YMR217W",805).
component("YGR061C",504).
component("YPR145W",1006).
component("YGR124W",510).
component("YOR303W",932).
component("YJR109C",650).
component("YJL130C",618).
component("YGL062W",477).
component("YBR218C",247).
component("YPL231W",976).
component("YNR016C",863).
component("YKL182W",686).
component("YGR037C",500).
component("YOR005C",898).
component("YDL164C",309).
component("YOL010W",875).
component("YPR138C",1005).
component("YPL274W",983).
component("YPL265W",979).
component("YPL134C",961).
component("YPL057C",955).
component("YPL036W",954).
component("YOR348C",942).
component("YOR222W",925).
component("YOR192C",919).
component("YOR171C",914).
component("YOR130C",908).
component("YOR071C",901).
component("YOL156W",897).
component("YOL103W",891).
component("YOL020W",877) :- not remove_orf("YOL020W",877).
component("YNR072W",873).
component("YNR056C",870).
component("YNL318C",858).
component("YNL268W",851).
component("YNL142W",837).
component("YMR272C",814).
component("YMR202W",802).
component("YMR011W",782).
component("YML123C",779).
component("YLR348C",752).
component("YLR260W",739).
component("YLR237W",737).
component("YLR138W",724).
component("YLR100C",721).
component("YLR081W",719).
component("YLL061W",710).
component("YLL043W",709).
component("YKR093W",703).
component("YKR053C",700).
component("YKR039W",699) :- not remove_orf("YKR039W",699).
component("YKL217W",694).
component("YKL120W",673).
component("YKL004W",662).
component("YJR158W",659).
component("YJR152W",657).
component("YJR095W",646).
component("YJR077C",644).
component("YJL219W",632).
component("YJL214W",630).
component("YJL134W",619).
component("YJL129C",617).
component("YIR028W",600).
component("YIL134W",589).
component("YHR096C",561).
component("YHR094C",560).
component("YHR092C",559).
component("YHL036W",542).
component("YHL016C",540).
component("YGR121C",508).
component("YGR055W",502).
component("YGL186C",485).
component("YGL077C",480).
component("YGL008C",467).
component("YFL055W",455).
component("YFL011W",448).
component("YER060W-A",422).
component("YER060W",421).
component("YER056C",420).
component("YER053C",418).
...
catalyst(1210,897).
catalyst(1160,891).
catalyst(801,877) :- not remove_reaction(801,877).
catalyst(802,877) :- not remove_reaction(802,877).
catalyst(811,877) :- not remove_reaction(811,877).
catalyst(812,877) :- not remove_reaction(812,877).
catalyst(831,877) :- not remove_reaction(831,877).
catalyst(832,877) :- not remove_reaction(832,877).
catalyst(901,877) :- not remove_reaction(901,877).
catalyst(902,877) :- not remove_reaction(902,877).
catalyst(941,877) :- not remove_reaction(941,877).
catalyst(942,877) :- not remove_reaction(942,877).
catalyst(1170,873).
catalyst(1180,873).
catalyst(1210,873).
catalyst(700,870).
...
catalyst(650,703).
catalyst(6560,700).
catalyst(761,699) :- not remove_reaction(761,699).
catalyst(762,699) :- not remove_reaction(762,699).
catalyst(771,699) :- not remove_reaction(771,699).
catalyst(772,699) :- not remove_reaction(772,699).
catalyst(781,699) :- not remove_reaction(781,699).
catalyst(782,699) :- not remove_reaction(782,699).
catalyst(791,699) :- not remove_reaction(791,699).
catalyst(792,699) :- not remove_reaction(792,699).
catalyst(801,699) :- not remove_reaction(801,699).
catalyst(802,699) :- not remove_reaction(802,699).
catalyst(811,699) :- not remove_reaction(811,699).
catalyst(812,699) :- not remove_reaction(812,699).
catalyst(821,699) :- not remove_reaction(821,699).
catalyst(822,699) :- not remove_reaction(822,699).
catalyst(831,699) :- not remove_reaction(831,699).
catalyst(832,699) :- not remove_reaction(832,699).
catalyst(841,699) :- not remove_reaction(841,699).
catalyst(842,699) :- not remove_reaction(842,699).
catalyst(861,699) :- not remove_reaction(861,699).
catalyst(862,699) :- not remove_reaction(862,699).
catalyst(881,699) :- not remove_reaction(881,699).
catalyst(882,699) :- not remove_reaction(882,699).
catalyst(901,699) :- not remove_reaction(901,699).
catalyst(902,699) :- not remove_reaction(902,699).
catalyst(911,699) :- not remove_reaction(911,699).
catalyst(912,699) :- not remove_reaction(912,699).
catalyst(921,699) :- not remove_reaction(921,699).
catalyst(922,699) :- not remove_reaction(922,699).
catalyst(941,699) :- not remove_reaction(941,699).
catalyst(942,699) :- not remove_reaction(942,699).
catalyst(1191,699) :- not remove_reaction(1191,699).
catalyst(1192,699) :- not remove_reaction(1192,699).
catalyst(390,694).
catalyst(1021,694).
catalyst(1022,694).
catalyst(1521,673).
