...
component("YNL280C",656).
component("YLR056W",549).
component("YGR060W",389).
component("YGL012W",362).
component("YKR009C",533).
component("YOL086C",684).
component("YMR303C",626).
component("YMR083W",604).
component("YGL256W",381).
component("YDL168W",236).
component("YBR145W",180).
component("YPL231W",746).
component("U46_",101).
component("YBR149W",181).
component("YJR159W",504).
component("YGL001C",359).
component("YIL094C",447).
component("YHR063C",430).
component("YBR153W",182).
component("YML056C",591).
component("YLR432W",584).
component("YHR216W",441).
component("YAR075W",145).
component("YAR073W",144).
component("YDR127W",263).
component("YJR139C",499).
component("YOL126C",689).
component("YDL078C",219).
component("YKL029C",509).
component("YOR136W",699).
component("YNL037C",631).
component("YDL066W",218).
component("YNL241C",646).
component("YOL059W",682).
component("YDL022W",213).
component("YLR355C",581).
component("YML054C",590).
component("YDL174C",238).
component("YML086C",594).
component("YIL155C",453).
component("YPR191W",776).
component("YOR065W",694).
component("YJL166W",477).
component("YHR001W-A",420).
component("YGR183C",401).
component("YFR033C",355).
component("YDR529C",304).
component("YBL045C",151).
component("Q0105",18).
component("YGR088W",391).
component("YDR256C",278).
component("YKL026C",508).
component("YIR037W",460).
component("YBR244W",192).
component("YJR078W",490).
component("YJR025C",484).
component("YGR255C",413).
component("U108_",22).
component("YBL098W",155).
component("YMR015C",601).
component("YHR007C",421).
component("YDR402C",293).
component("YGL055W",367).
component("YGR175C",398).
component("YJR104C",493).
component("YHR008C",422).
component("YJL026W",461).
component("YGR180C",400).
component("YER070W",327).
component("U35_",97).
component("YDL168W",237).
component("YDR158W",271).
component("YBR006W",156).
component("YPL276W",757).
component("YPL275W",756).
component("YOR388C",729).
component("YOR374W",726).
component("YER073W",328).
component("YGL154C",374).
component("U55_",108).
component("YOR323C",718).
component("YMR170C",612).
component("YMR169C",611).
component("U2_",93).
component("YER178W",342).
component("YBR221C",190).
component("YIL125W",451).
component("U52_",105).
component("YBR166C",185).
component("YNL280C",657).
component("YGL012W",363).
component("U57_",109).
component("YKL216W",530).
component("YDR044W",253).
component("YER014W",315).
component("YKR009C",534).
component("YIL160C",455).
component("YGL205W",377).
component("YMR118C",608).
component("YLR164W",562).
component("YLL041C",542).
component("YKL148C",520).
component("YKL141W",518).
component("YJL045W",462).
component("YDR178W",272).
component("YJR051W",486).
component("YEL047C",310).
component("YDL215C",242).
component("YOR375C",727).
component("YDL215C",243).
component("YAL062W",142).
component("U99_",137).
component("YBR035C",166).
component("YHR037W",427).
component("YKR080W",538).
component("YER023W",316).
component("YOR236W",713).
component("YGR204W",405).
component("YLR142W",557).
component("U62_",112).
component("YKL150W",521).
component("YIL043C",443).
component("YHR042W",428).
component("YOR221C",711).
component("YML120C",597).
component("YKL192C",527).
component("YKL055C",511).
component("YER061C",324).
component("YGR234W",408).
component("YFR030W",354).
component("YPL017C",732).
component("YFL018C",346).
component("YER042W",318).
component("YJR137C",498).
component("YPL266W",753).
component("YML110C",596).
component("YBR034C",165).
component("YPL273W",754).
component("YLL062C",545).
component("YDR410C",296).
component("U47_",102).
component("YER091C",334).
component("YJR073C",488).
component("YDL033C",215).
component("YOL096C",685).
component("YLR172C",563).
component("YDR019C",249).
component("YDR408C",295).
component("YMR120C",609).
component("YBL013W",146).
component("YKL024C",507).
component("YPR074C",768).
component("YBR117C",176).
component("YLR354C",580).
component("YGR043C",387).
component("YMR108W",606).
component("YCL009C",201).
component("YMR062C",603).
component("YNL071W",634).
component("YNR008W",664).
component("YNL277W",655).
component("YFL017C",345).
component("YPL231W",747).
component("YER061C",325).
component("U86_",127).
component("YPL001W",731).
component("YDR148C",269).
component("YOR377W",728).
component("YGR177C",399).
component("YPL231W",748).
component("YGR147C",395).
component("YDL040C",216).
component("YPL028W",733).
component("YGL017W",364).
component("YPR001W",759).
component("YNR001C",662).
component("YDL182W",239).
component("YDL131W",228).
component("YNL117W",638).
component("YIR031C",458).
component("YOR321W",717).
component("YJR143C",500).
component("YGR199W",404).
component("YDR307W",286).
component("YDL095W",223).
component("YDL093W",222).
component("YAL023C",139).
component("YNL029C",630).
component("YIL085C",446).
component("YMR261C",620).
component("YML100W",595).
component("YBR126C",179).
component("YNL192W",645).
component("YBR038W",168).
component("YBR023C",164).
component("YMR306W",628).
component("YLR342W",578).
component("YGR032W",385).
component("YLR209C",564).
component("U104_",21).
component("YOR209C",709).
component("YMR300C",625).
component("YER055C",320).
component("YDR354W",289) :- not remove_orf("YDR354W",289).
component("YFR047C",356).
component("YJR133W",497).
component("YLR209C",565).
component("YML022W",587).
component("YDR441C",299).
component("YDR399W",291).
component("YJL167W",478).
component("YNL256W",649).
component("YDR127W",264).
component("YLR303W",572).
component("YGR012W",383).
component("YJR130C",496).
component("YLR303W",573).
component("YDR035W",251).
component("YBR249C",193).
component("YOL143C",691).
component("YBR256C",194).
component("YHR137W",435).
component("YGL202W",376).
component("YLR027C",546).
component("YKL106W",515).
component("YKL104C",514).
component("YGR019W",384).
component("YLR089C",552).
component("U64_",113).
component("U61_",111).
component("U51_",104).
component("YJR148W",501).
component("YOR184W",704).
component("YNR058W",672).
component("YIL116W",450).
component("YGL253W",380).
component("YFR053C",357).
component("YOL136C",690).
component("YIL107C",448).
component("YMR205C",614).
component("YGR240C",409).
component("YDR248C",277).
component("YCR036W",209).
component("YGR194C",403).
component("YCL040W",204).
component("YJR105W",494).
component("U16_",49).
component("U15_",44).
component("U96_",135).
component("YKL001C",505).
component("YDR236C",275).
component("YML070W",593).
component("YFL053W",349).
component("YHL032C",418).
component("YLR133W",554).
component("YDR531W",306).
component("U83_",125).
component("U82_",124).
component("U81_",123).
component("YMR208W",615).
component("YHR025W",426).
component("YOR347C",723).
component("YAL038W",141).
component("YNR012W",665).
component("YPR121W",771).
component("YPL258C",750).
component("YOL055C",679).
component("U1_",72).
component("YDR009W",248).
component("YBR020W",162).
component("YNL267W",653).
component("YLR305C",575).
component("YFR019W",352).
component("YDR208W",273).
component("YDR127W",265).
component("U21_",82).
component("U20_",79).
component("YDR147W",268).
component("YDR300C",285).
component("YCR012W",206).
component("U18_",64).
component("U17_",57).
component("U76_",121).
component("YMR220W",617).
component("YER170W",341).
component("YDR226W",274).
component("YKL067W",513).
component("YDR454C",300).
component("YOL061W",683).
component("YKL181W",523).
component("YHL011C",416).
component("YER099C",336).
component("YBL068W",154).
component("YOR143C",701).
component("YNL256W",650).
component("YLR328W",576).
component("YBR018C",158).
component("YBR018C",159).
component("YGR007W",382).
component("YLR328W",577).
component("YKR002W",532).
component("YDL103C",226).
component("YJR010W",483).
component("YGL130W",372).
component("YDR530C",305).
component("YCL050C",205).
component("YPR190C",775).
component("YPR187W",774).
component("YPR110C",770).
component("YPR010C",761).
component("YOR341W",722).
component("YOR340C",721).
component("YOR224C",712).
component("YOR210W",710).
component("YOR207C",707).
component("YOR151C",702).
component("YOR116C",697).
component("YOL005C",673).
component("YNR003C",663).
component("YNL248C",648).
component("YNL151C",642).
component("YNL113W",637).
component("YKL144C",519).
component("YJR063W",487).
component("YJL148W",474).
component("YJL140W",473).
component("YIL021W",442).
component("YHR143W-A",436).
component("YGL070C",370).
component("YFL036W",348).
component("YDR404C",294).
component("YDR156W",270).
component("YDR045C",254).
component("YDL150W",234).
component("YDL140C",230).
component("YBR154C",184).
component("YPR175W",773).
component("YPL167C",741).
component("YOR330C",719).
component("YOL115W",688).
component("YNL299W",659).
component("YNL262W",652).
component("YNL102W",636).
component("YJR043C",485).
component("YJR006W",482).
component("YJL090C",466).
component("YIL139C",452).
component("YEL055C",311).
component("YDR419W",297).
component("YDR121W",262).
component("YDL102W",225).
component("YCR014C",207).
component("YBR278W",196).
component("YBL035C",148).
component("YKL035W",510).
component("YHL012W",417).
component("YHR123W",434).
component("YBR243C",191).
component("YDL142C",233).
component("YER026C",317).
component("YCL004W",200).
component("YJL068C",463).
component("YDR058C",258).
component("YNR034W",669).
component("YHR163W",438).
component("YGR248W",411).
component("YCR073W-A",210).
component("YDL086W",221).
component("YOL011W",675).
component("YMR008C",600).
component("YMR006C",599).
component("U101_",19).
component("YBL015W",147).
component("YJL068C",464).
component("YPL072W",736).
component("YOR124C",698).
component("YNL186W",644).
component("YMR304W",627).
component("YMR223W",618).
component("YKR098C",540).
component("YJL197W",479).
component("YIL156W",454).
component("YFR010W",351).
component("YER151C",339).
component("YER144C",338).
component("YER098W",335).
component("YDR069C",259).
component("YDL122W",227).
component("YBR058C",169).
component("YBL067C",153).
component("YDR272W",281).
component("U84_",126).
component("YPL179W",742).
component("YNR032W",667).
component("YML057W",592).
component("YML016C",586).
component("YLR433C",585).
component("YGR123C",394).
component("YER133W",337).
component("YER089C",332).
component("YDR436W",298).
component("YDR075W",260).
component("YDL188C",240).
component("YDL134C",229).
component("YDL047W",217).
component("YDL006W",211).
component("YBR125C",178).
component("YBL056W",152).
component("YPR073C",766).
component("YHR215W",440).
component("YDL024C",214).
component("YBR093C",174).
component("YBR092C",173).
component("YAR071W",143).
component("YIL053W",445).
component("YER062C",326).
component("YHR046C",429).
component("YGR208W",407).
component("YPL228W",745).
component("YMR180C",613).
component("YDL236W",245).
component("YJL155C",476).
component("YPR073C",767).
component("YOR208W",708).
component("YNL053W",633).
component("YMR036C",602).
component("YIR026C",456).
component("YIL113W",449).
component("YFR028C",353).
component("YER075C",329).
component("YDL230W",244).
component("YBR276C",195).
component("U34_",96).
component("U33_",95).
component("U30_",94).
component("U28_",92).
...
component("U25_",90).
component("U24_",89).
component("YOR360C",725).
component("YGL248W",379).
component("YKR031C",535).
component("YPL206C",743).
component("YLR286C",570).
component("YJR153W",503).
component("YOR190W",705).
component("YLR300W",571).
component("YGR282C",415).
component("YDR261C",279).
component("YDR400W",292).
component("U23_",88).
component("YML035C",588).
component("YJL070C",465).
component("YBR284W",197).
component("U102_",20).
component("YNL045W",632).
component("YLR160C",561).
component("YLR158C",560).
component("YLR157C",559).
component("YLR155C",558).
component("YDR321W",287).
component("YGL037C",366).
component("YMR293C",624).
component("YDR242W",276).
component("YBR208C",187).
component("YMR281W",623).
component("U53_",106).
component("YPL111W",739).
component("YIR032C",459).
component("YIR029W",457).
component("YPR062W",765).
component("YMR120C",610).
component("YLR028C",547).
component("YHR144C",437).
component("YGR267C",414).
component("YNL141W",639).
component("YBR153W",183).
component("YDL238C",246).
component("YNL141W",640).
component("YLR245C",568).
component("YML035C",589).
component("YJL126W",469).
component("U44_",100).
component("YDL100C",224).
component("U87_",128).
component("YMR267W",621).
component("YBR011C",157).
component("YBR111C",175).
component("YCL030C",203).
component("YER005W",314).
component("YIL048W",444).
component("YER166W",340).
component("YDR093W",261).
component("YAL026C",140).
component("YLR231C",566).
component("U88_",129).
component("YLR134W",555).
component("YLR044C",548).
component("YGR087C",390).
component("YDR380W",290).
component("YDL080C",220).
component("U98_",136).
component("YMR250W",619).
component("YKL184W",526).
component("YNR043W",670).
component("U93_",134).
component("YDR047W",256).
component("U54_",107).
component("YKL211C",528) :- not remove_orf("YKL211C",528).
component("YOL052C",678).
component("YNL169C",643).
component("YGR170W",397).
component("YKL060C",512).
component("YNL256W",651).
component("YDR294C",282).
component("YEL046C",309).
component("YNR033W",668).
component("YKL211C",529) :- not remove_orf("YKL211C",529).
component("YER090W",529) :- not remove_orf("YER090W",529).
component("YER090W",333) :- not remove_orf("YER090W",333).
component("YDR127W",266).
component("YPL281C",758).
component("YOR393W",730).
component("YMR323W",629).
component("YHR174W",439).
component("YGR254W",412).
component("YPL262W",751).
component("YGL026C",365) :- not remove_orf("YGL026C",365).
component("YGR155W",396).
component("YLR304C",574).
component("YJL200C",480).
component("YNL316C",660).
component("YKL182W",524).
component("YPL212C",744).
component("YNL292W",658).
component("YGL063W",369).
component("YFL001W",343).
component("YOR278W",715).
component("YPR002W",760).
component("YDR127W",267).
component("YGL148W",373).
component("YER086W",330).
component("YLR359W",582).
component("YAL012W",138).
component("YFR055W",358).
component("YJL121C",468).
component("YBR019C",160).
component("YBR019C",161).
component("YDR050C",257).
component("YDR007W",247) :- not remove_orf("YDR007W",247).
component("YOR095C",696).
component("YER003C",313).
component("YBR196C",186).
component("YGL001C",360).
component("U14_",37).
component("YOL056W",680).
component("YKL152C",522).
component("YDL021W",212).
component("YMR105C",605).
component("YKL127W",516).
component("YEL058W",312).
component("YPR060C",764).
component("YHR072W",431).
component("YJL153C",475).
component("YPL097W",737).
component("YGR185C",402).
component("YHR011W",423).
component("YDR023W",250).
component("YPL104W",738).
component("YLL018C",541).
component("YPR081C",769).
component("YBR121C",177).
component("YHR020W",425).
component("YER087W",331).
component("YNL247W",647).
component("YOL033W",677).
component("YHR091C",433).
component("YDR341C",288).
component("YOL097C",686).
component("YDR268W",280).
component("YPR047W",763).
component("YLR060W",550).
component("YFL022C",347).
component("YPR033C",762).
component("YHR019C",424).
component("YPL160W",740).
component("YLR382C",583).
component("YNL073W",635).
component("YDR037W",252).
component("YOR335C",720).
component("YGR094W",392).
component("YOR142W",700).
component("YGR244C",410).
component("U89_",130).
component("YOR241W",714).
component("YMR113W",607).
component("YKL132C",517).
component("YJL101C",467).
component("U92_",133).
component("YGL234W",378).
component("U91_",132).
component("U90_",131).
component("YDL141W",231).
component("YDL141W",232).
component("YJR103W",492).
component("YBL039C",149).
component("YGR204W",406).
component("YBR084W",172).
component("YOL058W",681).
component("YBR208C",188).
component("YHR074W",432).
component("YMR217W",616).
component("YOR303W",716).
component("YJR109C",495).
component("YJL130C",471).
component("YGL062W",368).
component("YBR218C",189).
component("YPL231W",749).
component("YNR016C",666).
component("YKL182W",525).
component("YGR037C",386).
component("YOR005C",693).
component("YDL164C",235).
component("YOL010W",674).
component("YPR138C",772).
component("YPL274W",755).
component("YPL265W",752).
component("YPL057C",735).
component("YPL036W",734).
component("YOR348C",724).
component("YOR192C",706).
component("YOR171C",703).
component("YOR071C",695).
component("YOL156W",692).
component("YOL103W",687).
component("YOL020W",676) :- not remove_orf("YOL020W",676).
component("YNR056C",671).
component("YNL318C",661).
component("YNL268W",654).
component("YNL142W",641).
component("YMR272C",622).
component("YML123C",598).
component("YLR348C",579).
component("YLR260W",569).
component("YLR237W",567).
component("YLR138W",556).
component("YLR100C",553).
component("YLR081W",551).
component("YLL061W",544).
component("YLL043W",543).
component("YKR093W",539).
component("YKR053C",537).
component("YKR039W",536) :- not remove_orf("YKR039W",536).
component("YKL217W",531).
component("YKL004W",506).
component("YJR152W",502).
component("YJR095W",491).
component("YJR077C",489).
component("YJL219W",481).
component("YJL134W",472).
component("YJL129C",470).
component("YHL036W",419).
component("YGR121C",393).
component("YGR055W",388).
component("YGL186C",375).
component("YGL077C",371).
component("YGL008C",361).
component("YFL055W",350).
component("YFL011W",344).
component("YER060W-A",323).
component("YER060W",322).
component("YER056C",321).
component("YER053C",319).
component("YEL017C-A",308).
component("YDR536W",307).
component("YDR508C",303).
component("YDR503C",302).
component("YDR497C",301).
component("YDR297W",284).
component("YDR294C",283).
component("YDR046C",255) :- not remove_orf("YDR046C",255).
component("YDL210W",241).
component("YCR024C-A",208).
component("YCL025C",202).
component("YBR298C",199).
component("YBR291C",198).
component("YBR069C",171) :- not remove_orf("YBR069C",171).
component("YBR068C",170) :- not remove_orf("YBR068C",170).
component("YBR036C",167).
component("YBR021W",163).
...
catalyst(6160,625).
catalyst(3870,320).
catalyst(3620,289) :- not remove_reaction(3620,289).
catalyst(2110,356).
catalyst(2190,356).
catalyst(5550,497).
catalyst(5791,565).
...
catalyst(1960,256).
catalyst(3460,107).
catalyst(3600,528) :- not remove_reaction(3600,528).
catalyst(3941,678).
catalyst(3942,678).
catalyst(6890,643).
catalyst(6900,397).
...
catalyst(4560,309).
catalyst(2550,668).
catalyst(1890,529) :- not remove_reaction(1890,529).
catalyst(3630,529) :- not remove_reaction(3630,529).
catalyst(1890,333) :- not remove_reaction(1890,333).
catalyst(3630,333) :- not remove_reaction(3630,333).
catalyst(3740,266).
catalyst(8231,758).
catalyst(8232,758).
catalyst(8231,730).
...
catalyst(8051,751).
catalyst(8052,751).
catalyst(3590,365) :- not remove_reaction(3590,365).
catalyst(10910,365) :- not remove_reaction(10910,365).
catalyst(4570,396).
catalyst(8181,574).
catalyst(8182,574).
catalyst(8181,480).
...
catalyst(8281,257).
catalyst(8282,257).
catalyst(3610,247) :- not remove_reaction(3610,247).
catalyst(7921,696).
catalyst(7922,696).
catalyst(7841,313).
catalyst(7842,313).
...
catalyst(1200,692).
catalyst(1160,687).
catalyst(801,676) :- not remove_reaction(801,676).
catalyst(802,676) :- not remove_reaction(802,676).
catalyst(811,676) :- not remove_reaction(811,676).
catalyst(812,676) :- not remove_reaction(812,676).
catalyst(831,676) :- not remove_reaction(831,676).
catalyst(832,676) :- not remove_reaction(832,676).
catalyst(901,676) :- not remove_reaction(901,676).
catalyst(902,676) :- not remove_reaction(902,676).
catalyst(941,676) :- not remove_reaction(941,676).
catalyst(942,676) :- not remove_reaction(942,676).
catalyst(700,671).
catalyst(1200,661).
catalyst(761,654).
catalyst(762,654).
...
catalyst(640,539).
catalyst(6560,537).
catalyst(761,536) :- not remove_reaction(761,536).
catalyst(762,536) :- not remove_reaction(762,536).
catalyst(771,536) :- not remove_reaction(771,536).
catalyst(772,536) :- not remove_reaction(772,536).
catalyst(781,536) :- not remove_reaction(781,536).
catalyst(782,536) :- not remove_reaction(782,536).
catalyst(791,536) :- not remove_reaction(791,536).
catalyst(792,536) :- not remove_reaction(792,536).
catalyst(801,536) :- not remove_reaction(801,536).
catalyst(802,536) :- not remove_reaction(802,536).
catalyst(811,536) :- not remove_reaction(811,536).
catalyst(812,536) :- not remove_reaction(812,536).
catalyst(821,536) :- not remove_reaction(821,536).
catalyst(822,536) :- not remove_reaction(822,536).
catalyst(831,536) :- not remove_reaction(831,536).
catalyst(832,536) :- not remove_reaction(832,536).
catalyst(841,536) :- not remove_reaction(841,536).
catalyst(842,536) :- not remove_reaction(842,536).
catalyst(861,536) :- not remove_reaction(861,536).
catalyst(862,536) :- not remove_reaction(862,536).
catalyst(881,536) :- not remove_reaction(881,536).
catalyst(882,536) :- not remove_reaction(882,536).
catalyst(901,536) :- not remove_reaction(901,536).
catalyst(902,536) :- not remove_reaction(902,536).
catalyst(911,536) :- not remove_reaction(911,536).
catalyst(912,536) :- not remove_reaction(912,536).
catalyst(941,536) :- not remove_reaction(941,536).
catalyst(942,536) :- not remove_reaction(942,536).
catalyst(1191,536) :- not remove_reaction(1191,536).
catalyst(1192,536) :- not remove_reaction(1192,536).
catalyst(1021,531).
catalyst(1022,531).
catalyst(6610,506).
catalyst(170,502).
...
catalyst(831,255) :- not remove_reaction(831,255).
catalyst(832,255) :- not remove_reaction(832,255).
catalyst(841,255) :- not remove_reaction(841,255).
catalyst(842,255) :- not remove_reaction(842,255).
catalyst(861,255) :- not remove_reaction(861,255).
catalyst(862,255) :- not remove_reaction(862,255).
...
catalyst(1511,198).
catalyst(1512,198).
catalyst(771,171) :- not remove_reaction(771,171).
catalyst(772,171) :- not remove_reaction(772,171).
...
catalyst(791,170) :- not remove_reaction(791,170).
catalyst(792,170) :- not remove_reaction(792,170).
...
catalyst(841,170) :- not remove_reaction(841,170).
catalyst(842,170) :- not remove_reaction(842,170).
catalyst(861,170) :- not remove_reaction(861,170).
catalyst(862,170) :- not remove_reaction(862,170).
catalyst(901,170) :- not remove_reaction(901,170).
catalyst(902,170) :- not remove_reaction(902,170).
catalyst(6600,167).
catalyst(620,163).
catalyst(540,150).
catalyst(2830,122).
