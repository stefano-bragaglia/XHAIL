...
component("YGR060W",209).
component("YGL012W",194).
component("YOL086C",355).
component("YMR303C",326).
component("YGL256W",204).
component("YDL168W",129).
component("YBR145W",97).
component("YPL231W",391).
component("YGL001C",191).
component("YML056C",309).
component("YLR432W",306).
component("YHR216W",234).
component("YAR075W",81).
component("YAR073W",80).
component("YDR127W",143).
component("YJR139C",268).
component("YOR136W",363).
component("YDL066W",122).
component("YIL155C",240).
component("YPR191W",413).
component("YOR065W",359).
component("YJL166W",254).
component("YHR001W-A",225).
component("YGR183C",216).
component("YFR033C",188).
component("YDR529C",168).
component("YBL045C",85).
component("Q0105",18).
component("YJR078W",261).
component("YJR025C",256).
component("YBL098W",87).
component("YMR015C",314).
component("YDR402C",161).
component("YJR104C",264).
component("YHR008C",226).
component("YER070W",177).
component("YDL168W",130).
component("YPL276W",399).
component("YPL275W",398).
component("YOR388C",381).
component("YGL154C",201).
component("YOR323C",374).
component("YMR170C",321).
component("YMR169C",320).
component("YBR166C",100).
component("YNL280C",341).
component("YER014W",174).
component("YMR118C",318).
component("YLR164W",294).
component("YLL041C",289).
component("YKL148C",277).
component("YJL045W",244).
component("YDR178W",149).
component("YJR051W",258).
component("YEL047C",171).
component("YOR375C",380).
component("YDL215C",132).
component("YAL062W",79).
component("YBR035C",90).
component("YER023W",175).
component("YOR236W",372).
component("YGR204W",217).
component("U62_",58).
component("YKL150W",278).
component("YIL043C",236).
component("YPL017C",384).
component("YFL018C",182).
component("YPL273W",397).
component("YLL062C",290).
component("U47_",52).
component("YDL033C",120).
component("YKL024C",271).
component("YPR074C",406).
component("YBR117C",96).
component("YCL009C",111).
component("YMR062C",316).
component("YPL231W",392).
component("YPL001W",383).
component("YPL231W",393).
component("YGR147C",213).
component("YDL040C",121).
component("YPL028W",385).
component("YPR001W",401).
component("YNR001C",345).
component("YDL182W",131).
component("YNL117W",333).
component("YIR031C",242).
component("YNL029C",328).
component("YIL085C",237).
component("YLR209C",295).
component("YMR300C",325).
component("YER055C",176).
component("YDR354W",157) :- not remove_orf("YDR354W",157).
component("YFR047C",189).
component("YJR133W",267).
component("YML022W",307).
component("YDR441C",164).
component("YDR399W",159).
component("YNL256W",338).
component("YDR127W",144).
component("YLR303W",301).
component("YJR130C",266).
component("YLR303W",302).
component("YDR035W",137).
component("YBR249C",104).
component("YBR256C",105).
component("YHR137W",229).
component("YGL202W",202).
component("YLR027C",291).
component("YKL106W",274).
component("YKL104C",273).
component("YGR019W",206).
component("U64_",59).
component("U51_",54).
component("YJR148W",269).
component("YGL253W",203).
component("YFR053C",190).
component("YMR205C",323).
component("YGR240C",218).
component("YDR248C",152).
component("YCR036W",118).
component("YCL040W",113).
component("YJR105W",265).
component("U16_",30).
component("U15_",28).
component("U96_",75).
component("YKL001C",270).
component("YML070W",310).
component("YFL053W",184).
component("U83_",70).
component("U82_",69).
component("YMR208W",324).
component("YOR347C",379).
component("YAL038W",78).
component("YPR121W",408).
component("YPL258C",395).
component("YOL055C",352).
component("U1_",39).
component("YNL267W",340).
component("YLR305C",303).
component("YFR019W",186).
component("YDR208W",150).
component("YDR127W",145).
component("U21_",44).
component("U20_",43).
component("YDR300C",155).
component("YCR012W",115).
component("U18_",36).
component("U76_",67).
component("YDR226W",151).
component("YDR454C",165).
component("YOL061W",354).
component("YKL181W",279).
component("YHL011C",222).
component("YER099C",180).
component("YBL068W",86).
component("YOR143C",364).
component("YGR007W",205).
component("YLR328W",304).
component("YCL050C",114).
component("YPR190C",412).
component("YPR187W",411).
component("YPR110C",407).
component("YPR010C",402).
component("YOR341W",378).
component("YOR340C",377).
component("YOR224C",371).
component("YOR210W",370).
component("YOR207C",368).
component("YOR151C",365).
component("YOR116C",362).
component("YOL005C",349).
component("YNR003C",346).
component("YNL248C",337).
component("YNL151C",336).
component("YNL113W",332).
component("YKL144C",276).
component("YJR063W",259).
component("YJL148W",252).
component("YJL140W",251).
component("YIL021W",235).
component("YHR143W-A",230).
component("YGL070C",199).
component("YFL036W",183).
component("YDR404C",162).
component("YDR156W",148).
component("YDR045C",138).
component("YDL150W",127).
component("YDL140C",126).
component("YBR154C",99).
component("YPR175W",410).
component("YPL167C",388).
component("YOR330C",375).
component("YOL115W",357).
component("YNL299W",343).
component("YNL262W",339).
component("YNL102W",331).
component("YJR043C",257).
component("YJR006W",255).
component("YJL090C",246).
component("YIL139C",239).
component("YEL055C",172).
component("YDR419W",163).
component("YDR121W",142).
component("YDL102W",125).
component("YCR014C",116).
component("YBR278W",107).
component("YBL035C",83).
component("YKL035W",272).
component("YHL012W",223).
component("YDR058C",141).
component("YDL086W",124).
component("YOL011W",350).
component("YMR008C",313).
component("YMR006C",312).
component("U101_",19).
component("YBL015W",82).
component("U84_",71).
component("YPR073C",404).
component("YHR215W",233).
component("YDL024C",119).
component("YBR093C",94).
component("YBR092C",93).
component("YPL228W",390).
component("YMR180C",322).
component("YDL236W",134).
component("YJL155C",253).
component("YPR073C",405).
component("YOR208W",369).
component("YNL053W",330).
component("YMR036C",315).
component("YIR026C",241).
component("YIL113W",238).
component("YFR028C",187).
component("YER075C",178).
component("YDL230W",133).
component("YBR276C",106).
component("U34_",50).
component("U30_",49).
component("U25_",48).
component("U24_",47).
component("YKR031C",285).
component("YLR286C",299).
component("YOR190W",366).
component("YLR300W",300).
component("YGR282C",221).
component("YDR261C",153).
component("YDR400W",160).
component("YML035C",308).
component("YJL070C",245).
component("YBR284W",108).
component("YNL045W",329).
component("YGL037C",196).
component("YBR208C",101).
component("U53_",55).
component("YIR032C",243).
component("YMR120C",319).
component("YHR144C",231).
component("YBR153W",98).
component("YDL238C",135).
component("YNL141W",334).
component("YLR245C",298).
component("YJL126W",248).
component("YBR111C",95).
component("YER005W",173).
component("YLR231C",296).
component("U88_",72).
component("YLR134W",293).
component("YLR044C",292).
component("YGR087C",210).
component("YDR380W",158).
component("YDL080C",123).
component("U98_",76).
component("YKL184W",282).
component("U93_",74).
component("U54_",56).
component("YKL211C",283) :- not remove_orf("YKL211C",283).
component("YGR170W",215).
component("YDR294C",154).
component("YNR033W",348).
component("YKL211C",284) :- not remove_orf("YKL211C",284).
component("YER090W",284) :- not remove_orf("YER090W",284).
component("YER090W",179) :- not remove_orf("YER090W",179).
component("YDR127W",146).
component("YPL281C",400).
component("YOR393W",382).
component("YMR323W",327).
component("YHR174W",232).
component("YGR254W",220).
component("YGL026C",195) :- not remove_orf("YGL026C",195).
component("YGR155W",214).
component("YNL316C",344).
component("YKL182W",280).
component("YPL212C",389).
component("YNL292W",342).
component("YGL063W",198).
component("YFL001W",181).
component("YDR127W",147).
component("YGL148W",200).
component("YAL012W",77).
component("YBR019C",88).
component("YDR050C",140).
component("YDR007W",136) :- not remove_orf("YDR007W",136).
component("YOR095C",361).
component("YGL001C",192).
component("YMR105C",317).
component("YKL127W",275).
component("YPR060C",403).
component("YPL104W",387).
component("YLL018C",288).
component("YHR091C",228).
component("YDR341C",156).
component("YOL097C",356).
component("YOR335C",376).
component("YGR094W",211).
component("YGR244C",219).
component("U89_",73).
component("YJL101C",247).
component("YJR103W",263).
component("YBL039C",84).
component("YOL058W",353).
component("YBR208C",102).
component("YHR074W",227).
component("YOR303W",373).
component("YGL062W",197).
component("YBR218C",103).
component("YPL231W",394).
component("YNR016C",347).
component("YKL182W",281).
component("YGR037C",207).
component("YOR005C",358).
component("YDL164C",128).
component("YPR138C",409).
component("YPL265W",396).
component("YPL036W",386).
component("YOR192C",367).
component("YOR071C",360).
component("YOL020W",351) :- not remove_orf("YOL020W",351).
component("YNL142W",335).
component("YML123C",311).
component("YLR348C",305).
component("YLR237W",297).
component("YKR053C",287).
component("YKR039W",286) :- not remove_orf("YKR039W",286).
component("YJR095W",262).
component("YJR077C",260).
component("YJL134W",250).
component("YJL129C",249).
component("YHL036W",224).
component("YGR121C",212).
component("YGR055W",208).
component("YGL008C",193).
component("YFL055W",185).
component("YEL017C-A",170).
component("YDR536W",169).
component("YDR508C",167).
component("YDR503C",166).
component("YDR046C",139) :- not remove_orf("YDR046C",139).
component("YCR024C-A",117).
component("YCL025C",112).
component("YBR298C",110).
component("YBR291C",109).
component("YBR069C",92) :- not remove_orf("YBR069C",92).
component("YBR068C",91) :- not remove_orf("YBR068C",91).
component("YBR021W",89).
component("U79_",68).
component("U75_",66).
component("U74_",65).
component("U73_",64).
...
catalyst(6160,325).
catalyst(3870,176).
catalyst(3620,157) :- not remove_reaction(3620,157).
catalyst(2190,189).
catalyst(5550,267).
catalyst(5650,307).
catalyst(5650,164).
...
catalyst(2300,74).
catalyst(3460,56).
catalyst(3600,283) :- not remove_reaction(3600,283).
catalyst(6900,215).
catalyst(8781,154).
catalyst(8782,154).
catalyst(2550,348).
catalyst(3630,284) :- not remove_reaction(3630,284).
...
catalyst(8231,220).
catalyst(8232,220).
catalyst(3590,195) :- not remove_reaction(3590,195).
catalyst(10910,195) :- not remove_reaction(10910,195).
catalyst(4570,214).
catalyst(3680,344).
catalyst(7141,280).
catalyst(7142,280).
...
catalyst(8281,140).
catalyst(8282,140).
catalyst(3610,136) :- not remove_reaction(3610,136).
catalyst(7921,361).
catalyst(7922,361).
catalyst(6370,192).
catalyst(7861,317).
...
catalyst(1501,109).
catalyst(1502,109).
catalyst(771,92) :- not remove_reaction(771,92).
catalyst(772,92) :- not remove_reaction(772,92).
...
catalyst(831,91) :- not remove_reaction(831,91).
catalyst(832,91) :- not remove_reaction(832,91).
catalyst(841,91) :- not remove_reaction(841,91).
catalyst(842,91) :- not remove_reaction(842,91).
catalyst(620,89).
catalyst(2830,68).
catalyst(2920,66).
catalyst(2920,65).
