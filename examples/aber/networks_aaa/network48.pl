...
component("YGR060W",207).
component("YGL012W",192).
component("YOL086C",351).
component("YMR303C",322).
component("YGL256W",202).
component("YDL168W",127).
component("YBR145W",95).
component("YPL231W",387).
component("YGL001C",189).
component("YML056C",305).
component("YLR432W",302).
component("YHR216W",231).
component("YAR075W",79).
component("YAR073W",78).
component("YDR127W",141).
component("YJR139C",265).
component("YOR136W",359).
component("YDL066W",120).
component("YIL155C",237).
component("YPR191W",409).
component("YOR065W",355).
component("YJL166W",251).
component("YHR001W-A",222).
component("YGR183C",214).
component("YFR033C",186).
component("YDR529C",166).
component("YBL045C",83).
component("Q0105",18).
component("YJR078W",258).
component("YJR025C",253).
component("YBL098W",85).
component("YMR015C",310).
component("YDR402C",159).
component("YJR104C",261).
component("YHR008C",223).
component("YER070W",175).
component("YDL168W",128).
component("YPL276W",395).
component("YPL275W",394).
component("YOR388C",377).
component("YGL154C",199).
component("YOR323C",370).
component("YMR170C",317).
component("YMR169C",316).
component("YBR166C",98).
component("YNL280C",337).
component("YER014W",172).
component("YMR118C",314).
component("YLR164W",291).
component("YLL041C",286).
component("YKL148C",274).
component("YJL045W",241).
component("YDR178W",147).
component("YJR051W",255).
component("YEL047C",169).
component("YOR375C",376).
component("YDL215C",130).
component("YAL062W",77).
component("YBR035C",88).
component("YER023W",173).
component("YOR236W",368).
component("YGR204W",215).
component("U62_",56).
component("YKL150W",275).
component("YIL043C",233).
component("YPL017C",380).
component("YFL018C",180).
component("YPL273W",393).
component("YLL062C",287).
component("U47_",50).
component("YDL033C",118).
component("YKL024C",268).
component("YPR074C",402).
component("YBR117C",94).
component("YCL009C",109).
component("YMR062C",312).
component("YPL231W",388).
component("YPL001W",379).
component("YPL231W",389).
component("YGR147C",211).
component("YDL040C",119).
component("YPL028W",381).
component("YPR001W",397).
component("YNR001C",341).
component("YDL182W",129).
component("YNL117W",329).
component("YIR031C",239).
component("YNL029C",324).
component("YIL085C",234).
component("YLR209C",292).
component("YMR300C",321).
component("YER055C",174).
component("YDR354W",155) :- not remove_orf("YDR354W",155).
component("YFR047C",187).
component("YJR133W",264).
component("YML022W",303).
component("YDR441C",162).
component("YDR399W",157).
component("YNL256W",334).
component("YDR127W",142).
component("YLR303W",298).
component("YJR130C",263).
component("YLR303W",299).
component("YDR035W",135).
component("YBR249C",102).
component("YBR256C",103).
component("YHR137W",226).
component("YGL202W",200).
component("YLR027C",288).
component("YKL106W",271).
component("YKL104C",270).
component("YGR019W",204).
component("U64_",57).
component("U51_",52).
component("YJR148W",266).
component("YGL253W",201).
component("YFR053C",188).
component("YMR205C",319).
component("YGR240C",216).
component("YDR248C",150).
component("YCR036W",116).
component("YCL040W",111).
component("YJR105W",262).
component("U16_",29).
component("U15_",27).
component("U96_",73).
component("YKL001C",267).
component("YML070W",306).
component("YFL053W",182).
component("U83_",68).
component("U82_",67).
component("YMR208W",320).
component("YOR347C",375).
component("YAL038W",76).
component("YPR121W",404).
component("YPL258C",391).
component("YOL055C",348).
component("U1_",37).
component("YNL267W",336).
component("YLR305C",300).
component("YFR019W",184).
component("YDR208W",148).
component("YDR127W",143).
component("U21_",42).
component("U20_",41).
component("YDR300C",153).
component("YCR012W",113).
component("U18_",34).
component("U76_",65).
component("YDR226W",149).
component("YDR454C",163).
component("YOL061W",350).
component("YKL181W",276).
component("YHL011C",219).
component("YER099C",178).
component("YBL068W",84).
component("YOR143C",360).
component("YGR007W",203).
component("YCL050C",112).
component("YPR190C",408).
component("YPR187W",407).
component("YPR110C",403).
component("YPR010C",398).
component("YOR341W",374).
component("YOR340C",373).
component("YOR224C",367).
component("YOR210W",366).
component("YOR207C",364).
component("YOR151C",361).
component("YOR116C",358).
component("YOL005C",345).
component("YNR003C",342).
component("YNL248C",333).
component("YNL151C",332).
component("YNL113W",328).
component("YKL144C",273).
component("YJR063W",256).
component("YJL148W",249).
component("YJL140W",248).
component("YIL021W",232).
component("YHR143W-A",227).
component("YGL070C",197).
component("YFL036W",181).
component("YDR404C",160).
component("YDR156W",146).
component("YDR045C",136).
component("YDL150W",125).
component("YDL140C",124).
component("YBR154C",97).
component("YPR175W",406).
component("YPL167C",384).
component("YOR330C",371).
component("YOL115W",353).
component("YNL299W",339).
component("YNL262W",335).
component("YNL102W",327).
component("YJR043C",254).
component("YJR006W",252).
component("YJL090C",243).
component("YIL139C",236).
component("YEL055C",170).
component("YDR419W",161).
component("YDR121W",140).
component("YDL102W",123).
component("YCR014C",114).
component("YBR278W",105).
component("YBL035C",81).
component("YKL035W",269).
component("YHL012W",220).
component("YDR058C",139).
component("YDL086W",122).
component("YOL011W",346).
component("YMR008C",309).
component("YMR006C",308).
component("U101_",19).
component("YBL015W",80).
component("U84_",69).
component("YPR073C",400).
component("YHR215W",230).
component("YDL024C",117).
component("YBR093C",92).
component("YBR092C",91).
component("YPL228W",386).
component("YMR180C",318).
component("YDL236W",132).
component("YJL155C",250).
component("YPR073C",401).
component("YOR208W",365).
component("YNL053W",326).
component("YMR036C",311).
component("YIR026C",238).
component("YIL113W",235).
component("YFR028C",185).
component("YER075C",176).
component("YDL230W",131).
component("YBR276C",104).
component("U34_",48).
component("U30_",47).
component("U25_",46).
component("U24_",45).
component("YKR031C",282).
component("YLR286C",296).
component("YOR190W",362).
component("YLR300W",297).
component("YGR282C",218).
component("YDR261C",151).
component("YDR400W",158).
component("YML035C",304).
component("YJL070C",242).
component("YBR284W",106).
component("YNL045W",325).
component("YGL037C",194).
component("YBR208C",99).
component("U53_",53).
component("YIR032C",240).
component("YMR120C",315).
component("YHR144C",228).
component("YBR153W",96).
component("YDL238C",133).
component("YNL141W",330).
component("YLR245C",295).
component("YJL126W",245).
component("YBR111C",93).
component("YER005W",171).
component("YLR231C",293).
component("U88_",70).
component("YLR134W",290).
component("YLR044C",289).
component("YGR087C",208).
component("YDR380W",156).
component("YDL080C",121).
component("U98_",74).
component("YKL184W",279).
component("U93_",72).
component("U54_",54).
component("YKL211C",280) :- not remove_orf("YKL211C",280).
component("YGR170W",213).
component("YDR294C",152).
component("YNR033W",344).
component("YKL211C",281) :- not remove_orf("YKL211C",281).
component("YER090W",281) :- not remove_orf("YER090W",281).
component("YER090W",177) :- not remove_orf("YER090W",177).
component("YDR127W",144).
component("YPL281C",396).
component("YOR393W",378).
component("YMR323W",323).
component("YHR174W",229).
component("YGR254W",217).
component("YGL026C",193) :- not remove_orf("YGL026C",193).
component("YGR155W",212).
component("YNL316C",340).
component("YKL182W",277).
component("YPL212C",385).
component("YNL292W",338).
component("YGL063W",196).
component("YFL001W",179).
component("YDR127W",145).
component("YGL148W",198).
component("YAL012W",75).
component("YBR019C",86).
component("YDR050C",138).
component("YDR007W",134) :- not remove_orf("YDR007W",134).
component("YOR095C",357).
component("YGL001C",190).
component("YMR105C",313).
component("YKL127W",272).
component("YPR060C",399).
component("YPL104W",383).
component("YLL018C",285).
component("YHR091C",225).
component("YDR341C",154).
component("YOL097C",352).
component("YOR335C",372).
component("YGR094W",209).
component("U89_",71).
component("YJL101C",244).
component("YJR103W",260).
component("YBL039C",82).
component("YOL058W",349).
component("YBR208C",100).
component("YHR074W",224).
component("YOR303W",369).
component("YGL062W",195).
component("YBR218C",101).
component("YPL231W",390).
component("YNR016C",343).
component("YKL182W",278).
component("YGR037C",205).
component("YOR005C",354).
component("YDL164C",126).
component("YPR138C",405).
component("YPL265W",392).
component("YPL036W",382).
component("YOR192C",363).
component("YOR071C",356).
component("YOL020W",347) :- not remove_orf("YOL020W",347).
component("YNL142W",331).
component("YML123C",307).
component("YLR348C",301).
component("YLR237W",294).
component("YKR053C",284).
component("YKR039W",283) :- not remove_orf("YKR039W",283).
component("YJR095W",259).
component("YJR077C",257).
component("YJL134W",247).
component("YJL129C",246).
...
component("YDR508C",165).
component("YDR503C",164).
component("YDR046C",137) :- not remove_orf("YDR046C",137).
component("YCR024C-A",115).
component("YCL025C",110).
component("YBR298C",108).
component("YBR291C",107).
component("YBR069C",90) :- not remove_orf("YBR069C",90).
component("YBR068C",89) :- not remove_orf("YBR068C",89).
component("YBR021W",87).
component("U79_",66).
component("U75_",64).
component("U74_",63).
component("U73_",62).
...
catalyst(6160,321).
catalyst(3870,174).
catalyst(3620,155) :- not remove_reaction(3620,155).
catalyst(2190,187).
catalyst(5550,264).
catalyst(5650,303).
catalyst(5650,162).
...
catalyst(2300,72).
catalyst(3460,54).
catalyst(3600,280) :- not remove_reaction(3600,280).
catalyst(6900,213).
catalyst(8781,152).
catalyst(8782,152).
catalyst(2550,344).
catalyst(3630,281) :- not remove_reaction(3630,281).
catalyst(3630,177) :- not remove_reaction(3630,177).
catalyst(3740,144).
catalyst(8231,396).
catalyst(8232,396).
catalyst(8231,378).
...
catalyst(8281,138).
catalyst(8282,138).
catalyst(3610,134) :- not remove_reaction(3610,134).
catalyst(7921,357).
catalyst(7922,357).
catalyst(6370,190).
catalyst(7861,313).
...
catalyst(190,294).
catalyst(6560,284).
catalyst(771,283) :- not remove_reaction(771,283).
catalyst(772,283) :- not remove_reaction(772,283).
catalyst(781,283) :- not remove_reaction(781,283).
catalyst(782,283) :- not remove_reaction(782,283).
catalyst(801,283) :- not remove_reaction(801,283).
catalyst(802,283) :- not remove_reaction(802,283).
catalyst(811,283) :- not remove_reaction(811,283).
catalyst(812,283) :- not remove_reaction(812,283).
catalyst(831,283) :- not remove_reaction(831,283).
catalyst(832,283) :- not remove_reaction(832,283).
catalyst(841,283) :- not remove_reaction(841,283).
catalyst(842,283) :- not remove_reaction(842,283).
catalyst(881,283) :- not remove_reaction(881,283).
catalyst(882,283) :- not remove_reaction(882,283).
catalyst(1191,283) :- not remove_reaction(1191,283).
catalyst(1192,283) :- not remove_reaction(1192,283).
catalyst(1250,259).
catalyst(1581,257).
catalyst(1582,257).
catalyst(6560,247).
