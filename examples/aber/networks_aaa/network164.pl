...
component("YNL280C",850).
component("YLR056W",713).
component("YGR060W",501).
component("YGL012W",466).
component("YKR009C",693).
component("YOL086C",885).
component("YMR303C",816).
component("YMR083W",785).
component("YGL256W",493).
component("YDL168W",309).
component("YBR145W",234).
component("YPL231W",970).
component("YBR265W",253).
component("U46_",132).
component("YBR149W",235).
component("YBR149W",236).
component("YJR159W",657).
component("YGL001C",463).
component("YIL094C",581).
component("YHR063C",553).
component("U45_",131).
component("YBR153W",237).
component("YML056C",766).
component("YLR432W",756).
component("YHR216W",571).
component("YAR075W",192).
component("YAR073W",191).
component("YCL030C",263).
component("YDR127W",345).
component("YJR139C",651).
component("YML075C",769).
component("YLR450W",758).
component("YOL126C",890).
component("YKL085W",667).
component("YDL078C",289).
component("YKL029C",662).
component("YOR136W",907).
component("YNL037C",821).
component("YDL066W",287).
component("YNL241C",840).
component("YOL059W",882).
component("YDL022W",280).
component("YLR355C",751).
component("YIL074C",579).
component("YER081W",430).
component("YML054C",765).
component("YDL174C",312).
component("YML086C",770).
component("YIL155C",589).
component("YPR191W",1010).
component("YOR065W",897).
component("YJL166W",622).
component("YHR001W-A",541).
component("YGR183C",517).
component("YFR033C",459).
component("YDR529C",395).
component("YBL045C",199).
component("Q0105",18).
component("YGR088W",504).
component("YDR256C",362).
component("YKL026C",661).
component("YIR037W",601).
component("YBR244W",249).
component("YJR078W",642).
component("U58_",144).
component("YJR025C",634).
component("YGR255C",529).
component("U108_",25).
component("YBL098W",203).
component("YMR015C",781).
component("YHR007C",542).
component("YDR402C",383).
component("YGL055W",473).
component("YGR175C",514).
component("YJR104C",645).
component("YHR008C",543).
component("YJL026W",604).
component("YIL066C",578).
component("YGR180C",516).
component("YER070W",427).
component("U38_",126).
component("U36_",125).
component("U35_",124).
component("YDL168W",310).
component("YDR158W",353).
component("YBR006W",206).
component("YPL276W",982).
component("YPL275W",981).
component("YOR388C",945).
component("YOR374W",942).
component("YER073W",428).
component("U68_",151).
component("YGL154C",482).
component("YBR115C",228).
component("U55_",141).
component("YOR323C",932).
component("YMR170C",796).
component("YMR169C",795).
component("U2_",118).
component("YER178W",444).
component("YBR221C",247).
component("YIL125W",586).
component("U52_",138).
component("YBR166C",240).
component("YNL280C",851).
component("YGL012W",467).
component("YKL182W",681).
component("U57_",143).
component("YKL216W",690).
component("YDR044W",329).
component("YER014W",411).
component("YKR009C",694).
component("YIL160C",591).
component("YGL205W",487).
component("YMR118C",790).
component("YLR164W",728).
component("YLL041C",705).
component("YKL148C",675).
component("YKL141W",673).
component("YJL045W",605).
component("YDR178W",355).
component("YJR051W",637).
component("YEL047C",405).
component("YDL171C",311).
component("YDL215C",316).
component("YOR375C",943).
component("YDL215C",317).
component("YAL062W",188).
component("U99_",182).
component("YBR035C",216).
component("YMR189W",798).
component("U56_",142).
component("YNR050C",866).
component("YHR037W",549).
component("YKR080W",698).
component("YER023W",413).
component("YPL023C",949).
component("YGL125W",479).
component("YOR236W",924).
component("YGR204W",521).
component("YLR142W",722).
component("U63_",148).
component("U62_",147).
component("YOR356W",940).
component("YKL150W",676).
component("YIL043C",575).
component("YHR042W",550).
component("YOR221C",921).
component("YML120C",774).
component("YKL192C",685).
component("YKL055C",664).
component("YER061C",422).
component("YMR145C",793).
component("YML120C",775).
component("YKL192C",686).
component("YDL085W",291).
component("YGR234W",524).
component("YFR030W",458).
component("YPL017C",948).
component("YFL018C",449).
component("YPL091W",954).
component("YDR353W",377).
component("YER042W",415).
component("YPR167C",1004).
component("YJR137C",650).
component("YNL052W",823).
component("YMR256C",807).
component("YLR395C",755).
component("YLR038C",711).
component("YIL111W",583).
component("YHR051W",552).
component("YGL191W",485).
component("YGL187C",484).
component("YDL067C",288).
component("Q0275",20).
component("Q0250",19).
component("YPL266W",977).
component("YML110C",773).
component("YBR034C",215).
component("YPL273W",979).
component("YLL062C",708).
component("YDR410C",386).
component("U47_",133).
component("YER091C",435).
component("YJR073C",640).
component("YDR120C",343).
component("YML008C",759).
component("YDL033C",282).
component("YOL096C",886).
component("YLR172C",729).
component("YDR019C",325).
component("YBR176W",241).
component("YDR408C",385).
component("YMR120C",791).
component("YBL013W",193).
component("YKL024C",660).
component("YPR074C",996).
component("YBR117C",229).
component("YLR354C",750).
component("YGR043C",499).
component("YMR108W",788).
component("YCL009C",261).
component("YMR062C",784).
component("YNL071W",825).
component("YNR008W",858).
component("YIL160C",592).
component("YNL277W",849).
component("YDR232W",358).
component("YFL017C",448).
component("YPL231W",971).
component("YER061C",423).
component("U86_",170).
component("YPL001W",947).
component("YMR296C",814).
component("YDR062W",337).
component("YDL052C",285).
component("U8_",174).
component("YDR148C",351).
component("YOR377W",944).
component("YGR177C",515).
component("YPL231W",972).
component("YGR147C",510).
component("YDL040C",283).
component("YPL028W",950).
component("YLR195C",730).
component("YGL017W",468).
component("YPR001W",984).
component("YNR001C",856).
component("YCR005C",269).
component("YNL104C",828).
component("YDL182W",313).
component("YDL131W",300).
component("YNL117W",830).
component("YIR031C",599).
component("YOR321W",931).
component("YJR143C",652).
component("YGR199W",520).
component("YDR307W",371).
component("YDL095W",295).
component("YDL093W",294).
component("YAL023C",185).
component("YOR103C",901).
component("YOR085W",899).
component("YMR149W",794).
component("YML019W",761).
component("YJL002C",602).
component("YEL002C",399).
component("YDL232W",319).
component("YCL043C",266).
component("YNL029C",820).
component("YIL085C",580).
component("YMR261C",808).
component("YML100W",771).
component("YBR126C",233).
component("YNL192W",838).
component("YBR038W",218).
component("YBR023C",214).
component("YMR306W",818).
component("YLR342W",748).
component("YGR032W",497).
component("YPR183W",1007).
component("YLR209C",731).
component("U104_",23).
component("YMR271C",810).
component("YML106W",772).
component("YOR209C",919).
component("YMR300C",815).
component("YER055C",418).
component("YDR354W",378) :- not remove_orf("YDR354W",378).
component("YFR047C",460).
component("YJR133W",649).
component("YLR209C",732).
component("YML022W",762).
component("YDR441C",389).
component("YDR399W",381).
component("YPR176C",1006).
component("YPL172C",962).
component("YNR041C",864).
component("YMR101C",786).
component("YDL090C",293).
component("YBR003W",205).
component("YBR002C",204).
component("YJL167W",623).
component("YJL167W",624).
component("YNL256W",843).
component("YPR069C",993).
component("YDR127W",346).
component("YLR146C",723).
component("YLR303W",739).
component("YGR012W",495).
component("YJR130C",648).
component("YLR303W",740).
component("YDR035W",327).
component("YBR249C",250).
component("YOR274W",927).
component("YOL143C",893).
component("YBR256C",252).
component("YHR137W",562).
component("YGL202W",486).
component("YLR027C",709).
component("YKL106W",669).
component("YOL140W",892).
component("YKL104C",668).
component("YGR019W",496).
component("YLR089C",717).
component("U64_",149).
component("U61_",146).
component("U51_",137).
component("YJR148W",653).
component("YHR208W",569).
component("YFL030W",451).
component("YOR184W",913).
component("YNR058W",869).
component("YIL116W",585).
component("YGL253W",492).
component("YFR053C",461).
component("YOL136C",891).
component("YIL107C",582).
component("YMR013C",780).
component("YMR205C",800).
component("YGR240C",525).
component("YDR248C",361).
component("YCR036W",275).
component("YGR194C",519).
component("YCL040W",265).
component("YJR105W",646).
component("U16_",66).
component("U15_",58).
component("YPL188W",964).
component("YJR049C",636).
component("YEL041W",403).
component("U96_",180).
component("YKL001C",658).
component("YDR236C",359).
component("YML070W",768).
component("YFL053W",453).
component("YHL032C",539).
component("YLR133W",719).
component("YDR531W",397).
component("U83_",167).
component("U82_",166).
component("U81_",165).
component("YMR208W",801).
component("YPL203W",965).
component("YOR061W",896).
component("YKL166C",678).
component("YJL164C",621).
component("YIL035C",574).
component("YHR205W",568).
component("YHR102W",560).
component("YGL019W",469).
component("YHR025W",548).
component("YOR347C",938).
component("YAL038W",187).
component("YNR012W",859).
component("YPR121W",1001).
component("YPL258C",974).
component("YOL055C",878).
component("YPL214C",968).
component("U1_",91).
component("YDR009W",324).
component("YBR020W",212).
component("YNL267W",847).
component("YLR305C",742).
component("YFR019W",456).
component("YDR208W",356).
component("YDR127W",347).
component("U21_",104).
component("U20_",99).
component("YDR147W",350).
component("YDR300C",370).
component("YCR012W",270).
component("YER052C",416).
component("YER069W",426).
component("U19_",90).
component("U18_",82).
component("U17_",75).
component("U76_",160).
component("YMR220W",803).
component("YER170W",443).
component("YDR226W",357).
component("YKL067W",666).
component("YOL055C",879).
component("YDR454C",390).
component("YJR057W",638).
component("YOL061W",883).
component("YKL181W",680).
component("YHL011C",536).
component("YER099C",437).
component("YBL068W",202).
component("YOR143C",909).
component("YNL256W",844).
component("YLR328W",746).
component("YBR018C",208).
component("YBR018C",209).
component("YGR007W",494).
component("YLR328W",747).
component("YKR002W",692).
component("U80_",164).
component("YDL103C",298).
component("U94_",179).
component("YJR010W",632).
component("YGL130W",480).
component("YDR530C",396).
component("YCL050C",267).
component("YPR190C",1009).
component("YPR187W",1008).
component("YPR110C",999).
component("YPR010C",987).
component("YOR341W",937).
component("YOR340C",936).
component("YOR224C",923).
component("YOR210W",920).
component("YOR207C",917).
component("YOR151C",910).
component("YOR116C",902).
component("YOL005C",871).
component("YNR003C",857).
component("YNL248C",842).
component("YNL151C",835).
component("YNL113W",829).
component("YKL144C",674).
component("YJR063W",639).
component("YJL148W",618).
component("YJL140W",617).
component("YIL021W",573).
component("YHR143W-A",563).
component("YGL070C",477).
component("YFL036W",452).
component("YDR404C",384).
component("YDR156W",352).
component("YDR045C",330).
component("YDL150W",307).
component("YDL140C",302).
component("YBR154C",239).
component("YPR175W",1005).
component("YPL167C",961).
component("YOR330C",933).
component("YOL115W",889).
component("YNL299W",853).
component("YNL262W",846).
component("YNL102W",827).
component("YJR043C",635).
component("YJR006W",631).
component("YJL090C",609).
component("YIL139C",588).
component("YEL055C",406).
component("YDR419W",387).
component("YDR121W",344).
component("YDL102W",297).
component("YCR014C",271).
component("YBR278W",255).
component("YBL035C",196).
component("YKL035W",663).
component("YHL012W",537).
component("YHR123W",561).
component("YPR113W",1000).
component("YBR243C",248).
component("YNL130C",831).
component("YDL142C",306).
component("YPL148C",959).
component("YER026C",414).
component("YCL004W",260).
component("YOR251C",926).
component("YGR286C",533).
component("YJL068C",606).
component("YDR058C",335).
component("YNR034W",863).
component("YHR163W",565).
component("YGR248W",527).
component("YCR073W-A",277).
component("YDL086W",292).
component("YOL011W",873).
component("YMR008C",778).
component("YMR006C",777).
component("U105_",24).
component("U101_",21).
component("YBL015W",194).
component("YJL068C",607).
component("YPL072W",953).
component("YOR124C",903).
component("YNL186W",837).
component("YMR304W",817).
component("YMR223W",804).
component("YKR098C",702).
component("YJL197W",625).
component("YIL156W",590).
component("YFR010W",455).
component("YER151C",441).
component("YER144C",440).
component("YER098W",436).
component("YDR069C",338).
component("YDL122W",299).
component("YBR058C",219).
component("YBL067C",201).
component("YDR272W",365).
component("U84_",168).
component("YDR481C",391).
component("YLR377C",753).
component("YDR074W",339).
component("YPL179W",963).
component("YNR032W",861).
component("YML057W",767).
component("YML016C",760).
component("YLR433C",757).
component("YGR123C",507).
component("YER133W",439).
component("YER089C",433).
component("YDR436W",388).
component("YDR075W",340).
component("YDL188C",314).
component("YDL134C",301).
component("YDL047W",284).
component("YDL006W",278).
component("YBR125C",232).
component("YBL056W",200).
component("YPR073C",994).
component("YHR215W",570).
component("YDL024C",281).
component("YBR093C",226).
component("YBR092C",225).
component("YAR071W",190).
component("YIL053W",577).
component("YER062C",424).
component("YHR046C",551).
component("U9_",183).
component("YGR208W",523).
component("YPL228W",969).
component("YMR180C",797).
component("YDL236W",320).
component("YJL155C",620).
component("YPR073C",995).
component("YOR208W",918).
component("YNL053W",824).
component("YMR036C",783).
component("YIR026C",596).
component("YIL113W",584).
component("YFR028C",457).
component("YER075C",429).
component("YDL230W",318).
component("YBR276C",254).
component("U34_",123).
component("U33_",122).
component("U32_",121).
component("U31_",120).
...
component("U25_",115).
component("U24_",114).
component("YOL064C",884).
component("YPL268W",978).
component("YOR360C",941).
component("YGL248W",491).
component("YKR031C",695).
component("YPL206C",966).
component("YGL027C",471).
component("YLR286C",737).
component("YJR153W",655).
component("YJL221C",630).
component("YJL216C",628).
component("YIL172C",595).
component("YGR292W",535).
component("YGR287C",534).
component("YBR299W",259).
component("YBR184W",242).
component("YIL162W",593).
component("YOR190W",915).
component("YLR300W",738).
component("YGR282C",532).
component("YDR261C",363).
component("YDR400W",382).
component("U23_",113).
component("YML035C",763).
component("YJL070C",608).
component("YBR284W",256).
component("U102_",22).
component("YNL045W",822).
component("YLR160C",727).
component("YLR158C",726).
component("YLR157C",725).
component("YLR155C",724).
component("YDR321W",372).
component("YGL037C",472).
component("YMR293C",813).
component("YDR242W",360).
component("YLR308W",745).
component("YLR307W",744).
component("YBR208C",244).
component("YMR281W",812).
component("U53_",139).
component("YIR027C",597).
component("YPL111W",957).
component("YIR032C",600).
component("YIR029W",598).
component("YPR062W",992).
component("YMR120C",792).
component("YLR028C",710).
component("YHR144C",564).
component("YGR267C",531).
component("YNL141W",832).
component("YBL033C",195).
component("YBR153W",238).
component("YDL238C",321).
component("YNL141W",833).
component("YLR245C",735).
component("YML035C",764).
component("YBR084W",223).
component("YJL126W",613).
component("U44_",130).
component("YDL100C",296).
component("U87_",171).
component("U40_",128).
component("YMR267W",809).
component("YBR011C",207).
component("YHR201C",567).
component("YBR111C",227).
component("YBR252W",251).
component("YCL030C",264).
component("YPR080W",997).
component("YOR187W",914).
component("YOR133W",906).
component("YLR069C",715).
component("YKR084C",699).
component("YKL173W",679).
component("YJL102W",611).
component("YDR385W",380).
component("YBR118W",230).
component("YER005W",410).
component("YLL001W",703).
component("YIL048W",576).
component("YER166W",442).
component("YDR093W",342).
component("YAL026C",186).
component("YLR231C",733).
component("U88_",172).
component("YLR134W",720).
component("YLR044C",712).
component("YGR087C",503).
component("YDR380W",379).
component("YDL080C",290).
component("U98_",181).
component("YMR250W",806).
component("YKL184W",684).
component("YOR128C",904).
component("YEL021W",402).
component("YNR043W",865).
component("U93_",178).
component("YDR047W",332).
component("U54_",140).
component("YKL211C",688) :- not remove_orf("YKL211C",688).
component("YKR097W",701).
component("YOL052C",877).
component("YNL169C",836).
component("YGR170W",512).
component("YKL060C",665).
component("YNL256W",845).
component("YDR294C",367).
component("YEL046C",404).
component("YNR033W",862).
component("YPR006C",986).
component("YER065C",425).
component("YKL211C",689) :- not remove_orf("YKL211C",689).
component("YER090W",689) :- not remove_orf("YER090W",689).
component("YER090W",434) :- not remove_orf("YER090W",434).
component("YDR127W",348).
component("YPL281C",983).
component("YOR393W",946).
component("YMR323W",819).
component("YHR174W",566).
component("YGR254W",528).
component("YPL262W",975).
component("YGL026C",470) :- not remove_orf("YGL026C",470).
component("YGR155W",511).
component("YLR304C",741).
component("YJL200C",626).
component("YNL316C",854).
component("YKL182W",682).
component("YPL212C",967).
component("YNL292W",852).
component("YGL063W",476).
component("YFL001W",446).
component("YOR278W",928).
component("YPR002W",985).
component("U49_",134).
component("YJR016C",633).
component("YCR053W",276).
component("YDR127W",349).
component("YGL148W",481).
component("YIL168W",594).
component("YER086W",431).
component("YCL064C",268).
component("YLR359W",752).
component("YAL012W",184).
component("YFR055W",462).
component("YJL005W",603).
component("YOR176W",912).
component("YJL121C",612).
component("YBR019C",210).
component("YBR019C",211).
component("YDR050C",333).
component("YDR007W",323) :- not remove_orf("YDR007W",323).
component("YOR095C",900).
component("YER003C",409).
component("YBR196C",243).
component("YGL001C",464).
component("U14_",50).
component("YOL056W",880).
component("YKL152C",677).
component("YDL021W",279).
component("YMR105C",787).
component("YKL127W",671).
component("YEL058W",407).
component("YPR060C",991).
component("YHR072W",554).
component("YJL153C",619).
component("YPL097W",955).
component("YGR185C",518).
component("YGR264C",530).
component("YGR171C",513).
component("YHR011W",544).
component("YDR023W",326).
component("YPL104W",956).
component("YLL018C",704).
component("YPR081C",998).
component("YBR121C",231).
component("YHR020W",547).
component("YER087W",432).
component("YNL247W",841).
component("YOL033W",875).
component("YGL245W",490).
component("YHR091C",556).
component("YDR341C",373).
component("YOL097C",887).
component("YDR268W",364).
component("YPR047W",990).
component("YLR060W",714).
component("YFL022C",450).
component("YPR033C",988).
component("YHR019C",545).
component("YCR024C",272).
component("YHR019C",546).
component("YPL160W",960).
component("YLR382C",754).
component("YNL073W",826).
component("YDR037W",328).
component("YOR335C",934).
component("YGR094W",505).
component("YOR317W",930).
component("YMR246W",805).
component("YIL009W",572).
component("YER015W",412).
component("YOR142W",908).
component("YGR244C",526).
component("YPR035W",989).
component("U89_",173).
component("YOR241W",925).
component("YMR113W",789).
component("YKL132C",672).
component("YOR339C",935).
component("YMR022W",782).
component("YLR306W",743).
component("YKL210W",687).
component("YGR133W",509).
component("YGL058W",474).
component("YER100W",438).
component("YEL012W",400).
component("YDR177W",354).
component("YDR092W",341).
component("YDR059C",336).
component("YDR054C",334).
component("YDL064W",286).
component("YBR082C",222).
component("YJL101C",610).
component("YOL049W",876).
component("U92_",177).
component("YAR015W",189).
component("YGL234W",488).
component("YER183C",445).
component("U91_",176).
component("U90_",175).
component("YNR057C",868).
component("YDL141W",303).
component("YDL141W",304).
component("YGL234W",489).
component("YDL141W",305).
component("YJR103W",644).
component("YBL039C",197).
component("YGR204W",522).
component("YBR084W",224).
component("YNL220W",839).
component("YOL058W",881).
component("YBR208C",245).
component("YHR074W",555).
component("YMR217W",802).
component("YGR061C",502).
component("YPR145W",1003).
component("YGR124W",508).
component("YOR303W",929).
component("YJR109C",647).
component("YJL130C",615).
component("YGL062W",475).
component("YBR218C",246).
component("YPL231W",973).
component("YNR016C",860).
component("YKL182W",683).
component("YGR037C",498).
component("YOR005C",895).
component("YDL164C",308).
component("YOL010W",872).
component("YPR138C",1002).
component("YPL274W",980).
component("YPL265W",976).
component("YPL134C",958).
component("YPL057C",952).
component("YPL036W",951).
component("YOR348C",939).
component("YOR222W",922).
component("YOR192C",916).
component("YOR171C",911).
component("YOR130C",905).
component("YOR071C",898).
component("YOL156W",894).
component("YOL103W",888).
component("YOL020W",874) :- not remove_orf("YOL020W",874).
component("YNR072W",870).
component("YNR056C",867).
component("YNL318C",855).
component("YNL268W",848).
component("YNL142W",834).
component("YMR272C",811).
component("YMR202W",799).
component("YMR011W",779).
component("YML123C",776).
component("YLR348C",749).
component("YLR260W",736).
component("YLR237W",734).
component("YLR138W",721).
component("YLR100C",718).
component("YLR081W",716).
component("YLL061W",707).
component("YLL043W",706).
component("YKR093W",700).
component("YKR053C",697).
component("YKR039W",696) :- not remove_orf("YKR039W",696).
component("YKL217W",691).
component("YKL120W",670).
component("YKL004W",659).
component("YJR158W",656).
component("YJR152W",654).
component("YJR095W",643).
component("YJR077C",641).
component("YJL219W",629).
component("YJL214W",627).
component("YJL134W",616).
component("YJL129C",614).
component("YIL134W",587).
component("YHR096C",559).
component("YHR094C",558).
component("YHR092C",557).
component("YHL036W",540).
component("YHL016C",538).
component("YGR121C",506).
component("YGR055W",500).
component("YGL186C",483).
component("YGL077C",478).
component("YGL008C",465).
component("YFL055W",454).
component("YFL011W",447).
component("YER060W-A",421).
component("YER060W",420).
component("YER056C",419).
component("YER053C",417).
component("YEL069C",408).
component("YEL017C-A",401).
component("YDR536W",398).
component("YDR508C",394).
component("YDR503C",393).
component("YDR497C",392).
component("YDR345C",376).
component("YDR343C",375).
component("YDR342C",374).
component("YDR297W",369).
component("YDR294C",368).
component("YDR284C",366).
component("YDR046C",331) :- not remove_orf("YDR046C",331).
component("YDL245C",322).
component("YDL210W",315).
component("YCR032W",274).
component("YCR024C-A",273).
component("YCL025C",262).
component("YBR298C",258).
component("YBR291C",257).
component("YBR069C",221) :- not remove_orf("YBR069C",221).
component("YBR068C",220) :- not remove_orf("YBR068C",220).
component("YBR036C",217).
component("YBR021W",213).
component("YBL042C",198).
component("U85_",169).
component("U7_",163).
component("U79_",162).
component("U78_",161).
...
catalyst(6160,815).
catalyst(3870,418).
catalyst(3620,378) :- not remove_reaction(3620,378).
catalyst(2110,460).
catalyst(2190,460).
catalyst(5550,649).
catalyst(5791,732).
...
catalyst(1960,332).
catalyst(3460,140).
catalyst(3600,688) :- not remove_reaction(3600,688).
catalyst(8000,701).
catalyst(3941,877).
catalyst(3942,877).
catalyst(6890,836).
...
catalyst(8020,986).
catalyst(8020,425).
catalyst(1890,689) :- not remove_reaction(1890,689).
catalyst(3630,689) :- not remove_reaction(3630,689).
catalyst(1890,434) :- not remove_reaction(1890,434).
catalyst(3630,434) :- not remove_reaction(3630,434).
catalyst(3740,348).
catalyst(8231,983).
catalyst(8232,983).
catalyst(8231,946).
...
catalyst(8281,333).
catalyst(8282,333).
catalyst(3610,323) :- not remove_reaction(3610,323).
catalyst(7921,900).
catalyst(7922,900).
catalyst(7841,409).
catalyst(7842,409).
...
catalyst(1210,894).
catalyst(1160,888).
catalyst(801,874) :- not remove_reaction(801,874).
catalyst(802,874) :- not remove_reaction(802,874).
catalyst(811,874) :- not remove_reaction(811,874).
catalyst(812,874) :- not remove_reaction(812,874).
catalyst(831,874) :- not remove_reaction(831,874).
catalyst(832,874) :- not remove_reaction(832,874).
catalyst(901,874) :- not remove_reaction(901,874).
catalyst(902,874) :- not remove_reaction(902,874).
catalyst(941,874) :- not remove_reaction(941,874).
catalyst(942,874) :- not remove_reaction(942,874).
catalyst(1170,870).
catalyst(1180,870).
catalyst(1210,870).
catalyst(700,867).
...
catalyst(650,700).
catalyst(6560,697).
catalyst(761,696) :- not remove_reaction(761,696).
catalyst(762,696) :- not remove_reaction(762,696).
catalyst(771,696) :- not remove_reaction(771,696).
catalyst(772,696) :- not remove_reaction(772,696).
catalyst(781,696) :- not remove_reaction(781,696).
catalyst(782,696) :- not remove_reaction(782,696).
catalyst(791,696) :- not remove_reaction(791,696).
catalyst(792,696) :- not remove_reaction(792,696).
catalyst(801,696) :- not remove_reaction(801,696).
catalyst(802,696) :- not remove_reaction(802,696).
catalyst(811,696) :- not remove_reaction(811,696).
catalyst(812,696) :- not remove_reaction(812,696).
catalyst(821,696) :- not remove_reaction(821,696).
catalyst(822,696) :- not remove_reaction(822,696).
catalyst(831,696) :- not remove_reaction(831,696).
catalyst(832,696) :- not remove_reaction(832,696).
catalyst(841,696) :- not remove_reaction(841,696).
catalyst(842,696) :- not remove_reaction(842,696).
catalyst(861,696) :- not remove_reaction(861,696).
catalyst(862,696) :- not remove_reaction(862,696).
catalyst(881,696) :- not remove_reaction(881,696).
catalyst(882,696) :- not remove_reaction(882,696).
catalyst(901,696) :- not remove_reaction(901,696).
catalyst(902,696) :- not remove_reaction(902,696).
catalyst(911,696) :- not remove_reaction(911,696).
catalyst(912,696) :- not remove_reaction(912,696).
catalyst(921,696) :- not remove_reaction(921,696).
catalyst(922,696) :- not remove_reaction(922,696).
catalyst(941,696) :- not remove_reaction(941,696).
catalyst(942,696) :- not remove_reaction(942,696).
catalyst(1191,696) :- not remove_reaction(1191,696).
catalyst(1192,696) :- not remove_reaction(1192,696).
catalyst(390,691).
catalyst(1021,691).
catalyst(1022,691).
catalyst(1521,670).
...
catalyst(6550,368).
catalyst(6690,366).
catalyst(791,331) :- not remove_reaction(791,331).
catalyst(792,331) :- not remove_reaction(792,331).
catalyst(801,331) :- not remove_reaction(801,331).
catalyst(802,331) :- not remove_reaction(802,331).
catalyst(811,331) :- not remove_reaction(811,331).
catalyst(812,331) :- not remove_reaction(812,331).
catalyst(831,331) :- not remove_reaction(831,331).
catalyst(832,331) :- not remove_reaction(832,331).
catalyst(841,331) :- not remove_reaction(841,331).
catalyst(842,331) :- not remove_reaction(842,331).
catalyst(861,331) :- not remove_reaction(861,331).
catalyst(862,331) :- not remove_reaction(862,331).
catalyst(901,331) :- not remove_reaction(901,331).
catalyst(902,331) :- not remove_reaction(902,331).
catalyst(1170,322).
catalyst(1180,322).
catalyst(1210,322).
catalyst(690,315).
...
catalyst(1511,257).
catalyst(1512,257).
catalyst(771,221) :- not remove_reaction(771,221).
catalyst(772,221) :- not remove_reaction(772,221).
catalyst(791,221) :- not remove_reaction(791,221).
catalyst(792,221) :- not remove_reaction(792,221).
catalyst(801,221) :- not remove_reaction(801,221).
catalyst(802,221) :- not remove_reaction(802,221).
catalyst(811,221) :- not remove_reaction(811,221).
catalyst(812,221) :- not remove_reaction(812,221).
catalyst(861,221) :- not remove_reaction(861,221).
catalyst(862,221) :- not remove_reaction(862,221).
catalyst(901,221) :- not remove_reaction(901,221).
catalyst(902,221) :- not remove_reaction(902,221).
catalyst(791,220) :- not remove_reaction(791,220).
catalyst(792,220) :- not remove_reaction(792,220).
catalyst(801,220) :- not remove_reaction(801,220).
catalyst(802,220) :- not remove_reaction(802,220).
catalyst(811,220) :- not remove_reaction(811,220).
catalyst(812,220) :- not remove_reaction(812,220).
catalyst(831,220) :- not remove_reaction(831,220).
catalyst(832,220) :- not remove_reaction(832,220).
catalyst(841,220) :- not remove_reaction(841,220).
catalyst(842,220) :- not remove_reaction(842,220).
catalyst(861,220) :- not remove_reaction(861,220).
catalyst(862,220) :- not remove_reaction(862,220).
catalyst(901,220) :- not remove_reaction(901,220).
catalyst(902,220) :- not remove_reaction(902,220).
catalyst(6600,217).
catalyst(620,213).
catalyst(540,198).
catalyst(2660,169).
...
modifiable_enzyme(689).
modifiable_enzyme(434).
modifiable_enzyme(470).
modifiable_enzyme(323).
modifiable_enzyme(874).
modifiable_enzyme(696).
modifiable_enzyme(331).
modifiable_enzyme(221).
modifiable_enzyme(220).
