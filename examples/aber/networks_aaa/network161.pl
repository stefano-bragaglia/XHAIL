...
component("YNL280C",841).
component("YLR056W",705).
component("YGR060W",494).
component("YGL012W",459).
component("YKR009C",685).
component("YOL086C",876).
component("YMR303C",807).
component("YMR083W",776).
component("YGL256W",486).
component("YDL168W",302).
component("YBR145W",227).
component("YPL231W",961).
component("YBR265W",246).
component("U46_",128).
component("YBR149W",228).
component("YBR149W",229).
component("YJR159W",650).
component("YGL001C",456).
component("YIL094C",574).
component("YHR063C",546).
component("U45_",127).
component("YBR153W",230).
component("YML056C",757).
component("YLR432W",747).
component("YHR216W",564).
component("YAR075W",186).
component("YAR073W",185).
component("YCL030C",256).
component("YDR127W",338).
component("YJR139C",644).
component("YML075C",760).
component("YLR450W",749).
component("YOL126C",881).
component("YKL085W",660).
component("YDL078C",282).
component("YKL029C",655).
component("YOR136W",898).
component("YNL037C",812).
component("YDL066W",280).
component("YNL241C",831).
component("YOL059W",873).
component("YDL022W",273).
component("YLR355C",742).
component("YIL074C",572).
component("YER081W",423).
component("YML054C",756).
component("YDL174C",305).
component("YML086C",761).
component("YIL155C",582).
component("YPR191W",1000).
component("YOR065W",888).
component("YJL166W",615).
component("YHR001W-A",534).
component("YGR183C",510).
component("YFR033C",452).
component("YDR529C",388).
component("YBL045C",193).
component("Q0105",18).
component("YGR088W",497).
component("YDR256C",355).
component("YKL026C",654).
component("YIR037W",594).
component("YBR244W",242).
component("YJR078W",635).
component("U58_",140).
component("YJR025C",627).
component("YGR255C",522).
component("U108_",25).
component("YBL098W",197).
component("YMR015C",772).
component("YHR007C",535).
component("YDR402C",376).
component("YGL055W",466).
component("YGR175C",507).
component("YJR104C",638).
component("YHR008C",536).
component("YJL026W",597).
component("YIL066C",571).
component("YGR180C",509).
component("YER070W",420).
component("U38_",122).
component("U36_",121).
component("U35_",120).
component("YDL168W",303).
component("YDR158W",346).
component("YBR006W",200).
component("YPL276W",973).
component("YPL275W",972).
component("YOR388C",936).
component("YOR374W",933).
component("YER073W",421).
component("U68_",146).
component("YGL154C",475).
component("U55_",137).
component("YOR323C",923).
component("YMR170C",787).
component("YMR169C",786).
component("U2_",114).
component("YER178W",437).
component("YBR221C",240).
component("YIL125W",579).
component("U52_",134).
component("YBR166C",233).
component("YNL280C",842).
component("YGL012W",460).
component("YKL182W",673).
component("U57_",139).
component("YKL216W",682).
component("YDR044W",322).
component("YER014W",404).
component("YKR009C",686).
component("YIL160C",584).
component("YGL205W",480).
component("YMR118C",781).
component("YLR164W",719).
component("YLL041C",697).
component("YKL148C",667).
component("YKL141W",665).
component("YJL045W",598).
component("YDR178W",348).
component("YJR051W",630).
component("YEL047C",398).
component("YDL171C",304).
component("YDL215C",309).
component("YOR375C",934).
component("YDL215C",310).
component("YAL062W",182).
component("U99_",176).
component("YBR035C",210).
component("YMR189W",789).
component("U56_",138).
component("YNR050C",857).
component("YHR037W",542).
component("YKR080W",690).
component("YER023W",406).
component("YPL023C",940).
component("YGL125W",472).
component("YOR236W",915).
component("YGR204W",514).
component("YLR142W",714).
component("U63_",144).
component("U62_",143).
component("YOR356W",931).
component("YKL150W",668).
component("YIL043C",568).
component("YHR042W",543).
component("YOR221C",912).
component("YML120C",765).
component("YKL192C",677).
component("YKL055C",657).
component("YER061C",415).
component("YMR145C",784).
component("YML120C",766).
component("YKL192C",678).
component("YDL085W",284).
component("YGR234W",517).
component("YFR030W",451).
component("YPL017C",939).
component("YFL018C",442).
component("YPL091W",945).
component("YDR353W",370).
component("YER042W",408).
component("YJR137C",643).
component("YNL052W",814).
component("YMR256C",798).
component("YLR395C",746).
component("YLR038C",703).
component("YIL111W",576).
component("YHR051W",545).
component("YGL191W",478).
component("YGL187C",477).
component("YDL067C",281).
component("Q0275",20).
component("Q0250",19).
component("YPL266W",968).
component("YML110C",764).
component("YBR034C",209).
component("YPL273W",970).
component("YLL062C",700).
component("YDR410C",379).
component("U47_",129).
component("YER091C",428).
component("YJR073C",633).
component("YDR120C",336).
component("YML008C",750).
component("YDL033C",275).
component("YOL096C",877).
component("YLR172C",720).
component("YDR019C",318).
component("YBR176W",234).
component("YDR408C",378).
component("YMR120C",782).
component("YBL013W",187).
component("YKL024C",653).
component("YPR074C",987).
component("YBR117C",222).
component("YLR354C",741).
component("YGR043C",492).
component("YMR108W",779).
component("YCL009C",254).
component("YMR062C",775).
component("YNL071W",816).
component("YNR008W",849).
component("YIL160C",585).
component("YNL277W",840).
component("YDR232W",351).
component("YFL017C",441).
component("YPL231W",962).
component("YER061C",416).
component("U86_",164).
component("YPL001W",938).
component("YMR296C",805).
component("YDR062W",330).
component("YDL052C",278).
component("U8_",168).
component("YDR148C",344).
component("YOR377W",935).
component("YGR177C",508).
component("YPL231W",963).
component("YGR147C",503).
component("YDL040C",276).
component("YPL028W",941).
component("YLR195C",721).
component("YGL017W",461).
component("YPR001W",975).
component("YNR001C",847).
component("YCR005C",262).
component("YNL104C",819).
component("YDL182W",306).
component("YDL131W",293).
component("YNL117W",821).
component("YIR031C",592).
component("YOR321W",922).
component("YJR143C",645).
component("YGR199W",513).
component("YDR307W",364).
component("YDL095W",288).
component("YDL093W",287).
component("YAL023C",179).
component("YOR103C",892).
component("YOR085W",890).
component("YMR149W",785).
component("YML019W",752).
component("YJL002C",595).
component("YEL002C",392).
component("YDL232W",312).
component("YCL043C",259).
component("YNL029C",811).
component("YIL085C",573).
component("YMR261C",799).
component("YML100W",762).
component("YBR126C",226).
component("YNL192W",829).
component("YBR038W",212).
component("YBR023C",208).
component("YMR306W",809).
component("YLR342W",739).
component("YGR032W",490).
component("YPR183W",997).
component("YLR209C",722).
component("U104_",23).
component("YMR271C",801).
component("YML106W",763).
component("YOR209C",910).
component("YMR300C",806).
component("YER055C",411).
component("YDR354W",371) :- not remove_orf("YDR354W",371).
component("YFR047C",453).
component("YJR133W",642).
component("YLR209C",723).
component("YML022W",753).
component("YDR441C",382).
component("YDR399W",374).
component("YPR176C",996).
component("YPL172C",953).
component("YNR041C",855).
component("YMR101C",777).
component("YDL090C",286).
component("YBR003W",199).
component("YBR002C",198).
component("YJL167W",616).
component("YJL167W",617).
component("YNL256W",834).
component("YPR069C",984).
component("YDR127W",339).
component("YLR303W",730).
component("YGR012W",488).
component("YJR130C",641).
component("YLR303W",731).
component("YDR035W",320).
component("YBR249C",243).
component("YOR274W",918).
component("YOL143C",884).
component("YBR256C",245).
component("YHR137W",555).
component("YGL202W",479).
component("YLR027C",701).
component("YKL106W",662).
component("YOL140W",883).
component("YKL104C",661).
component("YGR019W",489).
component("YLR089C",709).
component("U64_",145).
component("U61_",142).
component("U51_",133).
component("YJR148W",646).
component("YHR208W",562).
component("YFL030W",444).
component("YOR184W",904).
component("YNR058W",860).
component("YIL116W",578).
component("YGL253W",485).
component("YFR053C",454).
component("YOL136C",882).
component("YIL107C",575).
component("YMR013C",771).
component("YMR205C",791).
component("YGR240C",518).
component("YDR248C",354).
component("YCR036W",268).
component("YGR194C",512).
component("YCL040W",258).
component("YJR105W",639).
component("U16_",63).
component("U15_",56).
component("YPL188W",955).
component("YJR049C",629).
component("YEL041W",396).
component("U96_",174).
component("YKL001C",651).
component("YDR236C",352).
component("YML070W",759).
component("YFL053W",446).
component("YHL032C",532).
component("YLR133W",711).
component("YDR531W",390).
component("U83_",161).
component("U82_",160).
component("U81_",159).
component("YMR208W",792).
component("YPL203W",956).
component("YOR061W",887).
component("YKL166C",670).
component("YJL164C",614).
component("YIL035C",567).
component("YHR205W",561).
component("YHR102W",553).
component("YGL019W",462).
component("YHR025W",541).
component("YOR347C",929).
component("YAL038W",181).
component("YNR012W",850).
component("YPR121W",992).
component("YPL258C",965).
component("YOL055C",869).
component("YPL214C",959).
component("U1_",88).
component("YDR009W",317).
component("YBR020W",206).
component("YNL267W",838).
component("YLR305C",733).
component("YFR019W",449).
component("YDR208W",349).
component("YDR127W",340).
component("U21_",100).
component("U20_",96).
component("YDR147W",343).
component("YDR300C",363).
component("YCR012W",263).
component("YER052C",409).
component("YER069W",419).
component("U19_",87).
component("U18_",79).
component("U17_",72).
component("U76_",154).
component("YMR220W",794).
component("YER170W",436).
component("YDR226W",350).
component("YKL067W",659).
component("YOL055C",870).
component("YDR454C",383).
component("YJR057W",631).
component("YOL061W",874).
component("YKL181W",672).
component("YHL011C",529).
component("YER099C",430).
component("YBL068W",196).
component("YOR143C",900).
component("YNL256W",835).
component("YLR328W",737).
component("YBR018C",202).
component("YBR018C",203).
component("YGR007W",487).
component("YLR328W",738).
component("YKR002W",684).
component("U80_",158).
component("YDL103C",291).
component("U94_",173).
component("YJR010W",625).
component("YGL130W",473).
component("YDR530C",389).
component("YCL050C",260).
component("YPR190C",999).
component("YPR187W",998).
component("YPR110C",990).
component("YPR010C",978).
component("YOR341W",928).
component("YOR340C",927).
component("YOR224C",914).
component("YOR210W",911).
component("YOR207C",908).
component("YOR151C",901).
component("YOR116C",893).
component("YOL005C",862).
component("YNR003C",848).
component("YNL248C",833).
component("YNL151C",826).
component("YNL113W",820).
component("YKL144C",666).
component("YJR063W",632).
component("YJL148W",611).
component("YJL140W",610).
component("YIL021W",566).
component("YHR143W-A",556).
component("YGL070C",470).
component("YFL036W",445).
component("YDR404C",377).
component("YDR156W",345).
component("YDR045C",323).
component("YDL150W",300).
component("YDL140C",295).
component("YBR154C",232).
component("YPR175W",995).
component("YPL167C",952).
component("YOR330C",924).
component("YOL115W",880).
component("YNL299W",844).
component("YNL262W",837).
component("YNL102W",818).
component("YJR043C",628).
component("YJR006W",624).
component("YJL090C",602).
component("YIL139C",581).
component("YEL055C",399).
component("YDR419W",380).
component("YDR121W",337).
component("YDL102W",290).
component("YCR014C",264).
component("YBR278W",248).
component("YBL035C",190).
component("YKL035W",656).
component("YHL012W",530).
component("YHR123W",554).
component("YPR113W",991).
component("YBR243C",241).
component("YNL130C",822).
component("YDL142C",299).
component("YPL148C",950).
component("YER026C",407).
component("YCL004W",253).
component("YOR251C",917).
component("YGR286C",526).
component("YJL068C",599).
component("YDR058C",328).
component("YNR034W",854).
component("YHR163W",558).
component("YGR248W",520).
component("YCR073W-A",270).
component("YDL086W",285).
component("YOL011W",864).
component("YMR008C",769).
component("YMR006C",768).
component("U105_",24).
component("U101_",21).
component("YBL015W",188).
component("YJL068C",600).
component("YPL072W",944).
component("YOR124C",894).
component("YNL186W",828).
component("YMR304W",808).
component("YMR223W",795).
component("YKR098C",694).
component("YJL197W",618).
component("YIL156W",583).
component("YFR010W",448).
component("YER151C",434).
component("YER144C",433).
component("YER098W",429).
component("YDR069C",331).
component("YDL122W",292).
component("YBR058C",213).
component("YBL067C",195).
component("YDR272W",358).
component("U84_",162).
component("YDR481C",384).
component("YLR377C",744).
component("YDR074W",332).
component("YPL179W",954).
component("YNR032W",852).
component("YML057W",758).
component("YML016C",751).
component("YLR433C",748).
component("YGR123C",500).
component("YER133W",432).
component("YER089C",426).
component("YDR436W",381).
component("YDR075W",333).
component("YDL188C",307).
component("YDL134C",294).
component("YDL047W",277).
component("YDL006W",271).
component("YBR125C",225).
component("YBL056W",194).
component("YPR073C",985).
component("YHR215W",563).
component("YDL024C",274).
component("YBR093C",220).
component("YBR092C",219).
component("YAR071W",184).
component("YIL053W",570).
component("YER062C",417).
component("YHR046C",544).
component("U9_",177).
component("YGR208W",516).
component("YPL228W",960).
component("YMR180C",788).
component("YDL236W",313).
component("YJL155C",613).
component("YPR073C",986).
component("YOR208W",909).
component("YNL053W",815).
component("YMR036C",774).
component("YIR026C",589).
component("YIL113W",577).
component("YFR028C",450).
component("YER075C",422).
component("YDL230W",311).
component("YBR276C",247).
component("U34_",119).
component("U33_",118).
component("U32_",117).
component("U31_",116).
...
component("U25_",111).
component("U24_",110).
component("YOL064C",875).
component("YPL268W",969).
component("YOR360C",932).
component("YGL248W",484).
component("YKR031C",687).
component("YPL206C",957).
component("YGL027C",464).
component("YLR286C",728).
component("YJR153W",648).
component("YJL221C",623).
component("YJL216C",621).
component("YIL172C",588).
component("YGR292W",528).
component("YGR287C",527).
component("YBR299W",252).
component("YBR184W",235).
component("YIL162W",586).
component("YOR190W",906).
component("YLR300W",729).
component("YGR282C",525).
component("YDR261C",356).
component("YDR400W",375).
component("U23_",109).
component("YML035C",754).
component("YJL070C",601).
component("YBR284W",249).
component("U102_",22).
component("YNL045W",813).
component("YLR160C",718).
component("YLR158C",717).
component("YLR157C",716).
component("YLR155C",715).
component("YDR321W",365).
component("YGL037C",465).
component("YMR293C",804).
component("YDR242W",353).
component("YLR308W",736).
component("YLR307W",735).
component("YBR208C",237).
component("YMR281W",803).
component("U53_",135).
component("YIR027C",590).
component("YPL111W",948).
component("YIR032C",593).
component("YIR029W",591).
component("YPR062W",983).
component("YMR120C",783).
component("YLR028C",702).
component("YHR144C",557).
component("YGR267C",524).
component("YNL141W",823).
component("YBL033C",189).
component("YBR153W",231).
component("YDL238C",314).
component("YNL141W",824).
component("YLR245C",726).
component("YML035C",755).
component("YBR084W",217).
component("YJL126W",606).
component("U44_",126).
component("YDL100C",289).
component("U87_",165).
component("U40_",124).
component("YMR267W",800).
component("YBR011C",201).
component("YHR201C",560).
component("YBR111C",221).
component("YBR252W",244).
component("YCL030C",257).
component("YPR080W",988).
component("YOR187W",905).
component("YOR133W",897).
component("YLR069C",707).
component("YKR084C",691).
component("YKL173W",671).
component("YJL102W",604).
component("YDR385W",373).
component("YBR118W",223).
component("YER005W",403).
component("YLL001W",695).
component("YIL048W",569).
component("YER166W",435).
component("YDR093W",335).
component("YAL026C",180).
component("YLR231C",724).
component("U88_",166).
component("YLR134W",712).
component("YLR044C",704).
component("YGR087C",496).
component("YDR380W",372).
component("YDL080C",283).
component("U98_",175).
component("YMR250W",797).
component("YKL184W",676).
component("YOR128C",895).
component("YEL021W",395).
component("YNR043W",856).
component("U93_",172).
component("YDR047W",325).
component("U54_",136).
component("YKL211C",680) :- not remove_orf("YKL211C",680).
component("YKR097W",693).
component("YOL052C",868).
component("YNL169C",827).
component("YGR170W",505).
component("YKL060C",658).
component("YNL256W",836).
component("YDR294C",360).
component("YEL046C",397).
component("YNR033W",853).
component("YPR006C",977).
component("YER065C",418).
component("YKL211C",681) :- not remove_orf("YKL211C",681).
component("YER090W",681) :- not remove_orf("YER090W",681).
component("YER090W",427) :- not remove_orf("YER090W",427).
component("YDR127W",341).
component("YPL281C",974).
component("YOR393W",937).
component("YMR323W",810).
component("YHR174W",559).
component("YGR254W",521).
component("YPL262W",966).
component("YGL026C",463) :- not remove_orf("YGL026C",463).
component("YGR155W",504).
component("YLR304C",732).
component("YJL200C",619).
component("YNL316C",845).
component("YKL182W",674).
component("YPL212C",958).
component("YNL292W",843).
component("YGL063W",469).
component("YFL001W",439).
component("YOR278W",919).
component("YPR002W",976).
component("U49_",130).
component("YJR016C",626).
component("YCR053W",269).
component("YDR127W",342).
component("YGL148W",474).
component("YIL168W",587).
component("YER086W",424).
component("YCL064C",261).
component("YLR359W",743).
component("YAL012W",178).
component("YFR055W",455).
component("YJL005W",596).
component("YOR176W",903).
component("YJL121C",605).
component("YBR019C",204).
component("YBR019C",205).
component("YDR050C",326).
component("YDR007W",316) :- not remove_orf("YDR007W",316).
component("YOR095C",891).
component("YER003C",402).
component("YBR196C",236).
component("YGL001C",457).
component("U14_",48).
component("YOL056W",871).
component("YKL152C",669).
component("YDL021W",272).
component("YMR105C",778).
component("YKL127W",663).
component("YEL058W",400).
component("YPR060C",982).
component("YHR072W",547).
component("YJL153C",612).
component("YPL097W",946).
component("YGR185C",511).
component("YGR264C",523).
component("YGR171C",506).
component("YHR011W",537).
component("YDR023W",319).
component("YPL104W",947).
component("YLL018C",696).
component("YPR081C",989).
component("YBR121C",224).
component("YHR020W",540).
component("YER087W",425).
component("YNL247W",832).
component("YOL033W",866).
component("YGL245W",483).
component("YHR091C",549).
component("YDR341C",366).
component("YOL097C",878).
component("YDR268W",357).
component("YPR047W",981).
component("YLR060W",706).
component("YFL022C",443).
component("YPR033C",979).
component("YHR019C",538).
component("YCR024C",265).
component("YHR019C",539).
component("YPL160W",951).
component("YLR382C",745).
component("YNL073W",817).
component("YDR037W",321).
component("YOR335C",925).
component("YGR094W",498).
component("YOR317W",921).
component("YMR246W",796).
component("YIL009W",565).
component("YER015W",405).
component("YOR142W",899).
component("YGR244C",519).
component("YPR035W",980).
component("U89_",167).
component("YOR241W",916).
component("YMR113W",780).
component("YKL132C",664).
component("YOR339C",926).
component("YMR022W",773).
component("YLR306W",734).
component("YKL210W",679).
component("YGR133W",502).
component("YGL058W",467).
component("YER100W",431).
component("YEL012W",393).
component("YDR177W",347).
component("YDR092W",334).
component("YDR059C",329).
component("YDR054C",327).
component("YDL064W",279).
component("YBR082C",216).
component("YJL101C",603).
component("YOL049W",867).
component("U92_",171).
component("YAR015W",183).
component("YGL234W",481).
component("YER183C",438).
component("U91_",170).
component("U90_",169).
component("YNR057C",859).
component("YDL141W",296).
component("YDL141W",297).
component("YGL234W",482).
component("YDL141W",298).
component("YJR103W",637).
component("YBL039C",191).
component("YGR204W",515).
component("YBR084W",218).
component("YNL220W",830).
component("YOL058W",872).
component("YBR208C",238).
component("YHR074W",548).
component("YMR217W",793).
component("YGR061C",495).
component("YPR145W",994).
component("YGR124W",501).
component("YOR303W",920).
component("YJR109C",640).
component("YJL130C",608).
component("YGL062W",468).
component("YBR218C",239).
component("YPL231W",964).
component("YNR016C",851).
component("YKL182W",675).
component("YGR037C",491).
component("YOR005C",886).
component("YDL164C",301).
component("YOL010W",863).
component("YPR138C",993).
component("YPL274W",971).
component("YPL265W",967).
component("YPL134C",949).
component("YPL057C",943).
component("YPL036W",942).
component("YOR348C",930).
component("YOR222W",913).
component("YOR192C",907).
component("YOR171C",902).
component("YOR130C",896).
component("YOR071C",889).
component("YOL156W",885).
component("YOL103W",879).
component("YOL020W",865) :- not remove_orf("YOL020W",865).
component("YNR072W",861).
component("YNR056C",858).
component("YNL318C",846).
component("YNL268W",839).
component("YNL142W",825).
component("YMR272C",802).
component("YMR202W",790).
component("YMR011W",770).
component("YML123C",767).
component("YLR348C",740).
component("YLR260W",727).
component("YLR237W",725).
component("YLR138W",713).
component("YLR100C",710).
component("YLR081W",708).
component("YLL061W",699).
component("YLL043W",698).
component("YKR093W",692).
component("YKR053C",689).
component("YKR039W",688) :- not remove_orf("YKR039W",688).
component("YKL217W",683).
component("YKL004W",652).
component("YJR158W",649).
component("YJR152W",647).
component("YJR095W",636).
component("YJR077C",634).
component("YJL219W",622).
component("YJL214W",620).
component("YJL134W",609).
component("YJL129C",607).
component("YIL134W",580).
component("YHR096C",552).
component("YHR094C",551).
component("YHR092C",550).
component("YHL036W",533).
component("YHL016C",531).
component("YGR121C",499).
component("YGR055W",493).
component("YGL186C",476).
component("YGL077C",471).
component("YGL008C",458).
component("YFL055W",447).
component("YFL011W",440).
component("YER060W-A",414).
component("YER060W",413).
component("YER056C",412).
component("YER053C",410).
component("YEL069C",401).
component("YEL017C-A",394).
component("YDR536W",391).
component("YDR508C",387).
component("YDR503C",386).
component("YDR497C",385).
component("YDR345C",369).
component("YDR343C",368).
component("YDR342C",367).
component("YDR297W",362).
component("YDR294C",361).
component("YDR284C",359).
component("YDR046C",324) :- not remove_orf("YDR046C",324).
component("YDL245C",315).
component("YDL210W",308).
component("YCR032W",267).
component("YCR024C-A",266).
component("YCL025C",255).
component("YBR298C",251).
component("YBR291C",250).
component("YBR069C",215) :- not remove_orf("YBR069C",215).
component("YBR068C",214) :- not remove_orf("YBR068C",214).
component("YBR036C",211).
component("YBR021W",207).
component("YBL042C",192).
component("U85_",163).
component("U7_",157).
component("U79_",156).
component("U78_",155).
...
catalyst(6160,806).
catalyst(3870,411).
catalyst(3620,371) :- not remove_reaction(3620,371).
catalyst(2110,453).
catalyst(2190,453).
catalyst(5550,642).
catalyst(5791,723).
...
catalyst(1960,325).
catalyst(3460,136).
catalyst(3600,680) :- not remove_reaction(3600,680).
catalyst(8000,693).
catalyst(3941,868).
catalyst(3942,868).
catalyst(6890,827).
...
catalyst(8020,977).
catalyst(8020,418).
catalyst(1890,681) :- not remove_reaction(1890,681).
catalyst(3630,681) :- not remove_reaction(3630,681).
catalyst(1890,427) :- not remove_reaction(1890,427).
catalyst(3630,427) :- not remove_reaction(3630,427).
catalyst(3740,341).
catalyst(8231,974).
catalyst(8232,974).
catalyst(8231,937).
...
catalyst(8051,966).
catalyst(8052,966).
catalyst(3590,463) :- not remove_reaction(3590,463).
catalyst(10910,463) :- not remove_reaction(10910,463).
catalyst(4570,504).
catalyst(8181,732).
catalyst(8182,732).
catalyst(8181,619).
...
catalyst(8281,326).
catalyst(8282,326).
catalyst(3610,316) :- not remove_reaction(3610,316).
catalyst(7921,891).
catalyst(7922,891).
catalyst(7841,402).
catalyst(7842,402).
...
catalyst(1210,885).
catalyst(1160,879).
catalyst(801,865) :- not remove_reaction(801,865).
catalyst(802,865) :- not remove_reaction(802,865).
catalyst(811,865) :- not remove_reaction(811,865).
catalyst(812,865) :- not remove_reaction(812,865).
catalyst(831,865) :- not remove_reaction(831,865).
catalyst(832,865) :- not remove_reaction(832,865).
catalyst(901,865) :- not remove_reaction(901,865).
catalyst(902,865) :- not remove_reaction(902,865).
catalyst(941,865) :- not remove_reaction(941,865).
catalyst(942,865) :- not remove_reaction(942,865).
catalyst(1170,861).
catalyst(1180,861).
catalyst(1210,861).
catalyst(700,858).
...
catalyst(650,692).
catalyst(6560,689).
catalyst(761,688) :- not remove_reaction(761,688).
catalyst(762,688) :- not remove_reaction(762,688).
catalyst(771,688) :- not remove_reaction(771,688).
catalyst(772,688) :- not remove_reaction(772,688).
catalyst(781,688) :- not remove_reaction(781,688).
catalyst(782,688) :- not remove_reaction(782,688).
catalyst(791,688) :- not remove_reaction(791,688).
catalyst(792,688) :- not remove_reaction(792,688).
catalyst(801,688) :- not remove_reaction(801,688).
catalyst(802,688) :- not remove_reaction(802,688).
catalyst(811,688) :- not remove_reaction(811,688).
catalyst(812,688) :- not remove_reaction(812,688).
catalyst(821,688) :- not remove_reaction(821,688).
catalyst(822,688) :- not remove_reaction(822,688).
catalyst(831,688) :- not remove_reaction(831,688).
catalyst(832,688) :- not remove_reaction(832,688).
catalyst(841,688) :- not remove_reaction(841,688).
catalyst(842,688) :- not remove_reaction(842,688).
catalyst(861,688) :- not remove_reaction(861,688).
catalyst(862,688) :- not remove_reaction(862,688).
catalyst(881,688) :- not remove_reaction(881,688).
catalyst(882,688) :- not remove_reaction(882,688).
catalyst(901,688) :- not remove_reaction(901,688).
catalyst(902,688) :- not remove_reaction(902,688).
catalyst(911,688) :- not remove_reaction(911,688).
catalyst(912,688) :- not remove_reaction(912,688).
catalyst(921,688) :- not remove_reaction(921,688).
catalyst(922,688) :- not remove_reaction(922,688).
catalyst(941,688) :- not remove_reaction(941,688).
catalyst(942,688) :- not remove_reaction(942,688).
catalyst(1191,688) :- not remove_reaction(1191,688).
catalyst(1192,688) :- not remove_reaction(1192,688).
catalyst(390,683).
catalyst(1021,683).
catalyst(1022,683).
catalyst(6610,652).
...
catalyst(6550,361).
catalyst(6690,359).
catalyst(791,324) :- not remove_reaction(791,324).
catalyst(792,324) :- not remove_reaction(792,324).
...
catalyst(861,324) :- not remove_reaction(861,324).
catalyst(862,324) :- not remove_reaction(862,324).
...
catalyst(1511,250).
catalyst(1512,250).
catalyst(771,215) :- not remove_reaction(771,215).
catalyst(772,215) :- not remove_reaction(772,215).
catalyst(791,215) :- not remove_reaction(791,215).
catalyst(792,215) :- not remove_reaction(792,215).
catalyst(801,215) :- not remove_reaction(801,215).
catalyst(802,215) :- not remove_reaction(802,215).
catalyst(811,215) :- not remove_reaction(811,215).
catalyst(812,215) :- not remove_reaction(812,215).
catalyst(861,215) :- not remove_reaction(861,215).
catalyst(862,215) :- not remove_reaction(862,215).
catalyst(901,215) :- not remove_reaction(901,215).
catalyst(902,215) :- not remove_reaction(902,215).
catalyst(791,214) :- not remove_reaction(791,214).
catalyst(792,214) :- not remove_reaction(792,214).
catalyst(801,214) :- not remove_reaction(801,214).
catalyst(802,214) :- not remove_reaction(802,214).
catalyst(811,214) :- not remove_reaction(811,214).
catalyst(812,214) :- not remove_reaction(812,214).
catalyst(831,214) :- not remove_reaction(831,214).
catalyst(832,214) :- not remove_reaction(832,214).
catalyst(841,214) :- not remove_reaction(841,214).
catalyst(842,214) :- not remove_reaction(842,214).
catalyst(861,214) :- not remove_reaction(861,214).
catalyst(862,214) :- not remove_reaction(862,214).
catalyst(901,214) :- not remove_reaction(901,214).
catalyst(902,214) :- not remove_reaction(902,214).
catalyst(6600,211).
catalyst(620,207).
catalyst(540,192).
catalyst(2660,163).
...
modifiable_enzyme(680).
modifiable_enzyme(681).
modifiable_enzyme(427).
modifiable_enzyme(463).
modifiable_enzyme(316).
modifiable_enzyme(865).
modifiable_enzyme(688).
modifiable_enzyme(324).
modifiable_enzyme(215).
modifiable_enzyme(214).
