...
component("YGR060W",182).
component("YGL012W",169).
component("YOL086C",305).
component("YMR303C",282).
component("YGL256W",177).
component("YDL168W",113).
component("YBR145W",86).
component("YPL231W",336).
component("YGL001C",166).
component("YML056C",267).
component("YLR432W",264).
component("YHR216W",204).
component("YAR075W",72).
component("YAR073W",71).
component("YDR127W",125).
component("YJR139C",232).
component("YOR136W",311).
component("YIL155C",208).
component("YJR078W",225).
component("YJR025C",221).
component("YBL098W",76).
component("YMR015C",271).
component("YDR402C",141).
component("YJR104C",228).
component("YHR008C",196).
component("YER070W",154).
component("YDL168W",114).
component("YPL276W",343).
component("YPL275W",342).
component("YOR388C",328).
component("YGL154C",175).
component("YOR323C",322).
component("YMR170C",277).
component("YMR169C",276).
component("YBR166C",89).
component("YER014W",151).
component("YMR118C",275).
component("YLR164W",254).
component("YLL041C",250).
component("YKL148C",240).
component("YJL045W",212).
component("YDR178W",131).
component("YJR051W",222).
component("YEL047C",149).
component("YOR375C",327).
component("YDL215C",115).
component("YAL062W",70).
component("YBR035C",79).
component("YER023W",152).
component("YOR236W",320).
component("YGR204W",189).
component("U62_",52).
component("YPL017C",331).
component("YFL018C",158).
component("U47_",46).
component("YKL024C",235).
component("YPR074C",350).
component("YBR117C",85).
component("YCL009C",99).
component("YMR062C",273).
component("YPL231W",337).
component("YPL001W",330).
component("YPL231W",338).
component("YGR147C",186).
component("YDL040C",107).
component("YPL028W",332).
component("YPR001W",345).
component("YNR001C",295).
component("YNL117W",288).
component("YIR031C",210).
component("YNL029C",284).
component("YIL085C",206).
component("YLR209C",255).
component("YMR300C",281).
component("YER055C",153).
component("YDR354W",137) :- not remove_orf("YDR354W",137).
component("YFR047C",164).
component("YJR133W",231).
component("YML022W",265).
component("YDR441C",143).
component("YDR399W",139).
component("YDR127W",126).
component("YJR130C",230).
component("YLR303W",261).
component("YDR035W",120).
component("YBR249C",93).
component("YBR256C",94).
component("YHR137W",199).
component("YLR027C",251).
component("YKL106W",237).
component("YGR019W",179).
component("U64_",53).
component("U51_",48).
component("YJR148W",233).
component("YGL253W",176).
component("YFR053C",165).
component("YMR205C",279).
component("YGR240C",190).
component("YCR036W",105).
component("YCL040W",101).
component("YJR105W",229).
component("U16_",26).
component("U15_",24).
component("YKL001C",234).
component("YML070W",268).
component("YFL053W",160).
component("U83_",63).
component("U82_",62).
component("YMR208W",280).
component("YOR347C",326).
component("YAL038W",69).
component("YPR121W",352).
component("YPL258C",340).
component("YOL055C",302).
component("U1_",34).
component("YNL267W",293).
component("YLR305C",262).
component("YFR019W",162).
component("YDR208W",132).
component("YDR127W",127).
component("U21_",38).
component("U20_",37).
component("YDR300C",135).
component("YCR012W",103).
component("U18_",31).
component("U76_",61).
component("YDR454C",144).
component("YOL061W",304).
component("YKL181W",241).
component("YHL011C",193).
component("YER099C",157).
component("YBL068W",75).
component("YOR143C",312).
component("YGR007W",178).
component("YCL050C",102).
component("YPR190C",355).
component("YPR187W",354).
component("YPR110C",351).
component("YPR010C",346).
component("YOR341W",325).
component("YOR340C",324).
component("YOR224C",319).
component("YOR210W",318).
component("YOR207C",316).
component("YOR151C",313).
component("YOR116C",310).
component("YOL005C",299).
component("YNR003C",296).
component("YNL248C",292).
component("YNL151C",291).
component("YNL113W",287).
component("YKL144C",239).
component("YJR063W",223).
component("YJL148W",219).
component("YJL140W",218).
component("YIL021W",205).
component("YHR143W-A",200).
component("YGL070C",173).
component("YFL036W",159).
component("YDR404C",142).
component("YDR156W",130).
component("YDR045C",121).
component("YDL150W",111).
component("YDL140C",110).
component("YBR154C",88).
component("YKL035W",236).
component("YHL012W",194).
component("YDR058C",124).
component("YDL086W",109).
component("YOL011W",300).
component("YMR008C",270).
component("YMR006C",269).
component("U101_",18).
component("YBL015W",73).
component("U84_",64).
component("YPR073C",348).
component("YHR215W",203).
component("YDL024C",106).
component("YBR093C",83).
component("YBR092C",82).
component("YPL228W",335).
component("YMR180C",278).
component("YDL236W",117).
component("YJL155C",220).
component("YPR073C",349).
component("YOR208W",317).
component("YNL053W",286).
component("YMR036C",272).
component("YIR026C",209).
component("YIL113W",207).
component("YFR028C",163).
component("YER075C",155).
component("YDL230W",116).
component("YBR276C",95).
component("U34_",44).
component("U30_",43).
component("U25_",42).
component("U24_",41).
component("YKR031C",246).
component("YLR286C",259).
component("YOR190W",314).
component("YLR300W",260).
component("YGR282C",192).
component("YDR261C",133).
component("YDR400W",140).
component("YML035C",266).
component("YJL070C",213).
component("YBR284W",96).
component("YNL045W",285).
component("YGL037C",171).
component("YBR208C",90).
component("U53_",49).
component("YIR032C",211).
component("YHR144C",201).
component("YBR153W",87).
component("YDL238C",118).
component("YNL141W",289).
component("YLR245C",258).
component("YJL126W",215).
component("YBR111C",84).
component("YER005W",150).
component("YLR231C",256).
component("U88_",65).
component("YLR134W",253).
component("YLR044C",252).
component("YGR087C",183).
component("YDR380W",138).
component("YDL080C",108).
component("U93_",67).
component("U54_",50).
component("YKL211C",244) :- not remove_orf("YKL211C",244).
component("YGR170W",188).
component("YDR294C",134).
component("YNR033W",298).
...
component("YPL281C",344).
component("YOR393W",329).
component("YMR323W",283).
component("YHR174W",202).
component("YGR254W",191).
component("YGL026C",170) :- not remove_orf("YGL026C",170).
component("YGR155W",187).
component("YNL316C",294).
component("YKL182W",242).
component("YDR127W",129).
component("YGL148W",174).
component("YAL012W",68).
component("YBR019C",77).
component("YDR050C",123).
component("YDR007W",119) :- not remove_orf("YDR007W",119).
component("YOR095C",309).
component("YGL001C",167).
component("YMR105C",274).
component("YKL127W",238).
component("YPR060C",347).
component("YPL104W",334).
component("YLL018C",249).
component("YHR091C",198).
component("YDR341C",136).
component("YOL097C",306).
component("YOR335C",323).
component("YGR094W",184).
component("U89_",66).
component("YJL101C",214).
component("YJR103W",227).
component("YBL039C",74).
component("YOL058W",303).
component("YBR208C",91).
component("YHR074W",197).
component("YOR303W",321).
component("YGL062W",172).
component("YBR218C",92).
component("YPL231W",339).
component("YNR016C",297).
component("YKL182W",243).
component("YGR037C",180).
component("YOR005C",307).
component("YDL164C",112).
component("YPR138C",353).
component("YPL265W",341).
component("YPL036W",333).
component("YOR192C",315).
component("YOR071C",308).
component("YOL020W",301) :- not remove_orf("YOL020W",301).
component("YNL142W",290).
component("YLR348C",263).
component("YLR237W",257).
component("YKR053C",248).
component("YKR039W",247) :- not remove_orf("YKR039W",247).
component("YJR095W",226).
component("YJR077C",224).
component("YJL134W",217).
component("YJL129C",216).
component("YHL036W",195).
component("YGR121C",185).
component("YGR055W",181).
component("YGL008C",168).
component("YFL055W",161).
component("YEL017C-A",148).
component("YDR536W",147).
component("YDR508C",146).
component("YDR503C",145).
component("YDR046C",122) :- not remove_orf("YDR046C",122).
component("YCR024C-A",104).
component("YCL025C",100).
component("YBR298C",98).
component("YBR291C",97).
component("YBR069C",81) :- not remove_orf("YBR069C",81).
component("YBR068C",80) :- not remove_orf("YBR068C",80).
component("YBR021W",78).
component("U75_",60).
component("U74_",59).
component("U73_",58).
component("U72_",57).
...
catalyst(6160,281).
catalyst(3870,153).
catalyst(3620,137) :- not remove_reaction(3620,137).
catalyst(2190,164).
catalyst(5550,231).
catalyst(5650,265).
catalyst(5650,143).
...
catalyst(2300,67).
catalyst(3460,50).
catalyst(3600,244) :- not remove_reaction(3600,244).
catalyst(6900,188).
catalyst(8781,134).
catalyst(8782,134).
catalyst(2550,298).
...
catalyst(8231,191).
catalyst(8232,191).
catalyst(3590,170) :- not remove_reaction(3590,170).
catalyst(10910,170) :- not remove_reaction(10910,170).
catalyst(4570,187).
catalyst(3680,294).
catalyst(7141,242).
catalyst(7142,242).
...
catalyst(8281,123).
catalyst(8282,123).
catalyst(3610,119) :- not remove_reaction(3610,119).
catalyst(7921,309).
catalyst(7922,309).
catalyst(6370,167).
catalyst(7861,274).
...
catalyst(190,257).
catalyst(6560,248).
catalyst(771,247) :- not remove_reaction(771,247).
catalyst(772,247) :- not remove_reaction(772,247).
catalyst(781,247) :- not remove_reaction(781,247).
catalyst(782,247) :- not remove_reaction(782,247).
...
catalyst(881,247) :- not remove_reaction(881,247).
catalyst(882,247) :- not remove_reaction(882,247).
catalyst(1191,247) :- not remove_reaction(1191,247).
catalyst(1192,247) :- not remove_reaction(1192,247).
catalyst(1250,226).
catalyst(1581,224).
catalyst(1582,224).
catalyst(6560,217).
...
catalyst(1501,97).
catalyst(1502,97).
catalyst(771,81) :- not remove_reaction(771,81).
catalyst(772,81) :- not remove_reaction(772,81).
...
catalyst(801,80) :- not remove_reaction(801,80).
catalyst(802,80) :- not remove_reaction(802,80).
catalyst(811,80) :- not remove_reaction(811,80).
catalyst(812,80) :- not remove_reaction(812,80).
catalyst(831,80) :- not remove_reaction(831,80).
catalyst(832,80) :- not remove_reaction(832,80).
catalyst(841,80) :- not remove_reaction(841,80).
catalyst(842,80) :- not remove_reaction(842,80).
catalyst(620,78).
catalyst(2920,60).
catalyst(2920,59).
catalyst(2920,58).
