...
component("YNL280C",450).
component("YGR060W",277).
component("YGL012W",259).
component("YOL086C",467).
component("YMR303C",431).
component("YGL256W",271).
component("YDL168W",165).
component("YBR145W",127).
component("YPL231W",512).
component("YBR149W",128).
component("YGL001C",256).
component("YHR063C",302).
component("YBR153W",129).
component("YML056C",410).
component("YLR432W",406).
component("YHR216W",310).
component("YAR075W",104).
component("YAR073W",103).
component("YDR127W",182).
component("YJR139C",352).
component("YKL029C",356).
component("YOR136W",478).
component("YDL066W",156).
component("YLR355C",404).
component("YML086C",412).
component("YIL155C",318).
component("YPR191W",537).
component("YOR065W",473).
component("YJL166W",334).
component("YHR001W-A",298).
component("YGR183C",286).
component("YFR033C",252).
component("YDR529C",213).
component("YBL045C",109).
component("Q0105",18).
component("YGR088W",279).
component("YDR256C",195).
component("YJR078W",344).
component("YJR025C",339).
component("YGR255C",292).
component("YBL098W",112).
component("YMR015C",416).
component("YDR402C",205).
component("YJR104C",347).
component("YHR008C",299).
component("YER070W",232).
component("U35_",64).
component("YDL168W",166).
component("YDR158W",189).
component("YPL276W",520).
component("YPL275W",519).
component("YOR388C",500).
component("YGL154C",266).
component("U55_",73).
component("YOR323C",490).
component("YMR170C",424).
component("YMR169C",423).
component("U2_",61).
component("YBR221C",136).
component("U52_",70).
component("YBR166C",132).
component("YNL280C",451).
component("YER014W",222).
component("YMR118C",421).
component("YLR164W",389).
component("YLL041C",379).
component("YKL148C",363).
component("YJL045W",323).
component("YDR178W",190).
component("YJR051W",341).
component("YEL047C",217).
component("YOR375C",498).
component("YDL215C",168).
component("YAL062W",101).
component("U99_",97).
component("YBR035C",118).
component("YKR080W",376).
component("YER023W",223).
component("YOR236W",487).
component("YGR204W",287).
component("U62_",75).
component("YKL150W",364).
component("YIL043C",312).
component("YHR042W",300).
component("YFR030W",251).
component("YPL017C",503).
component("YFL018C",243).
component("YER042W",225).
component("YJR137C",351).
component("YPL273W",518).
component("YLL062C",381).
component("U47_",67).
component("YER091C",235).
component("YDL033C",154).
component("YOL096C",468).
component("YDR019C",173).
component("YDR408C",207).
component("YBL013W",105).
component("YKL024C",355).
component("YPR074C",530).
component("YBR117C",126).
component("YLR354C",403).
component("YGR043C",275).
component("YCL009C",145).
component("YMR062C",418).
component("YPL231W",513).
component("U86_",89).
component("YPL001W",502).
component("YOR377W",499).
component("YGR177C",285).
component("YPL231W",514).
component("YGR147C",282).
component("YDL040C",155).
component("YPL028W",504).
component("YPR001W",522).
component("YNR001C",455).
component("YDL182W",167).
component("YNL117W",439).
component("YIR031C",321).
component("YNL029C",434).
component("YIL085C",315).
component("YNL192W",444).
component("YBR038W",119).
component("YBR023C",117).
component("YLR209C",390).
component("YMR300C",430).
component("YER055C",227).
component("YDR354W",201) :- not remove_orf("YDR354W",201).
component("YFR047C",253).
component("YJR133W",350).
component("YLR209C",391).
component("YML022W",407).
component("YDR441C",209).
component("YDR399W",203).
component("YNL256W",446).
component("YDR127W",183).
component("YLR303W",397).
component("YJR130C",349).
component("YLR303W",398).
component("YDR035W",174).
component("YBR249C",137).
component("YOL143C",471).
component("YBR256C",138).
component("YHR137W",305).
component("YGL202W",268).
component("YLR027C",382).
component("YKL106W",359).
component("YKL104C",358).
component("YGR019W",273).
component("YLR089C",385).
component("U64_",76).
component("U51_",69).
component("YJR148W",353).
component("YGL253W",270).
component("YFR053C",254).
component("YMR205C",426).
component("YGR240C",289).
component("YDR248C",194).
component("YCR036W",152).
component("YCL040W",147).
component("YJR105W",348).
component("U16_",36).
component("U15_",33).
component("U96_",95).
component("YKL001C",354).
component("YML070W",411).
component("YFL053W",246).
component("YHL032C",296).
component("U83_",87).
component("U82_",86).
component("YMR208W",427).
component("YOR347C",495).
component("YAL038W",100).
component("YPR121W",532).
component("YPL258C",516).
component("YOL055C",464).
component("U1_",45).
component("YBR020W",115).
component("YNL267W",448).
component("YLR305C",400).
component("YFR019W",249).
component("YDR208W",191).
component("YDR127W",184).
component("U21_",53).
component("U20_",51).
component("YDR147W",187).
component("YDR300C",199).
component("YCR012W",149).
component("U18_",42).
component("U76_",84).
component("YER170W",241).
component("YDR226W",192).
component("YDR454C",210).
component("YOL061W",466).
component("YKL181W",366).
component("YHL011C",294).
component("YER099C",237).
component("YBL068W",111).
component("YOR143C",479).
component("YGR007W",272).
component("YLR328W",401).
component("YJR010W",338).
component("YCL050C",148).
component("YPR190C",536).
component("YPR187W",535).
component("YPR110C",531).
component("YPR010C",524).
component("YOR341W",494).
component("YOR340C",493).
component("YOR224C",486).
component("YOR210W",485).
component("YOR207C",483).
component("YOR151C",480).
component("YOR116C",476).
component("YOL005C",460).
component("YNR003C",456).
component("YNL248C",445).
component("YNL151C",442).
component("YNL113W",438).
component("YKL144C",362).
component("YJR063W",342).
component("YJL148W",332).
component("YJL140W",331).
component("YIL021W",311).
component("YHR143W-A",306).
component("YGL070C",264).
component("YFL036W",245).
component("YDR404C",206).
component("YDR156W",188).
component("YDR045C",175).
component("YDL150W",163).
component("YDL140C",161).
component("YBR154C",131).
component("YPR175W",534).
component("YPL167C",509).
component("YOR330C",491).
component("YOL115W",470).
component("YNL299W",453).
component("YNL262W",447).
component("YNL102W",437).
component("YJR043C",340).
component("YJR006W",337).
component("YJL090C",326).
component("YIL139C",317).
component("YEL055C",218).
component("YDR419W",208).
component("YDR121W",181).
component("YDL102W",159).
component("YCR014C",150).
component("YBR278W",140).
component("YBL035C",107).
component("YKL035W",357).
component("YHL012W",295).
component("YER026C",224).
component("YCL004W",144).
component("YDR058C",178).
component("YDL086W",158).
component("YOL011W",461).
component("YMR008C",415).
component("YMR006C",414).
component("U101_",19).
component("YBL015W",106).
component("YJL068C",324).
component("YPL072W",506).
component("YOR124C",477).
component("YNL186W",443).
component("YMR304W",432).
component("YMR223W",428).
component("YKR098C",377).
component("YJL197W",335).
component("YIL156W",319).
component("YFR010W",248).
component("YER151C",239).
component("YER144C",238).
component("YER098W",236).
component("YDR069C",179).
component("YDL122W",160).
component("YBR058C",120).
component("YBL067C",110).
component("U84_",88).
component("YPR073C",528).
component("YHR215W",309).
component("YDL024C",153).
component("YBR093C",124).
component("YBR092C",123).
component("YAR071W",102).
component("YIL053W",314).
component("YER062C",231).
component("YHR046C",301).
component("YGR208W",288).
component("YPL228W",511).
component("YMR180C",425).
component("YDL236W",170).
component("YJL155C",333).
component("YPR073C",529).
component("YOR208W",484).
component("YNL053W",436).
component("YMR036C",417).
component("YIR026C",320).
component("YIL113W",316).
component("YFR028C",250).
component("YER075C",233).
component("YDL230W",169).
component("YBR276C",139).
component("U34_",63).
component("U30_",62).
component("U25_",60).
component("U24_",59).
component("YOR360C",497).
component("YGL248W",269).
component("YKR031C",373).
component("YLR286C",395).
component("YOR190W",481).
component("YLR300W",396).
component("YGR282C",293).
component("YDR261C",196).
component("YDR400W",204).
component("U23_",58).
component("YML035C",408).
component("YJL070C",325).
component("YBR284W",141).
component("U102_",20).
component("YNL045W",435).
component("YGL037C",261).
component("YDR242W",193).
component("YBR208C",133).
component("U53_",71).
component("YIR032C",322).
component("YMR120C",422).
component("YHR144C",307).
component("YBR153W",130).
component("YDL238C",171).
component("YNL141W",440).
component("YLR245C",394).
component("YML035C",409).
component("YJL126W",328).
component("U87_",90).
component("YBR111C",125).
component("YER005W",221).
component("YIL048W",313).
component("YER166W",240).
component("YDR093W",180).
component("YAL026C",99).
component("YLR231C",392).
component("U88_",91).
component("YLR134W",387).
component("YLR044C",383).
component("YGR087C",278).
component("YDR380W",202).
component("YDL080C",157).
component("U98_",96).
component("YKL184W",369).
component("YNR043W",459).
component("U93_",94).
component("U54_",72).
component("YKL211C",370) :- not remove_orf("YKL211C",370).
component("YGR170W",284).
component("YDR294C",197).
component("YEL046C",216).
component("YNR033W",458).
component("YKL211C",371) :- not remove_orf("YKL211C",371).
component("YER090W",371) :- not remove_orf("YER090W",371).
component("YER090W",234) :- not remove_orf("YER090W",234).
component("YDR127W",185).
component("YPL281C",521).
component("YOR393W",501).
component("YMR323W",433).
component("YHR174W",308).
component("YGR254W",291).
component("YGL026C",260) :- not remove_orf("YGL026C",260).
component("YGR155W",283).
component("YLR304C",399).
component("YJL200C",336).
component("YNL316C",454).
component("YKL182W",367).
component("YPL212C",510).
component("YNL292W",452).
component("YGL063W",263).
component("YFL001W",242).
component("YPR002W",523).
component("YDR127W",186).
component("YGL148W",265).
component("YAL012W",98).
component("YFR055W",255).
component("YBR019C",113).
component("YBR019C",114).
component("YDR050C",177).
component("YDR007W",172) :- not remove_orf("YDR007W",172).
component("YOR095C",475).
component("YER003C",220).
component("YGL001C",257).
component("YKL152C",365).
component("YMR105C",419).
component("YKL127W",360).
component("YEL058W",219).
component("YPR060C",527).
component("YPL104W",507).
component("YLL018C",378).
component("YOL033W",463).
component("YHR091C",304).
component("YDR341C",200).
component("YOL097C",469).
component("YPR047W",526).
component("YLR060W",384).
component("YFL022C",244).
component("YPR033C",525).
component("YPL160W",508).
component("YLR382C",405).
component("YOR335C",492).
component("YGR094W",280).
component("YGR244C",290).
component("U89_",92).
component("YOR241W",488).
component("YMR113W",420).
component("YKL132C",361).
component("YJL101C",327).
component("U91_",93).
component("YDL141W",162).
component("YJR103W",346).
component("YBL039C",108).
component("YOL058W",465).
component("YBR208C",134).
component("YHR074W",303).
component("YOR303W",489).
component("YGL062W",262).
component("YBR218C",135).
component("YPL231W",515).
component("YNR016C",457).
component("YKL182W",368).
component("YGR037C",274).
component("YOR005C",472).
component("YDL164C",164).
component("YPR138C",533).
component("YPL265W",517).
component("YPL036W",505).
component("YOR348C",496).
component("YOR192C",482).
component("YOR071C",474).
component("YOL020W",462) :- not remove_orf("YOL020W",462).
component("YNL268W",449).
component("YNL142W",441).
component("YMR272C",429).
component("YML123C",413).
component("YLR348C",402).
component("YLR237W",393).
component("YLR138W",388).
component("YLR100C",386).
component("YLL061W",380).
component("YKR053C",375).
component("YKR039W",374) :- not remove_orf("YKR039W",374).
component("YKL217W",372).
component("YJR095W",345).
component("YJR077C",343).
component("YJL134W",330).
component("YJL129C",329).
component("YHL036W",297).
component("YGR121C",281).
component("YGR055W",276).
component("YGL186C",267).
component("YGL008C",258).
component("YFL055W",247).
component("YER060W-A",230).
component("YER060W",229).
component("YER056C",228).
component("YER053C",226).
component("YEL017C-A",215).
component("YDR536W",214).
component("YDR508C",212).
component("YDR503C",211).
component("YDR294C",198).
component("YDR046C",176) :- not remove_orf("YDR046C",176).
component("YCR024C-A",151).
...
catalyst(2300,94).
catalyst(3460,72).
catalyst(3600,370) :- not remove_reaction(3600,370).
catalyst(6900,284).
catalyst(8781,197).
catalyst(8782,197).
catalyst(4560,216).
catalyst(2550,458).
catalyst(3630,371) :- not remove_reaction(3630,371).
...
catalyst(8231,291).
catalyst(8232,291).
catalyst(3590,260) :- not remove_reaction(3590,260).
catalyst(10910,260) :- not remove_reaction(10910,260).
catalyst(4570,283).
catalyst(8181,399).
catalyst(8182,399).
catalyst(8181,336).
...
catalyst(8281,177).
catalyst(8282,177).
catalyst(3610,172) :- not remove_reaction(3610,172).
catalyst(7921,475).
catalyst(7922,475).
catalyst(7841,220).
catalyst(7842,220).
...
catalyst(190,482).
catalyst(190,474).
catalyst(801,462) :- not remove_reaction(801,462).
catalyst(802,462) :- not remove_reaction(802,462).
catalyst(811,462) :- not remove_reaction(811,462).
catalyst(812,462) :- not remove_reaction(812,462).
catalyst(831,462) :- not remove_reaction(831,462).
catalyst(832,462) :- not remove_reaction(832,462).
catalyst(941,462) :- not remove_reaction(941,462).
catalyst(942,462) :- not remove_reaction(942,462).
catalyst(761,449).
catalyst(762,449).
catalyst(371,441).
catalyst(372,441).
...
catalyst(750,380).
catalyst(6560,375).
catalyst(761,374) :- not remove_reaction(761,374).
catalyst(762,374) :- not remove_reaction(762,374).
catalyst(771,374) :- not remove_reaction(771,374).
catalyst(772,374) :- not remove_reaction(772,374).
catalyst(781,374) :- not remove_reaction(781,374).
catalyst(782,374) :- not remove_reaction(782,374).
...
catalyst(861,374) :- not remove_reaction(861,374).
catalyst(862,374) :- not remove_reaction(862,374).
catalyst(881,374) :- not remove_reaction(881,374).
catalyst(882,374) :- not remove_reaction(882,374).
catalyst(941,374) :- not remove_reaction(941,374).
catalyst(942,374) :- not remove_reaction(942,374).
catalyst(1191,374) :- not remove_reaction(1191,374).
catalyst(1192,374) :- not remove_reaction(1192,374).
catalyst(1021,372).
catalyst(1022,372).
catalyst(1250,345).
catalyst(1581,343).
