...
component("YNL280C",661).
component("YLR056W",554).
component("YGR060W",393).
component("YGL012W",366).
component("YKR009C",538).
component("YOL086C",689).
component("YMR303C",631).
component("YMR083W",609).
component("YGL256W",385).
component("YDL168W",240).
component("YBR145W",183).
component("YPL231W",751).
component("U46_",102).
component("YBR149W",184).
component("YJR159W",509).
component("YGL001C",363).
component("YIL094C",451).
component("YHR063C",434).
component("YBR153W",185).
component("YML056C",596).
component("YLR432W",589).
component("YHR216W",445).
component("YAR075W",148).
component("YAR073W",147).
component("YDR127W",267).
component("YJR139C",504).
component("YOL126C",694).
component("YDL078C",223).
component("YKL029C",514).
component("YOR136W",704).
component("YNL037C",636).
component("YDL066W",222).
component("YNL241C",651).
component("YOL059W",687).
component("YDL022W",217).
component("YLR355C",586).
component("YML054C",595).
component("YDL174C",242).
component("YML086C",599).
component("YIL155C",457).
component("YPR191W",781).
component("YOR065W",699).
component("YJL166W",482).
component("YHR001W-A",424).
component("YGR183C",405).
component("YFR033C",359).
component("YDR529C",308).
component("YBL045C",154).
component("Q0105",18).
component("YGR088W",395).
component("YDR256C",282).
component("YKL026C",513).
component("YIR037W",465).
component("YBR244W",195).
component("YJR078W",495).
component("YJR025C",489).
component("YGR255C",417).
component("U108_",22).
component("YBL098W",158).
component("YMR015C",606).
component("YHR007C",425).
component("YDR402C",297).
component("YGL055W",371).
component("YGR175C",402).
component("YJR104C",498).
component("YHR008C",426).
component("YJL026W",466).
component("YGR180C",404).
component("YER070W",331).
component("U38_",98).
component("U35_",97).
component("YDL168W",241).
component("YDR158W",275).
component("YBR006W",159).
component("YPL276W",762).
component("YPL275W",761).
component("YOR388C",734).
component("YOR374W",731).
component("YER073W",332).
component("U68_",116).
component("YGL154C",378).
component("U55_",110).
component("YOR323C",723).
component("YMR170C",617).
component("YMR169C",616).
component("U2_",93).
component("YER178W",346).
component("YBR221C",193).
component("YIL125W",455).
component("U52_",107).
component("YBR166C",188).
component("YNL280C",662).
component("YGL012W",367).
component("U57_",111).
component("YKL216W",535).
component("YDR044W",257).
component("YER014W",319).
component("YKR009C",539).
component("YIL160C",459).
component("YGL205W",381).
component("YMR118C",613).
component("YLR164W",567).
component("YLL041C",547).
component("YKL148C",525).
component("YKL141W",523).
component("YJL045W",467).
component("YDR178W",276).
component("YJR051W",491).
component("YEL047C",314).
component("YDL215C",246).
component("YOR375C",732).
component("YDL215C",247).
component("YAL062W",145).
component("U99_",140).
component("YBR035C",169).
component("YHR037W",431).
component("YKR080W",543).
component("YER023W",320).
component("YOR236W",718).
component("YGR204W",409).
component("YLR142W",562).
component("U62_",114).
component("YKL150W",526).
component("YIL043C",447).
component("YHR042W",432).
component("YOR221C",716).
component("YML120C",602).
component("YKL192C",532).
component("YKL055C",516).
component("YER061C",328).
component("YGR234W",412).
component("YFR030W",358).
component("YPL017C",737).
component("YFL018C",350).
component("YER042W",322).
component("YJR137C",503).
component("YPL266W",758).
component("YML110C",601).
component("YBR034C",168).
component("YPL273W",759).
component("YLL062C",550).
component("YDR410C",300).
component("U47_",103).
component("YER091C",338).
component("YJR073C",493).
component("YDL033C",219).
component("YOL096C",690).
component("YLR172C",568).
component("YDR019C",253).
component("YDR408C",299).
component("YMR120C",614).
component("YBL013W",149).
component("YKL024C",512).
component("YPR074C",773).
component("YBR117C",179).
component("YLR354C",585).
component("YGR043C",391).
component("YMR108W",611).
component("YCL009C",204).
component("YMR062C",608).
component("YNL071W",639).
component("YNR008W",669).
component("YNL277W",660).
component("YFL017C",349).
component("YPL231W",752).
component("YER061C",329).
component("U86_",130).
component("YPL001W",736).
component("YDR148C",273).
component("YOR377W",733).
component("YGR177C",403).
component("YPL231W",753).
component("YGR147C",399).
component("YDL040C",220).
component("YPL028W",738).
component("YGL017W",368).
component("YPR001W",764).
component("YNR001C",667).
component("YDL182W",243).
component("YDL131W",232).
component("YNL117W",643).
component("YIR031C",463).
component("YOR321W",722).
component("YJR143C",505).
component("YGR199W",408).
component("YDR307W",290).
component("YDL095W",227).
component("YDL093W",226).
component("YAL023C",142).
component("YNL029C",635).
component("YIL085C",450).
component("YMR261C",625).
component("YML100W",600).
component("YBR126C",182).
component("YNL192W",650).
component("YBR038W",171).
component("YBR023C",167).
component("YMR306W",633).
component("YLR342W",583).
component("YGR032W",389).
component("YLR209C",569).
component("U104_",21).
component("YOR209C",714).
component("YMR300C",630).
component("YER055C",324).
component("YDR354W",293) :- not remove_orf("YDR354W",293).
component("YFR047C",360).
component("YJR133W",502).
component("YLR209C",570).
component("YML022W",592).
component("YDR441C",303).
component("YDR399W",295).
component("YJL167W",483).
component("YNL256W",654).
component("YDR127W",268).
component("YLR303W",577).
component("YGR012W",387).
component("YJR130C",501).
component("YLR303W",578).
component("YDR035W",255).
component("YBR249C",196).
component("YOL143C",696).
component("YBR256C",197).
component("YHR137W",439).
component("YGL202W",380).
component("YLR027C",551).
component("YKL106W",520).
component("YKL104C",519).
component("YGR019W",388).
component("YLR089C",557).
component("U64_",115).
component("U61_",113).
component("U51_",106).
component("YJR148W",506).
component("YOR184W",709).
component("YNR058W",677).
component("YIL116W",454).
component("YGL253W",384).
component("YFR053C",361).
component("YOL136C",695).
component("YIL107C",452).
component("YMR205C",619).
component("YGR240C",413).
component("YDR248C",281).
component("YCR036W",213).
component("YGR194C",407).
component("YCL040W",207).
component("YJR105W",499).
component("U16_",49).
component("U15_",44).
component("U96_",138).
component("YKL001C",510).
component("YDR236C",279).
component("YML070W",598).
component("YFL053W",353).
component("YHL032C",422).
component("YLR133W",559).
component("YDR531W",310).
component("U83_",128).
component("U82_",127).
component("U81_",126).
component("YMR208W",620).
component("YHR025W",430).
component("YOR347C",728).
component("YAL038W",144).
component("YNR012W",670).
component("YPR121W",776).
component("YPL258C",755).
component("YOL055C",684).
component("U1_",72).
component("YDR009W",252).
component("YBR020W",165).
component("YNL267W",658).
component("YLR305C",580).
component("YFR019W",356).
component("YDR208W",277).
component("YDR127W",269).
component("U21_",82).
component("U20_",79).
component("YDR147W",272).
component("YDR300C",289).
component("YCR012W",209).
component("U18_",64).
component("U17_",57).
component("U76_",124).
component("YMR220W",622).
component("YER170W",345).
component("YDR226W",278).
component("YKL067W",518).
component("YDR454C",304).
component("YOL061W",688).
component("YKL181W",528).
component("YHL011C",420).
component("YER099C",340).
component("YBL068W",157).
component("YOR143C",706).
component("YNL256W",655).
component("YLR328W",581).
component("YBR018C",161).
component("YBR018C",162).
component("YGR007W",386).
component("YLR328W",582).
component("YKR002W",537).
component("YDL103C",230).
component("YJR010W",488).
component("YGL130W",376).
component("YDR530C",309).
component("YCL050C",208).
component("YPR190C",780).
component("YPR187W",779).
component("YPR110C",775).
component("YPR010C",766).
component("YOR341W",727).
component("YOR340C",726).
component("YOR224C",717).
component("YOR210W",715).
component("YOR207C",712).
component("YOR151C",707).
component("YOR116C",702).
component("YOL005C",678).
component("YNR003C",668).
component("YNL248C",653).
component("YNL151C",647).
component("YNL113W",642).
component("YKL144C",524).
component("YJR063W",492).
component("YJL148W",479).
component("YJL140W",478).
component("YIL021W",446).
component("YHR143W-A",440).
component("YGL070C",374).
component("YFL036W",352).
component("YDR404C",298).
component("YDR156W",274).
component("YDR045C",258).
component("YDL150W",238).
component("YDL140C",234).
component("YBR154C",187).
component("YPR175W",778).
component("YPL167C",746).
component("YOR330C",724).
component("YOL115W",693).
component("YNL299W",664).
component("YNL262W",657).
component("YNL102W",641).
component("YJR043C",490).
component("YJR006W",487).
component("YJL090C",471).
component("YIL139C",456).
component("YEL055C",315).
component("YDR419W",301).
component("YDR121W",266).
component("YDL102W",229).
component("YCR014C",210).
component("YBR278W",199).
component("YBL035C",151).
component("YKL035W",515).
component("YHL012W",421).
component("YHR123W",438).
component("YBR243C",194).
component("YDL142C",237).
component("YER026C",321).
component("YCL004W",203).
component("YJL068C",468).
component("YDR058C",262).
component("YNR034W",674).
component("YHR163W",442).
component("YGR248W",415).
component("YCR073W-A",214).
component("YDL086W",225).
component("YOL011W",680).
component("YMR008C",605).
component("YMR006C",604).
component("U101_",19).
component("YBL015W",150).
component("YJL068C",469).
component("YPL072W",741).
component("YOR124C",703).
component("YNL186W",649).
component("YMR304W",632).
component("YMR223W",623).
component("YKR098C",545).
component("YJL197W",484).
component("YIL156W",458).
component("YFR010W",355).
component("YER151C",343).
component("YER144C",342).
component("YER098W",339).
component("YDR069C",263).
component("YDL122W",231).
component("YBR058C",172).
component("YBL067C",156).
component("YDR272W",285).
component("U84_",129).
component("YPL179W",747).
component("YNR032W",672).
component("YML057W",597).
component("YML016C",591).
component("YLR433C",590).
component("YGR123C",398).
component("YER133W",341).
component("YER089C",336).
component("YDR436W",302).
component("YDR075W",264).
component("YDL188C",244).
component("YDL134C",233).
component("YDL047W",221).
component("YDL006W",215).
component("YBR125C",181).
component("YBL056W",155).
component("YPR073C",771).
component("YHR215W",444).
component("YDL024C",218).
component("YBR093C",177).
component("YBR092C",176).
component("YAR071W",146).
component("YIL053W",449).
component("YER062C",330).
component("YHR046C",433).
component("YGR208W",411).
component("YPL228W",750).
component("YMR180C",618).
component("YDL236W",249).
component("YJL155C",481).
component("YPR073C",772).
component("YOR208W",713).
component("YNL053W",638).
component("YMR036C",607).
component("YIR026C",460).
component("YIL113W",453).
component("YFR028C",357).
component("YER075C",333).
component("YDL230W",248).
component("YBR276C",198).
component("U34_",96).
component("U33_",95).
component("U30_",94).
component("U28_",92).
...
component("U25_",90).
component("U24_",89).
component("YOR360C",730).
component("YGL248W",383).
component("YKR031C",540).
component("YPL206C",748).
component("YLR286C",575).
component("YJR153W",508).
component("YOR190W",710).
component("YLR300W",576).
component("YGR282C",419).
component("YDR261C",283).
component("YDR400W",296).
component("U23_",88).
component("YML035C",593).
component("YJL070C",470).
component("YBR284W",200).
component("U102_",20).
component("YNL045W",637).
component("YLR160C",566).
component("YLR158C",565).
component("YLR157C",564).
component("YLR155C",563).
component("YDR321W",291).
component("YGL037C",370).
component("YMR293C",629).
component("YDR242W",280).
component("YBR208C",190).
component("YMR281W",628).
component("U53_",108).
component("YIR027C",461).
component("YPL111W",744).
component("YIR032C",464).
component("YIR029W",462).
component("YPR062W",770).
component("YMR120C",615).
component("YLR028C",552).
component("YHR144C",441).
component("YGR267C",418).
component("YNL141W",644).
component("YBR153W",186).
component("YDL238C",250).
component("YNL141W",645).
component("YLR245C",573).
component("YML035C",594).
component("YJL126W",474).
component("U44_",101).
component("YDL100C",228).
component("U87_",131).
component("YMR267W",626).
component("YBR011C",160).
component("YBR111C",178).
component("YCL030C",206).
component("YER005W",318).
component("YIL048W",448).
component("YER166W",344).
component("YDR093W",265).
component("YAL026C",143).
component("YLR231C",571).
component("U88_",132).
component("YLR134W",560).
component("YLR044C",553).
component("YGR087C",394).
component("YDR380W",294).
component("YDL080C",224).
component("U98_",139).
component("YMR250W",624).
component("YKL184W",531).
component("YNR043W",675).
component("U93_",137).
component("YDR047W",260).
component("U54_",109).
component("YKL211C",533) :- not remove_orf("YKL211C",533).
component("YOL052C",683).
component("YNL169C",648).
component("YGR170W",401).
component("YKL060C",517).
component("YNL256W",656).
component("YDR294C",286).
component("YEL046C",313).
component("YNR033W",673).
component("YKL211C",534) :- not remove_orf("YKL211C",534).
component("YER090W",534) :- not remove_orf("YER090W",534).
component("YER090W",337) :- not remove_orf("YER090W",337).
component("YDR127W",270).
component("YPL281C",763).
component("YOR393W",735).
component("YMR323W",634).
component("YHR174W",443).
component("YGR254W",416).
component("YPL262W",756).
component("YGL026C",369) :- not remove_orf("YGL026C",369).
component("YGR155W",400).
component("YLR304C",579).
component("YJL200C",485).
component("YNL316C",665).
component("YKL182W",529).
component("YPL212C",749).
component("YNL292W",663).
component("YGL063W",373).
component("YFL001W",347).
component("YOR278W",720).
component("YPR002W",765).
component("YDR127W",271).
component("YGL148W",377).
component("YER086W",334).
component("YLR359W",587).
component("YAL012W",141).
component("YFR055W",362).
component("YJL121C",473).
component("YBR019C",163).
component("YBR019C",164).
component("YDR050C",261).
component("YDR007W",251) :- not remove_orf("YDR007W",251).
component("YOR095C",701).
component("YER003C",317).
component("YBR196C",189).
component("YGL001C",364).
component("U14_",37).
component("YOL056W",685).
component("YKL152C",527).
component("YDL021W",216).
component("YMR105C",610).
component("YKL127W",521).
component("YEL058W",316).
component("YPR060C",769).
component("YHR072W",435).
component("YJL153C",480).
component("YPL097W",742).
component("YGR185C",406).
component("YHR011W",427).
component("YDR023W",254).
component("YPL104W",743).
component("YLL018C",546).
component("YPR081C",774).
component("YBR121C",180).
component("YHR020W",429).
component("YER087W",335).
component("YNL247W",652).
component("YOL033W",682).
component("YHR091C",437).
component("YDR341C",292).
component("YOL097C",691).
component("YDR268W",284).
component("YPR047W",768).
component("YLR060W",555).
component("YFL022C",351).
component("YPR033C",767).
component("YHR019C",428).
component("YPL160W",745).
component("YLR382C",588).
component("YNL073W",640).
component("YDR037W",256).
component("YOR335C",725).
component("YGR094W",396).
component("YOR142W",705).
component("YGR244C",414).
component("U89_",133).
component("YOR241W",719).
component("YMR113W",612).
component("YKL132C",522).
component("YJL101C",472).
component("U92_",136).
component("YGL234W",382).
component("U91_",135).
component("U90_",134).
component("YDL141W",235).
component("YDL141W",236).
component("YJR103W",497).
component("YBL039C",152).
component("YGR204W",410).
component("YBR084W",175).
component("YOL058W",686).
component("YBR208C",191).
component("YHR074W",436).
component("YMR217W",621).
component("YOR303W",721).
component("YJR109C",500).
component("YJL130C",476).
component("YGL062W",372).
component("YBR218C",192).
component("YPL231W",754).
component("YNR016C",671).
component("YKL182W",530).
component("YGR037C",390).
component("YOR005C",698).
component("YDL164C",239).
component("YOL010W",679).
component("YPR138C",777).
component("YPL274W",760).
component("YPL265W",757).
component("YPL057C",740).
component("YPL036W",739).
component("YOR348C",729).
component("YOR192C",711).
component("YOR171C",708).
component("YOR071C",700).
component("YOL156W",697).
component("YOL103W",692).
component("YOL020W",681) :- not remove_orf("YOL020W",681).
component("YNR056C",676).
component("YNL318C",666).
component("YNL268W",659).
component("YNL142W",646).
component("YMR272C",627).
component("YML123C",603).
component("YLR348C",584).
component("YLR260W",574).
component("YLR237W",572).
component("YLR138W",561).
component("YLR100C",558).
component("YLR081W",556).
component("YLL061W",549).
component("YLL043W",548).
component("YKR093W",544).
component("YKR053C",542).
component("YKR039W",541) :- not remove_orf("YKR039W",541).
component("YKL217W",536).
component("YKL004W",511).
component("YJR152W",507).
component("YJR095W",496).
component("YJR077C",494).
component("YJL219W",486).
component("YJL134W",477).
component("YJL129C",475).
component("YHL036W",423).
component("YGR121C",397).
component("YGR055W",392).
component("YGL186C",379).
component("YGL077C",375).
component("YGL008C",365).
component("YFL055W",354).
component("YFL011W",348).
component("YER060W-A",327).
component("YER060W",326).
component("YER056C",325).
component("YER053C",323).
component("YEL017C-A",312).
component("YDR536W",311).
component("YDR508C",307).
component("YDR503C",306).
component("YDR497C",305).
component("YDR297W",288).
component("YDR294C",287).
component("YDR046C",259) :- not remove_orf("YDR046C",259).
component("YDL210W",245).
component("YCR032W",212).
component("YCR024C-A",211).
component("YCL025C",205).
component("YBR298C",202).
component("YBR291C",201).
component("YBR069C",174) :- not remove_orf("YBR069C",174).
component("YBR068C",173) :- not remove_orf("YBR068C",173).
component("YBR036C",170).
component("YBR021W",166).
component("YBL042C",153).
component("U79_",125).
component("U75_",123).
component("U74_",122).
component("U73_",121).
...
catalyst(6160,630).
catalyst(3870,324).
catalyst(3620,293) :- not remove_reaction(3620,293).
catalyst(2110,360).
catalyst(2190,360).
catalyst(5550,502).
catalyst(5791,570).
...
catalyst(1960,260).
catalyst(3460,109).
catalyst(3600,533) :- not remove_reaction(3600,533).
catalyst(3941,683).
catalyst(3942,683).
catalyst(6890,648).
catalyst(6900,401).
...
catalyst(4560,313).
catalyst(2550,673).
catalyst(1890,534) :- not remove_reaction(1890,534).
catalyst(3630,534) :- not remove_reaction(3630,534).
catalyst(1890,337) :- not remove_reaction(1890,337).
catalyst(3630,337) :- not remove_reaction(3630,337).
catalyst(3740,270).
catalyst(8231,763).
catalyst(8232,763).
catalyst(8231,735).
...
catalyst(8051,756).
catalyst(8052,756).
catalyst(3590,369) :- not remove_reaction(3590,369).
catalyst(10910,369) :- not remove_reaction(10910,369).
catalyst(4570,400).
catalyst(8181,579).
catalyst(8182,579).
catalyst(8181,485).
...
catalyst(8281,261).
catalyst(8282,261).
catalyst(3610,251) :- not remove_reaction(3610,251).
catalyst(7921,701).
catalyst(7922,701).
catalyst(7841,317).
catalyst(7842,317).
...
catalyst(640,544).
catalyst(6560,542).
catalyst(761,541) :- not remove_reaction(761,541).
catalyst(762,541) :- not remove_reaction(762,541).
catalyst(771,541) :- not remove_reaction(771,541).
catalyst(772,541) :- not remove_reaction(772,541).
catalyst(781,541) :- not remove_reaction(781,541).
catalyst(782,541) :- not remove_reaction(782,541).
catalyst(791,541) :- not remove_reaction(791,541).
catalyst(792,541) :- not remove_reaction(792,541).
catalyst(801,541) :- not remove_reaction(801,541).
catalyst(802,541) :- not remove_reaction(802,541).
catalyst(811,541) :- not remove_reaction(811,541).
catalyst(812,541) :- not remove_reaction(812,541).
catalyst(821,541) :- not remove_reaction(821,541).
catalyst(822,541) :- not remove_reaction(822,541).
catalyst(831,541) :- not remove_reaction(831,541).
catalyst(832,541) :- not remove_reaction(832,541).
catalyst(841,541) :- not remove_reaction(841,541).
catalyst(842,541) :- not remove_reaction(842,541).
catalyst(861,541) :- not remove_reaction(861,541).
catalyst(862,541) :- not remove_reaction(862,541).
catalyst(881,541) :- not remove_reaction(881,541).
catalyst(882,541) :- not remove_reaction(882,541).
catalyst(901,541) :- not remove_reaction(901,541).
catalyst(902,541) :- not remove_reaction(902,541).
catalyst(911,541) :- not remove_reaction(911,541).
catalyst(912,541) :- not remove_reaction(912,541).
catalyst(941,541) :- not remove_reaction(941,541).
catalyst(942,541) :- not remove_reaction(942,541).
catalyst(1191,541) :- not remove_reaction(1191,541).
catalyst(1192,541) :- not remove_reaction(1192,541).
catalyst(1021,536).
catalyst(1022,536).
catalyst(6610,511).
catalyst(170,507).
...
catalyst(6650,288).
catalyst(6550,287).
catalyst(791,259) :- not remove_reaction(791,259).
catalyst(792,259) :- not remove_reaction(792,259).
catalyst(801,259) :- not remove_reaction(801,259).
catalyst(802,259) :- not remove_reaction(802,259).
catalyst(811,259) :- not remove_reaction(811,259).
catalyst(812,259) :- not remove_reaction(812,259).
catalyst(831,259) :- not remove_reaction(831,259).
catalyst(832,259) :- not remove_reaction(832,259).
catalyst(841,259) :- not remove_reaction(841,259).
catalyst(842,259) :- not remove_reaction(842,259).
catalyst(861,259) :- not remove_reaction(861,259).
catalyst(862,259) :- not remove_reaction(862,259).
catalyst(901,259) :- not remove_reaction(901,259).
catalyst(902,259) :- not remove_reaction(902,259).
catalyst(730,245).
catalyst(431,212).
catalyst(432,212).
catalyst(220,211).
...
catalyst(1511,201).
catalyst(1512,201).
catalyst(771,174) :- not remove_reaction(771,174).
catalyst(772,174) :- not remove_reaction(772,174).
catalyst(791,174) :- not remove_reaction(791,174).
catalyst(792,174) :- not remove_reaction(792,174).
catalyst(801,174) :- not remove_reaction(801,174).
catalyst(802,174) :- not remove_reaction(802,174).
catalyst(811,174) :- not remove_reaction(811,174).
catalyst(812,174) :- not remove_reaction(812,174).
catalyst(861,174) :- not remove_reaction(861,174).
catalyst(862,174) :- not remove_reaction(862,174).
catalyst(901,174) :- not remove_reaction(901,174).
catalyst(902,174) :- not remove_reaction(902,174).
catalyst(791,173) :- not remove_reaction(791,173).
catalyst(792,173) :- not remove_reaction(792,173).
...
catalyst(841,173) :- not remove_reaction(841,173).
catalyst(842,173) :- not remove_reaction(842,173).
catalyst(861,173) :- not remove_reaction(861,173).
catalyst(862,173) :- not remove_reaction(862,173).
catalyst(901,173) :- not remove_reaction(901,173).
catalyst(902,173) :- not remove_reaction(902,173).
catalyst(6600,170).
catalyst(620,166).
catalyst(540,153).
catalyst(2830,125).
