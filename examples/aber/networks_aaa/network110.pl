...
component("YNL280C",621).
component("YGR060W",368).
component("YGL012W",343).
component("YKR009C",506).
component("YOL086C",649).
component("YMR303C",594).
component("YMR083W",573).
component("YGL256W",361).
component("YDL168W",223).
component("YBR145W",167).
component("YPL231W",708).
component("U46_",91).
component("YBR149W",168).
component("YJR159W",478).
component("YGL001C",340).
component("YIL094C",422).
component("YHR063C",405).
component("YBR153W",169).
component("YML056C",560).
component("YLR432W",554).
component("YHR216W",416).
component("YAR075W",134).
component("YAR073W",133).
component("YDR127W",248).
component("YJR139C",474).
component("YOL126C",654).
component("YDL078C",206).
component("YKL029C",483).
component("YOR136W",664).
component("YNL037C",598).
component("YDL066W",205).
component("YNL241C",613).
component("YOL059W",647).
component("YDL022W",200).
component("YLR355C",551).
component("YML086C",563).
component("YIL155C",428).
component("YPR191W",736).
component("YOR065W",659).
component("YJL166W",452).
component("YHR001W-A",397).
component("YGR183C",380).
component("YFR033C",336).
component("YDR529C",287).
component("YBL045C",140).
component("Q0105",18).
component("YGR088W",370).
component("YDR256C",262).
component("YKL026C",482).
component("YIR037W",435).
component("YBR244W",179).
component("YJR078W",465).
component("YJR025C",459).
component("YGR255C",390).
component("U108_",22).
component("YBL098W",144).
component("YMR015C",570).
component("YDR402C",277).
component("YGL055W",348).
component("YGR175C",377).
component("YJR104C",468).
component("YHR008C",398).
component("YJL026W",436).
component("YGR180C",379).
component("YER070W",309).
component("U35_",87).
component("YDL168W",224).
component("YDR158W",256).
component("YPL276W",717).
component("YPL275W",716).
component("YOR388C",692).
component("YOR374W",689).
component("YER073W",310).
component("YGL154C",354).
component("U55_",98).
component("YOR323C",681).
component("YMR170C",580).
component("YMR169C",579).
component("U2_",84).
component("YBR221C",177).
component("YIL125W",426).
component("U52_",95).
component("YBR166C",172).
component("YNL280C",622).
component("YGL012W",344).
component("U57_",99).
component("YKL216W",503).
component("YDR044W",238).
component("YER014W",297).
component("YKR009C",507).
component("YIL160C",430).
component("YGL205W",357).
component("YMR118C",576).
component("YLR164W",534).
component("YLL041C",515).
component("YKL148C",493).
component("YKL141W",491).
component("YJL045W",437).
component("YDR178W",257).
component("YJR051W",461).
component("YEL047C",292).
component("YOR375C",690).
component("YDL215C",228).
component("YAL062W",131).
component("U99_",126).
component("YBR035C",154).
component("YHR037W",402).
component("YKR080W",511).
component("YER023W",298).
component("YOR236W",677).
component("YGR204W",383).
component("YLR142W",529).
component("U62_",102).
component("YKL150W",494).
component("YIL043C",418).
component("YHR042W",403).
component("YOR221C",675).
component("YML120C",566).
component("YKL192C",500).
component("YKL055C",485).
component("YER061C",306).
component("YFR030W",335).
component("YPL017C",695).
component("YFL018C",327).
component("YER042W",300).
component("YJR137C",473).
component("YPL266W",714).
component("YML110C",565).
component("YBR034C",153).
component("YPL273W",715).
component("YLL062C",518).
component("U47_",92).
component("YER091C",316).
component("YJR073C",463).
component("YDL033C",202).
component("YOL096C",650).
component("YLR172C",535).
component("YDR019C",234).
component("YDR408C",279).
component("YMR120C",577).
component("YBL013W",135).
component("YKL024C",481).
component("YPR074C",728).
component("YBR117C",163).
component("YLR354C",550).
component("YGR043C",366).
component("YCL009C",188).
component("YMR062C",572).
component("YNL071W",601).
component("YNR008W",629).
component("YFL017C",326).
component("YPL231W",709).
component("YER061C",307).
component("U86_",117).
component("YPL001W",694).
component("YDR148C",254).
component("YOR377W",691).
component("YGR177C",378).
component("YPL231W",710).
component("YGR147C",374).
component("YDL040C",203).
component("YPL028W",696).
component("YGL017W",345).
component("YPR001W",719).
component("YNR001C",627).
component("YDL182W",225).
component("YDL131W",215).
component("YNL117W",605).
component("YIR031C",433).
component("YOR321W",680).
component("YJR143C",475).
component("YGR199W",382).
component("YDR307W",270).
component("YDL095W",210).
component("YDL093W",209).
component("YAL023C",128).
component("YNL029C",597).
component("YIL085C",421).
component("YMR261C",588).
component("YML100W",564).
component("YBR126C",166).
component("YNL192W",612).
component("YBR038W",156).
component("YBR023C",152).
component("YLR209C",536).
component("U104_",21).
component("YOR209C",673).
component("YMR300C",593).
component("YER055C",302).
component("YDR354W",273) :- not remove_orf("YDR354W",273).
component("YFR047C",337).
component("YJR133W",472).
component("YLR209C",537).
component("YML022W",557).
component("YDR441C",282).
component("YDR399W",275).
component("YJL167W",453).
component("YNL256W",616).
component("YDR127W",249).
component("YLR303W",543).
component("YGR012W",363).
component("YJR130C",471).
component("YLR303W",544).
component("YDR035W",236).
component("YBR249C",180).
component("YOL143C",656).
component("YBR256C",181).
component("YHR137W",410).
component("YGL202W",356).
component("YLR027C",519).
component("YKL106W",488).
component("YKL104C",487).
component("YGR019W",364).
component("YLR089C",524).
component("U64_",103).
component("U61_",101).
component("U51_",94).
component("YJR148W",476).
component("YOR184W",668).
component("YNR058W",637).
component("YIL116W",425).
component("YGL253W",360).
component("YFR053C",338).
component("YOL136C",655).
component("YIL107C",423).
component("YMR205C",582).
component("YGR240C",386).
component("YDR248C",261).
component("YCR036W",196).
component("YCL040W",191).
component("YJR105W",469).
component("U16_",45).
component("U15_",40).
component("U96_",124).
component("YKL001C",479).
component("YML070W",562).
component("YFL053W",330).
component("YHL032C",395).
component("YLR133W",526).
component("YDR531W",288).
component("U83_",115).
component("U82_",114).
component("U81_",113).
component("YMR208W",583).
component("YOR347C",686).
component("YAL038W",130).
component("YNR012W",630).
component("YPR121W",731).
component("YPL258C",712).
component("YOL055C",644).
component("U1_",65).
component("YDR009W",233).
component("YBR020W",150).
component("YNL267W",619).
component("YLR305C",546).
component("YFR019W",333).
component("YDR208W",258).
component("YDR127W",250).
component("U21_",74).
component("U20_",72).
component("YDR147W",253).
component("YDR300C",269).
component("YCR012W",193).
component("U18_",58).
component("U17_",52).
component("U76_",111).
component("YMR220W",585).
component("YER170W",323).
component("YDR226W",259).
component("YKL067W",486).
component("YDR454C",283).
component("YOL061W",648).
component("YKL181W",496).
component("YHL011C",393).
component("YER099C",318).
component("YBL068W",143).
component("YOR143C",666).
component("YLR328W",547).
component("YBR018C",146).
component("YBR018C",147).
component("YGR007W",362).
component("YLR328W",548).
component("YKR002W",505).
component("YDL103C",213).
component("YJR010W",458).
component("YCL050C",192).
component("YPR190C",735).
component("YPR187W",734).
component("YPR110C",730).
component("YPR010C",721).
component("YOR341W",685).
component("YOR340C",684).
component("YOR224C",676).
component("YOR210W",674).
component("YOR207C",671).
component("YOR151C",667).
component("YOR116C",662).
component("YOL005C",638).
component("YNR003C",628).
component("YNL248C",615).
component("YNL151C",609).
component("YNL113W",604).
component("YKL144C",492).
component("YJR063W",462).
component("YJL148W",449).
component("YJL140W",448).
component("YIL021W",417).
component("YHR143W-A",411).
component("YGL070C",351).
component("YFL036W",329).
component("YDR404C",278).
component("YDR156W",255).
component("YDR045C",239).
component("YDL150W",221).
component("YDL140C",217).
component("YBR154C",171).
component("YPR175W",733).
component("YPL167C",704).
component("YOR330C",682).
component("YOL115W",653).
component("YNL299W",624).
component("YNL262W",618).
component("YNL102W",603).
component("YJR043C",460).
component("YJR006W",457).
component("YJL090C",441).
component("YIL139C",427).
component("YEL055C",293).
component("YDR419W",280).
component("YDR121W",247).
component("YDL102W",212).
component("YCR014C",194).
component("YBR278W",183).
component("YBL035C",137).
component("YKL035W",484).
component("YHL012W",394).
component("YHR123W",409).
component("YBR243C",178).
component("YDL142C",220).
component("YER026C",299).
component("YCL004W",187).
component("YJL068C",438).
component("YDR058C",243).
component("YNR034W",634).
component("YHR163W",413).
component("YGR248W",388).
component("YCR073W-A",197).
component("YDL086W",208).
component("YOL011W",640).
component("YMR008C",569).
component("YMR006C",568).
component("U101_",19).
component("YBL015W",136).
component("YJL068C",439).
component("YPL072W",699).
component("YOR124C",663).
component("YNL186W",611).
component("YMR304W",595).
component("YMR223W",586).
component("YKR098C",513).
component("YJL197W",454).
component("YIL156W",429).
component("YFR010W",332).
component("YER151C",321).
component("YER144C",320).
component("YER098W",317).
component("YDR069C",244).
component("YDL122W",214).
component("YBR058C",157).
component("YBL067C",142).
component("YDR272W",265).
component("U84_",116).
component("YPL179W",705).
component("YNR032W",632).
component("YML057W",561).
component("YML016C",556).
component("YLR433C",555).
component("YGR123C",373).
component("YER133W",319).
component("YER089C",314).
component("YDR436W",281).
component("YDR075W",245).
component("YDL188C",226).
component("YDL134C",216).
component("YDL047W",204).
component("YDL006W",198).
component("YBR125C",165).
component("YBL056W",141).
component("YPR073C",726).
component("YHR215W",415).
component("YDL024C",201).
component("YBR093C",161).
component("YBR092C",160).
component("YAR071W",132).
component("YIL053W",420).
component("YER062C",308).
component("YHR046C",404).
component("YGR208W",385).
component("YPL228W",707).
component("YMR180C",581).
component("YDL236W",230).
component("YJL155C",451).
component("YPR073C",727).
component("YOR208W",672).
component("YNL053W",600).
component("YMR036C",571).
component("YIR026C",431).
component("YIL113W",424).
component("YFR028C",334).
component("YER075C",311).
component("YDL230W",229).
component("YBR276C",182).
component("U34_",86).
component("U30_",85).
component("U27_",83).
component("U25_",82).
component("U24_",81).
component("YOR360C",688).
component("YGL248W",359).
component("YKR031C",508).
component("YLR286C",541).
component("YJR153W",477).
component("YOR190W",669).
component("YLR300W",542).
component("YGR282C",392).
component("YDR261C",263).
component("YDR400W",276).
component("U23_",80).
component("YML035C",558).
component("YJL070C",440).
component("YBR284W",184).
component("U102_",20).
component("YNL045W",599).
component("YLR160C",533).
component("YLR158C",532).
component("YLR157C",531).
component("YLR155C",530).
component("YDR321W",271).
component("YGL037C",347).
component("YMR293C",592).
component("YDR242W",260).
component("YBR208C",174).
component("YMR281W",591).
component("U53_",96).
component("YPL111W",702).
component("YIR032C",434).
component("YIR029W",432).
component("YPR062W",725).
component("YMR120C",578).
component("YLR028C",520).
component("YHR144C",412).
component("YGR267C",391).
component("YNL141W",606).
component("YBR153W",170).
component("YDL238C",231).
component("YNL141W",607).
component("YLR245C",540).
component("YML035C",559).
component("YJL126W",444).
component("U44_",90).
component("YDL100C",211).
component("U87_",118).
component("YMR267W",589).
component("YBR011C",145).
component("YBR111C",162).
component("YCL030C",190).
component("YER005W",296).
component("YIL048W",419).
component("YER166W",322).
component("YDR093W",246).
component("YAL026C",129).
component("YLR231C",538).
component("U88_",119).
component("YLR134W",527).
component("YLR044C",521).
component("YGR087C",369).
component("YDR380W",274).
component("YDL080C",207).
component("U98_",125).
component("YMR250W",587).
component("YKL184W",499).
component("YNR043W",635).
component("U93_",123).
component("YDR047W",241).
component("U54_",97).
component("YKL211C",501) :- not remove_orf("YKL211C",501).
component("YOL052C",643).
component("YNL169C",610).
component("YGR170W",376).
component("YNL256W",617).
component("YDR294C",266).
component("YEL046C",291).
component("YNR033W",633).
component("YKL211C",502) :- not remove_orf("YKL211C",502).
component("YER090W",502) :- not remove_orf("YER090W",502).
component("YER090W",315) :- not remove_orf("YER090W",315).
component("YDR127W",251).
component("YPL281C",718).
component("YOR393W",693).
component("YMR323W",596).
component("YHR174W",414).
component("YGR254W",389).
component("YGL026C",346) :- not remove_orf("YGL026C",346).
component("YGR155W",375).
component("YLR304C",545).
component("YJL200C",455).
component("YNL316C",625).
component("YKL182W",497).
component("YPL212C",706).
component("YNL292W",623).
component("YGL063W",350).
component("YFL001W",324).
component("YPR002W",720).
component("YDR127W",252).
component("YGL148W",353).
component("YER086W",312).
component("YLR359W",552).
component("YAL012W",127).
component("YFR055W",339).
component("YJL121C",443).
component("YBR019C",148).
component("YBR019C",149).
component("YDR050C",242).
component("YDR007W",232) :- not remove_orf("YDR007W",232).
component("YOR095C",661).
component("YER003C",295).
component("YBR196C",173).
component("YGL001C",341).
component("U14_",34).
component("YOL056W",645).
component("YKL152C",495).
component("YDL021W",199).
component("YMR105C",574).
component("YKL127W",489).
component("YEL058W",294).
component("YPR060C",724).
component("YHR072W",406).
component("YJL153C",450).
component("YPL097W",700).
component("YGR185C",381).
component("YHR011W",399).
component("YDR023W",235).
component("YPL104W",701).
component("YLL018C",514).
component("YPR081C",729).
component("YBR121C",164).
component("YHR020W",401).
component("YER087W",313).
component("YNL247W",614).
component("YOL033W",642).
component("YHR091C",408).
component("YDR341C",272).
component("YOL097C",651).
component("YDR268W",264).
component("YPR047W",723).
component("YLR060W",522).
component("YFL022C",328).
component("YPR033C",722).
component("YHR019C",400).
component("YPL160W",703).
component("YLR382C",553).
component("YNL073W",602).
component("YDR037W",237).
component("YOR335C",683).
component("YGR094W",371).
component("YOR142W",665).
component("YGR244C",387).
component("U89_",120).
component("YOR241W",678).
component("YMR113W",575).
component("YKL132C",490).
component("YJL101C",442).
component("U92_",122).
component("YGL234W",358).
component("U91_",121).
component("YDL141W",218).
component("YDL141W",219).
component("YJR103W",467).
component("YBL039C",138).
component("YGR204W",384).
component("YOL058W",646).
component("YBR208C",175).
component("YHR074W",407).
component("YMR217W",584).
component("YOR303W",679).
component("YJR109C",470).
component("YJL130C",446).
component("YGL062W",349).
component("YBR218C",176).
component("YPL231W",711).
component("YNR016C",631).
component("YKL182W",498).
component("YGR037C",365).
component("YOR005C",658).
component("YDL164C",222).
component("YOL010W",639).
component("YPR138C",732).
component("YPL265W",713).
component("YPL057C",698).
component("YPL036W",697).
component("YOR348C",687).
component("YOR192C",670).
component("YOR071C",660).
component("YOL156W",657).
component("YOL103W",652).
component("YOL020W",641) :- not remove_orf("YOL020W",641).
component("YNR056C",636).
component("YNL318C",626).
component("YNL268W",620).
component("YNL142W",608).
component("YMR272C",590).
component("YML123C",567).
component("YLR348C",549).
component("YLR237W",539).
component("YLR138W",528).
component("YLR100C",525).
component("YLR081W",523).
component("YLL061W",517).
component("YLL043W",516).
component("YKR093W",512).
component("YKR053C",510).
component("YKR039W",509) :- not remove_orf("YKR039W",509).
component("YKL217W",504).
component("YKL004W",480).
component("YJR095W",466).
component("YJR077C",464).
component("YJL219W",456).
component("YJL134W",447).
component("YJL129C",445).
component("YHL036W",396).
component("YGR121C",372).
component("YGR055W",367).
component("YGL186C",355).
component("YGL077C",352).
component("YGL008C",342).
component("YFL055W",331).
component("YFL011W",325).
component("YER060W-A",305).
component("YER060W",304).
component("YER056C",303).
component("YER053C",301).
component("YEL017C-A",290).
component("YDR536W",289).
component("YDR508C",286).
component("YDR503C",285).
component("YDR497C",284).
component("YDR297W",268).
component("YDR294C",267).
component("YDR046C",240) :- not remove_orf("YDR046C",240).
component("YDL210W",227).
component("YCR024C-A",195).
component("YCL025C",189).
component("YBR298C",186).
component("YBR291C",185).
component("YBR069C",159) :- not remove_orf("YBR069C",159).
component("YBR068C",158) :- not remove_orf("YBR068C",158).
component("YBR036C",155).
component("YBR021W",151).
component("YBL042C",139).
component("U79_",112).
component("U75_",110).
component("U74_",109).
component("U73_",108).
...
catalyst(6160,593).
catalyst(3870,302).
catalyst(3620,273) :- not remove_reaction(3620,273).
catalyst(2110,337).
catalyst(2190,337).
catalyst(5550,472).
catalyst(5791,537).
...
catalyst(1890,315) :- not remove_reaction(1890,315).
catalyst(3630,315) :- not remove_reaction(3630,315).
catalyst(3740,251).
catalyst(8231,718).
catalyst(8232,718).
catalyst(8231,693).
...
catalyst(8231,389).
catalyst(8232,389).
catalyst(3590,346) :- not remove_reaction(3590,346).
catalyst(10910,346) :- not remove_reaction(10910,346).
catalyst(4570,375).
catalyst(8181,545).
catalyst(8182,545).
catalyst(8181,455).
...
catalyst(8281,242).
catalyst(8282,242).
catalyst(3610,232) :- not remove_reaction(3610,232).
catalyst(7921,661).
catalyst(7922,661).
catalyst(7841,295).
catalyst(7842,295).
...
catalyst(1200,657).
catalyst(1160,652).
catalyst(801,641) :- not remove_reaction(801,641).
catalyst(802,641) :- not remove_reaction(802,641).
catalyst(811,641) :- not remove_reaction(811,641).
catalyst(812,641) :- not remove_reaction(812,641).
catalyst(831,641) :- not remove_reaction(831,641).
catalyst(832,641) :- not remove_reaction(832,641).
catalyst(901,641) :- not remove_reaction(901,641).
catalyst(902,641) :- not remove_reaction(902,641).
catalyst(941,641) :- not remove_reaction(941,641).
catalyst(942,641) :- not remove_reaction(942,641).
catalyst(700,636).
catalyst(1200,626).
catalyst(761,620).
catalyst(762,620).
...
catalyst(640,512).
catalyst(6560,510).
catalyst(761,509) :- not remove_reaction(761,509).
catalyst(762,509) :- not remove_reaction(762,509).
catalyst(771,509) :- not remove_reaction(771,509).
catalyst(772,509) :- not remove_reaction(772,509).
catalyst(781,509) :- not remove_reaction(781,509).
catalyst(782,509) :- not remove_reaction(782,509).
catalyst(791,509) :- not remove_reaction(791,509).
catalyst(792,509) :- not remove_reaction(792,509).
catalyst(801,509) :- not remove_reaction(801,509).
catalyst(802,509) :- not remove_reaction(802,509).
catalyst(811,509) :- not remove_reaction(811,509).
catalyst(812,509) :- not remove_reaction(812,509).
catalyst(821,509) :- not remove_reaction(821,509).
catalyst(822,509) :- not remove_reaction(822,509).
catalyst(831,509) :- not remove_reaction(831,509).
catalyst(832,509) :- not remove_reaction(832,509).
catalyst(841,509) :- not remove_reaction(841,509).
catalyst(842,509) :- not remove_reaction(842,509).
catalyst(861,509) :- not remove_reaction(861,509).
catalyst(862,509) :- not remove_reaction(862,509).
catalyst(881,509) :- not remove_reaction(881,509).
catalyst(882,509) :- not remove_reaction(882,509).
catalyst(901,509) :- not remove_reaction(901,509).
catalyst(902,509) :- not remove_reaction(902,509).
catalyst(911,509) :- not remove_reaction(911,509).
catalyst(912,509) :- not remove_reaction(912,509).
catalyst(941,509) :- not remove_reaction(941,509).
catalyst(942,509) :- not remove_reaction(942,509).
catalyst(1191,509) :- not remove_reaction(1191,509).
catalyst(1192,509) :- not remove_reaction(1192,509).
catalyst(1021,504).
catalyst(1022,504).
catalyst(6610,480).
catalyst(1250,466).
...
catalyst(1511,185).
catalyst(1512,185).
catalyst(771,159) :- not remove_reaction(771,159).
catalyst(772,159) :- not remove_reaction(772,159).
...
catalyst(791,158) :- not remove_reaction(791,158).
catalyst(792,158) :- not remove_reaction(792,158).
catalyst(801,158) :- not remove_reaction(801,158).
catalyst(802,158) :- not remove_reaction(802,158).
catalyst(811,158) :- not remove_reaction(811,158).
catalyst(812,158) :- not remove_reaction(812,158).
catalyst(831,158) :- not remove_reaction(831,158).
catalyst(832,158) :- not remove_reaction(832,158).
catalyst(841,158) :- not remove_reaction(841,158).
catalyst(842,158) :- not remove_reaction(842,158).
catalyst(861,158) :- not remove_reaction(861,158).
catalyst(862,158) :- not remove_reaction(862,158).
catalyst(901,158) :- not remove_reaction(901,158).
catalyst(902,158) :- not remove_reaction(902,158).
catalyst(6600,155).
catalyst(620,151).
catalyst(540,139).
catalyst(2830,112).
