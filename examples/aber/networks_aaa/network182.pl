...
component("YML075C",840).
component("YLR450W",829).
component("YOL126C",964).
component("YKL085W",728).
component("YDL078C",322).
component("YKL029C",723).
component("YOR136W",983).
component("YNL037C",894).
component("YNL009W",892).
component("YLR174W",796).
component("YDL066W",320).
component("YHR183W",617).
component("YGR256W",575).
component("YNL241C",913).
component("YOL059W",955).
component("YDL022W",313).
component("YCL018W",291).
component("YLR355C",821).
component("YIL074C",631).
component("YER081W",469).
component("YML054C",836).
component("YDL174C",346).
component("YML086C",841).
component("YIL155C",642).
component("YPR191W",1089).
component("YOR065W",972).
component("YJL166W",680).
component("YHR001W-A",587).
component("YGR183C",560).
component("YFR033C",501).
component("YDR529C",431).
component("YBL045C",225).
component("Q0105",18).
component("YGR088W",546).
component("YDR256C",398).
component("YKL026C",722).
component("YIR037W",656).
component("YBR244W",278).
component("YJR078W",702).
component("U58_",167).
component("YJR025C",693).
component("U107_",26).
component("YGR255C",574).
component("U108_",27).
component("YBL098W",229).
component("YMR015C",853).
...
component("U36_",146).
component("U35_",145).
component("YDL168W",343).
component("YDR158W",389).
component("YBR006W",234).
component("YPL276W",1060).
component("YPL275W",1059).
component("YOR388C",1021).
component("YPL061W",1029).
component("YOR374W",1018).
...
component("YOR323C",1008).
component("YMR170C",868).
component("YMR169C",867).
component("U2_",139).
component("YER178W",483).
component("YBR221C",276).
...
component("U57_",166).
component("YKL216W",753).
component("YDR044W",364).
component("YER014W",448).
component("YKR009C",757).
component("YIL160C",644).
component("YGL205W",529).
component("YMR118C",862).
component("YLR164W",794).
component("YLL041C",768).
component("YKL148C",736).
component("YKL141W",734).
component("YJL045W",660).
component("YDR178W",391).
component("YJR051W",696).
component("YEL047C",441).
component("YDL171C",344).
component("YDL171C",345).
component("YDL215C",350).
component("YOR375C",1019).
component("YDL215C",351).
component("YAL062W",213).
component("U99_",206).
component("YBR035C",244).
component("YMR189W",870).
component("U56_",165).
component("YNR050C",939).
component("YHR037W",595).
component("YKR080W",761).
component("YER023W",450).
component("YPL023C",1025).
component("YGL125W",521).
component("YOR236W",1000).
component("YGR204W",565).
component("YLR142W",787).
component("U63_",172).
component("U62_",171).
component("YOR356W",1016).
component("YHR068W",600).
component("YKL150W",737).
component("YIL043C",627).
component("YHR042W",596).
component("YOR221C",997).
component("YML120C",845).
component("YKL192C",746).
component("YKL055C",725).
component("YER061C",460).
component("YBR046C",247).
component("YMR145C",865).
component("YML120C",846).
component("YKL192C",747).
component("YDL085W",324).
component("YGR234W",569).
component("YFR030W",500).
component("YPL017C",1024).
component("YFL018C",488).
component("YPL091W",1031).
component("YHR106W",609).
component("YDR353W",413).
component("YER042W",452).
component("YPR167C",1083).
component("YJR137C",710).
component("YNL052W",896).
component("YMR256C",879).
component("YLR395C",825).
component("YLR038C",775).
component("YIL111W",636).
...
component("Q0275",20).
component("Q0250",19).
component("YPL266W",1055).
component("YML110C",844).
component("YBR034C",243).
component("YPL273W",1057).
component("YLL062C",771).
...
component("YNR058W",942).
component("YIL116W",638).
component("YGL253W",534).
component("YFR053C",503).
component("YOL136C",965).
component("YIL107C",635).
component("YMR013C",852).
component("YMR205C",872).
component("YGR240C",570).
component("YDR248C",397).
component("YLR240W",802).
component("YKL203C",749).
...
component("U16_",78).
component("U15_",69).
component("YPL188W",1042).
component("YJR049C",695).
component("YEL041W",439).
component("U96_",204).
component("YKL001C",718).
component("YDR236C",395).
component("YML070W",839).
component("YFL053W",493).
component("YHL032C",585).
component("YLR133W",784).
component("YDR531W",433).
component("U83_",191).
component("U82_",190).
component("U81_",189).
component("YMR208W",873).
component("YPL203W",1043).
component("YOR061W",971).
component("YKL166C",739).
component("YJL164C",679).
component("YIL035C",626).
component("YHR205W",620).
component("YHR102W",608).
component("YGL019W",511).
component("YHR025W",594).
component("YOR347C",1014).
component("YAL038W",211).
component("YNR012W",932).
component("YPR121W",1080).
component("YPL258C",1052).
component("YOL055C",951).
component("YPL214C",1046).
component("U1_",109).
component("YDR009W",359).
component("YBR020W",240).
component("YNL267W",920).
component("YLR305C",812).
component("YFR019W",497).
component("YDR208W",392).
component("YDR127W",383).
component("U21_",125).
component("U20_",119).
component("YDR147W",386).
component("YDR300C",406).
...
component("YPR190C",1088).
component("YPR187W",1087).
component("YPR110C",1078).
component("YPR010C",1065).
component("YOR341W",1013).
component("YOR340C",1012).
component("YOR224C",999).
component("YOR210W",996).
component("YOR207C",993).
component("YOR151C",986).
component("YOR116C",978).
component("YOL005C",944).
component("YNR003C",930).
component("YNL248C",915).
component("YNL151C",908).
component("YNL113W",902).
component("YKL144C",735).
component("YJR063W",698).
component("YJL148W",676).
component("YJL140W",675).
component("YIL021W",625).
component("YHR143W-A",613).
component("YGL070C",519).
component("YFL036W",491).
component("YDR404C",420).
component("YDR156W",388).
component("YDR045C",365).
component("YDL150W",340).
component("YDL140C",335).
component("YBR154C",268).
component("YPR175W",1084).
component("YPL167C",1039).
component("YOR330C",1009).
component("YOL115W",963).
component("YNL299W",926).
component("YNL262W",919).
component("YNL102W",900).
component("YJR043C",694).
component("YJR006W",689).
component("YJL090C",666).
component("YIL139C",641).
component("YEL055C",442).
component("YDR419W",423).
component("YDR121W",380).
component("YDL102W",330).
component("YCR014C",304).
component("YBR278W",284).
component("YBL035C",222).
component("YKL035W",724).
component("YHL012W",583).
component("YHR123W",610).
component("YPR113W",1079).
component("YBR243C",277).
component("YNL130C",904).
component("YDL142C",339).
component("YPL148C",1037).
component("YER026C",451).
component("YCL004W",289).
component("YOR251C",1002).
component("YGR286C",579).
component("YJL068C",661).
component("YHR189W",618).
component("YDR058C",370).
component("YNR034W",936).
component("YHR163W",615).
component("YGR248W",572).
component("YCR073W-A",310).
...
component("U105_",25).
component("U101_",21).
component("YBL015W",220).
component("YJL068C",662).
component("YPL072W",1030).
component("YOR124C",979).
component("YNL186W",910).
component("YMR304W",889).
component("YMR223W",876).
component("YKR098C",765).
component("YJL197W",683).
component("YIL156W",643).
component("YFR010W",495).
...
component("YJR019C",692).
component("YDR272W",401).
component("U84_",192).
component("YDR481C",427).
component("YLR377C",823).
component("YDR074W",374).
component("YFR025C",498).
component("YPL179W",1041).
component("YNR032W",934).
component("YML057W",838).
component("YML016C",831).
component("YLR433C",827).
component("YGR123C",549).
component("YER133W",478).
component("YER089C",472).
component("YDR436W",424).
component("YDR075W",375).
component("YDL188C",348).
component("YDL134C",334).
component("YDL047W",317).
component("YDL006W",311).
component("YBR125C",261).
component("YBL056W",226).
component("YPR073C",1073).
component("YHR215W",622).
component("YDL024C",314).
component("YBR093C",255).
component("YBR092C",254).
component("YAR071W",216).
component("YIL053W",629).
component("YER062C",462).
component("YHR046C",597).
component("U9_",207).
component("YGR208W",568).
component("YPL228W",1047).
component("YMR180C",869).
component("YDL236W",354).
component("YJL155C",678).
component("YPR073C",1074).
component("YOR208W",994).
component("YNL053W",897).
component("YMR036C",855).
component("YIR026C",650).
component("YIL113W",637).
component("YFR028C",499).
component("YER075C",468).
component("YDL230W",352).
component("YBR276C",283).
component("U34_",144).
component("U33_",143).
component("U32_",142).
component("U31_",141).
...
component("U25_",136).
component("U24_",135).
component("YOL064C",957).
component("YPL268W",1056).
component("YOR360C",1017).
component("YGL248W",533).
component("YKR031C",758).
component("YPL206C",1044).
component("YGL027C",513).
component("YLR286C",806).
component("YJR153W",715).
component("YJL221C",688).
component("YJL216C",686).
component("YIL172C",649).
component("YGR292W",581).
component("YGR287C",580).
component("YBR299W",288).
component("YBR184W",271).
component("YIL162W",646).
component("YPR026W",1066).
component("YDR001C",357).
component("YBR001C",231).
component("YOR190W",991).
component("YLR300W",808).
component("YGR282C",578).
component("YDR261C",399).
component("YDR400W",418).
component("U23_",134).
component("YML035C",834).
component("YJL070C",663).
component("YBR284W",285).
component("U102_",22).
component("YER043C",453).
component("YNL045W",895).
component("YLR160C",793).
component("YLR158C",792).
component("YLR157C",791).
component("YLR155C",790).
component("YDR321W",408).
component("YGL037C",514).
component("U43_",152).
component("U42_",151).
component("YMR293C",885).
component("YDR242W",396).
component("YLR308W",815).
component("YLR307W",814).
component("YBR208C",273).
component("YMR281W",884).
component("U53_",162).
component("YIR027C",651).
component("YPL111W",1034).
component("YIR032C",655).
component("YIR029W",653).
component("YPR062W",1071).
component("YMR120C",864).
component("YLR028C",774).
component("YHR144C",614).
component("YGR267C",577).
component("YCL030C",294).
component("YNL141W",905).
component("YBL033C",221).
component("YBR153W",267).
component("YDL238C",355).
component("YNL141W",906).
component("YLR245C",803).
component("YML035C",835).
component("YGR204W",566).
component("YBR084W",252).
component("YJL126W",670).
component("U44_",153).
component("YDL100C",329).
component("U87_",195).
component("U40_",149).
component("YMR267W",881).
component("YBR011C",235).
component("YHR201C",619).
component("YBR111C",256).
component("YBR252W",280).
component("YCL030C",295).
component("YPR080W",1076).
component("YOR187W",990).
component("YOR133W",982).
component("YLR069C",780).
component("YKR084C",762).
component("YKL173W",740).
component("YJL102W",668).
component("YDR385W",416).
component("YBR118W",259).
component("YER005W",447).
component("YLL001W",766).
component("YIL048W",628).
component("YER166W",481).
component("YDR093W",377).
component("YAL026C",210).
component("YBL099W",230).
component("U60_",169).
component("YLR231C",800).
component("U88_",196).
component("YLR134W",785).
component("YLR044C",776).
component("YGR087C",545).
component("YDR380W",415).
component("YDL080C",323).
component("U98_",205).
component("YMR250W",878).
component("YKL184W",745).
component("YOR128C",980).
component("YEL021W",438).
component("YNR043W",938).
component("U93_",202).
component("YDR047W",367).
component("U54_",163).
component("YKL211C",751) :- not remove_orf("YKL211C",751).
component("YKR097W",764).
component("YOL052C",950).
component("YNL169C",909).
component("YGR170W",555).
component("YKL060C",726).
...
component("YKL211C",752) :- not remove_orf("YKL211C",752).
component("YER090W",752) :- not remove_orf("YER090W",752).
component("YER090W",473) :- not remove_orf("YER090W",473).
component("YDR127W",384).
component("YPL281C",1061).
component("YOR393W",1022).
component("YMR323W",891).
component("YHR174W",616).
component("YGR254W",573).
component("YPL262W",1053).
component("YGL026C",512) :- not remove_orf("YGL026C",512).
component("YGR155W",553).
component("YLR304C",811).
component("YJL200C",684).
component("YNL316C",927).
component("YKL182W",743).
component("YPL212C",1045).
component("YNL292W",925).
component("YGL063W",518).
component("YFL001W",485).
component("YOR278W",1004).
component("YPR002W",1063).
component("U49_",157).
component("YJR016C",691).
component("YCR053W",309).
component("YDR127W",385).
component("YGL148W",523).
component("YIL168W",648).
component("YIL167W",647).
component("YCL064C",300).
component("YER086W",470).
component("YCL064C",301).
component("YLR359W",822).
component("YAL012W",208).
component("YFR055W",504).
component("YJL005W",658).
component("YOR176W",988).
component("YJL121C",669).
component("YBR019C",238).
component("YBR019C",239).
component("YDR050C",368).
component("YDR007W",358) :- not remove_orf("YDR007W",358).
component("YOR095C",975).
component("YER003C",446).
component("YBR196C",272).
component("YGL001C",506).
component("YPL117C",1035).
component("U14_",61).
component("YOL056W",953).
component("YKL152C",738).
component("YDL021W",312).
component("YMR105C",859).
component("YKL127W",732).
component("YEL058W",443).
component("YFL045C",492).
component("YPR060C",1070).
component("YHR072W",602).
component("YJL153C",677).
component("YPL097W",1032).
component("YGR185C",561).
component("YGR264C",576).
component("YGR171C",556).
component("YHR011W",590).
component("YDR023W",361).
component("YPL104W",1033).
component("YLL018C",767).
component("YPR081C",1077).
component("YBR121C",260).
component("YHR020W",593).
component("YER087W",471).
component("YNL247W",914).
component("YOL033W",948).
...
component("YLR060W",779).
component("YFL022C",489).
component("YPR033C",1067).
component("YHR019C",591).
component("YCR024C",305).
component("YHR019C",592).
component("YKL194C",748).
component("YIL078W",632).
component("YPL160W",1038).
component("YLR382C",824).
component("YNL073W",899).
component("YDR037W",363).
component("YOR335C",1010).
component("YGR094W",547).
component("YLR153C",789).
component("YAL054C",212).
component("YOR317W",1006).
component("YMR246W",877).
component("YIL009W",624).
component("YER015W",449).
component("YOR142W",984).
component("YGR244C",571).
component("YPR035W",1068).
component("U89_",197).
component("YOR241W",1001).
component("YMR113W",861).
component("YKL132C",733).
component("YOR339C",1011).
component("YMR022W",854).
component("YLR306W",813).
component("YKL210W",750).
component("YGR133W",551).
component("YGL058W",516).
component("YER100W",477).
component("YEL012W",436).
component("YDR177W",390).
component("YDR092W",376).
component("YDR059C",371).
component("YDR054C",369).
component("YDL064W",319).
component("YBR082C",251).
component("YJL101C",667).
component("YOL049W",949).
component("U92_",201).
component("YAR015W",214).
component("YGL234W",530).
component("YER183C",484).
component("U91_",200).
component("U90_",199).
component("YNR057C",941).
...
component("YOL058W",954).
component("YBR208C",274).
component("YHR074W",603).
component("YMR217W",874).
component("YGR061C",544).
component("YPR145W",1082).
component("YGR124W",550).
component("YOR303W",1005).
component("YJR109C",707).
component("YJL130C",673).
component("YGL062W",517).
component("YBR218C",275).
component("YPL231W",1051).
component("YNR016C",933).
component("YKL182W",744).
component("YGR037C",540).
component("YOR005C",969).
component("YDL164C",341).
component("YJL087C",664).
component("YOL010W",945).
component("YPR138C",1081).
component("YPL274W",1058).
component("YPL265W",1054).
component("YPL134C",1036).
component("YPL057C",1028).
component("YPL036W",1027).
component("YOR348C",1015).
component("YOR222W",998).
component("YOR192C",992).
component("YOR171C",987).
component("YOR130C",981).
component("YOR100C",976).
component("YOR071C",973).
component("YOR011W",970).
component("YOL156W",968).
component("YOL103W",962).
component("YOL020W",947) :- not remove_orf("YOL020W",947).
component("YNR072W",943).
component("YNR056C",940).
component("YNL318C",928).
component("YNL268W",921).
component("YNL142W",907).
component("YMR272C",883).
component("YMR202W",871).
component("YMR011W",851).
component("YML123C",847).
component("YLR348C",819).
component("YLR260W",805).
component("YLR237W",801).
component("YLR138W",786).
component("YLR100C",783).
component("YLR081W",781).
component("YLL061W",770).
component("YLL043W",769).
component("YKR093W",763).
component("YKR053C",760).
component("YKR039W",759) :- not remove_orf("YKR039W",759).
component("YKL217W",754).
component("YKL120W",731).
component("YKL004W",719).
component("YJR158W",716).
component("YJR152W",714).
component("YJR095W",703).
component("YJR077C",701).
component("YJL219W",687).
component("YJL214W",685).
component("YJL134W",674).
component("YJL129C",671).
component("YIR028W",652).
...
component("YGR121C",548).
component("YGR055W",542).
component("YGL186C",525).
component("YGL077C",520).
component("YGL008C",507).
component("YFL055W",494).
...
component("YDR297W",405).
component("YDR294C",404).
component("YDR284C",402).
component("YDR046C",366) :- not remove_orf("YDR046C",366).
component("YDL245C",356).
component("YDL210W",349).
component("YCR032W",307).
component("YCR024C-A",306).
component("YCL025C",292).
component("YBR298C",287).
component("YBR291C",286).
component("YBR069C",250) :- not remove_orf("YBR069C",250).
component("YBR068C",249) :- not remove_orf("YBR068C",249).
component("YBR036C",245).
component("YBR021W",241).
...
catalyst(1960,367).
catalyst(3460,163).
catalyst(3600,751) :- not remove_reaction(3600,751).
catalyst(8000,764).
catalyst(3941,950).
catalyst(3942,950).
catalyst(6890,909).
...
catalyst(8020,1064).
catalyst(8020,463).
catalyst(1890,752) :- not remove_reaction(1890,752).
catalyst(3630,752) :- not remove_reaction(3630,752).
...
catalyst(8281,368).
catalyst(8282,368).
catalyst(3610,358) :- not remove_reaction(3610,358).
catalyst(7921,975).
catalyst(7922,975).
catalyst(7841,446).
catalyst(7842,446).
...
catalyst(1210,968).
catalyst(1160,962).
catalyst(801,947) :- not remove_reaction(801,947).
catalyst(802,947) :- not remove_reaction(802,947).
catalyst(811,947) :- not remove_reaction(811,947).
catalyst(812,947) :- not remove_reaction(812,947).
catalyst(831,947) :- not remove_reaction(831,947).
catalyst(832,947) :- not remove_reaction(832,947).
catalyst(901,947) :- not remove_reaction(901,947).
catalyst(902,947) :- not remove_reaction(902,947).
catalyst(941,947) :- not remove_reaction(941,947).
catalyst(942,947) :- not remove_reaction(942,947).
catalyst(1170,943).
catalyst(1180,943).
catalyst(1210,943).
catalyst(700,940).
...
catalyst(650,763).
catalyst(6560,760).
catalyst(681,759) :- not remove_reaction(681,759).
catalyst(682,759) :- not remove_reaction(682,759).
catalyst(761,759) :- not remove_reaction(761,759).
catalyst(762,759) :- not remove_reaction(762,759).
catalyst(771,759) :- not remove_reaction(771,759).
catalyst(772,759) :- not remove_reaction(772,759).
catalyst(781,759) :- not remove_reaction(781,759).
catalyst(782,759) :- not remove_reaction(782,759).
catalyst(791,759) :- not remove_reaction(791,759).
catalyst(792,759) :- not remove_reaction(792,759).
catalyst(801,759) :- not remove_reaction(801,759).
catalyst(802,759) :- not remove_reaction(802,759).
catalyst(811,759) :- not remove_reaction(811,759).
catalyst(812,759) :- not remove_reaction(812,759).
catalyst(821,759) :- not remove_reaction(821,759).
catalyst(822,759) :- not remove_reaction(822,759).
catalyst(831,759) :- not remove_reaction(831,759).
catalyst(832,759) :- not remove_reaction(832,759).
catalyst(841,759) :- not remove_reaction(841,759).
catalyst(842,759) :- not remove_reaction(842,759).
catalyst(861,759) :- not remove_reaction(861,759).
catalyst(862,759) :- not remove_reaction(862,759).
catalyst(881,759) :- not remove_reaction(881,759).
catalyst(882,759) :- not remove_reaction(882,759).
catalyst(901,759) :- not remove_reaction(901,759).
catalyst(902,759) :- not remove_reaction(902,759).
catalyst(911,759) :- not remove_reaction(911,759).
catalyst(912,759) :- not remove_reaction(912,759).
catalyst(921,759) :- not remove_reaction(921,759).
catalyst(922,759) :- not remove_reaction(922,759).
catalyst(941,759) :- not remove_reaction(941,759).
catalyst(942,759) :- not remove_reaction(942,759).
catalyst(1191,759) :- not remove_reaction(1191,759).
catalyst(1192,759) :- not remove_reaction(1192,759).
catalyst(390,754).
catalyst(1021,754).
catalyst(1022,754).
catalyst(1521,731).
...
catalyst(6550,404).
catalyst(6690,402).
catalyst(791,366) :- not remove_reaction(791,366).
catalyst(792,366) :- not remove_reaction(792,366).
catalyst(801,366) :- not remove_reaction(801,366).
catalyst(802,366) :- not remove_reaction(802,366).
catalyst(811,366) :- not remove_reaction(811,366).
catalyst(812,366) :- not remove_reaction(812,366).
catalyst(831,366) :- not remove_reaction(831,366).
catalyst(832,366) :- not remove_reaction(832,366).
catalyst(841,366) :- not remove_reaction(841,366).
catalyst(842,366) :- not remove_reaction(842,366).
catalyst(861,366) :- not remove_reaction(861,366).
catalyst(862,366) :- not remove_reaction(862,366).
catalyst(901,366) :- not remove_reaction(901,366).
catalyst(902,366) :- not remove_reaction(902,366).
catalyst(1170,356).
catalyst(1180,356).
catalyst(1210,356).
catalyst(690,349).
...
catalyst(1511,286).
catalyst(1512,286).
catalyst(771,250) :- not remove_reaction(771,250).
catalyst(772,250) :- not remove_reaction(772,250).
catalyst(791,250) :- not remove_reaction(791,250).
catalyst(792,250) :- not remove_reaction(792,250).
...
catalyst(861,250) :- not remove_reaction(861,250).
catalyst(862,250) :- not remove_reaction(862,250).
