...
component("YNL280C",764).
component("YLR056W",647).
component("YGR060W",455).
component("YGL012W",423).
component("YKR009C",630).
component("YOL086C",795).
component("YMR303C",733).
component("YMR083W",706).
component("YGL256W",447).
component("YDL168W",278).
component("YBR145W",208).
component("YPL231W",872).
component("YBR265W",227).
component("U46_",116).
component("YBR149W",209).
component("YBR149W",210).
component("YJR159W",598).
component("YGL001C",420).
component("YIL094C",530).
component("YHR063C",503).
component("YBR153W",211).
component("YML056C",691).
component("YLR432W",683).
component("YHR216W",520).
component("YAR075W",170).
component("YAR073W",169).
component("YCL030C",236).
component("YDR127W",310).
component("YJR139C",592).
component("YOL126C",800).
component("YKL085W",608).
component("YDL078C",259).
component("YKL029C",603).
component("YOR136W",815).
component("YNL037C",738).
component("YDL066W",258).
component("YNL241C",754).
component("YOL059W",793).
component("YDL022W",252).
component("YLR355C",679).
component("YIL074C",528).
component("YER081W",390).
component("YML054C",690).
component("YDL174C",280).
component("YML086C",694).
component("YIL155C",536).
component("YPR191W",909).
component("YOR065W",806).
component("YJL166W",566).
component("YHR001W-A",492).
component("YGR183C",470).
component("YFR033C",416).
component("YDR529C",356).
component("YBL045C",176).
component("Q0105",18).
component("YGR088W",458).
component("YDR256C",325).
component("YKL026C",602).
component("YIR037W",546).
component("YBR244W",223).
component("YJR078W",583).
component("YJR025C",575).
component("YGR255C",482).
component("U108_",23).
component("YBL098W",180).
component("YMR015C",703).
component("YHR007C",493).
component("YDR402C",345).
component("YGL055W",430).
component("YGR175C",467).
component("YJR104C",586).
component("YHR008C",494).
component("YJL026W",549).
component("YIL066C",527).
component("YGR180C",469).
component("YER070W",387).
component("U38_",111).
component("U36_",110).
component("U35_",109).
component("YDL168W",279).
component("YDR158W",318).
component("YBR006W",183).
component("YPL276W",884).
component("YPL275W",883).
component("YOR388C",849).
component("YOR374W",846).
component("YER073W",388).
component("U68_",133).
component("YGL154C",438).
component("U55_",125).
component("YOR323C",837).
component("YMR170C",716).
component("YMR169C",715).
component("U2_",104).
component("YER178W",403).
component("YBR221C",221).
component("YIL125W",534).
component("U52_",122).
component("YBR166C",214).
component("YNL280C",765).
component("YGL012W",424).
component("YKL182W",620).
component("U57_",127).
component("YKL216W",627).
component("YDR044W",297).
component("YER014W",371).
component("YKR009C",631).
component("YIL160C",538).
component("YGL205W",441).
component("YMR118C",711).
component("YLR164W",660).
component("YLL041C",640).
component("YKL148C",615).
component("YKL141W",613).
component("YJL045W",550).
component("YDR178W",319).
component("YJR051W",578).
component("YEL047C",365).
component("YDL215C",284).
component("YOR375C",847).
component("YDL215C",285).
component("YAL062W",167).
component("U99_",161).
component("YBR035C",193).
component("YMR189W",718).
component("U56_",126).
component("YHR037W",500).
component("YKR080W",635).
component("YER023W",373).
component("YPL023C",853).
component("YGL125W",435).
component("YOR236W",830).
component("YGR204W",474).
component("YLR142W",655).
component("U63_",131).
component("U62_",130).
component("YOR356W",844).
component("YKL150W",616).
component("YIL043C",524).
component("YHR042W",501).
component("YOR221C",828).
component("YML120C",697).
component("YKL192C",624).
component("YKL055C",605).
component("YER061C",382).
component("YGR234W",477).
component("YFR030W",415).
component("YPL017C",852).
component("YFL018C",407).
component("YDR353W",340).
component("YER042W",375).
component("YJR137C",591).
component("YPL266W",879).
component("YML110C",696).
component("YBR034C",192).
component("YPL273W",881).
component("YLL062C",643).
component("YDR410C",348).
component("U47_",117).
component("YER091C",395).
component("YJR073C",581).
component("YDR120C",308).
component("YDL033C",254).
component("YOL096C",796).
component("YLR172C",661).
component("YDR019C",293).
component("YBR176W",215).
component("YDR408C",347).
component("YMR120C",712).
component("YBL013W",171).
component("YKL024C",601).
component("YPR074C",898).
component("YBR117C",204).
component("YLR354C",678).
component("YGR043C",453).
component("YMR108W",709).
component("YCL009C",234).
component("YMR062C",705).
component("YNL071W",741).
component("YNR008W",772).
component("YIL160C",539).
component("YNL277W",763).
component("YFL017C",406).
component("YPL231W",873).
component("YER061C",383).
component("U86_",149).
component("YPL001W",851).
component("YMR296C",731).
component("YDR062W",303).
component("YDL052C",257).
component("U8_",153).
component("YDR148C",316).
component("YOR377W",848).
component("YGR177C",468).
component("YPL231W",874).
component("YGR147C",463).
component("YDL040C",255).
component("YPL028W",854).
component("YGL017W",425).
component("YPR001W",886).
component("YNR001C",770).
component("YCR005C",241).
component("YDL182W",281).
component("YDL131W",269).
component("YNL117W",745).
component("YIR031C",544).
component("YOR321W",836).
component("YJR143C",593).
component("YGR199W",473).
component("YDR307W",334).
component("YDL095W",264).
component("YDL093W",263).
component("YAL023C",164).
component("YOR103C",810).
component("YOR085W",808).
component("YMR149W",714).
component("YML019W",686).
component("YJL002C",547).
component("YEL002C",360).
component("YDL232W",287).
component("YCL043C",239).
component("YNL029C",737).
component("YIL085C",529).
component("YMR261C",726).
component("YML100W",695).
component("YBR126C",207).
component("YNL192W",753).
component("YBR038W",195).
component("YBR023C",191).
component("YMR306W",735).
component("YLR342W",676).
component("YGR032W",451).
component("YLR209C",662).
component("U104_",21).
component("YOR209C",826).
component("YMR300C",732).
component("YER055C",378).
component("YDR354W",341) :- not remove_orf("YDR354W",341).
component("YFR047C",417).
component("YJR133W",590).
component("YLR209C",663).
component("YML022W",687).
component("YDR441C",351).
component("YDR399W",343).
component("YPR176C",906).
component("YPL172C",864).
component("YNR041C",778).
component("YMR101C",707).
component("YDL090C",262).
component("YBR003W",182).
component("YBR002C",181).
component("YJL167W",567).
component("YJL167W",568).
component("YNL256W",757).
component("YPR069C",895).
component("YDR127W",311).
component("YLR303W",670).
component("YGR012W",449).
component("YJR130C",589).
component("YLR303W",671).
component("YDR035W",295).
component("YBR249C",224).
component("YOR274W",832).
component("YOL143C",802).
component("YBR256C",226).
component("YHR137W",512).
component("YGL202W",440).
component("YLR027C",644).
component("YKL106W",610).
component("YKL104C",609).
component("YGR019W",450).
component("YLR089C",650).
component("U64_",132).
component("U61_",129).
component("U51_",121).
component("YJR148W",594).
component("YHR208W",518).
component("YOR184W",821).
component("YNR058W",781).
component("YIL116W",533).
component("YGL253W",446).
component("YFR053C",418).
component("YOL136C",801).
component("YIL107C",531).
component("YMR013C",702).
component("YMR205C",719).
component("YGR240C",478).
component("YDR248C",324).
component("YCR036W",247).
component("YGR194C",472).
component("YCL040W",238).
component("YJR105W",587).
component("U16_",57).
component("U15_",51).
component("YPL188W",866).
component("YJR049C",577).
component("YEL041W",363).
component("U96_",159).
component("YKL001C",599).
component("YDR236C",322).
component("YML070W",693).
component("YFL053W",410).
component("YHL032C",490).
component("YLR133W",652).
component("YDR531W",358).
component("U83_",147).
component("U82_",146).
component("U81_",145).
component("YMR208W",720).
component("YPL203W",867).
component("YOR061W",805).
component("YKL166C",618).
component("YJL164C",565).
component("YIL035C",523).
component("YHR205W",517).
component("YHR102W",510).
component("YGL019W",426).
component("YHR025W",499).
component("YOR347C",842).
component("YAL038W",166).
component("YNR012W",773).
component("YPR121W",902).
component("YPL258C",876).
component("YOL055C",789).
component("YPL214C",870).
component("U1_",80).
component("YDR009W",292).
component("YBR020W",189).
component("YNL267W",761).
component("YLR305C",673).
component("YFR019W",413).
component("YDR208W",320).
component("YDR127W",312).
component("U21_",91).
component("U20_",88).
component("YDR147W",315).
component("YDR300C",333).
component("YCR012W",242).
component("YER052C",376).
component("YER069W",386).
component("U18_",72).
component("U17_",65).
component("U76_",141).
component("YMR220W",722).
component("YER170W",402).
component("YDR226W",321).
component("YKL067W",607).
component("YOL055C",790).
component("YDR454C",352).
component("YJR057W",579).
component("YOL061W",794).
component("YKL181W",619).
component("YHL011C",487).
component("YER099C",397).
component("YBL068W",179).
component("YOR143C",817).
component("YNL256W",758).
component("YLR328W",674).
component("YBR018C",185).
component("YBR018C",186).
component("YGR007W",448).
component("YLR328W",675).
component("YKR002W",629).
component("YDL103C",267).
component("U94_",158).
component("YJR010W",574).
component("YGL130W",436).
component("YDR530C",357).
component("YCL050C",240).
component("YPR190C",908).
component("YPR187W",907).
component("YPR110C",900).
component("YPR010C",889).
component("YOR341W",841).
component("YOR340C",840).
component("YOR224C",829).
component("YOR210W",827).
component("YOR207C",824).
component("YOR151C",818).
component("YOR116C",811).
component("YOL005C",783).
component("YNR003C",771).
component("YNL248C",756).
component("YNL151C",750).
component("YNL113W",744).
component("YKL144C",614).
component("YJR063W",580).
component("YJL148W",562).
component("YJL140W",561).
component("YIL021W",522).
component("YHR143W-A",513).
component("YGL070C",433).
component("YFL036W",409).
component("YDR404C",346).
component("YDR156W",317).
component("YDR045C",298).
component("YDL150W",276).
component("YDL140C",271).
component("YBR154C",213).
component("YPR175W",905).
component("YPL167C",863).
component("YOR330C",838).
component("YOL115W",799).
component("YNL299W",767).
component("YNL262W",760).
component("YNL102W",743).
component("YJR043C",576).
component("YJR006W",573).
component("YJL090C",554).
component("YIL139C",535).
component("YEL055C",366).
component("YDR419W",349).
component("YDR121W",309).
component("YDL102W",266).
component("YCR014C",243).
component("YBR278W",229).
component("YBL035C",173).
component("YKL035W",604).
component("YHL012W",488).
component("YHR123W",511).
component("YPR113W",901).
component("YBR243C",222).
component("YNL130C",746).
component("YDL142C",275).
component("YPL148C",861).
component("YER026C",374).
component("YCL004W",233).
component("YGR286C",486).
component("YJL068C",551).
component("YDR058C",302).
component("YNR034W",777).
component("YHR163W",515).
component("YGR248W",480).
component("YCR073W-A",249).
component("YDL086W",261).
component("YOL011W",785).
component("YMR008C",700).
component("YMR006C",699).
component("U105_",22).
component("U101_",19).
component("YBL015W",172).
component("YJL068C",552).
component("YPL072W",857).
component("YOR124C",812).
component("YNL186W",752).
component("YMR304W",734).
component("YMR223W",723).
component("YKR098C",638).
component("YJL197W",569).
component("YIL156W",537).
component("YFR010W",412).
component("YER151C",400).
component("YER144C",399).
component("YER098W",396).
component("YDR069C",304).
component("YDL122W",268).
component("YBR058C",196).
component("YBL067C",178).
component("YDR272W",328).
component("U84_",148).
component("YLR377C",681).
component("YDR074W",305).
component("YPL179W",865).
component("YNR032W",775).
component("YML057W",692).
component("YML016C",685).
component("YLR433C",684).
component("YGR123C",461).
component("YER133W",398).
component("YER089C",393).
component("YDR436W",350).
component("YDR075W",306).
component("YDL188C",282).
component("YDL134C",270).
component("YDL047W",256).
component("YDL006W",250).
component("YBR125C",206).
component("YBL056W",177).
component("YPR073C",896).
component("YHR215W",519).
component("YDL024C",253).
component("YBR093C",202).
component("YBR092C",201).
component("YAR071W",168).
component("YIL053W",526).
component("YER062C",384).
component("YHR046C",502).
component("U9_",162).
component("YGR208W",476).
component("YPL228W",871).
component("YMR180C",717).
component("YDL236W",288).
component("YJL155C",564).
component("YPR073C",897).
component("YOR208W",825).
component("YNL053W",740).
component("YMR036C",704).
component("YIR026C",541).
component("YIL113W",532).
component("YFR028C",414).
component("YER075C",389).
component("YDL230W",286).
component("YBR276C",228).
component("U34_",108).
component("U33_",107).
component("U32_",106).
component("U30_",105).
...
component("U25_",101).
component("U24_",100).
component("YPL268W",880).
component("YOR360C",845).
component("YGL248W",445).
component("YKR031C",632).
component("YPL206C",868).
component("YGL027C",428).
component("YLR286C",668).
component("YJR153W",596).
component("YBR184W",216).
component("YOR190W",822).
component("YLR300W",669).
component("YGR282C",485).
component("YDR261C",326).
component("YDR400W",344).
component("U23_",99).
component("YML035C",688).
component("YJL070C",553).
component("YBR284W",230).
component("U102_",20).
component("YNL045W",739).
component("YLR160C",659).
component("YLR158C",658).
component("YLR157C",657).
component("YLR155C",656).
component("YDR321W",335).
component("YGL037C",429).
component("YMR293C",730).
component("YDR242W",323).
component("YBR208C",218).
component("YMR281W",729).
component("U53_",123).
component("YIR027C",542).
component("YPL111W",860).
component("YIR032C",545).
component("YIR029W",543).
component("YPR062W",894).
component("YMR120C",713).
component("YLR028C",645).
component("YHR144C",514).
component("YGR267C",484).
component("YNL141W",747).
component("YBR153W",212).
component("YDL238C",289).
component("YNL141W",748).
component("YLR245C",666).
component("YML035C",689).
component("YBR084W",199).
component("YJL126W",557).
component("U44_",115).
component("YDL100C",265).
component("U87_",150).
component("U40_",113).
component("YMR267W",727).
component("YBR011C",184).
component("YBR111C",203).
component("YBR252W",225).
component("YCL030C",237).
component("YER005W",370).
component("YIL048W",525).
component("YER166W",401).
component("YDR093W",307).
component("YAL026C",165).
component("YLR231C",664).
component("U88_",151).
component("YLR134W",653).
component("YLR044C",646).
component("YGR087C",457).
component("YDR380W",342).
component("YDL080C",260).
component("U98_",160).
component("YMR250W",725).
component("YKL184W",623).
component("YOR128C",813).
component("YEL021W",362).
component("YNR043W",779).
component("U93_",157).
component("YDR047W",300).
component("U54_",124).
component("YKL211C",625) :- not remove_orf("YKL211C",625).
component("YKR097W",637).
component("YOL052C",788).
component("YNL169C",751).
component("YGR170W",465).
component("YKL060C",606).
component("YNL256W",759).
component("YDR294C",330).
component("YEL046C",364).
component("YNR033W",776).
component("YPR006C",888).
component("YER065C",385).
component("YKL211C",626) :- not remove_orf("YKL211C",626).
component("YER090W",626) :- not remove_orf("YER090W",626).
component("YER090W",394) :- not remove_orf("YER090W",394).
component("YDR127W",313).
component("YPL281C",885).
component("YOR393W",850).
component("YMR323W",736).
component("YHR174W",516).
component("YGR254W",481).
component("YPL262W",877).
component("YGL026C",427) :- not remove_orf("YGL026C",427).
component("YGR155W",464).
component("YLR304C",672).
component("YJL200C",570).
component("YNL316C",768).
component("YKL182W",621).
component("YPL212C",869).
component("YNL292W",766).
component("YGL063W",432).
component("YFL001W",404).
component("YOR278W",833).
component("YPR002W",887).
component("U49_",118).
component("YCR053W",248).
component("YDR127W",314).
component("YGL148W",437).
component("YIL168W",540).
component("YER086W",391).
component("YLR359W",680).
component("YAL012W",163).
component("YFR055W",419).
component("YJL005W",548).
component("YOR176W",820).
component("YJL121C",556).
component("YBR019C",187).
component("YBR019C",188).
component("YDR050C",301).
component("YDR007W",291) :- not remove_orf("YDR007W",291).
component("YOR095C",809).
component("YER003C",369).
component("YBR196C",217).
component("YGL001C",421).
component("U14_",44).
component("YOL056W",791).
component("YKL152C",617).
component("YDL021W",251).
component("YMR105C",708).
component("YKL127W",611).
component("YEL058W",367).
component("YPR060C",893).
component("YHR072W",504).
component("YJL153C",563).
component("YPL097W",858).
component("YGR185C",471).
component("YGR264C",483).
component("YGR171C",466).
component("YHR011W",495).
component("YDR023W",294).
component("YPL104W",859).
component("YLL018C",639).
component("YPR081C",899).
component("YBR121C",205).
component("YHR020W",498).
component("YER087W",392).
component("YNL247W",755).
component("YOL033W",787).
component("YGL245W",444).
component("YHR091C",506).
component("YDR341C",336).
component("YOL097C",797).
component("YDR268W",327).
component("YPR047W",892).
component("YLR060W",648).
component("YFL022C",408).
component("YPR033C",890).
component("YHR019C",496).
component("YCR024C",244).
component("YHR019C",497).
component("YPL160W",862).
component("YLR382C",682).
component("YNL073W",742).
component("YDR037W",296).
component("YOR335C",839).
component("YGR094W",459).
component("YOR317W",835).
component("YMR246W",724).
component("YIL009W",521).
component("YER015W",372).
component("YOR142W",816).
component("YGR244C",479).
component("YPR035W",891).
component("U89_",152).
component("YOR241W",831).
component("YMR113W",710).
component("YKL132C",612).
component("YJL101C",555).
component("U92_",156).
component("YGL234W",442).
component("U91_",155).
component("U90_",154).
component("YDL141W",272).
component("YDL141W",273).
component("YGL234W",443).
component("YDL141W",274).
component("YJR103W",585).
component("YBL039C",174).
component("YGR204W",475).
component("YBR084W",200).
component("YOL058W",792).
component("YBR208C",219).
component("YHR074W",505).
component("YMR217W",721).
component("YGR061C",456).
component("YPR145W",904).
component("YGR124W",462).
component("YOR303W",834).
component("YJR109C",588).
component("YJL130C",559).
component("YGL062W",431).
component("YBR218C",220).
component("YPL231W",875).
component("YNR016C",774).
component("YKL182W",622).
component("YGR037C",452).
component("YOR005C",804).
component("YDL164C",277).
component("YOL010W",784).
component("YPR138C",903).
component("YPL274W",882).
component("YPL265W",878).
component("YPL057C",856).
component("YPL036W",855).
component("YOR348C",843).
component("YOR192C",823).
component("YOR171C",819).
component("YOR130C",814).
component("YOR071C",807).
component("YOL156W",803).
component("YOL103W",798).
component("YOL020W",786) :- not remove_orf("YOL020W",786).
component("YNR072W",782).
component("YNR056C",780).
component("YNL318C",769).
component("YNL268W",762).
component("YNL142W",749).
component("YMR272C",728).
component("YMR011W",701).
component("YML123C",698).
component("YLR348C",677).
component("YLR260W",667).
component("YLR237W",665).
component("YLR138W",654).
component("YLR100C",651).
component("YLR081W",649).
component("YLL061W",642).
component("YLL043W",641).
component("YKR093W",636).
component("YKR053C",634).
component("YKR039W",633) :- not remove_orf("YKR039W",633).
component("YKL217W",628).
component("YKL004W",600).
component("YJR158W",597).
component("YJR152W",595).
component("YJR095W",584).
component("YJR077C",582).
component("YJL219W",572).
component("YJL214W",571).
component("YJL134W",560).
component("YJL129C",558).
component("YHR096C",509).
component("YHR094C",508).
component("YHR092C",507).
component("YHL036W",491).
component("YHL016C",489).
component("YGR121C",460).
component("YGR055W",454).
component("YGL186C",439).
component("YGL077C",434).
component("YGL008C",422).
component("YFL055W",411).
component("YFL011W",405).
component("YER060W-A",381).
component("YER060W",380).
component("YER056C",379).
component("YER053C",377).
component("YEL069C",368).
component("YEL017C-A",361).
component("YDR536W",359).
component("YDR508C",355).
component("YDR503C",354).
component("YDR497C",353).
component("YDR345C",339).
component("YDR343C",338).
component("YDR342C",337).
component("YDR297W",332).
component("YDR294C",331).
component("YDR284C",329).
component("YDR046C",299) :- not remove_orf("YDR046C",299).
component("YDL245C",290).
component("YDL210W",283).
component("YCR032W",246).
component("YCR024C-A",245).
component("YCL025C",235).
component("YBR298C",232).
component("YBR291C",231).
component("YBR069C",198) :- not remove_orf("YBR069C",198).
component("YBR068C",197) :- not remove_orf("YBR068C",197).
component("YBR036C",194).
component("YBR021W",190).
component("YBL042C",175).
component("U7_",144).
component("U79_",143).
component("U78_",142).
component("U75_",140).
...
catalyst(6160,732).
catalyst(3870,378).
catalyst(3620,341) :- not remove_reaction(3620,341).
catalyst(2110,417).
catalyst(2190,417).
catalyst(5550,590).
catalyst(5791,663).
...
catalyst(1960,300).
catalyst(3460,124).
catalyst(3600,625) :- not remove_reaction(3600,625).
catalyst(8000,637).
catalyst(3941,788).
catalyst(3942,788).
catalyst(6890,751).
...
catalyst(8020,888).
catalyst(8020,385).
catalyst(1890,626) :- not remove_reaction(1890,626).
catalyst(3630,626) :- not remove_reaction(3630,626).
catalyst(1890,394) :- not remove_reaction(1890,394).
catalyst(3630,394) :- not remove_reaction(3630,394).
catalyst(3740,313).
catalyst(8231,885).
catalyst(8232,885).
catalyst(8231,850).
...
catalyst(8051,877).
catalyst(8052,877).
catalyst(3590,427) :- not remove_reaction(3590,427).
catalyst(10910,427) :- not remove_reaction(10910,427).
catalyst(4570,464).
catalyst(8181,672).
catalyst(8182,672).
catalyst(8181,570).
...
catalyst(8281,301).
catalyst(8282,301).
catalyst(3610,291) :- not remove_reaction(3610,291).
catalyst(7921,809).
catalyst(7922,809).
catalyst(7841,369).
catalyst(7842,369).
...
catalyst(1210,803).
catalyst(1160,798).
catalyst(801,786) :- not remove_reaction(801,786).
catalyst(802,786) :- not remove_reaction(802,786).
catalyst(811,786) :- not remove_reaction(811,786).
catalyst(812,786) :- not remove_reaction(812,786).
catalyst(831,786) :- not remove_reaction(831,786).
catalyst(832,786) :- not remove_reaction(832,786).
catalyst(901,786) :- not remove_reaction(901,786).
catalyst(902,786) :- not remove_reaction(902,786).
catalyst(941,786) :- not remove_reaction(941,786).
catalyst(942,786) :- not remove_reaction(942,786).
catalyst(1210,782).
catalyst(700,780).
catalyst(1200,769).
catalyst(761,762).
...
catalyst(650,636).
catalyst(6560,634).
catalyst(761,633) :- not remove_reaction(761,633).
catalyst(762,633) :- not remove_reaction(762,633).
catalyst(771,633) :- not remove_reaction(771,633).
catalyst(772,633) :- not remove_reaction(772,633).
catalyst(781,633) :- not remove_reaction(781,633).
catalyst(782,633) :- not remove_reaction(782,633).
catalyst(791,633) :- not remove_reaction(791,633).
catalyst(792,633) :- not remove_reaction(792,633).
catalyst(801,633) :- not remove_reaction(801,633).
catalyst(802,633) :- not remove_reaction(802,633).
catalyst(811,633) :- not remove_reaction(811,633).
catalyst(812,633) :- not remove_reaction(812,633).
catalyst(821,633) :- not remove_reaction(821,633).
catalyst(822,633) :- not remove_reaction(822,633).
catalyst(831,633) :- not remove_reaction(831,633).
catalyst(832,633) :- not remove_reaction(832,633).
catalyst(841,633) :- not remove_reaction(841,633).
catalyst(842,633) :- not remove_reaction(842,633).
catalyst(861,633) :- not remove_reaction(861,633).
catalyst(862,633) :- not remove_reaction(862,633).
catalyst(881,633) :- not remove_reaction(881,633).
catalyst(882,633) :- not remove_reaction(882,633).
catalyst(901,633) :- not remove_reaction(901,633).
catalyst(902,633) :- not remove_reaction(902,633).
catalyst(911,633) :- not remove_reaction(911,633).
catalyst(912,633) :- not remove_reaction(912,633).
catalyst(921,633) :- not remove_reaction(921,633).
catalyst(922,633) :- not remove_reaction(922,633).
catalyst(941,633) :- not remove_reaction(941,633).
catalyst(942,633) :- not remove_reaction(942,633).
catalyst(1191,633) :- not remove_reaction(1191,633).
catalyst(1192,633) :- not remove_reaction(1192,633).
catalyst(1021,628).
catalyst(1022,628).
catalyst(6610,600).
catalyst(1210,597).
...
catalyst(6550,331).
catalyst(6690,329).
catalyst(791,299) :- not remove_reaction(791,299).
catalyst(792,299) :- not remove_reaction(792,299).
catalyst(801,299) :- not remove_reaction(801,299).
catalyst(802,299) :- not remove_reaction(802,299).
catalyst(811,299) :- not remove_reaction(811,299).
catalyst(812,299) :- not remove_reaction(812,299).
catalyst(831,299) :- not remove_reaction(831,299).
catalyst(832,299) :- not remove_reaction(832,299).
catalyst(841,299) :- not remove_reaction(841,299).
catalyst(842,299) :- not remove_reaction(842,299).
catalyst(861,299) :- not remove_reaction(861,299).
catalyst(862,299) :- not remove_reaction(862,299).
catalyst(901,299) :- not remove_reaction(901,299).
catalyst(902,299) :- not remove_reaction(902,299).
catalyst(1210,290).
catalyst(690,283).
catalyst(730,283).
catalyst(431,246).
...
catalyst(1511,231).
catalyst(1512,231).
catalyst(771,198) :- not remove_reaction(771,198).
catalyst(772,198) :- not remove_reaction(772,198).
catalyst(791,198) :- not remove_reaction(791,198).
catalyst(792,198) :- not remove_reaction(792,198).
catalyst(801,198) :- not remove_reaction(801,198).
catalyst(802,198) :- not remove_reaction(802,198).
catalyst(811,198) :- not remove_reaction(811,198).
catalyst(812,198) :- not remove_reaction(812,198).
catalyst(861,198) :- not remove_reaction(861,198).
catalyst(862,198) :- not remove_reaction(862,198).
catalyst(901,198) :- not remove_reaction(901,198).
catalyst(902,198) :- not remove_reaction(902,198).
...
catalyst(831,197) :- not remove_reaction(831,197).
catalyst(832,197) :- not remove_reaction(832,197).
catalyst(841,197) :- not remove_reaction(841,197).
catalyst(842,197) :- not remove_reaction(842,197).
...
modifiable_enzyme(625).
modifiable_enzyme(626).
modifiable_enzyme(394).
modifiable_enzyme(427).
modifiable_enzyme(291).
modifiable_enzyme(786).
modifiable_enzyme(633).
