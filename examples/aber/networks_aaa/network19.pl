...
component("YGL012W",101).
component("YOL086C",183).
component("YMR303C",168).
component("YGL256W",107).
component("YDL168W",63).
component("YBR145W",51).
component("YGL001C",100).
component("YML056C",160).
component("YLR432W",158).
component("YHR216W",120).
component("YAR075W",40).
component("YAR073W",39).
component("YDR127W",72).
component("YJR139C",139).
component("YOR136W",187).
component("YIL155C",123).
component("YJR078W",134).
component("YJR025C",131).
component("YMR015C",162).
component("YDR402C",83).
component("YGL154C",105).
component("YMR170C",164).
component("YMR169C",163).
component("YBR166C",53).
component("YER014W",90).
component("YEL047C",89).
component("YOR375C",196).
component("YDL215C",64).
component("YAL062W",38).
component("U62_",32).
component("YPL017C",199).
component("YFL018C",93).
component("YKL024C",141).
component("YPR074C",208).
component("YBR117C",50).
component("YPL231W",201).
component("YPL001W",198).
component("YPL231W",202).
component("YNL029C",170).
component("YIL085C",122).
component("YLR209C",153).
component("YDR354W",81) :- not remove_orf("YDR354W",81).
component("YFR047C",98).
component("YJR133W",138).
component("YDR399W",82).
component("YDR127W",73).
component("YJR130C",137).
component("YDR035W",68).
component("YBR249C",54).
component("YBR256C",55).
component("YHR137W",116).
component("YLR027C",150).
component("YKL106W",142).
component("U64_",33).
component("YGL253W",106).
component("YFR053C",99).
component("YMR205C",166).
component("YGR240C",113).
component("YCR036W",59).
component("U15_",20).
component("YKL001C",140).
component("YML070W",161).
component("YFL053W",95).
component("U83_",36).
component("YMR208W",167).
component("U1_",24).
component("YNL267W",176).
component("YLR305C",157).
component("YFR019W",97).
component("YDR208W",78).
component("YDR127W",74).
component("U20_",27).
component("YDR300C",80).
component("U76_",35).
component("YDR454C",85).
component("YOL061W",182).
component("YKL181W",144).
component("YHL011C",115).
component("YER099C",92).
component("YBL068W",43).
component("YOR143C",188).
component("YPR190C",212).
component("YPR187W",211).
component("YPR110C",209).
component("YPR010C",205).
component("YOR341W",195).
component("YOR340C",194).
component("YOR224C",192).
component("YOR210W",191).
component("YOR207C",190).
component("YOR151C",189).
component("YOR116C",186).
component("YOL005C",180).
component("YNR003C",178).
component("YNL248C",175).
component("YNL151C",174).
component("YNL113W",172).
component("YKL144C",143).
component("YJR063W",132).
component("YJL148W",129).
component("YJL140W",128).
component("YIL021W",121).
component("YHR143W-A",117).
component("YGL070C",103).
component("YFL036W",94).
component("YDR404C",84).
component("YDR156W",77).
component("YDR045C",69).
component("YDL150W",62).
component("YDL140C",61).
component("YBR154C",52).
component("YDR058C",71).
component("YBL015W",41).
component("U84_",37).
component("YPR073C",207).
component("YHR215W",119).
component("YDL024C",60).
component("YBR093C",48).
component("YBR092C",47).
component("YPL228W",200).
component("YMR180C",165).
component("YDL236W",65).
component("YJL155C",130).
component("U30_",29).
component("YLR286C",156).
component("YML035C",159).
component("YJL070C",125).
component("YBR284W",56).
component("YNL045W",171).
component("U53_",30).
component("YIR032C",124).
component("YDL238C",66).
component("YLR245C",155).
component("YJL126W",126).
component("YBR111C",49).
component("YLR231C",154).
component("YLR134W",152).
component("YLR044C",151).
component("YGR087C",108).
component("U54_",31).
component("YKL211C",146) :- not remove_orf("YKL211C",146).
component("YGR170W",112).
component("YDR294C",79).
component("YNR033W",179).
component("YKL211C",147) :- not remove_orf("YKL211C",147).
component("YER090W",147) :- not remove_orf("YER090W",147).
component("YER090W",91) :- not remove_orf("YER090W",91).
component("YDR127W",75).
component("YPL281C",204).
component("YOR393W",197).
component("YMR323W",169).
component("YHR174W",118).
component("YGR254W",114).
component("YGL026C",102) :- not remove_orf("YGL026C",102).
component("YGR155W",111).
component("YNL316C",177).
component("YKL182W",145).
component("YDR127W",76).
component("YGL148W",104).
component("YDR007W",67) :- not remove_orf("YDR007W",67).
component("YOR095C",185).
component("YPR060C",206).
component("YOL097C",184).
component("YOR335C",193).
component("YGR094W",109).
component("YJR103W",136).
component("YBL039C",42).
component("YPR138C",210).
component("YPL265W",203).
component("YOL020W",181) :- not remove_orf("YOL020W",181).
component("YNL142W",173).
component("YKR053C",149).
component("YKR039W",148) :- not remove_orf("YKR039W",148).
component("YJR095W",135).
component("YJR077C",133).
component("YJL134W",127).
component("YGR121C",110).
component("YFL055W",96).
component("YDR536W",88).
component("YDR508C",87).
component("YDR503C",86).
...
catalyst(7550,108).
catalyst(3460,31).
catalyst(3600,146) :- not remove_reaction(3600,146).
catalyst(6900,112).
catalyst(8781,79).
catalyst(8782,79).
catalyst(2550,179).
