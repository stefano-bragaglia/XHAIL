...
component("YNL280C",825).
component("YLR056W",692).
component("YGR060W",487).
component("YGL012W",452).
component("YKR009C",674).
component("YOL086C",858).
component("YMR303C",792).
component("YMR083W",761).
component("YGL256W",479).
component("YDL168W",296).
component("YBR145W",221).
component("YPL231W",941).
component("YBR265W",240).
component("U46_",125).
component("YBR149W",222).
component("YBR149W",223).
component("YJR159W",640).
component("YGL001C",449).
component("YIL094C",567).
component("YHR063C",539).
component("YBR153W",224).
component("YML056C",742).
component("YLR432W",733).
component("YHR216W",557).
component("YAR075W",182).
component("YAR073W",181).
component("YCL030C",250).
component("YDR127W",332).
component("YJR139C",634).
component("YML075C",745).
component("YLR450W",735).
component("YOL126C",863).
component("YKL085W",650).
component("YDL078C",276).
component("YKL029C",645).
component("YOR136W",879).
component("YNL037C",797).
component("YDL066W",274).
component("YNL241C",815).
component("YOL059W",856).
component("YDL022W",267).
component("YLR355C",728).
component("YIL074C",565).
component("YER081W",416).
component("YML054C",741).
component("YDL174C",299).
component("YML086C",746).
component("YIL155C",574).
component("YPR191W",979).
component("YOR065W",870).
component("YJL166W",605).
component("YHR001W-A",527).
component("YGR183C",503).
component("YFR033C",445).
component("YDR529C",381).
component("YBL045C",188).
component("Q0105",18).
component("YGR088W",490).
component("YDR256C",349).
component("YKL026C",644).
component("YIR037W",585).
component("YBR244W",236).
component("YJR078W",625).
component("U58_",137).
component("YJR025C",617).
component("YGR255C",515).
component("U108_",25).
component("YBL098W",192).
component("YMR015C",757).
component("YHR007C",528).
component("YDR402C",369).
component("YGL055W",459).
component("YGR175C",500).
component("YJR104C",628).
component("YHR008C",529).
component("YJL026W",588).
component("YIL066C",564).
component("YGR180C",502).
component("YER070W",413).
component("U38_",120).
component("U36_",119).
component("U35_",118).
component("YDL168W",297).
component("YDR158W",340).
component("YBR006W",195).
component("YPL276W",953).
component("YPL275W",952).
component("YOR388C",916).
component("YOR374W",913).
component("YER073W",414).
component("U68_",143).
component("YGL154C",468).
component("U55_",134).
component("YOR323C",903).
component("YMR170C",772).
component("YMR169C",771).
component("U2_",113).
component("YER178W",430).
component("YBR221C",234).
component("YIL125W",572).
component("U52_",131).
component("YBR166C",227).
component("YNL280C",826).
component("YGL012W",453).
component("YKL182W",662).
component("U57_",136).
component("YKL216W",671).
component("YDR044W",316).
component("YER014W",397).
component("YKR009C",675).
component("YIL160C",576).
component("YGL205W",473).
component("YMR118C",766).
component("YLR164W",705).
component("YLL041C",684).
component("YKL148C",657).
component("YKL141W",655).
component("YJL045W",589).
component("YDR178W",342).
component("YJR051W",620).
component("YEL047C",391).
component("YDL171C",298).
component("YDL215C",303).
component("YOR375C",914).
component("YDL215C",304).
component("YAL062W",178).
component("U99_",172).
component("YBR035C",205).
component("YMR189W",774).
component("U56_",135).
component("YHR037W",535).
component("YKR080W",679).
component("YER023W",399).
component("YPL023C",920).
component("YGL125W",465).
component("YOR236W",895).
component("YGR204W",507).
component("YLR142W",700).
component("U63_",141).
component("U62_",140).
component("YOR356W",911).
component("YKL150W",658).
component("YIL043C",561).
component("YHR042W",536).
component("YOR221C",892).
component("YML120C",750).
component("YKL192C",666).
component("YKL055C",647).
component("YER061C",408).
component("YMR145C",769).
component("YML120C",751).
component("YKL192C",667).
component("YDL085W",278).
component("YGR234W",510).
component("YFR030W",444).
component("YPL017C",919).
component("YFL018C",435).
component("YPL091W",925).
component("YDR353W",364).
component("YER042W",401).
component("YJR137C",633).
component("YNL052W",799).
component("YMR256C",783).
component("YLR395C",732).
component("YLR038C",690).
component("YIL111W",569).
component("YHR051W",538).
component("YGL191W",471).
component("YGL187C",470).
component("YDL067C",275).
component("Q0275",20).
component("Q0250",19).
component("YPL266W",948).
component("YML110C",749).
component("YBR034C",204).
component("YPL273W",950).
component("YLL062C",687).
component("YDR410C",372).
component("U47_",126).
component("YER091C",421).
component("YJR073C",623).
component("YDR120C",330).
component("YDL033C",269).
component("YOL096C",859).
component("YLR172C",706).
component("YDR019C",312).
component("YBR176W",228).
component("YDR408C",371).
component("YMR120C",767).
component("YBL013W",183).
component("YKL024C",643).
component("YPR074C",967).
component("YBR117C",217).
component("YLR354C",727).
component("YGR043C",485).
component("YMR108W",764).
component("YCL009C",248).
component("YMR062C",760).
component("YNL071W",801).
component("YNR008W",833).
component("YIL160C",577).
component("YNL277W",824).
component("YDR232W",345).
component("YFL017C",434).
component("YPL231W",942).
component("YER061C",409).
component("U86_",160).
component("YPL001W",918).
component("YMR296C",790).
component("YDR062W",324).
component("YDL052C",272).
component("U8_",164).
component("YDR148C",338).
component("YOR377W",915).
component("YGR177C",501).
component("YPL231W",943).
component("YGR147C",496).
component("YDL040C",270).
component("YPL028W",921).
component("YLR195C",707).
component("YGL017W",454).
component("YPR001W",955).
component("YNR001C",831).
component("YCR005C",256).
component("YNL104C",804).
component("YDL182W",300).
component("YDL131W",287).
component("YNL117W",806).
component("YIR031C",583).
component("YOR321W",902).
component("YJR143C",635).
component("YGR199W",506).
component("YDR307W",358).
component("YDL095W",282).
component("YDL093W",281).
component("YAL023C",175).
component("YOR103C",874).
component("YOR085W",872).
component("YMR149W",770).
component("YML019W",737).
component("YJL002C",586).
component("YEL002C",385).
component("YDL232W",306).
component("YCL043C",253).
component("YNL029C",796).
component("YIL085C",566).
component("YMR261C",784).
component("YML100W",747).
component("YBR126C",220).
component("YNL192W",814).
component("YBR038W",207).
component("YBR023C",203).
component("YMR306W",794).
component("YLR342W",725).
component("YGR032W",483).
component("YPR183W",976).
component("YLR209C",708).
component("U104_",23).
component("YMR271C",786).
component("YML106W",748).
component("YOR209C",890).
component("YMR300C",791).
component("YER055C",404).
component("YDR354W",365) :- not remove_orf("YDR354W",365).
component("YFR047C",446).
component("YJR133W",632).
component("YLR209C",709).
component("YML022W",738).
component("YDR441C",375).
component("YDR399W",367).
component("YPR176C",975).
component("YPL172C",933).
component("YNR041C",839).
component("YMR101C",762).
component("YDL090C",280).
component("YBR003W",194).
component("YBR002C",193).
component("YJL167W",606).
component("YJL167W",607).
component("YNL256W",818).
component("YPR069C",964).
component("YDR127W",333).
component("YLR303W",716).
component("YGR012W",481).
component("YJR130C",631).
component("YLR303W",717).
component("YDR035W",314).
component("YBR249C",237).
component("YOR274W",898).
component("YOL143C",866).
component("YBR256C",239).
component("YHR137W",548).
component("YGL202W",472).
component("YLR027C",688).
component("YKL106W",652).
component("YOL140W",865).
component("YKL104C",651).
component("YGR019W",482).
component("YLR089C",695).
component("U64_",142).
component("U61_",139).
component("U51_",130).
component("YJR148W",636).
component("YHR208W",555).
component("YFL030W",437).
component("YOR184W",885).
component("YNR058W",843).
component("YIL116W",571).
component("YGL253W",478).
component("YFR053C",447).
component("YOL136C",864).
component("YIL107C",568).
component("YMR013C",756).
component("YMR205C",776).
component("YGR240C",511).
component("YDR248C",348).
component("YCR036W",262).
component("YGR194C",505).
component("YCL040W",252).
component("YJR105W",629).
component("U16_",63).
component("U15_",56).
component("YPL188W",935).
component("YJR049C",619).
component("YEL041W",389).
component("U96_",170).
component("YKL001C",641).
component("YDR236C",346).
component("YML070W",744).
component("YFL053W",439).
component("YHL032C",525).
component("YLR133W",697).
component("YDR531W",383).
component("U83_",157).
component("U82_",156).
component("U81_",155).
component("YMR208W",777).
component("YPL203W",936).
component("YOR061W",869).
component("YKL166C",660).
component("YJL164C",604).
component("YIL035C",560).
component("YHR205W",554).
component("YHR102W",546).
component("YGL019W",455).
component("YHR025W",534).
component("YOR347C",909).
component("YAL038W",177).
component("YNR012W",834).
component("YPR121W",971).
component("YPL258C",945).
component("YOL055C",852).
component("YPL214C",939).
component("U1_",87).
component("YDR009W",311).
component("YBR020W",201).
component("YNL267W",822).
component("YLR305C",719).
component("YFR019W",442).
component("YDR208W",343).
component("YDR127W",334).
component("U21_",99).
component("U20_",95).
component("YDR147W",337).
component("YDR300C",357).
component("YCR012W",257).
component("YER052C",402).
component("YER069W",412).
component("U19_",86).
component("U18_",78).
component("U17_",71).
component("U76_",151).
component("YMR220W",779).
component("YER170W",429).
component("YDR226W",344).
component("YKL067W",649).
component("YOL055C",853).
component("YDR454C",376).
component("YJR057W",621).
component("YOL061W",857).
component("YKL181W",661).
component("YHL011C",522).
component("YER099C",423).
component("YBL068W",191).
component("YOR143C",881).
component("YNL256W",819).
component("YLR328W",723).
component("YBR018C",197).
component("YBR018C",198).
component("YGR007W",480).
component("YLR328W",724).
component("YKR002W",673).
component("YDL103C",285).
component("U94_",169).
component("YJR010W",615).
component("YGL130W",466).
component("YDR530C",382).
component("YCL050C",254).
component("YPR190C",978).
component("YPR187W",977).
component("YPR110C",969).
component("YPR010C",958).
component("YOR341W",908).
component("YOR340C",907).
component("YOR224C",894).
component("YOR210W",891).
component("YOR207C",888).
component("YOR151C",882).
component("YOR116C",875).
component("YOL005C",845).
component("YNR003C",832).
component("YNL248C",817).
component("YNL151C",811).
component("YNL113W",805).
component("YKL144C",656).
component("YJR063W",622).
component("YJL148W",601).
component("YJL140W",600).
component("YIL021W",559).
component("YHR143W-A",549).
component("YGL070C",463).
component("YFL036W",438).
component("YDR404C",370).
component("YDR156W",339).
component("YDR045C",317).
component("YDL150W",294).
component("YDL140C",289).
component("YBR154C",226).
component("YPR175W",974).
component("YPL167C",932).
component("YOR330C",904).
component("YOL115W",862).
component("YNL299W",828).
component("YNL262W",821).
component("YNL102W",803).
component("YJR043C",618).
component("YJR006W",614).
component("YJL090C",593).
component("YIL139C",573).
component("YEL055C",392).
component("YDR419W",373).
component("YDR121W",331).
component("YDL102W",284).
component("YCR014C",258).
component("YBR278W",242).
component("YBL035C",185).
component("YKL035W",646).
component("YHL012W",523).
component("YHR123W",547).
component("YPR113W",970).
component("YBR243C",235).
component("YNL130C",807).
component("YDL142C",293).
component("YPL148C",930).
component("YER026C",400).
component("YCL004W",247).
component("YOR251C",897).
component("YGR286C",519).
component("YJL068C",590).
component("YDR058C",322).
component("YNR034W",838).
component("YHR163W",551).
component("YGR248W",513).
component("YCR073W-A",264).
component("YDL086W",279).
component("YOL011W",847).
component("YMR008C",754).
component("YMR006C",753).
component("U105_",24).
component("U101_",21).
component("YBL015W",184).
component("YJL068C",591).
component("YPL072W",924).
component("YOR124C",876).
component("YNL186W",813).
component("YMR304W",793).
component("YMR223W",780).
component("YKR098C",682).
component("YJL197W",608).
component("YIL156W",575).
component("YFR010W",441).
component("YER151C",427).
component("YER144C",426).
component("YER098W",422).
component("YDR069C",325).
component("YDL122W",286).
component("YBR058C",208).
component("YBL067C",190).
component("YDR272W",352).
component("U84_",158).
component("YDR481C",377).
component("YLR377C",730).
component("YDR074W",326).
component("YPL179W",934).
component("YNR032W",836).
component("YML057W",743).
component("YML016C",736).
component("YLR433C",734).
component("YGR123C",493).
component("YER133W",425).
component("YER089C",419).
component("YDR436W",374).
component("YDR075W",327).
component("YDL188C",301).
component("YDL134C",288).
component("YDL047W",271).
component("YDL006W",265).
component("YBR125C",219).
component("YBL056W",189).
component("YPR073C",965).
component("YHR215W",556).
component("YDL024C",268).
component("YBR093C",215).
component("YBR092C",214).
component("YAR071W",180).
component("YIL053W",563).
component("YER062C",410).
component("YHR046C",537).
component("U9_",173).
component("YGR208W",509).
component("YPL228W",940).
component("YMR180C",773).
component("YDL236W",307).
component("YJL155C",603).
component("YPR073C",966).
component("YOR208W",889).
component("YNL053W",800).
component("YMR036C",759).
component("YIR026C",580).
component("YIL113W",570).
component("YFR028C",443).
component("YER075C",415).
component("YDL230W",305).
...
component("U25_",110).
component("U24_",109).
component("YPL268W",949).
component("YOR360C",912).
component("YGL248W",477).
component("YKR031C",676).
component("YPL206C",937).
component("YGL027C",457).
component("YLR286C",714).
component("YJR153W",638).
component("YJL221C",613).
component("YJL216C",611).
component("YIL172C",579).
component("YGR292W",521).
component("YGR287C",520).
component("YBR299W",246).
component("YBR184W",229).
component("YOR190W",886).
component("YLR300W",715).
component("YGR282C",518).
component("YDR261C",350).
component("YDR400W",368).
component("U23_",108).
component("YML035C",739).
component("YJL070C",592).
component("YBR284W",243).
component("U102_",22).
component("YNL045W",798).
component("YLR160C",704).
component("YLR158C",703).
component("YLR157C",702).
component("YLR155C",701).
component("YDR321W",359).
component("YGL037C",458).
component("YMR293C",789).
component("YDR242W",347).
component("YLR308W",722).
component("YLR307W",721).
component("YBR208C",231).
component("YMR281W",788).
component("U53_",132).
component("YIR027C",581).
component("YPL111W",928).
component("YIR032C",584).
component("YIR029W",582).
component("YPR062W",963).
component("YMR120C",768).
component("YLR028C",689).
component("YHR144C",550).
component("YGR267C",517).
component("YNL141W",808).
component("YBR153W",225).
component("YDL238C",308).
component("YNL141W",809).
component("YLR245C",712).
component("YML035C",740).
component("YBR084W",212).
component("YJL126W",596).
component("U44_",124).
component("YDL100C",283).
component("U87_",161).
component("U40_",122).
component("YMR267W",785).
component("YBR011C",196).
component("YHR201C",553).
component("YBR111C",216).
component("YBR252W",238).
component("YCL030C",251).
component("YER005W",396).
component("YIL048W",562).
component("YER166W",428).
component("YDR093W",329).
component("YAL026C",176).
component("YLR231C",710).
component("U88_",162).
component("YLR134W",698).
component("YLR044C",691).
component("YGR087C",489).
component("YDR380W",366).
component("YDL080C",277).
component("U98_",171).
component("YMR250W",782).
component("YKL184W",665).
component("YOR128C",877).
component("YEL021W",388).
component("YNR043W",840).
component("U93_",168).
component("YDR047W",319).
component("U54_",133).
component("YKL211C",669) :- not remove_orf("YKL211C",669).
component("YKR097W",681).
component("YOL052C",851).
component("YNL169C",812).
component("YGR170W",498).
component("YKL060C",648).
component("YNL256W",820).
component("YDR294C",354).
component("YEL046C",390).
component("YNR033W",837).
component("YPR006C",957).
component("YER065C",411).
component("YKL211C",670) :- not remove_orf("YKL211C",670).
component("YER090W",670) :- not remove_orf("YER090W",670).
component("YER090W",420) :- not remove_orf("YER090W",420).
component("YDR127W",335).
component("YPL281C",954).
component("YOR393W",917).
component("YMR323W",795).
component("YHR174W",552).
component("YGR254W",514).
component("YPL262W",946).
component("YGL026C",456) :- not remove_orf("YGL026C",456).
component("YGR155W",497).
component("YLR304C",718).
component("YJL200C",609).
component("YNL316C",829).
component("YKL182W",663).
component("YPL212C",938).
component("YNL292W",827).
component("YGL063W",462).
component("YFL001W",432).
component("YOR278W",899).
component("YPR002W",956).
component("U49_",127).
component("YJR016C",616).
component("YCR053W",263).
component("YDR127W",336).
component("YGL148W",467).
component("YIL168W",578).
component("YER086W",417).
component("YCL064C",255).
component("YLR359W",729).
component("YAL012W",174).
component("YFR055W",448).
component("YJL005W",587).
component("YOR176W",884).
component("YJL121C",595).
component("YBR019C",199).
component("YBR019C",200).
component("YDR050C",320).
component("YDR007W",310) :- not remove_orf("YDR007W",310).
component("YOR095C",873).
component("YER003C",395).
component("YBR196C",230).
component("YGL001C",450).
component("U14_",48).
component("YOL056W",854).
component("YKL152C",659).
component("YDL021W",266).
component("YMR105C",763).
component("YKL127W",653).
component("YEL058W",393).
component("YPR060C",962).
component("YHR072W",540).
component("YJL153C",602).
component("YPL097W",926).
component("YGR185C",504).
component("YGR264C",516).
component("YGR171C",499).
component("YHR011W",530).
component("YDR023W",313).
component("YPL104W",927).
component("YLL018C",683).
component("YPR081C",968).
component("YBR121C",218).
component("YHR020W",533).
component("YER087W",418).
component("YNL247W",816).
component("YOL033W",849).
component("YGL245W",476).
component("YHR091C",542).
component("YDR341C",360).
component("YOL097C",860).
component("YDR268W",351).
component("YPR047W",961).
component("YLR060W",693).
component("YFL022C",436).
component("YPR033C",959).
component("YHR019C",531).
component("YCR024C",259).
component("YHR019C",532).
component("YPL160W",931).
component("YLR382C",731).
component("YNL073W",802).
component("YDR037W",315).
component("YOR335C",905).
component("YGR094W",491).
component("YOR317W",901).
component("YMR246W",781).
component("YIL009W",558).
component("YER015W",398).
component("YOR142W",880).
component("YGR244C",512).
component("YPR035W",960).
component("U89_",163).
component("YOR241W",896).
component("YMR113W",765).
component("YKL132C",654).
component("YOR339C",906).
component("YMR022W",758).
component("YLR306W",720).
component("YKL210W",668).
component("YGR133W",495).
component("YGL058W",460).
component("YER100W",424).
component("YEL012W",386).
component("YDR177W",341).
component("YDR092W",328).
component("YDR059C",323).
component("YDR054C",321).
component("YDL064W",273).
component("YBR082C",211).
component("YJL101C",594).
component("YOL049W",850).
component("U92_",167).
component("YAR015W",179).
component("YGL234W",474).
component("YER183C",431).
component("U91_",166).
component("U90_",165).
component("YNR057C",842).
component("YDL141W",290).
component("YDL141W",291).
component("YGL234W",475).
component("YDL141W",292).
component("YJR103W",627).
component("YBL039C",186).
component("YGR204W",508).
component("YBR084W",213).
component("YOL058W",855).
component("YBR208C",232).
component("YHR074W",541).
component("YMR217W",778).
component("YGR061C",488).
component("YPR145W",973).
component("YGR124W",494).
component("YOR303W",900).
component("YJR109C",630).
component("YJL130C",598).
component("YGL062W",461).
component("YBR218C",233).
component("YPL231W",944).
component("YNR016C",835).
component("YKL182W",664).
component("YGR037C",484).
component("YOR005C",868).
component("YDL164C",295).
component("YOL010W",846).
component("YPR138C",972).
component("YPL274W",951).
component("YPL265W",947).
component("YPL134C",929).
component("YPL057C",923).
component("YPL036W",922).
component("YOR348C",910).
component("YOR222W",893).
component("YOR192C",887).
component("YOR171C",883).
component("YOR130C",878).
component("YOR071C",871).
component("YOL156W",867).
component("YOL103W",861).
component("YOL020W",848) :- not remove_orf("YOL020W",848).
component("YNR072W",844).
component("YNR056C",841).
component("YNL318C",830).
component("YNL268W",823).
component("YNL142W",810).
component("YMR272C",787).
component("YMR202W",775).
component("YMR011W",755).
component("YML123C",752).
component("YLR348C",726).
component("YLR260W",713).
component("YLR237W",711).
component("YLR138W",699).
component("YLR100C",696).
component("YLR081W",694).
component("YLL061W",686).
component("YLL043W",685).
component("YKR093W",680).
component("YKR053C",678).
component("YKR039W",677) :- not remove_orf("YKR039W",677).
component("YKL217W",672).
component("YKL004W",642).
component("YJR158W",639).
component("YJR152W",637).
component("YJR095W",626).
component("YJR077C",624).
component("YJL219W",612).
component("YJL214W",610).
component("YJL134W",599).
component("YJL129C",597).
component("YHR096C",545).
component("YHR094C",544).
component("YHR092C",543).
component("YHL036W",526).
component("YHL016C",524).
component("YGR121C",492).
component("YGR055W",486).
component("YGL186C",469).
component("YGL077C",464).
component("YGL008C",451).
component("YFL055W",440).
component("YFL011W",433).
component("YER060W-A",407).
component("YER060W",406).
component("YER056C",405).
component("YER053C",403).
component("YEL069C",394).
component("YEL017C-A",387).
component("YDR536W",384).
component("YDR508C",380).
component("YDR503C",379).
component("YDR497C",378).
component("YDR345C",363).
component("YDR343C",362).
component("YDR342C",361).
component("YDR297W",356).
component("YDR294C",355).
component("YDR284C",353).
component("YDR046C",318) :- not remove_orf("YDR046C",318).
component("YDL245C",309).
component("YDL210W",302).
component("YCR032W",261).
component("YCR024C-A",260).
component("YCL025C",249).
component("YBR298C",245).
component("YBR291C",244).
component("YBR069C",210) :- not remove_orf("YBR069C",210).
component("YBR068C",209) :- not remove_orf("YBR068C",209).
component("YBR036C",206).
component("YBR021W",202).
...
catalyst(6160,791).
catalyst(3870,404).
catalyst(3620,365) :- not remove_reaction(3620,365).
catalyst(2110,446).
catalyst(2190,446).
catalyst(5550,632).
catalyst(5791,709).
...
catalyst(1960,319).
catalyst(3460,133).
catalyst(3600,669) :- not remove_reaction(3600,669).
catalyst(8000,681).
catalyst(3941,851).
catalyst(3942,851).
catalyst(6890,812).
...
catalyst(8020,957).
catalyst(8020,411).
catalyst(1890,670) :- not remove_reaction(1890,670).
catalyst(3630,670) :- not remove_reaction(3630,670).
catalyst(1890,420) :- not remove_reaction(1890,420).
catalyst(3630,420) :- not remove_reaction(3630,420).
catalyst(3740,335).
catalyst(8231,954).
catalyst(8232,954).
catalyst(8231,917).
...
catalyst(8051,946).
catalyst(8052,946).
catalyst(3590,456) :- not remove_reaction(3590,456).
catalyst(10910,456) :- not remove_reaction(10910,456).
catalyst(4570,497).
catalyst(8181,718).
catalyst(8182,718).
catalyst(8181,609).
...
catalyst(8281,320).
catalyst(8282,320).
catalyst(3610,310) :- not remove_reaction(3610,310).
catalyst(7921,873).
catalyst(7922,873).
catalyst(7841,395).
catalyst(7842,395).
...
catalyst(1210,867).
catalyst(1160,861).
catalyst(801,848) :- not remove_reaction(801,848).
catalyst(802,848) :- not remove_reaction(802,848).
catalyst(811,848) :- not remove_reaction(811,848).
catalyst(812,848) :- not remove_reaction(812,848).
catalyst(831,848) :- not remove_reaction(831,848).
catalyst(832,848) :- not remove_reaction(832,848).
catalyst(901,848) :- not remove_reaction(901,848).
catalyst(902,848) :- not remove_reaction(902,848).
catalyst(941,848) :- not remove_reaction(941,848).
catalyst(942,848) :- not remove_reaction(942,848).
catalyst(1170,844).
catalyst(1210,844).
catalyst(700,841).
catalyst(1200,830).
...
catalyst(650,680).
catalyst(6560,678).
catalyst(761,677) :- not remove_reaction(761,677).
catalyst(762,677) :- not remove_reaction(762,677).
...
catalyst(821,677) :- not remove_reaction(821,677).
catalyst(822,677) :- not remove_reaction(822,677).
...
catalyst(861,677) :- not remove_reaction(861,677).
catalyst(862,677) :- not remove_reaction(862,677).
...
catalyst(941,677) :- not remove_reaction(941,677).
catalyst(942,677) :- not remove_reaction(942,677).
...
catalyst(6550,355).
catalyst(6690,353).
catalyst(791,318) :- not remove_reaction(791,318).
catalyst(792,318) :- not remove_reaction(792,318).
catalyst(801,318) :- not remove_reaction(801,318).
catalyst(802,318) :- not remove_reaction(802,318).
catalyst(811,318) :- not remove_reaction(811,318).
catalyst(812,318) :- not remove_reaction(812,318).
catalyst(831,318) :- not remove_reaction(831,318).
catalyst(832,318) :- not remove_reaction(832,318).
catalyst(841,318) :- not remove_reaction(841,318).
catalyst(842,318) :- not remove_reaction(842,318).
catalyst(861,318) :- not remove_reaction(861,318).
catalyst(862,318) :- not remove_reaction(862,318).
catalyst(901,318) :- not remove_reaction(901,318).
catalyst(902,318) :- not remove_reaction(902,318).
catalyst(1170,309).
catalyst(1210,309).
catalyst(690,302).
catalyst(730,302).
...
catalyst(1511,244).
catalyst(1512,244).
catalyst(771,210) :- not remove_reaction(771,210).
catalyst(772,210) :- not remove_reaction(772,210).
catalyst(791,210) :- not remove_reaction(791,210).
catalyst(792,210) :- not remove_reaction(792,210).
catalyst(801,210) :- not remove_reaction(801,210).
catalyst(802,210) :- not remove_reaction(802,210).
catalyst(811,210) :- not remove_reaction(811,210).
catalyst(812,210) :- not remove_reaction(812,210).
catalyst(861,210) :- not remove_reaction(861,210).
catalyst(862,210) :- not remove_reaction(862,210).
catalyst(901,210) :- not remove_reaction(901,210).
catalyst(902,210) :- not remove_reaction(902,210).
catalyst(791,209) :- not remove_reaction(791,209).
catalyst(792,209) :- not remove_reaction(792,209).
...
catalyst(841,209) :- not remove_reaction(841,209).
catalyst(842,209) :- not remove_reaction(842,209).
catalyst(861,209) :- not remove_reaction(861,209).
catalyst(862,209) :- not remove_reaction(862,209).
catalyst(901,209) :- not remove_reaction(901,209).
catalyst(902,209) :- not remove_reaction(902,209).
catalyst(6600,206).
catalyst(620,202).
catalyst(540,187).
catalyst(2660,159).
