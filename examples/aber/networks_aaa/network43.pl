...
component("YGR060W",191).
component("YGL012W",178).
component("YOL086C",322).
component("YMR303C",296).
component("YGL256W",186).
component("YDL168W",118).
component("YBR145W",87).
component("YPL231W",356).
component("YGL001C",175).
component("YML056C",281).
component("YLR432W",278).
component("YHR216W",213).
component("YAR075W",72).
component("YAR073W",71).
component("YDR127W",131).
component("YJR139C",245).
component("YOR136W",329).
component("YDL066W",111).
component("YIL155C",218).
component("YJR078W",238).
component("YJR025C",233).
component("YBL098W",77).
component("YMR015C",285).
component("YDR402C",148).
component("YJR104C",241).
component("YHR008C",205).
component("YER070W",163).
component("YDL168W",119).
component("YPL276W",363).
component("YPL275W",362).
component("YOR388C",347).
component("YGL154C",184).
component("YOR323C",340).
component("YMR170C",291).
component("YMR169C",290).
component("YBR166C",90).
component("YER014W",160).
component("YMR118C",289).
component("YLR164W",268).
component("YLL041C",264).
component("YKL148C",254).
component("YJL045W",222).
component("YDR178W",137).
component("YJR051W",235).
component("YEL047C",157).
component("YOR375C",346).
component("YDL215C",120).
component("YAL062W",70).
component("YBR035C",80).
component("YER023W",161).
component("YOR236W",338).
component("YGR204W",198).
component("U62_",52).
component("YPL017C",350).
component("YFL018C",167).
component("U47_",46).
component("YKL024C",248).
component("YPR074C",370).
component("YBR117C",86).
component("YCL009C",101).
component("YMR062C",287).
component("YPL231W",357).
component("YPL001W",349).
component("YPL231W",358).
component("YGR147C",195).
component("YDL040C",110).
component("YPL028W",351).
component("YPR001W",365).
component("YNR001C",312).
component("YNL117W",303).
component("YIR031C",220).
component("YNL029C",298).
component("YIL085C",215).
component("YLR209C",269).
component("YMR300C",295).
component("YER055C",162).
component("YDR354W",144) :- not remove_orf("YDR354W",144).
component("YFR047C",173).
component("YJR133W",244).
component("YML022W",279).
component("YDR441C",151).
component("YDR399W",146).
component("YDR127W",132).
component("YJR130C",243).
component("YLR303W",275).
component("YDR035W",125).
component("YBR249C",94).
component("YBR256C",95).
component("YHR137W",208).
component("YLR027C",265).
component("YKL106W",251).
component("YKL104C",250).
component("YGR019W",188).
component("U64_",53).
component("U51_",48).
component("YJR148W",246).
component("YGL253W",185).
component("YFR053C",174).
component("YMR205C",293).
component("YGR240C",199).
component("YDR248C",139).
component("YCR036W",108).
component("YCL040W",103).
component("YJR105W",242).
component("U16_",26).
component("U15_",24).
component("YKL001C",247).
component("YML070W",282).
component("YFL053W",169).
component("U83_",63).
component("U82_",62).
component("YMR208W",294).
component("YOR347C",345).
component("YAL038W",69).
component("YPR121W",372).
component("YPL258C",360).
component("YOL055C",319).
component("U1_",34).
component("YNL267W",309).
component("YLR305C",276).
component("YFR019W",171).
component("YDR208W",138).
component("YDR127W",133).
component("U21_",38).
component("U20_",37).
component("YDR300C",142).
component("YCR012W",105).
component("U18_",31).
component("U76_",61).
component("YDR454C",152).
component("YOL061W",321).
component("YKL181W",255).
component("YHL011C",202).
component("YER099C",166).
component("YBL068W",76).
component("YOR143C",330).
component("YGR007W",187).
component("YCL050C",104).
component("YPR190C",376).
component("YPR187W",375).
component("YPR110C",371).
component("YPR010C",366).
component("YOR341W",344).
component("YOR340C",343).
component("YOR224C",337).
component("YOR210W",336).
component("YOR207C",334).
component("YOR151C",331).
component("YOR116C",328).
component("YOL005C",316).
component("YNR003C",313).
component("YNL248C",307).
component("YNL151C",306).
component("YNL113W",302).
component("YKL144C",253).
component("YJR063W",236).
component("YJL148W",230).
component("YJL140W",229).
component("YIL021W",214).
component("YHR143W-A",209).
component("YGL070C",182).
component("YFL036W",168).
component("YDR404C",149).
component("YDR156W",136).
component("YDR045C",126).
component("YDL150W",116).
component("YDL140C",115).
component("YBR154C",89).
component("YPR175W",374).
component("YPL167C",354).
component("YOR330C",341).
component("YOL115W",324).
component("YNL299W",310).
component("YNL262W",308).
component("YNL102W",301).
component("YJR043C",234).
component("YJR006W",232).
component("YJL090C",224).
component("YIL139C",217).
component("YEL055C",158).
component("YDR419W",150).
component("YDR121W",130).
component("YDL102W",114).
component("YCR014C",106).
component("YBR278W",97).
component("YBL035C",74).
component("YKL035W",249).
component("YHL012W",203).
component("YDR058C",129).
component("YDL086W",113).
component("YOL011W",317).
component("YMR008C",284).
component("YMR006C",283).
component("U101_",18).
component("YBL015W",73).
component("U84_",64).
component("YPR073C",368).
component("YHR215W",212).
component("YDL024C",109).
component("YBR093C",84).
component("YBR092C",83).
component("YPL228W",355).
component("YMR180C",292).
component("YDL236W",122).
component("YJL155C",231).
component("YPR073C",369).
component("YOR208W",335).
component("YNL053W",300).
component("YMR036C",286).
component("YIR026C",219).
component("YIL113W",216).
component("YFR028C",172).
component("YER075C",164).
component("YDL230W",121).
component("YBR276C",96).
component("U34_",44).
component("U30_",43).
component("U25_",42).
component("U24_",41).
component("YKR031C",260).
component("YLR286C",273).
component("YOR190W",332).
component("YLR300W",274).
component("YGR282C",201).
component("YDR261C",140).
component("YDR400W",147).
component("YML035C",280).
component("YJL070C",223).
component("YBR284W",98).
component("YNL045W",299).
component("YGL037C",180).
component("YBR208C",91).
component("U53_",49).
component("YIR032C",221).
component("YHR144C",210).
component("YBR153W",88).
component("YDL238C",123).
component("YNL141W",304).
component("YLR245C",272).
component("YJL126W",226).
component("YBR111C",85).
component("YER005W",159).
component("YLR231C",270).
component("U88_",65).
component("YLR134W",267).
component("YLR044C",266).
component("YGR087C",192).
component("YDR380W",145).
component("YDL080C",112).
component("U93_",67).
component("U54_",50).
component("YKL211C",258) :- not remove_orf("YKL211C",258).
component("YGR170W",197).
component("YDR294C",141).
component("YNR033W",315).
component("YKL211C",259) :- not remove_orf("YKL211C",259).
component("YER090W",259) :- not remove_orf("YER090W",259).
component("YER090W",165) :- not remove_orf("YER090W",165).
component("YDR127W",134).
component("YPL281C",364).
component("YOR393W",348).
component("YMR323W",297).
component("YHR174W",211).
component("YGR254W",200).
component("YGL026C",179) :- not remove_orf("YGL026C",179).
component("YGR155W",196).
component("YNL316C",311).
component("YKL182W",256).
component("YDR127W",135).
component("YGL148W",183).
component("YAL012W",68).
component("YBR019C",78).
component("YDR050C",128).
component("YDR007W",124) :- not remove_orf("YDR007W",124).
component("YOR095C",327).
component("YGL001C",176).
component("YMR105C",288).
component("YKL127W",252).
component("YPR060C",367).
component("YPL104W",353).
component("YLL018C",263).
component("YHR091C",207).
component("YDR341C",143).
component("YOL097C",323).
component("YOR335C",342).
component("YGR094W",193).
component("U89_",66).
component("YJL101C",225).
component("YJR103W",240).
component("YBL039C",75).
component("YOL058W",320).
component("YBR208C",92).
component("YHR074W",206).
component("YOR303W",339).
component("YGL062W",181).
component("YBR218C",93).
component("YPL231W",359).
component("YNR016C",314).
component("YKL182W",257).
component("YGR037C",189).
component("YOR005C",325).
component("YDL164C",117).
component("YPR138C",373).
component("YPL265W",361).
component("YPL036W",352).
component("YOR192C",333).
component("YOR071C",326).
component("YOL020W",318) :- not remove_orf("YOL020W",318).
component("YNL142W",305).
component("YLR348C",277).
component("YLR237W",271).
component("YKR053C",262).
component("YKR039W",261) :- not remove_orf("YKR039W",261).
component("YJR095W",239).
component("YJR077C",237).
component("YJL134W",228).
component("YJL129C",227).
component("YHL036W",204).
component("YGR121C",194).
component("YGR055W",190).
component("YGL008C",177).
component("YFL055W",170).
component("YEL017C-A",156).
component("YDR536W",155).
component("YDR508C",154).
component("YDR503C",153).
component("YDR046C",127) :- not remove_orf("YDR046C",127).
component("YCR024C-A",107).
component("YCL025C",102).
component("YBR298C",100).
component("YBR291C",99).
component("YBR069C",82) :- not remove_orf("YBR069C",82).
component("YBR068C",81) :- not remove_orf("YBR068C",81).
component("YBR021W",79).
component("U75_",60).
component("U74_",59).
component("U73_",58).
component("U72_",57).
...
catalyst(6160,295).
catalyst(3870,162).
catalyst(3620,144) :- not remove_reaction(3620,144).
catalyst(2190,173).
catalyst(5550,244).
catalyst(5650,279).
catalyst(5650,151).
...
catalyst(2300,67).
catalyst(3460,50).
catalyst(3600,258) :- not remove_reaction(3600,258).
catalyst(6900,197).
catalyst(8781,141).
catalyst(8782,141).
catalyst(2550,315).
catalyst(3630,259) :- not remove_reaction(3630,259).
catalyst(3630,165) :- not remove_reaction(3630,165).
catalyst(3740,134).
catalyst(8231,364).
catalyst(8232,364).
catalyst(8231,348).
...
catalyst(8231,200).
catalyst(8232,200).
catalyst(3590,179) :- not remove_reaction(3590,179).
catalyst(10910,179) :- not remove_reaction(10910,179).
catalyst(4570,196).
catalyst(3680,311).
catalyst(7141,256).
catalyst(7142,256).
...
catalyst(8281,128).
catalyst(8282,128).
catalyst(3610,124) :- not remove_reaction(3610,124).
catalyst(7921,327).
catalyst(7922,327).
catalyst(6370,176).
catalyst(7861,288).
...
catalyst(190,271).
catalyst(6560,262).
catalyst(771,261) :- not remove_reaction(771,261).
catalyst(772,261) :- not remove_reaction(772,261).
catalyst(781,261) :- not remove_reaction(781,261).
catalyst(782,261) :- not remove_reaction(782,261).
catalyst(801,261) :- not remove_reaction(801,261).
catalyst(802,261) :- not remove_reaction(802,261).
catalyst(811,261) :- not remove_reaction(811,261).
catalyst(812,261) :- not remove_reaction(812,261).
catalyst(831,261) :- not remove_reaction(831,261).
catalyst(832,261) :- not remove_reaction(832,261).
catalyst(841,261) :- not remove_reaction(841,261).
catalyst(842,261) :- not remove_reaction(842,261).
catalyst(881,261) :- not remove_reaction(881,261).
catalyst(882,261) :- not remove_reaction(882,261).
catalyst(1191,261) :- not remove_reaction(1191,261).
catalyst(1192,261) :- not remove_reaction(1192,261).
catalyst(1250,239).
catalyst(1581,237).
catalyst(1582,237).
catalyst(6560,228).
...
catalyst(1501,99).
catalyst(1502,99).
catalyst(771,82) :- not remove_reaction(771,82).
catalyst(772,82) :- not remove_reaction(772,82).
...
catalyst(801,81) :- not remove_reaction(801,81).
catalyst(802,81) :- not remove_reaction(802,81).
catalyst(811,81) :- not remove_reaction(811,81).
catalyst(812,81) :- not remove_reaction(812,81).
catalyst(831,81) :- not remove_reaction(831,81).
catalyst(832,81) :- not remove_reaction(832,81).
catalyst(841,81) :- not remove_reaction(841,81).
catalyst(842,81) :- not remove_reaction(842,81).
catalyst(620,79).
catalyst(2920,60).
catalyst(2920,59).
catalyst(2920,58).
