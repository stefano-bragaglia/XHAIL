...
component("YNL280C",618).
component("YGR060W",366).
component("YGL012W",341).
component("YKR009C",504).
component("YOL086C",646).
component("YMR303C",591).
component("YMR083W",570).
component("YGL256W",359).
component("YDL168W",222).
component("YBR145W",166).
component("YPL231W",705).
component("U46_",90).
component("YBR149W",167).
component("YJR159W",476).
component("YGL001C",338).
component("YIL094C",420).
component("YHR063C",403).
component("YBR153W",168).
component("YML056C",557).
component("YLR432W",551).
component("YHR216W",414).
component("YAR075W",133).
component("YAR073W",132).
component("YDR127W",247).
component("YJR139C",472).
component("YOL126C",651).
component("YDL078C",205).
component("YKL029C",481).
component("YOR136W",661).
component("YNL037C",595).
component("YDL066W",204).
component("YNL241C",610).
component("YOL059W",644).
component("YDL022W",199).
component("YLR355C",548).
component("YML086C",560).
component("YIL155C",426).
component("YPR191W",733).
component("YOR065W",656).
component("YJL166W",450).
component("YHR001W-A",395).
component("YGR183C",378).
component("YFR033C",334).
component("YDR529C",285).
component("YBL045C",139).
component("Q0105",18).
component("YGR088W",368).
component("YDR256C",261).
component("YKL026C",480).
component("YIR037W",433).
component("YBR244W",178).
component("YJR078W",463).
component("YJR025C",457).
component("YGR255C",388).
component("U108_",22).
component("YBL098W",143).
component("YMR015C",567).
component("YDR402C",275).
component("YGL055W",346).
component("YGR175C",375).
component("YJR104C",466).
component("YHR008C",396).
component("YJL026W",434).
component("YGR180C",377).
component("YER070W",307).
component("U35_",86).
component("YDL168W",223).
component("YDR158W",255).
component("YPL276W",714).
component("YPL275W",713).
component("YOR388C",689).
component("YOR374W",686).
component("YER073W",308).
component("YGL154C",352).
component("U55_",97).
component("YOR323C",678).
component("YMR170C",577).
component("YMR169C",576).
component("U2_",83).
component("YBR221C",176).
component("YIL125W",424).
component("U52_",94).
component("YBR166C",171).
component("YNL280C",619).
component("YGL012W",342).
component("U57_",98).
component("YKL216W",501).
component("YDR044W",237).
component("YER014W",295).
component("YKR009C",505).
component("YIL160C",428).
component("YGL205W",355).
component("YMR118C",573).
component("YLR164W",531).
component("YLL041C",513).
component("YKL148C",491).
component("YKL141W",489).
component("YJL045W",435).
component("YDR178W",256).
component("YJR051W",459).
component("YEL047C",290).
component("YOR375C",687).
component("YDL215C",227).
component("YAL062W",130).
component("U99_",125).
component("YBR035C",153).
component("YHR037W",400).
component("YKR080W",509).
component("YER023W",296).
component("YOR236W",674).
component("YGR204W",381).
component("YLR142W",526).
component("U62_",101).
component("YKL150W",492).
component("YIL043C",416).
component("YHR042W",401).
component("YOR221C",672).
component("YML120C",563).
component("YKL192C",498).
component("YKL055C",483).
component("YER061C",304).
component("YFR030W",333).
component("YPL017C",692).
component("YFL018C",325).
component("YER042W",298).
component("YJR137C",471).
component("YPL266W",711).
component("YML110C",562).
component("YBR034C",152).
component("YPL273W",712).
component("YLL062C",516).
component("U47_",91).
component("YER091C",314).
component("YJR073C",461).
component("YDL033C",201).
component("YOL096C",647).
component("YLR172C",532).
component("YDR019C",233).
component("YDR408C",277).
component("YMR120C",574).
component("YBL013W",134).
component("YKL024C",479).
component("YPR074C",725).
component("YBR117C",162).
component("YLR354C",547).
component("YGR043C",364).
component("YCL009C",187).
component("YMR062C",569).
component("YNL071W",598).
component("YNR008W",626).
component("YFL017C",324).
component("YPL231W",706).
component("YER061C",305).
component("U86_",116).
component("YPL001W",691).
component("YDR148C",253).
component("YOR377W",688).
component("YGR177C",376).
component("YPL231W",707).
component("YGR147C",372).
component("YDL040C",202).
component("YPL028W",693).
component("YGL017W",343).
component("YPR001W",716).
component("YNR001C",624).
component("YDL182W",224).
component("YDL131W",214).
component("YNL117W",602).
component("YIR031C",431).
component("YOR321W",677).
component("YJR143C",473).
component("YGR199W",380).
component("YDR307W",268).
component("YDL095W",209).
component("YDL093W",208).
component("YAL023C",127).
component("YNL029C",594).
component("YIL085C",419).
component("YMR261C",585).
component("YML100W",561).
component("YBR126C",165).
component("YNL192W",609).
component("YBR038W",155).
component("YBR023C",151).
component("YLR209C",533).
component("U104_",21).
component("YOR209C",670).
component("YMR300C",590).
component("YER055C",300).
component("YDR354W",271) :- not remove_orf("YDR354W",271).
component("YFR047C",335).
component("YJR133W",470).
component("YLR209C",534).
component("YML022W",554).
component("YDR441C",280).
component("YDR399W",273).
component("YJL167W",451).
component("YNL256W",613).
component("YDR127W",248).
component("YLR303W",540).
component("YGR012W",361).
component("YJR130C",469).
component("YLR303W",541).
component("YDR035W",235).
component("YBR249C",179).
component("YOL143C",653).
component("YBR256C",180).
component("YHR137W",408).
component("YGL202W",354).
component("YLR027C",517).
component("YKL106W",486).
component("YKL104C",485).
component("YGR019W",362).
component("YLR089C",522).
component("U64_",102).
component("U61_",100).
component("U51_",93).
component("YJR148W",474).
component("YOR184W",665).
component("YNR058W",634).
component("YIL116W",423).
component("YGL253W",358).
component("YFR053C",336).
component("YOL136C",652).
component("YIL107C",421).
component("YMR205C",579).
component("YGR240C",384).
component("YDR248C",260).
component("YCR036W",195).
component("YCL040W",190).
component("YJR105W",467).
component("U16_",44).
component("U15_",39).
component("U96_",123).
component("YKL001C",477).
component("YML070W",559).
component("YFL053W",328).
component("YHL032C",393).
component("YDR531W",286).
component("U83_",114).
component("U82_",113).
component("U81_",112).
component("YMR208W",580).
component("YOR347C",683).
component("YAL038W",129).
component("YNR012W",627).
component("YPR121W",728).
component("YPL258C",709).
component("YOL055C",641).
component("U1_",64).
component("YDR009W",232).
component("YBR020W",149).
component("YNL267W",616).
component("YLR305C",543).
component("YFR019W",331).
...
component("U17_",51).
component("U76_",110).
component("YMR220W",582).
component("YER170W",321).
component("YDR226W",258).
component("YKL067W",484).
component("YDR454C",281).
component("YOL061W",645).
component("YKL181W",494).
component("YHL011C",391).
component("YER099C",316).
component("YBL068W",142).
component("YOR143C",663).
component("YLR328W",544).
component("YBR018C",145).
component("YBR018C",146).
component("YGR007W",360).
component("YLR328W",545).
component("YKR002W",503).
component("YDL103C",212).
component("YJR010W",456).
component("YCL050C",191).
component("YPR190C",732).
component("YPR187W",731).
component("YPR110C",727).
component("YPR010C",718).
component("YOR341W",682).
component("YOR340C",681).
component("YOR224C",673).
component("YOR210W",671).
component("YOR207C",668).
component("YOR151C",664).
component("YOR116C",659).
component("YOL005C",635).
component("YNR003C",625).
component("YNL248C",612).
component("YNL151C",606).
component("YNL113W",601).
component("YKL144C",490).
component("YJR063W",460).
component("YJL148W",447).
component("YJL140W",446).
component("YIL021W",415).
component("YHR143W-A",409).
component("YGL070C",349).
component("YFL036W",327).
...
component("YPR175W",730).
component("YPL167C",701).
component("YOR330C",679).
component("YOL115W",650).
component("YNL299W",621).
component("YNL262W",615).
component("YNL102W",600).
component("YJR043C",458).
component("YJR006W",455).
component("YJL090C",439).
component("YIL139C",425).
...
component("YKL035W",482).
component("YHL012W",392).
component("YHR123W",407).
...
component("YNR034W",631).
component("YHR163W",411).
component("YGR248W",386).
component("YCR073W-A",196).
component("YDL086W",207).
component("YOL011W",637).
component("YMR008C",566).
component("YMR006C",565).
component("U101_",19).
component("YBL015W",135).
component("YJL068C",437).
component("YPL072W",696).
component("YOR124C",660).
component("YNL186W",608).
component("YMR304W",592).
component("YMR223W",583).
component("YKR098C",511).
component("YJL197W",452).
component("YIL156W",427).
component("YFR010W",330).
...
component("YNR032W",629).
component("YML057W",558).
component("YML016C",553).
component("YLR433C",552).
component("YGR123C",371).
...
component("YPR073C",723).
component("YHR215W",413).
component("YDL024C",200).
component("YBR093C",160).
component("YBR092C",159).
component("YAR071W",131).
component("YIL053W",418).
component("YER062C",306).
component("YHR046C",402).
component("YGR208W",383).
component("YPL228W",704).
component("YMR180C",578).
component("YDL236W",229).
component("YJL155C",449).
component("YPR073C",724).
component("YOR208W",669).
component("YNL053W",597).
component("YMR036C",568).
component("YIR026C",429).
component("YIL113W",422).
component("YFR028C",332).
...
component("U25_",81).
component("U24_",80).
component("YOR360C",685).
component("YGL248W",357).
component("YKR031C",506).
component("YLR286C",538).
component("YJR153W",475).
component("YOR190W",666).
component("YLR300W",539).
component("YGR282C",390).
component("YDR261C",262).
component("YDR400W",274).
component("U23_",79).
component("YML035C",555).
component("YJL070C",438).
component("YBR284W",183).
component("U102_",20).
component("YNL045W",596).
component("YLR160C",530).
component("YLR158C",529).
component("YLR157C",528).
component("YLR155C",527).
component("YDR321W",269).
component("YGL037C",345).
component("YMR293C",589).
component("YDR242W",259).
component("YBR208C",173).
component("YMR281W",588).
component("U53_",95).
component("YPL111W",699).
component("YIR032C",432).
component("YIR029W",430).
component("YPR062W",722).
component("YMR120C",575).
component("YLR028C",518).
component("YHR144C",410).
component("YGR267C",389).
component("YNL141W",603).
component("YBR153W",169).
component("YDL238C",230).
component("YNL141W",604).
component("YLR245C",537).
component("YML035C",556).
component("YJL126W",442).
component("U44_",89).
component("YDL100C",210).
component("U87_",117).
component("YMR267W",586).
component("YBR011C",144).
component("YBR111C",161).
component("YCL030C",189).
component("YER005W",294).
component("YIL048W",417).
component("YER166W",320).
component("YDR093W",245).
component("YAL026C",128).
component("YLR231C",535).
component("U88_",118).
component("YLR134W",524).
component("YLR044C",519).
component("YGR087C",367).
component("YDR380W",272).
component("YDL080C",206).
component("U98_",124).
component("YMR250W",584).
component("YKL184W",497).
component("YNR043W",632).
component("U93_",122).
component("YDR047W",240).
component("U54_",96).
component("YKL211C",499) :- not remove_orf("YKL211C",499).
component("YOL052C",640).
component("YNL169C",607).
component("YGR170W",374).
component("YNL256W",614).
component("YDR294C",264).
component("YEL046C",289).
component("YNR033W",630).
component("YKL211C",500) :- not remove_orf("YKL211C",500).
component("YER090W",500) :- not remove_orf("YER090W",500).
component("YER090W",313) :- not remove_orf("YER090W",313).
component("YDR127W",250).
component("YPL281C",715).
component("YOR393W",690).
component("YMR323W",593).
component("YHR174W",412).
component("YGR254W",387).
component("YGL026C",344) :- not remove_orf("YGL026C",344).
component("YGR155W",373).
component("YLR304C",542).
component("YJL200C",453).
component("YNL316C",622).
component("YKL182W",495).
component("YPL212C",703).
component("YNL292W",620).
component("YGL063W",348).
component("YFL001W",322).
component("YPR002W",717).
component("YDR127W",251).
component("YGL148W",351).
component("YER086W",310).
component("YLR359W",549).
component("YAL012W",126).
component("YFR055W",337).
component("YJL121C",441).
component("YBR019C",147).
component("YBR019C",148).
component("YDR050C",241).
component("YDR007W",231) :- not remove_orf("YDR007W",231).
component("YOR095C",658).
component("YER003C",293).
component("YBR196C",172).
component("YGL001C",339).
component("U14_",33).
component("YOL056W",642).
component("YKL152C",493).
component("YDL021W",198).
component("YMR105C",571).
component("YKL127W",487).
component("YEL058W",292).
component("YPR060C",721).
component("YHR072W",404).
component("YJL153C",448).
component("YPL097W",697).
component("YGR185C",379).
component("YHR011W",397).
component("YDR023W",234).
component("YPL104W",698).
component("YLL018C",512).
component("YPR081C",726).
component("YBR121C",163).
component("YHR020W",399).
component("YER087W",311).
component("YNL247W",611).
component("YOL033W",639).
component("YHR091C",406).
component("YDR341C",270).
component("YOL097C",648).
component("YPR047W",720).
component("YLR060W",520).
component("YFL022C",326).
component("YPR033C",719).
component("YHR019C",398).
component("YPL160W",700).
component("YLR382C",550).
component("YNL073W",599).
component("YDR037W",236).
component("YOR335C",680).
component("YGR094W",369).
component("YOR142W",662).
component("YGR244C",385).
component("U89_",119).
component("YOR241W",675).
component("YMR113W",572).
component("YKL132C",488).
component("YJL101C",440).
component("U92_",121).
component("YGL234W",356).
component("U91_",120).
component("YDL141W",217).
component("YDL141W",218).
component("YJR103W",465).
component("YBL039C",137).
component("YGR204W",382).
component("YOL058W",643).
component("YBR208C",174).
component("YHR074W",405).
component("YMR217W",581).
component("YOR303W",676).
component("YJR109C",468).
component("YJL130C",444).
component("YGL062W",347).
component("YBR218C",175).
component("YPL231W",708).
component("YNR016C",628).
component("YKL182W",496).
component("YGR037C",363).
component("YOR005C",655).
component("YDL164C",221).
component("YOL010W",636).
component("YPR138C",729).
component("YPL265W",710).
component("YPL057C",695).
component("YPL036W",694).
component("YOR348C",684).
component("YOR192C",667).
component("YOR071C",657).
component("YOL156W",654).
component("YOL103W",649).
component("YOL020W",638) :- not remove_orf("YOL020W",638).
component("YNR056C",633).
component("YNL318C",623).
component("YNL268W",617).
component("YNL142W",605).
component("YMR272C",587).
component("YML123C",564).
component("YLR348C",546).
component("YLR237W",536).
component("YLR138W",525).
component("YLR100C",523).
component("YLR081W",521).
component("YLL061W",515).
component("YLL043W",514).
component("YKR093W",510).
component("YKR053C",508).
component("YKR039W",507) :- not remove_orf("YKR039W",507).
component("YKL217W",502).
component("YKL004W",478).
component("YJR095W",464).
component("YJR077C",462).
component("YJL219W",454).
component("YJL134W",445).
component("YJL129C",443).
component("YHL036W",394).
component("YGR121C",370).
component("YGR055W",365).
component("YGL186C",353).
component("YGL077C",350).
component("YGL008C",340).
component("YFL055W",329).
...
catalyst(1960,240).
catalyst(3460,96).
catalyst(3600,499) :- not remove_reaction(3600,499).
catalyst(3941,640).
catalyst(3942,640).
catalyst(6890,607).
catalyst(6900,374).
...
catalyst(4560,289).
catalyst(2550,630).
catalyst(1890,500) :- not remove_reaction(1890,500).
catalyst(3630,500) :- not remove_reaction(3630,500).
...
catalyst(8231,387).
catalyst(8232,387).
catalyst(3590,344) :- not remove_reaction(3590,344).
catalyst(10910,344) :- not remove_reaction(10910,344).
catalyst(4570,373).
catalyst(8181,542).
catalyst(8182,542).
catalyst(8181,453).
...
catalyst(1200,654).
catalyst(1160,649).
catalyst(801,638) :- not remove_reaction(801,638).
catalyst(802,638) :- not remove_reaction(802,638).
catalyst(811,638) :- not remove_reaction(811,638).
catalyst(812,638) :- not remove_reaction(812,638).
catalyst(831,638) :- not remove_reaction(831,638).
catalyst(832,638) :- not remove_reaction(832,638).
catalyst(901,638) :- not remove_reaction(901,638).
catalyst(902,638) :- not remove_reaction(902,638).
catalyst(941,638) :- not remove_reaction(941,638).
catalyst(942,638) :- not remove_reaction(942,638).
catalyst(700,633).
catalyst(1200,623).
catalyst(761,617).
catalyst(762,617).
...
catalyst(640,510).
catalyst(6560,508).
catalyst(761,507) :- not remove_reaction(761,507).
catalyst(762,507) :- not remove_reaction(762,507).
...
catalyst(791,507) :- not remove_reaction(791,507).
catalyst(792,507) :- not remove_reaction(792,507).
...
catalyst(821,507) :- not remove_reaction(821,507).
catalyst(822,507) :- not remove_reaction(822,507).
...
catalyst(861,507) :- not remove_reaction(861,507).
catalyst(862,507) :- not remove_reaction(862,507).
...
catalyst(911,507) :- not remove_reaction(911,507).
catalyst(912,507) :- not remove_reaction(912,507).
catalyst(941,507) :- not remove_reaction(941,507).
catalyst(942,507) :- not remove_reaction(942,507).
