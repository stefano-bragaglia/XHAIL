...
component("YGL012W",119).
component("YOL086C",218).
component("YMR303C",200).
component("YGL256W",127).
component("YDL168W",74).
component("YBR145W",56).
component("YGL001C",117).
component("YML056C",189).
component("YLR432W",187).
component("YHR216W",142).
component("YAR075W",45).
component("YAR073W",44).
component("YDR127W",84).
component("YJR139C",165).
component("YOR136W",222).
component("YIL155C",146).
component("YJR078W",159).
component("YJR025C",156).
component("YMR015C",193).
component("YDR402C",96).
component("YJR104C",162).
component("YHR008C",137).
component("YER070W",105).
component("YGL154C",125).
component("YMR170C",196).
component("YMR169C",195).
component("YBR166C",58).
component("YER014W",104).
component("YEL047C",103).
component("YOR375C",233).
component("YDL215C",75).
component("YAL062W",43).
component("YOR236W",229).
component("U62_",37).
component("YPL017C",236).
component("YFL018C",109).
component("U47_",33).
component("YKL024C",168).
component("YPR074C",249).
component("YBR117C",55).
component("YPL231W",240).
component("YPL001W",235).
component("YPL231W",241).
component("YPL028W",237).
component("YNL029C",202).
component("YIL085C",144).
component("YLR209C",182).
component("YDR354W",93) :- not remove_orf("YDR354W",93).
component("YFR047C",115).
component("YJR133W",164).
component("YDR399W",94).
component("YDR127W",85).
component("YJR130C",163).
component("YDR035W",80).
component("YBR249C",61).
component("YBR256C",62).
component("YHR137W",138).
component("YLR027C",179).
component("YKL106W",169).
component("U64_",38).
component("U51_",34).
component("YJR148W",166).
component("YGL253W",126).
component("YFR053C",116).
component("YMR205C",198).
component("YGR240C",134).
component("YCR036W",70).
component("U15_",21).
component("YKL001C",167).
component("YML070W",190).
component("YFL053W",111).
component("U83_",41).
component("YMR208W",199).
component("U1_",26).
component("YNL267W",209).
component("YLR305C",186).
component("YFR019W",113).
component("YDR208W",90).
component("YDR127W",86).
component("U20_",29).
component("YDR300C",92).
component("U76_",40).
component("YDR454C",98).
component("YOL061W",217).
component("YKL181W",171).
component("YHL011C",136).
component("YER099C",108).
component("YBL068W",48).
component("YOR143C",223).
component("YCL050C",68).
component("YPR190C",253).
component("YPR187W",252).
component("YPR110C",250).
component("YPR010C",245).
component("YOR341W",232).
component("YOR340C",231).
component("YOR224C",228).
component("YOR210W",227).
component("YOR207C",225).
component("YOR151C",224).
component("YOR116C",221).
component("YOL005C",214).
component("YNR003C",211).
component("YNL248C",208).
component("YNL151C",207).
component("YNL113W",205).
component("YKL144C",170).
component("YJR063W",157).
component("YJL148W",154).
component("YJL140W",153).
component("YIL021W",143).
component("YHR143W-A",139).
component("YGL070C",123).
component("YFL036W",110).
component("YDR404C",97).
component("YDR156W",89).
component("YDR045C",81).
component("YDL150W",73).
component("YDL140C",72).
component("YBR154C",57).
component("YDR058C",83).
component("YOL011W",215).
component("YMR008C",192).
component("YMR006C",191).
component("YBL015W",46).
component("U84_",42).
component("YPR073C",247).
component("YHR215W",141).
component("YDL024C",71).
component("YBR093C",53).
component("YBR092C",52).
component("YPL228W",239).
component("YMR180C",197).
component("YDL236W",77).
component("YJL155C",155).
component("YPR073C",248).
component("YOR208W",226).
component("YNL053W",204).
component("YMR036C",194).
component("YIR026C",147).
component("YIL113W",145).
component("YFR028C",114).
component("YER075C",106).
component("YDL230W",76).
component("YBR276C",63).
component("U30_",32).
component("U24_",31).
component("YKR031C",176).
component("YLR286C",185).
component("YDR400W",95).
component("YML035C",188).
component("YJL070C",149).
component("YBR284W",64).
component("YNL045W",203).
component("YGL037C",121).
component("U53_",35).
component("YIR032C",148).
component("YDL238C",78).
component("YLR245C",184).
component("YJL126W",151).
component("YBR111C",54).
component("YLR231C",183).
component("YLR134W",181).
component("YLR044C",180).
component("YGR087C",129).
component("U54_",36).
component("YKL211C",174) :- not remove_orf("YKL211C",174).
component("YGR170W",133).
component("YDR294C",91).
component("YNR033W",213).
component("YKL211C",175) :- not remove_orf("YKL211C",175).
component("YER090W",175) :- not remove_orf("YER090W",175).
component("YER090W",107) :- not remove_orf("YER090W",107).
component("YDR127W",87).
component("YPL281C",244).
component("YOR393W",234).
component("YMR323W",201).
component("YHR174W",140).
component("YGR254W",135).
component("YGL026C",120) :- not remove_orf("YGL026C",120).
component("YGR155W",132).
component("YNL316C",210).
component("YKL182W",172).
component("YDR127W",88).
component("YGL148W",124).
component("YDR007W",79) :- not remove_orf("YDR007W",79).
component("YOR095C",220).
component("YPR060C",246).
component("YOL097C",219).
component("YOR335C",230).
component("YGR094W",130).
component("YJL101C",150).
component("YJR103W",161).
component("YBL039C",47).
component("YBR208C",59).
component("YGL062W",122).
component("YBR218C",60).
component("YPL231W",242).
component("YNR016C",212).
component("YKL182W",173).
component("YGR037C",128).
component("YPR138C",251).
component("YPL265W",243).
component("YPL036W",238).
component("YOL020W",216) :- not remove_orf("YOL020W",216).
component("YNL142W",206).
component("YKR053C",178).
component("YKR039W",177) :- not remove_orf("YKR039W",177).
component("YJR095W",160).
component("YJR077C",158).
component("YJL134W",152).
component("YGR121C",131).
component("YGL008C",118).
component("YFL055W",112).
component("YEL017C-A",102).
component("YDR536W",101).
component("YDR508C",100).
component("YDR503C",99).
component("YDR046C",82) :- not remove_orf("YDR046C",82).
component("YCR024C-A",69).
component("YCL025C",67).
component("YBR298C",66).
component("YBR291C",65).
component("YBR069C",51) :- not remove_orf("YBR069C",51).
component("YBR068C",50) :- not remove_orf("YBR068C",50).
component("YBR021W",49).
component("U71_",39).
component("U228_",30).
component("U206_",28).
component("U202_",27).
...
catalyst(5611,182).
catalyst(5612,182).
catalyst(3620,93) :- not remove_reaction(3620,93).
catalyst(2190,115).
catalyst(5550,164).
catalyst(5320,94).
catalyst(3710,85).
...
catalyst(7550,129).
catalyst(3460,36).
catalyst(3600,174) :- not remove_reaction(3600,174).
catalyst(6900,133).
catalyst(8781,91).
catalyst(8782,91).
catalyst(2550,213).
catalyst(3630,175) :- not remove_reaction(3630,175).
catalyst(3630,107) :- not remove_reaction(3630,107).
catalyst(3740,87).
catalyst(8231,244).
catalyst(8232,244).
catalyst(8231,234).
...
catalyst(3750,88).
catalyst(3700,124).
catalyst(3610,79) :- not remove_reaction(3610,79).
catalyst(7921,220).
catalyst(7922,220).
catalyst(3690,246).
catalyst(8671,219).
...
catalyst(781,177) :- not remove_reaction(781,177).
catalyst(782,177) :- not remove_reaction(782,177).
...
catalyst(881,177) :- not remove_reaction(881,177).
catalyst(882,177) :- not remove_reaction(882,177).
catalyst(1191,177) :- not remove_reaction(1191,177).
catalyst(1192,177) :- not remove_reaction(1192,177).
catalyst(1250,160).
catalyst(1581,158).
catalyst(1582,158).
catalyst(6560,152).
...
catalyst(1501,65).
catalyst(1502,65).
catalyst(771,51) :- not remove_reaction(771,51).
catalyst(772,51) :- not remove_reaction(772,51).
catalyst(801,51) :- not remove_reaction(801,51).
catalyst(802,51) :- not remove_reaction(802,51).
catalyst(811,51) :- not remove_reaction(811,51).
catalyst(812,51) :- not remove_reaction(812,51).
catalyst(801,50) :- not remove_reaction(801,50).
catalyst(802,50) :- not remove_reaction(802,50).
catalyst(811,50) :- not remove_reaction(811,50).
catalyst(812,50) :- not remove_reaction(812,50).
catalyst(831,50) :- not remove_reaction(831,50).
catalyst(832,50) :- not remove_reaction(832,50).
catalyst(620,49).
catalyst(2930,39).
catalyst(41,30).
catalyst(42,30).
