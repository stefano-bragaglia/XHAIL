...
component("YPL231W",588).
component("YBR149W",146).
component("YGL001C",283).
component("YIL094C",355).
component("YHR063C",338).
component("YBR153W",147).
component("YML056C",469).
component("YLR432W",465).
component("YHR216W",349).
component("YAR075W",117).
component("YAR073W",116).
component("YDR127W",205).
component("YJR139C",401).
component("YOL126C",542).
component("YDL078C",176).
component("YKL029C",405).
component("YOR136W",552).
component("YDL066W",175).
component("YLR355C",462).
component("YML086C",471).
component("YIL155C",359).
component("YPR191W",615).
component("YOR065W",547).
component("YJL166W",380).
component("YHR001W-A",333).
...
component("YJR104C",395).
component("YHR008C",334).
component("YER070W",258).
component("U35_",75).
component("YDL168W",187).
component("YDR158W",213).
component("YPL276W",597).
component("YPL275W",596).
component("YOR388C",574).
component("YGL154C",297).
component("U55_",84).
component("YOR323C",564).
component("YMR170C",485).
component("YMR169C",484).
component("U2_",72).
...
component("YIL160C",361).
component("YGL205W",300).
component("YMR118C",482).
component("YLR164W",447).
component("YLL041C",431).
component("YKL148C",413).
component("YJL045W",366).
component("YDR178W",214).
component("YJR051W",389).
...
component("YHR037W",335).
component("YKR080W",427).
component("YER023W",248).
component("YOR236W",561).
component("YGR204W",321).
component("YLR142W",442).
component("U62_",87).
component("YKL150W",414).
component("YIL043C",351).
component("YHR042W",336).
component("YFR030W",278).
component("YPL017C",577).
component("YFL018C",270).
component("YER042W",250).
component("YJR137C",400).
component("YPL266W",594).
component("YML110C",473).
component("YBR034C",132).
component("YPL273W",595).
...
component("YOR143C",553).
component("YGR007W",304).
component("YLR328W",459).
component("YJR010W",386).
component("YCL050C",166).
component("YPR190C",614).
component("YPR187W",613).
component("YPR110C",609).
component("YPR010C",601).
component("YOR341W",568).
component("YOR340C",567).
component("YOR224C",560).
component("YOR210W",559).
component("YOR207C",557).
component("YOR151C",554).
component("YOR116C",550).
component("YOL005C",531).
component("YNR003C",524).
component("YNL248C",512).
component("YNL151C",508).
component("YNL113W",503).
component("YKL144C",412).
component("YJR063W",390).
component("YJL148W",378).
component("YJL140W",377).
...
component("YKL035W",406).
component("YHL012W",330).
component("YHR123W",342).
component("YER026C",249).
component("YCL004W",162).
component("YJL068C",367).
component("YDR058C",201).
component("YNR034W",529).
component("YHR163W",346).
component("YGR248W",325).
component("YCR073W-A",171).
component("YDL086W",178).
component("YOL011W",532).
component("YMR008C",476).
component("YMR006C",475).
component("U101_",19).
component("YBL015W",119).
component("YJL068C",368).
component("YPL072W",581).
component("YOR124C",551).
component("YNL186W",509).
component("YMR304W",496).
component("YMR223W",490).
component("YKR098C",429).
component("YJL197W",382).
component("YIL156W",360).
...
component("YIL053W",353).
component("YER062C",257).
component("YHR046C",337).
component("YGR208W",322).
component("YPL228W",587).
component("YMR180C",486).
component("YDL236W",192).
component("YJL155C",379).
component("YPR073C",606).
component("YOR208W",558).
component("YNL053W",500).
component("YMR036C",478).
component("YIR026C",362).
...
component("U25_",71).
component("U24_",70).
component("YOR360C",571).
component("YGL248W",301).
component("YKR031C",424).
component("YLR286C",453).
component("YOR190W",555).
component("YLR300W",454).
component("YGR282C",328).
component("YDR261C",220).
component("YDR400W",229).
component("U23_",69).
component("YML035C",467).
component("YJL070C",369).
component("YBR284W",159).
component("U102_",20).
component("YNL045W",499).
component("YLR160C",446).
component("YLR158C",445).
component("YLR157C",444).
component("YLR155C",443).
component("YDR321W",224).
component("YGL037C",290).
component("YDR242W",217).
component("YBR208C",151).
component("YMR281W",493).
component("U53_",82).
component("YIR032C",365).
component("YIR029W",363).
...
component("YPL281C",598).
component("YOR393W",575).
...
component("U14_",30).
component("YKL152C",415).
component("YMR105C",480).
component("YKL127W",410).
component("YEL058W",244).
component("YPR060C",604).
component("YHR072W",339).
component("YPL097W",582).
component("YGR185C",320).
component("YPL104W",583).
component("YLL018C",430).
component("YPR081C",608).
component("YBR121C",143).
component("YNL247W",511).
component("YOL033W",534).
component("YHR091C",341).
component("YDR341C",225).
component("YOL097C",540).
component("YPR047W",603).
component("YLR060W",436).
component("YFL022C",271).
component("YPR033C",602).
component("YPL160W",584).
component("YLR382C",464).
component("YOR335C",566).
component("YGR094W",312).
component("YGR244C",324).
component("U89_",105).
component("YOR241W",562).
component("YMR113W",481).
component("YKL132C",411).
component("YJL101C",371).
component("U91_",106).
component("YDL141W",183).
component("YJR103W",394).
component("YBL039C",121).
component("YOL058W",536).
component("YBR208C",152).
component("YHR074W",340).
component("YMR217W",489).
component("YOR303W",563).
component("YJR109C",397).
component("YJL130C",375).
...
component("YOR005C",546).
component("YDL164C",185).
component("YPR138C",611).
component("YPL265W",593).
component("YPL057C",580).
component("YPL036W",579).
component("YOR348C",570).
component("YOR192C",556).
component("YOR071C",548).
component("YOL156W",545).
component("YOL020W",533) :- not remove_orf("YOL020W",533).
component("YNL318C",522).
component("YNL268W",516).
component("YNL142W",507).
component("YMR272C",492).
component("YML123C",474).
component("YLR348C",460).
component("YLR237W",451).
component("YLR138W",441).
component("YLR100C",439).
component("YLR081W",437).
component("YLL061W",432).
component("YKR093W",428).
component("YKR053C",426).
component("YKR039W",425) :- not remove_orf("YKR039W",425).
component("YKL217W",422).
component("YJR095W",393).
component("YJR077C",391).
component("YJL219W",384).
component("YJL134W",376).
component("YJL129C",374).
...
catalyst(1960,199).
catalyst(3460,83).
catalyst(3600,420) :- not remove_reaction(3600,420).
catalyst(6900,316).
catalyst(8781,221).
catalyst(8782,221).
catalyst(4560,241).
...
catalyst(640,428).
catalyst(6560,426).
catalyst(761,425) :- not remove_reaction(761,425).
catalyst(762,425) :- not remove_reaction(762,425).
...
catalyst(791,425) :- not remove_reaction(791,425).
catalyst(792,425) :- not remove_reaction(792,425).
...
catalyst(821,425) :- not remove_reaction(821,425).
catalyst(822,425) :- not remove_reaction(822,425).
...
catalyst(861,425) :- not remove_reaction(861,425).
catalyst(862,425) :- not remove_reaction(862,425).
catalyst(881,425) :- not remove_reaction(881,425).
catalyst(882,425) :- not remove_reaction(882,425).
catalyst(911,425) :- not remove_reaction(911,425).
catalyst(912,425) :- not remove_reaction(912,425).
catalyst(941,425) :- not remove_reaction(941,425).
catalyst(942,425) :- not remove_reaction(942,425).
