...
component("YGR060W",204).
component("YGL012W",189).
component("YOL086C",346).
component("YMR303C",317).
component("YGL256W",199).
component("YDL168W",126).
component("YBR145W",94).
component("YPL231W",382).
component("YGL001C",186).
component("YML056C",301).
component("YLR432W",298).
component("YHR216W",228).
component("YAR075W",78).
component("YAR073W",77).
component("YDR127W",139).
component("YJR139C",262).
component("YOR136W",354).
component("YDL066W",119).
component("YIL155C",234).
component("YPR191W",404).
component("YOR065W",350).
component("YJL166W",248).
component("YHR001W-A",219).
component("YGR183C",211).
component("YFR033C",183).
component("YDR529C",163).
component("YBL045C",82).
component("Q0105",18).
component("YJR078W",255).
component("YJR025C",250).
component("YBL098W",84).
component("YMR015C",305).
component("YDR402C",156).
component("YJR104C",258).
component("YHR008C",220).
component("YER070W",172).
component("YDL168W",127).
component("YPL276W",390).
component("YPL275W",389).
component("YOR388C",372).
component("YGL154C",196).
component("YOR323C",365).
component("YMR170C",312).
component("YMR169C",311).
component("YBR166C",97).
component("YNL280C",332).
component("YER014W",169).
component("YMR118C",309).
component("YLR164W",288).
component("YLL041C",283).
component("YKL148C",271).
component("YJL045W",238).
component("YDR178W",145).
component("YJR051W",252).
component("YEL047C",166).
component("YOR375C",371).
component("YDL215C",128).
component("YAL062W",76).
component("YBR035C",87).
component("YER023W",170).
component("YOR236W",363).
component("YGR204W",212).
component("U62_",55).
component("YKL150W",272).
component("YIL043C",230).
component("YPL017C",375).
component("YFL018C",177).
component("YPL273W",388).
component("YLL062C",284).
component("U47_",49).
component("YDL033C",117).
component("YKL024C",265).
component("YPR074C",397).
component("YBR117C",93).
component("YCL009C",108).
component("YMR062C",307).
component("YPL231W",383).
component("YPL001W",374).
component("YPL231W",384).
component("YGR147C",208).
component("YDL040C",118).
component("YPL028W",376).
component("YPR001W",392).
component("YNR001C",336).
component("YNL117W",324).
component("YIR031C",236).
component("YNL029C",319).
component("YIL085C",231).
component("YLR209C",289).
component("YMR300C",316).
component("YER055C",171).
component("YDR354W",152) :- not remove_orf("YDR354W",152).
component("YFR047C",184).
component("YJR133W",261).
component("YML022W",299).
component("YDR441C",159).
component("YDR399W",154).
component("YNL256W",329).
component("YDR127W",140).
component("YJR130C",260).
component("YLR303W",295).
component("YDR035W",133).
component("YBR249C",101).
component("YBR256C",102).
component("YHR137W",223).
component("YGL202W",197).
component("YLR027C",285).
component("YKL106W",268).
component("YKL104C",267).
component("YGR019W",201).
component("U64_",56).
component("U51_",51).
component("YJR148W",263).
component("YGL253W",198).
component("YFR053C",185).
component("YMR205C",314).
component("YGR240C",213).
component("YDR248C",147).
component("YCR036W",115).
component("YCL040W",110).
component("YJR105W",259).
component("U16_",28).
component("U15_",26).
component("U96_",72).
component("YKL001C",264).
component("YML070W",302).
component("YFL053W",179).
component("U83_",67).
component("U82_",66).
component("YMR208W",315).
component("YOR347C",370).
component("YAL038W",75).
component("YPR121W",399).
component("YPL258C",386).
component("YOL055C",343).
component("U1_",36).
component("YNL267W",331).
component("YLR305C",296).
component("YFR019W",181).
component("YDR208W",146).
component("YDR127W",141).
component("U21_",41).
component("U20_",40).
component("YDR300C",150).
component("YCR012W",112).
component("U18_",33).
component("U76_",64).
component("YDR454C",160).
component("YOL061W",345).
component("YKL181W",273).
component("YHL011C",216).
component("YER099C",175).
component("YBL068W",83).
component("YOR143C",355).
component("YGR007W",200).
component("YCL050C",111).
component("YPR190C",403).
component("YPR187W",402).
component("YPR110C",398).
component("YPR010C",393).
component("YOR341W",369).
component("YOR340C",368).
component("YOR224C",362).
component("YOR210W",361).
component("YOR207C",359).
component("YOR151C",356).
component("YOR116C",353).
component("YOL005C",340).
component("YNR003C",337).
component("YNL248C",328).
component("YNL151C",327).
component("YNL113W",323).
component("YKL144C",270).
component("YJR063W",253).
component("YJL148W",246).
component("YJL140W",245).
component("YIL021W",229).
component("YHR143W-A",224).
component("YGL070C",194).
component("YFL036W",178).
component("YDR404C",157).
component("YDR156W",144).
component("YDR045C",134).
component("YDL150W",124).
component("YDL140C",123).
component("YBR154C",96).
component("YPR175W",401).
component("YPL167C",379).
component("YOR330C",366).
component("YOL115W",348).
component("YNL299W",334).
component("YNL262W",330).
component("YNL102W",322).
component("YJR043C",251).
component("YJR006W",249).
component("YJL090C",240).
component("YIL139C",233).
component("YEL055C",167).
...
component("YHL012W",217).
component("YDR058C",137).
component("YDL086W",121).
component("YOL011W",341).
component("YMR008C",304).
component("YMR006C",303).
component("U101_",19).
component("YBL015W",79).
component("U84_",68).
component("YPR073C",395).
component("YHR215W",227).
component("YDL024C",116).
component("YBR093C",91).
component("YBR092C",90).
component("YPL228W",381).
component("YMR180C",313).
component("YDL236W",130).
component("YJL155C",247).
component("YPR073C",396).
component("YOR208W",360).
component("YNL053W",321).
component("YMR036C",306).
component("YIR026C",235).
component("YIL113W",232).
component("YFR028C",182).
component("YER075C",173).
component("YDL230W",129).
component("YBR276C",103).
component("U34_",47).
component("U30_",46).
component("U25_",45).
component("U24_",44).
component("YKR031C",279).
component("YLR286C",293).
component("YOR190W",357).
component("YLR300W",294).
component("YGR282C",215).
component("YDR261C",148).
component("YDR400W",155).
component("YML035C",300).
component("YJL070C",239).
component("YBR284W",105).
component("YNL045W",320).
component("YGL037C",191).
component("YBR208C",98).
component("U53_",52).
component("YIR032C",237).
component("YMR120C",310).
component("YHR144C",225).
component("YBR153W",95).
component("YDL238C",131).
component("YNL141W",325).
component("YLR245C",292).
component("YJL126W",242).
component("YBR111C",92).
component("YER005W",168).
component("YLR231C",290).
component("U88_",69).
component("YLR134W",287).
component("YLR044C",286).
component("YGR087C",205).
component("YDR380W",153).
component("YDL080C",120).
component("U98_",73).
component("YKL184W",276).
component("U93_",71).
component("U54_",53).
component("YKL211C",277) :- not remove_orf("YKL211C",277).
component("YGR170W",210).
component("YDR294C",149).
component("YNR033W",339).
component("YKL211C",278) :- not remove_orf("YKL211C",278).
component("YER090W",278) :- not remove_orf("YER090W",278).
component("YER090W",174) :- not remove_orf("YER090W",174).
component("YDR127W",142).
component("YPL281C",391).
component("YOR393W",373).
component("YMR323W",318).
component("YHR174W",226).
component("YGR254W",214).
component("YGL026C",190) :- not remove_orf("YGL026C",190).
component("YGR155W",209).
component("YNL316C",335).
component("YKL182W",274).
component("YPL212C",380).
component("YNL292W",333).
component("YGL063W",193).
component("YFL001W",176).
component("YDR127W",143).
component("YGL148W",195).
component("YAL012W",74).
component("YBR019C",85).
component("YDR050C",136).
component("YDR007W",132) :- not remove_orf("YDR007W",132).
component("YOR095C",352).
component("YGL001C",187).
component("YMR105C",308).
component("YKL127W",269).
component("YPR060C",394).
component("YPL104W",378).
component("YLL018C",282).
component("YHR091C",222).
component("YDR341C",151).
component("YOL097C",347).
component("YOR335C",367).
component("YGR094W",206).
component("U89_",70).
component("YJL101C",241).
component("YJR103W",257).
component("YBL039C",81).
component("YOL058W",344).
component("YBR208C",99).
component("YHR074W",221).
component("YOR303W",364).
component("YGL062W",192).
component("YBR218C",100).
component("YPL231W",385).
component("YNR016C",338).
component("YKL182W",275).
component("YGR037C",202).
component("YOR005C",349).
component("YDL164C",125).
component("YPR138C",400).
component("YPL265W",387).
component("YPL036W",377).
component("YOR192C",358).
component("YOR071C",351).
component("YOL020W",342) :- not remove_orf("YOL020W",342).
component("YNL142W",326).
component("YLR348C",297).
component("YLR237W",291).
component("YKR053C",281).
component("YKR039W",280) :- not remove_orf("YKR039W",280).
component("YJR095W",256).
component("YJR077C",254).
component("YJL134W",244).
component("YJL129C",243).
component("YHL036W",218).
component("YGR121C",207).
component("YGR055W",203).
...
catalyst(2300,71).
catalyst(3460,53).
catalyst(3600,277) :- not remove_reaction(3600,277).
catalyst(6900,210).
catalyst(8781,149).
catalyst(8782,149).
catalyst(2550,339).
catalyst(3630,278) :- not remove_reaction(3630,278).
catalyst(3630,174) :- not remove_reaction(3630,174).
catalyst(3740,142).
catalyst(8231,391).
catalyst(8232,391).
catalyst(8231,373).
...
catalyst(190,291).
catalyst(6560,281).
catalyst(771,280) :- not remove_reaction(771,280).
catalyst(772,280) :- not remove_reaction(772,280).
catalyst(781,280) :- not remove_reaction(781,280).
catalyst(782,280) :- not remove_reaction(782,280).
...
catalyst(881,280) :- not remove_reaction(881,280).
catalyst(882,280) :- not remove_reaction(882,280).
catalyst(1191,280) :- not remove_reaction(1191,280).
catalyst(1192,280) :- not remove_reaction(1192,280).
catalyst(1250,256).
catalyst(1581,254).
catalyst(1582,254).
catalyst(6560,244).
