...
component("YGR060W",162).
component("YGL012W",150).
component("YOL086C",267).
component("YMR303C",246).
component("YGL256W",158).
component("YDL168W",98).
component("YBR145W",75).
component("YPL231W",292).
component("YGL001C",147).
component("YML056C",234).
component("YLR432W",231).
component("YHR216W",179).
component("YAR075W",63).
component("YAR073W",62).
component("YDR127W",108).
component("YJR139C",205).
component("YOR136W",272).
component("YIL155C",183).
component("YJR078W",199).
component("YJR025C",195).
component("YMR015C",238).
component("YDR402C",122).
component("YJR104C",202).
component("YHR008C",173).
component("YER070W",135).
component("YGL154C",156).
component("YOR323C",280).
component("YMR170C",242).
component("YMR169C",241).
component("YBR166C",77).
component("YER014W",132).
component("YMR118C",240).
component("YLR164W",225).
component("YLL041C",221).
component("YKL148C",212).
component("YJL045W",187).
component("YDR178W",114).
component("YJR051W",196).
component("YEL047C",130).
component("YOR375C",285).
component("YDL215C",99).
component("YAL062W",61).
component("YER023W",133).
component("YOR236W",279).
component("YGR204W",168).
component("U62_",45).
component("YPL017C",288).
component("YFL018C",139).
component("U47_",40).
component("YKL024C",208).
component("YPR074C",303).
component("YBR117C",74).
component("YCL009C",87).
component("YPL231W",293).
component("YPL001W",287).
component("YPL231W",294).
component("YPL028W",289).
component("YPR001W",298).
component("YNR001C",258).
component("YNL117W",252).
component("YIR031C",185).
component("YNL029C",248).
component("YIL085C",181).
component("YLR209C",226).
component("YER055C",134).
component("YDR354W",118) :- not remove_orf("YDR354W",118).
component("YFR047C",145).
component("YJR133W",204).
component("YML022W",232).
component("YDR441C",124).
component("YDR399W",120).
component("YDR127W",109).
component("YJR130C",203).
component("YDR035W",104).
component("YBR249C",81).
component("YBR256C",82).
component("YHR137W",175).
component("YLR027C",222).
component("YKL106W",210).
component("YGR019W",160).
component("U64_",46).
component("U51_",41).
component("YJR148W",206).
component("YGL253W",157).
component("YFR053C",146).
component("YMR205C",244).
component("YGR240C",169).
component("YCR036W",91).
component("U16_",25).
component("U15_",23).
component("YKL001C",207).
component("YML070W",235).
component("YFL053W",141).
component("U83_",56).
component("U82_",55).
component("YMR208W",245).
component("YOR347C",284).
component("YAL038W",60).
component("U1_",32).
component("YNL267W",256).
component("YLR305C",230).
component("YFR019W",143).
component("YDR208W",115).
component("YDR127W",110).
component("U20_",35).
component("YDR300C",117).
component("U18_",29).
component("U76_",54).
component("YDR454C",125).
component("YOL061W",266).
component("YKL181W",213).
component("YHL011C",171).
component("YER099C",138).
component("YBL068W",66).
component("YOR143C",273).
component("YGR007W",159).
component("YCL050C",89).
component("YPR190C",307).
component("YPR187W",306).
component("YPR110C",304).
component("YPR010C",299).
component("YOR341W",283).
component("YOR340C",282).
component("YOR224C",278).
component("YOR210W",277).
component("YOR207C",275).
component("YOR151C",274).
component("YOR116C",271).
component("YOL005C",262).
component("YNR003C",259).
component("YNL248C",255).
component("YNL151C",254).
component("YNL113W",251).
component("YKL144C",211).
component("YJR063W",197).
component("YJL148W",193).
component("YJL140W",192).
component("YIL021W",180).
component("YHR143W-A",176).
component("YGL070C",154).
component("YFL036W",140).
component("YDR404C",123).
component("YDR156W",113).
component("YDR045C",105).
component("YDL150W",96).
component("YDL140C",95).
component("YBR154C",76).
component("YKL035W",209).
component("YHL012W",172).
component("YDR058C",107).
component("YDL086W",94).
component("YOL011W",263).
component("YMR008C",237).
component("YMR006C",236).
component("U101_",18).
component("YBL015W",64).
component("U84_",57).
component("YPR073C",301).
component("YHR215W",178).
component("YDL024C",92).
component("YBR093C",72).
component("YBR092C",71).
component("YPL228W",291).
component("YMR180C",243).
component("YDL236W",101).
component("YJL155C",194).
component("YPR073C",302).
component("YOR208W",276).
component("YNL053W",250).
component("YMR036C",239).
component("YIR026C",184).
component("YIL113W",182).
component("YFR028C",144).
component("YER075C",136).
component("YDL230W",100).
component("YBR276C",83).
component("U34_",39).
component("U30_",38).
component("U24_",37).
component("YKR031C",218).
component("YLR286C",229).
component("YDR400W",121).
component("YML035C",233).
component("YJL070C",188).
component("YBR284W",84).
component("YNL045W",249).
component("YGL037C",152).
component("YBR208C",78).
component("U53_",42).
component("YIR032C",186).
component("YDL238C",102).
component("YLR245C",228).
component("YJL126W",190).
component("YBR111C",73).
component("YER005W",131).
component("YLR231C",227).
component("U88_",58).
component("YLR134W",224).
component("YLR044C",223).
component("YGR087C",163).
component("YDR380W",119).
component("YDL080C",93).
component("U93_",59).
component("U54_",43).
component("YKL211C",216) :- not remove_orf("YKL211C",216).
component("YGR170W",167).
component("YDR294C",116).
component("YNR033W",261).
component("YKL211C",217) :- not remove_orf("YKL211C",217).
component("YER090W",217) :- not remove_orf("YER090W",217).
component("YER090W",137) :- not remove_orf("YER090W",137).
component("YDR127W",111).
component("YPL281C",297).
component("YOR393W",286).
component("YMR323W",247).
component("YHR174W",177).
component("YGR254W",170).
component("YGL026C",151) :- not remove_orf("YGL026C",151).
component("YGR155W",166).
component("YNL316C",257).
component("YKL182W",214).
component("YDR127W",112).
component("YGL148W",155).
component("YBR019C",67).
component("YDR007W",103) :- not remove_orf("YDR007W",103).
component("YOR095C",270).
component("YGL001C",148).
component("YPR060C",300).
component("YOL097C",268).
component("YOR335C",281).
component("YGR094W",164).
component("YJL101C",189).
component("YJR103W",201).
component("YBL039C",65).
component("YOL058W",265).
component("YBR208C",79).
component("YHR074W",174).
component("YGL062W",153).
component("YBR218C",80).
component("YPL231W",295).
component("YNR016C",260).
component("YKL182W",215).
component("YGR037C",161).
component("YOR005C",269).
component("YDL164C",97).
component("YPR138C",305).
component("YPL265W",296).
component("YPL036W",290).
component("YOL020W",264) :- not remove_orf("YOL020W",264).
component("YNL142W",253).
component("YKR053C",220).
component("YKR039W",219) :- not remove_orf("YKR039W",219).
component("YJR095W",200).
component("YJR077C",198).
component("YJL134W",191).
component("YGR121C",165).
component("YGL008C",149).
component("YFL055W",142).
component("YEL017C-A",129).
component("YDR536W",128).
component("YDR508C",127).
component("YDR503C",126).
component("YDR046C",106) :- not remove_orf("YDR046C",106).
component("YCR024C-A",90).
component("YCL025C",88).
component("YBR298C",86).
component("YBR291C",85).
component("YBR069C",70) :- not remove_orf("YBR069C",70).
component("YBR068C",69) :- not remove_orf("YBR068C",69).
component("YBR021W",68).
component("U75_",53).
component("U74_",52).
component("U73_",51).
component("U72_",50).
...
catalyst(5612,226).
catalyst(3870,134).
catalyst(3620,118) :- not remove_reaction(3620,118).
catalyst(2190,145).
catalyst(5550,204).
catalyst(5650,232).
catalyst(5650,124).
...
catalyst(2300,59).
catalyst(3460,43).
catalyst(3600,216) :- not remove_reaction(3600,216).
catalyst(6900,167).
catalyst(8781,116).
catalyst(8782,116).
catalyst(2550,261).
catalyst(3630,217) :- not remove_reaction(3630,217).
catalyst(3630,137) :- not remove_reaction(3630,137).
catalyst(3740,111).
catalyst(8231,297).
catalyst(8232,297).
catalyst(8231,286).
...
catalyst(8231,170).
catalyst(8232,170).
catalyst(3590,151) :- not remove_reaction(3590,151).
catalyst(10910,151) :- not remove_reaction(10910,151).
catalyst(4570,166).
catalyst(3680,257).
catalyst(7141,214).
catalyst(7142,214).
...
catalyst(8711,67).
catalyst(8712,67).
catalyst(3610,103) :- not remove_reaction(3610,103).
catalyst(7921,270).
catalyst(7922,270).
catalyst(6370,148).
catalyst(3690,300).
...
catalyst(372,253).
catalyst(6560,220).
catalyst(771,219) :- not remove_reaction(771,219).
catalyst(772,219) :- not remove_reaction(772,219).
catalyst(781,219) :- not remove_reaction(781,219).
catalyst(782,219) :- not remove_reaction(782,219).
...
catalyst(881,219) :- not remove_reaction(881,219).
catalyst(882,219) :- not remove_reaction(882,219).
catalyst(1191,219) :- not remove_reaction(1191,219).
catalyst(1192,219) :- not remove_reaction(1192,219).
catalyst(1250,200).
catalyst(1581,198).
catalyst(1582,198).
catalyst(6560,191).
...
catalyst(1501,85).
catalyst(1502,85).
catalyst(771,70) :- not remove_reaction(771,70).
catalyst(772,70) :- not remove_reaction(772,70).
catalyst(801,70) :- not remove_reaction(801,70).
catalyst(802,70) :- not remove_reaction(802,70).
catalyst(811,70) :- not remove_reaction(811,70).
catalyst(812,70) :- not remove_reaction(812,70).
...
catalyst(831,69) :- not remove_reaction(831,69).
catalyst(832,69) :- not remove_reaction(832,69).
catalyst(620,68).
catalyst(2920,53).
catalyst(2920,52).
catalyst(2920,51).
