...
component("YNL280C",465).
component("YGR060W",282).
component("YGL012W",264).
component("YOL086C",483).
component("YMR303C",446).
component("YGL256W",276).
component("YDL168W",167).
component("YBR145W",128).
component("YPL231W",529).
component("YBR149W",129).
component("YGL001C",261).
component("YHR063C",309).
component("YBR153W",130).
component("YML056C",425).
component("YLR432W",421).
component("YHR216W",317).
component("YAR075W",104).
component("YAR073W",103).
component("YDR127W",185).
component("YJR139C",362).
component("YKL029C",366).
component("YOR136W",495).
component("YDL066W",157).
component("YLR355C",419).
component("YML086C",427).
component("YIL155C",325).
component("YPR191W",554).
component("YOR065W",490).
component("YJL166W",343).
component("YHR001W-A",304).
component("YGR183C",292).
component("YFR033C",257).
component("YDR529C",217).
component("YBL045C",109).
component("Q0105",18).
component("YGR088W",284).
component("YDR256C",198).
component("YJR078W",354).
component("YJR025C",349).
component("YGR255C",298).
component("YBL098W",112).
component("YMR015C",431).
component("YDR402C",209).
component("YGR175C",290).
component("YJR104C",357).
component("YHR008C",305).
component("YER070W",236).
component("U35_",64).
component("YDL168W",168).
component("YDR158W",192).
component("YPL276W",537).
component("YPL275W",536).
component("YOR388C",517).
component("YGL154C",271).
component("U55_",73).
component("YOR323C",507).
component("YMR170C",439).
component("YMR169C",438).
component("U2_",61).
component("YBR221C",137).
component("U52_",70).
component("YBR166C",133).
component("YNL280C",466).
component("YER014W",226).
component("YMR118C",436).
component("YLR164W",404).
component("YLL041C",389).
component("YKL148C",373).
component("YJL045W",331).
component("YDR178W",193).
component("YJR051W",351).
component("YEL047C",221).
component("YOR375C",515).
component("YDL215C",170).
component("YAL062W",101).
component("U99_",97).
component("YBR035C",119).
component("YHR037W",306).
component("YKR080W",386).
component("YER023W",227).
component("YOR236W",504).
component("YGR204W",293).
component("U62_",75).
component("YKL150W",374).
component("YIL043C",319).
component("YHR042W",307).
component("YFR030W",256).
component("YPL017C",520).
component("YFL018C",248).
component("YER042W",229).
component("YJR137C",361).
component("YBR034C",118).
component("YPL273W",535).
component("YLL062C",391).
component("U47_",67).
component("YER091C",239).
component("YDL033C",155).
component("YOL096C",484).
component("YDR019C",175).
component("YDR408C",211).
component("YBL013W",105).
component("YKL024C",365).
component("YPR074C",547).
component("YBR117C",127).
component("YLR354C",418).
component("YGR043C",280).
component("YCL009C",146).
component("YMR062C",433).
component("YPL231W",530).
component("U86_",89).
component("YPL001W",519).
component("YOR377W",516).
component("YGR177C",291).
component("YPL231W",531).
component("YGR147C",287).
component("YDL040C",156).
component("YPL028W",521).
component("YPR001W",539).
component("YNR001C",471).
component("YDL182W",169).
component("YDL131W",162).
component("YNL117W",454).
component("YIR031C",329).
component("YNL029C",449).
component("YIL085C",322).
component("YNL192W",459).
component("YBR038W",120).
component("YBR023C",117).
component("YLR209C",405).
component("YMR300C",445).
component("YER055C",231).
component("YDR354W",205) :- not remove_orf("YDR354W",205).
component("YFR047C",258).
component("YJR133W",360).
component("YLR209C",406).
component("YML022W",422).
component("YDR441C",213).
component("YDR399W",207).
component("YNL256W",461).
component("YDR127W",186).
component("YLR303W",412).
component("YJR130C",359).
component("YLR303W",413).
component("YDR035W",176).
component("YBR249C",138).
component("YOL143C",487).
component("YBR256C",139).
component("YHR137W",312).
component("YGL202W",273).
component("YLR027C",392).
component("YKL106W",369).
component("YKL104C",368).
component("YGR019W",278).
component("YLR089C",396).
component("U64_",76).
component("U51_",69).
component("YJR148W",363).
component("YGL253W",275).
component("YFR053C",259).
component("YMR205C",441).
component("YGR240C",295).
component("YDR248C",197).
component("YCR036W",153).
component("YCL040W",148).
component("YJR105W",358).
component("U16_",36).
component("U15_",33).
component("U96_",95).
component("YKL001C",364).
component("YML070W",426).
component("YFL053W",251).
component("YHL032C",302).
component("U83_",87).
component("U82_",86).
component("YMR208W",442).
component("YOR347C",512).
component("YAL038W",100).
component("YPR121W",549).
component("YPL258C",533).
component("YOL055C",480).
component("U1_",45).
component("YBR020W",115).
component("YNL267W",463).
component("YLR305C",415).
component("YFR019W",254).
component("YDR208W",194).
component("YDR127W",187).
component("U21_",53).
component("U20_",51).
component("YDR147W",190).
component("YDR300C",202).
component("YCR012W",150).
component("U18_",42).
component("U76_",84).
component("YER170W",245).
component("YDR226W",195).
component("YDR454C",214).
component("YOL061W",482).
component("YKL181W",376).
component("YHL011C",300).
component("YER099C",241).
component("YBL068W",111).
component("YOR143C",496).
component("YGR007W",277).
component("YLR328W",416).
component("YJR010W",348).
component("YCL050C",149).
component("YPR190C",553).
component("YPR187W",552).
component("YPR110C",548).
component("YPR010C",541).
component("YOR341W",511).
component("YOR340C",510).
component("YOR224C",503).
component("YOR210W",502).
component("YOR207C",500).
component("YOR151C",497).
component("YOR116C",493).
component("YOL005C",476).
component("YNR003C",472).
component("YNL248C",460).
component("YNL151C",457).
component("YNL113W",453).
component("YKL144C",372).
component("YJR063W",352).
component("YJL148W",341).
component("YJL140W",340).
component("YIL021W",318).
component("YHR143W-A",313).
component("YGL070C",269).
component("YFL036W",250).
component("YDR404C",210).
component("YDR156W",191).
component("YDR045C",177).
component("YDL150W",165).
component("YDL140C",163).
component("YBR154C",132).
component("YPR175W",551).
component("YPL167C",526).
component("YOR330C",508).
component("YOL115W",486).
component("YNL299W",468).
component("YNL262W",462).
component("YNL102W",452).
component("YJR043C",350).
component("YJR006W",347).
component("YJL090C",334).
component("YIL139C",324).
component("YEL055C",222).
component("YDR419W",212).
component("YDR121W",184).
component("YDL102W",160).
component("YCR014C",151).
component("YBR278W",141).
component("YBL035C",107).
component("YKL035W",367).
component("YHL012W",301).
component("YER026C",228).
component("YCL004W",145).
component("YDR058C",181).
component("YDL086W",159).
component("YOL011W",477).
component("YMR008C",430).
component("YMR006C",429).
component("U101_",19).
component("YBL015W",106).
component("YJL068C",332).
component("YPL072W",523).
component("YOR124C",494).
component("YNL186W",458).
component("YMR304W",447).
component("YMR223W",443).
component("YKR098C",387).
component("YJL197W",344).
component("YIL156W",326).
component("YFR010W",253).
component("YER151C",243).
component("YER144C",242).
component("YER098W",240).
component("YDR069C",182).
component("YDL122W",161).
component("YBR058C",121).
component("YBL067C",110).
component("U84_",88).
component("YPR073C",545).
component("YHR215W",316).
component("YDL024C",154).
component("YBR093C",125).
component("YBR092C",124).
component("YAR071W",102).
component("YIL053W",321).
component("YER062C",235).
component("YHR046C",308).
component("YGR208W",294).
component("YPL228W",528).
component("YMR180C",440).
component("YDL236W",172).
component("YJL155C",342).
component("YPR073C",546).
component("YOR208W",501).
component("YNL053W",451).
component("YMR036C",432).
component("YIR026C",327).
component("YIL113W",323).
component("YFR028C",255).
component("YER075C",237).
component("YDL230W",171).
component("YBR276C",140).
component("U34_",63).
component("U30_",62).
component("U25_",60).
component("U24_",59).
component("YOR360C",514).
component("YGL248W",274).
component("YKR031C",383).
component("YLR286C",410).
component("YOR190W",498).
component("YLR300W",411).
component("YGR282C",299).
component("YDR261C",199).
component("YDR400W",208).
component("U23_",58).
component("YML035C",423).
component("YJL070C",333).
component("YBR284W",142).
component("U102_",20).
component("YNL045W",450).
component("YLR160C",403).
component("YLR158C",402).
component("YLR157C",401).
component("YLR155C",400).
component("YDR321W",203).
component("YGL037C",266).
component("YDR242W",196).
component("YBR208C",134).
component("U53_",71).
component("YIR032C",330).
component("YIR029W",328).
component("YMR120C",437).
component("YHR144C",314).
component("YBR153W",131).
component("YDL238C",173).
component("YNL141W",455).
component("YLR245C",409).
component("YML035C",424).
component("YJL126W",337).
component("U87_",90).
component("YBR111C",126).
component("YER005W",225).
component("YIL048W",320).
component("YER166W",244).
component("YDR093W",183).
component("YAL026C",99).
component("YLR231C",407).
component("U88_",91).
component("YLR134W",398).
component("YLR044C",393).
component("YGR087C",283).
component("YDR380W",206).
component("YDL080C",158).
component("U98_",96).
component("YKL184W",379).
component("YNR043W",475).
component("U93_",94).
component("YDR047W",179).
component("U54_",72).
component("YKL211C",380) :- not remove_orf("YKL211C",380).
component("YGR170W",289).
component("YDR294C",200).
component("YEL046C",220).
component("YNR033W",474).
component("YKL211C",381) :- not remove_orf("YKL211C",381).
component("YER090W",381) :- not remove_orf("YER090W",381).
component("YER090W",238) :- not remove_orf("YER090W",238).
component("YDR127W",188).
component("YPL281C",538).
component("YOR393W",518).
component("YMR323W",448).
component("YHR174W",315).
component("YGR254W",297).
component("YGL026C",265) :- not remove_orf("YGL026C",265).
component("YGR155W",288).
component("YLR304C",414).
component("YJL200C",345).
component("YNL316C",469).
component("YKL182W",377).
component("YPL212C",527).
component("YNL292W",467).
component("YGL063W",268).
component("YFL001W",246).
component("YPR002W",540).
component("YDR127W",189).
component("YGL148W",270).
component("YAL012W",98).
component("YFR055W",260).
component("YJL121C",336).
component("YBR019C",113).
component("YBR019C",114).
component("YDR050C",180).
component("YDR007W",174) :- not remove_orf("YDR007W",174).
component("YOR095C",492).
component("YER003C",224).
component("YGL001C",262).
component("YKL152C",375).
component("YMR105C",434).
component("YKL127W",370).
component("YEL058W",223).
component("YPR060C",544).
component("YPL104W",524).
component("YLL018C",388).
component("YOL033W",479).
component("YHR091C",311).
component("YDR341C",204).
component("YOL097C",485).
component("YPR047W",543).
component("YLR060W",394).
component("YFL022C",249).
component("YPR033C",542).
component("YPL160W",525).
component("YLR382C",420).
component("YOR335C",509).
component("YGR094W",285).
component("YGR244C",296).
component("U89_",92).
component("YOR241W",505).
component("YMR113W",435).
component("YKL132C",371).
component("YJL101C",335).
component("U91_",93).
component("YDL141W",164).
component("YJR103W",356).
component("YBL039C",108).
component("YOL058W",481).
component("YBR208C",135).
component("YHR074W",310).
component("YOR303W",506).
component("YGL062W",267).
component("YBR218C",136).
component("YPL231W",532).
component("YNR016C",473).
component("YKL182W",378).
component("YGR037C",279).
component("YOR005C",489).
component("YDL164C",166).
component("YPR138C",550).
component("YPL265W",534).
component("YPL036W",522).
component("YOR348C",513).
component("YOR192C",499).
component("YOR071C",491).
component("YOL156W",488).
component("YOL020W",478) :- not remove_orf("YOL020W",478).
component("YNL318C",470).
component("YNL268W",464).
component("YNL142W",456).
component("YMR272C",444).
component("YML123C",428).
component("YLR348C",417).
component("YLR237W",408).
component("YLR138W",399).
component("YLR100C",397).
component("YLR081W",395).
component("YLL061W",390).
component("YKR053C",385).
component("YKR039W",384) :- not remove_orf("YKR039W",384).
component("YKL217W",382).
component("YJR095W",355).
component("YJR077C",353).
component("YJL219W",346).
component("YJL134W",339).
component("YJL129C",338).
component("YHL036W",303).
component("YGR121C",286).
component("YGR055W",281).
component("YGL186C",272).
component("YGL008C",263).
component("YFL055W",252).
component("YFL011W",247).
component("YER060W-A",234).
component("YER060W",233).
component("YER056C",232).
component("YER053C",230).
component("YEL017C-A",219).
component("YDR536W",218).
component("YDR508C",216).
component("YDR503C",215).
component("YDR294C",201).
component("YDR046C",178) :- not remove_orf("YDR046C",178).
component("YCR024C-A",152).
component("YCL025C",147).
component("YBR298C",144).
component("YBR291C",143).
component("YBR069C",123) :- not remove_orf("YBR069C",123).
component("YBR068C",122) :- not remove_orf("YBR068C",122).
...
catalyst(1960,179).
catalyst(3460,72).
catalyst(3600,380) :- not remove_reaction(3600,380).
catalyst(6900,289).
catalyst(8781,200).
catalyst(8782,200).
catalyst(4560,220).
catalyst(2550,474).
catalyst(3630,381) :- not remove_reaction(3630,381).
catalyst(3630,238) :- not remove_reaction(3630,238).
catalyst(3740,188).
catalyst(8231,538).
catalyst(8232,538).
catalyst(8231,518).
...
catalyst(8231,297).
catalyst(8232,297).
catalyst(3590,265) :- not remove_reaction(3590,265).
catalyst(10910,265) :- not remove_reaction(10910,265).
catalyst(4570,288).
catalyst(8181,414).
catalyst(8182,414).
catalyst(8181,345).
...
catalyst(8281,180).
catalyst(8282,180).
catalyst(3610,174) :- not remove_reaction(3610,174).
catalyst(7921,492).
catalyst(7922,492).
catalyst(7841,224).
catalyst(7842,224).
...
catalyst(190,491).
catalyst(1200,488).
catalyst(801,478) :- not remove_reaction(801,478).
catalyst(802,478) :- not remove_reaction(802,478).
catalyst(811,478) :- not remove_reaction(811,478).
catalyst(812,478) :- not remove_reaction(812,478).
catalyst(831,478) :- not remove_reaction(831,478).
catalyst(832,478) :- not remove_reaction(832,478).
catalyst(941,478) :- not remove_reaction(941,478).
catalyst(942,478) :- not remove_reaction(942,478).
catalyst(1200,470).
catalyst(761,464).
catalyst(762,464).
catalyst(371,456).
...
catalyst(750,390).
catalyst(6560,385).
catalyst(761,384) :- not remove_reaction(761,384).
catalyst(762,384) :- not remove_reaction(762,384).
catalyst(771,384) :- not remove_reaction(771,384).
catalyst(772,384) :- not remove_reaction(772,384).
catalyst(781,384) :- not remove_reaction(781,384).
catalyst(782,384) :- not remove_reaction(782,384).
catalyst(791,384) :- not remove_reaction(791,384).
catalyst(792,384) :- not remove_reaction(792,384).
catalyst(801,384) :- not remove_reaction(801,384).
catalyst(802,384) :- not remove_reaction(802,384).
catalyst(811,384) :- not remove_reaction(811,384).
catalyst(812,384) :- not remove_reaction(812,384).
catalyst(831,384) :- not remove_reaction(831,384).
catalyst(832,384) :- not remove_reaction(832,384).
catalyst(841,384) :- not remove_reaction(841,384).
catalyst(842,384) :- not remove_reaction(842,384).
catalyst(861,384) :- not remove_reaction(861,384).
catalyst(862,384) :- not remove_reaction(862,384).
catalyst(881,384) :- not remove_reaction(881,384).
catalyst(882,384) :- not remove_reaction(882,384).
catalyst(941,384) :- not remove_reaction(941,384).
catalyst(942,384) :- not remove_reaction(942,384).
catalyst(1191,384) :- not remove_reaction(1191,384).
catalyst(1192,384) :- not remove_reaction(1192,384).
catalyst(1021,382).
catalyst(1022,382).
catalyst(1250,355).
catalyst(1581,353).
...
catalyst(831,178) :- not remove_reaction(831,178).
catalyst(832,178) :- not remove_reaction(832,178).
catalyst(841,178) :- not remove_reaction(841,178).
catalyst(842,178) :- not remove_reaction(842,178).
...
catalyst(1511,143).
catalyst(1512,143).
catalyst(771,123) :- not remove_reaction(771,123).
catalyst(772,123) :- not remove_reaction(772,123).
...
catalyst(831,122) :- not remove_reaction(831,122).
catalyst(832,122) :- not remove_reaction(832,122).
catalyst(841,122) :- not remove_reaction(841,122).
catalyst(842,122) :- not remove_reaction(842,122).
