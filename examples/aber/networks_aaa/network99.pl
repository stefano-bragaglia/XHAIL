...
component("YNL280C",564).
component("YGR060W",337).
component("YGL012W",312).
component("YKR009C",461).
component("YOL086C",587).
component("YMR303C",538).
component("YGL256W",330).
component("YDL168W",205).
component("YBR145W",159).
component("YPL231W",639).
component("U46_",87).
component("YBR149W",160).
component("YJR159W",438).
component("YGL001C",309).
component("YIL094C",386).
component("YHR063C",369).
component("YBR153W",161).
component("YML056C",510).
component("YLR432W",506).
component("YHR216W",380).
component("YAR075W",129).
component("YAR073W",128).
component("YDR127W",227).
component("YJR139C",436).
component("YOL126C",591).
component("YDL078C",192).
component("YKL029C",441).
component("YOR136W",601).
component("YNL037C",542).
component("YDL066W",191).
component("YLR355C",503).
component("YML086C",512).
component("YIL155C",391).
component("YPR191W",667).
component("YOR065W",596).
component("YJL166W",414).
component("YHR001W-A",363).
component("YGR183C",348).
component("YFR033C",305).
component("YDR529C",261).
component("YBL045C",135).
component("Q0105",18).
component("YGR088W",339).
component("YDR256C",241).
component("YJR078W",427).
component("YJR025C",421).
component("YGR255C",357).
component("YBL098W",138).
component("YMR015C",518).
component("YDR402C",253).
component("YGL055W",317).
component("YGR175C",345).
component("YJR104C",430).
component("YHR008C",364).
component("YJL026W",398).
component("YGR180C",347).
component("YER070W",281).
component("U35_",83).
component("YDL168W",206).
component("YDR158W",235).
component("YPL276W",648).
component("YPL275W",647).
component("YOR388C",625).
component("YOR374W",622).
component("YER073W",282).
component("YGL154C",323).
component("U55_",94).
component("YOR323C",614).
component("YMR170C",526).
component("YMR169C",525).
component("U2_",80).
component("YBR221C",169).
component("U52_",91).
component("YBR166C",164).
component("YNL280C",565).
component("YGL012W",313).
component("U57_",95).
component("YDR044W",218).
component("YER014W",270).
component("YKR009C",462).
component("YIL160C",393).
component("YGL205W",326).
component("YMR118C",523).
component("YLR164W",487).
component("YLL041C",470).
component("YKL148C",450).
component("YKL141W",448).
component("YJL045W",399).
component("YDR178W",236).
component("YJR051W",423).
component("YEL047C",265).
component("YOR375C",623).
component("YDL215C",209).
component("YAL062W",126).
component("U99_",122).
component("YBR035C",147).
component("YHR037W",366).
component("YKR080W",466).
component("YER023W",271).
component("YOR236W",611).
component("YGR204W",350).
component("YLR142W",482).
component("U62_",98).
component("YKL150W",451).
component("YIL043C",382).
component("YHR042W",367).
component("YFR030W",304).
component("YPL017C",628).
component("YFL018C",296).
component("YER042W",273).
component("YJR137C",435).
component("YPL266W",645).
component("YML110C",514).
component("YBR034C",146).
component("YPL273W",646).
component("YLL062C",473).
component("U47_",88).
component("YER091C",287).
component("YJR073C",425).
component("YDL033C",189).
component("YOL096C",588).
component("YLR172C",488).
component("YDR019C",215).
component("YDR408C",255).
component("YBL013W",130).
component("YKL024C",440).
component("YPR074C",659).
component("YBR117C",156).
component("YLR354C",502).
component("YGR043C",335).
component("YCL009C",178).
component("YMR062C",520).
component("YNL071W",545).
component("YNR008W",572).
component("YPL231W",640).
component("YER061C",279).
component("U86_",113).
component("YPL001W",627).
component("YDR148C",233).
component("YOR377W",624).
component("YGR177C",346).
component("YPL231W",641).
component("YGR147C",342).
component("YDL040C",190).
component("YPL028W",629).
component("YGL017W",314).
component("YPR001W",650).
component("YNR001C",570).
component("YDL182W",207).
component("YDL131W",198).
component("YNL117W",549).
component("YIR031C",396).
component("YDR307W",246).
component("YNL029C",541).
component("YIL085C",385).
component("YMR261C",533).
component("YML100W",513).
component("YBR126C",158).
component("YNL192W",556).
component("YBR038W",149).
component("YBR023C",145).
component("YLR209C",489).
component("U104_",21).
component("YOR209C",608).
component("YMR300C",537).
component("YER055C",275).
component("YDR354W",249) :- not remove_orf("YDR354W",249).
component("YFR047C",306).
component("YJR133W",434).
component("YLR209C",490).
component("YML022W",507).
component("YDR441C",257).
component("YDR399W",251).
component("YJL167W",415).
component("YNL256W",559).
component("YDR127W",228).
component("YLR303W",496).
component("YGR012W",332).
component("YJR130C",433).
component("YLR303W",497).
component("YDR035W",216).
component("YBR249C",170).
component("YOL143C",593).
component("YBR256C",171).
component("YHR137W",374).
component("YGL202W",325).
component("YLR027C",474).
component("YKL106W",445).
component("YKL104C",444).
component("YGR019W",333).
component("YLR089C",478).
component("U64_",99).
component("U61_",97).
component("U51_",90).
component("YJR148W",437).
component("YIL116W",389).
component("YGL253W",329).
component("YFR053C",307).
component("YOL136C",592).
component("YIL107C",387).
component("YMR205C",528).
component("YGR240C",353).
component("YDR248C",240).
component("YCR036W",186).
component("YCL040W",181).
component("YJR105W",431).
component("U16_",41).
component("U15_",37).
component("U96_",120).
component("YKL001C",439).
component("YML070W",511).
component("YFL053W",299).
component("YHL032C",361).
component("U83_",111).
component("U82_",110).
component("U81_",109).
component("YMR208W",529).
component("YOR347C",619).
component("YAL038W",125).
component("YNR012W",573).
component("YPR121W",662).
component("YPL258C",643).
component("YOL055C",584).
component("U1_",61).
component("YDR009W",214).
component("YBR020W",143).
component("YNL267W",562).
component("YLR305C",499).
component("YFR019W",302).
component("YDR208W",237).
component("YDR127W",229).
component("U21_",70).
component("U20_",68).
component("YDR147W",232).
component("YDR300C",245).
component("YCR012W",183).
component("U18_",54).
component("U17_",48).
component("U76_",107).
component("YER170W",293).
component("YDR226W",238).
component("YKL067W",443).
component("YDR454C",258).
component("YOL061W",586).
component("YKL181W",453).
component("YHL011C",359).
component("YER099C",289).
component("YBL068W",137).
component("YOR143C",602).
component("YBR018C",140).
component("YGR007W",331).
component("YLR328W",500).
component("YKR002W",460).
component("YDL103C",196).
component("YJR010W",420).
component("YCL050C",182).
component("YPR190C",666).
component("YPR187W",665).
component("YPR110C",661).
component("YPR010C",652).
component("YOR341W",618).
component("YOR340C",617).
component("YOR224C",610).
component("YOR210W",609).
component("YOR207C",606).
component("YOR151C",603).
component("YOR116C",599).
component("YOL005C",579).
component("YNR003C",571).
component("YNL248C",558).
component("YNL151C",553).
component("YNL113W",548).
component("YKL144C",449).
component("YJR063W",424).
component("YJL148W",411).
component("YJL140W",410).
component("YIL021W",381).
component("YHR143W-A",375).
component("YGL070C",320).
component("YFL036W",298).
component("YDR404C",254).
component("YDR156W",234).
component("YDR045C",219).
component("YDL150W",203).
component("YDL140C",199).
component("YBR154C",163).
component("YPR175W",664).
component("YPL167C",636).
component("YOR330C",615).
component("YOL115W",590).
component("YNL299W",567).
component("YNL262W",561).
component("YNL102W",547).
component("YJR043C",422).
component("YJR006W",419).
component("YJL090C",403).
component("YIL139C",390).
component("YEL055C",266).
component("YDR419W",256).
component("YDR121W",226).
component("YDL102W",195).
component("YCR014C",184).
component("YBR278W",173).
component("YBL035C",132).
component("YKL035W",442).
component("YHL012W",360).
component("YHR123W",373).
component("YDL142C",202).
component("YER026C",272).
component("YCL004W",177).
component("YJL068C",400).
component("YDR058C",223).
component("YNR034W",576).
component("YHR163W",377).
component("YGR248W",355).
component("YCR073W-A",187).
component("YDL086W",194).
component("YOL011W",581).
component("YMR008C",517).
component("YMR006C",516).
component("U101_",19).
component("YBL015W",131).
component("YJL068C",401).
component("YPL072W",632).
component("YOR124C",600).
component("YNL186W",555).
component("YMR304W",539).
component("YMR223W",531).
component("YKR098C",468).
component("YJL197W",416).
component("YIL156W",392).
component("YFR010W",301).
component("YER151C",291).
component("YER144C",290).
component("YER098W",288).
component("YDR069C",224).
component("YDL122W",197).
component("YBR058C",150).
component("YBL067C",136).
component("U84_",112).
component("YPR073C",657).
component("YHR215W",379).
component("YDL024C",188).
component("YBR093C",154).
component("YBR092C",153).
component("YAR071W",127).
component("YIL053W",384).
component("YER062C",280).
component("YHR046C",368).
component("YGR208W",352).
component("YPL228W",638).
component("YMR180C",527).
component("YDL236W",211).
component("YJL155C",413).
component("YPR073C",658).
component("YOR208W",607).
component("YNL053W",544).
component("YMR036C",519).
component("YIR026C",394).
component("YIL113W",388).
component("YFR028C",303).
component("YER075C",283).
component("YDL230W",210).
component("YBR276C",172).
component("U34_",82).
component("U30_",81).
component("U27_",79).
component("U25_",78).
component("U24_",77).
component("YOR360C",621).
component("YGL248W",328).
component("YKR031C",463).
component("YLR286C",494).
component("YOR190W",604).
component("YLR300W",495).
component("YGR282C",358).
component("YDR261C",242).
component("YDR400W",252).
component("U23_",76).
component("YML035C",508).
component("YJL070C",402).
component("YBR284W",174).
component("U102_",20).
component("YNL045W",543).
component("YLR160C",486).
component("YLR158C",485).
component("YLR157C",484).
component("YLR155C",483).
component("YDR321W",247).
component("YGL037C",316).
component("YDR242W",239).
component("YBR208C",166).
component("YMR281W",536).
component("U53_",92).
component("YIR032C",397).
component("YIR029W",395).
component("YPR062W",656).
component("YMR120C",524).
component("YHR144C",376).
component("YNL141W",550).
component("YBR153W",162).
component("YDL238C",212).
component("YNL141W",551).
component("YLR245C",493).
component("YML035C",509).
component("YJL126W",406).
component("U44_",86).
component("U87_",114).
component("YMR267W",534).
component("YBR011C",139).
component("YBR111C",155).
component("YCL030C",180).
component("YER005W",269).
component("YIL048W",383).
component("YER166W",292).
component("YDR093W",225).
component("YAL026C",124).
component("YLR231C",491).
component("U88_",115).
component("YLR134W",480).
component("YLR044C",475).
component("YGR087C",338).
component("YDR380W",250).
component("YDL080C",193).
component("U98_",121).
component("YMR250W",532).
component("YKL184W",456).
component("YNR043W",577).
component("U93_",119).
component("YDR047W",221).
component("U54_",93).
component("YKL211C",457) :- not remove_orf("YKL211C",457).
component("YNL169C",554).
component("YGR170W",344).
component("YNL256W",560).
component("YDR294C",243).
component("YEL046C",264).
component("YNR033W",575).
component("YKL211C",458) :- not remove_orf("YKL211C",458).
component("YER090W",458) :- not remove_orf("YER090W",458).
component("YER090W",286) :- not remove_orf("YER090W",286).
component("YDR127W",230).
component("YPL281C",649).
component("YOR393W",626).
component("YMR323W",540).
component("YHR174W",378).
component("YGR254W",356).
component("YGL026C",315) :- not remove_orf("YGL026C",315).
component("YGR155W",343).
component("YLR304C",498).
component("YJL200C",417).
component("YNL316C",568).
component("YKL182W",454).
component("YPL212C",637).
component("YNL292W",566).
component("YGL063W",319).
component("YFL001W",294).
component("YPR002W",651).
component("YDR127W",231).
component("YGL148W",322).
component("YER086W",284).
component("YLR359W",504).
component("YAL012W",123).
component("YFR055W",308).
component("YJL121C",405).
component("YBR019C",141).
component("YBR019C",142).
component("YDR050C",222).
component("YDR007W",213) :- not remove_orf("YDR007W",213).
component("YOR095C",598).
component("YER003C",268).
component("YBR196C",165).
component("YGL001C",310).
component("U14_",31).
component("YKL152C",452).
component("YMR105C",521).
component("YKL127W",446).
component("YEL058W",267).
component("YPR060C",655).
component("YHR072W",370).
component("YJL153C",412).
component("YPL097W",633).
component("YGR185C",349).
component("YPL104W",634).
component("YLL018C",469).
component("YPR081C",660).
component("YBR121C",157).
component("YHR020W",365).
component("YER087W",285).
component("YNL247W",557).
component("YOL033W",583).
component("YHR091C",372).
component("YDR341C",248).
component("YOL097C",589).
component("YPR047W",654).
component("YLR060W",476).
component("YFL022C",297).
component("YPR033C",653).
component("YPL160W",635).
component("YLR382C",505).
component("YNL073W",546).
component("YDR037W",217).
component("YOR335C",616).
component("YGR094W",340).
component("YGR244C",354).
component("U89_",116).
component("YOR241W",612).
component("YMR113W",522).
component("YKL132C",447).
component("YJL101C",404).
component("U92_",118).
component("YGL234W",327).
component("U91_",117).
component("YDL141W",200).
component("YDL141W",201).
component("YJR103W",429).
component("YBL039C",133).
component("YGR204W",351).
component("YOL058W",585).
component("YBR208C",167).
component("YHR074W",371).
component("YMR217W",530).
component("YOR303W",613).
component("YJR109C",432).
component("YJL130C",408).
component("YGL062W",318).
component("YBR218C",168).
component("YPL231W",642).
component("YNR016C",574).
component("YKL182W",455).
component("YGR037C",334).
component("YOR005C",595).
component("YDL164C",204).
component("YOL010W",580).
component("YPR138C",663).
component("YPL265W",644).
component("YPL057C",631).
component("YPL036W",630).
component("YOR348C",620).
component("YOR192C",605).
component("YOR071C",597).
component("YOL156W",594).
component("YOL020W",582) :- not remove_orf("YOL020W",582).
component("YNR056C",578).
component("YNL318C",569).
component("YNL268W",563).
component("YNL142W",552).
component("YMR272C",535).
component("YML123C",515).
component("YLR348C",501).
component("YLR237W",492).
component("YLR138W",481).
component("YLR100C",479).
component("YLR081W",477).
component("YLL061W",472).
component("YLL043W",471).
component("YKR093W",467).
component("YKR053C",465).
component("YKR039W",464) :- not remove_orf("YKR039W",464).
component("YKL217W",459).
component("YJR095W",428).
component("YJR077C",426).
component("YJL219W",418).
component("YJL134W",409).
component("YJL129C",407).
component("YHL036W",362).
component("YGR121C",341).
component("YGR055W",336).
component("YGL186C",324).
component("YGL077C",321).
component("YGL008C",311).
component("YFL055W",300).
component("YFL011W",295).
component("YER060W-A",278).
component("YER060W",277).
component("YER056C",276).
component("YER053C",274).
component("YEL017C-A",263).
component("YDR536W",262).
component("YDR508C",260).
component("YDR503C",259).
component("YDR294C",244).
component("YDR046C",220) :- not remove_orf("YDR046C",220).
component("YDL210W",208).
component("YCR024C-A",185).
component("YCL025C",179).
component("YBR298C",176).
component("YBR291C",175).
component("YBR069C",152) :- not remove_orf("YBR069C",152).
component("YBR068C",151) :- not remove_orf("YBR068C",151).
component("YBR036C",148).
component("YBR021W",144).
component("YBL042C",134).
component("U79_",108).
component("U75_",106).
component("U74_",105).
component("U73_",104).
...
catalyst(6160,537).
catalyst(3870,275).
catalyst(3620,249) :- not remove_reaction(3620,249).
catalyst(2110,306).
catalyst(2190,306).
catalyst(5550,434).
catalyst(5791,490).
...
catalyst(1960,221).
catalyst(3460,93).
catalyst(3600,457) :- not remove_reaction(3600,457).
catalyst(6890,554).
catalyst(6900,344).
catalyst(2570,560).
catalyst(8781,243).
...
catalyst(1890,286) :- not remove_reaction(1890,286).
...
catalyst(8231,356).
catalyst(8232,356).
catalyst(3590,315) :- not remove_reaction(3590,315).
catalyst(10910,315) :- not remove_reaction(10910,315).
catalyst(4570,343).
catalyst(8181,498).
catalyst(8182,498).
catalyst(8181,417).
...
catalyst(8281,222).
catalyst(8282,222).
catalyst(3610,213) :- not remove_reaction(3610,213).
catalyst(7921,598).
catalyst(7922,598).
catalyst(7841,268).
catalyst(7842,268).
...
catalyst(190,597).
catalyst(1200,594).
catalyst(801,582) :- not remove_reaction(801,582).
catalyst(802,582) :- not remove_reaction(802,582).
catalyst(811,582) :- not remove_reaction(811,582).
catalyst(812,582) :- not remove_reaction(812,582).
catalyst(831,582) :- not remove_reaction(831,582).
catalyst(832,582) :- not remove_reaction(832,582).
catalyst(901,582) :- not remove_reaction(901,582).
catalyst(902,582) :- not remove_reaction(902,582).
catalyst(941,582) :- not remove_reaction(941,582).
catalyst(942,582) :- not remove_reaction(942,582).
catalyst(700,578).
catalyst(1200,569).
catalyst(761,563).
catalyst(762,563).
...
catalyst(640,467).
catalyst(6560,465).
catalyst(761,464) :- not remove_reaction(761,464).
catalyst(762,464) :- not remove_reaction(762,464).
catalyst(771,464) :- not remove_reaction(771,464).
catalyst(772,464) :- not remove_reaction(772,464).
catalyst(781,464) :- not remove_reaction(781,464).
catalyst(782,464) :- not remove_reaction(782,464).
catalyst(791,464) :- not remove_reaction(791,464).
catalyst(792,464) :- not remove_reaction(792,464).
catalyst(801,464) :- not remove_reaction(801,464).
catalyst(802,464) :- not remove_reaction(802,464).
catalyst(811,464) :- not remove_reaction(811,464).
catalyst(812,464) :- not remove_reaction(812,464).
catalyst(821,464) :- not remove_reaction(821,464).
catalyst(822,464) :- not remove_reaction(822,464).
catalyst(831,464) :- not remove_reaction(831,464).
catalyst(832,464) :- not remove_reaction(832,464).
catalyst(841,464) :- not remove_reaction(841,464).
catalyst(842,464) :- not remove_reaction(842,464).
catalyst(861,464) :- not remove_reaction(861,464).
catalyst(862,464) :- not remove_reaction(862,464).
catalyst(881,464) :- not remove_reaction(881,464).
catalyst(882,464) :- not remove_reaction(882,464).
catalyst(901,464) :- not remove_reaction(901,464).
catalyst(902,464) :- not remove_reaction(902,464).
catalyst(911,464) :- not remove_reaction(911,464).
catalyst(912,464) :- not remove_reaction(912,464).
catalyst(941,464) :- not remove_reaction(941,464).
catalyst(942,464) :- not remove_reaction(942,464).
catalyst(1191,464) :- not remove_reaction(1191,464).
catalyst(1192,464) :- not remove_reaction(1192,464).
catalyst(1021,459).
catalyst(1022,459).
catalyst(1250,428).
catalyst(1581,426).
...
catalyst(1511,175).
catalyst(1512,175).
catalyst(771,152) :- not remove_reaction(771,152).
catalyst(772,152) :- not remove_reaction(772,152).
catalyst(791,152) :- not remove_reaction(791,152).
catalyst(792,152) :- not remove_reaction(792,152).
catalyst(801,152) :- not remove_reaction(801,152).
catalyst(802,152) :- not remove_reaction(802,152).
catalyst(811,152) :- not remove_reaction(811,152).
catalyst(812,152) :- not remove_reaction(812,152).
catalyst(861,152) :- not remove_reaction(861,152).
catalyst(862,152) :- not remove_reaction(862,152).
catalyst(901,152) :- not remove_reaction(901,152).
catalyst(902,152) :- not remove_reaction(902,152).
catalyst(791,151) :- not remove_reaction(791,151).
catalyst(792,151) :- not remove_reaction(792,151).
...
catalyst(841,151) :- not remove_reaction(841,151).
catalyst(842,151) :- not remove_reaction(842,151).
catalyst(861,151) :- not remove_reaction(861,151).
catalyst(862,151) :- not remove_reaction(862,151).
catalyst(901,151) :- not remove_reaction(901,151).
catalyst(902,151) :- not remove_reaction(902,151).
catalyst(6600,148).
catalyst(620,144).
catalyst(540,134).
catalyst(2830,108).
...
modifiable_enzyme(464).
modifiable_enzyme(220).
modifiable_enzyme(152).
