...
component("YNL280C",820).
component("YLR056W",689).
component("YGR060W",484).
component("YGL012W",449).
component("YKR009C",671).
component("YOL086C",852).
component("YMR303C",787).
component("YMR083W",756).
component("YGL256W",476).
component("YDL168W",294).
component("YBR145W",220).
component("YPL231W",935).
component("YBR265W",239).
component("U46_",124).
component("YBR149W",221).
component("YBR149W",222).
component("YJR159W",637).
component("YGL001C",446).
component("YIL094C",564).
component("YHR063C",536).
component("YBR153W",223).
component("YML056C",738).
component("YLR432W",730).
component("YHR216W",554).
component("YAR075W",181).
component("YAR073W",180).
component("YCL030C",249).
component("YDR127W",329).
component("YJR139C",631).
component("YOL126C",857).
component("YKL085W",647).
component("YDL078C",274).
component("YKL029C",642).
component("YOR136W",873).
component("YNL037C",792).
component("YDL066W",272).
component("YNL241C",810).
component("YOL059W",850).
component("YDL022W",265).
component("YLR355C",725).
component("YIL074C",562).
component("YER081W",413).
component("YML054C",737).
component("YDL174C",296).
component("YML086C",741).
component("YIL155C",571).
component("YPR191W",973).
component("YOR065W",864).
component("YJL166W",602).
component("YHR001W-A",524).
component("YGR183C",500).
component("YFR033C",442).
component("YDR529C",378).
component("YBL045C",187).
component("Q0105",18).
component("YGR088W",487).
component("YDR256C",346).
component("YKL026C",641).
component("YIR037W",582).
component("YBR244W",235).
component("YJR078W",622).
component("U58_",136).
component("YJR025C",614).
component("YGR255C",512).
component("U108_",25).
component("YBL098W",191).
component("YMR015C",752).
component("YHR007C",525).
component("YDR402C",366).
component("YGL055W",456).
component("YGR175C",497).
component("YJR104C",625).
component("YHR008C",526).
component("YJL026W",585).
component("YIL066C",561).
component("YGR180C",499).
component("YER070W",410).
component("U38_",119).
component("U36_",118).
component("U35_",117).
component("YDL168W",295).
component("YDR158W",337).
component("YBR006W",194).
component("YPL276W",947).
component("YPL275W",946).
component("YOR388C",910).
component("YOR374W",907).
component("YER073W",411).
component("U68_",142).
component("YGL154C",465).
component("U55_",133).
component("YOR323C",897).
component("YMR170C",767).
component("YMR169C",766).
component("U2_",112).
component("YER178W",427).
component("YBR221C",233).
component("YIL125W",569).
component("U52_",130).
component("YBR166C",226).
component("YNL280C",821).
component("YGL012W",450).
component("YKL182W",659).
component("U57_",135).
component("YKL216W",668).
component("YDR044W",313).
component("YER014W",394).
component("YKR009C",672).
component("YIL160C",573).
component("YGL205W",470).
component("YMR118C",761).
component("YLR164W",702).
component("YLL041C",681).
component("YKL148C",654).
component("YKL141W",652).
component("YJL045W",586).
component("YDR178W",339).
component("YJR051W",617).
component("YEL047C",388).
component("YDL215C",300).
component("YOR375C",908).
component("YDL215C",301).
component("YAL062W",177).
component("U99_",171).
component("YBR035C",204).
component("YMR189W",769).
component("U56_",134).
component("YHR037W",532).
component("YKR080W",676).
component("YER023W",396).
component("YPL023C",914).
component("YGL125W",462).
component("YOR236W",889).
component("YGR204W",504).
component("YLR142W",697).
component("U63_",140).
component("U62_",139).
component("YOR356W",905).
component("YKL150W",655).
component("YIL043C",558).
component("YHR042W",533).
component("YOR221C",886).
component("YML120C",745).
component("YKL192C",663).
component("YKL055C",644).
component("YER061C",405).
component("YMR145C",764).
component("YML120C",746).
component("YKL192C",664).
component("YDL085W",276).
component("YGR234W",507).
component("YFR030W",441).
component("YPL017C",913).
component("YFL018C",432).
component("YPL091W",919).
component("YDR353W",361).
component("YER042W",398).
component("YJR137C",630).
component("YNL052W",794).
component("YMR256C",778).
component("YLR395C",729).
component("YLR038C",687).
component("YIL111W",566).
component("YHR051W",535).
component("YGL191W",468).
component("YGL187C",467).
component("YDL067C",273).
component("Q0275",20).
component("Q0250",19).
component("YPL266W",942).
component("YML110C",744).
component("YBR034C",203).
component("YPL273W",944).
component("YLL062C",684).
component("YDR410C",369).
component("U47_",125).
component("YER091C",418).
component("YJR073C",620).
component("YDR120C",327).
component("YDL033C",267).
component("YOL096C",853).
component("YLR172C",703).
component("YDR019C",309).
component("YBR176W",227).
component("YDR408C",368).
component("YMR120C",762).
component("YBL013W",182).
component("YKL024C",640).
component("YPR074C",961).
component("YBR117C",216).
component("YLR354C",724).
component("YGR043C",482).
component("YMR108W",759).
component("YCL009C",247).
component("YMR062C",755).
component("YNL071W",796).
component("YNR008W",828).
component("YIL160C",574).
component("YNL277W",819).
component("YDR232W",342).
component("YFL017C",431).
component("YPL231W",936).
component("YER061C",406).
component("U86_",159).
component("YPL001W",912).
component("YMR296C",785).
component("YDR062W",321).
component("YDL052C",270).
component("U8_",163).
component("YDR148C",335).
component("YOR377W",909).
component("YGR177C",498).
component("YPL231W",937).
component("YGR147C",493).
component("YDL040C",268).
component("YPL028W",915).
component("YLR195C",704).
component("YGL017W",451).
component("YPR001W",949).
component("YNR001C",826).
component("YCR005C",254).
component("YNL104C",799).
component("YDL182W",297).
component("YDL131W",285).
component("YNL117W",801).
component("YIR031C",580).
component("YOR321W",896).
component("YJR143C",632).
component("YGR199W",503).
component("YDR307W",355).
component("YDL095W",280).
component("YDL093W",279).
component("YAL023C",174).
component("YOR103C",868).
component("YOR085W",866).
component("YMR149W",765).
component("YML019W",733).
component("YJL002C",583).
component("YEL002C",382).
component("YDL232W",303).
component("YCL043C",252).
component("YNL029C",791).
component("YIL085C",563).
component("YMR261C",779).
component("YML100W",742).
component("YBR126C",219).
component("YNL192W",809).
component("YBR038W",206).
component("YBR023C",202).
component("YMR306W",789).
component("YLR342W",722).
component("YGR032W",480).
component("YPR183W",970).
component("YLR209C",705).
component("U104_",23).
component("YMR271C",781).
component("YML106W",743).
component("YOR209C",884).
component("YMR300C",786).
component("YER055C",401).
component("YDR354W",362) :- not remove_orf("YDR354W",362).
component("YFR047C",443).
component("YJR133W",629).
component("YLR209C",706).
component("YML022W",734).
component("YDR441C",372).
component("YDR399W",364).
component("YPR176C",969).
component("YPL172C",927).
component("YNR041C",834).
component("YMR101C",757).
component("YDL090C",278).
component("YBR003W",193).
component("YBR002C",192).
component("YJL167W",603).
component("YJL167W",604).
component("YNL256W",813).
component("YPR069C",958).
component("YDR127W",330).
component("YLR303W",713).
component("YGR012W",478).
component("YJR130C",628).
component("YLR303W",714).
component("YDR035W",311).
component("YBR249C",236).
component("YOR274W",892).
component("YOL143C",860).
component("YBR256C",238).
component("YHR137W",545).
component("YGL202W",469).
component("YLR027C",685).
component("YKL106W",649).
component("YOL140W",859).
component("YKL104C",648).
component("YGR019W",479).
component("YLR089C",692).
component("U64_",141).
component("U61_",138).
component("U51_",129).
component("YJR148W",633).
component("YHR208W",552).
component("YFL030W",434).
component("YOR184W",879).
component("YNR058W",838).
component("YIL116W",568).
component("YGL253W",475).
component("YFR053C",444).
component("YOL136C",858).
component("YIL107C",565).
component("YMR013C",751).
component("YMR205C",771).
component("YGR240C",508).
component("YDR248C",345).
component("YCR036W",260).
component("YGR194C",502).
component("YCL040W",251).
component("YJR105W",626).
component("U16_",62).
component("U15_",56).
component("YPL188W",929).
component("YJR049C",616).
component("YEL041W",386).
component("U96_",169).
component("YKL001C",638).
component("YDR236C",343).
component("YML070W",740).
component("YFL053W",436).
component("YHL032C",522).
component("YLR133W",694).
component("YDR531W",380).
component("U83_",156).
component("U82_",155).
component("U81_",154).
component("YMR208W",772).
component("YPL203W",930).
component("YOR061W",863).
component("YKL166C",657).
component("YJL164C",601).
component("YIL035C",557).
component("YHR205W",551).
component("YHR102W",543).
component("YGL019W",452).
component("YHR025W",531).
component("YOR347C",903).
component("YAL038W",176).
component("YNR012W",829).
component("YPR121W",965).
component("YPL258C",939).
component("YOL055C",846).
component("YPL214C",933).
component("U1_",86).
component("YDR009W",308).
component("YBR020W",200).
component("YNL267W",817).
component("YLR305C",716).
component("YFR019W",439).
component("YDR208W",340).
component("YDR127W",331).
component("U21_",98).
component("U20_",94).
component("YDR147W",334).
component("YDR300C",354).
component("YCR012W",255).
component("YER052C",399).
component("YER069W",409).
component("U19_",85).
component("U18_",77).
component("U17_",70).
component("U76_",150).
...
component("YDR226W",341).
component("YKL067W",646).
component("YOL055C",847).
component("YDR454C",373).
component("YJR057W",618).
component("YOL061W",851).
component("YKL181W",658).
component("YHL011C",519).
component("YER099C",420).
component("YBL068W",190).
component("YOR143C",875).
component("YNL256W",814).
component("YLR328W",720).
component("YBR018C",196).
component("YBR018C",197).
component("YGR007W",477).
component("YLR328W",721).
component("YKR002W",670).
component("YDL103C",283).
component("U94_",168).
component("YJR010W",612).
component("YGL130W",463).
component("YDR530C",379).
component("YCL050C",253).
component("YPR190C",972).
component("YPR187W",971).
component("YPR110C",963).
component("YPR010C",952).
component("YOR341W",902).
component("YOR340C",901).
component("YOR224C",888).
component("YOR210W",885).
component("YOR207C",882).
component("YOR151C",876).
component("YOR116C",869).
component("YOL005C",840).
component("YNR003C",827).
component("YNL248C",812).
component("YNL151C",806).
component("YNL113W",800).
component("YKL144C",653).
component("YJR063W",619).
component("YJL148W",598).
component("YJL140W",597).
component("YIL021W",556).
component("YHR143W-A",546).
component("YGL070C",460).
component("YFL036W",435).
component("YDR404C",367).
component("YDR156W",336).
component("YDR045C",314).
component("YDL150W",292).
component("YDL140C",287).
component("YBR154C",225).
component("YPR175W",968).
component("YPL167C",926).
component("YOR330C",898).
component("YOL115W",856).
component("YNL299W",823).
component("YNL262W",816).
component("YNL102W",798).
component("YJR043C",615).
component("YJR006W",611).
component("YJL090C",590).
component("YIL139C",570).
component("YEL055C",389).
component("YDR419W",370).
component("YDR121W",328).
component("YDL102W",282).
component("YCR014C",256).
component("YBR278W",241).
component("YBL035C",184).
component("YKL035W",643).
component("YHL012W",520).
component("YHR123W",544).
component("YPR113W",964).
component("YBR243C",234).
component("YNL130C",802).
component("YDL142C",291).
component("YPL148C",924).
component("YER026C",397).
component("YCL004W",246).
component("YOR251C",891).
component("YGR286C",516).
component("YJL068C",587).
component("YDR058C",319).
component("YNR034W",833).
component("YHR163W",548).
component("YGR248W",510).
component("YCR073W-A",262).
component("YDL086W",277).
component("YOL011W",842).
component("YMR008C",749).
component("YMR006C",748).
component("U105_",24).
component("U101_",21).
component("YBL015W",183).
component("YJL068C",588).
component("YPL072W",918).
component("YOR124C",870).
component("YNL186W",808).
component("YMR304W",788).
component("YMR223W",775).
component("YKR098C",679).
component("YJL197W",605).
component("YIL156W",572).
component("YFR010W",438).
component("YER151C",424).
component("YER144C",423).
component("YER098W",419).
component("YDR069C",322).
component("YDL122W",284).
component("YBR058C",207).
component("YBL067C",189).
component("YDR272W",349).
component("U84_",157).
component("YDR481C",374).
component("YLR377C",727).
component("YDR074W",323).
component("YPL179W",928).
component("YNR032W",831).
component("YML057W",739).
component("YML016C",732).
component("YLR433C",731).
component("YGR123C",490).
component("YER133W",422).
component("YER089C",416).
component("YDR436W",371).
component("YDR075W",324).
component("YDL188C",298).
component("YDL134C",286).
component("YDL047W",269).
component("YDL006W",263).
component("YBR125C",218).
component("YBL056W",188).
component("YPR073C",959).
component("YHR215W",553).
component("YDL024C",266).
component("YBR093C",214).
component("YBR092C",213).
component("YAR071W",179).
component("YIL053W",560).
component("YER062C",407).
component("YHR046C",534).
component("U9_",172).
component("YGR208W",506).
component("YPL228W",934).
component("YMR180C",768).
component("YDL236W",304).
component("YJL155C",600).
component("YPR073C",960).
component("YOR208W",883).
component("YNL053W",795).
component("YMR036C",754).
component("YIR026C",577).
component("YIL113W",567).
component("YFR028C",440).
component("YER075C",412).
component("YDL230W",302).
component("YBR276C",240).
component("U34_",116).
component("U33_",115).
component("U32_",114).
component("U30_",113).
...
component("U25_",109).
component("U24_",108).
component("YPL268W",943).
component("YOR360C",906).
component("YGL248W",474).
component("YKR031C",673).
component("YPL206C",931).
component("YGL027C",454).
component("YLR286C",711).
component("YJR153W",635).
component("YJL221C",610).
component("YJL216C",608).
component("YIL172C",576).
component("YGR292W",518).
component("YGR287C",517).
component("YBR299W",245).
component("YBR184W",228).
component("YOR190W",880).
component("YLR300W",712).
component("YGR282C",515).
component("YDR261C",347).
component("YDR400W",365).
component("U23_",107).
component("YML035C",735).
component("YJL070C",589).
component("YBR284W",242).
component("U102_",22).
component("YNL045W",793).
component("YLR160C",701).
component("YLR158C",700).
component("YLR157C",699).
component("YLR155C",698).
component("YDR321W",356).
component("YGL037C",455).
component("YMR293C",784).
component("YDR242W",344).
component("YLR308W",719).
component("YLR307W",718).
component("YBR208C",230).
component("YMR281W",783).
component("U53_",131).
component("YIR027C",578).
component("YPL111W",922).
component("YIR032C",581).
component("YIR029W",579).
component("YPR062W",957).
component("YMR120C",763).
component("YLR028C",686).
component("YHR144C",547).
component("YGR267C",514).
component("YNL141W",803).
component("YBR153W",224).
component("YDL238C",305).
component("YNL141W",804).
component("YLR245C",709).
component("YML035C",736).
component("YBR084W",211).
component("YJL126W",593).
component("U44_",123).
component("YDL100C",281).
component("U87_",160).
component("U40_",121).
component("YMR267W",780).
component("YBR011C",195).
component("YHR201C",550).
component("YBR111C",215).
component("YBR252W",237).
component("YCL030C",250).
component("YER005W",393).
component("YIL048W",559).
component("YER166W",425).
component("YDR093W",326).
component("YAL026C",175).
component("YLR231C",707).
component("U88_",161).
component("YLR134W",695).
component("YLR044C",688).
component("YGR087C",486).
component("YDR380W",363).
component("YDL080C",275).
component("U98_",170).
component("YMR250W",777).
component("YKL184W",662).
component("YOR128C",871).
component("YEL021W",385).
component("YNR043W",835).
component("U93_",167).
component("YDR047W",316).
component("U54_",132).
component("YKL211C",666) :- not remove_orf("YKL211C",666).
component("YKR097W",678).
component("YOL052C",845).
component("YNL169C",807).
component("YGR170W",495).
component("YKL060C",645).
component("YNL256W",815).
component("YDR294C",351).
component("YEL046C",387).
component("YNR033W",832).
component("YPR006C",951).
component("YER065C",408).
component("YKL211C",667) :- not remove_orf("YKL211C",667).
component("YER090W",667) :- not remove_orf("YER090W",667).
component("YER090W",417) :- not remove_orf("YER090W",417).
component("YDR127W",332).
component("YPL281C",948).
component("YOR393W",911).
component("YMR323W",790).
component("YHR174W",549).
component("YGR254W",511).
component("YPL262W",940).
component("YGL026C",453) :- not remove_orf("YGL026C",453).
component("YGR155W",494).
component("YLR304C",715).
component("YJL200C",606).
component("YNL316C",824).
component("YKL182W",660).
component("YPL212C",932).
component("YNL292W",822).
component("YGL063W",459).
component("YFL001W",429).
component("YOR278W",893).
component("YPR002W",950).
component("U49_",126).
component("YJR016C",613).
component("YCR053W",261).
component("YDR127W",333).
component("YGL148W",464).
component("YIL168W",575).
component("YER086W",414).
component("YLR359W",726).
component("YAL012W",173).
component("YFR055W",445).
component("YJL005W",584).
component("YOR176W",878).
component("YJL121C",592).
component("YBR019C",198).
component("YBR019C",199).
component("YDR050C",317).
component("YDR007W",307) :- not remove_orf("YDR007W",307).
component("YOR095C",867).
component("YER003C",392).
component("YBR196C",229).
component("YGL001C",447).
component("U14_",48).
component("YOL056W",848).
component("YKL152C",656).
component("YDL021W",264).
component("YMR105C",758).
component("YKL127W",650).
component("YEL058W",390).
component("YPR060C",956).
component("YHR072W",537).
component("YJL153C",599).
component("YPL097W",920).
component("YGR185C",501).
component("YGR264C",513).
component("YGR171C",496).
component("YHR011W",527).
component("YDR023W",310).
component("YPL104W",921).
component("YLL018C",680).
component("YPR081C",962).
component("YBR121C",217).
component("YHR020W",530).
component("YER087W",415).
component("YNL247W",811).
component("YOL033W",844).
component("YGL245W",473).
component("YHR091C",539).
component("YDR341C",357).
component("YOL097C",854).
component("YDR268W",348).
component("YPR047W",955).
component("YLR060W",690).
component("YFL022C",433).
component("YPR033C",953).
component("YHR019C",528).
component("YCR024C",257).
component("YHR019C",529).
component("YPL160W",925).
component("YLR382C",728).
component("YNL073W",797).
component("YDR037W",312).
component("YOR335C",899).
component("YGR094W",488).
component("YOR317W",895).
component("YMR246W",776).
component("YIL009W",555).
component("YER015W",395).
component("YOR142W",874).
component("YGR244C",509).
component("YPR035W",954).
component("U89_",162).
component("YOR241W",890).
component("YMR113W",760).
component("YKL132C",651).
component("YOR339C",900).
component("YMR022W",753).
component("YLR306W",717).
component("YKL210W",665).
component("YGR133W",492).
component("YGL058W",457).
component("YER100W",421).
component("YEL012W",383).
component("YDR177W",338).
component("YDR092W",325).
component("YDR059C",320).
component("YDR054C",318).
component("YDL064W",271).
component("YBR082C",210).
component("YJL101C",591).
component("U92_",166).
component("YAR015W",178).
component("YGL234W",471).
component("YER183C",428).
component("U91_",165).
component("U90_",164).
component("YNR057C",837).
component("YDL141W",288).
component("YDL141W",289).
component("YGL234W",472).
component("YDL141W",290).
component("YJR103W",624).
component("YBL039C",185).
component("YGR204W",505).
component("YBR084W",212).
component("YOL058W",849).
component("YBR208C",231).
component("YHR074W",538).
component("YMR217W",773).
component("YGR061C",485).
component("YPR145W",967).
component("YGR124W",491).
component("YOR303W",894).
component("YJR109C",627).
component("YJL130C",595).
component("YGL062W",458).
component("YBR218C",232).
component("YPL231W",938).
component("YNR016C",830).
component("YKL182W",661).
component("YGR037C",481).
component("YOR005C",862).
component("YDL164C",293).
component("YOL010W",841).
component("YPR138C",966).
component("YPL274W",945).
component("YPL265W",941).
component("YPL134C",923).
component("YPL057C",917).
component("YPL036W",916).
component("YOR348C",904).
component("YOR222W",887).
component("YOR192C",881).
component("YOR171C",877).
component("YOR130C",872).
component("YOR071C",865).
component("YOL156W",861).
component("YOL103W",855).
component("YOL020W",843) :- not remove_orf("YOL020W",843).
component("YNR072W",839).
component("YNR056C",836).
component("YNL318C",825).
component("YNL268W",818).
component("YNL142W",805).
component("YMR272C",782).
component("YMR202W",770).
component("YMR011W",750).
component("YML123C",747).
component("YLR348C",723).
component("YLR260W",710).
component("YLR237W",708).
component("YLR138W",696).
component("YLR100C",693).
component("YLR081W",691).
component("YLL061W",683).
component("YLL043W",682).
component("YKR093W",677).
component("YKR053C",675).
component("YKR039W",674) :- not remove_orf("YKR039W",674).
component("YKL217W",669).
component("YKL004W",639).
component("YJR158W",636).
component("YJR152W",634).
component("YJR095W",623).
component("YJR077C",621).
component("YJL219W",609).
component("YJL214W",607).
component("YJL134W",596).
component("YJL129C",594).
component("YHR096C",542).
component("YHR094C",541).
component("YHR092C",540).
component("YHL036W",523).
component("YHL016C",521).
component("YGR121C",489).
component("YGR055W",483).
component("YGL186C",466).
component("YGL077C",461).
component("YGL008C",448).
component("YFL055W",437).
component("YFL011W",430).
component("YER060W-A",404).
component("YER060W",403).
component("YER056C",402).
component("YER053C",400).
component("YEL069C",391).
component("YEL017C-A",384).
component("YDR536W",381).
component("YDR508C",377).
component("YDR503C",376).
component("YDR497C",375).
component("YDR345C",360).
component("YDR343C",359).
component("YDR342C",358).
component("YDR297W",353).
component("YDR294C",352).
component("YDR284C",350).
component("YDR046C",315) :- not remove_orf("YDR046C",315).
component("YDL245C",306).
component("YDL210W",299).
component("YCR032W",259).
component("YCR024C-A",258).
component("YCL025C",248).
component("YBR298C",244).
component("YBR291C",243).
component("YBR069C",209) :- not remove_orf("YBR069C",209).
component("YBR068C",208) :- not remove_orf("YBR068C",208).
component("YBR036C",205).
component("YBR021W",201).
component("YBL042C",186).
component("U85_",158).
component("U7_",153).
component("U79_",152).
component("U78_",151).
...
catalyst(6160,786).
catalyst(3870,401).
catalyst(3620,362) :- not remove_reaction(3620,362).
catalyst(2110,443).
catalyst(2190,443).
catalyst(5550,629).
catalyst(5791,706).
...
catalyst(1960,316).
catalyst(3460,132).
catalyst(3600,666) :- not remove_reaction(3600,666).
catalyst(8000,678).
catalyst(3941,845).
catalyst(3942,845).
catalyst(6890,807).
...
catalyst(8020,951).
catalyst(8020,408).
catalyst(1890,667) :- not remove_reaction(1890,667).
catalyst(3630,667) :- not remove_reaction(3630,667).
catalyst(1890,417) :- not remove_reaction(1890,417).
catalyst(3630,417) :- not remove_reaction(3630,417).
catalyst(3740,332).
catalyst(8231,948).
catalyst(8232,948).
catalyst(8231,911).
...
catalyst(8281,317).
catalyst(8282,317).
catalyst(3610,307) :- not remove_reaction(3610,307).
catalyst(7921,867).
catalyst(7922,867).
catalyst(7841,392).
catalyst(7842,392).
...
catalyst(1210,861).
catalyst(1160,855).
catalyst(801,843) :- not remove_reaction(801,843).
catalyst(802,843) :- not remove_reaction(802,843).
catalyst(811,843) :- not remove_reaction(811,843).
catalyst(812,843) :- not remove_reaction(812,843).
catalyst(831,843) :- not remove_reaction(831,843).
catalyst(832,843) :- not remove_reaction(832,843).
catalyst(901,843) :- not remove_reaction(901,843).
catalyst(902,843) :- not remove_reaction(902,843).
catalyst(941,843) :- not remove_reaction(941,843).
catalyst(942,843) :- not remove_reaction(942,843).
catalyst(1170,839).
catalyst(1210,839).
catalyst(700,836).
catalyst(1200,825).
...
catalyst(650,677).
catalyst(6560,675).
catalyst(761,674) :- not remove_reaction(761,674).
catalyst(762,674) :- not remove_reaction(762,674).
catalyst(771,674) :- not remove_reaction(771,674).
catalyst(772,674) :- not remove_reaction(772,674).
catalyst(781,674) :- not remove_reaction(781,674).
catalyst(782,674) :- not remove_reaction(782,674).
catalyst(791,674) :- not remove_reaction(791,674).
catalyst(792,674) :- not remove_reaction(792,674).
catalyst(801,674) :- not remove_reaction(801,674).
catalyst(802,674) :- not remove_reaction(802,674).
catalyst(811,674) :- not remove_reaction(811,674).
catalyst(812,674) :- not remove_reaction(812,674).
catalyst(821,674) :- not remove_reaction(821,674).
catalyst(822,674) :- not remove_reaction(822,674).
catalyst(831,674) :- not remove_reaction(831,674).
catalyst(832,674) :- not remove_reaction(832,674).
catalyst(841,674) :- not remove_reaction(841,674).
catalyst(842,674) :- not remove_reaction(842,674).
catalyst(861,674) :- not remove_reaction(861,674).
catalyst(862,674) :- not remove_reaction(862,674).
catalyst(881,674) :- not remove_reaction(881,674).
catalyst(882,674) :- not remove_reaction(882,674).
catalyst(901,674) :- not remove_reaction(901,674).
catalyst(902,674) :- not remove_reaction(902,674).
catalyst(911,674) :- not remove_reaction(911,674).
catalyst(912,674) :- not remove_reaction(912,674).
catalyst(921,674) :- not remove_reaction(921,674).
catalyst(922,674) :- not remove_reaction(922,674).
catalyst(941,674) :- not remove_reaction(941,674).
catalyst(942,674) :- not remove_reaction(942,674).
catalyst(1191,674) :- not remove_reaction(1191,674).
catalyst(1192,674) :- not remove_reaction(1192,674).
catalyst(1021,669).
catalyst(1022,669).
catalyst(6610,639).
catalyst(1170,636).
...
catalyst(6550,352).
catalyst(6690,350).
catalyst(791,315) :- not remove_reaction(791,315).
catalyst(792,315) :- not remove_reaction(792,315).
catalyst(801,315) :- not remove_reaction(801,315).
catalyst(802,315) :- not remove_reaction(802,315).
catalyst(811,315) :- not remove_reaction(811,315).
catalyst(812,315) :- not remove_reaction(812,315).
catalyst(831,315) :- not remove_reaction(831,315).
catalyst(832,315) :- not remove_reaction(832,315).
catalyst(841,315) :- not remove_reaction(841,315).
catalyst(842,315) :- not remove_reaction(842,315).
catalyst(861,315) :- not remove_reaction(861,315).
catalyst(862,315) :- not remove_reaction(862,315).
catalyst(901,315) :- not remove_reaction(901,315).
catalyst(902,315) :- not remove_reaction(902,315).
catalyst(1170,306).
catalyst(1210,306).
catalyst(690,299).
catalyst(730,299).
...
catalyst(1511,243).
catalyst(1512,243).
catalyst(771,209) :- not remove_reaction(771,209).
catalyst(772,209) :- not remove_reaction(772,209).
...
catalyst(791,208) :- not remove_reaction(791,208).
catalyst(792,208) :- not remove_reaction(792,208).
catalyst(801,208) :- not remove_reaction(801,208).
catalyst(802,208) :- not remove_reaction(802,208).
catalyst(811,208) :- not remove_reaction(811,208).
catalyst(812,208) :- not remove_reaction(812,208).
catalyst(831,208) :- not remove_reaction(831,208).
catalyst(832,208) :- not remove_reaction(832,208).
catalyst(841,208) :- not remove_reaction(841,208).
catalyst(842,208) :- not remove_reaction(842,208).
catalyst(861,208) :- not remove_reaction(861,208).
catalyst(862,208) :- not remove_reaction(862,208).
catalyst(901,208) :- not remove_reaction(901,208).
catalyst(902,208) :- not remove_reaction(902,208).
catalyst(6600,205).
catalyst(620,201).
catalyst(540,186).
catalyst(2660,158).
...
modifiable_enzyme(666).
modifiable_enzyme(667).
modifiable_enzyme(417).
modifiable_enzyme(453).
modifiable_enzyme(307).
modifiable_enzyme(843).
modifiable_enzyme(674).
modifiable_enzyme(315).
modifiable_enzyme(209).
modifiable_enzyme(208).
