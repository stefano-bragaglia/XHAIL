...
component("YNL280C",743).
component("YLR056W",629).
component("YGR060W",440).
component("YGL012W",408).
component("YKR009C",612).
component("YOL086C",774).
component("YMR303C",712).
component("YMR083W",687).
component("YGL256W",432).
component("YDL168W",268).
component("YBR145W",202).
component("YPL231W",847).
component("U46_",111).
component("YBR149W",203).
component("YBR149W",204).
component("YJR159W",581).
component("YGL001C",405).
component("YIL094C",515).
component("YHR063C",488).
component("YBR153W",205).
component("YML056C",672).
component("YLR432W",665).
component("YHR216W",505).
component("YAR075W",164).
component("YAR073W",163).
component("YCL030C",229).
component("YDR127W",298).
component("YJR139C",575).
component("YOL126C",779).
component("YKL085W",591).
component("YDL078C",249).
component("YKL029C",586).
component("YOR136W",791).
component("YNL037C",717).
component("YDL066W",248).
component("YNL241C",733).
component("YOL059W",772).
component("YDL022W",242).
component("YLR355C",661).
component("YIL074C",513).
component("YER081W",375).
component("YML054C",671).
component("YDL174C",270).
component("YML086C",675).
component("YIL155C",521).
component("YPR191W",883).
component("YOR065W",785).
component("YJL166W",550).
component("YHR001W-A",477).
component("YGR183C",455).
component("YFR033C",401).
component("YDR529C",344).
component("YBL045C",170).
component("Q0105",18).
component("YGR088W",443).
component("YDR256C",313).
component("YKL026C",585).
component("YIR037W",531).
component("YBR244W",217).
component("YJR078W",566).
component("YJR025C",558).
component("YGR255C",467).
component("U108_",22).
component("YBL098W",174).
component("YMR015C",684).
component("YHR007C",478).
component("YDR402C",333).
component("YGL055W",415).
component("YGR175C",452).
component("YJR104C",569).
component("YHR008C",479).
component("YJL026W",533).
component("YIL066C",512).
component("YGR180C",454).
component("YER070W",372).
component("U38_",106).
component("U36_",105).
component("U35_",104).
component("YDL168W",269).
component("YDR158W",306).
component("YBR006W",177).
component("YPL276W",859).
component("YPL275W",858).
component("YOR388C",824).
component("YOR374W",821).
component("YER073W",373).
component("U68_",127).
component("YGL154C",423).
component("U55_",120).
component("YOR323C",813).
component("YMR170C",696).
component("YMR169C",695).
component("U2_",100).
component("YER178W",388).
component("YBR221C",215).
component("YIL125W",519).
component("U52_",117).
component("YBR166C",208).
component("YNL280C",744).
component("YGL012W",409).
component("U57_",122).
component("YKL216W",609).
component("YDR044W",286).
component("YER014W",357).
component("YKR009C",613).
component("YIL160C",523).
component("YGL205W",426).
component("YMR118C",692).
component("YLR164W",642).
component("YLL041C",622).
component("YKL148C",598).
component("YKL141W",596).
component("YJL045W",534).
component("YDR178W",307).
component("YJR051W",561).
component("YEL047C",351).
component("YDL215C",274).
component("YOR375C",822).
component("YDL215C",275).
component("YAL062W",161).
component("U99_",155).
component("YBR035C",187).
component("YMR189W",698).
component("U56_",121).
component("YHR037W",485).
component("YKR080W",617).
component("YER023W",359).
component("YPL023C",828).
component("YGL125W",420).
component("YOR236W",806).
component("YGR204W",459).
component("YLR142W",637).
component("U62_",125).
component("YKL150W",599).
component("YIL043C",509).
component("YHR042W",486).
component("YOR221C",804).
component("YML120C",678).
component("YKL192C",606).
component("YKL055C",588).
component("YER061C",368).
component("YGR234W",462).
component("YFR030W",400).
component("YPL017C",827).
component("YFL018C",392).
component("YDR353W",328).
component("YER042W",361).
component("YJR137C",574).
component("YPL266W",854).
component("YML110C",677).
component("YBR034C",186).
component("YPL273W",856).
component("YLL062C",625).
component("YDR410C",336).
component("U47_",112).
component("YER091C",380).
component("YJR073C",564).
component("YDR120C",296).
component("YDL033C",244).
component("YOL096C",775).
component("YLR172C",643).
component("YDR019C",282).
component("YBR176W",209).
component("YDR408C",335).
component("YMR120C",693).
component("YBL013W",165).
component("YKL024C",584).
component("YPR074C",872).
component("YBR117C",198).
component("YLR354C",660).
component("YGR043C",438).
component("YMR108W",690).
component("YCL009C",227).
component("YMR062C",686).
component("YNL071W",720).
component("YNR008W",751).
component("YIL160C",524).
component("YNL277W",742).
component("YFL017C",391).
component("YPL231W",848).
component("YER061C",369).
component("U86_",143).
component("YPL001W",826).
component("YDL052C",247).
component("U8_",147).
component("YDR148C",304).
component("YOR377W",823).
component("YGR177C",453).
component("YPL231W",849).
component("YGR147C",448).
component("YDL040C",245).
component("YPL028W",829).
component("YGL017W",410).
component("YPR001W",861).
component("YNR001C",749).
component("YDL182W",271).
component("YDL131W",259).
component("YNL117W",724).
component("YIR031C",529).
component("YOR321W",812).
component("YJR143C",576).
component("YGR199W",458).
component("YDR307W",322).
component("YDL095W",254).
component("YDL093W",253).
component("YAL023C",158).
component("YNL029C",716).
component("YIL085C",514).
component("YMR261C",706).
component("YML100W",676).
component("YBR126C",201).
component("YNL192W",732).
component("YBR038W",189).
component("YBR023C",185).
component("YMR306W",714).
component("YLR342W",658).
component("YGR032W",436).
component("YLR209C",644).
component("U104_",21).
component("YOR209C",802).
component("YMR300C",711).
component("YER055C",364).
component("YDR354W",329) :- not remove_orf("YDR354W",329).
component("YFR047C",402).
component("YJR133W",573).
component("YLR209C",645).
component("YML022W",668).
component("YDR441C",339).
component("YDR399W",331).
component("YPR176C",880).
component("YPL172C",839).
component("YNR041C",757).
component("YMR101C",688).
component("YDL090C",252).
component("YBR003W",176).
component("YBR002C",175).
component("YJL167W",551).
component("YNL256W",736).
component("YDR127W",299).
component("YLR303W",652).
component("YGR012W",434).
component("YJR130C",572).
component("YLR303W",653).
component("YDR035W",284).
component("YBR249C",218).
component("YOR274W",808).
component("YOL143C",781).
component("YBR256C",220).
component("YHR137W",497).
component("YGL202W",425).
component("YLR027C",626).
component("YKL106W",593).
component("YKL104C",592).
component("YGR019W",435).
component("YLR089C",632).
component("U64_",126).
component("U61_",124).
component("U51_",116).
component("YJR148W",577).
component("YHR208W",503).
component("YOR184W",797).
component("YNR058W",760).
component("YIL116W",518).
component("YGL253W",431).
component("YFR053C",403).
component("YOL136C",780).
component("YIL107C",516).
component("YMR013C",683).
component("YMR205C",699).
component("YGR240C",463).
component("YDR248C",312).
component("YCR036W",238).
component("YGR194C",457).
component("YCL040W",231).
component("YJR105W",570).
component("U16_",54).
component("U15_",48).
component("YPL188W",841).
component("YJR049C",560).
component("YEL041W",349).
component("U96_",153).
component("YKL001C",582).
component("YDR236C",310).
component("YML070W",674).
component("YFL053W",395).
component("YHL032C",475).
component("YLR133W",634).
component("YDR531W",346).
component("U83_",141).
component("U82_",140).
component("U81_",139).
component("YMR208W",700).
component("YPL203W",842).
component("YOR061W",784).
component("YKL166C",601).
component("YJL164C",549).
component("YIL035C",508).
component("YHR205W",502).
component("YHR102W",495).
component("YGL019W",411).
component("YHR025W",484).
component("YOR347C",818).
component("YAL038W",160).
component("YNR012W",752).
component("YPR121W",876).
component("YPL258C",851).
component("YOL055C",768).
component("YPL214C",845).
component("U1_",77).
component("YDR009W",281).
component("YBR020W",183).
component("YNL267W",740).
component("YLR305C",655).
component("YFR019W",398).
component("YDR208W",308).
component("YDR127W",300).
component("U21_",87).
component("U20_",84).
component("YDR147W",303).
component("YDR300C",321).
component("YCR012W",233).
component("YER052C",362).
component("U18_",69).
component("U17_",62).
component("U76_",135).
component("YMR220W",702).
component("YER170W",387).
component("YDR226W",309).
component("YKL067W",590).
component("YOL055C",769).
component("YDR454C",340).
component("YJR057W",562).
component("YOL061W",773).
component("YKL181W",602).
component("YHL011C",472).
component("YER099C",382).
component("YBL068W",173).
component("YOR143C",793).
component("YNL256W",737).
component("YLR328W",656).
component("YBR018C",179).
component("YBR018C",180).
component("YGR007W",433).
component("YLR328W",657).
component("YKR002W",611).
component("YDL103C",257).
component("U94_",152).
component("YJR010W",557).
component("YGL130W",421).
component("YDR530C",345).
component("YCL050C",232).
component("YPR190C",882).
component("YPR187W",881).
component("YPR110C",874).
component("YPR010C",864).
component("YOR341W",817).
component("YOR340C",816).
component("YOR224C",805).
component("YOR210W",803).
component("YOR207C",800).
component("YOR151C",794).
component("YOR116C",788).
component("YOL005C",762).
component("YNR003C",750).
component("YNL248C",735).
component("YNL151C",729).
component("YNL113W",723).
component("YKL144C",597).
component("YJR063W",563).
component("YJL148W",546).
component("YJL140W",545).
component("YIL021W",507).
component("YHR143W-A",498).
component("YGL070C",418).
component("YFL036W",394).
component("YDR404C",334).
component("YDR156W",305).
component("YDR045C",287).
component("YDL150W",266).
component("YDL140C",261).
component("YBR154C",207).
component("YPR175W",879).
component("YPL167C",838).
component("YOR330C",814).
component("YOL115W",778).
component("YNL299W",746).
component("YNL262W",739).
component("YNL102W",722).
component("YJR043C",559).
component("YJR006W",556).
component("YJL090C",538).
component("YIL139C",520).
component("YEL055C",352).
component("YDR419W",337).
component("YDR121W",297).
component("YDL102W",256).
component("YCR014C",234).
component("YBR278W",222).
component("YBL035C",167).
component("YKL035W",587).
component("YHL012W",473).
component("YHR123W",496).
component("YPR113W",875).
component("YBR243C",216).
component("YNL130C",725).
component("YDL142C",265).
component("YPL148C",836).
component("YER026C",360).
component("YCL004W",226).
component("YGR286C",471).
component("YJL068C",535).
component("YDR058C",291).
component("YNR034W",756).
component("YHR163W",500).
component("YGR248W",465).
component("YCR073W-A",239).
component("YDL086W",251).
component("YOL011W",764).
component("YMR008C",681).
component("YMR006C",680).
component("U101_",19).
component("YBL015W",166).
component("YJL068C",536).
component("YPL072W",832).
component("YOR124C",789).
component("YNL186W",731).
component("YMR304W",713).
component("YMR223W",703).
component("YKR098C",620).
component("YJL197W",552).
component("YIL156W",522).
component("YFR010W",397).
component("YER151C",385).
component("YER144C",384).
component("YER098W",381).
component("YDR069C",292).
component("YDL122W",258).
component("YBR058C",190).
component("YBL067C",172).
component("YDR272W",316).
component("U84_",142).
component("YLR377C",663).
component("YDR074W",293).
component("YPL179W",840).
component("YNR032W",754).
component("YML057W",673).
component("YML016C",667).
component("YLR433C",666).
component("YGR123C",446).
component("YER133W",383).
component("YER089C",378).
component("YDR436W",338).
component("YDR075W",294).
component("YDL188C",272).
component("YDL134C",260).
component("YDL047W",246).
component("YDL006W",240).
component("YBR125C",200).
component("YBL056W",171).
component("YPR073C",870).
component("YHR215W",504).
component("YDL024C",243).
component("YBR093C",196).
component("YBR092C",195).
component("YAR071W",162).
component("YIL053W",511).
component("YER062C",370).
component("YHR046C",487).
component("U9_",156).
component("YGR208W",461).
component("YPL228W",846).
component("YMR180C",697).
component("YDL236W",277).
component("YJL155C",548).
component("YPR073C",871).
component("YOR208W",801).
component("YNL053W",719).
component("YMR036C",685).
component("YIR026C",526).
component("YIL113W",517).
component("YFR028C",399).
component("YER075C",374).
component("YDL230W",276).
component("YBR276C",221).
component("U34_",103).
component("U33_",102).
component("U30_",101).
component("U28_",99).
...
component("U25_",97).
component("U24_",96).
component("YPL268W",855).
component("YOR360C",820).
component("YGL248W",430).
component("YKR031C",614).
component("YPL206C",843).
component("YGL027C",413).
component("YLR286C",650).
component("YJR153W",579).
component("YBR184W",210).
component("YOR190W",798).
component("YLR300W",651).
component("YGR282C",470).
component("YDR261C",314).
component("YDR400W",332).
component("U23_",95).
component("YML035C",669).
component("YJL070C",537).
component("YBR284W",223).
component("U102_",20).
component("YNL045W",718).
component("YLR160C",641).
component("YLR158C",640).
component("YLR157C",639).
component("YLR155C",638).
component("YDR321W",323).
component("YGL037C",414).
component("YMR293C",710).
component("YDR242W",311).
component("YBR208C",212).
component("YMR281W",709).
component("U53_",118).
component("YIR027C",527).
component("YPL111W",835).
component("YIR032C",530).
component("YIR029W",528).
component("YPR062W",869).
component("YMR120C",694).
component("YLR028C",627).
component("YHR144C",499).
component("YGR267C",469).
component("YNL141W",726).
component("YBR153W",206).
component("YDL238C",278).
component("YNL141W",727).
component("YLR245C",648).
component("YML035C",670).
component("YBR084W",193).
component("YJL126W",541).
component("U44_",110).
component("YDL100C",255).
component("U87_",144).
component("U40_",108).
component("YMR267W",707).
component("YBR011C",178).
component("YBR111C",197).
component("YBR252W",219).
component("YCL030C",230).
component("YER005W",356).
component("YIL048W",510).
component("YER166W",386).
component("YDR093W",295).
component("YAL026C",159).
component("YLR231C",646).
component("U88_",145).
component("YLR134W",635).
component("YLR044C",628).
component("YGR087C",442).
component("YDR380W",330).
component("YDL080C",250).
component("U98_",154).
component("YMR250W",705).
component("YKL184W",605).
component("YNR043W",758).
component("U93_",151).
component("YDR047W",289).
component("U54_",119).
component("YKL211C",607) :- not remove_orf("YKL211C",607).
component("YKR097W",619).
component("YOL052C",767).
component("YNL169C",730).
component("YGR170W",450).
component("YKL060C",589).
component("YNL256W",738).
component("YDR294C",318).
component("YEL046C",350).
component("YNR033W",755).
component("YPR006C",863).
component("YER065C",371).
component("YKL211C",608) :- not remove_orf("YKL211C",608).
component("YER090W",608) :- not remove_orf("YER090W",608).
component("YER090W",379) :- not remove_orf("YER090W",379).
component("YDR127W",301).
component("YPL281C",860).
component("YOR393W",825).
component("YMR323W",715).
component("YHR174W",501).
component("YGR254W",466).
component("YPL262W",852).
component("YGL026C",412) :- not remove_orf("YGL026C",412).
component("YGR155W",449).
component("YLR304C",654).
component("YJL200C",553).
component("YNL316C",747).
component("YKL182W",603).
component("YPL212C",844).
component("YNL292W",745).
component("YGL063W",417).
component("YFL001W",389).
component("YOR278W",809).
component("YPR002W",862).
component("U49_",113).
component("YDR127W",302).
component("YGL148W",422).
component("YIL168W",525).
component("YER086W",376).
component("YLR359W",662).
component("YAL012W",157).
component("YFR055W",404).
component("YJL005W",532).
component("YOR176W",796).
component("YJL121C",540).
component("YBR019C",181).
component("YBR019C",182).
component("YDR050C",290).
component("YDR007W",280) :- not remove_orf("YDR007W",280).
component("YOR095C",787).
component("YER003C",355).
component("YBR196C",211).
component("YGL001C",406).
component("U14_",41).
component("YOL056W",770).
component("YKL152C",600).
component("YDL021W",241).
component("YMR105C",689).
component("YKL127W",594).
component("YEL058W",353).
component("YPR060C",868).
component("YHR072W",489).
component("YJL153C",547).
component("YPL097W",833).
component("YGR185C",456).
component("YGR264C",468).
component("YGR171C",451).
component("YHR011W",480).
component("YDR023W",283).
component("YPL104W",834).
component("YLL018C",621).
component("YPR081C",873).
component("YBR121C",199).
component("YHR020W",483).
component("YER087W",377).
component("YNL247W",734).
component("YOL033W",766).
component("YGL245W",429).
component("YHR091C",491).
component("YDR341C",324).
component("YOL097C",776).
component("YDR268W",315).
component("YPR047W",867).
component("YLR060W",630).
component("YFL022C",393).
component("YPR033C",865).
component("YHR019C",481).
component("YCR024C",235).
component("YHR019C",482).
component("YPL160W",837).
component("YLR382C",664).
component("YNL073W",721).
component("YDR037W",285).
component("YOR335C",815).
component("YGR094W",444).
component("YOR317W",811).
component("YMR246W",704).
component("YIL009W",506).
component("YER015W",358).
component("YOR142W",792).
component("YGR244C",464).
component("YPR035W",866).
component("U89_",146).
component("YOR241W",807).
component("YMR113W",691).
component("YKL132C",595).
component("YJL101C",539).
component("U92_",150).
component("YGL234W",427).
component("U91_",149).
component("U90_",148).
component("YDL141W",262).
component("YDL141W",263).
component("YGL234W",428).
component("YDL141W",264).
component("YJR103W",568).
component("YBL039C",168).
component("YGR204W",460).
component("YBR084W",194).
component("YOL058W",771).
component("YBR208C",213).
component("YHR074W",490).
component("YMR217W",701).
component("YGR061C",441).
component("YPR145W",878).
component("YGR124W",447).
component("YOR303W",810).
component("YJR109C",571).
component("YJL130C",543).
component("YGL062W",416).
component("YBR218C",214).
component("YPL231W",850).
component("YNR016C",753).
component("YKL182W",604).
component("YGR037C",437).
component("YOR005C",783).
component("YDL164C",267).
component("YOL010W",763).
component("YPR138C",877).
component("YPL274W",857).
component("YPL265W",853).
component("YPL057C",831).
component("YPL036W",830).
component("YOR348C",819).
component("YOR192C",799).
component("YOR171C",795).
component("YOR130C",790).
component("YOR071C",786).
component("YOL156W",782).
component("YOL103W",777).
component("YOL020W",765) :- not remove_orf("YOL020W",765).
component("YNR072W",761).
component("YNR056C",759).
component("YNL318C",748).
component("YNL268W",741).
component("YNL142W",728).
component("YMR272C",708).
component("YMR011W",682).
component("YML123C",679).
component("YLR348C",659).
component("YLR260W",649).
component("YLR237W",647).
component("YLR138W",636).
component("YLR100C",633).
component("YLR081W",631).
component("YLL061W",624).
component("YLL043W",623).
component("YKR093W",618).
component("YKR053C",616).
component("YKR039W",615) :- not remove_orf("YKR039W",615).
component("YKL217W",610).
component("YKL004W",583).
component("YJR158W",580).
component("YJR152W",578).
component("YJR095W",567).
component("YJR077C",565).
component("YJL219W",555).
component("YJL214W",554).
component("YJL134W",544).
component("YJL129C",542).
component("YHR096C",494).
component("YHR094C",493).
component("YHR092C",492).
component("YHL036W",476).
component("YHL016C",474).
component("YGR121C",445).
component("YGR055W",439).
component("YGL186C",424).
component("YGL077C",419).
component("YGL008C",407).
component("YFL055W",396).
component("YFL011W",390).
component("YER060W-A",367).
component("YER060W",366).
component("YER056C",365).
component("YER053C",363).
component("YEL069C",354).
component("YEL017C-A",348).
component("YDR536W",347).
component("YDR508C",343).
component("YDR503C",342).
component("YDR497C",341).
component("YDR345C",327).
component("YDR343C",326).
component("YDR342C",325).
component("YDR297W",320).
component("YDR294C",319).
component("YDR284C",317).
component("YDR046C",288) :- not remove_orf("YDR046C",288).
component("YDL245C",279).
component("YDL210W",273).
component("YCR032W",237).
component("YCR024C-A",236).
component("YCL025C",228).
component("YBR298C",225).
component("YBR291C",224).
component("YBR069C",192) :- not remove_orf("YBR069C",192).
component("YBR068C",191) :- not remove_orf("YBR068C",191).
component("YBR036C",188).
component("YBR021W",184).
component("YBL042C",169).
component("U7_",138).
component("U79_",137).
component("U78_",136).
component("U75_",134).
...
catalyst(6160,711).
catalyst(3870,364).
catalyst(3620,329) :- not remove_reaction(3620,329).
catalyst(2110,402).
catalyst(2190,402).
catalyst(5550,573).
catalyst(5791,645).
...
catalyst(1960,289).
catalyst(3460,119).
catalyst(3600,607) :- not remove_reaction(3600,607).
catalyst(8000,619).
catalyst(3941,767).
catalyst(3942,767).
catalyst(6890,730).
...
catalyst(8020,863).
catalyst(8020,371).
catalyst(1890,608) :- not remove_reaction(1890,608).
catalyst(3630,608) :- not remove_reaction(3630,608).
catalyst(1890,379) :- not remove_reaction(1890,379).
catalyst(3630,379) :- not remove_reaction(3630,379).
catalyst(3740,301).
catalyst(8231,860).
catalyst(8232,860).
catalyst(8231,825).
...
catalyst(8051,852).
catalyst(8052,852).
catalyst(3590,412) :- not remove_reaction(3590,412).
catalyst(10910,412) :- not remove_reaction(10910,412).
catalyst(4570,449).
catalyst(8181,654).
catalyst(8182,654).
catalyst(8181,553).
...
catalyst(8281,290).
catalyst(8282,290).
catalyst(3610,280) :- not remove_reaction(3610,280).
catalyst(7921,787).
catalyst(7922,787).
catalyst(7841,355).
catalyst(7842,355).
...
catalyst(1210,782).
catalyst(1160,777).
catalyst(801,765) :- not remove_reaction(801,765).
catalyst(802,765) :- not remove_reaction(802,765).
catalyst(811,765) :- not remove_reaction(811,765).
catalyst(812,765) :- not remove_reaction(812,765).
catalyst(831,765) :- not remove_reaction(831,765).
catalyst(832,765) :- not remove_reaction(832,765).
catalyst(901,765) :- not remove_reaction(901,765).
catalyst(902,765) :- not remove_reaction(902,765).
catalyst(941,765) :- not remove_reaction(941,765).
catalyst(942,765) :- not remove_reaction(942,765).
catalyst(1210,761).
catalyst(700,759).
catalyst(1200,748).
catalyst(761,741).
...
catalyst(640,618).
catalyst(6560,616).
catalyst(761,615) :- not remove_reaction(761,615).
catalyst(762,615) :- not remove_reaction(762,615).
catalyst(771,615) :- not remove_reaction(771,615).
catalyst(772,615) :- not remove_reaction(772,615).
catalyst(781,615) :- not remove_reaction(781,615).
catalyst(782,615) :- not remove_reaction(782,615).
catalyst(791,615) :- not remove_reaction(791,615).
catalyst(792,615) :- not remove_reaction(792,615).
catalyst(801,615) :- not remove_reaction(801,615).
catalyst(802,615) :- not remove_reaction(802,615).
catalyst(811,615) :- not remove_reaction(811,615).
catalyst(812,615) :- not remove_reaction(812,615).
catalyst(821,615) :- not remove_reaction(821,615).
catalyst(822,615) :- not remove_reaction(822,615).
catalyst(831,615) :- not remove_reaction(831,615).
catalyst(832,615) :- not remove_reaction(832,615).
catalyst(841,615) :- not remove_reaction(841,615).
catalyst(842,615) :- not remove_reaction(842,615).
catalyst(861,615) :- not remove_reaction(861,615).
catalyst(862,615) :- not remove_reaction(862,615).
catalyst(881,615) :- not remove_reaction(881,615).
catalyst(882,615) :- not remove_reaction(882,615).
catalyst(901,615) :- not remove_reaction(901,615).
catalyst(902,615) :- not remove_reaction(902,615).
catalyst(911,615) :- not remove_reaction(911,615).
catalyst(912,615) :- not remove_reaction(912,615).
catalyst(921,615) :- not remove_reaction(921,615).
catalyst(922,615) :- not remove_reaction(922,615).
catalyst(941,615) :- not remove_reaction(941,615).
catalyst(942,615) :- not remove_reaction(942,615).
catalyst(1191,615) :- not remove_reaction(1191,615).
catalyst(1192,615) :- not remove_reaction(1192,615).
catalyst(1021,610).
catalyst(1022,610).
catalyst(6610,583).
catalyst(1210,580).
...
catalyst(6550,319).
catalyst(6690,317).
catalyst(791,288) :- not remove_reaction(791,288).
catalyst(792,288) :- not remove_reaction(792,288).
...
catalyst(861,288) :- not remove_reaction(861,288).
catalyst(862,288) :- not remove_reaction(862,288).
catalyst(901,288) :- not remove_reaction(901,288).
catalyst(902,288) :- not remove_reaction(902,288).
catalyst(1210,279).
catalyst(690,273).
catalyst(730,273).
catalyst(431,237).
...
catalyst(1511,224).
catalyst(1512,224).
catalyst(771,192) :- not remove_reaction(771,192).
catalyst(772,192) :- not remove_reaction(772,192).
...
catalyst(791,191) :- not remove_reaction(791,191).
catalyst(792,191) :- not remove_reaction(792,191).
catalyst(801,191) :- not remove_reaction(801,191).
catalyst(802,191) :- not remove_reaction(802,191).
catalyst(811,191) :- not remove_reaction(811,191).
catalyst(812,191) :- not remove_reaction(812,191).
catalyst(831,191) :- not remove_reaction(831,191).
catalyst(832,191) :- not remove_reaction(832,191).
catalyst(841,191) :- not remove_reaction(841,191).
catalyst(842,191) :- not remove_reaction(842,191).
catalyst(861,191) :- not remove_reaction(861,191).
catalyst(862,191) :- not remove_reaction(862,191).
catalyst(901,191) :- not remove_reaction(901,191).
catalyst(902,191) :- not remove_reaction(902,191).
catalyst(6600,188).
catalyst(620,184).
catalyst(540,169).
catalyst(6960,138).
...
modifiable_enzyme(607).
modifiable_enzyme(608).
modifiable_enzyme(379).
modifiable_enzyme(412).
modifiable_enzyme(280).
modifiable_enzyme(765).
modifiable_enzyme(615).
modifiable_enzyme(288).
modifiable_enzyme(192).
modifiable_enzyme(191).
