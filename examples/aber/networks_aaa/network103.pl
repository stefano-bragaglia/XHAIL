...
component("YNL280C",580).
component("YGR060W",344).
component("YGL012W",319).
component("YKR009C",477).
component("YOL086C",603).
component("YMR303C",554).
component("YGL256W",337).
component("YDL168W",209).
component("YBR145W",161).
component("YPL231W",658).
component("U46_",89).
component("YBR149W",162).
component("YJR159W",451).
component("YGL001C",316).
component("YIL094C",396).
component("YHR063C",379).
component("YBR153W",163).
component("YML056C",526).
component("YLR432W",522).
component("YHR216W",390).
component("YAR075W",131).
component("YAR073W",130).
component("YDR127W",232).
component("YJR139C",448).
component("YOL126C",607).
component("YDL078C",195).
component("YKL029C",455).
component("YOR136W",617).
component("YNL037C",558).
component("YDL066W",194).
component("YLR355C",519).
component("YML086C",528).
component("YIL155C",402).
component("YPR191W",686).
component("YOR065W",612).
component("YJL166W",426).
component("YHR001W-A",371).
component("YGR183C",355).
component("YFR033C",312).
component("YDR529C",267).
component("YBL045C",137).
component("Q0105",18).
component("YGR088W",346).
component("YDR256C",246).
component("YKL026C",454).
component("YIR037W",409).
component("YBR244W",172).
component("YJR078W",439).
component("YJR025C",433).
component("YGR255C",364).
component("U108_",22).
component("YBL098W",140).
component("YMR015C",534).
component("YDR402C",259).
component("YGL055W",324).
component("YGR175C",352).
component("YJR104C",442).
component("YHR008C",372).
component("YJL026W",410).
component("YGR180C",354).
component("YER070W",288).
component("U35_",85).
component("YDL168W",210).
component("YDR158W",240).
component("YPL276W",667).
component("YPL275W",666).
component("YOR388C",644).
component("YOR374W",641).
component("YER073W",289).
component("YGL154C",330).
component("U55_",96).
component("YOR323C",633).
component("YMR170C",542).
component("YMR169C",541).
component("U2_",82).
component("YBR221C",171).
component("YIL125W",400).
component("U52_",93).
component("YBR166C",166).
component("YNL280C",581).
component("YGL012W",320).
component("U57_",97).
component("YDR044W",223).
component("YER014W",276).
component("YKR009C",478).
component("YIL160C",404).
component("YGL205W",333).
component("YMR118C",539).
component("YLR164W",503).
component("YLL041C",486).
component("YKL148C",465).
component("YKL141W",463).
component("YJL045W",411).
component("YDR178W",241).
component("YJR051W",435).
component("YEL047C",271).
component("YOR375C",642).
component("YDL215C",213).
component("YAL062W",128).
component("U99_",124).
component("YBR035C",149).
component("YHR037W",376).
component("YKR080W",482).
component("YER023W",277).
component("YOR236W",630).
component("YGR204W",357).
component("YLR142W",498).
component("U62_",100).
component("YKL150W",466).
component("YIL043C",392).
component("YHR042W",377).
component("YOR221C",628).
component("YKL192C",472).
component("YKL055C",457).
component("YER061C",285).
component("YFR030W",311).
component("YPL017C",647).
component("YFL018C",303).
component("YER042W",279).
component("YJR137C",447).
component("YPL266W",664).
component("YML110C",530).
component("YBR034C",148).
component("YPL273W",665).
component("YLL062C",489).
component("U47_",90).
component("YER091C",294).
component("YJR073C",437).
component("YDL033C",192).
component("YOL096C",604).
component("YLR172C",504).
component("YDR019C",219).
component("YDR408C",261).
component("YBL013W",132).
component("YKL024C",453).
component("YPR074C",678).
component("YBR117C",158).
component("YLR354C",518).
component("YGR043C",342).
component("YCL009C",181).
component("YMR062C",536).
component("YNL071W",561).
component("YNR008W",588).
component("YPL231W",659).
component("YER061C",286).
component("U86_",115).
component("YPL001W",646).
component("YDR148C",238).
component("YOR377W",643).
component("YGR177C",353).
component("YPL231W",660).
component("YGR147C",349).
component("YDL040C",193).
component("YPL028W",648).
component("YGL017W",321).
component("YPR001W",669).
component("YNR001C",586).
component("YDL182W",211).
component("YDL131W",202).
component("YNL117W",565).
component("YIR031C",407).
component("YDR307W",252).
component("YNL029C",557).
component("YIL085C",395).
component("YMR261C",549).
component("YML100W",529).
component("YBR126C",160).
component("YNL192W",572).
component("YBR038W",151).
component("YBR023C",147).
component("YLR209C",505).
component("U104_",21).
component("YOR209C",626).
component("YMR300C",553).
component("YER055C",281).
component("YDR354W",255) :- not remove_orf("YDR354W",255).
component("YFR047C",313).
component("YJR133W",446).
component("YLR209C",506).
component("YML022W",523).
component("YDR441C",263).
component("YDR399W",257).
component("YJL167W",427).
component("YNL256W",575).
component("YDR127W",233).
component("YLR303W",512).
component("YGR012W",339).
component("YJR130C",445).
component("YLR303W",513).
component("YDR035W",221).
component("YBR249C",173).
component("YOL143C",609).
component("YBR256C",174).
component("YHR137W",384).
component("YGL202W",332).
component("YLR027C",490).
component("YKL106W",460).
component("YKL104C",459).
component("YGR019W",340).
component("YLR089C",494).
component("U64_",101).
component("U61_",99).
component("U51_",92).
component("YJR148W",449).
component("YOR184W",621).
component("YIL116W",399).
component("YGL253W",336).
component("YFR053C",314).
component("YOL136C",608).
component("YIL107C",397).
component("YMR205C",544).
component("YGR240C",360).
component("YDR248C",245).
component("YCR036W",189).
component("YCL040W",184).
component("YJR105W",443).
component("U16_",43).
component("U15_",39).
component("U96_",122).
component("YKL001C",452).
component("YML070W",527).
component("YFL053W",306).
component("YHL032C",369).
component("U83_",113).
component("U82_",112).
component("U81_",111).
component("YMR208W",545).
component("YOR347C",638).
component("YAL038W",127).
component("YNR012W",589).
component("YPR121W",681).
component("YPL258C",662).
component("YOL055C",600).
component("U1_",63).
component("YDR009W",218).
component("YBR020W",145).
component("YNL267W",578).
component("YLR305C",515).
component("YFR019W",309).
component("YDR208W",242).
component("YDR127W",234).
component("U21_",72).
component("U20_",70).
component("YDR147W",237).
component("YDR300C",251).
component("YCR012W",186).
component("U18_",56).
component("U17_",50).
component("U76_",109).
component("YER170W",300).
component("YDR226W",243).
component("YKL067W",458).
component("YDR454C",264).
component("YOL061W",602).
component("YKL181W",468).
component("YHL011C",367).
component("YER099C",296).
component("YBL068W",139).
component("YOR143C",619).
component("YBR018C",142).
component("YGR007W",338).
component("YLR328W",516).
component("YKR002W",476).
component("YDL103C",200).
component("YJR010W",432).
component("YCL050C",185).
component("YPR190C",685).
component("YPR187W",684).
component("YPR110C",680).
component("YPR010C",671).
component("YOR341W",637).
component("YOR340C",636).
component("YOR224C",629).
component("YOR210W",627).
component("YOR207C",624).
component("YOR151C",620).
component("YOR116C",615).
component("YOL005C",595).
component("YNR003C",587).
component("YNL248C",574).
component("YNL151C",569).
component("YNL113W",564).
component("YKL144C",464).
component("YJR063W",436).
component("YJL148W",423).
component("YJL140W",422).
component("YIL021W",391).
component("YHR143W-A",385).
component("YGL070C",327).
component("YFL036W",305).
component("YDR404C",260).
component("YDR156W",239).
component("YDR045C",224).
component("YDL150W",207).
component("YDL140C",203).
component("YBR154C",165).
component("YPR175W",683).
component("YPL167C",655).
component("YOR330C",634).
component("YOL115W",606).
component("YNL299W",583).
component("YNL262W",577).
component("YNL102W",563).
component("YJR043C",434).
component("YJR006W",431).
component("YJL090C",415).
component("YIL139C",401).
component("YEL055C",272).
component("YDR419W",262).
component("YDR121W",231).
component("YDL102W",199).
component("YCR014C",187).
component("YBR278W",176).
component("YBL035C",134).
component("YKL035W",456).
component("YHL012W",368).
component("YHR123W",383).
component("YDL142C",206).
component("YER026C",278).
component("YCL004W",180).
component("YJL068C",412).
component("YDR058C",228).
component("YNR034W",592).
component("YHR163W",387).
component("YGR248W",362).
component("YCR073W-A",190).
component("YDL086W",197).
component("YOL011W",597).
component("YMR008C",533).
component("YMR006C",532).
component("U101_",19).
component("YBL015W",133).
component("YJL068C",413).
component("YPL072W",651).
component("YOR124C",616).
component("YNL186W",571).
component("YMR304W",555).
component("YMR223W",547).
component("YKR098C",484).
component("YJL197W",428).
component("YIL156W",403).
component("YFR010W",308).
component("YER151C",298).
component("YER144C",297).
component("YER098W",295).
component("YDR069C",229).
component("YDL122W",201).
component("YBR058C",152).
component("YBL067C",138).
component("YDR272W",248).
component("U84_",114).
component("YPR073C",676).
component("YHR215W",389).
component("YDL024C",191).
component("YBR093C",156).
component("YBR092C",155).
component("YAR071W",129).
component("YIL053W",394).
component("YER062C",287).
component("YHR046C",378).
component("YGR208W",359).
component("YPL228W",657).
component("YMR180C",543).
component("YDL236W",215).
component("YJL155C",425).
component("YPR073C",677).
component("YOR208W",625).
component("YNL053W",560).
component("YMR036C",535).
component("YIR026C",405).
component("YIL113W",398).
component("YFR028C",310).
component("YER075C",290).
component("YDL230W",214).
component("YBR276C",175).
component("U34_",84).
component("U30_",83).
component("U27_",81).
component("U25_",80).
component("U24_",79).
component("YOR360C",640).
component("YGL248W",335).
component("YKR031C",479).
component("YLR286C",510).
component("YJR153W",450).
component("YOR190W",622).
component("YLR300W",511).
component("YGR282C",366).
component("YDR261C",247).
component("YDR400W",258).
component("U23_",78).
component("YML035C",524).
component("YJL070C",414).
component("YBR284W",177).
component("U102_",20).
component("YNL045W",559).
component("YLR160C",502).
component("YLR158C",501).
component("YLR157C",500).
component("YLR155C",499).
component("YDR321W",253).
component("YGL037C",323).
component("YDR242W",244).
component("YBR208C",168).
component("YMR281W",552).
component("U53_",94).
component("YIR032C",408).
component("YIR029W",406).
component("YPR062W",675).
component("YMR120C",540).
component("YHR144C",386).
component("YGR267C",365).
component("YNL141W",566).
component("YBR153W",164).
component("YDL238C",216).
component("YNL141W",567).
component("YLR245C",509).
component("YML035C",525).
component("YJL126W",418).
component("U44_",88).
component("YDL100C",198).
component("U87_",116).
component("YMR267W",550).
component("YBR011C",141).
component("YBR111C",157).
component("YCL030C",183).
component("YER005W",275).
component("YIL048W",393).
component("YER166W",299).
component("YDR093W",230).
component("YAL026C",126).
component("YLR231C",507).
component("U88_",117).
component("YLR134W",496).
component("YLR044C",491).
component("YGR087C",345).
component("YDR380W",256).
component("YDL080C",196).
component("U98_",123).
component("YMR250W",548).
component("YKL184W",471).
component("YNR043W",593).
component("U93_",121).
component("YDR047W",226).
component("U54_",95).
component("YKL211C",473) :- not remove_orf("YKL211C",473).
component("YNL169C",570).
component("YGR170W",351).
component("YNL256W",576).
component("YDR294C",249).
component("YEL046C",270).
component("YNR033W",591).
component("YKL211C",474) :- not remove_orf("YKL211C",474).
component("YER090W",474) :- not remove_orf("YER090W",474).
component("YER090W",293) :- not remove_orf("YER090W",293).
component("YDR127W",235).
component("YPL281C",668).
component("YOR393W",645).
component("YMR323W",556).
component("YHR174W",388).
component("YGR254W",363).
component("YGL026C",322) :- not remove_orf("YGL026C",322).
component("YGR155W",350).
component("YLR304C",514).
component("YJL200C",429).
component("YNL316C",584).
component("YKL182W",469).
component("YPL212C",656).
component("YNL292W",582).
component("YGL063W",326).
component("YFL001W",301).
component("YPR002W",670).
component("YDR127W",236).
component("YGL148W",329).
component("YER086W",291).
component("YLR359W",520).
component("YAL012W",125).
component("YFR055W",315).
component("YJL121C",417).
component("YBR019C",143).
component("YBR019C",144).
component("YDR050C",227).
component("YDR007W",217) :- not remove_orf("YDR007W",217).
component("YOR095C",614).
component("YER003C",274).
component("YBR196C",167).
component("YGL001C",317).
component("U14_",33).
component("YKL152C",467).
component("YMR105C",537).
component("YKL127W",461).
component("YEL058W",273).
component("YPR060C",674).
component("YHR072W",380).
component("YJL153C",424).
component("YPL097W",652).
component("YGR185C",356).
component("YHR011W",373).
component("YDR023W",220).
component("YPL104W",653).
component("YLL018C",485).
component("YPR081C",679).
component("YBR121C",159).
component("YHR020W",375).
component("YER087W",292).
component("YNL247W",573).
component("YOL033W",599).
component("YHR091C",382).
component("YDR341C",254).
component("YOL097C",605).
component("YPR047W",673).
component("YLR060W",492).
component("YFL022C",304).
component("YPR033C",672).
component("YHR019C",374).
component("YPL160W",654).
component("YLR382C",521).
component("YNL073W",562).
component("YDR037W",222).
component("YOR335C",635).
component("YGR094W",347).
component("YOR142W",618).
component("YGR244C",361).
component("U89_",118).
component("YOR241W",631).
component("YMR113W",538).
component("YKL132C",462).
component("YJL101C",416).
component("U92_",120).
component("YGL234W",334).
component("U91_",119).
component("YDL141W",204).
component("YDL141W",205).
component("YJR103W",441).
component("YBL039C",135).
component("YGR204W",358).
component("YOL058W",601).
component("YBR208C",169).
component("YHR074W",381).
component("YMR217W",546).
component("YOR303W",632).
component("YJR109C",444).
component("YJL130C",420).
component("YGL062W",325).
component("YBR218C",170).
component("YPL231W",661).
component("YNR016C",590).
component("YKL182W",470).
component("YGR037C",341).
component("YOR005C",611).
component("YDL164C",208).
component("YOL010W",596).
component("YPR138C",682).
component("YPL265W",663).
component("YPL057C",650).
component("YPL036W",649).
component("YOR348C",639).
component("YOR192C",623).
component("YOR071C",613).
component("YOL156W",610).
component("YOL020W",598) :- not remove_orf("YOL020W",598).
component("YNR056C",594).
component("YNL318C",585).
component("YNL268W",579).
component("YNL142W",568).
component("YMR272C",551).
component("YML123C",531).
component("YLR348C",517).
component("YLR237W",508).
component("YLR138W",497).
component("YLR100C",495).
component("YLR081W",493).
component("YLL061W",488).
component("YLL043W",487).
component("YKR093W",483).
component("YKR053C",481).
component("YKR039W",480) :- not remove_orf("YKR039W",480).
component("YKL217W",475).
component("YJR095W",440).
component("YJR077C",438).
component("YJL219W",430).
component("YJL134W",421).
component("YJL129C",419).
component("YHL036W",370).
component("YGR121C",348).
component("YGR055W",343).
component("YGL186C",331).
component("YGL077C",328).
component("YGL008C",318).
component("YFL055W",307).
component("YFL011W",302).
component("YER060W-A",284).
component("YER060W",283).
component("YER056C",282).
component("YER053C",280).
component("YEL017C-A",269).
component("YDR536W",268).
component("YDR508C",266).
component("YDR503C",265).
component("YDR294C",250).
component("YDR046C",225) :- not remove_orf("YDR046C",225).
component("YDL210W",212).
component("YCR024C-A",188).
component("YCL025C",182).
component("YBR298C",179).
component("YBR291C",178).
component("YBR069C",154) :- not remove_orf("YBR069C",154).
component("YBR068C",153) :- not remove_orf("YBR068C",153).
component("YBR036C",150).
component("YBR021W",146).
component("YBL042C",136).
component("U79_",110).
component("U75_",108).
component("U74_",107).
component("U73_",106).
...
catalyst(6160,553).
catalyst(3870,281).
catalyst(3620,255) :- not remove_reaction(3620,255).
catalyst(2110,313).
catalyst(2190,313).
catalyst(5550,446).
catalyst(5791,506).
...
catalyst(1960,226).
catalyst(3460,95).
catalyst(3600,473) :- not remove_reaction(3600,473).
catalyst(6890,570).
catalyst(6900,351).
catalyst(2570,576).
catalyst(8781,249).
...
catalyst(4560,270).
catalyst(2550,591).
catalyst(1890,474) :- not remove_reaction(1890,474).
catalyst(3630,474) :- not remove_reaction(3630,474).
catalyst(1890,293) :- not remove_reaction(1890,293).
catalyst(3630,293) :- not remove_reaction(3630,293).
catalyst(3740,235).
catalyst(8231,668).
catalyst(8232,668).
catalyst(8231,645).
...
catalyst(8231,363).
catalyst(8232,363).
catalyst(3590,322) :- not remove_reaction(3590,322).
catalyst(10910,322) :- not remove_reaction(10910,322).
catalyst(4570,350).
catalyst(8181,514).
catalyst(8182,514).
catalyst(8181,429).
...
catalyst(8281,227).
catalyst(8282,227).
catalyst(3610,217) :- not remove_reaction(3610,217).
catalyst(7921,614).
catalyst(7922,614).
catalyst(7841,274).
catalyst(7842,274).
...
catalyst(190,613).
catalyst(1200,610).
catalyst(801,598) :- not remove_reaction(801,598).
catalyst(802,598) :- not remove_reaction(802,598).
catalyst(811,598) :- not remove_reaction(811,598).
catalyst(812,598) :- not remove_reaction(812,598).
catalyst(831,598) :- not remove_reaction(831,598).
catalyst(832,598) :- not remove_reaction(832,598).
catalyst(901,598) :- not remove_reaction(901,598).
catalyst(902,598) :- not remove_reaction(902,598).
catalyst(941,598) :- not remove_reaction(941,598).
catalyst(942,598) :- not remove_reaction(942,598).
catalyst(700,594).
catalyst(1200,585).
catalyst(761,579).
catalyst(762,579).
...
catalyst(640,483).
catalyst(6560,481).
catalyst(761,480) :- not remove_reaction(761,480).
catalyst(762,480) :- not remove_reaction(762,480).
catalyst(771,480) :- not remove_reaction(771,480).
catalyst(772,480) :- not remove_reaction(772,480).
catalyst(781,480) :- not remove_reaction(781,480).
catalyst(782,480) :- not remove_reaction(782,480).
catalyst(791,480) :- not remove_reaction(791,480).
catalyst(792,480) :- not remove_reaction(792,480).
catalyst(801,480) :- not remove_reaction(801,480).
catalyst(802,480) :- not remove_reaction(802,480).
catalyst(811,480) :- not remove_reaction(811,480).
catalyst(812,480) :- not remove_reaction(812,480).
catalyst(821,480) :- not remove_reaction(821,480).
catalyst(822,480) :- not remove_reaction(822,480).
catalyst(831,480) :- not remove_reaction(831,480).
catalyst(832,480) :- not remove_reaction(832,480).
catalyst(841,480) :- not remove_reaction(841,480).
catalyst(842,480) :- not remove_reaction(842,480).
catalyst(861,480) :- not remove_reaction(861,480).
catalyst(862,480) :- not remove_reaction(862,480).
catalyst(881,480) :- not remove_reaction(881,480).
catalyst(882,480) :- not remove_reaction(882,480).
catalyst(901,480) :- not remove_reaction(901,480).
catalyst(902,480) :- not remove_reaction(902,480).
catalyst(911,480) :- not remove_reaction(911,480).
catalyst(912,480) :- not remove_reaction(912,480).
catalyst(941,480) :- not remove_reaction(941,480).
catalyst(942,480) :- not remove_reaction(942,480).
catalyst(1191,480) :- not remove_reaction(1191,480).
catalyst(1192,480) :- not remove_reaction(1192,480).
catalyst(1021,475).
catalyst(1022,475).
catalyst(1250,440).
catalyst(1581,438).
...
catalyst(791,154) :- not remove_reaction(791,154).
catalyst(792,154) :- not remove_reaction(792,154).
...
catalyst(861,154) :- not remove_reaction(861,154).
catalyst(862,154) :- not remove_reaction(862,154).
