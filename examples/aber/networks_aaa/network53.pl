...
component("YGR060W",220).
component("YGL012W",205).
component("YOL086C",375).
component("YMR303C",345).
component("YGL256W",215).
component("YDL168W",135).
component("YBR145W",103).
component("YPL231W",413).
component("YGL001C",202).
component("YML056C",327).
component("YLR432W",324).
component("YHR216W",247).
component("YAR075W",87).
component("YAR073W",86).
component("YDR127W",150).
component("YJR139C",283).
component("YOR136W",383).
component("YDL066W",128).
component("YIL155C",254).
component("YPR191W",435).
component("YOR065W",379).
component("YJL166W",268).
component("YHR001W-A",237).
component("YGR183C",227).
component("YFR033C",199).
component("YDR529C",175).
component("YBL045C",91).
component("Q0105",18).
component("YJR078W",276).
component("YJR025C",271).
component("YBL098W",93).
component("YMR015C",332).
component("YDR402C",168).
component("YJR104C",279).
component("YHR008C",238).
component("YER070W",186).
component("U35_",53).
component("YDL168W",136).
component("YPL276W",421).
component("YPL275W",420).
component("YOR388C",403).
component("YGL154C",212).
component("U55_",60).
component("YOR323C",395).
component("YMR170C",340).
component("YMR169C",339).
component("YBR166C",106).
component("YNL280C",360).
component("YER014W",182).
component("YMR118C",337).
component("YLR164W",311).
component("YLL041C",306).
component("YKL148C",293).
component("YJL045W",258).
component("YDR178W",156).
component("YJR051W",273).
component("YEL047C",179).
component("YOR375C",402).
component("YDL215C",138).
component("YAL062W",85).
component("U99_",81).
component("YBR035C",96).
component("YKR080W",304).
component("YER023W",183).
component("YOR236W",392).
component("YGR204W",228).
component("U62_",62).
component("YKL150W",294).
component("YIL043C",249).
component("YHR042W",239).
component("YPL017C",406).
component("YFL018C",193).
component("YPL273W",419).
component("YLL062C",307).
component("U47_",55).
component("YDL033C",126).
component("YKL024C",286).
component("YPR074C",428).
component("YBR117C",102).
component("YCL009C",117).
component("YMR062C",334).
component("YPL231W",414).
component("YPL001W",405).
component("YPL231W",415).
component("YGR147C",224).
component("YDL040C",127).
component("YPL028W",407).
component("YPR001W",423).
component("YNR001C",364).
component("YDL182W",137).
component("YNL117W",352).
component("YIR031C",256).
component("YNL029C",347).
component("YIL085C",251).
component("YLR209C",312).
component("YMR300C",344).
component("YER055C",185).
component("YDR354W",164) :- not remove_orf("YDR354W",164).
component("YFR047C",200).
component("YJR133W",282).
component("YML022W",325).
component("YDR441C",171).
component("YDR399W",166).
component("YNL256W",357).
component("YDR127W",151).
component("YLR303W",318).
component("YJR130C",281).
component("YLR303W",319).
component("YDR035W",143).
component("YBR249C",110).
component("YBR256C",111).
component("YHR137W",242).
component("YGL202W",213).
component("YLR027C",308).
component("YKL106W",289).
component("YKL104C",288).
component("YGR019W",217).
component("U64_",63).
component("U51_",57).
component("YJR148W",284).
component("YGL253W",214).
component("YFR053C",201).
component("YMR205C",342).
component("YGR240C",229).
component("YDR248C",159).
component("YCR036W",124).
component("YCL040W",119).
component("YJR105W",280).
component("U16_",31).
component("U15_",28).
component("U96_",79).
component("YKL001C",285).
component("YML070W",328).
component("YFL053W",195).
component("YHL032C",235).
component("U83_",74).
component("U82_",73).
component("YMR208W",343).
component("YOR347C",400).
component("YAL038W",84).
component("YPR121W",430).
component("YPL258C",417).
component("YOL055C",372).
component("U1_",40).
component("YNL267W",359).
component("YLR305C",321).
component("YFR019W",197).
component("YDR208W",157).
component("YDR127W",152).
component("U21_",45).
component("U20_",44).
component("YDR300C",162).
component("YCR012W",121).
component("U18_",37).
component("U76_",71).
component("YER170W",191).
component("YDR226W",158).
component("YDR454C",172).
component("YOL061W",374).
component("YKL181W",295).
component("YHL011C",233).
component("YER099C",189).
component("YBL068W",92).
component("YOR143C",384).
component("YGR007W",216).
component("YLR328W",322).
component("YCL050C",120).
component("YPR190C",434).
component("YPR187W",433).
component("YPR110C",429).
component("YPR010C",424).
component("YOR341W",399).
component("YOR340C",398).
component("YOR224C",391).
component("YOR210W",390).
component("YOR207C",388).
component("YOR151C",385).
component("YOR116C",382).
component("YOL005C",369).
component("YNR003C",365).
component("YNL248C",356).
component("YNL151C",355).
component("YNL113W",351).
component("YKL144C",292).
component("YJR063W",274).
component("YJL148W",266).
component("YJL140W",265).
component("YIL021W",248).
component("YHR143W-A",243).
component("YGL070C",210).
component("YFL036W",194).
component("YDR404C",169).
component("YDR156W",155).
component("YDR045C",144).
component("YDL150W",133).
component("YDL140C",132).
component("YBR154C",105).
component("YPR175W",432).
component("YPL167C",410).
component("YOR330C",396).
component("YOL115W",377).
component("YNL299W",362).
component("YNL262W",358).
component("YNL102W",350).
component("YJR043C",272).
component("YJR006W",270).
component("YJL090C",260).
component("YIL139C",253).
component("YEL055C",180).
component("YDR419W",170).
component("YDR121W",149).
component("YDL102W",131).
component("YCR014C",122).
component("YBR278W",113).
component("YBL035C",89).
component("YKL035W",287).
component("YHL012W",234).
component("YER026C",184).
component("YDR058C",147).
component("YDL086W",130).
component("YOL011W",370).
component("YMR008C",331).
component("YMR006C",330).
component("U101_",19).
component("YBL015W",88).
component("U84_",75).
component("YPR073C",426).
component("YHR215W",246).
component("YDL024C",125).
component("YBR093C",100).
component("YBR092C",99).
component("YPL228W",412).
component("YMR180C",341).
component("YDL236W",140).
component("YJL155C",267).
component("YPR073C",427).
component("YOR208W",389).
component("YNL053W",349).
component("YMR036C",333).
component("YIR026C",255).
component("YIL113W",252).
component("YFR028C",198).
component("YER075C",187).
component("YDL230W",139).
component("YBR276C",112).
component("U34_",52).
component("U30_",51).
component("U25_",50).
component("U24_",49).
component("YOR360C",401).
component("YKR031C",301).
component("YLR286C",316).
component("YOR190W",386).
component("YLR300W",317).
component("YGR282C",232).
component("YDR261C",160).
component("YDR400W",167).
component("YML035C",326).
component("YJL070C",259).
component("YBR284W",114).
component("YNL045W",348).
component("YGL037C",207).
component("YBR208C",107).
component("U53_",58).
component("YIR032C",257).
component("YMR120C",338).
component("YHR144C",244).
component("YBR153W",104).
component("YDL238C",141).
component("YNL141W",353).
component("YLR245C",315).
component("YJL126W",262).
component("YBR111C",101).
component("YER005W",181).
component("YIL048W",250).
component("YER166W",190).
component("YDR093W",148).
component("YAL026C",83).
component("YLR231C",313).
component("U88_",76).
component("YLR134W",310).
component("YLR044C",309).
component("YGR087C",221).
component("YDR380W",165).
component("YDL080C",129).
component("U98_",80).
component("YKL184W",298).
component("YNR043W",368).
component("U93_",78).
component("U54_",59).
component("YKL211C",299) :- not remove_orf("YKL211C",299).
component("YGR170W",226).
component("YDR294C",161).
component("YEL046C",178).
component("YNR033W",367).
component("YKL211C",300) :- not remove_orf("YKL211C",300).
...
component("YOR393W",404).
component("YMR323W",346).
component("YHR174W",245).
component("YGR254W",231).
component("YGL026C",206) :- not remove_orf("YGL026C",206).
component("YGR155W",225).
component("YLR304C",320).
component("YJL200C",269).
component("YNL316C",363).
component("YKL182W",296).
component("YPL212C",411).
component("YNL292W",361).
component("YGL063W",209).
component("YFL001W",192).
component("YDR127W",154).
component("YGL148W",211).
component("YAL012W",82).
component("YBR019C",94).
component("YDR050C",146).
component("YDR007W",142) :- not remove_orf("YDR007W",142).
component("YOR095C",381).
component("YGL001C",203).
component("YMR105C",335).
component("YKL127W",290).
component("YPR060C",425).
component("YPL104W",409).
component("YLL018C",305).
component("YHR091C",241).
component("YDR341C",163).
component("YOL097C",376).
component("YOR335C",397).
component("YGR094W",222).
component("YGR244C",230).
component("U89_",77).
component("YOR241W",393).
component("YMR113W",336).
component("YKL132C",291).
component("YJL101C",261).
component("YJR103W",278).
component("YBL039C",90).
component("YOL058W",373).
component("YBR208C",108).
component("YHR074W",240).
component("YOR303W",394).
...
component("YOR005C",378).
component("YDL164C",134).
component("YPR138C",431).
component("YPL265W",418).
component("YPL036W",408).
component("YOR192C",387).
component("YOR071C",380).
component("YOL020W",371) :- not remove_orf("YOL020W",371).
component("YNL142W",354).
component("YML123C",329).
component("YLR348C",323).
component("YLR237W",314).
component("YKR053C",303).
component("YKR039W",302) :- not remove_orf("YKR039W",302).
component("YJR095W",277).
component("YJR077C",275).
component("YJL134W",264).
component("YJL129C",263).
component("YHL036W",236).
...
component("YBR291C",115).
component("YBR069C",98) :- not remove_orf("YBR069C",98).
component("YBR068C",97) :- not remove_orf("YBR068C",97).
component("YBR021W",95).
component("U79_",72).
component("U75_",70).
component("U74_",69).
component("U73_",68).
...
catalyst(2300,78).
catalyst(3460,59).
catalyst(3600,299) :- not remove_reaction(3600,299).
catalyst(6900,226).
catalyst(8781,161).
catalyst(8782,161).
catalyst(4560,178).
...
catalyst(190,314).
catalyst(6560,303).
catalyst(771,302) :- not remove_reaction(771,302).
catalyst(772,302) :- not remove_reaction(772,302).
catalyst(781,302) :- not remove_reaction(781,302).
catalyst(782,302) :- not remove_reaction(782,302).
...
catalyst(881,302) :- not remove_reaction(881,302).
catalyst(882,302) :- not remove_reaction(882,302).
catalyst(1191,302) :- not remove_reaction(1191,302).
catalyst(1192,302) :- not remove_reaction(1192,302).
catalyst(1250,277).
catalyst(1581,275).
catalyst(1582,275).
catalyst(6560,264).
...
catalyst(1501,115).
catalyst(1502,115).
catalyst(771,98) :- not remove_reaction(771,98).
catalyst(772,98) :- not remove_reaction(772,98).
...
catalyst(801,97) :- not remove_reaction(801,97).
catalyst(802,97) :- not remove_reaction(802,97).
catalyst(811,97) :- not remove_reaction(811,97).
catalyst(812,97) :- not remove_reaction(812,97).
catalyst(831,97) :- not remove_reaction(831,97).
catalyst(832,97) :- not remove_reaction(832,97).
catalyst(841,97) :- not remove_reaction(841,97).
catalyst(842,97) :- not remove_reaction(842,97).
catalyst(620,95).
catalyst(2830,72).
catalyst(2920,70).
catalyst(2920,69).
