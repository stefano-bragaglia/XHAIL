...
component("YNL280C",819).
component("YLR056W",688).
component("YGR060W",483).
component("YGL012W",448).
component("YKR009C",670).
component("YOL086C",851).
component("YMR303C",786).
component("YMR083W",755).
component("YGL256W",475).
...
component("YJR159W",636).
component("YGL001C",445).
component("YIL094C",563).
component("YHR063C",535).
component("YBR153W",223).
component("YML056C",737).
component("YLR432W",729).
component("YHR216W",553).
component("YAR075W",181).
component("YAR073W",180).
component("YCL030C",249).
component("YDR127W",329).
component("YJR139C",630).
component("YOL126C",856).
component("YKL085W",646).
component("YDL078C",274).
component("YKL029C",641).
component("YOR136W",872).
component("YNL037C",791).
component("YDL066W",272).
component("YNL241C",809).
component("YOL059W",849).
component("YDL022W",265).
component("YLR355C",724).
component("YIL074C",561).
component("YER081W",412).
component("YML054C",736).
component("YDL174C",296).
component("YML086C",740).
component("YIL155C",570).
component("YPR191W",969).
component("YOR065W",863).
component("YJL166W",601).
component("YHR001W-A",523).
component("YGR183C",499).
component("YFR033C",441).
component("YDR529C",377).
component("YBL045C",187).
component("Q0105",18).
component("YGR088W",486).
component("YDR256C",345).
component("YKL026C",640).
component("YIR037W",581).
component("YBR244W",235).
component("YJR078W",621).
component("U58_",136).
component("YJR025C",613).
component("YGR255C",511).
component("U108_",25).
component("YBL098W",191).
component("YMR015C",751).
component("YHR007C",524).
component("YDR402C",365).
component("YGL055W",455).
component("YGR175C",496).
component("YJR104C",624).
component("YHR008C",525).
component("YJL026W",584).
component("YIL066C",560).
component("YGR180C",498).
...
component("YPL276W",944).
component("YPL275W",943).
component("YOR388C",908).
component("YOR374W",905).
component("YER073W",410).
component("U68_",142).
component("YGL154C",464).
component("U55_",133).
component("YOR323C",895).
component("YMR170C",766).
component("YMR169C",765).
component("U2_",112).
component("YER178W",426).
component("YBR221C",233).
component("YIL125W",568).
component("U52_",130).
component("YBR166C",226).
component("YNL280C",820).
component("YGL012W",449).
component("YKL182W",658).
component("U57_",135).
component("YKL216W",667).
component("YDR044W",313).
component("YER014W",393).
component("YKR009C",671).
component("YIL160C",572).
component("YGL205W",469).
component("YMR118C",760).
component("YLR164W",701).
component("YLL041C",680).
component("YKL148C",653).
component("YKL141W",651).
component("YJL045W",585).
component("YDR178W",339).
component("YJR051W",616).
component("YEL047C",387).
component("YDL215C",300).
component("YOR375C",906).
component("YDL215C",301).
component("YAL062W",177).
component("U99_",171).
component("YBR035C",204).
component("YMR189W",768).
component("U56_",134).
component("YHR037W",531).
component("YKR080W",675).
component("YER023W",395).
component("YPL023C",912).
component("YGL125W",461).
component("YOR236W",887).
component("YGR204W",503).
component("YLR142W",696).
component("U63_",140).
component("U62_",139).
component("YOR356W",903).
component("YKL150W",654).
component("YIL043C",557).
component("YHR042W",532).
component("YOR221C",885).
component("YML120C",744).
component("YKL192C",662).
component("YKL055C",643).
component("YER061C",404).
component("YMR145C",763).
component("YML120C",745).
component("YKL192C",663).
component("YDL085W",276).
component("YGR234W",506).
component("YFR030W",440).
component("YPL017C",911).
component("YFL018C",431).
component("YPL091W",917).
component("YDR353W",360).
component("YER042W",397).
component("YJR137C",629).
component("YNL052W",793).
component("YMR256C",777).
component("YLR395C",728).
component("YLR038C",686).
component("YIL111W",565).
component("YHR051W",534).
component("YGL191W",467).
component("YGL187C",466).
component("YDL067C",273).
component("Q0275",20).
component("Q0250",19).
component("YPL266W",939).
component("YML110C",743).
component("YBR034C",203).
component("YPL273W",941).
component("YLL062C",683).
component("YDR410C",368).
component("U47_",125).
component("YER091C",417).
component("YJR073C",619).
component("YDR120C",327).
component("YDL033C",267).
component("YOL096C",852).
component("YLR172C",702).
component("YDR019C",309).
component("YBR176W",227).
component("YDR408C",367).
component("YMR120C",761).
component("YBL013W",182).
component("YKL024C",639).
component("YPR074C",958).
component("YBR117C",216).
component("YLR354C",723).
component("YGR043C",481).
component("YMR108W",758).
component("YCL009C",247).
component("YMR062C",754).
component("YNL071W",795).
component("YNR008W",827).
component("YIL160C",573).
component("YNL277W",818).
component("YFL017C",430).
component("YPL231W",933).
component("YER061C",405).
component("U86_",159).
component("YPL001W",910).
component("YMR296C",784).
component("YDR062W",321).
component("YDL052C",270).
component("U8_",163).
component("YDR148C",335).
component("YOR377W",907).
component("YGR177C",497).
component("YPL231W",934).
component("YGR147C",492).
component("YDL040C",268).
component("YPL028W",913).
component("YLR195C",703).
component("YGL017W",450).
component("YPR001W",946).
component("YNR001C",825).
component("YCR005C",254).
component("YNL104C",798).
component("YDL182W",297).
component("YDL131W",285).
component("YNL117W",800).
component("YIR031C",579).
component("YOR321W",894).
component("YJR143C",631).
component("YGR199W",502).
component("YDR307W",354).
component("YDL095W",280).
component("YDL093W",279).
component("YAL023C",174).
component("YOR103C",867).
component("YOR085W",865).
component("YMR149W",764).
component("YML019W",732).
component("YJL002C",582).
component("YEL002C",381).
component("YDL232W",303).
component("YCL043C",252).
component("YNL029C",790).
component("YIL085C",562).
component("YMR261C",778).
component("YML100W",741).
component("YBR126C",219).
component("YNL192W",808).
component("YBR038W",206).
component("YBR023C",202).
component("YMR306W",788).
component("YLR342W",721).
component("YGR032W",479).
component("YLR209C",704).
component("U104_",23).
component("YMR271C",780).
component("YML106W",742).
component("YOR209C",883).
component("YMR300C",785).
component("YER055C",400).
component("YDR354W",361) :- not remove_orf("YDR354W",361).
component("YFR047C",442).
component("YJR133W",628).
component("YLR209C",705).
component("YML022W",733).
component("YDR441C",371).
component("YDR399W",363).
component("YPR176C",966).
component("YPL172C",924).
component("YNR041C",833).
component("YMR101C",756).
component("YDL090C",278).
component("YBR003W",193).
component("YBR002C",192).
component("YJL167W",602).
component("YJL167W",603).
component("YNL256W",812).
component("YPR069C",955).
component("YDR127W",330).
component("YLR303W",712).
component("YGR012W",477).
component("YJR130C",627).
component("YLR303W",713).
component("YDR035W",311).
component("YBR249C",236).
component("YOR274W",890).
component("YOL143C",859).
component("YBR256C",238).
component("YHR137W",544).
component("YGL202W",468).
component("YLR027C",684).
component("YKL106W",648).
component("YOL140W",858).
component("YKL104C",647).
component("YGR019W",478).
component("YLR089C",691).
component("U64_",141).
component("U61_",138).
component("U51_",129).
component("YJR148W",632).
component("YHR208W",551).
component("YFL030W",433).
component("YOR184W",878).
component("YNR058W",837).
component("YIL116W",567).
component("YGL253W",474).
component("YFR053C",443).
component("YOL136C",857).
component("YIL107C",564).
component("YMR013C",750).
component("YMR205C",770).
component("YGR240C",507).
component("YDR248C",344).
component("YCR036W",260).
component("YGR194C",501).
component("YCL040W",251).
component("YJR105W",625).
component("U16_",62).
component("U15_",56).
component("YPL188W",926).
component("YJR049C",615).
component("YEL041W",385).
component("U96_",169).
component("YKL001C",637).
component("YDR236C",342).
component("YML070W",739).
component("YFL053W",435).
component("YHL032C",521).
component("YLR133W",693).
component("YDR531W",379).
component("U83_",156).
component("U82_",155).
component("U81_",154).
component("YMR208W",771).
component("YPL203W",927).
component("YOR061W",862).
component("YKL166C",656).
component("YJL164C",600).
component("YIL035C",556).
component("YHR205W",550).
component("YHR102W",542).
component("YGL019W",451).
component("YHR025W",530).
component("YOR347C",901).
component("YAL038W",176).
component("YNR012W",828).
component("YPR121W",962).
component("YPL258C",936).
component("YOL055C",845).
component("YPL214C",930).
component("U1_",86).
component("YDR009W",308).
component("YBR020W",200).
component("YNL267W",816).
component("YLR305C",715).
component("YFR019W",438).
...
component("YER052C",398).
component("YER069W",408).
component("U19_",85).
component("U18_",77).
component("U17_",70).
component("U76_",150).
component("YMR220W",773).
component("YER170W",425).
component("YDR226W",341).
component("YKL067W",645).
component("YOL055C",846).
component("YDR454C",372).
component("YJR057W",617).
component("YOL061W",850).
component("YKL181W",657).
component("YHL011C",518).
component("YER099C",419).
component("YBL068W",190).
component("YOR143C",874).
component("YNL256W",813).
component("YLR328W",719).
component("YBR018C",196).
component("YBR018C",197).
component("YGR007W",476).
component("YLR328W",720).
component("YKR002W",669).
component("YDL103C",283).
component("U94_",168).
component("YJR010W",611).
component("YGL130W",462).
component("YDR530C",378).
component("YCL050C",253).
component("YPR190C",968).
component("YPR187W",967).
component("YPR110C",960).
component("YPR010C",949).
component("YOR341W",900).
component("YOR340C",899).
component("YOR224C",886).
component("YOR210W",884).
component("YOR207C",881).
component("YOR151C",875).
component("YOR116C",868).
component("YOL005C",839).
component("YNR003C",826).
component("YNL248C",811).
component("YNL151C",805).
component("YNL113W",799).
component("YKL144C",652).
component("YJR063W",618).
component("YJL148W",597).
component("YJL140W",596).
component("YIL021W",555).
component("YHR143W-A",545).
component("YGL070C",459).
component("YFL036W",434).
component("YDR404C",366).
component("YDR156W",336).
component("YDR045C",314).
component("YDL150W",292).
component("YDL140C",287).
component("YBR154C",225).
component("YPR175W",965).
component("YPL167C",923).
component("YOR330C",896).
component("YOL115W",855).
component("YNL299W",822).
component("YNL262W",815).
component("YNL102W",797).
component("YJR043C",614).
component("YJR006W",610).
component("YJL090C",589).
component("YIL139C",569).
component("YEL055C",388).
component("YDR419W",369).
component("YDR121W",328).
component("YDL102W",282).
component("YCR014C",256).
component("YBR278W",241).
component("YBL035C",184).
component("YKL035W",642).
component("YHL012W",519).
component("YHR123W",543).
component("YPR113W",961).
component("YBR243C",234).
component("YNL130C",801).
component("YDL142C",291).
component("YPL148C",921).
component("YER026C",396).
component("YCL004W",246).
component("YOR251C",889).
component("YGR286C",515).
component("YJL068C",586).
component("YDR058C",319).
component("YNR034W",832).
component("YHR163W",547).
component("YGR248W",509).
component("YCR073W-A",262).
component("YDL086W",277).
component("YOL011W",841).
component("YMR008C",748).
component("YMR006C",747).
component("U105_",24).
component("U101_",21).
component("YBL015W",183).
component("YJL068C",587).
component("YPL072W",916).
component("YOR124C",869).
component("YNL186W",807).
component("YMR304W",787).
component("YMR223W",774).
component("YKR098C",678).
component("YJL197W",604).
component("YIL156W",571).
component("YFR010W",437).
component("YER151C",423).
component("YER144C",422).
component("YER098W",418).
component("YDR069C",322).
component("YDL122W",284).
component("YBR058C",207).
component("YBL067C",189).
component("YDR272W",348).
component("U84_",157).
component("YDR481C",373).
component("YLR377C",726).
component("YDR074W",323).
component("YPL179W",925).
component("YNR032W",830).
component("YML057W",738).
component("YML016C",731).
component("YLR433C",730).
component("YGR123C",489).
component("YER133W",421).
component("YER089C",415).
component("YDR436W",370).
...
component("YPR073C",956).
component("YHR215W",552).
component("YDL024C",266).
component("YBR093C",214).
component("YBR092C",213).
component("YAR071W",179).
component("YIL053W",559).
component("YER062C",406).
component("YHR046C",533).
component("U9_",172).
component("YGR208W",505).
component("YPL228W",931).
component("YMR180C",767).
component("YDL236W",304).
component("YJL155C",599).
component("YPR073C",957).
component("YOR208W",882).
component("YNL053W",794).
component("YMR036C",753).
component("YIR026C",576).
component("YIL113W",566).
component("YFR028C",439).
component("YER075C",411).
...
component("U25_",109).
component("U24_",108).
component("YPL268W",940).
component("YOR360C",904).
component("YGL248W",473).
component("YKR031C",672).
component("YPL206C",928).
component("YGL027C",453).
component("YLR286C",710).
component("YJR153W",634).
component("YJL221C",609).
component("YJL216C",607).
component("YIL172C",575).
component("YGR292W",517).
component("YGR287C",516).
component("YBR299W",245).
component("YBR184W",228).
component("YOR190W",879).
component("YLR300W",711).
component("YGR282C",514).
component("YDR261C",346).
component("YDR400W",364).
component("U23_",107).
component("YML035C",734).
component("YJL070C",588).
component("YBR284W",242).
component("U102_",22).
component("YNL045W",792).
component("YLR160C",700).
component("YLR158C",699).
component("YLR157C",698).
component("YLR155C",697).
component("YDR321W",355).
component("YGL037C",454).
component("YMR293C",783).
component("YDR242W",343).
component("YLR308W",718).
component("YLR307W",717).
component("YBR208C",230).
component("YMR281W",782).
component("U53_",131).
component("YIR027C",577).
component("YPL111W",920).
component("YIR032C",580).
component("YIR029W",578).
component("YPR062W",954).
component("YMR120C",762).
component("YLR028C",685).
component("YHR144C",546).
component("YGR267C",513).
component("YNL141W",802).
component("YBR153W",224).
component("YDL238C",305).
component("YNL141W",803).
component("YLR245C",708).
component("YML035C",735).
component("YBR084W",211).
component("YJL126W",592).
component("U44_",123).
component("YDL100C",281).
component("U87_",160).
component("U40_",121).
component("YMR267W",779).
component("YBR011C",195).
component("YHR201C",549).
component("YBR111C",215).
component("YBR252W",237).
component("YCL030C",250).
component("YER005W",392).
component("YIL048W",558).
component("YER166W",424).
component("YDR093W",326).
component("YAL026C",175).
component("YLR231C",706).
component("U88_",161).
component("YLR134W",694).
component("YLR044C",687).
component("YGR087C",485).
component("YDR380W",362).
component("YDL080C",275).
component("U98_",170).
component("YMR250W",776).
component("YKL184W",661).
component("YOR128C",870).
component("YEL021W",384).
component("YNR043W",834).
component("U93_",167).
component("YDR047W",316).
component("U54_",132).
component("YKL211C",665) :- not remove_orf("YKL211C",665).
component("YKR097W",677).
component("YOL052C",844).
component("YNL169C",806).
component("YGR170W",494).
component("YKL060C",644).
component("YNL256W",814).
component("YDR294C",350).
component("YEL046C",386).
component("YNR033W",831).
component("YPR006C",948).
component("YER065C",407).
component("YKL211C",666) :- not remove_orf("YKL211C",666).
component("YER090W",666) :- not remove_orf("YER090W",666).
component("YER090W",416) :- not remove_orf("YER090W",416).
component("YDR127W",332).
component("YPL281C",945).
component("YOR393W",909).
component("YMR323W",789).
component("YHR174W",548).
component("YGR254W",510).
component("YPL262W",937).
component("YGL026C",452) :- not remove_orf("YGL026C",452).
component("YGR155W",493).
component("YLR304C",714).
component("YJL200C",605).
component("YNL316C",823).
component("YKL182W",659).
component("YPL212C",929).
component("YNL292W",821).
component("YGL063W",458).
component("YFL001W",428).
component("YOR278W",891).
component("YPR002W",947).
component("U49_",126).
component("YJR016C",612).
component("YCR053W",261).
component("YDR127W",333).
component("YGL148W",463).
component("YIL168W",574).
component("YER086W",413).
component("YLR359W",725).
component("YAL012W",173).
component("YFR055W",444).
component("YJL005W",583).
component("YOR176W",877).
component("YJL121C",591).
component("YBR019C",198).
component("YBR019C",199).
component("YDR050C",317).
component("YDR007W",307) :- not remove_orf("YDR007W",307).
component("YOR095C",866).
component("YER003C",391).
component("YBR196C",229).
component("YGL001C",446).
component("U14_",48).
component("YOL056W",847).
component("YKL152C",655).
component("YDL021W",264).
component("YMR105C",757).
component("YKL127W",649).
component("YEL058W",389).
component("YPR060C",953).
component("YHR072W",536).
component("YJL153C",598).
component("YPL097W",918).
component("YGR185C",500).
component("YGR264C",512).
component("YGR171C",495).
component("YHR011W",526).
component("YDR023W",310).
component("YPL104W",919).
component("YLL018C",679).
component("YPR081C",959).
component("YBR121C",217).
component("YHR020W",529).
component("YER087W",414).
component("YNL247W",810).
component("YOL033W",843).
component("YGL245W",472).
component("YHR091C",538).
component("YDR341C",356).
component("YOL097C",853).
component("YDR268W",347).
component("YPR047W",952).
component("YLR060W",689).
component("YFL022C",432).
component("YPR033C",950).
component("YHR019C",527).
component("YCR024C",257).
component("YHR019C",528).
component("YPL160W",922).
component("YLR382C",727).
component("YNL073W",796).
component("YDR037W",312).
component("YOR335C",897).
component("YGR094W",487).
component("YOR317W",893).
component("YMR246W",775).
component("YIL009W",554).
component("YER015W",394).
component("YOR142W",873).
component("YGR244C",508).
component("YPR035W",951).
component("U89_",162).
component("YOR241W",888).
component("YMR113W",759).
component("YKL132C",650).
component("YOR339C",898).
component("YMR022W",752).
component("YLR306W",716).
component("YKL210W",664).
component("YGR133W",491).
component("YGL058W",456).
component("YER100W",420).
component("YEL012W",382).
...
component("YJL101C",590).
component("U92_",166).
component("YAR015W",178).
component("YGL234W",470).
component("YER183C",427).
component("U91_",165).
component("U90_",164).
component("YNR057C",836).
component("YDL141W",288).
component("YDL141W",289).
component("YGL234W",471).
component("YDL141W",290).
component("YJR103W",623).
component("YBL039C",185).
component("YGR204W",504).
component("YBR084W",212).
component("YOL058W",848).
component("YBR208C",231).
component("YHR074W",537).
component("YMR217W",772).
component("YGR061C",484).
component("YPR145W",964).
component("YGR124W",490).
component("YOR303W",892).
component("YJR109C",626).
component("YJL130C",594).
component("YGL062W",457).
component("YBR218C",232).
component("YPL231W",935).
component("YNR016C",829).
component("YKL182W",660).
component("YGR037C",480).
component("YOR005C",861).
component("YDL164C",293).
component("YOL010W",840).
component("YPR138C",963).
component("YPL274W",942).
component("YPL265W",938).
component("YPL057C",915).
component("YPL036W",914).
component("YOR348C",902).
component("YOR192C",880).
component("YOR171C",876).
component("YOR130C",871).
component("YOR071C",864).
component("YOL156W",860).
component("YOL103W",854).
component("YOL020W",842) :- not remove_orf("YOL020W",842).
component("YNR072W",838).
component("YNR056C",835).
component("YNL318C",824).
component("YNL268W",817).
component("YNL142W",804).
component("YMR272C",781).
component("YMR202W",769).
component("YMR011W",749).
component("YML123C",746).
component("YLR348C",722).
component("YLR260W",709).
component("YLR237W",707).
component("YLR138W",695).
component("YLR100C",692).
component("YLR081W",690).
component("YLL061W",682).
component("YLL043W",681).
component("YKR093W",676).
component("YKR053C",674).
component("YKR039W",673) :- not remove_orf("YKR039W",673).
component("YKL217W",668).
component("YKL004W",638).
component("YJR158W",635).
component("YJR152W",633).
component("YJR095W",622).
component("YJR077C",620).
component("YJL219W",608).
component("YJL214W",606).
component("YJL134W",595).
component("YJL129C",593).
component("YHR096C",541).
component("YHR094C",540).
component("YHR092C",539).
component("YHL036W",522).
component("YHL016C",520).
component("YGR121C",488).
component("YGR055W",482).
component("YGL186C",465).
component("YGL077C",460).
component("YGL008C",447).
component("YFL055W",436).
component("YFL011W",429).
component("YER060W-A",403).
component("YER060W",402).
component("YER056C",401).
component("YER053C",399).
component("YEL069C",390).
component("YEL017C-A",383).
component("YDR536W",380).
component("YDR508C",376).
component("YDR503C",375).
component("YDR497C",374).
component("YDR345C",359).
component("YDR343C",358).
component("YDR342C",357).
component("YDR297W",352).
component("YDR294C",351).
component("YDR284C",349).
...
catalyst(6160,785).
catalyst(3870,400).
catalyst(3620,361) :- not remove_reaction(3620,361).
catalyst(2110,442).
catalyst(2190,442).
catalyst(5550,628).
catalyst(5791,705).
...
catalyst(1960,316).
catalyst(3460,132).
catalyst(3600,665) :- not remove_reaction(3600,665).
catalyst(8000,677).
catalyst(3941,844).
catalyst(3942,844).
catalyst(6890,806).
...
catalyst(8020,948).
catalyst(8020,407).
catalyst(1890,666) :- not remove_reaction(1890,666).
catalyst(3630,666) :- not remove_reaction(3630,666).
catalyst(1890,416) :- not remove_reaction(1890,416).
catalyst(3630,416) :- not remove_reaction(3630,416).
catalyst(3740,332).
catalyst(8231,945).
catalyst(8232,945).
catalyst(8231,909).
...
catalyst(8051,937).
catalyst(8052,937).
catalyst(3590,452) :- not remove_reaction(3590,452).
catalyst(10910,452) :- not remove_reaction(10910,452).
catalyst(4570,493).
catalyst(8181,714).
catalyst(8182,714).
catalyst(8181,605).
...
catalyst(1210,860).
catalyst(1160,854).
catalyst(801,842) :- not remove_reaction(801,842).
catalyst(802,842) :- not remove_reaction(802,842).
catalyst(811,842) :- not remove_reaction(811,842).
catalyst(812,842) :- not remove_reaction(812,842).
catalyst(831,842) :- not remove_reaction(831,842).
catalyst(832,842) :- not remove_reaction(832,842).
catalyst(901,842) :- not remove_reaction(901,842).
catalyst(902,842) :- not remove_reaction(902,842).
catalyst(941,842) :- not remove_reaction(941,842).
catalyst(942,842) :- not remove_reaction(942,842).
catalyst(1170,838).
catalyst(1210,838).
catalyst(700,835).
catalyst(1200,824).
...
catalyst(650,676).
catalyst(6560,674).
catalyst(761,673) :- not remove_reaction(761,673).
catalyst(762,673) :- not remove_reaction(762,673).
catalyst(771,673) :- not remove_reaction(771,673).
catalyst(772,673) :- not remove_reaction(772,673).
catalyst(781,673) :- not remove_reaction(781,673).
catalyst(782,673) :- not remove_reaction(782,673).
catalyst(791,673) :- not remove_reaction(791,673).
catalyst(792,673) :- not remove_reaction(792,673).
catalyst(801,673) :- not remove_reaction(801,673).
catalyst(802,673) :- not remove_reaction(802,673).
catalyst(811,673) :- not remove_reaction(811,673).
catalyst(812,673) :- not remove_reaction(812,673).
catalyst(821,673) :- not remove_reaction(821,673).
catalyst(822,673) :- not remove_reaction(822,673).
catalyst(831,673) :- not remove_reaction(831,673).
catalyst(832,673) :- not remove_reaction(832,673).
catalyst(841,673) :- not remove_reaction(841,673).
catalyst(842,673) :- not remove_reaction(842,673).
catalyst(861,673) :- not remove_reaction(861,673).
catalyst(862,673) :- not remove_reaction(862,673).
catalyst(881,673) :- not remove_reaction(881,673).
catalyst(882,673) :- not remove_reaction(882,673).
catalyst(901,673) :- not remove_reaction(901,673).
catalyst(902,673) :- not remove_reaction(902,673).
catalyst(911,673) :- not remove_reaction(911,673).
catalyst(912,673) :- not remove_reaction(912,673).
catalyst(921,673) :- not remove_reaction(921,673).
catalyst(922,673) :- not remove_reaction(922,673).
catalyst(941,673) :- not remove_reaction(941,673).
catalyst(942,673) :- not remove_reaction(942,673).
catalyst(1191,673) :- not remove_reaction(1191,673).
catalyst(1192,673) :- not remove_reaction(1192,673).
catalyst(1021,668).
catalyst(1022,668).
catalyst(6610,638).
catalyst(1170,635).
...
modifiable_enzyme(665).
modifiable_enzyme(666).
modifiable_enzyme(416).
modifiable_enzyme(452).
modifiable_enzyme(307).
modifiable_enzyme(842).
