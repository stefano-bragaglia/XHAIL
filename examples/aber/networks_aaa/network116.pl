...
component("YNL280C",643).
component("YLR056W",540).
component("YGR060W",381).
component("YGL012W",356).
component("YKR009C",524).
component("YOL086C",671).
component("YMR303C",614).
component("YMR083W",592).
...
component("YHR063C",421).
component("YBR153W",176).
component("YML056C",579).
component("YLR432W",573).
component("YHR216W",432).
component("YAR075W",140).
component("YAR073W",139).
component("YDR127W",257).
component("YJR139C",490).
component("YOL126C",676).
component("YDL078C",213).
component("YKL029C",500).
component("YOR136W",686).
component("YNL037C",618).
component("YDL066W",212).
component("YNL241C",633).
component("YOL059W",669).
component("YDL022W",207).
component("YLR355C",570).
component("YDL174C",232).
component("YML086C",582).
component("YIL155C",444).
component("YPR191W",762).
component("YOR065W",681).
component("YJL166W",468).
component("YHR001W-A",412).
component("YGR183C",393).
...
component("U17_",54).
component("U76_",116).
component("YMR220W",605).
component("YER170W",335).
component("YDR226W",268).
component("YKL067W",504).
component("YDR454C",294).
component("YOL061W",670).
component("YKL181W",514).
component("YHL011C",408).
component("YER099C",330).
component("YBL068W",149).
component("YOR143C",688).
component("YNL256W",637).
component("YLR328W",566).
component("YBR018C",152).
component("YBR018C",153).
component("YGR007W",375).
component("YLR328W",567).
component("YKR002W",523).
component("YDL103C",220).
component("YJR010W",474).
component("YDR530C",299).
component("YCL050C",199).
component("YPR190C",761).
component("YPR187W",760).
component("YPR110C",756).
component("YPR010C",747).
component("YOR341W",708).
component("YOR340C",707).
component("YOR224C",698).
component("YOR210W",696).
component("YOR207C",693).
component("YOR151C",689).
component("YOR116C",684).
component("YOL005C",660).
component("YNR003C",650).
component("YNL248C",635).
component("YNL151C",629).
component("YNL113W",624).
component("YKL144C",510).
component("YJR063W",478).
component("YJL148W",465).
component("YJL140W",464).
component("YIL021W",433).
component("YHR143W-A",427).
...
component("YPR175W",759).
component("YPL167C",727).
component("YOR330C",705).
component("YOL115W",675).
component("YNL299W",646).
component("YNL262W",639).
component("YNL102W",623).
component("YJR043C",476).
component("YJR006W",473).
component("YJL090C",457).
component("YIL139C",443).
...
component("YKL035W",501).
component("YHL012W",409).
component("YHR123W",425).
component("YBR243C",185).
component("YDL142C",227).
component("YER026C",311).
component("YCL004W",194).
component("YJL068C",454).
component("YDR058C",252).
component("YNR034W",656).
component("YHR163W",429).
component("YGR248W",403).
...
component("YPL072W",722).
component("YOR124C",685).
component("YNL186W",631).
component("YMR304W",615).
component("YMR223W",606).
component("YKR098C",531).
component("YJL197W",470).
...
component("YNR032W",654).
component("YML057W",580).
component("YML016C",575).
...
component("YPR073C",752).
component("YHR215W",431).
component("YDL024C",208).
component("YBR093C",168).
component("YBR092C",167).
component("YAR071W",138).
component("YIL053W",436).
component("YER062C",320).
component("YHR046C",420).
component("YGR208W",399).
component("YPL228W",731).
component("YMR180C",601).
component("YDL236W",239).
component("YJL155C",467).
component("YPR073C",753).
component("YOR208W",694).
component("YNL053W",620).
component("YMR036C",590).
component("YIR026C",447).
component("YIL113W",440).
...
component("YNL169C",630).
component("YGR170W",389).
component("YKL060C",503).
component("YNL256W",638).
component("YDR294C",276).
component("YEL046C",303).
component("YNR033W",655).
...
component("YJL121C",459).
component("YBR019C",154).
component("YBR019C",155).
component("YDR050C",251).
component("YDR007W",241) :- not remove_orf("YDR007W",241).
component("YOR095C",683).
component("YER003C",307).
component("YBR196C",180).
component("YGL001C",354).
component("U14_",35).
component("YOL056W",667).
component("YKL152C",513).
component("YDL021W",206).
component("YMR105C",593).
component("YKL127W",507).
component("YEL058W",306).
component("YPR060C",750).
component("YHR072W",422).
component("YJL153C",466).
component("YPL097W",723).
component("YGR185C",394).
component("YHR011W",415).
component("YDR023W",244).
component("YPL104W",724).
component("YLL018C",532).
component("YPR081C",755).
component("YBR121C",171).
component("YHR020W",417).
component("YER087W",325).
component("YNL247W",634).
component("YOL033W",664).
component("YHR091C",424).
component("YDR341C",282).
component("YOL097C",673).
component("YDR268W",274).
component("YPR047W",749).
component("YLR060W",541).
component("YFL022C",341).
component("YPR033C",748).
component("YHR019C",416).
component("YPL160W",726).
component("YLR382C",572).
component("YNL073W",622).
component("YDR037W",246).
component("YOR335C",706).
component("YGR094W",384).
component("YOR142W",687).
component("YGR244C",402).
component("U89_",125).
component("YOR241W",700).
component("YMR113W",595).
component("YKL132C",508).
component("YJL101C",458).
component("U92_",128).
component("YGL234W",371).
component("U91_",127).
component("U90_",126).
component("YDL141W",225).
component("YDL141W",226).
component("YJR103W",483).
component("YBL039C",144).
component("YGR204W",398).
component("YBR084W",166).
component("YOL058W",668).
component("YBR208C",182).
component("YHR074W",423).
component("YMR217W",604).
component("YOR303W",702).
component("YJR109C",486).
component("YJL130C",462).
...
component("YOR005C",680).
component("YDL164C",229).
component("YOL010W",661).
component("YPR138C",758).
component("YPL274W",741).
component("YPL265W",738).
component("YPL057C",721).
component("YPL036W",720).
component("YOR348C",710).
component("YOR192C",692).
component("YOR071C",682).
component("YOL156W",679).
component("YOL103W",674).
component("YOL020W",663) :- not remove_orf("YOL020W",663).
component("YNR056C",658).
component("YNL318C",648).
component("YNL268W",641).
component("YNL142W",628).
component("YMR272C",610).
component("YML123C",586).
component("YLR348C",568).
component("YLR237W",558).
component("YLR138W",547).
component("YLR100C",544).
component("YLR081W",542).
component("YLL061W",535).
component("YLL043W",534).
component("YKR093W",530).
component("YKR053C",528).
component("YKR039W",527) :- not remove_orf("YKR039W",527).
component("YKL217W",522).
component("YKL004W",497).
component("YJR152W",493).
component("YJR095W",482).
component("YJR077C",480).
component("YJL219W",472).
component("YJL134W",463).
component("YJL129C",461).
component("YHL036W",411).
component("YGR121C",385).
component("YGR055W",380).
...
catalyst(1200,679).
catalyst(1160,674).
catalyst(801,663) :- not remove_reaction(801,663).
catalyst(802,663) :- not remove_reaction(802,663).
catalyst(811,663) :- not remove_reaction(811,663).
catalyst(812,663) :- not remove_reaction(812,663).
catalyst(831,663) :- not remove_reaction(831,663).
catalyst(832,663) :- not remove_reaction(832,663).
catalyst(901,663) :- not remove_reaction(901,663).
catalyst(902,663) :- not remove_reaction(902,663).
catalyst(941,663) :- not remove_reaction(941,663).
catalyst(942,663) :- not remove_reaction(942,663).
catalyst(700,658).
catalyst(1200,648).
catalyst(761,641).
catalyst(762,641).
...
catalyst(640,530).
catalyst(6560,528).
catalyst(761,527) :- not remove_reaction(761,527).
catalyst(762,527) :- not remove_reaction(762,527).
...
catalyst(791,527) :- not remove_reaction(791,527).
catalyst(792,527) :- not remove_reaction(792,527).
...
catalyst(821,527) :- not remove_reaction(821,527).
catalyst(822,527) :- not remove_reaction(822,527).
...
catalyst(861,527) :- not remove_reaction(861,527).
catalyst(862,527) :- not remove_reaction(862,527).
...
catalyst(911,527) :- not remove_reaction(911,527).
catalyst(912,527) :- not remove_reaction(912,527).
catalyst(941,527) :- not remove_reaction(941,527).
catalyst(942,527) :- not remove_reaction(942,527).
