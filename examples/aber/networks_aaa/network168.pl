...
component("YNL280C",864).
component("YLR056W",726).
component("YGR060W",510).
component("YGL012W",475).
component("YKR009C",706).
component("YOL086C",899).
component("YMR303C",830).
component("YMR083W",799).
component("YGL256W",502).
component("YDL168W",315).
component("YBR145W",239).
component("YPL231W",984).
component("YBR265W",258).
component("U46_",136).
component("YBR149W",240).
component("YBR149W",241).
component("YJR159W",670).
component("YGL001C",472).
component("YIL094C",593).
component("YHR063C",564).
component("U45_",135).
component("YBR153W",242).
component("YML056C",780).
component("YLR432W",769).
component("YHR216W",583).
component("YAR075W",196).
component("YAR073W",195).
component("YCL030C",268).
component("YDR127W",352).
component("YJR139C",664).
component("YML075C",783).
component("YLR450W",772).
component("YOL126C",904).
component("YKL085W",680).
component("YDL078C",295).
component("YKL029C",675).
component("YOR136W",921).
component("YNL037C",835).
component("YDL066W",293).
component("YHR183W",578).
component("YGR256W",540).
component("YNL241C",854).
component("YOL059W",896).
component("YDL022W",286).
component("YLR355C",764).
component("YIL074C",591).
component("YER081W",438).
component("YML054C",779).
component("YDL174C",318).
component("YML086C",784).
component("YIL155C",601).
component("YPR191W",1024).
component("YOR065W",911).
component("YJL166W",635).
component("YHR001W-A",552).
component("YGR183C",527).
component("YFR033C",468).
component("YDR529C",402).
component("YBL045C",203).
component("Q0105",18).
component("YGR088W",513).
component("YDR256C",369).
component("YKL026C",674).
component("YIR037W",614).
component("YBR244W",254).
component("YJR078W",655).
component("U58_",148).
component("YJR025C",647).
component("YGR255C",539).
component("U108_",26).
component("YBL098W",207).
component("YMR015C",795).
component("YHR007C",553).
component("YDR402C",390).
component("YGL055W",482).
component("YGR175C",524).
component("YJR104C",658).
component("YHR008C",554).
component("YJL026W",617).
component("YIL066C",590).
component("YGR180C",526).
component("YER070W",435).
component("U38_",128).
component("U36_",127).
component("U35_",126).
component("YDL168W",316).
component("YDR158W",360).
component("YBR006W",210).
component("YPL276W",996).
component("YPL275W",995).
component("YOR388C",959).
component("YOR374W",956).
component("YER073W",436).
component("U68_",155).
component("YGL154C",491).
component("YBR115C",233).
component("U55_",145).
component("YER069W",433).
component("YOR323C",946).
component("YMR170C",810).
component("YMR169C",809).
component("U2_",120).
component("YER178W",452).
component("YBR221C",252).
component("YIL125W",598).
component("U52_",142).
component("YBR166C",245).
component("YNL280C",865).
component("YGL012W",476).
component("YKL182W",694).
component("U57_",147).
component("YKL216W",703).
component("YDR044W",335).
component("YER014W",418).
component("YKR009C",707).
component("YIL160C",603).
component("YGL205W",496).
component("YMR118C",804).
component("YLR164W",741).
component("YLL041C",718).
component("YKL148C",688).
component("YKL141W",686).
component("YJL045W",618).
component("YDR178W",362).
component("YJR051W",650).
component("YEL047C",412).
component("YDL171C",317).
component("YDL215C",322).
component("YOR375C",957).
component("YDL215C",323).
component("YAL062W",192).
component("U99_",186).
component("YBR035C",220).
component("YMR189W",812).
component("U56_",146).
component("YNR050C",880).
component("YHR037W",560).
component("YKR080W",711).
component("YER023W",420).
component("YPL023C",963).
component("YGL125W",488).
component("YOR236W",938).
component("YGR204W",531).
component("YLR142W",735).
component("U63_",152).
component("U62_",151).
component("YOR356W",954).
component("YKL150W",689).
component("YIL043C",587).
component("YHR042W",561).
component("YOR221C",935).
component("YML120C",788).
component("YKL192C",698).
component("YKL055C",677).
component("YER061C",429).
component("YBR046C",223).
component("YMR145C",807).
component("YML120C",789).
component("YKL192C",699).
component("YDL085W",297).
component("YGR234W",534).
component("YFR030W",467).
component("YPL017C",962).
component("YFL018C",457).
component("YPL091W",968).
component("YDR353W",384).
component("YER042W",422).
component("YPR167C",1018).
component("YJR137C",663).
component("YNL052W",837).
component("YMR256C",821).
component("YLR395C",768).
component("YLR038C",724).
component("YIL111W",595).
component("YHR051W",563).
component("YGL191W",494).
component("YGL187C",493).
component("YDL067C",294).
component("Q0275",20).
component("Q0250",19).
component("YPL266W",991).
component("YML110C",787).
component("YBR034C",219).
component("YPL273W",993).
component("YLL062C",721).
component("YDR410C",393).
component("U47_",137).
component("YER091C",443).
component("YJR073C",653).
component("YGR157W",521).
component("YDR120C",350).
component("YML008C",773).
component("YDL033C",288).
component("YOL096C",900).
component("YLR172C",742).
component("YDR019C",331).
component("YBR176W",246).
component("YDR408C",392).
component("YMR120C",805).
component("YBL013W",197).
component("YKL024C",673).
component("YPR074C",1010).
component("YBR117C",234).
component("YLR354C",763).
component("YGR043C",508).
component("YMR108W",802).
component("YCL009C",266).
component("YMR062C",798).
component("YNL071W",839).
component("YNR008W",872).
component("YIL160C",604).
component("YNL277W",863).
component("YDR232W",365).
component("YFL017C",456).
component("YPL231W",985).
component("YER061C",430).
component("U86_",174).
component("YPL001W",961).
component("YMR296C",828).
component("YDR062W",343).
component("YDL052C",291).
component("U8_",178).
component("YDR148C",358).
component("YOR377W",958).
component("YGR177C",525).
component("YPL231W",986).
component("YGR147C",519).
component("YDL040C",289).
component("YPL028W",964).
component("YLR195C",743).
component("YGL017W",477).
component("YPR001W",998).
component("YNR001C",870).
component("YCR005C",275).
component("YNL104C",842).
component("YDL182W",319).
component("YDL131W",306).
component("YNL117W",844).
component("YIR031C",612).
component("YOR321W",945).
component("YJR143C",665).
component("YGR199W",530).
component("YDR307W",378).
component("YDL095W",301).
component("YDL093W",300).
component("YAL023C",189).
component("YOR103C",915).
component("YOR085W",913).
component("YMR149W",808).
component("YML019W",775).
component("YJL002C",615).
component("YEL002C",406).
component("YDL232W",325).
component("YCL043C",271).
component("YNL029C",834).
component("YIL085C",592).
component("YMR261C",822).
component("YML100W",785).
component("YBR126C",238).
component("YNL192W",852).
component("YBR038W",222).
component("YBR023C",218).
component("YMR306W",832).
component("YLR342W",761).
component("YGR032W",506).
component("YPR183W",1021).
component("YLR209C",744).
component("U104_",24).
component("U103_",23).
component("YMR271C",824).
component("YML106W",786).
component("YOR209C",933).
component("YMR300C",829).
component("YER055C",425).
component("YDR354W",385) :- not remove_orf("YDR354W",385).
component("YFR047C",469).
component("YJR133W",662).
component("YLR209C",745).
component("YML022W",776).
component("YDR441C",396).
component("YDR399W",388).
component("YPR176C",1020).
component("YPL172C",976).
component("YNR041C",878).
component("YMR101C",800).
component("YDL090C",299).
component("YBR003W",209).
component("YBR002C",208).
component("YJL167W",636).
component("YJL167W",637).
component("YNL256W",857).
component("YPR069C",1007).
component("YDR127W",353).
component("YLR146C",736).
component("YLR303W",752).
component("YGR012W",504).
component("YJR130C",661).
component("YLR303W",753).
component("YDR035W",333).
component("YBR249C",255).
component("YOR274W",941).
component("YOL143C",907).
component("YBR256C",257).
component("YHR137W",573).
component("YGL202W",495).
component("YLR027C",722).
component("YKL106W",682).
component("YOL140W",906).
component("YLR438W",771).
component("YKL104C",681).
component("YGR019W",505).
component("YLR089C",730).
component("YDR111C",349).
component("U64_",153).
component("U61_",150).
component("U51_",141).
component("YJR148W",666).
component("YHR208W",581).
component("YFL030W",459).
component("YOR184W",927).
component("YNR058W",883).
component("YIL116W",597).
component("YGL253W",501).
component("YFR053C",470).
component("YOL136C",905).
component("YIL107C",594).
component("YMR013C",794).
component("YMR205C",814).
component("YGR240C",535).
component("YDR248C",368).
component("YCR036W",281).
component("YGR194C",529).
component("YCL040W",270).
component("YJR105W",659).
component("U16_",68).
component("U15_",60).
component("YPL188W",978).
component("YJR049C",649).
component("YEL041W",410).
component("U96_",184).
component("YKL001C",671).
component("YDR236C",366).
component("YML070W",782).
component("YFL053W",461).
component("YHL032C",550).
component("YLR133W",732).
component("YDR531W",404).
component("U83_",171).
component("U82_",170).
component("U81_",169).
component("YMR208W",815).
component("YPL203W",979).
component("YOR061W",910).
component("YKL166C",691).
component("YJL164C",634).
component("YIL035C",586).
component("YHR205W",580).
component("YHR102W",571).
component("YGL019W",478).
component("YHR025W",559).
component("YOR347C",952).
component("YAL038W",191).
component("YNR012W",873).
component("YPR121W",1015).
component("YPL258C",988).
component("YOL055C",892).
component("YPL214C",982).
component("U1_",93).
component("YDR009W",330).
component("YBR020W",216).
component("YNL267W",861).
component("YLR305C",755).
component("YFR019W",464).
component("YDR208W",363).
component("YDR127W",354).
component("U21_",106).
component("U20_",101).
component("YDR147W",357).
component("YDR300C",377).
component("YCR012W",276).
component("YER052C",423).
component("YER069W",434).
component("U19_",92).
component("U18_",84).
component("U17_",77).
component("U76_",164).
component("YMR220W",817).
component("YER170W",451).
component("YDR226W",364).
component("YKL067W",679).
component("YOL055C",893).
component("YDR454C",397).
component("YJR057W",651).
component("YOL061W",897).
component("YKL181W",693).
component("YHL011C",547).
component("YER099C",445).
component("YBL068W",206).
component("YOR143C",923).
component("YNL256W",858).
component("YLR328W",759).
component("YBR018C",212).
component("YBR018C",213).
component("YGR007W",503).
component("YLR328W",760).
component("YKR002W",705).
component("U80_",168).
component("YDL103C",304).
component("U94_",183).
component("YJR010W",645).
component("YCL050C",272).
component("YGL130W",489).
component("YDR530C",403).
component("YCL050C",273).
component("YPR190C",1023).
component("YPR187W",1022).
component("YPR110C",1013).
component("YPR010C",1001).
component("YOR341W",951).
component("YOR340C",950).
component("YOR224C",937).
component("YOR210W",934).
component("YOR207C",931).
component("YOR151C",924).
component("YOR116C",916).
component("YOL005C",885).
component("YNR003C",871).
component("YNL248C",856).
component("YNL151C",849).
component("YNL113W",843).
component("YKL144C",687).
component("YJR063W",652).
component("YJL148W",631).
component("YJL140W",630).
component("YIL021W",585).
component("YHR143W-A",574).
component("YGL070C",486).
component("YFL036W",460).
component("YDR404C",391).
component("YDR156W",359).
component("YDR045C",336).
component("YDL150W",313).
component("YDL140C",308).
component("YBR154C",244).
component("YPR175W",1019).
component("YPL167C",975).
component("YOR330C",947).
component("YOL115W",903).
component("YNL299W",867).
component("YNL262W",860).
component("YNL102W",841).
component("YJR043C",648).
component("YJR006W",644).
component("YJL090C",622).
component("YIL139C",600).
component("YEL055C",413).
component("YDR419W",394).
component("YDR121W",351).
component("YDL102W",303).
component("YCR014C",277).
component("YBR278W",260).
component("YBL035C",200).
component("YKL035W",676).
component("YHL012W",548).
component("YHR123W",572).
component("YPR113W",1014).
component("YBR243C",253).
component("YNL130C",845).
component("YDL142C",312).
component("YPL148C",973).
component("YER026C",421).
component("YCL004W",265).
component("YOR251C",940).
component("YGR286C",544).
component("YJL068C",619).
component("YDR058C",341).
component("YNR034W",877).
component("YHR163W",576).
component("YGR248W",537).
component("YCR073W-A",283).
component("YDL086W",298).
component("YOL011W",887).
component("YMR008C",792).
component("YMR006C",791).
component("U105_",25).
component("U101_",21).
component("YBL015W",198).
component("YJL068C",620).
component("YPL072W",967).
component("YOR124C",917).
component("YNL186W",851).
component("YMR304W",831).
component("YMR223W",818).
component("YKR098C",715).
component("YJL197W",638).
component("YIL156W",602).
component("YFR010W",463).
component("YER151C",449).
component("YER144C",448).
component("YER098W",444).
component("YDR069C",344).
component("YDL122W",305).
component("YBR058C",224).
component("YBL067C",205).
component("YDR272W",372).
component("U84_",172).
component("YDR481C",398).
component("YLR377C",766).
component("YDR074W",345).
component("YFR025C",465).
component("YPL179W",977).
component("YNR032W",875).
component("YML057W",781).
component("YML016C",774).
component("YLR433C",770).
component("YGR123C",516).
component("YER133W",447).
component("YER089C",441).
component("YDR436W",395).
component("YDR075W",346).
component("YDL188C",320).
component("YDL134C",307).
component("YDL047W",290).
component("YDL006W",284).
component("YBR125C",237).
component("YBL056W",204).
component("YPR073C",1008).
component("YHR215W",582).
component("YDL024C",287).
component("YBR093C",231).
component("YBR092C",230).
component("YAR071W",194).
component("YIL053W",589).
component("YER062C",431).
component("YHR046C",562).
component("U9_",187).
component("YGR208W",533).
component("YPL228W",983).
component("YMR180C",811).
component("YDL236W",326).
component("YJL155C",633).
component("YPR073C",1009).
component("YOR208W",932).
component("YNL053W",838).
component("YMR036C",797).
component("YIR026C",608).
component("YIL113W",596).
component("YFR028C",466).
component("YER075C",437).
component("YDL230W",324).
component("YBR276C",259).
component("U34_",125).
component("U33_",124).
component("U32_",123).
component("U31_",122).
...
component("U25_",117).
component("U24_",116).
component("YOL064C",898).
component("YPL268W",992).
component("YOR360C",955).
component("YGL248W",500).
component("YKR031C",708).
component("YPL206C",980).
component("YGL027C",480).
component("YLR286C",750).
component("YJR153W",668).
component("YJL221C",643).
component("YJL216C",641).
component("YIL172C",607).
component("YGR292W",546).
component("YGR287C",545).
component("YBR299W",264).
component("YBR184W",247).
component("YIL162W",605).
component("YOR190W",929).
component("YLR300W",751).
component("YGR282C",543).
component("YDR261C",370).
component("YDR400W",389).
component("U23_",115).
component("YML035C",777).
component("YJL070C",621).
component("YBR284W",261).
component("U102_",22).
component("YNL045W",836).
component("YLR160C",740).
component("YLR158C",739).
component("YLR157C",738).
component("YLR155C",737).
component("YDR321W",379).
component("YGL037C",481).
component("U43_",133).
component("U42_",132).
component("YMR293C",827).
component("YDR242W",367).
component("YLR308W",758).
component("YLR307W",757).
component("YBR208C",249).
component("YMR281W",826).
component("U53_",143).
component("YIR027C",609).
component("YPL111W",971).
component("YIR032C",613).
component("YIR029W",611).
component("YPR062W",1006).
component("YMR120C",806).
component("YLR028C",723).
component("YHR144C",575).
component("YGR267C",542).
component("YNL141W",846).
component("YBL033C",199).
component("YBR153W",243).
component("YDL238C",327).
component("YNL141W",847).
component("YLR245C",748).
component("YML035C",778).
component("YBR084W",228).
component("YJL126W",626).
component("U44_",134).
component("YDL100C",302).
component("U87_",175).
component("U40_",130).
component("YMR267W",823).
component("YBR011C",211).
component("YHR201C",579).
component("YBR111C",232).
component("YBR252W",256).
component("YCL030C",269).
component("YPR080W",1011).
component("YOR187W",928).
component("YOR133W",920).
component("YLR069C",728).
component("YKR084C",712).
component("YKL173W",692).
component("YJL102W",624).
component("YDR385W",387).
component("YBR118W",235).
component("YER005W",417).
component("YLL001W",716).
component("YIL048W",588).
component("YER166W",450).
component("YDR093W",348).
component("YAL026C",190).
component("YLR231C",746).
component("U88_",176).
component("YLR134W",733).
component("YLR044C",725).
component("YGR087C",512).
component("YDR380W",386).
component("YDL080C",296).
component("U98_",185).
component("YMR250W",820).
component("YKL184W",697).
component("YOR128C",918).
component("YEL021W",409).
component("YNR043W",879).
component("U93_",182).
component("YDR047W",338).
component("U54_",144).
component("YKL211C",701) :- not remove_orf("YKL211C",701).
component("YKR097W",714).
component("YOL052C",891).
component("YNL169C",850).
component("YGR170W",522).
component("YKL060C",678).
component("YNL256W",859).
component("YDR294C",374).
component("YEL046C",411).
component("YNR033W",876).
component("YPR006C",1000).
component("YER065C",432).
component("YKL211C",702) :- not remove_orf("YKL211C",702).
component("YER090W",702) :- not remove_orf("YER090W",702).
component("YER090W",442) :- not remove_orf("YER090W",442).
component("YDR127W",355).
component("YPL281C",997).
component("YOR393W",960).
component("YMR323W",833).
component("YHR174W",577).
component("YGR254W",538).
component("YPL262W",989).
component("YGL026C",479) :- not remove_orf("YGL026C",479).
component("YGR155W",520).
component("YLR304C",754).
component("YJL200C",639).
component("YNL316C",868).
component("YKL182W",695).
component("YPL212C",981).
component("YNL292W",866).
component("YGL063W",485).
component("YFL001W",454).
component("YOR278W",942).
component("YPR002W",999).
component("U49_",138).
component("YJR016C",646).
component("YCR053W",282).
component("YDR127W",356).
component("YGL148W",490).
component("YIL168W",606).
component("YER086W",439).
component("YCL064C",274).
component("YLR359W",765).
component("YAL012W",188).
component("YFR055W",471).
component("YJL005W",616).
component("YOR176W",926).
component("YJL121C",625).
component("YBR019C",214).
component("YBR019C",215).
component("YDR050C",339).
component("YDR007W",329) :- not remove_orf("YDR007W",329).
component("YOR095C",914).
component("YER003C",416).
component("YBR196C",248).
component("YGL001C",473).
component("U14_",52).
component("YOL056W",894).
component("YKL152C",690).
component("YDL021W",285).
component("YMR105C",801).
component("YKL127W",684).
component("YEL058W",414).
component("YPR060C",1005).
component("YHR072W",565).
component("YJL153C",632).
component("YPL097W",969).
component("YGR185C",528).
component("YGR264C",541).
component("YGR171C",523).
component("YHR011W",555).
component("YDR023W",332).
component("YPL104W",970).
component("YLL018C",717).
component("YPR081C",1012).
component("YBR121C",236).
component("YHR020W",558).
component("YER087W",440).
component("YNL247W",855).
component("YOL033W",889).
component("YGL245W",499).
component("YHR091C",567).
component("YDR341C",380).
component("YOL097C",901).
component("YDR268W",371).
component("YPR047W",1004).
component("YLR060W",727).
component("YFL022C",458).
component("YPR033C",1002).
component("YHR019C",556).
component("YCR024C",278).
component("YHR019C",557).
component("YPL160W",974).
component("YLR382C",767).
component("YNL073W",840).
component("YDR037W",334).
component("YOR335C",948).
component("YGR094W",514).
component("YOR317W",944).
component("YMR246W",819).
component("YIL009W",584).
component("YER015W",419).
component("YOR142W",922).
component("YGR244C",536).
component("YPR035W",1003).
component("U89_",177).
component("YOR241W",939).
component("YMR113W",803).
component("YKL132C",685).
component("YOR339C",949).
component("YMR022W",796).
component("YLR306W",756).
component("YKL210W",700).
component("YGR133W",518).
component("YGL058W",483).
component("YER100W",446).
component("YEL012W",407).
component("YDR177W",361).
component("YDR092W",347).
component("YDR059C",342).
component("YDR054C",340).
component("YDL064W",292).
component("YBR082C",227).
component("YJL101C",623).
component("YOL049W",890).
component("U92_",181).
component("YAR015W",193).
component("YGL234W",497).
component("YER183C",453).
component("U91_",180).
component("U90_",179).
component("YNR057C",882).
component("YDL141W",309).
component("YDL141W",310).
component("YGL234W",498).
component("YDL141W",311).
component("YJR103W",657).
component("YBL039C",201).
component("YGR204W",532).
component("YBR084W",229).
component("YNL220W",853).
component("YOL058W",895).
component("YBR208C",250).
component("YHR074W",566).
component("YMR217W",816).
component("YGR061C",511).
component("YPR145W",1017).
component("YGR124W",517).
component("YOR303W",943).
component("YJR109C",660).
component("YJL130C",628).
component("YGL062W",484).
component("YBR218C",251).
component("YPL231W",987).
component("YNR016C",874).
component("YKL182W",696).
component("YGR037C",507).
component("YOR005C",909).
component("YDL164C",314).
component("YOL010W",886).
component("YPR138C",1016).
component("YPL274W",994).
component("YPL265W",990).
component("YPL134C",972).
component("YPL057C",966).
component("YPL036W",965).
component("YOR348C",953).
component("YOR222W",936).
component("YOR192C",930).
component("YOR171C",925).
component("YOR130C",919).
component("YOR071C",912).
component("YOL156W",908).
component("YOL103W",902).
component("YOL020W",888) :- not remove_orf("YOL020W",888).
component("YNR072W",884).
component("YNR056C",881).
component("YNL318C",869).
component("YNL268W",862).
component("YNL142W",848).
component("YMR272C",825).
component("YMR202W",813).
component("YMR011W",793).
component("YML123C",790).
component("YLR348C",762).
component("YLR260W",749).
component("YLR237W",747).
component("YLR138W",734).
component("YLR100C",731).
component("YLR081W",729).
component("YLL061W",720).
component("YLL043W",719).
component("YKR093W",713).
component("YKR053C",710).
component("YKR039W",709) :- not remove_orf("YKR039W",709).
component("YKL217W",704).
component("YKL120W",683).
component("YKL004W",672).
component("YJR158W",669).
component("YJR152W",667).
component("YJR095W",656).
component("YJR077C",654).
component("YJL219W",642).
component("YJL214W",640).
component("YJL134W",629).
component("YJL129C",627).
component("YIR028W",610).
component("YIL134W",599).
component("YHR096C",570).
component("YHR094C",569).
component("YHR092C",568).
component("YHL036W",551).
component("YHL016C",549).
component("YGR121C",515).
component("YGR055W",509).
component("YGL186C",492).
component("YGL077C",487).
component("YGL008C",474).
component("YFL055W",462).
component("YFL011W",455).
component("YER060W-A",428).
component("YER060W",427).
component("YER056C",426).
component("YER053C",424).
component("YEL069C",415).
component("YEL017C-A",408).
component("YDR536W",405).
component("YDR508C",401).
component("YDR503C",400).
component("YDR497C",399).
component("YDR345C",383).
component("YDR343C",382).
component("YDR342C",381).
component("YDR297W",376).
component("YDR294C",375).
component("YDR284C",373).
component("YDR046C",337) :- not remove_orf("YDR046C",337).
component("YDL245C",328).
component("YDL210W",321).
component("YCR032W",280).
component("YCR024C-A",279).
component("YCL025C",267).
component("YBR298C",263).
component("YBR291C",262).
component("YBR069C",226) :- not remove_orf("YBR069C",226).
component("YBR068C",225) :- not remove_orf("YBR068C",225).
component("YBR036C",221).
component("YBR021W",217).
component("YBL042C",202).
component("U85_",173).
component("U7_",167).
component("U79_",166).
component("U78_",165).
...
catalyst(1960,338).
catalyst(3460,144).
catalyst(3600,701) :- not remove_reaction(3600,701).
catalyst(8000,714).
catalyst(3941,891).
catalyst(3942,891).
catalyst(6890,850).
...
catalyst(8020,1000).
catalyst(8020,432).
catalyst(1890,702) :- not remove_reaction(1890,702).
catalyst(3630,702) :- not remove_reaction(3630,702).
catalyst(1890,442) :- not remove_reaction(1890,442).
catalyst(3630,442) :- not remove_reaction(3630,442).
catalyst(3740,355).
catalyst(8231,997).
catalyst(8232,997).
catalyst(8231,960).
...
catalyst(8281,339).
catalyst(8282,339).
catalyst(3610,329) :- not remove_reaction(3610,329).
catalyst(7921,914).
catalyst(7922,914).
catalyst(7841,416).
catalyst(7842,416).
...
catalyst(1210,908).
catalyst(1160,902).
catalyst(801,888) :- not remove_reaction(801,888).
catalyst(802,888) :- not remove_reaction(802,888).
catalyst(811,888) :- not remove_reaction(811,888).
catalyst(812,888) :- not remove_reaction(812,888).
catalyst(831,888) :- not remove_reaction(831,888).
catalyst(832,888) :- not remove_reaction(832,888).
catalyst(901,888) :- not remove_reaction(901,888).
catalyst(902,888) :- not remove_reaction(902,888).
catalyst(941,888) :- not remove_reaction(941,888).
catalyst(942,888) :- not remove_reaction(942,888).
catalyst(1170,884).
catalyst(1180,884).
catalyst(1210,884).
catalyst(700,881).
...
catalyst(650,713).
catalyst(6560,710).
catalyst(761,709) :- not remove_reaction(761,709).
catalyst(762,709) :- not remove_reaction(762,709).
catalyst(771,709) :- not remove_reaction(771,709).
catalyst(772,709) :- not remove_reaction(772,709).
catalyst(781,709) :- not remove_reaction(781,709).
catalyst(782,709) :- not remove_reaction(782,709).
catalyst(791,709) :- not remove_reaction(791,709).
catalyst(792,709) :- not remove_reaction(792,709).
catalyst(801,709) :- not remove_reaction(801,709).
catalyst(802,709) :- not remove_reaction(802,709).
catalyst(811,709) :- not remove_reaction(811,709).
catalyst(812,709) :- not remove_reaction(812,709).
catalyst(821,709) :- not remove_reaction(821,709).
catalyst(822,709) :- not remove_reaction(822,709).
catalyst(831,709) :- not remove_reaction(831,709).
catalyst(832,709) :- not remove_reaction(832,709).
catalyst(841,709) :- not remove_reaction(841,709).
catalyst(842,709) :- not remove_reaction(842,709).
catalyst(861,709) :- not remove_reaction(861,709).
catalyst(862,709) :- not remove_reaction(862,709).
catalyst(881,709) :- not remove_reaction(881,709).
catalyst(882,709) :- not remove_reaction(882,709).
catalyst(901,709) :- not remove_reaction(901,709).
catalyst(902,709) :- not remove_reaction(902,709).
catalyst(911,709) :- not remove_reaction(911,709).
catalyst(912,709) :- not remove_reaction(912,709).
catalyst(921,709) :- not remove_reaction(921,709).
catalyst(922,709) :- not remove_reaction(922,709).
catalyst(941,709) :- not remove_reaction(941,709).
catalyst(942,709) :- not remove_reaction(942,709).
catalyst(1191,709) :- not remove_reaction(1191,709).
catalyst(1192,709) :- not remove_reaction(1192,709).
catalyst(390,704).
catalyst(1021,704).
catalyst(1022,704).
catalyst(1521,683).
...
catalyst(6550,375).
catalyst(6690,373).
catalyst(791,337) :- not remove_reaction(791,337).
catalyst(792,337) :- not remove_reaction(792,337).
catalyst(801,337) :- not remove_reaction(801,337).
catalyst(802,337) :- not remove_reaction(802,337).
catalyst(811,337) :- not remove_reaction(811,337).
catalyst(812,337) :- not remove_reaction(812,337).
catalyst(831,337) :- not remove_reaction(831,337).
catalyst(832,337) :- not remove_reaction(832,337).
catalyst(841,337) :- not remove_reaction(841,337).
catalyst(842,337) :- not remove_reaction(842,337).
catalyst(861,337) :- not remove_reaction(861,337).
catalyst(862,337) :- not remove_reaction(862,337).
catalyst(901,337) :- not remove_reaction(901,337).
catalyst(902,337) :- not remove_reaction(902,337).
catalyst(1170,328).
catalyst(1180,328).
catalyst(1210,328).
catalyst(690,321).
...
catalyst(1511,262).
catalyst(1512,262).
catalyst(771,226) :- not remove_reaction(771,226).
catalyst(772,226) :- not remove_reaction(772,226).
catalyst(791,226) :- not remove_reaction(791,226).
catalyst(792,226) :- not remove_reaction(792,226).
...
catalyst(861,226) :- not remove_reaction(861,226).
catalyst(862,226) :- not remove_reaction(862,226).
catalyst(901,226) :- not remove_reaction(901,226).
catalyst(902,226) :- not remove_reaction(902,226).
catalyst(791,225) :- not remove_reaction(791,225).
catalyst(792,225) :- not remove_reaction(792,225).
catalyst(801,225) :- not remove_reaction(801,225).
catalyst(802,225) :- not remove_reaction(802,225).
catalyst(811,225) :- not remove_reaction(811,225).
catalyst(812,225) :- not remove_reaction(812,225).
catalyst(831,225) :- not remove_reaction(831,225).
catalyst(832,225) :- not remove_reaction(832,225).
catalyst(841,225) :- not remove_reaction(841,225).
catalyst(842,225) :- not remove_reaction(842,225).
catalyst(861,225) :- not remove_reaction(861,225).
catalyst(862,225) :- not remove_reaction(862,225).
catalyst(901,225) :- not remove_reaction(901,225).
catalyst(902,225) :- not remove_reaction(902,225).
catalyst(6600,221).
catalyst(620,217).
catalyst(540,202).
catalyst(2660,173).
...
modifiable_enzyme(701).
modifiable_enzyme(702).
modifiable_enzyme(442).
modifiable_enzyme(479).
modifiable_enzyme(329).
modifiable_enzyme(888).
modifiable_enzyme(709).
modifiable_enzyme(337).
modifiable_enzyme(226).
modifiable_enzyme(225).
