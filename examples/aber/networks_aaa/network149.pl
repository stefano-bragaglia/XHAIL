...
component("YLR056W",657).
component("YGR060W",458).
component("YGL012W",426).
component("YKR009C",640).
component("YOL086C",812).
component("YMR303C",749).
component("YMR083W",720).
component("YGL256W",450).
component("YDL168W",280).
component("YBR145W",209).
component("YPL231W",890).
component("YBR265W",228).
component("U46_",117).
component("YBR149W",210).
component("YBR149W",211).
component("YJR159W",608).
component("YGL001C",423).
component("YIL094C",536).
component("YHR063C",508).
component("YBR153W",212).
component("YML056C",704).
component("YLR432W",696).
component("YHR216W",526).
component("YAR075W",171).
component("YAR073W",170).
component("YCL030C",238).
component("YDR127W",312).
component("YJR139C",602).
component("YOL126C",817).
component("YKL085W",618).
component("YDL078C",261).
component("YKL029C",613).
component("YOR136W",832).
component("YNL037C",754).
component("YDL066W",260).
component("YNL241C",770).
component("YOL059W",810).
component("YDL022W",254).
component("YLR355C",692).
component("YIL074C",534).
component("YER081W",393).
component("YML054C",703).
component("YDL174C",282).
component("YML086C",707).
component("YIL155C",542).
component("YPR191W",927).
component("YOR065W",823).
component("YJL166W",573).
component("YHR001W-A",497).
component("YGR183C",473).
component("YFR033C",419).
component("YDR529C",359).
component("YBL045C",177).
component("Q0105",18).
component("YGR088W",461).
component("YDR256C",327).
component("YKL026C",612).
component("YIR037W",553).
component("YBR244W",224).
component("YJR078W",593).
component("YJR025C",585).
component("YGR255C",485).
component("U108_",23).
component("YBL098W",181).
component("YMR015C",717).
component("YHR007C",498).
component("YDR402C",347).
component("YGL055W",433).
component("YGR175C",470).
component("YJR104C",596).
component("YHR008C",499).
component("YJL026W",556).
component("YIL066C",533).
component("YGR180C",472).
component("YER070W",390).
component("U38_",112).
component("U36_",111).
component("U35_",110).
component("YDL168W",281).
component("YDR158W",320).
component("YBR006W",184).
component("YPL276W",902).
component("YPL275W",901).
component("YOR388C",866).
component("YOR374W",863).
component("YER073W",391).
component("U68_",134).
component("YGL154C",441).
component("U55_",126).
component("YOR323C",854).
component("YMR170C",730).
component("YMR169C",729).
component("U2_",105).
component("YER178W",406).
component("YBR221C",222).
component("YIL125W",540).
component("U52_",123).
component("YBR166C",215).
component("YNL280C",781).
component("YGL012W",427).
component("YKL182W",630).
component("U57_",128).
component("YKL216W",637).
component("YDR044W",299).
component("YER014W",374).
component("YKR009C",641).
component("YIL160C",544).
component("YGL205W",444).
component("YMR118C",725).
component("YLR164W",670).
component("YLL041C",650).
component("YKL148C",625).
component("YKL141W",623).
component("YJL045W",557).
component("YDR178W",321).
component("YJR051W",588).
component("YEL047C",368).
component("YDL215C",286).
component("YOR375C",864).
component("YDL215C",287).
component("YAL062W",168).
component("U99_",162).
component("YBR035C",194).
component("YMR189W",732).
component("U56_",127).
component("YHR037W",505).
component("YKR080W",645).
component("YER023W",376).
component("YPL023C",870).
component("YGL125W",438).
component("YOR236W",847).
component("YGR204W",477).
component("YLR142W",665).
component("U63_",132).
component("U62_",131).
component("YOR356W",861).
component("YKL150W",626).
component("YIL043C",530).
component("YHR042W",506).
component("YOR221C",845).
component("YML120C",711).
component("YKL192C",634).
component("YKL055C",615).
component("YER061C",385).
component("YGR234W",480).
component("YFR030W",418).
component("YPL017C",869).
component("YFL018C",410).
component("YPL091W",875).
component("YDR353W",342).
component("YER042W",378).
component("YJR137C",601).
component("YPL266W",897).
component("YML110C",710).
component("YBR034C",193).
component("YPL273W",899).
component("YLL062C",653).
component("YDR410C",350).
component("U47_",118).
component("YER091C",398).
component("YJR073C",591).
component("YDR120C",310).
component("YDL033C",256).
component("YOL096C",813).
component("YLR172C",671).
component("YDR019C",295).
component("YBR176W",216).
component("YDR408C",349).
component("YMR120C",726).
component("YBL013W",172).
component("YKL024C",611).
component("YPR074C",916).
component("YBR117C",205).
component("YLR354C",691).
component("YGR043C",456).
component("YMR108W",723).
component("YCL009C",236).
component("YMR062C",719).
component("YNL071W",757).
component("YNR008W",788).
component("YIL160C",545).
component("YNL277W",779).
component("YFL017C",409).
component("YPL231W",891).
component("YER061C",386).
component("U86_",150).
component("YPL001W",868).
component("YMR296C",747).
component("YDR062W",305).
component("YDL052C",259).
component("U8_",154).
component("YDR148C",318).
component("YOR377W",865).
component("YGR177C",471).
component("YPL231W",892).
component("YGR147C",466).
component("YDL040C",257).
component("YPL028W",871).
component("YLR195C",672).
component("YGL017W",428).
component("YPR001W",904).
component("YNR001C",786).
component("YCR005C",243).
component("YDL182W",283).
component("YDL131W",271).
component("YNL117W",761).
component("YIR031C",551).
component("YOR321W",853).
component("YJR143C",603).
component("YGR199W",476).
component("YDR307W",336).
component("YDL095W",266).
component("YDL093W",265).
component("YAL023C",165).
component("YOR103C",827).
component("YOR085W",825).
component("YMR149W",728).
component("YML019W",699).
component("YJL002C",554).
component("YEL002C",363).
component("YDL232W",289).
component("YCL043C",241).
component("YNL029C",753).
component("YIL085C",535).
component("YMR261C",741).
component("YML100W",708).
component("YBR126C",208).
component("YNL192W",769).
component("YBR038W",196).
component("YBR023C",192).
component("YMR306W",751).
component("YLR342W",689).
component("YGR032W",454).
component("YLR209C",673).
component("U104_",21).
component("YMR271C",743).
component("YML106W",709).
component("YOR209C",843).
component("YMR300C",748).
component("YER055C",381).
component("YDR354W",343) :- not remove_orf("YDR354W",343).
component("YFR047C",420).
component("YJR133W",600).
component("YLR209C",674).
component("YML022W",700).
component("YDR441C",353).
component("YDR399W",345).
component("YPR176C",924).
component("YPL172C",882).
component("YNR041C",794).
component("YMR101C",721).
component("YDL090C",264).
component("YBR003W",183).
component("YBR002C",182).
component("YJL167W",574).
component("YJL167W",575).
component("YNL256W",773).
component("YPR069C",913).
component("YDR127W",313).
component("YLR303W",681).
component("YGR012W",452).
component("YJR130C",599).
component("YLR303W",682).
component("YDR035W",297).
component("YBR249C",225).
component("YOR274W",849).
component("YOL143C",819).
component("YBR256C",227).
component("YHR137W",517).
component("YGL202W",443).
component("YLR027C",654).
component("YKL106W",620).
component("YKL104C",619).
component("YGR019W",453).
component("YLR089C",660).
component("U64_",133).
component("U61_",130).
component("U51_",122).
component("YJR148W",604).
component("YHR208W",524).
component("YOR184W",838).
component("YNR058W",798).
component("YIL116W",539).
component("YGL253W",449).
component("YFR053C",421).
component("YOL136C",818).
component("YIL107C",537).
component("YMR013C",716).
component("YMR205C",734).
component("YGR240C",481).
component("YDR248C",326).
component("YCR036W",249).
component("YGR194C",475).
component("YCL040W",240).
component("YJR105W",597).
component("U16_",57).
component("U15_",51).
component("YPL188W",884).
component("YJR049C",587).
component("YEL041W",366).
component("U96_",160).
component("YKL001C",609).
component("YDR236C",324).
component("YML070W",706).
component("YFL053W",413).
component("YHL032C",495).
component("YLR133W",662).
component("YDR531W",361).
component("U83_",148).
component("U82_",147).
component("U81_",146).
component("YMR208W",735).
component("YPL203W",885).
component("YOR061W",822).
component("YKL166C",628).
component("YJL164C",572).
component("YIL035C",529).
component("YHR205W",523).
component("YHR102W",515).
component("YGL019W",429).
component("YHR025W",504).
component("YOR347C",859).
component("YAL038W",167).
component("YNR012W",789).
component("YPR121W",920).
component("YPL258C",894).
component("YOL055C",806).
component("YPL214C",888).
component("U1_",80).
component("YDR009W",294).
component("YBR020W",190).
component("YNL267W",777).
component("YLR305C",684).
component("YFR019W",416).
component("YDR208W",322).
component("YDR127W",314).
component("U21_",91).
component("U20_",88).
component("YDR147W",317).
component("YDR300C",335).
component("YCR012W",244).
component("YER052C",379).
component("YER069W",389).
component("U18_",72).
component("U17_",65).
component("U76_",142).
component("YMR220W",737).
component("YER170W",405).
component("YDR226W",323).
component("YKL067W",617).
component("YOL055C",807).
component("YDR454C",354).
component("YJR057W",589).
component("YOL061W",811).
component("YKL181W",629).
component("YHL011C",492).
component("YER099C",400).
component("YBL068W",180).
component("YOR143C",834).
component("YNL256W",774).
component("YLR328W",687).
component("YBR018C",186).
component("YBR018C",187).
component("YGR007W",451).
component("YLR328W",688).
component("YKR002W",639).
component("YDL103C",269).
component("U94_",159).
component("YJR010W",583).
component("YGL130W",439).
component("YDR530C",360).
component("YCL050C",242).
component("YPR190C",926).
component("YPR187W",925).
component("YPR110C",918).
component("YPR010C",907).
component("YOR341W",858).
component("YOR340C",857).
component("YOR224C",846).
component("YOR210W",844).
component("YOR207C",841).
component("YOR151C",835).
component("YOR116C",828).
component("YOL005C",800).
component("YNR003C",787).
component("YNL248C",772).
component("YNL151C",766).
component("YNL113W",760).
component("YKL144C",624).
component("YJR063W",590).
component("YJL148W",569).
component("YJL140W",568).
component("YIL021W",528).
component("YHR143W-A",518).
component("YGL070C",436).
component("YFL036W",412).
component("YDR404C",348).
component("YDR156W",319).
component("YDR045C",300).
component("YDL150W",278).
component("YDL140C",273).
component("YBR154C",214).
component("YPR175W",923).
component("YPL167C",881).
component("YOR330C",855).
component("YOL115W",816).
component("YNL299W",783).
component("YNL262W",776).
component("YNL102W",759).
component("YJR043C",586).
component("YJR006W",582).
component("YJL090C",561).
component("YIL139C",541).
component("YEL055C",369).
component("YDR419W",351).
component("YDR121W",311).
component("YDL102W",268).
component("YCR014C",245).
component("YBR278W",230).
component("YBL035C",174).
component("YKL035W",614).
component("YHL012W",493).
component("YHR123W",516).
component("YPR113W",919).
component("YBR243C",223).
component("YNL130C",762).
component("YDL142C",277).
component("YPL148C",879).
component("YER026C",377).
component("YCL004W",235).
component("YGR286C",489).
component("YJL068C",558).
component("YDR058C",304).
component("YNR034W",793).
component("YHR163W",520).
component("YGR248W",483).
component("YCR073W-A",251).
component("YDL086W",263).
component("YOL011W",802).
component("YMR008C",714).
component("YMR006C",713).
component("U105_",22).
component("U101_",19).
component("YBL015W",173).
component("YJL068C",559).
component("YPL072W",874).
component("YOR124C",829).
component("YNL186W",768).
component("YMR304W",750).
component("YMR223W",738).
component("YKR098C",648).
component("YJL197W",576).
component("YIL156W",543).
component("YFR010W",415).
component("YER151C",403).
component("YER144C",402).
component("YER098W",399).
component("YDR069C",306).
component("YDL122W",270).
component("YBR058C",197).
component("YBL067C",179).
component("YDR272W",330).
component("U84_",149).
component("YDR481C",355).
component("YLR377C",694).
component("YDR074W",307).
component("YPL179W",883).
component("YNR032W",791).
component("YML057W",705).
component("YML016C",698).
component("YLR433C",697).
component("YGR123C",464).
component("YER133W",401).
component("YER089C",396).
component("YDR436W",352).
component("YDR075W",308).
component("YDL188C",284).
component("YDL134C",272).
component("YDL047W",258).
component("YDL006W",252).
component("YBR125C",207).
component("YBL056W",178).
component("YPR073C",914).
component("YHR215W",525).
component("YDL024C",255).
component("YBR093C",203).
component("YBR092C",202).
component("YAR071W",169).
component("YIL053W",532).
component("YER062C",387).
component("YHR046C",507).
component("U9_",163).
component("YGR208W",479).
component("YPL228W",889).
component("YMR180C",731).
component("YDL236W",290).
component("YJL155C",571).
component("YPR073C",915).
component("YOR208W",842).
component("YNL053W",756).
component("YMR036C",718).
component("YIR026C",548).
component("YIL113W",538).
component("YFR028C",417).
component("YER075C",392).
component("YDL230W",288).
component("YBR276C",229).
component("U34_",109).
component("U33_",108).
component("U32_",107).
component("U30_",106).
...
component("U25_",102).
component("U24_",101).
component("YPL268W",898).
component("YOR360C",862).
component("YGL248W",448).
component("YKR031C",642).
component("YPL206C",886).
component("YGL027C",431).
component("YLR286C",679).
component("YJR153W",606).
component("YJL221C",581).
component("YJL216C",579).
component("YIL172C",547).
component("YGR292W",491).
component("YGR287C",490).
component("YBR299W",234).
component("YBR184W",217).
component("YOR190W",839).
component("YLR300W",680).
component("YGR282C",488).
component("YDR261C",328).
component("YDR400W",346).
component("U23_",100).
component("YML035C",701).
component("YJL070C",560).
component("YBR284W",231).
component("U102_",20).
component("YNL045W",755).
component("YLR160C",669).
component("YLR158C",668).
component("YLR157C",667).
component("YLR155C",666).
component("YDR321W",337).
component("YGL037C",432).
component("YMR293C",746).
component("YDR242W",325).
component("YLR308W",686).
component("YLR307W",685).
component("YBR208C",219).
component("YMR281W",745).
component("U53_",124).
component("YIR027C",549).
component("YPL111W",878).
component("YIR032C",552).
component("YIR029W",550).
component("YPR062W",912).
component("YMR120C",727).
component("YLR028C",655).
component("YHR144C",519).
component("YGR267C",487).
component("YNL141W",763).
component("YBR153W",213).
component("YDL238C",291).
component("YNL141W",764).
component("YLR245C",677).
component("YML035C",702).
component("YBR084W",200).
component("YJL126W",564).
component("U44_",116).
component("YDL100C",267).
component("U87_",151).
component("U40_",114).
component("YMR267W",742).
component("YBR011C",185).
component("YHR201C",522).
component("YBR111C",204).
component("YBR252W",226).
component("YCL030C",239).
component("YER005W",373).
component("YIL048W",531).
component("YER166W",404).
component("YDR093W",309).
component("YAL026C",166).
component("YLR231C",675).
component("U88_",152).
component("YLR134W",663).
component("YLR044C",656).
component("YGR087C",460).
component("YDR380W",344).
component("YDL080C",262).
component("U98_",161).
component("YMR250W",740).
component("YKL184W",633).
component("YOR128C",830).
component("YEL021W",365).
component("YNR043W",795).
component("U93_",158).
component("YDR047W",302).
component("U54_",125).
component("YKL211C",635) :- not remove_orf("YKL211C",635).
component("YKR097W",647).
component("YOL052C",805).
component("YNL169C",767).
component("YGR170W",468).
component("YKL060C",616).
component("YNL256W",775).
component("YDR294C",332).
component("YEL046C",367).
component("YNR033W",792).
component("YPR006C",906).
component("YER065C",388).
component("YKL211C",636) :- not remove_orf("YKL211C",636).
component("YER090W",636) :- not remove_orf("YER090W",636).
component("YER090W",397) :- not remove_orf("YER090W",397).
component("YDR127W",315).
component("YPL281C",903).
component("YOR393W",867).
component("YMR323W",752).
component("YHR174W",521).
component("YGR254W",484).
component("YPL262W",895).
component("YGL026C",430) :- not remove_orf("YGL026C",430).
component("YGR155W",467).
component("YLR304C",683).
component("YJL200C",577).
component("YNL316C",784).
component("YKL182W",631).
component("YPL212C",887).
component("YNL292W",782).
component("YGL063W",435).
component("YFL001W",407).
component("YOR278W",850).
component("YPR002W",905).
component("U49_",119).
component("YJR016C",584).
component("YCR053W",250).
component("YDR127W",316).
component("YGL148W",440).
component("YIL168W",546).
component("YER086W",394).
component("YLR359W",693).
component("YAL012W",164).
component("YFR055W",422).
component("YJL005W",555).
component("YOR176W",837).
component("YJL121C",563).
component("YBR019C",188).
component("YBR019C",189).
component("YDR050C",303).
component("YDR007W",293) :- not remove_orf("YDR007W",293).
component("YOR095C",826).
component("YER003C",372).
component("YBR196C",218).
component("YGL001C",424).
component("U14_",44).
component("YOL056W",808).
component("YKL152C",627).
component("YDL021W",253).
component("YMR105C",722).
component("YKL127W",621).
component("YEL058W",370).
component("YPR060C",911).
component("YHR072W",509).
component("YJL153C",570).
component("YPL097W",876).
component("YGR185C",474).
component("YGR264C",486).
component("YGR171C",469).
component("YHR011W",500).
component("YDR023W",296).
component("YPL104W",877).
component("YLL018C",649).
component("YPR081C",917).
component("YBR121C",206).
component("YHR020W",503).
component("YER087W",395).
component("YNL247W",771).
component("YOL033W",804).
component("YGL245W",447).
component("YHR091C",511).
component("YDR341C",338).
component("YOL097C",814).
component("YDR268W",329).
component("YPR047W",910).
component("YLR060W",658).
component("YFL022C",411).
component("YPR033C",908).
component("YHR019C",501).
component("YCR024C",246).
component("YHR019C",502).
component("YPL160W",880).
component("YLR382C",695).
component("YNL073W",758).
component("YDR037W",298).
component("YOR335C",856).
component("YGR094W",462).
component("YOR317W",852).
component("YMR246W",739).
component("YIL009W",527).
component("YER015W",375).
component("YOR142W",833).
component("YGR244C",482).
component("YPR035W",909).
component("U89_",153).
component("YOR241W",848).
component("YMR113W",724).
component("YKL132C",622).
component("YJL101C",562).
component("U92_",157).
component("YGL234W",445).
component("U91_",156).
component("U90_",155).
component("YNR057C",797).
component("YDL141W",274).
component("YDL141W",275).
component("YGL234W",446).
component("YDL141W",276).
component("YJR103W",595).
component("YBL039C",175).
component("YGR204W",478).
component("YBR084W",201).
component("YOL058W",809).
component("YBR208C",220).
component("YHR074W",510).
component("YMR217W",736).
component("YGR061C",459).
component("YPR145W",922).
component("YGR124W",465).
component("YOR303W",851).
component("YJR109C",598).
component("YJL130C",566).
component("YGL062W",434).
component("YBR218C",221).
component("YPL231W",893).
component("YNR016C",790).
component("YKL182W",632).
component("YGR037C",455).
component("YOR005C",821).
component("YDL164C",279).
component("YOL010W",801).
component("YPR138C",921).
component("YPL274W",900).
component("YPL265W",896).
component("YPL057C",873).
component("YPL036W",872).
component("YOR348C",860).
component("YOR192C",840).
component("YOR171C",836).
component("YOR130C",831).
component("YOR071C",824).
component("YOL156W",820).
component("YOL103W",815).
component("YOL020W",803) :- not remove_orf("YOL020W",803).
component("YNR072W",799).
component("YNR056C",796).
component("YNL318C",785).
component("YNL268W",778).
component("YNL142W",765).
component("YMR272C",744).
component("YMR202W",733).
component("YMR011W",715).
component("YML123C",712).
component("YLR348C",690).
component("YLR260W",678).
component("YLR237W",676).
component("YLR138W",664).
component("YLR100C",661).
component("YLR081W",659).
component("YLL061W",652).
component("YLL043W",651).
component("YKR093W",646).
component("YKR053C",644).
component("YKR039W",643) :- not remove_orf("YKR039W",643).
component("YKL217W",638).
component("YKL004W",610).
component("YJR158W",607).
component("YJR152W",605).
component("YJR095W",594).
component("YJR077C",592).
component("YJL219W",580).
component("YJL214W",578).
component("YJL134W",567).
component("YJL129C",565).
component("YHR096C",514).
component("YHR094C",513).
component("YHR092C",512).
component("YHL036W",496).
component("YHL016C",494).
component("YGR121C",463).
component("YGR055W",457).
component("YGL186C",442).
component("YGL077C",437).
component("YGL008C",425).
component("YFL055W",414).
component("YFL011W",408).
component("YER060W-A",384).
component("YER060W",383).
component("YER056C",382).
component("YER053C",380).
component("YEL069C",371).
component("YEL017C-A",364).
component("YDR536W",362).
component("YDR508C",358).
component("YDR503C",357).
component("YDR497C",356).
component("YDR345C",341).
component("YDR343C",340).
component("YDR342C",339).
component("YDR297W",334).
component("YDR294C",333).
component("YDR284C",331).
component("YDR046C",301) :- not remove_orf("YDR046C",301).
component("YDL245C",292).
component("YDL210W",285).
component("YCR032W",248).
component("YCR024C-A",247).
component("YCL025C",237).
component("YBR298C",233).
component("YBR291C",232).
component("YBR069C",199) :- not remove_orf("YBR069C",199).
component("YBR068C",198) :- not remove_orf("YBR068C",198).
component("YBR036C",195).
component("YBR021W",191).
component("YBL042C",176).
component("U7_",145).
component("U79_",144).
component("U78_",143).
component("U75_",141).
...
catalyst(1960,302).
catalyst(3460,125).
catalyst(3600,635) :- not remove_reaction(3600,635).
catalyst(8000,647).
catalyst(3941,805).
catalyst(3942,805).
catalyst(6890,767).
...
catalyst(8020,906).
catalyst(8020,388).
catalyst(1890,636) :- not remove_reaction(1890,636).
catalyst(3630,636) :- not remove_reaction(3630,636).
catalyst(1890,397) :- not remove_reaction(1890,397).
catalyst(3630,397) :- not remove_reaction(3630,397).
catalyst(3740,315).
catalyst(8231,903).
catalyst(8232,903).
catalyst(8231,867).
...
catalyst(8051,895).
catalyst(8052,895).
catalyst(3590,430) :- not remove_reaction(3590,430).
catalyst(10910,430) :- not remove_reaction(10910,430).
catalyst(4570,467).
catalyst(8181,683).
catalyst(8182,683).
catalyst(8181,577).
...
catalyst(8281,303).
catalyst(8282,303).
catalyst(3610,293) :- not remove_reaction(3610,293).
catalyst(7921,826).
catalyst(7922,826).
catalyst(7841,372).
catalyst(7842,372).
...
catalyst(1210,820).
catalyst(1160,815).
catalyst(801,803) :- not remove_reaction(801,803).
catalyst(802,803) :- not remove_reaction(802,803).
catalyst(811,803) :- not remove_reaction(811,803).
catalyst(812,803) :- not remove_reaction(812,803).
catalyst(831,803) :- not remove_reaction(831,803).
catalyst(832,803) :- not remove_reaction(832,803).
catalyst(901,803) :- not remove_reaction(901,803).
catalyst(902,803) :- not remove_reaction(902,803).
catalyst(941,803) :- not remove_reaction(941,803).
catalyst(942,803) :- not remove_reaction(942,803).
catalyst(1170,799).
catalyst(1210,799).
catalyst(700,796).
catalyst(1200,785).
...
catalyst(650,646).
catalyst(6560,644).
catalyst(761,643) :- not remove_reaction(761,643).
catalyst(762,643) :- not remove_reaction(762,643).
catalyst(771,643) :- not remove_reaction(771,643).
catalyst(772,643) :- not remove_reaction(772,643).
catalyst(781,643) :- not remove_reaction(781,643).
catalyst(782,643) :- not remove_reaction(782,643).
catalyst(791,643) :- not remove_reaction(791,643).
catalyst(792,643) :- not remove_reaction(792,643).
catalyst(801,643) :- not remove_reaction(801,643).
catalyst(802,643) :- not remove_reaction(802,643).
catalyst(811,643) :- not remove_reaction(811,643).
catalyst(812,643) :- not remove_reaction(812,643).
catalyst(821,643) :- not remove_reaction(821,643).
catalyst(822,643) :- not remove_reaction(822,643).
catalyst(831,643) :- not remove_reaction(831,643).
catalyst(832,643) :- not remove_reaction(832,643).
catalyst(841,643) :- not remove_reaction(841,643).
catalyst(842,643) :- not remove_reaction(842,643).
catalyst(861,643) :- not remove_reaction(861,643).
catalyst(862,643) :- not remove_reaction(862,643).
catalyst(881,643) :- not remove_reaction(881,643).
catalyst(882,643) :- not remove_reaction(882,643).
catalyst(901,643) :- not remove_reaction(901,643).
catalyst(902,643) :- not remove_reaction(902,643).
catalyst(911,643) :- not remove_reaction(911,643).
catalyst(912,643) :- not remove_reaction(912,643).
catalyst(921,643) :- not remove_reaction(921,643).
catalyst(922,643) :- not remove_reaction(922,643).
catalyst(941,643) :- not remove_reaction(941,643).
catalyst(942,643) :- not remove_reaction(942,643).
catalyst(1191,643) :- not remove_reaction(1191,643).
catalyst(1192,643) :- not remove_reaction(1192,643).
catalyst(1021,638).
catalyst(1022,638).
catalyst(6610,610).
catalyst(1170,607).
...
catalyst(6550,333).
catalyst(6690,331).
catalyst(791,301) :- not remove_reaction(791,301).
catalyst(792,301) :- not remove_reaction(792,301).
...
catalyst(841,301) :- not remove_reaction(841,301).
catalyst(842,301) :- not remove_reaction(842,301).
catalyst(861,301) :- not remove_reaction(861,301).
catalyst(862,301) :- not remove_reaction(862,301).
...
catalyst(1511,232).
catalyst(1512,232).
catalyst(771,199) :- not remove_reaction(771,199).
catalyst(772,199) :- not remove_reaction(772,199).
...
catalyst(831,198) :- not remove_reaction(831,198).
catalyst(832,198) :- not remove_reaction(832,198).
catalyst(841,198) :- not remove_reaction(841,198).
catalyst(842,198) :- not remove_reaction(842,198).
...
modifiable_enzyme(397).
modifiable_enzyme(430).
modifiable_enzyme(293).
modifiable_enzyme(803).
modifiable_enzyme(643).
