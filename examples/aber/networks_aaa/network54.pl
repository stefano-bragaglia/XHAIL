...
component("YGR060W",223).
component("YGL012W",208).
component("YOL086C",378).
component("YMR303C",348).
component("YGL256W",218).
component("YDL168W",138).
component("YBR145W",106).
component("YPL231W",417).
component("YGL001C",205).
component("YML056C",330).
component("YLR432W",327).
component("YHR216W",250).
component("YAR075W",90).
component("YAR073W",89).
component("YDR127W",153).
component("YJR139C",286).
component("YOR136W",386).
component("YDL066W",131).
component("YIL155C",257).
component("YPR191W",439).
component("YOR065W",382).
component("YJL166W",271).
component("YHR001W-A",240).
component("YGR183C",230).
component("YFR033C",202).
component("YDR529C",178).
component("YBL045C",94).
component("Q0105",18).
component("YJR078W",279).
component("YJR025C",274).
component("YBL098W",96).
component("YMR015C",335).
component("YDR402C",171).
component("YJR104C",282).
component("YHR008C",241).
component("YER070W",189).
component("U35_",55).
component("YDL168W",139).
component("YPL276W",425).
component("YPL275W",424).
component("YOR388C",407).
component("YGL154C",215).
component("U55_",62).
component("YOR323C",398).
component("YMR170C",343).
component("YMR169C",342).
component("YBR166C",109).
component("YNL280C",363).
component("YER014W",185).
component("YMR118C",340).
component("YLR164W",314).
component("YLL041C",309).
component("YKL148C",296).
component("YJL045W",261).
component("YDR178W",159).
component("YJR051W",276).
component("YEL047C",182).
component("YOR375C",406).
component("YDL215C",141).
component("YAL062W",88).
component("U99_",84).
component("YBR035C",99).
component("YKR080W",307).
component("YER023W",186).
component("YOR236W",395).
component("YGR204W",231).
component("U62_",64).
component("YKL150W",297).
component("YIL043C",252).
component("YHR042W",242).
component("YPL017C",410).
component("YFL018C",196).
component("YPL273W",423).
component("YLL062C",310).
component("U47_",57).
component("YDL033C",129).
component("YKL024C",289).
component("YPR074C",432).
component("YBR117C",105).
component("YCL009C",120).
component("YMR062C",337).
component("YPL231W",418).
component("U86_",78).
component("YPL001W",409).
component("YPL231W",419).
component("YGR147C",227).
component("YDL040C",130).
component("YPL028W",411).
component("YPR001W",427).
component("YNR001C",367).
component("YDL182W",140).
component("YNL117W",355).
component("YIR031C",259).
component("YNL029C",350).
component("YIL085C",254).
component("YLR209C",315).
component("YMR300C",347).
component("YER055C",188).
component("YDR354W",167) :- not remove_orf("YDR354W",167).
component("YFR047C",203).
component("YJR133W",285).
component("YML022W",328).
component("YDR441C",174).
component("YDR399W",169).
component("YNL256W",360).
component("YDR127W",154).
component("YLR303W",321).
component("YJR130C",284).
component("YLR303W",322).
component("YDR035W",146).
component("YBR249C",113).
component("YBR256C",114).
component("YHR137W",245).
component("YGL202W",216).
component("YLR027C",311).
component("YKL106W",292).
component("YKL104C",291).
component("YGR019W",220).
component("U64_",65).
component("U51_",59).
component("YJR148W",287).
component("YGL253W",217).
component("YFR053C",204).
component("YMR205C",345).
component("YGR240C",232).
component("YDR248C",162).
component("YCR036W",127).
component("YCL040W",122).
component("YJR105W",283).
component("U16_",32).
component("U15_",29).
component("U96_",82).
component("YKL001C",288).
component("YML070W",331).
component("YFL053W",198).
component("YHL032C",238).
component("U83_",76).
component("U82_",75).
component("YMR208W",346).
component("YOR347C",403).
component("YAL038W",87).
component("YPR121W",434).
component("YPL258C",421).
component("YOL055C",375).
component("U1_",41).
component("YNL267W",362).
component("YLR305C",324).
component("YFR019W",200).
component("YDR208W",160).
component("YDR127W",155).
component("U21_",46).
component("U20_",45).
component("YDR300C",165).
component("YCR012W",124).
component("U18_",38).
component("U76_",73).
component("YER170W",194).
component("YDR226W",161).
component("YDR454C",175).
component("YOL061W",377).
component("YKL181W",298).
component("YHL011C",236).
component("YER099C",192).
component("YBL068W",95).
component("YOR143C",387).
component("YGR007W",219).
component("YLR328W",325).
component("YCL050C",123).
component("YPR190C",438).
component("YPR187W",437).
component("YPR110C",433).
component("YPR010C",428).
component("YOR341W",402).
component("YOR340C",401).
component("YOR224C",394).
component("YOR210W",393).
component("YOR207C",391).
component("YOR151C",388).
component("YOR116C",385).
component("YOL005C",372).
component("YNR003C",368).
component("YNL248C",359).
component("YNL151C",358).
component("YNL113W",354).
component("YKL144C",295).
component("YJR063W",277).
component("YJL148W",269).
component("YJL140W",268).
component("YIL021W",251).
component("YHR143W-A",246).
component("YGL070C",213).
component("YFL036W",197).
component("YDR404C",172).
component("YDR156W",158).
component("YDR045C",147).
component("YDL150W",136).
component("YDL140C",135).
component("YBR154C",108).
component("YPR175W",436).
component("YPL167C",414).
component("YOR330C",399).
component("YOL115W",380).
component("YNL299W",365).
component("YNL262W",361).
component("YNL102W",353).
component("YJR043C",275).
component("YJR006W",273).
component("YJL090C",263).
component("YIL139C",256).
component("YEL055C",183).
component("YDR419W",173).
component("YDR121W",152).
component("YDL102W",134).
component("YCR014C",125).
component("YBR278W",116).
component("YBL035C",92).
component("YKL035W",290).
component("YHL012W",237).
component("YER026C",187).
component("YDR058C",150).
component("YDL086W",133).
component("YOL011W",373).
component("YMR008C",334).
component("YMR006C",333).
component("U101_",19).
component("YBL015W",91).
component("U84_",77).
component("YPR073C",430).
component("YHR215W",249).
component("YDL024C",128).
component("YBR093C",103).
component("YBR092C",102).
component("YPL228W",416).
component("YMR180C",344).
component("YDL236W",143).
component("YJL155C",270).
component("YPR073C",431).
component("YOR208W",392).
component("YNL053W",352).
component("YMR036C",336).
component("YIR026C",258).
component("YIL113W",255).
component("YFR028C",201).
component("YER075C",190).
component("YDL230W",142).
component("YBR276C",115).
component("U34_",54).
component("U30_",53).
component("U25_",52).
component("U24_",51).
component("YOR360C",405).
component("YKR031C",304).
component("YLR286C",319).
component("YOR190W",389).
component("YLR300W",320).
component("YGR282C",235).
component("YDR261C",163).
component("YDR400W",170).
component("U23_",50).
component("YML035C",329).
component("YJL070C",262).
component("YBR284W",117).
component("YNL045W",351).
component("YGL037C",210).
component("YBR208C",110).
component("U53_",60).
component("YIR032C",260).
component("YMR120C",341).
component("YHR144C",247).
component("YBR153W",107).
component("YDL238C",144).
component("YNL141W",356).
component("YLR245C",318).
component("YJL126W",265).
component("YBR111C",104).
component("YER005W",184).
component("YIL048W",253).
component("YER166W",193).
component("YDR093W",151).
component("YAL026C",86).
component("YLR231C",316).
component("U88_",79).
component("YLR134W",313).
component("YLR044C",312).
component("YGR087C",224).
component("YDR380W",168).
component("YDL080C",132).
component("U98_",83).
component("YKL184W",301).
component("YNR043W",371).
component("U93_",81).
component("U54_",61).
component("YKL211C",302) :- not remove_orf("YKL211C",302).
component("YGR170W",229).
component("YDR294C",164).
component("YEL046C",181).
component("YNR033W",370).
component("YKL211C",303) :- not remove_orf("YKL211C",303).
component("YER090W",303) :- not remove_orf("YER090W",303).
component("YER090W",191) :- not remove_orf("YER090W",191).
component("YDR127W",156).
component("YPL281C",426).
component("YOR393W",408).
component("YMR323W",349).
component("YHR174W",248).
component("YGR254W",234).
component("YGL026C",209) :- not remove_orf("YGL026C",209).
component("YGR155W",228).
component("YLR304C",323).
component("YJL200C",272).
component("YNL316C",366).
component("YKL182W",299).
component("YPL212C",415).
component("YNL292W",364).
component("YGL063W",212).
component("YFL001W",195).
component("YDR127W",157).
component("YGL148W",214).
component("YAL012W",85).
component("YBR019C",97).
component("YDR050C",149).
component("YDR007W",145) :- not remove_orf("YDR007W",145).
component("YOR095C",384).
component("YGL001C",206).
component("YMR105C",338).
component("YKL127W",293).
component("YPR060C",429).
component("YPL104W",413).
component("YLL018C",308).
component("YHR091C",244).
component("YDR341C",166).
component("YOL097C",379).
component("YOR335C",400).
component("YGR094W",225).
component("YGR244C",233).
component("U89_",80).
component("YOR241W",396).
component("YMR113W",339).
component("YKL132C",294).
component("YJL101C",264).
component("YJR103W",281).
component("YBL039C",93).
component("YOL058W",376).
component("YBR208C",111).
component("YHR074W",243).
component("YOR303W",397).
component("YGL062W",211).
component("YBR218C",112).
component("YPL231W",420).
component("YNR016C",369).
component("YKL182W",300).
component("YGR037C",221).
component("YOR005C",381).
component("YDL164C",137).
component("YPR138C",435).
component("YPL265W",422).
component("YPL036W",412).
component("YOR348C",404).
component("YOR192C",390).
component("YOR071C",383).
component("YOL020W",374) :- not remove_orf("YOL020W",374).
component("YNL142W",357).
component("YML123C",332).
component("YLR348C",326).
component("YLR237W",317).
component("YKR053C",306).
component("YKR039W",305) :- not remove_orf("YKR039W",305).
component("YJR095W",280).
component("YJR077C",278).
component("YJL134W",267).
component("YJL129C",266).
component("YHL036W",239).
component("YGR121C",226).
component("YGR055W",222).
component("YGL008C",207).
component("YFL055W",199).
component("YEL017C-A",180).
component("YDR536W",179).
component("YDR508C",177).
component("YDR503C",176).
component("YDR046C",148) :- not remove_orf("YDR046C",148).
component("YCR024C-A",126).
component("YCL025C",121).
component("YBR298C",119).
component("YBR291C",118).
component("YBR069C",101) :- not remove_orf("YBR069C",101).
component("YBR068C",100) :- not remove_orf("YBR068C",100).
component("YBR021W",98).
component("U79_",74).
component("U75_",72).
component("U74_",71).
component("U73_",70).
...
catalyst(6160,347).
catalyst(3870,188).
catalyst(3620,167) :- not remove_reaction(3620,167).
catalyst(2190,203).
catalyst(5550,285).
catalyst(5650,328).
catalyst(5650,174).
...
catalyst(2300,81).
catalyst(3460,61).
catalyst(3600,302) :- not remove_reaction(3600,302).
catalyst(6900,229).
catalyst(8781,164).
catalyst(8782,164).
catalyst(4560,181).
catalyst(2550,370).
catalyst(3630,303) :- not remove_reaction(3630,303).
catalyst(3630,191) :- not remove_reaction(3630,191).
catalyst(3740,156).
catalyst(8231,426).
catalyst(8232,426).
catalyst(8231,408).
...
catalyst(8231,234).
catalyst(8232,234).
catalyst(3590,209) :- not remove_reaction(3590,209).
catalyst(10910,209) :- not remove_reaction(10910,209).
catalyst(4570,228).
catalyst(8181,323).
catalyst(8182,323).
catalyst(8181,272).
...
catalyst(8281,149).
catalyst(8282,149).
catalyst(3610,145) :- not remove_reaction(3610,145).
catalyst(7921,384).
catalyst(7922,384).
catalyst(6370,206).
catalyst(7861,338).
...
catalyst(190,317).
catalyst(6560,306).
catalyst(771,305) :- not remove_reaction(771,305).
catalyst(772,305) :- not remove_reaction(772,305).
catalyst(781,305) :- not remove_reaction(781,305).
catalyst(782,305) :- not remove_reaction(782,305).
catalyst(801,305) :- not remove_reaction(801,305).
catalyst(802,305) :- not remove_reaction(802,305).
catalyst(811,305) :- not remove_reaction(811,305).
catalyst(812,305) :- not remove_reaction(812,305).
catalyst(831,305) :- not remove_reaction(831,305).
catalyst(832,305) :- not remove_reaction(832,305).
catalyst(841,305) :- not remove_reaction(841,305).
catalyst(842,305) :- not remove_reaction(842,305).
catalyst(881,305) :- not remove_reaction(881,305).
catalyst(882,305) :- not remove_reaction(882,305).
catalyst(941,305) :- not remove_reaction(941,305).
catalyst(942,305) :- not remove_reaction(942,305).
catalyst(1191,305) :- not remove_reaction(1191,305).
catalyst(1192,305) :- not remove_reaction(1192,305).
catalyst(1250,280).
catalyst(1581,278).
catalyst(1582,278).
catalyst(6560,267).
...
catalyst(1501,118).
catalyst(1502,118).
catalyst(771,101) :- not remove_reaction(771,101).
catalyst(772,101) :- not remove_reaction(772,101).
...
catalyst(831,100) :- not remove_reaction(831,100).
catalyst(832,100) :- not remove_reaction(832,100).
catalyst(841,100) :- not remove_reaction(841,100).
catalyst(842,100) :- not remove_reaction(842,100).
catalyst(620,98).
catalyst(2830,74).
catalyst(2920,72).
catalyst(2920,71).
