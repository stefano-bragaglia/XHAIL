...
component("YNL280C",534).
component("YGR060W",319).
component("YGL012W",295).
component("YOL086C",555).
component("YMR303C",512).
component("YGL256W",313).
component("YDL168W",192).
component("YBR145W",150).
component("YPL231W",606).
component("U46_",81).
component("YBR149W",151).
component("YGL001C",292).
component("YIL094C",367).
component("YHR063C",350).
component("YBR153W",152).
component("YML056C",484).
component("YLR432W",480).
component("YHR216W",361).
component("YAR075W",122).
component("YAR073W",121).
component("YDR127W",214).
component("YJR139C",415).
component("YOL126C",559).
component("YDL078C",182).
component("YKL029C",419).
component("YOR136W",569).
component("YDL066W",181).
component("YLR355C",477).
component("YML086C",486).
component("YIL155C",371).
component("YPR191W",634).
component("YOR065W",564).
component("YJL166W",394).
component("YHR001W-A",345).
component("YGR183C",330).
component("YFR033C",288).
component("YDR529C",247).
component("YBL045C",128).
component("Q0105",18).
component("YGR088W",321).
component("YDR256C",228).
component("YJR078W",406).
component("YJR025C",401).
component("YGR255C",339).
component("YBL098W",131).
component("YMR015C",492).
component("YDR402C",239).
component("YGL055W",300).
component("YGR175C",327).
component("YJR104C",409).
component("YHR008C",346).
component("YJL026W",378).
component("YGR180C",329).
component("YER070W",267).
component("U35_",78).
component("YDL168W",193).
component("YDR158W",222).
component("YPL276W",615).
component("YPL275W",614).
component("YOR388C",592).
component("YOR374W",589).
component("YGL154C",306).
component("U55_",88).
component("YOR323C",581).
component("YMR170C",500).
component("YMR169C",499).
component("U2_",75).
component("YBR221C",160).
component("U52_",85).
component("YBR166C",155).
component("YNL280C",535).
component("YGL012W",296).
component("U57_",89).
component("YDR044W",205).
component("YER014W",256).
component("YKR009C",437).
component("YIL160C",373).
component("YGL205W",309).
component("YMR118C",497).
component("YLR164W",462).
component("YLL041C",445).
component("YKL148C",427).
component("YJL045W",379).
component("YDR178W",223).
component("YJR051W",403).
component("YEL047C",251).
component("YOR375C",590).
component("YDL215C",196).
component("YAL062W",119).
component("U99_",115).
component("YBR035C",138).
component("YHR037W",347).
component("YKR080W",441).
component("YER023W",257).
component("YOR236W",578).
component("YGR204W",332).
component("YLR142W",457).
component("U62_",91).
component("YKL150W",428).
component("YIL043C",363).
component("YHR042W",348).
component("YFR030W",287).
component("YPL017C",595).
component("YFL018C",279).
component("YER042W",259).
component("YJR137C",414).
component("YPL266W",612).
component("YML110C",488).
component("YBR034C",137).
component("YPL273W",613).
component("YLL062C",448).
component("U47_",82).
component("YER091C",270).
component("YDL033C",179).
component("YOL096C",556).
component("YDR019C",202).
component("YDR408C",241).
component("YBL013W",123).
component("YKL024C",418).
component("YPR074C",626).
component("YBR117C",147).
component("YLR354C",476).
component("YGR043C",317).
component("YCL009C",169).
component("YMR062C",494).
component("YNL071W",518).
component("YNR008W",542).
component("YPL231W",607).
component("YER061C",265).
component("U86_",106).
component("YPL001W",594).
component("YDR148C",220).
component("YOR377W",591).
component("YGR177C",328).
component("YPL231W",608).
component("YGR147C",324).
component("YDL040C",180).
component("YPL028W",596).
component("YGL017W",297).
component("YPR001W",617).
component("YNR001C",540).
component("YDL182W",194).
component("YDL131W",187).
component("YNL117W",521).
component("YIR031C",376).
component("YNL029C",515).
component("YIL085C",366).
component("YMR261C",507).
component("YML100W",487).
component("YBR126C",149).
component("YNL192W",527).
component("YBR038W",140).
component("YBR023C",136).
component("YLR209C",463).
component("U104_",21).
component("YMR300C",511).
component("YER055C",261).
component("YDR354W",235) :- not remove_orf("YDR354W",235).
component("YFR047C",289).
component("YJR133W",413).
component("YLR209C",464).
component("YML022W",481).
component("YDR441C",243).
component("YDR399W",237).
component("YJL167W",395).
component("YNL256W",530).
component("YDR127W",215).
component("YLR303W",470).
component("YJR130C",412).
component("YLR303W",471).
component("YDR035W",203).
component("YBR249C",161).
component("YOL143C",561).
component("YBR256C",162).
component("YHR137W",355).
component("YGL202W",308).
component("YLR027C",449).
component("YKL106W",423).
component("YKL104C",422).
component("YGR019W",315).
component("YLR089C",453).
component("U64_",92).
component("U51_",84).
component("YJR148W",416).
component("YGL253W",312).
component("YFR053C",290).
component("YOL136C",560).
component("YIL107C",368).
component("YMR205C",502).
component("YGR240C",335).
component("YDR248C",227).
component("YCR036W",176).
component("YCL040W",171).
component("YJR105W",410).
component("U16_",38).
component("U15_",35).
component("U96_",113).
component("YKL001C",417).
component("YML070W",485).
component("YFL053W",282).
component("YHL032C",343).
component("U83_",104).
component("U82_",103).
component("U81_",102).
component("YMR208W",503).
component("YOR347C",586).
component("YAL038W",118).
component("YNR012W",543).
component("YPR121W",629).
component("YPL258C",610).
component("YOL055C",552).
component("U1_",57).
component("YDR009W",201).
component("YBR020W",134).
component("YNL267W",532).
component("YLR305C",473).
component("YFR019W",285).
component("YDR208W",224).
component("YDR127W",216).
component("U21_",66).
component("U20_",64).
component("YDR147W",219).
component("YDR300C",232).
component("YCR012W",173).
component("U18_",50).
component("U76_",100).
component("YER170W",276).
component("YDR226W",225).
component("YKL067W",421).
component("YDR454C",244).
component("YOL061W",554).
component("YKL181W",430).
component("YHL011C",341).
component("YER099C",272).
component("YBL068W",130).
component("YOR143C",570).
component("YGR007W",314).
component("YLR328W",474).
component("YJR010W",400).
component("YCL050C",172).
component("YPR190C",633).
component("YPR187W",632).
component("YPR110C",628).
component("YPR010C",619).
component("YOR341W",585).
component("YOR340C",584).
component("YOR224C",577).
component("YOR210W",576).
component("YOR207C",574).
component("YOR151C",571).
component("YOR116C",567).
component("YOL005C",548).
component("YNR003C",541).
component("YNL248C",529).
component("YNL151C",525).
component("YNL113W",520).
component("YKL144C",426).
component("YJR063W",404).
component("YJL148W",391).
component("YJL140W",390).
component("YIL021W",362).
component("YHR143W-A",356).
component("YGL070C",303).
component("YFL036W",281).
component("YDR404C",240).
component("YDR156W",221).
component("YDR045C",206).
component("YDL150W",190).
component("YDL140C",188).
component("YBR154C",154).
component("YPR175W",631).
component("YPL167C",603).
component("YOR330C",582).
component("YOL115W",558).
component("YNL299W",537).
component("YNL262W",531).
component("YNL102W",519).
component("YJR043C",402).
component("YJR006W",399).
component("YJL090C",383).
component("YIL139C",370).
component("YEL055C",252).
component("YDR419W",242).
component("YDR121W",213).
component("YDL102W",185).
component("YCR014C",174).
component("YBR278W",164).
component("YBL035C",125).
component("YKL035W",420).
component("YHL012W",342).
component("YHR123W",354).
component("YER026C",258).
component("YCL004W",168).
component("YJL068C",380).
component("YDR058C",210).
component("YNR034W",546).
component("YHR163W",358).
component("YGR248W",337).
component("YCR073W-A",177).
component("YDL086W",184).
component("YOL011W",549).
component("YMR008C",491).
component("YMR006C",490).
component("U101_",19).
component("YBL015W",124).
component("YJL068C",381).
component("YPL072W",599).
component("YOR124C",568).
component("YNL186W",526).
component("YMR304W",513).
component("YMR223W",505).
component("YKR098C",443).
component("YJL197W",396).
component("YIL156W",372).
component("YFR010W",284).
component("YER151C",274).
component("YER144C",273).
component("YER098W",271).
component("YDR069C",211).
component("YDL122W",186).
component("YBR058C",141).
component("YBL067C",129).
component("U84_",105).
component("YPR073C",624).
component("YHR215W",360).
component("YDL024C",178).
component("YBR093C",145).
component("YBR092C",144).
component("YAR071W",120).
component("YIL053W",365).
component("YER062C",266).
component("YHR046C",349).
component("YGR208W",334).
component("YPL228W",605).
component("YMR180C",501).
component("YDL236W",198).
component("YJL155C",393).
component("YPR073C",625).
component("YOR208W",575).
component("YNL053W",517).
component("YMR036C",493).
component("YIR026C",374).
component("YIL113W",369).
component("YFR028C",286).
component("YER075C",268).
component("YDL230W",197).
component("YBR276C",163).
component("U34_",77).
component("U30_",76).
component("U25_",74).
component("U24_",73).
component("YOR360C",588).
component("YGL248W",311).
component("YKR031C",438).
component("YLR286C",468).
component("YOR190W",572).
component("YLR300W",469).
component("YGR282C",340).
component("YDR261C",229).
component("YDR400W",238).
component("U23_",72).
component("YML035C",482).
component("YJL070C",382).
component("YBR284W",165).
component("U102_",20).
component("YNL045W",516).
component("YLR160C",461).
component("YLR158C",460).
component("YLR157C",459).
component("YLR155C",458).
component("YDR321W",233).
component("YGL037C",299).
component("YDR242W",226).
component("YBR208C",157).
component("YMR281W",510).
component("U53_",86).
component("YIR032C",377).
component("YIR029W",375).
component("YPR062W",623).
component("YMR120C",498).
component("YHR144C",357).
component("YNL141W",522).
component("YBR153W",153).
component("YDL238C",199).
component("YNL141W",523).
component("YLR245C",467).
component("YML035C",483).
component("YJL126W",386).
component("U87_",107).
component("YMR267W",508).
component("YBR111C",146).
component("YER005W",255).
component("YIL048W",364).
component("YER166W",275).
component("YDR093W",212).
component("YAL026C",117).
component("YLR231C",465).
component("U88_",108).
component("YLR134W",455).
component("YLR044C",450).
component("YGR087C",320).
component("YDR380W",236).
component("YDL080C",183).
component("U98_",114).
component("YMR250W",506).
component("YKL184W",433).
component("YNR043W",547).
component("U93_",112).
component("YDR047W",208).
component("U54_",87).
component("YKL211C",434) :- not remove_orf("YKL211C",434).
component("YGR170W",326).
component("YDR294C",230).
component("YEL046C",250).
component("YNR033W",545).
component("YKL211C",435) :- not remove_orf("YKL211C",435).
component("YER090W",435) :- not remove_orf("YER090W",435).
component("YER090W",269) :- not remove_orf("YER090W",269).
component("YDR127W",217).
component("YPL281C",616).
component("YOR393W",593).
component("YMR323W",514).
component("YHR174W",359).
component("YGR254W",338).
component("YGL026C",298) :- not remove_orf("YGL026C",298).
component("YGR155W",325).
component("YLR304C",472).
component("YJL200C",397).
component("YNL316C",538).
component("YKL182W",431).
component("YPL212C",604).
component("YNL292W",536).
component("YGL063W",302).
component("YFL001W",277).
component("YPR002W",618).
component("YDR127W",218).
component("YGL148W",305).
component("YLR359W",478).
component("YAL012W",116).
component("YFR055W",291).
component("YJL121C",385).
component("YBR019C",132).
component("YBR019C",133).
component("YDR050C",209).
component("YDR007W",200) :- not remove_orf("YDR007W",200).
component("YOR095C",566).
component("YER003C",254).
component("YBR196C",156).
component("YGL001C",293).
component("U14_",30).
component("YKL152C",429).
component("YMR105C",495).
component("YKL127W",424).
component("YEL058W",253).
component("YPR060C",622).
component("YHR072W",351).
component("YJL153C",392).
component("YPL097W",600).
component("YGR185C",331).
component("YPL104W",601).
component("YLL018C",444).
component("YPR081C",627).
component("YBR121C",148).
component("YNL247W",528).
component("YOL033W",551).
component("YHR091C",353).
component("YDR341C",234).
component("YOL097C",557).
component("YPR047W",621).
component("YLR060W",451).
component("YFL022C",280).
component("YPR033C",620).
component("YPL160W",602).
component("YLR382C",479).
component("YDR037W",204).
component("YOR335C",583).
component("YGR094W",322).
component("YGR244C",336).
component("U89_",109).
component("YOR241W",579).
component("YMR113W",496).
component("YKL132C",425).
component("YJL101C",384).
component("U92_",111).
component("YGL234W",310).
component("U91_",110).
component("YDL141W",189).
component("YJR103W",408).
component("YBL039C",126).
component("YGR204W",333).
component("YOL058W",553).
component("YBR208C",158).
component("YHR074W",352).
component("YMR217W",504).
component("YOR303W",580).
component("YJR109C",411).
component("YJL130C",388).
component("YGL062W",301).
component("YBR218C",159).
component("YPL231W",609).
component("YNR016C",544).
component("YKL182W",432).
component("YGR037C",316).
component("YOR005C",563).
component("YDL164C",191).
component("YPR138C",630).
component("YPL265W",611).
component("YPL057C",598).
component("YPL036W",597).
component("YOR348C",587).
component("YOR192C",573).
component("YOR071C",565).
component("YOL156W",562).
component("YOL020W",550) :- not remove_orf("YOL020W",550).
component("YNL318C",539).
component("YNL268W",533).
component("YNL142W",524).
component("YMR272C",509).
component("YML123C",489).
component("YLR348C",475).
component("YLR237W",466).
component("YLR138W",456).
component("YLR100C",454).
component("YLR081W",452).
component("YLL061W",447).
component("YLL043W",446).
component("YKR093W",442).
component("YKR053C",440).
component("YKR039W",439) :- not remove_orf("YKR039W",439).
component("YKL217W",436).
component("YJR095W",407).
component("YJR077C",405).
component("YJL219W",398).
component("YJL134W",389).
component("YJL129C",387).
component("YHL036W",344).
component("YGR121C",323).
component("YGR055W",318).
component("YGL186C",307).
component("YGL077C",304).
component("YGL008C",294).
component("YFL055W",283).
component("YFL011W",278).
component("YER060W-A",264).
component("YER060W",263).
component("YER056C",262).
component("YER053C",260).
component("YEL017C-A",249).
component("YDR536W",248).
component("YDR508C",246).
component("YDR503C",245).
component("YDR294C",231).
component("YDR046C",207) :- not remove_orf("YDR046C",207).
component("YDL210W",195).
component("YCR024C-A",175).
component("YCL025C",170).
component("YBR298C",167).
component("YBR291C",166).
component("YBR069C",143) :- not remove_orf("YBR069C",143).
component("YBR068C",142) :- not remove_orf("YBR068C",142).
component("YBR036C",139).
component("YBR021W",135).
component("YBL042C",127).
component("U79_",101).
component("U75_",99).
component("U74_",98).
component("U73_",97).
...
catalyst(6160,511).
catalyst(3870,261).
catalyst(3620,235) :- not remove_reaction(3620,235).
catalyst(2110,289).
catalyst(2190,289).
catalyst(5550,413).
catalyst(5791,464).
...
catalyst(1960,208).
catalyst(3460,87).
catalyst(3600,434) :- not remove_reaction(3600,434).
catalyst(6900,326).
catalyst(8781,230).
catalyst(8782,230).
catalyst(4560,250).
...
catalyst(3630,269) :- not remove_reaction(3630,269).
catalyst(3740,217).
catalyst(8231,616).
catalyst(8232,616).
catalyst(8231,593).
...
catalyst(8231,338).
catalyst(8232,338).
catalyst(3590,298) :- not remove_reaction(3590,298).
catalyst(10910,298) :- not remove_reaction(10910,298).
catalyst(4570,325).
catalyst(8181,472).
catalyst(8182,472).
catalyst(8181,397).
...
catalyst(8281,209).
catalyst(8282,209).
catalyst(3610,200) :- not remove_reaction(3610,200).
catalyst(7921,566).
catalyst(7922,566).
catalyst(7841,254).
catalyst(7842,254).
...
catalyst(190,565).
catalyst(1200,562).
catalyst(801,550) :- not remove_reaction(801,550).
catalyst(802,550) :- not remove_reaction(802,550).
catalyst(811,550) :- not remove_reaction(811,550).
catalyst(812,550) :- not remove_reaction(812,550).
catalyst(831,550) :- not remove_reaction(831,550).
catalyst(832,550) :- not remove_reaction(832,550).
catalyst(941,550) :- not remove_reaction(941,550).
catalyst(942,550) :- not remove_reaction(942,550).
catalyst(1200,539).
catalyst(761,533).
catalyst(762,533).
catalyst(371,524).
...
catalyst(640,442).
catalyst(6560,440).
catalyst(761,439) :- not remove_reaction(761,439).
catalyst(762,439) :- not remove_reaction(762,439).
catalyst(771,439) :- not remove_reaction(771,439).
catalyst(772,439) :- not remove_reaction(772,439).
catalyst(781,439) :- not remove_reaction(781,439).
catalyst(782,439) :- not remove_reaction(782,439).
catalyst(791,439) :- not remove_reaction(791,439).
catalyst(792,439) :- not remove_reaction(792,439).
catalyst(801,439) :- not remove_reaction(801,439).
catalyst(802,439) :- not remove_reaction(802,439).
catalyst(811,439) :- not remove_reaction(811,439).
catalyst(812,439) :- not remove_reaction(812,439).
catalyst(821,439) :- not remove_reaction(821,439).
catalyst(822,439) :- not remove_reaction(822,439).
catalyst(831,439) :- not remove_reaction(831,439).
catalyst(832,439) :- not remove_reaction(832,439).
catalyst(841,439) :- not remove_reaction(841,439).
catalyst(842,439) :- not remove_reaction(842,439).
catalyst(861,439) :- not remove_reaction(861,439).
catalyst(862,439) :- not remove_reaction(862,439).
catalyst(881,439) :- not remove_reaction(881,439).
catalyst(882,439) :- not remove_reaction(882,439).
catalyst(911,439) :- not remove_reaction(911,439).
catalyst(912,439) :- not remove_reaction(912,439).
catalyst(941,439) :- not remove_reaction(941,439).
catalyst(942,439) :- not remove_reaction(942,439).
catalyst(1191,439) :- not remove_reaction(1191,439).
catalyst(1192,439) :- not remove_reaction(1192,439).
catalyst(1021,436).
catalyst(1022,436).
catalyst(1250,407).
catalyst(1581,405).
...
catalyst(861,207) :- not remove_reaction(861,207).
catalyst(862,207) :- not remove_reaction(862,207).
catalyst(730,195).
catalyst(220,175).
catalyst(771,170).
catalyst(772,170).
...
catalyst(1511,166).
catalyst(1512,166).
catalyst(771,143) :- not remove_reaction(771,143).
catalyst(772,143) :- not remove_reaction(772,143).
catalyst(791,143) :- not remove_reaction(791,143).
catalyst(792,143) :- not remove_reaction(792,143).
catalyst(801,143) :- not remove_reaction(801,143).
catalyst(802,143) :- not remove_reaction(802,143).
catalyst(811,143) :- not remove_reaction(811,143).
catalyst(812,143) :- not remove_reaction(812,143).
catalyst(861,143) :- not remove_reaction(861,143).
catalyst(862,143) :- not remove_reaction(862,143).
catalyst(791,142) :- not remove_reaction(791,142).
catalyst(792,142) :- not remove_reaction(792,142).
catalyst(801,142) :- not remove_reaction(801,142).
catalyst(802,142) :- not remove_reaction(802,142).
catalyst(811,142) :- not remove_reaction(811,142).
catalyst(812,142) :- not remove_reaction(812,142).
catalyst(831,142) :- not remove_reaction(831,142).
catalyst(832,142) :- not remove_reaction(832,142).
catalyst(841,142) :- not remove_reaction(841,142).
catalyst(842,142) :- not remove_reaction(842,142).
catalyst(861,142) :- not remove_reaction(861,142).
catalyst(862,142) :- not remove_reaction(862,142).
catalyst(6600,139).
catalyst(620,135).
catalyst(540,127).
catalyst(2830,101).
...
modifiable_enzyme(550).
modifiable_enzyme(439).
modifiable_enzyme(207).
modifiable_enzyme(143).
