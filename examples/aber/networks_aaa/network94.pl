...
component("YNL280C",547).
component("YGR060W",328).
component("YGL012W",303).
component("YOL086C",570).
component("YMR303C",524).
component("YGL256W",321).
component("YDL168W",199).
component("YBR145W",155).
component("YPL231W",621).
component("U46_",84).
component("YBR149W",156).
component("YGL001C",300).
component("YIL094C",376).
component("YHR063C",359).
component("YBR153W",157).
component("YML056C",496).
component("YLR432W",492).
component("YHR216W",370).
component("YAR075W",126).
component("YAR073W",125).
component("YDR127W",221).
component("YJR139C",425).
component("YOL126C",574).
component("YDL078C",188).
component("YKL029C",429).
component("YOR136W",584).
component("YDL066W",187).
component("YLR355C",489).
component("YML086C",498).
component("YIL155C",380).
component("YPR191W",649).
component("YOR065W",579).
component("YJL166W",403).
component("YHR001W-A",354).
component("YGR183C",339).
component("YFR033C",296).
component("YDR529C",254).
component("YBL045C",132).
component("Q0105",18).
component("YGR088W",330).
component("YDR256C",235).
component("YJR078W",416).
component("YJR025C",410).
component("YGR255C",348).
component("YBL098W",135).
component("YMR015C",504).
component("YDR402C",246).
component("YGL055W",308).
component("YGR175C",336).
component("YJR104C",419).
component("YHR008C",355).
component("YJL026W",387).
component("YGR180C",338).
component("YER070W",274).
component("U35_",80).
component("YDL168W",200).
component("YDR158W",229).
component("YPL276W",630).
component("YPL275W",629).
component("YOR388C",607).
component("YOR374W",604).
component("YER073W",275).
component("YGL154C",314).
component("U55_",91).
component("YOR323C",596).
component("YMR170C",512).
component("YMR169C",511).
component("U2_",77).
component("YBR221C",165).
component("U52_",88).
component("YBR166C",160).
component("YNL280C",548).
component("YGL012W",304).
component("U57_",92).
component("YDR044W",212).
component("YER014W",263).
component("YKR009C",448).
component("YIL160C",382).
component("YGL205W",317).
component("YMR118C",509).
component("YLR164W",473).
component("YLL041C",456).
component("YKL148C",437).
component("YJL045W",388).
component("YDR178W",230).
component("YJR051W",412).
component("YEL047C",258).
component("YOR375C",605).
component("YDL215C",203).
component("YAL062W",123).
component("U99_",119).
component("YBR035C",143).
component("YHR037W",356).
component("YKR080W",452).
component("YER023W",264).
component("YOR236W",593).
component("YGR204W",341).
component("YLR142W",468).
component("U62_",95).
component("YKL150W",438).
component("YIL043C",372).
component("YHR042W",357).
component("YFR030W",295).
component("YPL017C",610).
component("YFL018C",287).
component("YER042W",266).
component("YJR137C",424).
component("YPL266W",627).
component("YML110C",500).
component("YBR034C",142).
component("YPL273W",628).
component("YLL062C",459).
component("U47_",85).
component("YER091C",278).
component("YJR073C",414).
component("YDL033C",185).
component("YOL096C",571).
component("YLR172C",474).
component("YDR019C",209).
component("YDR408C",248).
component("YBL013W",127).
component("YKL024C",428).
component("YPR074C",641).
component("YBR117C",152).
component("YLR354C",488).
component("YGR043C",326).
component("YCL009C",174).
component("YMR062C",506).
component("YNL071W",530).
component("YNR008W",555).
component("YPL231W",622).
component("YER061C",272).
component("U86_",110).
component("YPL001W",609).
component("YDR148C",227).
component("YOR377W",606).
component("YGR177C",337).
component("YPL231W",623).
component("YGR147C",333).
component("YDL040C",186).
component("YPL028W",611).
component("YGL017W",305).
component("YPR001W",632).
component("YNR001C",553).
component("YDL182W",201).
component("YDL131W",193).
component("YNL117W",533).
component("YIR031C",385).
component("YNL029C",527).
component("YIL085C",375).
component("YMR261C",519).
component("YML100W",499).
component("YBR126C",154).
component("YNL192W",540).
component("YBR038W",145).
component("YBR023C",141).
component("YLR209C",475).
component("U104_",21).
component("YMR300C",523).
component("YER055C",268).
component("YDR354W",242) :- not remove_orf("YDR354W",242).
component("YFR047C",297).
component("YJR133W",423).
component("YLR209C",476).
component("YML022W",493).
component("YDR441C",250).
component("YDR399W",244).
component("YJL167W",404).
component("YNL256W",543).
component("YDR127W",222).
component("YLR303W",482).
component("YGR012W",323).
component("YJR130C",422).
component("YLR303W",483).
component("YDR035W",210).
component("YBR249C",166).
component("YOL143C",576).
component("YBR256C",167).
component("YHR137W",364).
component("YGL202W",316).
component("YLR027C",460).
component("YKL106W",433).
component("YKL104C",432).
component("YGR019W",324).
component("YLR089C",464).
component("U64_",96).
component("U61_",94).
component("U51_",87).
component("YJR148W",426).
component("YGL253W",320).
component("YFR053C",298).
component("YOL136C",575).
component("YIL107C",377).
component("YMR205C",514).
component("YGR240C",344).
component("YDR248C",234).
component("YCR036W",182).
component("YCL040W",177).
component("YJR105W",420).
component("U16_",38).
component("U15_",35).
component("U96_",117).
component("YKL001C",427).
component("YML070W",497).
component("YFL053W",290).
component("YHL032C",352).
component("U83_",108).
component("U82_",107).
component("U81_",106).
component("YMR208W",515).
component("YOR347C",601).
component("YAL038W",122).
component("YNR012W",556).
component("YPR121W",644).
component("YPL258C",625).
component("YOL055C",567).
component("U1_",58).
component("YDR009W",208).
component("YBR020W",139).
component("YNL267W",545).
component("YLR305C",485).
component("YFR019W",293).
component("YDR208W",231).
component("YDR127W",223).
component("U21_",67).
component("U20_",65).
component("YDR147W",226).
component("YDR300C",239).
component("YCR012W",179).
component("U18_",51).
component("U17_",45).
component("U76_",104).
component("YER170W",284).
component("YDR226W",232).
component("YKL067W",431).
component("YDR454C",251).
component("YOL061W",569).
component("YKL181W",440).
component("YHL011C",350).
component("YER099C",280).
component("YBL068W",134).
component("YOR143C",585).
component("YGR007W",322).
component("YLR328W",486).
component("YKR002W",447).
component("YJR010W",409).
component("YCL050C",178).
component("YPR190C",648).
component("YPR187W",647).
component("YPR110C",643).
component("YPR010C",634).
component("YOR341W",600).
component("YOR340C",599).
component("YOR224C",592).
component("YOR210W",591).
component("YOR207C",589).
component("YOR151C",586).
component("YOR116C",582).
component("YOL005C",562).
component("YNR003C",554).
component("YNL248C",542).
component("YNL151C",537).
component("YNL113W",532).
component("YKL144C",436).
component("YJR063W",413).
component("YJL148W",400).
component("YJL140W",399).
component("YIL021W",371).
component("YHR143W-A",365).
component("YGL070C",311).
component("YFL036W",289).
component("YDR404C",247).
component("YDR156W",228).
component("YDR045C",213).
component("YDL150W",197).
component("YDL140C",194).
component("YBR154C",159).
component("YPR175W",646).
component("YPL167C",618).
component("YOR330C",597).
component("YOL115W",573).
component("YNL299W",550).
component("YNL262W",544).
component("YNL102W",531).
component("YJR043C",411).
component("YJR006W",408).
component("YJL090C",392).
component("YIL139C",379).
component("YEL055C",259).
component("YDR419W",249).
component("YDR121W",220).
component("YDL102W",191).
component("YCR014C",180).
component("YBR278W",169).
component("YBL035C",129).
component("YKL035W",430).
component("YHL012W",351).
component("YHR123W",363).
component("YDL142C",196).
component("YER026C",265).
component("YCL004W",173).
component("YJL068C",389).
component("YDR058C",217).
component("YNR034W",559).
component("YHR163W",367).
component("YGR248W",346).
component("YCR073W-A",183).
component("YDL086W",190).
component("YOL011W",564).
component("YMR008C",503).
component("YMR006C",502).
component("U101_",19).
component("YBL015W",128).
component("YJL068C",390).
component("YPL072W",614).
component("YOR124C",583).
component("YNL186W",539).
component("YMR304W",525).
component("YMR223W",517).
component("YKR098C",454).
component("YJL197W",405).
component("YIL156W",381).
component("YFR010W",292).
component("YER151C",282).
component("YER144C",281).
component("YER098W",279).
component("YDR069C",218).
component("YDL122W",192).
component("YBR058C",146).
component("YBL067C",133).
component("U84_",109).
component("YPR073C",639).
component("YHR215W",369).
component("YDL024C",184).
component("YBR093C",150).
component("YBR092C",149).
component("YAR071W",124).
component("YIL053W",374).
component("YER062C",273).
component("YHR046C",358).
component("YGR208W",343).
component("YPL228W",620).
component("YMR180C",513).
component("YDL236W",205).
component("YJL155C",402).
component("YPR073C",640).
component("YOR208W",590).
component("YNL053W",529).
component("YMR036C",505).
component("YIR026C",383).
component("YIL113W",378).
component("YFR028C",294).
component("YER075C",276).
component("YDL230W",204).
component("YBR276C",168).
component("U34_",79).
component("U30_",78).
component("U27_",76).
component("U25_",75).
component("U24_",74).
component("YOR360C",603).
component("YGL248W",319).
component("YKR031C",449).
component("YLR286C",480).
component("YOR190W",587).
component("YLR300W",481).
component("YGR282C",349).
component("YDR261C",236).
component("YDR400W",245).
component("U23_",73).
component("YML035C",494).
component("YJL070C",391).
component("YBR284W",170).
component("U102_",20).
component("YNL045W",528).
component("YLR160C",472).
component("YLR158C",471).
component("YLR157C",470).
component("YLR155C",469).
component("YDR321W",240).
component("YGL037C",307).
component("YDR242W",233).
component("YBR208C",162).
component("YMR281W",522).
component("U53_",89).
component("YIR032C",386).
component("YIR029W",384).
component("YPR062W",638).
component("YMR120C",510).
component("YHR144C",366).
component("YNL141W",534).
component("YBR153W",158).
component("YDL238C",206).
component("YNL141W",535).
component("YLR245C",479).
component("YML035C",495).
component("YJL126W",395).
component("U44_",83).
component("U87_",111).
component("YMR267W",520).
component("YBR011C",136).
component("YBR111C",151).
component("YCL030C",176).
component("YER005W",262).
component("YIL048W",373).
component("YER166W",283).
component("YDR093W",219).
component("YAL026C",121).
component("YLR231C",477).
component("U88_",112).
component("YLR134W",466).
component("YLR044C",461).
component("YGR087C",329).
component("YDR380W",243).
component("YDL080C",189).
component("U98_",118).
component("YMR250W",518).
component("YKL184W",443).
component("YNR043W",560).
component("U93_",116).
component("YDR047W",215).
component("U54_",90).
component("YKL211C",444) :- not remove_orf("YKL211C",444).
component("YNL169C",538).
component("YGR170W",335).
component("YDR294C",237).
component("YEL046C",257).
component("YNR033W",558).
component("YKL211C",445) :- not remove_orf("YKL211C",445).
component("YER090W",445) :- not remove_orf("YER090W",445).
component("YER090W",277) :- not remove_orf("YER090W",277).
component("YDR127W",224).
component("YPL281C",631).
component("YOR393W",608).
component("YMR323W",526).
component("YHR174W",368).
component("YGR254W",347).
component("YGL026C",306) :- not remove_orf("YGL026C",306).
component("YGR155W",334).
component("YLR304C",484).
component("YJL200C",406).
component("YNL316C",551).
component("YKL182W",441).
component("YPL212C",619).
component("YNL292W",549).
component("YGL063W",310).
component("YFL001W",285).
component("YPR002W",633).
component("YDR127W",225).
component("YGL148W",313).
component("YLR359W",490).
component("YAL012W",120).
component("YFR055W",299).
component("YJL121C",394).
component("YBR019C",137).
component("YBR019C",138).
component("YDR050C",216).
component("YDR007W",207) :- not remove_orf("YDR007W",207).
component("YOR095C",581).
component("YER003C",261).
component("YBR196C",161).
component("YGL001C",301).
component("U14_",30).
component("YKL152C",439).
component("YMR105C",507).
component("YKL127W",434).
component("YEL058W",260).
component("YPR060C",637).
component("YHR072W",360).
component("YJL153C",401).
component("YPL097W",615).
component("YGR185C",340).
component("YPL104W",616).
component("YLL018C",455).
component("YPR081C",642).
component("YBR121C",153).
component("YNL247W",541).
component("YOL033W",566).
component("YHR091C",362).
component("YDR341C",241).
component("YOL097C",572).
component("YPR047W",636).
component("YLR060W",462).
component("YFL022C",288).
component("YPR033C",635).
component("YPL160W",617).
component("YLR382C",491).
component("YDR037W",211).
component("YOR335C",598).
component("YGR094W",331).
component("YGR244C",345).
component("U89_",113).
component("YOR241W",594).
component("YMR113W",508).
component("YKL132C",435).
component("YJL101C",393).
component("U92_",115).
component("YGL234W",318).
component("U91_",114).
component("YDL141W",195).
component("YJR103W",418).
component("YBL039C",130).
component("YGR204W",342).
component("YOL058W",568).
component("YBR208C",163).
component("YHR074W",361).
component("YMR217W",516).
component("YOR303W",595).
component("YJR109C",421).
component("YJL130C",397).
component("YGL062W",309).
component("YBR218C",164).
component("YPL231W",624).
component("YNR016C",557).
component("YKL182W",442).
component("YGR037C",325).
component("YOR005C",578).
component("YDL164C",198).
component("YOL010W",563).
component("YPR138C",645).
component("YPL265W",626).
component("YPL057C",613).
component("YPL036W",612).
component("YOR348C",602).
component("YOR192C",588).
component("YOR071C",580).
component("YOL156W",577).
component("YOL020W",565) :- not remove_orf("YOL020W",565).
component("YNR056C",561).
component("YNL318C",552).
component("YNL268W",546).
component("YNL142W",536).
component("YMR272C",521).
component("YML123C",501).
component("YLR348C",487).
component("YLR237W",478).
component("YLR138W",467).
component("YLR100C",465).
component("YLR081W",463).
component("YLL061W",458).
component("YLL043W",457).
component("YKR093W",453).
component("YKR053C",451).
component("YKR039W",450) :- not remove_orf("YKR039W",450).
component("YKL217W",446).
component("YJR095W",417).
component("YJR077C",415).
component("YJL219W",407).
component("YJL134W",398).
component("YJL129C",396).
component("YHL036W",353).
component("YGR121C",332).
component("YGR055W",327).
component("YGL186C",315).
component("YGL077C",312).
component("YGL008C",302).
component("YFL055W",291).
component("YFL011W",286).
component("YER060W-A",271).
component("YER060W",270).
component("YER056C",269).
component("YER053C",267).
component("YEL017C-A",256).
component("YDR536W",255).
component("YDR508C",253).
component("YDR503C",252).
component("YDR294C",238).
component("YDR046C",214) :- not remove_orf("YDR046C",214).
component("YDL210W",202).
component("YCR024C-A",181).
component("YCL025C",175).
component("YBR298C",172).
component("YBR291C",171).
component("YBR069C",148) :- not remove_orf("YBR069C",148).
component("YBR068C",147) :- not remove_orf("YBR068C",147).
component("YBR036C",144).
component("YBR021W",140).
component("YBL042C",131).
component("U79_",105).
component("U75_",103).
component("U74_",102).
component("U73_",101).
...
catalyst(6160,523).
catalyst(3870,268).
catalyst(3620,242) :- not remove_reaction(3620,242).
catalyst(2110,297).
catalyst(2190,297).
catalyst(5550,423).
catalyst(5791,476).
...
catalyst(1960,215).
catalyst(3460,90).
catalyst(3600,444) :- not remove_reaction(3600,444).
catalyst(6890,538).
catalyst(6900,335).
catalyst(8781,237).
catalyst(8782,237).
...
catalyst(8231,347).
catalyst(8232,347).
catalyst(3590,306) :- not remove_reaction(3590,306).
catalyst(10910,306) :- not remove_reaction(10910,306).
catalyst(4570,334).
catalyst(8181,484).
catalyst(8182,484).
catalyst(8181,406).
...
catalyst(8281,216).
catalyst(8282,216).
catalyst(3610,207) :- not remove_reaction(3610,207).
catalyst(7921,581).
catalyst(7922,581).
catalyst(7841,261).
catalyst(7842,261).
...
catalyst(941,565) :- not remove_reaction(941,565).
catalyst(942,565) :- not remove_reaction(942,565).
catalyst(700,561).
catalyst(1200,552).
catalyst(761,546).
catalyst(762,546).
...
catalyst(640,453).
catalyst(6560,451).
catalyst(761,450) :- not remove_reaction(761,450).
catalyst(762,450) :- not remove_reaction(762,450).
catalyst(771,450) :- not remove_reaction(771,450).
catalyst(772,450) :- not remove_reaction(772,450).
catalyst(781,450) :- not remove_reaction(781,450).
catalyst(782,450) :- not remove_reaction(782,450).
catalyst(791,450) :- not remove_reaction(791,450).
catalyst(792,450) :- not remove_reaction(792,450).
catalyst(801,450) :- not remove_reaction(801,450).
catalyst(802,450) :- not remove_reaction(802,450).
catalyst(811,450) :- not remove_reaction(811,450).
catalyst(812,450) :- not remove_reaction(812,450).
catalyst(821,450) :- not remove_reaction(821,450).
catalyst(822,450) :- not remove_reaction(822,450).
catalyst(831,450) :- not remove_reaction(831,450).
catalyst(832,450) :- not remove_reaction(832,450).
catalyst(841,450) :- not remove_reaction(841,450).
catalyst(842,450) :- not remove_reaction(842,450).
catalyst(861,450) :- not remove_reaction(861,450).
catalyst(862,450) :- not remove_reaction(862,450).
catalyst(881,450) :- not remove_reaction(881,450).
catalyst(882,450) :- not remove_reaction(882,450).
catalyst(911,450) :- not remove_reaction(911,450).
catalyst(912,450) :- not remove_reaction(912,450).
catalyst(941,450) :- not remove_reaction(941,450).
catalyst(942,450) :- not remove_reaction(942,450).
catalyst(1191,450) :- not remove_reaction(1191,450).
catalyst(1192,450) :- not remove_reaction(1192,450).
catalyst(1021,446).
catalyst(1022,446).
catalyst(1250,417).
catalyst(1581,415).
...
catalyst(791,148) :- not remove_reaction(791,148).
catalyst(792,148) :- not remove_reaction(792,148).
...
catalyst(861,148) :- not remove_reaction(861,148).
catalyst(862,148) :- not remove_reaction(862,148).
catalyst(791,147) :- not remove_reaction(791,147).
catalyst(792,147) :- not remove_reaction(792,147).
catalyst(801,147) :- not remove_reaction(801,147).
catalyst(802,147) :- not remove_reaction(802,147).
catalyst(811,147) :- not remove_reaction(811,147).
catalyst(812,147) :- not remove_reaction(812,147).
catalyst(831,147) :- not remove_reaction(831,147).
catalyst(832,147) :- not remove_reaction(832,147).
catalyst(841,147) :- not remove_reaction(841,147).
catalyst(842,147) :- not remove_reaction(842,147).
catalyst(861,147) :- not remove_reaction(861,147).
catalyst(862,147) :- not remove_reaction(862,147).
catalyst(6600,144).
catalyst(620,140).
catalyst(540,131).
catalyst(2830,105).
