...
component("YGR060W",159).
component("YGL012W",148).
component("YOL086C",263).
component("YMR303C",243).
component("YGL256W",156).
component("YDL168W",97).
component("YBR145W",75).
component("YPL231W",288).
component("YGL001C",145).
component("YML056C",231).
component("YLR432W",228).
component("YHR216W",176).
component("YAR075W",63).
component("YAR073W",62).
component("YDR127W",107).
component("YJR139C",202).
component("YOR136W",268).
component("YIL155C",180).
component("YJR078W",196).
component("YJR025C",192).
component("YMR015C",235).
component("YDR402C",121).
component("YJR104C",199).
component("YHR008C",170).
component("YER070W",133).
component("YGL154C",154).
component("YOR323C",276).
component("YMR170C",239).
component("YMR169C",238).
component("YBR166C",77).
component("YER014W",130).
component("YMR118C",237).
component("YLR164W",222).
component("YLL041C",218).
component("YKL148C",209).
component("YJL045W",184).
component("YDR178W",113).
component("YJR051W",193).
component("YEL047C",129).
component("YOR375C",281).
component("YDL215C",98).
component("YAL062W",61).
component("YER023W",131).
component("YOR236W",275).
component("YGR204W",165).
component("U62_",45).
component("YPL017C",284).
component("YFL018C",137).
component("U47_",40).
component("YKL024C",205).
component("YPR074C",299).
component("YBR117C",74).
component("YCL009C",86).
component("YPL231W",289).
component("YPL001W",283).
component("YPL231W",290).
component("YPL028W",285).
component("YPR001W",294).
component("YNR001C",255).
component("YNL117W",249).
component("YIR031C",182).
component("YNL029C",245).
component("YIL085C",178).
component("YLR209C",223).
component("YER055C",132).
component("YDR354W",117) :- not remove_orf("YDR354W",117).
component("YFR047C",143).
component("YJR133W",201).
component("YML022W",229).
component("YDR441C",123).
component("YDR399W",119).
component("YDR127W",108).
component("YJR130C",200).
component("YDR035W",103).
component("YBR249C",80).
component("YBR256C",81).
component("YHR137W",172).
component("YLR027C",219).
component("YKL106W",207).
component("U64_",46).
component("U51_",41).
component("YJR148W",203).
component("YGL253W",155).
component("YFR053C",144).
component("YMR205C",241).
component("YGR240C",166).
component("YCR036W",90).
component("U16_",25).
component("U15_",23).
component("YKL001C",204).
component("YML070W",232).
component("YFL053W",139).
component("U83_",56).
component("U82_",55).
component("YMR208W",242).
component("YOR347C",280).
component("YAL038W",60).
component("U1_",32).
component("YNL267W",253).
component("YLR305C",227).
component("YFR019W",141).
component("YDR208W",114).
component("YDR127W",109).
component("U20_",35).
component("YDR300C",116).
component("U18_",29).
component("U76_",54).
component("YDR454C",124).
component("YOL061W",262).
component("YKL181W",210).
component("YHL011C",168).
component("YER099C",136).
component("YBL068W",66).
component("YOR143C",269).
component("YGR007W",157).
component("YCL050C",88).
component("YPR190C",303).
component("YPR187W",302).
component("YPR110C",300).
component("YPR010C",295).
component("YOR341W",279).
component("YOR340C",278).
component("YOR224C",274).
component("YOR210W",273).
component("YOR207C",271).
component("YOR151C",270).
component("YOR116C",267).
component("YOL005C",259).
component("YNR003C",256).
component("YNL248C",252).
component("YNL151C",251).
component("YNL113W",248).
component("YKL144C",208).
component("YJR063W",194).
component("YJL148W",190).
component("YJL140W",189).
component("YIL021W",177).
component("YHR143W-A",173).
component("YGL070C",152).
component("YFL036W",138).
component("YDR404C",122).
component("YDR156W",112).
component("YDR045C",104).
component("YDL150W",95).
component("YDL140C",94).
component("YBR154C",76).
component("YKL035W",206).
component("YHL012W",169).
component("YDR058C",106).
component("YDL086W",93).
component("YOL011W",260).
component("YMR008C",234).
component("YMR006C",233).
component("U101_",18).
component("YBL015W",64).
component("U84_",57).
component("YPR073C",297).
component("YHR215W",175).
component("YDL024C",91).
component("YBR093C",72).
component("YBR092C",71).
component("YPL228W",287).
component("YMR180C",240).
component("YDL236W",100).
component("YJL155C",191).
component("YPR073C",298).
component("YOR208W",272).
component("YNL053W",247).
component("YMR036C",236).
component("YIR026C",181).
component("YIL113W",179).
component("YFR028C",142).
component("YER075C",134).
component("YDL230W",99).
component("YBR276C",82).
component("U34_",39).
component("U30_",38).
component("U24_",37).
component("YKR031C",215).
component("YLR286C",226).
component("YDR400W",120).
component("YML035C",230).
component("YJL070C",185).
component("YBR284W",83).
component("YNL045W",246).
component("YGL037C",150).
component("U53_",42).
component("YIR032C",183).
component("YDL238C",101).
component("YLR245C",225).
component("YJL126W",187).
component("YBR111C",73).
component("YLR231C",224).
component("U88_",58).
component("YLR134W",221).
component("YLR044C",220).
component("YGR087C",160).
component("YDR380W",118).
component("YDL080C",92).
component("U93_",59).
component("U54_",43).
component("YKL211C",213) :- not remove_orf("YKL211C",213).
component("YGR170W",164).
component("YDR294C",115).
component("YNR033W",258).
component("YKL211C",214) :- not remove_orf("YKL211C",214).
component("YER090W",214) :- not remove_orf("YER090W",214).
component("YER090W",135) :- not remove_orf("YER090W",135).
component("YDR127W",110).
component("YPL281C",293).
component("YOR393W",282).
component("YMR323W",244).
component("YHR174W",174).
component("YGR254W",167).
component("YGL026C",149) :- not remove_orf("YGL026C",149).
component("YGR155W",163).
component("YNL316C",254).
component("YKL182W",211).
component("YDR127W",111).
component("YGL148W",153).
component("YBR019C",67).
component("YDR007W",102) :- not remove_orf("YDR007W",102).
component("YOR095C",266).
component("YGL001C",146).
component("YPR060C",296).
component("YOL097C",264).
component("YOR335C",277).
component("YGR094W",161).
component("YJL101C",186).
component("YJR103W",198).
component("YBL039C",65).
component("YBR208C",78).
component("YHR074W",171).
component("YGL062W",151).
component("YBR218C",79).
component("YPL231W",291).
component("YNR016C",257).
component("YKL182W",212).
component("YGR037C",158).
component("YOR005C",265).
component("YDL164C",96).
component("YPR138C",301).
component("YPL265W",292).
component("YPL036W",286).
component("YOL020W",261) :- not remove_orf("YOL020W",261).
component("YNL142W",250).
component("YKR053C",217).
component("YKR039W",216) :- not remove_orf("YKR039W",216).
component("YJR095W",197).
component("YJR077C",195).
component("YJL134W",188).
component("YGR121C",162).
component("YGL008C",147).
component("YFL055W",140).
component("YEL017C-A",128).
component("YDR536W",127).
component("YDR508C",126).
component("YDR503C",125).
component("YDR046C",105) :- not remove_orf("YDR046C",105).
component("YCR024C-A",89).
component("YCL025C",87).
component("YBR298C",85).
component("YBR291C",84).
...
catalyst(5612,223).
catalyst(3870,132).
catalyst(3620,117) :- not remove_reaction(3620,117).
catalyst(2190,143).
catalyst(5550,201).
catalyst(5650,229).
catalyst(5650,123).
...
catalyst(2300,59).
catalyst(3460,43).
catalyst(3600,213) :- not remove_reaction(3600,213).
catalyst(6900,164).
catalyst(8781,115).
catalyst(8782,115).
catalyst(2550,258).
...
catalyst(8231,167).
catalyst(8232,167).
catalyst(3590,149) :- not remove_reaction(3590,149).
catalyst(10910,149) :- not remove_reaction(10910,149).
catalyst(4570,163).
catalyst(3680,254).
catalyst(7141,211).
catalyst(7142,211).
...
catalyst(8711,67).
catalyst(8712,67).
catalyst(3610,102) :- not remove_reaction(3610,102).
catalyst(7921,266).
catalyst(7922,266).
catalyst(6370,146).
catalyst(3690,296).
...
catalyst(781,216) :- not remove_reaction(781,216).
catalyst(782,216) :- not remove_reaction(782,216).
...
catalyst(881,216) :- not remove_reaction(881,216).
catalyst(882,216) :- not remove_reaction(882,216).
catalyst(1191,216) :- not remove_reaction(1191,216).
catalyst(1192,216) :- not remove_reaction(1192,216).
catalyst(1250,197).
catalyst(1581,195).
catalyst(1582,195).
catalyst(6560,188).
