...
component("U56_",147).
component("YNR050C",886).
component("YHR037W",564).
component("YKR080W",717).
component("YER023W",424).
component("YPL023C",969).
component("YGL125W",492).
component("YOR236W",944).
component("YGR204W",535).
component("YLR142W",741).
component("U63_",153).
component("U62_",152).
component("YOR356W",960).
component("YHR068W",569).
component("YKL150W",695).
component("YIL043C",592).
component("YHR042W",565).
component("YOR221C",941).
component("YML120C",794).
component("YKL192C",704).
component("YKL055C",683).
...
component("YGR234W",538).
component("YFR030W",471).
component("YPL017C",968).
component("YFL018C",461).
component("YPL091W",974).
component("YDR353W",388).
component("YER042W",426).
component("YPR167C",1025).
component("YJR137C",669).
component("YNL052W",843).
component("YMR256C",827).
component("YLR395C",774).
component("YLR038C",730).
component("YIL111W",600).
component("YHR051W",567).
component("YGL191W",498).
component("YGL187C",497).
component("YDL067C",297).
component("Q0275",20).
component("Q0250",19).
component("YPL266W",997).
component("YML110C",793).
component("YBR034C",221).
component("YPL273W",999).
component("YLL062C",727).
component("YDR410C",397).
component("U47_",138).
component("YER091C",447).
component("YJR073C",659).
component("YGR157W",525).
component("YDR120C",354).
component("YML008C",779).
component("YDL033C",291).
component("YOL096C",906).
component("YLR172C",748).
component("YDR019C",335).
component("YBR176W",248).
component("YDR408C",396).
component("YMR120C",811).
component("YBL013W",198).
component("YKL024C",679).
component("YPR074C",1017).
component("YBR117C",236).
component("YLR354C",769).
component("YGR043C",512).
component("YMR108W",808).
component("YCL009C",268).
component("YMR062C",804).
component("YNL071W",845).
component("YNR008W",878).
component("YIL160C",609).
component("YNL277W",869).
component("YDR232W",369).
component("YFL017C",460).
component("YPL231W",991).
component("YER061C",434).
component("U86_",175).
component("YPL001W",967).
component("YMR296C",834).
component("YDR062W",347).
...
component("YDL040C",292).
component("YPL028W",970).
component("YLR195C",749).
component("YGL017W",481).
component("YPR001W",1004).
component("YNR001C",876).
component("YCR005C",278).
component("YNL104C",848).
component("YDL182W",322).
component("YDL131W",309).
component("YNL117W",850).
component("YIR031C",618).
component("YOR321W",951).
component("YJR143C",671).
component("YGR199W",534).
component("YDR307W",382).
component("YDL095W",304).
component("YDL093W",303).
component("YAL023C",190).
component("YOR103C",921).
component("YOR085W",919).
component("YMR149W",814).
component("YML019W",781).
component("YJL002C",621).
component("YEL002C",410).
component("YDL232W",328).
component("YCL043C",273).
component("YNL029C",840).
component("YIL085C",597).
component("YMR261C",828).
component("YML100W",791).
component("YBR126C",240).
component("YNL192W",858).
component("YBR038W",224).
component("YBR023C",220).
component("YMR306W",838).
component("YLR342W",767).
component("YGR032W",510).
component("YPR183W",1028).
component("YLR209C",750).
component("U104_",24).
component("U103_",23).
component("YMR271C",830).
component("YML106W",792).
component("YOR209C",939).
component("YMR300C",835).
component("YER055C",429).
component("YDR354W",389) :- not remove_orf("YDR354W",389).
component("YFR047C",473).
component("YJR133W",668).
component("YLR209C",751).
component("YML022W",782).
component("YDR441C",400).
component("YDR399W",392).
component("YPR176C",1027).
component("YPL172C",982).
component("YNR041C",884).
component("YMR101C",806).
...
component("YFL030W",463).
component("YOR184W",933).
component("YNR058W",889).
component("YIL116W",602).
component("YGL253W",505).
component("YFR053C",474).
component("YOL136C",911).
component("YIL107C",599).
component("YMR013C",800).
component("YMR205C",820).
component("YGR240C",539).
component("YDR248C",372).
component("YCR036W",284).
component("YGR194C",533).
component("YCL040W",272).
component("YJR105W",665).
component("U16_",69).
component("U15_",61).
component("YPL188W",984).
component("YJR049C",655).
component("YEL041W",414).
component("U96_",185).
component("YKL001C",677).
component("YDR236C",370).
component("YML070W",788).
component("YFL053W",465).
component("YHL032C",554).
component("YLR133W",738).
...
component("YOR061W",916).
component("YKL166C",697).
component("YJL164C",640).
component("YIL035C",591).
component("YHR205W",585).
component("YHR102W",576).
component("YGL019W",482).
component("YHR025W",563).
component("YOR347C",958).
component("YAL038W",192).
component("YNR012W",879).
component("YPR121W",1022).
component("YPL258C",994).
component("YOL055C",898).
component("YPL214C",988).
component("U1_",94).
component("YDR009W",334).
component("YBR020W",218).
component("YNL267W",867).
component("YLR305C",761).
component("YFR019W",468).
component("YDR208W",367).
component("YDR127W",358).
component("U21_",107).
component("U20_",102).
component("YDR147W",361).
component("YDR300C",381).
...
component("YER170W",455).
component("YDR226W",368).
component("YKL067W",685).
component("YOL055C",899).
component("YDR454C",401).
component("YJR057W",657).
component("YOL061W",903).
component("YKL181W",699).
component("YHL011C",551).
component("YER099C",449).
component("YBL068W",207).
component("YOR143C",929).
component("YNL256W",864).
component("YLR328W",765).
component("YBR018C",214).
component("YBR018C",215).
component("YGR007W",507).
component("YLR328W",766).
component("YKR002W",711).
component("U80_",169).
component("YDL103C",307).
component("U94_",184).
component("YJR010W",651).
component("YCL050C",274).
component("YGL130W",493).
component("YDR530C",407).
component("YCL050C",275).
component("YPR190C",1030).
component("YPR187W",1029).
component("YPR110C",1020).
component("YPR010C",1007).
component("YOR341W",957).
component("YOR340C",956).
component("YOR224C",943).
component("YOR210W",940).
component("YOR207C",937).
component("YOR151C",930).
component("YOR116C",922).
component("YOL005C",891).
component("YNR003C",877).
component("YNL248C",862).
component("YNL151C",855).
component("YNL113W",849).
component("YKL144C",693).
component("YJR063W",658).
component("YJL148W",637).
component("YJL140W",636).
component("YIL021W",590).
component("YHR143W-A",579).
component("YGL070C",490).
component("YFL036W",464).
component("YDR404C",395).
component("YDR156W",363).
component("YDR045C",340).
component("YDL150W",316).
component("YDL140C",311).
component("YBR154C",246).
component("YPR175W",1026).
component("YPL167C",981).
component("YOR330C",953).
component("YOL115W",909).
component("YNL299W",873).
component("YNL262W",866).
component("YNL102W",847).
component("YJR043C",654).
component("YJR006W",650).
component("YJL090C",628).
component("YIL139C",605).
component("YEL055C",417).
component("YDR419W",398).
component("YDR121W",355).
component("YDL102W",306).
component("YCR014C",280).
component("YBR278W",262).
component("YBL035C",201).
component("YKL035W",682).
component("YHL012W",552).
component("YHR123W",577).
component("YPR113W",1021).
component("YBR243C",255).
component("YNL130C",851).
component("YDL142C",315).
component("YPL148C",979).
component("YER026C",425).
component("YCL004W",267).
component("YOR251C",946).
component("YGR286C",548).
component("YJL068C",625).
component("YDR058C",345).
component("YNR034W",883).
component("YHR163W",581).
component("YGR248W",541).
...
component("YOR124C",923).
component("YNL186W",857).
component("YMR304W",837).
component("YMR223W",824).
component("YKR098C",721).
component("YJL197W",644).
component("YIL156W",607).
component("YFR010W",467).
component("YER151C",453).
component("YER144C",452).
component("YER098W",448).
component("YDR069C",348).
component("YDL122W",308).
component("YBR058C",226).
component("YBL067C",206).
component("YDR272W",376).
component("U84_",173).
component("YDR481C",402).
component("YLR377C",772).
component("YDR074W",349).
component("YFR025C",469).
component("YPL179W",983).
component("YNR032W",881).
component("YML057W",787).
component("YML016C",780).
component("YLR433C",776).
component("YGR123C",520).
component("YER133W",451).
component("YER089C",445).
component("YDR436W",399).
component("YDR075W",350).
component("YDL188C",323).
component("YDL134C",310).
component("YDL047W",293).
component("YDL006W",287).
component("YBR125C",239).
component("YBL056W",205).
component("YPR073C",1015).
component("YHR215W",587).
component("YDL024C",290).
component("YBR093C",233).
component("YBR092C",232).
component("YAR071W",195).
component("YIL053W",594).
component("YER062C",435).
component("YHR046C",566).
component("U9_",188).
component("YGR208W",537).
component("YPL228W",989).
component("YMR180C",817).
component("YDL236W",329).
component("YJL155C",639).
component("YPR073C",1016).
component("YOR208W",938).
component("YNL053W",844).
component("YMR036C",803).
component("YIR026C",614).
component("YIL113W",601).
component("YFR028C",470).
...
component("YPL268W",998).
component("YOR360C",961).
component("YGL248W",504).
component("YKR031C",714).
component("YPL206C",986).
component("YGL027C",484).
component("YLR286C",756).
...
component("YPR026W",1008).
component("YDR001C",332).
component("YBR001C",209).
component("YOR190W",935).
component("YLR300W",757).
component("YGR282C",547).
component("YDR261C",374).
component("YDR400W",393).
component("U23_",116).
component("YML035C",783).
component("YJL070C",627).
component("YBR284W",263).
component("U102_",22).
component("YNL045W",842).
component("YLR160C",746).
component("YLR158C",745).
component("YLR157C",744).
component("YLR155C",743).
component("YDR321W",383).
component("YGL037C",485).
component("U43_",134).
component("U42_",133).
component("YMR293C",833).
component("YDR242W",371).
component("YLR308W",764).
component("YLR307W",763).
component("YBR208C",251).
component("YMR281W",832).
component("U53_",144).
component("YIR027C",615).
component("YPL111W",977).
component("YIR032C",619).
component("YIR029W",617).
component("YPR062W",1013).
component("YMR120C",812).
component("YLR028C",729).
component("YHR144C",580).
component("YGR267C",546).
component("YNL141W",852).
component("YBL033C",200).
component("YBR153W",245).
component("YDL238C",330).
component("YNL141W",853).
component("YLR245C",754).
...
component("YOR095C",920).
component("YER003C",420).
component("YBR196C",250).
component("YGL001C",477).
component("U14_",53).
component("YOL056W",900).
component("YKL152C",696).
component("YDL021W",288).
component("YMR105C",807).
component("YKL127W",690).
component("YEL058W",418).
component("YPR060C",1012).
component("YHR072W",570).
component("YJL153C",638).
component("YPL097W",975).
component("YGR185C",532).
component("YGR264C",545).
component("YGR171C",527).
component("YHR011W",559).
component("YDR023W",336).
component("YPL104W",976).
component("YLL018C",723).
component("YPR081C",1019).
component("YBR121C",238).
component("YHR020W",562).
component("YER087W",444).
component("YNL247W",861).
component("YOL033W",895).
component("YGL245W",503).
component("YHR091C",572).
component("YDR341C",384).
component("YOL097C",907).
component("YDR268W",375).
component("YPR047W",1011).
component("YLR060W",733).
component("YFL022C",462).
component("YPR033C",1009).
component("YHR019C",560).
component("YCR024C",281).
component("YHR019C",561).
component("YPL160W",980).
component("YLR382C",773).
component("YNL073W",846).
component("YDR037W",338).
component("YOR335C",954).
component("YGR094W",518).
component("YOR317W",950).
component("YMR246W",825).
component("YIL009W",589).
component("YER015W",423).
component("YOR142W",928).
component("YGR244C",540).
component("YPR035W",1010).
component("U89_",178).
component("YOR241W",945).
component("YMR113W",809).
component("YKL132C",691).
component("YOR339C",955).
component("YMR022W",802).
component("YLR306W",762).
component("YKL210W",706).
component("YGR133W",522).
component("YGL058W",487).
component("YER100W",450).
...
component("YGL234W",501).
component("YER183C",457).
component("U91_",181).
component("U90_",180).
...
component("YHR074W",571).
component("YMR217W",822).
component("YGR061C",515).
component("YPR145W",1024).
component("YGR124W",521).
component("YOR303W",949).
component("YJR109C",666).
component("YJL130C",634).
component("YGL062W",488).
...
component("YDL164C",317).
component("YOL010W",892).
component("YPR138C",1023).
component("YPL274W",1000).
component("YPL265W",996).
component("YPL134C",978).
component("YPL057C",972).
component("YPL036W",971).
component("YOR348C",959).
component("YOR222W",942).
component("YOR192C",936).
component("YOR171C",931).
component("YOR130C",925).
component("YOR071C",918).
...
catalyst(1960,342).
catalyst(3460,145).
catalyst(3600,707) :- not remove_reaction(3600,707).
catalyst(8000,720).
catalyst(3941,897).
catalyst(3942,897).
catalyst(6890,856).
...
catalyst(8020,1006).
catalyst(8020,436).
catalyst(1890,708) :- not remove_reaction(1890,708).
catalyst(3630,708) :- not remove_reaction(3630,708).
...
catalyst(8051,995).
catalyst(8052,995).
catalyst(3590,483) :- not remove_reaction(3590,483).
catalyst(10910,483) :- not remove_reaction(10910,483).
catalyst(4570,524).
catalyst(8181,760).
catalyst(8182,760).
catalyst(8181,645).
...
catalyst(941,894) :- not remove_reaction(941,894).
catalyst(942,894) :- not remove_reaction(942,894).
catalyst(1170,890).
catalyst(1180,890).
catalyst(1210,890).
catalyst(700,887).
...
catalyst(650,719).
catalyst(6560,716).
catalyst(761,715) :- not remove_reaction(761,715).
catalyst(762,715) :- not remove_reaction(762,715).
catalyst(771,715) :- not remove_reaction(771,715).
catalyst(772,715) :- not remove_reaction(772,715).
catalyst(781,715) :- not remove_reaction(781,715).
catalyst(782,715) :- not remove_reaction(782,715).
catalyst(791,715) :- not remove_reaction(791,715).
catalyst(792,715) :- not remove_reaction(792,715).
catalyst(801,715) :- not remove_reaction(801,715).
catalyst(802,715) :- not remove_reaction(802,715).
catalyst(811,715) :- not remove_reaction(811,715).
catalyst(812,715) :- not remove_reaction(812,715).
catalyst(821,715) :- not remove_reaction(821,715).
catalyst(822,715) :- not remove_reaction(822,715).
catalyst(831,715) :- not remove_reaction(831,715).
catalyst(832,715) :- not remove_reaction(832,715).
catalyst(841,715) :- not remove_reaction(841,715).
catalyst(842,715) :- not remove_reaction(842,715).
catalyst(861,715) :- not remove_reaction(861,715).
catalyst(862,715) :- not remove_reaction(862,715).
catalyst(881,715) :- not remove_reaction(881,715).
catalyst(882,715) :- not remove_reaction(882,715).
catalyst(901,715) :- not remove_reaction(901,715).
catalyst(902,715) :- not remove_reaction(902,715).
catalyst(911,715) :- not remove_reaction(911,715).
catalyst(912,715) :- not remove_reaction(912,715).
catalyst(921,715) :- not remove_reaction(921,715).
catalyst(922,715) :- not remove_reaction(922,715).
catalyst(941,715) :- not remove_reaction(941,715).
catalyst(942,715) :- not remove_reaction(942,715).
catalyst(1191,715) :- not remove_reaction(1191,715).
catalyst(1192,715) :- not remove_reaction(1192,715).
catalyst(390,710).
catalyst(1021,710).
catalyst(1022,710).
catalyst(1521,689).
...
catalyst(861,341) :- not remove_reaction(861,341).
catalyst(862,341) :- not remove_reaction(862,341).
