...
component("YNL280C",688).
component("YLR056W",579).
component("YGR060W",409).
component("YGL012W",380).
component("YKR009C",563).
component("YOL086C",717).
component("YMR303C",658).
component("YMR083W",636).
component("YGL256W",401).
component("YDL168W",247).
component("YBR145W",187).
component("YPL231W",784).
component("U46_",105).
component("YBR149W",188).
component("YJR159W",534).
component("YGL001C",377).
component("YIL094C",473).
component("YHR063C",452).
component("YBR153W",189).
component("YML056C",621).
component("YLR432W",614).
component("YHR216W",466).
component("YAR075W",152).
component("YAR073W",151).
component("YDR127W",276).
component("YJR139C",528).
component("YOL126C",722).
component("YDL078C",229).
component("YKL029C",539).
component("YOR136W",733).
component("YNL037C",663).
component("YDL066W",228).
component("YNL241C",678).
component("YOL059W",715).
component("YDL022W",223).
component("YLR355C",611).
component("YML054C",620).
component("YDL174C",249).
component("YML086C",624).
component("YIL155C",479).
component("YPR191W",816).
component("YOR065W",727).
component("YJL166W",504).
component("YHR001W-A",442).
component("YGR183C",423).
...
component("YKL026C",538).
component("YIR037W",487).
component("YBR244W",200).
component("YJR078W",519).
component("YJR025C",512).
component("YGR255C",435).
component("U108_",22).
component("YBL098W",162).
component("YMR015C",633).
component("YHR007C",443).
component("YDR402C",309).
component("YGL055W",385).
component("YGR175C",420).
component("YJR104C",522).
component("YHR008C",444).
component("YJL026W",488).
component("YIL066C",471).
component("YGR180C",422).
...
component("YPL276W",795).
component("YPL275W",794).
component("YOR388C",764).
component("YOR374W",761).
component("YER073W",346).
component("U68_",119).
component("YGL154C",393).
component("U55_",113).
component("YOR323C",753).
component("YMR170C",644).
component("YMR169C",643).
component("U2_",95).
component("YER178W",360).
component("YBR221C",198).
component("YIL125W",477).
component("U52_",110).
component("YBR166C",192).
component("YNL280C",689).
component("YGL012W",381).
component("U57_",114).
component("YKL216W",560).
component("YDR044W",265).
component("YER014W",332).
component("YKR009C",564).
component("YIL160C",481).
component("YGL205W",396).
component("YMR118C",640).
component("YLR164W",592).
component("YLL041C",572).
component("YKL148C",550).
component("YKL141W",548).
component("YJL045W",489).
component("YDR178W",285).
component("YJR051W",514).
component("YEL047C",326).
component("YDL215C",253).
component("YOR375C",762).
component("YDL215C",254).
component("YAL062W",149).
component("U99_",144).
component("YBR035C",173).
component("YHR037W",449).
component("YKR080W",568).
component("YER023W",333).
component("YPL023C",768).
component("YGL125W",390).
component("YOR236W",748).
component("YGR204W",427).
component("YLR142W",587).
component("U62_",117).
component("YKL150W",551).
component("YIL043C",468).
component("YHR042W",450).
component("YOR221C",746).
component("YML120C",627).
component("YKL192C",557).
component("YKL055C",541).
component("YER061C",341).
component("YGR234W",430).
component("YFR030W",372).
component("YPL017C",767).
component("YFL018C",364).
component("YER042W",335).
component("YJR137C",527).
component("YPL266W",791).
component("YML110C",626).
component("YBR034C",172).
component("YPL273W",792).
component("YLL062C",575).
component("YDR410C",312).
component("U47_",106).
component("YER091C",352).
component("YJR073C",517).
component("YDL033C",225).
component("YOL096C",718).
component("YLR172C",593).
component("YDR019C",261).
component("YBR176W",193).
component("YDR408C",311).
component("YMR120C",641).
component("YBL013W",153).
component("YKL024C",537).
component("YPR074C",807).
component("YBR117C",183).
component("YLR354C",610).
component("YGR043C",407).
component("YMR108W",638).
component("YCL009C",210).
component("YMR062C",635).
component("YNL071W",666).
component("YNR008W",696).
component("YNL277W",687).
component("YFL017C",363).
component("YPL231W",785).
component("YER061C",342).
component("U86_",134).
component("YPL001W",766).
component("YDR148C",282).
component("YOR377W",763).
component("YGR177C",421).
component("YPL231W",786).
component("YGR147C",417).
component("YDL040C",226).
component("YPL028W",769).
component("YGL017W",382).
component("YPR001W",797).
component("YNR001C",694).
component("YDL182W",250).
component("YDL131W",238).
component("YNL117W",670).
component("YIR031C",485).
component("YOR321W",752).
component("YJR143C",529).
component("YGR199W",426).
component("YDR307W",299).
component("YDL095W",233).
component("YDL093W",232).
component("YAL023C",146).
component("YNL029C",662).
component("YIL085C",472).
component("YMR261C",652).
component("YML100W",625).
component("YBR126C",186).
component("YNL192W",677).
component("YBR038W",175).
component("YBR023C",171).
component("YMR306W",660).
component("YLR342W",608).
component("YGR032W",405).
component("YLR209C",594).
component("U104_",21).
component("YOR209C",744).
component("YMR300C",657).
component("YER055C",337).
component("YDR354W",305) :- not remove_orf("YDR354W",305).
component("YFR047C",374).
component("YJR133W",526).
component("YLR209C",595).
component("YML022W",617).
component("YDR441C",315).
component("YDR399W",307).
component("YJL167W",505).
component("YNL256W",681).
component("YDR127W",277).
component("YLR303W",602).
component("YGR012W",403).
component("YJR130C",525).
component("YLR303W",603).
component("YDR035W",263).
component("YBR249C",201).
component("YOL143C",724).
component("YBR256C",203).
component("YHR137W",460).
component("YGL202W",395).
component("YLR027C",576).
component("YKL106W",545).
component("YKL104C",544).
component("YGR019W",404).
component("YLR089C",582).
component("U64_",118).
component("U61_",116).
component("U51_",109).
component("YJR148W",530).
component("YOR184W",739).
component("YNR058W",704).
component("YIL116W",476).
component("YGL253W",400).
component("YFR053C",375).
component("YOL136C",723).
component("YIL107C",474).
component("YMR013C",632).
component("YMR205C",646).
component("YGR240C",431).
component("YDR248C",290).
component("YCR036W",219).
component("YGR194C",425).
component("YCL040W",213).
component("YJR105W",523).
component("U16_",50).
component("U15_",44).
component("U96_",142).
component("YKL001C",535).
component("YDR236C",288).
component("YML070W",623).
component("YFL053W",367).
component("YHL032C",440).
component("YLR133W",584).
component("YDR531W",322).
component("U83_",132).
component("U82_",131).
component("U81_",130).
component("YMR208W",647).
component("YHR025W",448).
component("YOR347C",758).
component("YAL038W",148).
component("YNR012W",697).
component("YPR121W",810).
component("YPL258C",788).
component("YOL055C",712).
component("YPL214C",782).
component("U1_",73).
component("YDR009W",260).
component("YBR020W",169).
component("YNL267W",685).
component("YLR305C",605).
...
component("U17_",58).
component("U76_",127).
component("YMR220W",649).
component("YER170W",359).
component("YDR226W",287).
component("YKL067W",543).
component("YDR454C",316).
component("YJR057W",515).
component("YOL061W",716).
component("YKL181W",553).
component("YHL011C",438).
component("YER099C",354).
component("YBL068W",161).
component("YOR143C",735).
component("YNL256W",682).
component("YLR328W",606).
component("YBR018C",165).
component("YBR018C",166).
component("YGR007W",402).
component("YLR328W",607).
component("YKR002W",562).
component("YDL103C",236).
component("YJR010W",511).
component("YGL130W",391).
component("YDR530C",321).
component("YCL050C",214).
component("YPR190C",815).
component("YPR187W",814).
component("YPR110C",809).
component("YPR010C",800).
component("YOR341W",757).
component("YOR340C",756).
component("YOR224C",747).
component("YOR210W",745).
component("YOR207C",742).
component("YOR151C",736).
component("YOR116C",730).
component("YOL005C",706).
component("YNR003C",695).
component("YNL248C",680).
component("YNL151C",674).
component("YNL113W",669).
component("YKL144C",549).
component("YJR063W",516).
component("YJL148W",501).
component("YJL140W",500).
component("YIL021W",467).
component("YHR143W-A",461).
...
component("YPR175W",813).
component("YPL167C",778).
component("YOR330C",754).
component("YOL115W",721).
component("YNL299W",691).
component("YNL262W",684).
component("YNL102W",668).
component("YJR043C",513).
component("YJR006W",510).
component("YJL090C",493).
component("YIL139C",478).
...
component("YKL035W",540).
component("YHL012W",439).
component("YHR123W",459).
component("YBR243C",199).
component("YDL142C",244).
component("YPL148C",776).
component("YER026C",334).
component("YCL004W",209).
component("YJL068C",490).
component("YDR058C",270).
component("YNR034W",701).
component("YHR163W",463).
component("YGR248W",433).
component("YCR073W-A",220).
component("YDL086W",231).
component("YOL011W",708).
component("YMR008C",630).
component("YMR006C",629).
component("U101_",19).
component("YBL015W",154).
component("YJL068C",491).
component("YPL072W",772).
component("YOR124C",731).
component("YNL186W",676).
component("YMR304W",659).
component("YMR223W",650).
component("YKR098C",570).
component("YJL197W",506).
component("YIL156W",480).
...
component("YPL179W",779).
component("YNR032W",699).
component("YML057W",622).
component("YML016C",616).
component("YLR433C",615).
...
component("YPR073C",805).
component("YHR215W",465).
component("YDL024C",224).
component("YBR093C",181).
component("YBR092C",180).
component("YAR071W",150).
component("YIL053W",470).
component("YER062C",343).
component("YHR046C",451).
component("YGR208W",429).
component("YPL228W",783).
component("YMR180C",645).
component("YDL236W",256).
component("YJL155C",503).
component("YPR073C",806).
component("YOR208W",743).
component("YNL053W",665).
component("YMR036C",634).
component("YIR026C",482).
component("YIL113W",475).
...
component("U25_",92).
component("U24_",91).
component("YOR360C",760).
component("YGL248W",399).
component("YKR031C",565).
component("YPL206C",780).
component("YLR286C",600).
component("YJR153W",532).
component("YOR190W",740).
component("YLR300W",601).
component("YGR282C",437).
component("YDR261C",292).
component("YDR400W",308).
component("U23_",90).
component("YML035C",618).
component("YJL070C",492).
component("YBR284W",206).
component("U102_",20).
component("YNL045W",664).
component("YLR160C",591).
component("YLR158C",590).
component("YLR157C",589).
component("YLR155C",588).
component("YDR321W",300).
component("YGL037C",384).
component("YMR293C",656).
component("YDR242W",289).
component("YBR208C",195).
component("YMR281W",655).
component("U53_",111).
component("YIR027C",483).
component("YPL111W",775).
component("YIR032C",486).
component("YIR029W",484).
component("YPR062W",804).
component("YMR120C",642).
component("YLR028C",577).
component("YHR144C",462).
component("YGR267C",436).
component("YNL141W",671).
component("YBR153W",190).
component("YDL238C",257).
component("YNL141W",672).
component("YLR245C",598).
component("YML035C",619).
component("YJL126W",496).
component("U44_",104).
component("YDL100C",234).
component("U87_",135).
component("YMR267W",653).
component("YBR011C",164).
component("YBR111C",182).
component("YBR252W",202).
component("YCL030C",212).
component("YER005W",331).
component("YIL048W",469).
component("YER166W",358).
component("YDR093W",274).
component("YAL026C",147).
component("YLR231C",596).
component("U88_",136).
component("YLR134W",585).
component("YLR044C",578).
component("YGR087C",411).
component("YDR380W",306).
component("YDL080C",230).
component("U98_",143).
component("YMR250W",651).
component("YKL184W",556).
component("YNR043W",702).
component("U93_",141).
component("YDR047W",268).
component("U54_",112).
component("YKL211C",558) :- not remove_orf("YKL211C",558).
component("YOL052C",711).
component("YNL169C",675).
component("YGR170W",419).
component("YKL060C",542).
component("YNL256W",683).
component("YDR294C",295).
component("YEL046C",325).
component("YNR033W",700).
component("YPR006C",799).
component("YER065C",344).
component("YKL211C",559) :- not remove_orf("YKL211C",559).
component("YER090W",559) :- not remove_orf("YER090W",559).
component("YER090W",351) :- not remove_orf("YER090W",351).
component("YDR127W",279).
component("YPL281C",796).
component("YOR393W",765).
component("YMR323W",661).
component("YHR174W",464).
component("YGR254W",434).
component("YPL262W",789).
component("YGL026C",383) :- not remove_orf("YGL026C",383).
component("YGR155W",418).
component("YLR304C",604).
component("YJL200C",507).
component("YNL316C",692).
component("YKL182W",554).
component("YPL212C",781).
component("YNL292W",690).
component("YGL063W",387).
component("YFL001W",361).
component("YOR278W",750).
component("YPR002W",798).
component("YDR127W",280).
component("YGL148W",392).
component("YER086W",348).
component("YLR359W",612).
component("YAL012W",145).
component("YFR055W",376).
component("YOR176W",738).
component("YJL121C",495).
component("YBR019C",167).
component("YBR019C",168).
component("YDR050C",269).
component("YDR007W",259) :- not remove_orf("YDR007W",259).
component("YOR095C",729).
component("YER003C",330).
component("YBR196C",194).
component("YGL001C",378).
component("U14_",37).
component("YOL056W",713).
component("YKL152C",552).
component("YDL021W",222).
component("YMR105C",637).
component("YKL127W",546).
component("YEL058W",328).
component("YPR060C",803).
component("YHR072W",453).
component("YJL153C",502).
component("YPL097W",773).
component("YGR185C",424).
component("YHR011W",445).
component("YDR023W",262).
component("YPL104W",774).
component("YLL018C",571).
component("YPR081C",808).
component("YBR121C",184).
component("YHR020W",447).
component("YER087W",349).
component("YNL247W",679).
component("YOL033W",710).
component("YHR091C",455).
component("YDR341C",301).
component("YOL097C",719).
component("YDR268W",293).
component("YPR047W",802).
component("YLR060W",580).
component("YFL022C",365).
component("YPR033C",801).
component("YHR019C",446).
component("YPL160W",777).
component("YLR382C",613).
component("YNL073W",667).
component("YDR037W",264).
component("YOR335C",755).
component("YGR094W",413).
component("YOR142W",734).
component("YGR244C",432).
component("U89_",137).
component("YOR241W",749).
component("YMR113W",639).
component("YKL132C",547).
component("YJL101C",494).
component("U92_",140).
...
component("YJR103W",521).
component("YBL039C",156).
component("YGR204W",428).
component("YBR084W",179).
component("YOL058W",714).
component("YBR208C",196).
component("YHR074W",454).
component("YMR217W",648).
component("YGR061C",410).
component("YPR145W",812).
component("YGR124W",416).
component("YOR303W",751).
component("YJR109C",524).
component("YJL130C",498).
component("YGL062W",386).
component("YBR218C",197).
component("YPL231W",787).
component("YNR016C",698).
component("YKL182W",555).
component("YGR037C",406).
component("YOR005C",726).
component("YDL164C",246).
component("YOL010W",707).
component("YPR138C",811).
component("YPL274W",793).
component("YPL265W",790).
component("YPL057C",771).
component("YPL036W",770).
component("YOR348C",759).
component("YOR192C",741).
component("YOR171C",737).
component("YOR130C",732).
component("YOR071C",728).
component("YOL156W",725).
component("YOL103W",720).
component("YOL020W",709) :- not remove_orf("YOL020W",709).
component("YNR072W",705).
component("YNR056C",703).
component("YNL318C",693).
component("YNL268W",686).
component("YNL142W",673).
component("YMR272C",654).
component("YMR011W",631).
component("YML123C",628).
component("YLR348C",609).
component("YLR260W",599).
component("YLR237W",597).
component("YLR138W",586).
component("YLR100C",583).
component("YLR081W",581).
component("YLL061W",574).
component("YLL043W",573).
component("YKR093W",569).
component("YKR053C",567).
component("YKR039W",566) :- not remove_orf("YKR039W",566).
component("YKL217W",561).
component("YKL004W",536).
component("YJR158W",533).
component("YJR152W",531).
component("YJR095W",520).
component("YJR077C",518).
component("YJL219W",509).
component("YJL214W",508).
component("YJL134W",499).
component("YJL129C",497).
component("YHR096C",458).
component("YHR094C",457).
component("YHR092C",456).
component("YHL036W",441).
...
catalyst(1960,268).
catalyst(3460,112).
catalyst(3600,558) :- not remove_reaction(3600,558).
catalyst(3941,711).
catalyst(3942,711).
catalyst(6890,675).
catalyst(6900,419).
...
catalyst(8020,799).
catalyst(8020,344).
catalyst(1890,559) :- not remove_reaction(1890,559).
catalyst(3630,559) :- not remove_reaction(3630,559).
...
catalyst(640,569).
catalyst(6560,567).
catalyst(761,566) :- not remove_reaction(761,566).
catalyst(762,566) :- not remove_reaction(762,566).
catalyst(771,566) :- not remove_reaction(771,566).
catalyst(772,566) :- not remove_reaction(772,566).
catalyst(781,566) :- not remove_reaction(781,566).
catalyst(782,566) :- not remove_reaction(782,566).
catalyst(791,566) :- not remove_reaction(791,566).
catalyst(792,566) :- not remove_reaction(792,566).
catalyst(801,566) :- not remove_reaction(801,566).
catalyst(802,566) :- not remove_reaction(802,566).
catalyst(811,566) :- not remove_reaction(811,566).
catalyst(812,566) :- not remove_reaction(812,566).
catalyst(821,566) :- not remove_reaction(821,566).
catalyst(822,566) :- not remove_reaction(822,566).
catalyst(831,566) :- not remove_reaction(831,566).
catalyst(832,566) :- not remove_reaction(832,566).
catalyst(841,566) :- not remove_reaction(841,566).
catalyst(842,566) :- not remove_reaction(842,566).
catalyst(861,566) :- not remove_reaction(861,566).
catalyst(862,566) :- not remove_reaction(862,566).
catalyst(881,566) :- not remove_reaction(881,566).
catalyst(882,566) :- not remove_reaction(882,566).
catalyst(901,566) :- not remove_reaction(901,566).
catalyst(902,566) :- not remove_reaction(902,566).
catalyst(911,566) :- not remove_reaction(911,566).
catalyst(912,566) :- not remove_reaction(912,566).
catalyst(941,566) :- not remove_reaction(941,566).
catalyst(942,566) :- not remove_reaction(942,566).
catalyst(1191,566) :- not remove_reaction(1191,566).
catalyst(1192,566) :- not remove_reaction(1192,566).
catalyst(1021,561).
catalyst(1022,561).
catalyst(6610,536).
catalyst(1210,533).
