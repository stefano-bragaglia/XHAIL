...
component("YGR060W",227).
component("YGL012W",212).
component("YOL086C",386).
component("YMR303C",356).
component("YGL256W",222).
component("YDL168W",140).
component("YBR145W",108).
component("YPL231W",425).
component("YGL001C",209).
component("YML056C",338).
component("YLR432W",335).
component("YHR216W",254).
component("YAR075W",92).
component("YAR073W",91).
component("YDR127W",155).
component("YJR139C",291).
component("YOR136W",394).
component("YDL066W",133).
component("YIL155C",262).
component("YPR191W",448).
component("YOR065W",390).
component("YJL166W",276).
component("YHR001W-A",244).
component("YGR183C",234).
component("YFR033C",206).
component("YDR529C",181).
component("YBL045C",96).
component("Q0105",18).
component("YJR078W",284).
component("YJR025C",279).
component("YBL098W",98).
component("YMR015C",343).
component("YDR402C",174).
component("YJR104C",287).
component("YHR008C",245).
component("YER070W",193).
component("U35_",56).
component("YDL168W",141).
component("YPL276W",433).
component("YPL275W",432).
component("YOR388C",415).
component("YGL154C",219).
component("U55_",63).
component("YOR323C",406).
component("YMR170C",351).
component("YMR169C",350).
component("U2_",53).
component("YBR166C",111).
component("YNL280C",371).
component("YER014W",188).
component("YMR118C",348).
component("YLR164W",321).
component("YLL041C",316).
component("YKL148C",301).
component("YJL045W",266).
component("YDR178W",161).
component("YJR051W",281).
component("YEL047C",185).
component("YOR375C",414).
component("YDL215C",143).
component("YAL062W",90).
component("U99_",86).
component("YBR035C",101).
component("YKR080W",314).
component("YER023W",189).
component("YOR236W",403).
component("YGR204W",235).
component("U62_",65).
component("YKL150W",302).
component("YIL043C",256).
component("YHR042W",246).
component("YPL017C",418).
component("YFL018C",200).
component("YPL273W",431).
component("YLL062C",317).
component("U47_",58).
component("YDL033C",131).
component("YKL024C",294).
component("YPR074C",441).
component("YBR117C",107).
component("YCL009C",122).
component("YMR062C",345).
component("YPL231W",426).
component("U86_",79).
component("YPL001W",417).
component("YPL231W",427).
component("YGR147C",231).
component("YDL040C",132).
component("YPL028W",419).
component("YPR001W",435).
component("YNR001C",375).
component("YDL182W",142).
component("YNL117W",363).
component("YIR031C",264).
component("YNL029C",358).
component("YIL085C",259).
component("YLR209C",322).
component("YMR300C",355).
component("YER055C",191).
component("YDR354W",170) :- not remove_orf("YDR354W",170).
component("YFR047C",207).
component("YJR133W",290).
component("YLR209C",323).
component("YML022W",336).
component("YDR441C",177).
component("YDR399W",172).
component("YNL256W",368).
component("YDR127W",156).
component("YLR303W",329).
component("YJR130C",289).
component("YLR303W",330).
component("YDR035W",148).
component("YBR249C",115).
component("YBR256C",116).
component("YHR137W",249).
component("YGL202W",220).
component("YLR027C",318).
component("YKL106W",297).
component("YKL104C",296).
component("YGR019W",224).
component("U64_",66).
component("U51_",60).
component("YJR148W",292).
component("YGL253W",221).
component("YFR053C",208).
component("YMR205C",353).
component("YGR240C",236).
component("YDR248C",165).
component("YCR036W",129).
component("YCL040W",124).
component("YJR105W",288).
component("U16_",32).
component("U15_",29).
component("U96_",84).
component("YKL001C",293).
component("YML070W",339).
component("YFL053W",202).
component("YHL032C",242).
component("U83_",77).
component("U82_",76).
component("YMR208W",354).
component("YOR347C",411).
component("YAL038W",89).
component("YPR121W",443).
component("YPL258C",429).
component("YOL055C",383).
component("U1_",41).
component("YNL267W",370).
component("YLR305C",332).
component("YFR019W",204).
component("YDR208W",162).
component("YDR127W",157).
component("U21_",46).
component("U20_",45).
component("YDR300C",168).
component("YCR012W",126).
component("U18_",38).
component("U76_",74).
component("YER170W",198).
component("YDR226W",163).
component("YDR454C",178).
component("YOL061W",385).
component("YKL181W",304).
component("YHL011C",240).
component("YER099C",196).
component("YBL068W",97).
component("YOR143C",395).
component("YGR007W",223).
component("YLR328W",333).
component("YCL050C",125).
component("YPR190C",447).
component("YPR187W",446).
component("YPR110C",442).
component("YPR010C",437).
component("YOR341W",410).
component("YOR340C",409).
component("YOR224C",402).
component("YOR210W",401).
component("YOR207C",399).
component("YOR151C",396).
component("YOR116C",393).
component("YOL005C",380).
component("YNR003C",376).
component("YNL248C",367).
component("YNL151C",366).
component("YNL113W",362).
component("YKL144C",300).
component("YJR063W",282).
component("YJL148W",274).
component("YJL140W",273).
component("YIL021W",255).
component("YHR143W-A",250).
component("YGL070C",217).
component("YFL036W",201).
component("YDR404C",175).
component("YDR156W",160).
component("YDR045C",149).
component("YDL150W",138).
component("YDL140C",137).
component("YBR154C",110).
component("YPR175W",445).
component("YPL167C",422).
component("YOR330C",407).
component("YOL115W",388).
component("YNL299W",373).
component("YNL262W",369).
component("YNL102W",361).
component("YJR043C",280).
component("YJR006W",278).
component("YJL090C",268).
component("YIL139C",261).
component("YEL055C",186).
component("YDR419W",176).
component("YDR121W",154).
component("YDL102W",136).
component("YCR014C",127).
component("YBR278W",118).
component("YBL035C",94).
component("YKL035W",295).
component("YHL012W",241).
component("YER026C",190).
component("YDR058C",152).
component("YDL086W",135).
component("YOL011W",381).
component("YMR008C",342).
component("YMR006C",341).
component("U101_",19).
component("YBL015W",93).
component("U84_",78).
component("YPR073C",439).
component("YHR215W",253).
component("YDL024C",130).
component("YBR093C",105).
component("YBR092C",104).
component("YIL053W",258).
component("YER062C",192).
component("YPL228W",424).
component("YMR180C",352).
component("YDL236W",145).
component("YJL155C",275).
component("YPR073C",440).
component("YOR208W",400).
component("YNL053W",360).
component("YMR036C",344).
component("YIR026C",263).
component("YIL113W",260).
component("YFR028C",205).
component("YER075C",194).
component("YDL230W",144).
component("YBR276C",117).
component("U34_",55).
component("U30_",54).
component("U25_",52).
component("U24_",51).
component("YOR360C",413).
component("YKR031C",311).
component("YLR286C",327).
component("YOR190W",397).
component("YLR300W",328).
component("YGR282C",239).
component("YDR261C",166).
component("YDR400W",173).
component("U23_",50).
component("YML035C",337).
component("YJL070C",267).
component("YBR284W",119).
component("YNL045W",359).
component("YGL037C",214).
component("YDR242W",164).
component("YBR208C",112).
component("U53_",61).
component("YIR032C",265).
component("YMR120C",349).
component("YHR144C",251).
component("YBR153W",109).
component("YDL238C",146).
component("YNL141W",364).
component("YLR245C",326).
component("YJL126W",270).
component("U87_",80).
component("YBR111C",106).
component("YER005W",187).
component("YIL048W",257).
component("YER166W",197).
component("YDR093W",153).
component("YAL026C",88).
component("YLR231C",324).
component("U88_",81).
component("YLR134W",320).
component("YLR044C",319).
component("YGR087C",228).
component("YDR380W",171).
component("YDL080C",134).
component("U98_",85).
component("YKL184W",307).
component("YNR043W",379).
component("U93_",83).
component("U54_",62).
component("YKL211C",308) :- not remove_orf("YKL211C",308).
component("YGR170W",233).
component("YDR294C",167).
component("YEL046C",184).
component("YNR033W",378).
component("YKL211C",309) :- not remove_orf("YKL211C",309).
component("YER090W",309) :- not remove_orf("YER090W",309).
component("YER090W",195) :- not remove_orf("YER090W",195).
component("YDR127W",158).
component("YPL281C",434).
component("YOR393W",416).
component("YMR323W",357).
component("YHR174W",252).
component("YGR254W",238).
component("YGL026C",213) :- not remove_orf("YGL026C",213).
component("YGR155W",232).
component("YLR304C",331).
component("YJL200C",277).
component("YNL316C",374).
component("YKL182W",305).
component("YPL212C",423).
component("YNL292W",372).
component("YGL063W",216).
component("YFL001W",199).
component("YPR002W",436).
component("YDR127W",159).
component("YGL148W",218).
component("YAL012W",87).
component("YBR019C",99).
component("YDR050C",151).
component("YDR007W",147) :- not remove_orf("YDR007W",147).
component("YOR095C",392).
component("YGL001C",210).
component("YKL152C",303).
component("YMR105C",346).
component("YKL127W",298).
component("YPR060C",438).
component("YPL104W",421).
component("YLL018C",315).
component("YHR091C",248).
component("YDR341C",169).
component("YOL097C",387).
component("YOR335C",408).
component("YGR094W",229).
component("YGR244C",237).
component("U89_",82).
component("YOR241W",404).
component("YMR113W",347).
component("YKL132C",299).
component("YJL101C",269).
component("YJR103W",286).
component("YBL039C",95).
component("YOL058W",384).
component("YBR208C",113).
component("YHR074W",247).
component("YOR303W",405).
component("YGL062W",215).
component("YBR218C",114).
component("YPL231W",428).
component("YNR016C",377).
component("YKL182W",306).
component("YGR037C",225).
component("YOR005C",389).
component("YDL164C",139).
component("YPR138C",444).
component("YPL265W",430).
component("YPL036W",420).
component("YOR348C",412).
component("YOR192C",398).
component("YOR071C",391).
component("YOL020W",382) :- not remove_orf("YOL020W",382).
component("YNL142W",365).
component("YML123C",340).
component("YLR348C",334).
component("YLR237W",325).
component("YKR053C",313).
component("YKR039W",312) :- not remove_orf("YKR039W",312).
component("YKL217W",310).
component("YJR095W",285).
component("YJR077C",283).
component("YJL134W",272).
component("YJL129C",271).
component("YHL036W",243).
component("YGR121C",230).
component("YGR055W",226).
component("YGL008C",211).
component("YFL055W",203).
component("YEL017C-A",183).
component("YDR536W",182).
component("YDR508C",180).
component("YDR503C",179).
component("YDR046C",150) :- not remove_orf("YDR046C",150).
component("YCR024C-A",128).
component("YCL025C",123).
component("YBR298C",121).
component("YBR291C",120).
component("YBR069C",103) :- not remove_orf("YBR069C",103).
component("YBR068C",102) :- not remove_orf("YBR068C",102).
component("YBR021W",100).
component("U79_",75).
component("U75_",73).
component("U74_",72).
component("U73_",71).
...
catalyst(6160,355).
catalyst(3870,191).
catalyst(3620,170) :- not remove_reaction(3620,170).
catalyst(2190,207).
catalyst(5550,290).
catalyst(5791,323).
catalyst(5792,323).
...
catalyst(2300,83).
catalyst(3460,62).
catalyst(3600,308) :- not remove_reaction(3600,308).
catalyst(6900,233).
catalyst(8781,167).
catalyst(8782,167).
catalyst(4560,184).
catalyst(2550,378).
catalyst(3630,309) :- not remove_reaction(3630,309).
catalyst(3630,195) :- not remove_reaction(3630,195).
catalyst(3740,158).
catalyst(8231,434).
catalyst(8232,434).
catalyst(8231,416).
...
catalyst(8231,238).
catalyst(8232,238).
catalyst(3590,213) :- not remove_reaction(3590,213).
catalyst(10910,213) :- not remove_reaction(10910,213).
catalyst(4570,232).
catalyst(8181,331).
catalyst(8182,331).
catalyst(8181,277).
...
catalyst(190,398).
catalyst(190,391).
catalyst(801,382) :- not remove_reaction(801,382).
catalyst(802,382) :- not remove_reaction(802,382).
catalyst(811,382) :- not remove_reaction(811,382).
catalyst(812,382) :- not remove_reaction(812,382).
catalyst(831,382) :- not remove_reaction(831,382).
catalyst(832,382) :- not remove_reaction(832,382).
catalyst(941,382) :- not remove_reaction(941,382).
catalyst(942,382) :- not remove_reaction(942,382).
catalyst(371,365).
catalyst(372,365).
catalyst(341,340).
catalyst(342,340).
...
catalyst(941,312) :- not remove_reaction(941,312).
catalyst(942,312) :- not remove_reaction(942,312).
