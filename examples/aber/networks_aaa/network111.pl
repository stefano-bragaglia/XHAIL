...
component("YNL280C",624).
component("YGR060W",370).
component("YGL012W",345).
component("YKR009C",508).
component("YOL086C",652).
component("YMR303C",597).
component("YMR083W",575).
component("YGL256W",363).
component("YDL168W",224).
component("YBR145W",168).
component("YPL231W",712).
component("U46_",91).
component("YBR149W",169).
component("YJR159W",480).
component("YGL001C",342).
component("YIL094C",424).
component("YHR063C",407).
component("YBR153W",170).
component("YML056C",562).
component("YLR432W",556).
component("YHR216W",418).
component("YAR075W",135).
component("YAR073W",134).
component("YDR127W",250).
component("YJR139C",476).
component("YOL126C",657).
component("YDL078C",207).
component("YKL029C",485).
component("YOR136W",667).
component("YNL037C",601).
component("YDL066W",206).
component("YNL241C",616).
component("YOL059W",650).
component("YDL022W",201).
component("YLR355C",553).
component("YDL174C",226).
component("YML086C",565).
component("YIL155C",430).
component("YPR191W",740).
component("YOR065W",662).
component("YJL166W",454).
component("YHR001W-A",399).
component("YGR183C",382).
component("YFR033C",338).
component("YDR529C",289).
component("YBL045C",141).
component("Q0105",18).
component("YGR088W",372).
component("YDR256C",264).
component("YKL026C",484).
component("YIR037W",437).
component("YBR244W",180).
component("YJR078W",467).
component("YJR025C",461).
component("YGR255C",392).
component("U108_",22).
component("YBL098W",145).
component("YMR015C",572).
component("YDR402C",279).
component("YGL055W",350).
component("YGR175C",379).
component("YJR104C",470).
component("YHR008C",400).
component("YJL026W",438).
component("YGR180C",381).
component("YER070W",311).
component("U35_",87).
component("YDL168W",225).
component("YDR158W",258).
component("YPL276W",721).
component("YPL275W",720).
component("YOR388C",695).
component("YOR374W",692).
component("YER073W",312).
component("YGL154C",356).
component("U55_",98).
component("YOR323C",684).
component("YMR170C",583).
component("YMR169C",582).
component("U2_",84).
component("YBR221C",178).
component("YIL125W",428).
component("U52_",95).
component("YBR166C",173).
component("YNL280C",625).
component("YGL012W",346).
component("U57_",99).
component("YKL216W",505).
component("YDR044W",240).
component("YER014W",299).
component("YKR009C",509).
component("YIL160C",432).
component("YGL205W",359).
component("YMR118C",579).
component("YLR164W",536).
component("YLL041C",517).
component("YKL148C",495).
component("YKL141W",493).
component("YJL045W",439).
component("YDR178W",259).
component("YJR051W",463).
component("YEL047C",294).
component("YOR375C",693).
component("YDL215C",230).
component("YAL062W",132).
component("U99_",127).
component("YBR035C",155).
component("YHR037W",404).
component("YKR080W",513).
component("YER023W",300).
component("YOR236W",680).
component("YGR204W",385).
component("YLR142W",531).
component("U62_",102).
component("YKL150W",496).
component("YIL043C",420).
component("YHR042W",405).
component("YOR221C",678).
component("YML120C",568).
component("YKL192C",502).
component("YKL055C",487).
component("YER061C",308).
component("YFR030W",337).
component("YPL017C",698).
component("YFL018C",329).
component("YER042W",302).
component("YJR137C",475).
component("YPL266W",718).
component("YML110C",567).
component("YBR034C",154).
component("YPL273W",719).
component("YLL062C",520).
component("U47_",92).
component("YER091C",318).
component("YJR073C",465).
component("YDL033C",203).
component("YOL096C",653).
component("YLR172C",537).
component("YDR019C",236).
component("YDR408C",281).
component("YMR120C",580).
component("YBL013W",136).
component("YKL024C",483).
component("YPR074C",732).
component("YBR117C",164).
component("YLR354C",552).
component("YGR043C",368).
component("YMR108W",577).
component("YCL009C",189).
component("YMR062C",574).
component("YNL071W",604).
component("YNR008W",632).
component("YFL017C",328).
component("YPL231W",713).
component("YER061C",309).
component("U86_",117).
component("YPL001W",697).
component("YDR148C",256).
component("YOR377W",694).
component("YGR177C",380).
component("YPL231W",714).
component("YGR147C",376).
component("YDL040C",204).
component("YPL028W",699).
component("YGL017W",347).
component("YPR001W",723).
component("YNR001C",630).
component("YDL182W",227).
component("YDL131W",216).
component("YNL117W",608).
component("YIR031C",435).
component("YOR321W",683).
component("YJR143C",477).
component("YGR199W",384).
component("YDR307W",272).
component("YDL095W",211).
component("YDL093W",210).
component("YAL023C",129).
component("YNL029C",600).
component("YIL085C",423).
component("YMR261C",591).
component("YML100W",566).
component("YBR126C",167).
component("YNL192W",615).
component("YBR038W",157).
component("YBR023C",153).
component("YLR209C",538).
component("U104_",21).
component("YOR209C",676).
component("YMR300C",596).
component("YER055C",304).
component("YDR354W",275) :- not remove_orf("YDR354W",275).
component("YFR047C",339).
component("YJR133W",474).
component("YLR209C",539).
component("YML022W",559).
component("YDR441C",284).
component("YDR399W",277).
component("YJL167W",455).
component("YNL256W",619).
component("YDR127W",251).
component("YLR303W",545).
component("YGR012W",365).
component("YJR130C",473).
component("YLR303W",546).
component("YDR035W",238).
component("YBR249C",181).
component("YOL143C",659).
component("YBR256C",182).
component("YHR137W",412).
component("YGL202W",358).
component("YLR027C",521).
component("YKL106W",490).
component("YKL104C",489).
component("YGR019W",366).
component("YLR089C",526).
component("U64_",103).
component("U61_",101).
component("U51_",94).
component("YJR148W",478).
component("YOR184W",671).
component("YNR058W",640).
component("YIL116W",427).
component("YGL253W",362).
component("YFR053C",340).
component("YOL136C",658).
component("YIL107C",425).
component("YMR205C",585).
component("YGR240C",388).
component("YDR248C",263).
component("YCR036W",197).
component("YCL040W",192).
component("YJR105W",471).
component("U16_",45).
component("U15_",40).
component("U96_",125).
component("YKL001C",481).
component("YML070W",564).
component("YFL053W",332).
component("YHL032C",397).
component("YLR133W",528).
component("YDR531W",290).
component("U83_",115).
component("U82_",114).
component("U81_",113).
component("YMR208W",586).
component("YOR347C",689).
component("YAL038W",131).
component("YNR012W",633).
component("YPR121W",735).
component("YPL258C",716).
component("YOL055C",647).
component("U1_",65).
component("YDR009W",235).
component("YBR020W",151).
component("YNL267W",622).
component("YLR305C",548).
component("YFR019W",335).
component("YDR208W",260).
component("YDR127W",252).
component("U21_",74).
component("U20_",72).
component("YDR147W",255).
component("YDR300C",271).
component("YCR012W",194).
component("U18_",58).
component("U17_",52).
component("U76_",111).
component("YMR220W",588).
component("YER170W",325).
component("YDR226W",261).
component("YKL067W",488).
component("YDR454C",285).
component("YOL061W",651).
component("YKL181W",498).
component("YHL011C",395).
component("YER099C",320).
component("YBL068W",144).
component("YOR143C",669).
component("YLR328W",549).
component("YBR018C",147).
component("YBR018C",148).
component("YGR007W",364).
component("YLR328W",550).
component("YKR002W",507).
component("YDL103C",214).
component("YJR010W",460).
component("YCL050C",193).
component("YPR190C",739).
component("YPR187W",738).
component("YPR110C",734).
component("YPR010C",725).
component("YOR341W",688).
component("YOR340C",687).
component("YOR224C",679).
component("YOR210W",677).
component("YOR207C",674).
component("YOR151C",670).
component("YOR116C",665).
component("YOL005C",641).
component("YNR003C",631).
component("YNL248C",618).
component("YNL151C",612).
component("YNL113W",607).
component("YKL144C",494).
component("YJR063W",464).
component("YJL148W",451).
component("YJL140W",450).
component("YIL021W",419).
component("YHR143W-A",413).
component("YGL070C",353).
component("YFL036W",331).
component("YDR404C",280).
component("YDR156W",257).
component("YDR045C",241).
component("YDL150W",222).
component("YDL140C",218).
component("YBR154C",172).
component("YPR175W",737).
component("YPL167C",707).
component("YOR330C",685).
component("YOL115W",656).
component("YNL299W",627).
component("YNL262W",621).
component("YNL102W",606).
component("YJR043C",462).
component("YJR006W",459).
component("YJL090C",443).
component("YIL139C",429).
component("YEL055C",295).
component("YDR419W",282).
component("YDR121W",249).
component("YDL102W",213).
component("YCR014C",195).
component("YBR278W",184).
component("YBL035C",138).
component("YKL035W",486).
component("YHL012W",396).
component("YHR123W",411).
component("YBR243C",179).
component("YDL142C",221).
component("YER026C",301).
component("YCL004W",188).
component("YJL068C",440).
component("YDR058C",245).
component("YNR034W",637).
component("YHR163W",415).
component("YGR248W",390).
component("YCR073W-A",198).
component("YDL086W",209).
component("YOL011W",643).
component("YMR008C",571).
component("YMR006C",570).
component("U101_",19).
component("YBL015W",137).
component("YJL068C",441).
component("YPL072W",702).
component("YOR124C",666).
component("YNL186W",614).
component("YMR304W",598).
component("YMR223W",589).
component("YKR098C",515).
component("YJL197W",456).
component("YIL156W",431).
component("YFR010W",334).
component("YER151C",323).
component("YER144C",322).
component("YER098W",319).
component("YDR069C",246).
component("YDL122W",215).
component("YBR058C",158).
component("YBL067C",143).
component("YDR272W",267).
component("U84_",116).
component("YPL179W",708).
component("YNR032W",635).
component("YML057W",563).
component("YML016C",558).
component("YLR433C",557).
component("YGR123C",375).
component("YER133W",321).
component("YER089C",316).
component("YDR436W",283).
component("YDR075W",247).
component("YDL188C",228).
component("YDL134C",217).
component("YDL047W",205).
component("YDL006W",199).
component("YBR125C",166).
component("YBL056W",142).
component("YPR073C",730).
component("YHR215W",417).
component("YDL024C",202).
component("YBR093C",162).
component("YBR092C",161).
component("YAR071W",133).
component("YIL053W",422).
component("YER062C",310).
component("YHR046C",406).
component("YGR208W",387).
component("YPL228W",711).
component("YMR180C",584).
component("YDL236W",232).
component("YJL155C",453).
component("YPR073C",731).
component("YOR208W",675).
component("YNL053W",603).
component("YMR036C",573).
component("YIR026C",433).
component("YIL113W",426).
component("YFR028C",336).
component("YER075C",313).
component("YDL230W",231).
component("YBR276C",183).
component("U34_",86).
component("U30_",85).
component("U27_",83).
component("U25_",82).
component("U24_",81).
component("YOR360C",691).
component("YGL248W",361).
component("YKR031C",510).
component("YPL206C",709).
component("YLR286C",543).
component("YJR153W",479).
component("YOR190W",672).
component("YLR300W",544).
component("YGR282C",394).
component("YDR261C",265).
component("YDR400W",278).
component("U23_",80).
component("YML035C",560).
component("YJL070C",442).
component("YBR284W",185).
component("U102_",20).
component("YNL045W",602).
component("YLR160C",535).
component("YLR158C",534).
component("YLR157C",533).
component("YLR155C",532).
component("YDR321W",273).
component("YGL037C",349).
component("YMR293C",595).
component("YDR242W",262).
component("YBR208C",175).
component("YMR281W",594).
component("U53_",96).
component("YPL111W",705).
component("YIR032C",436).
component("YIR029W",434).
component("YPR062W",729).
component("YMR120C",581).
component("YLR028C",522).
component("YHR144C",414).
component("YGR267C",393).
component("YNL141W",609).
component("YBR153W",171).
component("YDL238C",233).
component("YNL141W",610).
component("YLR245C",542).
component("YML035C",561).
component("YJL126W",446).
component("U44_",90).
component("YDL100C",212).
component("U87_",118).
component("YMR267W",592).
component("YBR011C",146).
component("YBR111C",163).
component("YCL030C",191).
component("YER005W",298).
component("YIL048W",421).
component("YER166W",324).
component("YDR093W",248).
component("YAL026C",130).
component("YLR231C",540).
component("U88_",119).
component("YLR134W",529).
component("YLR044C",523).
component("YGR087C",371).
component("YDR380W",276).
component("YDL080C",208).
component("U98_",126).
component("YMR250W",590).
component("YKL184W",501).
component("YNR043W",638).
component("U93_",124).
component("YDR047W",243).
component("U54_",97).
component("YKL211C",503) :- not remove_orf("YKL211C",503).
component("YOL052C",646).
component("YNL169C",613).
component("YGR170W",378).
component("YNL256W",620).
component("YDR294C",268).
component("YEL046C",293).
component("YNR033W",636).
component("YKL211C",504) :- not remove_orf("YKL211C",504).
component("YER090W",504) :- not remove_orf("YER090W",504).
component("YER090W",317) :- not remove_orf("YER090W",317).
component("YDR127W",253).
component("YPL281C",722).
component("YOR393W",696).
component("YMR323W",599).
component("YHR174W",416).
component("YGR254W",391).
component("YGL026C",348) :- not remove_orf("YGL026C",348).
component("YGR155W",377).
component("YLR304C",547).
component("YJL200C",457).
component("YNL316C",628).
component("YKL182W",499).
component("YPL212C",710).
component("YNL292W",626).
component("YGL063W",352).
component("YFL001W",326).
component("YPR002W",724).
component("YDR127W",254).
component("YGL148W",355).
component("YER086W",314).
component("YLR359W",554).
component("YAL012W",128).
component("YFR055W",341).
component("YJL121C",445).
component("YBR019C",149).
component("YBR019C",150).
component("YDR050C",244).
component("YDR007W",234) :- not remove_orf("YDR007W",234).
component("YOR095C",664).
component("YER003C",297).
component("YBR196C",174).
component("YGL001C",343).
component("U14_",34).
component("YOL056W",648).
component("YKL152C",497).
component("YDL021W",200).
component("YMR105C",576).
component("YKL127W",491).
component("YEL058W",296).
component("YPR060C",728).
component("YHR072W",408).
component("YJL153C",452).
component("YPL097W",703).
component("YGR185C",383).
component("YHR011W",401).
component("YDR023W",237).
component("YPL104W",704).
component("YLL018C",516).
component("YPR081C",733).
component("YBR121C",165).
component("YHR020W",403).
component("YER087W",315).
component("YNL247W",617).
component("YOL033W",645).
component("YHR091C",410).
component("YDR341C",274).
component("YOL097C",654).
component("YDR268W",266).
component("YPR047W",727).
component("YLR060W",524).
component("YFL022C",330).
component("YPR033C",726).
component("YHR019C",402).
component("YPL160W",706).
component("YLR382C",555).
component("YNL073W",605).
component("YDR037W",239).
component("YOR335C",686).
component("YGR094W",373).
component("YOR142W",668).
component("YGR244C",389).
component("U89_",120).
component("YOR241W",681).
component("YMR113W",578).
component("YKL132C",492).
component("YJL101C",444).
component("U92_",123).
component("YGL234W",360).
component("U91_",122).
component("U90_",121).
component("YDL141W",219).
component("YDL141W",220).
component("YJR103W",469).
component("YBL039C",139).
component("YGR204W",386).
component("YOL058W",649).
component("YBR208C",176).
component("YHR074W",409).
component("YMR217W",587).
component("YOR303W",682).
component("YJR109C",472).
component("YJL130C",448).
component("YGL062W",351).
component("YBR218C",177).
component("YPL231W",715).
component("YNR016C",634).
component("YKL182W",500).
component("YGR037C",367).
component("YOR005C",661).
component("YDL164C",223).
component("YOL010W",642).
component("YPR138C",736).
component("YPL265W",717).
component("YPL057C",701).
component("YPL036W",700).
component("YOR348C",690).
component("YOR192C",673).
component("YOR071C",663).
component("YOL156W",660).
component("YOL103W",655).
component("YOL020W",644) :- not remove_orf("YOL020W",644).
component("YNR056C",639).
component("YNL318C",629).
component("YNL268W",623).
component("YNL142W",611).
component("YMR272C",593).
component("YML123C",569).
component("YLR348C",551).
component("YLR237W",541).
component("YLR138W",530).
component("YLR100C",527).
component("YLR081W",525).
component("YLL061W",519).
component("YLL043W",518).
component("YKR093W",514).
component("YKR053C",512).
component("YKR039W",511) :- not remove_orf("YKR039W",511).
component("YKL217W",506).
component("YKL004W",482).
component("YJR095W",468).
component("YJR077C",466).
component("YJL219W",458).
component("YJL134W",449).
component("YJL129C",447).
component("YHL036W",398).
component("YGR121C",374).
component("YGR055W",369).
component("YGL186C",357).
component("YGL077C",354).
component("YGL008C",344).
component("YFL055W",333).
component("YFL011W",327).
component("YER060W-A",307).
component("YER060W",306).
component("YER056C",305).
component("YER053C",303).
component("YEL017C-A",292).
component("YDR536W",291).
component("YDR508C",288).
component("YDR503C",287).
component("YDR497C",286).
component("YDR297W",270).
component("YDR294C",269).
component("YDR046C",242) :- not remove_orf("YDR046C",242).
component("YDL210W",229).
component("YCR024C-A",196).
component("YCL025C",190).
component("YBR298C",187).
component("YBR291C",186).
component("YBR069C",160) :- not remove_orf("YBR069C",160).
component("YBR068C",159) :- not remove_orf("YBR068C",159).
component("YBR036C",156).
component("YBR021W",152).
component("YBL042C",140).
component("U79_",112).
component("U75_",110).
component("U74_",109).
component("U73_",108).
...
catalyst(6160,596).
catalyst(3870,304).
catalyst(3620,275) :- not remove_reaction(3620,275).
catalyst(2110,339).
catalyst(2190,339).
catalyst(5550,474).
catalyst(5791,539).
...
catalyst(1960,243).
catalyst(3460,97).
catalyst(3600,503) :- not remove_reaction(3600,503).
catalyst(3941,646).
catalyst(3942,646).
catalyst(6890,613).
catalyst(6900,378).
...
catalyst(4560,293).
catalyst(2550,636).
catalyst(1890,504) :- not remove_reaction(1890,504).
catalyst(3630,504) :- not remove_reaction(3630,504).
catalyst(1890,317) :- not remove_reaction(1890,317).
catalyst(3630,317) :- not remove_reaction(3630,317).
catalyst(3740,253).
catalyst(8231,722).
catalyst(8232,722).
catalyst(8231,696).
...
catalyst(8231,391).
catalyst(8232,391).
catalyst(3590,348) :- not remove_reaction(3590,348).
catalyst(10910,348) :- not remove_reaction(10910,348).
catalyst(4570,377).
catalyst(8181,547).
catalyst(8182,547).
catalyst(8181,457).
...
catalyst(8281,244).
catalyst(8282,244).
catalyst(3610,234) :- not remove_reaction(3610,234).
catalyst(7921,664).
catalyst(7922,664).
catalyst(7841,297).
catalyst(7842,297).
...
catalyst(640,514).
catalyst(6560,512).
catalyst(761,511) :- not remove_reaction(761,511).
catalyst(762,511) :- not remove_reaction(762,511).
catalyst(771,511) :- not remove_reaction(771,511).
catalyst(772,511) :- not remove_reaction(772,511).
catalyst(781,511) :- not remove_reaction(781,511).
catalyst(782,511) :- not remove_reaction(782,511).
catalyst(791,511) :- not remove_reaction(791,511).
catalyst(792,511) :- not remove_reaction(792,511).
catalyst(801,511) :- not remove_reaction(801,511).
catalyst(802,511) :- not remove_reaction(802,511).
catalyst(811,511) :- not remove_reaction(811,511).
catalyst(812,511) :- not remove_reaction(812,511).
catalyst(821,511) :- not remove_reaction(821,511).
catalyst(822,511) :- not remove_reaction(822,511).
catalyst(831,511) :- not remove_reaction(831,511).
catalyst(832,511) :- not remove_reaction(832,511).
catalyst(841,511) :- not remove_reaction(841,511).
catalyst(842,511) :- not remove_reaction(842,511).
catalyst(861,511) :- not remove_reaction(861,511).
catalyst(862,511) :- not remove_reaction(862,511).
catalyst(881,511) :- not remove_reaction(881,511).
catalyst(882,511) :- not remove_reaction(882,511).
catalyst(901,511) :- not remove_reaction(901,511).
catalyst(902,511) :- not remove_reaction(902,511).
catalyst(911,511) :- not remove_reaction(911,511).
catalyst(912,511) :- not remove_reaction(912,511).
catalyst(941,511) :- not remove_reaction(941,511).
catalyst(942,511) :- not remove_reaction(942,511).
catalyst(1191,511) :- not remove_reaction(1191,511).
catalyst(1192,511) :- not remove_reaction(1192,511).
catalyst(1021,506).
catalyst(1022,506).
catalyst(6610,482).
catalyst(1250,468).
...
catalyst(831,242) :- not remove_reaction(831,242).
catalyst(832,242) :- not remove_reaction(832,242).
catalyst(841,242) :- not remove_reaction(841,242).
catalyst(842,242) :- not remove_reaction(842,242).
catalyst(861,242) :- not remove_reaction(861,242).
catalyst(862,242) :- not remove_reaction(862,242).
...
catalyst(1511,186).
catalyst(1512,186).
catalyst(771,160) :- not remove_reaction(771,160).
catalyst(772,160) :- not remove_reaction(772,160).
catalyst(791,160) :- not remove_reaction(791,160).
catalyst(792,160) :- not remove_reaction(792,160).
catalyst(801,160) :- not remove_reaction(801,160).
catalyst(802,160) :- not remove_reaction(802,160).
catalyst(811,160) :- not remove_reaction(811,160).
catalyst(812,160) :- not remove_reaction(812,160).
catalyst(861,160) :- not remove_reaction(861,160).
catalyst(862,160) :- not remove_reaction(862,160).
catalyst(901,160) :- not remove_reaction(901,160).
catalyst(902,160) :- not remove_reaction(902,160).
catalyst(791,159) :- not remove_reaction(791,159).
catalyst(792,159) :- not remove_reaction(792,159).
...
catalyst(861,159) :- not remove_reaction(861,159).
catalyst(862,159) :- not remove_reaction(862,159).
