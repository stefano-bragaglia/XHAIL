...
component("YNL280C",875).
component("YLR056W",737).
component("YGR060W",517).
component("YGL012W",482).
component("YKR009C",717).
component("YOL086C",910).
component("YMR303C",841).
component("YMR083W",810).
component("YGL256W",509).
component("YDL168W",321).
component("YBR145W",243).
component("YPL231W",996).
component("YBR265W",262).
component("U46_",139).
component("YBR149W",244).
component("YBR149W",245).
component("YJR159W",681).
component("YGL001C",479).
component("YIL094C",602).
component("YHR063C",571).
component("U45_",138).
component("YBR153W",246).
component("YML056C",791).
component("YLR432W",780).
component("YHR216W",592).
component("YAR075W",199).
component("YAR073W",198).
component("YCL030C",272).
component("YDR127W",359).
component("YJR139C",675).
component("YML075C",794).
component("YLR450W",783).
component("YOL126C",916).
component("YKL085W",691).
component("YDL078C",301).
component("YKL029C",686).
component("YOR136W",933).
component("YNL037C",846).
component("YDL066W",299).
component("YHR183W",587).
component("YGR256W",547).
component("YNL241C",865).
component("YOL059W",907).
component("YDL022W",292).
component("YLR355C",775).
component("YIL074C",600).
component("YER081W",445).
component("YML054C",790).
component("YDL174C",324).
component("YML086C",795).
component("YIL155C",610).
component("YPR191W",1037).
component("YOR065W",923).
component("YJL166W",646).
component("YHR001W-A",559).
component("YGR183C",534).
component("YFR033C",475).
component("YDR529C",409).
component("YBL045C",206).
component("Q0105",18).
component("YGR088W",520).
component("YDR256C",376).
component("YKL026C",685).
component("YIR037W",624).
component("YBR244W",258).
component("YJR078W",666).
component("U58_",151).
component("YJR025C",658).
component("U107_",26).
component("YGR255C",546).
component("U108_",27).
component("YBL098W",210).
component("YMR015C",806).
component("YHR007C",560).
component("YDR402C",397).
component("YGL055W",489).
component("YGR175C",531).
component("YJR104C",669).
component("YHR008C",561).
component("YJL026W",627).
component("YIL066C",599).
component("YGR180C",533).
component("YER070W",442).
component("U38_",131).
component("U36_",130).
component("U35_",129).
component("YDL168W",322).
component("YDR158W",367).
component("YBR006W",214).
component("YPL276W",1008).
component("YPL275W",1007).
component("YOR388C",971).
component("YOR374W",968).
component("YER073W",443).
component("U68_",158).
component("YGL154C",498).
component("YBR115C",237).
component("U55_",148).
component("YER069W",440).
component("YOR323C",958).
component("YMR170C",821).
component("YMR169C",820).
component("U2_",123).
component("YER178W",459).
component("YBR221C",256).
component("YIL125W",607).
component("U52_",145).
component("YBR166C",249).
component("YNL280C",876).
component("YGL012W",483).
component("YKL182W",705).
component("U57_",150).
component("YKL216W",714).
component("YDR044W",342).
component("YER014W",425).
component("YKR009C",718).
component("YIL160C",612).
component("YGL205W",503).
component("YMR118C",815).
component("YLR164W",752).
component("YLL041C",729).
component("YKL148C",699).
component("YKL141W",697).
component("YJL045W",628).
component("YDR178W",369).
component("YJR051W",661).
component("YEL047C",419).
component("YDL171C",323).
component("YDL215C",328).
component("YOR375C",969).
component("YDL215C",329).
component("YAL062W",195).
component("U99_",189).
component("YBR035C",224).
component("YMR189W",823).
component("U56_",149).
component("YNR050C",891).
component("YHR037W",567).
component("YKR080W",722).
component("YER023W",427).
component("YPL023C",975).
component("YGL125W",495).
component("YOR236W",950).
component("YGR204W",538).
component("YLR142W",746).
component("U63_",155).
component("U62_",154).
component("YOR356W",966).
component("YHR068W",572).
component("YKL150W",700).
component("YIL043C",596).
component("YHR042W",568).
component("YOR221C",947).
component("YML120C",799).
component("YKL192C",709).
component("YKL055C",688).
component("YER061C",436).
component("YBR046C",227).
component("YMR145C",818).
component("YML120C",800).
component("YKL192C",710).
component("YDL085W",303).
component("YGR234W",541).
component("YFR030W",474).
component("YPL017C",974).
component("YFL018C",464).
component("YPL091W",980).
component("YDR353W",391).
component("YER042W",429).
component("YPR167C",1031).
component("YJR137C",674).
component("YNL052W",848).
component("YMR256C",832).
component("YLR395C",779).
component("YLR038C",735).
component("YIL111W",604).
component("YHR051W",570).
component("YGL191W",501).
component("YGL187C",500).
component("YDL067C",300).
component("Q0275",20).
component("Q0250",19).
component("YPL266W",1003).
component("YML110C",798).
component("YBR034C",223).
component("YPL273W",1005).
component("YLL062C",732).
component("YDR410C",400).
component("YOL096C",911).
component("U47_",140).
component("YER091C",450).
component("YJR073C",664).
component("YGR157W",528).
component("YDR120C",357).
component("YML008C",784).
component("YDL033C",294).
component("YOL096C",912).
component("YLR172C",753).
component("YDR019C",338).
component("YBR176W",250).
component("YDR408C",399).
component("YMR120C",816).
component("YBL013W",200).
component("YJL130C",638).
component("YKL024C",684).
component("YPR074C",1023).
component("YBR117C",238).
component("YLR354C",774).
component("YGR043C",515).
component("YMR108W",813).
component("YCL009C",270).
component("YMR062C",809).
component("YNL071W",850).
component("YNR008W",883).
component("YIL160C",613).
component("YNL277W",874).
component("YDR232W",372).
component("YFL017C",463).
component("YPL231W",997).
component("YER061C",437).
component("U86_",177).
component("YPL001W",973).
component("YMR296C",839).
component("YDR062W",350).
component("YDL052C",297).
component("U8_",181).
component("YDR148C",365).
component("YOR377W",970).
component("YGR177C",532).
component("YPL231W",998).
component("YGR147C",526).
component("YDL040C",295).
component("YPL028W",976).
component("YLR195C",754).
component("YGL017W",484).
component("YPR001W",1010).
component("YNR001C",881).
component("YCR005C",281).
component("YNL104C",853).
component("YDL182W",325).
component("YDL131W",312).
component("YNL117W",855).
component("YIR031C",622).
component("YOR321W",957).
component("YJR143C",676).
component("YGR199W",537).
component("YDR307W",385).
component("YDL095W",307).
component("YDL093W",306).
component("YAL023C",192).
component("YOR103C",927).
component("YOR085W",925).
component("YMR149W",819).
component("YML019W",786).
component("YJL002C",625).
component("YEL002C",413).
component("YDL232W",331).
component("YCL043C",276).
component("YNL029C",845).
component("YIL085C",601).
component("YMR261C",833).
component("YML100W",796).
component("YBR126C",242).
component("YNL192W",863).
component("YBR038W",226).
component("YBR023C",222).
component("YMR306W",843).
component("YLR342W",772).
component("YGR032W",513).
component("YPR183W",1034).
component("YLR209C",755).
component("U104_",24).
component("U103_",23).
component("YMR271C",835).
component("YML106W",797).
component("YOR209C",945).
component("YMR300C",840).
component("YER055C",432).
component("YDR354W",392) :- not remove_orf("YDR354W",392).
component("YFR047C",476).
component("YJR133W",673).
component("YLR209C",756).
component("YML022W",787).
component("YDR441C",403).
component("YDR399W",395).
component("YPR176C",1033).
component("YPL172C",988).
component("YNR041C",889).
component("YMR101C",811).
component("YDL090C",305).
component("YBR003W",213).
component("YBR002C",212).
component("YJL167W",647).
component("YJL167W",648).
component("YNL256W",868).
component("YPR069C",1020).
component("YDR127W",360).
component("YLR146C",747).
component("YHR068W",573).
component("YLR303W",763).
component("YGR012W",511).
component("YJR130C",672).
component("YLR303W",764).
component("YDR035W",340).
component("YBR249C",259).
component("YOR274W",953).
component("YOL143C",919).
component("YBR256C",261).
component("YHR137W",582).
component("YGL202W",502).
component("YLR027C",733).
component("YKL106W",693).
component("YOL140W",918).
component("YLR438W",782).
component("YKL104C",692).
component("YGR019W",512).
component("YLR089C",741).
component("YDR111C",356).
component("U64_",156).
component("U61_",153).
component("U51_",144).
component("YJR148W",677).
component("YHR208W",590).
component("YFL030W",466).
component("YOR184W",939).
component("YNR058W",894).
component("YIL116W",606).
component("YGL253W",508).
component("YFR053C",477).
component("YOL136C",917).
component("YIL107C",603).
component("YMR013C",805).
component("YMR205C",825).
component("YGR240C",542).
component("YDR248C",375).
component("YCR036W",287).
component("YGR194C",536).
component("YCL040W",275).
component("YJR105W",670).
component("U16_",71).
component("U15_",62).
component("YPL188W",990).
component("YJR049C",660).
component("YEL041W",417).
component("U96_",187).
component("YKL001C",682).
component("YDR236C",373).
component("YML070W",793).
component("YFL053W",468).
component("YHL032C",557).
component("YLR133W",743).
component("YDR531W",411).
component("U83_",174).
component("U82_",173).
component("U81_",172).
component("YMR208W",826).
component("YPL203W",991).
component("YOR061W",922).
component("YKL166C",702).
component("YJL164C",645).
component("YIL035C",595).
component("YHR205W",589).
component("YHR102W",580).
component("YGL019W",485).
component("YHR025W",566).
component("YOR347C",964).
component("YAL038W",194).
component("YNR012W",884).
component("YPR121W",1028).
component("YPL258C",1000).
component("YOL055C",903).
component("YPL214C",994).
component("U1_",96).
component("YDR009W",337).
component("YBR020W",220).
component("YNL267W",872).
component("YLR305C",766).
component("YFR019W",471).
component("YDR208W",370).
component("YDR127W",361).
component("U21_",109).
component("U20_",104).
component("YDR147W",364).
component("YDR300C",384).
component("YCR012W",282).
component("YER052C",430).
component("YER069W",441).
component("U19_",95).
component("U18_",87).
component("U17_",80).
component("U76_",167).
component("YMR220W",828).
component("YER170W",458).
component("YDR226W",371).
component("YKL067W",690).
component("YOL055C",904).
component("YDR454C",404).
component("YJR057W",662).
component("YOL061W",908).
component("YKL181W",704).
component("YHL011C",554).
component("YER099C",452).
component("YBL068W",209).
component("YOR143C",935).
component("YNL256W",869).
component("YLR328W",770).
component("YBR018C",216).
component("YBR018C",217).
component("YGR007W",510).
component("YLR328W",771).
component("YKR002W",716).
component("U80_",171).
component("YDL103C",310).
component("U94_",186).
component("YJR010W",656).
component("YCL050C",277).
component("YGL130W",496).
component("YDR530C",410).
component("YCL050C",278).
component("YPR190C",1036).
component("YPR187W",1035).
component("YPR110C",1026).
component("YPR010C",1013).
component("YOR341W",963).
component("YOR340C",962).
component("YOR224C",949).
component("YOR210W",946).
component("YOR207C",943).
component("YOR151C",936).
component("YOR116C",928).
component("YOL005C",896).
component("YNR003C",882).
component("YNL248C",867).
component("YNL151C",860).
component("YNL113W",854).
component("YKL144C",698).
component("YJR063W",663).
component("YJL148W",642).
component("YJL140W",641).
component("YIL021W",594).
component("YHR143W-A",583).
component("YGL070C",493).
component("YFL036W",467).
component("YDR404C",398).
component("YDR156W",366).
component("YDR045C",343).
component("YDL150W",319).
component("YDL140C",314).
component("YBR154C",248).
component("YPR175W",1032).
component("YPL167C",987).
component("YOR330C",959).
component("YOL115W",915).
component("YNL299W",878).
component("YNL262W",871).
component("YNL102W",852).
component("YJR043C",659).
component("YJR006W",655).
component("YJL090C",632).
component("YIL139C",609).
component("YEL055C",420).
component("YDR419W",401).
component("YDR121W",358).
component("YDL102W",309).
component("YCR014C",283).
component("YBR278W",264).
component("YBL035C",203).
component("YKL035W",687).
component("YHL012W",555).
component("YHR123W",581).
component("YPR113W",1027).
component("YBR243C",257).
component("YNL130C",856).
component("YDL142C",318).
component("YPL148C",985).
component("YER026C",428).
component("YCL004W",269).
component("YOR251C",952).
component("YGR286C",551).
component("YJL068C",629).
component("YDR058C",348).
component("YNR034W",888).
component("YHR163W",585).
component("YGR248W",544).
component("YCR073W-A",289).
component("YDL086W",304).
component("YOL011W",898).
component("YMR008C",803).
component("YMR006C",802).
component("U105_",25).
component("U101_",21).
component("YBL015W",201).
component("YJL068C",630).
component("YPL072W",979).
component("YOR124C",929).
component("YNL186W",862).
component("YMR304W",842).
component("YMR223W",829).
component("YKR098C",726).
component("YJL197W",649).
component("YIL156W",611).
component("YFR010W",470).
component("YER151C",456).
component("YER144C",455).
component("YER098W",451).
component("YDR069C",351).
component("YDL122W",311).
component("YBR058C",228).
component("YBL067C",208).
component("YDR272W",379).
component("U84_",175).
component("YDR481C",405).
component("YLR377C",777).
component("YDR074W",352).
component("YFR025C",472).
component("YPL179W",989).
component("YNR032W",886).
component("YML057W",792).
component("YML016C",785).
component("YLR433C",781).
component("YGR123C",523).
component("YER133W",454).
component("YER089C",448).
component("YDR436W",402).
component("YDR075W",353).
component("YDL188C",326).
component("YDL134C",313).
component("YDL047W",296).
component("YDL006W",290).
component("YBR125C",241).
component("YBL056W",207).
component("YPR073C",1021).
component("YHR215W",591).
component("YDL024C",293).
component("YBR093C",235).
component("YBR092C",234).
component("YAR071W",197).
component("YIL053W",598).
component("YER062C",438).
component("YHR046C",569).
component("U9_",190).
component("YGR208W",540).
component("YPL228W",995).
component("YMR180C",822).
component("YDL236W",332).
component("YJL155C",644).
component("YPR073C",1022).
component("YOR208W",944).
component("YNL053W",849).
component("YMR036C",808).
component("YIR026C",618).
component("YIL113W",605).
component("YFR028C",473).
component("YER075C",444).
component("YDL230W",330).
component("YBR276C",263).
component("U34_",128).
component("U33_",127).
component("U32_",126).
component("U31_",125).
...
component("U25_",120).
component("U24_",119).
component("YOL064C",909).
component("YPL268W",1004).
component("YOR360C",967).
component("YGL248W",507).
component("YKR031C",719).
component("YPL206C",992).
component("YGL027C",487).
component("YLR286C",761).
component("YJR153W",679).
component("YJL221C",654).
component("YJL216C",652).
component("YIL172C",617).
component("YGR292W",553).
component("YGR287C",552).
component("YBR299W",268).
component("YBR184W",251).
component("YIL162W",614).
component("YPR026W",1014).
component("YDR001C",335).
component("YBR001C",211).
component("YOR190W",941).
component("YLR300W",762).
component("YGR282C",550).
component("YDR261C",377).
component("YDR400W",396).
component("U23_",118).
component("YML035C",788).
component("YJL070C",631).
component("YBR284W",265).
component("U102_",22).
component("YNL045W",847).
component("YLR160C",751).
component("YLR158C",750).
component("YLR157C",749).
component("YLR155C",748).
component("YDR321W",386).
component("YGL037C",488).
component("U43_",136).
component("U42_",135).
component("YMR293C",838).
component("YDR242W",374).
component("YLR308W",769).
component("YLR307W",768).
component("YBR208C",253).
component("YMR281W",837).
component("U53_",146).
component("YIR027C",619).
component("YPL111W",983).
component("YIR032C",623).
component("YIR029W",621).
component("YPR062W",1019).
component("YMR120C",817).
component("YLR028C",734).
component("YHR144C",584).
component("YGR267C",549).
component("YCL030C",273).
component("YNL141W",857).
component("YBL033C",202).
component("YBR153W",247).
component("YDL238C",333).
component("YNL141W",858).
component("YLR245C",759).
component("YML035C",789).
component("YBR084W",232).
component("YJL126W",636).
component("U44_",137).
component("YDL100C",308).
component("U87_",178).
component("U40_",133).
component("YMR267W",834).
component("YBR011C",215).
component("YHR201C",588).
component("YBR111C",236).
component("YBR252W",260).
component("YCL030C",274).
component("YPR080W",1024).
component("YOR187W",940).
component("YOR133W",932).
component("YLR069C",739).
component("YKR084C",723).
component("YKL173W",703).
component("YJL102W",634).
component("YDR385W",394).
component("YBR118W",239).
component("YER005W",424).
component("YLL001W",727).
component("YIL048W",597).
component("YER166W",457).
component("YDR093W",355).
component("YAL026C",193).
component("YLR231C",757).
component("U88_",179).
component("YLR134W",744).
component("YLR044C",736).
component("YGR087C",519).
component("YDR380W",393).
component("YDL080C",302).
component("U98_",188).
component("YMR250W",831).
component("YKL184W",708).
component("YOR128C",930).
component("YEL021W",416).
component("YNR043W",890).
component("U93_",185).
component("YDR047W",345).
component("U54_",147).
component("YKL211C",712) :- not remove_orf("YKL211C",712).
component("YKR097W",725).
component("YOL052C",902).
component("YNL169C",861).
component("YGR170W",529).
component("YKL060C",689).
component("YNL256W",870).
component("YDR294C",381).
component("YEL046C",418).
component("YNR033W",887).
component("YPR006C",1012).
component("YER065C",439).
component("YKL211C",713) :- not remove_orf("YKL211C",713).
component("YER090W",713) :- not remove_orf("YER090W",713).
component("YER090W",449) :- not remove_orf("YER090W",449).
component("YDR127W",362).
component("YPL281C",1009).
component("YOR393W",972).
component("YMR323W",844).
component("YHR174W",586).
component("YGR254W",545).
component("YPL262W",1001).
component("YGL026C",486) :- not remove_orf("YGL026C",486).
component("YGR155W",527).
component("YLR304C",765).
component("YJL200C",650).
component("YNL316C",879).
component("YKL182W",706).
component("YPL212C",993).
component("YNL292W",877).
component("YGL063W",492).
component("YFL001W",461).
component("YOR278W",954).
component("YPR002W",1011).
component("U49_",141).
component("YJR016C",657).
component("YCR053W",288).
component("YDR127W",363).
component("YGL148W",497).
component("YIL168W",616).
component("YIL167W",615).
component("YCL064C",279).
component("YER086W",446).
component("YCL064C",280).
component("YLR359W",776).
component("YAL012W",191).
component("YFR055W",478).
component("YJL005W",626).
component("YOR176W",938).
component("YJL121C",635).
component("YBR019C",218).
component("YBR019C",219).
component("YDR050C",346).
component("YDR007W",336) :- not remove_orf("YDR007W",336).
component("YOR095C",926).
component("YER003C",423).
component("YBR196C",252).
component("YGL001C",480).
component("U14_",54).
component("YOL056W",905).
component("YKL152C",701).
component("YDL021W",291).
component("YMR105C",812).
component("YKL127W",695).
component("YEL058W",421).
component("YPR060C",1018).
component("YHR072W",574).
component("YJL153C",643).
component("YPL097W",981).
component("YGR185C",535).
component("YGR264C",548).
component("YGR171C",530).
component("YHR011W",562).
component("YDR023W",339).
component("YPL104W",982).
component("YLL018C",728).
component("YPR081C",1025).
component("YBR121C",240).
component("YHR020W",565).
component("YER087W",447).
component("YNL247W",866).
component("YOL033W",900).
component("YGL245W",506).
component("YHR091C",576).
component("YDR341C",387).
component("YOL097C",913).
component("YDR268W",378).
component("YPR047W",1017).
component("YLR060W",738).
component("YFL022C",465).
component("YPR033C",1015).
component("YHR019C",563).
component("YCR024C",284).
component("YHR019C",564).
component("YPL160W",986).
component("YLR382C",778).
component("YNL073W",851).
component("YDR037W",341).
component("YOR335C",960).
component("YGR094W",521).
component("YOR317W",956).
component("YMR246W",830).
component("YIL009W",593).
component("YER015W",426).
component("YOR142W",934).
component("YGR244C",543).
component("YPR035W",1016).
component("U89_",180).
component("YOR241W",951).
component("YMR113W",814).
component("YKL132C",696).
component("YOR339C",961).
component("YMR022W",807).
component("YLR306W",767).
component("YKL210W",711).
component("YGR133W",525).
component("YGL058W",490).
component("YER100W",453).
component("YEL012W",414).
component("YDR177W",368).
component("YDR092W",354).
component("YDR059C",349).
component("YDR054C",347).
component("YDL064W",298).
component("YBR082C",231).
component("YJL101C",633).
component("YOL049W",901).
component("U92_",184).
component("YAR015W",196).
component("YGL234W",504).
component("YER183C",460).
component("U91_",183).
component("U90_",182).
component("YNR057C",893).
component("YDL141W",315).
component("YDL141W",316).
component("YGL234W",505).
component("YDL141W",317).
component("YJR103W",668).
component("YBL039C",204).
component("YGR204W",539).
component("YBR084W",233).
component("YNL220W",864).
component("YOL058W",906).
component("YBR208C",254).
component("YHR074W",575).
component("YMR217W",827).
component("YGR061C",518).
component("YPR145W",1030).
component("YGR124W",524).
component("YOR303W",955).
component("YJR109C",671).
component("YJL130C",639).
component("YGL062W",491).
component("YBR218C",255).
component("YPL231W",999).
component("YNR016C",885).
component("YKL182W",707).
component("YGR037C",514).
component("YOR005C",921).
component("YDL164C",320).
component("YOL010W",897).
component("YPR138C",1029).
component("YPL274W",1006).
component("YPL265W",1002).
component("YPL134C",984).
component("YPL057C",978).
component("YPL036W",977).
component("YOR348C",965).
component("YOR222W",948).
component("YOR192C",942).
component("YOR171C",937).
component("YOR130C",931).
component("YOR071C",924).
component("YOL156W",920).
component("YOL103W",914).
component("YOL020W",899) :- not remove_orf("YOL020W",899).
component("YNR072W",895).
component("YNR056C",892).
component("YNL318C",880).
component("YNL268W",873).
component("YNL142W",859).
component("YMR272C",836).
component("YMR202W",824).
component("YMR011W",804).
component("YML123C",801).
component("YLR348C",773).
component("YLR260W",760).
component("YLR237W",758).
component("YLR138W",745).
component("YLR100C",742).
component("YLR081W",740).
component("YLL061W",731).
component("YLL043W",730).
component("YKR093W",724).
component("YKR053C",721).
component("YKR039W",720) :- not remove_orf("YKR039W",720).
component("YKL217W",715).
component("YKL120W",694).
component("YKL004W",683).
component("YJR158W",680).
component("YJR152W",678).
component("YJR095W",667).
component("YJR077C",665).
component("YJL219W",653).
component("YJL214W",651).
component("YJL134W",640).
component("YJL129C",637).
component("YIR028W",620).
component("YIL134W",608).
component("YHR096C",579).
component("YHR094C",578).
component("YHR092C",577).
component("YHL036W",558).
component("YHL016C",556).
component("YGR121C",522).
component("YGR055W",516).
component("YGL186C",499).
component("YGL077C",494).
component("YGL008C",481).
component("YFL055W",469).
component("YFL011W",462).
component("YER060W-A",435).
component("YER060W",434).
component("YER056C",433).
component("YER053C",431).
component("YEL069C",422).
component("YEL017C-A",415).
component("YDR536W",412).
component("YDR508C",408).
component("YDR503C",407).
component("YDR497C",406).
component("YDR345C",390).
component("YDR343C",389).
component("YDR342C",388).
component("YDR297W",383).
component("YDR294C",382).
component("YDR284C",380).
component("YDR046C",344) :- not remove_orf("YDR046C",344).
component("YDL245C",334).
component("YDL210W",327).
component("YCR032W",286).
component("YCR024C-A",285).
component("YCL025C",271).
component("YBR298C",267).
component("YBR291C",266).
component("YBR069C",230) :- not remove_orf("YBR069C",230).
component("YBR068C",229) :- not remove_orf("YBR068C",229).
component("YBR036C",225).
component("YBR021W",221).
component("YBL042C",205).
component("U85_",176).
component("U7_",170).
component("U79_",169).
component("U78_",168).
...
catalyst(6160,840).
catalyst(3870,432).
catalyst(3620,392) :- not remove_reaction(3620,392).
catalyst(2110,476).
catalyst(2190,476).
catalyst(5550,673).
catalyst(5791,756).
...
catalyst(1960,345).
catalyst(3460,147).
catalyst(3600,712) :- not remove_reaction(3600,712).
catalyst(8000,725).
catalyst(3941,902).
catalyst(3942,902).
catalyst(6890,861).
...
catalyst(8020,1012).
catalyst(8020,439).
catalyst(1890,713) :- not remove_reaction(1890,713).
catalyst(3630,713) :- not remove_reaction(3630,713).
catalyst(1890,449) :- not remove_reaction(1890,449).
catalyst(3630,449) :- not remove_reaction(3630,449).
catalyst(3740,362).
catalyst(8231,1009).
catalyst(8232,1009).
catalyst(8231,972).
...
catalyst(8051,1001).
catalyst(8052,1001).
catalyst(3590,486) :- not remove_reaction(3590,486).
catalyst(10910,486) :- not remove_reaction(10910,486).
catalyst(4570,527).
catalyst(8181,765).
catalyst(8182,765).
catalyst(8181,650).
...
catalyst(8281,346).
catalyst(8282,346).
catalyst(3610,336) :- not remove_reaction(3610,336).
catalyst(7921,926).
catalyst(7922,926).
catalyst(7841,423).
catalyst(7842,423).
...
catalyst(1210,920).
catalyst(1160,914).
catalyst(801,899) :- not remove_reaction(801,899).
catalyst(802,899) :- not remove_reaction(802,899).
catalyst(811,899) :- not remove_reaction(811,899).
catalyst(812,899) :- not remove_reaction(812,899).
catalyst(831,899) :- not remove_reaction(831,899).
catalyst(832,899) :- not remove_reaction(832,899).
catalyst(901,899) :- not remove_reaction(901,899).
catalyst(902,899) :- not remove_reaction(902,899).
catalyst(941,899) :- not remove_reaction(941,899).
catalyst(942,899) :- not remove_reaction(942,899).
catalyst(1170,895).
catalyst(1180,895).
catalyst(1210,895).
catalyst(700,892).
...
catalyst(650,724).
catalyst(6560,721).
catalyst(761,720) :- not remove_reaction(761,720).
catalyst(762,720) :- not remove_reaction(762,720).
catalyst(771,720) :- not remove_reaction(771,720).
catalyst(772,720) :- not remove_reaction(772,720).
catalyst(781,720) :- not remove_reaction(781,720).
catalyst(782,720) :- not remove_reaction(782,720).
catalyst(791,720) :- not remove_reaction(791,720).
catalyst(792,720) :- not remove_reaction(792,720).
catalyst(801,720) :- not remove_reaction(801,720).
catalyst(802,720) :- not remove_reaction(802,720).
catalyst(811,720) :- not remove_reaction(811,720).
catalyst(812,720) :- not remove_reaction(812,720).
catalyst(821,720) :- not remove_reaction(821,720).
catalyst(822,720) :- not remove_reaction(822,720).
catalyst(831,720) :- not remove_reaction(831,720).
catalyst(832,720) :- not remove_reaction(832,720).
catalyst(841,720) :- not remove_reaction(841,720).
catalyst(842,720) :- not remove_reaction(842,720).
catalyst(861,720) :- not remove_reaction(861,720).
catalyst(862,720) :- not remove_reaction(862,720).
catalyst(881,720) :- not remove_reaction(881,720).
catalyst(882,720) :- not remove_reaction(882,720).
catalyst(901,720) :- not remove_reaction(901,720).
catalyst(902,720) :- not remove_reaction(902,720).
catalyst(911,720) :- not remove_reaction(911,720).
catalyst(912,720) :- not remove_reaction(912,720).
catalyst(921,720) :- not remove_reaction(921,720).
catalyst(922,720) :- not remove_reaction(922,720).
catalyst(941,720) :- not remove_reaction(941,720).
catalyst(942,720) :- not remove_reaction(942,720).
catalyst(1191,720) :- not remove_reaction(1191,720).
catalyst(1192,720) :- not remove_reaction(1192,720).
catalyst(390,715).
catalyst(1021,715).
catalyst(1022,715).
catalyst(1521,694).
...
catalyst(6550,382).
catalyst(6690,380).
catalyst(791,344) :- not remove_reaction(791,344).
catalyst(792,344) :- not remove_reaction(792,344).
catalyst(801,344) :- not remove_reaction(801,344).
catalyst(802,344) :- not remove_reaction(802,344).
catalyst(811,344) :- not remove_reaction(811,344).
catalyst(812,344) :- not remove_reaction(812,344).
catalyst(831,344) :- not remove_reaction(831,344).
catalyst(832,344) :- not remove_reaction(832,344).
catalyst(841,344) :- not remove_reaction(841,344).
catalyst(842,344) :- not remove_reaction(842,344).
catalyst(861,344) :- not remove_reaction(861,344).
catalyst(862,344) :- not remove_reaction(862,344).
catalyst(901,344) :- not remove_reaction(901,344).
catalyst(902,344) :- not remove_reaction(902,344).
catalyst(1170,334).
catalyst(1180,334).
catalyst(1210,334).
catalyst(690,327).
...
catalyst(1511,266).
catalyst(1512,266).
catalyst(771,230) :- not remove_reaction(771,230).
catalyst(772,230) :- not remove_reaction(772,230).
catalyst(791,230) :- not remove_reaction(791,230).
catalyst(792,230) :- not remove_reaction(792,230).
catalyst(801,230) :- not remove_reaction(801,230).
catalyst(802,230) :- not remove_reaction(802,230).
catalyst(811,230) :- not remove_reaction(811,230).
catalyst(812,230) :- not remove_reaction(812,230).
catalyst(861,230) :- not remove_reaction(861,230).
catalyst(862,230) :- not remove_reaction(862,230).
catalyst(901,230) :- not remove_reaction(901,230).
catalyst(902,230) :- not remove_reaction(902,230).
...
catalyst(831,229) :- not remove_reaction(831,229).
catalyst(832,229) :- not remove_reaction(832,229).
catalyst(841,229) :- not remove_reaction(841,229).
catalyst(842,229) :- not remove_reaction(842,229).
catalyst(861,229) :- not remove_reaction(861,229).
catalyst(862,229) :- not remove_reaction(862,229).
...
modifiable_enzyme(392).
modifiable_enzyme(712).
modifiable_enzyme(713).
modifiable_enzyme(449).
modifiable_enzyme(486).
modifiable_enzyme(336).
modifiable_enzyme(899).
modifiable_enzyme(720).
modifiable_enzyme(344).
