...
component("YNL280C",461).
component("YGR060W",280).
component("YGL012W",262).
component("YOL086C",478).
component("YMR303C",442).
component("YGL256W",274).
component("YDL168W",166).
component("YBR145W",128).
component("YPL231W",523).
component("YBR149W",129).
component("YGL001C",259).
component("YHR063C",307).
component("YBR153W",130).
component("YML056C",421).
component("YLR432W",417).
component("YHR216W",315).
component("YAR075W",104).
component("YAR073W",103).
component("YDR127W",184).
component("YJR139C",359).
component("YKL029C",363).
component("YOR136W",489).
component("YDL066W",157).
component("YLR355C",415).
component("YML086C",423).
component("YIL155C",323).
component("YPR191W",548).
component("YOR065W",484).
component("YJL166W",341).
component("YHR001W-A",302).
component("YGR183C",290).
component("YFR033C",255).
component("YDR529C",216).
component("YBL045C",109).
component("Q0105",18).
component("YGR088W",282).
component("YDR256C",197).
component("YJR078W",351).
component("YJR025C",346).
component("YGR255C",296).
component("YBL098W",112).
component("YMR015C",427).
component("YDR402C",208).
component("YGR175C",288).
component("YJR104C",354).
component("YHR008C",303).
component("YER070W",235).
component("U35_",64).
component("YDL168W",167).
component("YDR158W",191).
component("YPL276W",531).
component("YPL275W",530).
component("YOR388C",511).
component("YGL154C",269).
component("U55_",73).
component("YOR323C",501).
component("YMR170C",435).
component("YMR169C",434).
component("U2_",61).
component("YBR221C",137).
component("U52_",70).
component("YBR166C",133).
component("YNL280C",462).
component("YER014W",225).
component("YMR118C",432).
component("YLR164W",400).
component("YLL041C",386).
component("YKL148C",370).
component("YJL045W",329).
component("YDR178W",192).
component("YJR051W",348).
component("YEL047C",220).
component("YOR375C",509).
component("YDL215C",169).
component("YAL062W",101).
component("U99_",97).
component("YBR035C",119).
component("YHR037W",304).
component("YKR080W",383).
component("YER023W",226).
component("YOR236W",498).
component("YGR204W",291).
component("U62_",75).
component("YKL150W",371).
component("YIL043C",317).
component("YHR042W",305).
component("YFR030W",254).
component("YPL017C",514).
component("YFL018C",246).
component("YER042W",228).
component("YJR137C",358).
component("YBR034C",118).
component("YPL273W",529).
component("YLL062C",388).
component("U47_",67).
component("YER091C",238).
component("YDL033C",155).
component("YOL096C",479).
component("YDR019C",174).
component("YDR408C",210).
component("YBL013W",105).
component("YKL024C",362).
component("YPR074C",541).
component("YBR117C",127).
component("YLR354C",414).
component("YGR043C",278).
component("YCL009C",146).
component("YMR062C",429).
component("YPL231W",524).
component("U86_",89).
component("YPL001W",513).
component("YOR377W",510).
component("YGR177C",289).
component("YPL231W",525).
component("YGR147C",285).
component("YDL040C",156).
component("YPL028W",515).
component("YPR001W",533).
component("YNR001C",466).
component("YDL182W",168).
component("YNL117W",450).
component("YIR031C",327).
component("YNL029C",445).
component("YIL085C",320).
component("YNL192W",455).
component("YBR038W",120).
component("YBR023C",117).
component("YLR209C",401).
component("YMR300C",441).
component("YER055C",230).
component("YDR354W",204) :- not remove_orf("YDR354W",204).
component("YFR047C",256).
component("YJR133W",357).
component("YLR209C",402).
component("YML022W",418).
component("YDR441C",212).
component("YDR399W",206).
component("YNL256W",457).
component("YDR127W",185).
component("YLR303W",408).
component("YJR130C",356).
component("YLR303W",409).
component("YDR035W",175).
component("YBR249C",138).
component("YOL143C",482).
component("YBR256C",139).
component("YHR137W",310).
component("YGL202W",271).
component("YLR027C",389).
component("YKL106W",366).
component("YKL104C",365).
component("YGR019W",276).
component("YLR089C",392).
component("U64_",76).
component("U51_",69).
component("YJR148W",360).
component("YGL253W",273).
component("YFR053C",257).
component("YMR205C",437).
component("YGR240C",293).
component("YDR248C",196).
component("YCR036W",153).
component("YCL040W",148).
component("YJR105W",355).
component("U16_",36).
component("U15_",33).
component("U96_",95).
component("YKL001C",361).
component("YML070W",422).
component("YFL053W",249).
component("YHL032C",300).
component("U83_",87).
component("U82_",86).
component("YMR208W",438).
component("YOR347C",506).
component("YAL038W",100).
component("YPR121W",543).
component("YPL258C",527).
component("YOL055C",475).
component("U1_",45).
component("YBR020W",115).
component("YNL267W",459).
component("YLR305C",411).
component("YFR019W",252).
component("YDR208W",193).
component("YDR127W",186).
component("U21_",53).
component("U20_",51).
component("YDR147W",189).
component("YDR300C",201).
component("YCR012W",150).
component("U18_",42).
component("U76_",84).
component("YER170W",244).
component("YDR226W",194).
component("YDR454C",213).
component("YOL061W",477).
component("YKL181W",373).
component("YHL011C",298).
component("YER099C",240).
component("YBL068W",111).
component("YOR143C",490).
component("YGR007W",275).
component("YLR328W",412).
component("YJR010W",345).
component("YCL050C",149).
component("YPR190C",547).
component("YPR187W",546).
component("YPR110C",542).
component("YPR010C",535).
component("YOR341W",505).
component("YOR340C",504).
component("YOR224C",497).
component("YOR210W",496).
component("YOR207C",494).
component("YOR151C",491).
component("YOR116C",487).
component("YOL005C",471).
component("YNR003C",467).
component("YNL248C",456).
component("YNL151C",453).
component("YNL113W",449).
component("YKL144C",369).
component("YJR063W",349).
component("YJL148W",339).
component("YJL140W",338).
component("YIL021W",316).
component("YHR143W-A",311).
component("YGL070C",267).
component("YFL036W",248).
component("YDR404C",209).
component("YDR156W",190).
component("YDR045C",176).
component("YDL150W",164).
component("YDL140C",162).
component("YBR154C",132).
component("YPR175W",545).
component("YPL167C",520).
component("YOR330C",502).
component("YOL115W",481).
component("YNL299W",464).
component("YNL262W",458).
component("YNL102W",448).
component("YJR043C",347).
component("YJR006W",344).
component("YJL090C",332).
component("YIL139C",322).
component("YEL055C",221).
component("YDR419W",211).
component("YDR121W",183).
component("YDL102W",160).
component("YCR014C",151).
component("YBR278W",141).
component("YBL035C",107).
component("YKL035W",364).
component("YHL012W",299).
component("YER026C",227).
component("YCL004W",145).
component("YDR058C",180).
component("YDL086W",159).
component("YOL011W",472).
component("YMR008C",426).
component("YMR006C",425).
component("U101_",19).
component("YBL015W",106).
component("YJL068C",330).
component("YPL072W",517).
component("YOR124C",488).
component("YNL186W",454).
component("YMR304W",443).
component("YMR223W",439).
component("YKR098C",384).
component("YJL197W",342).
component("YIL156W",324).
component("YFR010W",251).
component("YER151C",242).
component("YER144C",241).
component("YER098W",239).
component("YDR069C",181).
component("YDL122W",161).
component("YBR058C",121).
component("YBL067C",110).
component("U84_",88).
component("YPR073C",539).
component("YHR215W",314).
component("YDL024C",154).
component("YBR093C",125).
component("YBR092C",124).
component("YAR071W",102).
component("YIL053W",319).
component("YER062C",234).
component("YHR046C",306).
component("YGR208W",292).
component("YPL228W",522).
component("YMR180C",436).
component("YDL236W",171).
component("YJL155C",340).
component("YPR073C",540).
component("YOR208W",495).
component("YNL053W",447).
component("YMR036C",428).
component("YIR026C",325).
component("YIL113W",321).
component("YFR028C",253).
component("YER075C",236).
component("YDL230W",170).
component("YBR276C",140).
component("U34_",63).
component("U30_",62).
component("U25_",60).
component("U24_",59).
component("YOR360C",508).
component("YGL248W",272).
component("YKR031C",380).
component("YLR286C",406).
component("YOR190W",492).
component("YLR300W",407).
component("YGR282C",297).
component("YDR261C",198).
component("YDR400W",207).
component("U23_",58).
component("YML035C",419).
component("YJL070C",331).
component("YBR284W",142).
component("U102_",20).
component("YNL045W",446).
component("YLR160C",399).
component("YLR158C",398).
component("YLR157C",397).
component("YLR155C",396).
component("YDR321W",202).
component("YGL037C",264).
component("YDR242W",195).
component("YBR208C",134).
component("U53_",71).
component("YIR032C",328).
component("YIR029W",326).
component("YMR120C",433).
component("YHR144C",312).
component("YBR153W",131).
component("YDL238C",172).
component("YNL141W",451).
component("YLR245C",405).
component("YML035C",420).
component("YJL126W",335).
component("U87_",90).
component("YBR111C",126).
component("YER005W",224).
component("YIL048W",318).
component("YER166W",243).
component("YDR093W",182).
component("YAL026C",99).
component("YLR231C",403).
component("U88_",91).
component("YLR134W",394).
component("YLR044C",390).
component("YGR087C",281).
component("YDR380W",205).
component("YDL080C",158).
component("U98_",96).
component("YKL184W",376).
component("YNR043W",470).
component("U93_",94).
component("YDR047W",178).
component("U54_",72).
component("YKL211C",377) :- not remove_orf("YKL211C",377).
component("YGR170W",287).
component("YDR294C",199).
component("YEL046C",219).
component("YNR033W",469).
component("YKL211C",378) :- not remove_orf("YKL211C",378).
component("YER090W",378) :- not remove_orf("YER090W",378).
component("YER090W",237) :- not remove_orf("YER090W",237).
component("YDR127W",187).
component("YPL281C",532).
component("YOR393W",512).
component("YMR323W",444).
component("YHR174W",313).
component("YGR254W",295).
component("YGL026C",263) :- not remove_orf("YGL026C",263).
component("YGR155W",286).
component("YLR304C",410).
component("YJL200C",343).
component("YNL316C",465).
component("YKL182W",374).
component("YPL212C",521).
component("YNL292W",463).
component("YGL063W",266).
component("YFL001W",245).
component("YPR002W",534).
component("YDR127W",188).
component("YGL148W",268).
component("YAL012W",98).
component("YFR055W",258).
component("YJL121C",334).
component("YBR019C",113).
component("YBR019C",114).
component("YDR050C",179).
component("YDR007W",173) :- not remove_orf("YDR007W",173).
component("YOR095C",486).
component("YER003C",223).
component("YGL001C",260).
component("YKL152C",372).
component("YMR105C",430).
component("YKL127W",367).
component("YEL058W",222).
component("YPR060C",538).
component("YPL104W",518).
component("YLL018C",385).
component("YOL033W",474).
component("YHR091C",309).
component("YDR341C",203).
component("YOL097C",480).
component("YPR047W",537).
component("YLR060W",391).
component("YFL022C",247).
component("YPR033C",536).
component("YPL160W",519).
component("YLR382C",416).
component("YOR335C",503).
component("YGR094W",283).
component("YGR244C",294).
component("U89_",92).
component("YOR241W",499).
component("YMR113W",431).
component("YKL132C",368).
component("YJL101C",333).
component("U91_",93).
component("YDL141W",163).
component("YJR103W",353).
component("YBL039C",108).
component("YOL058W",476).
component("YBR208C",135).
component("YHR074W",308).
component("YOR303W",500).
component("YGL062W",265).
component("YBR218C",136).
component("YPL231W",526).
component("YNR016C",468).
component("YKL182W",375).
component("YGR037C",277).
component("YOR005C",483).
component("YDL164C",165).
component("YPR138C",544).
component("YPL265W",528).
component("YPL036W",516).
component("YOR348C",507).
component("YOR192C",493).
component("YOR071C",485).
component("YOL020W",473) :- not remove_orf("YOL020W",473).
component("YNL268W",460).
component("YNL142W",452).
component("YMR272C",440).
component("YML123C",424).
component("YLR348C",413).
component("YLR237W",404).
component("YLR138W",395).
component("YLR100C",393).
component("YLL061W",387).
component("YKR053C",382).
component("YKR039W",381) :- not remove_orf("YKR039W",381).
component("YKL217W",379).
component("YJR095W",352).
component("YJR077C",350).
component("YJL134W",337).
component("YJL129C",336).
component("YHL036W",301).
component("YGR121C",284).
component("YGR055W",279).
component("YGL186C",270).
component("YGL008C",261).
component("YFL055W",250).
component("YER060W-A",233).
component("YER060W",232).
component("YER056C",231).
component("YER053C",229).
...
catalyst(6160,441).
catalyst(3870,230).
catalyst(3620,204) :- not remove_reaction(3620,204).
catalyst(2190,256).
catalyst(5550,357).
catalyst(5791,402).
catalyst(5792,402).
...
catalyst(1960,178).
catalyst(3460,72).
catalyst(3600,377) :- not remove_reaction(3600,377).
catalyst(6900,287).
catalyst(8781,199).
catalyst(8782,199).
catalyst(4560,219).
catalyst(2550,469).
catalyst(3630,378) :- not remove_reaction(3630,378).
catalyst(3630,237) :- not remove_reaction(3630,237).
catalyst(3740,187).
catalyst(8231,532).
catalyst(8232,532).
catalyst(8231,512).
...
catalyst(8231,295).
catalyst(8232,295).
catalyst(3590,263) :- not remove_reaction(3590,263).
catalyst(10910,263) :- not remove_reaction(10910,263).
catalyst(4570,286).
catalyst(8181,410).
catalyst(8182,410).
catalyst(8181,343).
...
catalyst(750,387).
catalyst(6560,382).
catalyst(761,381) :- not remove_reaction(761,381).
catalyst(762,381) :- not remove_reaction(762,381).
catalyst(771,381) :- not remove_reaction(771,381).
catalyst(772,381) :- not remove_reaction(772,381).
catalyst(781,381) :- not remove_reaction(781,381).
catalyst(782,381) :- not remove_reaction(782,381).
catalyst(791,381) :- not remove_reaction(791,381).
catalyst(792,381) :- not remove_reaction(792,381).
catalyst(801,381) :- not remove_reaction(801,381).
catalyst(802,381) :- not remove_reaction(802,381).
catalyst(811,381) :- not remove_reaction(811,381).
catalyst(812,381) :- not remove_reaction(812,381).
catalyst(831,381) :- not remove_reaction(831,381).
catalyst(832,381) :- not remove_reaction(832,381).
catalyst(841,381) :- not remove_reaction(841,381).
catalyst(842,381) :- not remove_reaction(842,381).
catalyst(861,381) :- not remove_reaction(861,381).
catalyst(862,381) :- not remove_reaction(862,381).
catalyst(881,381) :- not remove_reaction(881,381).
catalyst(882,381) :- not remove_reaction(882,381).
catalyst(941,381) :- not remove_reaction(941,381).
catalyst(942,381) :- not remove_reaction(942,381).
catalyst(1191,381) :- not remove_reaction(1191,381).
catalyst(1192,381) :- not remove_reaction(1192,381).
catalyst(1021,379).
catalyst(1022,379).
catalyst(1250,352).
catalyst(1581,350).
