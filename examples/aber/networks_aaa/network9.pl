...
component("YGL012W",78).
component("YGL001C",77).
component("YDR127W",54).
component("YJR139C",102).
component("YOR136W",133).
component("YJR078W",100).
component("YJR025C",97).
component("YMR015C",117).
component("YGL154C",82).
component("YMR170C",119).
component("YMR169C",118).
component("YBR166C",38).
component("YER014W",70).
component("YEL047C",69).
component("YOR375C",142).
component("YAL062W",28).
component("U62_",25).
component("YPR074C",150).
component("YBR117C",36).
component("YPL231W",144).
component("YLR209C",111).
component("YDR354W",63) :- not remove_orf("YDR354W",63).
component("YFR047C",76).
component("YDR127W",55).
component("YJR130C",101).
component("YDR035W",50).
component("YBR249C",39).
component("YBR256C",40).
component("YHR137W",87).
component("YLR027C",110).
component("YKL106W",103).
component("YCR036W",43).
component("U83_",27).
component("YNL267W",125).
component("YLR305C",115).
component("YFR019W",75).
component("YDR208W",60).
component("YDR127W",56).
component("U20_",20).
component("YDR300C",62).
component("U76_",26).
component("YDR454C",65).
component("YOL061W",130).
component("YKL181W",105).
component("YHL011C",86).
component("YER099C",72).
component("YBL068W",29).
component("YOR143C",134).
component("YPR190C",154).
component("YPR187W",153).
component("YPR110C",151).
component("YPR010C",147).
component("YOR341W",141).
component("YOR340C",140).
component("YOR224C",138).
component("YOR210W",137).
component("YOR207C",136).
component("YOR151C",135).
component("YOR116C",132).
component("YOL005C",128).
component("YNR003C",127).
component("YNL248C",124).
component("YNL151C",123).
component("YNL113W",121).
component("YKL144C",104).
component("YJR063W",98).
component("YJL148W",95).
component("YJL140W",94).
component("YIL021W",91).
component("YHR143W-A",88).
component("YGL070C",80).
component("YFL036W",73).
component("YDR404C",64).
component("YDR156W",59).
component("YDR045C",51).
component("YDL150W",46).
component("YDL140C",45).
component("YBR154C",37).
component("YDR058C",53).
component("YPR073C",149).
component("YHR215W",90).
component("YDL024C",44).
component("YBR093C",34).
component("YBR092C",33).
component("YDL236W",47).
component("YJL155C",96).
component("U30_",22).
component("YLR286C",114).
component("YML035C",116).
component("YJL070C",92).
component("YBR284W",41).
component("U53_",23).
component("YDL238C",48).
component("YLR245C",113).
component("YBR111C",35).
component("YLR231C",112).
component("U54_",24).
component("YKL211C",106) :- not remove_orf("YKL211C",106).
component("YDR294C",61).
component("YKL211C",107) :- not remove_orf("YKL211C",107).
component("YER090W",107) :- not remove_orf("YER090W",107).
component("YER090W",71) :- not remove_orf("YER090W",71).
component("YDR127W",57).
component("YPL281C",146).
component("YOR393W",143).
component("YMR323W",120).
component("YHR174W",89).
component("YGR254W",85).
component("YGL026C",79) :- not remove_orf("YGL026C",79).
component("YNL316C",126).
component("YDR127W",58).
component("YGL148W",81).
component("YDR007W",49) :- not remove_orf("YDR007W",49).
component("YOR095C",131).
component("YPR060C",148).
component("YOR335C",139).
component("YGR094W",83).
component("YPR138C",152).
component("YPL265W",145).
component("YOL020W",129) :- not remove_orf("YOL020W",129).
component("YNL142W",122).
component("YKR053C",109).
component("YKR039W",108) :- not remove_orf("YKR039W",108).
component("YJR077C",99).
component("YJL134W",93).
component("YGR121C",84).
component("YFL055W",74).
component("YDR536W",68).
component("YDR508C",67).
component("YDR503C",66).
component("YDR046C",52) :- not remove_orf("YDR046C",52).
component("YCL025C",42).
component("YBR069C",32) :- not remove_orf("YBR069C",32).
component("YBR068C",31) :- not remove_orf("YBR068C",31).
component("YBR021W",30).
component("U228_",21).
component("U206_",19).
component("U168_",18).
component("I01179",17).
...
catalyst(5611,111).
catalyst(5612,111).
catalyst(3620,63) :- not remove_reaction(3620,63).
catalyst(2190,76).
catalyst(3710,55).
catalyst(9661,101).
catalyst(9662,101).
...
catalyst(3500,112).
catalyst(3460,24).
catalyst(3600,106) :- not remove_reaction(3600,106).
catalyst(8781,61).
catalyst(8782,61).
catalyst(3630,107) :- not remove_reaction(3630,107).
catalyst(3630,71) :- not remove_reaction(3630,71).
catalyst(3740,57).
catalyst(8231,146).
catalyst(8232,146).
catalyst(8231,143).
...
catalyst(8231,85).
catalyst(8232,85).
catalyst(3590,79) :- not remove_reaction(3590,79).
catalyst(10910,79) :- not remove_reaction(10910,79).
catalyst(3680,126).
catalyst(3750,58).
catalyst(3700,81).
...
catalyst(372,122).
catalyst(6560,109).
catalyst(781,108) :- not remove_reaction(781,108).
catalyst(782,108) :- not remove_reaction(782,108).
...
catalyst(881,108) :- not remove_reaction(881,108).
catalyst(882,108) :- not remove_reaction(882,108).
catalyst(1191,108) :- not remove_reaction(1191,108).
catalyst(1192,108) :- not remove_reaction(1192,108).
catalyst(1581,99).
catalyst(1582,99).
catalyst(6560,93).
catalyst(371,84).
