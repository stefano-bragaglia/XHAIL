...
component("YNL280C",759).
component("YLR056W",643).
component("YGR060W",451).
component("YGL012W",419).
component("YKR009C",626).
component("YOL086C",790).
component("YMR303C",728).
component("YMR083W",702).
component("YGL256W",443).
component("YDL168W",275).
component("YBR145W",207).
component("YPL231W",865).
component("U46_",115).
component("YBR149W",208).
component("YBR149W",209).
component("YJR159W",594).
component("YGL001C",416).
component("YIL094C",526).
component("YHR063C",499).
component("YBR153W",210).
component("YML056C",687).
component("YLR432W",679).
component("YHR216W",516).
component("YAR075W",169).
component("YAR073W",168).
component("YCL030C",234).
component("YDR127W",306).
component("YJR139C",588).
component("YOL126C",795).
component("YKL085W",604).
component("YDL078C",256).
component("YKL029C",599).
component("YOR136W",809).
component("YNL037C",733).
component("YDL066W",255).
component("YNL241C",749).
component("YOL059W",788).
component("YDL022W",249).
component("YLR355C",675).
component("YIL074C",524).
component("YER081W",386).
component("YML054C",686).
component("YDL174C",277).
component("YML086C",690).
component("YIL155C",532).
component("YPR191W",902).
component("YOR065W",801).
component("YJL166W",562).
component("YHR001W-A",488).
component("YGR183C",466).
component("YFR033C",412).
component("YDR529C",352).
component("YBL045C",175).
component("Q0105",18).
component("YGR088W",454).
component("YDR256C",321).
component("YKL026C",598).
component("YIR037W",542).
component("YBR244W",222).
component("YJR078W",579).
component("YJR025C",571).
component("YGR255C",478).
component("U108_",22).
component("YBL098W",179).
component("YMR015C",699).
component("YHR007C",489).
component("YDR402C",341).
component("YGL055W",426).
component("YGR175C",463).
component("YJR104C",582).
component("YHR008C",490).
component("YJL026W",545).
component("YIL066C",523).
component("YGR180C",465).
component("YER070W",383).
component("U38_",110).
component("U36_",109).
component("U35_",108).
component("YDL168W",276).
component("YDR158W",314).
component("YBR006W",182).
component("YPL276W",877).
component("YPL275W",876).
component("YOR388C",842).
component("YOR374W",839).
component("YER073W",384).
component("U68_",132).
component("YGL154C",434).
component("U55_",124).
component("YOR323C",831).
component("YMR170C",712).
component("YMR169C",711).
component("U2_",103).
component("YER178W",399).
component("YBR221C",220).
component("YIL125W",530).
component("U52_",121).
component("YBR166C",213).
component("YNL280C",760).
component("YGL012W",420).
component("YKL182W",616).
component("U57_",126).
component("YKL216W",623).
component("YDR044W",294).
component("YER014W",367).
component("YKR009C",627).
component("YIL160C",534).
component("YGL205W",437).
component("YMR118C",707).
component("YLR164W",656).
component("YLL041C",636).
component("YKL148C",611).
component("YKL141W",609).
component("YJL045W",546).
component("YDR178W",315).
component("YJR051W",574).
component("YEL047C",361).
component("YDL215C",281).
component("YOR375C",840).
component("YDL215C",282).
component("YAL062W",166).
component("U99_",160).
component("YBR035C",192).
component("YMR189W",714).
component("U56_",125).
component("YHR037W",496).
component("YKR080W",631).
component("YER023W",369).
component("YPL023C",846).
component("YGL125W",431).
component("YOR236W",824).
component("YGR204W",470).
component("YLR142W",651).
component("U63_",130).
component("U62_",129).
component("YKL150W",612).
component("YIL043C",520).
component("YHR042W",497).
component("YOR221C",822).
component("YML120C",693).
component("YKL192C",620).
component("YKL055C",601).
component("YER061C",378).
component("YGR234W",473).
component("YFR030W",411).
component("YPL017C",845).
component("YFL018C",403).
component("YDR353W",336).
component("YER042W",371).
component("YJR137C",587).
component("YPL266W",872).
component("YML110C",692).
component("YBR034C",191).
component("YPL273W",874).
component("YLL062C",639).
component("YDR410C",344).
component("U47_",116).
component("YER091C",391).
component("YJR073C",577).
component("YDR120C",304).
component("YDL033C",251).
component("YOL096C",791).
component("YLR172C",657).
component("YDR019C",290).
component("YBR176W",214).
component("YDR408C",343).
component("YMR120C",708).
component("YBL013W",170).
component("YKL024C",597).
component("YPR074C",891).
component("YBR117C",203).
component("YLR354C",674).
component("YGR043C",449).
component("YMR108W",705).
component("YCL009C",232).
component("YMR062C",701).
component("YNL071W",736).
component("YNR008W",767).
component("YIL160C",535).
component("YNL277W",758).
component("YFL017C",402).
component("YPL231W",866).
component("YER061C",379).
component("U86_",148).
component("YPL001W",844).
component("YDL052C",254).
component("U8_",152).
component("YDR148C",312).
component("YOR377W",841).
component("YGR177C",464).
component("YPL231W",867).
component("YGR147C",459).
component("YDL040C",252).
component("YPL028W",847).
component("YGL017W",421).
component("YPR001W",879).
component("YNR001C",765).
component("YCR005C",239).
component("YDL182W",278).
component("YDL131W",266).
component("YNL117W",740).
component("YIR031C",540).
component("YOR321W",830).
component("YJR143C",589).
component("YGR199W",469).
component("YDR307W",330).
component("YDL095W",261).
component("YDL093W",260).
component("YAL023C",163).
component("YOR103C",805).
component("YOR085W",803).
component("YMR149W",710).
component("YML019W",682).
component("YJL002C",543).
component("YEL002C",356).
component("YDL232W",284).
component("YCL043C",237).
component("YNL029C",732).
component("YIL085C",525).
component("YMR261C",722).
component("YML100W",691).
component("YBR126C",206).
component("YNL192W",748).
component("YBR038W",194).
component("YBR023C",190).
component("YMR306W",730).
component("YLR342W",672).
component("YGR032W",447).
component("YLR209C",658).
component("U104_",21).
component("YOR209C",820).
component("YMR300C",727).
component("YER055C",374).
component("YDR354W",337) :- not remove_orf("YDR354W",337).
component("YFR047C",413).
component("YJR133W",586).
component("YLR209C",659).
component("YML022W",683).
component("YDR441C",347).
component("YDR399W",339).
component("YPR176C",899).
component("YPL172C",857).
component("YNR041C",773).
component("YMR101C",703).
component("YDL090C",259).
component("YBR003W",181).
component("YBR002C",180).
component("YJL167W",563).
component("YJL167W",564).
component("YNL256W",752).
component("YPR069C",888).
component("YDR127W",307).
component("YLR303W",666).
component("YGR012W",445).
component("YJR130C",585).
component("YLR303W",667).
component("YDR035W",292).
component("YBR249C",223).
component("YOR274W",826).
component("YOL143C",797).
component("YBR256C",225).
component("YHR137W",508).
component("YGL202W",436).
component("YLR027C",640).
component("YKL106W",606).
component("YKL104C",605).
component("YGR019W",446).
component("YLR089C",646).
component("U64_",131).
component("U61_",128).
component("U51_",120).
component("YJR148W",590).
component("YHR208W",514).
component("YOR184W",815).
component("YNR058W",776).
component("YIL116W",529).
component("YGL253W",442).
component("YFR053C",414).
component("YOL136C",796).
component("YIL107C",527).
component("YMR013C",698).
component("YMR205C",715).
component("YGR240C",474).
component("YDR248C",320).
component("YCR036W",245).
component("YGR194C",468).
component("YCL040W",236).
component("YJR105W",583).
component("U16_",56).
component("U15_",50).
component("YPL188W",859).
component("YJR049C",573).
component("YEL041W",359).
component("U96_",158).
component("YKL001C",595).
component("YDR236C",318).
component("YML070W",689).
component("YFL053W",406).
component("YHL032C",486).
component("YLR133W",648).
component("YDR531W",354).
component("U83_",146).
component("U82_",145).
component("U81_",144).
component("YMR208W",716).
component("YPL203W",860).
component("YOR061W",800).
component("YKL166C",614).
component("YJL164C",561).
component("YIL035C",519).
component("YHR205W",513).
component("YHR102W",506).
component("YGL019W",422).
component("YHR025W",495).
component("YOR347C",836).
component("YAL038W",165).
component("YNR012W",768).
component("YPR121W",895).
component("YPL258C",869).
component("YOL055C",784).
component("YPL214C",863).
component("U1_",79).
component("YDR009W",289).
component("YBR020W",188).
component("YNL267W",756).
component("YLR305C",669).
component("YFR019W",409).
component("YDR208W",316).
component("YDR127W",308).
component("U21_",90).
component("U20_",87).
component("YDR147W",311).
component("YDR300C",329).
component("YCR012W",240).
component("YER052C",372).
component("YER069W",382).
component("U18_",71).
component("U17_",64).
component("U76_",140).
component("YMR220W",718).
component("YER170W",398).
component("YDR226W",317).
component("YKL067W",603).
component("YOL055C",785).
component("YDR454C",348).
component("YJR057W",575).
component("YOL061W",789).
component("YKL181W",615).
component("YHL011C",483).
component("YER099C",393).
component("YBL068W",178).
component("YOR143C",811).
component("YNL256W",753).
component("YLR328W",670).
component("YBR018C",184).
component("YBR018C",185).
component("YGR007W",444).
component("YLR328W",671).
component("YKR002W",625).
component("YDL103C",264).
component("U94_",157).
component("YJR010W",570).
component("YGL130W",432).
component("YDR530C",353).
component("YCL050C",238).
component("YPR190C",901).
component("YPR187W",900).
component("YPR110C",893).
component("YPR010C",882).
component("YOR341W",835).
component("YOR340C",834).
component("YOR224C",823).
component("YOR210W",821).
component("YOR207C",818).
component("YOR151C",812).
component("YOR116C",806).
component("YOL005C",778).
component("YNR003C",766).
component("YNL248C",751).
component("YNL151C",745).
component("YNL113W",739).
component("YKL144C",610).
component("YJR063W",576).
component("YJL148W",558).
component("YJL140W",557).
component("YIL021W",518).
component("YHR143W-A",509).
component("YGL070C",429).
component("YFL036W",405).
component("YDR404C",342).
component("YDR156W",313).
component("YDR045C",295).
component("YDL150W",273).
component("YDL140C",268).
component("YBR154C",212).
component("YPR175W",898).
component("YPL167C",856).
component("YOR330C",832).
component("YOL115W",794).
component("YNL299W",762).
component("YNL262W",755).
component("YNL102W",738).
component("YJR043C",572).
component("YJR006W",569).
component("YJL090C",550).
component("YIL139C",531).
component("YEL055C",362).
component("YDR419W",345).
component("YDR121W",305).
component("YDL102W",263).
component("YCR014C",241).
component("YBR278W",227).
component("YBL035C",172).
component("YKL035W",600).
component("YHL012W",484).
component("YHR123W",507).
component("YPR113W",894).
component("YBR243C",221).
component("YNL130C",741).
component("YDL142C",272).
component("YPL148C",854).
component("YER026C",370).
component("YCL004W",231).
component("YGR286C",482).
component("YJL068C",547).
component("YDR058C",299).
component("YNR034W",772).
component("YHR163W",511).
component("YGR248W",476).
component("YCR073W-A",246).
component("YDL086W",258).
component("YOL011W",780).
component("YMR008C",696).
component("YMR006C",695).
component("U101_",19).
component("YBL015W",171).
component("YJL068C",548).
component("YPL072W",850).
component("YOR124C",807).
component("YNL186W",747).
component("YMR304W",729).
component("YMR223W",719).
component("YKR098C",634).
component("YJL197W",565).
component("YIL156W",533).
component("YFR010W",408).
component("YER151C",396).
component("YER144C",395).
component("YER098W",392).
component("YDR069C",300).
component("YDL122W",265).
component("YBR058C",195).
component("YBL067C",177).
component("YDR272W",324).
component("U84_",147).
component("YLR377C",677).
component("YDR074W",301).
component("YPL179W",858).
component("YNR032W",770).
component("YML057W",688).
component("YML016C",681).
component("YLR433C",680).
component("YGR123C",457).
component("YER133W",394).
component("YER089C",389).
component("YDR436W",346).
component("YDR075W",302).
component("YDL188C",279).
component("YDL134C",267).
component("YDL047W",253).
component("YDL006W",247).
component("YBR125C",205).
component("YBL056W",176).
component("YPR073C",889).
component("YHR215W",515).
component("YDL024C",250).
component("YBR093C",201).
component("YBR092C",200).
component("YAR071W",167).
component("YIL053W",522).
component("YER062C",380).
component("YHR046C",498).
component("U9_",161).
component("YGR208W",472).
component("YPL228W",864).
component("YMR180C",713).
component("YDL236W",285).
component("YJL155C",560).
component("YPR073C",890).
component("YOR208W",819).
component("YNL053W",735).
component("YMR036C",700).
component("YIR026C",537).
component("YIL113W",528).
component("YFR028C",410).
component("YER075C",385).
component("YDL230W",283).
component("YBR276C",226).
component("U34_",107).
component("U33_",106).
component("U32_",105).
component("U30_",104).
...
component("U25_",100).
component("U24_",99).
component("YPL268W",873).
component("YOR360C",838).
component("YGL248W",441).
component("YKR031C",628).
component("YPL206C",861).
component("YGL027C",424).
component("YLR286C",664).
component("YJR153W",592).
component("YBR184W",215).
component("YOR190W",816).
component("YLR300W",665).
component("YGR282C",481).
component("YDR261C",322).
component("YDR400W",340).
component("U23_",98).
component("YML035C",684).
component("YJL070C",549).
component("YBR284W",228).
component("U102_",20).
component("YNL045W",734).
component("YLR160C",655).
component("YLR158C",654).
component("YLR157C",653).
component("YLR155C",652).
component("YDR321W",331).
component("YGL037C",425).
component("YMR293C",726).
component("YDR242W",319).
component("YBR208C",217).
component("YMR281W",725).
component("U53_",122).
component("YIR027C",538).
component("YPL111W",853).
component("YIR032C",541).
component("YIR029W",539).
component("YPR062W",887).
component("YMR120C",709).
component("YLR028C",641).
component("YHR144C",510).
component("YGR267C",480).
component("YNL141W",742).
component("YBR153W",211).
component("YDL238C",286).
component("YNL141W",743).
component("YLR245C",662).
component("YML035C",685).
component("YBR084W",198).
component("YJL126W",553).
component("U44_",114).
component("YDL100C",262).
component("U87_",149).
component("U40_",112).
component("YMR267W",723).
component("YBR011C",183).
component("YBR111C",202).
component("YBR252W",224).
component("YCL030C",235).
component("YER005W",366).
component("YIL048W",521).
component("YER166W",397).
component("YDR093W",303).
component("YAL026C",164).
component("YLR231C",660).
component("U88_",150).
component("YLR134W",649).
component("YLR044C",642).
component("YGR087C",453).
component("YDR380W",338).
component("YDL080C",257).
component("U98_",159).
component("YMR250W",721).
component("YKL184W",619).
component("YEL021W",358).
component("YNR043W",774).
component("U93_",156).
component("YDR047W",297).
component("U54_",123).
component("YKL211C",621) :- not remove_orf("YKL211C",621).
component("YKR097W",633).
component("YOL052C",783).
component("YNL169C",746).
component("YGR170W",461).
component("YKL060C",602).
component("YNL256W",754).
component("YDR294C",326).
component("YEL046C",360).
component("YNR033W",771).
component("YPR006C",881).
component("YER065C",381).
component("YKL211C",622) :- not remove_orf("YKL211C",622).
component("YER090W",622) :- not remove_orf("YER090W",622).
component("YER090W",390) :- not remove_orf("YER090W",390).
component("YDR127W",309).
component("YPL281C",878).
component("YOR393W",843).
component("YMR323W",731).
component("YHR174W",512).
component("YGR254W",477).
component("YPL262W",870).
component("YGL026C",423) :- not remove_orf("YGL026C",423).
component("YGR155W",460).
component("YLR304C",668).
component("YJL200C",566).
component("YNL316C",763).
component("YKL182W",617).
component("YPL212C",862).
component("YNL292W",761).
component("YGL063W",428).
component("YFL001W",400).
component("YOR278W",827).
component("YPR002W",880).
component("U49_",117).
component("YDR127W",310).
component("YGL148W",433).
component("YIL168W",536).
component("YER086W",387).
component("YLR359W",676).
component("YAL012W",162).
component("YFR055W",415).
component("YJL005W",544).
component("YOR176W",814).
component("YJL121C",552).
component("YBR019C",186).
component("YBR019C",187).
component("YDR050C",298).
component("YDR007W",288) :- not remove_orf("YDR007W",288).
component("YOR095C",804).
component("YER003C",365).
component("YBR196C",216).
component("YGL001C",417).
component("U14_",43).
component("YOL056W",786).
component("YKL152C",613).
component("YDL021W",248).
component("YMR105C",704).
component("YKL127W",607).
component("YEL058W",363).
component("YPR060C",886).
component("YHR072W",500).
component("YJL153C",559).
component("YPL097W",851).
component("YGR185C",467).
component("YGR264C",479).
component("YGR171C",462).
component("YHR011W",491).
component("YDR023W",291).
component("YPL104W",852).
component("YLL018C",635).
component("YPR081C",892).
component("YBR121C",204).
component("YHR020W",494).
component("YER087W",388).
component("YNL247W",750).
component("YOL033W",782).
component("YGL245W",440).
component("YHR091C",502).
component("YDR341C",332).
component("YOL097C",792).
component("YDR268W",323).
component("YPR047W",885).
component("YLR060W",644).
component("YFL022C",404).
component("YPR033C",883).
component("YHR019C",492).
component("YCR024C",242).
component("YHR019C",493).
component("YPL160W",855).
component("YLR382C",678).
component("YNL073W",737).
component("YDR037W",293).
component("YOR335C",833).
component("YGR094W",455).
component("YOR317W",829).
component("YMR246W",720).
component("YIL009W",517).
component("YER015W",368).
component("YOR142W",810).
component("YGR244C",475).
component("YPR035W",884).
component("U89_",151).
component("YOR241W",825).
component("YMR113W",706).
component("YKL132C",608).
component("YJL101C",551).
component("U92_",155).
component("YGL234W",438).
component("U91_",154).
component("U90_",153).
component("YDL141W",269).
component("YDL141W",270).
component("YGL234W",439).
component("YDL141W",271).
component("YJR103W",581).
component("YBL039C",173).
component("YGR204W",471).
component("YBR084W",199).
component("YOL058W",787).
component("YBR208C",218).
component("YHR074W",501).
component("YMR217W",717).
component("YGR061C",452).
component("YPR145W",897).
component("YGR124W",458).
component("YOR303W",828).
component("YJR109C",584).
component("YJL130C",555).
component("YGL062W",427).
component("YBR218C",219).
component("YPL231W",868).
component("YNR016C",769).
component("YKL182W",618).
component("YGR037C",448).
component("YOR005C",799).
component("YDL164C",274).
component("YOL010W",779).
component("YPR138C",896).
component("YPL274W",875).
component("YPL265W",871).
component("YPL057C",849).
component("YPL036W",848).
component("YOR348C",837).
component("YOR192C",817).
component("YOR171C",813).
component("YOR130C",808).
component("YOR071C",802).
component("YOL156W",798).
component("YOL103W",793).
component("YOL020W",781) :- not remove_orf("YOL020W",781).
component("YNR072W",777).
component("YNR056C",775).
component("YNL318C",764).
component("YNL268W",757).
component("YNL142W",744).
component("YMR272C",724).
component("YMR011W",697).
component("YML123C",694).
component("YLR348C",673).
component("YLR260W",663).
component("YLR237W",661).
component("YLR138W",650).
component("YLR100C",647).
component("YLR081W",645).
component("YLL061W",638).
component("YLL043W",637).
component("YKR093W",632).
component("YKR053C",630).
component("YKR039W",629) :- not remove_orf("YKR039W",629).
component("YKL217W",624).
component("YKL004W",596).
component("YJR158W",593).
component("YJR152W",591).
component("YJR095W",580).
component("YJR077C",578).
component("YJL219W",568).
component("YJL214W",567).
component("YJL134W",556).
component("YJL129C",554).
component("YHR096C",505).
component("YHR094C",504).
component("YHR092C",503).
component("YHL036W",487).
component("YHL016C",485).
component("YGR121C",456).
component("YGR055W",450).
component("YGL186C",435).
component("YGL077C",430).
component("YGL008C",418).
component("YFL055W",407).
component("YFL011W",401).
component("YER060W-A",377).
component("YER060W",376).
component("YER056C",375).
component("YER053C",373).
component("YEL069C",364).
component("YEL017C-A",357).
component("YDR536W",355).
component("YDR508C",351).
component("YDR503C",350).
component("YDR497C",349).
component("YDR345C",335).
component("YDR343C",334).
component("YDR342C",333).
component("YDR297W",328).
component("YDR294C",327).
component("YDR284C",325).
component("YDR046C",296) :- not remove_orf("YDR046C",296).
component("YDL245C",287).
component("YDL210W",280).
component("YCR032W",244).
component("YCR024C-A",243).
component("YCL025C",233).
component("YBR298C",230).
component("YBR291C",229).
...
catalyst(6160,727).
catalyst(3870,374).
catalyst(3620,337) :- not remove_reaction(3620,337).
catalyst(2110,413).
catalyst(2190,413).
catalyst(5550,586).
catalyst(5791,659).
...
catalyst(1960,297).
catalyst(3460,123).
catalyst(3600,621) :- not remove_reaction(3600,621).
catalyst(8000,633).
catalyst(3941,783).
catalyst(3942,783).
catalyst(6890,746).
...
catalyst(8020,881).
catalyst(8020,381).
catalyst(1890,622) :- not remove_reaction(1890,622).
catalyst(3630,622) :- not remove_reaction(3630,622).
catalyst(1890,390) :- not remove_reaction(1890,390).
catalyst(3630,390) :- not remove_reaction(3630,390).
catalyst(3740,309).
catalyst(8231,878).
catalyst(8232,878).
catalyst(8231,843).
...
catalyst(8051,870).
catalyst(8052,870).
catalyst(3590,423) :- not remove_reaction(3590,423).
catalyst(10910,423) :- not remove_reaction(10910,423).
catalyst(4570,460).
catalyst(8181,668).
catalyst(8182,668).
catalyst(8181,566).
...
catalyst(8281,298).
catalyst(8282,298).
catalyst(3610,288) :- not remove_reaction(3610,288).
catalyst(7921,804).
catalyst(7922,804).
catalyst(7841,365).
catalyst(7842,365).
...
catalyst(1210,798).
catalyst(1160,793).
catalyst(801,781) :- not remove_reaction(801,781).
catalyst(802,781) :- not remove_reaction(802,781).
catalyst(811,781) :- not remove_reaction(811,781).
catalyst(812,781) :- not remove_reaction(812,781).
catalyst(831,781) :- not remove_reaction(831,781).
catalyst(832,781) :- not remove_reaction(832,781).
catalyst(901,781) :- not remove_reaction(901,781).
catalyst(902,781) :- not remove_reaction(902,781).
catalyst(941,781) :- not remove_reaction(941,781).
catalyst(942,781) :- not remove_reaction(942,781).
catalyst(1210,777).
catalyst(700,775).
catalyst(1200,764).
catalyst(761,757).
...
catalyst(640,632).
catalyst(6560,630).
catalyst(761,629) :- not remove_reaction(761,629).
catalyst(762,629) :- not remove_reaction(762,629).
catalyst(771,629) :- not remove_reaction(771,629).
catalyst(772,629) :- not remove_reaction(772,629).
catalyst(781,629) :- not remove_reaction(781,629).
catalyst(782,629) :- not remove_reaction(782,629).
catalyst(791,629) :- not remove_reaction(791,629).
catalyst(792,629) :- not remove_reaction(792,629).
catalyst(801,629) :- not remove_reaction(801,629).
catalyst(802,629) :- not remove_reaction(802,629).
catalyst(811,629) :- not remove_reaction(811,629).
catalyst(812,629) :- not remove_reaction(812,629).
catalyst(821,629) :- not remove_reaction(821,629).
catalyst(822,629) :- not remove_reaction(822,629).
catalyst(831,629) :- not remove_reaction(831,629).
catalyst(832,629) :- not remove_reaction(832,629).
catalyst(841,629) :- not remove_reaction(841,629).
catalyst(842,629) :- not remove_reaction(842,629).
catalyst(861,629) :- not remove_reaction(861,629).
catalyst(862,629) :- not remove_reaction(862,629).
catalyst(881,629) :- not remove_reaction(881,629).
catalyst(882,629) :- not remove_reaction(882,629).
catalyst(901,629) :- not remove_reaction(901,629).
catalyst(902,629) :- not remove_reaction(902,629).
catalyst(911,629) :- not remove_reaction(911,629).
catalyst(912,629) :- not remove_reaction(912,629).
catalyst(921,629) :- not remove_reaction(921,629).
catalyst(922,629) :- not remove_reaction(922,629).
catalyst(941,629) :- not remove_reaction(941,629).
catalyst(942,629) :- not remove_reaction(942,629).
catalyst(1191,629) :- not remove_reaction(1191,629).
catalyst(1192,629) :- not remove_reaction(1192,629).
catalyst(1021,624).
catalyst(1022,624).
catalyst(6610,596).
catalyst(1210,593).
...
catalyst(6550,327).
catalyst(6690,325).
catalyst(791,296) :- not remove_reaction(791,296).
catalyst(792,296) :- not remove_reaction(792,296).
catalyst(801,296) :- not remove_reaction(801,296).
catalyst(802,296) :- not remove_reaction(802,296).
catalyst(811,296) :- not remove_reaction(811,296).
catalyst(812,296) :- not remove_reaction(812,296).
catalyst(831,296) :- not remove_reaction(831,296).
catalyst(832,296) :- not remove_reaction(832,296).
catalyst(841,296) :- not remove_reaction(841,296).
catalyst(842,296) :- not remove_reaction(842,296).
catalyst(861,296) :- not remove_reaction(861,296).
catalyst(862,296) :- not remove_reaction(862,296).
catalyst(901,296) :- not remove_reaction(901,296).
catalyst(902,296) :- not remove_reaction(902,296).
catalyst(1210,287).
catalyst(690,280).
catalyst(730,280).
catalyst(431,244).
...
modifiable_enzyme(621).
modifiable_enzyme(622).
modifiable_enzyme(390).
modifiable_enzyme(423).
modifiable_enzyme(288).
modifiable_enzyme(781).
