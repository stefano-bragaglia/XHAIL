...
component("YGR060W",346).
component("YGL012W",321).
component("YKR009C",479).
component("YOL086C",608).
component("YMR303C",559).
component("YMR083W",541).
...
component("YJR159W",453).
component("YGL001C",318).
component("YIL094C",398).
component("YHR063C",381).
component("YBR153W",163).
component("YML056C",529).
component("YLR432W",525).
component("YHR216W",392).
component("YAR075W",131).
component("YAR073W",130).
component("YDR127W",233).
component("YJR139C",450).
component("YOL126C",612).
component("YDL078C",196).
component("YKL029C",457).
component("YOR136W",622).
component("YNL037C",563).
component("YDL066W",195).
component("YLR355C",522).
component("YML086C",531).
component("YIL155C",404).
component("YPR191W",691).
component("YOR065W",617).
component("YJL166W",428).
component("YHR001W-A",373).
component("YGR183C",357).
component("YFR033C",314).
component("YDR529C",269).
component("YBL045C",137).
component("Q0105",18).
component("YGR088W",348).
component("YDR256C",247).
component("YKL026C",456).
component("YIR037W",411).
component("YBR244W",173).
component("YJR078W",441).
component("YJR025C",435).
component("YGR255C",366).
component("U108_",22).
component("YBL098W",140).
component("YMR015C",538).
component("YDR402C",261).
component("YGL055W",326).
component("YGR175C",354).
component("YJR104C",444).
component("YHR008C",374).
component("YJL026W",412).
component("YGR180C",356).
component("YER070W",290).
component("U35_",85).
component("YDL168W",211).
component("YDR158W",241).
component("YPL276W",672).
component("YPL275W",671).
component("YOR388C",649).
component("YOR374W",646).
component("YER073W",291).
component("YGL154C",332).
component("U55_",96).
component("YOR323C",638).
component("YMR170C",547).
component("YMR169C",546).
component("U2_",82).
component("YBR221C",171).
component("YIL125W",402).
component("U52_",93).
...
component("YER014W",278).
component("YKR009C",480).
component("YIL160C",406).
component("YGL205W",335).
component("YMR118C",544).
component("YLR164W",505).
component("YLL041C",488).
component("YKL148C",467).
component("YKL141W",465).
component("YJL045W",413).
component("YDR178W",242).
component("YJR051W",437).
component("YEL047C",273).
component("YOR375C",647).
component("YDL215C",214).
component("YAL062W",128).
component("U99_",124).
component("YBR035C",149).
component("YHR037W",378).
component("YKR080W",484).
component("YER023W",279).
component("YOR236W",635).
component("YGR204W",359).
component("YLR142W",500).
component("U62_",100).
component("YKL150W",468).
component("YIL043C",394).
component("YHR042W",379).
component("YOR221C",633).
component("YML120C",534).
component("YKL192C",474).
component("YKL055C",459).
component("YER061C",287).
component("YFR030W",313).
component("YPL017C",652).
component("YFL018C",305).
component("YER042W",281).
component("YJR137C",449).
component("YPL266W",669).
component("YML110C",533).
component("YBR034C",148).
component("YPL273W",670).
component("YLL062C",491).
component("U47_",90).
component("YER091C",296).
component("YJR073C",439).
component("YDL033C",193).
component("YOL096C",609).
component("YLR172C",506).
component("YDR019C",220).
component("YDR408C",263).
component("YBL013W",132).
component("YKL024C",455).
component("YPR074C",683).
component("YBR117C",158).
component("YLR354C",521).
component("YGR043C",344).
component("YCL009C",182).
component("YMR062C",540).
component("YNL071W",566).
component("YNR008W",593).
component("YPL231W",664).
component("YER061C",288).
component("U86_",115).
component("YPL001W",651).
component("YDR148C",239).
component("YOR377W",648).
component("YGR177C",355).
component("YPL231W",665).
component("YGR147C",351).
component("YDL040C",194).
component("YPL028W",653).
component("YGL017W",323).
component("YPR001W",674).
component("YNR001C",591).
component("YDL182W",212).
component("YDL131W",203).
component("YNL117W",570).
component("YIR031C",409).
component("YDR307W",254).
component("YNL029C",562).
component("YIL085C",397).
component("YMR261C",554).
component("YML100W",532).
component("YBR126C",160).
component("YNL192W",577).
component("YBR038W",151).
component("YBR023C",147).
component("YLR209C",507).
component("U104_",21).
component("YOR209C",631).
component("YMR300C",558).
component("YER055C",283).
component("YDR354W",257) :- not remove_orf("YDR354W",257).
component("YFR047C",315).
component("YJR133W",448).
component("YLR209C",508).
component("YML022W",526).
component("YDR441C",265).
component("YDR399W",259).
component("YJL167W",429).
component("YNL256W",580).
component("YDR127W",234).
component("YLR303W",514).
component("YGR012W",341).
component("YJR130C",447).
component("YLR303W",515).
component("YDR035W",222).
component("YBR249C",174).
component("YOL143C",614).
component("YBR256C",175).
component("YHR137W",386).
component("YGL202W",334).
component("YLR027C",492).
component("YKL106W",462).
component("YKL104C",461).
component("YGR019W",342).
component("YLR089C",496).
component("U64_",101).
component("U61_",99).
component("U51_",92).
component("YJR148W",451).
component("YOR184W",626).
component("YIL116W",401).
component("YGL253W",338).
component("YFR053C",316).
component("YOL136C",613).
component("YIL107C",399).
component("YMR205C",549).
component("YGR240C",362).
component("YDR248C",246).
...
component("YFL053W",308).
component("YHL032C",371).
component("U83_",113).
component("U82_",112).
component("U81_",111).
component("YMR208W",550).
component("YOR347C",643).
component("YAL038W",127).
component("YNR012W",594).
component("YPR121W",686).
component("YPL258C",667).
component("YOL055C",605).
component("U1_",63).
component("YDR009W",219).
component("YBR020W",145).
component("YNL267W",583).
component("YLR305C",517).
component("YFR019W",311).
...
component("YKL067W",460).
component("YDR454C",266).
component("YOL061W",607).
component("YKL181W",470).
component("YHL011C",369).
component("YER099C",298).
component("YBL068W",139).
component("YOR143C",624).
component("YLR328W",518).
component("YBR018C",142).
component("YGR007W",340).
component("YLR328W",519).
component("YKR002W",478).
component("YDL103C",201).
component("YJR010W",434).
component("YCL050C",186).
component("YPR190C",690).
component("YPR187W",689).
component("YPR110C",685).
component("YPR010C",676).
component("YOR341W",642).
component("YOR340C",641).
component("YOR224C",634).
component("YOR210W",632).
component("YOR207C",629).
component("YOR151C",625).
component("YOR116C",620).
component("YOL005C",600).
component("YNR003C",592).
component("YNL248C",579).
component("YNL151C",574).
component("YNL113W",569).
component("YKL144C",466).
component("YJR063W",438).
component("YJL148W",425).
component("YJL140W",424).
component("YIL021W",393).
component("YHR143W-A",387).
component("YGL070C",329).
component("YFL036W",307).
component("YDR404C",262).
...
component("YPL167C",660).
component("YOR330C",639).
...
component("YEL055C",274).
component("YDR419W",264).
component("YDR121W",232).
component("YDL102W",200).
component("YCR014C",188).
component("YBR278W",177).
component("YBL035C",134).
component("YKL035W",458).
component("YHL012W",370).
component("YHR123W",385).
component("YBR243C",172).
component("YDL142C",207).
component("YER026C",280).
component("YCL004W",181).
component("YJL068C",414).
component("YDR058C",229).
component("YNR034W",597).
component("YHR163W",389).
component("YGR248W",364).
component("YCR073W-A",191).
component("YDL086W",198).
component("YOL011W",602).
component("YMR008C",537).
component("YMR006C",536).
component("U101_",19).
component("YBL015W",133).
component("YJL068C",415).
component("YPL072W",656).
component("YOR124C",621).
component("YNL186W",576).
component("YMR304W",560).
component("YMR223W",552).
component("YKR098C",486).
component("YJL197W",430).
component("YIL156W",405).
component("YFR010W",310).
component("YER151C",300).
component("YER144C",299).
component("YER098W",297).
component("YDR069C",230).
component("YDL122W",202).
component("YBR058C",152).
component("YBL067C",138).
component("YDR272W",249).
component("U84_",114).
component("YPR073C",681).
component("YHR215W",391).
component("YDL024C",192).
...
component("YGR208W",361).
component("YPL228W",662).
component("YMR180C",548).
component("YDL236W",216).
component("YJL155C",427).
component("YPR073C",682).
component("YOR208W",630).
component("YNL053W",565).
component("YMR036C",539).
component("YIR026C",407).
component("YIL113W",400).
component("YFR028C",312).
component("YER075C",292).
...
component("U25_",80).
component("U24_",79).
component("YOR360C",645).
component("YGL248W",337).
component("YKR031C",481).
component("YLR286C",512).
component("YJR153W",452).
component("YOR190W",627).
component("YLR300W",513).
component("YGR282C",368).
component("YDR261C",248).
component("YDR400W",260).
component("U23_",78).
component("YML035C",527).
component("YJL070C",416).
...
component("YDL238C",217).
component("YNL141W",572).
component("YLR245C",511).
component("YML035C",528).
component("YJL126W",420).
component("U44_",88).
component("YDL100C",199).
component("U87_",116).
component("YMR267W",555).
component("YBR011C",141).
component("YBR111C",157).
component("YCL030C",184).
component("YER005W",277).
component("YIL048W",395).
component("YER166W",301).
component("YDR093W",231).
component("YAL026C",126).
component("YLR231C",509).
component("U88_",117).
component("YLR134W",498).
component("YLR044C",493).
component("YGR087C",347).
component("YDR380W",258).
component("YDL080C",197).
component("U98_",123).
component("YMR250W",553).
component("YKL184W",473).
component("YNR043W",598).
component("U93_",121).
component("YDR047W",227).
component("U54_",95).
component("YKL211C",475) :- not remove_orf("YKL211C",475).
component("YNL169C",575).
component("YGR170W",353).
component("YNL256W",581).
component("YDR294C",250).
component("YEL046C",272).
component("YNR033W",596).
component("YKL211C",476) :- not remove_orf("YKL211C",476).
component("YER090W",476) :- not remove_orf("YER090W",476).
component("YER090W",295) :- not remove_orf("YER090W",295).
component("YDR127W",236).
component("YPL281C",673).
component("YOR393W",650).
component("YMR323W",561).
component("YHR174W",390).
component("YGR254W",365).
component("YGL026C",324) :- not remove_orf("YGL026C",324).
component("YGR155W",352).
component("YLR304C",516).
component("YJL200C",431).
component("YNL316C",589).
component("YKL182W",471).
component("YPL212C",661).
component("YNL292W",587).
component("YGL063W",328).
component("YFL001W",303).
component("YPR002W",675).
component("YDR127W",237).
component("YGL148W",331).
component("YER086W",293).
component("YLR359W",523).
component("YAL012W",125).
component("YFR055W",317).
component("YJL121C",419).
component("YBR019C",143).
component("YBR019C",144).
component("YDR050C",228).
component("YDR007W",218) :- not remove_orf("YDR007W",218).
component("YOR095C",619).
component("YER003C",276).
component("YBR196C",167).
component("YGL001C",319).
component("U14_",33).
component("YKL152C",469).
component("YMR105C",542).
component("YKL127W",463).
component("YEL058W",275).
component("YPR060C",679).
component("YHR072W",382).
component("YJL153C",426).
component("YPL097W",657).
component("YGR185C",358).
component("YHR011W",375).
component("YDR023W",221).
component("YPL104W",658).
component("YLL018C",487).
component("YPR081C",684).
component("YBR121C",159).
component("YHR020W",377).
component("YER087W",294).
component("YNL247W",578).
component("YOL033W",604).
component("YHR091C",384).
component("YDR341C",256).
component("YOL097C",610).
component("YPR047W",678).
component("YLR060W",494).
component("YFL022C",306).
component("YPR033C",677).
component("YHR019C",376).
component("YPL160W",659).
component("YLR382C",524).
component("YNL073W",567).
component("YDR037W",223).
component("YOR335C",640).
component("YGR094W",349).
component("YOR142W",623).
component("YGR244C",363).
component("U89_",118).
component("YOR241W",636).
component("YMR113W",543).
component("YKL132C",464).
component("YJL101C",418).
component("U92_",120).
component("YGL234W",336).
component("U91_",119).
...
component("YOL058W",606).
component("YBR208C",169).
component("YHR074W",383).
component("YMR217W",551).
component("YOR303W",637).
component("YJR109C",446).
component("YJL130C",422).
...
component("YOR005C",616).
component("YDL164C",209).
component("YOL010W",601).
component("YPR138C",687).
component("YPL265W",668).
component("YPL057C",655).
component("YPL036W",654).
component("YOR348C",644).
component("YOR192C",628).
component("YOR071C",618).
component("YOL156W",615).
component("YOL020W",603) :- not remove_orf("YOL020W",603).
component("YNR056C",599).
component("YNL318C",590).
component("YNL268W",584).
component("YNL142W",573).
component("YMR272C",556).
component("YML123C",535).
component("YLR348C",520).
component("YLR237W",510).
component("YLR138W",499).
component("YLR100C",497).
component("YLR081W",495).
component("YLL061W",490).
component("YLL043W",489).
component("YKR093W",485).
component("YKR053C",483).
component("YKR039W",482) :- not remove_orf("YKR039W",482).
component("YKL217W",477).
component("YJR095W",442).
component("YJR077C",440).
component("YJL219W",432).
component("YJL134W",423).
component("YJL129C",421).
component("YHL036W",372).
component("YGR121C",350).
component("YGR055W",345).
component("YGL186C",333).
component("YGL077C",330).
component("YGL008C",320).
component("YFL055W",309).
component("YFL011W",304).
component("YER060W-A",286).
component("YER060W",285).
component("YER056C",284).
component("YER053C",282).
component("YEL017C-A",271).
component("YDR536W",270).
component("YDR508C",268).
component("YDR503C",267).
component("YDR297W",252).
component("YDR294C",251).
component("YDR046C",226) :- not remove_orf("YDR046C",226).
component("YDL210W",213).
component("YCR024C-A",189).
component("YCL025C",183).
...
catalyst(6160,558).
catalyst(3870,283).
catalyst(3620,257) :- not remove_reaction(3620,257).
catalyst(2110,315).
catalyst(2190,315).
catalyst(5550,448).
catalyst(5791,508).
...
catalyst(1960,227).
catalyst(3460,95).
catalyst(3600,475) :- not remove_reaction(3600,475).
catalyst(6890,575).
catalyst(6900,353).
catalyst(2570,581).
catalyst(8781,250).
...
catalyst(8231,365).
catalyst(8232,365).
catalyst(3590,324) :- not remove_reaction(3590,324).
catalyst(10910,324) :- not remove_reaction(10910,324).
catalyst(4570,352).
catalyst(8181,516).
catalyst(8182,516).
catalyst(8181,431).
...
catalyst(941,603) :- not remove_reaction(941,603).
catalyst(942,603) :- not remove_reaction(942,603).
catalyst(700,599).
catalyst(1200,590).
catalyst(761,584).
catalyst(762,584).
...
catalyst(640,485).
catalyst(6560,483).
catalyst(761,482) :- not remove_reaction(761,482).
catalyst(762,482) :- not remove_reaction(762,482).
catalyst(771,482) :- not remove_reaction(771,482).
catalyst(772,482) :- not remove_reaction(772,482).
catalyst(781,482) :- not remove_reaction(781,482).
catalyst(782,482) :- not remove_reaction(782,482).
catalyst(791,482) :- not remove_reaction(791,482).
catalyst(792,482) :- not remove_reaction(792,482).
...
catalyst(821,482) :- not remove_reaction(821,482).
catalyst(822,482) :- not remove_reaction(822,482).
catalyst(831,482) :- not remove_reaction(831,482).
catalyst(832,482) :- not remove_reaction(832,482).
catalyst(841,482) :- not remove_reaction(841,482).
catalyst(842,482) :- not remove_reaction(842,482).
catalyst(861,482) :- not remove_reaction(861,482).
catalyst(862,482) :- not remove_reaction(862,482).
catalyst(881,482) :- not remove_reaction(881,482).
catalyst(882,482) :- not remove_reaction(882,482).
catalyst(901,482) :- not remove_reaction(901,482).
catalyst(902,482) :- not remove_reaction(902,482).
catalyst(911,482) :- not remove_reaction(911,482).
catalyst(912,482) :- not remove_reaction(912,482).
catalyst(941,482) :- not remove_reaction(941,482).
catalyst(942,482) :- not remove_reaction(942,482).
catalyst(1191,482) :- not remove_reaction(1191,482).
catalyst(1192,482) :- not remove_reaction(1192,482).
catalyst(1021,477).
catalyst(1022,477).
catalyst(1250,442).
catalyst(1581,440).
