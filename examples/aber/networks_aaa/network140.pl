...
component("YNL280C",747).
component("YLR056W",633).
component("YGR060W",443).
component("YGL012W",411).
component("YKR009C",616).
component("YOL086C",778).
component("YMR303C",716).
component("YMR083W",691).
component("YGL256W",435).
component("YDL168W",270).
component("YBR145W",203).
component("YPL231W",851).
component("U46_",112).
component("YBR149W",204).
component("YBR149W",205).
component("YJR159W",585).
component("YGL001C",408).
component("YIL094C",518).
component("YHR063C",491).
component("YBR153W",206).
component("YML056C",676).
component("YLR432W",669).
component("YHR216W",508).
component("YAR075W",165).
component("YAR073W",164).
component("YCL030C",230).
component("YDR127W",300).
component("YJR139C",579).
component("YOL126C",783).
component("YKL085W",595).
component("YDL078C",251).
component("YKL029C",590).
component("YOR136W",795).
component("YNL037C",721).
component("YDL066W",250).
component("YNL241C",737).
component("YOL059W",776).
component("YDL022W",244).
component("YLR355C",665).
component("YIL074C",516).
component("YER081W",378).
component("YML054C",675).
component("YDL174C",272).
component("YML086C",679).
component("YIL155C",524).
component("YPR191W",887).
component("YOR065W",789).
component("YJL166W",553).
component("YHR001W-A",480).
component("YGR183C",458).
component("YFR033C",404).
component("YDR529C",346).
component("YBL045C",171).
component("Q0105",18).
component("YGR088W",446).
component("YDR256C",315).
component("YKL026C",589).
component("YIR037W",534).
component("YBR244W",218).
component("YJR078W",570).
component("YJR025C",562).
component("YGR255C",470).
component("U108_",22).
component("YBL098W",175).
component("YMR015C",688).
component("YHR007C",481).
component("YDR402C",335).
component("YGL055W",418).
component("YGR175C",455).
component("YJR104C",573).
component("YHR008C",482).
component("YJL026W",536).
component("YIL066C",515).
component("YGR180C",457).
component("YER070W",375).
component("U38_",107).
component("U36_",106).
component("U35_",105).
...
component("YPL276W",863).
component("YPL275W",862).
component("YOR388C",828).
component("YOR374W",825).
component("YER073W",376).
component("U68_",128).
component("YGL154C",426).
component("U55_",121).
component("YOR323C",817).
component("YMR170C",700).
component("YMR169C",699).
component("U2_",101).
component("YER178W",391).
component("YBR221C",216).
component("YIL125W",522).
component("U52_",118).
component("YBR166C",209).
component("YNL280C",748).
component("YGL012W",412).
component("U57_",123).
component("YKL216W",613).
component("YDR044W",288).
component("YER014W",360).
component("YKR009C",617).
component("YIL160C",526).
component("YGL205W",429).
component("YMR118C",696).
component("YLR164W",646).
component("YLL041C",626).
component("YKL148C",602).
component("YKL141W",600).
component("YJL045W",537).
component("YDR178W",309).
component("YJR051W",565).
component("YEL047C",354).
component("YDL215C",276).
component("YOR375C",826).
component("YDL215C",277).
component("YAL062W",162).
component("U99_",156).
component("YBR035C",188).
component("YMR189W",702).
component("U56_",122).
component("YHR037W",488).
component("YKR080W",621).
component("YER023W",362).
component("YPL023C",832).
component("YGL125W",423).
component("YOR236W",810).
component("YGR204W",462).
component("YLR142W",641).
component("U62_",126).
component("YKL150W",603).
component("YIL043C",512).
component("YHR042W",489).
component("YOR221C",808).
component("YML120C",682).
component("YKL192C",610).
component("YKL055C",592).
component("YER061C",371).
component("YGR234W",465).
component("YFR030W",403).
component("YPL017C",831).
component("YFL018C",395).
component("YDR353W",330).
component("YER042W",364).
component("YJR137C",578).
component("YPL266W",858).
component("YML110C",681).
component("YBR034C",187).
component("YPL273W",860).
component("YLL062C",629).
component("YDR410C",338).
component("U47_",113).
component("YER091C",383).
component("YJR073C",568).
component("YDR120C",298).
component("YDL033C",246).
component("YOL096C",779).
component("YLR172C",647).
component("YDR019C",284).
component("YBR176W",210).
component("YDR408C",337).
component("YMR120C",697).
component("YBL013W",166).
component("YKL024C",588).
component("YPR074C",876).
component("YBR117C",199).
component("YLR354C",664).
component("YGR043C",441).
component("YMR108W",694).
component("YCL009C",228).
component("YMR062C",690).
component("YNL071W",724).
component("YNR008W",755).
component("YIL160C",527).
component("YNL277W",746).
component("YFL017C",394).
component("YPL231W",852).
component("YER061C",372).
component("U86_",144).
component("YPL001W",830).
component("YDL052C",249).
component("U8_",148).
component("YDR148C",306).
component("YOR377W",827).
component("YGR177C",456).
component("YPL231W",853).
component("YGR147C",451).
component("YDL040C",247).
component("YPL028W",833).
component("YGL017W",413).
component("YPR001W",865).
component("YNR001C",753).
component("YCR005C",234).
component("YDL182W",273).
component("YDL131W",261).
component("YNL117W",728).
component("YIR031C",532).
component("YOR321W",816).
component("YJR143C",580).
component("YGR199W",461).
component("YDR307W",324).
component("YDL095W",256).
component("YDL093W",255).
component("YAL023C",159).
component("YNL029C",720).
component("YIL085C",517).
component("YMR261C",710).
component("YML100W",680).
component("YBR126C",202).
component("YNL192W",736).
component("YBR038W",190).
component("YBR023C",186).
component("YMR306W",718).
component("YLR342W",662).
component("YGR032W",439).
component("YLR209C",648).
component("U104_",21).
component("YOR209C",806).
component("YMR300C",715).
component("YER055C",367).
component("YDR354W",331) :- not remove_orf("YDR354W",331).
component("YFR047C",405).
component("YJR133W",577).
component("YLR209C",649).
component("YML022W",672).
component("YDR441C",341).
component("YDR399W",333).
component("YPR176C",884).
component("YPL172C",843).
component("YNR041C",761).
component("YMR101C",692).
component("YDL090C",254).
component("YBR003W",177).
component("YBR002C",176).
component("YJL167W",554).
component("YJL167W",555).
component("YNL256W",740).
component("YDR127W",301).
component("YLR303W",656).
component("YGR012W",437).
component("YJR130C",576).
component("YLR303W",657).
component("YDR035W",286).
component("YBR249C",219).
component("YOR274W",812).
component("YOL143C",785).
component("YBR256C",221).
component("YHR137W",500).
component("YGL202W",428).
component("YLR027C",630).
component("YKL106W",597).
component("YKL104C",596).
component("YGR019W",438).
component("YLR089C",636).
component("U64_",127).
component("U61_",125).
component("U51_",117).
component("YJR148W",581).
component("YHR208W",506).
component("YOR184W",801).
component("YNR058W",764).
component("YIL116W",521).
component("YGL253W",434).
component("YFR053C",406).
component("YOL136C",784).
component("YIL107C",519).
component("YMR013C",687).
component("YMR205C",703).
component("YGR240C",466).
component("YDR248C",314).
component("YCR036W",240).
component("YGR194C",460).
component("YCL040W",232).
component("YJR105W",574).
component("U16_",55).
component("U15_",49).
component("YPL188W",845).
component("YJR049C",564).
component("YEL041W",352).
component("U96_",154).
component("YKL001C",586).
component("YDR236C",312).
component("YML070W",678).
component("YFL053W",398).
component("YHL032C",478).
component("YLR133W",638).
component("YDR531W",348).
component("U83_",142).
component("U82_",141).
component("U81_",140).
component("YMR208W",704).
component("YPL203W",846).
component("YOR061W",788).
component("YKL166C",605).
component("YJL164C",552).
component("YIL035C",511).
component("YHR205W",505).
component("YHR102W",498).
component("YGL019W",414).
component("YHR025W",487).
component("YOR347C",822).
component("YAL038W",161).
component("YNR012W",756).
component("YPR121W",880).
component("YPL258C",855).
component("YOL055C",772).
component("YPL214C",849).
component("U1_",78).
component("YDR009W",283).
component("YBR020W",184).
component("YNL267W",744).
component("YLR305C",659).
component("YFR019W",401).
...
component("U17_",63).
component("U76_",136).
component("YMR220W",706).
component("YER170W",390).
component("YDR226W",311).
component("YKL067W",594).
component("YOL055C",773).
component("YDR454C",342).
component("YJR057W",566).
component("YOL061W",777).
component("YKL181W",606).
component("YHL011C",475).
component("YER099C",385).
component("YBL068W",174).
component("YOR143C",797).
component("YNL256W",741).
component("YLR328W",660).
component("YBR018C",180).
component("YBR018C",181).
component("YGR007W",436).
component("YLR328W",661).
component("YKR002W",615).
component("YDL103C",259).
component("U94_",153).
component("YJR010W",561).
component("YGL130W",424).
component("YDR530C",347).
component("YCL050C",233).
component("YPR190C",886).
component("YPR187W",885).
component("YPR110C",878).
component("YPR010C",868).
component("YOR341W",821).
component("YOR340C",820).
component("YOR224C",809).
component("YOR210W",807).
component("YOR207C",804).
component("YOR151C",798).
component("YOR116C",792).
component("YOL005C",766).
component("YNR003C",754).
component("YNL248C",739).
component("YNL151C",733).
component("YNL113W",727).
component("YKL144C",601).
component("YJR063W",567).
component("YJL148W",549).
component("YJL140W",548).
component("YIL021W",510).
component("YHR143W-A",501).
component("YGL070C",421).
component("YFL036W",397).
...
component("YPR175W",883).
component("YPL167C",842).
component("YOR330C",818).
component("YOL115W",782).
component("YNL299W",750).
component("YNL262W",743).
component("YNL102W",726).
component("YJR043C",563).
component("YJR006W",560).
component("YJL090C",541).
component("YIL139C",523).
...
component("YKL035W",591).
component("YHL012W",476).
component("YHR123W",499).
component("YPR113W",879).
component("YBR243C",217).
component("YNL130C",729).
component("YDL142C",267).
component("YPL148C",840).
component("YER026C",363).
component("YCL004W",227).
component("YGR286C",474).
component("YJL068C",538).
component("YDR058C",293).
component("YNR034W",760).
component("YHR163W",503).
component("YGR248W",468).
component("YCR073W-A",241).
component("YDL086W",253).
component("YOL011W",768).
component("YMR008C",685).
component("YMR006C",684).
component("U101_",19).
component("YBL015W",167).
component("YJL068C",539).
component("YPL072W",836).
component("YOR124C",793).
component("YNL186W",735).
component("YMR304W",717).
component("YMR223W",707).
component("YKR098C",624).
component("YJL197W",556).
component("YIL156W",525).
component("YFR010W",400).
component("YER151C",388).
component("YER144C",387).
component("YER098W",384).
...
component("U84_",143).
component("YLR377C",667).
component("YDR074W",295).
component("YPL179W",844).
component("YNR032W",758).
component("YML057W",677).
component("YML016C",671).
component("YLR433C",670).
component("YGR123C",449).
component("YER133W",386).
component("YER089C",381).
...
component("YPR073C",874).
component("YHR215W",507).
component("YDL024C",245).
component("YBR093C",197).
component("YBR092C",196).
component("YAR071W",163).
component("YIL053W",514).
component("YER062C",373).
component("YHR046C",490).
component("U9_",157).
component("YGR208W",464).
component("YPL228W",850).
component("YMR180C",701).
component("YDL236W",279).
component("YJL155C",551).
component("YPR073C",875).
component("YOR208W",805).
component("YNL053W",723).
component("YMR036C",689).
component("YIR026C",529).
component("YIL113W",520).
component("YFR028C",402).
component("YER075C",377).
...
component("U25_",98).
component("U24_",97).
component("YPL268W",859).
component("YOR360C",824).
component("YGL248W",433).
component("YKR031C",618).
component("YPL206C",847).
component("YGL027C",416).
component("YLR286C",654).
component("YJR153W",583).
component("YBR184W",211).
component("YOR190W",802).
component("YLR300W",655).
component("YGR282C",473).
component("YDR261C",316).
component("YDR400W",334).
component("U23_",96).
component("YML035C",673).
component("YJL070C",540).
component("YBR284W",224).
component("U102_",20).
component("YNL045W",722).
component("YLR160C",645).
component("YLR158C",644).
component("YLR157C",643).
component("YLR155C",642).
component("YDR321W",325).
component("YGL037C",417).
component("YMR293C",714).
component("YDR242W",313).
component("YBR208C",213).
component("YMR281W",713).
component("U53_",119).
component("YIR027C",530).
component("YPL111W",839).
component("YIR032C",533).
component("YIR029W",531).
component("YPR062W",873).
component("YMR120C",698).
component("YLR028C",631).
component("YHR144C",502).
component("YGR267C",472).
component("YNL141W",730).
component("YBR153W",207).
component("YDL238C",280).
component("YNL141W",731).
component("YLR245C",652).
component("YML035C",674).
component("YBR084W",194).
component("YJL126W",544).
component("U44_",111).
component("YDL100C",257).
component("U87_",145).
component("U40_",109).
component("YMR267W",711).
component("YBR011C",179).
component("YBR111C",198).
component("YBR252W",220).
component("YCL030C",231).
component("YER005W",359).
component("YIL048W",513).
component("YER166W",389).
component("YDR093W",297).
component("YAL026C",160).
component("YLR231C",650).
component("U88_",146).
component("YLR134W",639).
component("YLR044C",632).
component("YGR087C",445).
component("YDR380W",332).
component("YDL080C",252).
component("U98_",155).
component("YMR250W",709).
component("YKL184W",609).
component("YEL021W",351).
component("YNR043W",762).
component("U93_",152).
component("YDR047W",291).
component("U54_",120).
component("YKL211C",611) :- not remove_orf("YKL211C",611).
component("YKR097W",623).
component("YOL052C",771).
component("YNL169C",734).
component("YGR170W",453).
component("YKL060C",593).
component("YNL256W",742).
component("YDR294C",320).
component("YEL046C",353).
component("YNR033W",759).
component("YPR006C",867).
component("YER065C",374).
component("YKL211C",612) :- not remove_orf("YKL211C",612).
component("YER090W",612) :- not remove_orf("YER090W",612).
component("YER090W",382) :- not remove_orf("YER090W",382).
component("YDR127W",303).
component("YPL281C",864).
component("YOR393W",829).
component("YMR323W",719).
component("YHR174W",504).
component("YGR254W",469).
component("YPL262W",856).
component("YGL026C",415) :- not remove_orf("YGL026C",415).
component("YGR155W",452).
component("YLR304C",658).
component("YJL200C",557).
component("YNL316C",751).
component("YKL182W",607).
component("YPL212C",848).
component("YNL292W",749).
component("YGL063W",420).
component("YFL001W",392).
component("YOR278W",813).
component("YPR002W",866).
component("U49_",114).
component("YDR127W",304).
component("YGL148W",425).
component("YIL168W",528).
component("YER086W",379).
component("YLR359W",666).
component("YAL012W",158).
component("YFR055W",407).
component("YJL005W",535).
component("YOR176W",800).
component("YJL121C",543).
component("YBR019C",182).
component("YBR019C",183).
component("YDR050C",292).
component("YDR007W",282) :- not remove_orf("YDR007W",282).
component("YOR095C",791).
component("YER003C",358).
component("YBR196C",212).
component("YGL001C",409).
component("U14_",42).
component("YOL056W",774).
component("YKL152C",604).
component("YDL021W",243).
component("YMR105C",693).
component("YKL127W",598).
component("YEL058W",356).
component("YPR060C",872).
component("YHR072W",492).
component("YJL153C",550).
component("YPL097W",837).
component("YGR185C",459).
component("YGR264C",471).
component("YGR171C",454).
component("YHR011W",483).
component("YDR023W",285).
component("YPL104W",838).
component("YLL018C",625).
component("YPR081C",877).
component("YBR121C",200).
component("YHR020W",486).
component("YER087W",380).
component("YNL247W",738).
component("YOL033W",770).
component("YGL245W",432).
component("YHR091C",494).
component("YDR341C",326).
component("YOL097C",780).
component("YDR268W",317).
component("YPR047W",871).
component("YLR060W",634).
component("YFL022C",396).
component("YPR033C",869).
component("YHR019C",484).
component("YCR024C",237).
component("YHR019C",485).
component("YPL160W",841).
component("YLR382C",668).
component("YNL073W",725).
component("YDR037W",287).
component("YOR335C",819).
component("YGR094W",447).
component("YOR317W",815).
component("YMR246W",708).
component("YIL009W",509).
component("YER015W",361).
component("YOR142W",796).
component("YGR244C",467).
component("YPR035W",870).
component("U89_",147).
component("YOR241W",811).
component("YMR113W",695).
component("YKL132C",599).
component("YJL101C",542).
component("U92_",151).
component("YGL234W",430).
component("U91_",150).
component("U90_",149).
...
component("YJR103W",572).
component("YBL039C",169).
component("YGR204W",463).
component("YBR084W",195).
component("YOL058W",775).
component("YBR208C",214).
component("YHR074W",493).
component("YMR217W",705).
component("YGR061C",444).
component("YPR145W",882).
component("YGR124W",450).
component("YOR303W",814).
component("YJR109C",575).
component("YJL130C",546).
component("YGL062W",419).
component("YBR218C",215).
component("YPL231W",854).
component("YNR016C",757).
component("YKL182W",608).
component("YGR037C",440).
component("YOR005C",787).
component("YDL164C",269).
component("YOL010W",767).
component("YPR138C",881).
component("YPL274W",861).
component("YPL265W",857).
component("YPL057C",835).
component("YPL036W",834).
component("YOR348C",823).
component("YOR192C",803).
component("YOR171C",799).
component("YOR130C",794).
component("YOR071C",790).
component("YOL156W",786).
component("YOL103W",781).
component("YOL020W",769) :- not remove_orf("YOL020W",769).
component("YNR072W",765).
component("YNR056C",763).
component("YNL318C",752).
component("YNL268W",745).
component("YNL142W",732).
component("YMR272C",712).
component("YMR011W",686).
component("YML123C",683).
component("YLR348C",663).
component("YLR260W",653).
component("YLR237W",651).
component("YLR138W",640).
component("YLR100C",637).
component("YLR081W",635).
component("YLL061W",628).
component("YLL043W",627).
component("YKR093W",622).
component("YKR053C",620).
component("YKR039W",619) :- not remove_orf("YKR039W",619).
component("YKL217W",614).
component("YKL004W",587).
component("YJR158W",584).
component("YJR152W",582).
component("YJR095W",571).
component("YJR077C",569).
component("YJL219W",559).
component("YJL214W",558).
component("YJL134W",547).
component("YJL129C",545).
component("YHR096C",497).
component("YHR094C",496).
component("YHR092C",495).
component("YHL036W",479).
component("YHL016C",477).
component("YGR121C",448).
component("YGR055W",442).
component("YGL186C",427).
component("YGL077C",422).
component("YGL008C",410).
component("YFL055W",399).
component("YFL011W",393).
...
catalyst(1960,291).
catalyst(3460,120).
catalyst(3600,611) :- not remove_reaction(3600,611).
catalyst(8000,623).
catalyst(3941,771).
catalyst(3942,771).
catalyst(6890,734).
...
catalyst(8020,867).
catalyst(8020,374).
catalyst(1890,612) :- not remove_reaction(1890,612).
catalyst(3630,612) :- not remove_reaction(3630,612).
catalyst(1890,382) :- not remove_reaction(1890,382).
catalyst(3630,382) :- not remove_reaction(3630,382).
catalyst(3740,303).
catalyst(8231,864).
catalyst(8232,864).
catalyst(8231,829).
...
catalyst(8051,856).
catalyst(8052,856).
catalyst(3590,415) :- not remove_reaction(3590,415).
catalyst(10910,415) :- not remove_reaction(10910,415).
catalyst(4570,452).
catalyst(8181,658).
catalyst(8182,658).
catalyst(8181,557).
...
catalyst(1210,786).
catalyst(1160,781).
catalyst(801,769) :- not remove_reaction(801,769).
catalyst(802,769) :- not remove_reaction(802,769).
catalyst(811,769) :- not remove_reaction(811,769).
catalyst(812,769) :- not remove_reaction(812,769).
catalyst(831,769) :- not remove_reaction(831,769).
catalyst(832,769) :- not remove_reaction(832,769).
catalyst(901,769) :- not remove_reaction(901,769).
catalyst(902,769) :- not remove_reaction(902,769).
catalyst(941,769) :- not remove_reaction(941,769).
catalyst(942,769) :- not remove_reaction(942,769).
catalyst(1210,765).
catalyst(700,763).
catalyst(1200,752).
catalyst(761,745).
...
catalyst(640,622).
catalyst(6560,620).
catalyst(761,619) :- not remove_reaction(761,619).
catalyst(762,619) :- not remove_reaction(762,619).
catalyst(771,619) :- not remove_reaction(771,619).
catalyst(772,619) :- not remove_reaction(772,619).
catalyst(781,619) :- not remove_reaction(781,619).
catalyst(782,619) :- not remove_reaction(782,619).
catalyst(791,619) :- not remove_reaction(791,619).
catalyst(792,619) :- not remove_reaction(792,619).
catalyst(801,619) :- not remove_reaction(801,619).
catalyst(802,619) :- not remove_reaction(802,619).
catalyst(811,619) :- not remove_reaction(811,619).
catalyst(812,619) :- not remove_reaction(812,619).
catalyst(821,619) :- not remove_reaction(821,619).
catalyst(822,619) :- not remove_reaction(822,619).
catalyst(831,619) :- not remove_reaction(831,619).
catalyst(832,619) :- not remove_reaction(832,619).
catalyst(841,619) :- not remove_reaction(841,619).
catalyst(842,619) :- not remove_reaction(842,619).
catalyst(861,619) :- not remove_reaction(861,619).
catalyst(862,619) :- not remove_reaction(862,619).
catalyst(881,619) :- not remove_reaction(881,619).
catalyst(882,619) :- not remove_reaction(882,619).
catalyst(901,619) :- not remove_reaction(901,619).
catalyst(902,619) :- not remove_reaction(902,619).
catalyst(911,619) :- not remove_reaction(911,619).
catalyst(912,619) :- not remove_reaction(912,619).
catalyst(921,619) :- not remove_reaction(921,619).
catalyst(922,619) :- not remove_reaction(922,619).
catalyst(941,619) :- not remove_reaction(941,619).
catalyst(942,619) :- not remove_reaction(942,619).
catalyst(1191,619) :- not remove_reaction(1191,619).
catalyst(1192,619) :- not remove_reaction(1192,619).
catalyst(1021,614).
catalyst(1022,614).
catalyst(6610,587).
catalyst(1210,584).
...
modifiable_enzyme(611).
modifiable_enzyme(612).
modifiable_enzyme(382).
modifiable_enzyme(415).
modifiable_enzyme(282).
modifiable_enzyme(769).
modifiable_enzyme(619).
