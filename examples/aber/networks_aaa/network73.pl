...
component("YNL280C",458).
component("YGR060W",279).
component("YGL012W",261).
component("YOL086C",475).
component("YMR303C",439).
component("YGL256W",273).
component("YDL168W",166).
component("YBR145W",128).
component("YPL231W",520).
component("YBR149W",129).
component("YGL001C",258).
component("YHR063C",305).
component("YBR153W",130).
component("YML056C",418).
component("YLR432W",414).
component("YHR216W",313).
component("YAR075W",104).
component("YAR073W",103).
component("YDR127W",183).
component("YJR139C",356).
component("YKL029C",360).
component("YOR136W",486).
component("YDL066W",157).
component("YLR355C",412).
component("YML086C",420).
component("YIL155C",321).
component("YPR191W",545).
component("YOR065W",481).
component("YJL166W",338).
component("YHR001W-A",301).
component("YGR183C",289).
component("YFR033C",254).
component("YDR529C",215).
component("YBL045C",109).
component("Q0105",18).
component("YGR088W",281).
component("YDR256C",196).
component("YJR078W",348).
component("YJR025C",343).
component("YGR255C",295).
component("YBL098W",112).
component("YMR015C",424).
component("YDR402C",207).
component("YGR175C",287).
component("YJR104C",351).
component("YHR008C",302).
component("YER070W",234).
component("U35_",64).
component("YDL168W",167).
component("YDR158W",190).
component("YPL276W",528).
component("YPL275W",527).
component("YOR388C",508).
component("YGL154C",268).
component("U55_",73).
component("YOR323C",498).
component("YMR170C",432).
component("YMR169C",431).
component("U2_",61).
component("YBR221C",137).
component("U52_",70).
component("YBR166C",133).
component("YNL280C",459).
component("YER014W",224).
component("YMR118C",429).
component("YLR164W",397).
component("YLL041C",383).
component("YKL148C",367).
component("YJL045W",327).
component("YDR178W",191).
component("YJR051W",345).
component("YEL047C",219).
component("YOR375C",506).
component("YDL215C",169).
component("YAL062W",101).
component("U99_",97).
component("YBR035C",119).
component("YKR080W",380).
component("YER023W",225).
component("YOR236W",495).
component("YGR204W",290).
component("U62_",75).
component("YKL150W",368).
component("YIL043C",315).
component("YHR042W",303).
component("YFR030W",253).
component("YPL017C",511).
component("YFL018C",245).
component("YER042W",227).
component("YJR137C",355).
component("YBR034C",118).
component("YPL273W",526).
component("YLL062C",385).
component("U47_",67).
component("YER091C",237).
component("YDL033C",155).
component("YOL096C",476).
component("YDR019C",174).
component("YDR408C",209).
component("YBL013W",105).
component("YKL024C",359).
component("YPR074C",538).
component("YBR117C",127).
component("YLR354C",411).
component("YGR043C",277).
component("YCL009C",146).
component("YMR062C",426).
component("YPL231W",521).
component("U86_",89).
component("YPL001W",510).
component("YOR377W",507).
component("YGR177C",288).
component("YPL231W",522).
component("YGR147C",284).
component("YDL040C",156).
component("YPL028W",512).
component("YPR001W",530).
component("YNR001C",463).
component("YDL182W",168).
component("YNL117W",447).
component("YIR031C",325).
component("YNL029C",442).
component("YIL085C",318).
component("YNL192W",452).
component("YBR038W",120).
component("YBR023C",117).
component("YLR209C",398).
component("YMR300C",438).
component("YER055C",229).
component("YDR354W",203) :- not remove_orf("YDR354W",203).
component("YFR047C",255).
component("YJR133W",354).
component("YLR209C",399).
component("YML022W",415).
component("YDR441C",211).
component("YDR399W",205).
component("YNL256W",454).
component("YDR127W",184).
component("YLR303W",405).
component("YJR130C",353).
component("YLR303W",406).
component("YDR035W",175).
component("YBR249C",138).
component("YOL143C",479).
component("YBR256C",139).
component("YHR137W",308).
component("YGL202W",270).
component("YLR027C",386).
component("YKL106W",363).
component("YKL104C",362).
component("YGR019W",275).
component("YLR089C",389).
component("U64_",76).
component("U51_",69).
component("YJR148W",357).
component("YGL253W",272).
component("YFR053C",256).
component("YMR205C",434).
component("YGR240C",292).
component("YDR248C",195).
component("YCR036W",153).
component("YCL040W",148).
component("YJR105W",352).
component("U16_",36).
component("U15_",33).
component("U96_",95).
component("YKL001C",358).
component("YML070W",419).
component("YFL053W",248).
component("YHL032C",299).
component("U83_",87).
component("U82_",86).
component("YMR208W",435).
component("YOR347C",503).
component("YAL038W",100).
component("YPR121W",540).
component("YPL258C",524).
component("YOL055C",472).
component("U1_",45).
component("YBR020W",115).
component("YNL267W",456).
component("YLR305C",408).
component("YFR019W",251).
component("YDR208W",192).
component("YDR127W",185).
component("U21_",53).
component("U20_",51).
component("YDR147W",188).
component("YDR300C",200).
component("YCR012W",150).
component("U18_",42).
component("U76_",84).
component("YER170W",243).
component("YDR226W",193).
component("YDR454C",212).
component("YOL061W",474).
component("YKL181W",370).
component("YHL011C",297).
component("YER099C",239).
component("YBL068W",111).
component("YOR143C",487).
component("YGR007W",274).
component("YLR328W",409).
component("YJR010W",342).
component("YCL050C",149).
component("YPR190C",544).
component("YPR187W",543).
component("YPR110C",539).
component("YPR010C",532).
component("YOR341W",502).
component("YOR340C",501).
component("YOR224C",494).
component("YOR210W",493).
component("YOR207C",491).
component("YOR151C",488).
component("YOR116C",484).
component("YOL005C",468).
component("YNR003C",464).
component("YNL248C",453).
component("YNL151C",450).
component("YNL113W",446).
component("YKL144C",366).
component("YJR063W",346).
component("YJL148W",336).
component("YJL140W",335).
component("YIL021W",314).
component("YHR143W-A",309).
component("YGL070C",266).
component("YFL036W",247).
component("YDR404C",208).
component("YDR156W",189).
component("YDR045C",176).
component("YDL150W",164).
component("YDL140C",162).
component("YBR154C",132).
component("YPR175W",542).
component("YPL167C",517).
component("YOR330C",499).
component("YOL115W",478).
component("YNL299W",461).
component("YNL262W",455).
component("YNL102W",445).
component("YJR043C",344).
component("YJR006W",341).
component("YJL090C",330).
component("YIL139C",320).
component("YEL055C",220).
component("YDR419W",210).
component("YDR121W",182).
component("YDL102W",160).
component("YCR014C",151).
component("YBR278W",141).
component("YBL035C",107).
component("YKL035W",361).
component("YHL012W",298).
component("YER026C",226).
component("YCL004W",145).
component("YDR058C",179).
component("YDL086W",159).
component("YOL011W",469).
component("YMR008C",423).
component("YMR006C",422).
component("U101_",19).
component("YBL015W",106).
component("YJL068C",328).
component("YPL072W",514).
component("YOR124C",485).
component("YNL186W",451).
component("YMR304W",440).
component("YMR223W",436).
component("YKR098C",381).
component("YJL197W",339).
component("YIL156W",322).
component("YFR010W",250).
component("YER151C",241).
component("YER144C",240).
component("YER098W",238).
component("YDR069C",180).
component("YDL122W",161).
component("YBR058C",121).
component("YBL067C",110).
component("U84_",88).
component("YPR073C",536).
component("YHR215W",312).
component("YDL024C",154).
component("YBR093C",125).
component("YBR092C",124).
component("YAR071W",102).
component("YIL053W",317).
component("YER062C",233).
component("YHR046C",304).
component("YGR208W",291).
component("YPL228W",519).
component("YMR180C",433).
component("YDL236W",171).
component("YJL155C",337).
component("YPR073C",537).
component("YOR208W",492).
component("YNL053W",444).
component("YMR036C",425).
component("YIR026C",323).
component("YIL113W",319).
component("YFR028C",252).
component("YER075C",235).
...
component("U25_",60).
component("U24_",59).
component("YOR360C",505).
component("YGL248W",271).
component("YKR031C",377).
component("YLR286C",403).
component("YOR190W",489).
component("YLR300W",404).
component("YGR282C",296).
component("YDR261C",197).
component("YDR400W",206).
component("U23_",58).
component("YML035C",416).
component("YJL070C",329).
component("YBR284W",142).
component("U102_",20).
component("YNL045W",443).
component("YLR160C",396).
component("YLR158C",395).
component("YLR157C",394).
component("YLR155C",393).
component("YDR321W",201).
component("YGL037C",263).
component("YDR242W",194).
component("YBR208C",134).
component("U53_",71).
component("YIR032C",326).
component("YIR029W",324).
component("YMR120C",430).
component("YHR144C",310).
component("YBR153W",131).
component("YDL238C",172).
component("YNL141W",448).
component("YLR245C",402).
component("YML035C",417).
component("YJL126W",332).
component("U87_",90).
component("YBR111C",126).
component("YER005W",223).
component("YIL048W",316).
component("YER166W",242).
component("YDR093W",181).
component("YAL026C",99).
component("YLR231C",400).
component("U88_",91).
component("YLR134W",391).
component("YLR044C",387).
component("YGR087C",280).
component("YDR380W",204).
component("YDL080C",158).
component("U98_",96).
component("YKL184W",373).
component("YNR043W",467).
component("U93_",94).
component("U54_",72).
component("YKL211C",374) :- not remove_orf("YKL211C",374).
component("YGR170W",286).
component("YDR294C",198).
component("YEL046C",218).
component("YNR033W",466).
component("YKL211C",375) :- not remove_orf("YKL211C",375).
component("YER090W",375) :- not remove_orf("YER090W",375).
component("YER090W",236) :- not remove_orf("YER090W",236).
component("YDR127W",186).
component("YPL281C",529).
component("YOR393W",509).
component("YMR323W",441).
component("YHR174W",311).
component("YGR254W",294).
component("YGL026C",262) :- not remove_orf("YGL026C",262).
component("YGR155W",285).
component("YLR304C",407).
component("YJL200C",340).
component("YNL316C",462).
component("YKL182W",371).
component("YPL212C",518).
component("YNL292W",460).
component("YGL063W",265).
component("YFL001W",244).
component("YPR002W",531).
component("YDR127W",187).
component("YGL148W",267).
component("YAL012W",98).
component("YFR055W",257).
component("YBR019C",113).
component("YBR019C",114).
component("YDR050C",178).
component("YDR007W",173) :- not remove_orf("YDR007W",173).
component("YOR095C",483).
component("YER003C",222).
component("YGL001C",259).
component("YKL152C",369).
component("YMR105C",427).
component("YKL127W",364).
component("YEL058W",221).
component("YPR060C",535).
component("YPL104W",515).
component("YLL018C",382).
component("YOL033W",471).
component("YHR091C",307).
component("YDR341C",202).
component("YOL097C",477).
component("YPR047W",534).
component("YLR060W",388).
component("YFL022C",246).
component("YPR033C",533).
component("YPL160W",516).
component("YLR382C",413).
component("YOR335C",500).
component("YGR094W",282).
component("YGR244C",293).
component("U89_",92).
component("YOR241W",496).
component("YMR113W",428).
component("YKL132C",365).
component("YJL101C",331).
component("U91_",93).
component("YDL141W",163).
component("YJR103W",350).
component("YBL039C",108).
component("YOL058W",473).
component("YBR208C",135).
component("YHR074W",306).
component("YOR303W",497).
component("YGL062W",264).
component("YBR218C",136).
component("YPL231W",523).
component("YNR016C",465).
component("YKL182W",372).
component("YGR037C",276).
component("YOR005C",480).
component("YDL164C",165).
component("YPR138C",541).
component("YPL265W",525).
component("YPL036W",513).
component("YOR348C",504).
component("YOR192C",490).
component("YOR071C",482).
component("YOL020W",470) :- not remove_orf("YOL020W",470).
component("YNL268W",457).
component("YNL142W",449).
component("YMR272C",437).
component("YML123C",421).
component("YLR348C",410).
component("YLR237W",401).
component("YLR138W",392).
component("YLR100C",390).
component("YLL061W",384).
component("YKR053C",379).
component("YKR039W",378) :- not remove_orf("YKR039W",378).
component("YKL217W",376).
component("YJR095W",349).
component("YJR077C",347).
component("YJL134W",334).
component("YJL129C",333).
component("YHL036W",300).
component("YGR121C",283).
component("YGR055W",278).
component("YGL186C",269).
component("YGL008C",260).
component("YFL055W",249).
component("YER060W-A",232).
component("YER060W",231).
component("YER056C",230).
component("YER053C",228).
component("YEL017C-A",217).
component("YDR536W",216).
component("YDR508C",214).
component("YDR503C",213).
...
catalyst(6160,438).
catalyst(3870,229).
catalyst(3620,203) :- not remove_reaction(3620,203).
catalyst(2190,255).
catalyst(5550,354).
catalyst(5791,399).
catalyst(5792,399).
...
catalyst(2300,94).
catalyst(3460,72).
catalyst(3600,374) :- not remove_reaction(3600,374).
catalyst(6900,286).
catalyst(8781,198).
catalyst(8782,198).
catalyst(4560,218).
...
catalyst(3630,236) :- not remove_reaction(3630,236).
catalyst(3740,186).
catalyst(8231,529).
catalyst(8232,529).
catalyst(8231,509).
...
catalyst(8231,294).
catalyst(8232,294).
catalyst(3590,262) :- not remove_reaction(3590,262).
catalyst(10910,262) :- not remove_reaction(10910,262).
catalyst(4570,285).
catalyst(8181,407).
catalyst(8182,407).
catalyst(8181,340).
...
catalyst(190,490).
catalyst(190,482).
catalyst(801,470) :- not remove_reaction(801,470).
catalyst(802,470) :- not remove_reaction(802,470).
catalyst(811,470) :- not remove_reaction(811,470).
catalyst(812,470) :- not remove_reaction(812,470).
catalyst(831,470) :- not remove_reaction(831,470).
catalyst(832,470) :- not remove_reaction(832,470).
catalyst(941,470) :- not remove_reaction(941,470).
catalyst(942,470) :- not remove_reaction(942,470).
catalyst(761,457).
catalyst(762,457).
catalyst(371,449).
catalyst(372,449).
...
catalyst(750,384).
catalyst(6560,379).
catalyst(761,378) :- not remove_reaction(761,378).
catalyst(762,378) :- not remove_reaction(762,378).
catalyst(771,378) :- not remove_reaction(771,378).
catalyst(772,378) :- not remove_reaction(772,378).
catalyst(781,378) :- not remove_reaction(781,378).
catalyst(782,378) :- not remove_reaction(782,378).
catalyst(791,378) :- not remove_reaction(791,378).
catalyst(792,378) :- not remove_reaction(792,378).
...
catalyst(841,378) :- not remove_reaction(841,378).
catalyst(842,378) :- not remove_reaction(842,378).
catalyst(861,378) :- not remove_reaction(861,378).
catalyst(862,378) :- not remove_reaction(862,378).
catalyst(881,378) :- not remove_reaction(881,378).
catalyst(882,378) :- not remove_reaction(882,378).
catalyst(941,378) :- not remove_reaction(941,378).
catalyst(942,378) :- not remove_reaction(942,378).
catalyst(1191,378) :- not remove_reaction(1191,378).
catalyst(1192,378) :- not remove_reaction(1192,378).
catalyst(1021,376).
catalyst(1022,376).
catalyst(1250,349).
catalyst(1581,347).
