...
component("YNL280C",729).
component("YLR056W",615).
component("YGR060W",428).
component("YGL012W",396).
component("YKR009C",598).
component("YOL086C",760).
component("YMR303C",698).
component("YMR083W",673).
component("YGL256W",420).
component("YDL168W",258).
component("YBR145W",195).
component("YPL231W",832).
component("U46_",108).
component("YBR149W",196).
component("YJR159W",567).
component("YGL001C",393).
component("YIL094C",503).
component("YHR063C",476).
component("YBR153W",197).
component("YML056C",658).
component("YLR432W",651).
component("YHR216W",493).
component("YAR075W",157).
component("YAR073W",156).
component("YCL030C",221).
component("YDR127W",288).
component("YJR139C",561).
component("YOL126C",765).
component("YKL085W",577).
component("YDL078C",239).
component("YKL029C",572).
component("YOR136W",777).
component("YNL037C",703).
component("YDL066W",238).
component("YNL241C",719).
component("YOL059W",758).
component("YDL022W",233).
component("YLR355C",647).
component("YIL074C",501).
component("YER081W",363).
component("YML054C",657).
component("YDL174C",260).
component("YML086C",661).
component("YIL155C",509).
component("YPR191W",867).
component("YOR065W",771).
component("YJL166W",537).
component("YHR001W-A",465).
component("YGR183C",443).
component("YFR033C",389).
component("YDR529C",334).
component("YBL045C",163).
component("Q0105",18).
component("YGR088W",431).
component("YDR256C",303).
component("YKL026C",571).
component("YIR037W",518).
component("YBR244W",209).
component("YJR078W",552).
component("YJR025C",545).
component("YGR255C",455).
component("U108_",22).
component("YBL098W",167).
component("YMR015C",670).
component("YHR007C",466).
component("YDR402C",323).
component("YGL055W",403).
component("YGR175C",440).
component("YJR104C",555).
component("YHR008C",467).
component("YJL026W",520).
component("YIL066C",500).
component("YGR180C",442).
component("YER070W",360).
component("U38_",103).
component("U36_",102).
component("U35_",101).
component("YDL168W",259).
component("YDR158W",296).
component("YBR006W",170).
component("YPL276W",844).
component("YPL275W",843).
component("YOR388C",810).
component("YOR374W",807).
component("YER073W",361).
component("U68_",123).
component("YGL154C",411).
component("U55_",117).
component("YOR323C",799).
component("YMR170C",682).
component("YMR169C",681).
component("U2_",97).
component("YER178W",376).
component("YBR221C",207).
component("YIL125W",507).
component("U52_",114).
component("YBR166C",200).
component("YNL280C",730).
component("YGL012W",397).
component("U57_",118).
component("YKL216W",595).
component("YDR044W",276).
component("YER014W",346).
component("YKR009C",599).
component("YIL160C",511).
component("YGL205W",414).
component("YMR118C",678).
component("YLR164W",628).
component("YLL041C",608).
component("YKL148C",584).
component("YKL141W",582).
component("YJL045W",521).
component("YDR178W",297).
component("YJR051W",547).
component("YEL047C",340).
component("YDL215C",264).
component("YOR375C",808).
component("YDL215C",265).
component("YAL062W",154).
component("U99_",148).
component("YBR035C",180).
component("YMR189W",684).
component("YHR037W",473).
component("YKR080W",603).
component("YER023W",348).
component("YPL023C",814).
component("YGL125W",408).
component("YOR236W",792).
component("YGR204W",447).
component("YLR142W",623).
component("U62_",121).
component("YKL150W",585).
component("YIL043C",497).
component("YHR042W",474).
component("YOR221C",790).
component("YML120C",664).
component("YKL192C",592).
component("YKL055C",574).
component("YER061C",356).
component("YGR234W",450).
component("YFR030W",388).
component("YPL017C",813).
component("YFL018C",380).
component("YDR353W",318).
component("YER042W",350).
component("YJR137C",560).
component("YPL266W",839).
component("YML110C",663).
component("YBR034C",179).
component("YPL273W",841).
component("YLL062C",611).
component("YDR410C",326).
component("U47_",109).
component("YER091C",368).
component("YJR073C",550).
component("YDR120C",286).
component("YDL033C",235).
component("YOL096C",761).
component("YLR172C",629).
component("YDR019C",272).
component("YBR176W",201).
component("YDR408C",325).
component("YMR120C",679).
component("YBL013W",158).
component("YKL024C",570).
component("YPR074C",856).
component("YBR117C",191).
component("YLR354C",646).
component("YGR043C",426).
component("YMR108W",676).
component("YCL009C",219).
component("YMR062C",672).
component("YNL071W",706).
component("YNR008W",737).
component("YIL160C",512).
component("YNL277W",728).
component("YFL017C",379).
component("YPL231W",833).
component("YER061C",357).
component("U86_",138).
component("YPL001W",812).
component("YDR148C",294).
component("YOR377W",809).
component("YGR177C",441).
component("YPL231W",834).
component("YGR147C",436).
component("YDL040C",236).
component("YPL028W",815).
component("YGL017W",398).
component("YPR001W",846).
component("YNR001C",735).
component("YDL182W",261).
component("YDL131W",249).
component("YNL117W",710).
component("YIR031C",516).
component("YOR321W",798).
component("YJR143C",562).
component("YGR199W",446).
component("YDR307W",312).
component("YDL095W",244).
component("YDL093W",243).
component("YAL023C",151).
component("YNL029C",702).
component("YIL085C",502).
component("YMR261C",692).
component("YML100W",662).
component("YBR126C",194).
component("YNL192W",718).
component("YBR038W",182).
component("YBR023C",178).
component("YMR306W",700).
component("YLR342W",644).
component("YGR032W",424).
component("YLR209C",630).
component("U104_",21).
component("YOR209C",788).
component("YMR300C",697).
component("YER055C",352).
component("YDR354W",319) :- not remove_orf("YDR354W",319).
component("YFR047C",390).
component("YJR133W",559).
component("YLR209C",631).
component("YML022W",654).
component("YDR441C",329).
component("YDR399W",321).
component("YPR176C",864).
component("YPL172C",825).
component("YNR041C",743).
component("YMR101C",674).
component("YDL090C",242).
component("YBR003W",169).
component("YBR002C",168).
component("YJL167W",538).
component("YNL256W",722).
component("YDR127W",289).
component("YLR303W",638).
component("YGR012W",422).
component("YJR130C",558).
component("YLR303W",639).
component("YDR035W",274).
component("YBR249C",210).
component("YOR274W",794).
component("YOL143C",767).
component("YBR256C",212).
component("YHR137W",485).
component("YGL202W",413).
component("YLR027C",612).
component("YKL106W",579).
component("YKL104C",578).
component("YGR019W",423).
component("YLR089C",618).
component("U64_",122).
component("U61_",120).
component("U51_",113).
component("YJR148W",563).
component("YHR208W",491).
component("YOR184W",783).
component("YNR058W",746).
component("YIL116W",506).
component("YGL253W",419).
component("YFR053C",391).
component("YOL136C",766).
component("YIL107C",504).
component("YMR013C",669).
component("YMR205C",685).
component("YGR240C",451).
component("YDR248C",302).
component("YCR036W",229).
component("YGR194C",445).
component("YCL040W",223).
component("YJR105W",556).
component("U16_",52).
component("U15_",46).
component("U96_",146).
component("YKL001C",568).
component("YDR236C",300).
component("YML070W",660).
component("YFL053W",383).
component("YHL032C",463).
component("YLR133W",620).
component("YDR531W",336).
component("U83_",136).
component("U82_",135).
component("U81_",134).
component("YMR208W",686).
component("YPL203W",827).
component("YOR061W",770).
component("YKL166C",587).
component("YJL164C",536).
component("YIL035C",496).
component("YHR205W",490).
component("YHR102W",483).
component("YGL019W",399).
component("YHR025W",472).
component("YOR347C",804).
component("YAL038W",153).
component("YNR012W",738).
component("YPR121W",860).
component("YPL258C",836).
component("YOL055C",754).
component("YPL214C",830).
component("U1_",75).
component("YDR009W",271).
component("YBR020W",176).
component("YNL267W",726).
component("YLR305C",641).
component("YFR019W",386).
component("YDR208W",298).
component("YDR127W",290).
component("U21_",85).
component("U20_",82).
component("YDR147W",293).
component("YDR300C",311).
component("YCR012W",225).
component("U18_",67).
component("U17_",60).
component("U76_",131).
component("YMR220W",688).
component("YER170W",375).
component("YDR226W",299).
component("YKL067W",576).
component("YOL055C",755).
component("YDR454C",330).
component("YJR057W",548).
component("YOL061W",759).
component("YKL181W",588).
component("YHL011C",460).
component("YER099C",370).
component("YBL068W",166).
component("YOR143C",779).
component("YNL256W",723).
component("YLR328W",642).
component("YBR018C",172).
component("YBR018C",173).
component("YGR007W",421).
component("YLR328W",643).
component("YKR002W",597).
component("YDL103C",247).
component("YJR010W",544).
component("YGL130W",409).
component("YDR530C",335).
component("YCL050C",224).
component("YPR190C",866).
component("YPR187W",865).
component("YPR110C",858).
component("YPR010C",849).
component("YOR341W",803).
component("YOR340C",802).
component("YOR224C",791).
component("YOR210W",789).
component("YOR207C",786).
component("YOR151C",780).
component("YOR116C",774).
component("YOL005C",748).
component("YNR003C",736).
component("YNL248C",721).
component("YNL151C",715).
component("YNL113W",709).
component("YKL144C",583).
component("YJR063W",549).
component("YJL148W",533).
component("YJL140W",532).
component("YIL021W",495).
component("YHR143W-A",486).
component("YGL070C",406).
component("YFL036W",382).
component("YDR404C",324).
component("YDR156W",295).
component("YDR045C",277).
component("YDL150W",256).
component("YDL140C",251).
component("YBR154C",199).
component("YPR175W",863).
component("YPL167C",824).
component("YOR330C",800).
component("YOL115W",764).
component("YNL299W",732).
component("YNL262W",725).
component("YNL102W",708).
component("YJR043C",546).
component("YJR006W",543).
component("YJL090C",525).
component("YIL139C",508).
component("YEL055C",341).
component("YDR419W",327).
component("YDR121W",287).
component("YDL102W",246).
component("YCR014C",226).
component("YBR278W",214).
component("YBL035C",160).
component("YKL035W",573).
component("YHL012W",461).
component("YHR123W",484).
component("YPR113W",859).
component("YBR243C",208).
component("YNL130C",711).
component("YDL142C",255).
component("YPL148C",822).
component("YER026C",349).
component("YCL004W",218).
component("YGR286C",459).
component("YJL068C",522).
component("YDR058C",281).
component("YNR034W",742).
component("YHR163W",488).
component("YGR248W",453).
component("YCR073W-A",230).
component("YDL086W",241).
component("YOL011W",750).
component("YMR008C",667).
component("YMR006C",666).
component("U101_",19).
component("YBL015W",159).
component("YJL068C",523).
component("YPL072W",818).
component("YOR124C",775).
component("YNL186W",717).
component("YMR304W",699).
component("YMR223W",689).
component("YKR098C",606).
component("YJL197W",539).
component("YIL156W",510).
component("YFR010W",385).
component("YER151C",373).
component("YER144C",372).
component("YER098W",369).
component("YDR069C",282).
component("YDL122W",248).
component("YBR058C",183).
component("YBL067C",165).
component("YDR272W",306).
component("U84_",137).
component("YLR377C",649).
component("YDR074W",283).
component("YPL179W",826).
component("YNR032W",740).
component("YML057W",659).
component("YML016C",653).
component("YLR433C",652).
component("YGR123C",434).
component("YER133W",371).
component("YER089C",366).
component("YDR436W",328).
component("YDR075W",284).
component("YDL188C",262).
component("YDL134C",250).
component("YDL047W",237).
component("YDL006W",231).
component("YBR125C",193).
component("YBL056W",164).
component("YPR073C",854).
component("YHR215W",492).
component("YDL024C",234).
component("YBR093C",189).
component("YBR092C",188).
component("YAR071W",155).
component("YIL053W",499).
component("YER062C",358).
component("YHR046C",475).
component("U9_",149).
component("YGR208W",449).
component("YPL228W",831).
component("YMR180C",683).
component("YDL236W",267).
component("YJL155C",535).
component("YPR073C",855).
component("YOR208W",787).
component("YNL053W",705).
component("YMR036C",671).
component("YIR026C",513).
component("YIL113W",505).
component("YFR028C",387).
component("YER075C",362).
component("YDL230W",266).
component("YBR276C",213).
component("U34_",100).
component("U33_",99).
component("U30_",98).
component("U28_",96).
...
component("U25_",94).
component("U24_",93).
component("YPL268W",840).
component("YOR360C",806).
component("YGL248W",418).
component("YKR031C",600).
component("YPL206C",828).
component("YGL027C",401).
component("YLR286C",636).
component("YJR153W",565).
component("YBR184W",202).
component("YOR190W",784).
component("YLR300W",637).
component("YGR282C",458).
component("YDR261C",304).
component("YDR400W",322).
component("U23_",92).
component("YML035C",655).
component("YJL070C",524).
component("YBR284W",215).
component("U102_",20).
component("YNL045W",704).
component("YLR160C",627).
component("YLR158C",626).
component("YLR157C",625).
component("YLR155C",624).
component("YDR321W",313).
component("YGL037C",402).
component("YMR293C",696).
component("YDR242W",301).
component("YBR208C",204).
component("YMR281W",695).
component("U53_",115).
component("YIR027C",514).
component("YPL111W",821).
component("YIR032C",517).
component("YIR029W",515).
component("YPR062W",853).
component("YMR120C",680).
component("YLR028C",613).
component("YHR144C",487).
component("YGR267C",457).
component("YNL141W",712).
component("YBR153W",198).
component("YDL238C",268).
component("YNL141W",713).
component("YLR245C",634).
component("YML035C",656).
component("YBR084W",186).
component("YJL126W",528).
component("U44_",107).
component("YDL100C",245).
component("U87_",139).
component("U40_",105).
component("YMR267W",693).
component("YBR011C",171).
component("YBR111C",190).
component("YBR252W",211).
component("YCL030C",222).
component("YER005W",345).
component("YIL048W",498).
component("YER166W",374).
component("YDR093W",285).
component("YAL026C",152).
component("YLR231C",632).
component("U88_",140).
component("YLR134W",621).
component("YLR044C",614).
component("YGR087C",430).
component("YDR380W",320).
component("YDL080C",240).
component("U98_",147).
component("YMR250W",691).
component("YKL184W",591).
component("YNR043W",744).
component("U93_",145).
component("YDR047W",279).
component("U54_",116).
component("YKL211C",593) :- not remove_orf("YKL211C",593).
component("YKR097W",605).
component("YOL052C",753).
component("YNL169C",716).
component("YGR170W",438).
component("YKL060C",575).
component("YNL256W",724).
component("YDR294C",308).
component("YEL046C",339).
component("YNR033W",741).
component("YPR006C",848).
component("YER065C",359).
component("YKL211C",594) :- not remove_orf("YKL211C",594).
component("YER090W",594) :- not remove_orf("YER090W",594).
component("YER090W",367) :- not remove_orf("YER090W",367).
component("YDR127W",291).
component("YPL281C",845).
component("YOR393W",811).
component("YMR323W",701).
component("YHR174W",489).
component("YGR254W",454).
component("YPL262W",837).
component("YGL026C",400) :- not remove_orf("YGL026C",400).
component("YGR155W",437).
component("YLR304C",640).
component("YJL200C",540).
component("YNL316C",733).
component("YKL182W",589).
component("YPL212C",829).
component("YNL292W",731).
component("YGL063W",405).
component("YFL001W",377).
component("YOR278W",795).
component("YPR002W",847).
component("U49_",110).
component("YDR127W",292).
component("YGL148W",410).
component("YER086W",364).
component("YLR359W",648).
component("YAL012W",150).
component("YFR055W",392).
component("YJL005W",519).
component("YOR176W",782).
component("YJL121C",527).
component("YBR019C",174).
component("YBR019C",175).
component("YDR050C",280).
component("YDR007W",270) :- not remove_orf("YDR007W",270).
component("YOR095C",773).
component("YER003C",344).
component("YBR196C",203).
component("YGL001C",394).
component("U14_",39).
component("YOL056W",756).
component("YKL152C",586).
component("YDL021W",232).
component("YMR105C",675).
component("YKL127W",580).
component("YEL058W",342).
component("YPR060C",852).
component("YHR072W",477).
component("YJL153C",534).
component("YPL097W",819).
component("YGR185C",444).
component("YGR264C",456).
component("YGR171C",439).
component("YHR011W",468).
component("YDR023W",273).
component("YPL104W",820).
component("YLL018C",607).
component("YPR081C",857).
component("YBR121C",192).
component("YHR020W",471).
component("YER087W",365).
component("YNL247W",720).
component("YOL033W",752).
component("YGL245W",417).
component("YHR091C",479).
component("YDR341C",314).
component("YOL097C",762).
component("YDR268W",305).
component("YPR047W",851).
component("YLR060W",616).
component("YFL022C",381).
component("YPR033C",850).
component("YHR019C",469).
component("YHR019C",470).
component("YPL160W",823).
component("YLR382C",650).
component("YNL073W",707).
component("YDR037W",275).
component("YOR335C",801).
component("YGR094W",432).
component("YOR317W",797).
component("YMR246W",690).
component("YIL009W",494).
component("YER015W",347).
component("YOR142W",778).
component("YGR244C",452).
component("U89_",141).
component("YOR241W",793).
component("YMR113W",677).
component("YKL132C",581).
component("YJL101C",526).
component("U92_",144).
component("YGL234W",415).
component("U91_",143).
component("U90_",142).
component("YDL141W",252).
component("YDL141W",253).
component("YGL234W",416).
component("YDL141W",254).
component("YJR103W",554).
component("YBL039C",161).
component("YGR204W",448).
component("YBR084W",187).
component("YOL058W",757).
component("YBR208C",205).
component("YHR074W",478).
component("YMR217W",687).
component("YGR061C",429).
component("YPR145W",862).
component("YGR124W",435).
component("YOR303W",796).
component("YJR109C",557).
component("YJL130C",530).
component("YGL062W",404).
component("YBR218C",206).
component("YPL231W",835).
component("YNR016C",739).
component("YKL182W",590).
component("YGR037C",425).
component("YOR005C",769).
component("YDL164C",257).
component("YOL010W",749).
component("YPR138C",861).
component("YPL274W",842).
component("YPL265W",838).
component("YPL057C",817).
component("YPL036W",816).
component("YOR348C",805).
component("YOR192C",785).
component("YOR171C",781).
component("YOR130C",776).
component("YOR071C",772).
component("YOL156W",768).
component("YOL103W",763).
component("YOL020W",751) :- not remove_orf("YOL020W",751).
component("YNR072W",747).
component("YNR056C",745).
component("YNL318C",734).
component("YNL268W",727).
component("YNL142W",714).
component("YMR272C",694).
component("YMR011W",668).
component("YML123C",665).
component("YLR348C",645).
component("YLR260W",635).
component("YLR237W",633).
component("YLR138W",622).
component("YLR100C",619).
component("YLR081W",617).
component("YLL061W",610).
component("YLL043W",609).
component("YKR093W",604).
component("YKR053C",602).
component("YKR039W",601) :- not remove_orf("YKR039W",601).
component("YKL217W",596).
component("YKL004W",569).
component("YJR158W",566).
component("YJR152W",564).
component("YJR095W",553).
component("YJR077C",551).
component("YJL219W",542).
component("YJL214W",541).
component("YJL134W",531).
component("YJL129C",529).
component("YHR096C",482).
component("YHR094C",481).
component("YHR092C",480).
component("YHL036W",464).
component("YHL016C",462).
component("YGR121C",433).
component("YGR055W",427).
component("YGL186C",412).
component("YGL077C",407).
component("YGL008C",395).
component("YFL055W",384).
component("YFL011W",378).
component("YER060W-A",355).
component("YER060W",354).
component("YER056C",353).
component("YER053C",351).
component("YEL069C",343).
component("YEL017C-A",338).
component("YDR536W",337).
component("YDR508C",333).
component("YDR503C",332).
component("YDR497C",331).
component("YDR345C",317).
component("YDR343C",316).
component("YDR342C",315).
component("YDR297W",310).
component("YDR294C",309).
component("YDR284C",307).
component("YDR046C",278) :- not remove_orf("YDR046C",278).
component("YDL245C",269).
component("YDL210W",263).
component("YCR032W",228).
component("YCR024C-A",227).
component("YCL025C",220).
component("YBR298C",217).
component("YBR291C",216).
component("YBR069C",185) :- not remove_orf("YBR069C",185).
component("YBR068C",184) :- not remove_orf("YBR068C",184).
component("YBR036C",181).
component("YBR021W",177).
component("YBL042C",162).
component("U79_",133).
component("U78_",132).
component("U75_",130).
component("U74_",129).
...
catalyst(6160,697).
catalyst(3870,352).
catalyst(3620,319) :- not remove_reaction(3620,319).
catalyst(2110,390).
catalyst(2190,390).
catalyst(5550,559).
catalyst(5791,631).
...
catalyst(1960,279).
catalyst(3460,116).
catalyst(3600,593) :- not remove_reaction(3600,593).
catalyst(8000,605).
catalyst(3941,753).
catalyst(3942,753).
catalyst(6890,716).
...
catalyst(8020,848).
catalyst(8020,359).
catalyst(1890,594) :- not remove_reaction(1890,594).
catalyst(3630,594) :- not remove_reaction(3630,594).
catalyst(1890,367) :- not remove_reaction(1890,367).
catalyst(3630,367) :- not remove_reaction(3630,367).
catalyst(3740,291).
catalyst(8231,845).
catalyst(8232,845).
catalyst(8231,811).
...
catalyst(8051,837).
catalyst(8052,837).
catalyst(3590,400) :- not remove_reaction(3590,400).
catalyst(10910,400) :- not remove_reaction(10910,400).
catalyst(4570,437).
catalyst(8181,640).
catalyst(8182,640).
catalyst(8181,540).
...
catalyst(8281,280).
catalyst(8282,280).
catalyst(3610,270) :- not remove_reaction(3610,270).
catalyst(7921,773).
catalyst(7922,773).
catalyst(7841,344).
catalyst(7842,344).
...
catalyst(1210,768).
catalyst(1160,763).
catalyst(801,751) :- not remove_reaction(801,751).
catalyst(802,751) :- not remove_reaction(802,751).
catalyst(811,751) :- not remove_reaction(811,751).
catalyst(812,751) :- not remove_reaction(812,751).
catalyst(831,751) :- not remove_reaction(831,751).
catalyst(832,751) :- not remove_reaction(832,751).
catalyst(901,751) :- not remove_reaction(901,751).
catalyst(902,751) :- not remove_reaction(902,751).
catalyst(941,751) :- not remove_reaction(941,751).
catalyst(942,751) :- not remove_reaction(942,751).
catalyst(1210,747).
catalyst(700,745).
catalyst(1200,734).
catalyst(761,727).
...
catalyst(640,604).
catalyst(6560,602).
catalyst(761,601) :- not remove_reaction(761,601).
catalyst(762,601) :- not remove_reaction(762,601).
catalyst(771,601) :- not remove_reaction(771,601).
catalyst(772,601) :- not remove_reaction(772,601).
catalyst(781,601) :- not remove_reaction(781,601).
catalyst(782,601) :- not remove_reaction(782,601).
catalyst(791,601) :- not remove_reaction(791,601).
catalyst(792,601) :- not remove_reaction(792,601).
catalyst(801,601) :- not remove_reaction(801,601).
catalyst(802,601) :- not remove_reaction(802,601).
catalyst(811,601) :- not remove_reaction(811,601).
catalyst(812,601) :- not remove_reaction(812,601).
catalyst(821,601) :- not remove_reaction(821,601).
catalyst(822,601) :- not remove_reaction(822,601).
catalyst(831,601) :- not remove_reaction(831,601).
catalyst(832,601) :- not remove_reaction(832,601).
catalyst(841,601) :- not remove_reaction(841,601).
catalyst(842,601) :- not remove_reaction(842,601).
catalyst(861,601) :- not remove_reaction(861,601).
catalyst(862,601) :- not remove_reaction(862,601).
catalyst(881,601) :- not remove_reaction(881,601).
catalyst(882,601) :- not remove_reaction(882,601).
catalyst(901,601) :- not remove_reaction(901,601).
catalyst(902,601) :- not remove_reaction(902,601).
catalyst(911,601) :- not remove_reaction(911,601).
catalyst(912,601) :- not remove_reaction(912,601).
catalyst(941,601) :- not remove_reaction(941,601).
catalyst(942,601) :- not remove_reaction(942,601).
catalyst(1191,601) :- not remove_reaction(1191,601).
catalyst(1192,601) :- not remove_reaction(1192,601).
catalyst(1021,596).
catalyst(1022,596).
catalyst(6610,569).
catalyst(1210,566).
...
catalyst(6550,309).
catalyst(6690,307).
catalyst(791,278) :- not remove_reaction(791,278).
catalyst(792,278) :- not remove_reaction(792,278).
catalyst(801,278) :- not remove_reaction(801,278).
catalyst(802,278) :- not remove_reaction(802,278).
catalyst(811,278) :- not remove_reaction(811,278).
catalyst(812,278) :- not remove_reaction(812,278).
catalyst(831,278) :- not remove_reaction(831,278).
catalyst(832,278) :- not remove_reaction(832,278).
catalyst(841,278) :- not remove_reaction(841,278).
catalyst(842,278) :- not remove_reaction(842,278).
catalyst(861,278) :- not remove_reaction(861,278).
catalyst(862,278) :- not remove_reaction(862,278).
catalyst(901,278) :- not remove_reaction(901,278).
catalyst(902,278) :- not remove_reaction(902,278).
catalyst(1210,269).
catalyst(690,263).
catalyst(730,263).
catalyst(431,228).
...
catalyst(1511,216).
catalyst(1512,216).
catalyst(771,185) :- not remove_reaction(771,185).
catalyst(772,185) :- not remove_reaction(772,185).
...
catalyst(791,184) :- not remove_reaction(791,184).
catalyst(792,184) :- not remove_reaction(792,184).
...
catalyst(861,184) :- not remove_reaction(861,184).
catalyst(862,184) :- not remove_reaction(862,184).
...
modifiable_enzyme(593).
modifiable_enzyme(594).
modifiable_enzyme(367).
modifiable_enzyme(400).
modifiable_enzyme(270).
modifiable_enzyme(751).
modifiable_enzyme(601).
modifiable_enzyme(278).
