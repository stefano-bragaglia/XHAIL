...
component("YGL012W",110).
component("YOL086C",200).
component("YMR303C",184).
component("YGL256W",117).
component("YDL168W",68).
component("YBR145W",52).
component("YGL001C",108).
component("YML056C",176).
component("YLR432W",174).
component("YHR216W",132).
component("YAR075W",41).
component("YAR073W",40).
component("YDR127W",77).
component("YJR139C",153).
component("YOR136W",204).
component("YIL155C",135).
component("YJR078W",147).
component("YJR025C",144).
component("YMR015C",178).
component("YDR402C",89).
component("YJR104C",150).
component("YHR008C",127).
component("YER070W",98).
component("YGL154C",115).
component("YMR170C",180).
component("YMR169C",179).
component("YBR166C",54).
component("YER014W",97).
component("YEL047C",96).
component("YOR375C",213).
component("YDL215C",69).
component("YAL062W",39).
component("U62_",33).
component("YPL017C",216).
component("YFL018C",101).
component("U47_",30).
component("YKL024C",155).
component("YPR074C",228).
component("YBR117C",51).
component("YPL231W",220).
component("YPL001W",215).
component("YPL231W",221).
component("YPL028W",217).
component("YNL029C",186).
component("YIL085C",134).
component("YLR209C",169).
component("YDR354W",86) :- not remove_orf("YDR354W",86).
component("YFR047C",106).
component("YJR133W",152).
component("YDR399W",87).
component("YDR127W",78).
component("YJR130C",151).
component("YDR035W",73).
component("YBR249C",57).
component("YBR256C",58).
component("YHR137W",128).
component("YLR027C",166).
component("YKL106W",156).
component("U64_",34).
component("YGL253W",116).
component("YFR053C",107).
component("YMR205C",182).
component("YGR240C",124).
component("YCR036W",64).
component("U15_",20).
component("YKL001C",154).
component("YML070W",177).
component("YFL053W",103).
component("U83_",37).
component("YMR208W",183).
component("U1_",24).
component("YNL267W",192).
component("YLR305C",173).
component("YFR019W",105).
component("YDR208W",83).
component("YDR127W",79).
component("U20_",27).
component("YDR300C",85).
component("U76_",36).
component("YDR454C",91).
component("YOL061W",199).
component("YKL181W",158).
component("YHL011C",126).
component("YER099C",100).
component("YBL068W",44).
component("YOR143C",205).
component("YPR190C",232).
component("YPR187W",231).
component("YPR110C",229).
component("YPR010C",225).
component("YOR341W",212).
component("YOR340C",211).
component("YOR224C",209).
component("YOR210W",208).
component("YOR207C",207).
component("YOR151C",206).
component("YOR116C",203).
component("YOL005C",197).
component("YNR003C",194).
component("YNL248C",191).
component("YNL151C",190).
component("YNL113W",188).
component("YKL144C",157).
component("YJR063W",145).
component("YJL148W",142).
component("YJL140W",141).
component("YIL021W",133).
component("YHR143W-A",129).
component("YGL070C",113).
component("YFL036W",102).
component("YDR404C",90).
component("YDR156W",82).
component("YDR045C",74).
component("YDL150W",67).
component("YDL140C",66).
component("YBR154C",53).
component("YDR058C",76).
component("YBL015W",42).
component("U84_",38).
component("YPR073C",227).
component("YHR215W",131).
component("YDL024C",65).
component("YBR093C",49).
component("YBR092C",48).
component("YPL228W",219).
component("YMR180C",181).
component("YDL236W",70).
component("YJL155C",143).
component("U30_",29).
component("YKR031C",163).
component("YLR286C",172).
component("YDR400W",88).
component("YML035C",175).
component("YJL070C",137).
component("YBR284W",59).
component("YNL045W",187).
component("U53_",31).
component("YIR032C",136).
component("YDL238C",71).
component("YLR245C",171).
component("YJL126W",139).
component("YBR111C",50).
component("YLR231C",170).
component("YLR134W",168).
component("YLR044C",167).
component("YGR087C",119).
component("U54_",32).
component("YKL211C",161) :- not remove_orf("YKL211C",161).
component("YGR170W",123).
component("YDR294C",84).
component("YNR033W",196).
component("YKL211C",162) :- not remove_orf("YKL211C",162).
component("YER090W",162) :- not remove_orf("YER090W",162).
component("YER090W",99) :- not remove_orf("YER090W",99).
component("YDR127W",80).
component("YPL281C",224).
component("YOR393W",214).
component("YMR323W",185).
component("YHR174W",130).
component("YGR254W",125).
component("YGL026C",111) :- not remove_orf("YGL026C",111).
component("YGR155W",122).
component("YNL316C",193).
component("YKL182W",159).
component("YDR127W",81).
component("YGL148W",114).
component("YDR007W",72) :- not remove_orf("YDR007W",72).
component("YOR095C",202).
component("YPR060C",226).
component("YOL097C",201).
component("YOR335C",210).
component("YGR094W",120).
component("YJL101C",138).
component("YJR103W",149).
component("YBL039C",43).
component("YBR208C",55).
component("YGL062W",112).
component("YBR218C",56).
component("YPL231W",222).
component("YNR016C",195).
component("YKL182W",160).
component("YGR037C",118).
component("YPR138C",230).
component("YPL265W",223).
component("YPL036W",218).
component("YOL020W",198) :- not remove_orf("YOL020W",198).
component("YNL142W",189).
component("YKR053C",165).
component("YKR039W",164) :- not remove_orf("YKR039W",164).
component("YJR095W",148).
component("YJR077C",146).
component("YJL134W",140).
component("YGR121C",121).
component("YGL008C",109).
component("YFL055W",104).
component("YEL017C-A",95).
component("YDR536W",94).
component("YDR508C",93).
component("YDR503C",92).
component("YDR046C",75) :- not remove_orf("YDR046C",75).
component("YCR024C-A",63).
component("YCL025C",62).
component("YBR298C",61).
component("YBR291C",60).
component("YBR069C",47) :- not remove_orf("YBR069C",47).
component("YBR068C",46) :- not remove_orf("YBR068C",46).
component("YBR021W",45).
component("U71_",35).
component("U228_",28).
component("U206_",26).
component("U202_",25).
...
catalyst(5611,169).
catalyst(5612,169).
catalyst(3620,86) :- not remove_reaction(3620,86).
catalyst(2190,106).
catalyst(5550,152).
catalyst(5320,87).
catalyst(3710,78).
...
catalyst(7550,119).
catalyst(3460,32).
catalyst(3600,161) :- not remove_reaction(3600,161).
catalyst(6900,123).
catalyst(8781,84).
catalyst(8782,84).
catalyst(2550,196).
catalyst(3630,162) :- not remove_reaction(3630,162).
catalyst(3630,99) :- not remove_reaction(3630,99).
catalyst(3740,80).
catalyst(8231,224).
catalyst(8232,224).
catalyst(8231,214).
...
catalyst(8231,125).
catalyst(8232,125).
catalyst(3590,111) :- not remove_reaction(3590,111).
catalyst(10910,111) :- not remove_reaction(10910,111).
catalyst(4570,122).
catalyst(3680,193).
catalyst(7141,159).
catalyst(7142,159).
catalyst(3750,81).
catalyst(3700,114).
catalyst(3610,72) :- not remove_reaction(3610,72).
catalyst(7921,202).
catalyst(7922,202).
catalyst(3690,226).
catalyst(8671,201).
...
catalyst(372,189).
catalyst(6560,165).
catalyst(781,164) :- not remove_reaction(781,164).
catalyst(782,164) :- not remove_reaction(782,164).
...
catalyst(881,164) :- not remove_reaction(881,164).
catalyst(882,164) :- not remove_reaction(882,164).
catalyst(1191,164) :- not remove_reaction(1191,164).
catalyst(1192,164) :- not remove_reaction(1192,164).
catalyst(1250,148).
catalyst(1581,146).
catalyst(1582,146).
catalyst(6560,140).
...
catalyst(1501,60).
catalyst(1502,60).
catalyst(801,47) :- not remove_reaction(801,47).
catalyst(802,47) :- not remove_reaction(802,47).
catalyst(811,47) :- not remove_reaction(811,47).
catalyst(812,47) :- not remove_reaction(812,47).
catalyst(801,46) :- not remove_reaction(801,46).
catalyst(802,46) :- not remove_reaction(802,46).
catalyst(811,46) :- not remove_reaction(811,46).
catalyst(812,46) :- not remove_reaction(812,46).
catalyst(831,46) :- not remove_reaction(831,46).
catalyst(832,46) :- not remove_reaction(832,46).
catalyst(620,45).
catalyst(2930,35).
catalyst(41,28).
catalyst(42,28).
...
modifiable_enzyme(47).
modifiable_enzyme(46).
