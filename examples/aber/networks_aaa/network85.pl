...
component("YNL280C",512).
component("YGR060W",305).
component("YGL012W",283).
component("YOL086C",533).
component("YMR303C",490).
component("YGL256W",299).
component("YDL168W",183).
component("YBR145W",142).
component("YPL231W",583).
component("YBR149W",143).
component("YGL001C",280).
component("YIL094C",351).
component("YHR063C",334).
component("YBR153W",144).
component("YML056C",465).
component("YLR432W",461).
component("YHR216W",345).
component("YAR075W",114).
component("YAR073W",113).
component("YDR127W",202).
component("YJR139C",397).
component("YOL126C",537).
component("YDL078C",173).
component("YKL029C",401).
component("YOR136W",547).
component("YDL066W",172).
component("YLR355C",458).
component("YML086C",467).
component("YIL155C",355).
component("YPR191W",610).
component("YOR065W",542).
component("YJL166W",376).
component("YHR001W-A",329).
component("YGR183C",315).
component("YFR033C",276).
component("YDR529C",235).
component("YBL045C",120).
component("Q0105",18).
component("YGR088W",307).
component("YDR256C",216).
component("YJR078W",388).
component("YJR025C",383).
component("YGR255C",323).
component("YBL098W",123).
component("YMR015C",473).
component("YDR402C",227).
component("YGL055W",287).
component("YGR175C",313).
component("YJR104C",391).
component("YHR008C",330).
component("YER070W",255).
component("U35_",72).
component("YDL168W",184).
component("YDR158W",210).
component("YPL276W",592).
component("YPL275W",591).
component("YOR388C",569).
component("YGL154C",293).
component("U55_",81).
component("YOR323C",559).
component("YMR170C",481).
component("YMR169C",480).
component("U2_",69).
component("YBR221C",151).
component("U52_",78).
component("YBR166C",147).
component("YNL280C",513).
component("YGL012W",284).
component("U57_",82).
component("YER014W",244).
component("YKR009C",419).
component("YIL160C",357).
component("YGL205W",296).
component("YMR118C",478).
component("YLR164W",443).
component("YLL041C",427).
component("YKL148C",409).
component("YJL045W",362).
component("YDR178W",211).
component("YJR051W",385).
component("YEL047C",239).
component("YOR375C",567).
component("YDL215C",187).
component("YAL062W",111).
component("U99_",107).
component("YBR035C",130).
component("YHR037W",331).
component("YKR080W",423).
component("YER023W",245).
component("YOR236W",556).
component("YGR204W",317).
component("YLR142W",438).
component("U62_",84).
component("YKL150W",410).
component("YIL043C",347).
component("YHR042W",332).
component("YFR030W",275).
component("YPL017C",572).
component("YFL018C",267).
component("YER042W",247).
component("YJR137C",396).
component("YPL266W",589).
component("YML110C",469).
component("YBR034C",129).
component("YPL273W",590).
component("YLL062C",429).
component("U47_",75).
component("YER091C",258).
component("YDL033C",170).
component("YOL096C",534).
component("YDR019C",192).
component("YDR408C",229).
component("YBL013W",115).
component("YKL024C",400).
component("YPR074C",602).
component("YBR117C",139).
component("YLR354C",457).
component("YGR043C",303).
component("YCL009C",160).
component("YMR062C",475).
component("YNL071W",496).
component("YNR008W",520).
component("YPL231W",584).
component("YER061C",253).
component("U86_",99).
component("YPL001W",571).
component("YDR148C",208).
component("YOR377W",568).
component("YGR177C",314).
component("YPL231W",585).
component("YGR147C",310).
component("YDL040C",171).
component("YPL028W",573).
component("YPR001W",594).
component("YNR001C",518).
component("YDL182W",185).
component("YDL131W",178).
component("YNL117W",499).
component("YIR031C",360).
component("YNL029C",493).
component("YIL085C",350).
component("YMR261C",486).
component("YML100W",468).
component("YBR126C",141).
component("YNL192W",505).
component("YBR038W",132).
component("YBR023C",128).
component("YLR209C",444).
component("U104_",21).
component("YMR300C",489).
component("YER055C",249).
component("YDR354W",223) :- not remove_orf("YDR354W",223).
component("YFR047C",277).
component("YJR133W",395).
component("YLR209C",445).
component("YML022W",462).
component("YDR441C",231).
component("YDR399W",225).
component("YJL167W",377).
component("YNL256W",508).
component("YDR127W",203).
component("YLR303W",451).
component("YJR130C",394).
component("YLR303W",452).
component("YDR035W",193).
component("YBR249C",152).
component("YOL143C",539).
component("YBR256C",153).
component("YHR137W",339).
component("YGL202W",295).
component("YLR027C",430).
component("YKL106W",405).
component("YKL104C",404).
component("YGR019W",301).
component("YLR089C",434).
component("U64_",85).
component("U51_",77).
component("YJR148W",398).
component("YGL253W",298).
component("YFR053C",278).
component("YOL136C",538).
component("YIL107C",352).
component("YMR205C",483).
component("YGR240C",319).
component("YDR248C",215).
component("YCR036W",167).
component("YCL040W",162).
component("YJR105W",392).
component("U16_",38).
component("U15_",35).
component("U96_",105).
component("YKL001C",399).
component("YML070W",466).
component("YFL053W",270).
component("YHL032C",327).
component("U83_",97).
component("U82_",96).
component("U81_",95).
component("YMR208W",484).
component("YOR347C",564).
component("YAL038W",110).
component("YNR012W",521).
component("YPR121W",605).
component("YPL258C",587).
component("YOL055C",530).
component("U1_",52).
component("YBR020W",126).
component("YNL267W",510).
component("YLR305C",454).
component("YFR019W",273).
component("YDR208W",212).
component("YDR127W",204).
component("U21_",60).
component("U20_",58).
component("YDR147W",207).
component("YDR300C",220).
component("YCR012W",164).
component("U18_",47).
component("U76_",93).
component("YER170W",264).
component("YDR226W",213).
component("YKL067W",403).
component("YDR454C",232).
component("YOL061W",532).
component("YKL181W",412).
component("YHL011C",325).
component("YER099C",260).
component("YBL068W",122).
component("YOR143C",548).
component("YGR007W",300).
component("YLR328W",455).
component("YJR010W",382).
component("YCL050C",163).
component("YPR190C",609).
component("YPR187W",608).
component("YPR110C",604).
component("YPR010C",596).
component("YOR341W",563).
component("YOR340C",562).
component("YOR224C",555).
component("YOR210W",554).
component("YOR207C",552).
component("YOR151C",549).
component("YOR116C",545).
component("YOL005C",526).
component("YNR003C",519).
component("YNL248C",507).
component("YNL151C",503).
component("YNL113W",498).
component("YKL144C",408).
component("YJR063W",386).
component("YJL148W",374).
component("YJL140W",373).
component("YIL021W",346).
component("YHR143W-A",340).
component("YGL070C",290).
component("YFL036W",269).
component("YDR404C",228).
component("YDR156W",209).
component("YDR045C",194).
component("YDL150W",181).
component("YDL140C",179).
component("YBR154C",146).
component("YPR175W",607).
component("YPL167C",580).
component("YOR330C",560).
component("YOL115W",536).
component("YNL299W",515).
component("YNL262W",509).
component("YNL102W",497).
component("YJR043C",384).
component("YJR006W",381).
component("YJL090C",366).
component("YIL139C",354).
component("YEL055C",240).
component("YDR419W",230).
component("YDR121W",201).
component("YDL102W",176).
component("YCR014C",165).
component("YBR278W",155).
component("YBL035C",117).
component("YKL035W",402).
component("YHL012W",326).
component("YHR123W",338).
component("YER026C",246).
component("YCL004W",159).
component("YJL068C",363).
component("YDR058C",198).
component("YNR034W",524).
component("YHR163W",342).
component("YGR248W",321).
component("YCR073W-A",168).
component("YDL086W",175).
component("YOL011W",527).
component("YMR008C",472).
component("YMR006C",471).
component("U101_",19).
component("YBL015W",116).
component("YJL068C",364).
component("YPL072W",576).
component("YOR124C",546).
component("YNL186W",504).
component("YMR304W",491).
component("YMR223W",485).
component("YKR098C",425).
component("YJL197W",378).
component("YIL156W",356).
component("YFR010W",272).
component("YER151C",262).
component("YER144C",261).
component("YER098W",259).
component("YDR069C",199).
component("YDL122W",177).
component("YBR058C",133).
component("YBL067C",121).
component("U84_",98).
component("YPR073C",600).
component("YHR215W",344).
component("YDL024C",169).
component("YBR093C",137).
component("YBR092C",136).
component("YAR071W",112).
component("YIL053W",349).
component("YER062C",254).
component("YHR046C",333).
component("YGR208W",318).
component("YPL228W",582).
component("YMR180C",482).
component("YDL236W",189).
component("YJL155C",375).
component("YPR073C",601).
component("YOR208W",553).
component("YNL053W",495).
component("YMR036C",474).
component("YIR026C",358).
component("YIL113W",353).
component("YFR028C",274).
component("YER075C",256).
component("YDL230W",188).
component("YBR276C",154).
component("U34_",71).
component("U30_",70).
component("U25_",68).
component("U24_",67).
component("YOR360C",566).
component("YGL248W",297).
component("YKR031C",420).
component("YLR286C",449).
component("YOR190W",550).
component("YLR300W",450).
component("YGR282C",324).
component("YDR261C",217).
component("YDR400W",226).
component("U23_",66).
component("YML035C",463).
component("YJL070C",365).
component("YBR284W",156).
component("U102_",20).
component("YNL045W",494).
component("YLR160C",442).
component("YLR158C",441).
component("YLR157C",440).
component("YLR155C",439).
component("YDR321W",221).
component("YGL037C",286).
component("YDR242W",214).
component("YBR208C",148).
component("YMR281W",488).
component("U53_",79).
component("YIR032C",361).
component("YIR029W",359).
component("YMR120C",479).
component("YHR144C",341).
component("YNL141W",500).
component("YBR153W",145).
component("YDL238C",190).
component("YNL141W",501).
component("YLR245C",448).
component("YML035C",464).
component("YJL126W",369).
component("U87_",100).
component("YBR111C",138).
component("YER005W",243).
component("YIL048W",348).
component("YER166W",263).
component("YDR093W",200).
component("YAL026C",109).
component("YLR231C",446).
component("U88_",101).
component("YLR134W",436).
component("YLR044C",431).
component("YGR087C",306).
component("YDR380W",224).
component("YDL080C",174).
component("U98_",106).
component("YKL184W",415).
component("YNR043W",525).
component("U93_",104).
component("YDR047W",196).
component("U54_",80).
component("YKL211C",416) :- not remove_orf("YKL211C",416).
component("YGR170W",312).
component("YDR294C",218).
component("YEL046C",238).
component("YNR033W",523).
component("YKL211C",417) :- not remove_orf("YKL211C",417).
component("YER090W",417) :- not remove_orf("YER090W",417).
component("YER090W",257) :- not remove_orf("YER090W",257).
component("YDR127W",205).
component("YPL281C",593).
component("YOR393W",570).
component("YMR323W",492).
component("YHR174W",343).
component("YGR254W",322).
component("YGL026C",285) :- not remove_orf("YGL026C",285).
component("YGR155W",311).
component("YLR304C",453).
component("YJL200C",379).
component("YNL316C",516).
component("YKL182W",413).
component("YPL212C",581).
component("YNL292W",514).
component("YGL063W",289).
component("YFL001W",265).
component("YPR002W",595).
component("YDR127W",206).
component("YGL148W",292).
component("YLR359W",459).
component("YAL012W",108).
component("YFR055W",279).
component("YJL121C",368).
component("YBR019C",124).
component("YBR019C",125).
component("YDR050C",197).
component("YDR007W",191) :- not remove_orf("YDR007W",191).
component("YOR095C",544).
component("YER003C",242).
component("YGL001C",281).
component("U14_",30).
component("YKL152C",411).
component("YMR105C",476).
component("YKL127W",406).
component("YEL058W",241).
component("YPR060C",599).
component("YHR072W",335).
component("YPL097W",577).
component("YGR185C",316).
component("YPL104W",578).
component("YLL018C",426).
component("YPR081C",603).
component("YBR121C",140).
component("YNL247W",506).
component("YOL033W",529).
component("YHR091C",337).
component("YDR341C",222).
component("YOL097C",535).
component("YPR047W",598).
component("YLR060W",432).
component("YFL022C",268).
component("YPR033C",597).
component("YPL160W",579).
component("YLR382C",460).
component("YOR335C",561).
component("YGR094W",308).
component("YGR244C",320).
component("U89_",102).
component("YOR241W",557).
component("YMR113W",477).
component("YKL132C",407).
component("YJL101C",367).
component("U91_",103).
component("YDL141W",180).
component("YJR103W",390).
component("YBL039C",118).
component("YOL058W",531).
component("YBR208C",149).
component("YHR074W",336).
component("YOR303W",558).
component("YJR109C",393).
component("YJL130C",371).
component("YGL062W",288).
component("YBR218C",150).
component("YPL231W",586).
component("YNR016C",522).
component("YKL182W",414).
component("YGR037C",302).
component("YOR005C",541).
component("YDL164C",182).
component("YPR138C",606).
component("YPL265W",588).
component("YPL057C",575).
component("YPL036W",574).
component("YOR348C",565).
component("YOR192C",551).
component("YOR071C",543).
component("YOL156W",540).
component("YOL020W",528) :- not remove_orf("YOL020W",528).
component("YNL318C",517).
component("YNL268W",511).
component("YNL142W",502).
component("YMR272C",487).
component("YML123C",470).
component("YLR348C",456).
component("YLR237W",447).
component("YLR138W",437).
component("YLR100C",435).
component("YLR081W",433).
component("YLL061W",428).
component("YKR093W",424).
component("YKR053C",422).
component("YKR039W",421) :- not remove_orf("YKR039W",421).
component("YKL217W",418).
component("YJR095W",389).
component("YJR077C",387).
component("YJL219W",380).
component("YJL134W",372).
component("YJL129C",370).
component("YHL036W",328).
component("YGR121C",309).
component("YGR055W",304).
component("YGL186C",294).
component("YGL077C",291).
component("YGL008C",282).
component("YFL055W",271).
component("YFL011W",266).
component("YER060W-A",252).
component("YER060W",251).
component("YER056C",250).
component("YER053C",248).
component("YEL017C-A",237).
component("YDR536W",236).
component("YDR508C",234).
component("YDR503C",233).
component("YDR294C",219).
component("YDR046C",195) :- not remove_orf("YDR046C",195).
component("YDL210W",186).
component("YCR024C-A",166).
component("YCL025C",161).
component("YBR298C",158).
component("YBR291C",157).
component("YBR069C",135) :- not remove_orf("YBR069C",135).
component("YBR068C",134) :- not remove_orf("YBR068C",134).
component("YBR036C",131).
component("YBR021W",127).
component("YBL042C",119).
component("U79_",94).
component("U75_",92).
component("U74_",91).
component("U73_",90).
...
catalyst(6160,489).
catalyst(3870,249).
catalyst(3620,223) :- not remove_reaction(3620,223).
catalyst(2110,277).
catalyst(2190,277).
catalyst(5550,395).
catalyst(5791,445).
...
catalyst(1960,196).
catalyst(3460,80).
catalyst(3600,416) :- not remove_reaction(3600,416).
catalyst(6900,312).
catalyst(8781,218).
catalyst(8782,218).
catalyst(4560,238).
...
catalyst(3630,257) :- not remove_reaction(3630,257).
catalyst(3740,205).
catalyst(8231,593).
catalyst(8232,593).
catalyst(8231,570).
...
catalyst(8231,322).
catalyst(8232,322).
catalyst(3590,285) :- not remove_reaction(3590,285).
catalyst(10910,285) :- not remove_reaction(10910,285).
catalyst(4570,311).
catalyst(8181,453).
catalyst(8182,453).
catalyst(8181,379).
...
catalyst(8281,197).
catalyst(8282,197).
catalyst(3610,191) :- not remove_reaction(3610,191).
catalyst(7921,544).
catalyst(7922,544).
catalyst(7841,242).
catalyst(7842,242).
...
catalyst(941,528) :- not remove_reaction(941,528).
catalyst(942,528) :- not remove_reaction(942,528).
catalyst(1200,517).
catalyst(761,511).
catalyst(762,511).
catalyst(371,502).
...
catalyst(640,424).
catalyst(6560,422).
catalyst(761,421) :- not remove_reaction(761,421).
catalyst(762,421) :- not remove_reaction(762,421).
catalyst(771,421) :- not remove_reaction(771,421).
catalyst(772,421) :- not remove_reaction(772,421).
catalyst(781,421) :- not remove_reaction(781,421).
catalyst(782,421) :- not remove_reaction(782,421).
catalyst(791,421) :- not remove_reaction(791,421).
catalyst(792,421) :- not remove_reaction(792,421).
catalyst(801,421) :- not remove_reaction(801,421).
catalyst(802,421) :- not remove_reaction(802,421).
catalyst(811,421) :- not remove_reaction(811,421).
catalyst(812,421) :- not remove_reaction(812,421).
catalyst(821,421) :- not remove_reaction(821,421).
catalyst(822,421) :- not remove_reaction(822,421).
catalyst(831,421) :- not remove_reaction(831,421).
catalyst(832,421) :- not remove_reaction(832,421).
catalyst(841,421) :- not remove_reaction(841,421).
catalyst(842,421) :- not remove_reaction(842,421).
catalyst(861,421) :- not remove_reaction(861,421).
catalyst(862,421) :- not remove_reaction(862,421).
catalyst(881,421) :- not remove_reaction(881,421).
catalyst(882,421) :- not remove_reaction(882,421).
catalyst(941,421) :- not remove_reaction(941,421).
catalyst(942,421) :- not remove_reaction(942,421).
catalyst(1191,421) :- not remove_reaction(1191,421).
catalyst(1192,421) :- not remove_reaction(1192,421).
catalyst(1021,418).
catalyst(1022,418).
catalyst(1250,389).
catalyst(1581,387).
...
catalyst(6680,233).
catalyst(6550,219).
catalyst(791,195) :- not remove_reaction(791,195).
catalyst(792,195) :- not remove_reaction(792,195).
...
catalyst(841,195) :- not remove_reaction(841,195).
catalyst(842,195) :- not remove_reaction(842,195).
catalyst(861,195) :- not remove_reaction(861,195).
catalyst(862,195) :- not remove_reaction(862,195).
catalyst(730,186).
catalyst(220,166).
catalyst(771,161).
catalyst(772,161).
...
catalyst(1511,157).
catalyst(1512,157).
catalyst(771,135) :- not remove_reaction(771,135).
catalyst(772,135) :- not remove_reaction(772,135).
catalyst(791,135) :- not remove_reaction(791,135).
catalyst(792,135) :- not remove_reaction(792,135).
catalyst(801,135) :- not remove_reaction(801,135).
catalyst(802,135) :- not remove_reaction(802,135).
catalyst(811,135) :- not remove_reaction(811,135).
catalyst(812,135) :- not remove_reaction(812,135).
catalyst(861,135) :- not remove_reaction(861,135).
catalyst(862,135) :- not remove_reaction(862,135).
catalyst(791,134) :- not remove_reaction(791,134).
catalyst(792,134) :- not remove_reaction(792,134).
catalyst(801,134) :- not remove_reaction(801,134).
catalyst(802,134) :- not remove_reaction(802,134).
catalyst(811,134) :- not remove_reaction(811,134).
catalyst(812,134) :- not remove_reaction(812,134).
catalyst(831,134) :- not remove_reaction(831,134).
catalyst(832,134) :- not remove_reaction(832,134).
catalyst(841,134) :- not remove_reaction(841,134).
catalyst(842,134) :- not remove_reaction(842,134).
catalyst(861,134) :- not remove_reaction(861,134).
catalyst(862,134) :- not remove_reaction(862,134).
catalyst(6600,131).
catalyst(620,127).
catalyst(540,119).
catalyst(2830,94).
