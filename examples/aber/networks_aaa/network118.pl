...
component("YNL280C",651).
component("YLR056W",546).
component("YGR060W",386).
component("YGL012W",360).
component("YKR009C",530).
component("YOL086C",679).
component("YMR303C",622).
component("YMR083W",600).
component("YGL256W",379).
component("YDL168W",234).
component("YBR145W",178).
component("YPL231W",741).
component("U46_",99).
component("YBR149W",179).
component("YJR159W",501).
component("YGL001C",357).
component("YIL094C",444).
component("YHR063C",427).
component("YBR153W",180).
component("YML056C",587).
component("YLR432W",580).
component("YHR216W",438).
component("YAR075W",143).
component("YAR073W",142).
component("YDR127W",261).
component("YJR139C",496).
component("YOL126C",684).
component("YDL078C",217).
component("YKL029C",506).
component("YOR136W",694).
component("YNL037C",626).
component("YDL066W",216).
component("YNL241C",641).
component("YOL059W",677).
component("YDL022W",211).
component("YLR355C",577).
component("YML054C",586).
component("YDL174C",236).
component("YML086C",590).
component("YIL155C",450).
component("YPR191W",771).
component("YOR065W",689).
component("YJL166W",474).
component("YHR001W-A",417).
component("YGR183C",398).
component("YFR033C",353).
component("YDR529C",302).
component("YBL045C",149).
component("Q0105",18).
component("YGR088W",388).
component("YDR256C",276).
component("YKL026C",505).
component("YIR037W",457).
component("YBR244W",190).
component("YJR078W",487).
component("YJR025C",481).
component("YGR255C",410).
component("U108_",22).
component("YBL098W",153).
component("YMR015C",597).
component("YHR007C",418).
component("YDR402C",291).
component("YGL055W",365).
component("YGR175C",395).
component("YJR104C",490).
component("YHR008C",419).
component("YJL026W",458).
component("YGR180C",397).
component("YER070W",325).
component("U35_",95).
component("YDL168W",235).
component("YDR158W",269).
component("YBR006W",154).
component("YPL276W",752).
component("YPL275W",751).
component("YOR388C",724).
component("YOR374W",721).
component("YER073W",326).
component("YGL154C",372).
component("U55_",106).
component("YOR323C",713).
component("YMR170C",608).
component("YMR169C",607).
component("U2_",91).
component("YER178W",340).
component("YBR221C",188).
component("YIL125W",448).
component("U52_",103).
component("YBR166C",183).
component("YNL280C",652).
component("YGL012W",361).
component("U57_",107).
component("YKL216W",527).
component("YDR044W",251).
component("YER014W",313).
component("YKR009C",531).
component("YIL160C",452).
component("YGL205W",375).
component("YMR118C",604).
component("YLR164W",559).
component("YLL041C",539).
component("YKL148C",517).
component("YKL141W",515).
component("YJL045W",459).
component("YDR178W",270).
component("YJR051W",483).
component("YEL047C",308).
component("YDL215C",240).
component("YOR375C",722).
component("YDL215C",241).
component("YAL062W",140).
component("U99_",135).
component("YBR035C",164).
component("YHR037W",424).
component("YKR080W",535).
component("YER023W",314).
component("YOR236W",708).
component("YGR204W",402).
component("YLR142W",554).
component("U62_",110).
component("YKL150W",518).
component("YIL043C",440).
component("YHR042W",425).
component("YOR221C",706).
component("YML120C",593).
component("YKL192C",524).
component("YKL055C",508).
component("YER061C",322).
component("YGR234W",405).
component("YFR030W",352).
component("YPL017C",727).
component("YFL018C",344).
component("YER042W",316).
component("YJR137C",495).
component("YPL266W",748).
component("YML110C",592).
component("YBR034C",163).
component("YPL273W",749).
component("YLL062C",542).
component("YDR410C",294).
component("U47_",100).
component("YER091C",332).
component("YJR073C",485).
component("YDL033C",213).
component("YOL096C",680).
component("YLR172C",560).
component("YDR019C",247).
component("YDR408C",293).
component("YMR120C",605).
component("YBL013W",144).
component("YKL024C",504).
component("YPR074C",763).
component("YBR117C",174).
component("YLR354C",576).
component("YGR043C",384).
component("YMR108W",602).
component("YCL009C",199).
component("YMR062C",599).
component("YNL071W",629).
component("YNR008W",659).
component("YNL277W",650).
component("YFL017C",343).
component("YPL231W",742).
component("YER061C",323).
component("U86_",125).
component("YPL001W",726).
component("YDR148C",267).
component("YOR377W",723).
component("YGR177C",396).
component("YPL231W",743).
component("YGR147C",392).
component("YDL040C",214).
component("YPL028W",728).
component("YGL017W",362).
component("YPR001W",754).
component("YNR001C",657).
component("YDL182W",237).
component("YDL131W",226).
component("YNL117W",633).
component("YIR031C",455).
component("YOR321W",712).
component("YJR143C",497).
component("YGR199W",401).
component("YDR307W",284).
component("YDL095W",221).
component("YDL093W",220).
component("YAL023C",137).
component("YNL029C",625).
component("YIL085C",443).
component("YMR261C",616).
component("YML100W",591).
component("YBR126C",177).
component("YNL192W",640).
component("YBR038W",166).
component("YBR023C",162).
component("YLR209C",561).
component("U104_",21).
component("YOR209C",704).
component("YMR300C",621).
component("YER055C",318).
component("YDR354W",287) :- not remove_orf("YDR354W",287).
component("YFR047C",354).
component("YJR133W",494).
component("YLR209C",562).
component("YML022W",583).
component("YDR441C",297).
component("YDR399W",289).
component("YJL167W",475).
component("YNL256W",644).
component("YDR127W",262).
component("YLR303W",569).
component("YGR012W",381).
component("YJR130C",493).
component("YLR303W",570).
component("YDR035W",249).
component("YBR249C",191).
component("YOL143C",686).
component("YBR256C",192).
component("YHR137W",432).
component("YGL202W",374).
component("YLR027C",543).
component("YKL106W",512).
component("YKL104C",511).
component("YGR019W",382).
component("YLR089C",549).
component("U64_",111).
component("U61_",109).
component("U51_",102).
component("YJR148W",498).
component("YOR184W",699).
component("YNR058W",667).
component("YIL116W",447).
component("YGL253W",378).
component("YFR053C",355).
component("YOL136C",685).
component("YIL107C",445).
component("YMR205C",610).
component("YGR240C",406).
component("YDR248C",275).
component("YCR036W",207).
component("YGR194C",400).
component("YCL040W",202).
component("YJR105W",491).
component("U16_",47).
component("U15_",42).
component("U96_",133).
component("YKL001C",502).
component("YDR236C",273).
component("YML070W",589).
component("YFL053W",347).
component("YHL032C",415).
component("YLR133W",551).
component("YDR531W",304).
component("U83_",123).
component("U82_",122).
component("U81_",121).
component("YMR208W",611).
component("YHR025W",423).
component("YOR347C",718).
component("YAL038W",139).
component("YNR012W",660).
component("YPR121W",766).
component("YPL258C",745).
component("YOL055C",674).
component("U1_",70).
component("YDR009W",246).
component("YBR020W",160).
component("YNL267W",648).
component("YLR305C",572).
component("YFR019W",350).
component("YDR208W",271).
component("YDR127W",263).
component("U21_",80).
component("U20_",77).
component("YDR147W",266).
component("YDR300C",283).
component("YCR012W",204).
component("U18_",62).
component("U17_",55).
component("U76_",119).
component("YMR220W",613).
component("YER170W",339).
component("YDR226W",272).
component("YKL067W",510).
component("YDR454C",298).
component("YOL061W",678).
component("YKL181W",520).
component("YHL011C",413).
component("YER099C",334).
component("YBL068W",152).
component("YOR143C",696).
component("YNL256W",645).
component("YLR328W",573).
component("YBR018C",156).
component("YBR018C",157).
component("YGR007W",380).
component("YLR328W",574).
component("YKR002W",529).
component("YDL103C",224).
component("YJR010W",480).
component("YGL130W",370).
component("YDR530C",303).
component("YCL050C",203).
component("YPR190C",770).
component("YPR187W",769).
component("YPR110C",765).
component("YPR010C",756).
component("YOR341W",717).
component("YOR340C",716).
component("YOR224C",707).
component("YOR210W",705).
component("YOR207C",702).
component("YOR151C",697).
component("YOR116C",692).
component("YOL005C",668).
component("YNR003C",658).
component("YNL248C",643).
component("YNL151C",637).
component("YNL113W",632).
component("YKL144C",516).
component("YJR063W",484).
component("YJL148W",471).
component("YJL140W",470).
component("YIL021W",439).
component("YHR143W-A",433).
component("YGL070C",368).
component("YFL036W",346).
component("YDR404C",292).
component("YDR156W",268).
component("YDR045C",252).
component("YDL150W",232).
component("YDL140C",228).
component("YBR154C",182).
component("YPR175W",768).
component("YPL167C",736).
component("YOR330C",714).
component("YOL115W",683).
component("YNL299W",654).
component("YNL262W",647).
component("YNL102W",631).
component("YJR043C",482).
component("YJR006W",479).
component("YJL090C",463).
component("YIL139C",449).
component("YEL055C",309).
component("YDR419W",295).
component("YDR121W",260).
component("YDL102W",223).
component("YCR014C",205).
component("YBR278W",194).
component("YBL035C",146).
component("YKL035W",507).
component("YHL012W",414).
component("YHR123W",431).
component("YBR243C",189).
component("YDL142C",231).
component("YER026C",315).
component("YCL004W",198).
component("YJL068C",460).
component("YDR058C",256).
component("YNR034W",664).
component("YHR163W",435).
component("YGR248W",408).
component("YCR073W-A",208).
component("YDL086W",219).
component("YOL011W",670).
component("YMR008C",596).
component("YMR006C",595).
component("U101_",19).
component("YBL015W",145).
component("YJL068C",461).
component("YPL072W",731).
component("YOR124C",693).
component("YNL186W",639).
component("YMR304W",623).
component("YMR223W",614).
component("YKR098C",537).
component("YJL197W",476).
component("YIL156W",451).
component("YFR010W",349).
component("YER151C",337).
component("YER144C",336).
component("YER098W",333).
component("YDR069C",257).
component("YDL122W",225).
component("YBR058C",167).
component("YBL067C",151).
component("YDR272W",279).
component("U84_",124).
component("YPL179W",737).
component("YNR032W",662).
component("YML057W",588).
component("YML016C",582).
component("YLR433C",581).
component("YGR123C",391).
component("YER133W",335).
component("YER089C",330).
component("YDR436W",296).
component("YDR075W",258).
component("YDL188C",238).
component("YDL134C",227).
component("YDL047W",215).
component("YDL006W",209).
component("YBR125C",176).
component("YBL056W",150).
component("YPR073C",761).
component("YHR215W",437).
component("YDL024C",212).
component("YBR093C",172).
component("YBR092C",171).
component("YAR071W",141).
component("YIL053W",442).
component("YER062C",324).
component("YHR046C",426).
component("YGR208W",404).
component("YPL228W",740).
component("YMR180C",609).
component("YDL236W",243).
component("YJL155C",473).
component("YPR073C",762).
component("YOR208W",703).
component("YNL053W",628).
component("YMR036C",598).
component("YIR026C",453).
component("YIL113W",446).
component("YFR028C",351).
component("YER075C",327).
component("YDL230W",242).
component("YBR276C",193).
component("U34_",94).
component("U33_",93).
component("U30_",92).
component("U28_",90).
...
component("U25_",88).
component("U24_",87).
component("YOR360C",720).
component("YGL248W",377).
component("YKR031C",532).
component("YPL206C",738).
component("YLR286C",567).
component("YJR153W",500).
component("YOR190W",700).
component("YLR300W",568).
component("YGR282C",412).
component("YDR261C",277).
component("YDR400W",290).
component("U23_",86).
component("YML035C",584).
component("YJL070C",462).
component("YBR284W",195).
component("U102_",20).
component("YNL045W",627).
component("YLR160C",558).
component("YLR158C",557).
component("YLR157C",556).
component("YLR155C",555).
component("YDR321W",285).
component("YGL037C",364).
component("YMR293C",620).
component("YDR242W",274).
component("YBR208C",185).
component("YMR281W",619).
component("U53_",104).
component("YPL111W",734).
component("YIR032C",456).
component("YIR029W",454).
component("YPR062W",760).
component("YMR120C",606).
component("YLR028C",544).
component("YHR144C",434).
component("YGR267C",411).
component("YNL141W",634).
component("YBR153W",181).
component("YDL238C",244).
component("YNL141W",635).
component("YLR245C",565).
component("YML035C",585).
component("YJL126W",466).
component("U44_",98).
component("YDL100C",222).
component("U87_",126).
component("YMR267W",617).
component("YBR011C",155).
component("YBR111C",173).
component("YCL030C",201).
component("YER005W",312).
component("YIL048W",441).
component("YER166W",338).
component("YDR093W",259).
component("YAL026C",138).
component("YLR231C",563).
component("U88_",127).
component("YLR134W",552).
component("YLR044C",545).
component("YGR087C",387).
component("YDR380W",288).
component("YDL080C",218).
component("U98_",134).
component("YMR250W",615).
component("YKL184W",523).
component("YNR043W",665).
component("U93_",132).
component("YDR047W",254).
component("U54_",105).
component("YKL211C",525) :- not remove_orf("YKL211C",525).
component("YOL052C",673).
component("YNL169C",638).
component("YGR170W",394).
component("YKL060C",509).
component("YNL256W",646).
component("YDR294C",280).
component("YEL046C",307).
component("YNR033W",663).
component("YKL211C",526) :- not remove_orf("YKL211C",526).
component("YER090W",526) :- not remove_orf("YER090W",526).
component("YER090W",331) :- not remove_orf("YER090W",331).
component("YDR127W",264).
component("YPL281C",753).
component("YOR393W",725).
component("YMR323W",624).
component("YHR174W",436).
component("YGR254W",409).
component("YPL262W",746).
component("YGL026C",363) :- not remove_orf("YGL026C",363).
component("YGR155W",393).
component("YLR304C",571).
component("YJL200C",477).
component("YNL316C",655).
component("YKL182W",521).
component("YPL212C",739).
component("YNL292W",653).
component("YGL063W",367).
component("YFL001W",341).
component("YOR278W",710).
component("YPR002W",755).
component("YDR127W",265).
component("YGL148W",371).
component("YER086W",328).
component("YLR359W",578).
component("YAL012W",136).
component("YFR055W",356).
component("YJL121C",465).
component("YBR019C",158).
component("YBR019C",159).
component("YDR050C",255).
component("YDR007W",245) :- not remove_orf("YDR007W",245).
component("YOR095C",691).
component("YER003C",311).
component("YBR196C",184).
component("YGL001C",358).
component("U14_",35).
component("YOL056W",675).
component("YKL152C",519).
component("YDL021W",210).
component("YMR105C",601).
component("YKL127W",513).
component("YEL058W",310).
component("YPR060C",759).
component("YHR072W",428).
component("YJL153C",472).
component("YPL097W",732).
component("YGR185C",399).
component("YHR011W",420).
component("YDR023W",248).
component("YPL104W",733).
component("YLL018C",538).
component("YPR081C",764).
component("YBR121C",175).
component("YHR020W",422).
component("YER087W",329).
component("YNL247W",642).
component("YOL033W",672).
component("YHR091C",430).
component("YDR341C",286).
component("YOL097C",681).
component("YDR268W",278).
component("YPR047W",758).
component("YLR060W",547).
component("YFL022C",345).
component("YPR033C",757).
component("YHR019C",421).
component("YPL160W",735).
component("YLR382C",579).
component("YNL073W",630).
component("YDR037W",250).
component("YOR335C",715).
component("YGR094W",389).
component("YOR142W",695).
component("YGR244C",407).
component("U89_",128).
component("YOR241W",709).
component("YMR113W",603).
component("YKL132C",514).
component("YJL101C",464).
component("U92_",131).
component("YGL234W",376).
component("U91_",130).
component("U90_",129).
component("YDL141W",229).
component("YDL141W",230).
component("YJR103W",489).
component("YBL039C",147).
component("YGR204W",403).
component("YBR084W",170).
component("YOL058W",676).
component("YBR208C",186).
component("YHR074W",429).
component("YMR217W",612).
component("YOR303W",711).
component("YJR109C",492).
component("YJL130C",468).
component("YGL062W",366).
component("YBR218C",187).
component("YPL231W",744).
component("YNR016C",661).
component("YKL182W",522).
component("YGR037C",383).
component("YOR005C",688).
component("YDL164C",233).
component("YOL010W",669).
component("YPR138C",767).
component("YPL274W",750).
component("YPL265W",747).
component("YPL057C",730).
component("YPL036W",729).
component("YOR348C",719).
component("YOR192C",701).
component("YOR171C",698).
component("YOR071C",690).
component("YOL156W",687).
component("YOL103W",682).
component("YOL020W",671) :- not remove_orf("YOL020W",671).
component("YNR056C",666).
component("YNL318C",656).
component("YNL268W",649).
component("YNL142W",636).
component("YMR272C",618).
component("YML123C",594).
component("YLR348C",575).
component("YLR260W",566).
component("YLR237W",564).
component("YLR138W",553).
component("YLR100C",550).
component("YLR081W",548).
component("YLL061W",541).
component("YLL043W",540).
component("YKR093W",536).
component("YKR053C",534).
component("YKR039W",533) :- not remove_orf("YKR039W",533).
component("YKL217W",528).
component("YKL004W",503).
component("YJR152W",499).
component("YJR095W",488).
component("YJR077C",486).
component("YJL219W",478).
component("YJL134W",469).
component("YJL129C",467).
component("YHL036W",416).
component("YGR121C",390).
component("YGR055W",385).
component("YGL186C",373).
component("YGL077C",369).
component("YGL008C",359).
component("YFL055W",348).
component("YFL011W",342).
component("YER060W-A",321).
component("YER060W",320).
component("YER056C",319).
component("YER053C",317).
component("YEL017C-A",306).
component("YDR536W",305).
component("YDR508C",301).
component("YDR503C",300).
component("YDR497C",299).
component("YDR297W",282).
component("YDR294C",281).
component("YDR046C",253) :- not remove_orf("YDR046C",253).
component("YDL210W",239).
component("YCR024C-A",206).
component("YCL025C",200).
component("YBR298C",197).
component("YBR291C",196).
component("YBR069C",169) :- not remove_orf("YBR069C",169).
component("YBR068C",168) :- not remove_orf("YBR068C",168).
component("YBR036C",165).
component("YBR021W",161).
component("YBL042C",148).
component("U79_",120).
component("U75_",118).
component("U74_",117).
component("U73_",116).
...
catalyst(6160,621).
catalyst(3870,318).
catalyst(3620,287) :- not remove_reaction(3620,287).
catalyst(2110,354).
catalyst(2190,354).
catalyst(5550,494).
catalyst(5791,562).
...
catalyst(1960,254).
catalyst(3460,105).
catalyst(3600,525) :- not remove_reaction(3600,525).
catalyst(3941,673).
catalyst(3942,673).
catalyst(6890,638).
catalyst(6900,394).
...
catalyst(4560,307).
catalyst(2550,663).
catalyst(1890,526) :- not remove_reaction(1890,526).
catalyst(3630,526) :- not remove_reaction(3630,526).
catalyst(1890,331) :- not remove_reaction(1890,331).
catalyst(3630,331) :- not remove_reaction(3630,331).
catalyst(3740,264).
catalyst(8231,753).
catalyst(8232,753).
catalyst(8231,725).
...
catalyst(8051,746).
catalyst(8052,746).
catalyst(3590,363) :- not remove_reaction(3590,363).
catalyst(10910,363) :- not remove_reaction(10910,363).
catalyst(4570,393).
catalyst(8181,571).
catalyst(8182,571).
catalyst(8181,477).
...
catalyst(8281,255).
catalyst(8282,255).
catalyst(3610,245) :- not remove_reaction(3610,245).
catalyst(7921,691).
catalyst(7922,691).
catalyst(7841,311).
catalyst(7842,311).
...
catalyst(1200,687).
catalyst(1160,682).
catalyst(801,671) :- not remove_reaction(801,671).
catalyst(802,671) :- not remove_reaction(802,671).
catalyst(811,671) :- not remove_reaction(811,671).
catalyst(812,671) :- not remove_reaction(812,671).
catalyst(831,671) :- not remove_reaction(831,671).
catalyst(832,671) :- not remove_reaction(832,671).
catalyst(901,671) :- not remove_reaction(901,671).
catalyst(902,671) :- not remove_reaction(902,671).
catalyst(941,671) :- not remove_reaction(941,671).
catalyst(942,671) :- not remove_reaction(942,671).
catalyst(700,666).
catalyst(1200,656).
catalyst(761,649).
catalyst(762,649).
...
catalyst(640,536).
catalyst(6560,534).
catalyst(761,533) :- not remove_reaction(761,533).
catalyst(762,533) :- not remove_reaction(762,533).
catalyst(771,533) :- not remove_reaction(771,533).
catalyst(772,533) :- not remove_reaction(772,533).
catalyst(781,533) :- not remove_reaction(781,533).
catalyst(782,533) :- not remove_reaction(782,533).
catalyst(791,533) :- not remove_reaction(791,533).
catalyst(792,533) :- not remove_reaction(792,533).
catalyst(801,533) :- not remove_reaction(801,533).
catalyst(802,533) :- not remove_reaction(802,533).
catalyst(811,533) :- not remove_reaction(811,533).
catalyst(812,533) :- not remove_reaction(812,533).
catalyst(821,533) :- not remove_reaction(821,533).
catalyst(822,533) :- not remove_reaction(822,533).
catalyst(831,533) :- not remove_reaction(831,533).
catalyst(832,533) :- not remove_reaction(832,533).
catalyst(841,533) :- not remove_reaction(841,533).
catalyst(842,533) :- not remove_reaction(842,533).
catalyst(861,533) :- not remove_reaction(861,533).
catalyst(862,533) :- not remove_reaction(862,533).
catalyst(881,533) :- not remove_reaction(881,533).
catalyst(882,533) :- not remove_reaction(882,533).
catalyst(901,533) :- not remove_reaction(901,533).
catalyst(902,533) :- not remove_reaction(902,533).
catalyst(911,533) :- not remove_reaction(911,533).
catalyst(912,533) :- not remove_reaction(912,533).
catalyst(941,533) :- not remove_reaction(941,533).
catalyst(942,533) :- not remove_reaction(942,533).
catalyst(1191,533) :- not remove_reaction(1191,533).
catalyst(1192,533) :- not remove_reaction(1192,533).
catalyst(1021,528).
catalyst(1022,528).
catalyst(6610,503).
catalyst(170,499).
...
catalyst(831,253) :- not remove_reaction(831,253).
catalyst(832,253) :- not remove_reaction(832,253).
catalyst(841,253) :- not remove_reaction(841,253).
catalyst(842,253) :- not remove_reaction(842,253).
...
catalyst(1511,196).
catalyst(1512,196).
catalyst(771,169) :- not remove_reaction(771,169).
catalyst(772,169) :- not remove_reaction(772,169).
catalyst(791,169) :- not remove_reaction(791,169).
catalyst(792,169) :- not remove_reaction(792,169).
catalyst(801,169) :- not remove_reaction(801,169).
catalyst(802,169) :- not remove_reaction(802,169).
catalyst(811,169) :- not remove_reaction(811,169).
catalyst(812,169) :- not remove_reaction(812,169).
catalyst(861,169) :- not remove_reaction(861,169).
catalyst(862,169) :- not remove_reaction(862,169).
catalyst(901,169) :- not remove_reaction(901,169).
catalyst(902,169) :- not remove_reaction(902,169).
catalyst(791,168) :- not remove_reaction(791,168).
catalyst(792,168) :- not remove_reaction(792,168).
catalyst(801,168) :- not remove_reaction(801,168).
catalyst(802,168) :- not remove_reaction(802,168).
catalyst(811,168) :- not remove_reaction(811,168).
catalyst(812,168) :- not remove_reaction(812,168).
catalyst(831,168) :- not remove_reaction(831,168).
catalyst(832,168) :- not remove_reaction(832,168).
catalyst(841,168) :- not remove_reaction(841,168).
catalyst(842,168) :- not remove_reaction(842,168).
catalyst(861,168) :- not remove_reaction(861,168).
catalyst(862,168) :- not remove_reaction(862,168).
catalyst(901,168) :- not remove_reaction(901,168).
catalyst(902,168) :- not remove_reaction(902,168).
catalyst(6600,165).
catalyst(620,161).
catalyst(540,148).
catalyst(2830,120).
...
modifiable_enzyme(525).
modifiable_enzyme(526).
modifiable_enzyme(331).
modifiable_enzyme(363).
modifiable_enzyme(245).
modifiable_enzyme(671).
modifiable_enzyme(533).
modifiable_enzyme(253).
modifiable_enzyme(169).
modifiable_enzyme(168).
