...
component("YLR056W",712).
component("YGR060W",500).
component("YGL012W",465).
component("YKR009C",692).
component("YOL086C",883).
component("YMR303C",814).
component("YMR083W",783).
component("YGL256W",492).
component("YDL168W",308).
...
component("YJR159W",656).
component("YGL001C",462).
component("YIL094C",580).
component("YHR063C",552).
component("U45_",130).
component("YBR153W",236).
component("YML056C",764).
component("YLR432W",754).
component("YHR216W",570).
component("YAR075W",191).
component("YAR073W",190).
component("YCL030C",262).
component("YDR127W",344).
component("YJR139C",650).
component("YML075C",767).
component("YLR450W",756).
component("YOL126C",888).
component("YKL085W",666).
component("YDL078C",288).
component("YKL029C",661).
component("YOR136W",905).
component("YNL037C",819).
component("YDL066W",286).
component("YNL241C",838).
component("YOL059W",880).
component("YDL022W",279).
component("YLR355C",749).
component("YIL074C",578).
component("YER081W",429).
component("YML054C",763).
component("YDL174C",311).
component("YML086C",768).
component("YIL155C",588).
component("YPR191W",1008).
component("YOR065W",895).
component("YJL166W",621).
component("YHR001W-A",540).
component("YGR183C",516).
component("YFR033C",458).
component("YDR529C",394).
component("YBL045C",198).
component("Q0105",18).
component("YGR088W",503).
component("YDR256C",361).
component("YKL026C",660).
component("YIR037W",600).
component("YBR244W",248).
component("YJR078W",641).
component("U58_",143).
component("YJR025C",633).
component("YGR255C",528).
component("U108_",25).
component("YBL098W",202).
component("YMR015C",779).
component("YHR007C",541).
component("YDR402C",382).
component("YGL055W",472).
component("YGR175C",513).
component("YJR104C",644).
component("YHR008C",542).
component("YJL026W",603).
component("YIL066C",577).
component("YGR180C",515).
...
component("YPL276W",980).
component("YPL275W",979).
component("YOR388C",943).
component("YOR374W",940).
component("YER073W",427).
component("U68_",150).
component("YGL154C",481).
component("YBR115C",227).
component("U55_",140).
component("YOR323C",930).
component("YMR170C",794).
component("YMR169C",793).
component("U2_",117).
component("YER178W",443).
component("YBR221C",246).
component("YIL125W",585).
component("U52_",137).
...
component("YIL160C",590).
component("YGL205W",486).
component("YMR118C",788).
component("YLR164W",726).
component("YLL041C",704).
component("YKL148C",674).
component("YKL141W",672).
component("YJL045W",604).
component("YDR178W",354).
component("YJR051W",636).
component("YEL047C",404).
component("YDL171C",310).
component("YDL215C",315).
component("YOR375C",941).
...
component("U56_",141).
component("YNR050C",864).
component("YHR037W",548).
component("YKR080W",697).
component("YER023W",412).
component("YPL023C",947).
component("YGL125W",478).
component("YOR236W",922).
component("YGR204W",520).
component("YLR142W",721).
component("U63_",147).
component("U62_",146).
component("YOR356W",938).
component("YKL150W",675).
component("YIL043C",574).
component("YHR042W",549).
component("YOR221C",919).
component("YML120C",772).
component("YKL192C",684).
component("YKL055C",663).
component("YER061C",421).
component("YMR145C",791).
component("YML120C",773).
component("YKL192C",685).
component("YDL085W",290).
component("YGR234W",523).
component("YFR030W",457).
component("YPL017C",946).
component("YFL018C",448).
component("YPL091W",952).
component("YDR353W",376).
component("YER042W",414).
component("YPR167C",1002).
component("YJR137C",649).
component("YNL052W",821).
component("YMR256C",805).
component("YLR395C",753).
component("YLR038C",710).
component("YIL111W",582).
component("YHR051W",551).
component("YGL191W",484).
component("YGL187C",483).
component("YDL067C",287).
component("Q0275",20).
component("Q0250",19).
component("YPL266W",975).
component("YML110C",771).
component("YBR034C",214).
component("YPL273W",977).
component("YLL062C",707).
component("YDR410C",385).
component("U47_",132).
component("YER091C",434).
component("YJR073C",639).
component("YDR120C",342).
component("YML008C",757).
component("YDL033C",281).
component("YOL096C",884).
component("YLR172C",727).
component("YDR019C",324).
component("YBR176W",240).
component("YDR408C",384).
component("YMR120C",789).
component("YBL013W",192).
component("YKL024C",659).
component("YPR074C",994).
component("YBR117C",228).
component("YLR354C",748).
component("YGR043C",498).
component("YMR108W",786).
component("YCL009C",260).
component("YMR062C",782).
component("YNL071W",823).
component("YNR008W",856).
component("YIL160C",591).
component("YNL277W",847).
component("YDR232W",357).
component("YFL017C",447).
component("YPL231W",969).
component("YER061C",422).
component("U86_",169).
component("YPL001W",945).
component("YMR296C",812).
component("YDR062W",336).
component("YDL052C",284).
component("U8_",173).
component("YDR148C",350).
component("YOR377W",942).
component("YGR177C",514).
component("YPL231W",970).
component("YGR147C",509).
component("YDL040C",282).
component("YPL028W",948).
component("YLR195C",728).
component("YGL017W",467).
component("YPR001W",982).
component("YNR001C",854).
component("YCR005C",268).
component("YNL104C",826).
component("YDL182W",312).
component("YDL131W",299).
component("YNL117W",828).
component("YIR031C",598).
component("YOR321W",929).
component("YJR143C",651).
component("YGR199W",519).
component("YDR307W",370).
component("YDL095W",294).
component("YDL093W",293).
component("YAL023C",184).
component("YOR103C",899).
component("YOR085W",897).
component("YMR149W",792).
component("YML019W",759).
component("YJL002C",601).
component("YEL002C",398).
component("YDL232W",318).
component("YCL043C",265).
component("YNL029C",818).
component("YIL085C",579).
component("YMR261C",806).
component("YML100W",769).
component("YBR126C",232).
component("YNL192W",836).
component("YBR038W",217).
component("YBR023C",213).
component("YMR306W",816).
component("YLR342W",746).
component("YGR032W",496).
component("YPR183W",1005).
component("YLR209C",729).
component("U104_",23).
component("YMR271C",808).
component("YML106W",770).
component("YOR209C",917).
component("YMR300C",813).
component("YER055C",417).
component("YDR354W",377) :- not remove_orf("YDR354W",377).
component("YFR047C",459).
component("YJR133W",648).
component("YLR209C",730).
component("YML022W",760).
component("YDR441C",388).
component("YDR399W",380).
component("YPR176C",1004).
component("YPL172C",960).
component("YNR041C",862).
component("YMR101C",784).
...
component("YPR069C",991).
component("YDR127W",345).
component("YLR303W",737).
component("YGR012W",494).
component("YJR130C",647).
component("YLR303W",738).
component("YDR035W",326).
component("YBR249C",249).
component("YOR274W",925).
component("YOL143C",891).
component("YBR256C",251).
component("YHR137W",561).
component("YGL202W",485).
component("YLR027C",708).
component("YKL106W",668).
component("YOL140W",890).
component("YKL104C",667).
component("YGR019W",495).
component("YLR089C",716).
component("U64_",148).
component("U61_",145).
component("U51_",136).
component("YJR148W",652).
component("YHR208W",568).
component("YFL030W",450).
component("YOR184W",911).
component("YNR058W",867).
component("YIL116W",584).
component("YGL253W",491).
component("YFR053C",460).
component("YOL136C",889).
component("YIL107C",581).
component("YMR013C",778).
component("YMR205C",798).
component("YGR240C",524).
component("YDR248C",360).
component("YCR036W",274).
component("YGR194C",518).
component("YCL040W",264).
component("YJR105W",645).
component("U16_",65).
component("U15_",57).
component("YPL188W",962).
component("YJR049C",635).
component("YEL041W",402).
component("U96_",179).
component("YKL001C",657).
component("YDR236C",358).
component("YML070W",766).
component("YFL053W",452).
component("YHL032C",538).
component("YLR133W",718).
component("YDR531W",396).
component("U83_",166).
component("U82_",165).
component("U81_",164).
component("YMR208W",799).
component("YPL203W",963).
component("YOR061W",894).
component("YKL166C",677).
component("YJL164C",620).
component("YIL035C",573).
component("YHR205W",567).
component("YHR102W",559).
component("YGL019W",468).
component("YHR025W",547).
component("YOR347C",936).
component("YAL038W",186).
component("YNR012W",857).
component("YPR121W",999).
component("YPL258C",972).
component("YOL055C",876).
component("YPL214C",966).
component("U1_",90).
component("YDR009W",323).
component("YBR020W",211).
component("YNL267W",845).
component("YLR305C",740).
component("YFR019W",455).
component("YDR208W",355).
...
component("U17_",74).
component("U76_",159).
component("YMR220W",801).
component("YER170W",442).
component("YDR226W",356).
component("YKL067W",665).
component("YOL055C",877).
component("YDR454C",389).
component("YJR057W",637).
component("YOL061W",881).
component("YKL181W",679).
component("YHL011C",535).
component("YER099C",436).
component("YBL068W",201).
component("YOR143C",907).
...
component("YKR002W",691).
component("U80_",163).
component("YDL103C",297).
component("U94_",178).
component("YJR010W",631).
component("YGL130W",479).
component("YDR530C",395).
component("YCL050C",266).
component("YPR190C",1007).
component("YPR187W",1006).
component("YPR110C",997).
component("YPR010C",985).
component("YOR341W",935).
component("YOR340C",934).
component("YOR224C",921).
component("YOR210W",918).
component("YOR207C",915).
component("YOR151C",908).
component("YOR116C",900).
component("YOL005C",869).
component("YNR003C",855).
component("YNL248C",840).
component("YNL151C",833).
component("YNL113W",827).
component("YKL144C",673).
component("YJR063W",638).
component("YJL148W",617).
component("YJL140W",616).
component("YIL021W",572).
component("YHR143W-A",562).
component("YGL070C",476).
component("YFL036W",451).
component("YDR404C",383).
component("YDR156W",351).
component("YDR045C",329).
component("YDL150W",306).
component("YDL140C",301).
component("YBR154C",238).
component("YPR175W",1003).
component("YPL167C",959).
component("YOR330C",931).
component("YOL115W",887).
component("YNL299W",851).
component("YNL262W",844).
component("YNL102W",825).
component("YJR043C",634).
component("YJR006W",630).
component("YJL090C",608).
component("YIL139C",587).
component("YEL055C",405).
component("YDR419W",386).
component("YDR121W",343).
component("YDL102W",296).
component("YCR014C",270).
component("YBR278W",254).
component("YBL035C",195).
component("YKL035W",662).
component("YHL012W",536).
component("YHR123W",560).
component("YPR113W",998).
component("YBR243C",247).
component("YNL130C",829).
component("YDL142C",305).
component("YPL148C",957).
component("YER026C",413).
component("YCL004W",259).
component("YOR251C",924).
component("YGR286C",532).
component("YJL068C",605).
component("YDR058C",334).
component("YNR034W",861).
component("YHR163W",564).
component("YGR248W",526).
component("YCR073W-A",276).
component("YDL086W",291).
component("YOL011W",871).
component("YMR008C",776).
component("YMR006C",775).
component("U105_",24).
component("U101_",21).
component("YBL015W",193).
component("YJL068C",606).
component("YPL072W",951).
component("YOR124C",901).
component("YNL186W",835).
component("YMR304W",815).
component("YMR223W",802).
component("YKR098C",701).
component("YJL197W",624).
component("YIL156W",589).
component("YFR010W",454).
component("YER151C",440).
component("YER144C",439).
component("YER098W",435).
component("YDR069C",337).
component("YDL122W",298).
component("YBR058C",218).
component("YBL067C",200).
component("YDR272W",364).
component("U84_",167).
component("YDR481C",390).
component("YLR377C",751).
component("YDR074W",338).
component("YPL179W",961).
component("YNR032W",859).
component("YML057W",765).
component("YML016C",758).
component("YLR433C",755).
component("YGR123C",506).
component("YER133W",438).
component("YER089C",432).
component("YDR436W",387).
component("YDR075W",339).
component("YDL188C",313).
component("YDL134C",300).
component("YDL047W",283).
component("YDL006W",277).
component("YBR125C",231).
component("YBL056W",199).
component("YPR073C",992).
component("YHR215W",569).
...
component("YPL228W",967).
component("YMR180C",795).
component("YDL236W",319).
component("YJL155C",619).
component("YPR073C",993).
component("YOR208W",916).
component("YNL053W",822).
component("YMR036C",781).
component("YIR026C",595).
component("YIL113W",583).
component("YFR028C",456).
component("YER075C",428).
component("YDL230W",317).
...
component("U25_",114).
component("U24_",113).
component("YOL064C",882).
component("YPL268W",976).
component("YOR360C",939).
component("YGL248W",490).
component("YKR031C",694).
component("YPL206C",964).
component("YGL027C",470).
component("YLR286C",735).
component("YJR153W",654).
component("YJL221C",629).
component("YJL216C",627).
component("YIL172C",594).
component("YGR292W",534).
component("YGR287C",533).
component("YBR299W",258).
component("YBR184W",241).
component("YIL162W",592).
component("YOR190W",913).
component("YLR300W",736).
component("YGR282C",531).
component("YDR261C",362).
component("YDR400W",381).
component("U23_",112).
component("YML035C",761).
component("YJL070C",607).
component("YBR284W",255).
component("U102_",22).
component("YNL045W",820).
component("YLR160C",725).
component("YLR158C",724).
component("YLR157C",723).
component("YLR155C",722).
component("YDR321W",371).
component("YGL037C",471).
component("YMR293C",811).
component("YDR242W",359).
component("YLR308W",743).
component("YLR307W",742).
component("YBR208C",243).
component("YMR281W",810).
component("U53_",138).
component("YIR027C",596).
component("YPL111W",955).
component("YIR032C",599).
component("YIR029W",597).
component("YPR062W",990).
component("YMR120C",790).
component("YLR028C",709).
component("YHR144C",563).
component("YGR267C",530).
component("YNL141W",830).
component("YBL033C",194).
component("YBR153W",237).
component("YDL238C",320).
component("YNL141W",831).
component("YLR245C",733).
component("YML035C",762).
component("YBR084W",222).
component("YJL126W",612).
component("U44_",129).
component("YDL100C",295).
component("U87_",170).
component("U40_",127).
component("YMR267W",807).
component("YBR011C",206).
component("YHR201C",566).
component("YBR111C",226).
component("YBR252W",250).
component("YCL030C",263).
component("YPR080W",995).
component("YOR187W",912).
component("YOR133W",904).
component("YLR069C",714).
component("YKR084C",698).
component("YKL173W",678).
component("YJL102W",610).
component("YDR385W",379).
component("YBR118W",229).
component("YER005W",409).
component("YLL001W",702).
component("YIL048W",575).
component("YER166W",441).
component("YDR093W",341).
component("YAL026C",185).
component("YLR231C",731).
component("U88_",171).
component("YLR134W",719).
component("YLR044C",711).
component("YGR087C",502).
component("YDR380W",378).
component("YDL080C",289).
component("U98_",180).
component("YMR250W",804).
component("YKL184W",683).
component("YOR128C",902).
component("YEL021W",401).
component("YNR043W",863).
component("U93_",177).
component("YDR047W",331).
component("U54_",139).
component("YKL211C",687) :- not remove_orf("YKL211C",687).
component("YKR097W",700).
component("YOL052C",875).
component("YNL169C",834).
component("YGR170W",511).
component("YKL060C",664).
component("YNL256W",843).
component("YDR294C",366).
component("YEL046C",403).
component("YNR033W",860).
component("YPR006C",984).
...
component("YPL281C",981).
component("YOR393W",944).
component("YMR323W",817).
component("YHR174W",565).
component("YGR254W",527).
component("YPL262W",973).
component("YGL026C",469) :- not remove_orf("YGL026C",469).
component("YGR155W",510).
component("YLR304C",739).
component("YJL200C",625).
component("YNL316C",852).
component("YKL182W",681).
component("YPL212C",965).
component("YNL292W",850).
component("YGL063W",475).
component("YFL001W",445).
component("YOR278W",926).
component("YPR002W",983).
component("U49_",133).
component("YJR016C",632).
component("YCR053W",275).
component("YDR127W",348).
component("YGL148W",480).
component("YIL168W",593).
...
component("YOR176W",910).
component("YJL121C",611).
component("YBR019C",209).
component("YBR019C",210).
component("YDR050C",332).
component("YDR007W",322) :- not remove_orf("YDR007W",322).
component("YOR095C",898).
component("YER003C",408).
component("YBR196C",242).
component("YGL001C",463).
component("U14_",49).
component("YOL056W",878).
component("YKL152C",676).
component("YDL021W",278).
component("YMR105C",785).
component("YKL127W",670).
component("YEL058W",406).
component("YPR060C",989).
component("YHR072W",553).
component("YJL153C",618).
component("YPL097W",953).
component("YGR185C",517).
component("YGR264C",529).
component("YGR171C",512).
component("YHR011W",543).
component("YDR023W",325).
component("YPL104W",954).
component("YLL018C",703).
component("YPR081C",996).
component("YBR121C",230).
component("YHR020W",546).
component("YER087W",431).
component("YNL247W",839).
component("YOL033W",873).
component("YGL245W",489).
component("YHR091C",555).
component("YDR341C",372).
component("YOL097C",885).
component("YDR268W",363).
component("YPR047W",988).
component("YLR060W",713).
component("YFL022C",449).
component("YPR033C",986).
component("YHR019C",544).
component("YCR024C",271).
component("YHR019C",545).
component("YPL160W",958).
component("YLR382C",752).
component("YNL073W",824).
component("YDR037W",327).
component("YOR335C",932).
component("YGR094W",504).
component("YOR317W",928).
component("YMR246W",803).
component("YIL009W",571).
component("YER015W",411).
component("YOR142W",906).
component("YGR244C",525).
component("YPR035W",987).
component("U89_",172).
component("YOR241W",923).
component("YMR113W",787).
component("YKL132C",671).
component("YOR339C",933).
component("YMR022W",780).
component("YLR306W",741).
component("YKL210W",686).
component("YGR133W",508).
component("YGL058W",473).
component("YER100W",437).
component("YEL012W",399).
component("YDR177W",353).
component("YDR092W",340).
component("YDR059C",335).
component("YDR054C",333).
component("YDL064W",285).
component("YBR082C",221).
component("YJL101C",609).
component("YOL049W",874).
component("U92_",176).
...
component("U91_",175).
component("U90_",174).
component("YNR057C",866).
component("YDL141W",302).
component("YDL141W",303).
component("YGL234W",488).
component("YDL141W",304).
component("YJR103W",643).
component("YBL039C",196).
component("YGR204W",521).
component("YBR084W",223).
component("YNL220W",837).
component("YOL058W",879).
component("YBR208C",244).
component("YHR074W",554).
component("YMR217W",800).
component("YGR061C",501).
component("YPR145W",1001).
component("YGR124W",507).
component("YOR303W",927).
component("YJR109C",646).
component("YJL130C",614).
component("YGL062W",474).
component("YBR218C",245).
component("YPL231W",971).
component("YNR016C",858).
component("YKL182W",682).
component("YGR037C",497).
component("YOR005C",893).
component("YDL164C",307).
component("YOL010W",870).
component("YPR138C",1000).
component("YPL274W",978).
component("YPL265W",974).
component("YPL134C",956).
component("YPL057C",950).
component("YPL036W",949).
component("YOR348C",937).
component("YOR222W",920).
component("YOR192C",914).
component("YOR171C",909).
component("YOR130C",903).
component("YOR071C",896).
component("YOL156W",892).
component("YOL103W",886).
component("YOL020W",872) :- not remove_orf("YOL020W",872).
component("YNR072W",868).
component("YNR056C",865).
component("YNL318C",853).
component("YNL268W",846).
component("YNL142W",832).
component("YMR272C",809).
component("YMR202W",797).
component("YMR011W",777).
component("YML123C",774).
component("YLR348C",747).
component("YLR260W",734).
component("YLR237W",732).
component("YLR138W",720).
component("YLR100C",717).
component("YLR081W",715).
component("YLL061W",706).
component("YLL043W",705).
component("YKR093W",699).
component("YKR053C",696).
component("YKR039W",695) :- not remove_orf("YKR039W",695).
component("YKL217W",690).
component("YKL120W",669).
component("YKL004W",658).
component("YJR158W",655).
component("YJR152W",653).
component("YJR095W",642).
component("YJR077C",640).
component("YJL219W",628).
component("YJL214W",626).
component("YJL134W",615).
component("YJL129C",613).
component("YIL134W",586).
component("YHR096C",558).
component("YHR094C",557).
component("YHR092C",556).
component("YHL036W",539).
component("YHL016C",537).
component("YGR121C",505).
component("YGR055W",499).
component("YGL186C",482).
component("YGL077C",477).
...
catalyst(8051,973).
catalyst(8052,973).
catalyst(3590,469) :- not remove_reaction(3590,469).
catalyst(10910,469) :- not remove_reaction(10910,469).
catalyst(4570,510).
catalyst(8181,739).
catalyst(8182,739).
catalyst(8181,625).
...
catalyst(1210,892).
catalyst(1160,886).
catalyst(801,872) :- not remove_reaction(801,872).
catalyst(802,872) :- not remove_reaction(802,872).
catalyst(811,872) :- not remove_reaction(811,872).
catalyst(812,872) :- not remove_reaction(812,872).
catalyst(831,872) :- not remove_reaction(831,872).
catalyst(832,872) :- not remove_reaction(832,872).
catalyst(901,872) :- not remove_reaction(901,872).
catalyst(902,872) :- not remove_reaction(902,872).
catalyst(941,872) :- not remove_reaction(941,872).
catalyst(942,872) :- not remove_reaction(942,872).
catalyst(1170,868).
catalyst(1180,868).
catalyst(1210,868).
catalyst(700,865).
...
catalyst(650,699).
catalyst(6560,696).
catalyst(761,695) :- not remove_reaction(761,695).
catalyst(762,695) :- not remove_reaction(762,695).
catalyst(771,695) :- not remove_reaction(771,695).
catalyst(772,695) :- not remove_reaction(772,695).
catalyst(781,695) :- not remove_reaction(781,695).
catalyst(782,695) :- not remove_reaction(782,695).
catalyst(791,695) :- not remove_reaction(791,695).
catalyst(792,695) :- not remove_reaction(792,695).
...
catalyst(821,695) :- not remove_reaction(821,695).
catalyst(822,695) :- not remove_reaction(822,695).
catalyst(831,695) :- not remove_reaction(831,695).
catalyst(832,695) :- not remove_reaction(832,695).
catalyst(841,695) :- not remove_reaction(841,695).
catalyst(842,695) :- not remove_reaction(842,695).
catalyst(861,695) :- not remove_reaction(861,695).
catalyst(862,695) :- not remove_reaction(862,695).
catalyst(881,695) :- not remove_reaction(881,695).
catalyst(882,695) :- not remove_reaction(882,695).
catalyst(901,695) :- not remove_reaction(901,695).
catalyst(902,695) :- not remove_reaction(902,695).
catalyst(911,695) :- not remove_reaction(911,695).
catalyst(912,695) :- not remove_reaction(912,695).
catalyst(921,695) :- not remove_reaction(921,695).
catalyst(922,695) :- not remove_reaction(922,695).
catalyst(941,695) :- not remove_reaction(941,695).
catalyst(942,695) :- not remove_reaction(942,695).
catalyst(1191,695) :- not remove_reaction(1191,695).
catalyst(1192,695) :- not remove_reaction(1192,695).
catalyst(390,690).
catalyst(1021,690).
catalyst(1022,690).
catalyst(1521,669).
...
catalyst(861,330) :- not remove_reaction(861,330).
catalyst(862,330) :- not remove_reaction(862,330).
