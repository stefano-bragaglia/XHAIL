...
component("YGR060W",171).
component("YGL012W",159).
component("YOL086C",281).
component("YMR303C",259).
component("YGL256W",167).
component("YDL168W",106).
component("YBR145W",81).
component("YPL231W",306).
component("YGL001C",156).
component("YML056C",245).
component("YLR432W",242).
component("YHR216W",188).
component("YAR075W",69).
component("YAR073W",68).
component("YDR127W",117).
component("YJR139C",215).
component("YOR136W",286).
component("YIL155C",192).
component("YJR078W",209).
component("YJR025C",205).
component("YMR015C",249).
component("YDR402C",131).
component("YJR104C",212).
component("YHR008C",182).
component("YER070W",144).
component("YDL168W",107).
component("YGL154C",165).
component("YOR323C",294).
component("YMR170C",255).
component("YMR169C",254).
component("YBR166C",84).
component("YER014W",141).
component("YMR118C",253).
component("YLR164W",236).
component("YLL041C",232).
component("YKL148C",223).
component("YJL045W",196).
component("YDR178W",123).
component("YJR051W",206).
component("YEL047C",139).
component("YOR375C",299).
component("YDL215C",108).
component("YAL062W",67).
component("YER023W",142).
component("YOR236W",293).
component("YGR204W",177).
component("U62_",49).
component("YPL017C",302).
component("YFL018C",148).
component("U47_",43).
component("YKL024C",218).
component("YPR074C",318).
component("YBR117C",80).
component("YCL009C",94).
component("YMR062C",251).
component("YPL231W",307).
component("YPL001W",301).
component("YPL231W",308).
component("YPL028W",303).
component("YPR001W",313).
component("YNR001C",271).
component("YNL117W",265).
component("YIR031C",194).
component("YNL029C",261).
component("YIL085C",190).
component("YLR209C",237).
component("YER055C",143).
component("YDR354W",127) :- not remove_orf("YDR354W",127).
component("YFR047C",154).
component("YJR133W",214).
component("YML022W",243).
component("YDR441C",133).
component("YDR399W",129).
component("YDR127W",118).
component("YJR130C",213).
component("YDR035W",113).
component("YBR249C",88).
component("YBR256C",89).
component("YHR137W",184).
component("YLR027C",233).
component("YKL106W",220).
component("YGR019W",169).
component("U64_",50).
component("U51_",45).
component("YJR148W",216).
component("YGL253W",166).
component("YFR053C",155).
component("YMR205C",257).
component("YGR240C",178).
component("YCR036W",99).
component("YCL040W",96).
component("U16_",26).
component("U15_",24).
component("YKL001C",217).
component("YML070W",246).
component("YFL053W",150).
component("U83_",60).
component("U82_",59).
component("YMR208W",258).
component("YOR347C",298).
component("YAL038W",66).
component("YPR121W",320).
component("YPL258C",310).
component("YOL055C",278).
component("U1_",34).
component("YNL267W",269).
component("YLR305C",241).
component("YFR019W",152).
...
component("U18_",31).
component("U76_",58).
component("YDR454C",134).
component("YOL061W",280).
component("YKL181W",224).
component("YHL011C",180).
component("YER099C",147).
component("YBL068W",72).
component("YOR143C",287).
component("YGR007W",168).
component("YCL050C",97).
component("YPR190C",323).
component("YPR187W",322).
component("YPR110C",319).
component("YPR010C",314).
component("YOR341W",297).
component("YOR340C",296).
component("YOR224C",292).
component("YOR210W",291).
component("YOR207C",289).
component("YOR151C",288).
component("YOR116C",285).
component("YOL005C",275).
component("YNR003C",272).
component("YNL248C",268).
component("YNL151C",267).
component("YNL113W",264).
component("YKL144C",222).
component("YJR063W",207).
component("YJL148W",203).
component("YJL140W",202).
component("YIL021W",189).
component("YHR143W-A",185).
component("YGL070C",163).
component("YFL036W",149).
component("YDR404C",132).
component("YDR156W",122).
component("YDR045C",114).
component("YDL150W",104).
component("YDL140C",103).
component("YBR154C",83).
component("YKL035W",219).
component("YHL012W",181).
component("YDR058C",116).
component("YDL086W",102).
component("YOL011W",276).
component("YMR008C",248).
component("YMR006C",247).
component("U101_",18).
component("YBL015W",70).
component("U84_",61).
component("YPR073C",316).
component("YHR215W",187).
component("YDL024C",100).
component("YBR093C",78).
component("YBR092C",77).
component("YPL228W",305).
component("YMR180C",256).
component("YDL236W",110).
component("YJL155C",204).
component("YPR073C",317).
component("YOR208W",290).
component("YNL053W",263).
component("YMR036C",250).
component("YIR026C",193).
component("YIL113W",191).
component("YFR028C",153).
component("YER075C",145).
component("YDL230W",109).
component("YBR276C",90).
component("U34_",41).
component("U30_",40).
component("U24_",39).
component("YKR031C",229).
component("YLR286C",240).
component("YDR400W",130).
component("YML035C",244).
component("YJL070C",197).
component("YBR284W",91).
component("YNL045W",262).
component("YGL037C",161).
component("YBR208C",85).
component("U53_",46).
component("YIR032C",195).
component("YBR153W",82).
component("YDL238C",111).
component("YLR245C",239).
component("YJL126W",199).
component("YBR111C",79).
component("YER005W",140).
component("YLR231C",238).
component("U88_",62).
component("YLR134W",235).
component("YLR044C",234).
...
component("YGR170W",176).
component("YDR294C",125).
component("YNR033W",274).
component("YKL211C",228) :- not remove_orf("YKL211C",228).
component("YER090W",228) :- not remove_orf("YER090W",228).
component("YER090W",146) :- not remove_orf("YER090W",146).
component("YDR127W",120).
component("YPL281C",312).
component("YOR393W",300).
component("YMR323W",260).
component("YHR174W",186).
component("YGR254W",179).
component("YGL026C",160) :- not remove_orf("YGL026C",160).
component("YGR155W",175).
component("YNL316C",270).
component("YKL182W",225).
component("YDR127W",121).
component("YGL148W",164).
component("YAL012W",65).
component("YBR019C",73).
component("YDR007W",112) :- not remove_orf("YDR007W",112).
component("YOR095C",284).
component("YGL001C",157).
component("YMR105C",252).
component("YKL127W",221).
component("YPR060C",315).
component("YOL097C",282).
component("YOR335C",295).
component("YGR094W",173).
component("U89_",63).
component("YJL101C",198).
component("YJR103W",211).
component("YBL039C",71).
component("YOL058W",279).
component("YBR208C",86).
component("YHR074W",183).
component("YGL062W",162).
component("YBR218C",87).
component("YPL231W",309).
component("YNR016C",273).
component("YKL182W",226).
component("YGR037C",170).
component("YOR005C",283).
component("YDL164C",105).
component("YPR138C",321).
component("YPL265W",311).
component("YPL036W",304).
component("YOL020W",277) :- not remove_orf("YOL020W",277).
component("YNL142W",266).
component("YKR053C",231).
component("YKR039W",230) :- not remove_orf("YKR039W",230).
component("YJR095W",210).
component("YJR077C",208).
component("YJL134W",201).
component("YJL129C",200).
component("YGR121C",174).
component("YGL008C",158).
component("YFL055W",151).
component("YEL017C-A",138).
...
catalyst(5612,237).
catalyst(3870,143).
catalyst(3620,127) :- not remove_reaction(3620,127).
catalyst(2190,154).
catalyst(5550,214).
catalyst(5650,243).
catalyst(5650,133).
...
catalyst(2300,64).
catalyst(3460,47).
catalyst(3600,227) :- not remove_reaction(3600,227).
catalyst(6900,176).
catalyst(8781,125).
catalyst(8782,125).
catalyst(2550,274).
catalyst(3630,228) :- not remove_reaction(3630,228).
catalyst(3630,146) :- not remove_reaction(3630,146).
catalyst(3740,120).
catalyst(8231,312).
catalyst(8232,312).
catalyst(8231,300).
...
catalyst(1192,311).
catalyst(220,304).
catalyst(801,277) :- not remove_reaction(801,277).
catalyst(802,277) :- not remove_reaction(802,277).
catalyst(811,277) :- not remove_reaction(811,277).
catalyst(812,277) :- not remove_reaction(812,277).
catalyst(831,277) :- not remove_reaction(831,277).
catalyst(832,277) :- not remove_reaction(832,277).
catalyst(371,266).
catalyst(372,266).
catalyst(6560,231).
catalyst(771,230) :- not remove_reaction(771,230).
catalyst(772,230) :- not remove_reaction(772,230).
catalyst(781,230) :- not remove_reaction(781,230).
catalyst(782,230) :- not remove_reaction(782,230).
...
catalyst(881,230) :- not remove_reaction(881,230).
catalyst(882,230) :- not remove_reaction(882,230).
catalyst(1191,230) :- not remove_reaction(1191,230).
catalyst(1192,230) :- not remove_reaction(1192,230).
catalyst(1250,210).
catalyst(1581,208).
catalyst(1582,208).
catalyst(6560,201).
