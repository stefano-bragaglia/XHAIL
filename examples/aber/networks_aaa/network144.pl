...
component("YNL280C",762).
component("YLR056W",645).
component("YGR060W",453).
component("YGL012W",421).
component("YKR009C",628).
component("YOL086C",793).
component("YMR303C",731).
component("YMR083W",704).
component("YGL256W",445).
component("YDL168W",276).
component("YBR145W",207).
component("YPL231W",868).
component("YBR265W",226).
component("U46_",115).
component("YBR149W",208).
component("YBR149W",209).
component("YJR159W",596).
component("YGL001C",418).
component("YIL094C",528).
component("YHR063C",501).
component("YBR153W",210).
component("YML056C",689).
component("YLR432W",681).
component("YHR216W",518).
component("YAR075W",169).
component("YAR073W",168).
component("YCL030C",235).
component("YDR127W",308).
component("YJR139C",590).
component("YOL126C",798).
component("YKL085W",606).
component("YDL078C",257).
component("YKL029C",601).
component("YOR136W",812).
component("YNL037C",736).
component("YDL066W",256).
component("YNL241C",752).
component("YOL059W",791).
component("YDL022W",250).
component("YLR355C",677).
component("YIL074C",526).
component("YER081W",388).
component("YML054C",688).
component("YDL174C",278).
component("YML086C",692).
component("YIL155C",534).
component("YPR191W",905).
component("YOR065W",804).
component("YJL166W",564).
component("YHR001W-A",490).
component("YGR183C",468).
component("YFR033C",414).
component("YDR529C",354).
component("YBL045C",175).
component("Q0105",18).
component("YGR088W",456).
component("YDR256C",323).
component("YKL026C",600).
component("YIR037W",544).
component("YBR244W",222).
component("YJR078W",581).
component("YJR025C",573).
component("YGR255C",480).
component("U108_",22).
component("YBL098W",179).
component("YMR015C",701).
component("YHR007C",491).
component("YDR402C",343).
component("YGL055W",428).
component("YGR175C",465).
component("YJR104C",584).
component("YHR008C",492).
component("YJL026W",547).
component("YIL066C",525).
component("YGR180C",467).
component("YER070W",385).
component("U38_",110).
component("U36_",109).
component("U35_",108).
component("YDL168W",277).
component("YDR158W",316).
component("YBR006W",182).
component("YPL276W",880).
component("YPL275W",879).
component("YOR388C",845).
component("YOR374W",842).
component("YER073W",386).
component("U68_",132).
component("YGL154C",436).
component("U55_",124).
component("YOR323C",834).
component("YMR170C",714).
component("YMR169C",713).
component("U2_",103).
component("YER178W",401).
component("YBR221C",220).
component("YIL125W",532).
component("U52_",121).
component("YBR166C",213).
component("YNL280C",763).
component("YGL012W",422).
component("YKL182W",618).
component("U57_",126).
component("YKL216W",625).
component("YDR044W",295).
component("YER014W",369).
component("YKR009C",629).
component("YIL160C",536).
component("YGL205W",439).
component("YMR118C",709).
component("YLR164W",658).
component("YLL041C",638).
component("YKL148C",613).
component("YKL141W",611).
component("YJL045W",548).
component("YDR178W",317).
component("YJR051W",576).
component("YEL047C",363).
component("YDL215C",282).
component("YOR375C",843).
component("YDL215C",283).
component("YAL062W",166).
component("U99_",160).
component("YBR035C",192).
component("YMR189W",716).
component("U56_",125).
component("YHR037W",498).
component("YKR080W",633).
component("YER023W",371).
component("YPL023C",849).
component("YGL125W",433).
component("YOR236W",827).
component("YGR204W",472).
component("YLR142W",653).
component("U63_",130).
component("U62_",129).
component("YKL150W",614).
component("YIL043C",522).
component("YHR042W",499).
component("YOR221C",825).
component("YML120C",695).
component("YKL192C",622).
component("YKL055C",603).
component("YER061C",380).
component("YGR234W",475).
component("YFR030W",413).
component("YPL017C",848).
component("YFL018C",405).
component("YDR353W",338).
component("YER042W",373).
component("YJR137C",589).
component("YPL266W",875).
component("YML110C",694).
component("YBR034C",191).
component("YPL273W",877).
component("YLL062C",641).
component("YDR410C",346).
component("U47_",116).
component("YER091C",393).
component("YJR073C",579).
component("YDR120C",306).
component("YDL033C",252).
component("YOL096C",794).
component("YLR172C",659).
component("YDR019C",291).
component("YBR176W",214).
component("YDR408C",345).
component("YMR120C",710).
component("YBL013W",170).
component("YKL024C",599).
component("YPR074C",894).
component("YBR117C",203).
component("YLR354C",676).
component("YGR043C",451).
component("YMR108W",707).
component("YCL009C",233).
component("YMR062C",703).
component("YNL071W",739).
component("YNR008W",770).
component("YIL160C",537).
component("YNL277W",761).
component("YFL017C",404).
component("YPL231W",869).
component("YER061C",381).
component("U86_",148).
component("YPL001W",847).
component("YMR296C",729).
component("YDR062W",301).
component("YDL052C",255).
component("U8_",152).
component("YDR148C",314).
component("YOR377W",844).
component("YGR177C",466).
component("YPL231W",870).
component("YGR147C",461).
component("YDL040C",253).
component("YPL028W",850).
component("YGL017W",423).
component("YPR001W",882).
component("YNR001C",768).
component("YCR005C",240).
component("YDL182W",279).
component("YDL131W",267).
component("YNL117W",743).
component("YIR031C",542).
component("YOR321W",833).
component("YJR143C",591).
component("YGR199W",471).
component("YDR307W",332).
component("YDL095W",262).
component("YDL093W",261).
component("YAL023C",163).
component("YOR103C",808).
component("YOR085W",806).
component("YMR149W",712).
component("YML019W",684).
component("YJL002C",545).
component("YEL002C",358).
component("YDL232W",285).
component("YCL043C",238).
component("YNL029C",735).
component("YIL085C",527).
component("YMR261C",724).
component("YML100W",693).
component("YBR126C",206).
component("YNL192W",751).
component("YBR038W",194).
component("YBR023C",190).
component("YMR306W",733).
component("YLR342W",674).
component("YGR032W",449).
component("YLR209C",660).
component("U104_",21).
component("YOR209C",823).
component("YMR300C",730).
component("YER055C",376).
component("YDR354W",339) :- not remove_orf("YDR354W",339).
component("YFR047C",415).
component("YJR133W",588).
component("YLR209C",661).
component("YML022W",685).
component("YDR441C",349).
component("YDR399W",341).
component("YPR176C",902).
component("YPL172C",860).
component("YNR041C",776).
component("YMR101C",705).
component("YDL090C",260).
component("YBR003W",181).
component("YBR002C",180).
component("YJL167W",565).
component("YJL167W",566).
component("YNL256W",755).
component("YPR069C",891).
component("YDR127W",309).
component("YLR303W",668).
component("YGR012W",447).
component("YJR130C",587).
component("YLR303W",669).
component("YDR035W",293).
component("YBR249C",223).
component("YOR274W",829).
component("YOL143C",800).
component("YBR256C",225).
component("YHR137W",510).
component("YGL202W",438).
component("YLR027C",642).
component("YKL106W",608).
component("YKL104C",607).
component("YGR019W",448).
component("YLR089C",648).
component("U64_",131).
component("U61_",128).
component("U51_",120).
component("YJR148W",592).
component("YHR208W",516).
component("YOR184W",818).
component("YNR058W",779).
component("YIL116W",531).
component("YGL253W",444).
component("YFR053C",416).
component("YOL136C",799).
component("YIL107C",529).
component("YMR013C",700).
component("YMR205C",717).
component("YGR240C",476).
component("YDR248C",322).
component("YCR036W",246).
component("YGR194C",470).
component("YCL040W",237).
component("YJR105W",585).
component("U16_",56).
component("U15_",50).
component("YPL188W",862).
component("YJR049C",575).
component("YEL041W",361).
component("U96_",158).
component("YKL001C",597).
component("YDR236C",320).
component("YML070W",691).
component("YFL053W",408).
component("YHL032C",488).
component("YLR133W",650).
component("YDR531W",356).
component("U83_",146).
component("U82_",145).
component("U81_",144).
component("YMR208W",718).
component("YPL203W",863).
component("YOR061W",803).
component("YKL166C",616).
component("YJL164C",563).
component("YIL035C",521).
component("YHR205W",515).
component("YHR102W",508).
component("YGL019W",424).
component("YHR025W",497).
component("YOR347C",839).
component("YAL038W",165).
component("YNR012W",771).
component("YPR121W",898).
component("YPL258C",872).
component("YOL055C",787).
component("YPL214C",866).
component("U1_",79).
component("YDR009W",290).
component("YBR020W",188).
component("YNL267W",759).
component("YLR305C",671).
component("YFR019W",411).
component("YDR208W",318).
component("YDR127W",310).
component("U21_",90).
component("U20_",87).
component("YDR147W",313).
component("YDR300C",331).
component("YCR012W",241).
component("YER052C",374).
component("YER069W",384).
component("U18_",71).
component("U17_",64).
component("U76_",140).
component("YMR220W",720).
component("YER170W",400).
component("YDR226W",319).
component("YKL067W",605).
component("YOL055C",788).
component("YDR454C",350).
component("YJR057W",577).
component("YOL061W",792).
component("YKL181W",617).
component("YHL011C",485).
component("YER099C",395).
component("YBL068W",178).
component("YOR143C",814).
component("YNL256W",756).
component("YLR328W",672).
component("YBR018C",184).
component("YBR018C",185).
component("YGR007W",446).
component("YLR328W",673).
component("YKR002W",627).
component("YDL103C",265).
component("U94_",157).
component("YJR010W",572).
component("YGL130W",434).
component("YDR530C",355).
component("YCL050C",239).
component("YPR190C",904).
component("YPR187W",903).
component("YPR110C",896).
component("YPR010C",885).
component("YOR341W",838).
component("YOR340C",837).
component("YOR224C",826).
component("YOR210W",824).
component("YOR207C",821).
component("YOR151C",815).
component("YOR116C",809).
component("YOL005C",781).
component("YNR003C",769).
component("YNL248C",754).
component("YNL151C",748).
component("YNL113W",742).
component("YKL144C",612).
component("YJR063W",578).
component("YJL148W",560).
component("YJL140W",559).
component("YIL021W",520).
component("YHR143W-A",511).
component("YGL070C",431).
component("YFL036W",407).
component("YDR404C",344).
component("YDR156W",315).
component("YDR045C",296).
component("YDL150W",274).
component("YDL140C",269).
component("YBR154C",212).
component("YPR175W",901).
component("YPL167C",859).
component("YOR330C",835).
component("YOL115W",797).
component("YNL299W",765).
component("YNL262W",758).
component("YNL102W",741).
component("YJR043C",574).
component("YJR006W",571).
component("YJL090C",552).
component("YIL139C",533).
component("YEL055C",364).
component("YDR419W",347).
component("YDR121W",307).
component("YDL102W",264).
component("YCR014C",242).
component("YBR278W",228).
component("YBL035C",172).
component("YKL035W",602).
component("YHL012W",486).
component("YHR123W",509).
component("YPR113W",897).
component("YBR243C",221).
component("YNL130C",744).
component("YDL142C",273).
component("YPL148C",857).
component("YER026C",372).
component("YCL004W",232).
component("YGR286C",484).
component("YJL068C",549).
component("YDR058C",300).
component("YNR034W",775).
component("YHR163W",513).
component("YGR248W",478).
component("YCR073W-A",247).
component("YDL086W",259).
component("YOL011W",783).
component("YMR008C",698).
component("YMR006C",697).
component("U101_",19).
component("YBL015W",171).
component("YJL068C",550).
component("YPL072W",853).
component("YOR124C",810).
component("YNL186W",750).
component("YMR304W",732).
component("YMR223W",721).
component("YKR098C",636).
component("YJL197W",567).
component("YIL156W",535).
component("YFR010W",410).
component("YER151C",398).
component("YER144C",397).
component("YER098W",394).
component("YDR069C",302).
component("YDL122W",266).
component("YBR058C",195).
component("YBL067C",177).
component("YDR272W",326).
component("U84_",147).
component("YLR377C",679).
component("YDR074W",303).
component("YPL179W",861).
component("YNR032W",773).
component("YML057W",690).
component("YML016C",683).
component("YLR433C",682).
component("YGR123C",459).
component("YER133W",396).
component("YER089C",391).
component("YDR436W",348).
component("YDR075W",304).
component("YDL188C",280).
component("YDL134C",268).
component("YDL047W",254).
component("YDL006W",248).
component("YBR125C",205).
component("YBL056W",176).
component("YPR073C",892).
component("YHR215W",517).
component("YDL024C",251).
component("YBR093C",201).
component("YBR092C",200).
component("YAR071W",167).
component("YIL053W",524).
component("YER062C",382).
component("YHR046C",500).
component("U9_",161).
component("YGR208W",474).
component("YPL228W",867).
component("YMR180C",715).
component("YDL236W",286).
component("YJL155C",562).
component("YPR073C",893).
component("YOR208W",822).
component("YNL053W",738).
component("YMR036C",702).
component("YIR026C",539).
component("YIL113W",530).
component("YFR028C",412).
component("YER075C",387).
component("YDL230W",284).
component("YBR276C",227).
component("U34_",107).
component("U33_",106).
component("U32_",105).
component("U30_",104).
...
component("U25_",100).
component("U24_",99).
component("YPL268W",876).
component("YOR360C",841).
component("YGL248W",443).
component("YKR031C",630).
component("YPL206C",864).
component("YGL027C",426).
component("YLR286C",666).
component("YJR153W",594).
component("YBR184W",215).
component("YOR190W",819).
component("YLR300W",667).
component("YGR282C",483).
component("YDR261C",324).
component("YDR400W",342).
component("U23_",98).
component("YML035C",686).
component("YJL070C",551).
component("YBR284W",229).
component("U102_",20).
component("YNL045W",737).
component("YLR160C",657).
component("YLR158C",656).
component("YLR157C",655).
component("YLR155C",654).
component("YDR321W",333).
component("YGL037C",427).
component("YMR293C",728).
component("YDR242W",321).
component("YBR208C",217).
component("YMR281W",727).
component("U53_",122).
component("YIR027C",540).
component("YPL111W",856).
component("YIR032C",543).
component("YIR029W",541).
component("YPR062W",890).
component("YMR120C",711).
component("YLR028C",643).
component("YHR144C",512).
component("YGR267C",482).
component("YNL141W",745).
component("YBR153W",211).
component("YDL238C",287).
component("YNL141W",746).
component("YLR245C",664).
component("YML035C",687).
component("YBR084W",198).
component("YJL126W",555).
component("U44_",114).
component("YDL100C",263).
component("U87_",149).
component("U40_",112).
component("YMR267W",725).
component("YBR011C",183).
component("YBR111C",202).
component("YBR252W",224).
component("YCL030C",236).
component("YER005W",368).
component("YIL048W",523).
component("YER166W",399).
component("YDR093W",305).
component("YAL026C",164).
component("YLR231C",662).
component("U88_",150).
component("YLR134W",651).
component("YLR044C",644).
component("YGR087C",455).
component("YDR380W",340).
component("YDL080C",258).
component("U98_",159).
component("YMR250W",723).
component("YKL184W",621).
component("YEL021W",360).
component("YNR043W",777).
component("U93_",156).
component("YDR047W",298).
component("U54_",123).
component("YKL211C",623) :- not remove_orf("YKL211C",623).
component("YKR097W",635).
component("YOL052C",786).
component("YNL169C",749).
component("YGR170W",463).
component("YKL060C",604).
component("YNL256W",757).
component("YDR294C",328).
component("YEL046C",362).
component("YNR033W",774).
component("YPR006C",884).
component("YER065C",383).
component("YKL211C",624) :- not remove_orf("YKL211C",624).
component("YER090W",624) :- not remove_orf("YER090W",624).
component("YER090W",392) :- not remove_orf("YER090W",392).
component("YDR127W",311).
component("YPL281C",881).
component("YOR393W",846).
component("YMR323W",734).
component("YHR174W",514).
component("YGR254W",479).
component("YPL262W",873).
component("YGL026C",425) :- not remove_orf("YGL026C",425).
component("YGR155W",462).
component("YLR304C",670).
component("YJL200C",568).
component("YNL316C",766).
component("YKL182W",619).
component("YPL212C",865).
component("YNL292W",764).
component("YGL063W",430).
component("YFL001W",402).
component("YOR278W",830).
component("YPR002W",883).
component("U49_",117).
component("YDR127W",312).
component("YGL148W",435).
component("YIL168W",538).
component("YER086W",389).
component("YLR359W",678).
component("YAL012W",162).
component("YFR055W",417).
component("YJL005W",546).
component("YOR176W",817).
component("YJL121C",554).
component("YBR019C",186).
component("YBR019C",187).
component("YDR050C",299).
component("YDR007W",289) :- not remove_orf("YDR007W",289).
component("YOR095C",807).
component("YER003C",367).
component("YBR196C",216).
component("YGL001C",419).
component("U14_",43).
component("YOL056W",789).
component("YKL152C",615).
component("YDL021W",249).
component("YMR105C",706).
component("YKL127W",609).
component("YEL058W",365).
component("YPR060C",889).
component("YHR072W",502).
component("YJL153C",561).
component("YPL097W",854).
component("YGR185C",469).
component("YGR264C",481).
component("YGR171C",464).
component("YHR011W",493).
component("YDR023W",292).
component("YPL104W",855).
component("YLL018C",637).
component("YPR081C",895).
component("YBR121C",204).
component("YHR020W",496).
component("YER087W",390).
component("YNL247W",753).
component("YOL033W",785).
component("YGL245W",442).
component("YHR091C",504).
component("YDR341C",334).
component("YOL097C",795).
component("YDR268W",325).
component("YPR047W",888).
component("YLR060W",646).
component("YFL022C",406).
component("YPR033C",886).
component("YHR019C",494).
component("YCR024C",243).
component("YHR019C",495).
component("YPL160W",858).
component("YLR382C",680).
component("YNL073W",740).
component("YDR037W",294).
component("YOR335C",836).
component("YGR094W",457).
component("YOR317W",832).
component("YMR246W",722).
component("YIL009W",519).
component("YER015W",370).
component("YOR142W",813).
component("YGR244C",477).
component("YPR035W",887).
component("U89_",151).
component("YOR241W",828).
component("YMR113W",708).
component("YKL132C",610).
component("YJL101C",553).
component("U92_",155).
component("YGL234W",440).
component("U91_",154).
component("U90_",153).
component("YDL141W",270).
component("YDL141W",271).
component("YGL234W",441).
component("YDL141W",272).
component("YJR103W",583).
component("YBL039C",173).
component("YGR204W",473).
component("YBR084W",199).
component("YOL058W",790).
component("YBR208C",218).
component("YHR074W",503).
component("YMR217W",719).
component("YGR061C",454).
component("YPR145W",900).
component("YGR124W",460).
component("YOR303W",831).
component("YJR109C",586).
component("YJL130C",557).
component("YGL062W",429).
component("YBR218C",219).
component("YPL231W",871).
component("YNR016C",772).
component("YKL182W",620).
component("YGR037C",450).
component("YOR005C",802).
component("YDL164C",275).
component("YOL010W",782).
component("YPR138C",899).
component("YPL274W",878).
component("YPL265W",874).
component("YPL057C",852).
component("YPL036W",851).
component("YOR348C",840).
component("YOR192C",820).
component("YOR171C",816).
component("YOR130C",811).
component("YOR071C",805).
component("YOL156W",801).
component("YOL103W",796).
component("YOL020W",784) :- not remove_orf("YOL020W",784).
component("YNR072W",780).
component("YNR056C",778).
component("YNL318C",767).
component("YNL268W",760).
component("YNL142W",747).
component("YMR272C",726).
component("YMR011W",699).
component("YML123C",696).
component("YLR348C",675).
component("YLR260W",665).
component("YLR237W",663).
component("YLR138W",652).
component("YLR100C",649).
component("YLR081W",647).
component("YLL061W",640).
component("YLL043W",639).
component("YKR093W",634).
component("YKR053C",632).
component("YKR039W",631) :- not remove_orf("YKR039W",631).
component("YKL217W",626).
component("YKL004W",598).
component("YJR158W",595).
component("YJR152W",593).
component("YJR095W",582).
component("YJR077C",580).
component("YJL219W",570).
component("YJL214W",569).
component("YJL134W",558).
component("YJL129C",556).
component("YHR096C",507).
component("YHR094C",506).
component("YHR092C",505).
component("YHL036W",489).
component("YHL016C",487).
component("YGR121C",458).
component("YGR055W",452).
component("YGL186C",437).
component("YGL077C",432).
component("YGL008C",420).
component("YFL055W",409).
component("YFL011W",403).
component("YER060W-A",379).
component("YER060W",378).
component("YER056C",377).
component("YER053C",375).
component("YEL069C",366).
component("YEL017C-A",359).
component("YDR536W",357).
component("YDR508C",353).
component("YDR503C",352).
component("YDR497C",351).
component("YDR345C",337).
component("YDR343C",336).
component("YDR342C",335).
component("YDR297W",330).
component("YDR294C",329).
component("YDR284C",327).
component("YDR046C",297) :- not remove_orf("YDR046C",297).
component("YDL245C",288).
component("YDL210W",281).
component("YCR032W",245).
component("YCR024C-A",244).
component("YCL025C",234).
component("YBR298C",231).
component("YBR291C",230).
component("YBR069C",197) :- not remove_orf("YBR069C",197).
component("YBR068C",196) :- not remove_orf("YBR068C",196).
component("YBR036C",193).
component("YBR021W",189).
component("YBL042C",174).
component("U7_",143).
component("U79_",142).
component("U78_",141).
component("U75_",139).
...
catalyst(6160,730).
catalyst(3870,376).
catalyst(3620,339) :- not remove_reaction(3620,339).
catalyst(2110,415).
catalyst(2190,415).
catalyst(5550,588).
catalyst(5791,661).
...
catalyst(1960,298).
catalyst(3460,123).
catalyst(3600,623) :- not remove_reaction(3600,623).
catalyst(8000,635).
catalyst(3941,786).
catalyst(3942,786).
catalyst(6890,749).
...
catalyst(8020,884).
catalyst(8020,383).
catalyst(1890,624) :- not remove_reaction(1890,624).
catalyst(3630,624) :- not remove_reaction(3630,624).
catalyst(1890,392) :- not remove_reaction(1890,392).
catalyst(3630,392) :- not remove_reaction(3630,392).
catalyst(3740,311).
catalyst(8231,881).
catalyst(8232,881).
catalyst(8231,846).
...
catalyst(8051,873).
catalyst(8052,873).
catalyst(3590,425) :- not remove_reaction(3590,425).
catalyst(10910,425) :- not remove_reaction(10910,425).
catalyst(4570,462).
catalyst(8181,670).
catalyst(8182,670).
catalyst(8181,568).
...
catalyst(8281,299).
catalyst(8282,299).
catalyst(3610,289) :- not remove_reaction(3610,289).
catalyst(7921,807).
catalyst(7922,807).
catalyst(7841,367).
catalyst(7842,367).
...
catalyst(1210,801).
catalyst(1160,796).
catalyst(801,784) :- not remove_reaction(801,784).
catalyst(802,784) :- not remove_reaction(802,784).
catalyst(811,784) :- not remove_reaction(811,784).
catalyst(812,784) :- not remove_reaction(812,784).
catalyst(831,784) :- not remove_reaction(831,784).
catalyst(832,784) :- not remove_reaction(832,784).
catalyst(901,784) :- not remove_reaction(901,784).
catalyst(902,784) :- not remove_reaction(902,784).
catalyst(941,784) :- not remove_reaction(941,784).
catalyst(942,784) :- not remove_reaction(942,784).
catalyst(1210,780).
catalyst(700,778).
catalyst(1200,767).
catalyst(761,760).
...
catalyst(640,634).
catalyst(6560,632).
catalyst(761,631) :- not remove_reaction(761,631).
catalyst(762,631) :- not remove_reaction(762,631).
catalyst(771,631) :- not remove_reaction(771,631).
catalyst(772,631) :- not remove_reaction(772,631).
catalyst(781,631) :- not remove_reaction(781,631).
catalyst(782,631) :- not remove_reaction(782,631).
catalyst(791,631) :- not remove_reaction(791,631).
catalyst(792,631) :- not remove_reaction(792,631).
catalyst(801,631) :- not remove_reaction(801,631).
catalyst(802,631) :- not remove_reaction(802,631).
catalyst(811,631) :- not remove_reaction(811,631).
catalyst(812,631) :- not remove_reaction(812,631).
catalyst(821,631) :- not remove_reaction(821,631).
catalyst(822,631) :- not remove_reaction(822,631).
catalyst(831,631) :- not remove_reaction(831,631).
catalyst(832,631) :- not remove_reaction(832,631).
catalyst(841,631) :- not remove_reaction(841,631).
catalyst(842,631) :- not remove_reaction(842,631).
catalyst(861,631) :- not remove_reaction(861,631).
catalyst(862,631) :- not remove_reaction(862,631).
catalyst(881,631) :- not remove_reaction(881,631).
catalyst(882,631) :- not remove_reaction(882,631).
catalyst(901,631) :- not remove_reaction(901,631).
catalyst(902,631) :- not remove_reaction(902,631).
catalyst(911,631) :- not remove_reaction(911,631).
catalyst(912,631) :- not remove_reaction(912,631).
catalyst(921,631) :- not remove_reaction(921,631).
catalyst(922,631) :- not remove_reaction(922,631).
catalyst(941,631) :- not remove_reaction(941,631).
catalyst(942,631) :- not remove_reaction(942,631).
catalyst(1191,631) :- not remove_reaction(1191,631).
catalyst(1192,631) :- not remove_reaction(1192,631).
catalyst(1021,626).
catalyst(1022,626).
catalyst(6610,598).
catalyst(1210,595).
...
catalyst(6550,329).
catalyst(6690,327).
catalyst(791,297) :- not remove_reaction(791,297).
catalyst(792,297) :- not remove_reaction(792,297).
catalyst(801,297) :- not remove_reaction(801,297).
catalyst(802,297) :- not remove_reaction(802,297).
catalyst(811,297) :- not remove_reaction(811,297).
catalyst(812,297) :- not remove_reaction(812,297).
catalyst(831,297) :- not remove_reaction(831,297).
catalyst(832,297) :- not remove_reaction(832,297).
catalyst(841,297) :- not remove_reaction(841,297).
catalyst(842,297) :- not remove_reaction(842,297).
catalyst(861,297) :- not remove_reaction(861,297).
catalyst(862,297) :- not remove_reaction(862,297).
catalyst(901,297) :- not remove_reaction(901,297).
catalyst(902,297) :- not remove_reaction(902,297).
catalyst(1210,288).
catalyst(690,281).
catalyst(730,281).
catalyst(431,245).
...
catalyst(1511,230).
catalyst(1512,230).
catalyst(771,197) :- not remove_reaction(771,197).
catalyst(772,197) :- not remove_reaction(772,197).
catalyst(791,197) :- not remove_reaction(791,197).
catalyst(792,197) :- not remove_reaction(792,197).
catalyst(801,197) :- not remove_reaction(801,197).
catalyst(802,197) :- not remove_reaction(802,197).
catalyst(811,197) :- not remove_reaction(811,197).
catalyst(812,197) :- not remove_reaction(812,197).
catalyst(861,197) :- not remove_reaction(861,197).
catalyst(862,197) :- not remove_reaction(862,197).
catalyst(901,197) :- not remove_reaction(901,197).
catalyst(902,197) :- not remove_reaction(902,197).
catalyst(791,196) :- not remove_reaction(791,196).
catalyst(792,196) :- not remove_reaction(792,196).
catalyst(801,196) :- not remove_reaction(801,196).
catalyst(802,196) :- not remove_reaction(802,196).
catalyst(811,196) :- not remove_reaction(811,196).
catalyst(812,196) :- not remove_reaction(812,196).
catalyst(831,196) :- not remove_reaction(831,196).
catalyst(832,196) :- not remove_reaction(832,196).
catalyst(841,196) :- not remove_reaction(841,196).
catalyst(842,196) :- not remove_reaction(842,196).
catalyst(861,196) :- not remove_reaction(861,196).
catalyst(862,196) :- not remove_reaction(862,196).
catalyst(901,196) :- not remove_reaction(901,196).
catalyst(902,196) :- not remove_reaction(902,196).
catalyst(6600,193).
catalyst(620,189).
catalyst(540,174).
catalyst(6960,143).
...
modifiable_enzyme(623).
modifiable_enzyme(624).
modifiable_enzyme(392).
modifiable_enzyme(425).
modifiable_enzyme(289).
modifiable_enzyme(784).
modifiable_enzyme(631).
modifiable_enzyme(297).
modifiable_enzyme(197).
modifiable_enzyme(196).
