...
component("YGR060W",176).
component("YGL012W",164).
component("YOL086C",296).
component("YMR303C",274).
component("YGL256W",172).
component("YDL168W",108).
component("YBR145W",82).
component("YPL231W",326).
component("YGL001C",161).
component("YML056C",259).
component("YLR432W",256).
component("YHR216W",197).
component("YAR075W",69).
component("YAR073W",68).
component("YDR127W",120).
component("YJR139C",225).
component("YOR136W",302).
component("YIL155C",201).
component("YJR078W",218).
component("YJR025C",214).
component("YMR015C",263).
component("YDR402C",136).
component("YJR104C",221).
component("YHR008C",189).
component("YER070W",149).
component("YDL168W",109).
component("YPL276W",333).
component("YPL275W",332).
component("YOR388C",319).
component("YGL154C",170).
component("YOR323C",313).
component("YMR170C",269).
component("YMR169C",268).
component("YBR166C",85).
component("YER014W",146).
component("YMR118C",267).
component("YLR164W",246).
component("YLL041C",242).
component("YKL148C",233).
component("YJL045W",205).
component("YDR178W",126).
component("YJR051W",215).
component("YEL047C",144).
component("YOR375C",318).
component("YDL215C",110).
component("YAL062W",67).
component("YBR035C",75).
component("YER023W",147).
component("YOR236W",311).
component("YGR204W",183).
component("U62_",49).
component("YPL017C",322).
component("YFL018C",153).
component("U47_",43).
component("YKL024C",228).
component("YPR074C",340).
component("YBR117C",81).
component("YCL009C",95).
component("YMR062C",265).
component("YPL231W",327).
component("YPL001W",321).
component("YPL231W",328).
component("YGR147C",180).
component("YDL040C",102).
component("YPL028W",323).
component("YPR001W",335).
component("YNR001C",286).
component("YNL117W",280).
component("YIR031C",203).
component("YNL029C",276).
component("YIL085C",199).
component("YLR209C",247).
component("YMR300C",273).
component("YER055C",148).
component("YDR354W",132) :- not remove_orf("YDR354W",132).
component("YFR047C",159).
component("YJR133W",224).
component("YML022W",257).
component("YDR441C",138).
component("YDR399W",134).
component("YDR127W",121).
component("YJR130C",223).
component("YLR303W",253).
component("YDR035W",115).
component("YBR249C",89).
component("YBR256C",90).
component("YHR137W",192).
component("YLR027C",243).
component("YKL106W",230).
component("YGR019W",174).
component("U64_",50).
component("U51_",45).
component("YJR148W",226).
component("YGL253W",171).
component("YFR053C",160).
component("YMR205C",271).
component("YGR240C",184).
component("YCR036W",100).
component("YCL040W",97).
component("YJR105W",222).
component("U16_",26).
component("U15_",24).
component("YKL001C",227).
component("YML070W",260).
component("YFL053W",155).
component("U83_",60).
component("U82_",59).
component("YMR208W",272).
component("YOR347C",317).
component("YAL038W",66).
component("YPR121W",342).
component("YPL258C",330).
component("YOL055C",293).
component("U1_",34).
component("YNL267W",284).
component("YLR305C",254).
component("YFR019W",157).
component("YDR208W",127).
component("YDR127W",122).
component("U20_",37).
component("YDR300C",130).
component("U18_",31).
component("U76_",58).
component("YDR454C",139).
component("YOL061W",295).
component("YKL181W",234).
component("YHL011C",187).
component("YER099C",152).
component("YBL068W",72).
component("YOR143C",303).
component("YGR007W",173).
component("YCL050C",98).
component("YPR190C",345).
component("YPR187W",344).
component("YPR110C",341).
component("YPR010C",336).
component("YOR341W",316).
component("YOR340C",315).
component("YOR224C",310).
component("YOR210W",309).
component("YOR207C",307).
component("YOR151C",304).
component("YOR116C",301).
component("YOL005C",290).
component("YNR003C",287).
component("YNL248C",283).
component("YNL151C",282).
component("YNL113W",279).
component("YKL144C",232).
component("YJR063W",216).
component("YJL148W",212).
component("YJL140W",211).
component("YIL021W",198).
component("YHR143W-A",193).
component("YGL070C",168).
component("YFL036W",154).
component("YDR404C",137).
component("YDR156W",125).
component("YDR045C",116).
component("YDL150W",106).
component("YDL140C",105).
component("YBR154C",84).
component("YKL035W",229).
component("YHL012W",188).
component("YDR058C",119).
component("YDL086W",104).
component("YOL011W",291).
component("YMR008C",262).
component("YMR006C",261).
component("U101_",18).
component("YBL015W",70).
component("U84_",61).
component("YPR073C",338).
component("YHR215W",196).
component("YDL024C",101).
component("YBR093C",79).
component("YBR092C",78).
component("YPL228W",325).
component("YMR180C",270).
component("YDL236W",112).
component("YJL155C",213).
component("YPR073C",339).
component("YOR208W",308).
component("YNL053W",278).
component("YMR036C",264).
component("YIR026C",202).
component("YIL113W",200).
component("YFR028C",158).
component("YER075C",150).
component("YDL230W",111).
component("YBR276C",91).
component("U34_",41).
component("U30_",40).
component("U24_",39).
component("YKR031C",239).
component("YLR286C",251).
component("YOR190W",305).
component("YLR300W",252).
component("YGR282C",186).
component("YDR261C",128).
component("YDR400W",135).
component("YML035C",258).
component("YJL070C",206).
component("YBR284W",92).
component("YNL045W",277).
component("YGL037C",166).
component("YBR208C",86).
component("U53_",46).
component("YIR032C",204).
component("YHR144C",194).
component("YBR153W",83).
component("YDL238C",113).
component("YLR245C",250).
component("YJL126W",208).
component("YBR111C",80).
component("YER005W",145).
component("YLR231C",248).
component("U88_",62).
component("YLR134W",245).
component("YLR044C",244).
component("YGR087C",177).
component("YDR380W",133).
component("YDL080C",103).
component("U93_",64).
component("U54_",47).
component("YKL211C",237) :- not remove_orf("YKL211C",237).
component("YGR170W",182).
component("YDR294C",129).
component("YNR033W",289).
component("YKL211C",238) :- not remove_orf("YKL211C",238).
component("YER090W",238) :- not remove_orf("YER090W",238).
component("YER090W",151) :- not remove_orf("YER090W",151).
component("YDR127W",123).
component("YPL281C",334).
component("YOR393W",320).
component("YMR323W",275).
component("YHR174W",195).
component("YGR254W",185).
component("YGL026C",165) :- not remove_orf("YGL026C",165).
component("YGR155W",181).
component("YNL316C",285).
component("YKL182W",235).
component("YDR127W",124).
component("YGL148W",169).
component("YAL012W",65).
component("YBR019C",73).
component("YDR050C",118).
component("YDR007W",114) :- not remove_orf("YDR007W",114).
component("YOR095C",300).
component("YGL001C",162).
component("YMR105C",266).
component("YKL127W",231).
component("YPR060C",337).
component("YHR091C",191).
component("YDR341C",131).
component("YOL097C",297).
component("YOR335C",314).
component("YGR094W",178).
component("U89_",63).
component("YJL101C",207).
component("YJR103W",220).
component("YBL039C",71).
component("YOL058W",294).
component("YBR208C",87).
component("YHR074W",190).
component("YOR303W",312).
component("YGL062W",167).
component("YBR218C",88).
component("YPL231W",329).
component("YNR016C",288).
component("YKL182W",236).
component("YGR037C",175).
component("YOR005C",298).
component("YDL164C",107).
component("YPR138C",343).
component("YPL265W",331).
component("YPL036W",324).
component("YOR192C",306).
component("YOR071C",299).
component("YOL020W",292) :- not remove_orf("YOL020W",292).
component("YNL142W",281).
component("YLR348C",255).
component("YLR237W",249).
component("YKR053C",241).
component("YKR039W",240) :- not remove_orf("YKR039W",240).
component("YJR095W",219).
component("YJR077C",217).
component("YJL134W",210).
component("YJL129C",209).
component("YGR121C",179).
component("YGL008C",163).
component("YFL055W",156).
component("YEL017C-A",143).
component("YDR536W",142).
component("YDR508C",141).
component("YDR503C",140).
component("YDR046C",117) :- not remove_orf("YDR046C",117).
component("YCR024C-A",99).
component("YCL025C",96).
component("YBR298C",94).
component("YBR291C",93).
component("YBR069C",77) :- not remove_orf("YBR069C",77).
component("YBR068C",76) :- not remove_orf("YBR068C",76).
...
catalyst(6160,273).
catalyst(3870,148).
catalyst(3620,132) :- not remove_reaction(3620,132).
catalyst(2190,159).
catalyst(5550,224).
catalyst(5650,257).
catalyst(5650,138).
...
catalyst(2300,64).
catalyst(3460,47).
catalyst(3600,237) :- not remove_reaction(3600,237).
catalyst(6900,182).
catalyst(8781,129).
catalyst(8782,129).
catalyst(2550,289).
catalyst(3630,238) :- not remove_reaction(3630,238).
catalyst(3630,151) :- not remove_reaction(3630,151).
catalyst(3740,123).
catalyst(8231,334).
catalyst(8232,334).
catalyst(8231,320).
...
catalyst(8231,185).
catalyst(8232,185).
catalyst(3590,165) :- not remove_reaction(3590,165).
catalyst(10910,165) :- not remove_reaction(10910,165).
catalyst(4570,181).
catalyst(3680,285).
catalyst(7141,235).
catalyst(7142,235).
...
catalyst(8281,118).
catalyst(8282,118).
catalyst(3610,114) :- not remove_reaction(3610,114).
catalyst(7921,300).
catalyst(7922,300).
catalyst(6370,162).
catalyst(7861,266).
...
catalyst(190,306).
catalyst(190,299).
catalyst(801,292) :- not remove_reaction(801,292).
catalyst(802,292) :- not remove_reaction(802,292).
catalyst(811,292) :- not remove_reaction(811,292).
catalyst(812,292) :- not remove_reaction(812,292).
catalyst(831,292) :- not remove_reaction(831,292).
catalyst(832,292) :- not remove_reaction(832,292).
catalyst(371,281).
catalyst(372,281).
catalyst(1540,255).
catalyst(190,249).
catalyst(6560,241).
catalyst(771,240) :- not remove_reaction(771,240).
catalyst(772,240) :- not remove_reaction(772,240).
catalyst(781,240) :- not remove_reaction(781,240).
catalyst(782,240) :- not remove_reaction(782,240).
...
catalyst(881,240) :- not remove_reaction(881,240).
catalyst(882,240) :- not remove_reaction(882,240).
catalyst(1191,240) :- not remove_reaction(1191,240).
catalyst(1192,240) :- not remove_reaction(1192,240).
catalyst(1250,219).
catalyst(1581,217).
catalyst(1582,217).
catalyst(6560,210).
...
catalyst(1501,93).
catalyst(1502,93).
catalyst(771,77) :- not remove_reaction(771,77).
catalyst(772,77) :- not remove_reaction(772,77).
catalyst(801,77) :- not remove_reaction(801,77).
catalyst(802,77) :- not remove_reaction(802,77).
catalyst(811,77) :- not remove_reaction(811,77).
catalyst(812,77) :- not remove_reaction(812,77).
...
catalyst(831,76) :- not remove_reaction(831,76).
catalyst(832,76) :- not remove_reaction(832,76).
catalyst(620,74).
catalyst(2920,57).
catalyst(2920,56).
catalyst(2920,55).
