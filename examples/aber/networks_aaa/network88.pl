...
component("YNL280C",524).
component("YGR060W",313).
component("YGL012W",290).
component("YOL086C",545).
component("YMR303C",502).
component("YGL256W",307).
...
component("YHR063C",343).
component("YBR153W",150).
component("YML056C",474).
component("YLR432W",470).
component("YHR216W",354).
component("YAR075W",120).
component("YAR073W",119).
component("YDR127W",209).
component("YJR139C",406).
component("YOL126C",549).
component("YDL078C",179).
component("YKL029C",410).
component("YOR136W",559).
component("YDL066W",178).
component("YLR355C",467).
component("YML086C",476).
component("YIL155C",364).
component("YPR191W",623).
component("YOR065W",554).
component("YJL166W",385).
component("YHR001W-A",338).
component("YGR183C",323).
component("YFR033C",283).
component("YDR529C",242).
component("YBL045C",126).
component("Q0105",18).
component("YGR088W",315).
component("YDR256C",223).
component("YJR078W",397).
component("YJR025C",392).
component("YGR255C",332).
component("YBL098W",129).
component("YMR015C",482).
component("YDR402C",234).
component("YGL055W",295).
component("YGR175C",321).
component("YJR104C",400).
component("YHR008C",339).
component("YER070W",262).
component("U35_",78).
component("YDL168W",190).
component("YDR158W",217).
component("YPL276W",604).
component("YPL275W",603).
component("YOR388C",581).
component("YGL154C",301).
component("U55_",87).
component("YOR323C",571).
component("YMR170C",490).
component("YMR169C",489).
component("U2_",75).
component("YBR221C",157).
component("U52_",84).
component("YBR166C",153).
component("YNL280C",525).
component("YGL012W",291).
component("U57_",88).
component("YDR044W",200).
component("YER014W",251).
component("YKR009C",428).
component("YIL160C",366).
component("YGL205W",304).
component("YMR118C",487).
component("YLR164W",452).
component("YLL041C",436).
component("YKL148C",418).
component("YJL045W",371).
component("YDR178W",218).
component("YJR051W",394).
component("YEL047C",246).
component("YOR375C",579).
component("YDL215C",193).
component("YAL062W",117).
component("U99_",113).
component("YBR035C",136).
component("YHR037W",340).
component("YKR080W",432).
component("YER023W",252).
component("YOR236W",568).
component("YGR204W",325).
component("YLR142W",447).
component("U62_",90).
component("YKL150W",419).
component("YIL043C",356).
component("YHR042W",341).
component("YFR030W",282).
component("YPL017C",584).
component("YFL018C",274).
component("YER042W",254).
component("YJR137C",405).
component("YPL266W",601).
component("YML110C",478).
component("YBR034C",135).
component("YPL273W",602).
component("YLL062C",438).
component("U47_",81).
component("YER091C",265).
component("YDL033C",176).
component("YOL096C",546).
component("YDR019C",198).
component("YDR408C",236).
component("YBL013W",121).
component("YKL024C",409).
component("YPR074C",615).
component("YBR117C",145).
component("YLR354C",466).
component("YGR043C",311).
component("YCL009C",166).
component("YMR062C",484).
component("YNL071W",508).
component("YNR008W",532).
component("YPL231W",596).
component("YER061C",260).
component("U86_",105).
component("YPL001W",583).
component("YDR148C",215).
component("YOR377W",580).
component("YGR177C",322).
component("YPL231W",597).
component("YGR147C",318).
component("YDL040C",177).
component("YPL028W",585).
component("YGL017W",292).
component("YPR001W",606).
component("YNR001C",530).
component("YDL182W",191).
component("YDL131W",184).
component("YNL117W",511).
component("YIR031C",369).
component("YNL029C",505).
component("YIL085C",359).
component("YMR261C",497).
component("YML100W",477).
component("YBR126C",147).
component("YNL192W",517).
component("YBR038W",138).
component("YBR023C",134).
component("YLR209C",453).
component("U104_",21).
component("YMR300C",501).
component("YER055C",256).
component("YDR354W",230) :- not remove_orf("YDR354W",230).
component("YFR047C",284).
component("YJR133W",404).
component("YLR209C",454).
component("YML022W",471).
component("YDR441C",238).
component("YDR399W",232).
component("YJL167W",386).
component("YNL256W",520).
component("YDR127W",210).
component("YLR303W",460).
component("YJR130C",403).
component("YLR303W",461).
component("YDR035W",199).
component("YBR249C",158).
component("YOL143C",551).
component("YBR256C",159).
component("YHR137W",348).
component("YGL202W",303).
component("YLR027C",439).
component("YKL106W",414).
component("YKL104C",413).
component("YGR019W",309).
component("YLR089C",443).
component("U64_",91).
component("U51_",83).
component("YJR148W",407).
component("YGL253W",306).
component("YFR053C",285).
component("YOL136C",550).
component("YIL107C",361).
component("YMR205C",492).
component("YGR240C",328).
component("YDR248C",222).
component("YCR036W",173).
component("YCL040W",168).
component("YJR105W",401).
component("U16_",38).
component("U15_",35).
component("U96_",111).
component("YKL001C",408).
component("YML070W",475).
component("YFL053W",277).
component("YHL032C",336).
component("U83_",103).
component("U82_",102).
component("U81_",101).
component("YMR208W",493).
component("YOR347C",576).
component("YAL038W",116).
component("YNR012W",533).
component("YPR121W",618).
component("YPL258C",599).
component("YOL055C",542).
component("U1_",57).
component("YBR020W",132).
component("YNL267W",522).
component("YLR305C",463).
component("YFR019W",280).
component("YDR208W",219).
component("YDR127W",211).
component("U21_",66).
component("U20_",64).
component("YDR147W",214).
component("YDR300C",227).
...
component("YOL061W",544).
component("YKL181W",421).
component("YHL011C",334).
component("YER099C",267).
component("YBL068W",128).
component("YOR143C",560).
component("YGR007W",308).
component("YLR328W",464).
component("YJR010W",391).
component("YCL050C",169).
component("YPR190C",622).
component("YPR187W",621).
component("YPR110C",617).
component("YPR010C",608).
component("YOR341W",575).
component("YOR340C",574).
component("YOR224C",567).
component("YOR210W",566).
component("YOR207C",564).
component("YOR151C",561).
component("YOR116C",557).
component("YOL005C",538).
component("YNR003C",531).
component("YNL248C",519).
component("YNL151C",515).
component("YNL113W",510).
component("YKL144C",417).
component("YJR063W",395).
component("YJL148W",383).
component("YJL140W",382).
component("YIL021W",355).
component("YHR143W-A",349).
component("YGL070C",298).
component("YFL036W",276).
component("YDR404C",235).
component("YDR156W",216).
component("YDR045C",201).
component("YDL150W",187).
component("YDL140C",185).
component("YBR154C",152).
component("YPR175W",620).
component("YPL167C",592).
component("YOR330C",572).
component("YOL115W",548).
component("YNL299W",527).
component("YNL262W",521).
component("YNL102W",509).
component("YJR043C",393).
component("YJR006W",390).
component("YJL090C",375).
component("YIL139C",363).
...
component("YKL035W",411).
component("YHL012W",335).
component("YHR123W",347).
component("YER026C",253).
component("YCL004W",165).
component("YJL068C",372).
component("YDR058C",205).
component("YNR034W",536).
component("YHR163W",351).
component("YGR248W",330).
component("YCR073W-A",174).
component("YDL086W",181).
component("YOL011W",539).
component("YMR008C",481).
component("YMR006C",480).
component("U101_",19).
component("YBL015W",122).
component("YJL068C",373).
component("YPL072W",588).
component("YOR124C",558).
component("YNL186W",516).
component("YMR304W",503).
component("YMR223W",495).
component("YKR098C",434).
component("YJL197W",387).
component("YIL156W",365).
component("YFR010W",279).
component("YER151C",269).
component("YER144C",268).
component("YER098W",266).
component("YDR069C",206).
component("YDL122W",183).
component("YBR058C",139).
component("YBL067C",127).
component("U84_",104).
component("YPR073C",613).
component("YHR215W",353).
component("YDL024C",175).
component("YBR093C",143).
component("YBR092C",142).
component("YAR071W",118).
component("YIL053W",358).
component("YER062C",261).
component("YHR046C",342).
component("YGR208W",327).
component("YPL228W",594).
component("YMR180C",491).
component("YDL236W",195).
component("YJL155C",384).
component("YPR073C",614).
component("YOR208W",565).
component("YNL053W",507).
component("YMR036C",483).
component("YIR026C",367).
component("YIL113W",362).
component("YFR028C",281).
component("YER075C",263).
...
component("U25_",74).
component("U24_",73).
component("YOR360C",578).
component("YGL248W",305).
component("YKR031C",429).
component("YLR286C",458).
component("YOR190W",562).
component("YLR300W",459).
component("YGR282C",333).
component("YDR261C",224).
component("YDR400W",233).
component("U23_",72).
component("YML035C",472).
component("YJL070C",374).
component("YBR284W",162).
component("U102_",20).
component("YNL045W",506).
component("YLR160C",451).
component("YLR158C",450).
component("YLR157C",449).
component("YLR155C",448).
component("YDR321W",228).
component("YGL037C",294).
component("YDR242W",221).
component("YBR208C",154).
component("YMR281W",500).
component("U53_",85).
component("YIR032C",370).
component("YIR029W",368).
component("YPR062W",612).
component("YMR120C",488).
component("YHR144C",350).
component("YNL141W",512).
component("YBR153W",151).
component("YDL238C",196).
component("YNL141W",513).
component("YLR245C",457).
component("YML035C",473).
component("YJL126W",378).
component("U87_",106).
component("YMR267W",498).
component("YBR111C",144).
component("YER005W",250).
component("YIL048W",357).
component("YER166W",270).
component("YDR093W",207).
component("YAL026C",115).
component("YLR231C",455).
component("U88_",107).
component("YLR134W",445).
component("YLR044C",440).
component("YGR087C",314).
component("YDR380W",231).
component("YDL080C",180).
component("U98_",112).
component("YMR250W",496).
component("YKL184W",424).
component("YNR043W",537).
component("U93_",110).
component("YDR047W",203).
component("U54_",86).
component("YKL211C",425) :- not remove_orf("YKL211C",425).
component("YGR170W",320).
component("YDR294C",225).
component("YEL046C",245).
component("YNR033W",535).
component("YKL211C",426) :- not remove_orf("YKL211C",426).
component("YER090W",426) :- not remove_orf("YER090W",426).
component("YER090W",264) :- not remove_orf("YER090W",264).
component("YDR127W",212).
component("YPL281C",605).
component("YOR393W",582).
component("YMR323W",504).
component("YHR174W",352).
component("YGR254W",331).
component("YGL026C",293) :- not remove_orf("YGL026C",293).
component("YGR155W",319).
component("YLR304C",462).
component("YJL200C",388).
component("YNL316C",528).
component("YKL182W",422).
component("YPL212C",593).
component("YNL292W",526).
component("YGL063W",297).
component("YFL001W",272).
component("YPR002W",607).
component("YDR127W",213).
component("YGL148W",300).
component("YLR359W",468).
component("YAL012W",114).
component("YFR055W",286).
component("YJL121C",377).
component("YBR019C",130).
component("YBR019C",131).
component("YDR050C",204).
component("YDR007W",197) :- not remove_orf("YDR007W",197).
component("YOR095C",556).
component("YER003C",249).
component("YGL001C",288).
component("U14_",30).
component("YKL152C",420).
component("YMR105C",485).
component("YKL127W",415).
component("YEL058W",248).
component("YPR060C",611).
component("YHR072W",344).
component("YPL097W",589).
component("YGR185C",324).
component("YPL104W",590).
component("YLL018C",435).
component("YPR081C",616).
component("YBR121C",146).
component("YNL247W",518).
component("YOL033W",541).
component("YHR091C",346).
component("YDR341C",229).
component("YOL097C",547).
component("YPR047W",610).
component("YLR060W",441).
component("YFL022C",275).
component("YPR033C",609).
component("YPL160W",591).
component("YLR382C",469).
component("YOR335C",573).
component("YGR094W",316).
component("YGR244C",329).
component("U89_",108).
component("YOR241W",569).
component("YMR113W",486).
component("YKL132C",416).
component("YJL101C",376).
component("U91_",109).
component("YDL141W",186).
component("YJR103W",399).
component("YBL039C",124).
component("YGR204W",326).
component("YOL058W",543).
component("YBR208C",155).
component("YHR074W",345).
component("YMR217W",494).
component("YOR303W",570).
component("YJR109C",402).
component("YJL130C",380).
component("YGL062W",296).
component("YBR218C",156).
component("YPL231W",598).
component("YNR016C",534).
component("YKL182W",423).
component("YGR037C",310).
component("YOR005C",553).
component("YDL164C",188).
component("YPR138C",619).
component("YPL265W",600).
component("YPL057C",587).
component("YPL036W",586).
component("YOR348C",577).
component("YOR192C",563).
component("YOR071C",555).
component("YOL156W",552).
component("YOL020W",540) :- not remove_orf("YOL020W",540).
component("YNL318C",529).
component("YNL268W",523).
component("YNL142W",514).
component("YMR272C",499).
component("YML123C",479).
component("YLR348C",465).
component("YLR237W",456).
component("YLR138W",446).
component("YLR100C",444).
component("YLR081W",442).
component("YLL061W",437).
component("YKR093W",433).
component("YKR053C",431).
component("YKR039W",430) :- not remove_orf("YKR039W",430).
component("YKL217W",427).
component("YJR095W",398).
component("YJR077C",396).
component("YJL219W",389).
component("YJL134W",381).
component("YJL129C",379).
component("YHL036W",337).
component("YGR121C",317).
component("YGR055W",312).
component("YGL186C",302).
component("YGL077C",299).
component("YGL008C",289).
component("YFL055W",278).
component("YFL011W",273).
component("YER060W-A",259).
component("YER060W",258).
component("YER056C",257).
component("YER053C",255).
component("YEL017C-A",244).
component("YDR536W",243).
component("YDR508C",241).
component("YDR503C",240).
component("YDR294C",226).
component("YDR046C",202) :- not remove_orf("YDR046C",202).
component("YDL210W",192).
component("YCR024C-A",172).
...
catalyst(6160,501).
catalyst(3870,256).
catalyst(3620,230) :- not remove_reaction(3620,230).
catalyst(2110,284).
catalyst(2190,284).
catalyst(5550,404).
catalyst(5791,454).
...
catalyst(1960,203).
catalyst(3460,86).
catalyst(3600,425) :- not remove_reaction(3600,425).
catalyst(6900,320).
catalyst(8781,225).
catalyst(8782,225).
catalyst(4560,245).
catalyst(2550,535).
catalyst(3630,426) :- not remove_reaction(3630,426).
...
catalyst(941,540) :- not remove_reaction(941,540).
catalyst(942,540) :- not remove_reaction(942,540).
catalyst(1200,529).
catalyst(761,523).
catalyst(762,523).
catalyst(371,514).
...
catalyst(640,433).
catalyst(6560,431).
catalyst(761,430) :- not remove_reaction(761,430).
catalyst(762,430) :- not remove_reaction(762,430).
...
catalyst(791,430) :- not remove_reaction(791,430).
catalyst(792,430) :- not remove_reaction(792,430).
...
catalyst(821,430) :- not remove_reaction(821,430).
catalyst(822,430) :- not remove_reaction(822,430).
...
catalyst(861,430) :- not remove_reaction(861,430).
catalyst(862,430) :- not remove_reaction(862,430).
catalyst(881,430) :- not remove_reaction(881,430).
catalyst(882,430) :- not remove_reaction(882,430).
catalyst(911,430) :- not remove_reaction(911,430).
catalyst(912,430) :- not remove_reaction(912,430).
catalyst(941,430) :- not remove_reaction(941,430).
catalyst(942,430) :- not remove_reaction(942,430).
...
catalyst(831,202) :- not remove_reaction(831,202).
catalyst(832,202) :- not remove_reaction(832,202).
catalyst(841,202) :- not remove_reaction(841,202).
catalyst(842,202) :- not remove_reaction(842,202).
catalyst(861,202) :- not remove_reaction(861,202).
catalyst(862,202) :- not remove_reaction(862,202).
catalyst(730,192).
catalyst(220,172).
catalyst(771,167).
catalyst(772,167).
