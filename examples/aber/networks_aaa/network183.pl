...
component("YNL280C",928).
component("YLR056W",782).
component("YGR060W",547).
component("YGL012W",512).
component("YKR009C",761).
component("YOL086C",963).
component("YMR303C",893).
component("YMR083W",862).
component("YGL256W",539).
component("YDL168W",345).
component("YBR145W",265).
component("YPL231W",1053).
component("YBR265W",284).
component("U46_",157).
component("YBR149W",266).
component("YBR149W",267).
component("YJR159W",722).
component("YGL001C",509).
component("YIL094C",638).
component("YHR063C",603).
component("U45_",156).
component("YBR153W",268).
component("YML056C",842).
component("YLR432W",831).
component("YHR216W",627).
component("YAR075W",220).
component("YAR073W",219).
component("YCL030C",295).
component("YDR127W",384).
component("YJR139C",716).
component("YML075C",845).
component("YLR450W",834).
component("YOL126C",969).
component("YKL085W",733).
component("YDL078C",325).
component("YKL029C",728).
component("YOR136W",988).
component("YNL037C",899).
component("YNL009W",897).
component("YLR174W",801).
component("YDL066W",323).
component("YHR183W",621).
component("YGR256W",579).
component("YNL241C",918).
component("YOL059W",960).
component("YDL022W",315).
component("YCL018W",293).
component("YLR355C",826).
component("YIL074C",635).
component("YER081W",473).
component("YML054C",841).
component("YDL174C",349).
component("YML086C",846).
component("YIL155C",646).
component("YPR191W",1094).
component("YOR065W",977).
component("YJL166W",685).
component("YHR001W-A",591).
...
component("YKL026C",727).
component("YIR037W",661).
component("YBR244W",280).
component("YJR078W",707).
component("U58_",169).
component("YJR025C",698).
component("U107_",26).
component("YGR255C",578).
component("U108_",27).
component("YBL098W",231).
component("YMR015C",858).
component("YHR007C",592).
component("YDR402C",423).
component("YGL055W",519).
component("YGR175C",561).
component("YJR104C",710).
component("YHR008C",593).
component("YJL026W",664).
component("YIL066C",634).
...
component("YPL276W",1065).
component("YPL275W",1064).
component("YOR388C",1026).
component("YPL061W",1034).
component("YOR374W",1023).
...
component("YOR323C",1013).
component("YMR170C",873).
component("YMR169C",872).
component("U2_",141).
component("YER178W",487).
component("YBR221C",278).
component("YIL125W",643).
component("U52_",163).
component("YBR166C",271).
component("YNL280C",929).
component("YGL012W",513).
component("YKL182W",747).
component("U57_",168).
component("YKL216W",758).
component("YDR044W",367).
component("YER014W",452).
component("YKR009C",762).
component("YIL160C",648).
component("YGL205W",533).
component("YMR118C",867).
component("YLR164W",799).
component("YLL041C",773).
component("YKL148C",741).
component("YKL141W",739).
component("YJL045W",665).
component("YDR178W",394).
component("YJR051W",701).
component("YEL047C",445).
component("YDL171C",347).
component("YDL171C",348).
component("YDL215C",353).
component("YOR375C",1024).
component("YDL215C",354).
component("YAL062W",215).
component("U99_",208).
component("YBR035C",246).
component("YMR189W",875).
component("U56_",167).
component("YNR050C",944).
component("YHR037W",599).
component("YKR080W",766).
component("YER023W",454).
component("YPL023C",1030).
component("YGL125W",525).
component("YOR236W",1005).
component("YGR204W",569).
component("YIR034C",660).
component("YLR142W",792).
component("U63_",174).
component("U62_",173).
component("YOR356W",1021).
component("YHR068W",604).
component("YKL150W",742).
component("YIL043C",631).
component("YHR042W",600).
component("YOR221C",1002).
component("YML120C",850).
component("YKL192C",751).
component("YKL055C",730).
component("YER061C",464).
component("YBR046C",249).
component("YMR145C",870).
component("YML120C",851).
component("YKL192C",752).
component("YDL085W",327).
component("YGR234W",573).
component("YFR030W",504).
component("YPL017C",1029).
component("YFL018C",492).
component("YPL091W",1036).
component("YHR106W",613).
component("YDR353W",417).
component("YER042W",456).
component("YPR167C",1088).
component("YJR137C",715).
component("YNL052W",901).
component("YMR256C",884).
component("YLR395C",830).
component("YLR038C",780).
component("YIL111W",640).
component("YHR051W",602).
component("YGL191W",531).
component("YGL187C",530).
component("YDL067C",324).
component("Q0275",20).
component("Q0250",19).
component("YPL266W",1060).
component("YML110C",849).
component("YBR034C",245).
component("YPL273W",1062).
component("YLL062C",776).
component("YDR410C",426).
component("YOL096C",964).
component("U47_",158).
component("YER091C",478).
component("YJR073C",705).
component("YGR157W",558).
component("YDR120C",382).
component("YML008C",835).
component("YDL033C",317).
component("YOL096C",965).
component("YLR172C",800).
component("YLR058C",783).
component("YDR019C",363).
component("YBR176W",272).
component("YDR408C",425).
component("YMR120C",868).
component("YLR028C",778).
component("YBL013W",221).
component("YJL130C",677).
component("YJL088W",670).
component("YKL024C",725).
component("YPR074C",1080).
component("YBR117C",260).
component("YLR354C",825).
component("YGR043C",545).
component("YMR108W",865).
component("YCL009C",292).
component("YMR062C",861).
component("YNL071W",903).
component("YNR008W",936).
component("YIL160C",649).
component("YNL277W",927).
component("YDR232W",397).
component("YFL017C",491).
component("YPL231W",1054).
component("YER061C",465).
component("U86_",196).
component("YPL001W",1028).
component("YMR296C",891).
component("YDR062W",375).
component("YDL052C",321).
component("U8_",200).
component("YDR148C",390).
component("YAR035W",217).
component("YOR377W",1025).
component("YGR177C",562).
component("YPL231W",1055).
component("YGR147C",556).
component("YDL040C",318).
component("YPL028W",1031).
component("YLR195C",802).
component("YLR299W",812).
component("YGL017W",514).
component("YPR001W",1067).
component("YNR001C",934).
component("YCR005C",304).
component("YML126C",853).
component("YNL104C",906).
component("YDL182W",350).
component("YDL131W",336).
component("YNL117W",908).
component("YIR031C",658).
component("YOR321W",1012).
component("YJR143C",717).
component("YGR199W",567).
component("YDR307W",411).
component("YDL095W",331).
component("YDL093W",330).
component("YAL023C",211).
component("YLR258W",809).
component("YFR015C",500).
component("YOR103C",982).
component("YOR085W",979).
component("YMR149W",871).
component("YML019W",837).
component("YJL002C",662).
component("YEL002C",439).
component("YDL232W",356).
component("YCL043C",299).
component("YNL029C",898).
component("YIL085C",637).
component("YMR261C",885).
component("YML100W",847).
component("YBR126C",264).
component("YNL192W",916).
component("YBR038W",248).
component("YBR023C",244).
component("YMR306W",895).
component("YLR342W",823).
component("YGR032W",543).
component("YPR183W",1091).
component("YLR209C",803).
component("U104_",24).
component("U103_",23).
component("YMR271C",887).
component("YML106W",848).
component("YOR209C",1000).
component("YMR300C",892).
component("YER055C",460).
component("YDR354W",418) :- not remove_orf("YDR354W",418).
component("YFR047C",506).
component("YJR133W",714).
component("YLR209C",804).
component("YML022W",838).
component("YDR441C",429).
component("YDR399W",421).
component("YHR128W",615).
component("YPR176C",1090).
component("YPL172C",1045).
component("YNR041C",942).
component("YMR101C",863).
component("YDL090C",329).
component("YBR003W",235).
component("YBR002C",234).
component("YJL167W",686).
component("YJL167W",687).
component("YNL256W",921).
component("YPR069C",1077).
component("YDR127W",385).
component("YLR146C",793).
component("YHR068W",605).
component("YLR303W",814).
component("YGR012W",541).
component("YJR130C",713).
component("YLR303W",815).
component("YDR035W",365).
component("YBR249C",281).
component("YOR274W",1008).
component("YOL143C",972).
component("YBR256C",283).
component("YHR137W",616).
component("YGL202W",532).
component("YLR027C",777).
component("YKL106W",735).
component("YOL140W",971).
component("YLR438W",833).
component("YKL104C",734).
component("YGR019W",542).
component("YLR089C",787).
component("YDR111C",381).
component("U64_",175).
component("U61_",172).
component("U51_",162).
component("YJR148W",718).
component("YHR208W",625).
component("YFL030W",494).
component("YOR184W",994).
component("YNR058W",947).
component("YIL116W",642).
component("YGL253W",538).
component("YFR053C",507).
component("YOL136C",970).
component("YIL107C",639).
component("YMR013C",857).
component("YMR205C",877).
component("YGR240C",574).
component("YDR248C",401).
component("YLR240W",807).
component("YKL203C",754).
component("YJR066W",704).
component("YCR036W",310).
component("YGR194C",566).
component("YCL040W",298).
component("YJR105W",711).
component("U16_",78).
component("U15_",69).
component("YPL188W",1047).
component("YJR049C",700).
component("YEL041W",443).
component("U96_",206).
component("YKL001C",723).
component("YDR236C",399).
component("YML070W",844).
component("YFL053W",497).
component("YHL032C",589).
component("YLR133W",789).
component("YDR531W",437).
component("U83_",193).
component("U82_",192).
component("U81_",191).
component("YMR208W",878).
component("YPL203W",1048).
component("YOR061W",976).
component("YKL166C",744).
component("YJL164C",684).
component("YIL035C",630).
component("YHR205W",624).
component("YHR102W",612).
component("YGL019W",515).
component("YHR025W",598).
component("YOR347C",1019).
component("YAL038W",213).
component("YNR012W",937).
component("YPR121W",1085).
component("YPL258C",1057).
component("YOL055C",956).
component("YPL214C",1051).
component("U1_",109).
component("YDR009W",362).
component("YBR020W",242).
component("YNL267W",925).
component("YLR305C",817).
...
component("U19_",108).
component("YKL024C",726).
component("U18_",98).
component("U17_",88).
component("U76_",186).
component("YMR220W",880).
component("YER170W",486).
component("YDR226W",396).
component("YKL067W",732).
component("YOL055C",957).
component("YDR454C",430).
component("YJR057W",702).
component("YOL061W",961).
component("YKL181W",746).
component("YHL011C",586).
component("YER099C",480).
component("YBL068W",230).
component("YOR143C",990).
component("YNL256W",922).
component("YLR328W",821).
component("YBR018C",238).
component("YBR018C",239).
component("YGR007W",540).
component("YGR202C",568).
component("YLR328W",822).
component("YKR002W",760).
component("YDL045C",319).
component("U80_",190).
component("YDL103C",334).
component("U94_",205).
component("YJR010W",695).
component("YCL050C",300).
component("YGL130W",526).
component("YDR530C",436).
component("YCL050C",301).
component("YPR190C",1093).
component("YPR187W",1092).
component("YPR110C",1083).
component("YPR010C",1070).
component("YOR341W",1018).
component("YOR340C",1017).
component("YOR224C",1004).
component("YOR210W",1001).
component("YOR207C",998).
component("YOR151C",991).
component("YOR116C",983).
component("YOL005C",949).
component("YNR003C",935).
component("YNL248C",920).
component("YNL151C",913).
component("YNL113W",907).
component("YKL144C",740).
component("YJR063W",703).
component("YJL148W",681).
component("YJL140W",680).
component("YIL021W",629).
component("YHR143W-A",617).
...
component("YPR175W",1089).
component("YPL167C",1044).
component("YOR330C",1014).
component("YOL115W",968).
component("YNL299W",931).
component("YNL262W",924).
component("YNL102W",905).
component("YJR043C",699).
component("YJR006W",694).
component("YJL090C",671).
component("YIL139C",645).
...
component("YKL035W",729).
component("YHL012W",587).
component("YHR123W",614).
component("YPR113W",1084).
component("YBR243C",279).
component("YNL130C",909).
component("YDL142C",342).
component("YPL148C",1042).
component("YER026C",455).
component("YCL004W",291).
component("YOR251C",1007).
component("YGR286C",583).
component("YJL068C",666).
component("YHR189W",622).
component("YDR058C",373).
component("YNR034W",941).
component("YHR163W",619).
component("YGR248W",576).
component("YCR073W-A",312).
component("YDL086W",328).
component("YOL011W",951).
component("YMR008C",855).
component("YMR006C",854).
component("U105_",25).
component("U101_",21).
component("YBL015W",222).
component("YJL068C",667).
component("YPL072W",1035).
component("YOR124C",984).
component("YNL186W",915).
component("YMR304W",894).
component("YMR223W",881).
component("YKR098C",770).
component("YJL197W",688).
component("YIL156W",647).
...
component("YJR019C",697).
component("YDR272W",405).
component("U84_",194).
component("YDR481C",431).
component("YLR377C",828).
component("YDR074W",377).
component("YFR025C",502).
component("YPL179W",1046).
component("YNR032W",939).
component("YML057W",843).
component("YML016C",836).
component("YLR433C",832).
...
component("YPR073C",1078).
component("YHR215W",626).
component("YDL024C",316).
component("YBR093C",257).
component("YBR092C",256).
component("YAR071W",218).
component("YIL053W",633).
component("YER062C",466).
component("YHR046C",601).
component("U9_",209).
component("YGR208W",572).
component("YPL228W",1052).
component("YMR180C",874).
component("YDL236W",357).
component("YJL155C",683).
component("YPR073C",1079).
component("YOR208W",999).
component("YNL053W",902).
component("YMR036C",860).
component("YIR026C",654).
component("YIL113W",641).
...
component("U25_",138).
component("U24_",137).
component("YOL064C",962).
component("YPL268W",1061).
component("YOR360C",1022).
component("YGL248W",537).
component("YKR031C",763).
component("YPL206C",1049).
component("YGL027C",517).
component("YLR286C",811).
component("YJR153W",720).
component("YJL221C",693).
component("YJL216C",691).
component("YIL172C",653).
component("YGR292W",585).
component("YGR287C",584).
component("YBR299W",290).
component("YBR184W",273).
component("YIL162W",650).
component("YPR026W",1071).
component("YDR001C",360).
component("YBR001C",233).
component("YOR190W",996).
component("YLR300W",813).
component("YGR282C",582).
component("YDR261C",403).
component("YDR400W",422).
component("U23_",136).
component("YML035C",839).
component("YJL070C",668).
component("YBR284W",287).
component("U102_",22).
component("YER043C",457).
component("YNL045W",900).
component("YLR160C",798).
component("YLR158C",797).
component("YLR157C",796).
component("YLR155C",795).
component("YDR321W",412).
component("YGL037C",518).
component("U43_",154).
component("U42_",153).
component("YMR293C",890).
component("YDR242W",400).
component("YLR308W",820).
component("YLR307W",819).
component("YBR208C",275).
component("YMR281W",889).
component("U53_",164).
component("YIR027C",655).
component("YPL111W",1039).
component("YIR032C",659).
component("YIR029W",657).
component("YPR062W",1076).
component("YMR120C",869).
component("YLR028C",779).
component("YHR144C",618).
component("YGR267C",581).
component("YCL030C",296).
component("YNL141W",910).
component("YBL033C",223).
component("YBR153W",269).
component("YDL238C",358).
component("YNL141W",911).
component("YLR245C",808).
component("YML035C",840).
component("YGR204W",570).
component("YBR084W",254).
component("YJL126W",675).
component("U44_",155).
component("YDL100C",332).
component("U87_",197).
component("U40_",151).
component("YMR267W",886).
component("YBR011C",237).
component("YHR201C",623).
component("YBR111C",258).
component("YBR252W",282).
component("YCL030C",297).
component("YPR080W",1081).
component("YOR187W",995).
component("YOR133W",987).
component("YLR069C",785).
component("YKR084C",767).
component("YKL173W",745).
component("YJL102W",673).
component("YDR385W",420).
component("YBR118W",261).
component("YER005W",451).
component("YLL001W",771).
component("YIL048W",632).
component("YER166W",485).
component("YDR093W",380).
component("YAL026C",212).
component("YBL099W",232).
component("U60_",171).
component("YLR231C",805).
component("U88_",198).
component("YLR134W",790).
component("YLR044C",781).
component("YGR087C",549).
component("YDR380W",419).
component("YDL080C",326).
component("U98_",207).
component("YMR250W",883).
component("YKL184W",750).
component("YOR128C",985).
component("YEL021W",442).
component("YNR043W",943).
component("U93_",204).
component("YDR047W",370).
component("U54_",165).
component("YKL211C",756) :- not remove_orf("YKL211C",756).
component("YKR097W",769).
component("YOL052C",955).
component("YNL169C",914).
component("YGR170W",559).
component("YKL060C",731).
component("YNL256W",923).
component("YDR294C",407).
component("YEL046C",444).
component("YNR033W",940).
component("YPR006C",1069).
component("YER065C",467).
component("YKL211C",757) :- not remove_orf("YKL211C",757).
component("YER090W",757) :- not remove_orf("YER090W",757).
component("YER090W",477) :- not remove_orf("YER090W",477).
component("YDR127W",387).
component("YPL281C",1066).
component("YOR393W",1027).
component("YMR323W",896).
component("YHR174W",620).
component("YGR254W",577).
component("YPL262W",1058).
component("YGL026C",516) :- not remove_orf("YGL026C",516).
component("YGR155W",557).
component("YLR304C",816).
component("YJL200C",689).
component("YDR234W",398).
component("YNL316C",932).
component("YKL182W",748).
component("YPL212C",1050).
component("YNL292W",930).
component("YGL063W",522).
component("YFL001W",489).
component("YOR278W",1009).
component("YPR002W",1068).
component("U49_",159).
component("YJR016C",696).
component("YCR053W",311).
component("YDR127W",388).
component("YGL148W",527).
component("YIL168W",652).
component("YIL167W",651).
component("YCL064C",302).
component("YER086W",474).
component("YCL064C",303).
component("YLR359W",827).
component("YAL012W",210).
component("YFR055W",508).
component("YJL005W",663).
component("YOR176W",993).
component("YJL121C",674).
component("YBR019C",240).
component("YBR019C",241).
component("YDR050C",371).
component("YDR007W",361) :- not remove_orf("YDR007W",361).
component("YOR095C",980).
component("YER003C",450).
component("YBR196C",274).
component("YGL001C",510).
component("YPL117C",1040).
component("U14_",61).
component("YOL056W",958).
component("YKL152C",743).
component("YDL021W",314).
component("YMR105C",864).
component("YKL127W",737).
component("YEL058W",447).
component("YFL045C",496).
component("YPR060C",1075).
component("YHR072W",606).
component("YJL153C",682).
component("YPL097W",1037).
component("YGR185C",565).
component("YGR264C",580).
component("YGR171C",560).
component("YHR011W",594).
component("YDR023W",364).
component("YPL104W",1038).
component("YLL018C",772).
component("YPR081C",1082).
component("YBR121C",262).
component("YHR020W",597).
component("YER087W",475).
component("YNL247W",919).
component("YOL033W",953).
component("YGL245W",536).
component("YHR091C",608).
component("YDR341C",413).
component("YOL097C",966).
component("YDR268W",404).
component("YPR047W",1074).
component("YLR060W",784).
component("YFL022C",493).
component("YPR033C",1072).
component("YHR019C",595).
component("YCR024C",307).
component("YHR019C",596).
component("YKL194C",753).
component("YIL078W",636).
component("YPL160W",1043).
component("YLR382C",829).
component("YNL073W",904).
component("YDR037W",366).
component("YOR335C",1015).
component("YGR094W",551).
component("YLR153C",794).
component("YAL054C",214).
component("YOR317W",1011).
component("YMR246W",882).
component("YIL009W",628).
component("YER015W",453).
component("YOR142W",989).
component("YGR244C",575).
component("YPR035W",1073).
component("U89_",199).
component("YOR241W",1006).
component("YMR113W",866).
component("YKL132C",738).
component("YOR339C",1016).
component("YMR022W",859).
component("YLR306W",818).
component("YKL210W",755).
...
component("YJL101C",672).
component("YOL049W",954).
component("U92_",203).
...
component("U91_",202).
component("U90_",201).
component("YNR057C",946).
component("YDL141W",339).
component("YDL141W",340).
component("YGL234W",535).
component("YDL141W",341).
component("YJR103W",709).
component("YBL039C",225).
component("YGR204W",571).
component("YBR084W",255).
component("YNL220W",917).
component("YOL058W",959).
component("YBR208C",276).
component("YHR074W",607).
component("YMR217W",879).
component("YGR061C",548).
component("YPR145W",1087).
component("YGR124W",554).
component("YOR303W",1010).
component("YJR109C",712).
component("YJL130C",678).
component("YGL062W",521).
component("YBR218C",277).
component("YPL231W",1056).
component("YNR016C",938).
component("YKL182W",749).
component("YGR037C",544).
component("YOR005C",974).
component("YDL164C",344).
component("YJL087C",669).
component("YOL010W",950).
component("YPR138C",1086).
component("YPL274W",1063).
component("YPL265W",1059).
component("YPL134C",1041).
component("YPL057C",1033).
component("YPL036W",1032).
component("YOR348C",1020).
component("YOR222W",1003).
component("YOR192C",997).
component("YOR171C",992).
component("YOR130C",986).
component("YOR100C",981).
component("YOR071C",978).
component("YOR011W",975).
component("YOL156W",973).
component("YOL103W",967).
component("YOL020W",952) :- not remove_orf("YOL020W",952).
component("YNR072W",948).
component("YNR056C",945).
component("YNL318C",933).
component("YNL268W",926).
component("YNL142W",912).
component("YMR272C",888).
component("YMR202W",876).
component("YMR011W",856).
component("YML123C",852).
component("YLR348C",824).
component("YLR260W",810).
component("YLR237W",806).
component("YLR138W",791).
component("YLR100C",788).
component("YLR081W",786).
component("YLL061W",775).
component("YLL043W",774).
component("YKR093W",768).
component("YKR053C",765).
component("YKR039W",764) :- not remove_orf("YKR039W",764).
component("YKL217W",759).
component("YKL120W",736).
component("YKL004W",724).
component("YJR158W",721).
component("YJR152W",719).
component("YJR095W",708).
component("YJR077C",706).
component("YJL219W",692).
component("YJL214W",690).
component("YJL134W",679).
component("YJL129C",676).
component("YIR028W",656).
component("YIL134W",644).
component("YHR096C",611).
component("YHR094C",610).
component("YHR092C",609).
component("YHL036W",590).
component("YHL016C",588).
...
catalyst(1960,370).
catalyst(3460,165).
catalyst(3600,756) :- not remove_reaction(3600,756).
catalyst(8000,769).
catalyst(3941,955).
catalyst(3942,955).
catalyst(6890,914).
...
catalyst(8020,1069).
catalyst(8020,467).
catalyst(1890,757) :- not remove_reaction(1890,757).
catalyst(3630,757) :- not remove_reaction(3630,757).
...
catalyst(1210,973).
catalyst(1160,967).
catalyst(801,952) :- not remove_reaction(801,952).
catalyst(802,952) :- not remove_reaction(802,952).
catalyst(811,952) :- not remove_reaction(811,952).
catalyst(812,952) :- not remove_reaction(812,952).
catalyst(831,952) :- not remove_reaction(831,952).
catalyst(832,952) :- not remove_reaction(832,952).
catalyst(901,952) :- not remove_reaction(901,952).
catalyst(902,952) :- not remove_reaction(902,952).
catalyst(941,952) :- not remove_reaction(941,952).
catalyst(942,952) :- not remove_reaction(942,952).
catalyst(1170,948).
catalyst(1180,948).
catalyst(1210,948).
catalyst(700,945).
...
catalyst(650,768).
catalyst(6560,765).
catalyst(681,764) :- not remove_reaction(681,764).
catalyst(682,764) :- not remove_reaction(682,764).
catalyst(761,764) :- not remove_reaction(761,764).
catalyst(762,764) :- not remove_reaction(762,764).
catalyst(771,764) :- not remove_reaction(771,764).
catalyst(772,764) :- not remove_reaction(772,764).
catalyst(781,764) :- not remove_reaction(781,764).
catalyst(782,764) :- not remove_reaction(782,764).
catalyst(791,764) :- not remove_reaction(791,764).
catalyst(792,764) :- not remove_reaction(792,764).
catalyst(801,764) :- not remove_reaction(801,764).
catalyst(802,764) :- not remove_reaction(802,764).
catalyst(811,764) :- not remove_reaction(811,764).
catalyst(812,764) :- not remove_reaction(812,764).
catalyst(821,764) :- not remove_reaction(821,764).
catalyst(822,764) :- not remove_reaction(822,764).
catalyst(831,764) :- not remove_reaction(831,764).
catalyst(832,764) :- not remove_reaction(832,764).
catalyst(841,764) :- not remove_reaction(841,764).
catalyst(842,764) :- not remove_reaction(842,764).
catalyst(861,764) :- not remove_reaction(861,764).
catalyst(862,764) :- not remove_reaction(862,764).
catalyst(881,764) :- not remove_reaction(881,764).
catalyst(882,764) :- not remove_reaction(882,764).
catalyst(901,764) :- not remove_reaction(901,764).
catalyst(902,764) :- not remove_reaction(902,764).
catalyst(911,764) :- not remove_reaction(911,764).
catalyst(912,764) :- not remove_reaction(912,764).
catalyst(921,764) :- not remove_reaction(921,764).
catalyst(922,764) :- not remove_reaction(922,764).
catalyst(941,764) :- not remove_reaction(941,764).
catalyst(942,764) :- not remove_reaction(942,764).
catalyst(1191,764) :- not remove_reaction(1191,764).
catalyst(1192,764) :- not remove_reaction(1192,764).
catalyst(390,759).
catalyst(1021,759).
catalyst(1022,759).
catalyst(1521,736).
...
modifiable_enzyme(756).
modifiable_enzyme(757).
modifiable_enzyme(477).
modifiable_enzyme(516).
modifiable_enzyme(361).
modifiable_enzyme(952).
modifiable_enzyme(764).
