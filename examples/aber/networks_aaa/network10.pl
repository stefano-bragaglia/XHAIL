...
component("YGL012W",80).
component("YGL001C",79).
component("YDR127W",55).
component("YJR139C",107).
component("YOR136W",139).
component("YIL155C",95).
component("YJR078W",105).
component("YJR025C",102).
component("YMR015C",122).
component("YGL154C",84).
component("YMR170C",124).
component("YMR169C",123).
component("YBR166C",39).
component("YER014W",71).
component("YEL047C",70).
component("YOR375C",148).
component("YAL062W",29).
component("U62_",25).
component("YPR074C",157).
component("YBR117C",37).
component("YPL231W",151).
component("YLR209C",116).
component("YDR354W",64) :- not remove_orf("YDR354W",64).
component("YFR047C",77).
component("YDR127W",56).
component("YJR130C",106).
component("YDR035W",51).
component("YBR249C",40).
component("YBR256C",41).
component("YHR137W",90).
component("YLR027C",115).
component("YKL106W",108).
component("YGL253W",85).
component("YFR053C",78).
component("YCR036W",44).
component("U83_",27).
component("YNL267W",131).
component("YLR305C",120).
component("YFR019W",76).
component("YDR208W",61).
component("YDR127W",57).
component("U20_",20).
component("YDR300C",63).
component("U76_",26).
component("YDR454C",66).
component("YOL061W",136).
component("YKL181W",110).
component("YHL011C",89).
component("YER099C",73).
component("YBL068W",30).
component("YOR143C",140).
component("YPR190C",161).
component("YPR187W",160).
component("YPR110C",158).
component("YPR010C",154).
component("YOR341W",147).
component("YOR340C",146).
component("YOR224C",144).
component("YOR210W",143).
component("YOR207C",142).
component("YOR151C",141).
component("YOR116C",138).
component("YOL005C",134).
component("YNR003C",133).
component("YNL248C",130).
component("YNL151C",129).
component("YNL113W",127).
component("YKL144C",109).
component("YJR063W",103).
component("YJL148W",100).
component("YJL140W",99).
component("YIL021W",94).
component("YHR143W-A",91).
component("YGL070C",82).
component("YFL036W",74).
component("YDR404C",65).
component("YDR156W",60).
component("YDR045C",52).
component("YDL150W",47).
component("YDL140C",46).
component("YBR154C",38).
component("YDR058C",54).
component("U84_",28).
component("YPR073C",156).
component("YHR215W",93).
component("YDL024C",45).
component("YBR093C",35).
component("YBR092C",34).
component("YPL228W",150).
component("YMR180C",125).
component("YDL236W",48).
component("YJL155C",101).
component("U30_",22).
component("YLR286C",119).
component("YML035C",121).
component("YJL070C",96).
component("YBR284W",42).
component("U53_",23).
component("YDL238C",49).
component("YLR245C",118).
component("YJL126W",97).
component("YBR111C",36).
component("YLR231C",117).
component("U54_",24).
component("YKL211C",111) :- not remove_orf("YKL211C",111).
component("YDR294C",62).
component("YKL211C",112) :- not remove_orf("YKL211C",112).
component("YER090W",112) :- not remove_orf("YER090W",112).
component("YER090W",72) :- not remove_orf("YER090W",72).
component("YDR127W",58).
component("YPL281C",153).
component("YOR393W",149).
component("YMR323W",126).
component("YHR174W",92).
component("YGR254W",88).
component("YGL026C",81) :- not remove_orf("YGL026C",81).
component("YNL316C",132).
component("YDR127W",59).
component("YGL148W",83).
component("YDR007W",50) :- not remove_orf("YDR007W",50).
component("YOR095C",137).
component("YPR060C",155).
component("YOR335C",145).
component("YGR094W",86).
component("YPR138C",159).
component("YPL265W",152).
component("YOL020W",135) :- not remove_orf("YOL020W",135).
component("YNL142W",128).
component("YKR053C",114).
component("YKR039W",113) :- not remove_orf("YKR039W",113).
component("YJR077C",104).
component("YJL134W",98).
component("YGR121C",87).
component("YFL055W",75).
component("YDR536W",69).
component("YDR508C",68).
component("YDR503C",67).
component("YDR046C",53) :- not remove_orf("YDR046C",53).
component("YCL025C",43).
...
catalyst(5611,116).
catalyst(5612,116).
catalyst(3620,64) :- not remove_reaction(3620,64).
catalyst(2190,77).
catalyst(3710,56).
catalyst(9661,106).
catalyst(9662,106).
...
catalyst(3500,117).
catalyst(3460,24).
catalyst(3600,111) :- not remove_reaction(3600,111).
catalyst(8781,62).
catalyst(8782,62).
catalyst(3630,112) :- not remove_reaction(3630,112).
...
catalyst(8231,88).
catalyst(8232,88).
catalyst(3590,81) :- not remove_reaction(3590,81).
catalyst(10910,81) :- not remove_reaction(10910,81).
catalyst(3680,132).
catalyst(3750,59).
catalyst(3700,83).
catalyst(3610,50) :- not remove_reaction(3610,50).
catalyst(7921,137).
catalyst(7922,137).
catalyst(3690,155).
catalyst(8631,145).
