...
component("YGL012W",44).
component("YDR127W",32).
component("YOR136W",67).
component("YJR078W",52).
component("YBR166C",24).
component("YDR354W",37) :- not remove_orf("YDR354W",37).
component("YFR047C",43).
component("YDR127W",33).
component("YJR130C",53).
component("YDR035W",30).
component("YBR249C",25).
component("YHR137W",50).
component("YLR027C",59).
component("YKL106W",54).
component("YCR036W",27).
component("YDR127W",34).
component("YOL061W",65).
component("YKL181W",55).
component("YHL011C",49).
component("YER099C",41).
component("YBL068W",20).
component("U53_",19).
component("YDL238C",28).
component("YBR111C",23).
component("YLR231C",60).
component("YKL211C",56) :- not remove_orf("YKL211C",56).
component("YKL211C",57) :- not remove_orf("YKL211C",57).
component("YER090W",57) :- not remove_orf("YER090W",57).
component("YER090W",40) :- not remove_orf("YER090W",40).
component("YDR127W",35).
component("YPL281C",71).
component("YOR393W",69).
component("YMR323W",61).
component("YHR174W",51).
component("YGR254W",48).
component("YGL026C",45) :- not remove_orf("YGL026C",45).
component("YNL316C",63).
component("YDR127W",36).
component("YGL148W",46).
component("YDR007W",29) :- not remove_orf("YDR007W",29).
component("YOR095C",66).
component("YPR060C",72).
component("YOR335C",68).
component("YPR138C",73).
component("YPL265W",70).
component("YOL020W",64) :- not remove_orf("YOL020W",64).
component("YNL142W",62).
component("YKR039W",58) :- not remove_orf("YKR039W",58).
component("YGR121C",47).
...
catalyst(8822,23).
catalyst(3500,60).
catalyst(3600,56) :- not remove_reaction(3600,56).
...
catalyst(8231,48).
catalyst(8232,48).
catalyst(3590,45) :- not remove_reaction(3590,45).
catalyst(10910,45) :- not remove_reaction(10910,45).
catalyst(3680,63).
catalyst(3750,36).
catalyst(3700,46).
...
catalyst(371,62).
catalyst(372,62).
catalyst(781,58) :- not remove_reaction(781,58).
catalyst(782,58) :- not remove_reaction(782,58).
catalyst(801,58) :- not remove_reaction(801,58).
catalyst(802,58) :- not remove_reaction(802,58).
catalyst(811,58) :- not remove_reaction(811,58).
catalyst(812,58) :- not remove_reaction(812,58).
catalyst(831,58) :- not remove_reaction(831,58).
catalyst(832,58) :- not remove_reaction(832,58).
catalyst(881,58) :- not remove_reaction(881,58).
catalyst(882,58) :- not remove_reaction(882,58).
catalyst(1191,58) :- not remove_reaction(1191,58).
catalyst(1192,58) :- not remove_reaction(1192,58).
catalyst(371,47).
catalyst(372,47).
catalyst(781,42).
catalyst(782,42).
