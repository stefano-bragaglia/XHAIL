...
component("YGR060W",271).
component("YGL012W",253).
component("YOL086C",460).
component("YMR303C",424).
component("YGL256W",265).
component("YDL168W",161).
component("YBR145W",125).
component("YPL231W",504).
component("YBR149W",126).
component("YGL001C",250).
component("YHR063C",296).
component("YBR153W",127).
component("YML056C",403).
component("YLR432W",399).
component("YHR216W",304).
component("YAR075W",102).
component("YAR073W",101).
component("YDR127W",178).
component("YJR139C",345).
component("YKL029C",349).
component("YOR136W",470).
component("YDL066W",152).
component("YLR355C",397).
component("YML086C",405).
component("YIL155C",312).
component("YPR191W",528).
component("YOR065W",465).
component("YJL166W",328).
component("YHR001W-A",292).
component("YGR183C",280).
component("YFR033C",246).
component("YDR529C",209).
component("YBL045C",107).
component("Q0105",18).
component("YGR088W",273).
component("YDR256C",191).
component("YJR078W",338).
component("YJR025C",333).
component("YGR255C",286).
component("YBL098W",110).
component("YMR015C",409).
component("YDR402C",201).
component("YJR104C",341).
component("YHR008C",293).
component("YER070W",227).
component("U35_",63).
component("YDL168W",162).
component("YDR158W",185).
component("YPL276W",512).
component("YPL275W",511).
component("YOR388C",492).
component("YGL154C",260).
component("U55_",72).
component("YOR323C",482).
component("YMR170C",417).
component("YMR169C",416).
component("U2_",60).
component("U52_",69).
component("YBR166C",130).
component("YNL280C",444).
component("YER014W",218).
component("YMR118C",414).
component("YLR164W",382).
component("YLL041C",372).
component("YKL148C",356).
component("YJL045W",317).
component("YDR178W",186).
component("YJR051W",335).
component("YEL047C",213).
component("YOR375C",490).
component("YDL215C",164).
component("YAL062W",99).
component("U99_",95).
component("YBR035C",116).
component("YKR080W",369).
...
component("YHR042W",294).
component("YPL017C",495).
component("YFL018C",238).
component("YER042W",221).
component("YPL273W",510).
component("YLL062C",374).
component("U47_",66).
component("YER091C",230).
component("YDL033C",150).
component("YOL096C",461).
component("YDR019C",169).
component("YDR408C",203).
component("YBL013W",103).
component("YKL024C",348).
component("YPR074C",521).
component("YBR117C",124).
component("YLR354C",396).
component("YGR043C",269).
component("YCL009C",141).
component("YMR062C",411).
component("YPL231W",505).
component("U86_",88).
component("YPL001W",494).
component("YOR377W",491).
component("YGR177C",279).
component("YPL231W",506).
component("YGR147C",276).
component("YDL040C",151).
component("YPL028W",496).
component("YPR001W",514).
component("YNR001C",448).
component("YDL182W",163).
component("YNL117W",432).
component("YIR031C",315).
component("YNL029C",427).
component("YIL085C",309).
component("YNL192W",437).
component("YBR038W",117).
component("YBR023C",115).
component("YLR209C",383).
component("YMR300C",423).
component("YER055C",222).
component("YDR354W",197) :- not remove_orf("YDR354W",197).
component("YFR047C",247).
component("YJR133W",344).
component("YLR209C",384).
component("YML022W",400).
component("YDR441C",205).
component("YDR399W",199).
component("YNL256W",439).
component("YDR127W",179).
component("YLR303W",390).
component("YJR130C",343).
component("YLR303W",391).
component("YDR035W",170).
component("YBR249C",134).
component("YBR256C",135).
component("YHR137W",299).
component("YGL202W",262).
component("YLR027C",375).
component("YKL106W",352).
component("YKL104C",351).
component("YGR019W",267).
component("YLR089C",378).
component("U64_",75).
component("U51_",68).
component("YJR148W",346).
component("YGL253W",264).
component("YFR053C",248).
component("YMR205C",419).
component("YGR240C",283).
component("YDR248C",190).
component("YCR036W",148).
component("YCL040W",143).
component("YJR105W",342).
component("U16_",36).
component("U15_",33).
component("U96_",93).
component("YKL001C",347).
component("YML070W",404).
component("YFL053W",241).
component("YHL032C",290).
component("U83_",86).
component("U82_",85).
component("YMR208W",420).
component("YOR347C",487).
component("YAL038W",98).
component("YPR121W",523).
component("YPL258C",508).
component("YOL055C",457).
component("U1_",45).
component("YBR020W",113).
component("YNL267W",441).
component("YLR305C",393).
component("YFR019W",244).
component("YDR208W",187).
component("YDR127W",180).
component("U21_",52).
component("U20_",50).
component("YDR147W",183).
component("YDR300C",195).
component("YCR012W",145).
component("U18_",42).
component("U76_",83).
component("YER170W",236).
component("YDR226W",188).
component("YDR454C",206).
component("YOL061W",459).
component("YKL181W",359).
component("YHL011C",288).
component("YER099C",232).
component("YBL068W",109).
component("YOR143C",471).
component("YGR007W",266).
component("YLR328W",394).
component("YJR010W",332).
component("YCL050C",144).
component("YPR190C",527).
component("YPR187W",526).
component("YPR110C",522).
component("YPR010C",516).
component("YOR341W",486).
component("YOR340C",485).
component("YOR224C",478).
component("YOR210W",477).
component("YOR207C",475).
component("YOR151C",472).
component("YOR116C",468).
component("YOL005C",453).
component("YNR003C",449).
component("YNL248C",438).
component("YNL151C",435).
component("YNL113W",431).
component("YKL144C",355).
component("YJR063W",336).
component("YJL148W",326).
component("YJL140W",325).
component("YIL021W",305).
component("YHR143W-A",300).
component("YGL070C",258).
component("YFL036W",240).
component("YDR404C",202).
component("YDR156W",184).
component("YDR045C",171).
component("YDL150W",159).
component("YDL140C",157).
component("YBR154C",129).
component("YPR175W",525).
component("YPL167C",501).
component("YOR330C",483).
component("YOL115W",463).
component("YNL299W",446).
component("YNL262W",440).
component("YNL102W",430).
component("YJR043C",334).
component("YJR006W",331).
component("YJL090C",320).
component("YIL139C",311).
component("YEL055C",214).
component("YDR419W",204).
component("YDR121W",177).
component("YDL102W",155).
component("YCR014C",146).
component("YBR278W",137).
component("YBL035C",105).
component("YKL035W",350).
component("YHL012W",289).
component("YER026C",220).
component("YDR058C",174).
component("YDL086W",154).
component("YOL011W",454).
component("YMR008C",408).
component("YMR006C",407).
component("U101_",19).
component("YBL015W",104).
component("YJL068C",318).
component("YPL072W",498).
component("YOR124C",469).
component("YNL186W",436).
component("YMR304W",425).
component("YMR223W",421).
component("YKR098C",370).
component("YJL197W",329).
component("YIL156W",313).
component("YFR010W",243).
component("YER151C",234).
component("YER144C",233).
component("YER098W",231).
component("YDR069C",175).
component("YDL122W",156).
component("YBR058C",118).
component("YBL067C",108).
component("U84_",87).
component("YPR073C",519).
component("YHR215W",303).
component("YDL024C",149).
component("YBR093C",122).
component("YBR092C",121).
component("YAR071W",100).
component("YIL053W",308).
component("YER062C",226).
component("YHR046C",295).
component("YGR208W",282).
component("YPL228W",503).
component("YMR180C",418).
component("YDL236W",166).
component("YJL155C",327).
component("YPR073C",520).
component("YOR208W",476).
component("YNL053W",429).
component("YMR036C",410).
component("YIR026C",314).
component("YIL113W",310).
component("YFR028C",245).
component("YER075C",228).
component("YDL230W",165).
component("YBR276C",136).
component("U34_",62).
component("U30_",61).
component("U25_",59).
component("U24_",58).
component("YOR360C",489).
component("YGL248W",263).
component("YKR031C",366).
component("YLR286C",388).
component("YOR190W",473).
component("YLR300W",389).
component("YGR282C",287).
component("YDR261C",192).
component("YDR400W",200).
component("U23_",57).
component("YML035C",401).
component("YJL070C",319).
component("YBR284W",138).
component("U102_",20).
component("YNL045W",428).
component("YGL037C",255).
component("YDR242W",189).
component("YBR208C",131).
component("U53_",70).
component("YIR032C",316).
component("YMR120C",415).
component("YHR144C",301).
component("YBR153W",128).
component("YDL238C",167).
component("YNL141W",433).
component("YLR245C",387).
component("YML035C",402).
component("YJL126W",322).
component("U87_",89).
component("YBR111C",123).
component("YER005W",217).
component("YIL048W",307).
component("YER166W",235).
component("YDR093W",176).
component("YAL026C",97).
component("YLR231C",385).
component("U88_",90).
component("YLR134W",380).
component("YLR044C",376).
component("YGR087C",272).
component("YDR380W",198).
component("YDL080C",153).
component("U98_",94).
component("YKL184W",362).
component("YNR043W",452).
component("U93_",92).
component("U54_",71).
component("YKL211C",363) :- not remove_orf("YKL211C",363).
component("YGR170W",278).
component("YDR294C",193).
component("YEL046C",212).
component("YNR033W",451).
component("YKL211C",364) :- not remove_orf("YKL211C",364).
component("YER090W",364) :- not remove_orf("YER090W",364).
component("YER090W",229) :- not remove_orf("YER090W",229).
component("YDR127W",181).
component("YPL281C",513).
component("YOR393W",493).
component("YMR323W",426).
component("YHR174W",302).
component("YGR254W",285).
component("YGL026C",254) :- not remove_orf("YGL026C",254).
component("YGR155W",277).
component("YLR304C",392).
component("YJL200C",330).
component("YNL316C",447).
component("YKL182W",360).
component("YPL212C",502).
component("YNL292W",445).
component("YGL063W",257).
component("YFL001W",237).
component("YPR002W",515).
component("YDR127W",182).
component("YGL148W",259).
component("YAL012W",96).
component("YFR055W",249).
component("YBR019C",111).
component("YBR019C",112).
component("YDR050C",173).
component("YDR007W",168) :- not remove_orf("YDR007W",168).
component("YOR095C",467).
component("YER003C",216).
component("YGL001C",251).
component("YKL152C",358).
component("YMR105C",412).
component("YKL127W",353).
component("YEL058W",215).
component("YPR060C",518).
component("YPL104W",499).
component("YLL018C",371).
component("YOL033W",456).
component("YHR091C",298).
component("YDR341C",196).
component("YOL097C",462).
component("YPR047W",517).
component("YLR060W",377).
component("YFL022C",239).
component("YPL160W",500).
component("YLR382C",398).
component("YOR335C",484).
component("YGR094W",274).
component("YGR244C",284).
component("U89_",91).
component("YOR241W",480).
component("YMR113W",413).
component("YKL132C",354).
component("YJL101C",321).
component("YDL141W",158).
component("YJR103W",340).
component("YBL039C",106).
component("YOL058W",458).
component("YBR208C",132).
component("YHR074W",297).
component("YOR303W",481).
component("YGL062W",256).
component("YBR218C",133).
component("YPL231W",507).
component("YNR016C",450).
component("YKL182W",361).
component("YGR037C",268).
component("YOR005C",464).
component("YDL164C",160).
component("YPR138C",524).
component("YPL265W",509).
component("YPL036W",497).
component("YOR348C",488).
component("YOR192C",474).
component("YOR071C",466).
component("YOL020W",455) :- not remove_orf("YOL020W",455).
component("YNL268W",442).
component("YNL142W",434).
component("YMR272C",422).
component("YML123C",406).
component("YLR348C",395).
component("YLR237W",386).
component("YLR138W",381).
component("YLR100C",379).
component("YLL061W",373).
component("YKR053C",368).
component("YKR039W",367) :- not remove_orf("YKR039W",367).
component("YKL217W",365).
component("YJR095W",339).
component("YJR077C",337).
component("YJL134W",324).
component("YJL129C",323).
component("YHL036W",291).
component("YGR121C",275).
component("YGR055W",270).
component("YGL186C",261).
component("YGL008C",252).
component("YFL055W",242).
component("YER060W-A",225).
component("YER060W",224).
component("YER056C",223).
component("YEL017C-A",211).
component("YDR536W",210).
component("YDR508C",208).
component("YDR503C",207).
component("YDR294C",194).
component("YDR046C",172) :- not remove_orf("YDR046C",172).
component("YCR024C-A",147).
component("YCL025C",142).
component("YBR298C",140).
component("YBR291C",139).
component("YBR069C",120) :- not remove_orf("YBR069C",120).
component("YBR068C",119) :- not remove_orf("YBR068C",119).
component("YBR021W",114).
component("U79_",84).
component("U75_",82).
component("U74_",81).
component("U73_",80).
...
catalyst(2300,92).
catalyst(3460,71).
catalyst(3600,363) :- not remove_reaction(3600,363).
catalyst(6900,278).
catalyst(8781,193).
catalyst(8782,193).
catalyst(4560,212).
...
catalyst(8231,285).
catalyst(8232,285).
catalyst(3590,254) :- not remove_reaction(3590,254).
catalyst(10910,254) :- not remove_reaction(10910,254).
catalyst(4570,277).
catalyst(8181,392).
catalyst(8182,392).
catalyst(8181,330).
...
catalyst(8281,173).
catalyst(8282,173).
catalyst(3610,168) :- not remove_reaction(3610,168).
catalyst(7921,467).
catalyst(7922,467).
catalyst(7841,216).
catalyst(7842,216).
...
catalyst(941,455) :- not remove_reaction(941,455).
catalyst(942,455) :- not remove_reaction(942,455).
catalyst(761,442).
catalyst(762,442).
catalyst(371,434).
catalyst(372,434).
...
catalyst(750,373).
catalyst(6560,368).
catalyst(761,367) :- not remove_reaction(761,367).
catalyst(762,367) :- not remove_reaction(762,367).
...
catalyst(861,367) :- not remove_reaction(861,367).
catalyst(862,367) :- not remove_reaction(862,367).
catalyst(881,367) :- not remove_reaction(881,367).
catalyst(882,367) :- not remove_reaction(882,367).
catalyst(941,367) :- not remove_reaction(941,367).
catalyst(942,367) :- not remove_reaction(942,367).
...
catalyst(831,172) :- not remove_reaction(831,172).
catalyst(832,172) :- not remove_reaction(832,172).
catalyst(841,172) :- not remove_reaction(841,172).
catalyst(842,172) :- not remove_reaction(842,172).
...
catalyst(1511,139).
catalyst(1512,139).
catalyst(771,120) :- not remove_reaction(771,120).
catalyst(772,120) :- not remove_reaction(772,120).
catalyst(791,120) :- not remove_reaction(791,120).
catalyst(792,120) :- not remove_reaction(792,120).
...
catalyst(861,120) :- not remove_reaction(861,120).
catalyst(862,120) :- not remove_reaction(862,120).
catalyst(791,119) :- not remove_reaction(791,119).
catalyst(792,119) :- not remove_reaction(792,119).
catalyst(801,119) :- not remove_reaction(801,119).
catalyst(802,119) :- not remove_reaction(802,119).
catalyst(811,119) :- not remove_reaction(811,119).
catalyst(812,119) :- not remove_reaction(812,119).
catalyst(831,119) :- not remove_reaction(831,119).
catalyst(832,119) :- not remove_reaction(832,119).
catalyst(841,119) :- not remove_reaction(841,119).
catalyst(842,119) :- not remove_reaction(842,119).
catalyst(861,119) :- not remove_reaction(861,119).
catalyst(862,119) :- not remove_reaction(862,119).
catalyst(620,114).
catalyst(2830,84).
catalyst(2920,82).
catalyst(2920,81).
