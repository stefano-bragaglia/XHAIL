...
component("YGR060W",264).
component("YGL012W",246).
component("YOL086C",451).
component("YMR303C",416).
component("YGL256W",258).
component("YDL168W",157).
component("YBR145W",122).
component("YPL231W",495).
component("YBR149W",123).
component("YGL001C",243).
component("YHR063C",289).
component("YBR153W",124).
component("YML056C",395).
component("YLR432W",391).
component("YHR216W",297).
component("YAR075W",100).
component("YAR073W",99).
component("YDR127W",173).
component("YJR139C",338).
component("YKL029C",342).
component("YOR136W",461).
component("YDL066W",149).
component("YML086C",397).
component("YIL155C",305).
component("YPR191W",519).
component("YOR065W",456).
component("YJL166W",321).
component("YHR001W-A",285).
component("YGR183C",273).
component("YFR033C",239).
component("YDR529C",203).
component("YBL045C",105).
component("Q0105",18).
component("YGR088W",266).
component("YDR256C",185).
component("YJR078W",331).
component("YJR025C",326).
component("YGR255C",279).
component("YBL098W",108).
component("YMR015C",401).
component("YDR402C",195).
component("YJR104C",334).
component("YHR008C",286).
component("YER070W",220).
component("U35_",62).
component("YDL168W",158).
component("YPL276W",503).
component("YPL275W",502).
component("YOR388C",483).
component("YGL154C",253).
component("U55_",70).
component("YOR323C",473).
component("YMR170C",409).
component("YMR169C",408).
component("U2_",59).
component("YBR166C",127).
component("YNL280C",435).
component("YER014W",212).
component("YMR118C",406).
component("YLR164W",375).
component("YLL041C",365).
component("YKL148C",349).
component("YJL045W",310).
component("YDR178W",180).
component("YJR051W",328).
component("YEL047C",207).
component("YOR375C",481).
component("YDL215C",160).
component("YAL062W",97).
component("U99_",93).
component("YBR035C",113).
component("YKR080W",362).
component("YER023W",213).
component("YOR236W",470).
component("YGR204W",274).
component("U62_",72).
component("YKL150W",350).
component("YIL043C",299).
component("YHR042W",287).
component("YPL017C",486).
component("YFL018C",231).
component("YPL273W",501).
component("YLL062C",367).
component("U47_",65).
component("YER091C",223).
component("YDL033C",147).
component("YOL096C",452).
component("YDR408C",197).
component("YBL013W",101).
component("YKL024C",341).
component("YPR074C",512).
component("YBR117C",121).
component("YLR354C",389).
component("YGR043C",262).
component("YCL009C",138).
component("YMR062C",403).
component("YPL231W",496).
component("U86_",86).
component("YPL001W",485).
component("YOR377W",482).
component("YGR177C",272).
component("YPL231W",497).
component("YGR147C",269).
component("YDL040C",148).
component("YPL028W",487).
component("YPR001W",505).
component("YNR001C",439).
component("YDL182W",159).
component("YNL117W",424).
component("YIR031C",308).
component("YNL029C",419).
component("YIL085C",302).
component("YNL192W",429).
component("YBR038W",114).
component("YBR023C",112).
component("YLR209C",376).
component("YMR300C",415).
component("YER055C",215).
component("YDR354W",191) :- not remove_orf("YDR354W",191).
component("YFR047C",240).
component("YJR133W",337).
component("YLR209C",377).
component("YML022W",392).
component("YDR441C",199).
component("YDR399W",193).
component("YNL256W",431).
component("YDR127W",174).
component("YLR303W",383).
component("YJR130C",336).
component("YLR303W",384).
component("YDR035W",165).
component("YBR249C",131).
component("YBR256C",132).
component("YHR137W",292).
component("YGL202W",255).
component("YLR027C",368).
component("YKL106W",345).
component("YKL104C",344).
component("YGR019W",260).
component("YLR089C",371).
component("U64_",73).
component("U51_",67).
component("YJR148W",339).
component("YGL253W",257).
component("YFR053C",241).
component("YMR205C",411).
component("YGR240C",276).
component("YDR248C",184).
component("YCR036W",145).
component("YCL040W",140).
component("YJR105W",335).
component("U16_",36).
component("U15_",33).
component("U96_",91).
component("YKL001C",340).
component("YML070W",396).
component("YFL053W",234).
component("YHL032C",283).
component("U83_",84).
component("U82_",83).
component("YMR208W",412).
component("YOR347C",478).
component("YAL038W",96).
component("YPR121W",514).
component("YPL258C",499).
component("YOL055C",448).
component("U1_",45).
component("YNL267W",433).
component("YLR305C",386).
component("YFR019W",237).
component("YDR208W",181).
component("YDR127W",175).
component("U21_",51).
component("U20_",49).
component("YDR147W",178).
component("YDR300C",189).
component("YCR012W",142).
component("U18_",42).
component("U76_",81).
component("YER170W",229).
component("YDR226W",182).
component("YDR454C",200).
component("YOL061W",450).
component("YKL181W",352).
component("YHL011C",281).
component("YER099C",225).
component("YBL068W",107).
component("YOR143C",462).
component("YGR007W",259).
component("YLR328W",387).
component("YJR010W",325).
component("YCL050C",141).
component("YPR190C",518).
component("YPR187W",517).
component("YPR110C",513).
component("YPR010C",507).
component("YOR341W",477).
component("YOR340C",476).
component("YOR224C",469).
component("YOR210W",468).
component("YOR207C",466).
component("YOR151C",463).
component("YOR116C",459).
component("YOL005C",444).
component("YNR003C",440).
component("YNL248C",430).
component("YNL151C",427).
component("YNL113W",423).
component("YKL144C",348).
component("YJR063W",329).
component("YJL148W",319).
component("YJL140W",318).
component("YIL021W",298).
component("YHR143W-A",293).
component("YGL070C",251).
component("YFL036W",233).
component("YDR404C",196).
component("YDR156W",179).
component("YDR045C",166).
component("YDL150W",155).
component("YDL140C",154).
component("YBR154C",126).
component("YPR175W",516).
component("YPL167C",492).
component("YOR330C",474).
component("YOL115W",454).
component("YNL299W",437).
component("YNL262W",432).
component("YNL102W",422).
component("YJR043C",327).
component("YJR006W",324).
component("YJL090C",313).
component("YIL139C",304).
component("YEL055C",208).
component("YDR419W",198).
component("YDR121W",172).
component("YDL102W",152).
component("YCR014C",143).
component("YBR278W",134).
component("YBL035C",103).
component("YKL035W",343).
component("YHL012W",282).
component("YER026C",214).
component("YDR058C",169).
component("YDL086W",151).
component("YOL011W",445).
component("YMR008C",400).
component("YMR006C",399).
component("U101_",19).
component("YBL015W",102).
component("YJL068C",311).
component("YPL072W",489).
component("YOR124C",460).
component("YNL186W",428).
component("YMR304W",417).
component("YMR223W",413).
component("YKR098C",363).
component("YJL197W",322).
component("YIL156W",306).
component("YFR010W",236).
component("YER151C",227).
component("YER144C",226).
component("YER098W",224).
component("YDR069C",170).
component("YDL122W",153).
component("YBR058C",115).
component("YBL067C",106).
component("U84_",85).
component("YPR073C",510).
component("YHR215W",296).
component("YDL024C",146).
component("YBR093C",119).
component("YBR092C",118).
component("YAR071W",98).
component("YIL053W",301).
component("YER062C",219).
component("YHR046C",288).
component("YGR208W",275).
component("YPL228W",494).
component("YMR180C",410).
component("YDL236W",162).
component("YJL155C",320).
component("YPR073C",511).
component("YOR208W",467).
component("YNL053W",421).
component("YMR036C",402).
component("YIR026C",307).
component("YIL113W",303).
component("YFR028C",238).
component("YER075C",221).
component("YDL230W",161).
component("YBR276C",133).
component("U34_",61).
component("U30_",60).
component("U25_",58).
component("U24_",57).
component("YOR360C",480).
component("YGL248W",256).
component("YKR031C",359).
component("YLR286C",381).
component("YOR190W",464).
component("YLR300W",382).
component("YGR282C",280).
component("YDR261C",186).
component("YDR400W",194).
component("U23_",56).
component("YML035C",393).
component("YJL070C",312).
component("YBR284W",135).
component("U102_",20).
component("YNL045W",420).
component("YGL037C",248).
component("YDR242W",183).
component("YBR208C",128).
component("U53_",68).
component("YIR032C",309).
component("YMR120C",407).
component("YHR144C",294).
component("YBR153W",125).
component("YDL238C",163).
component("YNL141W",425).
component("YLR245C",380).
component("YML035C",394).
component("YJL126W",315).
component("U87_",87).
component("YBR111C",120).
component("YER005W",211).
component("YIL048W",300).
component("YER166W",228).
component("YDR093W",171).
component("YAL026C",95).
component("YLR231C",378).
component("U88_",88).
component("YLR134W",373).
component("YLR044C",369).
component("YGR087C",265).
component("YDR380W",192).
component("YDL080C",150).
component("U98_",92).
component("YKL184W",355).
component("YNR043W",443).
component("U93_",90).
component("U54_",69).
component("YKL211C",356) :- not remove_orf("YKL211C",356).
component("YGR170W",271).
component("YDR294C",187).
component("YEL046C",206).
component("YNR033W",442).
component("YKL211C",357) :- not remove_orf("YKL211C",357).
component("YER090W",357) :- not remove_orf("YER090W",357).
component("YER090W",222) :- not remove_orf("YER090W",222).
component("YDR127W",176).
component("YPL281C",504).
component("YOR393W",484).
component("YMR323W",418).
component("YHR174W",295).
component("YGR254W",278).
component("YGL026C",247) :- not remove_orf("YGL026C",247).
component("YGR155W",270).
component("YLR304C",385).
component("YJL200C",323).
component("YNL316C",438).
component("YKL182W",353).
component("YPL212C",493).
component("YNL292W",436).
component("YGL063W",250).
component("YFL001W",230).
component("YPR002W",506).
component("YDR127W",177).
component("YGL148W",252).
component("YAL012W",94).
component("YFR055W",242).
component("YBR019C",109).
component("YBR019C",110).
component("YDR050C",168).
component("YDR007W",164) :- not remove_orf("YDR007W",164).
component("YOR095C",458).
component("YER003C",210).
component("YGL001C",244).
component("YKL152C",351).
component("YMR105C",404).
component("YKL127W",346).
component("YEL058W",209).
component("YPR060C",509).
component("YPL104W",490).
component("YLL018C",364).
component("YOL033W",447).
component("YHR091C",291).
component("YDR341C",190).
component("YOL097C",453).
component("YPR047W",508).
component("YLR060W",370).
component("YFL022C",232).
component("YPL160W",491).
component("YLR382C",390).
component("YOR335C",475).
component("YGR094W",267).
component("YGR244C",277).
component("U89_",89).
component("YOR241W",471).
component("YMR113W",405).
component("YKL132C",347).
component("YJL101C",314).
component("YJR103W",333).
component("YBL039C",104).
component("YOL058W",449).
component("YBR208C",129).
component("YHR074W",290).
component("YOR303W",472).
component("YGL062W",249).
component("YBR218C",130).
component("YPL231W",498).
component("YNR016C",441).
component("YKL182W",354).
component("YGR037C",261).
component("YOR005C",455).
component("YDL164C",156).
component("YPR138C",515).
component("YPL265W",500).
component("YPL036W",488).
component("YOR348C",479).
component("YOR192C",465).
component("YOR071C",457).
component("YOL020W",446) :- not remove_orf("YOL020W",446).
component("YNL268W",434).
component("YNL142W",426).
component("YMR272C",414).
component("YML123C",398).
component("YLR348C",388).
component("YLR237W",379).
component("YLR138W",374).
component("YLR100C",372).
component("YLL061W",366).
component("YKR053C",361).
component("YKR039W",360) :- not remove_orf("YKR039W",360).
component("YKL217W",358).
component("YJR095W",332).
component("YJR077C",330).
component("YJL134W",317).
component("YJL129C",316).
component("YHL036W",284).
component("YGR121C",268).
component("YGR055W",263).
component("YGL186C",254).
component("YGL008C",245).
component("YFL055W",235).
component("YER060W-A",218).
component("YER060W",217).
component("YER056C",216).
component("YEL017C-A",205).
component("YDR536W",204).
component("YDR508C",202).
component("YDR503C",201).
component("YDR294C",188).
component("YDR046C",167) :- not remove_orf("YDR046C",167).
component("YCR024C-A",144).
component("YCL025C",139).
component("YBR298C",137).
component("YBR291C",136).
component("YBR069C",117) :- not remove_orf("YBR069C",117).
component("YBR068C",116) :- not remove_orf("YBR068C",116).
component("YBR021W",111).
component("U79_",82).
component("U75_",80).
component("U74_",79).
component("U73_",78).
...
catalyst(6160,415).
catalyst(3870,215).
catalyst(3620,191) :- not remove_reaction(3620,191).
catalyst(2190,240).
catalyst(5550,337).
catalyst(5791,377).
catalyst(5792,377).
...
catalyst(2300,90).
catalyst(3460,69).
catalyst(3600,356) :- not remove_reaction(3600,356).
catalyst(6900,271).
catalyst(8781,187).
catalyst(8782,187).
catalyst(4560,206).
...
catalyst(3630,222) :- not remove_reaction(3630,222).
catalyst(3740,176).
catalyst(8231,504).
catalyst(8232,504).
catalyst(8231,484).
...
catalyst(8231,278).
catalyst(8232,278).
catalyst(3590,247) :- not remove_reaction(3590,247).
catalyst(10910,247) :- not remove_reaction(10910,247).
catalyst(4570,270).
catalyst(8181,385).
catalyst(8182,385).
catalyst(8181,323).
...
catalyst(8281,168).
catalyst(8282,168).
catalyst(3610,164) :- not remove_reaction(3610,164).
catalyst(7921,458).
catalyst(7922,458).
catalyst(7841,210).
catalyst(7842,210).
...
catalyst(190,465).
catalyst(190,457).
catalyst(801,446) :- not remove_reaction(801,446).
catalyst(802,446) :- not remove_reaction(802,446).
catalyst(811,446) :- not remove_reaction(811,446).
catalyst(812,446) :- not remove_reaction(812,446).
catalyst(831,446) :- not remove_reaction(831,446).
catalyst(832,446) :- not remove_reaction(832,446).
catalyst(941,446) :- not remove_reaction(941,446).
catalyst(942,446) :- not remove_reaction(942,446).
catalyst(761,434).
catalyst(762,434).
catalyst(371,426).
catalyst(372,426).
...
catalyst(750,366).
catalyst(6560,361).
catalyst(761,360) :- not remove_reaction(761,360).
catalyst(762,360) :- not remove_reaction(762,360).
catalyst(771,360) :- not remove_reaction(771,360).
catalyst(772,360) :- not remove_reaction(772,360).
catalyst(781,360) :- not remove_reaction(781,360).
catalyst(782,360) :- not remove_reaction(782,360).
...
catalyst(861,360) :- not remove_reaction(861,360).
catalyst(862,360) :- not remove_reaction(862,360).
catalyst(881,360) :- not remove_reaction(881,360).
catalyst(882,360) :- not remove_reaction(882,360).
catalyst(941,360) :- not remove_reaction(941,360).
catalyst(942,360) :- not remove_reaction(942,360).
catalyst(1191,360) :- not remove_reaction(1191,360).
catalyst(1192,360) :- not remove_reaction(1192,360).
catalyst(1021,358).
catalyst(1022,358).
catalyst(1250,332).
catalyst(1581,330).
...
catalyst(6680,201).
catalyst(6550,188).
catalyst(791,167) :- not remove_reaction(791,167).
catalyst(792,167) :- not remove_reaction(792,167).
catalyst(801,167) :- not remove_reaction(801,167).
catalyst(802,167) :- not remove_reaction(802,167).
catalyst(811,167) :- not remove_reaction(811,167).
catalyst(812,167) :- not remove_reaction(812,167).
catalyst(831,167) :- not remove_reaction(831,167).
catalyst(832,167) :- not remove_reaction(832,167).
catalyst(841,167) :- not remove_reaction(841,167).
catalyst(842,167) :- not remove_reaction(842,167).
catalyst(861,167) :- not remove_reaction(861,167).
catalyst(862,167) :- not remove_reaction(862,167).
catalyst(220,144).
catalyst(771,139).
catalyst(772,139).
catalyst(781,139).
...
catalyst(1511,136).
catalyst(1512,136).
catalyst(771,117) :- not remove_reaction(771,117).
catalyst(772,117) :- not remove_reaction(772,117).
catalyst(791,117) :- not remove_reaction(791,117).
catalyst(792,117) :- not remove_reaction(792,117).
catalyst(801,117) :- not remove_reaction(801,117).
catalyst(802,117) :- not remove_reaction(802,117).
catalyst(811,117) :- not remove_reaction(811,117).
catalyst(812,117) :- not remove_reaction(812,117).
catalyst(861,117) :- not remove_reaction(861,117).
catalyst(862,117) :- not remove_reaction(862,117).
catalyst(791,116) :- not remove_reaction(791,116).
catalyst(792,116) :- not remove_reaction(792,116).
catalyst(801,116) :- not remove_reaction(801,116).
catalyst(802,116) :- not remove_reaction(802,116).
catalyst(811,116) :- not remove_reaction(811,116).
catalyst(812,116) :- not remove_reaction(812,116).
catalyst(831,116) :- not remove_reaction(831,116).
catalyst(832,116) :- not remove_reaction(832,116).
catalyst(841,116) :- not remove_reaction(841,116).
catalyst(842,116) :- not remove_reaction(842,116).
catalyst(861,116) :- not remove_reaction(861,116).
catalyst(862,116) :- not remove_reaction(862,116).
catalyst(620,111).
catalyst(2830,82).
catalyst(2920,80).
catalyst(2920,79).
...
modifiable_enzyme(167).
modifiable_enzyme(117).
modifiable_enzyme(116).
