...
component("YNL280C",636).
component("YGR060W",378).
component("YGL012W",353).
component("YKR009C",519).
component("YOL086C",664).
component("YMR303C",608).
component("YMR083W",586).
...
component("YJR159W",491).
component("YGL001C",350).
component("YIL094C",434).
component("YHR063C",417).
component("YBR153W",176).
component("YML056C",573).
component("YLR432W",567).
component("YHR216W",428).
component("YAR075W",140).
component("YAR073W",139).
component("YDR127W",257).
component("YJR139C",486).
component("YOL126C",669).
component("YDL078C",213).
component("YKL029C",496).
component("YOR136W",679).
component("YNL037C",612).
component("YDL066W",212).
component("YNL241C",627).
component("YOL059W",662).
component("YDL022W",207).
component("YLR355C",564).
component("YDL174C",232).
component("YML086C",576).
component("YIL155C",440).
component("YPR191W",754).
component("YOR065W",674).
component("YJL166W",464).
component("YHR001W-A",409).
component("YGR183C",390).
component("YFR033C",346).
component("YDR529C",296).
component("YBL045C",146).
component("Q0105",18).
component("YGR088W",380).
component("YDR256C",271).
component("YKL026C",495).
component("YIR037W",447).
component("YBR244W",186).
component("YJR078W",477).
component("YJR025C",471).
component("YGR255C",402).
component("U108_",22).
component("YBL098W",150).
component("YMR015C",583).
component("YDR402C",286).
component("YGL055W",358).
component("YGR175C",387).
component("YJR104C",480).
component("YHR008C",410).
component("YJL026W",448).
component("YGR180C",389).
component("YER070W",319).
component("U35_",92).
component("YDL168W",231).
component("YDR158W",265).
component("YPL276W",735).
component("YPL275W",734).
component("YOR388C",707).
component("YOR374W",704).
component("YER073W",320).
component("YGL154C",364).
component("U55_",103).
component("YOR323C",696).
component("YMR170C",594).
component("YMR169C",593).
component("U2_",88).
component("YBR221C",184).
component("YIL125W",438).
component("U52_",100).
component("YBR166C",179).
component("YNL280C",637).
component("YGL012W",354).
component("U57_",104).
component("YKL216W",516).
component("YDR044W",247).
component("YER014W",307).
component("YKR009C",520).
component("YIL160C",442).
component("YGL205W",367).
component("YMR118C",590).
component("YLR164W",547).
component("YLL041C",528).
component("YKL148C",506).
component("YKL141W",504).
component("YJL045W",449).
component("YDR178W",266).
component("YJR051W",473).
component("YEL047C",302).
component("YDL215C",236).
component("YOR375C",705).
component("YDL215C",237).
component("YAL062W",137).
component("U99_",132).
component("YBR035C",160).
component("YHR037W",414).
component("YKR080W",524).
component("YER023W",308).
component("YOR236W",692).
component("YGR204W",394).
component("YLR142W",542).
component("U62_",107).
component("YKL150W",507).
component("YIL043C",430).
component("YHR042W",415).
component("YOR221C",690).
component("YML120C",579).
component("YKL192C",513).
component("YKL055C",498).
component("YER061C",316).
component("YGR234W",397).
component("YFR030W",345).
component("YPL017C",710).
component("YFL018C",337).
component("YER042W",310).
component("YJR137C",485).
component("YPL266W",731).
component("YML110C",578).
component("YBR034C",159).
component("YPL273W",732).
component("YLL062C",531).
component("U47_",97).
...
component("YMR120C",591).
component("YBL013W",141).
component("YKL024C",494).
component("YPR074C",746).
component("YBR117C",170).
component("YLR354C",563).
component("YGR043C",376).
component("YMR108W",588).
component("YCL009C",195).
component("YMR062C",585).
component("YNL071W",615).
component("YNR008W",644).
component("YFL017C",336).
component("YPL231W",725).
component("YER061C",317).
component("U86_",122).
component("YPL001W",709).
component("YDR148C",263).
component("YOR377W",706).
component("YGR177C",388).
component("YPL231W",726).
component("YGR147C",384).
component("YDL040C",210).
component("YPL028W",711).
component("YGL017W",355).
component("YPR001W",737).
component("YNR001C",642).
component("YDL182W",233).
component("YDL131W",222).
component("YNL117W",619).
component("YIR031C",445).
component("YOR321W",695).
component("YJR143C",487).
component("YGR199W",393).
component("YDR307W",279).
component("YDL095W",217).
component("YDL093W",216).
component("YAL023C",134).
component("YNL029C",611).
component("YIL085C",433).
component("YMR261C",602).
component("YML100W",577).
component("YBR126C",173).
component("YNL192W",626).
component("YBR038W",162).
component("YBR023C",158).
component("YLR209C",549).
component("U104_",21).
component("YOR209C",688).
component("YMR300C",607).
component("YER055C",312).
component("YDR354W",282) :- not remove_orf("YDR354W",282).
component("YFR047C",347).
component("YJR133W",484).
component("YLR209C",550).
component("YML022W",570).
component("YDR441C",291).
component("YDR399W",284).
component("YJL167W",465).
component("YNL256W",630).
component("YDR127W",258).
component("YLR303W",556).
component("YGR012W",373).
component("YJR130C",483).
component("YLR303W",557).
component("YDR035W",245).
component("YBR249C",187).
component("YOL143C",671).
component("YBR256C",188).
component("YHR137W",422).
component("YGL202W",366).
component("YLR027C",532).
component("YKL106W",501).
component("YKL104C",500).
component("YGR019W",374).
component("YLR089C",537).
component("U64_",108).
component("U61_",106).
component("U51_",99).
component("YJR148W",488).
component("YOR184W",683).
component("YNR058W",652).
component("YIL116W",437).
component("YGL253W",370).
component("YFR053C",348).
component("YOL136C",670).
component("YIL107C",435).
component("YMR205C",596).
component("YGR240C",398).
component("YDR248C",270).
component("YCR036W",203).
component("YGR194C",392).
component("YCL040W",198).
component("YJR105W",481).
component("U16_",46).
component("U15_",41).
component("U96_",130).
component("YKL001C",492).
component("YML070W",575).
component("YFL053W",340).
component("YHL032C",407).
component("YLR133W",539).
component("YDR531W",298).
component("U83_",120).
component("U82_",119).
component("U81_",118).
component("YMR208W",597).
component("YOR347C",701).
component("YAL038W",136).
component("YNR012W",645).
component("YPR121W",749).
component("YPL258C",728).
component("YOL055C",659).
component("U1_",69).
component("YDR009W",242).
component("YBR020W",156).
component("YNL267W",634).
component("YLR305C",559).
component("YFR019W",343).
component("YDR208W",267).
component("YDR127W",259).
component("U21_",78).
component("U20_",76).
component("YDR147W",262).
component("YDR300C",278).
component("YCR012W",200).
component("U18_",61).
component("U17_",54).
component("U76_",116).
component("YMR220W",599).
component("YER170W",333).
component("YDR226W",268).
component("YKL067W",499).
component("YDR454C",292).
component("YOL061W",663).
component("YKL181W",509).
component("YHL011C",405).
component("YER099C",328).
component("YBL068W",149).
component("YOR143C",681).
component("YNL256W",631).
component("YLR328W",560).
component("YBR018C",152).
component("YBR018C",153).
component("YGR007W",372).
component("YLR328W",561).
component("YKR002W",518).
component("YDL103C",220).
component("YJR010W",470).
component("YDR530C",297).
component("YCL050C",199).
component("YPR190C",753).
component("YPR187W",752).
component("YPR110C",748).
component("YPR010C",739).
component("YOR341W",700).
component("YOR340C",699).
component("YOR224C",691).
component("YOR210W",689).
component("YOR207C",686).
component("YOR151C",682).
component("YOR116C",677).
component("YOL005C",653).
component("YNR003C",643).
component("YNL248C",629).
component("YNL151C",623).
component("YNL113W",618).
component("YKL144C",505).
component("YJR063W",474).
component("YJL148W",461).
component("YJL140W",460).
component("YIL021W",429).
component("YHR143W-A",423).
component("YGL070C",361).
component("YFL036W",339).
...
component("YPR175W",751).
component("YPL167C",719).
component("YOR330C",697).
component("YOL115W",668).
component("YNL299W",639).
component("YNL262W",633).
component("YNL102W",617).
component("YJR043C",472).
component("YJR006W",469).
component("YJL090C",453).
component("YIL139C",439).
...
component("YKL035W",497).
component("YHL012W",406).
component("YHR123W",421).
component("YBR243C",185).
component("YDL142C",227).
component("YER026C",309).
component("YCL004W",194).
component("YJL068C",450).
component("YDR058C",252).
component("YNR034W",649).
component("YHR163W",425).
component("YGR248W",400).
component("YCR073W-A",204).
component("YDL086W",215).
component("YOL011W",655).
component("YMR008C",582).
component("YMR006C",581).
component("U101_",19).
component("YBL015W",142).
component("YJL068C",451).
component("YPL072W",714).
component("YOR124C",678).
component("YNL186W",625).
component("YMR304W",609).
component("YMR223W",600).
component("YKR098C",526).
component("YJL197W",466).
component("YIL156W",441).
component("YFR010W",342).
component("YER151C",331).
component("YER144C",330).
component("YER098W",327).
component("YDR069C",253).
component("YDL122W",221).
component("YBR058C",163).
component("YBL067C",148).
component("YDR272W",274).
component("U84_",121).
component("YPL179W",720).
component("YNR032W",647).
component("YML057W",574).
component("YML016C",569).
component("YLR433C",568).
component("YGR123C",383).
...
component("YPR073C",744).
component("YHR215W",427).
component("YDL024C",208).
component("YBR093C",168).
component("YBR092C",167).
component("YAR071W",138).
component("YIL053W",432).
component("YER062C",318).
component("YHR046C",416).
component("YGR208W",396).
component("YPL228W",723).
component("YMR180C",595).
component("YDL236W",239).
component("YJL155C",463).
component("YPR073C",745).
component("YOR208W",687).
component("YNL053W",614).
component("YMR036C",584).
component("YIR026C",443).
component("YIL113W",436).
...
component("U25_",86).
component("U24_",85).
component("YOR360C",703).
component("YGL248W",369).
component("YKR031C",521).
component("YPL206C",721).
component("YLR286C",554).
component("YJR153W",490).
component("YOR190W",684).
component("YLR300W",555).
component("YGR282C",404).
component("YDR261C",272).
component("YDR400W",285).
component("U23_",84).
component("YML035C",571).
component("YJL070C",452).
component("YBR284W",191).
component("U102_",20).
component("YNL045W",613).
component("YLR160C",546).
component("YLR158C",545).
component("YLR157C",544).
component("YLR155C",543).
component("YDR321W",280).
component("YGL037C",357).
component("YMR293C",606).
component("YDR242W",269).
component("YBR208C",181).
component("YMR281W",605).
component("U53_",101).
component("YPL111W",717).
component("YIR032C",446).
component("YIR029W",444).
component("YPR062W",743).
component("YMR120C",592).
component("YLR028C",533).
component("YHR144C",424).
component("YGR267C",403).
component("YNL141W",620).
component("YBR153W",177).
component("YDL238C",240).
component("YNL141W",621).
component("YLR245C",553).
component("YML035C",572).
component("YJL126W",456).
component("U44_",95).
component("YDL100C",218).
component("U87_",123).
component("YMR267W",603).
component("YBR011C",151).
component("YBR111C",169).
component("YCL030C",197).
component("YER005W",306).
component("YIL048W",431).
component("YER166W",332).
component("YDR093W",255).
component("YAL026C",135).
component("YLR231C",551).
component("U88_",124).
component("YLR134W",540).
component("YLR044C",534).
component("YGR087C",379).
component("YDR380W",283).
component("YDL080C",214).
component("U98_",131).
component("YMR250W",601).
component("YKL184W",512).
component("YNR043W",650).
component("U93_",129).
component("YDR047W",250).
component("U54_",102).
component("YKL211C",514) :- not remove_orf("YKL211C",514).
component("YOL052C",658).
component("YNL169C",624).
component("YGR170W",386).
component("YNL256W",632).
component("YDR294C",275).
component("YEL046C",301).
component("YNR033W",648).
component("YKL211C",515) :- not remove_orf("YKL211C",515).
component("YER090W",515) :- not remove_orf("YER090W",515).
component("YER090W",325) :- not remove_orf("YER090W",325).
component("YDR127W",260).
component("YPL281C",736).
component("YOR393W",708).
component("YMR323W",610).
component("YHR174W",426).
component("YGR254W",401).
component("YPL262W",729).
component("YGL026C",356) :- not remove_orf("YGL026C",356).
component("YGR155W",385).
component("YLR304C",558).
component("YJL200C",467).
component("YNL316C",640).
component("YKL182W",510).
component("YPL212C",722).
component("YNL292W",638).
component("YGL063W",360).
component("YFL001W",334).
component("YPR002W",738).
component("YDR127W",261).
component("YGL148W",363).
component("YER086W",322).
component("YLR359W",565).
component("YAL012W",133).
component("YFR055W",349).
component("YJL121C",455).
component("YBR019C",154).
component("YBR019C",155).
component("YDR050C",251).
component("YDR007W",241) :- not remove_orf("YDR007W",241).
component("YOR095C",676).
component("YER003C",305).
component("YBR196C",180).
component("YGL001C",351).
component("U14_",35).
component("YOL056W",660).
component("YKL152C",508).
component("YDL021W",206).
component("YMR105C",587).
component("YKL127W",502).
component("YEL058W",304).
component("YPR060C",742).
component("YHR072W",418).
component("YJL153C",462).
component("YPL097W",715).
component("YGR185C",391).
component("YHR011W",411).
component("YDR023W",244).
component("YPL104W",716).
component("YLL018C",527).
component("YPR081C",747).
component("YBR121C",171).
component("YHR020W",413).
component("YER087W",323).
component("YNL247W",628).
component("YOL033W",657).
component("YHR091C",420).
component("YDR341C",281).
component("YOL097C",666).
component("YDR268W",273).
component("YPR047W",741).
component("YLR060W",535).
component("YFL022C",338).
component("YPR033C",740).
component("YHR019C",412).
component("YPL160W",718).
component("YLR382C",566).
component("YNL073W",616).
component("YDR037W",246).
component("YOR335C",698).
component("YGR094W",381).
component("YOR142W",680).
component("YGR244C",399).
component("U89_",125).
component("YOR241W",693).
component("YMR113W",589).
component("YKL132C",503).
component("YJL101C",454).
component("U92_",128).
...
component("YJR103W",479).
component("YBL039C",144).
component("YGR204W",395).
component("YBR084W",166).
component("YOL058W",661).
component("YBR208C",182).
component("YHR074W",419).
component("YMR217W",598).
component("YOR303W",694).
component("YJR109C",482).
component("YJL130C",458).
component("YGL062W",359).
component("YBR218C",183).
component("YPL231W",727).
component("YNR016C",646).
component("YKL182W",511).
component("YGR037C",375).
component("YOR005C",673).
component("YDL164C",229).
component("YOL010W",654).
component("YPR138C",750).
component("YPL274W",733).
component("YPL265W",730).
component("YPL057C",713).
component("YPL036W",712).
component("YOR348C",702).
component("YOR192C",685).
component("YOR071C",675).
component("YOL156W",672).
component("YOL103W",667).
component("YOL020W",656) :- not remove_orf("YOL020W",656).
component("YNR056C",651).
component("YNL318C",641).
component("YNL268W",635).
component("YNL142W",622).
component("YMR272C",604).
component("YML123C",580).
component("YLR348C",562).
component("YLR237W",552).
component("YLR138W",541).
component("YLR100C",538).
component("YLR081W",536).
component("YLL061W",530).
component("YLL043W",529).
component("YKR093W",525).
component("YKR053C",523).
component("YKR039W",522) :- not remove_orf("YKR039W",522).
component("YKL217W",517).
component("YKL004W",493).
component("YJR152W",489).
component("YJR095W",478).
component("YJR077C",476).
component("YJL219W",468).
component("YJL134W",459).
component("YJL129C",457).
component("YHL036W",408).
component("YGR121C",382).
component("YGR055W",377).
component("YGL186C",365).
component("YGL077C",362).
component("YGL008C",352).
component("YFL055W",341).
component("YFL011W",335).
component("YER060W-A",315).
component("YER060W",314).
component("YER056C",313).
component("YER053C",311).
component("YEL017C-A",300).
component("YDR536W",299).
component("YDR508C",295).
component("YDR503C",294).
component("YDR497C",293).
component("YDR297W",277).
...
catalyst(6160,607).
catalyst(3870,312).
catalyst(3620,282) :- not remove_reaction(3620,282).
catalyst(2110,347).
catalyst(2190,347).
catalyst(5550,484).
catalyst(5791,550).
...
catalyst(1960,250).
catalyst(3460,102).
catalyst(3600,514) :- not remove_reaction(3600,514).
catalyst(3941,658).
catalyst(3942,658).
catalyst(6890,624).
catalyst(6900,386).
...
catalyst(4560,301).
catalyst(2550,648).
catalyst(1890,515) :- not remove_reaction(1890,515).
catalyst(3630,515) :- not remove_reaction(3630,515).
...
catalyst(941,656) :- not remove_reaction(941,656).
catalyst(942,656) :- not remove_reaction(942,656).
catalyst(700,651).
catalyst(1200,641).
catalyst(761,635).
catalyst(762,635).
...
catalyst(640,525).
catalyst(6560,523).
catalyst(761,522) :- not remove_reaction(761,522).
catalyst(762,522) :- not remove_reaction(762,522).
...
catalyst(791,522) :- not remove_reaction(791,522).
catalyst(792,522) :- not remove_reaction(792,522).
...
catalyst(821,522) :- not remove_reaction(821,522).
catalyst(822,522) :- not remove_reaction(822,522).
...
catalyst(861,522) :- not remove_reaction(861,522).
catalyst(862,522) :- not remove_reaction(862,522).
...
catalyst(911,522) :- not remove_reaction(911,522).
catalyst(912,522) :- not remove_reaction(912,522).
catalyst(941,522) :- not remove_reaction(941,522).
catalyst(942,522) :- not remove_reaction(942,522).
