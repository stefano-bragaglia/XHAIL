...
component("YNL280C",477).
component("YGR060W",286).
component("YGL012W",266).
component("YOL086C",496).
component("YMR303C",457).
component("YGL256W",280).
component("YDL168W",169).
component("YBR145W",130).
component("YPL231W",544).
component("YBR149W",131).
component("YGL001C",263).
component("YIL094C",329).
component("YHR063C",314).
component("YBR153W",132).
component("YML056C",436).
component("YLR432W",432).
component("YHR216W",323).
component("YAR075W",105).
component("YAR073W",104).
component("YDR127W",187).
component("YJR139C",373).
component("YKL029C",377).
component("YOR136W",508).
component("YDL066W",159).
component("YLR355C",430).
component("YML086C",438).
component("YIL155C",332).
component("YPR191W",569).
component("YOR065W",503).
component("YJL166W",352).
component("YHR001W-A",309).
component("YGR183C",296).
component("YFR033C",259).
component("YDR529C",219).
component("YBL045C",110).
component("Q0105",18).
component("YGR088W",288).
component("YDR256C",200).
component("YJR078W",364).
component("YJR025C",359).
component("YGR255C",303).
component("YBL098W",113).
component("YMR015C",442).
component("YDR402C",211).
component("YGR175C",294).
component("YJR104C",367).
component("YHR008C",310).
component("YER070W",238).
component("U35_",65).
component("YDL168W",170).
component("YDR158W",194).
component("YPL276W",552).
component("YPL275W",551).
component("YOR388C",530).
component("YGL154C",275).
component("U55_",74).
component("YOR323C",520).
component("YMR170C",450).
component("YMR169C",449).
component("U2_",62).
component("YBR221C",139).
component("U52_",71).
component("YBR166C",135).
component("YNL280C",478).
component("YGL012W",267).
component("YER014W",228).
component("YMR118C",447).
component("YLR164W",415).
component("YLL041C",400).
component("YKL148C",384).
component("YJL045W",338).
component("YDR178W",195).
component("YJR051W",361).
component("YEL047C",223).
component("YOR375C",528).
component("YDL215C",172).
component("YAL062W",102).
component("U99_",98).
component("YBR035C",120).
component("YHR037W",311).
component("YKR080W",397).
component("YER023W",229).
component("YOR236W",517).
component("YGR204W",298).
component("U62_",76).
component("YKL150W",385).
component("YIL043C",325).
component("YHR042W",312).
component("YFR030W",258).
component("YPL017C",533).
component("YFL018C",250).
component("YER042W",231).
component("YJR137C",372).
component("YBR034C",119).
component("YPL273W",550).
component("YLL062C",402).
component("U47_",68).
component("YER091C",241).
component("YDL033C",157).
component("YOL096C",497).
component("YDR019C",177).
component("YDR408C",213).
component("YBL013W",106).
component("YKL024C",376).
component("YPR074C",562).
component("YBR117C",129).
component("YLR354C",429).
component("YGR043C",284).
component("YCL009C",148).
component("YMR062C",444).
component("YNL071W",463).
component("YNR008W",485).
component("YPL231W",545).
component("U86_",90).
component("YPL001W",532).
component("YOR377W",529).
component("YGR177C",295).
component("YPL231W",546).
component("YGR147C",291).
component("YDL040C",158).
component("YPL028W",534).
component("YPR001W",554).
component("YNR001C",483).
component("YDL182W",171).
component("YDL131W",164).
component("YNL117W",466).
component("YIR031C",336).
component("YNL029C",460).
component("YIL085C",328).
component("YNL192W",471).
component("YBR038W",122).
component("YBR023C",118).
component("YLR209C",416).
component("U104_",21).
component("YMR300C",456).
component("YER055C",233).
component("YDR354W",207) :- not remove_orf("YDR354W",207).
component("YFR047C",260).
component("YJR133W",371).
component("YLR209C",417).
component("YML022W",433).
component("YDR441C",215).
component("YDR399W",209).
component("YJL167W",353).
component("YNL256W",473).
component("YDR127W",188).
component("YLR303W",423).
component("YJR130C",370).
component("YLR303W",424).
component("YDR035W",178).
component("YBR249C",140).
component("YOL143C",500).
component("YBR256C",141).
component("YHR137W",318).
component("YGL202W",277).
component("YLR027C",403).
component("YKL106W",380).
component("YKL104C",379).
component("YGR019W",282).
component("YLR089C",407).
component("U64_",77).
component("U51_",70).
component("YJR148W",374).
component("YGL253W",279).
component("YFR053C",261).
component("YMR205C",452).
component("YGR240C",300).
component("YDR248C",199).
component("YCR036W",155).
component("YCL040W",150).
component("YJR105W",368).
component("U16_",37).
component("U15_",34).
component("U96_",96).
component("YKL001C",375).
component("YML070W",437).
component("YFL053W",253).
component("YHL032C",307).
component("U83_",88).
component("U82_",87).
component("YMR208W",453).
component("YOR347C",525).
component("YAL038W",101).
component("YPR121W",564).
component("YPL258C",548).
component("YOL055C",493).
component("U1_",46).
component("YBR020W",116).
component("YNL267W",475).
component("YLR305C",426).
component("YFR019W",256).
component("YDR208W",196).
component("YDR127W",189).
component("U21_",54).
component("U20_",52).
component("YDR147W",192).
component("YDR300C",204).
component("YCR012W",152).
component("U18_",43).
component("U76_",85).
component("YER170W",247).
component("YDR226W",197).
component("YDR454C",216).
component("YOL061W",495).
component("YKL181W",387).
component("YHL011C",305).
component("YER099C",243).
component("YBL068W",112).
component("YOR143C",509).
component("YGR007W",281).
component("YLR328W",427).
component("YJR010W",358).
component("YCL050C",151).
component("YPR190C",568).
component("YPR187W",567).
component("YPR110C",563).
component("YPR010C",556).
component("YOR341W",524).
component("YOR340C",523).
component("YOR224C",516).
component("YOR210W",515).
component("YOR207C",513).
component("YOR151C",510).
component("YOR116C",506).
component("YOL005C",489).
component("YNR003C",484).
component("YNL248C",472).
component("YNL151C",469).
component("YNL113W",465).
component("YKL144C",383).
component("YJR063W",362).
component("YJL148W",350).
component("YJL140W",349).
component("YIL021W",324).
component("YHR143W-A",319).
component("YGL070C",272).
component("YFL036W",252).
component("YDR404C",212).
component("YDR156W",193).
component("YDR045C",179).
component("YDL150W",167).
component("YDL140C",165).
component("YBR154C",134).
component("YPR175W",566).
component("YPL167C",541).
component("YOR330C",521).
component("YOL115W",499).
component("YNL299W",480).
component("YNL262W",474).
component("YNL102W",464).
component("YJR043C",360).
component("YJR006W",357).
component("YJL090C",342).
component("YIL139C",331).
component("YEL055C",224).
component("YDR419W",214).
component("YDR121W",186).
component("YDL102W",162).
component("YCR014C",153).
component("YBR278W",143).
component("YBL035C",108).
component("YKL035W",378).
component("YHL012W",306).
component("YHR123W",317).
component("YER026C",230).
component("YCL004W",147).
component("YJL068C",339).
component("YDR058C",183).
component("YDL086W",161).
component("YOL011W",490).
component("YMR008C",441).
component("YMR006C",440).
component("U101_",19).
component("YBL015W",107).
component("YJL068C",340).
component("YPL072W",537).
component("YOR124C",507).
component("YNL186W",470).
component("YMR304W",458).
component("YMR223W",454).
component("YKR098C",398).
component("YJL197W",354).
component("YIL156W",333).
component("YFR010W",255).
component("YER151C",245).
component("YER144C",244).
component("YER098W",242).
component("YDR069C",184).
component("YDL122W",163).
component("YBR058C",123).
component("YBL067C",111).
component("U84_",89).
component("YPR073C",560).
component("YHR215W",322).
component("YDL024C",156).
component("YBR093C",127).
component("YBR092C",126).
component("YAR071W",103).
component("YIL053W",327).
component("YER062C",237).
component("YHR046C",313).
component("YGR208W",299).
component("YPL228W",543).
component("YMR180C",451).
component("YDL236W",174).
component("YJL155C",351).
component("YPR073C",561).
component("YOR208W",514).
component("YNL053W",462).
component("YMR036C",443).
component("YIR026C",334).
component("YIL113W",330).
component("YFR028C",257).
component("YER075C",239).
component("YDL230W",173).
component("YBR276C",142).
component("U34_",64).
component("U30_",63).
component("U25_",61).
component("U24_",60).
component("YOR360C",527).
component("YGL248W",278).
component("YKR031C",394).
component("YLR286C",421).
component("YOR190W",511).
component("YLR300W",422).
component("YGR282C",304).
component("YDR261C",201).
component("YDR400W",210).
component("U23_",59).
component("YML035C",434).
component("YJL070C",341).
component("YBR284W",144).
component("U102_",20).
component("YNL045W",461).
component("YLR160C",414).
component("YLR158C",413).
component("YLR157C",412).
component("YLR155C",411).
component("YDR321W",205).
component("YGL037C",269).
component("YDR242W",198).
component("YBR208C",136).
component("U53_",72).
component("YIR032C",337).
component("YIR029W",335).
component("YMR120C",448).
component("YHR144C",320).
component("YBR153W",133).
component("YDL238C",175).
component("YNL141W",467).
component("YLR245C",420).
component("YML035C",435).
component("YJL126W",345).
component("U87_",91).
component("YBR111C",128).
component("YER005W",227).
component("YIL048W",326).
component("YER166W",246).
component("YDR093W",185).
component("YAL026C",100).
component("YLR231C",418).
component("U88_",92).
component("YLR134W",409).
component("YLR044C",404).
component("YGR087C",287).
component("YDR380W",208).
component("YDL080C",160).
component("U98_",97).
component("YKL184W",390).
component("YNR043W",488).
component("U93_",95).
component("YDR047W",181).
component("U54_",73).
component("YKL211C",391) :- not remove_orf("YKL211C",391).
component("YGR170W",293).
component("YDR294C",202).
component("YEL046C",222).
component("YNR033W",487).
component("YKL211C",392) :- not remove_orf("YKL211C",392).
component("YER090W",392) :- not remove_orf("YER090W",392).
component("YER090W",240) :- not remove_orf("YER090W",240).
component("YDR127W",190).
component("YPL281C",553).
component("YOR393W",531).
component("YMR323W",459).
component("YHR174W",321).
component("YGR254W",302).
component("YGL026C",268) :- not remove_orf("YGL026C",268).
component("YGR155W",292).
component("YLR304C",425).
component("YJL200C",355).
component("YNL316C",481).
component("YKL182W",388).
component("YPL212C",542).
component("YNL292W",479).
component("YGL063W",271).
component("YFL001W",248).
component("YPR002W",555).
component("YDR127W",191).
component("YGL148W",274).
component("YAL012W",99).
component("YFR055W",262).
component("YJL121C",344).
component("YBR019C",114).
component("YBR019C",115).
component("YDR050C",182).
component("YDR007W",176) :- not remove_orf("YDR007W",176).
component("YOR095C",505).
component("YER003C",226).
component("YGL001C",264).
component("YKL152C",386).
component("YMR105C",445).
component("YKL127W",381).
component("YEL058W",225).
component("YPR060C",559).
component("YPL097W",538).
component("YGR185C",297).
component("YPL104W",539).
component("YLL018C",399).
component("YOL033W",492).
component("YHR091C",316).
component("YDR341C",206).
component("YOL097C",498).
component("YPR047W",558).
component("YLR060W",405).
component("YFL022C",251).
component("YPR033C",557).
component("YPL160W",540).
component("YLR382C",431).
component("YOR335C",522).
component("YGR094W",289).
component("YGR244C",301).
component("U89_",93).
component("YOR241W",518).
component("YMR113W",446).
component("YKL132C",382).
component("YJL101C",343).
component("U91_",94).
component("YDL141W",166).
component("YJR103W",366).
component("YBL039C",109).
component("YOL058W",494).
component("YBR208C",137).
component("YHR074W",315).
component("YOR303W",519).
component("YJR109C",369).
component("YJL130C",347).
component("YGL062W",270).
component("YBR218C",138).
component("YPL231W",547).
component("YNR016C",486).
component("YKL182W",389).
component("YGR037C",283).
component("YOR005C",502).
component("YDL164C",168).
component("YPR138C",565).
component("YPL265W",549).
component("YPL057C",536).
component("YPL036W",535).
component("YOR348C",526).
component("YOR192C",512).
component("YOR071C",504).
component("YOL156W",501).
component("YOL020W",491) :- not remove_orf("YOL020W",491).
component("YNL318C",482).
component("YNL268W",476).
component("YNL142W",468).
component("YMR272C",455).
component("YML123C",439).
component("YLR348C",428).
component("YLR237W",419).
component("YLR138W",410).
component("YLR100C",408).
component("YLR081W",406).
component("YLL061W",401).
component("YKR053C",396).
component("YKR039W",395) :- not remove_orf("YKR039W",395).
component("YKL217W",393).
component("YJR095W",365).
component("YJR077C",363).
component("YJL219W",356).
component("YJL134W",348).
component("YJL129C",346).
component("YHL036W",308).
component("YGR121C",290).
component("YGR055W",285).
component("YGL186C",276).
component("YGL077C",273).
component("YGL008C",265).
component("YFL055W",254).
component("YFL011W",249).
component("YER060W-A",236).
component("YER060W",235).
component("YER056C",234).
component("YER053C",232).
component("YEL017C-A",221).
component("YDR536W",220).
component("YDR508C",218).
component("YDR503C",217).
...
catalyst(6160,456).
catalyst(3870,233).
catalyst(3620,207) :- not remove_reaction(3620,207).
catalyst(2110,260).
catalyst(2190,260).
catalyst(5550,371).
catalyst(5791,417).
...
catalyst(1960,181).
catalyst(3460,73).
catalyst(3600,391) :- not remove_reaction(3600,391).
catalyst(6900,293).
catalyst(8781,202).
catalyst(8782,202).
catalyst(4560,222).
...
catalyst(3630,240) :- not remove_reaction(3630,240).
catalyst(3740,190).
catalyst(8231,553).
catalyst(8232,553).
catalyst(8231,531).
...
catalyst(8231,302).
catalyst(8232,302).
catalyst(3590,268) :- not remove_reaction(3590,268).
catalyst(10910,268) :- not remove_reaction(10910,268).
catalyst(4570,292).
catalyst(8181,425).
catalyst(8182,425).
catalyst(8181,355).
...
catalyst(190,504).
catalyst(1200,501).
catalyst(801,491) :- not remove_reaction(801,491).
catalyst(802,491) :- not remove_reaction(802,491).
catalyst(811,491) :- not remove_reaction(811,491).
catalyst(812,491) :- not remove_reaction(812,491).
catalyst(831,491) :- not remove_reaction(831,491).
catalyst(832,491) :- not remove_reaction(832,491).
catalyst(941,491) :- not remove_reaction(941,491).
catalyst(942,491) :- not remove_reaction(942,491).
catalyst(1200,482).
catalyst(761,476).
catalyst(762,476).
catalyst(371,468).
...
catalyst(750,401).
catalyst(6560,396).
catalyst(761,395) :- not remove_reaction(761,395).
catalyst(762,395) :- not remove_reaction(762,395).
catalyst(771,395) :- not remove_reaction(771,395).
catalyst(772,395) :- not remove_reaction(772,395).
catalyst(781,395) :- not remove_reaction(781,395).
catalyst(782,395) :- not remove_reaction(782,395).
catalyst(791,395) :- not remove_reaction(791,395).
catalyst(792,395) :- not remove_reaction(792,395).
catalyst(801,395) :- not remove_reaction(801,395).
catalyst(802,395) :- not remove_reaction(802,395).
catalyst(811,395) :- not remove_reaction(811,395).
catalyst(812,395) :- not remove_reaction(812,395).
catalyst(831,395) :- not remove_reaction(831,395).
catalyst(832,395) :- not remove_reaction(832,395).
catalyst(841,395) :- not remove_reaction(841,395).
catalyst(842,395) :- not remove_reaction(842,395).
catalyst(861,395) :- not remove_reaction(861,395).
catalyst(862,395) :- not remove_reaction(862,395).
catalyst(881,395) :- not remove_reaction(881,395).
catalyst(882,395) :- not remove_reaction(882,395).
catalyst(941,395) :- not remove_reaction(941,395).
catalyst(942,395) :- not remove_reaction(942,395).
catalyst(1191,395) :- not remove_reaction(1191,395).
catalyst(1192,395) :- not remove_reaction(1192,395).
catalyst(1021,393).
catalyst(1022,393).
catalyst(1250,365).
catalyst(1581,363).
