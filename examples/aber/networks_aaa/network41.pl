...
component("YGR060W",179).
component("YGL012W",167).
component("YOL086C",299).
component("YMR303C",277).
component("YGL256W",175).
component("YDL168W",111).
component("YBR145W",85).
component("YPL231W",329).
component("YGL001C",164).
component("YML056C",262).
component("YLR432W",259).
component("YHR216W",200).
component("YAR075W",71).
component("YAR073W",70).
component("YDR127W",123).
component("YJR139C",228).
component("YOR136W",305).
component("YIL155C",204).
component("YJR078W",221).
component("YJR025C",217).
component("YBL098W",75).
component("YMR015C",266).
component("YDR402C",139).
component("YJR104C",224).
component("YHR008C",192).
component("YER070W",152).
component("YDL168W",112).
component("YPL276W",336).
component("YPL275W",335).
component("YOR388C",322).
component("YGL154C",173).
component("YOR323C",316).
component("YMR170C",272).
component("YMR169C",271).
component("YBR166C",88).
component("YER014W",149).
component("YMR118C",270).
component("YLR164W",249).
component("YLL041C",245).
component("YKL148C",236).
component("YJL045W",208).
component("YDR178W",129).
component("YJR051W",218).
component("YEL047C",147).
component("YOR375C",321).
component("YDL215C",113).
component("YAL062W",69).
component("YBR035C",78).
component("YER023W",150).
component("YOR236W",314).
component("YGR204W",186).
component("U62_",51).
component("YPL017C",325).
component("YFL018C",156).
component("U47_",45).
component("YKL024C",231).
component("YPR074C",343).
component("YBR117C",84).
component("YCL009C",98).
component("YMR062C",268).
component("YPL231W",330).
component("YPL001W",324).
component("YPL231W",331).
component("YGR147C",183).
component("YDL040C",105).
component("YPL028W",326).
component("YPR001W",338).
component("YNR001C",289).
component("YNL117W",283).
component("YIR031C",206).
component("YNL029C",279).
component("YIL085C",202).
component("YLR209C",250).
component("YMR300C",276).
component("YER055C",151).
component("YDR354W",135) :- not remove_orf("YDR354W",135).
component("YFR047C",162).
component("YJR133W",227).
component("YML022W",260).
component("YDR441C",141).
component("YDR399W",137).
component("YDR127W",124).
component("YJR130C",226).
component("YLR303W",256).
component("YDR035W",118).
component("YBR249C",92).
component("YBR256C",93).
component("YHR137W",195).
component("YLR027C",246).
component("YKL106W",233).
component("YGR019W",177).
component("U64_",52).
component("U51_",47).
component("YJR148W",229).
component("YGL253W",174).
component("YFR053C",163).
component("YMR205C",274).
component("YGR240C",187).
component("YCR036W",103).
component("YCL040W",100).
component("YJR105W",225).
component("U16_",26).
component("U15_",24).
component("YKL001C",230).
component("YML070W",263).
component("YFL053W",158).
component("U83_",62).
component("U82_",61).
component("YMR208W",275).
component("YOR347C",320).
component("YAL038W",68).
component("YPR121W",345).
component("YPL258C",333).
component("YOL055C",296).
component("U1_",34).
component("YNL267W",287).
component("YLR305C",257).
component("YFR019W",160).
component("YDR208W",130).
component("YDR127W",125).
component("U20_",37).
component("YDR300C",133).
component("U18_",31).
component("U76_",60).
component("YDR454C",142).
component("YOL061W",298).
component("YKL181W",237).
component("YHL011C",190).
component("YER099C",155).
component("YBL068W",74).
component("YOR143C",306).
component("YGR007W",176).
component("YCL050C",101).
component("YPR190C",348).
component("YPR187W",347).
component("YPR110C",344).
component("YPR010C",339).
component("YOR341W",319).
component("YOR340C",318).
component("YOR224C",313).
component("YOR210W",312).
component("YOR207C",310).
component("YOR151C",307).
component("YOR116C",304).
component("YOL005C",293).
component("YNR003C",290).
component("YNL248C",286).
component("YNL151C",285).
component("YNL113W",282).
component("YKL144C",235).
component("YJR063W",219).
component("YJL148W",215).
component("YJL140W",214).
component("YIL021W",201).
component("YHR143W-A",196).
component("YGL070C",171).
component("YFL036W",157).
component("YDR404C",140).
component("YDR156W",128).
component("YDR045C",119).
component("YDL150W",109).
component("YDL140C",108).
component("YBR154C",87).
component("YKL035W",232).
component("YHL012W",191).
component("YDR058C",122).
component("YDL086W",107).
component("YOL011W",294).
component("YMR008C",265).
component("YMR006C",264).
component("U101_",18).
component("YBL015W",72).
component("U84_",63).
component("YPR073C",341).
component("YHR215W",199).
component("YDL024C",104).
component("YBR093C",82).
component("YBR092C",81).
component("YPL228W",328).
component("YMR180C",273).
component("YDL236W",115).
component("YJL155C",216).
component("YPR073C",342).
component("YOR208W",311).
component("YNL053W",281).
component("YMR036C",267).
component("YIR026C",205).
component("YIL113W",203).
component("YFR028C",161).
component("YER075C",153).
component("YDL230W",114).
component("YBR276C",94).
component("U34_",43).
component("U30_",42).
component("U25_",41).
component("U24_",40).
component("YKR031C",242).
component("YLR286C",254).
component("YOR190W",308).
component("YLR300W",255).
component("YGR282C",189).
component("YDR261C",131).
component("YDR400W",138).
component("YML035C",261).
component("YJL070C",209).
component("YBR284W",95).
component("YNL045W",280).
component("YGL037C",169).
component("YBR208C",89).
component("U53_",48).
component("YIR032C",207).
component("YHR144C",197).
component("YBR153W",86).
component("YDL238C",116).
component("YLR245C",253).
component("YJL126W",211).
component("YBR111C",83).
component("YER005W",148).
component("YLR231C",251).
component("U88_",64).
component("YLR134W",248).
component("YLR044C",247).
component("YGR087C",180).
component("YDR380W",136).
component("YDL080C",106).
component("U93_",66).
component("U54_",49).
component("YKL211C",240) :- not remove_orf("YKL211C",240).
component("YGR170W",185).
component("YDR294C",132).
component("YNR033W",292).
component("YKL211C",241) :- not remove_orf("YKL211C",241).
component("YER090W",241) :- not remove_orf("YER090W",241).
component("YER090W",154) :- not remove_orf("YER090W",154).
component("YDR127W",126).
component("YPL281C",337).
component("YOR393W",323).
component("YMR323W",278).
component("YHR174W",198).
component("YGR254W",188).
component("YGL026C",168) :- not remove_orf("YGL026C",168).
component("YGR155W",184).
component("YNL316C",288).
component("YKL182W",238).
component("YDR127W",127).
component("YGL148W",172).
component("YAL012W",67).
component("YBR019C",76).
component("YDR050C",121).
component("YDR007W",117) :- not remove_orf("YDR007W",117).
component("YOR095C",303).
component("YGL001C",165).
component("YMR105C",269).
component("YKL127W",234).
component("YPR060C",340).
component("YHR091C",194).
component("YDR341C",134).
component("YOL097C",300).
component("YOR335C",317).
component("YGR094W",181).
component("U89_",65).
component("YJL101C",210).
component("YJR103W",223).
component("YBL039C",73).
component("YOL058W",297).
component("YBR208C",90).
component("YHR074W",193).
component("YOR303W",315).
component("YGL062W",170).
component("YBR218C",91).
component("YPL231W",332).
component("YNR016C",291).
component("YKL182W",239).
component("YGR037C",178).
component("YOR005C",301).
component("YDL164C",110).
component("YPR138C",346).
component("YPL265W",334).
component("YPL036W",327).
component("YOR192C",309).
component("YOR071C",302).
component("YOL020W",295) :- not remove_orf("YOL020W",295).
component("YNL142W",284).
component("YLR348C",258).
component("YLR237W",252).
component("YKR053C",244).
component("YKR039W",243) :- not remove_orf("YKR039W",243).
component("YJR095W",222).
component("YJR077C",220).
component("YJL134W",213).
component("YJL129C",212).
component("YGR121C",182).
component("YGL008C",166).
component("YFL055W",159).
component("YEL017C-A",146).
component("YDR536W",145).
component("YDR508C",144).
component("YDR503C",143).
component("YDR046C",120) :- not remove_orf("YDR046C",120).
component("YCR024C-A",102).
component("YCL025C",99).
component("YBR298C",97).
component("YBR291C",96).
component("YBR069C",80) :- not remove_orf("YBR069C",80).
component("YBR068C",79) :- not remove_orf("YBR068C",79).
component("YBR021W",77).
component("U75_",59).
component("U74_",58).
component("U73_",57).
component("U72_",56).
...
catalyst(6160,276).
catalyst(3870,151).
catalyst(3620,135) :- not remove_reaction(3620,135).
catalyst(2190,162).
catalyst(5550,227).
catalyst(5650,260).
catalyst(5650,141).
...
catalyst(3630,154) :- not remove_reaction(3630,154).
catalyst(3740,126).
catalyst(8231,337).
catalyst(8232,337).
catalyst(8231,323).
...
catalyst(8231,188).
catalyst(8232,188).
catalyst(3590,168) :- not remove_reaction(3590,168).
catalyst(10910,168) :- not remove_reaction(10910,168).
catalyst(4570,184).
catalyst(3680,288).
catalyst(7141,238).
catalyst(7142,238).
...
catalyst(8281,121).
catalyst(8282,121).
catalyst(3610,117) :- not remove_reaction(3610,117).
catalyst(7921,303).
catalyst(7922,303).
catalyst(6370,165).
catalyst(7861,269).
...
catalyst(781,243) :- not remove_reaction(781,243).
catalyst(782,243) :- not remove_reaction(782,243).
...
catalyst(881,243) :- not remove_reaction(881,243).
catalyst(882,243) :- not remove_reaction(882,243).
catalyst(1191,243) :- not remove_reaction(1191,243).
catalyst(1192,243) :- not remove_reaction(1192,243).
catalyst(1250,222).
catalyst(1581,220).
catalyst(1582,220).
catalyst(6560,213).
...
catalyst(1501,96).
catalyst(1502,96).
catalyst(771,80) :- not remove_reaction(771,80).
catalyst(772,80) :- not remove_reaction(772,80).
