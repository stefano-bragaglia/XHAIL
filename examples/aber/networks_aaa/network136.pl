...
component("YNL280C",732).
component("YLR056W",618).
component("YGR060W",431).
component("YGL012W",399).
component("YKR009C",601).
component("YOL086C",763).
component("YMR303C",701).
component("YMR083W",676).
component("YGL256W",423).
component("YDL168W",260).
component("YBR145W",196).
component("YPL231W",835).
component("U46_",108).
component("YBR149W",197).
component("YBR149W",198).
component("YJR159W",570).
component("YGL001C",396).
component("YIL094C",506).
component("YHR063C",479).
component("YBR153W",199).
component("YML056C",661).
component("YLR432W",654).
component("YHR216W",496).
component("YAR075W",158).
component("YAR073W",157).
component("YCL030C",223).
component("YDR127W",290).
component("YJR139C",564).
component("YOL126C",768).
component("YKL085W",580).
component("YDL078C",241).
component("YKL029C",575).
component("YOR136W",780).
component("YNL037C",706).
component("YDL066W",240).
component("YNL241C",722).
component("YOL059W",761).
component("YDL022W",235).
component("YLR355C",650).
component("YIL074C",504).
component("YER081W",366).
component("YML054C",660).
component("YDL174C",262).
component("YML086C",664).
component("YIL155C",512).
component("YPR191W",871).
component("YOR065W",774).
component("YJL166W",540).
component("YHR001W-A",468).
component("YGR183C",446).
component("YFR033C",392).
component("YDR529C",336).
component("YBL045C",164).
component("Q0105",18).
component("YGR088W",434).
component("YDR256C",305).
component("YKL026C",574).
component("YIR037W",521).
component("YBR244W",211).
component("YJR078W",555).
component("YJR025C",548).
component("YGR255C",458).
component("U108_",22).
component("YBL098W",168).
component("YMR015C",673).
component("YHR007C",469).
component("YDR402C",325).
component("YGL055W",406).
component("YGR175C",443).
component("YJR104C",558).
component("YHR008C",470).
component("YJL026W",523).
component("YIL066C",503).
component("YGR180C",445).
component("YER070W",363).
component("U38_",103).
component("U36_",102).
component("U35_",101).
component("YDL168W",261).
component("YDR158W",298).
component("YBR006W",171).
component("YPL276W",847).
component("YPL275W",846).
component("YOR388C",813).
component("YOR374W",810).
component("YER073W",364).
component("U68_",123).
component("YGL154C",414).
component("U55_",117).
component("YOR323C",802).
component("YMR170C",685).
component("YMR169C",684).
component("U2_",97).
component("YER178W",379).
component("YBR221C",209).
component("YIL125W",510).
component("U52_",114).
component("YBR166C",202).
component("YNL280C",733).
component("YGL012W",400).
component("U57_",118).
component("YKL216W",598).
component("YDR044W",278).
component("YER014W",348).
component("YKR009C",602).
component("YIL160C",514).
component("YGL205W",417).
component("YMR118C",681).
component("YLR164W",631).
component("YLL041C",611).
component("YKL148C",587).
component("YKL141W",585).
component("YJL045W",524).
component("YDR178W",299).
component("YJR051W",550).
component("YEL047C",342).
component("YDL215C",266).
component("YOR375C",811).
component("YDL215C",267).
component("YAL062W",155).
component("U99_",149).
component("YBR035C",181).
component("YMR189W",687).
component("YHR037W",476).
component("YKR080W",606).
component("YER023W",350).
component("YPL023C",817).
component("YGL125W",411).
component("YOR236W",795).
component("YGR204W",450).
component("YLR142W",626).
component("U62_",121).
component("YKL150W",588).
component("YIL043C",500).
component("YHR042W",477).
component("YOR221C",793).
component("YML120C",667).
component("YKL192C",595).
component("YKL055C",577).
component("YER061C",359).
component("YGR234W",453).
component("YFR030W",391).
component("YPL017C",816).
component("YFL018C",383).
component("YDR353W",320).
component("YER042W",352).
component("YJR137C",563).
component("YPL266W",842).
component("YML110C",666).
component("YBR034C",180).
component("YPL273W",844).
component("YLL062C",614).
component("YDR410C",328).
component("U47_",109).
component("YER091C",371).
component("YJR073C",553).
component("YDR120C",288).
component("YDL033C",237).
component("YOL096C",764).
component("YLR172C",632).
component("YDR019C",274).
component("YBR176W",203).
component("YDR408C",327).
component("YMR120C",682).
component("YBL013W",159).
component("YKL024C",573).
component("YPR074C",860).
component("YBR117C",192).
component("YLR354C",649).
component("YGR043C",429).
component("YMR108W",679).
component("YCL009C",221).
component("YMR062C",675).
component("YNL071W",709).
component("YNR008W",740).
component("YIL160C",515).
component("YNL277W",731).
component("YFL017C",382).
component("YPL231W",836).
component("YER061C",360).
component("U86_",138).
component("YPL001W",815).
component("YDR148C",296).
component("YOR377W",812).
component("YGR177C",444).
component("YPL231W",837).
component("YGR147C",439).
component("YDL040C",238).
component("YPL028W",818).
component("YGL017W",401).
component("YPR001W",849).
component("YNR001C",738).
component("YDL182W",263).
component("YDL131W",251).
component("YNL117W",713).
component("YIR031C",519).
component("YOR321W",801).
component("YJR143C",565).
component("YGR199W",449).
component("YDR307W",314).
component("YDL095W",246).
component("YDL093W",245).
component("YAL023C",152).
component("YNL029C",705).
component("YIL085C",505).
component("YMR261C",695).
component("YML100W",665).
component("YBR126C",195).
component("YNL192W",721).
component("YBR038W",183).
component("YBR023C",179).
component("YMR306W",703).
component("YLR342W",647).
component("YGR032W",427).
component("YLR209C",633).
component("U104_",21).
component("YOR209C",791).
component("YMR300C",700).
component("YER055C",355).
component("YDR354W",321) :- not remove_orf("YDR354W",321).
component("YFR047C",393).
component("YJR133W",562).
component("YLR209C",634).
component("YML022W",657).
component("YDR441C",331).
component("YDR399W",323).
component("YPR176C",868).
component("YPL172C",828).
component("YNR041C",746).
component("YMR101C",677).
component("YDL090C",244).
component("YBR003W",170).
component("YBR002C",169).
component("YJL167W",541).
component("YNL256W",725).
component("YDR127W",291).
component("YLR303W",641).
component("YGR012W",425).
component("YJR130C",561).
component("YLR303W",642).
component("YDR035W",276).
component("YBR249C",212).
component("YOR274W",797).
component("YOL143C",770).
component("YBR256C",214).
component("YHR137W",488).
component("YGL202W",416).
component("YLR027C",615).
component("YKL106W",582).
component("YKL104C",581).
component("YGR019W",426).
component("YLR089C",621).
component("U64_",122).
component("U61_",120).
component("U51_",113).
component("YJR148W",566).
component("YHR208W",494).
component("YOR184W",786).
component("YNR058W",749).
component("YIL116W",509).
component("YGL253W",422).
component("YFR053C",394).
component("YOL136C",769).
component("YIL107C",507).
component("YMR013C",672).
component("YMR205C",688).
component("YGR240C",454).
component("YDR248C",304).
component("YCR036W",231).
component("YGR194C",448).
component("YCL040W",225).
component("YJR105W",559).
component("U16_",52).
component("U15_",46).
component("U96_",147).
component("YKL001C",571).
component("YDR236C",302).
component("YML070W",663).
component("YFL053W",386).
component("YHL032C",466).
component("YLR133W",623).
component("YDR531W",338).
component("U83_",136).
component("U82_",135).
component("U81_",134).
component("YMR208W",689).
component("YPL203W",830).
component("YOR061W",773).
component("YKL166C",590).
component("YJL164C",539).
component("YIL035C",499).
component("YHR205W",493).
component("YHR102W",486).
component("YGL019W",402).
component("YHR025W",475).
component("YOR347C",807).
component("YAL038W",154).
component("YNR012W",741).
component("YPR121W",864).
component("YPL258C",839).
component("YOL055C",757).
component("YPL214C",833).
component("U1_",75).
component("YDR009W",273).
component("YBR020W",177).
component("YNL267W",729).
component("YLR305C",644).
component("YFR019W",389).
component("YDR208W",300).
component("YDR127W",292).
component("U21_",85).
component("U20_",82).
component("YDR147W",295).
component("YDR300C",313).
component("YCR012W",227).
component("YER052C",353).
component("U18_",67).
component("U17_",60).
component("U76_",131).
component("YMR220W",691).
component("YER170W",378).
component("YDR226W",301).
component("YKL067W",579).
component("YOL055C",758).
component("YDR454C",332).
component("YJR057W",551).
component("YOL061W",762).
component("YKL181W",591).
component("YHL011C",463).
component("YER099C",373).
component("YBL068W",167).
component("YOR143C",782).
component("YNL256W",726).
component("YLR328W",645).
component("YBR018C",173).
component("YBR018C",174).
component("YGR007W",424).
component("YLR328W",646).
component("YKR002W",600).
component("YDL103C",249).
component("U94_",146).
component("YJR010W",547).
component("YGL130W",412).
component("YDR530C",337).
component("YCL050C",226).
component("YPR190C",870).
component("YPR187W",869).
component("YPR110C",862).
component("YPR010C",852).
component("YOR341W",806).
component("YOR340C",805).
component("YOR224C",794).
component("YOR210W",792).
component("YOR207C",789).
component("YOR151C",783).
component("YOR116C",777).
component("YOL005C",751).
component("YNR003C",739).
component("YNL248C",724).
component("YNL151C",718).
component("YNL113W",712).
component("YKL144C",586).
component("YJR063W",552).
component("YJL148W",536).
component("YJL140W",535).
component("YIL021W",498).
component("YHR143W-A",489).
component("YGL070C",409).
component("YFL036W",385).
component("YDR404C",326).
component("YDR156W",297).
component("YDR045C",279).
component("YDL150W",258).
component("YDL140C",253).
component("YBR154C",201).
component("YPR175W",867).
component("YPL167C",827).
component("YOR330C",803).
component("YOL115W",767).
component("YNL299W",735).
component("YNL262W",728).
component("YNL102W",711).
component("YJR043C",549).
component("YJR006W",546).
component("YJL090C",528).
component("YIL139C",511).
component("YEL055C",343).
component("YDR419W",329).
component("YDR121W",289).
component("YDL102W",248).
component("YCR014C",228).
component("YBR278W",216).
component("YBL035C",161).
component("YKL035W",576).
component("YHL012W",464).
component("YHR123W",487).
component("YPR113W",863).
component("YBR243C",210).
component("YNL130C",714).
component("YDL142C",257).
component("YPL148C",825).
component("YER026C",351).
component("YCL004W",220).
component("YGR286C",462).
component("YJL068C",525).
component("YDR058C",283).
component("YNR034W",745).
component("YHR163W",491).
component("YGR248W",456).
component("YCR073W-A",232).
component("YDL086W",243).
component("YOL011W",753).
component("YMR008C",670).
component("YMR006C",669).
component("U101_",19).
component("YBL015W",160).
component("YJL068C",526).
component("YPL072W",821).
component("YOR124C",778).
component("YNL186W",720).
component("YMR304W",702).
component("YMR223W",692).
component("YKR098C",609).
component("YJL197W",542).
component("YIL156W",513).
component("YFR010W",388).
component("YER151C",376).
component("YER144C",375).
component("YER098W",372).
component("YDR069C",284).
component("YDL122W",250).
component("YBR058C",184).
component("YBL067C",166).
component("YDR272W",308).
component("U84_",137).
component("YLR377C",652).
component("YDR074W",285).
component("YPL179W",829).
component("YNR032W",743).
component("YML057W",662).
component("YML016C",656).
component("YLR433C",655).
component("YGR123C",437).
component("YER133W",374).
component("YER089C",369).
component("YDR436W",330).
component("YDR075W",286).
component("YDL188C",264).
component("YDL134C",252).
component("YDL047W",239).
component("YDL006W",233).
component("YBR125C",194).
component("YBL056W",165).
component("YPR073C",858).
component("YHR215W",495).
component("YDL024C",236).
component("YBR093C",190).
component("YBR092C",189).
component("YAR071W",156).
component("YIL053W",502).
component("YER062C",361).
component("YHR046C",478).
component("U9_",150).
component("YGR208W",452).
component("YPL228W",834).
component("YMR180C",686).
component("YDL236W",269).
component("YJL155C",538).
component("YPR073C",859).
component("YOR208W",790).
component("YNL053W",708).
component("YMR036C",674).
component("YIR026C",516).
component("YIL113W",508).
component("YFR028C",390).
component("YER075C",365).
component("YDL230W",268).
component("YBR276C",215).
component("U34_",100).
component("U33_",99).
component("U30_",98).
component("U28_",96).
...
component("U25_",94).
component("U24_",93).
component("YPL268W",843).
component("YOR360C",809).
component("YGL248W",421).
component("YKR031C",603).
component("YPL206C",831).
component("YGL027C",404).
component("YLR286C",639).
component("YJR153W",568).
component("YBR184W",204).
component("YOR190W",787).
component("YLR300W",640).
component("YGR282C",461).
component("YDR261C",306).
component("YDR400W",324).
component("U23_",92).
component("YML035C",658).
component("YJL070C",527).
component("YBR284W",217).
component("U102_",20).
component("YNL045W",707).
component("YLR160C",630).
component("YLR158C",629).
component("YLR157C",628).
component("YLR155C",627).
component("YDR321W",315).
component("YGL037C",405).
component("YMR293C",699).
component("YDR242W",303).
component("YBR208C",206).
component("YMR281W",698).
component("U53_",115).
component("YIR027C",517).
component("YPL111W",824).
component("YIR032C",520).
component("YIR029W",518).
component("YPR062W",857).
component("YMR120C",683).
component("YLR028C",616).
component("YHR144C",490).
component("YGR267C",460).
component("YNL141W",715).
component("YBR153W",200).
component("YDL238C",270).
component("YNL141W",716).
component("YLR245C",637).
component("YML035C",659).
component("YBR084W",187).
component("YJL126W",531).
component("U44_",107).
component("YDL100C",247).
component("U87_",139).
component("U40_",105).
component("YMR267W",696).
component("YBR011C",172).
component("YBR111C",191).
component("YBR252W",213).
component("YCL030C",224).
component("YER005W",347).
component("YIL048W",501).
component("YER166W",377).
component("YDR093W",287).
component("YAL026C",153).
component("YLR231C",635).
component("U88_",140).
component("YLR134W",624).
component("YLR044C",617).
component("YGR087C",433).
component("YDR380W",322).
component("YDL080C",242).
component("U98_",148).
component("YMR250W",694).
component("YKL184W",594).
component("YNR043W",747).
component("U93_",145).
component("YDR047W",281).
component("U54_",116).
component("YKL211C",596) :- not remove_orf("YKL211C",596).
component("YKR097W",608).
component("YOL052C",756).
component("YNL169C",719).
component("YGR170W",441).
component("YKL060C",578).
component("YNL256W",727).
component("YDR294C",310).
component("YEL046C",341).
component("YNR033W",744).
component("YPR006C",851).
component("YER065C",362).
component("YKL211C",597) :- not remove_orf("YKL211C",597).
component("YER090W",597) :- not remove_orf("YER090W",597).
component("YER090W",370) :- not remove_orf("YER090W",370).
component("YDR127W",293).
component("YPL281C",848).
component("YOR393W",814).
component("YMR323W",704).
component("YHR174W",492).
component("YGR254W",457).
component("YPL262W",840).
component("YGL026C",403) :- not remove_orf("YGL026C",403).
component("YGR155W",440).
component("YLR304C",643).
component("YJL200C",543).
component("YNL316C",736).
component("YKL182W",592).
component("YPL212C",832).
component("YNL292W",734).
component("YGL063W",408).
component("YFL001W",380).
component("YOR278W",798).
component("YPR002W",850).
component("U49_",110).
component("YDR127W",294).
component("YGL148W",413).
component("YER086W",367).
component("YLR359W",651).
component("YAL012W",151).
component("YFR055W",395).
component("YJL005W",522).
component("YOR176W",785).
component("YJL121C",530).
component("YBR019C",175).
component("YBR019C",176).
component("YDR050C",282).
component("YDR007W",272) :- not remove_orf("YDR007W",272).
component("YOR095C",776).
component("YER003C",346).
component("YBR196C",205).
component("YGL001C",397).
component("U14_",39).
component("YOL056W",759).
component("YKL152C",589).
component("YDL021W",234).
component("YMR105C",678).
component("YKL127W",583).
component("YEL058W",344).
component("YPR060C",856).
component("YHR072W",480).
component("YJL153C",537).
component("YPL097W",822).
component("YGR185C",447).
component("YGR264C",459).
component("YGR171C",442).
component("YHR011W",471).
component("YDR023W",275).
component("YPL104W",823).
component("YLL018C",610).
component("YPR081C",861).
component("YBR121C",193).
component("YHR020W",474).
component("YER087W",368).
component("YNL247W",723).
component("YOL033W",755).
component("YGL245W",420).
component("YHR091C",482).
component("YDR341C",316).
component("YOL097C",765).
component("YDR268W",307).
component("YPR047W",855).
component("YLR060W",619).
component("YFL022C",384).
component("YPR033C",853).
component("YHR019C",472).
component("YHR019C",473).
component("YPL160W",826).
component("YLR382C",653).
component("YNL073W",710).
component("YDR037W",277).
component("YOR335C",804).
component("YGR094W",435).
component("YOR317W",800).
component("YMR246W",693).
component("YIL009W",497).
component("YER015W",349).
component("YOR142W",781).
component("YGR244C",455).
component("YPR035W",854).
component("U89_",141).
component("YOR241W",796).
component("YMR113W",680).
component("YKL132C",584).
component("YJL101C",529).
component("U92_",144).
component("YGL234W",418).
component("U91_",143).
component("U90_",142).
component("YDL141W",254).
component("YDL141W",255).
component("YGL234W",419).
component("YDL141W",256).
component("YJR103W",557).
component("YBL039C",162).
component("YGR204W",451).
component("YBR084W",188).
component("YOL058W",760).
component("YBR208C",207).
component("YHR074W",481).
component("YMR217W",690).
component("YGR061C",432).
component("YPR145W",866).
component("YGR124W",438).
component("YOR303W",799).
component("YJR109C",560).
component("YJL130C",533).
component("YGL062W",407).
component("YBR218C",208).
component("YPL231W",838).
component("YNR016C",742).
component("YKL182W",593).
component("YGR037C",428).
component("YOR005C",772).
component("YDL164C",259).
component("YOL010W",752).
component("YPR138C",865).
component("YPL274W",845).
component("YPL265W",841).
component("YPL057C",820).
component("YPL036W",819).
component("YOR348C",808).
component("YOR192C",788).
component("YOR171C",784).
component("YOR130C",779).
component("YOR071C",775).
component("YOL156W",771).
component("YOL103W",766).
component("YOL020W",754) :- not remove_orf("YOL020W",754).
component("YNR072W",750).
component("YNR056C",748).
component("YNL318C",737).
component("YNL268W",730).
component("YNL142W",717).
component("YMR272C",697).
component("YMR011W",671).
component("YML123C",668).
component("YLR348C",648).
component("YLR260W",638).
component("YLR237W",636).
component("YLR138W",625).
component("YLR100C",622).
component("YLR081W",620).
component("YLL061W",613).
component("YLL043W",612).
component("YKR093W",607).
component("YKR053C",605).
component("YKR039W",604) :- not remove_orf("YKR039W",604).
component("YKL217W",599).
component("YKL004W",572).
component("YJR158W",569).
component("YJR152W",567).
component("YJR095W",556).
component("YJR077C",554).
component("YJL219W",545).
component("YJL214W",544).
component("YJL134W",534).
component("YJL129C",532).
component("YHR096C",485).
component("YHR094C",484).
component("YHR092C",483).
component("YHL036W",467).
component("YHL016C",465).
component("YGR121C",436).
component("YGR055W",430).
component("YGL186C",415).
component("YGL077C",410).
component("YGL008C",398).
component("YFL055W",387).
component("YFL011W",381).
component("YER060W-A",358).
component("YER060W",357).
component("YER056C",356).
component("YER053C",354).
component("YEL069C",345).
component("YEL017C-A",340).
component("YDR536W",339).
component("YDR508C",335).
component("YDR503C",334).
component("YDR497C",333).
component("YDR345C",319).
component("YDR343C",318).
component("YDR342C",317).
component("YDR297W",312).
component("YDR294C",311).
component("YDR284C",309).
component("YDR046C",280) :- not remove_orf("YDR046C",280).
component("YDL245C",271).
component("YDL210W",265).
component("YCR032W",230).
component("YCR024C-A",229).
component("YCL025C",222).
component("YBR298C",219).
component("YBR291C",218).
component("YBR069C",186) :- not remove_orf("YBR069C",186).
component("YBR068C",185) :- not remove_orf("YBR068C",185).
component("YBR036C",182).
component("YBR021W",178).
component("YBL042C",163).
component("U79_",133).
component("U78_",132).
component("U75_",130).
component("U74_",129).
...
catalyst(6160,700).
catalyst(3870,355).
catalyst(3620,321) :- not remove_reaction(3620,321).
catalyst(2110,393).
catalyst(2190,393).
catalyst(5550,562).
catalyst(5791,634).
...
catalyst(1960,281).
catalyst(3460,116).
catalyst(3600,596) :- not remove_reaction(3600,596).
catalyst(8000,608).
catalyst(3941,756).
catalyst(3942,756).
catalyst(6890,719).
...
catalyst(8020,851).
catalyst(8020,362).
catalyst(1890,597) :- not remove_reaction(1890,597).
catalyst(3630,597) :- not remove_reaction(3630,597).
catalyst(1890,370) :- not remove_reaction(1890,370).
catalyst(3630,370) :- not remove_reaction(3630,370).
catalyst(3740,293).
catalyst(8231,848).
catalyst(8232,848).
catalyst(8231,814).
...
catalyst(8051,840).
catalyst(8052,840).
catalyst(3590,403) :- not remove_reaction(3590,403).
catalyst(10910,403) :- not remove_reaction(10910,403).
catalyst(4570,440).
catalyst(8181,643).
catalyst(8182,643).
catalyst(8181,543).
...
catalyst(8281,282).
catalyst(8282,282).
catalyst(3610,272) :- not remove_reaction(3610,272).
catalyst(7921,776).
catalyst(7922,776).
catalyst(7841,346).
catalyst(7842,346).
...
catalyst(1210,771).
catalyst(1160,766).
catalyst(801,754) :- not remove_reaction(801,754).
catalyst(802,754) :- not remove_reaction(802,754).
catalyst(811,754) :- not remove_reaction(811,754).
catalyst(812,754) :- not remove_reaction(812,754).
catalyst(831,754) :- not remove_reaction(831,754).
catalyst(832,754) :- not remove_reaction(832,754).
catalyst(901,754) :- not remove_reaction(901,754).
catalyst(902,754) :- not remove_reaction(902,754).
catalyst(941,754) :- not remove_reaction(941,754).
catalyst(942,754) :- not remove_reaction(942,754).
catalyst(1210,750).
catalyst(700,748).
catalyst(1200,737).
catalyst(761,730).
...
catalyst(640,607).
catalyst(6560,605).
catalyst(761,604) :- not remove_reaction(761,604).
catalyst(762,604) :- not remove_reaction(762,604).
catalyst(771,604) :- not remove_reaction(771,604).
catalyst(772,604) :- not remove_reaction(772,604).
catalyst(781,604) :- not remove_reaction(781,604).
catalyst(782,604) :- not remove_reaction(782,604).
catalyst(791,604) :- not remove_reaction(791,604).
catalyst(792,604) :- not remove_reaction(792,604).
catalyst(801,604) :- not remove_reaction(801,604).
catalyst(802,604) :- not remove_reaction(802,604).
catalyst(811,604) :- not remove_reaction(811,604).
catalyst(812,604) :- not remove_reaction(812,604).
catalyst(821,604) :- not remove_reaction(821,604).
catalyst(822,604) :- not remove_reaction(822,604).
catalyst(831,604) :- not remove_reaction(831,604).
catalyst(832,604) :- not remove_reaction(832,604).
catalyst(841,604) :- not remove_reaction(841,604).
catalyst(842,604) :- not remove_reaction(842,604).
catalyst(861,604) :- not remove_reaction(861,604).
catalyst(862,604) :- not remove_reaction(862,604).
catalyst(881,604) :- not remove_reaction(881,604).
catalyst(882,604) :- not remove_reaction(882,604).
catalyst(901,604) :- not remove_reaction(901,604).
catalyst(902,604) :- not remove_reaction(902,604).
catalyst(911,604) :- not remove_reaction(911,604).
catalyst(912,604) :- not remove_reaction(912,604).
catalyst(921,604) :- not remove_reaction(921,604).
catalyst(922,604) :- not remove_reaction(922,604).
catalyst(941,604) :- not remove_reaction(941,604).
catalyst(942,604) :- not remove_reaction(942,604).
catalyst(1191,604) :- not remove_reaction(1191,604).
catalyst(1192,604) :- not remove_reaction(1192,604).
catalyst(1021,599).
catalyst(1022,599).
catalyst(6610,572).
catalyst(1210,569).
...
catalyst(6550,311).
catalyst(6690,309).
catalyst(791,280) :- not remove_reaction(791,280).
catalyst(792,280) :- not remove_reaction(792,280).
catalyst(801,280) :- not remove_reaction(801,280).
catalyst(802,280) :- not remove_reaction(802,280).
catalyst(811,280) :- not remove_reaction(811,280).
catalyst(812,280) :- not remove_reaction(812,280).
catalyst(831,280) :- not remove_reaction(831,280).
catalyst(832,280) :- not remove_reaction(832,280).
catalyst(841,280) :- not remove_reaction(841,280).
catalyst(842,280) :- not remove_reaction(842,280).
catalyst(861,280) :- not remove_reaction(861,280).
catalyst(862,280) :- not remove_reaction(862,280).
catalyst(901,280) :- not remove_reaction(901,280).
catalyst(902,280) :- not remove_reaction(902,280).
catalyst(1210,271).
catalyst(690,265).
catalyst(730,265).
catalyst(431,230).
...
catalyst(1511,218).
catalyst(1512,218).
catalyst(771,186) :- not remove_reaction(771,186).
catalyst(772,186) :- not remove_reaction(772,186).
catalyst(791,186) :- not remove_reaction(791,186).
catalyst(792,186) :- not remove_reaction(792,186).
catalyst(801,186) :- not remove_reaction(801,186).
catalyst(802,186) :- not remove_reaction(802,186).
catalyst(811,186) :- not remove_reaction(811,186).
catalyst(812,186) :- not remove_reaction(812,186).
catalyst(861,186) :- not remove_reaction(861,186).
catalyst(862,186) :- not remove_reaction(862,186).
catalyst(901,186) :- not remove_reaction(901,186).
catalyst(902,186) :- not remove_reaction(902,186).
catalyst(791,185) :- not remove_reaction(791,185).
catalyst(792,185) :- not remove_reaction(792,185).
catalyst(801,185) :- not remove_reaction(801,185).
catalyst(802,185) :- not remove_reaction(802,185).
catalyst(811,185) :- not remove_reaction(811,185).
catalyst(812,185) :- not remove_reaction(812,185).
catalyst(831,185) :- not remove_reaction(831,185).
catalyst(832,185) :- not remove_reaction(832,185).
catalyst(841,185) :- not remove_reaction(841,185).
catalyst(842,185) :- not remove_reaction(842,185).
catalyst(861,185) :- not remove_reaction(861,185).
catalyst(862,185) :- not remove_reaction(862,185).
catalyst(901,185) :- not remove_reaction(901,185).
catalyst(902,185) :- not remove_reaction(902,185).
catalyst(6600,182).
catalyst(620,178).
catalyst(540,163).
catalyst(2830,133).
...
modifiable_enzyme(596).
modifiable_enzyme(597).
modifiable_enzyme(370).
modifiable_enzyme(403).
modifiable_enzyme(272).
modifiable_enzyme(754).
modifiable_enzyme(604).
modifiable_enzyme(280).
modifiable_enzyme(186).
modifiable_enzyme(185).
