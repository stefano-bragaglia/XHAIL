...
component("YGR060W",153).
component("YGL012W",142).
component("YOL086C",255).
component("YMR303C",236).
component("YGL256W",150).
component("YDL168W",92).
component("YBR145W",70).
component("YPL231W",280).
component("YGL001C",139).
component("YML056C",224).
component("YLR432W",222).
component("YHR216W",170).
component("YAR075W",58).
component("YAR073W",57).
component("YDR127W",102).
component("YJR139C",196).
component("YOR136W",260).
component("YIL155C",174).
component("YJR078W",190).
component("YJR025C",186).
component("YMR015C",228).
component("YDR402C",116).
component("YJR104C",193).
component("YHR008C",164).
component("YER070W",127).
component("YGL154C",148).
component("YOR323C",268).
component("YMR170C",232).
component("YMR169C",231).
component("YBR166C",72).
component("YER014W",124).
component("YMR118C",230).
component("YLR164W",216).
component("YLL041C",212).
component("YKL148C",203).
component("YJL045W",178).
component("YDR178W",108).
component("YJR051W",187).
component("YEL047C",123).
component("YOR375C",273).
component("YDL215C",93).
component("YAL062W",56).
component("YER023W",125).
component("YOR236W",267).
component("YGR204W",159).
component("U62_",45).
component("YPL017C",276).
component("YFL018C",131).
component("U47_",40).
component("YKL024C",199).
component("YPR074C",290).
component("YBR117C",69).
component("YCL009C",81).
component("YPL231W",281).
component("YPL001W",275).
component("YPL231W",282).
component("YPL028W",277).
component("YNL117W",242).
component("YIR031C",176).
component("YNL029C",238).
component("YIL085C",172).
component("YLR209C",217).
component("YER055C",126).
component("YDR354W",112) :- not remove_orf("YDR354W",112).
component("YFR047C",137).
component("YJR133W",195).
component("YDR399W",114).
component("YDR127W",103).
component("YJR130C",194).
component("YDR035W",98).
component("YBR249C",75).
component("YBR256C",76).
component("YHR137W",166).
component("YLR027C",213).
component("YKL106W",201).
component("U64_",46).
component("U51_",41).
component("YJR148W",197).
component("YGL253W",149).
component("YFR053C",138).
component("YMR205C",234).
component("YGR240C",160).
component("YCR036W",85).
component("U16_",25).
component("U15_",23).
component("YKL001C",198).
component("YML070W",225).
component("YFL053W",133).
component("U83_",52).
component("U82_",51).
component("YMR208W",235).
component("YOR347C",272).
component("YAL038W",55).
component("U1_",32).
component("YNL267W",246).
component("YLR305C",221).
component("YFR019W",135).
component("YDR208W",109).
component("YDR127W",104).
component("U20_",35).
component("YDR300C",111).
component("U18_",29).
component("U76_",50).
component("YDR454C",118).
component("YOL061W",254).
component("YKL181W",204).
component("YHL011C",162).
component("YER099C",130).
component("YBL068W",61).
component("YOR143C",261).
component("YGR007W",151).
component("YCL050C",83).
component("YPR190C",294).
component("YPR187W",293).
component("YPR110C",291).
component("YPR010C",286).
component("YOR341W",271).
component("YOR340C",270).
component("YOR224C",266).
component("YOR210W",265).
component("YOR207C",263).
component("YOR151C",262).
component("YOR116C",259).
component("YOL005C",251).
component("YNR003C",248).
component("YNL248C",245).
component("YNL151C",244).
component("YNL113W",241).
component("YKL144C",202).
...
component("YFL036W",132).
component("YDR404C",117).
component("YDR156W",107).
component("YDR045C",99).
component("YDL150W",90).
component("YDL140C",89).
component("YBR154C",71).
component("YKL035W",200).
component("YHL012W",163).
component("YDR058C",101).
component("YDL086W",88).
component("YOL011W",252).
component("YMR008C",227).
component("YMR006C",226).
component("U101_",18).
component("YBL015W",59).
component("U84_",53).
component("YPR073C",288).
component("YHR215W",169).
component("YDL024C",86).
component("YBR093C",67).
component("YBR092C",66).
component("YPL228W",279).
component("YMR180C",233).
component("YDL236W",95).
component("YJL155C",185).
component("YPR073C",289).
component("YOR208W",264).
component("YNL053W",240).
component("YMR036C",229).
component("YIR026C",175).
component("YIL113W",173).
component("YFR028C",136).
component("YER075C",128).
component("YDL230W",94).
component("YBR276C",77).
component("U34_",39).
component("U30_",38).
component("U24_",37).
component("YKR031C",209).
component("YLR286C",220).
component("YDR400W",115).
component("YML035C",223).
component("YJL070C",179).
component("YBR284W",78).
component("YNL045W",239).
component("YGL037C",144).
component("U53_",42).
component("YIR032C",177).
component("YDL238C",96).
component("YLR245C",219).
component("YJL126W",181).
component("YBR111C",68).
component("YLR231C",218).
component("U88_",54).
component("YLR134W",215).
component("YLR044C",214).
component("YGR087C",154).
component("YDR380W",113).
component("YDL080C",87).
component("U54_",43).
component("YKL211C",207) :- not remove_orf("YKL211C",207).
component("YGR170W",158).
component("YDR294C",110).
component("YNR033W",250).
component("YKL211C",208) :- not remove_orf("YKL211C",208).
component("YER090W",208) :- not remove_orf("YER090W",208).
component("YER090W",129) :- not remove_orf("YER090W",129).
component("YDR127W",105).
component("YPL281C",285).
component("YOR393W",274).
component("YMR323W",237).
component("YHR174W",168).
component("YGR254W",161).
component("YGL026C",143) :- not remove_orf("YGL026C",143).
component("YGR155W",157).
component("YNL316C",247).
component("YKL182W",205).
component("YDR127W",106).
component("YGL148W",147).
component("YBR019C",62).
component("YDR007W",97) :- not remove_orf("YDR007W",97).
component("YOR095C",258).
component("YGL001C",140).
component("YPR060C",287).
component("YOL097C",256).
component("YOR335C",269).
component("YGR094W",155).
component("YJL101C",180).
component("YJR103W",192).
component("YBL039C",60).
component("YBR208C",73).
component("YHR074W",165).
component("YGL062W",145).
component("YBR218C",74).
component("YPL231W",283).
component("YNR016C",249).
component("YKL182W",206).
component("YGR037C",152).
component("YOR005C",257).
component("YDL164C",91).
component("YPR138C",292).
component("YPL265W",284).
component("YPL036W",278).
component("YOL020W",253) :- not remove_orf("YOL020W",253).
component("YNL142W",243).
component("YKR053C",211).
component("YKR039W",210) :- not remove_orf("YKR039W",210).
component("YJR095W",191).
component("YJR077C",189).
component("YJL134W",182).
component("YGR121C",156).
component("YGL008C",141).
component("YFL055W",134).
component("YEL017C-A",122).
component("YDR536W",121).
component("YDR508C",120).
component("YDR503C",119).
component("YDR046C",100) :- not remove_orf("YDR046C",100).
component("YCR024C-A",84).
component("YCL025C",82).
component("YBR298C",80).
component("YBR291C",79).
component("YBR069C",65) :- not remove_orf("YBR069C",65).
component("YBR068C",64) :- not remove_orf("YBR068C",64).
component("YBR021W",63).
component("U71_",49).
component("U6_",48).
component("U69_",47).
component("U5_",44).
...
catalyst(5612,217).
catalyst(3870,126).
catalyst(3620,112) :- not remove_reaction(3620,112).
catalyst(2190,137).
catalyst(5550,195).
catalyst(5320,114).
catalyst(3710,103).
...
catalyst(8802,87).
catalyst(3460,43).
catalyst(3600,207) :- not remove_reaction(3600,207).
catalyst(6900,158).
catalyst(8781,110).
catalyst(8782,110).
catalyst(2550,250).
catalyst(3630,208) :- not remove_reaction(3630,208).
...
catalyst(8711,62).
catalyst(8712,62).
catalyst(3610,97) :- not remove_reaction(3610,97).
catalyst(7921,258).
catalyst(7922,258).
catalyst(6370,140).
catalyst(3690,287).
...
catalyst(781,210) :- not remove_reaction(781,210).
catalyst(782,210) :- not remove_reaction(782,210).
...
catalyst(881,210) :- not remove_reaction(881,210).
catalyst(882,210) :- not remove_reaction(882,210).
catalyst(1191,210) :- not remove_reaction(1191,210).
catalyst(1192,210) :- not remove_reaction(1192,210).
catalyst(1250,191).
catalyst(1581,189).
catalyst(1582,189).
catalyst(6560,182).
...
catalyst(1501,79).
catalyst(1502,79).
catalyst(771,65) :- not remove_reaction(771,65).
catalyst(772,65) :- not remove_reaction(772,65).
