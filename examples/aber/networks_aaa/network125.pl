...
component("YML056C",610).
component("YLR432W",603).
...
component("YKL029C",528).
component("YOR136W",720).
component("YNL037C",651).
component("YDL066W",227).
component("YNL241C",666).
component("YOL059W",702).
component("YDL022W",222).
component("YLR355C",600).
component("YML054C",609).
component("YDL174C",248).
component("YML086C",613).
component("YIL155C",470).
component("YPR191W",802).
component("YOR065W",714).
...
component("YPL276W",781).
component("YPL275W",780).
component("YOR388C",751).
...
component("YMR170C",632).
component("YMR169C",631).
component("U2_",95).
...
component("YKR009C",553).
component("YIL160C",472).
component("YGL205W",390).
component("YMR118C",628).
component("YLR164W",581).
component("YLL041C",561).
component("YKL148C",539).
component("YKL141W",537).
...
component("YPL023C",755).
component("YGL125W",384).
component("YOR236W",735).
component("YGR204W",421).
component("YLR142W",576).
component("U62_",117).
component("YKL150W",540).
component("YIL043C",459).
component("YHR042W",444).
component("YOR221C",733).
component("YML120C",616).
component("YKL192C",546).
component("YKL055C",530).
...
component("YPL266W",777).
component("YML110C",615).
component("YBR034C",171).
component("YPL273W",778).
...
component("YKL024C",526).
component("YPR074C",793).
component("YBR117C",182).
component("YLR354C",599).
component("YGR043C",401).
component("YMR108W",626).
component("YCL009C",209).
component("YMR062C",623).
component("YNL071W",654).
component("YNR008W",684).
component("YNL277W",675).
component("YFL017C",357).
component("YPL231W",771).
component("YER061C",336).
component("U86_",133).
component("YPL001W",753).
...
component("YML070W",612).
component("YFL053W",361).
component("YHL032C",434).
component("YLR133W",573).
component("YDR531W",317).
component("U83_",131).
component("U82_",130).
component("U81_",129).
component("YMR208W",635).
component("YHR025W",442).
component("YOR347C",745).
component("YAL038W",147).
component("YNR012W",685).
component("YPR121W",796).
component("YPL258C",774).
component("YOL055C",699).
component("U1_",73).
component("YDR009W",258).
component("YBR020W",168).
component("YNL267W",673).
component("YLR305C",594).
...
component("YOR224C",734).
component("YOR210W",732).
component("YOR207C",729).
component("YOR151C",723).
component("YOR116C",717).
component("YOL005C",693).
component("YNR003C",683).
component("YNL248C",668).
component("YNL151C",662).
component("YNL113W",657).
component("YKL144C",538).
...
component("YNR034W",689).
component("YHR163W",454).
component("YGR248W",427).
component("YCR073W-A",219).
component("YDL086W",230).
component("YOL011W",695).
component("YMR008C",619).
component("YMR006C",618).
component("U101_",19).
component("YBL015W",153).
component("YJL068C",482).
component("YPL072W",759).
component("YOR124C",718).
component("YNL186W",664).
component("YMR304W",647).
component("YMR223W",638).
...
component("YNR032W",687).
component("YML057W",611).
component("YML016C",605).
component("YLR433C",604).
...
component("YPL228W",769).
component("YMR180C",633).
component("YDL236W",255).
component("YJL155C",494).
component("YPR073C",792).
component("YOR208W",730).
component("YNL053W",653).
component("YMR036C",622).
...
component("YKR031C",554).
component("YPL206C",767).
component("YLR286C",589).
component("YJR153W",522).
component("YOR190W",727).
component("YLR300W",590).
...
component("U102_",20).
component("YNL045W",652).
component("YLR160C",580).
component("YLR158C",579).
component("YLR157C",578).
component("YLR155C",577).
component("YDR321W",298).
component("YGL037C",378).
component("YMR293C",644).
component("YDR242W",287).
component("YBR208C",194).
component("YMR281W",643).
component("U53_",111).
component("YIR027C",474).
component("YPL111W",762).
component("YIR032C",477).
component("YIR029W",475).
component("YPR062W",790).
...
component("YNL141W",660).
component("YLR245C",587).
component("YML035C",608).
component("YJL126W",487).
component("U44_",104).
component("YDL100C",233).
component("U87_",134).
component("YMR267W",641).
...
component("YPL212C",768).
component("YNL292W",678).
component("YGL063W",381).
component("YFL001W",355).
component("YOR278W",737).
component("YPR002W",784).
...
component("YJR103W",511).
component("YBL039C",155).
component("YGR204W",422).
component("YBR084W",178).
component("YOL058W",701).
component("YBR208C",195).
component("YHR074W",448).
component("YMR217W",636).
component("YGR061C",404).
component("YPR145W",798).
component("YGR124W",410).
component("YOR303W",738).
component("YJR109C",514).
component("YJL130C",489).
component("YGL062W",380).
component("YBR218C",196).
component("YPL231W",773).
component("YNR016C",686).
component("YKL182W",544).
component("YGR037C",400).
component("YOR005C",713).
component("YDL164C",245).
component("YOL010W",694).
component("YPR138C",797).
component("YPL274W",779).
component("YPL265W",776).
component("YPL057C",758).
component("YPL036W",757).
component("YOR348C",746).
component("YOR192C",728).
component("YOR171C",724).
component("YOR130C",719).
component("YOR071C",715).
component("YOL156W",712).
component("YOL103W",707).
component("YOL020W",696) :- not remove_orf("YOL020W",696).
component("YNR056C",691).
component("YNL318C",681).
component("YNL268W",674).
component("YNL142W",661).
component("YMR272C",642).
component("YML123C",617).
component("YLR348C",598).
component("YLR260W",588).
component("YLR237W",586).
component("YLR138W",575).
component("YLR100C",572).
component("YLR081W",570).
component("YLL061W",563).
component("YLL043W",562).
component("YKR093W",558).
component("YKR053C",556).
component("YKR039W",555) :- not remove_orf("YKR039W",555).
component("YKL217W",550).
component("YKL004W",525).
component("YJR152W",521).
component("YJR095W",510).
...
catalyst(1960,266).
catalyst(3460,112).
catalyst(3600,547) :- not remove_reaction(3600,547).
catalyst(3941,698).
catalyst(3942,698).
catalyst(6890,663).
catalyst(6900,413).
...
catalyst(8020,785).
catalyst(8020,338).
catalyst(1890,548) :- not remove_reaction(1890,548).
catalyst(3630,548) :- not remove_reaction(3630,548).
...
catalyst(640,558).
catalyst(6560,556).
catalyst(761,555) :- not remove_reaction(761,555).
catalyst(762,555) :- not remove_reaction(762,555).
catalyst(771,555) :- not remove_reaction(771,555).
catalyst(772,555) :- not remove_reaction(772,555).
catalyst(781,555) :- not remove_reaction(781,555).
catalyst(782,555) :- not remove_reaction(782,555).
catalyst(791,555) :- not remove_reaction(791,555).
catalyst(792,555) :- not remove_reaction(792,555).
...
catalyst(821,555) :- not remove_reaction(821,555).
catalyst(822,555) :- not remove_reaction(822,555).
catalyst(831,555) :- not remove_reaction(831,555).
catalyst(832,555) :- not remove_reaction(832,555).
catalyst(841,555) :- not remove_reaction(841,555).
catalyst(842,555) :- not remove_reaction(842,555).
catalyst(861,555) :- not remove_reaction(861,555).
catalyst(862,555) :- not remove_reaction(862,555).
catalyst(881,555) :- not remove_reaction(881,555).
catalyst(882,555) :- not remove_reaction(882,555).
catalyst(901,555) :- not remove_reaction(901,555).
catalyst(902,555) :- not remove_reaction(902,555).
catalyst(911,555) :- not remove_reaction(911,555).
catalyst(912,555) :- not remove_reaction(912,555).
catalyst(941,555) :- not remove_reaction(941,555).
catalyst(942,555) :- not remove_reaction(942,555).
catalyst(1191,555) :- not remove_reaction(1191,555).
catalyst(1192,555) :- not remove_reaction(1192,555).
catalyst(1021,550).
catalyst(1022,550).
catalyst(6610,525).
catalyst(170,521).
