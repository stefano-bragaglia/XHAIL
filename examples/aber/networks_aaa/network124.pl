...
component("YNL280C",675).
component("YLR056W",567).
component("YGR060W",403).
component("YGL012W",374).
component("YKR009C",551).
component("YOL086C",703).
component("YMR303C",645).
component("YMR083W",623).
component("YGL256W",395).
component("YDL168W",246).
component("YBR145W",186).
component("YPL231W",766).
component("U46_",105).
component("YBR149W",187).
component("YJR159W",522).
component("YGL001C",371).
component("YIL094C",464).
component("YHR063C",446).
component("YBR153W",188).
component("YML056C",609).
component("YLR432W",602).
component("YHR216W",457).
component("YAR075W",151).
component("YAR073W",150).
component("YDR127W",274).
component("YJR139C",517).
component("YOL126C",708).
component("YDL078C",228).
component("YKL029C",527).
component("YOR136W",718).
component("YNL037C",650).
component("YDL066W",227).
component("YNL241C",665).
component("YOL059W",701).
component("YDL022W",222).
component("YLR355C",599).
component("YML054C",608).
component("YDL174C",248).
component("YML086C",612).
component("YIL155C",470).
component("YPR191W",798).
component("YOR065W",713).
component("YJL166W",495).
component("YHR001W-A",436).
component("YGR183C",417).
component("YFR033C",367).
component("YDR529C",315).
component("YBL045C",157).
component("Q0105",18).
component("YGR088W",406).
component("YDR256C",289).
component("YKL026C",526).
component("YIR037W",478).
component("YBR244W",199).
component("YJR078W",508).
component("YJR025C",502).
component("YGR255C",429).
component("U108_",22).
component("YBL098W",161).
component("YMR015C",620).
component("YHR007C",437).
component("YDR402C",304).
component("YGL055W",379).
component("YGR175C",414).
component("YJR104C",511).
component("YHR008C",438).
component("YJL026W",479).
component("YIL066C",462).
component("YGR180C",416).
component("YER070W",339).
component("U38_",101).
component("U36_",100).
component("U35_",99).
component("YDL168W",247).
component("YDR158W",282).
component("YBR006W",162).
component("YPL276W",777).
component("YPL275W",776).
component("YOR388C",748).
component("YOR374W",745).
component("YER073W",340).
component("U68_",119).
component("YGL154C",387).
component("U55_",113).
component("YOR323C",737).
component("YMR170C",631).
component("YMR169C",630).
component("U2_",95).
component("YER178W",354).
component("YBR221C",197).
component("YIL125W",468).
component("U52_",110).
component("YBR166C",191).
component("YNL280C",676).
component("YGL012W",375).
component("U57_",114).
component("YKL216W",548).
component("YDR044W",263).
component("YER014W",326).
component("YKR009C",552).
component("YIL160C",472).
component("YGL205W",390).
component("YMR118C",627).
component("YLR164W",580).
component("YLL041C",560).
component("YKL148C",538).
component("YKL141W",536).
component("YJL045W",480).
component("YDR178W",283).
component("YJR051W",504).
component("YEL047C",321).
component("YDL215C",252).
component("YOR375C",746).
component("YDL215C",253).
component("YAL062W",148).
component("U99_",143).
component("YBR035C",172).
component("YHR037W",443).
component("YKR080W",556).
component("YER023W",327).
component("YPL023C",752).
component("YGL125W",384).
component("YOR236W",732).
component("YGR204W",421).
component("YLR142W",575).
component("U62_",117).
component("YKL150W",539).
component("YIL043C",459).
component("YHR042W",444).
component("YOR221C",730).
component("YML120C",615).
component("YKL192C",545).
component("YKL055C",529).
component("YER061C",335).
component("YGR234W",424).
component("YFR030W",366).
component("YPL017C",751).
component("YFL018C",358).
component("YER042W",329).
component("YJR137C",516).
component("YPL266W",773).
component("YML110C",614).
component("YBR034C",171).
component("YPL273W",774).
component("YLL062C",563).
component("YDR410C",307).
component("U47_",106).
component("YER091C",346).
component("YJR073C",506).
component("YDL033C",224).
component("YOL096C",704).
component("YLR172C",581).
component("YDR019C",259).
component("YBR176W",192).
component("YDR408C",306).
component("YMR120C",628).
component("YBL013W",152).
component("YKL024C",525).
component("YPR074C",789).
component("YBR117C",182).
component("YLR354C",598).
component("YGR043C",401).
component("YMR108W",625).
component("YCL009C",209).
component("YMR062C",622).
component("YNL071W",653).
component("YNR008W",683).
component("YNL277W",674).
component("YFL017C",357).
component("YPL231W",767).
component("YER061C",336).
component("U86_",133).
component("YPL001W",750).
component("YDR148C",280).
component("YOR377W",747).
component("YGR177C",415).
component("YPL231W",768).
component("YGR147C",411).
component("YDL040C",225).
component("YPL028W",753).
component("YGL017W",376).
component("YPR001W",779).
component("YNR001C",681).
component("YDL182W",249).
component("YDL131W",237).
component("YNL117W",657).
component("YIR031C",476).
component("YOR321W",736).
component("YJR143C",518).
component("YGR199W",420).
component("YDR307W",297).
component("YDL095W",232).
component("YDL093W",231).
component("YAL023C",145).
component("YNL029C",649).
component("YIL085C",463).
component("YMR261C",639).
component("YML100W",613).
component("YBR126C",185).
component("YNL192W",664).
component("YBR038W",174).
component("YBR023C",170).
component("YMR306W",647).
component("YLR342W",596).
component("YGR032W",399).
component("YLR209C",582).
component("U104_",21).
component("YOR209C",728).
component("YMR300C",644).
component("YER055C",331).
component("YDR354W",300) :- not remove_orf("YDR354W",300).
component("YFR047C",368).
component("YJR133W",515).
component("YLR209C",583).
component("YML022W",605).
component("YDR441C",310).
component("YDR399W",302).
component("YJL167W",496).
component("YNL256W",668).
component("YDR127W",275).
component("YLR303W",590).
component("YGR012W",397).
component("YJR130C",514).
component("YLR303W",591).
component("YDR035W",261).
component("YBR249C",200).
component("YOL143C",710).
component("YBR256C",202).
component("YHR137W",451).
component("YGL202W",389).
component("YLR027C",564).
component("YKL106W",533).
component("YKL104C",532).
component("YGR019W",398).
component("YLR089C",570).
component("U64_",118).
component("U61_",116).
component("U51_",109).
component("YJR148W",519).
component("YOR184W",723).
component("YNR058W",691).
component("YIL116W",467).
component("YGL253W",394).
component("YFR053C",369).
component("YOL136C",709).
component("YIL107C",465).
component("YMR013C",619).
component("YMR205C",633).
component("YGR240C",425).
component("YDR248C",288).
component("YCR036W",218).
component("YGR194C",419).
component("YCL040W",212).
component("YJR105W",512).
component("U16_",50).
component("U15_",44).
component("U96_",141).
component("YKL001C",523).
component("YDR236C",286).
component("YML070W",611).
component("YFL053W",361).
component("YHL032C",434).
component("YLR133W",572).
component("YDR531W",317).
component("U83_",131).
component("U82_",130).
component("U81_",129).
component("YMR208W",634).
component("YHR025W",442).
component("YOR347C",742).
component("YAL038W",147).
component("YNR012W",684).
component("YPR121W",792).
component("YPL258C",770).
component("YOL055C",698).
component("U1_",73).
component("YDR009W",258).
component("YBR020W",168).
component("YNL267W",672).
component("YLR305C",593).
component("YFR019W",364).
component("YDR208W",284).
component("YDR127W",276).
component("U21_",83).
component("U20_",80).
component("YDR147W",279).
component("YDR300C",296).
component("YCR012W",214).
component("U18_",65).
component("U17_",58).
component("U76_",127).
component("YMR220W",636).
component("YER170W",353).
component("YDR226W",285).
component("YKL067W",531).
component("YDR454C",311).
component("YOL061W",702).
component("YKL181W",541).
component("YHL011C",432).
component("YER099C",348).
component("YBL068W",160).
component("YOR143C",720).
component("YNL256W",669).
component("YLR328W",594).
component("YBR018C",164).
component("YBR018C",165).
component("YGR007W",396).
component("YLR328W",595).
component("YKR002W",550).
component("YDL103C",235).
component("YJR010W",501).
component("YGL130W",385).
component("YDR530C",316).
component("YCL050C",213).
component("YPR190C",797).
component("YPR187W",796).
component("YPR110C",791).
component("YPR010C",782).
component("YOR341W",741).
component("YOR340C",740).
component("YOR224C",731).
component("YOR210W",729).
component("YOR207C",726).
component("YOR151C",721).
component("YOR116C",716).
component("YOL005C",692).
component("YNR003C",682).
component("YNL248C",667).
component("YNL151C",661).
component("YNL113W",656).
component("YKL144C",537).
component("YJR063W",505).
component("YJL148W",492).
component("YJL140W",491).
component("YIL021W",458).
component("YHR143W-A",452).
component("YGL070C",382).
component("YFL036W",360).
component("YDR404C",305).
component("YDR156W",281).
component("YDR045C",264).
component("YDL150W",244).
component("YDL140C",239).
component("YBR154C",190).
component("YPR175W",795).
component("YPL167C",761).
component("YOR330C",738).
component("YOL115W",707).
component("YNL299W",678).
component("YNL262W",671).
component("YNL102W",655).
component("YJR043C",503).
component("YJR006W",500).
component("YJL090C",484).
component("YIL139C",469).
component("YEL055C",322).
component("YDR419W",308).
component("YDR121W",273).
component("YDL102W",234).
component("YCR014C",215).
component("YBR278W",204).
component("YBL035C",154).
component("YKL035W",528).
component("YHL012W",433).
component("YHR123W",450).
component("YBR243C",198).
component("YDL142C",243).
component("YER026C",328).
component("YCL004W",208).
component("YJL068C",481).
component("YDR058C",268).
component("YNR034W",688).
component("YHR163W",454).
component("YGR248W",427).
component("YCR073W-A",219).
component("YDL086W",230).
component("YOL011W",694).
component("YMR008C",618).
component("YMR006C",617).
component("U101_",19).
component("YBL015W",153).
component("YJL068C",482).
component("YPL072W",756).
component("YOR124C",717).
component("YNL186W",663).
component("YMR304W",646).
component("YMR223W",637).
component("YKR098C",558).
component("YJL197W",497).
component("YIL156W",471).
component("YFR010W",363).
component("YER151C",351).
component("YER144C",350).
component("YER098W",347).
component("YDR069C",269).
component("YDL122W",236).
component("YBR058C",175).
component("YBL067C",159).
component("YDR272W",292).
component("U84_",132).
component("YDR074W",270).
component("YPL179W",762).
component("YNR032W",686).
component("YML057W",610).
component("YML016C",604).
component("YLR433C",603).
component("YGR123C",409).
component("YER133W",349).
component("YER089C",344).
component("YDR436W",309).
component("YDR075W",271).
component("YDL188C",250).
component("YDL134C",238).
component("YDL047W",226).
component("YDL006W",220).
component("YBR125C",184).
component("YBL056W",158).
component("YPR073C",787).
component("YHR215W",456).
component("YDL024C",223).
component("YBR093C",180).
component("YBR092C",179).
component("YAR071W",149).
component("YIL053W",461).
component("YER062C",337).
component("YHR046C",445).
component("YGR208W",423).
component("YPL228W",765).
component("YMR180C",632).
component("YDL236W",255).
component("YJL155C",494).
component("YPR073C",788).
component("YOR208W",727).
component("YNL053W",652).
component("YMR036C",621).
component("YIR026C",473).
component("YIL113W",466).
component("YFR028C",365).
component("YER075C",341).
component("YDL230W",254).
component("YBR276C",203).
component("U34_",98).
component("U33_",97).
component("U30_",96).
component("U28_",94).
...
component("U25_",92).
component("U24_",91).
component("YOR360C",744).
component("YGL248W",393).
component("YKR031C",553).
component("YPL206C",763).
component("YLR286C",588).
component("YJR153W",521).
component("YOR190W",724).
component("YLR300W",589).
component("YGR282C",431).
component("YDR261C",290).
component("YDR400W",303).
component("U23_",90).
component("YML035C",606).
component("YJL070C",483).
component("YBR284W",205).
component("U102_",20).
component("YNL045W",651).
component("YLR160C",579).
component("YLR158C",578).
component("YLR157C",577).
component("YLR155C",576).
component("YDR321W",298).
component("YGL037C",378).
component("YMR293C",643).
component("YDR242W",287).
component("YBR208C",194).
component("YMR281W",642).
component("U53_",111).
component("YIR027C",474).
component("YPL111W",759).
component("YIR032C",477).
component("YIR029W",475).
component("YPR062W",786).
component("YMR120C",629).
component("YLR028C",565).
component("YHR144C",453).
component("YGR267C",430).
component("YNL141W",658).
component("YBR153W",189).
component("YDL238C",256).
component("YNL141W",659).
component("YLR245C",586).
component("YML035C",607).
component("YJL126W",487).
component("U44_",104).
component("YDL100C",233).
component("U87_",134).
component("YMR267W",640).
component("YBR011C",163).
component("YBR111C",181).
component("YBR252W",201).
component("YCL030C",211).
component("YER005W",325).
component("YIL048W",460).
component("YER166W",352).
component("YDR093W",272).
component("YAL026C",146).
component("YLR231C",584).
component("U88_",135).
component("YLR134W",573).
component("YLR044C",566).
component("YGR087C",405).
component("YDR380W",301).
component("YDL080C",229).
component("U98_",142).
component("YMR250W",638).
component("YKL184W",544).
component("YNR043W",689).
component("U93_",140).
component("YDR047W",266).
component("U54_",112).
component("YKL211C",546) :- not remove_orf("YKL211C",546).
component("YOL052C",697).
component("YNL169C",662).
component("YGR170W",413).
component("YKL060C",530).
component("YNL256W",670).
component("YDR294C",293).
component("YEL046C",320).
component("YNR033W",687).
component("YPR006C",781).
component("YER065C",338).
component("YKL211C",547) :- not remove_orf("YKL211C",547).
component("YER090W",547) :- not remove_orf("YER090W",547).
component("YER090W",345) :- not remove_orf("YER090W",345).
component("YDR127W",277).
component("YPL281C",778).
component("YOR393W",749).
component("YMR323W",648).
component("YHR174W",455).
component("YGR254W",428).
component("YPL262W",771).
component("YGL026C",377) :- not remove_orf("YGL026C",377).
component("YGR155W",412).
component("YLR304C",592).
component("YJL200C",498).
component("YNL316C",679).
component("YKL182W",542).
component("YPL212C",764).
component("YNL292W",677).
component("YGL063W",381).
component("YFL001W",355).
component("YOR278W",734).
component("YPR002W",780).
component("YDR127W",278).
component("YGL148W",386).
component("YER086W",342).
component("YLR359W",600).
component("YAL012W",144).
component("YFR055W",370).
component("YJL121C",486).
component("YBR019C",166).
component("YBR019C",167).
component("YDR050C",267).
component("YDR007W",257) :- not remove_orf("YDR007W",257).
component("YOR095C",715).
component("YER003C",324).
component("YBR196C",193).
component("YGL001C",372).
component("U14_",37).
component("YOL056W",699).
component("YKL152C",540).
component("YDL021W",221).
component("YMR105C",624).
component("YKL127W",534).
component("YEL058W",323).
component("YPR060C",785).
component("YHR072W",447).
component("YJL153C",493).
component("YPL097W",757).
component("YGR185C",418).
component("YHR011W",439).
component("YDR023W",260).
component("YPL104W",758).
component("YLL018C",559).
component("YPR081C",790).
component("YBR121C",183).
component("YHR020W",441).
component("YER087W",343).
component("YNL247W",666).
component("YOL033W",696).
component("YHR091C",449).
component("YDR341C",299).
component("YOL097C",705).
component("YDR268W",291).
component("YPR047W",784).
component("YLR060W",568).
component("YFL022C",359).
component("YPR033C",783).
component("YHR019C",440).
component("YPL160W",760).
component("YLR382C",601).
component("YNL073W",654).
component("YDR037W",262).
component("YOR335C",739).
component("YGR094W",407).
component("YOR142W",719).
component("YGR244C",426).
component("U89_",136).
component("YOR241W",733).
component("YMR113W",626).
component("YKL132C",535).
component("YJL101C",485).
component("U92_",139).
component("YGL234W",391).
component("U91_",138).
component("U90_",137).
component("YDL141W",240).
component("YDL141W",241).
component("YGL234W",392).
component("YDL141W",242).
component("YJR103W",510).
component("YBL039C",155).
component("YGR204W",422).
component("YBR084W",178).
component("YOL058W",700).
component("YBR208C",195).
component("YHR074W",448).
component("YMR217W",635).
component("YGR061C",404).
component("YPR145W",794).
component("YGR124W",410).
component("YOR303W",735).
component("YJR109C",513).
component("YJL130C",489).
component("YGL062W",380).
component("YBR218C",196).
component("YPL231W",769).
component("YNR016C",685).
component("YKL182W",543).
component("YGR037C",400).
component("YOR005C",712).
component("YDL164C",245).
component("YOL010W",693).
component("YPR138C",793).
component("YPL274W",775).
component("YPL265W",772).
component("YPL057C",755).
component("YPL036W",754).
component("YOR348C",743).
component("YOR192C",725).
component("YOR171C",722).
component("YOR071C",714).
component("YOL156W",711).
component("YOL103W",706).
component("YOL020W",695) :- not remove_orf("YOL020W",695).
component("YNR056C",690).
component("YNL318C",680).
component("YNL268W",673).
component("YNL142W",660).
component("YMR272C",641).
component("YML123C",616).
component("YLR348C",597).
component("YLR260W",587).
component("YLR237W",585).
component("YLR138W",574).
component("YLR100C",571).
component("YLR081W",569).
component("YLL061W",562).
component("YLL043W",561).
component("YKR093W",557).
component("YKR053C",555).
component("YKR039W",554) :- not remove_orf("YKR039W",554).
component("YKL217W",549).
component("YKL004W",524).
component("YJR152W",520).
component("YJR095W",509).
component("YJR077C",507).
component("YJL219W",499).
component("YJL134W",490).
component("YJL129C",488).
component("YHL036W",435).
component("YGR121C",408).
component("YGR055W",402).
component("YGL186C",388).
component("YGL077C",383).
component("YGL008C",373).
component("YFL055W",362).
component("YFL011W",356).
component("YER060W-A",334).
component("YER060W",333).
component("YER056C",332).
component("YER053C",330).
component("YEL017C-A",319).
component("YDR536W",318).
component("YDR508C",314).
component("YDR503C",313).
component("YDR497C",312).
component("YDR297W",295).
component("YDR294C",294).
component("YDR046C",265) :- not remove_orf("YDR046C",265).
component("YDL210W",251).
component("YCR032W",217).
component("YCR024C-A",216).
component("YCL025C",210).
component("YBR298C",207).
component("YBR291C",206).
component("YBR069C",177) :- not remove_orf("YBR069C",177).
component("YBR068C",176) :- not remove_orf("YBR068C",176).
component("YBR036C",173).
component("YBR021W",169).
component("YBL042C",156).
component("U79_",128).
component("U75_",126).
component("U74_",125).
component("U73_",124).
...
catalyst(6160,644).
catalyst(3870,331).
catalyst(3620,300) :- not remove_reaction(3620,300).
catalyst(2110,368).
catalyst(2190,368).
catalyst(5550,515).
catalyst(5791,583).
...
catalyst(1960,266).
catalyst(3460,112).
catalyst(3600,546) :- not remove_reaction(3600,546).
catalyst(3941,697).
catalyst(3942,697).
catalyst(6890,662).
catalyst(6900,413).
...
catalyst(8020,781).
catalyst(8020,338).
catalyst(1890,547) :- not remove_reaction(1890,547).
catalyst(3630,547) :- not remove_reaction(3630,547).
catalyst(1890,345) :- not remove_reaction(1890,345).
catalyst(3630,345) :- not remove_reaction(3630,345).
catalyst(3740,277).
catalyst(8231,778).
catalyst(8232,778).
catalyst(8231,749).
...
catalyst(8051,771).
catalyst(8052,771).
catalyst(3590,377) :- not remove_reaction(3590,377).
catalyst(10910,377) :- not remove_reaction(10910,377).
catalyst(4570,412).
catalyst(8181,592).
catalyst(8182,592).
catalyst(8181,498).
...
catalyst(8281,267).
catalyst(8282,267).
catalyst(3610,257) :- not remove_reaction(3610,257).
catalyst(7921,715).
catalyst(7922,715).
catalyst(7841,324).
catalyst(7842,324).
...
catalyst(1200,711).
catalyst(1160,706).
catalyst(801,695) :- not remove_reaction(801,695).
catalyst(802,695) :- not remove_reaction(802,695).
catalyst(811,695) :- not remove_reaction(811,695).
catalyst(812,695) :- not remove_reaction(812,695).
catalyst(831,695) :- not remove_reaction(831,695).
catalyst(832,695) :- not remove_reaction(832,695).
catalyst(901,695) :- not remove_reaction(901,695).
catalyst(902,695) :- not remove_reaction(902,695).
catalyst(941,695) :- not remove_reaction(941,695).
catalyst(942,695) :- not remove_reaction(942,695).
catalyst(700,690).
catalyst(1200,680).
catalyst(761,673).
catalyst(762,673).
...
catalyst(640,557).
catalyst(6560,555).
catalyst(761,554) :- not remove_reaction(761,554).
catalyst(762,554) :- not remove_reaction(762,554).
catalyst(771,554) :- not remove_reaction(771,554).
catalyst(772,554) :- not remove_reaction(772,554).
catalyst(781,554) :- not remove_reaction(781,554).
catalyst(782,554) :- not remove_reaction(782,554).
catalyst(791,554) :- not remove_reaction(791,554).
catalyst(792,554) :- not remove_reaction(792,554).
catalyst(801,554) :- not remove_reaction(801,554).
catalyst(802,554) :- not remove_reaction(802,554).
catalyst(811,554) :- not remove_reaction(811,554).
catalyst(812,554) :- not remove_reaction(812,554).
catalyst(821,554) :- not remove_reaction(821,554).
catalyst(822,554) :- not remove_reaction(822,554).
catalyst(831,554) :- not remove_reaction(831,554).
catalyst(832,554) :- not remove_reaction(832,554).
catalyst(841,554) :- not remove_reaction(841,554).
catalyst(842,554) :- not remove_reaction(842,554).
catalyst(861,554) :- not remove_reaction(861,554).
catalyst(862,554) :- not remove_reaction(862,554).
catalyst(881,554) :- not remove_reaction(881,554).
catalyst(882,554) :- not remove_reaction(882,554).
catalyst(901,554) :- not remove_reaction(901,554).
catalyst(902,554) :- not remove_reaction(902,554).
catalyst(911,554) :- not remove_reaction(911,554).
catalyst(912,554) :- not remove_reaction(912,554).
catalyst(941,554) :- not remove_reaction(941,554).
catalyst(942,554) :- not remove_reaction(942,554).
catalyst(1191,554) :- not remove_reaction(1191,554).
catalyst(1192,554) :- not remove_reaction(1192,554).
catalyst(1021,549).
catalyst(1022,549).
catalyst(6610,524).
catalyst(170,520).
...
catalyst(6650,295).
catalyst(6550,294).
catalyst(791,265) :- not remove_reaction(791,265).
catalyst(792,265) :- not remove_reaction(792,265).
catalyst(801,265) :- not remove_reaction(801,265).
catalyst(802,265) :- not remove_reaction(802,265).
catalyst(811,265) :- not remove_reaction(811,265).
catalyst(812,265) :- not remove_reaction(812,265).
catalyst(831,265) :- not remove_reaction(831,265).
catalyst(832,265) :- not remove_reaction(832,265).
catalyst(841,265) :- not remove_reaction(841,265).
catalyst(842,265) :- not remove_reaction(842,265).
catalyst(861,265) :- not remove_reaction(861,265).
catalyst(862,265) :- not remove_reaction(862,265).
catalyst(901,265) :- not remove_reaction(901,265).
catalyst(902,265) :- not remove_reaction(902,265).
catalyst(730,251).
catalyst(431,217).
catalyst(432,217).
catalyst(220,216).
...
catalyst(1511,206).
catalyst(1512,206).
catalyst(771,177) :- not remove_reaction(771,177).
catalyst(772,177) :- not remove_reaction(772,177).
...
catalyst(791,176) :- not remove_reaction(791,176).
catalyst(792,176) :- not remove_reaction(792,176).
catalyst(801,176) :- not remove_reaction(801,176).
catalyst(802,176) :- not remove_reaction(802,176).
catalyst(811,176) :- not remove_reaction(811,176).
catalyst(812,176) :- not remove_reaction(812,176).
catalyst(831,176) :- not remove_reaction(831,176).
catalyst(832,176) :- not remove_reaction(832,176).
catalyst(841,176) :- not remove_reaction(841,176).
catalyst(842,176) :- not remove_reaction(842,176).
catalyst(861,176) :- not remove_reaction(861,176).
catalyst(862,176) :- not remove_reaction(862,176).
catalyst(901,176) :- not remove_reaction(901,176).
catalyst(902,176) :- not remove_reaction(902,176).
catalyst(6600,173).
catalyst(620,169).
catalyst(540,156).
catalyst(2830,128).
...
modifiable_enzyme(546).
modifiable_enzyme(547).
modifiable_enzyme(345).
modifiable_enzyme(377).
modifiable_enzyme(257).
modifiable_enzyme(695).
modifiable_enzyme(554).
modifiable_enzyme(265).
