...
component("YNL280C",567).
component("YGR060W",338).
component("YGL012W",313).
component("YKR009C",464).
component("YOL086C",590).
component("YMR303C",541).
component("YGL256W",331).
component("YDL168W",205).
component("YBR145W",159).
component("YPL231W",642).
component("U46_",87).
component("YBR149W",160).
component("YJR159W",441).
component("YGL001C",310).
component("YIL094C",388).
component("YHR063C",371).
component("YBR153W",161).
component("YML056C",513).
component("YLR432W",509).
component("YHR216W",382).
component("YAR075W",129).
component("YAR073W",128).
component("YDR127W",228).
component("YJR139C",438).
component("YOL126C",594).
component("YDL078C",192).
component("YKL029C",444).
component("YOR136W",604).
component("YNL037C",545).
component("YDL066W",191).
component("YLR355C",506).
component("YML086C",515).
component("YIL155C",393).
component("YPR191W",670).
component("YOR065W",599).
component("YJL166W",416).
component("YHR001W-A",364).
component("YGR183C",349).
component("YFR033C",306).
component("YDR529C",262).
component("YBL045C",135).
component("Q0105",18).
component("YGR088W",340).
component("YDR256C",242).
component("YJR078W",429).
component("YJR025C",423).
component("YGR255C",358).
component("YBL098W",138).
component("YMR015C",521).
component("YDR402C",254).
component("YGL055W",318).
component("YGR175C",346).
component("YJR104C",432).
component("YHR008C",365).
component("YJL026W",400).
component("YGR180C",348).
component("YER070W",282).
component("U35_",83).
component("YDL168W",206).
component("YDR158W",236).
component("YPL276W",651).
component("YPL275W",650).
component("YOR388C",628).
component("YOR374W",625).
component("YER073W",283).
component("YGL154C",324).
component("U55_",94).
component("YOR323C",617).
component("YMR170C",529).
component("YMR169C",528).
component("U2_",80).
component("YBR221C",169).
component("U52_",91).
component("YBR166C",164).
component("YNL280C",568).
component("YGL012W",314).
component("U57_",95).
component("YDR044W",219).
component("YER014W",271).
component("YKR009C",465).
component("YIL160C",395).
component("YGL205W",327).
component("YMR118C",526).
component("YLR164W",490).
component("YLL041C",473).
component("YKL148C",453).
component("YKL141W",451).
component("YJL045W",401).
component("YDR178W",237).
component("YJR051W",425).
component("YEL047C",266).
component("YOR375C",626).
component("YDL215C",209).
component("YAL062W",126).
component("U99_",122).
component("YBR035C",147).
component("YHR037W",368).
component("YKR080W",469).
component("YER023W",272).
component("YOR236W",614).
component("YGR204W",351).
component("YLR142W",485).
component("U62_",98).
component("YKL150W",454).
component("YIL043C",384).
component("YHR042W",369).
component("YFR030W",305).
component("YPL017C",631).
component("YFL018C",297).
component("YER042W",274).
component("YJR137C",437).
component("YPL266W",648).
component("YML110C",517).
component("YBR034C",146).
component("YPL273W",649).
component("YLL062C",476).
component("U47_",88).
component("YER091C",288).
component("YJR073C",427).
component("YDL033C",189).
component("YOL096C",591).
component("YLR172C",491).
component("YDR019C",215).
component("YDR408C",256).
component("YBL013W",130).
component("YKL024C",443).
component("YPR074C",662).
component("YBR117C",156).
component("YLR354C",505).
component("YGR043C",336).
component("YCL009C",178).
component("YMR062C",523).
component("YNL071W",548).
component("YNR008W",575).
component("YPL231W",643).
component("YER061C",280).
component("U86_",113).
component("YPL001W",630).
component("YDR148C",234).
component("YOR377W",627).
component("YGR177C",347).
component("YPL231W",644).
component("YGR147C",343).
component("YDL040C",190).
component("YPL028W",632).
component("YGL017W",315).
component("YPR001W",653).
component("YNR001C",573).
component("YDL182W",207).
component("YDL131W",198).
component("YNL117W",552).
component("YIR031C",398).
component("YDR307W",247).
component("YNL029C",544).
component("YIL085C",387).
component("YMR261C",536).
component("YML100W",516).
component("YBR126C",158).
component("YNL192W",559).
component("YBR038W",149).
component("YBR023C",145).
component("YLR209C",492).
component("U104_",21).
component("YOR209C",611).
component("YMR300C",540).
component("YER055C",276).
component("YDR354W",250) :- not remove_orf("YDR354W",250).
component("YFR047C",307).
component("YJR133W",436).
component("YLR209C",493).
component("YML022W",510).
component("YDR441C",258).
component("YDR399W",252).
component("YJL167W",417).
component("YNL256W",562).
component("YDR127W",229).
component("YLR303W",499).
component("YGR012W",333).
component("YJR130C",435).
component("YLR303W",500).
component("YDR035W",217).
component("YBR249C",170).
component("YOL143C",596).
component("YBR256C",171).
component("YHR137W",376).
component("YGL202W",326).
component("YLR027C",477).
component("YKL106W",448).
component("YKL104C",447).
component("YGR019W",334).
component("YLR089C",481).
component("U64_",99).
component("U61_",97).
component("U51_",90).
component("YJR148W",439).
component("YIL116W",391).
component("YGL253W",330).
component("YFR053C",308).
component("YOL136C",595).
component("YIL107C",389).
component("YMR205C",531).
component("YGR240C",354).
component("YDR248C",241).
component("YCR036W",186).
component("YCL040W",181).
component("YJR105W",433).
component("U16_",41).
component("U15_",37).
component("U96_",120).
component("YKL001C",442).
component("YML070W",514).
component("YFL053W",300).
component("YHL032C",362).
component("U83_",111).
component("U82_",110).
component("U81_",109).
component("YMR208W",532).
component("YOR347C",622).
component("YAL038W",125).
component("YNR012W",576).
component("YPR121W",665).
component("YPL258C",646).
component("YOL055C",587).
component("U1_",61).
component("YDR009W",214).
component("YBR020W",143).
component("YNL267W",565).
component("YLR305C",502).
component("YFR019W",303).
component("YDR208W",238).
component("YDR127W",230).
component("U21_",70).
component("U20_",68).
component("YDR147W",233).
component("YDR300C",246).
component("YCR012W",183).
component("U18_",54).
component("U17_",48).
component("U76_",107).
component("YER170W",294).
component("YDR226W",239).
component("YKL067W",446).
component("YDR454C",259).
component("YOL061W",589).
component("YKL181W",456).
component("YHL011C",360).
component("YER099C",290).
component("YBL068W",137).
component("YOR143C",605).
component("YBR018C",140).
component("YGR007W",332).
component("YLR328W",503).
component("YKR002W",463).
component("YDL103C",196).
component("YJR010W",422).
component("YCL050C",182).
component("YPR190C",669).
component("YPR187W",668).
component("YPR110C",664).
component("YPR010C",655).
component("YOR341W",621).
component("YOR340C",620).
component("YOR224C",613).
component("YOR210W",612).
component("YOR207C",609).
component("YOR151C",606).
component("YOR116C",602).
component("YOL005C",582).
component("YNR003C",574).
component("YNL248C",561).
component("YNL151C",556).
component("YNL113W",551).
component("YKL144C",452).
component("YJR063W",426).
component("YJL148W",413).
component("YJL140W",412).
component("YIL021W",383).
component("YHR143W-A",377).
component("YGL070C",321).
component("YFL036W",299).
component("YDR404C",255).
component("YDR156W",235).
component("YDR045C",220).
component("YDL150W",203).
component("YDL140C",199).
component("YBR154C",163).
component("YPR175W",667).
component("YPL167C",639).
component("YOR330C",618).
component("YOL115W",593).
component("YNL299W",570).
component("YNL262W",564).
component("YNL102W",550).
component("YJR043C",424).
component("YJR006W",421).
component("YJL090C",405).
component("YIL139C",392).
component("YEL055C",267).
component("YDR419W",257).
component("YDR121W",227).
component("YDL102W",195).
component("YCR014C",184).
component("YBR278W",173).
component("YBL035C",132).
component("YKL035W",445).
component("YHL012W",361).
component("YHR123W",375).
component("YDL142C",202).
component("YER026C",273).
component("YCL004W",177).
component("YJL068C",402).
component("YDR058C",224).
component("YNR034W",579).
component("YHR163W",379).
component("YGR248W",356).
component("YCR073W-A",187).
component("YDL086W",194).
component("YOL011W",584).
component("YMR008C",520).
component("YMR006C",519).
component("U101_",19).
component("YBL015W",131).
component("YJL068C",403).
component("YPL072W",635).
component("YOR124C",603).
component("YNL186W",558).
component("YMR304W",542).
component("YMR223W",534).
component("YKR098C",471).
component("YJL197W",418).
component("YIL156W",394).
component("YFR010W",302).
component("YER151C",292).
component("YER144C",291).
component("YER098W",289).
component("YDR069C",225).
component("YDL122W",197).
component("YBR058C",150).
component("YBL067C",136).
component("U84_",112).
component("YPR073C",660).
component("YHR215W",381).
component("YDL024C",188).
component("YBR093C",154).
component("YBR092C",153).
component("YAR071W",127).
component("YIL053W",386).
component("YER062C",281).
component("YHR046C",370).
component("YGR208W",353).
component("YPL228W",641).
component("YMR180C",530).
component("YDL236W",211).
component("YJL155C",415).
component("YPR073C",661).
component("YOR208W",610).
component("YNL053W",547).
component("YMR036C",522).
component("YIR026C",396).
component("YIL113W",390).
component("YFR028C",304).
component("YER075C",284).
...
component("U25_",78).
component("U24_",77).
component("YOR360C",624).
component("YGL248W",329).
component("YKR031C",466).
component("YLR286C",497).
component("YJR153W",440).
component("YOR190W",607).
component("YLR300W",498).
component("YGR282C",359).
component("YDR261C",243).
component("YDR400W",253).
component("U23_",76).
component("YML035C",511).
component("YJL070C",404).
component("YBR284W",174).
component("U102_",20).
component("YNL045W",546).
component("YLR160C",489).
component("YLR158C",488).
component("YLR157C",487).
component("YLR155C",486).
component("YDR321W",248).
component("YGL037C",317).
component("YDR242W",240).
component("YBR208C",166).
component("YMR281W",539).
component("U53_",92).
component("YIR032C",399).
component("YIR029W",397).
component("YPR062W",659).
component("YMR120C",527).
component("YHR144C",378).
component("YNL141W",553).
component("YBR153W",162).
component("YDL238C",212).
component("YNL141W",554).
component("YLR245C",496).
component("YML035C",512).
component("YJL126W",408).
component("U44_",86).
component("U87_",114).
component("YMR267W",537).
component("YBR011C",139).
component("YBR111C",155).
component("YCL030C",180).
component("YER005W",270).
component("YIL048W",385).
component("YER166W",293).
component("YDR093W",226).
component("YAL026C",124).
component("YLR231C",494).
component("U88_",115).
component("YLR134W",483).
component("YLR044C",478).
component("YGR087C",339).
component("YDR380W",251).
component("YDL080C",193).
component("U98_",121).
component("YMR250W",535).
component("YKL184W",459).
component("YNR043W",580).
component("U93_",119).
component("YDR047W",222).
component("U54_",93).
component("YKL211C",460) :- not remove_orf("YKL211C",460).
component("YNL169C",557).
component("YGR170W",345).
component("YNL256W",563).
component("YDR294C",244).
component("YEL046C",265).
component("YNR033W",578).
component("YKL211C",461) :- not remove_orf("YKL211C",461).
component("YER090W",461) :- not remove_orf("YER090W",461).
component("YER090W",287) :- not remove_orf("YER090W",287).
component("YDR127W",231).
component("YPL281C",652).
component("YOR393W",629).
component("YMR323W",543).
component("YHR174W",380).
component("YGR254W",357).
component("YGL026C",316) :- not remove_orf("YGL026C",316).
component("YGR155W",344).
component("YLR304C",501).
component("YJL200C",419).
component("YNL316C",571).
component("YKL182W",457).
component("YPL212C",640).
component("YNL292W",569).
component("YGL063W",320).
component("YFL001W",295).
component("YPR002W",654).
component("YDR127W",232).
component("YGL148W",323).
component("YER086W",285).
component("YLR359W",507).
component("YAL012W",123).
component("YFR055W",309).
component("YJL121C",407).
component("YBR019C",141).
component("YBR019C",142).
component("YDR050C",223).
component("YDR007W",213) :- not remove_orf("YDR007W",213).
component("YOR095C",601).
component("YER003C",269).
component("YBR196C",165).
component("YGL001C",311).
component("U14_",31).
component("YKL152C",455).
component("YMR105C",524).
component("YKL127W",449).
component("YEL058W",268).
component("YPR060C",658).
component("YHR072W",372).
component("YJL153C",414).
component("YPL097W",636).
component("YGR185C",350).
component("YHR011W",366).
component("YDR023W",216).
component("YPL104W",637).
component("YLL018C",472).
component("YPR081C",663).
component("YBR121C",157).
component("YHR020W",367).
component("YER087W",286).
component("YNL247W",560).
component("YOL033W",586).
component("YHR091C",374).
component("YDR341C",249).
component("YOL097C",592).
component("YPR047W",657).
component("YLR060W",479).
component("YFL022C",298).
component("YPR033C",656).
component("YPL160W",638).
component("YLR382C",508).
component("YNL073W",549).
component("YDR037W",218).
component("YOR335C",619).
component("YGR094W",341).
component("YGR244C",355).
component("U89_",116).
component("YOR241W",615).
component("YMR113W",525).
component("YKL132C",450).
component("YJL101C",406).
component("U92_",118).
component("YGL234W",328).
component("U91_",117).
component("YDL141W",200).
component("YDL141W",201).
component("YJR103W",431).
component("YBL039C",133).
component("YGR204W",352).
component("YOL058W",588).
component("YBR208C",167).
component("YHR074W",373).
component("YMR217W",533).
component("YOR303W",616).
component("YJR109C",434).
component("YJL130C",410).
component("YGL062W",319).
component("YBR218C",168).
component("YPL231W",645).
component("YNR016C",577).
component("YKL182W",458).
component("YGR037C",335).
component("YOR005C",598).
component("YDL164C",204).
component("YOL010W",583).
component("YPR138C",666).
component("YPL265W",647).
component("YPL057C",634).
component("YPL036W",633).
component("YOR348C",623).
component("YOR192C",608).
component("YOR071C",600).
component("YOL156W",597).
component("YOL020W",585) :- not remove_orf("YOL020W",585).
component("YNR056C",581).
component("YNL318C",572).
component("YNL268W",566).
component("YNL142W",555).
component("YMR272C",538).
component("YML123C",518).
component("YLR348C",504).
component("YLR237W",495).
component("YLR138W",484).
component("YLR100C",482).
component("YLR081W",480).
component("YLL061W",475).
component("YLL043W",474).
component("YKR093W",470).
component("YKR053C",468).
component("YKR039W",467) :- not remove_orf("YKR039W",467).
component("YKL217W",462).
component("YJR095W",430).
component("YJR077C",428).
component("YJL219W",420).
component("YJL134W",411).
component("YJL129C",409).
component("YHL036W",363).
component("YGR121C",342).
component("YGR055W",337).
component("YGL186C",325).
component("YGL077C",322).
component("YGL008C",312).
component("YFL055W",301).
component("YFL011W",296).
component("YER060W-A",279).
component("YER060W",278).
component("YER056C",277).
component("YER053C",275).
component("YEL017C-A",264).
component("YDR536W",263).
component("YDR508C",261).
component("YDR503C",260).
component("YDR294C",245).
component("YDR046C",221) :- not remove_orf("YDR046C",221).
...
catalyst(1960,222).
catalyst(3460,93).
catalyst(3600,460) :- not remove_reaction(3600,460).
catalyst(6890,557).
catalyst(6900,345).
catalyst(2570,563).
catalyst(8781,244).
...
catalyst(8231,357).
catalyst(8232,357).
catalyst(3590,316) :- not remove_reaction(3590,316).
catalyst(10910,316) :- not remove_reaction(10910,316).
catalyst(4570,344).
catalyst(8181,501).
catalyst(8182,501).
catalyst(8181,419).
...
catalyst(190,600).
catalyst(1200,597).
catalyst(801,585) :- not remove_reaction(801,585).
catalyst(802,585) :- not remove_reaction(802,585).
catalyst(811,585) :- not remove_reaction(811,585).
catalyst(812,585) :- not remove_reaction(812,585).
catalyst(831,585) :- not remove_reaction(831,585).
catalyst(832,585) :- not remove_reaction(832,585).
catalyst(901,585) :- not remove_reaction(901,585).
catalyst(902,585) :- not remove_reaction(902,585).
catalyst(941,585) :- not remove_reaction(941,585).
catalyst(942,585) :- not remove_reaction(942,585).
catalyst(700,581).
catalyst(1200,572).
catalyst(761,566).
catalyst(762,566).
...
catalyst(640,470).
catalyst(6560,468).
catalyst(761,467) :- not remove_reaction(761,467).
catalyst(762,467) :- not remove_reaction(762,467).
catalyst(771,467) :- not remove_reaction(771,467).
catalyst(772,467) :- not remove_reaction(772,467).
catalyst(781,467) :- not remove_reaction(781,467).
catalyst(782,467) :- not remove_reaction(782,467).
catalyst(791,467) :- not remove_reaction(791,467).
catalyst(792,467) :- not remove_reaction(792,467).
catalyst(801,467) :- not remove_reaction(801,467).
catalyst(802,467) :- not remove_reaction(802,467).
catalyst(811,467) :- not remove_reaction(811,467).
catalyst(812,467) :- not remove_reaction(812,467).
catalyst(821,467) :- not remove_reaction(821,467).
catalyst(822,467) :- not remove_reaction(822,467).
catalyst(831,467) :- not remove_reaction(831,467).
catalyst(832,467) :- not remove_reaction(832,467).
catalyst(841,467) :- not remove_reaction(841,467).
catalyst(842,467) :- not remove_reaction(842,467).
catalyst(861,467) :- not remove_reaction(861,467).
catalyst(862,467) :- not remove_reaction(862,467).
catalyst(881,467) :- not remove_reaction(881,467).
catalyst(882,467) :- not remove_reaction(882,467).
catalyst(901,467) :- not remove_reaction(901,467).
catalyst(902,467) :- not remove_reaction(902,467).
catalyst(911,467) :- not remove_reaction(911,467).
catalyst(912,467) :- not remove_reaction(912,467).
catalyst(941,467) :- not remove_reaction(941,467).
catalyst(942,467) :- not remove_reaction(942,467).
catalyst(1191,467) :- not remove_reaction(1191,467).
catalyst(1192,467) :- not remove_reaction(1192,467).
catalyst(1021,462).
catalyst(1022,462).
catalyst(1250,430).
catalyst(1581,428).
