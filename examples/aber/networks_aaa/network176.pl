...
component("YNL280C",899).
component("YLR056W",757).
component("YGR060W",530).
component("YGL012W",495).
component("YKR009C",737).
component("YOL086C",934).
component("YMR303C",865).
component("YMR083W",834).
...
component("YPL276W",1035).
component("YPL275W",1034).
component("YOR388C",997).
component("YPL061W",1005).
...
component("YMR170C",845).
component("YMR169C",844).
component("U2_",130).
...
component("YMR189W",847).
component("U56_",156).
component("YNR050C",915).
component("YHR037W",581).
component("YKR080W",742).
component("YER023W",438).
component("YPL023C",1001).
component("YGL125W",508).
component("YOR236W",976).
component("YGR204W",552).
component("YLR142W",767).
component("U63_",163).
component("U62_",162).
...
component("Q0275",20).
component("Q0250",19).
component("YPL266W",1030).
component("YML110C",821).
component("YBR034C",234).
component("YPL273W",1032).
component("YLL062C",752).
component("YDR410C",411).
component("YOL096C",935).
component("U47_",147).
component("YER091C",462).
component("YJR073C",682).
...
component("YNR012W",908).
component("YPR121W",1055).
component("YPL258C",1027).
component("YOL055C",927).
component("YPL214C",1021).
component("U1_",102).
component("YDR009W",348).
component("YBR020W",231).
component("YNL267W",896).
component("YLR305C",789).
...
component("YPR190C",1063).
component("YPR187W",1062).
component("YPR110C",1053).
component("YPR010C",1040).
component("YOR341W",989).
component("YOR340C",988).
component("YOR224C",975).
component("YOR210W",972).
component("YOR207C",969).
component("YOR151C",962).
component("YOR116C",954).
component("YOL005C",920).
component("YNR003C",906).
component("YNL248C",891).
component("YNL151C",884).
component("YNL113W",878).
...
component("YPR175W",1059).
component("YPL167C",1014).
component("YOR330C",985).
component("YOL115W",939).
component("YNL299W",902).
component("YNL262W",895).
component("YNL102W",876).
component("YJR043C",677).
...
component("YJR019C",675).
component("YDR272W",390).
component("U84_",183).
component("YDR481C",416).
component("YLR377C",800).
component("YDR074W",363).
component("YFR025C",485).
component("YPL179W",1016).
component("YNR032W",910).
component("YML057W",815).
component("YML016C",808).
component("YLR433C",804).
...
component("YPL228W",1022).
component("YMR180C",846).
component("YDL236W",343).
component("YJL155C",661).
component("YPR073C",1049).
component("YOR208W",970).
component("YNL053W",873).
...
component("U25_",127).
component("U24_",126).
component("YOL064C",933).
component("YPL268W",1031).
component("YOR360C",993).
component("YGL248W",520).
component("YKR031C",739).
component("YPL206C",1019).
component("YGL027C",500).
component("YLR286C",784).
...
component("YLR160C",773).
component("YLR158C",772).
component("YLR157C",771).
component("YLR155C",770).
component("YDR321W",397).
component("YGL037C",501).
component("U43_",143).
component("U42_",142).
component("YMR293C",862).
component("YDR242W",385).
component("YLR308W",792).
component("YLR307W",791).
component("YBR208C",264).
component("YMR281W",861).
component("U53_",153).
component("YIR027C",635).
component("YPL111W",1010).
component("YIR032C",639).
component("YIR029W",637).
component("YPR062W",1046).
...
component("YNL141W",882).
component("YLR245C",781).
component("YML035C",812).
...
component("U87_",186).
component("U40_",140).
component("YMR267W",858).
component("YBR011C",226).
component("YHR201C",603).
component("YBR111C",247).
component("YBR252W",271).
component("YCL030C",285).
component("YPR080W",1051).
component("YOR187W",966).
component("YOR133W",958).
component("YLR069C",760).
...
component("U91_",191).
component("U90_",190).
component("YNR057C",917).
component("YDL141W",326).
component("YDL141W",327).
component("YGL234W",518).
component("YDL141W",328).
component("YJR103W",686).
component("YBL039C",214).
component("YGR204W",553).
component("YBR084W",244).
component("YNL220W",888).
component("YOL058W",930).
component("YBR208C",265).
component("YHR074W",589).
component("YMR217W",851).
component("YGR061C",531).
component("YPR145W",1057).
component("YGR124W",537).
component("YOR303W",981).
component("YJR109C",689).
component("YJL130C",656).
component("YGL062W",504).
component("YBR218C",266).
component("YPL231W",1026).
component("YNR016C",909).
component("YKL182W",726).
component("YGR037C",527).
component("YOR005C",945).
component("YDL164C",331).
component("YJL087C",648).
component("YOL010W",921).
component("YPR138C",1056).
component("YPL274W",1033).
component("YPL265W",1029).
component("YPL134C",1011).
component("YPL057C",1004).
component("YPL036W",1003).
component("YOR348C",991).
component("YOR222W",974).
component("YOR192C",968).
component("YOR171C",963).
component("YOR130C",957).
component("YOR100C",952).
component("YOR071C",949).
component("YOR011W",946).
component("YOL156W",944).
component("YOL103W",938).
component("YOL020W",923) :- not remove_orf("YOL020W",923).
component("YNR072W",919).
component("YNR056C",916).
component("YNL318C",904).
component("YNL268W",897).
component("YNL142W",883).
component("YMR272C",860).
component("YMR202W",848).
component("YMR011W",828).
component("YML123C",824).
component("YLR348C",796).
component("YLR260W",783).
component("YLR237W",780).
component("YLR138W",766).
component("YLR100C",763).
component("YLR081W",761).
component("YLL061W",751).
component("YLL043W",750).
component("YKR093W",744).
component("YKR053C",741).
component("YKR039W",740) :- not remove_orf("YKR039W",740).
component("YKL217W",735).
component("YKL120W",713).
component("YKL004W",701).
component("YJR158W",698).
component("YJR152W",696).
component("YJR095W",685).
component("YJR077C",683).
...
catalyst(1960,356).
catalyst(3460,154).
catalyst(3600,732) :- not remove_reaction(3600,732).
catalyst(8000,745).
catalyst(3941,926).
catalyst(3942,926).
catalyst(6890,885).
...
catalyst(8020,1039).
catalyst(8020,451).
catalyst(1890,733) :- not remove_reaction(1890,733).
catalyst(3630,733) :- not remove_reaction(3630,733).
...
catalyst(1210,944).
catalyst(1160,938).
catalyst(801,923) :- not remove_reaction(801,923).
catalyst(802,923) :- not remove_reaction(802,923).
catalyst(811,923) :- not remove_reaction(811,923).
catalyst(812,923) :- not remove_reaction(812,923).
catalyst(831,923) :- not remove_reaction(831,923).
catalyst(832,923) :- not remove_reaction(832,923).
catalyst(901,923) :- not remove_reaction(901,923).
catalyst(902,923) :- not remove_reaction(902,923).
catalyst(941,923) :- not remove_reaction(941,923).
catalyst(942,923) :- not remove_reaction(942,923).
catalyst(1170,919).
catalyst(1180,919).
catalyst(1210,919).
catalyst(700,916).
...
catalyst(650,744).
catalyst(6560,741).
catalyst(761,740) :- not remove_reaction(761,740).
catalyst(762,740) :- not remove_reaction(762,740).
catalyst(771,740) :- not remove_reaction(771,740).
catalyst(772,740) :- not remove_reaction(772,740).
catalyst(781,740) :- not remove_reaction(781,740).
catalyst(782,740) :- not remove_reaction(782,740).
catalyst(791,740) :- not remove_reaction(791,740).
catalyst(792,740) :- not remove_reaction(792,740).
...
catalyst(821,740) :- not remove_reaction(821,740).
catalyst(822,740) :- not remove_reaction(822,740).
catalyst(831,740) :- not remove_reaction(831,740).
catalyst(832,740) :- not remove_reaction(832,740).
catalyst(841,740) :- not remove_reaction(841,740).
catalyst(842,740) :- not remove_reaction(842,740).
catalyst(861,740) :- not remove_reaction(861,740).
catalyst(862,740) :- not remove_reaction(862,740).
catalyst(881,740) :- not remove_reaction(881,740).
catalyst(882,740) :- not remove_reaction(882,740).
catalyst(901,740) :- not remove_reaction(901,740).
catalyst(902,740) :- not remove_reaction(902,740).
catalyst(911,740) :- not remove_reaction(911,740).
catalyst(912,740) :- not remove_reaction(912,740).
catalyst(921,740) :- not remove_reaction(921,740).
catalyst(922,740) :- not remove_reaction(922,740).
catalyst(941,740) :- not remove_reaction(941,740).
catalyst(942,740) :- not remove_reaction(942,740).
catalyst(1191,740) :- not remove_reaction(1191,740).
catalyst(1192,740) :- not remove_reaction(1192,740).
catalyst(390,735).
catalyst(1021,735).
catalyst(1022,735).
catalyst(1521,713).
