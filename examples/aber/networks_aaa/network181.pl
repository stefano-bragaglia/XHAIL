...
component("YNL280C",921).
component("YLR056W",775).
component("YGR060W",541).
component("YGL012W",506).
component("YKR009C",754).
component("YOL086C",956).
component("YMR303C",886).
component("YMR083W",855).
component("YGL256W",533).
component("YDL168W",341).
...
component("YJR159W",715).
component("YGL001C",503).
component("YIL094C",632).
component("YHR063C",597).
component("U45_",153).
component("YBR153W",265).
component("YML056C",835).
component("YLR432W",824).
component("YHR216W",621).
component("YAR075W",217).
component("YAR073W",216).
component("YCL030C",292).
component("YDR127W",380).
component("YJR139C",709).
component("YML075C",838).
component("YLR450W",827).
component("YOL126C",962).
component("YKL085W",726).
component("YDL078C",321).
component("YKL029C",721).
component("YOR136W",981).
component("YNL037C",892).
component("YNL009W",890).
component("YLR174W",794).
component("YDL066W",319).
component("YHR183W",615).
component("YGR256W",573).
component("YNL241C",911).
component("YOL059W",953).
component("YDL022W",312).
component("YCL018W",290).
component("YLR355C",819).
component("YIL074C",629).
component("YER081W",468).
component("YML054C",834).
component("YDL174C",345).
component("YML086C",839).
component("YIL155C",640).
component("YPR191W",1086).
component("YOR065W",970).
component("YJL166W",678).
component("YHR001W-A",585).
component("YGR183C",558).
component("YFR033C",499).
component("YDR529C",430).
component("YBL045C",224).
component("Q0105",18).
component("YGR088W",544).
component("YDR256C",397).
component("YKL026C",720).
component("YIR037W",654).
component("YBR244W",277).
component("YJR078W",700).
component("U58_",166).
component("YJR025C",691).
component("U107_",26).
component("YGR255C",572).
component("U108_",27).
component("YBL098W",228).
component("YMR015C",851).
component("YHR007C",586).
component("YDR402C",418).
component("YGL055W",513).
component("YGR175C",555).
component("YJR104C",703).
component("YHR008C",587).
component("YJL026W",657).
component("YIL066C",628).
component("YGR180C",557).
component("YER070W",465).
component("U38_",146).
component("U36_",145).
component("U35_",144).
component("YDL168W",342).
component("YDR158W",388).
component("YBR006W",233).
component("YPL276W",1057).
component("YPL275W",1056).
component("YOR388C",1019).
component("YPL061W",1027).
component("YOR374W",1016).
component("YER073W",466).
component("U68_",174).
component("YGL154C",522).
component("YBR115C",256).
component("U55_",163).
component("YER069W",463).
component("YOR323C",1006).
component("YMR170C",866).
component("YMR169C",865).
component("U2_",138).
component("YER178W",482).
component("YBR221C",275).
component("YIL125W",637).
component("U52_",160).
component("YBR166C",268).
component("YNL280C",922).
component("YGL012W",507).
component("YKL182W",740).
component("U57_",165).
component("YKL216W",751).
component("YDR044W",363).
component("YER014W",447).
component("YKR009C",755).
component("YIL160C",642).
component("YGL205W",527).
component("YMR118C",860).
component("YLR164W",792).
component("YLL041C",766).
component("YKL148C",734).
component("YKL141W",732).
component("YJL045W",658).
component("YDR178W",390).
component("YJR051W",694).
component("YEL047C",440).
component("YDL171C",343).
component("YDL171C",344).
component("YDL215C",349).
component("YOR375C",1017).
component("YDL215C",350).
component("YAL062W",212).
component("U99_",205).
component("YBR035C",243).
component("YMR189W",868).
component("U56_",164).
component("YNR050C",937).
component("YHR037W",593).
component("YKR080W",759).
component("YER023W",449).
component("YPL023C",1023).
component("YGL125W",519).
component("YOR236W",998).
component("YGR204W",563).
component("YLR142W",785).
component("U63_",171).
component("U62_",170).
component("YOR356W",1014).
component("YHR068W",598).
component("YKL150W",735).
component("YIL043C",625).
component("YHR042W",594).
component("YOR221C",995).
component("YML120C",843).
component("YKL192C",744).
component("YKL055C",723).
component("YER061C",459).
component("YBR046C",246).
component("YMR145C",863).
component("YML120C",844).
component("YKL192C",745).
component("YDL085W",323).
component("YGR234W",567).
component("YFR030W",498).
component("YPL017C",1022).
component("YFL018C",487).
component("YPL091W",1029).
component("YHR106W",607).
component("YDR353W",412).
component("YER042W",451).
component("YPR167C",1080).
component("YJR137C",708).
component("YNL052W",894).
component("YMR256C",877).
component("YLR395C",823).
component("YLR038C",773).
component("YIL111W",634).
component("YHR051W",596).
component("YGL191W",525).
component("YGL187C",524).
component("YDL067C",320).
component("Q0275",20).
component("Q0250",19).
component("YPL266W",1052).
component("YML110C",842).
component("YBR034C",242).
component("YPL273W",1054).
component("YLL062C",769).
component("YDR410C",421).
component("YOL096C",957).
component("U47_",155).
component("YER091C",473).
component("YJR073C",698).
component("YGR157W",552).
component("YDR120C",378).
component("YML008C",828).
component("YDL033C",314).
component("YOL096C",958).
component("YLR172C",793).
component("YLR058C",776).
component("YDR019C",359).
component("YBR176W",269).
component("YDR408C",420).
component("YMR120C",861).
component("YLR028C",771).
component("YBL013W",218).
component("YJL130C",670).
component("YJL088W",663).
component("YKL024C",718).
component("YPR074C",1072).
component("YBR117C",257).
component("YLR354C",818).
component("YGR043C",539).
component("YMR108W",858).
component("YCL009C",289).
component("YMR062C",854).
component("YNL071W",896).
component("YNR008W",929).
component("YIL160C",643).
component("YNL277W",920).
component("YDR232W",393).
component("YFL017C",486).
component("YPL231W",1046).
component("YER061C",460).
component("U86_",193).
component("YPL001W",1021).
component("YMR296C",884).
component("YDR062W",371).
component("YDL052C",317).
component("U8_",197).
component("YDR148C",386).
component("YAR035W",214).
component("YOR377W",1018).
component("YGR177C",556).
component("YPL231W",1047).
component("YGR147C",550).
component("YDL040C",315).
component("YPL028W",1024).
component("YLR195C",795).
component("YLR299W",805).
component("YGL017W",508).
component("YPR001W",1059).
component("YNR001C",927).
component("YCR005C",301).
component("YML126C",846).
component("YNL104C",899).
component("YDL182W",346).
component("YDL131W",332).
component("YNL117W",901).
component("YIR031C",652).
component("YOR321W",1005).
component("YJR143C",710).
component("YGR199W",561).
component("YDR307W",406).
component("YDL095W",327).
component("YDL093W",326).
component("YAL023C",208).
component("YLR258W",802).
component("YFR015C",494).
component("YOR103C",975).
component("YOR085W",972).
component("YMR149W",864).
component("YML019W",830).
component("YJL002C",655).
component("YEL002C",434).
component("YDL232W",352).
component("YCL043C",296).
component("YNL029C",891).
component("YIL085C",631).
component("YMR261C",878).
component("YML100W",840).
component("YBR126C",261).
component("YNL192W",909).
component("YBR038W",245).
component("YBR023C",241).
component("YMR306W",888).
component("YLR342W",816).
component("YGR032W",537).
component("YPR183W",1083).
component("YLR209C",796).
component("U104_",24).
component("U103_",23).
component("YMR271C",880).
component("YML106W",841).
component("YOR209C",993).
component("YMR300C",885).
component("YER055C",455).
component("YDR354W",413) :- not remove_orf("YDR354W",413).
component("YFR047C",500).
component("YJR133W",707).
component("YLR209C",797).
component("YML022W",831).
component("YDR441C",424).
component("YDR399W",416).
component("YHR128W",609).
component("YPR176C",1082).
component("YPL172C",1037).
component("YNR041C",935).
component("YMR101C",856).
component("YDL090C",325).
component("YBR003W",232).
component("YBR002C",231).
component("YJL167W",679).
component("YJL167W",680).
component("YNL256W",914).
component("YPR069C",1069).
component("YDR127W",381).
component("YLR146C",786).
component("YHR068W",599).
component("YLR303W",807).
component("YGR012W",535).
component("YJR130C",706).
component("YLR303W",808).
component("YDR035W",361).
component("YBR249C",278).
component("YOR274W",1001).
component("YOL143C",965).
component("YBR256C",280).
component("YHR137W",610).
component("YGL202W",526).
component("YLR027C",770).
component("YKL106W",728).
component("YOL140W",964).
component("YLR438W",826).
component("YKL104C",727).
component("YGR019W",536).
component("YLR089C",780).
component("YDR111C",377).
component("U64_",172).
component("U61_",169).
component("U51_",159).
component("YJR148W",711).
component("YHR208W",619).
component("YFL030W",489).
component("YOR184W",987).
component("YNR058W",940).
component("YIL116W",636).
component("YGL253W",532).
component("YFR053C",501).
component("YOL136C",963).
component("YIL107C",633).
component("YMR013C",850).
component("YMR205C",870).
component("YGR240C",568).
component("YDR248C",396).
component("YLR240W",800).
component("YKL203C",747).
component("YJR066W",697).
component("YCR036W",307).
component("YGR194C",560).
component("YCL040W",295).
component("YJR105W",704).
component("U16_",77).
component("U15_",68).
component("YPL188W",1039).
component("YJR049C",693).
component("YEL041W",438).
component("U96_",203).
component("YKL001C",716).
component("YDR236C",394).
component("YML070W",837).
component("YFL053W",491).
component("YHL032C",583).
component("YLR133W",782).
component("YDR531W",432).
component("U83_",190).
component("U82_",189).
component("U81_",188).
component("YMR208W",871).
component("YPL203W",1040).
component("YOR061W",969).
component("YKL166C",737).
component("YJL164C",677).
component("YIL035C",624).
component("YHR205W",618).
component("YHR102W",606).
component("YGL019W",509).
component("YHR025W",592).
component("YOR347C",1012).
component("YAL038W",210).
component("YNR012W",930).
component("YPR121W",1077).
component("YPL258C",1049).
component("YOL055C",949).
component("YPL214C",1043).
component("U1_",108).
component("YDR009W",358).
component("YBR020W",239).
component("YNL267W",918).
component("YLR305C",810).
component("YFR019W",495).
component("YDR208W",391).
component("YDR127W",382).
component("U21_",124).
component("U20_",118).
component("YDR147W",385).
component("YDR300C",405).
component("YCR012W",302).
component("YER052C",453).
component("YER069W",464).
component("U19_",107).
component("YKL024C",719).
component("U18_",97).
component("U17_",87).
component("U76_",183).
component("YMR220W",873).
component("YER170W",481).
component("YDR226W",392).
component("YKL067W",725).
component("YOL055C",950).
component("YDR454C",425).
component("YJR057W",695).
component("YOL061W",954).
component("YKL181W",739).
component("YHL011C",580).
component("YER099C",475).
component("YBL068W",227).
component("YOR143C",983).
component("YNL256W",915).
component("YLR328W",814).
component("YBR018C",235).
component("YBR018C",236).
component("YGR007W",534).
component("YGR202C",562).
component("YLR328W",815).
component("YKR002W",753).
component("U80_",187).
component("YDL103C",330).
component("U94_",202).
component("YJR010W",688).
component("YCL050C",297).
component("YGL130W",520).
component("YDR530C",431).
component("YCL050C",298).
component("YPR190C",1085).
component("YPR187W",1084).
component("YPR110C",1075).
component("YPR010C",1062).
component("YOR341W",1011).
component("YOR340C",1010).
component("YOR224C",997).
component("YOR210W",994).
component("YOR207C",991).
component("YOR151C",984).
component("YOR116C",976).
component("YOL005C",942).
component("YNR003C",928).
component("YNL248C",913).
component("YNL151C",906).
component("YNL113W",900).
component("YKL144C",733).
component("YJR063W",696).
component("YJL148W",674).
component("YJL140W",673).
component("YIL021W",623).
component("YHR143W-A",611).
component("YGL070C",517).
component("YFL036W",490).
component("YDR404C",419).
component("YDR156W",387).
component("YDR045C",364).
component("YDL150W",339).
component("YDL140C",334).
component("YBR154C",267).
component("YPR175W",1081).
component("YPL167C",1036).
component("YOR330C",1007).
component("YOL115W",961).
component("YNL299W",924).
component("YNL262W",917).
component("YNL102W",898).
component("YJR043C",692).
component("YJR006W",687).
component("YJL090C",664).
component("YIL139C",639).
component("YEL055C",441).
component("YDR419W",422).
component("YDR121W",379).
component("YDL102W",329).
component("YCR014C",303).
component("YBR278W",283).
component("YBL035C",221).
component("YKL035W",722).
component("YHL012W",581).
component("YHR123W",608).
component("YPR113W",1076).
component("YBR243C",276).
component("YNL130C",902).
component("YDL142C",338).
component("YPL148C",1034).
component("YER026C",450).
component("YCL004W",288).
component("YOR251C",1000).
component("YGR286C",577).
component("YJL068C",659).
component("YHR189W",616).
component("YDR058C",369).
component("YNR034W",934).
component("YHR163W",613).
component("YGR248W",570).
component("YCR073W-A",309).
component("YDL086W",324).
component("YOL011W",944).
component("YMR008C",848).
component("YMR006C",847).
component("U105_",25).
component("U101_",21).
component("YBL015W",219).
component("YJL068C",660).
component("YPL072W",1028).
component("YOR124C",977).
component("YNL186W",908).
component("YMR304W",887).
component("YMR223W",874).
component("YKR098C",763).
component("YJL197W",681).
component("YIL156W",641).
component("YFR010W",493).
component("YER151C",479).
component("YER144C",478).
component("YER098W",474).
component("YDR069C",372).
component("YDL122W",331).
component("YBR058C",247).
component("YBL067C",226).
component("YJR019C",690).
component("YDR272W",400).
component("U84_",191).
component("YDR481C",426).
component("YLR377C",821).
component("YDR074W",373).
component("YFR025C",496).
component("YPL179W",1038).
component("YNR032W",932).
component("YML057W",836).
component("YML016C",829).
component("YLR433C",825).
component("YGR123C",547).
component("YER133W",477).
component("YER089C",471).
component("YDR436W",423).
component("YDR075W",374).
component("YDL188C",347).
component("YDL134C",333).
component("YDL047W",316).
component("YDL006W",310).
component("YBR125C",260).
component("YBL056W",225).
component("YPR073C",1070).
component("YHR215W",620).
component("YDL024C",313).
component("YBR093C",254).
component("YBR092C",253).
component("YAR071W",215).
component("YIL053W",627).
component("YER062C",461).
component("YHR046C",595).
component("U9_",206).
component("YGR208W",566).
component("YPL228W",1044).
component("YMR180C",867).
component("YDL236W",353).
component("YJL155C",676).
component("YPR073C",1071).
component("YOR208W",992).
component("YNL053W",895).
component("YMR036C",853).
component("YIR026C",648).
component("YIL113W",635).
component("YFR028C",497).
component("YER075C",467).
component("YDL230W",351).
...
component("U25_",135).
component("U24_",134).
component("YOL064C",955).
component("YPL268W",1053).
component("YOR360C",1015).
component("YGL248W",531).
component("YKR031C",756).
component("YPL206C",1041).
component("YGL027C",511).
component("YLR286C",804).
component("YJR153W",713).
component("YJL221C",686).
component("YJL216C",684).
component("YIL172C",647).
component("YGR292W",579).
component("YGR287C",578).
component("YBR299W",287).
component("YBR184W",270).
component("YIL162W",644).
component("YPR026W",1063).
component("YDR001C",356).
component("YBR001C",230).
component("YOR190W",989).
component("YLR300W",806).
component("YGR282C",576).
component("YDR261C",398).
component("YDR400W",417).
component("U23_",133).
component("YML035C",832).
component("YJL070C",661).
component("YBR284W",284).
component("U102_",22).
component("YER043C",452).
component("YNL045W",893).
component("YLR160C",791).
component("YLR158C",790).
component("YLR157C",789).
component("YLR155C",788).
component("YDR321W",407).
component("YGL037C",512).
component("U43_",151).
component("U42_",150).
component("YMR293C",883).
component("YDR242W",395).
component("YLR308W",813).
component("YLR307W",812).
component("YBR208C",272).
component("YMR281W",882).
component("U53_",161).
component("YIR027C",649).
component("YPL111W",1032).
component("YIR032C",653).
component("YIR029W",651).
component("YPR062W",1068).
component("YMR120C",862).
component("YLR028C",772).
component("YHR144C",612).
component("YGR267C",575).
component("YCL030C",293).
component("YNL141W",903).
component("YBL033C",220).
component("YBR153W",266).
component("YDL238C",354).
component("YNL141W",904).
component("YLR245C",801).
component("YML035C",833).
component("YGR204W",564).
component("YBR084W",251).
component("YJL126W",668).
component("U44_",152).
component("YDL100C",328).
component("U87_",194).
component("U40_",148).
component("YMR267W",879).
component("YBR011C",234).
component("YHR201C",617).
component("YBR111C",255).
component("YBR252W",279).
component("YCL030C",294).
component("YPR080W",1073).
component("YOR187W",988).
component("YOR133W",980).
component("YLR069C",778).
component("YKR084C",760).
component("YKL173W",738).
component("YJL102W",666).
component("YDR385W",415).
component("YBR118W",258).
component("YER005W",446).
component("YLL001W",764).
component("YIL048W",626).
component("YER166W",480).
component("YDR093W",376).
component("YAL026C",209).
component("YBL099W",229).
component("U60_",168).
component("YLR231C",798).
component("U88_",195).
component("YLR134W",783).
component("YLR044C",774).
component("YGR087C",543).
component("YDR380W",414).
component("YDL080C",322).
component("U98_",204).
component("YMR250W",876).
component("YKL184W",743).
component("YOR128C",978).
component("YEL021W",437).
component("YNR043W",936).
component("U93_",201).
component("YDR047W",366).
component("U54_",162).
component("YKL211C",749) :- not remove_orf("YKL211C",749).
component("YKR097W",762).
component("YOL052C",948).
component("YNL169C",907).
component("YGR170W",553).
component("YKL060C",724).
component("YNL256W",916).
component("YDR294C",402).
component("YEL046C",439).
component("YNR033W",933).
component("YPR006C",1061).
component("YER065C",462).
component("YKL211C",750) :- not remove_orf("YKL211C",750).
component("YER090W",750) :- not remove_orf("YER090W",750).
component("YER090W",472) :- not remove_orf("YER090W",472).
component("YDR127W",383).
component("YPL281C",1058).
component("YOR393W",1020).
component("YMR323W",889).
component("YHR174W",614).
component("YGR254W",571).
component("YPL262W",1050).
component("YGL026C",510) :- not remove_orf("YGL026C",510).
component("YGR155W",551).
component("YLR304C",809).
component("YJL200C",682).
component("YNL316C",925).
component("YKL182W",741).
component("YPL212C",1042).
component("YNL292W",923).
component("YGL063W",516).
component("YFL001W",484).
component("YOR278W",1002).
component("YPR002W",1060).
component("U49_",156).
component("YJR016C",689).
component("YCR053W",308).
component("YDR127W",384).
component("YGL148W",521).
component("YIL168W",646).
component("YIL167W",645).
component("YCL064C",299).
component("YER086W",469).
component("YCL064C",300).
component("YLR359W",820).
component("YAL012W",207).
component("YFR055W",502).
component("YJL005W",656).
component("YOR176W",986).
component("YJL121C",667).
component("YBR019C",237).
component("YBR019C",238).
component("YDR050C",367).
component("YDR007W",357) :- not remove_orf("YDR007W",357).
component("YOR095C",973).
component("YER003C",445).
component("YBR196C",271).
component("YGL001C",504).
component("U14_",60).
component("YOL056W",951).
component("YKL152C",736).
component("YDL021W",311).
component("YMR105C",857).
component("YKL127W",730).
component("YEL058W",442).
component("YPR060C",1067).
component("YHR072W",600).
component("YJL153C",675).
component("YPL097W",1030).
component("YGR185C",559).
component("YGR264C",574).
component("YGR171C",554).
component("YHR011W",588).
component("YDR023W",360).
component("YPL104W",1031).
component("YLL018C",765).
component("YPR081C",1074).
component("YBR121C",259).
component("YHR020W",591).
component("YER087W",470).
component("YNL247W",912).
component("YOL033W",946).
component("YGL245W",530).
component("YHR091C",602).
component("YDR341C",408).
component("YOL097C",959).
component("YDR268W",399).
component("YPR047W",1066).
component("YLR060W",777).
component("YFL022C",488).
component("YPR033C",1064).
component("YHR019C",589).
component("YCR024C",304).
component("YHR019C",590).
component("YKL194C",746).
component("YIL078W",630).
component("YPL160W",1035).
component("YLR382C",822).
component("YNL073W",897).
component("YDR037W",362).
component("YOR335C",1008).
component("YGR094W",545).
component("YLR153C",787).
component("YAL054C",211).
component("YOR317W",1004).
component("YMR246W",875).
component("YIL009W",622).
component("YER015W",448).
component("YOR142W",982).
component("YGR244C",569).
component("YPR035W",1065).
component("U89_",196).
component("YOR241W",999).
component("YMR113W",859).
component("YKL132C",731).
component("YOR339C",1009).
component("YMR022W",852).
component("YLR306W",811).
component("YKL210W",748).
component("YGR133W",549).
component("YGL058W",514).
component("YER100W",476).
component("YEL012W",435).
component("YDR177W",389).
component("YDR092W",375).
component("YDR059C",370).
component("YDR054C",368).
component("YDL064W",318).
component("YBR082C",250).
component("YJL101C",665).
component("YOL049W",947).
component("U92_",200).
component("YAR015W",213).
component("YGL234W",528).
component("YER183C",483).
component("U91_",199).
component("U90_",198).
component("YNR057C",939).
component("YDL141W",335).
component("YDL141W",336).
component("YGL234W",529).
component("YDL141W",337).
component("YJR103W",702).
component("YBL039C",222).
component("YGR204W",565).
component("YBR084W",252).
component("YNL220W",910).
component("YOL058W",952).
component("YBR208C",273).
component("YHR074W",601).
component("YMR217W",872).
component("YGR061C",542).
component("YPR145W",1079).
component("YGR124W",548).
component("YOR303W",1003).
component("YJR109C",705).
component("YJL130C",671).
component("YGL062W",515).
component("YBR218C",274).
component("YPL231W",1048).
component("YNR016C",931).
component("YKL182W",742).
component("YGR037C",538).
component("YOR005C",967).
component("YDL164C",340).
component("YJL087C",662).
component("YOL010W",943).
component("YPR138C",1078).
component("YPL274W",1055).
component("YPL265W",1051).
component("YPL134C",1033).
component("YPL057C",1026).
component("YPL036W",1025).
component("YOR348C",1013).
component("YOR222W",996).
component("YOR192C",990).
component("YOR171C",985).
component("YOR130C",979).
component("YOR100C",974).
component("YOR071C",971).
component("YOR011W",968).
component("YOL156W",966).
component("YOL103W",960).
component("YOL020W",945) :- not remove_orf("YOL020W",945).
component("YNR072W",941).
component("YNR056C",938).
component("YNL318C",926).
component("YNL268W",919).
component("YNL142W",905).
component("YMR272C",881).
component("YMR202W",869).
component("YMR011W",849).
component("YML123C",845).
component("YLR348C",817).
component("YLR260W",803).
component("YLR237W",799).
component("YLR138W",784).
component("YLR100C",781).
component("YLR081W",779).
component("YLL061W",768).
component("YLL043W",767).
component("YKR093W",761).
component("YKR053C",758).
component("YKR039W",757) :- not remove_orf("YKR039W",757).
component("YKL217W",752).
component("YKL120W",729).
component("YKL004W",717).
component("YJR158W",714).
component("YJR152W",712).
component("YJR095W",701).
component("YJR077C",699).
component("YJL219W",685).
component("YJL214W",683).
component("YJL134W",672).
component("YJL129C",669).
component("YIR028W",650).
component("YIL134W",638).
component("YHR096C",605).
component("YHR094C",604).
component("YHR092C",603).
component("YHL036W",584).
component("YHL016C",582).
component("YGR121C",546).
component("YGR055W",540).
component("YGL186C",523).
component("YGL077C",518).
component("YGL008C",505).
component("YFL055W",492).
component("YFL011W",485).
component("YER060W-A",458).
component("YER060W",457).
component("YER056C",456).
component("YER053C",454).
component("YEL069C",444).
component("YEL063C",443).
component("YEL017C-A",436).
component("YDR536W",433).
component("YDR508C",429).
component("YDR503C",428).
component("YDR497C",427).
component("YDR345C",411).
component("YDR343C",410).
component("YDR342C",409).
component("YDR297W",404).
component("YDR294C",403).
component("YDR284C",401).
component("YDR046C",365) :- not remove_orf("YDR046C",365).
component("YDL245C",355).
component("YDL210W",348).
component("YCR032W",306).
component("YCR024C-A",305).
component("YCL025C",291).
component("YBR298C",286).
component("YBR291C",285).
component("YBR069C",249) :- not remove_orf("YBR069C",249).
component("YBR068C",248) :- not remove_orf("YBR068C",248).
component("YBR036C",244).
component("YBR021W",240).
component("YBL042C",223).
component("U85_",192).
component("U7_",186).
component("U79_",185).
component("U78_",184).
...
catalyst(1960,366).
catalyst(3460,162).
catalyst(3600,749) :- not remove_reaction(3600,749).
catalyst(8000,762).
catalyst(3941,948).
catalyst(3942,948).
catalyst(6890,907).
...
catalyst(8020,1061).
catalyst(8020,462).
catalyst(1890,750) :- not remove_reaction(1890,750).
catalyst(3630,750) :- not remove_reaction(3630,750).
catalyst(1890,472) :- not remove_reaction(1890,472).
catalyst(3630,472) :- not remove_reaction(3630,472).
catalyst(3740,383).
catalyst(8231,1058).
catalyst(8232,1058).
catalyst(8231,1020).
...
catalyst(8051,1050).
catalyst(8052,1050).
catalyst(3590,510) :- not remove_reaction(3590,510).
catalyst(10910,510) :- not remove_reaction(10910,510).
catalyst(4570,551).
catalyst(8181,809).
catalyst(8182,809).
catalyst(8181,682).
...
catalyst(1210,966).
catalyst(1160,960).
catalyst(801,945) :- not remove_reaction(801,945).
catalyst(802,945) :- not remove_reaction(802,945).
catalyst(811,945) :- not remove_reaction(811,945).
catalyst(812,945) :- not remove_reaction(812,945).
catalyst(831,945) :- not remove_reaction(831,945).
catalyst(832,945) :- not remove_reaction(832,945).
catalyst(901,945) :- not remove_reaction(901,945).
catalyst(902,945) :- not remove_reaction(902,945).
catalyst(941,945) :- not remove_reaction(941,945).
catalyst(942,945) :- not remove_reaction(942,945).
catalyst(1170,941).
catalyst(1180,941).
catalyst(1210,941).
catalyst(700,938).
...
catalyst(650,761).
catalyst(6560,758).
catalyst(681,757) :- not remove_reaction(681,757).
catalyst(682,757) :- not remove_reaction(682,757).
catalyst(761,757) :- not remove_reaction(761,757).
catalyst(762,757) :- not remove_reaction(762,757).
catalyst(771,757) :- not remove_reaction(771,757).
catalyst(772,757) :- not remove_reaction(772,757).
catalyst(781,757) :- not remove_reaction(781,757).
catalyst(782,757) :- not remove_reaction(782,757).
catalyst(791,757) :- not remove_reaction(791,757).
catalyst(792,757) :- not remove_reaction(792,757).
catalyst(801,757) :- not remove_reaction(801,757).
catalyst(802,757) :- not remove_reaction(802,757).
catalyst(811,757) :- not remove_reaction(811,757).
catalyst(812,757) :- not remove_reaction(812,757).
catalyst(821,757) :- not remove_reaction(821,757).
catalyst(822,757) :- not remove_reaction(822,757).
catalyst(831,757) :- not remove_reaction(831,757).
catalyst(832,757) :- not remove_reaction(832,757).
catalyst(841,757) :- not remove_reaction(841,757).
catalyst(842,757) :- not remove_reaction(842,757).
catalyst(861,757) :- not remove_reaction(861,757).
catalyst(862,757) :- not remove_reaction(862,757).
catalyst(881,757) :- not remove_reaction(881,757).
catalyst(882,757) :- not remove_reaction(882,757).
catalyst(901,757) :- not remove_reaction(901,757).
catalyst(902,757) :- not remove_reaction(902,757).
catalyst(911,757) :- not remove_reaction(911,757).
catalyst(912,757) :- not remove_reaction(912,757).
catalyst(921,757) :- not remove_reaction(921,757).
catalyst(922,757) :- not remove_reaction(922,757).
catalyst(941,757) :- not remove_reaction(941,757).
catalyst(942,757) :- not remove_reaction(942,757).
catalyst(1191,757) :- not remove_reaction(1191,757).
catalyst(1192,757) :- not remove_reaction(1192,757).
catalyst(390,752).
catalyst(1021,752).
catalyst(1022,752).
catalyst(1521,729).
...
catalyst(861,365) :- not remove_reaction(861,365).
catalyst(862,365) :- not remove_reaction(862,365).
...
catalyst(1511,285).
catalyst(1512,285).
catalyst(771,249) :- not remove_reaction(771,249).
catalyst(772,249) :- not remove_reaction(772,249).
...
modifiable_enzyme(510).
modifiable_enzyme(357).
modifiable_enzyme(945).
