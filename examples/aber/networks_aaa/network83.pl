...
component("YNL280C",505).
component("YGR060W",303).
component("YGL012W",281).
component("YOL086C",524).
component("YMR303C",483).
component("YGL256W",297).
component("YDL168W",182).
component("YBR145W",142).
component("YPL231W",574).
component("YBR149W",143).
component("YGL001C",278).
component("YIL094C",346).
component("YHR063C",331).
component("YBR153W",144).
component("YML056C",459).
component("YLR432W",455).
component("YHR216W",340).
component("YAR075W",114).
component("YAR073W",113).
component("YDR127W",200).
component("YJR139C",392).
component("YOL126C",528).
component("YDL078C",172).
component("YKL029C",396).
component("YOR136W",538).
component("YDL066W",171).
component("YLR355C",452).
component("YML086C",461).
component("YIL155C",350).
component("YPR191W",600).
component("YOR065W",533).
component("YJL166W",371).
component("YHR001W-A",326).
component("YGR183C",313).
component("YFR033C",274).
component("YDR529C",233).
component("YBL045C",120).
component("Q0105",18).
component("YGR088W",305).
component("YDR256C",214).
component("YJR078W",383).
component("YJR025C",378).
component("YGR255C",320).
component("YBL098W",123).
component("YMR015C",467).
component("YDR402C",225).
component("YGL055W",285).
component("YGR175C",311).
component("YJR104C",386).
component("YHR008C",327).
component("YER070W",253).
component("U35_",72).
component("YDL168W",183).
component("YDR158W",208).
component("YPL276W",582).
component("YPL275W",581).
component("YOR388C",560).
component("YGL154C",291).
component("U55_",81).
component("YOR323C",550).
component("YMR170C",475).
component("YMR169C",474).
component("U2_",69).
component("YBR221C",151).
component("U52_",78).
component("YBR166C",147).
component("YNL280C",506).
component("YGL012W",282).
component("U57_",82).
component("YER014W",242).
component("YKR009C",413).
component("YIL160C",352).
component("YGL205W",294).
component("YMR118C",472).
component("YLR164W",437).
component("YLL041C",421).
component("YKL148C",403).
component("YJL045W",357).
component("YDR178W",209).
component("YJR051W",380).
component("YEL047C",237).
component("YOR375C",558).
component("YDL215C",185).
component("YAL062W",111).
component("U99_",107).
component("YBR035C",130).
component("YHR037W",328).
component("YKR080W",417).
component("YER023W",243).
component("YOR236W",547).
component("YGR204W",315).
component("YLR142W",432).
component("U62_",84).
component("YKL150W",404).
component("YIL043C",342).
component("YHR042W",329).
component("YFR030W",273).
component("YPL017C",563).
component("YFL018C",265).
component("YER042W",245).
component("YJR137C",391).
component("YML110C",463).
component("YBR034C",129).
component("YPL273W",580).
component("YLL062C",423).
component("U47_",75).
component("YER091C",256).
component("YDL033C",169).
component("YOL096C",525).
component("YDR019C",190).
component("YDR408C",227).
component("YBL013W",115).
component("YKL024C",395).
component("YPR074C",592).
component("YBR117C",139).
component("YLR354C",451).
component("YGR043C",301).
component("YCL009C",160).
component("YMR062C",469).
component("YNL071W",489).
component("YNR008W",513).
component("YPL231W",575).
component("YER061C",251).
component("U86_",99).
component("YPL001W",562).
component("YDR148C",206).
component("YOR377W",559).
component("YGR177C",312).
component("YPL231W",576).
component("YGR147C",308).
component("YDL040C",170).
component("YPL028W",564).
component("YPR001W",584).
component("YNR001C",511).
component("YDL182W",184).
component("YDL131W",177).
component("YNL117W",492).
component("YIR031C",355).
component("YNL029C",486).
component("YIL085C",345).
component("YMR261C",480).
component("YML100W",462).
component("YBR126C",141).
component("YNL192W",498).
component("YBR038W",132).
component("YBR023C",128).
component("YLR209C",438).
component("U104_",21).
component("YMR300C",482).
component("YER055C",247).
component("YDR354W",221) :- not remove_orf("YDR354W",221).
component("YFR047C",275).
component("YJR133W",390).
component("YLR209C",439).
component("YML022W",456).
component("YDR441C",229).
component("YDR399W",223).
component("YJL167W",372).
component("YNL256W",501).
component("YDR127W",201).
component("YLR303W",445).
component("YJR130C",389).
component("YLR303W",446).
component("YDR035W",191).
component("YBR249C",152).
component("YOL143C",530).
component("YBR256C",153).
component("YHR137W",335).
component("YGL202W",293).
component("YLR027C",424).
component("YKL106W",399).
component("YKL104C",398).
component("YGR019W",299).
component("YLR089C",428).
component("U64_",85).
component("U51_",77).
component("YJR148W",393).
component("YGL253W",296).
component("YFR053C",276).
component("YOL136C",529).
component("YIL107C",347).
component("YMR205C",477).
component("YGR240C",317).
component("YDR248C",213).
component("YCR036W",167).
component("YCL040W",162).
component("YJR105W",387).
component("U16_",38).
component("U15_",35).
component("U96_",105).
component("YKL001C",394).
component("YML070W",460).
component("YFL053W",268).
component("YHL032C",324).
component("U83_",97).
component("U82_",96).
component("U81_",95).
component("YMR208W",478).
component("YOR347C",555).
component("YAL038W",110).
component("YPR121W",595).
component("YPL258C",578).
component("YOL055C",521).
component("U1_",52).
component("YBR020W",126).
component("YNL267W",503).
component("YLR305C",448).
component("YFR019W",271).
component("YDR208W",210).
component("YDR127W",202).
component("U21_",60).
component("U20_",58).
component("YDR147W",205).
component("YDR300C",218).
component("YCR012W",164).
component("U18_",47).
component("U76_",93).
component("YER170W",262).
component("YDR226W",211).
component("YDR454C",230).
component("YOL061W",523).
component("YKL181W",406).
component("YHL011C",322).
component("YER099C",258).
component("YBL068W",122).
component("YOR143C",539).
component("YGR007W",298).
component("YLR328W",449).
component("YJR010W",377).
component("YCL050C",163).
component("YPR190C",599).
component("YPR187W",598).
component("YPR110C",594).
component("YPR010C",586).
component("YOR341W",554).
component("YOR340C",553).
component("YOR224C",546).
component("YOR210W",545).
component("YOR207C",543).
component("YOR151C",540).
component("YOR116C",536).
component("YOL005C",517).
component("YNR003C",512).
component("YNL248C",500).
component("YNL151C",496).
component("YNL113W",491).
component("YKL144C",402).
component("YJR063W",381).
component("YJL148W",369).
component("YJL140W",368).
component("YIL021W",341).
component("YHR143W-A",336).
component("YGL070C",288).
component("YFL036W",267).
component("YDR404C",226).
component("YDR156W",207).
component("YDR045C",192).
component("YDL150W",180).
component("YDL140C",178).
component("YBR154C",146).
component("YPR175W",597).
component("YPL167C",571).
component("YOR330C",551).
component("YOL115W",527).
component("YNL299W",508).
component("YNL262W",502).
component("YNL102W",490).
component("YJR043C",379).
component("YJR006W",376).
component("YJL090C",361).
component("YIL139C",349).
component("YEL055C",238).
component("YDR419W",228).
component("YDR121W",199).
component("YDL102W",175).
component("YCR014C",165).
component("YBR278W",155).
component("YBL035C",117).
component("YKL035W",397).
component("YHL012W",323).
component("YHR123W",334).
component("YER026C",244).
component("YCL004W",159).
component("YJL068C",358).
component("YDR058C",196).
component("YDL086W",174).
component("YOL011W",518).
component("YMR008C",466).
component("YMR006C",465).
component("U101_",19).
component("YBL015W",116).
component("YJL068C",359).
component("YPL072W",567).
component("YOR124C",537).
component("YNL186W",497).
component("YMR304W",484).
component("YMR223W",479).
component("YKR098C",419).
component("YJL197W",373).
component("YIL156W",351).
component("YFR010W",270).
component("YER151C",260).
component("YER144C",259).
component("YER098W",257).
component("YDR069C",197).
component("YDL122W",176).
component("YBR058C",133).
component("YBL067C",121).
component("U84_",98).
component("YPR073C",590).
component("YHR215W",339).
component("YDL024C",168).
component("YBR093C",137).
component("YBR092C",136).
component("YAR071W",112).
component("YIL053W",344).
component("YER062C",252).
component("YHR046C",330).
component("YGR208W",316).
component("YPL228W",573).
component("YMR180C",476).
component("YDL236W",187).
component("YJL155C",370).
component("YPR073C",591).
component("YOR208W",544).
component("YNL053W",488).
component("YMR036C",468).
component("YIR026C",353).
component("YIL113W",348).
component("YFR028C",272).
component("YER075C",254).
component("YDL230W",186).
component("YBR276C",154).
component("U34_",71).
component("U30_",70).
component("U25_",68).
component("U24_",67).
component("YOR360C",557).
component("YGL248W",295).
component("YKR031C",414).
component("YLR286C",443).
component("YOR190W",541).
component("YLR300W",444).
component("YGR282C",321).
component("YDR261C",215).
component("YDR400W",224).
component("U23_",66).
component("YML035C",457).
component("YJL070C",360).
component("YBR284W",156).
component("U102_",20).
component("YNL045W",487).
component("YLR160C",436).
component("YLR158C",435).
component("YLR157C",434).
component("YLR155C",433).
component("YDR321W",219).
component("YGL037C",284).
component("YDR242W",212).
component("YBR208C",148).
component("U53_",79).
component("YIR032C",356).
component("YIR029W",354).
component("YMR120C",473).
component("YHR144C",337).
component("YNL141W",493).
component("YBR153W",145).
component("YDL238C",188).
component("YNL141W",494).
component("YLR245C",442).
component("YML035C",458).
component("YJL126W",364).
component("U87_",100).
component("YBR111C",138).
component("YER005W",241).
component("YIL048W",343).
component("YER166W",261).
component("YDR093W",198).
component("YAL026C",109).
component("YLR231C",440).
component("U88_",101).
component("YLR134W",430).
component("YLR044C",425).
component("YGR087C",304).
component("YDR380W",222).
component("YDL080C",173).
component("U98_",106).
component("YKL184W",409).
component("YNR043W",516).
component("U93_",104).
component("YDR047W",194).
component("U54_",80).
component("YKL211C",410) :- not remove_orf("YKL211C",410).
component("YGR170W",310).
component("YDR294C",216).
component("YEL046C",236).
component("YNR033W",515).
component("YKL211C",411) :- not remove_orf("YKL211C",411).
component("YER090W",411) :- not remove_orf("YER090W",411).
component("YER090W",255) :- not remove_orf("YER090W",255).
component("YDR127W",203).
component("YPL281C",583).
component("YOR393W",561).
component("YMR323W",485).
component("YHR174W",338).
component("YGR254W",319).
component("YGL026C",283) :- not remove_orf("YGL026C",283).
component("YGR155W",309).
component("YLR304C",447).
component("YJL200C",374).
component("YNL316C",509).
component("YKL182W",407).
component("YPL212C",572).
component("YNL292W",507).
component("YGL063W",287).
component("YFL001W",263).
component("YPR002W",585).
component("YDR127W",204).
component("YGL148W",290).
component("YLR359W",453).
component("YAL012W",108).
component("YFR055W",277).
component("YJL121C",363).
component("YBR019C",124).
component("YBR019C",125).
component("YDR050C",195).
component("YDR007W",189) :- not remove_orf("YDR007W",189).
component("YOR095C",535).
component("YER003C",240).
component("YGL001C",279).
component("U14_",30).
component("YKL152C",405).
component("YMR105C",470).
component("YKL127W",400).
component("YEL058W",239).
component("YPR060C",589).
component("YPL097W",568).
component("YGR185C",314).
component("YPL104W",569).
component("YLL018C",420).
component("YPR081C",593).
component("YBR121C",140).
component("YNL247W",499).
component("YOL033W",520).
component("YHR091C",333).
component("YDR341C",220).
component("YOL097C",526).
component("YPR047W",588).
component("YLR060W",426).
component("YFL022C",266).
component("YPR033C",587).
component("YPL160W",570).
component("YLR382C",454).
component("YOR335C",552).
component("YGR094W",306).
component("YGR244C",318).
component("U89_",102).
component("YOR241W",548).
component("YMR113W",471).
component("YKL132C",401).
component("YJL101C",362).
component("U91_",103).
component("YDL141W",179).
component("YJR103W",385).
component("YBL039C",118).
component("YOL058W",522).
component("YBR208C",149).
component("YHR074W",332).
component("YOR303W",549).
component("YJR109C",388).
component("YJL130C",366).
component("YGL062W",286).
component("YBR218C",150).
component("YPL231W",577).
component("YNR016C",514).
component("YKL182W",408).
component("YGR037C",300).
component("YOR005C",532).
component("YDL164C",181).
component("YPR138C",596).
component("YPL265W",579).
component("YPL057C",566).
component("YPL036W",565).
component("YOR348C",556).
component("YOR192C",542).
component("YOR071C",534).
component("YOL156W",531).
component("YOL020W",519) :- not remove_orf("YOL020W",519).
component("YNL318C",510).
component("YNL268W",504).
component("YNL142W",495).
component("YMR272C",481).
component("YML123C",464).
component("YLR348C",450).
component("YLR237W",441).
component("YLR138W",431).
component("YLR100C",429).
component("YLR081W",427).
component("YLL061W",422).
component("YKR093W",418).
component("YKR053C",416).
component("YKR039W",415) :- not remove_orf("YKR039W",415).
component("YKL217W",412).
component("YJR095W",384).
component("YJR077C",382).
component("YJL219W",375).
component("YJL134W",367).
component("YJL129C",365).
component("YHL036W",325).
component("YGR121C",307).
component("YGR055W",302).
component("YGL186C",292).
component("YGL077C",289).
component("YGL008C",280).
component("YFL055W",269).
component("YFL011W",264).
component("YER060W-A",250).
component("YER060W",249).
component("YER056C",248).
component("YER053C",246).
component("YEL017C-A",235).
component("YDR536W",234).
component("YDR508C",232).
component("YDR503C",231).
component("YDR294C",217).
component("YDR046C",193) :- not remove_orf("YDR046C",193).
...
catalyst(6160,482).
catalyst(3870,247).
catalyst(3620,221) :- not remove_reaction(3620,221).
catalyst(2110,275).
catalyst(2190,275).
catalyst(5550,390).
catalyst(5791,439).
...
catalyst(1960,194).
catalyst(3460,80).
catalyst(3600,410) :- not remove_reaction(3600,410).
catalyst(6900,310).
catalyst(8781,216).
catalyst(8782,216).
catalyst(4560,236).
...
catalyst(3630,255) :- not remove_reaction(3630,255).
catalyst(3740,203).
catalyst(8231,583).
catalyst(8232,583).
catalyst(8231,561).
...
catalyst(8231,319).
catalyst(8232,319).
catalyst(3590,283) :- not remove_reaction(3590,283).
catalyst(10910,283) :- not remove_reaction(10910,283).
catalyst(4570,309).
catalyst(8181,447).
catalyst(8182,447).
catalyst(8181,374).
...
catalyst(8281,195).
catalyst(8282,195).
catalyst(3610,189) :- not remove_reaction(3610,189).
catalyst(7921,535).
catalyst(7922,535).
catalyst(7841,240).
catalyst(7842,240).
...
catalyst(190,534).
catalyst(1200,531).
catalyst(801,519) :- not remove_reaction(801,519).
catalyst(802,519) :- not remove_reaction(802,519).
catalyst(811,519) :- not remove_reaction(811,519).
catalyst(812,519) :- not remove_reaction(812,519).
catalyst(831,519) :- not remove_reaction(831,519).
catalyst(832,519) :- not remove_reaction(832,519).
catalyst(941,519) :- not remove_reaction(941,519).
catalyst(942,519) :- not remove_reaction(942,519).
catalyst(1200,510).
catalyst(761,504).
catalyst(762,504).
catalyst(371,495).
...
catalyst(640,418).
catalyst(6560,416).
catalyst(761,415) :- not remove_reaction(761,415).
catalyst(762,415) :- not remove_reaction(762,415).
catalyst(771,415) :- not remove_reaction(771,415).
catalyst(772,415) :- not remove_reaction(772,415).
catalyst(781,415) :- not remove_reaction(781,415).
catalyst(782,415) :- not remove_reaction(782,415).
catalyst(791,415) :- not remove_reaction(791,415).
catalyst(792,415) :- not remove_reaction(792,415).
catalyst(801,415) :- not remove_reaction(801,415).
catalyst(802,415) :- not remove_reaction(802,415).
catalyst(811,415) :- not remove_reaction(811,415).
catalyst(812,415) :- not remove_reaction(812,415).
catalyst(831,415) :- not remove_reaction(831,415).
catalyst(832,415) :- not remove_reaction(832,415).
catalyst(841,415) :- not remove_reaction(841,415).
catalyst(842,415) :- not remove_reaction(842,415).
catalyst(861,415) :- not remove_reaction(861,415).
catalyst(862,415) :- not remove_reaction(862,415).
catalyst(881,415) :- not remove_reaction(881,415).
catalyst(882,415) :- not remove_reaction(882,415).
catalyst(941,415) :- not remove_reaction(941,415).
catalyst(942,415) :- not remove_reaction(942,415).
catalyst(1191,415) :- not remove_reaction(1191,415).
catalyst(1192,415) :- not remove_reaction(1192,415).
catalyst(1021,412).
catalyst(1022,412).
catalyst(1250,384).
catalyst(1581,382).
...
catalyst(831,193) :- not remove_reaction(831,193).
catalyst(832,193) :- not remove_reaction(832,193).
catalyst(841,193) :- not remove_reaction(841,193).
catalyst(842,193) :- not remove_reaction(842,193).
