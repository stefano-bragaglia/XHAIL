...
component("YNL280C",736).
component("YLR056W",622).
component("YGR060W",434).
component("YGL012W",402).
component("YKR009C",605).
component("YOL086C",767).
component("YMR303C",705).
component("YMR083W",680).
component("YGL256W",426).
component("YDL168W",262).
component("YBR145W",198).
component("YPL231W",840).
component("U46_",109).
component("YBR149W",199).
component("YBR149W",200).
component("YJR159W",574).
component("YGL001C",399).
component("YIL094C",509).
component("YHR063C",482).
component("YBR153W",201).
component("YML056C",665).
component("YLR432W",658).
component("YHR216W",499).
component("YAR075W",160).
component("YAR073W",159).
component("YCL030C",225).
component("YDR127W",292).
component("YJR139C",568).
component("YOL126C",772).
component("YKL085W",584).
component("YDL078C",243).
component("YKL029C",579).
component("YOR136W",784).
component("YNL037C",710).
component("YDL066W",242).
component("YNL241C",726).
component("YOL059W",765).
component("YDL022W",237).
component("YLR355C",654).
component("YIL074C",507).
component("YER081W",369).
component("YML054C",664).
component("YDL174C",264).
component("YML086C",668).
component("YIL155C",515).
component("YPR191W",876).
component("YOR065W",778).
component("YJL166W",543).
component("YHR001W-A",471).
component("YGR183C",449).
component("YFR033C",395).
component("YDR529C",338).
component("YBL045C",166).
component("Q0105",18).
component("YGR088W",437).
component("YDR256C",307).
component("YKL026C",578).
component("YIR037W",524).
component("YBR244W",213).
component("YJR078W",559).
component("YJR025C",551).
component("YGR255C",461).
component("U108_",22).
component("YBL098W",170).
component("YMR015C",677).
component("YHR007C",472).
component("YDR402C",327).
component("YGL055W",409).
component("YGR175C",446).
component("YJR104C",562).
component("YHR008C",473).
component("YJL026W",526).
component("YIL066C",506).
component("YGR180C",448).
component("YER070W",366).
component("U38_",104).
component("U36_",103).
component("U35_",102).
component("YDL168W",263).
component("YDR158W",300).
component("YBR006W",173).
component("YPL276W",852).
component("YPL275W",851).
component("YOR388C",817).
component("YOR374W",814).
component("YER073W",367).
component("U68_",125).
component("YGL154C",417).
component("U55_",118).
component("YOR323C",806).
component("YMR170C",689).
component("YMR169C",688).
component("U2_",98).
component("YER178W",382).
component("YBR221C",211).
component("YIL125W",513).
component("U52_",115).
component("YBR166C",204).
component("YNL280C",737).
component("YGL012W",403).
component("U57_",120).
component("YKL216W",602).
component("YDR044W",280).
component("YER014W",351).
component("YKR009C",606).
component("YIL160C",517).
component("YGL205W",420).
component("YMR118C",685).
component("YLR164W",635).
component("YLL041C",615).
component("YKL148C",591).
component("YKL141W",589).
component("YJL045W",527).
component("YDR178W",301).
component("YJR051W",554).
component("YEL047C",345).
component("YDL215C",268).
component("YOR375C",815).
component("YDL215C",269).
component("YAL062W",157).
component("U99_",151).
component("YBR035C",183).
component("YMR189W",691).
component("U56_",119).
component("YHR037W",479).
component("YKR080W",610).
component("YER023W",353).
component("YPL023C",821).
component("YGL125W",414).
component("YOR236W",799).
component("YGR204W",453).
component("YLR142W",630).
component("U62_",123).
component("YKL150W",592).
component("YIL043C",503).
component("YHR042W",480).
component("YOR221C",797).
component("YML120C",671).
component("YKL192C",599).
component("YKL055C",581).
component("YER061C",362).
component("YGR234W",456).
component("YFR030W",394).
component("YPL017C",820).
component("YFL018C",386).
component("YDR353W",322).
component("YER042W",355).
component("YJR137C",567).
component("YPL266W",847).
component("YML110C",670).
component("YBR034C",182).
component("YPL273W",849).
component("YLL062C",618).
component("YDR410C",330).
component("U47_",110).
component("YER091C",374).
component("YJR073C",557).
component("YDR120C",290).
component("YDL033C",239).
component("YOL096C",768).
component("YLR172C",636).
component("YDR019C",276).
component("YBR176W",205).
component("YDR408C",329).
component("YMR120C",686).
component("YBL013W",161).
component("YKL024C",577).
component("YPR074C",865).
component("YBR117C",194).
component("YLR354C",653).
component("YGR043C",432).
component("YMR108W",683).
component("YCL009C",223).
component("YMR062C",679).
component("YNL071W",713).
component("YNR008W",744).
component("YIL160C",518).
component("YNL277W",735).
component("YFL017C",385).
component("YPL231W",841).
component("YER061C",363).
component("U86_",140).
component("YPL001W",819).
component("YDR148C",298).
component("YOR377W",816).
component("YGR177C",447).
component("YPL231W",842).
component("YGR147C",442).
component("YDL040C",240).
component("YPL028W",822).
component("YGL017W",404).
component("YPR001W",854).
component("YNR001C",742).
component("YDL182W",265).
component("YDL131W",253).
component("YNL117W",717).
component("YIR031C",522).
component("YOR321W",805).
component("YJR143C",569).
component("YGR199W",452).
component("YDR307W",316).
component("YDL095W",248).
component("YDL093W",247).
component("YAL023C",154).
component("YNL029C",709).
component("YIL085C",508).
component("YMR261C",699).
component("YML100W",669).
component("YBR126C",197).
component("YNL192W",725).
component("YBR038W",185).
component("YBR023C",181).
component("YMR306W",707).
component("YLR342W",651).
component("YGR032W",430).
component("YLR209C",637).
component("U104_",21).
component("YOR209C",795).
component("YMR300C",704).
component("YER055C",358).
component("YDR354W",323) :- not remove_orf("YDR354W",323).
component("YFR047C",396).
component("YJR133W",566).
component("YLR209C",638).
component("YML022W",661).
component("YDR441C",333).
component("YDR399W",325).
component("YPR176C",873).
component("YPL172C",832).
component("YNR041C",750).
component("YMR101C",681).
component("YDL090C",246).
component("YBR003W",172).
component("YBR002C",171).
component("YJL167W",544).
component("YNL256W",729).
component("YDR127W",293).
component("YLR303W",645).
component("YGR012W",428).
component("YJR130C",565).
component("YLR303W",646).
component("YDR035W",278).
component("YBR249C",214).
component("YOR274W",801).
component("YOL143C",774).
component("YBR256C",216).
component("YHR137W",491).
component("YGL202W",419).
component("YLR027C",619).
component("YKL106W",586).
component("YKL104C",585).
component("YGR019W",429).
component("YLR089C",625).
component("U64_",124).
component("U61_",122).
component("U51_",114).
component("YJR148W",570).
component("YHR208W",497).
component("YOR184W",790).
component("YNR058W",753).
component("YIL116W",512).
component("YGL253W",425).
component("YFR053C",397).
component("YOL136C",773).
component("YIL107C",510).
component("YMR013C",676).
component("YMR205C",692).
component("YGR240C",457).
component("YDR248C",306).
component("YCR036W",233).
component("YGR194C",451).
component("YCL040W",227).
component("YJR105W",563).
component("U16_",53).
component("U15_",47).
component("YPL188W",834).
component("YJR049C",553).
component("YEL041W",343).
component("U96_",149).
component("YKL001C",575).
component("YDR236C",304).
component("YML070W",667).
component("YFL053W",389).
component("YHL032C",469).
component("YLR133W",627).
component("YDR531W",340).
component("U83_",138).
component("U82_",137).
component("U81_",136).
component("YMR208W",693).
component("YPL203W",835).
component("YOR061W",777).
component("YKL166C",594).
component("YJL164C",542).
component("YIL035C",502).
component("YHR205W",496).
component("YHR102W",489).
component("YGL019W",405).
component("YHR025W",478).
component("YOR347C",811).
component("YAL038W",156).
component("YNR012W",745).
component("YPR121W",869).
component("YPL258C",844).
component("YOL055C",761).
component("YPL214C",838).
component("U1_",76).
component("YDR009W",275).
component("YBR020W",179).
component("YNL267W",733).
component("YLR305C",648).
component("YFR019W",392).
component("YDR208W",302).
component("YDR127W",294).
component("U21_",86).
component("U20_",83).
component("YDR147W",297).
component("YDR300C",315).
component("YCR012W",229).
component("YER052C",356).
component("U18_",68).
component("U17_",61).
component("U76_",133).
component("YMR220W",695).
component("YER170W",381).
component("YDR226W",303).
component("YKL067W",583).
component("YOL055C",762).
component("YDR454C",334).
component("YJR057W",555).
component("YOL061W",766).
component("YKL181W",595).
component("YHL011C",466).
component("YER099C",376).
component("YBL068W",169).
component("YOR143C",786).
component("YNL256W",730).
component("YLR328W",649).
component("YBR018C",175).
component("YBR018C",176).
component("YGR007W",427).
component("YLR328W",650).
component("YKR002W",604).
component("YDL103C",251).
component("U94_",148).
component("YJR010W",550).
component("YGL130W",415).
component("YDR530C",339).
component("YCL050C",228).
component("YPR190C",875).
component("YPR187W",874).
component("YPR110C",867).
component("YPR010C",857).
component("YOR341W",810).
component("YOR340C",809).
component("YOR224C",798).
component("YOR210W",796).
component("YOR207C",793).
component("YOR151C",787).
component("YOR116C",781).
component("YOL005C",755).
component("YNR003C",743).
component("YNL248C",728).
component("YNL151C",722).
component("YNL113W",716).
component("YKL144C",590).
component("YJR063W",556).
component("YJL148W",539).
component("YJL140W",538).
component("YIL021W",501).
component("YHR143W-A",492).
component("YGL070C",412).
component("YFL036W",388).
component("YDR404C",328).
component("YDR156W",299).
component("YDR045C",281).
component("YDL150W",260).
component("YDL140C",255).
component("YBR154C",203).
component("YPR175W",872).
component("YPL167C",831).
component("YOR330C",807).
component("YOL115W",771).
component("YNL299W",739).
component("YNL262W",732).
component("YNL102W",715).
component("YJR043C",552).
component("YJR006W",549).
component("YJL090C",531).
component("YIL139C",514).
component("YEL055C",346).
component("YDR419W",331).
component("YDR121W",291).
component("YDL102W",250).
component("YCR014C",230).
component("YBR278W",218).
component("YBL035C",163).
component("YKL035W",580).
component("YHL012W",467).
component("YHR123W",490).
component("YPR113W",868).
component("YBR243C",212).
component("YNL130C",718).
component("YDL142C",259).
component("YPL148C",829).
component("YER026C",354).
component("YCL004W",222).
component("YGR286C",465).
component("YJL068C",528).
component("YDR058C",285).
component("YNR034W",749).
component("YHR163W",494).
component("YGR248W",459).
component("YCR073W-A",234).
component("YDL086W",245).
component("YOL011W",757).
component("YMR008C",674).
component("YMR006C",673).
component("U101_",19).
component("YBL015W",162).
component("YJL068C",529).
component("YPL072W",825).
component("YOR124C",782).
component("YNL186W",724).
component("YMR304W",706).
component("YMR223W",696).
component("YKR098C",613).
component("YJL197W",545).
component("YIL156W",516).
component("YFR010W",391).
component("YER151C",379).
component("YER144C",378).
component("YER098W",375).
component("YDR069C",286).
component("YDL122W",252).
component("YBR058C",186).
component("YBL067C",168).
component("YDR272W",310).
component("U84_",139).
component("YLR377C",656).
component("YDR074W",287).
component("YPL179W",833).
component("YNR032W",747).
component("YML057W",666).
component("YML016C",660).
component("YLR433C",659).
component("YGR123C",440).
component("YER133W",377).
component("YER089C",372).
component("YDR436W",332).
component("YDR075W",288).
component("YDL188C",266).
component("YDL134C",254).
component("YDL047W",241).
component("YDL006W",235).
component("YBR125C",196).
component("YBL056W",167).
component("YPR073C",863).
component("YHR215W",498).
component("YDL024C",238).
component("YBR093C",192).
component("YBR092C",191).
component("YAR071W",158).
component("YIL053W",505).
component("YER062C",364).
component("YHR046C",481).
component("U9_",152).
component("YGR208W",455).
component("YPL228W",839).
component("YMR180C",690).
component("YDL236W",271).
component("YJL155C",541).
component("YPR073C",864).
component("YOR208W",794).
component("YNL053W",712).
component("YMR036C",678).
component("YIR026C",519).
component("YIL113W",511).
component("YFR028C",393).
component("YER075C",368).
component("YDL230W",270).
component("YBR276C",217).
component("U34_",101).
component("U33_",100).
component("U30_",99).
component("U28_",97).
...
component("U25_",95).
component("U24_",94).
component("YPL268W",848).
component("YOR360C",813).
component("YGL248W",424).
component("YKR031C",607).
component("YPL206C",836).
component("YGL027C",407).
component("YLR286C",643).
component("YJR153W",572).
component("YBR184W",206).
component("YOR190W",791).
component("YLR300W",644).
component("YGR282C",464).
component("YDR261C",308).
component("YDR400W",326).
component("U23_",93).
component("YML035C",662).
component("YJL070C",530).
component("YBR284W",219).
component("U102_",20).
component("YNL045W",711).
component("YLR160C",634).
component("YLR158C",633).
component("YLR157C",632).
component("YLR155C",631).
component("YDR321W",317).
component("YGL037C",408).
component("YMR293C",703).
component("YDR242W",305).
component("YBR208C",208).
component("YMR281W",702).
component("U53_",116).
component("YIR027C",520).
component("YPL111W",828).
component("YIR032C",523).
component("YIR029W",521).
component("YPR062W",862).
component("YMR120C",687).
component("YLR028C",620).
component("YHR144C",493).
component("YGR267C",463).
component("YNL141W",719).
component("YBR153W",202).
component("YDL238C",272).
component("YNL141W",720).
component("YLR245C",641).
component("YML035C",663).
component("YBR084W",189).
component("YJL126W",534).
component("U44_",108).
component("YDL100C",249).
component("U87_",141).
component("U40_",106).
component("YMR267W",700).
component("YBR011C",174).
component("YBR111C",193).
component("YBR252W",215).
component("YCL030C",226).
component("YER005W",350).
component("YIL048W",504).
component("YER166W",380).
component("YDR093W",289).
component("YAL026C",155).
component("YLR231C",639).
component("U88_",142).
component("YLR134W",628).
component("YLR044C",621).
component("YGR087C",436).
component("YDR380W",324).
component("YDL080C",244).
component("U98_",150).
component("YMR250W",698).
component("YKL184W",598).
component("YNR043W",751).
component("U93_",147).
component("YDR047W",283).
component("U54_",117).
component("YKL211C",600) :- not remove_orf("YKL211C",600).
component("YKR097W",612).
component("YOL052C",760).
component("YNL169C",723).
component("YGR170W",444).
component("YKL060C",582).
component("YNL256W",731).
component("YDR294C",312).
component("YEL046C",344).
component("YNR033W",748).
component("YPR006C",856).
component("YER065C",365).
component("YKL211C",601) :- not remove_orf("YKL211C",601).
component("YER090W",601) :- not remove_orf("YER090W",601).
component("YER090W",373) :- not remove_orf("YER090W",373).
component("YDR127W",295).
component("YPL281C",853).
component("YOR393W",818).
component("YMR323W",708).
component("YHR174W",495).
component("YGR254W",460).
component("YPL262W",845).
component("YGL026C",406) :- not remove_orf("YGL026C",406).
component("YGR155W",443).
component("YLR304C",647).
component("YJL200C",546).
component("YNL316C",740).
component("YKL182W",596).
component("YPL212C",837).
component("YNL292W",738).
component("YGL063W",411).
component("YFL001W",383).
component("YOR278W",802).
component("YPR002W",855).
component("U49_",111).
component("YDR127W",296).
component("YGL148W",416).
component("YER086W",370).
component("YLR359W",655).
component("YAL012W",153).
component("YFR055W",398).
component("YJL005W",525).
component("YOR176W",789).
component("YJL121C",533).
component("YBR019C",177).
component("YBR019C",178).
component("YDR050C",284).
component("YDR007W",274) :- not remove_orf("YDR007W",274).
component("YOR095C",780).
component("YER003C",349).
component("YBR196C",207).
component("YGL001C",400).
component("U14_",40).
component("YOL056W",763).
component("YKL152C",593).
component("YDL021W",236).
component("YMR105C",682).
component("YKL127W",587).
component("YEL058W",347).
component("YPR060C",861).
component("YHR072W",483).
component("YJL153C",540).
component("YPL097W",826).
component("YGR185C",450).
component("YGR264C",462).
component("YGR171C",445).
component("YHR011W",474).
component("YDR023W",277).
component("YPL104W",827).
component("YLL018C",614).
component("YPR081C",866).
component("YBR121C",195).
component("YHR020W",477).
component("YER087W",371).
component("YNL247W",727).
component("YOL033W",759).
component("YGL245W",423).
component("YHR091C",485).
component("YDR341C",318).
component("YOL097C",769).
component("YDR268W",309).
component("YPR047W",860).
component("YLR060W",623).
component("YFL022C",387).
component("YPR033C",858).
component("YHR019C",475).
component("YHR019C",476).
component("YPL160W",830).
component("YLR382C",657).
component("YNL073W",714).
component("YDR037W",279).
component("YOR335C",808).
component("YGR094W",438).
component("YOR317W",804).
component("YMR246W",697).
component("YIL009W",500).
component("YER015W",352).
component("YOR142W",785).
component("YGR244C",458).
component("YPR035W",859).
component("U89_",143).
component("YOR241W",800).
component("YMR113W",684).
component("YKL132C",588).
component("YJL101C",532).
component("U92_",146).
component("YGL234W",421).
component("U91_",145).
component("U90_",144).
component("YDL141W",256).
component("YDL141W",257).
component("YGL234W",422).
component("YDL141W",258).
component("YJR103W",561).
component("YBL039C",164).
component("YGR204W",454).
component("YBR084W",190).
component("YOL058W",764).
component("YBR208C",209).
component("YHR074W",484).
component("YMR217W",694).
component("YGR061C",435).
component("YPR145W",871).
component("YGR124W",441).
component("YOR303W",803).
component("YJR109C",564).
component("YJL130C",536).
component("YGL062W",410).
component("YBR218C",210).
component("YPL231W",843).
component("YNR016C",746).
component("YKL182W",597).
component("YGR037C",431).
component("YOR005C",776).
component("YDL164C",261).
component("YOL010W",756).
component("YPR138C",870).
component("YPL274W",850).
component("YPL265W",846).
component("YPL057C",824).
component("YPL036W",823).
component("YOR348C",812).
component("YOR192C",792).
component("YOR171C",788).
component("YOR130C",783).
component("YOR071C",779).
component("YOL156W",775).
component("YOL103W",770).
component("YOL020W",758) :- not remove_orf("YOL020W",758).
component("YNR072W",754).
component("YNR056C",752).
component("YNL318C",741).
component("YNL268W",734).
component("YNL142W",721).
component("YMR272C",701).
component("YMR011W",675).
component("YML123C",672).
component("YLR348C",652).
component("YLR260W",642).
component("YLR237W",640).
component("YLR138W",629).
component("YLR100C",626).
component("YLR081W",624).
component("YLL061W",617).
component("YLL043W",616).
component("YKR093W",611).
component("YKR053C",609).
component("YKR039W",608) :- not remove_orf("YKR039W",608).
component("YKL217W",603).
component("YKL004W",576).
component("YJR158W",573).
component("YJR152W",571).
component("YJR095W",560).
component("YJR077C",558).
component("YJL219W",548).
component("YJL214W",547).
component("YJL134W",537).
component("YJL129C",535).
component("YHR096C",488).
component("YHR094C",487).
component("YHR092C",486).
component("YHL036W",470).
component("YHL016C",468).
component("YGR121C",439).
component("YGR055W",433).
component("YGL186C",418).
component("YGL077C",413).
component("YGL008C",401).
component("YFL055W",390).
component("YFL011W",384).
component("YER060W-A",361).
component("YER060W",360).
component("YER056C",359).
component("YER053C",357).
component("YEL069C",348).
component("YEL017C-A",342).
component("YDR536W",341).
component("YDR508C",337).
component("YDR503C",336).
component("YDR497C",335).
component("YDR345C",321).
component("YDR343C",320).
component("YDR342C",319).
component("YDR297W",314).
component("YDR294C",313).
component("YDR284C",311).
component("YDR046C",282) :- not remove_orf("YDR046C",282).
component("YDL245C",273).
component("YDL210W",267).
component("YCR032W",232).
component("YCR024C-A",231).
component("YCL025C",224).
component("YBR298C",221).
component("YBR291C",220).
component("YBR069C",188) :- not remove_orf("YBR069C",188).
component("YBR068C",187) :- not remove_orf("YBR068C",187).
component("YBR036C",184).
component("YBR021W",180).
...
catalyst(6160,704).
catalyst(3870,358).
catalyst(3620,323) :- not remove_reaction(3620,323).
catalyst(2110,396).
catalyst(2190,396).
catalyst(5550,566).
catalyst(5791,638).
...
catalyst(1960,283).
catalyst(3460,117).
catalyst(3600,600) :- not remove_reaction(3600,600).
catalyst(8000,612).
catalyst(3941,760).
catalyst(3942,760).
catalyst(6890,723).
...
catalyst(8020,856).
catalyst(8020,365).
catalyst(1890,601) :- not remove_reaction(1890,601).
catalyst(3630,601) :- not remove_reaction(3630,601).
catalyst(1890,373) :- not remove_reaction(1890,373).
catalyst(3630,373) :- not remove_reaction(3630,373).
catalyst(3740,295).
catalyst(8231,853).
catalyst(8232,853).
catalyst(8231,818).
...
catalyst(8051,845).
catalyst(8052,845).
catalyst(3590,406) :- not remove_reaction(3590,406).
catalyst(10910,406) :- not remove_reaction(10910,406).
catalyst(4570,443).
catalyst(8181,647).
catalyst(8182,647).
catalyst(8181,546).
...
catalyst(8281,284).
catalyst(8282,284).
catalyst(3610,274) :- not remove_reaction(3610,274).
catalyst(7921,780).
catalyst(7922,780).
catalyst(7841,349).
catalyst(7842,349).
...
catalyst(941,758) :- not remove_reaction(941,758).
catalyst(942,758) :- not remove_reaction(942,758).
catalyst(1210,754).
catalyst(700,752).
catalyst(1200,741).
catalyst(761,734).
...
catalyst(640,611).
catalyst(6560,609).
catalyst(761,608) :- not remove_reaction(761,608).
catalyst(762,608) :- not remove_reaction(762,608).
catalyst(771,608) :- not remove_reaction(771,608).
catalyst(772,608) :- not remove_reaction(772,608).
catalyst(781,608) :- not remove_reaction(781,608).
catalyst(782,608) :- not remove_reaction(782,608).
catalyst(791,608) :- not remove_reaction(791,608).
catalyst(792,608) :- not remove_reaction(792,608).
catalyst(801,608) :- not remove_reaction(801,608).
catalyst(802,608) :- not remove_reaction(802,608).
catalyst(811,608) :- not remove_reaction(811,608).
catalyst(812,608) :- not remove_reaction(812,608).
catalyst(821,608) :- not remove_reaction(821,608).
catalyst(822,608) :- not remove_reaction(822,608).
catalyst(831,608) :- not remove_reaction(831,608).
catalyst(832,608) :- not remove_reaction(832,608).
catalyst(841,608) :- not remove_reaction(841,608).
catalyst(842,608) :- not remove_reaction(842,608).
catalyst(861,608) :- not remove_reaction(861,608).
catalyst(862,608) :- not remove_reaction(862,608).
catalyst(881,608) :- not remove_reaction(881,608).
catalyst(882,608) :- not remove_reaction(882,608).
catalyst(901,608) :- not remove_reaction(901,608).
catalyst(902,608) :- not remove_reaction(902,608).
catalyst(911,608) :- not remove_reaction(911,608).
catalyst(912,608) :- not remove_reaction(912,608).
catalyst(921,608) :- not remove_reaction(921,608).
catalyst(922,608) :- not remove_reaction(922,608).
catalyst(941,608) :- not remove_reaction(941,608).
catalyst(942,608) :- not remove_reaction(942,608).
catalyst(1191,608) :- not remove_reaction(1191,608).
catalyst(1192,608) :- not remove_reaction(1192,608).
catalyst(1021,603).
catalyst(1022,603).
catalyst(6610,576).
catalyst(1210,573).
...
catalyst(6550,313).
catalyst(6690,311).
catalyst(791,282) :- not remove_reaction(791,282).
catalyst(792,282) :- not remove_reaction(792,282).
...
catalyst(841,282) :- not remove_reaction(841,282).
catalyst(842,282) :- not remove_reaction(842,282).
catalyst(861,282) :- not remove_reaction(861,282).
catalyst(862,282) :- not remove_reaction(862,282).
catalyst(901,282) :- not remove_reaction(901,282).
catalyst(902,282) :- not remove_reaction(902,282).
catalyst(1210,273).
catalyst(690,267).
catalyst(730,267).
catalyst(431,232).
...
catalyst(1511,220).
catalyst(1512,220).
catalyst(771,188) :- not remove_reaction(771,188).
catalyst(772,188) :- not remove_reaction(772,188).
catalyst(791,188) :- not remove_reaction(791,188).
catalyst(792,188) :- not remove_reaction(792,188).
catalyst(801,188) :- not remove_reaction(801,188).
catalyst(802,188) :- not remove_reaction(802,188).
catalyst(811,188) :- not remove_reaction(811,188).
catalyst(812,188) :- not remove_reaction(812,188).
catalyst(861,188) :- not remove_reaction(861,188).
catalyst(862,188) :- not remove_reaction(862,188).
catalyst(901,188) :- not remove_reaction(901,188).
catalyst(902,188) :- not remove_reaction(902,188).
catalyst(791,187) :- not remove_reaction(791,187).
catalyst(792,187) :- not remove_reaction(792,187).
catalyst(801,187) :- not remove_reaction(801,187).
catalyst(802,187) :- not remove_reaction(802,187).
catalyst(811,187) :- not remove_reaction(811,187).
catalyst(812,187) :- not remove_reaction(812,187).
catalyst(831,187) :- not remove_reaction(831,187).
catalyst(832,187) :- not remove_reaction(832,187).
catalyst(841,187) :- not remove_reaction(841,187).
catalyst(842,187) :- not remove_reaction(842,187).
catalyst(861,187) :- not remove_reaction(861,187).
catalyst(862,187) :- not remove_reaction(862,187).
catalyst(901,187) :- not remove_reaction(901,187).
catalyst(902,187) :- not remove_reaction(902,187).
catalyst(6600,184).
catalyst(620,180).
catalyst(540,165).
catalyst(2830,135).
...
modifiable_enzyme(600).
modifiable_enzyme(601).
modifiable_enzyme(373).
modifiable_enzyme(406).
modifiable_enzyme(274).
modifiable_enzyme(758).
modifiable_enzyme(608).
modifiable_enzyme(282).
modifiable_enzyme(188).
modifiable_enzyme(187).
