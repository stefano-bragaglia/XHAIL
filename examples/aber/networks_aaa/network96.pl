...
component("YNL280C",554).
component("YGR060W",332).
component("YGL012W",307).
component("YOL086C",577).
component("YMR303C",530).
component("YGL256W",325).
component("YDL168W",203).
component("YBR145W",158).
component("YPL231W",629).
component("U46_",86).
component("YBR149W",159).
component("YJR159W",432).
component("YGL001C",304).
component("YIL094C",380).
component("YHR063C",363).
component("YBR153W",160).
component("YML056C",502).
component("YLR432W",498).
component("YHR216W",374).
component("YAR075W",128).
component("YAR073W",127).
component("YDR127W",225).
component("YJR139C",430).
component("YOL126C",581).
component("YDL078C",191).
component("YKL029C",435).
component("YOR136W",591).
component("YDL066W",190).
component("YLR355C",495).
component("YML086C",504).
component("YIL155C",385).
component("YPR191W",657).
component("YOR065W",586).
component("YJL166W",408).
component("YHR001W-A",358).
component("YGR183C",343).
component("YFR033C",300).
component("YDR529C",258).
component("YBL045C",134).
component("Q0105",18).
component("YGR088W",334).
component("YDR256C",239).
component("YJR078W",421).
component("YJR025C",415).
component("YGR255C",352).
component("YBL098W",137).
component("YMR015C",510).
component("YDR402C",250).
component("YGL055W",312).
component("YGR175C",340).
component("YJR104C",424).
component("YHR008C",359).
component("YJL026W",392).
component("YGR180C",342).
component("YER070W",278).
component("U35_",82).
component("YDL168W",204).
component("YDR158W",233).
component("YPL276W",638).
component("YPL275W",637).
component("YOR388C",615).
component("YOR374W",612).
component("YER073W",279).
component("YGL154C",318).
component("U55_",93).
component("YOR323C",604).
component("YMR170C",518).
component("YMR169C",517).
component("U2_",79).
component("YBR221C",168).
component("U52_",90).
component("YBR166C",163).
component("YNL280C",555).
component("YGL012W",308).
component("U57_",94).
component("YDR044W",216).
component("YER014W",267).
component("YKR009C",454).
component("YIL160C",387).
component("YGL205W",321).
component("YMR118C",515).
component("YLR164W",479).
component("YLL041C",462).
component("YKL148C",443).
component("YJL045W",393).
component("YDR178W",234).
component("YJR051W",417).
component("YEL047C",262).
component("YOR375C",613).
component("YDL215C",207).
component("YAL062W",125).
component("U99_",121).
component("YBR035C",146).
component("YHR037W",360).
component("YKR080W",458).
component("YER023W",268).
component("YOR236W",601).
component("YGR204W",345).
component("YLR142W",474).
component("U62_",97).
component("YKL150W",444).
component("YIL043C",376).
component("YHR042W",361).
component("YFR030W",299).
component("YPL017C",618).
component("YFL018C",291).
component("YER042W",270).
component("YJR137C",429).
component("YPL266W",635).
component("YML110C",506).
component("YBR034C",145).
component("YPL273W",636).
component("YLL062C",465).
component("U47_",87).
component("YER091C",282).
component("YJR073C",419).
component("YDL033C",188).
component("YOL096C",578).
component("YLR172C",480).
component("YDR019C",213).
component("YDR408C",252).
component("YBL013W",129).
component("YKL024C",434).
component("YPR074C",649).
component("YBR117C",155).
component("YLR354C",494).
component("YGR043C",330).
component("YCL009C",177).
component("YMR062C",512).
component("YNL071W",536).
component("YNR008W",562).
component("YPL231W",630).
component("YER061C",276).
component("U86_",112).
component("YPL001W",617).
component("YDR148C",231).
component("YOR377W",614).
component("YGR177C",341).
component("YPL231W",631).
component("YGR147C",337).
component("YDL040C",189).
component("YPL028W",619).
component("YGL017W",309).
component("YPR001W",640).
component("YNR001C",560).
component("YDL182W",205).
component("YDL131W",197).
component("YNL117W",539).
component("YIR031C",390).
component("YNL029C",533).
component("YIL085C",379).
component("YMR261C",525).
component("YML100W",505).
component("YBR126C",157).
component("YNL192W",546).
component("YBR038W",148).
component("YBR023C",144).
component("YLR209C",481).
component("U104_",21).
component("YOR209C",598).
component("YMR300C",529).
component("YER055C",272).
component("YDR354W",246) :- not remove_orf("YDR354W",246).
component("YFR047C",301).
component("YJR133W",428).
component("YLR209C",482).
component("YML022W",499).
component("YDR441C",254).
component("YDR399W",248).
component("YJL167W",409).
component("YNL256W",549).
component("YDR127W",226).
component("YLR303W",488).
component("YGR012W",327).
component("YJR130C",427).
component("YLR303W",489).
component("YDR035W",214).
component("YBR249C",169).
component("YOL143C",583).
component("YBR256C",170).
component("YHR137W",368).
component("YGL202W",320).
component("YLR027C",466).
component("YKL106W",439).
component("YKL104C",438).
component("YGR019W",328).
component("YLR089C",470).
component("U64_",98).
component("U61_",96).
component("U51_",89).
component("YJR148W",431).
component("YIL116W",383).
component("YGL253W",324).
component("YFR053C",302).
component("YOL136C",582).
component("YIL107C",381).
component("YMR205C",520).
component("YGR240C",348).
component("YDR248C",238).
component("YCR036W",185).
component("YCL040W",180).
component("YJR105W",425).
component("U16_",40).
component("U15_",37).
component("U96_",119).
component("YKL001C",433).
component("YML070W",503).
component("YFL053W",294).
component("YHL032C",356).
component("U83_",110).
component("U82_",109).
component("U81_",108).
component("YMR208W",521).
component("YOR347C",609).
component("YAL038W",124).
component("YNR012W",563).
component("YPR121W",652).
component("YPL258C",633).
component("YOL055C",574).
component("U1_",60).
component("YDR009W",212).
component("YBR020W",142).
component("YNL267W",552).
component("YLR305C",491).
component("YFR019W",297).
component("YDR208W",235).
component("YDR127W",227).
component("U21_",69).
component("U20_",67).
component("YDR147W",230).
component("YDR300C",243).
component("YCR012W",182).
component("U18_",53).
component("U17_",47).
component("U76_",106).
component("YER170W",288).
component("YDR226W",236).
component("YKL067W",437).
component("YDR454C",255).
component("YOL061W",576).
component("YKL181W",446).
component("YHL011C",354).
component("YER099C",284).
component("YBL068W",136).
component("YOR143C",592).
component("YBR018C",139).
component("YGR007W",326).
component("YLR328W",492).
component("YKR002W",453).
component("YDL103C",195).
component("YJR010W",414).
component("YCL050C",181).
component("YPR190C",656).
component("YPR187W",655).
component("YPR110C",651).
component("YPR010C",642).
component("YOR341W",608).
component("YOR340C",607).
component("YOR224C",600).
component("YOR210W",599).
component("YOR207C",596).
component("YOR151C",593).
component("YOR116C",589).
component("YOL005C",569).
component("YNR003C",561).
component("YNL248C",548).
component("YNL151C",543).
component("YNL113W",538).
component("YKL144C",442).
component("YJR063W",418).
component("YJL148W",405).
component("YJL140W",404).
component("YIL021W",375).
component("YHR143W-A",369).
component("YGL070C",315).
component("YFL036W",293).
component("YDR404C",251).
component("YDR156W",232).
component("YDR045C",217).
component("YDL150W",201).
component("YDL140C",198).
component("YBR154C",162).
component("YPR175W",654).
component("YPL167C",626).
component("YOR330C",605).
component("YOL115W",580).
component("YNL299W",557).
component("YNL262W",551).
component("YNL102W",537).
component("YJR043C",416).
component("YJR006W",413).
component("YJL090C",397).
component("YIL139C",384).
component("YEL055C",263).
component("YDR419W",253).
component("YDR121W",224).
component("YDL102W",194).
component("YCR014C",183).
component("YBR278W",172).
component("YBL035C",131).
component("YKL035W",436).
component("YHL012W",355).
component("YHR123W",367).
component("YDL142C",200).
component("YER026C",269).
component("YCL004W",176).
component("YJL068C",394).
component("YDR058C",221).
component("YNR034W",566).
component("YHR163W",371).
component("YGR248W",350).
component("YCR073W-A",186).
component("YDL086W",193).
component("YOL011W",571).
component("YMR008C",509).
component("YMR006C",508).
component("U101_",19).
component("YBL015W",130).
component("YJL068C",395).
component("YPL072W",622).
component("YOR124C",590).
component("YNL186W",545).
component("YMR304W",531).
component("YMR223W",523).
component("YKR098C",460).
component("YJL197W",410).
component("YIL156W",386).
component("YFR010W",296).
component("YER151C",286).
component("YER144C",285).
component("YER098W",283).
component("YDR069C",222).
component("YDL122W",196).
component("YBR058C",149).
component("YBL067C",135).
component("U84_",111).
component("YPR073C",647).
component("YHR215W",373).
component("YDL024C",187).
component("YBR093C",153).
component("YBR092C",152).
component("YAR071W",126).
component("YIL053W",378).
component("YER062C",277).
component("YHR046C",362).
component("YGR208W",347).
component("YPL228W",628).
component("YMR180C",519).
component("YDL236W",209).
component("YJL155C",407).
component("YPR073C",648).
component("YOR208W",597).
component("YNL053W",535).
component("YMR036C",511).
component("YIR026C",388).
component("YIL113W",382).
component("YFR028C",298).
component("YER075C",280).
component("YDL230W",208).
...
component("U25_",77).
component("U24_",76).
component("YOR360C",611).
component("YGL248W",323).
component("YKR031C",455).
component("YLR286C",486).
component("YOR190W",594).
component("YLR300W",487).
component("YGR282C",353).
component("YDR261C",240).
component("YDR400W",249).
component("U23_",75).
component("YML035C",500).
component("YJL070C",396).
component("YBR284W",173).
component("U102_",20).
component("YNL045W",534).
component("YLR160C",478).
component("YLR158C",477).
component("YLR157C",476).
component("YLR155C",475).
component("YDR321W",244).
component("YGL037C",311).
component("YDR242W",237).
component("YBR208C",165).
component("YMR281W",528).
component("U53_",91).
component("YIR032C",391).
component("YIR029W",389).
component("YPR062W",646).
component("YMR120C",516).
component("YHR144C",370).
component("YNL141W",540).
component("YBR153W",161).
component("YDL238C",210).
component("YNL141W",541).
component("YLR245C",485).
component("YML035C",501).
component("YJL126W",400).
component("U44_",85).
component("U87_",113).
component("YMR267W",526).
component("YBR011C",138).
component("YBR111C",154).
component("YCL030C",179).
component("YER005W",266).
component("YIL048W",377).
component("YER166W",287).
component("YDR093W",223).
component("YAL026C",123).
component("YLR231C",483).
component("U88_",114).
component("YLR134W",472).
component("YLR044C",467).
component("YGR087C",333).
component("YDR380W",247).
component("YDL080C",192).
component("U98_",120).
component("YMR250W",524).
component("YKL184W",449).
component("YNR043W",567).
component("U93_",118).
component("YDR047W",219).
component("U54_",92).
component("YKL211C",450) :- not remove_orf("YKL211C",450).
component("YNL169C",544).
component("YGR170W",339).
component("YNL256W",550).
component("YDR294C",241).
component("YEL046C",261).
component("YNR033W",565).
component("YKL211C",451) :- not remove_orf("YKL211C",451).
component("YER090W",451) :- not remove_orf("YER090W",451).
component("YER090W",281) :- not remove_orf("YER090W",281).
component("YDR127W",228).
component("YPL281C",639).
component("YOR393W",616).
component("YMR323W",532).
component("YHR174W",372).
component("YGR254W",351).
component("YGL026C",310) :- not remove_orf("YGL026C",310).
component("YGR155W",338).
component("YLR304C",490).
component("YJL200C",411).
component("YNL316C",558).
component("YKL182W",447).
component("YPL212C",627).
component("YNL292W",556).
component("YGL063W",314).
component("YFL001W",289).
component("YPR002W",641).
component("YDR127W",229).
component("YGL148W",317).
component("YLR359W",496).
component("YAL012W",122).
component("YFR055W",303).
component("YJL121C",399).
component("YBR019C",140).
component("YBR019C",141).
component("YDR050C",220).
component("YDR007W",211) :- not remove_orf("YDR007W",211).
component("YOR095C",588).
component("YER003C",265).
component("YBR196C",164).
component("YGL001C",305).
component("U14_",31).
component("YKL152C",445).
component("YMR105C",513).
component("YKL127W",440).
component("YEL058W",264).
component("YPR060C",645).
component("YHR072W",364).
component("YJL153C",406).
component("YPL097W",623).
component("YGR185C",344).
component("YPL104W",624).
component("YLL018C",461).
component("YPR081C",650).
component("YBR121C",156).
component("YNL247W",547).
component("YOL033W",573).
component("YHR091C",366).
component("YDR341C",245).
component("YOL097C",579).
component("YPR047W",644).
component("YLR060W",468).
component("YFL022C",292).
component("YPR033C",643).
component("YPL160W",625).
component("YLR382C",497).
component("YDR037W",215).
component("YOR335C",606).
component("YGR094W",335).
component("YGR244C",349).
component("U89_",115).
component("YOR241W",602).
component("YMR113W",514).
component("YKL132C",441).
component("YJL101C",398).
component("U92_",117).
component("YGL234W",322).
component("U91_",116).
component("YDL141W",199).
component("YJR103W",423).
component("YBL039C",132).
component("YGR204W",346).
component("YOL058W",575).
component("YBR208C",166).
component("YHR074W",365).
component("YMR217W",522).
component("YOR303W",603).
component("YJR109C",426).
component("YJL130C",402).
component("YGL062W",313).
component("YBR218C",167).
component("YPL231W",632).
component("YNR016C",564).
component("YKL182W",448).
component("YGR037C",329).
component("YOR005C",585).
component("YDL164C",202).
component("YOL010W",570).
component("YPR138C",653).
component("YPL265W",634).
component("YPL057C",621).
component("YPL036W",620).
component("YOR348C",610).
component("YOR192C",595).
component("YOR071C",587).
component("YOL156W",584).
component("YOL020W",572) :- not remove_orf("YOL020W",572).
component("YNR056C",568).
component("YNL318C",559).
component("YNL268W",553).
component("YNL142W",542).
component("YMR272C",527).
component("YML123C",507).
component("YLR348C",493).
component("YLR237W",484).
component("YLR138W",473).
component("YLR100C",471).
component("YLR081W",469).
component("YLL061W",464).
component("YLL043W",463).
component("YKR093W",459).
component("YKR053C",457).
component("YKR039W",456) :- not remove_orf("YKR039W",456).
component("YKL217W",452).
component("YJR095W",422).
component("YJR077C",420).
component("YJL219W",412).
component("YJL134W",403).
component("YJL129C",401).
component("YHL036W",357).
component("YGR121C",336).
component("YGR055W",331).
component("YGL186C",319).
component("YGL077C",316).
component("YGL008C",306).
component("YFL055W",295).
component("YFL011W",290).
component("YER060W-A",275).
component("YER060W",274).
component("YER056C",273).
component("YER053C",271).
component("YEL017C-A",260).
component("YDR536W",259).
component("YDR508C",257).
component("YDR503C",256).
component("YDR294C",242).
component("YDR046C",218) :- not remove_orf("YDR046C",218).
component("YDL210W",206).
...
catalyst(6160,529).
catalyst(3870,272).
catalyst(3620,246) :- not remove_reaction(3620,246).
catalyst(2110,301).
catalyst(2190,301).
catalyst(5550,428).
catalyst(5791,482).
...
catalyst(1960,219).
catalyst(3460,92).
catalyst(3600,450) :- not remove_reaction(3600,450).
catalyst(6890,544).
catalyst(6900,339).
catalyst(2570,550).
catalyst(8781,241).
...
catalyst(1890,281) :- not remove_reaction(1890,281).
catalyst(3630,281) :- not remove_reaction(3630,281).
catalyst(3740,228).
catalyst(8231,639).
catalyst(8232,639).
catalyst(8231,616).
...
catalyst(8231,351).
catalyst(8232,351).
catalyst(3590,310) :- not remove_reaction(3590,310).
catalyst(10910,310) :- not remove_reaction(10910,310).
catalyst(4570,338).
catalyst(8181,490).
catalyst(8182,490).
catalyst(8181,411).
...
catalyst(8281,220).
catalyst(8282,220).
catalyst(3610,211) :- not remove_reaction(3610,211).
catalyst(7921,588).
catalyst(7922,588).
catalyst(7841,265).
catalyst(7842,265).
...
catalyst(190,587).
catalyst(1200,584).
catalyst(801,572) :- not remove_reaction(801,572).
catalyst(802,572) :- not remove_reaction(802,572).
catalyst(811,572) :- not remove_reaction(811,572).
catalyst(812,572) :- not remove_reaction(812,572).
catalyst(831,572) :- not remove_reaction(831,572).
catalyst(832,572) :- not remove_reaction(832,572).
catalyst(941,572) :- not remove_reaction(941,572).
catalyst(942,572) :- not remove_reaction(942,572).
catalyst(700,568).
catalyst(1200,559).
catalyst(761,553).
catalyst(762,553).
...
catalyst(640,459).
catalyst(6560,457).
catalyst(761,456) :- not remove_reaction(761,456).
catalyst(762,456) :- not remove_reaction(762,456).
catalyst(771,456) :- not remove_reaction(771,456).
catalyst(772,456) :- not remove_reaction(772,456).
catalyst(781,456) :- not remove_reaction(781,456).
catalyst(782,456) :- not remove_reaction(782,456).
catalyst(791,456) :- not remove_reaction(791,456).
catalyst(792,456) :- not remove_reaction(792,456).
catalyst(801,456) :- not remove_reaction(801,456).
catalyst(802,456) :- not remove_reaction(802,456).
catalyst(811,456) :- not remove_reaction(811,456).
catalyst(812,456) :- not remove_reaction(812,456).
catalyst(821,456) :- not remove_reaction(821,456).
catalyst(822,456) :- not remove_reaction(822,456).
catalyst(831,456) :- not remove_reaction(831,456).
catalyst(832,456) :- not remove_reaction(832,456).
catalyst(841,456) :- not remove_reaction(841,456).
catalyst(842,456) :- not remove_reaction(842,456).
catalyst(861,456) :- not remove_reaction(861,456).
catalyst(862,456) :- not remove_reaction(862,456).
catalyst(881,456) :- not remove_reaction(881,456).
catalyst(882,456) :- not remove_reaction(882,456).
catalyst(911,456) :- not remove_reaction(911,456).
catalyst(912,456) :- not remove_reaction(912,456).
catalyst(941,456) :- not remove_reaction(941,456).
catalyst(942,456) :- not remove_reaction(942,456).
catalyst(1191,456) :- not remove_reaction(1191,456).
catalyst(1192,456) :- not remove_reaction(1192,456).
catalyst(1021,452).
catalyst(1022,452).
catalyst(1250,422).
catalyst(1581,420).
...
catalyst(6680,256).
catalyst(6550,242).
catalyst(791,218) :- not remove_reaction(791,218).
catalyst(792,218) :- not remove_reaction(792,218).
catalyst(801,218) :- not remove_reaction(801,218).
catalyst(802,218) :- not remove_reaction(802,218).
catalyst(811,218) :- not remove_reaction(811,218).
catalyst(812,218) :- not remove_reaction(812,218).
catalyst(831,218) :- not remove_reaction(831,218).
catalyst(832,218) :- not remove_reaction(832,218).
catalyst(841,218) :- not remove_reaction(841,218).
catalyst(842,218) :- not remove_reaction(842,218).
catalyst(861,218) :- not remove_reaction(861,218).
catalyst(862,218) :- not remove_reaction(862,218).
catalyst(730,206).
catalyst(220,184).
catalyst(771,178).
catalyst(772,178).
