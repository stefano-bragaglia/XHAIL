...
component("YNL280C",550).
component("YGR060W",331).
component("YGL012W",306).
component("YOL086C",573).
component("YMR303C",527).
component("YGL256W",324).
component("YDL168W",202).
component("YBR145W",157).
component("YPL231W",625).
component("U46_",85).
component("YBR149W",158).
component("YGL001C",303).
component("YIL094C",379).
component("YHR063C",362).
component("YBR153W",159).
component("YML056C",499).
component("YLR432W",495).
component("YHR216W",373).
component("YAR075W",127).
component("YAR073W",126).
component("YDR127W",224).
component("YJR139C",428).
component("YOL126C",577).
component("YDL078C",190).
component("YKL029C",432).
component("YOR136W",587).
component("YDL066W",189).
component("YLR355C",492).
component("YML086C",501).
component("YIL155C",383).
component("YPR191W",653).
component("YOR065W",582).
component("YJL166W",406).
component("YHR001W-A",357).
component("YGR183C",342).
component("YFR033C",299).
component("YDR529C",257).
component("YBL045C",133).
component("Q0105",18).
component("YGR088W",333).
component("YDR256C",238).
component("YJR078W",419).
component("YJR025C",413).
component("YGR255C",351).
component("YBL098W",136).
component("YMR015C",507).
component("YDR402C",249).
component("YGL055W",311).
component("YGR175C",339).
component("YJR104C",422).
component("YHR008C",358).
component("YJL026W",390).
component("YGR180C",341).
component("YER070W",277).
component("U35_",81).
component("YDL168W",203).
component("YDR158W",232).
component("YPL276W",634).
component("YPL275W",633).
component("YOR388C",611).
component("YOR374W",608).
component("YER073W",278).
component("YGL154C",317).
component("U55_",92).
component("YOR323C",600).
component("YMR170C",515).
component("YMR169C",514).
component("U2_",78).
component("YBR221C",167).
component("U52_",89).
component("YBR166C",162).
component("YNL280C",551).
component("YGL012W",307).
component("U57_",93).
component("YDR044W",215).
component("YER014W",266).
component("YKR009C",451).
component("YIL160C",385).
component("YGL205W",320).
component("YMR118C",512).
component("YLR164W",476).
component("YLL041C",459).
component("YKL148C",440).
component("YJL045W",391).
component("YDR178W",233).
component("YJR051W",415).
component("YEL047C",261).
component("YOR375C",609).
component("YDL215C",206).
component("YAL062W",124).
component("U99_",120).
component("YBR035C",145).
component("YHR037W",359).
component("YKR080W",455).
component("YER023W",267).
component("YOR236W",597).
component("YGR204W",344).
component("YLR142W",471).
component("U62_",96).
component("YKL150W",441).
component("YIL043C",375).
component("YHR042W",360).
component("YFR030W",298).
component("YPL017C",614).
component("YFL018C",290).
component("YER042W",269).
component("YJR137C",427).
component("YPL266W",631).
component("YML110C",503).
component("YBR034C",144).
component("YPL273W",632).
component("YLL062C",462).
component("U47_",86).
component("YER091C",281).
component("YJR073C",417).
component("YDL033C",187).
component("YOL096C",574).
component("YLR172C",477).
component("YDR019C",212).
component("YDR408C",251).
component("YBL013W",128).
component("YKL024C",431).
component("YPR074C",645).
component("YBR117C",154).
component("YLR354C",491).
component("YGR043C",329).
component("YCL009C",176).
component("YMR062C",509).
component("YNL071W",533).
component("YNR008W",558).
component("YPL231W",626).
component("YER061C",275).
component("U86_",111).
component("YPL001W",613).
component("YDR148C",230).
component("YOR377W",610).
component("YGR177C",340).
component("YPL231W",627).
component("YGR147C",336).
component("YDL040C",188).
component("YPL028W",615).
component("YGL017W",308).
component("YPR001W",636).
component("YNR001C",556).
component("YDL182W",204).
component("YDL131W",196).
component("YNL117W",536).
component("YIR031C",388).
component("YNL029C",530).
component("YIL085C",378).
component("YMR261C",522).
component("YML100W",502).
component("YBR126C",156).
component("YNL192W",543).
component("YBR038W",147).
component("YBR023C",143).
component("YLR209C",478).
component("U104_",21).
component("YOR209C",594).
component("YMR300C",526).
component("YER055C",271).
component("YDR354W",245) :- not remove_orf("YDR354W",245).
component("YFR047C",300).
component("YJR133W",426).
component("YLR209C",479).
component("YML022W",496).
component("YDR441C",253).
component("YDR399W",247).
component("YJL167W",407).
component("YNL256W",546).
component("YDR127W",225).
component("YLR303W",485).
component("YGR012W",326).
component("YJR130C",425).
component("YLR303W",486).
component("YDR035W",213).
component("YBR249C",168).
component("YOL143C",579).
component("YBR256C",169).
component("YHR137W",367).
component("YGL202W",319).
component("YLR027C",463).
component("YKL106W",436).
component("YKL104C",435).
component("YGR019W",327).
component("YLR089C",467).
component("U64_",97).
component("U61_",95).
component("U51_",88).
component("YJR148W",429).
component("YGL253W",323).
component("YFR053C",301).
component("YOL136C",578).
component("YIL107C",380).
component("YMR205C",517).
component("YGR240C",347).
component("YDR248C",237).
component("YCR036W",184).
component("YCL040W",179).
component("YJR105W",423).
component("U16_",39).
component("U15_",36).
component("U96_",118).
component("YKL001C",430).
component("YML070W",500).
component("YFL053W",293).
component("YHL032C",355).
component("U83_",109).
component("U82_",108).
component("U81_",107).
component("YMR208W",518).
component("YOR347C",605).
component("YAL038W",123).
component("YNR012W",559).
component("YPR121W",648).
component("YPL258C",629).
component("YOL055C",570).
component("U1_",59).
component("YDR009W",211).
component("YBR020W",141).
component("YNL267W",548).
component("YLR305C",488).
component("YFR019W",296).
component("YDR208W",234).
component("YDR127W",226).
component("U21_",68).
component("U20_",66).
component("YDR147W",229).
component("YDR300C",242).
component("YCR012W",181).
component("U18_",52).
component("U17_",46).
component("U76_",105).
component("YER170W",287).
component("YDR226W",235).
component("YKL067W",434).
component("YDR454C",254).
component("YOL061W",572).
component("YKL181W",443).
component("YHL011C",353).
component("YER099C",283).
component("YBL068W",135).
component("YOR143C",588).
component("YBR018C",138).
component("YGR007W",325).
component("YLR328W",489).
component("YKR002W",450).
component("YDL103C",194).
component("YJR010W",412).
component("YCL050C",180).
component("YPR190C",652).
component("YPR187W",651).
component("YPR110C",647).
component("YPR010C",638).
component("YOR341W",604).
component("YOR340C",603).
component("YOR224C",596).
component("YOR210W",595).
component("YOR207C",592).
component("YOR151C",589).
component("YOR116C",585).
component("YOL005C",565).
component("YNR003C",557).
component("YNL248C",545).
component("YNL151C",540).
component("YNL113W",535).
component("YKL144C",439).
component("YJR063W",416).
component("YJL148W",403).
component("YJL140W",402).
component("YIL021W",374).
component("YHR143W-A",368).
component("YGL070C",314).
component("YFL036W",292).
component("YDR404C",250).
component("YDR156W",231).
component("YDR045C",216).
component("YDL150W",200).
component("YDL140C",197).
component("YBR154C",161).
component("YPR175W",650).
component("YPL167C",622).
component("YOR330C",601).
component("YOL115W",576).
component("YNL299W",553).
component("YNL262W",547).
component("YNL102W",534).
component("YJR043C",414).
component("YJR006W",411).
component("YJL090C",395).
component("YIL139C",382).
component("YEL055C",262).
component("YDR419W",252).
component("YDR121W",223).
component("YDL102W",193).
component("YCR014C",182).
component("YBR278W",171).
component("YBL035C",130).
component("YKL035W",433).
component("YHL012W",354).
component("YHR123W",366).
component("YDL142C",199).
component("YER026C",268).
component("YCL004W",175).
component("YJL068C",392).
component("YDR058C",220).
component("YNR034W",562).
component("YHR163W",370).
component("YGR248W",349).
component("YCR073W-A",185).
component("YDL086W",192).
component("YOL011W",567).
component("YMR008C",506).
component("YMR006C",505).
component("U101_",19).
component("YBL015W",129).
component("YJL068C",393).
component("YPL072W",618).
component("YOR124C",586).
component("YNL186W",542).
component("YMR304W",528).
component("YMR223W",520).
component("YKR098C",457).
component("YJL197W",408).
component("YIL156W",384).
component("YFR010W",295).
component("YER151C",285).
component("YER144C",284).
component("YER098W",282).
component("YDR069C",221).
component("YDL122W",195).
component("YBR058C",148).
component("YBL067C",134).
component("U84_",110).
component("YPR073C",643).
component("YHR215W",372).
component("YDL024C",186).
component("YBR093C",152).
component("YBR092C",151).
component("YAR071W",125).
component("YIL053W",377).
component("YER062C",276).
component("YHR046C",361).
component("YGR208W",346).
component("YPL228W",624).
component("YMR180C",516).
component("YDL236W",208).
component("YJL155C",405).
component("YPR073C",644).
component("YOR208W",593).
component("YNL053W",532).
component("YMR036C",508).
component("YIR026C",386).
component("YIL113W",381).
component("YFR028C",297).
component("YER075C",279).
component("YDL230W",207).
component("YBR276C",170).
component("U34_",80).
component("U30_",79).
component("U27_",77).
component("U25_",76).
component("U24_",75).
component("YOR360C",607).
component("YGL248W",322).
component("YKR031C",452).
component("YLR286C",483).
component("YOR190W",590).
component("YLR300W",484).
component("YGR282C",352).
component("YDR261C",239).
component("YDR400W",248).
component("U23_",74).
component("YML035C",497).
component("YJL070C",394).
component("YBR284W",172).
component("U102_",20).
component("YNL045W",531).
component("YLR160C",475).
component("YLR158C",474).
component("YLR157C",473).
component("YLR155C",472).
component("YDR321W",243).
component("YGL037C",310).
component("YDR242W",236).
component("YBR208C",164).
component("YMR281W",525).
component("U53_",90).
component("YIR032C",389).
component("YIR029W",387).
component("YPR062W",642).
component("YMR120C",513).
component("YHR144C",369).
component("YNL141W",537).
component("YBR153W",160).
component("YDL238C",209).
component("YNL141W",538).
component("YLR245C",482).
component("YML035C",498).
component("YJL126W",398).
component("U44_",84).
component("U87_",112).
component("YMR267W",523).
component("YBR011C",137).
component("YBR111C",153).
component("YCL030C",178).
component("YER005W",265).
component("YIL048W",376).
component("YER166W",286).
component("YDR093W",222).
component("YAL026C",122).
component("YLR231C",480).
component("U88_",113).
component("YLR134W",469).
component("YLR044C",464).
component("YGR087C",332).
component("YDR380W",246).
component("YDL080C",191).
component("U98_",119).
component("YMR250W",521).
component("YKL184W",446).
component("YNR043W",563).
component("U93_",117).
component("YDR047W",218).
component("U54_",91).
component("YKL211C",447) :- not remove_orf("YKL211C",447).
component("YNL169C",541).
component("YGR170W",338).
component("YDR294C",240).
component("YEL046C",260).
component("YNR033W",561).
component("YKL211C",448) :- not remove_orf("YKL211C",448).
component("YER090W",448) :- not remove_orf("YER090W",448).
component("YER090W",280) :- not remove_orf("YER090W",280).
component("YDR127W",227).
component("YPL281C",635).
component("YOR393W",612).
component("YMR323W",529).
component("YHR174W",371).
component("YGR254W",350).
component("YGL026C",309) :- not remove_orf("YGL026C",309).
component("YGR155W",337).
component("YLR304C",487).
component("YJL200C",409).
component("YNL316C",554).
component("YKL182W",444).
component("YPL212C",623).
component("YNL292W",552).
component("YGL063W",313).
component("YFL001W",288).
component("YPR002W",637).
component("YDR127W",228).
component("YGL148W",316).
component("YLR359W",493).
component("YAL012W",121).
component("YFR055W",302).
component("YJL121C",397).
component("YBR019C",139).
component("YBR019C",140).
component("YDR050C",219).
component("YDR007W",210) :- not remove_orf("YDR007W",210).
component("YOR095C",584).
component("YER003C",264).
component("YBR196C",163).
component("YGL001C",304).
component("U14_",31).
component("YKL152C",442).
component("YMR105C",510).
component("YKL127W",437).
component("YEL058W",263).
component("YPR060C",641).
component("YHR072W",363).
component("YJL153C",404).
component("YPL097W",619).
component("YGR185C",343).
component("YPL104W",620).
component("YLL018C",458).
component("YPR081C",646).
component("YBR121C",155).
component("YNL247W",544).
component("YOL033W",569).
component("YHR091C",365).
component("YDR341C",244).
component("YOL097C",575).
component("YPR047W",640).
component("YLR060W",465).
component("YFL022C",291).
component("YPR033C",639).
component("YPL160W",621).
component("YLR382C",494).
component("YDR037W",214).
component("YOR335C",602).
component("YGR094W",334).
component("YGR244C",348).
component("U89_",114).
component("YOR241W",598).
component("YMR113W",511).
component("YKL132C",438).
component("YJL101C",396).
component("U92_",116).
component("YGL234W",321).
component("U91_",115).
component("YDL141W",198).
component("YJR103W",421).
component("YBL039C",131).
component("YGR204W",345).
component("YOL058W",571).
component("YBR208C",165).
component("YHR074W",364).
component("YMR217W",519).
component("YOR303W",599).
component("YJR109C",424).
component("YJL130C",400).
component("YGL062W",312).
component("YBR218C",166).
component("YPL231W",628).
component("YNR016C",560).
component("YKL182W",445).
component("YGR037C",328).
component("YOR005C",581).
component("YDL164C",201).
component("YOL010W",566).
component("YPR138C",649).
component("YPL265W",630).
component("YPL057C",617).
component("YPL036W",616).
component("YOR348C",606).
component("YOR192C",591).
component("YOR071C",583).
component("YOL156W",580).
component("YOL020W",568) :- not remove_orf("YOL020W",568).
component("YNR056C",564).
component("YNL318C",555).
component("YNL268W",549).
component("YNL142W",539).
component("YMR272C",524).
component("YML123C",504).
component("YLR348C",490).
component("YLR237W",481).
component("YLR138W",470).
component("YLR100C",468).
component("YLR081W",466).
component("YLL061W",461).
component("YLL043W",460).
component("YKR093W",456).
component("YKR053C",454).
component("YKR039W",453) :- not remove_orf("YKR039W",453).
component("YKL217W",449).
component("YJR095W",420).
component("YJR077C",418).
component("YJL219W",410).
component("YJL134W",401).
component("YJL129C",399).
component("YHL036W",356).
component("YGR121C",335).
component("YGR055W",330).
component("YGL186C",318).
component("YGL077C",315).
component("YGL008C",305).
component("YFL055W",294).
component("YFL011W",289).
component("YER060W-A",274).
component("YER060W",273).
component("YER056C",272).
component("YER053C",270).
component("YEL017C-A",259).
component("YDR536W",258).
component("YDR508C",256).
component("YDR503C",255).
component("YDR294C",241).
component("YDR046C",217) :- not remove_orf("YDR046C",217).
component("YDL210W",205).
component("YCR024C-A",183).
component("YCL025C",177).
component("YBR298C",174).
component("YBR291C",173).
component("YBR069C",150) :- not remove_orf("YBR069C",150).
component("YBR068C",149) :- not remove_orf("YBR068C",149).
component("YBR036C",146).
component("YBR021W",142).
component("YBL042C",132).
component("U79_",106).
component("U75_",104).
component("U74_",103).
component("U73_",102).
...
catalyst(6160,526).
catalyst(3870,271).
catalyst(3620,245) :- not remove_reaction(3620,245).
catalyst(2110,300).
catalyst(2190,300).
catalyst(5550,426).
catalyst(5791,479).
...
catalyst(1960,218).
catalyst(3460,91).
catalyst(3600,447) :- not remove_reaction(3600,447).
catalyst(6890,541).
catalyst(6900,338).
catalyst(8781,240).
catalyst(8782,240).
catalyst(4560,260).
catalyst(2550,561).
catalyst(3630,448) :- not remove_reaction(3630,448).
catalyst(3630,280) :- not remove_reaction(3630,280).
catalyst(3740,227).
catalyst(8231,635).
catalyst(8232,635).
catalyst(8231,612).
...
catalyst(8231,350).
catalyst(8232,350).
catalyst(3590,309) :- not remove_reaction(3590,309).
catalyst(10910,309) :- not remove_reaction(10910,309).
catalyst(4570,337).
catalyst(8181,487).
catalyst(8182,487).
catalyst(8181,409).
...
catalyst(8281,219).
catalyst(8282,219).
catalyst(3610,210) :- not remove_reaction(3610,210).
catalyst(7921,584).
catalyst(7922,584).
catalyst(7841,264).
catalyst(7842,264).
...
catalyst(190,583).
catalyst(1200,580).
catalyst(801,568) :- not remove_reaction(801,568).
catalyst(802,568) :- not remove_reaction(802,568).
catalyst(811,568) :- not remove_reaction(811,568).
catalyst(812,568) :- not remove_reaction(812,568).
catalyst(831,568) :- not remove_reaction(831,568).
catalyst(832,568) :- not remove_reaction(832,568).
catalyst(941,568) :- not remove_reaction(941,568).
catalyst(942,568) :- not remove_reaction(942,568).
catalyst(700,564).
catalyst(1200,555).
catalyst(761,549).
catalyst(762,549).
...
catalyst(640,456).
catalyst(6560,454).
catalyst(761,453) :- not remove_reaction(761,453).
catalyst(762,453) :- not remove_reaction(762,453).
catalyst(771,453) :- not remove_reaction(771,453).
catalyst(772,453) :- not remove_reaction(772,453).
catalyst(781,453) :- not remove_reaction(781,453).
catalyst(782,453) :- not remove_reaction(782,453).
catalyst(791,453) :- not remove_reaction(791,453).
catalyst(792,453) :- not remove_reaction(792,453).
catalyst(801,453) :- not remove_reaction(801,453).
catalyst(802,453) :- not remove_reaction(802,453).
catalyst(811,453) :- not remove_reaction(811,453).
catalyst(812,453) :- not remove_reaction(812,453).
catalyst(821,453) :- not remove_reaction(821,453).
catalyst(822,453) :- not remove_reaction(822,453).
catalyst(831,453) :- not remove_reaction(831,453).
catalyst(832,453) :- not remove_reaction(832,453).
catalyst(841,453) :- not remove_reaction(841,453).
catalyst(842,453) :- not remove_reaction(842,453).
catalyst(861,453) :- not remove_reaction(861,453).
catalyst(862,453) :- not remove_reaction(862,453).
catalyst(881,453) :- not remove_reaction(881,453).
catalyst(882,453) :- not remove_reaction(882,453).
catalyst(911,453) :- not remove_reaction(911,453).
catalyst(912,453) :- not remove_reaction(912,453).
catalyst(941,453) :- not remove_reaction(941,453).
catalyst(942,453) :- not remove_reaction(942,453).
catalyst(1191,453) :- not remove_reaction(1191,453).
catalyst(1192,453) :- not remove_reaction(1192,453).
catalyst(1021,449).
catalyst(1022,449).
catalyst(1250,420).
catalyst(1581,418).
...
catalyst(831,217) :- not remove_reaction(831,217).
catalyst(832,217) :- not remove_reaction(832,217).
catalyst(841,217) :- not remove_reaction(841,217).
catalyst(842,217) :- not remove_reaction(842,217).
...
catalyst(1511,173).
catalyst(1512,173).
catalyst(771,150) :- not remove_reaction(771,150).
catalyst(772,150) :- not remove_reaction(772,150).
...
catalyst(791,149) :- not remove_reaction(791,149).
catalyst(792,149) :- not remove_reaction(792,149).
...
catalyst(861,149) :- not remove_reaction(861,149).
catalyst(862,149) :- not remove_reaction(862,149).
catalyst(6600,146).
catalyst(620,142).
catalyst(540,132).
catalyst(2830,106).
