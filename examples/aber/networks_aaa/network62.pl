...
component("YGR060W",247).
component("YGL012W",231).
component("YOL086C",422).
component("YMR303C",389).
component("YGL256W",242).
component("YDL168W",148).
component("YBR145W",114).
component("YPL231W",465).
component("YBR149W",115).
component("YGL001C",228).
component("YHR063C",269).
component("YML056C",368).
component("YLR432W",364).
component("YHR216W",277).
component("YAR075W",96).
component("YAR073W",95).
component("YDR127W",164).
component("YJR139C",317).
component("YOR136W",432).
component("YDL066W",140).
component("YML086C",370).
component("YIL155C",285).
component("YPR191W",488).
component("YOR065W",427).
component("YJL166W",301).
component("YHR001W-A",266).
component("YGR183C",255).
component("YFR033C",224).
component("YDR529C",192).
component("YBL045C",100).
component("Q0105",18).
component("YJR078W",310).
component("YJR025C",305).
component("YBL098W",103).
component("YMR015C",374).
component("YDR402C",184).
component("YJR104C",313).
component("YHR008C",267).
component("YER070W",207).
component("U35_",59).
component("YDL168W",149).
component("YPL276W",473).
component("YPL275W",472).
component("YOR388C",454).
component("YGL154C",238).
component("U55_",66).
component("YOR323C",444).
component("YMR170C",382).
component("YMR169C",381).
component("U2_",56).
component("YBR166C",118).
component("YNL280C",407).
component("YER014W",199).
component("YMR118C",379).
component("YLR164W",350).
component("YLL041C",343).
component("YKL148C",327).
component("YJL045W",290).
component("YDR178W",171).
component("YJR051W",307).
component("YEL047C",196).
component("YOR375C",452).
component("YDL215C",151).
component("YAL062W",93).
component("U99_",89).
component("YBR035C",106).
component("YKR080W",340).
component("YER023W",200).
component("YOR236W",441).
component("YGR204W",256).
component("U62_",68).
component("YKL150W",328).
component("YIL043C",279).
component("YHR042W",268).
component("YPL017C",457).
component("YFL018C",217).
component("YPL273W",471).
component("YLL062C",345).
component("U47_",61).
component("YDL033C",138).
component("YOL096C",423).
component("YDR408C",186).
component("YKL024C",320).
component("YPR074C",481).
component("YBR117C",113).
component("YCL009C",129).
component("YMR062C",376).
component("YPL231W",466).
component("U86_",82).
component("YPL001W",456).
component("YOR377W",453).
component("YGR177C",254).
component("YPL231W",467).
component("YGR147C",251).
component("YDL040C",139).
component("YPL028W",458).
component("YPR001W",475).
component("YNR001C",411).
component("YDL182W",150).
component("YNL117W",397).
component("YIR031C",288).
component("YNL029C",392).
component("YIL085C",282).
component("YLR209C",351).
component("YMR300C",388).
component("YER055C",202).
component("YDR354W",180) :- not remove_orf("YDR354W",180).
component("YFR047C",225).
component("YJR133W",316).
component("YLR209C",352).
component("YML022W",365).
component("YDR441C",188).
component("YDR399W",182).
component("YNL256W",403).
component("YDR127W",165).
component("YLR303W",358).
component("YJR130C",315).
component("YLR303W",359).
component("YDR035W",156).
component("YBR249C",122).
component("YBR256C",123).
component("YHR137W",272).
component("YGL202W",240).
component("YLR027C",346).
component("YKL106W",323).
component("YKL104C",322).
component("YGR019W",244).
component("U64_",69).
component("U51_",63).
component("YJR148W",318).
component("YGL253W",241).
component("YFR053C",226).
component("YMR205C",384).
component("YGR240C",258).
component("YDR248C",175).
component("YCR036W",136).
component("YCL040W",131).
component("YJR105W",314).
component("U16_",34).
component("U15_",31).
component("U96_",87).
component("YKL001C",319).
component("YML070W",369).
component("YFL053W",219).
component("YHL032C",264).
component("U83_",80).
component("U82_",79).
component("YMR208W",385).
component("YOR347C",449).
component("YAL038W",92).
component("YPR121W",483).
component("YPL258C",469).
component("YOL055C",419).
component("U1_",43).
component("YNL267W",405).
component("YLR305C",361).
component("YFR019W",222).
component("YDR208W",172).
component("YDR127W",166).
component("U21_",49).
component("U20_",47).
component("YDR147W",169).
component("YDR300C",178).
component("YCR012W",133).
component("U18_",40).
component("U76_",77).
component("YER170W",215).
component("YDR226W",173).
component("YDR454C",189).
component("YOL061W",421).
component("YKL181W",330).
component("YHL011C",262).
component("YER099C",211).
component("YBL068W",102).
component("YOR143C",433).
component("YGR007W",243).
component("YLR328W",362).
component("YCL050C",132).
component("YPR190C",487).
component("YPR187W",486).
component("YPR110C",482).
component("YPR010C",477).
component("YOR341W",448).
component("YOR340C",447).
component("YOR224C",440).
component("YOR210W",439).
component("YOR207C",437).
component("YOR151C",434).
component("YOR116C",430).
component("YOL005C",416).
component("YNR003C",412).
component("YNL248C",402).
component("YNL151C",400).
component("YNL113W",396).
component("YKL144C",326).
component("YJR063W",308).
component("YJL148W",299).
component("YJL140W",298).
component("YIL021W",278).
component("YHR143W-A",273).
component("YGL070C",236).
component("YFL036W",218).
component("YDR404C",185).
component("YDR156W",170).
component("YDR045C",157).
component("YDL150W",146).
component("YDL140C",145).
component("YBR154C",117).
component("YPR175W",485).
component("YPL167C",462).
component("YOR330C",445).
component("YOL115W",425).
component("YNL299W",409).
component("YNL262W",404).
component("YNL102W",395).
component("YJR043C",306).
component("YJR006W",304).
component("YJL090C",293).
component("YIL139C",284).
component("YEL055C",197).
component("YDR419W",187).
component("YDR121W",163).
component("YDL102W",143).
component("YCR014C",134).
component("YBR278W",125).
component("YBL035C",98).
component("YKL035W",321).
component("YHL012W",263).
component("YER026C",201).
component("YDR058C",160).
component("YDL086W",142).
component("YOL011W",417).
component("YMR008C",373).
component("YMR006C",372).
component("U101_",19).
component("YBL015W",97).
component("YJL068C",291).
component("YPL072W",460).
component("YOR124C",431).
component("YNL186W",401).
component("YMR304W",390).
component("YMR223W",386).
component("YKR098C",341).
component("YJL197W",302).
component("YIL156W",286).
component("YFR010W",221).
component("YER151C",213).
component("YER144C",212).
component("YER098W",210).
component("YDR069C",161).
component("YDL122W",144).
component("YBR058C",107).
component("YBL067C",101).
component("U84_",81).
component("YPR073C",479).
component("YHR215W",276).
component("YDL024C",137).
component("YBR093C",111).
component("YBR092C",110).
component("YAR071W",94).
component("YIL053W",281).
component("YER062C",206).
component("YGR208W",257).
component("YPL228W",464).
component("YMR180C",383).
component("YDL236W",153).
component("YJL155C",300).
component("YPR073C",480).
component("YOR208W",438).
component("YNL053W",394).
component("YMR036C",375).
component("YIR026C",287).
component("YIL113W",283).
component("YFR028C",223).
component("YER075C",208).
...
component("U25_",55).
component("U24_",54).
component("YOR360C",451).
component("YKR031C",337).
component("YLR286C",356).
component("YOR190W",435).
component("YLR300W",357).
component("YGR282C",261).
component("YDR261C",176).
component("YDR400W",183).
component("U23_",53).
component("YML035C",366).
component("YJL070C",292).
component("YBR284W",126).
component("U102_",20).
component("YNL045W",393).
component("YGL037C",233).
component("YDR242W",174).
component("YBR208C",119).
component("U53_",64).
component("YIR032C",289).
component("YMR120C",380).
component("YHR144C",274).
component("YBR153W",116).
component("YDL238C",154).
component("YNL141W",398).
component("YLR245C",355).
component("YML035C",367).
component("YJL126W",295).
component("U87_",83).
component("YBR111C",112).
component("YER005W",198).
component("YIL048W",280).
component("YER166W",214).
component("YDR093W",162).
component("YAL026C",91).
component("YLR231C",353).
component("U88_",84).
component("YLR134W",348).
component("YLR044C",347).
component("YGR087C",248).
component("YDR380W",181).
component("YDL080C",141).
component("U98_",88).
component("YKL184W",333).
component("YNR043W",415).
component("U93_",86).
component("U54_",65).
component("YKL211C",334) :- not remove_orf("YKL211C",334).
component("YGR170W",253).
component("YDR294C",177).
component("YEL046C",195).
component("YNR033W",414).
component("YKL211C",335) :- not remove_orf("YKL211C",335).
component("YER090W",335) :- not remove_orf("YER090W",335).
component("YER090W",209) :- not remove_orf("YER090W",209).
component("YDR127W",167).
component("YPL281C",474).
component("YOR393W",455).
component("YMR323W",391).
component("YHR174W",275).
component("YGR254W",260).
component("YGL026C",232) :- not remove_orf("YGL026C",232).
component("YGR155W",252).
component("YLR304C",360).
component("YJL200C",303).
component("YNL316C",410).
component("YKL182W",331).
component("YPL212C",463).
component("YNL292W",408).
component("YGL063W",235).
component("YFL001W",216).
component("YPR002W",476).
component("YDR127W",168).
component("YGL148W",237).
component("YAL012W",90).
component("YFR055W",227).
component("YBR019C",104).
component("YDR050C",159).
component("YDR007W",155) :- not remove_orf("YDR007W",155).
component("YOR095C",429).
component("YGL001C",229).
component("YKL152C",329).
component("YMR105C",377).
component("YKL127W",324).
component("YPR060C",478).
component("YPL104W",461).
component("YLL018C",342).
component("YHR091C",271).
component("YDR341C",179).
component("YOL097C",424).
component("YOR335C",446).
component("YGR094W",249).
component("YGR244C",259).
component("U89_",85).
component("YOR241W",442).
component("YMR113W",378).
component("YKL132C",325).
component("YJL101C",294).
component("YJR103W",312).
component("YBL039C",99).
component("YOL058W",420).
component("YBR208C",120).
component("YHR074W",270).
component("YOR303W",443).
component("YGL062W",234).
component("YBR218C",121).
component("YPL231W",468).
component("YNR016C",413).
component("YKL182W",332).
component("YGR037C",245).
component("YOR005C",426).
component("YDL164C",147).
component("YPR138C",484).
component("YPL265W",470).
component("YPL036W",459).
component("YOR348C",450).
component("YOR192C",436).
component("YOR071C",428).
component("YOL020W",418) :- not remove_orf("YOL020W",418).
component("YNL268W",406).
component("YNL142W",399).
component("YMR272C",387).
component("YML123C",371).
component("YLR348C",363).
component("YLR237W",354).
component("YLR138W",349).
component("YLL061W",344).
component("YKR053C",339).
component("YKR039W",338) :- not remove_orf("YKR039W",338).
component("YKL217W",336).
component("YJR095W",311).
component("YJR077C",309).
component("YJL134W",297).
component("YJL129C",296).
component("YHL036W",265).
component("YGR121C",250).
component("YGR055W",246).
component("YGL186C",239).
component("YGL008C",230).
component("YFL055W",220).
component("YER060W-A",205).
component("YER060W",204).
component("YER056C",203).
component("YEL017C-A",194).
component("YDR536W",193).
component("YDR508C",191).
component("YDR503C",190).
...
catalyst(6160,388).
catalyst(3870,202).
catalyst(3620,180) :- not remove_reaction(3620,180).
catalyst(2190,225).
catalyst(5550,316).
catalyst(5791,352).
catalyst(5792,352).
...
catalyst(2300,86).
catalyst(3460,65).
catalyst(3600,334) :- not remove_reaction(3600,334).
catalyst(6900,253).
catalyst(8781,177).
catalyst(8782,177).
catalyst(4560,195).
catalyst(2550,414).
catalyst(3630,335) :- not remove_reaction(3630,335).
catalyst(3630,209) :- not remove_reaction(3630,209).
catalyst(3740,167).
catalyst(8231,474).
catalyst(8232,474).
catalyst(8231,455).
...
catalyst(8231,260).
catalyst(8232,260).
catalyst(3590,232) :- not remove_reaction(3590,232).
catalyst(10910,232) :- not remove_reaction(10910,232).
catalyst(4570,252).
catalyst(8181,360).
catalyst(8182,360).
catalyst(8181,303).
...
catalyst(750,344).
catalyst(6560,339).
catalyst(761,338) :- not remove_reaction(761,338).
catalyst(762,338) :- not remove_reaction(762,338).
catalyst(771,338) :- not remove_reaction(771,338).
catalyst(772,338) :- not remove_reaction(772,338).
catalyst(781,338) :- not remove_reaction(781,338).
catalyst(782,338) :- not remove_reaction(782,338).
catalyst(791,338) :- not remove_reaction(791,338).
catalyst(792,338) :- not remove_reaction(792,338).
catalyst(801,338) :- not remove_reaction(801,338).
catalyst(802,338) :- not remove_reaction(802,338).
catalyst(811,338) :- not remove_reaction(811,338).
catalyst(812,338) :- not remove_reaction(812,338).
catalyst(831,338) :- not remove_reaction(831,338).
catalyst(832,338) :- not remove_reaction(832,338).
catalyst(841,338) :- not remove_reaction(841,338).
catalyst(842,338) :- not remove_reaction(842,338).
catalyst(861,338) :- not remove_reaction(861,338).
catalyst(862,338) :- not remove_reaction(862,338).
catalyst(881,338) :- not remove_reaction(881,338).
catalyst(882,338) :- not remove_reaction(882,338).
catalyst(941,338) :- not remove_reaction(941,338).
catalyst(942,338) :- not remove_reaction(942,338).
catalyst(1191,338) :- not remove_reaction(1191,338).
catalyst(1192,338) :- not remove_reaction(1192,338).
catalyst(1021,336).
catalyst(1022,336).
catalyst(1250,311).
catalyst(1581,309).
