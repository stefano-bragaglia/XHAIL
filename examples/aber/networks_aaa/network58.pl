...
component("YOL086C",409).
component("YMR303C",377).
component("YGL256W",238).
component("YDL168W",145).
component("YBR145W",111).
component("YPL231W",450).
component("YBR149W",112).
component("YGL001C",224).
component("YML056C",357).
component("YLR432W",354).
component("YHR216W",270).
component("YAR075W",93).
component("YAR073W",92).
component("YDR127W",161).
component("YJR139C",309).
component("YOR136W",418).
component("YDL066W",137).
component("YML086C",359).
component("YIL155C",278).
component("YPR191W",473).
component("YOR065W",413).
component("YJL166W",293).
...
component("Q0105",18).
component("YJR078W",302).
component("YJR025C",297).
component("YBL098W",100).
component("YMR015C",363).
...
component("YPL276W",458).
component("YPL275W",457).
component("YOR388C",439).
component("YGL154C",234).
component("U55_",64).
component("YOR323C",430).
component("YMR170C",371).
component("YMR169C",370).
component("U2_",54).
component("YBR166C",115).
component("YNL280C",394).
component("YER014W",195).
component("YMR118C",368).
component("YLR164W",340).
component("YLL041C",335).
component("YKL148C",319).
component("YJL045W",283).
component("YDR178W",167).
component("YJR051W",299).
component("YEL047C",192).
component("YOR375C",438).
...
component("YJR105W",306).
component("U16_",33).
component("U15_",30).
component("U96_",85).
component("YKL001C",311).
component("YML070W",358).
component("YFL053W",215).
component("YHL032C",258).
component("U83_",78).
component("U82_",77).
component("YMR208W",374).
component("YOR347C",435).
component("YAL038W",90).
component("YPR121W",468).
component("YPL258C",454).
component("YOL055C",406).
component("U1_",42).
component("YNL267W",393).
component("YLR305C",351).
...
component("YOL061W",408).
component("YKL181W",322).
component("YHL011C",256).
component("YER099C",207).
component("YBL068W",99).
component("YOR143C",419).
component("YGR007W",239).
component("YLR328W",352).
component("YCL050C",129).
component("YPR190C",472).
component("YPR187W",471).
component("YPR110C",467).
component("YPR010C",462).
component("YOR341W",434).
component("YOR340C",433).
component("YOR224C",426).
component("YOR210W",425).
component("YOR207C",423).
component("YOR151C",420).
component("YOR116C",416).
component("YOL005C",403).
component("YNR003C",399).
component("YNL248C",390).
component("YNL151C",388).
component("YNL113W",384).
component("YKL144C",318).
component("YJR063W",300).
component("YJL148W",291).
component("YJL140W",290).
component("YIL021W",271).
component("YHR143W-A",266).
...
component("YPR175W",470).
component("YPL167C",447).
component("YOR330C",431).
component("YOL115W",411).
component("YNL299W",396).
component("YNL262W",392).
component("YNL102W",383).
component("YJR043C",298).
component("YJR006W",296).
component("YJL090C",285).
component("YIL139C",277).
...
component("YKL035W",313).
component("YHL012W",257).
component("YER026C",197).
component("YDR058C",157).
component("YDL086W",139).
component("YOL011W",404).
component("YMR008C",362).
component("YMR006C",361).
component("U101_",19).
component("YBL015W",94).
component("YPL072W",445).
component("YOR124C",417).
component("YNL186W",389).
component("YMR304W",378).
component("YMR223W",375).
component("YKR098C",333).
component("YJL197W",294).
component("YIL156W",279).
...
component("U84_",79).
component("YPR073C",464).
component("YHR215W",269).
component("YDL024C",134).
component("YBR093C",108).
component("YBR092C",107).
component("YIL053W",274).
component("YER062C",202).
component("YPL228W",449).
component("YMR180C",372).
component("YDL236W",150).
component("YJL155C",292).
component("YPR073C",465).
component("YOR208W",424).
component("YNL053W",382).
component("YMR036C",364).
component("YIR026C",280).
component("YIL113W",276).
...
component("YLR286C",346).
component("YOR190W",421).
...
component("YPL281C",459).
component("YOR393W",440).
component("YMR323W",379).
component("YHR174W",268).
component("YGR254W",254).
component("YGL026C",228) :- not remove_orf("YGL026C",228).
component("YGR155W",248).
component("YLR304C",350).
component("YJL200C",295).
component("YNL316C",397).
component("YKL182W",323).
component("YPL212C",448).
...
component("YOR095C",415).
component("YGL001C",225).
component("YKL152C",321).
component("YMR105C",366).
component("YKL127W",316).
component("YPR060C",463).
component("YPL104W",446).
component("YLL018C",334).
component("YHR091C",264).
component("YDR341C",175).
component("YOL097C",410).
component("YOR335C",432).
component("YGR094W",245).
component("YGR244C",253).
component("U89_",83).
component("YOR241W",428).
component("YMR113W",367).
component("YKL132C",317).
component("YJL101C",286).
component("YJR103W",304).
component("YBL039C",96).
component("YOL058W",407).
component("YBR208C",117).
component("YHR074W",263).
component("YOR303W",429).
...
component("YOR005C",412).
component("YDL164C",144).
component("YPR138C",469).
component("YPL265W",455).
component("YPL036W",444).
component("YOR348C",436).
component("YOR192C",422).
component("YOR071C",414).
component("YOL020W",405) :- not remove_orf("YOL020W",405).
component("YNL142W",387).
component("YML123C",360).
component("YLR348C",353).
component("YLR237W",344).
component("YKR053C",331).
component("YKR039W",330) :- not remove_orf("YKR039W",330).
component("YKL217W",328).
component("YJR095W",303).
component("YJR077C",301).
component("YJL134W",289).
component("YJL129C",288).
...
catalyst(2300,84).
catalyst(3460,63).
catalyst(3600,326) :- not remove_reaction(3600,326).
catalyst(6900,249).
catalyst(8781,173).
catalyst(8782,173).
catalyst(4560,191).
...
catalyst(190,422).
catalyst(190,414).
catalyst(801,405) :- not remove_reaction(801,405).
catalyst(802,405) :- not remove_reaction(802,405).
catalyst(811,405) :- not remove_reaction(811,405).
catalyst(812,405) :- not remove_reaction(812,405).
catalyst(831,405) :- not remove_reaction(831,405).
catalyst(832,405) :- not remove_reaction(832,405).
catalyst(941,405) :- not remove_reaction(941,405).
catalyst(942,405) :- not remove_reaction(942,405).
catalyst(371,387).
catalyst(372,387).
catalyst(341,360).
catalyst(342,360).
...
catalyst(941,330) :- not remove_reaction(941,330).
catalyst(942,330) :- not remove_reaction(942,330).
