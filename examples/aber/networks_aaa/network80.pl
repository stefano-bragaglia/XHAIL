...
component("YNL280C",488).
component("YGR060W",291).
component("YGL012W",271).
component("YOL086C",507).
component("YMR303C",467).
component("YGL256W",285).
component("YDL168W",174).
component("YBR145W",134).
component("YPL231W",556).
component("YBR149W",135).
component("YGL001C",268).
component("YIL094C",334).
component("YHR063C",319).
component("YBR153W",136).
component("YML056C",443).
component("YLR432W",439).
component("YHR216W",328).
component("YAR075W",106).
component("YAR073W",105).
component("YDR127W",192).
component("YJR139C",378).
component("YOL126C",511).
component("YDL078C",164).
component("YKL029C",382).
component("YOR136W",520).
component("YDL066W",163).
component("YLR355C",437).
component("YML086C",445).
component("YIL155C",337).
component("YPR191W",582).
component("YOR065W",515).
component("YJL166W",357).
component("YHR001W-A",314).
component("YGR183C",301).
component("YFR033C",264).
component("YDR529C",224).
component("YBL045C",112).
component("Q0105",18).
component("YGR088W",293).
component("YDR256C",205).
component("YJR078W",369).
component("YJR025C",364).
component("YGR255C",308).
component("YBL098W",115).
component("YMR015C",451).
component("YDR402C",216).
component("YGR175C",299).
component("YJR104C",372).
component("YHR008C",315).
component("YER070W",243).
component("U35_",65).
component("YDL168W",175).
component("YDR158W",199).
component("YPL276W",564).
component("YPL275W",563).
component("YOR388C",542).
component("YGL154C",280).
component("U55_",74).
component("YOR323C",532).
component("YMR170C",459).
component("YMR169C",458).
component("U2_",62).
component("YBR221C",143).
component("U52_",71).
component("YBR166C",139).
component("YNL280C",489).
component("YGL012W",272).
component("U57_",75).
component("YER014W",233).
component("YMR118C",456).
component("YLR164W",422).
component("YLL041C",406).
component("YKL148C",389).
component("YJL045W",343).
component("YDR178W",200).
component("YJR051W",366).
component("YEL047C",228).
component("YOR375C",540).
component("YDL215C",177).
component("YAL062W",103).
component("U99_",99).
component("YBR035C",122).
component("YHR037W",316).
component("YKR080W",402).
component("YER023W",234).
component("YOR236W",529).
component("YGR204W",303).
component("YLR142W",417).
component("U62_",77).
component("YKL150W",390).
component("YIL043C",330).
component("YHR042W",317).
component("YFR030W",263).
component("YPL017C",545).
component("YFL018C",255).
component("YER042W",236).
component("YJR137C",377).
component("YML110C",447).
component("YBR034C",121).
component("YPL273W",562).
component("YLL062C",408).
component("U47_",68).
component("YER091C",246).
component("YDL033C",161).
component("YOL096C",508).
component("YDR019C",182).
component("YDR408C",218).
component("YBL013W",107).
component("YKL024C",381).
component("YPR074C",574).
component("YBR117C",131).
component("YLR354C",436).
component("YGR043C",289).
component("YCL009C",152).
component("YMR062C",453).
component("YNL071W",473).
component("YNR008W",496).
component("YPL231W",557).
component("U86_",91).
component("YPL001W",544).
component("YOR377W",541).
component("YGR177C",300).
component("YPL231W",558).
component("YGR147C",296).
component("YDL040C",162).
component("YPL028W",546).
component("YPR001W",566).
component("YNR001C",494).
component("YDL182W",176).
component("YDL131W",169).
component("YNL117W",476).
component("YIR031C",341).
component("YNL029C",470).
component("YIL085C",333).
component("YMR261C",464).
component("YML100W",446).
component("YBR126C",133).
component("YNL192W",481).
component("YBR038W",124).
component("YBR023C",120).
component("YLR209C",423).
component("U104_",21).
component("YMR300C",466).
component("YER055C",238).
component("YDR354W",212) :- not remove_orf("YDR354W",212).
component("YFR047C",265).
component("YJR133W",376).
component("YLR209C",424).
component("YML022W",440).
component("YDR441C",220).
component("YDR399W",214).
component("YJL167W",358).
component("YNL256W",484).
component("YDR127W",193).
component("YLR303W",430).
component("YJR130C",375).
component("YLR303W",431).
component("YDR035W",183).
component("YBR249C",144).
component("YOL143C",512).
component("YBR256C",145).
component("YHR137W",323).
component("YGL202W",282).
component("YLR027C",409).
component("YKL106W",385).
component("YKL104C",384).
component("YGR019W",287).
component("YLR089C",413).
component("U64_",78).
component("U51_",70).
component("YJR148W",379).
component("YGL253W",284).
component("YFR053C",266).
component("YMR205C",461).
component("YGR240C",305).
component("YDR248C",204).
component("YCR036W",159).
component("YCL040W",154).
component("YJR105W",373).
component("U16_",37).
component("U15_",34).
component("U96_",97).
component("YKL001C",380).
component("YML070W",444).
component("YFL053W",258).
component("YHL032C",312).
component("U83_",89).
component("U82_",88).
component("YMR208W",462).
component("YOR347C",537).
component("YAL038W",102).
component("YPR121W",577).
component("YPL258C",560).
component("YOL055C",504).
component("U1_",46).
component("YBR020W",118).
component("YNL267W",486).
component("YLR305C",433).
component("YFR019W",261).
component("YDR208W",201).
component("YDR127W",194).
component("U21_",54).
component("U20_",52).
component("YDR147W",197).
component("YDR300C",209).
component("YCR012W",156).
component("U18_",43).
component("U76_",86).
component("YER170W",252).
component("YDR226W",202).
component("YDR454C",221).
component("YOL061W",506).
component("YKL181W",392).
component("YHL011C",310).
component("YER099C",248).
component("YBL068W",114).
component("YOR143C",521).
component("YGR007W",286).
component("YLR328W",434).
component("YJR010W",363).
component("YCL050C",155).
component("YPR190C",581).
component("YPR187W",580).
component("YPR110C",576).
component("YPR010C",568).
component("YOR341W",536).
component("YOR340C",535).
component("YOR224C",528).
component("YOR210W",527).
component("YOR207C",525).
component("YOR151C",522).
component("YOR116C",518).
component("YOL005C",500).
component("YNR003C",495).
component("YNL248C",483).
component("YNL151C",479).
component("YNL113W",475).
component("YKL144C",388).
component("YJR063W",367).
component("YJL148W",355).
component("YJL140W",354).
component("YIL021W",329).
component("YHR143W-A",324).
component("YGL070C",277).
component("YFL036W",257).
component("YDR404C",217).
component("YDR156W",198).
component("YDR045C",184).
component("YDL150W",172).
component("YDL140C",170).
component("YBR154C",138).
component("YPR175W",579).
component("YPL167C",553).
component("YOR330C",533).
component("YOL115W",510).
component("YNL299W",491).
component("YNL262W",485).
component("YNL102W",474).
component("YJR043C",365).
component("YJR006W",362).
component("YJL090C",347).
component("YIL139C",336).
component("YEL055C",229).
component("YDR419W",219).
component("YDR121W",191).
component("YDL102W",167).
component("YCR014C",157).
component("YBR278W",147).
component("YBL035C",109).
component("YKL035W",383).
component("YHL012W",311).
component("YHR123W",322).
component("YER026C",235).
component("YCL004W",151).
component("YJL068C",344).
component("YDR058C",188).
component("YDL086W",166).
component("YOL011W",501).
component("YMR008C",450).
component("YMR006C",449).
component("U101_",19).
component("YBL015W",108).
component("YJL068C",345).
component("YPL072W",549).
component("YOR124C",519).
component("YNL186W",480).
component("YMR304W",468).
component("YMR223W",463).
component("YKR098C",404).
component("YJL197W",359).
component("YIL156W",338).
component("YFR010W",260).
component("YER151C",250).
component("YER144C",249).
component("YER098W",247).
component("YDR069C",189).
component("YDL122W",168).
component("YBR058C",125).
component("YBL067C",113).
component("U84_",90).
component("YPR073C",572).
component("YHR215W",327).
component("YDL024C",160).
component("YBR093C",129).
component("YBR092C",128).
component("YAR071W",104).
component("YIL053W",332).
component("YER062C",242).
component("YHR046C",318).
component("YGR208W",304).
component("YPL228W",555).
component("YMR180C",460).
component("YDL236W",179).
component("YJL155C",356).
component("YPR073C",573).
component("YOR208W",526).
component("YNL053W",472).
component("YMR036C",452).
component("YIR026C",339).
component("YIL113W",335).
component("YFR028C",262).
component("YER075C",244).
component("YDL230W",178).
component("YBR276C",146).
component("U34_",64).
component("U30_",63).
component("U25_",61).
component("U24_",60).
component("YOR360C",539).
component("YGL248W",283).
component("YKR031C",399).
component("YLR286C",428).
component("YOR190W",523).
component("YLR300W",429).
component("YGR282C",309).
component("YDR261C",206).
component("YDR400W",215).
component("U23_",59).
component("YML035C",441).
component("YJL070C",346).
component("YBR284W",148).
component("U102_",20).
component("YNL045W",471).
component("YLR160C",421).
component("YLR158C",420).
component("YLR157C",419).
component("YLR155C",418).
component("YDR321W",210).
component("YGL037C",274).
component("YDR242W",203).
component("YBR208C",140).
component("U53_",72).
component("YIR032C",342).
component("YIR029W",340).
component("YMR120C",457).
component("YHR144C",325).
component("YBR153W",137).
component("YDL238C",180).
component("YNL141W",477).
component("YLR245C",427).
component("YML035C",442).
component("YJL126W",350).
component("U87_",92).
component("YBR111C",130).
component("YER005W",232).
component("YIL048W",331).
component("YER166W",251).
component("YDR093W",190).
component("YAL026C",101).
component("YLR231C",425).
component("U88_",93).
component("YLR134W",415).
component("YLR044C",410).
component("YGR087C",292).
component("YDR380W",213).
component("YDL080C",165).
component("U98_",98).
component("YKL184W",395).
component("YNR043W",499).
component("U93_",96).
component("YDR047W",186).
component("U54_",73).
component("YKL211C",396) :- not remove_orf("YKL211C",396).
component("YGR170W",298).
component("YDR294C",207).
component("YEL046C",227).
component("YNR033W",498).
component("YKL211C",397) :- not remove_orf("YKL211C",397).
component("YER090W",397) :- not remove_orf("YER090W",397).
component("YER090W",245) :- not remove_orf("YER090W",245).
component("YDR127W",195).
component("YPL281C",565).
component("YOR393W",543).
component("YMR323W",469).
component("YHR174W",326).
component("YGR254W",307).
component("YGL026C",273) :- not remove_orf("YGL026C",273).
component("YGR155W",297).
component("YLR304C",432).
component("YJL200C",360).
component("YNL316C",492).
component("YKL182W",393).
component("YPL212C",554).
component("YNL292W",490).
component("YGL063W",276).
component("YFL001W",253).
component("YPR002W",567).
component("YDR127W",196).
component("YGL148W",279).
component("YAL012W",100).
component("YFR055W",267).
component("YJL121C",349).
component("YBR019C",116).
component("YBR019C",117).
component("YDR050C",187).
component("YDR007W",181) :- not remove_orf("YDR007W",181).
component("YOR095C",517).
component("YER003C",231).
component("YGL001C",269).
component("YKL152C",391).
component("YMR105C",454).
component("YKL127W",386).
component("YEL058W",230).
component("YPR060C",571).
component("YPL097W",550).
component("YGR185C",302).
component("YPL104W",551).
component("YLL018C",405).
component("YPR081C",575).
component("YBR121C",132).
component("YNL247W",482).
component("YOL033W",503).
component("YHR091C",321).
component("YDR341C",211).
component("YOL097C",509).
component("YPR047W",570).
component("YLR060W",411).
component("YFL022C",256).
component("YPR033C",569).
component("YPL160W",552).
component("YLR382C",438).
component("YOR335C",534).
component("YGR094W",294).
component("YGR244C",306).
component("U89_",94).
component("YOR241W",530).
component("YMR113W",455).
component("YKL132C",387).
component("YJL101C",348).
component("U91_",95).
component("YDL141W",171).
component("YJR103W",371).
component("YBL039C",110).
component("YOL058W",505).
component("YBR208C",141).
component("YHR074W",320).
component("YOR303W",531).
component("YJR109C",374).
component("YJL130C",352).
component("YGL062W",275).
component("YBR218C",142).
component("YPL231W",559).
component("YNR016C",497).
component("YKL182W",394).
component("YGR037C",288).
component("YOR005C",514).
component("YDL164C",173).
component("YPR138C",578).
component("YPL265W",561).
component("YPL057C",548).
component("YPL036W",547).
component("YOR348C",538).
component("YOR192C",524).
component("YOR071C",516).
component("YOL156W",513).
component("YOL020W",502) :- not remove_orf("YOL020W",502).
component("YNL318C",493).
component("YNL268W",487).
component("YNL142W",478).
component("YMR272C",465).
component("YML123C",448).
component("YLR348C",435).
component("YLR237W",426).
component("YLR138W",416).
component("YLR100C",414).
component("YLR081W",412).
component("YLL061W",407).
component("YKR093W",403).
component("YKR053C",401).
component("YKR039W",400) :- not remove_orf("YKR039W",400).
component("YKL217W",398).
component("YJR095W",370).
component("YJR077C",368).
component("YJL219W",361).
component("YJL134W",353).
component("YJL129C",351).
component("YHL036W",313).
component("YGR121C",295).
component("YGR055W",290).
component("YGL186C",281).
component("YGL077C",278).
component("YGL008C",270).
component("YFL055W",259).
component("YFL011W",254).
component("YER060W-A",241).
component("YER060W",240).
component("YER056C",239).
component("YER053C",237).
component("YEL017C-A",226).
component("YDR536W",225).
component("YDR508C",223).
component("YDR503C",222).
component("YDR294C",208).
component("YDR046C",185) :- not remove_orf("YDR046C",185).
component("YCR024C-A",158).
component("YCL025C",153).
component("YBR298C",150).
component("YBR291C",149).
component("YBR069C",127) :- not remove_orf("YBR069C",127).
component("YBR068C",126) :- not remove_orf("YBR068C",126).
component("YBR036C",123).
component("YBR021W",119).
component("YBL042C",111).
component("U79_",87).
component("U75_",85).
component("U74_",84).
component("U73_",83).
...
catalyst(6160,466).
catalyst(3870,238).
catalyst(3620,212) :- not remove_reaction(3620,212).
catalyst(2110,265).
catalyst(2190,265).
catalyst(5550,376).
catalyst(5791,424).
...
catalyst(1960,186).
catalyst(3460,73).
catalyst(3600,396) :- not remove_reaction(3600,396).
catalyst(6900,298).
catalyst(8781,207).
catalyst(8782,207).
catalyst(4560,227).
...
catalyst(3630,245) :- not remove_reaction(3630,245).
catalyst(3740,195).
catalyst(8231,565).
catalyst(8232,565).
catalyst(8231,543).
...
catalyst(8231,307).
catalyst(8232,307).
catalyst(3590,273) :- not remove_reaction(3590,273).
catalyst(10910,273) :- not remove_reaction(10910,273).
catalyst(4570,297).
catalyst(8181,432).
catalyst(8182,432).
catalyst(8181,360).
...
catalyst(8281,187).
catalyst(8282,187).
catalyst(3610,181) :- not remove_reaction(3610,181).
catalyst(7921,517).
catalyst(7922,517).
catalyst(7841,231).
catalyst(7842,231).
...
catalyst(190,516).
catalyst(1200,513).
catalyst(801,502) :- not remove_reaction(801,502).
catalyst(802,502) :- not remove_reaction(802,502).
catalyst(811,502) :- not remove_reaction(811,502).
catalyst(812,502) :- not remove_reaction(812,502).
catalyst(831,502) :- not remove_reaction(831,502).
catalyst(832,502) :- not remove_reaction(832,502).
catalyst(941,502) :- not remove_reaction(941,502).
catalyst(942,502) :- not remove_reaction(942,502).
catalyst(1200,493).
catalyst(761,487).
catalyst(762,487).
catalyst(371,478).
...
catalyst(640,403).
catalyst(6560,401).
catalyst(761,400) :- not remove_reaction(761,400).
catalyst(762,400) :- not remove_reaction(762,400).
catalyst(771,400) :- not remove_reaction(771,400).
catalyst(772,400) :- not remove_reaction(772,400).
catalyst(781,400) :- not remove_reaction(781,400).
catalyst(782,400) :- not remove_reaction(782,400).
catalyst(791,400) :- not remove_reaction(791,400).
catalyst(792,400) :- not remove_reaction(792,400).
...
catalyst(841,400) :- not remove_reaction(841,400).
catalyst(842,400) :- not remove_reaction(842,400).
catalyst(861,400) :- not remove_reaction(861,400).
catalyst(862,400) :- not remove_reaction(862,400).
catalyst(881,400) :- not remove_reaction(881,400).
catalyst(882,400) :- not remove_reaction(882,400).
catalyst(941,400) :- not remove_reaction(941,400).
catalyst(942,400) :- not remove_reaction(942,400).
catalyst(1191,400) :- not remove_reaction(1191,400).
catalyst(1192,400) :- not remove_reaction(1192,400).
catalyst(1021,398).
catalyst(1022,398).
catalyst(1250,370).
catalyst(1581,368).
...
catalyst(1511,149).
catalyst(1512,149).
catalyst(771,127) :- not remove_reaction(771,127).
catalyst(772,127) :- not remove_reaction(772,127).
catalyst(791,127) :- not remove_reaction(791,127).
catalyst(792,127) :- not remove_reaction(792,127).
catalyst(801,127) :- not remove_reaction(801,127).
catalyst(802,127) :- not remove_reaction(802,127).
catalyst(811,127) :- not remove_reaction(811,127).
catalyst(812,127) :- not remove_reaction(812,127).
catalyst(861,127) :- not remove_reaction(861,127).
catalyst(862,127) :- not remove_reaction(862,127).
catalyst(791,126) :- not remove_reaction(791,126).
catalyst(792,126) :- not remove_reaction(792,126).
...
catalyst(841,126) :- not remove_reaction(841,126).
catalyst(842,126) :- not remove_reaction(842,126).
catalyst(861,126) :- not remove_reaction(861,126).
catalyst(862,126) :- not remove_reaction(862,126).
catalyst(6600,123).
catalyst(620,119).
catalyst(540,111).
catalyst(2830,87).
