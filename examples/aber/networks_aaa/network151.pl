...
component("YNL280C",786).
component("YLR056W",661).
component("YGR060W",461).
component("YGL012W",429).
component("YKR009C",644).
component("YOL086C",818).
component("YMR303C",755).
component("YMR083W",725).
component("YGL256W",453).
...
component("YJR159W",611).
component("YGL001C",426).
component("YIL094C",539).
component("YHR063C",511).
component("YBR153W",213).
component("YML056C",708).
component("YLR432W",700).
component("YHR216W",529).
component("YAR075W",172).
component("YAR073W",171).
component("YCL030C",239).
component("YDR127W",314).
component("YJR139C",605).
component("YOL126C",823).
component("YKL085W",621).
component("YDL078C",262).
component("YKL029C",616).
component("YOR136W",839).
component("YNL037C",760).
component("YDL066W",261).
component("YNL241C",776).
component("YOL059W",816).
component("YDL022W",255).
component("YLR355C",696).
component("YIL074C",537).
component("YER081W",395).
component("YML054C",707).
component("YDL174C",284).
component("YML086C",711).
component("YIL155C",545).
component("YPR191W",934).
component("YOR065W",830).
component("YJL166W",576).
component("YHR001W-A",500).
component("YGR183C",476).
component("YFR033C",422).
component("YDR529C",361).
component("YBL045C",178).
component("Q0105",18).
component("YGR088W",464).
component("YDR256C",329).
component("YKL026C",615).
component("YIR037W",556).
component("YBR244W",225).
component("YJR078W",596).
component("YJR025C",588).
component("YGR255C",488).
component("U108_",23).
component("YBL098W",182).
component("YMR015C",722).
component("YHR007C",501).
component("YDR402C",349).
component("YGL055W",436).
component("YGR175C",473).
component("YJR104C",599).
component("YHR008C",502).
component("YJL026W",559).
component("YIL066C",536).
component("YGR180C",475).
component("YER070W",392).
component("U38_",113).
component("U36_",112).
component("U35_",111).
component("YDL168W",283).
component("YDR158W",322).
component("YBR006W",185).
component("YPL276W",909).
component("YPL275W",908).
component("YOR388C",873).
component("YOR374W",870).
component("YER073W",393).
component("U68_",135).
component("YGL154C",444).
component("U55_",127).
component("YOR323C",861).
component("YMR170C",736).
component("YMR169C",735).
component("U2_",106).
component("YER178W",408).
component("YBR221C",223).
component("YIL125W",543).
component("U52_",124).
component("YBR166C",216).
component("YNL280C",787).
component("YGL012W",430).
component("YKL182W",633).
component("U57_",129).
component("YKL216W",641).
component("YDR044W",301).
component("YER014W",376).
component("YKR009C",645).
component("YIL160C",547).
component("YGL205W",447).
component("YMR118C",730).
component("YLR164W",674).
component("YLL041C",654).
component("YKL148C",628).
component("YKL141W",626).
component("YJL045W",560).
component("YDR178W",323).
component("YJR051W",591).
component("YEL047C",370).
component("YDL215C",288).
component("YOR375C",871).
component("YDL215C",289).
component("YAL062W",169).
component("U99_",163).
component("YBR035C",195).
component("YMR189W",738).
component("U56_",128).
component("YHR037W",508).
component("YKR080W",649).
component("YER023W",378).
component("YPL023C",877).
component("YGL125W",441).
component("YOR236W",854).
component("YGR204W",480).
component("YLR142W",669).
component("U63_",133).
component("U62_",132).
component("YOR356W",868).
component("YKL150W",629).
component("YIL043C",533).
component("YHR042W",509).
component("YOR221C",852).
component("YML120C",715).
component("YKL192C",637).
component("YKL055C",618).
component("YER061C",387).
component("YMR145C",733).
component("YML120C",716).
component("YKL192C",638).
component("YDL085W",264).
component("YGR234W",483).
component("YFR030W",421).
component("YPL017C",876).
component("YFL018C",412).
component("YPL091W",882).
component("YDR353W",344).
component("YER042W",380).
component("YJR137C",604).
component("YPL266W",904).
component("YML110C",714).
component("YBR034C",194).
component("YPL273W",906).
component("YLL062C",657).
component("YDR410C",352).
component("U47_",119).
component("YER091C",400).
component("YJR073C",594).
component("YDR120C",312).
component("YDL033C",257).
component("YOL096C",819).
component("YLR172C",675).
component("YDR019C",297).
component("YBR176W",217).
component("YDR408C",351).
component("YMR120C",731).
component("YBL013W",173).
component("YKL024C",614).
component("YPR074C",923).
component("YBR117C",206).
component("YLR354C",695).
component("YGR043C",459).
component("YMR108W",728).
component("YCL009C",237).
component("YMR062C",724).
component("YNL071W",763).
component("YNR008W",794).
component("YIL160C",548).
component("YNL277W",785).
component("YFL017C",411).
component("YPL231W",898).
component("YER061C",388).
component("U86_",151).
component("YPL001W",875).
component("YMR296C",753).
component("YDR062W",307).
component("YDL052C",260).
component("U8_",155).
component("YDR148C",320).
component("YOR377W",872).
component("YGR177C",474).
component("YPL231W",899).
component("YGR147C",469).
component("YDL040C",258).
component("YPL028W",878).
component("YLR195C",676).
component("YGL017W",431).
component("YPR001W",911).
component("YNR001C",792).
component("YCR005C",244).
component("YDL182W",285).
component("YDL131W",273).
component("YNL117W",767).
component("YIR031C",554).
component("YOR321W",860).
component("YJR143C",606).
component("YGR199W",479).
component("YDR307W",338).
component("YDL095W",268).
component("YDL093W",267).
component("YAL023C",166).
component("YOR103C",834).
component("YOR085W",832).
component("YMR149W",734).
component("YML019W",703).
component("YJL002C",557).
component("YEL002C",365).
component("YDL232W",291).
component("YCL043C",242).
component("YNL029C",759).
component("YIL085C",538).
component("YMR261C",747).
component("YML100W",712).
component("YBR126C",209).
component("YNL192W",775).
component("YBR038W",197).
component("YBR023C",193).
component("YMR306W",757).
component("YLR342W",693).
component("YGR032W",457).
component("YLR209C",677).
component("U104_",21).
component("YMR271C",749).
component("YML106W",713).
component("YOR209C",850).
component("YMR300C",754).
component("YER055C",383).
component("YDR354W",345) :- not remove_orf("YDR354W",345).
component("YFR047C",423).
component("YJR133W",603).
component("YLR209C",678).
component("YML022W",704).
component("YDR441C",355).
component("YDR399W",347).
component("YPR176C",931).
component("YPL172C",889).
component("YNR041C",800).
component("YMR101C",726).
component("YDL090C",266).
component("YBR003W",184).
component("YBR002C",183).
component("YJL167W",577).
component("YJL167W",578).
component("YNL256W",779).
component("YPR069C",920).
component("YDR127W",315).
component("YLR303W",685).
component("YGR012W",455).
component("YJR130C",602).
component("YLR303W",686).
component("YDR035W",299).
component("YBR249C",226).
component("YOR274W",856).
component("YOL143C",826).
component("YBR256C",228).
component("YHR137W",520).
component("YGL202W",446).
component("YLR027C",658).
component("YKL106W",623).
component("YOL140W",825).
component("YKL104C",622).
component("YGR019W",456).
component("YLR089C",664).
component("U64_",134).
component("U61_",131).
component("U51_",123).
component("YJR148W",607).
component("YHR208W",527).
component("YFL030W",414).
component("YOR184W",845).
component("YNR058W",804).
component("YIL116W",542).
component("YGL253W",452).
component("YFR053C",424).
component("YOL136C",824).
component("YIL107C",540).
component("YMR013C",721).
component("YMR205C",740).
component("YGR240C",484).
component("YDR248C",328).
component("YCR036W",250).
component("YGR194C",478).
component("YCL040W",241).
component("YJR105W",600).
component("U16_",58).
component("U15_",52).
component("YPL188W",891).
component("YJR049C",590).
component("YEL041W",368).
component("U96_",161).
component("YKL001C",612).
component("YDR236C",326).
component("YML070W",710).
component("YFL053W",416).
component("YHL032C",498).
component("YLR133W",666).
component("YDR531W",363).
component("U83_",149).
component("U82_",148).
component("U81_",147).
component("YMR208W",741).
component("YPL203W",892).
component("YOR061W",829).
component("YKL166C",631).
component("YJL164C",575).
component("YIL035C",532).
component("YHR205W",526).
component("YHR102W",518).
component("YGL019W",432).
component("YHR025W",507).
component("YOR347C",866).
component("YAL038W",168).
component("YNR012W",795).
component("YPR121W",927).
component("YPL258C",901).
component("YOL055C",812).
component("YPL214C",895).
component("U1_",81).
component("YDR009W",296).
component("YBR020W",191).
component("YNL267W",783).
component("YLR305C",688).
component("YFR019W",419).
component("YDR208W",324).
component("YDR127W",316).
component("U21_",92).
component("U20_",89).
component("YDR147W",319).
component("YDR300C",337).
component("YCR012W",245).
component("YER052C",381).
component("YER069W",391).
component("U18_",73).
component("U17_",66).
component("U76_",143).
component("YMR220W",743).
component("YER170W",407).
component("YDR226W",325).
component("YKL067W",620).
component("YOL055C",813).
component("YDR454C",356).
component("YJR057W",592).
component("YOL061W",817).
component("YKL181W",632).
component("YHL011C",495).
component("YER099C",402).
component("YBL068W",181).
component("YOR143C",841).
component("YNL256W",780).
component("YLR328W",691).
component("YBR018C",187).
component("YBR018C",188).
component("YGR007W",454).
component("YLR328W",692).
component("YKR002W",643).
component("YDL103C",271).
component("U94_",160).
component("YJR010W",586).
component("YGL130W",442).
component("YDR530C",362).
component("YCL050C",243).
component("YPR190C",933).
component("YPR187W",932).
component("YPR110C",925).
component("YPR010C",914).
component("YOR341W",865).
component("YOR340C",864).
component("YOR224C",853).
component("YOR210W",851).
component("YOR207C",848).
component("YOR151C",842).
component("YOR116C",835).
component("YOL005C",806).
component("YNR003C",793).
component("YNL248C",778).
component("YNL151C",772).
component("YNL113W",766).
component("YKL144C",627).
component("YJR063W",593).
component("YJL148W",572).
component("YJL140W",571).
component("YIL021W",531).
component("YHR143W-A",521).
component("YGL070C",439).
component("YFL036W",415).
component("YDR404C",350).
component("YDR156W",321).
component("YDR045C",302).
component("YDL150W",280).
component("YDL140C",275).
component("YBR154C",215).
component("YPR175W",930).
component("YPL167C",888).
component("YOR330C",862).
component("YOL115W",822).
component("YNL299W",789).
component("YNL262W",782).
component("YNL102W",765).
component("YJR043C",589).
component("YJR006W",585).
component("YJL090C",564).
component("YIL139C",544).
component("YEL055C",371).
component("YDR419W",353).
component("YDR121W",313).
component("YDL102W",270).
component("YCR014C",246).
component("YBR278W",231).
component("YBL035C",175).
component("YKL035W",617).
component("YHL012W",496).
component("YHR123W",519).
component("YPR113W",926).
component("YBR243C",224).
component("YNL130C",768).
component("YDL142C",279).
component("YPL148C",886).
component("YER026C",379).
component("YCL004W",236).
component("YGR286C",492).
component("YJL068C",561).
component("YDR058C",306).
component("YNR034W",799).
component("YHR163W",523).
component("YGR248W",486).
component("YCR073W-A",252).
component("YDL086W",265).
component("YOL011W",808).
component("YMR008C",719).
component("YMR006C",718).
component("U105_",22).
component("U101_",19).
component("YBL015W",174).
component("YJL068C",562).
component("YPL072W",881).
component("YOR124C",836).
component("YNL186W",774).
component("YMR304W",756).
component("YMR223W",744).
component("YKR098C",652).
component("YJL197W",579).
component("YIL156W",546).
component("YFR010W",418).
component("YER151C",405).
component("YER144C",404).
component("YER098W",401).
component("YDR069C",308).
component("YDL122W",272).
component("YBR058C",198).
component("YBL067C",180).
component("YDR272W",332).
component("U84_",150).
component("YDR481C",357).
component("YLR377C",698).
component("YDR074W",309).
component("YPL179W",890).
component("YNR032W",797).
component("YML057W",709).
component("YML016C",702).
component("YLR433C",701).
component("YGR123C",467).
component("YER133W",403).
component("YER089C",398).
component("YDR436W",354).
component("YDR075W",310).
component("YDL188C",286).
component("YDL134C",274).
component("YDL047W",259).
component("YDL006W",253).
component("YBR125C",208).
component("YBL056W",179).
component("YPR073C",921).
component("YHR215W",528).
component("YDL024C",256).
component("YBR093C",204).
component("YBR092C",203).
component("YAR071W",170).
component("YIL053W",535).
component("YER062C",389).
component("YHR046C",510).
component("U9_",164).
component("YGR208W",482).
component("YPL228W",896).
component("YMR180C",737).
component("YDL236W",292).
component("YJL155C",574).
component("YPR073C",922).
component("YOR208W",849).
component("YNL053W",762).
component("YMR036C",723).
component("YIR026C",551).
component("YIL113W",541).
component("YFR028C",420).
component("YER075C",394).
component("YDL230W",290).
...
component("U25_",103).
component("U24_",102).
component("YPL268W",905).
component("YOR360C",869).
component("YGL248W",451).
component("YKR031C",646).
component("YPL206C",893).
component("YGL027C",434).
component("YLR286C",683).
component("YJR153W",609).
component("YJL221C",584).
component("YJL216C",582).
component("YIL172C",550).
component("YGR292W",494).
component("YGR287C",493).
component("YBR299W",235).
component("YBR184W",218).
component("YOR190W",846).
component("YLR300W",684).
component("YGR282C",491).
component("YDR261C",330).
component("YDR400W",348).
component("U23_",101).
component("YML035C",705).
component("YJL070C",563).
component("YBR284W",232).
component("U102_",20).
component("YNL045W",761).
component("YLR160C",673).
component("YLR158C",672).
component("YLR157C",671).
component("YLR155C",670).
component("YDR321W",339).
component("YGL037C",435).
component("YMR293C",752).
component("YDR242W",327).
component("YLR308W",690).
component("YLR307W",689).
component("YBR208C",220).
component("YMR281W",751).
component("U53_",125).
component("YIR027C",552).
component("YPL111W",885).
component("YIR032C",555).
component("YIR029W",553).
component("YPR062W",919).
component("YMR120C",732).
component("YLR028C",659).
component("YHR144C",522).
component("YGR267C",490).
component("YNL141W",769).
component("YBR153W",214).
component("YDL238C",293).
component("YNL141W",770).
component("YLR245C",681).
component("YML035C",706).
component("YBR084W",201).
component("YJL126W",567).
component("U44_",117).
component("YDL100C",269).
component("U87_",152).
component("U40_",115).
component("YMR267W",748).
component("YBR011C",186).
component("YHR201C",525).
component("YBR111C",205).
component("YBR252W",227).
component("YCL030C",240).
component("YER005W",375).
component("YIL048W",534).
component("YER166W",406).
component("YDR093W",311).
component("YAL026C",167).
component("YLR231C",679).
component("U88_",153).
component("YLR134W",667).
component("YLR044C",660).
component("YGR087C",463).
component("YDR380W",346).
component("YDL080C",263).
component("U98_",162).
component("YMR250W",746).
component("YKL184W",636).
component("YOR128C",837).
component("YEL021W",367).
component("YNR043W",801).
component("U93_",159).
component("YDR047W",304).
component("U54_",126).
component("YKL211C",639) :- not remove_orf("YKL211C",639).
component("YKR097W",651).
component("YOL052C",811).
component("YNL169C",773).
component("YGR170W",471).
component("YKL060C",619).
component("YNL256W",781).
component("YDR294C",334).
component("YEL046C",369).
component("YNR033W",798).
component("YPR006C",913).
component("YER065C",390).
component("YKL211C",640) :- not remove_orf("YKL211C",640).
component("YER090W",640) :- not remove_orf("YER090W",640).
component("YER090W",399) :- not remove_orf("YER090W",399).
component("YDR127W",317).
component("YPL281C",910).
component("YOR393W",874).
component("YMR323W",758).
component("YHR174W",524).
component("YGR254W",487).
component("YPL262W",902).
component("YGL026C",433) :- not remove_orf("YGL026C",433).
component("YGR155W",470).
component("YLR304C",687).
component("YJL200C",580).
component("YNL316C",790).
component("YKL182W",634).
component("YPL212C",894).
component("YNL292W",788).
component("YGL063W",438).
component("YFL001W",409).
component("YOR278W",857).
component("YPR002W",912).
component("U49_",120).
component("YJR016C",587).
component("YCR053W",251).
component("YDR127W",318).
component("YGL148W",443).
component("YIL168W",549).
component("YER086W",396).
component("YLR359W",697).
component("YAL012W",165).
component("YFR055W",425).
component("YJL005W",558).
component("YOR176W",844).
component("YJL121C",566).
component("YBR019C",189).
component("YBR019C",190).
component("YDR050C",305).
component("YDR007W",295) :- not remove_orf("YDR007W",295).
component("YOR095C",833).
component("YER003C",374).
component("YBR196C",219).
component("YGL001C",427).
component("U14_",44).
component("YOL056W",814).
component("YKL152C",630).
component("YDL021W",254).
component("YMR105C",727).
component("YKL127W",624).
component("YEL058W",372).
component("YPR060C",918).
component("YHR072W",512).
component("YJL153C",573).
component("YPL097W",883).
component("YGR185C",477).
component("YGR264C",489).
component("YGR171C",472).
component("YHR011W",503).
component("YDR023W",298).
component("YPL104W",884).
component("YLL018C",653).
component("YPR081C",924).
component("YBR121C",207).
component("YHR020W",506).
component("YER087W",397).
component("YNL247W",777).
component("YOL033W",810).
component("YGL245W",450).
component("YHR091C",514).
component("YDR341C",340).
component("YOL097C",820).
component("YDR268W",331).
component("YPR047W",917).
component("YLR060W",662).
component("YFL022C",413).
component("YPR033C",915).
component("YHR019C",504).
component("YCR024C",247).
component("YHR019C",505).
component("YPL160W",887).
component("YLR382C",699).
component("YNL073W",764).
component("YDR037W",300).
component("YOR335C",863).
component("YGR094W",465).
component("YOR317W",859).
component("YMR246W",745).
component("YIL009W",530).
component("YER015W",377).
component("YOR142W",840).
component("YGR244C",485).
component("YPR035W",916).
component("U89_",154).
component("YOR241W",855).
component("YMR113W",729).
component("YKL132C",625).
component("YJL101C",565).
component("U92_",158).
component("YGL234W",448).
component("U91_",157).
component("U90_",156).
component("YNR057C",803).
component("YDL141W",276).
component("YDL141W",277).
component("YGL234W",449).
component("YDL141W",278).
component("YJR103W",598).
component("YBL039C",176).
component("YGR204W",481).
component("YBR084W",202).
component("YOL058W",815).
component("YBR208C",221).
component("YHR074W",513).
component("YMR217W",742).
component("YGR061C",462).
component("YPR145W",929).
component("YGR124W",468).
component("YOR303W",858).
component("YJR109C",601).
component("YJL130C",569).
component("YGL062W",437).
component("YBR218C",222).
component("YPL231W",900).
component("YNR016C",796).
component("YKL182W",635).
component("YGR037C",458).
component("YOR005C",828).
component("YDL164C",281).
component("YOL010W",807).
component("YPR138C",928).
component("YPL274W",907).
component("YPL265W",903).
component("YPL057C",880).
component("YPL036W",879).
component("YOR348C",867).
component("YOR192C",847).
component("YOR171C",843).
component("YOR130C",838).
component("YOR071C",831).
component("YOL156W",827).
component("YOL103W",821).
component("YOL020W",809) :- not remove_orf("YOL020W",809).
component("YNR072W",805).
component("YNR056C",802).
component("YNL318C",791).
component("YNL268W",784).
component("YNL142W",771).
component("YMR272C",750).
component("YMR202W",739).
component("YMR011W",720).
component("YML123C",717).
component("YLR348C",694).
component("YLR260W",682).
component("YLR237W",680).
component("YLR138W",668).
component("YLR100C",665).
component("YLR081W",663).
component("YLL061W",656).
component("YLL043W",655).
component("YKR093W",650).
component("YKR053C",648).
component("YKR039W",647) :- not remove_orf("YKR039W",647).
component("YKL217W",642).
component("YKL004W",613).
component("YJR158W",610).
component("YJR152W",608).
component("YJR095W",597).
component("YJR077C",595).
component("YJL219W",583).
component("YJL214W",581).
component("YJL134W",570).
component("YJL129C",568).
component("YHR096C",517).
component("YHR094C",516).
component("YHR092C",515).
component("YHL036W",499).
component("YHL016C",497).
component("YGR121C",466).
component("YGR055W",460).
component("YGL186C",445).
component("YGL077C",440).
component("YGL008C",428).
component("YFL055W",417).
component("YFL011W",410).
component("YER060W-A",386).
component("YER060W",385).
component("YER056C",384).
component("YER053C",382).
component("YEL069C",373).
component("YEL017C-A",366).
component("YDR536W",364).
component("YDR508C",360).
component("YDR503C",359).
component("YDR497C",358).
component("YDR345C",343).
component("YDR343C",342).
component("YDR342C",341).
component("YDR297W",336).
component("YDR294C",335).
component("YDR284C",333).
component("YDR046C",303) :- not remove_orf("YDR046C",303).
component("YDL245C",294).
component("YDL210W",287).
...
catalyst(6160,754).
catalyst(3870,383).
catalyst(3620,345) :- not remove_reaction(3620,345).
catalyst(2110,423).
catalyst(2190,423).
catalyst(5550,603).
catalyst(5791,678).
...
catalyst(1960,304).
catalyst(3460,126).
catalyst(3600,639) :- not remove_reaction(3600,639).
catalyst(8000,651).
catalyst(3941,811).
catalyst(3942,811).
catalyst(6890,773).
...
catalyst(8020,913).
catalyst(8020,390).
catalyst(1890,640) :- not remove_reaction(1890,640).
catalyst(3630,640) :- not remove_reaction(3630,640).
catalyst(1890,399) :- not remove_reaction(1890,399).
catalyst(3630,399) :- not remove_reaction(3630,399).
catalyst(3740,317).
catalyst(8231,910).
catalyst(8232,910).
catalyst(8231,874).
...
catalyst(8051,902).
catalyst(8052,902).
catalyst(3590,433) :- not remove_reaction(3590,433).
catalyst(10910,433) :- not remove_reaction(10910,433).
catalyst(4570,470).
catalyst(8181,687).
catalyst(8182,687).
catalyst(8181,580).
...
catalyst(8281,305).
catalyst(8282,305).
catalyst(3610,295) :- not remove_reaction(3610,295).
catalyst(7921,833).
catalyst(7922,833).
catalyst(7841,374).
catalyst(7842,374).
...
catalyst(941,809) :- not remove_reaction(941,809).
catalyst(942,809) :- not remove_reaction(942,809).
catalyst(1170,805).
catalyst(1210,805).
catalyst(700,802).
catalyst(1200,791).
...
catalyst(650,650).
catalyst(6560,648).
catalyst(761,647) :- not remove_reaction(761,647).
catalyst(762,647) :- not remove_reaction(762,647).
catalyst(771,647) :- not remove_reaction(771,647).
catalyst(772,647) :- not remove_reaction(772,647).
catalyst(781,647) :- not remove_reaction(781,647).
catalyst(782,647) :- not remove_reaction(782,647).
catalyst(791,647) :- not remove_reaction(791,647).
catalyst(792,647) :- not remove_reaction(792,647).
catalyst(801,647) :- not remove_reaction(801,647).
catalyst(802,647) :- not remove_reaction(802,647).
catalyst(811,647) :- not remove_reaction(811,647).
catalyst(812,647) :- not remove_reaction(812,647).
catalyst(821,647) :- not remove_reaction(821,647).
catalyst(822,647) :- not remove_reaction(822,647).
catalyst(831,647) :- not remove_reaction(831,647).
catalyst(832,647) :- not remove_reaction(832,647).
catalyst(841,647) :- not remove_reaction(841,647).
catalyst(842,647) :- not remove_reaction(842,647).
catalyst(861,647) :- not remove_reaction(861,647).
catalyst(862,647) :- not remove_reaction(862,647).
catalyst(881,647) :- not remove_reaction(881,647).
catalyst(882,647) :- not remove_reaction(882,647).
catalyst(901,647) :- not remove_reaction(901,647).
catalyst(902,647) :- not remove_reaction(902,647).
catalyst(911,647) :- not remove_reaction(911,647).
catalyst(912,647) :- not remove_reaction(912,647).
catalyst(921,647) :- not remove_reaction(921,647).
catalyst(922,647) :- not remove_reaction(922,647).
catalyst(941,647) :- not remove_reaction(941,647).
catalyst(942,647) :- not remove_reaction(942,647).
catalyst(1191,647) :- not remove_reaction(1191,647).
catalyst(1192,647) :- not remove_reaction(1192,647).
catalyst(1021,642).
catalyst(1022,642).
catalyst(6610,613).
catalyst(1170,610).
...
catalyst(6550,335).
catalyst(6690,333).
catalyst(791,303) :- not remove_reaction(791,303).
catalyst(792,303) :- not remove_reaction(792,303).
...
catalyst(861,303) :- not remove_reaction(861,303).
catalyst(862,303) :- not remove_reaction(862,303).
...
modifiable_enzyme(639).
modifiable_enzyme(640).
modifiable_enzyme(399).
modifiable_enzyme(433).
modifiable_enzyme(295).
