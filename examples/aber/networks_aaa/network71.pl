...
component("YNL280C",448).
component("YGR060W",275).
component("YGL012W",257).
component("YOL086C",465).
component("YMR303C",429).
component("YGL256W",269).
component("YDL168W",164).
component("YBR145W",127).
component("YPL231W",509).
component("YBR149W",128).
component("YGL001C",254).
component("YHR063C",300).
component("YBR153W",129).
component("YML056C",408).
component("YLR432W",404).
component("YHR216W",308).
component("YAR075W",104).
component("YAR073W",103).
component("YDR127W",181).
component("YJR139C",350).
component("YKL029C",354).
component("YOR136W",475).
component("YDL066W",155).
component("YLR355C",402).
component("YML086C",410).
component("YIL155C",316).
component("YPR191W",534).
component("YOR065W",470).
component("YJL166W",332).
component("YHR001W-A",296).
component("YGR183C",284).
component("YFR033C",250).
component("YDR529C",212).
component("YBL045C",109).
component("Q0105",18).
component("YGR088W",277).
component("YDR256C",194).
component("YJR078W",342).
component("YJR025C",337).
component("YGR255C",290).
component("YBL098W",112).
component("YMR015C",414).
component("YDR402C",204).
component("YJR104C",345).
component("YHR008C",297).
component("YER070W",230).
component("U35_",64).
component("YDL168W",165).
component("YDR158W",188).
component("YPL276W",517).
component("YPL275W",516).
component("YOR388C",497).
component("YGL154C",264).
component("U55_",73).
component("YOR323C",487).
component("YMR170C",422).
component("YMR169C",421).
component("U2_",61).
component("YBR221C",136).
component("U52_",70).
component("YBR166C",132).
component("YNL280C",449).
component("YER014W",221).
component("YMR118C",419).
component("YLR164W",387).
component("YLL041C",377).
component("YKL148C",361).
component("YJL045W",321).
component("YDR178W",189).
component("YJR051W",339).
component("YEL047C",216).
component("YOR375C",495).
component("YDL215C",167).
component("YAL062W",101).
component("U99_",97).
component("YBR035C",118).
component("YKR080W",374).
component("YER023W",222).
component("YOR236W",484).
component("YGR204W",285).
component("U62_",75).
component("YKL150W",362).
component("YIL043C",310).
component("YHR042W",298).
component("YFR030W",249).
component("YPL017C",500).
component("YFL018C",241).
component("YER042W",224).
component("YJR137C",349).
component("YPL273W",515).
component("YLL062C",379).
component("U47_",67).
component("YER091C",233).
component("YDL033C",153).
component("YOL096C",466).
component("YDR019C",172).
component("YDR408C",206).
component("YBL013W",105).
component("YKL024C",353).
component("YPR074C",527).
component("YBR117C",126).
component("YLR354C",401).
component("YGR043C",273).
component("YCL009C",144).
component("YMR062C",416).
component("YPL231W",510).
component("U86_",89).
component("YPL001W",499).
component("YOR377W",496).
component("YGR177C",283).
component("YPL231W",511).
component("YGR147C",280).
component("YDL040C",154).
component("YPL028W",501).
component("YPR001W",519).
component("YNR001C",453).
component("YDL182W",166).
component("YNL117W",437).
component("YIR031C",319).
component("YNL029C",432).
component("YIL085C",313).
component("YNL192W",442).
component("YBR038W",119).
component("YBR023C",117).
component("YLR209C",388).
component("YMR300C",428).
component("YER055C",225).
component("YDR354W",200) :- not remove_orf("YDR354W",200).
component("YFR047C",251).
component("YJR133W",348).
component("YLR209C",389).
component("YML022W",405).
component("YDR441C",208).
component("YDR399W",202).
component("YNL256W",444).
component("YDR127W",182).
component("YLR303W",395).
component("YJR130C",347).
component("YLR303W",396).
component("YDR035W",173).
component("YBR249C",137).
component("YBR256C",138).
component("YHR137W",303).
component("YGL202W",266).
component("YLR027C",380).
component("YKL106W",357).
component("YKL104C",356).
component("YGR019W",271).
component("YLR089C",383).
component("U64_",76).
component("U51_",69).
component("YJR148W",351).
component("YGL253W",268).
component("YFR053C",252).
component("YMR205C",424).
component("YGR240C",287).
component("YDR248C",193).
component("YCR036W",151).
component("YCL040W",146).
component("YJR105W",346).
component("U16_",36).
component("U15_",33).
component("U96_",95).
component("YKL001C",352).
component("YML070W",409).
component("YFL053W",244).
component("YHL032C",294).
component("U83_",87).
component("U82_",86).
component("YMR208W",425).
component("YOR347C",492).
component("YAL038W",100).
component("YPR121W",529).
component("YPL258C",513).
component("YOL055C",462).
component("U1_",45).
component("YBR020W",115).
component("YNL267W",446).
component("YLR305C",398).
component("YFR019W",247).
component("YDR208W",190).
component("YDR127W",183).
component("U21_",53).
component("U20_",51).
component("YDR147W",186).
component("YDR300C",198).
component("YCR012W",148).
component("U18_",42).
component("U76_",84).
component("YER170W",239).
component("YDR226W",191).
component("YDR454C",209).
component("YOL061W",464).
component("YKL181W",364).
component("YHL011C",292).
component("YER099C",235).
component("YBL068W",111).
component("YOR143C",476).
component("YGR007W",270).
component("YLR328W",399).
component("YJR010W",336).
component("YCL050C",147).
component("YPR190C",533).
component("YPR187W",532).
component("YPR110C",528).
component("YPR010C",521).
component("YOR341W",491).
component("YOR340C",490).
component("YOR224C",483).
component("YOR210W",482).
component("YOR207C",480).
component("YOR151C",477).
component("YOR116C",473).
component("YOL005C",458).
component("YNR003C",454).
component("YNL248C",443).
component("YNL151C",440).
component("YNL113W",436).
component("YKL144C",360).
component("YJR063W",340).
component("YJL148W",330).
component("YJL140W",329).
component("YIL021W",309).
component("YHR143W-A",304).
component("YGL070C",262).
component("YFL036W",243).
component("YDR404C",205).
component("YDR156W",187).
component("YDR045C",174).
component("YDL150W",162).
component("YDL140C",160).
component("YBR154C",131).
component("YPR175W",531).
component("YPL167C",506).
component("YOR330C",488).
component("YOL115W",468).
component("YNL299W",451).
component("YNL262W",445).
component("YNL102W",435).
component("YJR043C",338).
component("YJR006W",335).
component("YJL090C",324).
component("YIL139C",315).
component("YEL055C",217).
component("YDR419W",207).
component("YDR121W",180).
component("YDL102W",158).
component("YCR014C",149).
component("YBR278W",140).
component("YBL035C",107).
component("YKL035W",355).
component("YHL012W",293).
component("YER026C",223).
component("YDR058C",177).
component("YDL086W",157).
component("YOL011W",459).
component("YMR008C",413).
component("YMR006C",412).
component("U101_",19).
component("YBL015W",106).
component("YJL068C",322).
component("YPL072W",503).
component("YOR124C",474).
component("YNL186W",441).
component("YMR304W",430).
component("YMR223W",426).
component("YKR098C",375).
component("YJL197W",333).
component("YIL156W",317).
component("YFR010W",246).
component("YER151C",237).
component("YER144C",236).
component("YER098W",234).
component("YDR069C",178).
component("YDL122W",159).
component("YBR058C",120).
component("YBL067C",110).
component("U84_",88).
component("YPR073C",525).
component("YHR215W",307).
component("YDL024C",152).
component("YBR093C",124).
component("YBR092C",123).
component("YAR071W",102).
component("YIL053W",312).
component("YER062C",229).
component("YHR046C",299).
component("YGR208W",286).
component("YPL228W",508).
component("YMR180C",423).
component("YDL236W",169).
component("YJL155C",331).
component("YPR073C",526).
component("YOR208W",481).
component("YNL053W",434).
component("YMR036C",415).
component("YIR026C",318).
component("YIL113W",314).
component("YFR028C",248).
component("YER075C",231).
component("YDL230W",168).
component("YBR276C",139).
component("U34_",63).
component("U30_",62).
component("U25_",60).
component("U24_",59).
component("YOR360C",494).
component("YGL248W",267).
component("YKR031C",371).
component("YLR286C",393).
component("YOR190W",478).
component("YLR300W",394).
component("YGR282C",291).
component("YDR261C",195).
component("YDR400W",203).
component("U23_",58).
component("YML035C",406).
component("YJL070C",323).
component("YBR284W",141).
component("U102_",20).
component("YNL045W",433).
component("YGL037C",259).
component("YDR242W",192).
component("YBR208C",133).
component("U53_",71).
component("YIR032C",320).
component("YMR120C",420).
component("YHR144C",305).
component("YBR153W",130).
component("YDL238C",170).
component("YNL141W",438).
component("YLR245C",392).
component("YML035C",407).
component("YJL126W",326).
component("U87_",90).
component("YBR111C",125).
component("YER005W",220).
component("YIL048W",311).
component("YER166W",238).
component("YDR093W",179).
component("YAL026C",99).
component("YLR231C",390).
component("U88_",91).
component("YLR134W",385).
component("YLR044C",381).
component("YGR087C",276).
component("YDR380W",201).
component("YDL080C",156).
component("U98_",96).
component("YKL184W",367).
component("YNR043W",457).
component("U93_",94).
component("U54_",72).
component("YKL211C",368) :- not remove_orf("YKL211C",368).
component("YGR170W",282).
component("YDR294C",196).
component("YEL046C",215).
component("YNR033W",456).
component("YKL211C",369) :- not remove_orf("YKL211C",369).
component("YER090W",369) :- not remove_orf("YER090W",369).
component("YER090W",232) :- not remove_orf("YER090W",232).
component("YDR127W",184).
component("YPL281C",518).
component("YOR393W",498).
component("YMR323W",431).
component("YHR174W",306).
component("YGR254W",289).
component("YGL026C",258) :- not remove_orf("YGL026C",258).
component("YGR155W",281).
component("YLR304C",397).
component("YJL200C",334).
component("YNL316C",452).
component("YKL182W",365).
component("YPL212C",507).
component("YNL292W",450).
component("YGL063W",261).
component("YFL001W",240).
component("YPR002W",520).
component("YDR127W",185).
component("YGL148W",263).
component("YAL012W",98).
component("YFR055W",253).
component("YBR019C",113).
component("YBR019C",114).
component("YDR050C",176).
component("YDR007W",171) :- not remove_orf("YDR007W",171).
component("YOR095C",472).
component("YER003C",219).
component("YGL001C",255).
component("YKL152C",363).
component("YMR105C",417).
component("YKL127W",358).
component("YEL058W",218).
component("YPR060C",524).
component("YPL104W",504).
component("YLL018C",376).
component("YOL033W",461).
component("YHR091C",302).
component("YDR341C",199).
component("YOL097C",467).
component("YPR047W",523).
component("YLR060W",382).
component("YFL022C",242).
component("YPR033C",522).
component("YPL160W",505).
component("YLR382C",403).
component("YOR335C",489).
component("YGR094W",278).
component("YGR244C",288).
component("U89_",92).
component("YOR241W",485).
component("YMR113W",418).
component("YKL132C",359).
component("YJL101C",325).
component("U91_",93).
component("YDL141W",161).
component("YJR103W",344).
component("YBL039C",108).
component("YOL058W",463).
component("YBR208C",134).
component("YHR074W",301).
component("YOR303W",486).
component("YGL062W",260).
component("YBR218C",135).
component("YPL231W",512).
component("YNR016C",455).
component("YKL182W",366).
component("YGR037C",272).
component("YOR005C",469).
component("YDL164C",163).
component("YPR138C",530).
component("YPL265W",514).
component("YPL036W",502).
component("YOR348C",493).
component("YOR192C",479).
component("YOR071C",471).
component("YOL020W",460) :- not remove_orf("YOL020W",460).
component("YNL268W",447).
component("YNL142W",439).
component("YMR272C",427).
component("YML123C",411).
component("YLR348C",400).
component("YLR237W",391).
component("YLR138W",386).
component("YLR100C",384).
component("YLL061W",378).
component("YKR053C",373).
component("YKR039W",372) :- not remove_orf("YKR039W",372).
component("YKL217W",370).
component("YJR095W",343).
component("YJR077C",341).
component("YJL134W",328).
component("YJL129C",327).
component("YHL036W",295).
component("YGR121C",279).
component("YGR055W",274).
component("YGL186C",265).
component("YGL008C",256).
component("YFL055W",245).
component("YER060W-A",228).
component("YER060W",227).
component("YER056C",226).
component("YEL017C-A",214).
component("YDR536W",213).
component("YDR508C",211).
component("YDR503C",210).
component("YDR294C",197).
component("YDR046C",175) :- not remove_orf("YDR046C",175).
component("YCR024C-A",150).
component("YCL025C",145).
component("YBR298C",143).
component("YBR291C",142).
component("YBR069C",122) :- not remove_orf("YBR069C",122).
component("YBR068C",121) :- not remove_orf("YBR068C",121).
component("YBR021W",116).
component("U79_",85).
component("U75_",83).
component("U74_",82).
component("U73_",81).
...
catalyst(6160,428).
catalyst(3870,225).
catalyst(3620,200) :- not remove_reaction(3620,200).
catalyst(2190,251).
catalyst(5550,348).
catalyst(5791,389).
catalyst(5792,389).
...
catalyst(2300,94).
catalyst(3460,72).
catalyst(3600,368) :- not remove_reaction(3600,368).
catalyst(6900,282).
catalyst(8781,196).
catalyst(8782,196).
catalyst(4560,215).
...
catalyst(3630,232) :- not remove_reaction(3630,232).
catalyst(3740,184).
catalyst(8231,518).
catalyst(8232,518).
catalyst(8231,498).
...
catalyst(8281,176).
catalyst(8282,176).
catalyst(3610,171) :- not remove_reaction(3610,171).
catalyst(7921,472).
catalyst(7922,472).
catalyst(7841,219).
catalyst(7842,219).
...
catalyst(750,378).
catalyst(6560,373).
catalyst(761,372) :- not remove_reaction(761,372).
catalyst(762,372) :- not remove_reaction(762,372).
catalyst(771,372) :- not remove_reaction(771,372).
catalyst(772,372) :- not remove_reaction(772,372).
catalyst(781,372) :- not remove_reaction(781,372).
catalyst(782,372) :- not remove_reaction(782,372).
catalyst(791,372) :- not remove_reaction(791,372).
catalyst(792,372) :- not remove_reaction(792,372).
catalyst(801,372) :- not remove_reaction(801,372).
catalyst(802,372) :- not remove_reaction(802,372).
catalyst(811,372) :- not remove_reaction(811,372).
catalyst(812,372) :- not remove_reaction(812,372).
catalyst(831,372) :- not remove_reaction(831,372).
catalyst(832,372) :- not remove_reaction(832,372).
catalyst(841,372) :- not remove_reaction(841,372).
catalyst(842,372) :- not remove_reaction(842,372).
catalyst(861,372) :- not remove_reaction(861,372).
catalyst(862,372) :- not remove_reaction(862,372).
catalyst(881,372) :- not remove_reaction(881,372).
catalyst(882,372) :- not remove_reaction(882,372).
catalyst(941,372) :- not remove_reaction(941,372).
catalyst(942,372) :- not remove_reaction(942,372).
catalyst(1191,372) :- not remove_reaction(1191,372).
catalyst(1192,372) :- not remove_reaction(1192,372).
catalyst(1021,370).
catalyst(1022,370).
catalyst(1250,343).
catalyst(1581,341).
...
catalyst(1511,142).
catalyst(1512,142).
catalyst(771,122) :- not remove_reaction(771,122).
catalyst(772,122) :- not remove_reaction(772,122).
catalyst(791,122) :- not remove_reaction(791,122).
catalyst(792,122) :- not remove_reaction(792,122).
catalyst(801,122) :- not remove_reaction(801,122).
catalyst(802,122) :- not remove_reaction(802,122).
catalyst(811,122) :- not remove_reaction(811,122).
catalyst(812,122) :- not remove_reaction(812,122).
catalyst(861,122) :- not remove_reaction(861,122).
catalyst(862,122) :- not remove_reaction(862,122).
catalyst(791,121) :- not remove_reaction(791,121).
catalyst(792,121) :- not remove_reaction(792,121).
catalyst(801,121) :- not remove_reaction(801,121).
catalyst(802,121) :- not remove_reaction(802,121).
catalyst(811,121) :- not remove_reaction(811,121).
catalyst(812,121) :- not remove_reaction(812,121).
catalyst(831,121) :- not remove_reaction(831,121).
catalyst(832,121) :- not remove_reaction(832,121).
catalyst(841,121) :- not remove_reaction(841,121).
catalyst(842,121) :- not remove_reaction(842,121).
catalyst(861,121) :- not remove_reaction(861,121).
catalyst(862,121) :- not remove_reaction(862,121).
catalyst(620,116).
catalyst(2830,85).
catalyst(2920,83).
catalyst(2920,82).
