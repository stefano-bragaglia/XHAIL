...
component("YNL280C",438).
component("YGR060W",266).
component("YGL012W",248).
component("YOL086C",455).
component("YMR303C",419).
component("YGL256W",260).
component("YDL168W",159).
component("YBR145W",124).
component("YPL231W",499).
component("YBR149W",125).
component("YGL001C",245).
component("YHR063C",291).
component("YBR153W",126).
component("YML056C",398).
component("YLR432W",394).
component("YHR216W",299).
component("YAR075W",101).
component("YAR073W",100).
component("YDR127W",175).
component("YJR139C",340).
component("YKL029C",344).
component("YOR136W",465).
component("YDL066W",151).
component("YLR355C",392).
component("YML086C",400).
component("YIL155C",307).
component("YPR191W",523).
component("YOR065W",460).
component("YJL166W",323).
component("YHR001W-A",287).
component("YGR183C",275).
component("YFR033C",241).
component("YDR529C",205).
component("YBL045C",106).
component("Q0105",18).
component("YGR088W",268).
component("YDR256C",187).
component("YJR078W",333).
component("YJR025C",328).
component("YGR255C",281).
component("YBL098W",109).
component("YMR015C",404).
component("YDR402C",197).
component("YJR104C",336).
component("YHR008C",288).
component("YER070W",222).
component("U35_",63).
component("YDL168W",160).
component("YPL276W",507).
component("YPL275W",506).
component("YOR388C",487).
component("YGL154C",255).
component("U55_",71).
component("YOR323C",477).
component("YMR170C",412).
component("YMR169C",411).
component("U2_",60).
component("YBR166C",129).
component("YNL280C",439).
component("YER014W",214).
component("YMR118C",409).
component("YLR164W",377).
component("YLL041C",367).
component("YKL148C",351).
component("YJL045W",312).
component("YDR178W",182).
component("YJR051W",330).
component("YEL047C",209).
component("YOR375C",485).
component("YDL215C",162).
component("YAL062W",98).
component("U99_",94).
component("YBR035C",115).
component("YKR080W",364).
component("YER023W",215).
component("YOR236W",474).
component("YGR204W",276).
component("U62_",73).
component("YKL150W",352).
component("YIL043C",301).
component("YHR042W",289).
component("YPL017C",490).
component("YFL018C",233).
component("YPL273W",505).
component("YLL062C",369).
component("U47_",66).
component("YER091C",225).
component("YDL033C",149).
component("YOL096C",456).
component("YDR408C",199).
component("YBL013W",102).
component("YKL024C",343).
component("YPR074C",516).
component("YBR117C",123).
component("YLR354C",391).
component("YGR043C",264).
component("YCL009C",140).
component("YMR062C",406).
component("YPL231W",500).
component("U86_",87).
component("YPL001W",489).
component("YOR377W",486).
component("YGR177C",274).
component("YPL231W",501).
component("YGR147C",271).
component("YDL040C",150).
component("YPL028W",491).
component("YPR001W",509).
component("YNR001C",443).
component("YDL182W",161).
component("YNL117W",427).
component("YIR031C",310).
component("YNL029C",422).
component("YIL085C",304).
component("YNL192W",432).
component("YBR038W",116).
component("YBR023C",114).
component("YLR209C",378).
component("YMR300C",418).
component("YER055C",217).
component("YDR354W",193) :- not remove_orf("YDR354W",193).
component("YFR047C",242).
component("YJR133W",339).
component("YLR209C",379).
component("YML022W",395).
component("YDR441C",201).
component("YDR399W",195).
component("YNL256W",434).
component("YDR127W",176).
component("YLR303W",385).
component("YJR130C",338).
component("YLR303W",386).
component("YDR035W",167).
component("YBR249C",133).
component("YBR256C",134).
component("YHR137W",294).
component("YGL202W",257).
component("YLR027C",370).
component("YKL106W",347).
component("YKL104C",346).
component("YGR019W",262).
component("YLR089C",373).
component("U64_",74).
component("U51_",68).
component("YJR148W",341).
component("YGL253W",259).
component("YFR053C",243).
component("YMR205C",414).
component("YGR240C",278).
component("YDR248C",186).
...
component("U15_",33).
component("U96_",92).
component("YKL001C",342).
component("YML070W",399).
component("YFL053W",236).
component("YHL032C",285).
component("U83_",85).
component("U82_",84).
component("YMR208W",415).
component("YOR347C",482).
component("YAL038W",97).
component("YPR121W",518).
component("YPL258C",503).
component("YOL055C",452).
component("U1_",45).
component("YBR020W",112).
component("YNL267W",436).
component("YLR305C",388).
component("YFR019W",239).
component("YDR208W",183).
component("YDR127W",177).
component("U21_",52).
component("U20_",50).
component("YDR147W",180).
component("YDR300C",191).
component("YCR012W",144).
component("U18_",42).
component("U76_",82).
component("YER170W",231).
component("YDR226W",184).
component("YDR454C",202).
component("YOL061W",454).
component("YKL181W",354).
component("YHL011C",283).
component("YER099C",227).
component("YBL068W",108).
component("YOR143C",466).
component("YGR007W",261).
component("YLR328W",389).
component("YJR010W",327).
component("YCL050C",143).
component("YPR190C",522).
component("YPR187W",521).
component("YPR110C",517).
component("YPR010C",511).
component("YOR341W",481).
component("YOR340C",480).
component("YOR224C",473).
component("YOR210W",472).
component("YOR207C",470).
component("YOR151C",467).
component("YOR116C",463).
component("YOL005C",448).
component("YNR003C",444).
component("YNL248C",433).
component("YNL151C",430).
component("YNL113W",426).
component("YKL144C",350).
component("YJR063W",331).
component("YJL148W",321).
component("YJL140W",320).
component("YIL021W",300).
component("YHR143W-A",295).
component("YGL070C",253).
component("YFL036W",235).
component("YDR404C",198).
component("YDR156W",181).
component("YDR045C",168).
component("YDL150W",157).
component("YDL140C",156).
component("YBR154C",128).
component("YPR175W",520).
component("YPL167C",496).
component("YOR330C",478).
component("YOL115W",458).
component("YNL299W",441).
component("YNL262W",435).
component("YNL102W",425).
component("YJR043C",329).
component("YJR006W",326).
component("YJL090C",315).
component("YIL139C",306).
component("YEL055C",210).
component("YDR419W",200).
component("YDR121W",174).
component("YDL102W",154).
component("YCR014C",145).
component("YBR278W",136).
component("YBL035C",104).
component("YKL035W",345).
component("YHL012W",284).
component("YER026C",216).
component("YDR058C",171).
component("YDL086W",153).
component("YOL011W",449).
component("YMR008C",403).
component("YMR006C",402).
component("U101_",19).
component("YBL015W",103).
component("YJL068C",313).
component("YPL072W",493).
component("YOR124C",464).
component("YNL186W",431).
component("YMR304W",420).
component("YMR223W",416).
component("YKR098C",365).
component("YJL197W",324).
component("YIL156W",308).
component("YFR010W",238).
component("YER151C",229).
component("YER144C",228).
component("YER098W",226).
component("YDR069C",172).
component("YDL122W",155).
component("YBR058C",117).
component("YBL067C",107).
component("U84_",86).
component("YPR073C",514).
component("YHR215W",298).
component("YDL024C",148).
component("YBR093C",121).
component("YBR092C",120).
component("YAR071W",99).
component("YIL053W",303).
component("YER062C",221).
component("YHR046C",290).
component("YGR208W",277).
component("YPL228W",498).
component("YMR180C",413).
component("YDL236W",164).
component("YJL155C",322).
component("YPR073C",515).
component("YOR208W",471).
component("YNL053W",424).
component("YMR036C",405).
component("YIR026C",309).
component("YIL113W",305).
component("YFR028C",240).
component("YER075C",223).
component("YDL230W",163).
component("YBR276C",135).
component("U34_",62).
component("U30_",61).
component("U25_",59).
component("U24_",58).
component("YOR360C",484).
component("YGL248W",258).
component("YKR031C",361).
component("YLR286C",383).
component("YOR190W",468).
component("YLR300W",384).
component("YGR282C",282).
component("YDR261C",188).
component("YDR400W",196).
component("U23_",57).
component("YML035C",396).
component("YJL070C",314).
component("YBR284W",137).
component("U102_",20).
component("YNL045W",423).
component("YGL037C",250).
component("YDR242W",185).
component("YBR208C",130).
component("U53_",69).
component("YIR032C",311).
component("YMR120C",410).
component("YHR144C",296).
component("YBR153W",127).
component("YDL238C",165).
component("YNL141W",428).
component("YLR245C",382).
component("YML035C",397).
component("YJL126W",317).
component("U87_",88).
component("YBR111C",122).
component("YER005W",213).
component("YIL048W",302).
component("YER166W",230).
component("YDR093W",173).
component("YAL026C",96).
component("YLR231C",380).
component("U88_",89).
component("YLR134W",375).
component("YLR044C",371).
component("YGR087C",267).
component("YDR380W",194).
component("YDL080C",152).
component("U98_",93).
component("YKL184W",357).
component("YNR043W",447).
component("U93_",91).
component("U54_",70).
component("YKL211C",358) :- not remove_orf("YKL211C",358).
component("YGR170W",273).
component("YDR294C",189).
component("YEL046C",208).
component("YNR033W",446).
component("YKL211C",359) :- not remove_orf("YKL211C",359).
...
component("YHR174W",297).
component("YGR254W",280).
component("YGL026C",249) :- not remove_orf("YGL026C",249).
component("YGR155W",272).
component("YLR304C",387).
component("YJL200C",325).
component("YNL316C",442).
component("YKL182W",355).
component("YPL212C",497).
component("YNL292W",440).
component("YGL063W",252).
component("YFL001W",232).
component("YPR002W",510).
component("YDR127W",179).
component("YGL148W",254).
component("YAL012W",95).
component("YFR055W",244).
component("YBR019C",110).
component("YBR019C",111).
component("YDR050C",170).
component("YDR007W",166) :- not remove_orf("YDR007W",166).
component("YOR095C",462).
component("YER003C",212).
component("YGL001C",246).
component("YKL152C",353).
component("YMR105C",407).
component("YKL127W",348).
component("YEL058W",211).
component("YPR060C",513).
component("YPL104W",494).
component("YLL018C",366).
component("YOL033W",451).
component("YHR091C",293).
component("YDR341C",192).
component("YOL097C",457).
component("YPR047W",512).
component("YLR060W",372).
component("YFL022C",234).
component("YPL160W",495).
component("YLR382C",393).
component("YOR335C",479).
component("YGR094W",269).
component("YGR244C",279).
component("U89_",90).
component("YOR241W",475).
component("YMR113W",408).
component("YKL132C",349).
component("YJL101C",316).
component("YJR103W",335).
component("YBL039C",105).
component("YOL058W",453).
component("YBR208C",131).
component("YHR074W",292).
component("YOR303W",476).
component("YGL062W",251).
component("YBR218C",132).
component("YPL231W",502).
component("YNR016C",445).
component("YKL182W",356).
component("YGR037C",263).
component("YOR005C",459).
component("YDL164C",158).
component("YPR138C",519).
component("YPL265W",504).
component("YPL036W",492).
component("YOR348C",483).
component("YOR192C",469).
component("YOR071C",461).
component("YOL020W",450) :- not remove_orf("YOL020W",450).
component("YNL268W",437).
component("YNL142W",429).
component("YMR272C",417).
component("YML123C",401).
component("YLR348C",390).
component("YLR237W",381).
component("YLR138W",376).
component("YLR100C",374).
component("YLL061W",368).
component("YKR053C",363).
component("YKR039W",362) :- not remove_orf("YKR039W",362).
component("YKL217W",360).
component("YJR095W",334).
component("YJR077C",332).
component("YJL134W",319).
component("YJL129C",318).
component("YHL036W",286).
component("YGR121C",270).
component("YGR055W",265).
component("YGL186C",256).
component("YGL008C",247).
component("YFL055W",237).
component("YER060W-A",220).
component("YER060W",219).
component("YER056C",218).
component("YEL017C-A",207).
component("YDR536W",206).
component("YDR508C",204).
component("YDR503C",203).
component("YDR294C",190).
component("YDR046C",169) :- not remove_orf("YDR046C",169).
component("YCR024C-A",146).
component("YCL025C",141).
component("YBR298C",139).
component("YBR291C",138).
component("YBR069C",119) :- not remove_orf("YBR069C",119).
component("YBR068C",118) :- not remove_orf("YBR068C",118).
component("YBR021W",113).
component("U79_",83).
component("U75_",81).
component("U74_",80).
component("U73_",79).
...
catalyst(6160,418).
catalyst(3870,217).
catalyst(3620,193) :- not remove_reaction(3620,193).
catalyst(2190,242).
catalyst(5550,339).
catalyst(5791,379).
catalyst(5792,379).
...
catalyst(2300,91).
catalyst(3460,70).
catalyst(3600,358) :- not remove_reaction(3600,358).
catalyst(6900,273).
catalyst(8781,189).
catalyst(8782,189).
catalyst(4560,208).
...
catalyst(8231,280).
catalyst(8232,280).
catalyst(3590,249) :- not remove_reaction(3590,249).
catalyst(10910,249) :- not remove_reaction(10910,249).
catalyst(4570,272).
catalyst(8181,387).
catalyst(8182,387).
catalyst(8181,325).
...
catalyst(750,368).
catalyst(6560,363).
catalyst(761,362) :- not remove_reaction(761,362).
catalyst(762,362) :- not remove_reaction(762,362).
catalyst(771,362) :- not remove_reaction(771,362).
catalyst(772,362) :- not remove_reaction(772,362).
catalyst(781,362) :- not remove_reaction(781,362).
catalyst(782,362) :- not remove_reaction(782,362).
catalyst(791,362) :- not remove_reaction(791,362).
catalyst(792,362) :- not remove_reaction(792,362).
catalyst(801,362) :- not remove_reaction(801,362).
catalyst(802,362) :- not remove_reaction(802,362).
catalyst(811,362) :- not remove_reaction(811,362).
catalyst(812,362) :- not remove_reaction(812,362).
catalyst(831,362) :- not remove_reaction(831,362).
catalyst(832,362) :- not remove_reaction(832,362).
catalyst(841,362) :- not remove_reaction(841,362).
catalyst(842,362) :- not remove_reaction(842,362).
catalyst(861,362) :- not remove_reaction(861,362).
catalyst(862,362) :- not remove_reaction(862,362).
catalyst(881,362) :- not remove_reaction(881,362).
catalyst(882,362) :- not remove_reaction(882,362).
catalyst(941,362) :- not remove_reaction(941,362).
catalyst(942,362) :- not remove_reaction(942,362).
catalyst(1191,362) :- not remove_reaction(1191,362).
catalyst(1192,362) :- not remove_reaction(1192,362).
catalyst(1021,360).
catalyst(1022,360).
catalyst(1250,334).
catalyst(1581,332).
...
catalyst(831,169) :- not remove_reaction(831,169).
catalyst(832,169) :- not remove_reaction(832,169).
catalyst(841,169) :- not remove_reaction(841,169).
catalyst(842,169) :- not remove_reaction(842,169).
...
catalyst(1511,138).
catalyst(1512,138).
catalyst(771,119) :- not remove_reaction(771,119).
catalyst(772,119) :- not remove_reaction(772,119).
...
catalyst(791,118) :- not remove_reaction(791,118).
catalyst(792,118) :- not remove_reaction(792,118).
...
catalyst(831,118) :- not remove_reaction(831,118).
catalyst(832,118) :- not remove_reaction(832,118).
catalyst(841,118) :- not remove_reaction(841,118).
catalyst(842,118) :- not remove_reaction(842,118).
catalyst(861,118) :- not remove_reaction(861,118).
catalyst(862,118) :- not remove_reaction(862,118).
catalyst(620,113).
catalyst(2830,83).
catalyst(2920,81).
catalyst(2920,80).
