...
component("YNL280C",720).
component("YLR056W",606).
component("YGR060W",424).
component("YGL012W",393).
component("YKR009C",589).
component("YOL086C",751).
component("YMR303C",689).
component("YMR083W",664).
component("YGL256W",416).
component("YDL168W",255).
component("YBR145W",193).
component("YPL231W",820).
component("U46_",108).
component("YBR149W",194).
component("YJR159W",559).
component("YGL001C",390).
component("YIL094C",496).
component("YHR063C",472).
component("YBR153W",195).
component("YML056C",649).
component("YLR432W",642).
component("YHR216W",487).
component("YAR075W",156).
component("YAR073W",155).
component("YCL030C",218).
component("YDR127W",285).
component("YJR139C",553).
component("YOL126C",756).
component("YKL085W",569).
component("YDL078C",236).
component("YKL029C",564).
component("YOR136W",767).
component("YNL037C",694).
component("YDL066W",235).
component("YNL241C",710).
component("YOL059W",749).
component("YDL022W",230).
component("YLR355C",638).
component("YIL074C",494).
component("YER081W",360).
component("YML054C",648).
component("YDL174C",257).
component("YML086C",652).
component("YIL155C",502).
component("YPR191W",855).
component("YOR065W",761).
component("YJL166W",529).
component("YHR001W-A",461).
component("YGR183C",439).
component("YFR033C",386).
component("YDR529C",331).
component("YBL045C",162).
component("Q0105",18).
component("YGR088W",427).
component("YDR256C",300).
component("YKL026C",563).
component("YIR037W",511).
component("YBR244W",206).
component("YJR078W",544).
component("YJR025C",537).
component("YGR255C",451).
component("U108_",22).
component("YBL098W",166).
component("YMR015C",661).
component("YHR007C",462).
component("YDR402C",320).
component("YGL055W",399).
component("YGR175C",436).
component("YJR104C",547).
component("YHR008C",463).
component("YJL026W",513).
component("YIL066C",493).
component("YGR180C",438).
component("YER070W",357).
component("U38_",103).
component("U36_",102).
component("U35_",101).
component("YDL168W",256).
component("YDR158W",293).
component("YBR006W",169).
component("YPL276W",832).
component("YPL275W",831).
component("YOR388C",799).
component("YOR374W",796).
component("YER073W",358).
component("U68_",123).
component("YGL154C",407).
component("U55_",117).
component("YOR323C",788).
component("YMR170C",673).
component("YMR169C",672).
component("U2_",97).
component("YER178W",373).
component("YBR221C",204).
component("YIL125W",500).
component("U52_",114).
component("YBR166C",198).
component("YNL280C",721).
component("YGL012W",394).
component("U57_",118).
component("YKL216W",586).
component("YDR044W",273).
component("YER014W",343).
component("YKR009C",590).
component("YIL160C",504).
component("YGL205W",410).
component("YMR118C",669).
component("YLR164W",619).
component("YLL041C",599).
component("YKL148C",576).
component("YKL141W",574).
component("YJL045W",514).
component("YDR178W",294).
component("YJR051W",539).
component("YEL047C",337).
component("YDL215C",261).
component("YOR375C",797).
component("YDL215C",262).
component("YAL062W",153).
component("U99_",148).
component("YBR035C",179).
component("YMR189W",675).
component("YHR037W",469).
component("YKR080W",594).
component("YER023W",345).
component("YPL023C",803).
component("YGL125W",404).
component("YOR236W",782).
component("YGR204W",443).
component("YLR142W",614).
component("U62_",121).
component("YKL150W",577).
component("YIL043C",490).
component("YHR042W",470).
component("YOR221C",780).
component("YML120C",655).
component("YKL192C",583).
component("YKL055C",566).
component("YER061C",353).
component("YGR234W",446).
component("YFR030W",385).
component("YPL017C",802).
component("YFL018C",377).
component("YDR353W",315).
component("YER042W",347).
component("YJR137C",552).
component("YPL266W",827).
component("YML110C",654).
component("YBR034C",178).
component("YPL273W",829).
component("YLL062C",602).
component("YDR410C",323).
component("U47_",109).
component("YER091C",365).
component("YJR073C",542).
component("YDR120C",283).
component("YDL033C",232).
component("YOL096C",752).
component("YLR172C",620).
component("YDR019C",269).
component("YBR176W",199).
component("YDR408C",322).
component("YMR120C",670).
component("YBL013W",157).
component("YKL024C",562).
component("YPR074C",844).
component("YBR117C",189).
component("YLR354C",637).
component("YGR043C",422).
component("YMR108W",667).
component("YCL009C",216).
component("YMR062C",663).
component("YNL071W",697).
component("YNR008W",728).
component("YIL160C",505).
component("YNL277W",719).
component("YFL017C",376).
component("YPL231W",821).
component("YER061C",354).
component("U86_",138).
component("YPL001W",801).
component("YDR148C",291).
component("YOR377W",798).
component("YGR177C",437).
component("YPL231W",822).
component("YGR147C",432).
component("YDL040C",233).
component("YPL028W",804).
component("YGL017W",395).
component("YPR001W",834).
component("YNR001C",726).
component("YDL182W",258).
component("YDL131W",246).
component("YNL117W",701).
component("YIR031C",509).
component("YOR321W",787).
component("YJR143C",554).
component("YGR199W",442).
component("YDR307W",309).
component("YDL095W",241).
component("YDL093W",240).
component("YAL023C",150).
component("YNL029C",693).
component("YIL085C",495).
component("YMR261C",683).
component("YML100W",653).
component("YBR126C",192).
component("YNL192W",709).
component("YBR038W",181).
component("YBR023C",177).
component("YMR306W",691).
component("YLR342W",635).
component("YGR032W",420).
component("YLR209C",621).
component("U104_",21).
component("YOR209C",778).
component("YMR300C",688).
component("YER055C",349).
component("YDR354W",316) :- not remove_orf("YDR354W",316).
component("YFR047C",387).
component("YJR133W",551).
component("YLR209C",622).
component("YML022W",645).
component("YDR441C",326).
component("YDR399W",318).
component("YPR176C",852).
component("YPL172C",814).
component("YNR041C",734).
component("YMR101C",665).
component("YDL090C",239).
component("YBR003W",168).
component("YBR002C",167).
component("YJL167W",530).
component("YNL256W",713).
component("YDR127W",286).
component("YLR303W",629).
component("YGR012W",418).
component("YJR130C",550).
component("YLR303W",630).
component("YDR035W",271).
component("YBR249C",207).
component("YOL143C",758).
component("YBR256C",209).
component("YHR137W",480).
component("YGL202W",409).
component("YLR027C",603).
component("YKL106W",571).
component("YKL104C",570).
component("YGR019W",419).
component("YLR089C",609).
component("U64_",122).
component("U61_",120).
component("U51_",113).
component("YJR148W",555).
component("YHR208W",485).
component("YOR184W",773).
component("YNR058W",737).
component("YIL116W",499).
component("YGL253W",415).
component("YFR053C",388).
component("YOL136C",757).
component("YIL107C",497).
component("YMR013C",660).
component("YMR205C",676).
component("YGR240C",447).
component("YDR248C",299).
component("YCR036W",226).
component("YGR194C",441).
component("YCL040W",220).
component("YJR105W",548).
component("U16_",52).
component("U15_",46).
component("U96_",146).
component("YKL001C",560).
component("YDR236C",297).
component("YML070W",651).
component("YFL053W",380).
component("YHL032C",459).
component("YLR133W",611).
component("YDR531W",333).
component("U83_",136).
component("U82_",135).
component("U81_",134).
component("YMR208W",677).
component("YHR025W",468).
component("YOR347C",793).
component("YAL038W",152).
component("YNR012W",729).
component("YPR121W",848).
component("YPL258C",824).
component("YOL055C",745).
component("YPL214C",818).
component("U1_",75).
component("YDR009W",268).
component("YBR020W",175).
component("YNL267W",717).
component("YLR305C",632).
component("YFR019W",383).
component("YDR208W",295).
component("YDR127W",287).
component("U21_",85).
component("U20_",82).
component("YDR147W",290).
component("YDR300C",308).
component("YCR012W",222).
component("U18_",67).
component("U17_",60).
component("U76_",131).
component("YMR220W",679).
component("YER170W",372).
component("YDR226W",296).
component("YKL067W",568).
component("YOL055C",746).
component("YDR454C",327).
component("YJR057W",540).
component("YOL061W",750).
component("YKL181W",579).
component("YHL011C",456).
component("YER099C",367).
component("YBL068W",165).
component("YOR143C",769).
component("YNL256W",714).
component("YLR328W",633).
component("YBR018C",171).
component("YBR018C",172).
component("YGR007W",417).
component("YLR328W",634).
component("YKR002W",588).
component("YDL103C",244).
component("YJR010W",536).
component("YGL130W",405).
component("YDR530C",332).
component("YCL050C",221).
component("YPR190C",854).
component("YPR187W",853).
component("YPR110C",846).
component("YPR010C",837).
component("YOR341W",792).
component("YOR340C",791).
component("YOR224C",781).
component("YOR210W",779).
component("YOR207C",776).
component("YOR151C",770).
component("YOR116C",764).
component("YOL005C",739).
component("YNR003C",727).
component("YNL248C",712).
component("YNL151C",706).
component("YNL113W",700).
component("YKL144C",575).
component("YJR063W",541).
component("YJL148W",526).
component("YJL140W",525).
component("YIL021W",489).
component("YHR143W-A",481).
component("YGL070C",402).
component("YFL036W",379).
component("YDR404C",321).
component("YDR156W",292).
component("YDR045C",274).
component("YDL150W",253).
component("YDL140C",248).
component("YBR154C",197).
component("YPR175W",851).
component("YPL167C",813).
component("YOR330C",789).
component("YOL115W",755).
component("YNL299W",723).
component("YNL262W",716).
component("YNL102W",699).
component("YJR043C",538).
component("YJR006W",535).
component("YJL090C",518).
component("YIL139C",501).
component("YEL055C",338).
component("YDR419W",324).
component("YDR121W",284).
component("YDL102W",243).
component("YCR014C",223).
component("YBR278W",211).
component("YBL035C",159).
component("YKL035W",565).
component("YHL012W",457).
component("YHR123W",479).
component("YPR113W",847).
component("YBR243C",205).
component("YNL130C",702).
component("YDL142C",252).
component("YPL148C",811).
component("YER026C",346).
component("YCL004W",215).
component("YGR286C",455).
component("YJL068C",515).
component("YDR058C",278).
component("YNR034W",733).
component("YHR163W",483).
component("YGR248W",449).
component("YCR073W-A",227).
component("YDL086W",238).
component("YOL011W",741).
component("YMR008C",658).
component("YMR006C",657).
component("U101_",19).
component("YBL015W",158).
component("YJL068C",516).
component("YPL072W",807).
component("YOR124C",765).
component("YNL186W",708).
component("YMR304W",690).
component("YMR223W",680).
component("YKR098C",597).
component("YJL197W",531).
component("YIL156W",503).
component("YFR010W",382).
component("YER151C",370).
component("YER144C",369).
component("YER098W",366).
component("YDR069C",279).
component("YDL122W",245).
component("YBR058C",182).
component("YBL067C",164).
component("YDR272W",303).
component("U84_",137).
component("YLR377C",640).
component("YDR074W",280).
component("YPL179W",815).
component("YNR032W",731).
component("YML057W",650).
component("YML016C",644).
component("YLR433C",643).
component("YGR123C",430).
component("YER133W",368).
component("YER089C",363).
component("YDR436W",325).
component("YDR075W",281).
component("YDL188C",259).
component("YDL134C",247).
component("YDL047W",234).
component("YDL006W",228).
component("YBR125C",191).
component("YBL056W",163).
component("YPR073C",842).
component("YHR215W",486).
component("YDL024C",231).
component("YBR093C",187).
component("YBR092C",186).
component("YAR071W",154).
component("YIL053W",492).
component("YER062C",355).
component("YHR046C",471).
component("YGR208W",445).
component("YPL228W",819).
component("YMR180C",674).
component("YDL236W",264).
component("YJL155C",528).
component("YPR073C",843).
component("YOR208W",777).
component("YNL053W",696).
component("YMR036C",662).
component("YIR026C",506).
component("YIL113W",498).
component("YFR028C",384).
component("YER075C",359).
component("YDL230W",263).
component("YBR276C",210).
component("U34_",100).
component("U33_",99).
component("U30_",98).
component("U28_",96).
...
component("U25_",94).
component("U24_",93).
component("YPL268W",828).
component("YOR360C",795).
component("YGL248W",414).
component("YKR031C",591).
component("YPL206C",816).
component("YGL027C",397).
component("YLR286C",627).
component("YJR153W",557).
component("YOR190W",774).
component("YLR300W",628).
component("YGR282C",454).
component("YDR261C",301).
component("YDR400W",319).
component("U23_",92).
component("YML035C",646).
component("YJL070C",517).
component("YBR284W",212).
component("U102_",20).
component("YNL045W",695).
component("YLR160C",618).
component("YLR158C",617).
component("YLR157C",616).
component("YLR155C",615).
component("YDR321W",310).
component("YGL037C",398).
component("YMR293C",687).
component("YDR242W",298).
component("YBR208C",201).
component("YMR281W",686).
component("U53_",115).
component("YIR027C",507).
component("YPL111W",810).
component("YIR032C",510).
component("YIR029W",508).
component("YPR062W",841).
component("YMR120C",671).
component("YLR028C",604).
component("YHR144C",482).
component("YGR267C",453).
component("YNL141W",703).
component("YBR153W",196).
component("YDL238C",265).
component("YNL141W",704).
component("YLR245C",625).
component("YML035C",647).
component("YJL126W",521).
component("U44_",107).
component("YDL100C",242).
component("U87_",139).
component("U40_",105).
component("YMR267W",684).
component("YBR011C",170).
component("YBR111C",188).
component("YBR252W",208).
component("YCL030C",219).
component("YER005W",342).
component("YIL048W",491).
component("YER166W",371).
component("YDR093W",282).
component("YAL026C",151).
component("YLR231C",623).
component("U88_",140).
component("YLR134W",612).
component("YLR044C",605).
component("YGR087C",426).
component("YDR380W",317).
component("YDL080C",237).
component("U98_",147).
component("YMR250W",682).
component("YKL184W",582).
component("YNR043W",735).
component("U93_",145).
component("YDR047W",276).
component("U54_",116).
component("YKL211C",584) :- not remove_orf("YKL211C",584).
component("YKR097W",596).
component("YOL052C",744).
component("YNL169C",707).
component("YGR170W",434).
component("YKL060C",567).
component("YNL256W",715).
component("YDR294C",305).
component("YEL046C",336).
component("YNR033W",732).
component("YPR006C",836).
component("YER065C",356).
component("YKL211C",585) :- not remove_orf("YKL211C",585).
component("YER090W",585) :- not remove_orf("YER090W",585).
component("YER090W",364) :- not remove_orf("YER090W",364).
component("YDR127W",288).
component("YPL281C",833).
component("YOR393W",800).
component("YMR323W",692).
component("YHR174W",484).
component("YGR254W",450).
component("YPL262W",825).
component("YGL026C",396) :- not remove_orf("YGL026C",396).
component("YGR155W",433).
component("YLR304C",631).
component("YJL200C",532).
component("YNL316C",724).
component("YKL182W",580).
component("YPL212C",817).
component("YNL292W",722).
component("YGL063W",401).
component("YFL001W",374).
component("YOR278W",784).
component("YPR002W",835).
component("U49_",110).
component("YDR127W",289).
component("YGL148W",406).
component("YER086W",361).
component("YLR359W",639).
component("YAL012W",149).
component("YFR055W",389).
component("YJL005W",512).
component("YOR176W",772).
component("YJL121C",520).
component("YBR019C",173).
component("YBR019C",174).
component("YDR050C",277).
component("YDR007W",267) :- not remove_orf("YDR007W",267).
component("YOR095C",763).
component("YER003C",341).
component("YBR196C",200).
component("YGL001C",391).
component("U14_",39).
component("YOL056W",747).
component("YKL152C",578).
component("YDL021W",229).
component("YMR105C",666).
component("YKL127W",572).
component("YEL058W",339).
component("YPR060C",840).
component("YHR072W",473).
component("YJL153C",527).
component("YPL097W",808).
component("YGR185C",440).
component("YGR264C",452).
component("YGR171C",435).
component("YHR011W",464).
component("YDR023W",270).
component("YPL104W",809).
component("YLL018C",598).
component("YPR081C",845).
component("YBR121C",190).
component("YHR020W",467).
component("YER087W",362).
component("YNL247W",711).
component("YOL033W",743).
component("YGL245W",413).
component("YHR091C",475).
component("YDR341C",311).
component("YOL097C",753).
component("YDR268W",302).
component("YPR047W",839).
component("YLR060W",607).
component("YFL022C",378).
component("YPR033C",838).
component("YHR019C",465).
component("YHR019C",466).
component("YPL160W",812).
component("YLR382C",641).
component("YNL073W",698).
component("YDR037W",272).
component("YOR335C",790).
component("YGR094W",428).
component("YOR317W",786).
component("YMR246W",681).
component("YIL009W",488).
component("YER015W",344).
component("YOR142W",768).
component("YGR244C",448).
component("U89_",141).
component("YOR241W",783).
component("YMR113W",668).
component("YKL132C",573).
component("YJL101C",519).
component("U92_",144).
component("YGL234W",411).
component("U91_",143).
component("U90_",142).
component("YDL141W",249).
component("YDL141W",250).
component("YGL234W",412).
component("YDL141W",251).
component("YJR103W",546).
component("YBL039C",160).
component("YGR204W",444).
component("YBR084W",185).
component("YOL058W",748).
component("YBR208C",202).
component("YHR074W",474).
component("YMR217W",678).
component("YGR061C",425).
component("YPR145W",850).
component("YGR124W",431).
component("YOR303W",785).
component("YJR109C",549).
component("YJL130C",523).
component("YGL062W",400).
component("YBR218C",203).
component("YPL231W",823).
component("YNR016C",730).
component("YKL182W",581).
component("YGR037C",421).
component("YOR005C",760).
component("YDL164C",254).
component("YOL010W",740).
component("YPR138C",849).
component("YPL274W",830).
component("YPL265W",826).
component("YPL057C",806).
component("YPL036W",805).
component("YOR348C",794).
component("YOR192C",775).
component("YOR171C",771).
component("YOR130C",766).
component("YOR071C",762).
component("YOL156W",759).
component("YOL103W",754).
component("YOL020W",742) :- not remove_orf("YOL020W",742).
component("YNR072W",738).
component("YNR056C",736).
component("YNL318C",725).
component("YNL268W",718).
component("YNL142W",705).
component("YMR272C",685).
component("YMR011W",659).
component("YML123C",656).
component("YLR348C",636).
component("YLR260W",626).
component("YLR237W",624).
component("YLR138W",613).
component("YLR100C",610).
component("YLR081W",608).
component("YLL061W",601).
component("YLL043W",600).
component("YKR093W",595).
component("YKR053C",593).
component("YKR039W",592) :- not remove_orf("YKR039W",592).
component("YKL217W",587).
component("YKL004W",561).
component("YJR158W",558).
component("YJR152W",556).
component("YJR095W",545).
component("YJR077C",543).
component("YJL219W",534).
component("YJL214W",533).
component("YJL134W",524).
component("YJL129C",522).
component("YHR096C",478).
component("YHR094C",477).
component("YHR092C",476).
component("YHL036W",460).
component("YHL016C",458).
component("YGR121C",429).
component("YGR055W",423).
component("YGL186C",408).
component("YGL077C",403).
component("YGL008C",392).
component("YFL055W",381).
component("YFL011W",375).
component("YER060W-A",352).
component("YER060W",351).
component("YER056C",350).
component("YER053C",348).
component("YEL069C",340).
component("YEL017C-A",335).
component("YDR536W",334).
component("YDR508C",330).
component("YDR503C",329).
component("YDR497C",328).
component("YDR345C",314).
component("YDR343C",313).
component("YDR342C",312).
component("YDR297W",307).
component("YDR294C",306).
component("YDR284C",304).
component("YDR046C",275) :- not remove_orf("YDR046C",275).
component("YDL245C",266).
component("YDL210W",260).
component("YCR032W",225).
component("YCR024C-A",224).
component("YCL025C",217).
component("YBR298C",214).
component("YBR291C",213).
component("YBR069C",184) :- not remove_orf("YBR069C",184).
component("YBR068C",183) :- not remove_orf("YBR068C",183).
component("YBR036C",180).
component("YBR021W",176).
component("YBL042C",161).
component("U79_",133).
component("U78_",132).
component("U75_",130).
component("U74_",129).
...
catalyst(6160,688).
catalyst(3870,349).
catalyst(3620,316) :- not remove_reaction(3620,316).
catalyst(2110,387).
catalyst(2190,387).
catalyst(5550,551).
catalyst(5791,622).
...
catalyst(1960,276).
catalyst(3460,116).
catalyst(3600,584) :- not remove_reaction(3600,584).
catalyst(8000,596).
catalyst(3941,744).
catalyst(3942,744).
catalyst(6890,707).
...
catalyst(8020,836).
catalyst(8020,356).
catalyst(1890,585) :- not remove_reaction(1890,585).
catalyst(3630,585) :- not remove_reaction(3630,585).
catalyst(1890,364) :- not remove_reaction(1890,364).
catalyst(3630,364) :- not remove_reaction(3630,364).
catalyst(3740,288).
catalyst(8231,833).
catalyst(8232,833).
catalyst(8231,800).
...
catalyst(8051,825).
catalyst(8052,825).
catalyst(3590,396) :- not remove_reaction(3590,396).
catalyst(10910,396) :- not remove_reaction(10910,396).
catalyst(4570,433).
catalyst(8181,631).
catalyst(8182,631).
catalyst(8181,532).
...
catalyst(8281,277).
catalyst(8282,277).
catalyst(3610,267) :- not remove_reaction(3610,267).
catalyst(7921,763).
catalyst(7922,763).
catalyst(7841,341).
catalyst(7842,341).
...
catalyst(1210,759).
catalyst(1160,754).
catalyst(801,742) :- not remove_reaction(801,742).
catalyst(802,742) :- not remove_reaction(802,742).
catalyst(811,742) :- not remove_reaction(811,742).
catalyst(812,742) :- not remove_reaction(812,742).
catalyst(831,742) :- not remove_reaction(831,742).
catalyst(832,742) :- not remove_reaction(832,742).
catalyst(901,742) :- not remove_reaction(901,742).
catalyst(902,742) :- not remove_reaction(902,742).
catalyst(941,742) :- not remove_reaction(941,742).
catalyst(942,742) :- not remove_reaction(942,742).
catalyst(1210,738).
catalyst(700,736).
catalyst(1200,725).
catalyst(761,718).
...
catalyst(640,595).
catalyst(6560,593).
catalyst(761,592) :- not remove_reaction(761,592).
catalyst(762,592) :- not remove_reaction(762,592).
catalyst(771,592) :- not remove_reaction(771,592).
catalyst(772,592) :- not remove_reaction(772,592).
catalyst(781,592) :- not remove_reaction(781,592).
catalyst(782,592) :- not remove_reaction(782,592).
catalyst(791,592) :- not remove_reaction(791,592).
catalyst(792,592) :- not remove_reaction(792,592).
catalyst(801,592) :- not remove_reaction(801,592).
catalyst(802,592) :- not remove_reaction(802,592).
catalyst(811,592) :- not remove_reaction(811,592).
catalyst(812,592) :- not remove_reaction(812,592).
catalyst(821,592) :- not remove_reaction(821,592).
catalyst(822,592) :- not remove_reaction(822,592).
catalyst(831,592) :- not remove_reaction(831,592).
catalyst(832,592) :- not remove_reaction(832,592).
catalyst(841,592) :- not remove_reaction(841,592).
catalyst(842,592) :- not remove_reaction(842,592).
catalyst(861,592) :- not remove_reaction(861,592).
catalyst(862,592) :- not remove_reaction(862,592).
catalyst(881,592) :- not remove_reaction(881,592).
catalyst(882,592) :- not remove_reaction(882,592).
catalyst(901,592) :- not remove_reaction(901,592).
catalyst(902,592) :- not remove_reaction(902,592).
catalyst(911,592) :- not remove_reaction(911,592).
catalyst(912,592) :- not remove_reaction(912,592).
catalyst(941,592) :- not remove_reaction(941,592).
catalyst(942,592) :- not remove_reaction(942,592).
catalyst(1191,592) :- not remove_reaction(1191,592).
catalyst(1192,592) :- not remove_reaction(1192,592).
catalyst(1021,587).
catalyst(1022,587).
catalyst(6610,561).
catalyst(1210,558).
...
catalyst(6550,306).
catalyst(6690,304).
catalyst(791,275) :- not remove_reaction(791,275).
catalyst(792,275) :- not remove_reaction(792,275).
catalyst(801,275) :- not remove_reaction(801,275).
catalyst(802,275) :- not remove_reaction(802,275).
catalyst(811,275) :- not remove_reaction(811,275).
catalyst(812,275) :- not remove_reaction(812,275).
catalyst(831,275) :- not remove_reaction(831,275).
catalyst(832,275) :- not remove_reaction(832,275).
catalyst(841,275) :- not remove_reaction(841,275).
catalyst(842,275) :- not remove_reaction(842,275).
catalyst(861,275) :- not remove_reaction(861,275).
catalyst(862,275) :- not remove_reaction(862,275).
catalyst(901,275) :- not remove_reaction(901,275).
catalyst(902,275) :- not remove_reaction(902,275).
catalyst(1210,266).
catalyst(690,260).
catalyst(730,260).
catalyst(431,225).
...
catalyst(1511,213).
catalyst(1512,213).
catalyst(771,184) :- not remove_reaction(771,184).
catalyst(772,184) :- not remove_reaction(772,184).
...
catalyst(791,183) :- not remove_reaction(791,183).
catalyst(792,183) :- not remove_reaction(792,183).
catalyst(801,183) :- not remove_reaction(801,183).
catalyst(802,183) :- not remove_reaction(802,183).
catalyst(811,183) :- not remove_reaction(811,183).
catalyst(812,183) :- not remove_reaction(812,183).
catalyst(831,183) :- not remove_reaction(831,183).
catalyst(832,183) :- not remove_reaction(832,183).
catalyst(841,183) :- not remove_reaction(841,183).
catalyst(842,183) :- not remove_reaction(842,183).
catalyst(861,183) :- not remove_reaction(861,183).
catalyst(862,183) :- not remove_reaction(862,183).
catalyst(901,183) :- not remove_reaction(901,183).
catalyst(902,183) :- not remove_reaction(902,183).
catalyst(6600,180).
catalyst(620,176).
catalyst(540,161).
catalyst(2830,133).
...
modifiable_enzyme(584).
modifiable_enzyme(585).
modifiable_enzyme(364).
modifiable_enzyme(396).
modifiable_enzyme(267).
modifiable_enzyme(742).
modifiable_enzyme(592).
modifiable_enzyme(275).
modifiable_enzyme(184).
modifiable_enzyme(183).
