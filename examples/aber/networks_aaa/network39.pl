...
component("YGR060W",175).
component("YGL012W",163).
component("YOL086C",291).
component("YMR303C",269).
component("YGL256W",171).
component("YDL168W",108).
component("YBR145W",82).
component("YPL231W",318).
component("YGL001C",160).
component("YML056C",254).
component("YLR432W",251).
component("YHR216W",194).
component("YAR075W",69).
component("YAR073W",68).
component("YDR127W",120).
component("YJR139C",222).
component("YOR136W",296).
component("YIL155C",198).
component("YJR078W",215).
component("YJR025C",211).
component("YMR015C",258).
component("YDR402C",135).
component("YJR104C",218).
component("YHR008C",187).
component("YER070W",148).
component("YDL168W",109).
component("YPL276W",325).
component("YPL275W",324).
component("YOR388C",311).
component("YGL154C",169).
component("YOR323C",305).
component("YMR170C",264).
component("YMR169C",263).
component("YBR166C",85).
component("YER014W",145).
component("YMR118C",262).
component("YLR164W",243).
component("YLL041C",239).
component("YKL148C",230).
component("YJL045W",202).
component("YDR178W",126).
component("YJR051W",212).
component("YEL047C",143).
component("YOR375C",310).
component("YDL215C",110).
component("YAL062W",67).
component("YBR035C",75).
component("YER023W",146).
component("YOR236W",303).
component("YGR204W",182).
component("U62_",49).
component("YPL017C",314).
component("YFL018C",152).
component("U47_",43).
component("YKL024C",225).
component("YPR074C",332).
component("YBR117C",81).
component("YCL009C",95).
component("YMR062C",260).
component("YPL231W",319).
component("YPL001W",313).
component("YPL231W",320).
component("YGR147C",179).
component("YDL040C",102).
component("YPL028W",315).
component("YPR001W",327).
component("YNR001C",281).
component("YNL117W",275).
component("YIR031C",200).
component("YNL029C",271).
component("YIL085C",196).
component("YLR209C",244).
component("YMR300C",268).
component("YER055C",147).
component("YDR354W",131) :- not remove_orf("YDR354W",131).
component("YFR047C",158).
component("YJR133W",221).
component("YML022W",252).
component("YDR441C",137).
component("YDR399W",133).
component("YDR127W",121).
component("YJR130C",220).
component("YLR303W",248).
component("YDR035W",115).
component("YBR249C",89).
component("YBR256C",90).
component("YHR137W",190).
component("YLR027C",240).
component("YKL106W",227).
component("YGR019W",173).
component("U64_",50).
component("U51_",45).
component("YJR148W",223).
component("YGL253W",170).
component("YFR053C",159).
component("YMR205C",266).
component("YGR240C",183).
component("YCR036W",100).
component("YCL040W",97).
component("YJR105W",219).
component("U16_",26).
component("U15_",24).
component("YKL001C",224).
component("YML070W",255).
component("YFL053W",154).
component("U83_",60).
component("U82_",59).
component("YMR208W",267).
component("YOR347C",309).
component("YAL038W",66).
component("YPR121W",334).
component("YPL258C",322).
component("YOL055C",288).
component("U1_",34).
component("YNL267W",279).
component("YLR305C",249).
component("YFR019W",156).
component("YDR208W",127).
component("YDR127W",122).
component("U20_",37).
component("YDR300C",129).
component("U18_",31).
component("U76_",58).
component("YDR454C",138).
component("YOL061W",290).
component("YKL181W",231).
component("YHL011C",185).
component("YER099C",151).
component("YBL068W",72).
component("YOR143C",297).
component("YGR007W",172).
component("YCL050C",98).
component("YPR190C",337).
component("YPR187W",336).
component("YPR110C",333).
component("YPR010C",328).
component("YOR341W",308).
component("YOR340C",307).
component("YOR224C",302).
component("YOR210W",301).
component("YOR207C",299).
component("YOR151C",298).
component("YOR116C",295).
component("YOL005C",285).
component("YNR003C",282).
component("YNL248C",278).
component("YNL151C",277).
component("YNL113W",274).
component("YKL144C",229).
component("YJR063W",213).
component("YJL148W",209).
component("YJL140W",208).
component("YIL021W",195).
component("YHR143W-A",191).
component("YGL070C",167).
component("YFL036W",153).
component("YDR404C",136).
component("YDR156W",125).
component("YDR045C",116).
component("YDL150W",106).
component("YDL140C",105).
component("YBR154C",84).
component("YKL035W",226).
component("YHL012W",186).
component("YDR058C",119).
component("YDL086W",104).
component("YOL011W",286).
component("YMR008C",257).
component("YMR006C",256).
component("U101_",18).
component("YBL015W",70).
component("U84_",61).
component("YPR073C",330).
component("YHR215W",193).
component("YDL024C",101).
component("YBR093C",79).
component("YBR092C",78).
component("YPL228W",317).
component("YMR180C",265).
component("YDL236W",112).
component("YJL155C",210).
component("YPR073C",331).
component("YOR208W",300).
component("YNL053W",273).
component("YMR036C",259).
component("YIR026C",199).
component("YIL113W",197).
component("YFR028C",157).
component("YER075C",149).
component("YDL230W",111).
component("YBR276C",91).
component("U34_",41).
component("U30_",40).
component("U24_",39).
component("YKR031C",236).
component("YLR286C",247).
component("YDR400W",134).
component("YML035C",253).
component("YJL070C",203).
component("YBR284W",92).
component("YNL045W",272).
component("YGL037C",165).
component("YBR208C",86).
component("U53_",46).
component("YIR032C",201).
component("YBR153W",83).
component("YDL238C",113).
component("YLR245C",246).
component("YJL126W",205).
component("YBR111C",80).
component("YER005W",144).
component("YLR231C",245).
component("U88_",62).
component("YLR134W",242).
component("YLR044C",241).
component("YGR087C",176).
component("YDR380W",132).
component("YDL080C",103).
component("U93_",64).
component("U54_",47).
component("YKL211C",234) :- not remove_orf("YKL211C",234).
component("YGR170W",181).
component("YDR294C",128).
component("YNR033W",284).
component("YKL211C",235) :- not remove_orf("YKL211C",235).
component("YER090W",235) :- not remove_orf("YER090W",235).
component("YER090W",150) :- not remove_orf("YER090W",150).
component("YDR127W",123).
component("YPL281C",326).
component("YOR393W",312).
component("YMR323W",270).
component("YHR174W",192).
component("YGR254W",184).
component("YGL026C",164) :- not remove_orf("YGL026C",164).
component("YGR155W",180).
component("YNL316C",280).
component("YKL182W",232).
component("YDR127W",124).
component("YGL148W",168).
component("YAL012W",65).
component("YBR019C",73).
component("YDR050C",118).
component("YDR007W",114) :- not remove_orf("YDR007W",114).
component("YOR095C",294).
component("YGL001C",161).
component("YMR105C",261).
component("YKL127W",228).
component("YPR060C",329).
component("YHR091C",189).
component("YDR341C",130).
component("YOL097C",292).
component("YOR335C",306).
component("YGR094W",177).
component("U89_",63).
component("YJL101C",204).
component("YJR103W",217).
component("YBL039C",71).
component("YOL058W",289).
component("YBR208C",87).
component("YHR074W",188).
component("YOR303W",304).
component("YGL062W",166).
component("YBR218C",88).
component("YPL231W",321).
component("YNR016C",283).
component("YKL182W",233).
component("YGR037C",174).
component("YOR005C",293).
component("YDL164C",107).
component("YPR138C",335).
component("YPL265W",323).
component("YPL036W",316).
component("YOL020W",287) :- not remove_orf("YOL020W",287).
component("YNL142W",276).
component("YLR348C",250).
component("YKR053C",238).
component("YKR039W",237) :- not remove_orf("YKR039W",237).
component("YJR095W",216).
component("YJR077C",214).
component("YJL134W",207).
component("YJL129C",206).
component("YGR121C",178).
component("YGL008C",162).
component("YFL055W",155).
component("YEL017C-A",142).
component("YDR536W",141).
component("YDR508C",140).
component("YDR503C",139).
...
catalyst(6160,268).
catalyst(3870,147).
catalyst(3620,131) :- not remove_reaction(3620,131).
catalyst(2190,158).
catalyst(5550,221).
catalyst(5650,252).
catalyst(5650,137).
...
catalyst(2300,64).
catalyst(3460,47).
catalyst(3600,234) :- not remove_reaction(3600,234).
catalyst(6900,181).
catalyst(8781,128).
catalyst(8782,128).
catalyst(2550,284).
...
catalyst(8231,184).
catalyst(8232,184).
catalyst(3590,164) :- not remove_reaction(3590,164).
catalyst(10910,164) :- not remove_reaction(10910,164).
catalyst(4570,180).
catalyst(3680,280).
catalyst(7141,232).
catalyst(7142,232).
...
catalyst(781,237) :- not remove_reaction(781,237).
catalyst(782,237) :- not remove_reaction(782,237).
...
catalyst(881,237) :- not remove_reaction(881,237).
catalyst(882,237) :- not remove_reaction(882,237).
catalyst(1191,237) :- not remove_reaction(1191,237).
catalyst(1192,237) :- not remove_reaction(1192,237).
catalyst(1250,216).
catalyst(1581,214).
catalyst(1582,214).
catalyst(6560,207).
