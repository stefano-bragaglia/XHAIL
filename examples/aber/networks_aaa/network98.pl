...
component("YNL280C",561).
component("YGR060W",337).
component("YGL012W",312).
component("YKR009C",460).
component("YOL086C",584).
component("YMR303C",537).
...
component("YPL276W",645).
component("YPL275W",644).
component("YOR388C",622).
component("YOR374W",619).
component("YER073W",282).
component("YGL154C",323).
component("U55_",94).
component("YOR323C",611).
component("YMR170C",525).
component("YMR169C",524).
component("U2_",80).
component("YBR221C",169).
component("U52_",91).
component("YBR166C",164).
component("YNL280C",562).
...
component("YOL136C",589).
component("YIL107C",387).
component("YMR205C",527).
...
component("YML070W",510).
component("YFL053W",299).
component("YHL032C",361).
component("U83_",111).
component("U82_",110).
component("U81_",109).
component("YMR208W",528).
component("YOR347C",616).
component("YAL038W",125).
component("YNR012W",570).
component("YPR121W",659).
component("YPL258C",640).
component("YOL055C",581).
component("U1_",61).
component("YDR009W",214).
component("YBR020W",143).
component("YNL267W",559).
component("YLR305C",498).
...
component("YOL061W",583).
component("YKL181W",452).
component("YHL011C",359).
component("YER099C",289).
component("YBL068W",137).
component("YOR143C",599).
component("YBR018C",140).
component("YGR007W",331).
component("YLR328W",499).
component("YKR002W",459).
component("YDL103C",196).
component("YJR010W",420).
component("YCL050C",182).
component("YPR190C",663).
component("YPR187W",662).
component("YPR110C",658).
component("YPR010C",649).
component("YOR341W",615).
component("YOR340C",614).
component("YOR224C",607).
component("YOR210W",606).
component("YOR207C",603).
component("YOR151C",600).
component("YOR116C",596).
component("YOL005C",576).
component("YNR003C",568).
component("YNL248C",555).
component("YNL151C",550).
component("YNL113W",545).
component("YKL144C",448).
...
component("YPR175W",661).
component("YPL167C",633).
component("YOR330C",612).
component("YOL115W",587).
component("YNL299W",564).
component("YNL262W",558).
component("YNL102W",544).
...
component("YNR034W",573).
component("YHR163W",377).
component("YGR248W",355).
component("YCR073W-A",187).
component("YDL086W",194).
component("YOL011W",578).
component("YMR008C",516).
component("YMR006C",515).
component("U101_",19).
component("YBL015W",131).
component("YJL068C",401).
component("YPL072W",629).
component("YOR124C",597).
component("YNL186W",552).
component("YMR304W",538).
component("YMR223W",530).
component("YKR098C",467).
...
component("YPL228W",635).
component("YMR180C",526).
component("YDL236W",211).
component("YJL155C",413).
component("YPR073C",655).
component("YOR208W",604).
component("YNL053W",542).
component("YMR036C",518).
...
component("U25_",78).
component("U24_",77).
component("YOR360C",618).
component("YGL248W",328).
component("YKR031C",462).
component("YLR286C",493).
component("YOR190W",601).
component("YLR300W",494).
component("YGR282C",358).
component("YDR261C",242).
component("YDR400W",252).
component("U23_",76).
component("YML035C",507).
component("YJL070C",402).
component("YBR284W",174).
component("U102_",20).
component("YNL045W",541).
component("YLR160C",485).
component("YLR158C",484).
component("YLR157C",483).
component("YLR155C",482).
component("YDR321W",247).
component("YGL037C",316).
component("YDR242W",239).
component("YBR208C",166).
component("YMR281W",535).
component("U53_",92).
component("YIR032C",397).
component("YIR029W",395).
component("YPR062W",653).
component("YMR120C",523).
component("YHR144C",376).
component("YNL141W",547).
component("YBR153W",162).
component("YDL238C",212).
component("YNL141W",548).
component("YLR245C",492).
component("YML035C",508).
component("YJL126W",406).
component("U44_",86).
component("U87_",114).
component("YMR267W",533).
...
component("YLR231C",490).
component("U88_",115).
component("YLR134W",479).
component("YLR044C",474).
component("YGR087C",338).
component("YDR380W",250).
component("YDL080C",193).
component("U98_",121).
component("YMR250W",531).
component("YKL184W",455).
component("YNR043W",574).
component("U93_",119).
component("YDR047W",221).
component("U54_",93).
component("YKL211C",456) :- not remove_orf("YKL211C",456).
component("YNL169C",551).
component("YGR170W",344).
component("YNL256W",557).
component("YDR294C",243).
component("YEL046C",264).
component("YNR033W",572).
...
component("YOR095C",595).
component("YER003C",268).
component("YBR196C",165).
component("YGL001C",310).
component("U14_",31).
component("YKL152C",451).
component("YMR105C",520).
component("YKL127W",446).
component("YEL058W",267).
component("YPR060C",652).
component("YHR072W",370).
component("YJL153C",412).
component("YPL097W",630).
component("YGR185C",349).
component("YPL104W",631).
component("YLL018C",468).
component("YPR081C",657).
component("YBR121C",157).
component("YHR020W",365).
component("YER087W",285).
component("YNL247W",554).
component("YOL033W",580).
component("YHR091C",372).
component("YDR341C",248).
component("YOL097C",586).
component("YPR047W",651).
component("YLR060W",475).
component("YFL022C",297).
component("YPR033C",650).
component("YPL160W",632).
component("YLR382C",504).
component("YDR037W",217).
component("YOR335C",613).
component("YGR094W",340).
component("YGR244C",354).
component("U89_",116).
component("YOR241W",609).
component("YMR113W",521).
...
component("YOL058W",582).
component("YBR208C",167).
component("YHR074W",371).
component("YMR217W",529).
component("YOR303W",610).
component("YJR109C",432).
component("YJL130C",408).
component("YGL062W",318).
component("YBR218C",168).
component("YPL231W",639).
component("YNR016C",571).
component("YKL182W",454).
component("YGR037C",334).
component("YOR005C",592).
component("YDL164C",204).
component("YOL010W",577).
component("YPR138C",660).
component("YPL265W",641).
component("YPL057C",628).
component("YPL036W",627).
component("YOR348C",617).
component("YOR192C",602).
component("YOR071C",594).
component("YOL156W",591).
component("YOL020W",579) :- not remove_orf("YOL020W",579).
component("YNR056C",575).
component("YNL318C",566).
component("YNL268W",560).
component("YNL142W",549).
component("YMR272C",534).
component("YML123C",514).
component("YLR348C",500).
component("YLR237W",491).
component("YLR138W",480).
component("YLR100C",478).
component("YLR081W",476).
component("YLL061W",471).
component("YLL043W",470).
component("YKR093W",466).
component("YKR053C",464).
component("YKR039W",463) :- not remove_orf("YKR039W",463).
component("YKL217W",458).
...
catalyst(1960,221).
catalyst(3460,93).
catalyst(3600,456) :- not remove_reaction(3600,456).
catalyst(6890,551).
catalyst(6900,344).
catalyst(2570,557).
catalyst(8781,243).
...
catalyst(941,579) :- not remove_reaction(941,579).
catalyst(942,579) :- not remove_reaction(942,579).
catalyst(700,575).
catalyst(1200,566).
catalyst(761,560).
catalyst(762,560).
...
catalyst(640,466).
catalyst(6560,464).
catalyst(761,463) :- not remove_reaction(761,463).
catalyst(762,463) :- not remove_reaction(762,463).
catalyst(771,463) :- not remove_reaction(771,463).
catalyst(772,463) :- not remove_reaction(772,463).
catalyst(781,463) :- not remove_reaction(781,463).
catalyst(782,463) :- not remove_reaction(782,463).
catalyst(791,463) :- not remove_reaction(791,463).
catalyst(792,463) :- not remove_reaction(792,463).
catalyst(801,463) :- not remove_reaction(801,463).
catalyst(802,463) :- not remove_reaction(802,463).
catalyst(811,463) :- not remove_reaction(811,463).
catalyst(812,463) :- not remove_reaction(812,463).
catalyst(821,463) :- not remove_reaction(821,463).
catalyst(822,463) :- not remove_reaction(822,463).
catalyst(831,463) :- not remove_reaction(831,463).
catalyst(832,463) :- not remove_reaction(832,463).
catalyst(841,463) :- not remove_reaction(841,463).
catalyst(842,463) :- not remove_reaction(842,463).
catalyst(861,463) :- not remove_reaction(861,463).
catalyst(862,463) :- not remove_reaction(862,463).
catalyst(881,463) :- not remove_reaction(881,463).
catalyst(882,463) :- not remove_reaction(882,463).
catalyst(911,463) :- not remove_reaction(911,463).
catalyst(912,463) :- not remove_reaction(912,463).
catalyst(941,463) :- not remove_reaction(941,463).
catalyst(942,463) :- not remove_reaction(942,463).
catalyst(1191,463) :- not remove_reaction(1191,463).
catalyst(1192,463) :- not remove_reaction(1192,463).
catalyst(1021,458).
catalyst(1022,458).
catalyst(1250,428).
catalyst(1581,426).
