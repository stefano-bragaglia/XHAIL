...
component("YNL280C",748).
component("YLR056W",634).
component("YGR060W",444).
component("YGL012W",412).
component("YKR009C",617).
component("YOL086C",779).
component("YMR303C",717).
component("YMR083W",692).
component("YGL256W",436).
component("YDL168W",270).
component("YBR145W",203).
component("YPL231W",852).
component("U46_",112).
component("YBR149W",204).
component("YBR149W",205).
component("YJR159W",586).
component("YGL001C",409).
component("YIL094C",519).
component("YHR063C",492).
component("YBR153W",206).
component("YML056C",677).
component("YLR432W",670).
component("YHR216W",509).
component("YAR075W",165).
component("YAR073W",164).
component("YCL030C",230).
component("YDR127W",300).
component("YJR139C",580).
component("YOL126C",784).
component("YKL085W",596).
component("YDL078C",251).
component("YKL029C",591).
component("YOR136W",796).
component("YNL037C",722).
component("YDL066W",250).
component("YNL241C",738).
component("YOL059W",777).
component("YDL022W",244).
component("YLR355C",666).
component("YIL074C",517).
component("YER081W",379).
component("YML054C",676).
component("YDL174C",272).
component("YML086C",680).
component("YIL155C",525).
component("YPR191W",889).
component("YOR065W",790).
component("YJL166W",554).
component("YHR001W-A",481).
component("YGR183C",459).
component("YFR033C",405).
component("YDR529C",346).
component("YBL045C",171).
component("Q0105",18).
component("YGR088W",447).
component("YDR256C",315).
component("YKL026C",590).
component("YIR037W",535).
component("YBR244W",218).
component("YJR078W",571).
component("YJR025C",563).
component("YGR255C",471).
component("U108_",22).
component("YBL098W",175).
component("YMR015C",689).
component("YHR007C",482).
component("YDR402C",335).
component("YGL055W",419).
component("YGR175C",456).
component("YJR104C",574).
component("YHR008C",483).
component("YJL026W",537).
component("YIL066C",516).
component("YGR180C",458).
component("YER070W",376).
component("U38_",107).
component("U36_",106).
component("U35_",105).
component("YDL168W",271).
component("YDR158W",308).
component("YBR006W",178).
component("YPL276W",864).
component("YPL275W",863).
component("YOR388C",829).
component("YOR374W",826).
component("YER073W",377).
component("U68_",128).
component("YGL154C",427).
component("U55_",121).
component("YOR323C",818).
component("YMR170C",701).
component("YMR169C",700).
component("U2_",101).
component("YER178W",392).
component("YBR221C",216).
component("YIL125W",523).
component("U52_",118).
component("YBR166C",209).
component("YNL280C",749).
component("YGL012W",413).
component("U57_",123).
component("YKL216W",614).
component("YDR044W",288).
component("YER014W",360).
component("YKR009C",618).
component("YIL160C",527).
component("YGL205W",430).
component("YMR118C",697).
component("YLR164W",647).
component("YLL041C",627).
component("YKL148C",603).
component("YKL141W",601).
component("YJL045W",538).
component("YDR178W",309).
component("YJR051W",566).
component("YEL047C",354).
component("YDL215C",276).
component("YOR375C",827).
component("YDL215C",277).
component("YAL062W",162).
component("U99_",156).
component("YBR035C",188).
component("YMR189W",703).
component("U56_",122).
component("YHR037W",489).
component("YKR080W",622).
component("YER023W",362).
component("YPL023C",833).
component("YGL125W",424).
component("YOR236W",811).
component("YGR204W",463).
component("YLR142W",642).
component("U62_",126).
component("YKL150W",604).
component("YIL043C",513).
component("YHR042W",490).
component("YOR221C",809).
component("YML120C",683).
component("YKL192C",611).
component("YKL055C",593).
component("YER061C",371).
component("YGR234W",466).
component("YFR030W",404).
component("YPL017C",832).
component("YFL018C",396).
component("YDR353W",330).
component("YER042W",364).
component("YJR137C",579).
component("YPL266W",859).
component("YML110C",682).
component("YBR034C",187).
component("YPL273W",861).
component("YLL062C",630).
component("YDR410C",338).
component("U47_",113).
component("YER091C",384).
component("YJR073C",569).
component("YDR120C",298).
component("YDL033C",246).
component("YOL096C",780).
component("YLR172C",648).
component("YDR019C",284).
component("YBR176W",210).
component("YDR408C",337).
component("YMR120C",698).
component("YBL013W",166).
component("YKL024C",589).
component("YPR074C",878).
component("YBR117C",199).
component("YLR354C",665).
component("YGR043C",442).
component("YMR108W",695).
component("YCL009C",228).
component("YMR062C",691).
component("YNL071W",725).
component("YNR008W",756).
component("YIL160C",528).
component("YNL277W",747).
component("YFL017C",395).
component("YPL231W",853).
component("YER061C",372).
component("U86_",144).
component("YPL001W",831).
component("YDL052C",249).
component("U8_",148).
component("YDR148C",306).
component("YOR377W",828).
component("YGR177C",457).
component("YPL231W",854).
component("YGR147C",452).
component("YDL040C",247).
component("YPL028W",834).
component("YGL017W",414).
component("YPR001W",866).
component("YNR001C",754).
component("YCR005C",234).
component("YDL182W",273).
component("YDL131W",261).
component("YNL117W",729).
component("YIR031C",533).
component("YOR321W",817).
component("YJR143C",581).
component("YGR199W",462).
component("YDR307W",324).
component("YDL095W",256).
component("YDL093W",255).
component("YAL023C",159).
component("YNL029C",721).
component("YIL085C",518).
component("YMR261C",711).
component("YML100W",681).
component("YBR126C",202).
component("YNL192W",737).
component("YBR038W",190).
component("YBR023C",186).
component("YMR306W",719).
component("YLR342W",663).
component("YGR032W",440).
component("YLR209C",649).
component("U104_",21).
component("YOR209C",807).
component("YMR300C",716).
component("YER055C",367).
component("YDR354W",331) :- not remove_orf("YDR354W",331).
component("YFR047C",406).
component("YJR133W",578).
component("YLR209C",650).
component("YML022W",673).
component("YDR441C",341).
component("YDR399W",333).
component("YPR176C",886).
component("YPL172C",844).
component("YNR041C",762).
component("YMR101C",693).
component("YDL090C",254).
component("YBR003W",177).
component("YBR002C",176).
component("YJL167W",555).
component("YJL167W",556).
component("YNL256W",741).
component("YPR069C",875).
component("YDR127W",301).
component("YLR303W",657).
component("YGR012W",438).
component("YJR130C",577).
component("YLR303W",658).
component("YDR035W",286).
component("YBR249C",219).
component("YOR274W",813).
component("YOL143C",786).
component("YBR256C",221).
component("YHR137W",501).
component("YGL202W",429).
component("YLR027C",631).
component("YKL106W",598).
component("YKL104C",597).
component("YGR019W",439).
component("YLR089C",637).
component("U64_",127).
component("U61_",125).
component("U51_",117).
component("YJR148W",582).
component("YHR208W",507).
component("YOR184W",802).
component("YNR058W",765).
component("YIL116W",522).
component("YGL253W",435).
component("YFR053C",407).
component("YOL136C",785).
component("YIL107C",520).
component("YMR013C",688).
component("YMR205C",704).
component("YGR240C",467).
component("YDR248C",314).
component("YCR036W",240).
component("YGR194C",461).
component("YCL040W",232).
component("YJR105W",575).
component("U16_",55).
component("U15_",49).
component("YPL188W",846).
component("YJR049C",565).
component("YEL041W",352).
component("U96_",154).
component("YKL001C",587).
component("YDR236C",312).
component("YML070W",679).
component("YFL053W",399).
component("YHL032C",479).
component("YLR133W",639).
component("YDR531W",348).
component("U83_",142).
component("U82_",141).
component("U81_",140).
component("YMR208W",705).
component("YPL203W",847).
component("YOR061W",789).
component("YKL166C",606).
component("YJL164C",553).
component("YIL035C",512).
component("YHR205W",506).
component("YHR102W",499).
component("YGL019W",415).
component("YHR025W",488).
component("YOR347C",823).
component("YAL038W",161).
component("YNR012W",757).
component("YPR121W",882).
component("YPL258C",856).
component("YOL055C",773).
component("YPL214C",850).
component("U1_",78).
component("YDR009W",283).
component("YBR020W",184).
component("YNL267W",745).
component("YLR305C",660).
component("YFR019W",402).
component("YDR208W",310).
component("YDR127W",302).
component("U21_",88).
component("U20_",85).
component("YDR147W",305).
component("YDR300C",323).
component("YCR012W",235).
component("YER052C",365).
component("YER069W",375).
component("U18_",70).
component("U17_",63).
component("U76_",136).
component("YMR220W",707).
component("YER170W",391).
component("YDR226W",311).
component("YKL067W",595).
component("YOL055C",774).
component("YDR454C",342).
component("YJR057W",567).
component("YOL061W",778).
component("YKL181W",607).
component("YHL011C",476).
component("YER099C",386).
component("YBL068W",174).
component("YOR143C",798).
component("YNL256W",742).
component("YLR328W",661).
component("YBR018C",180).
component("YBR018C",181).
component("YGR007W",437).
component("YLR328W",662).
component("YKR002W",616).
component("YDL103C",259).
component("U94_",153).
component("YJR010W",562).
component("YGL130W",425).
component("YDR530C",347).
component("YCL050C",233).
component("YPR190C",888).
component("YPR187W",887).
component("YPR110C",880).
component("YPR010C",869).
component("YOR341W",822).
component("YOR340C",821).
component("YOR224C",810).
component("YOR210W",808).
component("YOR207C",805).
component("YOR151C",799).
component("YOR116C",793).
component("YOL005C",767).
component("YNR003C",755).
component("YNL248C",740).
component("YNL151C",734).
component("YNL113W",728).
component("YKL144C",602).
component("YJR063W",568).
component("YJL148W",550).
component("YJL140W",549).
component("YIL021W",511).
component("YHR143W-A",502).
component("YGL070C",422).
component("YFL036W",398).
component("YDR404C",336).
component("YDR156W",307).
component("YDR045C",289).
component("YDL150W",268).
component("YDL140C",263).
component("YBR154C",208).
component("YPR175W",885).
component("YPL167C",843).
component("YOR330C",819).
component("YOL115W",783).
component("YNL299W",751).
component("YNL262W",744).
component("YNL102W",727).
component("YJR043C",564).
component("YJR006W",561).
component("YJL090C",542).
component("YIL139C",524).
component("YEL055C",355).
component("YDR419W",339).
component("YDR121W",299).
component("YDL102W",258).
component("YCR014C",236).
component("YBR278W",223).
component("YBL035C",168).
component("YKL035W",592).
component("YHL012W",477).
component("YHR123W",500).
component("YPR113W",881).
component("YBR243C",217).
component("YNL130C",730).
component("YDL142C",267).
component("YPL148C",841).
component("YER026C",363).
component("YCL004W",227).
component("YGR286C",475).
component("YJL068C",539).
component("YDR058C",293).
component("YNR034W",761).
component("YHR163W",504).
component("YGR248W",469).
component("YCR073W-A",241).
component("YDL086W",253).
component("YOL011W",769).
component("YMR008C",686).
component("YMR006C",685).
component("U101_",19).
component("YBL015W",167).
component("YJL068C",540).
component("YPL072W",837).
component("YOR124C",794).
component("YNL186W",736).
component("YMR304W",718).
component("YMR223W",708).
component("YKR098C",625).
component("YJL197W",557).
component("YIL156W",526).
component("YFR010W",401).
component("YER151C",389).
component("YER144C",388).
component("YER098W",385).
component("YDR069C",294).
component("YDL122W",260).
component("YBR058C",191).
component("YBL067C",173).
component("YDR272W",318).
component("U84_",143).
component("YLR377C",668).
component("YDR074W",295).
component("YPL179W",845).
component("YNR032W",759).
component("YML057W",678).
component("YML016C",672).
component("YLR433C",671).
component("YGR123C",450).
component("YER133W",387).
component("YER089C",382).
component("YDR436W",340).
component("YDR075W",296).
component("YDL188C",274).
component("YDL134C",262).
component("YDL047W",248).
component("YDL006W",242).
component("YBR125C",201).
component("YBL056W",172).
component("YPR073C",876).
component("YHR215W",508).
component("YDL024C",245).
component("YBR093C",197).
component("YBR092C",196).
component("YAR071W",163).
component("YIL053W",515).
component("YER062C",373).
component("YHR046C",491).
component("U9_",157).
component("YGR208W",465).
component("YPL228W",851).
component("YMR180C",702).
component("YDL236W",279).
component("YJL155C",552).
component("YPR073C",877).
component("YOR208W",806).
component("YNL053W",724).
component("YMR036C",690).
component("YIR026C",530).
component("YIL113W",521).
component("YFR028C",403).
component("YER075C",378).
component("YDL230W",278).
component("YBR276C",222).
component("U34_",104).
component("U33_",103).
component("U30_",102).
component("U28_",100).
...
component("U25_",98).
component("U24_",97).
component("YPL268W",860).
component("YOR360C",825).
component("YGL248W",434).
component("YKR031C",619).
component("YPL206C",848).
component("YGL027C",417).
component("YLR286C",655).
component("YJR153W",584).
component("YBR184W",211).
component("YOR190W",803).
component("YLR300W",656).
component("YGR282C",474).
component("YDR261C",316).
component("YDR400W",334).
component("U23_",96).
component("YML035C",674).
component("YJL070C",541).
component("YBR284W",224).
component("U102_",20).
component("YNL045W",723).
component("YLR160C",646).
component("YLR158C",645).
component("YLR157C",644).
component("YLR155C",643).
component("YDR321W",325).
component("YGL037C",418).
component("YMR293C",715).
component("YDR242W",313).
component("YBR208C",213).
component("YMR281W",714).
component("U53_",119).
component("YIR027C",531).
component("YPL111W",840).
component("YIR032C",534).
component("YIR029W",532).
component("YPR062W",874).
component("YMR120C",699).
component("YLR028C",632).
component("YHR144C",503).
component("YGR267C",473).
component("YNL141W",731).
component("YBR153W",207).
component("YDL238C",280).
component("YNL141W",732).
component("YLR245C",653).
component("YML035C",675).
component("YBR084W",194).
component("YJL126W",545).
component("U44_",111).
component("YDL100C",257).
component("U87_",145).
component("U40_",109).
component("YMR267W",712).
component("YBR011C",179).
component("YBR111C",198).
component("YBR252W",220).
component("YCL030C",231).
component("YER005W",359).
component("YIL048W",514).
component("YER166W",390).
component("YDR093W",297).
component("YAL026C",160).
component("YLR231C",651).
component("U88_",146).
component("YLR134W",640).
component("YLR044C",633).
component("YGR087C",446).
component("YDR380W",332).
component("YDL080C",252).
component("U98_",155).
component("YMR250W",710).
component("YKL184W",610).
component("YEL021W",351).
component("YNR043W",763).
component("U93_",152).
component("YDR047W",291).
component("U54_",120).
component("YKL211C",612) :- not remove_orf("YKL211C",612).
component("YKR097W",624).
component("YOL052C",772).
component("YNL169C",735).
component("YGR170W",454).
component("YKL060C",594).
component("YNL256W",743).
component("YDR294C",320).
component("YEL046C",353).
component("YNR033W",760).
component("YPR006C",868).
component("YER065C",374).
component("YKL211C",613) :- not remove_orf("YKL211C",613).
component("YER090W",613) :- not remove_orf("YER090W",613).
component("YER090W",383) :- not remove_orf("YER090W",383).
component("YDR127W",303).
component("YPL281C",865).
component("YOR393W",830).
component("YMR323W",720).
component("YHR174W",505).
component("YGR254W",470).
component("YPL262W",857).
component("YGL026C",416) :- not remove_orf("YGL026C",416).
component("YGR155W",453).
component("YLR304C",659).
component("YJL200C",558).
component("YNL316C",752).
component("YKL182W",608).
component("YPL212C",849).
component("YNL292W",750).
component("YGL063W",421).
component("YFL001W",393).
component("YOR278W",814).
component("YPR002W",867).
component("U49_",114).
component("YDR127W",304).
component("YGL148W",426).
component("YIL168W",529).
component("YER086W",380).
component("YLR359W",667).
component("YAL012W",158).
component("YFR055W",408).
component("YJL005W",536).
component("YOR176W",801).
component("YJL121C",544).
component("YBR019C",182).
component("YBR019C",183).
component("YDR050C",292).
component("YDR007W",282) :- not remove_orf("YDR007W",282).
component("YOR095C",792).
component("YER003C",358).
component("YBR196C",212).
component("YGL001C",410).
component("U14_",42).
component("YOL056W",775).
component("YKL152C",605).
component("YDL021W",243).
component("YMR105C",694).
component("YKL127W",599).
component("YEL058W",356).
component("YPR060C",873).
component("YHR072W",493).
component("YJL153C",551).
component("YPL097W",838).
component("YGR185C",460).
component("YGR264C",472).
component("YGR171C",455).
component("YHR011W",484).
component("YDR023W",285).
component("YPL104W",839).
component("YLL018C",626).
component("YPR081C",879).
component("YBR121C",200).
component("YHR020W",487).
component("YER087W",381).
component("YNL247W",739).
component("YOL033W",771).
component("YGL245W",433).
component("YHR091C",495).
component("YDR341C",326).
component("YOL097C",781).
component("YDR268W",317).
component("YPR047W",872).
component("YLR060W",635).
component("YFL022C",397).
component("YPR033C",870).
component("YHR019C",485).
component("YCR024C",237).
component("YHR019C",486).
component("YPL160W",842).
component("YLR382C",669).
component("YNL073W",726).
component("YDR037W",287).
component("YOR335C",820).
component("YGR094W",448).
component("YOR317W",816).
component("YMR246W",709).
component("YIL009W",510).
component("YER015W",361).
component("YOR142W",797).
component("YGR244C",468).
component("YPR035W",871).
component("U89_",147).
component("YOR241W",812).
component("YMR113W",696).
component("YKL132C",600).
component("YJL101C",543).
component("U92_",151).
component("YGL234W",431).
component("U91_",150).
component("U90_",149).
component("YDL141W",264).
component("YDL141W",265).
component("YGL234W",432).
component("YDL141W",266).
component("YJR103W",573).
component("YBL039C",169).
component("YGR204W",464).
component("YBR084W",195).
component("YOL058W",776).
component("YBR208C",214).
component("YHR074W",494).
component("YMR217W",706).
component("YGR061C",445).
component("YPR145W",884).
component("YGR124W",451).
component("YOR303W",815).
component("YJR109C",576).
component("YJL130C",547).
component("YGL062W",420).
component("YBR218C",215).
component("YPL231W",855).
component("YNR016C",758).
component("YKL182W",609).
component("YGR037C",441).
component("YOR005C",788).
component("YDL164C",269).
component("YOL010W",768).
component("YPR138C",883).
component("YPL274W",862).
component("YPL265W",858).
component("YPL057C",836).
component("YPL036W",835).
component("YOR348C",824).
component("YOR192C",804).
component("YOR171C",800).
component("YOR130C",795).
component("YOR071C",791).
component("YOL156W",787).
component("YOL103W",782).
component("YOL020W",770) :- not remove_orf("YOL020W",770).
component("YNR072W",766).
component("YNR056C",764).
component("YNL318C",753).
component("YNL268W",746).
component("YNL142W",733).
component("YMR272C",713).
component("YMR011W",687).
component("YML123C",684).
component("YLR348C",664).
component("YLR260W",654).
component("YLR237W",652).
component("YLR138W",641).
component("YLR100C",638).
component("YLR081W",636).
component("YLL061W",629).
component("YLL043W",628).
component("YKR093W",623).
component("YKR053C",621).
component("YKR039W",620) :- not remove_orf("YKR039W",620).
component("YKL217W",615).
component("YKL004W",588).
component("YJR158W",585).
component("YJR152W",583).
component("YJR095W",572).
component("YJR077C",570).
component("YJL219W",560).
component("YJL214W",559).
component("YJL134W",548).
component("YJL129C",546).
component("YHR096C",498).
component("YHR094C",497).
component("YHR092C",496).
component("YHL036W",480).
component("YHL016C",478).
component("YGR121C",449).
component("YGR055W",443).
component("YGL186C",428).
component("YGL077C",423).
component("YGL008C",411).
component("YFL055W",400).
component("YFL011W",394).
component("YER060W-A",370).
component("YER060W",369).
component("YER056C",368).
component("YER053C",366).
component("YEL069C",357).
component("YEL017C-A",350).
component("YDR536W",349).
component("YDR508C",345).
component("YDR503C",344).
component("YDR497C",343).
component("YDR345C",329).
component("YDR343C",328).
component("YDR342C",327).
component("YDR297W",322).
component("YDR294C",321).
component("YDR284C",319).
component("YDR046C",290) :- not remove_orf("YDR046C",290).
component("YDL245C",281).
component("YDL210W",275).
component("YCR032W",239).
component("YCR024C-A",238).
component("YCL025C",229).
component("YBR298C",226).
component("YBR291C",225).
component("YBR069C",193) :- not remove_orf("YBR069C",193).
component("YBR068C",192) :- not remove_orf("YBR068C",192).
component("YBR036C",189).
component("YBR021W",185).
component("YBL042C",170).
component("U7_",139).
component("U79_",138).
component("U78_",137).
component("U75_",135).
...
catalyst(6160,716).
catalyst(3870,367).
catalyst(3620,331) :- not remove_reaction(3620,331).
catalyst(2110,406).
catalyst(2190,406).
catalyst(5550,578).
catalyst(5791,650).
...
catalyst(1960,291).
catalyst(3460,120).
catalyst(3600,612) :- not remove_reaction(3600,612).
catalyst(8000,624).
catalyst(3941,772).
catalyst(3942,772).
catalyst(6890,735).
...
catalyst(8020,868).
catalyst(8020,374).
catalyst(1890,613) :- not remove_reaction(1890,613).
catalyst(3630,613) :- not remove_reaction(3630,613).
catalyst(1890,383) :- not remove_reaction(1890,383).
catalyst(3630,383) :- not remove_reaction(3630,383).
catalyst(3740,303).
catalyst(8231,865).
catalyst(8232,865).
catalyst(8231,830).
...
catalyst(8051,857).
catalyst(8052,857).
catalyst(3590,416) :- not remove_reaction(3590,416).
catalyst(10910,416) :- not remove_reaction(10910,416).
catalyst(4570,453).
catalyst(8181,659).
catalyst(8182,659).
catalyst(8181,558).
...
catalyst(8281,292).
catalyst(8282,292).
catalyst(3610,282) :- not remove_reaction(3610,282).
catalyst(7921,792).
catalyst(7922,792).
catalyst(7841,358).
catalyst(7842,358).
...
catalyst(1210,787).
catalyst(1160,782).
catalyst(801,770) :- not remove_reaction(801,770).
catalyst(802,770) :- not remove_reaction(802,770).
catalyst(811,770) :- not remove_reaction(811,770).
catalyst(812,770) :- not remove_reaction(812,770).
catalyst(831,770) :- not remove_reaction(831,770).
catalyst(832,770) :- not remove_reaction(832,770).
catalyst(901,770) :- not remove_reaction(901,770).
catalyst(902,770) :- not remove_reaction(902,770).
catalyst(941,770) :- not remove_reaction(941,770).
catalyst(942,770) :- not remove_reaction(942,770).
catalyst(1210,766).
catalyst(700,764).
catalyst(1200,753).
catalyst(761,746).
...
catalyst(640,623).
catalyst(6560,621).
catalyst(761,620) :- not remove_reaction(761,620).
catalyst(762,620) :- not remove_reaction(762,620).
catalyst(771,620) :- not remove_reaction(771,620).
catalyst(772,620) :- not remove_reaction(772,620).
catalyst(781,620) :- not remove_reaction(781,620).
catalyst(782,620) :- not remove_reaction(782,620).
catalyst(791,620) :- not remove_reaction(791,620).
catalyst(792,620) :- not remove_reaction(792,620).
catalyst(801,620) :- not remove_reaction(801,620).
catalyst(802,620) :- not remove_reaction(802,620).
catalyst(811,620) :- not remove_reaction(811,620).
catalyst(812,620) :- not remove_reaction(812,620).
catalyst(821,620) :- not remove_reaction(821,620).
catalyst(822,620) :- not remove_reaction(822,620).
catalyst(831,620) :- not remove_reaction(831,620).
catalyst(832,620) :- not remove_reaction(832,620).
catalyst(841,620) :- not remove_reaction(841,620).
catalyst(842,620) :- not remove_reaction(842,620).
catalyst(861,620) :- not remove_reaction(861,620).
catalyst(862,620) :- not remove_reaction(862,620).
catalyst(881,620) :- not remove_reaction(881,620).
catalyst(882,620) :- not remove_reaction(882,620).
catalyst(901,620) :- not remove_reaction(901,620).
catalyst(902,620) :- not remove_reaction(902,620).
catalyst(911,620) :- not remove_reaction(911,620).
catalyst(912,620) :- not remove_reaction(912,620).
catalyst(921,620) :- not remove_reaction(921,620).
catalyst(922,620) :- not remove_reaction(922,620).
catalyst(941,620) :- not remove_reaction(941,620).
catalyst(942,620) :- not remove_reaction(942,620).
catalyst(1191,620) :- not remove_reaction(1191,620).
catalyst(1192,620) :- not remove_reaction(1192,620).
catalyst(1021,615).
catalyst(1022,615).
catalyst(6610,588).
catalyst(1210,585).
...
catalyst(6550,321).
catalyst(6690,319).
catalyst(791,290) :- not remove_reaction(791,290).
catalyst(792,290) :- not remove_reaction(792,290).
catalyst(801,290) :- not remove_reaction(801,290).
catalyst(802,290) :- not remove_reaction(802,290).
catalyst(811,290) :- not remove_reaction(811,290).
catalyst(812,290) :- not remove_reaction(812,290).
catalyst(831,290) :- not remove_reaction(831,290).
catalyst(832,290) :- not remove_reaction(832,290).
catalyst(841,290) :- not remove_reaction(841,290).
catalyst(842,290) :- not remove_reaction(842,290).
catalyst(861,290) :- not remove_reaction(861,290).
catalyst(862,290) :- not remove_reaction(862,290).
catalyst(901,290) :- not remove_reaction(901,290).
catalyst(902,290) :- not remove_reaction(902,290).
catalyst(1210,281).
catalyst(690,275).
catalyst(730,275).
catalyst(431,239).
...
catalyst(1511,225).
catalyst(1512,225).
catalyst(771,193) :- not remove_reaction(771,193).
catalyst(772,193) :- not remove_reaction(772,193).
catalyst(791,193) :- not remove_reaction(791,193).
catalyst(792,193) :- not remove_reaction(792,193).
catalyst(801,193) :- not remove_reaction(801,193).
catalyst(802,193) :- not remove_reaction(802,193).
catalyst(811,193) :- not remove_reaction(811,193).
catalyst(812,193) :- not remove_reaction(812,193).
catalyst(861,193) :- not remove_reaction(861,193).
catalyst(862,193) :- not remove_reaction(862,193).
catalyst(901,193) :- not remove_reaction(901,193).
catalyst(902,193) :- not remove_reaction(902,193).
catalyst(791,192) :- not remove_reaction(791,192).
catalyst(792,192) :- not remove_reaction(792,192).
catalyst(801,192) :- not remove_reaction(801,192).
catalyst(802,192) :- not remove_reaction(802,192).
catalyst(811,192) :- not remove_reaction(811,192).
catalyst(812,192) :- not remove_reaction(812,192).
catalyst(831,192) :- not remove_reaction(831,192).
catalyst(832,192) :- not remove_reaction(832,192).
catalyst(841,192) :- not remove_reaction(841,192).
catalyst(842,192) :- not remove_reaction(842,192).
catalyst(861,192) :- not remove_reaction(861,192).
catalyst(862,192) :- not remove_reaction(862,192).
catalyst(901,192) :- not remove_reaction(901,192).
catalyst(902,192) :- not remove_reaction(902,192).
catalyst(6600,189).
catalyst(620,185).
catalyst(540,170).
catalyst(6960,139).
...
modifiable_enzyme(612).
modifiable_enzyme(613).
modifiable_enzyme(383).
modifiable_enzyme(416).
modifiable_enzyme(282).
modifiable_enzyme(770).
modifiable_enzyme(620).
modifiable_enzyme(290).
