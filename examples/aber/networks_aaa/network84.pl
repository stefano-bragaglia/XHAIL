...
component("YNL280C",508).
component("YGR060W",304).
component("YGL012W",282).
component("YOL086C",529).
component("YMR303C",486).
component("YGL256W",298).
component("YDL168W",183).
component("YBR145W",142).
component("YPL231W",579).
component("YBR149W",143).
component("YGL001C",279).
component("YIL094C",349).
component("YHR063C",333).
component("YBR153W",144).
component("YML056C",462).
component("YLR432W",458).
component("YHR216W",343).
component("YAR075W",114).
component("YAR073W",113).
component("YDR127W",201).
component("YJR139C",395).
component("YOL126C",533).
component("YDL078C",173).
component("YKL029C",399).
component("YOR136W",543).
component("YDL066W",172).
component("YLR355C",455).
component("YML086C",464).
component("YIL155C",353).
component("YPR191W",606).
component("YOR065W",538).
component("YJL166W",374).
component("YHR001W-A",328).
component("YGR183C",314).
component("YFR033C",275).
component("YDR529C",234).
component("YBL045C",120).
component("Q0105",18).
component("YGR088W",306).
component("YDR256C",215).
component("YJR078W",386).
component("YJR025C",381).
component("YGR255C",322).
component("YBL098W",123).
component("YMR015C",470).
component("YDR402C",226).
component("YGL055W",286).
component("YGR175C",312).
component("YJR104C",389).
component("YHR008C",329).
component("YER070W",254).
component("U35_",72).
component("YDL168W",184).
component("YDR158W",209).
component("YPL276W",588).
component("YPL275W",587).
component("YOR388C",565).
component("YGL154C",292).
component("U55_",81).
component("YOR323C",555).
component("YMR170C",478).
component("YMR169C",477).
component("U2_",69).
component("YBR221C",151).
component("U52_",78).
component("YBR166C",147).
component("YNL280C",509).
component("YGL012W",283).
component("U57_",82).
component("YER014W",243).
component("YKR009C",416).
component("YIL160C",355).
component("YGL205W",295).
component("YMR118C",475).
component("YLR164W",440).
component("YLL041C",424).
component("YKL148C",406).
component("YJL045W",360).
component("YDR178W",210).
component("YJR051W",383).
component("YEL047C",238).
component("YOR375C",563).
component("YDL215C",186).
component("YAL062W",111).
component("U99_",107).
component("YBR035C",130).
component("YHR037W",330).
component("YKR080W",420).
component("YER023W",244).
component("YOR236W",552).
component("YGR204W",316).
component("YLR142W",435).
component("U62_",84).
component("YKL150W",407).
component("YIL043C",345).
component("YHR042W",331).
component("YFR030W",274).
component("YPL017C",568).
component("YFL018C",266).
component("YER042W",246).
component("YJR137C",394).
component("YPL266W",585).
component("YML110C",466).
component("YBR034C",129).
component("YPL273W",586).
component("YLL062C",426).
component("U47_",75).
component("YER091C",257).
component("YDL033C",170).
component("YOL096C",530).
component("YDR019C",191).
component("YDR408C",228).
component("YBL013W",115).
component("YKL024C",398).
component("YPR074C",598).
component("YBR117C",139).
component("YLR354C",454).
component("YGR043C",302).
component("YCL009C",160).
component("YMR062C",472).
component("YNL071W",492).
component("YNR008W",516).
component("YPL231W",580).
component("YER061C",252).
component("U86_",99).
component("YPL001W",567).
component("YDR148C",207).
component("YOR377W",564).
component("YGR177C",313).
component("YPL231W",581).
component("YGR147C",309).
component("YDL040C",171).
component("YPL028W",569).
component("YPR001W",590).
component("YNR001C",514).
component("YDL182W",185).
component("YDL131W",178).
component("YNL117W",495).
component("YIR031C",358).
component("YNL029C",489).
component("YIL085C",348).
component("YMR261C",483).
component("YML100W",465).
component("YBR126C",141).
component("YNL192W",501).
component("YBR038W",132).
component("YBR023C",128).
component("YLR209C",441).
component("U104_",21).
component("YMR300C",485).
component("YER055C",248).
component("YDR354W",222) :- not remove_orf("YDR354W",222).
component("YFR047C",276).
component("YJR133W",393).
component("YLR209C",442).
component("YML022W",459).
component("YDR441C",230).
component("YDR399W",224).
component("YJL167W",375).
component("YNL256W",504).
component("YDR127W",202).
component("YLR303W",448).
component("YJR130C",392).
component("YLR303W",449).
component("YDR035W",192).
component("YBR249C",152).
component("YOL143C",535).
component("YBR256C",153).
component("YHR137W",337).
component("YGL202W",294).
component("YLR027C",427).
component("YKL106W",402).
component("YKL104C",401).
component("YGR019W",300).
component("YLR089C",431).
component("U64_",85).
component("U51_",77).
component("YJR148W",396).
component("YGL253W",297).
component("YFR053C",277).
component("YOL136C",534).
component("YIL107C",350).
component("YMR205C",480).
component("YGR240C",318).
component("YDR248C",214).
component("YCR036W",167).
component("YCL040W",162).
component("YJR105W",390).
component("U16_",38).
component("U15_",35).
component("U96_",105).
component("YKL001C",397).
component("YML070W",463).
component("YFL053W",269).
component("YHL032C",326).
component("U83_",97).
component("U82_",96).
component("U81_",95).
component("YMR208W",481).
component("YOR347C",560).
component("YAL038W",110).
component("YNR012W",517).
component("YPR121W",601).
component("YPL258C",583).
component("YOL055C",526).
component("U1_",52).
component("YBR020W",126).
component("YNL267W",506).
component("YLR305C",451).
component("YFR019W",272).
component("YDR208W",211).
component("YDR127W",203).
component("U21_",60).
component("U20_",58).
component("YDR147W",206).
component("YDR300C",219).
component("YCR012W",164).
component("U18_",47).
component("U76_",93).
component("YER170W",263).
component("YDR226W",212).
component("YDR454C",231).
component("YOL061W",528).
component("YKL181W",409).
component("YHL011C",324).
component("YER099C",259).
component("YBL068W",122).
component("YOR143C",544).
component("YGR007W",299).
component("YLR328W",452).
component("YJR010W",380).
component("YCL050C",163).
component("YPR190C",605).
component("YPR187W",604).
component("YPR110C",600).
component("YPR010C",592).
component("YOR341W",559).
component("YOR340C",558).
component("YOR224C",551).
component("YOR210W",550).
component("YOR207C",548).
component("YOR151C",545).
component("YOR116C",541).
component("YOL005C",522).
component("YNR003C",515).
component("YNL248C",503).
component("YNL151C",499).
component("YNL113W",494).
component("YKL144C",405).
component("YJR063W",384).
component("YJL148W",372).
component("YJL140W",371).
component("YIL021W",344).
component("YHR143W-A",338).
component("YGL070C",289).
component("YFL036W",268).
component("YDR404C",227).
component("YDR156W",208).
component("YDR045C",193).
component("YDL150W",181).
component("YDL140C",179).
component("YBR154C",146).
component("YPR175W",603).
component("YPL167C",576).
component("YOR330C",556).
component("YOL115W",532).
component("YNL299W",511).
component("YNL262W",505).
component("YNL102W",493).
component("YJR043C",382).
component("YJR006W",379).
component("YJL090C",364).
component("YIL139C",352).
component("YEL055C",239).
component("YDR419W",229).
component("YDR121W",200).
component("YDL102W",176).
component("YCR014C",165).
component("YBR278W",155).
component("YBL035C",117).
component("YKL035W",400).
component("YHL012W",325).
component("YHR123W",336).
component("YER026C",245).
component("YCL004W",159).
component("YJL068C",361).
component("YDR058C",197).
component("YNR034W",520).
component("YHR163W",340).
component("YGR248W",320).
component("YCR073W-A",168).
component("YDL086W",175).
component("YOL011W",523).
component("YMR008C",469).
component("YMR006C",468).
component("U101_",19).
component("YBL015W",116).
component("YJL068C",362).
component("YPL072W",572).
component("YOR124C",542).
component("YNL186W",500).
component("YMR304W",487).
component("YMR223W",482).
component("YKR098C",422).
component("YJL197W",376).
component("YIL156W",354).
component("YFR010W",271).
component("YER151C",261).
component("YER144C",260).
component("YER098W",258).
component("YDR069C",198).
component("YDL122W",177).
component("YBR058C",133).
component("YBL067C",121).
component("U84_",98).
component("YPR073C",596).
component("YHR215W",342).
component("YDL024C",169).
component("YBR093C",137).
component("YBR092C",136).
component("YAR071W",112).
component("YIL053W",347).
component("YER062C",253).
component("YHR046C",332).
component("YGR208W",317).
component("YPL228W",578).
component("YMR180C",479).
component("YDL236W",188).
component("YJL155C",373).
component("YPR073C",597).
component("YOR208W",549).
component("YNL053W",491).
component("YMR036C",471).
component("YIR026C",356).
component("YIL113W",351).
component("YFR028C",273).
component("YER075C",255).
component("YDL230W",187).
component("YBR276C",154).
component("U34_",71).
component("U30_",70).
component("U25_",68).
component("U24_",67).
component("YOR360C",562).
component("YGL248W",296).
component("YKR031C",417).
component("YLR286C",446).
component("YOR190W",546).
component("YLR300W",447).
component("YGR282C",323).
component("YDR261C",216).
component("YDR400W",225).
component("U23_",66).
component("YML035C",460).
component("YJL070C",363).
component("YBR284W",156).
component("U102_",20).
component("YNL045W",490).
component("YLR160C",439).
component("YLR158C",438).
component("YLR157C",437).
component("YLR155C",436).
component("YDR321W",220).
component("YGL037C",285).
component("YDR242W",213).
component("YBR208C",148).
component("U53_",79).
component("YIR032C",359).
component("YIR029W",357).
component("YMR120C",476).
component("YHR144C",339).
component("YNL141W",496).
component("YBR153W",145).
component("YDL238C",189).
component("YNL141W",497).
component("YLR245C",445).
component("YML035C",461).
component("YJL126W",367).
component("U87_",100).
component("YBR111C",138).
component("YER005W",242).
component("YIL048W",346).
component("YER166W",262).
component("YDR093W",199).
component("YAL026C",109).
component("YLR231C",443).
component("U88_",101).
component("YLR134W",433).
component("YLR044C",428).
component("YGR087C",305).
component("YDR380W",223).
component("YDL080C",174).
component("U98_",106).
component("YKL184W",412).
component("YNR043W",521).
component("U93_",104).
component("YDR047W",195).
component("U54_",80).
component("YKL211C",413) :- not remove_orf("YKL211C",413).
component("YGR170W",311).
component("YDR294C",217).
component("YEL046C",237).
component("YNR033W",519).
component("YKL211C",414) :- not remove_orf("YKL211C",414).
component("YER090W",414) :- not remove_orf("YER090W",414).
component("YER090W",256) :- not remove_orf("YER090W",256).
component("YDR127W",204).
component("YPL281C",589).
component("YOR393W",566).
component("YMR323W",488).
component("YHR174W",341).
component("YGR254W",321).
component("YGL026C",284) :- not remove_orf("YGL026C",284).
component("YGR155W",310).
component("YLR304C",450).
component("YJL200C",377).
component("YNL316C",512).
component("YKL182W",410).
component("YPL212C",577).
component("YNL292W",510).
component("YGL063W",288).
component("YFL001W",264).
component("YPR002W",591).
component("YDR127W",205).
component("YGL148W",291).
component("YLR359W",456).
component("YAL012W",108).
component("YFR055W",278).
component("YJL121C",366).
component("YBR019C",124).
component("YBR019C",125).
component("YDR050C",196).
component("YDR007W",190) :- not remove_orf("YDR007W",190).
component("YOR095C",540).
component("YER003C",241).
component("YGL001C",280).
component("U14_",30).
component("YKL152C",408).
component("YMR105C",473).
component("YKL127W",403).
component("YEL058W",240).
component("YPR060C",595).
component("YPL097W",573).
component("YGR185C",315).
component("YPL104W",574).
component("YLL018C",423).
component("YPR081C",599).
component("YBR121C",140).
component("YNL247W",502).
component("YOL033W",525).
component("YHR091C",335).
component("YDR341C",221).
component("YOL097C",531).
component("YPR047W",594).
component("YLR060W",429).
component("YFL022C",267).
component("YPR033C",593).
component("YPL160W",575).
component("YLR382C",457).
component("YOR335C",557).
component("YGR094W",307).
component("YGR244C",319).
component("U89_",102).
component("YOR241W",553).
component("YMR113W",474).
component("YKL132C",404).
component("YJL101C",365).
component("U91_",103).
component("YDL141W",180).
component("YJR103W",388).
component("YBL039C",118).
component("YOL058W",527).
component("YBR208C",149).
component("YHR074W",334).
component("YOR303W",554).
component("YJR109C",391).
component("YJL130C",369).
component("YGL062W",287).
component("YBR218C",150).
component("YPL231W",582).
component("YNR016C",518).
component("YKL182W",411).
component("YGR037C",301).
component("YOR005C",537).
component("YDL164C",182).
component("YPR138C",602).
component("YPL265W",584).
component("YPL057C",571).
component("YPL036W",570).
component("YOR348C",561).
component("YOR192C",547).
component("YOR071C",539).
component("YOL156W",536).
component("YOL020W",524) :- not remove_orf("YOL020W",524).
component("YNL318C",513).
component("YNL268W",507).
component("YNL142W",498).
component("YMR272C",484).
component("YML123C",467).
component("YLR348C",453).
component("YLR237W",444).
component("YLR138W",434).
component("YLR100C",432).
component("YLR081W",430).
component("YLL061W",425).
component("YKR093W",421).
component("YKR053C",419).
component("YKR039W",418) :- not remove_orf("YKR039W",418).
component("YKL217W",415).
component("YJR095W",387).
component("YJR077C",385).
component("YJL219W",378).
component("YJL134W",370).
component("YJL129C",368).
component("YHL036W",327).
component("YGR121C",308).
component("YGR055W",303).
component("YGL186C",293).
component("YGL077C",290).
component("YGL008C",281).
component("YFL055W",270).
component("YFL011W",265).
component("YER060W-A",251).
component("YER060W",250).
component("YER056C",249).
component("YER053C",247).
component("YEL017C-A",236).
component("YDR536W",235).
component("YDR508C",233).
component("YDR503C",232).
component("YDR294C",218).
component("YDR046C",194) :- not remove_orf("YDR046C",194).
...
catalyst(6160,485).
catalyst(3870,248).
catalyst(3620,222) :- not remove_reaction(3620,222).
catalyst(2110,276).
catalyst(2190,276).
catalyst(5550,393).
catalyst(5791,442).
...
catalyst(1960,195).
catalyst(3460,80).
catalyst(3600,413) :- not remove_reaction(3600,413).
catalyst(6900,311).
catalyst(8781,217).
catalyst(8782,217).
catalyst(4560,237).
...
catalyst(3630,256) :- not remove_reaction(3630,256).
catalyst(3740,204).
catalyst(8231,589).
catalyst(8232,589).
catalyst(8231,566).
...
catalyst(8231,321).
catalyst(8232,321).
catalyst(3590,284) :- not remove_reaction(3590,284).
catalyst(10910,284) :- not remove_reaction(10910,284).
catalyst(4570,310).
catalyst(8181,450).
catalyst(8182,450).
catalyst(8181,377).
...
catalyst(8281,196).
catalyst(8282,196).
catalyst(3610,190) :- not remove_reaction(3610,190).
catalyst(7921,540).
catalyst(7922,540).
catalyst(7841,241).
catalyst(7842,241).
...
catalyst(640,421).
catalyst(6560,419).
catalyst(761,418) :- not remove_reaction(761,418).
catalyst(762,418) :- not remove_reaction(762,418).
catalyst(771,418) :- not remove_reaction(771,418).
catalyst(772,418) :- not remove_reaction(772,418).
catalyst(781,418) :- not remove_reaction(781,418).
catalyst(782,418) :- not remove_reaction(782,418).
catalyst(791,418) :- not remove_reaction(791,418).
catalyst(792,418) :- not remove_reaction(792,418).
catalyst(801,418) :- not remove_reaction(801,418).
catalyst(802,418) :- not remove_reaction(802,418).
catalyst(811,418) :- not remove_reaction(811,418).
catalyst(812,418) :- not remove_reaction(812,418).
catalyst(831,418) :- not remove_reaction(831,418).
catalyst(832,418) :- not remove_reaction(832,418).
catalyst(841,418) :- not remove_reaction(841,418).
catalyst(842,418) :- not remove_reaction(842,418).
catalyst(861,418) :- not remove_reaction(861,418).
catalyst(862,418) :- not remove_reaction(862,418).
catalyst(881,418) :- not remove_reaction(881,418).
catalyst(882,418) :- not remove_reaction(882,418).
catalyst(941,418) :- not remove_reaction(941,418).
catalyst(942,418) :- not remove_reaction(942,418).
catalyst(1191,418) :- not remove_reaction(1191,418).
catalyst(1192,418) :- not remove_reaction(1192,418).
catalyst(1021,415).
catalyst(1022,415).
catalyst(1250,387).
catalyst(1581,385).
...
catalyst(6680,232).
catalyst(6550,218).
catalyst(791,194) :- not remove_reaction(791,194).
catalyst(792,194) :- not remove_reaction(792,194).
catalyst(801,194) :- not remove_reaction(801,194).
catalyst(802,194) :- not remove_reaction(802,194).
catalyst(811,194) :- not remove_reaction(811,194).
catalyst(812,194) :- not remove_reaction(812,194).
catalyst(831,194) :- not remove_reaction(831,194).
catalyst(832,194) :- not remove_reaction(832,194).
catalyst(841,194) :- not remove_reaction(841,194).
catalyst(842,194) :- not remove_reaction(842,194).
catalyst(861,194) :- not remove_reaction(861,194).
catalyst(862,194) :- not remove_reaction(862,194).
catalyst(220,166).
catalyst(771,161).
catalyst(772,161).
catalyst(781,161).
