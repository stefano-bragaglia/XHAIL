...
component("YNL280C",718).
component("YLR056W",604).
component("YGR060W",423).
component("YGL012W",393).
component("YKR009C",587).
component("YOL086C",749).
component("YMR303C",687).
component("YMR083W",662).
component("YGL256W",415).
component("YDL168W",255).
component("YBR145W",193).
component("YPL231W",818).
component("U46_",108).
component("YBR149W",194).
component("YJR159W",557).
component("YGL001C",390).
component("YIL094C",495).
component("YHR063C",471).
component("YBR153W",195).
component("YML056C",647).
component("YLR432W",640).
component("YHR216W",486).
component("YAR075W",156).
component("YAR073W",155).
component("YCL030C",218).
component("YDR127W",285).
component("YJR139C",551).
component("YOL126C",754).
component("YKL085W",567).
component("YDL078C",236).
component("YKL029C",562).
component("YOR136W",765).
component("YNL037C",692).
component("YDL066W",235).
component("YNL241C",708).
component("YOL059W",747).
component("YDL022W",230).
component("YLR355C",636).
component("YIL074C",493).
component("YER081W",360).
component("YML054C",646).
component("YDL174C",257).
component("YML086C",650).
component("YIL155C",501).
component("YPR191W",853).
component("YOR065W",759).
component("YJL166W",527).
component("YHR001W-A",460).
component("YGR183C",438).
component("YFR033C",386).
component("YDR529C",331).
component("YBL045C",162).
component("Q0105",18).
component("YGR088W",426).
component("YDR256C",300).
component("YKL026C",561).
component("YIR037W",509).
component("YBR244W",206).
component("YJR078W",542).
component("YJR025C",535).
component("YGR255C",450).
component("U108_",22).
component("YBL098W",166).
component("YMR015C",659).
component("YHR007C",461).
component("YDR402C",320).
component("YGL055W",398).
component("YGR175C",435).
component("YJR104C",545).
component("YHR008C",462).
component("YJL026W",511).
component("YIL066C",492).
component("YGR180C",437).
...
component("YPL276W",830).
component("YPL275W",829).
component("YOR388C",797).
component("YOR374W",794).
component("YER073W",358).
component("U68_",123).
component("YGL154C",406).
component("U55_",117).
component("YOR323C",786).
component("YMR170C",671).
component("YMR169C",670).
component("U2_",97).
component("YER178W",373).
component("YBR221C",204).
component("YIL125W",499).
component("U52_",114).
component("YBR166C",198).
component("YNL280C",719).
component("YGL012W",394).
component("U57_",118).
component("YKL216W",584).
component("YDR044W",273).
component("YER014W",343).
component("YKR009C",588).
component("YIL160C",503).
component("YGL205W",409).
component("YMR118C",667).
component("YLR164W",617).
component("YLL041C",597).
component("YKL148C",574).
component("YKL141W",572).
component("YJL045W",512).
component("YDR178W",294).
component("YJR051W",537).
component("YEL047C",337).
component("YDL215C",261).
component("YOR375C",795).
component("YDL215C",262).
component("YAL062W",153).
component("U99_",148).
component("YBR035C",179).
component("YMR189W",673).
component("YHR037W",468).
component("YKR080W",592).
component("YER023W",345).
component("YPL023C",801).
component("YGL125W",403).
component("YOR236W",780).
component("YGR204W",442).
component("YLR142W",612).
component("U62_",121).
component("YKL150W",575).
component("YIL043C",489).
component("YHR042W",469).
component("YOR221C",778).
component("YML120C",653).
component("YKL192C",581).
component("YKL055C",564).
component("YER061C",353).
component("YGR234W",445).
component("YFR030W",385).
component("YPL017C",800).
component("YFL018C",377).
component("YDR353W",315).
component("YER042W",347).
component("YJR137C",550).
component("YPL266W",825).
component("YML110C",652).
component("YBR034C",178).
component("YPL273W",827).
component("YLL062C",600).
component("YDR410C",323).
component("U47_",109).
component("YER091C",365).
component("YJR073C",540).
component("YDR120C",283).
component("YDL033C",232).
component("YOL096C",750).
component("YLR172C",618).
component("YDR019C",269).
component("YBR176W",199).
component("YDR408C",322).
component("YMR120C",668).
component("YBL013W",157).
component("YKL024C",560).
component("YPR074C",842).
component("YBR117C",189).
component("YLR354C",635).
component("YGR043C",421).
component("YMR108W",665).
component("YCL009C",216).
component("YMR062C",661).
component("YNL071W",695).
component("YNR008W",726).
component("YNL277W",717).
component("YFL017C",376).
component("YPL231W",819).
component("YER061C",354).
component("U86_",138).
component("YPL001W",799).
component("YDR148C",291).
component("YOR377W",796).
component("YGR177C",436).
component("YPL231W",820).
component("YGR147C",431).
component("YDL040C",233).
component("YPL028W",802).
component("YGL017W",395).
component("YPR001W",832).
component("YNR001C",724).
component("YDL182W",258).
component("YDL131W",246).
component("YNL117W",699).
component("YIR031C",507).
component("YOR321W",785).
component("YJR143C",552).
component("YGR199W",441).
component("YDR307W",309).
component("YDL095W",241).
component("YDL093W",240).
component("YAL023C",150).
component("YNL029C",691).
component("YIL085C",494).
component("YMR261C",681).
component("YML100W",651).
component("YBR126C",192).
component("YNL192W",707).
component("YBR038W",181).
component("YBR023C",177).
component("YMR306W",689).
component("YLR342W",633).
component("YGR032W",419).
component("YLR209C",619).
component("U104_",21).
component("YOR209C",776).
component("YMR300C",686).
component("YER055C",349).
component("YDR354W",316) :- not remove_orf("YDR354W",316).
component("YFR047C",387).
component("YJR133W",549).
component("YLR209C",620).
component("YML022W",643).
component("YDR441C",326).
component("YDR399W",318).
component("YPR176C",850).
component("YPL172C",812).
component("YNR041C",732).
component("YMR101C",663).
component("YDL090C",239).
component("YBR003W",168).
component("YBR002C",167).
component("YJL167W",528).
component("YNL256W",711).
component("YDR127W",286).
component("YLR303W",627).
component("YGR012W",417).
component("YJR130C",548).
component("YLR303W",628).
component("YDR035W",271).
component("YBR249C",207).
component("YOL143C",756).
component("YBR256C",209).
component("YHR137W",479).
component("YGL202W",408).
component("YLR027C",601).
component("YKL106W",569).
component("YKL104C",568).
component("YGR019W",418).
component("YLR089C",607).
component("U64_",122).
component("U61_",120).
component("U51_",113).
component("YJR148W",553).
component("YHR208W",484).
component("YOR184W",771).
component("YNR058W",735).
component("YIL116W",498).
component("YGL253W",414).
component("YFR053C",388).
component("YOL136C",755).
component("YIL107C",496).
component("YMR013C",658).
component("YMR205C",674).
component("YGR240C",446).
component("YDR248C",299).
component("YCR036W",226).
component("YGR194C",440).
component("YCL040W",220).
component("YJR105W",546).
component("U16_",52).
component("U15_",46).
component("U96_",146).
component("YKL001C",558).
component("YDR236C",297).
component("YML070W",649).
component("YFL053W",380).
component("YHL032C",458).
component("YLR133W",609).
component("YDR531W",333).
component("U83_",136).
component("U82_",135).
component("U81_",134).
component("YMR208W",675).
component("YHR025W",467).
component("YOR347C",791).
component("YAL038W",152).
component("YNR012W",727).
component("YPR121W",846).
component("YPL258C",822).
component("YOL055C",743).
component("YPL214C",816).
component("U1_",75).
component("YDR009W",268).
component("YBR020W",175).
component("YNL267W",715).
component("YLR305C",630).
...
component("U17_",60).
component("U76_",131).
component("YMR220W",677).
component("YER170W",372).
component("YDR226W",296).
component("YKL067W",566).
component("YOL055C",744).
component("YDR454C",327).
component("YJR057W",538).
component("YOL061W",748).
component("YKL181W",577).
component("YHL011C",455).
component("YER099C",367).
component("YBL068W",165).
component("YOR143C",767).
component("YNL256W",712).
component("YLR328W",631).
component("YBR018C",171).
component("YBR018C",172).
component("YGR007W",416).
component("YLR328W",632).
component("YKR002W",586).
component("YDL103C",244).
component("YJR010W",534).
component("YGL130W",404).
component("YDR530C",332).
component("YCL050C",221).
component("YPR190C",852).
component("YPR187W",851).
component("YPR110C",844).
component("YPR010C",835).
component("YOR341W",790).
component("YOR340C",789).
component("YOR224C",779).
component("YOR210W",777).
component("YOR207C",774).
component("YOR151C",768).
component("YOR116C",762).
component("YOL005C",737).
component("YNR003C",725).
component("YNL248C",710).
component("YNL151C",704).
component("YNL113W",698).
component("YKL144C",573).
component("YJR063W",539).
component("YJL148W",524).
component("YJL140W",523).
component("YIL021W",488).
component("YHR143W-A",480).
component("YGL070C",401).
...
component("YPR175W",849).
component("YPL167C",811).
component("YOR330C",787).
component("YOL115W",753).
component("YNL299W",721).
component("YNL262W",714).
component("YNL102W",697).
component("YJR043C",536).
component("YJR006W",533).
component("YJL090C",516).
component("YIL139C",500).
...
component("YKL035W",563).
component("YHL012W",456).
component("YHR123W",478).
component("YPR113W",845).
component("YBR243C",205).
component("YNL130C",700).
component("YDL142C",252).
component("YPL148C",809).
component("YER026C",346).
component("YCL004W",215).
component("YGR286C",454).
component("YJL068C",513).
component("YDR058C",278).
component("YNR034W",731).
component("YHR163W",482).
component("YGR248W",448).
component("YCR073W-A",227).
component("YDL086W",238).
component("YOL011W",739).
component("YMR008C",656).
component("YMR006C",655).
component("U101_",19).
component("YBL015W",158).
component("YJL068C",514).
component("YPL072W",805).
component("YOR124C",763).
component("YNL186W",706).
component("YMR304W",688).
component("YMR223W",678).
component("YKR098C",595).
component("YJL197W",529).
component("YIL156W",502).
...
component("U84_",137).
component("YLR377C",638).
component("YDR074W",280).
component("YPL179W",813).
component("YNR032W",729).
component("YML057W",648).
component("YML016C",642).
component("YLR433C",641).
component("YGR123C",429).
...
component("YPR073C",840).
component("YHR215W",485).
component("YDL024C",231).
component("YBR093C",187).
component("YBR092C",186).
component("YAR071W",154).
component("YIL053W",491).
component("YER062C",355).
component("YHR046C",470).
component("YGR208W",444).
component("YPL228W",817).
component("YMR180C",672).
component("YDL236W",264).
component("YJL155C",526).
component("YPR073C",841).
component("YOR208W",775).
component("YNL053W",694).
component("YMR036C",660).
component("YIR026C",504).
component("YIL113W",497).
...
component("U25_",94).
component("U24_",93).
component("YPL268W",826).
component("YOR360C",793).
component("YGL248W",413).
component("YKR031C",589).
component("YPL206C",814).
component("YLR286C",625).
component("YJR153W",555).
component("YOR190W",772).
component("YLR300W",626).
component("YGR282C",453).
component("YDR261C",301).
component("YDR400W",319).
component("U23_",92).
component("YML035C",644).
component("YJL070C",515).
component("YBR284W",212).
component("U102_",20).
component("YNL045W",693).
component("YLR160C",616).
component("YLR158C",615).
component("YLR157C",614).
component("YLR155C",613).
component("YDR321W",310).
component("YGL037C",397).
component("YMR293C",685).
component("YDR242W",298).
component("YBR208C",201).
component("YMR281W",684).
component("U53_",115).
component("YIR027C",505).
component("YPL111W",808).
component("YIR032C",508).
component("YIR029W",506).
component("YPR062W",839).
component("YMR120C",669).
component("YLR028C",602).
component("YHR144C",481).
component("YGR267C",452).
component("YNL141W",701).
component("YBR153W",196).
component("YDL238C",265).
component("YNL141W",702).
component("YLR245C",623).
component("YML035C",645).
component("YJL126W",519).
component("U44_",107).
component("YDL100C",242).
component("U87_",139).
component("U40_",105).
component("YMR267W",682).
component("YBR011C",170).
component("YBR111C",188).
component("YBR252W",208).
component("YCL030C",219).
component("YER005W",342).
component("YIL048W",490).
component("YER166W",371).
component("YDR093W",282).
component("YAL026C",151).
component("YLR231C",621).
component("U88_",140).
component("YLR134W",610).
component("YLR044C",603).
component("YGR087C",425).
component("YDR380W",317).
component("YDL080C",237).
component("U98_",147).
component("YMR250W",680).
component("YKL184W",580).
component("YNR043W",733).
component("U93_",145).
component("YDR047W",276).
component("U54_",116).
component("YKL211C",582) :- not remove_orf("YKL211C",582).
component("YKR097W",594).
component("YOL052C",742).
component("YNL169C",705).
component("YGR170W",433).
component("YKL060C",565).
component("YNL256W",713).
component("YDR294C",305).
component("YEL046C",336).
component("YNR033W",730).
component("YPR006C",834).
component("YER065C",356).
component("YKL211C",583) :- not remove_orf("YKL211C",583).
component("YER090W",583) :- not remove_orf("YER090W",583).
component("YER090W",364) :- not remove_orf("YER090W",364).
component("YDR127W",288).
component("YPL281C",831).
component("YOR393W",798).
component("YMR323W",690).
component("YHR174W",483).
component("YGR254W",449).
component("YPL262W",823).
component("YGL026C",396) :- not remove_orf("YGL026C",396).
component("YGR155W",432).
component("YLR304C",629).
component("YJL200C",530).
component("YNL316C",722).
component("YKL182W",578).
component("YPL212C",815).
component("YNL292W",720).
component("YGL063W",400).
component("YFL001W",374).
component("YOR278W",782).
component("YPR002W",833).
component("U49_",110).
component("YDR127W",289).
component("YGL148W",405).
component("YER086W",361).
component("YLR359W",637).
component("YAL012W",149).
component("YFR055W",389).
component("YJL005W",510).
component("YOR176W",770).
component("YJL121C",518).
component("YBR019C",173).
component("YBR019C",174).
component("YDR050C",277).
component("YDR007W",267) :- not remove_orf("YDR007W",267).
component("YOR095C",761).
component("YER003C",341).
component("YBR196C",200).
component("YGL001C",391).
component("U14_",39).
component("YOL056W",745).
component("YKL152C",576).
component("YDL021W",229).
component("YMR105C",664).
component("YKL127W",570).
component("YEL058W",339).
component("YPR060C",838).
component("YHR072W",472).
component("YJL153C",525).
component("YPL097W",806).
component("YGR185C",439).
component("YGR264C",451).
component("YGR171C",434).
component("YHR011W",463).
component("YDR023W",270).
component("YPL104W",807).
component("YLL018C",596).
component("YPR081C",843).
component("YBR121C",190).
component("YHR020W",466).
component("YER087W",362).
component("YNL247W",709).
component("YOL033W",741).
component("YGL245W",412).
component("YHR091C",474).
component("YDR341C",311).
component("YOL097C",751).
component("YDR268W",302).
component("YPR047W",837).
component("YLR060W",605).
component("YFL022C",378).
component("YPR033C",836).
component("YHR019C",464).
component("YHR019C",465).
component("YPL160W",810).
component("YLR382C",639).
component("YNL073W",696).
component("YDR037W",272).
component("YOR335C",788).
component("YGR094W",427).
component("YOR317W",784).
component("YMR246W",679).
component("YIL009W",487).
component("YER015W",344).
component("YOR142W",766).
component("YGR244C",447).
component("U89_",141).
component("YOR241W",781).
component("YMR113W",666).
component("YKL132C",571).
component("YJL101C",517).
component("U92_",144).
component("YGL234W",410).
component("U91_",143).
component("U90_",142).
...
component("YJR103W",544).
component("YBL039C",160).
component("YGR204W",443).
component("YBR084W",185).
component("YOL058W",746).
component("YBR208C",202).
component("YHR074W",473).
component("YMR217W",676).
component("YGR061C",424).
component("YPR145W",848).
component("YGR124W",430).
component("YOR303W",783).
component("YJR109C",547).
component("YJL130C",521).
component("YGL062W",399).
component("YBR218C",203).
component("YPL231W",821).
component("YNR016C",728).
component("YKL182W",579).
component("YGR037C",420).
component("YOR005C",758).
component("YDL164C",254).
component("YOL010W",738).
component("YPR138C",847).
component("YPL274W",828).
component("YPL265W",824).
component("YPL057C",804).
component("YPL036W",803).
component("YOR348C",792).
component("YOR192C",773).
component("YOR171C",769).
component("YOR130C",764).
component("YOR071C",760).
component("YOL156W",757).
component("YOL103W",752).
component("YOL020W",740) :- not remove_orf("YOL020W",740).
component("YNR072W",736).
component("YNR056C",734).
component("YNL318C",723).
component("YNL268W",716).
component("YNL142W",703).
component("YMR272C",683).
component("YMR011W",657).
component("YML123C",654).
component("YLR348C",634).
component("YLR260W",624).
component("YLR237W",622).
component("YLR138W",611).
component("YLR100C",608).
component("YLR081W",606).
component("YLL061W",599).
component("YLL043W",598).
component("YKR093W",593).
component("YKR053C",591).
component("YKR039W",590) :- not remove_orf("YKR039W",590).
component("YKL217W",585).
component("YKL004W",559).
component("YJR158W",556).
component("YJR152W",554).
component("YJR095W",543).
component("YJR077C",541).
component("YJL219W",532).
component("YJL214W",531).
component("YJL134W",522).
component("YJL129C",520).
component("YHR096C",477).
component("YHR094C",476).
component("YHR092C",475).
component("YHL036W",459).
component("YHL016C",457).
component("YGR121C",428).
component("YGR055W",422).
component("YGL186C",407).
component("YGL077C",402).
...
catalyst(1960,276).
catalyst(3460,116).
catalyst(3600,582) :- not remove_reaction(3600,582).
catalyst(8000,594).
catalyst(3941,742).
catalyst(3942,742).
catalyst(6890,705).
...
catalyst(8020,834).
catalyst(8020,356).
catalyst(1890,583) :- not remove_reaction(1890,583).
catalyst(3630,583) :- not remove_reaction(3630,583).
...
catalyst(1210,757).
catalyst(1160,752).
catalyst(801,740) :- not remove_reaction(801,740).
catalyst(802,740) :- not remove_reaction(802,740).
catalyst(811,740) :- not remove_reaction(811,740).
catalyst(812,740) :- not remove_reaction(812,740).
catalyst(831,740) :- not remove_reaction(831,740).
catalyst(832,740) :- not remove_reaction(832,740).
catalyst(901,740) :- not remove_reaction(901,740).
catalyst(902,740) :- not remove_reaction(902,740).
catalyst(941,740) :- not remove_reaction(941,740).
catalyst(942,740) :- not remove_reaction(942,740).
catalyst(1210,736).
catalyst(700,734).
catalyst(1200,723).
catalyst(761,716).
...
catalyst(640,593).
catalyst(6560,591).
catalyst(761,590) :- not remove_reaction(761,590).
catalyst(762,590) :- not remove_reaction(762,590).
catalyst(771,590) :- not remove_reaction(771,590).
catalyst(772,590) :- not remove_reaction(772,590).
catalyst(781,590) :- not remove_reaction(781,590).
catalyst(782,590) :- not remove_reaction(782,590).
catalyst(791,590) :- not remove_reaction(791,590).
catalyst(792,590) :- not remove_reaction(792,590).
catalyst(801,590) :- not remove_reaction(801,590).
catalyst(802,590) :- not remove_reaction(802,590).
catalyst(811,590) :- not remove_reaction(811,590).
catalyst(812,590) :- not remove_reaction(812,590).
catalyst(821,590) :- not remove_reaction(821,590).
catalyst(822,590) :- not remove_reaction(822,590).
catalyst(831,590) :- not remove_reaction(831,590).
catalyst(832,590) :- not remove_reaction(832,590).
catalyst(841,590) :- not remove_reaction(841,590).
catalyst(842,590) :- not remove_reaction(842,590).
catalyst(861,590) :- not remove_reaction(861,590).
catalyst(862,590) :- not remove_reaction(862,590).
catalyst(881,590) :- not remove_reaction(881,590).
catalyst(882,590) :- not remove_reaction(882,590).
catalyst(901,590) :- not remove_reaction(901,590).
catalyst(902,590) :- not remove_reaction(902,590).
catalyst(911,590) :- not remove_reaction(911,590).
catalyst(912,590) :- not remove_reaction(912,590).
catalyst(941,590) :- not remove_reaction(941,590).
catalyst(942,590) :- not remove_reaction(942,590).
catalyst(1191,590) :- not remove_reaction(1191,590).
catalyst(1192,590) :- not remove_reaction(1192,590).
catalyst(1021,585).
catalyst(1022,585).
catalyst(6610,559).
catalyst(1210,556).
