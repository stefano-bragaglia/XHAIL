...
component("YGR060W",298).
component("YGL012W",278).
component("YOL086C",516).
component("YMR303C",475).
component("YGL256W",292).
component("YDL168W",179).
component("YBR145W",139).
component("YPL231W",565).
component("YBR149W",140).
component("YGL001C",275).
component("YIL094C",341).
component("YHR063C",326).
component("YBR153W",141).
component("YML056C",451).
component("YLR432W",447).
component("YHR216W",335).
component("YAR075W",111).
component("YAR073W",110).
component("YDR127W",197).
component("YJR139C",385).
component("YOL126C",520).
component("YDL078C",169).
component("YKL029C",389).
component("YOR136W",529).
component("YDL066W",168).
component("YLR355C",444).
component("YML086C",453).
component("YIL155C",344).
component("YPR191W",591).
component("YOR065W",524).
component("YJL166W",364).
component("YHR001W-A",321).
component("YGR183C",308).
component("YFR033C",271).
component("YDR529C",230).
component("YBL045C",117).
component("Q0105",18).
component("YGR088W",300).
component("YDR256C",211).
component("YJR078W",376).
component("YJR025C",371).
component("YGR255C",315).
component("YBL098W",120).
component("YMR015C",459).
component("YDR402C",222).
component("YGR175C",306).
component("YJR104C",379).
component("YHR008C",322).
component("YER070W",250).
component("U35_",69).
component("YDL168W",180).
component("YDR158W",205).
component("YPL276W",573).
component("YPL275W",572).
component("YOR388C",551).
component("YGL154C",287).
component("U55_",78).
component("YOR323C",541).
component("YMR170C",467).
component("YMR169C",466).
component("U2_",66).
component("YBR221C",148).
component("U52_",75).
component("YBR166C",144).
component("YNL280C",498).
component("YGL012W",279).
component("U57_",79).
component("YER014W",239).
component("YMR118C",464).
component("YLR164W",429).
component("YLL041C",413).
component("YKL148C",396).
component("YJL045W",350).
component("YDR178W",206).
component("YJR051W",373).
component("YEL047C",234).
component("YOR375C",549).
component("YDL215C",182).
component("YAL062W",108).
component("U99_",104).
component("YBR035C",127).
component("YHR037W",323).
component("YKR080W",409).
component("YER023W",240).
component("YOR236W",538).
component("YGR204W",310).
component("YLR142W",424).
component("U62_",81).
component("YKL150W",397).
component("YIL043C",337).
component("YHR042W",324).
component("YFR030W",270).
component("YPL017C",554).
component("YFL018C",262).
component("YER042W",242).
component("YJR137C",384).
component("YML110C",455).
component("YBR034C",126).
component("YPL273W",571).
component("YLL062C",415).
component("U47_",72).
component("YER091C",253).
component("YDL033C",166).
component("YOL096C",517).
component("YDR019C",187).
component("YDR408C",224).
component("YBL013W",112).
component("YKL024C",388).
component("YPR074C",583).
component("YBR117C",136).
component("YLR354C",443).
component("YGR043C",296).
component("YCL009C",157).
component("YMR062C",461).
component("YNL071W",481).
component("YNR008W",505).
component("YPL231W",566).
component("YER061C",248).
component("U86_",96).
component("YPL001W",553).
component("YDR148C",203).
component("YOR377W",550).
component("YGR177C",307).
component("YPL231W",567).
component("YGR147C",303).
component("YDL040C",167).
component("YPL028W",555).
component("YPR001W",575).
component("YNR001C",503).
component("YDL182W",181).
component("YDL131W",174).
component("YNL117W",484).
component("YIR031C",348).
component("YNL029C",478).
component("YIL085C",340).
component("YMR261C",472).
component("YML100W",454).
component("YBR126C",138).
component("YNL192W",490).
component("YBR038W",129).
component("YBR023C",125).
component("YLR209C",430).
component("U104_",21).
component("YMR300C",474).
component("YER055C",244).
component("YDR354W",218) :- not remove_orf("YDR354W",218).
component("YFR047C",272).
component("YJR133W",383).
component("YLR209C",431).
component("YML022W",448).
component("YDR441C",226).
component("YDR399W",220).
component("YJL167W",365).
component("YNL256W",493).
component("YDR127W",198).
component("YLR303W",437).
component("YJR130C",382).
component("YLR303W",438).
component("YDR035W",188).
component("YBR249C",149).
component("YOL143C",521).
component("YBR256C",150).
component("YHR137W",330).
component("YGL202W",289).
component("YLR027C",416).
component("YKL106W",392).
component("YKL104C",391).
component("YGR019W",294).
component("YLR089C",420).
component("U64_",82).
component("U51_",74).
component("YJR148W",386).
component("YGL253W",291).
component("YFR053C",273).
component("YMR205C",469).
component("YGR240C",312).
component("YDR248C",210).
component("YCR036W",164).
component("YCL040W",159).
component("YJR105W",380).
component("U16_",38).
component("U15_",35).
component("U96_",102).
component("YKL001C",387).
component("YML070W",452).
component("YFL053W",265).
component("YHL032C",319).
component("U83_",94).
component("U82_",93).
component("U81_",92).
component("YMR208W",470).
component("YOR347C",546).
component("YAL038W",107).
component("YPR121W",586).
component("YPL258C",569).
component("YOL055C",513).
component("U1_",49).
component("YBR020W",123).
component("YNL267W",495).
component("YLR305C",440).
component("YFR019W",268).
component("YDR208W",207).
component("YDR127W",199).
component("U21_",57).
component("U20_",55).
component("YDR147W",202).
component("YDR300C",215).
component("YCR012W",161).
component("U18_",45).
component("U76_",90).
component("YER170W",259).
component("YDR226W",208).
component("YDR454C",227).
component("YOL061W",515).
component("YKL181W",399).
component("YHL011C",317).
component("YER099C",255).
component("YBL068W",119).
component("YOR143C",530).
component("YGR007W",293).
component("YLR328W",441).
component("YJR010W",370).
component("YCL050C",160).
component("YPR190C",590).
component("YPR187W",589).
component("YPR110C",585).
component("YPR010C",577).
component("YOR341W",545).
component("YOR340C",544).
component("YOR224C",537).
component("YOR210W",536).
component("YOR207C",534).
component("YOR151C",531).
component("YOR116C",527).
component("YOL005C",509).
component("YNR003C",504).
component("YNL248C",492).
component("YNL151C",488).
component("YNL113W",483).
component("YKL144C",395).
component("YJR063W",374).
component("YJL148W",362).
component("YJL140W",361).
component("YIL021W",336).
component("YHR143W-A",331).
component("YGL070C",284).
component("YFL036W",264).
component("YDR404C",223).
component("YDR156W",204).
component("YDR045C",189).
component("YDL150W",177).
component("YDL140C",175).
component("YBR154C",143).
component("YPR175W",588).
component("YPL167C",562).
component("YOR330C",542).
component("YOL115W",519).
component("YNL299W",500).
component("YNL262W",494).
component("YNL102W",482).
component("YJR043C",372).
component("YJR006W",369).
component("YJL090C",354).
component("YIL139C",343).
component("YEL055C",235).
component("YDR419W",225).
component("YDR121W",196).
component("YDL102W",172).
component("YCR014C",162).
component("YBR278W",152).
component("YBL035C",114).
component("YKL035W",390).
component("YHL012W",318).
component("YHR123W",329).
component("YER026C",241).
component("YCL004W",156).
component("YJL068C",351).
component("YDR058C",193).
component("YDL086W",171).
component("YOL011W",510).
component("YMR008C",458).
component("YMR006C",457).
component("U101_",19).
component("YBL015W",113).
component("YJL068C",352).
component("YPL072W",558).
component("YOR124C",528).
component("YNL186W",489).
component("YMR304W",476).
component("YMR223W",471).
component("YKR098C",411).
component("YJL197W",366).
component("YIL156W",345).
component("YFR010W",267).
component("YER151C",257).
component("YER144C",256).
component("YER098W",254).
component("YDR069C",194).
component("YDL122W",173).
component("YBR058C",130).
component("YBL067C",118).
component("U84_",95).
component("YPR073C",581).
component("YHR215W",334).
component("YDL024C",165).
component("YBR093C",134).
component("YBR092C",133).
component("YAR071W",109).
component("YIL053W",339).
component("YER062C",249).
component("YHR046C",325).
component("YGR208W",311).
component("YPL228W",564).
component("YMR180C",468).
component("YDL236W",184).
component("YJL155C",363).
component("YPR073C",582).
component("YOR208W",535).
component("YNL053W",480).
component("YMR036C",460).
component("YIR026C",346).
component("YIL113W",342).
component("YFR028C",269).
component("YER075C",251).
component("YDL230W",183).
...
component("YGL248W",290).
component("YKR031C",406).
component("YLR286C",435).
component("YOR190W",532).
component("YLR300W",436).
component("YGR282C",316).
component("YDR261C",212).
component("YDR400W",221).
component("U23_",63).
component("YML035C",449).
component("YJL070C",353).
component("YBR284W",153).
component("U102_",20).
component("YNL045W",479).
component("YLR160C",428).
component("YLR158C",427).
component("YLR157C",426).
component("YLR155C",425).
component("YDR321W",216).
component("YGL037C",281).
component("YDR242W",209).
component("YBR208C",145).
component("U53_",76).
component("YIR032C",349).
component("YIR029W",347).
component("YMR120C",465).
component("YHR144C",332).
component("YNL141W",485).
component("YBR153W",142).
component("YDL238C",185).
component("YNL141W",486).
component("YLR245C",434).
component("YML035C",450).
component("YJL126W",357).
component("U87_",97).
component("YBR111C",135).
component("YER005W",238).
component("YIL048W",338).
component("YER166W",258).
component("YDR093W",195).
component("YAL026C",106).
component("YLR231C",432).
component("U88_",98).
component("YLR134W",422).
component("YLR044C",417).
component("YGR087C",299).
component("YDR380W",219).
component("YDL080C",170).
component("U98_",103).
component("YKL184W",402).
component("YNR043W",508).
component("U93_",101).
component("YDR047W",191).
component("U54_",77).
component("YKL211C",403) :- not remove_orf("YKL211C",403).
component("YGR170W",305).
component("YDR294C",213).
component("YEL046C",233).
component("YNR033W",507).
component("YKL211C",404) :- not remove_orf("YKL211C",404).
component("YER090W",404) :- not remove_orf("YER090W",404).
component("YER090W",252) :- not remove_orf("YER090W",252).
component("YDR127W",200).
component("YPL281C",574).
component("YOR393W",552).
component("YMR323W",477).
component("YHR174W",333).
component("YGR254W",314).
component("YGL026C",280) :- not remove_orf("YGL026C",280).
component("YGR155W",304).
component("YLR304C",439).
component("YJL200C",367).
component("YNL316C",501).
component("YKL182W",400).
component("YPL212C",563).
component("YNL292W",499).
component("YGL063W",283).
component("YFL001W",260).
component("YPR002W",576).
component("YDR127W",201).
component("YGL148W",286).
component("YLR359W",445).
component("YAL012W",105).
component("YFR055W",274).
component("YJL121C",356).
component("YBR019C",121).
component("YBR019C",122).
component("YDR050C",192).
component("YDR007W",186) :- not remove_orf("YDR007W",186).
component("YOR095C",526).
component("YER003C",237).
component("YGL001C",276).
component("U14_",30).
component("YKL152C",398).
component("YMR105C",462).
component("YKL127W",393).
component("YEL058W",236).
component("YPR060C",580).
component("YPL097W",559).
component("YGR185C",309).
component("YPL104W",560).
component("YLL018C",412).
component("YPR081C",584).
component("YBR121C",137).
component("YNL247W",491).
component("YOL033W",512).
component("YHR091C",328).
component("YDR341C",217).
component("YOL097C",518).
component("YPR047W",579).
component("YLR060W",418).
component("YFL022C",263).
component("YPR033C",578).
component("YPL160W",561).
component("YLR382C",446).
component("YOR335C",543).
component("YGR094W",301).
component("YGR244C",313).
component("U89_",99).
component("YOR241W",539).
component("YMR113W",463).
component("YKL132C",394).
component("YJL101C",355).
component("U91_",100).
component("YDL141W",176).
component("YJR103W",378).
component("YBL039C",115).
component("YOL058W",514).
component("YBR208C",146).
component("YHR074W",327).
component("YOR303W",540).
component("YJR109C",381).
component("YJL130C",359).
component("YGL062W",282).
component("YBR218C",147).
component("YPL231W",568).
component("YNR016C",506).
component("YKL182W",401).
component("YGR037C",295).
component("YOR005C",523).
component("YDL164C",178).
component("YPR138C",587).
component("YPL265W",570).
component("YPL057C",557).
component("YPL036W",556).
component("YOR348C",547).
component("YOR192C",533).
component("YOR071C",525).
component("YOL156W",522).
component("YOL020W",511) :- not remove_orf("YOL020W",511).
component("YNL318C",502).
component("YNL268W",496).
component("YNL142W",487).
component("YMR272C",473).
component("YML123C",456).
component("YLR348C",442).
component("YLR237W",433).
component("YLR138W",423).
component("YLR100C",421).
component("YLR081W",419).
component("YLL061W",414).
component("YKR093W",410).
component("YKR053C",408).
component("YKR039W",407) :- not remove_orf("YKR039W",407).
component("YKL217W",405).
component("YJR095W",377).
component("YJR077C",375).
component("YJL219W",368).
component("YJL134W",360).
component("YJL129C",358).
component("YHL036W",320).
component("YGR121C",302).
component("YGR055W",297).
component("YGL186C",288).
component("YGL077C",285).
component("YGL008C",277).
component("YFL055W",266).
component("YFL011W",261).
component("YER060W-A",247).
component("YER060W",246).
component("YER056C",245).
component("YER053C",243).
component("YEL017C-A",232).
component("YDR536W",231).
component("YDR508C",229).
component("YDR503C",228).
component("YDR294C",214).
component("YDR046C",190) :- not remove_orf("YDR046C",190).
component("YCR024C-A",163).
component("YCL025C",158).
component("YBR298C",155).
component("YBR291C",154).
component("YBR069C",132) :- not remove_orf("YBR069C",132).
component("YBR068C",131) :- not remove_orf("YBR068C",131).
component("YBR036C",128).
component("YBR021W",124).
component("YBL042C",116).
component("U79_",91).
component("U75_",89).
component("U74_",88).
component("U73_",87).
...
catalyst(6160,474).
catalyst(3870,244).
catalyst(3620,218) :- not remove_reaction(3620,218).
catalyst(2110,272).
catalyst(2190,272).
catalyst(5550,383).
catalyst(5791,431).
...
catalyst(1960,191).
catalyst(3460,77).
catalyst(3600,403) :- not remove_reaction(3600,403).
catalyst(6900,305).
catalyst(8781,213).
catalyst(8782,213).
catalyst(4560,233).
catalyst(2550,507).
catalyst(3630,404) :- not remove_reaction(3630,404).
catalyst(3630,252) :- not remove_reaction(3630,252).
catalyst(3740,200).
catalyst(8231,574).
catalyst(8232,574).
catalyst(8231,552).
...
catalyst(8231,314).
catalyst(8232,314).
catalyst(3590,280) :- not remove_reaction(3590,280).
catalyst(10910,280) :- not remove_reaction(10910,280).
catalyst(4570,304).
catalyst(8181,439).
catalyst(8182,439).
catalyst(8181,367).
...
catalyst(8281,192).
catalyst(8282,192).
catalyst(3610,186) :- not remove_reaction(3610,186).
catalyst(7921,526).
catalyst(7922,526).
catalyst(7841,237).
catalyst(7842,237).
...
catalyst(640,410).
catalyst(6560,408).
catalyst(761,407) :- not remove_reaction(761,407).
catalyst(762,407) :- not remove_reaction(762,407).
catalyst(771,407) :- not remove_reaction(771,407).
catalyst(772,407) :- not remove_reaction(772,407).
catalyst(781,407) :- not remove_reaction(781,407).
catalyst(782,407) :- not remove_reaction(782,407).
catalyst(791,407) :- not remove_reaction(791,407).
catalyst(792,407) :- not remove_reaction(792,407).
catalyst(801,407) :- not remove_reaction(801,407).
catalyst(802,407) :- not remove_reaction(802,407).
catalyst(811,407) :- not remove_reaction(811,407).
catalyst(812,407) :- not remove_reaction(812,407).
catalyst(831,407) :- not remove_reaction(831,407).
catalyst(832,407) :- not remove_reaction(832,407).
catalyst(841,407) :- not remove_reaction(841,407).
catalyst(842,407) :- not remove_reaction(842,407).
catalyst(861,407) :- not remove_reaction(861,407).
catalyst(862,407) :- not remove_reaction(862,407).
catalyst(881,407) :- not remove_reaction(881,407).
catalyst(882,407) :- not remove_reaction(882,407).
catalyst(941,407) :- not remove_reaction(941,407).
catalyst(942,407) :- not remove_reaction(942,407).
catalyst(1191,407) :- not remove_reaction(1191,407).
catalyst(1192,407) :- not remove_reaction(1192,407).
catalyst(1021,405).
catalyst(1022,405).
catalyst(1250,377).
catalyst(1581,375).
...
catalyst(831,190) :- not remove_reaction(831,190).
catalyst(832,190) :- not remove_reaction(832,190).
catalyst(841,190) :- not remove_reaction(841,190).
catalyst(842,190) :- not remove_reaction(842,190).
...
catalyst(791,132) :- not remove_reaction(791,132).
catalyst(792,132) :- not remove_reaction(792,132).
...
catalyst(861,132) :- not remove_reaction(861,132).
catalyst(862,132) :- not remove_reaction(862,132).
catalyst(791,131) :- not remove_reaction(791,131).
catalyst(792,131) :- not remove_reaction(792,131).
...
catalyst(861,131) :- not remove_reaction(861,131).
catalyst(862,131) :- not remove_reaction(862,131).
catalyst(6600,128).
catalyst(620,124).
catalyst(540,116).
catalyst(2830,91).
