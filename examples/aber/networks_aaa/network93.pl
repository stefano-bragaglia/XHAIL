...
component("YNL280C",543).
component("YGR060W",325).
component("YGL012W",301).
component("YOL086C",565).
component("YMR303C",520).
component("YGL256W",319).
component("YDL168W",197).
component("YBR145W",153).
component("YPL231W",616).
component("U46_",83).
component("YBR149W",154).
component("YGL001C",298).
component("YIL094C",373).
component("YHR063C",356).
component("YBR153W",155).
component("YML056C",492).
component("YLR432W",488).
component("YHR216W",367).
component("YAR075W",124).
component("YAR073W",123).
component("YDR127W",219).
component("YJR139C",422).
component("YOL126C",569).
component("YDL078C",186).
component("YKL029C",426).
component("YOR136W",579).
component("YDL066W",185).
component("YLR355C",485).
component("YML086C",494).
component("YIL155C",377).
component("YPR191W",644).
component("YOR065W",574).
component("YJL166W",400).
component("YHR001W-A",351).
component("YGR183C",336).
component("YFR033C",294).
component("YDR529C",252).
component("YBL045C",130).
component("Q0105",18).
component("YGR088W",327).
component("YDR256C",233).
component("YJR078W",413).
component("YJR025C",407).
component("YGR255C",345).
component("YBL098W",133).
component("YMR015C",500).
component("YDR402C",244).
component("YGL055W",306).
component("YGR175C",333).
component("YJR104C",416).
component("YHR008C",352).
component("YJL026W",384).
component("YGR180C",335).
component("YER070W",272).
component("U35_",79).
component("YDL168W",198).
component("YDR158W",227).
component("YPL276W",625).
component("YPL275W",624).
component("YOR388C",602).
component("YOR374W",599).
component("YER073W",273).
component("YGL154C",312).
component("U55_",90).
component("YOR323C",591).
component("YMR170C",508).
component("YMR169C",507).
component("U2_",76).
component("YBR221C",163).
component("U52_",87).
component("YBR166C",158).
component("YNL280C",544).
component("YGL012W",302).
component("U57_",91).
component("YDR044W",210).
component("YER014W",261).
component("YKR009C",445).
component("YIL160C",379).
component("YGL205W",315).
component("YMR118C",505).
component("YLR164W",470).
component("YLL041C",453).
component("YKL148C",434).
component("YJL045W",385).
component("YDR178W",228).
component("YJR051W",409).
component("YEL047C",256).
component("YOR375C",600).
component("YDL215C",201).
component("YAL062W",121).
component("U99_",117).
component("YBR035C",141).
component("YHR037W",353).
component("YKR080W",449).
component("YER023W",262).
component("YOR236W",588).
component("YGR204W",338).
component("YLR142W",465).
component("U62_",93).
component("YKL150W",435).
component("YIL043C",369).
component("YHR042W",354).
component("YFR030W",293).
component("YPL017C",605).
component("YFL018C",285).
component("YER042W",264).
component("YJR137C",421).
component("YPL266W",622).
component("YML110C",496).
component("YBR034C",140).
component("YPL273W",623).
component("YLL062C",456).
component("U47_",84).
component("YER091C",276).
component("YJR073C",411).
component("YDL033C",183).
component("YOL096C",566).
component("YDR019C",207).
component("YDR408C",246).
component("YBL013W",125).
component("YKL024C",425).
component("YPR074C",636).
component("YBR117C",150).
component("YLR354C",484).
component("YGR043C",323).
component("YCL009C",172).
component("YMR062C",502).
component("YNL071W",526).
component("YNR008W",551).
component("YPL231W",617).
component("YER061C",270).
component("U86_",108).
component("YPL001W",604).
component("YDR148C",225).
component("YOR377W",601).
component("YGR177C",334).
component("YPL231W",618).
component("YGR147C",330).
component("YDL040C",184).
component("YPL028W",606).
component("YGL017W",303).
component("YPR001W",627).
component("YNR001C",549).
component("YDL182W",199).
component("YDL131W",191).
component("YNL117W",529).
component("YIR031C",382).
component("YNL029C",523).
component("YIL085C",372).
component("YMR261C",515).
component("YML100W",495).
component("YBR126C",152).
component("YNL192W",536).
component("YBR038W",143).
component("YBR023C",139).
component("YLR209C",471).
component("U104_",21).
component("YMR300C",519).
component("YER055C",266).
component("YDR354W",240) :- not remove_orf("YDR354W",240).
component("YFR047C",295).
component("YJR133W",420).
component("YLR209C",472).
component("YML022W",489).
component("YDR441C",248).
component("YDR399W",242).
component("YJL167W",401).
component("YNL256W",539).
component("YDR127W",220).
component("YLR303W",478).
component("YJR130C",419).
component("YLR303W",479).
component("YDR035W",208).
component("YBR249C",164).
component("YOL143C",571).
component("YBR256C",165).
component("YHR137W",361).
component("YGL202W",314).
component("YLR027C",457).
component("YKL106W",430).
component("YKL104C",429).
component("YGR019W",321).
component("YLR089C",461).
component("U64_",94).
component("U51_",86).
component("YJR148W",423).
component("YGL253W",318).
component("YFR053C",296).
component("YOL136C",570).
component("YIL107C",374).
component("YMR205C",510).
component("YGR240C",341).
component("YDR248C",232).
component("YCR036W",180).
component("YCL040W",175).
component("YJR105W",417).
component("U16_",38).
component("U15_",35).
component("U96_",115).
component("YKL001C",424).
component("YML070W",493).
component("YFL053W",288).
component("YHL032C",349).
component("U83_",106).
component("U82_",105).
component("U81_",104).
component("YMR208W",511).
component("YOR347C",596).
component("YAL038W",120).
component("YNR012W",552).
component("YPR121W",639).
component("YPL258C",620).
component("YOL055C",562).
component("U1_",58).
component("YDR009W",206).
component("YBR020W",137).
component("YNL267W",541).
component("YLR305C",481).
component("YFR019W",291).
component("YDR208W",229).
component("YDR127W",221).
component("U21_",67).
component("U20_",65).
component("YDR147W",224).
component("YDR300C",237).
component("YCR012W",177).
component("U18_",51).
component("U17_",45).
component("U76_",102).
component("YER170W",282).
component("YDR226W",230).
component("YKL067W",428).
component("YDR454C",249).
component("YOL061W",564).
component("YKL181W",437).
component("YHL011C",347).
component("YER099C",278).
component("YBL068W",132).
component("YOR143C",580).
component("YGR007W",320).
component("YLR328W",482).
component("YKR002W",444).
component("YJR010W",406).
component("YCL050C",176).
component("YPR190C",643).
component("YPR187W",642).
component("YPR110C",638).
component("YPR010C",629).
component("YOR341W",595).
component("YOR340C",594).
component("YOR224C",587).
component("YOR210W",586).
component("YOR207C",584).
component("YOR151C",581).
component("YOR116C",577).
component("YOL005C",558).
component("YNR003C",550).
component("YNL248C",538).
component("YNL151C",533).
component("YNL113W",528).
component("YKL144C",433).
component("YJR063W",410).
component("YJL148W",397).
component("YJL140W",396).
component("YIL021W",368).
component("YHR143W-A",362).
component("YGL070C",309).
component("YFL036W",287).
component("YDR404C",245).
component("YDR156W",226).
component("YDR045C",211).
component("YDL150W",195).
component("YDL140C",192).
component("YBR154C",157).
component("YPR175W",641).
component("YPL167C",613).
component("YOR330C",592).
component("YOL115W",568).
component("YNL299W",546).
component("YNL262W",540).
component("YNL102W",527).
component("YJR043C",408).
component("YJR006W",405).
component("YJL090C",389).
component("YIL139C",376).
component("YEL055C",257).
component("YDR419W",247).
component("YDR121W",218).
component("YDL102W",189).
component("YCR014C",178).
component("YBR278W",167).
component("YBL035C",127).
component("YKL035W",427).
component("YHL012W",348).
component("YHR123W",360).
component("YDL142C",194).
component("YER026C",263).
component("YCL004W",171).
component("YJL068C",386).
component("YDR058C",215).
component("YNR034W",555).
component("YHR163W",364).
component("YGR248W",343).
component("YCR073W-A",181).
component("YDL086W",188).
component("YOL011W",559).
component("YMR008C",499).
component("YMR006C",498).
component("U101_",19).
component("YBL015W",126).
component("YJL068C",387).
component("YPL072W",609).
component("YOR124C",578).
component("YNL186W",535).
component("YMR304W",521).
component("YMR223W",513).
component("YKR098C",451).
component("YJL197W",402).
component("YIL156W",378).
component("YFR010W",290).
component("YER151C",280).
component("YER144C",279).
component("YER098W",277).
component("YDR069C",216).
component("YDL122W",190).
component("YBR058C",144).
component("YBL067C",131).
component("U84_",107).
component("YPR073C",634).
component("YHR215W",366).
component("YDL024C",182).
component("YBR093C",148).
component("YBR092C",147).
component("YAR071W",122).
component("YIL053W",371).
component("YER062C",271).
component("YHR046C",355).
component("YGR208W",340).
component("YPL228W",615).
component("YMR180C",509).
component("YDL236W",203).
component("YJL155C",399).
component("YPR073C",635).
component("YOR208W",585).
component("YNL053W",525).
component("YMR036C",501).
component("YIR026C",380).
component("YIL113W",375).
component("YFR028C",292).
component("YER075C",274).
component("YDL230W",202).
component("YBR276C",166).
component("U34_",78).
component("U30_",77).
component("U25_",75).
component("U24_",74).
component("YOR360C",598).
component("YGL248W",317).
component("YKR031C",446).
component("YLR286C",476).
component("YOR190W",582).
component("YLR300W",477).
component("YGR282C",346).
component("YDR261C",234).
component("YDR400W",243).
component("U23_",73).
component("YML035C",490).
component("YJL070C",388).
component("YBR284W",168).
component("U102_",20).
component("YNL045W",524).
component("YLR160C",469).
component("YLR158C",468).
component("YLR157C",467).
component("YLR155C",466).
component("YDR321W",238).
component("YGL037C",305).
component("YDR242W",231).
component("YBR208C",160).
component("YMR281W",518).
component("U53_",88).
component("YIR032C",383).
component("YIR029W",381).
component("YPR062W",633).
component("YMR120C",506).
component("YHR144C",363).
component("YNL141W",530).
component("YBR153W",156).
component("YDL238C",204).
component("YNL141W",531).
component("YLR245C",475).
component("YML035C",491).
component("YJL126W",392).
component("U44_",82).
component("U87_",109).
component("YMR267W",516).
component("YBR011C",134).
component("YBR111C",149).
component("YCL030C",174).
component("YER005W",260).
component("YIL048W",370).
component("YER166W",281).
component("YDR093W",217).
component("YAL026C",119).
component("YLR231C",473).
component("U88_",110).
component("YLR134W",463).
component("YLR044C",458).
component("YGR087C",326).
component("YDR380W",241).
component("YDL080C",187).
component("U98_",116).
component("YMR250W",514).
component("YKL184W",440).
component("YNR043W",556).
component("U93_",114).
component("YDR047W",213).
component("U54_",89).
component("YKL211C",441) :- not remove_orf("YKL211C",441).
component("YNL169C",534).
component("YGR170W",332).
component("YDR294C",235).
component("YEL046C",255).
component("YNR033W",554).
component("YKL211C",442) :- not remove_orf("YKL211C",442).
component("YER090W",442) :- not remove_orf("YER090W",442).
component("YER090W",275) :- not remove_orf("YER090W",275).
component("YDR127W",222).
component("YPL281C",626).
component("YOR393W",603).
component("YMR323W",522).
component("YHR174W",365).
component("YGR254W",344).
component("YGL026C",304) :- not remove_orf("YGL026C",304).
component("YGR155W",331).
component("YLR304C",480).
component("YJL200C",403).
component("YNL316C",547).
component("YKL182W",438).
component("YPL212C",614).
component("YNL292W",545).
component("YGL063W",308).
component("YFL001W",283).
component("YPR002W",628).
component("YDR127W",223).
component("YGL148W",311).
component("YLR359W",486).
component("YAL012W",118).
component("YFR055W",297).
component("YJL121C",391).
component("YBR019C",135).
component("YBR019C",136).
component("YDR050C",214).
component("YDR007W",205) :- not remove_orf("YDR007W",205).
component("YOR095C",576).
component("YER003C",259).
component("YBR196C",159).
component("YGL001C",299).
component("U14_",30).
component("YKL152C",436).
component("YMR105C",503).
component("YKL127W",431).
component("YEL058W",258).
component("YPR060C",632).
component("YHR072W",357).
component("YJL153C",398).
component("YPL097W",610).
component("YGR185C",337).
component("YPL104W",611).
component("YLL018C",452).
component("YPR081C",637).
component("YBR121C",151).
component("YNL247W",537).
component("YOL033W",561).
component("YHR091C",359).
component("YDR341C",239).
component("YOL097C",567).
component("YPR047W",631).
component("YLR060W",459).
component("YFL022C",286).
component("YPR033C",630).
component("YPL160W",612).
component("YLR382C",487).
component("YDR037W",209).
component("YOR335C",593).
component("YGR094W",328).
component("YGR244C",342).
component("U89_",111).
component("YOR241W",589).
component("YMR113W",504).
component("YKL132C",432).
component("YJL101C",390).
component("U92_",113).
component("YGL234W",316).
component("U91_",112).
component("YDL141W",193).
component("YJR103W",415).
component("YBL039C",128).
component("YGR204W",339).
component("YOL058W",563).
component("YBR208C",161).
component("YHR074W",358).
component("YMR217W",512).
component("YOR303W",590).
component("YJR109C",418).
component("YJL130C",394).
component("YGL062W",307).
component("YBR218C",162).
component("YPL231W",619).
component("YNR016C",553).
component("YKL182W",439).
component("YGR037C",322).
component("YOR005C",573).
component("YDL164C",196).
component("YPR138C",640).
component("YPL265W",621).
component("YPL057C",608).
component("YPL036W",607).
component("YOR348C",597).
component("YOR192C",583).
component("YOR071C",575).
component("YOL156W",572).
component("YOL020W",560) :- not remove_orf("YOL020W",560).
component("YNR056C",557).
component("YNL318C",548).
component("YNL268W",542).
component("YNL142W",532).
component("YMR272C",517).
component("YML123C",497).
component("YLR348C",483).
component("YLR237W",474).
component("YLR138W",464).
component("YLR100C",462).
component("YLR081W",460).
component("YLL061W",455).
component("YLL043W",454).
component("YKR093W",450).
component("YKR053C",448).
component("YKR039W",447) :- not remove_orf("YKR039W",447).
component("YKL217W",443).
component("YJR095W",414).
component("YJR077C",412).
component("YJL219W",404).
component("YJL134W",395).
component("YJL129C",393).
component("YHL036W",350).
component("YGR121C",329).
component("YGR055W",324).
component("YGL186C",313).
component("YGL077C",310).
component("YGL008C",300).
component("YFL055W",289).
component("YFL011W",284).
component("YER060W-A",269).
component("YER060W",268).
component("YER056C",267).
component("YER053C",265).
component("YEL017C-A",254).
component("YDR536W",253).
component("YDR508C",251).
component("YDR503C",250).
component("YDR294C",236).
component("YDR046C",212) :- not remove_orf("YDR046C",212).
component("YDL210W",200).
component("YCR024C-A",179).
component("YCL025C",173).
component("YBR298C",170).
component("YBR291C",169).
component("YBR069C",146) :- not remove_orf("YBR069C",146).
component("YBR068C",145) :- not remove_orf("YBR068C",145).
component("YBR036C",142).
component("YBR021W",138).
component("YBL042C",129).
component("U79_",103).
component("U75_",101).
component("U74_",100).
component("U73_",99).
...
catalyst(6160,519).
catalyst(3870,266).
catalyst(3620,240) :- not remove_reaction(3620,240).
catalyst(2110,295).
catalyst(2190,295).
catalyst(5550,420).
catalyst(5791,472).
...
catalyst(3630,275) :- not remove_reaction(3630,275).
catalyst(3740,222).
catalyst(8231,626).
catalyst(8232,626).
catalyst(8231,603).
...
catalyst(8231,344).
catalyst(8232,344).
catalyst(3590,304) :- not remove_reaction(3590,304).
catalyst(10910,304) :- not remove_reaction(10910,304).
catalyst(4570,331).
catalyst(8181,480).
catalyst(8182,480).
catalyst(8181,403).
...
catalyst(8281,214).
catalyst(8282,214).
catalyst(3610,205) :- not remove_reaction(3610,205).
catalyst(7921,576).
catalyst(7922,576).
catalyst(7841,259).
catalyst(7842,259).
...
catalyst(190,575).
catalyst(1200,572).
catalyst(801,560) :- not remove_reaction(801,560).
catalyst(802,560) :- not remove_reaction(802,560).
catalyst(811,560) :- not remove_reaction(811,560).
catalyst(812,560) :- not remove_reaction(812,560).
catalyst(831,560) :- not remove_reaction(831,560).
catalyst(832,560) :- not remove_reaction(832,560).
catalyst(941,560) :- not remove_reaction(941,560).
catalyst(942,560) :- not remove_reaction(942,560).
catalyst(700,557).
catalyst(1200,548).
catalyst(761,542).
catalyst(762,542).
...
catalyst(640,450).
catalyst(6560,448).
catalyst(761,447) :- not remove_reaction(761,447).
catalyst(762,447) :- not remove_reaction(762,447).
...
catalyst(791,447) :- not remove_reaction(791,447).
catalyst(792,447) :- not remove_reaction(792,447).
...
catalyst(821,447) :- not remove_reaction(821,447).
catalyst(822,447) :- not remove_reaction(822,447).
...
catalyst(861,447) :- not remove_reaction(861,447).
catalyst(862,447) :- not remove_reaction(862,447).
catalyst(881,447) :- not remove_reaction(881,447).
catalyst(882,447) :- not remove_reaction(882,447).
catalyst(911,447) :- not remove_reaction(911,447).
catalyst(912,447) :- not remove_reaction(912,447).
catalyst(941,447) :- not remove_reaction(941,447).
catalyst(942,447) :- not remove_reaction(942,447).
...
catalyst(1511,169).
catalyst(1512,169).
catalyst(771,146) :- not remove_reaction(771,146).
catalyst(772,146) :- not remove_reaction(772,146).
catalyst(791,146) :- not remove_reaction(791,146).
catalyst(792,146) :- not remove_reaction(792,146).
...
catalyst(861,146) :- not remove_reaction(861,146).
catalyst(862,146) :- not remove_reaction(862,146).
...
catalyst(831,145) :- not remove_reaction(831,145).
catalyst(832,145) :- not remove_reaction(832,145).
catalyst(841,145) :- not remove_reaction(841,145).
catalyst(842,145) :- not remove_reaction(842,145).
