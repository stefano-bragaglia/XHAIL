...
component("YNL280C",519).
component("YGR060W",309).
component("YGL012W",286).
component("YOL086C",540).
component("YMR303C",497).
component("YGL256W",303).
component("YDL168W",186).
component("YBR145W",145).
component("YPL231W",590).
component("YBR149W",146).
component("YGL001C",283).
component("YIL094C",356).
component("YHR063C",339).
component("YBR153W",147).
component("YML056C",470).
component("YLR432W",466).
component("YHR216W",350).
component("YAR075W",117).
component("YAR073W",116).
component("YDR127W",205).
component("YJR139C",402).
component("YOL126C",544).
component("YDL078C",176).
component("YKL029C",406).
component("YOR136W",554).
component("YDL066W",175).
component("YLR355C",463).
component("YML086C",472).
component("YIL155C",360).
component("YPR191W",617).
component("YOR065W",549).
component("YJL166W",381).
component("YHR001W-A",334).
component("YGR183C",319).
component("YFR033C",279).
component("YDR529C",238).
component("YBL045C",123).
component("Q0105",18).
component("YGR088W",311).
component("YDR256C",219).
component("YJR078W",393).
component("YJR025C",388).
component("YGR255C",328).
component("YBL098W",126).
component("YMR015C",478).
component("YDR402C",230).
component("YGL055W",291).
component("YGR175C",317).
component("YJR104C",396).
component("YHR008C",335).
component("YER070W",258).
component("U35_",75).
component("YDL168W",187).
component("YDR158W",213).
component("YPL276W",599).
component("YPL275W",598).
component("YOR388C",576).
component("YGL154C",297).
component("U55_",84).
component("YOR323C",566).
component("YMR170C",486).
component("YMR169C",485).
component("U2_",72).
component("YBR221C",154).
component("U52_",81).
component("YBR166C",150).
component("YNL280C",520).
component("YGL012W",287).
component("U57_",85).
component("YER014W",247).
component("YKR009C",424).
component("YIL160C",362).
component("YGL205W",300).
component("YMR118C",483).
component("YLR164W",448).
component("YLL041C",432).
component("YKL148C",414).
component("YJL045W",367).
component("YDR178W",214).
component("YJR051W",390).
component("YEL047C",242).
component("YOR375C",574).
component("YDL215C",190).
component("YAL062W",114).
component("U99_",110).
component("YBR035C",133).
component("YHR037W",336).
component("YKR080W",428).
component("YER023W",248).
component("YOR236W",563).
component("YGR204W",321).
component("YLR142W",443).
component("U62_",87).
component("YKL150W",415).
component("YIL043C",352).
component("YHR042W",337).
component("YFR030W",278).
component("YPL017C",579).
component("YFL018C",270).
component("YER042W",250).
component("YJR137C",401).
component("YPL266W",596).
component("YML110C",474).
component("YBR034C",132).
component("YPL273W",597).
component("YLL062C",434).
component("U47_",78).
component("YER091C",261).
component("YDL033C",173).
component("YOL096C",541).
component("YDR019C",195).
component("YDR408C",232).
component("YBL013W",118).
component("YKL024C",405).
component("YPR074C",609).
component("YBR117C",142).
component("YLR354C",462).
component("YGR043C",307).
component("YCL009C",163).
component("YMR062C",480).
component("YNL071W",503).
component("YNR008W",527).
component("YPL231W",591).
component("YER061C",256).
component("U86_",102).
component("YPL001W",578).
component("YDR148C",211).
component("YOR377W",575).
component("YGR177C",318).
component("YPL231W",592).
component("YGR147C",314).
component("YDL040C",174).
component("YPL028W",580).
component("YGL017W",288).
component("YPR001W",601).
component("YNR001C",525).
component("YDL182W",188).
component("YDL131W",181).
component("YNL117W",506).
component("YIR031C",365).
component("YNL029C",500).
component("YIL085C",355).
component("YMR261C",493).
component("YML100W",473).
component("YBR126C",144).
component("YNL192W",512).
component("YBR038W",135).
component("YBR023C",131).
component("YLR209C",449).
component("U104_",21).
component("YMR300C",496).
component("YER055C",252).
component("YDR354W",226) :- not remove_orf("YDR354W",226).
component("YFR047C",280).
component("YJR133W",400).
component("YLR209C",450).
component("YML022W",467).
component("YDR441C",234).
component("YDR399W",228).
component("YJL167W",382).
component("YNL256W",515).
component("YDR127W",206).
component("YLR303W",456).
component("YJR130C",399).
component("YLR303W",457).
component("YDR035W",196).
component("YBR249C",155).
component("YOL143C",546).
component("YBR256C",156).
component("YHR137W",344).
component("YGL202W",299).
component("YLR027C",435).
component("YKL106W",410).
component("YKL104C",409).
component("YGR019W",305).
component("YLR089C",439).
component("U64_",88).
component("U51_",80).
component("YJR148W",403).
component("YGL253W",302).
component("YFR053C",281).
component("YOL136C",545).
component("YIL107C",357).
component("YMR205C",488).
component("YGR240C",324).
component("YDR248C",218).
component("YCR036W",170).
component("YCL040W",165).
component("YJR105W",397).
component("U16_",38).
component("U15_",35).
component("U96_",108).
component("YKL001C",404).
component("YML070W",471).
component("YFL053W",273).
component("YHL032C",332).
component("U83_",100).
component("U82_",99).
component("U81_",98).
component("YMR208W",489).
component("YOR347C",571).
component("YAL038W",113).
component("YNR012W",528).
component("YPR121W",612).
component("YPL258C",594).
component("YOL055C",537).
component("U1_",54).
component("YBR020W",129).
component("YNL267W",517).
component("YLR305C",459).
component("YFR019W",276).
component("YDR208W",215).
component("YDR127W",207).
component("U21_",63).
component("U20_",61).
component("YDR147W",210).
component("YDR300C",223).
component("YCR012W",167).
component("U18_",48).
component("U76_",96).
component("YER170W",267).
component("YDR226W",216).
component("YKL067W",408).
component("YDR454C",235).
component("YOL061W",539).
component("YKL181W",417).
component("YHL011C",330).
component("YER099C",263).
component("YBL068W",125).
component("YOR143C",555).
component("YGR007W",304).
component("YLR328W",460).
component("YJR010W",387).
component("YCL050C",166).
component("YPR190C",616).
component("YPR187W",615).
component("YPR110C",611).
component("YPR010C",603).
component("YOR341W",570).
component("YOR340C",569).
component("YOR224C",562).
component("YOR210W",561).
component("YOR207C",559).
component("YOR151C",556).
component("YOR116C",552).
component("YOL005C",533).
component("YNR003C",526).
component("YNL248C",514).
component("YNL151C",510).
component("YNL113W",505).
component("YKL144C",413).
component("YJR063W",391).
component("YJL148W",379).
component("YJL140W",378).
component("YIL021W",351).
component("YHR143W-A",345).
component("YGL070C",294).
component("YFL036W",272).
component("YDR404C",231).
component("YDR156W",212).
component("YDR045C",197).
component("YDL150W",184).
component("YDL140C",182).
component("YBR154C",149).
component("YPR175W",614).
component("YPL167C",587).
component("YOR330C",567).
component("YOL115W",543).
component("YNL299W",522).
component("YNL262W",516).
component("YNL102W",504).
component("YJR043C",389).
component("YJR006W",386).
component("YJL090C",371).
component("YIL139C",359).
component("YEL055C",243).
component("YDR419W",233).
component("YDR121W",204).
component("YDL102W",179).
component("YCR014C",168).
component("YBR278W",158).
component("YBL035C",120).
component("YKL035W",407).
component("YHL012W",331).
component("YHR123W",343).
component("YER026C",249).
component("YCL004W",162).
component("YJL068C",368).
component("YDR058C",201).
component("YNR034W",531).
component("YHR163W",347).
component("YGR248W",326).
component("YCR073W-A",171).
component("YDL086W",178).
component("YOL011W",534).
component("YMR008C",477).
component("YMR006C",476).
component("U101_",19).
component("YBL015W",119).
component("YJL068C",369).
component("YPL072W",583).
component("YOR124C",553).
component("YNL186W",511).
component("YMR304W",498).
component("YMR223W",491).
component("YKR098C",430).
component("YJL197W",383).
component("YIL156W",361).
component("YFR010W",275).
component("YER151C",265).
component("YER144C",264).
component("YER098W",262).
component("YDR069C",202).
component("YDL122W",180).
component("YBR058C",136).
component("YBL067C",124).
component("U84_",101).
component("YPR073C",607).
component("YHR215W",349).
component("YDL024C",172).
component("YBR093C",140).
component("YBR092C",139).
component("YAR071W",115).
component("YIL053W",354).
component("YER062C",257).
component("YHR046C",338).
component("YGR208W",323).
component("YPL228W",589).
component("YMR180C",487).
component("YDL236W",192).
component("YJL155C",380).
component("YPR073C",608).
component("YOR208W",560).
component("YNL053W",502).
component("YMR036C",479).
component("YIR026C",363).
component("YIL113W",358).
component("YFR028C",277).
component("YER075C",259).
component("YDL230W",191).
component("YBR276C",157).
component("U34_",74).
component("U30_",73).
component("U25_",71).
component("U24_",70).
component("YOR360C",573).
component("YGL248W",301).
component("YKR031C",425).
component("YLR286C",454).
component("YOR190W",557).
component("YLR300W",455).
component("YGR282C",329).
component("YDR261C",220).
component("YDR400W",229).
component("U23_",69).
component("YML035C",468).
component("YJL070C",370).
component("YBR284W",159).
component("U102_",20).
component("YNL045W",501).
component("YLR160C",447).
component("YLR158C",446).
component("YLR157C",445).
component("YLR155C",444).
component("YDR321W",224).
component("YGL037C",290).
component("YDR242W",217).
component("YBR208C",151).
component("YMR281W",495).
component("U53_",82).
component("YIR032C",366).
component("YIR029W",364).
component("YMR120C",484).
component("YHR144C",346).
component("YNL141W",507).
component("YBR153W",148).
component("YDL238C",193).
component("YNL141W",508).
component("YLR245C",453).
component("YML035C",469).
component("YJL126W",374).
component("U87_",103).
component("YBR111C",141).
component("YER005W",246).
component("YIL048W",353).
component("YER166W",266).
component("YDR093W",203).
component("YAL026C",112).
component("YLR231C",451).
component("U88_",104).
component("YLR134W",441).
component("YLR044C",436).
component("YGR087C",310).
component("YDR380W",227).
component("YDL080C",177).
component("U98_",109).
component("YMR250W",492).
component("YKL184W",420).
component("YNR043W",532).
component("U93_",107).
component("YDR047W",199).
component("U54_",83).
component("YKL211C",421) :- not remove_orf("YKL211C",421).
component("YGR170W",316).
component("YDR294C",221).
component("YEL046C",241).
component("YNR033W",530).
component("YKL211C",422) :- not remove_orf("YKL211C",422).
component("YER090W",422) :- not remove_orf("YER090W",422).
component("YER090W",260) :- not remove_orf("YER090W",260).
component("YDR127W",208).
component("YPL281C",600).
component("YOR393W",577).
component("YMR323W",499).
component("YHR174W",348).
component("YGR254W",327).
component("YGL026C",289) :- not remove_orf("YGL026C",289).
component("YGR155W",315).
component("YLR304C",458).
component("YJL200C",384).
component("YNL316C",523).
component("YKL182W",418).
component("YPL212C",588).
component("YNL292W",521).
component("YGL063W",293).
component("YFL001W",268).
component("YPR002W",602).
component("YDR127W",209).
component("YGL148W",296).
component("YLR359W",464).
component("YAL012W",111).
component("YFR055W",282).
component("YJL121C",373).
component("YBR019C",127).
component("YBR019C",128).
component("YDR050C",200).
component("YDR007W",194) :- not remove_orf("YDR007W",194).
component("YOR095C",551).
component("YER003C",245).
component("YGL001C",284).
component("U14_",30).
component("YKL152C",416).
component("YMR105C",481).
component("YKL127W",411).
component("YEL058W",244).
component("YPR060C",606).
component("YHR072W",340).
component("YPL097W",584).
component("YGR185C",320).
component("YPL104W",585).
component("YLL018C",431).
component("YPR081C",610).
component("YBR121C",143).
component("YNL247W",513).
component("YOL033W",536).
component("YHR091C",342).
component("YDR341C",225).
component("YOL097C",542).
component("YPR047W",605).
component("YLR060W",437).
component("YFL022C",271).
component("YPR033C",604).
component("YPL160W",586).
component("YLR382C",465).
component("YOR335C",568).
component("YGR094W",312).
component("YGR244C",325).
component("U89_",105).
component("YOR241W",564).
component("YMR113W",482).
component("YKL132C",412).
component("YJL101C",372).
component("U91_",106).
component("YDL141W",183).
component("YJR103W",395).
component("YBL039C",121).
component("YGR204W",322).
component("YOL058W",538).
component("YBR208C",152).
component("YHR074W",341).
component("YMR217W",490).
component("YOR303W",565).
component("YJR109C",398).
component("YJL130C",376).
component("YGL062W",292).
component("YBR218C",153).
component("YPL231W",593).
component("YNR016C",529).
component("YKL182W",419).
component("YGR037C",306).
component("YOR005C",548).
component("YDL164C",185).
component("YPR138C",613).
component("YPL265W",595).
component("YPL057C",582).
component("YPL036W",581).
component("YOR348C",572).
component("YOR192C",558).
component("YOR071C",550).
component("YOL156W",547).
component("YOL020W",535) :- not remove_orf("YOL020W",535).
component("YNL318C",524).
component("YNL268W",518).
component("YNL142W",509).
component("YMR272C",494).
component("YML123C",475).
component("YLR348C",461).
component("YLR237W",452).
component("YLR138W",442).
component("YLR100C",440).
component("YLR081W",438).
component("YLL061W",433).
component("YKR093W",429).
component("YKR053C",427).
component("YKR039W",426) :- not remove_orf("YKR039W",426).
component("YKL217W",423).
component("YJR095W",394).
component("YJR077C",392).
component("YJL219W",385).
component("YJL134W",377).
component("YJL129C",375).
component("YHL036W",333).
component("YGR121C",313).
component("YGR055W",308).
component("YGL186C",298).
component("YGL077C",295).
component("YGL008C",285).
component("YFL055W",274).
component("YFL011W",269).
component("YER060W-A",255).
component("YER060W",254).
component("YER056C",253).
component("YER053C",251).
component("YEL017C-A",240).
component("YDR536W",239).
component("YDR508C",237).
component("YDR503C",236).
component("YDR294C",222).
component("YDR046C",198) :- not remove_orf("YDR046C",198).
component("YDL210W",189).
component("YCR024C-A",169).
component("YCL025C",164).
component("YBR298C",161).
component("YBR291C",160).
component("YBR069C",138) :- not remove_orf("YBR069C",138).
component("YBR068C",137) :- not remove_orf("YBR068C",137).
component("YBR036C",134).
component("YBR021W",130).
component("YBL042C",122).
component("U79_",97).
component("U75_",95).
component("U74_",94).
component("U73_",93).
...
catalyst(6160,496).
catalyst(3870,252).
catalyst(3620,226) :- not remove_reaction(3620,226).
catalyst(2110,280).
catalyst(2190,280).
catalyst(5550,400).
catalyst(5791,450).
...
catalyst(1960,199).
catalyst(3460,83).
catalyst(3600,421) :- not remove_reaction(3600,421).
catalyst(6900,316).
catalyst(8781,221).
catalyst(8782,221).
catalyst(4560,241).
catalyst(2550,530).
catalyst(3630,422) :- not remove_reaction(3630,422).
catalyst(3630,260) :- not remove_reaction(3630,260).
catalyst(3740,208).
catalyst(8231,600).
catalyst(8232,600).
catalyst(8231,577).
...
catalyst(8231,327).
catalyst(8232,327).
catalyst(3590,289) :- not remove_reaction(3590,289).
catalyst(10910,289) :- not remove_reaction(10910,289).
catalyst(4570,315).
catalyst(8181,458).
catalyst(8182,458).
catalyst(8181,384).
...
catalyst(8281,200).
catalyst(8282,200).
catalyst(3610,194) :- not remove_reaction(3610,194).
catalyst(7921,551).
catalyst(7922,551).
catalyst(7841,245).
catalyst(7842,245).
...
catalyst(190,550).
catalyst(1200,547).
catalyst(801,535) :- not remove_reaction(801,535).
catalyst(802,535) :- not remove_reaction(802,535).
catalyst(811,535) :- not remove_reaction(811,535).
catalyst(812,535) :- not remove_reaction(812,535).
catalyst(831,535) :- not remove_reaction(831,535).
catalyst(832,535) :- not remove_reaction(832,535).
catalyst(941,535) :- not remove_reaction(941,535).
catalyst(942,535) :- not remove_reaction(942,535).
catalyst(1200,524).
catalyst(761,518).
catalyst(762,518).
catalyst(371,509).
...
catalyst(640,429).
catalyst(6560,427).
catalyst(761,426) :- not remove_reaction(761,426).
catalyst(762,426) :- not remove_reaction(762,426).
catalyst(771,426) :- not remove_reaction(771,426).
catalyst(772,426) :- not remove_reaction(772,426).
catalyst(781,426) :- not remove_reaction(781,426).
catalyst(782,426) :- not remove_reaction(782,426).
catalyst(791,426) :- not remove_reaction(791,426).
catalyst(792,426) :- not remove_reaction(792,426).
catalyst(801,426) :- not remove_reaction(801,426).
catalyst(802,426) :- not remove_reaction(802,426).
catalyst(811,426) :- not remove_reaction(811,426).
catalyst(812,426) :- not remove_reaction(812,426).
catalyst(821,426) :- not remove_reaction(821,426).
catalyst(822,426) :- not remove_reaction(822,426).
catalyst(831,426) :- not remove_reaction(831,426).
catalyst(832,426) :- not remove_reaction(832,426).
catalyst(841,426) :- not remove_reaction(841,426).
catalyst(842,426) :- not remove_reaction(842,426).
catalyst(861,426) :- not remove_reaction(861,426).
catalyst(862,426) :- not remove_reaction(862,426).
catalyst(881,426) :- not remove_reaction(881,426).
catalyst(882,426) :- not remove_reaction(882,426).
catalyst(911,426) :- not remove_reaction(911,426).
catalyst(912,426) :- not remove_reaction(912,426).
catalyst(941,426) :- not remove_reaction(941,426).
catalyst(942,426) :- not remove_reaction(942,426).
catalyst(1191,426) :- not remove_reaction(1191,426).
catalyst(1192,426) :- not remove_reaction(1192,426).
catalyst(1021,423).
catalyst(1022,423).
catalyst(1250,394).
catalyst(1581,392).
...
catalyst(1511,160).
catalyst(1512,160).
catalyst(771,138) :- not remove_reaction(771,138).
catalyst(772,138) :- not remove_reaction(772,138).
catalyst(791,138) :- not remove_reaction(791,138).
catalyst(792,138) :- not remove_reaction(792,138).
...
catalyst(861,138) :- not remove_reaction(861,138).
catalyst(862,138) :- not remove_reaction(862,138).
catalyst(791,137) :- not remove_reaction(791,137).
catalyst(792,137) :- not remove_reaction(792,137).
catalyst(801,137) :- not remove_reaction(801,137).
catalyst(802,137) :- not remove_reaction(802,137).
catalyst(811,137) :- not remove_reaction(811,137).
catalyst(812,137) :- not remove_reaction(812,137).
catalyst(831,137) :- not remove_reaction(831,137).
catalyst(832,137) :- not remove_reaction(832,137).
catalyst(841,137) :- not remove_reaction(841,137).
catalyst(842,137) :- not remove_reaction(842,137).
catalyst(861,137) :- not remove_reaction(861,137).
catalyst(862,137) :- not remove_reaction(862,137).
catalyst(6600,134).
catalyst(620,130).
catalyst(540,122).
catalyst(2830,97).
