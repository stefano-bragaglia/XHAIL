...
component("YGR060W",166).
component("YGL012W",154).
component("YOL086C",273).
component("YMR303C",251).
component("YGL256W",162).
component("YDL168W",101).
component("YBR145W",78).
component("YPL231W",298).
component("YGL001C",151).
component("YML056C",239).
component("YLR432W",236).
component("YHR216W",183).
component("YAR075W",66).
component("YAR073W",65).
component("YDR127W",112).
component("YJR139C",210).
component("YOR136W",278).
component("YIL155C",187).
component("YJR078W",204).
component("YJR025C",200).
component("YMR015C",243).
component("YDR402C",126).
component("YJR104C",207).
component("YHR008C",177).
component("YER070W",139).
component("YDL168W",102).
component("YGL154C",160).
component("YOR323C",286).
component("YMR170C",247).
component("YMR169C",246).
component("YBR166C",80).
component("YER014W",136).
component("YMR118C",245).
component("YLR164W",230).
component("YLL041C",226).
component("YKL148C",217).
component("YJL045W",191).
component("YDR178W",118).
component("YJR051W",201).
component("YEL047C",134).
component("YOR375C",291).
component("YDL215C",103).
component("YAL062W",64).
component("YER023W",137).
component("YOR236W",285).
component("YGR204W",172).
component("U62_",47).
component("YPL017C",294).
component("YFL018C",143).
component("U47_",41).
component("YKL024C",213).
component("YPR074C",310).
component("YBR117C",77).
component("YCL009C",90).
component("YPL231W",299).
component("YPL001W",293).
component("YPL231W",300).
component("YPL028W",295).
component("YPR001W",305).
component("YNR001C",263).
component("YNL117W",257).
component("YIR031C",189).
component("YNL029C",253).
component("YIL085C",185).
component("YLR209C",231).
component("YER055C",138).
component("YDR354W",122) :- not remove_orf("YDR354W",122).
component("YFR047C",149).
component("YJR133W",209).
component("YML022W",237).
component("YDR441C",128).
component("YDR399W",124).
component("YDR127W",113).
component("YJR130C",208).
component("YDR035W",108).
component("YBR249C",84).
component("YBR256C",85).
component("YHR137W",179).
component("YLR027C",227).
component("YKL106W",215).
component("YGR019W",164).
component("U64_",48).
component("U51_",43).
component("YJR148W",211).
component("YGL253W",161).
component("YFR053C",150).
component("YMR205C",249).
component("YGR240C",173).
component("YCR036W",94).
component("U16_",25).
component("U15_",23).
component("YKL001C",212).
component("YML070W",240).
component("YFL053W",145).
component("U83_",58).
component("U82_",57).
component("YMR208W",250).
component("YOR347C",290).
component("YAL038W",63).
component("YPR121W",312).
component("YPL258C",302).
component("YOL055C",270).
component("U1_",32).
component("YNL267W",261).
component("YLR305C",235).
component("YFR019W",147).
component("YDR208W",119).
component("YDR127W",114).
component("U20_",35).
component("YDR300C",121).
component("U18_",29).
component("U76_",56).
component("YDR454C",129).
component("YOL061W",272).
component("YKL181W",218).
component("YHL011C",175).
component("YER099C",142).
component("YBL068W",69).
component("YOR143C",279).
component("YGR007W",163).
component("YCL050C",92).
component("YPR190C",315).
component("YPR187W",314).
component("YPR110C",311).
component("YPR010C",306).
component("YOR341W",289).
component("YOR340C",288).
component("YOR224C",284).
component("YOR210W",283).
component("YOR207C",281).
component("YOR151C",280).
component("YOR116C",277).
component("YOL005C",267).
component("YNR003C",264).
component("YNL248C",260).
component("YNL151C",259).
component("YNL113W",256).
component("YKL144C",216).
component("YJR063W",202).
component("YJL148W",198).
component("YJL140W",197).
component("YIL021W",184).
component("YHR143W-A",180).
component("YGL070C",158).
component("YFL036W",144).
component("YDR404C",127).
component("YDR156W",117).
component("YDR045C",109).
component("YDL150W",99).
component("YDL140C",98).
component("YBR154C",79).
component("YKL035W",214).
component("YHL012W",176).
component("YDR058C",111).
component("YDL086W",97).
component("YOL011W",268).
component("YMR008C",242).
component("YMR006C",241).
component("U101_",18).
component("YBL015W",67).
component("U84_",59).
component("YPR073C",308).
component("YHR215W",182).
component("YDL024C",95).
component("YBR093C",75).
component("YBR092C",74).
component("YPL228W",297).
component("YMR180C",248).
component("YDL236W",105).
component("YJL155C",199).
component("YPR073C",309).
component("YOR208W",282).
component("YNL053W",255).
component("YMR036C",244).
component("YIR026C",188).
component("YIL113W",186).
component("YFR028C",148).
component("YER075C",140).
component("YDL230W",104).
component("YBR276C",86).
component("U34_",39).
component("U30_",38).
component("U24_",37).
component("YKR031C",223).
component("YLR286C",234).
component("YDR400W",125).
component("YML035C",238).
component("YJL070C",192).
component("YBR284W",87).
component("YNL045W",254).
component("YGL037C",156).
component("YBR208C",81).
component("U53_",44).
component("YIR032C",190).
component("YDL238C",106).
component("YLR245C",233).
component("YJL126W",194).
component("YBR111C",76).
component("YER005W",135).
component("YLR231C",232).
component("U88_",60).
component("YLR134W",229).
component("YLR044C",228).
component("YGR087C",167).
component("YDR380W",123).
component("YDL080C",96).
component("U93_",62).
component("U54_",45).
component("YKL211C",221) :- not remove_orf("YKL211C",221).
component("YGR170W",171).
component("YDR294C",120).
component("YNR033W",266).
component("YKL211C",222) :- not remove_orf("YKL211C",222).
component("YER090W",222) :- not remove_orf("YER090W",222).
component("YER090W",141) :- not remove_orf("YER090W",141).
component("YDR127W",115).
component("YPL281C",304).
component("YOR393W",292).
component("YMR323W",252).
component("YHR174W",181).
component("YGR254W",174).
component("YGL026C",155) :- not remove_orf("YGL026C",155).
component("YGR155W",170).
component("YNL316C",262).
component("YKL182W",219).
component("YDR127W",116).
component("YGL148W",159).
component("YBR019C",70).
component("YDR007W",107) :- not remove_orf("YDR007W",107).
component("YOR095C",276).
component("YGL001C",152).
component("YPR060C",307).
component("YOL097C",274).
component("YOR335C",287).
component("YGR094W",168).
component("U89_",61).
component("YJL101C",193).
component("YJR103W",206).
component("YBL039C",68).
component("YOL058W",271).
component("YBR208C",82).
component("YHR074W",178).
component("YGL062W",157).
component("YBR218C",83).
component("YPL231W",301).
component("YNR016C",265).
component("YKL182W",220).
component("YGR037C",165).
component("YOR005C",275).
component("YDL164C",100).
component("YPR138C",313).
component("YPL265W",303).
component("YPL036W",296).
component("YOL020W",269) :- not remove_orf("YOL020W",269).
component("YNL142W",258).
component("YKR053C",225).
component("YKR039W",224) :- not remove_orf("YKR039W",224).
component("YJR095W",205).
component("YJR077C",203).
component("YJL134W",196).
component("YJL129C",195).
component("YGR121C",169).
component("YGL008C",153).
component("YFL055W",146).
component("YEL017C-A",133).
component("YDR536W",132).
component("YDR508C",131).
component("YDR503C",130).
component("YDR046C",110) :- not remove_orf("YDR046C",110).
component("YCR024C-A",93).
component("YCL025C",91).
component("YBR298C",89).
component("YBR291C",88).
component("YBR069C",73) :- not remove_orf("YBR069C",73).
component("YBR068C",72) :- not remove_orf("YBR068C",72).
component("YBR021W",71).
component("U75_",55).
component("U74_",54).
component("U73_",53).
component("U72_",52).
...
catalyst(2300,62).
catalyst(3460,45).
catalyst(3600,221) :- not remove_reaction(3600,221).
catalyst(6900,171).
catalyst(8781,120).
catalyst(8782,120).
catalyst(2550,266).
catalyst(3630,222) :- not remove_reaction(3630,222).
catalyst(3630,141) :- not remove_reaction(3630,141).
catalyst(3740,115).
catalyst(8231,304).
catalyst(8232,304).
catalyst(8231,292).
...
catalyst(8231,174).
catalyst(8232,174).
catalyst(3590,155) :- not remove_reaction(3590,155).
catalyst(10910,155) :- not remove_reaction(10910,155).
catalyst(4570,170).
catalyst(3680,262).
catalyst(7141,219).
catalyst(7142,219).
...
catalyst(781,224) :- not remove_reaction(781,224).
catalyst(782,224) :- not remove_reaction(782,224).
...
catalyst(881,224) :- not remove_reaction(881,224).
catalyst(882,224) :- not remove_reaction(882,224).
catalyst(1191,224) :- not remove_reaction(1191,224).
catalyst(1192,224) :- not remove_reaction(1192,224).
catalyst(1250,205).
catalyst(1581,203).
catalyst(1582,203).
catalyst(6560,196).
...
catalyst(1501,88).
catalyst(1502,88).
catalyst(771,73) :- not remove_reaction(771,73).
catalyst(772,73) :- not remove_reaction(772,73).
...
catalyst(801,72) :- not remove_reaction(801,72).
catalyst(802,72) :- not remove_reaction(802,72).
catalyst(811,72) :- not remove_reaction(811,72).
catalyst(812,72) :- not remove_reaction(812,72).
catalyst(831,72) :- not remove_reaction(831,72).
catalyst(832,72) :- not remove_reaction(832,72).
catalyst(620,71).
catalyst(2920,55).
catalyst(2920,54).
catalyst(2920,53).
