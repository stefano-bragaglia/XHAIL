...
component("YGR060W",198).
component("YGL012W",183).
component("YOL086C",336).
component("YMR303C",308).
component("YGL256W",193).
component("YDL168W",122).
component("YBR145W",90).
component("YPL231W",371).
component("YGL001C",180).
component("YML056C",292).
component("YLR432W",289).
component("YHR216W",220).
component("YAR075W",75).
component("YAR073W",74).
component("YDR127W",135).
component("YJR139C",253).
component("YOR136W",343).
component("YDL066W",115).
component("YIL155C",226).
component("YJR078W",246).
component("YJR025C",241).
component("YBL098W",80).
component("YMR015C",296).
component("YDR402C",152).
component("YJR104C",249).
component("YHR008C",212).
component("YER070W",167).
component("YDL168W",123).
component("YPL276W",379).
component("YPL275W",378).
component("YOR388C",361).
component("YGL154C",190).
component("YOR323C",354).
component("YMR170C",303).
component("YMR169C",302).
component("YBR166C",93).
component("YNL280C",322).
component("YER014W",164).
component("YMR118C",300).
component("YLR164W",279).
component("YLL041C",274).
component("YKL148C",262).
component("YJL045W",230).
component("YDR178W",141).
component("YJR051W",243).
component("YEL047C",161).
component("YOR375C",360).
component("YDL215C",124).
component("YAL062W",73).
component("YBR035C",83).
component("YER023W",165).
component("YOR236W",352).
component("YGR204W",205).
component("U62_",53).
component("YKL150W",263).
component("YIL043C",222).
component("YPL017C",364).
component("YFL018C",172).
component("YPL273W",377).
component("YLL062C",275).
component("U47_",47).
component("YDL033C",113).
component("YKL024C",256).
component("YPR074C",386).
component("YBR117C",89).
component("YCL009C",104).
component("YMR062C",298).
component("YPL231W",372).
component("YPL001W",363).
component("YPL231W",373).
component("YGR147C",202).
component("YDL040C",114).
component("YPL028W",365).
component("YPR001W",381).
component("YNR001C",326).
component("YNL117W",315).
component("YIR031C",228).
component("YNL029C",310).
component("YIL085C",223).
component("YLR209C",280).
component("YMR300C",307).
component("YER055C",166).
component("YDR354W",148) :- not remove_orf("YDR354W",148).
component("YFR047C",178).
component("YJR133W",252).
component("YML022W",290).
component("YDR441C",155).
component("YDR399W",150).
component("YDR127W",136).
component("YJR130C",251).
component("YLR303W",286).
component("YDR035W",129).
component("YBR249C",97).
component("YBR256C",98).
component("YHR137W",215).
component("YGL202W",191).
component("YLR027C",276).
component("YKL106W",259).
component("YKL104C",258).
component("YGR019W",195).
component("U64_",54).
component("U51_",49).
component("YJR148W",254).
component("YGL253W",192).
component("YFR053C",179).
component("YMR205C",305).
component("YGR240C",206).
component("YDR248C",143).
component("YCR036W",111).
component("YCL040W",106).
component("YJR105W",250).
component("U16_",26).
component("U15_",24).
component("U96_",69).
component("YKL001C",255).
component("YML070W",293).
component("YFL053W",174).
component("U83_",64).
component("U82_",63).
component("YMR208W",306).
component("YOR347C",359).
component("YAL038W",72).
component("YPR121W",388).
component("YPL258C",375).
component("YOL055C",333).
component("U1_",34).
component("YNL267W",321).
component("YLR305C",287).
component("YFR019W",176).
component("YDR208W",142).
component("YDR127W",137).
component("U21_",39).
component("U20_",38).
component("YDR300C",146).
component("YCR012W",108).
component("U18_",31).
component("U76_",62).
component("YDR454C",156).
component("YOL061W",335).
component("YKL181W",264).
component("YHL011C",209).
component("YER099C",170).
component("YBL068W",79).
component("YOR143C",344).
component("YGR007W",194).
component("YCL050C",107).
component("YPR190C",392).
component("YPR187W",391).
component("YPR110C",387).
component("YPR010C",382).
component("YOR341W",358).
component("YOR340C",357).
component("YOR224C",351).
component("YOR210W",350).
component("YOR207C",348).
component("YOR151C",345).
component("YOR116C",342).
component("YOL005C",330).
component("YNR003C",327).
component("YNL248C",319).
component("YNL151C",318).
component("YNL113W",314).
component("YKL144C",261).
component("YJR063W",244).
component("YJL148W",238).
component("YJL140W",237).
component("YIL021W",221).
component("YHR143W-A",216).
component("YGL070C",188).
component("YFL036W",173).
component("YDR404C",153).
component("YDR156W",140).
component("YDR045C",130).
component("YDL150W",120).
component("YDL140C",119).
component("YBR154C",92).
component("YPR175W",390).
component("YPL167C",368).
component("YOR330C",355).
component("YOL115W",338).
component("YNL299W",324).
component("YNL262W",320).
component("YNL102W",313).
component("YJR043C",242).
component("YJR006W",240).
component("YJL090C",232).
component("YIL139C",225).
component("YEL055C",162).
component("YDR419W",154).
component("YDR121W",134).
component("YDL102W",118).
component("YCR014C",109).
component("YBR278W",100).
component("YBL035C",77).
component("YKL035W",257).
component("YHL012W",210).
component("YDR058C",133).
component("YDL086W",117).
component("YOL011W",331).
component("YMR008C",295).
component("YMR006C",294).
component("U101_",18).
component("YBL015W",76).
component("U84_",65).
component("YPR073C",384).
component("YHR215W",219).
component("YDL024C",112).
component("YBR093C",87).
component("YBR092C",86).
component("YPL228W",370).
component("YMR180C",304).
component("YDL236W",126).
component("YJL155C",239).
component("YPR073C",385).
component("YOR208W",349).
component("YNL053W",312).
component("YMR036C",297).
component("YIR026C",227).
component("YIL113W",224).
component("YFR028C",177).
component("YER075C",168).
component("YDL230W",125).
component("YBR276C",99).
component("U34_",45).
component("U30_",44).
component("U25_",43).
component("U24_",42).
component("YKR031C",270).
component("YLR286C",284).
component("YOR190W",346).
component("YLR300W",285).
component("YGR282C",208).
component("YDR261C",144).
component("YDR400W",151).
component("YML035C",291).
component("YJL070C",231).
component("YBR284W",101).
component("YNL045W",311).
component("YGL037C",185).
component("YBR208C",94).
component("U53_",50).
component("YIR032C",229).
component("YMR120C",301).
component("YHR144C",217).
component("YBR153W",91).
component("YDL238C",127).
component("YNL141W",316).
component("YLR245C",283).
component("YJL126W",234).
component("YBR111C",88).
component("YER005W",163).
component("YLR231C",281).
component("U88_",66).
component("YLR134W",278).
component("YLR044C",277).
component("YGR087C",199).
component("YDR380W",149).
component("YDL080C",116).
component("U98_",70).
component("YKL184W",267).
component("U93_",68).
component("U54_",51).
component("YKL211C",268) :- not remove_orf("YKL211C",268).
component("YGR170W",204).
component("YDR294C",145).
component("YNR033W",329).
component("YKL211C",269) :- not remove_orf("YKL211C",269).
component("YER090W",269) :- not remove_orf("YER090W",269).
component("YER090W",169) :- not remove_orf("YER090W",169).
component("YDR127W",138).
component("YPL281C",380).
component("YOR393W",362).
component("YMR323W",309).
component("YHR174W",218).
component("YGR254W",207).
component("YGL026C",184) :- not remove_orf("YGL026C",184).
component("YGR155W",203).
component("YNL316C",325).
component("YKL182W",265).
component("YPL212C",369).
component("YNL292W",323).
component("YGL063W",187).
component("YFL001W",171).
component("YDR127W",139).
component("YGL148W",189).
component("YAL012W",71).
component("YBR019C",81).
component("YDR050C",132).
component("YDR007W",128) :- not remove_orf("YDR007W",128).
component("YOR095C",341).
component("YGL001C",181).
component("YMR105C",299).
component("YKL127W",260).
component("YPR060C",383).
component("YPL104W",367).
component("YLL018C",273).
component("YHR091C",214).
component("YDR341C",147).
component("YOL097C",337).
component("YOR335C",356).
component("YGR094W",200).
component("U89_",67).
component("YJL101C",233).
component("YJR103W",248).
component("YBL039C",78).
component("YOL058W",334).
component("YBR208C",95).
component("YHR074W",213).
component("YOR303W",353).
component("YGL062W",186).
component("YBR218C",96).
component("YPL231W",374).
component("YNR016C",328).
component("YKL182W",266).
component("YGR037C",196).
component("YOR005C",339).
component("YDL164C",121).
component("YPR138C",389).
component("YPL265W",376).
component("YPL036W",366).
component("YOR192C",347).
component("YOR071C",340).
component("YOL020W",332) :- not remove_orf("YOL020W",332).
component("YNL142W",317).
component("YLR348C",288).
component("YLR237W",282).
component("YKR053C",272).
component("YKR039W",271) :- not remove_orf("YKR039W",271).
component("YJR095W",247).
component("YJR077C",245).
component("YJL134W",236).
component("YJL129C",235).
component("YHL036W",211).
component("YGR121C",201).
component("YGR055W",197).
component("YGL008C",182).
component("YFL055W",175).
component("YEL017C-A",160).
component("YDR536W",159).
component("YDR508C",158).
component("YDR503C",157).
component("YDR046C",131) :- not remove_orf("YDR046C",131).
component("YCR024C-A",110).
component("YCL025C",105).
component("YBR298C",103).
component("YBR291C",102).
component("YBR069C",85) :- not remove_orf("YBR069C",85).
component("YBR068C",84) :- not remove_orf("YBR068C",84).
component("YBR021W",82).
component("U75_",61).
component("U74_",60).
component("U73_",59).
component("U72_",58).
...
catalyst(6160,307).
catalyst(3870,166).
catalyst(3620,148) :- not remove_reaction(3620,148).
catalyst(2190,178).
catalyst(5550,252).
catalyst(5650,290).
catalyst(5650,155).
...
catalyst(2300,68).
catalyst(3460,51).
catalyst(3600,268) :- not remove_reaction(3600,268).
catalyst(6900,204).
catalyst(8781,145).
catalyst(8782,145).
catalyst(2550,329).
catalyst(3630,269) :- not remove_reaction(3630,269).
catalyst(3630,169) :- not remove_reaction(3630,169).
catalyst(3740,138).
catalyst(8231,380).
catalyst(8232,380).
catalyst(8231,362).
...
catalyst(8231,207).
catalyst(8232,207).
catalyst(3590,184) :- not remove_reaction(3590,184).
catalyst(10910,184) :- not remove_reaction(10910,184).
catalyst(4570,203).
catalyst(3680,325).
catalyst(7141,265).
catalyst(7142,265).
...
catalyst(8281,132).
catalyst(8282,132).
catalyst(3610,128) :- not remove_reaction(3610,128).
catalyst(7921,341).
catalyst(7922,341).
catalyst(6370,181).
catalyst(7861,299).
...
catalyst(190,347).
catalyst(190,340).
catalyst(801,332) :- not remove_reaction(801,332).
catalyst(802,332) :- not remove_reaction(802,332).
catalyst(811,332) :- not remove_reaction(811,332).
catalyst(812,332) :- not remove_reaction(812,332).
catalyst(831,332) :- not remove_reaction(831,332).
catalyst(832,332) :- not remove_reaction(832,332).
catalyst(371,317).
catalyst(372,317).
catalyst(1540,288).
catalyst(190,282).
catalyst(6560,272).
catalyst(771,271) :- not remove_reaction(771,271).
catalyst(772,271) :- not remove_reaction(772,271).
catalyst(781,271) :- not remove_reaction(781,271).
catalyst(782,271) :- not remove_reaction(782,271).
...
catalyst(881,271) :- not remove_reaction(881,271).
catalyst(882,271) :- not remove_reaction(882,271).
catalyst(1191,271) :- not remove_reaction(1191,271).
catalyst(1192,271) :- not remove_reaction(1192,271).
catalyst(1250,247).
catalyst(1581,245).
catalyst(1582,245).
catalyst(6560,236).
