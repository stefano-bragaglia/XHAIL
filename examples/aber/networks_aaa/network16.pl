...
component("YML056C",146).
component("YLR432W",144).
component("YHR216W",109).
component("YAR075W",39).
component("YAR073W",38).
component("YDR127W",68).
component("YJR139C",127).
component("YOR136W",169).
component("YIL155C",112).
component("YJR078W",122).
component("YJR025C",119).
component("YMR015C",148).
component("YGL154C",99).
component("YMR170C",150).
component("YMR169C",149).
component("YBR166C",51).
component("YER014W",85).
component("YEL047C",84).
component("YOR375C",178).
component("YAL062W",37).
component("U62_",32).
component("YKL024C",129).
component("YPR074C",188).
component("YBR117C",49).
component("YPL001W",180).
component("YPL231W",182).
component("YNL029C",154).
component("YIL085C",111).
component("YLR209C",139).
component("YDR354W",77) :- not remove_orf("YDR354W",77).
component("YFR047C",92).
component("YJR133W",126).
...
component("YLR027C",138).
component("YKL106W",130).
component("YGL253W",100).
component("YFR053C",93).
component("YCR036W",57).
component("U15_",20).
component("YKL001C",128).
component("YML070W",147).
component("YFL053W",89).
component("U83_",35).
component("YMR208W",152).
component("U1_",24).
component("YNL267W",160).
component("YLR305C",143).
...
component("YOL061W",165).
component("YKL181W",132).
component("YHL011C",104).
component("YER099C",87).
component("YBL068W",42).
component("YOR143C",170).
component("YPR190C",192).
component("YPR187W",191).
component("YPR110C",189).
component("YPR010C",185).
component("YOR341W",177).
component("YOR340C",176).
component("YOR224C",174).
component("YOR210W",173).
component("YOR207C",172).
component("YOR151C",171).
component("YOR116C",168).
component("YOL005C",163).
component("YNR003C",162).
component("YNL248C",159).
component("YNL151C",158).
component("YNL113W",156).
component("YKL144C",131).
component("YJR063W",120).
component("YJL148W",117).
component("YJL140W",116).
component("YIL021W",110).
component("YHR143W-A",106).
...
component("U84_",36).
component("YPR073C",187).
component("YHR215W",108).
component("YDL024C",58).
component("YBR093C",47).
component("YBR092C",46).
component("YPL228W",181).
component("YMR180C",151).
component("YDL236W",61).
component("YJL155C",118).
component("U30_",29).
component("YLR286C",142).
component("YML035C",145).
component("YJL070C",113).
component("YBR284W",54).
component("YNL045W",155).
component("U53_",30).
component("YDL238C",62).
component("YLR245C",141).
component("YJL126W",114).
component("YBR111C",48).
component("YLR231C",140).
component("U54_",31).
component("YKL211C",134) :- not remove_orf("YKL211C",134).
component("YDR294C",75).
component("YKL211C",135) :- not remove_orf("YKL211C",135).
component("YER090W",135) :- not remove_orf("YER090W",135).
component("YER090W",86) :- not remove_orf("YER090W",86).
component("YDR127W",71).
component("YPL281C",184).
component("YOR393W",179).
component("YMR323W",153).
component("YHR174W",107).
component("YGR254W",103).
component("YGL026C",96) :- not remove_orf("YGL026C",96).
component("YNL316C",161).
component("YKL182W",133).
component("YDR127W",72).
component("YGL148W",98).
component("YDR007W",63) :- not remove_orf("YDR007W",63).
component("YOR095C",167).
component("YPR060C",186).
component("YOL097C",166).
component("YOR335C",175).
component("YGR094W",101).
component("YJR103W",124).
component("YBL039C",41).
component("YPR138C",190).
component("YPL265W",183).
component("YOL020W",164) :- not remove_orf("YOL020W",164).
component("YNL142W",157).
component("YKR053C",137).
component("YKR039W",136) :- not remove_orf("YKR039W",136).
component("YJR095W",123).
component("YJR077C",121).
component("YJL134W",115).
...
catalyst(3500,140).
catalyst(3460,31).
catalyst(3600,134) :- not remove_reaction(3600,134).
catalyst(8781,75).
catalyst(8782,75).
catalyst(3630,135) :- not remove_reaction(3630,135).
...
catalyst(372,157).
catalyst(6560,137).
catalyst(781,136) :- not remove_reaction(781,136).
catalyst(782,136) :- not remove_reaction(782,136).
...
catalyst(881,136) :- not remove_reaction(881,136).
catalyst(882,136) :- not remove_reaction(882,136).
catalyst(1191,136) :- not remove_reaction(1191,136).
catalyst(1192,136) :- not remove_reaction(1192,136).
catalyst(1250,123).
catalyst(1581,121).
catalyst(1582,121).
catalyst(6560,115).
