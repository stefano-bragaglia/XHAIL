...
component("YGR060W",419).
component("YGL012W",389).
component("YKR009C",583).
component("YOL086C",744).
component("YMR303C",683).
component("YMR083W",658).
component("YGL256W",411).
component("YDL168W",252).
component("YBR145W",190).
component("YPL231W",813).
component("U46_",106).
component("YBR149W",191).
component("YJR159W",553).
component("YGL001C",386).
component("YIL094C",491).
component("YHR063C",467).
component("YBR153W",192).
component("YML056C",643).
component("YLR432W",636).
...
component("YOL126C",749).
component("YKL085W",563).
component("YDL078C",233).
component("YKL029C",558).
component("YOR136W",760).
component("YNL037C",688).
component("YDL066W",232).
component("YNL241C",703).
component("YOL059W",742).
component("YDL022W",227).
component("YLR355C",632).
component("YIL074C",489).
component("YER081W",356).
component("YML054C",642).
component("YDL174C",254).
component("YML086C",646).
component("YIL155C",497).
component("YPR191W",848).
component("YOR065W",754).
component("YJL166W",523).
component("YHR001W-A",456).
component("YGR183C",434).
component("YFR033C",382).
component("YDR529C",327).
component("YBL045C",159).
component("Q0105",18).
component("YGR088W",422).
component("YDR256C",296).
component("YKL026C",557).
component("YIR037W",505).
component("YBR244W",203).
component("YJR078W",538).
component("YJR025C",531).
component("YGR255C",446).
component("U108_",22).
component("YBL098W",163).
component("YMR015C",655).
component("YHR007C",457).
component("YDR402C",316).
component("YGL055W",394).
component("YGR175C",431).
component("YJR104C",541).
component("YHR008C",458).
component("YJL026W",507).
component("YIL066C",488).
component("YGR180C",433).
...
component("YPL276W",825).
component("YPL275W",824).
component("YOR388C",792).
component("YOR374W",789).
component("YER073W",354).
component("U68_",120).
component("YGL154C",402).
component("U55_",114).
component("YOR323C",781).
component("YMR170C",667).
component("YMR169C",666).
component("U2_",96).
component("YER178W",369).
component("YBR221C",201).
component("YIL125W",495).
component("U52_",111).
component("YBR166C",195).
component("YNL280C",714).
component("YGL012W",390).
component("U57_",115).
component("YKL216W",580).
component("YDR044W",270).
component("YER014W",339).
component("YKR009C",584).
component("YIL160C",499).
component("YGL205W",405).
component("YMR118C",663).
component("YLR164W",613).
component("YLL041C",593).
component("YKL148C",570).
component("YKL141W",568).
component("YJL045W",508).
component("YDR178W",290).
component("YJR051W",533).
component("YEL047C",333).
component("YDL215C",258).
component("YOR375C",790).
component("YDL215C",259).
component("YAL062W",150).
component("U99_",145).
component("YBR035C",176).
component("YMR189W",669).
component("YHR037W",464).
component("YKR080W",588).
component("YER023W",341).
component("YPL023C",796).
component("YGL125W",399).
component("YOR236W",775).
component("YGR204W",438).
component("YLR142W",608).
component("U62_",118).
component("YKL150W",571).
component("YIL043C",485).
component("YHR042W",465).
component("YOR221C",773).
component("YML120C",649).
component("YKL192C",577).
component("YKL055C",560).
component("YER061C",349).
component("YGR234W",441).
component("YFR030W",381).
component("YPL017C",795).
component("YFL018C",373).
component("YDR353W",311).
component("YER042W",343).
component("YJR137C",546).
component("YPL266W",820).
component("YML110C",648).
component("YBR034C",175).
component("YPL273W",822).
component("YLL062C",596).
component("YDR410C",319).
component("U47_",107).
component("YER091C",361).
component("YJR073C",536).
component("YDL033C",229).
component("YOL096C",745).
component("YLR172C",614).
component("YDR019C",266).
component("YBR176W",196).
component("YDR408C",318).
component("YMR120C",664).
component("YBL013W",154).
component("YKL024C",556).
component("YPR074C",837).
component("YBR117C",186).
component("YLR354C",631).
component("YGR043C",417).
component("YMR108W",661).
component("YCL009C",213).
component("YMR062C",657).
component("YNL071W",691).
component("YNR008W",721).
component("YNL277W",712).
component("YFL017C",372).
component("YPL231W",814).
component("YER061C",350).
component("U86_",135).
component("YPL001W",794).
component("YDR148C",287).
component("YOR377W",791).
component("YGR177C",432).
component("YPL231W",815).
component("YGR147C",427).
component("YDL040C",230).
component("YPL028W",797).
component("YGL017W",391).
component("YPR001W",827).
component("YNR001C",719).
component("YDL182W",255).
component("YDL131W",243).
component("YNL117W",695).
component("YIR031C",503).
component("YOR321W",780).
component("YJR143C",548).
component("YGR199W",437).
...
component("YMR261C",677).
component("YML100W",647).
component("YBR126C",189).
component("YNL192W",702).
component("YBR038W",178).
component("YBR023C",174).
component("YMR306W",685).
component("YLR342W",629).
component("YGR032W",415).
component("YLR209C",615).
component("U104_",21).
component("YOR209C",771).
...
component("U82_",132).
component("U81_",131).
component("YMR208W",671).
component("YHR025W",463).
component("YOR347C",786).
component("YAL038W",149).
component("YNR012W",722).
component("YPR121W",841).
component("YPL258C",817).
component("YOL055C",738).
component("YPL214C",811).
component("U1_",74).
component("YDR009W",265).
component("YBR020W",172).
component("YNL267W",710).
component("YLR305C",626).
component("YFR019W",379).
...
component("U17_",59).
component("U76_",128).
component("YMR220W",673).
component("YER170W",368).
component("YDR226W",292).
component("YKL067W",562).
component("YOL055C",739).
component("YDR454C",323).
component("YJR057W",534).
component("YOL061W",743).
component("YKL181W",573).
component("YHL011C",451).
component("YER099C",363).
component("YBL068W",162).
component("YOR143C",762).
component("YNL256W",707).
component("YLR328W",627).
component("YBR018C",168).
component("YBR018C",169).
component("YGR007W",412).
component("YLR328W",628).
component("YKR002W",582).
component("YDL103C",241).
component("YJR010W",530).
component("YGL130W",400).
component("YDR530C",328).
component("YCL050C",218).
component("YPR190C",847).
component("YPR187W",846).
component("YPR110C",839).
component("YPR010C",830).
component("YOR341W",785).
component("YOR340C",784).
component("YOR224C",774).
component("YOR210W",772).
component("YOR207C",769).
component("YOR151C",763).
component("YOR116C",757).
component("YOL005C",732).
component("YNR003C",720).
component("YNL248C",705).
component("YNL151C",699).
component("YNL113W",694).
component("YKL144C",569).
component("YJR063W",535).
component("YJL148W",520).
component("YJL140W",519).
component("YIL021W",484).
component("YHR143W-A",476).
...
component("YOL115W",748).
component("YNL299W",716).
component("YNL262W",709).
component("YNL102W",693).
component("YJR043C",532).
component("YJR006W",529).
component("YJL090C",512).
component("YIL139C",496).
...
component("YKL035W",559).
component("YHL012W",452).
component("YHR123W",474).
component("YPR113W",840).
...
component("YJL068C",509).
component("YDR058C",275).
component("YNR034W",726).
component("YHR163W",478).
component("YGR248W",444).
component("YCR073W-A",224).
component("YDL086W",235).
component("YOL011W",734).
component("YMR008C",652).
component("YMR006C",651).
component("U101_",19).
component("YBL015W",155).
component("YJL068C",510).
component("YPL072W",800).
component("YOR124C",758).
component("YNL186W",701).
component("YMR304W",684).
component("YMR223W",674).
component("YKR098C",591).
component("YJL197W",525).
component("YIL156W",498).
component("YFR010W",378).
component("YER151C",366).
component("YER144C",365).
component("YER098W",362).
...
component("U84_",134).
component("YLR377C",634).
component("YDR074W",277).
component("YPL179W",808).
component("YNR032W",724).
component("YML057W",644).
component("YML016C",638).
component("YLR433C",637).
component("YGR123C",425).
component("YER133W",364).
component("YER089C",359).
...
component("YIL053W",487).
component("YER062C",351).
component("YHR046C",466).
component("YGR208W",440).
component("YPL228W",812).
component("YMR180C",668).
component("YDL236W",261).
component("YJL155C",522).
component("YPR073C",836).
component("YOR208W",770).
component("YNL053W",690).
component("YMR036C",656).
component("YIR026C",500).
component("YIL113W",493).
component("YFR028C",380).
...
component("YOR360C",788).
component("YGL248W",409).
component("YKR031C",585).
component("YPL206C",809).
component("YLR286C",621).
component("YJR153W",551).
component("YOR190W",767).
component("YLR300W",622).
component("YGR282C",449).
component("YDR261C",297).
component("YDR400W",315).
component("U23_",91).
component("YML035C",640).
component("YJL070C",511).
component("YBR284W",209).
component("U102_",20).
component("YNL045W",689).
...
component("YMR293C",681).
component("YDR242W",294).
component("YBR208C",198).
component("YMR281W",680).
component("U53_",112).
component("YIR027C",501).
component("YPL111W",803).
component("YIR032C",504).
component("YIR029W",502).
component("YPR062W",834).
component("YMR120C",665).
...
component("YLR245C",619).
component("YML035C",641).
component("YJL126W",515).
component("U44_",105).
component("YDL100C",239).
component("U87_",136).
component("YMR267W",678).
component("YBR011C",167).
component("YBR111C",185).
component("YBR252W",205).
component("YCL030C",216).
component("YER005W",338).
component("YIL048W",486).
component("YER166W",367).
component("YDR093W",279).
component("YAL026C",148).
component("YLR231C",617).
component("U88_",137).
component("YLR134W",606).
component("YLR044C",599).
component("YGR087C",421).
component("YDR380W",313).
component("YDL080C",234).
component("U98_",144).
component("YMR250W",676).
component("YKL184W",576).
component("YNR043W",728).
component("U93_",142).
component("YDR047W",273).
component("U54_",113).
component("YKL211C",578) :- not remove_orf("YKL211C",578).
component("YKR097W",590).
component("YOL052C",737).
component("YNL169C",700).
component("YGR170W",429).
component("YKL060C",561).
component("YNL256W",708).
component("YDR294C",301).
component("YEL046C",332).
component("YNR033W",725).
component("YPR006C",829).
component("YER065C",352).
component("YKL211C",579) :- not remove_orf("YKL211C",579).
component("YER090W",579) :- not remove_orf("YER090W",579).
component("YER090W",360) :- not remove_orf("YER090W",360).
component("YDR127W",284).
component("YPL281C",826).
component("YOR393W",793).
component("YMR323W",686).
component("YHR174W",479).
component("YGR254W",445).
component("YPL262W",818).
component("YGL026C",392) :- not remove_orf("YGL026C",392).
component("YGR155W",428).
component("YLR304C",625).
component("YJL200C",526).
component("YNL316C",717).
component("YKL182W",574).
component("YPL212C",810).
component("YNL292W",715).
component("YGL063W",396).
component("YFL001W",370).
component("YOR278W",777).
component("YPR002W",828).
component("YDR127W",285).
component("YGL148W",401).
component("YER086W",357).
component("YLR359W",633).
component("YAL012W",146).
component("YFR055W",385).
component("YJL005W",506).
component("YOR176W",765).
component("YJL121C",514).
component("YBR019C",170).
component("YBR019C",171).
component("YDR050C",274).
component("YDR007W",264) :- not remove_orf("YDR007W",264).
component("YOR095C",756).
component("YER003C",337).
component("YBR196C",197).
component("YGL001C",387).
component("U14_",38).
component("YOL056W",740).
component("YKL152C",572).
component("YDL021W",226).
component("YMR105C",660).
component("YKL127W",566).
component("YEL058W",335).
component("YPR060C",833).
component("YHR072W",468).
component("YJL153C",521).
component("YPL097W",801).
component("YGR185C",435).
component("YGR264C",447).
component("YGR171C",430).
component("YHR011W",459).
component("YDR023W",267).
component("YPL104W",802).
component("YLL018C",592).
component("YPR081C",838).
component("YBR121C",187).
component("YHR020W",462).
component("YER087W",358).
component("YNL247W",704).
component("YOL033W",736).
component("YGL245W",408).
component("YHR091C",470).
component("YDR341C",307).
component("YOL097C",746).
component("YDR268W",298).
component("YPR047W",832).
component("YLR060W",601).
component("YFL022C",374).
component("YPR033C",831).
component("YHR019C",460).
component("YHR019C",461).
component("YPL160W",805).
component("YLR382C",635).
component("YNL073W",692).
component("YDR037W",269).
component("YOR335C",783).
component("YGR094W",423).
component("YOR317W",779).
component("YMR246W",675).
component("YIL009W",483).
component("YER015W",340).
component("YOR142W",761).
component("YGR244C",443).
component("U89_",138).
component("YOR241W",776).
component("YMR113W",662).
component("YKL132C",567).
component("YJL101C",513).
component("U92_",141).
...
component("YJR103W",540).
component("YBL039C",157).
component("YGR204W",439).
component("YBR084W",182).
component("YOL058W",741).
component("YBR208C",199).
component("YHR074W",469).
component("YMR217W",672).
component("YGR061C",420).
component("YPR145W",843).
component("YGR124W",426).
component("YOR303W",778).
component("YJR109C",543).
component("YJL130C",517).
component("YGL062W",395).
component("YBR218C",200).
component("YPL231W",816).
component("YNR016C",723).
component("YKL182W",575).
component("YGR037C",416).
component("YOR005C",753).
component("YDL164C",251).
component("YOL010W",733).
component("YPR138C",842).
component("YPL274W",823).
component("YPL265W",819).
component("YPL057C",799).
component("YPL036W",798).
component("YOR348C",787).
component("YOR192C",768).
component("YOR171C",764).
component("YOR130C",759).
component("YOR071C",755).
component("YOL156W",752).
component("YOL103W",747).
component("YOL020W",735) :- not remove_orf("YOL020W",735).
component("YNR072W",731).
component("YNR056C",729).
component("YNL318C",718).
component("YNL268W",711).
component("YNL142W",698).
component("YMR272C",679).
component("YMR011W",653).
component("YML123C",650).
component("YLR348C",630).
component("YLR260W",620).
component("YLR237W",618).
component("YLR138W",607).
component("YLR100C",604).
component("YLR081W",602).
component("YLL061W",595).
component("YLL043W",594).
component("YKR093W",589).
component("YKR053C",587).
component("YKR039W",586) :- not remove_orf("YKR039W",586).
component("YKL217W",581).
component("YKL004W",555).
component("YJR158W",552).
component("YJR152W",550).
component("YJR095W",539).
component("YJR077C",537).
component("YJL219W",528).
component("YJL214W",527).
component("YJL134W",518).
component("YJL129C",516).
component("YHR096C",473).
component("YHR094C",472).
component("YHR092C",471).
component("YHL036W",455).
component("YHL016C",453).
component("YGR121C",424).
component("YGR055W",418).
component("YGL186C",403).
component("YGL077C",398).
component("YGL008C",388).
...
catalyst(1960,273).
catalyst(3460,113).
catalyst(3600,578) :- not remove_reaction(3600,578).
catalyst(8000,590).
catalyst(3941,737).
catalyst(3942,737).
catalyst(6890,700).
...
catalyst(8020,829).
catalyst(8020,352).
catalyst(1890,579) :- not remove_reaction(1890,579).
catalyst(3630,579) :- not remove_reaction(3630,579).
catalyst(1890,360) :- not remove_reaction(1890,360).
catalyst(3630,360) :- not remove_reaction(3630,360).
catalyst(3740,284).
catalyst(8231,826).
catalyst(8232,826).
catalyst(8231,793).
...
catalyst(8051,818).
catalyst(8052,818).
catalyst(3590,392) :- not remove_reaction(3590,392).
catalyst(10910,392) :- not remove_reaction(10910,392).
catalyst(4570,428).
catalyst(8181,625).
catalyst(8182,625).
catalyst(8181,526).
...
catalyst(640,589).
catalyst(6560,587).
catalyst(761,586) :- not remove_reaction(761,586).
catalyst(762,586) :- not remove_reaction(762,586).
catalyst(771,586) :- not remove_reaction(771,586).
catalyst(772,586) :- not remove_reaction(772,586).
catalyst(781,586) :- not remove_reaction(781,586).
catalyst(782,586) :- not remove_reaction(782,586).
catalyst(791,586) :- not remove_reaction(791,586).
catalyst(792,586) :- not remove_reaction(792,586).
...
catalyst(821,586) :- not remove_reaction(821,586).
catalyst(822,586) :- not remove_reaction(822,586).
catalyst(831,586) :- not remove_reaction(831,586).
catalyst(832,586) :- not remove_reaction(832,586).
catalyst(841,586) :- not remove_reaction(841,586).
catalyst(842,586) :- not remove_reaction(842,586).
catalyst(861,586) :- not remove_reaction(861,586).
catalyst(862,586) :- not remove_reaction(862,586).
catalyst(881,586) :- not remove_reaction(881,586).
catalyst(882,586) :- not remove_reaction(882,586).
catalyst(901,586) :- not remove_reaction(901,586).
catalyst(902,586) :- not remove_reaction(902,586).
catalyst(911,586) :- not remove_reaction(911,586).
catalyst(912,586) :- not remove_reaction(912,586).
catalyst(941,586) :- not remove_reaction(941,586).
catalyst(942,586) :- not remove_reaction(942,586).
catalyst(1191,586) :- not remove_reaction(1191,586).
catalyst(1192,586) :- not remove_reaction(1192,586).
catalyst(1021,581).
catalyst(1022,581).
catalyst(6610,555).
catalyst(1210,552).
