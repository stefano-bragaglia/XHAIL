...
component("YNL280C",539).
component("YGR060W",323).
component("YGL012W",299).
component("YOL086C",560).
component("YMR303C",517).
component("YGL256W",317).
component("YDL168W",195).
component("YBR145W",152).
component("YPL231W",611).
component("U46_",82).
component("YBR149W",153).
component("YGL001C",296).
component("YIL094C",371).
component("YHR063C",354).
component("YBR153W",154).
component("YML056C",489).
component("YLR432W",485).
component("YHR216W",365).
component("YAR075W",123).
component("YAR073W",122).
component("YDR127W",217).
component("YJR139C",420).
component("YOL126C",564).
component("YDL078C",184).
component("YKL029C",424).
component("YOR136W",574).
component("YDL066W",183).
component("YLR355C",482).
component("YML086C",491).
component("YIL155C",375).
component("YPR191W",639).
component("YOR065W",569).
component("YJL166W",398).
component("YHR001W-A",349).
component("YGR183C",334).
component("YFR033C",292).
component("YDR529C",250).
component("YBL045C",129).
component("Q0105",18).
component("YGR088W",325).
component("YDR256C",231).
component("YJR078W",411).
component("YJR025C",405).
component("YGR255C",343).
component("YBL098W",132).
component("YMR015C",497).
component("YDR402C",242).
component("YGL055W",304).
component("YGR175C",331).
component("YJR104C",414).
component("YHR008C",350).
component("YJL026W",382).
component("YGR180C",333).
component("YER070W",270).
component("U35_",79).
component("YDL168W",196).
component("YDR158W",225).
component("YPL276W",620).
component("YPL275W",619).
component("YOR388C",597).
component("YOR374W",594).
component("YER073W",271).
component("YGL154C",310).
component("U55_",89).
component("YOR323C",586).
component("YMR170C",505).
component("YMR169C",504).
component("U2_",76).
component("YBR221C",162).
component("U52_",86).
component("YBR166C",157).
component("YNL280C",540).
component("YGL012W",300).
component("U57_",90).
component("YDR044W",208).
component("YER014W",259).
component("YKR009C",442).
component("YIL160C",377).
component("YGL205W",313).
component("YMR118C",502).
component("YLR164W",467).
component("YLL041C",450).
component("YKL148C",432).
component("YJL045W",383).
component("YDR178W",226).
component("YJR051W",407).
component("YEL047C",254).
component("YOR375C",595).
component("YDL215C",199).
component("YAL062W",120).
component("U99_",116).
component("YBR035C",140).
component("YHR037W",351).
component("YKR080W",446).
component("YER023W",260).
component("YOR236W",583).
component("YGR204W",336).
component("YLR142W",462).
component("U62_",92).
component("YKL150W",433).
component("YIL043C",367).
component("YHR042W",352).
component("YFR030W",291).
component("YPL017C",600).
component("YFL018C",283).
component("YER042W",262).
component("YJR137C",419).
component("YPL266W",617).
component("YML110C",493).
component("YBR034C",139).
component("YPL273W",618).
component("YLL062C",453).
component("U47_",83).
component("YER091C",274).
component("YJR073C",409).
component("YDL033C",181).
component("YOL096C",561).
component("YDR019C",205).
component("YDR408C",244).
component("YBL013W",124).
component("YKL024C",423).
component("YPR074C",631).
component("YBR117C",149).
component("YLR354C",481).
component("YGR043C",321).
component("YCL009C",171).
component("YMR062C",499).
component("YNL071W",523).
component("YNR008W",547).
component("YPL231W",612).
component("YER061C",268).
component("U86_",107).
component("YPL001W",599).
component("YDR148C",223).
component("YOR377W",596).
component("YGR177C",332).
component("YPL231W",613).
component("YGR147C",328).
component("YDL040C",182).
component("YPL028W",601).
component("YGL017W",301).
component("YPR001W",622).
component("YNR001C",545).
component("YDL182W",197).
component("YDL131W",189).
component("YNL117W",526).
component("YIR031C",380).
component("YNL029C",520).
component("YIL085C",370).
component("YMR261C",512).
component("YML100W",492).
component("YBR126C",151).
component("YNL192W",532).
component("YBR038W",142).
component("YBR023C",138).
component("YLR209C",468).
component("U104_",21).
component("YMR300C",516).
component("YER055C",264).
component("YDR354W",238) :- not remove_orf("YDR354W",238).
component("YFR047C",293).
component("YJR133W",418).
component("YLR209C",469).
component("YML022W",486).
component("YDR441C",246).
component("YDR399W",240).
component("YJL167W",399).
component("YNL256W",535).
component("YDR127W",218).
component("YLR303W",475).
component("YJR130C",417).
component("YLR303W",476).
component("YDR035W",206).
component("YBR249C",163).
component("YOL143C",566).
component("YBR256C",164).
component("YHR137W",359).
component("YGL202W",312).
component("YLR027C",454).
component("YKL106W",428).
component("YKL104C",427).
component("YGR019W",319).
component("YLR089C",458).
component("U64_",93).
component("U51_",85).
component("YJR148W",421).
component("YGL253W",316).
component("YFR053C",294).
component("YOL136C",565).
component("YIL107C",372).
component("YMR205C",507).
component("YGR240C",339).
component("YDR248C",230).
component("YCR036W",178).
component("YCL040W",173).
component("YJR105W",415).
component("U16_",38).
component("U15_",35).
component("U96_",114).
component("YKL001C",422).
component("YML070W",490).
component("YFL053W",286).
component("YHL032C",347).
component("U83_",105).
component("U82_",104).
component("U81_",103).
component("YMR208W",508).
component("YOR347C",591).
component("YAL038W",119).
component("YNR012W",548).
component("YPR121W",634).
component("YPL258C",615).
component("YOL055C",557).
component("U1_",58).
component("YDR009W",204).
component("YBR020W",136).
component("YNL267W",537).
component("YLR305C",478).
component("YFR019W",289).
component("YDR208W",227).
component("YDR127W",219).
component("U21_",67).
component("U20_",65).
component("YDR147W",222).
component("YDR300C",235).
component("YCR012W",175).
component("U18_",51).
component("U17_",45).
component("U76_",101).
component("YER170W",280).
component("YDR226W",228).
component("YKL067W",426).
component("YDR454C",247).
component("YOL061W",559).
component("YKL181W",435).
component("YHL011C",345).
component("YER099C",276).
component("YBL068W",131).
component("YOR143C",575).
component("YGR007W",318).
component("YLR328W",479).
component("YJR010W",404).
component("YCL050C",174).
component("YPR190C",638).
component("YPR187W",637).
component("YPR110C",633).
component("YPR010C",624).
component("YOR341W",590).
component("YOR340C",589).
component("YOR224C",582).
component("YOR210W",581).
component("YOR207C",579).
component("YOR151C",576).
component("YOR116C",572).
component("YOL005C",553).
component("YNR003C",546).
component("YNL248C",534).
component("YNL151C",530).
component("YNL113W",525).
component("YKL144C",431).
component("YJR063W",408).
component("YJL148W",395).
component("YJL140W",394).
component("YIL021W",366).
component("YHR143W-A",360).
component("YGL070C",307).
component("YFL036W",285).
component("YDR404C",243).
component("YDR156W",224).
component("YDR045C",209).
component("YDL150W",193).
component("YDL140C",190).
component("YBR154C",156).
component("YPR175W",636).
component("YPL167C",608).
component("YOR330C",587).
component("YOL115W",563).
component("YNL299W",542).
component("YNL262W",536).
component("YNL102W",524).
component("YJR043C",406).
component("YJR006W",403).
component("YJL090C",387).
component("YIL139C",374).
component("YEL055C",255).
component("YDR419W",245).
component("YDR121W",216).
component("YDL102W",187).
component("YCR014C",176).
component("YBR278W",166).
component("YBL035C",126).
component("YKL035W",425).
component("YHL012W",346).
component("YHR123W",358).
component("YDL142C",192).
component("YER026C",261).
component("YCL004W",170).
component("YJL068C",384).
component("YDR058C",213).
component("YNR034W",551).
component("YHR163W",362).
component("YGR248W",341).
component("YCR073W-A",179).
component("YDL086W",186).
component("YOL011W",554).
component("YMR008C",496).
component("YMR006C",495).
component("U101_",19).
component("YBL015W",125).
component("YJL068C",385).
component("YPL072W",604).
component("YOR124C",573).
component("YNL186W",531).
component("YMR304W",518).
component("YMR223W",510).
component("YKR098C",448).
component("YJL197W",400).
component("YIL156W",376).
component("YFR010W",288).
component("YER151C",278).
component("YER144C",277).
component("YER098W",275).
component("YDR069C",214).
component("YDL122W",188).
component("YBR058C",143).
component("YBL067C",130).
component("U84_",106).
component("YPR073C",629).
component("YHR215W",364).
component("YDL024C",180).
component("YBR093C",147).
component("YBR092C",146).
component("YAR071W",121).
component("YIL053W",369).
component("YER062C",269).
component("YHR046C",353).
component("YGR208W",338).
component("YPL228W",610).
component("YMR180C",506).
component("YDL236W",201).
component("YJL155C",397).
component("YPR073C",630).
component("YOR208W",580).
component("YNL053W",522).
component("YMR036C",498).
component("YIR026C",378).
component("YIL113W",373).
component("YFR028C",290).
component("YER075C",272).
component("YDL230W",200).
component("YBR276C",165).
component("U34_",78).
component("U30_",77).
component("U25_",75).
component("U24_",74).
component("YOR360C",593).
component("YGL248W",315).
component("YKR031C",443).
component("YLR286C",473).
component("YOR190W",577).
component("YLR300W",474).
component("YGR282C",344).
component("YDR261C",232).
component("YDR400W",241).
component("U23_",73).
component("YML035C",487).
component("YJL070C",386).
component("YBR284W",167).
component("U102_",20).
component("YNL045W",521).
component("YLR160C",466).
component("YLR158C",465).
component("YLR157C",464).
component("YLR155C",463).
component("YDR321W",236).
component("YGL037C",303).
component("YDR242W",229).
component("YBR208C",159).
component("YMR281W",515).
component("U53_",87).
component("YIR032C",381).
component("YIR029W",379).
component("YPR062W",628).
component("YMR120C",503).
component("YHR144C",361).
component("YNL141W",527).
component("YBR153W",155).
component("YDL238C",202).
component("YNL141W",528).
component("YLR245C",472).
component("YML035C",488).
component("YJL126W",390).
component("U87_",108).
component("YMR267W",513).
component("YBR011C",133).
component("YBR111C",148).
component("YER005W",258).
component("YIL048W",368).
component("YER166W",279).
component("YDR093W",215).
component("YAL026C",118).
component("YLR231C",470).
component("U88_",109).
component("YLR134W",460).
component("YLR044C",455).
component("YGR087C",324).
component("YDR380W",239).
component("YDL080C",185).
component("U98_",115).
component("YMR250W",511).
component("YKL184W",438).
component("YNR043W",552).
component("U93_",113).
component("YDR047W",211).
component("U54_",88).
component("YKL211C",439) :- not remove_orf("YKL211C",439).
component("YGR170W",330).
component("YDR294C",233).
component("YEL046C",253).
component("YNR033W",550).
component("YKL211C",440) :- not remove_orf("YKL211C",440).
component("YER090W",440) :- not remove_orf("YER090W",440).
component("YER090W",273) :- not remove_orf("YER090W",273).
component("YDR127W",220).
component("YPL281C",621).
component("YOR393W",598).
component("YMR323W",519).
component("YHR174W",363).
component("YGR254W",342).
component("YGL026C",302) :- not remove_orf("YGL026C",302).
component("YGR155W",329).
component("YLR304C",477).
component("YJL200C",401).
component("YNL316C",543).
component("YKL182W",436).
component("YPL212C",609).
component("YNL292W",541).
component("YGL063W",306).
component("YFL001W",281).
component("YPR002W",623).
component("YDR127W",221).
component("YGL148W",309).
component("YLR359W",483).
component("YAL012W",117).
component("YFR055W",295).
component("YJL121C",389).
component("YBR019C",134).
component("YBR019C",135).
component("YDR050C",212).
component("YDR007W",203) :- not remove_orf("YDR007W",203).
component("YOR095C",571).
component("YER003C",257).
component("YBR196C",158).
component("YGL001C",297).
component("U14_",30).
component("YKL152C",434).
component("YMR105C",500).
component("YKL127W",429).
component("YEL058W",256).
component("YPR060C",627).
component("YHR072W",355).
component("YJL153C",396).
component("YPL097W",605).
component("YGR185C",335).
component("YPL104W",606).
component("YLL018C",449).
component("YPR081C",632).
component("YBR121C",150).
component("YNL247W",533).
component("YOL033W",556).
component("YHR091C",357).
component("YDR341C",237).
component("YOL097C",562).
component("YPR047W",626).
component("YLR060W",456).
component("YFL022C",284).
component("YPR033C",625).
component("YPL160W",607).
component("YLR382C",484).
component("YDR037W",207).
component("YOR335C",588).
component("YGR094W",326).
component("YGR244C",340).
component("U89_",110).
component("YOR241W",584).
component("YMR113W",501).
component("YKL132C",430).
component("YJL101C",388).
component("U92_",112).
component("YGL234W",314).
component("U91_",111).
component("YDL141W",191).
component("YJR103W",413).
component("YBL039C",127).
component("YGR204W",337).
component("YOL058W",558).
component("YBR208C",160).
component("YHR074W",356).
component("YMR217W",509).
component("YOR303W",585).
component("YJR109C",416).
component("YJL130C",392).
component("YGL062W",305).
component("YBR218C",161).
component("YPL231W",614).
component("YNR016C",549).
component("YKL182W",437).
component("YGR037C",320).
component("YOR005C",568).
component("YDL164C",194).
component("YPR138C",635).
component("YPL265W",616).
component("YPL057C",603).
component("YPL036W",602).
component("YOR348C",592).
component("YOR192C",578).
component("YOR071C",570).
component("YOL156W",567).
component("YOL020W",555) :- not remove_orf("YOL020W",555).
component("YNL318C",544).
component("YNL268W",538).
component("YNL142W",529).
component("YMR272C",514).
component("YML123C",494).
component("YLR348C",480).
component("YLR237W",471).
component("YLR138W",461).
component("YLR100C",459).
component("YLR081W",457).
component("YLL061W",452).
component("YLL043W",451).
component("YKR093W",447).
component("YKR053C",445).
component("YKR039W",444) :- not remove_orf("YKR039W",444).
component("YKL217W",441).
component("YJR095W",412).
component("YJR077C",410).
component("YJL219W",402).
component("YJL134W",393).
component("YJL129C",391).
component("YHL036W",348).
component("YGR121C",327).
component("YGR055W",322).
component("YGL186C",311).
component("YGL077C",308).
component("YGL008C",298).
component("YFL055W",287).
component("YFL011W",282).
component("YER060W-A",267).
component("YER060W",266).
component("YER056C",265).
component("YER053C",263).
component("YEL017C-A",252).
component("YDR536W",251).
component("YDR508C",249).
component("YDR503C",248).
component("YDR294C",234).
component("YDR046C",210) :- not remove_orf("YDR046C",210).
component("YDL210W",198).
component("YCR024C-A",177).
component("YCL025C",172).
component("YBR298C",169).
component("YBR291C",168).
component("YBR069C",145) :- not remove_orf("YBR069C",145).
component("YBR068C",144) :- not remove_orf("YBR068C",144).
component("YBR036C",141).
component("YBR021W",137).
component("YBL042C",128).
component("U79_",102).
component("U75_",100).
component("U74_",99).
component("U73_",98).
...
catalyst(6160,516).
catalyst(3870,264).
catalyst(3620,238) :- not remove_reaction(3620,238).
catalyst(2110,293).
catalyst(2190,293).
catalyst(5550,418).
catalyst(5791,469).
...
catalyst(1960,211).
catalyst(3460,88).
catalyst(3600,439) :- not remove_reaction(3600,439).
catalyst(6900,330).
catalyst(8781,233).
catalyst(8782,233).
catalyst(4560,253).
catalyst(2550,550).
catalyst(3630,440) :- not remove_reaction(3630,440).
catalyst(3630,273) :- not remove_reaction(3630,273).
catalyst(3740,220).
catalyst(8231,621).
catalyst(8232,621).
catalyst(8231,598).
...
catalyst(8231,342).
catalyst(8232,342).
catalyst(3590,302) :- not remove_reaction(3590,302).
catalyst(10910,302) :- not remove_reaction(10910,302).
catalyst(4570,329).
catalyst(8181,477).
catalyst(8182,477).
catalyst(8181,401).
...
catalyst(8281,212).
catalyst(8282,212).
catalyst(3610,203) :- not remove_reaction(3610,203).
catalyst(7921,571).
catalyst(7922,571).
catalyst(7841,257).
catalyst(7842,257).
...
catalyst(190,570).
catalyst(1200,567).
catalyst(801,555) :- not remove_reaction(801,555).
catalyst(802,555) :- not remove_reaction(802,555).
catalyst(811,555) :- not remove_reaction(811,555).
catalyst(812,555) :- not remove_reaction(812,555).
catalyst(831,555) :- not remove_reaction(831,555).
catalyst(832,555) :- not remove_reaction(832,555).
catalyst(941,555) :- not remove_reaction(941,555).
catalyst(942,555) :- not remove_reaction(942,555).
catalyst(1200,544).
catalyst(761,538).
catalyst(762,538).
catalyst(371,529).
...
catalyst(640,447).
catalyst(6560,445).
catalyst(761,444) :- not remove_reaction(761,444).
catalyst(762,444) :- not remove_reaction(762,444).
catalyst(771,444) :- not remove_reaction(771,444).
catalyst(772,444) :- not remove_reaction(772,444).
catalyst(781,444) :- not remove_reaction(781,444).
catalyst(782,444) :- not remove_reaction(782,444).
catalyst(791,444) :- not remove_reaction(791,444).
catalyst(792,444) :- not remove_reaction(792,444).
catalyst(801,444) :- not remove_reaction(801,444).
catalyst(802,444) :- not remove_reaction(802,444).
catalyst(811,444) :- not remove_reaction(811,444).
catalyst(812,444) :- not remove_reaction(812,444).
catalyst(821,444) :- not remove_reaction(821,444).
catalyst(822,444) :- not remove_reaction(822,444).
catalyst(831,444) :- not remove_reaction(831,444).
catalyst(832,444) :- not remove_reaction(832,444).
catalyst(841,444) :- not remove_reaction(841,444).
catalyst(842,444) :- not remove_reaction(842,444).
catalyst(861,444) :- not remove_reaction(861,444).
catalyst(862,444) :- not remove_reaction(862,444).
catalyst(881,444) :- not remove_reaction(881,444).
catalyst(882,444) :- not remove_reaction(882,444).
catalyst(911,444) :- not remove_reaction(911,444).
catalyst(912,444) :- not remove_reaction(912,444).
catalyst(941,444) :- not remove_reaction(941,444).
catalyst(942,444) :- not remove_reaction(942,444).
catalyst(1191,444) :- not remove_reaction(1191,444).
catalyst(1192,444) :- not remove_reaction(1192,444).
catalyst(1021,441).
catalyst(1022,441).
catalyst(1250,412).
catalyst(1581,410).
...
catalyst(1511,168).
catalyst(1512,168).
catalyst(771,145) :- not remove_reaction(771,145).
catalyst(772,145) :- not remove_reaction(772,145).
catalyst(791,145) :- not remove_reaction(791,145).
catalyst(792,145) :- not remove_reaction(792,145).
catalyst(801,145) :- not remove_reaction(801,145).
catalyst(802,145) :- not remove_reaction(802,145).
catalyst(811,145) :- not remove_reaction(811,145).
catalyst(812,145) :- not remove_reaction(812,145).
catalyst(861,145) :- not remove_reaction(861,145).
catalyst(862,145) :- not remove_reaction(862,145).
catalyst(791,144) :- not remove_reaction(791,144).
catalyst(792,144) :- not remove_reaction(792,144).
catalyst(801,144) :- not remove_reaction(801,144).
catalyst(802,144) :- not remove_reaction(802,144).
catalyst(811,144) :- not remove_reaction(811,144).
catalyst(812,144) :- not remove_reaction(812,144).
catalyst(831,144) :- not remove_reaction(831,144).
catalyst(832,144) :- not remove_reaction(832,144).
catalyst(841,144) :- not remove_reaction(841,144).
catalyst(842,144) :- not remove_reaction(842,144).
catalyst(861,144) :- not remove_reaction(861,144).
catalyst(862,144) :- not remove_reaction(862,144).
catalyst(6600,141).
catalyst(620,137).
catalyst(540,128).
catalyst(2830,102).
...
modifiable_enzyme(444).
modifiable_enzyme(210).
modifiable_enzyme(145).
