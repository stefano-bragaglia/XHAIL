...
component("YNL280C",708).
component("YLR056W",595).
component("YGR060W",418).
component("YGL012W",388).
component("YKR009C",578).
component("YOL086C",739).
component("YMR303C",678).
component("YMR083W",653).
component("YGL256W",410).
component("YDL168W",252).
component("YBR145W",190).
component("YPL231W",808).
component("U46_",106).
component("YBR149W",191).
component("YJR159W",549).
component("YGL001C",385).
component("YIL094C",488).
component("YHR063C",466).
component("YBR153W",192).
component("YML056C",638).
component("YLR432W",631).
component("YHR216W",480).
component("YAR075W",153).
component("YAR073W",152).
component("YCL030C",215).
component("YDR127W",281).
component("YJR139C",543).
component("YOL126C",744).
component("YDL078C",233).
component("YKL029C",554).
component("YOR136W",755).
component("YNL037C",683).
component("YDL066W",232).
component("YNL241C",698).
component("YOL059W",737).
component("YDL022W",227).
component("YLR355C",627).
component("YML054C",637).
component("YDL174C",254).
component("YML086C",641).
component("YIL155C",494).
component("YPR191W",843).
component("YOR065W",749).
component("YJL166W",519).
component("YHR001W-A",455).
component("YGR183C",433).
component("YFR033C",381).
component("YDR529C",327).
component("YBL045C",159).
component("Q0105",18).
component("YGR088W",421).
component("YDR256C",296).
component("YKL026C",553).
component("YIR037W",502).
component("YBR244W",203).
component("YJR078W",534).
component("YJR025C",527).
component("YGR255C",445).
component("U108_",22).
component("YBL098W",163).
component("YMR015C",650).
component("YHR007C",456).
component("YDR402C",316).
component("YGL055W",393).
component("YGR175C",430).
component("YJR104C",537).
component("YHR008C",457).
component("YJL026W",503).
component("YIL066C",486).
component("YGR180C",432).
component("YER070W",353).
component("U38_",102).
component("U36_",101).
component("U35_",100).
component("YDL168W",253).
component("YDR158W",289).
component("YBR006W",166).
component("YPL276W",820).
component("YPL275W",819).
component("YOR388C",787).
component("YOR374W",784).
component("YER073W",354).
component("U68_",120).
component("YGL154C",401).
component("U55_",114).
component("YOR323C",776).
component("YMR170C",662).
component("YMR169C",661).
component("U2_",96).
component("YER178W",368).
component("YBR221C",201).
component("YIL125W",492).
component("U52_",111).
component("YBR166C",195).
component("YNL280C",709).
component("YGL012W",389).
component("U57_",115).
component("YKL216W",575).
component("YDR044W",270).
component("YER014W",339).
component("YKR009C",579).
component("YIL160C",496).
component("YGL205W",404).
component("YMR118C",658).
component("YLR164W",608).
component("YLL041C",588).
component("YKL148C",565).
component("YKL141W",563).
component("YJL045W",504).
component("YDR178W",290).
component("YJR051W",529).
component("YEL047C",333).
component("YDL215C",258).
component("YOR375C",785).
component("YDL215C",259).
component("YAL062W",150).
component("U99_",145).
component("YBR035C",176).
component("YMR189W",664).
component("YHR037W",463).
component("YKR080W",583).
component("YER023W",341).
component("YPL023C",791).
component("YGL125W",398).
component("YOR236W",770).
component("YGR204W",437).
component("YLR142W",603).
component("U62_",118).
component("YKL150W",566).
component("YIL043C",483).
component("YHR042W",464).
component("YOR221C",768).
component("YML120C",644).
component("YKL192C",572).
component("YKL055C",556).
component("YER061C",349).
component("YGR234W",440).
component("YFR030W",380).
component("YPL017C",790).
component("YFL018C",372).
component("YDR353W",311).
component("YER042W",343).
component("YJR137C",542).
component("YPL266W",815).
component("YML110C",643).
component("YBR034C",175).
component("YPL273W",817).
component("YLL062C",591).
component("YDR410C",319).
component("U47_",107).
component("YER091C",360).
component("YJR073C",532).
component("YDL033C",229).
component("YOL096C",740).
component("YLR172C",609).
component("YDR019C",266).
component("YBR176W",196).
component("YDR408C",318).
component("YMR120C",659).
component("YBL013W",154).
component("YKL024C",552).
component("YPR074C",832).
component("YBR117C",186).
component("YLR354C",626).
component("YGR043C",416).
component("YMR108W",656).
component("YCL009C",213).
component("YMR062C",652).
component("YNL071W",686).
component("YNR008W",716).
component("YNL277W",707).
component("YFL017C",371).
component("YPL231W",809).
component("YER061C",350).
component("U86_",135).
component("YPL001W",789).
component("YDR148C",287).
component("YOR377W",786).
component("YGR177C",431).
component("YPL231W",810).
component("YGR147C",426).
component("YDL040C",230).
component("YPL028W",792).
component("YGL017W",390).
component("YPR001W",822).
component("YNR001C",714).
component("YDL182W",255).
component("YDL131W",243).
component("YNL117W",690).
component("YIR031C",500).
component("YOR321W",775).
component("YJR143C",544).
component("YGR199W",436).
component("YDR307W",305).
component("YDL095W",238).
component("YDL093W",237).
component("YAL023C",147).
component("YNL029C",682).
component("YIL085C",487).
component("YMR261C",672).
component("YML100W",642).
component("YBR126C",189).
component("YNL192W",697).
component("YBR038W",178).
component("YBR023C",174).
component("YMR306W",680).
component("YLR342W",624).
component("YGR032W",414).
component("YLR209C",610).
component("U104_",21).
component("YOR209C",766).
component("YMR300C",677).
component("YER055C",345).
component("YDR354W",312) :- not remove_orf("YDR354W",312).
component("YFR047C",382).
component("YJR133W",541).
component("YLR209C",611).
component("YML022W",634).
component("YDR441C",322).
component("YDR399W",314).
component("YPR176C",840).
component("YPL172C",802).
component("YNR041C",722).
component("YMR101C",654).
component("YDL090C",236).
component("YBR003W",165).
component("YBR002C",164).
component("YJL167W",520).
component("YNL256W",701).
component("YDR127W",282).
component("YLR303W",618).
component("YGR012W",412).
component("YJR130C",540).
component("YLR303W",619).
component("YDR035W",268).
component("YBR249C",204).
component("YOL143C",746).
component("YBR256C",206).
component("YHR137W",474).
component("YGL202W",403).
component("YLR027C",592).
component("YKL106W",560).
component("YKL104C",559).
component("YGR019W",413).
component("YLR089C",598).
component("U64_",119).
component("U61_",117).
component("U51_",110).
component("YJR148W",545).
component("YOR184W",761).
component("YNR058W",725).
component("YIL116W",491).
component("YGL253W",409).
component("YFR053C",383).
component("YOL136C",745).
component("YIL107C",489).
component("YMR013C",649).
component("YMR205C",665).
component("YGR240C",441).
component("YDR248C",295).
component("YCR036W",223).
component("YGR194C",435).
component("YCL040W",217).
component("YJR105W",538).
component("U16_",51).
component("U15_",45).
component("U96_",143).
component("YKL001C",550).
component("YDR236C",293).
component("YML070W",640).
component("YFL053W",375).
component("YHL032C",453).
component("YLR133W",600).
component("YDR531W",329).
component("U83_",133).
component("U82_",132).
component("U81_",131).
component("YMR208W",666).
component("YHR025W",462).
component("YOR347C",781).
component("YAL038W",149).
component("YNR012W",717).
component("YPR121W",836).
component("YPL258C",812).
component("YOL055C",733).
component("YPL214C",806).
component("U1_",74).
component("YDR009W",265).
component("YBR020W",172).
component("YNL267W",705).
component("YLR305C",621).
component("YFR019W",378).
component("YDR208W",291).
component("YDR127W",283).
component("U21_",84).
component("U20_",81).
component("YDR147W",286).
component("YDR300C",304).
component("YCR012W",219).
component("U18_",66).
component("U17_",59).
component("U76_",128).
component("YMR220W",668).
component("YER170W",367).
component("YDR226W",292).
component("YKL067W",558).
component("YOL055C",734).
component("YDR454C",323).
component("YJR057W",530).
component("YOL061W",738).
component("YKL181W",568).
component("YHL011C",450).
component("YER099C",362).
component("YBL068W",162).
component("YOR143C",757).
component("YNL256W",702).
component("YLR328W",622).
component("YBR018C",168).
component("YBR018C",169).
component("YGR007W",411).
component("YLR328W",623).
component("YKR002W",577).
component("YDL103C",241).
component("YJR010W",526).
component("YGL130W",399).
component("YDR530C",328).
component("YCL050C",218).
component("YPR190C",842).
component("YPR187W",841).
component("YPR110C",834).
component("YPR010C",825).
component("YOR341W",780).
component("YOR340C",779).
component("YOR224C",769).
component("YOR210W",767).
component("YOR207C",764).
component("YOR151C",758).
component("YOR116C",752).
component("YOL005C",727).
component("YNR003C",715).
component("YNL248C",700).
component("YNL151C",694).
component("YNL113W",689).
component("YKL144C",564).
component("YJR063W",531).
component("YJL148W",516).
component("YJL140W",515).
component("YIL021W",482).
component("YHR143W-A",475).
component("YGL070C",396).
component("YFL036W",374).
component("YDR404C",317).
component("YDR156W",288).
component("YDR045C",271).
component("YDL150W",250).
component("YDL140C",245).
component("YBR154C",194).
component("YPR175W",839).
component("YPL167C",801).
component("YOR330C",777).
component("YOL115W",743).
component("YNL299W",711).
component("YNL262W",704).
component("YNL102W",688).
component("YJR043C",528).
component("YJR006W",525).
component("YJL090C",508).
component("YIL139C",493).
component("YEL055C",334).
component("YDR419W",320).
component("YDR121W",280).
component("YDL102W",240).
component("YCR014C",220).
component("YBR278W",208).
component("YBL035C",156).
component("YKL035W",555).
component("YHL012W",451).
component("YHR123W",473).
component("YPR113W",835).
component("YBR243C",202).
component("YDL142C",249).
component("YPL148C",799).
component("YER026C",342).
component("YCL004W",212).
component("YGR286C",449).
component("YJL068C",505).
component("YDR058C",275).
component("YNR034W",721).
component("YHR163W",477).
component("YGR248W",443).
component("YCR073W-A",224).
component("YDL086W",235).
component("YOL011W",729).
component("YMR008C",647).
component("YMR006C",646).
component("U101_",19).
component("YBL015W",155).
component("YJL068C",506).
component("YPL072W",795).
component("YOR124C",753).
component("YNL186W",696).
component("YMR304W",679).
component("YMR223W",669).
component("YKR098C",586).
component("YJL197W",521).
component("YIL156W",495).
component("YFR010W",377).
component("YER151C",365).
component("YER144C",364).
component("YER098W",361).
component("YDR069C",276).
component("YDL122W",242).
component("YBR058C",179).
component("YBL067C",161).
component("YDR272W",299).
component("U84_",134).
component("YLR377C",629).
component("YDR074W",277).
component("YPL179W",803).
component("YNR032W",719).
component("YML057W",639).
component("YML016C",633).
component("YLR433C",632).
component("YGR123C",424).
component("YER133W",363).
component("YER089C",358).
component("YDR436W",321).
component("YDR075W",278).
component("YDL188C",256).
component("YDL134C",244).
component("YDL047W",231).
component("YDL006W",225).
component("YBR125C",188).
component("YBL056W",160).
component("YPR073C",830).
component("YHR215W",479).
component("YDL024C",228).
component("YBR093C",184).
component("YBR092C",183).
component("YAR071W",151).
component("YIL053W",485).
component("YER062C",351).
component("YHR046C",465).
component("YGR208W",439).
component("YPL228W",807).
component("YMR180C",663).
component("YDL236W",261).
component("YJL155C",518).
component("YPR073C",831).
component("YOR208W",765).
component("YNL053W",685).
component("YMR036C",651).
component("YIR026C",497).
component("YIL113W",490).
component("YFR028C",379).
component("YER075C",355).
component("YDL230W",260).
component("YBR276C",207).
component("U34_",99).
component("U33_",98).
component("U30_",97).
component("U28_",95).
...
component("U25_",93).
component("U24_",92).
component("YPL268W",816).
component("YOR360C",783).
component("YGL248W",408).
component("YKR031C",580).
component("YPL206C",804).
component("YLR286C",616).
component("YJR153W",547).
component("YOR190W",762).
component("YLR300W",617).
component("YGR282C",448).
component("YDR261C",297).
component("YDR400W",315).
component("U23_",91).
component("YML035C",635).
component("YJL070C",507).
component("YBR284W",209).
component("U102_",20).
component("YNL045W",684).
component("YLR160C",607).
component("YLR158C",606).
component("YLR157C",605).
component("YLR155C",604).
component("YDR321W",306).
component("YGL037C",392).
component("YMR293C",676).
component("YDR242W",294).
component("YBR208C",198).
component("YMR281W",675).
component("U53_",112).
component("YIR027C",498).
component("YPL111W",798).
component("YIR032C",501).
component("YIR029W",499).
component("YPR062W",829).
component("YMR120C",660).
component("YLR028C",593).
component("YHR144C",476).
component("YGR267C",447).
component("YNL141W",691).
component("YBR153W",193).
component("YDL238C",262).
component("YNL141W",692).
component("YLR245C",614).
component("YML035C",636).
component("YJL126W",511).
component("U44_",105).
component("YDL100C",239).
component("U87_",136).
component("YMR267W",673).
component("YBR011C",167).
component("YBR111C",185).
component("YBR252W",205).
component("YCL030C",216).
component("YER005W",338).
component("YIL048W",484).
component("YER166W",366).
component("YDR093W",279).
component("YAL026C",148).
component("YLR231C",612).
component("U88_",137).
component("YLR134W",601).
component("YLR044C",594).
component("YGR087C",420).
component("YDR380W",313).
component("YDL080C",234).
component("U98_",144).
component("YMR250W",671).
component("YKL184W",571).
component("YNR043W",723).
component("U93_",142).
component("YDR047W",273).
component("U54_",113).
component("YKL211C",573) :- not remove_orf("YKL211C",573).
component("YKR097W",585).
component("YOL052C",732).
component("YNL169C",695).
component("YGR170W",428).
component("YKL060C",557).
component("YNL256W",703).
component("YDR294C",301).
component("YEL046C",332).
component("YNR033W",720).
component("YPR006C",824).
component("YER065C",352).
component("YKL211C",574) :- not remove_orf("YKL211C",574).
component("YER090W",574) :- not remove_orf("YER090W",574).
component("YER090W",359) :- not remove_orf("YER090W",359).
component("YDR127W",284).
component("YPL281C",821).
component("YOR393W",788).
component("YMR323W",681).
component("YHR174W",478).
component("YGR254W",444).
component("YPL262W",813).
component("YGL026C",391) :- not remove_orf("YGL026C",391).
component("YGR155W",427).
component("YLR304C",620).
component("YJL200C",522).
component("YNL316C",712).
component("YKL182W",569).
component("YPL212C",805).
component("YNL292W",710).
component("YGL063W",395).
component("YFL001W",369).
component("YOR278W",772).
component("YPR002W",823).
component("YDR127W",285).
component("YGL148W",400).
component("YER086W",356).
component("YLR359W",628).
component("YAL012W",146).
component("YFR055W",384).
component("YOR176W",760).
component("YJL121C",510).
component("YBR019C",170).
component("YBR019C",171).
component("YDR050C",274).
component("YDR007W",264) :- not remove_orf("YDR007W",264).
component("YOR095C",751).
component("YER003C",337).
component("YBR196C",197).
component("YGL001C",386).
component("U14_",38).
component("YOL056W",735).
component("YKL152C",567).
component("YDL021W",226).
component("YMR105C",655).
component("YKL127W",561).
component("YEL058W",335).
component("YPR060C",828).
component("YHR072W",467).
component("YJL153C",517).
component("YPL097W",796).
component("YGR185C",434).
component("YGR264C",446).
component("YGR171C",429).
component("YHR011W",458).
component("YDR023W",267).
component("YPL104W",797).
component("YLL018C",587).
component("YPR081C",833).
component("YBR121C",187).
component("YHR020W",461).
component("YER087W",357).
component("YNL247W",699).
component("YOL033W",731).
component("YGL245W",407).
component("YHR091C",469).
component("YDR341C",307).
component("YOL097C",741).
component("YDR268W",298).
component("YPR047W",827).
component("YLR060W",596).
component("YFL022C",373).
component("YPR033C",826).
component("YHR019C",459).
component("YHR019C",460).
component("YPL160W",800).
component("YLR382C",630).
component("YNL073W",687).
component("YDR037W",269).
component("YOR335C",778).
component("YGR094W",422).
component("YOR317W",774).
component("YMR246W",670).
component("YIL009W",481).
component("YER015W",340).
component("YOR142W",756).
component("YGR244C",442).
component("U89_",138).
component("YOR241W",771).
component("YMR113W",657).
component("YKL132C",562).
component("YJL101C",509).
component("U92_",141).
component("YGL234W",405).
component("U91_",140).
component("U90_",139).
component("YDL141W",246).
component("YDL141W",247).
component("YGL234W",406).
component("YDL141W",248).
component("YJR103W",536).
component("YBL039C",157).
component("YGR204W",438).
component("YBR084W",182).
component("YOL058W",736).
component("YBR208C",199).
component("YHR074W",468).
component("YMR217W",667).
component("YGR061C",419).
component("YPR145W",838).
component("YGR124W",425).
component("YOR303W",773).
component("YJR109C",539).
component("YJL130C",513).
component("YGL062W",394).
component("YBR218C",200).
component("YPL231W",811).
component("YNR016C",718).
component("YKL182W",570).
component("YGR037C",415).
component("YOR005C",748).
component("YDL164C",251).
component("YOL010W",728).
component("YPR138C",837).
component("YPL274W",818).
component("YPL265W",814).
component("YPL057C",794).
component("YPL036W",793).
component("YOR348C",782).
component("YOR192C",763).
component("YOR171C",759).
component("YOR130C",754).
component("YOR071C",750).
component("YOL156W",747).
component("YOL103W",742).
component("YOL020W",730) :- not remove_orf("YOL020W",730).
component("YNR072W",726).
component("YNR056C",724).
component("YNL318C",713).
component("YNL268W",706).
component("YNL142W",693).
component("YMR272C",674).
component("YMR011W",648).
component("YML123C",645).
component("YLR348C",625).
component("YLR260W",615).
component("YLR237W",613).
component("YLR138W",602).
component("YLR100C",599).
component("YLR081W",597).
component("YLL061W",590).
component("YLL043W",589).
component("YKR093W",584).
component("YKR053C",582).
component("YKR039W",581) :- not remove_orf("YKR039W",581).
component("YKL217W",576).
component("YKL004W",551).
component("YJR158W",548).
component("YJR152W",546).
component("YJR095W",535).
component("YJR077C",533).
component("YJL219W",524).
component("YJL214W",523).
component("YJL134W",514).
component("YJL129C",512).
component("YHR096C",472).
component("YHR094C",471).
component("YHR092C",470).
component("YHL036W",454).
component("YHL016C",452).
component("YGR121C",423).
component("YGR055W",417).
component("YGL186C",402).
component("YGL077C",397).
component("YGL008C",387).
component("YFL055W",376).
component("YFL011W",370).
component("YER060W-A",348).
component("YER060W",347).
component("YER056C",346).
component("YER053C",344).
component("YEL069C",336).
component("YEL017C-A",331).
component("YDR536W",330).
component("YDR508C",326).
component("YDR503C",325).
component("YDR497C",324).
component("YDR345C",310).
component("YDR343C",309).
component("YDR342C",308).
component("YDR297W",303).
component("YDR294C",302).
component("YDR284C",300).
component("YDR046C",272) :- not remove_orf("YDR046C",272).
component("YDL245C",263).
component("YDL210W",257).
component("YCR032W",222).
component("YCR024C-A",221).
component("YCL025C",214).
component("YBR298C",211).
component("YBR291C",210).
component("YBR069C",181) :- not remove_orf("YBR069C",181).
component("YBR068C",180) :- not remove_orf("YBR068C",180).
component("YBR036C",177).
component("YBR021W",173).
component("YBL042C",158).
component("U79_",130).
component("U78_",129).
component("U75_",127).
component("U74_",126).
...
catalyst(6160,677).
catalyst(3870,345).
catalyst(3620,312) :- not remove_reaction(3620,312).
catalyst(2110,382).
catalyst(2190,382).
catalyst(5550,541).
catalyst(5791,611).
...
catalyst(1960,273).
catalyst(3460,113).
catalyst(3600,573) :- not remove_reaction(3600,573).
catalyst(8000,585).
catalyst(3941,732).
catalyst(3942,732).
catalyst(6890,695).
...
catalyst(8020,824).
catalyst(8020,352).
catalyst(1890,574) :- not remove_reaction(1890,574).
catalyst(3630,574) :- not remove_reaction(3630,574).
catalyst(1890,359) :- not remove_reaction(1890,359).
catalyst(3630,359) :- not remove_reaction(3630,359).
catalyst(3740,284).
catalyst(8231,821).
catalyst(8232,821).
catalyst(8231,788).
...
catalyst(8051,813).
catalyst(8052,813).
catalyst(3590,391) :- not remove_reaction(3590,391).
catalyst(10910,391) :- not remove_reaction(10910,391).
catalyst(4570,427).
catalyst(8181,620).
catalyst(8182,620).
catalyst(8181,522).
...
catalyst(8281,274).
catalyst(8282,274).
catalyst(3610,264) :- not remove_reaction(3610,264).
catalyst(7921,751).
catalyst(7922,751).
catalyst(7841,337).
catalyst(7842,337).
...
catalyst(1210,747).
catalyst(1160,742).
catalyst(801,730) :- not remove_reaction(801,730).
catalyst(802,730) :- not remove_reaction(802,730).
catalyst(811,730) :- not remove_reaction(811,730).
catalyst(812,730) :- not remove_reaction(812,730).
catalyst(831,730) :- not remove_reaction(831,730).
catalyst(832,730) :- not remove_reaction(832,730).
catalyst(901,730) :- not remove_reaction(901,730).
catalyst(902,730) :- not remove_reaction(902,730).
catalyst(941,730) :- not remove_reaction(941,730).
catalyst(942,730) :- not remove_reaction(942,730).
catalyst(1210,726).
catalyst(700,724).
catalyst(1200,713).
catalyst(761,706).
...
catalyst(640,584).
catalyst(6560,582).
catalyst(761,581) :- not remove_reaction(761,581).
catalyst(762,581) :- not remove_reaction(762,581).
catalyst(771,581) :- not remove_reaction(771,581).
catalyst(772,581) :- not remove_reaction(772,581).
catalyst(781,581) :- not remove_reaction(781,581).
catalyst(782,581) :- not remove_reaction(782,581).
catalyst(791,581) :- not remove_reaction(791,581).
catalyst(792,581) :- not remove_reaction(792,581).
catalyst(801,581) :- not remove_reaction(801,581).
catalyst(802,581) :- not remove_reaction(802,581).
catalyst(811,581) :- not remove_reaction(811,581).
catalyst(812,581) :- not remove_reaction(812,581).
catalyst(821,581) :- not remove_reaction(821,581).
catalyst(822,581) :- not remove_reaction(822,581).
catalyst(831,581) :- not remove_reaction(831,581).
catalyst(832,581) :- not remove_reaction(832,581).
catalyst(841,581) :- not remove_reaction(841,581).
catalyst(842,581) :- not remove_reaction(842,581).
catalyst(861,581) :- not remove_reaction(861,581).
catalyst(862,581) :- not remove_reaction(862,581).
catalyst(881,581) :- not remove_reaction(881,581).
catalyst(882,581) :- not remove_reaction(882,581).
catalyst(901,581) :- not remove_reaction(901,581).
catalyst(902,581) :- not remove_reaction(902,581).
catalyst(911,581) :- not remove_reaction(911,581).
catalyst(912,581) :- not remove_reaction(912,581).
catalyst(941,581) :- not remove_reaction(941,581).
catalyst(942,581) :- not remove_reaction(942,581).
catalyst(1191,581) :- not remove_reaction(1191,581).
catalyst(1192,581) :- not remove_reaction(1192,581).
catalyst(1021,576).
catalyst(1022,576).
catalyst(6610,551).
catalyst(1210,548).
...
catalyst(6550,302).
catalyst(6690,300).
catalyst(791,272) :- not remove_reaction(791,272).
catalyst(792,272) :- not remove_reaction(792,272).
catalyst(801,272) :- not remove_reaction(801,272).
catalyst(802,272) :- not remove_reaction(802,272).
catalyst(811,272) :- not remove_reaction(811,272).
catalyst(812,272) :- not remove_reaction(812,272).
catalyst(831,272) :- not remove_reaction(831,272).
catalyst(832,272) :- not remove_reaction(832,272).
catalyst(841,272) :- not remove_reaction(841,272).
catalyst(842,272) :- not remove_reaction(842,272).
catalyst(861,272) :- not remove_reaction(861,272).
catalyst(862,272) :- not remove_reaction(862,272).
catalyst(901,272) :- not remove_reaction(901,272).
catalyst(902,272) :- not remove_reaction(902,272).
catalyst(1210,263).
catalyst(690,257).
catalyst(730,257).
catalyst(431,222).
...
catalyst(1511,210).
catalyst(1512,210).
catalyst(771,181) :- not remove_reaction(771,181).
catalyst(772,181) :- not remove_reaction(772,181).
catalyst(791,181) :- not remove_reaction(791,181).
catalyst(792,181) :- not remove_reaction(792,181).
catalyst(801,181) :- not remove_reaction(801,181).
catalyst(802,181) :- not remove_reaction(802,181).
catalyst(811,181) :- not remove_reaction(811,181).
catalyst(812,181) :- not remove_reaction(812,181).
catalyst(861,181) :- not remove_reaction(861,181).
catalyst(862,181) :- not remove_reaction(862,181).
catalyst(901,181) :- not remove_reaction(901,181).
catalyst(902,181) :- not remove_reaction(902,181).
...
catalyst(831,180) :- not remove_reaction(831,180).
catalyst(832,180) :- not remove_reaction(832,180).
catalyst(841,180) :- not remove_reaction(841,180).
catalyst(842,180) :- not remove_reaction(842,180).
...
modifiable_enzyme(312).
modifiable_enzyme(573).
modifiable_enzyme(574).
modifiable_enzyme(359).
modifiable_enzyme(391).
modifiable_enzyme(264).
modifiable_enzyme(730).
modifiable_enzyme(581).
