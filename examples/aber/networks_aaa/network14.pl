...
component("YGL012W",91).
component("YGL001C",90).
component("YML056C",139).
component("YLR432W",137).
component("YHR216W",105).
component("YAR075W",37).
component("YAR073W",36).
component("YDR127W",66).
component("YJR139C",121).
component("YOR136W",159).
component("YIL155C",107).
component("YJR078W",117).
component("YJR025C",114).
component("YMR015C",140).
component("YGL154C",95).
component("YMR170C",142).
component("YMR169C",141).
component("YBR166C",49).
component("YER014W",82).
component("YEL047C",81).
component("YOR375C",168).
component("YAL062W",35).
component("U62_",31).
component("YPR074C",177).
component("YBR117C",47).
component("YPL231W",171).
component("YLR209C",132).
component("YDR354W",75) :- not remove_orf("YDR354W",75).
component("YFR047C",88).
component("YJR133W",120).
component("YDR127W",67).
component("YJR130C",119).
component("YDR035W",62).
component("YBR249C",50).
component("YBR256C",51).
component("YHR137W",101).
component("YLR027C",131).
component("YKL106W",123).
component("YGL253W",96).
component("YFR053C",89).
component("YCR036W",55).
component("U15_",19).
component("YKL001C",122).
component("U83_",33).
component("U1_",23).
component("YNL267W",150).
component("YLR305C",136).
component("YFR019W",87).
component("YDR208W",72).
component("YDR127W",68).
component("U20_",26).
component("YDR300C",74).
component("U76_",32).
component("YDR454C",77).
component("YOL061W",155).
component("YKL181W",125).
component("YHL011C",100).
component("YER099C",84).
component("YBL068W",40).
component("YOR143C",160).
component("YPR190C",181).
component("YPR187W",180).
component("YPR110C",178).
component("YPR010C",174).
component("YOR341W",167).
component("YOR340C",166).
component("YOR224C",164).
component("YOR210W",163).
component("YOR207C",162).
component("YOR151C",161).
component("YOR116C",158).
component("YOL005C",153).
component("YNR003C",152).
component("YNL248C",149).
component("YNL151C",148).
component("YNL113W",146).
component("YKL144C",124).
component("YJR063W",115).
component("YJL148W",112).
component("YJL140W",111).
component("YIL021W",106).
component("YHR143W-A",102).
component("YGL070C",93).
component("YFL036W",85).
component("YDR404C",76).
component("YDR156W",71).
component("YDR045C",63).
component("YDL150W",58).
component("YDL140C",57).
component("YBR154C",48).
component("YDR058C",65).
component("YBL015W",38).
component("U84_",34).
component("YPR073C",176).
component("YHR215W",104).
component("YDL024C",56).
component("YBR093C",45).
component("YBR092C",44).
component("YPL228W",170).
component("YMR180C",143).
component("YDL236W",59).
component("YJL155C",113).
component("U30_",28).
component("YLR286C",135).
component("YML035C",138).
component("YJL070C",108).
component("YBR284W",52).
component("YNL045W",145).
component("U53_",29).
component("YDL238C",60).
component("YLR245C",134).
component("YJL126W",109).
component("YBR111C",46).
component("YLR231C",133).
component("U54_",30).
component("YKL211C",127) :- not remove_orf("YKL211C",127).
component("YDR294C",73).
component("YKL211C",128) :- not remove_orf("YKL211C",128).
component("YER090W",128) :- not remove_orf("YER090W",128).
component("YER090W",83) :- not remove_orf("YER090W",83).
component("YDR127W",69).
component("YPL281C",173).
component("YOR393W",169).
component("YMR323W",144).
component("YHR174W",103).
component("YGR254W",99).
component("YGL026C",92) :- not remove_orf("YGL026C",92).
component("YNL316C",151).
component("YKL182W",126).
component("YDR127W",70).
component("YGL148W",94).
component("YDR007W",61) :- not remove_orf("YDR007W",61).
component("YOR095C",157).
component("YPR060C",175).
component("YOL097C",156).
component("YOR335C",165).
component("YGR094W",97).
component("YJR103W",118).
component("YBL039C",39).
component("YPR138C",179).
component("YPL265W",172).
component("YOL020W",154) :- not remove_orf("YOL020W",154).
component("YNL142W",147).
component("YKR053C",130).
component("YKR039W",129) :- not remove_orf("YKR039W",129).
component("YJR077C",116).
component("YJL134W",110).
component("YGR121C",98).
component("YFL055W",86).
component("YDR536W",80).
component("YDR508C",79).
component("YDR503C",78).
component("YDR046C",64) :- not remove_orf("YDR046C",64).
component("YCL025C",54).
component("YBR291C",53).
component("YBR069C",43) :- not remove_orf("YBR069C",43).
component("YBR068C",42) :- not remove_orf("YBR068C",42).
component("YBR021W",41).
component("U228_",27).
component("U206_",25).
component("U202_",24).
component("U196_",22).
...
catalyst(3500,133).
catalyst(3460,30).
catalyst(3600,127) :- not remove_reaction(3600,127).
catalyst(8781,73).
catalyst(8782,73).
catalyst(3630,128) :- not remove_reaction(3630,128).
catalyst(3630,83) :- not remove_reaction(3630,83).
catalyst(3740,69).
catalyst(8231,173).
catalyst(8232,173).
catalyst(8231,169).
...
catalyst(8231,99).
catalyst(8232,99).
catalyst(3590,92) :- not remove_reaction(3590,92).
catalyst(10910,92) :- not remove_reaction(10910,92).
catalyst(3680,151).
catalyst(7141,126).
catalyst(7142,126).
catalyst(3750,70).
...
catalyst(801,42) :- not remove_reaction(801,42).
catalyst(802,42) :- not remove_reaction(802,42).
catalyst(811,42) :- not remove_reaction(811,42).
catalyst(812,42) :- not remove_reaction(812,42).
catalyst(831,42) :- not remove_reaction(831,42).
catalyst(832,42) :- not remove_reaction(832,42).
catalyst(620,41).
catalyst(41,27).
catalyst(42,27).
catalyst(331,25).
