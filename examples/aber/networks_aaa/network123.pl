...
component("YLR056W",562).
component("YGR060W",398).
component("YGL012W",371).
component("YKR009C",546).
component("YOL086C",698).
component("YMR303C",640).
component("YMR083W",618).
component("YGL256W",390).
component("YDL168W",244).
component("YBR145W",185).
component("YPL231W",760).
component("U46_",104).
component("YBR149W",186).
component("YJR159W",517).
component("YGL001C",368).
component("YIL094C",459).
component("YHR063C",441).
component("YBR153W",187).
component("YML056C",604).
component("YLR432W",597).
component("YHR216W",452).
component("YAR075W",150).
component("YAR073W",149).
component("YDR127W",272).
component("YJR139C",512).
component("YOL126C",703).
component("YDL078C",226).
component("YKL029C",522).
component("YOR136W",713).
component("YNL037C",645).
component("YDL066W",225).
component("YNL241C",660).
component("YOL059W",696).
component("YDL022W",220).
component("YLR355C",594).
component("YML054C",603).
component("YDL174C",246).
component("YML086C",607).
component("YIL155C",465).
component("YPR191W",791).
component("YOR065W",708).
component("YJL166W",490).
component("YHR001W-A",431).
component("YGR183C",412).
component("YFR033C",364).
component("YDR529C",313).
component("YBL045C",156).
component("Q0105",18).
component("YGR088W",401).
component("YDR256C",287).
component("YKL026C",521).
component("YIR037W",473).
component("YBR244W",197).
component("YJR078W",503).
component("YJR025C",497).
component("YGR255C",424).
component("U108_",22).
component("YBL098W",160).
component("YMR015C",615).
component("YHR007C",432).
component("YDR402C",302).
component("YGL055W",376).
component("YGR175C",409).
component("YJR104C",506).
component("YHR008C",433).
component("YJL026W",474).
component("YIL066C",457).
component("YGR180C",411).
component("YER070W",336).
component("U38_",100).
component("U35_",99).
component("YDL168W",245).
component("YDR158W",280).
component("YBR006W",161).
component("YPL276W",771).
component("YPL275W",770).
component("YOR388C",743).
component("YOR374W",740).
component("YER073W",337).
component("U68_",118).
component("YGL154C",383).
component("U55_",112).
component("YOR323C",732).
component("YMR170C",626).
component("YMR169C",625).
component("U2_",95).
component("YER178W",351).
component("YBR221C",195).
component("YIL125W",463).
component("U52_",109).
component("YBR166C",190).
component("YNL280C",671).
component("YGL012W",372).
component("U57_",113).
component("YKL216W",543).
component("YDR044W",261).
component("YER014W",324).
component("YKR009C",547).
component("YIL160C",467).
component("YGL205W",386).
component("YMR118C",622).
component("YLR164W",575).
component("YLL041C",555).
component("YKL148C",533).
component("YKL141W",531).
component("YJL045W",475).
component("YDR178W",281).
component("YJR051W",499).
component("YEL047C",319).
component("YDL215C",250).
component("YOR375C",741).
component("YDL215C",251).
component("YAL062W",147).
component("U99_",142).
component("YBR035C",171).
component("YHR037W",438).
component("YKR080W",551).
component("YER023W",325).
component("YOR236W",727).
component("YGR204W",416).
component("YLR142W",570).
component("U62_",116).
component("YKL150W",534).
component("YIL043C",454).
component("YHR042W",439).
component("YOR221C",725).
component("YML120C",610).
component("YKL192C",540).
component("YKL055C",524).
component("YER061C",333).
component("YGR234W",419).
component("YFR030W",363).
component("YPL017C",746).
component("YFL018C",355).
component("YER042W",327).
component("YJR137C",511).
component("YPL266W",767).
component("YML110C",609).
component("YBR034C",170).
component("YPL273W",768).
component("YLL062C",558).
component("YDR410C",305).
component("U47_",105).
component("YER091C",343).
component("YJR073C",501).
component("YDL033C",222).
component("YOL096C",699).
component("YLR172C",576).
component("YDR019C",257).
component("YDR408C",304).
component("YMR120C",623).
component("YBL013W",151).
component("YKL024C",520).
component("YPR074C",782).
component("YBR117C",181).
component("YLR354C",593).
component("YGR043C",396).
component("YMR108W",620).
component("YCL009C",207).
component("YMR062C",617).
component("YNL071W",648).
component("YNR008W",678).
component("YNL277W",669).
component("YFL017C",354).
component("YPL231W",761).
component("YER061C",334).
component("U86_",132).
component("YPL001W",745).
component("YDR148C",278).
component("YOR377W",742).
component("YGR177C",410).
component("YPL231W",762).
component("YGR147C",406).
component("YDL040C",223).
component("YPL028W",747).
component("YGL017W",373).
component("YPR001W",773).
component("YNR001C",676).
component("YDL182W",247).
component("YDL131W",235).
component("YNL117W",652).
component("YIR031C",471).
component("YOR321W",731).
component("YJR143C",513).
component("YGR199W",415).
component("YDR307W",295).
component("YDL095W",230).
component("YDL093W",229).
component("YAL023C",144).
component("YNL029C",644).
component("YIL085C",458).
component("YMR261C",634).
component("YML100W",608).
component("YBR126C",184).
component("YNL192W",659).
component("YBR038W",173).
component("YBR023C",169).
component("YMR306W",642).
component("YLR342W",591).
component("YGR032W",394).
component("YLR209C",577).
component("U104_",21).
component("YOR209C",723).
component("YMR300C",639).
component("YER055C",329).
component("YDR354W",298) :- not remove_orf("YDR354W",298).
component("YFR047C",365).
component("YJR133W",510).
component("YLR209C",578).
component("YML022W",600).
component("YDR441C",308).
component("YDR399W",300).
component("YJL167W",491).
component("YNL256W",663).
component("YDR127W",273).
component("YLR303W",585).
component("YGR012W",392).
component("YJR130C",509).
component("YLR303W",586).
component("YDR035W",259).
component("YBR249C",198).
component("YOL143C",705).
component("YBR256C",200).
component("YHR137W",446).
component("YGL202W",385).
component("YLR027C",559).
component("YKL106W",528).
component("YKL104C",527).
component("YGR019W",393).
component("YLR089C",565).
component("U64_",117).
component("U61_",115).
component("U51_",108).
component("YJR148W",514).
component("YOR184W",718).
component("YNR058W",686).
component("YIL116W",462).
component("YGL253W",389).
component("YFR053C",366).
component("YOL136C",704).
component("YIL107C",460).
component("YMR013C",614).
component("YMR205C",628).
component("YGR240C",420).
component("YDR248C",286).
component("YCR036W",216).
component("YGR194C",414).
component("YCL040W",210).
component("YJR105W",507).
component("U16_",50).
component("U15_",44).
component("U96_",140).
component("YKL001C",518).
component("YDR236C",284).
component("YML070W",606).
component("YFL053W",358).
component("YHL032C",429).
component("YLR133W",567).
component("YDR531W",315).
component("U83_",130).
component("U82_",129).
component("U81_",128).
component("YMR208W",629).
component("YHR025W",437).
component("YOR347C",737).
component("YAL038W",146).
component("YNR012W",679).
component("YPR121W",785).
component("YPL258C",764).
component("YOL055C",693).
component("U1_",73).
component("YDR009W",256).
component("YBR020W",167).
component("YNL267W",667).
component("YLR305C",588).
component("YFR019W",361).
component("YDR208W",282).
component("YDR127W",274).
component("U21_",83).
component("U20_",80).
component("YDR147W",277).
component("YDR300C",294).
component("YCR012W",212).
component("U18_",65).
component("U17_",58).
component("U76_",126).
component("YMR220W",631).
component("YER170W",350).
component("YDR226W",283).
component("YKL067W",526).
component("YDR454C",309).
component("YOL061W",697).
component("YKL181W",536).
component("YHL011C",427).
component("YER099C",345).
component("YBL068W",159).
component("YOR143C",715).
component("YNL256W",664).
component("YLR328W",589).
component("YBR018C",163).
component("YBR018C",164).
component("YGR007W",391).
component("YLR328W",590).
component("YKR002W",545).
component("YDL103C",233).
component("YJR010W",496).
component("YGL130W",381).
component("YDR530C",314).
component("YCL050C",211).
component("YPR190C",790).
component("YPR187W",789).
component("YPR110C",784).
component("YPR010C",775).
component("YOR341W",736).
component("YOR340C",735).
component("YOR224C",726).
component("YOR210W",724).
component("YOR207C",721).
component("YOR151C",716).
component("YOR116C",711).
component("YOL005C",687).
component("YNR003C",677).
component("YNL248C",662).
component("YNL151C",656).
component("YNL113W",651).
component("YKL144C",532).
component("YJR063W",500).
component("YJL148W",487).
component("YJL140W",486).
component("YIL021W",453).
component("YHR143W-A",447).
component("YGL070C",379).
component("YFL036W",357).
component("YDR404C",303).
component("YDR156W",279).
component("YDR045C",262).
component("YDL150W",242).
component("YDL140C",237).
component("YBR154C",189).
component("YPR175W",788).
component("YPL167C",755).
component("YOR330C",733).
component("YOL115W",702).
component("YNL299W",673).
component("YNL262W",666).
component("YNL102W",650).
component("YJR043C",498).
component("YJR006W",495).
component("YJL090C",479).
component("YIL139C",464).
component("YEL055C",320).
component("YDR419W",306).
component("YDR121W",271).
component("YDL102W",232).
component("YCR014C",213).
component("YBR278W",202).
component("YBL035C",153).
component("YKL035W",523).
component("YHL012W",428).
component("YHR123W",445).
component("YBR243C",196).
component("YDL142C",241).
component("YER026C",326).
component("YCL004W",206).
component("YJL068C",476).
component("YDR058C",266).
component("YNR034W",683).
component("YHR163W",449).
component("YGR248W",422).
component("YCR073W-A",217).
component("YDL086W",228).
component("YOL011W",689).
component("YMR008C",613).
component("YMR006C",612).
component("U101_",19).
component("YBL015W",152).
component("YJL068C",477).
component("YPL072W",750).
component("YOR124C",712).
component("YNL186W",658).
component("YMR304W",641).
component("YMR223W",632).
component("YKR098C",553).
component("YJL197W",492).
component("YIL156W",466).
component("YFR010W",360).
component("YER151C",348).
component("YER144C",347).
component("YER098W",344).
component("YDR069C",267).
component("YDL122W",234).
component("YBR058C",174).
component("YBL067C",158).
component("YDR272W",290).
component("U84_",131).
component("YDR074W",268).
component("YPL179W",756).
component("YNR032W",681).
component("YML057W",605).
component("YML016C",599).
component("YLR433C",598).
component("YGR123C",404).
component("YER133W",346).
component("YER089C",341).
component("YDR436W",307).
component("YDR075W",269).
component("YDL188C",248).
component("YDL134C",236).
component("YDL047W",224).
component("YDL006W",218).
component("YBR125C",183).
component("YBL056W",157).
component("YPR073C",780).
component("YHR215W",451).
component("YDL024C",221).
component("YBR093C",179).
component("YBR092C",178).
component("YAR071W",148).
component("YIL053W",456).
component("YER062C",335).
component("YHR046C",440).
component("YGR208W",418).
component("YPL228W",759).
component("YMR180C",627).
component("YDL236W",253).
component("YJL155C",489).
component("YPR073C",781).
component("YOR208W",722).
component("YNL053W",647).
component("YMR036C",616).
component("YIR026C",468).
component("YIL113W",461).
component("YFR028C",362).
component("YER075C",338).
component("YDL230W",252).
component("YBR276C",201).
component("U34_",98).
component("U33_",97).
component("U30_",96).
component("U28_",94).
...
component("U25_",92).
component("U24_",91).
component("YOR360C",739).
component("YGL248W",388).
component("YKR031C",548).
component("YPL206C",757).
component("YLR286C",583).
component("YJR153W",516).
component("YOR190W",719).
component("YLR300W",584).
component("YGR282C",426).
component("YDR261C",288).
component("YDR400W",301).
component("U23_",90).
component("YML035C",601).
component("YJL070C",478).
component("YBR284W",203).
component("U102_",20).
component("YNL045W",646).
component("YLR160C",574).
component("YLR158C",573).
component("YLR157C",572).
component("YLR155C",571).
component("YDR321W",296).
component("YGL037C",375).
component("YMR293C",638).
component("YDR242W",285).
component("YBR208C",192).
component("YMR281W",637).
component("U53_",110).
component("YIR027C",469).
component("YPL111W",753).
component("YIR032C",472).
component("YIR029W",470).
component("YPR062W",779).
component("YMR120C",624).
component("YLR028C",560).
component("YHR144C",448).
component("YGR267C",425).
component("YNL141W",653).
component("YBR153W",188).
component("YDL238C",254).
component("YNL141W",654).
component("YLR245C",581).
component("YML035C",602).
component("YJL126W",482).
component("U44_",103).
component("YDL100C",231).
component("U87_",133).
component("YMR267W",635).
component("YBR011C",162).
component("YBR111C",180).
component("YBR252W",199).
component("YCL030C",209).
component("YER005W",323).
component("YIL048W",455).
component("YER166W",349).
component("YDR093W",270).
component("YAL026C",145).
component("YLR231C",579).
component("U88_",134).
component("YLR134W",568).
component("YLR044C",561).
component("YGR087C",400).
component("YDR380W",299).
component("YDL080C",227).
component("U98_",141).
component("YMR250W",633).
component("YKL184W",539).
component("YNR043W",684).
component("U93_",139).
component("YDR047W",264).
component("U54_",111).
component("YKL211C",541) :- not remove_orf("YKL211C",541).
component("YOL052C",692).
component("YNL169C",657).
component("YGR170W",408).
component("YKL060C",525).
component("YNL256W",665).
component("YDR294C",291).
component("YEL046C",318).
component("YNR033W",682).
component("YKL211C",542) :- not remove_orf("YKL211C",542).
component("YER090W",542) :- not remove_orf("YER090W",542).
component("YER090W",342) :- not remove_orf("YER090W",342).
component("YDR127W",275).
component("YPL281C",772).
component("YOR393W",744).
component("YMR323W",643).
component("YHR174W",450).
component("YGR254W",423).
component("YPL262W",765).
component("YGL026C",374) :- not remove_orf("YGL026C",374).
component("YGR155W",407).
component("YLR304C",587).
component("YJL200C",493).
component("YNL316C",674).
component("YKL182W",537).
component("YPL212C",758).
component("YNL292W",672).
component("YGL063W",378).
component("YFL001W",352).
component("YOR278W",729).
component("YPR002W",774).
component("YDR127W",276).
component("YGL148W",382).
component("YER086W",339).
component("YLR359W",595).
component("YAL012W",143).
component("YFR055W",367).
component("YJL121C",481).
component("YBR019C",165).
component("YBR019C",166).
component("YDR050C",265).
component("YDR007W",255) :- not remove_orf("YDR007W",255).
component("YOR095C",710).
component("YER003C",322).
component("YBR196C",191).
component("YGL001C",369).
component("U14_",37).
component("YOL056W",694).
component("YKL152C",535).
component("YDL021W",219).
component("YMR105C",619).
component("YKL127W",529).
component("YEL058W",321).
component("YPR060C",778).
component("YHR072W",442).
component("YJL153C",488).
component("YPL097W",751).
component("YGR185C",413).
component("YHR011W",434).
component("YDR023W",258).
component("YPL104W",752).
component("YLL018C",554).
component("YPR081C",783).
component("YBR121C",182).
component("YHR020W",436).
component("YER087W",340).
component("YNL247W",661).
component("YOL033W",691).
component("YHR091C",444).
component("YDR341C",297).
component("YOL097C",700).
component("YDR268W",289).
component("YPR047W",777).
component("YLR060W",563).
component("YFL022C",356).
component("YPR033C",776).
component("YHR019C",435).
component("YPL160W",754).
component("YLR382C",596).
component("YNL073W",649).
component("YDR037W",260).
component("YOR335C",734).
component("YGR094W",402).
component("YOR142W",714).
component("YGR244C",421).
component("U89_",135).
component("YOR241W",728).
component("YMR113W",621).
component("YKL132C",530).
component("YJL101C",480).
component("U92_",138).
component("YGL234W",387).
component("U91_",137).
component("U90_",136).
component("YDL141W",238).
component("YDL141W",239).
component("YDL141W",240).
component("YJR103W",505).
component("YBL039C",154).
component("YGR204W",417).
component("YBR084W",177).
component("YOL058W",695).
component("YBR208C",193).
component("YHR074W",443).
component("YMR217W",630).
component("YGR061C",399).
component("YPR145W",787).
component("YGR124W",405).
component("YOR303W",730).
component("YJR109C",508).
component("YJL130C",484).
component("YGL062W",377).
component("YBR218C",194).
component("YPL231W",763).
component("YNR016C",680).
component("YKL182W",538).
component("YGR037C",395).
component("YOR005C",707).
component("YDL164C",243).
component("YOL010W",688).
component("YPR138C",786).
component("YPL274W",769).
component("YPL265W",766).
component("YPL057C",749).
component("YPL036W",748).
component("YOR348C",738).
component("YOR192C",720).
component("YOR171C",717).
component("YOR071C",709).
component("YOL156W",706).
component("YOL103W",701).
component("YOL020W",690) :- not remove_orf("YOL020W",690).
component("YNR056C",685).
component("YNL318C",675).
component("YNL268W",668).
component("YNL142W",655).
component("YMR272C",636).
component("YML123C",611).
component("YLR348C",592).
component("YLR260W",582).
component("YLR237W",580).
component("YLR138W",569).
component("YLR100C",566).
component("YLR081W",564).
component("YLL061W",557).
component("YLL043W",556).
component("YKR093W",552).
component("YKR053C",550).
component("YKR039W",549) :- not remove_orf("YKR039W",549).
component("YKL217W",544).
component("YKL004W",519).
component("YJR152W",515).
component("YJR095W",504).
component("YJR077C",502).
component("YJL219W",494).
component("YJL134W",485).
component("YJL129C",483).
component("YHL036W",430).
component("YGR121C",403).
component("YGR055W",397).
component("YGL186C",384).
component("YGL077C",380).
component("YGL008C",370).
component("YFL055W",359).
component("YFL011W",353).
component("YER060W-A",332).
component("YER060W",331).
component("YER056C",330).
component("YER053C",328).
component("YEL017C-A",317).
component("YDR536W",316).
component("YDR508C",312).
component("YDR503C",311).
component("YDR497C",310).
component("YDR297W",293).
component("YDR294C",292).
component("YDR046C",263) :- not remove_orf("YDR046C",263).
component("YDL210W",249).
component("YCR032W",215).
component("YCR024C-A",214).
component("YCL025C",208).
component("YBR298C",205).
component("YBR291C",204).
component("YBR069C",176) :- not remove_orf("YBR069C",176).
component("YBR068C",175) :- not remove_orf("YBR068C",175).
component("YBR036C",172).
component("YBR021W",168).
component("YBL042C",155).
component("U79_",127).
component("U75_",125).
component("U74_",124).
component("U73_",123).
...
catalyst(6160,639).
catalyst(3870,329).
catalyst(3620,298) :- not remove_reaction(3620,298).
catalyst(2110,365).
catalyst(2190,365).
catalyst(5550,510).
catalyst(5791,578).
...
catalyst(1960,264).
catalyst(3460,111).
catalyst(3600,541) :- not remove_reaction(3600,541).
catalyst(3941,692).
catalyst(3942,692).
catalyst(6890,657).
catalyst(6900,408).
...
catalyst(4560,318).
catalyst(2550,682).
catalyst(1890,542) :- not remove_reaction(1890,542).
catalyst(3630,542) :- not remove_reaction(3630,542).
catalyst(1890,342) :- not remove_reaction(1890,342).
catalyst(3630,342) :- not remove_reaction(3630,342).
catalyst(3740,275).
catalyst(8231,772).
catalyst(8232,772).
catalyst(8231,744).
...
catalyst(8051,765).
catalyst(8052,765).
catalyst(3590,374) :- not remove_reaction(3590,374).
catalyst(10910,374) :- not remove_reaction(10910,374).
catalyst(4570,407).
catalyst(8181,587).
catalyst(8182,587).
catalyst(8181,493).
...
catalyst(8281,265).
catalyst(8282,265).
catalyst(3610,255) :- not remove_reaction(3610,255).
catalyst(7921,710).
catalyst(7922,710).
catalyst(7841,322).
catalyst(7842,322).
...
catalyst(1200,706).
catalyst(1160,701).
catalyst(801,690) :- not remove_reaction(801,690).
catalyst(802,690) :- not remove_reaction(802,690).
catalyst(811,690) :- not remove_reaction(811,690).
catalyst(812,690) :- not remove_reaction(812,690).
catalyst(831,690) :- not remove_reaction(831,690).
catalyst(832,690) :- not remove_reaction(832,690).
catalyst(901,690) :- not remove_reaction(901,690).
catalyst(902,690) :- not remove_reaction(902,690).
catalyst(941,690) :- not remove_reaction(941,690).
catalyst(942,690) :- not remove_reaction(942,690).
catalyst(700,685).
catalyst(1200,675).
catalyst(761,668).
catalyst(762,668).
...
catalyst(640,552).
catalyst(6560,550).
catalyst(761,549) :- not remove_reaction(761,549).
catalyst(762,549) :- not remove_reaction(762,549).
catalyst(771,549) :- not remove_reaction(771,549).
catalyst(772,549) :- not remove_reaction(772,549).
catalyst(781,549) :- not remove_reaction(781,549).
catalyst(782,549) :- not remove_reaction(782,549).
catalyst(791,549) :- not remove_reaction(791,549).
catalyst(792,549) :- not remove_reaction(792,549).
catalyst(801,549) :- not remove_reaction(801,549).
catalyst(802,549) :- not remove_reaction(802,549).
catalyst(811,549) :- not remove_reaction(811,549).
catalyst(812,549) :- not remove_reaction(812,549).
catalyst(821,549) :- not remove_reaction(821,549).
catalyst(822,549) :- not remove_reaction(822,549).
catalyst(831,549) :- not remove_reaction(831,549).
catalyst(832,549) :- not remove_reaction(832,549).
catalyst(841,549) :- not remove_reaction(841,549).
catalyst(842,549) :- not remove_reaction(842,549).
catalyst(861,549) :- not remove_reaction(861,549).
catalyst(862,549) :- not remove_reaction(862,549).
catalyst(881,549) :- not remove_reaction(881,549).
catalyst(882,549) :- not remove_reaction(882,549).
catalyst(901,549) :- not remove_reaction(901,549).
catalyst(902,549) :- not remove_reaction(902,549).
catalyst(911,549) :- not remove_reaction(911,549).
catalyst(912,549) :- not remove_reaction(912,549).
catalyst(941,549) :- not remove_reaction(941,549).
catalyst(942,549) :- not remove_reaction(942,549).
catalyst(1191,549) :- not remove_reaction(1191,549).
catalyst(1192,549) :- not remove_reaction(1192,549).
catalyst(1021,544).
catalyst(1022,544).
catalyst(6610,519).
catalyst(170,515).
...
catalyst(6650,293).
catalyst(6550,292).
catalyst(791,263) :- not remove_reaction(791,263).
catalyst(792,263) :- not remove_reaction(792,263).
catalyst(801,263) :- not remove_reaction(801,263).
catalyst(802,263) :- not remove_reaction(802,263).
catalyst(811,263) :- not remove_reaction(811,263).
catalyst(812,263) :- not remove_reaction(812,263).
catalyst(831,263) :- not remove_reaction(831,263).
catalyst(832,263) :- not remove_reaction(832,263).
catalyst(841,263) :- not remove_reaction(841,263).
catalyst(842,263) :- not remove_reaction(842,263).
catalyst(861,263) :- not remove_reaction(861,263).
catalyst(862,263) :- not remove_reaction(862,263).
catalyst(901,263) :- not remove_reaction(901,263).
catalyst(902,263) :- not remove_reaction(902,263).
catalyst(730,249).
catalyst(431,215).
catalyst(432,215).
catalyst(220,214).
...
catalyst(1511,204).
catalyst(1512,204).
catalyst(771,176) :- not remove_reaction(771,176).
catalyst(772,176) :- not remove_reaction(772,176).
...
catalyst(791,175) :- not remove_reaction(791,175).
catalyst(792,175) :- not remove_reaction(792,175).
catalyst(801,175) :- not remove_reaction(801,175).
catalyst(802,175) :- not remove_reaction(802,175).
catalyst(811,175) :- not remove_reaction(811,175).
catalyst(812,175) :- not remove_reaction(812,175).
catalyst(831,175) :- not remove_reaction(831,175).
catalyst(832,175) :- not remove_reaction(832,175).
catalyst(841,175) :- not remove_reaction(841,175).
catalyst(842,175) :- not remove_reaction(842,175).
catalyst(861,175) :- not remove_reaction(861,175).
catalyst(862,175) :- not remove_reaction(862,175).
catalyst(901,175) :- not remove_reaction(901,175).
catalyst(902,175) :- not remove_reaction(902,175).
catalyst(6600,172).
catalyst(620,168).
catalyst(540,155).
catalyst(2830,127).
...
modifiable_enzyme(542).
modifiable_enzyme(342).
modifiable_enzyme(374).
modifiable_enzyme(255).
modifiable_enzyme(690).
modifiable_enzyme(549).
