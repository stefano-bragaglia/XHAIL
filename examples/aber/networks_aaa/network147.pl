...
component("YNL280C",773).
component("YLR056W",654).
component("YGR060W",456).
component("YGL012W",424).
component("YKR009C",637).
component("YOL086C",804).
component("YMR303C",742).
component("YMR083W",714).
...
component("YOL126C",809).
component("YKL085W",615).
component("YDL078C",260).
component("YKL029C",610).
component("YOR136W",824).
component("YNL037C",747).
component("YDL066W",259).
component("YNL241C",763).
component("YOL059W",802).
component("YDL022W",253).
component("YLR355C",687).
component("YIL074C",531).
component("YER081W",391).
component("YML054C",698).
component("YDL174C",281).
component("YML086C",702).
component("YIL155C",539).
component("YPR191W",918).
component("YOR065W",815).
component("YJL166W",570).
component("YHR001W-A",495).
component("YGR183C",471).
component("YFR033C",417).
component("YDR529C",357).
component("YBL045C",176).
component("Q0105",18).
component("YGR088W",459).
component("YDR256C",326).
component("YKL026C",609).
component("YIR037W",550).
component("YBR244W",223).
component("YJR078W",590).
component("YJR025C",582).
component("YGR255C",483).
component("U108_",23).
component("YBL098W",180).
component("YMR015C",711).
component("YHR007C",496).
component("YDR402C",346).
component("YGL055W",431).
component("YGR175C",468).
component("YJR104C",593).
component("YHR008C",497).
component("YJL026W",553).
component("YIL066C",530).
component("YGR180C",470).
...
component("YPL276W",893).
component("YPL275W",892).
component("YOR388C",858).
component("YOR374W",855).
component("YER073W",389).
component("U68_",133).
component("YGL154C",439).
component("U55_",125).
component("YOR323C",846).
component("YMR170C",724).
component("YMR169C",723).
component("U2_",104).
component("YER178W",404).
component("YBR221C",221).
component("YIL125W",537).
component("U52_",122).
component("YBR166C",214).
component("YNL280C",774).
component("YGL012W",425).
component("YKL182W",627).
component("U57_",127).
component("YKL216W",634).
component("YDR044W",298).
component("YER014W",372).
component("YKR009C",638).
component("YIL160C",541).
component("YGL205W",442).
component("YMR118C",719).
component("YLR164W",667).
component("YLL041C",647).
component("YKL148C",622).
component("YKL141W",620).
component("YJL045W",554).
component("YDR178W",320).
...
component("YMR189W",726).
component("U56_",126).
component("YHR037W",503).
component("YKR080W",642).
component("YER023W",374).
component("YPL023C",862).
component("YGL125W",436).
component("YOR236W",839).
component("YGR204W",475).
component("YLR142W",662).
component("U63_",131).
component("U62_",130).
component("YOR356W",853).
component("YKL150W",623).
component("YIL043C",527).
component("YHR042W",504).
component("YOR221C",837).
component("YML120C",705).
component("YKL192C",631).
component("YKL055C",612).
component("YER061C",383).
component("YGR234W",478).
component("YFR030W",416).
component("YPL017C",861).
component("YFL018C",408).
component("YDR353W",341).
component("YER042W",376).
component("YJR137C",598).
component("YPL266W",888).
component("YML110C",704).
component("YBR034C",192).
component("YPL273W",890).
component("YLL062C",650).
component("YDR410C",349).
component("U47_",117).
component("YER091C",396).
component("YJR073C",588).
component("YDR120C",309).
component("YDL033C",255).
component("YOL096C",805).
component("YLR172C",668).
component("YDR019C",294).
component("YBR176W",215).
component("YDR408C",348).
component("YMR120C",720).
component("YBL013W",171).
component("YKL024C",608).
component("YPR074C",907).
component("YBR117C",204).
component("YLR354C",686).
component("YGR043C",454).
component("YMR108W",717).
component("YCL009C",235).
component("YMR062C",713).
component("YNL071W",750).
component("YNR008W",781).
component("YIL160C",542).
component("YNL277W",772).
component("YFL017C",407).
component("YPL231W",882).
component("YER061C",384).
component("U86_",149).
component("YPL001W",860).
component("YMR296C",740).
component("YDR062W",304).
component("YDL052C",258).
component("U8_",153).
component("YDR148C",317).
component("YOR377W",857).
component("YGR177C",469).
component("YPL231W",883).
component("YGR147C",464).
component("YDL040C",256).
component("YPL028W",863).
component("YLR195C",669).
component("YGL017W",426).
component("YPR001W",895).
component("YNR001C",779).
component("YCR005C",242).
component("YDL182W",282).
component("YDL131W",270).
component("YNL117W",754).
component("YIR031C",548).
component("YOR321W",845).
component("YJR143C",600).
component("YGR199W",474).
component("YDR307W",335).
component("YDL095W",265).
component("YDL093W",264).
component("YAL023C",164).
component("YOR103C",819).
component("YOR085W",817).
component("YMR149W",722).
component("YML019W",694).
component("YJL002C",551).
component("YEL002C",361).
component("YDL232W",288).
component("YCL043C",240).
component("YNL029C",746).
component("YIL085C",532).
component("YMR261C",735).
component("YML100W",703).
component("YBR126C",207).
component("YNL192W",762).
component("YBR038W",195).
component("YBR023C",191).
component("YMR306W",744).
component("YLR342W",684).
component("YGR032W",452).
component("YLR209C",670).
component("U104_",21).
component("YOR209C",835).
component("YMR300C",741).
component("YER055C",379).
...
component("YNR041C",787).
component("YMR101C",715).
component("YDL090C",263).
component("YBR003W",182).
component("YBR002C",181).
component("YJL167W",571).
component("YJL167W",572).
...
component("YLR303W",679).
component("YDR035W",296).
component("YBR249C",224).
component("YOR274W",841).
component("YOL143C",811).
component("YBR256C",226).
component("YHR137W",515).
component("YGL202W",441).
component("YLR027C",651).
component("YKL106W",617).
component("YKL104C",616).
component("YGR019W",451).
component("YLR089C",657).
component("U64_",132).
component("U61_",129).
component("U51_",121).
component("YJR148W",601).
component("YHR208W",521).
component("YOR184W",830).
component("YNR058W",790).
component("YIL116W",536).
component("YGL253W",447).
component("YFR053C",419).
component("YOL136C",810).
component("YIL107C",534).
component("YMR013C",710).
component("YMR205C",728).
component("YGR240C",479).
component("YDR248C",325).
component("YCR036W",248).
component("YGR194C",473).
component("YCL040W",239).
component("YJR105W",594).
component("U16_",57).
component("U15_",51).
...
component("YML070W",701).
component("YFL053W",411).
component("YHL032C",493).
component("YLR133W",659).
component("YDR531W",359).
component("U83_",147).
component("U82_",146).
component("U81_",145).
component("YMR208W",729).
component("YPL203W",876).
component("YOR061W",814).
component("YKL166C",625).
component("YJL164C",569).
component("YIL035C",526).
component("YHR205W",520).
component("YHR102W",513).
component("YGL019W",427).
component("YHR025W",502).
component("YOR347C",851).
component("YAL038W",166).
component("YNR012W",782).
component("YPR121W",911).
component("YPL258C",885).
component("YOL055C",798).
component("YPL214C",879).
component("U1_",80).
component("YDR009W",293).
component("YBR020W",189).
component("YNL267W",770).
component("YLR305C",681).
component("YFR019W",414).
component("YDR208W",321).
...
component("YER052C",377).
component("YER069W",387).
component("U18_",72).
component("U17_",65).
component("U76_",141).
component("YMR220W",731).
component("YER170W",403).
component("YDR226W",322).
component("YKL067W",614).
component("YOL055C",799).
component("YDR454C",353).
component("YJR057W",586).
component("YOL061W",803).
component("YKL181W",626).
...
component("YKR002W",636).
component("YDL103C",268).
component("U94_",158).
component("YJR010W",580).
component("YGL130W",437).
component("YDR530C",358).
component("YCL050C",241).
component("YPR190C",917).
component("YPR187W",916).
component("YPR110C",909).
component("YPR010C",898).
component("YOR341W",850).
component("YOR340C",849).
component("YOR224C",838).
component("YOR210W",836).
component("YOR207C",833).
component("YOR151C",827).
component("YOR116C",820).
component("YOL005C",792).
component("YNR003C",780).
component("YNL248C",765).
component("YNL151C",759).
component("YNL113W",753).
component("YKL144C",621).
component("YJR063W",587).
component("YJL148W",566).
component("YJL140W",565).
component("YIL021W",525).
component("YHR143W-A",516).
component("YGL070C",434).
component("YFL036W",410).
component("YDR404C",347).
component("YDR156W",318).
component("YDR045C",299).
component("YDL150W",277).
component("YDL140C",272).
component("YBR154C",213).
component("YPR175W",914).
component("YPL167C",872).
component("YOR330C",847).
component("YOL115W",808).
component("YNL299W",776).
component("YNL262W",769).
component("YNL102W",752).
component("YJR043C",583).
component("YJR006W",579).
component("YJL090C",558).
component("YIL139C",538).
...
component("YKL035W",611).
component("YHL012W",491).
component("YHR123W",514).
component("YPR113W",910).
component("YBR243C",222).
component("YNL130C",755).
component("YDL142C",276).
component("YPL148C",870).
component("YER026C",375).
component("YCL004W",234).
component("YGR286C",487).
component("YJL068C",555).
component("YDR058C",303).
component("YNR034W",786).
component("YHR163W",518).
component("YGR248W",481).
component("YCR073W-A",250).
component("YDL086W",262).
component("YOL011W",794).
component("YMR008C",708).
component("YMR006C",707).
component("U105_",22).
component("U101_",19).
component("YBL015W",172).
component("YJL068C",556).
component("YPL072W",866).
component("YOR124C",821).
component("YNL186W",761).
component("YMR304W",743).
component("YMR223W",732).
component("YKR098C",645).
component("YJL197W",573).
component("YIL156W",540).
component("YFR010W",413).
component("YER151C",401).
component("YER144C",400).
component("YER098W",397).
component("YDR069C",305).
component("YDL122W",269).
component("YBR058C",196).
component("YBL067C",178).
component("YDR272W",329).
component("U84_",148).
component("YLR377C",689).
component("YDR074W",306).
component("YPL179W",874).
component("YNR032W",784).
component("YML057W",700).
component("YML016C",693).
component("YLR433C",692).
component("YGR123C",462).
component("YER133W",399).
component("YER089C",394).
component("YDR436W",351).
component("YDR075W",307).
component("YDL188C",283).
component("YDL134C",271).
component("YDL047W",257).
...
component("YIL053W",529).
component("YER062C",385).
component("YHR046C",505).
component("U9_",162).
component("YGR208W",477).
component("YPL228W",880).
component("YMR180C",725).
component("YDL236W",289).
component("YJL155C",568).
component("YPR073C",906).
component("YOR208W",834).
component("YNL053W",749).
component("YMR036C",712).
component("YIR026C",545).
component("YIL113W",535).
component("YFR028C",415).
component("YER075C",390).
...
component("U25_",101).
component("U24_",100).
component("YPL268W",889).
component("YOR360C",854).
component("YGL248W",446).
component("YKR031C",639).
component("YPL206C",877).
component("YGL027C",429).
component("YLR286C",676).
component("YJR153W",603).
component("YJL221C",578).
component("YJL216C",576).
component("YIL172C",544).
component("YGR292W",489).
component("YGR287C",488).
component("YBR299W",233).
component("YBR184W",216).
component("YOR190W",831).
component("YLR300W",677).
component("YGR282C",486).
component("YDR261C",327).
component("YDR400W",345).
component("U23_",99).
component("YML035C",696).
component("YJL070C",557).
component("YBR284W",230).
component("U102_",20).
component("YNL045W",748).
component("YLR160C",666).
component("YLR158C",665).
component("YLR157C",664).
component("YLR155C",663).
component("YDR321W",336).
component("YGL037C",430).
component("YMR293C",739).
component("YDR242W",324).
component("YBR208C",218).
component("YMR281W",738).
component("U53_",123).
component("YIR027C",546).
component("YPL111W",869).
component("YIR032C",549).
component("YIR029W",547).
component("YPR062W",903).
component("YMR120C",721).
component("YLR028C",652).
component("YHR144C",517).
component("YGR267C",485).
component("YNL141W",756).
component("YBR153W",212).
component("YDL238C",290).
component("YNL141W",757).
component("YLR245C",674).
...
component("U87_",150).
component("U40_",113).
component("YMR267W",736).
component("YBR011C",184).
component("YBR111C",203).
component("YBR252W",225).
component("YCL030C",238).
component("YER005W",371).
component("YIL048W",528).
component("YER166W",402).
component("YDR093W",308).
component("YAL026C",165).
component("YLR231C",672).
component("U88_",151).
component("YLR134W",660).
component("YLR044C",653).
component("YGR087C",458).
component("YDR380W",343).
component("YDL080C",261).
component("U98_",160).
component("YMR250W",734).
component("YKL184W",630).
component("YOR128C",822).
component("YEL021W",363).
component("YNR043W",788).
component("U93_",157).
component("YDR047W",301).
component("U54_",124).
component("YKL211C",632) :- not remove_orf("YKL211C",632).
component("YKR097W",644).
component("YOL052C",797).
component("YNL169C",760).
component("YGR170W",466).
component("YKL060C",613).
component("YNL256W",768).
component("YDR294C",331).
component("YEL046C",365).
component("YNR033W",785).
component("YPR006C",897).
component("YER065C",386).
component("YKL211C",633) :- not remove_orf("YKL211C",633).
component("YER090W",633) :- not remove_orf("YER090W",633).
component("YER090W",395) :- not remove_orf("YER090W",395).
component("YDR127W",314).
component("YPL281C",894).
component("YOR393W",859).
component("YMR323W",745).
component("YHR174W",519).
component("YGR254W",482).
component("YPL262W",886).
component("YGL026C",428) :- not remove_orf("YGL026C",428).
component("YGR155W",465).
component("YLR304C",680).
component("YJL200C",574).
component("YNL316C",777).
component("YKL182W",628).
component("YPL212C",878).
component("YNL292W",775).
component("YGL063W",433).
component("YFL001W",405).
component("YOR278W",842).
component("YPR002W",896).
component("U49_",118).
component("YJR016C",581).
component("YCR053W",249).
component("YDR127W",315).
component("YGL148W",438).
component("YIL168W",543).
component("YER086W",392).
component("YLR359W",688).
component("YAL012W",163).
component("YFR055W",420).
component("YJL005W",552).
component("YOR176W",829).
...
component("YOR095C",818).
component("YER003C",370).
component("YBR196C",217).
component("YGL001C",422).
component("U14_",44).
component("YOL056W",800).
component("YKL152C",624).
component("YDL021W",252).
component("YMR105C",716).
component("YKL127W",618).
component("YEL058W",368).
component("YPR060C",902).
component("YHR072W",507).
component("YJL153C",567).
component("YPL097W",867).
component("YGR185C",472).
component("YGR264C",484).
component("YGR171C",467).
component("YHR011W",498).
component("YDR023W",295).
component("YPL104W",868).
component("YLL018C",646).
component("YPR081C",908).
component("YBR121C",205).
component("YHR020W",501).
component("YER087W",393).
component("YNL247W",764).
component("YOL033W",796).
component("YGL245W",445).
component("YHR091C",509).
component("YDR341C",337).
component("YOL097C",806).
component("YDR268W",328).
component("YPR047W",901).
component("YLR060W",655).
component("YFL022C",409).
component("YPR033C",899).
component("YHR019C",499).
component("YCR024C",245).
component("YHR019C",500).
component("YPL160W",871).
component("YLR382C",690).
component("YNL073W",751).
component("YDR037W",297).
component("YOR335C",848).
component("YGR094W",460).
component("YOR317W",844).
component("YMR246W",733).
component("YIL009W",524).
component("YER015W",373).
component("YOR142W",825).
component("YGR244C",480).
component("YPR035W",900).
component("U89_",152).
component("YOR241W",840).
component("YMR113W",718).
component("YKL132C",619).
...
component("YJR103W",592).
component("YBL039C",174).
component("YGR204W",476).
component("YBR084W",200).
component("YOL058W",801).
component("YBR208C",219).
component("YHR074W",508).
component("YMR217W",730).
component("YGR061C",457).
component("YPR145W",913).
component("YGR124W",463).
component("YOR303W",843).
component("YJR109C",595).
component("YJL130C",563).
component("YGL062W",432).
component("YBR218C",220).
component("YPL231W",884).
component("YNR016C",783).
component("YKL182W",629).
component("YGR037C",453).
component("YOR005C",813).
component("YDL164C",278).
component("YOL010W",793).
component("YPR138C",912).
component("YPL274W",891).
component("YPL265W",887).
component("YPL057C",865).
component("YPL036W",864).
component("YOR348C",852).
component("YOR192C",832).
component("YOR171C",828).
component("YOR130C",823).
component("YOR071C",816).
component("YOL156W",812).
component("YOL103W",807).
component("YOL020W",795) :- not remove_orf("YOL020W",795).
component("YNR072W",791).
component("YNR056C",789).
component("YNL318C",778).
component("YNL268W",771).
component("YNL142W",758).
component("YMR272C",737).
component("YMR202W",727).
component("YMR011W",709).
component("YML123C",706).
component("YLR348C",685).
component("YLR260W",675).
component("YLR237W",673).
component("YLR138W",661).
component("YLR100C",658).
component("YLR081W",656).
component("YLL061W",649).
component("YLL043W",648).
component("YKR093W",643).
component("YKR053C",641).
component("YKR039W",640) :- not remove_orf("YKR039W",640).
component("YKL217W",635).
component("YKL004W",607).
component("YJR158W",604).
component("YJR152W",602).
component("YJR095W",591).
component("YJR077C",589).
component("YJL219W",577).
component("YJL214W",575).
component("YJL134W",564).
component("YJL129C",562).
component("YHR096C",512).
component("YHR094C",511).
component("YHR092C",510).
component("YHL036W",494).
component("YHL016C",492).
component("YGR121C",461).
component("YGR055W",455).
component("YGL186C",440).
component("YGL077C",435).
component("YGL008C",423).
component("YFL055W",412).
component("YFL011W",406).
...
component("YDR284C",330).
component("YDR046C",300) :- not remove_orf("YDR046C",300).
component("YDL245C",291).
component("YDL210W",284).
...
catalyst(1960,301).
catalyst(3460,124).
catalyst(3600,632) :- not remove_reaction(3600,632).
catalyst(8000,644).
catalyst(3941,797).
catalyst(3942,797).
catalyst(6890,760).
...
catalyst(8020,897).
catalyst(8020,386).
catalyst(1890,633) :- not remove_reaction(1890,633).
catalyst(3630,633) :- not remove_reaction(3630,633).
catalyst(1890,395) :- not remove_reaction(1890,395).
catalyst(3630,395) :- not remove_reaction(3630,395).
catalyst(3740,314).
catalyst(8231,894).
catalyst(8232,894).
catalyst(8231,859).
...
catalyst(8051,886).
catalyst(8052,886).
catalyst(3590,428) :- not remove_reaction(3590,428).
catalyst(10910,428) :- not remove_reaction(10910,428).
catalyst(4570,465).
catalyst(8181,680).
catalyst(8182,680).
catalyst(8181,574).
...
catalyst(1210,812).
catalyst(1160,807).
catalyst(801,795) :- not remove_reaction(801,795).
catalyst(802,795) :- not remove_reaction(802,795).
catalyst(811,795) :- not remove_reaction(811,795).
catalyst(812,795) :- not remove_reaction(812,795).
catalyst(831,795) :- not remove_reaction(831,795).
catalyst(832,795) :- not remove_reaction(832,795).
catalyst(901,795) :- not remove_reaction(901,795).
catalyst(902,795) :- not remove_reaction(902,795).
catalyst(941,795) :- not remove_reaction(941,795).
catalyst(942,795) :- not remove_reaction(942,795).
catalyst(1210,791).
catalyst(700,789).
catalyst(1200,778).
catalyst(761,771).
...
catalyst(650,643).
catalyst(6560,641).
catalyst(761,640) :- not remove_reaction(761,640).
catalyst(762,640) :- not remove_reaction(762,640).
catalyst(771,640) :- not remove_reaction(771,640).
catalyst(772,640) :- not remove_reaction(772,640).
catalyst(781,640) :- not remove_reaction(781,640).
catalyst(782,640) :- not remove_reaction(782,640).
catalyst(791,640) :- not remove_reaction(791,640).
catalyst(792,640) :- not remove_reaction(792,640).
catalyst(801,640) :- not remove_reaction(801,640).
catalyst(802,640) :- not remove_reaction(802,640).
catalyst(811,640) :- not remove_reaction(811,640).
catalyst(812,640) :- not remove_reaction(812,640).
catalyst(821,640) :- not remove_reaction(821,640).
catalyst(822,640) :- not remove_reaction(822,640).
catalyst(831,640) :- not remove_reaction(831,640).
catalyst(832,640) :- not remove_reaction(832,640).
catalyst(841,640) :- not remove_reaction(841,640).
catalyst(842,640) :- not remove_reaction(842,640).
catalyst(861,640) :- not remove_reaction(861,640).
catalyst(862,640) :- not remove_reaction(862,640).
catalyst(881,640) :- not remove_reaction(881,640).
catalyst(882,640) :- not remove_reaction(882,640).
catalyst(901,640) :- not remove_reaction(901,640).
catalyst(902,640) :- not remove_reaction(902,640).
catalyst(911,640) :- not remove_reaction(911,640).
catalyst(912,640) :- not remove_reaction(912,640).
catalyst(921,640) :- not remove_reaction(921,640).
catalyst(922,640) :- not remove_reaction(922,640).
catalyst(941,640) :- not remove_reaction(941,640).
catalyst(942,640) :- not remove_reaction(942,640).
catalyst(1191,640) :- not remove_reaction(1191,640).
catalyst(1192,640) :- not remove_reaction(1192,640).
catalyst(1021,635).
catalyst(1022,635).
catalyst(6610,607).
catalyst(1210,604).
...
catalyst(6550,332).
catalyst(6690,330).
catalyst(791,300) :- not remove_reaction(791,300).
catalyst(792,300) :- not remove_reaction(792,300).
...
catalyst(861,300) :- not remove_reaction(861,300).
catalyst(862,300) :- not remove_reaction(862,300).
