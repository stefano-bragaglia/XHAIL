...
component("YLR056W",717).
component("YGR060W",504).
component("YGL012W",469).
component("YKR009C",697).
component("YOL086C",890).
component("YMR303C",821).
...
component("YLR450W",763).
component("YOL126C",895).
component("YKL085W",671).
component("YDL078C",290).
component("YKL029C",666).
component("YOR136W",912).
component("YNL037C",826).
component("YDL066W",288).
component("YNL241C",845).
component("YOL059W",887).
component("YDL022W",281).
component("YLR355C",755).
component("YIL074C",582).
component("YER081W",432).
component("YML054C",770).
component("YDL174C",313).
component("YML086C",775).
component("YIL155C",592).
component("YPR191W",1015).
component("YOR065W",902).
component("YJL166W",626).
component("YHR001W-A",544).
component("YGR183C",520).
component("YFR033C",462).
component("YDR529C",397).
component("YBL045C",199).
component("Q0105",18).
component("YGR088W",507).
...
component("YPL276W",987).
component("YPL275W",986).
component("YOR388C",950).
component("YOR374W",947).
component("YER073W",430).
component("U68_",151).
component("YGL154C",485).
component("YBR115C",229).
component("U55_",141).
component("YOR323C",937).
component("YMR170C",801).
component("YMR169C",800).
component("U2_",118).
component("YER178W",446).
component("YBR221C",248).
component("YIL125W",589).
component("U52_",138).
component("YBR166C",241).
component("YNL280C",856).
component("YGL012W",470).
component("YKL182W",685).
component("U57_",143).
component("YKL216W",694).
component("YDR044W",330).
component("YER014W",413).
component("YKR009C",698).
component("YIL160C",594).
component("YGL205W",490).
component("YMR118C",795).
component("YLR164W",732).
component("YLL041C",709).
component("YKL148C",679).
component("YKL141W",677).
component("YJL045W",609).
component("YDR178W",357).
component("YJR051W",641).
component("YEL047C",407).
component("YDL171C",312).
component("YDL215C",317).
component("YOR375C",948).
component("YDL215C",318).
component("YAL062W",188).
component("U99_",182).
component("YBR035C",216).
component("YMR189W",803).
component("U56_",142).
component("YNR050C",871).
component("YHR037W",552).
component("YKR080W",702).
component("YER023W",415).
component("YPL023C",954).
component("YGL125W",482).
component("YOR236W",929).
component("YGR204W",524).
component("YLR142W",726).
component("U63_",148).
component("U62_",147).
component("YOR356W",945).
component("YKL150W",680).
component("YIL043C",578).
component("YHR042W",553).
component("YOR221C",926).
component("YML120C",779).
component("YKL192C",689).
component("YKL055C",668).
component("YER061C",424).
component("YBR046C",219).
component("YMR145C",798).
component("YML120C",780).
component("YKL192C",690).
component("YDL085W",292).
component("YGR234W",527).
component("YFR030W",461).
component("YPL017C",953).
component("YFL018C",451).
component("YPL091W",959).
component("YDR353W",379).
component("YER042W",417).
component("YPR167C",1009).
component("YJR137C",654).
component("YNL052W",828).
component("YMR256C",812).
component("YLR395C",759).
component("YLR038C",715).
component("YIL111W",586).
component("YHR051W",555).
component("YGL191W",488).
component("YGL187C",487).
component("YDL067C",289).
component("Q0275",20).
component("Q0250",19).
component("YPL266W",982).
component("YML110C",778).
component("YBR034C",215).
component("YPL273W",984).
component("YLL062C",712).
component("YDR410C",388).
component("U47_",133).
component("YER091C",437).
component("YJR073C",644).
component("YDR120C",345).
component("YML008C",764).
component("YDL033C",283).
component("YOL096C",891).
component("YLR172C",733).
component("YDR019C",326).
...
component("YNL071W",830).
component("YNR008W",863).
component("YIL160C",595).
component("YNL277W",854).
component("YDR232W",360).
component("YFL017C",450).
component("YPL231W",976).
component("YER061C",425).
component("U86_",170).
component("YPL001W",952).
component("YMR296C",819).
component("YDR062W",338).
component("YDL052C",286).
component("U8_",174).
component("YDR148C",353).
component("YOR377W",949).
component("YGR177C",518).
component("YPL231W",977).
component("YGR147C",513).
component("YDL040C",284).
component("YPL028W",955).
component("YLR195C",734).
component("YGL017W",471).
component("YPR001W",989).
component("YNR001C",861).
component("YCR005C",270).
component("YNL104C",833).
component("YDL182W",314).
component("YDL131W",301).
component("YNL117W",835).
component("YIR031C",603).
component("YOR321W",936).
component("YJR143C",656).
component("YGR199W",523).
component("YDR307W",373).
component("YDL095W",296).
component("YDL093W",295).
component("YAL023C",185).
component("YOR103C",906).
component("YOR085W",904).
component("YMR149W",799).
component("YML019W",766).
component("YJL002C",606).
component("YEL002C",401).
component("YDL232W",320).
component("YCL043C",267).
component("YNL029C",825).
component("YIL085C",583).
component("YMR261C",813).
component("YML100W",776).
component("YBR126C",234).
component("YNL192W",843).
component("YBR038W",218).
component("YBR023C",214).
component("YMR306W",823).
component("YLR342W",752).
component("YGR032W",500).
component("YPR183W",1012).
component("YLR209C",735).
component("U104_",23).
component("YMR271C",815).
component("YML106W",777).
component("YOR209C",924).
component("YMR300C",820).
component("YER055C",420).
component("YDR354W",380) :- not remove_orf("YDR354W",380).
component("YFR047C",463).
component("YJR133W",653).
component("YLR209C",736).
component("YML022W",767).
component("YDR441C",391).
component("YDR399W",383).
component("YPR176C",1011).
component("YPL172C",967).
component("YNR041C",869).
component("YMR101C",791).
component("YDL090C",294).
component("YBR003W",205).
component("YBR002C",204).
component("YJL167W",627).
component("YJL167W",628).
component("YNL256W",848).
component("YPR069C",998).
component("YDR127W",348).
component("YLR146C",727).
component("YLR303W",743).
component("YGR012W",498).
component("YJR130C",652).
component("YLR303W",744).
component("YDR035W",328).
component("YBR249C",251).
component("YOR274W",932).
component("YOL143C",898).
component("YBR256C",253).
component("YHR137W",565).
component("YGL202W",489).
component("YLR027C",713).
component("YKL106W",673).
component("YOL140W",897).
component("YLR438W",762).
component("YKL104C",672).
component("YGR019W",499).
component("YLR089C",721).
component("YDR111C",344).
component("U64_",149).
component("U61_",146).
component("U51_",137).
component("YJR148W",657).
component("YHR208W",572).
component("YFL030W",453).
component("YOR184W",918).
component("YNR058W",874).
component("YIL116W",588).
component("YGL253W",495).
component("YFR053C",464).
component("YOL136C",896).
component("YIL107C",585).
component("YMR013C",785).
component("YMR205C",805).
component("YGR240C",528).
component("YDR248C",363).
component("YCR036W",276).
component("YGR194C",522).
component("YCL040W",266).
component("YJR105W",650).
component("U16_",66).
component("U15_",58).
component("YPL188W",969).
component("YJR049C",640).
component("YEL041W",405).
component("U96_",180).
component("YKL001C",662).
component("YDR236C",361).
component("YML070W",773).
component("YFL053W",455).
component("YHL032C",542).
component("YLR133W",723).
component("YDR531W",399).
component("U83_",167).
component("U82_",166).
component("U81_",165).
component("YMR208W",806).
component("YPL203W",970).
component("YOR061W",901).
component("YKL166C",682).
component("YJL164C",625).
component("YIL035C",577).
component("YHR205W",571).
component("YHR102W",563).
component("YGL019W",472).
component("YHR025W",551).
component("YOR347C",943).
component("YAL038W",187).
component("YNR012W",864).
component("YPR121W",1006).
component("YPL258C",979).
component("YOL055C",883).
component("YPL214C",973).
component("U1_",91).
component("YDR009W",325).
component("YBR020W",212).
component("YNL267W",852).
component("YLR305C",746).
component("YFR019W",458).
component("YDR208W",358).
...
component("U17_",75).
component("U76_",160).
component("YMR220W",808).
component("YER170W",445).
component("YDR226W",359).
component("YKL067W",670).
component("YOL055C",884).
component("YDR454C",392).
component("YJR057W",642).
component("YOL061W",888).
component("YKL181W",684).
component("YHL011C",539).
component("YER099C",439).
component("YBL068W",202).
component("YOR143C",914).
...
component("YKR002W",696).
component("U80_",164).
component("YDL103C",299).
component("U94_",179).
component("YJR010W",636).
component("YGL130W",483).
component("YDR530C",398).
component("YCL050C",268).
component("YPR190C",1014).
component("YPR187W",1013).
component("YPR110C",1004).
component("YPR010C",992).
component("YOR341W",942).
component("YOR340C",941).
component("YOR224C",928).
component("YOR210W",925).
component("YOR207C",922).
component("YOR151C",915).
component("YOR116C",907).
component("YOL005C",876).
component("YNR003C",862).
component("YNL248C",847).
component("YNL151C",840).
component("YNL113W",834).
component("YKL144C",678).
component("YJR063W",643).
component("YJL148W",622).
component("YJL140W",621).
component("YIL021W",576).
component("YHR143W-A",566).
component("YGL070C",480).
component("YFL036W",454).
component("YDR404C",386).
component("YDR156W",354).
component("YDR045C",331).
component("YDL150W",308).
component("YDL140C",303).
component("YBR154C",240).
component("YPR175W",1010).
component("YPL167C",966).
component("YOR330C",938).
component("YOL115W",894).
component("YNL299W",858).
component("YNL262W",851).
component("YNL102W",832).
component("YJR043C",639).
component("YJR006W",635).
component("YJL090C",613).
component("YIL139C",591).
...
component("YHL012W",540).
component("YHR123W",564).
component("YPR113W",1005).
component("YBR243C",249).
component("YNL130C",836).
component("YDL142C",307).
component("YPL148C",964).
component("YER026C",416).
component("YCL004W",261).
component("YOR251C",931).
component("YGR286C",536).
component("YJL068C",610).
component("YDR058C",336).
component("YNR034W",868).
component("YHR163W",568).
component("YGR248W",530).
component("YCR073W-A",278).
component("YDL086W",293).
component("YOL011W",878).
component("YMR008C",783).
component("YMR006C",782).
component("U105_",24).
component("U101_",21).
component("YBL015W",194).
component("YJL068C",611).
component("YPL072W",958).
component("YOR124C",908).
component("YNL186W",842).
component("YMR304W",822).
component("YMR223W",809).
component("YKR098C",706).
component("YJL197W",629).
component("YIL156W",593).
component("YFR010W",457).
component("YER151C",443).
component("YER144C",442).
component("YER098W",438).
component("YDR069C",339).
component("YDL122W",300).
component("YBR058C",220).
component("YBL067C",201).
component("YDR272W",367).
component("U84_",168).
component("YDR481C",393).
component("YLR377C",757).
component("YDR074W",340).
component("YFR025C",459).
component("YPL179W",968).
component("YNR032W",866).
component("YML057W",772).
component("YML016C",765).
component("YLR433C",761).
component("YGR123C",510).
component("YER133W",441).
component("YER089C",435).
component("YDR436W",390).
component("YDR075W",341).
component("YDL188C",315).
component("YDL134C",302).
component("YDL047W",285).
component("YDL006W",279).
component("YBR125C",233).
component("YBL056W",200).
component("YPR073C",999).
component("YHR215W",573).
component("YDL024C",282).
...
component("U9_",183).
component("YGR208W",526).
component("YPL228W",974).
component("YMR180C",802).
component("YDL236W",321).
component("YJL155C",624).
component("YPR073C",1000).
component("YOR208W",923).
component("YNL053W",829).
component("YMR036C",788).
component("YIR026C",599).
component("YIL113W",587).
component("YFR028C",460).
component("YER075C",431).
component("YDL230W",319).
...
component("U25_",115).
component("U24_",114).
component("YOL064C",889).
component("YPL268W",983).
component("YOR360C",946).
component("YGL248W",494).
component("YKR031C",699).
component("YPL206C",971).
component("YGL027C",474).
component("YLR286C",741).
component("YJR153W",659).
component("YJL221C",634).
component("YJL216C",632).
component("YIL172C",598).
component("YGR292W",538).
component("YGR287C",537).
component("YBR299W",260).
component("YBR184W",243).
component("YIL162W",596).
component("YOR190W",920).
component("YLR300W",742).
component("YGR282C",535).
...
component("U102_",22).
component("YNL045W",827).
component("YLR160C",731).
component("YLR158C",730).
component("YLR157C",729).
component("YLR155C",728).
component("YDR321W",374).
component("YGL037C",475).
component("YMR293C",818).
component("YDR242W",362).
component("YLR308W",749).
component("YLR307W",748).
component("YBR208C",245).
component("YMR281W",817).
component("U53_",139).
component("YIR027C",600).
component("YPL111W",962).
component("YIR032C",604).
component("YIR029W",602).
component("YPR062W",997).
component("YMR120C",797).
component("YLR028C",714).
component("YHR144C",567).
component("YGR267C",534).
component("YNL141W",837).
...
component("YJL126W",617).
component("U44_",130).
component("YDL100C",297).
component("U87_",171).
component("U40_",128).
component("YMR267W",814).
component("YBR011C",207).
component("YHR201C",570).
component("YBR111C",228).
component("YBR252W",252).
component("YCL030C",265).
component("YPR080W",1002).
component("YOR187W",919).
component("YOR133W",911).
component("YLR069C",719).
component("YKR084C",703).
component("YKL173W",683).
component("YJL102W",615).
component("YDR385W",382).
component("YBR118W",231).
component("YER005W",412).
component("YLL001W",707).
component("YIL048W",579).
component("YER166W",444).
component("YDR093W",343).
component("YAL026C",186).
component("YLR231C",737).
component("U88_",172).
component("YLR134W",724).
component("YLR044C",716).
component("YGR087C",506).
component("YDR380W",381).
component("YDL080C",291).
component("U98_",181).
component("YMR250W",811).
component("YKL184W",688).
component("YOR128C",909).
component("YEL021W",404).
component("YNR043W",870).
component("U93_",178).
component("YDR047W",333).
component("U54_",140).
component("YKL211C",692) :- not remove_orf("YKL211C",692).
component("YKR097W",705).
component("YOL052C",882).
component("YNL169C",841).
component("YGR170W",515).
...
component("YKL211C",693) :- not remove_orf("YKL211C",693).
component("YER090W",693) :- not remove_orf("YER090W",693).
component("YER090W",436) :- not remove_orf("YER090W",436).
component("YDR127W",350).
component("YPL281C",988).
component("YOR393W",951).
component("YMR323W",824).
component("YHR174W",569).
component("YGR254W",531).
component("YPL262W",980).
component("YGL026C",473) :- not remove_orf("YGL026C",473).
component("YGR155W",514).
component("YLR304C",745).
component("YJL200C",630).
component("YNL316C",859).
component("YKL182W",686).
component("YPL212C",972).
component("YNL292W",857).
component("YGL063W",479).
component("YFL001W",448).
component("YOR278W",933).
component("YPR002W",990).
component("U49_",134).
component("YJR016C",637).
component("YCR053W",277).
component("YDR127W",351).
component("YGL148W",484).
component("YIL168W",597).
component("YER086W",433).
component("YCL064C",269).
component("YLR359W",756).
component("YAL012W",184).
component("YFR055W",465).
component("YJL005W",607).
component("YOR176W",917).
component("YJL121C",616).
component("YBR019C",210).
component("YBR019C",211).
component("YDR050C",334).
component("YDR007W",324) :- not remove_orf("YDR007W",324).
component("YOR095C",905).
component("YER003C",411).
component("YBR196C",244).
component("YGL001C",467).
component("U14_",50).
component("YOL056W",885).
component("YKL152C",681).
component("YDL021W",280).
component("YMR105C",792).
component("YKL127W",675).
component("YEL058W",409).
component("YPR060C",996).
component("YHR072W",557).
component("YJL153C",623).
component("YPL097W",960).
component("YGR185C",521).
component("YGR264C",533).
component("YGR171C",516).
component("YHR011W",547).
component("YDR023W",327).
component("YPL104W",961).
component("YLL018C",708).
component("YPR081C",1003).
component("YBR121C",232).
component("YHR020W",550).
component("YER087W",434).
component("YNL247W",846).
component("YOL033W",880).
component("YGL245W",493).
component("YHR091C",559).
component("YDR341C",375).
component("YOL097C",892).
component("YDR268W",366).
component("YPR047W",995).
component("YLR060W",718).
component("YFL022C",452).
component("YPR033C",993).
component("YHR019C",548).
component("YCR024C",273).
component("YHR019C",549).
component("YPL160W",965).
component("YLR382C",758).
component("YNL073W",831).
component("YDR037W",329).
component("YOR335C",939).
component("YGR094W",508).
component("YOR317W",935).
component("YMR246W",810).
component("YIL009W",575).
component("YER015W",414).
component("YOR142W",913).
component("YGR244C",529).
component("YPR035W",994).
component("U89_",173).
component("YOR241W",930).
component("YMR113W",794).
component("YKL132C",676).
component("YOR339C",940).
component("YMR022W",787).
component("YLR306W",747).
component("YKL210W",691).
component("YGR133W",512).
component("YGL058W",477).
component("YER100W",440).
component("YEL012W",402).
component("YDR177W",356).
component("YDR092W",342).
component("YDR059C",337).
component("YDR054C",335).
component("YDL064W",287).
component("YBR082C",223).
component("YJL101C",614).
component("YOL049W",881).
component("U92_",177).
...
component("YNL220W",844).
component("YOL058W",886).
component("YBR208C",246).
component("YHR074W",558).
component("YMR217W",807).
component("YGR061C",505).
component("YPR145W",1008).
component("YGR124W",511).
component("YOR303W",934).
component("YJR109C",651).
component("YJL130C",619).
component("YGL062W",478).
component("YBR218C",247).
component("YPL231W",978).
component("YNR016C",865).
component("YKL182W",687).
component("YGR037C",501).
component("YOR005C",900).
component("YDL164C",309).
component("YOL010W",877).
component("YPR138C",1007).
component("YPL274W",985).
component("YPL265W",981).
component("YPL134C",963).
component("YPL057C",957).
component("YPL036W",956).
component("YOR348C",944).
component("YOR222W",927).
component("YOR192C",921).
component("YOR171C",916).
component("YOR130C",910).
component("YOR071C",903).
component("YOL156W",899).
component("YOL103W",893).
component("YOL020W",879) :- not remove_orf("YOL020W",879).
component("YNR072W",875).
component("YNR056C",872).
component("YNL318C",860).
component("YNL268W",853).
component("YNL142W",839).
component("YMR272C",816).
component("YMR202W",804).
component("YMR011W",784).
component("YML123C",781).
component("YLR348C",753).
component("YLR260W",740).
component("YLR237W",738).
component("YLR138W",725).
component("YLR100C",722).
component("YLR081W",720).
component("YLL061W",711).
component("YLL043W",710).
component("YKR093W",704).
component("YKR053C",701).
component("YKR039W",700) :- not remove_orf("YKR039W",700).
component("YKL217W",695).
component("YKL120W",674).
component("YKL004W",663).
component("YJR158W",660).
component("YJR152W",658).
component("YJR095W",647).
component("YJR077C",645).
component("YJL219W",633).
component("YJL214W",631).
component("YJL134W",620).
component("YJL129C",618).
component("YIR028W",601).
component("YIL134W",590).
component("YHR096C",562).
component("YHR094C",561).
component("YHR092C",560).
component("YHL036W",543).
component("YHL016C",541).
component("YGR121C",509).
component("YGR055W",503).
component("YGL186C",486).
component("YGL077C",481).
component("YGL008C",468).
component("YFL055W",456).
component("YFL011W",449).
component("YER060W-A",423).
component("YER060W",422).
component("YER056C",421).
component("YER053C",419).
component("YEL069C",410).
component("YEL017C-A",403).
...
component("YDR284C",368).
component("YDR046C",332) :- not remove_orf("YDR046C",332).
component("YDL245C",323).
component("YDL210W",316).
component("YCR032W",275).
...
catalyst(6160,820).
catalyst(3870,420).
catalyst(3620,380) :- not remove_reaction(3620,380).
catalyst(2110,463).
catalyst(2190,463).
catalyst(5550,653).
catalyst(5791,736).
...
catalyst(1960,333).
catalyst(3460,140).
catalyst(3600,692) :- not remove_reaction(3600,692).
catalyst(8000,705).
catalyst(3941,882).
catalyst(3942,882).
catalyst(6890,841).
...
catalyst(8020,991).
catalyst(8020,427).
catalyst(1890,693) :- not remove_reaction(1890,693).
catalyst(3630,693) :- not remove_reaction(3630,693).
catalyst(1890,436) :- not remove_reaction(1890,436).
catalyst(3630,436) :- not remove_reaction(3630,436).
catalyst(3740,350).
catalyst(8231,988).
catalyst(8232,988).
catalyst(8231,951).
...
catalyst(8051,980).
catalyst(8052,980).
catalyst(3590,473) :- not remove_reaction(3590,473).
catalyst(10910,473) :- not remove_reaction(10910,473).
catalyst(4570,514).
catalyst(8181,745).
catalyst(8182,745).
catalyst(8181,630).
...
catalyst(8281,334).
catalyst(8282,334).
catalyst(3610,324) :- not remove_reaction(3610,324).
catalyst(7921,905).
catalyst(7922,905).
catalyst(7841,411).
catalyst(7842,411).
...
catalyst(1210,899).
catalyst(1160,893).
catalyst(801,879) :- not remove_reaction(801,879).
catalyst(802,879) :- not remove_reaction(802,879).
catalyst(811,879) :- not remove_reaction(811,879).
catalyst(812,879) :- not remove_reaction(812,879).
catalyst(831,879) :- not remove_reaction(831,879).
catalyst(832,879) :- not remove_reaction(832,879).
catalyst(901,879) :- not remove_reaction(901,879).
catalyst(902,879) :- not remove_reaction(902,879).
catalyst(941,879) :- not remove_reaction(941,879).
catalyst(942,879) :- not remove_reaction(942,879).
catalyst(1170,875).
catalyst(1180,875).
catalyst(1210,875).
catalyst(700,872).
...
catalyst(650,704).
catalyst(6560,701).
catalyst(761,700) :- not remove_reaction(761,700).
catalyst(762,700) :- not remove_reaction(762,700).
catalyst(771,700) :- not remove_reaction(771,700).
catalyst(772,700) :- not remove_reaction(772,700).
catalyst(781,700) :- not remove_reaction(781,700).
catalyst(782,700) :- not remove_reaction(782,700).
catalyst(791,700) :- not remove_reaction(791,700).
catalyst(792,700) :- not remove_reaction(792,700).
...
catalyst(821,700) :- not remove_reaction(821,700).
catalyst(822,700) :- not remove_reaction(822,700).
catalyst(831,700) :- not remove_reaction(831,700).
catalyst(832,700) :- not remove_reaction(832,700).
catalyst(841,700) :- not remove_reaction(841,700).
catalyst(842,700) :- not remove_reaction(842,700).
catalyst(861,700) :- not remove_reaction(861,700).
catalyst(862,700) :- not remove_reaction(862,700).
catalyst(881,700) :- not remove_reaction(881,700).
catalyst(882,700) :- not remove_reaction(882,700).
catalyst(901,700) :- not remove_reaction(901,700).
catalyst(902,700) :- not remove_reaction(902,700).
catalyst(911,700) :- not remove_reaction(911,700).
catalyst(912,700) :- not remove_reaction(912,700).
catalyst(921,700) :- not remove_reaction(921,700).
catalyst(922,700) :- not remove_reaction(922,700).
catalyst(941,700) :- not remove_reaction(941,700).
catalyst(942,700) :- not remove_reaction(942,700).
catalyst(1191,700) :- not remove_reaction(1191,700).
catalyst(1192,700) :- not remove_reaction(1192,700).
catalyst(390,695).
catalyst(1021,695).
catalyst(1022,695).
catalyst(1521,674).
...
catalyst(6550,370).
catalyst(6690,368).
catalyst(791,332) :- not remove_reaction(791,332).
catalyst(792,332) :- not remove_reaction(792,332).
...
catalyst(841,332) :- not remove_reaction(841,332).
catalyst(842,332) :- not remove_reaction(842,332).
catalyst(861,332) :- not remove_reaction(861,332).
catalyst(862,332) :- not remove_reaction(862,332).
catalyst(901,332) :- not remove_reaction(901,332).
catalyst(902,332) :- not remove_reaction(902,332).
catalyst(1170,323).
catalyst(1180,323).
catalyst(1210,323).
catalyst(690,316).
...
modifiable_enzyme(693).
modifiable_enzyme(436).
modifiable_enzyme(473).
modifiable_enzyme(324).
modifiable_enzyme(879).
