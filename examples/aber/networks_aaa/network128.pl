...
component("YNL280C",699).
component("YLR056W",587).
component("YGR060W",412).
component("YGL012W",383).
component("YKR009C",570).
component("YOL086C",730).
component("YMR303C",669).
component("YMR083W",645).
component("YGL256W",404).
component("YDL168W",250).
component("YBR145W",189).
component("YPL231W",798).
component("U46_",105).
component("YBR149W",190).
component("YJR159W",541).
component("YGL001C",380).
component("YIL094C",480).
component("YHR063C",459).
component("YBR153W",191).
component("YML056C",630).
component("YLR432W",623).
component("YHR216W",473).
component("YAR075W",152).
component("YAR073W",151).
component("YDR127W",279).
component("YJR139C",535).
component("YOL126C",735).
component("YDL078C",231).
component("YKL029C",546).
component("YOR136W",746).
component("YNL037C",674).
component("YDL066W",230).
component("YNL241C",689).
component("YOL059W",728).
component("YDL022W",225).
component("YLR355C",619).
component("YML054C",629).
component("YDL174C",252).
component("YML086C",633).
component("YIL155C",486).
component("YPR191W",832).
component("YOR065W",740).
component("YJL166W",511).
component("YHR001W-A",448).
component("YGR183C",427).
component("YFR033C",376).
component("YDR529C",323).
component("YBL045C",158).
component("Q0105",18).
component("YGR088W",415).
component("YDR256C",294).
component("YKL026C",545).
component("YIR037W",494).
component("YBR244W",202).
component("YJR078W",526).
component("YJR025C",519).
component("YGR255C",439).
component("U108_",22).
component("YBL098W",162).
component("YMR015C",642).
component("YHR007C",449).
component("YDR402C",312).
component("YGL055W",388).
component("YGR175C",424).
component("YJR104C",529).
component("YHR008C",450).
component("YJL026W",495).
component("YIL066C",478).
component("YGR180C",426).
component("YER070W",348).
component("U38_",101).
component("U36_",100).
component("U35_",99).
component("YDL168W",251).
component("YDR158W",287).
component("YBR006W",165).
component("YPL276W",810).
component("YPL275W",809).
component("YOR388C",777).
component("YOR374W",774).
component("YER073W",349).
component("U68_",119).
component("YGL154C",396).
component("U55_",113).
component("YOR323C",766).
component("YMR170C",654).
component("YMR169C",653).
component("U2_",95).
component("YER178W",363).
component("YBR221C",200).
component("YIL125W",484).
component("U52_",110).
component("YBR166C",194).
component("YNL280C",700).
component("YGL012W",384).
component("U57_",114).
component("YKL216W",567).
component("YDR044W",268).
component("YER014W",335).
component("YKR009C",571).
component("YIL160C",488).
component("YGL205W",399).
component("YMR118C",650).
component("YLR164W",600).
component("YLL041C",580).
component("YKL148C",557).
component("YKL141W",555).
component("YJL045W",496).
component("YDR178W",288).
component("YJR051W",521).
component("YEL047C",329).
component("YDL215C",256).
component("YOR375C",775).
component("YDL215C",257).
component("YAL062W",149).
component("U99_",144).
component("YBR035C",175).
component("YMR189W",656).
component("YHR037W",456).
component("YKR080W",575).
component("YER023W",336).
component("YPL023C",781).
component("YGL125W",393).
component("YOR236W",761).
component("YGR204W",431).
component("YLR142W",595).
component("U62_",117).
component("YKL150W",558).
component("YIL043C",475).
component("YHR042W",457).
component("YOR221C",759).
component("YML120C",636).
component("YKL192C",564).
component("YKL055C",548).
component("YER061C",344).
component("YGR234W",434).
component("YFR030W",375).
component("YPL017C",780).
component("YFL018C",367).
component("YER042W",338).
component("YJR137C",534).
component("YPL266W",805).
component("YML110C",635).
component("YBR034C",174).
component("YPL273W",807).
component("YLL062C",583).
component("YDR410C",315).
component("U47_",106).
component("YER091C",355).
component("YJR073C",524).
component("YDL033C",227).
component("YOL096C",731).
component("YLR172C",601).
component("YDR019C",264).
component("YBR176W",195).
component("YDR408C",314).
component("YMR120C",651).
component("YBL013W",153).
component("YKL024C",544).
component("YPR074C",822).
component("YBR117C",185).
component("YLR354C",618).
component("YGR043C",410).
component("YMR108W",648).
component("YCL009C",212).
component("YMR062C",644).
component("YNL071W",677).
component("YNR008W",707).
component("YNL277W",698).
component("YFL017C",366).
component("YPL231W",799).
component("YER061C",345).
component("U86_",134).
component("YPL001W",779).
component("YDR148C",285).
component("YOR377W",776).
component("YGR177C",425).
component("YPL231W",800).
component("YGR147C",420).
component("YDL040C",228).
component("YPL028W",782).
component("YGL017W",385).
component("YPR001W",812).
component("YNR001C",705).
component("YDL182W",253).
component("YDL131W",241).
component("YNL117W",681).
component("YIR031C",492).
component("YOR321W",765).
component("YJR143C",536).
component("YGR199W",430).
component("YDR307W",302).
component("YDL095W",236).
component("YDL093W",235).
component("YAL023C",146).
component("YNL029C",673).
component("YIL085C",479).
component("YMR261C",663).
component("YML100W",634).
component("YBR126C",188).
component("YNL192W",688).
component("YBR038W",177).
component("YBR023C",173).
component("YMR306W",671).
component("YLR342W",616).
component("YGR032W",408).
component("YLR209C",602).
component("U104_",21).
component("YOR209C",757).
component("YMR300C",668).
component("YER055C",340).
component("YDR354W",308) :- not remove_orf("YDR354W",308).
component("YFR047C",377).
component("YJR133W",533).
component("YLR209C",603).
component("YML022W",626).
component("YDR441C",318).
component("YDR399W",310).
component("YPR176C",829).
component("YPL172C",792).
component("YNR041C",713).
component("YMR101C",646).
component("YDL090C",234).
component("YBR003W",164).
component("YBR002C",163).
component("YJL167W",512).
component("YNL256W",692).
component("YDR127W",280).
component("YLR303W",610).
component("YGR012W",406).
component("YJR130C",532).
component("YLR303W",611).
component("YDR035W",266).
component("YBR249C",203).
component("YOL143C",737).
component("YBR256C",205).
component("YHR137W",467).
component("YGL202W",398).
component("YLR027C",584).
component("YKL106W",552).
component("YKL104C",551).
component("YGR019W",407).
component("YLR089C",590).
component("U64_",118).
component("U61_",116).
component("U51_",109).
component("YJR148W",537).
component("YOR184W",752).
component("YNR058W",716).
component("YIL116W",483).
component("YGL253W",403).
component("YFR053C",378).
component("YOL136C",736).
component("YIL107C",481).
component("YMR013C",641).
component("YMR205C",657).
component("YGR240C",435).
component("YDR248C",293).
component("YCR036W",221).
component("YGR194C",429).
component("YCL040W",215).
component("YJR105W",530).
component("U16_",50).
component("U15_",44).
component("U96_",142).
component("YKL001C",542).
component("YDR236C",291).
component("YML070W",632).
component("YFL053W",370).
component("YHL032C",446).
component("YLR133W",592).
component("YDR531W",325).
component("U83_",132).
component("U82_",131).
component("U81_",130).
component("YMR208W",658).
component("YHR025W",455).
component("YOR347C",771).
component("YAL038W",148).
component("YNR012W",708).
component("YPR121W",825).
component("YPL258C",802).
component("YOL055C",724).
component("YPL214C",796).
component("U1_",73).
component("YDR009W",263).
component("YBR020W",171).
component("YNL267W",696).
component("YLR305C",613).
component("YFR019W",373).
component("YDR208W",289).
component("YDR127W",281).
component("U21_",83).
component("U20_",80).
component("YDR147W",284).
component("YDR300C",301).
component("YCR012W",217).
component("U18_",65).
component("U17_",58).
component("U76_",127).
component("YMR220W",660).
component("YER170W",362).
component("YDR226W",290).
component("YKL067W",550).
component("YOL055C",725).
component("YDR454C",319).
component("YJR057W",522).
component("YOL061W",729).
component("YKL181W",560).
component("YHL011C",444).
component("YER099C",357).
component("YBL068W",161).
component("YOR143C",748).
component("YNL256W",693).
component("YLR328W",614).
component("YBR018C",167).
component("YBR018C",168).
component("YGR007W",405).
component("YLR328W",615).
component("YKR002W",569).
component("YDL103C",239).
component("YJR010W",518).
component("YGL130W",394).
component("YDR530C",324).
component("YCL050C",216).
component("YPR190C",831).
component("YPR187W",830).
component("YPR110C",824).
component("YPR010C",815).
component("YOR341W",770).
component("YOR340C",769).
component("YOR224C",760).
component("YOR210W",758).
component("YOR207C",755).
component("YOR151C",749).
component("YOR116C",743).
component("YOL005C",718).
component("YNR003C",706).
component("YNL248C",691).
component("YNL151C",685).
component("YNL113W",680).
component("YKL144C",556).
component("YJR063W",523).
component("YJL148W",508).
component("YJL140W",507).
component("YIL021W",474).
component("YHR143W-A",468).
component("YGL070C",391).
component("YFL036W",369).
component("YDR404C",313).
component("YDR156W",286).
component("YDR045C",269).
component("YDL150W",248).
component("YDL140C",243).
component("YBR154C",193).
component("YPR175W",828).
component("YPL167C",791).
component("YOR330C",767).
component("YOL115W",734).
component("YNL299W",702).
component("YNL262W",695).
component("YNL102W",679).
component("YJR043C",520).
component("YJR006W",517).
component("YJL090C",500).
component("YIL139C",485).
component("YEL055C",330).
component("YDR419W",316).
component("YDR121W",278).
component("YDL102W",238).
component("YCR014C",218).
component("YBR278W",207).
component("YBL035C",155).
component("YKL035W",547).
component("YHL012W",445).
component("YHR123W",466).
component("YBR243C",201).
component("YDL142C",247).
component("YPL148C",789).
component("YER026C",337).
component("YCL004W",211).
component("YGR286C",443).
component("YJL068C",497).
component("YDR058C",273).
component("YNR034W",712).
component("YHR163W",470).
component("YGR248W",437).
component("YCR073W-A",222).
component("YDL086W",233).
component("YOL011W",720).
component("YMR008C",639).
component("YMR006C",638).
component("U101_",19).
component("YBL015W",154).
component("YJL068C",498).
component("YPL072W",785).
component("YOR124C",744).
component("YNL186W",687).
component("YMR304W",670).
component("YMR223W",661).
component("YKR098C",578).
component("YJL197W",513).
component("YIL156W",487).
component("YFR010W",372).
component("YER151C",360).
component("YER144C",359).
component("YER098W",356).
component("YDR069C",274).
component("YDL122W",240).
component("YBR058C",178).
component("YBL067C",160).
component("YDR272W",297).
component("U84_",133).
component("YLR377C",621).
component("YDR074W",275).
component("YPL179W",793).
component("YNR032W",710).
component("YML057W",631).
component("YML016C",625).
component("YLR433C",624).
component("YGR123C",418).
component("YER133W",358).
component("YER089C",353).
component("YDR436W",317).
component("YDR075W",276).
component("YDL188C",254).
...
component("YHR215W",472).
component("YDL024C",226).
component("YBR093C",183).
component("YBR092C",182).
component("YAR071W",150).
component("YIL053W",477).
component("YER062C",346).
component("YHR046C",458).
component("YGR208W",433).
component("YPL228W",797).
component("YMR180C",655).
component("YDL236W",259).
component("YJL155C",510).
component("YPR073C",821).
component("YOR208W",756).
component("YNL053W",676).
component("YMR036C",643).
component("YIR026C",489).
component("YIL113W",482).
component("YFR028C",374).
...
component("U25_",92).
component("U24_",91).
component("YPL268W",806).
component("YOR360C",773).
component("YGL248W",402).
component("YKR031C",572).
component("YPL206C",794).
component("YLR286C",608).
component("YJR153W",539).
component("YOR190W",753).
component("YLR300W",609).
component("YGR282C",442).
component("YDR261C",295).
component("YDR400W",311).
component("U23_",90).
component("YML035C",627).
component("YJL070C",499).
component("YBR284W",208).
component("U102_",20).
component("YNL045W",675).
component("YLR160C",599).
component("YLR158C",598).
component("YLR157C",597).
component("YLR155C",596).
component("YDR321W",303).
component("YGL037C",387).
component("YMR293C",667).
component("YDR242W",292).
component("YBR208C",197).
component("YMR281W",666).
component("U53_",111).
component("YIR027C",490).
component("YPL111W",788).
component("YIR032C",493).
component("YIR029W",491).
component("YPR062W",819).
component("YMR120C",652).
component("YLR028C",585).
component("YHR144C",469).
component("YGR267C",441).
component("YNL141W",682).
component("YBR153W",192).
component("YDL238C",260).
component("YNL141W",683).
component("YLR245C",606).
component("YML035C",628).
component("YJL126W",503).
component("U44_",104).
component("YDL100C",237).
component("U87_",135).
component("YMR267W",664).
component("YBR011C",166).
component("YBR111C",184).
component("YBR252W",204).
component("YCL030C",214).
component("YER005W",334).
component("YIL048W",476).
component("YER166W",361).
component("YDR093W",277).
component("YAL026C",147).
component("YLR231C",604).
component("U88_",136).
component("YLR134W",593).
component("YLR044C",586).
component("YGR087C",414).
component("YDR380W",309).
component("YDL080C",232).
component("U98_",143).
component("YMR250W",662).
component("YKL184W",563).
component("YNR043W",714).
component("U93_",141).
component("YDR047W",271).
component("U54_",112).
component("YKL211C",565) :- not remove_orf("YKL211C",565).
component("YKR097W",577).
component("YOL052C",723).
component("YNL169C",686).
component("YGR170W",422).
component("YKL060C",549).
component("YNL256W",694).
component("YDR294C",298).
component("YEL046C",328).
component("YNR033W",711).
component("YPR006C",814).
component("YER065C",347).
component("YKL211C",566) :- not remove_orf("YKL211C",566).
component("YER090W",566) :- not remove_orf("YER090W",566).
component("YER090W",354) :- not remove_orf("YER090W",354).
component("YDR127W",282).
component("YPL281C",811).
component("YOR393W",778).
component("YMR323W",672).
component("YHR174W",471).
component("YGR254W",438).
component("YPL262W",803).
component("YGL026C",386) :- not remove_orf("YGL026C",386).
component("YGR155W",421).
component("YLR304C",612).
component("YJL200C",514).
component("YNL316C",703).
component("YKL182W",561).
component("YPL212C",795).
component("YNL292W",701).
component("YGL063W",390).
component("YFL001W",364).
component("YOR278W",763).
component("YPR002W",813).
component("YDR127W",283).
component("YGL148W",395).
component("YER086W",351).
component("YLR359W",620).
component("YAL012W",145).
component("YFR055W",379).
component("YOR176W",751).
component("YJL121C",502).
component("YBR019C",169).
component("YBR019C",170).
component("YDR050C",272).
component("YDR007W",262) :- not remove_orf("YDR007W",262).
component("YOR095C",742).
component("YER003C",333).
component("YBR196C",196).
component("YGL001C",381).
component("U14_",37).
component("YOL056W",726).
component("YKL152C",559).
component("YDL021W",224).
component("YMR105C",647).
component("YKL127W",553).
component("YEL058W",331).
component("YPR060C",818).
component("YHR072W",460).
component("YJL153C",509).
component("YPL097W",786).
component("YGR185C",428).
component("YGR264C",440).
component("YGR171C",423).
component("YHR011W",451).
component("YDR023W",265).
component("YPL104W",787).
component("YLL018C",579).
component("YPR081C",823).
component("YBR121C",186).
component("YHR020W",454).
component("YER087W",352).
component("YNL247W",690).
component("YOL033W",722).
component("YHR091C",462).
component("YDR341C",304).
component("YOL097C",732).
component("YDR268W",296).
component("YPR047W",817).
component("YLR060W",588).
component("YFL022C",368).
component("YPR033C",816).
component("YHR019C",452).
component("YHR019C",453).
component("YPL160W",790).
component("YLR382C",622).
component("YNL073W",678).
component("YDR037W",267).
component("YOR335C",768).
component("YGR094W",416).
component("YOR142W",747).
component("YGR244C",436).
component("U89_",137).
component("YOR241W",762).
component("YMR113W",649).
component("YKL132C",554).
component("YJL101C",501).
component("U92_",140).
component("YGL234W",400).
component("U91_",139).
component("U90_",138).
...
component("YJR103W",528).
component("YBL039C",156).
component("YGR204W",432).
component("YBR084W",181).
component("YOL058W",727).
component("YBR208C",198).
component("YHR074W",461).
component("YMR217W",659).
component("YGR061C",413).
component("YPR145W",827).
component("YGR124W",419).
component("YOR303W",764).
component("YJR109C",531).
component("YJL130C",505).
component("YGL062W",389).
component("YBR218C",199).
component("YPL231W",801).
component("YNR016C",709).
component("YKL182W",562).
component("YGR037C",409).
component("YOR005C",739).
component("YDL164C",249).
component("YOL010W",719).
component("YPR138C",826).
component("YPL274W",808).
component("YPL265W",804).
component("YPL057C",784).
component("YPL036W",783).
component("YOR348C",772).
component("YOR192C",754).
component("YOR171C",750).
component("YOR130C",745).
component("YOR071C",741).
component("YOL156W",738).
component("YOL103W",733).
component("YOL020W",721) :- not remove_orf("YOL020W",721).
component("YNR072W",717).
component("YNR056C",715).
component("YNL318C",704).
component("YNL268W",697).
component("YNL142W",684).
component("YMR272C",665).
component("YMR011W",640).
component("YML123C",637).
component("YLR348C",617).
component("YLR260W",607).
component("YLR237W",605).
component("YLR138W",594).
component("YLR100C",591).
component("YLR081W",589).
component("YLL061W",582).
component("YLL043W",581).
component("YKR093W",576).
component("YKR053C",574).
component("YKR039W",573) :- not remove_orf("YKR039W",573).
component("YKL217W",568).
component("YKL004W",543).
component("YJR158W",540).
component("YJR152W",538).
component("YJR095W",527).
component("YJR077C",525).
component("YJL219W",516).
component("YJL214W",515).
component("YJL134W",506).
component("YJL129C",504).
component("YHR096C",465).
component("YHR094C",464).
component("YHR092C",463).
component("YHL036W",447).
component("YGR121C",417).
component("YGR055W",411).
component("YGL186C",397).
component("YGL077C",392).
component("YGL008C",382).
component("YFL055W",371).
component("YFL011W",365).
component("YER060W-A",343).
component("YER060W",342).
component("YER056C",341).
component("YER053C",339).
component("YEL069C",332).
component("YEL017C-A",327).
component("YDR536W",326).
component("YDR508C",322).
component("YDR503C",321).
component("YDR497C",320).
component("YDR345C",307).
component("YDR343C",306).
component("YDR342C",305).
component("YDR297W",300).
component("YDR294C",299).
component("YDR046C",270) :- not remove_orf("YDR046C",270).
component("YDL245C",261).
component("YDL210W",255).
component("YCR032W",220).
component("YCR024C-A",219).
...
catalyst(1960,271).
catalyst(3460,112).
catalyst(3600,565) :- not remove_reaction(3600,565).
catalyst(8000,577).
catalyst(3941,723).
catalyst(3942,723).
catalyst(6890,686).
...
catalyst(8020,814).
catalyst(8020,347).
catalyst(1890,566) :- not remove_reaction(1890,566).
catalyst(3630,566) :- not remove_reaction(3630,566).
...
catalyst(8051,803).
catalyst(8052,803).
catalyst(3590,386) :- not remove_reaction(3590,386).
catalyst(10910,386) :- not remove_reaction(10910,386).
catalyst(4570,421).
catalyst(8181,612).
catalyst(8182,612).
catalyst(8181,514).
...
catalyst(8281,272).
catalyst(8282,272).
catalyst(3610,262) :- not remove_reaction(3610,262).
catalyst(7921,742).
catalyst(7922,742).
catalyst(7841,333).
catalyst(7842,333).
...
catalyst(1210,738).
catalyst(1160,733).
catalyst(801,721) :- not remove_reaction(801,721).
catalyst(802,721) :- not remove_reaction(802,721).
catalyst(811,721) :- not remove_reaction(811,721).
catalyst(812,721) :- not remove_reaction(812,721).
catalyst(831,721) :- not remove_reaction(831,721).
catalyst(832,721) :- not remove_reaction(832,721).
catalyst(901,721) :- not remove_reaction(901,721).
catalyst(902,721) :- not remove_reaction(902,721).
catalyst(941,721) :- not remove_reaction(941,721).
catalyst(942,721) :- not remove_reaction(942,721).
catalyst(1210,717).
catalyst(700,715).
catalyst(1200,704).
catalyst(761,697).
...
catalyst(640,576).
catalyst(6560,574).
catalyst(761,573) :- not remove_reaction(761,573).
catalyst(762,573) :- not remove_reaction(762,573).
...
catalyst(791,573) :- not remove_reaction(791,573).
catalyst(792,573) :- not remove_reaction(792,573).
...
catalyst(821,573) :- not remove_reaction(821,573).
catalyst(822,573) :- not remove_reaction(822,573).
...
catalyst(861,573) :- not remove_reaction(861,573).
catalyst(862,573) :- not remove_reaction(862,573).
...
catalyst(911,573) :- not remove_reaction(911,573).
catalyst(912,573) :- not remove_reaction(912,573).
catalyst(941,573) :- not remove_reaction(941,573).
catalyst(942,573) :- not remove_reaction(942,573).
...
catalyst(6650,300).
catalyst(6550,299).
catalyst(791,270) :- not remove_reaction(791,270).
catalyst(792,270) :- not remove_reaction(792,270).
catalyst(801,270) :- not remove_reaction(801,270).
catalyst(802,270) :- not remove_reaction(802,270).
catalyst(811,270) :- not remove_reaction(811,270).
catalyst(812,270) :- not remove_reaction(812,270).
catalyst(831,270) :- not remove_reaction(831,270).
catalyst(832,270) :- not remove_reaction(832,270).
catalyst(841,270) :- not remove_reaction(841,270).
catalyst(842,270) :- not remove_reaction(842,270).
catalyst(861,270) :- not remove_reaction(861,270).
catalyst(862,270) :- not remove_reaction(862,270).
catalyst(901,270) :- not remove_reaction(901,270).
catalyst(902,270) :- not remove_reaction(902,270).
catalyst(1210,261).
catalyst(730,255).
catalyst(431,220).
catalyst(432,220).
...
modifiable_enzyme(386).
modifiable_enzyme(262).
modifiable_enzyme(721).
