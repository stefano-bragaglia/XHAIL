...
component("YNL280C",896).
component("YLR056W",755).
component("YGR060W",530).
component("YGL012W",495).
component("YKR009C",735).
component("YOL086C",931).
component("YMR303C",862).
component("YMR083W",831).
component("YGL256W",522).
component("YDL168W",332).
component("YBR145W",254).
component("YPL231W",1019).
component("YBR265W",273).
component("U46_",146).
component("YBR149W",255).
component("YBR149W",256).
component("YJR159W",698).
component("YGL001C",492).
component("YIL094C",618).
component("YHR063C",585).
component("U45_",145).
component("YBR153W",257).
component("YML056C",812).
component("YLR432W",801).
component("YHR216W",607).
component("YAR075W",209).
component("YAR073W",208).
component("YCL030C",283).
component("YDR127W",370).
component("YJR139C",692).
component("YML075C",815).
component("YLR450W",804).
component("YOL126C",937).
component("YKL085W",708).
component("YDL078C",312).
component("YKL029C",703).
component("YOR136W",955).
component("YNL037C",867).
component("YDL066W",310).
component("YHR183W",602).
component("YGR256W",561).
component("YNL241C",886).
component("YOL059W",928).
component("YDL022W",303).
component("YLR355C",796).
component("YIL074C",615).
component("YER081W",457).
component("YML054C",811).
component("YDL174C",335).
component("YML086C",816).
component("YIL155C",626).
component("YPR191W",1060).
component("YOR065W",945).
component("YJL166W",662).
component("YHR001W-A",573).
component("YGR183C",547).
component("YFR033C",488).
component("YDR529C",420).
component("YBL045C",216).
component("Q0105",18).
component("YGR088W",533).
component("YDR256C",387).
component("YKL026C",702).
component("YIR037W",640).
component("YBR244W",269).
component("YJR078W",683).
component("U58_",158).
component("YJR025C",675).
component("U107_",26).
component("YGR255C",560).
component("U108_",27).
component("YBL098W",220).
component("YMR015C",827).
component("YHR007C",574).
component("YDR402C",408).
component("YGL055W",502).
component("YGR175C",544).
component("YJR104C",686).
component("YHR008C",575).
component("YJL026W",643).
component("YIL066C",614).
component("YGR180C",546).
component("YER070W",454).
component("U38_",138).
component("U36_",137).
component("U35_",136).
component("YDL168W",333).
component("YDR158W",378).
component("YBR006W",225).
component("YPL276W",1031).
component("YPL275W",1030).
component("YOR388C",993).
component("YPL061W",1001).
component("YOR374W",990).
component("YER073W",455).
component("U68_",166).
component("YGL154C",511).
component("YBR115C",248).
component("U55_",155).
component("YER069W",452).
component("YOR323C",980).
component("YMR170C",842).
component("YMR169C",841).
component("U2_",130).
component("YER178W",471).
component("YBR221C",267).
component("YIL125W",623).
component("U52_",152).
component("YBR166C",260).
component("YNL280C",897).
component("YGL012W",496).
component("YKL182W",722).
component("U57_",157).
component("YKL216W",732).
component("YDR044W",353).
component("YER014W",436).
component("YKR009C",736).
component("YIL160C",628).
component("YGL205W",516).
component("YMR118C",836).
component("YLR164W",772).
component("YLL041C",747).
component("YKL148C",716).
component("YKL141W",714).
component("YJL045W",644).
component("YDR178W",380).
component("YJR051W",678).
component("YEL047C",430).
component("YDL171C",334).
component("YDL215C",339).
component("YOR375C",991).
component("YDL215C",340).
component("YAL062W",204).
component("U99_",197).
component("YBR035C",235).
component("YMR189W",844).
component("U56_",156).
component("YNR050C",912).
component("YHR037W",581).
component("YKR080W",740).
component("YER023W",438).
component("YPL023C",997).
component("YGL125W",508).
component("YOR236W",972).
component("YGR204W",552).
component("YLR142W",765).
component("U63_",163).
component("U62_",162).
component("YOR356W",988).
component("YHR068W",586).
component("YKL150W",717).
component("YIL043C",611).
component("YHR042W",582).
component("YOR221C",969).
component("YML120C",820).
component("YKL192C",726).
component("YKL055C",705).
component("YER061C",448).
component("YBR046C",238).
component("YMR145C",839).
component("YML120C",821).
component("YKL192C",727).
component("YDL085W",314).
component("YGR234W",555).
component("YFR030W",487).
component("YPL017C",996).
component("YFL018C",476).
component("YPL091W",1003).
component("YDR353W",402).
component("YER042W",440).
component("YPR167C",1054).
component("YJR137C",691).
component("YNL052W",869).
component("YMR256C",853).
component("YLR395C",800).
component("YLR038C",753).
component("YIL111W",620).
component("YHR051W",584).
component("YGL191W",514).
component("YGL187C",513).
component("YDL067C",311).
component("Q0275",20).
component("Q0250",19).
component("YPL266W",1026).
component("YML110C",819).
component("YBR034C",234).
component("YPL273W",1028).
component("YLL062C",750).
component("YDR410C",411).
component("YOL096C",932).
component("U47_",147).
component("YER091C",462).
component("YJR073C",681).
component("YGR157W",541).
component("YDR120C",368).
component("YML008C",805).
component("YDL033C",305).
component("YOL096C",933).
component("YLR172C",773).
component("YLR058C",756).
component("YDR019C",349).
component("YBR176W",261).
component("YDR408C",410).
component("YMR120C",837).
component("YBL013W",210).
component("YJL130C",654).
component("YKL024C",701).
component("YPR074C",1046).
component("YBR117C",249).
component("YLR354C",795).
component("YGR043C",528).
component("YMR108W",834).
component("YCL009C",281).
component("YMR062C",830).
component("YNL071W",871).
component("YNR008W",904).
component("YIL160C",629).
component("YNL277W",895).
component("YDR232W",383).
component("YFL017C",475).
component("YPL231W",1020).
component("YER061C",449).
component("U86_",185).
component("YPL001W",995).
component("YMR296C",860).
component("YDR062W",361).
component("YDL052C",308).
component("U8_",189).
component("YDR148C",376).
component("YAR035W",206).
component("YOR377W",992).
component("YGR177C",545).
component("YPL231W",1021).
component("YGR147C",539).
component("YDL040C",306).
component("YPL028W",998).
component("YLR195C",774).
component("YGL017W",497).
component("YPR001W",1033).
component("YNR001C",902).
component("YCR005C",292).
component("YNL104C",874).
component("YDL182W",336).
component("YDL131W",323).
component("YNL117W",876).
component("YIR031C",638).
component("YOR321W",979).
component("YJR143C",693).
component("YGR199W",550).
component("YDR307W",396).
component("YDL095W",318).
component("YDL093W",317).
component("YAL023C",200).
component("YLR258W",780).
component("YFR015C",483).
component("YOR103C",949).
component("YOR085W",947).
component("YMR149W",840).
component("YML019W",807).
component("YJL002C",641).
component("YEL002C",424).
component("YDL232W",342).
component("YCL043C",287).
component("YNL029C",866).
component("YIL085C",617).
component("YMR261C",854).
component("YML100W",817).
component("YBR126C",253).
component("YNL192W",884).
component("YBR038W",237).
component("YBR023C",233).
component("YMR306W",864).
component("YLR342W",793).
component("YGR032W",526).
component("YPR183W",1057).
component("YLR209C",775).
component("U104_",24).
component("U103_",23).
component("YMR271C",856).
component("YML106W",818).
component("YOR209C",967).
component("YMR300C",861).
component("YER055C",444).
component("YDR354W",403) :- not remove_orf("YDR354W",403).
component("YFR047C",489).
component("YJR133W",690).
component("YLR209C",776).
component("YML022W",808).
component("YDR441C",414).
component("YDR399W",406).
component("YHR128W",596).
component("YPR176C",1056).
component("YPL172C",1011).
component("YNR041C",910).
component("YMR101C",832).
component("YDL090C",316).
component("YBR003W",224).
component("YBR002C",223).
component("YJL167W",663).
component("YJL167W",664).
component("YNL256W",889).
component("YPR069C",1043).
component("YDR127W",371).
component("YLR146C",766).
component("YHR068W",587).
component("YLR303W",784).
component("YGR012W",524).
component("YJR130C",689).
component("YLR303W",785).
component("YDR035W",351).
component("YBR249C",270).
component("YOR274W",975).
component("YOL143C",940).
component("YBR256C",272).
component("YHR137W",597).
component("YGL202W",515).
component("YLR027C",751).
component("YKL106W",710).
component("YOL140W",939).
component("YLR438W",803).
component("YKL104C",709).
component("YGR019W",525).
component("YLR089C",760).
component("YDR111C",367).
component("U64_",164).
component("U61_",161).
component("U51_",151).
component("YJR148W",694).
component("YHR208W",605).
component("YFL030W",478).
component("YOR184W",961).
component("YNR058W",915).
component("YIL116W",622).
component("YGL253W",521).
component("YFR053C",490).
component("YOL136C",938).
component("YIL107C",619).
component("YMR013C",826).
component("YMR205C",846).
component("YGR240C",556).
component("YDR248C",386).
component("YCR036W",298).
component("YGR194C",549).
component("YCL040W",286).
component("YJR105W",687).
component("U16_",71).
component("U15_",62).
component("YPL188W",1013).
component("YJR049C",677).
component("YEL041W",428).
component("U96_",195).
component("YKL001C",699).
component("YDR236C",384).
component("YML070W",814).
component("YFL053W",480).
component("YHL032C",571).
component("YLR133W",762).
component("YDR531W",422).
component("U83_",182).
component("U82_",181).
component("U81_",180).
component("YMR208W",847).
component("YPL203W",1014).
component("YOR061W",944).
component("YKL166C",719).
component("YJL164C",661).
component("YIL035C",610).
component("YHR205W",604).
component("YHR102W",594).
component("YGL019W",498).
component("YHR025W",580).
component("YOR347C",986).
component("YAL038W",202).
component("YNR012W",905).
component("YPR121W",1051).
component("YPL258C",1023).
component("YOL055C",924).
component("YPL214C",1017).
component("U1_",102).
component("YDR009W",348).
component("YBR020W",231).
component("YNL267W",893).
component("YLR305C",787).
component("YFR019W",484).
component("YDR208W",381).
component("YDR127W",372).
component("U21_",116).
component("U20_",111).
component("YDR147W",375).
component("YDR300C",395).
component("YCR012W",293).
component("YER052C",442).
component("YER069W",453).
component("U19_",101).
component("U18_",91).
component("U17_",81).
component("U76_",175).
component("YMR220W",849).
component("YER170W",470).
component("YDR226W",382).
component("YKL067W",707).
component("YOL055C",925).
component("YDR454C",415).
component("YJR057W",679).
component("YOL061W",929).
component("YKL181W",721).
component("YHL011C",568).
component("YER099C",464).
component("YBL068W",219).
component("YOR143C",957).
component("YNL256W",890).
component("YLR328W",791).
component("YBR018C",227).
component("YBR018C",228).
component("YGR007W",523).
component("YGR202C",551).
component("YLR328W",792).
component("YKR002W",734).
component("U80_",179).
component("YDL103C",321).
component("U94_",194).
component("YJR010W",672).
component("YCL050C",288).
component("YGL130W",509).
component("YDR530C",421).
component("YCL050C",289).
component("YPR190C",1059).
component("YPR187W",1058).
component("YPR110C",1049).
component("YPR010C",1036).
component("YOR341W",985).
component("YOR340C",984).
component("YOR224C",971).
component("YOR210W",968).
component("YOR207C",965).
component("YOR151C",958).
component("YOR116C",950).
component("YOL005C",917).
component("YNR003C",903).
component("YNL248C",888).
component("YNL151C",881).
component("YNL113W",875).
component("YKL144C",715).
component("YJR063W",680).
component("YJL148W",658).
component("YJL140W",657).
component("YIL021W",609).
component("YHR143W-A",598).
component("YGL070C",506).
component("YFL036W",479).
component("YDR404C",409).
component("YDR156W",377).
component("YDR045C",354).
component("YDL150W",330).
component("YDL140C",325).
component("YBR154C",259).
component("YPR175W",1055).
component("YPL167C",1010).
component("YOR330C",981).
component("YOL115W",936).
component("YNL299W",899).
component("YNL262W",892).
component("YNL102W",873).
component("YJR043C",676).
component("YJR006W",671).
component("YJL090C",648).
component("YIL139C",625).
component("YEL055C",431).
component("YDR419W",412).
component("YDR121W",369).
component("YDL102W",320).
component("YCR014C",294).
component("YBR278W",275).
component("YBL035C",213).
component("YKL035W",704).
component("YHL012W",569).
component("YHR123W",595).
component("YPR113W",1050).
component("YBR243C",268).
component("YNL130C",877).
component("YDL142C",329).
component("YPL148C",1008).
component("YER026C",439).
component("YCL004W",280).
component("YOR251C",974).
component("YGR286C",565).
component("YJL068C",645).
component("YDR058C",359).
component("YNR034W",909).
component("YHR163W",600).
component("YGR248W",558).
component("YCR073W-A",300).
component("YDL086W",315).
component("YOL011W",919).
component("YMR008C",824).
component("YMR006C",823).
component("U105_",25).
component("U101_",21).
component("YBL015W",211).
component("YJL068C",646).
component("YPL072W",1002).
component("YOR124C",951).
component("YNL186W",883).
component("YMR304W",863).
component("YMR223W",850).
component("YKR098C",744).
component("YJL197W",665).
component("YIL156W",627).
component("YFR010W",482).
component("YER151C",468).
component("YER144C",467).
component("YER098W",463).
component("YDR069C",362).
component("YDL122W",322).
component("YBR058C",239).
component("YBL067C",218).
component("YJR019C",674).
component("YDR272W",390).
component("U84_",183).
component("YDR481C",416).
component("YLR377C",798).
component("YDR074W",363).
component("YFR025C",485).
component("YPL179W",1012).
component("YNR032W",907).
component("YML057W",813).
component("YML016C",806).
component("YLR433C",802).
component("YGR123C",536).
component("YER133W",466).
component("YER089C",460).
component("YDR436W",413).
component("YDR075W",364).
component("YDL188C",337).
component("YDL134C",324).
component("YDL047W",307).
component("YDL006W",301).
component("YBR125C",252).
component("YBL056W",217).
component("YPR073C",1044).
component("YHR215W",606).
component("YDL024C",304).
component("YBR093C",246).
component("YBR092C",245).
component("YAR071W",207).
component("YIL053W",613).
component("YER062C",450).
component("YHR046C",583).
component("U9_",198).
component("YGR208W",554).
component("YPL228W",1018).
component("YMR180C",843).
component("YDL236W",343).
component("YJL155C",660).
component("YPR073C",1045).
component("YOR208W",966).
component("YNL053W",870).
component("YMR036C",829).
component("YIR026C",634).
component("YIL113W",621).
component("YFR028C",486).
component("YER075C",456).
component("YDL230W",341).
component("YBR276C",274).
component("U34_",135).
component("U33_",134).
component("U32_",133).
component("U31_",132).
...
component("U25_",127).
component("U24_",126).
component("YOL064C",930).
component("YPL268W",1027).
component("YOR360C",989).
component("YGL248W",520).
component("YKR031C",737).
component("YPL206C",1015).
component("YGL027C",500).
component("YLR286C",782).
component("YJR153W",696).
component("YJL221C",670).
component("YJL216C",668).
component("YIL172C",633).
component("YGR292W",567).
component("YGR287C",566).
component("YBR299W",279).
component("YBR184W",262).
component("YIL162W",630).
component("YPR026W",1037).
component("YDR001C",346).
component("YBR001C",222).
component("YOR190W",963).
component("YLR300W",783).
component("YGR282C",564).
component("YDR261C",388).
component("YDR400W",407).
component("U23_",125).
component("YML035C",809).
component("YJL070C",647).
component("YBR284W",276).
component("U102_",22).
component("YER043C",441).
component("YNL045W",868).
component("YLR160C",771).
component("YLR158C",770).
component("YLR157C",769).
component("YLR155C",768).
component("YDR321W",397).
component("YGL037C",501).
component("U43_",143).
component("U42_",142).
component("YMR293C",859).
component("YDR242W",385).
component("YLR308W",790).
component("YLR307W",789).
component("YBR208C",264).
component("YMR281W",858).
component("U53_",153).
component("YIR027C",635).
component("YPL111W",1006).
component("YIR032C",639).
component("YIR029W",637).
component("YPR062W",1042).
component("YMR120C",838).
component("YLR028C",752).
component("YHR144C",599).
component("YGR267C",563).
component("YCL030C",284).
component("YNL141W",878).
component("YBL033C",212).
component("YBR153W",258).
component("YDL238C",344).
component("YNL141W",879).
component("YLR245C",779).
component("YML035C",810).
component("YBR084W",243).
component("YJL126W",652).
component("U44_",144).
component("YDL100C",319).
component("U87_",186).
component("U40_",140).
component("YMR267W",855).
component("YBR011C",226).
component("YHR201C",603).
component("YBR111C",247).
component("YBR252W",271).
component("YCL030C",285).
component("YPR080W",1047).
component("YOR187W",962).
component("YOR133W",954).
component("YLR069C",758).
component("YKR084C",741).
component("YKL173W",720).
component("YJL102W",650).
component("YDR385W",405).
component("YBR118W",250).
component("YER005W",435).
component("YLL001W",745).
component("YIL048W",612).
component("YER166W",469).
component("YDR093W",366).
component("YAL026C",201).
component("YBL099W",221).
component("U60_",160).
component("YLR231C",777).
component("U88_",187).
component("YLR134W",763).
component("YLR044C",754).
component("YGR087C",532).
component("YDR380W",404).
component("YDL080C",313).
component("U98_",196).
component("YMR250W",852).
component("YKL184W",725).
component("YOR128C",952).
component("YEL021W",427).
component("YNR043W",911).
component("U93_",193).
component("YDR047W",356).
component("U54_",154).
component("YKL211C",730) :- not remove_orf("YKL211C",730).
component("YKR097W",743).
component("YOL052C",923).
component("YNL169C",882).
component("YGR170W",542).
component("YKL060C",706).
component("YNL256W",891).
component("YDR294C",392).
component("YEL046C",429).
component("YNR033W",908).
component("YPR006C",1035).
component("YER065C",451).
component("YKL211C",731) :- not remove_orf("YKL211C",731).
component("YER090W",731) :- not remove_orf("YER090W",731).
component("YER090W",461) :- not remove_orf("YER090W",461).
component("YDR127W",373).
component("YPL281C",1032).
component("YOR393W",994).
component("YMR323W",865).
component("YHR174W",601).
component("YGR254W",559).
component("YPL262W",1024).
component("YGL026C",499) :- not remove_orf("YGL026C",499).
component("YGR155W",540).
component("YLR304C",786).
component("YJL200C",666).
component("YNL316C",900).
component("YKL182W",723).
component("YPL212C",1016).
component("YNL292W",898).
component("YGL063W",505).
component("YFL001W",473).
component("YOR278W",976).
component("YPR002W",1034).
component("U49_",148).
component("YJR016C",673).
component("YCR053W",299).
component("YDR127W",374).
component("YGL148W",510).
component("YIL168W",632).
component("YIL167W",631).
component("YCL064C",290).
component("YER086W",458).
component("YCL064C",291).
component("YLR359W",797).
component("YAL012W",199).
component("YFR055W",491).
component("YJL005W",642).
component("YOR176W",960).
component("YJL121C",651).
component("YBR019C",229).
component("YBR019C",230).
component("YDR050C",357).
component("YDR007W",347) :- not remove_orf("YDR007W",347).
component("YOR095C",948).
component("YER003C",434).
component("YBR196C",263).
component("YGL001C",493).
component("U14_",54).
component("YOL056W",926).
component("YKL152C",718).
component("YDL021W",302).
component("YMR105C",833).
component("YKL127W",712).
component("YEL058W",432).
component("YPR060C",1041).
component("YHR072W",588).
component("YJL153C",659).
component("YPL097W",1004).
component("YGR185C",548).
component("YGR264C",562).
component("YGR171C",543).
component("YHR011W",576).
component("YDR023W",350).
component("YPL104W",1005).
component("YLL018C",746).
component("YPR081C",1048).
component("YBR121C",251).
component("YHR020W",579).
component("YER087W",459).
component("YNL247W",887).
component("YOL033W",921).
component("YGL245W",519).
component("YHR091C",590).
component("YDR341C",398).
component("YOL097C",934).
component("YDR268W",389).
component("YPR047W",1040).
component("YLR060W",757).
component("YFL022C",477).
component("YPR033C",1038).
component("YHR019C",577).
component("YCR024C",295).
component("YHR019C",578).
component("YKL194C",728).
component("YIL078W",616).
component("YPL160W",1009).
component("YLR382C",799).
component("YNL073W",872).
component("YDR037W",352).
component("YOR335C",982).
component("YGR094W",534).
component("YLR153C",767).
component("YAL054C",203).
component("YOR317W",978).
component("YMR246W",851).
component("YIL009W",608).
component("YER015W",437).
component("YOR142W",956).
component("YGR244C",557).
component("YPR035W",1039).
component("U89_",188).
component("YOR241W",973).
component("YMR113W",835).
component("YKL132C",713).
component("YOR339C",983).
component("YMR022W",828).
component("YLR306W",788).
component("YKL210W",729).
component("YGR133W",538).
component("YGL058W",503).
component("YER100W",465).
component("YEL012W",425).
component("YDR177W",379).
component("YDR092W",365).
component("YDR059C",360).
component("YDR054C",358).
component("YDL064W",309).
component("YBR082C",242).
component("YJL101C",649).
component("YOL049W",922).
component("U92_",192).
component("YAR015W",205).
component("YGL234W",517).
component("YER183C",472).
component("U91_",191).
component("U90_",190).
component("YNR057C",914).
component("YDL141W",326).
component("YDL141W",327).
component("YGL234W",518).
component("YDL141W",328).
component("YJR103W",685).
component("YBL039C",214).
component("YGR204W",553).
component("YBR084W",244).
component("YNL220W",885).
component("YOL058W",927).
component("YBR208C",265).
component("YHR074W",589).
component("YMR217W",848).
component("YGR061C",531).
component("YPR145W",1053).
component("YGR124W",537).
component("YOR303W",977).
component("YJR109C",688).
component("YJL130C",655).
component("YGL062W",504).
component("YBR218C",266).
component("YPL231W",1022).
component("YNR016C",906).
component("YKL182W",724).
component("YGR037C",527).
component("YOR005C",942).
component("YDL164C",331).
component("YOL010W",918).
component("YPR138C",1052).
component("YPL274W",1029).
component("YPL265W",1025).
component("YPL134C",1007).
component("YPL057C",1000).
component("YPL036W",999).
component("YOR348C",987).
component("YOR222W",970).
component("YOR192C",964).
component("YOR171C",959).
component("YOR130C",953).
component("YOR071C",946).
component("YOR011W",943).
component("YOL156W",941).
component("YOL103W",935).
component("YOL020W",920) :- not remove_orf("YOL020W",920).
component("YNR072W",916).
component("YNR056C",913).
component("YNL318C",901).
component("YNL268W",894).
component("YNL142W",880).
component("YMR272C",857).
component("YMR202W",845).
component("YMR011W",825).
component("YML123C",822).
component("YLR348C",794).
component("YLR260W",781).
component("YLR237W",778).
component("YLR138W",764).
component("YLR100C",761).
component("YLR081W",759).
component("YLL061W",749).
component("YLL043W",748).
component("YKR093W",742).
component("YKR053C",739).
component("YKR039W",738) :- not remove_orf("YKR039W",738).
component("YKL217W",733).
component("YKL120W",711).
component("YKL004W",700).
component("YJR158W",697).
component("YJR152W",695).
component("YJR095W",684).
component("YJR077C",682).
component("YJL219W",669).
component("YJL214W",667).
component("YJL134W",656).
component("YJL129C",653).
component("YIR028W",636).
component("YIL134W",624).
component("YHR096C",593).
component("YHR094C",592).
component("YHR092C",591).
component("YHL036W",572).
component("YHL016C",570).
component("YGR121C",535).
component("YGR055W",529).
component("YGL186C",512).
component("YGL077C",507).
component("YGL008C",494).
component("YFL055W",481).
component("YFL011W",474).
component("YER060W-A",447).
component("YER060W",446).
component("YER056C",445).
component("YER053C",443).
component("YEL069C",433).
component("YEL017C-A",426).
component("YDR536W",423).
component("YDR508C",419).
component("YDR503C",418).
component("YDR497C",417).
component("YDR345C",401).
component("YDR343C",400).
component("YDR342C",399).
component("YDR297W",394).
component("YDR294C",393).
component("YDR284C",391).
component("YDR046C",355) :- not remove_orf("YDR046C",355).
component("YDL245C",345).
component("YDL210W",338).
component("YCR032W",297).
component("YCR024C-A",296).
component("YCL025C",282).
component("YBR298C",278).
component("YBR291C",277).
component("YBR069C",241) :- not remove_orf("YBR069C",241).
component("YBR068C",240) :- not remove_orf("YBR068C",240).
component("YBR036C",236).
component("YBR021W",232).
component("YBL042C",215).
component("U85_",184).
component("U7_",178).
component("U79_",177).
component("U78_",176).
...
catalyst(1960,356).
catalyst(3460,154).
catalyst(3600,730) :- not remove_reaction(3600,730).
catalyst(8000,743).
catalyst(3941,923).
catalyst(3942,923).
catalyst(6890,882).
...
catalyst(8020,1035).
catalyst(8020,451).
catalyst(1890,731) :- not remove_reaction(1890,731).
catalyst(3630,731) :- not remove_reaction(3630,731).
catalyst(1890,461) :- not remove_reaction(1890,461).
catalyst(3630,461) :- not remove_reaction(3630,461).
catalyst(3740,373).
catalyst(8231,1032).
catalyst(8232,1032).
catalyst(8231,994).
...
catalyst(8051,1024).
catalyst(8052,1024).
catalyst(3590,499) :- not remove_reaction(3590,499).
catalyst(10910,499) :- not remove_reaction(10910,499).
catalyst(4570,540).
catalyst(8181,786).
catalyst(8182,786).
catalyst(8181,666).
...
catalyst(8281,357).
catalyst(8282,357).
catalyst(3610,347) :- not remove_reaction(3610,347).
catalyst(7921,948).
catalyst(7922,948).
catalyst(7841,434).
catalyst(7842,434).
...
catalyst(1210,941).
catalyst(1160,935).
catalyst(801,920) :- not remove_reaction(801,920).
catalyst(802,920) :- not remove_reaction(802,920).
catalyst(811,920) :- not remove_reaction(811,920).
catalyst(812,920) :- not remove_reaction(812,920).
catalyst(831,920) :- not remove_reaction(831,920).
catalyst(832,920) :- not remove_reaction(832,920).
catalyst(901,920) :- not remove_reaction(901,920).
catalyst(902,920) :- not remove_reaction(902,920).
catalyst(941,920) :- not remove_reaction(941,920).
catalyst(942,920) :- not remove_reaction(942,920).
catalyst(1170,916).
catalyst(1180,916).
catalyst(1210,916).
catalyst(700,913).
...
catalyst(650,742).
catalyst(6560,739).
catalyst(761,738) :- not remove_reaction(761,738).
catalyst(762,738) :- not remove_reaction(762,738).
catalyst(771,738) :- not remove_reaction(771,738).
catalyst(772,738) :- not remove_reaction(772,738).
catalyst(781,738) :- not remove_reaction(781,738).
catalyst(782,738) :- not remove_reaction(782,738).
catalyst(791,738) :- not remove_reaction(791,738).
catalyst(792,738) :- not remove_reaction(792,738).
catalyst(801,738) :- not remove_reaction(801,738).
catalyst(802,738) :- not remove_reaction(802,738).
catalyst(811,738) :- not remove_reaction(811,738).
catalyst(812,738) :- not remove_reaction(812,738).
catalyst(821,738) :- not remove_reaction(821,738).
catalyst(822,738) :- not remove_reaction(822,738).
catalyst(831,738) :- not remove_reaction(831,738).
catalyst(832,738) :- not remove_reaction(832,738).
catalyst(841,738) :- not remove_reaction(841,738).
catalyst(842,738) :- not remove_reaction(842,738).
catalyst(861,738) :- not remove_reaction(861,738).
catalyst(862,738) :- not remove_reaction(862,738).
catalyst(881,738) :- not remove_reaction(881,738).
catalyst(882,738) :- not remove_reaction(882,738).
catalyst(901,738) :- not remove_reaction(901,738).
catalyst(902,738) :- not remove_reaction(902,738).
catalyst(911,738) :- not remove_reaction(911,738).
catalyst(912,738) :- not remove_reaction(912,738).
catalyst(921,738) :- not remove_reaction(921,738).
catalyst(922,738) :- not remove_reaction(922,738).
catalyst(941,738) :- not remove_reaction(941,738).
catalyst(942,738) :- not remove_reaction(942,738).
catalyst(1191,738) :- not remove_reaction(1191,738).
catalyst(1192,738) :- not remove_reaction(1192,738).
catalyst(390,733).
catalyst(1021,733).
catalyst(1022,733).
catalyst(1521,711).
...
catalyst(6550,393).
catalyst(6690,391).
catalyst(791,355) :- not remove_reaction(791,355).
catalyst(792,355) :- not remove_reaction(792,355).
catalyst(801,355) :- not remove_reaction(801,355).
catalyst(802,355) :- not remove_reaction(802,355).
catalyst(811,355) :- not remove_reaction(811,355).
catalyst(812,355) :- not remove_reaction(812,355).
catalyst(831,355) :- not remove_reaction(831,355).
catalyst(832,355) :- not remove_reaction(832,355).
catalyst(841,355) :- not remove_reaction(841,355).
catalyst(842,355) :- not remove_reaction(842,355).
catalyst(861,355) :- not remove_reaction(861,355).
catalyst(862,355) :- not remove_reaction(862,355).
catalyst(901,355) :- not remove_reaction(901,355).
catalyst(902,355) :- not remove_reaction(902,355).
catalyst(1170,345).
catalyst(1180,345).
catalyst(1210,345).
catalyst(690,338).
...
catalyst(1511,277).
catalyst(1512,277).
catalyst(771,241) :- not remove_reaction(771,241).
catalyst(772,241) :- not remove_reaction(772,241).
catalyst(791,241) :- not remove_reaction(791,241).
catalyst(792,241) :- not remove_reaction(792,241).
...
catalyst(861,241) :- not remove_reaction(861,241).
catalyst(862,241) :- not remove_reaction(862,241).
catalyst(901,241) :- not remove_reaction(901,241).
catalyst(902,241) :- not remove_reaction(902,241).
catalyst(791,240) :- not remove_reaction(791,240).
catalyst(792,240) :- not remove_reaction(792,240).
catalyst(801,240) :- not remove_reaction(801,240).
catalyst(802,240) :- not remove_reaction(802,240).
catalyst(811,240) :- not remove_reaction(811,240).
catalyst(812,240) :- not remove_reaction(812,240).
catalyst(831,240) :- not remove_reaction(831,240).
catalyst(832,240) :- not remove_reaction(832,240).
catalyst(841,240) :- not remove_reaction(841,240).
catalyst(842,240) :- not remove_reaction(842,240).
catalyst(861,240) :- not remove_reaction(861,240).
catalyst(862,240) :- not remove_reaction(862,240).
catalyst(901,240) :- not remove_reaction(901,240).
catalyst(902,240) :- not remove_reaction(902,240).
catalyst(6600,236).
catalyst(620,232).
catalyst(540,215).
catalyst(2660,184).
...
modifiable_enzyme(730).
modifiable_enzyme(731).
modifiable_enzyme(461).
modifiable_enzyme(499).
modifiable_enzyme(347).
modifiable_enzyme(920).
modifiable_enzyme(738).
