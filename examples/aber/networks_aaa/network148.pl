...
component("YNL280C",779).
component("YLR056W",656).
component("YGR060W",458).
component("YGL012W",426).
component("YKR009C",639).
component("YOL086C",810).
component("YMR303C",748).
component("YMR083W",719).
...
component("YKL026C",611).
component("YIR037W",552).
component("YBR244W",224).
component("YJR078W",592).
component("YJR025C",584).
component("YGR255C",485).
component("U108_",23).
component("YBL098W",181).
component("YMR015C",716).
...
component("YJL026W",555).
component("YIL066C",532).
...
component("YPL276W",899).
component("YPL275W",898).
component("YOR388C",864).
component("YOR374W",861).
component("YER073W",391).
component("U68_",134).
component("YGL154C",441).
component("U55_",126).
component("YOR323C",852).
component("YMR170C",729).
component("YMR169C",728).
component("U2_",105).
component("YER178W",406).
component("YBR221C",222).
component("YIL125W",539).
component("U52_",123).
component("YBR166C",215).
component("YNL280C",780).
component("YGL012W",427).
component("YKL182W",629).
component("U57_",128).
...
component("YOR103C",825).
component("YOR085W",823).
component("YMR149W",727).
component("YML019W",698).
component("YJL002C",553).
component("YEL002C",363).
component("YDL232W",289).
component("YCL043C",241).
component("YNL029C",752).
component("YIL085C",534).
component("YMR261C",740).
component("YML100W",707).
component("YBR126C",208).
component("YNL192W",768).
component("YBR038W",196).
component("YBR023C",192).
component("YMR306W",750).
component("YLR342W",688).
component("YGR032W",454).
component("YLR209C",672).
component("U104_",21).
component("YMR271C",742).
component("YML106W",708).
component("YOR209C",841).
component("YMR300C",747).
...
component("U16_",57).
component("U15_",51).
component("YPL188W",881).
component("YJR049C",586).
component("YEL041W",366).
component("U96_",160).
component("YKL001C",608).
component("YDR236C",324).
component("YML070W",705).
component("YFL053W",413).
component("YHL032C",495).
component("YLR133W",661).
component("YDR531W",361).
component("U83_",148).
component("U82_",147).
component("U81_",146).
component("YMR208W",734).
component("YPL203W",882).
component("YOR061W",820).
component("YKL166C",627).
component("YJL164C",571).
component("YIL035C",528).
component("YHR205W",522).
component("YHR102W",515).
component("YGL019W",429).
component("YHR025W",504).
component("YOR347C",857).
component("YAL038W",167).
component("YNR012W",788).
component("YPR121W",917).
component("YPL258C",891).
component("YOL055C",804).
component("YPL214C",885).
component("U1_",80).
component("YDR009W",294).
component("YBR020W",190).
component("YNL267W",776).
component("YLR305C",683).
...
component("U94_",159).
component("YJR010W",582).
component("YGL130W",439).
component("YDR530C",360).
component("YCL050C",242).
component("YPR190C",923).
component("YPR187W",922).
component("YPR110C",915).
component("YPR010C",904).
component("YOR341W",856).
component("YOR340C",855).
component("YOR224C",844).
component("YOR210W",842).
component("YOR207C",839).
component("YOR151C",833).
component("YOR116C",826).
component("YOL005C",798).
component("YNR003C",786).
component("YNL248C",771).
component("YNL151C",765).
component("YNL113W",759).
component("YKL144C",623).
component("YJR063W",589).
component("YJL148W",568).
component("YJL140W",567).
component("YIL021W",527).
...
component("YPR175W",920).
component("YPL167C",878).
component("YOR330C",853).
component("YOL115W",814).
component("YNL299W",782).
component("YNL262W",775).
component("YNL102W",758).
component("YJR043C",585).
component("YJR006W",581).
component("YJL090C",560).
component("YIL139C",540).
...
component("YLR377C",693).
component("YDR074W",307).
component("YPL179W",880).
component("YNR032W",790).
component("YML057W",704).
component("YML016C",697).
component("YLR433C",696).
...
component("YPR073C",911).
component("YHR215W",524).
component("YDL024C",255).
component("YBR093C",203).
component("YBR092C",202).
component("YAR071W",169).
component("YIL053W",531).
component("YER062C",387).
component("YHR046C",507).
component("U9_",163).
component("YGR208W",479).
component("YPL228W",886).
component("YMR180C",730).
component("YDL236W",290).
component("YJL155C",570).
component("YPR073C",912).
component("YOR208W",840).
component("YNL053W",755).
component("YMR036C",717).
component("YIR026C",547).
component("YIL113W",537).
...
component("U25_",102).
component("U24_",101).
component("YPL268W",895).
component("YOR360C",860).
component("YGL248W",448).
component("YKR031C",641).
component("YPL206C",883).
component("YGL027C",431).
component("YLR286C",678).
component("YJR153W",605).
component("YJL221C",580).
component("YJL216C",578).
component("YIL172C",546).
component("YGR292W",491).
component("YGR287C",490).
component("YBR299W",234).
component("YBR184W",217).
component("YOR190W",837).
component("YLR300W",679).
component("YGR282C",488).
component("YDR261C",328).
component("YDR400W",346).
component("U23_",100).
component("YML035C",700).
component("YJL070C",559).
component("YBR284W",231).
component("U102_",20).
component("YNL045W",754).
component("YLR160C",668).
component("YLR158C",667).
component("YLR157C",666).
component("YLR155C",665).
component("YDR321W",337).
component("YGL037C",432).
component("YMR293C",745).
component("YDR242W",325).
component("YLR308W",685).
component("YLR307W",684).
component("YBR208C",219).
component("YMR281W",744).
component("U53_",124).
component("YIR027C",548).
component("YPL111W",875).
component("YIR032C",551).
component("YIR029W",549).
component("YPR062W",909).
component("YMR120C",726).
component("YLR028C",654).
...
component("YMR217W",735).
component("YGR061C",459).
component("YPR145W",919).
component("YGR124W",465).
component("YOR303W",849).
component("YJR109C",597).
component("YJL130C",565).
...
component("YPR138C",918).
component("YPL274W",897).
component("YPL265W",893).
component("YPL057C",871).
component("YPL036W",870).
component("YOR348C",858).
component("YOR192C",838).
component("YOR171C",834).
component("YOR130C",829).
component("YOR071C",822).
component("YOL156W",818).
component("YOL103W",813).
component("YOL020W",801) :- not remove_orf("YOL020W",801).
component("YNR072W",797).
component("YNR056C",795).
component("YNL318C",784).
component("YNL268W",777).
component("YNL142W",764).
component("YMR272C",743).
component("YMR202W",732).
component("YMR011W",714).
component("YML123C",711).
component("YLR348C",689).
component("YLR260W",677).
component("YLR237W",675).
component("YLR138W",663).
component("YLR100C",660).
component("YLR081W",658).
component("YLL061W",651).
component("YLL043W",650).
component("YKR093W",645).
component("YKR053C",643).
component("YKR039W",642) :- not remove_orf("YKR039W",642).
component("YKL217W",637).
component("YKL004W",609).
component("YJR158W",606).
component("YJR152W",604).
component("YJR095W",593).
component("YJR077C",591).
component("YJL219W",579).
component("YJL214W",577).
component("YJL134W",566).
component("YJL129C",564).
...
catalyst(1960,302).
catalyst(3460,125).
catalyst(3600,634) :- not remove_reaction(3600,634).
catalyst(8000,646).
catalyst(3941,803).
catalyst(3942,803).
catalyst(6890,766).
...
catalyst(8020,903).
catalyst(8020,388).
catalyst(1890,635) :- not remove_reaction(1890,635).
catalyst(3630,635) :- not remove_reaction(3630,635).
...
catalyst(1210,818).
catalyst(1160,813).
catalyst(801,801) :- not remove_reaction(801,801).
catalyst(802,801) :- not remove_reaction(802,801).
catalyst(811,801) :- not remove_reaction(811,801).
catalyst(812,801) :- not remove_reaction(812,801).
catalyst(831,801) :- not remove_reaction(831,801).
catalyst(832,801) :- not remove_reaction(832,801).
catalyst(901,801) :- not remove_reaction(901,801).
catalyst(902,801) :- not remove_reaction(902,801).
catalyst(941,801) :- not remove_reaction(941,801).
catalyst(942,801) :- not remove_reaction(942,801).
catalyst(1170,797).
catalyst(1210,797).
catalyst(700,795).
catalyst(1200,784).
...
catalyst(650,645).
catalyst(6560,643).
catalyst(761,642) :- not remove_reaction(761,642).
catalyst(762,642) :- not remove_reaction(762,642).
catalyst(771,642) :- not remove_reaction(771,642).
catalyst(772,642) :- not remove_reaction(772,642).
catalyst(781,642) :- not remove_reaction(781,642).
catalyst(782,642) :- not remove_reaction(782,642).
catalyst(791,642) :- not remove_reaction(791,642).
catalyst(792,642) :- not remove_reaction(792,642).
catalyst(801,642) :- not remove_reaction(801,642).
catalyst(802,642) :- not remove_reaction(802,642).
catalyst(811,642) :- not remove_reaction(811,642).
catalyst(812,642) :- not remove_reaction(812,642).
catalyst(821,642) :- not remove_reaction(821,642).
catalyst(822,642) :- not remove_reaction(822,642).
catalyst(831,642) :- not remove_reaction(831,642).
catalyst(832,642) :- not remove_reaction(832,642).
catalyst(841,642) :- not remove_reaction(841,642).
catalyst(842,642) :- not remove_reaction(842,642).
catalyst(861,642) :- not remove_reaction(861,642).
catalyst(862,642) :- not remove_reaction(862,642).
catalyst(881,642) :- not remove_reaction(881,642).
catalyst(882,642) :- not remove_reaction(882,642).
catalyst(901,642) :- not remove_reaction(901,642).
catalyst(902,642) :- not remove_reaction(902,642).
catalyst(911,642) :- not remove_reaction(911,642).
catalyst(912,642) :- not remove_reaction(912,642).
catalyst(921,642) :- not remove_reaction(921,642).
catalyst(922,642) :- not remove_reaction(922,642).
catalyst(941,642) :- not remove_reaction(941,642).
catalyst(942,642) :- not remove_reaction(942,642).
catalyst(1191,642) :- not remove_reaction(1191,642).
catalyst(1192,642) :- not remove_reaction(1192,642).
catalyst(1021,637).
catalyst(1022,637).
catalyst(6610,609).
catalyst(1170,606).
