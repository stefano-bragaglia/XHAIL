...
component("YNL280C",593).
component("YGR060W",351).
component("YGL012W",326).
component("YKR009C",486).
component("YOL086C",617).
component("YMR303C",566).
component("YMR083W",548).
...
component("YJR159W",460).
component("YGL001C",323).
component("YIL094C",404).
component("YHR063C",387).
component("YBR153W",165).
component("YML056C",536).
component("YLR432W",532).
component("YHR216W",398).
component("YAR075W",133).
component("YAR073W",132).
component("YDR127W",238).
component("YJR139C",456).
component("YOL126C",621).
component("YDL078C",199).
component("YKL029C",464).
component("YOR136W",631).
component("YNL037C",570).
component("YDL066W",198).
component("YNL241C",585).
component("YLR355C",529).
component("YML086C",538).
component("YIL155C",410).
component("YPR191W",701).
component("YOR065W",626).
component("YJL166W",434).
component("YHR001W-A",379).
component("YGR183C",362).
component("YFR033C",319).
component("YDR529C",274).
component("YBL045C",139).
component("Q0105",18).
component("YGR088W",353).
component("YDR256C",252).
component("YKL026C",463).
component("YIR037W",417).
component("YBR244W",175).
component("YJR078W",447).
component("YJR025C",441).
component("YGR255C",372).
component("U108_",22).
component("YBL098W",142).
component("YMR015C",545).
component("YDR402C",266).
component("YGL055W",331).
component("YGR175C",359).
component("YJR104C",450).
component("YHR008C",380).
component("YJL026W",418).
component("YGR180C",361).
component("YER070W",295).
component("U35_",86).
component("YDL168W",216).
component("YDR158W",246).
component("YPL276W",682).
component("YPL275W",681).
component("YOR388C",659).
component("YOR374W",656).
component("YER073W",296).
component("YGL154C",337).
component("U55_",97).
component("YOR323C",648).
component("YMR170C",554).
component("YMR169C",553).
component("U2_",83).
component("YBR221C",173).
component("YIL125W",408).
component("U52_",94).
component("YBR166C",168).
component("YNL280C",594).
component("YGL012W",327).
component("U57_",98).
component("YDR044W",229).
component("YER014W",283).
component("YKR009C",487).
component("YIL160C",412).
component("YGL205W",340).
component("YMR118C",551).
component("YLR164W",512).
component("YLL041C",495).
component("YKL148C",474).
component("YKL141W",472).
component("YJL045W",419).
component("YDR178W",247).
component("YJR051W",443).
component("YEL047C",278).
component("YOR375C",657).
component("YDL215C",219).
component("YAL062W",130).
component("U99_",125).
component("YBR035C",151).
component("YHR037W",384).
component("YKR080W",491).
component("YER023W",284).
component("YOR236W",644).
component("YGR204W",365).
component("YLR142W",507).
component("U62_",101).
component("YKL150W",475).
component("YIL043C",400).
component("YHR042W",385).
component("YOR221C",642).
component("YML120C",541).
component("YKL192C",481).
component("YKL055C",466).
component("YER061C",292).
component("YFR030W",318).
component("YPL017C",662).
component("YFL018C",310).
component("YER042W",286).
component("YJR137C",455).
component("YPL266W",679).
component("YML110C",540).
component("YBR034C",150).
component("YPL273W",680).
component("YLL062C",498).
component("U47_",91).
component("YER091C",301).
component("YJR073C",445).
component("YDL033C",196).
component("YOL096C",618).
component("YLR172C",513).
component("YDR019C",225).
component("YDR408C",268).
component("YBL013W",134).
component("YKL024C",462).
component("YPR074C",693).
component("YBR117C",160).
component("YLR354C",528).
component("YGR043C",349).
component("YCL009C",184).
component("YMR062C",547).
component("YNL071W",573).
component("YNR008W",601).
component("YPL231W",674).
component("YER061C",293).
component("U86_",116).
component("YPL001W",661).
component("YDR148C",244).
component("YOR377W",658).
component("YGR177C",360).
component("YPL231W",675).
component("YGR147C",356).
component("YDL040C",197).
component("YPL028W",663).
component("YGL017W",328).
component("YPR001W",684).
component("YNR001C",599).
component("YDL182W",217).
component("YDL131W",208).
component("YNL117W",577).
component("YIR031C",415).
component("YOR321W",647).
component("YJR143C",457).
component("YGR199W",364).
component("YDR307W",259).
component("YDL095W",203).
component("YDL093W",202).
component("YAL023C",127).
component("YNL029C",569).
component("YIL085C",403).
component("YMR261C",561).
component("YML100W",539).
component("YBR126C",162).
component("YNL192W",584).
component("YBR038W",153).
component("YBR023C",149).
component("YLR209C",514).
component("U104_",21).
component("YOR209C",640).
component("YMR300C",565).
component("YER055C",288).
component("YDR354W",262) :- not remove_orf("YDR354W",262).
component("YFR047C",320).
component("YJR133W",454).
component("YLR209C",515).
component("YML022W",533).
component("YDR441C",270).
component("YDR399W",264).
component("YJL167W",435).
component("YNL256W",588).
component("YDR127W",239).
component("YLR303W",521).
component("YGR012W",346).
component("YJR130C",453).
component("YLR303W",522).
component("YDR035W",227).
component("YBR249C",176).
component("YOL143C",623).
component("YBR256C",177).
component("YHR137W",392).
component("YGL202W",339).
component("YLR027C",499).
component("YKL106W",469).
component("YKL104C",468).
component("YGR019W",347).
component("YLR089C",503).
component("U64_",102).
component("U61_",100).
component("U51_",93).
component("YJR148W",458).
component("YOR184W",635).
component("YIL116W",407).
component("YGL253W",343).
component("YFR053C",321).
component("YOL136C",622).
component("YIL107C",405).
component("YMR205C",556).
component("YGR240C",368).
component("YDR248C",251).
component("YCR036W",192).
component("YCL040W",187).
component("YJR105W",451).
component("U16_",44).
component("U15_",39).
component("U96_",123).
component("YKL001C",461).
component("YML070W",537).
component("YFL053W",313).
component("YHL032C",377).
component("U83_",114).
component("U82_",113).
component("U81_",112).
component("YMR208W",557).
component("YOR347C",653).
component("YAL038W",129).
component("YNR012W",602).
component("YPR121W",696).
component("YPL258C",677).
component("YOL055C",613).
component("U1_",64).
component("YDR009W",224).
component("YBR020W",147).
component("YNL267W",591).
component("YLR305C",524).
component("YFR019W",316).
component("YDR208W",248).
component("YDR127W",240).
component("U21_",73).
component("U20_",71).
component("YDR147W",243).
...
component("YKL067W",467).
component("YDR454C",271).
component("YOL061W",616).
component("YKL181W",477).
component("YHL011C",375).
component("YER099C",303).
component("YBL068W",141).
component("YOR143C",633).
component("YLR328W",525).
component("YBR018C",144).
component("YGR007W",345).
component("YLR328W",526).
component("YKR002W",485).
component("YDL103C",206).
component("YJR010W",440).
component("YCL050C",188).
component("YPR190C",700).
component("YPR187W",699).
component("YPR110C",695).
component("YPR010C",686).
component("YOR341W",652).
component("YOR340C",651).
component("YOR224C",643).
component("YOR210W",641).
component("YOR207C",638).
component("YOR151C",634).
component("YOR116C",629).
component("YOL005C",608).
component("YNR003C",600).
component("YNL248C",587).
component("YNL151C",581).
component("YNL113W",576).
component("YKL144C",473).
component("YJR063W",444).
component("YJL148W",431).
component("YJL140W",430).
component("YIL021W",399).
component("YHR143W-A",393).
component("YGL070C",334).
component("YFL036W",312).
component("YDR404C",267).
component("YDR156W",245).
component("YDR045C",230).
component("YDL150W",213).
component("YDL140C",209).
component("YBR154C",167).
component("YPR175W",698).
component("YPL167C",670).
component("YOR330C",649).
component("YOL115W",620).
component("YNL299W",596).
component("YNL262W",590).
component("YNL102W",575).
component("YJR043C",442).
component("YJR006W",439).
component("YJL090C",423).
component("YIL139C",409).
component("YEL055C",279).
component("YDR419W",269).
component("YDR121W",237).
component("YDL102W",205).
component("YCR014C",190).
component("YBR278W",179).
component("YBL035C",136).
component("YKL035W",465).
component("YHL012W",376).
component("YHR123W",391).
component("YBR243C",174).
component("YDL142C",212).
component("YER026C",285).
component("YCL004W",183).
component("YJL068C",420).
component("YDR058C",234).
component("YNR034W",605).
component("YHR163W",395).
component("YGR248W",370).
component("YCR073W-A",193).
component("YDL086W",201).
component("YOL011W",610).
component("YMR008C",544).
component("YMR006C",543).
component("U101_",19).
component("YBL015W",135).
component("YJL068C",421).
component("YPL072W",666).
component("YOR124C",630).
component("YNL186W",583).
component("YMR304W",567).
component("YMR223W",559).
component("YKR098C",493).
component("YJL197W",436).
component("YIL156W",411).
component("YFR010W",315).
component("YER151C",305).
component("YER144C",304).
component("YER098W",302).
component("YDR069C",235).
component("YDL122W",207).
component("YBR058C",154).
component("YBL067C",140).
component("YDR272W",254).
component("U84_",115).
component("YPR073C",691).
component("YHR215W",397).
component("YDL024C",195).
component("YBR093C",158).
component("YBR092C",157).
component("YAR071W",131).
component("YIL053W",402).
component("YER062C",294).
component("YHR046C",386).
component("YGR208W",367).
component("YPL228W",672).
component("YMR180C",555).
component("YDL236W",221).
component("YJL155C",433).
component("YPR073C",692).
component("YOR208W",639).
component("YNL053W",572).
component("YMR036C",546).
component("YIR026C",413).
component("YIL113W",406).
component("YFR028C",317).
component("YER075C",297).
...
component("U25_",81).
component("U24_",80).
component("YOR360C",655).
component("YGL248W",342).
component("YKR031C",488).
component("YLR286C",519).
component("YJR153W",459).
component("YOR190W",636).
component("YLR300W",520).
component("YGR282C",374).
component("YDR261C",253).
component("YDR400W",265).
component("U23_",79).
component("YML035C",534).
component("YJL070C",422).
component("YBR284W",180).
component("U102_",20).
component("YNL045W",571).
component("YLR160C",511).
component("YLR158C",510).
component("YLR157C",509).
component("YLR155C",508).
component("YDR321W",260).
component("YGL037C",330).
component("YDR242W",250).
component("YBR208C",170).
component("YMR281W",564).
component("U53_",95).
component("YIR032C",416).
component("YIR029W",414).
component("YPR062W",690).
component("YMR120C",552).
component("YHR144C",394).
component("YGR267C",373).
component("YNL141W",578).
component("YBR153W",166).
component("YDL238C",222).
component("YNL141W",579).
component("YLR245C",518).
component("YML035C",535).
component("YJL126W",426).
component("U44_",89).
component("YDL100C",204).
component("U87_",117).
component("YMR267W",562).
component("YBR011C",143).
component("YBR111C",159).
component("YCL030C",186).
component("YER005W",282).
component("YIL048W",401).
component("YER166W",306).
component("YDR093W",236).
component("YAL026C",128).
component("YLR231C",516).
component("U88_",118).
component("YLR134W",505).
component("YLR044C",500).
component("YGR087C",352).
component("YDR380W",263).
component("YDL080C",200).
component("U98_",124).
component("YMR250W",560).
component("YKL184W",480).
component("YNR043W",606).
component("U93_",122).
component("YDR047W",232).
component("U54_",96).
component("YKL211C",482) :- not remove_orf("YKL211C",482).
component("YNL169C",582).
component("YGR170W",358).
component("YNL256W",589).
component("YDR294C",255).
component("YEL046C",277).
component("YNR033W",604).
component("YKL211C",483) :- not remove_orf("YKL211C",483).
component("YER090W",483) :- not remove_orf("YER090W",483).
component("YER090W",300) :- not remove_orf("YER090W",300).
component("YDR127W",241).
component("YPL281C",683).
component("YOR393W",660).
component("YMR323W",568).
component("YHR174W",396).
component("YGR254W",371).
component("YGL026C",329) :- not remove_orf("YGL026C",329).
component("YGR155W",357).
component("YLR304C",523).
component("YJL200C",437).
component("YNL316C",597).
component("YKL182W",478).
component("YPL212C",671).
component("YNL292W",595).
component("YGL063W",333).
component("YFL001W",308).
component("YPR002W",685).
component("YDR127W",242).
component("YGL148W",336).
component("YER086W",298).
component("YLR359W",530).
component("YAL012W",126).
component("YFR055W",322).
component("YJL121C",425).
component("YBR019C",145).
component("YBR019C",146).
component("YDR050C",233).
component("YDR007W",223) :- not remove_orf("YDR007W",223).
component("YOR095C",628).
component("YER003C",281).
component("YBR196C",169).
component("YGL001C",324).
component("U14_",33).
component("YOL056W",614).
component("YKL152C",476).
component("YDL021W",194).
component("YMR105C",549).
component("YKL127W",470).
component("YEL058W",280).
component("YPR060C",689).
component("YHR072W",388).
component("YJL153C",432).
component("YPL097W",667).
component("YGR185C",363).
component("YHR011W",381).
component("YDR023W",226).
component("YPL104W",668).
component("YLL018C",494).
component("YPR081C",694).
component("YBR121C",161).
component("YHR020W",383).
component("YER087W",299).
component("YNL247W",586).
component("YOL033W",612).
component("YHR091C",390).
component("YDR341C",261).
component("YOL097C",619).
component("YPR047W",688).
component("YLR060W",501).
component("YFL022C",311).
component("YPR033C",687).
component("YHR019C",382).
component("YPL160W",669).
component("YLR382C",531).
component("YNL073W",574).
component("YDR037W",228).
component("YOR335C",650).
component("YGR094W",354).
component("YOR142W",632).
component("YGR244C",369).
component("U89_",119).
component("YOR241W",645).
component("YMR113W",550).
component("YKL132C",471).
component("YJL101C",424).
component("U92_",121).
component("YGL234W",341).
component("U91_",120).
component("YDL141W",210).
component("YDL141W",211).
component("YJR103W",449).
component("YBL039C",137).
component("YGR204W",366).
component("YOL058W",615).
component("YBR208C",171).
component("YHR074W",389).
component("YMR217W",558).
component("YOR303W",646).
component("YJR109C",452).
component("YJL130C",428).
component("YGL062W",332).
component("YBR218C",172).
component("YPL231W",676).
component("YNR016C",603).
component("YKL182W",479).
component("YGR037C",348).
component("YOR005C",625).
component("YDL164C",214).
component("YOL010W",609).
component("YPR138C",697).
component("YPL265W",678).
component("YPL057C",665).
component("YPL036W",664).
component("YOR348C",654).
component("YOR192C",637).
component("YOR071C",627).
component("YOL156W",624).
component("YOL020W",611) :- not remove_orf("YOL020W",611).
component("YNR056C",607).
component("YNL318C",598).
component("YNL268W",592).
component("YNL142W",580).
component("YMR272C",563).
component("YML123C",542).
component("YLR348C",527).
component("YLR237W",517).
component("YLR138W",506).
component("YLR100C",504).
component("YLR081W",502).
component("YLL061W",497).
component("YLL043W",496).
component("YKR093W",492).
component("YKR053C",490).
component("YKR039W",489) :- not remove_orf("YKR039W",489).
component("YKL217W",484).
component("YJR095W",448).
component("YJR077C",446).
component("YJL219W",438).
component("YJL134W",429).
component("YJL129C",427).
component("YHL036W",378).
component("YGR121C",355).
component("YGR055W",350).
component("YGL186C",338).
component("YGL077C",335).
component("YGL008C",325).
component("YFL055W",314).
component("YFL011W",309).
component("YER060W-A",291).
component("YER060W",290).
component("YER056C",289).
component("YER053C",287).
component("YEL017C-A",276).
component("YDR536W",275).
component("YDR508C",273).
component("YDR503C",272).
component("YDR297W",257).
component("YDR294C",256).
component("YDR046C",231) :- not remove_orf("YDR046C",231).
component("YDL210W",218).
...
catalyst(1960,232).
catalyst(3460,96).
catalyst(3600,482) :- not remove_reaction(3600,482).
catalyst(6890,582).
catalyst(6900,358).
catalyst(2570,589).
catalyst(8781,255).
...
catalyst(4560,277).
catalyst(2550,604).
catalyst(1890,483) :- not remove_reaction(1890,483).
catalyst(3630,483) :- not remove_reaction(3630,483).
catalyst(1890,300) :- not remove_reaction(1890,300).
catalyst(3630,300) :- not remove_reaction(3630,300).
catalyst(3740,241).
catalyst(8231,683).
catalyst(8232,683).
catalyst(8231,660).
...
catalyst(8231,371).
catalyst(8232,371).
catalyst(3590,329) :- not remove_reaction(3590,329).
catalyst(10910,329) :- not remove_reaction(10910,329).
catalyst(4570,357).
catalyst(8181,523).
catalyst(8182,523).
catalyst(8181,437).
...
catalyst(941,611) :- not remove_reaction(941,611).
catalyst(942,611) :- not remove_reaction(942,611).
catalyst(700,607).
catalyst(1200,598).
catalyst(761,592).
catalyst(762,592).
...
catalyst(640,492).
catalyst(6560,490).
catalyst(761,489) :- not remove_reaction(761,489).
catalyst(762,489) :- not remove_reaction(762,489).
catalyst(771,489) :- not remove_reaction(771,489).
catalyst(772,489) :- not remove_reaction(772,489).
catalyst(781,489) :- not remove_reaction(781,489).
catalyst(782,489) :- not remove_reaction(782,489).
catalyst(791,489) :- not remove_reaction(791,489).
catalyst(792,489) :- not remove_reaction(792,489).
catalyst(801,489) :- not remove_reaction(801,489).
catalyst(802,489) :- not remove_reaction(802,489).
catalyst(811,489) :- not remove_reaction(811,489).
catalyst(812,489) :- not remove_reaction(812,489).
catalyst(821,489) :- not remove_reaction(821,489).
catalyst(822,489) :- not remove_reaction(822,489).
catalyst(831,489) :- not remove_reaction(831,489).
catalyst(832,489) :- not remove_reaction(832,489).
catalyst(841,489) :- not remove_reaction(841,489).
catalyst(842,489) :- not remove_reaction(842,489).
catalyst(861,489) :- not remove_reaction(861,489).
catalyst(862,489) :- not remove_reaction(862,489).
catalyst(881,489) :- not remove_reaction(881,489).
catalyst(882,489) :- not remove_reaction(882,489).
catalyst(901,489) :- not remove_reaction(901,489).
catalyst(902,489) :- not remove_reaction(902,489).
catalyst(911,489) :- not remove_reaction(911,489).
catalyst(912,489) :- not remove_reaction(912,489).
catalyst(941,489) :- not remove_reaction(941,489).
catalyst(942,489) :- not remove_reaction(942,489).
catalyst(1191,489) :- not remove_reaction(1191,489).
catalyst(1192,489) :- not remove_reaction(1192,489).
catalyst(1021,484).
catalyst(1022,484).
catalyst(1250,448).
catalyst(1581,446).
...
catalyst(861,231) :- not remove_reaction(861,231).
catalyst(862,231) :- not remove_reaction(862,231).
