...
component("YGR060W",139).
component("YGL012W",129).
component("YOL086C",232).
component("YMR303C",214).
component("YGL256W",137).
component("YDL168W",80).
component("YBR145W",59).
component("YPL231W",256).
component("YGL001C",126).
component("YML056C",203).
component("YLR432W",201).
component("YHR216W",155).
component("YAR075W",48).
component("YAR073W",47).
component("YDR127W",90).
component("YJR139C",178).
component("YOR136W",237).
component("YIL155C",159).
component("YJR078W",172).
component("YJR025C",169).
component("YMR015C",207).
component("YDR402C",103).
component("YJR104C",175).
component("YHR008C",149).
component("YER070W",114).
component("YGL154C",135).
component("YMR170C",210).
component("YMR169C",209).
component("YBR166C",61).
component("YER014W",111).
component("YEL047C",110).
component("YOR375C",249).
component("YDL215C",81).
component("YAL062W",46).
component("YER023W",112).
component("YOR236W",244).
component("U62_",38).
component("YPL017C",252).
component("YFL018C",118).
component("U47_",34).
component("YKL024C",181).
component("YPR074C",266).
component("YBR117C",58).
component("YCL009C",70).
component("YPL231W",257).
component("YPL001W",251).
component("YPL231W",258).
component("YPL028W",253).
component("YNL029C",216).
component("YIL085C",157).
component("YLR209C",196).
component("YER055C",113).
component("YDR354W",99) :- not remove_orf("YDR354W",99).
component("YFR047C",124).
component("YJR133W",177).
component("YDR399W",101).
component("YDR127W",91).
component("YJR130C",176).
component("YDR035W",86).
component("YBR249C",64).
component("YBR256C",65).
component("YHR137W",151).
component("YLR027C",193).
component("YKL106W",183).
component("U64_",39).
component("U51_",35).
component("YJR148W",179).
component("YGL253W",136).
component("YFR053C",125).
component("YMR205C",212).
component("YGR240C",145).
component("YCR036W",74).
component("U15_",22).
component("YKL001C",180).
component("YML070W",204).
component("YFL053W",120).
component("U83_",43).
component("YMR208W",213).
component("YOR347C",248).
component("YAL038W",45).
component("U1_",27).
component("YNL267W",223).
component("YLR305C",200).
component("YFR019W",122).
component("YDR208W",96).
component("YDR127W",92).
component("U20_",30).
component("YDR300C",98).
component("U76_",42).
component("YDR454C",105).
component("YOL061W",231).
component("YKL181W",185).
component("YHL011C",147).
component("YER099C",117).
component("YBL068W",51).
component("YOR143C",238).
component("YCL050C",72).
component("YPR190C",270).
component("YPR187W",269).
component("YPR110C",267).
component("YPR010C",262).
component("YOR341W",247).
component("YOR340C",246).
component("YOR224C",243).
component("YOR210W",242).
component("YOR207C",240).
component("YOR151C",239).
component("YOR116C",236).
component("YOL005C",228).
component("YNR003C",225).
component("YNL248C",222).
component("YNL151C",221).
component("YNL113W",219).
component("YKL144C",184).
component("YJR063W",170).
component("YJL148W",167).
component("YJL140W",166).
component("YIL021W",156).
component("YHR143W-A",152).
component("YGL070C",133).
component("YFL036W",119).
component("YDR404C",104).
component("YDR156W",95).
component("YDR045C",87).
component("YDL150W",78).
component("YDL140C",77).
component("YBR154C",60).
component("YKL035W",182).
component("YHL012W",148).
component("YDR058C",89).
component("YOL011W",229).
component("YMR008C",206).
component("YMR006C",205).
component("U101_",18).
component("YBL015W",49).
component("U84_",44).
component("YPR073C",264).
component("YHR215W",154).
component("YDL024C",75).
component("YBR093C",56).
component("YBR092C",55).
component("YPL228W",255).
component("YMR180C",211).
component("YDL236W",83).
component("YJL155C",168).
component("YPR073C",265).
component("YOR208W",241).
component("YNL053W",218).
component("YMR036C",208).
component("YIR026C",160).
component("YIL113W",158).
component("YFR028C",123).
component("YER075C",115).
component("YDL230W",82).
component("YBR276C",66).
component("U30_",33).
component("U24_",32).
component("YKR031C",190).
component("YLR286C",199).
component("YDR400W",102).
component("YML035C",202).
component("YJL070C",162).
component("YBR284W",67).
component("YNL045W",217).
component("YGL037C",131).
component("U53_",36).
component("YIR032C",161).
component("YDL238C",84).
component("YLR245C",198).
component("YJL126W",164).
component("YBR111C",57).
component("YLR231C",197).
component("YLR134W",195).
component("YLR044C",194).
component("YGR087C",140).
component("YDR380W",100).
component("YDL080C",76).
component("U54_",37).
component("YKL211C",188) :- not remove_orf("YKL211C",188).
component("YGR170W",144).
component("YDR294C",97).
component("YNR033W",227).
component("YKL211C",189) :- not remove_orf("YKL211C",189).
component("YER090W",189) :- not remove_orf("YER090W",189).
component("YER090W",116) :- not remove_orf("YER090W",116).
component("YDR127W",93).
component("YPL281C",261).
component("YOR393W",250).
component("YMR323W",215).
component("YHR174W",153).
component("YGR254W",146).
component("YGL026C",130) :- not remove_orf("YGL026C",130).
component("YGR155W",143).
component("YNL316C",224).
component("YKL182W",186).
component("YDR127W",94).
component("YGL148W",134).
component("YDR007W",85) :- not remove_orf("YDR007W",85).
component("YOR095C",235).
component("YGL001C",127).
component("YPR060C",263).
component("YOL097C",233).
component("YOR335C",245).
component("YGR094W",141).
component("YJL101C",163).
component("YJR103W",174).
component("YBL039C",50).
component("YBR208C",62).
component("YHR074W",150).
component("YGL062W",132).
component("YBR218C",63).
component("YPL231W",259).
component("YNR016C",226).
component("YKL182W",187).
component("YGR037C",138).
component("YOR005C",234).
component("YDL164C",79).
component("YPR138C",268).
component("YPL265W",260).
component("YPL036W",254).
component("YOL020W",230) :- not remove_orf("YOL020W",230).
component("YNL142W",220).
component("YKR053C",192).
component("YKR039W",191) :- not remove_orf("YKR039W",191).
component("YJR095W",173).
component("YJR077C",171).
component("YJL134W",165).
component("YGR121C",142).
component("YGL008C",128).
component("YFL055W",121).
component("YEL017C-A",109).
component("YDR536W",108).
component("YDR508C",107).
component("YDR503C",106).
component("YDR046C",88) :- not remove_orf("YDR046C",88).
component("YCR024C-A",73).
component("YCL025C",71).
component("YBR298C",69).
component("YBR291C",68).
component("YBR069C",54) :- not remove_orf("YBR069C",54).
component("YBR068C",53) :- not remove_orf("YBR068C",53).
component("YBR021W",52).
component("U71_",41).
component("U69_",40).
component("U228_",31).
component("U206_",29).
...
catalyst(5612,196).
catalyst(3870,113).
catalyst(3620,99) :- not remove_reaction(3620,99).
catalyst(2190,124).
catalyst(5550,177).
catalyst(5320,101).
catalyst(3710,91).
...
catalyst(8802,76).
catalyst(3460,37).
catalyst(3600,188) :- not remove_reaction(3600,188).
catalyst(6900,144).
catalyst(8781,97).
catalyst(8782,97).
catalyst(2550,227).
catalyst(3630,189) :- not remove_reaction(3630,189).
catalyst(3630,116) :- not remove_reaction(3630,116).
catalyst(3740,93).
catalyst(8231,261).
catalyst(8232,261).
catalyst(8231,250).
...
catalyst(8231,146).
catalyst(8232,146).
catalyst(3590,130) :- not remove_reaction(3590,130).
catalyst(10910,130) :- not remove_reaction(10910,130).
catalyst(4570,143).
catalyst(3680,224).
catalyst(7141,186).
catalyst(7142,186).
catalyst(3750,94).
catalyst(3700,134).
catalyst(3610,85) :- not remove_reaction(3610,85).
catalyst(7921,235).
catalyst(7922,235).
catalyst(6370,127).
catalyst(3690,263).
...
catalyst(372,220).
catalyst(6560,192).
catalyst(771,191) :- not remove_reaction(771,191).
catalyst(772,191) :- not remove_reaction(772,191).
catalyst(781,191) :- not remove_reaction(781,191).
catalyst(782,191) :- not remove_reaction(782,191).
...
catalyst(881,191) :- not remove_reaction(881,191).
catalyst(882,191) :- not remove_reaction(882,191).
catalyst(1191,191) :- not remove_reaction(1191,191).
catalyst(1192,191) :- not remove_reaction(1192,191).
catalyst(1250,173).
catalyst(1581,171).
catalyst(1582,171).
catalyst(6560,165).
...
catalyst(1501,68).
catalyst(1502,68).
catalyst(771,54) :- not remove_reaction(771,54).
catalyst(772,54) :- not remove_reaction(772,54).
...
catalyst(831,53) :- not remove_reaction(831,53).
catalyst(832,53) :- not remove_reaction(832,53).
catalyst(620,52).
catalyst(2930,41).
catalyst(2990,40).
catalyst(41,31).
