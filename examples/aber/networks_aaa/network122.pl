...
component("YHR216W",448).
component("YAR075W",150).
component("YAR073W",149).
component("YDR127W",269).
component("YJR139C",508).
component("YOL126C",698).
component("YDL078C",225).
component("YKL029C",518).
component("YOR136W",708).
component("YNL037C",640).
component("YDL066W",224).
component("YNL241C",655).
component("YOL059W",691).
component("YDL022W",219).
component("YLR355C",590).
component("YML054C",599).
component("YDL174C",244).
component("YML086C",603).
component("YIL155C",461).
component("YPR191W",786).
component("YOR065W",703).
component("YJL166W",486).
component("YHR001W-A",427).
component("YGR183C",408).
component("YFR033C",361).
component("YDR529C",310).
component("YBL045C",156).
component("Q0105",18).
component("YGR088W",397).
component("YDR256C",284).
component("YKL026C",517).
component("YIR037W",469).
component("YBR244W",197).
component("YJR078W",499).
component("YJR025C",493).
component("YGR255C",420).
component("U108_",22).
component("YBL098W",160).
component("YMR015C",610).
component("YHR007C",428).
component("YDR402C",299).
component("YGL055W",373).
component("YGR175C",405).
component("YJR104C",502).
component("YHR008C",429).
component("YJL026W",470).
component("YIL066C",453).
component("YGR180C",407).
component("YER070W",333).
component("U38_",100).
component("U35_",99).
component("YDL168W",243).
component("YDR158W",277).
component("YBR006W",161).
component("YPL276W",766).
component("YPL275W",765).
component("YOR388C",738).
component("YOR374W",735).
component("YER073W",334).
component("U68_",118).
component("YGL154C",380).
component("U55_",112).
component("YOR323C",727).
component("YMR170C",621).
component("YMR169C",620).
component("U2_",95).
component("YER178W",348).
component("YBR221C",195).
component("YIL125W",459).
component("U52_",109).
component("YBR166C",190).
component("YNL280C",666).
component("YGL012W",369).
component("U57_",113).
component("YKL216W",539).
component("YDR044W",259).
component("YER014W",321).
component("YKR009C",543).
component("YIL160C",463).
component("YGL205W",383).
component("YMR118C",617).
component("YLR164W",571).
component("YLL041C",551).
component("YKL148C",529).
component("YKL141W",527).
component("YJL045W",471).
component("YDR178W",278).
component("YJR051W",495).
component("YEL047C",316).
component("YDL215C",248).
component("YOR375C",736).
component("YDL215C",249).
component("YAL062W",147).
component("U99_",142).
component("YBR035C",171).
component("YHR037W",434).
component("YKR080W",547).
component("YER023W",322).
component("YOR236W",722).
component("YGR204W",412).
component("YLR142W",566).
component("U62_",116).
component("YKL150W",530).
component("YIL043C",450).
component("YHR042W",435).
component("YOR221C",720).
component("YML120C",606).
component("YKL192C",536).
component("YKL055C",520).
component("YER061C",330).
component("YGR234W",415).
component("YFR030W",360).
component("YPL017C",741).
component("YFL018C",352).
component("YER042W",324).
component("YJR137C",507).
component("YPL266W",762).
component("YML110C",605).
component("YBR034C",170).
component("YPL273W",763).
component("YLL062C",554).
component("YDR410C",302).
component("U47_",105).
component("YER091C",340).
component("YJR073C",497).
component("YDL033C",221).
component("YOL096C",694).
component("YLR172C",572).
component("YDR019C",255).
component("YDR408C",301).
component("YMR120C",618).
component("YBL013W",151).
component("YKL024C",516).
component("YPR074C",777).
component("YBR117C",181).
component("YLR354C",589).
component("YGR043C",393).
component("YMR108W",615).
component("YCL009C",206).
component("YMR062C",612).
component("YNL071W",643).
component("YNR008W",673).
component("YNL277W",664).
component("YFL017C",351).
component("YPL231W",756).
component("YER061C",331).
component("U86_",132).
component("YPL001W",740).
component("YDR148C",275).
component("YOR377W",737).
component("YGR177C",406).
component("YPL231W",757).
component("YGR147C",402).
component("YDL040C",222).
component("YPL028W",742).
component("YGL017W",370).
component("YPR001W",768).
component("YNR001C",671).
component("YDL182W",245).
component("YDL131W",234).
component("YNL117W",647).
component("YIR031C",467).
component("YOR321W",726).
component("YJR143C",509).
component("YGR199W",411).
component("YDR307W",292).
component("YDL095W",229).
component("YDL093W",228).
component("YAL023C",144).
component("YNL029C",639).
component("YIL085C",454).
component("YMR261C",629).
component("YML100W",604).
component("YBR126C",184).
component("YNL192W",654).
component("YBR038W",173).
component("YBR023C",169).
component("YMR306W",637).
component("YLR342W",587).
component("YGR032W",391).
component("YLR209C",573).
component("U104_",21).
component("YOR209C",718).
component("YMR300C",634).
component("YER055C",326).
component("YDR354W",295) :- not remove_orf("YDR354W",295).
component("YFR047C",362).
component("YJR133W",506).
component("YLR209C",574).
component("YML022W",596).
component("YDR441C",305).
component("YDR399W",297).
component("YJL167W",487).
component("YNL256W",658).
component("YDR127W",270).
component("YLR303W",581).
component("YGR012W",389).
component("YJR130C",505).
component("YLR303W",582).
component("YDR035W",257).
component("YBR249C",198).
component("YOL143C",700).
component("YBR256C",199).
component("YHR137W",442).
component("YGL202W",382).
component("YLR027C",555).
component("YKL106W",524).
component("YKL104C",523).
component("YGR019W",390).
component("YLR089C",561).
component("U64_",117).
component("U61_",115).
component("U51_",108).
component("YJR148W",510).
component("YOR184W",713).
component("YNR058W",681).
component("YIL116W",458).
component("YGL253W",386).
component("YFR053C",363).
component("YOL136C",699).
component("YIL107C",456).
component("YMR205C",623).
component("YGR240C",416).
component("YDR248C",283).
component("YCR036W",215).
component("YGR194C",410).
component("YCL040W",209).
component("YJR105W",503).
component("U16_",50).
component("U15_",44).
component("U96_",140).
component("YKL001C",514).
component("YDR236C",281).
component("YML070W",602).
component("YFL053W",355).
component("YHL032C",425).
component("YLR133W",563).
component("YDR531W",312).
component("U83_",130).
component("U82_",129).
component("U81_",128).
component("YMR208W",624).
component("YHR025W",433).
component("YOR347C",732).
component("YAL038W",146).
component("YNR012W",674).
component("YPR121W",780).
component("YPL258C",759).
component("YOL055C",688).
component("U1_",73).
component("YDR009W",254).
component("YBR020W",167).
component("YNL267W",662).
component("YLR305C",584).
component("YFR019W",358).
component("YDR208W",279).
component("YDR127W",271).
component("U21_",83).
component("U20_",80).
component("YDR147W",274).
component("YDR300C",291).
component("YCR012W",211).
component("U18_",65).
component("U17_",58).
component("U76_",126).
component("YMR220W",626).
component("YER170W",347).
component("YDR226W",280).
component("YKL067W",522).
component("YDR454C",306).
component("YOL061W",692).
component("YKL181W",532).
component("YHL011C",423).
component("YER099C",342).
component("YBL068W",159).
component("YOR143C",710).
component("YNL256W",659).
component("YLR328W",585).
component("YBR018C",163).
component("YBR018C",164).
component("YGR007W",388).
component("YLR328W",586).
component("YKR002W",541).
component("YDL103C",232).
component("YJR010W",492).
component("YGL130W",378).
component("YDR530C",311).
component("YCL050C",210).
component("YPR190C",785).
component("YPR187W",784).
component("YPR110C",779).
component("YPR010C",770).
component("YOR341W",731).
component("YOR340C",730).
component("YOR224C",721).
component("YOR210W",719).
component("YOR207C",716).
component("YOR151C",711).
component("YOR116C",706).
component("YOL005C",682).
component("YNR003C",672).
component("YNL248C",657).
component("YNL151C",651).
component("YNL113W",646).
component("YKL144C",528).
component("YJR063W",496).
component("YJL148W",483).
component("YJL140W",482).
component("YIL021W",449).
component("YHR143W-A",443).
component("YGL070C",376).
component("YFL036W",354).
component("YDR404C",300).
component("YDR156W",276).
component("YDR045C",260).
component("YDL150W",240).
component("YDL140C",236).
component("YBR154C",189).
component("YPR175W",783).
component("YPL167C",750).
component("YOR330C",728).
component("YOL115W",697).
component("YNL299W",668).
component("YNL262W",661).
component("YNL102W",645).
component("YJR043C",494).
component("YJR006W",491).
component("YJL090C",475).
component("YIL139C",460).
...
component("YKL035W",519).
component("YHL012W",424).
component("YHR123W",441).
component("YBR243C",196).
component("YDL142C",239).
component("YER026C",323).
component("YCL004W",205).
component("YJL068C",472).
component("YDR058C",264).
component("YNR034W",678).
component("YHR163W",445).
component("YGR248W",418).
component("YCR073W-A",216).
component("YDL086W",227).
component("YOL011W",684).
component("YMR008C",609).
component("YMR006C",608).
component("U101_",19).
component("YBL015W",152).
component("YJL068C",473).
component("YPL072W",745).
component("YOR124C",707).
component("YNL186W",653).
component("YMR304W",636).
component("YMR223W",627).
component("YKR098C",549).
component("YJL197W",488).
component("YIL156W",462).
component("YFR010W",357).
component("YER151C",345).
component("YER144C",344).
component("YER098W",341).
component("YDR069C",265).
component("YDL122W",233).
component("YBR058C",174).
component("YBL067C",158).
component("YDR272W",287).
component("U84_",131).
component("YPL179W",751).
component("YNR032W",676).
...
component("YDL134C",235).
component("YDL047W",223).
component("YDL006W",217).
component("YBR125C",183).
component("YBL056W",157).
component("YPR073C",775).
component("YHR215W",447).
component("YDL024C",220).
component("YBR093C",179).
component("YBR092C",178).
component("YAR071W",148).
component("YIL053W",452).
component("YER062C",332).
component("YHR046C",436).
component("YGR208W",414).
component("YPL228W",754).
component("YMR180C",622).
component("YDL236W",251).
component("YJL155C",485).
component("YPR073C",776).
component("YOR208W",717).
component("YNL053W",642).
component("YMR036C",611).
component("YIR026C",464).
component("YIL113W",457).
component("YFR028C",359).
component("YER075C",335).
component("YDL230W",250).
component("YBR276C",200).
component("U34_",98).
component("U33_",97).
component("U30_",96).
component("U28_",94).
...
component("U25_",92).
component("U24_",91).
component("YOR360C",734).
component("YGL248W",385).
component("YKR031C",544).
component("YPL206C",752).
component("YLR286C",579).
component("YJR153W",512).
component("YOR190W",714).
component("YLR300W",580).
component("YGR282C",422).
component("YDR261C",285).
component("YDR400W",298).
component("U23_",90).
component("YML035C",597).
component("YJL070C",474).
component("YBR284W",202).
component("U102_",20).
component("YNL045W",641).
component("YLR160C",570).
component("YLR158C",569).
component("YLR157C",568).
component("YLR155C",567).
component("YDR321W",293).
component("YGL037C",372).
component("YMR293C",633).
component("YDR242W",282).
component("YBR208C",192).
component("YMR281W",632).
component("U53_",110).
component("YIR027C",465).
component("YPL111W",748).
component("YIR032C",468).
component("YIR029W",466).
component("YPR062W",774).
component("YMR120C",619).
component("YLR028C",556).
component("YHR144C",444).
component("YGR267C",421).
...
component("YJL126W",478).
component("U44_",103).
component("YDL100C",230).
component("U87_",133).
component("YMR267W",630).
component("YBR011C",162).
component("YBR111C",180).
component("YCL030C",208).
component("YER005W",320).
component("YIL048W",451).
component("YER166W",346).
component("YDR093W",267).
...
component("YDR380W",296).
component("YDL080C",226).
component("U98_",141).
component("YMR250W",628).
component("YKL184W",535).
component("YNR043W",679).
component("U93_",139).
component("YDR047W",262).
component("U54_",111).
component("YKL211C",537) :- not remove_orf("YKL211C",537).
component("YOL052C",687).
component("YNL169C",652).
component("YGR170W",404).
component("YKL060C",521).
component("YNL256W",660).
component("YDR294C",288).
component("YEL046C",315).
component("YNR033W",677).
component("YKL211C",538) :- not remove_orf("YKL211C",538).
component("YER090W",538) :- not remove_orf("YER090W",538).
component("YER090W",339) :- not remove_orf("YER090W",339).
component("YDR127W",272).
component("YPL281C",767).
component("YOR393W",739).
component("YMR323W",638).
component("YHR174W",446).
component("YGR254W",419).
component("YPL262W",760).
component("YGL026C",371) :- not remove_orf("YGL026C",371).
component("YGR155W",403).
component("YLR304C",583).
component("YJL200C",489).
component("YNL316C",669).
component("YKL182W",533).
component("YPL212C",753).
component("YNL292W",667).
component("YGL063W",375).
component("YFL001W",349).
component("YOR278W",724).
component("YPR002W",769).
component("YDR127W",273).
component("YGL148W",379).
component("YER086W",336).
component("YLR359W",591).
component("YAL012W",143).
component("YFR055W",364).
component("YJL121C",477).
component("YBR019C",165).
component("YBR019C",166).
component("YDR050C",263).
component("YDR007W",253) :- not remove_orf("YDR007W",253).
component("YOR095C",705).
component("YER003C",319).
component("YBR196C",191).
component("YGL001C",366).
component("U14_",37).
component("YOL056W",689).
component("YKL152C",531).
component("YDL021W",218).
component("YMR105C",614).
component("YKL127W",525).
component("YEL058W",318).
component("YPR060C",773).
component("YHR072W",438).
component("YJL153C",484).
component("YPL097W",746).
component("YGR185C",409).
component("YHR011W",430).
component("YDR023W",256).
component("YPL104W",747).
component("YLL018C",550).
component("YPR081C",778).
component("YBR121C",182).
component("YHR020W",432).
component("YER087W",337).
component("YNL247W",656).
component("YOL033W",686).
component("YHR091C",440).
component("YDR341C",294).
component("YOL097C",695).
component("YDR268W",286).
component("YPR047W",772).
component("YLR060W",559).
component("YFL022C",353).
component("YPR033C",771).
component("YHR019C",431).
component("YPL160W",749).
component("YLR382C",592).
component("YNL073W",644).
component("YDR037W",258).
component("YOR335C",729).
component("YGR094W",398).
component("YOR142W",709).
component("YGR244C",417).
component("U89_",135).
component("YOR241W",723).
component("YMR113W",616).
component("YKL132C",526).
component("YJL101C",476).
component("U92_",138).
...
component("YJR103W",501).
component("YBL039C",154).
component("YGR204W",413).
component("YBR084W",177).
component("YOL058W",690).
component("YBR208C",193).
component("YHR074W",439).
component("YMR217W",625).
component("YPR145W",782).
component("YGR124W",401).
component("YOR303W",725).
component("YJR109C",504).
component("YJL130C",480).
component("YGL062W",374).
component("YBR218C",194).
component("YPL231W",758).
component("YNR016C",675).
component("YKL182W",534).
component("YGR037C",392).
component("YOR005C",702).
component("YDL164C",241).
component("YOL010W",683).
component("YPR138C",781).
component("YPL274W",764).
component("YPL265W",761).
component("YPL057C",744).
component("YPL036W",743).
component("YOR348C",733).
component("YOR192C",715).
component("YOR171C",712).
component("YOR071C",704).
component("YOL156W",701).
component("YOL103W",696).
component("YOL020W",685) :- not remove_orf("YOL020W",685).
component("YNR056C",680).
component("YNL318C",670).
component("YNL268W",663).
component("YNL142W",650).
component("YMR272C",631).
component("YML123C",607).
component("YLR348C",588).
component("YLR260W",578).
component("YLR237W",576).
component("YLR138W",565).
component("YLR100C",562).
component("YLR081W",560).
component("YLL061W",553).
component("YLL043W",552).
component("YKR093W",548).
component("YKR053C",546).
component("YKR039W",545) :- not remove_orf("YKR039W",545).
component("YKL217W",540).
component("YKL004W",515).
component("YJR152W",511).
component("YJR095W",500).
component("YJR077C",498).
component("YJL219W",490).
component("YJL134W",481).
component("YJL129C",479).
component("YHL036W",426).
component("YGR121C",399).
component("YGR055W",394).
component("YGL186C",381).
component("YGL077C",377).
component("YGL008C",367).
component("YFL055W",356).
component("YFL011W",350).
component("YER060W-A",329).
component("YER060W",328).
component("YER056C",327).
component("YER053C",325).
component("YEL017C-A",314).
component("YDR536W",313).
component("YDR508C",309).
component("YDR503C",308).
component("YDR497C",307).
component("YDR297W",290).
component("YDR294C",289).
component("YDR046C",261) :- not remove_orf("YDR046C",261).
component("YDL210W",247).
component("YCR032W",214).
component("YCR024C-A",213).
component("YCL025C",207).
component("YBR298C",204).
component("YBR291C",203).
...
catalyst(6160,634).
catalyst(3870,326).
catalyst(3620,295) :- not remove_reaction(3620,295).
catalyst(2110,362).
catalyst(2190,362).
catalyst(5550,506).
catalyst(5791,574).
...
catalyst(1960,262).
catalyst(3460,111).
catalyst(3600,537) :- not remove_reaction(3600,537).
catalyst(3941,687).
catalyst(3942,687).
catalyst(6890,652).
catalyst(6900,404).
...
catalyst(4560,315).
catalyst(2550,677).
catalyst(1890,538) :- not remove_reaction(1890,538).
catalyst(3630,538) :- not remove_reaction(3630,538).
...
catalyst(8281,263).
catalyst(8282,263).
catalyst(3610,253) :- not remove_reaction(3610,253).
catalyst(7921,705).
catalyst(7922,705).
catalyst(7841,319).
catalyst(7842,319).
...
catalyst(1200,701).
catalyst(1160,696).
catalyst(801,685) :- not remove_reaction(801,685).
catalyst(802,685) :- not remove_reaction(802,685).
catalyst(811,685) :- not remove_reaction(811,685).
catalyst(812,685) :- not remove_reaction(812,685).
catalyst(831,685) :- not remove_reaction(831,685).
catalyst(832,685) :- not remove_reaction(832,685).
catalyst(901,685) :- not remove_reaction(901,685).
catalyst(902,685) :- not remove_reaction(902,685).
catalyst(941,685) :- not remove_reaction(941,685).
catalyst(942,685) :- not remove_reaction(942,685).
catalyst(700,680).
catalyst(1200,670).
catalyst(761,663).
catalyst(762,663).
...
catalyst(640,548).
catalyst(6560,546).
catalyst(761,545) :- not remove_reaction(761,545).
catalyst(762,545) :- not remove_reaction(762,545).
catalyst(771,545) :- not remove_reaction(771,545).
catalyst(772,545) :- not remove_reaction(772,545).
catalyst(781,545) :- not remove_reaction(781,545).
catalyst(782,545) :- not remove_reaction(782,545).
catalyst(791,545) :- not remove_reaction(791,545).
catalyst(792,545) :- not remove_reaction(792,545).
catalyst(801,545) :- not remove_reaction(801,545).
catalyst(802,545) :- not remove_reaction(802,545).
catalyst(811,545) :- not remove_reaction(811,545).
catalyst(812,545) :- not remove_reaction(812,545).
catalyst(821,545) :- not remove_reaction(821,545).
catalyst(822,545) :- not remove_reaction(822,545).
catalyst(831,545) :- not remove_reaction(831,545).
catalyst(832,545) :- not remove_reaction(832,545).
catalyst(841,545) :- not remove_reaction(841,545).
catalyst(842,545) :- not remove_reaction(842,545).
catalyst(861,545) :- not remove_reaction(861,545).
catalyst(862,545) :- not remove_reaction(862,545).
catalyst(881,545) :- not remove_reaction(881,545).
catalyst(882,545) :- not remove_reaction(882,545).
catalyst(901,545) :- not remove_reaction(901,545).
catalyst(902,545) :- not remove_reaction(902,545).
catalyst(911,545) :- not remove_reaction(911,545).
catalyst(912,545) :- not remove_reaction(912,545).
catalyst(941,545) :- not remove_reaction(941,545).
catalyst(942,545) :- not remove_reaction(942,545).
catalyst(1191,545) :- not remove_reaction(1191,545).
catalyst(1192,545) :- not remove_reaction(1192,545).
catalyst(1021,540).
catalyst(1022,540).
catalyst(6610,515).
catalyst(170,511).
...
catalyst(6650,290).
catalyst(6550,289).
catalyst(791,261) :- not remove_reaction(791,261).
catalyst(792,261) :- not remove_reaction(792,261).
...
catalyst(861,261) :- not remove_reaction(861,261).
catalyst(862,261) :- not remove_reaction(862,261).
catalyst(901,261) :- not remove_reaction(901,261).
catalyst(902,261) :- not remove_reaction(902,261).
catalyst(730,247).
catalyst(431,214).
catalyst(432,214).
catalyst(220,213).
