...
component("YGR060W",134).
component("YGL012W",124).
component("YOL086C",225).
component("YMR303C",207).
component("YGL256W",132).
component("YDL168W",77).
component("YBR145W",57).
component("YPL231W",249).
component("YGL001C",121).
component("YML056C",196).
component("YLR432W",194).
component("YHR216W",149).
component("YAR075W",46).
component("YAR073W",45).
component("YDR127W",87).
component("YJR139C",172).
component("YOR136W",230).
component("YIL155C",153).
component("YJR078W",166).
component("YJR025C",163).
component("YMR015C",200).
component("YDR402C",99).
component("YJR104C",169).
component("YHR008C",143).
component("YER070W",109).
component("YGL154C",130).
component("YMR170C",203).
component("YMR169C",202).
component("YBR166C",59).
component("YER014W",107).
component("YEL047C",106).
component("YOR375C",242).
component("YDL215C",78).
component("YAL062W",44).
component("YOR236W",237).
component("U62_",37).
component("YPL017C",245).
component("YFL018C",113).
component("U47_",33).
component("YKL024C",175).
component("YPR074C",259).
component("YBR117C",56).
component("YCL009C",68).
component("YPL231W",250).
component("YPL001W",244).
component("YPL231W",251).
component("YPL028W",246).
component("YNL029C",209).
component("YIL085C",151).
component("YLR209C",189).
component("YER055C",108).
component("YDR354W",96) :- not remove_orf("YDR354W",96).
component("YFR047C",119).
component("YJR133W",171).
component("YDR399W",97).
component("YDR127W",88).
component("YJR130C",170).
component("YDR035W",83).
component("YBR249C",62).
component("YBR256C",63).
component("YHR137W",145).
component("YLR027C",186).
component("YKL106W",176).
component("U64_",38).
component("U51_",34).
component("YJR148W",173).
component("YGL253W",131).
component("YFR053C",120).
component("YMR205C",205).
component("YGR240C",140).
component("YCR036W",72).
component("U15_",21).
component("YKL001C",174).
component("YML070W",197).
component("YFL053W",115).
component("U83_",41).
component("YMR208W",206).
component("YOR347C",241).
component("YAL038W",43).
component("U1_",26).
component("YNL267W",216).
component("YLR305C",193).
component("YFR019W",117).
component("YDR208W",93).
component("YDR127W",89).
component("U20_",29).
component("YDR300C",95).
component("U76_",40).
component("YDR454C",101).
component("YOL061W",224).
component("YKL181W",178).
component("YHL011C",142).
component("YER099C",112).
component("YBL068W",49).
component("YOR143C",231).
component("YCL050C",70).
component("YPR190C",263).
component("YPR187W",262).
component("YPR110C",260).
component("YPR010C",255).
component("YOR341W",240).
component("YOR340C",239).
component("YOR224C",236).
component("YOR210W",235).
component("YOR207C",233).
component("YOR151C",232).
component("YOR116C",229).
component("YOL005C",221).
component("YNR003C",218).
component("YNL248C",215).
component("YNL151C",214).
component("YNL113W",212).
component("YKL144C",177).
component("YJR063W",164).
component("YJL148W",161).
component("YJL140W",160).
component("YIL021W",150).
component("YHR143W-A",146).
component("YGL070C",128).
component("YFL036W",114).
component("YDR404C",100).
component("YDR156W",92).
component("YDR045C",84).
component("YDL150W",75).
component("YDL140C",74).
component("YBR154C",58).
component("YDR058C",86).
component("YOL011W",222).
component("YMR008C",199).
component("YMR006C",198).
component("YBL015W",47).
component("U84_",42).
component("YPR073C",257).
component("YHR215W",148).
component("YDL024C",73).
component("YBR093C",54).
component("YBR092C",53).
component("YPL228W",248).
component("YMR180C",204).
component("YDL236W",80).
component("YJL155C",162).
component("YPR073C",258).
component("YOR208W",234).
component("YNL053W",211).
component("YMR036C",201).
component("YIR026C",154).
component("YIL113W",152).
component("YFR028C",118).
component("YER075C",110).
component("YDL230W",79).
component("YBR276C",64).
component("U30_",32).
component("U24_",31).
component("YKR031C",183).
component("YLR286C",192).
component("YDR400W",98).
component("YML035C",195).
component("YJL070C",156).
component("YBR284W",65).
component("YNL045W",210).
component("YGL037C",126).
component("U53_",35).
component("YIR032C",155).
component("YDL238C",81).
component("YLR245C",191).
component("YJL126W",158).
component("YBR111C",55).
component("YLR231C",190).
component("YLR134W",188).
component("YLR044C",187).
component("YGR087C",135).
component("U54_",36).
component("YKL211C",181) :- not remove_orf("YKL211C",181).
component("YGR170W",139).
component("YDR294C",94).
component("YNR033W",220).
component("YKL211C",182) :- not remove_orf("YKL211C",182).
component("YER090W",182) :- not remove_orf("YER090W",182).
component("YER090W",111) :- not remove_orf("YER090W",111).
component("YDR127W",90).
component("YPL281C",254).
component("YOR393W",243).
component("YMR323W",208).
component("YHR174W",147).
component("YGR254W",141).
component("YGL026C",125) :- not remove_orf("YGL026C",125).
component("YGR155W",138).
component("YNL316C",217).
component("YKL182W",179).
component("YDR127W",91).
component("YGL148W",129).
component("YDR007W",82) :- not remove_orf("YDR007W",82).
component("YOR095C",228).
component("YGL001C",122).
component("YPR060C",256).
component("YOL097C",226).
component("YOR335C",238).
component("YGR094W",136).
component("YJL101C",157).
component("YJR103W",168).
component("YBL039C",48).
component("YBR208C",60).
component("YHR074W",144).
component("YGL062W",127).
component("YBR218C",61).
component("YPL231W",252).
component("YNR016C",219).
component("YKL182W",180).
component("YGR037C",133).
component("YOR005C",227).
component("YDL164C",76).
component("YPR138C",261).
component("YPL265W",253).
component("YPL036W",247).
component("YOL020W",223) :- not remove_orf("YOL020W",223).
component("YNL142W",213).
component("YKR053C",185).
component("YKR039W",184) :- not remove_orf("YKR039W",184).
component("YJR095W",167).
component("YJR077C",165).
component("YJL134W",159).
component("YGR121C",137).
component("YGL008C",123).
component("YFL055W",116).
component("YEL017C-A",105).
component("YDR536W",104).
component("YDR508C",103).
component("YDR503C",102).
component("YDR046C",85) :- not remove_orf("YDR046C",85).
component("YCR024C-A",71).
component("YCL025C",69).
component("YBR298C",67).
component("YBR291C",66).
component("YBR069C",52) :- not remove_orf("YBR069C",52).
component("YBR068C",51) :- not remove_orf("YBR068C",51).
component("YBR021W",50).
component("U71_",39).
component("U228_",30).
component("U206_",28).
component("U202_",27).
...
catalyst(7550,135).
catalyst(3460,36).
catalyst(3600,181) :- not remove_reaction(3600,181).
catalyst(6900,139).
catalyst(8781,94).
catalyst(8782,94).
catalyst(2550,220).
...
catalyst(8231,141).
catalyst(8232,141).
catalyst(3590,125) :- not remove_reaction(3590,125).
catalyst(10910,125) :- not remove_reaction(10910,125).
catalyst(4570,138).
catalyst(3680,217).
catalyst(7141,179).
catalyst(7142,179).
catalyst(3750,91).
catalyst(3700,129).
catalyst(3610,82) :- not remove_reaction(3610,82).
catalyst(7921,228).
catalyst(7922,228).
catalyst(6370,122).
catalyst(3690,256).
...
catalyst(781,184) :- not remove_reaction(781,184).
catalyst(782,184) :- not remove_reaction(782,184).
...
catalyst(881,184) :- not remove_reaction(881,184).
catalyst(882,184) :- not remove_reaction(882,184).
catalyst(1191,184) :- not remove_reaction(1191,184).
catalyst(1192,184) :- not remove_reaction(1192,184).
catalyst(1250,167).
catalyst(1581,165).
catalyst(1582,165).
catalyst(6560,159).
...
catalyst(831,85) :- not remove_reaction(831,85).
catalyst(832,85) :- not remove_reaction(832,85).
catalyst(220,71).
catalyst(771,69).
catalyst(772,69).
catalyst(781,69).
...
catalyst(1501,66).
catalyst(1502,66).
catalyst(771,52) :- not remove_reaction(771,52).
catalyst(772,52) :- not remove_reaction(772,52).
...
catalyst(831,51) :- not remove_reaction(831,51).
catalyst(832,51) :- not remove_reaction(832,51).
catalyst(620,50).
catalyst(2930,39).
catalyst(41,30).
catalyst(42,30).
