...
component("YLR056W",699).
component("YGR060W",492).
component("YGL012W",457).
component("YKR009C",681).
component("YOL086C",866).
component("YMR303C",799).
component("YMR083W",768).
component("YGL256W",484).
...
component("YJR159W",647).
component("YGL001C",454).
component("YIL094C",572).
component("YHR063C",544).
component("U45_",127).
component("YBR153W",229).
component("YML056C",749).
component("YLR432W",740).
component("YHR216W",562).
...
component("YLR450W",742).
component("YOL126C",871).
component("YKL085W",657).
component("YDL078C",281).
component("YKL029C",652).
component("YOR136W",887).
component("YNL037C",804).
component("YDL066W",279).
component("YNL241C",822).
component("YOL059W",864).
component("YDL022W",272).
component("YLR355C",735).
component("YIL074C",570).
component("YER081W",421).
component("YML054C",748).
component("YDL174C",304).
component("YML086C",753).
component("YIL155C",580).
component("YPR191W",987).
component("YOR065W",878).
component("YJL166W",612).
component("YHR001W-A",532).
component("YGR183C",508).
component("YFR033C",450).
component("YDR529C",386).
component("YBL045C",193).
component("Q0105",18).
component("YGR088W",495).
component("YDR256C",354).
component("YKL026C",651).
component("YIR037W",592).
component("YBR244W",241).
component("YJR078W",632).
component("U58_",140).
component("YJR025C",624).
component("YGR255C",520).
component("U108_",25).
component("YBL098W",197).
component("YMR015C",764).
component("YHR007C",533).
component("YDR402C",374).
component("YGL055W",464).
component("YGR175C",505).
component("YJR104C",635).
component("YHR008C",534).
component("YJL026W",595).
component("YIL066C",569).
component("YGR180C",507).
...
component("U2_",114).
component("YER178W",435).
component("YBR221C",239).
component("YIL125W",577).
component("U52_",134).
component("YBR166C",232).
component("YNL280C",833).
component("YGL012W",458).
component("YKL182W",669).
component("U57_",139).
component("YKL216W",678).
component("YDR044W",321).
component("YER014W",402).
component("YKR009C",682).
component("YIL160C",582).
component("YGL205W",478).
component("YMR118C",773).
component("YLR164W",712).
component("YLL041C",691).
component("YKL148C",664).
component("YKL141W",662).
component("YJL045W",596).
component("YDR178W",347).
component("YJR051W",627).
component("YEL047C",396).
component("YDL171C",303).
component("YDL215C",308).
...
component("U56_",138).
component("YNR050C",848).
component("YHR037W",540).
component("YKR080W",686).
component("YER023W",404).
component("YPL023C",928).
component("YGL125W",470).
component("YOR236W",903).
component("YGR204W",512).
component("YLR142W",707).
component("U63_",144).
component("U62_",143).
component("YOR356W",919).
component("YKL150W",665).
component("YIL043C",566).
component("YHR042W",541).
component("YOR221C",900).
component("YML120C",757).
component("YKL192C",673).
component("YKL055C",654).
component("YER061C",413).
component("YMR145C",776).
component("YML120C",758).
component("YKL192C",674).
component("YDL085W",283).
component("YGR234W",515).
component("YFR030W",449).
component("YPL017C",927).
component("YFL018C",440).
component("YPL091W",933).
component("YDR353W",369).
component("YER042W",406).
component("YJR137C",640).
component("YNL052W",806).
component("YMR256C",790).
component("YLR395C",739).
component("YLR038C",697).
component("YIL111W",574).
...
component("YML110C",756).
component("YBR034C",209).
component("YPL273W",958).
component("YLL062C",694).
component("YDR410C",377).
component("U47_",129).
component("YER091C",426).
component("YJR073C",630).
component("YDR120C",335).
component("YDL033C",274).
component("YOL096C",867).
component("YLR172C",713).
component("YDR019C",317).
component("YBR176W",233).
component("YDR408C",376).
component("YMR120C",774).
component("YBL013W",187).
component("YKL024C",650).
component("YPR074C",975).
component("YBR117C",222).
component("YLR354C",734).
component("YGR043C",490).
component("YMR108W",771).
component("YCL009C",253).
component("YMR062C",767).
component("YNL071W",808).
component("YNR008W",840).
component("YIL160C",583).
component("YNL277W",831).
component("YDR232W",350).
component("YFL017C",439).
component("YPL231W",950).
component("YER061C",414).
component("U86_",164).
component("YPL001W",926).
component("YMR296C",797).
component("YDR062W",329).
component("YDL052C",277).
component("U8_",168).
component("YDR148C",343).
component("YOR377W",923).
component("YGR177C",506).
component("YPL231W",951).
component("YGR147C",501).
component("YDL040C",275).
component("YPL028W",929).
component("YLR195C",714).
component("YGL017W",459).
component("YPR001W",963).
component("YNR001C",838).
component("YCR005C",261).
component("YNL104C",811).
component("YDL182W",305).
component("YDL131W",292).
component("YNL117W",813).
component("YIR031C",590).
component("YOR321W",910).
component("YJR143C",642).
component("YGR199W",511).
component("YDR307W",363).
component("YDL095W",287).
component("YDL093W",286).
component("YAL023C",179).
component("YOR103C",882).
component("YOR085W",880).
component("YMR149W",777).
component("YML019W",744).
component("YJL002C",593).
component("YEL002C",390).
component("YDL232W",311).
component("YCL043C",258).
component("YNL029C",803).
component("YIL085C",571).
component("YMR261C",791).
component("YML100W",754).
component("YBR126C",225).
component("YNL192W",821).
component("YBR038W",212).
component("YBR023C",208).
component("YMR306W",801).
component("YLR342W",732).
component("YGR032W",488).
component("YPR183W",984).
component("YLR209C",715).
component("U104_",23).
component("YMR271C",793).
component("YML106W",755).
component("YOR209C",898).
component("YMR300C",798).
component("YER055C",409).
component("YDR354W",370) :- not remove_orf("YDR354W",370).
component("YFR047C",451).
component("YJR133W",639).
component("YLR209C",716).
component("YML022W",745).
component("YDR441C",380).
component("YDR399W",372).
component("YPR176C",983).
component("YPL172C",941).
component("YNR041C",846).
component("YMR101C",769).
component("YDL090C",285).
component("YBR003W",199).
component("YBR002C",198).
component("YJL167W",613).
component("YJL167W",614).
component("YNL256W",825).
component("YPR069C",972).
component("YDR127W",338).
component("YLR303W",723).
component("YGR012W",486).
component("YJR130C",638).
component("YLR303W",724).
component("YDR035W",319).
component("YBR249C",242).
component("YOR274W",906).
component("YOL143C",874).
component("YBR256C",244).
component("YHR137W",553).
component("YGL202W",477).
component("YLR027C",695).
component("YKL106W",659).
component("YOL140W",873).
component("YKL104C",658).
component("YGR019W",487).
component("YLR089C",702).
component("U64_",145).
component("U61_",142).
component("U51_",133).
component("YJR148W",643).
component("YHR208W",560).
component("YFL030W",442).
component("YOR184W",893).
component("YNR058W",851).
component("YIL116W",576).
component("YGL253W",483).
component("YFR053C",452).
component("YOL136C",872).
component("YIL107C",573).
component("YMR013C",763).
component("YMR205C",783).
component("YGR240C",516).
component("YDR248C",353).
component("YCR036W",267).
component("YGR194C",510).
component("YCL040W",257).
component("YJR105W",636).
component("U16_",63).
component("U15_",56).
component("YPL188W",943).
component("YJR049C",626).
component("YEL041W",394).
component("U96_",174).
component("YKL001C",648).
component("YDR236C",351).
component("YML070W",751).
component("YFL053W",444).
component("YHL032C",530).
component("YLR133W",704).
...
component("YOR061W",877).
component("YKL166C",667).
component("YJL164C",611).
component("YIL035C",565).
component("YHR205W",559).
component("YHR102W",551).
component("YGL019W",460).
component("YHR025W",539).
component("YOR347C",917).
component("YAL038W",181).
component("YNR012W",841).
component("YPR121W",979).
...
component("YNL267W",829).
component("YLR305C",726).
component("YFR019W",447).
component("YDR208W",348).
...
component("YER170W",434).
component("YDR226W",349).
component("YKL067W",656).
component("YOL055C",861).
component("YDR454C",381).
component("YJR057W",628).
component("YOL061W",865).
component("YKL181W",668).
component("YHL011C",527).
component("YER099C",428).
component("YBL068W",196).
component("YOR143C",889).
component("YNL256W",826).
component("YLR328W",730).
component("YBR018C",202).
component("YBR018C",203).
component("YGR007W",485).
component("YLR328W",731).
component("YKR002W",680).
component("U80_",158).
component("YDL103C",290).
component("U94_",173).
component("YJR010W",622).
component("YGL130W",471).
component("YDR530C",387).
component("YCL050C",259).
component("YPR190C",986).
component("YPR187W",985).
component("YPR110C",977).
component("YPR010C",966).
component("YOR341W",916).
component("YOR340C",915).
component("YOR224C",902).
component("YOR210W",899).
component("YOR207C",896).
component("YOR151C",890).
component("YOR116C",883).
component("YOL005C",853).
component("YNR003C",839).
component("YNL248C",824).
component("YNL151C",818).
component("YNL113W",812).
component("YKL144C",663).
component("YJR063W",629).
component("YJL148W",608).
component("YJL140W",607).
component("YIL021W",564).
component("YHR143W-A",554).
component("YGL070C",468).
component("YFL036W",443).
component("YDR404C",375).
component("YDR156W",344).
component("YDR045C",322).
component("YDL150W",299).
component("YDL140C",294).
component("YBR154C",231).
component("YPR175W",982).
component("YPL167C",940).
component("YOR330C",912).
component("YOL115W",870).
component("YNL299W",835).
component("YNL262W",828).
component("YNL102W",810).
component("YJR043C",625).
component("YJR006W",621).
component("YJL090C",600).
component("YIL139C",579).
component("YEL055C",397).
component("YDR419W",378).
component("YDR121W",336).
component("YDL102W",289).
component("YCR014C",263).
component("YBR278W",247).
component("YBL035C",190).
component("YKL035W",653).
component("YHL012W",528).
component("YHR123W",552).
component("YPR113W",978).
component("YBR243C",240).
component("YNL130C",814).
component("YDL142C",298).
component("YPL148C",938).
component("YER026C",405).
component("YCL004W",252).
component("YOR251C",905).
component("YGR286C",524).
component("YJL068C",597).
component("YDR058C",327).
component("YNR034W",845).
component("YHR163W",556).
component("YGR248W",518).
component("YCR073W-A",269).
component("YDL086W",284).
component("YOL011W",855).
component("YMR008C",761).
component("YMR006C",760).
component("U105_",24).
component("U101_",21).
component("YBL015W",188).
component("YJL068C",598).
component("YPL072W",932).
component("YOR124C",884).
component("YNL186W",820).
component("YMR304W",800).
component("YMR223W",787).
component("YKR098C",689).
component("YJL197W",615).
component("YIL156W",581).
component("YFR010W",446).
component("YER151C",432).
component("YER144C",431).
component("YER098W",427).
component("YDR069C",330).
component("YDL122W",291).
component("YBR058C",213).
component("YBL067C",195).
component("YDR272W",357).
component("U84_",162).
component("YDR481C",382).
component("YLR377C",737).
component("YDR074W",331).
component("YPL179W",942).
component("YNR032W",843).
component("YML057W",750).
component("YML016C",743).
component("YLR433C",741).
component("YGR123C",498).
component("YER133W",430).
component("YER089C",424).
component("YDR436W",379).
component("YDR075W",332).
component("YDL188C",306).
...
component("YOR208W",897).
component("YNL053W",807).
component("YMR036C",766).
component("YIR026C",587).
component("YIL113W",575).
component("YFR028C",448).
...
component("YKR031C",683).
component("YPL206C",945).
component("YGL027C",462).
component("YLR286C",721).
component("YJR153W",645).
component("YJL221C",620).
component("YJL216C",618).
component("YIL172C",586).
component("YGR292W",526).
component("YGR287C",525).
component("YBR299W",251).
component("YBR184W",234).
component("YIL162W",584).
component("YOR190W",894).
component("YLR300W",722).
component("YGR282C",523).
component("YDR261C",355).
component("YDR400W",373).
component("U23_",109).
component("YML035C",746).
component("YJL070C",599).
component("YBR284W",248).
component("U102_",22).
component("YNL045W",805).
component("YLR160C",711).
component("YLR158C",710).
component("YLR157C",709).
component("YLR155C",708).
component("YDR321W",364).
component("YGL037C",463).
component("YMR293C",796).
component("YDR242W",352).
component("YLR308W",729).
component("YLR307W",728).
component("YBR208C",236).
component("YMR281W",795).
component("U53_",135).
component("YIR027C",588).
component("YPL111W",936).
component("YIR032C",591).
component("YIR029W",589).
component("YPR062W",971).
component("YMR120C",775).
component("YLR028C",696).
component("YHR144C",555).
component("YGR267C",522).
component("YNL141W",815).
component("YBL033C",189).
component("YBR153W",230).
component("YDL238C",313).
component("YNL141W",816).
component("YLR245C",719).
...
component("U87_",165).
component("U40_",124).
component("YMR267W",792).
component("YBR011C",201).
component("YHR201C",558).
component("YBR111C",221).
component("YBR252W",243).
component("YCL030C",256).
component("YER005W",401).
component("YIL048W",567).
component("YER166W",433).
component("YDR093W",334).
component("YAL026C",180).
component("YLR231C",717).
component("U88_",166).
component("YLR134W",705).
component("YLR044C",698).
component("YGR087C",494).
component("YDR380W",371).
component("YDL080C",282).
component("U98_",175).
component("YMR250W",789).
component("YKL184W",672).
component("YOR128C",885).
component("YEL021W",393).
component("YNR043W",847).
component("U93_",172).
component("YDR047W",324).
component("U54_",136).
component("YKL211C",676) :- not remove_orf("YKL211C",676).
component("YKR097W",688).
component("YOL052C",859).
component("YNL169C",819).
component("YGR170W",503).
component("YKL060C",655).
component("YNL256W",827).
component("YDR294C",359).
component("YEL046C",395).
component("YNR033W",844).
component("YPR006C",965).
component("YER065C",416).
component("YKL211C",677) :- not remove_orf("YKL211C",677).
component("YER090W",677) :- not remove_orf("YER090W",677).
component("YER090W",425) :- not remove_orf("YER090W",425).
component("YDR127W",340).
component("YPL281C",962).
component("YOR393W",925).
component("YMR323W",802).
component("YHR174W",557).
component("YGR254W",519).
component("YPL262W",954).
component("YGL026C",461) :- not remove_orf("YGL026C",461).
component("YGR155W",502).
component("YLR304C",725).
component("YJL200C",616).
component("YNL316C",836).
component("YKL182W",670).
component("YPL212C",946).
component("YNL292W",834).
component("YGL063W",467).
component("YFL001W",437).
component("YOR278W",907).
component("YPR002W",964).
component("U49_",130).
component("YJR016C",623).
component("YCR053W",268).
component("YDR127W",341).
component("YGL148W",472).
component("YIL168W",585).
component("YER086W",422).
component("YCL064C",260).
component("YLR359W",736).
component("YAL012W",178).
component("YFR055W",453).
component("YJL005W",594).
component("YOR176W",892).
...
component("YOR095C",881).
component("YER003C",400).
component("YBR196C",235).
component("YGL001C",455).
component("U14_",48).
component("YOL056W",862).
component("YKL152C",666).
component("YDL021W",271).
component("YMR105C",770).
component("YKL127W",660).
component("YEL058W",398).
component("YPR060C",970).
component("YHR072W",545).
component("YJL153C",609).
component("YPL097W",934).
component("YGR185C",509).
component("YGR264C",521).
component("YGR171C",504).
component("YHR011W",535).
component("YDR023W",318).
component("YPL104W",935).
component("YLL018C",690).
component("YPR081C",976).
component("YBR121C",223).
component("YHR020W",538).
component("YER087W",423).
component("YNL247W",823).
component("YOL033W",857).
component("YGL245W",481).
component("YHR091C",547).
component("YDR341C",365).
component("YOL097C",868).
component("YDR268W",356).
component("YPR047W",969).
component("YLR060W",700).
component("YFL022C",441).
component("YPR033C",967).
component("YHR019C",536).
component("YCR024C",264).
component("YHR019C",537).
component("YPL160W",939).
component("YLR382C",738).
component("YNL073W",809).
component("YDR037W",320).
component("YOR335C",913).
component("YGR094W",496).
component("YOR317W",909).
component("YMR246W",788).
component("YIL009W",563).
component("YER015W",403).
component("YOR142W",888).
component("YGR244C",517).
component("YPR035W",968).
component("U89_",167).
component("YOR241W",904).
component("YMR113W",772).
component("YKL132C",661).
component("YOR339C",914).
component("YMR022W",765).
component("YLR306W",727).
component("YKL210W",675).
component("YGR133W",500).
component("YGL058W",465).
component("YER100W",429).
component("YEL012W",391).
component("YDR177W",346).
component("YDR092W",333).
component("YDR059C",328).
component("YDR054C",326).
component("YDL064W",278).
component("YBR082C",216).
component("YJL101C",601).
component("YOL049W",858).
component("U92_",171).
component("YAR015W",183).
component("YGL234W",479).
component("YER183C",436).
component("U91_",170).
component("U90_",169).
component("YNR057C",850).
component("YDL141W",295).
component("YDL141W",296).
component("YGL234W",480).
component("YDL141W",297).
component("YJR103W",634).
component("YBL039C",191).
component("YGR204W",513).
component("YBR084W",218).
component("YOL058W",863).
component("YBR208C",237).
component("YHR074W",546).
component("YMR217W",785).
component("YGR061C",493).
component("YPR145W",981).
component("YGR124W",499).
component("YOR303W",908).
component("YJR109C",637).
component("YJL130C",605).
component("YGL062W",466).
component("YBR218C",238).
component("YPL231W",952).
component("YNR016C",842).
component("YKL182W",671).
component("YGR037C",489).
component("YOR005C",876).
component("YDL164C",300).
component("YOL010W",854).
component("YPR138C",980).
component("YPL274W",959).
component("YPL265W",955).
component("YPL134C",937).
component("YPL057C",931).
component("YPL036W",930).
component("YOR348C",918).
component("YOR222W",901).
component("YOR192C",895).
component("YOR171C",891).
component("YOR130C",886).
component("YOR071C",879).
component("YOL156W",875).
component("YOL103W",869).
component("YOL020W",856) :- not remove_orf("YOL020W",856).
component("YNR072W",852).
component("YNR056C",849).
component("YNL318C",837).
component("YNL268W",830).
component("YNL142W",817).
component("YMR272C",794).
component("YMR202W",782).
component("YMR011W",762).
component("YML123C",759).
component("YLR348C",733).
component("YLR260W",720).
component("YLR237W",718).
component("YLR138W",706).
component("YLR100C",703).
component("YLR081W",701).
component("YLL061W",693).
component("YLL043W",692).
component("YKR093W",687).
component("YKR053C",685).
component("YKR039W",684) :- not remove_orf("YKR039W",684).
component("YKL217W",679).
component("YKL004W",649).
component("YJR158W",646).
component("YJR152W",644).
...
component("YIL134W",578).
component("YHR096C",550).
component("YHR094C",549).
component("YHR092C",548).
component("YHL036W",531).
component("YHL016C",529).
component("YGR121C",497).
component("YGR055W",491).
component("YGL186C",474).
component("YGL077C",469).
component("YGL008C",456).
component("YFL055W",445).
component("YFL011W",438).
component("YER060W-A",412).
component("YER060W",411).
component("YER056C",410).
component("YER053C",408).
component("YEL069C",399).
component("YEL017C-A",392).
component("YDR536W",389).
component("YDR508C",385).
component("YDR503C",384).
component("YDR497C",383).
component("YDR345C",368).
component("YDR343C",367).
component("YDR342C",366).
component("YDR297W",361).
component("YDR294C",360).
component("YDR284C",358).
component("YDR046C",323) :- not remove_orf("YDR046C",323).
component("YDL245C",314).
component("YDL210W",307).
component("YCR032W",266).
component("YCR024C-A",265).
...
catalyst(6160,798).
catalyst(3870,409).
catalyst(3620,370) :- not remove_reaction(3620,370).
catalyst(2110,451).
catalyst(2190,451).
catalyst(5550,639).
catalyst(5791,716).
...
catalyst(1960,324).
catalyst(3460,136).
catalyst(3600,676) :- not remove_reaction(3600,676).
catalyst(8000,688).
catalyst(3941,859).
catalyst(3942,859).
catalyst(6890,819).
...
catalyst(8020,965).
catalyst(8020,416).
catalyst(1890,677) :- not remove_reaction(1890,677).
catalyst(3630,677) :- not remove_reaction(3630,677).
...
catalyst(8051,954).
catalyst(8052,954).
catalyst(3590,461) :- not remove_reaction(3590,461).
catalyst(10910,461) :- not remove_reaction(10910,461).
catalyst(4570,502).
catalyst(8181,725).
catalyst(8182,725).
catalyst(8181,616).
...
catalyst(1210,875).
catalyst(1160,869).
catalyst(801,856) :- not remove_reaction(801,856).
catalyst(802,856) :- not remove_reaction(802,856).
catalyst(811,856) :- not remove_reaction(811,856).
catalyst(812,856) :- not remove_reaction(812,856).
catalyst(831,856) :- not remove_reaction(831,856).
catalyst(832,856) :- not remove_reaction(832,856).
catalyst(901,856) :- not remove_reaction(901,856).
catalyst(902,856) :- not remove_reaction(902,856).
catalyst(941,856) :- not remove_reaction(941,856).
catalyst(942,856) :- not remove_reaction(942,856).
catalyst(1170,852).
catalyst(1210,852).
catalyst(700,849).
catalyst(1200,837).
...
catalyst(650,687).
catalyst(6560,685).
catalyst(761,684) :- not remove_reaction(761,684).
catalyst(762,684) :- not remove_reaction(762,684).
catalyst(771,684) :- not remove_reaction(771,684).
catalyst(772,684) :- not remove_reaction(772,684).
catalyst(781,684) :- not remove_reaction(781,684).
catalyst(782,684) :- not remove_reaction(782,684).
catalyst(791,684) :- not remove_reaction(791,684).
catalyst(792,684) :- not remove_reaction(792,684).
catalyst(801,684) :- not remove_reaction(801,684).
catalyst(802,684) :- not remove_reaction(802,684).
catalyst(811,684) :- not remove_reaction(811,684).
catalyst(812,684) :- not remove_reaction(812,684).
catalyst(821,684) :- not remove_reaction(821,684).
catalyst(822,684) :- not remove_reaction(822,684).
catalyst(831,684) :- not remove_reaction(831,684).
catalyst(832,684) :- not remove_reaction(832,684).
catalyst(841,684) :- not remove_reaction(841,684).
catalyst(842,684) :- not remove_reaction(842,684).
catalyst(861,684) :- not remove_reaction(861,684).
catalyst(862,684) :- not remove_reaction(862,684).
catalyst(881,684) :- not remove_reaction(881,684).
catalyst(882,684) :- not remove_reaction(882,684).
catalyst(901,684) :- not remove_reaction(901,684).
catalyst(902,684) :- not remove_reaction(902,684).
catalyst(911,684) :- not remove_reaction(911,684).
catalyst(912,684) :- not remove_reaction(912,684).
catalyst(921,684) :- not remove_reaction(921,684).
catalyst(922,684) :- not remove_reaction(922,684).
catalyst(941,684) :- not remove_reaction(941,684).
catalyst(942,684) :- not remove_reaction(942,684).
catalyst(1191,684) :- not remove_reaction(1191,684).
catalyst(1192,684) :- not remove_reaction(1192,684).
catalyst(390,679).
catalyst(1021,679).
catalyst(1022,679).
catalyst(6610,649).
...
catalyst(861,323) :- not remove_reaction(861,323).
catalyst(862,323) :- not remove_reaction(862,323).
