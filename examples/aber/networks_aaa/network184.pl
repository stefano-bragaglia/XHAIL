...
component("YNL280C",931).
component("YLR056W",785).
component("YGR060W",547).
component("YGL012W",512).
component("YKR009C",764).
component("YOL086C",966).
component("YMR303C",896).
component("YMR083W",865).
component("YGL256W",539).
component("YDL168W",345).
component("YBR145W",265).
component("YPL231W",1057).
component("YBR265W",284).
component("U46_",157).
component("YBR149W",266).
component("YBR149W",267).
component("YJR159W",725).
component("YGL001C",509).
component("YIL094C",641).
component("YHR063C",605).
component("U45_",156).
component("YBR153W",268).
component("YML056C",845).
component("YLR432W",834).
component("YHR216W",630).
component("YAR075W",220).
component("YAR073W",219).
component("YCL030C",295).
component("YDR127W",384).
component("YJR139C",719).
component("YML075C",848).
component("YLR450W",837).
component("YOL126C",972).
component("YKL085W",736).
component("YDL078C",325).
component("YKL029C",731).
component("YOR136W",991).
component("YNL037C",902).
component("YNL009W",900).
component("YLR174W",804).
component("YDL066W",323).
component("YHR183W",624).
component("YGR256W",580).
component("YNL241C",921).
component("YOL059W",963).
component("YDL022W",315).
component("YCL018W",293).
component("YLR355C",829).
component("YIL074C",638).
component("YER081W",473).
component("YML054C",844).
component("YDL174C",349).
component("YML086C",849).
component("YIL155C",649).
component("YPR191W",1098).
component("YOR065W",980).
component("YJL166W",688).
component("YHR001W-A",592).
component("YGR183C",564).
component("YFR033C",505).
component("YDR529C",435).
component("YBL045C",227).
component("Q0105",18).
component("YGR088W",550).
component("YDR256C",402).
component("YKL026C",730).
component("YIR037W",664).
component("YBR244W",280).
component("YJR078W",710).
component("U58_",169).
component("YJR025C",701).
component("U107_",26).
component("YGR255C",579).
component("U108_",27).
component("YBL098W",231).
component("YMR015C",861).
component("YHR007C",593).
component("YDR402C",423).
component("YGL055W",519).
component("YGR175C",561).
component("YJR104C",713).
component("YHR008C",594).
component("YJL026W",667).
component("YIL066C",637).
component("YGR180C",563).
component("YER070W",470).
component("U38_",149).
component("U36_",148).
component("U35_",147).
component("YDL168W",346).
component("YDR158W",392).
component("YBR006W",236).
component("YPL276W",1069).
component("YPL275W",1068).
component("YOR388C",1029).
component("YPL061W",1037).
component("YOR374W",1026).
component("YER073W",471).
component("U68_",177).
component("YGL154C",528).
component("YBR115C",259).
component("U55_",166).
component("YER069W",468).
component("YOR323C",1016).
component("YMR170C",876).
component("YMR169C",875).
component("U2_",141).
component("YER178W",487).
component("YBR221C",278).
component("YIL125W",646).
component("U52_",163).
component("YBR166C",271).
component("YNL280C",932).
component("YGL012W",513).
component("YKL182W",750).
component("U57_",168).
component("YKL216W",761).
component("YDR044W",367).
component("YER014W",452).
component("YKR009C",765).
component("YIL160C",651).
component("YGL205W",533).
component("YMR118C",870).
component("YLR164W",802).
component("YLL041C",776).
component("YKL148C",744).
component("YKL141W",742).
component("YJL045W",668).
component("YDR178W",394).
component("YJR051W",704).
component("YEL047C",445).
component("YDL171C",347).
component("YDL171C",348).
component("YDL215C",353).
component("YOR375C",1027).
component("YDL215C",354).
component("YAL062W",215).
component("U99_",208).
component("YBR035C",246).
component("YMR189W",878).
component("U56_",167).
component("YNR050C",947).
component("YHR037W",601).
component("YKR080W",769).
component("YER023W",454).
component("YPL023C",1033).
component("YGL125W",525).
component("YOR236W",1008).
component("YGR204W",570).
component("YIR034C",663).
component("YLR142W",795).
component("U63_",174).
component("U62_",173).
component("YOR356W",1024).
component("YHR068W",606).
component("YKL150W",745).
component("YIL043C",634).
component("YHR042W",602).
component("YOR221C",1005).
component("YML120C",853).
component("YKL192C",754).
component("YKL055C",733).
component("YER061C",464).
component("YBR046C",249).
component("YPL171C",1048).
component("YHR179W",623).
component("YMR145C",873).
component("YML120C",854).
component("YKL192C",755).
component("YDL085W",327).
component("YGR234W",574).
component("YFR030W",504).
component("YPL017C",1032).
component("YFL018C",492).
component("YPL091W",1039).
component("YHR106W",615).
component("YDR353W",417).
component("YER042W",456).
component("YPR167C",1092).
component("YJR137C",718).
component("YNL052W",904).
component("YMR256C",887).
component("YLR395C",833).
component("YLR038C",783).
component("YIL111W",643).
component("YHR051W",604).
component("YGL191W",531).
component("YGL187C",530).
component("YDL067C",324).
component("Q0275",20).
component("Q0250",19).
component("YPL266W",1064).
component("YML110C",852).
component("YBR034C",245).
component("YPL273W",1066).
component("YLL062C",779).
component("YDR410C",426).
component("YOL096C",967).
component("U47_",158).
component("YER091C",478).
component("YJR073C",708).
component("YGR157W",558).
component("YDR120C",382).
component("YML008C",838).
component("YDL033C",317).
component("YOL096C",968).
component("YLR172C",803).
component("YLR058C",786).
component("YDR019C",363).
component("YBR176W",272).
component("YDR408C",425).
component("YMR120C",871).
component("YLR028C",781).
component("YBL013W",221).
component("YJL130C",680).
component("YJL088W",673).
component("YKL024C",728).
component("YPR074C",1084).
component("YBR117C",260).
component("YLR354C",828).
component("YGR043C",545).
component("YMR108W",868).
component("YCL009C",292).
component("YMR062C",864).
component("YNL071W",906).
component("YNR008W",939).
component("YIL160C",652).
component("YNL277W",930).
component("YDR232W",397).
component("YFL017C",491).
component("YPL231W",1058).
component("YER061C",465).
component("U86_",196).
component("YPL001W",1031).
component("YMR296C",894).
component("YDR062W",375).
component("YDL052C",321).
component("U8_",200).
component("YDR148C",390).
component("YAR035W",217).
component("YOR377W",1028).
component("YGR177C",562).
component("YPL231W",1059).
component("YGR147C",556).
component("YDL040C",318).
component("YPL028W",1034).
component("YLR195C",805).
component("YLR299W",815).
component("YGL017W",514).
component("YPR001W",1071).
component("YNR001C",937).
component("YCR005C",304).
component("YML126C",856).
component("YNL104C",909).
component("YDL182W",350).
component("YDL131W",336).
component("YNL117W",911).
component("YIR031C",661).
component("YOR321W",1015).
component("YJR143C",720).
component("YGR199W",568).
component("YDR307W",411).
component("YDL095W",331).
component("YDL093W",330).
component("YAL023C",211).
component("YLR258W",812).
component("YFR015C",500).
component("YOR103C",985).
component("YOR085W",982).
component("YMR149W",874).
component("YML019W",840).
component("YJL002C",665).
component("YEL002C",439).
component("YDL232W",356).
component("YCL043C",299).
component("YNL029C",901).
component("YIL085C",640).
component("YMR261C",888).
component("YML100W",850).
component("YBR126C",264).
component("YNL192W",919).
component("YBR038W",248).
component("YBR023C",244).
component("YMR306W",898).
component("YLR342W",826).
component("YGR032W",543).
component("YPR183W",1095).
component("YLR209C",806).
component("U104_",24).
component("U103_",23).
component("YMR271C",890).
component("YML106W",851).
component("YOR209C",1003).
component("YMR300C",895).
component("YER055C",460).
component("YDR354W",418) :- not remove_orf("YDR354W",418).
component("YFR047C",506).
component("YJR133W",717).
component("YLR209C",807).
component("YML022W",841).
component("YDR441C",429).
component("YDR399W",421).
component("YHR128W",617).
component("YPR176C",1094).
component("YPL172C",1049).
component("YNR041C",945).
component("YMR101C",866).
component("YDL090C",329).
component("YBR003W",235).
component("YBR002C",234).
component("YJL167W",689).
component("YJL167W",690).
component("YNL256W",924).
component("YPR069C",1081).
component("YDR127W",385).
component("YLR146C",796).
component("YHR068W",607).
component("YLR303W",817).
component("YGR012W",541).
component("YJR130C",716).
component("YLR303W",818).
component("YDR035W",365).
component("YBR249C",281).
component("YOR274W",1011).
component("YOL143C",975).
component("YBR256C",283).
component("YHR137W",618).
component("YGL202W",532).
component("YLR027C",780).
component("YKL106W",738).
component("YOL140W",974).
component("YLR438W",836).
component("YKL104C",737).
component("YGR019W",542).
component("YLR089C",790).
component("YDR111C",381).
component("U64_",175).
component("U61_",172).
component("U51_",162).
component("YJR148W",721).
component("YHR208W",628).
component("YFL030W",494).
component("YOR184W",997).
component("YNR058W",950).
component("YIL116W",645).
component("YGL253W",538).
component("YFR053C",507).
component("YOL136C",973).
component("YIL107C",642).
component("YMR013C",860).
component("YMR205C",880).
component("YGR240C",575).
component("YDR248C",401).
component("YLR240W",810).
component("YKL203C",757).
component("YJR066W",707).
component("YCR036W",310).
component("YGR194C",567).
component("YCL040W",298).
component("YJR105W",714).
component("U16_",78).
component("U15_",69).
component("YPL188W",1051).
component("YJR049C",703).
component("YEL041W",443).
component("U96_",206).
component("YKL001C",726).
component("YDR236C",399).
component("YML070W",847).
component("YFL053W",497).
component("YHL032C",590).
component("YLR133W",792).
component("YDR531W",437).
component("U83_",193).
component("U82_",192).
component("U81_",191).
component("YMR208W",881).
component("YPL203W",1052).
component("YOR061W",979).
component("YKL166C",747).
component("YJL164C",687).
component("YIL035C",633).
component("YHR205W",627).
component("YHR102W",614).
component("YGL019W",515).
component("YHR025W",600).
component("YOR347C",1022).
component("YAL038W",213).
component("YNR012W",940).
component("YPR121W",1089).
component("YPL258C",1061).
component("YOL055C",959).
component("YPL214C",1055).
component("U1_",109).
component("YDR009W",362).
component("YBR020W",242).
component("YNL267W",928).
component("YLR305C",820).
component("YFR019W",501).
component("YDR208W",395).
component("YDR127W",386).
component("U21_",127).
component("U20_",120).
component("YDR147W",389).
component("YDR300C",410).
component("YCR012W",305).
component("YER052C",458).
...
component("U17_",88).
component("U76_",186).
component("YMR220W",883).
component("YER170W",486).
component("YDR226W",396).
component("YKL067W",735).
component("YOL055C",960).
component("YDR454C",430).
component("YJR057W",705).
component("YOL061W",964).
component("YKL181W",749).
component("YHL011C",587).
component("YER099C",480).
component("YBL068W",230).
component("YOR143C",993).
component("YNL256W",925).
component("YLR328W",824).
component("YBR018C",238).
component("YBR018C",239).
component("YGR007W",540).
component("YGR202C",569).
component("YLR328W",825).
component("YKR002W",763).
component("YDL045C",319).
component("U80_",190).
component("YDL103C",334).
component("U94_",205).
component("YJR010W",698).
component("YCL050C",300).
component("YGL130W",526).
component("YDR530C",436).
component("YCL050C",301).
component("YPR190C",1097).
component("YPR187W",1096).
component("YPR110C",1087).
component("YPR010C",1074).
component("YOR341W",1021).
component("YOR340C",1020).
component("YOR224C",1007).
component("YOR210W",1004).
component("YOR207C",1001).
component("YOR151C",994).
component("YOR116C",986).
component("YOL005C",952).
component("YNR003C",938).
component("YNL248C",923).
component("YNL151C",916).
component("YNL113W",910).
component("YKL144C",743).
component("YJR063W",706).
component("YJL148W",684).
component("YJL140W",683).
component("YIL021W",632).
component("YHR143W-A",619).
component("YGL070C",523).
component("YFL036W",495).
component("YDR404C",424).
component("YDR156W",391).
component("YDR045C",368).
component("YDL150W",343).
component("YDL140C",338).
component("YBR154C",270).
component("YPR175W",1093).
component("YPL167C",1047).
component("YOR330C",1017).
component("YOL115W",971).
component("YNL299W",934).
component("YNL262W",927).
component("YNL102W",908).
component("YJR043C",702).
component("YJR006W",697).
component("YJL090C",674).
component("YIL139C",648).
component("YEL055C",446).
component("YDR419W",427).
component("YDR121W",383).
component("YDL102W",333).
component("YCR014C",306).
component("YBR278W",286).
component("YBL035C",224).
component("YKL035W",732).
component("YHL012W",588).
component("YHR123W",616).
component("YPR113W",1088).
component("YBR243C",279).
component("YNL130C",912).
component("YDL142C",342).
component("YPL148C",1045).
component("YER026C",455).
component("YCL004W",291).
component("YOR251C",1010).
component("YGR286C",584).
component("YJL068C",669).
component("YHR189W",625).
component("YDR058C",373).
component("YNR034W",944).
component("YHR163W",621).
component("YGR248W",577).
component("YCR073W-A",312).
component("YDL086W",328).
component("YOL011W",954).
component("YMR008C",858).
component("YMR006C",857).
component("U105_",25).
component("U101_",21).
component("YBL015W",222).
component("YJL068C",670).
component("YPL072W",1038).
component("YOR124C",987).
component("YNL186W",918).
component("YMR304W",897).
component("YMR223W",884).
component("YKR098C",773).
component("YJL197W",691).
component("YIL156W",650).
component("YFR010W",499).
component("YER151C",484).
component("YER144C",483).
component("YER098W",479).
component("YDR069C",376).
component("YDL122W",335).
component("YBR058C",250).
component("YBL067C",229).
component("YJR019C",700).
component("YDR272W",405).
component("U84_",194).
component("YDR481C",431).
component("YLR377C",831).
component("YDR074W",377).
component("YFR025C",502).
component("YPL179W",1050).
component("YNR032W",942).
component("YML057W",846).
component("YML016C",839).
component("YLR433C",835).
component("YGR123C",553).
component("YER133W",482).
component("YER089C",476).
component("YDR436W",428).
component("YDR075W",378).
component("YDL188C",351).
component("YDL134C",337).
component("YDL047W",320).
component("YDL006W",313).
component("YBR125C",263).
component("YBL056W",228).
component("YPR073C",1082).
component("YHR215W",629).
component("YDL024C",316).
component("YBR093C",257).
component("YBR092C",256).
component("YAR071W",218).
component("YIL053W",636).
component("YER062C",466).
component("YHR046C",603).
component("U9_",209).
component("YGR208W",573).
component("YPL228W",1056).
component("YMR180C",877).
component("YDL236W",357).
component("YJL155C",686).
component("YPR073C",1083).
component("YOR208W",1002).
component("YNL053W",905).
component("YMR036C",863).
component("YIR026C",657).
component("YIL113W",644).
component("YFR028C",503).
component("YER075C",472).
component("YDL230W",355).
component("YBR276C",285).
component("U34_",146).
component("U33_",145).
component("U32_",144).
component("U31_",143).
...
component("U25_",138).
component("U24_",137).
component("YOL064C",965).
component("YPL268W",1065).
component("YOR360C",1025).
component("YGL248W",537).
component("YKR031C",766).
component("YPL206C",1053).
component("YGL027C",517).
component("YLR286C",814).
component("YJR153W",723).
component("YJL221C",696).
component("YJL216C",694).
component("YIL172C",656).
component("YGR292W",586).
component("YGR287C",585).
component("YBR299W",290).
component("YBR184W",273).
component("YIL162W",653).
component("YPR026W",1075).
component("YDR001C",360).
component("YBR001C",233).
component("YOR190W",999).
component("YLR300W",816).
component("YGR282C",583).
component("YDR261C",403).
component("YDR400W",422).
component("U23_",136).
component("YML035C",842).
component("YJL070C",671).
component("YBR284W",287).
component("U102_",22).
component("YER043C",457).
component("YNL045W",903).
component("YLR160C",801).
component("YLR158C",800).
component("YLR157C",799).
component("YLR155C",798).
component("YDR321W",412).
component("YGL037C",518).
component("U43_",154).
component("U42_",153).
component("YMR293C",893).
component("YDR242W",400).
component("YLR308W",823).
component("YLR307W",822).
component("YBR208C",275).
component("YMR281W",892).
component("U53_",164).
component("YIR027C",658).
component("YPL111W",1042).
component("YIR032C",662).
component("YIR029W",660).
component("YPR062W",1080).
component("YMR120C",872).
component("YLR028C",782).
component("YHR144C",620).
component("YGR267C",582).
component("YCL030C",296).
component("YNL141W",913).
component("YBL033C",223).
component("YBR153W",269).
component("YDL238C",358).
component("YNL141W",914).
component("YLR245C",811).
component("YML035C",843).
component("YGR204W",571).
component("YBR084W",254).
component("YJL126W",678).
component("U44_",155).
component("YDL100C",332).
component("U87_",197).
component("U40_",151).
component("YMR267W",889).
component("YBR011C",237).
component("YHR201C",626).
component("YBR111C",258).
component("YBR252W",282).
component("YCL030C",297).
component("YPR080W",1085).
component("YOR187W",998).
component("YOR133W",990).
component("YLR069C",788).
component("YKR084C",770).
component("YKL173W",748).
component("YJL102W",676).
component("YDR385W",420).
component("YBR118W",261).
component("YER005W",451).
component("YLL001W",774).
component("YIL048W",635).
component("YER166W",485).
component("YDR093W",380).
component("YAL026C",212).
component("YBL099W",232).
component("U60_",171).
component("YLR231C",808).
component("U88_",198).
component("YLR134W",793).
component("YLR044C",784).
component("YGR087C",549).
component("YDR380W",419).
component("YDL080C",326).
component("U98_",207).
component("YMR250W",886).
component("YKL184W",753).
component("YOR128C",988).
component("YEL021W",442).
component("YNR043W",946).
component("U93_",204).
component("YDR047W",370).
component("U54_",165).
component("YKL211C",759) :- not remove_orf("YKL211C",759).
component("YKR097W",772).
component("YOL052C",958).
component("YNL169C",917).
component("YGR170W",559).
component("YKL060C",734).
component("YNL256W",926).
component("YDR294C",407).
component("YEL046C",444).
component("YNR033W",943).
component("YPR006C",1073).
component("YER065C",467).
component("YKL211C",760) :- not remove_orf("YKL211C",760).
component("YER090W",760) :- not remove_orf("YER090W",760).
component("YER090W",477) :- not remove_orf("YER090W",477).
component("YDR127W",387).
component("YPL281C",1070).
component("YOR393W",1030).
component("YMR323W",899).
component("YHR174W",622).
component("YGR254W",578).
component("YPL262W",1062).
component("YGL026C",516) :- not remove_orf("YGL026C",516).
component("YGR155W",557).
component("YLR304C",819).
component("YJL200C",692).
component("YDR234W",398).
component("YNL316C",935).
component("YKL182W",751).
component("YPL212C",1054).
component("YNL292W",933).
component("YGL063W",522).
component("YFL001W",489).
component("YOR278W",1012).
component("YPR002W",1072).
component("U49_",159).
component("YJR016C",699).
component("YCR053W",311).
component("YDR127W",388).
component("YGL148W",527).
component("YIL168W",655).
component("YIL167W",654).
component("YCL064C",302).
component("YER086W",474).
component("YCL064C",303).
component("YHR018C",596).
component("YLR359W",830).
component("YAL012W",210).
component("YFR055W",508).
component("YJL005W",666).
component("YOR176W",996).
component("YJL121C",677).
component("YBR019C",240).
component("YBR019C",241).
component("YDR050C",371).
component("YDR007W",361) :- not remove_orf("YDR007W",361).
component("YOR095C",983).
component("YER003C",450).
component("YBR196C",274).
component("YGL001C",510).
component("YPL117C",1043).
component("U14_",61).
component("YOL056W",961).
component("YKL152C",746).
component("YDL021W",314).
component("YMR105C",867).
component("YKL127W",740).
component("YEL058W",447).
component("YFL045C",496).
component("YPR060C",1079).
component("YHR072W",608).
component("YJL153C",685).
component("YPL097W",1040).
component("YGR185C",565).
component("YGR264C",581).
component("YGR171C",560).
component("YHR011W",595).
component("YDR023W",364).
component("YPL104W",1041).
component("YLL018C",775).
component("YPR081C",1086).
component("YBR121C",262).
component("YHR020W",599).
component("YER087W",475).
component("YNL247W",922).
component("YOL033W",956).
component("YGL245W",536).
component("YHR091C",610).
component("YDR341C",413).
component("YOL097C",969).
component("YDR268W",404).
component("YPR047W",1078).
component("YLR060W",787).
component("YFL022C",493).
component("YPR033C",1076).
component("YHR019C",597).
component("YCR024C",307).
component("YHR019C",598).
component("YKL194C",756).
component("YIL078W",639).
component("YPL160W",1046).
component("YLR382C",832).
component("YNL073W",907).
component("YDR037W",366).
component("YOR335C",1018).
component("YGR094W",551).
component("YLR153C",797).
component("YAL054C",214).
component("YOR317W",1014).
component("YMR246W",885).
component("YIL009W",631).
component("YER015W",453).
component("YOR142W",992).
component("YGR244C",576).
component("YPR035W",1077).
component("U89_",199).
component("YOR241W",1009).
component("YMR113W",869).
component("YKL132C",741).
component("YOR339C",1019).
component("YMR022W",862).
component("YLR306W",821).
component("YKL210W",758).
component("YGR133W",555).
component("YGL058W",520).
component("YER100W",481).
component("YEL012W",440).
component("YDR177W",393).
component("YDR092W",379).
component("YDR059C",374).
component("YDR054C",372).
component("YDL064W",322).
component("YBR082C",253).
component("YJL101C",675).
component("YOL049W",957).
component("U92_",203).
component("YAR015W",216).
component("YGL234W",534).
component("YER183C",488).
component("U91_",202).
component("U90_",201).
component("YNR057C",949).
component("YDL141W",339).
component("YDL141W",340).
component("YGL234W",535).
component("YDL141W",341).
component("YJR103W",712).
component("YBL039C",225).
component("YGR204W",572).
component("YBR084W",255).
component("YNL220W",920).
component("YOL058W",962).
component("YBR208C",276).
component("YHR074W",609).
component("YMR217W",882).
component("YGR061C",548).
component("YPR145W",1091).
component("YGR124W",554).
component("YOR303W",1013).
component("YJR109C",715).
component("YJL130C",681).
component("YGL062W",521).
component("YBR218C",277).
component("YPL231W",1060).
component("YNR016C",941).
component("YKL182W",752).
component("YGR037C",544).
component("YOR005C",977).
component("YDL164C",344).
component("YJL087C",672).
component("YOL010W",953).
component("YPR138C",1090).
component("YPL274W",1067).
component("YPL265W",1063).
component("YPL134C",1044).
component("YPL057C",1036).
component("YPL036W",1035).
component("YOR348C",1023).
component("YOR222W",1006).
component("YOR192C",1000).
component("YOR171C",995).
component("YOR130C",989).
component("YOR100C",984).
component("YOR071C",981).
component("YOR011W",978).
component("YOL156W",976).
component("YOL103W",970).
component("YOL020W",955) :- not remove_orf("YOL020W",955).
component("YNR072W",951).
component("YNR056C",948).
component("YNL318C",936).
component("YNL268W",929).
component("YNL142W",915).
component("YMR272C",891).
component("YMR202W",879).
component("YMR011W",859).
component("YML123C",855).
component("YLR348C",827).
component("YLR260W",813).
component("YLR237W",809).
component("YLR138W",794).
component("YLR100C",791).
component("YLR081W",789).
component("YLL061W",778).
component("YLL043W",777).
component("YKR093W",771).
component("YKR053C",768).
component("YKR039W",767) :- not remove_orf("YKR039W",767).
component("YKL217W",762).
component("YKL120W",739).
component("YKL004W",727).
component("YJR158W",724).
component("YJR152W",722).
component("YJR095W",711).
component("YJR077C",709).
component("YJL219W",695).
component("YJL214W",693).
component("YJL134W",682).
component("YJL129C",679).
component("YIR028W",659).
component("YIL134W",647).
component("YHR096C",613).
component("YHR094C",612).
component("YHR092C",611).
component("YHL036W",591).
component("YHL016C",589).
component("YGR191W",566).
component("YGR121C",552).
component("YGR055W",546).
component("YGL186C",529).
component("YGL077C",524).
component("YGL008C",511).
component("YFL055W",498).
component("YFL011W",490).
component("YER060W-A",463).
component("YER060W",462).
component("YER056C",461).
component("YER053C",459).
component("YEL069C",449).
component("YEL063C",448).
component("YEL017C-A",441).
component("YDR536W",438).
component("YDR508C",434).
component("YDR503C",433).
component("YDR497C",432).
component("YDR345C",416).
component("YDR343C",415).
component("YDR342C",414).
component("YDR297W",409).
component("YDR294C",408).
component("YDR284C",406).
component("YDR046C",369) :- not remove_orf("YDR046C",369).
component("YDL245C",359).
component("YDL210W",352).
component("YCR032W",309).
component("YCR024C-A",308).
component("YCL025C",294).
component("YBR298C",289).
component("YBR291C",288).
component("YBR069C",252) :- not remove_orf("YBR069C",252).
component("YBR068C",251) :- not remove_orf("YBR068C",251).
component("YBR036C",247).
component("YBR021W",243).
component("YBL042C",226).
component("U85_",195).
component("U7_",189).
component("U79_",188).
component("U78_",187).
...
catalyst(6160,895).
catalyst(3870,460).
catalyst(3620,418) :- not remove_reaction(3620,418).
catalyst(2110,506).
catalyst(2190,506).
catalyst(5550,717).
catalyst(5791,807).
...
catalyst(1960,370).
catalyst(3460,165).
catalyst(3600,759) :- not remove_reaction(3600,759).
catalyst(8000,772).
catalyst(3941,958).
catalyst(3942,958).
catalyst(6890,917).
...
catalyst(8020,1073).
catalyst(8020,467).
catalyst(1890,760) :- not remove_reaction(1890,760).
catalyst(3630,760) :- not remove_reaction(3630,760).
catalyst(1890,477) :- not remove_reaction(1890,477).
catalyst(3630,477) :- not remove_reaction(3630,477).
catalyst(3740,387).
catalyst(8231,1070).
catalyst(8232,1070).
catalyst(8231,1030).
...
catalyst(8051,1062).
catalyst(8052,1062).
catalyst(3590,516) :- not remove_reaction(3590,516).
catalyst(10910,516) :- not remove_reaction(10910,516).
catalyst(4570,557).
catalyst(8181,819).
catalyst(8182,819).
catalyst(8181,692).
...
catalyst(8281,371).
catalyst(8282,371).
catalyst(3610,361) :- not remove_reaction(3610,361).
catalyst(7921,983).
catalyst(7922,983).
catalyst(7841,450).
catalyst(7842,450).
...
catalyst(1210,976).
catalyst(1160,970).
catalyst(801,955) :- not remove_reaction(801,955).
catalyst(802,955) :- not remove_reaction(802,955).
catalyst(811,955) :- not remove_reaction(811,955).
catalyst(812,955) :- not remove_reaction(812,955).
catalyst(831,955) :- not remove_reaction(831,955).
catalyst(832,955) :- not remove_reaction(832,955).
catalyst(901,955) :- not remove_reaction(901,955).
catalyst(902,955) :- not remove_reaction(902,955).
catalyst(941,955) :- not remove_reaction(941,955).
catalyst(942,955) :- not remove_reaction(942,955).
catalyst(1170,951).
catalyst(1180,951).
catalyst(1210,951).
catalyst(700,948).
...
catalyst(650,771).
catalyst(6560,768).
catalyst(681,767) :- not remove_reaction(681,767).
catalyst(682,767) :- not remove_reaction(682,767).
catalyst(761,767) :- not remove_reaction(761,767).
catalyst(762,767) :- not remove_reaction(762,767).
catalyst(771,767) :- not remove_reaction(771,767).
catalyst(772,767) :- not remove_reaction(772,767).
catalyst(781,767) :- not remove_reaction(781,767).
catalyst(782,767) :- not remove_reaction(782,767).
catalyst(791,767) :- not remove_reaction(791,767).
catalyst(792,767) :- not remove_reaction(792,767).
catalyst(801,767) :- not remove_reaction(801,767).
catalyst(802,767) :- not remove_reaction(802,767).
catalyst(811,767) :- not remove_reaction(811,767).
catalyst(812,767) :- not remove_reaction(812,767).
catalyst(821,767) :- not remove_reaction(821,767).
catalyst(822,767) :- not remove_reaction(822,767).
catalyst(831,767) :- not remove_reaction(831,767).
catalyst(832,767) :- not remove_reaction(832,767).
catalyst(841,767) :- not remove_reaction(841,767).
catalyst(842,767) :- not remove_reaction(842,767).
catalyst(861,767) :- not remove_reaction(861,767).
catalyst(862,767) :- not remove_reaction(862,767).
catalyst(871,767) :- not remove_reaction(871,767).
catalyst(872,767) :- not remove_reaction(872,767).
catalyst(881,767) :- not remove_reaction(881,767).
catalyst(882,767) :- not remove_reaction(882,767).
catalyst(901,767) :- not remove_reaction(901,767).
catalyst(902,767) :- not remove_reaction(902,767).
catalyst(911,767) :- not remove_reaction(911,767).
catalyst(912,767) :- not remove_reaction(912,767).
catalyst(921,767) :- not remove_reaction(921,767).
catalyst(922,767) :- not remove_reaction(922,767).
catalyst(941,767) :- not remove_reaction(941,767).
catalyst(942,767) :- not remove_reaction(942,767).
catalyst(1191,767) :- not remove_reaction(1191,767).
catalyst(1192,767) :- not remove_reaction(1192,767).
catalyst(390,762).
catalyst(1021,762).
catalyst(1022,762).
catalyst(1521,739).
...
catalyst(6550,408).
catalyst(6690,406).
catalyst(791,369) :- not remove_reaction(791,369).
catalyst(792,369) :- not remove_reaction(792,369).
catalyst(801,369) :- not remove_reaction(801,369).
catalyst(802,369) :- not remove_reaction(802,369).
catalyst(811,369) :- not remove_reaction(811,369).
catalyst(812,369) :- not remove_reaction(812,369).
catalyst(831,369) :- not remove_reaction(831,369).
catalyst(832,369) :- not remove_reaction(832,369).
catalyst(841,369) :- not remove_reaction(841,369).
catalyst(842,369) :- not remove_reaction(842,369).
catalyst(861,369) :- not remove_reaction(861,369).
catalyst(862,369) :- not remove_reaction(862,369).
catalyst(901,369) :- not remove_reaction(901,369).
catalyst(902,369) :- not remove_reaction(902,369).
catalyst(1170,359).
catalyst(1180,359).
catalyst(1210,359).
catalyst(690,352).
...
catalyst(1511,288).
catalyst(1512,288).
catalyst(771,252) :- not remove_reaction(771,252).
catalyst(772,252) :- not remove_reaction(772,252).
...
catalyst(871,252) :- not remove_reaction(871,252).
catalyst(872,252) :- not remove_reaction(872,252).
catalyst(901,252) :- not remove_reaction(901,252).
catalyst(902,252) :- not remove_reaction(902,252).
catalyst(791,251) :- not remove_reaction(791,251).
catalyst(792,251) :- not remove_reaction(792,251).
catalyst(801,251) :- not remove_reaction(801,251).
catalyst(802,251) :- not remove_reaction(802,251).
catalyst(811,251) :- not remove_reaction(811,251).
catalyst(812,251) :- not remove_reaction(812,251).
catalyst(831,251) :- not remove_reaction(831,251).
catalyst(832,251) :- not remove_reaction(832,251).
catalyst(841,251) :- not remove_reaction(841,251).
catalyst(842,251) :- not remove_reaction(842,251).
catalyst(861,251) :- not remove_reaction(861,251).
catalyst(862,251) :- not remove_reaction(862,251).
catalyst(901,251) :- not remove_reaction(901,251).
catalyst(902,251) :- not remove_reaction(902,251).
catalyst(6600,247).
catalyst(620,243).
catalyst(540,226).
catalyst(2660,195).
...
modifiable_enzyme(418).
modifiable_enzyme(759).
modifiable_enzyme(760).
modifiable_enzyme(477).
modifiable_enzyme(516).
modifiable_enzyme(361).
modifiable_enzyme(955).
modifiable_enzyme(767).
modifiable_enzyme(369).
modifiable_enzyme(252).
modifiable_enzyme(251).
