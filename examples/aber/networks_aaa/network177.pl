...
component("YLR056W",761).
component("YGR060W",534).
component("YGL012W",499).
component("YKR009C",741).
component("YOL086C",938).
...
component("YJR159W",703).
component("YGL001C",496).
component("YIL094C",622).
component("YHR063C",589).
component("U45_",147).
component("YBR153W",259).
component("YML056C",818).
component("YLR432W",807).
component("YHR216W",611).
...
component("YLR450W",810).
component("YOL126C",944).
component("YKL085W",714).
component("YDL078C",314).
component("YKL029C",709).
component("YOR136W",963).
component("YNL037C",874).
component("YDL066W",312).
component("YHR183W",606).
component("YGR256W",565).
component("YNL241C",893).
component("YOL059W",935).
component("YDL022W",305).
component("YLR355C",802).
component("YIL074C",619).
component("YER081W",461).
component("YML054C",817).
component("YDL174C",338).
component("YML086C",822).
component("YIL155C",630).
component("YPR191W",1068).
component("YOR065W",952).
component("YJL166W",667).
component("YHR001W-A",577).
component("YGR183C",551).
component("YFR033C",492).
component("YDR529C",423).
component("YBL045C",218).
component("Q0105",18).
component("YGR088W",537).
component("YDR256C",390).
component("YKL026C",708).
component("YIR037W",644).
component("YBR244W",271).
component("YJR078W",688).
component("U58_",160).
component("YJR025C",680).
component("U107_",26).
component("YGR255C",564).
component("U108_",27).
component("YBL098W",222).
component("YMR015C",834).
component("YHR007C",578).
component("YDR402C",411).
component("YGL055W",506).
component("YGR175C",548).
component("YJR104C",691).
component("YHR008C",579).
component("YJL026W",647).
component("YIL066C",618).
component("YGR180C",550).
component("YER070W",458).
component("U38_",140).
component("U36_",139).
component("U35_",138).
component("YDL168W",335).
component("YDR158W",381).
component("YBR006W",227).
component("YPL276W",1039).
component("YPL275W",1038).
component("YOR388C",1001).
component("YPL061W",1009).
component("YOR374W",998).
component("YER073W",459).
component("U68_",168).
component("YGL154C",515).
component("YBR115C",250).
component("U55_",157).
component("YER069W",456).
component("YOR323C",988).
component("YMR170C",849).
component("YMR169C",848).
component("U2_",132).
component("YER178W",475).
component("YBR221C",269).
component("YIL125W",627).
component("U52_",154).
component("YBR166C",262).
component("YNL280C",904).
component("YGL012W",500).
component("YKL182W",728).
component("U57_",159).
component("YKL216W",738).
component("YDR044W",356).
component("YER014W",440).
component("YKR009C",742).
component("YIL160C",632).
component("YGL205W",520).
component("YMR118C",843).
component("YLR164W",778).
component("YLL041C",753).
component("YKL148C",722).
component("YKL141W",720).
component("YJL045W",648).
component("YDR178W",383).
component("YJR051W",683).
component("YEL047C",433).
component("YDL171C",336).
component("YDL171C",337).
component("YDL215C",342).
component("YOR375C",999).
component("YDL215C",343).
component("YAL062W",206).
component("U99_",199).
component("YBR035C",237).
component("YMR189W",851).
component("U56_",158).
component("YNR050C",919).
component("YHR037W",585).
component("YKR080W",746).
component("YER023W",442).
component("YPL023C",1005).
component("YGL125W",512).
component("YOR236W",980).
component("YGR204W",556).
component("YLR142W",771).
component("U63_",165).
component("U62_",164).
component("YOR356W",996).
component("YHR068W",590).
component("YKL150W",723).
component("YIL043C",615).
component("YHR042W",586).
component("YOR221C",977).
component("YML120C",826).
component("YKL192C",732).
component("YKL055C",711).
component("YER061C",452).
component("YBR046C",240).
...
component("YPL017C",1004).
component("YFL018C",480).
component("YPL091W",1011).
component("YDR353W",405).
component("YER042W",444).
component("YPR167C",1062).
component("YJR137C",696).
component("YNL052W",876).
component("YMR256C",860).
component("YLR395C",806).
component("YLR038C",759).
component("YIL111W",624).
component("YHR051W",588).
component("YGL191W",518).
component("YGL187C",517).
component("YDL067C",313).
component("Q0275",20).
component("Q0250",19).
component("YPL266W",1034).
component("YML110C",825).
component("YBR034C",236).
component("YPL273W",1036).
component("YLL062C",756).
component("YDR410C",414).
component("YOL096C",939).
component("U47_",149).
component("YER091C",466).
component("YJR073C",686).
component("YGR157W",545).
component("YDR120C",371).
component("YML008C",811).
component("YDL033C",307).
component("YOL096C",940).
component("YLR172C",779).
component("YLR058C",762).
component("YDR019C",352).
component("YBR176W",263).
component("YDR408C",413).
component("YMR120C",844).
component("YBL013W",212).
component("YJL130C",659).
component("YKL024C",706).
component("YPR074C",1054).
component("YBR117C",251).
component("YLR354C",801).
component("YGR043C",532).
component("YMR108W",841).
component("YCL009C",283).
component("YMR062C",837).
component("YNL071W",878).
component("YNR008W",911).
component("YIL160C",633).
component("YNL277W",902).
component("YDR232W",386).
component("YFL017C",479).
component("YPL231W",1028).
component("YER061C",453).
component("U86_",187).
component("YPL001W",1003).
component("YMR296C",867).
component("YDR062W",364).
component("YDL052C",310).
component("U8_",191).
component("YDR148C",379).
component("YAR035W",208).
component("YOR377W",1000).
component("YGR177C",549).
component("YPL231W",1029).
component("YGR147C",543).
component("YDL040C",308).
component("YPL028W",1006).
component("YLR195C",780).
component("YGL017W",501).
component("YPR001W",1041).
component("YNR001C",909).
component("YCR005C",294).
component("YML126C",829).
component("YNL104C",881).
component("YDL182W",339).
component("YDL131W",325).
component("YNL117W",883).
component("YIR031C",642).
component("YOR321W",987).
component("YJR143C",698).
component("YGR199W",554).
component("YDR307W",399).
component("YDL095W",320).
component("YDL093W",319).
component("YAL023C",202).
component("YLR258W",786).
component("YFR015C",487).
component("YOR103C",957).
component("YOR085W",954).
component("YMR149W",847).
component("YML019W",813).
component("YJL002C",645).
component("YEL002C",427).
component("YDL232W",345).
component("YCL043C",289).
component("YNL029C",873).
component("YIL085C",621).
component("YMR261C",861).
component("YML100W",823).
component("YBR126C",255).
component("YNL192W",891).
component("YBR038W",239).
component("YBR023C",235).
component("YMR306W",871).
component("YLR342W",799).
component("YGR032W",530).
component("YPR183W",1065).
component("YLR209C",781).
component("U104_",24).
component("U103_",23).
component("YMR271C",863).
component("YML106W",824).
component("YOR209C",975).
component("YMR300C",868).
component("YER055C",448).
component("YDR354W",406) :- not remove_orf("YDR354W",406).
component("YFR047C",493).
component("YJR133W",695).
component("YLR209C",782).
component("YML022W",814).
component("YDR441C",417).
component("YDR399W",409).
component("YHR128W",600).
component("YPR176C",1064).
component("YPL172C",1019).
component("YNR041C",917).
component("YMR101C",839).
component("YDL090C",318).
component("YBR003W",226).
component("YBR002C",225).
component("YJL167W",668).
component("YJL167W",669).
...
component("YLR303W",791).
component("YDR035W",354).
component("YBR249C",272).
component("YOR274W",983).
component("YOL143C",947).
component("YBR256C",274).
component("YHR137W",601).
component("YGL202W",519).
component("YLR027C",757).
component("YKL106W",716).
component("YOL140W",946).
component("YLR438W",809).
component("YKL104C",715).
component("YGR019W",529).
component("YLR089C",766).
component("YDR111C",370).
component("U64_",166).
component("U61_",163).
component("U51_",153).
component("YJR148W",699).
component("YHR208W",609).
component("YFL030W",482).
component("YOR184W",969).
component("YNR058W",922).
component("YIL116W",626).
component("YGL253W",525).
component("YFR053C",494).
component("YOL136C",945).
component("YIL107C",623).
component("YMR013C",833).
component("YMR205C",853).
component("YGR240C",560).
component("YDR248C",389).
component("YCR036W",300).
component("YGR194C",553).
component("YCL040W",288).
component("YJR105W",692).
component("U16_",73).
component("U15_",64).
component("YPL188W",1021).
component("YJR049C",682).
component("YEL041W",431).
component("U96_",197).
component("YKL001C",704).
component("YDR236C",387).
component("YML070W",820).
component("YFL053W",484).
component("YHL032C",575).
component("YLR133W",768).
component("YDR531W",425).
component("U83_",184).
component("U82_",183).
component("U81_",182).
component("YMR208W",854).
component("YPL203W",1022).
component("YOR061W",951).
component("YKL166C",725).
component("YJL164C",666).
component("YIL035C",614).
component("YHR205W",608).
component("YHR102W",598).
component("YGL019W",502).
component("YHR025W",584).
component("YOR347C",994).
component("YAL038W",204).
component("YNR012W",912).
component("YPR121W",1059).
component("YPL258C",1031).
component("YOL055C",931).
component("YPL214C",1025).
component("U1_",104).
component("YDR009W",351).
component("YBR020W",233).
component("YNL267W",900).
component("YLR305C",793).
component("YFR019W",488).
component("YDR208W",384).
component("YDR127W",375).
component("U21_",118).
component("U20_",113).
component("YDR147W",378).
component("YDR300C",398).
component("YCR012W",295).
component("YER052C",446).
component("YER069W",457).
component("U19_",103).
component("YKL024C",707).
component("U18_",93).
component("U17_",83).
component("U76_",177).
component("YMR220W",856).
component("YER170W",474).
component("YDR226W",385).
component("YKL067W",713).
component("YOL055C",932).
component("YDR454C",418).
component("YJR057W",684).
component("YOL061W",936).
component("YKL181W",727).
component("YHL011C",572).
component("YER099C",468).
component("YBL068W",221).
component("YOR143C",965).
component("YNL256W",897).
component("YLR328W",797).
component("YBR018C",229).
component("YBR018C",230).
component("YGR007W",527).
component("YGR202C",555).
component("YLR328W",798).
component("YKR002W",740).
component("U80_",181).
component("YDL103C",323).
component("U94_",196).
component("YJR010W",677).
component("YCL050C",290).
component("YGL130W",513).
component("YDR530C",424).
component("YCL050C",291).
component("YPR190C",1067).
component("YPR187W",1066).
component("YPR110C",1057).
component("YPR010C",1044).
component("YOR341W",993).
component("YOR340C",992).
component("YOR224C",979).
component("YOR210W",976).
component("YOR207C",973).
component("YOR151C",966).
component("YOR116C",958).
component("YOL005C",924).
component("YNR003C",910).
component("YNL248C",895).
component("YNL151C",888).
component("YNL113W",882).
component("YKL144C",721).
component("YJR063W",685).
component("YJL148W",663).
component("YJL140W",662).
component("YIL021W",613).
component("YHR143W-A",602).
component("YGL070C",510).
component("YFL036W",483).
component("YDR404C",412).
component("YDR156W",380).
component("YDR045C",357).
component("YDL150W",332).
component("YDL140C",327).
component("YBR154C",261).
component("YPR175W",1063).
component("YPL167C",1018).
component("YOR330C",989).
component("YOL115W",943).
component("YNL299W",906).
component("YNL262W",899).
component("YNL102W",880).
component("YJR043C",681).
component("YJR006W",676).
component("YJL090C",653).
component("YIL139C",629).
component("YEL055C",434).
component("YDR419W",415).
component("YDR121W",372).
component("YDL102W",322).
component("YCR014C",296).
component("YBR278W",277).
component("YBL035C",215).
component("YKL035W",710).
component("YHL012W",573).
component("YHR123W",599).
component("YPR113W",1058).
component("YBR243C",270).
component("YNL130C",884).
component("YDL142C",331).
component("YPL148C",1016).
component("YER026C",443).
component("YCL004W",282).
component("YOR251C",982).
component("YGR286C",569).
component("YJL068C",649).
component("YDR058C",362).
component("YNR034W",916).
component("YHR163W",604).
component("YGR248W",562).
component("YCR073W-A",302).
component("YDL086W",317).
component("YOL011W",926).
component("YMR008C",831).
component("YMR006C",830).
component("U105_",25).
component("U101_",21).
component("YBL015W",213).
component("YJL068C",650).
component("YPL072W",1010).
component("YOR124C",959).
component("YNL186W",890).
component("YMR304W",870).
component("YMR223W",857).
component("YKR098C",750).
component("YJL197W",670).
component("YIL156W",631).
component("YFR010W",486).
component("YER151C",472).
component("YER144C",471).
component("YER098W",467).
component("YDR069C",365).
component("YDL122W",324).
component("YBR058C",241).
component("YBL067C",220).
component("YJR019C",679).
component("YDR272W",393).
component("U84_",185).
component("YDR481C",419).
component("YLR377C",804).
component("YDR074W",366).
component("YFR025C",489).
component("YPL179W",1020).
component("YNR032W",914).
component("YML057W",819).
component("YML016C",812).
component("YLR433C",808).
component("YGR123C",540).
component("YER133W",470).
component("YER089C",464).
component("YDR436W",416).
component("YDR075W",367).
component("YDL188C",340).
component("YDL134C",326).
component("YDL047W",309).
component("YDL006W",303).
component("YBR125C",254).
component("YBL056W",219).
component("YPR073C",1052).
component("YHR215W",610).
component("YDL024C",306).
component("YBR093C",248).
component("YBR092C",247).
component("YAR071W",209).
component("YIL053W",617).
component("YER062C",454).
component("YHR046C",587).
component("U9_",200).
component("YGR208W",558).
component("YPL228W",1026).
component("YMR180C",850).
component("YDL236W",346).
component("YJL155C",665).
component("YPR073C",1053).
component("YOR208W",974).
component("YNL053W",877).
component("YMR036C",836).
component("YIR026C",638).
component("YIL113W",625).
component("YFR028C",490).
component("YER075C",460).
component("YDL230W",344).
...
component("U25_",129).
component("U24_",128).
component("YOL064C",937).
component("YPL268W",1035).
component("YOR360C",997).
component("YGL248W",524).
component("YKR031C",743).
component("YPL206C",1023).
component("YGL027C",504).
component("YLR286C",788).
component("YJR153W",701).
component("YJL221C",675).
component("YJL216C",673).
...
component("YBR001C",224).
component("YOR190W",971).
component("YLR300W",789).
component("YGR282C",568).
component("YDR261C",391).
component("YDR400W",410).
component("U23_",127).
component("YML035C",815).
component("YJL070C",651).
component("YBR284W",278).
component("U102_",22).
component("YER043C",445).
component("YNL045W",875).
component("YLR160C",777).
component("YLR158C",776).
component("YLR157C",775).
component("YLR155C",774).
component("YDR321W",400).
component("YGL037C",505).
component("U43_",145).
component("U42_",144).
component("YMR293C",866).
component("YDR242W",388).
component("YLR308W",796).
component("YLR307W",795).
component("YBR208C",266).
component("YMR281W",865).
component("U53_",155).
component("YIR027C",639).
component("YPL111W",1014).
component("YIR032C",643).
component("YIR029W",641).
component("YPR062W",1050).
component("YMR120C",845).
component("YLR028C",758).
component("YHR144C",603).
component("YGR267C",567).
component("YCL030C",286).
component("YNL141W",885).
component("YBL033C",214).
component("YBR153W",260).
component("YDL238C",347).
component("YNL141W",886).
component("YLR245C",785).
component("YML035C",816).
component("YBR084W",245).
component("YJL126W",657).
component("U44_",146).
component("YDL100C",321).
component("U87_",188).
component("U40_",142).
component("YMR267W",862).
component("YBR011C",228).
component("YHR201C",607).
component("YBR111C",249).
component("YBR252W",273).
component("YCL030C",287).
component("YPR080W",1055).
component("YOR187W",970).
component("YOR133W",962).
component("YLR069C",764).
component("YKR084C",747).
component("YKL173W",726).
component("YJL102W",655).
component("YDR385W",408).
component("YBR118W",252).
component("YER005W",439).
component("YLL001W",751).
component("YIL048W",616).
component("YER166W",473).
component("YDR093W",369).
component("YAL026C",203).
component("YBL099W",223).
component("U60_",162).
component("YLR231C",783).
component("U88_",189).
component("YLR134W",769).
component("YLR044C",760).
component("YGR087C",536).
component("YDR380W",407).
component("YDL080C",315).
component("U98_",198).
component("YMR250W",859).
component("YKL184W",731).
component("YOR128C",960).
component("YEL021W",430).
component("YNR043W",918).
component("U93_",195).
component("YDR047W",359).
component("U54_",156).
component("YKL211C",736) :- not remove_orf("YKL211C",736).
component("YKR097W",749).
component("YOL052C",930).
component("YNL169C",889).
component("YGR170W",546).
component("YKL060C",712).
component("YNL256W",898).
component("YDR294C",395).
component("YEL046C",432).
component("YNR033W",915).
component("YPR006C",1043).
component("YER065C",455).
component("YKL211C",737) :- not remove_orf("YKL211C",737).
component("YER090W",737) :- not remove_orf("YER090W",737).
component("YER090W",465) :- not remove_orf("YER090W",465).
component("YDR127W",376).
component("YPL281C",1040).
component("YOR393W",1002).
component("YMR323W",872).
component("YHR174W",605).
component("YGR254W",563).
component("YPL262W",1032).
component("YGL026C",503) :- not remove_orf("YGL026C",503).
component("YGR155W",544).
component("YLR304C",792).
component("YJL200C",671).
component("YNL316C",907).
component("YKL182W",729).
component("YPL212C",1024).
component("YNL292W",905).
component("YGL063W",509).
component("YFL001W",477).
component("YOR278W",984).
component("YPR002W",1042).
component("U49_",150).
component("YJR016C",678).
component("YCR053W",301).
component("YDR127W",377).
component("YGL148W",514).
component("YIL168W",636).
component("YIL167W",635).
component("YCL064C",292).
component("YER086W",462).
component("YCL064C",293).
component("YLR359W",803).
component("YAL012W",201).
component("YFR055W",495).
component("YJL005W",646).
component("YOR176W",968).
component("YJL121C",656).
component("YBR019C",231).
component("YBR019C",232).
component("YDR050C",360).
component("YDR007W",350) :- not remove_orf("YDR007W",350).
component("YOR095C",955).
component("YER003C",438).
component("YBR196C",265).
component("YGL001C",497).
component("U14_",56).
component("YOL056W",933).
component("YKL152C",724).
component("YDL021W",304).
component("YMR105C",840).
component("YKL127W",718).
component("YEL058W",435).
component("YPR060C",1049).
component("YHR072W",592).
component("YJL153C",664).
component("YPL097W",1012).
component("YGR185C",552).
component("YGR264C",566).
component("YGR171C",547).
component("YHR011W",580).
component("YDR023W",353).
component("YPL104W",1013).
component("YLL018C",752).
component("YPR081C",1056).
component("YBR121C",253).
component("YHR020W",583).
component("YER087W",463).
component("YNL247W",894).
component("YOL033W",928).
component("YGL245W",523).
component("YHR091C",594).
component("YDR341C",401).
component("YOL097C",941).
component("YDR268W",392).
component("YPR047W",1048).
component("YLR060W",763).
component("YFL022C",481).
component("YPR033C",1046).
component("YHR019C",581).
component("YCR024C",297).
component("YHR019C",582).
component("YKL194C",734).
component("YIL078W",620).
component("YPL160W",1017).
component("YLR382C",805).
component("YNL073W",879).
component("YDR037W",355).
component("YOR335C",990).
component("YGR094W",538).
component("YLR153C",773).
component("YAL054C",205).
component("YOR317W",986).
component("YMR246W",858).
component("YIL009W",612).
component("YER015W",441).
component("YOR142W",964).
component("YGR244C",561).
component("YPR035W",1047).
component("U89_",190).
component("YOR241W",981).
component("YMR113W",842).
component("YKL132C",719).
component("YOR339C",991).
component("YMR022W",835).
component("YLR306W",794).
component("YKL210W",735).
component("YGR133W",542).
component("YGL058W",507).
component("YER100W",469).
component("YEL012W",428).
component("YDR177W",382).
component("YDR092W",368).
component("YDR059C",363).
component("YDR054C",361).
component("YDL064W",311).
component("YBR082C",244).
component("YJL101C",654).
component("YOL049W",929).
component("U92_",194).
component("YAR015W",207).
component("YGL234W",521).
component("YER183C",476).
component("U91_",193).
component("U90_",192).
component("YNR057C",921).
component("YDL141W",328).
component("YDL141W",329).
component("YGL234W",522).
component("YDL141W",330).
component("YJR103W",690).
component("YBL039C",216).
component("YGR204W",557).
component("YBR084W",246).
component("YNL220W",892).
component("YOL058W",934).
component("YBR208C",267).
component("YHR074W",593).
component("YMR217W",855).
component("YGR061C",535).
component("YPR145W",1061).
component("YGR124W",541).
component("YOR303W",985).
component("YJR109C",693).
component("YJL130C",660).
component("YGL062W",508).
component("YBR218C",268).
component("YPL231W",1030).
component("YNR016C",913).
component("YKL182W",730).
component("YGR037C",531).
component("YOR005C",949).
component("YDL164C",333).
component("YJL087C",652).
component("YOL010W",925).
component("YPR138C",1060).
component("YPL274W",1037).
component("YPL265W",1033).
component("YPL134C",1015).
component("YPL057C",1008).
component("YPL036W",1007).
component("YOR348C",995).
component("YOR222W",978).
component("YOR192C",972).
component("YOR171C",967).
component("YOR130C",961).
component("YOR100C",956).
component("YOR071C",953).
component("YOR011W",950).
component("YOL156W",948).
component("YOL103W",942).
component("YOL020W",927) :- not remove_orf("YOL020W",927).
component("YNR072W",923).
component("YNR056C",920).
component("YNL318C",908).
component("YNL268W",901).
component("YNL142W",887).
component("YMR272C",864).
component("YMR202W",852).
component("YMR011W",832).
component("YML123C",828).
component("YLR348C",800).
component("YLR260W",787).
component("YLR237W",784).
component("YLR138W",770).
component("YLR100C",767).
component("YLR081W",765).
component("YLL061W",755).
component("YLL043W",754).
component("YKR093W",748).
component("YKR053C",745).
component("YKR039W",744) :- not remove_orf("YKR039W",744).
component("YKL217W",739).
component("YKL120W",717).
component("YKL004W",705).
component("YJR158W",702).
component("YJR152W",700).
component("YJR095W",689).
component("YJR077C",687).
component("YJL219W",674).
component("YJL214W",672).
component("YJL134W",661).
component("YJL129C",658).
component("YIR028W",640).
component("YIL134W",628).
component("YHR096C",597).
component("YHR094C",596).
component("YHR092C",595).
component("YHL036W",576).
component("YHL016C",574).
component("YGR121C",539).
component("YGR055W",533).
component("YGL186C",516).
component("YGL077C",511).
component("YGL008C",498).
component("YFL055W",485).
...
component("YEL017C-A",429).
component("YDR536W",426).
component("YDR508C",422).
component("YDR503C",421).
component("YDR497C",420).
component("YDR345C",404).
component("YDR343C",403).
component("YDR342C",402).
component("YDR297W",397).
component("YDR294C",396).
component("YDR284C",394).
component("YDR046C",358) :- not remove_orf("YDR046C",358).
component("YDL245C",348).
component("YDL210W",341).
component("YCR032W",299).
component("YCR024C-A",298).
component("YCL025C",284).
component("YBR298C",280).
component("YBR291C",279).
component("YBR069C",243) :- not remove_orf("YBR069C",243).
component("YBR068C",242) :- not remove_orf("YBR068C",242).
...
catalyst(6160,868).
catalyst(3870,448).
catalyst(3620,406) :- not remove_reaction(3620,406).
catalyst(2110,493).
catalyst(2190,493).
catalyst(5550,695).
catalyst(5791,782).
...
catalyst(1960,359).
catalyst(3460,156).
catalyst(3600,736) :- not remove_reaction(3600,736).
catalyst(8000,749).
catalyst(3941,930).
catalyst(3942,930).
catalyst(6890,889).
...
catalyst(8020,1043).
catalyst(8020,455).
catalyst(1890,737) :- not remove_reaction(1890,737).
catalyst(3630,737) :- not remove_reaction(3630,737).
...
catalyst(8051,1032).
catalyst(8052,1032).
catalyst(3590,503) :- not remove_reaction(3590,503).
catalyst(10910,503) :- not remove_reaction(10910,503).
catalyst(4570,544).
catalyst(8181,792).
catalyst(8182,792).
catalyst(8181,671).
...
catalyst(8281,360).
catalyst(8282,360).
catalyst(3610,350) :- not remove_reaction(3610,350).
catalyst(7921,955).
catalyst(7922,955).
catalyst(7841,438).
catalyst(7842,438).
...
catalyst(1210,948).
catalyst(1160,942).
catalyst(801,927) :- not remove_reaction(801,927).
catalyst(802,927) :- not remove_reaction(802,927).
catalyst(811,927) :- not remove_reaction(811,927).
catalyst(812,927) :- not remove_reaction(812,927).
catalyst(831,927) :- not remove_reaction(831,927).
catalyst(832,927) :- not remove_reaction(832,927).
catalyst(901,927) :- not remove_reaction(901,927).
catalyst(902,927) :- not remove_reaction(902,927).
catalyst(941,927) :- not remove_reaction(941,927).
catalyst(942,927) :- not remove_reaction(942,927).
catalyst(1170,923).
catalyst(1180,923).
catalyst(1210,923).
catalyst(700,920).
...
catalyst(650,748).
catalyst(6560,745).
catalyst(681,744) :- not remove_reaction(681,744).
catalyst(682,744) :- not remove_reaction(682,744).
catalyst(761,744) :- not remove_reaction(761,744).
catalyst(762,744) :- not remove_reaction(762,744).
catalyst(771,744) :- not remove_reaction(771,744).
catalyst(772,744) :- not remove_reaction(772,744).
catalyst(781,744) :- not remove_reaction(781,744).
catalyst(782,744) :- not remove_reaction(782,744).
catalyst(791,744) :- not remove_reaction(791,744).
catalyst(792,744) :- not remove_reaction(792,744).
...
catalyst(821,744) :- not remove_reaction(821,744).
catalyst(822,744) :- not remove_reaction(822,744).
catalyst(831,744) :- not remove_reaction(831,744).
catalyst(832,744) :- not remove_reaction(832,744).
catalyst(841,744) :- not remove_reaction(841,744).
catalyst(842,744) :- not remove_reaction(842,744).
catalyst(861,744) :- not remove_reaction(861,744).
catalyst(862,744) :- not remove_reaction(862,744).
catalyst(881,744) :- not remove_reaction(881,744).
catalyst(882,744) :- not remove_reaction(882,744).
catalyst(901,744) :- not remove_reaction(901,744).
catalyst(902,744) :- not remove_reaction(902,744).
catalyst(911,744) :- not remove_reaction(911,744).
catalyst(912,744) :- not remove_reaction(912,744).
catalyst(921,744) :- not remove_reaction(921,744).
catalyst(922,744) :- not remove_reaction(922,744).
catalyst(941,744) :- not remove_reaction(941,744).
catalyst(942,744) :- not remove_reaction(942,744).
catalyst(1191,744) :- not remove_reaction(1191,744).
catalyst(1192,744) :- not remove_reaction(1192,744).
catalyst(390,739).
catalyst(1021,739).
catalyst(1022,739).
catalyst(1521,717).
...
catalyst(6550,396).
catalyst(6690,394).
catalyst(791,358) :- not remove_reaction(791,358).
catalyst(792,358) :- not remove_reaction(792,358).
catalyst(801,358) :- not remove_reaction(801,358).
catalyst(802,358) :- not remove_reaction(802,358).
catalyst(811,358) :- not remove_reaction(811,358).
catalyst(812,358) :- not remove_reaction(812,358).
catalyst(831,358) :- not remove_reaction(831,358).
catalyst(832,358) :- not remove_reaction(832,358).
catalyst(841,358) :- not remove_reaction(841,358).
catalyst(842,358) :- not remove_reaction(842,358).
catalyst(861,358) :- not remove_reaction(861,358).
catalyst(862,358) :- not remove_reaction(862,358).
catalyst(901,358) :- not remove_reaction(901,358).
catalyst(902,358) :- not remove_reaction(902,358).
catalyst(1170,348).
catalyst(1180,348).
catalyst(1210,348).
catalyst(690,341).
...
catalyst(1511,279).
catalyst(1512,279).
catalyst(771,243) :- not remove_reaction(771,243).
catalyst(772,243) :- not remove_reaction(772,243).
catalyst(791,243) :- not remove_reaction(791,243).
catalyst(792,243) :- not remove_reaction(792,243).
catalyst(801,243) :- not remove_reaction(801,243).
catalyst(802,243) :- not remove_reaction(802,243).
catalyst(811,243) :- not remove_reaction(811,243).
catalyst(812,243) :- not remove_reaction(812,243).
catalyst(861,243) :- not remove_reaction(861,243).
catalyst(862,243) :- not remove_reaction(862,243).
catalyst(901,243) :- not remove_reaction(901,243).
catalyst(902,243) :- not remove_reaction(902,243).
...
modifiable_enzyme(736).
modifiable_enzyme(737).
modifiable_enzyme(465).
modifiable_enzyme(503).
modifiable_enzyme(350).
modifiable_enzyme(927).
