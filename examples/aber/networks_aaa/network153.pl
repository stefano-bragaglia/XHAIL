...
component("YNL280C",803).
component("YLR056W",675).
component("YGR060W",472).
component("YGL012W",438).
component("YKR009C",657).
component("YOL086C",835).
component("YMR303C",771).
component("YMR083W",740).
component("YGL256W",464).
...
component("YML056C",723).
component("YLR432W",715).
component("YHR216W",541).
component("YAR075W",180).
component("YAR073W",179).
component("YCL030C",247).
component("YDR127W",323).
component("YJR139C",618).
component("YOL126C",840).
component("YKL085W",634).
component("YDL078C",271).
component("YKL029C",629).
component("YOR136W",856).
component("YNL037C",776).
component("YDL066W",269).
component("YNL241C",793).
component("YOL059W",833).
component("YDL022W",263).
component("YLR355C",710).
component("YIL074C",549).
component("YER081W",404).
component("YML054C",722).
component("YDL174C",293).
component("YML086C",726).
component("YIL155C",558).
component("YPR191W",952).
component("YOR065W",847).
component("YJL166W",589).
component("YHR001W-A",511).
component("YGR183C",487).
component("YFR033C",431).
component("YDR529C",370).
component("YBL045C",186).
component("Q0105",18).
component("YGR088W",475).
component("YDR256C",338).
component("YKL026C",628).
component("YIR037W",569).
component("YBR244W",233).
component("YJR078W",609).
component("U58_",135).
component("YJR025C",601).
component("YGR255C",499).
component("U108_",25).
component("YBL098W",190).
component("YMR015C",737).
component("YHR007C",512).
component("YDR402C",358).
component("YGL055W",445).
component("YGR175C",484).
component("YJR104C",612).
component("YHR008C",513).
component("YJL026W",572).
component("YIL066C",548).
...
component("YDR044W",310).
component("YER014W",385).
...
component("YDR178W",332).
component("YJR051W",604).
component("YEL047C",379).
component("YDL215C",297).
component("YOR375C",889).
...
component("U56_",133).
component("YHR037W",519).
component("YKR080W",662).
component("YER023W",387).
component("YPL023C",895).
...
component("YPL017C",894).
component("YFL018C",421).
component("YPL091W",900).
component("YDR353W",353).
component("YER042W",389).
component("YJR137C",617).
component("YNL052W",778).
component("YMR256C",762).
component("YLR395C",714).
component("YLR038C",673).
...
component("YML110C",729).
component("YBR034C",202).
component("YPL273W",924).
component("YLL062C",670).
component("YDR410C",361).
component("U47_",124).
component("YER091C",409).
component("YJR073C",607).
component("YDR120C",321).
component("YDL033C",265).
component("YOL096C",836).
component("YLR172C",689).
component("YDR019C",306).
component("YBR176W",225).
component("YDR408C",360).
component("YMR120C",746).
component("YBL013W",181).
component("YKL024C",627).
component("YPR074C",941).
component("YBR117C",214).
component("YLR354C",709).
component("YGR043C",470).
component("YMR108W",743).
component("YCL009C",245).
component("YMR062C",739).
component("YNL071W",780).
component("YNR008W",811).
component("YIL160C",561).
component("YNL277W",802).
component("YFL017C",420).
component("YPL231W",916).
component("YER061C",397).
component("U86_",158).
component("YPL001W",893).
component("YMR296C",769).
component("YDR062W",316).
component("YDL052C",268).
component("U8_",162).
component("YDR148C",329).
component("YOR377W",890).
component("YGR177C",485).
component("YPL231W",917).
component("YGR147C",480).
component("YDL040C",266).
component("YPL028W",896).
component("YLR195C",690).
component("YGL017W",440).
component("YPR001W",929).
component("YNR001C",809).
component("YCR005C",252).
component("YDL182W",294).
component("YDL131W",282).
component("YNL117W",784).
component("YIR031C",567).
component("YOR321W",878).
component("YJR143C",619).
component("YGR199W",490).
component("YDR307W",347).
component("YDL095W",277).
component("YDL093W",276).
component("YAL023C",173).
component("YOR103C",851).
component("YOR085W",849).
component("YMR149W",749).
component("YML019W",718).
component("YJL002C",570).
component("YEL002C",374).
component("YDL232W",300).
component("YCL043C",250).
component("YNL029C",775).
component("YIL085C",550).
component("YMR261C",763).
component("YML100W",727).
component("YBR126C",217).
component("YNL192W",792).
component("YBR038W",205).
component("YBR023C",201).
component("YMR306W",773).
component("YLR342W",707).
component("YGR032W",468).
component("YLR209C",691).
component("U104_",23).
component("YMR271C",765).
component("YML106W",728).
component("YOR209C",867).
component("YMR300C",770).
component("YER055C",392).
component("YDR354W",354) :- not remove_orf("YDR354W",354).
component("YFR047C",432).
component("YJR133W",616).
component("YLR209C",692).
component("YML022W",719).
component("YDR441C",364).
component("YDR399W",356).
component("YPR176C",949).
component("YPL172C",907).
component("YNR041C",817).
component("YMR101C",741).
...
component("YNL248C",795).
component("YNL151C",789).
component("YNL113W",783).
component("YKL144C",640).
component("YJR063W",606).
...
component("YDR404C",359).
component("YDR156W",330).
component("YDR045C",311).
component("YDL150W",289).
component("YDL140C",284).
component("YBR154C",223).
component("YPR175W",948).
component("YPL167C",906).
component("YOR330C",880).
component("YOL115W",839).
component("YNL299W",806).
component("YNL262W",799).
component("YNL102W",782).
component("YJR043C",602).
component("YJR006W",598).
component("YJL090C",577).
component("YIL139C",557).
component("YEL055C",380).
component("YDR419W",362).
component("YDR121W",322).
component("YDL102W",279).
component("YCR014C",254).
component("YBR278W",239).
component("YBL035C",183).
component("YKL035W",630).
component("YHL012W",507).
component("YHR123W",531).
component("YPR113W",944).
component("YBR243C",232).
component("YNL130C",785).
component("YDL142C",288).
component("YPL148C",904).
component("YER026C",388).
component("YCL004W",244).
component("YOR251C",873).
component("YGR286C",503).
component("YJL068C",574).
component("YDR058C",315).
component("YNR034W",816).
component("YHR163W",535).
component("YGR248W",497).
component("YCR073W-A",260).
component("YDL086W",274).
component("YOL011W",825).
...
component("YPL072W",899).
component("YOR124C",853).
component("YNL186W",791).
component("YMR304W",772).
component("YMR223W",759).
component("YKR098C",665).
component("YJL197W",592).
component("YIL156W",559).
component("YFR010W",427).
component("YER151C",414).
component("YER144C",413).
component("YER098W",410).
component("YDR069C",317).
component("YDL122W",281).
component("YBR058C",206).
component("YBL067C",188).
component("YDR272W",341).
component("U84_",156).
component("YDR481C",366).
component("YLR377C",712).
component("YDR074W",318).
component("YPL179W",908).
component("YNR032W",814).
component("YML057W",724).
component("YML016C",717).
component("YLR433C",716).
component("YGR123C",478).
component("YER133W",412).
component("YER089C",407).
component("YDR436W",363).
...
component("YJL155C",587).
component("YPR073C",940).
component("YOR208W",866).
component("YNL053W",779).
...
component("U25_",108).
component("U24_",107).
component("YPL268W",923).
component("YOR360C",887).
component("YGL248W",462).
component("YKR031C",659).
...
component("YIL172C",563).
component("YGR292W",505).
component("YGR287C",504).
component("YBR299W",243).
component("YBR184W",226).
component("YOR190W",863).
component("YLR300W",698).
component("YGR282C",502).
component("YDR261C",339).
component("YDR400W",357).
component("U23_",106).
component("YML035C",720).
component("YJL070C",576).
component("YBR284W",240).
component("U102_",22).
component("YNL045W",777).
component("YLR160C",687).
component("YLR158C",686).
component("YLR157C",685).
component("YLR155C",684).
component("YDR321W",348).
component("YGL037C",444).
component("YMR293C",768).
component("YDR242W",336).
component("YLR308W",704).
component("YLR307W",703).
component("YBR208C",228).
component("YMR281W",767).
component("U53_",130).
component("YIR027C",565).
component("YPL111W",903).
component("YIR032C",568).
component("YIR029W",566).
...
component("YOR393W",892).
component("YMR323W",774).
component("YHR174W",536).
component("YGR254W",498).
...
component("YMR105C",742).
component("YKL127W",637).
component("YEL058W",381).
component("YPR060C",936).
component("YHR072W",524).
component("YJL153C",586).
component("YPL097W",901).
component("YGR185C",488).
component("YGR264C",500).
component("YGR171C",483).
component("YHR011W",514).
component("YDR023W",307).
component("YPL104W",902).
component("YLL018C",666).
component("YPR081C",942).
component("YBR121C",215).
component("YHR020W",517).
component("YER087W",406).
component("YNL247W",794).
component("YOL033W",827).
component("YGL245W",461).
component("YHR091C",526).
component("YDR341C",349).
component("YOL097C",837).
...
component("YPL160W",905).
component("YLR382C",713).
component("YNL073W",781).
component("YDR037W",309).
component("YOR335C",881).
component("YGR094W",476).
component("YOR317W",877).
component("YMR246W",760).
component("YIL009W",542).
component("YER015W",386).
component("YOR142W",857).
component("YGR244C",496).
component("YPR035W",934).
component("U89_",161).
component("YOR241W",872).
component("YMR113W",744).
component("YKL132C",638).
...
component("YPR145W",947).
component("YGR124W",479).
component("YOR303W",876).
component("YJR109C",614).
...
component("YOR005C",845).
component("YDL164C",290).
component("YOL010W",824).
component("YPR138C",946).
component("YPL274W",925).
component("YPL265W",921).
component("YPL057C",898).
component("YPL036W",897).
component("YOR348C",885).
component("YOR192C",864).
component("YOR171C",860).
component("YOR130C",855).
component("YOR071C",848).
component("YOL156W",844).
component("YOL103W",838).
component("YOL020W",826) :- not remove_orf("YOL020W",826).
component("YNR072W",822).
component("YNR056C",819).
component("YNL318C",808).
component("YNL268W",801).
component("YNL142W",788).
component("YMR272C",766).
component("YMR202W",754).
component("YMR011W",735).
component("YML123C",732).
component("YLR348C",708).
component("YLR260W",696).
component("YLR237W",694).
component("YLR138W",682).
component("YLR100C",679).
component("YLR081W",677).
component("YLL061W",669).
component("YLL043W",668).
component("YKR093W",663).
component("YKR053C",661).
component("YKR039W",660) :- not remove_orf("YKR039W",660).
component("YKL217W",655).
component("YKL004W",626).
component("YJR158W",623).
component("YJR152W",621).
component("YJR095W",610).
component("YJR077C",608).
component("YJL219W",596).
component("YJL214W",594).
component("YJL134W",583).
component("YJL129C",581).
component("YHR096C",529).
component("YHR094C",528).
component("YHR092C",527).
component("YHL036W",510).
component("YHL016C",508).
component("YGR121C",477).
...
component("YER060W-A",395).
component("YER060W",394).
component("YER056C",393).
component("YER053C",391).
component("YEL069C",382).
component("YEL017C-A",375).
component("YDR536W",373).
component("YDR508C",369).
component("YDR503C",368).
component("YDR497C",367).
component("YDR345C",352).
component("YDR343C",351).
component("YDR342C",350).
component("YDR297W",345).
component("YDR294C",344).
component("YDR284C",342).
component("YDR046C",312) :- not remove_orf("YDR046C",312).
...
component("YBR036C",204).
component("YBR021W",200).
...
catalyst(6160,770).
catalyst(3870,392).
catalyst(3620,354) :- not remove_reaction(3620,354).
catalyst(2110,432).
catalyst(2190,432).
catalyst(5550,616).
catalyst(5791,692).
...
catalyst(8281,314).
catalyst(8282,314).
catalyst(3610,304) :- not remove_reaction(3610,304).
catalyst(7921,850).
catalyst(7922,850).
catalyst(7841,383).
catalyst(7842,383).
...
catalyst(941,826) :- not remove_reaction(941,826).
catalyst(942,826) :- not remove_reaction(942,826).
catalyst(1170,822).
catalyst(1210,822).
catalyst(700,819).
catalyst(1200,808).
...
catalyst(650,663).
catalyst(6560,661).
catalyst(761,660) :- not remove_reaction(761,660).
catalyst(762,660) :- not remove_reaction(762,660).
catalyst(771,660) :- not remove_reaction(771,660).
catalyst(772,660) :- not remove_reaction(772,660).
catalyst(781,660) :- not remove_reaction(781,660).
catalyst(782,660) :- not remove_reaction(782,660).
catalyst(791,660) :- not remove_reaction(791,660).
catalyst(792,660) :- not remove_reaction(792,660).
catalyst(801,660) :- not remove_reaction(801,660).
catalyst(802,660) :- not remove_reaction(802,660).
catalyst(811,660) :- not remove_reaction(811,660).
catalyst(812,660) :- not remove_reaction(812,660).
catalyst(821,660) :- not remove_reaction(821,660).
catalyst(822,660) :- not remove_reaction(822,660).
catalyst(831,660) :- not remove_reaction(831,660).
catalyst(832,660) :- not remove_reaction(832,660).
catalyst(841,660) :- not remove_reaction(841,660).
catalyst(842,660) :- not remove_reaction(842,660).
catalyst(861,660) :- not remove_reaction(861,660).
catalyst(862,660) :- not remove_reaction(862,660).
catalyst(881,660) :- not remove_reaction(881,660).
catalyst(882,660) :- not remove_reaction(882,660).
catalyst(901,660) :- not remove_reaction(901,660).
catalyst(902,660) :- not remove_reaction(902,660).
catalyst(911,660) :- not remove_reaction(911,660).
catalyst(912,660) :- not remove_reaction(912,660).
catalyst(921,660) :- not remove_reaction(921,660).
catalyst(922,660) :- not remove_reaction(922,660).
catalyst(941,660) :- not remove_reaction(941,660).
catalyst(942,660) :- not remove_reaction(942,660).
catalyst(1191,660) :- not remove_reaction(1191,660).
catalyst(1192,660) :- not remove_reaction(1192,660).
catalyst(1021,655).
catalyst(1022,655).
catalyst(6610,626).
catalyst(1170,623).
...
catalyst(6550,344).
catalyst(6690,342).
catalyst(791,312) :- not remove_reaction(791,312).
catalyst(792,312) :- not remove_reaction(792,312).
...
catalyst(861,312) :- not remove_reaction(861,312).
catalyst(862,312) :- not remove_reaction(862,312).
