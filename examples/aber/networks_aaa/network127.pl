...
component("YNL280C",693).
component("YLR056W",583).
component("YGR060W",409).
component("YGL012W",380).
component("YKR009C",566).
component("YOL086C",723).
component("YMR303C",663).
component("YMR083W",641).
component("YGL256W",401).
component("YDL168W",247).
component("YBR145W",187).
component("YPL231W",790).
component("U46_",105).
component("YBR149W",188).
component("YJR159W",537).
component("YGL001C",377).
component("YIL094C",476).
component("YHR063C",455).
component("YBR153W",189).
component("YML056C",626).
component("YLR432W",619).
component("YHR216W",469).
component("YAR075W",152).
component("YAR073W",151).
component("YDR127W",276).
component("YJR139C",531).
component("YOL126C",728).
component("YDL078C",229).
component("YKL029C",542).
component("YOR136W",739).
component("YNL037C",668).
component("YDL066W",228).
component("YNL241C",683).
component("YOL059W",721).
component("YDL022W",223).
component("YLR355C",615).
component("YML054C",625).
component("YDL174C",249).
component("YML086C",629).
component("YIL155C",482).
component("YPR191W",822).
component("YOR065W",733).
component("YJL166W",507).
component("YHR001W-A",444).
component("YGR183C",424).
component("YFR033C",373).
component("YDR529C",320).
component("YBL045C",158).
component("Q0105",18).
component("YGR088W",412).
component("YDR256C",291).
component("YKL026C",541).
component("YIR037W",490).
component("YBR244W",200).
component("YJR078W",522).
component("YJR025C",515).
component("YGR255C",436).
component("U108_",22).
component("YBL098W",162).
component("YMR015C",638).
component("YHR007C",445).
component("YDR402C",309).
component("YGL055W",385).
component("YGR175C",421).
component("YJR104C",525).
component("YHR008C",446).
component("YJL026W",491).
component("YIL066C",474).
component("YGR180C",423).
component("YER070W",345).
component("U38_",101).
component("U36_",100).
component("U35_",99).
component("YDL168W",248).
component("YDR158W",284).
component("YBR006W",163).
component("YPL276W",801).
component("YPL275W",800).
component("YOR388C",770).
component("YOR374W",767).
component("YER073W",346).
component("U68_",119).
component("YGL154C",393).
component("U55_",113).
component("YOR323C",759).
component("YMR170C",649).
component("YMR169C",648).
component("U2_",95).
component("YER178W",360).
component("YBR221C",198).
component("YIL125W",480).
component("U52_",110).
component("YBR166C",192).
component("YNL280C",694).
component("YGL012W",381).
component("U57_",114).
component("YKL216W",563).
component("YDR044W",265).
component("YER014W",332).
component("YKR009C",567).
component("YIL160C",484).
component("YGL205W",396).
component("YMR118C",645).
component("YLR164W",596).
component("YLL041C",576).
component("YKL148C",553).
component("YKL141W",551).
component("YJL045W",492).
component("YDR178W",285).
component("YJR051W",517).
component("YEL047C",326).
component("YDL215C",253).
component("YOR375C",768).
component("YDL215C",254).
component("YAL062W",149).
component("U99_",144).
component("YBR035C",173).
component("YHR037W",452).
component("YKR080W",571).
component("YER023W",333).
component("YPL023C",774).
component("YGL125W",390).
component("YOR236W",754).
component("YGR204W",428).
component("YLR142W",591).
component("U62_",117).
component("YKL150W",554).
component("YIL043C",471).
component("YHR042W",453).
component("YOR221C",752).
component("YML120C",632).
component("YKL192C",560).
component("YKL055C",544).
component("YER061C",341).
component("YGR234W",431).
component("YFR030W",372).
component("YPL017C",773).
component("YFL018C",364).
component("YER042W",335).
component("YJR137C",530).
component("YPL266W",797).
component("YML110C",631).
component("YBR034C",172).
component("YPL273W",798).
component("YLL062C",579).
component("YDR410C",312).
component("U47_",106).
component("YER091C",352).
component("YJR073C",520).
component("YDL033C",225).
component("YOL096C",724).
component("YLR172C",597).
component("YDR019C",261).
component("YBR176W",193).
component("YDR408C",311).
component("YMR120C",646).
component("YBL013W",153).
component("YKL024C",540).
component("YPR074C",813).
component("YBR117C",183).
component("YLR354C",614).
component("YGR043C",407).
component("YMR108W",643).
component("YCL009C",210).
component("YMR062C",640).
component("YNL071W",671).
component("YNR008W",701).
component("YNL277W",692).
component("YFL017C",363).
component("YPL231W",791).
component("YER061C",342).
component("U86_",134).
component("YPL001W",772).
component("YDR148C",282).
component("YOR377W",769).
component("YGR177C",422).
component("YPL231W",792).
component("YGR147C",417).
component("YDL040C",226).
component("YPL028W",775).
component("YGL017W",382).
component("YPR001W",803).
component("YNR001C",699).
component("YDL182W",250).
component("YDL131W",238).
component("YNL117W",675).
component("YIR031C",488).
component("YOR321W",758).
component("YJR143C",532).
component("YGR199W",427).
component("YDR307W",299).
component("YDL095W",233).
component("YDL093W",232).
component("YAL023C",146).
component("YNL029C",667).
component("YIL085C",475).
component("YMR261C",657).
component("YML100W",630).
component("YBR126C",186).
component("YNL192W",682).
component("YBR038W",175).
component("YBR023C",171).
component("YMR306W",665).
component("YLR342W",612).
component("YGR032W",405).
component("YLR209C",598).
component("U104_",21).
component("YOR209C",750).
component("YMR300C",662).
component("YER055C",337).
component("YDR354W",305) :- not remove_orf("YDR354W",305).
component("YFR047C",374).
component("YJR133W",529).
component("YLR209C",599).
component("YML022W",622).
component("YDR441C",315).
component("YDR399W",307).
component("YJL167W",508).
component("YNL256W",686).
component("YDR127W",277).
component("YLR303W",606).
component("YGR012W",403).
component("YJR130C",528).
component("YLR303W",607).
component("YDR035W",263).
component("YBR249C",201).
component("YOL143C",730).
component("YBR256C",203).
component("YHR137W",463).
component("YGL202W",395).
component("YLR027C",580).
component("YKL106W",548).
component("YKL104C",547).
component("YGR019W",404).
component("YLR089C",586).
component("U64_",118).
component("U61_",116).
component("U51_",109).
component("YJR148W",533).
component("YOR184W",745).
component("YNR058W",709).
component("YIL116W",479).
component("YGL253W",400).
component("YFR053C",375).
component("YOL136C",729).
component("YIL107C",477).
component("YMR013C",637).
component("YMR205C",651).
component("YGR240C",432).
component("YDR248C",290).
component("YCR036W",219).
component("YGR194C",426).
component("YCL040W",213).
component("YJR105W",526).
component("U16_",50).
component("U15_",44).
component("U96_",142).
component("YKL001C",538).
component("YDR236C",288).
component("YML070W",628).
component("YFL053W",367).
component("YHL032C",442).
component("YLR133W",588).
component("YDR531W",322).
component("U83_",132).
component("U82_",131).
component("U81_",130).
component("YMR208W",652).
component("YHR025W",451).
component("YOR347C",764).
component("YAL038W",148).
component("YNR012W",702).
component("YPR121W",816).
component("YPL258C",794).
component("YOL055C",717).
component("YPL214C",788).
component("U1_",73).
component("YDR009W",260).
component("YBR020W",169).
component("YNL267W",690).
component("YLR305C",609).
component("YFR019W",370).
component("YDR208W",286).
component("YDR127W",278).
component("U21_",83).
component("U20_",80).
component("YDR147W",281).
component("YDR300C",298).
component("YCR012W",215).
component("U18_",65).
component("U17_",58).
component("U76_",127).
component("YMR220W",654).
component("YER170W",359).
component("YDR226W",287).
component("YKL067W",546).
component("YOL055C",718).
component("YDR454C",316).
component("YJR057W",518).
component("YOL061W",722).
component("YKL181W",556).
component("YHL011C",440).
component("YER099C",354).
component("YBL068W",161).
component("YOR143C",741).
component("YNL256W",687).
component("YLR328W",610).
component("YBR018C",165).
component("YBR018C",166).
component("YGR007W",402).
component("YLR328W",611).
component("YKR002W",565).
component("YDL103C",236).
component("YJR010W",514).
component("YGL130W",391).
component("YDR530C",321).
component("YCL050C",214).
component("YPR190C",821).
component("YPR187W",820).
component("YPR110C",815).
component("YPR010C",806).
component("YOR341W",763).
component("YOR340C",762).
component("YOR224C",753).
component("YOR210W",751).
component("YOR207C",748).
component("YOR151C",742).
component("YOR116C",736).
component("YOL005C",711).
component("YNR003C",700).
component("YNL248C",685).
component("YNL151C",679).
component("YNL113W",674).
component("YKL144C",552).
component("YJR063W",519).
component("YJL148W",504).
component("YJL140W",503).
component("YIL021W",470).
component("YHR143W-A",464).
component("YGL070C",388).
component("YFL036W",366).
component("YDR404C",310).
component("YDR156W",283).
component("YDR045C",266).
component("YDL150W",245).
component("YDL140C",240).
component("YBR154C",191).
component("YPR175W",819).
component("YPL167C",784).
component("YOR330C",760).
component("YOL115W",727).
component("YNL299W",696).
component("YNL262W",689).
component("YNL102W",673).
component("YJR043C",516).
component("YJR006W",513).
component("YJL090C",496).
component("YIL139C",481).
component("YEL055C",327).
component("YDR419W",313).
component("YDR121W",275).
component("YDL102W",235).
component("YCR014C",216).
component("YBR278W",205).
component("YBL035C",155).
component("YKL035W",543).
component("YHL012W",441).
component("YHR123W",462).
component("YBR243C",199).
component("YDL142C",244).
component("YPL148C",782).
component("YER026C",334).
component("YCL004W",209).
component("YJL068C",493).
component("YDR058C",270).
component("YNR034W",706).
component("YHR163W",466).
component("YGR248W",434).
component("YCR073W-A",220).
component("YDL086W",231).
component("YOL011W",713).
component("YMR008C",635).
component("YMR006C",634).
component("U101_",19).
component("YBL015W",154).
component("YJL068C",494).
component("YPL072W",778).
component("YOR124C",737).
component("YNL186W",681).
component("YMR304W",664).
component("YMR223W",655).
component("YKR098C",574).
component("YJL197W",509).
component("YIL156W",483).
component("YFR010W",369).
component("YER151C",357).
component("YER144C",356).
component("YER098W",353).
component("YDR069C",271).
component("YDL122W",237).
component("YBR058C",176).
component("YBL067C",160).
component("YDR272W",294).
component("U84_",133).
component("YLR377C",617).
component("YDR074W",272).
component("YPL179W",785).
component("YNR032W",704).
component("YML057W",627).
component("YML016C",621).
component("YLR433C",620).
component("YGR123C",415).
component("YER133W",355).
component("YER089C",350).
component("YDR436W",314).
component("YDR075W",273).
component("YDL188C",251).
component("YDL134C",239).
component("YDL047W",227).
component("YDL006W",221).
component("YBR125C",185).
component("YBL056W",159).
component("YPR073C",811).
component("YHR215W",468).
component("YDL024C",224).
component("YBR093C",181).
component("YBR092C",180).
component("YAR071W",150).
component("YIL053W",473).
component("YER062C",343).
component("YHR046C",454).
component("YGR208W",430).
component("YPL228W",789).
component("YMR180C",650).
component("YDL236W",256).
component("YJL155C",506).
component("YPR073C",812).
component("YOR208W",749).
component("YNL053W",670).
component("YMR036C",639).
component("YIR026C",485).
component("YIL113W",478).
component("YFR028C",371).
component("YER075C",347).
component("YDL230W",255).
component("YBR276C",204).
component("U34_",98).
component("U33_",97).
component("U30_",96).
component("U28_",94).
...
component("U25_",92).
component("U24_",91).
component("YOR360C",766).
component("YGL248W",399).
component("YKR031C",568).
component("YPL206C",786).
component("YLR286C",604).
component("YJR153W",535).
component("YOR190W",746).
component("YLR300W",605).
component("YGR282C",439).
component("YDR261C",292).
component("YDR400W",308).
component("U23_",90).
component("YML035C",623).
component("YJL070C",495).
component("YBR284W",206).
component("U102_",20).
component("YNL045W",669).
component("YLR160C",595).
component("YLR158C",594).
component("YLR157C",593).
component("YLR155C",592).
component("YDR321W",300).
component("YGL037C",384).
component("YMR293C",661).
component("YDR242W",289).
component("YBR208C",195).
component("YMR281W",660).
component("U53_",111).
component("YIR027C",486).
component("YPL111W",781).
component("YIR032C",489).
component("YIR029W",487).
component("YPR062W",810).
component("YMR120C",647).
component("YLR028C",581).
component("YHR144C",465).
component("YGR267C",438).
component("YNL141W",676).
component("YBR153W",190).
component("YDL238C",257).
component("YNL141W",677).
component("YLR245C",602).
component("YML035C",624).
component("YJL126W",499).
component("U44_",104).
component("YDL100C",234).
component("U87_",135).
component("YMR267W",658).
component("YBR011C",164).
component("YBR111C",182).
component("YBR252W",202).
component("YCL030C",212).
component("YER005W",331).
component("YIL048W",472).
component("YER166W",358).
component("YDR093W",274).
component("YAL026C",147).
component("YLR231C",600).
component("U88_",136).
component("YLR134W",589).
component("YLR044C",582).
component("YGR087C",411).
component("YDR380W",306).
component("YDL080C",230).
component("U98_",143).
component("YMR250W",656).
component("YKL184W",559).
component("YNR043W",707).
component("U93_",141).
component("YDR047W",268).
component("U54_",112).
component("YKL211C",561) :- not remove_orf("YKL211C",561).
component("YKR097W",573).
component("YOL052C",716).
component("YNL169C",680).
component("YGR170W",419).
component("YKL060C",545).
component("YNL256W",688).
component("YDR294C",295).
component("YEL046C",325).
component("YNR033W",705).
component("YPR006C",805).
component("YER065C",344).
component("YKL211C",562) :- not remove_orf("YKL211C",562).
component("YER090W",562) :- not remove_orf("YER090W",562).
component("YER090W",351) :- not remove_orf("YER090W",351).
component("YDR127W",279).
component("YPL281C",802).
component("YOR393W",771).
component("YMR323W",666).
component("YHR174W",467).
component("YGR254W",435).
component("YPL262W",795).
component("YGL026C",383) :- not remove_orf("YGL026C",383).
component("YGR155W",418).
component("YLR304C",608).
component("YJL200C",510).
component("YNL316C",697).
component("YKL182W",557).
component("YPL212C",787).
component("YNL292W",695).
component("YGL063W",387).
component("YFL001W",361).
component("YOR278W",756).
component("YPR002W",804).
component("YDR127W",280).
component("YGL148W",392).
component("YER086W",348).
component("YLR359W",616).
component("YAL012W",145).
component("YFR055W",376).
component("YOR176W",744).
component("YJL121C",498).
component("YBR019C",167).
component("YBR019C",168).
component("YDR050C",269).
component("YDR007W",259) :- not remove_orf("YDR007W",259).
component("YOR095C",735).
component("YER003C",330).
component("YBR196C",194).
component("YGL001C",378).
component("U14_",37).
component("YOL056W",719).
component("YKL152C",555).
component("YDL021W",222).
component("YMR105C",642).
component("YKL127W",549).
component("YEL058W",328).
component("YPR060C",809).
component("YHR072W",456).
component("YJL153C",505).
component("YPL097W",779).
component("YGR185C",425).
component("YGR264C",437).
component("YGR171C",420).
component("YHR011W",447).
component("YDR023W",262).
component("YPL104W",780).
component("YLL018C",575).
component("YPR081C",814).
component("YBR121C",184).
component("YHR020W",450).
component("YER087W",349).
component("YNL247W",684).
component("YOL033W",715).
component("YHR091C",458).
component("YDR341C",301).
component("YOL097C",725).
component("YDR268W",293).
component("YPR047W",808).
component("YLR060W",584).
component("YFL022C",365).
component("YPR033C",807).
component("YHR019C",448).
component("YHR019C",449).
component("YPL160W",783).
component("YLR382C",618).
component("YNL073W",672).
component("YDR037W",264).
component("YOR335C",761).
component("YGR094W",413).
component("YOR142W",740).
component("YGR244C",433).
component("U89_",137).
component("YOR241W",755).
component("YMR113W",644).
component("YKL132C",550).
component("YJL101C",497).
component("U92_",140).
component("YGL234W",397).
component("U91_",139).
component("U90_",138).
component("YDL141W",241).
component("YDL141W",242).
component("YGL234W",398).
component("YDL141W",243).
component("YJR103W",524).
component("YBL039C",156).
component("YGR204W",429).
component("YBR084W",179).
component("YOL058W",720).
component("YBR208C",196).
component("YHR074W",457).
component("YMR217W",653).
component("YGR061C",410).
component("YPR145W",818).
component("YGR124W",416).
component("YOR303W",757).
component("YJR109C",527).
component("YJL130C",501).
component("YGL062W",386).
component("YBR218C",197).
component("YPL231W",793).
component("YNR016C",703).
component("YKL182W",558).
component("YGR037C",406).
component("YOR005C",732).
component("YDL164C",246).
component("YOL010W",712).
component("YPR138C",817).
component("YPL274W",799).
component("YPL265W",796).
component("YPL057C",777).
component("YPL036W",776).
component("YOR348C",765).
component("YOR192C",747).
component("YOR171C",743).
component("YOR130C",738).
component("YOR071C",734).
component("YOL156W",731).
component("YOL103W",726).
component("YOL020W",714) :- not remove_orf("YOL020W",714).
component("YNR072W",710).
component("YNR056C",708).
component("YNL318C",698).
component("YNL268W",691).
component("YNL142W",678).
component("YMR272C",659).
component("YMR011W",636).
component("YML123C",633).
component("YLR348C",613).
component("YLR260W",603).
component("YLR237W",601).
component("YLR138W",590).
component("YLR100C",587).
component("YLR081W",585).
component("YLL061W",578).
component("YLL043W",577).
component("YKR093W",572).
component("YKR053C",570).
component("YKR039W",569) :- not remove_orf("YKR039W",569).
component("YKL217W",564).
component("YKL004W",539).
component("YJR158W",536).
component("YJR152W",534).
component("YJR095W",523).
component("YJR077C",521).
component("YJL219W",512).
component("YJL214W",511).
component("YJL134W",502).
component("YJL129C",500).
component("YHR096C",461).
component("YHR094C",460).
component("YHR092C",459).
component("YHL036W",443).
component("YGR121C",414).
component("YGR055W",408).
component("YGL186C",394).
component("YGL077C",389).
component("YGL008C",379).
component("YFL055W",368).
component("YFL011W",362).
component("YER060W-A",340).
component("YER060W",339).
component("YER056C",338).
component("YER053C",336).
component("YEL069C",329).
component("YEL017C-A",324).
component("YDR536W",323).
component("YDR508C",319).
component("YDR503C",318).
component("YDR497C",317).
component("YDR345C",304).
component("YDR343C",303).
component("YDR342C",302).
component("YDR297W",297).
component("YDR294C",296).
component("YDR046C",267) :- not remove_orf("YDR046C",267).
component("YDL245C",258).
component("YDL210W",252).
component("YCR032W",218).
component("YCR024C-A",217).
component("YCL025C",211).
component("YBR298C",208).
component("YBR291C",207).
component("YBR069C",178) :- not remove_orf("YBR069C",178).
component("YBR068C",177) :- not remove_orf("YBR068C",177).
component("YBR036C",174).
component("YBR021W",170).
...
catalyst(6160,662).
catalyst(3870,337).
catalyst(3620,305) :- not remove_reaction(3620,305).
catalyst(2110,374).
catalyst(2190,374).
catalyst(5550,529).
catalyst(5791,599).
...
catalyst(1960,268).
catalyst(3460,112).
catalyst(3600,561) :- not remove_reaction(3600,561).
catalyst(8000,573).
catalyst(3941,716).
catalyst(3942,716).
catalyst(6890,680).
...
catalyst(8020,805).
catalyst(8020,344).
catalyst(1890,562) :- not remove_reaction(1890,562).
catalyst(3630,562) :- not remove_reaction(3630,562).
catalyst(1890,351) :- not remove_reaction(1890,351).
catalyst(3630,351) :- not remove_reaction(3630,351).
catalyst(3740,279).
catalyst(8231,802).
catalyst(8232,802).
catalyst(8231,771).
...
catalyst(8051,795).
catalyst(8052,795).
catalyst(3590,383) :- not remove_reaction(3590,383).
catalyst(10910,383) :- not remove_reaction(10910,383).
catalyst(4570,418).
catalyst(8181,608).
catalyst(8182,608).
catalyst(8181,510).
...
catalyst(8281,269).
catalyst(8282,269).
catalyst(3610,259) :- not remove_reaction(3610,259).
catalyst(7921,735).
catalyst(7922,735).
catalyst(7841,330).
catalyst(7842,330).
...
catalyst(941,714) :- not remove_reaction(941,714).
catalyst(942,714) :- not remove_reaction(942,714).
catalyst(1210,710).
catalyst(700,708).
catalyst(1200,698).
catalyst(761,691).
...
catalyst(640,572).
catalyst(6560,570).
catalyst(761,569) :- not remove_reaction(761,569).
catalyst(762,569) :- not remove_reaction(762,569).
catalyst(771,569) :- not remove_reaction(771,569).
catalyst(772,569) :- not remove_reaction(772,569).
catalyst(781,569) :- not remove_reaction(781,569).
catalyst(782,569) :- not remove_reaction(782,569).
catalyst(791,569) :- not remove_reaction(791,569).
catalyst(792,569) :- not remove_reaction(792,569).
catalyst(801,569) :- not remove_reaction(801,569).
catalyst(802,569) :- not remove_reaction(802,569).
catalyst(811,569) :- not remove_reaction(811,569).
catalyst(812,569) :- not remove_reaction(812,569).
catalyst(821,569) :- not remove_reaction(821,569).
catalyst(822,569) :- not remove_reaction(822,569).
catalyst(831,569) :- not remove_reaction(831,569).
catalyst(832,569) :- not remove_reaction(832,569).
catalyst(841,569) :- not remove_reaction(841,569).
catalyst(842,569) :- not remove_reaction(842,569).
catalyst(861,569) :- not remove_reaction(861,569).
catalyst(862,569) :- not remove_reaction(862,569).
catalyst(881,569) :- not remove_reaction(881,569).
catalyst(882,569) :- not remove_reaction(882,569).
catalyst(901,569) :- not remove_reaction(901,569).
catalyst(902,569) :- not remove_reaction(902,569).
catalyst(911,569) :- not remove_reaction(911,569).
catalyst(912,569) :- not remove_reaction(912,569).
catalyst(941,569) :- not remove_reaction(941,569).
catalyst(942,569) :- not remove_reaction(942,569).
catalyst(1191,569) :- not remove_reaction(1191,569).
catalyst(1192,569) :- not remove_reaction(1192,569).
catalyst(1021,564).
catalyst(1022,564).
catalyst(6610,539).
catalyst(1210,536).
...
catalyst(6650,297).
catalyst(6550,296).
catalyst(791,267) :- not remove_reaction(791,267).
catalyst(792,267) :- not remove_reaction(792,267).
catalyst(801,267) :- not remove_reaction(801,267).
catalyst(802,267) :- not remove_reaction(802,267).
catalyst(811,267) :- not remove_reaction(811,267).
catalyst(812,267) :- not remove_reaction(812,267).
catalyst(831,267) :- not remove_reaction(831,267).
catalyst(832,267) :- not remove_reaction(832,267).
catalyst(841,267) :- not remove_reaction(841,267).
catalyst(842,267) :- not remove_reaction(842,267).
catalyst(861,267) :- not remove_reaction(861,267).
catalyst(862,267) :- not remove_reaction(862,267).
catalyst(901,267) :- not remove_reaction(901,267).
catalyst(902,267) :- not remove_reaction(902,267).
catalyst(1210,258).
catalyst(730,252).
catalyst(431,218).
catalyst(432,218).
...
catalyst(1511,207).
catalyst(1512,207).
catalyst(771,178) :- not remove_reaction(771,178).
catalyst(772,178) :- not remove_reaction(772,178).
catalyst(791,178) :- not remove_reaction(791,178).
catalyst(792,178) :- not remove_reaction(792,178).
catalyst(801,178) :- not remove_reaction(801,178).
catalyst(802,178) :- not remove_reaction(802,178).
catalyst(811,178) :- not remove_reaction(811,178).
catalyst(812,178) :- not remove_reaction(812,178).
catalyst(861,178) :- not remove_reaction(861,178).
catalyst(862,178) :- not remove_reaction(862,178).
catalyst(901,178) :- not remove_reaction(901,178).
catalyst(902,178) :- not remove_reaction(902,178).
catalyst(791,177) :- not remove_reaction(791,177).
catalyst(792,177) :- not remove_reaction(792,177).
catalyst(801,177) :- not remove_reaction(801,177).
catalyst(802,177) :- not remove_reaction(802,177).
catalyst(811,177) :- not remove_reaction(811,177).
catalyst(812,177) :- not remove_reaction(812,177).
catalyst(831,177) :- not remove_reaction(831,177).
catalyst(832,177) :- not remove_reaction(832,177).
catalyst(841,177) :- not remove_reaction(841,177).
catalyst(842,177) :- not remove_reaction(842,177).
catalyst(861,177) :- not remove_reaction(861,177).
catalyst(862,177) :- not remove_reaction(862,177).
catalyst(901,177) :- not remove_reaction(901,177).
catalyst(902,177) :- not remove_reaction(902,177).
catalyst(6600,174).
catalyst(620,170).
catalyst(540,157).
catalyst(2830,129).
...
modifiable_enzyme(561).
modifiable_enzyme(562).
modifiable_enzyme(351).
modifiable_enzyme(383).
modifiable_enzyme(259).
modifiable_enzyme(714).
modifiable_enzyme(569).
modifiable_enzyme(267).
modifiable_enzyme(178).
