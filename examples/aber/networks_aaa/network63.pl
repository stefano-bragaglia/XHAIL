...
component("YGR060W",250).
component("YGL012W",233).
component("YOL086C",428).
component("YMR303C",395).
component("YGL256W",244).
component("YDL168W",148).
component("YBR145W",114).
component("YPL231W",471).
component("YBR149W",115).
component("YGL001C",230).
component("YHR063C",273).
component("YML056C",374).
component("YLR432W",370).
component("YHR216W",281).
component("YAR075W",96).
component("YAR073W",95).
component("YDR127W",164).
component("YJR139C",321).
component("YOR136W",438).
component("YDL066W",140).
component("YML086C",376).
component("YIL155C",289).
component("YPR191W",494).
component("YOR065W",433).
component("YJL166W",305).
component("YHR001W-A",270).
component("YGR183C",259).
component("YFR033C",226).
component("YDR529C",193).
component("YBL045C",100).
component("Q0105",18).
component("YGR088W",252).
component("YDR256C",176).
component("YJR078W",314).
component("YJR025C",309).
component("YBL098W",103).
component("YMR015C",380).
component("YDR402C",185).
component("YJR104C",317).
component("YHR008C",271).
component("YER070W",209).
component("U35_",59).
component("YDL168W",149).
component("YPL276W",479).
component("YPL275W",478).
component("YOR388C",460).
component("YGL154C",240).
component("U55_",66).
component("YOR323C",450).
component("YMR170C",388).
component("YMR169C",387).
component("U2_",56).
component("YBR166C",118).
component("YNL280C",413).
component("YER014W",201).
component("YMR118C",385).
component("YLR164W",355).
component("YLL041C",347).
component("YKL148C",331).
component("YJL045W",294).
component("YDR178W",171).
component("YJR051W",311).
component("YEL047C",197).
component("YOR375C",458).
component("YDL215C",151).
component("YAL062W",93).
component("U99_",89).
component("YBR035C",106).
component("YKR080W",344).
component("YER023W",202).
component("YOR236W",447).
component("YGR204W",260).
component("U62_",68).
component("YKL150W",332).
component("YIL043C",283).
component("YHR042W",272).
component("YPL017C",463).
component("YFL018C",219).
component("YPL273W",477).
component("YLL062C",349).
component("U47_",61).
component("YDL033C",138).
component("YOL096C",429).
component("YDR408C",187).
component("YKL024C",324).
component("YPR074C",487).
component("YBR117C",113).
component("YLR354C",369).
component("YGR043C",248).
component("YCL009C",129).
component("YMR062C",382).
component("YPL231W",472).
component("U86_",82).
component("YPL001W",462).
component("YOR377W",459).
component("YGR177C",258).
component("YPL231W",473).
component("YGR147C",255).
component("YDL040C",139).
component("YPL028W",464).
component("YPR001W",481).
component("YNR001C",417).
component("YDL182W",150).
component("YNL117W",403).
component("YIR031C",292).
component("YNL029C",398).
component("YIL085C",286).
component("YLR209C",356).
component("YMR300C",394).
component("YER055C",204).
component("YDR354W",181) :- not remove_orf("YDR354W",181).
component("YFR047C",227).
component("YJR133W",320).
component("YLR209C",357).
component("YML022W",371).
component("YDR441C",189).
component("YDR399W",183).
component("YNL256W",409).
component("YDR127W",165).
component("YLR303W",363).
component("YJR130C",319).
component("YLR303W",364).
component("YDR035W",156).
component("YBR249C",122).
component("YBR256C",123).
component("YHR137W",276).
component("YGL202W",242).
component("YLR027C",350).
component("YKL106W",327).
component("YKL104C",326).
component("YGR019W",246).
component("U64_",69).
component("U51_",63).
component("YJR148W",322).
component("YGL253W",243).
component("YFR053C",228).
component("YMR205C",390).
component("YGR240C",262).
component("YDR248C",175).
component("YCR036W",136).
component("YCL040W",131).
component("YJR105W",318).
component("U16_",34).
component("U15_",31).
component("U96_",87).
component("YKL001C",323).
component("YML070W",375).
component("YFL053W",221).
component("YHL032C",268).
component("U83_",80).
component("U82_",79).
component("YMR208W",391).
component("YOR347C",455).
component("YAL038W",92).
component("YPR121W",489).
component("YPL258C",475).
component("YOL055C",425).
component("U1_",43).
component("YNL267W",411).
component("YLR305C",366).
component("YFR019W",224).
...
component("U18_",40).
component("U76_",77).
component("YER170W",217).
component("YDR226W",173).
component("YDR454C",190).
component("YOL061W",427).
component("YKL181W",334).
component("YHL011C",266).
component("YER099C",213).
component("YBL068W",102).
component("YOR143C",439).
component("YGR007W",245).
component("YLR328W",367).
component("YCL050C",132).
component("YPR190C",493).
component("YPR187W",492).
component("YPR110C",488).
component("YPR010C",483).
component("YOR341W",454).
component("YOR340C",453).
component("YOR224C",446).
component("YOR210W",445).
component("YOR207C",443).
component("YOR151C",440).
component("YOR116C",436).
component("YOL005C",422).
component("YNR003C",418).
component("YNL248C",408).
component("YNL151C",406).
component("YNL113W",402).
component("YKL144C",330).
component("YJR063W",312).
component("YJL148W",303).
component("YJL140W",302).
component("YIL021W",282).
component("YHR143W-A",277).
component("YGL070C",238).
component("YFL036W",220).
...
component("YPR175W",491).
component("YPL167C",468).
component("YOR330C",451).
component("YOL115W",431).
component("YNL299W",415).
component("YNL262W",410).
component("YNL102W",401).
component("YJR043C",310).
component("YJR006W",308).
component("YJL090C",297).
component("YIL139C",288).
...
component("YKL035W",325).
component("YHL012W",267).
component("YER026C",203).
component("YDR058C",160).
component("YDL086W",142).
component("YOL011W",423).
component("YMR008C",379).
component("YMR006C",378).
component("U101_",19).
component("YBL015W",97).
component("YJL068C",295).
component("YPL072W",466).
component("YOR124C",437).
component("YNL186W",407).
component("YMR304W",396).
component("YMR223W",392).
component("YKR098C",345).
component("YJL197W",306).
component("YIL156W",290).
component("YFR010W",223).
component("YER151C",215).
component("YER144C",214).
component("YER098W",212).
component("YDR069C",161).
component("YDL122W",144).
component("YBR058C",107).
component("YBL067C",101).
component("U84_",81).
component("YPR073C",485).
component("YHR215W",280).
component("YDL024C",137).
component("YBR093C",111).
component("YBR092C",110).
component("YAR071W",94).
component("YIL053W",285).
component("YER062C",208).
component("YGR208W",261).
component("YPL228W",470).
component("YMR180C",389).
component("YDL236W",153).
component("YJL155C",304).
component("YPR073C",486).
component("YOR208W",444).
component("YNL053W",400).
component("YMR036C",381).
component("YIR026C",291).
component("YIL113W",287).
component("YFR028C",225).
component("YER075C",210).
...
component("YKR031C",341).
component("YLR286C",361).
component("YOR190W",441).
component("YLR300W",362).
component("YGR282C",265).
component("YDR261C",177).
component("YDR400W",184).
component("U23_",53).
component("YML035C",372).
component("YJL070C",296).
component("YBR284W",126).
component("U102_",20).
component("YNL045W",399).
component("YGL037C",235).
component("YDR242W",174).
component("YBR208C",119).
component("U53_",64).
component("YIR032C",293).
component("YMR120C",386).
component("YHR144C",278).
component("YBR153W",116).
component("YDL238C",154).
component("YNL141W",404).
component("YLR245C",360).
component("YML035C",373).
component("YJL126W",299).
component("U87_",83).
component("YBR111C",112).
component("YER005W",200).
component("YIL048W",284).
component("YER166W",216).
component("YDR093W",162).
component("YAL026C",91).
component("YLR231C",358).
component("U88_",84).
component("YLR134W",353).
component("YLR044C",351).
component("YGR087C",251).
component("YDR380W",182).
component("YDL080C",141).
component("U98_",88).
component("YKL184W",337).
component("YNR043W",421).
component("U93_",86).
component("U54_",65).
component("YKL211C",338) :- not remove_orf("YKL211C",338).
component("YGR170W",257).
...
component("YER090W",211) :- not remove_orf("YER090W",211).
component("YDR127W",167).
component("YPL281C",480).
component("YOR393W",461).
component("YMR323W",397).
component("YHR174W",279).
component("YGR254W",264).
component("YGL026C",234) :- not remove_orf("YGL026C",234).
component("YGR155W",256).
component("YLR304C",365).
component("YJL200C",307).
component("YNL316C",416).
component("YKL182W",335).
component("YPL212C",469).
component("YNL292W",414).
component("YGL063W",237).
component("YFL001W",218).
component("YPR002W",482).
component("YDR127W",168).
component("YGL148W",239).
component("YAL012W",90).
component("YFR055W",229).
component("YBR019C",104).
component("YDR050C",159).
component("YDR007W",155) :- not remove_orf("YDR007W",155).
component("YOR095C",435).
component("YER003C",199).
component("YGL001C",231).
component("YKL152C",333).
component("YMR105C",383).
component("YKL127W",328).
component("YPR060C",484).
component("YPL104W",467).
component("YLL018C",346).
component("YHR091C",275).
component("YDR341C",180).
component("YOL097C",430).
component("YOR335C",452).
component("YGR094W",253).
component("YGR244C",263).
component("U89_",85).
component("YOR241W",448).
component("YMR113W",384).
component("YKL132C",329).
component("YJL101C",298).
component("YJR103W",316).
component("YBL039C",99).
component("YOL058W",426).
component("YBR208C",120).
component("YHR074W",274).
component("YOR303W",449).
component("YGL062W",236).
component("YBR218C",121).
component("YPL231W",474).
component("YNR016C",419).
component("YKL182W",336).
component("YGR037C",247).
component("YOR005C",432).
component("YDL164C",147).
component("YPR138C",490).
component("YPL265W",476).
component("YPL036W",465).
component("YOR348C",456).
component("YOR192C",442).
component("YOR071C",434).
component("YOL020W",424) :- not remove_orf("YOL020W",424).
component("YNL268W",412).
component("YNL142W",405).
component("YMR272C",393).
component("YML123C",377).
component("YLR348C",368).
component("YLR237W",359).
component("YLR138W",354).
component("YLR100C",352).
component("YLL061W",348).
component("YKR053C",343).
component("YKR039W",342) :- not remove_orf("YKR039W",342).
component("YKL217W",340).
component("YJR095W",315).
component("YJR077C",313).
component("YJL134W",301).
component("YJL129C",300).
component("YHL036W",269).
component("YGR121C",254).
component("YGR055W",249).
component("YGL186C",241).
component("YGL008C",232).
component("YFL055W",222).
component("YER060W-A",207).
component("YER060W",206).
component("YER056C",205).
...
catalyst(3630,211) :- not remove_reaction(3630,211).
catalyst(3740,167).
catalyst(8231,480).
catalyst(8232,480).
catalyst(8231,461).
...
catalyst(190,442).
catalyst(190,434).
catalyst(801,424) :- not remove_reaction(801,424).
catalyst(802,424) :- not remove_reaction(802,424).
catalyst(811,424) :- not remove_reaction(811,424).
catalyst(812,424) :- not remove_reaction(812,424).
catalyst(831,424) :- not remove_reaction(831,424).
catalyst(832,424) :- not remove_reaction(832,424).
catalyst(941,424) :- not remove_reaction(941,424).
catalyst(942,424) :- not remove_reaction(942,424).
catalyst(761,412).
catalyst(762,412).
catalyst(371,405).
catalyst(372,405).
...
catalyst(750,348).
catalyst(6560,343).
catalyst(761,342) :- not remove_reaction(761,342).
catalyst(762,342) :- not remove_reaction(762,342).
catalyst(771,342) :- not remove_reaction(771,342).
catalyst(772,342) :- not remove_reaction(772,342).
catalyst(781,342) :- not remove_reaction(781,342).
catalyst(782,342) :- not remove_reaction(782,342).
...
catalyst(881,342) :- not remove_reaction(881,342).
catalyst(882,342) :- not remove_reaction(882,342).
catalyst(941,342) :- not remove_reaction(941,342).
catalyst(942,342) :- not remove_reaction(942,342).
catalyst(1191,342) :- not remove_reaction(1191,342).
catalyst(1192,342) :- not remove_reaction(1192,342).
catalyst(1021,340).
catalyst(1022,340).
catalyst(1250,315).
catalyst(1581,313).
