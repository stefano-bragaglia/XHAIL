...
component("YGR060W",152).
component("YGL012W",141).
component("YOL086C",251).
component("YMR303C",233).
component("YGL256W",149).
component("YDL168W",91).
component("YBR145W",69).
component("YPL231W",275).
component("YGL001C",138).
component("YML056C",221).
component("YLR432W",219).
component("YHR216W",169).
component("YAR075W",57).
component("YAR073W",56).
component("YDR127W",101).
component("YJR139C",193).
component("YOR136W",256).
component("YIL155C",173).
component("YJR078W",187).
component("YJR025C",184).
component("YMR015C",225).
component("YDR402C",115).
component("YJR104C",190).
component("YHR008C",163).
component("YER070W",126).
component("YGL154C",147).
component("YMR170C",229).
component("YMR169C",228).
component("YBR166C",71).
component("YER014W",123).
component("YMR118C",227).
component("YLR164W",213).
component("YLL041C",209).
component("YKL148C",200).
component("YJL045W",176).
component("YDR178W",107).
component("YEL047C",122).
component("YOR375C",268).
component("YDL215C",92).
component("YAL062W",55).
component("YER023W",124).
component("YOR236W",263).
component("YGR204W",158).
component("U62_",45).
component("YPL017C",271).
component("YFL018C",130).
component("U47_",40).
component("YKL024C",196).
component("YPR074C",285).
component("YBR117C",68).
component("YCL009C",80).
component("YPL231W",276).
component("YPL001W",270).
component("YPL231W",277).
component("YPL028W",272).
component("YNL029C",235).
component("YIL085C",171).
component("YLR209C",214).
component("YER055C",125).
component("YDR354W",111) :- not remove_orf("YDR354W",111).
component("YFR047C",136).
component("YJR133W",192).
component("YDR399W",113).
component("YDR127W",102).
component("YJR130C",191).
component("YDR035W",97).
component("YBR249C",74).
component("YBR256C",75).
component("YHR137W",165).
component("YLR027C",210).
component("YKL106W",198).
component("U64_",46).
component("U51_",41).
component("YJR148W",194).
component("YGL253W",148).
component("YFR053C",137).
component("YMR205C",231).
component("YGR240C",159).
component("YCR036W",84).
component("U16_",25).
component("U15_",23).
component("YKL001C",195).
component("YML070W",222).
component("YFL053W",132).
component("U83_",52).
component("U82_",51).
component("YMR208W",232).
component("YOR347C",267).
component("YAL038W",54).
component("U1_",32).
component("YNL267W",242).
component("YLR305C",218).
component("YFR019W",134).
component("YDR208W",108).
component("YDR127W",103).
component("U20_",35).
component("YDR300C",110).
component("U18_",29).
component("U76_",50).
component("YDR454C",117).
component("YOL061W",250).
component("YKL181W",201).
component("YHL011C",161).
component("YER099C",129).
component("YBL068W",60).
component("YOR143C",257).
component("YGR007W",150).
component("YCL050C",82).
component("YPR190C",289).
component("YPR187W",288).
component("YPR110C",286).
component("YPR010C",281).
component("YOR341W",266).
component("YOR340C",265).
component("YOR224C",262).
component("YOR210W",261).
component("YOR207C",259).
component("YOR151C",258).
component("YOR116C",255).
component("YOL005C",247).
component("YNR003C",244).
component("YNL248C",241).
component("YNL151C",240).
component("YNL113W",238).
component("YKL144C",199).
component("YJR063W",185).
component("YJL148W",182).
component("YJL140W",181).
component("YIL021W",170).
component("YHR143W-A",166).
component("YGL070C",145).
component("YFL036W",131).
component("YDR404C",116).
component("YDR156W",106).
component("YDR045C",98).
component("YDL150W",89).
component("YDL140C",88).
component("YBR154C",70).
component("YKL035W",197).
component("YHL012W",162).
component("YDR058C",100).
component("YDL086W",87).
component("YOL011W",248).
component("YMR008C",224).
component("YMR006C",223).
component("U101_",18).
component("YBL015W",58).
component("U84_",53).
component("YPR073C",283).
component("YHR215W",168).
component("YDL024C",85).
component("YBR093C",66).
component("YBR092C",65).
component("YPL228W",274).
component("YMR180C",230).
component("YDL236W",94).
component("YJL155C",183).
component("YPR073C",284).
component("YOR208W",260).
component("YNL053W",237).
component("YMR036C",226).
component("YIR026C",174).
component("YIL113W",172).
component("YFR028C",135).
component("YER075C",127).
component("YDL230W",93).
component("YBR276C",76).
component("U34_",39).
component("U30_",38).
component("U24_",37).
component("YKR031C",206).
component("YLR286C",217).
component("YDR400W",114).
component("YML035C",220).
component("YJL070C",177).
component("YBR284W",77).
component("YNL045W",236).
component("YGL037C",143).
component("U53_",42).
component("YIR032C",175).
component("YDL238C",95).
component("YLR245C",216).
component("YJL126W",179).
component("YBR111C",67).
component("YLR231C",215).
component("YLR134W",212).
component("YLR044C",211).
component("YGR087C",153).
component("YDR380W",112).
component("YDL080C",86).
component("U54_",43).
component("YKL211C",204) :- not remove_orf("YKL211C",204).
component("YGR170W",157).
component("YDR294C",109).
component("YNR033W",246).
...
component("YPL281C",280).
component("YOR393W",269).
component("YMR323W",234).
component("YHR174W",167).
component("YGR254W",160).
component("YGL026C",142) :- not remove_orf("YGL026C",142).
component("YGR155W",156).
component("YNL316C",243).
component("YKL182W",202).
component("YDR127W",105).
component("YGL148W",146).
component("YBR019C",61).
component("YDR007W",96) :- not remove_orf("YDR007W",96).
component("YOR095C",254).
component("YGL001C",139).
component("YPR060C",282).
component("YOL097C",252).
component("YOR335C",264).
component("YGR094W",154).
component("YJL101C",178).
component("YJR103W",189).
component("YBL039C",59).
component("YBR208C",72).
component("YHR074W",164).
component("YGL062W",144).
component("YBR218C",73).
component("YPL231W",278).
component("YNR016C",245).
component("YKL182W",203).
component("YGR037C",151).
component("YOR005C",253).
component("YDL164C",90).
component("YPR138C",287).
component("YPL265W",279).
component("YPL036W",273).
component("YOL020W",249) :- not remove_orf("YOL020W",249).
component("YNL142W",239).
component("YKR053C",208).
component("YKR039W",207) :- not remove_orf("YKR039W",207).
component("YJR095W",188).
component("YJR077C",186).
component("YJL134W",180).
component("YGR121C",155).
...
component("YDR046C",99) :- not remove_orf("YDR046C",99).
component("YCR024C-A",83).
component("YCL025C",81).
component("YBR298C",79).
component("YBR291C",78).
component("YBR069C",64) :- not remove_orf("YBR069C",64).
component("YBR068C",63) :- not remove_orf("YBR068C",63).
component("YBR021W",62).
component("U71_",49).
component("U6_",48).
component("U69_",47).
component("U5_",44).
...
catalyst(8231,160).
catalyst(8232,160).
catalyst(3590,142) :- not remove_reaction(3590,142).
catalyst(10910,142) :- not remove_reaction(10910,142).
catalyst(4570,156).
catalyst(3680,243).
catalyst(7141,202).
catalyst(7142,202).
...
catalyst(8711,61).
catalyst(8712,61).
catalyst(3610,96) :- not remove_reaction(3610,96).
catalyst(7921,254).
catalyst(7922,254).
catalyst(6370,139).
catalyst(3690,282).
...
catalyst(372,239).
catalyst(6560,208).
catalyst(771,207) :- not remove_reaction(771,207).
catalyst(772,207) :- not remove_reaction(772,207).
catalyst(781,207) :- not remove_reaction(781,207).
catalyst(782,207) :- not remove_reaction(782,207).
...
catalyst(881,207) :- not remove_reaction(881,207).
catalyst(882,207) :- not remove_reaction(882,207).
catalyst(1191,207) :- not remove_reaction(1191,207).
catalyst(1192,207) :- not remove_reaction(1192,207).
catalyst(1250,188).
catalyst(1581,186).
catalyst(1582,186).
catalyst(6560,180).
