...
component("YNL280C",575).
component("YGR060W",341).
component("YGL012W",316).
component("YKR009C",472).
component("YOL086C",598).
component("YMR303C",549).
component("YGL256W",334).
component("YDL168W",207).
component("YBR145W",160).
component("YPL231W",652).
component("U46_",88).
component("YBR149W",161).
component("YJR159W",448).
component("YGL001C",313).
component("YIL094C",393).
component("YHR063C",376).
component("YBR153W",162).
component("YML056C",521).
component("YLR432W",517).
component("YHR216W",387).
component("YAR075W",130).
component("YAR073W",129).
component("YDR127W",230).
component("YJR139C",445).
component("YOL126C",602).
component("YDL078C",194).
component("YKL029C",452).
component("YOR136W",612).
component("YNL037C",553).
component("YDL066W",193).
component("YLR355C",514).
component("YML086C",523).
component("YIL155C",399).
component("YPR191W",680).
component("YOR065W",607).
component("YJL166W",423).
component("YHR001W-A",368).
component("YGR183C",352).
component("YFR033C",309).
component("YDR529C",265).
component("YBL045C",136).
component("Q0105",18).
component("YGR088W",343).
component("YDR256C",244).
component("YKL026C",451).
component("YIR037W",406).
component("YBR244W",171).
component("YJR078W",436).
component("YJR025C",430).
component("YGR255C",361).
component("U108_",22).
component("YBL098W",139).
component("YMR015C",529).
component("YDR402C",257).
component("YGL055W",321).
component("YGR175C",349).
component("YJR104C",439).
component("YHR008C",369).
component("YJL026W",407).
component("YGR180C",351).
component("YER070W",285).
component("U35_",84).
component("YDL168W",208).
component("YDR158W",238).
component("YPL276W",661).
component("YPL275W",660).
component("YOR388C",638).
component("YOR374W",635).
component("YER073W",286).
component("YGL154C",327).
component("U55_",95).
component("YOR323C",627).
component("YMR170C",537).
component("YMR169C",536).
component("U2_",81).
component("YBR221C",170).
component("YIL125W",397).
component("U52_",92).
component("YBR166C",165).
component("YNL280C",576).
component("YGL012W",317).
component("U57_",96).
component("YDR044W",221).
component("YER014W",274).
component("YKR009C",473).
component("YIL160C",401).
component("YGL205W",330).
component("YMR118C",534).
component("YLR164W",498).
component("YLL041C",481).
component("YKL148C",461).
component("YKL141W",459).
component("YJL045W",408).
component("YDR178W",239).
component("YJR051W",432).
component("YEL047C",269).
component("YOR375C",636).
component("YDL215C",211).
component("YAL062W",127).
component("U99_",123).
component("YBR035C",148).
component("YHR037W",373).
component("YKR080W",477).
component("YER023W",275).
component("YOR236W",624).
component("YGR204W",354).
component("YLR142W",493).
component("U62_",99).
component("YKL150W",462).
component("YIL043C",389).
component("YHR042W",374).
component("YFR030W",308).
component("YPL017C",641).
component("YFL018C",300).
component("YER042W",277).
component("YJR137C",444).
component("YPL266W",658).
component("YML110C",525).
component("YBR034C",147).
component("YPL273W",659).
component("YLL062C",484).
component("U47_",89).
component("YER091C",291).
component("YJR073C",434).
component("YDL033C",191).
component("YOL096C",599).
component("YLR172C",499).
component("YDR019C",217).
component("YDR408C",259).
component("YBL013W",131).
component("YKL024C",450).
component("YPR074C",672).
component("YBR117C",157).
component("YLR354C",513).
component("YGR043C",339).
component("YCL009C",180).
component("YMR062C",531).
component("YNL071W",556).
component("YNR008W",583).
component("YPL231W",653).
component("YER061C",283).
component("U86_",114).
component("YPL001W",640).
component("YDR148C",236).
component("YOR377W",637).
component("YGR177C",350).
component("YPL231W",654).
component("YGR147C",346).
component("YDL040C",192).
component("YPL028W",642).
component("YGL017W",318).
component("YPR001W",663).
component("YNR001C",581).
component("YDL182W",209).
component("YDL131W",200).
component("YNL117W",560).
component("YIR031C",404).
component("YDR307W",250).
component("YNL029C",552).
component("YIL085C",392).
component("YMR261C",544).
component("YML100W",524).
component("YBR126C",159).
component("YNL192W",567).
component("YBR038W",150).
component("YBR023C",146).
component("YLR209C",500).
component("U104_",21).
component("YOR209C",621).
component("YMR300C",548).
component("YER055C",279).
component("YDR354W",253) :- not remove_orf("YDR354W",253).
component("YFR047C",310).
component("YJR133W",443).
component("YLR209C",501).
component("YML022W",518).
component("YDR441C",261).
component("YDR399W",255).
component("YJL167W",424).
component("YNL256W",570).
component("YDR127W",231).
component("YLR303W",507).
component("YGR012W",336).
component("YJR130C",442).
component("YLR303W",508).
component("YDR035W",219).
component("YBR249C",172).
component("YOL143C",604).
component("YBR256C",173).
component("YHR137W",381).
component("YGL202W",329).
component("YLR027C",485).
component("YKL106W",456).
component("YKL104C",455).
component("YGR019W",337).
component("YLR089C",489).
component("U64_",100).
component("U61_",98).
component("U51_",91).
component("YJR148W",446).
component("YOR184W",616).
component("YIL116W",396).
component("YGL253W",333).
component("YFR053C",311).
component("YOL136C",603).
component("YIL107C",394).
component("YMR205C",539).
component("YGR240C",357).
component("YDR248C",243).
component("YCR036W",188).
component("YCL040W",183).
component("YJR105W",440).
component("U16_",42).
component("U15_",38).
component("U96_",121).
component("YKL001C",449).
component("YML070W",522).
component("YFL053W",303).
component("YHL032C",366).
component("U83_",112).
component("U82_",111).
component("U81_",110).
component("YMR208W",540).
component("YOR347C",632).
component("YAL038W",126).
component("YNR012W",584).
component("YPR121W",675).
component("YPL258C",656).
component("YOL055C",595).
component("U1_",62).
component("YDR009W",216).
component("YBR020W",144).
component("YNL267W",573).
component("YLR305C",510).
component("YFR019W",306).
component("YDR208W",240).
component("YDR127W",232).
component("U21_",71).
component("U20_",69).
component("YDR147W",235).
component("YDR300C",249).
component("YCR012W",185).
component("U18_",55).
component("U17_",49).
component("U76_",108).
component("YER170W",297).
component("YDR226W",241).
component("YKL067W",454).
component("YDR454C",262).
component("YOL061W",597).
component("YKL181W",464).
component("YHL011C",364).
component("YER099C",293).
component("YBL068W",138).
component("YOR143C",614).
component("YBR018C",141).
component("YGR007W",335).
component("YLR328W",511).
component("YKR002W",471).
component("YDL103C",198).
component("YJR010W",429).
component("YCL050C",184).
component("YPR190C",679).
component("YPR187W",678).
component("YPR110C",674).
component("YPR010C",665).
component("YOR341W",631).
component("YOR340C",630).
component("YOR224C",623).
component("YOR210W",622).
component("YOR207C",619).
component("YOR151C",615).
component("YOR116C",610).
component("YOL005C",590).
component("YNR003C",582).
component("YNL248C",569).
component("YNL151C",564).
component("YNL113W",559).
component("YKL144C",460).
component("YJR063W",433).
component("YJL148W",420).
component("YJL140W",419).
component("YIL021W",388).
component("YHR143W-A",382).
component("YGL070C",324).
component("YFL036W",302).
component("YDR404C",258).
component("YDR156W",237).
component("YDR045C",222).
component("YDL150W",205).
component("YDL140C",201).
component("YBR154C",164).
component("YPR175W",677).
component("YPL167C",649).
component("YOR330C",628).
component("YOL115W",601).
component("YNL299W",578).
component("YNL262W",572).
component("YNL102W",558).
component("YJR043C",431).
component("YJR006W",428).
component("YJL090C",412).
component("YIL139C",398).
component("YEL055C",270).
component("YDR419W",260).
component("YDR121W",229).
component("YDL102W",197).
component("YCR014C",186).
component("YBR278W",175).
component("YBL035C",133).
component("YKL035W",453).
component("YHL012W",365).
component("YHR123W",380).
component("YDL142C",204).
component("YER026C",276).
component("YCL004W",179).
component("YJL068C",409).
component("YDR058C",226).
component("YNR034W",587).
component("YHR163W",384).
component("YGR248W",359).
component("YCR073W-A",189).
component("YDL086W",196).
component("YOL011W",592).
component("YMR008C",528).
component("YMR006C",527).
component("U101_",19).
component("YBL015W",132).
component("YJL068C",410).
component("YPL072W",645).
component("YOR124C",611).
component("YNL186W",566).
component("YMR304W",550).
component("YMR223W",542).
component("YKR098C",479).
component("YJL197W",425).
component("YIL156W",400).
component("YFR010W",305).
component("YER151C",295).
component("YER144C",294).
component("YER098W",292).
component("YDR069C",227).
component("YDL122W",199).
component("YBR058C",151).
component("YBL067C",137).
component("YDR272W",246).
component("U84_",113).
component("YPR073C",670).
component("YHR215W",386).
component("YDL024C",190).
component("YBR093C",155).
component("YBR092C",154).
component("YAR071W",128).
component("YIL053W",391).
component("YER062C",284).
component("YHR046C",375).
component("YGR208W",356).
component("YPL228W",651).
component("YMR180C",538).
component("YDL236W",213).
component("YJL155C",422).
component("YPR073C",671).
component("YOR208W",620).
component("YNL053W",555).
component("YMR036C",530).
component("YIR026C",402).
component("YIL113W",395).
component("YFR028C",307).
component("YER075C",287).
component("YDL230W",212).
...
component("U25_",79).
component("U24_",78).
component("YOR360C",634).
component("YGL248W",332).
component("YKR031C",474).
component("YLR286C",505).
component("YJR153W",447).
component("YOR190W",617).
component("YLR300W",506).
component("YGR282C",363).
component("YDR261C",245).
component("YDR400W",256).
component("U23_",77).
component("YML035C",519).
component("YJL070C",411).
component("YBR284W",176).
component("U102_",20).
component("YNL045W",554).
component("YLR160C",497).
component("YLR158C",496).
component("YLR157C",495).
component("YLR155C",494).
component("YDR321W",251).
component("YGL037C",320).
component("YDR242W",242).
component("YBR208C",167).
component("YMR281W",547).
component("U53_",93).
component("YIR032C",405).
component("YIR029W",403).
component("YPR062W",669).
component("YMR120C",535).
component("YHR144C",383).
component("YGR267C",362).
component("YNL141W",561).
component("YBR153W",163).
component("YDL238C",214).
component("YNL141W",562).
component("YLR245C",504).
component("YML035C",520).
component("YJL126W",415).
component("U44_",87).
component("U87_",115).
component("YMR267W",545).
component("YBR011C",140).
component("YBR111C",156).
component("YCL030C",182).
component("YER005W",273).
component("YIL048W",390).
component("YER166W",296).
component("YDR093W",228).
component("YAL026C",125).
component("YLR231C",502).
component("U88_",116).
component("YLR134W",491).
component("YLR044C",486).
component("YGR087C",342).
component("YDR380W",254).
component("YDL080C",195).
component("U98_",122).
component("YMR250W",543).
component("YKL184W",467).
component("YNR043W",588).
component("U93_",120).
component("YDR047W",224).
component("U54_",94).
component("YKL211C",468) :- not remove_orf("YKL211C",468).
component("YNL169C",565).
component("YGR170W",348).
component("YNL256W",571).
component("YDR294C",247).
component("YEL046C",268).
component("YNR033W",586).
component("YKL211C",469) :- not remove_orf("YKL211C",469).
component("YER090W",469) :- not remove_orf("YER090W",469).
component("YER090W",290) :- not remove_orf("YER090W",290).
component("YDR127W",233).
component("YPL281C",662).
component("YOR393W",639).
component("YMR323W",551).
component("YHR174W",385).
component("YGR254W",360).
component("YGL026C",319) :- not remove_orf("YGL026C",319).
component("YGR155W",347).
component("YLR304C",509).
component("YJL200C",426).
component("YNL316C",579).
component("YKL182W",465).
component("YPL212C",650).
component("YNL292W",577).
component("YGL063W",323).
component("YFL001W",298).
component("YPR002W",664).
component("YDR127W",234).
component("YGL148W",326).
component("YER086W",288).
component("YLR359W",515).
component("YAL012W",124).
component("YFR055W",312).
component("YJL121C",414).
component("YBR019C",142).
component("YBR019C",143).
component("YDR050C",225).
component("YDR007W",215) :- not remove_orf("YDR007W",215).
component("YOR095C",609).
component("YER003C",272).
component("YBR196C",166).
component("YGL001C",314).
component("U14_",32).
component("YKL152C",463).
component("YMR105C",532).
component("YKL127W",457).
component("YEL058W",271).
component("YPR060C",668).
component("YHR072W",377).
component("YJL153C",421).
component("YPL097W",646).
component("YGR185C",353).
component("YHR011W",370).
component("YDR023W",218).
component("YPL104W",647).
component("YLL018C",480).
component("YPR081C",673).
component("YBR121C",158).
component("YHR020W",372).
component("YER087W",289).
component("YNL247W",568).
component("YOL033W",594).
component("YHR091C",379).
component("YDR341C",252).
component("YOL097C",600).
component("YPR047W",667).
component("YLR060W",487).
component("YFL022C",301).
component("YPR033C",666).
component("YHR019C",371).
component("YPL160W",648).
component("YLR382C",516).
component("YNL073W",557).
component("YDR037W",220).
component("YOR335C",629).
component("YGR094W",344).
component("YOR142W",613).
component("YGR244C",358).
component("U89_",117).
component("YOR241W",625).
component("YMR113W",533).
component("YKL132C",458).
component("YJL101C",413).
component("U92_",119).
component("YGL234W",331).
component("U91_",118).
component("YDL141W",202).
component("YDL141W",203).
component("YJR103W",438).
component("YBL039C",134).
component("YGR204W",355).
component("YOL058W",596).
component("YBR208C",168).
component("YHR074W",378).
component("YMR217W",541).
component("YOR303W",626).
component("YJR109C",441).
component("YJL130C",417).
component("YGL062W",322).
component("YBR218C",169).
component("YPL231W",655).
component("YNR016C",585).
component("YKL182W",466).
component("YGR037C",338).
component("YOR005C",606).
component("YDL164C",206).
component("YOL010W",591).
component("YPR138C",676).
component("YPL265W",657).
component("YPL057C",644).
component("YPL036W",643).
component("YOR348C",633).
component("YOR192C",618).
component("YOR071C",608).
component("YOL156W",605).
component("YOL020W",593) :- not remove_orf("YOL020W",593).
component("YNR056C",589).
component("YNL318C",580).
component("YNL268W",574).
component("YNL142W",563).
component("YMR272C",546).
component("YML123C",526).
component("YLR348C",512).
component("YLR237W",503).
component("YLR138W",492).
component("YLR100C",490).
component("YLR081W",488).
component("YLL061W",483).
component("YLL043W",482).
component("YKR093W",478).
component("YKR053C",476).
component("YKR039W",475) :- not remove_orf("YKR039W",475).
component("YKL217W",470).
component("YJR095W",437).
component("YJR077C",435).
component("YJL219W",427).
component("YJL134W",418).
component("YJL129C",416).
component("YHL036W",367).
component("YGR121C",345).
component("YGR055W",340).
component("YGL186C",328).
component("YGL077C",325).
component("YGL008C",315).
component("YFL055W",304).
component("YFL011W",299).
component("YER060W-A",282).
component("YER060W",281).
component("YER056C",280).
component("YER053C",278).
component("YEL017C-A",267).
component("YDR536W",266).
component("YDR508C",264).
component("YDR503C",263).
component("YDR294C",248).
component("YDR046C",223) :- not remove_orf("YDR046C",223).
component("YDL210W",210).
component("YCR024C-A",187).
component("YCL025C",181).
component("YBR298C",178).
component("YBR291C",177).
component("YBR069C",153) :- not remove_orf("YBR069C",153).
component("YBR068C",152) :- not remove_orf("YBR068C",152).
component("YBR036C",149).
component("YBR021W",145).
component("YBL042C",135).
component("U79_",109).
component("U75_",107).
component("U74_",106).
component("U73_",105).
...
catalyst(6160,548).
catalyst(3870,279).
catalyst(3620,253) :- not remove_reaction(3620,253).
catalyst(2110,310).
catalyst(2190,310).
catalyst(5550,443).
catalyst(5791,501).
...
catalyst(1960,224).
catalyst(3460,94).
catalyst(3600,468) :- not remove_reaction(3600,468).
catalyst(6890,565).
catalyst(6900,348).
catalyst(2570,571).
catalyst(8781,247).
...
catalyst(4560,268).
catalyst(2550,586).
catalyst(1890,469) :- not remove_reaction(1890,469).
catalyst(3630,469) :- not remove_reaction(3630,469).
catalyst(1890,290) :- not remove_reaction(1890,290).
catalyst(3630,290) :- not remove_reaction(3630,290).
catalyst(3740,233).
catalyst(8231,662).
catalyst(8232,662).
catalyst(8231,639).
...
catalyst(8231,360).
catalyst(8232,360).
catalyst(3590,319) :- not remove_reaction(3590,319).
catalyst(10910,319) :- not remove_reaction(10910,319).
catalyst(4570,347).
catalyst(8181,509).
catalyst(8182,509).
catalyst(8181,426).
...
catalyst(8281,225).
catalyst(8282,225).
catalyst(3610,215) :- not remove_reaction(3610,215).
catalyst(7921,609).
catalyst(7922,609).
catalyst(7841,272).
catalyst(7842,272).
...
catalyst(190,608).
catalyst(1200,605).
catalyst(801,593) :- not remove_reaction(801,593).
catalyst(802,593) :- not remove_reaction(802,593).
catalyst(811,593) :- not remove_reaction(811,593).
catalyst(812,593) :- not remove_reaction(812,593).
catalyst(831,593) :- not remove_reaction(831,593).
catalyst(832,593) :- not remove_reaction(832,593).
catalyst(901,593) :- not remove_reaction(901,593).
catalyst(902,593) :- not remove_reaction(902,593).
catalyst(941,593) :- not remove_reaction(941,593).
catalyst(942,593) :- not remove_reaction(942,593).
catalyst(700,589).
catalyst(1200,580).
catalyst(761,574).
catalyst(762,574).
...
catalyst(640,478).
catalyst(6560,476).
catalyst(761,475) :- not remove_reaction(761,475).
catalyst(762,475) :- not remove_reaction(762,475).
catalyst(771,475) :- not remove_reaction(771,475).
catalyst(772,475) :- not remove_reaction(772,475).
catalyst(781,475) :- not remove_reaction(781,475).
catalyst(782,475) :- not remove_reaction(782,475).
catalyst(791,475) :- not remove_reaction(791,475).
catalyst(792,475) :- not remove_reaction(792,475).
catalyst(801,475) :- not remove_reaction(801,475).
catalyst(802,475) :- not remove_reaction(802,475).
catalyst(811,475) :- not remove_reaction(811,475).
catalyst(812,475) :- not remove_reaction(812,475).
catalyst(821,475) :- not remove_reaction(821,475).
catalyst(822,475) :- not remove_reaction(822,475).
catalyst(831,475) :- not remove_reaction(831,475).
catalyst(832,475) :- not remove_reaction(832,475).
catalyst(841,475) :- not remove_reaction(841,475).
catalyst(842,475) :- not remove_reaction(842,475).
catalyst(861,475) :- not remove_reaction(861,475).
catalyst(862,475) :- not remove_reaction(862,475).
catalyst(881,475) :- not remove_reaction(881,475).
catalyst(882,475) :- not remove_reaction(882,475).
catalyst(901,475) :- not remove_reaction(901,475).
catalyst(902,475) :- not remove_reaction(902,475).
catalyst(911,475) :- not remove_reaction(911,475).
catalyst(912,475) :- not remove_reaction(912,475).
catalyst(941,475) :- not remove_reaction(941,475).
catalyst(942,475) :- not remove_reaction(942,475).
catalyst(1191,475) :- not remove_reaction(1191,475).
catalyst(1192,475) :- not remove_reaction(1192,475).
catalyst(1021,470).
catalyst(1022,470).
catalyst(1250,437).
catalyst(1581,435).
...
catalyst(1511,177).
catalyst(1512,177).
catalyst(771,153) :- not remove_reaction(771,153).
catalyst(772,153) :- not remove_reaction(772,153).
catalyst(791,153) :- not remove_reaction(791,153).
catalyst(792,153) :- not remove_reaction(792,153).
...
catalyst(861,153) :- not remove_reaction(861,153).
catalyst(862,153) :- not remove_reaction(862,153).
...
catalyst(831,152) :- not remove_reaction(831,152).
catalyst(832,152) :- not remove_reaction(832,152).
catalyst(841,152) :- not remove_reaction(841,152).
catalyst(842,152) :- not remove_reaction(842,152).
