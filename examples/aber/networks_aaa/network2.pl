...
component("YGL012W",49).
component("YDR127W",35).
component("YOR136W",75).
component("YJR078W",59).
component("YJR025C",58).
component("YBR166C",26).
component("YPR074C",81).
component("YBR117C",25).
component("YDR354W",41) :- not remove_orf("YDR354W",41).
component("YFR047C",48).
component("YDR127W",36).
component("YJR130C",60).
component("YDR035W",33).
component("YBR249C",27).
component("YHR137W",55).
component("YLR027C",66).
component("YKL106W",61).
component("YCR036W",30).
component("YFR019W",47).
component("YDR208W",40).
component("YDR127W",37).
component("YOL061W",73).
component("YKL181W",62).
component("YHL011C",54).
component("YER099C",45).
component("YBL068W",21).
component("YML035C",68).
component("YJL070C",57).
component("YBR284W",28).
component("U53_",19).
component("YDL238C",31).
component("YBR111C",24).
component("YLR231C",67).
component("U54_",20).
component("YKL211C",63) :- not remove_orf("YKL211C",63).
component("YKL211C",64) :- not remove_orf("YKL211C",64).
component("YER090W",64) :- not remove_orf("YER090W",64).
component("YER090W",44) :- not remove_orf("YER090W",44).
component("YDR127W",38).
component("YPL281C",79).
component("YOR393W",77).
component("YMR323W",69).
component("YHR174W",56).
component("YGR254W",53).
component("YGL026C",50) :- not remove_orf("YGL026C",50).
component("YNL316C",71).
component("YDR127W",39).
component("YGL148W",51).
component("YDR007W",32) :- not remove_orf("YDR007W",32).
component("YOR095C",74).
component("YPR060C",80).
component("YOR335C",76).
component("YPR138C",82).
component("YPL265W",78).
component("YOL020W",72) :- not remove_orf("YOL020W",72).
component("YNL142W",70).
component("YKR039W",65) :- not remove_orf("YKR039W",65).
component("YGR121C",52).
component("YFL055W",46).
component("YDR536W",43).
component("YDR508C",42).
component("YDR046C",34) :- not remove_orf("YDR046C",34).
...
catalyst(7911,25).
catalyst(7912,25).
catalyst(3620,41) :- not remove_reaction(3620,41).
catalyst(2190,48).
catalyst(3710,36).
catalyst(9661,60).
catalyst(9662,60).
...
catalyst(3500,67).
catalyst(3460,20).
catalyst(3600,63) :- not remove_reaction(3600,63).
catalyst(3630,64) :- not remove_reaction(3630,64).
catalyst(3630,44) :- not remove_reaction(3630,44).
catalyst(3740,38).
catalyst(8231,79).
catalyst(8232,79).
catalyst(8231,77).
...
catalyst(8231,53).
catalyst(8232,53).
catalyst(3590,50) :- not remove_reaction(3590,50).
catalyst(10910,50) :- not remove_reaction(10910,50).
catalyst(3680,71).
catalyst(3750,39).
catalyst(3700,51).
catalyst(3610,32) :- not remove_reaction(3610,32).
catalyst(7921,74).
catalyst(7922,74).
catalyst(3690,80).
catalyst(8631,76).
...
catalyst(371,70).
catalyst(372,70).
catalyst(781,65) :- not remove_reaction(781,65).
catalyst(782,65) :- not remove_reaction(782,65).
...
catalyst(881,65) :- not remove_reaction(881,65).
catalyst(882,65) :- not remove_reaction(882,65).
catalyst(1191,65) :- not remove_reaction(1191,65).
catalyst(1192,65) :- not remove_reaction(1192,65).
catalyst(371,52).
catalyst(372,52).
catalyst(781,46).
catalyst(782,46).
...
catalyst(881,42).
catalyst(882,42).
catalyst(801,34) :- not remove_reaction(801,34).
catalyst(802,34) :- not remove_reaction(802,34).
catalyst(811,34) :- not remove_reaction(811,34).
catalyst(812,34) :- not remove_reaction(812,34).
catalyst(831,34) :- not remove_reaction(831,34).
catalyst(832,34) :- not remove_reaction(832,34).
catalyst(781,29).
catalyst(782,29).
catalyst(801,29).
catalyst(802,29).
