...
component("YGR060W",215).
component("YGL012W",200).
component("YOL086C",366).
component("YMR303C",336).
component("YGL256W",210).
component("YDL168W",132).
component("YBR145W",100).
component("YPL231W",403).
component("YGL001C",197).
component("YML056C",319).
component("YLR432W",316).
component("YHR216W",241).
component("YAR075W",84).
component("YAR073W",83).
component("YDR127W",146).
component("YJR139C",276).
component("YOR136W",374).
component("YDL066W",125).
component("YIL155C",247).
component("YPR191W",425).
component("YOR065W",370).
component("YJL166W",261).
component("YHR001W-A",232).
component("YGR183C",222).
component("YFR033C",194).
component("YDR529C",171).
component("YBL045C",88).
component("Q0105",18).
component("YJR078W",269).
component("YJR025C",264).
component("YBL098W",90).
component("YMR015C",324).
component("YDR402C",164).
component("YJR104C",272).
component("YHR008C",233).
component("YER070W",182).
component("YDL168W",133).
component("YPL276W",411).
component("YPL275W",410).
component("YOR388C",393).
component("YGL154C",207).
component("YOR323C",385).
component("YMR170C",331).
component("YMR169C",330).
component("YBR166C",103).
component("YNL280C",351).
component("YER014W",178).
component("YMR118C",328).
component("YLR164W",303).
component("YLL041C",298).
component("YKL148C",285).
component("YJL045W",251).
component("YDR178W",152).
component("YJR051W",266).
component("YEL047C",175).
component("YOR375C",392).
component("YDL215C",135).
component("YAL062W",82).
component("U99_",79).
component("YBR035C",93).
component("YKR080W",296).
component("YER023W",179).
component("YOR236W",383).
component("YGR204W",223).
component("U62_",60).
component("YKL150W",286).
component("YIL043C",243).
component("YPL017C",396).
component("YFL018C",188).
component("YPL273W",409).
component("YLL062C",299).
component("U47_",54).
component("YDL033C",123).
component("YKL024C",279).
component("YPR074C",418).
component("YBR117C",99).
component("YCL009C",114).
component("YMR062C",326).
component("YPL231W",404).
component("YPL001W",395).
component("YPL231W",405).
component("YGR147C",219).
component("YDL040C",124).
component("YPL028W",397).
component("YPR001W",413).
component("YNR001C",355).
component("YDL182W",134).
component("YNL117W",343).
component("YIR031C",249).
component("YNL029C",338).
component("YIL085C",244).
component("YLR209C",304).
component("YMR300C",335).
component("YER055C",181).
component("YDR354W",160) :- not remove_orf("YDR354W",160).
component("YFR047C",195).
component("YJR133W",275).
component("YML022W",317).
component("YDR441C",167).
component("YDR399W",162).
component("YNL256W",348).
component("YDR127W",147).
component("YLR303W",310).
component("YJR130C",274).
component("YLR303W",311).
component("YDR035W",140).
component("YBR249C",107).
component("YBR256C",108).
component("YHR137W",236).
component("YGL202W",208).
component("YLR027C",300).
component("YKL106W",282).
component("YKL104C",281).
component("YGR019W",212).
component("U64_",61).
component("U51_",56).
component("YJR148W",277).
component("YGL253W",209).
component("YFR053C",196).
component("YMR205C",333).
component("YGR240C",224).
component("YDR248C",155).
component("YCR036W",121).
component("YCL040W",116).
component("YJR105W",273).
component("U16_",31).
component("U15_",28).
component("U96_",77).
component("YKL001C",278).
component("YML070W",320).
component("YFL053W",190).
component("YHL032C",230).
component("U83_",72).
component("U82_",71).
component("YMR208W",334).
component("YOR347C",390).
component("YAL038W",81).
component("YPR121W",420).
component("YPL258C",407).
component("YOL055C",363).
component("U1_",40).
component("YNL267W",350).
component("YLR305C",313).
component("YFR019W",192).
...
component("U18_",37).
component("U76_",69).
component("YER170W",186).
component("YDR226W",154).
component("YDR454C",168).
component("YOL061W",365).
component("YKL181W",287).
component("YHL011C",228).
component("YER099C",185).
component("YBL068W",89).
component("YOR143C",375).
component("YGR007W",211).
component("YLR328W",314).
component("YCL050C",117).
component("YPR190C",424).
component("YPR187W",423).
component("YPR110C",419).
component("YPR010C",414).
component("YOR341W",389).
component("YOR340C",388).
component("YOR224C",382).
component("YOR210W",381).
component("YOR207C",379).
component("YOR151C",376).
component("YOR116C",373).
component("YOL005C",360).
component("YNR003C",356).
component("YNL248C",347).
component("YNL151C",346).
component("YNL113W",342).
component("YKL144C",284).
component("YJR063W",267).
component("YJL148W",259).
component("YJL140W",258).
component("YIL021W",242).
component("YHR143W-A",237).
component("YGL070C",205).
...
component("YPR175W",422).
component("YPL167C",400).
component("YOR330C",386).
component("YOL115W",368).
component("YNL299W",353).
component("YNL262W",349).
component("YNL102W",341).
component("YJR043C",265).
component("YJR006W",263).
component("YJL090C",253).
...
component("YKL035W",280).
component("YHL012W",229).
component("YER026C",180).
component("YDR058C",144).
component("YDL086W",127).
component("YOL011W",361).
component("YMR008C",323).
component("YMR006C",322).
component("U101_",19).
component("YBL015W",85).
component("U84_",73).
component("YPR073C",416).
component("YHR215W",240).
component("YDL024C",122).
component("YBR093C",97).
component("YBR092C",96).
component("YPL228W",402).
component("YMR180C",332).
component("YDL236W",137).
component("YJL155C",260).
component("YPR073C",417).
component("YOR208W",380).
component("YNL053W",340).
component("YMR036C",325).
component("YIR026C",248).
component("YIL113W",245).
component("YFR028C",193).
component("YER075C",183).
...
component("U25_",50).
component("U24_",49).
component("YOR360C",391).
component("YKR031C",293).
component("YLR286C",308).
component("YOR190W",377).
component("YLR300W",309).
component("YGR282C",227).
component("YDR261C",156).
component("YDR400W",163).
component("YML035C",318).
component("YJL070C",252).
component("YBR284W",111).
component("YNL045W",339).
component("YGL037C",202).
component("YBR208C",104).
component("U53_",57).
component("YIR032C",250).
component("YMR120C",329).
component("YHR144C",238).
component("YBR153W",101).
component("YDL238C",138).
component("YNL141W",344).
component("YLR245C",307).
component("YJL126W",255).
component("YBR111C",98).
component("YER005W",177).
component("YLR231C",305).
component("U88_",74).
component("YLR134W",302).
component("YLR044C",301).
component("YGR087C",216).
component("YDR380W",161).
component("YDL080C",126).
component("U98_",78).
component("YKL184W",290).
component("YNR043W",359).
component("U93_",76).
component("U54_",58).
component("YKL211C",291) :- not remove_orf("YKL211C",291).
component("YGR170W",221).
component("YDR294C",157).
component("YEL046C",174).
component("YNR033W",358).
component("YKL211C",292) :- not remove_orf("YKL211C",292).
component("YER090W",292) :- not remove_orf("YER090W",292).
component("YER090W",184) :- not remove_orf("YER090W",184).
component("YDR127W",149).
component("YPL281C",412).
component("YOR393W",394).
component("YMR323W",337).
component("YHR174W",239).
component("YGR254W",226).
component("YGL026C",201) :- not remove_orf("YGL026C",201).
component("YGR155W",220).
component("YLR304C",312).
component("YJL200C",262).
component("YNL316C",354).
component("YKL182W",288).
component("YPL212C",401).
component("YNL292W",352).
component("YGL063W",204).
component("YFL001W",187).
...
component("YOR095C",372).
component("YGL001C",198).
component("YMR105C",327).
component("YKL127W",283).
component("YPR060C",415).
component("YPL104W",399).
component("YLL018C",297).
component("YHR091C",235).
component("YDR341C",159).
component("YOL097C",367).
component("YOR335C",387).
component("YGR094W",217).
component("YGR244C",225).
component("U89_",75).
component("YJL101C",254).
component("YJR103W",271).
component("YBL039C",87).
component("YOL058W",364).
component("YBR208C",105).
component("YHR074W",234).
component("YOR303W",384).
component("YGL062W",203).
component("YBR218C",106).
component("YPL231W",406).
component("YNR016C",357).
component("YKL182W",289).
component("YGR037C",213).
component("YOR005C",369).
component("YDL164C",131).
component("YPR138C",421).
component("YPL265W",408).
component("YPL036W",398).
component("YOR192C",378).
component("YOR071C",371).
component("YOL020W",362) :- not remove_orf("YOL020W",362).
component("YNL142W",345).
component("YML123C",321).
component("YLR348C",315).
component("YLR237W",306).
component("YKR053C",295).
component("YKR039W",294) :- not remove_orf("YKR039W",294).
component("YJR095W",270).
component("YJR077C",268).
component("YJL134W",257).
component("YJL129C",256).
component("YHL036W",231).
component("YGR121C",218).
component("YGR055W",214).
...
catalyst(2300,76).
catalyst(3460,58).
catalyst(3600,291) :- not remove_reaction(3600,291).
catalyst(6900,221).
catalyst(8781,157).
catalyst(8782,157).
catalyst(4560,174).
...
catalyst(3630,184) :- not remove_reaction(3630,184).
catalyst(3740,149).
catalyst(8231,412).
catalyst(8232,412).
catalyst(8231,394).
...
catalyst(190,306).
catalyst(6560,295).
catalyst(771,294) :- not remove_reaction(771,294).
catalyst(772,294) :- not remove_reaction(772,294).
catalyst(781,294) :- not remove_reaction(781,294).
catalyst(782,294) :- not remove_reaction(782,294).
...
catalyst(841,294) :- not remove_reaction(841,294).
catalyst(842,294) :- not remove_reaction(842,294).
catalyst(881,294) :- not remove_reaction(881,294).
catalyst(882,294) :- not remove_reaction(882,294).
catalyst(1191,294) :- not remove_reaction(1191,294).
catalyst(1192,294) :- not remove_reaction(1192,294).
catalyst(1250,270).
catalyst(1581,268).
catalyst(1582,268).
catalyst(6560,257).
