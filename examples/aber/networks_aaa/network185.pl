...
in_compartment(Experiment,"C00084",cytosol,Day) :-
  not exclude(201),
  Day >= 1,
  in_compartment(Experiment,"C00084",medium,Day),
  catalyst(201,Complex),
  not inhibited(Experiment,Complex,Day),
  not deleted(Experiment,Complex).
...
in_compartment(Experiment,"C00487",cytosol,Day) :-
  not exclude(1420),
  Day >= 1,
  in_compartment(Experiment,"C00487",mitochondrion,Day),
  in_compartment(Experiment,"C02571",cytosol,Day),
  catalyst(1420,Complex),
  not inhibited(Experiment,Complex,Day),
  not deleted(Experiment,Complex).

in_compartment(Experiment,"C02571",mitochondrion,Day) :-
  not exclude(1420),
  Day >= 1,
  in_compartment(Experiment,"C00487",mitochondrion,Day),
  in_compartment(Experiment,"C02571",cytosol,Day),
...
in_compartment(Experiment,"C00006",mitochondrion,Day) :-
  ...
  Day >= 1,
  in_compartment(Experiment,"C00005",mitochondrion,Day),
  in_compartment(Experiment,"C00343",mitochondrion,Day),
  catalyst(5740,Complex),
  not inhibited(Experiment,Complex,Day),
  not deleted(Experiment,Complex).

in_compartment(Experiment,"C00342",mitochondrion,Day) :-
  not exclude(5740),
  Day >= 1,
  in_compartment(Experiment,"C00005",mitochondrion,Day),
  in_compartment(Experiment,"C00343",mitochondrion,Day),
...
retractable_reaction(201).
retractable_reaction(202).
...
retractable_reaction(4151).
retractable_reaction(4152).
...
retractable_reaction(7831).
retractable_reaction(7832).
...
component("YNL280C",932).
component("YLR056W",786).
component("YGR060W",548).
component("YGL012W",513).
component("YKR009C",765).
component("YOL086C",967).
component("YMR303C",897).
component("YMR083W",866).
component("YGL256W",540).
component("YDL168W",346).
component("YBR145W",266).
component("YPL231W",1058).
component("YBR265W",285).
component("U46_",158).
component("YBR149W",267).
component("YBR149W",268).
component("YJR159W",726).
component("YGL001C",510).
component("YIL094C",642).
component("YHR063C",606).
component("U45_",157).
component("YBR153W",269).
component("YML056C",846).
component("YLR432W",835).
component("YHR216W",631).
component("YAR075W",221).
component("YAR073W",220).
component("YCL030C",296).
component("YDR127W",385).
component("YJR139C",720).
component("YML075C",849).
component("YLR450W",838).
component("YOL126C",973).
component("YKL085W",737).
component("YDL078C",326).
component("YKL029C",732).
component("YOR136W",992).
component("YNL037C",903).
component("YNL009W",901).
component("YLR174W",805).
component("YDL066W",324).
component("YHR183W",625).
component("YGR256W",581).
component("YNL241C",922).
component("YOL059W",964).
component("YDL022W",316).
component("YCL018W",294).
component("YLR355C",830).
component("YIL074C",639).
component("YER081W",474).
component("YML054C",845).
component("YDL174C",350).
component("YML086C",850).
component("YIL155C",650).
component("YPR191W",1099).
component("YOR065W",981).
component("YJL166W",689).
component("YHR001W-A",593).
component("YGR183C",565).
component("YFR033C",506).
component("YDR529C",436).
component("YBL045C",228).
component("Q0105",19).
component("YGR088W",551).
component("YDR256C",403).
component("YKL026C",731).
component("YIR037W",665).
component("YBR244W",281).
component("YJR078W",711).
component("U58_",170).
component("YJR025C",702).
component("U107_",27).
component("YGR255C",580).
component("U108_",28).
component("YBL098W",232).
component("YMR015C",862).
component("YHR007C",594).
component("YDR402C",424).
component("YGL055W",520).
component("YGR175C",562).
component("YJR104C",714).
component("YHR008C",595).
component("YJL026W",668).
component("YIL066C",638).
component("YGR180C",564).
component("YER070W",471).
component("U38_",150).
component("U36_",149).
component("U35_",148).
component("YDL168W",347).
component("YDR158W",393).
component("YBR006W",237).
component("YPL276W",1070).
component("YPL275W",1069).
component("YOR388C",1030).
component("YPL061W",1038).
component("YOR374W",1027).
component("YER073W",472).
component("U68_",178).
component("YGL154C",529).
component("YBR115C",260).
component("U55_",167).
component("YER069W",469).
component("YOR323C",1017).
component("YMR170C",877).
component("YMR169C",876).
component("U2_",142).
component("YER178W",488).
component("YBR221C",279).
component("YIL125W",647).
component("U52_",164).
component("YBR166C",272).
component("YNL280C",933).
component("YGL012W",514).
component("YKL182W",751).
component("U57_",169).
component("YKL216W",762).
component("YDR044W",368).
component("YER014W",453).
component("YKR009C",766).
component("YIL160C",652).
component("YGL205W",534).
component("YMR118C",871).
component("YLR164W",803).
component("YLL041C",777).
component("YKL148C",745).
component("YKL141W",743).
component("YJL045W",669).
component("YDR178W",395).
component("YJR051W",705).
component("YEL047C",446).
component("YDL171C",348).
component("YDL171C",349).
component("YDL215C",354).
component("YOR375C",1028).
component("YDL215C",355).
component("YAL062W",216).
component("U99_",209).
component("YBR035C",247).
component("YMR189W",879).
component("U56_",168).
component("YNR050C",948).
component("YHR037W",602).
component("YKR080W",770).
component("YER023W",455).
component("YPL023C",1034).
component("YGL125W",526).
component("YOR236W",1009).
component("YGR204W",571).
component("YIR034C",664).
component("YLR142W",796).
component("U63_",175).
component("U62_",174).
component("YOR356W",1025).
component("YHR068W",607).
component("YKL150W",746).
component("YIL043C",635).
component("YHR042W",603).
component("YOR221C",1006).
component("YML120C",854).
component("YKL192C",755).
component("YKL055C",734).
component("YER061C",465).
component("YBR046C",250).
component("YPL171C",1049).
component("YHR179W",624).
component("YMR145C",874).
component("YML120C",855).
component("YKL192C",756).
component("YDL085W",328).
component("YGR234W",575).
component("YFR030W",505).
component("YPL017C",1033).
component("YFL018C",493).
component("YPL091W",1040).
component("YHR106W",616).
component("YDR353W",418).
component("YER042W",457).
component("YPR167C",1093).
component("YJR137C",719).
component("YNL052W",905).
component("YMR256C",888).
component("YLR395C",834).
component("YLR038C",784).
component("YIL111W",644).
component("YHR051W",605).
component("YGL191W",532).
component("YGL187C",531).
component("YDL067C",325).
component("Q0275",21).
component("Q0250",20).
component("Q0045",18).
component("YPL266W",1065).
component("YML110C",853).
component("YBR034C",246).
component("YPL273W",1067).
component("YLL062C",780).
component("YDR410C",427).
component("YOL096C",968).
component("U47_",159).
component("YER091C",479).
component("YJR073C",709).
component("YGR157W",559).
component("YDR120C",383).
component("YML008C",839).
component("YDL033C",318).
component("YOL096C",969).
component("YLR172C",804).
component("YLR058C",787).
component("YDR019C",364).
component("YBR176W",273).
component("YDR408C",426).
component("YMR120C",872).
component("YLR028C",782).
component("YBL013W",222).
component("YJL130C",681).
component("YJL088W",674).
component("YKL024C",729).
component("YPR074C",1085).
component("YBR117C",261).
component("YLR354C",829).
component("YGR043C",546).
component("YMR108W",869).
component("YCL009C",293).
component("YMR062C",865).
component("YNL071W",907).
component("YNR008W",940).
component("YIL160C",653).
component("YNL277W",931).
component("YDR232W",398).
component("YFL017C",492).
component("YPL231W",1059).
component("YER061C",466).
component("U86_",197).
component("YPL001W",1032).
component("YMR296C",895).
component("YDR062W",376).
component("YDL052C",322).
component("U8_",201).
component("YDR148C",391).
component("YAR035W",218).
component("YOR377W",1029).
component("YGR177C",563).
component("YPL231W",1060).
component("YGR147C",557).
component("YDL040C",319).
component("YPL028W",1035).
component("YLR195C",806).
component("YLR299W",816).
component("YGL017W",515).
component("YPR001W",1072).
component("YNR001C",938).
component("YCR005C",305).
component("YML126C",857).
component("YNL104C",910).
component("YDL182W",351).
component("YDL131W",337).
component("YNL117W",912).
component("YIR031C",662).
component("YOR321W",1016).
component("YJR143C",721).
component("YGR199W",569).
component("YDR307W",412).
component("YDL095W",332).
component("YDL093W",331).
component("YAL023C",212).
component("YLR258W",813).
component("YFR015C",501).
component("YOR103C",986).
component("YOR085W",983).
component("YMR149W",875).
component("YML019W",841).
component("YJL002C",666).
component("YEL002C",440).
component("YDL232W",357).
component("YCL043C",300).
component("YNL029C",902).
component("YIL085C",641).
component("YMR261C",889).
component("YML100W",851).
component("YBR126C",265).
component("YNL192W",920).
component("YBR038W",249).
component("YBR023C",245).
component("YMR306W",899).
component("YLR342W",827).
component("YGR032W",544).
component("YPR183W",1096).
component("YLR209C",807).
component("U104_",25).
component("U103_",24).
component("YMR271C",891).
component("YML106W",852).
component("YOR209C",1004).
component("YMR300C",896).
component("YER055C",461).
component("YDR354W",419) :- not remove_orf("YDR354W",419).
component("YFR047C",507).
component("YJR133W",718).
component("YLR209C",808).
component("YML022W",842).
component("YDR441C",430).
component("YDR399W",422).
component("YHR128W",618).
component("YPR176C",1095).
component("YPL172C",1050).
component("YNR041C",946).
component("YMR101C",867).
component("YDL090C",330).
component("YBR003W",236).
component("YBR002C",235).
component("YJL167W",690).
component("YJL167W",691).
component("YNL256W",925).
component("YPR069C",1082).
component("YDR127W",386).
component("YLR146C",797).
component("YHR068W",608).
component("YLR303W",818).
component("YGR012W",542).
component("YJR130C",717).
component("YLR303W",819).
component("YDR035W",366).
component("YBR249C",282).
component("YOR274W",1012).
component("YOL143C",976).
component("YBR256C",284).
component("YHR137W",619).
component("YGL202W",533).
component("YLR027C",781).
component("YKL106W",739).
component("YOL140W",975).
component("YLR438W",837).
component("YKL104C",738).
component("YGR019W",543).
component("YLR089C",791).
component("YDR111C",382).
component("U64_",176).
component("U61_",173).
component("U51_",163).
component("YJR148W",722).
component("YHR208W",629).
component("YFL030W",495).
component("YOR184W",998).
component("YNR058W",951).
component("YIL116W",646).
component("YGL253W",539).
component("YFR053C",508).
component("YOL136C",974).
component("YIL107C",643).
component("YMR013C",861).
component("YMR205C",881).
component("YGR240C",576).
component("YDR248C",402).
component("YLR240W",811).
component("YKL203C",758).
component("YJR066W",708).
component("YCR036W",311).
component("YGR194C",568).
component("YCL040W",299).
component("YJR105W",715).
component("U16_",79).
component("U15_",70).
component("YPL188W",1052).
component("YJR049C",704).
component("YEL041W",444).
component("U96_",207).
component("YKL001C",727).
component("YDR236C",400).
component("YML070W",848).
component("YFL053W",498).
component("YHL032C",591).
component("YLR133W",793).
component("YDR531W",438).
component("U83_",194).
component("U82_",193).
component("U81_",192).
component("YMR208W",882).
component("YPL203W",1053).
component("YOR061W",980).
component("YKL166C",748).
component("YJL164C",688).
component("YIL035C",634).
component("YHR205W",628).
component("YHR102W",615).
component("YGL019W",516).
component("YHR025W",601).
component("YOR347C",1023).
component("YAL038W",214).
component("YNR012W",941).
component("YPR121W",1090).
component("YPL258C",1062).
component("YOL055C",960).
component("YPL214C",1056).
component("U1_",110).
component("YDR009W",363).
component("YBR020W",243).
component("YNL267W",929).
component("YLR305C",821).
component("YFR019W",502).
component("YDR208W",396).
component("YDR127W",387).
component("U21_",128).
component("U20_",121).
component("YDR147W",390).
component("YDR300C",411).
component("YCR012W",306).
component("YER052C",459).
component("YER069W",470).
component("U19_",109).
component("YKL024C",730).
component("U18_",99).
component("U17_",89).
component("U76_",187).
component("YMR220W",884).
component("YER170W",487).
component("YDR226W",397).
component("YKL067W",736).
component("YOL055C",961).
component("YDR454C",431).
component("YJR057W",706).
component("YOL061W",965).
component("YKL181W",750).
component("YHL011C",588).
component("YER099C",481).
component("YBL068W",231).
component("YOR143C",994).
component("YNL256W",926).
component("YLR328W",825).
component("YBR018C",239).
component("YBR018C",240).
component("YGR007W",541).
component("YGR202C",570).
component("YLR328W",826).
component("YKR002W",764).
component("YDL045C",320).
component("U80_",191).
component("YDL103C",335).
component("U94_",206).
component("YJR010W",699).
component("YCL050C",301).
component("YGL130W",527).
component("YDR530C",437).
component("YCL050C",302).
component("YPR190C",1098).
component("YPR187W",1097).
component("YPR110C",1088).
component("YPR010C",1075).
component("YOR341W",1022).
component("YOR340C",1021).
component("YOR224C",1008).
component("YOR210W",1005).
component("YOR207C",1002).
component("YOR151C",995).
component("YOR116C",987).
component("YOL005C",953).
component("YNR003C",939).
component("YNL248C",924).
component("YNL151C",917).
component("YNL113W",911).
component("YKL144C",744).
component("YJR063W",707).
component("YJL148W",685).
component("YJL140W",684).
component("YIL021W",633).
component("YHR143W-A",620).
component("YGL070C",524).
component("YFL036W",496).
component("YDR404C",425).
component("YDR156W",392).
component("YDR045C",369).
component("YDL150W",344).
component("YDL140C",339).
component("YBR154C",271).
component("YPR175W",1094).
component("YPL167C",1048).
component("YOR330C",1018).
component("YOL115W",972).
component("YNL299W",935).
component("YNL262W",928).
component("YNL102W",909).
component("YJR043C",703).
component("YJR006W",698).
component("YJL090C",675).
component("YIL139C",649).
component("YEL055C",447).
component("YDR419W",428).
component("YDR121W",384).
component("YDL102W",334).
component("YCR014C",307).
component("YBR278W",287).
component("YBL035C",225).
component("YKL035W",733).
component("YHL012W",589).
component("YHR123W",617).
component("YPR113W",1089).
component("YBR243C",280).
component("YNL130C",913).
component("YDL142C",343).
component("YPL148C",1046).
component("YER026C",456).
component("YCL004W",292).
component("YOR251C",1011).
component("YGR286C",585).
component("YJL068C",670).
component("YHR189W",626).
component("YDR058C",374).
component("YNR034W",945).
component("YHR163W",622).
component("YGR248W",578).
component("YCR073W-A",313).
component("YDL086W",329).
component("YOL011W",955).
component("YMR008C",859).
component("YMR006C",858).
component("U105_",26).
component("U101_",22).
component("YBL015W",223).
component("YJL068C",671).
component("YPL072W",1039).
component("YOR124C",988).
component("YNL186W",919).
component("YMR304W",898).
component("YMR223W",885).
component("YKR098C",774).
component("YJL197W",692).
component("YIL156W",651).
component("YFR010W",500).
component("YER151C",485).
component("YER144C",484).
component("YER098W",480).
component("YDR069C",377).
component("YDL122W",336).
component("YBR058C",251).
component("YBL067C",230).
component("YJR019C",701).
component("YDR272W",406).
component("U84_",195).
component("YDR481C",432).
component("YLR377C",832).
component("YDR074W",378).
component("YFR025C",503).
component("YPL179W",1051).
component("YNR032W",943).
component("YML057W",847).
component("YML016C",840).
component("YLR433C",836).
component("YGR123C",554).
component("YER133W",483).
component("YER089C",477).
component("YDR436W",429).
component("YDR075W",379).
component("YDL188C",352).
component("YDL134C",338).
component("YDL047W",321).
component("YDL006W",314).
component("YBR125C",264).
component("YBL056W",229).
component("YPR073C",1083).
component("YHR215W",630).
component("YDL024C",317).
component("YBR093C",258).
component("YBR092C",257).
component("YAR071W",219).
component("YIL053W",637).
component("YER062C",467).
component("YHR046C",604).
component("U9_",210).
component("YGR208W",574).
component("YPL228W",1057).
component("YMR180C",878).
component("YDL236W",358).
component("YJL155C",687).
component("YPR073C",1084).
component("YOR208W",1003).
component("YNL053W",906).
component("YMR036C",864).
component("YIR026C",658).
component("YIL113W",645).
component("YFR028C",504).
component("YER075C",473).
component("YDL230W",356).
component("YBR276C",286).
component("U34_",147).
component("U33_",146).
component("U32_",145).
component("U31_",144).
...
component("U25_",139).
component("U24_",138).
component("YOL064C",966).
component("YPL268W",1066).
component("YOR360C",1026).
component("YGL248W",538).
component("YKR031C",767).
component("YPL206C",1054).
component("YGL027C",518).
component("YLR286C",815).
component("YJR153W",724).
component("YJL221C",697).
component("YJL216C",695).
component("YIL172C",657).
component("YGR292W",587).
component("YGR287C",586).
component("YBR299W",291).
component("YBR184W",274).
component("YIL162W",654).
component("YPR026W",1076).
component("YDR001C",361).
component("YBR001C",234).
component("YOR190W",1000).
component("YLR300W",817).
component("YGR282C",584).
component("YDR261C",404).
component("YDR400W",423).
component("U23_",137).
component("YML035C",843).
component("YJL070C",672).
component("YBR284W",288).
component("U102_",23).
component("YER043C",458).
component("YNL045W",904).
component("YLR160C",802).
component("YLR158C",801).
component("YLR157C",800).
component("YLR155C",799).
component("YDR321W",413).
component("YGL037C",519).
component("U43_",155).
component("U42_",154).
component("YMR293C",894).
component("YDR242W",401).
component("YLR308W",824).
component("YLR307W",823).
component("YBR208C",276).
component("YMR281W",893).
component("U53_",165).
component("YIR027C",659).
component("YPL111W",1043).
component("YIR032C",663).
component("YIR029W",661).
component("YPR062W",1081).
component("YMR120C",873).
component("YLR028C",783).
component("YHR144C",621).
component("YGR267C",583).
component("YCL030C",297).
component("YNL141W",914).
component("YBL033C",224).
component("YBR153W",270).
component("YDL238C",359).
component("YNL141W",915).
component("YLR245C",812).
component("YML035C",844).
component("YGR204W",572).
component("YBR084W",255).
component("YJL126W",679).
component("U44_",156).
component("YDL100C",333).
component("U87_",198).
component("U40_",152).
component("YMR267W",890).
component("YBR011C",238).
component("YHR201C",627).
component("YBR111C",259).
component("YBR252W",283).
component("YCL030C",298).
component("YPR080W",1086).
component("YOR187W",999).
component("YOR133W",991).
component("YLR069C",789).
component("YKR084C",771).
component("YKL173W",749).
component("YJL102W",677).
component("YDR385W",421).
component("YBR118W",262).
component("YER005W",452).
component("YLL001W",775).
component("YIL048W",636).
component("YER166W",486).
component("YDR093W",381).
component("YAL026C",213).
component("YBL099W",233).
component("U60_",172).
component("YLR231C",809).
component("U88_",199).
component("YLR134W",794).
component("YLR044C",785).
component("YGR087C",550).
component("YDR380W",420).
component("YDL080C",327).
component("U98_",208).
component("YMR250W",887).
component("YKL184W",754).
component("YOR128C",989).
component("YEL021W",443).
component("YNR043W",947).
component("U93_",205).
component("YDR047W",371).
component("U54_",166).
component("YKL211C",760) :- not remove_orf("YKL211C",760).
component("YKR097W",773).
component("YOL052C",959).
component("YNL169C",918).
component("YGR170W",560).
component("YKL060C",735).
component("YNL256W",927).
component("YDR294C",408).
component("YEL046C",445).
component("YNR033W",944).
component("YPR006C",1074).
component("YER065C",468).
component("YKL211C",761) :- not remove_orf("YKL211C",761).
component("YER090W",761) :- not remove_orf("YER090W",761).
component("YER090W",478) :- not remove_orf("YER090W",478).
component("YDR127W",388).
component("YPL281C",1071).
component("YOR393W",1031).
component("YMR323W",900).
component("YHR174W",623).
component("YGR254W",579).
component("YPL262W",1063).
component("YGL026C",517) :- not remove_orf("YGL026C",517).
component("YGR155W",558).
component("YLR304C",820).
component("YJL200C",693).
component("YDR234W",399).
component("YNL316C",936).
component("YKL182W",752).
component("YPL212C",1055).
component("YNL292W",934).
component("YGL063W",523).
component("YFL001W",490).
component("YOR278W",1013).
component("YPR002W",1073).
component("U49_",160).
component("YJR016C",700).
component("YCR053W",312).
component("YDR127W",389).
component("YGL148W",528).
component("YIL168W",656).
component("YIL167W",655).
component("YCL064C",303).
component("YER086W",475).
component("YCL064C",304).
component("YHR018C",597).
component("YLR359W",831).
component("YAL012W",211).
component("YFR055W",509).
component("YJL005W",667).
component("YOR176W",997).
component("YJL121C",678).
component("YBR019C",241).
component("YBR019C",242).
component("YDR050C",372).
component("YDR007W",362) :- not remove_orf("YDR007W",362).
component("YOR095C",984).
component("YER003C",451).
component("YBR196C",275).
component("YGL001C",511).
component("YPL117C",1044).
component("U14_",62).
component("YOL056W",962).
component("YKL152C",747).
component("YDL021W",315).
component("YMR105C",868).
component("YKL127W",741).
component("YEL058W",448).
component("YFL045C",497).
component("YPR060C",1080).
component("YHR072W",609).
component("YJL153C",686).
component("YPL097W",1041).
component("YGR185C",566).
component("YGR264C",582).
component("YGR171C",561).
component("YHR011W",596).
component("YDR023W",365).
component("YPL104W",1042).
component("YLL018C",776).
component("YPR081C",1087).
component("YBR121C",263).
component("YHR020W",600).
component("YER087W",476).
component("YNL247W",923).
component("YOL033W",957).
component("YGL245W",537).
component("YHR091C",611).
component("YDR341C",414).
component("YOL097C",970).
component("YDR268W",405).
component("YPR047W",1079).
component("YLR060W",788).
component("YFL022C",494).
component("YPR033C",1077).
component("YHR019C",598).
component("YCR024C",308).
component("YHR019C",599).
component("YKL194C",757).
component("YIL078W",640).
component("YPL160W",1047).
component("YLR382C",833).
component("YNL073W",908).
component("YDR037W",367).
component("YOR335C",1019).
component("YGR094W",552).
component("YLR153C",798).
component("YAL054C",215).
component("YOR317W",1015).
component("YMR246W",886).
component("YIL009W",632).
component("YER015W",454).
component("YOR142W",993).
component("YGR244C",577).
component("YPR035W",1078).
component("U89_",200).
component("YOR241W",1010).
component("YMR113W",870).
component("YKL132C",742).
component("YOR339C",1020).
component("YMR022W",863).
component("YLR306W",822).
component("YKL210W",759).
component("YGR133W",556).
component("YGL058W",521).
component("YER100W",482).
component("YEL012W",441).
component("YDR177W",394).
component("YDR092W",380).
component("YDR059C",375).
component("YDR054C",373).
component("YDL064W",323).
component("YBR082C",254).
component("YJL101C",676).
component("YOL049W",958).
component("U92_",204).
component("YAR015W",217).
component("YGL234W",535).
component("YER183C",489).
component("U91_",203).
component("U90_",202).
component("YNR057C",950).
component("YDL141W",340).
component("YDL141W",341).
component("YGL234W",536).
component("YDL141W",342).
component("YJR103W",713).
component("YBL039C",226).
component("YGR204W",573).
component("YBR084W",256).
component("YNL220W",921).
component("YOL058W",963).
component("YBR208C",277).
component("YHR074W",610).
component("YMR217W",883).
component("YGR061C",549).
component("YPR145W",1092).
component("YGR124W",555).
component("YOR303W",1014).
component("YJR109C",716).
component("YJL130C",682).
component("YGL062W",522).
component("YBR218C",278).
component("YPL231W",1061).
component("YNR016C",942).
component("YKL182W",753).
component("YGR037C",545).
component("YOR005C",978).
component("YDL164C",345).
component("YJL087C",673).
component("YOL010W",954).
component("YPR138C",1091).
component("YPL274W",1068).
component("YPL265W",1064).
component("YPL134C",1045).
component("YPL057C",1037).
component("YPL036W",1036).
component("YOR348C",1024).
component("YOR222W",1007).
component("YOR192C",1001).
component("YOR171C",996).
component("YOR130C",990).
component("YOR100C",985).
component("YOR071C",982).
component("YOR011W",979).
component("YOL156W",977).
component("YOL103W",971).
component("YOL020W",956) :- not remove_orf("YOL020W",956).
component("YNR072W",952).
component("YNR056C",949).
component("YNL318C",937).
component("YNL268W",930).
component("YNL142W",916).
component("YMR272C",892).
component("YMR202W",880).
component("YMR011W",860).
component("YML123C",856).
component("YLR348C",828).
component("YLR260W",814).
component("YLR237W",810).
component("YLR138W",795).
component("YLR100C",792).
component("YLR081W",790).
component("YLL061W",779).
component("YLL043W",778).
component("YKR093W",772).
component("YKR053C",769).
component("YKR039W",768) :- not remove_orf("YKR039W",768).
component("YKL217W",763).
component("YKL120W",740).
component("YKL004W",728).
component("YJR158W",725).
component("YJR152W",723).
component("YJR095W",712).
component("YJR077C",710).
component("YJL219W",696).
component("YJL214W",694).
component("YJL134W",683).
component("YJL129C",680).
component("YIR028W",660).
component("YIL134W",648).
component("YHR096C",614).
component("YHR094C",613).
component("YHR092C",612).
component("YHL036W",592).
component("YHL016C",590).
component("YGR191W",567).
component("YGR121C",553).
component("YGR055W",547).
component("YGL186C",530).
component("YGL077C",525).
component("YGL008C",512).
component("YFL055W",499).
component("YFL011W",491).
component("YER060W-A",464).
component("YER060W",463).
component("YER056C",462).
component("YER053C",460).
component("YEL069C",450).
component("YEL063C",449).
component("YEL017C-A",442).
component("YDR536W",439).
component("YDR508C",435).
component("YDR503C",434).
component("YDR497C",433).
component("YDR345C",417).
component("YDR343C",416).
component("YDR342C",415).
component("YDR297W",410).
component("YDR294C",409).
component("YDR284C",407).
component("YDR046C",370) :- not remove_orf("YDR046C",370).
component("YDL245C",360).
component("YDL210W",353).
component("YCR032W",310).
component("YCR024C-A",309).
component("YCL025C",295).
component("YBR298C",290).
component("YBR291C",289).
component("YBR069C",253) :- not remove_orf("YBR069C",253).
component("YBR068C",252) :- not remove_orf("YBR068C",252).
component("YBR036C",248).
component("YBR021W",244).
component("YBL042C",227).
component("U85_",196).
component("U7_",190).
component("U79_",189).
component("U78_",188).
...
catalyst(6160,896).
catalyst(3870,461).
catalyst(3620,419) :- not remove_reaction(3620,419).
catalyst(2110,507).
catalyst(2190,507).
catalyst(5550,718).
catalyst(5791,808).
...
catalyst(1960,371).
catalyst(3460,166).
catalyst(3600,760) :- not remove_reaction(3600,760).
catalyst(8000,773).
catalyst(3941,959).
catalyst(3942,959).
catalyst(6890,918).
...
catalyst(8020,1074).
catalyst(8020,468).
catalyst(1890,761) :- not remove_reaction(1890,761).
catalyst(3630,761) :- not remove_reaction(3630,761).
catalyst(1890,478) :- not remove_reaction(1890,478).
catalyst(3630,478) :- not remove_reaction(3630,478).
catalyst(3740,388).
catalyst(8231,1071).
catalyst(8232,1071).
catalyst(8231,1031).
...
catalyst(8051,1063).
catalyst(8052,1063).
catalyst(3590,517) :- not remove_reaction(3590,517).
catalyst(10910,517) :- not remove_reaction(10910,517).
catalyst(4570,558).
catalyst(8181,820).
catalyst(8182,820).
catalyst(8181,693).
...
catalyst(8281,372).
catalyst(8282,372).
catalyst(3610,362) :- not remove_reaction(3610,362).
catalyst(7921,984).
catalyst(7922,984).
catalyst(7841,451).
catalyst(7842,451).
...
catalyst(1210,977).
catalyst(1160,971).
catalyst(801,956) :- not remove_reaction(801,956).
catalyst(802,956) :- not remove_reaction(802,956).
catalyst(811,956) :- not remove_reaction(811,956).
catalyst(812,956) :- not remove_reaction(812,956).
catalyst(831,956) :- not remove_reaction(831,956).
catalyst(832,956) :- not remove_reaction(832,956).
catalyst(901,956) :- not remove_reaction(901,956).
catalyst(902,956) :- not remove_reaction(902,956).
catalyst(941,956) :- not remove_reaction(941,956).
catalyst(942,956) :- not remove_reaction(942,956).
catalyst(1170,952).
catalyst(1180,952).
catalyst(1210,952).
catalyst(700,949).
...
catalyst(650,772).
catalyst(6560,769).
catalyst(681,768) :- not remove_reaction(681,768).
catalyst(682,768) :- not remove_reaction(682,768).
catalyst(761,768) :- not remove_reaction(761,768).
catalyst(762,768) :- not remove_reaction(762,768).
catalyst(771,768) :- not remove_reaction(771,768).
catalyst(772,768) :- not remove_reaction(772,768).
catalyst(781,768) :- not remove_reaction(781,768).
catalyst(782,768) :- not remove_reaction(782,768).
catalyst(791,768) :- not remove_reaction(791,768).
catalyst(792,768) :- not remove_reaction(792,768).
catalyst(801,768) :- not remove_reaction(801,768).
catalyst(802,768) :- not remove_reaction(802,768).
catalyst(811,768) :- not remove_reaction(811,768).
catalyst(812,768) :- not remove_reaction(812,768).
catalyst(821,768) :- not remove_reaction(821,768).
catalyst(822,768) :- not remove_reaction(822,768).
catalyst(831,768) :- not remove_reaction(831,768).
catalyst(832,768) :- not remove_reaction(832,768).
catalyst(841,768) :- not remove_reaction(841,768).
catalyst(842,768) :- not remove_reaction(842,768).
catalyst(861,768) :- not remove_reaction(861,768).
catalyst(862,768) :- not remove_reaction(862,768).
catalyst(871,768) :- not remove_reaction(871,768).
catalyst(872,768) :- not remove_reaction(872,768).
catalyst(881,768) :- not remove_reaction(881,768).
catalyst(882,768) :- not remove_reaction(882,768).
catalyst(901,768) :- not remove_reaction(901,768).
catalyst(902,768) :- not remove_reaction(902,768).
catalyst(911,768) :- not remove_reaction(911,768).
catalyst(912,768) :- not remove_reaction(912,768).
catalyst(921,768) :- not remove_reaction(921,768).
catalyst(922,768) :- not remove_reaction(922,768).
catalyst(941,768) :- not remove_reaction(941,768).
catalyst(942,768) :- not remove_reaction(942,768).
catalyst(1191,768) :- not remove_reaction(1191,768).
catalyst(1192,768) :- not remove_reaction(1192,768).
catalyst(390,763).
catalyst(1021,763).
catalyst(1022,763).
catalyst(1521,740).
...
catalyst(6550,409).
catalyst(6690,407).
catalyst(791,370) :- not remove_reaction(791,370).
catalyst(792,370) :- not remove_reaction(792,370).
catalyst(801,370) :- not remove_reaction(801,370).
catalyst(802,370) :- not remove_reaction(802,370).
catalyst(811,370) :- not remove_reaction(811,370).
catalyst(812,370) :- not remove_reaction(812,370).
catalyst(831,370) :- not remove_reaction(831,370).
catalyst(832,370) :- not remove_reaction(832,370).
catalyst(841,370) :- not remove_reaction(841,370).
catalyst(842,370) :- not remove_reaction(842,370).
catalyst(861,370) :- not remove_reaction(861,370).
catalyst(862,370) :- not remove_reaction(862,370).
catalyst(901,370) :- not remove_reaction(901,370).
catalyst(902,370) :- not remove_reaction(902,370).
catalyst(1170,360).
catalyst(1180,360).
catalyst(1210,360).
catalyst(690,353).
...
catalyst(1511,289).
catalyst(1512,289).
catalyst(771,253) :- not remove_reaction(771,253).
catalyst(772,253) :- not remove_reaction(772,253).
catalyst(791,253) :- not remove_reaction(791,253).
catalyst(792,253) :- not remove_reaction(792,253).
catalyst(801,253) :- not remove_reaction(801,253).
catalyst(802,253) :- not remove_reaction(802,253).
catalyst(811,253) :- not remove_reaction(811,253).
catalyst(812,253) :- not remove_reaction(812,253).
catalyst(861,253) :- not remove_reaction(861,253).
catalyst(862,253) :- not remove_reaction(862,253).
catalyst(871,253) :- not remove_reaction(871,253).
catalyst(872,253) :- not remove_reaction(872,253).
catalyst(901,253) :- not remove_reaction(901,253).
catalyst(902,253) :- not remove_reaction(902,253).
catalyst(791,252) :- not remove_reaction(791,252).
catalyst(792,252) :- not remove_reaction(792,252).
catalyst(801,252) :- not remove_reaction(801,252).
catalyst(802,252) :- not remove_reaction(802,252).
catalyst(811,252) :- not remove_reaction(811,252).
catalyst(812,252) :- not remove_reaction(812,252).
catalyst(831,252) :- not remove_reaction(831,252).
catalyst(832,252) :- not remove_reaction(832,252).
catalyst(841,252) :- not remove_reaction(841,252).
catalyst(842,252) :- not remove_reaction(842,252).
catalyst(861,252) :- not remove_reaction(861,252).
catalyst(862,252) :- not remove_reaction(862,252).
catalyst(901,252) :- not remove_reaction(901,252).
catalyst(902,252) :- not remove_reaction(902,252).
catalyst(6600,248).
catalyst(620,244).
catalyst(540,227).
catalyst(2660,196).
...
modifiable_enzyme(419).
modifiable_enzyme(760).
modifiable_enzyme(761).
modifiable_enzyme(478).
modifiable_enzyme(517).
modifiable_enzyme(362).
modifiable_enzyme(956).
modifiable_enzyme(768).
modifiable_enzyme(370).
modifiable_enzyme(253).
