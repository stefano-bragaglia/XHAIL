...
component("YGR060W",130).
component("YGL012W",120).
component("YOL086C",221).
component("YMR303C",203).
component("YGL256W",128).
component("YDL168W",74).
component("YBR145W",56).
component("YPL231W",243).
component("YGL001C",117).
component("YML056C",192).
component("YLR432W",190).
component("YHR216W",145).
component("YAR075W",45).
component("YAR073W",44).
component("YDR127W",84).
component("YJR139C",168).
component("YOR136W",225).
component("YIL155C",149).
component("YJR078W",162).
component("YJR025C",159).
component("YMR015C",196).
component("YDR402C",96).
component("YJR104C",165).
component("YHR008C",139).
component("YER070W",105).
component("YGL154C",126).
component("YMR170C",199).
component("YMR169C",198).
component("YBR166C",58).
component("YER014W",104).
component("YEL047C",103).
component("YOR375C",236).
component("YDL215C",75).
component("YAL062W",43).
component("YOR236W",232).
component("U62_",37).
component("YPL017C",239).
component("YFL018C",109).
component("U47_",33).
component("YKL024C",171).
component("YPR074C",253).
component("YBR117C",55).
component("YPL231W",244).
component("YPL001W",238).
component("YPL231W",245).
component("YPL028W",240).
component("YNL029C",205).
component("YIL085C",147).
component("YLR209C",185).
component("YDR354W",93) :- not remove_orf("YDR354W",93).
component("YFR047C",115).
component("YJR133W",167).
component("YDR399W",94).
component("YDR127W",85).
component("YJR130C",166).
component("YDR035W",80).
component("YBR249C",61).
component("YBR256C",62).
component("YHR137W",141).
component("YLR027C",182).
component("YKL106W",172).
component("U64_",38).
component("U51_",34).
component("YJR148W",169).
component("YGL253W",127).
component("YFR053C",116).
component("YMR205C",201).
component("YGR240C",136).
component("YCR036W",70).
component("U15_",21).
component("YKL001C",170).
component("YML070W",193).
component("YFL053W",111).
component("U83_",41).
component("YMR208W",202).
component("U1_",26).
component("YNL267W",212).
component("YLR305C",189).
...
component("YOL061W",220).
component("YKL181W",174).
component("YHL011C",138).
component("YER099C",108).
component("YBL068W",48).
component("YOR143C",226).
component("YCL050C",68).
component("YPR190C",257).
component("YPR187W",256).
component("YPR110C",254).
component("YPR010C",249).
component("YOR341W",235).
component("YOR340C",234).
component("YOR224C",231).
component("YOR210W",230).
component("YOR207C",228).
component("YOR151C",227).
component("YOR116C",224).
component("YOL005C",217).
component("YNR003C",214).
component("YNL248C",211).
component("YNL151C",210).
component("YNL113W",208).
component("YKL144C",173).
component("YJR063W",160).
component("YJL148W",157).
component("YJL140W",156).
component("YIL021W",146).
component("YHR143W-A",142).
...
component("YOL011W",218).
component("YMR008C",195).
component("YMR006C",194).
component("YBL015W",46).
component("U84_",42).
component("YPR073C",251).
component("YHR215W",144).
component("YDL024C",71).
component("YBR093C",53).
component("YBR092C",52).
component("YPL228W",242).
component("YMR180C",200).
component("YDL236W",77).
component("YJL155C",158).
component("YPR073C",252).
component("YOR208W",229).
component("YNL053W",207).
component("YMR036C",197).
component("YIR026C",150).
component("YIL113W",148).
...
component("U30_",32).
component("U24_",31).
component("YKR031C",179).
component("YLR286C",188).
component("YDR400W",95).
component("YML035C",191).
component("YJL070C",152).
component("YBR284W",64).
component("YNL045W",206).
component("YGL037C",122).
component("U53_",35).
component("YIR032C",151).
component("YDL238C",78).
component("YLR245C",187).
component("YJL126W",154).
component("YBR111C",54).
component("YLR231C",186).
component("YLR134W",184).
component("YLR044C",183).
component("YGR087C",131).
component("U54_",36).
component("YKL211C",177) :- not remove_orf("YKL211C",177).
component("YGR170W",135).
component("YDR294C",91).
component("YNR033W",216).
component("YKL211C",178) :- not remove_orf("YKL211C",178).
component("YER090W",178) :- not remove_orf("YER090W",178).
component("YER090W",107) :- not remove_orf("YER090W",107).
component("YDR127W",87).
component("YPL281C",248).
component("YOR393W",237).
component("YMR323W",204).
component("YHR174W",143).
component("YGR254W",137).
component("YGL026C",121) :- not remove_orf("YGL026C",121).
component("YGR155W",134).
component("YNL316C",213).
component("YKL182W",175).
component("YDR127W",88).
component("YGL148W",125).
component("YDR007W",79) :- not remove_orf("YDR007W",79).
component("YOR095C",223).
component("YGL001C",118).
component("YPR060C",250).
component("YOL097C",222).
component("YOR335C",233).
component("YGR094W",132).
component("YJL101C",153).
component("YJR103W",164).
component("YBL039C",47).
component("YBR208C",59).
component("YHR074W",140).
component("YGL062W",123).
component("YBR218C",60).
component("YPL231W",246).
component("YNR016C",215).
component("YKL182W",176).
component("YGR037C",129).
component("YPR138C",255).
component("YPL265W",247).
component("YPL036W",241).
component("YOL020W",219) :- not remove_orf("YOL020W",219).
component("YNL142W",209).
component("YKR053C",181).
component("YKR039W",180) :- not remove_orf("YKR039W",180).
component("YJR095W",163).
component("YJR077C",161).
component("YJL134W",155).
component("YGR121C",133).
component("YGL008C",119).
...
catalyst(7550,131).
catalyst(3460,36).
catalyst(3600,177) :- not remove_reaction(3600,177).
catalyst(6900,135).
catalyst(8781,91).
catalyst(8782,91).
catalyst(2550,216).
catalyst(3630,178) :- not remove_reaction(3630,178).
...
catalyst(781,180) :- not remove_reaction(781,180).
catalyst(782,180) :- not remove_reaction(782,180).
...
catalyst(881,180) :- not remove_reaction(881,180).
catalyst(882,180) :- not remove_reaction(882,180).
catalyst(1191,180) :- not remove_reaction(1191,180).
catalyst(1192,180) :- not remove_reaction(1192,180).
catalyst(1250,163).
catalyst(1581,161).
catalyst(1582,161).
catalyst(6560,155).
