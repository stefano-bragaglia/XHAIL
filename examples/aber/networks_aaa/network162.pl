...
component("YLR056W",709).
component("YGR060W",497).
component("YGL012W",462).
component("YKR009C",689).
component("YOL086C",880).
component("YMR303C",811).
component("YMR083W",780).
component("YGL256W",489).
component("YDL168W",305).
component("YBR145W",230).
component("YPL231W",965).
component("YBR265W",249).
component("U46_",128).
component("YBR149W",231).
component("YBR149W",232).
component("YJR159W",653).
component("YGL001C",459).
component("YIL094C",577).
component("YHR063C",549).
component("U45_",127).
component("YBR153W",233).
component("YML056C",761).
component("YLR432W",751).
component("YHR216W",567).
component("YAR075W",188).
component("YAR073W",187).
component("YCL030C",259).
component("YDR127W",341).
component("YJR139C",647).
component("YML075C",764).
component("YLR450W",753).
component("YOL126C",885).
component("YKL085W",663).
component("YDL078C",285).
component("YKL029C",658).
component("YOR136W",902).
component("YNL037C",816).
component("YDL066W",283).
component("YNL241C",835).
component("YOL059W",877).
component("YDL022W",276).
component("YLR355C",746).
component("YIL074C",575).
component("YER081W",426).
component("YML054C",760).
component("YDL174C",308).
component("YML086C",765).
component("YIL155C",585).
component("YPR191W",1004).
component("YOR065W",892).
component("YJL166W",618).
component("YHR001W-A",537).
component("YGR183C",513).
component("YFR033C",455).
component("YDR529C",391).
component("YBL045C",195).
component("Q0105",18).
component("YGR088W",500).
component("YDR256C",358).
component("YKL026C",657).
component("YIR037W",597).
component("YBR244W",245).
component("YJR078W",638).
component("U58_",140).
component("YJR025C",630).
component("YGR255C",525).
component("U108_",25).
component("YBL098W",199).
component("YMR015C",776).
component("YHR007C",538).
component("YDR402C",379).
component("YGL055W",469).
component("YGR175C",510).
component("YJR104C",641).
component("YHR008C",539).
component("YJL026W",600).
component("YIL066C",574).
component("YGR180C",512).
component("YER070W",423).
component("U38_",122).
component("U36_",121).
component("U35_",120).
component("YDL168W",306).
component("YDR158W",349).
component("YBR006W",202).
component("YPL276W",977).
component("YPL275W",976).
component("YOR388C",940).
component("YOR374W",937).
component("YER073W",424).
component("U68_",147).
component("YGL154C",478).
component("YBR115C",224).
component("U55_",137).
component("YOR323C",927).
component("YMR170C",791).
component("YMR169C",790).
component("U2_",114).
component("YER178W",440).
component("YBR221C",243).
component("YIL125W",582).
component("U52_",134).
component("YBR166C",236).
component("YNL280C",846).
component("YGL012W",463).
component("YKL182W",677).
component("U57_",139).
component("YKL216W",686).
component("YDR044W",325).
component("YER014W",407).
component("YKR009C",690).
component("YIL160C",587).
component("YGL205W",483).
component("YMR118C",785).
component("YLR164W",723).
component("YLL041C",701).
component("YKL148C",671).
component("YKL141W",669).
component("YJL045W",601).
component("YDR178W",351).
component("YJR051W",633).
component("YEL047C",401).
component("YDL171C",307).
component("YDL215C",312).
component("YOR375C",938).
component("YDL215C",313).
component("YAL062W",184).
component("U99_",178).
component("YBR035C",212).
component("YMR189W",793).
component("U56_",138).
component("YNR050C",861).
component("YHR037W",545).
component("YKR080W",694).
component("YER023W",409).
component("YPL023C",944).
component("YGL125W",475).
component("YOR236W",919).
component("YGR204W",517).
component("YLR142W",718).
component("U63_",144).
component("U62_",143).
component("YOR356W",935).
component("YKL150W",672).
component("YIL043C",571).
component("YHR042W",546).
component("YOR221C",916).
component("YML120C",769).
component("YKL192C",681).
component("YKL055C",660).
component("YER061C",418).
component("YMR145C",788).
component("YML120C",770).
component("YKL192C",682).
component("YDL085W",287).
component("YGR234W",520).
component("YFR030W",454).
component("YPL017C",943).
component("YFL018C",445).
component("YPL091W",949).
component("YDR353W",373).
component("YER042W",411).
component("YJR137C",646).
component("YNL052W",818).
component("YMR256C",802).
component("YLR395C",750).
component("YLR038C",707).
component("YIL111W",579).
component("YHR051W",548).
component("YGL191W",481).
component("YGL187C",480).
component("YDL067C",284).
component("Q0275",20).
component("Q0250",19).
component("YPL266W",972).
component("YML110C",768).
component("YBR034C",211).
component("YPL273W",974).
component("YLL062C",704).
component("YDR410C",382).
component("U47_",129).
component("YER091C",431).
component("YJR073C",636).
component("YDR120C",339).
component("YML008C",754).
component("YDL033C",278).
component("YOL096C",881).
component("YLR172C",724).
component("YDR019C",321).
component("YBR176W",237).
component("YDR408C",381).
component("YMR120C",786).
component("YBL013W",189).
component("YKL024C",656).
component("YPR074C",991).
component("YBR117C",225).
component("YLR354C",745).
component("YGR043C",495).
component("YMR108W",783).
component("YCL009C",257).
component("YMR062C",779).
component("YNL071W",820).
component("YNR008W",853).
component("YIL160C",588).
component("YNL277W",844).
component("YDR232W",354).
component("YFL017C",444).
component("YPL231W",966).
component("YER061C",419).
component("U86_",166).
component("YPL001W",942).
component("YMR296C",809).
component("YDR062W",333).
component("YDL052C",281).
component("U8_",170).
component("YDR148C",347).
component("YOR377W",939).
component("YGR177C",511).
component("YPL231W",967).
component("YGR147C",506).
component("YDL040C",279).
component("YPL028W",945).
component("YLR195C",725).
component("YGL017W",464).
component("YPR001W",979).
component("YNR001C",851).
component("YCR005C",265).
component("YNL104C",823).
component("YDL182W",309).
component("YDL131W",296).
component("YNL117W",825).
component("YIR031C",595).
component("YOR321W",926).
component("YJR143C",648).
component("YGR199W",516).
component("YDR307W",367).
component("YDL095W",291).
component("YDL093W",290).
component("YAL023C",181).
component("YOR103C",896).
component("YOR085W",894).
component("YMR149W",789).
component("YML019W",756).
component("YJL002C",598).
component("YEL002C",395).
component("YDL232W",315).
component("YCL043C",262).
component("YNL029C",815).
component("YIL085C",576).
component("YMR261C",803).
component("YML100W",766).
component("YBR126C",229).
component("YNL192W",833).
component("YBR038W",214).
component("YBR023C",210).
component("YMR306W",813).
component("YLR342W",743).
component("YGR032W",493).
component("YPR183W",1001).
component("YLR209C",726).
component("U104_",23).
component("YMR271C",805).
component("YML106W",767).
component("YOR209C",914).
component("YMR300C",810).
component("YER055C",414).
component("YDR354W",374) :- not remove_orf("YDR354W",374).
component("YFR047C",456).
component("YJR133W",645).
component("YLR209C",727).
component("YML022W",757).
component("YDR441C",385).
component("YDR399W",377).
component("YPR176C",1000).
component("YPL172C",957).
component("YNR041C",859).
component("YMR101C",781).
component("YDL090C",289).
component("YBR003W",201).
component("YBR002C",200).
component("YJL167W",619).
component("YJL167W",620).
component("YNL256W",838).
component("YPR069C",988).
component("YDR127W",342).
component("YLR303W",734).
component("YGR012W",491).
component("YJR130C",644).
component("YLR303W",735).
component("YDR035W",323).
component("YBR249C",246).
component("YOR274W",922).
component("YOL143C",888).
component("YBR256C",248).
component("YHR137W",558).
component("YGL202W",482).
component("YLR027C",705).
component("YKL106W",665).
component("YOL140W",887).
component("YKL104C",664).
component("YGR019W",492).
component("YLR089C",713).
component("U64_",145).
component("U61_",142).
component("U51_",133).
component("YJR148W",649).
component("YHR208W",565).
component("YFL030W",447).
component("YOR184W",908).
component("YNR058W",864).
component("YIL116W",581).
component("YGL253W",488).
component("YFR053C",457).
component("YOL136C",886).
component("YIL107C",578).
component("YMR013C",775).
component("YMR205C",795).
component("YGR240C",521).
component("YDR248C",357).
component("YCR036W",271).
component("YGR194C",515).
component("YCL040W",261).
component("YJR105W",642).
component("U16_",63).
component("U15_",56).
component("YPL188W",959).
component("YJR049C",632).
component("YEL041W",399).
component("U96_",176).
component("YKL001C",654).
component("YDR236C",355).
component("YML070W",763).
component("YFL053W",449).
component("YHL032C",535).
component("YLR133W",715).
component("YDR531W",393).
component("U83_",163).
component("U82_",162).
component("U81_",161).
component("YMR208W",796).
component("YPL203W",960).
component("YOR061W",891).
component("YKL166C",674).
component("YJL164C",617).
component("YIL035C",570).
component("YHR205W",564).
component("YHR102W",556).
component("YGL019W",465).
component("YHR025W",544).
component("YOR347C",933).
component("YAL038W",183).
component("YNR012W",854).
component("YPR121W",996).
component("YPL258C",969).
component("YOL055C",873).
component("YPL214C",963).
component("U1_",88).
component("YDR009W",320).
component("YBR020W",208).
component("YNL267W",842).
component("YLR305C",737).
component("YFR019W",452).
component("YDR208W",352).
component("YDR127W",343).
component("U21_",100).
component("U20_",96).
component("YDR147W",346).
component("YDR300C",366).
component("YCR012W",266).
component("YER052C",412).
component("YER069W",422).
component("U19_",87).
component("U18_",79).
component("U17_",72).
component("U76_",156).
component("YMR220W",798).
component("YER170W",439).
component("YDR226W",353).
component("YKL067W",662).
component("YOL055C",874).
component("YDR454C",386).
component("YJR057W",634).
component("YOL061W",878).
component("YKL181W",676).
component("YHL011C",532).
component("YER099C",433).
component("YBL068W",198).
component("YOR143C",904).
component("YNL256W",839).
component("YLR328W",741).
component("YBR018C",204).
component("YBR018C",205).
component("YGR007W",490).
component("YLR328W",742).
component("YKR002W",688).
component("U80_",160).
component("YDL103C",294).
component("U94_",175).
component("YJR010W",628).
component("YGL130W",476).
component("YDR530C",392).
component("YCL050C",263).
component("YPR190C",1003).
component("YPR187W",1002).
component("YPR110C",994).
component("YPR010C",982).
component("YOR341W",932).
component("YOR340C",931).
component("YOR224C",918).
component("YOR210W",915).
component("YOR207C",912).
component("YOR151C",905).
component("YOR116C",897).
component("YOL005C",866).
component("YNR003C",852).
component("YNL248C",837).
component("YNL151C",830).
component("YNL113W",824).
component("YKL144C",670).
component("YJR063W",635).
component("YJL148W",614).
component("YJL140W",613).
component("YIL021W",569).
component("YHR143W-A",559).
component("YGL070C",473).
component("YFL036W",448).
component("YDR404C",380).
component("YDR156W",348).
component("YDR045C",326).
component("YDL150W",303).
component("YDL140C",298).
component("YBR154C",235).
component("YPR175W",999).
component("YPL167C",956).
component("YOR330C",928).
component("YOL115W",884).
component("YNL299W",848).
component("YNL262W",841).
component("YNL102W",822).
component("YJR043C",631).
component("YJR006W",627).
component("YJL090C",605).
component("YIL139C",584).
component("YEL055C",402).
component("YDR419W",383).
component("YDR121W",340).
component("YDL102W",293).
component("YCR014C",267).
component("YBR278W",251).
component("YBL035C",192).
component("YKL035W",659).
component("YHL012W",533).
component("YHR123W",557).
component("YPR113W",995).
component("YBR243C",244).
component("YNL130C",826).
component("YDL142C",302).
component("YPL148C",954).
component("YER026C",410).
component("YCL004W",256).
component("YOR251C",921).
component("YGR286C",529).
component("YJL068C",602).
component("YDR058C",331).
component("YNR034W",858).
component("YHR163W",561).
component("YGR248W",523).
component("YCR073W-A",273).
component("YDL086W",288).
component("YOL011W",868).
component("YMR008C",773).
component("YMR006C",772).
component("U105_",24).
component("U101_",21).
component("YBL015W",190).
component("YJL068C",603).
component("YPL072W",948).
component("YOR124C",898).
component("YNL186W",832).
component("YMR304W",812).
component("YMR223W",799).
component("YKR098C",698).
component("YJL197W",621).
component("YIL156W",586).
component("YFR010W",451).
component("YER151C",437).
component("YER144C",436).
component("YER098W",432).
component("YDR069C",334).
component("YDL122W",295).
component("YBR058C",215).
component("YBL067C",197).
component("YDR272W",361).
component("U84_",164).
component("YDR481C",387).
component("YLR377C",748).
component("YDR074W",335).
component("YPL179W",958).
component("YNR032W",856).
component("YML057W",762).
component("YML016C",755).
component("YLR433C",752).
component("YGR123C",503).
component("YER133W",435).
component("YER089C",429).
component("YDR436W",384).
component("YDR075W",336).
component("YDL188C",310).
component("YDL134C",297).
component("YDL047W",280).
component("YDL006W",274).
component("YBR125C",228).
component("YBL056W",196).
component("YPR073C",989).
component("YHR215W",566).
component("YDL024C",277).
component("YBR093C",222).
component("YBR092C",221).
component("YAR071W",186).
component("YIL053W",573).
component("YER062C",420).
component("YHR046C",547).
component("U9_",179).
component("YGR208W",519).
component("YPL228W",964).
component("YMR180C",792).
component("YDL236W",316).
component("YJL155C",616).
component("YPR073C",990).
component("YOR208W",913).
component("YNL053W",819).
component("YMR036C",778).
component("YIR026C",592).
component("YIL113W",580).
component("YFR028C",453).
component("YER075C",425).
component("YDL230W",314).
component("YBR276C",250).
component("U34_",119).
component("U33_",118).
component("U32_",117).
component("U31_",116).
...
component("U25_",111).
component("U24_",110).
component("YOL064C",879).
component("YPL268W",973).
component("YOR360C",936).
component("YGL248W",487).
component("YKR031C",691).
component("YPL206C",961).
component("YGL027C",467).
component("YLR286C",732).
component("YJR153W",651).
component("YJL221C",626).
component("YJL216C",624).
component("YIL172C",591).
component("YGR292W",531).
component("YGR287C",530).
component("YBR299W",255).
component("YBR184W",238).
component("YIL162W",589).
component("YOR190W",910).
component("YLR300W",733).
component("YGR282C",528).
component("YDR261C",359).
component("YDR400W",378).
component("U23_",109).
component("YML035C",758).
component("YJL070C",604).
component("YBR284W",252).
component("U102_",22).
component("YNL045W",817).
component("YLR160C",722).
component("YLR158C",721).
component("YLR157C",720).
component("YLR155C",719).
component("YDR321W",368).
component("YGL037C",468).
component("YMR293C",808).
component("YDR242W",356).
component("YLR308W",740).
component("YLR307W",739).
component("YBR208C",240).
component("YMR281W",807).
component("U53_",135).
component("YIR027C",593).
component("YPL111W",952).
component("YIR032C",596).
component("YIR029W",594).
component("YPR062W",987).
component("YMR120C",787).
component("YLR028C",706).
component("YHR144C",560).
component("YGR267C",527).
component("YNL141W",827).
component("YBL033C",191).
component("YBR153W",234).
component("YDL238C",317).
component("YNL141W",828).
component("YLR245C",730).
component("YML035C",759).
component("YBR084W",219).
component("YJL126W",609).
component("U44_",126).
component("YDL100C",292).
component("U87_",167).
component("U40_",124).
component("YMR267W",804).
component("YBR011C",203).
component("YHR201C",563).
component("YBR111C",223).
component("YBR252W",247).
component("YCL030C",260).
component("YPR080W",992).
component("YOR187W",909).
component("YOR133W",901).
component("YLR069C",711).
component("YKR084C",695).
component("YKL173W",675).
component("YJL102W",607).
component("YDR385W",376).
component("YBR118W",226).
component("YER005W",406).
component("YLL001W",699).
component("YIL048W",572).
component("YER166W",438).
component("YDR093W",338).
component("YAL026C",182).
component("YLR231C",728).
component("U88_",168).
component("YLR134W",716).
component("YLR044C",708).
component("YGR087C",499).
component("YDR380W",375).
component("YDL080C",286).
component("U98_",177).
component("YMR250W",801).
component("YKL184W",680).
component("YOR128C",899).
component("YEL021W",398).
component("YNR043W",860).
component("U93_",174).
component("YDR047W",328).
component("U54_",136).
component("YKL211C",684) :- not remove_orf("YKL211C",684).
component("YKR097W",697).
component("YOL052C",872).
component("YNL169C",831).
component("YGR170W",508).
component("YKL060C",661).
component("YNL256W",840).
component("YDR294C",363).
component("YEL046C",400).
component("YNR033W",857).
component("YPR006C",981).
component("YER065C",421).
component("YKL211C",685) :- not remove_orf("YKL211C",685).
component("YER090W",685) :- not remove_orf("YER090W",685).
component("YER090W",430) :- not remove_orf("YER090W",430).
component("YDR127W",344).
component("YPL281C",978).
component("YOR393W",941).
component("YMR323W",814).
component("YHR174W",562).
component("YGR254W",524).
component("YPL262W",970).
component("YGL026C",466) :- not remove_orf("YGL026C",466).
component("YGR155W",507).
component("YLR304C",736).
component("YJL200C",622).
component("YNL316C",849).
component("YKL182W",678).
component("YPL212C",962).
component("YNL292W",847).
component("YGL063W",472).
component("YFL001W",442).
component("YOR278W",923).
component("YPR002W",980).
component("U49_",130).
component("YJR016C",629).
component("YCR053W",272).
component("YDR127W",345).
component("YGL148W",477).
component("YIL168W",590).
component("YER086W",427).
component("YCL064C",264).
component("YLR359W",747).
component("YAL012W",180).
component("YFR055W",458).
component("YJL005W",599).
component("YOR176W",907).
component("YJL121C",608).
component("YBR019C",206).
component("YBR019C",207).
component("YDR050C",329).
component("YDR007W",319) :- not remove_orf("YDR007W",319).
component("YOR095C",895).
component("YER003C",405).
component("YBR196C",239).
component("YGL001C",460).
component("U14_",48).
component("YOL056W",875).
component("YKL152C",673).
component("YDL021W",275).
component("YMR105C",782).
component("YKL127W",667).
component("YEL058W",403).
component("YPR060C",986).
component("YHR072W",550).
component("YJL153C",615).
component("YPL097W",950).
component("YGR185C",514).
component("YGR264C",526).
component("YGR171C",509).
component("YHR011W",540).
component("YDR023W",322).
component("YPL104W",951).
component("YLL018C",700).
component("YPR081C",993).
component("YBR121C",227).
component("YHR020W",543).
component("YER087W",428).
component("YNL247W",836).
component("YOL033W",870).
component("YGL245W",486).
component("YHR091C",552).
component("YDR341C",369).
component("YOL097C",882).
component("YDR268W",360).
component("YPR047W",985).
component("YLR060W",710).
component("YFL022C",446).
component("YPR033C",983).
component("YHR019C",541).
component("YCR024C",268).
component("YHR019C",542).
component("YPL160W",955).
component("YLR382C",749).
component("YNL073W",821).
component("YDR037W",324).
component("YOR335C",929).
component("YGR094W",501).
component("YOR317W",925).
component("YMR246W",800).
component("YIL009W",568).
component("YER015W",408).
component("YOR142W",903).
component("YGR244C",522).
component("YPR035W",984).
component("U89_",169).
component("YOR241W",920).
component("YMR113W",784).
component("YKL132C",668).
component("YOR339C",930).
component("YMR022W",777).
component("YLR306W",738).
component("YKL210W",683).
component("YGR133W",505).
component("YGL058W",470).
component("YER100W",434).
component("YEL012W",396).
component("YDR177W",350).
component("YDR092W",337).
component("YDR059C",332).
component("YDR054C",330).
component("YDL064W",282).
component("YBR082C",218).
component("YJL101C",606).
component("YOL049W",871).
component("U92_",173).
component("YAR015W",185).
component("YGL234W",484).
component("YER183C",441).
component("U91_",172).
component("U90_",171).
component("YNR057C",863).
component("YDL141W",299).
component("YDL141W",300).
component("YGL234W",485).
component("YDL141W",301).
component("YJR103W",640).
component("YBL039C",193).
component("YGR204W",518).
component("YBR084W",220).
component("YNL220W",834).
component("YOL058W",876).
component("YBR208C",241).
component("YHR074W",551).
component("YMR217W",797).
component("YGR061C",498).
component("YPR145W",998).
component("YGR124W",504).
component("YOR303W",924).
component("YJR109C",643).
component("YJL130C",611).
component("YGL062W",471).
component("YBR218C",242).
component("YPL231W",968).
component("YNR016C",855).
component("YKL182W",679).
component("YGR037C",494).
component("YOR005C",890).
component("YDL164C",304).
component("YOL010W",867).
component("YPR138C",997).
component("YPL274W",975).
component("YPL265W",971).
component("YPL134C",953).
component("YPL057C",947).
component("YPL036W",946).
component("YOR348C",934).
component("YOR222W",917).
component("YOR192C",911).
component("YOR171C",906).
component("YOR130C",900).
component("YOR071C",893).
component("YOL156W",889).
component("YOL103W",883).
component("YOL020W",869) :- not remove_orf("YOL020W",869).
component("YNR072W",865).
component("YNR056C",862).
component("YNL318C",850).
component("YNL268W",843).
component("YNL142W",829).
component("YMR272C",806).
component("YMR202W",794).
component("YMR011W",774).
component("YML123C",771).
component("YLR348C",744).
component("YLR260W",731).
component("YLR237W",729).
component("YLR138W",717).
component("YLR100C",714).
component("YLR081W",712).
component("YLL061W",703).
component("YLL043W",702).
component("YKR093W",696).
component("YKR053C",693).
component("YKR039W",692) :- not remove_orf("YKR039W",692).
component("YKL217W",687).
component("YKL120W",666).
component("YKL004W",655).
component("YJR158W",652).
component("YJR152W",650).
component("YJR095W",639).
component("YJR077C",637).
component("YJL219W",625).
component("YJL214W",623).
component("YJL134W",612).
component("YJL129C",610).
component("YIL134W",583).
component("YHR096C",555).
component("YHR094C",554).
component("YHR092C",553).
component("YHL036W",536).
component("YHL016C",534).
component("YGR121C",502).
component("YGR055W",496).
component("YGL186C",479).
component("YGL077C",474).
component("YGL008C",461).
component("YFL055W",450).
component("YFL011W",443).
component("YER060W-A",417).
component("YER060W",416).
component("YER056C",415).
component("YER053C",413).
component("YEL069C",404).
...
component("YDR297W",365).
component("YDR294C",364).
component("YDR284C",362).
component("YDR046C",327) :- not remove_orf("YDR046C",327).
component("YDL245C",318).
component("YDL210W",311).
component("YCR032W",270).
component("YCR024C-A",269).
component("YCL025C",258).
component("YBR298C",254).
component("YBR291C",253).
component("YBR069C",217) :- not remove_orf("YBR069C",217).
component("YBR068C",216) :- not remove_orf("YBR068C",216).
component("YBR036C",213).
component("YBR021W",209).
component("YBL042C",194).
component("U85_",165).
component("U7_",159).
component("U79_",158).
component("U78_",157).
...
catalyst(1960,328).
catalyst(3460,136).
catalyst(3600,684) :- not remove_reaction(3600,684).
catalyst(8000,697).
catalyst(3941,872).
catalyst(3942,872).
catalyst(6890,831).
...
catalyst(8020,981).
catalyst(8020,421).
catalyst(1890,685) :- not remove_reaction(1890,685).
catalyst(3630,685) :- not remove_reaction(3630,685).
catalyst(1890,430) :- not remove_reaction(1890,430).
catalyst(3630,430) :- not remove_reaction(3630,430).
catalyst(3740,344).
catalyst(8231,978).
catalyst(8232,978).
catalyst(8231,941).
...
catalyst(8281,329).
catalyst(8282,329).
catalyst(3610,319) :- not remove_reaction(3610,319).
catalyst(7921,895).
catalyst(7922,895).
catalyst(7841,405).
catalyst(7842,405).
...
catalyst(1210,889).
catalyst(1160,883).
catalyst(801,869) :- not remove_reaction(801,869).
catalyst(802,869) :- not remove_reaction(802,869).
catalyst(811,869) :- not remove_reaction(811,869).
catalyst(812,869) :- not remove_reaction(812,869).
catalyst(831,869) :- not remove_reaction(831,869).
catalyst(832,869) :- not remove_reaction(832,869).
catalyst(901,869) :- not remove_reaction(901,869).
catalyst(902,869) :- not remove_reaction(902,869).
catalyst(941,869) :- not remove_reaction(941,869).
catalyst(942,869) :- not remove_reaction(942,869).
catalyst(1170,865).
catalyst(1180,865).
catalyst(1210,865).
catalyst(700,862).
...
catalyst(650,696).
catalyst(6560,693).
catalyst(761,692) :- not remove_reaction(761,692).
catalyst(762,692) :- not remove_reaction(762,692).
catalyst(771,692) :- not remove_reaction(771,692).
catalyst(772,692) :- not remove_reaction(772,692).
catalyst(781,692) :- not remove_reaction(781,692).
catalyst(782,692) :- not remove_reaction(782,692).
catalyst(791,692) :- not remove_reaction(791,692).
catalyst(792,692) :- not remove_reaction(792,692).
catalyst(801,692) :- not remove_reaction(801,692).
catalyst(802,692) :- not remove_reaction(802,692).
catalyst(811,692) :- not remove_reaction(811,692).
catalyst(812,692) :- not remove_reaction(812,692).
catalyst(821,692) :- not remove_reaction(821,692).
catalyst(822,692) :- not remove_reaction(822,692).
catalyst(831,692) :- not remove_reaction(831,692).
catalyst(832,692) :- not remove_reaction(832,692).
catalyst(841,692) :- not remove_reaction(841,692).
catalyst(842,692) :- not remove_reaction(842,692).
catalyst(861,692) :- not remove_reaction(861,692).
catalyst(862,692) :- not remove_reaction(862,692).
catalyst(881,692) :- not remove_reaction(881,692).
catalyst(882,692) :- not remove_reaction(882,692).
catalyst(901,692) :- not remove_reaction(901,692).
catalyst(902,692) :- not remove_reaction(902,692).
catalyst(911,692) :- not remove_reaction(911,692).
catalyst(912,692) :- not remove_reaction(912,692).
catalyst(921,692) :- not remove_reaction(921,692).
catalyst(922,692) :- not remove_reaction(922,692).
catalyst(941,692) :- not remove_reaction(941,692).
catalyst(942,692) :- not remove_reaction(942,692).
catalyst(1191,692) :- not remove_reaction(1191,692).
catalyst(1192,692) :- not remove_reaction(1192,692).
catalyst(390,687).
catalyst(1021,687).
catalyst(1022,687).
catalyst(1521,666).
...
catalyst(6550,364).
catalyst(6690,362).
catalyst(791,327) :- not remove_reaction(791,327).
catalyst(792,327) :- not remove_reaction(792,327).
catalyst(801,327) :- not remove_reaction(801,327).
catalyst(802,327) :- not remove_reaction(802,327).
catalyst(811,327) :- not remove_reaction(811,327).
catalyst(812,327) :- not remove_reaction(812,327).
catalyst(831,327) :- not remove_reaction(831,327).
catalyst(832,327) :- not remove_reaction(832,327).
catalyst(841,327) :- not remove_reaction(841,327).
catalyst(842,327) :- not remove_reaction(842,327).
catalyst(861,327) :- not remove_reaction(861,327).
catalyst(862,327) :- not remove_reaction(862,327).
catalyst(901,327) :- not remove_reaction(901,327).
catalyst(902,327) :- not remove_reaction(902,327).
catalyst(1170,318).
catalyst(1180,318).
catalyst(1210,318).
catalyst(690,311).
...
catalyst(1511,253).
catalyst(1512,253).
catalyst(771,217) :- not remove_reaction(771,217).
catalyst(772,217) :- not remove_reaction(772,217).
catalyst(791,217) :- not remove_reaction(791,217).
catalyst(792,217) :- not remove_reaction(792,217).
catalyst(801,217) :- not remove_reaction(801,217).
catalyst(802,217) :- not remove_reaction(802,217).
catalyst(811,217) :- not remove_reaction(811,217).
catalyst(812,217) :- not remove_reaction(812,217).
catalyst(861,217) :- not remove_reaction(861,217).
catalyst(862,217) :- not remove_reaction(862,217).
catalyst(901,217) :- not remove_reaction(901,217).
catalyst(902,217) :- not remove_reaction(902,217).
catalyst(791,216) :- not remove_reaction(791,216).
catalyst(792,216) :- not remove_reaction(792,216).
catalyst(801,216) :- not remove_reaction(801,216).
catalyst(802,216) :- not remove_reaction(802,216).
catalyst(811,216) :- not remove_reaction(811,216).
catalyst(812,216) :- not remove_reaction(812,216).
catalyst(831,216) :- not remove_reaction(831,216).
catalyst(832,216) :- not remove_reaction(832,216).
catalyst(841,216) :- not remove_reaction(841,216).
catalyst(842,216) :- not remove_reaction(842,216).
catalyst(861,216) :- not remove_reaction(861,216).
catalyst(862,216) :- not remove_reaction(862,216).
catalyst(901,216) :- not remove_reaction(901,216).
catalyst(902,216) :- not remove_reaction(902,216).
catalyst(6600,213).
catalyst(620,209).
catalyst(540,194).
catalyst(2660,165).
...
modifiable_enzyme(684).
modifiable_enzyme(685).
modifiable_enzyme(430).
modifiable_enzyme(466).
modifiable_enzyme(319).
modifiable_enzyme(869).
modifiable_enzyme(692).
modifiable_enzyme(327).
modifiable_enzyme(217).
