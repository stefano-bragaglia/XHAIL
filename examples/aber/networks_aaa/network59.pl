...
component("YGR060W",243).
component("YGL012W",227).
component("YOL086C",412).
component("YMR303C",380).
component("YGL256W",238).
component("YDL168W",145).
component("YBR145W",111).
component("YPL231W",453).
component("YBR149W",112).
component("YGL001C",224).
component("YHR063C",263).
component("YML056C",360).
component("YLR432W",356).
component("YHR216W",271).
component("YAR075W",93).
component("YAR073W",92).
component("YDR127W",161).
component("YJR139C",310).
component("YOR136W",421).
component("YDL066W",137).
component("YML086C",362).
component("YIL155C",279).
component("YPR191W",476).
component("YOR065W",416).
component("YJL166W",294).
component("YHR001W-A",260).
component("YGR183C",250).
component("YFR033C",220).
component("YDR529C",188).
component("YBL045C",97).
component("Q0105",18).
component("YJR078W",303).
component("YJR025C",298).
component("YBL098W",100).
component("YMR015C",366).
component("YDR402C",180).
component("YJR104C",306).
component("YHR008C",261).
component("YER070W",203).
component("U35_",57).
component("YDL168W",146).
component("YPL276W",461).
component("YPL275W",460).
component("YOR388C",442).
component("YGL154C",234).
component("U55_",64).
component("YOR323C",433).
component("YMR170C",374).
component("YMR169C",373).
component("U2_",54).
component("YBR166C",115).
component("YNL280C",397).
component("YER014W",195).
component("YMR118C",371).
component("YLR164W",342).
component("YLL041C",336).
component("YKL148C",320).
component("YJL045W",284).
component("YDR178W",167).
component("YJR051W",300).
component("YEL047C",192).
component("YOR375C",441).
component("YDL215C",148).
component("YAL062W",91).
component("U99_",87).
component("YBR035C",103).
component("YKR080W",333).
component("YER023W",196).
component("YOR236W",430).
component("YGR204W",251).
component("U62_",66).
component("YKL150W",321).
component("YIL043C",273).
component("YHR042W",262).
component("YPL017C",445).
component("YFL018C",213).
component("YPL273W",459).
component("YLL062C",338).
component("U47_",59).
component("YDL033C",135).
component("YDR408C",182).
component("YKL024C",313).
component("YPR074C",469).
component("YBR117C",110).
component("YCL009C",126).
component("YMR062C",368).
component("YPL231W",454).
component("U86_",80).
component("YPL001W",444).
component("YPL231W",455).
component("YGR147C",247).
component("YDL040C",136).
component("YPL028W",446).
component("YPR001W",463).
component("YNR001C",401).
component("YDL182W",147).
component("YNL117W",388).
component("YIR031C",282).
component("YNL029C",383).
component("YIL085C",276).
component("YLR209C",343).
component("YMR300C",379).
component("YER055C",198).
component("YDR354W",176) :- not remove_orf("YDR354W",176).
component("YFR047C",221).
component("YJR133W",309).
component("YLR209C",344).
component("YML022W",357).
component("YDR441C",184).
component("YDR399W",178).
component("YNL256W",394).
component("YDR127W",162).
component("YLR303W",350).
component("YJR130C",308).
component("YLR303W",351).
component("YDR035W",153).
component("YBR249C",119).
component("YBR256C",120).
component("YHR137W",266).
component("YGL202W",236).
component("YLR027C",339).
component("YKL106W",316).
component("YKL104C",315).
component("YGR019W",240).
component("U64_",67).
component("U51_",61).
component("YJR148W",311).
component("YGL253W",237).
component("YFR053C",222).
component("YMR205C",376).
component("YGR240C",252).
component("YDR248C",171).
component("YCR036W",133).
component("YCL040W",128).
component("YJR105W",307).
component("U16_",33).
component("U15_",30).
component("U96_",85).
component("YKL001C",312).
component("YML070W",361).
component("YFL053W",215).
component("YHL032C",258).
component("U83_",78).
component("U82_",77).
component("YMR208W",377).
component("YOR347C",438).
component("YAL038W",90).
component("YPR121W",471).
component("YPL258C",457).
component("YOL055C",409).
component("U1_",42).
component("YNL267W",396).
component("YLR305C",353).
component("YFR019W",218).
component("YDR208W",168).
component("YDR127W",163).
component("U21_",47).
component("U20_",46).
component("YDR300C",174).
component("YCR012W",130).
component("U18_",39).
component("U76_",75).
component("YER170W",211).
component("YDR226W",169).
component("YDR454C",185).
component("YOL061W",411).
component("YKL181W",323).
component("YHL011C",256).
component("YER099C",207).
component("YBL068W",99).
component("YOR143C",422).
component("YGR007W",239).
component("YLR328W",354).
component("YCL050C",129).
component("YPR190C",475).
component("YPR187W",474).
...
component("YOR116C",419).
component("YOL005C",406).
component("YNR003C",402).
component("YNL248C",393).
component("YNL151C",391).
component("YNL113W",387).
component("YKL144C",319).
component("YJR063W",301).
component("YJL148W",292).
component("YJL140W",291).
component("YIL021W",272).
component("YHR143W-A",267).
component("YGL070C",232).
component("YFL036W",214).
component("YDR404C",181).
component("YDR156W",166).
component("YDR045C",154).
component("YDL150W",143).
component("YDL140C",142).
component("YBR154C",114).
component("YPR175W",473).
component("YPL167C",450).
component("YOR330C",434).
component("YOL115W",414).
component("YNL299W",399).
component("YNL262W",395).
component("YNL102W",386).
component("YJR043C",299).
component("YJR006W",297).
component("YJL090C",286).
component("YIL139C",278).
component("YEL055C",193).
component("YDR419W",183).
component("YDR121W",160).
component("YDL102W",140).
component("YCR014C",131).
component("YBR278W",122).
component("YBL035C",95).
component("YKL035W",314).
component("YHL012W",257).
component("YER026C",197).
component("YDR058C",157).
component("YDL086W",139).
component("YOL011W",407).
component("YMR008C",365).
component("YMR006C",364).
component("U101_",19).
component("YBL015W",94).
component("YPL072W",448).
component("YOR124C",420).
component("YNL186W",392).
component("YMR304W",381).
component("YMR223W",378).
component("YKR098C",334).
component("YJL197W",295).
component("YIL156W",280).
component("YFR010W",217).
component("YER151C",209).
component("YER144C",208).
component("YER098W",206).
component("YDR069C",158).
component("YDL122W",141).
component("YBR058C",104).
component("YBL067C",98).
component("U84_",79).
component("YPR073C",467).
component("YHR215W",270).
component("YDL024C",134).
component("YBR093C",108).
component("YBR092C",107).
component("YIL053W",275).
component("YER062C",202).
component("YPL228W",452).
component("YMR180C",375).
component("YDL236W",150).
component("YJL155C",293).
component("YPR073C",468).
component("YOR208W",427).
component("YNL053W",385).
component("YMR036C",367).
component("YIR026C",281).
component("YIL113W",277).
component("YFR028C",219).
component("YER075C",204).
component("YDL230W",149).
component("YBR276C",121).
component("U34_",56).
component("U30_",55).
component("U25_",53).
component("U24_",52).
component("YOR360C",440).
component("YKR031C",330).
component("YLR286C",348).
component("YOR190W",424).
component("YLR300W",349).
component("YGR282C",255).
component("YDR261C",172).
component("YDR400W",179).
component("U23_",51).
component("YML035C",358).
component("YJL070C",285).
component("YBR284W",123).
component("YNL045W",384).
component("YGL037C",229).
component("YDR242W",170).
component("YBR208C",116).
component("U53_",62).
component("YIR032C",283).
component("YMR120C",372).
component("YHR144C",268).
component("YBR153W",113).
component("YDL238C",151).
component("YNL141W",389).
component("YLR245C",347).
component("YML035C",359).
component("YJL126W",288).
component("U87_",81).
component("YBR111C",109).
component("YER005W",194).
component("YIL048W",274).
component("YER166W",210).
component("YDR093W",159).
component("YAL026C",89).
component("YLR231C",345).
component("U88_",82).
component("YLR134W",341).
component("YLR044C",340).
component("YGR087C",244).
component("YDR380W",177).
component("YDL080C",138).
component("U98_",86).
component("YKL184W",326).
component("YNR043W",405).
component("U93_",84).
component("U54_",63).
component("YKL211C",327) :- not remove_orf("YKL211C",327).
component("YGR170W",249).
component("YDR294C",173).
component("YEL046C",191).
component("YNR033W",404).
component("YKL211C",328) :- not remove_orf("YKL211C",328).
component("YER090W",328) :- not remove_orf("YER090W",328).
component("YER090W",205) :- not remove_orf("YER090W",205).
component("YDR127W",164).
component("YPL281C",462).
component("YOR393W",443).
component("YMR323W",382).
component("YHR174W",269).
component("YGR254W",254).
component("YGL026C",228) :- not remove_orf("YGL026C",228).
component("YGR155W",248).
component("YLR304C",352).
component("YJL200C",296).
component("YNL316C",400).
component("YKL182W",324).
component("YPL212C",451).
component("YNL292W",398).
component("YGL063W",231).
component("YFL001W",212).
component("YPR002W",464).
component("YDR127W",165).
component("YGL148W",233).
component("YAL012W",88).
component("YFR055W",223).
component("YBR019C",101).
component("YDR050C",156).
component("YDR007W",152) :- not remove_orf("YDR007W",152).
component("YOR095C",418).
component("YGL001C",225).
component("YKL152C",322).
component("YMR105C",369).
component("YKL127W",317).
component("YPR060C",466).
component("YPL104W",449).
component("YLL018C",335).
component("YHR091C",265).
component("YDR341C",175).
component("YOL097C",413).
component("YOR335C",435).
component("YGR094W",245).
component("YGR244C",253).
component("U89_",83).
component("YOR241W",431).
component("YMR113W",370).
component("YKL132C",318).
component("YJL101C",287).
component("YJR103W",305).
component("YBL039C",96).
component("YOL058W",410).
component("YBR208C",117).
component("YHR074W",264).
component("YOR303W",432).
component("YGL062W",230).
component("YBR218C",118).
component("YPL231W",456).
component("YNR016C",403).
component("YKL182W",325).
component("YGR037C",241).
component("YOR005C",415).
component("YDL164C",144).
component("YPR138C",472).
component("YPL265W",458).
component("YPL036W",447).
component("YOR348C",439).
component("YOR192C",425).
component("YOR071C",417).
component("YOL020W",408) :- not remove_orf("YOL020W",408).
component("YNL142W",390).
component("YML123C",363).
component("YLR348C",355).
component("YLR237W",346).
component("YLL061W",337).
component("YKR053C",332).
component("YKR039W",331) :- not remove_orf("YKR039W",331).
component("YKL217W",329).
component("YJR095W",304).
component("YJR077C",302).
component("YJL134W",290).
component("YJL129C",289).
component("YHL036W",259).
component("YGR121C",246).
component("YGR055W",242).
component("YGL186C",235).
component("YGL008C",226).
component("YFL055W",216).
component("YER060W-A",201).
component("YER060W",200).
component("YER056C",199).
component("YEL017C-A",190).
component("YDR536W",189).
component("YDR508C",187).
component("YDR503C",186).
component("YDR046C",155) :- not remove_orf("YDR046C",155).
component("YCR024C-A",132).
component("YCL025C",127).
component("YBR298C",125).
component("YBR291C",124).
component("YBR069C",106) :- not remove_orf("YBR069C",106).
component("YBR068C",105) :- not remove_orf("YBR068C",105).
component("YBR021W",102).
component("U79_",76).
component("U75_",74).
component("U74_",73).
component("U73_",72).
...
catalyst(2300,84).
catalyst(3460,63).
catalyst(3600,327) :- not remove_reaction(3600,327).
catalyst(6900,249).
catalyst(8781,173).
catalyst(8782,173).
catalyst(4560,191).
catalyst(2550,404).
catalyst(3630,328) :- not remove_reaction(3630,328).
catalyst(3630,205) :- not remove_reaction(3630,205).
catalyst(3740,164).
catalyst(8231,462).
catalyst(8232,462).
catalyst(8231,443).
...
catalyst(8231,254).
catalyst(8232,254).
catalyst(3590,228) :- not remove_reaction(3590,228).
catalyst(10910,228) :- not remove_reaction(10910,228).
catalyst(4570,248).
catalyst(8181,352).
catalyst(8182,352).
catalyst(8181,296).
...
catalyst(8281,156).
catalyst(8282,156).
catalyst(3610,152) :- not remove_reaction(3610,152).
catalyst(7921,418).
catalyst(7922,418).
catalyst(6370,225).
catalyst(8251,322).
...
catalyst(941,408) :- not remove_reaction(941,408).
catalyst(942,408) :- not remove_reaction(942,408).
catalyst(371,390).
catalyst(372,390).
catalyst(341,363).
catalyst(342,363).
...
catalyst(750,337).
catalyst(6560,332).
catalyst(771,331) :- not remove_reaction(771,331).
catalyst(772,331) :- not remove_reaction(772,331).
catalyst(781,331) :- not remove_reaction(781,331).
catalyst(782,331) :- not remove_reaction(782,331).
...
catalyst(881,331) :- not remove_reaction(881,331).
catalyst(882,331) :- not remove_reaction(882,331).
catalyst(941,331) :- not remove_reaction(941,331).
catalyst(942,331) :- not remove_reaction(942,331).
catalyst(1191,331) :- not remove_reaction(1191,331).
catalyst(1192,331) :- not remove_reaction(1192,331).
catalyst(1021,329).
catalyst(1022,329).
catalyst(1250,304).
catalyst(1581,302).
...
catalyst(861,105) :- not remove_reaction(861,105).
catalyst(862,105) :- not remove_reaction(862,105).
catalyst(620,102).
catalyst(2830,76).
catalyst(2920,74).
catalyst(2920,73).
