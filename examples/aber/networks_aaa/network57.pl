...
component("YGR060W",235).
component("YGL012W",219).
component("YOL086C",394).
component("YMR303C",364).
component("YGL256W",230).
component("YDL168W",142).
component("YBR145W",109).
component("YPL231W",433).
component("YBR149W",110).
component("YGL001C",216).
component("YML056C",346).
component("YLR432W",343).
component("YHR216W",262).
component("YAR075W",93).
component("YAR073W",92).
component("YDR127W",157).
component("YJR139C",299).
component("YOR136W",402).
component("YDL066W",135).
component("YIL155C",270).
component("YPR191W",456).
component("YOR065W",398).
component("YJL166W",284).
component("YHR001W-A",252).
component("YGR183C",242).
component("YFR033C",212).
component("YDR529C",184).
component("YBL045C",97).
component("Q0105",18).
component("YJR078W",292).
component("YJR025C",287).
component("YBL098W",99).
component("YMR015C",351).
component("YDR402C",176).
component("YJR104C",295).
component("YHR008C",253).
component("YER070W",199).
component("U35_",57).
component("YDL168W",143).
component("YPL276W",441).
component("YPL275W",440).
component("YOR388C",423).
component("YGL154C",226).
component("U55_",64).
component("YOR323C",414).
component("YMR170C",359).
component("YMR169C",358).
component("U2_",54).
component("YBR166C",113).
component("YNL280C",379).
component("YER014W",191).
component("YMR118C",356).
component("YLR164W",329).
component("YLL041C",324).
component("YKL148C",309).
component("YJL045W",274).
component("YDR178W",163).
component("YJR051W",289).
component("YEL047C",188).
component("YOR375C",422).
component("YDL215C",145).
component("YAL062W",91).
component("U99_",87).
component("YBR035C",102).
component("YKR080W",322).
component("YER023W",192).
component("YOR236W",411).
component("YGR204W",243).
component("U62_",66).
component("YKL150W",310).
component("YIL043C",264).
component("YHR042W",254).
component("YPL017C",426).
component("YFL018C",206).
component("YPL273W",439).
component("YLL062C",325).
component("U47_",59).
component("YDL033C",133).
component("YDR408C",178).
component("YKL024C",302).
component("YPR074C",449).
component("YBR117C",108).
component("YCL009C",124).
component("YMR062C",353).
component("YPL231W",434).
component("U86_",80).
component("YPL001W",425).
component("YPL231W",435).
component("YGR147C",239).
component("YDL040C",134).
component("YPL028W",427).
component("YPR001W",443).
component("YNR001C",383).
component("YDL182W",144).
component("YNL117W",371).
component("YIR031C",272).
component("YNL029C",366).
component("YIL085C",267).
component("YLR209C",330).
component("YMR300C",363).
component("YER055C",194).
component("YDR354W",172) :- not remove_orf("YDR354W",172).
component("YFR047C",213).
component("YJR133W",298).
component("YLR209C",331).
component("YML022W",344).
component("YDR441C",180).
component("YDR399W",174).
component("YNL256W",376).
component("YDR127W",158).
component("YLR303W",337).
component("YJR130C",297).
component("YLR303W",338).
component("YDR035W",150).
component("YBR249C",117).
component("YBR256C",118).
component("YHR137W",257).
component("YGL202W",228).
component("YLR027C",326).
component("YKL106W",305).
component("YKL104C",304).
component("YGR019W",232).
component("U64_",67).
component("U51_",61).
component("YJR148W",300).
component("YGL253W",229).
component("YFR053C",214).
component("YMR205C",361).
component("YGR240C",244).
component("YDR248C",167).
component("YCR036W",131).
component("YCL040W",126).
component("YJR105W",296).
component("U16_",33).
component("U15_",30).
component("U96_",85).
component("YKL001C",301).
component("YML070W",347).
component("YFL053W",208).
component("YHL032C",250).
component("U83_",78).
component("U82_",77).
component("YMR208W",362).
component("YOR347C",419).
component("YAL038W",90).
component("YPR121W",451).
component("YPL258C",437).
component("YOL055C",391).
component("U1_",42).
component("YNL267W",378).
component("YLR305C",340).
component("YFR019W",210).
component("YDR208W",164).
component("YDR127W",159).
component("U21_",47).
component("U20_",46).
component("YDR300C",170).
component("YCR012W",128).
component("U18_",39).
component("U76_",75).
component("YER170W",204).
component("YDR226W",165).
component("YDR454C",181).
component("YOL061W",393).
component("YKL181W",312).
component("YHL011C",248).
component("YER099C",202).
component("YBL068W",98).
component("YOR143C",403).
component("YGR007W",231).
component("YLR328W",341).
component("YCL050C",127).
component("YPR190C",455).
component("YPR187W",454).
component("YPR110C",450).
component("YPR010C",445).
component("YOR341W",418).
component("YOR340C",417).
component("YOR224C",410).
component("YOR210W",409).
component("YOR207C",407).
component("YOR151C",404).
component("YOR116C",401).
component("YOL005C",388).
component("YNR003C",384).
component("YNL248C",375).
component("YNL151C",374).
component("YNL113W",370).
component("YKL144C",308).
component("YJR063W",290).
component("YJL148W",282).
component("YJL140W",281).
component("YIL021W",263).
component("YHR143W-A",258).
component("YGL070C",224).
component("YFL036W",207).
component("YDR404C",177).
component("YDR156W",162).
component("YDR045C",151).
component("YDL150W",140).
component("YDL140C",139).
component("YBR154C",112).
component("YPR175W",453).
component("YPL167C",430).
component("YOR330C",415).
component("YOL115W",396).
component("YNL299W",381).
component("YNL262W",377).
component("YNL102W",369).
component("YJR043C",288).
component("YJR006W",286).
component("YJL090C",276).
component("YIL139C",269).
component("YEL055C",189).
component("YDR419W",179).
component("YDR121W",156).
component("YDL102W",138).
component("YCR014C",129).
component("YBR278W",120).
component("YBL035C",95).
component("YKL035W",303).
component("YHL012W",249).
component("YER026C",193).
component("YDR058C",154).
component("YDL086W",137).
component("YOL011W",389).
component("YMR008C",350).
component("YMR006C",349).
component("U101_",19).
component("YBL015W",94).
component("U84_",79).
component("YPR073C",447).
component("YHR215W",261).
component("YDL024C",132).
component("YBR093C",106).
component("YBR092C",105).
component("YIL053W",266).
component("YER062C",198).
component("YPL228W",432).
component("YMR180C",360).
component("YDL236W",147).
component("YJL155C",283).
component("YPR073C",448).
component("YOR208W",408).
component("YNL053W",368).
component("YMR036C",352).
component("YIR026C",271).
component("YIL113W",268).
component("YFR028C",211).
...
component("U25_",53).
component("U24_",52).
component("YOR360C",421).
component("YKR031C",319).
component("YLR286C",335).
component("YOR190W",405).
component("YLR300W",336).
component("YGR282C",247).
component("YDR261C",168).
component("YDR400W",175).
component("U23_",51).
component("YML035C",345).
component("YJL070C",275).
component("YBR284W",121).
component("YNL045W",367).
component("YGL037C",221).
component("YDR242W",166).
component("YBR208C",114).
component("U53_",62).
component("YIR032C",273).
component("YMR120C",357).
component("YHR144C",259).
component("YBR153W",111).
component("YDL238C",148).
component("YNL141W",372).
component("YLR245C",334).
component("YJL126W",278).
component("U87_",81).
component("YBR111C",107).
component("YER005W",190).
component("YIL048W",265).
component("YER166W",203).
component("YDR093W",155).
component("YAL026C",89).
component("YLR231C",332).
component("U88_",82).
component("YLR134W",328).
component("YLR044C",327).
component("YGR087C",236).
component("YDR380W",173).
component("YDL080C",136).
component("U98_",86).
component("YKL184W",315).
component("YNR043W",387).
component("U93_",84).
component("U54_",63).
component("YKL211C",316) :- not remove_orf("YKL211C",316).
component("YGR170W",241).
component("YDR294C",169).
component("YEL046C",187).
...
component("YPL281C",442).
component("YOR393W",424).
component("YMR323W",365).
component("YHR174W",260).
component("YGR254W",246).
component("YGL026C",220) :- not remove_orf("YGL026C",220).
component("YGR155W",240).
component("YLR304C",339).
component("YJL200C",285).
component("YNL316C",382).
component("YKL182W",313).
component("YPL212C",431).
component("YNL292W",380).
component("YGL063W",223).
component("YFL001W",205).
component("YPR002W",444).
component("YDR127W",161).
component("YGL148W",225).
component("YAL012W",88).
component("YFR055W",215).
component("YBR019C",100).
component("YDR050C",153).
component("YDR007W",149) :- not remove_orf("YDR007W",149).
component("YOR095C",400).
component("YGL001C",217).
component("YKL152C",311).
component("YMR105C",354).
component("YKL127W",306).
component("YPR060C",446).
component("YPL104W",429).
component("YLL018C",323).
component("YHR091C",256).
component("YDR341C",171).
component("YOL097C",395).
component("YOR335C",416).
component("YGR094W",237).
component("YGR244C",245).
component("U89_",83).
component("YOR241W",412).
component("YMR113W",355).
component("YKL132C",307).
component("YJL101C",277).
component("YJR103W",294).
component("YBL039C",96).
component("YOL058W",392).
component("YBR208C",115).
component("YHR074W",255).
component("YOR303W",413).
component("YGL062W",222).
component("YBR218C",116).
component("YPL231W",436).
component("YNR016C",385).
component("YKL182W",314).
component("YGR037C",233).
component("YOR005C",397).
component("YDL164C",141).
component("YPR138C",452).
component("YPL265W",438).
component("YPL036W",428).
component("YOR348C",420).
component("YOR192C",406).
component("YOR071C",399).
component("YOL020W",390) :- not remove_orf("YOL020W",390).
component("YNL142W",373).
component("YML123C",348).
component("YLR348C",342).
component("YLR237W",333).
component("YKR053C",321).
component("YKR039W",320) :- not remove_orf("YKR039W",320).
component("YKL217W",318).
component("YJR095W",293).
component("YJR077C",291).
component("YJL134W",280).
component("YJL129C",279).
component("YHL036W",251).
component("YGR121C",238).
component("YGR055W",234).
component("YGL186C",227).
component("YGL008C",218).
component("YFL055W",209).
component("YER060W-A",197).
component("YER060W",196).
component("YER056C",195).
component("YEL017C-A",186).
component("YDR536W",185).
component("YDR508C",183).
component("YDR503C",182).
component("YDR046C",152) :- not remove_orf("YDR046C",152).
component("YCR024C-A",130).
component("YCL025C",125).
component("YBR298C",123).
component("YBR291C",122).
component("YBR069C",104) :- not remove_orf("YBR069C",104).
component("YBR068C",103) :- not remove_orf("YBR068C",103).
component("YBR021W",101).
component("U79_",76).
component("U75_",74).
component("U74_",73).
component("U73_",72).
...
catalyst(8281,153).
catalyst(8282,153).
catalyst(3610,149) :- not remove_reaction(3610,149).
catalyst(7921,400).
catalyst(7922,400).
catalyst(6370,217).
catalyst(8251,311).
...
catalyst(941,390) :- not remove_reaction(941,390).
catalyst(942,390) :- not remove_reaction(942,390).
catalyst(371,373).
catalyst(372,373).
catalyst(341,348).
catalyst(342,348).
...
catalyst(190,333).
catalyst(6560,321).
catalyst(771,320) :- not remove_reaction(771,320).
catalyst(772,320) :- not remove_reaction(772,320).
catalyst(781,320) :- not remove_reaction(781,320).
catalyst(782,320) :- not remove_reaction(782,320).
catalyst(801,320) :- not remove_reaction(801,320).
catalyst(802,320) :- not remove_reaction(802,320).
catalyst(811,320) :- not remove_reaction(811,320).
catalyst(812,320) :- not remove_reaction(812,320).
catalyst(831,320) :- not remove_reaction(831,320).
catalyst(832,320) :- not remove_reaction(832,320).
catalyst(841,320) :- not remove_reaction(841,320).
catalyst(842,320) :- not remove_reaction(842,320).
catalyst(881,320) :- not remove_reaction(881,320).
catalyst(882,320) :- not remove_reaction(882,320).
catalyst(941,320) :- not remove_reaction(941,320).
catalyst(942,320) :- not remove_reaction(942,320).
catalyst(1191,320) :- not remove_reaction(1191,320).
catalyst(1192,320) :- not remove_reaction(1192,320).
catalyst(1021,318).
catalyst(1022,318).
catalyst(1250,293).
catalyst(1581,291).
...
catalyst(1501,122).
catalyst(1502,122).
catalyst(771,104) :- not remove_reaction(771,104).
catalyst(772,104) :- not remove_reaction(772,104).
