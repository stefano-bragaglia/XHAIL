...
component("YGL012W",105).
component("YOL086C",190).
component("YMR303C",174).
component("YGL256W",111).
component("YDL168W",64).
component("YBR145W",51).
component("YGL001C",103).
component("YML056C",166).
component("YLR432W",164).
component("YHR216W",125).
component("YAR075W",40).
component("YAR073W",39).
component("YDR127W",73).
component("YJR139C",144).
component("YOR136W",194).
component("YIL155C",128).
component("YJR078W",139).
component("YJR025C",136).
component("YMR015C",168).
component("YDR402C",85).
component("YGL154C",109).
component("YMR170C",170).
component("YMR169C",169).
component("YBR166C",53).
component("YER014W",93).
component("YEL047C",92).
component("YOR375C",203).
component("YDL215C",65).
component("YAL062W",38).
component("U62_",32).
component("YPL017C",206).
component("YFL018C",96).
component("YKL024C",146).
component("YPR074C",217).
component("YBR117C",50).
component("YPL231W",209).
component("YPL001W",205).
component("YPL231W",210).
component("YNL029C",176).
component("YIL085C",127).
component("YLR209C",159).
component("YDR354W",82) :- not remove_orf("YDR354W",82).
component("YFR047C",101).
component("YJR133W",143).
component("YDR399W",83).
component("YDR127W",74).
component("YJR130C",142).
component("YDR035W",69).
component("YBR249C",54).
component("YBR256C",55).
component("YHR137W",121).
component("YLR027C",156).
component("YKL106W",147).
component("U64_",33).
component("YGL253W",110).
component("YFR053C",102).
component("YMR205C",172).
component("YGR240C",118).
component("YCR036W",60).
component("U15_",20).
component("YKL001C",145).
component("YML070W",167).
component("YFL053W",98).
component("U83_",36).
component("YMR208W",173).
component("U1_",24).
component("YNL267W",182).
component("YLR305C",163).
component("YFR019W",100).
component("YDR208W",79).
component("YDR127W",75).
component("U20_",27).
component("YDR300C",81).
component("U76_",35).
component("YDR454C",87).
component("YOL061W",189).
component("YKL181W",149).
component("YHL011C",120).
component("YER099C",95).
component("YBL068W",43).
component("YOR143C",195).
component("YPR190C",221).
component("YPR187W",220).
component("YPR110C",218).
component("YPR010C",214).
component("YOR341W",202).
component("YOR340C",201).
component("YOR224C",199).
component("YOR210W",198).
component("YOR207C",197).
component("YOR151C",196).
component("YOR116C",193).
component("YOL005C",187).
component("YNR003C",184).
component("YNL248C",181).
component("YNL151C",180).
component("YNL113W",178).
component("YKL144C",148).
component("YJR063W",137).
component("YJL148W",134).
component("YJL140W",133).
component("YIL021W",126).
component("YHR143W-A",122).
component("YGL070C",107).
component("YFL036W",97).
component("YDR404C",86).
component("YDR156W",78).
component("YDR045C",70).
component("YDL150W",63).
component("YDL140C",62).
component("YBR154C",52).
component("YDR058C",72).
component("YBL015W",41).
component("U84_",37).
component("YPR073C",216).
component("YHR215W",124).
component("YDL024C",61).
component("YBR093C",48).
component("YBR092C",47).
component("YPL228W",208).
component("YMR180C",171).
component("YDL236W",66).
component("YJL155C",135).
component("U30_",29).
component("YLR286C",162).
component("YDR400W",84).
component("YML035C",165).
component("YJL070C",130).
component("YBR284W",56).
component("YNL045W",177).
component("U53_",30).
component("YIR032C",129).
component("YDL238C",67).
component("YLR245C",161).
component("YJL126W",131).
component("YBR111C",49).
component("YLR231C",160).
component("YLR134W",158).
component("YLR044C",157).
component("YGR087C",113).
component("U54_",31).
component("YKL211C",152) :- not remove_orf("YKL211C",152).
component("YGR170W",117).
component("YDR294C",80).
component("YNR033W",186).
component("YKL211C",153) :- not remove_orf("YKL211C",153).
component("YER090W",153) :- not remove_orf("YER090W",153).
component("YER090W",94) :- not remove_orf("YER090W",94).
component("YDR127W",76).
component("YPL281C",213).
component("YOR393W",204).
component("YMR323W",175).
component("YHR174W",123).
component("YGR254W",119).
component("YGL026C",106) :- not remove_orf("YGL026C",106).
component("YGR155W",116).
component("YNL316C",183).
component("YKL182W",150).
component("YDR127W",77).
component("YGL148W",108).
component("YDR007W",68) :- not remove_orf("YDR007W",68).
component("YOR095C",192).
component("YPR060C",215).
component("YOL097C",191).
component("YOR335C",200).
component("YGR094W",114).
component("YJR103W",141).
component("YBL039C",42).
component("YPL231W",211).
component("YNR016C",185).
component("YKL182W",151).
component("YGR037C",112).
component("YPR138C",219).
component("YPL265W",212).
component("YPL036W",207).
component("YOL020W",188) :- not remove_orf("YOL020W",188).
component("YNL142W",179).
component("YKR053C",155).
component("YKR039W",154) :- not remove_orf("YKR039W",154).
component("YJR095W",140).
component("YJR077C",138).
component("YJL134W",132).
component("YGR121C",115).
component("YGL008C",104).
component("YFL055W",99).
component("YEL017C-A",91).
component("YDR536W",90).
component("YDR508C",89).
component("YDR503C",88).
component("YDR046C",71) :- not remove_orf("YDR046C",71).
component("YCR024C-A",59).
component("YCL025C",58).
component("YBR291C",57).
component("YBR069C",46) :- not remove_orf("YBR069C",46).
component("YBR068C",45) :- not remove_orf("YBR068C",45).
component("YBR021W",44).
component("U71_",34).
component("U228_",28).
component("U206_",26).
component("U202_",25).
...
catalyst(5611,159).
catalyst(5612,159).
catalyst(3620,82) :- not remove_reaction(3620,82).
catalyst(2190,101).
catalyst(5550,143).
catalyst(5320,83).
catalyst(3710,74).
...
catalyst(7550,113).
catalyst(3460,31).
catalyst(3600,152) :- not remove_reaction(3600,152).
catalyst(6900,117).
catalyst(8781,80).
catalyst(8782,80).
catalyst(2550,186).
catalyst(3630,153) :- not remove_reaction(3630,153).
catalyst(3630,94) :- not remove_reaction(3630,94).
catalyst(3740,76).
catalyst(8231,213).
catalyst(8232,213).
catalyst(8231,204).
...
catalyst(3750,77).
catalyst(3700,108).
catalyst(3610,68) :- not remove_reaction(3610,68).
catalyst(7921,192).
catalyst(7922,192).
catalyst(3690,215).
catalyst(8671,191).
...
catalyst(882,89).
catalyst(6680,88).
catalyst(801,71) :- not remove_reaction(801,71).
catalyst(802,71) :- not remove_reaction(802,71).
catalyst(811,71) :- not remove_reaction(811,71).
catalyst(812,71) :- not remove_reaction(812,71).
catalyst(831,71) :- not remove_reaction(831,71).
catalyst(832,71) :- not remove_reaction(832,71).
catalyst(220,59).
catalyst(781,58).
catalyst(782,58).
catalyst(801,58).
...
catalyst(831,45) :- not remove_reaction(831,45).
catalyst(832,45) :- not remove_reaction(832,45).
catalyst(620,44).
catalyst(2930,34).
catalyst(41,28).
catalyst(42,28).
