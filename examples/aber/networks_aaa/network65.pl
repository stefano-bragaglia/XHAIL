...
component("YGR060W",256).
component("YGL012W",239).
component("YOL086C",437).
component("YMR303C",404).
component("YGL256W",250).
component("YDL168W",152).
component("YBR145W",118).
component("YPL231W",481).
component("YBR149W",119).
component("YGL001C",236).
component("YHR063C",279).
component("YML056C",383).
component("YLR432W",379).
component("YHR216W",287).
component("YAR075W",99).
component("YAR073W",98).
component("YDR127W",168).
component("YJR139C",327).
component("YKL029C",331).
component("YOR136W",447).
component("YDL066W",144).
component("YML086C",385).
component("YIL155C",295).
component("YPR191W",505).
component("YOR065W",442).
component("YJL166W",311).
component("YHR001W-A",276).
component("YGR183C",265).
component("YFR033C",232).
component("YDR529C",197).
component("YBL045C",104).
component("Q0105",18).
component("YGR088W",258).
component("YDR256C",180).
component("YJR078W",320).
component("YJR025C",315).
component("YBL098W",107).
component("YMR015C",389).
component("YDR402C",189).
component("YJR104C",323).
component("YHR008C",277).
component("YER070W",214).
component("U35_",61).
component("YDL168W",153).
component("YPL276W",489).
component("YPL275W",488).
component("YOR388C",469).
component("YGL154C",246).
component("U55_",69).
component("YOR323C",459).
component("YMR170C",397).
component("YMR169C",396).
component("U2_",58).
component("YBR166C",122).
component("YNL280C",422).
component("YER014W",206).
component("YMR118C",394).
component("YLR164W",363).
component("YLL041C",354).
component("YKL148C",338).
component("YJL045W",300).
component("YDR178W",175).
component("YJR051W",317).
component("YEL047C",201).
component("YOR375C",467).
component("YDL215C",155).
component("YAL062W",96).
component("U99_",92).
component("YBR035C",110).
component("YKR080W",351).
component("YER023W",207).
component("YOR236W",456).
component("YGR204W",266).
component("U62_",71).
component("YKL150W",339).
component("YIL043C",289).
component("YHR042W",278).
component("YPL017C",472).
component("YFL018C",224).
component("YPL273W",487).
component("YLL062C",356).
component("U47_",64).
component("YDL033C",142).
component("YOL096C",438).
component("YDR408C",191).
component("YBL013W",100).
component("YKL024C",330).
component("YPR074C",498).
component("YBR117C",117).
component("YLR354C",377).
component("YGR043C",254).
component("YCL009C",133).
component("YMR062C",391).
component("YPL231W",482).
component("U86_",85).
component("YPL001W",471).
component("YOR377W",468).
component("YGR177C",264).
component("YPL231W",483).
component("YGR147C",261).
component("YDL040C",143).
component("YPL028W",473).
component("YPR001W",491).
component("YNR001C",426).
component("YDL182W",154).
component("YNL117W",412).
component("YIR031C",298).
component("YNL029C",407).
component("YIL085C",292).
component("YLR209C",364).
component("YMR300C",403).
component("YER055C",209).
component("YDR354W",185) :- not remove_orf("YDR354W",185).
component("YFR047C",233).
component("YJR133W",326).
component("YLR209C",365).
component("YML022W",380).
component("YDR441C",193).
component("YDR399W",187).
component("YNL256W",418).
component("YDR127W",169).
component("YLR303W",371).
component("YJR130C",325).
component("YLR303W",372).
component("YDR035W",160).
component("YBR249C",126).
component("YBR256C",127).
component("YHR137W",282).
component("YGL202W",248).
component("YLR027C",357).
component("YKL106W",334).
component("YKL104C",333).
component("YGR019W",252).
component("U64_",72).
component("U51_",66).
component("YJR148W",328).
component("YGL253W",249).
component("YFR053C",234).
component("YMR205C",399).
component("YGR240C",268).
component("YDR248C",179).
component("YCR036W",140).
component("YCL040W",135).
component("YJR105W",324).
component("U16_",35).
component("U15_",32).
component("U96_",90).
component("YKL001C",329).
component("YML070W",384).
component("YFL053W",227).
component("YHL032C",274).
component("U83_",83).
component("U82_",82).
component("YMR208W",400).
component("YOR347C",464).
component("YAL038W",95).
component("YPR121W",500).
component("YPL258C",485).
component("YOL055C",434).
component("U1_",44).
component("YNL267W",420).
component("YLR305C",374).
component("YFR019W",230).
component("YDR208W",176).
component("YDR127W",170).
component("U21_",50).
component("U20_",48).
component("YDR147W",173).
component("YDR300C",183).
component("YCR012W",137).
component("U18_",41).
component("U76_",80).
component("YER170W",222).
component("YDR226W",177).
component("YDR454C",194).
component("YOL061W",436).
component("YKL181W",341).
component("YHL011C",272).
component("YER099C",218).
component("YBL068W",106).
component("YOR143C",448).
component("YGR007W",251).
component("YLR328W",375).
component("YCL050C",136).
component("YPR190C",504).
component("YPR187W",503).
component("YPR110C",499).
component("YPR010C",493).
component("YOR341W",463).
component("YOR340C",462).
component("YOR224C",455).
component("YOR210W",454).
component("YOR207C",452).
component("YOR151C",449).
component("YOR116C",445).
component("YOL005C",431).
component("YNR003C",427).
component("YNL248C",417).
component("YNL151C",415).
component("YNL113W",411).
component("YKL144C",337).
component("YJR063W",318).
component("YJL148W",309).
component("YJL140W",308).
component("YIL021W",288).
component("YHR143W-A",283).
component("YGL070C",244).
component("YFL036W",226).
component("YDR404C",190).
component("YDR156W",174).
component("YDR045C",161).
component("YDL150W",150).
component("YDL140C",149).
component("YBR154C",121).
component("YPR175W",502).
component("YPL167C",478).
component("YOR330C",460).
component("YOL115W",440).
component("YNL299W",424).
component("YNL262W",419).
component("YNL102W",410).
component("YJR043C",316).
component("YJR006W",314).
component("YJL090C",303).
component("YIL139C",294).
...
component("YHL012W",273).
component("YER026C",208).
component("YDR058C",164).
component("YDL086W",146).
component("YOL011W",432).
component("YMR008C",388).
component("YMR006C",387).
component("U101_",19).
component("YBL015W",101).
component("YJL068C",301).
component("YPL072W",475).
component("YOR124C",446).
component("YNL186W",416).
component("YMR304W",405).
component("YMR223W",401).
component("YKR098C",352).
component("YJL197W",312).
component("YIL156W",296).
component("YFR010W",229).
component("YER151C",220).
component("YER144C",219).
component("YER098W",217).
component("YDR069C",165).
component("YDL122W",148).
component("YBR058C",111).
component("YBL067C",105).
component("U84_",84).
component("YPR073C",496).
component("YHR215W",286).
component("YDL024C",141).
component("YBR093C",115).
component("YBR092C",114).
component("YAR071W",97).
component("YIL053W",291).
component("YER062C",213).
component("YGR208W",267).
component("YPL228W",480).
component("YMR180C",398).
component("YDL236W",157).
component("YJL155C",310).
component("YPR073C",497).
component("YOR208W",453).
component("YNL053W",409).
component("YMR036C",390).
component("YIR026C",297).
component("YIL113W",293).
component("YFR028C",231).
component("YER075C",215).
component("YDL230W",156).
component("YBR276C",128).
component("U34_",60).
component("U30_",59).
component("U25_",57).
component("U24_",56).
component("YOR360C",466).
component("YKR031C",348).
component("YLR286C",369).
component("YOR190W",450).
component("YLR300W",370).
component("YGR282C",271).
component("YDR261C",181).
component("YDR400W",188).
component("U23_",55).
component("YML035C",381).
component("YJL070C",302).
component("YBR284W",130).
component("U102_",20).
component("YNL045W",408).
component("YGL037C",241).
component("YDR242W",178).
component("YBR208C",123).
component("U53_",67).
component("YIR032C",299).
component("YMR120C",395).
component("YHR144C",284).
component("YBR153W",120).
component("YDL238C",158).
component("YNL141W",413).
component("YLR245C",368).
component("YML035C",382).
component("YJL126W",305).
component("U87_",86).
component("YBR111C",116).
component("YER005W",205).
component("YIL048W",290).
component("YER166W",221).
component("YDR093W",166).
component("YAL026C",94).
component("YLR231C",366).
component("U88_",87).
component("YLR134W",361).
component("YLR044C",358).
component("YGR087C",257).
component("YDR380W",186).
component("YDL080C",145).
component("U98_",91).
component("YKL184W",344).
component("YNR043W",430).
component("U93_",89).
component("U54_",68).
component("YKL211C",345) :- not remove_orf("YKL211C",345).
component("YGR170W",263).
component("YDR294C",182).
component("YEL046C",200).
component("YNR033W",429).
component("YKL211C",346) :- not remove_orf("YKL211C",346).
component("YER090W",346) :- not remove_orf("YER090W",346).
component("YER090W",216) :- not remove_orf("YER090W",216).
component("YDR127W",171).
component("YPL281C",490).
component("YOR393W",470).
component("YMR323W",406).
component("YHR174W",285).
component("YGR254W",270).
component("YGL026C",240) :- not remove_orf("YGL026C",240).
component("YGR155W",262).
component("YLR304C",373).
component("YJL200C",313).
component("YNL316C",425).
component("YKL182W",342).
component("YPL212C",479).
component("YNL292W",423).
component("YGL063W",243).
component("YFL001W",223).
component("YPR002W",492).
component("YDR127W",172).
component("YGL148W",245).
component("YAL012W",93).
component("YFR055W",235).
component("YBR019C",108).
component("YDR050C",163).
component("YDR007W",159) :- not remove_orf("YDR007W",159).
component("YOR095C",444).
component("YER003C",204).
component("YGL001C",237).
component("YKL152C",340).
component("YMR105C",392).
component("YKL127W",335).
component("YEL058W",203).
component("YPR060C",495).
component("YPL104W",476).
component("YLL018C",353).
component("YHR091C",281).
component("YDR341C",184).
component("YOL097C",439).
component("YPR047W",494).
component("YLR060W",359).
component("YFL022C",225).
component("YPL160W",477).
component("YLR382C",378).
component("YOR335C",461).
component("YGR094W",259).
component("YGR244C",269).
component("U89_",88).
component("YOR241W",457).
component("YMR113W",393).
component("YKL132C",336).
component("YJL101C",304).
component("YJR103W",322).
component("YBL039C",103).
component("YOL058W",435).
component("YBR208C",124).
component("YHR074W",280).
component("YOR303W",458).
component("YGL062W",242).
component("YBR218C",125).
component("YPL231W",484).
component("YNR016C",428).
component("YKL182W",343).
component("YGR037C",253).
component("YOR005C",441).
component("YDL164C",151).
component("YPR138C",501).
component("YPL265W",486).
component("YPL036W",474).
component("YOR348C",465).
component("YOR192C",451).
component("YOR071C",443).
component("YOL020W",433) :- not remove_orf("YOL020W",433).
component("YNL268W",421).
component("YNL142W",414).
component("YMR272C",402).
component("YML123C",386).
component("YLR348C",376).
component("YLR237W",367).
component("YLR138W",362).
component("YLR100C",360).
component("YLL061W",355).
component("YKR053C",350).
component("YKR039W",349) :- not remove_orf("YKR039W",349).
component("YKL217W",347).
component("YJR095W",321).
component("YJR077C",319).
component("YJL134W",307).
component("YJL129C",306).
component("YHL036W",275).
component("YGR121C",260).
component("YGR055W",255).
component("YGL186C",247).
component("YGL008C",238).
...
component("YDR508C",196).
component("YDR503C",195).
component("YDR046C",162) :- not remove_orf("YDR046C",162).
component("YCR024C-A",139).
component("YCL025C",134).
component("YBR298C",132).
component("YBR291C",131).
component("YBR069C",113) :- not remove_orf("YBR069C",113).
component("YBR068C",112) :- not remove_orf("YBR068C",112).
component("YBR021W",109).
component("U79_",81).
component("U75_",79).
component("U74_",78).
component("U73_",77).
...
catalyst(6160,403).
catalyst(3870,209).
catalyst(3620,185) :- not remove_reaction(3620,185).
catalyst(2190,233).
catalyst(5550,326).
catalyst(5791,365).
catalyst(5792,365).
...
catalyst(2300,89).
catalyst(3460,68).
catalyst(3600,345) :- not remove_reaction(3600,345).
catalyst(6900,263).
catalyst(8781,182).
catalyst(8782,182).
catalyst(4560,200).
...
catalyst(3630,216) :- not remove_reaction(3630,216).
catalyst(3740,171).
catalyst(8231,490).
catalyst(8232,490).
catalyst(8231,470).
...
catalyst(750,355).
catalyst(6560,350).
catalyst(761,349) :- not remove_reaction(761,349).
catalyst(762,349) :- not remove_reaction(762,349).
catalyst(771,349) :- not remove_reaction(771,349).
catalyst(772,349) :- not remove_reaction(772,349).
catalyst(781,349) :- not remove_reaction(781,349).
catalyst(782,349) :- not remove_reaction(782,349).
catalyst(791,349) :- not remove_reaction(791,349).
catalyst(792,349) :- not remove_reaction(792,349).
catalyst(801,349) :- not remove_reaction(801,349).
catalyst(802,349) :- not remove_reaction(802,349).
catalyst(811,349) :- not remove_reaction(811,349).
catalyst(812,349) :- not remove_reaction(812,349).
catalyst(831,349) :- not remove_reaction(831,349).
catalyst(832,349) :- not remove_reaction(832,349).
catalyst(841,349) :- not remove_reaction(841,349).
catalyst(842,349) :- not remove_reaction(842,349).
catalyst(861,349) :- not remove_reaction(861,349).
catalyst(862,349) :- not remove_reaction(862,349).
catalyst(881,349) :- not remove_reaction(881,349).
catalyst(882,349) :- not remove_reaction(882,349).
catalyst(941,349) :- not remove_reaction(941,349).
catalyst(942,349) :- not remove_reaction(942,349).
catalyst(1191,349) :- not remove_reaction(1191,349).
catalyst(1192,349) :- not remove_reaction(1192,349).
catalyst(1021,347).
catalyst(1022,347).
catalyst(1250,321).
catalyst(1581,319).
...
catalyst(1511,131).
catalyst(1512,131).
catalyst(771,113) :- not remove_reaction(771,113).
catalyst(772,113) :- not remove_reaction(772,113).
...
catalyst(791,112) :- not remove_reaction(791,112).
catalyst(792,112) :- not remove_reaction(792,112).
catalyst(801,112) :- not remove_reaction(801,112).
catalyst(802,112) :- not remove_reaction(802,112).
catalyst(811,112) :- not remove_reaction(811,112).
catalyst(812,112) :- not remove_reaction(812,112).
catalyst(831,112) :- not remove_reaction(831,112).
catalyst(832,112) :- not remove_reaction(832,112).
catalyst(841,112) :- not remove_reaction(841,112).
catalyst(842,112) :- not remove_reaction(842,112).
catalyst(861,112) :- not remove_reaction(861,112).
catalyst(862,112) :- not remove_reaction(862,112).
catalyst(620,109).
catalyst(2830,81).
catalyst(2920,79).
catalyst(2920,78).
