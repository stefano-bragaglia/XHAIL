...
component("YNL280C",892).
component("YLR056W",752).
component("YGR060W",530).
component("YGL012W",495).
component("YKR009C",732).
component("YOL086C",927).
component("YMR303C",858).
component("YMR083W",827).
component("YGL256W",522).
component("YDL168W",332).
component("YBR145W",254).
component("YPL231W",1014).
component("YBR265W",273).
component("U46_",146).
component("YBR149W",255).
component("YBR149W",256).
component("YJR159W",696).
component("YGL001C",492).
component("YIL094C",617).
component("YHR063C",585).
component("U45_",145).
component("YBR153W",257).
component("YML056C",808).
component("YLR432W",797).
component("YHR216W",607).
component("YAR075W",209).
component("YAR073W",208).
component("YCL030C",283).
component("YDR127W",370).
component("YJR139C",690).
component("YML075C",811).
component("YLR450W",800).
component("YOL126C",933).
component("YKL085W",706).
component("YDL078C",312).
component("YKL029C",701).
component("YOR136W",950).
component("YNL037C",863).
component("YDL066W",310).
component("YHR183W",602).
component("YGR256W",561).
component("YNL241C",882).
component("YOL059W",924).
component("YDL022W",303).
component("YLR355C",792).
component("YIL074C",615).
component("YER081W",457).
component("YML054C",807).
component("YDL174C",335).
component("YML086C",812).
component("YIL155C",625).
component("YPR191W",1055).
component("YOR065W",940).
component("YJL166W",661).
...
component("YPL276W",1026).
component("YPL275W",1025).
component("YOR388C",988).
component("YPL061W",996).
component("YOR374W",985).
...
component("YOR323C",975).
component("YMR170C",838).
component("YMR169C",837).
component("U2_",130).
component("YER178W",471).
component("YBR221C",267).
component("YIL125W",622).
component("U52_",152).
component("YBR166C",260).
component("YNL280C",893).
component("YGL012W",496).
component("YKL182W",720).
component("U57_",157).
component("YKL216W",729).
component("YDR044W",353).
component("YER014W",436).
component("YKR009C",733).
component("YIL160C",627).
component("YGL205W",516).
component("YMR118C",832).
component("YLR164W",768).
component("YLL041C",744).
component("YKL148C",714).
component("YKL141W",712).
component("YJL045W",643).
component("YDR178W",380).
component("YJR051W",676).
component("YEL047C",430).
component("YDL171C",334).
component("YDL215C",339).
component("YOR375C",986).
component("YDL215C",340).
component("YAL062W",204).
component("U99_",197).
component("YBR035C",235).
component("YMR189W",840).
component("U56_",156).
component("YNR050C",908).
component("YHR037W",581).
component("YKR080W",737).
component("YER023W",438).
component("YPL023C",992).
component("YGL125W",508).
component("YOR236W",967).
component("YGR204W",552).
component("YLR142W",761).
component("U63_",163).
component("U62_",162).
component("YOR356W",983).
component("YHR068W",586).
component("YKL150W",715).
component("YIL043C",611).
component("YHR042W",582).
component("YOR221C",964).
component("YML120C",816).
component("YKL192C",724).
component("YKL055C",703).
component("YER061C",448).
component("YBR046C",238).
component("YMR145C",835).
component("YML120C",817).
component("YKL192C",725).
component("YDL085W",314).
component("YGR234W",555).
component("YFR030W",487).
component("YPL017C",991).
component("YFL018C",476).
component("YPL091W",998).
component("YDR353W",402).
component("YER042W",440).
component("YPR167C",1049).
component("YJR137C",689).
component("YNL052W",865).
component("YMR256C",849).
component("YLR395C",796).
component("YLR038C",750).
component("YIL111W",619).
...
component("Q0275",20).
component("Q0250",19).
component("YPL266W",1021).
component("YML110C",815).
component("YBR034C",234).
component("YPL273W",1023).
component("YLL062C",747).
component("YDR410C",411).
component("YOL096C",928).
component("U47_",147).
component("YER091C",462).
component("YJR073C",679).
component("YGR157W",541).
component("YDR120C",368).
component("YML008C",801).
component("YDL033C",305).
component("YOL096C",929).
component("YLR172C",769).
component("YDR019C",349).
component("YBR176W",261).
component("YDR408C",410).
component("YMR120C",833).
component("YBL013W",210).
component("YJL130C",653).
component("YKL024C",699).
component("YPR074C",1041).
component("YBR117C",249).
component("YLR354C",791).
component("YGR043C",528).
component("YMR108W",830).
component("YCL009C",281).
component("YMR062C",826).
component("YNL071W",867).
component("YNR008W",900).
component("YIL160C",628).
component("YNL277W",891).
component("YDR232W",383).
component("YFL017C",475).
component("YPL231W",1015).
component("YER061C",449).
component("U86_",185).
component("YPL001W",990).
component("YMR296C",856).
component("YDR062W",361).
component("YDL052C",308).
component("U8_",189).
component("YDR148C",376).
component("YAR035W",206).
component("YOR377W",987).
component("YGR177C",545).
component("YPL231W",1016).
component("YGR147C",539).
component("YDL040C",306).
component("YPL028W",993).
component("YLR195C",770).
component("YGL017W",497).
component("YPR001W",1028).
component("YNR001C",898).
component("YCR005C",292).
component("YNL104C",870).
component("YDL182W",336).
component("YDL131W",323).
component("YNL117W",872).
component("YIR031C",637).
component("YOR321W",974).
component("YJR143C",691).
component("YGR199W",550).
component("YDR307W",396).
component("YDL095W",318).
component("YDL093W",317).
component("YAL023C",200).
component("YLR258W",776).
component("YFR015C",483).
component("YOR103C",944).
component("YOR085W",942).
component("YMR149W",836).
component("YML019W",803).
component("YJL002C",640).
component("YEL002C",424).
component("YDL232W",342).
component("YCL043C",287).
component("YNL029C",862).
component("YIL085C",616).
component("YMR261C",850).
component("YML100W",813).
component("YBR126C",253).
component("YNL192W",880).
component("YBR038W",237).
component("YBR023C",233).
component("YMR306W",860).
component("YLR342W",789).
component("YGR032W",526).
component("YPR183W",1052).
component("YLR209C",771).
component("U104_",24).
component("U103_",23).
component("YMR271C",852).
component("YML106W",814).
component("YOR209C",962).
component("YMR300C",857).
component("YER055C",444).
component("YDR354W",403) :- not remove_orf("YDR354W",403).
component("YFR047C",489).
component("YJR133W",688).
component("YLR209C",772).
component("YML022W",804).
component("YDR441C",414).
component("YDR399W",406).
component("YHR128W",596).
component("YPR176C",1051).
component("YPL172C",1006).
component("YNR041C",906).
component("YMR101C",828).
component("YDL090C",316).
component("YBR003W",224).
component("YBR002C",223).
component("YJL167W",662).
component("YJL167W",663).
component("YNL256W",885).
component("YPR069C",1038).
component("YDR127W",371).
component("YLR146C",762).
component("YHR068W",587).
component("YLR303W",780).
component("YGR012W",524).
component("YJR130C",687).
component("YLR303W",781).
component("YDR035W",351).
component("YBR249C",270).
component("YOR274W",970).
component("YOL143C",936).
component("YBR256C",272).
component("YHR137W",597).
component("YGL202W",515).
component("YLR027C",748).
component("YKL106W",708).
component("YOL140W",935).
component("YLR438W",799).
component("YKL104C",707).
component("YGR019W",525).
component("YLR089C",756).
component("YDR111C",367).
component("U64_",164).
component("U61_",161).
component("U51_",151).
component("YJR148W",692).
component("YHR208W",605).
component("YFL030W",478).
component("YOR184W",956).
component("YNR058W",911).
component("YIL116W",621).
component("YGL253W",521).
component("YFR053C",490).
component("YOL136C",934).
component("YIL107C",618).
component("YMR013C",822).
component("YMR205C",842).
component("YGR240C",556).
component("YDR248C",386).
component("YCR036W",298).
component("YGR194C",549).
component("YCL040W",286).
component("YJR105W",685).
component("U16_",71).
component("U15_",62).
component("YPL188W",1008).
component("YJR049C",675).
component("YEL041W",428).
component("U96_",195).
component("YKL001C",697).
component("YDR236C",384).
component("YML070W",810).
component("YFL053W",480).
component("YHL032C",571).
component("YLR133W",758).
component("YDR531W",422).
component("U83_",182).
component("U82_",181).
component("U81_",180).
component("YMR208W",843).
component("YPL203W",1009).
component("YOR061W",939).
component("YKL166C",717).
component("YJL164C",660).
component("YIL035C",610).
component("YHR205W",604).
component("YHR102W",594).
component("YGL019W",498).
component("YHR025W",580).
component("YOR347C",981).
component("YAL038W",202).
component("YNR012W",901).
component("YPR121W",1046).
component("YPL258C",1018).
component("YOL055C",920).
component("YPL214C",1012).
component("U1_",102).
component("YDR009W",348).
component("YBR020W",231).
component("YNL267W",889).
component("YLR305C",783).
...
component("U17_",81).
component("U76_",175).
component("YMR220W",845).
component("YER170W",470).
component("YDR226W",382).
component("YKL067W",705).
component("YOL055C",921).
component("YDR454C",415).
component("YJR057W",677).
component("YOL061W",925).
component("YKL181W",719).
component("YHL011C",568).
component("YER099C",464).
component("YBL068W",219).
component("YOR143C",952).
component("YNL256W",886).
component("YLR328W",787).
component("YBR018C",227).
component("YBR018C",228).
component("YGR007W",523).
component("YGR202C",551).
component("YLR328W",788).
component("YKR002W",731).
component("U80_",179).
component("YDL103C",321).
component("U94_",194).
component("YJR010W",671).
component("YCL050C",288).
component("YGL130W",509).
component("YDR530C",421).
component("YCL050C",289).
component("YPR190C",1054).
component("YPR187W",1053).
component("YPR110C",1044).
component("YPR010C",1031).
component("YOR341W",980).
component("YOR340C",979).
component("YOR224C",966).
component("YOR210W",963).
component("YOR207C",960).
component("YOR151C",953).
component("YOR116C",945).
component("YOL005C",913).
component("YNR003C",899).
component("YNL248C",884).
component("YNL151C",877).
component("YNL113W",871).
component("YKL144C",713).
component("YJR063W",678).
component("YJL148W",657).
component("YJL140W",656).
...
component("YPR175W",1050).
component("YPL167C",1005).
component("YOR330C",976).
component("YOL115W",932).
component("YNL299W",895).
component("YNL262W",888).
component("YNL102W",869).
component("YJR043C",674).
component("YJR006W",670).
component("YJL090C",647).
component("YIL139C",624).
...
component("YKL035W",702).
component("YHL012W",569).
component("YHR123W",595).
component("YPR113W",1045).
component("YBR243C",268).
component("YNL130C",873).
component("YDL142C",329).
component("YPL148C",1003).
component("YER026C",439).
component("YCL004W",280).
component("YOR251C",969).
component("YGR286C",565).
component("YJL068C",644).
component("YDR058C",359).
component("YNR034W",905).
component("YHR163W",600).
component("YGR248W",558).
component("YCR073W-A",300).
component("YDL086W",315).
component("YOL011W",915).
component("YMR008C",820).
component("YMR006C",819).
component("U105_",25).
component("U101_",21).
component("YBL015W",211).
component("YJL068C",645).
component("YPL072W",997).
component("YOR124C",946).
component("YNL186W",879).
component("YMR304W",859).
component("YMR223W",846).
component("YKR098C",741).
component("YJL197W",664).
component("YIL156W",626).
...
component("YLR377C",794).
component("YDR074W",363).
component("YFR025C",485).
component("YPL179W",1007).
component("YNR032W",903).
component("YML057W",809).
component("YML016C",802).
component("YLR433C",798).
...
component("YPL228W",1013).
component("YMR180C",839).
component("YDL236W",343).
component("YJL155C",659).
component("YPR073C",1040).
component("YOR208W",961).
component("YNL053W",866).
component("YMR036C",825).
component("YIR026C",633).
component("YIL113W",620).
...
component("U25_",127).
component("U24_",126).
component("YOL064C",926).
component("YPL268W",1022).
component("YOR360C",984).
component("YGL248W",520).
component("YKR031C",734).
component("YPL206C",1010).
component("YGL027C",500).
component("YLR286C",778).
component("YJR153W",694).
component("YJL221C",669).
component("YJL216C",667).
component("YIL172C",632).
component("YGR292W",567).
component("YGR287C",566).
component("YBR299W",279).
component("YBR184W",262).
component("YIL162W",629).
component("YPR026W",1032).
component("YDR001C",346).
component("YBR001C",222).
component("YOR190W",958).
component("YLR300W",779).
component("YGR282C",564).
component("YDR261C",388).
component("YDR400W",407).
component("U23_",125).
component("YML035C",805).
component("YJL070C",646).
component("YBR284W",276).
component("U102_",22).
component("YER043C",441).
component("YNL045W",864).
component("YLR160C",767).
component("YLR158C",766).
component("YLR157C",765).
component("YLR155C",764).
component("YDR321W",397).
component("YGL037C",501).
component("U43_",143).
component("U42_",142).
component("YMR293C",855).
component("YDR242W",385).
component("YLR308W",786).
component("YLR307W",785).
component("YBR208C",264).
component("YMR281W",854).
component("U53_",153).
component("YIR027C",634).
component("YPL111W",1001).
component("YIR032C",638).
component("YIR029W",636).
component("YPR062W",1037).
component("YMR120C",834).
component("YLR028C",749).
component("YHR144C",599).
component("YGR267C",563).
component("YCL030C",284).
component("YNL141W",874).
component("YBL033C",212).
component("YBR153W",258).
component("YDL238C",344).
component("YNL141W",875).
component("YLR245C",775).
component("YML035C",806).
component("YBR084W",243).
component("YJL126W",651).
component("U44_",144).
component("YDL100C",319).
component("U87_",186).
component("U40_",140).
component("YMR267W",851).
component("YBR011C",226).
component("YHR201C",603).
component("YBR111C",247).
component("YBR252W",271).
component("YCL030C",285).
component("YPR080W",1042).
component("YOR187W",957).
component("YOR133W",949).
component("YLR069C",754).
component("YKR084C",738).
component("YKL173W",718).
component("YJL102W",649).
component("YDR385W",405).
component("YBR118W",250).
component("YER005W",435).
component("YLL001W",742).
...
component("U60_",160).
component("YLR231C",773).
component("U88_",187).
component("YLR134W",759).
component("YLR044C",751).
component("YGR087C",532).
component("YDR380W",404).
component("YDL080C",313).
component("U98_",196).
component("YMR250W",848).
component("YKL184W",723).
component("YOR128C",947).
component("YEL021W",427).
component("YNR043W",907).
component("U93_",193).
component("YDR047W",356).
component("U54_",154).
component("YKL211C",727) :- not remove_orf("YKL211C",727).
component("YKR097W",740).
component("YOL052C",919).
component("YNL169C",878).
component("YGR170W",542).
component("YKL060C",704).
component("YNL256W",887).
component("YDR294C",392).
component("YEL046C",429).
component("YNR033W",904).
component("YPR006C",1030).
component("YER065C",451).
component("YKL211C",728) :- not remove_orf("YKL211C",728).
component("YER090W",728) :- not remove_orf("YER090W",728).
component("YER090W",461) :- not remove_orf("YER090W",461).
component("YDR127W",373).
component("YPL281C",1027).
component("YOR393W",989).
component("YMR323W",861).
component("YHR174W",601).
component("YGR254W",559).
component("YPL262W",1019).
component("YGL026C",499) :- not remove_orf("YGL026C",499).
component("YGR155W",540).
component("YLR304C",782).
component("YJL200C",665).
component("YNL316C",896).
component("YKL182W",721).
component("YPL212C",1011).
component("YNL292W",894).
component("YGL063W",505).
component("YFL001W",473).
component("YOR278W",971).
component("YPR002W",1029).
component("U49_",148).
component("YJR016C",672).
component("YCR053W",299).
component("YDR127W",374).
component("YGL148W",510).
component("YIL168W",631).
component("YIL167W",630).
component("YCL064C",290).
component("YER086W",458).
component("YCL064C",291).
component("YLR359W",793).
component("YAL012W",199).
component("YFR055W",491).
component("YJL005W",641).
component("YOR176W",955).
component("YJL121C",650).
component("YBR019C",229).
component("YBR019C",230).
component("YDR050C",357).
component("YDR007W",347) :- not remove_orf("YDR007W",347).
component("YOR095C",943).
component("YER003C",434).
component("YBR196C",263).
component("YGL001C",493).
component("U14_",54).
component("YOL056W",922).
component("YKL152C",716).
component("YDL021W",302).
component("YMR105C",829).
component("YKL127W",710).
component("YEL058W",432).
component("YPR060C",1036).
component("YHR072W",588).
component("YJL153C",658).
component("YPL097W",999).
component("YGR185C",548).
component("YGR264C",562).
component("YGR171C",543).
component("YHR011W",576).
component("YDR023W",350).
component("YPL104W",1000).
component("YLL018C",743).
component("YPR081C",1043).
component("YBR121C",251).
component("YHR020W",579).
component("YER087W",459).
component("YNL247W",883).
component("YOL033W",917).
component("YGL245W",519).
component("YHR091C",590).
component("YDR341C",398).
component("YOL097C",930).
component("YDR268W",389).
component("YPR047W",1035).
component("YLR060W",753).
component("YFL022C",477).
component("YPR033C",1033).
component("YHR019C",577).
component("YCR024C",295).
component("YHR019C",578).
component("YPL160W",1004).
component("YLR382C",795).
component("YNL073W",868).
component("YDR037W",352).
component("YOR335C",977).
component("YGR094W",534).
component("YLR153C",763).
component("YAL054C",203).
component("YOR317W",973).
component("YMR246W",847).
component("YIL009W",608).
component("YER015W",437).
component("YOR142W",951).
component("YGR244C",557).
component("YPR035W",1034).
component("U89_",188).
component("YOR241W",968).
component("YMR113W",831).
component("YKL132C",711).
component("YOR339C",978).
component("YMR022W",824).
component("YLR306W",784).
component("YKL210W",726).
...
component("YJL101C",648).
component("YOL049W",918).
component("U92_",192).
...
component("U91_",191).
component("U90_",190).
component("YNR057C",910).
component("YDL141W",326).
component("YDL141W",327).
component("YGL234W",518).
component("YDL141W",328).
component("YJR103W",683).
component("YBL039C",214).
component("YGR204W",553).
component("YBR084W",244).
component("YNL220W",881).
component("YOL058W",923).
component("YBR208C",265).
component("YHR074W",589).
component("YMR217W",844).
component("YGR061C",531).
component("YPR145W",1048).
component("YGR124W",537).
component("YOR303W",972).
component("YJR109C",686).
component("YJL130C",654).
component("YGL062W",504).
component("YBR218C",266).
component("YPL231W",1017).
component("YNR016C",902).
component("YKL182W",722).
component("YGR037C",527).
component("YOR005C",938).
component("YDL164C",331).
component("YOL010W",914).
component("YPR138C",1047).
component("YPL274W",1024).
component("YPL265W",1020).
component("YPL134C",1002).
component("YPL057C",995).
component("YPL036W",994).
component("YOR348C",982).
component("YOR222W",965).
component("YOR192C",959).
component("YOR171C",954).
component("YOR130C",948).
component("YOR071C",941).
component("YOL156W",937).
component("YOL103W",931).
component("YOL020W",916) :- not remove_orf("YOL020W",916).
component("YNR072W",912).
component("YNR056C",909).
component("YNL318C",897).
component("YNL268W",890).
component("YNL142W",876).
component("YMR272C",853).
component("YMR202W",841).
component("YMR011W",821).
component("YML123C",818).
component("YLR348C",790).
component("YLR260W",777).
component("YLR237W",774).
component("YLR138W",760).
component("YLR100C",757).
component("YLR081W",755).
component("YLL061W",746).
component("YLL043W",745).
component("YKR093W",739).
component("YKR053C",736).
component("YKR039W",735) :- not remove_orf("YKR039W",735).
component("YKL217W",730).
component("YKL120W",709).
component("YKL004W",698).
component("YJR158W",695).
component("YJR152W",693).
component("YJR095W",682).
component("YJR077C",680).
component("YJL219W",668).
component("YJL214W",666).
component("YJL134W",655).
component("YJL129C",652).
component("YIR028W",635).
component("YIL134W",623).
...
catalyst(1960,356).
catalyst(3460,154).
catalyst(3600,727) :- not remove_reaction(3600,727).
catalyst(8000,740).
catalyst(3941,919).
catalyst(3942,919).
catalyst(6890,878).
...
catalyst(8020,1030).
catalyst(8020,451).
catalyst(1890,728) :- not remove_reaction(1890,728).
catalyst(3630,728) :- not remove_reaction(3630,728).
...
catalyst(1210,937).
catalyst(1160,931).
catalyst(801,916) :- not remove_reaction(801,916).
catalyst(802,916) :- not remove_reaction(802,916).
catalyst(811,916) :- not remove_reaction(811,916).
catalyst(812,916) :- not remove_reaction(812,916).
catalyst(831,916) :- not remove_reaction(831,916).
catalyst(832,916) :- not remove_reaction(832,916).
catalyst(901,916) :- not remove_reaction(901,916).
catalyst(902,916) :- not remove_reaction(902,916).
catalyst(941,916) :- not remove_reaction(941,916).
catalyst(942,916) :- not remove_reaction(942,916).
catalyst(1170,912).
catalyst(1180,912).
catalyst(1210,912).
catalyst(700,909).
...
catalyst(650,739).
catalyst(6560,736).
catalyst(761,735) :- not remove_reaction(761,735).
catalyst(762,735) :- not remove_reaction(762,735).
catalyst(771,735) :- not remove_reaction(771,735).
catalyst(772,735) :- not remove_reaction(772,735).
catalyst(781,735) :- not remove_reaction(781,735).
catalyst(782,735) :- not remove_reaction(782,735).
catalyst(791,735) :- not remove_reaction(791,735).
catalyst(792,735) :- not remove_reaction(792,735).
catalyst(801,735) :- not remove_reaction(801,735).
catalyst(802,735) :- not remove_reaction(802,735).
catalyst(811,735) :- not remove_reaction(811,735).
catalyst(812,735) :- not remove_reaction(812,735).
catalyst(821,735) :- not remove_reaction(821,735).
catalyst(822,735) :- not remove_reaction(822,735).
catalyst(831,735) :- not remove_reaction(831,735).
catalyst(832,735) :- not remove_reaction(832,735).
catalyst(841,735) :- not remove_reaction(841,735).
catalyst(842,735) :- not remove_reaction(842,735).
catalyst(861,735) :- not remove_reaction(861,735).
catalyst(862,735) :- not remove_reaction(862,735).
catalyst(881,735) :- not remove_reaction(881,735).
catalyst(882,735) :- not remove_reaction(882,735).
catalyst(901,735) :- not remove_reaction(901,735).
catalyst(902,735) :- not remove_reaction(902,735).
catalyst(911,735) :- not remove_reaction(911,735).
catalyst(912,735) :- not remove_reaction(912,735).
catalyst(921,735) :- not remove_reaction(921,735).
catalyst(922,735) :- not remove_reaction(922,735).
catalyst(941,735) :- not remove_reaction(941,735).
catalyst(942,735) :- not remove_reaction(942,735).
catalyst(1191,735) :- not remove_reaction(1191,735).
catalyst(1192,735) :- not remove_reaction(1192,735).
catalyst(390,730).
catalyst(1021,730).
catalyst(1022,730).
catalyst(1521,709).
...
modifiable_enzyme(728).
modifiable_enzyme(461).
modifiable_enzyme(499).
modifiable_enzyme(347).
modifiable_enzyme(916).
modifiable_enzyme(735).
