...
component("YNL280C",707).
component("YLR056W",594).
component("YGR060W",417).
component("YGL012W",387).
component("YKR009C",577).
component("YOL086C",738).
component("YMR303C",677).
component("YMR083W",652).
component("YGL256W",409).
component("YDL168W",252).
component("YBR145W",190).
component("YPL231W",807).
component("U46_",106).
component("YBR149W",191).
component("YJR159W",548).
component("YGL001C",384).
component("YIL094C",487).
component("YHR063C",465).
component("YBR153W",192).
component("YML056C",637).
component("YLR432W",630).
component("YHR216W",479).
component("YAR075W",153).
component("YAR073W",152).
component("YCL030C",215).
component("YDR127W",281).
component("YJR139C",542).
component("YOL126C",743).
component("YDL078C",233).
component("YKL029C",553).
component("YOR136W",754).
component("YNL037C",682).
component("YDL066W",232).
component("YNL241C",697).
component("YOL059W",736).
component("YDL022W",227).
component("YLR355C",626).
component("YML054C",636).
component("YDL174C",254).
component("YML086C",640).
component("YIL155C",493).
component("YPR191W",841).
component("YOR065W",748).
component("YJL166W",518).
component("YHR001W-A",454).
component("YGR183C",432).
component("YFR033C",380).
component("YDR529C",326).
component("YBL045C",159).
component("Q0105",18).
component("YGR088W",420).
component("YDR256C",296).
component("YKL026C",552).
component("YIR037W",501).
component("YBR244W",203).
component("YJR078W",533).
component("YJR025C",526).
component("YGR255C",444).
component("U108_",22).
component("YBL098W",163).
component("YMR015C",649).
component("YHR007C",455).
component("YDR402C",315).
component("YGL055W",392).
component("YGR175C",429).
component("YJR104C",536).
component("YHR008C",456).
component("YJL026W",502).
component("YIL066C",485).
component("YGR180C",431).
component("YER070W",352).
component("U38_",102).
component("U36_",101).
component("U35_",100).
...
component("YPL276W",819).
component("YPL275W",818).
component("YOR388C",786).
component("YOR374W",783).
component("YER073W",353).
component("U68_",120).
component("YGL154C",400).
component("U55_",114).
component("YOR323C",775).
component("YMR170C",661).
component("YMR169C",660).
component("U2_",96).
component("YER178W",367).
component("YBR221C",201).
component("YIL125W",491).
component("U52_",111).
component("YBR166C",195).
component("YNL280C",708).
component("YGL012W",388).
component("U57_",115).
component("YKL216W",574).
component("YDR044W",270).
component("YER014W",338).
component("YKR009C",578).
component("YIL160C",495).
component("YGL205W",403).
component("YMR118C",657).
component("YLR164W",607).
component("YLL041C",587).
component("YKL148C",564).
component("YKL141W",562).
component("YJL045W",503).
component("YDR178W",290).
component("YJR051W",528).
component("YEL047C",332).
component("YDL215C",258).
component("YOR375C",784).
component("YDL215C",259).
component("YAL062W",150).
component("U99_",145).
component("YBR035C",176).
component("YMR189W",663).
component("YHR037W",462).
component("YKR080W",582).
component("YER023W",340).
component("YPL023C",790).
component("YGL125W",397).
component("YOR236W",769).
component("YGR204W",436).
component("YLR142W",602).
component("U62_",118).
component("YKL150W",565).
component("YIL043C",482).
component("YHR042W",463).
component("YOR221C",767).
component("YML120C",643).
component("YKL192C",571).
component("YKL055C",555).
component("YER061C",348).
component("YGR234W",439).
component("YFR030W",379).
component("YPL017C",789).
component("YFL018C",371).
component("YER042W",342).
component("YJR137C",541).
component("YPL266W",814).
component("YML110C",642).
component("YBR034C",175).
component("YPL273W",816).
component("YLL062C",590).
component("YDR410C",318).
component("U47_",107).
component("YER091C",359).
component("YJR073C",531).
component("YDL033C",229).
component("YOL096C",739).
component("YLR172C",608).
component("YDR019C",266).
component("YBR176W",196).
component("YDR408C",317).
component("YMR120C",658).
component("YBL013W",154).
component("YKL024C",551).
component("YPR074C",831).
component("YBR117C",186).
component("YLR354C",625).
component("YGR043C",415).
component("YMR108W",655).
component("YCL009C",213).
component("YMR062C",651).
component("YNL071W",685).
component("YNR008W",715).
component("YNL277W",706).
component("YFL017C",370).
component("YPL231W",808).
component("YER061C",349).
component("U86_",135).
component("YPL001W",788).
component("YDR148C",287).
component("YOR377W",785).
component("YGR177C",430).
component("YPL231W",809).
component("YGR147C",425).
component("YDL040C",230).
component("YPL028W",791).
component("YGL017W",389).
component("YPR001W",821).
component("YNR001C",713).
component("YDL182W",255).
component("YDL131W",243).
component("YNL117W",689).
component("YIR031C",499).
component("YOR321W",774).
component("YJR143C",543).
component("YGR199W",435).
component("YDR307W",305).
component("YDL095W",238).
component("YDL093W",237).
component("YAL023C",147).
component("YNL029C",681).
component("YIL085C",486).
component("YMR261C",671).
component("YML100W",641).
component("YBR126C",189).
component("YNL192W",696).
component("YBR038W",178).
component("YBR023C",174).
component("YMR306W",679).
component("YLR342W",623).
component("YGR032W",413).
component("YLR209C",609).
component("U104_",21).
component("YOR209C",765).
component("YMR300C",676).
component("YER055C",344).
component("YDR354W",311) :- not remove_orf("YDR354W",311).
component("YFR047C",381).
component("YJR133W",540).
component("YLR209C",610).
component("YML022W",633).
component("YDR441C",321).
component("YDR399W",313).
component("YPR176C",838).
component("YPL172C",801).
component("YNR041C",721).
component("YMR101C",653).
component("YDL090C",236).
component("YBR003W",165).
component("YBR002C",164).
component("YJL167W",519).
component("YNL256W",700).
component("YDR127W",282).
component("YLR303W",617).
component("YGR012W",411).
component("YJR130C",539).
component("YLR303W",618).
component("YDR035W",268).
component("YBR249C",204).
component("YOL143C",745).
component("YBR256C",206).
component("YHR137W",473).
component("YGL202W",402).
component("YLR027C",591).
component("YKL106W",559).
component("YKL104C",558).
component("YGR019W",412).
component("YLR089C",597).
component("U64_",119).
component("U61_",117).
component("U51_",110).
component("YJR148W",544).
component("YOR184W",760).
component("YNR058W",724).
component("YIL116W",490).
component("YGL253W",408).
component("YFR053C",382).
component("YOL136C",744).
component("YIL107C",488).
component("YMR013C",648).
component("YMR205C",664).
component("YGR240C",440).
component("YDR248C",295).
component("YCR036W",223).
component("YGR194C",434).
component("YCL040W",217).
component("YJR105W",537).
component("U16_",51).
component("U15_",45).
component("U96_",143).
component("YKL001C",549).
component("YDR236C",293).
component("YML070W",639).
component("YFL053W",374).
component("YHL032C",452).
component("YLR133W",599).
component("YDR531W",328).
component("U83_",133).
component("U82_",132).
component("U81_",131).
component("YMR208W",665).
component("YHR025W",461).
component("YOR347C",780).
component("YAL038W",149).
component("YNR012W",716).
component("YPR121W",834).
component("YPL258C",811).
component("YOL055C",732).
component("YPL214C",805).
component("U1_",74).
component("YDR009W",265).
component("YBR020W",172).
component("YNL267W",704).
component("YLR305C",620).
component("YFR019W",377).
...
component("U17_",59).
component("U76_",128).
component("YMR220W",667).
component("YER170W",366).
component("YDR226W",292).
component("YKL067W",557).
component("YOL055C",733).
component("YDR454C",322).
component("YJR057W",529).
component("YOL061W",737).
component("YKL181W",567).
component("YHL011C",449).
component("YER099C",361).
component("YBL068W",162).
component("YOR143C",756).
component("YNL256W",701).
component("YLR328W",621).
component("YBR018C",168).
component("YBR018C",169).
component("YGR007W",410).
component("YLR328W",622).
component("YKR002W",576).
component("YDL103C",241).
component("YJR010W",525).
component("YGL130W",398).
component("YDR530C",327).
component("YCL050C",218).
component("YPR190C",840).
component("YPR187W",839).
component("YPR110C",833).
component("YPR010C",824).
component("YOR341W",779).
component("YOR340C",778).
component("YOR224C",768).
component("YOR210W",766).
component("YOR207C",763).
component("YOR151C",757).
component("YOR116C",751).
component("YOL005C",726).
component("YNR003C",714).
component("YNL248C",699).
component("YNL151C",693).
component("YNL113W",688).
component("YKL144C",563).
component("YJR063W",530).
component("YJL148W",515).
component("YJL140W",514).
component("YIL021W",481).
component("YHR143W-A",474).
component("YGL070C",395).
component("YFL036W",373).
component("YDR404C",316).
component("YDR156W",288).
component("YDR045C",271).
component("YDL150W",250).
component("YDL140C",245).
component("YBR154C",194).
component("YPR175W",837).
component("YPL167C",800).
component("YOR330C",776).
component("YOL115W",742).
component("YNL299W",710).
component("YNL262W",703).
component("YNL102W",687).
component("YJR043C",527).
component("YJR006W",524).
component("YJL090C",507).
component("YIL139C",492).
component("YEL055C",333).
component("YDR419W",319).
component("YDR121W",280).
component("YDL102W",240).
component("YCR014C",220).
component("YBR278W",208).
component("YBL035C",156).
component("YKL035W",554).
component("YHL012W",450).
component("YHR123W",472).
component("YBR243C",202).
component("YDL142C",249).
component("YPL148C",798).
component("YER026C",341).
component("YCL004W",212).
component("YGR286C",448).
component("YJL068C",504).
component("YDR058C",275).
component("YNR034W",720).
component("YHR163W",476).
component("YGR248W",442).
component("YCR073W-A",224).
component("YDL086W",235).
component("YOL011W",728).
component("YMR008C",646).
component("YMR006C",645).
component("U101_",19).
component("YBL015W",155).
component("YJL068C",505).
component("YPL072W",794).
component("YOR124C",752).
component("YNL186W",695).
component("YMR304W",678).
component("YMR223W",668).
component("YKR098C",585).
component("YJL197W",520).
component("YIL156W",494).
component("YFR010W",376).
component("YER151C",364).
component("YER144C",363).
component("YER098W",360).
...
component("U84_",134).
component("YLR377C",628).
component("YDR074W",277).
component("YPL179W",802).
component("YNR032W",718).
component("YML057W",638).
component("YML016C",632).
component("YLR433C",631).
component("YGR123C",423).
component("YER133W",362).
component("YER089C",357).
component("YDR436W",320).
...
component("YPR073C",829).
component("YHR215W",478).
component("YDL024C",228).
component("YBR093C",184).
component("YBR092C",183).
component("YAR071W",151).
component("YIL053W",484).
component("YER062C",350).
component("YHR046C",464).
component("YGR208W",438).
component("YPL228W",806).
component("YMR180C",662).
component("YDL236W",261).
component("YJL155C",517).
component("YPR073C",830).
component("YOR208W",764).
component("YNL053W",684).
component("YMR036C",650).
component("YIR026C",496).
component("YIL113W",489).
component("YFR028C",378).
component("YER075C",354).
...
component("U25_",93).
component("U24_",92).
component("YPL268W",815).
component("YOR360C",782).
component("YGL248W",407).
component("YKR031C",579).
component("YPL206C",803).
component("YLR286C",615).
component("YJR153W",546).
component("YOR190W",761).
component("YLR300W",616).
component("YGR282C",447).
component("YDR261C",297).
component("YDR400W",314).
component("U23_",91).
component("YML035C",634).
component("YJL070C",506).
component("YBR284W",209).
component("U102_",20).
component("YNL045W",683).
component("YLR160C",606).
component("YLR158C",605).
component("YLR157C",604).
component("YLR155C",603).
component("YDR321W",306).
component("YGL037C",391).
component("YMR293C",675).
component("YDR242W",294).
component("YBR208C",198).
component("YMR281W",674).
component("U53_",112).
component("YIR027C",497).
component("YPL111W",797).
component("YIR032C",500).
component("YIR029W",498).
component("YPR062W",828).
component("YMR120C",659).
component("YLR028C",592).
component("YHR144C",475).
component("YGR267C",446).
component("YNL141W",690).
component("YBR153W",193).
component("YDL238C",262).
component("YNL141W",691).
component("YLR245C",613).
component("YML035C",635).
component("YJL126W",510).
component("U44_",105).
component("YDL100C",239).
component("U87_",136).
component("YMR267W",672).
component("YBR011C",167).
component("YBR111C",185).
component("YBR252W",205).
component("YCL030C",216).
component("YER005W",337).
component("YIL048W",483).
component("YER166W",365).
component("YDR093W",279).
component("YAL026C",148).
component("YLR231C",611).
component("U88_",137).
component("YLR134W",600).
component("YLR044C",593).
component("YGR087C",419).
component("YDR380W",312).
component("YDL080C",234).
component("U98_",144).
component("YMR250W",670).
component("YKL184W",570).
component("YNR043W",722).
component("U93_",142).
component("YDR047W",273).
component("U54_",113).
component("YKL211C",572) :- not remove_orf("YKL211C",572).
component("YKR097W",584).
component("YOL052C",731).
component("YNL169C",694).
component("YGR170W",427).
component("YKL060C",556).
component("YNL256W",702).
component("YDR294C",301).
component("YEL046C",331).
component("YNR033W",719).
component("YPR006C",823).
component("YER065C",351).
component("YKL211C",573) :- not remove_orf("YKL211C",573).
component("YER090W",573) :- not remove_orf("YER090W",573).
component("YER090W",358) :- not remove_orf("YER090W",358).
component("YDR127W",284).
component("YPL281C",820).
component("YOR393W",787).
component("YMR323W",680).
component("YHR174W",477).
component("YGR254W",443).
component("YPL262W",812).
component("YGL026C",390) :- not remove_orf("YGL026C",390).
component("YGR155W",426).
component("YLR304C",619).
component("YJL200C",521).
component("YNL316C",711).
component("YKL182W",568).
component("YPL212C",804).
component("YNL292W",709).
component("YGL063W",394).
component("YFL001W",368).
component("YOR278W",771).
component("YPR002W",822).
component("YDR127W",285).
component("YGL148W",399).
component("YER086W",355).
component("YLR359W",627).
component("YAL012W",146).
component("YFR055W",383).
component("YOR176W",759).
component("YJL121C",509).
component("YBR019C",170).
component("YBR019C",171).
component("YDR050C",274).
component("YDR007W",264) :- not remove_orf("YDR007W",264).
component("YOR095C",750).
component("YER003C",336).
component("YBR196C",197).
component("YGL001C",385).
component("U14_",38).
component("YOL056W",734).
component("YKL152C",566).
component("YDL021W",226).
component("YMR105C",654).
component("YKL127W",560).
component("YEL058W",334).
component("YPR060C",827).
component("YHR072W",466).
component("YJL153C",516).
component("YPL097W",795).
component("YGR185C",433).
component("YGR264C",445).
component("YGR171C",428).
component("YHR011W",457).
component("YDR023W",267).
component("YPL104W",796).
component("YLL018C",586).
component("YPR081C",832).
component("YBR121C",187).
component("YHR020W",460).
component("YER087W",356).
component("YNL247W",698).
component("YOL033W",730).
component("YGL245W",406).
component("YHR091C",468).
component("YDR341C",307).
component("YOL097C",740).
component("YDR268W",298).
component("YPR047W",826).
component("YLR060W",595).
component("YFL022C",372).
component("YPR033C",825).
component("YHR019C",458).
component("YHR019C",459).
component("YPL160W",799).
component("YLR382C",629).
component("YNL073W",686).
component("YDR037W",269).
component("YOR335C",777).
component("YGR094W",421).
component("YOR317W",773).
component("YMR246W",669).
component("YIL009W",480).
component("YER015W",339).
component("YOR142W",755).
component("YGR244C",441).
component("U89_",138).
component("YOR241W",770).
component("YMR113W",656).
component("YKL132C",561).
component("YJL101C",508).
component("U92_",141).
...
component("YJR103W",535).
component("YBL039C",157).
component("YGR204W",437).
component("YBR084W",182).
component("YOL058W",735).
component("YBR208C",199).
component("YHR074W",467).
component("YMR217W",666).
component("YGR061C",418).
component("YPR145W",836).
component("YGR124W",424).
component("YOR303W",772).
component("YJR109C",538).
component("YJL130C",512).
component("YGL062W",393).
component("YBR218C",200).
component("YPL231W",810).
component("YNR016C",717).
component("YKL182W",569).
component("YGR037C",414).
component("YOR005C",747).
component("YDL164C",251).
component("YOL010W",727).
component("YPR138C",835).
component("YPL274W",817).
component("YPL265W",813).
component("YPL057C",793).
component("YPL036W",792).
component("YOR348C",781).
component("YOR192C",762).
component("YOR171C",758).
component("YOR130C",753).
component("YOR071C",749).
component("YOL156W",746).
component("YOL103W",741).
component("YOL020W",729) :- not remove_orf("YOL020W",729).
component("YNR072W",725).
component("YNR056C",723).
component("YNL318C",712).
component("YNL268W",705).
component("YNL142W",692).
component("YMR272C",673).
component("YMR011W",647).
component("YML123C",644).
component("YLR348C",624).
component("YLR260W",614).
component("YLR237W",612).
component("YLR138W",601).
component("YLR100C",598).
component("YLR081W",596).
component("YLL061W",589).
component("YLL043W",588).
component("YKR093W",583).
component("YKR053C",581).
component("YKR039W",580) :- not remove_orf("YKR039W",580).
component("YKL217W",575).
component("YKL004W",550).
component("YJR158W",547).
component("YJR152W",545).
component("YJR095W",534).
component("YJR077C",532).
component("YJL219W",523).
component("YJL214W",522).
component("YJL134W",513).
component("YJL129C",511).
component("YHR096C",471).
component("YHR094C",470).
component("YHR092C",469).
component("YHL036W",453).
component("YHL016C",451).
component("YGR121C",422).
component("YGR055W",416).
component("YGL186C",401).
component("YGL077C",396).
component("YGL008C",386).
component("YFL055W",375).
component("YFL011W",369).
component("YER060W-A",347).
component("YER060W",346).
component("YER056C",345).
component("YER053C",343).
component("YEL069C",335).
component("YEL017C-A",330).
component("YDR536W",329).
component("YDR508C",325).
component("YDR503C",324).
component("YDR497C",323).
...
catalyst(6160,676).
catalyst(3870,344).
catalyst(3620,311) :- not remove_reaction(3620,311).
catalyst(2110,381).
catalyst(2190,381).
catalyst(5550,540).
catalyst(5791,610).
...
catalyst(1960,273).
catalyst(3460,113).
catalyst(3600,572) :- not remove_reaction(3600,572).
catalyst(8000,584).
catalyst(3941,731).
catalyst(3942,731).
catalyst(6890,694).
...
catalyst(8020,823).
catalyst(8020,351).
catalyst(1890,573) :- not remove_reaction(1890,573).
catalyst(3630,573) :- not remove_reaction(3630,573).
catalyst(1890,358) :- not remove_reaction(1890,358).
catalyst(3630,358) :- not remove_reaction(3630,358).
catalyst(3740,284).
catalyst(8231,820).
catalyst(8232,820).
catalyst(8231,787).
...
catalyst(8051,812).
catalyst(8052,812).
catalyst(3590,390) :- not remove_reaction(3590,390).
catalyst(10910,390) :- not remove_reaction(10910,390).
catalyst(4570,426).
catalyst(8181,619).
catalyst(8182,619).
catalyst(8181,521).
...
catalyst(1210,746).
catalyst(1160,741).
catalyst(801,729) :- not remove_reaction(801,729).
catalyst(802,729) :- not remove_reaction(802,729).
catalyst(811,729) :- not remove_reaction(811,729).
catalyst(812,729) :- not remove_reaction(812,729).
catalyst(831,729) :- not remove_reaction(831,729).
catalyst(832,729) :- not remove_reaction(832,729).
catalyst(901,729) :- not remove_reaction(901,729).
catalyst(902,729) :- not remove_reaction(902,729).
catalyst(941,729) :- not remove_reaction(941,729).
catalyst(942,729) :- not remove_reaction(942,729).
catalyst(1210,725).
catalyst(700,723).
catalyst(1200,712).
catalyst(761,705).
...
catalyst(640,583).
catalyst(6560,581).
catalyst(761,580) :- not remove_reaction(761,580).
catalyst(762,580) :- not remove_reaction(762,580).
catalyst(771,580) :- not remove_reaction(771,580).
catalyst(772,580) :- not remove_reaction(772,580).
catalyst(781,580) :- not remove_reaction(781,580).
catalyst(782,580) :- not remove_reaction(782,580).
catalyst(791,580) :- not remove_reaction(791,580).
catalyst(792,580) :- not remove_reaction(792,580).
catalyst(801,580) :- not remove_reaction(801,580).
catalyst(802,580) :- not remove_reaction(802,580).
catalyst(811,580) :- not remove_reaction(811,580).
catalyst(812,580) :- not remove_reaction(812,580).
catalyst(821,580) :- not remove_reaction(821,580).
catalyst(822,580) :- not remove_reaction(822,580).
catalyst(831,580) :- not remove_reaction(831,580).
catalyst(832,580) :- not remove_reaction(832,580).
catalyst(841,580) :- not remove_reaction(841,580).
catalyst(842,580) :- not remove_reaction(842,580).
catalyst(861,580) :- not remove_reaction(861,580).
catalyst(862,580) :- not remove_reaction(862,580).
catalyst(881,580) :- not remove_reaction(881,580).
catalyst(882,580) :- not remove_reaction(882,580).
catalyst(901,580) :- not remove_reaction(901,580).
catalyst(902,580) :- not remove_reaction(902,580).
catalyst(911,580) :- not remove_reaction(911,580).
catalyst(912,580) :- not remove_reaction(912,580).
catalyst(941,580) :- not remove_reaction(941,580).
catalyst(942,580) :- not remove_reaction(942,580).
catalyst(1191,580) :- not remove_reaction(1191,580).
catalyst(1192,580) :- not remove_reaction(1192,580).
catalyst(1021,575).
catalyst(1022,575).
catalyst(6610,550).
catalyst(1210,547).
