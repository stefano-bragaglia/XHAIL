...
component("YNL280C",493).
component("YGR060W",295).
component("YGL012W",275).
component("YOL086C",512).
component("YMR303C",472).
component("YGL256W",289).
component("YDL168W",177).
component("YBR145W",137).
component("YPL231W",561).
component("YBR149W",138).
component("YGL001C",272).
component("YIL094C",338).
component("YHR063C",323).
component("YBR153W",139).
component("YML056C",448).
component("YLR432W",444).
component("YHR216W",332).
component("YAR075W",109).
component("YAR073W",108).
component("YDR127W",195).
component("YJR139C",382).
component("YOL126C",516).
component("YDL078C",167).
component("YKL029C",386).
component("YOR136W",525).
component("YDL066W",166).
component("YLR355C",441).
component("YML086C",450).
component("YIL155C",341).
component("YPR191W",587).
component("YOR065W",520).
component("YJL166W",361).
component("YHR001W-A",318).
component("YGR183C",305).
component("YFR033C",268).
component("YDR529C",227).
component("YBL045C",115).
component("Q0105",18).
component("YGR088W",297).
component("YDR256C",208).
component("YJR078W",373).
component("YJR025C",368).
component("YGR255C",312).
component("YBL098W",118).
component("YMR015C",456).
component("YDR402C",219).
component("YGR175C",303).
component("YJR104C",376).
component("YHR008C",319).
component("YER070W",247).
component("U35_",68).
component("YDL168W",178).
component("YDR158W",202).
component("YPL276W",569).
component("YPL275W",568).
component("YOR388C",547).
component("YGL154C",284).
component("U55_",77).
component("YOR323C",537).
component("YMR170C",464).
component("YMR169C",463).
component("U2_",65).
component("YBR221C",146).
component("U52_",74).
component("YBR166C",142).
component("YNL280C",494).
component("YGL012W",276).
component("U57_",78).
component("YER014W",236).
component("YMR118C",461).
component("YLR164W",426).
component("YLL041C",410).
component("YKL148C",393).
component("YJL045W",347).
component("YDR178W",203).
component("YJR051W",370).
component("YEL047C",231).
component("YOR375C",545).
component("YDL215C",180).
component("YAL062W",106).
component("U99_",102).
component("YBR035C",125).
component("YHR037W",320).
component("YKR080W",406).
component("YER023W",237).
component("YOR236W",534).
component("YGR204W",307).
component("YLR142W",421).
component("U62_",80).
component("YKL150W",394).
component("YIL043C",334).
component("YHR042W",321).
component("YFR030W",267).
component("YPL017C",550).
component("YFL018C",259).
component("YER042W",239).
component("YJR137C",381).
component("YML110C",452).
component("YBR034C",124).
component("YPL273W",567).
component("YLL062C",412).
component("U47_",71).
component("YER091C",250).
component("YDL033C",164).
component("YOL096C",513).
component("YDR019C",185).
component("YDR408C",221).
component("YBL013W",110).
component("YKL024C",385).
component("YPR074C",579).
component("YBR117C",134).
component("YLR354C",440).
component("YGR043C",293).
component("YCL009C",155).
component("YMR062C",458).
component("YNL071W",478).
component("YNR008W",501).
component("YPL231W",562).
component("YER061C",245).
component("U86_",94).
component("YPL001W",549).
component("YOR377W",546).
component("YGR177C",304).
component("YPL231W",563).
component("YGR147C",300).
component("YDL040C",165).
component("YPL028W",551).
component("YPR001W",571).
component("YNR001C",499).
component("YDL182W",179).
component("YDL131W",172).
component("YNL117W",481).
component("YIR031C",345).
component("YNL029C",475).
component("YIL085C",337).
component("YMR261C",469).
component("YML100W",451).
component("YBR126C",136).
component("YNL192W",486).
component("YBR038W",127).
component("YBR023C",123).
component("YLR209C",427).
component("U104_",21).
component("YMR300C",471).
component("YER055C",241).
component("YDR354W",215) :- not remove_orf("YDR354W",215).
component("YFR047C",269).
component("YJR133W",380).
component("YLR209C",428).
component("YML022W",445).
component("YDR441C",223).
component("YDR399W",217).
component("YJL167W",362).
component("YNL256W",489).
component("YDR127W",196).
component("YLR303W",434).
component("YJR130C",379).
component("YLR303W",435).
component("YDR035W",186).
component("YBR249C",147).
component("YOL143C",517).
component("YBR256C",148).
component("YHR137W",327).
component("YGL202W",286).
component("YLR027C",413).
component("YKL106W",389).
component("YKL104C",388).
component("YGR019W",291).
component("YLR089C",417).
component("U64_",81).
component("U51_",73).
component("YJR148W",383).
component("YGL253W",288).
component("YFR053C",270).
component("YMR205C",466).
component("YGR240C",309).
component("YDR248C",207).
component("YCR036W",162).
component("YCL040W",157).
component("YJR105W",377).
component("U16_",37).
component("U15_",34).
component("U96_",100).
component("YKL001C",384).
component("YML070W",449).
component("YFL053W",262).
component("YHL032C",316).
component("U83_",92).
component("U82_",91).
component("YMR208W",467).
component("YOR347C",542).
component("YAL038W",105).
component("YPR121W",582).
component("YPL258C",565).
component("YOL055C",509).
component("U1_",48).
component("YBR020W",121).
component("YNL267W",491).
component("YLR305C",437).
component("YFR019W",265).
component("YDR208W",204).
component("YDR127W",197).
component("U21_",56).
component("U20_",54).
component("YDR147W",200).
component("YDR300C",212).
component("YCR012W",159).
component("U18_",44).
component("U76_",89).
component("YER170W",256).
component("YDR226W",205).
component("YDR454C",224).
component("YOL061W",511).
component("YKL181W",396).
component("YHL011C",314).
component("YER099C",252).
component("YBL068W",117).
component("YOR143C",526).
component("YGR007W",290).
component("YLR328W",438).
component("YJR010W",367).
component("YCL050C",158).
component("YPR190C",586).
component("YPR187W",585).
component("YPR110C",581).
component("YPR010C",573).
component("YOR341W",541).
component("YOR340C",540).
component("YOR224C",533).
component("YOR210W",532).
component("YOR207C",530).
component("YOR151C",527).
component("YOR116C",523).
component("YOL005C",505).
component("YNR003C",500).
component("YNL248C",488).
component("YNL151C",484).
component("YNL113W",480).
component("YKL144C",392).
component("YJR063W",371).
component("YJL148W",359).
component("YJL140W",358).
component("YIL021W",333).
component("YHR143W-A",328).
component("YGL070C",281).
component("YFL036W",261).
component("YDR404C",220).
component("YDR156W",201).
component("YDR045C",187).
component("YDL150W",175).
component("YDL140C",173).
component("YBR154C",141).
component("YPR175W",584).
component("YPL167C",558).
component("YOR330C",538).
component("YOL115W",515).
component("YNL299W",496).
component("YNL262W",490).
component("YNL102W",479).
component("YJR043C",369).
component("YJR006W",366).
component("YJL090C",351).
component("YIL139C",340).
component("YEL055C",232).
component("YDR419W",222).
component("YDR121W",194).
component("YDL102W",170).
component("YCR014C",160).
component("YBR278W",150).
component("YBL035C",112).
component("YKL035W",387).
component("YHL012W",315).
component("YHR123W",326).
component("YER026C",238).
component("YCL004W",154).
component("YJL068C",348).
component("YDR058C",191).
component("YDL086W",169).
component("YOL011W",506).
component("YMR008C",455).
component("YMR006C",454).
component("U101_",19).
component("YBL015W",111).
component("YJL068C",349).
component("YPL072W",554).
component("YOR124C",524).
component("YNL186W",485).
component("YMR304W",473).
component("YMR223W",468).
component("YKR098C",408).
component("YJL197W",363).
component("YIL156W",342).
component("YFR010W",264).
component("YER151C",254).
component("YER144C",253).
component("YER098W",251).
component("YDR069C",192).
component("YDL122W",171).
component("YBR058C",128).
component("YBL067C",116).
component("U84_",93).
component("YPR073C",577).
component("YHR215W",331).
component("YDL024C",163).
component("YBR093C",132).
component("YBR092C",131).
component("YAR071W",107).
component("YIL053W",336).
component("YER062C",246).
component("YHR046C",322).
component("YGR208W",308).
component("YPL228W",560).
component("YMR180C",465).
component("YDL236W",182).
component("YJL155C",360).
component("YPR073C",578).
component("YOR208W",531).
component("YNL053W",477).
component("YMR036C",457).
component("YIR026C",343).
component("YIL113W",339).
component("YFR028C",266).
component("YER075C",248).
component("YDL230W",181).
component("YBR276C",149).
component("U34_",67).
component("U30_",66).
component("U25_",64).
component("U24_",63).
component("YOR360C",544).
component("YGL248W",287).
component("YKR031C",403).
component("YLR286C",432).
component("YOR190W",528).
component("YLR300W",433).
component("YGR282C",313).
component("YDR261C",209).
component("YDR400W",218).
component("U23_",62).
component("YML035C",446).
component("YJL070C",350).
component("YBR284W",151).
component("U102_",20).
component("YNL045W",476).
component("YLR160C",425).
component("YLR158C",424).
component("YLR157C",423).
component("YLR155C",422).
component("YDR321W",213).
component("YGL037C",278).
component("YDR242W",206).
component("YBR208C",143).
component("U53_",75).
component("YIR032C",346).
component("YIR029W",344).
component("YMR120C",462).
component("YHR144C",329).
component("YBR153W",140).
component("YDL238C",183).
component("YNL141W",482).
component("YLR245C",431).
component("YML035C",447).
component("YJL126W",354).
component("U87_",95).
component("YBR111C",133).
component("YER005W",235).
component("YIL048W",335).
component("YER166W",255).
component("YDR093W",193).
component("YAL026C",104).
component("YLR231C",429).
component("U88_",96).
component("YLR134W",419).
component("YLR044C",414).
component("YGR087C",296).
component("YDR380W",216).
component("YDL080C",168).
component("U98_",101).
component("YKL184W",399).
component("YNR043W",504).
component("U93_",99).
component("YDR047W",189).
component("U54_",76).
component("YKL211C",400) :- not remove_orf("YKL211C",400).
component("YGR170W",302).
component("YDR294C",210).
component("YEL046C",230).
component("YNR033W",503).
component("YKL211C",401) :- not remove_orf("YKL211C",401).
component("YER090W",401) :- not remove_orf("YER090W",401).
component("YER090W",249) :- not remove_orf("YER090W",249).
component("YDR127W",198).
component("YPL281C",570).
component("YOR393W",548).
component("YMR323W",474).
component("YHR174W",330).
component("YGR254W",311).
component("YGL026C",277) :- not remove_orf("YGL026C",277).
component("YGR155W",301).
component("YLR304C",436).
component("YJL200C",364).
component("YNL316C",497).
component("YKL182W",397).
component("YPL212C",559).
component("YNL292W",495).
component("YGL063W",280).
component("YFL001W",257).
component("YPR002W",572).
component("YDR127W",199).
component("YGL148W",283).
component("YLR359W",442).
component("YAL012W",103).
component("YFR055W",271).
component("YJL121C",353).
component("YBR019C",119).
component("YBR019C",120).
component("YDR050C",190).
component("YDR007W",184) :- not remove_orf("YDR007W",184).
component("YOR095C",522).
component("YER003C",234).
component("YGL001C",273).
component("YKL152C",395).
component("YMR105C",459).
component("YKL127W",390).
component("YEL058W",233).
component("YPR060C",576).
component("YPL097W",555).
component("YGR185C",306).
component("YPL104W",556).
component("YLL018C",409).
component("YPR081C",580).
component("YBR121C",135).
component("YNL247W",487).
component("YOL033W",508).
component("YHR091C",325).
component("YDR341C",214).
component("YOL097C",514).
component("YPR047W",575).
component("YLR060W",415).
component("YFL022C",260).
component("YPR033C",574).
component("YPL160W",557).
component("YLR382C",443).
component("YOR335C",539).
component("YGR094W",298).
component("YGR244C",310).
component("U89_",97).
component("YOR241W",535).
component("YMR113W",460).
component("YKL132C",391).
component("YJL101C",352).
component("U91_",98).
component("YDL141W",174).
component("YJR103W",375).
component("YBL039C",113).
component("YOL058W",510).
component("YBR208C",144).
component("YHR074W",324).
component("YOR303W",536).
component("YJR109C",378).
component("YJL130C",356).
component("YGL062W",279).
component("YBR218C",145).
component("YPL231W",564).
component("YNR016C",502).
component("YKL182W",398).
component("YGR037C",292).
component("YOR005C",519).
component("YDL164C",176).
component("YPR138C",583).
component("YPL265W",566).
component("YPL057C",553).
component("YPL036W",552).
component("YOR348C",543).
component("YOR192C",529).
component("YOR071C",521).
component("YOL156W",518).
component("YOL020W",507) :- not remove_orf("YOL020W",507).
component("YNL318C",498).
component("YNL268W",492).
component("YNL142W",483).
component("YMR272C",470).
component("YML123C",453).
component("YLR348C",439).
component("YLR237W",430).
component("YLR138W",420).
component("YLR100C",418).
component("YLR081W",416).
component("YLL061W",411).
component("YKR093W",407).
component("YKR053C",405).
component("YKR039W",404) :- not remove_orf("YKR039W",404).
component("YKL217W",402).
component("YJR095W",374).
component("YJR077C",372).
component("YJL219W",365).
component("YJL134W",357).
component("YJL129C",355).
component("YHL036W",317).
component("YGR121C",299).
component("YGR055W",294).
component("YGL186C",285).
component("YGL077C",282).
component("YGL008C",274).
component("YFL055W",263).
component("YFL011W",258).
component("YER060W-A",244).
component("YER060W",243).
component("YER056C",242).
component("YER053C",240).
component("YEL017C-A",229).
component("YDR536W",228).
component("YDR508C",226).
component("YDR503C",225).
component("YDR294C",211).
component("YDR046C",188) :- not remove_orf("YDR046C",188).
component("YCR024C-A",161).
component("YCL025C",156).
component("YBR298C",153).
component("YBR291C",152).
component("YBR069C",130) :- not remove_orf("YBR069C",130).
component("YBR068C",129) :- not remove_orf("YBR068C",129).
component("YBR036C",126).
component("YBR021W",122).
component("YBL042C",114).
component("U79_",90).
component("U75_",88).
component("U74_",87).
component("U73_",86).
...
catalyst(1960,189).
catalyst(3460,76).
catalyst(3600,400) :- not remove_reaction(3600,400).
catalyst(6900,302).
catalyst(8781,210).
catalyst(8782,210).
catalyst(4560,230).
...
catalyst(3630,249) :- not remove_reaction(3630,249).
catalyst(3740,198).
catalyst(8231,570).
catalyst(8232,570).
catalyst(8231,548).
...
catalyst(8231,311).
catalyst(8232,311).
catalyst(3590,277) :- not remove_reaction(3590,277).
catalyst(10910,277) :- not remove_reaction(10910,277).
catalyst(4570,301).
catalyst(8181,436).
catalyst(8182,436).
catalyst(8181,364).
...
catalyst(8281,190).
catalyst(8282,190).
catalyst(3610,184) :- not remove_reaction(3610,184).
catalyst(7921,522).
catalyst(7922,522).
catalyst(7841,234).
catalyst(7842,234).
...
catalyst(640,407).
catalyst(6560,405).
catalyst(761,404) :- not remove_reaction(761,404).
catalyst(762,404) :- not remove_reaction(762,404).
catalyst(771,404) :- not remove_reaction(771,404).
catalyst(772,404) :- not remove_reaction(772,404).
catalyst(781,404) :- not remove_reaction(781,404).
catalyst(782,404) :- not remove_reaction(782,404).
catalyst(791,404) :- not remove_reaction(791,404).
catalyst(792,404) :- not remove_reaction(792,404).
catalyst(801,404) :- not remove_reaction(801,404).
catalyst(802,404) :- not remove_reaction(802,404).
catalyst(811,404) :- not remove_reaction(811,404).
catalyst(812,404) :- not remove_reaction(812,404).
catalyst(831,404) :- not remove_reaction(831,404).
catalyst(832,404) :- not remove_reaction(832,404).
catalyst(841,404) :- not remove_reaction(841,404).
catalyst(842,404) :- not remove_reaction(842,404).
catalyst(861,404) :- not remove_reaction(861,404).
catalyst(862,404) :- not remove_reaction(862,404).
catalyst(881,404) :- not remove_reaction(881,404).
catalyst(882,404) :- not remove_reaction(882,404).
catalyst(941,404) :- not remove_reaction(941,404).
catalyst(942,404) :- not remove_reaction(942,404).
catalyst(1191,404) :- not remove_reaction(1191,404).
catalyst(1192,404) :- not remove_reaction(1192,404).
catalyst(1021,402).
catalyst(1022,402).
catalyst(1250,374).
catalyst(1581,372).
...
catalyst(1511,152).
catalyst(1512,152).
catalyst(771,130) :- not remove_reaction(771,130).
catalyst(772,130) :- not remove_reaction(772,130).
catalyst(791,130) :- not remove_reaction(791,130).
catalyst(792,130) :- not remove_reaction(792,130).
catalyst(801,130) :- not remove_reaction(801,130).
catalyst(802,130) :- not remove_reaction(802,130).
catalyst(811,130) :- not remove_reaction(811,130).
catalyst(812,130) :- not remove_reaction(812,130).
catalyst(861,130) :- not remove_reaction(861,130).
catalyst(862,130) :- not remove_reaction(862,130).
catalyst(791,129) :- not remove_reaction(791,129).
catalyst(792,129) :- not remove_reaction(792,129).
catalyst(801,129) :- not remove_reaction(801,129).
catalyst(802,129) :- not remove_reaction(802,129).
catalyst(811,129) :- not remove_reaction(811,129).
catalyst(812,129) :- not remove_reaction(812,129).
catalyst(831,129) :- not remove_reaction(831,129).
catalyst(832,129) :- not remove_reaction(832,129).
catalyst(841,129) :- not remove_reaction(841,129).
catalyst(842,129) :- not remove_reaction(842,129).
catalyst(861,129) :- not remove_reaction(861,129).
catalyst(862,129) :- not remove_reaction(862,129).
catalyst(6600,126).
catalyst(620,122).
catalyst(540,114).
catalyst(2830,90).
...
modifiable_enzyme(404).
modifiable_enzyme(188).
modifiable_enzyme(130).
modifiable_enzyme(129).
