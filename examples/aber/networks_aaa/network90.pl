...
component("YOL086C",552).
component("YMR303C",509).
...
component("YIL094C",366).
component("YHR063C",349).
component("YBR153W",152).
component("YML056C",481).
component("YLR432W",477).
component("YHR216W",360).
component("YAR075W",122).
component("YAR073W",121).
component("YDR127W",214).
component("YJR139C",412).
component("YOL126C",556).
component("YDL078C",182).
component("YKL029C",416).
component("YOR136W",566).
component("YDL066W",181).
component("YLR355C",474).
component("YML086C",483).
component("YIL155C",370).
component("YPR191W",631).
component("YOR065W",561).
component("YJL166W",391).
component("YHR001W-A",344).
component("YGR183C",329).
...
component("YJR025C",398).
component("YGR255C",338).
...
component("YHR008C",345).
component("YER070W",267).
component("U35_",78).
component("YDL168W",193).
component("YDR158W",222).
component("YPL276W",612).
component("YPL275W",611).
component("YOR388C",589).
component("YOR374W",586).
component("YGL154C",306).
component("U55_",88).
component("YOR323C",578).
component("YMR170C",497).
component("YMR169C",496).
component("U2_",75).
component("YBR221C",160).
component("U52_",85).
component("YBR166C",155).
component("YNL280C",532).
component("YGL012W",296).
component("U57_",89).
component("YDR044W",205).
component("YER014W",256).
component("YKR009C",434).
component("YIL160C",372).
component("YGL205W",309).
component("YMR118C",494).
component("YLR164W",459).
component("YLL041C",442).
component("YKL148C",424).
component("YJL045W",377).
component("YDR178W",223).
component("YJR051W",400).
component("YEL047C",251).
component("YOR375C",587).
component("YDL215C",196).
component("YAL062W",119).
component("U99_",115).
component("YBR035C",138).
component("YHR037W",346).
component("YKR080W",438).
component("YER023W",257).
component("YOR236W",575).
component("YGR204W",331).
component("YLR142W",454).
component("U62_",91).
component("YKL150W",425).
component("YIL043C",362).
component("YHR042W",347).
component("YFR030W",287).
component("YPL017C",592).
component("YFL018C",279).
component("YER042W",259).
component("YJR137C",411).
component("YPL266W",609).
component("YML110C",485).
component("YBR034C",137).
component("YPL273W",610).
component("YLL062C",445).
component("U47_",82).
...
component("YKL067W",418).
component("YDR454C",244).
component("YOL061W",551).
component("YKL181W",427).
component("YHL011C",340).
component("YER099C",272).
component("YBL068W",130).
component("YOR143C",567).
component("YGR007W",314).
component("YLR328W",471).
component("YJR010W",397).
component("YCL050C",172).
component("YPR190C",630).
component("YPR187W",629).
component("YPR110C",625).
component("YPR010C",616).
component("YOR341W",582).
component("YOR340C",581).
component("YOR224C",574).
component("YOR210W",573).
component("YOR207C",571).
component("YOR151C",568).
component("YOR116C",564).
component("YOL005C",545).
component("YNR003C",538).
component("YNL248C",526).
component("YNL151C",522).
component("YNL113W",517).
component("YKL144C",423).
component("YJR063W",401).
component("YJL148W",389).
component("YJL140W",388).
component("YIL021W",361).
component("YHR143W-A",355).
...
component("YOR330C",579).
component("YOL115W",555).
component("YNL299W",534).
component("YNL262W",528).
component("YNL102W",516).
component("YJR043C",399).
component("YJR006W",396).
component("YJL090C",381).
component("YIL139C",369).
...
component("YKL035W",417).
component("YHL012W",341).
component("YHR123W",353).
component("YER026C",258).
component("YCL004W",168).
component("YJL068C",378).
component("YDR058C",210).
component("YNR034W",543).
component("YHR163W",357).
component("YGR248W",336).
component("YCR073W-A",177).
component("YDL086W",184).
component("YOL011W",546).
component("YMR008C",488).
component("YMR006C",487).
component("U101_",19).
component("YBL015W",124).
component("YJL068C",379).
component("YPL072W",596).
component("YOR124C",565).
component("YNL186W",523).
component("YMR304W",510).
component("YMR223W",502).
component("YKR098C",440).
component("YJL197W",393).
component("YIL156W",371).
...
component("U84_",105).
component("YPR073C",621).
component("YHR215W",359).
component("YDL024C",178).
component("YBR093C",145).
component("YBR092C",144).
component("YAR071W",120).
component("YIL053W",364).
component("YER062C",266).
component("YHR046C",348).
component("YGR208W",333).
component("YPL228W",602).
component("YMR180C",498).
component("YDL236W",198).
component("YJL155C",390).
component("YPR073C",622).
component("YOR208W",572).
component("YNL053W",514).
component("YMR036C",490).
component("YIR026C",373).
component("YIL113W",368).
...
component("U25_",74).
component("U24_",73).
component("YOR360C",585).
component("YGL248W",311).
component("YKR031C",435).
component("YLR286C",465).
component("YOR190W",569).
component("YLR300W",466).
component("YGR282C",339).
component("YDR261C",229).
component("YDR400W",238).
component("U23_",72).
component("YML035C",479).
component("YJL070C",380).
component("YBR284W",165).
component("U102_",20).
component("YNL045W",513).
component("YLR160C",458).
component("YLR158C",457).
component("YLR157C",456).
component("YLR155C",455).
component("YDR321W",233).
component("YGL037C",299).
component("YDR242W",226).
component("YBR208C",157).
component("YMR281W",507).
component("U53_",86).
component("YIR032C",376).
component("YIR029W",374).
component("YPR062W",620).
component("YMR120C",495).
component("YHR144C",356).
component("YNL141W",519).
component("YBR153W",153).
component("YDL238C",199).
component("YNL141W",520).
component("YLR245C",464).
component("YML035C",480).
component("YJL126W",384).
component("U87_",107).
component("YMR267W",505).
component("YBR111C",146).
component("YER005W",255).
component("YIL048W",363).
component("YER166W",275).
component("YDR093W",212).
component("YAL026C",117).
component("YLR231C",462).
component("U88_",108).
component("YLR134W",452).
component("YLR044C",447).
component("YGR087C",320).
component("YDR380W",236).
component("YDL080C",183).
component("U98_",114).
component("YMR250W",503).
component("YKL184W",430).
component("YNR043W",544).
component("U93_",112).
component("YDR047W",208).
component("U54_",87).
component("YKL211C",431) :- not remove_orf("YKL211C",431).
component("YGR170W",326).
component("YDR294C",230).
component("YEL046C",250).
component("YNR033W",542).
component("YKL211C",432) :- not remove_orf("YKL211C",432).
component("YER090W",432) :- not remove_orf("YER090W",432).
component("YER090W",269) :- not remove_orf("YER090W",269).
component("YDR127W",217).
component("YPL281C",613).
component("YOR393W",590).
component("YMR323W",511).
component("YHR174W",358).
component("YGR254W",337).
component("YGL026C",298) :- not remove_orf("YGL026C",298).
component("YGR155W",325).
component("YLR304C",469).
component("YJL200C",394).
component("YNL316C",535).
component("YKL182W",428).
component("YPL212C",601).
component("YNL292W",533).
component("YGL063W",302).
component("YFL001W",277).
component("YPR002W",615).
component("YDR127W",218).
component("YGL148W",305).
component("YLR359W",475).
component("YAL012W",116).
component("YFR055W",291).
component("YJL121C",383).
component("YBR019C",132).
component("YBR019C",133).
component("YDR050C",209).
component("YDR007W",200) :- not remove_orf("YDR007W",200).
component("YOR095C",563).
component("YER003C",254).
component("YBR196C",156).
component("YGL001C",293).
component("U14_",30).
component("YKL152C",426).
component("YMR105C",492).
component("YKL127W",421).
component("YEL058W",253).
component("YPR060C",619).
component("YHR072W",350).
component("YPL097W",597).
component("YGR185C",330).
component("YPL104W",598).
component("YLL018C",441).
component("YPR081C",624).
component("YBR121C",148).
component("YNL247W",525).
component("YOL033W",548).
component("YHR091C",352).
component("YDR341C",234).
component("YOL097C",554).
component("YPR047W",618).
component("YLR060W",448).
component("YFL022C",280).
component("YPR033C",617).
component("YPL160W",599).
component("YLR382C",476).
component("YDR037W",204).
component("YOR335C",580).
component("YGR094W",322).
component("YGR244C",335).
component("U89_",109).
component("YOR241W",576).
component("YMR113W",493).
component("YKL132C",422).
component("YJL101C",382).
component("U92_",111).
...
component("YOL058W",550).
component("YBR208C",158).
component("YHR074W",351).
component("YMR217W",501).
component("YOR303W",577).
component("YJR109C",408).
component("YJL130C",386).
component("YGL062W",301).
component("YBR218C",159).
component("YPL231W",606).
component("YNR016C",541).
component("YKL182W",429).
component("YGR037C",316).
component("YOR005C",560).
component("YDL164C",191).
component("YPR138C",627).
component("YPL265W",608).
component("YPL057C",595).
component("YPL036W",594).
component("YOR348C",584).
component("YOR192C",570).
component("YOR071C",562).
component("YOL156W",559).
component("YOL020W",547) :- not remove_orf("YOL020W",547).
component("YNL318C",536).
component("YNL268W",530).
component("YNL142W",521).
component("YMR272C",506).
component("YML123C",486).
component("YLR348C",472).
component("YLR237W",463).
component("YLR138W",453).
component("YLR100C",451).
component("YLR081W",449).
component("YLL061W",444).
component("YLL043W",443).
component("YKR093W",439).
component("YKR053C",437).
component("YKR039W",436) :- not remove_orf("YKR039W",436).
component("YKL217W",433).
component("YJR095W",404).
component("YJR077C",402).
component("YJL219W",395).
component("YJL134W",387).
component("YJL129C",385).
component("YHL036W",343).
...
catalyst(1960,208).
catalyst(3460,87).
catalyst(3600,431) :- not remove_reaction(3600,431).
catalyst(6900,326).
catalyst(8781,230).
catalyst(8782,230).
catalyst(4560,250).
catalyst(2550,542).
catalyst(3630,432) :- not remove_reaction(3630,432).
...
catalyst(941,547) :- not remove_reaction(941,547).
catalyst(942,547) :- not remove_reaction(942,547).
catalyst(1200,536).
catalyst(761,530).
catalyst(762,530).
catalyst(371,521).
...
catalyst(640,439).
catalyst(6560,437).
catalyst(761,436) :- not remove_reaction(761,436).
catalyst(762,436) :- not remove_reaction(762,436).
catalyst(771,436) :- not remove_reaction(771,436).
catalyst(772,436) :- not remove_reaction(772,436).
catalyst(781,436) :- not remove_reaction(781,436).
catalyst(782,436) :- not remove_reaction(782,436).
catalyst(791,436) :- not remove_reaction(791,436).
catalyst(792,436) :- not remove_reaction(792,436).
catalyst(801,436) :- not remove_reaction(801,436).
catalyst(802,436) :- not remove_reaction(802,436).
catalyst(811,436) :- not remove_reaction(811,436).
catalyst(812,436) :- not remove_reaction(812,436).
catalyst(821,436) :- not remove_reaction(821,436).
catalyst(822,436) :- not remove_reaction(822,436).
catalyst(831,436) :- not remove_reaction(831,436).
catalyst(832,436) :- not remove_reaction(832,436).
catalyst(841,436) :- not remove_reaction(841,436).
catalyst(842,436) :- not remove_reaction(842,436).
catalyst(861,436) :- not remove_reaction(861,436).
catalyst(862,436) :- not remove_reaction(862,436).
catalyst(881,436) :- not remove_reaction(881,436).
catalyst(882,436) :- not remove_reaction(882,436).
catalyst(911,436) :- not remove_reaction(911,436).
catalyst(912,436) :- not remove_reaction(912,436).
catalyst(941,436) :- not remove_reaction(941,436).
catalyst(942,436) :- not remove_reaction(942,436).
catalyst(1191,436) :- not remove_reaction(1191,436).
catalyst(1192,436) :- not remove_reaction(1192,436).
catalyst(1021,433).
catalyst(1022,433).
catalyst(1250,404).
catalyst(1581,402).
