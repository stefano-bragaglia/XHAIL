...
component("YLR056W",646).
component("YGR060W",454).
component("YGL012W",422).
component("YKR009C",629).
component("YOL086C",794).
component("YMR303C",732).
component("YMR083W",705).
component("YGL256W",446).
...
component("YJR159W",597).
component("YGL001C",419).
component("YIL094C",529).
component("YHR063C",502).
component("YBR153W",211).
component("YML056C",690).
component("YLR432W",682).
component("YHR216W",519).
component("YAR075W",170).
component("YAR073W",169).
component("YCL030C",236).
component("YDR127W",309).
component("YJR139C",591).
component("YOL126C",799).
component("YKL085W",607).
component("YDL078C",258).
component("YKL029C",602).
component("YOR136W",813).
component("YNL037C",737).
component("YDL066W",257).
component("YNL241C",753).
component("YOL059W",792).
component("YDL022W",251).
component("YLR355C",678).
component("YIL074C",527).
component("YER081W",389).
component("YML054C",689).
component("YDL174C",279).
component("YML086C",693).
component("YIL155C",535).
component("YPR191W",906).
component("YOR065W",805).
component("YJL166W",565).
component("YHR001W-A",491).
component("YGR183C",469).
component("YFR033C",415).
component("YDR529C",355).
component("YBL045C",176).
component("Q0105",18).
component("YGR088W",457).
component("YDR256C",324).
component("YKL026C",601).
component("YIR037W",545).
component("YBR244W",223).
component("YJR078W",582).
component("YJR025C",574).
component("YGR255C",481).
component("U108_",23).
component("YBL098W",180).
component("YMR015C",702).
component("YHR007C",492).
component("YDR402C",344).
component("YGL055W",429).
component("YGR175C",466).
component("YJR104C",585).
component("YHR008C",493).
component("YJL026W",548).
component("YIL066C",526).
component("YGR180C",468).
component("YER070W",386).
component("U38_",111).
component("U36_",110).
component("U35_",109).
component("YDL168W",278).
component("YDR158W",317).
component("YBR006W",183).
component("YPL276W",881).
component("YPL275W",880).
component("YOR388C",846).
component("YOR374W",843).
component("YER073W",387).
component("U68_",133).
component("YGL154C",437).
component("U55_",125).
component("YOR323C",835).
component("YMR170C",715).
component("YMR169C",714).
component("U2_",104).
component("YER178W",402).
component("YBR221C",221).
component("YIL125W",533).
component("U52_",122).
...
component("U57_",127).
component("YKL216W",626).
component("YDR044W",296).
component("YER014W",370).
component("YKR009C",630).
component("YIL160C",537).
component("YGL205W",440).
component("YMR118C",710).
component("YLR164W",659).
component("YLL041C",639).
component("YKL148C",614).
component("YKL141W",612).
component("YJL045W",549).
component("YDR178W",318).
component("YJR051W",577).
component("YEL047C",364).
component("YDL215C",283).
component("YOR375C",844).
component("YDL215C",284).
component("YAL062W",167).
component("U99_",161).
component("YBR035C",193).
component("YMR189W",717).
component("U56_",126).
component("YHR037W",499).
component("YKR080W",634).
component("YER023W",372).
component("YPL023C",850).
component("YGL125W",434).
component("YOR236W",828).
component("YGR204W",473).
component("YLR142W",654).
component("U63_",131).
component("U62_",130).
component("YKL150W",615).
component("YIL043C",523).
component("YHR042W",500).
component("YOR221C",826).
component("YML120C",696).
component("YKL192C",623).
component("YKL055C",604).
component("YER061C",381).
component("YGR234W",476).
component("YFR030W",414).
component("YPL017C",849).
component("YFL018C",406).
component("YDR353W",339).
component("YER042W",374).
component("YJR137C",590).
component("YPL266W",876).
component("YML110C",695).
component("YBR034C",192).
component("YPL273W",878).
component("YLL062C",642).
component("YDR410C",347).
component("U47_",117).
component("YER091C",394).
component("YJR073C",580).
component("YDR120C",307).
component("YDL033C",253).
component("YOL096C",795).
component("YLR172C",660).
component("YDR019C",292).
component("YBR176W",215).
component("YDR408C",346).
component("YMR120C",711).
component("YBL013W",171).
component("YKL024C",600).
component("YPR074C",895).
component("YBR117C",204).
component("YLR354C",677).
component("YGR043C",452).
component("YMR108W",708).
component("YCL009C",234).
component("YMR062C",704).
component("YNL071W",740).
component("YNR008W",771).
component("YIL160C",538).
component("YNL277W",762).
component("YFL017C",405).
component("YPL231W",870).
component("YER061C",382).
component("U86_",149).
component("YPL001W",848).
component("YMR296C",730).
component("YDR062W",302).
component("YDL052C",256).
component("U8_",153).
component("YDR148C",315).
component("YOR377W",845).
component("YGR177C",467).
component("YPL231W",871).
component("YGR147C",462).
component("YDL040C",254).
component("YPL028W",851).
component("YGL017W",424).
component("YPR001W",883).
component("YNR001C",769).
component("YCR005C",241).
component("YDL182W",280).
component("YDL131W",268).
component("YNL117W",744).
component("YIR031C",543).
component("YOR321W",834).
component("YJR143C",592).
component("YGR199W",472).
component("YDR307W",333).
component("YDL095W",263).
component("YDL093W",262).
component("YAL023C",164).
component("YOR103C",809).
component("YOR085W",807).
component("YMR149W",713).
component("YML019W",685).
component("YJL002C",546).
component("YEL002C",359).
component("YDL232W",286).
component("YCL043C",239).
component("YNL029C",736).
component("YIL085C",528).
component("YMR261C",725).
component("YML100W",694).
component("YBR126C",207).
component("YNL192W",752).
component("YBR038W",195).
component("YBR023C",191).
component("YMR306W",734).
component("YLR342W",675).
component("YGR032W",450).
component("YLR209C",661).
component("U104_",21).
component("YOR209C",824).
component("YMR300C",731).
component("YER055C",377).
component("YDR354W",340) :- not remove_orf("YDR354W",340).
component("YFR047C",416).
component("YJR133W",589).
component("YLR209C",662).
component("YML022W",686).
component("YDR441C",350).
component("YDR399W",342).
component("YPR176C",903).
component("YPL172C",861).
component("YNR041C",777).
component("YMR101C",706).
component("YDL090C",261).
component("YBR003W",182).
component("YBR002C",181).
component("YJL167W",566).
component("YJL167W",567).
component("YNL256W",756).
component("YPR069C",892).
component("YDR127W",310).
component("YLR303W",669).
component("YGR012W",448).
component("YJR130C",588).
component("YLR303W",670).
component("YDR035W",294).
component("YBR249C",224).
component("YOR274W",830).
component("YOL143C",801).
component("YBR256C",226).
component("YHR137W",511).
component("YGL202W",439).
component("YLR027C",643).
component("YKL106W",609).
component("YKL104C",608).
component("YGR019W",449).
component("YLR089C",649).
component("U64_",132).
component("U61_",129).
component("U51_",121).
component("YJR148W",593).
component("YHR208W",517).
component("YOR184W",819).
component("YNR058W",780).
component("YIL116W",532).
component("YGL253W",445).
component("YFR053C",417).
component("YOL136C",800).
component("YIL107C",530).
component("YMR013C",701).
component("YMR205C",718).
component("YGR240C",477).
component("YDR248C",323).
component("YCR036W",247).
component("YGR194C",471).
component("YCL040W",238).
component("YJR105W",586).
component("U16_",57).
component("U15_",51).
component("YPL188W",863).
component("YJR049C",576).
component("YEL041W",362).
component("U96_",159).
component("YKL001C",598).
component("YDR236C",321).
component("YML070W",692).
component("YFL053W",409).
component("YHL032C",489).
component("YLR133W",651).
component("YDR531W",357).
component("U83_",147).
component("U82_",146).
component("U81_",145).
component("YMR208W",719).
component("YPL203W",864).
component("YOR061W",804).
component("YKL166C",617).
component("YJL164C",564).
component("YIL035C",522).
component("YHR205W",516).
component("YHR102W",509).
component("YGL019W",425).
component("YHR025W",498).
component("YOR347C",840).
component("YAL038W",166).
component("YNR012W",772).
component("YPR121W",899).
component("YPL258C",873).
component("YOL055C",788).
component("YPL214C",867).
component("U1_",80).
component("YDR009W",291).
component("YBR020W",189).
component("YNL267W",760).
component("YLR305C",672).
component("YFR019W",412).
component("YDR208W",319).
component("YDR127W",311).
component("U21_",91).
component("U20_",88).
component("YDR147W",314).
component("YDR300C",332).
component("YCR012W",242).
component("YER052C",375).
component("YER069W",385).
component("U18_",72).
component("U17_",65).
component("U76_",141).
component("YMR220W",721).
component("YER170W",401).
component("YDR226W",320).
component("YKL067W",606).
component("YOL055C",789).
component("YDR454C",351).
component("YJR057W",578).
component("YOL061W",793).
component("YKL181W",618).
component("YHL011C",486).
component("YER099C",396).
component("YBL068W",179).
component("YOR143C",815).
component("YNL256W",757).
component("YLR328W",673).
component("YBR018C",185).
component("YBR018C",186).
component("YGR007W",447).
component("YLR328W",674).
component("YKR002W",628).
component("YDL103C",266).
component("U94_",158).
component("YJR010W",573).
component("YGL130W",435).
component("YDR530C",356).
component("YCL050C",240).
component("YPR190C",905).
component("YPR187W",904).
component("YPR110C",897).
component("YPR010C",886).
component("YOR341W",839).
component("YOR340C",838).
component("YOR224C",827).
component("YOR210W",825).
component("YOR207C",822).
component("YOR151C",816).
component("YOR116C",810).
component("YOL005C",782).
component("YNR003C",770).
component("YNL248C",755).
component("YNL151C",749).
component("YNL113W",743).
component("YKL144C",613).
component("YJR063W",579).
component("YJL148W",561).
component("YJL140W",560).
component("YIL021W",521).
component("YHR143W-A",512).
component("YGL070C",432).
component("YFL036W",408).
component("YDR404C",345).
component("YDR156W",316).
component("YDR045C",297).
component("YDL150W",275).
component("YDL140C",270).
component("YBR154C",213).
component("YPR175W",902).
component("YPL167C",860).
component("YOR330C",836).
component("YOL115W",798).
component("YNL299W",766).
component("YNL262W",759).
component("YNL102W",742).
component("YJR043C",575).
component("YJR006W",572).
component("YJL090C",553).
component("YIL139C",534).
component("YEL055C",365).
component("YDR419W",348).
component("YDR121W",308).
component("YDL102W",265).
component("YCR014C",243).
component("YBR278W",229).
component("YBL035C",173).
component("YKL035W",603).
component("YHL012W",487).
component("YHR123W",510).
component("YPR113W",898).
component("YBR243C",222).
component("YNL130C",745).
component("YDL142C",274).
component("YPL148C",858).
component("YER026C",373).
component("YCL004W",233).
component("YGR286C",485).
component("YJL068C",550).
component("YDR058C",301).
component("YNR034W",776).
component("YHR163W",514).
component("YGR248W",479).
component("YCR073W-A",248).
component("YDL086W",260).
component("YOL011W",784).
component("YMR008C",699).
component("YMR006C",698).
component("U105_",22).
component("U101_",19).
component("YBL015W",172).
component("YJL068C",551).
component("YPL072W",854).
component("YOR124C",811).
component("YNL186W",751).
component("YMR304W",733).
component("YMR223W",722).
component("YKR098C",637).
component("YJL197W",568).
component("YIL156W",536).
component("YFR010W",411).
component("YER151C",399).
component("YER144C",398).
component("YER098W",395).
component("YDR069C",303).
component("YDL122W",267).
component("YBR058C",196).
component("YBL067C",178).
component("YDR272W",327).
component("U84_",148).
component("YLR377C",680).
component("YDR074W",304).
component("YPL179W",862).
component("YNR032W",774).
component("YML057W",691).
component("YML016C",684).
component("YLR433C",683).
component("YGR123C",460).
component("YER133W",397).
component("YER089C",392).
component("YDR436W",349).
component("YDR075W",305).
component("YDL188C",281).
component("YDL134C",269).
component("YDL047W",255).
component("YDL006W",249).
component("YBR125C",206).
component("YBL056W",177).
component("YPR073C",893).
component("YHR215W",518).
component("YDL024C",252).
component("YBR093C",202).
component("YBR092C",201).
component("YAR071W",168).
component("YIL053W",525).
component("YER062C",383).
component("YHR046C",501).
component("U9_",162).
component("YGR208W",475).
component("YPL228W",868).
component("YMR180C",716).
component("YDL236W",287).
component("YJL155C",563).
component("YPR073C",894).
component("YOR208W",823).
component("YNL053W",739).
component("YMR036C",703).
component("YIR026C",540).
component("YIL113W",531).
component("YFR028C",413).
component("YER075C",388).
component("YDL230W",285).
...
component("U25_",101).
component("U24_",100).
component("YPL268W",877).
component("YOR360C",842).
component("YGL248W",444).
component("YKR031C",631).
component("YPL206C",865).
component("YGL027C",427).
component("YLR286C",667).
component("YJR153W",595).
component("YBR184W",216).
component("YOR190W",820).
component("YLR300W",668).
component("YGR282C",484).
component("YDR261C",325).
component("YDR400W",343).
component("U23_",99).
component("YML035C",687).
component("YJL070C",552).
component("YBR284W",230).
component("U102_",20).
component("YNL045W",738).
component("YLR160C",658).
component("YLR158C",657).
component("YLR157C",656).
component("YLR155C",655).
component("YDR321W",334).
component("YGL037C",428).
component("YMR293C",729).
component("YDR242W",322).
component("YBR208C",218).
component("YMR281W",728).
component("U53_",123).
component("YIR027C",541).
component("YPL111W",857).
component("YIR032C",544).
component("YIR029W",542).
component("YPR062W",891).
component("YMR120C",712).
component("YLR028C",644).
component("YHR144C",513).
component("YGR267C",483).
component("YNL141W",746).
component("YBR153W",212).
component("YDL238C",288).
component("YNL141W",747).
component("YLR245C",665).
component("YML035C",688).
component("YBR084W",199).
component("YJL126W",556).
component("U44_",115).
component("YDL100C",264).
component("U87_",150).
component("U40_",113).
component("YMR267W",726).
component("YBR011C",184).
component("YBR111C",203).
component("YBR252W",225).
component("YCL030C",237).
component("YER005W",369).
component("YIL048W",524).
component("YER166W",400).
component("YDR093W",306).
component("YAL026C",165).
component("YLR231C",663).
component("U88_",151).
component("YLR134W",652).
component("YLR044C",645).
component("YGR087C",456).
component("YDR380W",341).
component("YDL080C",259).
component("U98_",160).
component("YMR250W",724).
component("YKL184W",622).
component("YEL021W",361).
component("YNR043W",778).
component("U93_",157).
component("YDR047W",299).
component("U54_",124).
component("YKL211C",624) :- not remove_orf("YKL211C",624).
component("YKR097W",636).
component("YOL052C",787).
component("YNL169C",750).
component("YGR170W",464).
component("YKL060C",605).
component("YNL256W",758).
component("YDR294C",329).
component("YEL046C",363).
component("YNR033W",775).
component("YPR006C",885).
component("YER065C",384).
component("YKL211C",625) :- not remove_orf("YKL211C",625).
component("YER090W",625) :- not remove_orf("YER090W",625).
component("YER090W",393) :- not remove_orf("YER090W",393).
component("YDR127W",312).
component("YPL281C",882).
component("YOR393W",847).
component("YMR323W",735).
component("YHR174W",515).
component("YGR254W",480).
component("YPL262W",874).
component("YGL026C",426) :- not remove_orf("YGL026C",426).
component("YGR155W",463).
component("YLR304C",671).
component("YJL200C",569).
component("YNL316C",767).
component("YKL182W",620).
component("YPL212C",866).
component("YNL292W",765).
component("YGL063W",431).
component("YFL001W",403).
component("YOR278W",831).
component("YPR002W",884).
component("U49_",118).
component("YDR127W",313).
component("YGL148W",436).
component("YIL168W",539).
component("YER086W",390).
component("YLR359W",679).
component("YAL012W",163).
component("YFR055W",418).
component("YJL005W",547).
component("YOR176W",818).
component("YJL121C",555).
component("YBR019C",187).
component("YBR019C",188).
component("YDR050C",300).
component("YDR007W",290) :- not remove_orf("YDR007W",290).
component("YOR095C",808).
component("YER003C",368).
component("YBR196C",217).
component("YGL001C",420).
component("U14_",44).
component("YOL056W",790).
component("YKL152C",616).
component("YDL021W",250).
component("YMR105C",707).
component("YKL127W",610).
component("YEL058W",366).
component("YPR060C",890).
component("YHR072W",503).
component("YJL153C",562).
component("YPL097W",855).
component("YGR185C",470).
component("YGR264C",482).
component("YGR171C",465).
component("YHR011W",494).
component("YDR023W",293).
component("YPL104W",856).
component("YLL018C",638).
component("YPR081C",896).
component("YBR121C",205).
component("YHR020W",497).
component("YER087W",391).
component("YNL247W",754).
component("YOL033W",786).
component("YGL245W",443).
component("YHR091C",505).
component("YDR341C",335).
component("YOL097C",796).
component("YDR268W",326).
component("YPR047W",889).
component("YLR060W",647).
component("YFL022C",407).
component("YPR033C",887).
component("YHR019C",495).
component("YCR024C",244).
component("YHR019C",496).
component("YPL160W",859).
component("YLR382C",681).
component("YNL073W",741).
component("YDR037W",295).
component("YOR335C",837).
component("YGR094W",458).
component("YOR317W",833).
component("YMR246W",723).
component("YIL009W",520).
component("YER015W",371).
component("YOR142W",814).
component("YGR244C",478).
component("YPR035W",888).
component("U89_",152).
component("YOR241W",829).
component("YMR113W",709).
component("YKL132C",611).
component("YJL101C",554).
component("U92_",156).
...
component("YJR103W",584).
component("YBL039C",174).
component("YGR204W",474).
component("YBR084W",200).
component("YOL058W",791).
component("YBR208C",219).
component("YHR074W",504).
component("YMR217W",720).
component("YGR061C",455).
component("YPR145W",901).
component("YGR124W",461).
component("YOR303W",832).
component("YJR109C",587).
component("YJL130C",558).
component("YGL062W",430).
component("YBR218C",220).
component("YPL231W",872).
component("YNR016C",773).
component("YKL182W",621).
component("YGR037C",451).
component("YOR005C",803).
component("YDL164C",276).
component("YOL010W",783).
component("YPR138C",900).
component("YPL274W",879).
component("YPL265W",875).
component("YPL057C",853).
component("YPL036W",852).
component("YOR348C",841).
component("YOR192C",821).
component("YOR171C",817).
component("YOR130C",812).
component("YOR071C",806).
component("YOL156W",802).
component("YOL103W",797).
component("YOL020W",785) :- not remove_orf("YOL020W",785).
component("YNR072W",781).
component("YNR056C",779).
component("YNL318C",768).
component("YNL268W",761).
component("YNL142W",748).
component("YMR272C",727).
component("YMR011W",700).
component("YML123C",697).
component("YLR348C",676).
component("YLR260W",666).
component("YLR237W",664).
component("YLR138W",653).
component("YLR100C",650).
component("YLR081W",648).
component("YLL061W",641).
component("YLL043W",640).
component("YKR093W",635).
component("YKR053C",633).
component("YKR039W",632) :- not remove_orf("YKR039W",632).
component("YKL217W",627).
component("YKL004W",599).
component("YJR158W",596).
component("YJR152W",594).
component("YJR095W",583).
component("YJR077C",581).
component("YJL219W",571).
component("YJL214W",570).
component("YJL134W",559).
component("YJL129C",557).
component("YHR096C",508).
component("YHR094C",507).
component("YHR092C",506).
component("YHL036W",490).
component("YHL016C",488).
component("YGR121C",459).
component("YGR055W",453).
component("YGL186C",438).
component("YGL077C",433).
component("YGL008C",421).
component("YFL055W",410).
component("YFL011W",404).
component("YER060W-A",380).
component("YER060W",379).
component("YER056C",378).
component("YER053C",376).
component("YEL069C",367).
component("YEL017C-A",360).
component("YDR536W",358).
component("YDR508C",354).
component("YDR503C",353).
component("YDR497C",352).
component("YDR345C",338).
component("YDR343C",337).
component("YDR342C",336).
component("YDR297W",331).
component("YDR294C",330).
component("YDR284C",328).
component("YDR046C",298) :- not remove_orf("YDR046C",298).
component("YDL245C",289).
component("YDL210W",282).
...
catalyst(6160,731).
catalyst(3870,377).
catalyst(3620,340) :- not remove_reaction(3620,340).
catalyst(2110,416).
catalyst(2190,416).
catalyst(5550,589).
catalyst(5791,662).
...
catalyst(1960,299).
catalyst(3460,124).
catalyst(3600,624) :- not remove_reaction(3600,624).
catalyst(8000,636).
catalyst(3941,787).
catalyst(3942,787).
catalyst(6890,750).
...
catalyst(8020,885).
catalyst(8020,384).
catalyst(1890,625) :- not remove_reaction(1890,625).
catalyst(3630,625) :- not remove_reaction(3630,625).
catalyst(1890,393) :- not remove_reaction(1890,393).
catalyst(3630,393) :- not remove_reaction(3630,393).
catalyst(3740,312).
catalyst(8231,882).
catalyst(8232,882).
catalyst(8231,847).
...
catalyst(8281,300).
catalyst(8282,300).
catalyst(3610,290) :- not remove_reaction(3610,290).
catalyst(7921,808).
catalyst(7922,808).
catalyst(7841,368).
catalyst(7842,368).
...
catalyst(1210,802).
catalyst(1160,797).
catalyst(801,785) :- not remove_reaction(801,785).
catalyst(802,785) :- not remove_reaction(802,785).
catalyst(811,785) :- not remove_reaction(811,785).
catalyst(812,785) :- not remove_reaction(812,785).
catalyst(831,785) :- not remove_reaction(831,785).
catalyst(832,785) :- not remove_reaction(832,785).
catalyst(901,785) :- not remove_reaction(901,785).
catalyst(902,785) :- not remove_reaction(902,785).
catalyst(941,785) :- not remove_reaction(941,785).
catalyst(942,785) :- not remove_reaction(942,785).
catalyst(1210,781).
catalyst(700,779).
catalyst(1200,768).
catalyst(761,761).
...
catalyst(650,635).
catalyst(6560,633).
catalyst(761,632) :- not remove_reaction(761,632).
catalyst(762,632) :- not remove_reaction(762,632).
catalyst(771,632) :- not remove_reaction(771,632).
catalyst(772,632) :- not remove_reaction(772,632).
catalyst(781,632) :- not remove_reaction(781,632).
catalyst(782,632) :- not remove_reaction(782,632).
catalyst(791,632) :- not remove_reaction(791,632).
catalyst(792,632) :- not remove_reaction(792,632).
catalyst(801,632) :- not remove_reaction(801,632).
catalyst(802,632) :- not remove_reaction(802,632).
catalyst(811,632) :- not remove_reaction(811,632).
catalyst(812,632) :- not remove_reaction(812,632).
catalyst(821,632) :- not remove_reaction(821,632).
catalyst(822,632) :- not remove_reaction(822,632).
catalyst(831,632) :- not remove_reaction(831,632).
catalyst(832,632) :- not remove_reaction(832,632).
catalyst(841,632) :- not remove_reaction(841,632).
catalyst(842,632) :- not remove_reaction(842,632).
catalyst(861,632) :- not remove_reaction(861,632).
catalyst(862,632) :- not remove_reaction(862,632).
catalyst(881,632) :- not remove_reaction(881,632).
catalyst(882,632) :- not remove_reaction(882,632).
catalyst(901,632) :- not remove_reaction(901,632).
catalyst(902,632) :- not remove_reaction(902,632).
catalyst(911,632) :- not remove_reaction(911,632).
catalyst(912,632) :- not remove_reaction(912,632).
catalyst(921,632) :- not remove_reaction(921,632).
catalyst(922,632) :- not remove_reaction(922,632).
catalyst(941,632) :- not remove_reaction(941,632).
catalyst(942,632) :- not remove_reaction(942,632).
catalyst(1191,632) :- not remove_reaction(1191,632).
catalyst(1192,632) :- not remove_reaction(1192,632).
catalyst(1021,627).
catalyst(1022,627).
catalyst(6610,599).
catalyst(1210,596).
...
catalyst(6550,330).
catalyst(6690,328).
catalyst(791,298) :- not remove_reaction(791,298).
catalyst(792,298) :- not remove_reaction(792,298).
catalyst(801,298) :- not remove_reaction(801,298).
catalyst(802,298) :- not remove_reaction(802,298).
catalyst(811,298) :- not remove_reaction(811,298).
catalyst(812,298) :- not remove_reaction(812,298).
catalyst(831,298) :- not remove_reaction(831,298).
catalyst(832,298) :- not remove_reaction(832,298).
catalyst(841,298) :- not remove_reaction(841,298).
catalyst(842,298) :- not remove_reaction(842,298).
catalyst(861,298) :- not remove_reaction(861,298).
catalyst(862,298) :- not remove_reaction(862,298).
catalyst(901,298) :- not remove_reaction(901,298).
catalyst(902,298) :- not remove_reaction(902,298).
catalyst(1210,289).
catalyst(690,282).
catalyst(730,282).
catalyst(431,246).
...
modifiable_enzyme(393).
modifiable_enzyme(426).
modifiable_enzyme(290).
modifiable_enzyme(785).
modifiable_enzyme(632).
