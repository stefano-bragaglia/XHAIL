...
component("YNL280C",558).
component("YGR060W",334).
component("YGL012W",309).
component("YKR009C",457).
component("YOL086C",581).
component("YMR303C",534).
component("YGL256W",327).
component("YDL168W",204).
component("YBR145W",158).
component("YPL231W",633).
component("U46_",86).
component("YBR149W",159).
component("YJR159W",435).
component("YGL001C",306).
component("YIL094C",383).
component("YHR063C",366).
component("YBR153W",160).
component("YML056C",506).
component("YLR432W",502).
component("YHR216W",377).
component("YAR075W",128).
component("YAR073W",127).
component("YDR127W",226).
component("YJR139C",433).
component("YOL126C",585).
component("YDL078C",191).
component("YKL029C",438).
component("YOR136W",595).
component("YDL066W",190).
component("YLR355C",499).
component("YML086C",508).
component("YIL155C",388).
component("YPR191W",661).
component("YOR065W",590).
component("YJL166W",411).
component("YHR001W-A",360).
component("YGR183C",345).
component("YFR033C",302).
component("YDR529C",259).
component("YBL045C",134).
component("Q0105",18).
component("YGR088W",336).
component("YDR256C",240).
component("YJR078W",424).
component("YJR025C",418).
component("YGR255C",354).
component("YBL098W",137).
component("YMR015C",514).
component("YDR402C",251).
component("YGL055W",314).
component("YGR175C",342).
component("YJR104C",427).
component("YHR008C",361).
component("YJL026W",395).
component("YGR180C",344).
component("YER070W",279).
component("U35_",82).
component("YDL168W",205).
component("YDR158W",234).
component("YPL276W",642).
component("YPL275W",641).
component("YOR388C",619).
component("YOR374W",616).
component("YER073W",280).
component("YGL154C",320).
component("U55_",93).
component("YOR323C",608).
component("YMR170C",522).
component("YMR169C",521).
component("U2_",79).
component("YBR221C",168).
component("U52_",90).
component("YBR166C",163).
component("YNL280C",559).
component("YGL012W",310).
component("U57_",94).
component("YDR044W",217).
component("YER014W",268).
component("YKR009C",458).
component("YIL160C",390).
component("YGL205W",323).
component("YMR118C",519).
component("YLR164W",483).
component("YLL041C",466).
component("YKL148C",446).
component("YJL045W",396).
component("YDR178W",235).
component("YJR051W",420).
component("YEL047C",263).
component("YOR375C",617).
component("YDL215C",208).
component("YAL062W",125).
component("U99_",121).
component("YBR035C",146).
component("YHR037W",363).
component("YKR080W",462).
component("YER023W",269).
component("YOR236W",605).
component("YGR204W",347).
component("YLR142W",478).
component("U62_",97).
component("YKL150W",447).
component("YIL043C",379).
component("YHR042W",364).
component("YFR030W",301).
component("YPL017C",622).
component("YFL018C",293).
component("YER042W",271).
component("YJR137C",432).
component("YPL266W",639).
component("YML110C",510).
component("YBR034C",145).
component("YPL273W",640).
component("YLL062C",469).
component("U47_",87).
component("YER091C",284).
component("YJR073C",422).
component("YDL033C",188).
component("YOL096C",582).
component("YLR172C",484).
component("YDR019C",214).
component("YDR408C",253).
component("YBL013W",129).
component("YKL024C",437).
component("YPR074C",653).
component("YBR117C",155).
component("YLR354C",498).
component("YGR043C",332).
component("YCL009C",177).
component("YMR062C",516).
component("YNL071W",540).
component("YNR008W",566).
component("YPL231W",634).
component("YER061C",277).
component("U86_",112).
component("YPL001W",621).
component("YDR148C",232).
component("YOR377W",618).
component("YGR177C",343).
component("YPL231W",635).
component("YGR147C",339).
component("YDL040C",189).
component("YPL028W",623).
component("YGL017W",311).
component("YPR001W",644).
component("YNR001C",564).
component("YDL182W",206).
component("YDL131W",197).
component("YNL117W",543).
component("YIR031C",393).
component("YNL029C",537).
component("YIL085C",382).
component("YMR261C",529).
component("YML100W",509).
component("YBR126C",157).
component("YNL192W",550).
component("YBR038W",148).
component("YBR023C",144).
component("YLR209C",485).
component("U104_",21).
component("YOR209C",602).
component("YMR300C",533).
component("YER055C",273).
component("YDR354W",247) :- not remove_orf("YDR354W",247).
component("YFR047C",303).
component("YJR133W",431).
component("YLR209C",486).
component("YML022W",503).
component("YDR441C",255).
component("YDR399W",249).
component("YJL167W",412).
component("YNL256W",553).
component("YDR127W",227).
component("YLR303W",492).
component("YGR012W",329).
component("YJR130C",430).
component("YLR303W",493).
component("YDR035W",215).
component("YBR249C",169).
component("YOL143C",587).
component("YBR256C",170).
component("YHR137W",371).
component("YGL202W",322).
component("YLR027C",470).
component("YKL106W",442).
component("YKL104C",441).
component("YGR019W",330).
component("YLR089C",474).
component("U64_",98).
component("U61_",96).
component("U51_",89).
component("YJR148W",434).
component("YIL116W",386).
component("YGL253W",326).
component("YFR053C",304).
component("YOL136C",586).
component("YIL107C",384).
component("YMR205C",524).
component("YGR240C",350).
component("YDR248C",239).
component("YCR036W",185).
component("YCL040W",180).
component("YJR105W",428).
component("U16_",40).
component("U15_",37).
component("U96_",119).
component("YKL001C",436).
component("YML070W",507).
component("YFL053W",296).
component("YHL032C",358).
component("U83_",110).
component("U82_",109).
component("U81_",108).
component("YMR208W",525).
component("YOR347C",613).
component("YAL038W",124).
component("YNR012W",567).
component("YPR121W",656).
component("YPL258C",637).
component("YOL055C",578).
component("U1_",60).
component("YDR009W",213).
component("YBR020W",142).
component("YNL267W",556).
component("YLR305C",495).
component("YFR019W",299).
component("YDR208W",236).
component("YDR127W",228).
component("U21_",69).
component("U20_",67).
component("YDR147W",231).
component("YDR300C",244).
component("YCR012W",182).
component("U18_",53).
component("U17_",47).
component("U76_",106).
component("YER170W",290).
component("YDR226W",237).
component("YKL067W",440).
component("YDR454C",256).
component("YOL061W",580).
component("YKL181W",449).
component("YHL011C",356).
component("YER099C",286).
component("YBL068W",136).
component("YOR143C",596).
component("YBR018C",139).
component("YGR007W",328).
component("YLR328W",496).
component("YKR002W",456).
component("YDL103C",195).
component("YJR010W",417).
component("YCL050C",181).
component("YPR190C",660).
component("YPR187W",659).
component("YPR110C",655).
component("YPR010C",646).
component("YOR341W",612).
component("YOR340C",611).
component("YOR224C",604).
component("YOR210W",603).
component("YOR207C",600).
component("YOR151C",597).
component("YOR116C",593).
component("YOL005C",573).
component("YNR003C",565).
component("YNL248C",552).
component("YNL151C",547).
component("YNL113W",542).
component("YKL144C",445).
component("YJR063W",421).
component("YJL148W",408).
component("YJL140W",407).
component("YIL021W",378).
component("YHR143W-A",372).
component("YGL070C",317).
component("YFL036W",295).
component("YDR404C",252).
component("YDR156W",233).
component("YDR045C",218).
component("YDL150W",202).
component("YDL140C",198).
component("YBR154C",162).
component("YPR175W",658).
component("YPL167C",630).
component("YOR330C",609).
component("YOL115W",584).
component("YNL299W",561).
component("YNL262W",555).
component("YNL102W",541).
component("YJR043C",419).
component("YJR006W",416).
component("YJL090C",400).
component("YIL139C",387).
component("YEL055C",264).
component("YDR419W",254).
component("YDR121W",225).
component("YDL102W",194).
component("YCR014C",183).
component("YBR278W",172).
component("YBL035C",131).
component("YKL035W",439).
component("YHL012W",357).
component("YHR123W",370).
component("YDL142C",201).
component("YER026C",270).
component("YCL004W",176).
component("YJL068C",397).
component("YDR058C",222).
component("YNR034W",570).
component("YHR163W",374).
component("YGR248W",352).
component("YCR073W-A",186).
component("YDL086W",193).
component("YOL011W",575).
component("YMR008C",513).
component("YMR006C",512).
component("U101_",19).
component("YBL015W",130).
component("YJL068C",398).
component("YPL072W",626).
component("YOR124C",594).
component("YNL186W",549).
component("YMR304W",535).
component("YMR223W",527).
component("YKR098C",464).
component("YJL197W",413).
component("YIL156W",389).
component("YFR010W",298).
component("YER151C",288).
component("YER144C",287).
component("YER098W",285).
component("YDR069C",223).
component("YDL122W",196).
component("YBR058C",149).
component("YBL067C",135).
component("U84_",111).
component("YPR073C",651).
component("YHR215W",376).
component("YDL024C",187).
component("YBR093C",153).
component("YBR092C",152).
component("YAR071W",126).
component("YIL053W",381).
component("YER062C",278).
component("YHR046C",365).
component("YGR208W",349).
component("YPL228W",632).
component("YMR180C",523).
component("YDL236W",210).
component("YJL155C",410).
component("YPR073C",652).
component("YOR208W",601).
component("YNL053W",539).
component("YMR036C",515).
component("YIR026C",391).
component("YIL113W",385).
component("YFR028C",300).
component("YER075C",281).
component("YDL230W",209).
component("YBR276C",171).
component("U34_",81).
component("U30_",80).
component("U27_",78).
component("U25_",77).
component("U24_",76).
component("YOR360C",615).
component("YGL248W",325).
component("YKR031C",459).
component("YLR286C",490).
component("YOR190W",598).
component("YLR300W",491).
component("YGR282C",355).
component("YDR261C",241).
component("YDR400W",250).
component("U23_",75).
component("YML035C",504).
component("YJL070C",399).
component("YBR284W",173).
component("U102_",20).
component("YNL045W",538).
component("YLR160C",482).
component("YLR158C",481).
component("YLR157C",480).
component("YLR155C",479).
component("YDR321W",245).
component("YGL037C",313).
component("YDR242W",238).
component("YBR208C",165).
component("YMR281W",532).
component("U53_",91).
component("YIR032C",394).
component("YIR029W",392).
component("YPR062W",650).
component("YMR120C",520).
component("YHR144C",373).
component("YNL141W",544).
component("YBR153W",161).
component("YDL238C",211).
component("YNL141W",545).
component("YLR245C",489).
component("YML035C",505).
component("YJL126W",403).
component("U44_",85).
component("U87_",113).
component("YMR267W",530).
component("YBR011C",138).
component("YBR111C",154).
component("YCL030C",179).
component("YER005W",267).
component("YIL048W",380).
component("YER166W",289).
component("YDR093W",224).
component("YAL026C",123).
component("YLR231C",487).
component("U88_",114).
component("YLR134W",476).
component("YLR044C",471).
component("YGR087C",335).
component("YDR380W",248).
component("YDL080C",192).
component("U98_",120).
component("YMR250W",528).
component("YKL184W",452).
component("YNR043W",571).
component("U93_",118).
component("YDR047W",220).
component("U54_",92).
component("YKL211C",453) :- not remove_orf("YKL211C",453).
component("YNL169C",548).
component("YGR170W",341).
component("YNL256W",554).
component("YDR294C",242).
component("YEL046C",262).
component("YNR033W",569).
component("YKL211C",454) :- not remove_orf("YKL211C",454).
component("YER090W",454) :- not remove_orf("YER090W",454).
component("YER090W",283) :- not remove_orf("YER090W",283).
component("YDR127W",229).
component("YPL281C",643).
component("YOR393W",620).
component("YMR323W",536).
component("YHR174W",375).
component("YGR254W",353).
component("YGL026C",312) :- not remove_orf("YGL026C",312).
component("YGR155W",340).
component("YLR304C",494).
component("YJL200C",414).
component("YNL316C",562).
component("YKL182W",450).
component("YPL212C",631).
component("YNL292W",560).
component("YGL063W",316).
component("YFL001W",291).
component("YPR002W",645).
component("YDR127W",230).
component("YGL148W",319).
component("YLR359W",500).
component("YAL012W",122).
component("YFR055W",305).
component("YJL121C",402).
component("YBR019C",140).
component("YBR019C",141).
component("YDR050C",221).
component("YDR007W",212) :- not remove_orf("YDR007W",212).
component("YOR095C",592).
component("YER003C",266).
component("YBR196C",164).
component("YGL001C",307).
component("U14_",31).
component("YKL152C",448).
component("YMR105C",517).
component("YKL127W",443).
component("YEL058W",265).
component("YPR060C",649).
component("YHR072W",367).
component("YJL153C",409).
component("YPL097W",627).
component("YGR185C",346).
component("YPL104W",628).
component("YLL018C",465).
component("YPR081C",654).
component("YBR121C",156).
component("YHR020W",362).
component("YER087W",282).
component("YNL247W",551).
component("YOL033W",577).
component("YHR091C",369).
component("YDR341C",246).
component("YOL097C",583).
component("YPR047W",648).
component("YLR060W",472).
component("YFL022C",294).
component("YPR033C",647).
component("YPL160W",629).
component("YLR382C",501).
component("YDR037W",216).
component("YOR335C",610).
component("YGR094W",337).
component("YGR244C",351).
component("U89_",115).
component("YOR241W",606).
component("YMR113W",518).
component("YKL132C",444).
component("YJL101C",401).
component("U92_",117).
component("YGL234W",324).
component("U91_",116).
component("YDL141W",199).
component("YDL141W",200).
component("YJR103W",426).
component("YBL039C",132).
component("YGR204W",348).
component("YOL058W",579).
component("YBR208C",166).
component("YHR074W",368).
component("YMR217W",526).
component("YOR303W",607).
component("YJR109C",429).
component("YJL130C",405).
component("YGL062W",315).
component("YBR218C",167).
component("YPL231W",636).
component("YNR016C",568).
component("YKL182W",451).
component("YGR037C",331).
component("YOR005C",589).
component("YDL164C",203).
component("YOL010W",574).
component("YPR138C",657).
component("YPL265W",638).
component("YPL057C",625).
component("YPL036W",624).
component("YOR348C",614).
component("YOR192C",599).
component("YOR071C",591).
component("YOL156W",588).
component("YOL020W",576) :- not remove_orf("YOL020W",576).
component("YNR056C",572).
component("YNL318C",563).
component("YNL268W",557).
component("YNL142W",546).
component("YMR272C",531).
component("YML123C",511).
component("YLR348C",497).
component("YLR237W",488).
component("YLR138W",477).
component("YLR100C",475).
component("YLR081W",473).
component("YLL061W",468).
component("YLL043W",467).
component("YKR093W",463).
component("YKR053C",461).
component("YKR039W",460) :- not remove_orf("YKR039W",460).
component("YKL217W",455).
component("YJR095W",425).
component("YJR077C",423).
component("YJL219W",415).
component("YJL134W",406).
component("YJL129C",404).
component("YHL036W",359).
component("YGR121C",338).
component("YGR055W",333).
component("YGL186C",321).
component("YGL077C",318).
component("YGL008C",308).
component("YFL055W",297).
component("YFL011W",292).
component("YER060W-A",276).
component("YER060W",275).
component("YER056C",274).
component("YER053C",272).
component("YEL017C-A",261).
component("YDR536W",260).
component("YDR508C",258).
component("YDR503C",257).
component("YDR294C",243).
component("YDR046C",219) :- not remove_orf("YDR046C",219).
component("YDL210W",207).
component("YCR024C-A",184).
component("YCL025C",178).
component("YBR298C",175).
component("YBR291C",174).
component("YBR069C",151) :- not remove_orf("YBR069C",151).
component("YBR068C",150) :- not remove_orf("YBR068C",150).
component("YBR036C",147).
component("YBR021W",143).
component("YBL042C",133).
component("U79_",107).
component("U75_",105).
component("U74_",104).
component("U73_",103).
...
catalyst(6160,533).
catalyst(3870,273).
catalyst(3620,247) :- not remove_reaction(3620,247).
catalyst(2110,303).
catalyst(2190,303).
catalyst(5550,431).
catalyst(5791,486).
...
catalyst(1960,220).
catalyst(3460,92).
catalyst(3600,453) :- not remove_reaction(3600,453).
catalyst(6890,548).
catalyst(6900,341).
catalyst(2570,554).
catalyst(8781,242).
...
catalyst(4560,262).
catalyst(2550,569).
catalyst(1890,454) :- not remove_reaction(1890,454).
catalyst(3630,454) :- not remove_reaction(3630,454).
catalyst(1890,283) :- not remove_reaction(1890,283).
catalyst(3630,283) :- not remove_reaction(3630,283).
catalyst(3740,229).
catalyst(8231,643).
catalyst(8232,643).
catalyst(8231,620).
...
catalyst(8231,353).
catalyst(8232,353).
catalyst(3590,312) :- not remove_reaction(3590,312).
catalyst(10910,312) :- not remove_reaction(10910,312).
catalyst(4570,340).
catalyst(8181,494).
catalyst(8182,494).
catalyst(8181,414).
...
catalyst(8281,221).
catalyst(8282,221).
catalyst(3610,212) :- not remove_reaction(3610,212).
catalyst(7921,592).
catalyst(7922,592).
catalyst(7841,266).
catalyst(7842,266).
...
catalyst(190,591).
catalyst(1200,588).
catalyst(801,576) :- not remove_reaction(801,576).
catalyst(802,576) :- not remove_reaction(802,576).
catalyst(811,576) :- not remove_reaction(811,576).
catalyst(812,576) :- not remove_reaction(812,576).
catalyst(831,576) :- not remove_reaction(831,576).
catalyst(832,576) :- not remove_reaction(832,576).
catalyst(941,576) :- not remove_reaction(941,576).
catalyst(942,576) :- not remove_reaction(942,576).
catalyst(700,572).
catalyst(1200,563).
catalyst(761,557).
catalyst(762,557).
...
catalyst(640,463).
catalyst(6560,461).
catalyst(761,460) :- not remove_reaction(761,460).
catalyst(762,460) :- not remove_reaction(762,460).
catalyst(771,460) :- not remove_reaction(771,460).
catalyst(772,460) :- not remove_reaction(772,460).
catalyst(781,460) :- not remove_reaction(781,460).
catalyst(782,460) :- not remove_reaction(782,460).
catalyst(791,460) :- not remove_reaction(791,460).
catalyst(792,460) :- not remove_reaction(792,460).
catalyst(801,460) :- not remove_reaction(801,460).
catalyst(802,460) :- not remove_reaction(802,460).
catalyst(811,460) :- not remove_reaction(811,460).
catalyst(812,460) :- not remove_reaction(812,460).
catalyst(821,460) :- not remove_reaction(821,460).
catalyst(822,460) :- not remove_reaction(822,460).
catalyst(831,460) :- not remove_reaction(831,460).
catalyst(832,460) :- not remove_reaction(832,460).
catalyst(841,460) :- not remove_reaction(841,460).
catalyst(842,460) :- not remove_reaction(842,460).
catalyst(861,460) :- not remove_reaction(861,460).
catalyst(862,460) :- not remove_reaction(862,460).
catalyst(881,460) :- not remove_reaction(881,460).
catalyst(882,460) :- not remove_reaction(882,460).
catalyst(911,460) :- not remove_reaction(911,460).
catalyst(912,460) :- not remove_reaction(912,460).
catalyst(941,460) :- not remove_reaction(941,460).
catalyst(942,460) :- not remove_reaction(942,460).
catalyst(1191,460) :- not remove_reaction(1191,460).
catalyst(1192,460) :- not remove_reaction(1192,460).
catalyst(1021,455).
catalyst(1022,455).
catalyst(1250,425).
catalyst(1581,423).
...
catalyst(861,219) :- not remove_reaction(861,219).
catalyst(862,219) :- not remove_reaction(862,219).
catalyst(730,207).
catalyst(220,184).
catalyst(771,178).
catalyst(772,178).
...
catalyst(1511,174).
catalyst(1512,174).
catalyst(771,151) :- not remove_reaction(771,151).
catalyst(772,151) :- not remove_reaction(772,151).
...
catalyst(791,150) :- not remove_reaction(791,150).
catalyst(792,150) :- not remove_reaction(792,150).
catalyst(801,150) :- not remove_reaction(801,150).
catalyst(802,150) :- not remove_reaction(802,150).
catalyst(811,150) :- not remove_reaction(811,150).
catalyst(812,150) :- not remove_reaction(812,150).
catalyst(831,150) :- not remove_reaction(831,150).
catalyst(832,150) :- not remove_reaction(832,150).
catalyst(841,150) :- not remove_reaction(841,150).
catalyst(842,150) :- not remove_reaction(842,150).
catalyst(861,150) :- not remove_reaction(861,150).
catalyst(862,150) :- not remove_reaction(862,150).
catalyst(6600,147).
catalyst(620,143).
catalyst(540,133).
catalyst(2830,107).
