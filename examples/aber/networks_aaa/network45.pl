...
component("YGR060W",195).
component("YGL012W",180).
component("YOL086C",333).
component("YMR303C",305).
component("YGL256W",190).
component("YDL168W",119).
component("YBR145W",88).
component("YPL231W",368).
component("YGL001C",177).
component("YML056C",289).
component("YLR432W",286).
component("YHR216W",217).
component("YAR075W",73).
component("YAR073W",72).
component("YDR127W",132).
component("YJR139C",250).
component("YOR136W",340).
component("YDL066W",112).
component("YIL155C",223).
component("YJR078W",243).
component("YJR025C",238).
component("YBL098W",78).
component("YMR015C",293).
component("YDR402C",149).
component("YJR104C",246).
component("YHR008C",209).
component("YER070W",164).
component("YDL168W",120).
component("YPL276W",376).
component("YPL275W",375).
component("YOR388C",358).
component("YGL154C",187).
component("YOR323C",351).
component("YMR170C",300).
component("YMR169C",299).
component("YBR166C",91).
component("YNL280C",319).
component("YER014W",161).
component("YMR118C",297).
component("YLR164W",276).
component("YLL041C",271).
component("YKL148C",259).
component("YJL045W",227).
component("YDR178W",138).
component("YJR051W",240).
component("YEL047C",158).
component("YOR375C",357).
component("YDL215C",121).
component("YAL062W",71).
component("YBR035C",81).
component("YER023W",162).
component("YOR236W",349).
component("YGR204W",202).
component("U62_",52).
component("YKL150W",260).
component("YIL043C",219).
component("YPL017C",361).
component("YFL018C",169).
component("YPL273W",374).
component("YLL062C",272).
component("U47_",46).
component("YKL024C",253).
component("YPR074C",383).
component("YBR117C",87).
component("YCL009C",102).
component("YMR062C",295).
component("YPL231W",369).
component("YPL001W",360).
component("YPL231W",370).
component("YGR147C",199).
component("YDL040C",111).
component("YPL028W",362).
component("YPR001W",378).
component("YNR001C",323).
component("YNL117W",312).
component("YIR031C",225).
component("YNL029C",307).
component("YIL085C",220).
component("YLR209C",277).
component("YMR300C",304).
component("YER055C",163).
component("YDR354W",145) :- not remove_orf("YDR354W",145).
component("YFR047C",175).
component("YJR133W",249).
component("YML022W",287).
component("YDR441C",152).
component("YDR399W",147).
component("YDR127W",133).
component("YJR130C",248).
component("YLR303W",283).
component("YDR035W",126).
component("YBR249C",95).
component("YBR256C",96).
component("YHR137W",212).
component("YGL202W",188).
component("YLR027C",273).
component("YKL106W",256).
component("YKL104C",255).
component("YGR019W",192).
component("U64_",53).
component("U51_",48).
component("YJR148W",251).
component("YGL253W",189).
component("YFR053C",176).
component("YMR205C",302).
component("YGR240C",203).
component("YDR248C",140).
component("YCR036W",109).
component("YCL040W",104).
component("YJR105W",247).
component("U16_",26).
component("U15_",24).
component("YKL001C",252).
component("YML070W",290).
component("YFL053W",171).
component("U83_",63).
component("U82_",62).
component("YMR208W",303).
component("YOR347C",356).
component("YAL038W",70).
component("YPR121W",385).
component("YPL258C",372).
component("YOL055C",330).
component("U1_",34).
component("YNL267W",318).
component("YLR305C",284).
component("YFR019W",173).
component("YDR208W",139).
component("YDR127W",134).
component("U21_",38).
component("U20_",37).
component("YDR300C",143).
component("YCR012W",106).
component("U18_",31).
component("U76_",61).
component("YDR454C",153).
component("YOL061W",332).
component("YKL181W",261).
component("YHL011C",206).
component("YER099C",167).
component("YBL068W",77).
component("YOR143C",341).
component("YGR007W",191).
component("YCL050C",105).
component("YPR190C",389).
component("YPR187W",388).
component("YPR110C",384).
component("YPR010C",379).
component("YOR341W",355).
component("YOR340C",354).
component("YOR224C",348).
component("YOR210W",347).
component("YOR207C",345).
component("YOR151C",342).
component("YOR116C",339).
component("YOL005C",327).
component("YNR003C",324).
component("YNL248C",316).
component("YNL151C",315).
component("YNL113W",311).
component("YKL144C",258).
component("YJR063W",241).
component("YJL148W",235).
component("YJL140W",234).
component("YIL021W",218).
component("YHR143W-A",213).
component("YGL070C",185).
component("YFL036W",170).
component("YDR404C",150).
component("YDR156W",137).
component("YDR045C",127).
component("YDL150W",117).
component("YDL140C",116).
component("YBR154C",90).
component("YPR175W",387).
component("YPL167C",365).
component("YOR330C",352).
component("YOL115W",335).
component("YNL299W",321).
component("YNL262W",317).
component("YNL102W",310).
component("YJR043C",239).
component("YJR006W",237).
component("YJL090C",229).
component("YIL139C",222).
component("YEL055C",159).
component("YDR419W",151).
component("YDR121W",131).
component("YDL102W",115).
component("YCR014C",107).
component("YBR278W",98).
component("YBL035C",75).
component("YKL035W",254).
component("YHL012W",207).
component("YDR058C",130).
component("YDL086W",114).
component("YOL011W",328).
component("YMR008C",292).
component("YMR006C",291).
component("U101_",18).
component("YBL015W",74).
component("U84_",64).
component("YPR073C",381).
component("YHR215W",216).
component("YDL024C",110).
component("YBR093C",85).
component("YBR092C",84).
component("YPL228W",367).
component("YMR180C",301).
component("YDL236W",123).
component("YJL155C",236).
component("YPR073C",382).
component("YOR208W",346).
component("YNL053W",309).
component("YMR036C",294).
component("YIR026C",224).
component("YIL113W",221).
component("YFR028C",174).
component("YER075C",165).
component("YDL230W",122).
component("YBR276C",97).
component("U34_",44).
component("U30_",43).
component("U25_",42).
component("U24_",41).
component("YKR031C",267).
component("YLR286C",281).
component("YOR190W",343).
component("YLR300W",282).
component("YGR282C",205).
component("YDR261C",141).
component("YDR400W",148).
component("YML035C",288).
component("YJL070C",228).
component("YBR284W",99).
component("YNL045W",308).
component("YGL037C",182).
component("YBR208C",92).
component("U53_",49).
component("YIR032C",226).
component("YMR120C",298).
component("YHR144C",214).
component("YBR153W",89).
component("YDL238C",124).
component("YNL141W",313).
component("YLR245C",280).
component("YJL126W",231).
component("YBR111C",86).
component("YER005W",160).
component("YLR231C",278).
component("U88_",65).
component("YLR134W",275).
component("YLR044C",274).
component("YGR087C",196).
component("YDR380W",146).
component("YDL080C",113).
component("U98_",68).
component("YKL184W",264).
component("U93_",67).
component("U54_",50).
component("YKL211C",265) :- not remove_orf("YKL211C",265).
component("YGR170W",201).
component("YDR294C",142).
component("YNR033W",326).
component("YKL211C",266) :- not remove_orf("YKL211C",266).
component("YER090W",266) :- not remove_orf("YER090W",266).
component("YER090W",166) :- not remove_orf("YER090W",166).
component("YDR127W",135).
component("YPL281C",377).
component("YOR393W",359).
component("YMR323W",306).
component("YHR174W",215).
component("YGR254W",204).
component("YGL026C",181) :- not remove_orf("YGL026C",181).
component("YGR155W",200).
component("YNL316C",322).
component("YKL182W",262).
component("YPL212C",366).
component("YNL292W",320).
component("YGL063W",184).
component("YFL001W",168).
component("YDR127W",136).
component("YGL148W",186).
component("YAL012W",69).
component("YBR019C",79).
component("YDR050C",129).
component("YDR007W",125) :- not remove_orf("YDR007W",125).
component("YOR095C",338).
component("YGL001C",178).
component("YMR105C",296).
component("YKL127W",257).
component("YPR060C",380).
component("YPL104W",364).
component("YLL018C",270).
component("YHR091C",211).
component("YDR341C",144).
component("YOL097C",334).
component("YOR335C",353).
component("YGR094W",197).
component("U89_",66).
component("YJL101C",230).
component("YJR103W",245).
component("YBL039C",76).
component("YOL058W",331).
component("YBR208C",93).
component("YHR074W",210).
component("YOR303W",350).
component("YGL062W",183).
component("YBR218C",94).
component("YPL231W",371).
component("YNR016C",325).
component("YKL182W",263).
component("YGR037C",193).
component("YOR005C",336).
component("YDL164C",118).
component("YPR138C",386).
component("YPL265W",373).
component("YPL036W",363).
component("YOR192C",344).
component("YOR071C",337).
component("YOL020W",329) :- not remove_orf("YOL020W",329).
component("YNL142W",314).
component("YLR348C",285).
component("YLR237W",279).
component("YKR053C",269).
component("YKR039W",268) :- not remove_orf("YKR039W",268).
component("YJR095W",244).
component("YJR077C",242).
component("YJL134W",233).
component("YJL129C",232).
component("YHL036W",208).
component("YGR121C",198).
component("YGR055W",194).
component("YGL008C",179).
component("YFL055W",172).
component("YEL017C-A",157).
component("YDR536W",156).
component("YDR508C",155).
component("YDR503C",154).
component("YDR046C",128) :- not remove_orf("YDR046C",128).
component("YCR024C-A",108).
component("YCL025C",103).
component("YBR298C",101).
component("YBR291C",100).
component("YBR069C",83) :- not remove_orf("YBR069C",83).
component("YBR068C",82) :- not remove_orf("YBR068C",82).
component("YBR021W",80).
component("U75_",60).
component("U74_",59).
component("U73_",58).
component("U72_",57).
...
catalyst(6160,304).
catalyst(3870,163).
catalyst(3620,145) :- not remove_reaction(3620,145).
catalyst(2190,175).
catalyst(5550,249).
catalyst(5650,287).
catalyst(5650,152).
...
catalyst(2300,67).
catalyst(3460,50).
catalyst(3600,265) :- not remove_reaction(3600,265).
catalyst(6900,201).
catalyst(8781,142).
catalyst(8782,142).
catalyst(2550,326).
catalyst(3630,266) :- not remove_reaction(3630,266).
catalyst(3630,166) :- not remove_reaction(3630,166).
catalyst(3740,135).
catalyst(8231,377).
catalyst(8232,377).
catalyst(8231,359).
...
catalyst(8231,204).
catalyst(8232,204).
catalyst(3590,181) :- not remove_reaction(3590,181).
catalyst(10910,181) :- not remove_reaction(10910,181).
catalyst(4570,200).
catalyst(3680,322).
catalyst(7141,262).
catalyst(7142,262).
...
catalyst(190,279).
catalyst(6560,269).
catalyst(771,268) :- not remove_reaction(771,268).
catalyst(772,268) :- not remove_reaction(772,268).
catalyst(781,268) :- not remove_reaction(781,268).
catalyst(782,268) :- not remove_reaction(782,268).
catalyst(801,268) :- not remove_reaction(801,268).
catalyst(802,268) :- not remove_reaction(802,268).
catalyst(811,268) :- not remove_reaction(811,268).
catalyst(812,268) :- not remove_reaction(812,268).
catalyst(831,268) :- not remove_reaction(831,268).
catalyst(832,268) :- not remove_reaction(832,268).
catalyst(841,268) :- not remove_reaction(841,268).
catalyst(842,268) :- not remove_reaction(842,268).
catalyst(881,268) :- not remove_reaction(881,268).
catalyst(882,268) :- not remove_reaction(882,268).
catalyst(1191,268) :- not remove_reaction(1191,268).
catalyst(1192,268) :- not remove_reaction(1192,268).
catalyst(1250,244).
catalyst(1581,242).
catalyst(1582,242).
catalyst(6560,233).
...
catalyst(1501,100).
catalyst(1502,100).
catalyst(771,83) :- not remove_reaction(771,83).
catalyst(772,83) :- not remove_reaction(772,83).
catalyst(801,83) :- not remove_reaction(801,83).
catalyst(802,83) :- not remove_reaction(802,83).
catalyst(811,83) :- not remove_reaction(811,83).
catalyst(812,83) :- not remove_reaction(812,83).
catalyst(801,82) :- not remove_reaction(801,82).
catalyst(802,82) :- not remove_reaction(802,82).
catalyst(811,82) :- not remove_reaction(811,82).
catalyst(812,82) :- not remove_reaction(812,82).
catalyst(831,82) :- not remove_reaction(831,82).
catalyst(832,82) :- not remove_reaction(832,82).
catalyst(841,82) :- not remove_reaction(841,82).
catalyst(842,82) :- not remove_reaction(842,82).
catalyst(620,80).
catalyst(2920,60).
catalyst(2920,59).
catalyst(2920,58).
