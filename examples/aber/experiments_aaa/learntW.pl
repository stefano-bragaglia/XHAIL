...
#modeh inhibited(+experiment,$modifiable_enzyme,$day) : 2-2.
#modeh additional_nutrient(+experiment, $metabolite, medium) : 1.
...
#example not predicted_growth(1, 1) =10.
...
#example not predicted_growth(2, 1) =10.
...
#example not predicted_growth(3, 1) =10.
...
#example not predicted_growth(4, 1) =10.
...
#example predicted_growth(5, 1) =10.
...
#example not predicted_growth(6, 1) =10.
...
#example not predicted_growth(7, 1) =10.
...
#example not predicted_growth(8, 1) =10.
...
#example predicted_growth(9, 1) =10.
...
#example predicted_growth(10, 1) =10.
...
#example predicted_growth(11, 1) =10.
...
#example predicted_growth(12, 1) =10.
...
#example predicted_growth(13, 1) =10.
...
#example not predicted_growth(14, 1) =10.
...
#example predicted_growth(15, 1) =10.
...
#example not predicted_growth(16, 1) =10.
...
#example predicted_growth(17, 1) =10.
...
#example predicted_growth(18, 1) =10.
...
#example predicted_growth(19, 1) =10.
...
#example predicted_growth(20, 1) =10.
...
#example predicted_growth(21, 1) =10.
...
#example predicted_growth(22, 1) =10.
...
#example predicted_growth(23, 1) =10.
...
#example predicted_growth(24, 1) =10.
...
#example predicted_growth(25, 1) =10.
...
#example not predicted_growth(26, 1) =10.
...
#example not predicted_growth(27, 1) =10.
...
#example not predicted_growth(28, 1) =10.
...
#example not predicted_growth(29, 1) =10.
...
#example not predicted_growth(30, 1) =10.
...
#example not predicted_growth(31, 1) =10.
...
#example predicted_growth(32, 1) =10.
...
#example not predicted_growth(33, 1) =10.
...
#example not predicted_growth(34, 1) =10.
...
#example predicted_growth(35, 1) =10.
...
#example not predicted_growth(36, 1) =10.
...
#example not predicted_growth(37, 1) =10.
...
#example predicted_growth(38, 1) =10. 
...
#example not predicted_growth(39, 1) =10.
...
#example not predicted_growth(40, 1) =10.
