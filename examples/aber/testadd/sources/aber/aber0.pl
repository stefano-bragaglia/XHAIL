...
reaction(30100, certain, "none", 1, [reactant(medium, 1, "C00003")], [reactant(cytosol, 1, "C00003")]). % was (->)
...
enzyme(55, modifiable, "4.1.3.27", ["YKL211C", "YER090W"], [3630]).
...
enzyme(44, modifiable, "4.2.1.20", ["YGL026C"], [3590, 10910]).
