...
component("YNL280C",668).
component("YLR056W",573).
component("YGR060W",398).
component("YGL012W",370).
component("YKR009C",555).
component("YOL086C",694).
component("YMR303C",642).
component("YGL256W",392).
component("YDL168W",250).
component("YBR145W",189).
component("YPL231W",756).
component("YBR265W",204).
component("U46_",110).
component("YBR149W",190).
component("YBR149W",191).
component("YGL001C",367).
component("YIL094C",466).
component("U45_",109).
component("YML056C",619).
component("YLR432W",609).
component("YHR216W",458).
component("YAR075W",161).
component("YAR073W",160).
component("YDR127W",275).
component("YJR139C",529).
component("YML075C",621).
component("YLR450W",612).
component("YOL126C",700).
component("YKL085W",537).
component("YDL078C",236).
component("YNL037C",647).
component("YNL009W",645).
component("YLR174W",586).
component("YHR183W",451).
component("YGR256W",417).
component("YNL241C",661).
component("YOL059W",691).
component("YDL022W",229).
component("YCL018W",212).
component("YLR355C",604).
component("YIL074C",463).
component("YER081W",342).
component("YDL174C",254).
component("YML086C",623).
component("YIL155C",475).
component("YGR088W",401).
component("YDR256C",288).
component("YKL026C",535).
component("YIR037W",485).
component("YBR244W",200).
component("YJR078W",522).
component("U58_",119).
component("YJR025C",514).
component("U107_",24).
component("YHR007C",427).
component("YDR402C",302).
component("YGL055W",377).
component("YJR104C",524).
component("YHR008C",428).
component("YOR384W",736).
component("YOR381W",735).
component("YOL152W",702).
component("YLL051C",566).
component("YJL026W",487).
...
component("YJR009C",511).
component("YJL052W",489).
component("YGR192C",409).
component("YBR006W",171).
component("YPL276W",764).
component("YPL275W",763).
component("YOR388C",737).
component("YOR374W",733).
component("YER073W",340).
component("YGL154C",384).
component("YBR115C",185).
component("U55_",118).
component("YER069W",337).
component("YOR323C",725).
component("YER178W",351).
component("YBR221C",198).
component("YIL125W",471).
component("U52_",115).
component("YBR166C",193).
component("YGL012W",371).
component("YKL182W",546).
component("YKL216W",554).
component("YDR044W",266).
component("YKR009C",556).
component("YIL160C",476).
component("YGL205W",389).
component("YMR118C",632).
component("YLR164W",584).
component("YLL041C",565).
component("YKL148C",541).
component("YKL141W",539).
component("YJL045W",488).
component("YDR178W",283).
component("YEL047C",322).
component("YDL171C",252).
component("YDL171C",253).
component("YOR375C",734).
component("YDL215C",258).
component("YAL062W",157).
component("U99_",152).
component("U100_",20).
component("YBR035C",177).
component("YKR080W",561).
component("YER023W",329).
component("YOR236W",723).
component("YGR204W",411).
component("YIR034C",484).
component("YLR142W",581).
component("U65_",125).
component("U63_",123).
component("U62_",122).
component("YHR068W",437).
component("YKL150W",542).
component("YIL043C",461).
component("YHR042W",432).
component("YPL171C",749).
component("YHR179W",450).
component("YMR145C",635).
component("YML120C",624).
component("YKL192C",549).
component("YDL085W",238).
component("YGR234W",413).
component("YFR030W",363).
component("YPL017C",739).
component("YFL018C",355).
component("YDR353W",298).
component("YPR167C",779).
component("YJR137C",528).
component("YNL052W",649).
component("YMR256C",641).
component("YLR395C",608).
component("YLR038C",571).
component("YIL111W",468).
component("YHR051W",436).
component("YGL191W",387).
component("YGL187C",386).
component("YDL067C",235).
component("Q0275",19).
component("Q0250",18).
component("YDR072C",271).
component("YPL266W",762).
component("YKR069W",560).
component("YOL096C",695).
component("U47_",111).
component("YER091C",347).
component("YJR073C",520).
component("YGR157W",405).
component("YDR120C",273).
component("YML008C",614).
component("YOR074C",707).
component("YDL033C",231).
component("YOL096C",696).
component("YLR172C",585).
component("YLR058C",574).
component("YDR019C",264).
component("YBR176W",194).
component("YDR408C",304).
component("YMR120C",633).
component("YLR028C",569).
component("YBL013W",162).
component("YJL130C",497).
component("YKL024C",534).
component("YPR074C",774).
component("YBR117C",186).
component("YMR108W",631).
component("YCL009C",211).
component("YNL071W",651).
component("YNR008W",673).
component("YIL160C",477).
component("YNR019W",676).
component("YCR048W",225).
component("U48_",112).
component("YDR232W",285).
component("YPL231W",757).
component("YER061C",336).
component("YDL052C",234).
component("U8_",146).
component("YPL231W",758).
component("YPL028W",740).
component("YLR299W",596).
component("YGL017W",372).
component("YCR005C",217).
component("YML126C",625).
component("YNL104C",654).
component("YDL182W",255).
component("YDL131W",242).
component("YDR307W",294).
component("YLR258W",593).
component("YFR015C",361).
component("YNL029C",646).
component("YIL085C",465).
component("YMR306W",643).
component("YLR342W",602).
component("YGR032W",395).
component("YLR209C",588).
component("U104_",21).
component("YDR354W",299) :- not remove_orf("YDR354W",299).
component("YFR047C",364).
component("YJR133W",527).
component("YLR209C",589).
component("YML022W",616).
component("YDR441C",307).
component("YHR128W",445).
component("YJL167W",503).
component("YJL167W",504).
component("YPR069C",771).
component("YDR127W",276).
component("YHR190W",453).
component("YLR146C",582).
component("YHR068W",438).
component("YLR303W",598).
component("YGR012W",393).
component("YML082W",622).
component("YJR130C",526).
component("YDR035W",265).
component("YBR249C",201).
component("YLR180W",587).
component("YDR502C",311).
component("YOR274W",724).
component("YBR256C",203).
component("YHR137W",446).
component("YGL202W",388).
component("YLR027C",568).
component("YKL106W",538).
component("YOL140W",701).
component("YLR438W",611).
component("YGR019W",394).
component("YLR089C",577).
component("U64_",124).
component("U61_",121).
component("U51_",114).
component("YJR148W",530).
component("YHR208W",456).
component("YFL030W",357).
component("YOR184W",716).
component("YNR058W",681).
component("YIL116W",470).
component("YGL253W",391).
component("YFR053C",365).
component("YMR013C",629).
component("YMR205C",637).
component("YGR240C",414).
component("YOL016C",685).
component("YFR014C",360).
component("YLR240W",591).
component("YKL203C",551).
component("YJR066W",519).
component("YCR036W",224).
component("YCL040W",214).
component("U15_",54).
component("YPL188W",751).
component("YJR049C",516).
component("YEL041W",320).
component("U96_",150).
component("YKL001C",533).
...
component("YPL203W",752).
component("YOR061W",706).
component("YKL166C",544).
component("YJL164C",502).
component("YIL035C",460).
component("YHR205W",455).
component("YHR102W",444).
component("YGL019W",373).
component("YHR025W",431).
component("YOR347C",730).
component("YAL038W",155).
component("YNR012W",674).
component("YDR009W",263).
component("YDR127W",277).
component("YDR147W",280).
component("YDR300C",293).
component("YCR012W",218).
component("YER069W",338).
component("U19_",81).
component("U18_",73).
component("U17_",65).
component("U76_",134).
component("YER170W",350).
component("YDR226W",284).
component("YKL067W",536).
component("YOL055C",688).
component("YDR454C",308).
component("YJR057W",517).
component("YOL061W",692).
component("YKL181W",545).
component("YHL011C",424).
component("YER099C",348).
component("YBL068W",169).
component("YOR143C",712).
component("YNL256W",664).
component("YLR328W",600).
component("YBR018C",173).
component("YGR202C",410).
component("YLR328W",601).
component("U80_",138).
component("U94_",149).
component("YJR010W",512).
component("YBR029C",176).
component("YCL050C",215).
component("YGL130W",382).
component("YDR530C",314).
component("YPR190C",782).
component("YPR187W",781).
component("YPR110C",776).
component("YPR010C",767).
component("YOR341W",729).
component("YOR340C",728).
component("YOR224C",722).
component("YOR210W",720).
component("YOR207C",718).
component("YOR151C",713).
component("YOR116C",709).
component("YOL005C",683).
component("YNR003C",672).
component("YNL248C",663).
component("YNL151C",658).
component("YNL113W",655).
component("YKL144C",540).
component("YJR063W",518).
component("YJL148W",501).
component("YJL140W",500).
component("YIL021W",459).
component("YHR143W-A",447).
component("YGL070C",380).
component("YFL036W",358).
component("YDR404C",303).
component("YDR156W",281).
component("YDR045C",267).
component("YDL150W",249).
component("YDL140C",244).
component("YBR154C",192).
component("YPR175W",780).
component("YPL167C",748).
component("YOR330C",726).
component("YOL115W",699).
component("YNL299W",670).
component("YNL262W",666).
component("YNL102W",653).
component("YJR043C",515).
component("YJR006W",510).
component("YJL090C",492).
component("YIL139C",473).
component("YEL055C",323).
component("YDR419W",305).
component("YDR121W",274).
component("YDL102W",241).
component("YCR014C",219).
component("YBR278W",206).
component("YBL035C",165).
component("YPR113W",777).
component("YBR243C",199).
component("YPL148C",746).
component("YER026C",330).
component("YGR286C",421).
component("YHR189W",452).
component("YDR058C",270).
component("YDL086W",239).
component("YOL011W",684).
component("YMR008C",627).
component("YMR006C",626).
component("U105_",22).
component("YBL015W",163).
component("YJL068C",490).
component("YOR040W",705).
component("U77_",135).
component("YDR481C",309).
component("YLR377C",606).
component("YPL179W",750).
component("YNR032W",677).
component("YML057W",620).
component("YML016C",615).
component("YLR433C",610).
component("YGR123C",403).
component("YER133W",349).
component("YER089C",345).
component("YDR436W",306).
component("YDR075W",272).
component("YDL188C",256).
component("YDL134C",243).
component("YDL047W",233).
component("YDL006W",227).
component("YBR125C",188).
component("YBL056W",168).
component("YPR073C",772).
component("YHR215W",457).
component("YDL024C",230).
component("YBR093C",183).
component("YBR092C",182).
component("YAR071W",159).
component("YHR046C",435).
component("U9_",153).
component("YPL228W",755).
component("YMR180C",636).
component("YDL236W",260).
component("YPR073C",773).
component("YOR208W",719).
component("YNL053W",650).
component("YMR036C",630).
component("YIR026C",483).
component("YIL113W",469).
component("YFR028C",362).
component("YER075C",341).
component("YDL230W",259).
component("YBR276C",205).
component("U34_",101).
component("U33_",100).
component("U32_",99).
component("U31_",98).
...
component("YOL064C",693).
component("YOR360C",732).
component("YKR031C",557).
component("YPL206C",753).
component("YGL027C",375).
component("YLR286C",595).
component("YJR153W",531).
component("YJL221C",509).
component("YJL216C",507).
component("YIL172C",481).
component("YGR292W",423).
component("YGR287C",422).
component("YBR299W",210).
component("YBR184W",195).
component("YIL162W",478).
component("YIR019C",482).
component("YIL099W",467).
component("YDL037C",232).
component("YOR190W",717).
component("YLR300W",597).
component("YGR282C",420).
component("YDR261C",289).
component("YDR400W",301).
component("YML035C",617).
component("YJL070C",491).
component("YBR284W",207).
component("U106_",23).
component("YER043C",331).
component("YNL045W",648).
component("YGL037C",376).
component("YDR242W",287).
component("U53_",116).
component("YPR062W",770).
component("YMR120C",634).
component("YLR028C",570).
component("YHR144C",448).
component("YGR267C",419).
component("YBL033C",164).
component("YNL141W",656).
component("YLR245C",592).
component("YML035C",618).
component("YBR084W",180).
component("YJL126W",495).
component("U44_",108).
component("YDL100C",240).
component("U87_",143).
component("U40_",106).
component("U39_",104).
component("YBR011C",172).
component("YHR201C",454).
component("YBR111C",184).
component("YBR252W",202).
component("YER005W",328).
component("YBL099W",170).
component("YLR231C",590).
component("U88_",144).
component("YDR538W",317).
component("YLR134W",579).
component("YLR044C",572).
component("YGR087C",400).
component("YDR380W",300).
component("YDL080C",237).
component("U98_",151).
component("YMR250W",640).
component("YOR128C",710).
component("YEL021W",319).
component("YNR043W",679).
component("U93_",148).
component("U54_",117).
component("YKL211C",552) :- not remove_orf("YKL211C",552).
component("YKR097W",563).
component("YNL169C",659).
component("YNL256W",665).
component("YDR294C",291).
component("YEL046C",321).
component("YNR033W",678).
component("YKL211C",553) :- not remove_orf("YKL211C",553).
component("YER090W",553) :- not remove_orf("YER090W",553).
component("YER090W",346) :- not remove_orf("YER090W",346).
component("YDR127W",278).
component("YPL281C",765).
component("YOR393W",738).
component("YMR323W",644).
component("YHR174W",449).
component("YGR254W",416).
component("YPL262W",760).
component("YGL026C",374) :- not remove_orf("YGL026C",374).
component("YGR155W",404).
component("YLR304C",599).
component("YJL200C",505).
component("YNL316C",671).
component("YKL182W",547).
component("YPL212C",754).
component("YNL292W",669).
component("YGL063W",379).
component("YFL001W",353).
component("YPR002W",766).
component("YJR016C",513).
component("YCR053W",226).
component("YDR127W",279).
component("YGL148W",383).
component("YIL168W",480).
component("YIL167W",479).
component("YCL064C",216).
component("YER086W",343).
component("YLR359W",605).
component("YAL012W",154).
component("YML004C",613).
component("YFR055W",366).
component("YJL005W",486).
component("YJL121C",494).
component("YBR019C",174).
component("YDR050C",269).
component("YDR007W",262) :- not remove_orf("YDR007W",262).
component("YOR095C",708).
component("YER003C",327).
component("YBR196C",196).
component("YGL001C",368).
component("YPL117C",744).
component("U14_",46).
component("YOL056W",689).
component("YKL152C",543).
component("YDL021W",228).
component("YEL058W",324).
component("YPR060C",769).
component("YHR072W",439).
component("YPL097W",742).
component("YGR185C",408).
component("YGR264C",418).
component("YGR171C",406).
component("YPL104W",743).
component("YLL018C",564).
component("YPR081C",775).
component("YBR121C",187).
component("YHR020W",430).
component("YER087W",344).
component("YNL247W",662).
component("YOR168W",714).
component("YOL097C",697).
component("YDR268W",290).
component("YPR047W",768).
component("YLR060W",575).
component("YFL022C",356).
component("YCR024C",220).
component("YHR019C",429).
component("YKL194C",550).
component("YIL078W",464).
component("YPL160W",747).
component("YLR382C",607).
component("YNL073W",652).
component("YOR335C",727).
component("YLR153C",583).
component("YAL054C",156).
component("YGR244C",415).
component("YIL145C",474).
component("U89_",145).
component("YJL101C",493).
component("YOL049W",687).
component("YAR015W",158).
component("YER183C",352).
component("U90_",147).
component("YNR057C",680).
component("YDL141W",245).
component("YDL141W",246).
component("YGL234W",390).
component("YDL141W",247).
component("YJR103W",523).
component("YBL039C",166).
component("YGR204W",412).
component("YBR084W",181).
component("YNL220W",660).
component("YOL058W",690).
component("YDL141W",248).
component("YHR074W",440).
component("YMR217W",639).
component("YJR109C",525).
...
component("YGR037C",396).
component("YPR138C",778).
component("YPL265W",761).
component("YPL134C",745).
component("YPL036W",741).
component("YOR348C",731).
component("YOR222W",721).
component("YOR171C",715).
component("YOR130C",711).
component("YOR011W",704).
component("YOL156W",703).
component("YOL103W",698).
component("YOL020W",686) :- not remove_orf("YOL020W",686).
component("YNR072W",682).
component("YNL270C",667).
component("YNL142W",657).
component("YMR011W",628).
component("YLR348C",603).
component("YLR260W",594).
component("YLR138W",580).
component("YLR100C",578).
component("YLR081W",576).
component("YLL061W",567).
component("YKR093W",562).
component("YKR053C",559).
component("YKR039W",558) :- not remove_orf("YKR039W",558).
component("YJR158W",532).
component("YJR077C",521).
component("YJL219W",508).
component("YJL214W",506).
component("YJL134W",499).
component("YJL129C",496).
component("YIL134W",472).
component("YHR096C",443).
component("YHR094C",442).
component("YHR092C",441).
component("YHL036W",426).
component("YGR121C",402).
component("YGR065C",399).
component("YGR055W",397).
component("YGL186C",385).
component("YGL077C",381).
component("YGL008C",369).
component("YFL055W",359).
component("YFL011W",354).
component("YER060W-A",335).
component("YER060W",334).
component("YER056C",333).
component("YER053C",332).
component("YEL069C",326).
component("YEL063C",325).
component("YEL017C-A",318).
component("YDR536W",316).
component("YDR508C",313).
component("YDR503C",312).
component("YDR497C",310).
component("YDR345C",297).
component("YDR343C",296).
component("YDR342C",295).
component("YDR297W",292).
component("YDR046C",268) :- not remove_orf("YDR046C",268).
component("YDL245C",261).
component("YDL210W",257).
component("YCR032W",223).
component("YCR028C",222).
component("YCR024C-A",221).
component("YCL025C",213).
component("YBR298C",209).
component("YBR291C",208).
component("YBR069C",179) :- not remove_orf("YBR069C",179).
component("YBR068C",178) :- not remove_orf("YBR068C",178).
component("YBR021W",175).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,299) :- not remove_reaction(3620,299).
catalyst(2110,364).
catalyst(2190,364).
catalyst(5550,527).
catalyst(5791,589).
...
catalyst(2300,148).
catalyst(3460,117).
catalyst(3600,552) :- not remove_reaction(3600,552).
catalyst(8000,563).
catalyst(6890,659).
catalyst(2570,665).
catalyst(8781,291).
...
catalyst(4560,321).
catalyst(2550,678).
catalyst(1890,553) :- not remove_reaction(1890,553).
catalyst(3630,553) :- not remove_reaction(3630,553).
catalyst(1890,346) :- not remove_reaction(1890,346).
catalyst(3630,346) :- not remove_reaction(3630,346).
catalyst(3740,278).
catalyst(8231,765).
catalyst(8232,765).
catalyst(8231,738).
...
catalyst(1210,703).
catalyst(1160,698).
catalyst(801,686) :- not remove_reaction(801,686).
catalyst(802,686) :- not remove_reaction(802,686).
catalyst(811,686) :- not remove_reaction(811,686).
catalyst(812,686) :- not remove_reaction(812,686).
catalyst(831,686) :- not remove_reaction(831,686).
catalyst(832,686) :- not remove_reaction(832,686).
catalyst(901,686) :- not remove_reaction(901,686).
catalyst(902,686) :- not remove_reaction(902,686).
catalyst(1180,682).
catalyst(1210,682).
catalyst(931,667).
catalyst(932,667).
...
catalyst(640,562).
catalyst(6560,559).
catalyst(771,558) :- not remove_reaction(771,558).
catalyst(772,558) :- not remove_reaction(772,558).
catalyst(781,558) :- not remove_reaction(781,558).
catalyst(782,558) :- not remove_reaction(782,558).
catalyst(801,558) :- not remove_reaction(801,558).
catalyst(802,558) :- not remove_reaction(802,558).
catalyst(811,558) :- not remove_reaction(811,558).
catalyst(812,558) :- not remove_reaction(812,558).
catalyst(831,558) :- not remove_reaction(831,558).
catalyst(832,558) :- not remove_reaction(832,558).
catalyst(841,558) :- not remove_reaction(841,558).
catalyst(842,558) :- not remove_reaction(842,558).
catalyst(851,558) :- not remove_reaction(851,558).
catalyst(852,558) :- not remove_reaction(852,558).
catalyst(881,558) :- not remove_reaction(881,558).
catalyst(882,558) :- not remove_reaction(882,558).
catalyst(901,558) :- not remove_reaction(901,558).
catalyst(902,558) :- not remove_reaction(902,558).
catalyst(921,558) :- not remove_reaction(921,558).
catalyst(922,558) :- not remove_reaction(922,558).
catalyst(931,558) :- not remove_reaction(931,558).
catalyst(932,558) :- not remove_reaction(932,558).
catalyst(1191,558) :- not remove_reaction(1191,558).
catalyst(1192,558) :- not remove_reaction(1192,558).
catalyst(1180,532).
catalyst(1210,532).
catalyst(1581,521).
catalyst(1582,521).
...
catalyst(851,268) :- not remove_reaction(851,268).
catalyst(852,268) :- not remove_reaction(852,268).
catalyst(901,268) :- not remove_reaction(901,268).
catalyst(902,268) :- not remove_reaction(902,268).
catalyst(1180,261).
catalyst(1210,261).
catalyst(730,257).
catalyst(431,223).
