...
component("YNL280C",755).
component("YLR056W",647).
component("YGR060W",448).
component("YGL012W",419).
component("YKR009C",627).
component("YOL086C",786).
component("YMR303C",727).
component("YMR083W",707).
component("YGL256W",441).
component("YDL168W",290).
component("YBR145W",220).
component("YPL231W",855).
component("YBR265W",238).
component("U46_",131).
component("YBR149W",221).
component("YBR149W",222).
component("YGL001C",416).
component("YIL094C",525).
component("U45_",130).
component("YML056C",694).
component("YLR432W",683).
component("YHR216W",516).
component("YAR075W",186).
component("YAR073W",185).
component("YDR127W",318).
component("YJR139C",594).
component("YML075C",696).
component("YLR450W",686).
component("YOL126C",792).
component("YKL085W",605).
component("YDL078C",272).
component("YKL029C",601).
component("YNL037C",732).
component("YNL009W",730).
component("YLR174W",660).
component("YHR183W",509).
component("YGR256W",472).
component("YNL241C",747).
component("YOL059W",783).
component("YDL022W",264).
component("YCL018W",246).
component("YLR355C",678).
component("YIL074C",522).
component("YER081W",389).
component("YML054C",693).
component("YDL174C",294).
component("YML086C",698).
component("YIL155C",534).
component("YEL024W",364).
component("YKR066C",632).
component("YGR088W",452).
component("YDR256C",332).
component("YKL026C",600).
component("YIR037W",544).
component("YBR244W",233).
component("YJR078W",586).
component("U58_",140).
component("YJR025C",577).
component("U107_",27).
component("YGR255C",471).
component("U108_",28).
component("YHR007C",483).
component("YDR402C",346).
component("YGL055W",426).
component("YJR104C",589).
component("YHR008C",484).
component("YOR384W",831).
component("YOR381W",830).
component("YOL152W",794).
component("YLL051C",640).
component("YJL026W",546).
component("YIL066C",521).
component("YGR180C",460).
component("YER070W",386).
component("U37_",124).
component("U36_",123).
component("U35_",122).
component("YDL168W",291).
component("YDR158W",326).
component("YJR009C",573).
component("YJL052W",548).
component("YGR192C",462).
component("YBR006W",198).
component("YPL276W",863).
component("YPL275W",862).
component("YOR388C",832).
component("YPL061W",839).
component("YOR374W",828).
component("YER073W",387).
component("YGL154C",433).
component("YBR115C",216).
component("U55_",139).
component("YER069W",384).
component("YOR323C",820).
component("YMR170C",717).
component("YMR169C",716).
component("YER178W",399).
component("YBR221C",231).
component("YIL125W",530).
component("U52_",136).
component("YBR166C",225).
component("YNL280C",756).
component("YGL012W",420).
component("YKL182W",615).
component("YKL216W",625).
component("YDR044W",308).
component("YER014W",374).
component("YKR009C",628).
component("YIL160C",535).
component("YGL205W",438).
component("YMR118C",711).
component("YLR164W",658).
component("YLL041C",638).
component("YKL148C",610).
component("YKL141W",608).
component("YJL045W",547).
component("YDR178W",327).
component("YJR051W",580).
component("YEL047C",367).
component("YDL171C",292).
component("YDL171C",293).
component("YOR375C",829).
component("YDL215C",298).
component("YAL062W",182).
component("U99_",176).
component("U100_",21).
component("YBR035C",206).
component("YKR080W",634).
component("YER023W",375).
component("YOR236W",818).
component("YGR204W",464).
component("YIR034C",543).
component("YLR142W",655).
component("U65_",147).
component("U63_",145).
component("U62_",144).
component("YHR068W",494).
component("YKL150W",611).
component("YIL043C",519).
component("YHR042W",489).
component("YOR221C",815).
component("YMR145C",714).
component("YKL192C",619).
component("YKL055C",603).
component("YER061C",382).
component("YDL085W",274).
component("YPL171C",847).
component("YHR179W",508).
component("YMR145C",715).
component("YML120C",699).
component("YKL192C",620).
component("YDL085W",275).
component("YGR234W",467).
component("YFR030W",412).
component("YPL017C",835).
component("YFL018C",403).
component("YDR353W",342).
component("YPR167C",880).
component("YJR137C",593).
component("YNL052W",734).
component("YMR256C",724).
component("YLR395C",682).
component("YLR038C",645).
component("YIL111W",527).
component("YHR051W",493).
component("YGL191W",436).
component("YGL187C",435).
component("YDL067C",271).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",313).
component("YPL266W",861).
component("YKR069W",633).
component("YOL096C",787).
component("U47_",132).
component("YER091C",394).
component("YJR073C",584).
component("YGR157W",457).
component("YDR120C",316).
component("YML008C",688).
component("YOR074C",799).
component("YDL033C",266).
component("YOL096C",788).
component("YLR172C",659).
component("YLR058C",648).
component("YDR019C",304).
component("YBR176W",226).
component("YDR408C",348).
component("YMR120C",712).
component("YLR028C",643).
component("YBL013W",187).
component("YJL130C",558).
component("YJL088W",552).
component("YKL024C",599).
component("YPR074C",875).
component("YBR117C",217).
component("YMR108W",710).
component("YCL009C",245).
component("YNL071W",736).
component("YNR008W",762).
component("YIL160C",536).
component("YNR019W",765).
component("YCR048W",260).
component("U48_",133).
component("YMR062C",706).
component("YDR232W",329).
component("YPL231W",856).
component("YER061C",383).
component("YPL001W",834).
component("YDL052C",270).
component("U8_",170).
component("YDR148C",324).
component("YPL231W",857).
component("YPL028W",836).
component("YLR299W",670).
component("YGL017W",421).
component("YCR005C",252).
component("YML126C",700).
component("YNL104C",739).
component("YDL182W",295).
component("YDL131W",281).
component("YDR307W",338).
component("YLR258W",667).
component("YFR015C",409).
component("YNL029C",731).
component("YIL085C",524).
component("YNL192W",745).
component("YBR038W",208).
component("YBR023C",204).
component("YMR306W",728).
component("YLR342W",676).
component("YGR032W",445).
component("YPR183W",883).
component("YBR248C",234).
component("YLR209C",662).
component("U104_",24).
component("U103_",23).
component("YDR354W",343) :- not remove_orf("YDR354W",343).
component("YFR047C",413).
component("YJR133W",592).
component("YLR209C",663).
component("YML022W",690).
component("YDR441C",351).
component("YHR128W",503).
component("YPR176C",882).
component("YPL172C",848).
component("YNR041C",768).
component("YMR101C",708).
component("YDL090C",277).
component("YBR003W",197).
component("YBR002C",196).
component("YJL167W",565).
component("YJL167W",566).
component("YNL256W",750).
component("YPR069C",872).
component("YDR127W",319).
component("YHR190W",511).
component("YLR146C",656).
component("YHR068W",495).
component("YLR303W",672).
component("YGR012W",443).
component("YML082W",697).
component("YJR130C",591).
component("YDR035W",306).
component("YBR249C",235).
component("YLR180W",661).
component("YDR502C",355).
component("YOR274W",819).
component("YBR256C",237).
component("YHR137W",504).
component("YGL202W",437).
component("YLR027C",642).
component("YKL106W",606).
component("YOL140W",793).
component("YLR438W",685).
component("YGR019W",444).
component("YLR089C",651).
component("U64_",146).
component("U61_",143).
component("U51_",135).
component("YJR148W",595).
component("YHR208W",514).
component("YFL030W",405).
component("YOR184W",809).
component("YNR058W",772).
component("YIL116W",529).
component("YGL253W",440).
component("YFR053C",414).
component("YMR013C",704).
component("YMR205C",720).
component("YGR240C",468).
component("YOL016C",776).
component("YFR014C",408).
component("YLR240W",665).
component("YKL203C",622).
component("YJR066W",583).
component("YCR036W",259).
component("YCL040W",248).
component("U15_",63).
component("YPL188W",850).
component("YJR049C",579).
component("YEL041W",365).
component("U96_",174).
component("YKL001C",598).
component("YDR236C",330).
component("YHL032C",481).
component("YDR531W",359).
component("U83_",165).
component("U82_",164).
component("U81_",163).
component("YMR208W",721).
component("YPL203W",851).
component("YOR061W",798).
component("YKL166C",613).
component("YJL164C",564).
component("YIL035C",518).
component("YHR205W",513).
component("YHR102W",501).
component("YGL019W",422).
component("YHR025W",488).
component("YOR347C",825).
component("YAL038W",180).
component("YNR012W",763).
component("YDR009W",303).
component("YDR127W",320).
component("YDR147W",323).
component("YDR300C",337).
component("YCR012W",253).
...
component("YDR226W",328).
component("YKL067W",604).
component("YOL055C",780).
component("YDR454C",352).
component("YJR057W",581).
component("YOL061W",784).
component("YKL181W",614).
component("YHL011C",479).
component("YER099C",395).
component("YBL068W",194).
component("YOR143C",805).
component("YNL256W",751).
component("YLR328W",674).
component("YBR018C",200).
component("YBR018C",201).
component("YGR007W",442).
component("YGR202C",463).
component("YLR328W",675).
component("YDL045C",268).
component("U80_",162).
component("YDL103C",280).
component("U94_",173).
component("YJR010W",574).
component("YBR029C",205).
component("YCL050C",249).
component("YGL130W",431).
component("YDR530C",358).
component("YCL050C",250).
component("YPR190C",885).
component("YPR187W",884).
component("YPR110C",877).
component("YPR010C",866).
component("YOR341W",824).
component("YOR340C",823).
component("YOR224C",817).
component("YOR210W",814).
component("YOR207C",812).
component("YOR151C",806).
component("YOR116C",801).
component("YOL005C",774).
component("YNR003C",761).
component("YNL248C",749).
component("YNL151C",743).
component("YNL113W",740).
component("YKL144C",609).
component("YJR063W",582).
component("YJL148W",562).
component("YJL140W",561).
component("YIL021W",517).
component("YHR143W-A",505).
component("YGL070C",429).
component("YFL036W",406).
component("YDR404C",347).
component("YDR156W",325).
component("YDR045C",309).
component("YDL150W",289).
component("YDL140C",283).
component("YBR154C",224).
component("YPR175W",881).
component("YPL167C",846).
component("YOR330C",821).
component("YOL115W",791).
component("YNL299W",758).
component("YNL262W",753).
component("YNL102W",738).
component("YJR043C",578).
component("YJR006W",572).
component("YJL090C",553).
component("YIL139C",532).
component("YEL055C",368).
component("YDR419W",349).
component("YDR121W",317).
component("YDL102W",279).
component("YCR014C",254).
component("YBR278W",240).
component("YBL035C",190).
component("YKL035W",602).
component("YHL012W",480).
component("YHR123W",502).
component("YPR113W",878).
component("YBR243C",232).
component("YDL142C",288).
component("YPL148C",844).
component("YER026C",376).
component("YGR286C",476).
component("YJL068C",549).
component("YHR189W",510).
component("YDR058C",312).
component("YDL086W",276).
component("YOL011W",775).
component("YMR008C",702).
component("YMR006C",701).
component("U105_",25).
component("YBL015W",188).
component("YJL068C",550).
component("YJR019C",576).
component("YOR040W",797).
component("U77_",158).
component("YDR481C",353).
component("YLR377C",680).
component("YFR025C",410).
component("YPL179W",849).
component("YNR032W",766).
component("YML057W",695).
component("YML016C",689).
component("YLR433C",684).
component("YGR123C",455).
component("YER133W",396).
component("YER089C",392).
component("YDR436W",350).
component("YDR075W",314).
component("YDL188C",296).
component("YDL134C",282).
component("YDL047W",269).
component("YDL006W",262).
component("YBR125C",219).
component("YBL056W",193).
component("YPR073C",873).
component("YHR215W",515).
component("YDL024C",265).
component("YBR093C",214).
component("YBR092C",213).
component("YAR071W",184).
component("YHR046C",492).
component("U9_",177).
component("YPL228W",854).
component("YMR180C",718).
component("YDL236W",300).
component("YJL155C",563).
component("YPR073C",874).
component("YOR208W",813).
component("YNL053W",735).
component("YMR036C",705).
component("YIR026C",542).
component("YIL113W",528).
component("YFR028C",411).
component("YER075C",388).
component("YDL230W",299).
component("YBR276C",239).
component("U34_",121).
component("U33_",120).
component("U32_",119).
component("U31_",118).
...
component("U25_",112).
component("U24_",111).
component("YHR044C",491).
component("YHR043C",490).
component("YOL064C",785).
component("YOR360C",827).
component("YKR031C",629).
component("YPL206C",852).
component("YGL027C",424).
component("YLR286C",669).
component("YJR153W",596).
component("YJL221C",571).
component("YJL216C",569).
component("YIL172C",540).
component("YGR292W",478).
component("YGR287C",477).
component("YBR299W",244).
component("YBR184W",227).
component("YIL162W",537).
component("YIR019C",541).
component("YIL099W",526).
component("YDL037C",267).
component("YOR190W",810).
component("YLR300W",671).
component("YGR282C",475).
component("YDR261C",333).
component("YDR400W",345).
component("U23_",110).
component("YML035C",691).
component("YJL070C",551).
component("YBR284W",241).
component("U106_",26).
component("U102_",22).
component("YER043C",377).
component("YNL045W",733).
component("YGL037C",425).
component("YDR242W",331).
component("YBR208C",229).
component("YMR281W",726).
component("U53_",137).
component("YPR062W",871).
component("YMR120C",713).
component("YLR028C",644).
component("YHR144C",506).
component("YGR267C",474).
component("YBL033C",189).
component("YBR153W",223).
component("YNL141W",741).
component("YLR245C",666).
component("YML035C",692).
component("YGR204W",465).
component("YBR084W",211).
component("YJL126W",556).
component("U44_",129).
component("YDL100C",278).
component("U87_",167).
component("U40_",127).
component("U39_",125).
component("YBR011C",199).
component("YHR201C",512).
component("YBR111C",215).
component("YBR252W",236).
component("YER005W",373).
component("YIL048W",520).
component("YER166W",397).
component("YDR093W",315).
component("YAL026C",179).
component("YBL099W",195).
component("U60_",142).
component("YLR231C",664).
component("U88_",168).
component("YDR538W",361).
component("YLR134W",653).
component("YLR044C",646).
component("YGR087C",451).
component("YDR380W",344).
component("YDL080C",273).
component("U98_",175).
component("YMR250W",723).
component("YKL184W",618).
component("YOR128C",802).
component("YEL021W",363).
component("YNR043W",769).
component("U93_",172).
component("U54_",138).
component("YKL211C",623) :- not remove_orf("YKL211C",623).
component("YKR097W",636).
component("YOL052C",779).
component("YNL169C",744).
component("YGR170W",458).
component("YNL256W",752).
component("YDR294C",335).
component("YEL046C",366).
component("YNR033W",767).
...
component("YOR393W",833).
component("YMR323W",729).
component("YHR174W",507).
component("YGR254W",470).
component("YOR202W",811).
component("YPL262W",859).
component("YGL026C",423) :- not remove_orf("YGL026C",423).
component("YGR155W",456).
component("YLR304C",673).
component("YJL200C",567).
component("YNL316C",759).
component("YKL182W",616).
component("YPL212C",853).
component("YNL292W",757).
component("YGL063W",428).
component("YFL001W",401).
component("YPR002W",865).
component("YJR016C",575).
component("YCR053W",261).
component("YDR127W",322).
component("YGL148W",432).
component("YIL168W",539).
component("YIL167W",538).
component("YCL064C",251).
component("YER086W",390).
component("YLR359W",679).
component("YAL012W",178).
component("YML004C",687).
component("YFR055W",415).
component("YJL005W",545).
component("YJL121C",555).
component("YBR019C",202).
component("YDR050C",311).
component("YDR007W",302) :- not remove_orf("YDR007W",302).
component("YOR095C",800).
component("YER003C",372).
component("YBR196C",228).
component("YGL001C",417).
component("YPL117C",842).
component("U14_",55).
component("YOL056W",781).
component("YKL152C",612).
component("YDL021W",263).
component("YMR105C",709).
component("YKL127W",607).
component("YEL058W",369).
component("YPR060C",870).
component("YHR072W",496).
component("YPL097W",840).
component("YGR185C",461).
component("YGR264C",473).
component("YGR171C",459).
component("YHR011W",485).
component("YDR023W",305).
component("YPL104W",841).
component("YLL018C",637).
component("YPR081C",876).
component("YBR121C",218).
component("YHR020W",487).
component("YER087W",391).
component("YNL247W",748).
component("YOR168W",807).
component("YOL097C",789).
component("YDR268W",334).
component("YPR047W",869).
component("YLR060W",649).
component("YFL022C",404).
component("YPR033C",867).
component("YCR024C",255).
component("YHR019C",486).
component("YKL194C",621).
component("YIL078W",523).
component("YPL160W",845).
component("YLR382C",681).
component("YNL073W",737).
component("YDR037W",307).
component("YOR335C",822).
component("YGR094W",453).
component("YLR153C",657).
component("YAL054C",181).
component("YOR142W",804).
component("YGR244C",469).
component("YPR035W",868).
component("YIL145C",533).
component("U89_",169).
component("YJL101C",554).
component("YOL049W",778).
component("YAR015W",183).
component("YER183C",400).
component("U90_",171).
component("YNR057C",771).
component("YDL141W",284).
component("YDL141W",285).
component("YGL234W",439).
component("YDL141W",286).
component("YJR103W",588).
component("YBL039C",191).
component("YGR204W",466).
component("YBR084W",212).
component("YNL220W",746).
component("YOL058W",782).
component("YDL141W",287).
component("YHR074W",497).
component("YMR217W",722).
component("YGR061C",449).
component("YJR109C",590).
component("YJL130C",559).
component("YGL062W",427).
component("YBR218C",230).
component("YPL231W",858).
component("YNR016C",764).
component("YKL182W",617).
component("YGR037C",446).
component("YPR138C",879).
component("YPL265W",860).
component("YPL134C",843).
component("YPL057C",838).
component("YPL036W",837).
component("YOR348C",826).
component("YOR222W",816).
component("YOR171C",808).
component("YOR130C",803).
component("YOR011W",796).
component("YOL156W",795).
component("YOL103W",790).
component("YOL020W",777) :- not remove_orf("YOL020W",777).
component("YNR072W",773).
component("YNR056C",770).
component("YNL318C",760).
component("YNL270C",754).
component("YNL142W",742).
component("YMR272C",725).
component("YMR202W",719).
component("YMR011W",703).
component("YLR348C",677).
component("YLR260W",668).
component("YLR138W",654).
component("YLR100C",652).
component("YLR081W",650).
component("YLL061W",641).
component("YLL043W",639).
component("YKR093W",635).
component("YKR053C",631).
component("YKR039W",630) :- not remove_orf("YKR039W",630).
component("YKL217W",626).
component("YJR158W",597).
component("YJR095W",587).
component("YJR077C",585).
component("YJL219W",570).
component("YJL214W",568).
component("YJL134W",560).
component("YJL129C",557).
component("YIL134W",531).
component("YHR096C",500).
component("YHR094C",499).
component("YHR092C",498).
component("YHL036W",482).
component("YGR121C",454).
component("YGR065C",450).
component("YGR055W",447).
component("YGL186C",434).
component("YGL077C",430).
component("YGL008C",418).
component("YFL055W",407).
component("YFL011W",402).
component("YER060W-A",381).
component("YER060W",380).
component("YER056C",379).
component("YER053C",378).
component("YEL069C",371).
component("YEL063C",370).
component("YEL017C-A",362).
component("YDR536W",360).
component("YDR508C",357).
component("YDR503C",356).
component("YDR497C",354).
component("YDR345C",341).
component("YDR343C",340).
component("YDR342C",339).
component("YDR297W",336).
component("YDR046C",310) :- not remove_orf("YDR046C",310).
component("YDL245C",301).
component("YDL210W",297).
component("YCR032W",258).
component("YCR028C",257).
component("YCR024C-A",256).
component("YCL025C",247).
component("YBR298C",243).
component("YBR291C",242).
component("YBR069C",210) :- not remove_orf("YBR069C",210).
component("YBR068C",209) :- not remove_orf("YBR068C",209).
component("YBR036C",207).
component("YBR021W",203).
...
catalyst(2131,23).
catalyst(2132,23).
catalyst(3620,343) :- not remove_reaction(3620,343).
catalyst(2110,413).
catalyst(2190,413).
catalyst(5550,592).
catalyst(5791,663).
...
catalyst(8281,311).
catalyst(8282,311).
catalyst(3610,302) :- not remove_reaction(3610,302).
catalyst(7921,800).
catalyst(7922,800).
catalyst(7841,372).
catalyst(7842,372).
...
catalyst(1210,795).
catalyst(1160,790).
catalyst(801,777) :- not remove_reaction(801,777).
catalyst(802,777) :- not remove_reaction(802,777).
catalyst(811,777) :- not remove_reaction(811,777).
catalyst(812,777) :- not remove_reaction(812,777).
catalyst(831,777) :- not remove_reaction(831,777).
catalyst(832,777) :- not remove_reaction(832,777).
catalyst(901,777) :- not remove_reaction(901,777).
catalyst(902,777) :- not remove_reaction(902,777).
catalyst(1180,773).
catalyst(1210,773).
catalyst(700,770).
catalyst(1200,760).
...
catalyst(650,635).
catalyst(6560,631).
catalyst(771,630) :- not remove_reaction(771,630).
catalyst(772,630) :- not remove_reaction(772,630).
catalyst(781,630) :- not remove_reaction(781,630).
catalyst(782,630) :- not remove_reaction(782,630).
catalyst(791,630) :- not remove_reaction(791,630).
catalyst(792,630) :- not remove_reaction(792,630).
catalyst(801,630) :- not remove_reaction(801,630).
catalyst(802,630) :- not remove_reaction(802,630).
catalyst(811,630) :- not remove_reaction(811,630).
catalyst(812,630) :- not remove_reaction(812,630).
catalyst(831,630) :- not remove_reaction(831,630).
catalyst(832,630) :- not remove_reaction(832,630).
catalyst(841,630) :- not remove_reaction(841,630).
catalyst(842,630) :- not remove_reaction(842,630).
catalyst(851,630) :- not remove_reaction(851,630).
catalyst(852,630) :- not remove_reaction(852,630).
catalyst(881,630) :- not remove_reaction(881,630).
catalyst(882,630) :- not remove_reaction(882,630).
catalyst(901,630) :- not remove_reaction(901,630).
catalyst(902,630) :- not remove_reaction(902,630).
catalyst(911,630) :- not remove_reaction(911,630).
catalyst(912,630) :- not remove_reaction(912,630).
catalyst(921,630) :- not remove_reaction(921,630).
catalyst(922,630) :- not remove_reaction(922,630).
catalyst(931,630) :- not remove_reaction(931,630).
catalyst(932,630) :- not remove_reaction(932,630).
catalyst(1191,630) :- not remove_reaction(1191,630).
catalyst(1192,630) :- not remove_reaction(1192,630).
catalyst(390,626).
catalyst(1180,597).
catalyst(1210,597).
catalyst(1250,587).
...
catalyst(1210,339).
catalyst(6650,336).
catalyst(791,310) :- not remove_reaction(791,310).
catalyst(792,310) :- not remove_reaction(792,310).
catalyst(801,310) :- not remove_reaction(801,310).
catalyst(802,310) :- not remove_reaction(802,310).
catalyst(811,310) :- not remove_reaction(811,310).
catalyst(812,310) :- not remove_reaction(812,310).
catalyst(831,310) :- not remove_reaction(831,310).
catalyst(832,310) :- not remove_reaction(832,310).
catalyst(841,310) :- not remove_reaction(841,310).
catalyst(842,310) :- not remove_reaction(842,310).
catalyst(851,310) :- not remove_reaction(851,310).
catalyst(852,310) :- not remove_reaction(852,310).
catalyst(901,310) :- not remove_reaction(901,310).
catalyst(902,310) :- not remove_reaction(902,310).
catalyst(1180,301).
catalyst(1210,301).
catalyst(690,297).
catalyst(730,297).
...
catalyst(851,210) :- not remove_reaction(851,210).
catalyst(852,210) :- not remove_reaction(852,210).
...
catalyst(851,209) :- not remove_reaction(851,209).
catalyst(852,209) :- not remove_reaction(852,209).
...
modifiable_enzyme(777).
modifiable_enzyme(630).
