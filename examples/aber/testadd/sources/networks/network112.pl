...
component("YNL280C",633).
component("YLR056W",542).
component("YGR060W",376).
component("YGL012W",348).
component("YKR009C",524).
component("YOL086C",658).
component("YMR303C",607).
component("YGL256W",370).
component("YDL168W",231).
component("YBR145W",173).
component("YPL231W",719).
component("YBR265W",188).
component("U46_",101).
component("YBR149W",174).
component("YBR149W",175).
component("YGL001C",345).
component("YIL094C",442).
component("U45_",100).
component("YML056C",585).
component("YLR432W",575).
component("YHR216W",435).
component("YAR075W",147).
component("YAR073W",146).
component("YDR127W",256).
component("YJR139C",501).
component("YML075C",587).
component("YLR450W",578).
component("YOL126C",664).
component("YKL085W",509).
component("YDL078C",218).
component("YNL037C",612).
component("YNL009W",610).
component("YLR174W",554).
component("YHR183W",428).
component("YGR256W",394).
component("YNL241C",626).
component("YOL059W",656).
component("YDL022W",211).
component("YCL018W",196).
component("YLR355C",570).
component("YIL074C",440).
component("YER081W",321).
component("YDL174C",235).
component("YML086C",589).
component("YIL155C",451).
component("YGR088W",379).
component("YDR256C",268).
component("YKL026C",507).
component("YIR037W",460).
component("YBR244W",184).
component("YJR078W",495).
component("U58_",109).
component("YJR025C",488).
component("U107_",24).
component("YHR007C",404).
component("YDR402C",282).
component("YGL055W",355).
component("YJR104C",497).
component("YHR008C",405).
component("YOR384W",700).
component("YOR381W",699).
component("YOL152W",666).
component("YLL051C",535).
component("YJL026W",462).
component("YIL066C",439).
component("YGR180C",385).
component("YER070W",318).
component("U37_",94).
component("U36_",93).
component("YDL168W",232).
component("YJR009C",485).
component("YJL052W",464).
component("YGR192C",387).
component("YBR006W",157).
component("YPL276W",727).
component("YPL275W",726).
component("YOR388C",701).
component("YOR374W",697).
component("YER073W",319).
component("YGL154C",362).
component("U55_",108).
component("YER069W",316).
component("YOR323C",689).
component("YER178W",330).
component("YBR221C",182).
component("YIL125W",447).
component("U52_",106).
component("YBR166C",177).
component("YGL012W",349).
component("YKL216W",523).
component("YDR044W",247).
component("YKR009C",525).
component("YIL160C",452).
component("YGL205W",367).
component("YMR118C",598).
component("YLR164W",552).
component("YLL041C",534).
component("YKL148C",513).
component("YKL141W",511).
component("YJL045W",463).
component("YDR178W",263).
component("YEL047C",301).
component("YDL171C",233).
component("YDL171C",234).
component("YOR375C",698).
component("YDL215C",239).
component("YAL062W",144).
component("U99_",139).
component("U100_",20).
component("YBR035C",163).
component("YKR080W",530).
component("YER023W",308).
component("YOR236W",687).
component("YGR204W",388).
component("YIR034C",459).
component("YLR142W",549).
component("U65_",115).
component("U63_",113).
component("U62_",112).
component("YHR068W",414).
component("YKL150W",514).
component("YIL043C",438).
component("YHR042W",409).
component("YPL171C",713).
component("YHR179W",427).
component("YMR145C",601).
component("YML120C",590).
component("YKL192C",520).
component("YDL085W",220).
component("YGR234W",390).
component("YFR030W",341).
component("YPL017C",703).
component("YFL018C",334).
component("YDR353W",278).
component("YPR167C",739).
component("YJR137C",500).
component("YNL052W",614).
component("YMR256C",606).
component("YLR395C",574).
component("YLR038C",540).
component("YIL111W",444).
component("YHR051W",413).
component("YGL191W",365).
component("YGL187C",364).
component("YDL067C",217).
component("Q0275",19).
component("Q0250",18).
component("YDR072C",252).
component("YPL266W",725).
component("YKR069W",529).
component("YOL096C",659).
component("U47_",102).
component("YER091C",326).
component("YJR073C",493).
component("YGR157W",383).
component("YDR120C",254).
component("YML008C",580).
component("YOR074C",671).
component("YDL033C",213).
component("YOL096C",660).
component("YLR172C",553).
component("YLR058C",543).
component("YDR019C",245).
component("YBR176W",178).
component("YDR408C",284).
component("YMR120C",599).
component("YLR028C",538).
component("YBL013W",148).
component("YJL130C",472).
component("YKL024C",506).
component("YPR074C",735).
component("YBR117C",171).
component("YMR108W",597).
component("YCL009C",195).
component("YNL071W",616).
component("YNR008W",638).
component("YIL160C",453).
component("YNR019W",641).
component("YCR048W",207).
component("U48_",103).
component("YDR232W",265).
component("YPL231W",720).
component("YER061C",315).
component("YDL052C",216).
component("U8_",133).
component("YPL231W",721).
component("YPL028W",704).
component("YLR299W",563).
component("YGL017W",350).
component("YML126C",591).
component("YNL104C",619).
component("YDL182W",236).
component("YDL131W",224).
component("YDR307W",274).
component("YLR258W",560).
component("YFR015C",339).
component("YNL029C",611).
component("YIL085C",441).
component("YMR306W",608).
component("YLR342W",569).
component("YGR032W",373).
component("YLR209C",556).
component("U104_",21).
component("YDR354W",279) :- not remove_orf("YDR354W",279).
component("YFR047C",342).
component("YJR133W",499).
component("YLR209C",557).
component("YML022W",582).
component("YDR441C",287).
component("YHR128W",422).
component("YJL167W",477).
component("YJL167W",478).
component("YDR127W",257).
component("YHR190W",430).
component("YLR146C",550).
component("YHR068W",415).
component("YLR303W",565).
component("YGR012W",371).
component("YML082W",588).
component("YJR130C",498).
component("YDR035W",246).
component("YBR249C",185).
component("YLR180W",555).
component("YDR502C",290).
component("YOR274W",688).
component("YBR256C",187).
component("YHR137W",423).
component("YGL202W",366).
component("YLR027C",537).
component("YKL106W",510).
component("YOL140W",665).
component("YLR438W",577).
component("YGR019W",372).
component("YLR089C",545).
component("U64_",114).
component("U61_",111).
component("U51_",105).
component("YJR148W",502).
component("YHR208W",433).
component("YFL030W",335).
component("YOR184W",680).
component("YNR058W",646).
component("YIL116W",446).
component("YGL253W",369).
component("YFR053C",343).
component("YMR013C",595).
component("YMR205C",602).
component("YGR240C",391).
component("YOL016C",650).
component("YFR014C",338).
component("YCR036W",206).
component("YCL040W",198).
component("U15_",48).
component("YPL188W",715).
component("YJR049C",490).
component("YEL041W",299).
component("U96_",137).
component("YKL001C",505).
component("YDR236C",266).
component("YHL032C",402).
component("YDR531W",294).
component("U83_",131).
component("U82_",130).
component("U81_",129).
component("YMR208W",603).
component("YPL203W",716).
component("YOR061W",670).
component("YKL166C",516).
component("YJL164C",476).
component("YIL035C",437).
component("YHR205W",432).
component("YHR102W",421).
component("YGL019W",351).
component("YHR025W",408).
component("YOR347C",694).
component("YAL038W",142).
component("YNR012W",639).
component("YDR009W",244).
component("YDR127W",258).
component("YDR147W",261).
component("YDR300C",273).
component("YCR012W",201).
component("YER069W",317).
component("U19_",73).
component("U18_",66).
component("U17_",58).
component("U76_",124).
component("YER170W",329).
component("YDR226W",264).
component("YKL067W",508).
component("YOL055C",653).
component("YDR454C",288).
component("YJR057W",491).
component("YOL061W",657).
component("YKL181W",517).
component("YHL011C",401).
component("YER099C",327).
component("YBL068W",155).
component("YOR143C",676).
component("YNL256W",629).
component("YLR328W",567).
component("YBR018C",159).
component("YLR328W",568).
component("U80_",128).
component("U94_",136).
component("YJR010W",486).
component("YBR029C",162).
component("YCL050C",199).
component("YGL130W",360).
component("YDR530C",293).
component("YPR190C",742).
component("YPR187W",741).
component("YPR110C",736).
component("YPR010C",730).
component("YOR341W",693).
component("YOR340C",692).
component("YOR224C",686).
component("YOR210W",684).
component("YOR207C",682).
component("YOR151C",677).
component("YOR116C",673).
component("YOL005C",648).
component("YNR003C",637).
component("YNL248C",628).
component("YNL151C",623).
component("YNL113W",620).
component("YKL144C",512).
component("YJR063W",492).
component("YJL148W",475).
component("YJL140W",474).
component("YIL021W",436).
component("YHR143W-A",424).
component("YGL070C",358).
component("YFL036W",336).
component("YDR404C",283).
component("YDR156W",262).
component("YDR045C",248).
component("YDL150W",230).
component("YDL140C",226).
component("YBR154C",176).
component("YPR175W",740).
component("YPL167C",712).
component("YOR330C",690).
component("YOL115W",663).
component("YNL299W",635).
component("YNL262W",631).
component("YNL102W",618).
component("YJR043C",489).
component("YJR006W",484).
component("YJL090C",467).
component("YIL139C",449).
component("YEL055C",302).
component("YDR419W",285).
component("YDR121W",255).
component("YDL102W",223).
component("YCR014C",202).
component("YBR278W",190).
component("YBL035C",151).
component("YPR113W",737).
component("YBR243C",183).
component("YPL148C",710).
component("YER026C",309).
component("YGR286C",398).
component("YHR189W",429).
component("YDR058C",251).
component("YDL086W",221).
component("YOL011W",649).
component("YMR008C",593).
component("YMR006C",592).
component("U105_",22).
component("YBL015W",149).
component("YJL068C",465).
component("YOR040W",669).
component("U77_",125).
component("YLR377C",572).
component("YPL179W",714).
component("YNR032W",642).
component("YML057W",586).
component("YML016C",581).
component("YLR433C",576).
component("YGR123C",381).
component("YER133W",328).
component("YER089C",324).
component("YDR436W",286).
component("YDR075W",253).
component("YDL188C",237).
component("YDL134C",225).
component("YDL047W",215).
component("YDL006W",209).
component("YBR125C",172).
component("YBL056W",154).
component("YPR073C",733).
component("YHR215W",434).
component("YDL024C",212).
component("YBR093C",169).
component("YBR092C",168).
component("YHR046C",412).
component("U9_",140).
component("YDL236W",241).
component("YPR073C",734).
component("YOR208W",683).
component("YNL053W",615).
component("YMR036C",596).
component("YIR026C",458).
component("YIL113W",445).
component("YFR028C",340).
component("YER075C",320).
component("YDL230W",240).
...
component("U25_",85).
component("U24_",84).
component("YHR044C",411).
component("YHR043C",410).
component("YOR360C",696).
component("YKR031C",526).
component("YPL206C",717).
component("YGL027C",353).
component("YLR286C",562).
component("YJR153W",503).
component("YJL221C",483).
component("YJL216C",481).
component("YIL172C",456).
component("YGR292W",400).
component("YGR287C",399).
component("YBR299W",194).
component("YBR184W",179).
component("YIR019C",457).
component("YIL099W",443).
component("YDL037C",214).
component("YOR190W",681).
component("YLR300W",564).
component("YGR282C",397).
component("YDR261C",269).
component("YDR400W",281).
component("YML035C",583).
component("YJL070C",466).
component("YBR284W",191).
component("U106_",23).
component("YER043C",310).
component("YNL045W",613).
component("YGL037C",354).
component("YDR242W",267).
component("U53_",107).
component("YPR062W",732).
component("YMR120C",600).
component("YLR028C",539).
component("YHR144C",425).
component("YGR267C",396).
component("YBL033C",150).
component("YNL141W",621).
component("YLR245C",559).
...
component("YHR201C",431).
component("YBR111C",170).
component("YBR252W",186).
component("YER005W",307).
component("YBL099W",156).
component("YLR231C",558).
component("YDR538W",296).
component("YLR134W",547).
component("YLR044C",541).
component("YGR087C",378).
component("YDR380W",280).
component("YDL080C",219).
component("U98_",138).
component("YMR250W",605).
component("YOR128C",674).
component("YEL021W",298).
component("YNR043W",644).
component("U93_",135).
component("YKL211C",521) :- not remove_orf("YKL211C",521).
component("YKR097W",532).
component("YNL169C",624).
component("YNL256W",630).
component("YDR294C",271).
component("YEL046C",300).
component("YNR033W",643).
component("YKL211C",522) :- not remove_orf("YKL211C",522).
component("YER090W",522) :- not remove_orf("YER090W",522).
component("YER090W",325) :- not remove_orf("YER090W",325).
component("YDR127W",259).
component("YPL281C",728).
component("YOR393W",702).
component("YMR323W",609).
component("YHR174W",426).
component("YGR254W",393).
component("YPL262W",723).
component("YGL026C",352) :- not remove_orf("YGL026C",352).
component("YGR155W",382).
component("YLR304C",566).
component("YJL200C",479).
component("YNL316C",636).
component("YKL182W",518).
component("YPL212C",718).
component("YNL292W",634).
component("YGL063W",357).
component("YFL001W",332).
component("YPR002W",729).
component("YJR016C",487).
component("YCR053W",208).
component("YDR127W",260).
component("YGL148W",361).
component("YIL168W",455).
component("YIL167W",454).
component("YCL064C",200).
component("YER086W",322).
component("YLR359W",571).
component("YAL012W",141).
component("YML004C",579).
component("YFR055W",344).
component("YJL005W",461).
component("YJL121C",469).
component("YBR019C",160).
component("YDR050C",250).
component("YDR007W",243) :- not remove_orf("YDR007W",243).
component("YOR095C",672).
component("YER003C",306).
component("YBR196C",180).
component("YGL001C",346).
component("YPL117C",708).
component("U14_",40).
component("YOL056W",654).
component("YKL152C",515).
component("YDL021W",210).
component("YEL058W",303).
component("YPR060C",731).
component("YHR072W",416).
component("YPL097W",706).
component("YGR185C",386).
component("YGR264C",395).
component("YGR171C",384).
component("YPL104W",707).
component("YLL018C",533).
component("YHR020W",407).
component("YER087W",323).
component("YNL247W",627).
component("YOR168W",678).
component("YOL097C",661).
component("YDR268W",270).
component("YCR024C",203).
component("YHR019C",406).
component("YPL160W",711).
component("YLR382C",573).
component("YNL073W",617).
component("YOR335C",691).
component("YLR153C",551).
component("YAL054C",143).
component("YGR244C",392).
component("YIL145C",450).
component("YJL101C",468).
component("YOL049W",652).
component("YAR015W",145).
component("YER183C",331).
component("U90_",134).
component("YNR057C",645).
component("YDL141W",227).
component("YGL234W",368).
component("YDL141W",228).
component("YJR103W",496).
component("YBL039C",152).
component("YGR204W",389).
component("YBR084W",167).
component("YNL220W",625).
component("YOL058W",655).
component("YDL141W",229).
component("YHR074W",417).
component("YMR217W",604).
component("YGL062W",356).
component("YBR218C",181).
component("YPL231W",722).
component("YNR016C",640).
component("YKL182W",519).
component("YGR037C",374).
component("YPR138C",738).
component("YPL265W",724).
component("YPL134C",709).
component("YPL036W",705).
component("YOR348C",695).
component("YOR222W",685).
component("YOR171C",679).
component("YOR130C",675).
component("YOR011W",668).
component("YOL156W",667).
component("YOL103W",662).
component("YOL020W",651) :- not remove_orf("YOL020W",651).
component("YNR072W",647).
component("YNL270C",632).
component("YNL142W",622).
component("YMR011W",594).
component("YLR260W",561).
component("YLR138W",548).
component("YLR100C",546).
component("YLR081W",544).
component("YLL061W",536).
component("YKR093W",531).
component("YKR053C",528).
component("YKR039W",527) :- not remove_orf("YKR039W",527).
component("YJR158W",504).
component("YJR077C",494).
component("YJL219W",482).
component("YJL214W",480).
component("YJL134W",473).
component("YJL129C",471).
component("YIL134W",448).
component("YHR096C",420).
component("YHR094C",419).
component("YHR092C",418).
component("YHL036W",403).
component("YGR121C",380).
component("YGR065C",377).
component("YGR055W",375).
component("YGL186C",363).
component("YGL077C",359).
component("YGL008C",347).
component("YFL055W",337).
component("YFL011W",333).
component("YER060W-A",314).
component("YER060W",313).
component("YER056C",312).
component("YER053C",311).
component("YEL069C",305).
component("YEL063C",304).
component("YEL017C-A",297).
component("YDR536W",295).
component("YDR508C",292).
component("YDR503C",291).
component("YDR497C",289).
component("YDR345C",277).
component("YDR343C",276).
component("YDR342C",275).
component("YDR297W",272).
component("YDR046C",249) :- not remove_orf("YDR046C",249).
component("YDL245C",242).
component("YDL210W",238).
component("YCR032W",205).
component("YCR024C-A",204).
component("YCL025C",197).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,279) :- not remove_reaction(3620,279).
catalyst(2110,342).
catalyst(2190,342).
catalyst(5550,499).
catalyst(5791,557).
...
catalyst(6470,644).
catalyst(2300,135).
catalyst(3600,521) :- not remove_reaction(3600,521).
catalyst(8000,532).
catalyst(6890,624).
catalyst(2570,630).
catalyst(8781,271).
...
catalyst(4560,300).
catalyst(2550,643).
catalyst(1890,522) :- not remove_reaction(1890,522).
catalyst(3630,522) :- not remove_reaction(3630,522).
catalyst(1890,325) :- not remove_reaction(1890,325).
...
catalyst(8051,723).
catalyst(8052,723).
catalyst(3590,352) :- not remove_reaction(3590,352).
catalyst(10910,352) :- not remove_reaction(10910,352).
catalyst(4570,382).
catalyst(8181,566).
catalyst(8182,566).
catalyst(8181,479).
...
catalyst(8281,250).
catalyst(8282,250).
catalyst(3610,243) :- not remove_reaction(3610,243).
catalyst(7921,672).
catalyst(7922,672).
catalyst(7841,306).
catalyst(7842,306).
...
catalyst(1210,667).
catalyst(1160,662).
catalyst(801,651) :- not remove_reaction(801,651).
catalyst(802,651) :- not remove_reaction(802,651).
catalyst(811,651) :- not remove_reaction(811,651).
catalyst(812,651) :- not remove_reaction(812,651).
catalyst(831,651) :- not remove_reaction(831,651).
catalyst(832,651) :- not remove_reaction(832,651).
catalyst(901,651) :- not remove_reaction(901,651).
catalyst(902,651) :- not remove_reaction(902,651).
catalyst(1180,647).
catalyst(1210,647).
catalyst(931,632).
catalyst(932,632).
...
catalyst(640,531).
catalyst(6560,528).
catalyst(771,527) :- not remove_reaction(771,527).
catalyst(772,527) :- not remove_reaction(772,527).
catalyst(781,527) :- not remove_reaction(781,527).
catalyst(782,527) :- not remove_reaction(782,527).
catalyst(801,527) :- not remove_reaction(801,527).
catalyst(802,527) :- not remove_reaction(802,527).
catalyst(811,527) :- not remove_reaction(811,527).
catalyst(812,527) :- not remove_reaction(812,527).
catalyst(831,527) :- not remove_reaction(831,527).
catalyst(832,527) :- not remove_reaction(832,527).
catalyst(841,527) :- not remove_reaction(841,527).
catalyst(842,527) :- not remove_reaction(842,527).
catalyst(851,527) :- not remove_reaction(851,527).
catalyst(852,527) :- not remove_reaction(852,527).
catalyst(881,527) :- not remove_reaction(881,527).
catalyst(882,527) :- not remove_reaction(882,527).
catalyst(901,527) :- not remove_reaction(901,527).
catalyst(902,527) :- not remove_reaction(902,527).
catalyst(921,527) :- not remove_reaction(921,527).
catalyst(922,527) :- not remove_reaction(922,527).
catalyst(931,527) :- not remove_reaction(931,527).
catalyst(932,527) :- not remove_reaction(932,527).
catalyst(1191,527) :- not remove_reaction(1191,527).
catalyst(1192,527) :- not remove_reaction(1192,527).
catalyst(1180,504).
catalyst(1210,504).
catalyst(1581,494).
catalyst(1582,494).
...
catalyst(851,249) :- not remove_reaction(851,249).
catalyst(852,249) :- not remove_reaction(852,249).
...
catalyst(851,164) :- not remove_reaction(851,164).
catalyst(852,164) :- not remove_reaction(852,164).
...
modifiable_enzyme(279).
modifiable_enzyme(521).
modifiable_enzyme(522).
modifiable_enzyme(325).
modifiable_enzyme(352).
modifiable_enzyme(243).
