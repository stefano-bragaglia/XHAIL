...
component("YNL280C",727).
component("YLR056W",623).
component("YGR060W",433).
component("YGL012W",404).
component("YKR009C",604).
component("YOL086C",755).
component("YMR303C",700).
...
component("YIL094C",508).
component("U45_",124).
component("YML056C",669).
component("YLR432W",659).
component("YHR216W",499).
component("YAR075W",180).
component("YAR073W",179).
component("YDR127W",305).
component("YJR139C",573).
component("YML075C",671).
component("YLR450W",662).
component("YOL126C",761).
component("YKL085W",584).
component("YDL078C",261).
component("YKL029C",580).
component("YNL037C",705).
component("YNL009W",703).
component("YLR174W",636).
component("YHR183W",492).
component("YGR256W",455).
component("YNL241C",720).
component("YOL059W",752).
component("YDL022W",253).
component("YCL018W",236).
component("YLR355C",654).
component("YIL074C",505).
component("YER081W",375).
component("YDL174C",282).
component("YML086C",673).
component("YIL155C",517).
component("YEL024W",351).
component("YKR066C",609).
component("YGR088W",437).
component("YDR256C",319).
component("YKL026C",579).
component("YIR037W",527).
component("YBR244W",223).
component("YJR078W",566).
component("U58_",134).
component("YJR025C",558).
component("U107_",25).
component("YGR255C",454).
component("U108_",26).
component("YHR007C",466).
component("YDR402C",333).
component("YGL055W",411).
component("YJR104C",568).
component("YHR008C",467).
component("YOR384W",799).
component("YOR381W",798).
component("YOL152W",763).
component("YLL051C",616).
component("YJL026W",529).
component("YIL066C",504).
component("YGR180C",444).
component("YER070W",372).
component("U37_",118).
component("U36_",117).
component("U35_",116).
component("YDL168W",279).
component("YDR158W",313).
component("YJR009C",555).
component("YJL052W",531).
component("YGR192C",446).
component("YBR006W",190).
component("YPL276W",828).
component("YPL275W",827).
component("YOR388C",800).
component("YPL061W",805).
component("YOR374W",796).
component("YER073W",373).
component("YGL154C",418).
component("YBR115C",206).
component("U55_",133).
component("YER069W",370).
component("YOR323C",788).
component("YMR170C",691).
component("YMR169C",690).
component("YER178W",385).
component("YBR221C",221).
component("YIL125W",513).
component("U52_",130).
component("YBR166C",215).
component("YNL280C",728).
component("YGL012W",405).
component("YKL182W",594).
component("YKL216W",603).
component("YDR044W",295).
component("YKR009C",605).
component("YIL160C",518).
component("YGL205W",423).
component("YMR118C",685).
component("YLR164W",634).
component("YLL041C",615).
component("YKL148C",589).
component("YKL141W",587).
component("YJL045W",530).
component("YDR178W",314).
component("YEL047C",354).
component("YDL171C",280).
component("YDL171C",281).
component("YOR375C",797).
component("YDL215C",286).
component("YAL062W",176).
component("U99_",170).
component("U100_",21).
component("YBR035C",197).
component("YKR080W",611).
component("YER023W",361).
component("YOR236W",786).
component("YGR204W",448).
component("YIR034C",526).
component("YLR142W",631).
component("U65_",141).
component("U63_",139).
component("U62_",138).
component("YHR068W",477).
component("YKL150W",590).
component("YIL043C",502).
component("YHR042W",472).
component("YOR221C",783).
component("YMR145C",688).
component("YKL192C",597).
component("YKL055C",582).
component("YER061C",368).
component("YDL085W",263).
component("YPL171C",813).
component("YHR179W",491).
component("YMR145C",689).
component("YML120C",674).
component("YKL192C",598).
component("YDL085W",264).
component("YGR234W",450).
component("YFR030W",397).
component("YPL017C",802).
component("YFL018C",389).
component("YDR353W",329).
component("YPR167C",843).
component("YJR137C",572).
component("YNL052W",707).
component("YMR256C",697).
component("YLR395C",658).
component("YLR038C",621).
component("YIL111W",510).
component("YHR051W",476).
component("YGL191W",421).
component("YGL187C",420).
component("YDL067C",260).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",300).
component("YPL266W",826).
component("YKR069W",610).
component("YOL096C",756).
component("U47_",126).
component("YER091C",380).
component("YJR073C",564).
component("YGR157W",442).
component("YDR120C",303).
component("YML008C",664).
component("YOR074C",768).
component("YDL033C",255).
component("YOL096C",757).
component("YLR172C",635).
component("YLR058C",624).
component("YDR019C",292).
component("YBR176W",216).
component("YDR408C",335).
component("YMR120C",686).
component("YLR028C",619).
component("YBL013W",181).
component("YJL130C",540).
component("YJL088W",534).
component("YKL024C",578).
component("YPR074C",838).
component("YBR117C",207).
component("YMR108W",684).
component("YCL009C",235).
component("YNL071W",709).
component("YNR008W",733).
component("YIL160C",519).
component("YNR019W",736).
component("YCR048W",249).
component("U48_",127).
component("YMR062C",681).
component("YDR232W",316).
component("YPL231W",821).
component("YER061C",369).
component("YDL052C",259).
component("U8_",164).
component("YDR148C",311).
component("YPL231W",822).
component("YPL028W",803).
component("YLR299W",646).
component("YGL017W",406).
component("YCR005C",241).
component("YML126C",675).
component("YNL104C",712).
component("YDL182W",283).
component("YDL131W",269).
component("YDR307W",325).
component("YLR258W",643).
component("YFR015C",395).
component("YNL029C",704).
component("YIL085C",507).
component("YNL192W",718).
component("YBR038W",198).
component("YBR023C",195).
component("YMR306W",701).
component("YLR342W",652).
component("YGR032W",430).
component("YPR183W",845).
component("YBR248C",224).
component("YLR209C",638).
component("U104_",22).
component("YDR354W",330) :- not remove_orf("YDR354W",330).
component("YFR047C",398).
component("YJR133W",571).
component("YLR209C",639).
component("YML022W",666).
component("YDR441C",338).
component("YHR128W",486).
component("YJL167W",547).
component("YJL167W",548).
component("YPR069C",835).
component("YDR127W",306).
component("YHR190W",494).
component("YLR146C",632).
component("YHR068W",478).
component("YLR303W",648).
component("YGR012W",428).
component("YML082W",672).
component("YJR130C",570).
component("YDR035W",294).
component("YBR249C",225).
component("YLR180W",637).
component("YDR502C",342).
component("YOR274W",787).
component("YBR256C",227).
component("YHR137W",487).
component("YGL202W",422).
component("YLR027C",618).
component("YKL106W",585).
component("YOL140W",762).
component("YLR438W",661).
component("YGR019W",429).
component("YLR089C",627).
component("U64_",140).
component("U61_",137).
component("U51_",129).
component("YJR148W",574).
component("YHR208W",497).
component("YFL030W",391).
component("YOR184W",777).
component("YNR058W",742).
component("YIL116W",512).
component("YGL253W",425).
component("YFR053C",399).
component("YMR013C",679).
component("YMR205C",693).
component("YGR240C",451).
component("YOL016C",746).
component("YFR014C",394).
component("YLR240W",641).
component("YKL203C",600).
component("YJR066W",563).
component("YCR036W",248).
component("YCL040W",238).
component("U15_",59).
component("YPL188W",815).
component("YJR049C",560).
component("YEL041W",352).
component("U96_",168).
component("YKL001C",577).
component("YDR236C",317).
component("YHL032C",464).
component("YDR531W",346).
component("U83_",159).
component("U82_",158).
component("U81_",157).
component("YMR208W",694).
component("YPL203W",816).
component("YOR061W",767).
component("YKL166C",592).
component("YJL164C",546).
component("YIL035C",501).
component("YHR205W",496).
component("YHR102W",484).
component("YGL019W",407).
component("YHR025W",471).
component("YOR347C",793).
component("YAL038W",174).
component("YNR012W",734).
component("YDR009W",291).
component("YDR127W",307).
component("YDR147W",310).
component("YDR300C",324).
...
component("U17_",73).
component("U76_",151).
component("YER170W",384).
component("YDR226W",315).
component("YKL067W",583).
component("YOL055C",749).
component("YDR454C",339).
component("YJR057W",561).
component("YOL061W",753).
component("YKL181W",593).
component("YHL011C",462).
component("YER099C",381).
component("YBL068W",188).
component("YOR143C",773).
component("YNL256W",723).
component("YLR328W",650).
component("YBR018C",192).
component("YGR007W",427).
component("YGR202C",447).
component("YLR328W",651).
component("YDL045C",257).
component("U80_",156).
component("YDL103C",268).
component("U94_",167).
component("YJR010W",556).
component("YBR029C",196).
component("YCL050C",239).
component("YGL130W",416).
component("YDR530C",345).
component("YPR190C",847).
component("YPR187W",846).
component("YPR110C",840).
component("YPR010C",831).
component("YOR341W",792).
component("YOR340C",791).
component("YOR224C",785).
component("YOR210W",782).
component("YOR207C",780).
component("YOR151C",774).
component("YOR116C",770).
component("YOL005C",744).
component("YNR003C",732).
component("YNL248C",722).
component("YNL151C",716).
component("YNL113W",713).
component("YKL144C",588).
component("YJR063W",562).
component("YJL148W",544).
component("YJL140W",543).
component("YIL021W",500).
component("YHR143W-A",488).
component("YGL070C",414).
component("YFL036W",392).
component("YDR404C",334).
component("YDR156W",312).
component("YDR045C",296).
component("YDL150W",277).
component("YDL140C",271).
component("YBR154C",214).
component("YPR175W",844).
component("YPL167C",812).
component("YOR330C",789).
component("YOL115W",760).
component("YNL299W",730).
component("YNL262W",725).
component("YNL102W",711).
component("YJR043C",559).
component("YJR006W",554).
component("YJL090C",535).
component("YIL139C",515).
component("YEL055C",355).
component("YDR419W",336).
component("YDR121W",304).
component("YDL102W",267).
component("YCR014C",243).
component("YBR278W",230).
component("YBL035C",184).
component("YKL035W",581).
component("YHL012W",463).
component("YHR123W",485).
component("YPR113W",841).
component("YBR243C",222).
component("YDL142C",276).
component("YPL148C",810).
component("YER026C",362).
component("YGR286C",459).
component("YHR189W",493).
component("YDR058C",299).
component("YDL086W",265).
component("YOL011W",745).
component("YMR008C",677).
component("YMR006C",676).
component("U105_",23).
component("YBL015W",182).
component("YJL068C",532).
component("YOR040W",766).
component("U77_",152).
component("YDR481C",340).
component("YLR377C",656).
component("YPL179W",814).
component("YNR032W",737).
component("YML057W",670).
component("YML016C",665).
component("YLR433C",660).
component("YGR123C",440).
component("YER133W",382).
component("YER089C",378).
component("YDR436W",337).
component("YDR075W",301).
component("YDL188C",284).
component("YDL134C",270).
component("YDL047W",258).
component("YDL006W",251).
component("YBR125C",209).
component("YBL056W",187).
component("YPR073C",836).
component("YHR215W",498).
component("YDL024C",254).
component("YBR093C",204).
component("YBR092C",203).
component("YAR071W",178).
component("YHR046C",475).
component("U9_",171).
component("YPL228W",819).
component("YMR180C",692).
component("YDL236W",288).
component("YJL155C",545).
component("YPR073C",837).
component("YOR208W",781).
component("YNL053W",708).
component("YMR036C",680).
component("YIR026C",525).
component("YIL113W",511).
component("YFR028C",396).
component("YER075C",374).
component("YDL230W",287).
...
component("U25_",106).
component("U24_",105).
component("YHR044C",474).
component("YHR043C",473).
component("YOL064C",754).
component("YOR360C",795).
component("YKR031C",606).
component("YPL206C",817).
component("YGL027C",409).
component("YLR286C",645).
component("YJR153W",575).
component("YJL221C",553).
component("YJL216C",551).
component("YIL172C",523).
component("YGR292W",461).
component("YGR287C",460).
component("YBR299W",234).
component("YBR184W",217).
component("YIL162W",520).
component("YIR019C",524).
component("YIL099W",509).
component("YDL037C",256).
component("YOR190W",778).
component("YLR300W",647).
component("YGR282C",458).
component("YDR261C",320).
component("YDR400W",332).
component("YML035C",667).
component("YJL070C",533).
component("YBR284W",231).
component("U106_",24).
component("YER043C",363).
component("YNL045W",706).
component("YGL037C",410).
component("YDR242W",318).
component("YBR208C",219).
component("YMR281W",699).
component("U53_",131).
component("YPR062W",834).
component("YMR120C",687).
component("YLR028C",620).
component("YHR144C",489).
component("YGR267C",457).
component("YBL033C",183).
component("YBR153W",213).
component("YNL141W",714).
component("YLR245C",642).
component("YML035C",668).
component("YBR084W",201).
component("YJL126W",538).
component("U44_",123).
component("YDL100C",266).
component("U87_",161).
component("U40_",121).
component("U39_",119).
component("YBR011C",191).
component("YHR201C",495).
component("YBR111C",205).
component("YBR252W",226).
component("YER005W",360).
component("YIL048W",503).
component("YER166W",383).
component("YDR093W",302).
component("YAL026C",173).
component("YBL099W",189).
component("U60_",136).
component("YLR231C",640).
component("U88_",162).
component("YDR538W",348).
component("YLR134W",629).
component("YLR044C",622).
component("YGR087C",436).
component("YDR380W",331).
component("YDL080C",262).
component("U98_",169).
component("YMR250W",696).
component("YOR128C",771).
component("YEL021W",350).
component("YNR043W",739).
component("U93_",166).
component("U54_",132).
component("YKL211C",601) :- not remove_orf("YKL211C",601).
component("YKR097W",613).
component("YNL169C",717).
component("YNL256W",724).
component("YDR294C",322).
component("YEL046C",353).
component("YNR033W",738).
component("YKL211C",602) :- not remove_orf("YKL211C",602).
component("YER090W",602) :- not remove_orf("YER090W",602).
component("YER090W",379) :- not remove_orf("YER090W",379).
component("YDR127W",308).
component("YPL281C",829).
component("YOR393W",801).
component("YMR323W",702).
component("YHR174W",490).
component("YGR254W",453).
component("YOR202W",779).
component("YPL262W",824).
component("YGL026C",408) :- not remove_orf("YGL026C",408).
component("YGR155W",441).
component("YLR304C",649).
component("YJL200C",549).
component("YNL316C",731).
component("YKL182W",595).
component("YPL212C",818).
component("YNL292W",729).
component("YGL063W",413).
component("YFL001W",387).
component("YPR002W",830).
component("YJR016C",557).
component("YCR053W",250).
component("YDR127W",309).
component("YGL148W",417).
component("YIL168W",522).
component("YIL167W",521).
component("YCL064C",240).
component("YER086W",376).
component("YLR359W",655).
component("YAL012W",172).
component("YML004C",663).
component("YFR055W",400).
component("YJL005W",528).
component("YJL121C",537).
component("YBR019C",193).
component("YDR050C",298).
component("YDR007W",290) :- not remove_orf("YDR007W",290).
component("YOR095C",769).
component("YER003C",359).
component("YBR196C",218).
component("YGL001C",402).
component("YPL117C",808).
component("U14_",51).
component("YOL056W",750).
component("YKL152C",591).
component("YDL021W",252).
component("YMR105C",683).
component("YKL127W",586).
component("YEL058W",356).
component("YPR060C",833).
component("YHR072W",479).
component("YPL097W",806).
component("YGR185C",445).
component("YGR264C",456).
component("YGR171C",443).
component("YHR011W",468).
component("YDR023W",293).
component("YPL104W",807).
component("YLL018C",614).
component("YPR081C",839).
component("YBR121C",208).
component("YHR020W",470).
component("YER087W",377).
component("YNL247W",721).
component("YOR168W",775).
component("YOL097C",758).
component("YDR268W",321).
component("YPR047W",832).
component("YLR060W",625).
component("YFL022C",390).
component("YCR024C",244).
component("YHR019C",469).
component("YKL194C",599).
component("YIL078W",506).
component("YPL160W",811).
component("YLR382C",657).
component("YNL073W",710).
component("YOR335C",790).
component("YGR094W",438).
component("YLR153C",633).
component("YAL054C",175).
component("YGR244C",452).
component("YIL145C",516).
component("U89_",163).
component("YJL101C",536).
component("YOL049W",748).
component("YAR015W",177).
component("YER183C",386).
component("U90_",165).
component("YNR057C",741).
component("YDL141W",272).
component("YDL141W",273).
component("YGL234W",424).
component("YDL141W",274).
component("YJR103W",567).
component("YBL039C",185).
component("YGR204W",449).
component("YBR084W",202).
component("YNL220W",719).
component("YOL058W",751).
component("YDL141W",275).
component("YHR074W",480).
component("YMR217W",695).
component("YGR061C",434).
component("YJR109C",569).
component("YJL130C",541).
component("YGL062W",412).
component("YBR218C",220).
component("YPL231W",823).
component("YNR016C",735).
component("YKL182W",596).
component("YGR037C",431).
component("YPR138C",842).
component("YPL265W",825).
component("YPL134C",809).
component("YPL036W",804).
component("YOR348C",794).
component("YOR222W",784).
component("YOR171C",776).
component("YOR130C",772).
component("YOR011W",765).
component("YOL156W",764).
component("YOL103W",759).
component("YOL020W",747) :- not remove_orf("YOL020W",747).
component("YNR072W",743).
component("YNR056C",740).
component("YNL270C",726).
component("YNL142W",715).
component("YMR272C",698).
component("YMR011W",678).
component("YLR348C",653).
component("YLR260W",644).
component("YLR138W",630).
component("YLR100C",628).
component("YLR081W",626).
component("YLL061W",617).
component("YKR093W",612).
component("YKR053C",608).
component("YKR039W",607) :- not remove_orf("YKR039W",607).
component("YJR158W",576).
component("YJR077C",565).
component("YJL219W",552).
component("YJL214W",550).
component("YJL134W",542).
component("YJL129C",539).
component("YIL134W",514).
component("YHR096C",483).
component("YHR094C",482).
component("YHR092C",481).
component("YHL036W",465).
component("YGR121C",439).
component("YGR065C",435).
component("YGR055W",432).
component("YGL186C",419).
component("YGL077C",415).
component("YGL008C",403).
component("YFL055W",393).
component("YFL011W",388).
component("YER060W-A",367).
component("YER060W",366).
component("YER056C",365).
component("YER053C",364).
component("YEL069C",358).
component("YEL063C",357).
component("YEL017C-A",349).
component("YDR536W",347).
component("YDR508C",344).
component("YDR503C",343).
component("YDR497C",341).
component("YDR345C",328).
component("YDR343C",327).
component("YDR342C",326).
component("YDR297W",323).
component("YDR046C",297) :- not remove_orf("YDR046C",297).
component("YDL245C",289).
component("YDL210W",285).
component("YCR032W",247).
component("YCR028C",246).
...
catalyst(2121,22).
catalyst(2122,22).
catalyst(3620,330) :- not remove_reaction(3620,330).
catalyst(2110,398).
catalyst(2190,398).
catalyst(5550,571).
catalyst(5791,639).
...
catalyst(2300,166).
catalyst(3460,132).
catalyst(3600,601) :- not remove_reaction(3600,601).
catalyst(8000,613).
catalyst(6890,717).
catalyst(2570,724).
catalyst(8781,322).
...
catalyst(4560,353).
catalyst(2550,738).
catalyst(1890,602) :- not remove_reaction(1890,602).
catalyst(3630,602) :- not remove_reaction(3630,602).
...
catalyst(1210,764).
catalyst(1160,759).
catalyst(801,747) :- not remove_reaction(801,747).
catalyst(802,747) :- not remove_reaction(802,747).
catalyst(811,747) :- not remove_reaction(811,747).
catalyst(812,747) :- not remove_reaction(812,747).
catalyst(831,747) :- not remove_reaction(831,747).
catalyst(832,747) :- not remove_reaction(832,747).
catalyst(901,747) :- not remove_reaction(901,747).
catalyst(902,747) :- not remove_reaction(902,747).
catalyst(1180,743).
catalyst(1210,743).
catalyst(700,740).
catalyst(931,726).
...
catalyst(640,612).
catalyst(6560,608).
catalyst(771,607) :- not remove_reaction(771,607).
catalyst(772,607) :- not remove_reaction(772,607).
catalyst(781,607) :- not remove_reaction(781,607).
catalyst(782,607) :- not remove_reaction(782,607).
catalyst(801,607) :- not remove_reaction(801,607).
catalyst(802,607) :- not remove_reaction(802,607).
catalyst(811,607) :- not remove_reaction(811,607).
catalyst(812,607) :- not remove_reaction(812,607).
catalyst(831,607) :- not remove_reaction(831,607).
catalyst(832,607) :- not remove_reaction(832,607).
catalyst(841,607) :- not remove_reaction(841,607).
catalyst(842,607) :- not remove_reaction(842,607).
catalyst(851,607) :- not remove_reaction(851,607).
catalyst(852,607) :- not remove_reaction(852,607).
catalyst(881,607) :- not remove_reaction(881,607).
catalyst(882,607) :- not remove_reaction(882,607).
catalyst(901,607) :- not remove_reaction(901,607).
catalyst(902,607) :- not remove_reaction(902,607).
catalyst(911,607) :- not remove_reaction(911,607).
catalyst(912,607) :- not remove_reaction(912,607).
catalyst(921,607) :- not remove_reaction(921,607).
catalyst(922,607) :- not remove_reaction(922,607).
catalyst(931,607) :- not remove_reaction(931,607).
catalyst(932,607) :- not remove_reaction(932,607).
catalyst(1191,607) :- not remove_reaction(1191,607).
catalyst(1192,607) :- not remove_reaction(1192,607).
catalyst(1180,576).
catalyst(1210,576).
catalyst(1581,565).
catalyst(1582,565).
...
catalyst(851,297) :- not remove_reaction(851,297).
catalyst(852,297) :- not remove_reaction(852,297).
