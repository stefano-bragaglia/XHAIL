...
component("YLR056W",543).
component("YGR060W",377).
component("YGL012W",349).
component("YKR009C",525).
component("YOL086C",659).
component("YMR303C",608).
component("YGL256W",371).
component("YDL168W",232).
component("YBR145W",174).
component("YPL231W",720).
component("YBR265W",189).
component("U46_",101).
component("YBR149W",175).
component("YBR149W",176).
component("YGL001C",346).
component("YIL094C",443).
component("U45_",100).
component("YML056C",586).
component("YLR432W",576).
component("YHR216W",436).
component("YAR075W",148).
component("YAR073W",147).
component("YDR127W",257).
component("YJR139C",502).
component("YML075C",588).
component("YLR450W",579).
component("YOL126C",665).
component("YKL085W",510).
component("YDL078C",219).
component("YNL037C",613).
component("YNL009W",611).
component("YLR174W",555).
component("YHR183W",429).
component("YGR256W",395).
component("YNL241C",627).
component("YOL059W",657).
component("YDL022W",212).
component("YCL018W",197).
component("YLR355C",571).
component("YIL074C",441).
component("YER081W",322).
component("YDL174C",236).
component("YML086C",590).
component("YIL155C",452).
component("YGR088W",380).
component("YDR256C",269).
component("YKL026C",508).
component("YIR037W",461).
component("YBR244W",185).
component("YJR078W",496).
component("U58_",109).
component("YJR025C",489).
component("U107_",24).
component("YHR007C",405).
component("YDR402C",283).
component("YGL055W",356).
component("YJR104C",498).
component("YHR008C",406).
component("YOR384W",701).
component("YOR381W",700).
component("YOL152W",667).
component("YLL051C",536).
component("YJL026W",463).
component("YIL066C",440).
component("YGR180C",386).
component("YER070W",319).
component("U37_",94).
component("U36_",93).
component("YDL168W",233).
component("YJR009C",486).
component("YJL052W",465).
component("YGR192C",388).
component("YBR006W",158).
component("YPL276W",728).
component("YPL275W",727).
component("YOR388C",702).
component("YOR374W",698).
component("YER073W",320).
component("YGL154C",363).
component("U55_",108).
component("YER069W",317).
component("YOR323C",690).
component("YER178W",331).
component("YBR221C",183).
component("YIL125W",448).
component("U52_",106).
component("YBR166C",178).
component("YGL012W",350).
component("YKL216W",524).
component("YDR044W",248).
component("YKR009C",526).
component("YIL160C",453).
component("YGL205W",368).
component("YMR118C",599).
component("YLR164W",553).
component("YLL041C",535).
component("YKL148C",514).
component("YKL141W",512).
component("YJL045W",464).
component("YDR178W",264).
component("YEL047C",302).
component("YDL171C",234).
component("YDL171C",235).
component("YOR375C",699).
component("YDL215C",240).
component("YAL062W",145).
component("U99_",140).
component("U100_",20).
component("YBR035C",164).
component("YKR080W",531).
component("YER023W",309).
component("YOR236W",688).
component("YGR204W",389).
component("YIR034C",460).
component("YLR142W",550).
component("U65_",115).
component("U63_",113).
component("U62_",112).
component("YHR068W",415).
component("YKL150W",515).
component("YIL043C",439).
component("YHR042W",410).
component("YPL171C",714).
component("YHR179W",428).
component("YMR145C",602).
component("YML120C",591).
component("YKL192C",521).
component("YDL085W",221).
component("YGR234W",391).
component("YFR030W",342).
component("YPL017C",704).
component("YFL018C",335).
component("YDR353W",279).
component("YPR167C",740).
component("YJR137C",501).
component("YNL052W",615).
component("YMR256C",607).
component("YLR395C",575).
component("YLR038C",541).
component("YIL111W",445).
component("YHR051W",414).
component("YGL191W",366).
component("YGL187C",365).
component("YDL067C",218).
component("Q0275",19).
component("Q0250",18).
component("YDR072C",253).
component("YPL266W",726).
component("YKR069W",530).
component("YOL096C",660).
component("U47_",102).
component("YER091C",327).
component("YJR073C",494).
component("YGR157W",384).
component("YDR120C",255).
component("YML008C",581).
component("YOR074C",672).
component("YDL033C",214).
component("YOL096C",661).
component("YLR172C",554).
component("YLR058C",544).
component("YDR019C",246).
component("YBR176W",179).
component("YDR408C",285).
component("YMR120C",600).
component("YLR028C",539).
component("YBL013W",149).
component("YJL130C",473).
component("YKL024C",507).
component("YPR074C",736).
component("YBR117C",172).
component("YMR108W",598).
component("YCL009C",196).
component("YNL071W",617).
component("YNR008W",639).
component("YIL160C",454).
component("YNR019W",642).
component("YCR048W",208).
component("U48_",103).
component("YDR232W",266).
component("YPL231W",721).
component("YER061C",316).
component("YDL052C",217).
component("U8_",134).
component("YPL231W",722).
component("YPL028W",705).
component("YLR299W",564).
component("YGL017W",351).
component("YML126C",592).
component("YNL104C",620).
component("YDL182W",237).
component("YDL131W",225).
component("YDR307W",275).
component("YLR258W",561).
component("YFR015C",340).
component("YNL029C",612).
component("YIL085C",442).
component("YMR306W",609).
component("YLR342W",570).
component("YGR032W",374).
component("YLR209C",557).
component("U104_",21).
component("YDR354W",280) :- not remove_orf("YDR354W",280).
component("YFR047C",343).
component("YJR133W",500).
component("YLR209C",558).
component("YML022W",583).
component("YDR441C",288).
component("YHR128W",423).
component("YJL167W",478).
component("YJL167W",479).
component("YDR127W",258).
component("YHR190W",431).
component("YLR146C",551).
component("YHR068W",416).
component("YLR303W",566).
component("YGR012W",372).
component("YML082W",589).
component("YJR130C",499).
component("YDR035W",247).
component("YBR249C",186).
component("YLR180W",556).
component("YDR502C",291).
component("YOR274W",689).
component("YBR256C",188).
component("YHR137W",424).
component("YGL202W",367).
component("YLR027C",538).
component("YKL106W",511).
component("YOL140W",666).
component("YLR438W",578).
component("YGR019W",373).
component("YLR089C",546).
component("U64_",114).
component("U61_",111).
component("U51_",105).
component("YJR148W",503).
component("YHR208W",434).
component("YFL030W",336).
component("YOR184W",681).
component("YNR058W",647).
component("YIL116W",447).
component("YGL253W",370).
component("YFR053C",344).
component("YMR013C",596).
component("YMR205C",603).
component("YGR240C",392).
component("YOL016C",651).
component("YFR014C",339).
component("YCR036W",207).
component("YCL040W",199).
component("U15_",48).
component("YPL188W",716).
component("YJR049C",491).
component("YEL041W",300).
component("U96_",138).
component("YKL001C",506).
component("YDR236C",267).
component("YHL032C",403).
component("YDR531W",295).
component("U83_",131).
component("U82_",130).
component("U81_",129).
component("YMR208W",604).
component("YPL203W",717).
component("YOR061W",671).
component("YKL166C",517).
component("YJL164C",477).
component("YIL035C",438).
component("YHR205W",433).
component("YHR102W",422).
component("YGL019W",352).
component("YHR025W",409).
component("YOR347C",695).
component("YAL038W",143).
component("YNR012W",640).
component("YDR009W",245).
component("YDR127W",259).
component("YDR147W",262).
component("YDR300C",274).
component("YCR012W",202).
component("YER069W",318).
component("U19_",73).
component("U18_",66).
component("U17_",58).
component("U76_",124).
component("YER170W",330).
component("YDR226W",265).
component("YKL067W",509).
component("YOL055C",654).
component("YDR454C",289).
component("YJR057W",492).
component("YOL061W",658).
component("YKL181W",518).
component("YHL011C",402).
component("YER099C",328).
component("YBL068W",156).
component("YOR143C",677).
component("YNL256W",630).
component("YLR328W",568).
component("YBR018C",160).
component("YLR328W",569).
component("U80_",128).
component("U94_",137).
component("YJR010W",487).
component("YBR029C",163).
component("YCL050C",200).
component("YGL130W",361).
component("YDR530C",294).
component("YPR190C",743).
component("YPR187W",742).
component("YPR110C",737).
component("YPR010C",731).
component("YOR341W",694).
component("YOR340C",693).
component("YOR224C",687).
component("YOR210W",685).
component("YOR207C",683).
component("YOR151C",678).
component("YOR116C",674).
component("YOL005C",649).
component("YNR003C",638).
component("YNL248C",629).
component("YNL151C",624).
component("YNL113W",621).
component("YKL144C",513).
component("YJR063W",493).
component("YJL148W",476).
component("YJL140W",475).
component("YIL021W",437).
component("YHR143W-A",425).
component("YGL070C",359).
component("YFL036W",337).
component("YDR404C",284).
component("YDR156W",263).
component("YDR045C",249).
component("YDL150W",231).
component("YDL140C",227).
component("YBR154C",177).
component("YPR175W",741).
component("YPL167C",713).
component("YOR330C",691).
component("YOL115W",664).
component("YNL299W",636).
component("YNL262W",632).
component("YNL102W",619).
component("YJR043C",490).
component("YJR006W",485).
component("YJL090C",468).
component("YIL139C",450).
component("YEL055C",303).
component("YDR419W",286).
component("YDR121W",256).
component("YDL102W",224).
component("YCR014C",203).
component("YBR278W",191).
component("YBL035C",152).
component("YPR113W",738).
component("YBR243C",184).
component("YPL148C",711).
component("YER026C",310).
component("YGR286C",399).
component("YHR189W",430).
component("YDR058C",252).
component("YDL086W",222).
component("YOL011W",650).
component("YMR008C",594).
component("YMR006C",593).
component("U105_",22).
component("YBL015W",150).
component("YJL068C",466).
component("YOR040W",670).
component("U77_",125).
component("YLR377C",573).
component("YPL179W",715).
component("YNR032W",643).
component("YML057W",587).
component("YML016C",582).
component("YLR433C",577).
component("YGR123C",382).
component("YER133W",329).
component("YER089C",325).
component("YDR436W",287).
component("YDR075W",254).
component("YDL188C",238).
component("YDL134C",226).
component("YDL047W",216).
component("YDL006W",210).
component("YBR125C",173).
component("YBL056W",155).
component("YPR073C",734).
component("YHR215W",435).
component("YDL024C",213).
component("YBR093C",170).
component("YBR092C",169).
component("YHR046C",413).
component("U9_",141).
component("YDL236W",242).
component("YPR073C",735).
component("YOR208W",684).
component("YNL053W",616).
component("YMR036C",597).
component("YIR026C",459).
component("YIL113W",446).
component("YFR028C",341).
component("YER075C",321).
component("YDL230W",241).
component("YBR276C",190).
component("U34_",92).
component("U33_",91).
component("U32_",90).
component("U31_",89).
...
component("U25_",85).
component("U24_",84).
component("YHR044C",412).
component("YHR043C",411).
component("YOR360C",697).
component("YKR031C",527).
component("YPL206C",718).
component("YGL027C",354).
component("YLR286C",563).
component("YJR153W",504).
component("YJL221C",484).
component("YJL216C",482).
component("YIL172C",457).
component("YGR292W",401).
component("YGR287C",400).
component("YBR299W",195).
component("YBR184W",180).
component("YIR019C",458).
component("YIL099W",444).
component("YDL037C",215).
component("YOR190W",682).
component("YLR300W",565).
component("YGR282C",398).
component("YDR261C",270).
component("YDR400W",282).
component("YML035C",584).
component("YJL070C",467).
component("YBR284W",192).
component("U106_",23).
component("YER043C",311).
component("YNL045W",614).
component("YGL037C",355).
component("YDR242W",268).
component("U53_",107).
component("YPR062W",733).
component("YMR120C",601).
component("YLR028C",540).
component("YHR144C",426).
component("YGR267C",397).
component("YBL033C",151).
component("YNL141W",622).
component("YLR245C",560).
component("YML035C",585).
component("YBR084W",167).
component("YJL126W",471).
component("U44_",99).
component("YDL100C",223).
component("U87_",133).
component("U40_",97).
component("U39_",95).
component("YBR011C",159).
component("YHR201C",432).
component("YBR111C",171).
component("YBR252W",187).
component("YER005W",308).
component("YBL099W",157).
component("YLR231C",559).
component("YDR538W",297).
component("YLR134W",548).
component("YLR044C",542).
component("YGR087C",379).
component("YDR380W",281).
component("YDL080C",220).
component("U98_",139).
component("YMR250W",606).
component("YOR128C",675).
component("YEL021W",299).
component("YNR043W",645).
component("U93_",136).
component("YKL211C",522) :- not remove_orf("YKL211C",522).
component("YKR097W",533).
component("YNL169C",625).
component("YNL256W",631).
component("YDR294C",272).
component("YEL046C",301).
component("YNR033W",644).
component("YKL211C",523) :- not remove_orf("YKL211C",523).
component("YER090W",523) :- not remove_orf("YER090W",523).
component("YER090W",326) :- not remove_orf("YER090W",326).
component("YDR127W",260).
component("YPL281C",729).
component("YOR393W",703).
component("YMR323W",610).
component("YHR174W",427).
component("YGR254W",394).
component("YPL262W",724).
component("YGL026C",353) :- not remove_orf("YGL026C",353).
component("YGR155W",383).
component("YLR304C",567).
component("YJL200C",480).
component("YNL316C",637).
component("YKL182W",519).
component("YPL212C",719).
component("YNL292W",635).
component("YGL063W",358).
component("YFL001W",333).
component("YPR002W",730).
component("YJR016C",488).
component("YCR053W",209).
component("YDR127W",261).
component("YGL148W",362).
component("YIL168W",456).
component("YIL167W",455).
component("YCL064C",201).
component("YER086W",323).
component("YLR359W",572).
component("YAL012W",142).
component("YML004C",580).
component("YFR055W",345).
component("YJL005W",462).
component("YJL121C",470).
component("YBR019C",161).
component("YDR050C",251).
component("YDR007W",244) :- not remove_orf("YDR007W",244).
component("YOR095C",673).
component("YER003C",307).
component("YBR196C",181).
component("YGL001C",347).
component("YPL117C",709).
component("U14_",40).
component("YOL056W",655).
component("YKL152C",516).
component("YDL021W",211).
component("YEL058W",304).
component("YPR060C",732).
component("YHR072W",417).
component("YPL097W",707).
component("YGR185C",387).
component("YGR264C",396).
component("YGR171C",385).
component("YPL104W",708).
component("YLL018C",534).
component("YHR020W",408).
component("YER087W",324).
component("YNL247W",628).
component("YOR168W",679).
component("YOL097C",662).
component("YDR268W",271).
component("YCR024C",204).
component("YHR019C",407).
component("YPL160W",712).
component("YLR382C",574).
component("YNL073W",618).
component("YOR335C",692).
component("YLR153C",552).
component("YAL054C",144).
component("YGR244C",393).
component("YIL145C",451).
component("YJL101C",469).
component("YOL049W",653).
component("YAR015W",146).
component("YER183C",332).
component("U90_",135).
component("YNR057C",646).
component("YDL141W",228).
component("YGL234W",369).
component("YDL141W",229).
component("YJR103W",497).
component("YBL039C",153).
component("YGR204W",390).
component("YBR084W",168).
component("YNL220W",626).
component("YOL058W",656).
component("YDL141W",230).
component("YHR074W",418).
component("YMR217W",605).
component("YGL062W",357).
component("YBR218C",182).
component("YPL231W",723).
component("YNR016C",641).
component("YKL182W",520).
component("YGR037C",375).
component("YPR138C",739).
component("YPL265W",725).
component("YPL134C",710).
component("YPL036W",706).
component("YOR348C",696).
component("YOR222W",686).
component("YOR171C",680).
component("YOR130C",676).
component("YOR011W",669).
component("YOL156W",668).
component("YOL103W",663).
component("YOL020W",652) :- not remove_orf("YOL020W",652).
component("YNR072W",648).
component("YNL270C",633).
component("YNL142W",623).
component("YMR011W",595).
component("YLR260W",562).
component("YLR138W",549).
component("YLR100C",547).
component("YLR081W",545).
component("YLL061W",537).
component("YKR093W",532).
component("YKR053C",529).
component("YKR039W",528) :- not remove_orf("YKR039W",528).
component("YJR158W",505).
component("YJR077C",495).
component("YJL219W",483).
component("YJL214W",481).
component("YJL134W",474).
component("YJL129C",472).
component("YIL134W",449).
component("YHR096C",421).
component("YHR094C",420).
component("YHR092C",419).
component("YHL036W",404).
component("YGR121C",381).
component("YGR065C",378).
component("YGR055W",376).
component("YGL186C",364).
component("YGL077C",360).
component("YGL008C",348).
component("YFL055W",338).
component("YFL011W",334).
component("YER060W-A",315).
component("YER060W",314).
component("YER056C",313).
component("YER053C",312).
component("YEL069C",306).
component("YEL063C",305).
component("YEL017C-A",298).
component("YDR536W",296).
component("YDR508C",293).
component("YDR503C",292).
component("YDR497C",290).
component("YDR345C",278).
component("YDR343C",277).
component("YDR342C",276).
component("YDR297W",273).
component("YDR046C",250) :- not remove_orf("YDR046C",250).
component("YDL245C",243).
component("YDL210W",239).
component("YCR032W",206).
component("YCR024C-A",205).
component("YCL025C",198).
component("YBR298C",194).
component("YBR291C",193).
component("YBR069C",166) :- not remove_orf("YBR069C",166).
component("YBR068C",165) :- not remove_orf("YBR068C",165).
component("YBR021W",162).
component("YBL042C",154).
component("U85_",132).
component("U7_",127).
component("U78_",126).
component("U75_",123).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,280) :- not remove_reaction(3620,280).
catalyst(2110,343).
catalyst(2190,343).
catalyst(5550,500).
catalyst(5791,558).
...
catalyst(6470,645).
catalyst(2300,136).
catalyst(3600,522) :- not remove_reaction(3600,522).
catalyst(8000,533).
catalyst(6890,625).
catalyst(2570,631).
catalyst(8781,272).
...
catalyst(4560,301).
catalyst(2550,644).
catalyst(1890,523) :- not remove_reaction(1890,523).
catalyst(3630,523) :- not remove_reaction(3630,523).
catalyst(1890,326) :- not remove_reaction(1890,326).
catalyst(3630,326) :- not remove_reaction(3630,326).
catalyst(3740,260).
catalyst(8231,729).
catalyst(8232,729).
catalyst(8231,703).
...
catalyst(8051,724).
catalyst(8052,724).
catalyst(3590,353) :- not remove_reaction(3590,353).
catalyst(10910,353) :- not remove_reaction(10910,353).
catalyst(4570,383).
catalyst(8181,567).
catalyst(8182,567).
catalyst(8181,480).
...
catalyst(8281,251).
catalyst(8282,251).
catalyst(3610,244) :- not remove_reaction(3610,244).
catalyst(7921,673).
catalyst(7922,673).
catalyst(7841,307).
catalyst(7842,307).
...
catalyst(1210,668).
catalyst(1160,663).
catalyst(801,652) :- not remove_reaction(801,652).
catalyst(802,652) :- not remove_reaction(802,652).
catalyst(811,652) :- not remove_reaction(811,652).
catalyst(812,652) :- not remove_reaction(812,652).
catalyst(831,652) :- not remove_reaction(831,652).
catalyst(832,652) :- not remove_reaction(832,652).
catalyst(901,652) :- not remove_reaction(901,652).
catalyst(902,652) :- not remove_reaction(902,652).
catalyst(1180,648).
catalyst(1210,648).
catalyst(931,633).
catalyst(932,633).
...
catalyst(640,532).
catalyst(6560,529).
catalyst(771,528) :- not remove_reaction(771,528).
catalyst(772,528) :- not remove_reaction(772,528).
catalyst(781,528) :- not remove_reaction(781,528).
catalyst(782,528) :- not remove_reaction(782,528).
catalyst(801,528) :- not remove_reaction(801,528).
catalyst(802,528) :- not remove_reaction(802,528).
catalyst(811,528) :- not remove_reaction(811,528).
catalyst(812,528) :- not remove_reaction(812,528).
catalyst(831,528) :- not remove_reaction(831,528).
catalyst(832,528) :- not remove_reaction(832,528).
catalyst(841,528) :- not remove_reaction(841,528).
catalyst(842,528) :- not remove_reaction(842,528).
catalyst(851,528) :- not remove_reaction(851,528).
catalyst(852,528) :- not remove_reaction(852,528).
catalyst(881,528) :- not remove_reaction(881,528).
catalyst(882,528) :- not remove_reaction(882,528).
catalyst(901,528) :- not remove_reaction(901,528).
catalyst(902,528) :- not remove_reaction(902,528).
catalyst(921,528) :- not remove_reaction(921,528).
catalyst(922,528) :- not remove_reaction(922,528).
catalyst(931,528) :- not remove_reaction(931,528).
catalyst(932,528) :- not remove_reaction(932,528).
catalyst(1191,528) :- not remove_reaction(1191,528).
catalyst(1192,528) :- not remove_reaction(1192,528).
catalyst(1180,505).
catalyst(1210,505).
catalyst(1581,495).
catalyst(1582,495).
...
catalyst(1210,276).
catalyst(6650,273).
catalyst(801,250) :- not remove_reaction(801,250).
catalyst(802,250) :- not remove_reaction(802,250).
catalyst(811,250) :- not remove_reaction(811,250).
catalyst(812,250) :- not remove_reaction(812,250).
catalyst(831,250) :- not remove_reaction(831,250).
catalyst(832,250) :- not remove_reaction(832,250).
catalyst(841,250) :- not remove_reaction(841,250).
catalyst(842,250) :- not remove_reaction(842,250).
catalyst(851,250) :- not remove_reaction(851,250).
catalyst(852,250) :- not remove_reaction(852,250).
catalyst(901,250) :- not remove_reaction(901,250).
catalyst(902,250) :- not remove_reaction(902,250).
catalyst(1180,243).
catalyst(1210,243).
catalyst(730,239).
catalyst(431,206).
...
catalyst(1511,193).
catalyst(1512,193).
catalyst(771,166) :- not remove_reaction(771,166).
catalyst(772,166) :- not remove_reaction(772,166).
catalyst(801,166) :- not remove_reaction(801,166).
catalyst(802,166) :- not remove_reaction(802,166).
catalyst(811,166) :- not remove_reaction(811,166).
catalyst(812,166) :- not remove_reaction(812,166).
catalyst(851,166) :- not remove_reaction(851,166).
catalyst(852,166) :- not remove_reaction(852,166).
catalyst(901,166) :- not remove_reaction(901,166).
catalyst(902,166) :- not remove_reaction(902,166).
...
catalyst(831,165) :- not remove_reaction(831,165).
catalyst(832,165) :- not remove_reaction(832,165).
catalyst(841,165) :- not remove_reaction(841,165).
catalyst(842,165) :- not remove_reaction(842,165).
catalyst(851,165) :- not remove_reaction(851,165).
catalyst(852,165) :- not remove_reaction(852,165).
...
modifiable_enzyme(522).
modifiable_enzyme(523).
