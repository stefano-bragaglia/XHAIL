...
component("YLR056W",625).
component("YGR060W",434).
component("YGL012W",405).
component("YKR009C",605).
component("YOL086C",757).
component("YMR303C",702).
component("YMR083W",684).
component("YGL256W",427).
component("YDL168W",279).
component("YBR145W",211).
...
component("U45_",125).
component("YML056C",671).
component("YLR432W",661).
component("YHR216W",500).
component("YAR075W",181).
component("YAR073W",180).
component("YDR127W",306).
component("YJR139C",574).
component("YML075C",673).
component("YLR450W",664).
component("YOL126C",763).
component("YKL085W",585).
component("YDL078C",262).
component("YKL029C",581).
component("YNL037C",707).
component("YNL009W",705).
component("YLR174W",638).
component("YHR183W",493).
component("YGR256W",456).
component("YNL241C",722).
component("YOL059W",754).
component("YDL022W",254).
component("YCL018W",237).
component("YLR355C",656).
component("YIL074C",506).
component("YER081W",376).
component("YDL174C",283).
component("YML086C",675).
component("YIL155C",518).
component("YEL024W",352).
component("YKR066C",610).
component("YGR088W",438).
component("YDR256C",320).
component("YKL026C",580).
component("YIR037W",528).
component("YBR244W",224).
component("YJR078W",567).
component("U58_",135).
component("YJR025C",559).
component("U107_",26).
component("YGR255C",455).
component("U108_",27).
component("YHR007C",467).
component("YDR402C",334).
component("YGL055W",412).
component("YJR104C",569).
component("YHR008C",468).
component("YOR384W",801).
component("YOR381W",800).
component("YOL152W",765).
component("YLL051C",618).
component("YJL026W",530).
component("YIL066C",505).
component("YGR180C",445).
component("YER070W",373).
component("U37_",119).
component("U36_",118).
component("U35_",117).
component("YDL168W",280).
component("YDR158W",314).
component("YJR009C",556).
component("YJL052W",532).
component("YGR192C",447).
component("YBR006W",191).
component("YPL276W",830).
component("YPL275W",829).
component("YOR388C",802).
component("YPL061W",807).
component("YOR374W",798).
component("YER073W",374).
component("YGL154C",419).
component("YBR115C",207).
component("U55_",134).
component("YER069W",371).
component("YOR323C",790).
component("YMR170C",693).
component("YMR169C",692).
component("YER178W",386).
component("YBR221C",222).
component("YIL125W",514).
component("U52_",131).
component("YBR166C",216).
component("YNL280C",730).
component("YGL012W",406).
component("YKL182W",595).
component("YKL216W",604).
component("YDR044W",296).
component("YKR009C",606).
component("YIL160C",519).
component("YGL205W",424).
component("YMR118C",687).
component("YLR164W",636).
component("YLL041C",616).
component("YKL148C",590).
component("YKL141W",588).
component("YJL045W",531).
component("YDR178W",315).
component("YEL047C",355).
component("YDL171C",281).
component("YDL171C",282).
component("YOR375C",799).
component("YDL215C",287).
component("YAL062W",177).
component("U99_",171).
component("U100_",21).
component("YBR035C",198).
component("YKR080W",612).
component("YER023W",362).
component("YOR236W",788).
component("YGR204W",449).
component("YIR034C",527).
component("YLR142W",633).
component("U65_",142).
component("U63_",140).
component("U62_",139).
component("YHR068W",478).
component("YKL150W",591).
component("YIL043C",503).
component("YHR042W",473).
component("YOR221C",785).
component("YMR145C",690).
component("YKL192C",598).
component("YKL055C",583).
component("YER061C",369).
component("YDL085W",264).
component("YPL171C",815).
component("YHR179W",492).
component("YMR145C",691).
component("YML120C",676).
component("YKL192C",599).
component("YDL085W",265).
component("YGR234W",451).
component("YFR030W",398).
component("YPL017C",804).
component("YFL018C",390).
component("YDR353W",330).
component("YPR167C",845).
component("YJR137C",573).
component("YNL052W",709).
component("YMR256C",699).
component("YLR395C",660).
component("YLR038C",623).
component("YIL111W",511).
component("YHR051W",477).
component("YGL191W",422).
component("YGL187C",421).
component("YDL067C",261).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",301).
component("YPL266W",828).
component("YKR069W",611).
component("YOL096C",758).
component("U47_",127).
component("YER091C",381).
component("YJR073C",565).
component("YGR157W",443).
component("YDR120C",304).
component("YML008C",666).
component("YOR074C",770).
component("YDL033C",256).
component("YOL096C",759).
component("YLR172C",637).
component("YLR058C",626).
component("YDR019C",293).
component("YBR176W",217).
component("YDR408C",336).
component("YMR120C",688).
component("YLR028C",621).
component("YBL013W",182).
component("YJL130C",541).
component("YJL088W",535).
component("YKL024C",579).
component("YPR074C",840).
component("YBR117C",208).
component("YMR108W",686).
component("YCL009C",236).
component("YNL071W",711).
component("YNR008W",735).
component("YIL160C",520).
component("YNR019W",738).
component("YCR048W",250).
component("U48_",128).
component("YMR062C",683).
component("YDR232W",317).
component("YPL231W",823).
component("YER061C",370).
component("YDL052C",260).
component("U8_",165).
component("YDR148C",312).
component("YPL231W",824).
component("YPL028W",805).
component("YLR299W",648).
component("YGL017W",407).
component("YCR005C",242).
component("YML126C",677).
component("YNL104C",714).
component("YDL182W",284).
component("YDL131W",270).
component("YDR307W",326).
component("YLR258W",645).
component("YFR015C",396).
component("YNL029C",706).
component("YIL085C",508).
component("YNL192W",720).
component("YBR038W",199).
component("YBR023C",196).
component("YMR306W",703).
component("YLR342W",654).
component("YGR032W",431).
component("YPR183W",847).
component("YBR248C",225).
component("YLR209C",640).
component("U104_",23).
component("U103_",22).
component("YDR354W",331) :- not remove_orf("YDR354W",331).
component("YFR047C",399).
component("YJR133W",572).
component("YLR209C",641).
component("YML022W",668).
component("YDR441C",339).
component("YHR128W",487).
component("YJL167W",548).
component("YJL167W",549).
component("YPR069C",837).
component("YDR127W",307).
component("YHR190W",495).
component("YLR146C",634).
component("YHR068W",479).
component("YLR303W",650).
component("YGR012W",429).
component("YML082W",674).
component("YJR130C",571).
component("YDR035W",295).
component("YBR249C",226).
component("YLR180W",639).
component("YDR502C",343).
component("YOR274W",789).
component("YBR256C",228).
component("YHR137W",488).
component("YGL202W",423).
component("YLR027C",620).
component("YKL106W",586).
component("YOL140W",764).
component("YLR438W",663).
component("YGR019W",430).
component("YLR089C",629).
component("U64_",141).
component("U61_",138).
component("U51_",130).
component("YJR148W",575).
component("YHR208W",498).
component("YFL030W",392).
component("YOR184W",779).
component("YNR058W",744).
component("YIL116W",513).
component("YGL253W",426).
component("YFR053C",400).
component("YMR013C",681).
component("YMR205C",695).
component("YGR240C",452).
component("YOL016C",748).
component("YFR014C",395).
component("YLR240W",643).
component("YKL203C",601).
component("YJR066W",564).
component("YCR036W",249).
component("YCL040W",239).
component("U15_",60).
component("YPL188W",817).
component("YJR049C",561).
component("YEL041W",353).
component("U96_",169).
component("YKL001C",578).
component("YDR236C",318).
component("YHL032C",465).
component("YDR531W",347).
component("U83_",160).
component("U82_",159).
component("U81_",158).
component("YMR208W",696).
component("YPL203W",818).
component("YOR061W",769).
component("YKL166C",593).
component("YJL164C",547).
component("YIL035C",502).
component("YHR205W",497).
component("YHR102W",485).
component("YGL019W",408).
component("YHR025W",472).
component("YOR347C",795).
component("YAL038W",175).
component("YNR012W",736).
component("YDR009W",292).
component("YDR127W",308).
component("YDR147W",311).
component("YDR300C",325).
component("YCR012W",243).
component("YER069W",372).
component("U19_",92).
component("U18_",83).
component("U17_",74).
component("U76_",152).
component("YER170W",385).
component("YDR226W",316).
component("YKL067W",584).
component("YOL055C",751).
component("YDR454C",340).
component("YJR057W",562).
component("YOL061W",755).
component("YKL181W",594).
component("YHL011C",463).
component("YER099C",382).
component("YBL068W",189).
component("YOR143C",775).
component("YNL256W",725).
component("YLR328W",652).
component("YBR018C",193).
component("YGR007W",428).
component("YGR202C",448).
component("YLR328W",653).
component("YDL045C",258).
component("U80_",157).
component("YDL103C",269).
component("U94_",168).
component("YJR010W",557).
component("YBR029C",197).
component("YCL050C",240).
component("YGL130W",417).
component("YDR530C",346).
component("YPR190C",849).
component("YPR187W",848).
component("YPR110C",842).
component("YPR010C",833).
component("YOR341W",794).
component("YOR340C",793).
component("YOR224C",787).
component("YOR210W",784).
component("YOR207C",782).
component("YOR151C",776).
component("YOR116C",772).
component("YOL005C",746).
component("YNR003C",734).
component("YNL248C",724).
component("YNL151C",718).
component("YNL113W",715).
component("YKL144C",589).
component("YJR063W",563).
component("YJL148W",545).
component("YJL140W",544).
component("YIL021W",501).
component("YHR143W-A",489).
component("YGL070C",415).
component("YFL036W",393).
component("YDR404C",335).
component("YDR156W",313).
component("YDR045C",297).
component("YDL150W",278).
component("YDL140C",272).
component("YBR154C",215).
component("YPR175W",846).
component("YPL167C",814).
component("YOR330C",791).
component("YOL115W",762).
component("YNL299W",732).
component("YNL262W",727).
component("YNL102W",713).
component("YJR043C",560).
component("YJR006W",555).
component("YJL090C",536).
component("YIL139C",516).
component("YEL055C",356).
component("YDR419W",337).
component("YDR121W",305).
component("YDL102W",268).
component("YCR014C",244).
component("YBR278W",231).
component("YBL035C",185).
component("YKL035W",582).
component("YHL012W",464).
component("YHR123W",486).
component("YPR113W",843).
component("YBR243C",223).
component("YDL142C",277).
component("YPL148C",812).
component("YER026C",363).
component("YGR286C",460).
component("YHR189W",494).
component("YDR058C",300).
component("YDL086W",266).
component("YOL011W",747).
component("YMR008C",679).
component("YMR006C",678).
component("U105_",24).
component("YBL015W",183).
component("YJL068C",533).
component("YOR040W",768).
component("U77_",153).
component("YDR481C",341).
component("YLR377C",658).
component("YPL179W",816).
component("YNR032W",739).
component("YML057W",672).
component("YML016C",667).
component("YLR433C",662).
component("YGR123C",441).
component("YER133W",383).
component("YER089C",379).
component("YDR436W",338).
component("YDR075W",302).
component("YDL188C",285).
component("YDL134C",271).
component("YDL047W",259).
component("YDL006W",252).
component("YBR125C",210).
component("YBL056W",188).
component("YPR073C",838).
component("YHR215W",499).
component("YDL024C",255).
component("YBR093C",205).
component("YBR092C",204).
component("YAR071W",179).
component("YHR046C",476).
component("U9_",172).
component("YPL228W",821).
component("YMR180C",694).
component("YDL236W",289).
component("YJL155C",546).
component("YPR073C",839).
component("YOR208W",783).
component("YNL053W",710).
component("YMR036C",682).
component("YIR026C",526).
component("YIL113W",512).
component("YFR028C",397).
component("YER075C",375).
...
component("U25_",107).
component("U24_",106).
component("YHR044C",475).
component("YHR043C",474).
component("YOL064C",756).
component("YOR360C",797).
component("YKR031C",607).
component("YPL206C",819).
component("YGL027C",410).
component("YLR286C",647).
component("YJR153W",576).
component("YJL221C",554).
component("YJL216C",552).
component("YIL172C",524).
component("YGR292W",462).
component("YGR287C",461).
component("YBR299W",235).
component("YBR184W",218).
component("YIL162W",521).
component("YIR019C",525).
component("YIL099W",510).
component("YDL037C",257).
component("YOR190W",780).
component("YLR300W",649).
component("YGR282C",459).
component("YDR261C",321).
component("YDR400W",333).
component("YML035C",669).
component("YJL070C",534).
component("YBR284W",232).
component("U106_",25).
component("YER043C",364).
component("YNL045W",708).
component("YGL037C",411).
component("YDR242W",319).
component("YBR208C",220).
component("YMR281W",701).
component("U53_",132).
component("YPR062W",836).
component("YMR120C",689).
component("YLR028C",622).
component("YHR144C",490).
component("YGR267C",458).
component("YBL033C",184).
component("YBR153W",214).
component("YNL141W",716).
component("YLR245C",644).
component("YML035C",670).
component("YBR084W",202).
component("YJL126W",539).
component("U44_",124).
component("YDL100C",267).
component("U87_",162).
component("U40_",122).
component("U39_",120).
component("YBR011C",192).
component("YHR201C",496).
component("YBR111C",206).
component("YBR252W",227).
component("YER005W",361).
component("YIL048W",504).
component("YER166W",384).
component("YDR093W",303).
component("YAL026C",174).
component("YBL099W",190).
component("U60_",137).
component("YLR231C",642).
component("U88_",163).
component("YDR538W",349).
component("YLR134W",631).
component("YLR044C",624).
component("YGR087C",437).
component("YDR380W",332).
component("YDL080C",263).
component("U98_",170).
component("YMR250W",698).
component("YOR128C",773).
component("YEL021W",351).
component("YNR043W",741).
component("U93_",167).
component("U54_",133).
...
component("YDR294C",323).
component("YEL046C",354).
component("YNR033W",740).
component("YKL211C",603) :- not remove_orf("YKL211C",603).
component("YER090W",603) :- not remove_orf("YER090W",603).
component("YER090W",380) :- not remove_orf("YER090W",380).
component("YDR127W",309).
component("YPL281C",831).
component("YOR393W",803).
component("YMR323W",704).
component("YHR174W",491).
component("YGR254W",454).
component("YOR202W",781).
component("YPL262W",826).
component("YGL026C",409) :- not remove_orf("YGL026C",409).
component("YGR155W",442).
component("YLR304C",651).
component("YJL200C",550).
component("YNL316C",733).
component("YKL182W",596).
component("YPL212C",820).
component("YNL292W",731).
component("YGL063W",414).
component("YFL001W",388).
component("YPR002W",832).
component("YJR016C",558).
component("YCR053W",251).
component("YDR127W",310).
component("YGL148W",418).
component("YIL168W",523).
component("YIL167W",522).
component("YCL064C",241).
component("YER086W",377).
component("YLR359W",657).
component("YAL012W",173).
component("YML004C",665).
component("YFR055W",401).
component("YJL005W",529).
component("YJL121C",538).
component("YBR019C",194).
component("YDR050C",299).
component("YDR007W",291) :- not remove_orf("YDR007W",291).
component("YOR095C",771).
component("YER003C",360).
component("YBR196C",219).
component("YGL001C",403).
component("YPL117C",810).
component("U14_",52).
component("YOL056W",752).
component("YKL152C",592).
component("YDL021W",253).
component("YMR105C",685).
component("YKL127W",587).
component("YEL058W",357).
component("YPR060C",835).
component("YHR072W",480).
component("YPL097W",808).
component("YGR185C",446).
component("YGR264C",457).
component("YGR171C",444).
component("YHR011W",469).
component("YDR023W",294).
component("YPL104W",809).
component("YLL018C",615).
component("YPR081C",841).
component("YBR121C",209).
component("YHR020W",471).
component("YER087W",378).
component("YNL247W",723).
component("YOR168W",777).
component("YOL097C",760).
component("YDR268W",322).
component("YPR047W",834).
component("YLR060W",627).
component("YFL022C",391).
component("YCR024C",245).
component("YHR019C",470).
component("YKL194C",600).
component("YIL078W",507).
component("YPL160W",813).
component("YLR382C",659).
component("YNL073W",712).
component("YOR335C",792).
component("YGR094W",439).
component("YLR153C",635).
component("YAL054C",176).
component("YGR244C",453).
component("YIL145C",517).
component("U89_",164).
component("YJL101C",537).
component("YOL049W",750).
component("YAR015W",178).
component("YER183C",387).
component("U90_",166).
component("YNR057C",743).
component("YDL141W",273).
component("YDL141W",274).
component("YGL234W",425).
component("YDL141W",275).
component("YJR103W",568).
component("YBL039C",186).
component("YGR204W",450).
component("YBR084W",203).
component("YNL220W",721).
component("YOL058W",753).
component("YDL141W",276).
component("YHR074W",481).
component("YMR217W",697).
component("YGR061C",435).
component("YJR109C",570).
component("YJL130C",542).
component("YGL062W",413).
component("YBR218C",221).
component("YPL231W",825).
component("YNR016C",737).
component("YKL182W",597).
component("YGR037C",432).
component("YPR138C",844).
component("YPL265W",827).
component("YPL134C",811).
component("YPL036W",806).
component("YOR348C",796).
component("YOR222W",786).
component("YOR171C",778).
component("YOR130C",774).
component("YOR011W",767).
component("YOL156W",766).
component("YOL103W",761).
component("YOL020W",749) :- not remove_orf("YOL020W",749).
component("YNR072W",745).
component("YNR056C",742).
component("YNL270C",728).
component("YNL142W",717).
component("YMR272C",700).
component("YMR011W",680).
component("YLR348C",655).
component("YLR260W",646).
component("YLR138W",632).
component("YLR100C",630).
component("YLR081W",628).
component("YLL061W",619).
component("YLL043W",617).
component("YKR093W",613).
component("YKR053C",609).
component("YKR039W",608) :- not remove_orf("YKR039W",608).
component("YJR158W",577).
component("YJR077C",566).
component("YJL219W",553).
component("YJL214W",551).
component("YJL134W",543).
component("YJL129C",540).
component("YIL134W",515).
component("YHR096C",484).
component("YHR094C",483).
component("YHR092C",482).
component("YHL036W",466).
component("YGR121C",440).
component("YGR065C",436).
component("YGR055W",433).
component("YGL186C",420).
component("YGL077C",416).
component("YGL008C",404).
component("YFL055W",394).
component("YFL011W",389).
component("YER060W-A",368).
component("YER060W",367).
component("YER056C",366).
component("YER053C",365).
component("YEL069C",359).
component("YEL063C",358).
component("YEL017C-A",350).
component("YDR536W",348).
component("YDR508C",345).
component("YDR503C",344).
component("YDR497C",342).
component("YDR345C",329).
component("YDR343C",328).
component("YDR342C",327).
component("YDR297W",324).
component("YDR046C",298) :- not remove_orf("YDR046C",298).
component("YDL245C",290).
component("YDL210W",286).
component("YCR032W",248).
component("YCR028C",247).
component("YCR024C-A",246).
component("YCL025C",238).
component("YBR298C",234).
component("YBR291C",233).
component("YBR069C",201) :- not remove_orf("YBR069C",201).
component("YBR068C",200) :- not remove_orf("YBR068C",200).
component("YBR021W",195).
...
catalyst(1890,380) :- not remove_reaction(1890,380).
catalyst(3630,380) :- not remove_reaction(3630,380).
catalyst(3740,309).
catalyst(8231,831).
catalyst(8232,831).
catalyst(8231,803).
...
catalyst(8061,826).
catalyst(8062,826).
catalyst(3590,409) :- not remove_reaction(3590,409).
catalyst(10910,409) :- not remove_reaction(10910,409).
catalyst(4570,442).
catalyst(8181,651).
catalyst(8182,651).
catalyst(8181,550).
...
catalyst(851,608) :- not remove_reaction(851,608).
catalyst(852,608) :- not remove_reaction(852,608).
...
catalyst(931,608) :- not remove_reaction(931,608).
catalyst(932,608) :- not remove_reaction(932,608).
...
catalyst(851,298) :- not remove_reaction(851,298).
catalyst(852,298) :- not remove_reaction(852,298).
...
catalyst(1511,233).
catalyst(1512,233).
catalyst(771,201) :- not remove_reaction(771,201).
catalyst(772,201) :- not remove_reaction(772,201).
...
catalyst(831,200) :- not remove_reaction(831,200).
catalyst(832,200) :- not remove_reaction(832,200).
catalyst(841,200) :- not remove_reaction(841,200).
catalyst(842,200) :- not remove_reaction(842,200).
catalyst(851,200) :- not remove_reaction(851,200).
catalyst(852,200) :- not remove_reaction(852,200).
