...
component("YNL280C",682).
component("YLR056W",585).
component("YGR060W",406).
component("YGL012W",378).
component("YKR009C",567).
component("YOL086C",708).
component("YMR303C",656).
component("YMR083W",643).
component("YGL256W",400).
component("YDL168W",256).
component("YBR145W",193).
component("YPL231W",772).
component("YBR265W",209).
component("U46_",114).
component("YBR149W",194).
component("YBR149W",195).
component("YGL001C",375).
component("YIL094C",475).
component("U45_",113).
component("YML056C",631).
component("YLR432W",621).
component("YHR216W",467).
component("YAR075W",165).
component("YAR073W",164).
component("YDR127W",281).
component("YJR139C",539).
component("YML075C",633).
component("YLR450W",624).
component("YOL126C",714).
component("YKL085W",548).
component("YDL078C",241).
component("YNL037C",661).
component("YNL009W",659).
component("YLR174W",598).
component("YHR183W",460).
component("YGR256W",426).
component("YNL241C",675).
component("YOL059W",705).
component("YDL022W",234).
component("YCL018W",217).
component("YLR355C",616).
component("YIL074C",472).
component("YER081W",350).
component("YDL174C",260).
component("YML086C",635).
component("YIL155C",484).
component("YGR088W",409).
component("YDR256C",295).
component("YKL026C",545).
component("YIR037W",494).
component("YBR244W",204).
component("YJR078W",532).
component("U58_",123).
component("YJR025C",524).
component("U107_",24).
component("YHR007C",436).
component("YDR402C",309).
component("YGL055W",385).
component("YJR104C",534).
component("YHR008C",437).
component("YOR384W",751).
component("YOR381W",750).
component("YOL152W",716).
component("YLL051C",578).
component("YJL026W",496).
...
component("YJR009C",521).
component("YJL052W",498).
component("YGR192C",418).
component("YBR006W",175).
component("YPL276W",780).
component("YPL275W",779).
component("YOR388C",752).
component("YPL061W",757).
component("YOR374W",748).
component("YER073W",348).
component("YGL154C",392).
component("YBR115C",189).
component("U55_",122).
component("YER069W",345).
component("YOR323C",740).
...
component("YKL216W",566).
component("YDR044W",272).
component("YKR009C",568).
component("YIL160C",485).
component("YGL205W",397).
component("YMR118C",645).
component("YLR164W",596).
component("YLL041C",577).
component("YKL148C",552).
component("YKL141W",550).
component("YJL045W",497).
component("YDR178W",290).
component("YEL047C",329).
component("YDL171C",258).
component("YDL171C",259).
component("YOR375C",749).
component("YDL215C",264).
component("YAL062W",161).
component("U99_",156).
component("U100_",20).
component("YBR035C",181).
component("YKR080W",573).
component("YER023W",336).
component("YOR236W",738).
component("YGR204W",420).
component("YIR034C",493).
component("YLR142W",593).
component("U65_",129).
component("U63_",127).
component("U62_",126).
component("YHR068W",446).
component("YKL150W",553).
component("YIL043C",470).
component("YHR042W",441).
component("YOR221C",735).
component("YMR145C",648).
component("YKL192C",560).
component("YKL055C",546).
component("YER061C",343).
component("YDL085W",243).
component("YPL171C",765).
component("YHR179W",459).
component("YMR145C",649).
component("YML120C",636).
component("YKL192C",561).
component("YDL085W",244).
component("YGR234W",422).
component("YFR030W",371).
component("YPL017C",754).
component("YFL018C",363).
component("YDR353W",305).
component("YPR167C",795).
component("YJR137C",538).
component("YNL052W",663).
component("YMR256C",655).
component("YLR395C",620).
component("YLR038C",583).
component("YIL111W",477).
component("YHR051W",445).
...
component("YPL266W",778).
component("YKR069W",572).
component("YOL096C",709).
component("U47_",115).
component("YER091C",355).
component("YJR073C",530).
component("YGR157W",414).
component("YDR120C",279).
component("YML008C",626).
component("YOR074C",721).
component("YDL033C",236).
component("YOL096C",710).
component("YLR172C",597).
component("YLR058C",586).
...
component("YJL130C",506).
component("YKL024C",544).
component("YPR074C",790).
component("YBR117C",190).
component("YMR108W",644).
component("YCL009C",216).
component("YNL071W",665).
component("YNR008W",687).
component("YIL160C",486).
component("YNR019W",690).
component("YCR048W",230).
component("U48_",116).
component("YDR232W",292).
component("YPL231W",773).
component("YER061C",344).
component("YDL052C",239).
component("U8_",150).
component("YDR148C",287).
component("YPL231W",774).
component("YPL028W",755).
component("YLR299W",608).
component("YGL017W",380).
component("YCR005C",222).
component("YML126C",637).
component("YNL104C",668).
component("YDL182W",261).
component("YDL131W",248).
component("YDR307W",301).
component("YLR258W",605).
component("YFR015C",369).
component("YNL029C",660).
component("YIL085C",474).
component("YMR306W",657).
component("YLR342W",614).
component("YGR032W",403).
component("YBR248C",205).
component("YLR209C",600).
component("U104_",21).
component("YDR354W",306) :- not remove_orf("YDR354W",306).
component("YFR047C",372).
component("YJR133W",537).
component("YLR209C",601).
component("YML022W",628).
component("YDR441C",314).
component("YHR128W",454).
component("YJL167W",513).
component("YJL167W",514).
component("YPR069C",787).
component("YDR127W",282).
component("YHR190W",462).
component("YLR146C",594).
component("YHR068W",447).
component("YLR303W",610).
component("YGR012W",401).
component("YML082W",634).
component("YJR130C",536).
component("YDR035W",271).
component("YBR249C",206).
component("YLR180W",599).
component("YDR502C",318).
component("YOR274W",739).
component("YBR256C",208).
component("YHR137W",455).
component("YGL202W",396).
component("YLR027C",580).
component("YKL106W",549).
component("YOL140W",715).
component("YLR438W",623).
component("YGR019W",402).
component("YLR089C",589).
component("U64_",128).
component("U61_",125).
component("U51_",118).
component("YJR148W",540).
component("YHR208W",465).
component("YFL030W",365).
component("YOR184W",730).
component("YNR058W",695).
component("YIL116W",479).
component("YGL253W",399).
component("YFR053C",373).
component("YMR013C",641).
component("YMR205C",651).
component("YGR240C",423).
component("YOL016C",699).
component("YFR014C",368).
component("YLR240W",603).
component("YKL203C",563).
component("YJR066W",529).
component("YCR036W",229).
component("YCL040W",219).
component("U15_",54).
component("YPL188W",767).
component("YJR049C",526).
component("YEL041W",327).
component("U96_",154).
component("YKL001C",543).
...
component("YPL203W",768).
component("YOR061W",720).
component("YKL166C",555).
component("YJL164C",512).
component("YIL035C",469).
component("YHR205W",464).
component("YHR102W",453).
component("YGL019W",381).
component("YHR025W",440).
component("YOR347C",745).
component("YAL038W",159).
component("YNR012W",688).
...
component("YKL067W",547).
component("YOL055C",702).
component("YDR454C",315).
component("YJR057W",527).
component("YOL061W",706).
component("YKL181W",556).
component("YHL011C",433).
component("YER099C",356).
component("YBL068W",173).
component("YOR143C",726).
component("YNL256W",678).
component("YLR328W",612).
component("YBR018C",177).
component("YGR202C",419).
component("YLR328W",613).
component("U80_",142).
component("U94_",153).
component("YJR010W",522).
component("YBR029C",180).
component("YCL050C",220).
component("YGL130W",390).
component("YDR530C",321).
component("YPR190C",798).
component("YPR187W",797).
component("YPR110C",792).
component("YPR010C",783).
component("YOR341W",744).
component("YOR340C",743).
component("YOR224C",737).
component("YOR210W",734).
component("YOR207C",732).
component("YOR151C",727).
component("YOR116C",723).
component("YOL005C",697).
component("YNR003C",686).
component("YNL248C",677).
component("YNL151C",672).
component("YNL113W",669).
component("YKL144C",551).
component("YJR063W",528).
component("YJL148W",510).
component("YJL140W",509).
component("YIL021W",468).
component("YHR143W-A",456).
...
component("YPR175W",796).
component("YPL167C",764).
component("YOR330C",741).
component("YOL115W",713).
component("YNL299W",684).
component("YNL262W",680).
component("YNL102W",667).
component("YJR043C",525).
component("YJR006W",520).
component("YJL090C",501).
component("YIL139C",482).
...
component("YPR113W",793).
component("YBR243C",203).
component("YPL148C",762).
component("YER026C",337).
component("YGR286C",430).
component("YHR189W",461).
component("YDR058C",276).
component("YDL086W",245).
component("YOL011W",698).
component("YMR008C",639).
component("YMR006C",638).
component("U105_",22).
component("YBL015W",167).
component("YJL068C",499).
component("YOR040W",719).
component("U77_",139).
component("YDR481C",316).
component("YLR377C",618).
component("YPL179W",766).
component("YNR032W",691).
component("YML057W",632).
component("YML016C",627).
component("YLR433C",622).
component("YGR123C",412).
...
component("YHR215W",466).
component("YDL024C",235).
component("YBR093C",187).
component("YBR092C",186).
component("YAR071W",163).
component("YHR046C",444).
component("U9_",157).
component("YPL228W",771).
component("YMR180C",650).
component("YDL236W",266).
component("YJL155C",511).
component("YPR073C",789).
component("YOR208W",733).
component("YNL053W",664).
component("YMR036C",642).
component("YIR026C",492).
...
component("U25_",96).
component("U24_",95).
component("YHR044C",443).
component("YHR043C",442).
component("YOL064C",707).
component("YOR360C",747).
component("YKR031C",569).
component("YPL206C",769).
component("YGL027C",383).
component("YLR286C",607).
component("YJR153W",541).
component("YJL221C",519).
component("YJL216C",517).
component("YIL172C",490).
component("YGR292W",432).
component("YGR287C",431).
component("YBR299W",215).
component("YBR184W",199).
component("YIL162W",487).
component("YIR019C",491).
component("YIL099W",476).
component("YDL037C",237).
component("YOR190W",731).
component("YLR300W",609).
component("YGR282C",429).
component("YDR261C",296).
component("YDR400W",308).
component("YML035C",629).
component("YJL070C",500).
component("YBR284W",212).
component("U106_",23).
component("YER043C",338).
component("YNL045W",662).
component("YGL037C",384).
component("YDR242W",294).
component("U53_",120).
component("YPR062W",786).
component("YMR120C",647).
component("YLR028C",582).
component("YHR144C",457).
component("YGR267C",428).
component("YBL033C",168).
component("YNL141W",670).
component("YLR245C",604).
component("YML035C",630).
component("YBR084W",184).
component("YJL126W",504).
component("U44_",112).
...
component("YHR201C",463).
component("YBR111C",188).
component("YBR252W",207).
component("YER005W",335).
component("YBL099W",174).
component("YLR231C",602).
component("U88_",148).
component("YDR538W",324).
component("YLR134W",591).
component("YLR044C",584).
component("YGR087C",408).
component("YDR380W",307).
component("YDL080C",242).
component("U98_",155).
component("YMR250W",654).
component("YOR128C",724).
component("YEL021W",326).
component("YNR043W",693).
component("U93_",152).
component("U54_",121).
component("YKL211C",564) :- not remove_orf("YKL211C",564).
component("YKR097W",575).
component("YNL169C",673).
component("YNL256W",679).
component("YDR294C",298).
component("YEL046C",328).
component("YNR033W",692).
component("YKL211C",565) :- not remove_orf("YKL211C",565).
component("YER090W",565) :- not remove_orf("YER090W",565).
component("YER090W",354) :- not remove_orf("YER090W",354).
component("YDR127W",284).
component("YPL281C",781).
component("YOR393W",753).
component("YMR323W",658).
component("YHR174W",458).
component("YGR254W",425).
component("YPL262W",776).
component("YGL026C",382) :- not remove_orf("YGL026C",382).
component("YGR155W",413).
component("YLR304C",611).
component("YJL200C",515).
component("YNL316C",685).
component("YKL182W",558).
component("YPL212C",770).
component("YNL292W",683).
component("YGL063W",387).
component("YFL001W",361).
component("YPR002W",782).
component("YJR016C",523).
component("YCR053W",231).
component("YDR127W",285).
component("YGL148W",391).
component("YIL168W",489).
component("YIL167W",488).
component("YCL064C",221).
component("YER086W",351).
component("YLR359W",617).
component("YAL012W",158).
component("YML004C",625).
component("YFR055W",374).
component("YJL005W",495).
component("YJL121C",503).
component("YBR019C",178).
component("YDR050C",275).
component("YDR007W",268) :- not remove_orf("YDR007W",268).
component("YOR095C",722).
component("YER003C",334).
component("YBR196C",200).
component("YGL001C",376).
component("YPL117C",760).
component("U14_",46).
component("YOL056W",703).
component("YKL152C",554).
component("YDL021W",233).
component("YEL058W",331).
component("YPR060C",785).
component("YHR072W",448).
component("YPL097W",758).
component("YGR185C",417).
component("YGR264C",427).
component("YGR171C",415).
component("YPL104W",759).
component("YLL018C",576).
component("YPR081C",791).
component("YBR121C",191).
component("YHR020W",439).
component("YER087W",352).
component("YNL247W",676).
component("YOR168W",728).
component("YOL097C",711).
component("YDR268W",297).
component("YPR047W",784).
component("YLR060W",587).
component("YFL022C",364).
component("YCR024C",225).
component("YHR019C",438).
component("YKL194C",562).
component("YIL078W",473).
component("YPL160W",763).
component("YLR382C",619).
component("YNL073W",666).
component("YOR335C",742).
component("YGR094W",410).
component("YLR153C",595).
component("YAL054C",160).
component("YGR244C",424).
component("YIL145C",483).
component("U89_",149).
component("YJL101C",502).
component("YOL049W",701).
component("YAR015W",162).
component("YER183C",360).
component("U90_",151).
component("YNR057C",694).
...
component("YNL220W",674).
component("YOL058W",704).
component("YDL141W",254).
component("YHR074W",449).
component("YMR217W",653).
component("YJR109C",535).
component("YJL130C",507).
component("YGL062W",386).
component("YBR218C",201).
component("YPL231W",775).
component("YNR016C",689).
component("YKL182W",559).
component("YGR037C",404).
component("YPR138C",794).
component("YPL265W",777).
component("YPL134C",761).
component("YPL036W",756).
component("YOR348C",746).
component("YOR222W",736).
component("YOR171C",729).
component("YOR130C",725).
component("YOR011W",718).
component("YOL156W",717).
component("YOL103W",712).
component("YOL020W",700) :- not remove_orf("YOL020W",700).
component("YNR072W",696).
component("YNL270C",681).
component("YNL142W",671).
component("YMR011W",640).
component("YLR348C",615).
component("YLR260W",606).
component("YLR138W",592).
component("YLR100C",590).
component("YLR081W",588).
component("YLL061W",579).
component("YKR093W",574).
component("YKR053C",571).
component("YKR039W",570) :- not remove_orf("YKR039W",570).
component("YJR158W",542).
component("YJR077C",531).
component("YJL219W",518).
component("YJL214W",516).
component("YJL134W",508).
component("YJL129C",505).
component("YIL134W",481).
component("YHR096C",452).
component("YHR094C",451).
component("YHR092C",450).
component("YHL036W",435).
component("YGR121C",411).
component("YGR065C",407).
...
catalyst(2300,152).
catalyst(3460,121).
catalyst(3600,564) :- not remove_reaction(3600,564).
catalyst(8000,575).
catalyst(6890,673).
catalyst(2570,679).
catalyst(8781,298).
...
catalyst(4560,328).
catalyst(2550,692).
catalyst(1890,565) :- not remove_reaction(1890,565).
catalyst(3630,565) :- not remove_reaction(3630,565).
...
catalyst(1210,717).
catalyst(1160,712).
catalyst(801,700) :- not remove_reaction(801,700).
catalyst(802,700) :- not remove_reaction(802,700).
catalyst(811,700) :- not remove_reaction(811,700).
catalyst(812,700) :- not remove_reaction(812,700).
catalyst(831,700) :- not remove_reaction(831,700).
catalyst(832,700) :- not remove_reaction(832,700).
catalyst(901,700) :- not remove_reaction(901,700).
catalyst(902,700) :- not remove_reaction(902,700).
catalyst(1180,696).
catalyst(1210,696).
catalyst(931,681).
catalyst(932,681).
...
catalyst(640,574).
catalyst(6560,571).
catalyst(771,570) :- not remove_reaction(771,570).
catalyst(772,570) :- not remove_reaction(772,570).
catalyst(781,570) :- not remove_reaction(781,570).
catalyst(782,570) :- not remove_reaction(782,570).
catalyst(801,570) :- not remove_reaction(801,570).
catalyst(802,570) :- not remove_reaction(802,570).
catalyst(811,570) :- not remove_reaction(811,570).
catalyst(812,570) :- not remove_reaction(812,570).
catalyst(831,570) :- not remove_reaction(831,570).
catalyst(832,570) :- not remove_reaction(832,570).
catalyst(841,570) :- not remove_reaction(841,570).
catalyst(842,570) :- not remove_reaction(842,570).
catalyst(851,570) :- not remove_reaction(851,570).
catalyst(852,570) :- not remove_reaction(852,570).
catalyst(881,570) :- not remove_reaction(881,570).
catalyst(882,570) :- not remove_reaction(882,570).
catalyst(901,570) :- not remove_reaction(901,570).
catalyst(902,570) :- not remove_reaction(902,570).
catalyst(921,570) :- not remove_reaction(921,570).
catalyst(922,570) :- not remove_reaction(922,570).
catalyst(931,570) :- not remove_reaction(931,570).
catalyst(932,570) :- not remove_reaction(932,570).
catalyst(1191,570) :- not remove_reaction(1191,570).
catalyst(1192,570) :- not remove_reaction(1192,570).
catalyst(1180,542).
catalyst(1210,542).
catalyst(1581,531).
catalyst(1582,531).
