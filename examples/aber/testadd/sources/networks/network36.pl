...
component("YLR056W",224).
component("YKR009C",213).
component("YPL231W",301).
component("U46_",45).
component("YBR149W",67).
component("YGL001C",140).
component("YIL094C",178).
component("U45_",44).
component("YDR127W",97).
component("YOL126C",275).
component("YKL085W",205).
component("YDL078C",83).
component("YNL037C",251).
component("YLR355C",240).
component("YDL174C",89).
component("YML086C",244).
component("YGR088W",157).
component("YDR256C",106).
component("YJR078W",199).
component("YJR025C",195).
component("U107_",20).
component("YER070W",132).
component("U36_",41).
component("YPL276W",307).
component("YPL275W",306).
component("YOR388C",292).
component("YOR323C",286).
component("YIL125W",179).
component("U52_",47).
component("YBR166C",69).
component("YKL216W",212).
component("YKR009C",214).
component("YIL160C",182).
component("YGL205W",151).
component("YKR080W",218).
component("YER023W",127).
component("YGR204W",161).
component("YLR142W",229).
component("U62_",49).
component("YHR068W",169).
component("YKL150W",208).
component("YIL043C",176).
component("YPL171C",300).
component("YHR179W",174).
component("YDR353W",110).
component("YPL266W",305).
component("YKR069W",217).
component("YDL033C",82).
component("YLR172C",231).
component("YLR058C",225).
component("YDR019C",92).
component("YBR176W",70).
component("YDR408C",115).
component("YMR120C",248).
component("YLR028C",221).
component("YBL013W",56).
component("YJL130C",189).
component("YKL024C",203).
component("YPR074C",311).
component("YBR117C",66).
component("YPL231W",302).
component("YPL231W",303).
component("YLR299W",237).
component("YML126C",245).
component("YDL182W",90).
component("YDL131W",86).
component("YLR258W",235).
component("YFR015C",137).
component("YNL029C",250).
component("YIL085C",177).
component("YLR209C",232).
component("U104_",18).
component("YDR354W",111) :- not remove_orf("YDR354W",111).
component("YFR047C",138).
component("YLR209C",233).
component("YML022W",242).
component("YDR441C",117).
component("YJL167W",193).
component("YDR127W",98).
component("YLR303W",239).
component("YJR130C",201).
component("YDR035W",93).
component("YBR249C",72).
component("YOR274W",285).
component("YHR137W",170).
component("YGL202W",150).
component("YLR027C",220).
component("YKL106W",206).
component("YLR089C",226).
component("YJR148W",202).
component("YNR058W",266).
component("YGL253W",153).
component("YFR053C",139).
component("YCR036W",81).
component("U96_",52).
component("YNR012W",264).
component("YDR127W",99).
component("YDR147W",102).
component("U76_",50).
component("YDR226W",104).
component("YKL067W",204).
component("YOL055C",270).
component("YDR454C",118).
component("YOL061W",271).
component("YKL181W",209).
component("YHL011C",165).
component("YER099C",134).
component("YBL068W",60).
component("YNL256W",258).
component("YBR018C",62).
component("YGL130W",147).
component("YPR190C",317).
component("YPR187W",316).
component("YPR110C",312).
component("YPR010C",309).
component("YOR341W",290).
component("YOR340C",289).
component("YOR224C",284).
component("YOR210W",283).
component("YOR207C",282).
component("YOR151C",279).
component("YOR116C",278).
component("YOL005C",267).
component("YNR003C",263).
component("YNL248C",257).
component("YNL151C",256).
component("YNL113W",253).
component("YKL144C",207).
component("YJR063W",197).
component("YJL148W",192).
component("YJL140W",191).
component("YIL021W",175).
component("YHR143W-A",171).
component("YGL070C",146).
component("YFL036W",135).
component("YDR404C",114).
component("YDR156W",103).
component("YDR045C",94).
component("YDL150W",88).
component("YDL140C",87).
component("YBR154C",68).
component("YPR175W",315).
component("YPL167C",299).
component("YOR330C",287).
component("YOL115W",274).
component("YNL299W",261).
component("YNL262W",259).
component("YNL102W",252).
component("YJR043C",196).
component("YJR006W",194).
component("YJL090C",186).
component("YIL139C",180).
component("YEL055C",124).
component("YDR419W",116).
component("YDR121W",96).
component("YDL102W",85).
component("YCR014C",79).
component("YBR278W",74).
component("YBL035C",58).
component("YPR113W",313).
component("YPL148C",298).
component("YOL011W",268).
component("YMR008C",247).
component("YMR006C",246).
component("U105_",19).
component("YBL015W",57).
component("YLR377C",241).
component("U30_",40).
component("U29_",39).
component("U24_",38).
component("YHR044C",168).
component("YHR043C",167).
component("YOR360C",291).
component("YGL027C",144).
component("YOR190W",281).
component("YLR300W",238).
component("YGR282C",164).
component("YDR261C",107).
component("YDR400W",113).
component("YML035C",243).
component("YJL070C",185).
component("YBR284W",75).
component("YDR242W",105).
component("U53_",48).
component("YLR028C",222).
component("YHR144C",172).
component("YNL141W",254).
component("YJL126W",187).
component("U39_",42).
component("YBR011C",61).
component("YBR111C",65).
component("YBR252W",73).
component("YER005W",126).
component("YLR231C",234).
component("YLR134W",228).
component("YLR044C",223).
component("YGR087C",156).
component("YDR380W",112).
component("YDL080C",84).
component("U98_",53).
component("YKL211C",210) :- not remove_orf("YKL211C",210).
component("YKL211C",211) :- not remove_orf("YKL211C",211).
component("YER090W",211) :- not remove_orf("YER090W",211).
component("YER090W",133) :- not remove_orf("YER090W",133).
component("YDR127W",100).
component("YPL281C",308).
component("YOR393W",293).
component("YMR323W",249).
component("YHR174W",173).
component("YGR254W",162).
component("YGL026C",143) :- not remove_orf("YGL026C",143).
component("YNL316C",262).
component("YDR127W",101).
component("YGL148W",148).
component("YIL168W",184).
component("YIL167W",183).
component("YCL064C",78).
component("YAL012W",54).
component("YDR007W",91) :- not remove_orf("YDR007W",91).
component("YOR095C",277).
component("YGL001C",141).
component("YPL117C",297).
component("YPR060C",310).
component("YPL097W",295).
component("YGR185C",160).
component("YGR264C",163).
component("YGR171C",159).
component("YPL104W",296).
component("YLL018C",219).
component("YOL097C",272).
component("YDR268W",108).
component("YOR335C",288).
component("YLR153C",230).
component("YAL054C",55).
component("YIL145C",181).
component("U90_",51).
component("YNR057C",265).
component("YGL234W",152).
component("YJR103W",200).
component("YBL039C",59).
component("YGL062W",145).
component("YBR218C",71).
component("YPR138C",314).
component("YPL265W",304).
component("YPL036W",294).
component("YOR171C",280).
component("YOR011W",276).
component("YOL103W",273).
component("YOL020W",269) :- not remove_orf("YOL020W",269).
component("YNL270C",260).
component("YNL142W",255).
component("YLR260W",236).
component("YLR100C",227).
component("YKR053C",216).
component("YKR039W",215) :- not remove_orf("YKR039W",215).
component("YJR077C",198).
component("YJL134W",190).
component("YJL129C",188).
component("YHL036W",166).
component("YGR121C",158).
component("YGR065C",155).
component("YGR055W",154).
component("YGL186C",149).
component("YGL008C",142).
component("YFL055W",136).
component("YER060W-A",131).
component("YER060W",130).
component("YER056C",129).
component("YER053C",128).
component("YEL063C",125).
component("YEL017C-A",123).
component("YDR536W",122).
component("YDR508C",121).
component("YDR503C",120).
component("YDR497C",119).
component("YDR297W",109).
component("YDR046C",95) :- not remove_orf("YDR046C",95).
component("YCR024C-A",80).
component("YCL025C",77).
component("YBR298C",76).
component("YBR069C",64) :- not remove_orf("YBR069C",64).
component("YBR068C",63) :- not remove_orf("YBR068C",63).
component("U4_",46).
component("U3_",43).
component("U228_",37).
component("U223_",36).
...
catalyst(2121,18).
catalyst(2122,18).
catalyst(3620,111) :- not remove_reaction(3620,111).
catalyst(2190,138).
catalyst(5791,233).
catalyst(5792,233).
catalyst(5801,233).
...
catalyst(8812,84).
catalyst(2250,53).
catalyst(3600,210) :- not remove_reaction(3600,210).
catalyst(3630,211) :- not remove_reaction(3630,211).
catalyst(3630,133) :- not remove_reaction(3630,133).
catalyst(3740,100).
catalyst(8231,308).
catalyst(8232,308).
catalyst(8231,293).
...
catalyst(8231,162).
catalyst(8232,162).
catalyst(3590,143) :- not remove_reaction(3590,143).
catalyst(10910,143) :- not remove_reaction(10910,143).
catalyst(3680,262).
catalyst(3750,101).
catalyst(3700,148).
catalyst(8751,184).
...
catalyst(4520,78).
catalyst(4460,54).
catalyst(3610,91) :- not remove_reaction(3610,91).
catalyst(7921,277).
catalyst(7922,277).
catalyst(6370,141).
catalyst(6461,297).
...
catalyst(781,215) :- not remove_reaction(781,215).
catalyst(782,215) :- not remove_reaction(782,215).
...
catalyst(881,215) :- not remove_reaction(881,215).
catalyst(882,215) :- not remove_reaction(882,215).
catalyst(901,215) :- not remove_reaction(901,215).
catalyst(902,215) :- not remove_reaction(902,215).
catalyst(931,215) :- not remove_reaction(931,215).
catalyst(932,215) :- not remove_reaction(932,215).
catalyst(1191,215) :- not remove_reaction(1191,215).
catalyst(1192,215) :- not remove_reaction(1192,215).
catalyst(1581,198).
catalyst(1582,198).
catalyst(6560,190).
catalyst(361,188).
...
catalyst(831,95) :- not remove_reaction(831,95).
catalyst(832,95) :- not remove_reaction(832,95).
catalyst(841,95) :- not remove_reaction(841,95).
catalyst(842,95) :- not remove_reaction(842,95).
catalyst(851,95) :- not remove_reaction(851,95).
catalyst(852,95) :- not remove_reaction(852,95).
catalyst(901,95) :- not remove_reaction(901,95).
catalyst(902,95) :- not remove_reaction(902,95).
catalyst(220,80).
catalyst(771,77).
catalyst(772,77).
catalyst(781,77).
...
catalyst(1121,76).
catalyst(1122,76).
catalyst(771,64) :- not remove_reaction(771,64).
catalyst(772,64) :- not remove_reaction(772,64).
catalyst(801,64) :- not remove_reaction(801,64).
catalyst(802,64) :- not remove_reaction(802,64).
catalyst(811,64) :- not remove_reaction(811,64).
catalyst(812,64) :- not remove_reaction(812,64).
catalyst(851,64) :- not remove_reaction(851,64).
catalyst(852,64) :- not remove_reaction(852,64).
catalyst(901,64) :- not remove_reaction(901,64).
catalyst(902,64) :- not remove_reaction(902,64).
catalyst(801,63) :- not remove_reaction(801,63).
catalyst(802,63) :- not remove_reaction(802,63).
catalyst(811,63) :- not remove_reaction(811,63).
catalyst(812,63) :- not remove_reaction(812,63).
catalyst(831,63) :- not remove_reaction(831,63).
catalyst(832,63) :- not remove_reaction(832,63).
catalyst(841,63) :- not remove_reaction(841,63).
catalyst(842,63) :- not remove_reaction(842,63).
catalyst(851,63) :- not remove_reaction(851,63).
catalyst(852,63) :- not remove_reaction(852,63).
catalyst(901,63) :- not remove_reaction(901,63).
catalyst(902,63) :- not remove_reaction(902,63).
catalyst(6980,46).
catalyst(6980,43).
catalyst(41,37).
catalyst(42,37).
