...
component("YLR056W",368).
component("YKR009C",354).
component("YOL086C",444).
component("YMR303C",406).
component("YGL256W",254).
component("YDL168W",163).
component("YBR145W",125).
component("YPL231W",485).
component("U46_",73).
component("YBR149W",126).
component("YGL001C",234).
component("YIL094C",300).
component("U45_",72).
component("YML056C",396).
component("YLR432W",393).
component("YHR216W",295).
component("YAR075W",104).
component("YAR073W",103).
component("YDR127W",176).
component("YOL126C",448).
component("YKL085W",344).
component("YDL078C",155).
component("YNL037C",411).
component("YNL009W",409).
component("YLR174W",376).
component("YCL018W",140).
component("YLR355C",390).
component("YDL174C",166).
component("YML086C",397).
component("YGR088W",261).
component("YDR256C",186).
component("YJR078W",335).
component("YJR025C",328).
component("U107_",23).
component("YJR104C",337).
component("YHR008C",279).
component("YJL026W",312).
component("YIL066C",298).
component("YGR180C",264).
component("YER070W",216).
component("U36_",66).
component("YDL168W",164).
component("YBR006W",112).
component("YPL276W",493).
component("YPL275W",492).
component("YOR388C",471).
component("U55_",79).
component("YER069W",215).
component("YOR323C",464).
component("YER178W",222).
component("YBR221C",131).
component("YIL125W",303).
component("U52_",77).
component("YBR166C",128).
component("YGL012W",237).
component("YKL216W",353).
component("YKR009C",355).
component("YIL160C",306).
component("YGL205W",251).
component("YDL171C",165).
component("U99_",98).
component("U100_",20).
component("YKR080W",360).
component("YER023W",209).
component("YGR204W",266).
component("YLR142W",373).
component("U65_",83).
component("U62_",82).
component("YHR068W",286).
component("YKL150W",347).
component("YIL043C",297).
component("YPL171C",481).
component("YHR179W",293).
component("YGR234W",268).
component("YPL017C",473).
component("YFL018C",225).
component("YDR353W",190).
component("YPR167C",505).
component("YNL052W",412).
component("YMR256C",405).
component("YLR395C",392).
component("YLR038C",366).
component("YIL111W",301).
component("YHR051W",285).
component("YGL191W",249).
component("YGL187C",248).
component("YDL067C",154).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",491).
component("YKR069W",359).
component("U47_",74).
component("YJR073C",333).
component("YDL033C",153).
component("YLR172C",375).
component("YLR058C",369).
component("YDR019C",171).
component("YBR176W",129).
component("YDR408C",195).
component("YMR120C",402).
component("YLR028C",364).
component("YBL013W",105).
component("YJL130C",318).
component("YKL024C",342).
component("YPR074C",501).
component("YBR117C",124).
component("YCL009C",139).
component("YNL071W",414).
component("YIL160C",307).
component("U48_",75).
component("YPL231W",486).
component("YPL231W",487).
component("YPL028W",474).
component("YLR299W",384).
component("YGL017W",238).
component("YML126C",398).
component("YNL104C",416).
component("YDL182W",167).
component("YDL131W",159).
component("YLR258W",381).
component("YFR015C",230).
component("YNL029C",410).
component("YIL085C",299).
component("YMR306W",407).
component("YLR342W",389).
component("YGR032W",256).
component("YLR209C",377).
component("U104_",21).
component("YDR354W",191) :- not remove_orf("YDR354W",191).
component("YFR047C",232).
component("YLR209C",378).
component("YML022W",394).
component("YDR441C",197).
component("YJL167W",322).
component("YDR127W",177).
component("YHR068W",287).
component("YLR303W",386).
component("YGR012W",255).
component("YJR130C",338).
component("YDR035W",172).
component("YBR249C",132).
component("YOR274W",463).
component("YHR137W",289).
component("YGL202W",250).
component("YLR027C",363).
component("YKL106W",345).
component("YOL140W",449).
component("YLR089C",370).
component("U61_",81).
component("YJR148W",339).
component("YFL030W",226).
component("YNR058W",435).
component("YGL253W",253).
component("YFR053C",233).
component("YMR205C",404).
component("YGR240C",269).
component("YOL016C",438).
component("YFR014C",229).
component("YCR036W",149).
component("YCL040W",142).
component("YPL188W",482).
component("YJR049C",330).
component("YEL041W",204).
component("U96_",96).
component("YKL001C",341).
component("YDR236C",184).
component("YHL032C",277).
component("U83_",93).
component("YOR347C",469).
component("YAL038W",101).
component("YNR012W",431).
...
component("YKL067W",343).
component("YOL055C",441).
component("YDR454C",198).
component("YJR057W",331).
component("YOL061W",443).
component("YKL181W",349).
component("YHL011C",276).
component("YER099C",220).
component("YBL068W",110).
component("YOR143C",454).
component("YNL256W",424).
component("YBR018C",114).
component("YLR328W",388).
component("U94_",95).
component("YBR029C",116).
component("YGL130W",245).
component("YPR190C",508).
component("YPR187W",507).
component("YPR110C",502).
component("YPR010C",496).
component("YOR341W",468).
component("YOR340C",467).
component("YOR224C",462).
component("YOR210W",461).
component("YOR207C",459).
component("YOR151C",455).
component("YOR116C",452).
component("YOL005C",436).
component("YNR003C",430).
component("YNL248C",423).
component("YNL151C",420).
component("YNL113W",417).
component("YKL144C",346).
component("YJR063W",332).
component("YJL148W",321).
component("YJL140W",320).
component("YIL021W",296).
component("YHR143W-A",290).
component("YGL070C",243).
...
component("YPR175W",506).
component("YPL167C",480).
component("YOR330C",465).
component("YOL115W",447).
component("YNL299W",428).
component("YNL262W",425).
component("YNL102W",415).
component("YJR043C",329).
component("YJR006W",326).
component("YJL090C",314).
...
component("YPR113W",503).
component("YPL148C",479).
component("YGR286C",273).
component("YOL011W",437).
component("YMR008C",400).
component("YMR006C",399).
component("U105_",22).
component("YBL015W",106).
component("U77_",92).
component("YLR377C",391).
component("YPR073C",499).
component("YHR215W",294).
component("YDL024C",152).
component("YBR093C",122).
component("YBR092C",121).
component("YHR046C",284).
component("U9_",99).
component("YDL236W",169).
component("YPR073C",500).
component("YOR208W",460).
component("YNL053W",413).
component("YMR036C",401).
component("YIR026C",311).
component("YIL113W",302).
...
component("U26_",61).
component("U24_",60).
component("YHR044C",283).
component("YHR043C",282).
component("YOR360C",470).
component("YKR031C",356).
component("YPL206C",483).
component("YGL027C",240).
component("YLR286C",383).
component("YJR153W",340).
component("YJL221C",325).
component("YJL216C",324).
component("YIL172C",310).
component("YGR292W",275).
component("YGR287C",274).
component("YBR299W",138).
component("YOR190W",458).
component("YLR300W",385).
component("YGR282C",272).
component("YDR261C",187).
component("YDR400W",193).
component("YML035C",395).
component("YJL070C",313).
component("YBR284W",136).
component("YER043C",210).
component("YDR242W",185).
component("U53_",78).
component("YPR062W",498).
component("YMR120C",403).
component("YLR028C",365).
component("YHR144C",291).
component("YBL033C",107).
component("YNL141W",418).
component("YLR245C",380).
component("YBR084W",119).
component("YJL126W",316).
component("U44_",71).
...
component("YLR231C",379).
component("YLR134W",372).
component("YLR044C",367).
component("YGR087C",260).
component("YDR380W",192).
component("YDL080C",156).
component("U98_",97).
component("YOR128C",453).
component("YKL211C",351) :- not remove_orf("YKL211C",351).
component("YKR097W",361).
component("YNL169C",421).
component("YEL046C",205).
component("YNR033W",433).
component("YKL211C",352) :- not remove_orf("YKL211C",352).
component("YER090W",352) :- not remove_orf("YER090W",352).
component("YER090W",219) :- not remove_orf("YER090W",219).
component("YDR127W",179).
component("YPL281C",494).
component("YOR393W",472).
component("YMR323W",408).
component("YHR174W",292).
component("YGR254W",270).
component("YPL262W",489).
component("YGL026C",239) :- not remove_orf("YGL026C",239).
component("YLR304C",387).
component("YJL200C",323).
component("YNL316C",429).
component("YPL212C",484).
component("YNL292W",427).
component("YGL063W",242).
component("YFL001W",224).
component("YPR002W",495).
component("YJR016C",327).
component("YCR053W",150).
component("YDR127W",180).
component("YGL148W",246).
component("YIL168W",309).
component("YIL167W",308).
component("YCL064C",143).
component("YAL012W",100).
component("YBR019C",115).
component("YDR007W",170) :- not remove_orf("YDR007W",170).
component("YOR095C",451).
component("YGL001C",235).
component("YPL117C",478).
component("U14_",32).
component("YOL056W",442).
component("YKL152C",348).
component("YDL021W",151).
component("YPR060C",497).
component("YPL097W",476).
component("YGR185C",265).
component("YGR264C",271).
component("YGR171C",263).
component("YPL104W",477).
component("YLL018C",362).
component("YHR020W",281).
component("YER087W",218).
component("YNL247W",422).
component("YOR168W",456).
component("YOL097C",445).
component("YDR268W",188).
component("YCR024C",146).
component("YHR019C",280).
component("YOR335C",466).
component("YLR153C",374).
component("YAL054C",102).
component("YIL145C",305).
component("YJL101C",315).
component("YOL049W",440).
component("YER183C",223).
component("U90_",94).
component("YNR057C",434).
component("YGL234W",252).
component("YJR103W",336).
component("YBL039C",109).
component("YGR204W",267).
component("YBR084W",120).
component("YDL141W",161).
component("YHR074W",288).
component("YGL062W",241).
component("YBR218C",130).
component("YPL231W",488).
component("YNR016C",432).
component("YKL182W",350).
component("YGR037C",257).
component("YPR138C",504).
component("YPL265W",490).
component("YPL036W",475).
component("YOR171C",457).
component("YOR011W",450).
component("YOL103W",446).
component("YOL020W",439) :- not remove_orf("YOL020W",439).
component("YNL270C",426).
component("YNL142W",419).
component("YLR260W",382).
component("YLR100C",371).
component("YKR053C",358).
component("YKR039W",357) :- not remove_orf("YKR039W",357).
component("YJR077C",334).
component("YJL134W",319).
component("YJL129C",317).
component("YHL036W",278).
component("YGR121C",262).
component("YGR065C",259).
component("YGR055W",258).
component("YGL186C",247).
component("YGL077C",244).
...
catalyst(6111,453).
catalyst(6112,453).
catalyst(3600,351) :- not remove_reaction(3600,351).
catalyst(8000,361).
catalyst(6890,421).
catalyst(4560,205).
catalyst(2550,433).
catalyst(3630,352) :- not remove_reaction(3630,352).
...
catalyst(8051,489).
catalyst(8052,489).
catalyst(3590,239) :- not remove_reaction(3590,239).
catalyst(10910,239) :- not remove_reaction(10910,239).
catalyst(8181,387).
catalyst(8182,387).
catalyst(8181,323).
catalyst(8182,323).
...
catalyst(901,439) :- not remove_reaction(901,439).
catalyst(902,439) :- not remove_reaction(902,439).
catalyst(931,426).
catalyst(932,426).
catalyst(371,419).
catalyst(372,419).
...
catalyst(6330,371).
catalyst(6560,358).
catalyst(771,357) :- not remove_reaction(771,357).
catalyst(772,357) :- not remove_reaction(772,357).
catalyst(781,357) :- not remove_reaction(781,357).
catalyst(782,357) :- not remove_reaction(782,357).
catalyst(801,357) :- not remove_reaction(801,357).
catalyst(802,357) :- not remove_reaction(802,357).
catalyst(811,357) :- not remove_reaction(811,357).
catalyst(812,357) :- not remove_reaction(812,357).
catalyst(831,357) :- not remove_reaction(831,357).
catalyst(832,357) :- not remove_reaction(832,357).
catalyst(841,357) :- not remove_reaction(841,357).
catalyst(842,357) :- not remove_reaction(842,357).
catalyst(851,357) :- not remove_reaction(851,357).
catalyst(852,357) :- not remove_reaction(852,357).
catalyst(881,357) :- not remove_reaction(881,357).
catalyst(882,357) :- not remove_reaction(882,357).
catalyst(901,357) :- not remove_reaction(901,357).
catalyst(902,357) :- not remove_reaction(902,357).
catalyst(931,357) :- not remove_reaction(931,357).
catalyst(932,357) :- not remove_reaction(932,357).
catalyst(1191,357) :- not remove_reaction(1191,357).
catalyst(1192,357) :- not remove_reaction(1192,357).
catalyst(1581,334).
catalyst(1582,334).
catalyst(6560,319).
catalyst(361,317).
