...
component("YNL280C",791).
component("YLR056W",677).
component("YGR060W",469).
component("YGL012W",438).
component("YKR009C",654).
component("YOL086C",822).
component("YMR303C",763).
component("YMR083W",741).
component("YGL256W",462).
component("YDL168W",302).
component("YBR145W",232).
component("YPL231W",899).
component("YBR265W",250).
component("U46_",141).
component("YBR149W",233).
component("YBR149W",234).
component("YGL001C",434).
component("YIL094C",550).
component("YHR063C",516).
component("U45_",140).
component("YML056C",725).
component("YLR432W",714).
component("YHR216W",539).
component("YAR075W",196).
component("YAR073W",195).
component("YDR127W",331).
component("YJR139C",620).
component("YML075C",728).
component("YLR450W",717).
component("YOL126C",828).
component("YKL085W",631).
component("YDL078C",284).
component("YKL029C",627).
component("YNL037C",768).
component("YNL009W",766).
component("YLR174W",691).
component("YHR183W",532).
component("YGR256W",494).
component("YNL241C",783).
component("YOL059W",819).
component("YDL022W",276).
component("YCL018W",258).
component("YLR355C",709).
component("YIL074C",547).
component("YER081W",406).
component("YML054C",724).
component("YDL174C",306).
component("YML086C",730).
component("YIL155C",559).
component("YEL024W",379).
component("YKR066C",659).
component("YGR088W",473).
component("YDR256C",345).
component("YKL026C",626).
component("YIR037W",569).
component("YBR244W",245).
component("YJR078W",612).
component("U58_",150).
component("YJR025C",603).
component("U107_",27).
component("YGR255C",493).
component("U108_",28).
component("YHR007C",505).
component("YDR402C",360).
component("YGL055W",445).
component("YJR104C",615).
component("YHR008C",506).
component("YOR384W",872).
component("YOR381W",871).
component("YOL152W",831).
component("YLL051C",669).
component("YJL026W",571).
component("YIL066C",546).
component("YGR180C",481).
component("YER070W",403).
component("U37_",134).
component("U36_",133).
component("U35_",132).
component("YDL168W",303).
component("YDR158W",339).
component("YJR009C",599).
component("YJL052W",573).
component("YGR192C",483).
component("YBR006W",209).
component("YPL276W",908).
component("YPL275W",907).
component("YOR388C",873).
component("YPL061W",881).
component("YOR374W",869).
component("YER073W",404).
component("YGL154C",453).
component("YBR115C",227).
component("U55_",149).
component("YER069W",401).
component("YOR323C",861).
component("YMR170C",751).
component("YMR169C",750).
component("YER178W",416).
component("YBR221C",243).
component("YIL125W",555).
component("U52_",146).
component("YBR166C",237).
component("YNL280C",792).
component("YGL012W",439).
component("YKL182W",642).
component("YKL216W",652).
component("YDR044W",321).
component("YER014W",389).
component("YKR009C",655).
component("YIL160C",560).
component("YGL205W",458).
component("YMR118C",745).
component("YLR164W",689).
component("YLL041C",667).
component("YKL148C",636).
component("YKL141W",634).
component("YJL045W",572).
component("YDR178W",340).
component("YJR051W",606).
component("YEL047C",382).
component("YDL171C",304).
component("YDL171C",305).
component("YOR375C",870).
component("YDL215C",310).
component("YAL062W",192).
component("U99_",186).
component("U100_",21).
component("YBR035C",217).
component("YMR189W",753).
component("YKR080W",661).
component("YER023W",391).
component("YPL023C",877).
component("YGL125W",450).
component("YOR236W",858).
component("YGR204W",486).
component("YIR034C",568).
component("YLR142W",686).
component("U65_",157).
component("U63_",155).
component("U62_",154).
component("YHR068W",517).
component("YKL150W",637).
component("YIL043C",544).
component("YHR042W",511).
component("YOR221C",855).
component("YMR145C",748).
component("YML120C",731).
component("YKL192C",646).
component("YKL055C",629).
component("YER061C",399).
component("YDL085W",286).
component("YPL171C",889).
component("YHR179W",531).
component("YMR145C",749).
component("YML120C",732).
component("YKL192C",647).
component("YDL085W",287).
component("YGR234W",489).
component("YFR030W",430).
component("YPL017C",876).
component("YFL018C",420).
component("YDR353W",355).
component("YER042W",393).
component("YPR167C",927).
component("YJR137C",619).
component("YNL052W",770).
component("YMR256C",760).
component("YLR395C",713).
component("YLR038C",675).
component("YIL111W",552).
component("YHR051W",515).
component("YGL191W",456).
component("YGL187C",455).
component("YDL067C",283).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",326).
component("YPL266W",905).
component("YPL273W",906).
component("YLL062C",671).
component("YDR410C",363).
component("YKR069W",660).
component("YOL096C",823).
component("U47_",142).
component("YER091C",411).
component("YJR073C",610).
component("YGR157W",478).
component("YDR120C",329).
component("YML008C",719).
component("YOR074C",836).
component("YDL033C",278).
component("YOL096C",824).
component("YLR172C",690).
component("YLR058C",678).
component("YDR019C",317).
component("YBR176W",238).
component("YDR408C",362).
component("YMR120C",746).
component("YLR028C",673).
component("YBL013W",197).
component("YJL130C",584).
component("YJL088W",577).
component("YKL024C",625).
component("YPR074C",921).
component("YBR117C",228).
component("YMR108W",744).
component("YCL009C",257).
component("YMR062C",739).
component("YNL071W",772).
component("YNR008W",798).
component("YIL160C",561).
component("YNR019W",801).
component("YCR048W",272).
component("U48_",143).
component("YMR062C",740).
component("YDR232W",342).
component("YPL231W",900).
component("YER061C",400).
component("YPL001W",875).
component("YDL052C",282).
component("U8_",180).
component("YDR148C",337).
component("YPL231W",901).
component("YPL028W",878).
component("YLR299W",701).
component("YGL017W",440).
component("YCR005C",264).
component("YML126C",733).
component("YNL104C",775).
component("YDL182W",307).
component("YDL131W",293).
component("YDR307W",351).
component("YLR258W",698).
component("YFR015C",427).
component("YPL227C",897).
component("YNL029C",767).
component("YIL085C",549).
component("YNL192W",781).
component("YBR038W",219).
component("YBR023C",215).
component("YMR306W",764).
component("YLR342W",707).
component("YGR032W",466).
component("YPR183W",930).
component("YBR248C",246).
component("YLR209C",693).
component("U104_",24).
component("U103_",23).
component("YOR209C",853).
component("YDR354W",356) :- not remove_orf("YDR354W",356).
component("YFR047C",431).
component("YJR133W",618).
component("YLR209C",694).
component("YML022W",721).
component("YDR441C",366).
component("YHR128W",526).
component("YPR176C",929).
component("YPL172C",890).
component("YNR041C",804).
component("YMR101C",742).
component("YDL090C",289).
component("YBR003W",208).
component("YBR002C",207).
component("YJL167W",591).
component("YJL167W",592).
component("YNL256W",786).
component("YPR069C",918).
component("YDR127W",332).
component("YHR190W",534).
component("YLR146C",687).
component("YPL214C",896).
component("YHR068W",518).
component("YLR303W",703).
component("YGR012W",464).
component("YML082W",729).
component("YJR130C",617).
component("YDR035W",319).
component("YBR249C",247).
component("YLR180W",692).
component("YDR502C",370).
component("YOR274W",859).
component("YOL143C",830).
component("YBR256C",249).
component("YHR137W",527).
component("YGL202W",457).
component("YLR027C",672).
component("YKL106W",632).
component("YOL140W",829).
component("YLR438W",716).
component("YGR019W",465).
component("YLR089C",682).
component("U64_",156).
component("U61_",153).
component("U51_",145).
component("YJR148W",621).
component("YHR208W",537).
component("YFL030W",422).
component("YOR184W",847).
component("YNR058W",808).
component("YIL116W",554).
component("YGL253W",461).
component("YFR053C",432).
component("YMR013C",737).
component("YMR205C",755).
component("YGR240C",490).
component("YOL016C",812).
component("YFR014C",426).
component("YLR240W",696).
component("YKL203C",649).
component("YJR066W",609).
component("YCR036W",271).
component("YGR194C",484).
component("YCL040W",260).
component("U15_",68).
component("YPL188W",892).
component("YJR049C",605).
component("YEL041W",380).
component("U96_",184).
component("YKL001C",624).
component("YDR236C",343).
component("YML070W",727).
component("YFL053W",424).
component("YHL032C",503).
component("YDR531W",374).
component("U83_",175).
component("U82_",174).
component("U81_",173).
component("YMR208W",756).
component("YPL203W",893).
component("YOR061W",835).
component("YKL166C",639).
component("YJL164C",590).
component("YIL035C",543).
component("YHR205W",536).
component("YHR102W",524).
component("YGL019W",441).
component("YHR025W",510).
component("YOR347C",866).
component("YAL038W",190).
component("YNR012W",799).
component("YDR009W",316).
component("YDR127W",333).
component("U21_",113).
component("YDR147W",336).
component("YDR300C",350).
component("YCR012W",265).
component("YER069W",402).
component("U19_",103).
component("U18_",93).
component("U17_",83).
component("U76_",167).
component("YER170W",415).
component("YDR226W",341).
component("YKL067W",630).
component("YOL055C",816).
component("YDR454C",367).
component("YJR057W",607).
component("YOL061W",820).
component("YKL181W",641).
component("YHL011C",501).
component("YER099C",412).
component("YBL068W",204).
component("YOR143C",843).
component("YNL256W",787).
component("YLR328W",705).
component("YBR018C",211).
component("YBR018C",212).
component("YGR007W",463).
component("YGR202C",485).
component("YLR328W",706).
component("YDL045C",280).
component("U80_",172).
component("YDL103C",292).
component("U94_",183).
component("YJR010W",600).
component("YBR029C",216).
component("YCL050C",261).
component("YGL130W",451).
component("YDR530C",373).
component("YCL050C",262).
component("YPR190C",932).
component("YPR187W",931).
component("YPR110C",924).
component("YPR010C",911).
component("YOR341W",865).
component("YOR340C",864).
component("YOR224C",857).
component("YOR210W",854).
component("YOR207C",851).
component("YOR151C",844).
component("YOR116C",838).
component("YOL005C",810).
component("YNR003C",797).
component("YNL248C",785).
component("YNL151C",779).
component("YNL113W",776).
component("YKL144C",635).
component("YJR063W",608).
component("YJL148W",588).
component("YJL140W",587).
component("YIL021W",542).
component("YHR143W-A",528).
component("YGL070C",448).
component("YFL036W",423).
component("YDR404C",361).
component("YDR156W",338).
component("YDR045C",322).
component("YDL150W",301).
component("YDL140C",295).
component("YBR154C",236).
component("YPR175W",928).
component("YPL167C",888).
component("YOR330C",862).
component("YOL115W",827).
component("YNL299W",794).
component("YNL262W",789).
component("YNL102W",774).
component("YJR043C",604).
component("YJR006W",598).
component("YJL090C",578).
component("YIL139C",557).
component("YEL055C",383).
component("YDR419W",364).
component("YDR121W",330).
component("YDL102W",291).
component("YCR014C",266).
component("YBR278W",252).
component("YBL035C",200).
component("YKL035W",628).
component("YHL012W",502).
component("YHR123W",525).
component("YPR113W",925).
component("YBR243C",244).
component("YDL142C",300).
component("YPL148C",886).
component("YER026C",392).
component("YGR286C",498).
component("YJL068C",574).
component("YHR189W",533).
component("YDR058C",325).
component("YDL086W",288).
component("YOL011W",811).
component("YMR008C",735).
component("YMR006C",734).
component("U105_",25).
component("YBL015W",198).
component("YJL068C",575).
component("YJR019C",602).
component("YOR040W",834).
component("U77_",168).
component("YDR481C",368).
component("YLR377C",711).
component("YFR025C",428).
component("YPL179W",891).
component("YNR032W",802).
component("YML057W",726).
component("YML016C",720).
component("YLR433C",715).
component("YGR123C",476).
component("YER133W",413).
component("YER089C",409).
component("YDR436W",365).
component("YDR075W",327).
component("YDL188C",308).
component("YDL134C",294).
component("YDL047W",281).
component("YDL006W",274).
component("YBR125C",231).
component("YBL056W",203).
component("YPR073C",919).
component("YHR215W",538).
component("YDL024C",277).
component("YBR093C",225).
component("YBR092C",224).
component("YAR071W",194).
component("YHR046C",514).
component("U9_",187).
component("YPL228W",898).
component("YMR180C",752).
component("YDL236W",312).
component("YJL155C",589).
component("YPR073C",920).
component("YOR208W",852).
component("YNL053W",771).
component("YMR036C",738).
component("YIR026C",567).
component("YIL113W",553).
component("YFR028C",429).
component("YER075C",405).
component("YDL230W",311).
component("YBR276C",251).
component("U34_",131).
component("U33_",130).
component("U32_",129).
component("U31_",128).
...
component("U25_",122).
component("U24_",121).
component("YHR044C",513).
component("YHR043C",512).
component("YOL064C",821).
component("YOR360C",868).
component("YGL248W",460).
component("YKR031C",656).
component("YPL206C",894).
component("YGL027C",443).
component("YLR286C",700).
component("YJR153W",622).
component("YJL221C",597).
component("YJL216C",595).
component("YIL172C",565).
component("YGR292W",500).
component("YGR287C",499).
component("YBR299W",256).
component("YBR184W",239).
component("YIL162W",562).
component("YPR026W",912).
component("YDR001C",314).
component("YBR001C",206).
component("YIR019C",566).
component("YIL099W",551).
component("YDL037C",279).
component("YOR190W",849).
component("YLR300W",702).
component("YGR282C",497).
component("YDR261C",346).
component("YDR400W",359).
component("U23_",120).
component("YML035C",722).
component("YJL070C",576).
component("YBR284W",253).
component("U106_",26).
component("U102_",22).
component("YER043C",394).
component("YNL045W",769).
component("YGL037C",444).
component("YDR242W",344).
component("YBR208C",241).
component("YMR281W",762).
component("U53_",147).
component("YPR062W",917).
component("YMR120C",747).
component("YLR028C",674).
component("YHR144C",529).
component("YGR267C",496).
component("YBL033C",199).
component("YBR153W",235).
component("YNL141W",777).
component("YLR245C",697).
component("YML035C",723).
component("YGR204W",487).
component("YBR084W",222).
component("YJL126W",582).
component("U44_",139).
component("YDL100C",290).
component("U87_",177).
component("U40_",137).
component("U39_",135).
component("YBR011C",210).
component("YHR201C",535).
component("YBR111C",226).
component("YBR252W",248).
component("YPR080W",922).
component("YOR187W",848).
component("YOR133W",841).
component("YLR069C",680).
component("YKR084C",662).
component("YKL173W",640).
component("YJL102W",580).
component("YDR385W",358).
component("YBR118W",229).
component("YER005W",388).
component("YLL001W",665).
component("YIL048W",545).
component("YER166W",414).
component("YDR093W",328).
component("YAL026C",189).
component("YBL099W",205).
component("U60_",152).
component("YLR231C",695).
component("U88_",178).
component("YDR538W",376).
component("YLR134W",684).
component("YLR044C",676).
component("YGR087C",472).
component("YDR380W",357).
component("YDL080C",285).
component("U98_",185).
component("YMR250W",759).
component("YKL184W",645).
component("YOR128C",839).
component("YEL021W",378).
component("YNR043W",805).
component("U93_",182).
component("U54_",148).
component("YKL211C",650) :- not remove_orf("YKL211C",650).
component("YKR097W",664).
component("YOL052C",815).
component("YNL169C",780).
component("YGR170W",479).
component("YNL256W",788).
component("YDR294C",348).
component("YEL046C",381).
component("YNR033W",803).
component("YKL211C",651) :- not remove_orf("YKL211C",651).
component("YER090W",651) :- not remove_orf("YER090W",651).
component("YER090W",410) :- not remove_orf("YER090W",410).
component("YDR127W",334).
component("YPL281C",909).
component("YOR393W",874).
component("YMR323W",765).
component("YHR174W",530).
component("YGR254W",492).
component("YOR202W",850).
component("YPL262W",903).
component("YGL026C",442) :- not remove_orf("YGL026C",442).
component("YGR155W",477).
component("YLR304C",704).
component("YJL200C",593).
component("YGL009C",437).
component("YNL316C",795).
component("YKL182W",643).
component("YPL212C",895).
component("YNL292W",793).
component("YGL063W",447).
component("YFL001W",418).
component("YPR002W",910).
component("YJR016C",601).
component("YCR053W",273).
component("YDR127W",335).
component("YGL148W",452).
component("YIL168W",564).
component("YIL167W",563).
component("YCL064C",263).
component("YER086W",407).
component("YLR359W",710).
component("YAL012W",188).
component("YML004C",718).
component("YFR055W",433).
component("YJL005W",570).
component("YJL121C",581).
component("YBR019C",213).
component("YDR050C",324).
component("YIL020C",541).
component("YDR007W",315) :- not remove_orf("YDR007W",315).
component("YOR095C",837).
component("YER003C",387).
component("YBR196C",240).
component("YGL001C",435).
component("YPL117C",884).
component("U14_",60).
component("YOL056W",817).
component("YKL152C",638).
component("YDL021W",275).
component("YMR105C",743).
component("YKL127W",633).
component("YEL058W",384).
component("YPR060C",916).
component("YHR072W",519).
component("YPL097W",882).
component("YGR185C",482).
component("YGR264C",495).
component("YGR171C",480).
component("YHR011W",507).
component("YDR023W",318).
component("YPL104W",883).
component("YLL018C",666).
component("YPR081C",923).
component("YBR121C",230).
component("YHR020W",509).
component("YER087W",408).
component("YNL247W",784).
component("YOR168W",845).
component("YOL097C",825).
component("YDR268W",347).
component("YPR047W",915).
component("YLR060W",679).
component("YFL022C",421).
component("YPR033C",913).
component("YCR024C",267).
component("YHR019C",508).
component("YKL194C",648).
component("YIL078W",548).
component("YPL160W",887).
component("YLR382C",712).
component("YNL073W",773).
component("YDR037W",320).
component("YOR335C",863).
component("YGR094W",474).
component("YLR153C",688).
component("YAL054C",191).
component("YOR317W",860).
component("YMR246W",758).
component("YIL009W",540).
component("YER015W",390).
component("YOR142W",842).
component("YGR244C",491).
component("YPR035W",914).
component("YIL145C",558).
component("U89_",179).
component("YJL101C",579).
component("YOL049W",814).
component("YAR015W",193).
component("YER183C",417).
component("U90_",181).
component("YNR057C",807).
component("YDL141W",296).
component("YDL141W",297).
component("YGL234W",459).
component("YDL141W",298).
component("YJR103W",614).
component("YBL039C",201).
component("YGR204W",488).
component("YBR084W",223).
component("YNL220W",782).
component("YOL058W",818).
component("YDL141W",299).
component("YHR074W",520).
component("YMR217W",757).
component("YGR061C",470).
component("YJR109C",616).
component("YJL130C",585).
component("YGL062W",446).
component("YBR218C",242).
component("YPL231W",902).
component("YNR016C",800).
component("YKL182W",644).
component("YGR037C",467).
component("YPR138C",926).
component("YPL265W",904).
component("YPL134C",885).
component("YPL057C",880).
component("YPL036W",879).
component("YOR348C",867).
component("YOR222W",856).
component("YOR171C",846).
component("YOR130C",840).
component("YOR011W",833).
component("YOL156W",832).
component("YOL103W",826).
component("YOL020W",813) :- not remove_orf("YOL020W",813).
component("YNR072W",809).
component("YNR056C",806).
component("YNL318C",796).
component("YNL270C",790).
component("YNL142W",778).
component("YMR272C",761).
component("YMR202W",754).
component("YMR011W",736).
component("YLR348C",708).
component("YLR260W",699).
component("YLR138W",685).
component("YLR100C",683).
component("YLR081W",681).
component("YLL061W",670).
component("YLL043W",668).
component("YKR093W",663).
component("YKR053C",658).
component("YKR039W",657) :- not remove_orf("YKR039W",657).
component("YKL217W",653).
component("YJR158W",623).
component("YJR095W",613).
component("YJR077C",611).
component("YJL219W",596).
component("YJL214W",594).
component("YJL134W",586).
component("YJL129C",583).
component("YIL134W",556).
component("YHR096C",523).
component("YHR094C",522).
component("YHR092C",521).
component("YHL036W",504).
component("YGR121C",475).
component("YGR065C",471).
component("YGR055W",468).
component("YGL186C",454).
component("YGL077C",449).
component("YGL008C",436).
component("YFL055W",425).
component("YFL011W",419).
component("YER060W-A",398).
component("YER060W",397).
component("YER056C",396).
component("YER053C",395).
component("YEL069C",386).
component("YEL063C",385).
component("YEL017C-A",377).
component("YDR536W",375).
component("YDR508C",372).
component("YDR503C",371).
component("YDR497C",369).
component("YDR345C",354).
component("YDR343C",353).
component("YDR342C",352).
component("YDR297W",349).
component("YDR046C",323) :- not remove_orf("YDR046C",323).
component("YDL245C",313).
component("YDL210W",309).
component("YCR032W",270).
component("YCR028C",269).
component("YCR024C-A",268).
component("YCL025C",259).
component("YBR298C",255).
component("YBR291C",254).
...
catalyst(2132,23).
catalyst(2220,853).
catalyst(3620,356) :- not remove_reaction(3620,356).
catalyst(2110,431).
catalyst(2190,431).
catalyst(5550,618).
catalyst(5791,694).
...
catalyst(2300,182).
catalyst(3460,148).
catalyst(3600,650) :- not remove_reaction(3600,650).
catalyst(8000,664).
catalyst(3941,815).
catalyst(3942,815).
catalyst(6890,780).
...
catalyst(4560,381).
catalyst(2550,803).
catalyst(1890,651) :- not remove_reaction(1890,651).
catalyst(3630,651) :- not remove_reaction(3630,651).
catalyst(1890,410) :- not remove_reaction(1890,410).
catalyst(3630,410) :- not remove_reaction(3630,410).
catalyst(3740,334).
catalyst(8231,909).
catalyst(8232,909).
catalyst(8231,874).
...
catalyst(8061,903).
catalyst(8062,903).
catalyst(3590,442) :- not remove_reaction(3590,442).
catalyst(10910,442) :- not remove_reaction(10910,442).
catalyst(4570,477).
catalyst(8181,704).
catalyst(8182,704).
catalyst(8181,593).
...
catalyst(8282,324).
catalyst(3840,541).
catalyst(3610,315) :- not remove_reaction(3610,315).
catalyst(7921,837).
catalyst(7922,837).
catalyst(7841,387).
catalyst(7842,387).
...
catalyst(1210,832).
catalyst(1160,826).
catalyst(801,813) :- not remove_reaction(801,813).
catalyst(802,813) :- not remove_reaction(802,813).
catalyst(811,813) :- not remove_reaction(811,813).
catalyst(812,813) :- not remove_reaction(812,813).
catalyst(831,813) :- not remove_reaction(831,813).
catalyst(832,813) :- not remove_reaction(832,813).
catalyst(901,813) :- not remove_reaction(901,813).
catalyst(902,813) :- not remove_reaction(902,813).
catalyst(1180,809).
catalyst(1210,809).
catalyst(700,806).
catalyst(1200,796).
...
catalyst(650,663).
catalyst(6560,658).
catalyst(681,657) :- not remove_reaction(681,657).
catalyst(682,657) :- not remove_reaction(682,657).
catalyst(771,657) :- not remove_reaction(771,657).
catalyst(772,657) :- not remove_reaction(772,657).
catalyst(781,657) :- not remove_reaction(781,657).
catalyst(782,657) :- not remove_reaction(782,657).
catalyst(791,657) :- not remove_reaction(791,657).
catalyst(792,657) :- not remove_reaction(792,657).
catalyst(801,657) :- not remove_reaction(801,657).
catalyst(802,657) :- not remove_reaction(802,657).
catalyst(811,657) :- not remove_reaction(811,657).
catalyst(812,657) :- not remove_reaction(812,657).
catalyst(831,657) :- not remove_reaction(831,657).
catalyst(832,657) :- not remove_reaction(832,657).
catalyst(841,657) :- not remove_reaction(841,657).
catalyst(842,657) :- not remove_reaction(842,657).
catalyst(851,657) :- not remove_reaction(851,657).
catalyst(852,657) :- not remove_reaction(852,657).
catalyst(881,657) :- not remove_reaction(881,657).
catalyst(882,657) :- not remove_reaction(882,657).
catalyst(901,657) :- not remove_reaction(901,657).
catalyst(902,657) :- not remove_reaction(902,657).
catalyst(911,657) :- not remove_reaction(911,657).
catalyst(912,657) :- not remove_reaction(912,657).
catalyst(921,657) :- not remove_reaction(921,657).
catalyst(922,657) :- not remove_reaction(922,657).
catalyst(931,657) :- not remove_reaction(931,657).
catalyst(932,657) :- not remove_reaction(932,657).
catalyst(1191,657) :- not remove_reaction(1191,657).
catalyst(1192,657) :- not remove_reaction(1192,657).
catalyst(390,653).
catalyst(1180,623).
catalyst(1210,623).
catalyst(1250,613).
...
catalyst(1210,352).
catalyst(6650,349).
catalyst(791,323) :- not remove_reaction(791,323).
catalyst(792,323) :- not remove_reaction(792,323).
catalyst(801,323) :- not remove_reaction(801,323).
catalyst(802,323) :- not remove_reaction(802,323).
catalyst(811,323) :- not remove_reaction(811,323).
catalyst(812,323) :- not remove_reaction(812,323).
catalyst(831,323) :- not remove_reaction(831,323).
catalyst(832,323) :- not remove_reaction(832,323).
catalyst(841,323) :- not remove_reaction(841,323).
catalyst(842,323) :- not remove_reaction(842,323).
catalyst(851,323) :- not remove_reaction(851,323).
catalyst(852,323) :- not remove_reaction(852,323).
catalyst(901,323) :- not remove_reaction(901,323).
catalyst(902,323) :- not remove_reaction(902,323).
catalyst(1180,313).
catalyst(1210,313).
catalyst(690,309).
catalyst(730,309).
...
catalyst(851,220) :- not remove_reaction(851,220).
catalyst(852,220) :- not remove_reaction(852,220).
...
modifiable_enzyme(356).
modifiable_enzyme(650).
modifiable_enzyme(651).
modifiable_enzyme(410).
modifiable_enzyme(442).
modifiable_enzyme(315).
modifiable_enzyme(813).
modifiable_enzyme(657).
