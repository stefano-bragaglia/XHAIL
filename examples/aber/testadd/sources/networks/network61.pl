...
component("YLR056W",340).
component("YKR009C",326).
component("YOL086C",412).
component("YMR303C",375).
component("YGL256W",235).
component("YDL168W",149).
component("YBR145W",114).
component("YPL231W",451).
component("U46_",69).
component("YBR149W",115).
component("YGL001C",215).
component("YIL094C",276).
component("U45_",68).
component("YDR127W",160).
component("YOL126C",416).
component("YKL085W",316).
component("YDL078C",142).
component("YNL037C",379).
component("YCL018W",128).
component("YLR355C",361).
component("YDL174C",151).
component("YML086C",366).
component("YGR088W",242).
component("YDR256C",170).
component("YJR078W",308).
component("YJR025C",301).
component("U107_",23).
component("YJR104C",310).
component("YHR008C",258).
component("YJL026W",287).
component("YIL066C",274).
component("YGR180C",245).
component("YER070W",199).
component("U36_",64).
component("YDL168W",150).
component("YPL276W",459).
component("YPL275W",458).
component("YOR388C",438).
component("U55_",75).
component("YOR323C",431).
component("YER178W",204).
component("YBR221C",120).
component("YIL125W",279).
component("U52_",73).
component("YBR166C",117).
component("YGL012W",218).
component("YKL216W",325).
component("YKR009C",327).
component("YIL160C",282).
component("YGL205W",232).
component("U100_",20).
component("YKR080W",332).
component("YER023W",193).
component("YGR204W",247).
component("YLR142W",345).
component("U65_",79).
component("U62_",78).
component("YHR068W",264).
component("YKL150W",319).
component("YIL043C",273).
component("YPL171C",447).
component("YHR179W",271).
component("YGR234W",249).
component("YPL017C",440).
component("YFL018C",206).
component("YDR353W",174).
component("YPR167C",470).
component("YNL052W",380).
component("YMR256C",374).
component("YLR395C",363).
component("YLR038C",338).
component("YIL111W",277).
component("YHR051W",263).
component("YGL191W",230).
component("YGL187C",229).
component("YDL067C",141).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",457).
component("YKR069W",331).
component("U47_",70).
component("YJR073C",306).
component("YDL033C",140).
component("YLR172C",347).
component("YLR058C",341).
component("YDR019C",155).
component("YBR176W",118).
component("YDR408C",179).
component("YMR120C",371).
component("YLR028C",336).
component("YBL013W",97).
component("YJL130C",293).
component("YKL024C",314).
component("YPR074C",466).
component("YBR117C",113).
component("YCL009C",127).
component("YNL071W",382).
component("YIL160C",283).
component("U48_",71).
component("YPL231W",452).
component("YPL231W",453).
component("YLR299W",355).
component("YGL017W",219).
component("YML126C",367).
component("YNL104C",384).
component("YDL182W",152).
component("YDL131W",146).
component("YLR258W",352).
component("YFR015C",211).
component("YNL029C",378).
component("YIL085C",275).
component("YMR306W",376).
component("YLR342W",360).
component("YGR032W",237).
component("YLR209C",348).
component("U104_",21).
component("YDR354W",175) :- not remove_orf("YDR354W",175).
component("YFR047C",213).
component("YLR209C",349).
component("YML022W",364).
component("YDR441C",181).
component("YJL167W",297).
component("YDR127W",161).
component("YHR068W",265).
component("YLR303W",357).
component("YGR012W",236).
component("YJR130C",311).
component("YDR035W",156).
component("YBR249C",121).
component("YOR274W",430).
component("YHR137W",267).
component("YGL202W",231).
component("YLR027C",335).
component("YKL106W",317).
component("YOL140W",417).
component("YLR089C",342).
component("U61_",77).
component("YJR148W",312).
component("YFL030W",207).
component("YNR058W",403).
component("YGL253W",234).
component("YFR053C",214).
component("YMR205C",373).
component("YGR240C",250).
component("YOL016C",406).
component("YFR014C",210).
component("YCR036W",137).
component("YCL040W",130).
component("YPL188W",448).
component("YJR049C",303).
component("YEL041W",188).
component("U96_",91).
component("YDR236C",168).
component("YHL032C",256).
component("YOR347C",436).
component("YAL038W",95).
component("YNR012W",399).
component("YDR127W",162).
component("YDR147W",165).
component("YCR012W",132).
component("U76_",87).
component("YER170W",203).
component("YDR226W",167).
component("YKL067W",315).
component("YOL055C",409).
component("YDR454C",182).
component("YJR057W",304).
component("YOL061W",411).
component("YKL181W",321).
component("YHL011C",255).
component("YER099C",202).
component("YBL068W",102).
component("YOR143C",422).
component("YNL256W",392).
component("YBR018C",105).
component("YLR328W",359).
component("U94_",90).
component("YBR029C",107).
component("YGL130W",226).
component("YPR190C",473).
component("YPR187W",472).
component("YPR110C",467).
component("YPR010C",462).
component("YOR341W",435).
component("YOR340C",434).
component("YOR224C",429).
component("YOR210W",428).
component("YOR207C",426).
component("YOR151C",423).
component("YOR116C",420).
component("YOL005C",404).
component("YNR003C",398).
component("YNL248C",391).
component("YNL151C",388).
component("YNL113W",385).
component("YKL144C",318).
component("YJR063W",305).
component("YJL148W",296).
component("YJL140W",295).
component("YIL021W",272).
component("YHR143W-A",268).
component("YGL070C",224).
component("YFL036W",208).
component("YDR404C",178).
component("YDR156W",166).
component("YDR045C",157).
component("YDL150W",148).
component("YDL140C",147).
component("YBR154C",116).
component("YPR175W",471).
component("YPL167C",446).
component("YOR330C",432).
component("YOL115W",415).
component("YNL299W",396).
component("YNL262W",393).
component("YNL102W",383).
component("YJR043C",302).
component("YJR006W",299).
component("YJL090C",289).
component("YIL139C",280).
component("YEL055C",190).
component("YDR419W",180).
component("YDR121W",159).
component("YDL102W",145).
component("YCR014C",133).
component("YBR278W",124).
component("YBL035C",100).
component("YPR113W",468).
component("YPL148C",445).
component("YGR286C",254).
component("YOL011W",405).
component("YMR008C",369).
component("YMR006C",368).
component("U105_",22).
component("YBL015W",98).
component("U77_",88).
component("YLR377C",362).
component("YHR046C",262).
component("U9_",93).
component("YPR073C",465).
component("YOR208W",427).
component("YNL053W",381).
component("YMR036C",370).
component("YIR026C",286).
component("YIL113W",278).
component("YFR028C",212).
component("YER075C",200).
component("YDL230W",153).
...
component("U26_",60).
component("U24_",59).
component("YHR044C",261).
component("YHR043C",260).
component("YOR360C",437).
component("YKR031C",328).
component("YPL206C",449).
component("YGL027C",221).
component("YLR286C",354).
component("YJR153W",313).
component("YOR190W",425).
component("YLR300W",356).
component("YGR282C",253).
component("YDR261C",171).
component("YDR400W",177).
component("YML035C",365).
component("YJL070C",288).
component("YBR284W",125).
component("YER043C",194).
component("YDR242W",169).
component("U53_",74).
component("YPR062W",464).
component("YMR120C",372).
component("YLR028C",337).
component("YHR144C",269).
component("YBL033C",99).
component("YNL141W",386).
component("YLR245C",351).
component("YBR084W",110).
component("YJL126W",291).
component("YDL100C",144).
component("U39_",65).
component("YBR011C",104).
component("YBR111C",112).
component("YBR252W",122).
component("YER005W",192).
component("YBL099W",103).
component("YLR231C",350).
component("YLR134W",344).
component("YLR044C",339).
component("YGR087C",241).
component("YDR380W",176).
component("YDL080C",143).
component("U98_",92).
component("YOR128C",421).
component("YKL211C",323) :- not remove_orf("YKL211C",323).
component("YKR097W",333).
component("YNL169C",389).
component("YEL046C",189).
component("YNR033W",401).
component("YKL211C",324) :- not remove_orf("YKL211C",324).
component("YER090W",324) :- not remove_orf("YER090W",324).
component("YER090W",201) :- not remove_orf("YER090W",201).
component("YDR127W",163).
component("YPL281C",460).
component("YOR393W",439).
component("YMR323W",377).
component("YHR174W",270).
component("YGR254W",251).
component("YPL262W",455).
component("YGL026C",220) :- not remove_orf("YGL026C",220).
component("YLR304C",358).
component("YJL200C",298).
component("YNL316C",397).
component("YPL212C",450).
component("YNL292W",395).
component("YGL063W",223).
component("YFL001W",205).
component("YPR002W",461).
component("YJR016C",300).
component("YCR053W",138).
component("YDR127W",164).
component("YGL148W",227).
component("YIL168W",285).
component("YIL167W",284).
component("YCL064C",131).
component("YAL012W",94).
component("YBR019C",106).
component("YDR007W",154) :- not remove_orf("YDR007W",154).
component("YOR095C",419).
component("YGL001C",216).
component("YPL117C",444).
component("YOL056W",410).
component("YKL152C",320).
component("YDL021W",139).
component("YPR060C",463).
component("YPL097W",442).
component("YGR185C",246).
component("YGR264C",252).
component("YGR171C",244).
component("YPL104W",443).
component("YLL018C",334).
component("YNL247W",390).
component("YOL097C",413).
component("YDR268W",172).
component("YCR024C",134).
component("YHR019C",259).
component("YOR335C",433).
component("YLR153C",346).
component("YAL054C",96).
component("YIL145C",281).
component("YJL101C",290).
component("YOL049W",408).
component("U90_",89).
component("YNR057C",402).
component("YGL234W",233).
component("YJR103W",309).
component("YBL039C",101).
component("YGR204W",248).
component("YBR084W",111).
component("YHR074W",266).
component("YGL062W",222).
component("YBR218C",119).
component("YPL231W",454).
component("YNR016C",400).
component("YKL182W",322).
component("YGR037C",238).
component("YPR138C",469).
component("YPL265W",456).
component("YPL036W",441).
component("YOR171C",424).
component("YOR011W",418).
component("YOL103W",414).
component("YOL020W",407) :- not remove_orf("YOL020W",407).
component("YNL270C",394).
component("YNL142W",387).
component("YLR260W",353).
component("YLR100C",343).
component("YKR053C",330).
component("YKR039W",329) :- not remove_orf("YKR039W",329).
component("YJR077C",307).
component("YJL134W",294).
component("YJL129C",292).
component("YHL036W",257).
component("YGR121C",243).
component("YGR065C",240).
component("YGR055W",239).
component("YGL186C",228).
component("YGL077C",225).
component("YGL008C",217).
component("YFL055W",209).
component("YER060W-A",198).
component("YER060W",197).
component("YER056C",196).
component("YER053C",195).
component("YEL063C",191).
component("YEL017C-A",187).
component("YDR536W",186).
component("YDR508C",185).
component("YDR503C",184).
component("YDR497C",183).
component("YDR297W",173).
component("YDR046C",158) :- not remove_orf("YDR046C",158).
component("YCR032W",136).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,175) :- not remove_reaction(3620,175).
catalyst(2190,213).
catalyst(5791,349).
catalyst(5792,349).
catalyst(5801,349).
...
catalyst(6111,421).
catalyst(6112,421).
catalyst(3600,323) :- not remove_reaction(3600,323).
catalyst(8000,333).
catalyst(6890,389).
catalyst(4560,189).
catalyst(2550,401).
catalyst(3630,324) :- not remove_reaction(3630,324).
catalyst(3630,201) :- not remove_reaction(3630,201).
catalyst(3740,163).
catalyst(8231,460).
catalyst(8232,460).
catalyst(8231,439).
...
catalyst(8051,455).
catalyst(8052,455).
catalyst(3590,220) :- not remove_reaction(3590,220).
catalyst(10910,220) :- not remove_reaction(10910,220).
catalyst(8181,358).
catalyst(8182,358).
catalyst(8181,298).
catalyst(8182,298).
...
catalyst(6330,343).
catalyst(6560,330).
catalyst(771,329) :- not remove_reaction(771,329).
catalyst(772,329) :- not remove_reaction(772,329).
catalyst(781,329) :- not remove_reaction(781,329).
catalyst(782,329) :- not remove_reaction(782,329).
catalyst(801,329) :- not remove_reaction(801,329).
catalyst(802,329) :- not remove_reaction(802,329).
catalyst(811,329) :- not remove_reaction(811,329).
catalyst(812,329) :- not remove_reaction(812,329).
catalyst(831,329) :- not remove_reaction(831,329).
catalyst(832,329) :- not remove_reaction(832,329).
catalyst(841,329) :- not remove_reaction(841,329).
catalyst(842,329) :- not remove_reaction(842,329).
catalyst(851,329) :- not remove_reaction(851,329).
catalyst(852,329) :- not remove_reaction(852,329).
catalyst(881,329) :- not remove_reaction(881,329).
catalyst(882,329) :- not remove_reaction(882,329).
catalyst(901,329) :- not remove_reaction(901,329).
catalyst(902,329) :- not remove_reaction(902,329).
catalyst(931,329) :- not remove_reaction(931,329).
catalyst(932,329) :- not remove_reaction(932,329).
catalyst(1191,329) :- not remove_reaction(1191,329).
catalyst(1192,329) :- not remove_reaction(1192,329).
catalyst(1581,307).
catalyst(1582,307).
catalyst(6560,294).
catalyst(361,292).
...
catalyst(851,108) :- not remove_reaction(851,108).
catalyst(852,108) :- not remove_reaction(852,108).
catalyst(901,108) :- not remove_reaction(901,108).
catalyst(902,108) :- not remove_reaction(902,108).
catalyst(2920,86).
catalyst(2920,85).
catalyst(2920,84).
catalyst(2920,83).
