...
component("YNL280C",915).
component("YLR056W",779).
component("YGR060W",543).
component("YGL012W",508).
component("YKR009C",755).
component("YOL086C",950).
component("YMR303C",882).
component("YMR083W",854).
component("YGL256W",535).
component("YDL168W",345).
component("YBR145W",267).
component("YPL231W",1045).
component("YBR265W",286).
component("U46_",160).
component("YBR149W",268).
component("YBR149W",269).
component("YJR159W",718).
component("YGL001C",504).
component("YIL094C",635).
component("YHR063C",598).
component("U45_",159).
component("YML056C",835).
component("YLR432W",823).
component("YHR216W",623).
component("YAR075W",222).
component("YAR073W",221).
component("YDR127W",382).
component("YJR139C",713).
component("YML075C",838).
component("YLR450W",826).
component("YOL126C",956).
component("YKL085W",729).
component("YDL078C",324).
component("YKL029C",724).
component("YOR136W",977).
component("YNL037C",888).
component("YNL009W",886).
component("YLR174W",793).
component("YHR183W",616).
component("YGR256W",574).
component("YNL241C",904).
component("YOL059W",947).
component("YDL022W",315).
component("YCL018W",294).
component("YLR355C",818).
component("YIL074C",632).
component("YER081W",469).
component("YML054C",834).
component("YDL174C",349).
component("YML086C",840).
component("YIL155C",645).
component("YPR191W",1086).
component("YOR065W",965).
component("YJL166W",682).
component("YHR001W-A",585).
component("YGR183C",559).
component("YFR033C",500).
component("YEL024W",437).
component("YDR529C",427).
component("YBL045C",230).
component("Q0105",19).
component("YKR066C",760).
component("YGR088W",547).
component("YDR256C",398).
component("YKL026C",723).
component("YIR037W",657).
component("YBR244W",281).
component("YJR078W",705).
component("U58_",169).
component("YJR025C",696).
component("U107_",28).
component("YGR255C",573).
component("U108_",29).
component("YHR007C",586).
component("YDR402C",414).
component("YGL055W",515).
component("YJR104C",708).
component("YHR008C",587).
component("YOR384W",1014).
component("YOR381W",1013).
component("YOL152W",960).
component("YLL051C",771).
component("YJL026W",660).
component("YIL066C",631).
component("YGR180C",558).
component("YER070W",466).
component("U37_",151).
component("U36_",150).
component("U35_",149).
component("YDL168W",346).
component("YDR158W",390).
component("YJR009C",692).
component("YJL052W",662).
component("YGR192C",561).
component("YBR006W",239).
component("YPL276W",1056).
component("YPL275W",1055).
component("YOR388C",1015).
component("YPL061W",1024).
component("YOR374W",1010).
component("YER073W",467).
component("YGL154C",524).
component("YBR115C",262).
component("U55_",168).
component("YER069W",464).
component("YOR323C",1000).
component("YMR170C",865).
component("YMR169C",864).
component("U2_",143).
component("YER178W",483).
component("YBR221C",279).
component("YIL125W",641).
component("U52_",165).
component("YBR166C",272).
component("YNL280C",916).
component("YGL012W",509).
component("YKL182W",741).
component("YKL216W",752).
component("YDR044W",365).
component("YER014W",448).
component("YKR009C",756).
component("YIL160C",647).
component("YGL205W",529).
component("YMR118C",858).
component("YLR164W",791).
component("YLL041C",769).
component("YKL148C",735).
component("YKL141W",733).
component("YJL045W",661).
component("YDR178W",392).
component("YJR051W",699).
component("YEL047C",441).
component("YDL171C",347).
component("YDL171C",348).
component("YOR375C",1011).
component("YDL215C",353).
component("YAL062W",217).
component("U99_",210).
component("U100_",22).
component("YBR035C",248).
component("YMR189W",867).
component("YKR080W",762).
component("YER023W",450).
component("YPL023C",1019).
component("YGL125W",521).
component("YOR236W",995).
component("YGR204W",565).
component("YBR084W",255).
component("YIR034C",656).
component("YLR142W",788).
component("U65_",177).
component("U63_",175).
component("U62_",174).
component("YOR356W",1008).
component("YHR068W",599).
component("YKL150W",736).
component("YIL043C",628).
component("YHR042W",593).
component("YOR221C",992).
component("YMR145C",861).
component("YML120C",842).
component("YKL192C",745).
component("YKL055C",726).
component("YER061C",460).
component("YDL085W",326).
component("YPL171C",1034).
component("YHR179W",615).
component("YMR145C",862).
component("YML120C",843).
component("YKL192C",746).
component("YDL085W",327).
component("YGR234W",568).
component("YFR030W",499).
component("YPL017C",1018).
component("YFL018C",487).
component("YPL091W",1026).
component("YDR353W",409).
component("YER042W",452).
component("YPR167C",1080).
component("YJR137C",712).
component("YNL052W",890).
component("YMR256C",876).
component("YLR395C",822).
component("YLR038C",777).
component("YIL111W",638).
component("YHR051W",597).
component("YGL191W",527).
component("YGL187C",526).
component("YDL067C",323).
component("Q0275",21).
component("Q0250",20).
component("Q0045",18).
component("YDR072C",374).
component("YPL266W",1052).
component("YPL273W",1054).
component("YLL062C",773).
component("YDR410C",417).
component("YKR069W",761).
component("YOL096C",951).
component("U47_",161).
component("YER091C",474).
component("YJR073C",703).
component("YGR157W",554).
component("YDR120C",380).
component("YML008C",828).
component("YOR074C",967).
component("YDL033C",317).
component("YOL096C",952).
component("YLR172C",792).
component("YLR058C",780).
component("YDR019C",361).
component("YBR176W",273).
component("YDR408C",416).
component("YMR120C",859).
component("YLR028C",775).
component("YBL013W",223).
component("YJL130C",674).
component("YJL088W",667).
component("YKL024C",721).
component("YPR074C",1071).
component("YBR117C",263).
component("YLR354C",817).
component("YGR043C",541).
component("YMR108W",857).
component("YCL009C",293).
component("YMR062C",852).
component("YNL071W",892).
component("YNR008W",923).
component("YIL160C",648).
component("YNR019W",926).
component("YCR048W",310).
component("U48_",162).
component("YNL277W",914).
component("YMR062C",853).
component("YDR232W",395).
component("YPL231W",1046).
component("YER061C",461).
component("YPL001W",1017).
component("YDL052C",321).
component("U8_",202).
component("YDR148C",388).
component("YAR035W",219).
component("YOR377W",1012).
component("YGR177C",557).
component("YPL231W",1047).
component("YPL028W",1020).
component("YLR299W",804).
component("YGL017W",510).
component("YPR001W",1058).
component("YNR001C",921).
component("YCR005C",302).
component("YML126C",844).
component("YNL104C",895).
component("YDL182W",350).
component("YDL131W",336).
component("YPR160W",1079).
component("YOR321W",999).
component("YJR143C",714).
component("YGR199W",563).
component("YDR307W",405).
component("YDL095W",331).
component("YDL093W",330).
component("YAL023C",213).
component("YLR258W",801).
component("YFR015C",495).
component("YPL227C",1043).
component("YOR103C",971).
component("YOR085W",968).
component("YMR149W",863).
component("YML019W",830).
component("YJL002C",658).
component("YEL002C",432).
component("YDL232W",355).
component("YCL043C",298).
component("YNL029C",887).
component("YIL085C",634).
component("YNL192W",902).
component("YBR038W",250).
component("YBR023C",246).
component("YEL011W",433).
component("YMR306W",884).
component("YLR342W",815).
component("YGR032W",539).
component("YPR183W",1083).
component("YBR248C",282).
component("YLR209C",795).
component("U104_",25).
component("U103_",24).
component("YMR271C",877).
component("YML106W",841).
component("YOR209C",990).
component("YMR300C",881).
component("YER055C",456).
component("YDR354W",410) :- not remove_orf("YDR354W",410).
component("YFR047C",501).
component("YJR133W",711).
component("U22_",135).
component("YLR209C",796).
component("YML022W",831).
component("YDR441C",420).
component("YHR128W",608).
component("YPR176C",1082).
component("YPL172C",1035).
component("YNR041C",930).
component("YMR101C",855).
component("YDL090C",329).
component("YBR003W",238).
component("YBR002C",237).
component("YJL167W",683).
component("YJL167W",684).
component("YNL256W",907).
component("YPR069C",1068).
component("YDR127W",383).
component("YHR190W",618).
component("YLR146C",789).
component("YPL214C",1041).
component("YHR068W",600).
component("YLR303W",806).
component("YGR012W",537).
component("YML082W",839).
component("YJR130C",710).
component("YLR303W",807).
component("YDR035W",363).
component("YBR249C",283).
component("YLR180W",794).
component("YDR502C",424).
component("YOR274W",996).
component("YOL143C",959).
component("YBR256C",285).
component("YHR137W",609).
component("YGL202W",528).
component("YLR027C",774).
component("YKL106W",730).
component("YOL140W",958).
component("YLR438W",825).
component("YGR019W",538).
component("YLR089C",784).
component("YDR111C",379).
component("U64_",176).
component("U61_",173).
component("U51_",164).
component("YJR148W",715).
component("YHR208W",621).
component("YFL030W",489).
component("YOR184W",983).
component("YNR058W",934).
component("YIL116W",640).
component("YGL253W",534).
component("YFR053C",502).
component("YOL136C",957).
component("YIL107C",637).
component("YMR013C",848).
component("YMR205C",869).
component("YGR240C",569).
component("YOL016C",938).
component("YFR014C",494).
component("YLR240W",799).
component("YKL203C",748).
component("YJR066W",702).
component("YCR036W",309).
component("YGR194C",562).
component("YCL040W",297).
component("U15_",72).
component("YPL188W",1037).
component("YJR049C",698).
component("YEL041W",438).
component("U96_",208).
component("YKL001C",719).
component("YDR236C",396).
component("YML070W",837).
component("YFL053W",491).
component("YHL032C",583).
component("YDR531W",429).
component("U83_",196).
component("U82_",195).
component("U81_",194).
component("YMR208W",870).
component("YPL203W",1038).
component("YOR061W",964).
component("YKL166C",738).
component("YJL164C",681).
component("YIL035C",627).
component("YHR205W",620).
component("YHR102W",606).
component("YGL019W",511).
component("YHR025W",592).
component("YOR347C",1006).
component("YAL038W",215).
component("YNR012W",924).
component("YPR121W",1076).
component("YPL258C",1049).
component("YOL055C",943).
component("YPL214C",1042).
component("U1_",112).
component("YDR009W",360).
component("YNL267W",911).
component("YLR305C",809).
component("YFR019W",496).
component("YDR208W",393).
component("YDR127W",384).
component("U21_",126).
component("U20_",121).
component("YDR147W",387).
component("YDR300C",404).
component("YCR012W",303).
component("YER052C",454).
component("YER069W",465).
component("U19_",111).
component("YKL024C",722).
component("U18_",100).
component("U17_",89).
component("U76_",188).
component("YMR220W",872).
component("YER170W",482).
component("YDR226W",394).
component("YKL067W",728).
component("YOL055C",944).
component("YDR454C",421).
component("YJR057W",700).
component("YOL061W",948).
component("YKL181W",740).
component("YHL011C",581).
component("YER099C",476).
component("YBL068W",233).
component("YOR143C",979).
component("YNL256W",908).
component("YLR328W",813).
component("YBR018C",241).
component("YBR018C",242).
component("YGR007W",536).
component("YGR202C",564).
component("YLR328W",814).
component("YKR002W",754).
component("YDL045C",319).
component("U80_",193).
component("YDL103C",334).
component("U94_",207).
component("YJR010W",693).
component("YBR029C",247).
component("YCL050C",299).
component("YGL130W",522).
component("YDR530C",428).
component("YCL050C",300).
component("YPR190C",1085).
component("YPR187W",1084).
component("YPR110C",1074).
component("YPR010C",1061).
component("YOR341W",1005).
component("YOR340C",1004).
component("YOR224C",994).
component("YOR210W",991).
component("YOR207C",988).
component("YOR151C",980).
component("YOR116C",972).
component("YOL005C",936).
component("YNR003C",922).
component("YNL248C",906).
component("YNL151C",899).
component("YNL113W",896).
component("YKL144C",734).
component("YJR063W",701).
component("YJL148W",678).
component("YJL140W",677).
component("YIL021W",626).
component("YHR143W-A",610).
component("YGL070C",519).
component("YFL036W",490).
component("YDR404C",415).
component("YDR156W",389).
component("YDR045C",366).
component("YDL150W",344).
component("YDL140C",338).
component("YBR154C",271).
component("YPR175W",1081).
component("YPL167C",1033).
component("YOR330C",1001).
component("YOL115W",955).
component("YNL299W",918).
component("YNL262W",910).
component("YNL102W",894).
component("YJR043C",697).
component("YJR006W",691).
component("YJL090C",668).
component("YIL139C",643).
component("YEL055C",442).
component("YDR419W",418).
component("YDR121W",381).
component("YDL102W",333).
component("YCR014C",304).
component("YBR278W",288).
component("YBL035C",227).
component("YKL035W",725).
component("YHL012W",582).
component("YHR123W",607).
component("YPR113W",1075).
component("YBR243C",280).
component("YDL142C",343).
component("YPL148C",1031).
component("YER026C",451).
component("YGR286C",578).
component("YJL068C",663).
component("YHR189W",617).
component("YDR058C",371).
component("YNR034W",929).
component("YHR163W",613).
component("YGR248W",571).
component("YCR073W-A",312).
component("YDL086W",328).
component("YOL011W",937).
component("YMR008C",846).
component("YMR006C",845).
component("U105_",26).
component("YBL015W",224).
component("YJL068C",664).
component("YPL072W",1025).
component("YOR124C",973).
component("YNL186W",901).
component("YMR304W",883).
component("YMR223W",873).
component("YKR098C",766).
component("YJL197W",685).
component("YIL156W",646).
component("YFR010W",493).
component("YER151C",480).
component("YER144C",479).
component("YER098W",475).
component("YDR069C",373).
component("YDL122W",335).
component("YBR058C",251).
component("YBL067C",232).
component("YJR019C",695).
component("YOR040W",963).
component("U84_",197).
component("U77_",189).
component("YDR481C",422).
component("YLR377C",820).
component("YDR074W",375).
component("YFR025C",497).
component("YPL179W",1036).
component("YNR032W",927).
component("YML057W",836).
component("YML016C",829).
component("YLR433C",824).
component("YGR123C",550).
component("YER133W",478).
component("YER089C",472).
component("YDR436W",419).
component("YDR075W",376).
component("YDL188C",351).
component("YDL134C",337).
component("YDL047W",320).
component("YDL006W",313).
component("YBR125C",266).
component("YBL056W",231).
component("YPR073C",1069).
component("YHR215W",622).
component("YDL024C",316).
component("YBR093C",260).
component("YBR092C",259).
component("YAR071W",220).
component("YIL053W",630).
component("YER062C",462).
component("YHR046C",596).
component("U9_",211).
component("YPL228W",1044).
component("YMR180C",866).
component("YDL236W",356).
component("YJL155C",680).
component("YPR073C",1070).
component("YOR208W",989).
component("YNL053W",891).
component("YMR036C",850).
component("YIR026C",654).
component("YIL113W",639).
component("YFR028C",498).
component("YER075C",468).
component("YDL230W",354).
component("YBR276C",287).
component("U34_",148).
component("U33_",147).
component("U32_",146).
component("U31_",145).
...
component("U25_",138).
component("U24_",137).
component("YHR044C",595).
component("YHR043C",594).
component("YOL064C",949).
component("YPL268W",1053).
component("YOR360C",1009).
component("YGL248W",533).
component("YKR031C",757).
component("YPL206C",1039).
component("YGL027C",513).
component("YLR286C",803).
component("YJR153W",716).
component("YJL221C",690).
component("YJL216C",688).
component("YIL172C",652).
component("YGR292W",580).
component("YGR287C",579).
component("YBR299W",292).
component("YBR184W",274).
component("YIL162W",649).
component("YPR026W",1062).
component("YDR001C",358).
component("YBR001C",236).
component("YIR019C",653).
component("YIL099W",636).
component("YDL037C",318).
component("YOR190W",985).
component("YLR300W",805).
component("YGR282C",577).
component("YDR261C",399).
component("YDR400W",413).
component("U23_",136).
component("YML035C",832).
component("YJL070C",665).
component("YBR284W",289).
component("U106_",27).
component("U102_",23).
component("YER043C",453).
component("YNL045W",889).
component("YGL037C",514).
component("U43_",157).
component("U42_",156).
component("YMR293C",880).
component("YDR242W",397).
component("YLR308W",812).
component("YLR307W",811).
component("YBR208C",276).
component("YMR281W",879).
component("U53_",166).
component("YIR032C",655).
component("YPR062W",1067).
component("YMR120C",860).
component("YLR028C",776).
component("YHR144C",611).
component("YHR144C",612).
component("YGR267C",576).
component("YCL030C",296).
component("YBL033C",226).
component("YBR153W",270).
component("YNL141W",897).
component("YLR245C",800).
component("YML035C",833).
component("YGR204W",566).
component("YBR084W",256).
component("YJL126W",672).
component("U44_",158).
component("YDL100C",332).
component("U87_",199).
component("U40_",154).
component("U39_",152).
component("YBR011C",240).
component("YHR201C",619).
component("YBR111C",261).
component("YBR252W",284).
component("YEL042W",439).
component("YPR080W",1072).
component("YOR187W",984).
component("YOR133W",976).
component("YLR069C",782).
component("YKR084C",763).
component("YKL173W",739).
component("YJL102W",670).
component("YDR385W",412).
component("YBR118W",264).
component("YER005W",447).
component("YLL001W",767).
component("YIL048W",629).
component("YER166W",481).
component("YDR093W",378).
component("YAL026C",214).
component("YBL099W",235).
component("U60_",172).
component("YLR231C",797).
component("U88_",200).
component("YDR538W",431).
component("YLR134W",786).
component("YLR044C",778).
component("YGR087C",546).
component("YDR380W",411).
component("YDL080C",325).
component("U98_",209).
component("YMR250W",875).
component("YKL184W",744).
component("YOR128C",974).
component("YEL021W",436).
component("YNR043W",931).
component("U93_",206).
component("YDR047W",368).
component("U54_",167).
component("YKL211C",750) :- not remove_orf("YKL211C",750).
component("YKR097W",765).
component("YOL052C",942).
component("YNL169C",900).
component("YGR170W",555).
component("YKL060C",727).
component("YNL256W",909).
component("YDR294C",402).
component("YEL046C",440).
component("YNR033W",928).
component("YPR006C",1060).
component("YER065C",463).
component("YKL211C",751) :- not remove_orf("YKL211C",751).
component("YER090W",751) :- not remove_orf("YER090W",751).
component("YER090W",473) :- not remove_orf("YER090W",473).
component("YDR127W",385).
component("YPL281C",1057).
component("YOR393W",1016).
component("YMR323W",885).
component("YHR174W",614).
component("YGR254W",572).
component("YOR202W",987).
component("YPL262W",1050).
component("YGL026C",512) :- not remove_orf("YGL026C",512).
component("YGR155W",553).
component("YLR304C",808).
component("YJL200C",686).
component("YGL009C",507).
component("YNL316C",919).
component("YKL182W",742).
component("YPL212C",1040).
component("YNL292W",917).
component("YGL063W",518).
component("YFL001W",485).
component("YOR278W",997).
component("YPR002W",1059).
component("YJR016C",694).
component("YCR053W",311).
component("YDR127W",386).
component("YGL148W",523).
component("YIL168W",651).
component("YIL167W",650).
component("YCL064C",301).
component("YER086W",470).
component("YLR359W",819).
component("YAL012W",212).
component("YML004C",827).
component("YFR055W",503).
component("YJL005W",659).
component("YJL121C",671).
component("YBR019C",243).
component("YBR019C",244).
component("U59_",170).
component("YDR050C",369).
component("YIL020C",625).
component("YDR007W",359) :- not remove_orf("YDR007W",359).
component("YOR095C",969).
component("YER003C",446).
component("YBR196C",275).
component("YGL001C",505).
component("YPL117C",1029).
component("U14_",64).
component("YOL056W",945).
component("YKL152C",737).
component("YDL021W",314).
component("YMR105C",856).
component("YKL127W",732).
component("YEL058W",443).
component("YPR060C",1066).
component("YHR072W",601).
component("YJL153C",679).
component("YPL097W",1027).
component("YGR185C",560).
component("YGR264C",575).
component("YGR171C",556).
component("YHR011W",588).
component("YDR023W",362).
component("YPL104W",1028).
component("YLL018C",768).
component("YPR081C",1073).
component("YBR121C",265).
component("YHR020W",591).
component("YER087W",471).
component("YNL247W",905).
component("YOL033W",940).
component("YGL245W",532).
component("YOR168W",981).
component("YOL097C",953).
component("YDR268W",400).
component("YPR047W",1065).
component("YLR060W",781).
component("YFL022C",488).
component("YPR033C",1063).
component("YHR019C",589).
component("YCR024C",305).
component("YHR019C",590).
component("YKL194C",747).
component("YIL078W",633).
component("YPL160W",1032).
component("YLR382C",821).
component("YPL040C",1022).
component("YBL076C",234).
component("YNL073W",893).
component("YDR037W",364).
component("YOR335C",1002).
component("YGR094W",548).
component("YLR153C",790).
component("YAL054C",216).
component("YOR317W",998).
component("YMR246W",874).
component("YIL009W",624).
component("YER015W",449).
component("YOR142W",978).
component("YGR244C",570).
component("YPR035W",1064).
component("YIL145C",644).
component("U89_",201).
component("YOR339C",1003).
component("YMR022W",849).
component("YLR306W",810).
component("YKL210W",749).
component("YGR133W",552).
component("YGL058W",516).
component("YER100W",477).
component("YEL012W",434).
component("YDR177W",391).
component("YDR092W",377).
component("YDR059C",372).
component("YDR054C",370).
component("YDL064W",322).
component("YBR082C",254).
component("YJL101C",669).
component("YOL049W",941).
component("U92_",205).
component("YAR015W",218).
component("YGL234W",530).
component("YER183C",484).
component("U91_",204).
component("U90_",203).
component("YNR057C",933).
component("YDL141W",339).
component("YDL141W",340).
component("YGL234W",531).
component("YDL141W",341).
component("YJR103W",707).
component("YBL039C",228).
component("YGR204W",567).
component("YBR084W",257).
component("YNL220W",903).
component("YOL058W",946).
component("YBR208C",277).
component("YDL141W",342).
component("YHR074W",602).
component("YMR217W",871).
component("YGR061C",544).
component("YPR145W",1078).
component("YGR124W",551).
component("YJR109C",709).
component("YJL130C",675).
component("YGL062W",517).
component("YBR218C",278).
component("YPL231W",1048).
component("YNR016C",925).
component("YKL182W",743).
component("YGR037C",540).
component("YJL087C",666).
component("YPR138C",1077).
component("YPL265W",1051).
component("YPL134C",1030).
component("YPL057C",1023).
component("YPL036W",1021).
component("YOR348C",1007).
component("YOR222W",993).
component("YOR192C",986).
component("YOR171C",982).
component("YOR130C",975).
component("YOR100C",970).
component("YOR071C",966).
component("YOR011W",962).
component("YOL156W",961).
component("YOL103W",954).
component("YOL020W",939) :- not remove_orf("YOL020W",939).
component("YNR072W",935).
component("YNR056C",932).
component("YNL318C",920).
component("YNL270C",913).
component("YNL268W",912).
component("YNL142W",898).
component("YMR272C",878).
component("YMR202W",868).
component("YMR056C",851).
component("YMR011W",847).
component("YLR348C",816).
component("YLR260W",802).
component("YLR237W",798).
component("YLR138W",787).
component("YLR100C",785).
component("YLR081W",783).
component("YLL061W",772).
component("YLL043W",770).
component("YKR093W",764).
component("YKR053C",759).
component("YKR039W",758) :- not remove_orf("YKR039W",758).
component("YKL217W",753).
component("YKL120W",731).
component("YKL004W",720).
component("YJR158W",717).
component("YJR095W",706).
component("YJR077C",704).
component("YJL219W",689).
component("YJL214W",687).
component("YJL134W",676).
component("YJL129C",673).
component("YIL134W",642).
component("YHR096C",605).
component("YHR094C",604).
component("YHR092C",603).
component("YHL036W",584).
component("YGR121C",549).
component("YGR065C",545).
component("YGR055W",542).
component("YGL186C",525).
component("YGL077C",520).
component("YGL008C",506).
component("YFL055W",492).
component("YFL011W",486).
component("YER060W-A",459).
component("YER060W",458).
component("YER056C",457).
component("YER053C",455).
component("YEL069C",445).
component("YEL063C",444).
component("YEL017C-A",435).
component("YDR536W",430).
component("YDR508C",426).
component("YDR503C",425).
component("YDR497C",423).
component("YDR345C",408).
component("YDR343C",407).
component("YDR342C",406).
component("YDR297W",403).
component("YDR284C",401).
component("YDR046C",367) :- not remove_orf("YDR046C",367).
component("YDL245C",357).
component("YDL210W",352).
component("YCR032W",308).
component("YCR028C",307).
component("YCR024C-A",306).
component("YCL025C",295).
component("YBR298C",291).
component("YBR291C",290).
component("YBR085W",258).
component("YBR069C",253) :- not remove_orf("YBR069C",253).
component("YBR068C",252) :- not remove_orf("YBR068C",252).
component("YBR036C",249).
component("YBR021W",245).
component("YBL042C",229).
component("YBL030C",225).
component("U85_",198).
component("U7_",192).
component("U79_",191).
component("U78_",190).
...
catalyst(6160,881).
catalyst(3870,456).
catalyst(3620,410) :- not remove_reaction(3620,410).
catalyst(2110,501).
catalyst(2190,501).
catalyst(5550,711).
catalyst(5301,135).
...
catalyst(1960,368).
catalyst(3460,167).
catalyst(3600,750) :- not remove_reaction(3600,750).
catalyst(8000,765).
catalyst(3941,942).
catalyst(3942,942).
catalyst(6890,900).
...
catalyst(8020,1060).
catalyst(8020,463).
catalyst(1890,751) :- not remove_reaction(1890,751).
catalyst(3630,751) :- not remove_reaction(3630,751).
catalyst(1890,473) :- not remove_reaction(1890,473).
catalyst(3630,473) :- not remove_reaction(3630,473).
catalyst(3740,385).
catalyst(8231,1057).
catalyst(8232,1057).
catalyst(8231,1016).
...
catalyst(8061,1050).
catalyst(8062,1050).
catalyst(3590,512) :- not remove_reaction(3590,512).
catalyst(10910,512) :- not remove_reaction(10910,512).
catalyst(4570,553).
catalyst(8181,808).
catalyst(8182,808).
catalyst(8181,686).
...
catalyst(8282,369).
catalyst(3840,625).
catalyst(3610,359) :- not remove_reaction(3610,359).
catalyst(7921,969).
catalyst(7922,969).
catalyst(7841,446).
catalyst(7842,446).
...
catalyst(1210,961).
catalyst(1160,954).
catalyst(801,939) :- not remove_reaction(801,939).
catalyst(802,939) :- not remove_reaction(802,939).
catalyst(811,939) :- not remove_reaction(811,939).
catalyst(812,939) :- not remove_reaction(812,939).
catalyst(831,939) :- not remove_reaction(831,939).
catalyst(832,939) :- not remove_reaction(832,939).
catalyst(901,939) :- not remove_reaction(901,939).
catalyst(902,939) :- not remove_reaction(902,939).
catalyst(1180,935).
catalyst(1210,935).
catalyst(700,932).
catalyst(1200,920).
...
catalyst(650,764).
catalyst(6560,759).
catalyst(681,758) :- not remove_reaction(681,758).
catalyst(682,758) :- not remove_reaction(682,758).
catalyst(761,758) :- not remove_reaction(761,758).
catalyst(762,758) :- not remove_reaction(762,758).
catalyst(771,758) :- not remove_reaction(771,758).
catalyst(772,758) :- not remove_reaction(772,758).
catalyst(781,758) :- not remove_reaction(781,758).
catalyst(782,758) :- not remove_reaction(782,758).
catalyst(791,758) :- not remove_reaction(791,758).
catalyst(792,758) :- not remove_reaction(792,758).
catalyst(801,758) :- not remove_reaction(801,758).
catalyst(802,758) :- not remove_reaction(802,758).
catalyst(811,758) :- not remove_reaction(811,758).
catalyst(812,758) :- not remove_reaction(812,758).
catalyst(831,758) :- not remove_reaction(831,758).
catalyst(832,758) :- not remove_reaction(832,758).
catalyst(841,758) :- not remove_reaction(841,758).
catalyst(842,758) :- not remove_reaction(842,758).
catalyst(851,758) :- not remove_reaction(851,758).
catalyst(852,758) :- not remove_reaction(852,758).
catalyst(881,758) :- not remove_reaction(881,758).
catalyst(882,758) :- not remove_reaction(882,758).
catalyst(901,758) :- not remove_reaction(901,758).
catalyst(902,758) :- not remove_reaction(902,758).
catalyst(911,758) :- not remove_reaction(911,758).
catalyst(912,758) :- not remove_reaction(912,758).
catalyst(921,758) :- not remove_reaction(921,758).
catalyst(922,758) :- not remove_reaction(922,758).
catalyst(931,758) :- not remove_reaction(931,758).
catalyst(932,758) :- not remove_reaction(932,758).
catalyst(1191,758) :- not remove_reaction(1191,758).
catalyst(1192,758) :- not remove_reaction(1192,758).
catalyst(390,753).
catalyst(1021,753).
catalyst(1022,753).
catalyst(1521,731).
...
catalyst(6650,403).
catalyst(6690,401).
catalyst(791,367) :- not remove_reaction(791,367).
catalyst(792,367) :- not remove_reaction(792,367).
catalyst(801,367) :- not remove_reaction(801,367).
catalyst(802,367) :- not remove_reaction(802,367).
catalyst(811,367) :- not remove_reaction(811,367).
catalyst(812,367) :- not remove_reaction(812,367).
catalyst(831,367) :- not remove_reaction(831,367).
catalyst(832,367) :- not remove_reaction(832,367).
catalyst(841,367) :- not remove_reaction(841,367).
catalyst(842,367) :- not remove_reaction(842,367).
catalyst(851,367) :- not remove_reaction(851,367).
catalyst(852,367) :- not remove_reaction(852,367).
catalyst(901,367) :- not remove_reaction(901,367).
catalyst(902,367) :- not remove_reaction(902,367).
catalyst(1180,357).
catalyst(1210,357).
catalyst(690,352).
catalyst(730,352).
...
catalyst(851,253) :- not remove_reaction(851,253).
catalyst(852,253) :- not remove_reaction(852,253).
...
catalyst(851,252) :- not remove_reaction(851,252).
catalyst(852,252) :- not remove_reaction(852,252).
...
modifiable_enzyme(410).
modifiable_enzyme(750).
modifiable_enzyme(751).
modifiable_enzyme(473).
modifiable_enzyme(512).
modifiable_enzyme(359).
modifiable_enzyme(939).
modifiable_enzyme(758).
modifiable_enzyme(367).
