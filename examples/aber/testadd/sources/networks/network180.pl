...
component("YNL280C",919).
component("YLR056W",783).
component("YGR060W",546).
component("YGL012W",511).
component("YKR009C",759).
component("YOL086C",954).
component("YMR303C",886).
component("YMR083W",858).
component("YGL256W",538).
component("YDL168W",348).
component("YBR145W",269).
component("YPL231W",1049).
component("YBR265W",288).
component("U46_",161).
component("YBR149W",270).
component("YBR149W",271).
component("YJR159W",722).
component("YGL001C",507).
component("YIL094C",638).
component("YHR063C",601).
component("U45_",160).
component("YML056C",839).
component("YLR432W",827).
component("YHR216W",626).
component("YAR075W",224).
component("YAR073W",223).
component("YDR127W",385).
component("YJR139C",717).
component("YML075C",842).
component("YLR450W",830).
component("YOL126C",960).
component("YKL085W",733).
component("YDL078C",327).
component("YKL029C",728).
component("YOR136W",981).
component("YNL037C",892).
component("YNL009W",890).
component("YLR174W",797).
component("YHR183W",619).
component("YGR256W",577).
component("YNL241C",908).
component("YOL059W",951).
component("YDL022W",318).
component("YCL018W",297).
component("YLR355C",822).
component("YIL074C",635).
component("YER081W",472).
component("YML054C",838).
component("YDL174C",352).
component("YML086C",844).
component("YIL155C",648).
component("YPR191W",1090).
component("YOR065W",969).
component("YJL166W",686).
component("YHR001W-A",588).
component("YGR183C",562).
component("YFR033C",503).
component("YEL024W",440).
component("YDR529C",430).
component("YBL045C",232).
component("Q0105",19).
component("YKR066C",764).
component("YGR088W",550).
component("YDR256C",401).
component("YKL026C",727).
component("YIR037W",661).
component("YBR244W",283).
component("YJR078W",709).
component("U58_",170).
component("YJR025C",700).
component("U107_",28).
component("YGR255C",576).
component("U108_",29).
component("YHR007C",589).
component("YDR402C",417).
component("YGL055W",518).
component("YJR104C",712).
component("YHR008C",590).
component("YOR384W",1018).
component("YOR381W",1017).
component("YOL152W",964).
component("YLL051C",775).
component("YJL026W",664).
component("YIL066C",634).
component("YGR180C",561).
component("YER070W",469).
component("U37_",152).
component("U36_",151).
component("U35_",150).
component("YDL168W",349).
component("YDR158W",393).
component("YJR009C",696).
component("YJL052W",666).
component("YGR192C",564).
component("YBR006W",241).
component("YPL276W",1060).
component("YPL275W",1059).
component("YOR388C",1019).
component("YPL061W",1028).
component("YOR374W",1014).
component("YER073W",470).
component("YGL154C",527).
component("YBR115C",264).
component("U55_",169).
component("YER069W",467).
component("YOR323C",1004).
component("YMR170C",869).
component("YMR169C",868).
component("U2_",144).
component("YER178W",486).
component("YBR221C",281).
component("YIL125W",644).
component("U52_",166).
component("YBR166C",274).
component("YNL280C",920).
component("YGL012W",512).
component("YKL182W",745).
component("YKL216W",756).
component("YDR044W",368).
component("YER014W",451).
component("YKR009C",760).
component("YIL160C",650).
component("YGL205W",532).
component("YMR118C",862).
component("YLR164W",795).
component("YLL041C",773).
component("YKL148C",739).
component("YKL141W",737).
component("YJL045W",665).
component("YDR178W",395).
component("YJR051W",703).
component("YEL047C",444).
component("YDL171C",350).
component("YDL171C",351).
component("YOR375C",1015).
component("YDL215C",356).
component("YAL062W",219).
component("U99_",212).
component("U100_",22).
component("YBR035C",250).
component("YMR189W",871).
component("YKR080W",766).
component("YER023W",453).
component("YPL023C",1023).
component("YGL125W",524).
component("YOR236W",999).
component("YGR204W",568).
component("YBR084W",257).
component("YIR034C",660).
component("YLR142W",792).
component("U65_",178).
component("U63_",176).
component("U62_",175).
component("YOR356W",1012).
component("YHR068W",602).
component("YKL150W",740).
component("YIL043C",631).
component("YHR042W",596).
component("YOR221C",996).
component("YMR145C",865).
component("YML120C",846).
component("YKL192C",749).
component("YKL055C",730).
component("YER061C",463).
component("YDL085W",329).
component("YPL171C",1038).
component("YHR179W",618).
component("YMR145C",866).
component("YML120C",847).
component("YKL192C",750).
component("YDL085W",330).
component("YGR234W",571).
component("YFR030W",502).
component("YPL017C",1022).
component("YFL018C",490).
component("YPL091W",1030).
component("YDR353W",412).
component("YER042W",455).
component("YPR167C",1084).
component("YJR137C",716).
component("YNL052W",894).
component("YMR256C",880).
component("YLR395C",826).
component("YLR038C",781).
component("YIL111W",641).
component("YHR051W",600).
component("YGL191W",530).
component("YGL187C",529).
component("YDL067C",326).
component("Q0275",21).
component("Q0250",20).
component("Q0045",18).
component("YDR072C",377).
component("YPL266W",1056).
component("YPL273W",1058).
component("YLL062C",777).
component("YDR410C",420).
component("YKR069W",765).
component("YOL096C",955).
component("U47_",162).
component("YER091C",477).
component("YJR073C",707).
component("YGR157W",557).
component("YDR120C",383).
component("YML008C",832).
component("YOR074C",971).
component("YDL033C",320).
component("YOL096C",956).
component("YLR172C",796).
component("YLR058C",784).
component("YDR019C",364).
component("YBR176W",275).
component("YDR408C",419).
component("YMR120C",863).
component("YLR028C",779).
component("YBL013W",225).
component("YJL130C",678).
component("YJL088W",671).
component("YKL024C",725).
component("YPR074C",1075).
component("YBR117C",265).
component("YLR354C",821).
component("YGR043C",544).
component("YMR108W",861).
component("YCL009C",296).
component("YMR062C",856).
component("YNL071W",896).
component("YNR008W",927).
component("YIL160C",651).
component("YNR019W",930).
component("YCR048W",313).
component("U48_",163).
component("YNL277W",918).
component("YMR062C",857).
component("YDR232W",398).
component("YPL231W",1050).
component("YER061C",464).
component("U86_",200).
component("YPL001W",1021).
component("YDL052C",324).
component("U8_",204).
component("YDR148C",391).
component("YAR035W",221).
component("YOR377W",1016).
component("YGR177C",560).
component("YPL231W",1051).
component("YPL028W",1024).
component("YLR299W",808).
component("YGL017W",513).
component("YPR001W",1062).
component("YNR001C",925).
component("YCR005C",305).
component("YML126C",848).
component("YNL104C",899).
component("YDL182W",353).
component("YDL131W",339).
component("YPR160W",1083).
component("YOR321W",1003).
component("YJR143C",718).
component("YGR199W",566).
component("YDR307W",408).
component("YDL095W",334).
component("YDL093W",333).
component("YAL023C",215).
component("YLR258W",805).
component("YFR015C",498).
component("YPL227C",1047).
component("YOR103C",975).
component("YOR085W",972).
component("YMR149W",867).
component("YML019W",834).
component("YJL002C",662).
component("YEL002C",435).
component("YDL232W",358).
component("YCL043C",301).
component("YNL029C",891).
component("YIL085C",637).
component("YNL192W",906).
component("YBR038W",252).
component("YBR023C",248).
component("YEL011W",436).
component("YMR306W",888).
component("YLR342W",819).
component("YGR032W",542).
component("YPR183W",1087).
component("YBR248C",284).
component("YLR209C",799).
component("U104_",25).
component("U103_",24).
component("YMR271C",881).
component("YML106W",845).
component("YOR209C",994).
component("YMR300C",885).
component("YER055C",459).
component("YDR354W",413) :- not remove_orf("YDR354W",413).
component("YFR047C",504).
component("YJR133W",715).
component("U22_",136).
component("YLR209C",800).
component("YML022W",835).
component("YDR441C",423).
component("YHR128W",611).
component("YPR176C",1086).
component("YPL172C",1039).
component("YNR041C",934).
component("YMR101C",859).
component("YDL090C",332).
component("YBR003W",240).
component("YBR002C",239).
component("YJL167W",687).
component("YJL167W",688).
component("YNL256W",911).
component("YPR069C",1072).
component("YDR127W",386).
component("YHR190W",621).
component("YLR146C",793).
component("YPL214C",1045).
component("YHR068W",603).
component("YLR303W",810).
component("YGR012W",540).
component("YML082W",843).
component("YJR130C",714).
component("YLR303W",811).
component("YDR035W",366).
component("YBR249C",285).
component("YLR180W",798).
component("YDR502C",427).
component("YOR274W",1000).
component("YOL143C",963).
component("YBR256C",287).
component("YHR137W",612).
component("YGL202W",531).
component("YLR027C",778).
component("YKL106W",734).
component("YOL140W",962).
component("YLR438W",829).
component("YGR019W",541).
component("YLR089C",788).
component("YDR111C",382).
component("U64_",177).
component("U61_",174).
component("U51_",165).
component("YJR148W",719).
component("YHR208W",624).
component("YFL030W",492).
component("YOR184W",987).
component("YNR058W",938).
component("YIL116W",643).
component("YGL253W",537).
component("YFR053C",505).
component("YOL136C",961).
component("YIL107C",640).
component("YMR013C",852).
component("YMR205C",873).
component("YGR240C",572).
component("YOL016C",942).
component("YFR014C",497).
component("YLR240W",803).
component("YKL203C",752).
component("YJR066W",706).
component("YCR036W",312).
component("YGR194C",565).
component("YCL040W",300).
component("U15_",72).
component("YPL188W",1041).
component("YJR049C",702).
component("YEL041W",441).
component("U96_",210).
component("YKL001C",723).
component("YDR236C",399).
component("YML070W",841).
component("YFL053W",494).
component("YHL032C",586).
component("YDR531W",432).
component("U83_",197).
component("U82_",196).
component("U81_",195).
component("YMR208W",874).
component("YPL203W",1042).
component("YOR061W",968).
component("YKL166C",742).
component("YJL164C",685).
component("YIL035C",630).
component("YHR205W",623).
component("YHR102W",609).
component("YGL019W",514).
component("YHR025W",595).
component("YOR347C",1010).
component("YAL038W",217).
component("YNR012W",928).
component("YPR121W",1080).
component("YPL258C",1053).
component("YOL055C",947).
component("YPL214C",1046).
component("U1_",112).
component("YDR009W",363).
component("YNL267W",915).
component("YLR305C",813).
component("YFR019W",499).
component("YDR208W",396).
component("YDR127W",387).
component("U21_",127).
component("U20_",122).
component("YDR147W",390).
component("YDR300C",407).
component("YCR012W",306).
component("YER052C",457).
...
component("U17_",89).
component("U76_",189).
component("YMR220W",876).
component("YER170W",485).
component("YDR226W",397).
component("YKL067W",732).
component("YOL055C",948).
component("YDR454C",424).
component("YJR057W",704).
component("YOL061W",952).
component("YKL181W",744).
component("YHL011C",584).
component("YER099C",479).
component("YBL068W",235).
component("YOR143C",983).
component("YNL256W",912).
component("YLR328W",817).
component("YBR018C",243).
component("YBR018C",244).
component("YGR007W",539).
component("YGR202C",567).
component("YLR328W",818).
component("YKR002W",758).
component("YDL045C",322).
component("U80_",194).
component("YDL103C",337).
component("U94_",209).
component("YJR010W",697).
component("YBR029C",249).
component("YCL050C",302).
component("YGL130W",525).
component("YDR530C",431).
component("YCL050C",303).
component("YPR190C",1089).
component("YPR187W",1088).
component("YPR110C",1078).
component("YPR010C",1065).
component("YOR341W",1009).
component("YOR340C",1008).
component("YOR224C",998).
component("YOR210W",995).
component("YOR207C",992).
component("YOR151C",984).
component("YOR116C",976).
component("YOL005C",940).
component("YNR003C",926).
component("YNL248C",910).
component("YNL151C",903).
component("YNL113W",900).
component("YKL144C",738).
component("YJR063W",705).
component("YJL148W",682).
component("YJL140W",681).
component("YIL021W",629).
component("YHR143W-A",613).
component("YGL070C",522).
component("YFL036W",493).
component("YDR404C",418).
component("YDR156W",392).
component("YDR045C",369).
component("YDL150W",347).
component("YDL140C",341).
component("YBR154C",273).
component("YPR175W",1085).
component("YPL167C",1037).
component("YOR330C",1005).
component("YOL115W",959).
component("YNL299W",922).
component("YNL262W",914).
component("YNL102W",898).
component("YJR043C",701).
component("YJR006W",695).
component("YJL090C",672).
component("YIL139C",646).
component("YEL055C",445).
component("YDR419W",421).
component("YDR121W",384).
component("YDL102W",336).
component("YCR014C",307).
component("YBR278W",290).
component("YBL035C",229).
component("YKL035W",729).
component("YHL012W",585).
component("YHR123W",610).
component("YPR113W",1079).
component("YBR243C",282).
component("YDL142C",346).
component("YPL148C",1035).
component("YER026C",454).
component("YCL004W",295).
component("YGR286C",581).
component("YJL068C",667).
component("YHR189W",620).
component("YDR058C",374).
component("YNR034W",933).
component("YHR163W",616).
component("YGR248W",574).
component("YCR073W-A",315).
component("YDL086W",331).
component("YOL011W",941).
component("YMR008C",850).
component("YMR006C",849).
component("U105_",26).
component("YBL015W",226).
component("YJL068C",668).
component("YPL072W",1029).
component("YOR124C",977).
component("YNL186W",905).
component("YMR304W",887).
component("YMR223W",877).
component("YKR098C",770).
component("YJL197W",689).
component("YIL156W",649).
component("YFR010W",496).
component("YER151C",483).
component("YER144C",482).
component("YER098W",478).
component("YDR069C",376).
component("YDL122W",338).
component("YBR058C",253).
component("YBL067C",234).
component("YJR019C",699).
component("YOR040W",967).
component("U84_",198).
component("U77_",190).
component("YDR481C",425).
component("YLR377C",824).
component("YDR074W",378).
component("YFR025C",500).
component("YPL179W",1040).
component("YNR032W",931).
component("YML057W",840).
component("YML016C",833).
component("YLR433C",828).
component("YGR123C",553).
component("YER133W",481).
component("YER089C",475).
component("YDR436W",422).
component("YDR075W",379).
component("YDL188C",354).
component("YDL134C",340).
component("YDL047W",323).
component("YDL006W",316).
component("YBR125C",268).
component("YBL056W",233).
component("YPR073C",1073).
component("YHR215W",625).
component("YDL024C",319).
component("YBR093C",262).
component("YBR092C",261).
component("YAR071W",222).
component("YIL053W",633).
component("YER062C",465).
component("YHR046C",599).
component("U9_",213).
component("YPL228W",1048).
component("YMR180C",870).
component("YDL236W",359).
component("YJL155C",684).
component("YPR073C",1074).
component("YOR208W",993).
component("YNL053W",895).
component("YMR036C",854).
component("YIR026C",657).
component("YIL113W",642).
component("YFR028C",501).
component("YER075C",471).
component("YDL230W",357).
component("YBR276C",289).
component("U34_",149).
component("U33_",148).
component("U32_",147).
component("U31_",146).
...
component("U25_",139).
component("U24_",138).
component("YHR044C",598).
component("YHR043C",597).
component("YOL064C",953).
component("YPL268W",1057).
component("YOR360C",1013).
component("YGL248W",536).
component("YKR031C",761).
component("YPL206C",1043).
component("YGL027C",516).
component("YLR286C",807).
component("YJR153W",720).
component("YJL221C",694).
component("YJL216C",692).
component("YIL172C",655).
component("YGR292W",583).
component("YGR287C",582).
component("YBR299W",294).
component("YBR184W",276).
component("YIL162W",652).
component("YPR026W",1066).
component("YDR001C",361).
component("YBR001C",238).
component("YIR019C",656).
component("YIL099W",639).
component("YDL037C",321).
component("YOR190W",989).
component("YLR300W",809).
component("YGR282C",580).
component("YDR261C",402).
component("YDR400W",416).
component("U23_",137).
component("YML035C",836).
component("YJL070C",669).
component("YBR284W",291).
component("U106_",27).
component("U102_",23).
component("YER043C",456).
component("YNL045W",893).
component("YGL037C",517).
component("U43_",158).
component("U42_",157).
component("YMR293C",884).
component("YDR242W",400).
component("YLR308W",816).
component("YLR307W",815).
component("YBR208C",278).
component("YMR281W",883).
component("U53_",167).
component("YIR032C",659).
component("YIR029W",658).
component("YPR062W",1071).
component("YMR120C",864).
component("YLR028C",780).
component("YHR144C",614).
component("YHR144C",615).
component("YGR267C",579).
component("YCL030C",299).
component("YBL033C",228).
component("YBR153W",272).
component("YNL141W",901).
component("YLR245C",804).
component("YML035C",837).
component("YGR204W",569).
component("YBR084W",258).
component("YJL126W",676).
component("U44_",159).
component("YDL100C",335).
component("U87_",201).
component("U40_",155).
component("U39_",153).
component("YBR011C",242).
component("YHR201C",622).
component("YBR111C",263).
component("YBR252W",286).
component("YEL042W",442).
component("YPR080W",1076).
component("YOR187W",988).
component("YOR133W",980).
component("YLR069C",786).
component("YKR084C",767).
component("YKL173W",743).
component("YJL102W",674).
component("YDR385W",415).
component("YBR118W",266).
component("YER005W",450).
component("YLL001W",771).
component("YIL048W",632).
component("YER166W",484).
component("YDR093W",381).
component("YAL026C",216).
component("YBL099W",237).
component("U60_",173).
component("YLR231C",801).
component("U88_",202).
component("YDR538W",434).
component("YLR134W",790).
component("YLR044C",782).
component("YGR087C",549).
component("YDR380W",414).
component("YDL080C",328).
component("U98_",211).
component("YMR250W",879).
component("YKL184W",748).
component("YOR128C",978).
component("YEL021W",439).
component("YNR043W",935).
component("U93_",208).
component("YDR047W",371).
component("U54_",168).
component("YKL211C",754) :- not remove_orf("YKL211C",754).
component("YKR097W",769).
component("YOL052C",946).
component("YNL169C",904).
component("YGR170W",558).
component("YKL060C",731).
component("YNL256W",913).
component("YDR294C",405).
component("YEL046C",443).
component("YNR033W",932).
component("YPR006C",1064).
component("YER065C",466).
component("YKL211C",755) :- not remove_orf("YKL211C",755).
component("YER090W",755) :- not remove_orf("YER090W",755).
component("YER090W",476) :- not remove_orf("YER090W",476).
component("YDR127W",388).
component("YPL281C",1061).
component("YOR393W",1020).
component("YMR323W",889).
component("YHR174W",617).
component("YGR254W",575).
component("YOR202W",991).
component("YPL262W",1054).
component("YGL026C",515) :- not remove_orf("YGL026C",515).
component("YGR155W",556).
component("YLR304C",812).
component("YJL200C",690).
component("YGL009C",510).
component("YNL316C",923).
component("YKL182W",746).
component("YPL212C",1044).
component("YNL292W",921).
component("YGL063W",521).
component("YFL001W",488).
component("YOR278W",1001).
component("YPR002W",1063).
component("YJR016C",698).
component("YCR053W",314).
component("YDR127W",389).
component("YGL148W",526).
component("YIL168W",654).
component("YIL167W",653).
component("YCL064C",304).
component("YER086W",473).
component("YLR359W",823).
component("YAL012W",214).
component("YML004C",831).
component("YFR055W",506).
component("YJL005W",663).
component("YJL121C",675).
component("YBR019C",245).
component("YBR019C",246).
component("U59_",171).
component("YDR050C",372).
component("YIL020C",628).
component("YDR007W",362) :- not remove_orf("YDR007W",362).
component("YOR095C",973).
component("YER003C",449).
component("YBR196C",277).
component("YGL001C",508).
component("YPL117C",1033).
component("U14_",64).
component("YOL056W",949).
component("YKL152C",741).
component("YDL021W",317).
component("YMR105C",860).
component("YKL127W",736).
component("YEL058W",446).
component("YPR060C",1070).
component("YHR072W",604).
component("YJL153C",683).
component("YPL097W",1031).
component("YGR185C",563).
component("YGR264C",578).
component("YGR171C",559).
component("YHR011W",591).
component("YDR023W",365).
component("YPL104W",1032).
component("YLL018C",772).
component("YPR081C",1077).
component("YBR121C",267).
component("YHR020W",594).
component("YER087W",474).
component("YNL247W",909).
component("YOL033W",944).
component("YGL245W",535).
component("YOR168W",985).
component("YOL097C",957).
component("YDR268W",403).
component("YPR047W",1069).
component("YLR060W",785).
component("YFL022C",491).
component("YPR033C",1067).
component("YHR019C",592).
component("YCR024C",308).
component("YHR019C",593).
component("YKL194C",751).
component("YIL078W",636).
component("YPL160W",1036).
component("YLR382C",825).
component("YPL040C",1026).
component("YBL076C",236).
component("YNL073W",897).
component("YDR037W",367).
component("YOR335C",1006).
component("YGR094W",551).
component("YLR153C",794).
component("YAL054C",218).
component("YOR317W",1002).
component("YMR246W",878).
component("YIL009W",627).
component("YER015W",452).
component("YOR142W",982).
component("YGR244C",573).
component("YPR035W",1068).
component("YIL145C",647).
component("U89_",203).
component("YOR339C",1007).
component("YMR022W",853).
component("YLR306W",814).
component("YKL210W",753).
component("YGR133W",555).
component("YGL058W",519).
component("YER100W",480).
component("YEL012W",437).
component("YDR177W",394).
component("YDR092W",380).
component("YDR059C",375).
component("YDR054C",373).
component("YDL064W",325).
component("YBR082C",256).
component("YJL101C",673).
component("YOL049W",945).
component("U92_",207).
component("YAR015W",220).
component("YGL234W",533).
component("YER183C",487).
component("U91_",206).
component("U90_",205).
component("YNR057C",937).
component("YDL141W",342).
component("YDL141W",343).
component("YGL234W",534).
component("YDL141W",344).
component("YJR103W",711).
component("YBL039C",230).
component("YGR204W",570).
component("YBR084W",259).
component("YNL220W",907).
component("YOL058W",950).
component("YBR208C",279).
component("YDL141W",345).
component("YHR074W",605).
component("YMR217W",875).
component("YGR061C",547).
component("YPR145W",1082).
component("YGR124W",554).
component("YJR109C",713).
component("YJL130C",679).
component("YGL062W",520).
component("YBR218C",280).
component("YPL231W",1052).
component("YNR016C",929).
component("YKL182W",747).
component("YGR037C",543).
component("YJL087C",670).
component("YPR138C",1081).
component("YPL265W",1055).
component("YPL134C",1034).
component("YPL057C",1027).
component("YPL036W",1025).
component("YOR348C",1011).
component("YOR222W",997).
component("YOR192C",990).
component("YOR171C",986).
component("YOR130C",979).
component("YOR100C",974).
component("YOR071C",970).
component("YOR011W",966).
component("YOL156W",965).
component("YOL103W",958).
component("YOL020W",943) :- not remove_orf("YOL020W",943).
component("YNR072W",939).
component("YNR056C",936).
component("YNL318C",924).
component("YNL270C",917).
component("YNL268W",916).
component("YNL142W",902).
component("YMR272C",882).
component("YMR202W",872).
component("YMR056C",855).
component("YMR011W",851).
component("YLR348C",820).
component("YLR260W",806).
component("YLR237W",802).
component("YLR138W",791).
component("YLR100C",789).
component("YLR081W",787).
component("YLL061W",776).
component("YLL043W",774).
component("YKR093W",768).
component("YKR053C",763).
component("YKR039W",762) :- not remove_orf("YKR039W",762).
component("YKL217W",757).
component("YKL120W",735).
component("YKL004W",724).
component("YJR158W",721).
component("YJR095W",710).
component("YJR077C",708).
component("YJL219W",693).
component("YJL214W",691).
component("YJL134W",680).
component("YJL129C",677).
component("YIL134W",645).
component("YHR096C",608).
component("YHR094C",607).
component("YHR092C",606).
component("YHL036W",587).
component("YGR121C",552).
component("YGR065C",548).
component("YGR055W",545).
component("YGL186C",528).
component("YGL077C",523).
component("YGL008C",509).
component("YFL055W",495).
component("YFL011W",489).
component("YER060W-A",462).
component("YER060W",461).
component("YER056C",460).
component("YER053C",458).
component("YEL069C",448).
component("YEL063C",447).
component("YEL017C-A",438).
component("YDR536W",433).
component("YDR508C",429).
component("YDR503C",428).
component("YDR497C",426).
component("YDR345C",411).
component("YDR343C",410).
component("YDR342C",409).
component("YDR297W",406).
component("YDR284C",404).
component("YDR046C",370) :- not remove_orf("YDR046C",370).
component("YDL245C",360).
component("YDL210W",355).
component("YCR032W",311).
component("YCR028C",310).
component("YCR024C-A",309).
component("YCL025C",298).
component("YBR298C",293).
component("YBR291C",292).
component("YBR085W",260).
component("YBR069C",255) :- not remove_orf("YBR069C",255).
component("YBR068C",254) :- not remove_orf("YBR068C",254).
component("YBR036C",251).
component("YBR021W",247).
component("YBL042C",231).
component("YBL030C",227).
component("U85_",199).
component("U7_",193).
component("U79_",192).
component("U78_",191).
...
catalyst(6160,885).
catalyst(3870,459).
catalyst(3620,413) :- not remove_reaction(3620,413).
catalyst(2110,504).
catalyst(2190,504).
catalyst(5550,715).
catalyst(5301,136).
...
catalyst(1960,371).
catalyst(3460,168).
catalyst(3600,754) :- not remove_reaction(3600,754).
catalyst(8000,769).
catalyst(3941,946).
catalyst(3942,946).
catalyst(6890,904).
...
catalyst(8020,1064).
catalyst(8020,466).
catalyst(1890,755) :- not remove_reaction(1890,755).
catalyst(3630,755) :- not remove_reaction(3630,755).
catalyst(1890,476) :- not remove_reaction(1890,476).
catalyst(3630,476) :- not remove_reaction(3630,476).
catalyst(3740,388).
catalyst(8231,1061).
catalyst(8232,1061).
catalyst(8231,1020).
...
catalyst(8061,1054).
catalyst(8062,1054).
catalyst(3590,515) :- not remove_reaction(3590,515).
catalyst(10910,515) :- not remove_reaction(10910,515).
catalyst(4570,556).
catalyst(8181,812).
catalyst(8182,812).
catalyst(8181,690).
...
catalyst(1210,965).
catalyst(1160,958).
catalyst(801,943) :- not remove_reaction(801,943).
catalyst(802,943) :- not remove_reaction(802,943).
catalyst(811,943) :- not remove_reaction(811,943).
catalyst(812,943) :- not remove_reaction(812,943).
catalyst(831,943) :- not remove_reaction(831,943).
catalyst(832,943) :- not remove_reaction(832,943).
catalyst(901,943) :- not remove_reaction(901,943).
catalyst(902,943) :- not remove_reaction(902,943).
catalyst(1180,939).
catalyst(1210,939).
catalyst(700,936).
catalyst(1200,924).
...
catalyst(650,768).
catalyst(6560,763).
catalyst(681,762) :- not remove_reaction(681,762).
catalyst(682,762) :- not remove_reaction(682,762).
catalyst(761,762) :- not remove_reaction(761,762).
catalyst(762,762) :- not remove_reaction(762,762).
catalyst(771,762) :- not remove_reaction(771,762).
catalyst(772,762) :- not remove_reaction(772,762).
catalyst(781,762) :- not remove_reaction(781,762).
catalyst(782,762) :- not remove_reaction(782,762).
catalyst(791,762) :- not remove_reaction(791,762).
catalyst(792,762) :- not remove_reaction(792,762).
catalyst(801,762) :- not remove_reaction(801,762).
catalyst(802,762) :- not remove_reaction(802,762).
catalyst(811,762) :- not remove_reaction(811,762).
catalyst(812,762) :- not remove_reaction(812,762).
catalyst(831,762) :- not remove_reaction(831,762).
catalyst(832,762) :- not remove_reaction(832,762).
catalyst(841,762) :- not remove_reaction(841,762).
catalyst(842,762) :- not remove_reaction(842,762).
catalyst(851,762) :- not remove_reaction(851,762).
catalyst(852,762) :- not remove_reaction(852,762).
catalyst(881,762) :- not remove_reaction(881,762).
catalyst(882,762) :- not remove_reaction(882,762).
catalyst(901,762) :- not remove_reaction(901,762).
catalyst(902,762) :- not remove_reaction(902,762).
catalyst(911,762) :- not remove_reaction(911,762).
catalyst(912,762) :- not remove_reaction(912,762).
catalyst(921,762) :- not remove_reaction(921,762).
catalyst(922,762) :- not remove_reaction(922,762).
catalyst(931,762) :- not remove_reaction(931,762).
catalyst(932,762) :- not remove_reaction(932,762).
catalyst(1191,762) :- not remove_reaction(1191,762).
catalyst(1192,762) :- not remove_reaction(1192,762).
catalyst(390,757).
catalyst(1021,757).
catalyst(1022,757).
catalyst(1521,735).
...
catalyst(851,370) :- not remove_reaction(851,370).
catalyst(852,370) :- not remove_reaction(852,370).
...
catalyst(1512,292).
catalyst(1590,260).
catalyst(771,255) :- not remove_reaction(771,255).
catalyst(772,255) :- not remove_reaction(772,255).
catalyst(791,255) :- not remove_reaction(791,255).
catalyst(792,255) :- not remove_reaction(792,255).
catalyst(801,255) :- not remove_reaction(801,255).
catalyst(802,255) :- not remove_reaction(802,255).
catalyst(811,255) :- not remove_reaction(811,255).
catalyst(812,255) :- not remove_reaction(812,255).
catalyst(851,255) :- not remove_reaction(851,255).
catalyst(852,255) :- not remove_reaction(852,255).
catalyst(901,255) :- not remove_reaction(901,255).
catalyst(902,255) :- not remove_reaction(902,255).
catalyst(791,254) :- not remove_reaction(791,254).
catalyst(792,254) :- not remove_reaction(792,254).
catalyst(801,254) :- not remove_reaction(801,254).
catalyst(802,254) :- not remove_reaction(802,254).
catalyst(811,254) :- not remove_reaction(811,254).
catalyst(812,254) :- not remove_reaction(812,254).
catalyst(831,254) :- not remove_reaction(831,254).
catalyst(832,254) :- not remove_reaction(832,254).
catalyst(841,254) :- not remove_reaction(841,254).
catalyst(842,254) :- not remove_reaction(842,254).
catalyst(851,254) :- not remove_reaction(851,254).
catalyst(852,254) :- not remove_reaction(852,254).
catalyst(901,254) :- not remove_reaction(901,254).
catalyst(902,254) :- not remove_reaction(902,254).
catalyst(6600,251).
catalyst(620,247).
catalyst(540,231).
catalyst(1590,227).
...
modifiable_enzyme(413).
modifiable_enzyme(754).
modifiable_enzyme(755).
modifiable_enzyme(476).
modifiable_enzyme(515).
modifiable_enzyme(362).
modifiable_enzyme(943).
modifiable_enzyme(762).
modifiable_enzyme(370).
modifiable_enzyme(255).
modifiable_enzyme(254).
