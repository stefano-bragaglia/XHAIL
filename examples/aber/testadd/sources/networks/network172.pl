...
component("YNL280C",859).
component("YLR056W",734).
component("YGR060W",508).
component("YGL012W",474).
component("YKR009C",711).
component("YOL086C",893).
component("YMR303C",830).
component("YMR083W",806).
component("YGL256W",500).
component("YDL168W",323).
component("YBR145W",249).
component("YPL231W",980).
component("YBR265W",268).
component("U46_",148).
component("YBR149W",250).
component("YBR149W",251).
component("YGL001C",470).
component("YIL094C",597).
component("YHR063C",560).
component("U45_",147).
component("YML056C",788).
component("YLR432W",777).
component("YHR216W",585).
component("YAR075W",207).
component("YAR073W",206).
component("YDR127W",358).
component("YJR139C",671).
component("YML075C",791).
component("YLR450W",780).
component("YOL126C",899).
component("YKL085W",685).
component("YDL078C",305).
component("YKL029C",680).
component("YOR136W",915).
component("YNL037C",835).
component("YNL009W",833).
component("YLR174W",748).
component("YHR183W",578).
component("YGR256W",537).
component("YNL241C",850).
component("YOL059W",890).
component("YDL022W",296).
component("YCL018W",276).
component("YLR355C",772).
component("YIL074C",594).
component("YER081W",441).
component("YML054C",787).
component("YDL174C",327).
component("YML086C",793).
component("YIL155C",607).
component("YEL024W",409).
component("YKR066C",716).
component("YGR088W",512).
component("YDR256C",373).
component("YKL026C",679).
component("YIR037W",618).
component("YBR244W",263).
component("YJR078W",663).
component("U58_",157).
component("YJR025C",654).
component("U107_",27).
component("YGR255C",536).
component("U108_",28).
component("YHR007C",548).
component("YDR402C",388).
component("YGL055W",481).
component("YJR104C",666).
component("YHR008C",549).
component("YOR384W",950).
component("YOR381W",949).
component("YOL152W",903).
component("YLL051C",726).
component("YJL026W",620).
component("YIL066C",593).
component("YGR180C",523).
component("YER070W",438).
component("U37_",141).
component("U36_",140).
component("U35_",139).
component("YDL168W",324).
component("YDR158W",366).
component("YJR009C",650).
component("YJL052W",622).
component("YGR192C",525).
component("YBR006W",222).
component("YPL276W",990).
component("YPL275W",989).
component("YOR388C",951).
component("YPL061W",960).
component("YOR374W",946).
component("YER073W",439).
component("YGL154C",490).
component("YBR115C",244).
component("U55_",156).
component("YER069W",436).
component("YOR323C",936).
component("YMR170C",816).
component("YMR169C",815).
component("YER178W",452).
component("YBR221C",261).
component("YIL125W",603).
component("U52_",153).
component("YBR166C",254).
component("YNL280C",860).
component("YGL012W",475).
component("YKL182W",697).
component("YKL216W",708).
component("YDR044W",342).
component("YER014W",420).
component("YKR009C",712).
component("YIL160C",608).
component("YGL205W",495).
component("YMR118C",810).
component("YLR164W",746).
component("YLL041C",724).
component("YKL148C",691).
component("YKL141W",689).
component("YJL045W",621).
component("YDR178W",368).
component("YJR051W",657).
component("YEL047C",413).
component("YDL171C",325).
component("YDL171C",326).
component("YOR375C",947).
component("YDL215C",331).
component("YAL062W",203).
component("U99_",197).
component("U100_",21).
component("YBR035C",231).
component("YMR189W",818).
component("YKR080W",718).
component("YER023W",422).
component("YPL023C",955).
component("YGL125W",487).
component("YOR236W",933).
component("YGR204W",528).
component("YBR084W",237).
component("YIR034C",617).
component("YLR142W",743).
component("U65_",164).
component("U63_",162).
component("U62_",161).
component("YOR356W",944).
component("YHR068W",561).
component("YKL150W",692).
component("YIL043C",590).
component("YHR042W",555).
component("YOR221C",930).
component("YMR145C",813).
component("YML120C",794).
component("YKL192C",701).
component("YKL055C",682).
component("YER061C",432).
component("YDL085W",307).
component("YPL171C",969).
component("YHR179W",577).
component("YMR145C",814).
component("YML120C",795).
component("YKL192C",702).
component("YDL085W",308).
component("YGR234W",531).
component("YFR030W",466).
component("YPL017C",954).
component("YFL018C",456).
component("YPL091W",961).
component("YDR353W",383).
component("YER042W",424).
component("YPR167C",1013).
component("YJR137C",670).
component("YNL052W",837).
component("YMR256C",826).
component("YLR395C",776).
component("YLR038C",732).
component("YIL111W",600).
component("YHR051W",559).
component("YGL191W",493).
component("YGL187C",492).
component("YDL067C",304).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",350).
component("YPL266W",987).
component("YPL273W",988).
component("YLL062C",728).
component("YDR410C",391).
component("YKR069W",717).
component("YOL096C",894).
component("U47_",149).
component("YER091C",446).
component("YJR073C",661).
component("YGR157W",519).
component("YDR120C",356).
component("YML008C",782).
component("YOR074C",909).
component("YDL033C",298).
component("YOL096C",895).
component("YLR172C",747).
component("YLR058C",735).
component("YDR019C",338).
component("YBR176W",255).
component("YDR408C",390).
component("YMR120C",811).
component("YLR028C",730).
component("YBL013W",208).
component("YJL130C",634).
component("YJL088W",627).
component("YKL024C",677).
component("YPR074C",1004).
component("YBR117C",245).
component("YLR354C",771).
component("YGR043C",506).
component("YMR108W",809).
component("YCL009C",275).
component("YMR062C",804).
component("YNL071W",839).
component("YNR008W",866).
component("YIL160C",609).
component("YNR019W",869).
component("YCR048W",291).
component("U48_",150).
component("YNL277W",858).
component("YMR062C",805).
component("YDR232W",370).
component("YPL231W",981).
component("YER061C",433).
component("YPL001W",953).
component("YDL052C",302).
component("U8_",189).
component("YDR148C",364).
component("YOR377W",948).
component("YGR177C",522).
component("YPL231W",982).
component("YPL028W",956).
component("YLR299W",759).
component("YGL017W",476).
component("YCR005C",283).
component("YML126C",796).
component("YNL104C",842).
component("YDL182W",328).
component("YDL131W",314).
component("YPR160W",1012).
component("YDR307W",379).
component("YLR258W",756).
component("YFR015C",463).
component("YPL227C",978).
component("YNL029C",834).
component("YIL085C",596).
component("YNL192W",848).
component("YBR038W",233).
component("YBR023C",229).
component("YEL011W",405).
component("YMR306W",831).
component("YLR342W",769).
component("YGR032W",504).
component("YPR183W",1016).
component("YBR248C",264).
component("YLR209C",750).
component("U104_",24).
component("U103_",23).
component("YOR209C",928).
component("YMR300C",829).
component("YER055C",428).
component("YDR354W",384) :- not remove_orf("YDR354W",384).
component("YFR047C",467).
component("YJR133W",669).
component("U22_",126).
component("YLR209C",751).
component("YML022W",784).
component("YDR441C",394).
component("YHR128W",570).
component("YPR176C",1015).
component("YPL172C",970).
component("YNR041C",873).
component("YMR101C",807).
component("YDL090C",310).
component("YBR003W",221).
component("YBR002C",220).
component("YJL167W",642).
component("YJL167W",643).
component("YNL256W",853).
component("YPR069C",1001).
component("YDR127W",359).
component("YHR190W",580).
component("YLR146C",744).
component("YPL214C",976).
component("YHR068W",562).
component("YLR303W",761).
component("YGR012W",502).
component("YML082W",792).
component("YJR130C",668).
component("YLR303W",762).
component("YDR035W",340).
component("YBR249C",265).
component("YLR180W",749).
component("YDR502C",398).
component("YOR274W",934).
component("YOL143C",902).
component("YBR256C",267).
component("YHR137W",571).
component("YGL202W",494).
component("YLR027C",729).
component("YKL106W",686).
component("YOL140W",901).
component("YLR438W",779).
component("YGR019W",503).
component("YLR089C",739).
component("YDR111C",355).
component("U64_",163).
component("U61_",160).
component("U51_",152).
component("YJR148W",672).
component("YHR208W",583).
component("YFL030W",458).
component("YOR184W",921).
component("YNR058W",877).
component("YIL116W",602).
component("YGL253W",499).
component("YFR053C",468).
component("YOL136C",900).
component("YIL107C",599).
component("YMR013C",800).
component("YMR205C",820).
component("YGR240C",532).
component("YOL016C",881).
component("YFR014C",462).
component("YLR240W",754).
component("YKL203C",704).
component("YJR066W",660).
component("YCR036W",290).
component("YGR194C",526).
component("YCL040W",279).
component("U15_",69).
component("YPL188W",972).
component("YJR049C",656).
component("YEL041W",410).
component("U96_",195).
component("YKL001C",675).
component("YDR236C",371).
component("YML070W",790).
component("YFL053W",460).
component("YHL032C",546).
component("YDR531W",402).
component("U83_",183).
component("U82_",182).
component("U81_",181).
component("YMR208W",821).
component("YPL203W",973).
component("YOR061W",907).
component("YKL166C",694).
component("YJL164C",641).
component("YIL035C",589).
component("YHR205W",582).
component("YHR102W",568).
component("YGL019W",477).
component("YHR025W",554).
component("YOR347C",942).
component("YAL038W",201).
component("YNR012W",867).
component("YPR121W",1009).
component("YPL258C",984).
component("YOL055C",886).
component("YPL214C",977).
component("U1_",105).
component("YDR009W",337).
component("YDR127W",360).
component("U21_",117).
component("U20_",114).
component("YDR147W",363).
component("YDR300C",378).
component("YCR012W",284).
component("YER052C",426).
component("YER069W",437).
component("U19_",104).
component("YKL024C",678).
component("U18_",94).
component("U17_",84).
component("U76_",175).
component("YMR220W",823).
component("YER170W",451).
component("YDR226W",369).
component("YKL067W",684).
component("YOL055C",887).
component("YDR454C",395).
component("YJR057W",658).
component("YOL061W",891).
component("YKL181W",696).
component("YHL011C",544).
component("YER099C",447).
component("YBL068W",216).
component("YOR143C",917).
component("YNL256W",854).
component("YLR328W",767).
component("YBR018C",224).
component("YBR018C",225).
component("YGR007W",501).
component("YGR202C",527).
component("YLR328W",768).
component("YKR002W",710).
component("YDL045C",300).
component("U80_",180).
component("YDL103C",313).
component("U94_",194).
component("YJR010W",651).
component("YBR029C",230).
component("YCL050C",280).
component("YGL130W",488).
component("YDR530C",401).
component("YCL050C",281).
component("YPR190C",1018).
component("YPR187W",1017).
component("YPR110C",1007).
component("YPR010C",994).
component("YOR341W",941).
component("YOR340C",940).
component("YOR224C",932).
component("YOR210W",929).
component("YOR207C",926).
component("YOR151C",918).
component("YOR116C",911).
component("YOL005C",879).
component("YNR003C",865).
component("YNL248C",852).
component("YNL151C",846).
component("YNL113W",843).
component("YKL144C",690).
component("YJR063W",659).
component("YJL148W",638).
component("YJL140W",637).
component("YIL021W",588).
component("YHR143W-A",572).
component("YGL070C",485).
component("YFL036W",459).
component("YDR404C",389).
component("YDR156W",365).
component("YDR045C",343).
component("YDL150W",322).
component("YDL140C",316).
component("YBR154C",253).
component("YPR175W",1014).
component("YPL167C",968).
component("YOR330C",937).
component("YOL115W",898).
component("YNL299W",862).
component("YNL262W",856).
component("YNL102W",841).
component("YJR043C",655).
component("YJR006W",649).
component("YJL090C",628).
component("YIL139C",605).
component("YEL055C",414).
component("YDR419W",392).
component("YDR121W",357).
component("YDL102W",312).
component("YCR014C",285).
component("YBR278W",270).
component("YBL035C",212).
component("YKL035W",681).
component("YHL012W",545).
component("YHR123W",569).
component("YPR113W",1008).
component("YBR243C",262).
component("YDL142C",321).
component("YPL148C",966).
component("YER026C",423).
component("YGR286C",541).
component("YJL068C",623).
component("YHR189W",579).
component("YDR058C",348).
component("YNR034W",872).
component("YHR163W",575).
component("YGR248W",534).
component("YCR073W-A",293).
component("YDL086W",309).
component("YOL011W",880).
component("YMR008C",798).
component("YMR006C",797).
component("U105_",25).
component("YBL015W",209).
component("YJL068C",624).
component("YJR019C",653).
component("YOR040W",906).
component("U84_",184).
component("U77_",176).
component("YDR481C",396).
component("YLR377C",774).
component("YDR074W",351).
component("YFR025C",464).
component("YPL179W",971).
component("YNR032W",870).
component("YML057W",789).
component("YML016C",783).
component("YLR433C",778).
component("YGR123C",515).
component("YER133W",449).
component("YER089C",444).
component("YDR436W",393).
component("YDR075W",352).
component("YDL188C",329).
component("YDL134C",315).
component("YDL047W",301).
component("YDL006W",294).
component("YBR125C",248).
component("YBL056W",215).
component("YPR073C",1002).
component("YHR215W",584).
component("YDL024C",297).
component("YBR093C",242).
component("YBR092C",241).
component("YAR071W",205).
component("YIL053W",592).
component("YER062C",434).
component("YHR046C",558).
component("U9_",198).
component("YPL228W",979).
component("YMR180C",817).
component("YDL236W",333).
component("YJL155C",640).
component("YPR073C",1003).
component("YOR208W",927).
component("YNL053W",838).
component("YMR036C",802).
component("YIR026C",615).
component("YIL113W",601).
component("YFR028C",465).
component("YER075C",440).
component("YDL230W",332).
component("YBR276C",269).
component("U34_",138).
component("U33_",137).
component("U32_",136).
component("U31_",135).
...
component("U25_",129).
component("U24_",128).
component("YHR044C",557).
component("YHR043C",556).
component("YOL064C",892).
component("YOR360C",945).
component("YGL248W",498).
component("YKR031C",713).
component("YPL206C",974).
component("YGL027C",479).
component("YLR286C",758).
component("YJR153W",673).
component("YJL221C",648).
component("YJL216C",646).
component("YIL172C",613).
component("YGR292W",543).
component("YGR287C",542).
component("YBR299W",274).
component("YBR184W",256).
component("YIL162W",610).
component("YPR026W",995).
component("YDR001C",335).
component("YBR001C",219).
component("YIR019C",614).
component("YIL099W",598).
component("YDL037C",299).
component("YOR190W",923).
component("YLR300W",760).
component("YGR282C",540).
component("YDR261C",374).
component("YDR400W",387).
component("U23_",127).
component("YML035C",785).
component("YJL070C",625).
component("YBR284W",271).
component("U106_",26).
component("U102_",22).
component("YER043C",425).
component("YNL045W",836).
component("YGL037C",480).
component("YDR242W",372).
component("YLR308W",766).
component("YLR307W",765).
component("YBR208C",258).
component("YMR281W",828).
component("U53_",154).
component("YIR032C",616).
component("YPR062W",1000).
component("YMR120C",812).
component("YLR028C",731).
component("YHR144C",573).
component("YHR144C",574).
component("YGR267C",539).
component("YCL030C",278).
component("YBL033C",211).
component("YBR153W",252).
component("YNL141W",844).
component("YLR245C",755).
component("YML035C",786).
component("YGR204W",529).
component("YBR084W",238).
component("YJL126W",632).
component("U44_",146).
component("YDL100C",311).
component("U87_",186).
component("U40_",144).
component("U39_",142).
component("YBR011C",223).
component("YHR201C",581).
component("YBR111C",243).
component("YBR252W",266).
component("YEL042W",411).
component("YPR080W",1005).
component("YOR187W",922).
component("YOR133W",914).
component("YLR069C",737).
component("YKR084C",719).
component("YKL173W",695).
component("YJL102W",630).
component("YDR385W",386).
component("YBR118W",246).
component("YER005W",419).
component("YLL001W",722).
component("YIL048W",591).
component("YER166W",450).
component("YDR093W",354).
component("YAL026C",200).
component("YBL099W",218).
component("U60_",159).
component("YLR231C",752).
component("U88_",187).
component("YDR538W",404).
component("YLR134W",741).
component("YLR044C",733).
component("YGR087C",511).
component("YDR380W",385).
component("YDL080C",306).
component("U98_",196).
component("YMR250W",825).
component("YKL184W",700).
component("YOR128C",912).
component("YEL021W",408).
component("YNR043W",874).
component("U93_",193).
component("YDR047W",345).
component("U54_",155).
component("YKL211C",706) :- not remove_orf("YKL211C",706).
component("YKR097W",721).
component("YOL052C",885).
component("YNL169C",847).
component("YGR170W",520).
component("YKL060C",683).
component("YNL256W",855).
component("YDR294C",376).
component("YEL046C",412).
component("YNR033W",871).
component("YPR006C",993).
component("YER065C",435).
component("YKL211C",707) :- not remove_orf("YKL211C",707).
component("YER090W",707) :- not remove_orf("YER090W",707).
component("YER090W",445) :- not remove_orf("YER090W",445).
component("YDR127W",361).
component("YPL281C",991).
component("YOR393W",952).
component("YMR323W",832).
component("YHR174W",576).
component("YGR254W",535).
component("YOR202W",925).
component("YPL262W",985).
component("YGL026C",478) :- not remove_orf("YGL026C",478).
component("YGR155W",518).
component("YLR304C",763).
component("YJL200C",644).
component("YGL009C",473).
component("YNL316C",863).
component("YKL182W",698).
component("YPL212C",975).
component("YNL292W",861).
component("YGL063W",484).
component("YFL001W",454).
component("YPR002W",992).
component("YJR016C",652).
component("YCR053W",292).
component("YDR127W",362).
component("YGL148W",489).
component("YIL168W",612).
component("YIL167W",611).
component("YCL064C",282).
component("YER086W",442).
component("YLR359W",773).
component("YAL012W",199).
component("YML004C",781).
component("YFR055W",469).
component("YJL005W",619).
component("YJL121C",631).
component("YBR019C",226).
component("YBR019C",227).
component("YDR050C",346).
component("YIL020C",587).
component("YDR007W",336) :- not remove_orf("YDR007W",336).
component("YOR095C",910).
component("YER003C",418).
component("YBR196C",257).
component("YGL001C",471).
component("YPL117C",964).
component("U14_",61).
component("YOL056W",888).
component("YKL152C",693).
component("YDL021W",295).
component("YMR105C",808).
component("YKL127W",688).
component("YEL058W",415).
component("YPR060C",999).
component("YHR072W",563).
component("YJL153C",639).
component("YPL097W",962).
component("YGR185C",524).
component("YGR264C",538).
component("YGR171C",521).
component("YHR011W",550).
component("YDR023W",339).
component("YPL104W",963).
component("YLL018C",723).
component("YPR081C",1006).
component("YBR121C",247).
component("YHR020W",553).
component("YER087W",443).
component("YNL247W",851).
component("YOL033W",883).
component("YOR168W",919).
component("YOL097C",896).
component("YDR268W",375).
component("YPR047W",998).
component("YLR060W",736).
component("YFL022C",457).
component("YPR033C",996).
component("YHR019C",551).
component("YCR024C",286).
component("YHR019C",552).
component("YKL194C",703).
component("YIL078W",595).
component("YPL160W",967).
component("YLR382C",775).
component("YPL040C",958).
component("YBL076C",217).
component("YNL073W",840).
component("YDR037W",341).
component("YOR335C",938).
component("YGR094W",513).
component("YLR153C",745).
component("YAL054C",202).
component("YOR317W",935).
component("YMR246W",824).
component("YIL009W",586).
component("YER015W",421).
component("YOR142W",916).
component("YGR244C",533).
component("YPR035W",997).
component("YIL145C",606).
component("U89_",188).
component("YOR339C",939).
component("YMR022W",801).
component("YLR306W",764).
component("YKL210W",705).
component("YGR133W",517).
component("YGL058W",482).
component("YER100W",448).
component("YEL012W",406).
component("YDR177W",367).
component("YDR092W",353).
component("YDR059C",349).
component("YDR054C",347).
component("YDL064W",303).
component("YBR082C",236).
component("YJL101C",629).
component("YOL049W",884).
component("U92_",192).
component("YAR015W",204).
component("YGL234W",496).
component("YER183C",453).
component("U91_",191).
component("U90_",190).
component("YNR057C",876).
component("YDL141W",317).
component("YDL141W",318).
component("YGL234W",497).
component("YDL141W",319).
component("YJR103W",665).
component("YBL039C",213).
component("YGR204W",530).
component("YBR084W",239).
component("YNL220W",849).
component("YOL058W",889).
component("YBR208C",259).
component("YDL141W",320).
component("YHR074W",564).
component("YMR217W",822).
component("YGR061C",509).
component("YPR145W",1011).
component("YGR124W",516).
component("YJR109C",667).
component("YJL130C",635).
component("YGL062W",483).
component("YBR218C",260).
component("YPL231W",983).
component("YNR016C",868).
component("YKL182W",699).
component("YGR037C",505).
component("YJL087C",626).
component("YPR138C",1010).
component("YPL265W",986).
component("YPL134C",965).
component("YPL057C",959).
component("YPL036W",957).
component("YOR348C",943).
component("YOR222W",931).
component("YOR192C",924).
component("YOR171C",920).
component("YOR130C",913).
component("YOR071C",908).
component("YOR011W",905).
component("YOL156W",904).
component("YOL103W",897).
component("YOL020W",882) :- not remove_orf("YOL020W",882).
component("YNR072W",878).
component("YNR056C",875).
component("YNL318C",864).
component("YNL270C",857).
component("YNL142W",845).
component("YMR272C",827).
component("YMR202W",819).
component("YMR056C",803).
component("YMR011W",799).
component("YLR348C",770).
component("YLR260W",757).
component("YLR237W",753).
component("YLR138W",742).
component("YLR100C",740).
component("YLR081W",738).
component("YLL061W",727).
component("YLL043W",725).
component("YKR093W",720).
component("YKR053C",715).
component("YKR039W",714) :- not remove_orf("YKR039W",714).
component("YKL217W",709).
component("YKL120W",687).
component("YKL004W",676).
component("YJR158W",674).
component("YJR095W",664).
component("YJR077C",662).
component("YJL219W",647).
component("YJL214W",645).
component("YJL134W",636).
component("YJL129C",633).
component("YIL134W",604).
component("YHR096C",567).
component("YHR094C",566).
component("YHR092C",565).
component("YHL036W",547).
component("YGR121C",514).
component("YGR065C",510).
component("YGR055W",507).
component("YGL186C",491).
component("YGL077C",486).
component("YGL008C",472).
component("YFL055W",461).
component("YFL011W",455).
component("YER060W-A",431).
component("YER060W",430).
component("YER056C",429).
component("YER053C",427).
component("YEL069C",417).
component("YEL063C",416).
component("YEL017C-A",407).
component("YDR536W",403).
component("YDR508C",400).
component("YDR503C",399).
component("YDR497C",397).
component("YDR345C",382).
component("YDR343C",381).
component("YDR342C",380).
component("YDR297W",377).
component("YDR046C",344) :- not remove_orf("YDR046C",344).
component("YDL245C",334).
component("YDL210W",330).
component("YCR032W",289).
component("YCR028C",288).
component("YCR024C-A",287).
component("YCL025C",277).
component("YBR298C",273).
component("YBR291C",272).
component("YBR085W",240).
component("YBR069C",235) :- not remove_orf("YBR069C",235).
component("YBR068C",234) :- not remove_orf("YBR068C",234).
component("YBR036C",232).
component("YBR021W",228).
component("YBL042C",214).
component("YBL030C",210).
component("U85_",185).
component("U7_",179).
component("U79_",178).
component("U78_",177).
...
catalyst(6160,829).
catalyst(3870,428).
catalyst(3620,384) :- not remove_reaction(3620,384).
catalyst(2110,467).
catalyst(2190,467).
catalyst(5550,669).
catalyst(5301,126).
...
catalyst(1960,345).
catalyst(3460,155).
catalyst(3600,706) :- not remove_reaction(3600,706).
catalyst(8000,721).
catalyst(3941,885).
catalyst(3942,885).
catalyst(6890,847).
...
catalyst(8020,993).
catalyst(8020,435).
catalyst(1890,707) :- not remove_reaction(1890,707).
catalyst(3630,707) :- not remove_reaction(3630,707).
catalyst(1890,445) :- not remove_reaction(1890,445).
catalyst(3630,445) :- not remove_reaction(3630,445).
catalyst(3740,361).
catalyst(8231,991).
catalyst(8232,991).
catalyst(8231,952).
...
catalyst(8061,985).
catalyst(8062,985).
catalyst(3590,478) :- not remove_reaction(3590,478).
catalyst(10910,478) :- not remove_reaction(10910,478).
catalyst(4570,518).
catalyst(8181,763).
catalyst(8182,763).
catalyst(8181,644).
...
catalyst(1210,904).
catalyst(1160,897).
catalyst(801,882) :- not remove_reaction(801,882).
catalyst(802,882) :- not remove_reaction(802,882).
catalyst(811,882) :- not remove_reaction(811,882).
catalyst(812,882) :- not remove_reaction(812,882).
catalyst(831,882) :- not remove_reaction(831,882).
catalyst(832,882) :- not remove_reaction(832,882).
catalyst(901,882) :- not remove_reaction(901,882).
catalyst(902,882) :- not remove_reaction(902,882).
catalyst(1180,878).
catalyst(1210,878).
catalyst(700,875).
catalyst(1200,864).
...
catalyst(650,720).
catalyst(6560,715).
catalyst(681,714) :- not remove_reaction(681,714).
catalyst(682,714) :- not remove_reaction(682,714).
catalyst(771,714) :- not remove_reaction(771,714).
catalyst(772,714) :- not remove_reaction(772,714).
catalyst(781,714) :- not remove_reaction(781,714).
catalyst(782,714) :- not remove_reaction(782,714).
catalyst(791,714) :- not remove_reaction(791,714).
catalyst(792,714) :- not remove_reaction(792,714).
catalyst(801,714) :- not remove_reaction(801,714).
catalyst(802,714) :- not remove_reaction(802,714).
catalyst(811,714) :- not remove_reaction(811,714).
catalyst(812,714) :- not remove_reaction(812,714).
catalyst(831,714) :- not remove_reaction(831,714).
catalyst(832,714) :- not remove_reaction(832,714).
catalyst(841,714) :- not remove_reaction(841,714).
catalyst(842,714) :- not remove_reaction(842,714).
catalyst(851,714) :- not remove_reaction(851,714).
catalyst(852,714) :- not remove_reaction(852,714).
catalyst(881,714) :- not remove_reaction(881,714).
catalyst(882,714) :- not remove_reaction(882,714).
catalyst(901,714) :- not remove_reaction(901,714).
catalyst(902,714) :- not remove_reaction(902,714).
catalyst(911,714) :- not remove_reaction(911,714).
catalyst(912,714) :- not remove_reaction(912,714).
catalyst(921,714) :- not remove_reaction(921,714).
catalyst(922,714) :- not remove_reaction(922,714).
catalyst(931,714) :- not remove_reaction(931,714).
catalyst(932,714) :- not remove_reaction(932,714).
catalyst(1191,714) :- not remove_reaction(1191,714).
catalyst(1192,714) :- not remove_reaction(1192,714).
catalyst(390,709).
catalyst(1021,709).
catalyst(1022,709).
catalyst(1521,687).
...
catalyst(851,344) :- not remove_reaction(851,344).
catalyst(852,344) :- not remove_reaction(852,344).
...
catalyst(1512,272).
catalyst(1590,240).
catalyst(771,235) :- not remove_reaction(771,235).
catalyst(772,235) :- not remove_reaction(772,235).
...
catalyst(791,234) :- not remove_reaction(791,234).
catalyst(792,234) :- not remove_reaction(792,234).
...
catalyst(841,234) :- not remove_reaction(841,234).
catalyst(842,234) :- not remove_reaction(842,234).
catalyst(851,234) :- not remove_reaction(851,234).
catalyst(852,234) :- not remove_reaction(852,234).
catalyst(901,234) :- not remove_reaction(901,234).
catalyst(902,234) :- not remove_reaction(902,234).
catalyst(6600,232).
catalyst(620,228).
catalyst(540,214).
catalyst(1590,210).
...
modifiable_enzyme(706).
modifiable_enzyme(707).
modifiable_enzyme(445).
modifiable_enzyme(478).
modifiable_enzyme(336).
modifiable_enzyme(882).
modifiable_enzyme(714).
