...
component("YNL280C",445).
component("YLR056W",382).
component("YGL012W",245).
component("YKR009C",368).
component("YOL086C",463).
component("YMR303C",423).
component("YGL256W",263).
component("YDL168W",169).
component("YBR145W",130).
component("YPL231W",506).
component("U46_",76).
component("YBR149W",131).
component("YGL001C",242).
component("YIL094C",311).
component("U45_",75).
component("YML056C",412).
component("YLR432W",409).
component("YHR216W",306).
component("YAR075W",109).
component("YAR073W",108).
component("YDR127W",182).
component("YOL126C",468).
component("YKL085W",358).
component("YDL078C",161).
component("YNL037C",428).
component("YNL009W",426).
component("YLR174W",390).
component("YCL018W",146).
component("YLR355C",405).
component("YDL174C",172).
component("YML086C",413).
component("YGR088W",271).
component("YDR256C",192).
component("YJR078W",348).
component("YJR025C",341).
component("U107_",23).
component("YJR104C",350).
component("YHR008C",289).
component("YJL026W",325).
component("YIL066C",309).
component("YGR180C",274).
component("YER070W",222).
component("U36_",69).
component("YDL168W",170).
component("YBR006W",117).
component("YPL276W",514).
component("YPL275W",513).
component("YOR388C",492).
component("YOR374W",491).
component("YER073W",223).
component("U55_",82).
component("YER069W",221).
component("YOR323C",484).
component("YER178W",229).
component("YBR221C",137).
component("YIL125W",315).
component("U52_",80).
component("YBR166C",133).
component("YGL012W",246).
component("YKL216W",367).
component("YKR009C",369).
component("YIL160C",319).
component("YGL205W",260).
component("YDL171C",171).
component("U99_",103).
component("U100_",20).
component("YKR080W",374).
component("YER023W",215).
component("YGR204W",276).
component("YLR142W",387).
component("U65_",86).
component("U62_",85).
component("YHR068W",297).
component("YKL150W",361).
component("YIL043C",308).
component("YPL171C",502).
component("YHR179W",304).
component("YGR234W",278).
component("YFR030W",239).
component("YPL017C",494).
component("YFL018C",232).
component("YDR353W",196).
component("YPR167C",526).
component("YJR137C",352).
component("YNL052W",429).
component("YMR256C",422).
component("YLR395C",408).
component("YLR038C",380).
component("YIL111W",312).
component("YHR051W",296).
component("YGL191W",258).
component("YGL187C",257).
component("YDL067C",160).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",512).
component("YKR069W",373).
component("YOL096C",464).
component("U47_",77).
component("YJR073C",346).
component("YDL033C",159).
component("YLR172C",389).
component("YLR058C",383).
component("YDR019C",177).
component("YBR176W",134).
component("YDR408C",201).
component("YMR120C",418).
component("YLR028C",378).
component("YBL013W",110).
component("YJL130C",331).
component("YKL024C",356).
component("YPR074C",522).
component("YBR117C",129).
component("YCL009C",145).
component("YNL071W",431).
component("YIL160C",320).
component("U48_",78).
component("YPL231W",507).
component("YPL231W",508).
component("YPL028W",495).
component("YLR299W",398).
component("YGL017W",247).
component("YML126C",414).
component("YNL104C",433).
component("YDL182W",173).
component("YDL131W",165).
component("YLR258W",395).
component("YFR015C",237).
component("YNL029C",427).
component("YIL085C",310).
component("YMR306W",424).
component("YLR342W",404).
component("YGR032W",266).
component("YLR209C",391).
component("U104_",21).
component("YDR354W",197) :- not remove_orf("YDR354W",197).
component("YFR047C",240).
component("YLR209C",392).
component("YML022W",410).
component("YDR441C",203).
component("YJL167W",335).
component("YDR127W",183).
component("YHR068W",298).
component("YLR303W",400).
component("YGR012W",264).
component("YJR130C",351).
component("YDR035W",178).
component("YBR249C",138).
component("YOR274W",483).
component("YHR137W",300).
component("YGL202W",259).
component("YLR027C",377).
component("YKL106W",359).
component("YOL140W",469).
component("YGR019W",265).
component("YLR089C",384).
component("U61_",84).
component("YJR148W",353).
component("YFL030W",233).
component("YNR058W",454).
component("YIL116W",314).
component("YGL253W",262).
component("YFR053C",241).
component("YMR205C",420).
component("YGR240C",279).
component("YOL016C",457).
component("YFR014C",236).
component("YCR036W",155).
component("YCL040W",148).
component("YPL188W",503).
component("YJR049C",343).
component("YEL041W",210).
component("U96_",101).
component("YKL001C",355).
component("YDR236C",190).
component("YHL032C",287).
component("U83_",98).
component("YMR208W",421).
component("YHR025W",292).
component("YOR347C",489).
component("YAL038W",106).
component("YNR012W",450).
component("YDR127W",184).
component("YDR147W",187).
component("YCR012W",150).
component("U76_",95).
component("YER170W",228).
component("YDR226W",189).
component("YKL067W",357).
component("YOL055C",460).
component("YDR454C",204).
component("YJR057W",344).
component("YOL061W",462).
component("YKL181W",363).
component("YHL011C",286).
component("YER099C",227).
component("YBL068W",115).
component("YOR143C",474).
component("YNL256W",442).
component("YLR328W",402).
component("YBR018C",119).
component("YLR328W",403).
component("U94_",100).
component("YBR029C",121).
component("YGL130W",254).
component("YPR190C",529).
component("YPR187W",528).
component("YPR110C",523).
component("YPR010C",517).
component("YOR341W",488).
component("YOR340C",487).
component("YOR224C",482).
component("YOR210W",481).
component("YOR207C",479).
component("YOR151C",475).
component("YOR116C",472).
component("YOL005C",455).
component("YNR003C",449).
component("YNL248C",441).
component("YNL151C",437).
component("YNL113W",434).
component("YKL144C",360).
component("YJR063W",345).
component("YJL148W",334).
component("YJL140W",333).
component("YIL021W",307).
component("YHR143W-A",301).
component("YGL070C",252).
component("YFL036W",234).
component("YDR404C",200).
component("YDR156W",188).
component("YDR045C",179).
component("YDL150W",168).
component("YDL140C",166).
component("YBR154C",132).
component("YPR175W",527).
component("YPL167C",501).
component("YOR330C",485).
component("YOL115W",467).
component("YNL299W",447).
component("YNL262W",443).
component("YNL102W",432).
component("YJR043C",342).
component("YJR006W",339).
component("YJL090C",327).
component("YIL139C",317).
component("YEL055C",212).
component("YDR419W",202).
component("YDR121W",181).
component("YDL102W",164).
component("YCR014C",151).
component("YBR278W",141).
component("YBL035C",113).
component("YPR113W",524).
component("YPL148C",500).
component("YGR286C",283).
component("YOL011W",456).
component("YMR008C",416).
component("YMR006C",415).
component("U105_",22).
component("YBL015W",111).
component("U77_",96).
component("YLR377C",407).
component("YPR073C",520).
component("YHR215W",305).
component("YDL024C",158).
component("YBR093C",127).
component("YBR092C",126).
component("YHR046C",295).
component("U9_",104).
component("YDL236W",175).
component("YPR073C",521).
component("YOR208W",480).
component("YNL053W",430).
component("YMR036C",417).
component("YIR026C",324).
component("YIL113W",313).
component("YFR028C",238).
component("YER075C",224).
...
component("U25_",63).
component("U24_",62).
component("YHR044C",294).
component("YHR043C",293).
component("YOR360C",490).
component("YKR031C",370).
component("YPL206C",504).
component("YGL027C",249).
component("YLR286C",397).
component("YJR153W",354).
component("YJL221C",338).
component("YJL216C",337).
component("YIL172C",323).
component("YGR292W",285).
component("YGR287C",284).
component("YBR299W",144).
component("YOR190W",478).
component("YLR300W",399).
component("YGR282C",282).
component("YDR261C",193).
component("YDR400W",199).
component("YML035C",411).
component("YJL070C",326).
component("YBR284W",142).
component("YER043C",216).
component("YDR242W",191).
component("U53_",81).
component("YPR062W",519).
component("YMR120C",419).
component("YLR028C",379).
component("YHR144C",302).
component("YBL033C",112).
component("YNL141W",435).
component("YLR245C",394).
component("YBR084W",124).
component("YJL126W",329).
component("U44_",74).
component("YDL100C",163).
component("U40_",72).
component("U39_",70).
component("YBR011C",118).
component("YBR111C",128).
component("YBR252W",139).
component("YER005W",214).
component("YBL099W",116).
component("YLR231C",393).
component("YLR134W",386).
component("YLR044C",381).
component("YGR087C",270).
component("YDR380W",198).
component("YDL080C",162).
component("U98_",102).
component("YOR128C",473).
component("YKL211C",365) :- not remove_orf("YKL211C",365).
component("YKR097W",375).
component("YNL169C",438).
component("YEL046C",211).
component("YNR033W",452).
component("YKL211C",366) :- not remove_orf("YKL211C",366).
component("YER090W",366) :- not remove_orf("YER090W",366).
component("YER090W",226) :- not remove_orf("YER090W",226).
component("YDR127W",185).
component("YPL281C",515).
component("YOR393W",493).
component("YMR323W",425).
component("YHR174W",303).
component("YGR254W",280).
component("YPL262W",510).
component("YGL026C",248) :- not remove_orf("YGL026C",248).
component("YLR304C",401).
component("YJL200C",336).
component("YNL316C",448).
component("YPL212C",505).
component("YNL292W",446).
component("YGL063W",251).
component("YFL001W",231).
component("YPR002W",516).
component("YJR016C",340).
component("YCR053W",156).
component("YDR127W",186).
component("YGL148W",255).
component("YIL168W",322).
component("YIL167W",321).
component("YCL064C",149).
component("YLR359W",406).
component("YAL012W",105).
component("YBR019C",120).
component("YDR007W",176) :- not remove_orf("YDR007W",176).
component("YOR095C",471).
component("YBR196C",135).
component("YGL001C",243).
component("YPL117C",499).
component("U14_",34).
component("YOL056W",461).
component("YKL152C",362).
component("YDL021W",157).
component("YPR060C",518).
component("YPL097W",497).
component("YGR185C",275).
component("YGR264C",281).
component("YGR171C",273).
component("YPL104W",498).
component("YLL018C",376).
component("YHR020W",291).
component("YER087W",225).
component("YNL247W",440).
component("YOR168W",476).
component("YOL097C",465).
component("YDR268W",194).
component("YCR024C",152).
component("YHR019C",290).
component("YOR335C",486).
component("YLR153C",388).
component("YAL054C",107).
component("YIL145C",318).
component("YJL101C",328).
component("YOL049W",459).
component("YER183C",230).
component("U90_",99).
component("YNR057C",453).
component("YGL234W",261).
component("YJR103W",349).
component("YBL039C",114).
component("YGR204W",277).
component("YBR084W",125).
component("YNL220W",439).
component("YDL141W",167).
component("YHR074W",299).
component("YGL062W",250).
component("YBR218C",136).
component("YPL231W",509).
component("YNR016C",451).
component("YKL182W",364).
component("YGR037C",267).
component("YPR138C",525).
component("YPL265W",511).
component("YPL036W",496).
component("YOR171C",477).
component("YOR011W",470).
component("YOL103W",466).
component("YOL020W",458) :- not remove_orf("YOL020W",458).
component("YNL270C",444).
component("YNL142W",436).
component("YLR260W",396).
component("YLR100C",385).
component("YKR053C",372).
component("YKR039W",371) :- not remove_orf("YKR039W",371).
component("YJR077C",347).
component("YJL134W",332).
component("YJL129C",330).
component("YIL134W",316).
component("YHL036W",288).
component("YGR121C",272).
component("YGR065C",269).
component("YGR055W",268).
component("YGL186C",256).
component("YGL077C",253).
component("YGL008C",244).
component("YFL055W",235).
component("YER060W-A",220).
component("YER060W",219).
component("YER056C",218).
component("YER053C",217).
component("YEL063C",213).
component("YEL017C-A",209).
component("YDR536W",208).
component("YDR508C",207).
component("YDR503C",206).
component("YDR497C",205).
component("YDR297W",195).
component("YDR046C",180) :- not remove_orf("YDR046C",180).
component("YCR032W",154).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,197) :- not remove_reaction(3620,197).
catalyst(2190,240).
catalyst(5791,392).
catalyst(5792,392).
catalyst(5801,392).
...
catalyst(6111,473).
catalyst(6112,473).
catalyst(3600,365) :- not remove_reaction(3600,365).
catalyst(8000,375).
catalyst(6890,438).
catalyst(4560,211).
catalyst(2550,452).
...
catalyst(1890,226) :- not remove_reaction(1890,226).
catalyst(3630,226) :- not remove_reaction(3630,226).
catalyst(3740,185).
catalyst(8231,515).
catalyst(8232,515).
catalyst(8231,493).
...
catalyst(8051,510).
catalyst(8052,510).
catalyst(3590,248) :- not remove_reaction(3590,248).
catalyst(10910,248) :- not remove_reaction(10910,248).
catalyst(8181,401).
catalyst(8182,401).
catalyst(8181,336).
catalyst(8182,336).
...
catalyst(7751,120).
catalyst(7752,120).
catalyst(3610,176) :- not remove_reaction(3610,176).
catalyst(7921,471).
catalyst(7922,471).
catalyst(8341,135).
catalyst(8342,135).
...
catalyst(22,470).
catalyst(1160,466).
catalyst(801,458) :- not remove_reaction(801,458).
catalyst(802,458) :- not remove_reaction(802,458).
catalyst(811,458) :- not remove_reaction(811,458).
catalyst(812,458) :- not remove_reaction(812,458).
catalyst(831,458) :- not remove_reaction(831,458).
catalyst(832,458) :- not remove_reaction(832,458).
catalyst(901,458) :- not remove_reaction(901,458).
catalyst(902,458) :- not remove_reaction(902,458).
catalyst(931,444).
catalyst(932,444).
catalyst(371,436).
catalyst(372,436).
...
catalyst(6330,385).
catalyst(6560,372).
catalyst(771,371) :- not remove_reaction(771,371).
catalyst(772,371) :- not remove_reaction(772,371).
catalyst(781,371) :- not remove_reaction(781,371).
catalyst(782,371) :- not remove_reaction(782,371).
catalyst(801,371) :- not remove_reaction(801,371).
catalyst(802,371) :- not remove_reaction(802,371).
catalyst(811,371) :- not remove_reaction(811,371).
catalyst(812,371) :- not remove_reaction(812,371).
catalyst(831,371) :- not remove_reaction(831,371).
catalyst(832,371) :- not remove_reaction(832,371).
catalyst(841,371) :- not remove_reaction(841,371).
catalyst(842,371) :- not remove_reaction(842,371).
catalyst(851,371) :- not remove_reaction(851,371).
catalyst(852,371) :- not remove_reaction(852,371).
catalyst(881,371) :- not remove_reaction(881,371).
catalyst(882,371) :- not remove_reaction(882,371).
catalyst(901,371) :- not remove_reaction(901,371).
catalyst(902,371) :- not remove_reaction(902,371).
catalyst(921,371) :- not remove_reaction(921,371).
catalyst(922,371) :- not remove_reaction(922,371).
catalyst(931,371) :- not remove_reaction(931,371).
catalyst(932,371) :- not remove_reaction(932,371).
catalyst(1191,371) :- not remove_reaction(1191,371).
catalyst(1192,371) :- not remove_reaction(1192,371).
catalyst(1581,347).
catalyst(1582,347).
catalyst(6560,332).
catalyst(361,330).
...
catalyst(851,123) :- not remove_reaction(851,123).
catalyst(852,123) :- not remove_reaction(852,123).
catalyst(901,123) :- not remove_reaction(901,123).
catalyst(902,123) :- not remove_reaction(902,123).
...
catalyst(851,122) :- not remove_reaction(851,122).
catalyst(852,122) :- not remove_reaction(852,122).
catalyst(901,122) :- not remove_reaction(901,122).
catalyst(902,122) :- not remove_reaction(902,122).
catalyst(6960,97).
catalyst(2920,94).
catalyst(2920,93).
catalyst(2920,92).
