...
component("YNL280C",887).
component("YLR056W",759).
component("YGR060W",526).
component("YGL012W",492).
component("YKR009C",735).
component("YOL086C",921).
component("YMR303C",856).
component("YMR083W",831).
component("YGL256W",518).
component("YDL168W",331).
component("YBR145W",256).
component("YPL231W",1013).
component("YBR265W",275).
component("U46_",151).
component("YBR149W",257).
component("YBR149W",258).
component("YJR159W",698).
component("YGL001C",488).
component("YIL094C",617).
component("YHR063C",580).
component("U45_",150).
component("YML056C",813).
component("YLR432W",802).
component("YHR216W",605).
component("YAR075W",211).
component("YAR073W",210).
component("YDR127W",367).
component("YJR139C",694).
component("YML075C",816).
component("YLR450W",805).
component("YOL126C",927).
component("YKL085W",709).
component("YDL078C",312).
component("YKL029C",704).
component("YOR136W",946).
component("YNL037C",862).
component("YNL009W",860).
component("YLR174W",773).
component("YHR183W",598).
component("YGR256W",556).
component("YNL241C",878).
component("YOL059W",918).
component("YDL022W",303).
component("YCL018W",283).
component("YLR355C",797).
component("YIL074C",614).
component("YER081W",453).
component("YML054C",812).
component("YDL174C",335).
component("YML086C",818).
component("YIL155C",627).
component("YPR191W",1052).
component("YOR065W",936).
component("YJL166W",663).
component("YHR001W-A",567).
component("YGR183C",542).
component("YFR033C",484).
component("YEL024W",421).
component("YDR529C",412).
component("YBL045C",219).
component("Q0105",19).
component("YKR066C",740).
component("YGR088W",530).
component("YDR256C",383).
component("YKL026C",703).
component("YIR037W",639).
component("YBR244W",270).
component("YJR078W",686).
component("U58_",160).
component("YJR025C",677).
component("U107_",28).
component("YGR255C",555).
component("U108_",29).
component("YHR007C",568).
component("YDR402C",399).
component("YGL055W",499).
component("YJR104C",689).
component("YHR008C",569).
component("YOR384W",982).
component("YOR381W",981).
component("YOL152W",931).
component("YLL051C",751).
component("YJL026W",641).
component("YIL066C",613).
component("YGR180C",541).
component("YER070W",450).
component("U37_",144).
component("U36_",143).
component("U35_",142).
component("YDL168W",332).
component("YDR158W",375).
component("YJR009C",673).
component("YJL052W",643).
component("YGR192C",544).
component("YBR006W",228).
component("YPL276W",1023).
component("YPL275W",1022).
component("YOR388C",983).
component("YPL061W",992).
component("YOR374W",978).
component("YER073W",451).
component("YGL154C",508).
component("YBR115C",251).
component("U55_",159).
component("YER069W",448).
component("YOR323C",968).
component("YMR170C",841).
component("YMR169C",840).
component("YER178W",467).
component("YBR221C",268).
component("YIL125W",623).
component("U52_",156).
component("YBR166C",261).
component("YNL280C",888).
component("YGL012W",493).
component("YKL182W",721).
component("YKL216W",732).
component("YDR044W",350).
component("YER014W",432).
component("YKR009C",736).
component("YIL160C",629).
component("YGL205W",513).
component("YMR118C",835).
component("YLR164W",771).
component("YLL041C",749).
component("YKL148C",715).
component("YKL141W",713).
component("YJL045W",642).
component("YDR178W",377).
component("YJR051W",680).
component("YEL047C",425).
component("YDL171C",333).
component("YDL171C",334).
component("YOR375C",979).
component("YDL215C",339).
component("YAL062W",206).
component("U99_",200).
component("U100_",22).
component("YBR035C",237).
component("YMR189W",843).
component("YKR080W",742).
component("YER023W",434).
component("YPL023C",987).
component("YGL125W",505).
component("YOR236W",964).
component("YGR204W",547).
component("YBR084W",244).
component("YIR034C",638).
component("YLR142W",768).
component("U65_",167).
component("U63_",165).
component("U62_",164).
component("YOR356W",976).
component("YHR068W",581).
component("YKL150W",716).
component("YIL043C",610).
component("YHR042W",575).
component("YOR221C",961).
component("YMR145C",838).
component("YML120C",819).
component("YKL192C",725).
component("YKL055C",706).
component("YER061C",444).
component("YDL085W",314).
component("YPL171C",1002).
component("YHR179W",597).
component("YMR145C",839).
component("YML120C",820).
component("YKL192C",726).
component("YDL085W",315).
component("YGR234W",550).
component("YFR030W",483).
component("YPL017C",986).
component("YFL018C",471).
component("YPL091W",994).
component("YDR353W",394).
component("YER042W",436).
component("YPR167C",1046).
component("YJR137C",693).
component("YNL052W",864).
component("YMR256C",852).
component("YLR395C",801).
component("YLR038C",757).
component("YIL111W",620).
component("YHR051W",579).
...
component("Q0250",20).
component("Q0045",18).
component("YDR072C",359).
component("YPL266W",1020).
component("YPL273W",1021).
component("YLL062C",753).
component("YDR410C",402).
component("YKR069W",741).
component("YOL096C",922).
component("U47_",152).
component("YER091C",458).
component("YJR073C",684).
component("YGR157W",537).
component("YDR120C",365).
component("YML008C",807).
component("YOR074C",938).
component("YDL033C",305).
component("YOL096C",923).
component("YLR172C",772).
component("YLR058C",760).
component("YDR019C",346).
component("YBR176W",262).
component("YDR408C",401).
component("YMR120C",836).
component("YLR028C",755).
component("YBL013W",212).
component("YJL130C",655).
component("YJL088W",648).
component("YKL024C",701).
component("YPR074C",1037).
component("YBR117C",252).
component("YLR354C",796).
component("YGR043C",524).
component("YMR108W",834).
component("YCL009C",282).
component("YMR062C",829).
component("YNL071W",866).
component("YNR008W",894).
component("YIL160C",630).
component("YNR019W",897).
component("YCR048W",298).
component("U48_",153).
component("YNL277W",886).
component("YMR062C",830).
component("YDR232W",380).
component("YPL231W",1014).
component("YER061C",445).
component("YPL001W",985).
component("YDL052C",309).
component("U8_",192).
component("YDR148C",373).
component("YAR035W",208).
component("YOR377W",980).
component("YGR177C",540).
component("YPL231W",1015).
component("YPL028W",988).
component("YLR299W",784).
component("YGL017W",494).
component("YCR005C",290).
component("YML126C",821).
component("YNL104C",869).
component("YDL182W",336).
component("YDL131W",322).
component("YPR160W",1045).
component("YDR307W",390).
component("YLR258W",781).
component("YFR015C",479).
component("YPL227C",1011).
component("YNL029C",861).
component("YIL085C",616).
component("YNL192W",876).
component("YBR038W",239).
component("YBR023C",235).
component("YEL011W",417).
component("YMR306W",858).
component("YLR342W",794).
component("YGR032W",522).
component("YPR183W",1049).
component("YBR248C",271).
component("YLR209C",775).
component("U104_",25).
component("U103_",24).
component("YOR209C",959).
component("YMR300C",855).
component("YER055C",440).
component("YDR354W",395) :- not remove_orf("YDR354W",395).
component("YFR047C",485).
component("YJR133W",692).
component("U22_",129).
component("YLR209C",776).
component("YML022W",809).
component("YDR441C",405).
component("YHR128W",590).
component("YPR176C",1048).
component("YPL172C",1003).
component("YNR041C",901).
component("YMR101C",832).
component("YDL090C",317).
component("YBR003W",227).
component("YBR002C",226).
component("YJL167W",664).
component("YJL167W",665).
component("YNL256W",881).
component("YPR069C",1034).
component("YDR127W",368).
component("YHR190W",600).
component("YLR146C",769).
component("YPL214C",1009).
component("YHR068W",582).
component("YLR303W",786).
component("YGR012W",520).
component("YML082W",817).
component("YJR130C",691).
component("YLR303W",787).
component("YDR035W",348).
component("YBR249C",272).
component("YLR180W",774).
component("YDR502C",409).
component("YOR274W",965).
component("YOL143C",930).
component("YBR256C",274).
component("YHR137W",591).
component("YGL202W",512).
component("YLR027C",754).
component("YKL106W",710).
component("YOL140W",929).
component("YLR438W",804).
component("YGR019W",521).
component("YLR089C",764).
component("YDR111C",364).
component("U64_",166).
component("U61_",163).
component("U51_",155).
component("YJR148W",695).
component("YHR208W",603).
component("YFL030W",473).
component("YOR184W",952).
component("YNR058W",905).
component("YIL116W",622).
component("YGL253W",517).
component("YFR053C",486).
component("YOL136C",928).
component("YIL107C",619).
component("YMR013C",825).
component("YMR205C",845).
component("YGR240C",551).
component("YOL016C",909).
component("YFR014C",478).
component("YLR240W",779).
component("YKL203C",728).
component("YJR066W",683).
component("YCR036W",297).
component("YGR194C",545).
component("YCL040W",286).
component("U15_",70).
component("YPL188W",1005).
component("YJR049C",679).
component("YEL041W",422).
component("U96_",198).
component("YKL001C",699).
component("YDR236C",381).
component("YML070W",815).
component("YFL053W",475).
component("YHL032C",565).
component("YDR531W",414).
component("U83_",186).
component("U82_",185).
component("U81_",184).
component("YMR208W",846).
component("YPL203W",1006).
component("YOR061W",935).
component("YKL166C",718).
component("YJL164C",662).
component("YIL035C",609).
component("YHR205W",602).
component("YHR102W",588).
component("YGL019W",495).
component("YHR025W",574).
component("YOR347C",974).
component("YAL038W",204).
component("YNR012W",895).
component("YPR121W",1042).
component("YPL258C",1017).
component("YOL055C",914).
component("YPL214C",1010).
component("U1_",106).
component("YDR009W",345).
component("YFR019W",480).
component("YDR208W",378).
component("YDR127W",369).
component("U21_",120).
component("U20_",115).
component("YDR147W",372).
component("YDR300C",389).
component("YCR012W",291).
component("YER052C",438).
component("YER069W",449).
component("U19_",105).
component("YKL024C",702).
component("U18_",95).
component("U17_",85).
component("U76_",178).
component("YMR220W",848).
component("YER170W",466).
component("YDR226W",379).
component("YKL067W",708).
component("YOL055C",915).
component("YDR454C",406).
component("YJR057W",681).
component("YOL061W",919).
component("YKL181W",720).
component("YHL011C",563).
component("YER099C",460).
component("YBL068W",222).
component("YOR143C",948).
component("YNL256W",882).
component("YLR328W",792).
component("YBR018C",230).
component("YBR018C",231).
component("YGR007W",519).
component("YGR202C",546).
component("YLR328W",793).
component("YKR002W",734).
component("YDL045C",307).
component("U80_",183).
component("YDL103C",320).
component("U94_",197).
component("YJR010W",674).
component("YBR029C",236).
component("YCL050C",287).
component("YGL130W",506).
component("YDR530C",413).
component("YCL050C",288).
component("YPR190C",1051).
component("YPR187W",1050).
component("YPR110C",1040).
component("YPR010C",1027).
component("YOR341W",973).
component("YOR340C",972).
component("YOR224C",963).
component("YOR210W",960).
component("YOR207C",957).
component("YOR151C",949).
component("YOR116C",941).
component("YOL005C",907).
component("YNR003C",893).
component("YNL248C",880).
component("YNL151C",873).
component("YNL113W",870).
component("YKL144C",714).
component("YJR063W",682).
component("YJL148W",659).
component("YJL140W",658).
component("YIL021W",608).
component("YHR143W-A",592).
component("YGL070C",503).
component("YFL036W",474).
component("YDR404C",400).
component("YDR156W",374).
component("YDR045C",351).
component("YDL150W",330).
component("YDL140C",324).
component("YBR154C",260).
component("YPR175W",1047).
component("YPL167C",1001).
component("YOR330C",969).
component("YOL115W",926).
component("YNL299W",890).
component("YNL262W",884).
component("YNL102W",868).
component("YJR043C",678).
component("YJR006W",672).
component("YJL090C",649).
component("YIL139C",625).
component("YEL055C",426).
component("YDR419W",403).
component("YDR121W",366).
component("YDL102W",319).
component("YCR014C",292).
component("YBR278W",277).
component("YBL035C",216).
component("YKL035W",705).
component("YHL012W",564).
component("YHR123W",589).
component("YPR113W",1041).
component("YBR243C",269).
component("YDL142C",329).
component("YPL148C",999).
component("YER026C",435).
component("YGR286C",560).
component("YJL068C",644).
component("YHR189W",599).
component("YDR058C",356).
component("YNR034W",900).
component("YHR163W",595).
component("YGR248W",553).
component("YCR073W-A",300).
component("YDL086W",316).
component("YOL011W",908).
component("YMR008C",823).
component("YMR006C",822).
component("U105_",26).
component("YBL015W",213).
component("YJL068C",645).
component("YPL072W",993).
component("YOR124C",942).
component("YNL186W",875).
component("YMR304W",857).
component("YMR223W",849).
component("YKR098C",746).
component("YJL197W",666).
component("YIL156W",628).
component("YFR010W",477).
component("YER151C",464).
component("YER144C",463).
component("YER098W",459).
component("YDR069C",358).
component("YDL122W",321).
component("YBR058C",240).
component("YBL067C",221).
component("YJR019C",676).
component("YOR040W",934).
component("U84_",187).
component("U77_",179).
component("YDR481C",407).
component("YLR377C",799).
component("YDR074W",360).
component("YFR025C",481).
component("YPL179W",1004).
component("YNR032W",898).
component("YML057W",814).
component("YML016C",808).
component("YLR433C",803).
component("YGR123C",533).
component("YER133W",462).
component("YER089C",456).
component("YDR436W",404).
component("YDR075W",361).
component("YDL188C",337).
component("YDL134C",323).
component("YDL047W",308).
component("YDL006W",301).
component("YBR125C",255).
component("YBL056W",220).
component("YPR073C",1035).
component("YHR215W",604).
component("YDL024C",304).
component("YBR093C",249).
component("YBR092C",248).
component("YAR071W",209).
component("YIL053W",612).
component("YER062C",446).
component("YHR046C",578).
component("U9_",201).
component("YPL228W",1012).
component("YMR180C",842).
component("YDL236W",341).
component("YJL155C",661).
component("YPR073C",1036).
component("YOR208W",958).
component("YNL053W",865).
component("YMR036C",827).
component("YIR026C",636).
component("YIL113W",621).
component("YFR028C",482).
component("YER075C",452).
component("YDL230W",340).
component("YBR276C",276).
component("U34_",141).
component("U33_",140).
component("U32_",139).
component("U31_",138).
...
component("U25_",132).
component("U24_",131).
component("YHR044C",577).
component("YHR043C",576).
component("YOL064C",920).
component("YOR360C",977).
component("YGL248W",516).
component("YKR031C",737).
component("YPL206C",1007).
component("YGL027C",497).
component("YLR286C",783).
component("YJR153W",696).
component("YJL221C",671).
component("YJL216C",669).
component("YIL172C",634).
component("YGR292W",562).
component("YGR287C",561).
component("YBR299W",281).
component("YBR184W",263).
component("YIL162W",631).
component("YPR026W",1028).
component("YDR001C",343).
component("YBR001C",225).
component("YIR019C",635).
component("YIL099W",618).
component("YDL037C",306).
component("YOR190W",954).
component("YLR300W",785).
component("YGR282C",559).
component("YDR261C",384).
component("YDR400W",398).
component("U23_",130).
component("YML035C",810).
component("YJL070C",646).
component("YBR284W",278).
component("U106_",27).
component("U102_",23).
component("YER043C",437).
component("YNL045W",863).
component("YGL037C",498).
component("YDR242W",382).
component("YLR308W",791).
component("YLR307W",790).
component("YBR208C",265).
component("YMR281W",854).
component("U53_",157).
component("YIR032C",637).
component("YPR062W",1033).
component("YMR120C",837).
component("YLR028C",756).
component("YHR144C",593).
component("YHR144C",594).
component("YGR267C",558).
component("YCL030C",285).
component("YBL033C",215).
component("YBR153W",259).
component("YNL141W",871).
component("YLR245C",780).
component("YML035C",811).
component("YGR204W",548).
component("YBR084W",245).
component("YJL126W",653).
component("U44_",149).
component("YDL100C",318).
component("U87_",189).
component("U40_",147).
component("U39_",145).
component("YBR011C",229).
component("YHR201C",601).
component("YBR111C",250).
component("YBR252W",273).
component("YEL042W",423).
component("YPR080W",1038).
component("YOR187W",953).
component("YOR133W",945).
component("YLR069C",762).
component("YKR084C",743).
component("YKL173W",719).
component("YJL102W",651).
component("YDR385W",397).
component("YBR118W",253).
component("YER005W",431).
component("YLL001W",747).
component("YIL048W",611).
component("YER166W",465).
component("YDR093W",363).
component("YAL026C",203).
component("YBL099W",224).
component("U60_",162).
component("YLR231C",777).
component("U88_",190).
component("YDR538W",416).
component("YLR134W",766).
component("YLR044C",758).
component("YGR087C",529).
component("YDR380W",396).
component("YDL080C",313).
component("U98_",199).
component("YMR250W",851).
component("YKL184W",724).
component("YOR128C",943).
component("YEL021W",420).
component("YNR043W",902).
component("U93_",196).
component("YDR047W",353).
component("U54_",158).
component("YKL211C",730) :- not remove_orf("YKL211C",730).
component("YKR097W",745).
component("YOL052C",913).
component("YNL169C",874).
component("YGR170W",538).
component("YKL060C",707).
component("YNL256W",883).
component("YDR294C",387).
component("YEL046C",424).
component("YNR033W",899).
component("YPR006C",1026).
component("YER065C",447).
component("YKL211C",731) :- not remove_orf("YKL211C",731).
component("YER090W",731) :- not remove_orf("YER090W",731).
component("YER090W",457) :- not remove_orf("YER090W",457).
component("YDR127W",370).
component("YPL281C",1024).
component("YOR393W",984).
component("YMR323W",859).
component("YHR174W",596).
component("YGR254W",554).
component("YOR202W",956).
component("YPL262W",1018).
component("YGL026C",496) :- not remove_orf("YGL026C",496).
component("YGR155W",536).
component("YLR304C",788).
component("YJL200C",667).
component("YGL009C",491).
component("YNL316C",891).
component("YKL182W",722).
component("YPL212C",1008).
component("YNL292W",889).
component("YGL063W",502).
component("YFL001W",469).
component("YOR278W",966).
component("YPR002W",1025).
component("YJR016C",675).
component("YCR053W",299).
component("YDR127W",371).
component("YGL148W",507).
component("YIL168W",633).
component("YIL167W",632).
component("YCL064C",289).
component("YER086W",454).
component("YLR359W",798).
component("YAL012W",202).
component("YML004C",806).
component("YFR055W",487).
component("YJL005W",640).
component("YJL121C",652).
component("YBR019C",232).
component("YBR019C",233).
component("YDR050C",354).
component("YIL020C",607).
component("YDR007W",344) :- not remove_orf("YDR007W",344).
component("YOR095C",939).
component("YER003C",430).
component("YBR196C",264).
component("YGL001C",489).
component("YPL117C",997).
component("U14_",62).
component("YOL056W",916).
component("YKL152C",717).
component("YDL021W",302).
component("YMR105C",833).
component("YKL127W",712).
component("YEL058W",427).
component("YPR060C",1032).
component("YHR072W",583).
component("YJL153C",660).
component("YPL097W",995).
component("YGR185C",543).
component("YGR264C",557).
component("YGR171C",539).
component("YHR011W",570).
component("YDR023W",347).
component("YPL104W",996).
component("YLL018C",748).
component("YPR081C",1039).
component("YBR121C",254).
component("YHR020W",573).
component("YER087W",455).
component("YNL247W",879).
component("YOL033W",911).
component("YOR168W",950).
component("YOL097C",924).
component("YDR268W",385).
component("YPR047W",1031).
component("YLR060W",761).
component("YFL022C",472).
component("YPR033C",1029).
component("YHR019C",571).
component("YCR024C",293).
component("YHR019C",572).
component("YKL194C",727).
component("YIL078W",615).
component("YPL160W",1000).
component("YLR382C",800).
component("YPL040C",990).
component("YBL076C",223).
component("YNL073W",867).
component("YDR037W",349).
component("YOR335C",970).
component("YGR094W",531).
component("YLR153C",770).
component("YAL054C",205).
component("YOR317W",967).
component("YMR246W",850).
component("YIL009W",606).
component("YER015W",433).
component("YOR142W",947).
component("YGR244C",552).
component("YPR035W",1030).
component("YIL145C",626).
component("U89_",191).
component("YOR339C",971).
component("YMR022W",826).
component("YLR306W",789).
component("YKL210W",729).
component("YGR133W",535).
component("YGL058W",500).
component("YER100W",461).
component("YEL012W",418).
component("YDR177W",376).
component("YDR092W",362).
component("YDR059C",357).
component("YDR054C",355).
component("YDL064W",310).
component("YBR082C",243).
component("YJL101C",650).
component("YOL049W",912).
component("U92_",195).
component("YAR015W",207).
component("YGL234W",514).
component("YER183C",468).
component("U91_",194).
component("U90_",193).
component("YNR057C",904).
component("YDL141W",325).
component("YDL141W",326).
component("YGL234W",515).
component("YDL141W",327).
component("YJR103W",688).
component("YBL039C",217).
component("YGR204W",549).
component("YBR084W",246).
component("YNL220W",877).
component("YOL058W",917).
component("YBR208C",266).
component("YDL141W",328).
component("YHR074W",584).
component("YMR217W",847).
component("YGR061C",527).
component("YPR145W",1044).
component("YGR124W",534).
component("YJR109C",690).
component("YJL130C",656).
component("YGL062W",501).
component("YBR218C",267).
component("YPL231W",1016).
component("YNR016C",896).
component("YKL182W",723).
component("YGR037C",523).
component("YJL087C",647).
component("YPR138C",1043).
component("YPL265W",1019).
component("YPL134C",998).
component("YPL057C",991).
component("YPL036W",989).
component("YOR348C",975).
component("YOR222W",962).
component("YOR192C",955).
component("YOR171C",951).
component("YOR130C",944).
component("YOR100C",940).
component("YOR071C",937).
component("YOR011W",933).
component("YOL156W",932).
component("YOL103W",925).
component("YOL020W",910) :- not remove_orf("YOL020W",910).
component("YNR072W",906).
component("YNR056C",903).
component("YNL318C",892).
component("YNL270C",885).
component("YNL142W",872).
component("YMR272C",853).
component("YMR202W",844).
component("YMR056C",828).
component("YMR011W",824).
component("YLR348C",795).
component("YLR260W",782).
component("YLR237W",778).
component("YLR138W",767).
component("YLR100C",765).
component("YLR081W",763).
component("YLL061W",752).
component("YLL043W",750).
component("YKR093W",744).
...
component("YJR095W",687).
component("YJR077C",685).
component("YJL219W",670).
component("YJL214W",668).
component("YJL134W",657).
component("YJL129C",654).
component("YIL134W",624).
component("YHR096C",587).
component("YHR094C",586).
component("YHR092C",585).
component("YHL036W",566).
component("YGR121C",532).
component("YGR065C",528).
component("YGR055W",525).
component("YGL186C",509).
component("YGL077C",504).
component("YGL008C",490).
component("YFL055W",476).
component("YFL011W",470).
component("YER060W-A",443).
component("YER060W",442).
component("YER056C",441).
component("YER053C",439).
component("YEL069C",429).
component("YEL063C",428).
component("YEL017C-A",419).
component("YDR536W",415).
component("YDR508C",411).
component("YDR503C",410).
component("YDR497C",408).
component("YDR345C",393).
component("YDR343C",392).
component("YDR342C",391).
component("YDR297W",388).
component("YDR284C",386).
component("YDR046C",352) :- not remove_orf("YDR046C",352).
component("YDL245C",342).
component("YDL210W",338).
component("YCR032W",296).
component("YCR028C",295).
component("YCR024C-A",294).
component("YCL025C",284).
component("YBR298C",280).
component("YBR291C",279).
component("YBR085W",247).
component("YBR069C",242) :- not remove_orf("YBR069C",242).
component("YBR068C",241) :- not remove_orf("YBR068C",241).
component("YBR036C",238).
component("YBR021W",234).
component("YBL042C",218).
component("YBL030C",214).
component("U85_",188).
component("U7_",182).
component("U79_",181).
component("U78_",180).
...
catalyst(6160,855).
catalyst(3870,440).
catalyst(3620,395) :- not remove_reaction(3620,395).
catalyst(2110,485).
catalyst(2190,485).
catalyst(5550,692).
catalyst(5301,129).
...
catalyst(1890,457) :- not remove_reaction(1890,457).
catalyst(3630,457) :- not remove_reaction(3630,457).
catalyst(3740,370).
catalyst(8231,1024).
catalyst(8232,1024).
catalyst(8231,984).
...
catalyst(8282,354).
catalyst(3840,607).
catalyst(3610,344) :- not remove_reaction(3610,344).
catalyst(7921,939).
catalyst(7922,939).
catalyst(7841,430).
catalyst(7842,430).
...
catalyst(1210,932).
catalyst(1160,925).
catalyst(801,910) :- not remove_reaction(801,910).
catalyst(802,910) :- not remove_reaction(802,910).
catalyst(811,910) :- not remove_reaction(811,910).
catalyst(812,910) :- not remove_reaction(812,910).
catalyst(831,910) :- not remove_reaction(831,910).
catalyst(832,910) :- not remove_reaction(832,910).
catalyst(901,910) :- not remove_reaction(901,910).
catalyst(902,910) :- not remove_reaction(902,910).
catalyst(1180,906).
catalyst(1210,906).
catalyst(700,903).
catalyst(1200,892).
...
catalyst(650,744).
catalyst(6560,739).
catalyst(681,738) :- not remove_reaction(681,738).
catalyst(682,738) :- not remove_reaction(682,738).
...
catalyst(851,738) :- not remove_reaction(851,738).
catalyst(852,738) :- not remove_reaction(852,738).
...
catalyst(931,738) :- not remove_reaction(931,738).
catalyst(932,738) :- not remove_reaction(932,738).
...
catalyst(6650,388).
catalyst(6690,386).
catalyst(791,352) :- not remove_reaction(791,352).
catalyst(792,352) :- not remove_reaction(792,352).
catalyst(801,352) :- not remove_reaction(801,352).
catalyst(802,352) :- not remove_reaction(802,352).
catalyst(811,352) :- not remove_reaction(811,352).
catalyst(812,352) :- not remove_reaction(812,352).
catalyst(831,352) :- not remove_reaction(831,352).
catalyst(832,352) :- not remove_reaction(832,352).
catalyst(841,352) :- not remove_reaction(841,352).
catalyst(842,352) :- not remove_reaction(842,352).
catalyst(851,352) :- not remove_reaction(851,352).
catalyst(852,352) :- not remove_reaction(852,352).
catalyst(901,352) :- not remove_reaction(901,352).
catalyst(902,352) :- not remove_reaction(902,352).
catalyst(1180,342).
catalyst(1210,342).
catalyst(690,338).
catalyst(730,338).
...
catalyst(1512,279).
catalyst(1590,247).
catalyst(771,242) :- not remove_reaction(771,242).
catalyst(772,242) :- not remove_reaction(772,242).
catalyst(791,242) :- not remove_reaction(791,242).
catalyst(792,242) :- not remove_reaction(792,242).
catalyst(801,242) :- not remove_reaction(801,242).
catalyst(802,242) :- not remove_reaction(802,242).
catalyst(811,242) :- not remove_reaction(811,242).
catalyst(812,242) :- not remove_reaction(812,242).
catalyst(851,242) :- not remove_reaction(851,242).
catalyst(852,242) :- not remove_reaction(852,242).
catalyst(901,242) :- not remove_reaction(901,242).
catalyst(902,242) :- not remove_reaction(902,242).
