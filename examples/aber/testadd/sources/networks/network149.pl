...
component("YNL280C",758).
component("YLR056W",650).
component("YGR060W",449).
component("YGL012W",420).
component("YKR009C",630).
component("YOL086C",789).
component("YMR303C",730).
component("YMR083W",710).
component("YGL256W",442).
...
component("YHR063C",495).
component("U45_",131).
component("YML056C",697).
component("YLR432W",686).
component("YHR216W",518).
component("YAR075W",187).
component("YAR073W",186).
component("YDR127W",319).
component("YJR139C",597).
component("YML075C",699).
component("YLR450W",689).
component("YOL126C",795).
component("YKL085W",608).
component("YDL078C",273).
component("YKL029C",604).
component("YNL037C",735).
component("YNL009W",733).
component("YLR174W",663).
component("YHR183W",511).
component("YGR256W",473).
component("YNL241C",750).
component("YOL059W",786).
component("YDL022W",265).
component("YCL018W",247).
component("YLR355C",681).
component("YIL074C",525).
component("YER081W",390).
component("YML054C",696).
component("YDL174C",295).
component("YML086C",701).
component("YIL155C",537).
component("YEL024W",365).
component("YKR066C",635).
component("YGR088W",453).
component("YDR256C",333).
component("YKL026C",603).
component("YIR037W",547).
component("YBR244W",234).
component("YJR078W",589).
component("U58_",141).
component("YJR025C",580).
component("U107_",27).
component("YGR255C",472).
component("U108_",28).
component("YHR007C",484).
component("YDR402C",347).
component("YGL055W",427).
component("YJR104C",592).
component("YHR008C",485).
component("YOR384W",834).
component("YOR381W",833).
component("YOL152W",797).
component("YLL051C",643).
component("YJL026W",549).
component("YIL066C",524).
component("YGR180C",461).
component("YER070W",387).
component("U37_",125).
component("U36_",124).
component("U35_",123).
component("YDL168W",292).
component("YDR158W",327).
component("YJR009C",576).
component("YJL052W",551).
component("YGR192C",463).
component("YBR006W",199).
component("YPL276W",866).
component("YPL275W",865).
component("YOR388C",835).
component("YPL061W",842).
component("YOR374W",831).
component("YER073W",388).
component("YGL154C",434).
component("YBR115C",217).
component("U55_",140).
component("YER069W",385).
component("YOR323C",823).
component("YMR170C",720).
component("YMR169C",719).
component("YER178W",400).
component("YBR221C",232).
...
component("YKL216W",628).
component("YDR044W",309).
component("YER014W",375).
component("YKR009C",631).
component("YIL160C",538).
component("YGL205W",439).
component("YMR118C",714).
component("YLR164W",661).
component("YLL041C",641).
component("YKL148C",613).
component("YKL141W",611).
component("YJL045W",550).
component("YDR178W",328).
component("YJR051W",583).
component("YEL047C",368).
component("YDL171C",293).
component("YDL171C",294).
component("YOR375C",832).
component("YDL215C",299).
component("YAL062W",183).
component("U99_",177).
component("U100_",21).
component("YBR035C",207).
component("YKR080W",637).
component("YER023W",376).
component("YOR236W",821).
component("YGR204W",465).
component("YIR034C",546).
component("YLR142W",658).
component("U65_",148).
component("U63_",146).
component("U62_",145).
component("YHR068W",496).
component("YKL150W",614).
component("YIL043C",522).
component("YHR042W",490).
component("YOR221C",818).
component("YMR145C",717).
component("YKL192C",622).
component("YKL055C",606).
component("YER061C",383).
component("YDL085W",275).
component("YPL171C",850).
component("YHR179W",510).
component("YMR145C",718).
component("YML120C",702).
component("YKL192C",623).
component("YDL085W",276).
component("YGR234W",468).
component("YFR030W",413).
component("YPL017C",838).
component("YFL018C",404).
component("YDR353W",343).
component("YPR167C",883).
component("YJR137C",596).
component("YNL052W",737).
component("YMR256C",727).
component("YLR395C",685).
component("YLR038C",648).
component("YIL111W",530).
component("YHR051W",494).
component("YGL191W",437).
component("YGL187C",436).
component("YDL067C",272).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",314).
component("YPL266W",864).
component("YKR069W",636).
component("YOL096C",790).
component("U47_",133).
component("YER091C",395).
component("YJR073C",587).
component("YGR157W",458).
component("YDR120C",317).
component("YML008C",691).
component("YOR074C",802).
component("YDL033C",267).
component("YOL096C",791).
component("YLR172C",662).
component("YLR058C",651).
component("YDR019C",305).
component("YBR176W",227).
component("YDR408C",349).
component("YMR120C",715).
component("YLR028C",646).
component("YBL013W",188).
component("YJL130C",561).
component("YJL088W",555).
component("YKL024C",602).
component("YPR074C",878).
component("YBR117C",218).
component("YMR108W",713).
component("YCL009C",246).
component("YNL071W",739).
component("YNR008W",765).
component("YIL160C",539).
component("YNR019W",768).
component("YCR048W",261).
component("U48_",134).
component("YMR062C",709).
component("YDR232W",330).
component("YPL231W",859).
component("YER061C",384).
component("YPL001W",837).
component("YDL052C",271).
component("U8_",171).
component("YDR148C",325).
component("YPL231W",860).
component("YPL028W",839).
component("YLR299W",673).
component("YGL017W",422).
component("YCR005C",253).
component("YML126C",703).
component("YNL104C",742).
component("YDL182W",296).
component("YDL131W",282).
component("YDR307W",339).
component("YLR258W",670).
component("YFR015C",410).
component("YNL029C",734).
component("YIL085C",527).
component("YNL192W",748).
component("YBR038W",209).
component("YBR023C",205).
component("YMR306W",731).
component("YLR342W",679).
component("YGR032W",446).
component("YPR183W",886).
component("YBR248C",235).
component("YLR209C",665).
component("U104_",24).
component("U103_",23).
component("YDR354W",344) :- not remove_orf("YDR354W",344).
component("YFR047C",414).
component("YJR133W",595).
component("YLR209C",666).
component("YML022W",693).
component("YDR441C",352).
component("YHR128W",505).
component("YPR176C",885).
component("YPL172C",851).
component("YNR041C",771).
component("YMR101C",711).
component("YDL090C",278).
component("YBR003W",198).
component("YBR002C",197).
component("YJL167W",568).
component("YJL167W",569).
component("YNL256W",753).
component("YPR069C",875).
component("YDR127W",320).
component("YHR190W",513).
component("YLR146C",659).
component("YHR068W",497).
component("YLR303W",675).
component("YGR012W",444).
component("YML082W",700).
component("YJR130C",594).
component("YDR035W",307).
component("YBR249C",236).
component("YLR180W",664).
component("YDR502C",356).
component("YOR274W",822).
component("YBR256C",238).
component("YHR137W",506).
component("YGL202W",438).
component("YLR027C",645).
component("YKL106W",609).
component("YOL140W",796).
component("YLR438W",688).
component("YGR019W",445).
component("YLR089C",654).
component("U64_",147).
component("U61_",144).
component("U51_",136).
component("YJR148W",598).
component("YHR208W",516).
component("YFL030W",406).
component("YOR184W",812).
component("YNR058W",775).
component("YIL116W",532).
component("YGL253W",441).
component("YFR053C",415).
component("YMR013C",707).
component("YMR205C",723).
component("YGR240C",469).
component("YOL016C",779).
component("YFR014C",409).
component("YLR240W",668).
component("YKL203C",625).
component("YJR066W",586).
component("YCR036W",260).
component("YCL040W",249).
component("U15_",64).
component("YPL188W",853).
component("YJR049C",582).
component("YEL041W",366).
component("U96_",175).
component("YKL001C",601).
component("YDR236C",331).
component("YHL032C",482).
component("YDR531W",360).
component("U83_",166).
component("U82_",165).
component("U81_",164).
component("YMR208W",724).
component("YPL203W",854).
component("YOR061W",801).
component("YKL166C",616).
component("YJL164C",567).
component("YIL035C",521).
component("YHR205W",515).
component("YHR102W",503).
component("YGL019W",423).
component("YHR025W",489).
component("YOR347C",828).
component("YAL038W",181).
component("YNR012W",766).
component("YDR009W",304).
component("YDR127W",321).
component("YDR147W",324).
component("YDR300C",338).
component("YCR012W",254).
component("YER069W",386).
component("U19_",96).
component("U18_",87).
component("U17_",78).
component("U76_",158).
component("YER170W",399).
component("YDR226W",329).
component("YKL067W",607).
component("YOL055C",783).
component("YDR454C",353).
component("YJR057W",584).
component("YOL061W",787).
component("YKL181W",617).
component("YHL011C",480).
component("YER099C",396).
component("YBL068W",195).
component("YOR143C",808).
component("YNL256W",754).
component("YLR328W",677).
component("YBR018C",201).
component("YBR018C",202).
component("YGR007W",443).
component("YGR202C",464).
component("YLR328W",678).
component("YDL045C",269).
component("U80_",163).
component("YDL103C",281).
component("U94_",174).
component("YJR010W",577).
component("YBR029C",206).
component("YCL050C",250).
component("YGL130W",432).
component("YDR530C",359).
component("YCL050C",251).
component("YPR190C",888).
component("YPR187W",887).
component("YPR110C",880).
component("YPR010C",869).
component("YOR341W",827).
component("YOR340C",826).
component("YOR224C",820).
component("YOR210W",817).
component("YOR207C",815).
component("YOR151C",809).
component("YOR116C",804).
component("YOL005C",777).
component("YNR003C",764).
component("YNL248C",752).
component("YNL151C",746).
component("YNL113W",743).
component("YKL144C",612).
component("YJR063W",585).
component("YJL148W",565).
component("YJL140W",564).
component("YIL021W",520).
component("YHR143W-A",507).
component("YGL070C",430).
component("YFL036W",407).
component("YDR404C",348).
component("YDR156W",326).
component("YDR045C",310).
component("YDL150W",290).
component("YDL140C",284).
component("YBR154C",225).
component("YPR175W",884).
component("YPL167C",849).
component("YOR330C",824).
component("YOL115W",794).
component("YNL299W",761).
component("YNL262W",756).
component("YNL102W",741).
component("YJR043C",581).
component("YJR006W",575).
component("YJL090C",556).
component("YIL139C",535).
component("YEL055C",369).
component("YDR419W",350).
component("YDR121W",318).
component("YDL102W",280).
component("YCR014C",255).
component("YBR278W",241).
component("YBL035C",191).
component("YKL035W",605).
component("YHL012W",481).
component("YHR123W",504).
component("YPR113W",881).
component("YBR243C",233).
component("YDL142C",289).
component("YPL148C",847).
component("YER026C",377).
component("YGR286C",477).
component("YJL068C",552).
component("YHR189W",512).
component("YDR058C",313).
component("YDL086W",277).
component("YOL011W",778).
component("YMR008C",705).
component("YMR006C",704).
component("U105_",25).
component("YBL015W",189).
component("YJL068C",553).
component("YJR019C",579).
component("YOR040W",800).
component("U77_",159).
component("YDR481C",354).
component("YLR377C",683).
component("YFR025C",411).
component("YPL179W",852).
component("YNR032W",769).
component("YML057W",698).
component("YML016C",692).
component("YLR433C",687).
component("YGR123C",456).
component("YER133W",397).
component("YER089C",393).
component("YDR436W",351).
component("YDR075W",315).
component("YDL188C",297).
component("YDL134C",283).
component("YDL047W",270).
component("YDL006W",263).
component("YBR125C",220).
...
component("YHR046C",493).
component("U9_",178).
component("YPL228W",857).
component("YMR180C",721).
component("YDL236W",301).
component("YJL155C",566).
component("YPR073C",877).
component("YOR208W",816).
component("YNL053W",738).
component("YMR036C",708).
component("YIR026C",545).
component("YIL113W",531).
component("YFR028C",412).
component("YER075C",389).
component("YDL230W",300).
...
component("U25_",113).
component("U24_",112).
component("YHR044C",492).
component("YHR043C",491).
component("YOL064C",788).
component("YOR360C",830).
component("YKR031C",632).
component("YPL206C",855).
component("YGL027C",425).
component("YLR286C",672).
component("YJR153W",599).
component("YJL221C",574).
component("YJL216C",572).
component("YIL172C",543).
component("YGR292W",479).
component("YGR287C",478).
component("YBR299W",245).
component("YBR184W",228).
component("YIL162W",540).
component("YIR019C",544).
component("YIL099W",529).
component("YDL037C",268).
component("YOR190W",813).
component("YLR300W",674).
component("YGR282C",476).
component("YDR261C",334).
component("YDR400W",346).
component("U23_",111).
component("YML035C",694).
component("YJL070C",554).
component("YBR284W",242).
component("U106_",26).
component("U102_",22).
component("YER043C",378).
component("YNL045W",736).
component("YGL037C",426).
component("YDR242W",332).
component("YBR208C",230).
component("YMR281W",729).
component("U53_",138).
component("YPR062W",874).
component("YMR120C",716).
component("YLR028C",647).
component("YHR144C",508).
component("YGR267C",475).
component("YBL033C",190).
component("YBR153W",224).
component("YNL141W",744).
component("YLR245C",669).
component("YML035C",695).
component("YGR204W",466).
component("YBR084W",212).
component("YJL126W",559).
component("U44_",130).
component("YDL100C",279).
component("U87_",168).
component("U40_",128).
component("U39_",126).
component("YBR011C",200).
component("YHR201C",514).
component("YBR111C",216).
component("YBR252W",237).
component("YER005W",374).
component("YIL048W",523).
component("YER166W",398).
component("YDR093W",316).
component("YAL026C",180).
component("YBL099W",196).
component("U60_",143).
component("YLR231C",667).
component("U88_",169).
component("YDR538W",362).
component("YLR134W",656).
component("YLR044C",649).
component("YGR087C",452).
component("YDR380W",345).
component("YDL080C",274).
component("U98_",176).
component("YMR250W",726).
component("YKL184W",621).
component("YOR128C",805).
component("YEL021W",364).
component("YNR043W",772).
component("U93_",173).
component("U54_",139).
component("YKL211C",626) :- not remove_orf("YKL211C",626).
component("YKR097W",639).
component("YOL052C",782).
component("YNL169C",747).
component("YGR170W",459).
component("YNL256W",755).
component("YDR294C",336).
component("YEL046C",367).
component("YNR033W",770).
component("YKL211C",627) :- not remove_orf("YKL211C",627).
component("YER090W",627) :- not remove_orf("YER090W",627).
component("YER090W",394) :- not remove_orf("YER090W",394).
component("YDR127W",322).
component("YPL281C",867).
component("YOR393W",836).
component("YMR323W",732).
component("YHR174W",509).
component("YGR254W",471).
component("YOR202W",814).
component("YPL262W",862).
component("YGL026C",424) :- not remove_orf("YGL026C",424).
component("YGR155W",457).
component("YLR304C",676).
component("YJL200C",570).
component("YNL316C",762).
component("YKL182W",619).
component("YPL212C",856).
component("YNL292W",760).
component("YGL063W",429).
component("YFL001W",402).
component("YPR002W",868).
component("YJR016C",578).
component("YCR053W",262).
component("YDR127W",323).
component("YGL148W",433).
component("YIL168W",542).
component("YIL167W",541).
component("YCL064C",252).
component("YER086W",391).
component("YLR359W",682).
component("YAL012W",179).
component("YML004C",690).
component("YFR055W",416).
component("YJL005W",548).
component("YJL121C",558).
component("YBR019C",203).
component("YDR050C",312).
component("YIL020C",519).
component("YDR007W",303) :- not remove_orf("YDR007W",303).
component("YOR095C",803).
component("YER003C",373).
component("YBR196C",229).
component("YGL001C",418).
component("YPL117C",845).
component("U14_",56).
component("YOL056W",784).
component("YKL152C",615).
component("YDL021W",264).
component("YMR105C",712).
component("YKL127W",610).
component("YEL058W",370).
component("YPR060C",873).
component("YHR072W",498).
component("YPL097W",843).
component("YGR185C",462).
component("YGR264C",474).
component("YGR171C",460).
component("YHR011W",486).
component("YDR023W",306).
component("YPL104W",844).
component("YLL018C",640).
component("YPR081C",879).
component("YBR121C",219).
component("YHR020W",488).
component("YER087W",392).
component("YNL247W",751).
component("YOR168W",810).
component("YOL097C",792).
component("YDR268W",335).
component("YPR047W",872).
component("YLR060W",652).
component("YFL022C",405).
component("YPR033C",870).
component("YCR024C",256).
component("YHR019C",487).
component("YKL194C",624).
component("YIL078W",526).
component("YPL160W",848).
component("YLR382C",684).
component("YNL073W",740).
component("YDR037W",308).
component("YOR335C",825).
component("YGR094W",454).
component("YLR153C",660).
component("YAL054C",182).
component("YOR142W",807).
component("YGR244C",470).
component("YPR035W",871).
component("YIL145C",536).
component("U89_",170).
component("YJL101C",557).
component("YOL049W",781).
component("YAR015W",184).
component("YER183C",401).
component("U90_",172).
component("YNR057C",774).
component("YDL141W",285).
component("YDL141W",286).
component("YGL234W",440).
component("YDL141W",287).
component("YJR103W",591).
component("YBL039C",192).
component("YGR204W",467).
component("YBR084W",213).
component("YNL220W",749).
component("YOL058W",785).
component("YDL141W",288).
component("YHR074W",499).
component("YMR217W",725).
component("YGR061C",450).
component("YJR109C",593).
component("YJL130C",562).
component("YGL062W",428).
component("YBR218C",231).
component("YPL231W",861).
component("YNR016C",767).
component("YKL182W",620).
component("YGR037C",447).
component("YPR138C",882).
component("YPL265W",863).
component("YPL134C",846).
component("YPL057C",841).
component("YPL036W",840).
component("YOR348C",829).
component("YOR222W",819).
component("YOR171C",811).
component("YOR130C",806).
component("YOR011W",799).
component("YOL156W",798).
component("YOL103W",793).
component("YOL020W",780) :- not remove_orf("YOL020W",780).
component("YNR072W",776).
component("YNR056C",773).
component("YNL318C",763).
component("YNL270C",757).
component("YNL142W",745).
component("YMR272C",728).
component("YMR202W",722).
component("YMR011W",706).
component("YLR348C",680).
component("YLR260W",671).
component("YLR138W",657).
component("YLR100C",655).
component("YLR081W",653).
component("YLL061W",644).
component("YLL043W",642).
component("YKR093W",638).
component("YKR053C",634).
component("YKR039W",633) :- not remove_orf("YKR039W",633).
component("YKL217W",629).
component("YJR158W",600).
component("YJR095W",590).
component("YJR077C",588).
component("YJL219W",573).
component("YJL214W",571).
component("YJL134W",563).
component("YJL129C",560).
component("YIL134W",534).
component("YHR096C",502).
component("YHR094C",501).
component("YHR092C",500).
component("YHL036W",483).
component("YGR121C",455).
component("YGR065C",451).
component("YGR055W",448).
component("YGL186C",435).
component("YGL077C",431).
component("YGL008C",419).
component("YFL055W",408).
component("YFL011W",403).
component("YER060W-A",382).
component("YER060W",381).
component("YER056C",380).
component("YER053C",379).
component("YEL069C",372).
component("YEL063C",371).
component("YEL017C-A",363).
component("YDR536W",361).
component("YDR508C",358).
component("YDR503C",357).
component("YDR497C",355).
component("YDR345C",342).
component("YDR343C",341).
component("YDR342C",340).
component("YDR297W",337).
component("YDR046C",311) :- not remove_orf("YDR046C",311).
component("YDL245C",302).
component("YDL210W",298).
component("YCR032W",259).
component("YCR028C",258).
component("YCR024C-A",257).
component("YCL025C",248).
component("YBR298C",244).
component("YBR291C",243).
component("YBR069C",211) :- not remove_orf("YBR069C",211).
component("YBR068C",210) :- not remove_orf("YBR068C",210).
component("YBR036C",208).
component("YBR021W",204).
...
catalyst(2300,173).
catalyst(3460,139).
catalyst(3600,626) :- not remove_reaction(3600,626).
catalyst(8000,639).
catalyst(3941,782).
catalyst(3942,782).
catalyst(6890,747).
...
catalyst(4560,367).
catalyst(2550,770).
catalyst(1890,627) :- not remove_reaction(1890,627).
catalyst(3630,627) :- not remove_reaction(3630,627).
...
catalyst(8061,862).
catalyst(8062,862).
catalyst(3590,424) :- not remove_reaction(3590,424).
catalyst(10910,424) :- not remove_reaction(10910,424).
catalyst(4570,457).
catalyst(8181,676).
catalyst(8182,676).
catalyst(8181,570).
...
catalyst(8282,312).
catalyst(3840,519).
catalyst(3610,303) :- not remove_reaction(3610,303).
catalyst(7921,803).
catalyst(7922,803).
catalyst(7841,373).
catalyst(7842,373).
...
catalyst(1210,798).
catalyst(1160,793).
catalyst(801,780) :- not remove_reaction(801,780).
catalyst(802,780) :- not remove_reaction(802,780).
catalyst(811,780) :- not remove_reaction(811,780).
catalyst(812,780) :- not remove_reaction(812,780).
catalyst(831,780) :- not remove_reaction(831,780).
catalyst(832,780) :- not remove_reaction(832,780).
catalyst(901,780) :- not remove_reaction(901,780).
catalyst(902,780) :- not remove_reaction(902,780).
catalyst(1180,776).
catalyst(1210,776).
catalyst(700,773).
catalyst(1200,763).
...
catalyst(851,633) :- not remove_reaction(851,633).
catalyst(852,633) :- not remove_reaction(852,633).
...
catalyst(931,633) :- not remove_reaction(931,633).
catalyst(932,633) :- not remove_reaction(932,633).
...
catalyst(1210,340).
catalyst(6650,337).
catalyst(791,311) :- not remove_reaction(791,311).
catalyst(792,311) :- not remove_reaction(792,311).
catalyst(801,311) :- not remove_reaction(801,311).
catalyst(802,311) :- not remove_reaction(802,311).
catalyst(811,311) :- not remove_reaction(811,311).
catalyst(812,311) :- not remove_reaction(812,311).
catalyst(831,311) :- not remove_reaction(831,311).
catalyst(832,311) :- not remove_reaction(832,311).
catalyst(841,311) :- not remove_reaction(841,311).
catalyst(842,311) :- not remove_reaction(842,311).
catalyst(851,311) :- not remove_reaction(851,311).
catalyst(852,311) :- not remove_reaction(852,311).
catalyst(901,311) :- not remove_reaction(901,311).
catalyst(902,311) :- not remove_reaction(902,311).
catalyst(1180,302).
catalyst(1210,302).
catalyst(690,298).
catalyst(730,298).
...
catalyst(1511,243).
catalyst(1512,243).
catalyst(771,211) :- not remove_reaction(771,211).
catalyst(772,211) :- not remove_reaction(772,211).
...
catalyst(831,210) :- not remove_reaction(831,210).
catalyst(832,210) :- not remove_reaction(832,210).
catalyst(841,210) :- not remove_reaction(841,210).
catalyst(842,210) :- not remove_reaction(842,210).
...
modifiable_enzyme(424).
modifiable_enzyme(303).
modifiable_enzyme(780).
