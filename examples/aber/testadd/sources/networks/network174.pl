...
component("YNL280C",871).
component("YLR056W",746).
component("YGR060W",516).
component("YGL012W",482).
component("YKR009C",723).
component("YOL086C",905).
component("YMR303C",842).
component("YMR083W",818).
component("YGL256W",508).
component("YDL168W",326).
...
component("YJR159W",686).
component("YGL001C",478).
component("YIL094C",607).
component("YHR063C",570).
component("U45_",148).
component("YML056C",800).
component("YLR432W",789).
component("YHR216W",595).
component("YAR075W",209).
component("YAR073W",208).
component("YDR127W",361).
component("YJR139C",682).
component("YML075C",803).
component("YLR450W",792).
component("YOL126C",911).
component("YKL085W",697).
component("YDL078C",308).
component("YKL029C",692).
component("YOR136W",929).
component("YNL037C",847).
component("YNL009W",845).
component("YLR174W",760).
component("YHR183W",588).
component("YGR256W",546).
component("YNL241C",862).
component("YOL059W",902).
component("YDL022W",299).
component("YCL018W",279).
component("YLR355C",784).
component("YIL074C",604).
component("YER081W",447).
component("YML054C",799).
component("YDL174C",330).
component("YML086C",805).
component("YIL155C",617).
component("YPR191W",1034).
component("YOR065W",920).
component("YJL166W",652).
component("YHR001W-A",557).
component("YGR183C",532).
component("YFR033C",474).
component("YEL024W",415).
component("YDR529C",406).
component("YBL045C",217).
component("Q0105",19).
component("YKR066C",728).
component("YGR088W",520).
component("YDR256C",377).
component("YKL026C",691).
component("YIR037W",628).
component("YBR244W",266).
component("YJR078W",674).
component("U58_",158).
component("YJR025C",665).
component("U107_",28).
component("YGR255C",545).
component("U108_",29).
component("YHR007C",558).
component("YDR402C",393).
component("YGL055W",489).
component("YJR104C",677).
component("YHR008C",559).
component("YOR384W",965).
component("YOR381W",964).
component("YOL152W",915).
component("YLL051C",738).
component("YJL026W",630).
component("YIL066C",603).
component("YGR180C",531).
component("YER070W",444).
component("U37_",142).
component("U36_",141).
component("U35_",140).
component("YDL168W",327).
component("YDR158W",369).
component("YJR009C",661).
component("YJL052W",632).
component("YGR192C",534).
component("YBR006W",225).
component("YPL276W",1005).
component("YPL275W",1004).
component("YOR388C",966).
component("YPL061W",975).
component("YOR374W",961).
component("YER073W",445).
component("YGL154C",498).
component("YBR115C",247).
component("U55_",157).
component("YER069W",442).
component("YOR323C",951).
component("YMR170C",828).
component("YMR169C",827).
component("YER178W",458).
component("YBR221C",264).
component("YIL125W",613).
component("U52_",154).
component("YBR166C",257).
component("YNL280C",872).
component("YGL012W",483).
component("YKL182W",709).
component("YKL216W",720).
component("YDR044W",345).
component("YER014W",426).
component("YKR009C",724).
component("YIL160C",618).
component("YGL205W",503).
component("YMR118C",822).
component("YLR164W",758).
component("YLL041C",736).
component("YKL148C",703).
component("YKL141W",701).
component("YJL045W",631).
component("YDR178W",371).
component("YJR051W",668).
component("YEL047C",419).
component("YDL171C",328).
component("YDL171C",329).
component("YOR375C",962).
component("YDL215C",334).
component("YAL062W",204).
component("U99_",198).
component("U100_",22).
component("YBR035C",234).
component("YMR189W",830).
component("YKR080W",730).
component("YER023W",428).
component("YPL023C",970).
component("YGL125W",495).
component("YOR236W",947).
component("YGR204W",537).
component("YBR084W",240).
component("YIR034C",627).
component("YLR142W",755).
component("U65_",165).
component("U63_",163).
component("U62_",162).
component("YOR356W",959).
component("YHR068W",571).
component("YKL150W",704).
component("YIL043C",600).
component("YHR042W",565).
component("YOR221C",944).
component("YMR145C",825).
component("YML120C",806).
component("YKL192C",713).
component("YKL055C",694).
component("YER061C",438).
component("YDL085W",310).
component("YPL171C",984).
component("YHR179W",587).
component("YMR145C",826).
component("YML120C",807).
component("YKL192C",714).
component("YDL085W",311).
component("YGR234W",540).
component("YFR030W",473).
component("YPL017C",969).
component("YFL018C",462).
component("YPL091W",976).
component("YDR353W",388).
component("YER042W",430).
component("YPR167C",1028).
component("YJR137C",681).
component("YNL052W",849).
component("YMR256C",838).
component("YLR395C",788).
component("YLR038C",744).
component("YIL111W",610).
component("YHR051W",569).
...
component("Q0250",20).
component("Q0045",18).
component("YDR072C",353).
component("YPL266W",1002).
component("YPL273W",1003).
component("YLL062C",740).
component("YDR410C",396).
component("YKR069W",729).
component("YOL096C",906).
component("U47_",150).
component("YER091C",452).
component("YJR073C",672).
component("YGR157W",527).
component("YDR120C",359).
component("YML008C",794).
component("YOR074C",922).
component("YDL033C",301).
component("YOL096C",907).
component("YLR172C",759).
component("YLR058C",747).
component("YDR019C",341).
component("YBR176W",258).
component("YDR408C",395).
component("YMR120C",823).
component("YLR028C",742).
component("YBL013W",210).
component("YJL130C",644).
component("YJL088W",637).
component("YKL024C",689).
component("YPR074C",1019).
component("YBR117C",248).
component("YLR354C",783).
component("YGR043C",514).
component("YMR108W",821).
component("YCL009C",278).
component("YMR062C",816).
component("YNL071W",851).
component("YNR008W",878).
component("YIL160C",619).
component("YNR019W",881).
component("YCR048W",294).
component("U48_",151).
component("YNL277W",870).
component("YMR062C",817).
component("YDR232W",374).
component("YPL231W",996).
component("YER061C",439).
component("YPL001W",968).
component("YDL052C",305).
component("U8_",190).
component("YDR148C",367).
component("YAR035W",206).
component("YOR377W",963).
component("YGR177C",530).
component("YPL231W",997).
component("YPL028W",971).
component("YLR299W",771).
component("YGL017W",484).
component("YCR005C",286).
component("YML126C",808).
component("YNL104C",854).
component("YDL182W",331).
component("YDL131W",317).
component("YPR160W",1027).
component("YDR307W",384).
component("YLR258W",768).
component("YFR015C",469).
component("YPL227C",993).
component("YNL029C",846).
component("YIL085C",606).
component("YNL192W",860).
component("YBR038W",236).
component("YBR023C",232).
component("YEL011W",411).
component("YMR306W",843).
component("YLR342W",781).
component("YGR032W",512).
component("YPR183W",1031).
component("YBR248C",267).
component("YLR209C",762).
component("U104_",25).
component("U103_",24).
component("YOR209C",942).
component("YMR300C",841).
component("YER055C",434).
component("YDR354W",389) :- not remove_orf("YDR354W",389).
component("YFR047C",475).
component("YJR133W",680).
component("U22_",127).
component("YLR209C",763).
component("YML022W",796).
component("YDR441C",399).
component("YHR128W",580).
component("YPR176C",1030).
component("YPL172C",985).
component("YNR041C",885).
component("YMR101C",819).
component("YDL090C",313).
component("YBR003W",224).
component("YBR002C",223).
component("YJL167W",653).
component("YJL167W",654).
component("YNL256W",865).
component("YPR069C",1016).
component("YDR127W",362).
component("YHR190W",590).
component("YLR146C",756).
component("YPL214C",991).
component("YHR068W",572).
component("YLR303W",773).
component("YGR012W",510).
component("YML082W",804).
component("YJR130C",679).
component("YLR303W",774).
component("YDR035W",343).
component("YBR249C",268).
component("YLR180W",761).
component("YDR502C",403).
component("YOR274W",948).
component("YOL143C",914).
component("YBR256C",270).
component("YHR137W",581).
component("YGL202W",502).
component("YLR027C",741).
component("YKL106W",698).
component("YOL140W",913).
component("YLR438W",791).
component("YGR019W",511).
component("YLR089C",751).
component("YDR111C",358).
component("U64_",164).
component("U61_",161).
component("U51_",153).
component("YJR148W",683).
component("YHR208W",593).
component("YFL030W",464).
component("YOR184W",935).
component("YNR058W",889).
component("YIL116W",612).
component("YGL253W",507).
component("YFR053C",476).
component("YOL136C",912).
component("YIL107C",609).
component("YMR013C",812).
component("YMR205C",832).
component("YGR240C",541).
component("YOL016C",893).
component("YFR014C",468).
component("YLR240W",766).
component("YKL203C",716).
component("YJR066W",671).
component("YCR036W",293).
component("YGR194C",535).
component("YCL040W",282).
component("U15_",70).
component("YPL188W",987).
component("YJR049C",667).
component("YEL041W",416).
component("U96_",196).
component("YKL001C",687).
component("YDR236C",375).
component("YML070W",802).
component("YFL053W",466).
component("YHL032C",555).
component("YDR531W",408).
component("U83_",184).
component("U82_",183).
component("U81_",182).
...
component("YKL166C",706).
component("YJL164C",651).
component("YIL035C",599).
component("YHR205W",592).
component("YHR102W",578).
component("YGL019W",485).
component("YHR025W",564).
component("YOR347C",957).
component("YAL038W",202).
component("YNR012W",879).
component("YPR121W",1024).
component("YPL258C",999).
component("YOL055C",898).
component("YPL214C",992).
component("U1_",106).
component("YDR009W",340).
component("YFR019W",470).
component("YDR208W",372).
component("YDR127W",363).
component("U21_",118).
component("U20_",115).
component("YDR147W",366).
component("YDR300C",383).
component("YCR012W",287).
component("YER052C",432).
component("YER069W",443).
component("U19_",105).
component("YKL024C",690).
component("U18_",95).
component("U17_",85).
component("U76_",176).
component("YMR220W",835).
component("YER170W",457).
component("YDR226W",373).
component("YKL067W",696).
component("YOL055C",899).
component("YDR454C",400).
component("YJR057W",669).
component("YOL061W",903).
component("YKL181W",708).
component("YHL011C",553).
component("YER099C",453).
component("YBL068W",219).
component("YOR143C",931).
component("YNL256W",866).
component("YLR328W",779).
component("YBR018C",227).
component("YBR018C",228).
component("YGR007W",509).
component("YGR202C",536).
component("YLR328W",780).
component("YKR002W",722).
component("YDL045C",303).
component("U80_",181).
component("YDL103C",316).
component("U94_",195).
component("YJR010W",662).
component("YBR029C",233).
component("YCL050C",283).
component("YGL130W",496).
component("YDR530C",407).
component("YCL050C",284).
component("YPR190C",1033).
component("YPR187W",1032).
component("YPR110C",1022).
component("YPR010C",1009).
component("YOR341W",956).
component("YOR340C",955).
component("YOR224C",946).
component("YOR210W",943).
component("YOR207C",940).
component("YOR151C",932).
component("YOR116C",925).
component("YOL005C",891).
component("YNR003C",877).
component("YNL248C",864).
component("YNL151C",858).
component("YNL113W",855).
component("YKL144C",702).
component("YJR063W",670).
component("YJL148W",648).
component("YJL140W",647).
component("YIL021W",598).
component("YHR143W-A",582).
component("YGL070C",493).
component("YFL036W",465).
component("YDR404C",394).
component("YDR156W",368).
component("YDR045C",346).
component("YDL150W",325).
component("YDL140C",319).
component("YBR154C",256).
component("YPR175W",1029).
component("YPL167C",983).
component("YOR330C",952).
component("YOL115W",910).
component("YNL299W",874).
component("YNL262W",868).
component("YNL102W",853).
component("YJR043C",666).
component("YJR006W",660).
component("YJL090C",638).
component("YIL139C",615).
component("YEL055C",420).
component("YDR419W",397).
component("YDR121W",360).
component("YDL102W",315).
component("YCR014C",288).
component("YBR278W",273).
component("YBL035C",214).
component("YKL035W",693).
component("YHL012W",554).
component("YHR123W",579).
component("YPR113W",1023).
component("YBR243C",265).
component("YDL142C",324).
component("YPL148C",981).
component("YER026C",429).
component("YGR286C",550).
component("YJL068C",633).
component("YHR189W",589).
component("YDR058C",351).
component("YNR034W",884).
component("YHR163W",585).
component("YGR248W",543).
component("YCR073W-A",296).
component("YDL086W",312).
component("YOL011W",892).
component("YMR008C",810).
component("YMR006C",809).
component("U105_",26).
component("YBL015W",211).
component("YJL068C",634).
component("YJR019C",664).
component("YOR040W",918).
component("U84_",185).
component("U77_",177).
component("YDR481C",401).
component("YLR377C",786).
component("YDR074W",354).
component("YFR025C",471).
component("YPL179W",986).
component("YNR032W",882).
component("YML057W",801).
component("YML016C",795).
component("YLR433C",790).
component("YGR123C",523).
component("YER133W",455).
component("YER089C",450).
component("YDR436W",398).
component("YDR075W",355).
component("YDL188C",332).
component("YDL134C",318).
component("YDL047W",304).
component("YDL006W",297).
component("YBR125C",251).
component("YBL056W",218).
component("YPR073C",1017).
component("YHR215W",594).
component("YDL024C",300).
component("YBR093C",245).
component("YBR092C",244).
component("YAR071W",207).
component("YIL053W",602).
component("YER062C",440).
component("YHR046C",568).
component("U9_",199).
component("YPL228W",994).
component("YMR180C",829).
component("YDL236W",336).
component("YJL155C",650).
component("YPR073C",1018).
component("YOR208W",941).
component("YNL053W",850).
component("YMR036C",814).
component("YIR026C",625).
component("YIL113W",611).
component("YFR028C",472).
component("YER075C",446).
component("YDL230W",335).
...
component("U25_",130).
component("U24_",129).
component("YHR044C",567).
component("YHR043C",566).
component("YOL064C",904).
component("YOR360C",960).
component("YGL248W",506).
component("YKR031C",725).
component("YPL206C",989).
component("YGL027C",487).
component("YLR286C",770).
component("YJR153W",684).
component("YJL221C",659).
component("YJL216C",657).
component("YIL172C",623).
component("YGR292W",552).
component("YGR287C",551).
component("YBR299W",277).
component("YBR184W",259).
component("YIL162W",620).
component("YPR026W",1010).
component("YDR001C",338).
component("YBR001C",222).
component("YIR019C",624).
component("YIL099W",608).
component("YDL037C",302).
component("YOR190W",937).
component("YLR300W",772).
component("YGR282C",549).
component("YDR261C",378).
component("YDR400W",392).
component("U23_",128).
component("YML035C",797).
component("YJL070C",635).
component("YBR284W",274).
component("U106_",27).
component("U102_",23).
component("YER043C",431).
component("YNL045W",848).
component("YGL037C",488).
component("YDR242W",376).
component("YLR308W",778).
component("YLR307W",777).
component("YBR208C",261).
component("YMR281W",840).
component("U53_",155).
component("YIR032C",626).
component("YPR062W",1015).
component("YMR120C",824).
component("YLR028C",743).
component("YHR144C",583).
component("YHR144C",584).
component("YGR267C",548).
component("YCL030C",281).
component("YBL033C",213).
component("YBR153W",255).
component("YNL141W",856).
component("YLR245C",767).
component("YML035C",798).
component("YGR204W",538).
component("YBR084W",241).
component("YJL126W",642).
component("U44_",147).
component("YDL100C",314).
component("U87_",187).
component("U40_",145).
component("U39_",143).
component("YBR011C",226).
component("YHR201C",591).
component("YBR111C",246).
component("YBR252W",269).
component("YEL042W",417).
component("YPR080W",1020).
component("YOR187W",936).
component("YOR133W",928).
component("YLR069C",749).
component("YKR084C",731).
component("YKL173W",707).
component("YJL102W",640).
component("YDR385W",391).
component("YBR118W",249).
component("YER005W",425).
component("YLL001W",734).
component("YIL048W",601).
component("YER166W",456).
component("YDR093W",357).
component("YAL026C",201).
component("YBL099W",221).
component("U60_",160).
component("YLR231C",764).
component("U88_",188).
component("YDR538W",410).
component("YLR134W",753).
component("YLR044C",745).
component("YGR087C",519).
component("YDR380W",390).
component("YDL080C",309).
component("U98_",197).
component("YMR250W",837).
component("YKL184W",712).
component("YOR128C",926).
component("YEL021W",414).
component("YNR043W",886).
component("U93_",194).
component("YDR047W",348).
component("U54_",156).
component("YKL211C",718) :- not remove_orf("YKL211C",718).
component("YKR097W",733).
component("YOL052C",897).
component("YNL169C",859).
component("YGR170W",528).
component("YKL060C",695).
component("YNL256W",867).
component("YDR294C",381).
component("YEL046C",418).
component("YNR033W",883).
component("YPR006C",1008).
component("YER065C",441).
component("YKL211C",719) :- not remove_orf("YKL211C",719).
component("YER090W",719) :- not remove_orf("YER090W",719).
component("YER090W",451) :- not remove_orf("YER090W",451).
component("YDR127W",364).
component("YPL281C",1006).
component("YOR393W",967).
component("YMR323W",844).
component("YHR174W",586).
component("YGR254W",544).
component("YOR202W",939).
component("YPL262W",1000).
component("YGL026C",486) :- not remove_orf("YGL026C",486).
component("YGR155W",526).
component("YLR304C",775).
component("YJL200C",655).
component("YGL009C",481).
component("YNL316C",875).
component("YKL182W",710).
component("YPL212C",990).
component("YNL292W",873).
component("YGL063W",492).
component("YFL001W",460).
component("YOR278W",949).
component("YPR002W",1007).
component("YJR016C",663).
component("YCR053W",295).
component("YDR127W",365).
component("YGL148W",497).
component("YIL168W",622).
component("YIL167W",621).
component("YCL064C",285).
component("YER086W",448).
component("YLR359W",785).
component("YAL012W",200).
component("YML004C",793).
component("YFR055W",477).
component("YJL005W",629).
component("YJL121C",641).
component("YBR019C",229).
component("YBR019C",230).
component("YDR050C",349).
component("YIL020C",597).
component("YDR007W",339) :- not remove_orf("YDR007W",339).
component("YOR095C",923).
component("YER003C",424).
component("YBR196C",260).
component("YGL001C",479).
component("YPL117C",979).
component("U14_",62).
component("YOL056W",900).
component("YKL152C",705).
component("YDL021W",298).
component("YMR105C",820).
component("YKL127W",700).
component("YEL058W",421).
component("YPR060C",1014).
component("YHR072W",573).
component("YJL153C",649).
component("YPL097W",977).
component("YGR185C",533).
component("YGR264C",547).
component("YGR171C",529).
component("YHR011W",560).
component("YDR023W",342).
component("YPL104W",978).
component("YLL018C",735).
component("YPR081C",1021).
component("YBR121C",250).
component("YHR020W",563).
component("YER087W",449).
component("YNL247W",863).
component("YOL033W",895).
component("YOR168W",933).
component("YOL097C",908).
component("YDR268W",379).
component("YPR047W",1013).
component("YLR060W",748).
component("YFL022C",463).
component("YPR033C",1011).
component("YHR019C",561).
component("YCR024C",289).
component("YHR019C",562).
component("YKL194C",715).
component("YIL078W",605).
component("YPL160W",982).
component("YLR382C",787).
component("YPL040C",973).
component("YBL076C",220).
component("YNL073W",852).
component("YDR037W",344).
component("YOR335C",953).
component("YGR094W",521).
component("YLR153C",757).
component("YAL054C",203).
component("YOR317W",950).
component("YMR246W",836).
component("YIL009W",596).
component("YER015W",427).
component("YOR142W",930).
component("YGR244C",542).
component("YPR035W",1012).
component("YIL145C",616).
component("U89_",189).
component("YOR339C",954).
component("YMR022W",813).
component("YLR306W",776).
component("YKL210W",717).
component("YGR133W",525).
component("YGL058W",490).
component("YER100W",454).
component("YEL012W",412).
component("YDR177W",370).
component("YDR092W",356).
component("YDR059C",352).
component("YDR054C",350).
component("YDL064W",306).
component("YBR082C",239).
component("YJL101C",639).
component("YOL049W",896).
component("U92_",193).
component("YAR015W",205).
component("YGL234W",504).
component("YER183C",459).
component("U91_",192).
component("U90_",191).
component("YNR057C",888).
component("YDL141W",320).
component("YDL141W",321).
component("YGL234W",505).
component("YDL141W",322).
component("YJR103W",676).
component("YBL039C",215).
component("YGR204W",539).
component("YBR084W",242).
component("YNL220W",861).
component("YOL058W",901).
component("YBR208C",262).
component("YDL141W",323).
component("YHR074W",574).
component("YMR217W",834).
component("YGR061C",517).
component("YPR145W",1026).
component("YGR124W",524).
component("YJR109C",678).
component("YJL130C",645).
component("YGL062W",491).
component("YBR218C",263).
component("YPL231W",998).
component("YNR016C",880).
component("YKL182W",711).
component("YGR037C",513).
component("YJL087C",636).
component("YPR138C",1025).
component("YPL265W",1001).
component("YPL134C",980).
component("YPL057C",974).
component("YPL036W",972).
component("YOR348C",958).
component("YOR222W",945).
component("YOR192C",938).
component("YOR171C",934).
component("YOR130C",927).
component("YOR100C",924).
component("YOR071C",921).
component("YOR011W",917).
component("YOL156W",916).
component("YOL103W",909).
component("YOL020W",894) :- not remove_orf("YOL020W",894).
component("YNR072W",890).
component("YNR056C",887).
component("YNL318C",876).
component("YNL270C",869).
component("YNL142W",857).
component("YMR272C",839).
component("YMR202W",831).
component("YMR056C",815).
component("YMR011W",811).
component("YLR348C",782).
component("YLR260W",769).
component("YLR237W",765).
component("YLR138W",754).
component("YLR100C",752).
component("YLR081W",750).
component("YLL061W",739).
component("YLL043W",737).
component("YKR093W",732).
component("YKR053C",727).
component("YKR039W",726) :- not remove_orf("YKR039W",726).
component("YKL217W",721).
component("YKL120W",699).
component("YKL004W",688).
component("YJR158W",685).
component("YJR095W",675).
component("YJR077C",673).
component("YJL219W",658).
component("YJL214W",656).
component("YJL134W",646).
component("YJL129C",643).
component("YIL134W",614).
component("YHR096C",577).
component("YHR094C",576).
component("YHR092C",575).
component("YHL036W",556).
component("YGR121C",522).
component("YGR065C",518).
component("YGR055W",515).
component("YGL186C",499).
component("YGL077C",494).
component("YGL008C",480).
component("YFL055W",467).
component("YFL011W",461).
component("YER060W-A",437).
component("YER060W",436).
component("YER056C",435).
component("YER053C",433).
component("YEL069C",423).
component("YEL063C",422).
component("YEL017C-A",413).
component("YDR536W",409).
component("YDR508C",405).
component("YDR503C",404).
component("YDR497C",402).
component("YDR345C",387).
component("YDR343C",386).
component("YDR342C",385).
component("YDR297W",382).
component("YDR284C",380).
component("YDR046C",347) :- not remove_orf("YDR046C",347).
component("YDL245C",337).
component("YDL210W",333).
component("YCR032W",292).
component("YCR028C",291).
component("YCR024C-A",290).
component("YCL025C",280).
component("YBR298C",276).
component("YBR291C",275).
component("YBR085W",243).
component("YBR069C",238) :- not remove_orf("YBR069C",238).
component("YBR068C",237) :- not remove_orf("YBR068C",237).
component("YBR036C",235).
component("YBR021W",231).
component("YBL042C",216).
component("YBL030C",212).
component("U85_",186).
component("U7_",180).
component("U79_",179).
component("U78_",178).
...
catalyst(6160,841).
catalyst(3870,434).
catalyst(3620,389) :- not remove_reaction(3620,389).
catalyst(2110,475).
catalyst(2190,475).
catalyst(5550,680).
catalyst(5301,127).
...
catalyst(1960,348).
catalyst(3460,156).
catalyst(3600,718) :- not remove_reaction(3600,718).
catalyst(8000,733).
catalyst(3941,897).
catalyst(3942,897).
catalyst(6890,859).
...
catalyst(8020,1008).
catalyst(8020,441).
catalyst(1890,719) :- not remove_reaction(1890,719).
catalyst(3630,719) :- not remove_reaction(3630,719).
catalyst(1890,451) :- not remove_reaction(1890,451).
catalyst(3630,451) :- not remove_reaction(3630,451).
catalyst(3740,364).
catalyst(8231,1006).
catalyst(8232,1006).
catalyst(8231,967).
...
catalyst(8282,349).
catalyst(3840,597).
catalyst(3610,339) :- not remove_reaction(3610,339).
catalyst(7921,923).
catalyst(7922,923).
catalyst(7841,424).
catalyst(7842,424).
...
catalyst(1210,916).
catalyst(1160,909).
catalyst(801,894) :- not remove_reaction(801,894).
catalyst(802,894) :- not remove_reaction(802,894).
catalyst(811,894) :- not remove_reaction(811,894).
catalyst(812,894) :- not remove_reaction(812,894).
catalyst(831,894) :- not remove_reaction(831,894).
catalyst(832,894) :- not remove_reaction(832,894).
catalyst(901,894) :- not remove_reaction(901,894).
catalyst(902,894) :- not remove_reaction(902,894).
catalyst(1180,890).
catalyst(1210,890).
catalyst(700,887).
catalyst(1200,876).
...
catalyst(650,732).
catalyst(6560,727).
catalyst(681,726) :- not remove_reaction(681,726).
catalyst(682,726) :- not remove_reaction(682,726).
catalyst(771,726) :- not remove_reaction(771,726).
catalyst(772,726) :- not remove_reaction(772,726).
catalyst(781,726) :- not remove_reaction(781,726).
catalyst(782,726) :- not remove_reaction(782,726).
catalyst(791,726) :- not remove_reaction(791,726).
catalyst(792,726) :- not remove_reaction(792,726).
catalyst(801,726) :- not remove_reaction(801,726).
catalyst(802,726) :- not remove_reaction(802,726).
catalyst(811,726) :- not remove_reaction(811,726).
catalyst(812,726) :- not remove_reaction(812,726).
catalyst(831,726) :- not remove_reaction(831,726).
catalyst(832,726) :- not remove_reaction(832,726).
catalyst(841,726) :- not remove_reaction(841,726).
catalyst(842,726) :- not remove_reaction(842,726).
catalyst(851,726) :- not remove_reaction(851,726).
catalyst(852,726) :- not remove_reaction(852,726).
catalyst(881,726) :- not remove_reaction(881,726).
catalyst(882,726) :- not remove_reaction(882,726).
catalyst(901,726) :- not remove_reaction(901,726).
catalyst(902,726) :- not remove_reaction(902,726).
catalyst(911,726) :- not remove_reaction(911,726).
catalyst(912,726) :- not remove_reaction(912,726).
catalyst(921,726) :- not remove_reaction(921,726).
catalyst(922,726) :- not remove_reaction(922,726).
catalyst(931,726) :- not remove_reaction(931,726).
catalyst(932,726) :- not remove_reaction(932,726).
catalyst(1191,726) :- not remove_reaction(1191,726).
catalyst(1192,726) :- not remove_reaction(1192,726).
catalyst(390,721).
catalyst(1021,721).
catalyst(1022,721).
catalyst(1521,699).
...
catalyst(6650,382).
catalyst(6690,380).
catalyst(791,347) :- not remove_reaction(791,347).
catalyst(792,347) :- not remove_reaction(792,347).
catalyst(801,347) :- not remove_reaction(801,347).
catalyst(802,347) :- not remove_reaction(802,347).
catalyst(811,347) :- not remove_reaction(811,347).
catalyst(812,347) :- not remove_reaction(812,347).
catalyst(831,347) :- not remove_reaction(831,347).
catalyst(832,347) :- not remove_reaction(832,347).
catalyst(841,347) :- not remove_reaction(841,347).
catalyst(842,347) :- not remove_reaction(842,347).
catalyst(851,347) :- not remove_reaction(851,347).
catalyst(852,347) :- not remove_reaction(852,347).
catalyst(901,347) :- not remove_reaction(901,347).
catalyst(902,347) :- not remove_reaction(902,347).
catalyst(1180,337).
catalyst(1210,337).
catalyst(690,333).
catalyst(730,333).
...
catalyst(831,237) :- not remove_reaction(831,237).
catalyst(832,237) :- not remove_reaction(832,237).
catalyst(841,237) :- not remove_reaction(841,237).
catalyst(842,237) :- not remove_reaction(842,237).
catalyst(851,237) :- not remove_reaction(851,237).
catalyst(852,237) :- not remove_reaction(852,237).
...
modifiable_enzyme(718).
modifiable_enzyme(719).
modifiable_enzyme(451).
modifiable_enzyme(486).
modifiable_enzyme(339).
modifiable_enzyme(894).
modifiable_enzyme(726).
