...
component("YKR009C",370).
component("YOL086C",465).
component("YMR303C",425).
component("YGL256W",264).
component("YDL168W",170).
component("YBR145W",131).
component("YPL231W",509).
component("U46_",76).
component("YBR149W",132).
component("YGL001C",243).
component("YIL094C",313).
component("U45_",75).
component("YML056C",414).
component("YLR432W",411).
component("YHR216W",308).
component("YAR075W",110).
component("YAR073W",109).
component("YDR127W",183).
component("YOL126C",470).
component("YKL085W",360).
component("YDL078C",162).
component("YNL037C",430).
component("YNL009W",428).
component("YLR174W",392).
component("YCL018W",147).
component("YLR355C",407).
component("YDL174C",173).
component("YML086C",415).
component("YGR088W",272).
component("YDR256C",193).
component("YJR078W",350).
component("YJR025C",343).
component("U107_",23).
component("YJR104C",352).
component("YHR008C",290).
component("YJL026W",327).
component("YIL066C",311).
component("YGR180C",275).
component("YER070W",223).
component("U36_",69).
component("YDL168W",171).
component("YBR006W",118).
component("YPL276W",517).
component("YPL275W",516).
component("YOR388C",495).
component("YOR374W",494).
component("YER073W",224).
component("U55_",82).
component("YER069W",222).
component("YOR323C",487).
component("YER178W",230).
component("YBR221C",138).
component("YIL125W",317).
component("U52_",80).
component("YBR166C",134).
component("YGL012W",247).
component("YKL216W",369).
component("YKR009C",371).
component("YIL160C",321).
component("YGL205W",261).
component("YDL171C",172).
component("U99_",104).
component("U100_",20).
component("YKR080W",376).
component("YER023W",216).
component("YOR236W",485).
component("YGR204W",277).
component("YLR142W",389).
component("U65_",86).
component("U62_",85).
component("YHR068W",298).
component("YKL150W",363).
component("YIL043C",310).
component("YPL171C",505).
component("YHR179W",305).
component("YGR234W",279).
component("YFR030W",240).
component("YPL017C",497).
component("YFL018C",233).
component("YDR353W",197).
component("YPR167C",529).
component("YJR137C",354).
component("YNL052W",431).
component("YMR256C",424).
component("YLR395C",410).
component("YLR038C",382).
component("YIL111W",314).
component("YHR051W",297).
component("YGL191W",259).
component("YGL187C",258).
component("YDL067C",161).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",515).
component("YKR069W",375).
component("YOL096C",466).
component("U47_",77).
component("YJR073C",348).
component("YDL033C",160).
component("YLR172C",391).
component("YLR058C",385).
component("YDR019C",178).
component("YBR176W",135).
component("YDR408C",202).
component("YMR120C",420).
component("YLR028C",380).
component("YBL013W",111).
component("YJL130C",333).
component("YKL024C",358).
component("YPR074C",525).
component("YBR117C",130).
...
component("YPL028W",498).
component("YLR299W",400).
component("YGL017W",248).
component("YML126C",416).
component("YNL104C",435).
component("YDL182W",174).
component("YDL131W",166).
component("YLR258W",397).
component("YFR015C",238).
component("YNL029C",429).
component("YIL085C",312).
component("YMR306W",426).
component("YLR342W",406).
component("YGR032W",267).
component("YLR209C",393).
component("U104_",21).
component("YDR354W",198) :- not remove_orf("YDR354W",198).
component("YFR047C",241).
component("YLR209C",394).
component("YML022W",412).
component("YDR441C",204).
component("YJL167W",337).
component("YDR127W",184).
component("YHR068W",299).
component("YLR303W",402).
component("YGR012W",265).
component("YJR130C",353).
component("YDR035W",179).
component("YBR249C",139).
component("YOR274W",486).
component("YHR137W",301).
component("YGL202W",260).
component("YLR027C",379).
component("YKL106W",361).
component("YOL140W",471).
component("YGR019W",266).
component("YLR089C",386).
component("U61_",84).
component("YJR148W",355).
component("YFL030W",234).
component("YNR058W",456).
component("YIL116W",316).
component("YGL253W",263).
component("YFR053C",242).
component("YMR205C",422).
component("YGR240C",280).
component("YOL016C",459).
component("YFR014C",237).
component("YCR036W",156).
component("YCL040W",149).
component("YPL188W",506).
component("YJR049C",345).
component("YEL041W",211).
component("U96_",102).
component("YKL001C",357).
component("YDR236C",191).
component("YHL032C",288).
component("U83_",98).
component("YMR208W",423).
component("YHR025W",293).
component("YOR347C",492).
component("YAL038W",107).
component("YNR012W",452).
component("YDR127W",185).
component("YDR147W",188).
component("YCR012W",151).
component("U76_",95).
component("YER170W",229).
component("YDR226W",190).
component("YKL067W",359).
component("YOL055C",462).
component("YDR454C",205).
component("YJR057W",346).
component("YOL061W",464).
component("YKL181W",365).
component("YHL011C",287).
component("YER099C",228).
component("YBL068W",116).
component("YOR143C",476).
component("YNL256W",444).
component("YLR328W",404).
component("YBR018C",120).
component("YLR328W",405).
component("U94_",101).
component("YBR029C",122).
component("YGL130W",255).
component("YPR190C",532).
component("YPR187W",531).
component("YPR110C",526).
component("YPR010C",520).
component("YOR341W",491).
component("YOR340C",490).
component("YOR224C",484).
component("YOR210W",483).
component("YOR207C",481).
component("YOR151C",477).
component("YOR116C",474).
component("YOL005C",457).
component("YNR003C",451).
component("YNL248C",443).
component("YNL151C",439).
...
component("YIL139C",319).
component("YEL055C",213).
component("YDR419W",203).
component("YDR121W",182).
component("YDL102W",165).
component("YCR014C",152).
component("YBR278W",142).
component("YBL035C",114).
component("YPR113W",527).
component("YPL148C",503).
component("YGR286C",284).
component("YHR189W",306).
component("YOL011W",458).
component("YMR008C",418).
component("YMR006C",417).
component("U105_",22).
component("YBL015W",112).
component("U77_",96).
component("YLR377C",409).
component("YPR073C",523).
component("YHR215W",307).
component("YDL024C",159).
component("YBR093C",128).
component("YBR092C",127).
component("YHR046C",296).
component("U9_",105).
component("YDL236W",176).
component("YPR073C",524).
component("YOR208W",482).
component("YNL053W",432).
component("YMR036C",419).
component("YIR026C",326).
component("YIL113W",315).
component("YFR028C",239).
component("YER075C",225).
component("YDL230W",175).
...
component("U25_",63).
component("U24_",62).
component("YHR044C",295).
component("YHR043C",294).
component("YOR360C",493).
component("YKR031C",372).
component("YPL206C",507).
component("YGL027C",250).
component("YLR286C",399).
component("YJR153W",356).
component("YJL221C",340).
component("YJL216C",339).
component("YIL172C",325).
component("YGR292W",286).
component("YGR287C",285).
component("YBR299W",145).
component("YOR190W",480).
component("YLR300W",401).
component("YGR282C",283).
component("YDR261C",194).
component("YDR400W",200).
component("YML035C",413).
component("YJL070C",328).
component("YBR284W",143).
component("YER043C",217).
component("YDR242W",192).
component("U53_",81).
component("YPR062W",522).
component("YMR120C",421).
component("YLR028C",381).
component("YHR144C",303).
component("YBL033C",113).
component("YNL141W",437).
component("YLR245C",396).
component("YBR084W",125).
component("YJL126W",331).
component("U44_",74).
component("YDL100C",164).
component("U40_",72).
component("U39_",70).
component("YBR011C",119).
component("YBR111C",129).
component("YBR252W",140).
component("YER005W",215).
component("YBL099W",117).
component("YLR231C",395).
component("YLR134W",388).
component("YLR044C",383).
component("YGR087C",271).
component("YDR380W",199).
component("YDL080C",163).
component("U98_",103).
component("YOR128C",475).
component("U93_",100).
component("YKL211C",367) :- not remove_orf("YKL211C",367).
component("YKR097W",377).
component("YNL169C",440).
component("YEL046C",212).
component("YNR033W",454).
component("YKL211C",368) :- not remove_orf("YKL211C",368).
component("YER090W",368) :- not remove_orf("YER090W",368).
component("YER090W",227) :- not remove_orf("YER090W",227).
component("YDR127W",186).
component("YPL281C",518).
component("YOR393W",496).
component("YMR323W",427).
component("YHR174W",304).
component("YGR254W",281).
component("YPL262W",513).
component("YGL026C",249) :- not remove_orf("YGL026C",249).
component("YLR304C",403).
component("YJL200C",338).
component("YNL316C",450).
component("YPL212C",508).
component("YNL292W",448).
component("YGL063W",252).
component("YFL001W",232).
component("YPR002W",519).
component("YJR016C",342).
component("YCR053W",157).
component("YDR127W",187).
component("YGL148W",256).
component("YIL168W",324).
component("YIL167W",323).
component("YCL064C",150).
component("YLR359W",408).
component("YAL012W",106).
...
component("U14_",34).
component("YOL056W",463).
component("YKL152C",364).
component("YDL021W",158).
component("YPR060C",521).
component("YPL097W",500).
component("YGR185C",276).
component("YGR264C",282).
component("YGR171C",274).
component("YPL104W",501).
component("YLL018C",378).
component("YHR020W",292).
component("YER087W",226).
component("YNL247W",442).
component("YOR168W",478).
component("YOL097C",467).
component("YDR268W",195).
component("YCR024C",153).
component("YHR019C",291).
component("YOR335C",489).
component("YLR153C",390).
component("YAL054C",108).
component("YIL145C",320).
component("YJL101C",330).
component("YOL049W",461).
component("YER183C",231).
component("U90_",99).
component("YNR057C",455).
component("YGL234W",262).
component("YJR103W",351).
component("YBL039C",115).
component("YGR204W",278).
component("YBR084W",126).
component("YNL220W",441).
component("YDL141W",168).
component("YHR074W",300).
component("YGL062W",251).
component("YBR218C",137).
component("YPL231W",512).
component("YNR016C",453).
component("YKL182W",366).
component("YGR037C",268).
component("YPR138C",528).
component("YPL265W",514).
component("YPL036W",499).
component("YOR171C",479).
component("YOR011W",472).
component("YOL103W",468).
component("YOL020W",460) :- not remove_orf("YOL020W",460).
component("YNL270C",446).
component("YNL142W",438).
component("YLR260W",398).
component("YLR100C",387).
component("YKR053C",374).
component("YKR039W",373) :- not remove_orf("YKR039W",373).
component("YJR077C",349).
component("YJL134W",334).
component("YJL129C",332).
component("YIL134W",318).
component("YHL036W",289).
component("YGR121C",273).
component("YGR065C",270).
component("YGR055W",269).
component("YGL186C",257).
component("YGL077C",254).
component("YGL008C",245).
component("YFL055W",236).
component("YER060W-A",221).
component("YER060W",220).
component("YER056C",219).
component("YER053C",218).
component("YEL063C",214).
component("YEL017C-A",210).
component("YDR536W",209).
component("YDR508C",208).
component("YDR503C",207).
component("YDR497C",206).
component("YDR297W",196).
component("YDR046C",181) :- not remove_orf("YDR046C",181).
component("YCR032W",155).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,198) :- not remove_reaction(3620,198).
catalyst(2190,241).
catalyst(5791,394).
catalyst(5792,394).
catalyst(5801,394).
...
catalyst(6112,475).
catalyst(2300,100).
catalyst(3600,367) :- not remove_reaction(3600,367).
catalyst(8000,377).
catalyst(6890,440).
catalyst(4560,212).
catalyst(2550,454).
catalyst(1890,368) :- not remove_reaction(1890,368).
catalyst(3630,368) :- not remove_reaction(3630,368).
catalyst(1890,227) :- not remove_reaction(1890,227).
...
catalyst(901,460) :- not remove_reaction(901,460).
catalyst(902,460) :- not remove_reaction(902,460).
catalyst(931,446).
catalyst(932,446).
catalyst(371,438).
catalyst(372,438).
...
catalyst(6330,387).
catalyst(6560,374).
catalyst(771,373) :- not remove_reaction(771,373).
catalyst(772,373) :- not remove_reaction(772,373).
catalyst(781,373) :- not remove_reaction(781,373).
catalyst(782,373) :- not remove_reaction(782,373).
...
catalyst(881,373) :- not remove_reaction(881,373).
catalyst(882,373) :- not remove_reaction(882,373).
catalyst(901,373) :- not remove_reaction(901,373).
catalyst(902,373) :- not remove_reaction(902,373).
catalyst(921,373) :- not remove_reaction(921,373).
catalyst(922,373) :- not remove_reaction(922,373).
catalyst(931,373) :- not remove_reaction(931,373).
catalyst(932,373) :- not remove_reaction(932,373).
catalyst(1191,373) :- not remove_reaction(1191,373).
catalyst(1192,373) :- not remove_reaction(1192,373).
catalyst(1581,349).
catalyst(1582,349).
catalyst(6560,334).
catalyst(361,332).
