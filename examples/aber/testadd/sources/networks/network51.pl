...
component("YLR056W",300).
component("YKR009C",287).
component("YOL086C",363).
component("YMR303C",333).
component("YGL256W",209).
component("YDL168W",131).
component("YBR145W",99).
component("YPL231W",396).
component("U46_",63).
component("YBR149W",100).
component("YGL001C",191).
component("YIL094C",244).
component("U45_",62).
component("YDR127W",142).
component("YOL126C",367).
component("YKL085W",279).
component("YDL078C",125).
component("YNL037C",337).
component("YCL018W",112).
component("YLR355C",320).
component("YDL174C",133).
component("YML086C",325).
component("YGR088W",215).
component("YDR256C",152).
component("YJR078W",273).
component("YJR025C",267).
component("U107_",23).
component("YJL026W",254).
component("YGR180C",218).
component("YER070W",178).
component("U36_",58).
component("YDL168W",132).
component("YPL276W",402).
component("YPL275W",401).
component("YOR388C",387).
component("YOR323C",381).
component("YIL125W",247).
component("U52_",66).
component("YBR166C",102).
component("YKL216W",286).
component("YKR009C",288).
component("YIL160C",250).
component("YGL205W",206).
component("U100_",20).
component("YKR080W",292).
component("YER023W",173).
component("YGR204W",220).
component("YLR142W",305).
component("U65_",69).
component("U62_",68).
component("YHR068W",233).
component("YKL150W",282).
component("YIL043C",242).
component("YPL171C",395).
component("YHR179W",240).
component("YGR234W",221).
component("YDR353W",156).
component("YNL052W",338).
component("YMR256C",332).
component("YLR395C",322).
component("YLR038C",298).
component("YIL111W",245).
component("YHR051W",232).
component("YGL191W",204).
component("YGL187C",203).
component("YDL067C",124).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",400).
component("YKR069W",291).
component("YJR073C",271).
component("YDL033C",123).
component("YLR172C",307).
component("YLR058C",301).
component("YDR019C",137).
component("YBR176W",103).
component("YDR408C",161).
component("YMR120C",330).
component("YLR028C",296).
component("YBL013W",83).
component("YJL130C",259).
component("YKL024C",277).
component("YPR074C",409).
component("YBR117C",98).
component("YCL009C",111).
component("YNL071W",340).
component("U48_",64).
component("YPL231W",397).
component("YPL231W",398).
component("YLR299W",314).
component("YGL017W",194).
component("YML126C",326).
component("YDL182W",134).
component("YDL131W",128).
component("YLR258W",312).
component("YFR015C",187).
component("YNL029C",336).
component("YIL085C",243).
component("YMR306W",334).
component("YLR342W",319).
component("YGR032W",211).
component("YLR209C",308).
component("U104_",21).
component("YDR354W",157) :- not remove_orf("YDR354W",157).
component("YFR047C",189).
component("YLR209C",309).
component("YML022W",323).
component("YDR441C",163).
component("YJL167W",263).
component("YDR127W",143).
component("YHR068W",234).
component("YLR303W",316).
component("YGR012W",210).
component("YJR130C",275).
component("YDR035W",138).
component("YBR249C",105).
component("YOR274W",380).
component("YHR137W",236).
component("YGL202W",205).
component("YLR027C",295).
component("YKL106W",280).
component("YOL140W",368).
component("YLR089C",302).
component("YJR148W",276).
component("YFL030W",183).
component("YNR058W",356).
component("YGL253W",208).
component("YFR053C",190).
component("YOL016C",359).
component("YFR014C",186).
component("YCR036W",121).
component("YCL040W",114).
component("U96_",79).
component("YDR236C",150).
component("YHL032C",227).
component("YNR012W",354).
component("YDR127W",144).
component("YDR147W",147).
component("YCR012W",116).
component("U76_",76).
component("YER170W",182).
component("YDR226W",149).
component("YKL067W",278).
component("YOL055C",361).
component("YDR454C",164).
component("YJR057W",269).
component("YOL061W",362).
component("YKL181W",283).
component("YHL011C",226).
component("YER099C",181).
component("YBL068W",88).
component("YNL256W",348).
component("YBR018C",91).
component("YLR328W",318).
component("YBR029C",93).
component("YGL130W",200).
component("YPR190C",415).
component("YPR187W",414).
component("YPR110C",410).
component("YPR010C",405).
component("YOR341W",385).
component("YOR340C",384).
component("YOR224C",379).
component("YOR210W",378).
component("YOR207C",376).
component("YOR151C",373).
component("YOR116C",371).
component("YOL005C",357).
component("YNR003C",353).
component("YNL248C",347).
component("YNL151C",345).
component("YNL113W",342).
component("YKL144C",281).
component("YJR063W",270).
component("YJL148W",262).
component("YJL140W",261).
component("YIL021W",241).
component("YHR143W-A",237).
component("YGL070C",198).
component("YFL036W",184).
component("YDR404C",160).
component("YDR156W",148).
component("YDR045C",139).
component("YDL150W",130).
component("YDL140C",129).
component("YBR154C",101).
component("YPR175W",413).
component("YPL167C",394).
component("YOR330C",382).
component("YOL115W",366).
component("YNL299W",351).
component("YNL262W",349).
component("YNL102W",341).
component("YJR043C",268).
component("YJR006W",265).
component("YJL090C",256).
component("YIL139C",248).
component("YEL055C",170).
component("YDR419W",162).
component("YDR121W",141).
component("YDL102W",127).
component("YCR014C",117).
component("YBR278W",108).
component("YBL035C",86).
component("YPR113W",411).
component("YPL148C",393).
component("YGR286C",225).
component("YOL011W",358).
component("YMR008C",328).
component("YMR006C",327).
component("U105_",22).
component("YBL015W",84).
component("U77_",77).
component("YLR377C",321).
component("YPR073C",408).
component("YOR208W",377).
component("YNL053W",339).
component("YMR036C",329).
component("YIR026C",253).
component("YIL113W",246).
component("YFR028C",188).
component("YER075C",179).
component("YDL230W",135).
component("YBR276C",107).
component("U30_",57).
component("U29_",56).
component("U26_",55).
component("U24_",54).
component("YHR044C",231).
component("YHR043C",230).
component("YOR360C",386).
component("YGL027C",196).
component("YOR190W",375).
component("YLR300W",315).
component("YGR282C",224).
component("YDR261C",153).
component("YDR400W",159).
component("YML035C",324).
component("YJL070C",255).
component("YBR284W",109).
component("YDR242W",151).
component("U53_",67).
component("YPR062W",407).
component("YMR120C",331).
component("YLR028C",297).
component("YHR144C",238).
component("YBL033C",85).
component("YNL141W",343).
component("YLR245C",311).
component("YJL126W",257).
component("U39_",59).
component("YBR011C",90).
component("YBR111C",97).
component("YBR252W",106).
component("YER005W",172).
component("YBL099W",89).
component("YLR231C",310).
component("YLR134W",304).
component("YLR044C",299).
component("YGR087C",214).
component("YDR380W",158).
component("YDL080C",126).
component("U98_",80).
component("YOR128C",372).
component("YKL211C",284) :- not remove_orf("YKL211C",284).
component("YKR097W",293).
component("YNL169C",346).
component("YKL211C",285) :- not remove_orf("YKL211C",285).
component("YER090W",285) :- not remove_orf("YER090W",285).
component("YER090W",180) :- not remove_orf("YER090W",180).
component("YDR127W",145).
component("YPL281C",403).
component("YOR393W",388).
component("YMR323W",335).
component("YHR174W",239).
component("YGR254W",222).
component("YGL026C",195) :- not remove_orf("YGL026C",195).
component("YLR304C",317).
component("YJL200C",264).
component("YNL316C",352).
component("YPR002W",404).
component("YJR016C",266).
component("YCR053W",122).
component("YDR127W",146).
component("YGL148W",201).
component("YIL168W",252).
component("YIL167W",251).
component("YCL064C",115).
component("YAL012W",81).
component("YBR019C",92).
component("YDR007W",136) :- not remove_orf("YDR007W",136).
component("YOR095C",370).
component("YGL001C",192).
component("YPL117C",392).
component("YPR060C",406).
component("YPL097W",390).
component("YGR185C",219).
component("YGR264C",223).
component("YGR171C",217).
component("YPL104W",391).
component("YLL018C",294).
component("YOL097C",364).
component("YDR268W",154).
component("YCR024C",118).
component("YHR019C",229).
component("YOR335C",383).
component("YLR153C",306).
component("YAL054C",82).
component("YIL145C",249).
component("U90_",78).
component("YNR057C",355).
component("YGL234W",207).
component("YJR103W",274).
component("YBL039C",87).
component("YBR084W",96).
component("YHR074W",235).
component("YGL062W",197).
component("YBR218C",104).
component("YPR138C",412).
component("YPL265W",399).
component("YPL036W",389).
component("YOR171C",374).
component("YOR011W",369).
component("YOL103W",365).
component("YOL020W",360) :- not remove_orf("YOL020W",360).
component("YNL270C",350).
component("YNL142W",344).
component("YLR260W",313).
component("YLR100C",303).
component("YKR053C",290).
component("YKR039W",289) :- not remove_orf("YKR039W",289).
component("YJR077C",272).
component("YJL134W",260).
component("YJL129C",258).
component("YHL036W",228).
component("YGR121C",216).
component("YGR065C",213).
component("YGR055W",212).
component("YGL186C",202).
component("YGL077C",199).
component("YGL008C",193).
component("YFL055W",185).
component("YER060W-A",177).
component("YER060W",176).
component("YER056C",175).
component("YER053C",174).
component("YEL063C",171).
component("YEL017C-A",169).
component("YDR536W",168).
component("YDR508C",167).
component("YDR503C",166).
component("YDR497C",165).
component("YDR297W",155).
component("YDR046C",140) :- not remove_orf("YDR046C",140).
component("YCR032W",120).
component("YCR024C-A",119).
component("YCL025C",113).
...
catalyst(6111,372).
catalyst(6112,372).
catalyst(3600,284) :- not remove_reaction(3600,284).
catalyst(8000,293).
catalyst(6890,346).
catalyst(3630,285) :- not remove_reaction(3630,285).
catalyst(3630,180) :- not remove_reaction(3630,180).
catalyst(3740,145).
catalyst(8231,403).
catalyst(8232,403).
catalyst(8231,388).
...
catalyst(6330,303).
catalyst(6560,290).
catalyst(771,289) :- not remove_reaction(771,289).
catalyst(772,289) :- not remove_reaction(772,289).
catalyst(781,289) :- not remove_reaction(781,289).
catalyst(782,289) :- not remove_reaction(782,289).
catalyst(801,289) :- not remove_reaction(801,289).
catalyst(802,289) :- not remove_reaction(802,289).
catalyst(811,289) :- not remove_reaction(811,289).
catalyst(812,289) :- not remove_reaction(812,289).
catalyst(831,289) :- not remove_reaction(831,289).
catalyst(832,289) :- not remove_reaction(832,289).
catalyst(841,289) :- not remove_reaction(841,289).
catalyst(842,289) :- not remove_reaction(842,289).
catalyst(851,289) :- not remove_reaction(851,289).
catalyst(852,289) :- not remove_reaction(852,289).
catalyst(881,289) :- not remove_reaction(881,289).
catalyst(882,289) :- not remove_reaction(882,289).
catalyst(901,289) :- not remove_reaction(901,289).
catalyst(902,289) :- not remove_reaction(902,289).
catalyst(931,289) :- not remove_reaction(931,289).
catalyst(932,289) :- not remove_reaction(932,289).
catalyst(1191,289) :- not remove_reaction(1191,289).
catalyst(1192,289) :- not remove_reaction(1192,289).
catalyst(1581,272).
catalyst(1582,272).
catalyst(6560,260).
catalyst(361,258).
