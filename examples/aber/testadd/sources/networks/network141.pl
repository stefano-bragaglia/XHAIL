...
component("YNL280C",741).
component("YLR056W",636).
component("YGR060W",443).
component("YGL012W",414).
component("YKR009C",616).
component("YOL086C",770).
component("YMR303C",714).
component("YMR083W",695).
component("YGL256W",436).
component("YDL168W",287).
component("YBR145W",218).
component("YPL231W",838).
component("YBR265W",236).
component("U46_",130).
component("YBR149W",219).
component("YBR149W",220).
component("YGL001C",411).
component("YIL094C",518).
component("U45_",129).
component("YML056C",682).
component("YLR432W",672).
component("YHR216W",509).
component("YAR075W",185).
component("YAR073W",184).
component("YDR127W",314).
component("YJR139C",583).
component("YML075C",684).
component("YLR450W",675).
component("YOL126C",776).
component("YKL085W",594).
component("YDL078C",269).
component("YKL029C",590).
component("YNL037C",719).
component("YNL009W",717).
component("YLR174W",649).
component("YHR183W",502).
component("YGR256W",465).
component("YNL241C",734).
component("YOL059W",767).
component("YDL022W",261).
component("YCL018W",244).
component("YLR355C",667).
component("YIL074C",515).
component("YER081W",385).
component("YDL174C",291).
component("YML086C",686).
component("YIL155C",527).
component("YEL024W",360).
component("YKR066C",621).
component("YGR088W",447).
component("YDR256C",328).
component("YKL026C",589).
component("YIR037W",537).
component("YBR244W",231).
component("YJR078W",576).
component("U58_",139).
component("YJR025C",568).
component("U107_",26).
component("YGR255C",464).
component("U108_",27).
component("YHR007C",476).
component("YDR402C",342).
component("YGL055W",421).
component("YJR104C",578).
component("YHR008C",477).
component("YOR384W",814).
component("YOR381W",813).
component("YOL152W",778).
component("YLL051C",629).
component("YJL026W",539).
component("YIL066C",514).
component("YGR180C",454).
component("YER070W",382).
component("U37_",123).
component("U36_",122).
component("U35_",121).
component("YDL168W",288).
component("YDR158W",322).
component("YJR009C",565).
component("YJL052W",541).
component("YGR192C",456).
component("YBR006W",197).
component("YPL276W",846).
component("YPL275W",845).
component("YOR388C",815).
component("YPL061W",822).
component("YOR374W",811).
component("YER073W",383).
component("YGL154C",428).
component("YBR115C",214).
component("U55_",138).
component("YER069W",380).
component("YOR323C",803).
component("YMR170C",705).
component("YMR169C",704).
component("YER178W",395).
component("YBR221C",229).
component("YIL125W",523).
component("U52_",135).
component("YBR166C",223).
component("YNL280C",742).
component("YGL012W",415).
component("YKL182W",604).
component("YKL216W",614).
component("YDR044W",304).
component("YER014W",370).
component("YKR009C",617).
component("YIL160C",528).
component("YGL205W",433).
component("YMR118C",699).
component("YLR164W",647).
component("YLL041C",627).
component("YKL148C",599).
component("YKL141W",597).
component("YJL045W",540).
component("YDR178W",323).
component("YEL047C",363).
component("YDL171C",289).
component("YDL171C",290).
component("YOR375C",812).
component("YDL215C",295).
component("YAL062W",181).
component("U99_",175).
component("U100_",21).
component("YBR035C",204).
component("YKR080W",623).
component("YER023W",371).
component("YOR236W",801).
component("YGR204W",458).
component("YIR034C",536).
component("YLR142W",644).
component("U65_",146).
component("U63_",144).
component("U62_",143).
component("YHR068W",487).
component("YKL150W",600).
component("YIL043C",512).
component("YHR042W",482).
component("YOR221C",798).
component("YMR145C",702).
component("YKL192C",608).
component("YKL055C",592).
component("YER061C",378).
component("YDL085W",271).
component("YPL171C",830).
component("YHR179W",501).
component("YMR145C",703).
component("YML120C",687).
component("YKL192C",609).
component("YDL085W",272).
component("YGR234W",460).
component("YFR030W",407).
component("YPL017C",818).
component("YFL018C",399).
component("YDR353W",338).
component("YPR167C",863).
component("YJR137C",582).
component("YNL052W",721).
component("YMR256C",711).
component("YLR395C",671).
component("YLR038C",634).
component("YIL111W",520).
component("YHR051W",486).
component("YGL191W",431).
component("YGL187C",430).
component("YDL067C",268).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",309).
component("YPL266W",844).
component("YKR069W",622).
component("YOL096C",771).
component("U47_",131).
component("YER091C",390).
component("YJR073C",574).
component("YGR157W",452).
component("YDR120C",312).
component("YML008C",677).
component("YOR074C",783).
component("YDL033C",263).
component("YOL096C",772).
component("YLR172C",648).
component("YLR058C",637).
component("YDR019C",301).
component("YBR176W",224).
component("YDR408C",344).
component("YMR120C",700).
component("YLR028C",632).
component("YBL013W",186).
component("YJL130C",550).
component("YJL088W",544).
component("YKL024C",588).
component("YPR074C",858).
component("YBR117C",215).
component("YMR108W",698).
component("YCL009C",243).
component("YNL071W",723).
component("YNR008W",747).
component("YIL160C",529).
component("YNR019W",750).
component("YCR048W",257).
component("U48_",132).
component("YMR062C",694).
component("YDR232W",325).
component("YPL231W",839).
component("YER061C",379).
component("YPL001W",817).
component("YDL052C",267).
component("U8_",169).
component("YDR148C",320).
component("YPL231W",840).
component("YPL028W",819).
component("YLR299W",659).
component("YGL017W",416).
component("YCR005C",249).
component("YML126C",688).
component("YNL104C",726).
component("YDL182W",292).
component("YDL131W",278).
component("YDR307W",334).
component("YLR258W",656).
component("YFR015C",405).
component("YNL029C",718).
component("YIL085C",517).
component("YNL192W",732).
component("YBR038W",206).
component("YBR023C",202).
component("YMR306W",715).
component("YLR342W",665).
component("YGR032W",440).
component("YPR183W",866).
component("YBR248C",232).
component("YLR209C",651).
component("U104_",23).
component("U103_",22).
component("YDR354W",339) :- not remove_orf("YDR354W",339).
component("YFR047C",408).
component("YJR133W",581).
component("YLR209C",652).
component("YML022W",679).
component("YDR441C",347).
component("YHR128W",496).
component("YPR176C",865).
component("YPL172C",831).
component("YNR041C",753).
component("YMR101C",696).
component("YDL090C",274).
component("YBR003W",196).
component("YBR002C",195).
component("YJL167W",557).
component("YJL167W",558).
component("YPR069C",855).
component("YDR127W",315).
component("YHR190W",504).
component("YLR146C",645).
component("YHR068W",488).
component("YLR303W",661).
component("YGR012W",438).
component("YML082W",685).
component("YJR130C",580).
component("YDR035W",303).
component("YBR249C",233).
component("YLR180W",650).
component("YDR502C",351).
component("YOR274W",802).
component("YBR256C",235).
component("YHR137W",497).
component("YGL202W",432).
component("YLR027C",631).
component("YKL106W",595).
component("YOL140W",777).
component("YLR438W",674).
component("YGR019W",439).
component("YLR089C",640).
component("U64_",145).
component("U61_",142).
component("U51_",134).
component("YJR148W",584).
component("YHR208W",507).
component("YFL030W",401).
component("YOR184W",792).
component("YNR058W",757).
component("YIL116W",522).
component("YGL253W",435).
component("YFR053C",409).
component("YMR013C",692).
component("YMR205C",707).
component("YGR240C",461).
component("YOL016C",761).
component("YFR014C",404).
component("YLR240W",654).
component("YKL203C",611).
component("YJR066W",573).
component("YCR036W",256).
component("YCL040W",246).
component("U15_",62).
component("YPL188W",833).
component("YJR049C",570).
component("YEL041W",361).
component("U96_",173).
component("YKL001C",587).
component("YDR236C",326).
component("YHL032C",474).
component("YDR531W",355).
component("U83_",164).
component("U82_",163).
component("U81_",162).
component("YMR208W",708).
component("YPL203W",834).
component("YOR061W",782).
component("YKL166C",602).
component("YJL164C",556).
component("YIL035C",511).
component("YHR205W",506).
component("YHR102W",494).
component("YGL019W",417).
component("YHR025W",481).
component("YOR347C",808).
component("YAL038W",179).
component("YNR012W",748).
component("YDR009W",300).
component("YDR127W",316).
component("YDR147W",319).
component("YDR300C",333).
component("YCR012W",250).
component("YER069W",381).
component("U19_",94).
component("U18_",85).
component("U17_",76).
component("U76_",156).
component("YER170W",394).
component("YDR226W",324).
component("YKL067W",593).
component("YOL055C",764).
component("YDR454C",348).
component("YJR057W",571).
component("YOL061W",768).
component("YKL181W",603).
component("YHL011C",472).
component("YER099C",391).
component("YBL068W",193).
component("YOR143C",788).
component("YNL256W",737).
component("YLR328W",663).
component("YBR018C",199).
component("YGR007W",437).
component("YGR202C",457).
component("YLR328W",664).
component("YDL045C",265).
component("U80_",161).
component("YDL103C",277).
component("U94_",172).
component("YJR010W",566).
component("YBR029C",203).
component("YCL050C",247).
component("YGL130W",426).
component("YDR530C",354).
component("YPR190C",868).
component("YPR187W",867).
component("YPR110C",860).
component("YPR010C",849).
component("YOR341W",807).
component("YOR340C",806).
component("YOR224C",800).
component("YOR210W",797).
component("YOR207C",795).
component("YOR151C",789).
component("YOR116C",785).
component("YOL005C",759).
component("YNR003C",746).
component("YNL248C",736).
component("YNL151C",730).
component("YNL113W",727).
component("YKL144C",598).
component("YJR063W",572).
component("YJL148W",554).
component("YJL140W",553).
component("YIL021W",510).
component("YHR143W-A",498).
component("YGL070C",424).
component("YFL036W",402).
component("YDR404C",343).
component("YDR156W",321).
component("YDR045C",305).
component("YDL150W",286).
component("YDL140C",280).
component("YBR154C",222).
component("YPR175W",864).
component("YPL167C",829).
component("YOR330C",804).
component("YOL115W",775).
component("YNL299W",744).
component("YNL262W",739).
component("YNL102W",725).
component("YJR043C",569).
component("YJR006W",564).
component("YJL090C",545).
component("YIL139C",525).
component("YEL055C",364).
component("YDR419W",345).
component("YDR121W",313).
component("YDL102W",276).
component("YCR014C",251).
component("YBR278W",238).
component("YBL035C",189).
component("YKL035W",591).
component("YHL012W",473).
component("YHR123W",495).
component("YPR113W",861).
component("YBR243C",230).
component("YDL142C",285).
component("YPL148C",827).
component("YER026C",372).
component("YGR286C",469).
component("YHR189W",503).
component("YDR058C",308).
component("YDL086W",273).
component("YOL011W",760).
component("YMR008C",690).
component("YMR006C",689).
component("U105_",24).
component("YBL015W",187).
component("YJL068C",542).
component("YOR040W",781).
component("U77_",157).
component("YDR481C",349).
component("YLR377C",669).
component("YPL179W",832).
component("YNR032W",751).
component("YML057W",683).
component("YML016C",678).
component("YLR433C",673).
component("YGR123C",450).
component("YER133W",392).
component("YER089C",388).
component("YDR436W",346).
component("YDR075W",310).
component("YDL188C",293).
component("YDL134C",279).
component("YDL047W",266).
component("YDL006W",259).
component("YBR125C",217).
component("YBL056W",192).
component("YPR073C",856).
component("YHR215W",508).
component("YDL024C",262).
component("YBR093C",212).
component("YBR092C",211).
component("YAR071W",183).
component("YHR046C",485).
component("U9_",176).
component("YPL228W",837).
component("YMR180C",706).
component("YDL236W",297).
component("YJL155C",555).
component("YPR073C",857).
component("YOR208W",796).
component("YNL053W",722).
component("YMR036C",693).
component("YIR026C",535).
component("YIL113W",521).
component("YFR028C",406).
component("YER075C",384).
component("YDL230W",296).
component("YBR276C",237).
component("U34_",120).
component("U33_",119).
component("U32_",118).
component("U31_",117).
...
component("U25_",111).
component("U24_",110).
component("YHR044C",484).
component("YHR043C",483).
component("YOL064C",769).
component("YOR360C",810).
component("YKR031C",618).
component("YPL206C",835).
component("YGL027C",419).
component("YLR286C",658).
component("YJR153W",585).
component("YJL221C",563).
component("YJL216C",561).
component("YIL172C",533).
component("YGR292W",471).
component("YGR287C",470).
component("YBR299W",242).
component("YBR184W",225).
component("YIL162W",530).
component("YIR019C",534).
component("YIL099W",519).
component("YDL037C",264).
component("YOR190W",793).
component("YLR300W",660).
component("YGR282C",468).
component("YDR261C",329).
component("YDR400W",341).
component("U23_",109).
component("YML035C",680).
component("YJL070C",543).
component("YBR284W",239).
component("U106_",25).
component("YER043C",373).
component("YNL045W",720).
component("YGL037C",420).
component("YDR242W",327).
component("YBR208C",227).
component("YMR281W",713).
component("U53_",136).
component("YPR062W",854).
component("YMR120C",701).
component("YLR028C",633).
component("YHR144C",499).
component("YGR267C",467).
component("YBL033C",188).
component("YBR153W",221).
component("YNL141W",728).
component("YLR245C",655).
component("YML035C",681).
component("YBR084W",209).
component("YJL126W",548).
component("U44_",128).
component("YDL100C",275).
component("U87_",166).
component("U40_",126).
component("U39_",124).
component("YBR011C",198).
component("YHR201C",505).
component("YBR111C",213).
component("YBR252W",234).
component("YER005W",369).
component("YIL048W",513).
component("YER166W",393).
component("YDR093W",311).
component("YAL026C",178).
component("YBL099W",194).
component("U60_",141).
component("YLR231C",653).
component("U88_",167).
component("YDR538W",357).
component("YLR134W",642).
component("YLR044C",635).
component("YGR087C",446).
component("YDR380W",340).
component("YDL080C",270).
component("U98_",174).
component("YMR250W",710).
component("YKL184W",607).
component("YOR128C",786).
component("YEL021W",359).
component("YNR043W",754).
component("U93_",171).
component("U54_",137).
component("YKL211C",612) :- not remove_orf("YKL211C",612).
component("YKR097W",625).
component("YNL169C",731).
component("YNL256W",738).
component("YDR294C",331).
component("YEL046C",362).
component("YNR033W",752).
component("YKL211C",613) :- not remove_orf("YKL211C",613).
component("YER090W",613) :- not remove_orf("YER090W",613).
component("YER090W",389) :- not remove_orf("YER090W",389).
component("YDR127W",317).
component("YPL281C",847).
component("YOR393W",816).
component("YMR323W",716).
component("YHR174W",500).
component("YGR254W",463).
component("YOR202W",794).
component("YPL262W",842).
component("YGL026C",418) :- not remove_orf("YGL026C",418).
component("YGR155W",451).
component("YLR304C",662).
component("YJL200C",559).
component("YNL316C",745).
component("YKL182W",605).
component("YPL212C",836).
component("YNL292W",743).
component("YGL063W",423).
component("YFL001W",397).
component("YPR002W",848).
component("YJR016C",567).
component("YCR053W",258).
component("YDR127W",318).
component("YGL148W",427).
component("YIL168W",532).
component("YIL167W",531).
component("YCL064C",248).
component("YER086W",386).
component("YLR359W",668).
component("YAL012W",177).
component("YML004C",676).
component("YFR055W",410).
component("YJL005W",538).
component("YJL121C",547).
component("YBR019C",200).
component("YDR050C",307).
component("YDR007W",299) :- not remove_orf("YDR007W",299).
component("YOR095C",784).
component("YER003C",368).
component("YBR196C",226).
component("YGL001C",412).
component("YPL117C",825).
component("U14_",54).
component("YOL056W",765).
component("YKL152C",601).
component("YDL021W",260).
component("YMR105C",697).
component("YKL127W",596).
component("YEL058W",365).
component("YPR060C",853).
component("YHR072W",489).
component("YPL097W",823).
component("YGR185C",455).
component("YGR264C",466).
component("YGR171C",453).
component("YHR011W",478).
component("YDR023W",302).
component("YPL104W",824).
component("YLL018C",626).
component("YPR081C",859).
component("YBR121C",216).
component("YHR020W",480).
component("YER087W",387).
component("YNL247W",735).
component("YOR168W",790).
component("YOL097C",773).
component("YDR268W",330).
component("YPR047W",852).
component("YLR060W",638).
component("YFL022C",400).
component("YPR033C",850).
component("YCR024C",252).
component("YHR019C",479).
component("YKL194C",610).
component("YIL078W",516).
component("YPL160W",828).
component("YLR382C",670).
component("YNL073W",724).
component("YOR335C",805).
component("YGR094W",448).
component("YLR153C",646).
component("YAL054C",180).
component("YGR244C",462).
component("YPR035W",851).
component("YIL145C",526).
component("U89_",168).
component("YJL101C",546).
component("YOL049W",763).
component("YAR015W",182).
component("YER183C",396).
component("U90_",170).
component("YNR057C",756).
component("YDL141W",281).
component("YDL141W",282).
component("YGL234W",434).
component("YDL141W",283).
component("YJR103W",577).
component("YBL039C",190).
component("YGR204W",459).
component("YBR084W",210).
component("YNL220W",733).
component("YOL058W",766).
component("YDL141W",284).
component("YHR074W",490).
component("YMR217W",709).
component("YGR061C",444).
component("YJR109C",579).
component("YJL130C",551).
component("YGL062W",422).
component("YBR218C",228).
component("YPL231W",841).
component("YNR016C",749).
component("YKL182W",606).
component("YGR037C",441).
component("YPR138C",862).
component("YPL265W",843).
component("YPL134C",826).
component("YPL057C",821).
component("YPL036W",820).
component("YOR348C",809).
component("YOR222W",799).
component("YOR171C",791).
component("YOR130C",787).
component("YOR011W",780).
component("YOL156W",779).
component("YOL103W",774).
component("YOL020W",762) :- not remove_orf("YOL020W",762).
component("YNR072W",758).
component("YNR056C",755).
component("YNL270C",740).
component("YNL142W",729).
component("YMR272C",712).
component("YMR011W",691).
component("YLR348C",666).
component("YLR260W",657).
component("YLR138W",643).
component("YLR100C",641).
component("YLR081W",639).
component("YLL061W",630).
component("YLL043W",628).
component("YKR093W",624).
component("YKR053C",620).
component("YKR039W",619) :- not remove_orf("YKR039W",619).
component("YKL217W",615).
component("YJR158W",586).
component("YJR077C",575).
component("YJL219W",562).
component("YJL214W",560).
component("YJL134W",552).
component("YJL129C",549).
component("YIL134W",524).
component("YHR096C",493).
component("YHR094C",492).
component("YHR092C",491).
component("YHL036W",475).
component("YGR121C",449).
component("YGR065C",445).
component("YGR055W",442).
component("YGL186C",429).
component("YGL077C",425).
component("YGL008C",413).
component("YFL055W",403).
component("YFL011W",398).
component("YER060W-A",377).
component("YER060W",376).
component("YER056C",375).
component("YER053C",374).
component("YEL069C",367).
component("YEL063C",366).
component("YEL017C-A",358).
component("YDR536W",356).
component("YDR508C",353).
component("YDR503C",352).
component("YDR497C",350).
component("YDR345C",337).
component("YDR343C",336).
component("YDR342C",335).
component("YDR297W",332).
component("YDR046C",306) :- not remove_orf("YDR046C",306).
component("YDL245C",298).
component("YDL210W",294).
component("YCR032W",255).
component("YCR028C",254).
component("YCR024C-A",253).
component("YCL025C",245).
component("YBR298C",241).
component("YBR291C",240).
component("YBR069C",208) :- not remove_orf("YBR069C",208).
component("YBR068C",207) :- not remove_orf("YBR068C",207).
component("YBR036C",205).
component("YBR021W",201).
component("YBL042C",191).
component("U85_",165).
component("U7_",160).
component("U79_",159).
component("U78_",158).
...
catalyst(1890,389) :- not remove_reaction(1890,389).
catalyst(3630,389) :- not remove_reaction(3630,389).
catalyst(3740,317).
catalyst(8231,847).
catalyst(8232,847).
catalyst(8231,816).
...
catalyst(8061,842).
catalyst(8062,842).
catalyst(3590,418) :- not remove_reaction(3590,418).
catalyst(10910,418) :- not remove_reaction(10910,418).
catalyst(4570,451).
catalyst(8181,662).
catalyst(8182,662).
catalyst(8181,559).
...
catalyst(8281,307).
catalyst(8282,307).
catalyst(3610,299) :- not remove_reaction(3610,299).
catalyst(7921,784).
catalyst(7922,784).
catalyst(7841,368).
catalyst(7842,368).
...
catalyst(851,619) :- not remove_reaction(851,619).
catalyst(852,619) :- not remove_reaction(852,619).
...
catalyst(931,619) :- not remove_reaction(931,619).
catalyst(932,619) :- not remove_reaction(932,619).
...
catalyst(1210,335).
catalyst(6650,332).
catalyst(791,306) :- not remove_reaction(791,306).
catalyst(792,306) :- not remove_reaction(792,306).
catalyst(801,306) :- not remove_reaction(801,306).
catalyst(802,306) :- not remove_reaction(802,306).
catalyst(811,306) :- not remove_reaction(811,306).
catalyst(812,306) :- not remove_reaction(812,306).
catalyst(831,306) :- not remove_reaction(831,306).
catalyst(832,306) :- not remove_reaction(832,306).
catalyst(841,306) :- not remove_reaction(841,306).
catalyst(842,306) :- not remove_reaction(842,306).
catalyst(851,306) :- not remove_reaction(851,306).
catalyst(852,306) :- not remove_reaction(852,306).
catalyst(901,306) :- not remove_reaction(901,306).
catalyst(902,306) :- not remove_reaction(902,306).
catalyst(1180,298).
catalyst(1210,298).
catalyst(730,294).
catalyst(431,255).
...
catalyst(1511,240).
catalyst(1512,240).
catalyst(771,208) :- not remove_reaction(771,208).
catalyst(772,208) :- not remove_reaction(772,208).
...
catalyst(851,208) :- not remove_reaction(851,208).
catalyst(852,208) :- not remove_reaction(852,208).
catalyst(901,208) :- not remove_reaction(901,208).
catalyst(902,208) :- not remove_reaction(902,208).
catalyst(791,207) :- not remove_reaction(791,207).
catalyst(792,207) :- not remove_reaction(792,207).
catalyst(801,207) :- not remove_reaction(801,207).
catalyst(802,207) :- not remove_reaction(802,207).
catalyst(811,207) :- not remove_reaction(811,207).
catalyst(812,207) :- not remove_reaction(812,207).
catalyst(831,207) :- not remove_reaction(831,207).
catalyst(832,207) :- not remove_reaction(832,207).
catalyst(841,207) :- not remove_reaction(841,207).
catalyst(842,207) :- not remove_reaction(842,207).
catalyst(851,207) :- not remove_reaction(851,207).
catalyst(852,207) :- not remove_reaction(852,207).
catalyst(901,207) :- not remove_reaction(901,207).
catalyst(902,207) :- not remove_reaction(902,207).
catalyst(6600,205).
catalyst(620,201).
catalyst(540,191).
catalyst(2660,165).
