...
component("YLR056W",218).
component("YKR009C",207).
component("YPL231W",295).
component("U46_",44).
component("YBR149W",65).
component("YGL001C",138).
component("YIL094C",174).
component("U45_",43).
component("YDR127W",95).
component("YOL126C",269).
component("YKL085W",199).
component("YDL078C",81).
component("YNL037C",245).
component("YLR355C",234).
component("YDL174C",87).
component("YML086C",238).
component("YGR088W",155).
component("YDR256C",104).
component("YJR078W",193).
component("U107_",20).
component("YER070W",130).
component("U36_",40).
component("YPL276W",301).
component("YPL275W",300).
component("YOR388C",286).
component("YOR323C",280).
component("YIL125W",175).
component("U52_",46).
component("YBR166C",67).
component("YKL216W",206).
component("YKR009C",208).
component("YIL160C",177).
component("YGL205W",149).
component("YKR080W",212).
component("YER023W",125).
component("YGR204W",159).
component("YLR142W",223).
component("U62_",48).
component("YHR068W",165).
component("YKL150W",202).
component("YIL043C",172).
component("YPL171C",294).
component("YHR179W",170).
component("YDR353W",108).
component("YPL266W",299).
component("YKR069W",211).
component("YDL033C",80).
component("YLR172C",225).
component("YLR058C",219).
component("YDR019C",90).
component("YBR176W",68).
component("YDR408C",113).
component("YMR120C",242).
component("YLR028C",215).
component("YJL130C",184).
component("YKL024C",197).
component("YPR074C",305).
component("YBR117C",64).
component("YPL231W",296).
component("YPL231W",297).
component("YLR299W",231).
component("YML126C",239).
component("YDL182W",88).
component("YDL131W",84).
component("YLR258W",229).
component("YFR015C",135).
component("YNL029C",244).
component("YIL085C",173).
component("YLR209C",226).
component("U104_",18).
component("YDR354W",109) :- not remove_orf("YDR354W",109).
component("YFR047C",136).
component("YLR209C",227).
component("YML022W",236).
component("YDR441C",115).
component("YJL167W",188).
component("YDR127W",96).
component("YLR303W",233).
component("YJR130C",195).
component("YDR035W",91).
component("YBR249C",70).
component("YOR274W",279).
component("YHR137W",166).
component("YGL202W",148).
component("YLR027C",214).
component("YKL106W",200).
component("YLR089C",220).
component("YJR148W",196).
component("YNR058W",260).
component("YGL253W",151).
component("YFR053C",137).
component("YCR036W",79).
component("U96_",51).
component("YNR012W",258).
component("YDR127W",97).
component("YDR147W",100).
component("U76_",49).
component("YDR226W",102).
component("YKL067W",198).
component("YOL055C",264).
component("YDR454C",116).
component("YOL061W",265).
component("YKL181W",203).
component("YHL011C",163).
component("YER099C",132).
component("YBL068W",58).
component("YNL256W",252).
component("YBR018C",60).
component("YGL130W",145).
component("YPR190C",311).
component("YPR187W",310).
component("YPR110C",306).
component("YPR010C",303).
component("YOR341W",284).
component("YOR340C",283).
component("YOR224C",278).
component("YOR210W",277).
component("YOR207C",276).
component("YOR151C",273).
component("YOR116C",272).
component("YOL005C",261).
component("YNR003C",257).
component("YNL248C",251).
component("YNL151C",250).
component("YNL113W",247).
component("YKL144C",201).
component("YJR063W",191).
component("YJL148W",187).
component("YJL140W",186).
component("YIL021W",171).
component("YHR143W-A",167).
component("YGL070C",144).
component("YFL036W",133).
component("YDR404C",112).
component("YDR156W",101).
component("YDR045C",92).
component("YDL150W",86).
component("YDL140C",85).
component("YBR154C",66).
component("YPR175W",309).
component("YPL167C",293).
component("YOR330C",281).
component("YOL115W",268).
component("YNL299W",255).
component("YNL262W",253).
component("YNL102W",246).
component("YJR043C",190).
component("YJR006W",189).
component("YJL090C",181).
component("YIL139C",176).
component("YEL055C",122).
component("YDR419W",114).
component("YDR121W",94).
component("YDL102W",83).
component("YCR014C",77).
component("YBR278W",72).
component("YBL035C",56).
component("YPR113W",307).
component("YPL148C",292).
component("YOL011W",262).
component("YMR008C",241).
component("YMR006C",240).
component("U105_",19).
component("YBL015W",55).
component("YLR377C",235).
component("U30_",39).
component("U29_",38).
component("U24_",37).
component("YOR360C",285).
component("YGL027C",142).
component("YOR190W",275).
component("YLR300W",232).
component("YGR282C",162).
component("YDR261C",105).
component("YDR400W",111).
component("YML035C",237).
component("YJL070C",180).
component("YBR284W",73).
component("YDR242W",103).
component("U53_",47).
component("YLR028C",216).
component("YHR144C",168).
component("YNL141W",248).
component("YJL126W",182).
component("U39_",41).
component("YBR011C",59).
component("YBR111C",63).
component("YBR252W",71).
component("YER005W",124).
component("YLR231C",228).
component("YLR134W",222).
component("YLR044C",217).
component("YGR087C",154).
component("YDR380W",110).
component("YDL080C",82).
component("U98_",52).
component("YKL211C",204) :- not remove_orf("YKL211C",204).
component("YKL211C",205) :- not remove_orf("YKL211C",205).
component("YER090W",205) :- not remove_orf("YER090W",205).
component("YER090W",131) :- not remove_orf("YER090W",131).
component("YDR127W",98).
component("YPL281C",302).
component("YOR393W",287).
component("YMR323W",243).
component("YHR174W",169).
component("YGR254W",160).
component("YGL026C",141) :- not remove_orf("YGL026C",141).
component("YNL316C",256).
component("YDR127W",99).
component("YGL148W",146).
component("YIL168W",179).
component("YIL167W",178).
component("YCL064C",76).
component("YAL012W",53).
component("YDR007W",89) :- not remove_orf("YDR007W",89).
component("YOR095C",271).
component("YGL001C",139).
component("YPL117C",291).
component("YPR060C",304).
component("YPL097W",289).
component("YGR185C",158).
component("YGR264C",161).
component("YGR171C",157).
component("YPL104W",290).
component("YLL018C",213).
component("YOL097C",266).
component("YDR268W",106).
component("YOR335C",282).
component("YLR153C",224).
component("YAL054C",54).
component("U90_",50).
component("YNR057C",259).
component("YGL234W",150).
component("YJR103W",194).
component("YBL039C",57).
component("YGL062W",143).
component("YBR218C",69).
component("YPR138C",308).
component("YPL265W",298).
component("YPL036W",288).
component("YOR171C",274).
component("YOR011W",270).
component("YOL103W",267).
component("YOL020W",263) :- not remove_orf("YOL020W",263).
component("YNL270C",254).
component("YNL142W",249).
component("YLR260W",230).
component("YLR100C",221).
component("YKR053C",210).
component("YKR039W",209) :- not remove_orf("YKR039W",209).
component("YJR077C",192).
component("YJL134W",185).
component("YJL129C",183).
component("YHL036W",164).
component("YGR121C",156).
component("YGR065C",153).
component("YGR055W",152).
component("YGL186C",147).
component("YGL008C",140).
component("YFL055W",134).
component("YER060W-A",129).
component("YER060W",128).
component("YER056C",127).
component("YER053C",126).
component("YEL063C",123).
component("YEL017C-A",121).
component("YDR536W",120).
component("YDR508C",119).
component("YDR503C",118).
component("YDR497C",117).
component("YDR297W",107).
component("YDR046C",93) :- not remove_orf("YDR046C",93).
component("YCR024C-A",78).
component("YCL025C",75).
component("YBR298C",74).
component("YBR069C",62) :- not remove_orf("YBR069C",62).
component("YBR068C",61) :- not remove_orf("YBR068C",61).
component("U4_",45).
component("U3_",42).
component("U228_",36).
component("U223_",35).
...
catalyst(2121,18).
catalyst(2122,18).
catalyst(3620,109) :- not remove_reaction(3620,109).
catalyst(2190,136).
catalyst(5791,227).
catalyst(5792,227).
catalyst(5801,227).
...
catalyst(8812,82).
catalyst(2250,52).
catalyst(3600,204) :- not remove_reaction(3600,204).
...
catalyst(8231,160).
catalyst(8232,160).
catalyst(3590,141) :- not remove_reaction(3590,141).
catalyst(10910,141) :- not remove_reaction(10910,141).
catalyst(3680,256).
catalyst(3750,99).
catalyst(3700,146).
catalyst(8751,179).
...
catalyst(781,209) :- not remove_reaction(781,209).
catalyst(782,209) :- not remove_reaction(782,209).
...
catalyst(881,209) :- not remove_reaction(881,209).
catalyst(882,209) :- not remove_reaction(882,209).
catalyst(901,209) :- not remove_reaction(901,209).
catalyst(902,209) :- not remove_reaction(902,209).
catalyst(931,209) :- not remove_reaction(931,209).
catalyst(932,209) :- not remove_reaction(932,209).
catalyst(1191,209) :- not remove_reaction(1191,209).
catalyst(1192,209) :- not remove_reaction(1192,209).
catalyst(1581,192).
catalyst(1582,192).
catalyst(6560,185).
catalyst(361,183).
...
catalyst(1121,74).
catalyst(1122,74).
catalyst(771,62) :- not remove_reaction(771,62).
catalyst(772,62) :- not remove_reaction(772,62).
...
catalyst(901,62) :- not remove_reaction(901,62).
catalyst(902,62) :- not remove_reaction(902,62).
...
catalyst(841,61) :- not remove_reaction(841,61).
catalyst(842,61) :- not remove_reaction(842,61).
