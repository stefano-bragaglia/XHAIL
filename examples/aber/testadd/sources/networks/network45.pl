...
component("YLR056W",274).
component("YKR009C",262).
component("YOL086C",331).
component("YMR303C",305).
component("YGL256W",189).
component("YDL168W",117).
component("YBR145W",89).
component("YPL231W",362).
component("U46_",55).
component("YBR149W",90).
component("YGL001C",171).
component("YIL094C",223).
component("U45_",54).
component("YDR127W",126).
component("YOL126C",335).
component("YKL085W",254).
component("YDL078C",111).
component("YNL037C",309).
component("YCL018W",101).
component("YLR355C",293).
component("YDL174C",118).
component("YML086C",298).
component("YGR088W",195).
component("YDR256C",136).
component("YJR078W",248).
component("YJR025C",243).
component("U107_",22).
component("YJL026W",231).
component("YGR180C",198).
component("YER070W",162).
component("U36_",50).
component("YPL276W",368).
component("YPL275W",367).
component("YOR388C",353).
component("YOR323C",347).
component("YIL125W",225).
component("U52_",58).
component("YBR166C",92).
component("YKL216W",261).
component("YKR009C",263).
component("YIL160C",228).
component("YGL205W",186).
component("YKR080W",267).
component("YER023W",157).
component("YGR204W",200).
component("YLR142W",279).
component("U65_",61).
component("U62_",60).
component("YHR068W",213).
component("YKL150W",257).
component("YIL043C",221).
component("YPL171C",361).
component("YHR179W",219).
component("YGR234W",201).
component("YDR353W",140).
component("YNL052W",310).
component("YMR256C",304).
component("YLR395C",295).
component("YLR038C",272).
component("YIL111W",224).
component("YHR051W",212).
component("YGL191W",184).
component("YGL187C",183).
component("YDL067C",110).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",366).
component("YKR069W",266).
component("YJR073C",246).
component("YDL033C",109).
component("YLR172C",281).
component("YLR058C",275).
component("YDR019C",121).
component("YBR176W",93).
component("YDR408C",145).
component("YMR120C",302).
component("YLR028C",270).
component("YBL013W",74).
component("YJL130C",236).
component("YKL024C",252).
component("YPR074C",372).
component("YBR117C",88).
component("YCL009C",100).
component("U48_",56).
component("YPL231W",363).
component("YPL231W",364).
component("YLR299W",288).
component("YGL017W",174).
component("YML126C",299).
component("YDL182W",119).
component("YDL131W",114).
component("YLR258W",286).
component("YFR015C",168).
component("YNL029C",308).
component("YIL085C",222).
component("YMR306W",306).
component("YLR342W",292).
component("YGR032W",191).
component("YLR209C",282).
component("U104_",20).
component("YDR354W",141) :- not remove_orf("YDR354W",141).
component("YFR047C",169).
component("YLR209C",283).
component("YML022W",296).
component("YDR441C",147).
component("YJL167W",240).
component("YDR127W",127).
component("YLR303W",290).
component("YGR012W",190).
component("YJR130C",250).
component("YDR035W",122).
component("YBR249C",95).
component("YOR274W",346).
component("YHR137W",215).
component("YGL202W",185).
component("YLR027C",269).
component("YKL106W",255).
component("YOL140W",336).
component("YLR089C",276).
component("YJR148W",251).
component("YNR058W",325).
component("YGL253W",188).
component("YFR053C",170).
component("YCR036W",107).
component("U96_",70).
component("YDR236C",134).
component("YHL032C",207).
component("YNR012W",323).
component("YDR127W",128).
component("YDR147W",131).
component("U76_",67).
component("YER170W",165).
component("YDR226W",133).
component("YKL067W",253).
component("YOL055C",329).
component("YDR454C",148).
component("YOL061W",330).
component("YKL181W",258).
component("YHL011C",206).
component("YER099C",164).
component("YBL068W",78).
component("YNL256W",317).
component("YBR018C",81).
component("YBR029C",83).
component("YGL130W",180).
component("YPR190C",378).
component("YPR187W",377).
component("YPR110C",373).
component("YPR010C",370).
component("YOR341W",351).
component("YOR340C",350).
component("YOR224C",345).
component("YOR210W",344).
component("YOR207C",343).
component("YOR151C",340).
component("YOR116C",339).
component("YOL005C",326).
component("YNR003C",322).
component("YNL248C",316).
component("YNL151C",315).
component("YNL113W",312).
component("YKL144C",256).
component("YJR063W",245).
component("YJL148W",239).
component("YJL140W",238).
component("YIL021W",220).
component("YHR143W-A",216).
component("YGL070C",178).
component("YFL036W",166).
component("YDR404C",144).
component("YDR156W",132).
component("YDR045C",123).
component("YDL150W",116).
component("YDL140C",115).
component("YBR154C",91).
component("YPR175W",376).
component("YPL167C",360).
component("YOR330C",348).
component("YOL115W",334).
component("YNL299W",320).
component("YNL262W",318).
component("YNL102W",311).
component("YJR043C",244).
component("YJR006W",242).
component("YJL090C",233).
component("YIL139C",226).
component("YEL055C",154).
component("YDR419W",146).
component("YDR121W",125).
component("YDL102W",113).
component("YCR014C",104).
component("YBR278W",97).
component("YBL035C",76).
component("YPR113W",374).
component("YPL148C",359).
component("YGR286C",205).
component("YOL011W",327).
component("YMR008C",301).
component("YMR006C",300).
component("U105_",21).
component("YBL015W",75).
component("U77_",68).
component("YLR377C",294).
component("U30_",49).
component("U29_",48).
component("U24_",47).
component("YHR044C",211).
component("YHR043C",210).
component("YOR360C",352).
component("YGL027C",176).
component("YOR190W",342).
component("YLR300W",289).
component("YGR282C",204).
component("YDR261C",137).
component("YDR400W",143).
component("YML035C",297).
component("YJL070C",232).
component("YBR284W",98).
component("YDR242W",135).
component("U53_",59).
component("YMR120C",303).
component("YLR028C",271).
component("YHR144C",217).
component("YNL141W",313).
component("YLR245C",285).
component("YJL126W",234).
component("U39_",51).
component("YBR011C",80).
component("YBR111C",87).
component("YBR252W",96).
component("YER005W",156).
component("YBL099W",79).
component("YLR231C",284).
component("YLR134W",278).
component("YLR044C",273).
component("YGR087C",194).
component("YDR380W",142).
component("YDL080C",112).
component("U98_",71).
component("YKL211C",259) :- not remove_orf("YKL211C",259).
component("YKL211C",260) :- not remove_orf("YKL211C",260).
component("YER090W",260) :- not remove_orf("YER090W",260).
component("YER090W",163) :- not remove_orf("YER090W",163).
component("YDR127W",129).
component("YPL281C",369).
component("YOR393W",354).
component("YMR323W",307).
component("YHR174W",218).
component("YGR254W",202).
component("YGL026C",175) :- not remove_orf("YGL026C",175).
component("YLR304C",291).
component("YJL200C",241).
component("YNL316C",321).
component("YCR053W",108).
component("YDR127W",130).
component("YGL148W",181).
component("YIL168W",230).
component("YIL167W",229).
component("YCL064C",103).
component("YAL012W",72).
component("YBR019C",82).
component("YDR007W",120) :- not remove_orf("YDR007W",120).
component("YOR095C",338).
component("YGL001C",172).
component("YPL117C",358).
component("YPR060C",371).
component("YPL097W",356).
component("YGR185C",199).
component("YGR264C",203).
component("YGR171C",197).
component("YPL104W",357).
component("YLL018C",268).
component("YOL097C",332).
component("YDR268W",138).
component("YCR024C",105).
component("YHR019C",209).
component("YOR335C",349).
component("YLR153C",280).
component("YAL054C",73).
component("YIL145C",227).
component("U90_",69).
component("YNR057C",324).
component("YGL234W",187).
component("YJR103W",249).
component("YBL039C",77).
component("YBR084W",86).
component("YHR074W",214).
component("YGL062W",177).
component("YBR218C",94).
component("YPR138C",375).
component("YPL265W",365).
component("YPL036W",355).
component("YOR171C",341).
component("YOR011W",337).
component("YOL103W",333).
component("YOL020W",328) :- not remove_orf("YOL020W",328).
component("YNL270C",319).
component("YNL142W",314).
component("YLR260W",287).
component("YLR100C",277).
component("YKR053C",265).
component("YKR039W",264) :- not remove_orf("YKR039W",264).
component("YJR077C",247).
component("YJL134W",237).
component("YJL129C",235).
component("YHL036W",208).
component("YGR121C",196).
component("YGR065C",193).
component("YGR055W",192).
component("YGL186C",182).
component("YGL077C",179).
component("YGL008C",173).
component("YFL055W",167).
component("YER060W-A",161).
component("YER060W",160).
component("YER056C",159).
component("YER053C",158).
component("YEL063C",155).
component("YEL017C-A",153).
component("YDR536W",152).
component("YDR508C",151).
component("YDR503C",150).
component("YDR497C",149).
component("YDR297W",139).
component("YDR046C",124) :- not remove_orf("YDR046C",124).
component("YCR024C-A",106).
component("YCL025C",102).
component("YBR298C",99).
component("YBR069C",85) :- not remove_orf("YBR069C",85).
component("YBR068C",84) :- not remove_orf("YBR068C",84).
component("U75_",66).
component("U74_",65).
component("U73_",64).
component("U72_",63).
...
catalyst(2121,20).
catalyst(2122,20).
catalyst(3620,141) :- not remove_reaction(3620,141).
catalyst(2190,169).
catalyst(5791,283).
catalyst(5792,283).
catalyst(5801,283).
...
catalyst(8812,112).
catalyst(2250,71).
catalyst(3600,259) :- not remove_reaction(3600,259).
catalyst(3630,260) :- not remove_reaction(3630,260).
catalyst(3630,163) :- not remove_reaction(3630,163).
catalyst(3740,129).
catalyst(8231,369).
catalyst(8232,369).
catalyst(8231,354).
...
catalyst(8231,202).
catalyst(8232,202).
catalyst(3590,175) :- not remove_reaction(3590,175).
catalyst(10910,175) :- not remove_reaction(10910,175).
catalyst(8181,291).
catalyst(8182,291).
catalyst(8181,241).
catalyst(8182,241).
...
catalyst(7751,82).
catalyst(7752,82).
catalyst(3610,120) :- not remove_reaction(3610,120).
catalyst(7921,338).
catalyst(7922,338).
catalyst(6370,172).
catalyst(6461,358).
...
catalyst(22,337).
catalyst(1160,333).
catalyst(801,328) :- not remove_reaction(801,328).
catalyst(802,328) :- not remove_reaction(802,328).
catalyst(811,328) :- not remove_reaction(811,328).
catalyst(812,328) :- not remove_reaction(812,328).
catalyst(831,328) :- not remove_reaction(831,328).
catalyst(832,328) :- not remove_reaction(832,328).
catalyst(901,328) :- not remove_reaction(901,328).
catalyst(902,328) :- not remove_reaction(902,328).
catalyst(931,319).
catalyst(932,319).
catalyst(371,314).
catalyst(372,314).
...
catalyst(6330,277).
catalyst(6560,265).
catalyst(771,264) :- not remove_reaction(771,264).
catalyst(772,264) :- not remove_reaction(772,264).
catalyst(781,264) :- not remove_reaction(781,264).
catalyst(782,264) :- not remove_reaction(782,264).
catalyst(801,264) :- not remove_reaction(801,264).
catalyst(802,264) :- not remove_reaction(802,264).
catalyst(811,264) :- not remove_reaction(811,264).
catalyst(812,264) :- not remove_reaction(812,264).
catalyst(831,264) :- not remove_reaction(831,264).
catalyst(832,264) :- not remove_reaction(832,264).
catalyst(841,264) :- not remove_reaction(841,264).
catalyst(842,264) :- not remove_reaction(842,264).
catalyst(851,264) :- not remove_reaction(851,264).
catalyst(852,264) :- not remove_reaction(852,264).
catalyst(881,264) :- not remove_reaction(881,264).
catalyst(882,264) :- not remove_reaction(882,264).
catalyst(901,264) :- not remove_reaction(901,264).
catalyst(902,264) :- not remove_reaction(902,264).
catalyst(931,264) :- not remove_reaction(931,264).
catalyst(932,264) :- not remove_reaction(932,264).
catalyst(1191,264) :- not remove_reaction(1191,264).
catalyst(1192,264) :- not remove_reaction(1192,264).
catalyst(1581,247).
catalyst(1582,247).
catalyst(6560,237).
catalyst(361,235).
...
catalyst(851,124) :- not remove_reaction(851,124).
catalyst(852,124) :- not remove_reaction(852,124).
catalyst(901,124) :- not remove_reaction(901,124).
catalyst(902,124) :- not remove_reaction(902,124).
catalyst(220,106).
catalyst(771,102).
catalyst(772,102).
catalyst(781,102).
...
catalyst(1121,99).
catalyst(1122,99).
catalyst(771,85) :- not remove_reaction(771,85).
catalyst(772,85) :- not remove_reaction(772,85).
catalyst(801,85) :- not remove_reaction(801,85).
catalyst(802,85) :- not remove_reaction(802,85).
catalyst(811,85) :- not remove_reaction(811,85).
catalyst(812,85) :- not remove_reaction(812,85).
catalyst(851,85) :- not remove_reaction(851,85).
catalyst(852,85) :- not remove_reaction(852,85).
catalyst(901,85) :- not remove_reaction(901,85).
catalyst(902,85) :- not remove_reaction(902,85).
catalyst(801,84) :- not remove_reaction(801,84).
catalyst(802,84) :- not remove_reaction(802,84).
catalyst(811,84) :- not remove_reaction(811,84).
catalyst(812,84) :- not remove_reaction(812,84).
catalyst(831,84) :- not remove_reaction(831,84).
catalyst(832,84) :- not remove_reaction(832,84).
catalyst(841,84) :- not remove_reaction(841,84).
catalyst(842,84) :- not remove_reaction(842,84).
catalyst(851,84) :- not remove_reaction(851,84).
catalyst(852,84) :- not remove_reaction(852,84).
catalyst(901,84) :- not remove_reaction(901,84).
catalyst(902,84) :- not remove_reaction(902,84).
catalyst(2920,66).
catalyst(2920,65).
catalyst(2920,64).
catalyst(2920,63).
...
modifiable_enzyme(85).
modifiable_enzyme(84).
