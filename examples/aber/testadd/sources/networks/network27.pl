...
component("U46_",41).
component("YBR149W",60).
component("YGL001C",124).
component("YIL094C",154).
component("U45_",40).
component("YDR127W",87).
component("YOL126C",231).
component("YDL078C",75).
component("YNL037C",210).
component("YML086C",206).
component("YGR088W",136).
component("YDR256C",95).
component("YJR078W",172).
component("U107_",19).
component("YER070W",117).
component("U36_",37).
component("YPL276W",258).
component("YPL275W",257).
component("YOR388C",245).
component("YOR323C",240).
component("YIL125W",155).
component("U52_",43).
component("YBR166C",62).
component("YKL216W",183).
component("YKR009C",184).
component("YIL160C",157).
component("YGL205W",133).
component("YKR080W",187).
component("YER023W",113).
component("YLR142W",195).
component("U62_",45).
component("YHR068W",145).
component("YKL150W",179).
component("YIL043C",152).
component("YPL171C",251).
component("YHR179W",150).
component("YDR353W",99).
component("YPL266W",256).
component("YDL033C",74).
component("YLR058C",193).
component("YDR019C",82).
component("YBR176W",63).
component("YDR408C",103).
component("YMR120C",207).
component("YLR028C",190).
component("YPR074C",262).
component("YBR117C",59).
component("YPL231W",253).
component("YPL231W",254).
component("YLR299W",201).
component("YDL182W",80).
component("YDL131W",77).
component("YLR258W",200).
component("YFR015C",122).
component("YNL029C",209).
component("YIL085C",153).
component("YLR209C",197).
component("YDR354W",100) :- not remove_orf("YDR354W",100).
component("YFR047C",123).
component("YLR209C",198).
component("YML022W",204).
component("YDR441C",105).
component("YJL167W",167).
component("YDR127W",88).
component("YJR130C",174).
component("YDR035W",83).
component("YBR249C",65).
component("YOR274W",239).
component("YHR137W",146).
component("YGL202W",132).
component("YLR027C",189).
component("YKL106W",177).
component("YJR148W",175).
component("YNR058W",224).
component("YCR036W",73).
component("U96_",47).
component("YNR012W",222).
component("YDR127W",89).
component("YDR226W",93).
component("YKL067W",176).
component("YDR454C",106).
component("YOL061W",227).
component("YKL181W",180).
component("YHL011C",143).
component("YER099C",119).
component("YBL068W",53).
component("YNL256W",216).
component("YBR018C",55).
component("YPR190C",268).
component("YPR187W",267).
component("YPR110C",263).
component("YPR010C",260).
component("YOR341W",244).
component("YOR340C",243).
component("YOR224C",238).
component("YOR210W",237).
component("YOR207C",236).
component("YOR151C",234).
component("YOR116C",233).
component("YOL005C",225).
component("YNR003C",221).
component("YNL248C",215).
component("YNL151C",214).
component("YNL113W",212).
component("YKL144C",178).
component("YJR063W",170).
component("YJL148W",166).
component("YJL140W",165).
component("YIL021W",151).
component("YHR143W-A",147).
component("YGL070C",129).
component("YFL036W",120).
component("YDR404C",102).
component("YDR156W",92).
component("YDR045C",84).
component("YDL150W",79).
component("YDL140C",78).
component("YBR154C",61).
component("YPR175W",266).
component("YPL167C",250).
component("YOR330C",241).
component("YOL115W",230).
component("YNL299W",219).
component("YNL262W",217).
component("YNL102W",211).
component("YJR043C",169).
component("YJR006W",168).
component("YJL090C",161).
component("YIL139C",156).
component("YEL055C",110).
component("YDR419W",104).
component("YDR121W",86).
component("YDL102W",76).
component("YCR014C",72).
component("YBR278W",67).
component("YBL035C",51).
component("YPR113W",264).
component("U105_",18).
component("YLR377C",203).
component("U30_",36).
component("U29_",35).
component("U24_",34).
component("YGL027C",127).
component("YOR190W",235).
component("YLR300W",202).
component("YGR282C",142).
component("YDR261C",96).
component("YDR400W",101).
component("YML035C",205).
component("YJL070C",160).
component("YBR284W",68).
component("YDR242W",94).
component("U53_",44).
component("YLR028C",191).
component("YHR144C",148).
component("YJL126W",162).
component("U39_",38).
component("YBR011C",54).
component("YBR111C",58).
component("YBR252W",66).
component("YER005W",112).
component("YLR231C",199).
component("U98_",48).
...
component("YER090W",118) :- not remove_orf("YER090W",118).
component("YDR127W",90).
component("YPL281C",259).
component("YOR393W",246).
component("YMR323W",208).
component("YHR174W",149).
component("YGR254W",140).
component("YGL026C",126) :- not remove_orf("YGL026C",126).
component("YNL316C",220).
component("YDR127W",91).
component("YGL148W",130).
component("YIL168W",159).
component("YIL167W",158).
component("YCL064C",71).
component("YAL012W",49).
component("YDR007W",81) :- not remove_orf("YDR007W",81).
component("YOR095C",232).
component("YGL001C",125).
component("YPL117C",249).
component("YPR060C",261).
component("YPL097W",247).
component("YGR185C",139).
component("YGR264C",141).
component("YGR171C",138).
component("YPL104W",248).
component("YLL018C",188).
component("YOL097C",228).
component("YDR268W",97).
component("YOR335C",242).
component("YLR153C",196).
component("YAL054C",50).
component("U90_",46).
component("YNR057C",223).
component("YJR103W",173).
component("YBL039C",52).
component("YGL062W",128).
component("YBR218C",64).
component("YPR138C",265).
component("YPL265W",255).
component("YOL103W",229).
component("YOL020W",226) :- not remove_orf("YOL020W",226).
component("YNL270C",218).
component("YNL142W",213).
component("YLR100C",194).
component("YKR053C",186).
component("YKR039W",185) :- not remove_orf("YKR039W",185).
component("YJR077C",171).
component("YJL134W",164).
component("YJL129C",163).
component("YHL036W",144).
component("YGR121C",137).
component("YGR065C",135).
component("YGR055W",134).
component("YGL186C",131).
component("YFL055W",121).
component("YER060W-A",116).
component("YER060W",115).
component("YER056C",114).
component("YEL063C",111).
component("YDR536W",109).
component("YDR508C",108).
component("YDR497C",107).
component("YDR297W",98).
component("YDR046C",85) :- not remove_orf("YDR046C",85).
component("YCL025C",70).
...
catalyst(5601,197).
catalyst(5602,197).
catalyst(3620,100) :- not remove_reaction(3620,100).
catalyst(2190,123).
catalyst(5791,198).
catalyst(5792,198).
catalyst(5801,198).
...
catalyst(3630,118) :- not remove_reaction(3630,118).
catalyst(3740,90).
catalyst(8231,259).
catalyst(8232,259).
catalyst(8231,246).
...
catalyst(8231,140).
catalyst(8232,140).
catalyst(3590,126) :- not remove_reaction(3590,126).
catalyst(10910,126) :- not remove_reaction(10910,126).
catalyst(3680,220).
catalyst(3750,91).
catalyst(3700,130).
catalyst(8751,159).
...
catalyst(4520,71).
catalyst(4460,49).
catalyst(3610,81) :- not remove_reaction(3610,81).
catalyst(7921,232).
catalyst(7922,232).
catalyst(6370,125).
catalyst(6461,249).
...
catalyst(781,185) :- not remove_reaction(781,185).
catalyst(782,185) :- not remove_reaction(782,185).
...
catalyst(881,185) :- not remove_reaction(881,185).
catalyst(882,185) :- not remove_reaction(882,185).
catalyst(901,185) :- not remove_reaction(901,185).
catalyst(902,185) :- not remove_reaction(902,185).
catalyst(931,185) :- not remove_reaction(931,185).
catalyst(932,185) :- not remove_reaction(932,185).
catalyst(1191,185) :- not remove_reaction(1191,185).
catalyst(1192,185) :- not remove_reaction(1192,185).
catalyst(1581,171).
catalyst(1582,171).
catalyst(6560,164).
catalyst(361,163).
...
catalyst(841,85) :- not remove_reaction(841,85).
catalyst(842,85) :- not remove_reaction(842,85).
...
catalyst(841,56) :- not remove_reaction(841,56).
catalyst(842,56) :- not remove_reaction(842,56).
catalyst(851,56) :- not remove_reaction(851,56).
catalyst(852,56) :- not remove_reaction(852,56).
catalyst(901,56) :- not remove_reaction(901,56).
catalyst(902,56) :- not remove_reaction(902,56).
catalyst(6980,42).
catalyst(6980,39).
catalyst(41,33).
catalyst(42,33).
