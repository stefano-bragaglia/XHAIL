...
component("YNL280C",649).
component("YLR056W",556).
component("YGR060W",384).
component("YGL012W",356).
component("YKR009C",538).
component("YOL086C",674).
component("YMR303C",623).
component("YGL256W",378).
component("YDL168W",239).
component("YBR145W",179).
component("YPL231W",736).
component("YBR265W",194).
component("U46_",104).
component("YBR149W",180).
component("YBR149W",181).
component("YGL001C",353).
component("YIL094C",452).
component("U45_",103).
component("YML056C",600).
component("YLR432W",590).
component("YHR216W",444).
component("YAR075W",151).
component("YAR073W",150).
component("YDR127W",264).
component("YJR139C",512).
component("YML075C",602).
component("YLR450W",593).
component("YOL126C",680).
component("YKL085W",520).
component("YDL078C",226).
component("YNL037C",628).
component("YNL009W",626).
component("YLR174W",568).
component("YHR183W",437).
component("YGR256W",403).
component("YNL241C",642).
component("YOL059W",672).
component("YDL022W",219).
component("YCL018W",202).
component("YLR355C",585).
component("YIL074C",449).
component("YER081W",329).
component("YDL174C",243).
component("YML086C",604).
component("YIL155C",461).
component("YGR088W",387).
component("YDR256C",276).
component("YKL026C",518).
component("YIR037W",470).
component("YBR244W",190).
component("YJR078W",506).
component("U58_",112).
component("YJR025C",498).
component("U107_",24).
component("YHR007C",413).
component("YDR402C",290).
component("YGL055W",363).
component("YJR104C",508).
component("YHR008C",414).
component("YOR384W",716).
component("YOR381W",715).
component("YOL152W",682).
component("YLL051C",549).
component("YJL026W",472).
component("YIL066C",448).
component("YGR180C",393).
component("YER070W",326).
component("U37_",97).
component("U36_",96).
component("YDL168W",240).
component("YJR009C",495).
component("YJL052W",474).
component("YGR192C",395).
component("YBR006W",161).
component("YPL276W",744).
component("YPL275W",743).
component("YOR388C",717).
component("YOR374W",713).
component("YER073W",327).
component("YGL154C",370).
component("YBR115C",175).
component("U55_",111).
component("YER069W",324).
component("YOR323C",705).
component("YER178W",338).
component("YBR221C",188).
component("YIL125W",457).
component("U52_",109).
component("YBR166C",183).
component("YGL012W",357).
component("YKL182W",529).
component("YKL216W",537).
component("YDR044W",255).
component("YKR009C",539).
component("YIL160C",462).
component("YGL205W",375).
component("YMR118C",613).
component("YLR164W",566).
component("YLL041C",548).
component("YKL148C",524).
component("YKL141W",522).
component("YJL045W",473).
component("YDR178W",271).
component("YEL047C",309).
component("YDL171C",241).
component("YDL171C",242).
component("YOR375C",714).
component("YDL215C",247).
component("YAL062W",148).
component("U99_",143).
component("U100_",20).
component("YBR035C",167).
component("YKR080W",544).
component("YER023W",316).
component("YOR236W",703).
component("YGR204W",397).
component("YIR034C",469).
component("YLR142W",563).
component("U65_",118).
component("U63_",116).
component("U62_",115).
component("YHR068W",423).
component("YKL150W",525).
component("YIL043C",447).
component("YHR042W",418).
component("YPL171C",729).
component("YHR179W",436).
component("YMR145C",616).
component("YML120C",605).
component("YKL192C",532).
component("YDL085W",228).
component("YGR234W",399).
component("YFR030W",349).
component("YPL017C",719).
component("YFL018C",342).
component("YDR353W",286).
component("YPR167C",757).
component("YJR137C",511).
component("YNL052W",630).
component("YMR256C",622).
component("YLR395C",589).
component("YLR038C",554).
component("YIL111W",454).
component("YHR051W",422).
component("YGL191W",373).
component("YGL187C",372).
component("YDL067C",225).
component("Q0275",19).
component("Q0250",18).
component("YDR072C",260).
component("YPL266W",742).
component("YKR069W",543).
component("YOL096C",675).
component("U47_",105).
component("YER091C",334).
component("YJR073C",504).
component("YGR157W",391).
component("YDR120C",262).
component("YML008C",595).
component("YOR074C",687).
component("YDL033C",221).
component("YOL096C",676).
component("YLR172C",567).
component("YLR058C",557).
component("YDR019C",253).
component("YBR176W",184).
component("YDR408C",292).
component("YMR120C",614).
component("YLR028C",552).
component("YBL013W",152).
component("YJL130C",482).
component("YKL024C",517).
component("YPR074C",752).
component("YBR117C",176).
component("YMR108W",612).
component("YCL009C",201).
component("YNL071W",632).
component("YNR008W",654).
component("YIL160C",463).
component("YNR019W",657).
component("YCR048W",215).
component("U48_",106).
component("YDR232W",273).
component("YPL231W",737).
component("YER061C",323).
component("YDL052C",224).
component("U8_",137).
component("YPL231W",738).
component("YPL028W",720).
component("YLR299W",578).
component("YGL017W",358).
component("YCR005C",207).
component("YML126C",606).
component("YNL104C",635).
component("YDL182W",244).
component("YDL131W",232).
component("YDR307W",282).
component("YLR258W",575).
component("YFR015C",347).
component("YNL029C",627).
component("YIL085C",451).
component("YMR306W",624).
component("YLR342W",584).
component("YGR032W",381).
component("YLR209C",570).
component("U104_",21).
component("YDR354W",287) :- not remove_orf("YDR354W",287).
component("YFR047C",350).
component("YJR133W",510).
component("YLR209C",571).
component("YML022W",597).
component("YDR441C",295).
component("YHR128W",431).
component("YJL167W",487).
component("YJL167W",488).
component("YDR127W",265).
component("YHR190W",439).
component("YLR146C",564).
component("YHR068W",424).
component("YLR303W",580).
component("YGR012W",379).
component("YML082W",603).
component("YJR130C",509).
component("YDR035W",254).
component("YBR249C",191).
component("YLR180W",569).
component("YDR502C",298).
component("YOR274W",704).
component("YBR256C",193).
component("YHR137W",432).
component("YGL202W",374).
component("YLR027C",551).
component("YKL106W",521).
component("YOL140W",681).
component("YLR438W",592).
component("YGR019W",380).
component("YLR089C",559).
component("U64_",117).
component("U61_",114).
component("U51_",108).
component("YJR148W",513).
component("YHR208W",442).
component("YFL030W",343).
component("YOR184W",696).
component("YNR058W",662).
component("YIL116W",456).
component("YGL253W",377).
component("YFR053C",351).
component("YMR013C",610).
component("YMR205C",618).
component("YGR240C",400).
component("YOL016C",666).
component("YFR014C",346).
component("YLR240W",573).
component("YKL203C",534).
component("YJR066W",503).
component("YCR036W",214).
component("YCL040W",204).
component("U15_",49).
component("YPL188W",731).
component("YJR049C",500).
component("YEL041W",307).
component("U96_",141).
component("YKL001C",516).
component("YDR236C",274).
component("YHL032C",411).
component("YDR531W",302).
component("U83_",134).
component("U82_",133).
component("U81_",132).
component("YMR208W",619).
component("YPL203W",732).
component("YOR061W",686).
component("YKL166C",527).
component("YJL164C",486).
component("YIL035C",446).
component("YHR205W",441).
component("YHR102W",430).
component("YGL019W",359).
component("YHR025W",417).
component("YOR347C",710).
component("YAL038W",146).
component("YNR012W",655).
component("YDR009W",252).
component("YDR127W",266).
component("YDR147W",269).
component("YDR300C",281).
component("YCR012W",208).
component("YER069W",325).
component("U19_",76).
component("U18_",68).
component("U17_",60).
component("U76_",127).
component("YER170W",337).
component("YDR226W",272).
component("YKL067W",519).
component("YOL055C",669).
component("YDR454C",296).
component("YJR057W",501).
component("YOL061W",673).
component("YKL181W",528).
component("YHL011C",410).
component("YER099C",335).
component("YBL068W",159).
component("YOR143C",692).
component("YNL256W",645).
component("YLR328W",582).
component("YBR018C",163).
component("YGR202C",396).
component("YLR328W",583).
component("U80_",131).
component("U94_",140).
component("YJR010W",496).
component("YBR029C",166).
component("YCL050C",205).
component("YGL130W",368).
component("YDR530C",301).
component("YPR190C",760).
component("YPR187W",759).
component("YPR110C",754).
component("YPR010C",747).
component("YOR341W",709).
component("YOR340C",708).
component("YOR224C",702).
component("YOR210W",700).
component("YOR207C",698).
component("YOR151C",693).
component("YOR116C",689).
component("YOL005C",664).
component("YNR003C",653).
component("YNL248C",644).
component("YNL151C",639).
component("YNL113W",636).
component("YKL144C",523).
component("YJR063W",502).
component("YJL148W",485).
component("YJL140W",484).
component("YIL021W",445).
component("YHR143W-A",433).
component("YGL070C",366).
component("YFL036W",344).
component("YDR404C",291).
component("YDR156W",270).
component("YDR045C",256).
component("YDL150W",238).
component("YDL140C",234).
component("YBR154C",182).
component("YPR175W",758).
component("YPL167C",728).
component("YOR330C",706).
component("YOL115W",679).
component("YNL299W",651).
component("YNL262W",647).
component("YNL102W",634).
component("YJR043C",499).
component("YJR006W",494).
component("YJL090C",477).
component("YIL139C",459).
component("YEL055C",310).
component("YDR419W",293).
component("YDR121W",263).
component("YDL102W",231).
component("YCR014C",209).
component("YBR278W",196).
component("YBL035C",155).
component("YPR113W",755).
component("YBR243C",189).
component("YPL148C",726).
component("YER026C",317).
component("YGR286C",407).
component("YHR189W",438).
component("YDR058C",259).
component("YDL086W",229).
component("YOL011W",665).
component("YMR008C",608).
component("YMR006C",607).
component("U105_",22).
component("YBL015W",153).
component("YJL068C",475).
component("YOR040W",685).
component("U77_",128).
component("YLR377C",587).
component("YPL179W",730).
component("YNR032W",658).
component("YML057W",601).
component("YML016C",596).
component("YLR433C",591).
component("YGR123C",389).
component("YER133W",336).
component("YER089C",332).
component("YDR436W",294).
component("YDR075W",261).
component("YDL188C",245).
component("YDL134C",233).
component("YDL047W",223).
component("YDL006W",217).
component("YBR125C",178).
component("YBL056W",158).
component("YPR073C",750).
component("YHR215W",443).
component("YDL024C",220).
component("YBR093C",173).
component("YBR092C",172).
component("YHR046C",421).
component("U9_",144).
component("YPL228W",735).
component("YMR180C",617).
component("YDL236W",249).
component("YPR073C",751).
component("YOR208W",699).
component("YNL053W",631).
component("YMR036C",611).
component("YIR026C",468).
component("YIL113W",455).
component("YFR028C",348).
component("YER075C",328).
...
component("U25_",88).
component("U24_",87).
component("YHR044C",420).
component("YHR043C",419).
component("YOR360C",712).
component("YKR031C",540).
component("YPL206C",733).
component("YGL027C",361).
component("YLR286C",577).
component("YJR153W",514).
component("YJL221C",493).
component("YJL216C",491).
component("YIL172C",466).
component("YGR292W",409).
component("YGR287C",408).
component("YBR299W",200).
component("YBR184W",185).
component("YIR019C",467).
component("YIL099W",453).
component("YDL037C",222).
component("YOR190W",697).
component("YLR300W",579).
component("YGR282C",406).
component("YDR261C",277).
component("YDR400W",289).
component("YML035C",598).
component("YJL070C",476).
component("YBR284W",197).
component("U106_",23).
component("YER043C",318).
component("YNL045W",629).
component("YGL037C",362).
component("YDR242W",275).
component("U53_",110).
component("YPR062W",749).
component("YMR120C",615).
component("YLR028C",553).
component("YHR144C",434).
component("YGR267C",405).
component("YBL033C",154).
component("YNL141W",637).
component("YLR245C",574).
component("YML035C",599).
component("YBR084W",170).
component("YJL126W",480).
component("U44_",102).
component("YDL100C",230).
component("U87_",136).
component("U40_",100).
component("U39_",98).
component("YBR011C",162).
component("YHR201C",440).
component("YBR111C",174).
component("YBR252W",192).
component("YER005W",315).
component("YBL099W",160).
component("YLR231C",572).
component("YDR538W",304).
component("YLR134W",561).
component("YLR044C",555).
component("YGR087C",386).
component("YDR380W",288).
component("YDL080C",227).
component("U98_",142).
component("YMR250W",621).
component("YOR128C",690).
component("YEL021W",306).
component("YNR043W",660).
component("U93_",139).
component("YKL211C",535) :- not remove_orf("YKL211C",535).
component("YKR097W",546).
component("YNL169C",640).
component("YNL256W",646).
component("YDR294C",279).
component("YEL046C",308).
component("YNR033W",659).
component("YKL211C",536) :- not remove_orf("YKL211C",536).
component("YER090W",536) :- not remove_orf("YER090W",536).
component("YER090W",333) :- not remove_orf("YER090W",333).
component("YDR127W",267).
component("YPL281C",745).
component("YOR393W",718).
component("YMR323W",625).
component("YHR174W",435).
component("YGR254W",402).
component("YPL262W",740).
component("YGL026C",360) :- not remove_orf("YGL026C",360).
component("YGR155W",390).
component("YLR304C",581).
component("YJL200C",489).
component("YNL316C",652).
component("YKL182W",530).
component("YPL212C",734).
component("YNL292W",650).
component("YGL063W",365).
component("YFL001W",340).
component("YPR002W",746).
component("YJR016C",497).
component("YCR053W",216).
component("YDR127W",268).
component("YGL148W",369).
component("YIL168W",465).
component("YIL167W",464).
component("YCL064C",206).
component("YER086W",330).
component("YLR359W",586).
component("YAL012W",145).
component("YML004C",594).
component("YFR055W",352).
component("YJL005W",471).
component("YJL121C",479).
component("YBR019C",164).
component("YDR050C",258).
component("YDR007W",251) :- not remove_orf("YDR007W",251).
component("YOR095C",688).
component("YER003C",314).
component("YBR196C",186).
component("YGL001C",354).
component("YPL117C",724).
component("U14_",41).
component("YOL056W",670).
component("YKL152C",526).
component("YDL021W",218).
component("YEL058W",311).
component("YPR060C",748).
component("YHR072W",425).
component("YPL097W",722).
component("YGR185C",394).
component("YGR264C",404).
component("YGR171C",392).
component("YPL104W",723).
component("YLL018C",547).
component("YPR081C",753).
component("YBR121C",177).
component("YHR020W",416).
component("YER087W",331).
component("YNL247W",643).
component("YOR168W",694).
component("YOL097C",677).
component("YDR268W",278).
component("YCR024C",210).
component("YHR019C",415).
component("YKL194C",533).
component("YIL078W",450).
component("YPL160W",727).
component("YLR382C",588).
component("YNL073W",633).
component("YOR335C",707).
component("YLR153C",565).
component("YAL054C",147).
component("YGR244C",401).
component("YIL145C",460).
component("YJL101C",478).
component("YOL049W",668).
component("YAR015W",149).
component("YER183C",339).
component("U90_",138).
component("YNR057C",661).
component("YDL141W",235).
component("YGL234W",376).
component("YDL141W",236).
component("YJR103W",507).
component("YBL039C",156).
component("YGR204W",398).
component("YBR084W",171).
component("YNL220W",641).
component("YOL058W",671).
component("YDL141W",237).
component("YHR074W",426).
component("YMR217W",620).
component("YGL062W",364).
component("YBR218C",187).
component("YPL231W",739).
component("YNR016C",656).
component("YKL182W",531).
component("YGR037C",382).
component("YPR138C",756).
component("YPL265W",741).
component("YPL134C",725).
component("YPL036W",721).
component("YOR348C",711).
component("YOR222W",701).
component("YOR171C",695).
component("YOR130C",691).
component("YOR011W",684).
component("YOL156W",683).
component("YOL103W",678).
component("YOL020W",667) :- not remove_orf("YOL020W",667).
component("YNR072W",663).
component("YNL270C",648).
component("YNL142W",638).
component("YMR011W",609).
component("YLR260W",576).
component("YLR138W",562).
component("YLR100C",560).
component("YLR081W",558).
component("YLL061W",550).
component("YKR093W",545).
component("YKR053C",542).
component("YKR039W",541) :- not remove_orf("YKR039W",541).
component("YJR158W",515).
component("YJR077C",505).
component("YJL219W",492).
component("YJL214W",490).
component("YJL134W",483).
component("YJL129C",481).
component("YIL134W",458).
component("YHR096C",429).
component("YHR094C",428).
component("YHR092C",427).
component("YHL036W",412).
component("YGR121C",388).
component("YGR065C",385).
component("YGR055W",383).
component("YGL186C",371).
component("YGL077C",367).
component("YGL008C",355).
component("YFL055W",345).
component("YFL011W",341).
component("YER060W-A",322).
component("YER060W",321).
component("YER056C",320).
component("YER053C",319).
component("YEL069C",313).
component("YEL063C",312).
component("YEL017C-A",305).
component("YDR536W",303).
component("YDR508C",300).
component("YDR503C",299).
component("YDR497C",297).
component("YDR345C",285).
component("YDR343C",284).
component("YDR342C",283).
component("YDR297W",280).
component("YDR046C",257) :- not remove_orf("YDR046C",257).
component("YDL245C",250).
component("YDL210W",246).
component("YCR032W",213).
component("YCR028C",212).
...
catalyst(6470,660).
catalyst(2300,139).
catalyst(3600,535) :- not remove_reaction(3600,535).
catalyst(8000,546).
catalyst(6890,640).
catalyst(2570,646).
catalyst(8781,279).
...
catalyst(4560,308).
catalyst(2550,659).
catalyst(1890,536) :- not remove_reaction(1890,536).
catalyst(3630,536) :- not remove_reaction(3630,536).
...
catalyst(8051,740).
catalyst(8052,740).
catalyst(3590,360) :- not remove_reaction(3590,360).
catalyst(10910,360) :- not remove_reaction(10910,360).
catalyst(4570,390).
catalyst(8181,581).
catalyst(8182,581).
catalyst(8181,489).
...
catalyst(1210,683).
catalyst(1160,678).
catalyst(801,667) :- not remove_reaction(801,667).
catalyst(802,667) :- not remove_reaction(802,667).
catalyst(811,667) :- not remove_reaction(811,667).
catalyst(812,667) :- not remove_reaction(812,667).
catalyst(831,667) :- not remove_reaction(831,667).
catalyst(832,667) :- not remove_reaction(832,667).
catalyst(901,667) :- not remove_reaction(901,667).
catalyst(902,667) :- not remove_reaction(902,667).
catalyst(1180,663).
catalyst(1210,663).
catalyst(931,648).
catalyst(932,648).
...
catalyst(851,541) :- not remove_reaction(851,541).
catalyst(852,541) :- not remove_reaction(852,541).
...
catalyst(921,541) :- not remove_reaction(921,541).
catalyst(922,541) :- not remove_reaction(922,541).
catalyst(931,541) :- not remove_reaction(931,541).
catalyst(932,541) :- not remove_reaction(932,541).
...
catalyst(831,257) :- not remove_reaction(831,257).
catalyst(832,257) :- not remove_reaction(832,257).
catalyst(841,257) :- not remove_reaction(841,257).
catalyst(842,257) :- not remove_reaction(842,257).
...
catalyst(851,169) :- not remove_reaction(851,169).
catalyst(852,169) :- not remove_reaction(852,169).
...
catalyst(851,168) :- not remove_reaction(851,168).
catalyst(852,168) :- not remove_reaction(852,168).
