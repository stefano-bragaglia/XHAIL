...
component("YNL280C",578).
component("YLR056W",495).
component("YGL012W",313).
component("YKR009C",477).
component("YOL086C",600).
component("YMR303C",553).
component("YGL256W",333).
component("YDL168W",215).
component("YBR145W",162).
component("YPL231W",655).
component("YBR265W",176).
component("U46_",95).
component("YBR149W",163).
component("YBR149W",164).
component("YGL001C",310).
component("YIL094C",399).
component("U45_",94).
component("YML056C",534).
component("YLR432W",528).
component("YHR216W",393).
component("YAR075W",138).
component("YAR073W",137).
component("YDR127W",234).
component("YOL126C",606).
component("YKL085W",463).
component("YDL078C",203).
component("YNL037C",558).
component("YNL009W",556).
component("YLR174W",507).
component("YHR183W",387).
component("YGR256W",354).
component("YOL059W",598).
component("YDL022W",197).
component("YCL018W",184).
component("YLR355C",523).
component("YDL174C",219).
component("YML086C",536).
component("YGR088W",341).
component("YDR256C",246).
component("YKL026C",461).
component("YIR037W",416).
component("YBR244W",173).
component("YJR078W",450).
component("U58_",102).
component("YJR025C",443).
component("U107_",24).
component("YHR007C",364).
component("YJR104C",452).
component("YHR008C",365).
component("YOR384W",638).
component("YOR381W",637).
component("YOL152W",608).
component("YLL051C",488).
component("YJL026W",418).
component("YIL066C",397).
component("YGR180C",345).
component("YER070W",288).
component("U37_",88).
component("U36_",87).
component("YDL168W",216).
component("YJR009C",441).
component("YJL052W",420).
component("YGR192C",347).
component("YBR006W",147).
component("YPL276W",663).
component("YPL275W",662).
component("YOR388C",639).
component("YOR374W",635).
component("YER073W",289).
component("YGL154C",325).
component("U55_",101).
component("YER069W",286).
component("YOR323C",628).
component("YER178W",296).
component("YBR221C",171).
component("YIL125W",404).
component("U52_",99).
component("YBR166C",166).
component("YGL012W",314).
component("YKL216W",476).
component("YDR044W",228).
component("YKR009C",478).
component("YIL160C",408).
component("YGL205W",330).
component("YMR118C",544).
component("YLR164W",505).
component("YLL041C",487).
component("YKL148C",467).
component("YKL141W",465).
component("YJL045W",419).
component("YDR178W",241).
component("YEL047C",274).
component("YDL171C",217).
component("YDL171C",218).
component("YOR375C",636).
component("YDL215C",221).
component("YAL062W",135).
component("U99_",130).
component("U100_",20).
component("YBR035C",153).
component("YKR080W",483).
component("YER023W",280).
component("YOR236W",626).
component("YGR204W",348).
component("YIR034C",415).
component("YLR142W",502).
component("U65_",108).
component("U63_",106).
component("U62_",105).
component("YHR068W",374).
component("YKL150W",468).
component("YIL043C",396).
component("YHR042W",369).
component("YPL171C",650).
component("YHR179W",386).
component("YMR145C",547).
component("YML120C",537).
component("YKL192C",473).
component("YDL085W",205).
component("YGR234W",350).
component("YFR030W",307).
component("YPL017C",641).
component("YFL018C",300).
component("YDR353W",254).
component("YPR167C",675).
component("YJR137C",455).
component("YNL052W",560).
component("YMR256C",552).
component("YLR395C",527).
component("YLR038C",493).
component("YIL111W",401).
component("YHR051W",373).
component("YGL191W",328).
component("YGL187C",327).
component("YDL067C",202).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",661).
component("YKR069W",482).
component("YOL096C",601).
component("U47_",96).
component("YER091C",293).
component("YJR073C",448).
component("YDR120C",232).
component("YML008C",530).
component("YDL033C",199).
component("YOL096C",602).
component("YLR172C",506).
component("YLR058C",496).
component("YDR019C",226).
component("YBR176W",167).
component("YDR408C",259).
component("YMR120C",545).
component("YLR028C",491).
component("YBL013W",139).
component("YJL130C",428).
component("YKL024C",460).
component("YPR074C",671).
component("YBR117C",161).
component("YCL009C",183).
component("YNL071W",562).
component("YNR008W",583).
component("YIL160C",409).
component("YNR019W",586).
component("YCR048W",194).
component("U48_",97).
component("YDR232W",243).
component("YPL231W",656).
component("YDL052C",201).
component("U8_",124).
component("YPL231W",657).
component("YPL028W",642).
component("YLR299W",516).
component("YGL017W",315).
component("YML126C",538).
component("YNL104C",565).
component("YDL182W",220).
component("YDL131W",209).
component("YLR258W",513).
component("YFR015C",305).
component("YNL029C",557).
component("YIL085C",398).
component("YMR306W",554).
component("YLR342W",522).
component("YGR032W",336).
component("YLR209C",509).
component("U104_",21).
component("YDR354W",255) :- not remove_orf("YDR354W",255).
component("YFR047C",308).
component("YJR133W",454).
component("YLR209C",510).
component("YML022W",531).
component("YDR441C",261).
component("YJL167W",433).
component("YJL167W",434).
component("YDR127W",235).
component("YLR146C",503).
component("YHR068W",375).
component("YLR303W",518).
component("YGR012W",334).
component("YML082W",535).
component("YJR130C",453).
component("YDR035W",227).
component("YBR249C",174).
component("YLR180W",508).
component("YDR502C",264).
component("YOR274W",627).
component("YHR137W",382).
component("YGL202W",329).
component("YLR027C",490).
component("YKL106W",464).
component("YOL140W",607).
component("YLR438W",529).
component("YGR019W",335).
component("YLR089C",498).
component("U64_",107).
component("U61_",104).
component("YJR148W",456).
component("YHR208W",391).
component("YFL030W",301).
component("YOR184W",620).
component("YNR058W",589).
component("YIL116W",403).
component("YGL253W",332).
component("YFR053C",309).
component("YMR013C",542).
component("YMR205C",548).
component("YGR240C",351).
component("YOL016C",593).
component("YFR014C",304).
component("YCR036W",193).
component("YCL040W",186).
component("U15_",45).
component("YPL188W",651).
component("YJR049C",445).
component("YEL041W",272).
component("U96_",128).
component("YKL001C",459).
component("YDR236C",244).
component("YHL032C",362).
component("YDR531W",268).
component("U83_",123).
component("U82_",122).
component("U81_",121).
component("YMR208W",549).
component("YPL203W",652).
component("YOR061W",611).
component("YKL166C",470).
component("YJL164C",432).
component("YIL035C",395).
component("YHR205W",390).
component("YHR102W",381).
component("YGL019W",316).
component("YHR025W",368).
component("YOR347C",633).
component("YAL038W",133).
component("YNR012W",584).
component("YDR127W",236).
component("YDR147W",239).
component("YDR300C",250).
component("YCR012W",188).
component("YER069W",287).
component("U18_",62).
component("U76_",117).
component("YER170W",295).
component("YDR226W",242).
component("YKL067W",462).
component("YOL055C",596).
component("YDR454C",262).
component("YJR057W",446).
component("YOL061W",599).
component("YKL181W",471).
component("YHL011C",361).
component("YER099C",294).
component("YBL068W",145).
component("YOR143C",616).
component("YNL256W",574).
component("YLR328W",520).
component("YBR018C",149).
component("YLR328W",521).
component("U94_",127).
component("YBR029C",152).
component("YGL130W",323).
component("YDR530C",267).
component("YPR190C",678).
component("YPR187W",677).
component("YPR110C",672).
component("YPR010C",666).
component("YOR341W",632).
component("YOR340C",631).
component("YOR224C",625).
component("YOR210W",624).
component("YOR207C",622).
component("YOR151C",617).
component("YOR116C",613).
component("YOL005C",591).
component("YNR003C",582).
component("YNL248C",573).
component("YNL151C",569).
component("YNL113W",566).
component("YKL144C",466).
component("YJR063W",447).
component("YJL148W",431).
component("YJL140W",430).
component("YIL021W",394).
component("YHR143W-A",383).
component("YGL070C",321).
component("YFL036W",302).
component("YDR404C",258).
component("YDR156W",240).
component("YDR045C",229).
component("YDL150W",214).
component("YDL140C",210).
component("YBR154C",165).
component("YPR175W",676).
component("YPL167C",649).
component("YOR330C",629).
component("YOL115W",605).
component("YNL299W",580).
component("YNL262W",576).
component("YNL102W",564).
component("YJR043C",444).
component("YJR006W",440).
component("YJL090C",423).
component("YIL139C",406).
component("YEL055C",275).
component("YDR419W",260).
component("YDR121W",233).
component("YDL102W",208).
component("YCR014C",189).
component("YBR278W",178).
component("YBL035C",142).
component("YPR113W",673).
component("YBR243C",172).
component("YPL148C",647).
component("YGR286C",358).
component("YHR189W",388).
component("YDR058C",231).
component("YDL086W",206).
component("YOL011W",592).
component("YMR008C",540).
component("YMR006C",539).
component("U105_",22).
component("YBL015W",140).
component("YJL068C",421).
component("U77_",118).
component("YLR377C",525).
component("YPR073C",669).
component("YHR215W",392).
component("YDL024C",198).
component("YBR093C",159).
component("YBR092C",158).
component("YHR046C",372).
component("U9_",131).
component("YDL236W",223).
component("YPR073C",670).
component("YOR208W",623).
component("YNL053W",561).
component("YMR036C",543).
component("YIR026C",414).
component("YIL113W",402).
component("YFR028C",306).
component("YER075C",290).
component("YDL230W",222).
component("YBR276C",177).
component("U34_",86).
component("U33_",85).
component("U32_",84).
component("U31_",83).
...
component("U25_",79).
component("U24_",78).
component("YHR044C",371).
component("YHR043C",370).
component("YOR360C",634).
component("YKR031C",479).
component("YPL206C",653).
component("YGL027C",318).
component("YLR286C",515).
component("YJR153W",457).
component("YJL221C",439).
component("YJL216C",437).
component("YIL172C",412).
component("YGR292W",360).
component("YGR287C",359).
component("YBR299W",182).
component("YBR184W",168).
component("YIR019C",413).
component("YIL099W",400).
component("YDL037C",200).
component("YOR190W",621).
component("YLR300W",517).
component("YGR282C",357).
component("YDR261C",247).
component("YDR400W",257).
component("YML035C",532).
component("YJL070C",422).
component("YBR284W",179).
component("U106_",23).
component("YER043C",281).
component("YNL045W",559).
component("YDR242W",245).
component("U53_",100).
component("YPR062W",668).
component("YMR120C",546).
component("YLR028C",492).
component("YHR144C",384).
component("YGR267C",356).
component("YBL033C",141).
component("YNL141W",567).
component("YLR245C",512).
component("YML035C",533).
component("YBR084W",156).
component("YJL126W",426).
component("U44_",93).
component("YDL100C",207).
component("U40_",91).
component("U39_",89).
component("YBR011C",148).
component("YHR201C",389).
component("YBR111C",160).
component("YBR252W",175).
component("YER005W",279).
component("YBL099W",146).
component("YLR231C",511).
component("YLR134W",500).
component("YLR044C",494).
component("YGR087C",340).
component("YDR380W",256).
component("YDL080C",204).
component("U98_",129).
component("YMR250W",551).
component("YOR128C",614).
component("YEL021W",271).
component("U93_",126).
component("YKL211C",474) :- not remove_orf("YKL211C",474).
component("YKR097W",485).
component("YNL169C",570).
component("YNL256W",575).
component("YEL046C",273).
component("YNR033W",587).
component("YKL211C",475) :- not remove_orf("YKL211C",475).
component("YER090W",475) :- not remove_orf("YER090W",475).
component("YER090W",292) :- not remove_orf("YER090W",292).
component("YDR127W",237).
component("YPL281C",664).
component("YOR393W",640).
component("YMR323W",555).
component("YHR174W",385).
component("YGR254W",353).
component("YPL262W",659).
component("YGL026C",317) :- not remove_orf("YGL026C",317).
component("YGR155W",343).
component("YLR304C",519).
component("YJL200C",435).
component("YNL316C",581).
component("YPL212C",654).
component("YNL292W",579).
component("YGL063W",320).
component("YFL001W",298).
component("YPR002W",665).
component("YJR016C",442).
component("YCR053W",195).
component("YDR127W",238).
component("YGL148W",324).
component("YIL168W",411).
component("YIL167W",410).
component("YCL064C",187).
component("YLR359W",524).
component("YAL012W",132).
component("YJL005W",417).
component("YJL121C",425).
component("YBR019C",150).
component("YDR007W",225) :- not remove_orf("YDR007W",225).
component("YOR095C",612).
component("YBR196C",169).
component("YGL001C",311).
component("YPL117C",646).
component("U14_",39).
component("YOL056W",597).
component("YKL152C",469).
component("YDL021W",196).
component("YEL058W",276).
component("YPR060C",667).
component("YHR072W",376).
component("YPL097W",644).
component("YGR185C",346).
component("YGR264C",355).
component("YGR171C",344).
component("YPL104W",645).
component("YLL018C",486).
component("YHR020W",367).
component("YER087W",291).
component("YNL247W",572).
component("YOR168W",618).
component("YOL097C",603).
component("YDR268W",248).
component("YCR024C",190).
component("YHR019C",366).
component("YPL160W",648).
component("YLR382C",526).
component("YNL073W",563).
component("YOR335C",630).
component("YLR153C",504).
component("YAL054C",134).
component("YGR244C",352).
component("YIL145C",407).
component("YJL101C",424).
component("YOL049W",595).
component("YAR015W",136).
component("YER183C",297).
component("U90_",125).
component("YNR057C",588).
component("YDL141W",211).
component("YGL234W",331).
component("YDL141W",212).
component("YJR103W",451).
component("YBL039C",143).
component("YGR204W",349).
component("YBR084W",157).
component("YNL220W",571).
component("YDL141W",213).
component("YHR074W",377).
component("YMR217W",550).
component("YGL062W",319).
component("YBR218C",170).
component("YPL231W",658).
component("YNR016C",585).
component("YKL182W",472).
component("YGR037C",337).
component("YPR138C",674).
component("YPL265W",660).
component("YPL036W",643).
component("YOR171C",619).
component("YOR130C",615).
component("YOR011W",610).
component("YOL156W",609).
component("YOL103W",604).
component("YOL020W",594) :- not remove_orf("YOL020W",594).
component("YNR072W",590).
component("YNL270C",577).
component("YNL142W",568).
component("YMR011W",541).
component("YLR260W",514).
component("YLR138W",501).
component("YLR100C",499).
component("YLR081W",497).
component("YLL061W",489).
component("YKR093W",484).
component("YKR053C",481).
component("YKR039W",480) :- not remove_orf("YKR039W",480).
component("YJR158W",458).
component("YJR077C",449).
component("YJL219W",438).
component("YJL214W",436).
component("YJL134W",429).
component("YJL129C",427).
component("YIL134W",405).
component("YHR096C",380).
component("YHR094C",379).
component("YHR092C",378).
component("YHL036W",363).
component("YGR121C",342).
component("YGR065C",339).
component("YGR055W",338).
component("YGL186C",326).
component("YGL077C",322).
component("YGL008C",312).
component("YFL055W",303).
component("YFL011W",299).
component("YER060W-A",285).
component("YER060W",284).
component("YER056C",283).
component("YER053C",282).
component("YEL069C",278).
component("YEL063C",277).
component("YEL017C-A",270).
component("YDR536W",269).
component("YDR508C",266).
component("YDR503C",265).
component("YDR497C",263).
component("YDR345C",253).
component("YDR343C",252).
component("YDR342C",251).
component("YDR297W",249).
component("YDR046C",230) :- not remove_orf("YDR046C",230).
component("YDL245C",224).
component("YCR032W",192).
component("YCR024C-A",191).
component("YCL025C",185).
component("YBR298C",181).
component("YBR291C",180).
component("YBR069C",155) :- not remove_orf("YBR069C",155).
component("YBR068C",154) :- not remove_orf("YBR068C",154).
...
catalyst(5880,271).
catalyst(2300,126).
catalyst(3600,474) :- not remove_reaction(3600,474).
catalyst(8000,485).
catalyst(6890,570).
catalyst(2570,575).
catalyst(4560,273).
catalyst(2550,587).
catalyst(1890,475) :- not remove_reaction(1890,475).
catalyst(3630,475) :- not remove_reaction(3630,475).
catalyst(1890,292) :- not remove_reaction(1890,292).
catalyst(3630,292) :- not remove_reaction(3630,292).
catalyst(3740,237).
catalyst(8231,664).
catalyst(8232,664).
catalyst(8231,640).
...
catalyst(8051,659).
catalyst(8052,659).
catalyst(3590,317) :- not remove_reaction(3590,317).
catalyst(10910,317) :- not remove_reaction(10910,317).
catalyst(4570,343).
catalyst(8181,519).
catalyst(8182,519).
catalyst(8181,435).
...
catalyst(7751,150).
catalyst(7752,150).
catalyst(3610,225) :- not remove_reaction(3610,225).
catalyst(7921,612).
catalyst(7922,612).
catalyst(8341,169).
catalyst(8342,169).
...
catalyst(1210,609).
catalyst(1160,604).
catalyst(801,594) :- not remove_reaction(801,594).
catalyst(802,594) :- not remove_reaction(802,594).
catalyst(811,594) :- not remove_reaction(811,594).
catalyst(812,594) :- not remove_reaction(812,594).
catalyst(831,594) :- not remove_reaction(831,594).
catalyst(832,594) :- not remove_reaction(832,594).
catalyst(901,594) :- not remove_reaction(901,594).
catalyst(902,594) :- not remove_reaction(902,594).
catalyst(1180,590).
catalyst(1210,590).
catalyst(931,577).
catalyst(932,577).
...
catalyst(851,480) :- not remove_reaction(851,480).
catalyst(852,480) :- not remove_reaction(852,480).
...
catalyst(921,480) :- not remove_reaction(921,480).
catalyst(922,480) :- not remove_reaction(922,480).
catalyst(931,480) :- not remove_reaction(931,480).
catalyst(932,480) :- not remove_reaction(932,480).
...
catalyst(1491,180).
catalyst(1492,180).
catalyst(771,155) :- not remove_reaction(771,155).
catalyst(772,155) :- not remove_reaction(772,155).
...
catalyst(831,154) :- not remove_reaction(831,154).
catalyst(832,154) :- not remove_reaction(832,154).
catalyst(841,154) :- not remove_reaction(841,154).
catalyst(842,154) :- not remove_reaction(842,154).
