...
component("YLR056W",347).
component("YKR009C",333).
component("YOL086C",419).
component("YMR303C",382).
component("YGL256W",241).
component("YDL168W",154).
component("YBR145W",118).
component("YPL231W",460).
component("U46_",70).
component("YBR149W",119).
component("YGL001C",221).
component("YIL094C",283).
component("U45_",69).
component("YDR127W",165).
component("YOL126C",423).
component("YKL085W",323).
component("YDL078C",147).
component("YNL037C",386).
component("YCL018W",132).
component("YLR355C",368).
component("YDL174C",156).
component("YML086C",373).
component("YGR088W",248).
component("YDR256C",175).
component("YJR078W",315).
component("YJR025C",308).
component("U107_",23).
component("YJR104C",317).
component("YHR008C",264).
component("YJL026W",294).
component("YIL066C",281).
component("YGR180C",251).
...
component("U55_",76).
component("YER069W",204).
component("YOR323C",439).
component("YER178W",210).
component("YBR221C",124).
component("YIL125W",286).
component("U52_",74).
component("YBR166C",121).
component("YGL012W",224).
component("YKL216W",332).
component("YKR009C",334).
component("YIL160C",289).
component("YGL205W",238).
component("U100_",20).
component("YKR080W",339).
component("YER023W",198).
component("YGR204W",253).
component("YLR142W",352).
component("U65_",80).
component("U62_",79).
component("YHR068W",270).
component("YKL150W",326).
component("YIL043C",280).
component("YPL171C",456).
component("YHR179W",277).
component("YGR234W",255).
component("YPL017C",448).
component("YFL018C",212).
component("YDR353W",179).
component("YPR167C",480).
component("YNL052W",387).
component("YMR256C",381).
component("YLR395C",370).
component("YLR038C",345).
component("YIL111W",284).
component("YHR051W",269).
component("YGL191W",236).
component("YGL187C",235).
component("YDL067C",146).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",466).
component("YKR069W",338).
component("U47_",71).
component("YJR073C",313).
component("YDL033C",145).
component("YLR172C",354).
component("YLR058C",348).
component("YDR019C",160).
component("YBR176W",122).
component("YDR408C",184).
component("YMR120C",378).
component("YLR028C",343).
component("YBL013W",99).
component("YJL130C",300).
component("YKL024C",321).
component("YPR074C",476).
component("YBR117C",117).
component("YCL009C",131).
component("YNL071W",389).
component("YIL160C",290).
component("U48_",72).
component("YPL231W",461).
component("YPL231W",462).
component("YPL028W",449).
component("YLR299W",362).
component("YGL017W",225).
component("YML126C",374).
component("YNL104C",391).
component("YDL182W",157).
component("YDL131W",151).
component("YLR258W",359).
component("YFR015C",217).
component("YNL029C",385).
component("YIL085C",282).
component("YMR306W",383).
component("YLR342W",367).
component("YGR032W",243).
component("YLR209C",355).
component("U104_",21).
component("YDR354W",180) :- not remove_orf("YDR354W",180).
component("YFR047C",219).
component("YLR209C",356).
component("YML022W",371).
component("YDR441C",186).
component("YJL167W",304).
component("YDR127W",166).
component("YHR068W",271).
component("YLR303W",364).
component("YGR012W",242).
component("YJR130C",318).
component("YDR035W",161).
component("YBR249C",125).
component("YOR274W",438).
component("YHR137W",273).
component("YGL202W",237).
component("YLR027C",342).
component("YKL106W",324).
component("YOL140W",424).
component("YLR089C",349).
component("U61_",78).
component("YJR148W",319).
component("YFL030W",213).
component("YNR058W",410).
component("YGL253W",240).
component("YFR053C",220).
component("YMR205C",380).
component("YGR240C",256).
component("YOL016C",413).
component("YFR014C",216).
component("YCR036W",141).
component("YCL040W",134).
component("YPL188W",457).
component("YJR049C",310).
component("YEL041W",193).
component("U96_",93).
component("YDR236C",173).
component("YHL032C",262).
component("U83_",90).
component("YOR347C",444).
component("YAL038W",97).
component("YNR012W",406).
component("YDR127W",167).
component("YDR147W",170).
component("YCR012W",136).
component("U76_",88).
component("YER170W",209).
component("YDR226W",172).
component("YKL067W",322).
component("YOL055C",416).
component("YDR454C",187).
component("YJR057W",311).
component("YOL061W",418).
component("YKL181W",328).
component("YHL011C",261).
component("YER099C",208).
component("YBL068W",104).
component("YOR143C",429).
component("YNL256W",399).
component("YBR018C",107).
component("YLR328W",366).
component("U94_",92).
component("YBR029C",109).
component("YGL130W",232).
component("YPR190C",483).
component("YPR187W",482).
component("YPR110C",477).
component("YPR010C",471).
component("YOR341W",443).
component("YOR340C",442).
component("YOR224C",437).
component("YOR210W",436).
component("YOR207C",434).
component("YOR151C",430).
component("YOR116C",427).
component("YOL005C",411).
component("YNR003C",405).
component("YNL248C",398).
component("YNL151C",395).
component("YNL113W",392).
component("YKL144C",325).
component("YJR063W",312).
component("YJL148W",303).
component("YJL140W",302).
component("YIL021W",279).
component("YHR143W-A",274).
component("YGL070C",230).
component("YFL036W",214).
component("YDR404C",183).
component("YDR156W",171).
component("YDR045C",162).
component("YDL150W",153).
component("YDL140C",152).
component("YBR154C",120).
component("YPR175W",481).
component("YPL167C",455).
component("YOR330C",440).
component("YOL115W",422).
component("YNL299W",403).
component("YNL262W",400).
component("YNL102W",390).
component("YJR043C",309).
component("YJR006W",306).
component("YJL090C",296).
component("YIL139C",287).
component("YEL055C",195).
component("YDR419W",185).
component("YDR121W",164).
component("YDL102W",150).
component("YCR014C",137).
component("YBR278W",128).
component("YBL035C",102).
component("YPR113W",478).
component("YPL148C",454).
component("YGR286C",260).
component("YOL011W",412).
component("YMR008C",376).
component("YMR006C",375).
component("U105_",22).
component("YBL015W",100).
component("U77_",89).
component("YLR377C",369).
component("YPR073C",474).
component("YHR215W",278).
component("YDL024C",144).
component("YBR093C",115).
component("YBR092C",114).
component("YHR046C",268).
component("U9_",95).
component("YPR073C",475).
component("YOR208W",435).
component("YNL053W",388).
component("YMR036C",377).
component("YIR026C",293).
component("YIL113W",285).
component("YFR028C",218).
component("YER075C",206).
component("YDL230W",158).
component("YBR276C",127).
component("U34_",64).
component("U31_",63).
component("U30_",62).
component("U29_",61).
component("U26_",60).
component("U24_",59).
component("YHR044C",267).
component("YHR043C",266).
component("YOR360C",445).
component("YKR031C",335).
component("YPL206C",458).
component("YGL027C",227).
component("YLR286C",361).
component("YJR153W",320).
component("YOR190W",433).
component("YLR300W",363).
component("YGR282C",259).
component("YDR261C",176).
component("YDR400W",182).
component("YML035C",372).
component("YJL070C",295).
component("YBR284W",129).
component("YER043C",199).
component("YDR242W",174).
component("U53_",75).
component("YPR062W",473).
component("YMR120C",379).
component("YLR028C",344).
component("YHR144C",275).
component("YBL033C",101).
component("YNL141W",393).
component("YLR245C",358).
component("YBR084W",112).
component("YJL126W",298).
component("YDL100C",149).
component("U39_",66).
component("YBR011C",106).
component("YBR111C",116).
component("YBR252W",126).
component("YER005W",197).
component("YBL099W",105).
component("YLR231C",357).
component("YLR134W",351).
component("YLR044C",346).
component("YGR087C",247).
component("YDR380W",181).
component("YDL080C",148).
component("U98_",94).
component("YOR128C",428).
component("YKL211C",330) :- not remove_orf("YKL211C",330).
component("YKR097W",340).
component("YNL169C",396).
component("YEL046C",194).
component("YNR033W",408).
...
component("YMR323W",384).
component("YHR174W",276).
component("YGR254W",257).
component("YPL262W",464).
component("YGL026C",226) :- not remove_orf("YGL026C",226).
component("YLR304C",365).
component("YJL200C",305).
component("YNL316C",404).
component("YPL212C",459).
component("YNL292W",402).
component("YGL063W",229).
component("YFL001W",211).
component("YPR002W",470).
component("YJR016C",307).
component("YCR053W",142).
component("YDR127W",169).
component("YGL148W",233).
component("YIL168W",292).
component("YIL167W",291).
component("YCL064C",135).
component("YAL012W",96).
component("YBR019C",108).
component("YDR007W",159) :- not remove_orf("YDR007W",159).
component("YOR095C",426).
component("YGL001C",222).
component("YPL117C",453).
component("YOL056W",417).
component("YKL152C",327).
component("YDL021W",143).
component("YPR060C",472).
component("YPL097W",451).
component("YGR185C",252).
component("YGR264C",258).
component("YGR171C",250).
component("YPL104W",452).
component("YLL018C",341).
component("YNL247W",397).
component("YOR168W",431).
component("YOL097C",420).
component("YDR268W",177).
component("YCR024C",138).
component("YHR019C",265).
component("YOR335C",441).
component("YLR153C",353).
component("YAL054C",98).
component("YIL145C",288).
component("YJL101C",297).
component("YOL049W",415).
component("U90_",91).
component("YNR057C",409).
component("YGL234W",239).
component("YJR103W",316).
component("YBL039C",103).
component("YGR204W",254).
component("YBR084W",113).
component("YHR074W",272).
component("YGL062W",228).
component("YBR218C",123).
component("YPL231W",463).
component("YNR016C",407).
component("YKL182W",329).
component("YGR037C",244).
component("YPR138C",479).
component("YPL265W",465).
component("YPL036W",450).
component("YOR171C",432).
component("YOR011W",425).
component("YOL103W",421).
component("YOL020W",414) :- not remove_orf("YOL020W",414).
component("YNL270C",401).
component("YNL142W",394).
component("YLR260W",360).
component("YLR100C",350).
component("YKR053C",337).
component("YKR039W",336) :- not remove_orf("YKR039W",336).
component("YJR077C",314).
component("YJL134W",301).
component("YJL129C",299).
component("YHL036W",263).
component("YGR121C",249).
component("YGR065C",246).
component("YGR055W",245).
component("YGL186C",234).
component("YGL077C",231).
component("YGL008C",223).
component("YFL055W",215).
component("YER060W-A",203).
component("YER060W",202).
component("YER056C",201).
component("YER053C",200).
component("YEL063C",196).
component("YEL017C-A",192).
component("YDR536W",191).
component("YDR508C",190).
component("YDR503C",189).
component("YDR497C",188).
component("YDR297W",178).
component("YDR046C",163) :- not remove_orf("YDR046C",163).
component("YCR032W",140).
component("YCR024C-A",139).
component("YCL025C",133).
component("YBR298C",130).
component("YBR069C",111) :- not remove_orf("YBR069C",111).
component("YBR068C",110) :- not remove_orf("YBR068C",110).
component("U75_",87).
component("U74_",86).
component("U73_",85).
component("U72_",84).
...
catalyst(6111,428).
catalyst(6112,428).
catalyst(3600,330) :- not remove_reaction(3600,330).
catalyst(8000,340).
catalyst(6890,396).
catalyst(4560,194).
catalyst(2550,408).
...
catalyst(8051,464).
catalyst(8052,464).
catalyst(3590,226) :- not remove_reaction(3590,226).
catalyst(10910,226) :- not remove_reaction(10910,226).
catalyst(8181,365).
catalyst(8182,365).
catalyst(8181,305).
catalyst(8182,305).
...
catalyst(7751,108).
catalyst(7752,108).
catalyst(3610,159) :- not remove_reaction(3610,159).
catalyst(7921,426).
catalyst(7922,426).
catalyst(6370,222).
catalyst(6461,453).
...
catalyst(22,425).
catalyst(1160,421).
catalyst(801,414) :- not remove_reaction(801,414).
catalyst(802,414) :- not remove_reaction(802,414).
catalyst(811,414) :- not remove_reaction(811,414).
catalyst(812,414) :- not remove_reaction(812,414).
catalyst(831,414) :- not remove_reaction(831,414).
catalyst(832,414) :- not remove_reaction(832,414).
catalyst(901,414) :- not remove_reaction(901,414).
catalyst(902,414) :- not remove_reaction(902,414).
catalyst(931,401).
catalyst(932,401).
catalyst(371,394).
catalyst(372,394).
...
catalyst(6330,350).
catalyst(6560,337).
catalyst(771,336) :- not remove_reaction(771,336).
catalyst(772,336) :- not remove_reaction(772,336).
catalyst(781,336) :- not remove_reaction(781,336).
catalyst(782,336) :- not remove_reaction(782,336).
...
catalyst(881,336) :- not remove_reaction(881,336).
catalyst(882,336) :- not remove_reaction(882,336).
catalyst(901,336) :- not remove_reaction(901,336).
catalyst(902,336) :- not remove_reaction(902,336).
catalyst(931,336) :- not remove_reaction(931,336).
catalyst(932,336) :- not remove_reaction(932,336).
catalyst(1191,336) :- not remove_reaction(1191,336).
catalyst(1192,336) :- not remove_reaction(1192,336).
catalyst(1581,314).
catalyst(1582,314).
catalyst(6560,301).
catalyst(361,299).
...
catalyst(1121,130).
catalyst(1122,130).
catalyst(771,111) :- not remove_reaction(771,111).
catalyst(772,111) :- not remove_reaction(772,111).
...
catalyst(831,110) :- not remove_reaction(831,110).
catalyst(832,110) :- not remove_reaction(832,110).
catalyst(841,110) :- not remove_reaction(841,110).
catalyst(842,110) :- not remove_reaction(842,110).
