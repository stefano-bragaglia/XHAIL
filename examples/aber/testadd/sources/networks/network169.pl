...
component("YNL280C",848).
component("YLR056W",725).
component("YGR060W",502).
component("YGL012W",468).
component("YKR009C",702).
component("YOL086C",882).
component("YMR303C",819).
component("YMR083W",797).
component("YGL256W",494).
component("YDL168W",319).
component("YBR145W",245).
component("YPL231W",966).
component("YBR265W",264).
component("U46_",146).
component("YBR149W",246).
component("YBR149W",247).
component("YGL001C",464).
component("YIL094C",589).
component("YHR063C",552).
component("U45_",145).
component("YML056C",779).
component("YLR432W",768).
component("YHR216W",577).
component("YAR075W",204).
component("YAR073W",203).
component("YDR127W",353).
component("YJR139C",663).
component("YML075C",782).
component("YLR450W",771).
component("YOL126C",888).
component("YKL085W",677).
component("YDL078C",301).
component("YKL029C",672).
component("YNL037C",824).
component("YNL009W",822).
component("YLR174W",739).
component("YHR183W",570).
component("YGR256W",530).
component("YNL241C",839).
component("YOL059W",879).
component("YDL022W",292).
component("YCL018W",272).
component("YLR355C",763).
component("YIL074C",586).
component("YER081W",435).
component("YML054C",778).
component("YDL174C",323).
component("YML086C",784).
component("YIL155C",599).
component("YEL024W",404).
component("YKR066C",707).
component("YGR088W",506).
component("YDR256C",368).
component("YKL026C",671).
component("YIR037W",610).
component("YBR244W",259).
component("YJR078W",655).
component("U58_",155).
component("YJR025C",646).
component("U107_",27).
component("YGR255C",529).
component("U108_",28).
component("YHR007C",541).
component("YDR402C",383).
component("YGL055W",475).
component("YJR104C",658).
component("YHR008C",542).
component("YOR384W",937).
component("YOR381W",936).
component("YOL152W",892).
component("YLL051C",717).
component("YJL026W",612).
component("YIL066C",585).
component("YGR180C",516).
component("YER070W",432).
component("U37_",139).
component("U36_",138).
component("U35_",137).
component("YDL168W",320).
component("YDR158W",361).
component("YJR009C",642).
component("YJL052W",614).
component("YGR192C",518).
component("YBR006W",218).
component("YPL276W",976).
component("YPL275W",975).
component("YOR388C",938).
component("YPL061W",946).
component("YOR374W",934).
component("YER073W",433).
component("YGL154C",484).
component("YBR115C",240).
component("U55_",154).
component("YER069W",430).
component("YOR323C",924).
component("YMR170C",807).
component("YMR169C",806).
component("YER178W",446).
component("YBR221C",257).
component("YIL125W",595).
component("U52_",151).
component("YBR166C",250).
component("YNL280C",849).
component("YGL012W",469).
component("YKL182W",689).
component("YKL216W",700).
component("YDR044W",338).
component("YER014W",414).
component("YKR009C",703).
component("YIL160C",600).
component("YGL205W",489).
component("YMR118C",801).
component("YLR164W",737).
component("YLL041C",715).
component("YKL148C",683).
component("YKL141W",681).
component("YJL045W",613).
component("YDR178W",363).
component("YJR051W",649).
component("YEL047C",407).
component("YDL171C",321).
component("YDL171C",322).
component("YOR375C",935).
component("YDL215C",327).
component("YAL062W",200).
component("U99_",194).
component("U100_",21).
component("YBR035C",227).
component("YMR189W",809).
component("YKR080W",709).
component("YER023W",416).
component("YPL023C",942).
component("YGL125W",481).
component("YOR236W",921).
component("YGR204W",521).
component("YBR084W",233).
component("YIR034C",609).
component("YLR142W",734).
component("U65_",162).
component("U63_",160).
component("U62_",159).
component("YOR356W",932).
component("YHR068W",553).
component("YKL150W",684).
component("YIL043C",582).
component("YHR042W",547).
component("YOR221C",918).
component("YMR145C",804).
component("YML120C",785).
component("YKL192C",693).
component("YKL055C",674).
component("YER061C",426).
component("YDL085W",303).
component("YPL171C",955).
component("YHR179W",569).
component("YMR145C",805).
component("YML120C",786).
component("YKL192C",694).
component("YDL085W",304).
component("YGR234W",524).
component("YFR030W",460).
component("YPL017C",941).
component("YFL018C",450).
component("YPL091W",947).
component("YDR353W",378).
component("YER042W",418).
component("YPR167C",999).
component("YJR137C",662).
component("YNL052W",826).
component("YMR256C",816).
component("YLR395C",767).
component("YLR038C",723).
component("YIL111W",592).
component("YHR051W",551).
component("YGL191W",487).
component("YGL187C",486).
component("YDL067C",300).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",346).
component("YPL266W",973).
component("YPL273W",974).
component("YLL062C",719).
component("YDR410C",386).
component("YKR069W",708).
component("YOL096C",883).
component("U47_",147).
component("YER091C",440).
component("YJR073C",653).
component("YGR157W",513).
component("YDR120C",351).
component("YML008C",773).
component("YOR074C",898).
component("YDL033C",294).
component("YOL096C",884).
component("YLR172C",738).
component("YLR058C",726).
component("YDR019C",334).
component("YBR176W",251).
component("YDR408C",385).
component("YMR120C",802).
component("YLR028C",721).
component("YBL013W",205).
component("YJL130C",626).
component("YJL088W",619).
component("YKL024C",669).
component("YPR074C",990).
component("YBR117C",241).
component("YLR354C",762).
component("YGR043C",500).
component("YMR108W",800).
component("YCL009C",271).
component("YMR062C",795).
component("YNL071W",828).
component("YNR008W",855).
component("YIL160C",601).
component("YNR019W",858).
component("YCR048W",287).
component("U48_",148).
component("YNL277W",847).
component("YMR062C",796).
component("YDR232W",365).
component("YPL231W",967).
component("YER061C",427).
component("YPL001W",940).
component("YDL052C",298).
component("U8_",187).
component("YDR148C",359).
component("YPL231W",968).
component("YPL028W",943).
component("YLR299W",750).
component("YGL017W",470).
component("YCR005C",279).
component("YML126C",787).
component("YNL104C",831).
component("YDL182W",324).
component("YDL131W",310).
component("YPR160W",998).
component("YDR307W",374).
component("YLR258W",747).
component("YFR015C",457).
component("YPL227C",964).
component("YNL029C",823).
component("YIL085C",588).
component("YNL192W",837).
component("YBR038W",229).
component("YBR023C",225).
component("YEL011W",400).
component("YMR306W",820).
component("YLR342W",760).
component("YGR032W",498).
component("YPR183W",1002).
component("YBR248C",260).
component("YLR209C",741).
component("U104_",24).
component("U103_",23).
component("YOR209C",916).
component("YER055C",422).
component("YDR354W",379) :- not remove_orf("YDR354W",379).
component("YFR047C",461).
component("YJR133W",661).
component("U22_",124).
component("YLR209C",742).
component("YML022W",775).
component("YDR441C",389).
component("YHR128W",562).
component("YPR176C",1001).
component("YPL172C",956).
component("YNR041C",862).
component("YMR101C",798).
component("YDL090C",306).
component("YBR003W",217).
component("YBR002C",216).
component("YJL167W",634).
component("YJL167W",635).
component("YNL256W",842).
component("YPR069C",987).
component("YDR127W",354).
component("YHR190W",572).
component("YLR146C",735).
component("YPL214C",962).
component("YHR068W",554).
component("YLR303W",752).
component("YGR012W",496).
component("YML082W",783).
component("YJR130C",660).
component("YLR303W",753).
component("YDR035W",336).
component("YBR249C",261).
component("YLR180W",740).
component("YDR502C",393).
component("YOR274W",922).
component("YOL143C",891).
component("YBR256C",263).
component("YHR137W",563).
component("YGL202W",488).
component("YLR027C",720).
component("YKL106W",678).
component("YOL140W",890).
component("YLR438W",770).
component("YGR019W",497).
component("YLR089C",730).
component("YDR111C",350).
component("U64_",161).
component("U61_",158).
component("U51_",150).
component("YJR148W",664).
component("YHR208W",575).
component("YFL030W",452).
component("YOR184W",909).
component("YNR058W",866).
component("YIL116W",594).
component("YGL253W",493).
component("YFR053C",462).
component("YOL136C",889).
component("YIL107C",591).
component("YMR013C",791).
component("YMR205C",811).
component("YGR240C",525).
component("YOL016C",870).
component("YFR014C",456).
component("YLR240W",745).
component("YKL203C",696).
component("YJR066W",652).
component("YCR036W",286).
component("YGR194C",519).
component("YCL040W",275).
component("U15_",68).
component("YPL188W",958).
component("YJR049C",648).
component("YEL041W",405).
component("U96_",192).
component("YKL001C",667).
component("YDR236C",366).
component("YML070W",781).
component("YFL053W",454).
component("YHL032C",539).
component("YDR531W",397).
component("U83_",181).
component("U82_",180).
component("U81_",179).
component("YMR208W",812).
component("YPL203W",959).
component("YOR061W",896).
component("YKL166C",686).
component("YJL164C",633).
component("YIL035C",581).
component("YHR205W",574).
component("YHR102W",560).
component("YGL019W",471).
component("YHR025W",546).
component("YOR347C",930).
component("YAL038W",198).
component("YNR012W",856).
component("YPR121W",995).
component("YPL258C",970).
component("YOL055C",875).
component("YPL214C",963).
component("U1_",104).
component("YDR009W",333).
component("YDR127W",355).
component("U21_",116).
component("U20_",113).
component("YDR147W",358).
component("YDR300C",373).
component("YCR012W",280).
component("YER052C",420).
component("YER069W",431).
component("U19_",103).
component("YKL024C",670).
component("U18_",93).
component("U17_",83).
component("U76_",173).
component("YER170W",445).
component("YDR226W",364).
component("YKL067W",676).
component("YOL055C",876).
component("YDR454C",390).
component("YJR057W",650).
component("YOL061W",880).
component("YKL181W",688).
component("YHL011C",537).
component("YER099C",441).
component("YBL068W",213).
component("YOR143C",905).
component("YNL256W",843).
component("YLR328W",758).
component("YBR018C",220).
component("YBR018C",221).
component("YGR007W",495).
component("YGR202C",520).
component("YLR328W",759).
component("YDL045C",296).
component("U80_",178).
component("YDL103C",309).
component("U94_",191).
component("YJR010W",643).
component("YBR029C",226).
component("YCL050C",276).
component("YGL130W",482).
component("YDR530C",396).
component("YCL050C",277).
component("YPR190C",1004).
component("YPR187W",1003).
component("YPR110C",993).
component("YPR010C",980).
component("YOR341W",929).
component("YOR340C",928).
component("YOR224C",920).
component("YOR210W",917).
component("YOR207C",914).
component("YOR151C",906).
component("YOR116C",900).
component("YOL005C",868).
component("YNR003C",854).
component("YNL248C",841).
component("YNL151C",835).
component("YNL113W",832).
component("YKL144C",682).
component("YJR063W",651).
component("YJL148W",630).
component("YJL140W",629).
component("YIL021W",580).
component("YHR143W-A",564).
component("YGL070C",479).
component("YFL036W",453).
component("YDR404C",384).
component("YDR156W",360).
component("YDR045C",339).
component("YDL150W",318).
component("YDL140C",312).
component("YBR154C",249).
component("YPR175W",1000).
component("YPL167C",954).
component("YOR330C",925).
component("YOL115W",887).
component("YNL299W",851).
component("YNL262W",845).
component("YNL102W",830).
component("YJR043C",647).
component("YJR006W",641).
component("YJL090C",620).
component("YIL139C",597).
component("YEL055C",408).
component("YDR419W",387).
component("YDR121W",352).
component("YDL102W",308).
component("YCR014C",281).
component("YBR278W",266).
component("YBL035C",209).
component("YKL035W",673).
component("YHL012W",538).
component("YHR123W",561).
component("YPR113W",994).
component("YBR243C",258).
component("YDL142C",317).
component("YPL148C",952).
component("YER026C",417).
component("YGR286C",534).
component("YJL068C",615).
component("YHR189W",571).
component("YDR058C",344).
component("YNR034W",861).
component("YHR163W",567).
component("YGR248W",527).
component("YCR073W-A",289).
component("YDL086W",305).
component("YOL011W",869).
component("YMR008C",789).
component("YMR006C",788).
component("U105_",25).
component("YBL015W",206).
component("YJL068C",616).
component("YJR019C",645).
component("YOR040W",895).
component("U84_",182).
component("U77_",174).
component("YDR481C",391).
component("YLR377C",765).
component("YFR025C",458).
component("YPL179W",957).
component("YNR032W",859).
component("YML057W",780).
component("YML016C",774).
component("YLR433C",769).
component("YGR123C",509).
component("YER133W",443).
component("YER089C",438).
component("YDR436W",388).
component("YDR075W",347).
component("YDL188C",325).
component("YDL134C",311).
component("YDL047W",297).
component("YDL006W",290).
component("YBR125C",244).
component("YBL056W",212).
component("YPR073C",988).
component("YHR215W",576).
component("YDL024C",293).
component("YBR093C",238).
component("YBR092C",237).
component("YAR071W",202).
component("YIL053W",584).
component("YER062C",428).
component("YHR046C",550).
component("U9_",195).
component("YPL228W",965).
component("YMR180C",808).
component("YDL236W",329).
component("YJL155C",632).
component("YPR073C",989).
component("YOR208W",915).
component("YNL053W",827).
component("YMR036C",793).
component("YIR026C",607).
component("YIL113W",593).
component("YFR028C",459).
component("YER075C",434).
component("YDL230W",328).
component("YBR276C",265).
component("U34_",136).
component("U33_",135).
component("U32_",134).
component("U31_",133).
...
component("U25_",127).
component("U24_",126).
component("YHR044C",549).
component("YHR043C",548).
component("YOL064C",881).
component("YOR360C",933).
component("YGL248W",492).
component("YKR031C",704).
component("YPL206C",960).
component("YGL027C",473).
component("YLR286C",749).
component("YJR153W",665).
component("YJL221C",640).
component("YJL216C",638).
component("YIL172C",605).
component("YGR292W",536).
component("YGR287C",535).
component("YBR299W",270).
component("YBR184W",252).
component("YIL162W",602).
component("YPR026W",981).
component("YDR001C",331).
component("YBR001C",215).
component("YIR019C",606).
component("YIL099W",590).
component("YDL037C",295).
component("YOR190W",911).
component("YLR300W",751).
component("YGR282C",533).
component("YDR261C",369).
component("YDR400W",382).
component("U23_",125).
component("YML035C",776).
component("YJL070C",617).
component("YBR284W",267).
component("U106_",26).
component("U102_",22).
component("YER043C",419).
component("YNL045W",825).
component("YGL037C",474).
component("YDR242W",367).
component("YLR308W",757).
component("YLR307W",756).
component("YBR208C",254).
component("YMR281W",818).
component("U53_",152).
component("YIR032C",608).
component("YPR062W",986).
component("YMR120C",803).
component("YLR028C",722).
component("YHR144C",565).
component("YHR144C",566).
component("YGR267C",532).
component("YCL030C",274).
component("YBL033C",208).
component("YBR153W",248).
component("YNL141W",833).
component("YLR245C",746).
component("YML035C",777).
component("YGR204W",522).
component("YBR084W",234).
component("YJL126W",624).
component("U44_",144).
component("YDL100C",307).
component("U87_",184).
component("U40_",142).
component("U39_",140).
component("YBR011C",219).
component("YHR201C",573).
component("YBR111C",239).
component("YBR252W",262).
component("YPR080W",991).
component("YOR187W",910).
component("YOR133W",903).
component("YLR069C",728).
component("YKR084C",710).
component("YKL173W",687).
component("YJL102W",622).
component("YDR385W",381).
component("YBR118W",242).
component("YER005W",413).
component("YLL001W",713).
component("YIL048W",583).
component("YER166W",444).
component("YDR093W",349).
component("YAL026C",197).
component("YBL099W",214).
component("U60_",157).
component("YLR231C",743).
component("U88_",185).
component("YDR538W",399).
component("YLR134W",732).
component("YLR044C",724).
component("YGR087C",505).
component("YDR380W",380).
component("YDL080C",302).
component("U98_",193).
component("YMR250W",815).
component("YKL184W",692).
component("YOR128C",901).
component("YEL021W",403).
component("YNR043W",863).
component("U93_",190).
component("YDR047W",341).
component("U54_",153).
component("YKL211C",698) :- not remove_orf("YKL211C",698).
component("YKR097W",712).
component("YOL052C",874).
component("YNL169C",836).
component("YGR170W",514).
component("YKL060C",675).
component("YNL256W",844).
component("YDR294C",371).
component("YEL046C",406).
component("YNR033W",860).
component("YPR006C",979).
component("YER065C",429).
component("YKL211C",699) :- not remove_orf("YKL211C",699).
component("YER090W",699) :- not remove_orf("YER090W",699).
component("YER090W",439) :- not remove_orf("YER090W",439).
component("YDR127W",356).
component("YPL281C",977).
component("YOR393W",939).
component("YMR323W",821).
component("YHR174W",568).
component("YGR254W",528).
component("YOR202W",913).
component("YPL262W",971).
component("YGL026C",472) :- not remove_orf("YGL026C",472).
component("YGR155W",512).
component("YLR304C",754).
component("YJL200C",636).
component("YGL009C",467).
component("YNL316C",852).
component("YKL182W",690).
component("YPL212C",961).
component("YNL292W",850).
component("YGL063W",478).
component("YFL001W",448).
component("YPR002W",978).
component("YJR016C",644).
component("YCR053W",288).
component("YDR127W",357).
component("YGL148W",483).
component("YIL168W",604).
component("YIL167W",603).
component("YCL064C",278).
component("YER086W",436).
component("YLR359W",764).
component("YAL012W",196).
component("YML004C",772).
component("YFR055W",463).
component("YJL005W",611).
component("YJL121C",623).
component("YBR019C",222).
component("YBR019C",223).
component("YDR050C",342).
component("YIL020C",579).
component("YDR007W",332) :- not remove_orf("YDR007W",332).
component("YOR095C",899).
component("YER003C",412).
component("YBR196C",253).
component("YGL001C",465).
component("YPL117C",950).
component("U14_",60).
component("YOL056W",877).
component("YKL152C",685).
component("YDL021W",291).
component("YMR105C",799).
component("YKL127W",680).
component("YEL058W",409).
component("YPR060C",985).
component("YHR072W",555).
component("YJL153C",631).
component("YPL097W",948).
component("YGR185C",517).
component("YGR264C",531).
component("YGR171C",515).
component("YHR011W",543).
component("YDR023W",335).
component("YPL104W",949).
component("YLL018C",714).
component("YPR081C",992).
component("YBR121C",243).
component("YHR020W",545).
component("YER087W",437).
component("YNL247W",840).
component("YOL033W",872).
component("YOR168W",907).
component("YOL097C",885).
component("YDR268W",370).
component("YPR047W",984).
component("YLR060W",727).
component("YFL022C",451).
component("YPR033C",982).
component("YCR024C",282).
component("YHR019C",544).
component("YKL194C",695).
component("YIL078W",587).
component("YPL160W",953).
component("YLR382C",766).
component("YNL073W",829).
component("YDR037W",337).
component("YOR335C",926).
component("YGR094W",507).
component("YLR153C",736).
component("YAL054C",199).
component("YOR317W",923).
component("YMR246W",814).
component("YIL009W",578).
component("YER015W",415).
component("YOR142W",904).
component("YGR244C",526).
component("YPR035W",983).
component("YIL145C",598).
component("U89_",186).
component("YOR339C",927).
component("YMR022W",792).
component("YLR306W",755).
component("YKL210W",697).
component("YGR133W",511).
component("YGL058W",476).
component("YER100W",442).
component("YEL012W",401).
component("YDR177W",362).
component("YDR092W",348).
component("YDR059C",345).
component("YDR054C",343).
component("YDL064W",299).
component("YBR082C",232).
component("YJL101C",621).
component("YOL049W",873).
component("YAR015W",201).
component("YGL234W",490).
component("YER183C",447).
component("U91_",189).
component("U90_",188).
component("YNR057C",865).
component("YDL141W",313).
component("YDL141W",314).
component("YGL234W",491).
component("YDL141W",315).
component("YJR103W",657).
component("YBL039C",210).
component("YGR204W",523).
component("YBR084W",235).
component("YNL220W",838).
component("YOL058W",878).
component("YBR208C",255).
component("YDL141W",316).
component("YHR074W",556).
component("YMR217W",813).
component("YGR061C",503).
component("YPR145W",997).
component("YGR124W",510).
component("YJR109C",659).
component("YJL130C",627).
component("YGL062W",477).
component("YBR218C",256).
component("YPL231W",969).
component("YNR016C",857).
component("YKL182W",691).
component("YGR037C",499).
component("YJL087C",618).
component("YPR138C",996).
component("YPL265W",972).
component("YPL134C",951).
component("YPL057C",945).
component("YPL036W",944).
component("YOR348C",931).
component("YOR222W",919).
component("YOR192C",912).
component("YOR171C",908).
component("YOR130C",902).
component("YOR071C",897).
component("YOR011W",894).
component("YOL156W",893).
component("YOL103W",886).
component("YOL020W",871) :- not remove_orf("YOL020W",871).
component("YNR072W",867).
component("YNR056C",864).
component("YNL318C",853).
component("YNL270C",846).
component("YNL142W",834).
component("YMR272C",817).
component("YMR202W",810).
component("YMR056C",794).
component("YMR011W",790).
component("YLR348C",761).
component("YLR260W",748).
component("YLR237W",744).
component("YLR138W",733).
component("YLR100C",731).
component("YLR081W",729).
component("YLL061W",718).
component("YLL043W",716).
component("YKR093W",711).
component("YKR053C",706).
component("YKR039W",705) :- not remove_orf("YKR039W",705).
component("YKL217W",701).
component("YKL120W",679).
component("YKL004W",668).
component("YJR158W",666).
component("YJR095W",656).
component("YJR077C",654).
component("YJL219W",639).
component("YJL214W",637).
component("YJL134W",628).
component("YJL129C",625).
component("YIL134W",596).
component("YHR096C",559).
component("YHR094C",558).
component("YHR092C",557).
component("YHL036W",540).
component("YGR121C",508).
component("YGR065C",504).
component("YGR055W",501).
component("YGL186C",485).
component("YGL077C",480).
component("YGL008C",466).
component("YFL055W",455).
component("YFL011W",449).
component("YER060W-A",425).
component("YER060W",424).
component("YER056C",423).
component("YER053C",421).
component("YEL069C",411).
component("YEL063C",410).
component("YEL017C-A",402).
component("YDR536W",398).
component("YDR508C",395).
component("YDR503C",394).
component("YDR497C",392).
component("YDR345C",377).
component("YDR343C",376).
component("YDR342C",375).
component("YDR297W",372).
component("YDR046C",340) :- not remove_orf("YDR046C",340).
component("YDL245C",330).
component("YDL210W",326).
component("YCR032W",285).
component("YCR028C",284).
component("YCR024C-A",283).
component("YCL025C",273).
component("YBR298C",269).
component("YBR291C",268).
component("YBR085W",236).
component("YBR069C",231) :- not remove_orf("YBR069C",231).
component("YBR068C",230) :- not remove_orf("YBR068C",230).
component("YBR036C",228).
component("YBR021W",224).
component("YBL042C",211).
component("YBL030C",207).
component("U85_",183).
component("U7_",177).
component("U79_",176).
component("U78_",175).
...
catalyst(2220,916).
catalyst(3870,422).
catalyst(3620,379) :- not remove_reaction(3620,379).
catalyst(2110,461).
catalyst(2190,461).
catalyst(5550,661).
catalyst(5301,124).
...
catalyst(1960,341).
catalyst(3460,153).
catalyst(3600,698) :- not remove_reaction(3600,698).
catalyst(8000,712).
catalyst(3941,874).
catalyst(3942,874).
catalyst(6890,836).
...
catalyst(8020,979).
catalyst(8020,429).
catalyst(1890,699) :- not remove_reaction(1890,699).
catalyst(3630,699) :- not remove_reaction(3630,699).
catalyst(1890,439) :- not remove_reaction(1890,439).
catalyst(3630,439) :- not remove_reaction(3630,439).
catalyst(3740,356).
catalyst(8231,977).
catalyst(8232,977).
catalyst(8231,939).
...
catalyst(8061,971).
catalyst(8062,971).
catalyst(3590,472) :- not remove_reaction(3590,472).
catalyst(10910,472) :- not remove_reaction(10910,472).
catalyst(4570,512).
catalyst(8181,754).
catalyst(8182,754).
catalyst(8181,636).
...
catalyst(8282,342).
catalyst(3840,579).
catalyst(3610,332) :- not remove_reaction(3610,332).
catalyst(7921,899).
catalyst(7922,899).
catalyst(7841,412).
catalyst(7842,412).
...
catalyst(1210,893).
catalyst(1160,886).
catalyst(801,871) :- not remove_reaction(801,871).
catalyst(802,871) :- not remove_reaction(802,871).
catalyst(811,871) :- not remove_reaction(811,871).
catalyst(812,871) :- not remove_reaction(812,871).
catalyst(831,871) :- not remove_reaction(831,871).
catalyst(832,871) :- not remove_reaction(832,871).
catalyst(901,871) :- not remove_reaction(901,871).
catalyst(902,871) :- not remove_reaction(902,871).
catalyst(1180,867).
catalyst(1210,867).
catalyst(700,864).
catalyst(1200,853).
...
catalyst(650,711).
catalyst(6560,706).
catalyst(681,705) :- not remove_reaction(681,705).
catalyst(682,705) :- not remove_reaction(682,705).
catalyst(771,705) :- not remove_reaction(771,705).
catalyst(772,705) :- not remove_reaction(772,705).
catalyst(781,705) :- not remove_reaction(781,705).
catalyst(782,705) :- not remove_reaction(782,705).
catalyst(791,705) :- not remove_reaction(791,705).
catalyst(792,705) :- not remove_reaction(792,705).
catalyst(801,705) :- not remove_reaction(801,705).
catalyst(802,705) :- not remove_reaction(802,705).
catalyst(811,705) :- not remove_reaction(811,705).
catalyst(812,705) :- not remove_reaction(812,705).
catalyst(831,705) :- not remove_reaction(831,705).
catalyst(832,705) :- not remove_reaction(832,705).
catalyst(841,705) :- not remove_reaction(841,705).
catalyst(842,705) :- not remove_reaction(842,705).
catalyst(851,705) :- not remove_reaction(851,705).
catalyst(852,705) :- not remove_reaction(852,705).
catalyst(881,705) :- not remove_reaction(881,705).
catalyst(882,705) :- not remove_reaction(882,705).
catalyst(901,705) :- not remove_reaction(901,705).
catalyst(902,705) :- not remove_reaction(902,705).
catalyst(911,705) :- not remove_reaction(911,705).
catalyst(912,705) :- not remove_reaction(912,705).
catalyst(921,705) :- not remove_reaction(921,705).
catalyst(922,705) :- not remove_reaction(922,705).
catalyst(931,705) :- not remove_reaction(931,705).
catalyst(932,705) :- not remove_reaction(932,705).
catalyst(1191,705) :- not remove_reaction(1191,705).
catalyst(1192,705) :- not remove_reaction(1192,705).
catalyst(390,701).
catalyst(1521,679).
catalyst(1522,679).
catalyst(6610,668).
...
catalyst(1210,375).
catalyst(6650,372).
catalyst(791,340) :- not remove_reaction(791,340).
catalyst(792,340) :- not remove_reaction(792,340).
catalyst(801,340) :- not remove_reaction(801,340).
catalyst(802,340) :- not remove_reaction(802,340).
catalyst(811,340) :- not remove_reaction(811,340).
catalyst(812,340) :- not remove_reaction(812,340).
catalyst(831,340) :- not remove_reaction(831,340).
catalyst(832,340) :- not remove_reaction(832,340).
catalyst(841,340) :- not remove_reaction(841,340).
catalyst(842,340) :- not remove_reaction(842,340).
catalyst(851,340) :- not remove_reaction(851,340).
catalyst(852,340) :- not remove_reaction(852,340).
catalyst(901,340) :- not remove_reaction(901,340).
catalyst(902,340) :- not remove_reaction(902,340).
catalyst(1180,330).
catalyst(1210,330).
catalyst(690,326).
catalyst(730,326).
...
catalyst(1512,268).
catalyst(1590,236).
catalyst(771,231) :- not remove_reaction(771,231).
catalyst(772,231) :- not remove_reaction(772,231).
catalyst(791,231) :- not remove_reaction(791,231).
catalyst(792,231) :- not remove_reaction(792,231).
catalyst(801,231) :- not remove_reaction(801,231).
catalyst(802,231) :- not remove_reaction(802,231).
catalyst(811,231) :- not remove_reaction(811,231).
catalyst(812,231) :- not remove_reaction(812,231).
catalyst(851,231) :- not remove_reaction(851,231).
catalyst(852,231) :- not remove_reaction(852,231).
catalyst(901,231) :- not remove_reaction(901,231).
catalyst(902,231) :- not remove_reaction(902,231).
...
catalyst(831,230) :- not remove_reaction(831,230).
catalyst(832,230) :- not remove_reaction(832,230).
catalyst(841,230) :- not remove_reaction(841,230).
catalyst(842,230) :- not remove_reaction(842,230).
catalyst(851,230) :- not remove_reaction(851,230).
catalyst(852,230) :- not remove_reaction(852,230).
...
modifiable_enzyme(379).
modifiable_enzyme(698).
modifiable_enzyme(699).
modifiable_enzyme(439).
modifiable_enzyme(472).
modifiable_enzyme(332).
modifiable_enzyme(871).
modifiable_enzyme(705).
modifiable_enzyme(340).
