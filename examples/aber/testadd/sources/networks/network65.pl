...
component("YLR056W",355).
component("YKR009C",341).
component("YOL086C",431).
component("YMR303C",393).
component("YGL256W",248).
component("YDL168W",160).
component("YBR145W",124).
component("YPL231W",472).
component("U46_",72).
component("YBR149W",125).
component("YGL001C",228).
component("YIL094C",291).
component("U45_",71).
component("YML056C",383).
component("YLR432W",380).
component("YHR216W",286).
component("YAR075W",103).
component("YAR073W",102).
component("YDR127W",172).
component("YOL126C",435).
component("YKL085W",331).
component("YDL078C",153).
component("YNL037C",398).
component("YNL009W",396).
component("YLR174W",363).
component("YCL018W",138).
component("YLR355C",377).
component("YDL174C",162).
component("YML086C",384).
component("YGR088W",255).
component("YDR256C",182).
component("YJR078W",323).
component("YJR025C",316).
component("U107_",23).
component("YJR104C",325).
component("YHR008C",271).
component("YJL026W",302).
component("YIL066C",289).
component("YGR180C",258).
component("YER070W",212).
component("U36_",66).
component("YDL168W",161).
component("YBR006W",111).
component("YPL276W",480).
component("YPL275W",479).
component("YOR388C",458).
component("U55_",78).
component("YER069W",211).
component("YOR323C",451).
component("YER178W",217).
component("YBR221C",130).
component("YIL125W",294).
component("U52_",76).
component("YBR166C",127).
component("YGL012W",231).
component("YKL216W",340).
component("YKR009C",342).
component("YIL160C",297).
component("YGL205W",245).
component("U99_",97).
component("U100_",20).
component("YKR080W",347).
component("YER023W",205).
component("YGR204W",260).
component("YLR142W",360).
component("U65_",82).
component("U62_",81).
component("YHR068W",277).
component("YKL150W",334).
component("YIL043C",288).
component("YPL171C",468).
component("YHR179W",284).
component("YGR234W",262).
component("YPL017C",460).
component("YFL018C",219).
component("YDR353W",186).
component("YPR167C",492).
component("YNL052W",399).
component("YMR256C",392).
component("YLR395C",379).
component("YLR038C",353).
component("YIL111W",292).
component("YHR051W",276).
component("YGL191W",243).
component("YGL187C",242).
component("YDL067C",152).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",478).
component("YKR069W",346).
component("U47_",73).
component("YJR073C",321).
component("YDL033C",151).
component("YLR172C",362).
component("YLR058C",356).
component("YDR019C",167).
component("YBR176W",128).
component("YDR408C",191).
component("YMR120C",389).
component("YLR028C",351).
component("YBL013W",104).
component("YJL130C",308).
component("YKL024C",329).
component("YPR074C",488).
component("YBR117C",123).
component("YCL009C",137).
component("YNL071W",401).
component("YIL160C",298).
component("U48_",74).
component("YPL231W",473).
component("YPL231W",474).
component("YPL028W",461).
component("YLR299W",371).
component("YGL017W",232).
component("YML126C",385).
component("YNL104C",403).
component("YDL182W",163).
component("YDL131W",157).
component("YLR258W",368).
component("YFR015C",224).
component("YNL029C",397).
component("YIL085C",290).
component("YMR306W",394).
component("YLR342W",376).
component("YGR032W",250).
component("YLR209C",364).
component("U104_",21).
component("YDR354W",187) :- not remove_orf("YDR354W",187).
component("YFR047C",226).
component("YLR209C",365).
component("YML022W",381).
component("YDR441C",193).
component("YJL167W",312).
component("YDR127W",173).
component("YHR068W",278).
component("YLR303W",373).
component("YGR012W",249).
component("YJR130C",326).
component("YDR035W",168).
component("YBR249C",131).
component("YOR274W",450).
component("YHR137W",280).
component("YGL202W",244).
component("YLR027C",350).
component("YKL106W",332).
component("YOL140W",436).
component("YLR089C",357).
component("U61_",80).
component("YJR148W",327).
component("YFL030W",220).
component("YNR058W",422).
component("YGL253W",247).
component("YFR053C",227).
component("YMR205C",391).
component("YGR240C",263).
component("YOL016C",425).
component("YFR014C",223).
component("YCR036W",147).
component("YCL040W",140).
component("YPL188W",469).
component("YJR049C",318).
component("YEL041W",200).
component("U96_",95).
component("YDR236C",180).
component("YHL032C",269).
component("U83_",92).
component("YOR347C",456).
component("YAL038W",100).
component("YNR012W",418).
...
component("YKL067W",330).
component("YOL055C",428).
component("YDR454C",194).
component("YJR057W",319).
component("YOL061W",430).
component("YKL181W",336).
component("YHL011C",268).
component("YER099C",215).
component("YBL068W",109).
component("YOR143C",441).
component("YNL256W",411).
component("YBR018C",113).
component("YLR328W",375).
component("U94_",94).
component("YBR029C",115).
component("YGL130W",239).
component("YPR190C",495).
component("YPR187W",494).
component("YPR110C",489).
component("YPR010C",483).
component("YOR341W",455).
component("YOR340C",454).
component("YOR224C",449).
component("YOR210W",448).
component("YOR207C",446).
component("YOR151C",442).
component("YOR116C",439).
component("YOL005C",423).
component("YNR003C",417).
component("YNL248C",410).
component("YNL151C",407).
component("YNL113W",404).
component("YKL144C",333).
component("YJR063W",320).
component("YJL148W",311).
component("YJL140W",310).
component("YIL021W",287).
component("YHR143W-A",281).
component("YGL070C",237).
component("YFL036W",221).
...
component("YPR175W",493).
component("YPL167C",467).
component("YOR330C",452).
component("YOL115W",434).
component("YNL299W",415).
component("YNL262W",412).
component("YNL102W",402).
component("YJR043C",317).
component("YJR006W",314).
component("YJL090C",304).
component("YIL139C",295).
...
component("YPR113W",490).
component("YPL148C",466).
component("YGR286C",267).
component("YOL011W",424).
component("YMR008C",387).
component("YMR006C",386).
component("U105_",22).
component("YBL015W",105).
component("U77_",91).
component("YLR377C",378).
component("YPR073C",486).
component("YHR215W",285).
component("YDL024C",150).
component("YBR093C",121).
component("YBR092C",120).
component("YHR046C",275).
component("U9_",98).
component("YDL236W",165).
component("YPR073C",487).
component("YOR208W",447).
component("YNL053W",400).
component("YMR036C",388).
component("YIR026C",301).
component("YIL113W",293).
component("YFR028C",225).
...
component("U26_",61).
component("U24_",60).
component("YHR044C",274).
component("YHR043C",273).
component("YOR360C",457).
component("YKR031C",343).
component("YPL206C",470).
component("YGL027C",234).
component("YLR286C",370).
component("YJR153W",328).
component("YOR190W",445).
component("YLR300W",372).
component("YGR282C",266).
component("YDR261C",183).
component("YDR400W",189).
component("YML035C",382).
component("YJL070C",303).
component("YBR284W",135).
component("YER043C",206).
component("YDR242W",181).
component("U53_",77).
component("YPR062W",485).
component("YMR120C",390).
component("YLR028C",352).
component("YHR144C",282).
component("YBL033C",106).
component("YNL141W",405).
component("YLR245C",367).
component("YBR084W",118).
component("YJL126W",306).
...
component("YLR231C",366).
component("YLR134W",359).
component("YLR044C",354).
component("YGR087C",254).
component("YDR380W",188).
component("YDL080C",154).
component("U98_",96).
component("YOR128C",440).
component("YKL211C",338) :- not remove_orf("YKL211C",338).
component("YKR097W",348).
component("YNL169C",408).
component("YEL046C",201).
component("YNR033W",420).
component("YKL211C",339) :- not remove_orf("YKL211C",339).
component("YER090W",339) :- not remove_orf("YER090W",339).
component("YER090W",214) :- not remove_orf("YER090W",214).
component("YDR127W",175).
component("YPL281C",481).
component("YOR393W",459).
component("YMR323W",395).
component("YHR174W",283).
component("YGR254W",264).
component("YPL262W",476).
component("YGL026C",233) :- not remove_orf("YGL026C",233).
component("YLR304C",374).
component("YJL200C",313).
component("YNL316C",416).
component("YPL212C",471).
component("YNL292W",414).
component("YGL063W",236).
component("YFL001W",218).
component("YPR002W",482).
component("YJR016C",315).
component("YCR053W",148).
component("YDR127W",176).
component("YGL148W",240).
component("YIL168W",300).
component("YIL167W",299).
component("YCL064C",141).
component("YAL012W",99).
component("YBR019C",114).
component("YDR007W",166) :- not remove_orf("YDR007W",166).
component("YOR095C",438).
component("YGL001C",229).
component("YPL117C",465).
component("U14_",32).
component("YOL056W",429).
component("YKL152C",335).
component("YDL021W",149).
component("YPR060C",484).
component("YPL097W",463).
component("YGR185C",259).
component("YGR264C",265).
component("YGR171C",257).
component("YPL104W",464).
component("YLL018C",349).
component("YNL247W",409).
component("YOR168W",443).
component("YOL097C",432).
component("YDR268W",184).
component("YCR024C",144).
component("YHR019C",272).
component("YOR335C",453).
component("YLR153C",361).
component("YAL054C",101).
component("YIL145C",296).
component("YJL101C",305).
component("YOL049W",427).
component("U90_",93).
component("YNR057C",421).
component("YGL234W",246).
component("YJR103W",324).
component("YBL039C",108).
component("YGR204W",261).
component("YBR084W",119).
component("YHR074W",279).
component("YGL062W",235).
component("YBR218C",129).
component("YPL231W",475).
component("YNR016C",419).
component("YKL182W",337).
component("YGR037C",251).
component("YPR138C",491).
component("YPL265W",477).
component("YPL036W",462).
component("YOR171C",444).
component("YOR011W",437).
component("YOL103W",433).
component("YOL020W",426) :- not remove_orf("YOL020W",426).
component("YNL270C",413).
component("YNL142W",406).
component("YLR260W",369).
component("YLR100C",358).
component("YKR053C",345).
component("YKR039W",344) :- not remove_orf("YKR039W",344).
component("YJR077C",322).
component("YJL134W",309).
component("YJL129C",307).
component("YHL036W",270).
component("YGR121C",256).
component("YGR065C",253).
component("YGR055W",252).
component("YGL186C",241).
component("YGL077C",238).
component("YGL008C",230).
component("YFL055W",222).
...
catalyst(6111,440).
catalyst(6112,440).
catalyst(3600,338) :- not remove_reaction(3600,338).
catalyst(8000,348).
catalyst(6890,408).
catalyst(4560,201).
catalyst(2550,420).
...
catalyst(8051,476).
catalyst(8052,476).
catalyst(3590,233) :- not remove_reaction(3590,233).
catalyst(10910,233) :- not remove_reaction(10910,233).
catalyst(8181,374).
catalyst(8182,374).
catalyst(8181,313).
catalyst(8182,313).
...
catalyst(901,426) :- not remove_reaction(901,426).
catalyst(902,426) :- not remove_reaction(902,426).
catalyst(931,413).
catalyst(932,413).
catalyst(371,406).
catalyst(372,406).
...
catalyst(6330,358).
catalyst(6560,345).
catalyst(771,344) :- not remove_reaction(771,344).
catalyst(772,344) :- not remove_reaction(772,344).
catalyst(781,344) :- not remove_reaction(781,344).
catalyst(782,344) :- not remove_reaction(782,344).
...
catalyst(881,344) :- not remove_reaction(881,344).
catalyst(882,344) :- not remove_reaction(882,344).
catalyst(901,344) :- not remove_reaction(901,344).
catalyst(902,344) :- not remove_reaction(902,344).
catalyst(931,344) :- not remove_reaction(931,344).
catalyst(932,344) :- not remove_reaction(932,344).
catalyst(1191,344) :- not remove_reaction(1191,344).
catalyst(1192,344) :- not remove_reaction(1192,344).
catalyst(1581,322).
catalyst(1582,322).
catalyst(6560,309).
catalyst(361,307).
