...
component("YLR056W",613).
component("YGR060W",424).
component("YGL012W",395).
component("YKR009C",594).
component("YOL086C",741).
component("YMR303C",687).
component("YMR083W",672).
component("YGL256W",417).
component("YDL168W",269).
component("YBR145W",202).
component("YPL231W",805).
component("YBR265W",220).
component("U46_",119).
component("YBR149W",203).
component("YBR149W",204).
component("YGL001C",392).
component("YIL094C",499).
component("U45_",118).
component("YML056C",659).
component("YLR432W",649).
component("YHR216W",490).
component("YAR075W",174).
component("YAR073W",173).
component("YDR127W",296).
component("YJR139C",564).
component("YML075C",661).
component("YLR450W",652).
component("YOL126C",747).
component("YKL085W",574).
component("YDL078C",252).
component("YNL037C",692).
component("YNL009W",690).
component("YLR174W",626).
component("YHR183W",483).
component("YGR256W",446).
component("YNL241C",706).
component("YOL059W",738).
component("YDL022W",245).
component("YCL018W",228).
component("YLR355C",644).
component("YIL074C",496).
component("YER081W",366).
component("YDL174C",273).
component("YML086C",663).
component("YIL155C",508).
component("YEL024W",342).
component("YKR066C",599).
component("YGR088W",428).
component("YDR256C",310).
component("YKL026C",570).
component("YIR037W",518).
component("YBR244W",215).
component("YJR078W",557).
component("U58_",128).
component("YJR025C",549).
component("U107_",24).
component("YGR255C",445).
component("U108_",25).
component("YHR007C",457).
component("YDR402C",324).
component("YGL055W",402).
component("YJR104C",559).
component("YHR008C",458).
component("YOR384W",784).
component("YOR381W",783).
component("YOL152W",749).
component("YLL051C",606).
component("YJL026W",520).
component("YIL066C",495).
component("YGR180C",435).
component("YER070W",363).
component("U37_",112).
component("U36_",111).
component("U35_",110).
component("YDL168W",270).
component("YDR158W",304).
component("YJR009C",546).
component("YJL052W",522).
component("YGR192C",437).
component("YBR006W",184).
component("YPL276W",813).
component("YPL275W",812).
component("YOR388C",785).
component("YPL061W",790).
component("YOR374W",781).
component("YER073W",364).
component("YGL154C",409).
...
component("YIL125W",504).
component("U52_",124).
component("YBR166C",207).
component("YNL280C",714).
component("YGL012W",396).
component("YKL182W",584).
component("YKL216W",593).
component("YDR044W",286).
component("YKR009C",595).
component("YIL160C",509).
component("YGL205W",414).
component("YMR118C",675).
component("YLR164W",624).
component("YLL041C",605).
component("YKL148C",579).
component("YKL141W",577).
component("YJL045W",521).
component("YDR178W",305).
component("YEL047C",345).
component("YDL171C",271).
component("YDL171C",272).
...
component("YKR080W",601).
component("YER023W",352).
component("YOR236W",771).
component("YGR204W",439).
component("YIR034C",517).
component("YLR142W",621).
component("U65_",135).
component("U63_",133).
component("U62_",132).
component("YHR068W",468).
component("YKL150W",580).
component("YIL043C",493).
component("YHR042W",463).
component("YOR221C",768).
component("YMR145C",678).
component("YKL192C",587).
component("YKL055C",572).
component("YER061C",359).
component("YDL085W",254).
component("YPL171C",798).
component("YHR179W",482).
component("YMR145C",679).
component("YML120C",664).
component("YKL192C",588).
component("YDL085W",255).
component("YGR234W",441).
component("YFR030W",388).
component("YPL017C",787).
component("YFL018C",380).
component("YDR353W",320).
component("YPR167C",828).
component("YJR137C",563).
component("YNL052W",694).
component("YMR256C",685).
component("YLR395C",648).
component("YLR038C",611).
component("YIL111W",501).
component("YHR051W",467).
component("YGL191W",412).
component("YGL187C",411).
component("YDL067C",251).
component("Q0275",19).
component("Q0250",18).
component("YDR072C",291).
component("YPL266W",811).
component("YKR069W",600).
component("YOL096C",742).
component("U47_",120).
component("YER091C",371).
component("YJR073C",555).
component("YGR157W",433).
component("YDR120C",294).
component("YML008C",654).
component("YOR074C",754).
component("YDL033C",247).
component("YOL096C",743).
component("YLR172C",625).
component("YLR058C",614).
component("YDR019C",283).
component("YBR176W",208).
component("YDR408C",326).
component("YMR120C",676).
component("YLR028C",609).
component("YBL013W",175).
component("YJL130C",531).
component("YJL088W",525).
component("YKL024C",569).
component("YPR074C",823).
component("YBR117C",199).
component("YMR108W",674).
component("YCL009C",227).
component("YNL071W",696).
component("YNR008W",719).
component("YIL160C",510).
component("YNR019W",722).
component("YCR048W",241).
component("U48_",121).
component("YMR062C",671).
component("YDR232W",307).
component("YPL231W",806).
component("YER061C",360).
component("YDL052C",250).
component("U8_",158).
component("YDR148C",302).
component("YPL231W",807).
component("YPL028W",788).
component("YLR299W",636).
component("YGL017W",397).
component("YCR005C",233).
component("YML126C",665).
component("YNL104C",699).
component("YDL182W",274).
component("YDL131W",260).
component("YDR307W",316).
component("YLR258W",633).
component("YFR015C",386).
component("YNL029C",691).
component("YIL085C",498).
component("YMR306W",688).
component("YLR342W",642).
component("YGR032W",421).
component("YPR183W",830).
component("YBR248C",216).
component("YLR209C",628).
component("U104_",21).
component("YDR354W",321) :- not remove_orf("YDR354W",321).
component("YFR047C",389).
component("YJR133W",562).
component("YLR209C",629).
component("YML022W",656).
component("YDR441C",329).
component("YHR128W",477).
component("YJL167W",538).
component("YJL167W",539).
component("YPR069C",820).
component("YDR127W",297).
component("YHR190W",485).
component("YLR146C",622).
component("YHR068W",469).
component("YLR303W",638).
component("YGR012W",419).
component("YML082W",662).
component("YJR130C",561).
component("YDR035W",285).
component("YBR249C",217).
component("YLR180W",627).
component("YDR502C",333).
component("YOR274W",772).
component("YBR256C",219).
component("YHR137W",478).
component("YGL202W",413).
component("YLR027C",608).
component("YKL106W",575).
component("YOL140W",748).
component("YLR438W",651).
component("YGR019W",420).
component("YLR089C",617).
component("U64_",134).
component("U61_",131).
component("U51_",123).
component("YJR148W",565).
component("YHR208W",488).
component("YFL030W",382).
component("YOR184W",763).
component("YNR058W",728).
component("YIL116W",503).
component("YGL253W",416).
component("YFR053C",390).
component("YMR013C",669).
component("YMR205C",681).
component("YGR240C",442).
component("YOL016C",732).
component("YFR014C",385).
component("YLR240W",631).
component("YKL203C",590).
component("YJR066W",554).
component("YCR036W",240).
component("YCL040W",230).
component("U15_",56).
component("YPL188W",800).
component("YJR049C",551).
component("YEL041W",343).
component("U96_",162).
component("YKL001C",568).
component("YDR236C",308).
component("YHL032C",455).
component("YDR531W",337).
component("U83_",153).
component("U82_",152).
component("U81_",151).
component("YMR208W",682).
component("YPL203W",801).
component("YOR061W",753).
component("YKL166C",582).
component("YJL164C",537).
component("YIL035C",492).
component("YHR205W",487).
component("YHR102W",475).
component("YGL019W",398).
component("YHR025W",462).
component("YOR347C",778).
component("YAL038W",168).
component("YNR012W",720).
component("YDR009W",282).
component("YDR127W",298).
component("YDR147W",301).
component("YDR300C",315).
component("YCR012W",234).
component("YER069W",362).
component("U19_",85).
component("U18_",77).
component("U17_",69).
component("U76_",145).
component("YER170W",375).
component("YDR226W",306).
component("YKL067W",573).
component("YOL055C",735).
component("YDR454C",330).
component("YJR057W",552).
component("YOL061W",739).
component("YKL181W",583).
component("YHL011C",453).
component("YER099C",372).
component("YBL068W",182).
component("YOR143C",759).
component("YNL256W",709).
component("YLR328W",640).
component("YBR018C",186).
component("YGR007W",418).
component("YGR202C",438).
component("YLR328W",641).
component("U80_",150).
component("YDL103C",259).
component("U94_",161).
component("YJR010W",547).
component("YBR029C",189).
component("YCL050C",231).
component("YGL130W",407).
component("YDR530C",336).
component("YPR190C",832).
component("YPR187W",831).
component("YPR110C",825).
component("YPR010C",816).
component("YOR341W",777).
component("YOR340C",776).
component("YOR224C",770).
component("YOR210W",767).
component("YOR207C",765).
component("YOR151C",760).
component("YOR116C",756).
component("YOL005C",730).
component("YNR003C",718).
component("YNL248C",708).
component("YNL151C",703).
component("YNL113W",700).
component("YKL144C",578).
component("YJR063W",553).
component("YJL148W",535).
component("YJL140W",534).
component("YIL021W",491).
component("YHR143W-A",479).
component("YGL070C",405).
component("YFL036W",383).
component("YDR404C",325).
component("YDR156W",303).
component("YDR045C",287).
component("YDL150W",268).
component("YDL140C",262).
component("YBR154C",206).
component("YPR175W",829).
component("YPL167C",797).
component("YOR330C",774).
component("YOL115W",746).
component("YNL299W",716).
component("YNL262W",711).
component("YNL102W",698).
component("YJR043C",550).
component("YJR006W",545).
component("YJL090C",526).
component("YIL139C",506).
component("YEL055C",346).
component("YDR419W",327).
component("YDR121W",295).
component("YDL102W",258).
component("YCR014C",235).
component("YBR278W",222).
component("YBL035C",178).
component("YKL035W",571).
component("YHL012W",454).
component("YHR123W",476).
component("YPR113W",826).
component("YBR243C",214).
component("YDL142C",267).
component("YPL148C",795).
component("YER026C",353).
component("YGR286C",450).
component("YHR189W",484).
component("YDR058C",290).
component("YDL086W",256).
component("YOL011W",731).
component("YMR008C",667).
component("YMR006C",666).
component("U105_",22).
component("YBL015W",176).
component("YJL068C",523).
component("YOR040W",752).
component("U77_",146).
component("YDR481C",331).
component("YLR377C",646).
component("YPL179W",799).
component("YNR032W",723).
component("YML057W",660).
component("YML016C",655).
component("YLR433C",650).
component("YGR123C",431).
component("YER133W",373).
component("YER089C",369).
component("YDR436W",328).
component("YDR075W",292).
component("YDL188C",275).
component("YDL134C",261).
component("YDL047W",249).
component("YDL006W",243).
component("YBR125C",201).
component("YBL056W",181).
component("YPR073C",821).
component("YHR215W",489).
component("YDL024C",246).
component("YBR093C",196).
component("YBR092C",195).
component("YAR071W",172).
component("YHR046C",466).
component("U9_",165).
component("YPL228W",804).
component("YMR180C",680).
component("YDL236W",279).
component("YJL155C",536).
component("YPR073C",822).
component("YOR208W",766).
component("YNL053W",695).
component("YMR036C",670).
component("YIR026C",516).
component("YIL113W",502).
...
component("U25_",100).
component("U24_",99).
component("YHR044C",465).
component("YHR043C",464).
component("YOL064C",740).
component("YOR360C",780).
component("YKR031C",596).
component("YPL206C",802).
component("YGL027C",400).
component("YLR286C",635).
component("YJR153W",566).
component("YJL221C",544).
component("YJL216C",542).
component("YIL172C",514).
component("YGR292W",452).
component("YGR287C",451).
component("YBR299W",226).
component("YBR184W",209).
component("YIL162W",511).
component("YIR019C",515).
component("YIL099W",500).
component("YDL037C",248).
component("YOR190W",764).
component("YLR300W",637).
component("YGR282C",449).
component("YDR261C",311).
component("YDR400W",323).
component("YML035C",657).
component("YJL070C",524).
component("YBR284W",223).
component("U106_",23).
component("YER043C",354).
component("YNL045W",693).
component("YGL037C",401).
component("YDR242W",309).
component("YBR208C",211).
component("U53_",125).
component("YPR062W",819).
component("YMR120C",677).
component("YLR028C",610).
component("YHR144C",480).
component("YGR267C",448).
component("YBL033C",177).
component("YBR153W",205).
component("YNL141W",701).
component("YLR245C",632).
component("YML035C",658).
component("YBR084W",193).
component("YJL126W",529).
component("U44_",117).
...
component("YHR201C",486).
component("YBR111C",197).
component("YBR252W",218).
component("YER005W",351).
component("YIL048W",494).
component("YER166W",374).
component("YDR093W",293).
component("YAL026C",167).
component("YBL099W",183).
component("U60_",130).
component("YLR231C",630).
component("U88_",156).
component("YDR538W",339).
component("YLR134W",619).
component("YLR044C",612).
component("YGR087C",427).
component("YDR380W",322).
component("YDL080C",253).
component("U98_",163).
component("YMR250W",684).
component("YOR128C",757).
component("YEL021W",341).
component("YNR043W",725).
component("U93_",160).
component("U54_",126).
component("YKL211C",591) :- not remove_orf("YKL211C",591).
component("YKR097W",603).
component("YNL169C",704).
component("YNL256W",710).
component("YDR294C",313).
component("YEL046C",344).
component("YNR033W",724).
component("YKL211C",592) :- not remove_orf("YKL211C",592).
component("YER090W",592) :- not remove_orf("YER090W",592).
component("YER090W",370) :- not remove_orf("YER090W",370).
component("YDR127W",299).
component("YPL281C",814).
component("YOR393W",786).
component("YMR323W",689).
component("YHR174W",481).
component("YGR254W",444).
component("YPL262W",809).
component("YGL026C",399) :- not remove_orf("YGL026C",399).
component("YGR155W",432).
component("YLR304C",639).
component("YJL200C",540).
component("YNL316C",717).
component("YKL182W",585).
component("YPL212C",803).
component("YNL292W",715).
component("YGL063W",404).
component("YFL001W",378).
component("YPR002W",815).
component("YJR016C",548).
component("YCR053W",242).
component("YDR127W",300).
component("YGL148W",408).
component("YIL168W",513).
component("YIL167W",512).
component("YCL064C",232).
component("YER086W",367).
component("YLR359W",645).
component("YAL012W",166).
component("YML004C",653).
component("YFR055W",391).
component("YJL005W",519).
component("YJL121C",528).
component("YBR019C",187).
component("YDR050C",289).
component("YDR007W",281) :- not remove_orf("YDR007W",281).
component("YOR095C",755).
component("YER003C",350).
component("YBR196C",210).
component("YGL001C",393).
component("YPL117C",793).
component("U14_",48).
component("YOL056W",736).
component("YKL152C",581).
component("YDL021W",244).
component("YMR105C",673).
component("YKL127W",576).
component("YEL058W",347).
component("YPR060C",818).
component("YHR072W",470).
component("YPL097W",791).
component("YGR185C",436).
component("YGR264C",447).
component("YGR171C",434).
component("YHR011W",459).
component("YDR023W",284).
component("YPL104W",792).
component("YLL018C",604).
component("YPR081C",824).
component("YBR121C",200).
component("YHR020W",461).
component("YER087W",368).
component("YNL247W",707).
component("YOR168W",761).
component("YOL097C",744).
component("YDR268W",312).
component("YPR047W",817).
component("YLR060W",615).
component("YFL022C",381).
component("YCR024C",236).
component("YHR019C",460).
component("YKL194C",589).
component("YIL078W",497).
component("YPL160W",796).
component("YLR382C",647).
component("YNL073W",697).
component("YOR335C",775).
component("YGR094W",429).
component("YLR153C",623).
component("YAL054C",169).
component("YGR244C",443).
component("YIL145C",507).
component("U89_",157).
component("YJL101C",527).
component("YOL049W",734).
component("YAR015W",171).
component("YER183C",377).
component("U90_",159).
component("YNR057C",727).
component("YDL141W",263).
component("YDL141W",264).
component("YGL234W",415).
component("YDL141W",265).
component("YJR103W",558).
component("YBL039C",179).
component("YGR204W",440).
component("YBR084W",194).
component("YNL220W",705).
component("YOL058W",737).
component("YDL141W",266).
component("YHR074W",471).
component("YMR217W",683).
component("YGR061C",425).
component("YJR109C",560).
component("YJL130C",532).
component("YGL062W",403).
component("YBR218C",212).
component("YPL231W",808).
component("YNR016C",721).
component("YKL182W",586).
component("YGR037C",422).
component("YPR138C",827).
component("YPL265W",810).
component("YPL134C",794).
component("YPL036W",789).
component("YOR348C",779).
component("YOR222W",769).
component("YOR171C",762).
component("YOR130C",758).
component("YOR011W",751).
component("YOL156W",750).
component("YOL103W",745).
component("YOL020W",733) :- not remove_orf("YOL020W",733).
component("YNR072W",729).
component("YNR056C",726).
component("YNL270C",712).
component("YNL142W",702).
component("YMR272C",686).
component("YMR011W",668).
component("YLR348C",643).
component("YLR260W",634).
component("YLR138W",620).
component("YLR100C",618).
component("YLR081W",616).
component("YLL061W",607).
component("YKR093W",602).
component("YKR053C",598).
component("YKR039W",597) :- not remove_orf("YKR039W",597).
component("YJR158W",567).
component("YJR077C",556).
component("YJL219W",543).
component("YJL214W",541).
component("YJL134W",533).
component("YJL129C",530).
component("YIL134W",505).
component("YHR096C",474).
component("YHR094C",473).
component("YHR092C",472).
component("YHL036W",456).
component("YGR121C",430).
component("YGR065C",426).
component("YGR055W",423).
component("YGL186C",410).
component("YGL077C",406).
component("YGL008C",394).
component("YFL055W",384).
component("YFL011W",379).
component("YER060W-A",358).
component("YER060W",357).
component("YER056C",356).
component("YER053C",355).
component("YEL069C",349).
component("YEL063C",348).
component("YEL017C-A",340).
component("YDR536W",338).
component("YDR508C",335).
component("YDR503C",334).
component("YDR497C",332).
...
component("YDL245C",280).
component("YDL210W",276).
component("YCR032W",239).
component("YCR028C",238).
component("YCR024C-A",237).
...
catalyst(2300,160).
catalyst(3460,126).
catalyst(3600,591) :- not remove_reaction(3600,591).
catalyst(8000,603).
catalyst(6890,704).
catalyst(2570,710).
catalyst(8781,313).
...
catalyst(4560,344).
catalyst(2550,724).
catalyst(1890,592) :- not remove_reaction(1890,592).
catalyst(3630,592) :- not remove_reaction(3630,592).
...
catalyst(8061,809).
catalyst(8062,809).
catalyst(3590,399) :- not remove_reaction(3590,399).
catalyst(10910,399) :- not remove_reaction(10910,399).
catalyst(4570,432).
catalyst(8181,639).
catalyst(8182,639).
catalyst(8181,540).
...
catalyst(8281,289).
catalyst(8282,289).
catalyst(3610,281) :- not remove_reaction(3610,281).
catalyst(7921,755).
catalyst(7922,755).
catalyst(7841,350).
catalyst(7842,350).
...
catalyst(1210,750).
catalyst(1160,745).
catalyst(801,733) :- not remove_reaction(801,733).
catalyst(802,733) :- not remove_reaction(802,733).
catalyst(811,733) :- not remove_reaction(811,733).
catalyst(812,733) :- not remove_reaction(812,733).
catalyst(831,733) :- not remove_reaction(831,733).
catalyst(832,733) :- not remove_reaction(832,733).
catalyst(901,733) :- not remove_reaction(901,733).
catalyst(902,733) :- not remove_reaction(902,733).
catalyst(1180,729).
catalyst(1210,729).
catalyst(700,726).
catalyst(931,712).
...
catalyst(640,602).
catalyst(6560,598).
catalyst(771,597) :- not remove_reaction(771,597).
catalyst(772,597) :- not remove_reaction(772,597).
catalyst(781,597) :- not remove_reaction(781,597).
catalyst(782,597) :- not remove_reaction(782,597).
catalyst(801,597) :- not remove_reaction(801,597).
catalyst(802,597) :- not remove_reaction(802,597).
catalyst(811,597) :- not remove_reaction(811,597).
catalyst(812,597) :- not remove_reaction(812,597).
catalyst(831,597) :- not remove_reaction(831,597).
catalyst(832,597) :- not remove_reaction(832,597).
catalyst(841,597) :- not remove_reaction(841,597).
catalyst(842,597) :- not remove_reaction(842,597).
catalyst(851,597) :- not remove_reaction(851,597).
catalyst(852,597) :- not remove_reaction(852,597).
catalyst(881,597) :- not remove_reaction(881,597).
catalyst(882,597) :- not remove_reaction(882,597).
catalyst(901,597) :- not remove_reaction(901,597).
catalyst(902,597) :- not remove_reaction(902,597).
catalyst(911,597) :- not remove_reaction(911,597).
catalyst(912,597) :- not remove_reaction(912,597).
catalyst(921,597) :- not remove_reaction(921,597).
catalyst(922,597) :- not remove_reaction(922,597).
catalyst(931,597) :- not remove_reaction(931,597).
catalyst(932,597) :- not remove_reaction(932,597).
catalyst(1191,597) :- not remove_reaction(1191,597).
catalyst(1192,597) :- not remove_reaction(1192,597).
catalyst(1180,567).
catalyst(1210,567).
catalyst(1581,556).
catalyst(1582,556).
...
catalyst(851,288) :- not remove_reaction(851,288).
catalyst(852,288) :- not remove_reaction(852,288).
