...
component("YLR056W",423).
component("YGL012W",265).
component("YKR009C",407).
component("YOL086C",512).
component("YMR303C",471).
component("YGL256W",285).
component("YDL168W",181).
component("YBR145W",138).
component("YPL231W",562).
component("YBR265W",149).
component("U46_",80).
component("YBR149W",139).
component("YBR149W",140).
component("YGL001C",262).
component("YIL094C",341).
component("U45_",79).
component("YML056C",455).
component("YLR432W",452).
component("YHR216W",335).
component("YAR075W",116).
component("YAR073W",115).
component("YDR127W",195).
component("YOL126C",517).
component("YKL085W",394).
component("YDL078C",171).
component("YNL037C",476).
component("YNL009W",474).
component("YLR174W",433).
component("YCL018W",156).
component("YLR355C",448).
component("YDL174C",184).
component("YML086C",456).
component("YGR088W",293).
component("YDR256C",206).
component("YJR078W",383).
component("YJR025C",376).
component("U107_",24).
component("YJR104C",385).
component("YHR008C",312).
component("YOR384W",546).
component("YOR381W",545).
component("YOL152W",519).
component("YLL051C",417).
component("YJL026W",355).
component("YIL066C",339).
component("YGR180C",296).
component("YER070W",241).
component("U36_",73).
component("YDL168W",182).
component("YBR006W",124).
component("YPL276W",570).
component("YPL275W",569).
component("YOR388C",547).
component("YOR374W",544).
component("YER073W",242).
component("YGL154C",277).
component("U55_",86).
component("YER069W",240).
component("YOR323C",537).
component("YER178W",248).
component("YBR221C",146).
component("YIL125W",345).
component("U52_",84).
component("YBR166C",142).
component("YGL012W",266).
component("YKL216W",406).
component("YKR009C",408).
component("YIL160C",349).
component("YGL205W",282).
component("YMR118C",463).
component("YLR164W",431).
component("YLL041C",416).
component("YKL148C",397).
component("YJL045W",356).
component("YDR178W",202).
component("YDL171C",183).
component("U99_",110).
component("U100_",20).
component("YKR080W",413).
component("YER023W",234).
component("YOR236W",535).
component("YGR204W",298).
component("YLR142W",429).
component("U65_",92).
component("U63_",90).
component("U62_",89).
component("YHR068W",320).
component("YKL150W",398).
component("YIL043C",338).
component("YPL171C",557).
component("YHR179W",331).
component("YMR145C",466).
component("YML120C",457).
component("YKL192C",403).
component("YDL085W",173).
component("YGR234W",300).
component("YFR030W",259).
component("YPL017C",549).
component("YFL018C",252).
component("YDR353W",213).
component("YPR167C",582).
component("YJR137C",387).
component("YNL052W",477).
component("YMR256C",470).
component("YLR395C",451).
component("YLR038C",421).
component("YIL111W",342).
component("YHR051W",319).
component("YGL191W",280).
component("YGL187C",279).
component("YDL067C",170).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",568).
component("YKR069W",412).
component("YOL096C",513).
component("U47_",81).
component("YJR073C",381).
component("YDL033C",169).
component("YLR172C",432).
component("YLR058C",424).
component("YDR019C",190).
component("YBR176W",143).
component("YDR408C",218).
component("YMR120C",464).
component("YLR028C",419).
component("YBL013W",117).
component("YJL130C",363).
component("YKL024C",392).
component("YPR074C",578).
component("YBR117C",137).
component("YCL009C",155).
component("YNL071W",479).
component("YIL160C",350).
component("U48_",82).
component("YPL231W",563).
component("YPL231W",564).
component("YPL028W",550).
component("YLR299W",441).
component("YGL017W",267).
component("YML126C",458).
component("YNL104C",481).
component("YDL182W",185).
component("YDL131W",177).
component("YLR258W",438).
component("YFR015C",257).
component("YNL029C",475).
component("YIL085C",340).
component("YMR306W",472).
component("YLR342W",447).
component("YGR032W",288).
component("YLR209C",434).
component("U104_",21).
component("YDR354W",214) :- not remove_orf("YDR354W",214).
component("YFR047C",260).
component("YLR209C",435).
component("YML022W",453).
component("YDR441C",220).
component("YJL167W",368).
component("YDR127W",196).
component("YHR068W",321).
component("YLR303W",443).
component("YGR012W",286).
component("YJR130C",386).
component("YDR035W",191).
component("YBR249C",147).
component("YOR274W",536).
component("YHR137W",327).
component("YGL202W",281).
component("YLR027C",418).
component("YKL106W",395).
component("YOL140W",518).
component("YGR019W",287).
component("YLR089C",426).
component("U64_",91).
component("U61_",88).
component("YJR148W",388).
component("YFL030W",253).
component("YNR058W",502).
component("YIL116W",344).
component("YGL253W",284).
component("YFR053C",261).
component("YMR205C",467).
component("YGR240C",301).
component("YOL016C",506).
component("YFR014C",256).
component("YCR036W",165).
component("YCL040W",158).
component("U15_",41).
component("YPL188W",558).
component("YJR049C",378).
component("YEL041W",228).
component("U96_",108).
component("YKL001C",391).
component("YDR236C",204).
component("YHL032C",310).
component("U83_",104).
component("YMR208W",468).
component("YPL203W",559).
component("YOR061W",522).
component("YKL166C",400).
component("YJL164C",367).
component("YIL035C",337).
component("YHR205W",333).
component("YHR102W",326).
component("YGL019W",268).
component("YHR025W",315).
component("YOR347C",542).
component("YAL038W",113).
component("YNR012W",498).
component("YDR127W",197).
component("YDR147W",200).
component("YCR012W",160).
component("U76_",101).
component("YER170W",247).
component("YDR226W",203).
component("YKL067W",393).
component("YOL055C",509).
component("YDR454C",221).
component("YJR057W",379).
component("YOL061W",511).
component("YKL181W",401).
component("YHL011C",309).
component("YER099C",246).
component("YBL068W",122).
component("YOR143C",526).
component("YNL256W",490).
component("YLR328W",445).
component("YBR018C",126).
component("YLR328W",446).
component("U94_",107).
component("YBR029C",129).
component("YGL130W",275).
component("YDR530C",225).
component("YPR190C",585).
component("YPR187W",584).
component("YPR110C",579).
component("YPR010C",573).
component("YOR341W",541).
component("YOR340C",540).
component("YOR224C",534).
component("YOR210W",533).
component("YOR207C",531).
component("YOR151C",527).
component("YOR116C",524).
component("YOL005C",504).
component("YNR003C",497).
component("YNL248C",489).
component("YNL151C",485).
component("YNL113W",482).
component("YKL144C",396).
component("YJR063W",380).
component("YJL148W",366).
component("YJL140W",365).
component("YIL021W",336).
component("YHR143W-A",328).
component("YGL070C",273).
component("YFL036W",254).
...
component("YPR175W",583).
component("YPL167C",556).
component("YOR330C",538).
component("YOL115W",516).
component("YNL299W",495).
component("YNL262W",491).
component("YNL102W",480).
component("YJR043C",377).
component("YJR006W",374).
component("YJL090C",359).
component("YIL139C",347).
component("YEL055C",230).
component("YDR419W",219).
component("YDR121W",194).
component("YDL102W",176).
component("YCR014C",161).
component("YBR278W",151).
component("YBL035C",120).
component("YPR113W",580).
component("YPL148C",555).
component("YGR286C",306).
component("YHR189W",332).
component("YDL086W",174).
component("YOL011W",505).
component("YMR008C",460).
component("YMR006C",459).
component("U105_",22).
component("YBL015W",118).
component("YJL068C",357).
component("U77_",102).
component("YLR377C",450).
component("YPR073C",576).
component("YHR215W",334).
component("YDL024C",168).
component("YBR093C",135).
component("YBR092C",134).
component("YHR046C",318).
component("U9_",111).
component("YDL236W",187).
component("YPR073C",577).
component("YOR208W",532).
component("YNL053W",478).
component("YMR036C",462).
component("YIR026C",354).
component("YIL113W",343).
component("YFR028C",258).
component("YER075C",243).
component("YDL230W",186).
component("YBR276C",150).
component("U34_",72).
component("U31_",71).
component("U30_",70).
component("U29_",69).
...
component("U25_",67).
component("U24_",66).
component("YHR044C",317).
component("YHR043C",316).
component("YOR360C",543).
component("YKR031C",409).
component("YPL206C",560).
component("YGL027C",270).
component("YLR286C",440).
component("YJR153W",389).
component("YJL221C",373).
component("YJL216C",371).
component("YIL172C",353).
component("YGR292W",308).
component("YGR287C",307).
component("YBR299W",154).
component("YOR190W",530).
component("YLR300W",442).
component("YGR282C",305).
component("YDR261C",207).
component("YDR400W",216).
component("YML035C",454).
component("YJL070C",358).
component("YBR284W",152).
component("U106_",23).
component("YER043C",235).
component("YDR242W",205).
component("U53_",85).
component("YPR062W",575).
component("YMR120C",465).
component("YLR028C",420).
component("YHR144C",329).
component("YBL033C",119).
component("YNL141W",483).
component("YLR245C",437).
component("YBR084W",132).
component("YJL126W",361).
component("U44_",78).
component("YDL100C",175).
component("U40_",76).
component("U39_",74).
component("YBR011C",125).
component("YBR111C",136).
component("YBR252W",148).
component("YER005W",233).
component("YBL099W",123).
component("YLR231C",436).
component("YLR134W",428).
component("YLR044C",422).
component("YGR087C",292).
component("YDR380W",215).
component("YDL080C",172).
component("U98_",109).
component("YMR250W",469).
component("YOR128C",525).
component("U93_",106).
component("YKL211C",404) :- not remove_orf("YKL211C",404).
component("YKR097W",414).
component("YNL169C",486).
component("YEL046C",229).
component("YNR033W",500).
component("YKL211C",405) :- not remove_orf("YKL211C",405).
component("YER090W",405) :- not remove_orf("YER090W",405).
component("YER090W",245) :- not remove_orf("YER090W",245).
component("YDR127W",198).
component("YPL281C",571).
component("YOR393W",548).
component("YMR323W",473).
component("YHR174W",330).
component("YGR254W",303).
component("YPL262W",566).
component("YGL026C",269) :- not remove_orf("YGL026C",269).
component("YLR304C",444).
component("YJL200C",369).
component("YNL316C",496).
component("YPL212C",561).
component("YNL292W",494).
component("YGL063W",272).
component("YFL001W",250).
component("YPR002W",572).
component("YJR016C",375).
component("YCR053W",166).
component("YDR127W",199).
component("YGL148W",276).
component("YIL168W",352).
component("YIL167W",351).
component("YCL064C",159).
component("YLR359W",449).
component("YAL012W",112).
component("YBR019C",127).
component("YDR007W",189) :- not remove_orf("YDR007W",189).
component("YOR095C",523).
component("YBR196C",144).
component("YGL001C",263).
component("YPL117C",554).
component("U14_",35).
component("YOL056W",510).
component("YKL152C",399).
component("YDL021W",167).
component("YPR060C",574).
component("YPL097W",552).
component("YGR185C",297).
component("YGR264C",304).
component("YGR171C",295).
component("YPL104W",553).
component("YLL018C",415).
component("YHR020W",314).
component("YER087W",244).
component("YNL247W",488).
component("YOR168W",528).
component("YOL097C",514).
component("YDR268W",208).
component("YCR024C",162).
component("YHR019C",313).
component("YOR335C",539).
component("YLR153C",430).
component("YAL054C",114).
component("YGR244C",302).
component("YIL145C",348).
component("YJL101C",360).
component("YOL049W",508).
component("YER183C",249).
component("U90_",105).
component("YNR057C",501).
component("YGL234W",283).
component("YJR103W",384).
component("YBL039C",121).
component("YGR204W",299).
component("YBR084W",133).
component("YNL220W",487).
component("YDL141W",179).
component("YHR074W",322).
component("YGL062W",271).
component("YBR218C",145).
component("YPL231W",565).
component("YNR016C",499).
component("YKL182W",402).
component("YGR037C",289).
component("YPR138C",581).
component("YPL265W",567).
component("YPL036W",551).
component("YOR171C",529).
component("YOR011W",521).
component("YOL156W",520).
component("YOL103W",515).
component("YOL020W",507) :- not remove_orf("YOL020W",507).
component("YNR072W",503).
component("YNL270C",492).
component("YNL142W",484).
component("YMR011W",461).
component("YLR260W",439).
component("YLR100C",427).
component("YLR081W",425).
component("YKR053C",411).
component("YKR039W",410) :- not remove_orf("YKR039W",410).
component("YJR158W",390).
component("YJR077C",382).
component("YJL219W",372).
component("YJL214W",370).
component("YJL134W",364).
component("YJL129C",362).
component("YIL134W",346).
component("YHR096C",325).
component("YHR094C",324).
component("YHR092C",323).
component("YHL036W",311).
...
component("YFL011W",251).
component("YER060W-A",239).
component("YER060W",238).
component("YER056C",237).
component("YER053C",236).
component("YEL069C",232).
component("YEL063C",231).
component("YEL017C-A",227).
component("YDR536W",226).
component("YDR508C",224).
component("YDR503C",223).
component("YDR497C",222).
component("YDR345C",212).
component("YDR343C",211).
component("YDR342C",210).
component("YDR297W",209).
component("YDR046C",193) :- not remove_orf("YDR046C",193).
component("YDL245C",188).
component("YCR032W",164).
component("YCR024C-A",163).
component("YCL025C",157).
component("YBR298C",153).
component("YBR069C",131) :- not remove_orf("YBR069C",131).
component("YBR068C",130) :- not remove_orf("YBR068C",130).
component("YBR021W",128).
component("U7_",103).
component("U75_",100).
component("U74_",99).
component("U73_",98).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,214) :- not remove_reaction(3620,214).
catalyst(2110,260).
catalyst(2190,260).
catalyst(5791,435).
catalyst(5792,435).
...
catalyst(6112,525).
catalyst(2300,106).
catalyst(3600,404) :- not remove_reaction(3600,404).
catalyst(8000,414).
catalyst(6890,486).
catalyst(4560,229).
catalyst(2550,500).
catalyst(1890,405) :- not remove_reaction(1890,405).
catalyst(3630,405) :- not remove_reaction(3630,405).
catalyst(1890,245) :- not remove_reaction(1890,245).
...
catalyst(1210,425).
catalyst(6560,411).
catalyst(771,410) :- not remove_reaction(771,410).
catalyst(772,410) :- not remove_reaction(772,410).
catalyst(781,410) :- not remove_reaction(781,410).
catalyst(782,410) :- not remove_reaction(782,410).
catalyst(801,410) :- not remove_reaction(801,410).
catalyst(802,410) :- not remove_reaction(802,410).
catalyst(811,410) :- not remove_reaction(811,410).
catalyst(812,410) :- not remove_reaction(812,410).
catalyst(831,410) :- not remove_reaction(831,410).
catalyst(832,410) :- not remove_reaction(832,410).
catalyst(841,410) :- not remove_reaction(841,410).
catalyst(842,410) :- not remove_reaction(842,410).
catalyst(851,410) :- not remove_reaction(851,410).
catalyst(852,410) :- not remove_reaction(852,410).
catalyst(881,410) :- not remove_reaction(881,410).
catalyst(882,410) :- not remove_reaction(882,410).
catalyst(901,410) :- not remove_reaction(901,410).
catalyst(902,410) :- not remove_reaction(902,410).
catalyst(921,410) :- not remove_reaction(921,410).
catalyst(922,410) :- not remove_reaction(922,410).
catalyst(931,410) :- not remove_reaction(931,410).
catalyst(932,410) :- not remove_reaction(932,410).
catalyst(1191,410) :- not remove_reaction(1191,410).
catalyst(1192,410) :- not remove_reaction(1192,410).
catalyst(1210,390).
catalyst(1581,382).
catalyst(1582,382).
catalyst(1210,372).
...
catalyst(851,193) :- not remove_reaction(851,193).
catalyst(852,193) :- not remove_reaction(852,193).
...
catalyst(1121,153).
catalyst(1122,153).
catalyst(771,131) :- not remove_reaction(771,131).
catalyst(772,131) :- not remove_reaction(772,131).
...
catalyst(831,130) :- not remove_reaction(831,130).
catalyst(832,130) :- not remove_reaction(832,130).
catalyst(841,130) :- not remove_reaction(841,130).
catalyst(842,130) :- not remove_reaction(842,130).
catalyst(851,130) :- not remove_reaction(851,130).
catalyst(852,130) :- not remove_reaction(852,130).
catalyst(901,130) :- not remove_reaction(901,130).
catalyst(902,130) :- not remove_reaction(902,130).
catalyst(620,128).
catalyst(6960,103).
catalyst(2920,100).
catalyst(2920,99).
