...
component("YNL280C",600).
component("YLR056W",513).
component("YGL012W",327).
component("YKR009C",495).
component("YOL086C",624).
component("YMR303C",574).
component("YGL256W",348).
...
component("YIL094C",415).
component("U45_",97).
component("YML056C",553).
component("YLR432W",546).
component("YHR216W",409).
component("YAR075W",143).
component("YAR073W",142).
component("YDR127W",242).
component("YML075C",554).
component("YLR450W",548).
component("YOL126C",630).
component("YKL085W",481).
component("YDL078C",209).
component("YNL037C",579).
component("YNL009W",577).
component("YLR174W",525).
component("YHR183W",402).
component("YGR256W",369).
component("YNL241C",593).
component("YOL059W",622).
component("YDL022W",203).
component("YCL018W",190).
component("YLR355C",541).
component("YDL174C",225).
component("YML086C",556).
component("YIL155C",424).
component("YGR088W",356).
component("YDR256C",254).
component("YKL026C",479).
component("YIR037W",433).
component("YBR244W",178).
component("YJR078W",468).
component("U58_",106).
component("YJR025C",461).
component("U107_",24).
component("YHR007C",379).
component("YGL055W",333).
component("YJR104C",470).
component("YHR008C",380).
component("YOR384W",664).
component("YOR381W",663).
component("YOL152W",632).
component("YLL051C",506).
component("YJL026W",435).
component("YIL066C",413).
component("YGR180C",360).
component("YER070W",300).
component("U37_",91).
component("U36_",90).
component("YDL168W",222).
component("YJR009C",458).
component("YJL052W",437).
component("YGR192C",362).
component("YBR006W",152).
component("YPL276W",689).
component("YPL275W",688).
component("YOR388C",665).
component("YOR374W",661).
component("YER073W",301).
component("YGL154C",340).
component("U55_",105).
component("YER069W",298).
component("YOR323C",654).
component("YER178W",309).
component("YBR221C",176).
component("YIL125W",420).
component("U52_",103).
component("YBR166C",171).
component("YGL012W",328).
component("YKL216W",494).
component("YDR044W",235).
component("YKR009C",496).
component("YIL160C",425).
component("YGL205W",345).
component("YMR118C",565).
component("YLR164W",523).
component("YLL041C",505).
component("YKL148C",485).
component("YKL141W",483).
component("YJL045W",436).
component("YDR178W",249).
component("YEL047C",285).
component("YDL171C",223).
component("YDL171C",224).
component("YOR375C",662).
component("YDL215C",227).
component("YAL062W",140).
component("U99_",135).
component("U100_",20).
component("YBR035C",158).
component("YKR080W",501).
component("YER023W",291).
component("YOR236W",652).
component("YGR204W",363).
component("YIR034C",432).
component("YLR142W",520).
component("U65_",112).
component("U63_",110).
component("U62_",109).
component("YHR068W",389).
component("YKL150W",486).
component("YIL043C",412).
component("YHR042W",384).
component("YPL171C",676).
component("YHR179W",401).
component("YMR145C",568).
component("YML120C",557).
component("YKL192C",491).
component("YDL085W",211).
component("YGR234W",365).
component("YFR030W",320).
component("YPL017C",667).
component("YFL018C",313).
component("YDR353W",264).
component("YPR167C",701).
component("YJR137C",473).
component("YNL052W",581).
component("YMR256C",573).
component("YLR395C",545).
component("YLR038C",511).
component("YIL111W",417).
component("YHR051W",388).
component("YGL191W",343).
component("YGL187C",342).
component("YDL067C",208).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",687).
component("YKR069W",500).
component("YOL096C",625).
component("U47_",99).
component("YER091C",306).
component("YJR073C",466).
component("YDR120C",240).
component("YML008C",549).
component("YOR074C",637).
component("YDL033C",205).
component("YOL096C",626).
component("YLR172C",524).
component("YLR058C",514).
component("YDR019C",233).
component("YBR176W",172).
component("YDR408C",269).
component("YMR120C",566).
component("YLR028C",509).
component("YBL013W",144).
component("YJL130C",445).
component("YKL024C",478).
component("YPR074C",697).
component("YBR117C",166).
component("YMR108W",564).
component("YCL009C",189).
component("YNL071W",583).
component("YNR008W",605).
component("YIL160C",426).
component("YNR019W",608).
...
component("U8_",129).
component("YPL231W",683).
component("YPL028W",668).
component("YLR299W",534).
component("YGL017W",329).
component("YML126C",558).
component("YNL104C",586).
component("YDL182W",226).
component("YDL131W",215).
component("YDR307W",260).
component("YLR258W",531).
component("YFR015C",318).
component("YNL029C",578).
component("YIL085C",414).
component("YMR306W",575).
component("YLR342W",540).
component("YGR032W",351).
component("YLR209C",527).
component("U104_",21).
component("YDR354W",265) :- not remove_orf("YDR354W",265).
component("YFR047C",321).
component("YJR133W",472).
component("YLR209C",528).
component("YML022W",550).
component("YDR441C",271).
component("YJL167W",450).
component("YJL167W",451).
component("YDR127W",243).
component("YHR190W",404).
component("YLR146C",521).
component("YHR068W",390).
component("YLR303W",536).
component("YGR012W",349).
component("YML082W",555).
component("YJR130C",471).
component("YDR035W",234).
component("YBR249C",179).
component("YLR180W",526).
component("YDR502C",274).
component("YOR274W",653).
component("YBR256C",181).
component("YHR137W",397).
component("YGL202W",344).
component("YLR027C",508).
component("YKL106W",482).
component("YOL140W",631).
component("YLR438W",547).
component("YGR019W",350).
component("YLR089C",516).
component("U64_",111).
component("U61_",108).
component("U51_",102).
component("YJR148W",474).
component("YHR208W",407).
component("YFL030W",314).
component("YOR184W",646).
component("YNR058W",612).
component("YIL116W",419).
component("YGL253W",347).
component("YFR053C",322).
component("YMR013C",562).
component("YMR205C",569).
component("YGR240C",366).
component("YOL016C",616).
component("YFR014C",317).
component("YCR036W",199).
component("YCL040W",192).
component("U15_",47).
component("YPL188W",677).
component("YJR049C",463).
component("YEL041W",283).
component("U96_",133).
component("YKL001C",477).
component("YDR236C",252).
component("YHL032C",377).
component("YDR531W",278).
component("U83_",128).
component("U82_",127).
component("U81_",126).
component("YMR208W",570).
component("YPL203W",678).
component("YOR061W",636).
component("YKL166C",488).
component("YJL164C",449).
component("YIL035C",411).
component("YHR205W",406).
component("YHR102W",396).
component("YGL019W",330).
component("YHR025W",383).
component("YOR347C",659).
component("YAL038W",138).
component("YNR012W",606).
...
component("YKL067W",480).
component("YOL055C",619).
component("YDR454C",272).
component("YJR057W",464).
component("YOL061W",623).
component("YKL181W",489).
component("YHL011C",376).
component("YER099C",307).
component("YBL068W",150).
component("YOR143C",642).
component("YNL256W",596).
component("YLR328W",538).
component("YBR018C",154).
component("YLR328W",539).
component("U80_",125).
component("U94_",132).
component("YJR010W",459).
component("YBR029C",157).
component("YGL130W",338).
component("YDR530C",277).
component("YPR190C",704).
component("YPR187W",703).
component("YPR110C",698).
component("YPR010C",692).
component("YOR341W",658).
component("YOR340C",657).
component("YOR224C",651).
component("YOR210W",650).
component("YOR207C",648).
component("YOR151C",643).
component("YOR116C",639).
component("YOL005C",614).
component("YNR003C",604).
component("YNL248C",595).
component("YNL151C",590).
component("YNL113W",587).
component("YKL144C",484).
component("YJR063W",465).
component("YJL148W",448).
component("YJL140W",447).
component("YIL021W",410).
component("YHR143W-A",398).
component("YGL070C",336).
component("YFL036W",315).
...
component("YPR175W",702).
component("YPL167C",675).
component("YOR330C",655).
component("YOL115W",629).
component("YNL299W",602).
component("YNL262W",598).
component("YNL102W",585).
component("YJR043C",462).
component("YJR006W",457).
component("YJL090C",440).
component("YIL139C",422).
...
component("YPR113W",699).
component("YBR243C",177).
component("YPL148C",673).
component("YER026C",292).
component("YGR286C",373).
component("YHR189W",403).
component("YDR058C",239).
component("YDL086W",212).
component("YOL011W",615).
component("YMR008C",560).
component("YMR006C",559).
component("U105_",22).
component("YBL015W",145).
component("YJL068C",438).
component("YOR040W",635).
component("U77_",122).
component("YLR377C",543).
component("YPR073C",695).
component("YHR215W",408).
...
component("YPR073C",696).
component("YOR208W",649).
component("YNL053W",582).
component("YMR036C",563).
component("YIR026C",431).
component("YIL113W",418).
component("YFR028C",319).
component("YER075C",302).
...
component("U25_",82).
component("U24_",81).
component("YHR044C",386).
component("YHR043C",385).
component("YOR360C",660).
component("YKR031C",497).
component("YPL206C",679).
component("YGL027C",332).
component("YLR286C",533).
component("YJR153W",475).
component("YJL221C",456).
component("YJL216C",454).
component("YIL172C",429).
component("YGR292W",375).
component("YGR287C",374).
component("YBR299W",188).
component("YBR184W",173).
component("YIR019C",430).
component("YIL099W",416).
component("YDL037C",206).
component("YOR190W",647).
component("YLR300W",535).
component("YGR282C",372).
component("YDR261C",255).
component("YDR400W",267).
component("YML035C",551).
component("YJL070C",439).
component("YBR284W",185).
component("U106_",23).
component("YER043C",293).
component("YNL045W",580).
component("YDR242W",253).
component("U53_",104).
component("YPR062W",694).
component("YMR120C",567).
component("YLR028C",510).
component("YHR144C",399).
component("YGR267C",371).
component("YBL033C",146).
component("YNL141W",588).
component("YLR245C",530).
component("YML035C",552).
component("YBR084W",161).
component("YJL126W",443).
component("U44_",96).
component("YDL100C",213).
component("U40_",94).
component("U39_",92).
component("YBR011C",153).
component("YHR201C",405).
component("YBR111C",165).
component("YBR252W",180).
component("YER005W",290).
component("YBL099W",151).
component("YLR231C",529).
component("YDR538W",280).
component("YLR134W",518).
component("YLR044C",512).
component("YGR087C",355).
component("YDR380W",266).
component("YDL080C",210).
component("U98_",134).
component("YMR250W",572).
component("YOR128C",640).
component("YEL021W",282).
component("YNR043W",610).
component("U93_",131).
component("YKL211C",492) :- not remove_orf("YKL211C",492).
component("YKR097W",503).
component("YNL169C",591).
component("YNL256W",597).
component("YDR294C",257).
component("YEL046C",284).
component("YNR033W",609).
component("YKL211C",493) :- not remove_orf("YKL211C",493).
component("YER090W",493) :- not remove_orf("YER090W",493).
component("YER090W",305) :- not remove_orf("YER090W",305).
component("YDR127W",245).
component("YPL281C",690).
component("YOR393W",666).
component("YMR323W",576).
component("YHR174W",400).
component("YGR254W",368).
component("YPL262W",685).
component("YGL026C",331) :- not remove_orf("YGL026C",331).
component("YGR155W",358).
component("YLR304C",537).
component("YJL200C",452).
component("YNL316C",603).
component("YPL212C",680).
component("YNL292W",601).
component("YGL063W",335).
component("YFL001W",311).
component("YPR002W",691).
component("YJR016C",460).
component("YCR053W",201).
component("YDR127W",246).
component("YGL148W",339).
component("YIL168W",428).
component("YIL167W",427).
component("YCL064C",193).
component("YER086W",303).
component("YLR359W",542).
component("YAL012W",137).
component("YFR055W",323).
component("YJL005W",434).
component("YJL121C",442).
component("YBR019C",155).
component("YDR050C",238).
component("YDR007W",231) :- not remove_orf("YDR007W",231).
component("YOR095C",638).
component("YBR196C",174).
component("YGL001C",325).
component("YPL117C",672).
component("U14_",39).
component("YOL056W",620).
component("YKL152C",487).
component("YDL021W",202).
component("YEL058W",287).
component("YPR060C",693).
component("YHR072W",391).
component("YPL097W",670).
component("YGR185C",361).
component("YGR264C",370).
component("YGR171C",359).
component("YPL104W",671).
component("YLL018C",504).
component("YHR020W",382).
component("YER087W",304).
component("YNL247W",594).
component("YOR168W",644).
component("YOL097C",627).
component("YDR268W",256).
component("YCR024C",196).
component("YHR019C",381).
component("YPL160W",674).
component("YLR382C",544).
component("YNL073W",584).
component("YOR335C",656).
component("YLR153C",522).
component("YAL054C",139).
component("YGR244C",367).
component("YIL145C",423).
component("YJL101C",441).
component("YOL049W",618).
component("YAR015W",141).
component("YER183C",310).
component("U90_",130).
component("YNR057C",611).
component("YDL141W",217).
component("YGL234W",346).
component("YDL141W",218).
component("YJR103W",469).
component("YBL039C",148).
component("YGR204W",364).
component("YBR084W",162).
component("YNL220W",592).
component("YOL058W",621).
component("YDL141W",219).
component("YHR074W",392).
component("YMR217W",571).
component("YGL062W",334).
component("YBR218C",175).
component("YPL231W",684).
component("YNR016C",607).
component("YKL182W",490).
component("YGR037C",352).
component("YPR138C",700).
component("YPL265W",686).
component("YPL036W",669).
component("YOR171C",645).
component("YOR130C",641).
component("YOR011W",634).
component("YOL156W",633).
component("YOL103W",628).
component("YOL020W",617) :- not remove_orf("YOL020W",617).
component("YNR072W",613).
component("YNL270C",599).
component("YNL142W",589).
component("YMR011W",561).
component("YLR260W",532).
component("YLR138W",519).
component("YLR100C",517).
component("YLR081W",515).
component("YLL061W",507).
component("YKR093W",502).
component("YKR053C",499).
component("YKR039W",498) :- not remove_orf("YKR039W",498).
component("YJR158W",476).
component("YJR077C",467).
component("YJL219W",455).
component("YJL214W",453).
component("YJL134W",446).
component("YJL129C",444).
component("YIL134W",421).
component("YHR096C",395).
component("YHR094C",394).
component("YHR092C",393).
component("YHL036W",378).
component("YGR121C",357).
component("YGR065C",354).
component("YGR055W",353).
component("YGL186C",341).
component("YGL077C",337).
component("YGL008C",326).
component("YFL055W",316).
component("YFL011W",312).
component("YER060W-A",297).
component("YER060W",296).
component("YER056C",295).
component("YER053C",294).
...
catalyst(6470,610).
catalyst(2300,131).
catalyst(3600,492) :- not remove_reaction(3600,492).
catalyst(8000,503).
catalyst(6890,591).
catalyst(2570,597).
catalyst(8781,257).
...
catalyst(4560,284).
catalyst(2550,609).
catalyst(1890,493) :- not remove_reaction(1890,493).
catalyst(3630,493) :- not remove_reaction(3630,493).
catalyst(1890,305) :- not remove_reaction(1890,305).
...
catalyst(8051,685).
catalyst(8052,685).
catalyst(3590,331) :- not remove_reaction(3590,331).
catalyst(10910,331) :- not remove_reaction(10910,331).
catalyst(4570,358).
catalyst(8181,537).
catalyst(8182,537).
catalyst(8181,452).
...
catalyst(1210,633).
catalyst(1160,628).
catalyst(801,617) :- not remove_reaction(801,617).
catalyst(802,617) :- not remove_reaction(802,617).
catalyst(811,617) :- not remove_reaction(811,617).
catalyst(812,617) :- not remove_reaction(812,617).
catalyst(831,617) :- not remove_reaction(831,617).
catalyst(832,617) :- not remove_reaction(832,617).
catalyst(901,617) :- not remove_reaction(901,617).
catalyst(902,617) :- not remove_reaction(902,617).
catalyst(1180,613).
catalyst(1210,613).
catalyst(931,599).
catalyst(932,599).
...
catalyst(640,502).
catalyst(6560,499).
catalyst(771,498) :- not remove_reaction(771,498).
catalyst(772,498) :- not remove_reaction(772,498).
catalyst(781,498) :- not remove_reaction(781,498).
catalyst(782,498) :- not remove_reaction(782,498).
catalyst(801,498) :- not remove_reaction(801,498).
catalyst(802,498) :- not remove_reaction(802,498).
catalyst(811,498) :- not remove_reaction(811,498).
catalyst(812,498) :- not remove_reaction(812,498).
catalyst(831,498) :- not remove_reaction(831,498).
catalyst(832,498) :- not remove_reaction(832,498).
catalyst(841,498) :- not remove_reaction(841,498).
catalyst(842,498) :- not remove_reaction(842,498).
catalyst(851,498) :- not remove_reaction(851,498).
catalyst(852,498) :- not remove_reaction(852,498).
catalyst(881,498) :- not remove_reaction(881,498).
catalyst(882,498) :- not remove_reaction(882,498).
catalyst(901,498) :- not remove_reaction(901,498).
catalyst(902,498) :- not remove_reaction(902,498).
catalyst(921,498) :- not remove_reaction(921,498).
catalyst(922,498) :- not remove_reaction(922,498).
catalyst(931,498) :- not remove_reaction(931,498).
catalyst(932,498) :- not remove_reaction(932,498).
catalyst(1191,498) :- not remove_reaction(1191,498).
catalyst(1192,498) :- not remove_reaction(1192,498).
catalyst(1180,476).
catalyst(1210,476).
catalyst(1581,467).
catalyst(1582,467).
