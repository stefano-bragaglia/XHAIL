...
component("YLR056W",608).
component("YGR060W",421).
component("YGL012W",392).
component("YKR009C",589).
component("YOL086C",735).
component("YMR303C",681).
component("YMR083W",667).
component("YGL256W",414).
component("YDL168W",266).
component("YBR145W",200).
component("YPL231W",799).
component("YBR265W",217).
component("U46_",118).
...
component("U45_",117).
component("YML056C",654).
component("YLR432W",644).
component("YHR216W",486).
component("YAR075W",172).
component("YAR073W",171).
component("YDR127W",293).
component("YJR139C",560).
component("YML075C",656).
component("YLR450W",647).
component("YOL126C",741).
component("YKL085W",570).
component("YDL078C",249).
component("YNL037C",686).
component("YNL009W",684).
component("YLR174W",621).
component("YHR183W",479).
component("YGR256W",442).
component("YNL241C",700).
component("YOL059W",732).
component("YDL022W",242).
component("YCL018W",225).
component("YLR355C",639).
component("YIL074C",492).
component("YER081W",363).
component("YDL174C",270).
component("YML086C",658).
component("YIL155C",504).
component("YEL024W",339).
component("YKR066C",594).
component("YGR088W",425).
component("YDR256C",307).
component("YKL026C",566).
component("YIR037W",514).
component("YBR244W",212).
component("YJR078W",553).
component("U58_",127).
component("YJR025C",545).
component("U107_",24).
component("U108_",25).
component("YHR007C",453).
component("YDR402C",321).
component("YGL055W",399).
component("YJR104C",555).
component("YHR008C",454).
component("YOR384W",778).
component("YOR381W",777).
component("YOL152W",743).
component("YLL051C",601).
component("YJL026W",516).
component("YIL066C",491).
component("YGR180C",432).
component("YER070W",360).
component("U37_",111).
component("U36_",110).
component("U35_",109).
component("YDL168W",267).
component("YDR158W",301).
component("YJR009C",542).
component("YJL052W",518).
component("YGR192C",434).
component("YBR006W",182).
component("YPL276W",807).
component("YPL275W",806).
component("YOR388C",779).
component("YPL061W",784).
component("YOR374W",775).
component("YER073W",361).
component("YGL154C",406).
component("YBR115C",196).
component("U55_",126).
component("YER069W",358).
component("YOR323C",767).
component("YER178W",373).
component("YBR221C",210).
component("YIL125W",500).
component("U52_",123).
component("YBR166C",205).
component("YNL280C",708).
component("YGL012W",393).
component("YKL182W",579).
component("YKL216W",588).
component("YDR044W",283).
component("YKR009C",590).
component("YIL160C",505).
component("YGL205W",411).
component("YMR118C",669).
component("YLR164W",619).
component("YLL041C",600).
component("YKL148C",574).
component("YKL141W",572).
component("YJL045W",517).
component("YDR178W",302).
component("YEL047C",342).
component("YDL171C",268).
component("YDL171C",269).
component("YOR375C",776).
component("YDL215C",274).
component("YAL062W",168).
component("U99_",162).
component("U100_",20).
component("YBR035C",188).
component("YKR080W",596).
component("YER023W",349).
component("YOR236W",765).
component("YGR204W",436).
component("YIR034C",513).
component("YLR142W",616).
component("U65_",133).
component("U63_",131).
component("U62_",130).
...
component("YHR042W",459).
component("YOR221C",762).
component("YMR145C",672).
component("YKL192C",582).
component("YKL055C",568).
component("YER061C",356).
component("YDL085W",251).
component("YPL171C",792).
component("YHR179W",478).
component("YMR145C",673).
component("YML120C",659).
component("YKL192C",583).
component("YDL085W",252).
component("YGR234W",438).
component("YFR030W",385).
component("YPL017C",781).
component("YFL018C",377).
component("YDR353W",317).
component("YPR167C",822).
component("YJR137C",559).
component("YNL052W",688).
component("YMR256C",679).
component("YLR395C",643).
component("YLR038C",606).
component("YIL111W",497).
component("YHR051W",463).
component("YGL191W",409).
component("YGL187C",408).
component("YDL067C",248).
component("Q0275",19).
component("Q0250",18).
component("YDR072C",288).
component("YPL266W",805).
component("YKR069W",595).
component("YOL096C",736).
component("U47_",119).
component("YER091C",368).
component("YJR073C",551).
component("YGR157W",430).
component("YDR120C",291).
component("YML008C",649).
component("YOR074C",748).
component("YDL033C",244).
component("YOL096C",737).
component("YLR172C",620).
component("YLR058C",609).
component("YDR019C",280).
component("YBR176W",206).
component("YDR408C",323).
component("YMR120C",670).
component("YLR028C",604).
component("YBL013W",173).
component("YJL130C",527).
component("YJL088W",521).
component("YKL024C",565).
component("YPR074C",817).
component("YBR117C",197).
component("YMR108W",668).
component("YCL009C",224).
component("YNL071W",690).
component("YNR008W",713).
component("YIL160C",506).
component("YNR019W",716).
component("YCR048W",238).
component("U48_",120).
component("YMR062C",666).
component("YDR232W",304).
component("YPL231W",800).
component("YER061C",357).
component("YDL052C",247).
component("U8_",156).
component("YDR148C",299).
component("YPL231W",801).
component("YPL028W",782).
component("YLR299W",631).
component("YGL017W",394).
component("YCR005C",230).
component("YML126C",660).
component("YNL104C",693).
component("YDL182W",271).
component("YDL131W",257).
component("YDR307W",313).
component("YLR258W",628).
component("YFR015C",383).
component("YNL029C",685).
component("YIL085C",494).
component("YMR306W",682).
component("YLR342W",637).
component("YGR032W",418).
component("YPR183W",824).
component("YBR248C",213).
component("YLR209C",623).
component("U104_",21).
component("YDR354W",318) :- not remove_orf("YDR354W",318).
component("YFR047C",386).
component("YJR133W",558).
component("YLR209C",624).
component("YML022W",651).
component("YDR441C",326).
component("YHR128W",473).
component("YJL167W",534).
component("YJL167W",535).
component("YPR069C",814).
component("YDR127W",294).
component("YHR190W",481).
component("YLR146C",617).
component("YHR068W",465).
component("YLR303W",633).
component("YGR012W",416).
component("YML082W",657).
component("YJR130C",557).
component("YDR035W",282).
component("YBR249C",214).
component("YLR180W",622).
component("YDR502C",330).
component("YOR274W",766).
component("YBR256C",216).
component("YHR137W",474).
component("YGL202W",410).
component("YLR027C",603).
component("YKL106W",571).
component("YOL140W",742).
component("YLR438W",646).
component("YGR019W",417).
component("YLR089C",612).
component("U64_",132).
component("U61_",129).
component("U51_",122).
component("YJR148W",561).
component("YHR208W",484).
component("YFL030W",379).
component("YOR184W",757).
component("YNR058W",722).
component("YIL116W",499).
component("YGL253W",413).
component("YFR053C",387).
component("YMR013C",664).
component("YMR205C",675).
component("YGR240C",439).
component("YOL016C",726).
component("YFR014C",382).
component("YLR240W",626).
component("YKL203C",585).
component("YJR066W",550).
component("YCR036W",237).
component("YCL040W",227).
component("U15_",56).
component("YPL188W",794).
component("YJR049C",547).
component("YEL041W",340).
component("U96_",160).
component("YKL001C",564).
component("YDR236C",305).
component("YHL032C",451).
component("YDR531W",334).
component("U83_",151).
component("U82_",150).
component("U81_",149).
component("YMR208W",676).
component("YPL203W",795).
component("YOR061W",747).
component("YKL166C",577).
component("YJL164C",533).
component("YIL035C",488).
component("YHR205W",483).
component("YHR102W",471).
component("YGL019W",395).
component("YHR025W",458).
component("YOR347C",772).
component("YAL038W",166).
component("YNR012W",714).
component("YDR009W",279).
component("YDR127W",295).
component("YDR147W",298).
component("YDR300C",312).
component("YCR012W",231).
component("YER069W",359).
component("U19_",85).
component("U18_",77).
component("U17_",69).
component("U76_",143).
...
component("YKL067W",569).
component("YOL055C",729).
component("YDR454C",327).
component("YJR057W",548).
component("YOL061W",733).
component("YKL181W",578).
component("YHL011C",449).
component("YER099C",369).
component("YBL068W",180).
component("YOR143C",753).
component("YNL256W",703).
component("YLR328W",635).
component("YBR018C",184).
component("YGR007W",415).
component("YGR202C",435).
component("YLR328W",636).
component("U80_",148).
component("YDL103C",256).
component("U94_",159).
component("YJR010W",543).
component("YBR029C",187).
component("YCL050C",228).
component("YGL130W",404).
component("YDR530C",333).
component("YPR190C",826).
component("YPR187W",825).
component("YPR110C",819).
component("YPR010C",810).
component("YOR341W",771).
component("YOR340C",770).
component("YOR224C",764).
component("YOR210W",761).
component("YOR207C",759).
component("YOR151C",754).
component("YOR116C",750).
component("YOL005C",724).
component("YNR003C",712).
component("YNL248C",702).
component("YNL151C",697).
component("YNL113W",694).
component("YKL144C",573).
component("YJR063W",549).
component("YJL148W",531).
component("YJL140W",530).
component("YIL021W",487).
component("YHR143W-A",475).
component("YGL070C",402).
component("YFL036W",380).
component("YDR404C",322).
component("YDR156W",300).
component("YDR045C",284).
component("YDL150W",265).
component("YDL140C",259).
component("YBR154C",204).
component("YPR175W",823).
component("YPL167C",791).
component("YOR330C",768).
component("YOL115W",740).
component("YNL299W",710).
component("YNL262W",705).
component("YNL102W",692).
component("YJR043C",546).
component("YJR006W",541).
component("YJL090C",522).
component("YIL139C",502).
component("YEL055C",343).
component("YDR419W",324).
component("YDR121W",292).
component("YDL102W",255).
component("YCR014C",232).
component("YBR278W",219).
component("YBL035C",176).
component("YKL035W",567).
component("YHL012W",450).
component("YHR123W",472).
component("YPR113W",820).
component("YBR243C",211).
component("YDL142C",264).
component("YPL148C",789).
component("YER026C",350).
component("YGR286C",446).
component("YHR189W",480).
component("YDR058C",287).
component("YDL086W",253).
component("YOL011W",725).
component("YMR008C",662).
component("YMR006C",661).
component("U105_",22).
component("YBL015W",174).
component("YJL068C",519).
component("YOR040W",746).
component("U77_",144).
component("YDR481C",328).
component("YLR377C",641).
component("YPL179W",793).
component("YNR032W",717).
component("YML057W",655).
component("YML016C",650).
component("YLR433C",645).
component("YGR123C",428).
component("YER133W",370).
component("YER089C",366).
component("YDR436W",325).
component("YDR075W",289).
component("YDL188C",272).
component("YDL134C",258).
component("YDL047W",246).
component("YDL006W",240).
component("YBR125C",199).
component("YBL056W",179).
component("YPR073C",815).
...
component("U9_",163).
component("YPL228W",798).
component("YMR180C",674).
component("YDL236W",276).
component("YJL155C",532).
component("YPR073C",816).
component("YOR208W",760).
component("YNL053W",689).
component("YMR036C",665).
component("YIR026C",512).
component("YIL113W",498).
component("YFR028C",384).
component("YER075C",362).
component("YDL230W",275).
component("YBR276C",218).
component("U34_",108).
component("U33_",107).
component("U32_",106).
component("U31_",105).
...
component("U25_",99).
component("U24_",98).
component("YHR044C",461).
component("YHR043C",460).
component("YOL064C",734).
component("YOR360C",774).
component("YKR031C",591).
component("YPL206C",796).
component("YGL027C",397).
component("YLR286C",630).
component("YJR153W",562).
component("YJL221C",540).
component("YJL216C",538).
component("YIL172C",510).
component("YGR292W",448).
component("YGR287C",447).
component("YBR299W",223).
component("YBR184W",207).
component("YIL162W",507).
component("YIR019C",511).
component("YIL099W",496).
component("YDL037C",245).
component("YOR190W",758).
component("YLR300W",632).
component("YGR282C",445).
component("YDR261C",308).
component("YDR400W",320).
component("YML035C",652).
component("YJL070C",520).
component("YBR284W",220).
component("U106_",23).
component("YER043C",351).
component("YNL045W",687).
component("YGL037C",398).
component("YDR242W",306).
component("U53_",124).
component("YPR062W",813).
component("YMR120C",671).
component("YLR028C",605).
component("YHR144C",476).
component("YGR267C",444).
component("YBL033C",175).
component("YBR153W",203).
component("YNL141W",695).
component("YLR245C",627).
component("YML035C",653).
component("YBR084W",191).
component("YJL126W",525).
component("U44_",116).
component("YDL100C",254).
component("U87_",153).
component("U40_",114).
component("U39_",112).
component("YBR011C",183).
component("YHR201C",482).
component("YBR111C",195).
component("YBR252W",215).
component("YER005W",348).
component("YIL048W",490).
component("YER166W",371).
component("YDR093W",290).
component("YAL026C",165).
component("YBL099W",181).
component("YLR231C",625).
component("U88_",154).
component("YDR538W",336).
component("YLR134W",614).
component("YLR044C",607).
component("YGR087C",424).
component("YDR380W",319).
component("YDL080C",250).
component("U98_",161).
component("YMR250W",678).
component("YOR128C",751).
component("YEL021W",338).
component("YNR043W",719).
component("U93_",158).
component("U54_",125).
component("YKL211C",586) :- not remove_orf("YKL211C",586).
component("YKR097W",598).
component("YNL169C",698).
component("YNL256W",704).
component("YDR294C",310).
component("YEL046C",341).
component("YNR033W",718).
component("YKL211C",587) :- not remove_orf("YKL211C",587).
component("YER090W",587) :- not remove_orf("YER090W",587).
component("YER090W",367) :- not remove_orf("YER090W",367).
component("YDR127W",296).
component("YPL281C",808).
component("YOR393W",780).
component("YMR323W",683).
component("YHR174W",477).
component("YGR254W",441).
component("YPL262W",803).
component("YGL026C",396) :- not remove_orf("YGL026C",396).
component("YGR155W",429).
component("YLR304C",634).
component("YJL200C",536).
component("YNL316C",711).
component("YKL182W",580).
component("YPL212C",797).
component("YNL292W",709).
component("YGL063W",401).
component("YFL001W",375).
component("YPR002W",809).
component("YJR016C",544).
component("YCR053W",239).
component("YDR127W",297).
component("YGL148W",405).
component("YIL168W",509).
component("YIL167W",508).
component("YCL064C",229).
component("YER086W",364).
component("YLR359W",640).
component("YAL012W",164).
component("YML004C",648).
component("YFR055W",388).
component("YJL005W",515).
component("YJL121C",524).
component("YBR019C",185).
component("YDR050C",286).
component("YDR007W",278) :- not remove_orf("YDR007W",278).
component("YOR095C",749).
component("YER003C",347).
component("YBR196C",208).
component("YGL001C",390).
component("YPL117C",787).
component("U14_",48).
component("YOL056W",730).
component("YKL152C",576).
component("YDL021W",241).
component("YEL058W",344).
component("YPR060C",812).
component("YHR072W",466).
component("YPL097W",785).
component("YGR185C",433).
component("YGR264C",443).
component("YGR171C",431).
component("YHR011W",455).
component("YDR023W",281).
component("YPL104W",786).
component("YLL018C",599).
component("YPR081C",818).
component("YBR121C",198).
component("YHR020W",457).
component("YER087W",365).
component("YNL247W",701).
component("YOR168W",755).
component("YOL097C",738).
component("YDR268W",309).
component("YPR047W",811).
component("YLR060W",610).
component("YFL022C",378).
component("YCR024C",233).
component("YHR019C",456).
component("YKL194C",584).
component("YIL078W",493).
component("YPL160W",790).
component("YLR382C",642).
component("YNL073W",691).
component("YOR335C",769).
component("YGR094W",426).
component("YLR153C",618).
component("YAL054C",167).
component("YGR244C",440).
component("YIL145C",503).
component("U89_",155).
component("YJL101C",523).
component("YOL049W",728).
component("YAR015W",169).
component("YER183C",374).
component("U90_",157).
component("YNR057C",721).
component("YDL141W",260).
component("YDL141W",261).
component("YGL234W",412).
component("YDL141W",262).
component("YJR103W",554).
component("YBL039C",177).
component("YGR204W",437).
component("YBR084W",192).
component("YNL220W",699).
component("YOL058W",731).
component("YDL141W",263).
component("YHR074W",467).
component("YMR217W",677).
component("YGR061C",422).
component("YJR109C",556).
component("YJL130C",528).
component("YGL062W",400).
component("YBR218C",209).
component("YPL231W",802).
component("YNR016C",715).
component("YKL182W",581).
component("YGR037C",419).
component("YPR138C",821).
component("YPL265W",804).
component("YPL134C",788).
component("YPL036W",783).
component("YOR348C",773).
component("YOR222W",763).
component("YOR171C",756).
component("YOR130C",752).
component("YOR011W",745).
component("YOL156W",744).
component("YOL103W",739).
component("YOL020W",727) :- not remove_orf("YOL020W",727).
component("YNR072W",723).
component("YNR056C",720).
component("YNL270C",706).
component("YNL142W",696).
component("YMR272C",680).
component("YMR011W",663).
component("YLR348C",638).
component("YLR260W",629).
component("YLR138W",615).
component("YLR100C",613).
component("YLR081W",611).
component("YLL061W",602).
component("YKR093W",597).
component("YKR053C",593).
component("YKR039W",592) :- not remove_orf("YKR039W",592).
component("YJR158W",563).
component("YJR077C",552).
component("YJL219W",539).
component("YJL214W",537).
component("YJL134W",529).
component("YJL129C",526).
component("YIL134W",501).
component("YHR096C",470).
component("YHR094C",469).
component("YHR092C",468).
component("YHL036W",452).
component("YGR121C",427).
component("YGR065C",423).
component("YGR055W",420).
component("YGL186C",407).
component("YGL077C",403).
component("YGL008C",391).
component("YFL055W",381).
component("YFL011W",376).
component("YER060W-A",355).
component("YER060W",354).
component("YER056C",353).
component("YER053C",352).
component("YEL069C",346).
component("YEL063C",345).
component("YEL017C-A",337).
component("YDR536W",335).
component("YDR508C",332).
component("YDR503C",331).
component("YDR497C",329).
component("YDR345C",316).
component("YDR343C",315).
component("YDR342C",314).
component("YDR297W",311).
component("YDR046C",285) :- not remove_orf("YDR046C",285).
component("YDL245C",277).
component("YDL210W",273).
component("YCR032W",236).
component("YCR028C",235).
component("YCR024C-A",234).
component("YCL025C",226).
component("YBR298C",222).
component("YBR291C",221).
component("YBR069C",190) :- not remove_orf("YBR069C",190).
component("YBR068C",189) :- not remove_orf("YBR068C",189).
component("YBR021W",186).
component("YBL042C",178).
component("U85_",152).
component("U7_",147).
component("U79_",146).
component("U78_",145).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,318) :- not remove_reaction(3620,318).
catalyst(2110,386).
catalyst(2190,386).
catalyst(5550,558).
catalyst(5791,624).
...
catalyst(2300,158).
catalyst(3460,125).
catalyst(3600,586) :- not remove_reaction(3600,586).
catalyst(8000,598).
catalyst(6890,698).
catalyst(2570,704).
catalyst(8781,310).
...
catalyst(4560,341).
catalyst(2550,718).
catalyst(1890,587) :- not remove_reaction(1890,587).
catalyst(3630,587) :- not remove_reaction(3630,587).
...
catalyst(8281,286).
catalyst(8282,286).
catalyst(3610,278) :- not remove_reaction(3610,278).
catalyst(7921,749).
catalyst(7922,749).
catalyst(7841,347).
catalyst(7842,347).
...
catalyst(851,592) :- not remove_reaction(851,592).
catalyst(852,592) :- not remove_reaction(852,592).
...
catalyst(921,592) :- not remove_reaction(921,592).
catalyst(922,592) :- not remove_reaction(922,592).
catalyst(931,592) :- not remove_reaction(931,592).
catalyst(932,592) :- not remove_reaction(932,592).
...
catalyst(1210,314).
catalyst(6650,311).
catalyst(801,285) :- not remove_reaction(801,285).
catalyst(802,285) :- not remove_reaction(802,285).
catalyst(811,285) :- not remove_reaction(811,285).
catalyst(812,285) :- not remove_reaction(812,285).
catalyst(831,285) :- not remove_reaction(831,285).
catalyst(832,285) :- not remove_reaction(832,285).
catalyst(841,285) :- not remove_reaction(841,285).
catalyst(842,285) :- not remove_reaction(842,285).
catalyst(851,285) :- not remove_reaction(851,285).
catalyst(852,285) :- not remove_reaction(852,285).
catalyst(901,285) :- not remove_reaction(901,285).
catalyst(902,285) :- not remove_reaction(902,285).
catalyst(1180,277).
catalyst(1210,277).
catalyst(730,273).
catalyst(431,236).
...
catalyst(851,190) :- not remove_reaction(851,190).
catalyst(852,190) :- not remove_reaction(852,190).
