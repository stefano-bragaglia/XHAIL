...
component("YNL280C",853).
component("YLR056W",729).
component("YGR060W",504).
component("YGL012W",470).
component("YKR009C",706).
component("YOL086C",887).
component("YMR303C",824).
component("YMR083W",801).
component("YGL256W",496).
component("YDL168W",320).
component("YBR145W",246).
component("YPL231W",972).
component("YBR265W",265).
component("U46_",147).
component("YBR149W",247).
component("YBR149W",248).
component("YGL001C",466).
component("YIL094C",593).
component("YHR063C",556).
component("U45_",146).
component("YML056C",783).
component("YLR432W",772).
component("YHR216W",581).
component("YAR075W",205).
component("YAR073W",204).
component("YDR127W",355).
component("YJR139C",667).
component("YML075C",786).
component("YLR450W",775).
component("YOL126C",893).
component("YKL085W",681).
component("YDL078C",302).
component("YKL029C",676).
component("YNL037C",829).
component("YNL009W",827).
component("YLR174W",743).
component("YHR183W",574).
component("YGR256W",533).
component("YNL241C",844).
component("YOL059W",884).
component("YDL022W",293).
component("YCL018W",273).
component("YLR355C",767).
component("YIL074C",590).
component("YER081W",437).
component("YML054C",782).
component("YDL174C",324).
component("YML086C",788).
component("YIL155C",603).
component("YEL024W",406).
component("YKR066C",711).
component("YGR088W",508).
component("YDR256C",370).
component("YKL026C",675).
component("YIR037W",614).
component("YBR244W",260).
component("YJR078W",659).
component("U58_",156).
component("YJR025C",650).
component("U107_",27).
component("YGR255C",532).
component("U108_",28).
component("YHR007C",544).
component("YDR402C",385).
component("YGL055W",477).
component("YJR104C",662).
component("YHR008C",545).
component("YOR384W",943).
component("YOR381W",942).
component("YOL152W",897).
component("YLL051C",721).
component("YJL026W",616).
component("YIL066C",589).
component("YGR180C",519).
component("YER070W",434).
component("U37_",140).
component("U36_",139).
component("U35_",138).
component("YDL168W",321).
component("YDR158W",363).
component("YJR009C",646).
component("YJL052W",618).
component("YGR192C",521).
component("YBR006W",219).
component("YPL276W",982).
component("YPL275W",981).
component("YOR388C",944).
component("YPL061W",952).
component("YOR374W",939).
component("YER073W",435).
component("YGL154C",486).
component("YBR115C",241).
component("U55_",155).
component("YER069W",432).
component("YOR323C",929).
component("YMR170C",811).
component("YMR169C",810).
component("YER178W",448).
component("YBR221C",258).
component("YIL125W",599).
component("U52_",152).
component("YBR166C",251).
component("YNL280C",854).
component("YGL012W",471).
component("YKL182W",693).
component("YKL216W",704).
component("YDR044W",339).
component("YER014W",416).
component("YKR009C",707).
component("YIL160C",604).
component("YGL205W",491).
component("YMR118C",805).
component("YLR164W",741).
component("YLL041C",719).
component("YKL148C",687).
component("YKL141W",685).
component("YJL045W",617).
component("YDR178W",365).
component("YJR051W",653).
component("YEL047C",409).
component("YDL171C",322).
component("YDL171C",323).
component("YOR375C",940).
component("YDL215C",328).
component("YAL062W",201).
component("U99_",195).
component("U100_",21).
component("YBR035C",228).
component("YMR189W",813).
component("YKR080W",713).
component("YER023W",418).
component("YPL023C",948).
component("YGL125W",483).
component("YOR236W",926).
component("YGR204W",524).
component("YBR084W",234).
component("YIR034C",613).
component("YLR142W",738).
component("U65_",163).
component("U63_",161).
component("U62_",160).
component("YOR356W",937).
component("YHR068W",557).
component("YKL150W",688).
component("YIL043C",586).
component("YHR042W",551).
component("YOR221C",923).
component("YMR145C",808).
component("YML120C",789).
component("YKL192C",697).
component("YKL055C",678).
component("YER061C",428).
component("YDL085W",304).
component("YPL171C",961).
component("YHR179W",573).
component("YMR145C",809).
component("YML120C",790).
component("YKL192C",698).
component("YDL085W",305).
component("YGR234W",527).
component("YFR030W",462).
component("YPL017C",947).
component("YFL018C",452).
component("YPL091W",953).
component("YDR353W",380).
component("YER042W",420).
component("YPR167C",1005).
component("YJR137C",666).
component("YNL052W",831).
component("YMR256C",820).
component("YLR395C",771).
component("YLR038C",727).
component("YIL111W",596).
component("YHR051W",555).
component("YGL191W",489).
component("YGL187C",488).
component("YDL067C",301).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",347).
component("YPL266W",979).
component("YPL273W",980).
component("YLL062C",723).
component("YDR410C",388).
component("YKR069W",712).
component("YOL096C",888).
component("U47_",148).
component("YER091C",442).
component("YJR073C",657).
component("YGR157W",515).
component("YDR120C",353).
component("YML008C",777).
component("YOR074C",903).
component("YDL033C",295).
component("YOL096C",889).
component("YLR172C",742).
component("YLR058C",730).
component("YDR019C",335).
component("YBR176W",252).
component("YDR408C",387).
component("YMR120C",806).
component("YLR028C",725).
component("YBL013W",206).
component("YJL130C",630).
component("YJL088W",623).
component("YKL024C",673).
component("YPR074C",996).
component("YBR117C",242).
component("YLR354C",766).
component("YGR043C",502).
component("YMR108W",804).
component("YCL009C",272).
component("YMR062C",799).
component("YNL071W",833).
component("YNR008W",860).
component("YIL160C",605).
component("YNR019W",863).
component("YCR048W",288).
component("U48_",149).
component("YNL277W",852).
component("YMR062C",800).
component("YDR232W",367).
component("YPL231W",973).
component("YER061C",429).
component("YPL001W",946).
component("YDL052C",299).
component("U8_",188).
component("YDR148C",361).
component("YOR377W",941).
component("YGR177C",518).
component("YPL231W",974).
component("YPL028W",949).
component("YLR299W",754).
component("YGL017W",472).
component("YCR005C",280).
component("YML126C",791).
component("YNL104C",836).
component("YDL182W",325).
component("YDL131W",311).
component("YPR160W",1004).
component("YDR307W",376).
component("YLR258W",751).
component("YFR015C",459).
component("YPL227C",970).
component("YNL029C",828).
component("YIL085C",592).
component("YNL192W",842).
component("YBR038W",230).
component("YBR023C",226).
component("YEL011W",402).
component("YMR306W",825).
component("YLR342W",764).
component("YGR032W",500).
component("YPR183W",1008).
component("YBR248C",261).
component("YLR209C",745).
component("U104_",24).
component("U103_",23).
component("YOR209C",921).
component("YMR300C",823).
component("YER055C",424).
component("YDR354W",381) :- not remove_orf("YDR354W",381).
component("YFR047C",463).
component("YJR133W",665).
component("U22_",125).
component("YLR209C",746).
component("YML022W",779).
component("YDR441C",391).
component("YHR128W",566).
component("YPR176C",1007).
component("YPL172C",962).
component("YNR041C",867).
component("YMR101C",802).
component("YDL090C",307).
component("YBR003W",218).
component("YBR002C",217).
component("YJL167W",638).
component("YJL167W",639).
component("YNL256W",847).
component("YPR069C",993).
component("YDR127W",356).
component("YHR190W",576).
component("YLR146C",739).
component("YPL214C",968).
component("YHR068W",558).
component("YLR303W",756).
component("YGR012W",498).
component("YML082W",787).
component("YJR130C",664).
component("YLR303W",757).
component("YDR035W",337).
component("YBR249C",262).
component("YLR180W",744).
component("YDR502C",395).
component("YOR274W",927).
component("YOL143C",896).
component("YBR256C",264).
component("YHR137W",567).
component("YGL202W",490).
component("YLR027C",724).
component("YKL106W",682).
component("YOL140W",895).
component("YLR438W",774).
component("YGR019W",499).
component("YLR089C",734).
component("YDR111C",352).
component("U64_",162).
component("U61_",159).
component("U51_",151).
component("YJR148W",668).
component("YHR208W",579).
component("YFL030W",454).
component("YOR184W",914).
component("YNR058W",871).
component("YIL116W",598).
component("YGL253W",495).
component("YFR053C",464).
component("YOL136C",894).
component("YIL107C",595).
component("YMR013C",795).
component("YMR205C",815).
component("YGR240C",528).
component("YOL016C",875).
component("YFR014C",458).
component("YLR240W",749).
component("YKL203C",700).
component("YJR066W",656).
component("YCR036W",287).
component("YGR194C",522).
component("YCL040W",276).
component("U15_",69).
component("YPL188W",964).
component("YJR049C",652).
component("YEL041W",407).
component("U96_",193).
component("YKL001C",671).
component("YDR236C",368).
component("YML070W",785).
component("YFL053W",456).
component("YHL032C",542).
component("YDR531W",399).
component("U83_",182).
component("U82_",181).
component("U81_",180).
component("YMR208W",816).
component("YPL203W",965).
component("YOR061W",901).
component("YKL166C",690).
component("YJL164C",637).
component("YIL035C",585).
component("YHR205W",578).
component("YHR102W",564).
component("YGL019W",473).
component("YHR025W",550).
component("YOR347C",935).
component("YAL038W",199).
component("YNR012W",861).
component("YPR121W",1001).
component("YPL258C",976).
component("YOL055C",880).
component("YPL214C",969).
component("U1_",105).
component("YDR009W",334).
component("YDR127W",357).
component("U21_",117).
component("U20_",114).
component("YDR147W",360).
component("YDR300C",375).
component("YCR012W",281).
component("YER052C",422).
component("YER069W",433).
component("U19_",104).
component("YKL024C",674).
component("U18_",94).
component("U17_",84).
component("U76_",174).
component("YER170W",447).
component("YDR226W",366).
component("YKL067W",680).
component("YOL055C",881).
component("YDR454C",392).
component("YJR057W",654).
component("YOL061W",885).
component("YKL181W",692).
component("YHL011C",540).
component("YER099C",443).
component("YBL068W",214).
component("YOR143C",910).
component("YNL256W",848).
component("YLR328W",762).
component("YBR018C",221).
component("YBR018C",222).
component("YGR007W",497).
component("YGR202C",523).
component("YLR328W",763).
component("YDL045C",297).
component("U80_",179).
component("YDL103C",310).
component("U94_",192).
component("YJR010W",647).
component("YBR029C",227).
component("YCL050C",277).
component("YGL130W",484).
component("YDR530C",398).
component("YCL050C",278).
component("YPR190C",1010).
component("YPR187W",1009).
component("YPR110C",999).
component("YPR010C",986).
component("YOR341W",934).
component("YOR340C",933).
component("YOR224C",925).
component("YOR210W",922).
component("YOR207C",919).
component("YOR151C",911).
component("YOR116C",905).
component("YOL005C",873).
component("YNR003C",859).
component("YNL248C",846).
component("YNL151C",840).
component("YNL113W",837).
component("YKL144C",686).
component("YJR063W",655).
component("YJL148W",634).
component("YJL140W",633).
component("YIL021W",584).
component("YHR143W-A",568).
component("YGL070C",481).
component("YFL036W",455).
component("YDR404C",386).
component("YDR156W",362).
component("YDR045C",340).
component("YDL150W",319).
component("YDL140C",313).
component("YBR154C",250).
component("YPR175W",1006).
component("YPL167C",960).
component("YOR330C",930).
component("YOL115W",892).
component("YNL299W",856).
component("YNL262W",850).
component("YNL102W",835).
component("YJR043C",651).
component("YJR006W",645).
component("YJL090C",624).
component("YIL139C",601).
component("YEL055C",410).
component("YDR419W",389).
component("YDR121W",354).
component("YDL102W",309).
component("YCR014C",282).
component("YBR278W",267).
component("YBL035C",210).
component("YKL035W",677).
component("YHL012W",541).
component("YHR123W",565).
component("YPR113W",1000).
component("YBR243C",259).
component("YDL142C",318).
component("YPL148C",958).
component("YER026C",419).
component("YGR286C",537).
component("YJL068C",619).
component("YHR189W",575).
component("YDR058C",345).
component("YNR034W",866).
component("YHR163W",571).
component("YGR248W",530).
component("YCR073W-A",290).
component("YDL086W",306).
component("YOL011W",874).
component("YMR008C",793).
component("YMR006C",792).
component("U105_",25).
component("YBL015W",207).
component("YJL068C",620).
component("YJR019C",649).
component("YOR040W",900).
component("U84_",183).
component("U77_",175).
component("YDR481C",393).
component("YLR377C",769).
component("YDR074W",348).
component("YFR025C",460).
component("YPL179W",963).
component("YNR032W",864).
component("YML057W",784).
component("YML016C",778).
component("YLR433C",773).
component("YGR123C",511).
component("YER133W",445).
component("YER089C",440).
component("YDR436W",390).
component("YDR075W",349).
component("YDL188C",326).
component("YDL134C",312).
component("YDL047W",298).
component("YDL006W",291).
component("YBR125C",245).
component("YBL056W",213).
component("YPR073C",994).
component("YHR215W",580).
component("YDL024C",294).
component("YBR093C",239).
component("YBR092C",238).
component("YAR071W",203).
component("YIL053W",588).
component("YER062C",430).
component("YHR046C",554).
component("U9_",196).
component("YPL228W",971).
component("YMR180C",812).
component("YDL236W",330).
component("YJL155C",636).
component("YPR073C",995).
component("YOR208W",920).
component("YNL053W",832).
component("YMR036C",797).
component("YIR026C",611).
component("YIL113W",597).
component("YFR028C",461).
component("YER075C",436).
component("YDL230W",329).
component("YBR276C",266).
component("U34_",137).
component("U33_",136).
component("U32_",135).
component("U31_",134).
...
component("U25_",128).
component("U24_",127).
component("YHR044C",553).
component("YHR043C",552).
component("YOL064C",886).
component("YOR360C",938).
component("YGL248W",494).
component("YKR031C",708).
component("YPL206C",966).
component("YGL027C",475).
component("YLR286C",753).
component("YJR153W",669).
component("YJL221C",644).
component("YJL216C",642).
component("YIL172C",609).
component("YGR292W",539).
component("YGR287C",538).
component("YBR299W",271).
component("YBR184W",253).
component("YIL162W",606).
component("YPR026W",987).
component("YDR001C",332).
component("YBR001C",216).
component("YIR019C",610).
component("YIL099W",594).
component("YDL037C",296).
component("YOR190W",916).
component("YLR300W",755).
component("YGR282C",536).
component("YDR261C",371).
component("YDR400W",384).
component("U23_",126).
component("YML035C",780).
component("YJL070C",621).
component("YBR284W",268).
component("U106_",26).
component("U102_",22).
component("YER043C",421).
component("YNL045W",830).
component("YGL037C",476).
component("YDR242W",369).
component("YLR308W",761).
component("YLR307W",760).
component("YBR208C",255).
component("YMR281W",822).
component("U53_",153).
component("YIR032C",612).
component("YPR062W",992).
component("YMR120C",807).
component("YLR028C",726).
component("YHR144C",569).
component("YHR144C",570).
component("YGR267C",535).
component("YCL030C",275).
component("YBL033C",209).
component("YBR153W",249).
component("YNL141W",838).
component("YLR245C",750).
component("YML035C",781).
component("YGR204W",525).
component("YBR084W",235).
component("YJL126W",628).
component("U44_",145).
component("YDL100C",308).
component("U87_",185).
component("U40_",143).
component("U39_",141).
component("YBR011C",220).
component("YHR201C",577).
component("YBR111C",240).
component("YBR252W",263).
component("YPR080W",997).
component("YOR187W",915).
component("YOR133W",908).
component("YLR069C",732).
component("YKR084C",714).
component("YKL173W",691).
component("YJL102W",626).
component("YDR385W",383).
component("YBR118W",243).
component("YER005W",415).
component("YLL001W",717).
component("YIL048W",587).
component("YER166W",446).
component("YDR093W",351).
component("YAL026C",198).
component("YBL099W",215).
component("U60_",158).
component("YLR231C",747).
component("U88_",186).
component("YDR538W",401).
component("YLR134W",736).
component("YLR044C",728).
component("YGR087C",507).
component("YDR380W",382).
component("YDL080C",303).
component("U98_",194).
component("YMR250W",819).
component("YKL184W",696).
component("YOR128C",906).
component("YEL021W",405).
component("YNR043W",868).
component("U93_",191).
component("YDR047W",342).
component("U54_",154).
component("YKL211C",702) :- not remove_orf("YKL211C",702).
component("YKR097W",716).
component("YOL052C",879).
component("YNL169C",841).
component("YGR170W",516).
component("YKL060C",679).
component("YNL256W",849).
component("YDR294C",373).
component("YEL046C",408).
component("YNR033W",865).
component("YPR006C",985).
component("YER065C",431).
component("YKL211C",703) :- not remove_orf("YKL211C",703).
component("YER090W",703) :- not remove_orf("YER090W",703).
component("YER090W",441) :- not remove_orf("YER090W",441).
component("YDR127W",358).
component("YPL281C",983).
component("YOR393W",945).
component("YMR323W",826).
component("YHR174W",572).
component("YGR254W",531).
component("YOR202W",918).
component("YPL262W",977).
component("YGL026C",474) :- not remove_orf("YGL026C",474).
component("YGR155W",514).
component("YLR304C",758).
component("YJL200C",640).
component("YGL009C",469).
component("YNL316C",857).
component("YKL182W",694).
component("YPL212C",967).
component("YNL292W",855).
component("YGL063W",480).
component("YFL001W",450).
component("YPR002W",984).
component("YJR016C",648).
component("YCR053W",289).
component("YDR127W",359).
component("YGL148W",485).
component("YIL168W",608).
component("YIL167W",607).
component("YCL064C",279).
component("YER086W",438).
component("YLR359W",768).
component("YAL012W",197).
component("YML004C",776).
component("YFR055W",465).
component("YJL005W",615).
component("YJL121C",627).
component("YBR019C",223).
component("YBR019C",224).
component("YDR050C",343).
component("YIL020C",583).
component("YDR007W",333) :- not remove_orf("YDR007W",333).
component("YOR095C",904).
component("YER003C",414).
component("YBR196C",254).
component("YGL001C",467).
component("YPL117C",956).
component("U14_",61).
component("YOL056W",882).
component("YKL152C",689).
component("YDL021W",292).
component("YMR105C",803).
component("YKL127W",684).
component("YEL058W",411).
component("YPR060C",991).
component("YHR072W",559).
component("YJL153C",635).
component("YPL097W",954).
component("YGR185C",520).
component("YGR264C",534).
component("YGR171C",517).
component("YHR011W",546).
component("YDR023W",336).
component("YPL104W",955).
component("YLL018C",718).
component("YPR081C",998).
component("YBR121C",244).
component("YHR020W",549).
component("YER087W",439).
component("YNL247W",845).
component("YOL033W",877).
component("YOR168W",912).
component("YOL097C",890).
component("YDR268W",372).
component("YPR047W",990).
component("YLR060W",731).
component("YFL022C",453).
component("YPR033C",988).
component("YHR019C",547).
component("YCR024C",283).
component("YHR019C",548).
component("YKL194C",699).
component("YIL078W",591).
component("YPL160W",959).
component("YLR382C",770).
component("YNL073W",834).
component("YDR037W",338).
component("YOR335C",931).
component("YGR094W",509).
component("YLR153C",740).
component("YAL054C",200).
component("YOR317W",928).
component("YMR246W",818).
component("YIL009W",582).
component("YER015W",417).
component("YOR142W",909).
component("YGR244C",529).
component("YPR035W",989).
component("YIL145C",602).
component("U89_",187).
component("YOR339C",932).
component("YMR022W",796).
component("YLR306W",759).
component("YKL210W",701).
component("YGR133W",513).
component("YGL058W",478).
component("YER100W",444).
component("YEL012W",403).
component("YDR177W",364).
component("YDR092W",350).
component("YDR059C",346).
component("YDR054C",344).
component("YDL064W",300).
component("YBR082C",233).
component("YJL101C",625).
component("YOL049W",878).
component("YAR015W",202).
component("YGL234W",492).
component("YER183C",449).
component("U91_",190).
component("U90_",189).
component("YNR057C",870).
component("YDL141W",314).
component("YDL141W",315).
component("YGL234W",493).
component("YDL141W",316).
component("YJR103W",661).
component("YBL039C",211).
component("YGR204W",526).
component("YBR084W",236).
component("YNL220W",843).
component("YOL058W",883).
component("YBR208C",256).
component("YDL141W",317).
component("YHR074W",560).
component("YMR217W",817).
component("YGR061C",505).
component("YPR145W",1003).
component("YGR124W",512).
component("YJR109C",663).
component("YJL130C",631).
component("YGL062W",479).
component("YBR218C",257).
component("YPL231W",975).
component("YNR016C",862).
component("YKL182W",695).
component("YGR037C",501).
component("YJL087C",622).
component("YPR138C",1002).
component("YPL265W",978).
component("YPL134C",957).
component("YPL057C",951).
component("YPL036W",950).
component("YOR348C",936).
component("YOR222W",924).
component("YOR192C",917).
component("YOR171C",913).
component("YOR130C",907).
component("YOR071C",902).
component("YOR011W",899).
component("YOL156W",898).
component("YOL103W",891).
component("YOL020W",876) :- not remove_orf("YOL020W",876).
component("YNR072W",872).
component("YNR056C",869).
component("YNL318C",858).
component("YNL270C",851).
component("YNL142W",839).
component("YMR272C",821).
component("YMR202W",814).
component("YMR056C",798).
component("YMR011W",794).
component("YLR348C",765).
component("YLR260W",752).
component("YLR237W",748).
component("YLR138W",737).
component("YLR100C",735).
component("YLR081W",733).
component("YLL061W",722).
component("YLL043W",720).
component("YKR093W",715).
component("YKR053C",710).
component("YKR039W",709) :- not remove_orf("YKR039W",709).
component("YKL217W",705).
component("YKL120W",683).
component("YKL004W",672).
component("YJR158W",670).
component("YJR095W",660).
component("YJR077C",658).
component("YJL219W",643).
component("YJL214W",641).
component("YJL134W",632).
component("YJL129C",629).
component("YIL134W",600).
component("YHR096C",563).
component("YHR094C",562).
component("YHR092C",561).
component("YHL036W",543).
component("YGR121C",510).
component("YGR065C",506).
component("YGR055W",503).
component("YGL186C",487).
component("YGL077C",482).
component("YGL008C",468).
component("YFL055W",457).
component("YFL011W",451).
component("YER060W-A",427).
component("YER060W",426).
component("YER056C",425).
component("YER053C",423).
component("YEL069C",413).
component("YEL063C",412).
component("YEL017C-A",404).
component("YDR536W",400).
component("YDR508C",397).
component("YDR503C",396).
component("YDR497C",394).
component("YDR345C",379).
component("YDR343C",378).
component("YDR342C",377).
component("YDR297W",374).
component("YDR046C",341) :- not remove_orf("YDR046C",341).
component("YDL245C",331).
component("YDL210W",327).
component("YCR032W",286).
component("YCR028C",285).
component("YCR024C-A",284).
component("YCL025C",274).
component("YBR298C",270).
component("YBR291C",269).
component("YBR085W",237).
component("YBR069C",232) :- not remove_orf("YBR069C",232).
component("YBR068C",231) :- not remove_orf("YBR068C",231).
component("YBR036C",229).
component("YBR021W",225).
component("YBL042C",212).
component("YBL030C",208).
component("U85_",184).
component("U7_",178).
component("U79_",177).
component("U78_",176).
...
catalyst(1960,342).
catalyst(3460,154).
catalyst(3600,702) :- not remove_reaction(3600,702).
catalyst(8000,716).
catalyst(3941,879).
catalyst(3942,879).
catalyst(6890,841).
...
catalyst(8020,985).
catalyst(8020,431).
catalyst(1890,703) :- not remove_reaction(1890,703).
catalyst(3630,703) :- not remove_reaction(3630,703).
catalyst(1890,441) :- not remove_reaction(1890,441).
catalyst(3630,441) :- not remove_reaction(3630,441).
catalyst(3740,358).
catalyst(8231,983).
catalyst(8232,983).
catalyst(8231,945).
...
catalyst(8061,977).
catalyst(8062,977).
catalyst(3590,474) :- not remove_reaction(3590,474).
catalyst(10910,474) :- not remove_reaction(10910,474).
catalyst(4570,514).
catalyst(8181,758).
catalyst(8182,758).
catalyst(8181,640).
...
catalyst(8282,343).
catalyst(3840,583).
catalyst(3610,333) :- not remove_reaction(3610,333).
catalyst(7921,904).
catalyst(7922,904).
catalyst(7841,414).
catalyst(7842,414).
...
catalyst(1210,898).
catalyst(1160,891).
catalyst(801,876) :- not remove_reaction(801,876).
catalyst(802,876) :- not remove_reaction(802,876).
catalyst(811,876) :- not remove_reaction(811,876).
catalyst(812,876) :- not remove_reaction(812,876).
catalyst(831,876) :- not remove_reaction(831,876).
catalyst(832,876) :- not remove_reaction(832,876).
catalyst(901,876) :- not remove_reaction(901,876).
catalyst(902,876) :- not remove_reaction(902,876).
catalyst(1180,872).
catalyst(1210,872).
catalyst(700,869).
catalyst(1200,858).
...
catalyst(650,715).
catalyst(6560,710).
catalyst(681,709) :- not remove_reaction(681,709).
catalyst(682,709) :- not remove_reaction(682,709).
...
catalyst(851,709) :- not remove_reaction(851,709).
catalyst(852,709) :- not remove_reaction(852,709).
...
catalyst(931,709) :- not remove_reaction(931,709).
catalyst(932,709) :- not remove_reaction(932,709).
...
catalyst(1210,377).
catalyst(6650,374).
catalyst(791,341) :- not remove_reaction(791,341).
catalyst(792,341) :- not remove_reaction(792,341).
catalyst(801,341) :- not remove_reaction(801,341).
catalyst(802,341) :- not remove_reaction(802,341).
catalyst(811,341) :- not remove_reaction(811,341).
catalyst(812,341) :- not remove_reaction(812,341).
catalyst(831,341) :- not remove_reaction(831,341).
catalyst(832,341) :- not remove_reaction(832,341).
catalyst(841,341) :- not remove_reaction(841,341).
catalyst(842,341) :- not remove_reaction(842,341).
catalyst(851,341) :- not remove_reaction(851,341).
catalyst(852,341) :- not remove_reaction(852,341).
catalyst(901,341) :- not remove_reaction(901,341).
catalyst(902,341) :- not remove_reaction(902,341).
catalyst(1180,331).
catalyst(1210,331).
catalyst(690,327).
catalyst(730,327).
...
catalyst(1512,269).
catalyst(1590,237).
catalyst(771,232) :- not remove_reaction(771,232).
catalyst(772,232) :- not remove_reaction(772,232).
...
catalyst(851,232) :- not remove_reaction(851,232).
catalyst(852,232) :- not remove_reaction(852,232).
...
catalyst(831,231) :- not remove_reaction(831,231).
catalyst(832,231) :- not remove_reaction(832,231).
catalyst(841,231) :- not remove_reaction(841,231).
catalyst(842,231) :- not remove_reaction(842,231).
...
modifiable_enzyme(703).
modifiable_enzyme(441).
modifiable_enzyme(474).
modifiable_enzyme(333).
modifiable_enzyme(876).
modifiable_enzyme(709).
modifiable_enzyme(341).
