...
component("YKR009C",338).
component("YOL086C",426).
component("YMR303C",389).
component("YGL256W",245).
...
component("YIL094C",288).
component("U45_",70).
component("YML056C",379).
component("YLR432W",376).
component("YHR216W",283).
component("YAR075W",101).
component("YAR073W",100).
component("YDR127W",169).
component("YOL126C",430).
component("YKL085W",328).
component("YDL078C",151).
component("YNL037C",393).
component("YCL018W",136).
component("YLR355C",373).
component("YDL174C",160).
component("YML086C",380).
component("YGR088W",252).
component("YDR256C",179).
component("YJR078W",320).
component("YJR025C",313).
component("U107_",23).
component("YJR104C",322).
component("YHR008C",268).
component("YJL026W",299).
component("YIL066C",286).
component("YGR180C",255).
component("YER070W",209).
component("U36_",65).
component("YDL168W",159).
component("YBR006W",109).
component("YPL276W",475).
component("YPL275W",474).
component("YOR388C",453).
component("U55_",77).
component("YER069W",208).
component("YOR323C",446).
component("YER178W",214).
component("YBR221C",128).
component("YIL125W",291).
component("U52_",75).
component("YBR166C",125).
component("YGL012W",228).
component("YKL216W",337).
component("YKR009C",339).
component("YIL160C",294).
component("YGL205W",242).
component("U100_",20).
component("YKR080W",344).
component("YER023W",202).
component("YGR204W",257).
component("YLR142W",357).
component("U65_",81).
component("U62_",80).
component("YHR068W",274).
component("YKL150W",331).
component("YIL043C",285).
component("YPL171C",463).
component("YHR179W",281).
component("YGR234W",259).
component("YPL017C",455).
component("YFL018C",216).
component("YDR353W",183).
component("YPR167C",487).
component("YNL052W",394).
component("YMR256C",388).
component("YLR395C",375).
component("YLR038C",350).
component("YIL111W",289).
...
component("Q0275",19).
component("Q0250",18).
component("YPL266W",473).
component("YKR069W",343).
component("U47_",72).
component("YJR073C",318).
component("YDL033C",149).
component("YLR172C",359).
component("YLR058C",353).
component("YDR019C",164).
component("YBR176W",126).
component("YDR408C",188).
component("YMR120C",385).
component("YLR028C",348).
component("YBL013W",102).
component("YJL130C",305).
component("YKL024C",326).
component("YPR074C",483).
component("YBR117C",121).
component("YCL009C",135).
component("YNL071W",396).
component("YIL160C",295).
component("U48_",73).
component("YPL231W",468).
component("YPL231W",469).
component("YPL028W",456).
component("YLR299W",367).
component("YGL017W",229).
component("YML126C",381).
component("YNL104C",398).
component("YDL182W",161).
component("YDL131W",155).
component("YLR258W",364).
component("YFR015C",221).
component("YNL029C",392).
component("YIL085C",287).
component("YMR306W",390).
component("YLR342W",372).
component("YGR032W",247).
component("YLR209C",360).
component("U104_",21).
component("YDR354W",184) :- not remove_orf("YDR354W",184).
component("YFR047C",223).
component("YLR209C",361).
component("YML022W",377).
component("YDR441C",190).
component("YJL167W",309).
component("YDR127W",170).
component("YHR068W",275).
component("YLR303W",369).
component("YGR012W",246).
component("YJR130C",323).
component("YDR035W",165).
component("YBR249C",129).
component("YOR274W",445).
component("YHR137W",277).
component("YGL202W",241).
component("YLR027C",347).
component("YKL106W",329).
component("YOL140W",431).
component("YLR089C",354).
component("U61_",79).
component("YJR148W",324).
component("YFL030W",217).
component("YNR058W",417).
component("YGL253W",244).
component("YFR053C",224).
component("YMR205C",387).
component("YGR240C",260).
component("YOL016C",420).
component("YFR014C",220).
component("YCR036W",145).
component("YCL040W",138).
component("YPL188W",464).
component("YJR049C",315).
component("YEL041W",197).
component("U96_",94).
component("YDR236C",177).
component("YHL032C",266).
component("U83_",91).
component("YOR347C",451).
component("YAL038W",98).
component("YNR012W",413).
component("YDR127W",171).
component("YDR147W",174).
component("YCR012W",140).
component("U76_",89).
component("YER170W",213).
component("YDR226W",176).
component("YKL067W",327).
component("YOL055C",423).
component("YDR454C",191).
component("YJR057W",316).
component("YOL061W",425).
component("YKL181W",333).
component("YHL011C",265).
component("YER099C",212).
component("YBL068W",107).
component("YOR143C",436).
component("YNL256W",406).
component("YBR018C",111).
component("YLR328W",371).
component("U94_",93).
component("YBR029C",113).
component("YGL130W",236).
component("YPR190C",490).
component("YPR187W",489).
component("YPR110C",484).
component("YPR010C",478).
component("YOR341W",450).
component("YOR340C",449).
component("YOR224C",444).
component("YOR210W",443).
component("YOR207C",441).
component("YOR151C",437).
component("YOR116C",434).
component("YOL005C",418).
component("YNR003C",412).
component("YNL248C",405).
component("YNL151C",402).
component("YNL113W",399).
component("YKL144C",330).
component("YJR063W",317).
component("YJL148W",308).
component("YJL140W",307).
component("YIL021W",284).
component("YHR143W-A",278).
component("YGL070C",234).
component("YFL036W",218).
component("YDR404C",187).
component("YDR156W",175).
component("YDR045C",166).
component("YDL150W",157).
component("YDL140C",156).
component("YBR154C",124).
component("YPR175W",488).
component("YPL167C",462).
component("YOR330C",447).
component("YOL115W",429).
component("YNL299W",410).
component("YNL262W",407).
component("YNL102W",397).
component("YJR043C",314).
component("YJR006W",311).
component("YJL090C",301).
component("YIL139C",292).
component("YEL055C",199).
component("YDR419W",189).
component("YDR121W",168).
component("YDL102W",154).
component("YCR014C",141).
component("YBR278W",132).
component("YBL035C",105).
component("YPR113W",485).
component("YPL148C",461).
component("YGR286C",264).
component("YOL011W",419).
component("YMR008C",383).
component("YMR006C",382).
component("U105_",22).
component("YBL015W",103).
component("U77_",90).
component("YLR377C",374).
component("YPR073C",481).
component("YHR215W",282).
component("YDL024C",148).
component("YBR093C",119).
component("YBR092C",118).
component("YHR046C",272).
component("U9_",96).
component("YPR073C",482).
component("YOR208W",442).
component("YNL053W",395).
component("YMR036C",384).
component("YIR026C",298).
component("YIL113W",290).
component("YFR028C",222).
component("YER075C",210).
component("YDL230W",162).
component("YBR276C",131).
component("U34_",64).
component("U31_",63).
component("U30_",62).
component("U29_",61).
component("U26_",60).
component("U24_",59).
component("YHR044C",271).
component("YHR043C",270).
component("YOR360C",452).
component("YKR031C",340).
component("YPL206C",465).
component("YGL027C",231).
component("YLR286C",366).
component("YJR153W",325).
component("YOR190W",440).
component("YLR300W",368).
component("YGR282C",263).
component("YDR261C",180).
component("YDR400W",186).
component("YML035C",378).
component("YJL070C",300).
component("YBR284W",133).
component("YER043C",203).
component("YDR242W",178).
component("U53_",76).
component("YPR062W",480).
component("YMR120C",386).
component("YLR028C",349).
component("YHR144C",279).
component("YBL033C",104).
component("YNL141W",400).
component("YLR245C",363).
component("YBR084W",116).
component("YJL126W",303).
component("YDL100C",153).
component("U40_",68).
component("U39_",66).
component("YBR011C",110).
component("YBR111C",120).
component("YBR252W",130).
component("YER005W",201).
component("YBL099W",108).
component("YLR231C",362).
component("YLR134W",356).
component("YLR044C",351).
component("YGR087C",251).
component("YDR380W",185).
component("YDL080C",152).
component("U98_",95).
component("YOR128C",435).
component("YKL211C",335) :- not remove_orf("YKL211C",335).
component("YKR097W",345).
component("YNL169C",403).
component("YEL046C",198).
component("YNR033W",415).
component("YKL211C",336) :- not remove_orf("YKL211C",336).
component("YER090W",336) :- not remove_orf("YER090W",336).
component("YER090W",211) :- not remove_orf("YER090W",211).
component("YDR127W",172).
component("YPL281C",476).
component("YOR393W",454).
component("YMR323W",391).
component("YHR174W",280).
component("YGR254W",261).
component("YPL262W",471).
component("YGL026C",230) :- not remove_orf("YGL026C",230).
component("YLR304C",370).
component("YJL200C",310).
component("YNL316C",411).
component("YPL212C",466).
component("YNL292W",409).
component("YGL063W",233).
component("YFL001W",215).
component("YPR002W",477).
component("YJR016C",312).
component("YCR053W",146).
component("YDR127W",173).
component("YGL148W",237).
component("YIL168W",297).
component("YIL167W",296).
component("YCL064C",139).
component("YAL012W",97).
component("YBR019C",112).
component("YDR007W",163) :- not remove_orf("YDR007W",163).
component("YOR095C",433).
component("YGL001C",226).
component("YPL117C",460).
component("YOL056W",424).
component("YKL152C",332).
component("YDL021W",147).
component("YPR060C",479).
component("YPL097W",458).
component("YGR185C",256).
component("YGR264C",262).
component("YGR171C",254).
component("YPL104W",459).
component("YLL018C",346).
component("YNL247W",404).
component("YOR168W",438).
component("YOL097C",427).
component("YDR268W",181).
component("YCR024C",142).
component("YHR019C",269).
component("YOR335C",448).
component("YLR153C",358).
component("YAL054C",99).
component("YIL145C",293).
component("YJL101C",302).
component("YOL049W",422).
component("U90_",92).
component("YNR057C",416).
component("YGL234W",243).
component("YJR103W",321).
component("YBL039C",106).
component("YGR204W",258).
component("YBR084W",117).
component("YHR074W",276).
component("YGL062W",232).
component("YBR218C",127).
component("YPL231W",470).
component("YNR016C",414).
component("YKL182W",334).
component("YGR037C",248).
component("YPR138C",486).
component("YPL265W",472).
component("YPL036W",457).
component("YOR171C",439).
component("YOR011W",432).
component("YOL103W",428).
component("YOL020W",421) :- not remove_orf("YOL020W",421).
component("YNL270C",408).
component("YNL142W",401).
component("YLR260W",365).
component("YLR100C",355).
component("YKR053C",342).
component("YKR039W",341) :- not remove_orf("YKR039W",341).
component("YJR077C",319).
component("YJL134W",306).
component("YJL129C",304).
component("YHL036W",267).
component("YGR121C",253).
component("YGR065C",250).
component("YGR055W",249).
component("YGL186C",238).
component("YGL077C",235).
component("YGL008C",227).
component("YFL055W",219).
component("YER060W-A",207).
component("YER060W",206).
component("YER056C",205).
component("YER053C",204).
component("YEL063C",200).
component("YEL017C-A",196).
component("YDR536W",195).
component("YDR508C",194).
component("YDR503C",193).
component("YDR497C",192).
component("YDR297W",182).
component("YDR046C",167) :- not remove_orf("YDR046C",167).
component("YCR032W",144).
component("YCR024C-A",143).
component("YCL025C",137).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,184) :- not remove_reaction(3620,184).
catalyst(2190,223).
catalyst(5791,361).
catalyst(5792,361).
catalyst(5801,361).
...
catalyst(6111,435).
catalyst(6112,435).
catalyst(3600,335) :- not remove_reaction(3600,335).
catalyst(8000,345).
catalyst(6890,403).
catalyst(4560,198).
catalyst(2550,415).
...
catalyst(7751,112).
catalyst(7752,112).
catalyst(3610,163) :- not remove_reaction(3610,163).
catalyst(7921,433).
catalyst(7922,433).
catalyst(6370,226).
catalyst(6461,460).
...
catalyst(6330,355).
catalyst(6560,342).
catalyst(771,341) :- not remove_reaction(771,341).
catalyst(772,341) :- not remove_reaction(772,341).
catalyst(781,341) :- not remove_reaction(781,341).
catalyst(782,341) :- not remove_reaction(782,341).
...
catalyst(881,341) :- not remove_reaction(881,341).
catalyst(882,341) :- not remove_reaction(882,341).
catalyst(901,341) :- not remove_reaction(901,341).
catalyst(902,341) :- not remove_reaction(902,341).
catalyst(931,341) :- not remove_reaction(931,341).
catalyst(932,341) :- not remove_reaction(932,341).
catalyst(1191,341) :- not remove_reaction(1191,341).
catalyst(1192,341) :- not remove_reaction(1192,341).
catalyst(1581,319).
catalyst(1582,319).
catalyst(6560,306).
catalyst(361,304).
...
catalyst(851,167) :- not remove_reaction(851,167).
catalyst(852,167) :- not remove_reaction(852,167).
catalyst(901,167) :- not remove_reaction(901,167).
catalyst(902,167) :- not remove_reaction(902,167).
catalyst(431,144).
catalyst(432,144).
catalyst(220,143).
catalyst(771,137).
...
catalyst(851,115) :- not remove_reaction(851,115).
catalyst(852,115) :- not remove_reaction(852,115).
catalyst(901,115) :- not remove_reaction(901,115).
catalyst(902,115) :- not remove_reaction(902,115).
...
catalyst(851,114) :- not remove_reaction(851,114).
catalyst(852,114) :- not remove_reaction(852,114).
catalyst(901,114) :- not remove_reaction(901,114).
catalyst(902,114) :- not remove_reaction(902,114).
catalyst(2920,88).
catalyst(2920,87).
catalyst(2920,86).
catalyst(2920,85).
