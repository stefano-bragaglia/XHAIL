...
component("YNL280C",735).
component("YLR056W",631).
component("YGR060W",438).
component("YGL012W",409).
component("YKR009C",611).
component("YOL086C",763).
component("YMR303C",708).
component("YMR083W",690).
component("YGL256W",431).
component("YDL168W",282).
component("YBR145W",214).
component("YPL231W",829).
component("YBR265W",232).
component("U46_",129).
component("YBR149W",215).
component("YBR149W",216).
component("YGL001C",406).
component("YIL094C",513).
component("U45_",128).
component("YML056C",677).
component("YLR432W",667).
component("YHR216W",504).
component("YAR075W",184).
component("YAR073W",183).
component("YDR127W",309).
component("YJR139C",578).
component("YML075C",679).
component("YLR450W",670).
component("YOL126C",769).
component("YKL085W",589).
component("YDL078C",265).
component("YKL029C",585).
component("YNL037C",713).
component("YNL009W",711).
component("YLR174W",644).
component("YHR183W",497).
component("YGR256W",460).
component("YNL241C",728).
component("YOL059W",760).
component("YDL022W",257).
component("YCL018W",240).
component("YLR355C",662).
component("YIL074C",510).
component("YER081W",380).
component("YDL174C",286).
component("YML086C",681).
component("YIL155C",522).
component("YEL024W",355).
component("YKR066C",616).
component("YGR088W",442).
component("YDR256C",323).
component("YKL026C",584).
component("YIR037W",532).
component("YBR244W",227).
component("YJR078W",571).
component("U58_",138).
component("YJR025C",563).
component("U107_",26).
component("YGR255C",459).
component("U108_",27).
component("YHR007C",471).
component("YDR402C",337).
component("YGL055W",416).
component("YJR104C",573).
component("YHR008C",472).
component("YOR384W",807).
component("YOR381W",806).
component("YOL152W",771).
component("YLL051C",624).
component("YJL026W",534).
component("YIL066C",509).
component("YGR180C",449).
component("YER070W",377).
component("U37_",122).
component("U36_",121).
component("U35_",120).
component("YDL168W",283).
component("YDR158W",317).
component("YJR009C",560).
component("YJL052W",536).
component("YGR192C",451).
component("YBR006W",194).
component("YPL276W",837).
component("YPL275W",836).
component("YOR388C",808).
component("YPL061W",814).
component("YOR374W",804).
component("YER073W",378).
component("YGL154C",423).
component("YBR115C",210).
component("U55_",137).
component("YER069W",375).
component("YOR323C",796).
component("YMR170C",699).
component("YMR169C",698).
component("YER178W",390).
component("YBR221C",225).
component("YIL125W",518).
component("U52_",134).
component("YBR166C",219).
component("YNL280C",736).
component("YGL012W",410).
component("YKL182W",599).
component("YKL216W",609).
component("YDR044W",299).
component("YER014W",365).
component("YKR009C",612).
component("YIL160C",523).
component("YGL205W",428).
component("YMR118C",693).
component("YLR164W",642).
component("YLL041C",622).
component("YKL148C",594).
component("YKL141W",592).
component("YJL045W",535).
component("YDR178W",318).
component("YEL047C",358).
component("YDL171C",284).
component("YDL171C",285).
component("YOR375C",805).
component("YDL215C",290).
component("YAL062W",180).
component("U99_",174).
component("U100_",21).
component("YBR035C",201).
component("YKR080W",618).
component("YER023W",366).
component("YOR236W",794).
component("YGR204W",453).
component("YIR034C",531).
component("YLR142W",639).
component("U65_",145).
component("U63_",143).
component("U62_",142).
component("YHR068W",482).
component("YKL150W",595).
component("YIL043C",507).
component("YHR042W",477).
component("YOR221C",791).
component("YMR145C",696).
component("YKL192C",603).
component("YKL055C",587).
component("YER061C",373).
component("YDL085W",267).
component("YPL171C",822).
component("YHR179W",496).
component("YMR145C",697).
component("YML120C",682).
component("YKL192C",604).
component("YDL085W",268).
component("YGR234W",455).
component("YFR030W",402).
component("YPL017C",811).
component("YFL018C",394).
component("YDR353W",333).
component("YPR167C",853).
component("YJR137C",577).
component("YNL052W",715).
component("YMR256C",705).
component("YLR395C",666).
component("YLR038C",629).
component("YIL111W",515).
component("YHR051W",481).
component("YGL191W",426).
component("YGL187C",425).
component("YDL067C",264).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",304).
component("YPL266W",835).
component("YKR069W",617).
component("YOL096C",764).
component("U47_",130).
component("YER091C",385).
component("YJR073C",569).
component("YGR157W",447).
component("YDR120C",307).
component("YML008C",672).
component("YOR074C",776).
component("YDL033C",259).
component("YOL096C",765).
component("YLR172C",643).
component("YLR058C",632).
component("YDR019C",296).
component("YBR176W",220).
component("YDR408C",339).
component("YMR120C",694).
component("YLR028C",627).
component("YBL013W",185).
component("YJL130C",545).
component("YJL088W",539).
component("YKL024C",583).
component("YPR074C",848).
component("YBR117C",211).
component("YMR108W",692).
component("YCL009C",239).
component("YNL071W",717).
component("YNR008W",741).
component("YIL160C",524).
component("YNR019W",744).
component("YCR048W",253).
component("U48_",131).
component("YMR062C",689).
component("YDR232W",320).
component("YPL231W",830).
component("YER061C",374).
component("YPL001W",810).
component("YDL052C",263).
component("U8_",168).
component("YDR148C",315).
component("YPL231W",831).
component("YPL028W",812).
component("YLR299W",654).
component("YGL017W",411).
component("YCR005C",245).
component("YML126C",683).
component("YNL104C",720).
component("YDL182W",287).
component("YDL131W",273).
component("YDR307W",329).
component("YLR258W",651).
component("YFR015C",400).
component("YNL029C",712).
component("YIL085C",512).
component("YNL192W",726).
component("YBR038W",202).
component("YBR023C",199).
component("YMR306W",709).
component("YLR342W",660).
component("YGR032W",435).
component("YPR183W",855).
component("YBR248C",228).
component("YLR209C",646).
component("U104_",23).
component("U103_",22).
component("YDR354W",334) :- not remove_orf("YDR354W",334).
component("YFR047C",403).
component("YJR133W",576).
component("YLR209C",647).
component("YML022W",674).
component("YDR441C",342).
component("YHR128W",491).
component("YJL167W",552).
component("YJL167W",553).
component("YPR069C",845).
component("YDR127W",310).
component("YHR190W",499).
component("YLR146C",640).
component("YHR068W",483).
component("YLR303W",656).
component("YGR012W",433).
component("YML082W",680).
component("YJR130C",575).
component("YDR035W",298).
component("YBR249C",229).
component("YLR180W",645).
component("YDR502C",346).
component("YOR274W",795).
component("YBR256C",231).
component("YHR137W",492).
component("YGL202W",427).
component("YLR027C",626).
component("YKL106W",590).
component("YOL140W",770).
component("YLR438W",669).
component("YGR019W",434).
component("YLR089C",635).
component("U64_",144).
component("U61_",141).
component("U51_",133).
component("YJR148W",579).
component("YHR208W",502).
component("YFL030W",396).
component("YOR184W",785).
component("YNR058W",750).
component("YIL116W",517).
component("YGL253W",430).
component("YFR053C",404).
component("YMR013C",687).
component("YMR205C",701).
component("YGR240C",456).
component("YOL016C",754).
component("YFR014C",399).
component("YLR240W",649).
component("YKL203C",606).
component("YJR066W",568).
component("YCR036W",252).
component("YCL040W",242).
component("U15_",61).
component("YPL188W",824).
component("YJR049C",565).
component("YEL041W",356).
component("U96_",172).
component("YKL001C",582).
component("YDR236C",321).
component("YHL032C",469).
component("YDR531W",350).
component("U83_",163).
component("U82_",162).
component("U81_",161).
component("YMR208W",702).
component("YPL203W",825).
component("YOR061W",775).
component("YKL166C",597).
component("YJL164C",551).
component("YIL035C",506).
component("YHR205W",501).
component("YHR102W",489).
component("YGL019W",412).
component("YHR025W",476).
component("YOR347C",801).
component("YAL038W",178).
component("YNR012W",742).
component("YDR009W",295).
component("YDR127W",311).
component("YDR147W",314).
component("YDR300C",328).
component("YCR012W",246).
component("YER069W",376).
component("U19_",93).
component("U18_",84).
component("U17_",75).
component("U76_",155).
component("YER170W",389).
component("YDR226W",319).
component("YKL067W",588).
component("YOL055C",757).
component("YDR454C",343).
component("YJR057W",566).
component("YOL061W",761).
component("YKL181W",598).
component("YHL011C",467).
component("YER099C",386).
component("YBL068W",192).
component("YOR143C",781).
component("YNL256W",731).
component("YLR328W",658).
component("YBR018C",196).
component("YGR007W",432).
component("YGR202C",452).
component("YLR328W",659).
component("YDL045C",261).
component("U80_",160).
component("YDL103C",272).
component("U94_",171).
component("YJR010W",561).
component("YBR029C",200).
component("YCL050C",243).
component("YGL130W",421).
component("YDR530C",349).
component("YPR190C",857).
component("YPR187W",856).
component("YPR110C",850).
component("YPR010C",840).
component("YOR341W",800).
component("YOR340C",799).
component("YOR224C",793).
component("YOR210W",790).
component("YOR207C",788).
component("YOR151C",782).
component("YOR116C",778).
component("YOL005C",752).
component("YNR003C",740).
component("YNL248C",730).
component("YNL151C",724).
component("YNL113W",721).
component("YKL144C",593).
component("YJR063W",567).
component("YJL148W",549).
component("YJL140W",548).
component("YIL021W",505).
component("YHR143W-A",493).
component("YGL070C",419).
component("YFL036W",397).
component("YDR404C",338).
component("YDR156W",316).
component("YDR045C",300).
component("YDL150W",281).
component("YDL140C",275).
component("YBR154C",218).
component("YPR175W",854).
component("YPL167C",821).
component("YOR330C",797).
component("YOL115W",768).
component("YNL299W",738).
component("YNL262W",733).
component("YNL102W",719).
component("YJR043C",564).
component("YJR006W",559).
component("YJL090C",540).
component("YIL139C",520).
component("YEL055C",359).
component("YDR419W",340).
component("YDR121W",308).
component("YDL102W",271).
component("YCR014C",247).
component("YBR278W",234).
component("YBL035C",188).
component("YKL035W",586).
component("YHL012W",468).
component("YHR123W",490).
component("YPR113W",851).
component("YBR243C",226).
component("YDL142C",280).
component("YPL148C",819).
component("YER026C",367).
component("YGR286C",464).
component("YHR189W",498).
component("YDR058C",303).
component("YDL086W",269).
component("YOL011W",753).
component("YMR008C",685).
component("YMR006C",684).
component("U105_",24).
component("YBL015W",186).
component("YJL068C",537).
component("YOR040W",774).
component("U77_",156).
component("YDR481C",344).
component("YLR377C",664).
component("YPL179W",823).
component("YNR032W",745).
component("YML057W",678).
component("YML016C",673).
component("YLR433C",668).
component("YGR123C",445).
component("YER133W",387).
component("YER089C",383).
component("YDR436W",341).
component("YDR075W",305).
component("YDL188C",288).
component("YDL134C",274).
component("YDL047W",262).
component("YDL006W",255).
component("YBR125C",213).
component("YBL056W",191).
component("YPR073C",846).
component("YHR215W",503).
component("YDL024C",258).
component("YBR093C",208).
component("YBR092C",207).
component("YAR071W",182).
component("YHR046C",480).
component("U9_",175).
component("YPL228W",828).
component("YMR180C",700).
component("YDL236W",292).
component("YJL155C",550).
component("YPR073C",847).
component("YOR208W",789).
component("YNL053W",716).
component("YMR036C",688).
component("YIR026C",530).
component("YIL113W",516).
component("YFR028C",401).
component("YER075C",379).
component("YDL230W",291).
component("YBR276C",233).
component("U34_",119).
component("U33_",118).
component("U32_",117).
component("U31_",116).
...
component("U25_",110).
component("U24_",109).
component("YHR044C",479).
component("YHR043C",478).
component("YOL064C",762).
component("YOR360C",803).
component("YKR031C",613).
component("YPL206C",826).
component("YGL027C",414).
component("YLR286C",653).
component("YJR153W",580).
component("YJL221C",558).
component("YJL216C",556).
component("YIL172C",528).
component("YGR292W",466).
component("YGR287C",465).
component("YBR299W",238).
component("YBR184W",221).
component("YIL162W",525).
component("YIR019C",529).
component("YIL099W",514).
component("YDL037C",260).
component("YOR190W",786).
component("YLR300W",655).
component("YGR282C",463).
component("YDR261C",324).
component("YDR400W",336).
component("U23_",108).
component("YML035C",675).
component("YJL070C",538).
component("YBR284W",235).
component("U106_",25).
component("YER043C",368).
component("YNL045W",714).
component("YGL037C",415).
component("YDR242W",322).
component("YBR208C",223).
component("YMR281W",707).
component("U53_",135).
component("YPR062W",844).
component("YMR120C",695).
component("YLR028C",628).
component("YHR144C",494).
component("YGR267C",462).
component("YBL033C",187).
component("YBR153W",217).
component("YNL141W",722).
component("YLR245C",650).
component("YML035C",676).
component("YBR084W",205).
component("YJL126W",543).
component("U44_",127).
component("YDL100C",270).
component("U87_",165).
component("U40_",125).
component("U39_",123).
component("YBR011C",195).
component("YHR201C",500).
component("YBR111C",209).
component("YBR252W",230).
component("YER005W",364).
component("YIL048W",508).
component("YER166W",388).
component("YDR093W",306).
component("YAL026C",177).
component("YBL099W",193).
component("U60_",140).
component("YLR231C",648).
component("U88_",166).
component("YDR538W",352).
component("YLR134W",637).
component("YLR044C",630).
component("YGR087C",441).
component("YDR380W",335).
component("YDL080C",266).
component("U98_",173).
component("YMR250W",704).
component("YKL184W",602).
component("YOR128C",779).
component("YEL021W",354).
component("YNR043W",747).
component("U93_",170).
component("U54_",136).
component("YKL211C",607) :- not remove_orf("YKL211C",607).
component("YKR097W",620).
component("YNL169C",725).
component("YNL256W",732).
component("YDR294C",326).
component("YEL046C",357).
component("YNR033W",746).
...
component("YPL281C",838).
component("YOR393W",809).
component("YMR323W",710).
component("YHR174W",495).
component("YGR254W",458).
component("YOR202W",787).
component("YPL262W",833).
component("YGL026C",413) :- not remove_orf("YGL026C",413).
component("YGR155W",446).
component("YLR304C",657).
component("YJL200C",554).
component("YNL316C",739).
component("YKL182W",600).
component("YPL212C",827).
component("YNL292W",737).
component("YGL063W",418).
component("YFL001W",392).
component("YPR002W",839).
component("YJR016C",562).
component("YCR053W",254).
component("YDR127W",313).
component("YGL148W",422).
component("YIL168W",527).
component("YIL167W",526).
component("YCL064C",244).
component("YER086W",381).
component("YLR359W",663).
component("YAL012W",176).
component("YML004C",671).
component("YFR055W",405).
component("YJL005W",533).
component("YJL121C",542).
component("YBR019C",197).
component("YDR050C",302).
component("YDR007W",294) :- not remove_orf("YDR007W",294).
component("YOR095C",777).
component("YER003C",363).
component("YBR196C",222).
component("YGL001C",407).
component("YPL117C",817).
component("U14_",53).
component("YOL056W",758).
component("YKL152C",596).
component("YDL021W",256).
component("YMR105C",691).
component("YKL127W",591).
component("YEL058W",360).
component("YPR060C",843).
component("YHR072W",484).
component("YPL097W",815).
component("YGR185C",450).
component("YGR264C",461).
component("YGR171C",448).
component("YHR011W",473).
component("YDR023W",297).
component("YPL104W",816).
component("YLL018C",621).
component("YPR081C",849).
component("YBR121C",212).
component("YHR020W",475).
component("YER087W",382).
component("YNL247W",729).
component("YOR168W",783).
component("YOL097C",766).
component("YDR268W",325).
component("YPR047W",842).
component("YLR060W",633).
component("YFL022C",395).
component("YCR024C",248).
component("YHR019C",474).
component("YKL194C",605).
component("YIL078W",511).
component("YPL160W",820).
component("YLR382C",665).
component("YNL073W",718).
component("YOR335C",798).
component("YGR094W",443).
component("YLR153C",641).
component("YAL054C",179).
component("YGR244C",457).
component("YPR035W",841).
component("YIL145C",521).
component("U89_",167).
component("YJL101C",541).
component("YOL049W",756).
component("YAR015W",181).
component("YER183C",391).
component("U90_",169).
component("YNR057C",749).
component("YDL141W",276).
component("YDL141W",277).
component("YGL234W",429).
component("YDL141W",278).
component("YJR103W",572).
component("YBL039C",189).
component("YGR204W",454).
component("YBR084W",206).
component("YNL220W",727).
component("YOL058W",759).
component("YDL141W",279).
component("YHR074W",485).
component("YMR217W",703).
component("YGR061C",439).
component("YJR109C",574).
component("YJL130C",546).
component("YGL062W",417).
component("YBR218C",224).
component("YPL231W",832).
component("YNR016C",743).
component("YKL182W",601).
component("YGR037C",436).
component("YPR138C",852).
component("YPL265W",834).
component("YPL134C",818).
component("YPL036W",813).
component("YOR348C",802).
component("YOR222W",792).
component("YOR171C",784).
component("YOR130C",780).
component("YOR011W",773).
component("YOL156W",772).
component("YOL103W",767).
component("YOL020W",755) :- not remove_orf("YOL020W",755).
component("YNR072W",751).
component("YNR056C",748).
component("YNL270C",734).
component("YNL142W",723).
component("YMR272C",706).
component("YMR011W",686).
component("YLR348C",661).
component("YLR260W",652).
component("YLR138W",638).
component("YLR100C",636).
component("YLR081W",634).
component("YLL061W",625).
component("YLL043W",623).
component("YKR093W",619).
component("YKR053C",615).
component("YKR039W",614) :- not remove_orf("YKR039W",614).
component("YKL217W",610).
component("YJR158W",581).
component("YJR077C",570).
component("YJL219W",557).
component("YJL214W",555).
component("YJL134W",547).
component("YJL129C",544).
component("YIL134W",519).
component("YHR096C",488).
component("YHR094C",487).
component("YHR092C",486).
component("YHL036W",470).
component("YGR121C",444).
component("YGR065C",440).
component("YGR055W",437).
component("YGL186C",424).
component("YGL077C",420).
component("YGL008C",408).
component("YFL055W",398).
component("YFL011W",393).
component("YER060W-A",372).
component("YER060W",371).
component("YER056C",370).
component("YER053C",369).
component("YEL069C",362).
component("YEL063C",361).
component("YEL017C-A",353).
component("YDR536W",351).
component("YDR508C",348).
component("YDR503C",347).
component("YDR497C",345).
component("YDR345C",332).
component("YDR343C",331).
component("YDR342C",330).
component("YDR297W",327).
component("YDR046C",301) :- not remove_orf("YDR046C",301).
component("YDL245C",293).
component("YDL210W",289).
component("YCR032W",251).
component("YCR028C",250).
component("YCR024C-A",249).
component("YCL025C",241).
component("YBR298C",237).
component("YBR291C",236).
component("YBR069C",204) :- not remove_orf("YBR069C",204).
component("YBR068C",203) :- not remove_orf("YBR068C",203).
component("YBR021W",198).
...
catalyst(2131,22).
catalyst(2132,22).
catalyst(3620,334) :- not remove_reaction(3620,334).
catalyst(2110,403).
catalyst(2190,403).
catalyst(5550,576).
catalyst(5791,647).
...
catalyst(1890,384) :- not remove_reaction(1890,384).
...
catalyst(8061,833).
catalyst(8062,833).
catalyst(3590,413) :- not remove_reaction(3590,413).
catalyst(10910,413) :- not remove_reaction(10910,413).
catalyst(4570,446).
catalyst(8181,657).
catalyst(8182,657).
catalyst(8181,554).
...
catalyst(1210,772).
catalyst(1160,767).
catalyst(801,755) :- not remove_reaction(801,755).
catalyst(802,755) :- not remove_reaction(802,755).
catalyst(811,755) :- not remove_reaction(811,755).
catalyst(812,755) :- not remove_reaction(812,755).
catalyst(831,755) :- not remove_reaction(831,755).
catalyst(832,755) :- not remove_reaction(832,755).
catalyst(901,755) :- not remove_reaction(901,755).
catalyst(902,755) :- not remove_reaction(902,755).
catalyst(1180,751).
catalyst(1210,751).
catalyst(700,748).
catalyst(931,734).
...
catalyst(640,619).
catalyst(6560,615).
catalyst(771,614) :- not remove_reaction(771,614).
catalyst(772,614) :- not remove_reaction(772,614).
catalyst(781,614) :- not remove_reaction(781,614).
catalyst(782,614) :- not remove_reaction(782,614).
catalyst(791,614) :- not remove_reaction(791,614).
catalyst(792,614) :- not remove_reaction(792,614).
catalyst(801,614) :- not remove_reaction(801,614).
catalyst(802,614) :- not remove_reaction(802,614).
catalyst(811,614) :- not remove_reaction(811,614).
catalyst(812,614) :- not remove_reaction(812,614).
catalyst(831,614) :- not remove_reaction(831,614).
catalyst(832,614) :- not remove_reaction(832,614).
catalyst(841,614) :- not remove_reaction(841,614).
catalyst(842,614) :- not remove_reaction(842,614).
catalyst(851,614) :- not remove_reaction(851,614).
catalyst(852,614) :- not remove_reaction(852,614).
catalyst(881,614) :- not remove_reaction(881,614).
catalyst(882,614) :- not remove_reaction(882,614).
catalyst(901,614) :- not remove_reaction(901,614).
catalyst(902,614) :- not remove_reaction(902,614).
catalyst(911,614) :- not remove_reaction(911,614).
catalyst(912,614) :- not remove_reaction(912,614).
catalyst(921,614) :- not remove_reaction(921,614).
catalyst(922,614) :- not remove_reaction(922,614).
catalyst(931,614) :- not remove_reaction(931,614).
catalyst(932,614) :- not remove_reaction(932,614).
catalyst(1191,614) :- not remove_reaction(1191,614).
catalyst(1192,614) :- not remove_reaction(1192,614).
catalyst(390,610).
catalyst(1180,581).
catalyst(1210,581).
catalyst(1581,570).
...
catalyst(851,301) :- not remove_reaction(851,301).
catalyst(852,301) :- not remove_reaction(852,301).
...
catalyst(1511,236).
catalyst(1512,236).
catalyst(771,204) :- not remove_reaction(771,204).
catalyst(772,204) :- not remove_reaction(772,204).
catalyst(791,204) :- not remove_reaction(791,204).
catalyst(792,204) :- not remove_reaction(792,204).
catalyst(801,204) :- not remove_reaction(801,204).
catalyst(802,204) :- not remove_reaction(802,204).
catalyst(811,204) :- not remove_reaction(811,204).
catalyst(812,204) :- not remove_reaction(812,204).
catalyst(851,204) :- not remove_reaction(851,204).
catalyst(852,204) :- not remove_reaction(852,204).
catalyst(901,204) :- not remove_reaction(901,204).
catalyst(902,204) :- not remove_reaction(902,204).
catalyst(791,203) :- not remove_reaction(791,203).
catalyst(792,203) :- not remove_reaction(792,203).
catalyst(801,203) :- not remove_reaction(801,203).
catalyst(802,203) :- not remove_reaction(802,203).
catalyst(811,203) :- not remove_reaction(811,203).
catalyst(812,203) :- not remove_reaction(812,203).
catalyst(831,203) :- not remove_reaction(831,203).
catalyst(832,203) :- not remove_reaction(832,203).
catalyst(841,203) :- not remove_reaction(841,203).
catalyst(842,203) :- not remove_reaction(842,203).
catalyst(851,203) :- not remove_reaction(851,203).
catalyst(852,203) :- not remove_reaction(852,203).
catalyst(901,203) :- not remove_reaction(901,203).
catalyst(902,203) :- not remove_reaction(902,203).
catalyst(620,198).
catalyst(540,190).
catalyst(2660,164).
catalyst(6960,159).
...
modifiable_enzyme(614).
modifiable_enzyme(301).
modifiable_enzyme(204).
