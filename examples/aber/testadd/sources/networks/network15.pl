...
component("YPL231W",161).
component("U46_",34).
component("U45_",33).
component("YDR127W",64).
component("YOL126C",151).
component("YDL078C",55).
component("YNL037C",138).
component("YML086C",135).
component("YJR078W",112).
component("U107_",19).
component("YER070W",85).
component("U36_",31).
component("YOR323C",153).
component("YIL125W",104).
component("U52_",35).
component("YBR166C",46).
component("YKL216W",121).
component("YKR009C",122).
component("YIL160C",106).
component("YGL205W",93).
component("YKR080W",124).
component("YER023W",81).
component("YLR142W",131).
component("YHR068W",100).
component("YKL150W",117).
component("YIL043C",103).
component("YPL266W",165).
component("YDL033C",54).
component("YLR058C",129).
component("YDR019C",60).
component("YBR176W",47).
component("YMR120C",136).
component("YLR028C",127).
component("YPR074C",168).
...
component("YDR354W",72) :- not remove_orf("YDR354W",72).
component("YFR047C",89).
component("YML022W",134).
component("YDR441C",75).
component("YJL167W",108).
component("YDR127W",65).
component("YDR035W",61).
component("YBR249C",48).
component("YHR137W",101).
component("YLR027C",126).
component("YKL106W",116).
component("YJR148W",114).
component("YNR058W",146).
component("YCR036W",53).
component("YNR012W",144).
component("YDR127W",66).
component("YDR226W",69).
component("YKL067W",115).
component("YDR454C",76).
component("YOL061W",148).
component("YKL181W",118).
component("YHL011C",99).
component("YER099C",87).
component("YBL068W",40).
component("YBR018C",41).
component("YPR175W",170).
component("YPL167C",160).
component("YOR330C",154).
component("YOL115W",150).
component("YNL299W",142).
component("YNL262W",141).
component("YNL102W",139).
component("YJR043C",110).
component("YJR006W",109).
component("YJL090C",107).
component("YIL139C",105).
component("YEL055C",80).
component("YDR419W",74).
...
component("U30_",30).
component("U24_",29).
component("YDR400W",73).
component("YDR242W",70).
component("U53_",36).
component("YLR028C",128).
component("U39_",32).
component("YBR111C",44).
component("YBR252W",49).
component("YLR231C",133).
component("YKL211C",119) :- not remove_orf("YKL211C",119).
component("YKL211C",120) :- not remove_orf("YKL211C",120).
component("YER090W",120) :- not remove_orf("YER090W",120).
component("YER090W",86) :- not remove_orf("YER090W",86).
component("YDR127W",67).
component("YPL281C",166).
component("YOR393W",156).
component("YMR323W",137).
component("YHR174W",102).
component("YGR254W",97).
component("YGL026C",90) :- not remove_orf("YGL026C",90).
component("YNL316C",143).
component("YDR127W",68).
component("YGL148W",91).
component("YAL012W",37).
component("YDR007W",59) :- not remove_orf("YDR007W",59).
component("YOR095C",152).
component("YPL117C",159).
component("YPR060C",167).
component("YPL097W",157).
component("YGR185C",96).
component("YGR264C",98).
component("YGR171C",95).
component("YPL104W",158).
component("YLL018C",125).
component("YOR335C",155).
component("YNR057C",145).
component("YJR103W",113).
component("YBL039C",39).
component("YPR138C",169).
component("YPL265W",164).
component("YOL103W",149).
component("YOL020W",147) :- not remove_orf("YOL020W",147).
component("YNL142W",140).
component("YLR100C",130).
component("YKR039W",123) :- not remove_orf("YKR039W",123).
component("YJR077C",111).
component("YGR121C",94).
component("YGL186C",92).
component("YFL055W",88).
component("YER060W-A",84).
component("YER060W",83).
component("YER056C",82).
component("YDR536W",79).
component("YDR508C",78).
component("YDR497C",77).
component("YDR297W",71).
...
catalyst(5601,132).
catalyst(5602,132).
catalyst(3620,72) :- not remove_reaction(3620,72).
catalyst(2190,89).
catalyst(5650,134).
catalyst(5650,75).
catalyst(6440,108).
...
catalyst(5730,49).
catalyst(3500,133).
catalyst(3600,119) :- not remove_reaction(3600,119).
...
catalyst(781,123) :- not remove_reaction(781,123).
catalyst(782,123) :- not remove_reaction(782,123).
...
catalyst(881,123) :- not remove_reaction(881,123).
catalyst(882,123) :- not remove_reaction(882,123).
catalyst(1191,123) :- not remove_reaction(1191,123).
catalyst(1192,123) :- not remove_reaction(1192,123).
catalyst(1581,111).
catalyst(1582,111).
catalyst(371,94).
catalyst(372,94).
