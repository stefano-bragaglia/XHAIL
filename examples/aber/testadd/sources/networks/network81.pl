...
component("YNL280C",502).
component("YLR056W",430).
component("YGL012W",270).
component("YKR009C",414).
component("YOL086C",521).
component("YMR303C",479).
component("YGL256W",290).
component("YDL168W",183).
component("YBR145W",140).
component("YPL231W",572).
component("YBR265W",151).
component("U46_",81).
component("YBR149W",141).
component("YBR149W",142).
component("YGL001C",267).
component("YIL094C",347).
component("U45_",80).
component("YML056C",462).
component("YLR432W",459).
component("YHR216W",341).
component("YAR075W",118).
component("YAR073W",117).
component("YDR127W",198).
component("YOL126C",526).
component("YKL085W",401).
component("YDL078C",173).
component("YNL037C",484).
component("YNL009W",482).
component("YLR174W",440).
component("YCL018W",158).
component("YLR355C",455).
component("YDL174C",186).
component("YML086C",464).
component("YGR088W",298).
component("YDR256C",209).
component("YJR078W",390).
component("YJR025C",383).
component("U107_",24).
component("YJR104C",392).
component("YHR008C",317).
component("YOR384W",556).
component("YOR381W",555).
component("YOL152W",528).
component("YLL051C",424).
component("YJL026W",361).
component("YIL066C",345).
component("YGR180C",301).
component("YER070W",246).
component("U36_",74).
component("YDL168W",184).
component("YBR006W",126).
component("YPL276W",580).
component("YPL275W",579).
component("YOR388C",557).
component("YOR374W",554).
component("YER073W",247).
component("YGL154C",282).
component("U55_",87).
component("YER069W",244).
component("YOR323C",547).
component("YER178W",253).
component("YBR221C",148).
component("YIL125W",351).
component("U52_",85).
component("YBR166C",144).
component("YGL012W",271).
component("YKL216W",413).
component("YKR009C",415).
component("YIL160C",355).
component("YGL205W",287).
component("YMR118C",471).
component("YLR164W",438).
component("YLL041C",423).
component("YKL148C",404).
component("YJL045W",362).
component("YDR178W",205).
component("YEL047C",233).
component("YDL171C",185).
component("U99_",112).
component("U100_",20).
component("YKR080W",420).
component("YER023W",238).
component("YOR236W",545).
component("YGR204W",303).
component("YLR142W",436).
component("U65_",93).
component("U63_",91).
component("U62_",90).
component("YHR068W",325).
component("YKL150W",405).
component("YIL043C",344).
component("YPL171C",567).
component("YHR179W",336).
component("YMR145C",474).
component("YML120C",465).
component("YKL192C",410).
component("YDL085W",175).
component("YGR234W",305).
component("YFR030W",264).
component("YPL017C",559).
component("YFL018C",257).
component("YDR353W",216).
component("YPR167C",592).
component("YJR137C",394).
component("YNL052W",485).
component("YMR256C",478).
component("YLR395C",458).
component("YLR038C",428).
component("YIL111W",348).
component("YHR051W",324).
component("YGL191W",285).
component("YGL187C",284).
component("YDL067C",172).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",578).
component("YKR069W",419).
component("YOL096C",522).
component("U47_",82).
component("YJR073C",388).
component("YDR120C",196).
component("YDL033C",171).
component("YLR172C",439).
component("YLR058C",431).
component("YDR019C",192).
component("YBR176W",145).
component("YDR408C",221).
component("YMR120C",472).
component("YLR028C",426).
component("YBL013W",119).
component("YJL130C",370).
component("YKL024C",399).
component("YPR074C",588).
component("YBR117C",139).
component("YCL009C",157).
component("YNL071W",487).
component("YIL160C",356).
component("U48_",83).
component("YPL231W",573).
component("YPL231W",574).
component("YPL028W",560).
component("YLR299W",448).
component("YGL017W",272).
component("YML126C",466).
component("YNL104C",490).
component("YDL182W",187).
component("YDL131W",179).
component("YLR258W",445).
component("YFR015C",262).
component("YNL029C",483).
component("YIL085C",346).
component("YMR306W",480).
component("YLR342W",454).
component("YGR032W",293).
component("YLR209C",441).
component("U104_",21).
component("YDR354W",217) :- not remove_orf("YDR354W",217).
component("YFR047C",265).
component("YLR209C",442).
component("YML022W",460).
component("YDR441C",223).
component("YJL167W",375).
component("YDR127W",199).
component("YHR068W",326).
component("YLR303W",450).
component("YGR012W",291).
component("YML082W",463).
component("YJR130C",393).
component("YDR035W",193).
component("YBR249C",149).
component("YOR274W",546).
component("YHR137W",332).
component("YGL202W",286).
component("YLR027C",425).
component("YKL106W",402).
component("YOL140W",527).
component("YGR019W",292).
component("YLR089C",433).
component("U64_",92).
component("U61_",89).
component("YJR148W",395).
component("YFL030W",258).
component("YOR184W",539).
component("YNR058W",511).
component("YIL116W",350).
component("YGL253W",289).
component("YFR053C",266).
component("YMR205C",475).
component("YGR240C",306).
component("YOL016C",515).
component("YFR014C",261).
component("YCR036W",167).
component("YCL040W",160).
component("U15_",41).
component("YPL188W",568).
component("YJR049C",385).
component("YEL041W",231).
component("U96_",110).
component("YKL001C",398).
component("YDR236C",207).
component("YHL032C",315).
component("U83_",106).
component("U81_",105).
component("YMR208W",476).
component("YPL203W",569).
component("YOR061W",531).
component("YKL166C",407).
component("YJL164C",374).
component("YIL035C",343).
component("YHR205W",339).
component("YHR102W",331).
component("YGL019W",273).
component("YHR025W",320).
component("YOR347C",552).
component("YAL038W",115).
component("YNR012W",507).
component("YDR127W",200).
component("YDR147W",203).
component("YCR012W",162).
component("YER069W",245).
component("U76_",102).
component("YER170W",252).
component("YDR226W",206).
component("YKL067W",400).
component("YOL055C",518).
component("YDR454C",224).
component("YJR057W",386).
component("YOL061W",520).
component("YKL181W",408).
component("YHL011C",314).
component("YER099C",251).
component("YBL068W",124).
component("YOR143C",535).
component("YNL256W",499).
component("YLR328W",452).
component("YBR018C",128).
component("YLR328W",453).
component("U94_",109).
component("YBR029C",131).
component("YGL130W",280).
component("YDR530C",228).
component("YPR190C",595).
component("YPR187W",594).
component("YPR110C",589).
component("YPR010C",583).
component("YOR341W",551).
component("YOR340C",550).
component("YOR224C",544).
component("YOR210W",543).
component("YOR207C",541).
component("YOR151C",536).
component("YOR116C",533).
component("YOL005C",513).
component("YNR003C",506).
component("YNL248C",498).
component("YNL151C",494).
component("YNL113W",491).
component("YKL144C",403).
component("YJR063W",387).
component("YJL148W",373).
component("YJL140W",372).
component("YIL021W",342).
component("YHR143W-A",333).
component("YGL070C",278).
component("YFL036W",259).
component("YDR404C",220).
component("YDR156W",204).
component("YDR045C",194).
component("YDL150W",182).
component("YDL140C",180).
component("YBR154C",143).
component("YPR175W",593).
component("YPL167C",566).
component("YOR330C",548).
component("YOL115W",525).
component("YNL299W",504).
component("YNL262W",500).
component("YNL102W",489).
component("YJR043C",384).
component("YJR006W",381).
component("YJL090C",365).
component("YIL139C",353).
component("YEL055C",234).
component("YDR419W",222).
component("YDR121W",197).
component("YDL102W",178).
component("YCR014C",163).
component("YBR278W",153).
component("YBL035C",122).
component("YPR113W",590).
component("YPL148C",565).
component("YGR286C",311).
component("YHR189W",337).
component("YDL086W",176).
component("YOL011W",514).
component("YMR008C",468).
component("YMR006C",467).
component("U105_",22).
component("YBL015W",120).
component("YJL068C",363).
component("U77_",103).
component("YLR377C",457).
component("YPR073C",586).
component("YHR215W",340).
component("YDL024C",170).
component("YBR093C",137).
component("YBR092C",136).
component("YHR046C",323).
component("U9_",113).
component("YDL236W",189).
component("YPR073C",587).
component("YOR208W",542).
component("YNL053W",486).
component("YMR036C",470).
component("YIR026C",360).
component("YIL113W",349).
component("YFR028C",263).
component("YER075C",248).
component("YDL230W",188).
component("YBR276C",152).
component("U34_",73).
component("U32_",72).
component("U31_",71).
component("U30_",70).
...
component("U25_",67).
component("U24_",66).
component("YHR044C",322).
component("YHR043C",321).
component("YOR360C",553).
component("YKR031C",416).
component("YPL206C",570).
component("YGL027C",275).
component("YLR286C",447).
component("YJR153W",396).
component("YJL221C",380).
component("YJL216C",378).
component("YIL172C",359).
component("YGR292W",313).
component("YGR287C",312).
component("YBR299W",156).
component("YOR190W",540).
component("YLR300W",449).
component("YGR282C",310).
component("YDR261C",210).
component("YDR400W",219).
component("YML035C",461).
component("YJL070C",364).
component("YBR284W",154).
component("U106_",23).
component("YER043C",239).
component("YDR242W",208).
component("U53_",86).
component("YPR062W",585).
component("YMR120C",473).
component("YLR028C",427).
component("YHR144C",334).
component("YBL033C",121).
component("YNL141W",492).
component("YLR245C",444).
component("YBR084W",134).
component("YJL126W",368).
component("U44_",79).
component("YDL100C",177).
component("U40_",77).
component("U39_",75).
component("YBR011C",127).
component("YHR201C",338).
component("YBR111C",138).
component("YBR252W",150).
component("YER005W",237).
component("YBL099W",125).
component("YLR231C",443).
component("YLR134W",435).
component("YLR044C",429).
component("YGR087C",297).
component("YDR380W",218).
component("YDL080C",174).
component("U98_",111).
component("YMR250W",477).
component("YOR128C",534).
component("U93_",108).
component("YKL211C",411) :- not remove_orf("YKL211C",411).
component("YKR097W",421).
component("YNL169C",495).
component("YEL046C",232).
component("YNR033W",509).
component("YKL211C",412) :- not remove_orf("YKL211C",412).
component("YER090W",412) :- not remove_orf("YER090W",412).
component("YER090W",250) :- not remove_orf("YER090W",250).
component("YDR127W",201).
component("YPL281C",581).
component("YOR393W",558).
component("YMR323W",481).
component("YHR174W",335).
component("YGR254W",308).
component("YPL262W",576).
component("YGL026C",274) :- not remove_orf("YGL026C",274).
component("YLR304C",451).
component("YJL200C",376).
component("YNL316C",505).
component("YPL212C",571).
component("YNL292W",503).
component("YGL063W",277).
component("YFL001W",255).
component("YPR002W",582).
component("YJR016C",382).
component("YCR053W",168).
component("YDR127W",202).
component("YGL148W",281).
component("YIL168W",358).
component("YIL167W",357).
component("YCL064C",161).
component("YLR359W",456).
component("YAL012W",114).
component("YJL121C",367).
component("YBR019C",129).
component("YDR007W",191) :- not remove_orf("YDR007W",191).
component("YOR095C",532).
component("YBR196C",146).
component("YGL001C",268).
component("YPL117C",564).
component("U14_",35).
component("YOL056W",519).
component("YKL152C",406).
component("YDL021W",169).
component("YPR060C",584).
component("YPL097W",562).
component("YGR185C",302).
component("YGR264C",309).
component("YGR171C",300).
component("YPL104W",563).
component("YLL018C",422).
component("YHR020W",319).
component("YER087W",249).
component("YNL247W",497).
component("YOR168W",537).
component("YOL097C",523).
component("YDR268W",211).
component("YCR024C",164).
component("YHR019C",318).
component("YNL073W",488).
component("YOR335C",549).
component("YLR153C",437).
component("YAL054C",116).
component("YGR244C",307).
component("YIL145C",354).
component("YJL101C",366).
component("YOL049W",517).
component("YER183C",254).
component("U90_",107).
component("YNR057C",510).
component("YGL234W",288).
component("YJR103W",391).
component("YBL039C",123).
component("YGR204W",304).
component("YBR084W",135).
component("YNL220W",496).
component("YDL141W",181).
component("YHR074W",327).
component("YGL062W",276).
component("YBR218C",147).
component("YPL231W",575).
component("YNR016C",508).
component("YKL182W",409).
component("YGR037C",294).
component("YPR138C",591).
component("YPL265W",577).
component("YPL036W",561).
component("YOR171C",538).
component("YOR011W",530).
component("YOL156W",529).
component("YOL103W",524).
component("YOL020W",516) :- not remove_orf("YOL020W",516).
component("YNR072W",512).
component("YNL270C",501).
component("YNL142W",493).
component("YMR011W",469).
component("YLR260W",446).
component("YLR100C",434).
component("YLR081W",432).
component("YKR053C",418).
component("YKR039W",417) :- not remove_orf("YKR039W",417).
component("YJR158W",397).
component("YJR077C",389).
component("YJL219W",379).
component("YJL214W",377).
component("YJL134W",371).
component("YJL129C",369).
component("YIL134W",352).
component("YHR096C",330).
component("YHR094C",329).
component("YHR092C",328).
component("YHL036W",316).
component("YGR121C",299).
component("YGR065C",296).
component("YGR055W",295).
component("YGL186C",283).
component("YGL077C",279).
component("YGL008C",269).
component("YFL055W",260).
component("YFL011W",256).
component("YER060W-A",243).
component("YER060W",242).
component("YER056C",241).
component("YER053C",240).
component("YEL069C",236).
component("YEL063C",235).
component("YEL017C-A",230).
component("YDR536W",229).
component("YDR508C",227).
component("YDR503C",226).
component("YDR497C",225).
component("YDR345C",215).
component("YDR343C",214).
component("YDR342C",213).
component("YDR297W",212).
component("YDR046C",195) :- not remove_orf("YDR046C",195).
component("YDL245C",190).
component("YCR032W",166).
component("YCR024C-A",165).
component("YCL025C",159).
component("YBR298C",155).
component("YBR069C",133) :- not remove_orf("YBR069C",133).
component("YBR068C",132) :- not remove_orf("YBR068C",132).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,217) :- not remove_reaction(3620,217).
catalyst(2110,265).
catalyst(2190,265).
catalyst(5791,442).
catalyst(5792,442).
...
catalyst(6112,534).
catalyst(2300,108).
catalyst(3600,411) :- not remove_reaction(3600,411).
catalyst(8000,421).
catalyst(6890,495).
catalyst(4560,232).
catalyst(2550,509).
catalyst(1890,412) :- not remove_reaction(1890,412).
catalyst(3630,412) :- not remove_reaction(3630,412).
catalyst(1890,250) :- not remove_reaction(1890,250).
catalyst(3630,250) :- not remove_reaction(3630,250).
catalyst(3740,201).
catalyst(8231,581).
catalyst(8232,581).
catalyst(8231,558).
...
catalyst(8051,576).
catalyst(8052,576).
catalyst(3590,274) :- not remove_reaction(3590,274).
catalyst(10910,274) :- not remove_reaction(10910,274).
catalyst(8181,451).
catalyst(8182,451).
catalyst(8181,376).
catalyst(8182,376).
...
catalyst(1210,529).
catalyst(1160,524).
catalyst(801,516) :- not remove_reaction(801,516).
catalyst(802,516) :- not remove_reaction(802,516).
catalyst(811,516) :- not remove_reaction(811,516).
catalyst(812,516) :- not remove_reaction(812,516).
catalyst(831,516) :- not remove_reaction(831,516).
catalyst(832,516) :- not remove_reaction(832,516).
catalyst(901,516) :- not remove_reaction(901,516).
catalyst(902,516) :- not remove_reaction(902,516).
catalyst(1210,512).
catalyst(931,501).
catalyst(932,501).
catalyst(371,493).
...
catalyst(1210,432).
catalyst(6560,418).
catalyst(771,417) :- not remove_reaction(771,417).
catalyst(772,417) :- not remove_reaction(772,417).
catalyst(781,417) :- not remove_reaction(781,417).
catalyst(782,417) :- not remove_reaction(782,417).
catalyst(801,417) :- not remove_reaction(801,417).
catalyst(802,417) :- not remove_reaction(802,417).
catalyst(811,417) :- not remove_reaction(811,417).
catalyst(812,417) :- not remove_reaction(812,417).
catalyst(831,417) :- not remove_reaction(831,417).
catalyst(832,417) :- not remove_reaction(832,417).
catalyst(841,417) :- not remove_reaction(841,417).
catalyst(842,417) :- not remove_reaction(842,417).
catalyst(851,417) :- not remove_reaction(851,417).
catalyst(852,417) :- not remove_reaction(852,417).
catalyst(881,417) :- not remove_reaction(881,417).
catalyst(882,417) :- not remove_reaction(882,417).
catalyst(901,417) :- not remove_reaction(901,417).
catalyst(902,417) :- not remove_reaction(902,417).
catalyst(921,417) :- not remove_reaction(921,417).
catalyst(922,417) :- not remove_reaction(922,417).
catalyst(931,417) :- not remove_reaction(931,417).
catalyst(932,417) :- not remove_reaction(932,417).
catalyst(1191,417) :- not remove_reaction(1191,417).
catalyst(1192,417) :- not remove_reaction(1192,417).
catalyst(1210,397).
catalyst(1581,389).
catalyst(1582,389).
catalyst(1210,379).
...
catalyst(851,195) :- not remove_reaction(851,195).
catalyst(852,195) :- not remove_reaction(852,195).
catalyst(901,195) :- not remove_reaction(901,195).
catalyst(902,195) :- not remove_reaction(902,195).
catalyst(1210,190).
catalyst(431,166).
catalyst(432,166).
catalyst(220,165).
...
catalyst(1121,155).
catalyst(1122,155).
catalyst(771,133) :- not remove_reaction(771,133).
catalyst(772,133) :- not remove_reaction(772,133).
catalyst(801,133) :- not remove_reaction(801,133).
catalyst(802,133) :- not remove_reaction(802,133).
catalyst(811,133) :- not remove_reaction(811,133).
catalyst(812,133) :- not remove_reaction(812,133).
catalyst(851,133) :- not remove_reaction(851,133).
catalyst(852,133) :- not remove_reaction(852,133).
catalyst(901,133) :- not remove_reaction(901,133).
catalyst(902,133) :- not remove_reaction(902,133).
...
catalyst(831,132) :- not remove_reaction(831,132).
catalyst(832,132) :- not remove_reaction(832,132).
catalyst(841,132) :- not remove_reaction(841,132).
catalyst(842,132) :- not remove_reaction(842,132).
