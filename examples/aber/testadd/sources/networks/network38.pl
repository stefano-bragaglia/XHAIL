...
component("YLR056W",241).
component("YKR009C",229).
component("YOL086C",294).
component("YMR303C",269).
component("YGL256W",165).
component("YDL168W",96).
component("YBR145W",70).
component("YPL231W",324).
component("U46_",47).
component("YBR149W",71).
component("YGL001C",149).
component("YIL094C",191).
component("U45_",46).
component("YDR127W",105).
component("YOL126C",298).
component("YKL085W",221).
component("YDL078C",90).
component("YNL037C",272).
component("YCL018W",81).
component("YLR355C",258).
component("YDL174C",97).
component("YML086C",263).
component("YGR088W",169).
component("YDR256C",115).
component("YJR078W",215).
component("YJR025C",210).
component("U107_",22).
component("YER070W",141).
component("U36_",43).
component("YPL276W",330).
component("YPL275W",329).
component("YOR388C",315).
component("YOR323C",309).
component("YIL125W",193).
component("U52_",49).
component("YBR166C",73).
component("YKL216W",228).
component("YKR009C",230).
component("YIL160C",196).
component("YGL205W",162).
component("YKR080W",234).
component("YER023W",136).
component("YGR204W",173).
component("YLR142W",246).
component("U62_",51).
component("YHR068W",182).
component("YKL150W",224).
component("YIL043C",189).
component("YPL171C",323).
component("YHR179W",187).
component("YDR353W",119).
component("YNL052W",273).
component("YMR256C",268).
component("YLR395C",260).
component("YLR038C",239).
component("YIL111W",192).
component("YHR051W",181).
component("YGL191W",160).
component("YGL187C",159).
component("YDL067C",89).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",328).
component("YKR069W",233).
component("YJR073C",213).
component("YDL033C",88).
component("YLR172C",248).
component("YLR058C",242).
component("YDR019C",100).
component("YBR176W",74).
component("YDR408C",124).
component("YMR120C",267).
component("YLR028C",237).
component("YBL013W",58).
component("YJL130C",203).
component("YKL024C",219).
component("YPR074C",334).
component("YBR117C",69).
component("YPL231W",325).
component("YPL231W",326).
component("YLR299W",254).
component("YML126C",264).
component("YDL182W",98).
component("YDL131W",93).
component("YLR258W",252).
component("YFR015C",146).
component("YNL029C",271).
component("YIL085C",190).
component("YLR209C",249).
component("U104_",20).
component("YDR354W",120) :- not remove_orf("YDR354W",120).
component("YFR047C",147).
component("YLR209C",250).
component("YML022W",261).
component("YDR441C",126).
component("YJL167W",207).
component("YDR127W",106).
component("YLR303W",256).
component("YJR130C",217).
component("YDR035W",101).
component("YBR249C",76).
component("YOR274W",308).
component("YHR137W",183).
component("YGL202W",161).
component("YLR027C",236).
component("YKL106W",222).
component("YLR089C",243).
component("YJR148W",218).
component("YNR058W",288).
component("YGL253W",164).
component("YFR053C",148).
component("YCR036W",86).
component("U96_",54).
component("YDR236C",113).
component("YNR012W",286).
component("YDR127W",107).
component("YDR147W",110).
component("U76_",52).
component("YDR226W",112).
component("YKL067W",220).
component("YOL055C",292).
component("YDR454C",127).
component("YOL061W",293).
component("YKL181W",225).
component("YHL011C",177).
component("YER099C",143).
component("YBL068W",62).
component("YNL256W",280).
component("YBR018C",65).
component("YGL130W",156).
component("YPR190C",340).
component("YPR187W",339).
component("YPR110C",335).
component("YPR010C",332).
component("YOR341W",313).
component("YOR340C",312).
component("YOR224C",307).
component("YOR210W",306).
component("YOR207C",305).
component("YOR151C",302).
component("YOR116C",301).
component("YOL005C",289).
component("YNR003C",285).
component("YNL248C",279).
component("YNL151C",278).
component("YNL113W",275).
component("YKL144C",223).
component("YJR063W",212).
component("YJL148W",206).
component("YJL140W",205).
component("YIL021W",188).
component("YHR143W-A",184).
component("YGL070C",155).
component("YFL036W",144).
component("YDR404C",123).
component("YDR156W",111).
component("YDR045C",102).
component("YDL150W",95).
component("YDL140C",94).
component("YBR154C",72).
component("YPR175W",338).
component("YPL167C",322).
component("YOR330C",310).
component("YOL115W",297).
component("YNL299W",283).
component("YNL262W",281).
component("YNL102W",274).
component("YJR043C",211).
component("YJR006W",209).
component("YJL090C",200).
component("YIL139C",194).
component("YEL055C",133).
component("YDR419W",125).
component("YDR121W",104).
component("YDL102W",92).
component("YCR014C",84).
component("YBR278W",78).
component("YBL035C",60).
component("YPR113W",336).
component("YPL148C",321).
component("YOL011W",290).
component("YMR008C",266).
component("YMR006C",265).
component("U105_",21).
component("YBL015W",59).
component("YLR377C",259).
component("U30_",42).
component("U29_",41).
component("U24_",40).
component("YHR044C",180).
component("YHR043C",179).
component("YOR360C",314).
component("YGL027C",153).
component("YOR190W",304).
component("YLR300W",255).
component("YGR282C",176).
component("YDR261C",116).
component("YDR400W",122).
component("YML035C",262).
component("YJL070C",199).
component("YBR284W",79).
component("YDR242W",114).
component("U53_",50).
component("YLR028C",238).
component("YHR144C",185).
component("YNL141W",276).
component("YJL126W",201).
component("U39_",44).
component("YBR011C",64).
component("YBR111C",68).
component("YBR252W",77).
component("YER005W",135).
component("YBL099W",63).
component("YLR231C",251).
component("YLR134W",245).
component("YLR044C",240).
component("YGR087C",168).
component("YDR380W",121).
component("YDL080C",91).
component("U98_",55).
component("YKL211C",226) :- not remove_orf("YKL211C",226).
component("YKL211C",227) :- not remove_orf("YKL211C",227).
component("YER090W",227) :- not remove_orf("YER090W",227).
component("YER090W",142) :- not remove_orf("YER090W",142).
component("YDR127W",108).
component("YPL281C",331).
component("YOR393W",316).
component("YMR323W",270).
component("YHR174W",186).
component("YGR254W",174).
component("YGL026C",152) :- not remove_orf("YGL026C",152).
component("YLR304C",257).
component("YJL200C",208).
component("YNL316C",284).
component("YCR053W",87).
component("YDR127W",109).
component("YGL148W",157).
component("YIL168W",198).
component("YIL167W",197).
component("YCL064C",83).
component("YAL012W",56).
component("YDR007W",99) :- not remove_orf("YDR007W",99).
component("YOR095C",300).
component("YGL001C",150).
component("YPL117C",320).
component("YPR060C",333).
component("YPL097W",318).
component("YGR185C",172).
component("YGR264C",175).
component("YGR171C",171).
component("YPL104W",319).
component("YLL018C",235).
component("YOL097C",295).
component("YDR268W",117).
component("YOR335C",311).
component("YLR153C",247).
component("YAL054C",57).
component("YIL145C",195).
component("U90_",53).
component("YNR057C",287).
component("YGL234W",163).
component("YJR103W",216).
component("YBL039C",61).
component("YGL062W",154).
component("YBR218C",75).
component("YPR138C",337).
component("YPL265W",327).
component("YPL036W",317).
component("YOR171C",303).
component("YOR011W",299).
component("YOL103W",296).
component("YOL020W",291) :- not remove_orf("YOL020W",291).
component("YNL270C",282).
component("YNL142W",277).
component("YLR260W",253).
component("YLR100C",244).
component("YKR053C",232).
component("YKR039W",231) :- not remove_orf("YKR039W",231).
component("YJR077C",214).
component("YJL134W",204).
component("YJL129C",202).
component("YHL036W",178).
component("YGR121C",170).
component("YGR065C",167).
component("YGR055W",166).
component("YGL186C",158).
component("YGL008C",151).
component("YFL055W",145).
component("YER060W-A",140).
component("YER060W",139).
component("YER056C",138).
component("YER053C",137).
component("YEL063C",134).
component("YEL017C-A",132).
component("YDR536W",131).
component("YDR508C",130).
component("YDR503C",129).
component("YDR497C",128).
component("YDR297W",118).
component("YDR046C",103) :- not remove_orf("YDR046C",103).
component("YCR024C-A",85).
component("YCL025C",82).
component("YBR298C",80).
component("YBR069C",67) :- not remove_orf("YBR069C",67).
component("YBR068C",66) :- not remove_orf("YBR068C",66).
component("U4_",48).
component("U3_",45).
component("U228_",39).
component("U223_",38).
...
catalyst(2121,20).
catalyst(2122,20).
catalyst(3620,120) :- not remove_reaction(3620,120).
catalyst(2190,147).
catalyst(5791,250).
catalyst(5792,250).
catalyst(5801,250).
...
catalyst(8812,91).
catalyst(2250,55).
catalyst(3600,226) :- not remove_reaction(3600,226).
catalyst(3630,227) :- not remove_reaction(3630,227).
catalyst(3630,142) :- not remove_reaction(3630,142).
catalyst(3740,108).
catalyst(8231,331).
catalyst(8232,331).
catalyst(8231,316).
...
catalyst(8231,174).
catalyst(8232,174).
catalyst(3590,152) :- not remove_reaction(3590,152).
catalyst(10910,152) :- not remove_reaction(10910,152).
catalyst(8181,257).
catalyst(8182,257).
catalyst(8181,208).
catalyst(8182,208).
...
catalyst(4520,83).
catalyst(4460,56).
catalyst(3610,99) :- not remove_reaction(3610,99).
catalyst(7921,300).
catalyst(7922,300).
catalyst(6370,150).
catalyst(6461,320).
...
catalyst(22,299).
catalyst(1160,296).
catalyst(801,291) :- not remove_reaction(801,291).
catalyst(802,291) :- not remove_reaction(802,291).
catalyst(811,291) :- not remove_reaction(811,291).
catalyst(812,291) :- not remove_reaction(812,291).
catalyst(831,291) :- not remove_reaction(831,291).
catalyst(832,291) :- not remove_reaction(832,291).
catalyst(901,291) :- not remove_reaction(901,291).
catalyst(902,291) :- not remove_reaction(902,291).
catalyst(931,282).
catalyst(932,282).
catalyst(371,277).
catalyst(372,277).
...
catalyst(781,231) :- not remove_reaction(781,231).
catalyst(782,231) :- not remove_reaction(782,231).
...
catalyst(881,231) :- not remove_reaction(881,231).
catalyst(882,231) :- not remove_reaction(882,231).
catalyst(901,231) :- not remove_reaction(901,231).
catalyst(902,231) :- not remove_reaction(902,231).
catalyst(931,231) :- not remove_reaction(931,231).
catalyst(932,231) :- not remove_reaction(932,231).
catalyst(1191,231) :- not remove_reaction(1191,231).
catalyst(1192,231) :- not remove_reaction(1192,231).
catalyst(1581,214).
catalyst(1582,214).
catalyst(6560,204).
catalyst(361,202).
...
catalyst(841,103) :- not remove_reaction(841,103).
catalyst(842,103) :- not remove_reaction(842,103).
...
catalyst(1121,80).
catalyst(1122,80).
catalyst(771,67) :- not remove_reaction(771,67).
catalyst(772,67) :- not remove_reaction(772,67).
catalyst(801,67) :- not remove_reaction(801,67).
catalyst(802,67) :- not remove_reaction(802,67).
catalyst(811,67) :- not remove_reaction(811,67).
catalyst(812,67) :- not remove_reaction(812,67).
catalyst(851,67) :- not remove_reaction(851,67).
catalyst(852,67) :- not remove_reaction(852,67).
catalyst(901,67) :- not remove_reaction(901,67).
catalyst(902,67) :- not remove_reaction(902,67).
...
catalyst(841,66) :- not remove_reaction(841,66).
catalyst(842,66) :- not remove_reaction(842,66).
catalyst(851,66) :- not remove_reaction(851,66).
catalyst(852,66) :- not remove_reaction(852,66).
catalyst(901,66) :- not remove_reaction(901,66).
catalyst(902,66) :- not remove_reaction(902,66).
catalyst(6980,48).
catalyst(6980,45).
catalyst(41,39).
catalyst(42,39).
