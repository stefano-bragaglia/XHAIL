...
component("YNL280C",566).
component("YLR056W",485).
component("YGL012W",305).
component("YKR009C",467).
component("YOL086C",588).
component("YMR303C",542).
component("YGL256W",325).
component("YDL168W",209).
component("YBR145W",159).
component("YPL231W",643).
component("YBR265W",171).
component("U46_",92).
component("YBR149W",160).
component("YBR149W",161).
component("YGL001C",302).
component("YIL094C",391).
component("U45_",91).
component("YML056C",524).
component("YLR432W",518).
component("YHR216W",385).
component("YAR075W",135).
component("YAR073W",134).
component("YDR127W",228).
component("YOL126C",594).
component("YKL085W",453).
component("YDL078C",197).
component("YNL037C",547).
component("YNL009W",545).
component("YLR174W",497).
component("YHR183W",379).
component("YGR256W",346).
component("YOL059W",586).
component("YDL022W",192).
component("YCL018W",179).
component("YLR355C",513).
component("YDL174C",213).
component("YML086C",526).
component("YGR088W",333).
component("YDR256C",240).
component("YKL026C",451).
component("YIR037W",406).
component("YBR244W",168).
component("YJR078W",440).
component("U58_",99).
component("YJR025C",433).
component("U107_",24).
component("YHR007C",356).
component("YJR104C",442).
component("YHR008C",357).
component("YOR384W",626).
component("YOR381W",625).
component("YOL152W",596).
component("YLL051C",478).
component("YJL026W",408).
component("YIL066C",389).
component("YGR180C",337).
component("YER070W",281).
component("U37_",85).
component("U36_",84).
component("YDL168W",210).
component("YJR009C",431).
component("YJL052W",410).
component("YGR192C",339).
component("YBR006W",144).
component("YPL276W",651).
component("YPL275W",650).
component("YOR388C",627).
component("YOR374W",623).
component("YER073W",282).
component("YGL154C",317).
component("U55_",98).
component("YER069W",279).
component("YOR323C",616).
component("YER178W",288).
component("YBR221C",167).
component("YIL125W",395).
component("U52_",96).
component("YBR166C",163).
component("YGL012W",306).
component("YKL216W",466).
component("YDR044W",222).
component("YKR009C",468).
component("YIL160C",399).
component("YGL205W",322).
component("YMR118C",534).
component("YLR164W",495).
component("YLL041C",477).
component("YKL148C",457).
component("YKL141W",455).
component("YJL045W",409).
component("YDR178W",235).
component("YEL047C",267).
component("YDL171C",211).
component("YDL171C",212).
component("YOR375C",624).
component("YDL215C",215).
component("YAL062W",132).
component("U99_",127).
component("U100_",20).
component("YBR035C",150).
component("YKR080W",473).
component("YER023W",273).
component("YOR236W",614).
component("YGR204W",340).
component("YIR034C",405).
component("YLR142W",492).
component("U65_",105).
component("U63_",103).
component("U62_",102).
component("YHR068W",366).
component("YKL150W",458).
component("YIL043C",388).
component("YHR042W",361).
component("YPL171C",638).
component("YHR179W",378).
component("YMR145C",537).
component("YML120C",527).
component("YKL192C",463).
component("YDL085W",199).
component("YGR234W",342).
component("YFR030W",299).
component("YPL017C",629).
component("YFL018C",292).
component("YDR353W",247).
component("YPR167C",663).
component("YJR137C",445).
component("YNL052W",549).
component("YMR256C",541).
component("YLR395C",517).
component("YLR038C",483).
component("YIL111W",392).
component("YHR051W",365).
component("YGL191W",320).
component("YGL187C",319).
component("YDL067C",196).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",649).
component("YKR069W",472).
component("YOL096C",589).
component("U47_",93).
component("YJR073C",438).
component("YDR120C",226).
component("YML008C",520).
component("YDL033C",194).
component("YOL096C",590).
component("YLR172C",496).
component("YLR058C",486).
component("YDR019C",220).
component("YBR176W",164).
component("YDR408C",252).
component("YMR120C",535).
component("YLR028C",481).
component("YBL013W",136).
component("YJL130C",418).
component("YKL024C",450).
component("YPR074C",659).
component("YBR117C",158).
component("YCL009C",178).
component("YNL071W",551).
component("YNR008W",571).
component("YIL160C",400).
component("YNR019W",574).
component("YCR048W",189).
component("U48_",94).
component("YDR232W",237).
component("YPL231W",644).
component("YDL052C",195).
component("U8_",121).
component("YPL231W",645).
component("YPL028W",630).
component("YLR299W",506).
component("YGL017W",307).
component("YML126C",528).
component("YNL104C",554).
component("YDL182W",214).
component("YDL131W",203).
component("YLR258W",503).
component("YFR015C",297).
component("YNL029C",546).
component("YIL085C",390).
component("YMR306W",543).
component("YLR342W",512).
component("YGR032W",328).
component("YLR209C",499).
component("U104_",21).
component("YDR354W",248) :- not remove_orf("YDR354W",248).
component("YFR047C",300).
component("YJR133W",444).
component("YLR209C",500).
component("YML022W",521).
component("YDR441C",254).
component("YJL167W",423).
component("YJL167W",424).
component("YDR127W",229).
component("YLR146C",493).
component("YHR068W",367).
component("YLR303W",508).
component("YGR012W",326).
component("YML082W",525).
component("YJR130C",443).
component("YDR035W",221).
component("YBR249C",169).
component("YLR180W",498).
component("YDR502C",257).
component("YOR274W",615).
component("YHR137W",374).
component("YGL202W",321).
component("YLR027C",480).
component("YKL106W",454).
component("YOL140W",595).
component("YLR438W",519).
component("YGR019W",327).
component("YLR089C",488).
component("U64_",104).
component("U61_",101).
component("YJR148W",446).
component("YHR208W",383).
component("YFL030W",293).
component("YOR184W",608).
component("YNR058W",577).
component("YIL116W",394).
component("YGL253W",324).
component("YFR053C",301).
component("YMR013C",532).
component("YMR205C",538).
component("YGR240C",343).
component("YOL016C",581).
component("YFR014C",296).
component("YCR036W",188).
component("YCL040W",181).
component("U15_",44).
component("YPL188W",639).
component("YJR049C",435).
component("YEL041W",265).
component("U96_",125).
component("YKL001C",449).
component("YDR236C",238).
component("YHL032C",354).
component("YDR531W",261).
component("U83_",120).
component("U82_",119).
component("U81_",118).
component("YMR208W",539).
component("YPL203W",640).
component("YOR061W",599).
component("YKL166C",460).
component("YJL164C",422).
component("YIL035C",387).
component("YHR205W",382).
component("YHR102W",373).
component("YGL019W",308).
component("YHR025W",360).
component("YOR347C",621).
component("YAL038W",130).
component("YNR012W",572).
component("YDR127W",230).
component("YDR147W",233).
component("YCR012W",183).
component("YER069W",280).
component("U76_",114).
...
component("YGL130W",315).
component("YDR530C",260).
component("YPR190C",666).
component("YPR187W",665).
component("YPR110C",660).
component("YPR010C",654).
component("YOR341W",620).
component("YOR340C",619).
component("YOR224C",613).
component("YOR210W",612).
component("YOR207C",610).
component("YOR151C",605).
component("YOR116C",601).
component("YOL005C",579).
component("YNR003C",570).
component("YNL248C",562).
component("YNL151C",558).
component("YNL113W",555).
component("YKL144C",456).
component("YJR063W",437).
component("YJL148W",421).
component("YJL140W",420).
component("YIL021W",386).
component("YHR143W-A",375).
component("YGL070C",313).
component("YFL036W",294).
component("YDR404C",251).
component("YDR156W",234).
component("YDR045C",223).
component("YDL150W",208).
component("YDL140C",204).
component("YBR154C",162).
component("YPR175W",664).
component("YPL167C",637).
component("YOR330C",617).
component("YOL115W",593).
component("YNL299W",568).
component("YNL262W",564).
component("YNL102W",553).
component("YJR043C",434).
component("YJR006W",430).
component("YJL090C",413).
component("YIL139C",397).
component("YEL055C",268).
component("YDR419W",253).
component("YDR121W",227).
component("YDL102W",202).
component("YCR014C",184).
component("YBR278W",173).
component("YBL035C",139).
component("YPR113W",661).
component("YPL148C",635).
component("YGR286C",350).
component("YHR189W",380).
component("YDR058C",225).
component("YDL086W",200).
component("YOL011W",580).
component("YMR008C",530).
component("YMR006C",529).
component("U105_",22).
component("YBL015W",137).
component("YJL068C",411).
component("U77_",115).
component("YLR377C",515).
component("YPR073C",657).
component("YHR215W",384).
component("YDL024C",193).
component("YBR093C",156).
component("YBR092C",155).
component("YHR046C",364).
component("U9_",128).
component("YDL236W",217).
component("YPR073C",658).
component("YOR208W",611).
component("YNL053W",550).
component("YMR036C",533).
component("YIR026C",404).
component("YIL113W",393).
component("YFR028C",298).
component("YER075C",283).
component("YDL230W",216).
...
component("U25_",77).
component("U24_",76).
component("YHR044C",363).
component("YHR043C",362).
component("YOR360C",622).
component("YKR031C",469).
component("YPL206C",641).
component("YGL027C",310).
component("YLR286C",505).
component("YJR153W",447).
component("YJL221C",429).
component("YJL216C",427).
component("YIL172C",403).
component("YGR292W",352).
component("YGR287C",351).
component("YBR299W",177).
component("YOR190W",609).
component("YLR300W",507).
component("YGR282C",349).
component("YDR261C",241).
component("YDR400W",250).
component("YML035C",522).
component("YJL070C",412).
component("YBR284W",174).
component("U106_",23).
component("YER043C",274).
component("YNL045W",548).
component("YDR242W",239).
component("U53_",97).
component("YPR062W",656).
component("YMR120C",536).
component("YLR028C",482).
component("YHR144C",376).
component("YGR267C",348).
component("YBL033C",138).
component("YNL141W",556).
component("YLR245C",502).
component("YML035C",523).
component("YBR084W",153).
component("YJL126W",416).
component("U44_",90).
component("YDL100C",201).
component("U40_",88).
component("U39_",86).
component("YBR011C",145).
component("YHR201C",381).
component("YBR111C",157).
component("YBR252W",170).
component("YER005W",272).
component("YBL099W",143).
component("YLR231C",501).
component("YLR134W",490).
component("YLR044C",484).
component("YGR087C",332).
component("YDR380W",249).
component("YDL080C",198).
component("U98_",126).
component("YMR250W",540).
component("YOR128C",602).
component("YEL021W",264).
component("U93_",123).
component("YKL211C",464) :- not remove_orf("YKL211C",464).
component("YKR097W",475).
component("YNL169C",559).
component("YEL046C",266).
component("YNR033W",575).
component("YKL211C",465) :- not remove_orf("YKL211C",465).
component("YER090W",465) :- not remove_orf("YER090W",465).
component("YER090W",285) :- not remove_orf("YER090W",285).
component("YDR127W",231).
component("YPL281C",652).
component("YOR393W",628).
component("YMR323W",544).
component("YHR174W",377).
component("YGR254W",345).
component("YPL262W",647).
component("YGL026C",309) :- not remove_orf("YGL026C",309).
component("YGR155W",335).
component("YLR304C",509).
component("YJL200C",425).
component("YNL316C",569).
component("YPL212C",642).
component("YNL292W",567).
component("YGL063W",312).
component("YFL001W",290).
component("YPR002W",653).
component("YJR016C",432).
component("YCR053W",190).
component("YDR127W",232).
component("YGL148W",316).
component("YIL168W",402).
component("YIL167W",401).
component("YCL064C",182).
component("YLR359W",514).
component("YAL012W",129).
component("YJL005W",407).
component("YJL121C",415).
component("YBR019C",147).
component("YDR007W",219) :- not remove_orf("YDR007W",219).
component("YOR095C",600).
component("YBR196C",165).
component("YGL001C",303).
component("YPL117C",634).
component("U14_",38).
component("YOL056W",585).
component("YKL152C",459).
component("YDL021W",191).
component("YEL058W",269).
component("YPR060C",655).
component("YHR072W",368).
component("YPL097W",632).
component("YGR185C",338).
component("YGR264C",347).
component("YGR171C",336).
component("YPL104W",633).
component("YLL018C",476).
component("YHR020W",359).
component("YER087W",284).
component("YNL247W",561).
component("YOR168W",606).
component("YOL097C",591).
component("YDR268W",242).
component("YCR024C",185).
component("YHR019C",358).
component("YPL160W",636).
component("YLR382C",516).
component("YNL073W",552).
component("YOR335C",618).
component("YLR153C",494).
component("YAL054C",131).
component("YGR244C",344).
component("YIL145C",398).
component("YJL101C",414).
component("YOL049W",583).
component("YAR015W",133).
...
component("YBL039C",140).
component("YGR204W",341).
component("YBR084W",154).
component("YNL220W",560).
component("YDL141W",207).
component("YHR074W",369).
component("YGL062W",311).
component("YBR218C",166).
component("YPL231W",646).
component("YNR016C",573).
component("YKL182W",462).
component("YGR037C",329).
component("YPR138C",662).
component("YPL265W",648).
component("YPL036W",631).
component("YOR171C",607).
component("YOR130C",603).
component("YOR011W",598).
component("YOL156W",597).
component("YOL103W",592).
component("YOL020W",582) :- not remove_orf("YOL020W",582).
component("YNR072W",578).
component("YNL270C",565).
component("YNL142W",557).
component("YMR011W",531).
component("YLR260W",504).
component("YLR138W",491).
component("YLR100C",489).
component("YLR081W",487).
component("YLL061W",479).
component("YKR093W",474).
component("YKR053C",471).
component("YKR039W",470) :- not remove_orf("YKR039W",470).
component("YJR158W",448).
component("YJR077C",439).
component("YJL219W",428).
component("YJL214W",426).
component("YJL134W",419).
component("YJL129C",417).
component("YIL134W",396).
component("YHR096C",372).
component("YHR094C",371).
component("YHR092C",370).
component("YHL036W",355).
component("YGR121C",334).
component("YGR065C",331).
component("YGR055W",330).
component("YGL186C",318).
component("YGL077C",314).
component("YGL008C",304).
component("YFL055W",295).
component("YFL011W",291).
component("YER060W-A",278).
component("YER060W",277).
component("YER056C",276).
component("YER053C",275).
component("YEL069C",271).
component("YEL063C",270).
component("YEL017C-A",263).
component("YDR536W",262).
component("YDR508C",259).
component("YDR503C",258).
component("YDR497C",256).
component("YDR345C",246).
component("YDR343C",245).
component("YDR342C",244).
component("YDR297W",243).
component("YDR046C",224) :- not remove_orf("YDR046C",224).
component("YDL245C",218).
component("YCR032W",187).
component("YCR024C-A",186).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,248) :- not remove_reaction(3620,248).
catalyst(2110,300).
catalyst(2190,300).
catalyst(5550,444).
catalyst(5791,500).
...
catalyst(5880,264).
catalyst(2300,123).
catalyst(3600,464) :- not remove_reaction(3600,464).
catalyst(8000,475).
catalyst(6890,559).
catalyst(4560,266).
catalyst(2550,575).
...
catalyst(1890,285) :- not remove_reaction(1890,285).
catalyst(3630,285) :- not remove_reaction(3630,285).
catalyst(3740,231).
catalyst(8231,652).
catalyst(8232,652).
catalyst(8231,628).
...
catalyst(7751,147).
catalyst(7752,147).
catalyst(3610,219) :- not remove_reaction(3610,219).
catalyst(7921,600).
catalyst(7922,600).
catalyst(8341,165).
catalyst(8342,165).
...
catalyst(640,474).
catalyst(6560,471).
catalyst(771,470) :- not remove_reaction(771,470).
catalyst(772,470) :- not remove_reaction(772,470).
catalyst(781,470) :- not remove_reaction(781,470).
catalyst(782,470) :- not remove_reaction(782,470).
...
catalyst(841,470) :- not remove_reaction(841,470).
catalyst(842,470) :- not remove_reaction(842,470).
catalyst(851,470) :- not remove_reaction(851,470).
catalyst(852,470) :- not remove_reaction(852,470).
catalyst(881,470) :- not remove_reaction(881,470).
catalyst(882,470) :- not remove_reaction(882,470).
catalyst(901,470) :- not remove_reaction(901,470).
catalyst(902,470) :- not remove_reaction(902,470).
catalyst(921,470) :- not remove_reaction(921,470).
catalyst(922,470) :- not remove_reaction(922,470).
catalyst(931,470) :- not remove_reaction(931,470).
catalyst(932,470) :- not remove_reaction(932,470).
catalyst(1191,470) :- not remove_reaction(1191,470).
catalyst(1192,470) :- not remove_reaction(1192,470).
catalyst(1180,448).
catalyst(1210,448).
catalyst(1581,439).
catalyst(1582,439).
...
catalyst(851,152) :- not remove_reaction(851,152).
catalyst(852,152) :- not remove_reaction(852,152).
