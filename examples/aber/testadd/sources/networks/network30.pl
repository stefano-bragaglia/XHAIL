...
component("YPL231W",265).
component("U46_",42).
component("YBR149W",63).
component("YGL001C",132).
component("YIL094C",163).
component("U45_",41).
component("YDR127W",92).
component("YOL126C",242).
component("YKL085W",186).
component("YDL078C",78).
component("YNL037C",221).
component("YDL174C",84).
component("YML086C",217).
component("YGR088W",145).
component("YDR256C",101).
component("YJR078W",181).
component("U107_",19).
component("YER070W",125).
component("U36_",38).
component("YPL276W",271).
component("YPL275W",270).
component("YOR388C",258).
component("YOR323C",252).
component("YIL125W",164).
component("U52_",44).
component("YBR166C",65).
component("YKL216W",193).
component("YKR009C",194).
component("YIL160C",166).
component("YGL205W",142).
component("YKR080W",197).
component("YER023W",121).
component("YLR142W",205).
component("U62_",46).
component("YHR068W",154).
component("YKL150W",189).
component("YIL043C",161).
component("YPL171C",264).
component("YHR179W",159).
component("YDR353W",105).
component("YPL266W",269).
component("YDL033C",77).
component("YLR172C",207).
component("YLR058C",203).
component("YDR019C",87).
component("YBR176W",66).
component("YDR408C",110).
component("YMR120C",218).
component("YLR028C",200).
component("YPR074C",275).
component("YBR117C",62).
component("YPL231W",266).
component("YPL231W",267).
component("YLR299W",212).
component("YDL182W",85).
component("YDL131W",81).
component("YLR258W",211).
component("YFR015C",130).
component("YNL029C",220).
component("YIL085C",162).
component("YLR209C",208).
component("YDR354W",106) :- not remove_orf("YDR354W",106).
component("YFR047C",131).
component("YLR209C",209).
component("YML022W",215).
component("YDR441C",112).
component("YJL167W",176).
component("YDR127W",93).
component("YJR130C",183).
component("YDR035W",88).
component("YBR249C",68).
component("YOR274W",251).
component("YHR137W",155).
component("YGL202W",141).
component("YLR027C",199).
component("YKL106W",187).
component("YJR148W",184).
component("YNR058W",235).
component("YCR036W",76).
component("U96_",49).
component("YNR012W",233).
component("YDR127W",94).
component("YDR147W",97).
component("U76_",47).
component("YDR226W",99).
component("YKL067W",185).
component("YDR454C",113).
component("YOL061W",238).
component("YKL181W",190).
component("YHL011C",152).
component("YER099C",127).
component("YBL068W",56).
component("YNL256W",227).
component("YBR018C",58).
component("YGL130W",138).
component("YPR190C",281).
component("YPR187W",280).
component("YPR110C",276).
component("YPR010C",273).
component("YOR341W",256).
component("YOR340C",255).
component("YOR224C",250).
component("YOR210W",249).
component("YOR207C",248).
component("YOR151C",246).
component("YOR116C",245).
component("YOL005C",236).
component("YNR003C",232).
component("YNL248C",226).
component("YNL151C",225).
component("YNL113W",223).
component("YKL144C",188).
component("YJR063W",179).
component("YJL148W",175).
component("YJL140W",174).
component("YIL021W",160).
component("YHR143W-A",156).
component("YGL070C",137).
component("YFL036W",128).
component("YDR404C",109).
component("YDR156W",98).
component("YDR045C",89).
component("YDL150W",83).
component("YDL140C",82).
component("YBR154C",64).
component("YPR175W",279).
component("YPL167C",263).
component("YOR330C",253).
component("YOL115W",241).
component("YNL299W",230).
component("YNL262W",228).
component("YNL102W",222).
component("YJR043C",178).
component("YJR006W",177).
component("YJL090C",170).
component("YIL139C",165).
component("YEL055C",118).
component("YDR419W",111).
component("YDR121W",91).
component("YDL102W",80).
component("YCR014C",75).
component("YBR278W",70).
component("YBL035C",54).
component("YPR113W",277).
component("U105_",18).
component("YBL015W",53).
component("YLR377C",214).
component("U30_",37).
component("U29_",36).
component("U24_",35).
component("YOR360C",257).
component("YGL027C",135).
component("YOR190W",247).
component("YLR300W",213).
component("YGR282C",151).
component("YDR261C",102).
component("YDR400W",108).
component("YML035C",216).
component("YJL070C",169).
component("YBR284W",71).
component("YDR242W",100).
component("U53_",45).
component("YLR028C",201).
component("YHR144C",157).
component("YJL126W",171).
component("U39_",39).
component("YBR011C",57).
component("YBR111C",61).
component("YBR252W",69).
component("YER005W",120).
component("YLR231C",210).
component("YDR380W",107).
component("YDL080C",79).
component("U98_",50).
component("YKL211C",191) :- not remove_orf("YKL211C",191).
component("YKL211C",192) :- not remove_orf("YKL211C",192).
component("YER090W",192) :- not remove_orf("YER090W",192).
component("YER090W",126) :- not remove_orf("YER090W",126).
component("YDR127W",95).
component("YPL281C",272).
component("YOR393W",259).
component("YMR323W",219).
component("YHR174W",158).
component("YGR254W",149).
component("YGL026C",134) :- not remove_orf("YGL026C",134).
component("YNL316C",231).
component("YDR127W",96).
component("YGL148W",139).
component("YIL168W",168).
component("YIL167W",167).
component("YCL064C",74).
component("YAL012W",51).
component("YDR007W",86) :- not remove_orf("YDR007W",86).
component("YOR095C",244).
component("YGL001C",133).
component("YPL117C",262).
component("YPR060C",274).
component("YPL097W",260).
component("YGR185C",148).
component("YGR264C",150).
component("YGR171C",147).
component("YPL104W",261).
component("YLL018C",198).
component("YOL097C",239).
component("YDR268W",103).
component("YOR335C",254).
component("YLR153C",206).
component("YAL054C",52).
component("U90_",48).
component("YNR057C",234).
component("YJR103W",182).
component("YBL039C",55).
component("YGL062W",136).
component("YBR218C",67).
component("YPR138C",278).
component("YPL265W",268).
component("YOR011W",243).
component("YOL103W",240).
component("YOL020W",237) :- not remove_orf("YOL020W",237).
component("YNL270C",229).
component("YNL142W",224).
component("YLR100C",204).
component("YKR053C",196).
component("YKR039W",195) :- not remove_orf("YKR039W",195).
component("YJR077C",180).
component("YJL134W",173).
component("YJL129C",172).
component("YHL036W",153).
component("YGR121C",146).
component("YGR065C",144).
component("YGR055W",143).
component("YGL186C",140).
component("YFL055W",129).
component("YER060W-A",124).
component("YER060W",123).
component("YER056C",122).
component("YEL063C",119).
component("YDR536W",117).
component("YDR508C",116).
component("YDR503C",115).
component("YDR497C",114).
component("YDR297W",104).
component("YDR046C",90) :- not remove_orf("YDR046C",90).
component("YCL025C",73).
component("YBR298C",72).
component("YBR069C",60) :- not remove_orf("YBR069C",60).
component("YBR068C",59) :- not remove_orf("YBR068C",59).
component("U4_",43).
component("U3_",40).
component("U228_",34).
component("U223_",33).
...
catalyst(5601,208).
catalyst(5602,208).
catalyst(3620,106) :- not remove_reaction(3620,106).
catalyst(2190,131).
catalyst(5791,209).
catalyst(5792,209).
catalyst(5801,209).
...
catalyst(8812,79).
catalyst(2250,50).
catalyst(3600,191) :- not remove_reaction(3600,191).
catalyst(3630,192) :- not remove_reaction(3630,192).
catalyst(3630,126) :- not remove_reaction(3630,126).
catalyst(3740,95).
catalyst(8231,272).
catalyst(8232,272).
catalyst(8231,259).
...
catalyst(4520,74).
catalyst(4460,51).
catalyst(3610,86) :- not remove_reaction(3610,86).
catalyst(7921,244).
catalyst(7922,244).
catalyst(6370,133).
catalyst(6461,262).
...
catalyst(931,195) :- not remove_reaction(931,195).
catalyst(932,195) :- not remove_reaction(932,195).
...
catalyst(1121,72).
catalyst(1122,72).
catalyst(771,60) :- not remove_reaction(771,60).
catalyst(772,60) :- not remove_reaction(772,60).
...
catalyst(801,59) :- not remove_reaction(801,59).
catalyst(802,59) :- not remove_reaction(802,59).
catalyst(811,59) :- not remove_reaction(811,59).
catalyst(812,59) :- not remove_reaction(812,59).
catalyst(831,59) :- not remove_reaction(831,59).
catalyst(832,59) :- not remove_reaction(832,59).
catalyst(841,59) :- not remove_reaction(841,59).
catalyst(842,59) :- not remove_reaction(842,59).
catalyst(851,59) :- not remove_reaction(851,59).
catalyst(852,59) :- not remove_reaction(852,59).
catalyst(901,59) :- not remove_reaction(901,59).
catalyst(902,59) :- not remove_reaction(902,59).
catalyst(6980,43).
catalyst(6980,40).
catalyst(41,34).
catalyst(42,34).
