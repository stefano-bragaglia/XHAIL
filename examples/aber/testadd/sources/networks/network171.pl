...
component("YNL280C",855).
component("YLR056W",731).
component("YGR060W",505).
component("YGL012W",471).
component("YKR009C",708).
component("YOL086C",889).
component("YMR303C",826).
component("YMR083W",803).
component("YGL256W",497).
component("YDL168W",321).
component("YBR145W",247).
component("YPL231W",975).
component("YBR265W",266).
component("U46_",147).
component("YBR149W",248).
component("YBR149W",249).
component("YGL001C",467).
component("YIL094C",594).
component("YHR063C",557).
component("U45_",146).
component("YML056C",785).
component("YLR432W",774).
component("YHR216W",582).
component("YAR075W",206).
component("YAR073W",205).
component("YDR127W",356).
component("YJR139C",668).
component("YML075C",788).
component("YLR450W",777).
component("YOL126C",895).
component("YKL085W",682).
component("YDL078C",303).
component("YKL029C",677).
component("YOR136W",911).
component("YNL037C",831).
component("YNL009W",829).
component("YLR174W",745).
component("YHR183W",575).
component("YGR256W",534).
component("YNL241C",846).
component("YOL059W",886).
component("YDL022W",294).
component("YCL018W",274).
component("YLR355C",769).
component("YIL074C",591).
component("YER081W",438).
component("YML054C",784).
component("YDL174C",325).
component("YML086C",790).
component("YIL155C",604).
component("YEL024W",407).
component("YKR066C",713).
component("YGR088W",509).
component("YDR256C",371).
component("YKL026C",676).
component("YIR037W",615).
component("YBR244W",261).
component("YJR078W",660).
component("U58_",156).
component("YJR025C",651).
component("U107_",27).
component("YGR255C",533).
component("U108_",28).
component("YHR007C",545).
component("YDR402C",386).
component("YGL055W",478).
component("YJR104C",663).
component("YHR008C",546).
component("YOR384W",946).
component("YOR381W",945).
component("YOL152W",899).
component("YLL051C",723).
component("YJL026W",617).
component("YIL066C",590).
component("YGR180C",520).
component("YER070W",435).
component("U37_",140).
component("U36_",139).
component("U35_",138).
component("YDL168W",322).
component("YDR158W",364).
component("YJR009C",647).
component("YJL052W",619).
component("YGR192C",522).
component("YBR006W",220).
component("YPL276W",985).
component("YPL275W",984).
component("YOR388C",947).
component("YPL061W",955).
component("YOR374W",942).
component("YER073W",436).
component("YGL154C",487).
component("YBR115C",242).
component("U55_",155).
component("YER069W",433).
component("YOR323C",932).
component("YMR170C",813).
component("YMR169C",812).
component("YER178W",449).
component("YBR221C",259).
component("YIL125W",600).
component("U52_",152).
component("YBR166C",252).
component("YNL280C",856).
component("YGL012W",472).
component("YKL182W",694).
component("YKL216W",705).
component("YDR044W",340).
component("YER014W",417).
component("YKR009C",709).
component("YIL160C",605).
component("YGL205W",492).
component("YMR118C",807).
component("YLR164W",743).
component("YLL041C",721).
component("YKL148C",688).
component("YKL141W",686).
component("YJL045W",618).
component("YDR178W",366).
component("YJR051W",654).
component("YEL047C",410).
component("YDL171C",323).
component("YDL171C",324).
component("YOR375C",943).
component("YDL215C",329).
component("YAL062W",202).
component("U99_",196).
component("U100_",21).
component("YBR035C",229).
component("YMR189W",815).
component("YKR080W",715).
component("YER023W",419).
component("YPL023C",951).
component("YGL125W",484).
component("YOR236W",929).
component("YGR204W",525).
component("YBR084W",235).
component("YIR034C",614).
component("YLR142W",740).
component("U65_",163).
component("U63_",161).
component("U62_",160).
...
component("YHR042W",552).
component("YOR221C",926).
component("YMR145C",810).
component("YML120C",791).
component("YKL192C",698).
component("YKL055C",679).
component("YER061C",429).
component("YDL085W",305).
component("YPL171C",964).
component("YHR179W",574).
component("YMR145C",811).
component("YML120C",792).
component("YKL192C",699).
component("YDL085W",306).
component("YGR234W",528).
component("YFR030W",463).
component("YPL017C",950).
component("YFL018C",453).
component("YPL091W",956).
component("YDR353W",381).
component("YER042W",421).
component("YPR167C",1008).
component("YJR137C",667).
component("YNL052W",833).
component("YMR256C",822).
component("YLR395C",773).
component("YLR038C",729).
component("YIL111W",597).
component("YHR051W",556).
component("YGL191W",490).
component("YGL187C",489).
component("YDL067C",302).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",348).
component("YPL266W",982).
component("YPL273W",983).
component("YLL062C",725).
component("YDR410C",389).
component("YKR069W",714).
component("YOL096C",890).
component("U47_",148).
component("YER091C",443).
component("YJR073C",658).
component("YGR157W",516).
component("YDR120C",354).
component("YML008C",779).
component("YOR074C",905).
component("YDL033C",296).
component("YOL096C",891).
component("YLR172C",744).
component("YLR058C",732).
component("YDR019C",336).
component("YBR176W",253).
component("YDR408C",388).
component("YMR120C",808).
component("YLR028C",727).
component("YBL013W",207).
component("YJL130C",631).
component("YJL088W",624).
component("YKL024C",674).
component("YPR074C",999).
component("YBR117C",243).
component("YLR354C",768).
component("YGR043C",503).
component("YMR108W",806).
component("YCL009C",273).
component("YMR062C",801).
component("YNL071W",835).
component("YNR008W",862).
component("YIL160C",606).
component("YNR019W",865).
component("YCR048W",289).
component("U48_",149).
component("YNL277W",854).
component("YMR062C",802).
component("YDR232W",368).
component("YPL231W",976).
component("YER061C",430).
component("YPL001W",949).
component("YDL052C",300).
component("U8_",188).
component("YDR148C",362).
component("YOR377W",944).
component("YGR177C",519).
component("YPL231W",977).
component("YPL028W",952).
component("YLR299W",756).
component("YGL017W",473).
component("YCR005C",281).
component("YML126C",793).
component("YNL104C",838).
component("YDL182W",326).
component("YDL131W",312).
component("YPR160W",1007).
component("YDR307W",377).
component("YLR258W",753).
component("YFR015C",460).
component("YPL227C",973).
component("YNL029C",830).
component("YIL085C",593).
component("YNL192W",844).
component("YBR038W",231).
component("YBR023C",227).
component("YEL011W",403).
component("YMR306W",827).
component("YLR342W",766).
component("YGR032W",501).
component("YPR183W",1011).
component("YBR248C",262).
component("YLR209C",747).
component("U104_",24).
component("U103_",23).
component("YOR209C",924).
component("YMR300C",825).
component("YER055C",425).
component("YDR354W",382) :- not remove_orf("YDR354W",382).
component("YFR047C",464).
component("YJR133W",666).
component("U22_",125).
component("YLR209C",748).
component("YML022W",781).
component("YDR441C",392).
component("YHR128W",567).
component("YPR176C",1010).
component("YPL172C",965).
component("YNR041C",869).
component("YMR101C",804).
component("YDL090C",308).
component("YBR003W",219).
component("YBR002C",218).
component("YJL167W",639).
component("YJL167W",640).
component("YNL256W",849).
component("YPR069C",996).
component("YDR127W",357).
component("YHR190W",577).
component("YLR146C",741).
component("YPL214C",971).
component("YHR068W",559).
component("YLR303W",758).
component("YGR012W",499).
component("YML082W",789).
component("YJR130C",665).
component("YLR303W",759).
component("YDR035W",338).
component("YBR249C",263).
component("YLR180W",746).
component("YDR502C",396).
component("YOR274W",930).
component("YOL143C",898).
component("YBR256C",265).
component("YHR137W",568).
component("YGL202W",491).
component("YLR027C",726).
component("YKL106W",683).
component("YOL140W",897).
component("YLR438W",776).
component("YGR019W",500).
component("YLR089C",736).
component("YDR111C",353).
component("U64_",162).
component("U61_",159).
component("U51_",151).
component("YJR148W",669).
component("YHR208W",580).
component("YFL030W",455).
component("YOR184W",917).
component("YNR058W",873).
component("YIL116W",599).
component("YGL253W",496).
component("YFR053C",465).
component("YOL136C",896).
component("YIL107C",596).
component("YMR013C",797).
component("YMR205C",817).
component("YGR240C",529).
component("YOL016C",877).
component("YFR014C",459).
component("YLR240W",751).
component("YKL203C",701).
component("YJR066W",657).
component("YCR036W",288).
component("YGR194C",523).
component("YCL040W",277).
component("U15_",69).
component("YPL188W",967).
component("YJR049C",653).
component("YEL041W",408).
component("U96_",194).
component("YKL001C",672).
component("YDR236C",369).
component("YML070W",787).
component("YFL053W",457).
component("YHL032C",543).
component("YDR531W",400).
component("U83_",182).
component("U82_",181).
component("U81_",180).
component("YMR208W",818).
component("YPL203W",968).
component("YOR061W",903).
component("YKL166C",691).
component("YJL164C",638).
component("YIL035C",586).
component("YHR205W",579).
component("YHR102W",565).
component("YGL019W",474).
component("YHR025W",551).
component("YOR347C",938).
component("YAL038W",200).
component("YNR012W",863).
component("YPR121W",1004).
component("YPL258C",979).
component("YOL055C",882).
component("YPL214C",972).
component("U1_",105).
component("YDR009W",335).
component("YDR127W",358).
component("U21_",117).
component("U20_",114).
component("YDR147W",361).
component("YDR300C",376).
component("YCR012W",282).
component("YER052C",423).
component("YER069W",434).
component("U19_",104).
component("YKL024C",675).
component("U18_",94).
component("U17_",84).
component("U76_",174).
component("YER170W",448).
component("YDR226W",367).
component("YKL067W",681).
component("YOL055C",883).
component("YDR454C",393).
component("YJR057W",655).
component("YOL061W",887).
component("YKL181W",693).
component("YHL011C",541).
component("YER099C",444).
component("YBL068W",215).
component("YOR143C",913).
component("YNL256W",850).
component("YLR328W",764).
component("YBR018C",222).
component("YBR018C",223).
component("YGR007W",498).
component("YGR202C",524).
component("YLR328W",765).
component("YKR002W",707).
component("YDL045C",298).
component("U80_",179).
component("YDL103C",311).
component("U94_",193).
component("YJR010W",648).
component("YBR029C",228).
component("YCL050C",278).
component("YGL130W",485).
component("YDR530C",399).
component("YCL050C",279).
component("YPR190C",1013).
component("YPR187W",1012).
component("YPR110C",1002).
component("YPR010C",989).
component("YOR341W",937).
component("YOR340C",936).
component("YOR224C",928).
component("YOR210W",925).
component("YOR207C",922).
component("YOR151C",914).
component("YOR116C",907).
component("YOL005C",875).
component("YNR003C",861).
component("YNL248C",848).
component("YNL151C",842).
component("YNL113W",839).
component("YKL144C",687).
component("YJR063W",656).
component("YJL148W",635).
component("YJL140W",634).
component("YIL021W",585).
component("YHR143W-A",569).
component("YGL070C",482).
component("YFL036W",456).
component("YDR404C",387).
component("YDR156W",363).
component("YDR045C",341).
component("YDL150W",320).
component("YDL140C",314).
component("YBR154C",251).
component("YPR175W",1009).
component("YPL167C",963).
component("YOR330C",933).
component("YOL115W",894).
component("YNL299W",858).
component("YNL262W",852).
component("YNL102W",837).
component("YJR043C",652).
component("YJR006W",646).
component("YJL090C",625).
component("YIL139C",602).
component("YEL055C",411).
component("YDR419W",390).
component("YDR121W",355).
component("YDL102W",310).
component("YCR014C",283).
component("YBR278W",268).
component("YBL035C",211).
component("YKL035W",678).
component("YHL012W",542).
component("YHR123W",566).
component("YPR113W",1003).
component("YBR243C",260).
component("YDL142C",319).
component("YPL148C",961).
component("YER026C",420).
component("YGR286C",538).
component("YJL068C",620).
component("YHR189W",576).
component("YDR058C",346).
component("YNR034W",868).
component("YHR163W",572).
component("YGR248W",531).
component("YCR073W-A",291).
component("YDL086W",307).
component("YOL011W",876).
component("YMR008C",795).
component("YMR006C",794).
component("U105_",25).
component("YBL015W",208).
component("YJL068C",621).
component("YJR019C",650).
component("YOR040W",902).
component("U84_",183).
component("U77_",175).
component("YDR481C",394).
component("YLR377C",771).
component("YDR074W",349).
component("YFR025C",461).
component("YPL179W",966).
component("YNR032W",866).
component("YML057W",786).
component("YML016C",780).
component("YLR433C",775).
component("YGR123C",512).
component("YER133W",446).
component("YER089C",441).
component("YDR436W",391).
component("YDR075W",350).
component("YDL188C",327).
component("YDL134C",313).
component("YDL047W",299).
component("YDL006W",292).
component("YBR125C",246).
component("YBL056W",214).
component("YPR073C",997).
component("YHR215W",581).
component("YDL024C",295).
component("YBR093C",240).
component("YBR092C",239).
component("YAR071W",204).
component("YIL053W",589).
component("YER062C",431).
component("YHR046C",555).
component("U9_",197).
component("YPL228W",974).
component("YMR180C",814).
component("YDL236W",331).
component("YJL155C",637).
component("YPR073C",998).
component("YOR208W",923).
component("YNL053W",834).
component("YMR036C",799).
component("YIR026C",612).
component("YIL113W",598).
component("YFR028C",462).
component("YER075C",437).
component("YDL230W",330).
component("YBR276C",267).
component("U34_",137).
component("U33_",136).
component("U32_",135).
component("U31_",134).
...
component("U25_",128).
component("U24_",127).
component("YHR044C",554).
component("YHR043C",553).
component("YOL064C",888).
component("YOR360C",941).
component("YGL248W",495).
component("YKR031C",710).
component("YPL206C",969).
component("YGL027C",476).
component("YLR286C",755).
component("YJR153W",670).
component("YJL221C",645).
component("YJL216C",643).
component("YIL172C",610).
component("YGR292W",540).
component("YGR287C",539).
component("YBR299W",272).
component("YBR184W",254).
component("YIL162W",607).
component("YPR026W",990).
component("YDR001C",333).
component("YBR001C",217).
component("YIR019C",611).
component("YIL099W",595).
component("YDL037C",297).
component("YOR190W",919).
component("YLR300W",757).
component("YGR282C",537).
component("YDR261C",372).
component("YDR400W",385).
component("U23_",126).
component("YML035C",782).
component("YJL070C",622).
component("YBR284W",269).
component("U106_",26).
component("U102_",22).
component("YER043C",422).
component("YNL045W",832).
component("YGL037C",477).
component("YDR242W",370).
component("YLR308W",763).
component("YLR307W",762).
component("YBR208C",256).
component("YMR281W",824).
component("U53_",153).
component("YIR032C",613).
component("YPR062W",995).
component("YMR120C",809).
component("YLR028C",728).
component("YHR144C",570).
component("YHR144C",571).
component("YGR267C",536).
component("YCL030C",276).
component("YBL033C",210).
component("YBR153W",250).
component("YNL141W",840).
component("YLR245C",752).
component("YML035C",783).
component("YGR204W",526).
component("YBR084W",236).
component("YJL126W",629).
component("U44_",145).
component("YDL100C",309).
component("U87_",185).
component("U40_",143).
component("U39_",141).
component("YBR011C",221).
component("YHR201C",578).
component("YBR111C",241).
component("YBR252W",264).
component("YPR080W",1000).
component("YOR187W",918).
component("YOR133W",910).
component("YLR069C",734).
component("YKR084C",716).
component("YKL173W",692).
component("YJL102W",627).
component("YDR385W",384).
component("YBR118W",244).
component("YER005W",416).
component("YLL001W",719).
component("YIL048W",588).
component("YER166W",447).
component("YDR093W",352).
component("YAL026C",199).
component("YBL099W",216).
component("U60_",158).
component("YLR231C",749).
component("U88_",186).
component("YDR538W",402).
component("YLR134W",738).
component("YLR044C",730).
component("YGR087C",508).
component("YDR380W",383).
component("YDL080C",304).
component("U98_",195).
component("YMR250W",821).
component("YKL184W",697).
component("YOR128C",908).
component("YEL021W",406).
component("YNR043W",870).
component("U93_",192).
component("YDR047W",343).
component("U54_",154).
component("YKL211C",703) :- not remove_orf("YKL211C",703).
component("YKR097W",718).
component("YOL052C",881).
component("YNL169C",843).
component("YGR170W",517).
component("YKL060C",680).
component("YNL256W",851).
component("YDR294C",374).
component("YEL046C",409).
component("YNR033W",867).
component("YPR006C",988).
component("YER065C",432).
component("YKL211C",704) :- not remove_orf("YKL211C",704).
component("YER090W",704) :- not remove_orf("YER090W",704).
component("YER090W",442) :- not remove_orf("YER090W",442).
component("YDR127W",359).
component("YPL281C",986).
component("YOR393W",948).
component("YMR323W",828).
component("YHR174W",573).
component("YGR254W",532).
component("YOR202W",921).
component("YPL262W",980).
component("YGL026C",475) :- not remove_orf("YGL026C",475).
component("YGR155W",515).
component("YLR304C",760).
component("YJL200C",641).
component("YGL009C",470).
component("YNL316C",859).
component("YKL182W",695).
component("YPL212C",970).
component("YNL292W",857).
component("YGL063W",481).
component("YFL001W",451).
component("YPR002W",987).
component("YJR016C",649).
component("YCR053W",290).
component("YDR127W",360).
component("YGL148W",486).
component("YIL168W",609).
component("YIL167W",608).
component("YCL064C",280).
component("YER086W",439).
component("YLR359W",770).
component("YAL012W",198).
component("YML004C",778).
component("YFR055W",466).
component("YJL005W",616).
component("YJL121C",628).
component("YBR019C",224).
component("YBR019C",225).
component("YDR050C",344).
component("YIL020C",584).
component("YDR007W",334) :- not remove_orf("YDR007W",334).
component("YOR095C",906).
component("YER003C",415).
component("YBR196C",255).
component("YGL001C",468).
component("YPL117C",959).
component("U14_",61).
component("YOL056W",884).
component("YKL152C",690).
component("YDL021W",293).
component("YMR105C",805).
component("YKL127W",685).
component("YEL058W",412).
component("YPR060C",994).
component("YHR072W",560).
component("YJL153C",636).
component("YPL097W",957).
component("YGR185C",521).
component("YGR264C",535).
component("YGR171C",518).
component("YHR011W",547).
component("YDR023W",337).
component("YPL104W",958).
component("YLL018C",720).
component("YPR081C",1001).
component("YBR121C",245).
component("YHR020W",550).
component("YER087W",440).
component("YNL247W",847).
component("YOL033W",879).
component("YOR168W",915).
component("YOL097C",892).
component("YDR268W",373).
component("YPR047W",993).
component("YLR060W",733).
component("YFL022C",454).
component("YPR033C",991).
component("YHR019C",548).
component("YCR024C",284).
component("YHR019C",549).
component("YKL194C",700).
component("YIL078W",592).
component("YPL160W",962).
component("YLR382C",772).
component("YNL073W",836).
component("YDR037W",339).
component("YOR335C",934).
component("YGR094W",510).
component("YLR153C",742).
component("YAL054C",201).
component("YOR317W",931).
component("YMR246W",820).
component("YIL009W",583).
component("YER015W",418).
component("YOR142W",912).
component("YGR244C",530).
component("YPR035W",992).
component("YIL145C",603).
component("U89_",187).
component("YOR339C",935).
component("YMR022W",798).
component("YLR306W",761).
component("YKL210W",702).
component("YGR133W",514).
component("YGL058W",479).
component("YER100W",445).
component("YEL012W",404).
component("YDR177W",365).
component("YDR092W",351).
component("YDR059C",347).
component("YDR054C",345).
component("YDL064W",301).
component("YBR082C",234).
component("YJL101C",626).
component("YOL049W",880).
component("U92_",191).
component("YAR015W",203).
component("YGL234W",493).
component("YER183C",450).
component("U91_",190).
component("U90_",189).
component("YNR057C",872).
component("YDL141W",315).
component("YDL141W",316).
component("YGL234W",494).
component("YDL141W",317).
component("YJR103W",662).
component("YBL039C",212).
component("YGR204W",527).
component("YBR084W",237).
component("YNL220W",845).
component("YOL058W",885).
component("YBR208C",257).
component("YDL141W",318).
component("YHR074W",561).
component("YMR217W",819).
component("YGR061C",506).
component("YPR145W",1006).
component("YGR124W",513).
component("YJR109C",664).
component("YJL130C",632).
component("YGL062W",480).
component("YBR218C",258).
component("YPL231W",978).
component("YNR016C",864).
component("YKL182W",696).
component("YGR037C",502).
component("YJL087C",623).
component("YPR138C",1005).
component("YPL265W",981).
component("YPL134C",960).
component("YPL057C",954).
component("YPL036W",953).
component("YOR348C",939).
component("YOR222W",927).
component("YOR192C",920).
component("YOR171C",916).
component("YOR130C",909).
component("YOR071C",904).
component("YOR011W",901).
component("YOL156W",900).
component("YOL103W",893).
component("YOL020W",878) :- not remove_orf("YOL020W",878).
component("YNR072W",874).
component("YNR056C",871).
component("YNL318C",860).
component("YNL270C",853).
component("YNL142W",841).
component("YMR272C",823).
component("YMR202W",816).
component("YMR056C",800).
component("YMR011W",796).
component("YLR348C",767).
component("YLR260W",754).
component("YLR237W",750).
component("YLR138W",739).
component("YLR100C",737).
component("YLR081W",735).
component("YLL061W",724).
component("YLL043W",722).
component("YKR093W",717).
component("YKR053C",712).
component("YKR039W",711) :- not remove_orf("YKR039W",711).
component("YKL217W",706).
component("YKL120W",684).
component("YKL004W",673).
component("YJR158W",671).
component("YJR095W",661).
component("YJR077C",659).
component("YJL219W",644).
component("YJL214W",642).
component("YJL134W",633).
component("YJL129C",630).
component("YIL134W",601).
component("YHR096C",564).
component("YHR094C",563).
component("YHR092C",562).
component("YHL036W",544).
component("YGR121C",511).
component("YGR065C",507).
component("YGR055W",504).
component("YGL186C",488).
component("YGL077C",483).
component("YGL008C",469).
component("YFL055W",458).
component("YFL011W",452).
component("YER060W-A",428).
component("YER060W",427).
component("YER056C",426).
component("YER053C",424).
component("YEL069C",414).
component("YEL063C",413).
component("YEL017C-A",405).
component("YDR536W",401).
component("YDR508C",398).
component("YDR503C",397).
component("YDR497C",395).
component("YDR345C",380).
component("YDR343C",379).
component("YDR342C",378).
component("YDR297W",375).
component("YDR046C",342) :- not remove_orf("YDR046C",342).
component("YDL245C",332).
component("YDL210W",328).
component("YCR032W",287).
component("YCR028C",286).
component("YCR024C-A",285).
component("YCL025C",275).
component("YBR298C",271).
component("YBR291C",270).
component("YBR085W",238).
component("YBR069C",233) :- not remove_orf("YBR069C",233).
component("YBR068C",232) :- not remove_orf("YBR068C",232).
component("YBR036C",230).
component("YBR021W",226).
component("YBL042C",213).
component("YBL030C",209).
component("U85_",184).
component("U7_",178).
component("U79_",177).
component("U78_",176).
...
catalyst(6160,825).
catalyst(3870,425).
catalyst(3620,382) :- not remove_reaction(3620,382).
catalyst(2110,464).
catalyst(2190,464).
catalyst(5550,666).
catalyst(5301,125).
...
catalyst(1960,343).
catalyst(3460,154).
catalyst(3600,703) :- not remove_reaction(3600,703).
catalyst(8000,718).
catalyst(3941,881).
catalyst(3942,881).
catalyst(6890,843).
...
catalyst(8020,988).
catalyst(8020,432).
catalyst(1890,704) :- not remove_reaction(1890,704).
catalyst(3630,704) :- not remove_reaction(3630,704).
...
catalyst(1210,900).
catalyst(1160,893).
catalyst(801,878) :- not remove_reaction(801,878).
catalyst(802,878) :- not remove_reaction(802,878).
catalyst(811,878) :- not remove_reaction(811,878).
catalyst(812,878) :- not remove_reaction(812,878).
catalyst(831,878) :- not remove_reaction(831,878).
catalyst(832,878) :- not remove_reaction(832,878).
catalyst(901,878) :- not remove_reaction(901,878).
catalyst(902,878) :- not remove_reaction(902,878).
catalyst(1180,874).
catalyst(1210,874).
catalyst(700,871).
catalyst(1200,860).
...
catalyst(650,717).
catalyst(6560,712).
catalyst(681,711) :- not remove_reaction(681,711).
catalyst(682,711) :- not remove_reaction(682,711).
catalyst(771,711) :- not remove_reaction(771,711).
catalyst(772,711) :- not remove_reaction(772,711).
catalyst(781,711) :- not remove_reaction(781,711).
catalyst(782,711) :- not remove_reaction(782,711).
catalyst(791,711) :- not remove_reaction(791,711).
catalyst(792,711) :- not remove_reaction(792,711).
catalyst(801,711) :- not remove_reaction(801,711).
catalyst(802,711) :- not remove_reaction(802,711).
catalyst(811,711) :- not remove_reaction(811,711).
catalyst(812,711) :- not remove_reaction(812,711).
catalyst(831,711) :- not remove_reaction(831,711).
catalyst(832,711) :- not remove_reaction(832,711).
catalyst(841,711) :- not remove_reaction(841,711).
catalyst(842,711) :- not remove_reaction(842,711).
catalyst(851,711) :- not remove_reaction(851,711).
catalyst(852,711) :- not remove_reaction(852,711).
catalyst(881,711) :- not remove_reaction(881,711).
catalyst(882,711) :- not remove_reaction(882,711).
catalyst(901,711) :- not remove_reaction(901,711).
catalyst(902,711) :- not remove_reaction(902,711).
catalyst(911,711) :- not remove_reaction(911,711).
catalyst(912,711) :- not remove_reaction(912,711).
catalyst(921,711) :- not remove_reaction(921,711).
catalyst(922,711) :- not remove_reaction(922,711).
catalyst(931,711) :- not remove_reaction(931,711).
catalyst(932,711) :- not remove_reaction(932,711).
catalyst(1191,711) :- not remove_reaction(1191,711).
catalyst(1192,711) :- not remove_reaction(1192,711).
catalyst(390,706).
catalyst(1521,684).
catalyst(1522,684).
catalyst(6610,673).
...
catalyst(851,342) :- not remove_reaction(851,342).
catalyst(852,342) :- not remove_reaction(852,342).
...
catalyst(791,233) :- not remove_reaction(791,233).
catalyst(792,233) :- not remove_reaction(792,233).
...
catalyst(851,233) :- not remove_reaction(851,233).
catalyst(852,233) :- not remove_reaction(852,233).
catalyst(901,233) :- not remove_reaction(901,233).
catalyst(902,233) :- not remove_reaction(902,233).
...
modifiable_enzyme(382).
modifiable_enzyme(703).
modifiable_enzyme(704).
modifiable_enzyme(442).
modifiable_enzyme(475).
modifiable_enzyme(334).
modifiable_enzyme(878).
modifiable_enzyme(711).
