...
component("YNL280C",815).
component("YLR056W",697).
component("YGR060W",481).
component("YGL012W",449).
component("YKR009C",674).
component("YOL086C",848).
component("YMR303C",787).
component("YMR083W",765).
component("YGL256W",474).
component("YDL168W",309).
component("YBR145W",236).
component("YPL231W",930).
component("YBR265W",255).
component("U46_",142).
component("YBR149W",237).
component("YBR149W",238).
component("YGL001C",445).
component("YIL094C",565).
component("YHR063C",529).
component("U45_",141).
component("YML056C",749).
component("YLR432W",738).
component("YHR216W",553).
component("YAR075W",199).
component("YAR073W",198).
component("YDR127W",339).
component("YJR139C",637).
component("YML075C",752).
component("YLR450W",741).
component("YOL126C",854).
component("YKL085W",651).
component("YDL078C",291).
component("YKL029C",646).
component("YNL037C",792).
component("YNL009W",790).
component("YLR174W",711).
component("YHR183W",546).
component("YGR256W",507).
component("YNL241C",807).
component("YOL059W",845).
component("YDL022W",283).
component("YCL018W",263).
component("YLR355C",733).
component("YIL074C",562).
component("YER081W",417).
component("YML054C",748).
component("YDL174C",313).
component("YML086C",754).
component("YIL155C",574).
component("YEL024W",388).
component("YKR066C",679).
component("YGR088W",485).
component("YDR256C",353).
component("YKL026C",645).
component("YIR037W",585).
component("YBR244W",250).
component("YJR078W",629).
component("U58_",151).
component("YJR025C",620).
component("U107_",27).
component("YGR255C",506).
component("U108_",28).
component("YHR007C",518).
component("YDR402C",368).
component("YGL055W",456).
component("YJR104C",632).
component("YHR008C",519).
component("YOR384W",901).
component("YOR381W",900).
component("YOL152W",857).
component("YLL051C",689).
component("YJL026W",587).
component("YIL066C",561).
component("YGR180C",493).
component("YER070W",414).
component("U37_",135).
component("U36_",134).
component("U35_",133).
component("YDL168W",310).
component("YDR158W",347).
component("YJR009C",616).
component("YJL052W",589).
component("YGR192C",495).
component("YBR006W",212).
component("YPL276W",940).
component("YPL275W",939).
component("YOR388C",902).
component("YPL061W",910).
component("YOR374W",898).
component("YER073W",415).
component("YGL154C",464).
component("YBR115C",231).
component("U55_",150).
component("YER069W",412).
component("YOR323C",889).
component("YMR170C",775).
component("YMR169C",774).
component("YER178W",427).
component("YBR221C",248).
component("YIL125W",570).
component("U52_",147).
component("YBR166C",241).
component("YNL280C",816).
component("YGL012W",450).
component("YKL182W",662).
component("YKL216W",672).
component("YDR044W",328).
component("YER014W",398).
component("YKR009C",675).
component("YIL160C",575).
component("YGL205W",469).
component("YMR118C",769).
component("YLR164W",709).
component("YLL041C",687).
component("YKL148C",656).
component("YKL141W",654).
component("YJL045W",588).
component("YDR178W",348).
component("YJR051W",623).
component("YEL047C",391).
component("YDL171C",311).
component("YDL171C",312).
component("YOR375C",899).
component("YDL215C",317).
component("YAL062W",195).
component("U99_",189).
component("U100_",21).
component("YBR035C",221).
component("YMR189W",777).
component("YKR080W",681).
component("YER023W",400).
component("YPL023C",906).
component("YGL125W",461).
component("YOR236W",886).
component("YGR204W",498).
component("YIR034C",584).
component("YLR142W",706).
component("U65_",158).
component("U63_",156).
component("U62_",155).
component("YOR356W",896).
component("YHR068W",530).
component("YKL150W",657).
component("YIL043C",558).
component("YHR042W",524).
component("YOR221C",883).
component("YMR145C",772).
component("YML120C",755).
component("YKL192C",666).
component("YKL055C",648).
component("YER061C",408).
component("YDL085W",293).
component("YPL171C",919).
component("YHR179W",545).
component("YMR145C",773).
component("YML120C",756).
component("YKL192C",667).
component("YDL085W",294).
component("YGR234W",501).
component("YFR030W",441).
component("YPL017C",905).
component("YFL018C",431).
component("YPL091W",911).
component("YDR353W",363).
component("YER042W",402).
component("YPR167C",962).
component("YJR137C",636).
component("YNL052W",794).
component("YMR256C",784).
component("YLR395C",737).
component("YLR038C",695).
component("YIL111W",567).
component("YHR051W",528).
component("YGL191W",467).
component("YGL187C",466).
component("YDL067C",290).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",333).
component("YPL266W",937).
component("YPL273W",938).
component("YLL062C",691).
component("YDR410C",371).
component("YKR069W",680).
component("YOL096C",849).
component("U47_",143).
component("YER091C",422).
component("YJR073C",627).
component("YGR157W",490).
component("YDR120C",337).
component("YML008C",743).
component("YOR074C",863).
component("YDL033C",285).
component("YOL096C",850).
component("YLR172C",710).
component("YLR058C",698).
component("YDR019C",324).
component("YBR176W",242).
component("YDR408C",370).
component("YMR120C",770).
component("YLR028C",693).
component("YBL013W",200).
component("YJL130C",601).
component("YJL088W",594).
component("YKL024C",643).
component("YPR074C",954).
component("YBR117C",232).
component("YMR108W",768).
component("YCL009C",262).
component("YMR062C",763).
component("YNL071W",796).
component("YNR008W",822).
component("YIL160C",576).
component("YNR019W",825).
component("YCR048W",278).
component("U48_",144).
component("YMR062C",764).
component("YDR232W",350).
component("YPL231W",931).
component("YER061C",409).
component("YPL001W",904).
component("YDL052C",289).
component("U8_",182).
component("YDR148C",345).
component("YPL231W",932).
component("YPL028W",907).
component("YLR299W",722).
component("YGL017W",451).
component("YCR005C",270).
component("YML126C",757).
component("YNL104C",799).
component("YDL182W",314).
component("YDL131W",300).
component("YPR160W",961).
component("YDR307W",359).
component("YLR258W",719).
component("YFR015C",438).
component("YPL227C",928).
component("YNL029C",791).
component("YIL085C",564).
component("YNL192W",805).
component("YBR038W",223).
component("YBR023C",219).
component("YEL011W",385).
component("YMR306W",788).
component("YLR342W",731).
component("YGR032W",478).
component("YPR183W",965).
component("YBR248C",251).
component("YLR209C",713).
component("U104_",24).
component("U103_",23).
component("YOR209C",881).
component("YDR354W",364) :- not remove_orf("YDR354W",364).
component("YFR047C",442).
component("YJR133W",635).
component("YLR209C",714).
component("YML022W",745).
component("YDR441C",374).
component("YHR128W",539).
component("YPR176C",964).
component("YPL172C",920).
component("YNR041C",829).
component("YMR101C",766).
component("YDL090C",296).
component("YBR003W",211).
component("YBR002C",210).
component("YJL167W",608).
component("YJL167W",609).
component("YNL256W",810).
component("YPR069C",951).
component("YDR127W",340).
component("YHR190W",548).
component("YLR146C",707).
component("YPL214C",926).
component("YHR068W",531).
component("YLR303W",724).
component("YGR012W",476).
component("YML082W",753).
component("YJR130C",634).
component("YLR303W",725).
component("YDR035W",326).
component("YBR249C",252).
component("YLR180W",712).
component("YDR502C",378).
component("YOR274W",887).
component("YOL143C",856).
component("YBR256C",254).
component("YHR137W",540).
component("YGL202W",468).
component("YLR027C",692).
component("YKL106W",652).
component("YOL140W",855).
component("YLR438W",740).
component("YGR019W",477).
component("YLR089C",702).
component("YDR111C",336).
component("U64_",157).
component("U61_",154).
component("U51_",146).
component("YJR148W",638).
component("YHR208W",551).
component("YFL030W",433).
component("YOR184W",874).
component("YNR058W",833).
component("YIL116W",569).
component("YGL253W",473).
component("YFR053C",443).
component("YMR013C",761).
component("YMR205C",779).
component("YGR240C",502).
component("YOL016C",837).
component("YFR014C",437).
component("YLR240W",717).
component("YKL203C",669).
component("YJR066W",626).
component("YCR036W",277).
component("YGR194C",496).
component("YCL040W",266).
component("U15_",68).
component("YPL188W",922).
component("YJR049C",622).
component("YEL041W",389).
component("U96_",187).
component("YKL001C",641).
component("YDR236C",351).
component("YML070W",751).
component("YFL053W",435).
component("YHL032C",516).
component("YDR531W",382).
component("U83_",176).
component("U82_",175).
component("U81_",174).
component("YMR208W",780).
component("YPL203W",923).
component("YOR061W",861).
component("YKL166C",659).
component("YJL164C",607).
component("YIL035C",557).
component("YHR205W",550).
component("YHR102W",537).
component("YGL019W",452).
component("YHR025W",523).
component("YOR347C",894).
component("YAL038W",193).
component("YNR012W",823).
component("YPR121W",959).
component("YPL258C",934).
component("YOL055C",841).
component("YPL214C",927).
component("YDR009W",323).
component("YDR127W",341).
component("U21_",114).
component("YDR147W",344).
component("YDR300C",358).
component("YCR012W",271).
component("YER069W",413).
component("U19_",103).
component("YKL024C",644).
component("U18_",93).
component("U17_",83).
component("U76_",168).
component("YER170W",426).
component("YDR226W",349).
component("YKL067W",650).
component("YOL055C",842).
component("YDR454C",375).
component("YJR057W",624).
component("YOL061W",846).
component("YKL181W",661).
component("YHL011C",514).
component("YER099C",423).
component("YBL068W",207).
component("YOR143C",870).
component("YNL256W",811).
component("YLR328W",729).
component("YBR018C",214).
component("YBR018C",215).
component("YGR007W",475).
component("YGR202C",497).
component("YLR328W",730).
component("YDL045C",287).
component("U80_",173).
component("YDL103C",299).
component("U94_",186).
component("YJR010W",617).
component("YBR029C",220).
component("YCL050C",267).
component("YGL130W",462).
component("YDR530C",381).
component("YCL050C",268).
component("YPR190C",967).
component("YPR187W",966).
component("YPR110C",957).
component("YPR010C",944).
component("YOR341W",893).
component("YOR340C",892).
component("YOR224C",885).
component("YOR210W",882).
component("YOR207C",879).
component("YOR151C",871).
component("YOR116C",865).
component("YOL005C",835).
component("YNR003C",821).
component("YNL248C",809).
component("YNL151C",803).
component("YNL113W",800).
component("YKL144C",655).
component("YJR063W",625).
component("YJL148W",605).
component("YJL140W",604).
component("YIL021W",556).
component("YHR143W-A",541).
component("YGL070C",459).
component("YFL036W",434).
component("YDR404C",369).
component("YDR156W",346).
component("YDR045C",329).
component("YDL150W",308).
component("YDL140C",302).
component("YBR154C",240).
component("YPR175W",963).
component("YPL167C",918).
component("YOR330C",890).
component("YOL115W",853).
component("YNL299W",818).
component("YNL262W",813).
component("YNL102W",798).
component("YJR043C",621).
component("YJR006W",615).
component("YJL090C",595).
component("YIL139C",572).
component("YEL055C",392).
component("YDR419W",372).
component("YDR121W",338).
component("YDL102W",298).
component("YCR014C",272).
component("YBR278W",257).
component("YBL035C",203).
component("YKL035W",647).
component("YHL012W",515).
component("YHR123W",538).
component("YPR113W",958).
component("YBR243C",249).
component("YDL142C",307).
component("YPL148C",916).
component("YER026C",401).
component("YGR286C",511).
component("YJL068C",590).
component("YHR189W",547).
component("YDR058C",332).
component("YNR034W",828).
component("YHR163W",543).
component("YGR248W",504).
component("YCR073W-A",280).
component("YDL086W",295).
component("YOL011W",836).
component("YMR008C",759).
component("YMR006C",758).
component("U105_",25).
component("YBL015W",201).
component("YJL068C",591).
component("YJR019C",619).
component("YOR040W",860).
component("U84_",177).
component("U77_",169).
component("YDR481C",376).
component("YLR377C",735).
component("YFR025C",439).
component("YPL179W",921).
component("YNR032W",826).
component("YML057W",750).
component("YML016C",744).
component("YLR433C",739).
component("YGR123C",488).
component("YER133W",424).
component("YER089C",420).
component("YDR436W",373).
component("YDR075W",334).
component("YDL188C",315).
component("YDL134C",301).
component("YDL047W",288).
component("YDL006W",281).
component("YBR125C",235).
component("YBL056W",206).
component("YPR073C",952).
component("YHR215W",552).
component("YDL024C",284).
component("YBR093C",229).
component("YBR092C",228).
component("YAR071W",197).
component("YIL053W",560).
component("YER062C",410).
component("YHR046C",527).
component("U9_",190).
component("YPL228W",929).
component("YMR180C",776).
component("YDL236W",319).
component("YJL155C",606).
component("YPR073C",953).
component("YOR208W",880).
component("YNL053W",795).
component("YMR036C",762).
component("YIR026C",582).
component("YIL113W",568).
component("YFR028C",440).
component("YER075C",416).
...
component("U25_",123).
component("U24_",122).
component("YHR044C",526).
component("YHR043C",525).
component("YOL064C",847).
component("YOR360C",897).
component("YGL248W",472).
component("YKR031C",676).
component("YPL206C",924).
component("YGL027C",454).
component("YLR286C",721).
component("YJR153W",639).
component("YJL221C",614).
component("YJL216C",612).
component("YIL172C",580).
component("YGR292W",513).
component("YGR287C",512).
component("YBR299W",261).
component("YBR184W",243).
component("YIL162W",577).
component("YPR026W",945).
component("YDR001C",321).
component("YBR001C",209).
component("YIR019C",581).
component("YIL099W",566).
component("YDL037C",286).
component("YOR190W",876).
component("YLR300W",723).
component("YGR282C",510).
component("YDR261C",354).
component("YDR400W",367).
component("U23_",121).
component("YML035C",746).
component("YJL070C",592).
component("YBR284W",258).
component("U106_",26).
component("U102_",22).
component("YER043C",403).
component("YNL045W",793).
component("YGL037C",455).
component("YDR242W",352).
component("YLR308W",728).
component("YLR307W",727).
component("YBR208C",245).
component("YMR281W",786).
component("U53_",148).
component("YIR032C",583).
component("YPR062W",950).
component("YMR120C",771).
component("YLR028C",694).
component("YHR144C",542).
component("YGR267C",509).
component("YCL030C",265).
component("YBL033C",202).
component("YBR153W",239).
component("YNL141W",801).
component("YLR245C",718).
component("YML035C",747).
component("YGR204W",499).
component("YBR084W",226).
component("YJL126W",599).
component("U44_",140).
component("YDL100C",297).
component("U87_",179).
component("U40_",138).
component("U39_",136).
component("YBR011C",213).
component("YHR201C",549).
component("YBR111C",230).
component("YBR252W",253).
component("YPR080W",955).
component("YOR187W",875).
component("YOR133W",868).
component("YLR069C",700).
component("YKR084C",682).
component("YKL173W",660).
component("YJL102W",597).
component("YDR385W",366).
component("YBR118W",233).
component("YER005W",397).
component("YLL001W",685).
component("YIL048W",559).
component("YER166W",425).
component("YDR093W",335).
component("YAL026C",192).
component("YBL099W",208).
component("U60_",153).
component("YLR231C",715).
component("U88_",180).
component("YDR538W",384).
component("YLR134W",704).
component("YLR044C",696).
component("YGR087C",484).
component("YDR380W",365).
component("YDL080C",292).
component("U98_",188).
component("YMR250W",783).
component("YKL184W",665).
component("YOR128C",866).
component("YEL021W",387).
component("YNR043W",830).
component("U93_",185).
component("U54_",149).
component("YKL211C",670) :- not remove_orf("YKL211C",670).
component("YKR097W",684).
component("YOL052C",840).
component("YNL169C",804).
component("YGR170W",491).
component("YKL060C",649).
component("YNL256W",812).
component("YDR294C",356).
component("YEL046C",390).
component("YNR033W",827).
component("YPR006C",943).
component("YER065C",411).
component("YKL211C",671) :- not remove_orf("YKL211C",671).
component("YER090W",671) :- not remove_orf("YER090W",671).
component("YER090W",421) :- not remove_orf("YER090W",421).
component("YDR127W",342).
component("YPL281C",941).
component("YOR393W",903).
component("YMR323W",789).
component("YHR174W",544).
component("YGR254W",505).
component("YOR202W",878).
component("YPL262W",935).
component("YGL026C",453) :- not remove_orf("YGL026C",453).
component("YGR155W",489).
component("YLR304C",726).
component("YJL200C",610).
component("YGL009C",448).
component("YNL316C",819).
component("YKL182W",663).
component("YPL212C",925).
component("YNL292W",817).
component("YGL063W",458).
component("YFL001W",429).
component("YPR002W",942).
component("YJR016C",618).
component("YCR053W",279).
component("YDR127W",343).
component("YGL148W",463).
component("YIL168W",579).
component("YIL167W",578).
component("YCL064C",269).
component("YER086W",418).
component("YLR359W",734).
component("YAL012W",191).
component("YML004C",742).
component("YFR055W",444).
component("YJL005W",586).
component("YJL121C",598).
component("YBR019C",216).
component("YBR019C",217).
component("YDR050C",331).
component("YIL020C",555).
component("YDR007W",322) :- not remove_orf("YDR007W",322).
component("YOR095C",864).
component("YER003C",396).
component("YBR196C",244).
component("YGL001C",446).
component("YPL117C",914).
component("U14_",60).
component("YOL056W",843).
component("YKL152C",658).
component("YDL021W",282).
component("YMR105C",767).
component("YKL127W",653).
component("YEL058W",393).
component("YPR060C",949).
component("YHR072W",532).
component("YPL097W",912).
component("YGR185C",494).
component("YGR264C",508).
component("YGR171C",492).
component("YHR011W",520).
component("YDR023W",325).
component("YPL104W",913).
component("YLL018C",686).
component("YPR081C",956).
component("YBR121C",234).
component("YHR020W",522).
component("YER087W",419).
component("YNL247W",808).
component("YOR168W",872).
component("YOL097C",851).
component("YDR268W",355).
component("YPR047W",948).
component("YLR060W",699).
component("YFL022C",432).
component("YPR033C",946).
component("YCR024C",273).
component("YHR019C",521).
component("YKL194C",668).
component("YIL078W",563).
component("YPL160W",917).
component("YLR382C",736).
component("YNL073W",797).
component("YDR037W",327).
component("YOR335C",891).
component("YGR094W",486).
component("YLR153C",708).
component("YAL054C",194).
component("YOR317W",888).
component("YMR246W",782).
component("YIL009W",554).
component("YER015W",399).
component("YOR142W",869).
component("YGR244C",503).
component("YPR035W",947).
component("YIL145C",573).
component("U89_",181).
component("YJL101C",596).
component("YOL049W",839).
component("YAR015W",196).
component("YGL234W",470).
component("YER183C",428).
component("U91_",184).
component("U90_",183).
component("YNR057C",832).
component("YDL141W",303).
component("YDL141W",304).
component("YGL234W",471).
component("YDL141W",305).
component("YJR103W",631).
component("YBL039C",204).
component("YGR204W",500).
component("YBR084W",227).
component("YNL220W",806).
component("YOL058W",844).
component("YBR208C",246).
component("YDL141W",306).
component("YHR074W",533).
component("YMR217W",781).
component("YGR061C",482).
component("YJR109C",633).
component("YJL130C",602).
component("YGL062W",457).
component("YBR218C",247).
component("YPL231W",933).
component("YNR016C",824).
component("YKL182W",664).
component("YGR037C",479).
component("YJL087C",593).
component("YPR138C",960).
component("YPL265W",936).
component("YPL134C",915).
component("YPL057C",909).
component("YPL036W",908).
component("YOR348C",895).
component("YOR222W",884).
component("YOR192C",877).
component("YOR171C",873).
component("YOR130C",867).
component("YOR071C",862).
component("YOR011W",859).
component("YOL156W",858).
component("YOL103W",852).
component("YOL020W",838) :- not remove_orf("YOL020W",838).
component("YNR072W",834).
component("YNR056C",831).
component("YNL318C",820).
component("YNL270C",814).
component("YNL142W",802).
component("YMR272C",785).
component("YMR202W",778).
component("YMR011W",760).
component("YLR348C",732).
component("YLR260W",720).
component("YLR237W",716).
component("YLR138W",705).
component("YLR100C",703).
component("YLR081W",701).
component("YLL061W",690).
component("YLL043W",688).
component("YKR093W",683).
component("YKR053C",678).
component("YKR039W",677) :- not remove_orf("YKR039W",677).
component("YKL217W",673).
component("YKL004W",642).
component("YJR158W",640).
component("YJR095W",630).
component("YJR077C",628).
component("YJL219W",613).
component("YJL214W",611).
component("YJL134W",603).
component("YJL129C",600).
component("YIL134W",571).
component("YHR096C",536).
component("YHR094C",535).
component("YHR092C",534).
component("YHL036W",517).
component("YGR121C",487).
component("YGR065C",483).
component("YGR055W",480).
component("YGL186C",465).
component("YGL077C",460).
component("YGL008C",447).
component("YFL055W",436).
component("YFL011W",430).
component("YER060W-A",407).
component("YER060W",406).
component("YER056C",405).
component("YER053C",404).
component("YEL069C",395).
component("YEL063C",394).
component("YEL017C-A",386).
component("YDR536W",383).
component("YDR508C",380).
component("YDR503C",379).
component("YDR497C",377).
component("YDR345C",362).
component("YDR343C",361).
component("YDR342C",360).
component("YDR297W",357).
component("YDR046C",330) :- not remove_orf("YDR046C",330).
component("YDL245C",320).
component("YDL210W",316).
component("YCR032W",276).
component("YCR028C",275).
component("YCR024C-A",274).
component("YCL025C",264).
component("YBR298C",260).
component("YBR291C",259).
component("YBR069C",225) :- not remove_orf("YBR069C",225).
component("YBR068C",224) :- not remove_orf("YBR068C",224).
component("YBR036C",222).
component("YBR021W",218).
...
catalyst(2132,23).
catalyst(2220,881).
catalyst(3620,364) :- not remove_reaction(3620,364).
catalyst(2110,442).
catalyst(2190,442).
catalyst(5550,635).
catalyst(5791,714).
...
catalyst(2300,185).
catalyst(3460,149).
catalyst(3600,670) :- not remove_reaction(3600,670).
catalyst(8000,684).
catalyst(3941,840).
catalyst(3942,840).
catalyst(6890,804).
...
catalyst(8020,943).
catalyst(8020,411).
catalyst(1890,671) :- not remove_reaction(1890,671).
catalyst(3630,671) :- not remove_reaction(3630,671).
catalyst(1890,421) :- not remove_reaction(1890,421).
catalyst(3630,421) :- not remove_reaction(3630,421).
catalyst(3740,342).
catalyst(8231,941).
catalyst(8232,941).
catalyst(8231,903).
...
catalyst(8061,935).
catalyst(8062,935).
catalyst(3590,453) :- not remove_reaction(3590,453).
catalyst(10910,453) :- not remove_reaction(10910,453).
catalyst(4570,489).
catalyst(8181,726).
catalyst(8182,726).
catalyst(8181,610).
...
catalyst(8282,331).
catalyst(3840,555).
catalyst(3610,322) :- not remove_reaction(3610,322).
catalyst(7921,864).
catalyst(7922,864).
catalyst(7841,396).
catalyst(7842,396).
...
catalyst(1210,858).
catalyst(1160,852).
catalyst(801,838) :- not remove_reaction(801,838).
catalyst(802,838) :- not remove_reaction(802,838).
catalyst(811,838) :- not remove_reaction(811,838).
catalyst(812,838) :- not remove_reaction(812,838).
catalyst(831,838) :- not remove_reaction(831,838).
catalyst(832,838) :- not remove_reaction(832,838).
catalyst(901,838) :- not remove_reaction(901,838).
catalyst(902,838) :- not remove_reaction(902,838).
catalyst(1180,834).
catalyst(1210,834).
catalyst(700,831).
catalyst(1200,820).
...
catalyst(650,683).
catalyst(6560,678).
catalyst(681,677) :- not remove_reaction(681,677).
catalyst(682,677) :- not remove_reaction(682,677).
catalyst(771,677) :- not remove_reaction(771,677).
catalyst(772,677) :- not remove_reaction(772,677).
catalyst(781,677) :- not remove_reaction(781,677).
catalyst(782,677) :- not remove_reaction(782,677).
catalyst(791,677) :- not remove_reaction(791,677).
catalyst(792,677) :- not remove_reaction(792,677).
catalyst(801,677) :- not remove_reaction(801,677).
catalyst(802,677) :- not remove_reaction(802,677).
catalyst(811,677) :- not remove_reaction(811,677).
catalyst(812,677) :- not remove_reaction(812,677).
catalyst(831,677) :- not remove_reaction(831,677).
catalyst(832,677) :- not remove_reaction(832,677).
catalyst(841,677) :- not remove_reaction(841,677).
catalyst(842,677) :- not remove_reaction(842,677).
catalyst(851,677) :- not remove_reaction(851,677).
catalyst(852,677) :- not remove_reaction(852,677).
catalyst(881,677) :- not remove_reaction(881,677).
catalyst(882,677) :- not remove_reaction(882,677).
catalyst(901,677) :- not remove_reaction(901,677).
catalyst(902,677) :- not remove_reaction(902,677).
catalyst(911,677) :- not remove_reaction(911,677).
catalyst(912,677) :- not remove_reaction(912,677).
catalyst(921,677) :- not remove_reaction(921,677).
catalyst(922,677) :- not remove_reaction(922,677).
catalyst(931,677) :- not remove_reaction(931,677).
catalyst(932,677) :- not remove_reaction(932,677).
catalyst(1191,677) :- not remove_reaction(1191,677).
catalyst(1192,677) :- not remove_reaction(1192,677).
catalyst(390,673).
catalyst(6610,642).
catalyst(1180,640).
catalyst(1210,640).
...
catalyst(1210,360).
catalyst(6650,357).
catalyst(791,330) :- not remove_reaction(791,330).
catalyst(792,330) :- not remove_reaction(792,330).
...
catalyst(1511,259).
catalyst(1512,259).
catalyst(771,225) :- not remove_reaction(771,225).
catalyst(772,225) :- not remove_reaction(772,225).
...
catalyst(851,225) :- not remove_reaction(851,225).
catalyst(852,225) :- not remove_reaction(852,225).
catalyst(901,225) :- not remove_reaction(901,225).
catalyst(902,225) :- not remove_reaction(902,225).
catalyst(791,224) :- not remove_reaction(791,224).
catalyst(792,224) :- not remove_reaction(792,224).
catalyst(801,224) :- not remove_reaction(801,224).
catalyst(802,224) :- not remove_reaction(802,224).
catalyst(811,224) :- not remove_reaction(811,224).
catalyst(812,224) :- not remove_reaction(812,224).
catalyst(831,224) :- not remove_reaction(831,224).
catalyst(832,224) :- not remove_reaction(832,224).
catalyst(841,224) :- not remove_reaction(841,224).
catalyst(842,224) :- not remove_reaction(842,224).
catalyst(851,224) :- not remove_reaction(851,224).
catalyst(852,224) :- not remove_reaction(852,224).
catalyst(901,224) :- not remove_reaction(901,224).
catalyst(902,224) :- not remove_reaction(902,224).
catalyst(6600,222).
catalyst(620,218).
catalyst(540,205).
catalyst(2660,178).
...
modifiable_enzyme(364).
modifiable_enzyme(670).
modifiable_enzyme(671).
modifiable_enzyme(421).
modifiable_enzyme(453).
modifiable_enzyme(322).
modifiable_enzyme(838).
modifiable_enzyme(677).
