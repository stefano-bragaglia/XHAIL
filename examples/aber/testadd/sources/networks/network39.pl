...
component("YLR056W",243).
component("YKR009C",231).
component("YOL086C",297).
component("YMR303C",272).
component("YGL256W",166).
component("YDL168W",96).
component("YBR145W",70).
component("YPL231W",327).
component("U46_",47).
component("YBR149W",71).
component("YGL001C",149).
component("YIL094C",193).
component("U45_",46).
component("YDR127W",105).
component("YOL126C",301).
component("YKL085W",223).
component("YDL078C",90).
component("YNL037C",275).
component("YCL018W",81).
component("YLR355C",260).
component("YDL174C",97).
component("YML086C",265).
component("YGR088W",170).
component("YDR256C",115).
component("YJR078W",217).
component("YJR025C",212).
component("U107_",22).
component("YER070W",141).
component("U36_",43).
component("YPL276W",333).
component("YPL275W",332).
component("YOR388C",318).
component("YOR323C",312).
component("YIL125W",195).
component("U52_",49).
component("YBR166C",73).
component("YKL216W",230).
component("YKR009C",232).
component("YIL160C",198).
component("YGL205W",163).
component("YKR080W",236).
component("YER023W",136).
component("YGR204W",174).
component("YLR142W",248).
component("U62_",51).
component("YHR068W",184).
component("YKL150W",226).
component("YIL043C",191).
component("YPL171C",326).
component("YHR179W",189).
component("YDR353W",119).
component("YNL052W",276).
component("YMR256C",271).
component("YLR395C",262).
component("YLR038C",241).
component("YIL111W",194).
component("YHR051W",183).
component("YGL191W",161).
component("YGL187C",160).
component("YDL067C",89).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",331).
component("YKR069W",235).
component("YJR073C",215).
component("YDL033C",88).
component("YLR172C",250).
component("YLR058C",244).
component("YDR019C",100).
component("YBR176W",74).
component("YDR408C",124).
component("YMR120C",269).
component("YLR028C",239).
component("YBL013W",58).
component("YJL130C",205).
component("YKL024C",221).
component("YPR074C",337).
component("YBR117C",69).
component("YPL231W",328).
component("YPL231W",329).
component("YLR299W",256).
component("YML126C",266).
component("YDL182W",98).
component("YDL131W",93).
component("YLR258W",254).
component("YFR015C",146).
component("YNL029C",274).
component("YIL085C",192).
component("YLR209C",251).
component("U104_",20).
component("YDR354W",120) :- not remove_orf("YDR354W",120).
component("YFR047C",147).
component("YLR209C",252).
component("YML022W",263).
component("YDR441C",126).
component("YJL167W",209).
component("YDR127W",106).
component("YLR303W",258).
component("YJR130C",219).
component("YDR035W",101).
component("YBR249C",76).
component("YOR274W",311).
component("YHR137W",185).
component("YGL202W",162).
component("YLR027C",238).
component("YKL106W",224).
component("YLR089C",245).
component("YJR148W",220).
component("YNR058W",291).
component("YGL253W",165).
component("YFR053C",148).
component("YCR036W",86).
component("U96_",54).
component("YDR236C",113).
component("YNR012W",289).
component("YDR127W",107).
component("YDR147W",110).
component("U76_",52).
component("YDR226W",112).
component("YKL067W",222).
component("YOL055C",295).
component("YDR454C",127).
component("YOL061W",296).
component("YKL181W",227).
component("YHL011C",178).
component("YER099C",143).
component("YBL068W",62).
component("YNL256W",283).
component("YBR018C",65).
component("YGL130W",157).
component("YPR190C",343).
component("YPR187W",342).
component("YPR110C",338).
component("YPR010C",335).
component("YOR341W",316).
component("YOR340C",315).
component("YOR224C",310).
component("YOR210W",309).
component("YOR207C",308).
component("YOR151C",305).
component("YOR116C",304).
component("YOL005C",292).
component("YNR003C",288).
component("YNL248C",282).
component("YNL151C",281).
component("YNL113W",278).
component("YKL144C",225).
component("YJR063W",214).
component("YJL148W",208).
component("YJL140W",207).
component("YIL021W",190).
component("YHR143W-A",186).
...
component("YPR175W",341).
component("YPL167C",325).
component("YOR330C",313).
component("YOL115W",300).
component("YNL299W",286).
component("YNL262W",284).
component("YNL102W",277).
component("YJR043C",213).
component("YJR006W",211).
component("YJL090C",202).
component("YIL139C",196).
...
component("YPR113W",339).
component("YPL148C",324).
component("YOL011W",293).
component("YMR008C",268).
component("YMR006C",267).
component("U105_",21).
component("YBL015W",59).
component("YLR377C",261).
component("U30_",42).
component("U29_",41).
component("U24_",40).
component("YHR044C",182).
component("YHR043C",181).
component("YOR360C",317).
component("YGL027C",153).
component("YOR190W",307).
component("YLR300W",257).
component("YGR282C",177).
component("YDR261C",116).
component("YDR400W",122).
component("YML035C",264).
component("YJL070C",201).
component("YBR284W",79).
component("YDR242W",114).
component("U53_",50).
component("YMR120C",270).
component("YLR028C",240).
component("YHR144C",187).
component("YNL141W",279).
component("YJL126W",203).
component("U39_",44).
...
component("YLR231C",253).
component("YLR134W",247).
component("YLR044C",242).
component("YGR087C",169).
component("YDR380W",121).
component("YDL080C",91).
component("U98_",55).
component("YKL211C",228) :- not remove_orf("YKL211C",228).
component("YKL211C",229) :- not remove_orf("YKL211C",229).
component("YER090W",229) :- not remove_orf("YER090W",229).
component("YER090W",142) :- not remove_orf("YER090W",142).
component("YDR127W",108).
component("YPL281C",334).
component("YOR393W",319).
component("YMR323W",273).
component("YHR174W",188).
component("YGR254W",175).
component("YGL026C",152) :- not remove_orf("YGL026C",152).
component("YLR304C",259).
component("YJL200C",210).
component("YNL316C",287).
component("YCR053W",87).
component("YDR127W",109).
component("YGL148W",158).
component("YIL168W",200).
component("YIL167W",199).
component("YCL064C",83).
component("YAL012W",56).
component("YDR007W",99) :- not remove_orf("YDR007W",99).
component("YOR095C",303).
component("YGL001C",150).
component("YPL117C",323).
component("YPR060C",336).
component("YPL097W",321).
component("YGR185C",173).
component("YGR264C",176).
component("YGR171C",172).
component("YPL104W",322).
component("YLL018C",237).
component("YOL097C",298).
component("YDR268W",117).
component("YHR019C",180).
component("YOR335C",314).
component("YLR153C",249).
component("YAL054C",57).
component("YIL145C",197).
component("U90_",53).
component("YNR057C",290).
component("YGL234W",164).
component("YJR103W",218).
component("YBL039C",61).
component("YGL062W",154).
component("YBR218C",75).
component("YPR138C",340).
component("YPL265W",330).
component("YPL036W",320).
component("YOR171C",306).
component("YOR011W",302).
component("YOL103W",299).
component("YOL020W",294) :- not remove_orf("YOL020W",294).
component("YNL270C",285).
component("YNL142W",280).
component("YLR260W",255).
component("YLR100C",246).
component("YKR053C",234).
component("YKR039W",233) :- not remove_orf("YKR039W",233).
component("YJR077C",216).
component("YJL134W",206).
component("YJL129C",204).
component("YHL036W",179).
component("YGR121C",171).
component("YGR065C",168).
component("YGR055W",167).
component("YGL186C",159).
component("YGL077C",156).
...
catalyst(8812,91).
catalyst(2250,55).
catalyst(3600,228) :- not remove_reaction(3600,228).
catalyst(3630,229) :- not remove_reaction(3630,229).
...
catalyst(22,302).
catalyst(1160,299).
catalyst(801,294) :- not remove_reaction(801,294).
catalyst(802,294) :- not remove_reaction(802,294).
catalyst(811,294) :- not remove_reaction(811,294).
catalyst(812,294) :- not remove_reaction(812,294).
catalyst(831,294) :- not remove_reaction(831,294).
catalyst(832,294) :- not remove_reaction(832,294).
catalyst(901,294) :- not remove_reaction(901,294).
catalyst(902,294) :- not remove_reaction(902,294).
catalyst(931,285).
catalyst(932,285).
catalyst(371,280).
catalyst(372,280).
...
catalyst(931,233) :- not remove_reaction(931,233).
catalyst(932,233) :- not remove_reaction(932,233).
