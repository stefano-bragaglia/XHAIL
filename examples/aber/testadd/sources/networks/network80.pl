...
component("YNL280C",500).
component("YLR056W",429).
component("YGL012W",269).
component("YKR009C",413).
component("YOL086C",519).
component("YMR303C",478).
...
component("U45_",80).
component("YML056C",461).
component("YLR432W",458).
component("YHR216W",340).
component("YAR075W",118).
component("YAR073W",117).
component("YDR127W",198).
component("YOL126C",524).
component("YKL085W",400).
component("YDL078C",173).
component("YNL037C",483).
component("YNL009W",481).
component("YLR174W",439).
component("YCL018W",158).
component("YLR355C",454).
component("YDL174C",186).
component("YML086C",463).
component("YGR088W",297).
component("YDR256C",209).
component("YJR078W",389).
component("YJR025C",382).
component("U107_",24).
component("YJR104C",391).
component("YHR008C",316).
component("YOR384W",554).
component("YOR381W",553).
component("YOL152W",526).
component("YLL051C",423).
component("YJL026W",360).
component("YIL066C",344).
component("YGR180C",300).
component("YER070W",245).
component("U36_",74).
component("YDL168W",184).
component("YBR006W",126).
component("YPL276W",578).
component("YPL275W",577).
component("YOR388C",555).
component("YOR374W",552).
component("YER073W",246).
component("YGL154C",281).
component("U55_",87).
component("YER069W",244).
component("YOR323C",545).
component("YER178W",252).
component("YBR221C",148).
component("YIL125W",350).
component("U52_",85).
component("YBR166C",144).
component("YGL012W",270).
component("YKL216W",412).
component("YKR009C",414).
component("YIL160C",354).
component("YGL205W",286).
component("YMR118C",470).
component("YLR164W",437).
component("YLL041C",422).
component("YKL148C",403).
component("YJL045W",361).
component("YDR178W",205).
component("YEL047C",233).
component("YDL171C",185).
component("U99_",112).
component("U100_",20).
component("YKR080W",419).
component("YER023W",238).
component("YOR236W",543).
...
component("YIL043C",343).
component("YPL171C",565).
component("YHR179W",335).
component("YMR145C",473).
component("YML120C",464).
component("YKL192C",409).
component("YDL085W",175).
component("YGR234W",304).
component("YFR030W",263).
component("YPL017C",557).
component("YFL018C",256).
component("YDR353W",216).
component("YPR167C",590).
component("YJR137C",393).
component("YNL052W",484).
component("YMR256C",477).
component("YLR395C",457).
component("YLR038C",427).
component("YIL111W",347).
...
component("Q0275",19).
component("Q0250",18).
component("YPL266W",576).
component("YKR069W",418).
component("YOL096C",520).
component("U47_",82).
component("YJR073C",387).
component("YDR120C",196).
component("YDL033C",171).
component("YLR172C",438).
component("YLR058C",430).
component("YDR019C",192).
component("YBR176W",145).
component("YDR408C",221).
component("YMR120C",471).
component("YLR028C",425).
component("YBL013W",119).
component("YJL130C",369).
component("YKL024C",398).
component("YPR074C",586).
component("YBR117C",139).
component("YCL009C",157).
component("YNL071W",486).
component("YIL160C",355).
component("U48_",83).
component("YPL231W",571).
component("YPL231W",572).
component("YPL028W",558).
component("YLR299W",447).
component("YGL017W",271).
component("YML126C",465).
component("YNL104C",488).
component("YDL182W",187).
component("YDL131W",179).
component("YLR258W",444).
component("YFR015C",261).
component("YNL029C",482).
component("YIL085C",345).
component("YMR306W",479).
component("YLR342W",453).
component("YGR032W",292).
...
component("YJL167W",374).
component("YDR127W",199).
component("YHR068W",325).
component("YLR303W",449).
component("YGR012W",290).
component("YML082W",462).
component("YJR130C",392).
component("YDR035W",193).
component("YBR249C",149).
component("YOR274W",544).
component("YHR137W",331).
component("YGL202W",285).
component("YLR027C",424).
component("YKL106W",401).
component("YOL140W",525).
component("YGR019W",291).
component("YLR089C",432).
component("U64_",92).
component("U61_",89).
component("YJR148W",394).
component("YFL030W",257).
component("YOR184W",537).
component("YNR058W",509).
component("YIL116W",349).
component("YGL253W",288).
component("YFR053C",265).
component("YMR205C",474).
component("YGR240C",305).
component("YOL016C",513).
component("YFR014C",260).
component("YCR036W",167).
component("YCL040W",160).
component("U15_",41).
component("YPL188W",566).
component("YJR049C",384).
component("YEL041W",231).
component("U96_",110).
component("YKL001C",397).
component("YDR236C",207).
component("YHL032C",314).
component("U83_",106).
component("U81_",105).
component("YMR208W",475).
component("YPL203W",567).
component("YOR061W",529).
component("YKL166C",406).
component("YJL164C",373).
component("YIL035C",342).
component("YHR205W",338).
component("YHR102W",330).
component("YGL019W",272).
component("YHR025W",319).
component("YOR347C",550).
component("YAL038W",115).
component("YNR012W",505).
...
component("YKL067W",399).
component("YOL055C",516).
component("YDR454C",224).
component("YJR057W",385).
component("YOL061W",518).
component("YKL181W",407).
component("YHL011C",313).
component("YER099C",250).
component("YBL068W",124).
component("YOR143C",533).
component("YNL256W",497).
component("YLR328W",451).
component("YBR018C",128).
component("YLR328W",452).
component("U94_",109).
component("YBR029C",131).
component("YGL130W",279).
component("YDR530C",228).
component("YPR190C",593).
component("YPR187W",592).
component("YPR110C",587).
component("YPR010C",581).
component("YOR341W",549).
component("YOR340C",548).
component("YOR224C",542).
component("YOR210W",541).
component("YOR207C",539).
component("YOR151C",534).
component("YOR116C",531).
component("YOL005C",511).
component("YNR003C",504).
component("YNL248C",496).
component("YNL151C",492).
component("YNL113W",489).
component("YKL144C",402).
component("YJR063W",386).
component("YJL148W",372).
component("YJL140W",371).
component("YIL021W",341).
component("YHR143W-A",332).
component("YGL070C",277).
component("YFL036W",258).
...
component("YPR175W",591).
component("YPL167C",564).
component("YOR330C",546).
component("YOL115W",523).
component("YNL299W",502).
component("YNL262W",498).
component("YNL102W",487).
component("YJR043C",383).
component("YJR006W",380).
...
component("YPR113W",588).
component("YPL148C",563).
component("YGR286C",310).
component("YHR189W",336).
component("YDL086W",176).
component("YOL011W",512).
component("YMR008C",467).
component("YMR006C",466).
component("U105_",22).
component("YBL015W",120).
component("YJL068C",362).
component("U77_",103).
component("YLR377C",456).
component("YPR073C",584).
...
component("YPR073C",585).
component("YOR208W",540).
component("YNL053W",485).
component("YMR036C",469).
component("YIR026C",359).
component("YIL113W",348).
component("YFR028C",262).
component("YER075C",247).
...
component("YOR360C",551).
component("YKR031C",415).
component("YPL206C",568).
component("YGL027C",274).
component("YLR286C",446).
component("YJR153W",395).
component("YJL221C",379).
component("YJL216C",377).
component("YIL172C",358).
component("YGR292W",312).
component("YGR287C",311).
component("YBR299W",156).
component("YOR190W",538).
component("YLR300W",448).
...
component("U53_",86).
component("YPR062W",583).
component("YMR120C",472).
component("YLR028C",426).
component("YHR144C",333).
component("YBL033C",121).
component("YNL141W",490).
component("YLR245C",443).
...
component("U98_",111).
component("YMR250W",476).
component("YOR128C",532).
component("U93_",108).
component("YKL211C",410) :- not remove_orf("YKL211C",410).
component("YKR097W",420).
component("YNL169C",493).
...
component("YPL281C",579).
component("YOR393W",556).
component("YMR323W",480).
component("YHR174W",334).
component("YGR254W",307).
component("YPL262W",574).
component("YGL026C",273) :- not remove_orf("YGL026C",273).
component("YLR304C",450).
component("YJL200C",375).
component("YNL316C",503).
component("YPL212C",569).
component("YNL292W",501).
component("YGL063W",276).
component("YFL001W",254).
component("YPR002W",580).
component("YJR016C",381).
component("YCR053W",168).
component("YDR127W",202).
component("YGL148W",280).
component("YIL168W",357).
component("YIL167W",356).
...
component("YOR095C",530).
component("YBR196C",146).
component("YGL001C",267).
component("YPL117C",562).
component("U14_",35).
component("YOL056W",517).
component("YKL152C",405).
component("YDL021W",169).
component("YPR060C",582).
component("YPL097W",560).
component("YGR185C",301).
component("YGR264C",308).
component("YGR171C",299).
component("YPL104W",561).
component("YLL018C",421).
component("YHR020W",318).
component("YER087W",248).
component("YNL247W",495).
component("YOR168W",535).
component("YOL097C",521).
component("YDR268W",211).
component("YCR024C",164).
component("YHR019C",317).
component("YOR335C",547).
component("YLR153C",436).
component("YAL054C",116).
component("YGR244C",306).
component("YIL145C",353).
component("YJL101C",365).
component("YOL049W",515).
component("YER183C",253).
component("U90_",107).
component("YNR057C",508).
component("YGL234W",287).
component("YJR103W",390).
component("YBL039C",123).
component("YGR204W",303).
component("YBR084W",135).
component("YNL220W",494).
component("YDL141W",181).
component("YHR074W",326).
component("YGL062W",275).
component("YBR218C",147).
component("YPL231W",573).
component("YNR016C",506).
component("YKL182W",408).
component("YGR037C",293).
component("YPR138C",589).
component("YPL265W",575).
component("YPL036W",559).
component("YOR171C",536).
component("YOR011W",528).
component("YOL156W",527).
component("YOL103W",522).
component("YOL020W",514) :- not remove_orf("YOL020W",514).
component("YNR072W",510).
component("YNL270C",499).
component("YNL142W",491).
component("YMR011W",468).
component("YLR260W",445).
component("YLR100C",433).
component("YLR081W",431).
component("YKR053C",417).
component("YKR039W",416) :- not remove_orf("YKR039W",416).
component("YJR158W",396).
component("YJR077C",388).
component("YJL219W",378).
component("YJL214W",376).
component("YJL134W",370).
component("YJL129C",368).
component("YIL134W",351).
component("YHR096C",329).
component("YHR094C",328).
component("YHR092C",327).
component("YHL036W",315).
component("YGR121C",298).
component("YGR065C",295).
component("YGR055W",294).
component("YGL186C",282).
component("YGL077C",278).
component("YGL008C",268).
component("YFL055W",259).
component("YFL011W",255).
...
catalyst(1890,249) :- not remove_reaction(1890,249).
...
catalyst(1210,527).
catalyst(1160,522).
catalyst(801,514) :- not remove_reaction(801,514).
catalyst(802,514) :- not remove_reaction(802,514).
catalyst(811,514) :- not remove_reaction(811,514).
catalyst(812,514) :- not remove_reaction(812,514).
catalyst(831,514) :- not remove_reaction(831,514).
catalyst(832,514) :- not remove_reaction(832,514).
catalyst(901,514) :- not remove_reaction(901,514).
catalyst(902,514) :- not remove_reaction(902,514).
catalyst(1210,510).
catalyst(931,499).
catalyst(932,499).
catalyst(371,491).
...
catalyst(1210,431).
catalyst(6560,417).
catalyst(771,416) :- not remove_reaction(771,416).
catalyst(772,416) :- not remove_reaction(772,416).
catalyst(781,416) :- not remove_reaction(781,416).
catalyst(782,416) :- not remove_reaction(782,416).
catalyst(801,416) :- not remove_reaction(801,416).
catalyst(802,416) :- not remove_reaction(802,416).
catalyst(811,416) :- not remove_reaction(811,416).
catalyst(812,416) :- not remove_reaction(812,416).
catalyst(831,416) :- not remove_reaction(831,416).
catalyst(832,416) :- not remove_reaction(832,416).
catalyst(841,416) :- not remove_reaction(841,416).
catalyst(842,416) :- not remove_reaction(842,416).
catalyst(851,416) :- not remove_reaction(851,416).
catalyst(852,416) :- not remove_reaction(852,416).
catalyst(881,416) :- not remove_reaction(881,416).
catalyst(882,416) :- not remove_reaction(882,416).
catalyst(901,416) :- not remove_reaction(901,416).
catalyst(902,416) :- not remove_reaction(902,416).
catalyst(921,416) :- not remove_reaction(921,416).
catalyst(922,416) :- not remove_reaction(922,416).
catalyst(931,416) :- not remove_reaction(931,416).
catalyst(932,416) :- not remove_reaction(932,416).
catalyst(1191,416) :- not remove_reaction(1191,416).
catalyst(1192,416) :- not remove_reaction(1192,416).
catalyst(1210,396).
catalyst(1581,388).
catalyst(1582,388).
catalyst(1210,378).
