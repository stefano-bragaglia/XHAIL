...
component("YLR056W",186).
component("YPL231W",246).
component("U46_",37).
component("YBR149W",56).
component("YGL001C",120).
component("YIL094C",148).
component("U45_",36).
component("YDR127W",83).
component("YOL126C",225).
component("YDL078C",71).
component("YNL037C",204).
component("YML086C",200).
component("YGR088W",130).
component("YDR256C",91).
component("YJR078W",166).
component("U107_",19).
component("YER070W",113).
component("U36_",33).
component("YPL276W",252).
component("YPL275W",251).
component("YOR388C",239).
component("YOR323C",234).
component("YIL125W",149).
component("U52_",39).
component("YBR166C",58).
component("YKL216W",177).
component("YKR009C",178).
component("YIL160C",151).
component("YGL205W",127).
component("YKR080W",181).
component("YER023W",109).
component("YLR142W",189).
component("U62_",41).
component("YHR068W",139).
component("YKL150W",173).
component("YIL043C",146).
component("YPL171C",245).
component("YHR179W",144).
component("YDR353W",95).
component("YPL266W",250).
component("YDL033C",70).
component("YLR058C",187).
component("YDR019C",78).
component("YBR176W",59).
component("YDR408C",99).
component("YMR120C",201).
component("YLR028C",184).
component("YPR074C",256).
component("YBR117C",55).
component("YPL231W",247).
component("YPL231W",248).
component("YLR299W",195).
component("YDL182W",76).
component("YDL131W",73).
component("YLR258W",194).
component("YFR015C",118).
component("YNL029C",203).
component("YIL085C",147).
component("YLR209C",191).
component("YDR354W",96) :- not remove_orf("YDR354W",96).
component("YFR047C",119).
component("YLR209C",192).
component("YML022W",198).
component("YDR441C",101).
component("YJL167W",161).
component("YDR127W",84).
component("YJR130C",168).
component("YDR035W",79).
component("YBR249C",61).
component("YOR274W",233).
component("YHR137W",140).
component("YLR027C",183).
component("YKL106W",171).
component("YJR148W",169).
component("YNR058W",218).
component("YCR036W",69).
component("U96_",43).
component("YNR012W",216).
component("YDR127W",85).
component("YDR226W",89).
component("YKL067W",170).
component("YDR454C",102).
component("YOL061W",221).
component("YKL181W",174).
component("YHL011C",137).
component("YER099C",115).
component("YBL068W",49).
component("YNL256W",210).
component("YBR018C",51).
component("YPR190C",262).
component("YPR187W",261).
component("YPR110C",257).
component("YPR010C",254).
component("YOR341W",238).
component("YOR340C",237).
component("YOR224C",232).
component("YOR210W",231).
component("YOR207C",230).
component("YOR151C",228).
component("YOR116C",227).
component("YOL005C",219).
component("YNR003C",215).
component("YNL248C",209).
component("YNL151C",208).
component("YNL113W",206).
component("YKL144C",172).
component("YJR063W",164).
component("YJL148W",160).
component("YJL140W",159).
component("YIL021W",145).
component("YHR143W-A",141).
component("YGL070C",124).
component("YFL036W",116).
component("YDR404C",98).
component("YDR156W",88).
component("YDR045C",80).
component("YDL150W",75).
component("YDL140C",74).
component("YBR154C",57).
component("YPR175W",260).
component("YPL167C",244).
component("YOR330C",235).
component("YOL115W",224).
component("YNL299W",213).
component("YNL262W",211).
component("YNL102W",205).
component("YJR043C",163).
component("YJR006W",162).
component("YJL090C",155).
component("YIL139C",150).
component("YEL055C",106).
component("YDR419W",100).
component("YDR121W",82).
component("YDL102W",72).
component("YCR014C",68).
component("YBR278W",63).
component("YBL035C",47).
component("YPR113W",258).
component("U105_",18).
component("YLR377C",197).
component("U30_",32).
component("U29_",31).
component("U24_",30).
component("YGL027C",122).
component("YOR190W",229).
component("YLR300W",196).
component("YGR282C",136).
component("YDR261C",92).
component("YDR400W",97).
component("YML035C",199).
component("YJL070C",154).
component("YBR284W",64).
component("YDR242W",90).
component("U53_",40).
component("YLR028C",185).
component("YHR144C",142).
component("YJL126W",156).
component("U39_",34).
...
component("U98_",44).
component("YKL211C",175) :- not remove_orf("YKL211C",175).
component("YKL211C",176) :- not remove_orf("YKL211C",176).
component("YER090W",176) :- not remove_orf("YER090W",176).
component("YER090W",114) :- not remove_orf("YER090W",114).
component("YDR127W",86).
component("YPL281C",253).
component("YOR393W",240).
component("YMR323W",202).
component("YHR174W",143).
component("YGR254W",134).
component("YGL026C",121) :- not remove_orf("YGL026C",121).
component("YNL316C",214).
component("YDR127W",87).
component("YGL148W",125).
component("YIL168W",153).
component("YIL167W",152).
component("YCL064C",67).
component("YAL012W",45).
component("YDR007W",77) :- not remove_orf("YDR007W",77).
component("YOR095C",226).
component("YPL117C",243).
component("YPR060C",255).
component("YPL097W",241).
component("YGR185C",133).
component("YGR264C",135).
component("YGR171C",132).
component("YPL104W",242).
component("YLL018C",182).
component("YOL097C",222).
component("YDR268W",93).
component("YOR335C",236).
component("YLR153C",190).
component("YAL054C",46).
component("U90_",42).
component("YNR057C",217).
component("YJR103W",167).
component("YBL039C",48).
component("YGL062W",123).
component("YBR218C",60).
component("YPR138C",259).
component("YPL265W",249).
component("YOL103W",223).
component("YOL020W",220) :- not remove_orf("YOL020W",220).
component("YNL270C",212).
component("YNL142W",207).
component("YLR100C",188).
component("YKR053C",180).
component("YKR039W",179) :- not remove_orf("YKR039W",179).
component("YJR077C",165).
component("YJL134W",158).
component("YJL129C",157).
component("YHL036W",138).
component("YGR121C",131).
component("YGR065C",129).
component("YGR055W",128).
component("YGL186C",126).
component("YFL055W",117).
component("YER060W-A",112).
component("YER060W",111).
component("YER056C",110).
component("YEL063C",107).
component("YDR536W",105).
component("YDR508C",104).
component("YDR497C",103).
component("YDR297W",94).
...
catalyst(5601,191).
catalyst(5602,191).
catalyst(3620,96) :- not remove_reaction(3620,96).
catalyst(2190,119).
catalyst(5791,192).
catalyst(5792,192).
catalyst(5801,192).
...
catalyst(3500,193).
catalyst(2250,44).
catalyst(3600,175) :- not remove_reaction(3600,175).
...
catalyst(8231,134).
catalyst(8232,134).
catalyst(3590,121) :- not remove_reaction(3590,121).
catalyst(10910,121) :- not remove_reaction(10910,121).
catalyst(3680,214).
catalyst(3750,87).
catalyst(3700,125).
catalyst(8751,153).
...
catalyst(6330,188).
catalyst(6560,180).
catalyst(771,179) :- not remove_reaction(771,179).
catalyst(772,179) :- not remove_reaction(772,179).
catalyst(781,179) :- not remove_reaction(781,179).
catalyst(782,179) :- not remove_reaction(782,179).
...
catalyst(881,179) :- not remove_reaction(881,179).
catalyst(882,179) :- not remove_reaction(882,179).
catalyst(931,179) :- not remove_reaction(931,179).
catalyst(932,179) :- not remove_reaction(932,179).
catalyst(1191,179) :- not remove_reaction(1191,179).
catalyst(1192,179) :- not remove_reaction(1192,179).
catalyst(1581,165).
catalyst(1582,165).
catalyst(6560,158).
catalyst(361,157).
