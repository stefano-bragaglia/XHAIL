...
component("YNL280C",511).
component("YLR056W",438).
component("YGL012W",278).
component("YKR009C",422).
component("YOL086C",531).
component("YMR303C",488).
component("YGL256W",298).
component("YDL168W",189).
component("YBR145W",145).
component("YPL231W",582).
component("YBR265W",156).
component("U46_",85).
component("YBR149W",146).
component("YBR149W",147).
component("YGL001C",275).
component("YIL094C",355).
component("U45_",84).
component("YML056C",471).
component("YLR432W",468).
component("YHR216W",349).
component("YAR075W",123).
component("YAR073W",122).
component("YDR127W",204).
component("YOL126C",536).
component("YKL085W",409).
component("YDL078C",179).
component("YNL037C",493).
component("YNL009W",491).
component("YLR174W",448).
component("YOL059W",529).
component("YDL022W",175).
component("YCL018W",163).
component("YLR355C",464).
component("YDL174C",192).
component("YML086C",473).
component("YGR088W",306).
component("YDR256C",215).
component("YJR078W",398).
component("YJR025C",391).
component("U107_",24).
component("YJR104C",400).
component("YHR008C",325).
component("YOR384W",566).
component("YOR381W",565).
component("YOL152W",538).
component("YLL051C",432).
component("YJL026W",369).
component("YIL066C",353).
component("YGR180C",309).
component("YER070W",254).
component("U37_",78).
component("U36_",77).
component("YDL168W",190).
component("YBR006W",131).
component("YPL276W",590).
component("YPL275W",589).
component("YOR388C",567).
component("YOR374W",564).
component("YER073W",255).
component("YGL154C",290).
component("U55_",91).
component("YER069W",252).
component("YOR323C",557).
component("YER178W",261).
component("YBR221C",153).
component("YIL125W",359).
component("U52_",89).
component("YBR166C",149).
component("YGL012W",279).
component("YKL216W",421).
component("YKR009C",423).
component("YIL160C",363).
component("YGL205W",295).
component("YMR118C",480).
component("YLR164W",446).
component("YLL041C",431).
component("YKL148C",412).
component("YJL045W",370).
component("YDR178W",211).
component("YEL047C",241).
component("YDL171C",191).
component("U99_",116).
component("U100_",20).
component("YKR080W",428).
component("YER023W",246).
component("YOR236W",555).
component("YGR204W",311).
component("YLR142W",444).
component("U65_",97).
component("U63_",95).
component("U62_",94).
component("YHR068W",333).
component("YKL150W",413).
component("YIL043C",352).
component("YPL171C",577).
component("YHR179W",344).
component("YMR145C",483).
component("YML120C",474).
component("YKL192C",418).
component("YDL085W",181).
component("YGR234W",313).
component("YFR030W",272).
component("YPL017C",569).
component("YFL018C",265).
component("YDR353W",222).
component("YPR167C",602).
component("YJR137C",402).
component("YNL052W",494).
component("YMR256C",487).
component("YLR395C",467).
component("YLR038C",436).
component("YIL111W",356).
component("YHR051W",332).
component("YGL191W",293).
component("YGL187C",292).
component("YDL067C",178).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",588).
component("YKR069W",427).
component("YOL096C",532).
component("U47_",86).
component("YJR073C",396).
component("YDR120C",202).
component("YDL033C",177).
component("YLR172C",447).
component("YLR058C",439).
component("YDR019C",198).
component("YBR176W",150).
component("YDR408C",227).
component("YMR120C",481).
component("YLR028C",434).
component("YBL013W",124).
component("YJL130C",378).
component("YKL024C",407).
component("YPR074C",598).
component("YBR117C",144).
component("YCL009C",162).
component("YNL071W",496).
component("YIL160C",364).
component("U48_",87).
component("YPL231W",583).
component("YPL231W",584).
component("YPL028W",570).
component("YLR299W",457).
component("YGL017W",280).
component("YML126C",475).
component("YNL104C",499).
component("YDL182W",193).
component("YDL131W",185).
component("YLR258W",454).
component("YFR015C",270).
component("YNL029C",492).
component("YIL085C",354).
component("YMR306W",489).
component("YLR342W",463).
component("YGR032W",301).
component("YLR209C",450).
component("U104_",21).
component("YDR354W",223) :- not remove_orf("YDR354W",223).
component("YFR047C",273).
component("YLR209C",451).
component("YML022W",469).
component("YDR441C",229).
component("YJL167W",383).
component("YDR127W",205).
component("YHR068W",334).
component("YLR303W",459).
component("YGR012W",299).
component("YML082W",472).
component("YJR130C",401).
component("YDR035W",199).
component("YBR249C",154).
component("YLR180W",449).
component("YDR502C",232).
component("YOR274W",556).
component("YHR137W",340).
component("YGL202W",294).
component("YLR027C",433).
component("YKL106W",410).
component("YOL140W",537).
component("YGR019W",300).
component("YLR089C",441).
component("U64_",96).
component("U61_",93).
component("YJR148W",403).
component("YFL030W",266).
component("YOR184W",549).
component("YNR058W",520).
component("YIL116W",358).
component("YGL253W",297).
component("YFR053C",274).
component("YMR205C",484).
component("YGR240C",314).
component("YOL016C",524).
component("YFR014C",269).
component("YCR036W",172).
component("YCL040W",165).
component("U15_",43).
component("YPL188W",578).
component("YJR049C",393).
component("YEL041W",239).
component("U96_",114).
component("YKL001C",406).
component("YDR236C",213).
component("YHL032C",323).
component("YDR531W",236).
component("U83_",110).
component("U81_",109).
component("YMR208W",485).
component("YPL203W",579).
component("YOR061W",541).
component("YKL166C",415).
component("YJL164C",382).
component("YIL035C",351).
component("YHR205W",347).
component("YHR102W",339).
component("YGL019W",281).
component("YHR025W",328).
component("YOR347C",562).
component("YAL038W",119).
component("YNR012W",516).
component("YDR127W",206).
component("YDR147W",209).
component("YCR012W",167).
component("YER069W",253).
component("U76_",106).
component("YER170W",260).
component("YDR226W",212).
component("YKL067W",408).
component("YOL055C",527).
component("YDR454C",230).
component("YJR057W",394).
component("YOL061W",530).
component("YKL181W",416).
component("YHL011C",322).
component("YER099C",259).
component("YBL068W",129).
component("YOR143C",545).
component("YNL256W",508).
component("YLR328W",461).
component("YBR018C",133).
component("YLR328W",462).
component("U94_",113).
component("YBR029C",136).
component("YGL130W",288).
component("YDR530C",235).
component("YPR190C",605).
component("YPR187W",604).
component("YPR110C",599).
component("YPR010C",593).
component("YOR341W",561).
component("YOR340C",560).
component("YOR224C",554).
component("YOR210W",553).
component("YOR207C",551).
component("YOR151C",546).
component("YOR116C",543).
component("YOL005C",522).
component("YNR003C",515).
component("YNL248C",507).
component("YNL151C",503).
component("YNL113W",500).
component("YKL144C",411).
component("YJR063W",395).
component("YJL148W",381).
component("YJL140W",380).
component("YIL021W",350).
component("YHR143W-A",341).
component("YGL070C",286).
component("YFL036W",267).
component("YDR404C",226).
component("YDR156W",210).
component("YDR045C",200).
component("YDL150W",188).
component("YDL140C",186).
component("YBR154C",148).
component("YPR175W",603).
component("YPL167C",576).
component("YOR330C",558).
component("YOL115W",535).
component("YNL299W",513).
component("YNL262W",509).
component("YNL102W",498).
component("YJR043C",392).
component("YJR006W",389).
component("YJL090C",373).
component("YIL139C",361).
component("YEL055C",242).
component("YDR419W",228).
component("YDR121W",203).
component("YDL102W",184).
component("YCR014C",168).
component("YBR278W",158).
component("YBL035C",127).
component("YPR113W",600).
component("YPL148C",575).
component("YGR286C",319).
component("YHR189W",345).
...
component("YJL068C",371).
component("U77_",107).
component("YLR377C",466).
component("YPR073C",596).
component("YHR215W",348).
component("YDL024C",176).
component("YBR093C",142).
component("YBR092C",141).
component("YHR046C",331).
component("U9_",117).
component("YDL236W",195).
component("YPR073C",597).
component("YOR208W",552).
component("YNL053W",495).
component("YMR036C",479).
component("YIR026C",368).
component("YIL113W",357).
component("YFR028C",271).
component("YER075C",256).
component("YDL230W",194).
...
component("U25_",70).
component("U24_",69).
component("YHR044C",330).
component("YHR043C",329).
component("YOR360C",563).
component("YKR031C",424).
component("YPL206C",580).
component("YGL027C",283).
component("YLR286C",456).
component("YJR153W",404).
component("YJL221C",388).
component("YJL216C",386).
component("YIL172C",367).
component("YGR292W",321).
component("YGR287C",320).
component("YBR299W",161).
component("YOR190W",550).
component("YLR300W",458).
component("YGR282C",318).
component("YDR261C",216).
component("YDR400W",225).
component("YML035C",470).
component("YJL070C",372).
component("YBR284W",159).
component("U106_",23).
component("YER043C",247).
component("YDR242W",214).
component("U53_",90).
component("YPR062W",595).
component("YMR120C",482).
component("YLR028C",435).
component("YHR144C",342).
component("YBL033C",126).
component("YNL141W",501).
component("YLR245C",453).
component("YBR084W",139).
component("YJL126W",376).
component("U44_",83).
component("YDL100C",183).
component("U40_",81).
component("U39_",79).
component("YBR011C",132).
component("YHR201C",346).
component("YBR111C",143).
component("YBR252W",155).
component("YER005W",245).
component("YBL099W",130).
component("YLR231C",452).
component("YLR134W",443).
component("YLR044C",437).
component("YGR087C",305).
component("YDR380W",224).
component("YDL080C",180).
component("U98_",115).
component("YMR250W",486).
component("YOR128C",544).
component("U93_",112).
component("YKL211C",419) :- not remove_orf("YKL211C",419).
component("YKR097W",429).
component("YNL169C",504).
component("YEL046C",240).
component("YNR033W",518).
component("YKL211C",420) :- not remove_orf("YKL211C",420).
component("YER090W",420) :- not remove_orf("YER090W",420).
component("YER090W",258) :- not remove_orf("YER090W",258).
component("YDR127W",207).
component("YPL281C",591).
component("YOR393W",568).
component("YMR323W",490).
component("YHR174W",343).
component("YGR254W",316).
component("YPL262W",586).
component("YGL026C",282) :- not remove_orf("YGL026C",282).
component("YLR304C",460).
component("YJL200C",384).
component("YNL316C",514).
component("YPL212C",581).
component("YNL292W",512).
component("YGL063W",285).
component("YFL001W",263).
component("YPR002W",592).
component("YJR016C",390).
component("YCR053W",173).
component("YDR127W",208).
component("YGL148W",289).
component("YIL168W",366).
component("YIL167W",365).
component("YCL064C",166).
component("YLR359W",465).
component("YAL012W",118).
component("YJL121C",375).
component("YBR019C",134).
component("YDR007W",197) :- not remove_orf("YDR007W",197).
component("YOR095C",542).
component("YBR196C",151).
component("YGL001C",276).
component("YPL117C",574).
component("U14_",37).
component("YOL056W",528).
component("YKL152C",414).
component("YDL021W",174).
component("YPR060C",594).
component("YPL097W",572).
component("YGR185C",310).
component("YGR264C",317).
component("YGR171C",308).
component("YPL104W",573).
component("YLL018C",430).
component("YHR020W",327).
component("YER087W",257).
component("YNL247W",506).
component("YOR168W",547).
component("YOL097C",533).
component("YDR268W",217).
component("YCR024C",169).
component("YHR019C",326).
component("YNL073W",497).
component("YOR335C",559).
component("YLR153C",445).
component("YAL054C",120).
component("YGR244C",315).
component("YIL145C",362).
component("YJL101C",374).
component("YOL049W",526).
component("YAR015W",121).
component("YER183C",262).
component("U90_",111).
component("YNR057C",519).
component("YGL234W",296).
component("YJR103W",399).
component("YBL039C",128).
component("YGR204W",312).
component("YBR084W",140).
component("YNL220W",505).
component("YDL141W",187).
component("YHR074W",335).
component("YGL062W",284).
component("YBR218C",152).
component("YPL231W",585).
component("YNR016C",517).
component("YKL182W",417).
component("YGR037C",302).
component("YPR138C",601).
component("YPL265W",587).
component("YPL036W",571).
component("YOR171C",548).
component("YOR011W",540).
component("YOL156W",539).
component("YOL103W",534).
component("YOL020W",525) :- not remove_orf("YOL020W",525).
component("YNR072W",521).
component("YNL270C",510).
component("YNL142W",502).
component("YMR011W",478).
component("YLR260W",455).
component("YLR100C",442).
component("YLR081W",440).
component("YKR053C",426).
component("YKR039W",425) :- not remove_orf("YKR039W",425).
component("YJR158W",405).
component("YJR077C",397).
component("YJL219W",387).
component("YJL214W",385).
component("YJL134W",379).
component("YJL129C",377).
component("YIL134W",360).
component("YHR096C",338).
component("YHR094C",337).
component("YHR092C",336).
component("YHL036W",324).
component("YGR121C",307).
component("YGR065C",304).
component("YGR055W",303).
component("YGL186C",291).
component("YGL077C",287).
component("YGL008C",277).
component("YFL055W",268).
component("YFL011W",264).
component("YER060W-A",251).
component("YER060W",250).
component("YER056C",249).
component("YER053C",248).
component("YEL069C",244).
component("YEL063C",243).
component("YEL017C-A",238).
component("YDR536W",237).
component("YDR508C",234).
component("YDR503C",233).
component("YDR497C",231).
component("YDR345C",221).
component("YDR343C",220).
component("YDR342C",219).
component("YDR297W",218).
component("YDR046C",201) :- not remove_orf("YDR046C",201).
component("YDL245C",196).
component("YCR032W",171).
component("YCR024C-A",170).
component("YCL025C",164).
component("YBR298C",160).
...
catalyst(6112,544).
catalyst(2300,112).
catalyst(3600,419) :- not remove_reaction(3600,419).
catalyst(8000,429).
catalyst(6890,504).
catalyst(4560,240).
catalyst(2550,518).
...
catalyst(1890,258) :- not remove_reaction(1890,258).
catalyst(3630,258) :- not remove_reaction(3630,258).
catalyst(3740,207).
catalyst(8231,591).
catalyst(8232,591).
catalyst(8231,568).
...
catalyst(8051,586).
catalyst(8052,586).
catalyst(3590,282) :- not remove_reaction(3590,282).
catalyst(10910,282) :- not remove_reaction(10910,282).
catalyst(8181,460).
catalyst(8182,460).
catalyst(8181,384).
catalyst(8182,384).
...
catalyst(7751,134).
catalyst(7752,134).
catalyst(3610,197) :- not remove_reaction(3610,197).
catalyst(7921,542).
catalyst(7922,542).
catalyst(8341,151).
catalyst(8342,151).
...
catalyst(1210,539).
catalyst(1160,534).
catalyst(801,525) :- not remove_reaction(801,525).
catalyst(802,525) :- not remove_reaction(802,525).
catalyst(811,525) :- not remove_reaction(811,525).
catalyst(812,525) :- not remove_reaction(812,525).
catalyst(831,525) :- not remove_reaction(831,525).
catalyst(832,525) :- not remove_reaction(832,525).
catalyst(901,525) :- not remove_reaction(901,525).
catalyst(902,525) :- not remove_reaction(902,525).
catalyst(1210,521).
catalyst(931,510).
catalyst(932,510).
catalyst(371,502).
...
catalyst(1210,440).
catalyst(6560,426).
catalyst(771,425) :- not remove_reaction(771,425).
catalyst(772,425) :- not remove_reaction(772,425).
catalyst(781,425) :- not remove_reaction(781,425).
catalyst(782,425) :- not remove_reaction(782,425).
catalyst(801,425) :- not remove_reaction(801,425).
catalyst(802,425) :- not remove_reaction(802,425).
catalyst(811,425) :- not remove_reaction(811,425).
catalyst(812,425) :- not remove_reaction(812,425).
catalyst(831,425) :- not remove_reaction(831,425).
catalyst(832,425) :- not remove_reaction(832,425).
catalyst(841,425) :- not remove_reaction(841,425).
catalyst(842,425) :- not remove_reaction(842,425).
catalyst(851,425) :- not remove_reaction(851,425).
catalyst(852,425) :- not remove_reaction(852,425).
catalyst(881,425) :- not remove_reaction(881,425).
catalyst(882,425) :- not remove_reaction(882,425).
catalyst(901,425) :- not remove_reaction(901,425).
catalyst(902,425) :- not remove_reaction(902,425).
catalyst(921,425) :- not remove_reaction(921,425).
catalyst(922,425) :- not remove_reaction(922,425).
catalyst(931,425) :- not remove_reaction(931,425).
catalyst(932,425) :- not remove_reaction(932,425).
catalyst(1191,425) :- not remove_reaction(1191,425).
catalyst(1192,425) :- not remove_reaction(1192,425).
catalyst(1210,405).
catalyst(1581,397).
catalyst(1582,397).
catalyst(1210,387).
...
catalyst(851,138) :- not remove_reaction(851,138).
catalyst(852,138) :- not remove_reaction(852,138).
catalyst(901,138) :- not remove_reaction(901,138).
catalyst(902,138) :- not remove_reaction(902,138).
...
catalyst(851,137) :- not remove_reaction(851,137).
catalyst(852,137) :- not remove_reaction(852,137).
catalyst(901,137) :- not remove_reaction(901,137).
catalyst(902,137) :- not remove_reaction(902,137).
catalyst(620,135).
catalyst(6960,108).
catalyst(2920,105).
catalyst(2920,104).
