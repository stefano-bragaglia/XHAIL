...
component("YNL280C",677).
component("YLR056W",580).
component("YGR060W",405).
component("YGL012W",377).
component("YKR009C",562).
component("YOL086C",703).
component("YMR303C",651).
component("YMR083W",638).
component("YGL256W",399).
component("YDL168W",256).
component("YBR145W",193).
component("YPL231W",765).
component("YBR265W",209).
component("U46_",114).
component("YBR149W",194).
component("YBR149W",195).
component("YGL001C",374).
component("YIL094C",473).
component("U45_",113).
component("YML056C",626).
component("YLR432W",616).
component("YHR216W",465).
component("YAR075W",165).
component("YAR073W",164).
component("YDR127W",281).
component("YJR139C",536).
component("YML075C",628).
component("YLR450W",619).
component("YOL126C",709).
component("YKL085W",544).
component("YDL078C",241).
component("YNL037C",656).
component("YNL009W",654).
component("YLR174W",593).
component("YHR183W",458).
component("YGR256W",424).
component("YNL241C",670).
component("YOL059W",700).
component("YDL022W",234).
component("YCL018W",217).
component("YLR355C",611).
component("YIL074C",470).
component("YER081W",349).
component("YDL174C",260).
component("YML086C",630).
component("YIL155C",482).
component("YGR088W",408).
component("YDR256C",295).
component("YKL026C",542).
component("YIR037W",492).
component("YBR244W",204).
component("YJR078W",529).
component("U58_",123).
component("YJR025C",521).
component("U107_",24).
component("YHR007C",434).
component("YDR402C",309).
component("YGL055W",384).
component("YJR104C",531).
component("YHR008C",435).
component("YOR384W",745).
component("YOR381W",744).
component("YOL152W",711).
component("YLL051C",573).
component("YJL026W",494).
component("YIL066C",469).
component("YGR180C",414).
component("YER070W",346).
component("U37_",107).
component("U36_",106).
component("U35_",105).
component("YDL168W",257).
component("YDR158W",289).
component("YJR009C",518).
component("YJL052W",496).
component("YGR192C",416).
component("YBR006W",175).
component("YPL276W",773).
component("YPL275W",772).
component("YOR388C",746).
component("YOR374W",742).
component("YER073W",347).
component("YGL154C",391).
component("YBR115C",189).
component("U55_",122).
component("YER069W",344).
component("YOR323C",734).
component("YER178W",358).
component("YBR221C",202).
component("YIL125W",478).
component("U52_",119).
component("YBR166C",197).
component("YGL012W",378).
component("YKL182W",553).
component("YKL216W",561).
component("YDR044W",272).
component("YKR009C",563).
component("YIL160C",483).
component("YGL205W",396).
component("YMR118C",640).
component("YLR164W",591).
component("YLL041C",572).
component("YKL148C",548).
component("YKL141W",546).
component("YJL045W",495).
component("YDR178W",290).
component("YEL047C",329).
component("YDL171C",258).
component("YDL171C",259).
component("YOR375C",743).
...
component("YGR204W",418).
component("YIR034C",491).
component("YLR142W",588).
component("U65_",129).
component("U63_",127).
component("U62_",126).
component("YHR068W",444).
component("YKL150W",549).
component("YIL043C",468).
component("YHR042W",439).
component("YMR145C",643).
component("YDL085W",243).
component("YPL171C",758).
component("YHR179W",457).
component("YMR145C",644).
component("YML120C",631).
component("YKL192C",556).
component("YDL085W",244).
component("YGR234W",420).
component("YFR030W",370).
component("YPL017C",748).
component("YFL018C",362).
component("YDR353W",305).
component("YPR167C",788).
component("YJR137C",535).
component("YNL052W",658).
component("YMR256C",650).
component("YLR395C",615).
component("YLR038C",578).
component("YIL111W",475).
component("YHR051W",443).
component("YGL191W",394).
component("YGL187C",393).
component("YDL067C",240).
component("Q0275",19).
component("Q0250",18).
component("YDR072C",277).
component("YPL266W",771).
component("YKR069W",567).
component("YOL096C",704).
component("U47_",115).
component("YER091C",354).
component("YJR073C",527).
component("YGR157W",412).
component("YDR120C",279).
component("YML008C",621).
component("YOR074C",716).
component("YDL033C",236).
component("YOL096C",705).
component("YLR172C",592).
component("YLR058C",581).
component("YDR019C",270).
component("YBR176W",198).
component("YDR408C",311).
component("YMR120C",641).
component("YLR028C",576).
component("YBL013W",166).
component("YJL130C",504).
component("YKL024C",541).
component("YPR074C",783).
component("YBR117C",190).
component("YMR108W",639).
component("YCL009C",216).
component("YNL071W",660).
component("YNR008W",682).
component("YIL160C",484).
component("YNR019W",685).
...
component("YPL028W",749).
component("YLR299W",603).
component("YGL017W",379).
component("YCR005C",222).
component("YML126C",632).
component("YNL104C",663).
component("YDL182W",261).
component("YDL131W",248).
component("YDR307W",301).
component("YLR258W",600).
component("YFR015C",368).
component("YNL029C",655).
component("YIL085C",472).
component("YMR306W",652).
component("YLR342W",609).
component("YGR032W",402).
component("YBR248C",205).
component("YLR209C",595).
component("U104_",21).
component("YDR354W",306) :- not remove_orf("YDR354W",306).
component("YFR047C",371).
component("YJR133W",534).
component("YLR209C",596).
component("YML022W",623).
component("YDR441C",314).
component("YHR128W",452).
component("YJL167W",510).
component("YJL167W",511).
component("YPR069C",780).
component("YDR127W",282).
component("YHR190W",460).
component("YLR146C",589).
component("YHR068W",445).
component("YLR303W",605).
component("YGR012W",400).
component("YML082W",629).
component("YJR130C",533).
component("YDR035W",271).
component("YBR249C",206).
component("YLR180W",594).
component("YDR502C",318).
component("YOR274W",733).
component("YBR256C",208).
component("YHR137W",453).
component("YGL202W",395).
component("YLR027C",575).
component("YKL106W",545).
component("YOL140W",710).
component("YLR438W",618).
component("YGR019W",401).
component("YLR089C",584).
component("U64_",128).
component("U61_",125).
component("U51_",118).
component("YJR148W",537).
component("YHR208W",463).
component("YFL030W",364).
component("YOR184W",725).
component("YNR058W",690).
component("YIL116W",477).
component("YGL253W",398).
component("YFR053C",372).
component("YMR013C",636).
component("YMR205C",646).
component("YGR240C",421).
component("YOL016C",694).
component("YFR014C",367).
component("YLR240W",598).
component("YKL203C",558).
component("YJR066W",526).
component("YCR036W",229).
component("YCL040W",219).
component("U15_",54).
component("YPL188W",760).
component("YJR049C",523).
component("YEL041W",327).
component("U96_",154).
component("YKL001C",540).
component("YDR236C",293).
component("YHL032C",432).
component("YDR531W",322).
component("U83_",145).
component("U82_",144).
component("U81_",143).
component("YMR208W",647).
component("YPL203W",761).
component("YOR061W",715).
component("YKL166C",551).
component("YJL164C",509).
component("YIL035C",467).
component("YHR205W",462).
component("YHR102W",451).
component("YGL019W",380).
component("YHR025W",438).
component("YOR347C",739).
component("YAL038W",159).
component("YNR012W",683).
...
component("U17_",66).
component("U76_",138).
component("YER170W",357).
component("YDR226W",291).
component("YKL067W",543).
component("YOL055C",697).
component("YDR454C",315).
component("YJR057W",524).
component("YOL061W",701).
component("YKL181W",552).
component("YHL011C",431).
component("YER099C",355).
component("YBL068W",173).
component("YOR143C",721).
component("YNL256W",673).
component("YLR328W",607).
component("YBR018C",177).
component("YGR202C",417).
component("YLR328W",608).
component("U80_",142).
component("U94_",153).
component("YJR010W",519).
component("YBR029C",180).
component("YCL050C",220).
component("YGL130W",389).
component("YDR530C",321).
component("YPR190C",791).
component("YPR187W",790).
component("YPR110C",785).
component("YPR010C",776).
component("YOR341W",738).
component("YOR340C",737).
component("YOR224C",731).
component("YOR210W",729).
component("YOR207C",727).
component("YOR151C",722).
component("YOR116C",718).
component("YOL005C",692).
component("YNR003C",681).
component("YNL248C",672).
component("YNL151C",667).
component("YNL113W",664).
component("YKL144C",547).
component("YJR063W",525).
component("YJL148W",508).
component("YJL140W",507).
component("YIL021W",466).
component("YHR143W-A",454).
component("YGL070C",387).
component("YFL036W",365).
...
component("YPR175W",789).
component("YPL167C",757).
component("YOR330C",735).
component("YOL115W",708).
component("YNL299W",679).
component("YNL262W",675).
component("YNL102W",662).
component("YJR043C",522).
component("YJR006W",517).
component("YJL090C",499).
component("YIL139C",480).
...
component("YPR113W",786).
component("YBR243C",203).
component("YPL148C",755).
component("YER026C",337).
component("YGR286C",428).
component("YHR189W",459).
component("YDR058C",276).
component("YDL086W",245).
component("YOL011W",693).
component("YMR008C",634).
component("YMR006C",633).
component("U105_",22).
component("YBL015W",167).
component("YJL068C",497).
component("YOR040W",714).
component("U77_",139).
component("YDR481C",316).
component("YLR377C",613).
component("YPL179W",759).
component("YNR032W",686).
component("YML057W",627).
component("YML016C",622).
component("YLR433C",617).
component("YGR123C",410).
component("YER133W",356).
component("YER089C",352).
...
component("YHR215W",464).
component("YDL024C",235).
component("YBR093C",187).
component("YBR092C",186).
component("YAR071W",163).
component("YHR046C",442).
component("U9_",157).
component("YPL228W",764).
component("YMR180C",645).
component("YDL236W",266).
component("YPR073C",782).
component("YOR208W",728).
component("YNL053W",659).
component("YMR036C",637).
component("YIR026C",490).
component("YIL113W",476).
component("YFR028C",369).
component("YER075C",348).
...
component("U25_",96).
component("U24_",95).
component("YHR044C",441).
component("YHR043C",440).
component("YOL064C",702).
component("YOR360C",741).
component("YKR031C",564).
component("YPL206C",762).
component("YGL027C",382).
component("YLR286C",602).
component("YJR153W",538).
component("YJL221C",516).
component("YJL216C",514).
component("YIL172C",488).
component("YGR292W",430).
component("YGR287C",429).
component("YBR299W",215).
component("YBR184W",199).
component("YIL162W",485).
component("YIR019C",489).
component("YIL099W",474).
component("YDL037C",237).
component("YOR190W",726).
component("YLR300W",604).
component("YGR282C",427).
component("YDR261C",296).
component("YDR400W",308).
component("YML035C",624).
component("YJL070C",498).
component("YBR284W",212).
component("U106_",23).
component("YER043C",338).
component("YNL045W",657).
component("YGL037C",383).
component("YDR242W",294).
component("U53_",120).
component("YPR062W",779).
component("YMR120C",642).
component("YLR028C",577).
component("YHR144C",455).
component("YGR267C",426).
component("YBL033C",168).
component("YNL141W",665).
component("YLR245C",599).
component("YML035C",625).
component("YBR084W",184).
component("YJL126W",502).
component("U44_",112).
...
component("YHR201C",461).
component("YBR111C",188).
component("YBR252W",207).
component("YER005W",335).
component("YBL099W",174).
component("YLR231C",597).
component("U88_",148).
component("YDR538W",324).
component("YLR134W",586).
component("YLR044C",579).
component("YGR087C",407).
component("YDR380W",307).
component("YDL080C",242).
component("U98_",155).
component("YMR250W",649).
component("YOR128C",719).
component("YEL021W",326).
component("YNR043W",688).
component("U93_",152).
component("U54_",121).
component("YKL211C",559) :- not remove_orf("YKL211C",559).
component("YKR097W",570).
component("YNL169C",668).
component("YNL256W",674).
component("YDR294C",298).
component("YEL046C",328).
component("YNR033W",687).
component("YKL211C",560) :- not remove_orf("YKL211C",560).
component("YER090W",560) :- not remove_orf("YER090W",560).
component("YER090W",353) :- not remove_orf("YER090W",353).
component("YDR127W",284).
component("YPL281C",774).
component("YOR393W",747).
component("YMR323W",653).
component("YHR174W",456).
component("YGR254W",423).
component("YPL262W",769).
component("YGL026C",381) :- not remove_orf("YGL026C",381).
component("YGR155W",411).
component("YLR304C",606).
component("YJL200C",512).
component("YNL316C",680).
component("YKL182W",554).
component("YPL212C",763).
component("YNL292W",678).
component("YGL063W",386).
component("YFL001W",360).
component("YPR002W",775).
component("YJR016C",520).
component("YCR053W",231).
component("YDR127W",285).
component("YGL148W",390).
component("YIL168W",487).
component("YIL167W",486).
component("YCL064C",221).
component("YER086W",350).
component("YLR359W",612).
component("YAL012W",158).
component("YML004C",620).
component("YFR055W",373).
component("YJL005W",493).
component("YJL121C",501).
component("YBR019C",178).
component("YDR050C",275).
component("YDR007W",268) :- not remove_orf("YDR007W",268).
component("YOR095C",717).
component("YER003C",334).
component("YBR196C",200).
component("YGL001C",375).
component("YPL117C",753).
component("U14_",46).
component("YOL056W",698).
component("YKL152C",550).
component("YDL021W",233).
component("YEL058W",331).
component("YPR060C",778).
component("YHR072W",446).
component("YPL097W",751).
component("YGR185C",415).
component("YGR264C",425).
component("YGR171C",413).
component("YPL104W",752).
component("YLL018C",571).
component("YPR081C",784).
component("YBR121C",191).
component("YHR020W",437).
component("YER087W",351).
component("YNL247W",671).
component("YOR168W",723).
component("YOL097C",706).
component("YDR268W",297).
component("YPR047W",777).
component("YLR060W",582).
component("YFL022C",363).
component("YCR024C",225).
component("YHR019C",436).
component("YKL194C",557).
component("YIL078W",471).
component("YPL160W",756).
component("YLR382C",614).
component("YNL073W",661).
component("YOR335C",736).
component("YLR153C",590).
component("YAL054C",160).
component("YGR244C",422).
component("YIL145C",481).
component("U89_",149).
component("YJL101C",500).
component("YOL049W",696).
component("YAR015W",162).
component("YER183C",359).
component("U90_",151).
component("YNR057C",689).
component("YDL141W",251).
component("YDL141W",252).
component("YGL234W",397).
component("YDL141W",253).
component("YJR103W",530).
component("YBL039C",170).
component("YGR204W",419).
component("YBR084W",185).
component("YNL220W",669).
component("YOL058W",699).
component("YDL141W",254).
component("YHR074W",447).
component("YMR217W",648).
component("YJR109C",532).
component("YJL130C",505).
component("YGL062W",385).
component("YBR218C",201).
component("YPL231W",768).
component("YNR016C",684).
component("YKL182W",555).
component("YGR037C",403).
component("YPR138C",787).
component("YPL265W",770).
component("YPL134C",754).
component("YPL036W",750).
component("YOR348C",740).
component("YOR222W",730).
component("YOR171C",724).
component("YOR130C",720).
component("YOR011W",713).
component("YOL156W",712).
component("YOL103W",707).
component("YOL020W",695) :- not remove_orf("YOL020W",695).
component("YNR072W",691).
component("YNL270C",676).
component("YNL142W",666).
component("YMR011W",635).
component("YLR348C",610).
component("YLR260W",601).
component("YLR138W",587).
component("YLR100C",585).
component("YLR081W",583).
component("YLL061W",574).
component("YKR093W",569).
component("YKR053C",566).
component("YKR039W",565) :- not remove_orf("YKR039W",565).
component("YJR158W",539).
component("YJR077C",528).
component("YJL219W",515).
component("YJL214W",513).
component("YJL134W",506).
component("YJL129C",503).
component("YIL134W",479).
component("YHR096C",450).
component("YHR094C",449).
component("YHR092C",448).
component("YHL036W",433).
component("YGR121C",409).
component("YGR065C",406).
component("YGR055W",404).
component("YGL186C",392).
component("YGL077C",388).
component("YGL008C",376).
component("YFL055W",366).
component("YFL011W",361).
...
catalyst(2300,152).
catalyst(3460,121).
catalyst(3600,559) :- not remove_reaction(3600,559).
catalyst(8000,570).
catalyst(6890,668).
catalyst(2570,674).
catalyst(8781,298).
...
catalyst(4560,328).
catalyst(2550,687).
catalyst(1890,560) :- not remove_reaction(1890,560).
catalyst(3630,560) :- not remove_reaction(3630,560).
catalyst(1890,353) :- not remove_reaction(1890,353).
catalyst(3630,353) :- not remove_reaction(3630,353).
catalyst(3740,284).
catalyst(8231,774).
catalyst(8232,774).
catalyst(8231,747).
...
catalyst(8061,769).
catalyst(8062,769).
catalyst(3590,381) :- not remove_reaction(3590,381).
catalyst(10910,381) :- not remove_reaction(10910,381).
catalyst(4570,411).
catalyst(8181,606).
catalyst(8182,606).
catalyst(8181,512).
...
catalyst(640,569).
catalyst(6560,566).
catalyst(771,565) :- not remove_reaction(771,565).
catalyst(772,565) :- not remove_reaction(772,565).
catalyst(781,565) :- not remove_reaction(781,565).
catalyst(782,565) :- not remove_reaction(782,565).
catalyst(801,565) :- not remove_reaction(801,565).
catalyst(802,565) :- not remove_reaction(802,565).
catalyst(811,565) :- not remove_reaction(811,565).
catalyst(812,565) :- not remove_reaction(812,565).
catalyst(831,565) :- not remove_reaction(831,565).
catalyst(832,565) :- not remove_reaction(832,565).
catalyst(841,565) :- not remove_reaction(841,565).
catalyst(842,565) :- not remove_reaction(842,565).
catalyst(851,565) :- not remove_reaction(851,565).
catalyst(852,565) :- not remove_reaction(852,565).
catalyst(881,565) :- not remove_reaction(881,565).
catalyst(882,565) :- not remove_reaction(882,565).
catalyst(901,565) :- not remove_reaction(901,565).
catalyst(902,565) :- not remove_reaction(902,565).
catalyst(921,565) :- not remove_reaction(921,565).
catalyst(922,565) :- not remove_reaction(922,565).
catalyst(931,565) :- not remove_reaction(931,565).
catalyst(932,565) :- not remove_reaction(932,565).
catalyst(1191,565) :- not remove_reaction(1191,565).
catalyst(1192,565) :- not remove_reaction(1192,565).
catalyst(1180,539).
catalyst(1210,539).
catalyst(1581,528).
catalyst(1582,528).
