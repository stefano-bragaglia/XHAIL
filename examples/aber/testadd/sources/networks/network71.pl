...
component("YLR056W",380).
component("YGL012W",244).
component("YKR009C",366).
component("YOL086C",461).
component("YMR303C",421).
component("YGL256W",262).
...
component("YIL094C",310).
component("U45_",75).
component("YML056C",410).
component("YLR432W",407).
component("YHR216W",305).
component("YAR075W",109).
component("YAR073W",108).
component("YDR127W",182).
component("YOL126C",465).
component("YKL085W",356).
component("YDL078C",161).
component("YNL037C",426).
component("YNL009W",424).
component("YLR174W",388).
component("YCL018W",146).
component("YLR355C",403).
component("YDL174C",172).
component("YML086C",411).
component("YGR088W",270).
component("YDR256C",192).
component("YJR078W",346).
component("YJR025C",339).
component("U107_",23).
component("YJR104C",348).
component("YHR008C",288).
component("YJL026W",323).
component("YIL066C",308).
component("YGR180C",273).
component("YER070W",222).
component("U36_",69).
component("YDL168W",170).
component("YBR006W",117).
component("YPL276W",510).
component("YPL275W",509).
component("YOR388C",488).
component("U55_",82).
component("YER069W",221).
component("YOR323C",481).
component("YER178W",228).
component("YBR221C",137).
component("YIL125W",313).
component("U52_",80).
component("YBR166C",133).
component("YGL012W",245).
component("YKL216W",365).
component("YKR009C",367).
component("YIL160C",317).
component("YGL205W",259).
component("YDL171C",171).
component("U99_",103).
component("U100_",20).
component("YKR080W",372).
component("YER023W",215).
component("YGR204W",275).
component("YLR142W",385).
component("U65_",86).
component("U62_",85).
component("YHR068W",296).
component("YKL150W",359).
component("YIL043C",307).
component("YPL171C",498).
component("YHR179W",303).
component("YGR234W",277).
component("YFR030W",238).
component("YPL017C",490).
component("YFL018C",231).
component("YDR353W",196).
component("YPR167C",522).
component("YJR137C",350).
component("YNL052W",427).
component("YMR256C",420).
component("YLR395C",406).
component("YLR038C",378).
component("YIL111W",311).
component("YHR051W",295).
component("YGL191W",257).
component("YGL187C",256).
component("YDL067C",160).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",508).
component("YKR069W",371).
component("U47_",77).
component("YJR073C",344).
component("YDL033C",159).
component("YLR172C",387).
component("YLR058C",381).
component("YDR019C",177).
component("YBR176W",134).
component("YDR408C",201).
component("YMR120C",416).
component("YLR028C",376).
component("YBL013W",110).
component("YJL130C",329).
component("YKL024C",354).
component("YPR074C",518).
component("YBR117C",129).
component("YCL009C",145).
component("YNL071W",429).
component("YIL160C",318).
component("U48_",78).
component("YPL231W",503).
component("YPL231W",504).
component("YPL028W",491).
component("YLR299W",396).
component("YGL017W",246).
component("YML126C",412).
component("YNL104C",431).
component("YDL182W",173).
component("YDL131W",165).
component("YLR258W",393).
component("YFR015C",236).
component("YNL029C",425).
component("YIL085C",309).
component("YMR306W",422).
component("YLR342W",402).
component("YGR032W",265).
component("YLR209C",389).
component("U104_",21).
component("YDR354W",197) :- not remove_orf("YDR354W",197).
component("YFR047C",239).
component("YLR209C",390).
component("YML022W",408).
component("YDR441C",203).
component("YJL167W",333).
component("YDR127W",183).
component("YHR068W",297).
component("YLR303W",398).
component("YGR012W",263).
component("YJR130C",349).
component("YDR035W",178).
component("YBR249C",138).
component("YOR274W",480).
component("YHR137W",299).
component("YGL202W",258).
component("YLR027C",375).
component("YKL106W",357).
component("YOL140W",466).
component("YGR019W",264).
component("YLR089C",382).
component("U61_",84).
component("YJR148W",351).
component("YFL030W",232).
component("YNR058W",452).
component("YGL253W",261).
component("YFR053C",240).
component("YMR205C",418).
component("YGR240C",278).
component("YOL016C",455).
component("YFR014C",235).
component("YCR036W",155).
component("YCL040W",148).
component("YPL188W",499).
component("YJR049C",341).
component("YEL041W",210).
component("U96_",101).
component("YKL001C",353).
component("YDR236C",190).
component("YHL032C",286).
component("U83_",98).
component("YMR208W",419).
component("YHR025W",291).
component("YOR347C",486).
...
component("U76_",95).
component("YER170W",227).
component("YDR226W",189).
component("YKL067W",355).
component("YOL055C",458).
component("YDR454C",204).
component("YJR057W",342).
component("YOL061W",460).
component("YKL181W",361).
component("YHL011C",285).
component("YER099C",226).
component("YBL068W",115).
component("YOR143C",471).
component("YNL256W",440).
component("YLR328W",400).
component("YBR018C",119).
component("YLR328W",401).
component("U94_",100).
component("YBR029C",121).
component("YGL130W",253).
component("YPR190C",525).
component("YPR187W",524).
component("YPR110C",519).
component("YPR010C",513).
component("YOR341W",485).
component("YOR340C",484).
component("YOR224C",479).
component("YOR210W",478).
...
component("YNL113W",432).
component("YKL144C",358).
component("YJR063W",343).
component("YJL148W",332).
component("YJL140W",331).
component("YIL021W",306).
...
component("YPR113W",520).
component("YPL148C",496).
component("YGR286C",282).
component("YOL011W",454).
component("YMR008C",414).
component("YMR006C",413).
component("U105_",22).
component("YBL015W",111).
component("U77_",96).
component("YLR377C",405).
component("YPR073C",516).
component("YHR215W",304).
...
component("YPR073C",517).
component("YOR208W",477).
component("YNL053W",428).
component("YMR036C",415).
component("YIR026C",322).
component("YIL113W",312).
component("YFR028C",237).
...
component("YOR360C",487).
component("YKR031C",368).
component("YPL206C",500).
component("YGL027C",248).
component("YLR286C",395).
component("YJR153W",352).
component("YJL221C",336).
component("YJL216C",335).
component("YIL172C",321).
component("YGR292W",284).
component("YGR287C",283).
component("YBR299W",144).
component("YOR190W",475).
component("YLR300W",397).
component("YGR282C",281).
component("YDR261C",193).
component("YDR400W",199).
component("YML035C",409).
component("YJL070C",324).
component("YBR284W",142).
component("YER043C",216).
component("YDR242W",191).
component("U53_",81).
component("YPR062W",515).
component("YMR120C",417).
component("YLR028C",377).
component("YHR144C",301).
component("YBL033C",112).
component("YNL141W",433).
component("YLR245C",392).
component("YBR084W",124).
component("YJL126W",327).
component("U44_",74).
...
component("YLR231C",391).
component("YLR134W",384).
component("YLR044C",379).
component("YGR087C",269).
component("YDR380W",198).
component("YDL080C",162).
component("U98_",102).
component("YOR128C",470).
component("YKL211C",363) :- not remove_orf("YKL211C",363).
component("YKR097W",373).
component("YNL169C",436).
component("YEL046C",211).
component("YNR033W",450).
component("YKL211C",364) :- not remove_orf("YKL211C",364).
component("YER090W",364) :- not remove_orf("YER090W",364).
component("YER090W",225) :- not remove_orf("YER090W",225).
component("YDR127W",185).
component("YPL281C",511).
component("YOR393W",489).
component("YMR323W",423).
component("YHR174W",302).
component("YGR254W",279).
component("YPL262W",506).
component("YGL026C",247) :- not remove_orf("YGL026C",247).
component("YLR304C",399).
component("YJL200C",334).
component("YNL316C",446).
component("YPL212C",501).
component("YNL292W",444).
component("YGL063W",250).
component("YFL001W",230).
component("YPR002W",512).
component("YJR016C",338).
component("YCR053W",156).
component("YDR127W",186).
component("YGL148W",254).
component("YIL168W",320).
component("YIL167W",319).
component("YCL064C",149).
component("YLR359W",404).
...
component("U14_",34).
component("YOL056W",459).
component("YKL152C",360).
component("YDL021W",157).
component("YPR060C",514).
component("YPL097W",493).
component("YGR185C",274).
component("YGR264C",280).
component("YGR171C",272).
component("YPL104W",494).
component("YLL018C",374).
component("YHR020W",290).
component("YER087W",224).
component("YNL247W",438).
component("YOR168W",473).
component("YOL097C",462).
component("YDR268W",194).
component("YCR024C",152).
component("YHR019C",289).
component("YOR335C",483).
component("YLR153C",386).
component("YAL054C",107).
component("YIL145C",316).
component("YJL101C",326).
component("YOL049W",457).
component("YER183C",229).
component("U90_",99).
component("YNR057C",451).
component("YGL234W",260).
component("YJR103W",347).
component("YBL039C",114).
component("YGR204W",276).
component("YBR084W",125).
component("YNL220W",437).
component("YDL141W",167).
component("YHR074W",298).
component("YGL062W",249).
component("YBR218C",136).
component("YPL231W",505).
component("YNR016C",449).
component("YKL182W",362).
component("YGR037C",266).
component("YPR138C",521).
component("YPL265W",507).
component("YPL036W",492).
component("YOR171C",474).
component("YOR011W",467).
component("YOL103W",463).
component("YOL020W",456) :- not remove_orf("YOL020W",456).
component("YNL270C",442).
component("YNL142W",434).
component("YLR260W",394).
component("YLR100C",383).
component("YKR053C",370).
component("YKR039W",369) :- not remove_orf("YKR039W",369).
component("YJR077C",345).
component("YJL134W",330).
component("YJL129C",328).
component("YIL134W",314).
component("YHL036W",287).
component("YGR121C",271).
component("YGR065C",268).
component("YGR055W",267).
component("YGL186C",255).
component("YGL077C",252).
component("YGL008C",243).
component("YFL055W",234).
...
catalyst(1890,225) :- not remove_reaction(1890,225).
catalyst(3630,225) :- not remove_reaction(3630,225).
catalyst(3740,185).
catalyst(8231,511).
catalyst(8232,511).
catalyst(8231,489).
...
catalyst(901,456) :- not remove_reaction(901,456).
catalyst(902,456) :- not remove_reaction(902,456).
catalyst(931,442).
catalyst(932,442).
catalyst(371,434).
catalyst(372,434).
...
catalyst(6330,383).
catalyst(6560,370).
catalyst(771,369) :- not remove_reaction(771,369).
catalyst(772,369) :- not remove_reaction(772,369).
catalyst(781,369) :- not remove_reaction(781,369).
catalyst(782,369) :- not remove_reaction(782,369).
...
catalyst(851,369) :- not remove_reaction(851,369).
catalyst(852,369) :- not remove_reaction(852,369).
catalyst(881,369) :- not remove_reaction(881,369).
catalyst(882,369) :- not remove_reaction(882,369).
catalyst(901,369) :- not remove_reaction(901,369).
catalyst(902,369) :- not remove_reaction(902,369).
catalyst(921,369) :- not remove_reaction(921,369).
catalyst(922,369) :- not remove_reaction(922,369).
catalyst(931,369) :- not remove_reaction(931,369).
catalyst(932,369) :- not remove_reaction(932,369).
catalyst(1191,369) :- not remove_reaction(1191,369).
catalyst(1192,369) :- not remove_reaction(1192,369).
catalyst(1581,345).
catalyst(1582,345).
catalyst(6560,330).
catalyst(361,328).
