...
component("YLR056W",665).
component("YGR060W",460).
component("YGL012W",430).
component("YKR009C",643).
component("YOL086C",807).
component("YMR303C",748).
component("YMR083W",728).
component("YGL256W",453).
component("YDL168W",296).
component("YBR145W",226).
component("YPL231W",881).
component("YBR265W",244).
component("U46_",135).
component("YBR149W",227).
component("YBR149W",228).
component("YGL001C",426).
component("YIL094C",539).
component("YHR063C",506).
component("U45_",134).
component("YML056C",713).
component("YLR432W",702).
component("YHR216W",529).
component("YAR075W",190).
component("YAR073W",189).
component("YDR127W",325).
component("YJR139C",609).
component("YML075C",716).
component("YLR450W",705).
component("YOL126C",813).
component("YKL085W",620).
component("YDL078C",278).
component("YKL029C",616).
component("YNL037C",753).
component("YNL009W",751).
component("YLR174W",679).
component("YHR183W",522).
component("YGR256W",484).
component("YNL241C",768).
component("YOL059W",804).
component("YDL022W",270).
component("YCL018W",252).
component("YLR355C",697).
component("YIL074C",536).
component("YER081W",398).
component("YML054C",712).
component("YDL174C",300).
component("YML086C",718).
component("YIL155C",548).
component("YEL024W",373).
component("YKR066C",648).
component("YGR088W",464).
component("YDR256C",339).
component("YKL026C",615).
component("YIR037W",558).
component("YBR244W",239).
component("YJR078W",601).
component("U58_",144).
component("YJR025C",592).
component("U107_",27).
component("YGR255C",483).
component("U108_",28).
component("YHR007C",495).
component("YDR402C",354).
component("YGL055W",437).
component("YJR104C",604).
component("YHR008C",496).
component("YOR384W",855).
component("YOR381W",854).
component("YOL152W",816).
component("YLL051C",658).
component("YJL026W",560).
component("YIL066C",535).
component("YGR180C",472).
component("YER070W",395).
component("U37_",128).
component("U36_",127).
component("U35_",126).
component("YDL168W",297).
component("YDR158W",333).
component("YJR009C",588).
component("YJL052W",562).
component("YGR192C",474).
component("YBR006W",203).
component("YPL276W",889).
component("YPL275W",888).
component("YOR388C",856).
component("YPL061W",864).
component("YOR374W",852).
component("YER073W",396).
component("YGL154C",445).
component("YBR115C",221).
component("U55_",143).
component("YER069W",393).
component("YOR323C",844).
component("YMR170C",738).
component("YMR169C",737).
component("YER178W",408).
component("YBR221C",237).
component("YIL125W",544).
component("U52_",140).
component("YBR166C",231).
component("YNL280C",777).
component("YGL012W",431).
component("YKL182W",631).
component("YKL216W",641).
component("YDR044W",315).
component("YER014W",383).
component("YKR009C",644).
component("YIL160C",549).
component("YGL205W",450).
component("YMR118C",732).
component("YLR164W",677).
component("YLL041C",656).
component("YKL148C",625).
component("YKL141W",623).
component("YJL045W",561).
component("YDR178W",334).
component("YJR051W",595).
...
component("U99_",180).
component("U100_",21).
component("YBR035C",211).
component("YKR080W",650).
component("YER023W",384).
component("YPL023C",860).
component("YGL125W",442).
component("YOR236W",842).
component("YGR204W",476).
component("YIR034C",557).
component("YLR142W",674).
component("U65_",151).
component("U63_",149).
component("U62_",148).
component("YHR068W",507).
component("YKL150W",626).
component("YIL043C",533).
component("YHR042W",501).
component("YOR221C",839).
component("YMR145C",735).
component("YML120C",719).
component("YKL192C",635).
component("YKL055C",618).
component("YER061C",391).
component("YDL085W",280).
component("YPL171C",872).
component("YHR179W",521).
component("YMR145C",736).
component("YML120C",720).
component("YKL192C",636).
component("YDL085W",281).
component("YGR234W",479).
component("YFR030W",422).
component("YPL017C",859).
component("YFL018C",412).
component("YDR353W",349).
component("YPR167C",908).
component("YJR137C",608).
component("YNL052W",755).
component("YMR256C",745).
component("YLR395C",701).
component("YLR038C",663).
component("YIL111W",541).
component("YHR051W",505).
component("YGL191W",448).
component("YGL187C",447).
component("YDL067C",277).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",320).
component("YPL266W",887).
component("YDR410C",357).
component("YKR069W",649).
component("YOL096C",808).
component("U47_",136).
component("YER091C",403).
component("YJR073C",599).
component("YGR157W",469).
component("YDR120C",323).
component("YML008C",707).
component("YOR074C",821).
component("YDL033C",272).
component("YOL096C",809).
component("YLR172C",678).
component("YLR058C",666).
component("YDR019C",311).
component("YBR176W",232).
component("YDR408C",356).
component("YMR120C",733).
component("YLR028C",661).
component("YBL013W",191).
component("YJL130C",573).
component("YJL088W",566).
component("YKL024C",614).
component("YPR074C",902).
component("YBR117C",222).
component("YMR108W",731).
component("YCL009C",251).
component("YNL071W",757).
component("YNR008W",783).
component("YIL160C",550).
component("YNR019W",786).
component("YCR048W",266).
component("U48_",137).
component("YMR062C",727).
component("YDR232W",336).
component("YPL231W",882).
component("YER061C",392).
component("YPL001W",858).
component("YDL052C",276).
component("U8_",174).
component("YDR148C",331).
component("YPL231W",883).
component("YPL028W",861).
component("YLR299W",689).
component("YGL017W",432).
component("YCR005C",258).
component("YML126C",721).
component("YNL104C",760).
component("YDL182W",301).
component("YDL131W",287).
component("YDR307W",345).
component("YLR258W",686).
component("YFR015C",419).
component("YPL227C",879).
component("YNL029C",752).
component("YIL085C",538).
component("YNL192W",766).
component("YBR038W",213).
component("YBR023C",209).
component("YMR306W",749).
component("YLR342W",695).
component("YGR032W",457).
component("YPR183W",911).
component("YBR248C",240).
component("YLR209C",681).
component("U104_",24).
component("U103_",23).
component("YDR354W",350) :- not remove_orf("YDR354W",350).
component("YFR047C",423).
component("YJR133W",607).
component("YLR209C",682).
component("YML022W",709).
component("YDR441C",360).
component("YHR128W",516).
component("YPR176C",910).
component("YPL172C",873).
component("YNR041C",789).
component("YMR101C",729).
component("YDL090C",283).
component("YBR003W",202).
component("YBR002C",201).
component("YJL167W",580).
component("YJL167W",581).
component("YNL256W",771).
component("YPR069C",899).
component("YDR127W",326).
component("YHR190W",524).
component("YLR146C",675).
component("YHR068W",508).
component("YLR303W",691).
component("YGR012W",455).
component("YML082W",717).
component("YJR130C",606).
component("YDR035W",313).
component("YBR249C",241).
component("YLR180W",680).
component("YDR502C",364).
component("YOR274W",843).
component("YOL143C",815).
component("YBR256C",243).
component("YHR137W",517).
component("YGL202W",449).
component("YLR027C",660).
component("YKL106W",621).
component("YOL140W",814).
component("YLR438W",704).
component("YGR019W",456).
component("YLR089C",670).
component("U64_",150).
component("U61_",147).
component("U51_",139).
component("YJR148W",610).
component("YHR208W",527).
component("YFL030W",414).
component("YOR184W",832).
component("YNR058W",793).
component("YIL116W",543).
component("YGL253W",452).
component("YFR053C",424).
component("YMR013C",725).
component("YMR205C",741).
component("YGR240C",480).
component("YOL016C",797).
component("YFR014C",418).
component("YLR240W",684).
component("YKL203C",638).
component("YJR066W",598).
component("YCR036W",265).
component("YCL040W",254).
component("U15_",65).
component("YPL188W",875).
component("YJR049C",594).
component("YEL041W",374).
component("U96_",178).
component("YKL001C",613).
component("YDR236C",337).
component("YML070W",715).
component("YFL053W",416).
component("YHL032C",493).
component("YDR531W",368).
component("U83_",169).
component("U82_",168).
component("U81_",167).
component("YMR208W",742).
component("YPL203W",876).
component("YOR061W",820).
component("YKL166C",628).
component("YJL164C",579).
component("YIL035C",532).
component("YHR205W",526).
component("YHR102W",514).
component("YGL019W",433).
component("YHR025W",500).
component("YOR347C",849).
component("YAL038W",184).
component("YNR012W",784).
component("YDR009W",310).
component("YDR127W",327).
component("U21_",107).
component("YDR147W",330).
component("YDR300C",344).
component("YCR012W",259).
...
component("YKL067W",619).
component("YOL055C",801).
component("YDR454C",361).
component("YJR057W",596).
component("YOL061W",805).
component("YKL181W",630).
component("YHL011C",491).
component("YER099C",404).
component("YBL068W",198).
component("YOR143C",828).
...
component("YLR328W",694).
component("YDL045C",274).
component("U80_",166).
component("YDL103C",286).
component("U94_",177).
component("YJR010W",589).
component("YBR029C",210).
component("YCL050C",255).
component("YGL130W",443).
component("YDR530C",367).
component("YCL050C",256).
component("YPR190C",913).
component("YPR187W",912).
component("YPR110C",905).
component("YPR010C",892).
component("YOR341W",848).
component("YOR340C",847).
component("YOR224C",841).
component("YOR210W",838).
component("YOR207C",836).
component("YOR151C",829).
component("YOR116C",823).
component("YOL005C",795).
component("YNR003C",782).
component("YNL248C",770).
component("YNL151C",764).
component("YNL113W",761).
component("YKL144C",624).
component("YJR063W",597).
component("YJL148W",577).
component("YJL140W",576).
component("YIL021W",531).
component("YHR143W-A",518).
component("YGL070C",440).
component("YFL036W",415).
component("YDR404C",355).
component("YDR156W",332).
component("YDR045C",316).
component("YDL150W",295).
component("YDL140C",289).
component("YBR154C",230).
component("YPR175W",909).
component("YPL167C",871).
component("YOR330C",845).
component("YOL115W",812).
component("YNL299W",779).
component("YNL262W",774).
component("YNL102W",759).
component("YJR043C",593).
component("YJR006W",587).
component("YJL090C",567).
component("YIL139C",546).
component("YEL055C",377).
component("YDR419W",358).
component("YDR121W",324).
component("YDL102W",285).
component("YCR014C",260).
component("YBR278W",246).
component("YBL035C",194).
component("YKL035W",617).
component("YHL012W",492).
component("YHR123W",515).
component("YPR113W",906).
component("YBR243C",238).
component("YDL142C",294).
component("YPL148C",869).
component("YER026C",385).
component("YGR286C",488).
component("YJL068C",563).
component("YHR189W",523).
component("YDR058C",319).
component("YDL086W",282).
component("YOL011W",796).
component("YMR008C",723).
component("YMR006C",722).
component("U105_",25).
component("YBL015W",192).
component("YJL068C",564).
component("YJR019C",591).
component("YOR040W",819).
component("U77_",162).
component("YDR481C",362).
component("YLR377C",699).
component("YFR025C",420).
component("YPL179W",874).
component("YNR032W",787).
component("YML057W",714).
component("YML016C",708).
component("YLR433C",703).
component("YGR123C",467).
component("YER133W",405).
component("YER089C",401).
component("YDR436W",359).
component("YDR075W",321).
component("YDL188C",302).
component("YDL134C",288).
component("YDL047W",275).
component("YDL006W",268).
component("YBR125C",225).
component("YBL056W",197).
component("YPR073C",900).
component("YHR215W",528).
component("YDL024C",271).
component("YBR093C",219).
component("YBR092C",218).
component("YAR071W",188).
component("YHR046C",504).
component("U9_",181).
component("YPL228W",880).
component("YMR180C",739).
component("YDL236W",306).
component("YJL155C",578).
component("YPR073C",901).
component("YOR208W",837).
component("YNL053W",756).
component("YMR036C",726).
component("YIR026C",556).
component("YIL113W",542).
component("YFR028C",421).
component("YER075C",397).
component("YDL230W",305).
component("YBR276C",245).
component("U34_",125).
component("U33_",124).
component("U32_",123).
component("U31_",122).
...
component("U25_",116).
component("U24_",115).
component("YHR044C",503).
component("YHR043C",502).
component("YOL064C",806).
component("YOR360C",851).
component("YKR031C",645).
component("YPL206C",877).
component("YGL027C",435).
component("YLR286C",688).
component("YJR153W",611).
component("YJL221C",586).
component("YJL216C",584).
component("YIL172C",554).
component("YGR292W",490).
component("YGR287C",489).
component("YBR299W",250).
component("YBR184W",233).
component("YIL162W",551).
component("YPR026W",893).
component("YDR001C",308).
component("YBR001C",200).
component("YIR019C",555).
component("YIL099W",540).
component("YDL037C",273).
component("YOR190W",834).
component("YLR300W",690).
component("YGR282C",487).
component("YDR261C",340).
component("YDR400W",353).
component("U23_",114).
component("YML035C",710).
component("YJL070C",565).
component("YBR284W",247).
component("U106_",26).
component("U102_",22).
component("YER043C",386).
component("YNL045W",754).
component("YGL037C",436).
component("YDR242W",338).
component("YBR208C",235).
component("YMR281W",747).
component("U53_",141).
component("YPR062W",898).
component("YMR120C",734).
component("YLR028C",662).
component("YHR144C",519).
component("YGR267C",486).
component("YBL033C",193).
component("YBR153W",229).
component("YNL141W",762).
component("YLR245C",685).
component("YML035C",711).
component("YGR204W",477).
component("YBR084W",216).
component("YJL126W",571).
component("U44_",133).
component("YDL100C",284).
component("U87_",171).
component("U40_",131).
component("U39_",129).
component("YBR011C",204).
component("YHR201C",525).
component("YBR111C",220).
component("YBR252W",242).
component("YPR080W",903).
component("YOR187W",833).
component("YOR133W",826).
component("YLR069C",668).
component("YKR084C",651).
component("YKL173W",629).
component("YJL102W",569).
component("YDR385W",352).
component("YBR118W",223).
component("YER005W",382).
component("YLL001W",654).
component("YIL048W",534).
component("YER166W",406).
component("YDR093W",322).
component("YAL026C",183).
component("YBL099W",199).
component("U60_",146).
component("YLR231C",683).
component("U88_",172).
component("YDR538W",370).
component("YLR134W",672).
component("YLR044C",664).
component("YGR087C",463).
component("YDR380W",351).
component("YDL080C",279).
component("U98_",179).
component("YMR250W",744).
component("YKL184W",634).
component("YOR128C",824).
component("YEL021W",372).
component("YNR043W",790).
component("U93_",176).
component("U54_",142).
component("YKL211C",639) :- not remove_orf("YKL211C",639).
component("YKR097W",653).
component("YOL052C",800).
component("YNL169C",765).
component("YGR170W",470).
component("YNL256W",773).
component("YDR294C",342).
component("YEL046C",375).
component("YNR033W",788).
component("YKL211C",640) :- not remove_orf("YKL211C",640).
component("YER090W",640) :- not remove_orf("YER090W",640).
component("YER090W",402) :- not remove_orf("YER090W",402).
component("YDR127W",328).
component("YPL281C",890).
component("YOR393W",857).
component("YMR323W",750).
component("YHR174W",520).
component("YGR254W",482).
component("YOR202W",835).
component("YPL262W",885).
component("YGL026C",434) :- not remove_orf("YGL026C",434).
component("YGR155W",468).
component("YLR304C",692).
component("YJL200C",582).
component("YGL009C",429).
component("YNL316C",780).
component("YKL182W",632).
component("YPL212C",878).
component("YNL292W",778).
component("YGL063W",439).
component("YFL001W",410).
component("YPR002W",891).
component("YJR016C",590).
component("YCR053W",267).
component("YDR127W",329).
component("YGL148W",444).
component("YIL168W",553).
component("YIL167W",552).
component("YCL064C",257).
component("YER086W",399).
component("YLR359W",698).
component("YAL012W",182).
component("YML004C",706).
component("YFR055W",425).
component("YJL005W",559).
component("YJL121C",570).
component("YBR019C",207).
component("YDR050C",318).
component("YIL020C",530).
component("YDR007W",309) :- not remove_orf("YDR007W",309).
component("YOR095C",822).
component("YER003C",381).
component("YBR196C",234).
component("YGL001C",427).
component("YPL117C",867).
component("U14_",57).
component("YOL056W",802).
component("YKL152C",627).
component("YDL021W",269).
component("YMR105C",730).
component("YKL127W",622).
component("YEL058W",378).
component("YPR060C",897).
component("YHR072W",509).
component("YPL097W",865).
component("YGR185C",473).
component("YGR264C",485).
component("YGR171C",471).
component("YHR011W",497).
component("YDR023W",312).
component("YPL104W",866).
component("YLL018C",655).
component("YPR081C",904).
component("YBR121C",224).
component("YHR020W",499).
component("YER087W",400).
component("YNL247W",769).
component("YOR168W",830).
component("YOL097C",810).
component("YDR268W",341).
component("YPR047W",896).
component("YLR060W",667).
component("YFL022C",413).
component("YPR033C",894).
component("YCR024C",261).
component("YHR019C",498).
component("YKL194C",637).
component("YIL078W",537).
component("YPL160W",870).
component("YLR382C",700).
component("YNL073W",758).
component("YDR037W",314).
component("YOR335C",846).
component("YGR094W",465).
component("YLR153C",676).
component("YAL054C",185).
component("YOR142W",827).
component("YGR244C",481).
component("YPR035W",895).
component("YIL145C",547).
component("U89_",173).
component("YJL101C",568).
component("YOL049W",799).
component("YAR015W",187).
component("YER183C",409).
component("U90_",175).
component("YNR057C",792).
component("YDL141W",290).
component("YDL141W",291).
component("YGL234W",451).
component("YDL141W",292).
component("YJR103W",603).
component("YBL039C",195).
component("YGR204W",478).
component("YBR084W",217).
component("YNL220W",767).
component("YOL058W",803).
component("YDL141W",293).
component("YHR074W",510).
component("YMR217W",743).
component("YGR061C",461).
component("YJR109C",605).
component("YJL130C",574).
component("YGL062W",438).
component("YBR218C",236).
component("YPL231W",884).
component("YNR016C",785).
component("YKL182W",633).
component("YGR037C",458).
component("YPR138C",907).
component("YPL265W",886).
component("YPL134C",868).
component("YPL057C",863).
component("YPL036W",862).
component("YOR348C",850).
component("YOR222W",840).
component("YOR171C",831).
component("YOR130C",825).
component("YOR011W",818).
component("YOL156W",817).
component("YOL103W",811).
component("YOL020W",798) :- not remove_orf("YOL020W",798).
component("YNR072W",794).
component("YNR056C",791).
component("YNL318C",781).
component("YNL270C",775).
component("YNL142W",763).
component("YMR272C",746).
component("YMR202W",740).
component("YMR011W",724).
component("YLR348C",696).
component("YLR260W",687).
component("YLR138W",673).
component("YLR100C",671).
component("YLR081W",669).
component("YLL061W",659).
component("YLL043W",657).
component("YKR093W",652).
component("YKR053C",647).
component("YKR039W",646) :- not remove_orf("YKR039W",646).
component("YKL217W",642).
component("YJR158W",612).
component("YJR095W",602).
component("YJR077C",600).
component("YJL219W",585).
component("YJL214W",583).
component("YJL134W",575).
component("YJL129C",572).
component("YIL134W",545).
component("YHR096C",513).
component("YHR094C",512).
component("YHR092C",511).
component("YHL036W",494).
component("YGR121C",466).
component("YGR065C",462).
component("YGR055W",459).
component("YGL186C",446).
component("YGL077C",441).
component("YGL008C",428).
component("YFL055W",417).
component("YFL011W",411).
component("YER060W-A",390).
component("YER060W",389).
component("YER056C",388).
component("YER053C",387).
component("YEL069C",380).
component("YEL063C",379).
component("YEL017C-A",371).
component("YDR536W",369).
component("YDR508C",366).
component("YDR503C",365).
component("YDR497C",363).
component("YDR345C",348).
component("YDR343C",347).
component("YDR342C",346).
component("YDR297W",343).
component("YDR046C",317) :- not remove_orf("YDR046C",317).
component("YDL245C",307).
component("YDL210W",303).
component("YCR032W",264).
component("YCR028C",263).
component("YCR024C-A",262).
component("YCL025C",253).
component("YBR298C",249).
component("YBR291C",248).
component("YBR069C",215) :- not remove_orf("YBR069C",215).
component("YBR068C",214) :- not remove_orf("YBR068C",214).
component("YBR036C",212).
component("YBR021W",208).
component("YBL042C",196).
component("U85_",170).
component("U7_",165).
component("U79_",164).
component("U78_",163).
...
catalyst(2131,23).
catalyst(2132,23).
catalyst(3620,350) :- not remove_reaction(3620,350).
catalyst(2110,423).
catalyst(2190,423).
catalyst(5550,607).
catalyst(5791,682).
...
catalyst(1890,402) :- not remove_reaction(1890,402).
catalyst(3630,402) :- not remove_reaction(3630,402).
catalyst(3740,328).
catalyst(8231,890).
catalyst(8232,890).
catalyst(8231,857).
...
catalyst(8061,885).
catalyst(8062,885).
catalyst(3590,434) :- not remove_reaction(3590,434).
catalyst(10910,434) :- not remove_reaction(10910,434).
catalyst(4570,468).
catalyst(8181,692).
catalyst(8182,692).
catalyst(8181,582).
...
catalyst(8282,318).
catalyst(3840,530).
catalyst(3610,309) :- not remove_reaction(3610,309).
catalyst(7921,822).
catalyst(7922,822).
catalyst(7841,381).
catalyst(7842,381).
...
catalyst(1210,817).
catalyst(1160,811).
catalyst(801,798) :- not remove_reaction(801,798).
catalyst(802,798) :- not remove_reaction(802,798).
catalyst(811,798) :- not remove_reaction(811,798).
catalyst(812,798) :- not remove_reaction(812,798).
catalyst(831,798) :- not remove_reaction(831,798).
catalyst(832,798) :- not remove_reaction(832,798).
catalyst(901,798) :- not remove_reaction(901,798).
catalyst(902,798) :- not remove_reaction(902,798).
catalyst(1180,794).
catalyst(1210,794).
catalyst(700,791).
catalyst(1200,781).
...
catalyst(650,652).
catalyst(6560,647).
catalyst(771,646) :- not remove_reaction(771,646).
catalyst(772,646) :- not remove_reaction(772,646).
catalyst(781,646) :- not remove_reaction(781,646).
catalyst(782,646) :- not remove_reaction(782,646).
catalyst(791,646) :- not remove_reaction(791,646).
catalyst(792,646) :- not remove_reaction(792,646).
catalyst(801,646) :- not remove_reaction(801,646).
catalyst(802,646) :- not remove_reaction(802,646).
catalyst(811,646) :- not remove_reaction(811,646).
catalyst(812,646) :- not remove_reaction(812,646).
catalyst(831,646) :- not remove_reaction(831,646).
catalyst(832,646) :- not remove_reaction(832,646).
catalyst(841,646) :- not remove_reaction(841,646).
catalyst(842,646) :- not remove_reaction(842,646).
catalyst(851,646) :- not remove_reaction(851,646).
catalyst(852,646) :- not remove_reaction(852,646).
catalyst(881,646) :- not remove_reaction(881,646).
catalyst(882,646) :- not remove_reaction(882,646).
catalyst(901,646) :- not remove_reaction(901,646).
catalyst(902,646) :- not remove_reaction(902,646).
catalyst(911,646) :- not remove_reaction(911,646).
catalyst(912,646) :- not remove_reaction(912,646).
catalyst(921,646) :- not remove_reaction(921,646).
catalyst(922,646) :- not remove_reaction(922,646).
catalyst(931,646) :- not remove_reaction(931,646).
catalyst(932,646) :- not remove_reaction(932,646).
catalyst(1191,646) :- not remove_reaction(1191,646).
catalyst(1192,646) :- not remove_reaction(1192,646).
catalyst(390,642).
catalyst(1180,612).
catalyst(1210,612).
catalyst(1250,602).
...
catalyst(1210,346).
catalyst(6650,343).
catalyst(791,317) :- not remove_reaction(791,317).
catalyst(792,317) :- not remove_reaction(792,317).
catalyst(801,317) :- not remove_reaction(801,317).
catalyst(802,317) :- not remove_reaction(802,317).
catalyst(811,317) :- not remove_reaction(811,317).
catalyst(812,317) :- not remove_reaction(812,317).
catalyst(831,317) :- not remove_reaction(831,317).
catalyst(832,317) :- not remove_reaction(832,317).
catalyst(841,317) :- not remove_reaction(841,317).
catalyst(842,317) :- not remove_reaction(842,317).
catalyst(851,317) :- not remove_reaction(851,317).
catalyst(852,317) :- not remove_reaction(852,317).
catalyst(901,317) :- not remove_reaction(901,317).
catalyst(902,317) :- not remove_reaction(902,317).
catalyst(1180,307).
catalyst(1210,307).
catalyst(690,303).
catalyst(730,303).
...
modifiable_enzyme(402).
modifiable_enzyme(434).
modifiable_enzyme(309).
modifiable_enzyme(798).
modifiable_enzyme(646).
