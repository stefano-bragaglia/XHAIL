...
component("YNL280C",789).
component("YLR056W",676).
component("YGR060W",468).
component("YGL012W",437).
component("YKR009C",653).
component("YOL086C",820).
component("YMR303C",761).
component("YMR083W",739).
component("YGL256W",461).
component("YDL168W",302).
component("YBR145W",232).
component("YPL231W",897).
component("YBR265W",250).
component("U46_",141).
component("YBR149W",233).
component("YBR149W",234).
component("YGL001C",433).
component("YIL094C",549).
component("YHR063C",515).
component("U45_",140).
component("YML056C",724).
component("YLR432W",713).
component("YHR216W",538).
component("YAR075W",196).
component("YAR073W",195).
component("YDR127W",331).
component("YJR139C",619).
component("YML075C",727).
component("YLR450W",716).
component("YOL126C",826).
component("YKL085W",630).
component("YDL078C",284).
component("YKL029C",626).
component("YNL037C",766).
component("YNL009W",764).
component("YLR174W",690).
component("YHR183W",531).
component("YGR256W",493).
component("YNL241C",781).
component("YOL059W",817).
component("YDL022W",276).
component("YCL018W",258).
component("YLR355C",708).
component("YIL074C",546).
component("YER081W",405).
component("YML054C",723).
component("YDL174C",306).
component("YML086C",729).
component("YIL155C",558).
component("YEL024W",379).
component("YKR066C",658).
component("YGR088W",472).
component("YDR256C",345).
component("YKL026C",625).
component("YIR037W",568).
component("YBR244W",245).
component("YJR078W",611).
component("U58_",150).
component("YJR025C",602).
component("U107_",27).
component("YGR255C",492).
component("U108_",28).
component("YHR007C",504).
component("YDR402C",360).
component("YGL055W",444).
component("YJR104C",614).
component("YHR008C",505).
component("YOR384W",870).
component("YOR381W",869).
component("YOL152W",829).
component("YLL051C",668).
component("YJL026W",570).
component("YIL066C",545).
component("YGR180C",480).
component("YER070W",402).
component("U37_",134).
component("U36_",133).
component("U35_",132).
component("YDL168W",303).
component("YDR158W",339).
component("YJR009C",598).
component("YJL052W",572).
component("YGR192C",482).
component("YBR006W",209).
component("YPL276W",906).
component("YPL275W",905).
component("YOR388C",871).
component("YPL061W",879).
component("YOR374W",867).
component("YER073W",403).
component("YGL154C",452).
component("YBR115C",227).
component("U55_",149).
component("YER069W",400).
component("YOR323C",859).
component("YMR170C",749).
component("YMR169C",748).
component("YER178W",415).
component("YBR221C",243).
component("YIL125W",554).
component("U52_",146).
component("YBR166C",237).
component("YNL280C",790).
component("YGL012W",438).
component("YKL182W",641).
component("YKL216W",651).
component("YDR044W",321).
component("YER014W",389).
component("YKR009C",654).
component("YIL160C",559).
component("YGL205W",457).
component("YMR118C",743).
component("YLR164W",688).
component("YLL041C",666).
component("YKL148C",635).
component("YKL141W",633).
component("YJL045W",571).
component("YDR178W",340).
component("YJR051W",605).
component("YEL047C",382).
component("YDL171C",304).
component("YDL171C",305).
component("YOR375C",868).
component("YDL215C",310).
component("YAL062W",192).
component("U99_",186).
component("U100_",21).
component("YBR035C",217).
component("YMR189W",751).
component("YKR080W",660).
component("YER023W",391).
component("YPL023C",875).
component("YGL125W",449).
component("YOR236W",856).
component("YGR204W",485).
component("YIR034C",567).
component("YLR142W",685).
component("U65_",157).
component("U63_",155).
component("U62_",154).
component("YHR068W",516).
component("YKL150W",636).
component("YIL043C",543).
component("YHR042W",510).
component("YOR221C",853).
component("YMR145C",746).
component("YML120C",730).
component("YKL192C",645).
component("YKL055C",628).
component("YER061C",398).
component("YDL085W",286).
component("YPL171C",887).
component("YHR179W",530).
component("YMR145C",747).
component("YML120C",731).
component("YKL192C",646).
component("YDL085W",287).
component("YGR234W",488).
component("YFR030W",429).
component("YPL017C",874).
component("YFL018C",419).
component("YDR353W",355).
component("YPR167C",925).
component("YJR137C",618).
component("YNL052W",768).
component("YMR256C",758).
component("YLR395C",712).
component("YLR038C",674).
component("YIL111W",551).
component("YHR051W",514).
component("YGL191W",455).
component("YGL187C",454).
component("YDL067C",283).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",326).
component("YPL266W",903).
component("YPL273W",904).
component("YLL062C",670).
component("YDR410C",363).
component("YKR069W",659).
component("YOL096C",821).
component("U47_",142).
component("YER091C",410).
component("YJR073C",609).
component("YGR157W",477).
component("YDR120C",329).
component("YML008C",718).
component("YOR074C",834).
component("YDL033C",278).
component("YOL096C",822).
component("YLR172C",689).
component("YLR058C",677).
component("YDR019C",317).
component("YBR176W",238).
component("YDR408C",362).
component("YMR120C",744).
component("YLR028C",672).
component("YBL013W",197).
component("YJL130C",583).
component("YJL088W",576).
component("YKL024C",624).
component("YPR074C",919).
component("YBR117C",228).
component("YMR108W",742).
component("YCL009C",257).
component("YNL071W",770).
component("YNR008W",796).
component("YIL160C",560).
component("YNR019W",799).
component("YCR048W",272).
component("U48_",143).
component("YMR062C",738).
component("YDR232W",342).
component("YPL231W",898).
component("YER061C",399).
component("YPL001W",873).
component("YDL052C",282).
component("U8_",180).
component("YDR148C",337).
component("YPL231W",899).
component("YPL028W",876).
component("YLR299W",700).
component("YGL017W",439).
component("YCR005C",264).
component("YML126C",732).
component("YNL104C",773).
component("YDL182W",307).
component("YDL131W",293).
component("YDR307W",351).
component("YLR258W",697).
component("YFR015C",426).
component("YPL227C",895).
component("YNL029C",765).
component("YIL085C",548).
component("YNL192W",779).
component("YBR038W",219).
component("YBR023C",215).
component("YMR306W",762).
component("YLR342W",706).
component("YGR032W",465).
component("YPR183W",928).
component("YBR248C",246).
component("YLR209C",692).
component("U104_",24).
component("U103_",23).
component("YOR209C",851).
component("YDR354W",356) :- not remove_orf("YDR354W",356).
component("YFR047C",430).
component("YJR133W",617).
component("YLR209C",693).
component("YML022W",720).
component("YDR441C",366).
component("YHR128W",525).
component("YPR176C",927).
component("YPL172C",888).
component("YNR041C",802).
component("YMR101C",740).
component("YDL090C",289).
component("YBR003W",208).
component("YBR002C",207).
component("YJL167W",590).
component("YJL167W",591).
component("YNL256W",784).
component("YPR069C",916).
component("YDR127W",332).
component("YHR190W",533).
component("YLR146C",686).
component("YPL214C",894).
component("YHR068W",517).
component("YLR303W",702).
component("YGR012W",463).
component("YML082W",728).
component("YJR130C",616).
component("YDR035W",319).
component("YBR249C",247).
component("YLR180W",691).
component("YDR502C",370).
component("YOR274W",857).
component("YOL143C",828).
component("YBR256C",249).
component("YHR137W",526).
component("YGL202W",456).
component("YLR027C",671).
component("YKL106W",631).
component("YOL140W",827).
component("YLR438W",715).
component("YGR019W",464).
component("YLR089C",681).
component("U64_",156).
component("U61_",153).
component("U51_",145).
component("YJR148W",620).
component("YHR208W",536).
component("YFL030W",421).
component("YOR184W",845).
component("YNR058W",806).
component("YIL116W",553).
component("YGL253W",460).
component("YFR053C",431).
component("YMR013C",736).
component("YMR205C",753).
component("YGR240C",489).
component("YOL016C",810).
component("YFR014C",425).
component("YLR240W",695).
component("YKL203C",648).
component("YJR066W",608).
component("YCR036W",271).
component("YGR194C",483).
component("YCL040W",260).
component("U15_",68).
component("YPL188W",890).
component("YJR049C",604).
component("YEL041W",380).
component("U96_",184).
component("YKL001C",623).
component("YDR236C",343).
component("YML070W",726).
component("YFL053W",423).
component("YHL032C",502).
component("YDR531W",374).
component("U83_",175).
component("U82_",174).
component("U81_",173).
component("YMR208W",754).
component("YPL203W",891).
component("YOR061W",833).
component("YKL166C",638).
component("YJL164C",589).
component("YIL035C",542).
component("YHR205W",535).
component("YHR102W",523).
component("YGL019W",440).
component("YHR025W",509).
component("YOR347C",864).
component("YAL038W",190).
component("YNR012W",797).
...
component("U17_",83).
component("U76_",167).
component("YER170W",414).
component("YDR226W",341).
component("YKL067W",629).
component("YOL055C",814).
component("YDR454C",367).
component("YJR057W",606).
component("YOL061W",818).
component("YKL181W",640).
component("YHL011C",500).
component("YER099C",411).
component("YBL068W",204).
component("YOR143C",841).
component("YNL256W",785).
component("YLR328W",704).
component("YBR018C",211).
component("YBR018C",212).
component("YGR007W",462).
component("YGR202C",484).
component("YLR328W",705).
component("YDL045C",280).
component("U80_",172).
component("YDL103C",292).
component("U94_",183).
component("YJR010W",599).
component("YBR029C",216).
component("YCL050C",261).
component("YGL130W",450).
component("YDR530C",373).
component("YCL050C",262).
component("YPR190C",930).
component("YPR187W",929).
component("YPR110C",922).
component("YPR010C",909).
component("YOR341W",863).
component("YOR340C",862).
component("YOR224C",855).
component("YOR210W",852).
component("YOR207C",849).
component("YOR151C",842).
component("YOR116C",836).
component("YOL005C",808).
component("YNR003C",795).
component("YNL248C",783).
component("YNL151C",777).
component("YNL113W",774).
component("YKL144C",634).
component("YJR063W",607).
component("YJL148W",587).
component("YJL140W",586).
component("YIL021W",541).
component("YHR143W-A",527).
component("YGL070C",447).
component("YFL036W",422).
...
component("YPR175W",926).
component("YPL167C",886).
component("YOR330C",860).
component("YOL115W",825).
component("YNL299W",792).
component("YNL262W",787).
component("YNL102W",772).
component("YJR043C",603).
component("YJR006W",597).
component("YJL090C",577).
component("YIL139C",556).
...
component("YKL035W",627).
component("YHL012W",501).
component("YHR123W",524).
component("YPR113W",923).
component("YBR243C",244).
component("YDL142C",300).
component("YPL148C",884).
component("YER026C",392).
component("YGR286C",497).
component("YJL068C",573).
component("YHR189W",532).
component("YDR058C",325).
component("YDL086W",288).
component("YOL011W",809).
component("YMR008C",734).
component("YMR006C",733).
component("U105_",25).
component("YBL015W",198).
component("YJL068C",574).
component("YJR019C",601).
component("YOR040W",832).
component("U77_",168).
component("YDR481C",368).
component("YLR377C",710).
component("YFR025C",427).
component("YPL179W",889).
component("YNR032W",800).
component("YML057W",725).
component("YML016C",719).
component("YLR433C",714).
component("YGR123C",475).
component("YER133W",412).
component("YER089C",408).
...
component("YPR073C",917).
component("YHR215W",537).
component("YDL024C",277).
component("YBR093C",225).
component("YBR092C",224).
component("YAR071W",194).
component("YHR046C",513).
component("U9_",187).
component("YPL228W",896).
component("YMR180C",750).
component("YDL236W",312).
component("YJL155C",588).
component("YPR073C",918).
component("YOR208W",850).
component("YNL053W",769).
component("YMR036C",737).
component("YIR026C",566).
component("YIL113W",552).
component("YFR028C",428).
component("YER075C",404).
...
component("U25_",122).
component("U24_",121).
component("YHR044C",512).
component("YHR043C",511).
component("YOL064C",819).
component("YOR360C",866).
component("YGL248W",459).
component("YKR031C",655).
component("YPL206C",892).
component("YGL027C",442).
component("YLR286C",699).
component("YJR153W",621).
component("YJL221C",596).
component("YJL216C",594).
component("YIL172C",564).
component("YGR292W",499).
component("YGR287C",498).
component("YBR299W",256).
component("YBR184W",239).
component("YIL162W",561).
component("YPR026W",910).
component("YDR001C",314).
component("YBR001C",206).
component("YIR019C",565).
component("YIL099W",550).
component("YDL037C",279).
component("YOR190W",847).
component("YLR300W",701).
component("YGR282C",496).
component("YDR261C",346).
component("YDR400W",359).
component("U23_",120).
component("YML035C",721).
component("YJL070C",575).
component("YBR284W",253).
component("U106_",26).
component("U102_",22).
component("YER043C",393).
component("YNL045W",767).
component("YGL037C",443).
component("YDR242W",344).
component("YBR208C",241).
component("YMR281W",760).
component("U53_",147).
component("YPR062W",915).
component("YMR120C",745).
component("YLR028C",673).
component("YHR144C",528).
component("YGR267C",495).
component("YBL033C",199).
component("YBR153W",235).
component("YNL141W",775).
component("YLR245C",696).
component("YML035C",722).
component("YGR204W",486).
component("YBR084W",222).
component("YJL126W",581).
component("U44_",139).
...
component("YHR201C",534).
component("YBR111C",226).
component("YBR252W",248).
component("YPR080W",920).
component("YOR187W",846).
component("YOR133W",839).
component("YLR069C",679).
component("YKR084C",661).
component("YKL173W",639).
component("YJL102W",579).
component("YDR385W",358).
component("YBR118W",229).
component("YER005W",388).
component("YLL001W",664).
component("YIL048W",544).
component("YER166W",413).
component("YDR093W",328).
component("YAL026C",189).
component("YBL099W",205).
component("U60_",152).
component("YLR231C",694).
component("U88_",178).
component("YDR538W",376).
component("YLR134W",683).
component("YLR044C",675).
component("YGR087C",471).
component("YDR380W",357).
component("YDL080C",285).
component("U98_",185).
component("YMR250W",757).
component("YKL184W",644).
component("YOR128C",837).
component("YEL021W",378).
component("YNR043W",803).
component("U93_",182).
component("U54_",148).
component("YKL211C",649) :- not remove_orf("YKL211C",649).
component("YKR097W",663).
component("YOL052C",813).
component("YNL169C",778).
component("YGR170W",478).
component("YNL256W",786).
component("YDR294C",348).
component("YEL046C",381).
component("YNR033W",801).
component("YKL211C",650) :- not remove_orf("YKL211C",650).
component("YER090W",650) :- not remove_orf("YER090W",650).
component("YER090W",409) :- not remove_orf("YER090W",409).
component("YDR127W",334).
component("YPL281C",907).
component("YOR393W",872).
component("YMR323W",763).
component("YHR174W",529).
component("YGR254W",491).
component("YOR202W",848).
component("YPL262W",901).
component("YGL026C",441) :- not remove_orf("YGL026C",441).
component("YGR155W",476).
component("YLR304C",703).
component("YJL200C",592).
component("YGL009C",436).
component("YNL316C",793).
component("YKL182W",642).
component("YPL212C",893).
component("YNL292W",791).
component("YGL063W",446).
component("YFL001W",417).
component("YPR002W",908).
component("YJR016C",600).
component("YCR053W",273).
component("YDR127W",335).
component("YGL148W",451).
component("YIL168W",563).
component("YIL167W",562).
component("YCL064C",263).
component("YER086W",406).
component("YLR359W",709).
component("YAL012W",188).
component("YML004C",717).
component("YFR055W",432).
component("YJL005W",569).
component("YJL121C",580).
component("YBR019C",213).
component("YDR050C",324).
component("YIL020C",540).
component("YDR007W",315) :- not remove_orf("YDR007W",315).
component("YOR095C",835).
component("YER003C",387).
component("YBR196C",240).
component("YGL001C",434).
component("YPL117C",882).
component("U14_",60).
component("YOL056W",815).
component("YKL152C",637).
component("YDL021W",275).
component("YMR105C",741).
component("YKL127W",632).
component("YEL058W",384).
component("YPR060C",914).
component("YHR072W",518).
component("YPL097W",880).
component("YGR185C",481).
component("YGR264C",494).
component("YGR171C",479).
component("YHR011W",506).
component("YDR023W",318).
component("YPL104W",881).
component("YLL018C",665).
component("YPR081C",921).
component("YBR121C",230).
component("YHR020W",508).
component("YER087W",407).
component("YNL247W",782).
component("YOR168W",843).
component("YOL097C",823).
component("YDR268W",347).
component("YPR047W",913).
component("YLR060W",678).
component("YFL022C",420).
component("YPR033C",911).
component("YCR024C",267).
component("YHR019C",507).
component("YKL194C",647).
component("YIL078W",547).
component("YPL160W",885).
component("YLR382C",711).
component("YNL073W",771).
component("YDR037W",320).
component("YOR335C",861).
component("YGR094W",473).
component("YLR153C",687).
component("YAL054C",191).
component("YOR317W",858).
component("YMR246W",756).
component("YIL009W",539).
component("YER015W",390).
component("YOR142W",840).
component("YGR244C",490).
component("YPR035W",912).
component("YIL145C",557).
component("U89_",179).
component("YJL101C",578).
component("YOL049W",812).
component("YAR015W",193).
component("YER183C",416).
component("U90_",181).
component("YNR057C",805).
component("YDL141W",296).
component("YDL141W",297).
component("YGL234W",458).
component("YDL141W",298).
component("YJR103W",613).
component("YBL039C",201).
component("YGR204W",487).
component("YBR084W",223).
component("YNL220W",780).
component("YOL058W",816).
component("YDL141W",299).
component("YHR074W",519).
component("YMR217W",755).
component("YGR061C",469).
component("YJR109C",615).
component("YJL130C",584).
component("YGL062W",445).
component("YBR218C",242).
component("YPL231W",900).
component("YNR016C",798).
component("YKL182W",643).
component("YGR037C",466).
component("YPR138C",924).
component("YPL265W",902).
component("YPL134C",883).
component("YPL057C",878).
component("YPL036W",877).
component("YOR348C",865).
component("YOR222W",854).
component("YOR171C",844).
component("YOR130C",838).
component("YOR011W",831).
component("YOL156W",830).
component("YOL103W",824).
component("YOL020W",811) :- not remove_orf("YOL020W",811).
component("YNR072W",807).
component("YNR056C",804).
component("YNL318C",794).
component("YNL270C",788).
component("YNL142W",776).
component("YMR272C",759).
component("YMR202W",752).
component("YMR011W",735).
component("YLR348C",707).
component("YLR260W",698).
component("YLR138W",684).
component("YLR100C",682).
component("YLR081W",680).
component("YLL061W",669).
component("YLL043W",667).
component("YKR093W",662).
component("YKR053C",657).
component("YKR039W",656) :- not remove_orf("YKR039W",656).
component("YKL217W",652).
component("YJR158W",622).
component("YJR095W",612).
component("YJR077C",610).
component("YJL219W",595).
component("YJL214W",593).
component("YJL134W",585).
component("YJL129C",582).
component("YIL134W",555).
component("YHR096C",522).
component("YHR094C",521).
component("YHR092C",520).
component("YHL036W",503).
component("YGR121C",474).
component("YGR065C",470).
component("YGR055W",467).
component("YGL186C",453).
component("YGL077C",448).
component("YGL008C",435).
component("YFL055W",424).
component("YFL011W",418).
component("YER060W-A",397).
component("YER060W",396).
component("YER056C",395).
component("YER053C",394).
...
catalyst(2300,182).
catalyst(3460,148).
catalyst(3600,649) :- not remove_reaction(3600,649).
catalyst(8000,663).
catalyst(3941,813).
catalyst(3942,813).
catalyst(6890,778).
...
catalyst(4560,381).
catalyst(2550,801).
catalyst(1890,650) :- not remove_reaction(1890,650).
catalyst(3630,650) :- not remove_reaction(3630,650).
catalyst(1890,409) :- not remove_reaction(1890,409).
catalyst(3630,409) :- not remove_reaction(3630,409).
catalyst(3740,334).
catalyst(8231,907).
catalyst(8232,907).
catalyst(8231,872).
...
catalyst(8061,901).
catalyst(8062,901).
catalyst(3590,441) :- not remove_reaction(3590,441).
catalyst(10910,441) :- not remove_reaction(10910,441).
catalyst(4570,476).
catalyst(8181,703).
catalyst(8182,703).
catalyst(8181,592).
...
catalyst(1210,830).
catalyst(1160,824).
catalyst(801,811) :- not remove_reaction(801,811).
catalyst(802,811) :- not remove_reaction(802,811).
catalyst(811,811) :- not remove_reaction(811,811).
catalyst(812,811) :- not remove_reaction(812,811).
catalyst(831,811) :- not remove_reaction(831,811).
catalyst(832,811) :- not remove_reaction(832,811).
catalyst(901,811) :- not remove_reaction(901,811).
catalyst(902,811) :- not remove_reaction(902,811).
catalyst(1180,807).
catalyst(1210,807).
catalyst(700,804).
catalyst(1200,794).
...
catalyst(650,662).
catalyst(6560,657).
catalyst(771,656) :- not remove_reaction(771,656).
catalyst(772,656) :- not remove_reaction(772,656).
catalyst(781,656) :- not remove_reaction(781,656).
catalyst(782,656) :- not remove_reaction(782,656).
catalyst(791,656) :- not remove_reaction(791,656).
catalyst(792,656) :- not remove_reaction(792,656).
catalyst(801,656) :- not remove_reaction(801,656).
catalyst(802,656) :- not remove_reaction(802,656).
catalyst(811,656) :- not remove_reaction(811,656).
catalyst(812,656) :- not remove_reaction(812,656).
catalyst(831,656) :- not remove_reaction(831,656).
catalyst(832,656) :- not remove_reaction(832,656).
catalyst(841,656) :- not remove_reaction(841,656).
catalyst(842,656) :- not remove_reaction(842,656).
catalyst(851,656) :- not remove_reaction(851,656).
catalyst(852,656) :- not remove_reaction(852,656).
catalyst(881,656) :- not remove_reaction(881,656).
catalyst(882,656) :- not remove_reaction(882,656).
catalyst(901,656) :- not remove_reaction(901,656).
catalyst(902,656) :- not remove_reaction(902,656).
catalyst(911,656) :- not remove_reaction(911,656).
catalyst(912,656) :- not remove_reaction(912,656).
catalyst(921,656) :- not remove_reaction(921,656).
catalyst(922,656) :- not remove_reaction(922,656).
catalyst(931,656) :- not remove_reaction(931,656).
catalyst(932,656) :- not remove_reaction(932,656).
catalyst(1191,656) :- not remove_reaction(1191,656).
catalyst(1192,656) :- not remove_reaction(1192,656).
catalyst(390,652).
catalyst(1180,622).
catalyst(1210,622).
catalyst(1250,612).
