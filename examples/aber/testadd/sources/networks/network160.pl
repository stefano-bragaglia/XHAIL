...
component("YNL280C",800).
component("YLR056W",684).
component("YGR060W",474).
component("YGL012W",442).
component("YKR009C",661).
component("YOL086C",832).
component("YMR303C",772).
component("YMR083W",750).
component("YGL256W",467).
component("YDL168W",305).
component("YBR145W",234).
component("YPL231W",910).
component("YBR265W",253).
component("U46_",141).
component("YBR149W",235).
component("YBR149W",236).
component("YGL001C",438).
component("YIL094C",555).
component("YHR063C",521).
component("U45_",140).
component("YML056C",734).
component("YLR432W",723).
component("YHR216W",544).
component("YAR075W",197).
component("YAR073W",196).
component("YDR127W",334).
component("YJR139C",626).
component("YML075C",737).
component("YLR450W",726).
component("YOL126C",838).
component("YKL085W",638).
component("YDL078C",287).
component("YKL029C",633).
component("YNL037C",777).
component("YNL009W",775).
component("YLR174W",698).
component("YHR183W",537).
component("YGR256W",499).
component("YNL241C",792).
component("YOL059W",829).
component("YDL022W",279).
component("YCL018W",261).
component("YLR355C",718).
component("YIL074C",552).
component("YER081W",410).
component("YML054C",733).
component("YDL174C",309).
component("YML086C",739).
component("YIL155C",564).
component("YEL024W",383).
component("YKR066C",666).
component("YGR088W",478).
component("YDR256C",348).
component("YKL026C",632).
component("YIR037W",575).
component("YBR244W",248).
component("YJR078W",618).
component("U58_",150).
component("YJR025C",609).
component("U107_",27).
component("YGR255C",498).
component("U108_",28).
component("YHR007C",510).
component("YDR402C",363).
component("YGL055W",449).
component("YJR104C",621).
component("YHR008C",511).
component("YOR384W",882).
component("YOR381W",881).
component("YOL152W",841).
component("YLL051C",676).
component("YJL026W",577).
component("YIL066C",551).
component("YGR180C",486).
component("YER070W",407).
component("U37_",134).
component("U36_",133).
component("U35_",132).
component("YDL168W",306).
component("YDR158W",342).
component("YJR009C",605).
component("YJL052W",579).
component("YGR192C",488).
component("YBR006W",210).
component("YPL276W",920).
component("YPL275W",919).
component("YOR388C",883).
component("YPL061W",891).
component("YOR374W",879).
component("YER073W",408).
component("YGL154C",457).
component("YBR115C",229).
component("U55_",149).
component("YER069W",405).
component("YOR323C",871).
component("YMR170C",760).
component("YMR169C",759).
component("YER178W",420).
component("YBR221C",246).
component("YIL125W",560).
component("U52_",146).
component("YBR166C",239).
component("YNL280C",801).
component("YGL012W",443).
component("YKL182W",649).
component("YKL216W",659).
component("YDR044W",324).
component("YER014W",393).
component("YKR009C",662).
component("YIL160C",565).
component("YGL205W",462).
component("YMR118C",754).
component("YLR164W",696).
component("YLL041C",674).
component("YKL148C",643).
component("YKL141W",641).
component("YJL045W",578).
component("YDR178W",343).
component("YJR051W",612).
component("YEL047C",386).
component("YDL171C",307).
component("YDL171C",308).
component("YOR375C",880).
component("YDL215C",313).
component("YAL062W",193).
component("U99_",187).
component("U100_",21).
component("YBR035C",219).
component("YMR189W",762).
component("YKR080W",668).
component("YER023W",395).
component("YPL023C",887).
component("YGL125W",454).
component("YOR236W",868).
component("YGR204W",491).
component("YIR034C",574).
component("YLR142W",693).
component("U65_",157).
component("U63_",155).
component("U62_",154).
component("YHR068W",522).
component("YKL150W",644).
component("YIL043C",549).
component("YHR042W",516).
component("YOR221C",865).
component("YMR145C",757).
component("YML120C",740).
component("YKL192C",653).
component("YKL055C",635).
component("YER061C",403).
component("YDL085W",289).
component("YPL171C",900).
component("YHR179W",536).
component("YMR145C",758).
component("YML120C",741).
component("YKL192C",654).
component("YDL085W",290).
component("YGR234W",494).
component("YFR030W",434).
component("YPL017C",886).
component("YFL018C",424).
component("YPL091W",892).
component("YDR353W",358).
component("YER042W",397).
component("YPR167C",941).
component("YJR137C",625).
component("YNL052W",779).
component("YMR256C",769).
component("YLR395C",722).
component("YLR038C",682).
component("YIL111W",557).
component("YHR051W",520).
component("YGL191W",460).
component("YGL187C",459).
component("YDL067C",286).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",329).
component("YPL266W",917).
component("YPL273W",918).
component("YLL062C",678).
component("YDR410C",366).
component("YKR069W",667).
component("YOL096C",833).
component("U47_",142).
component("YER091C",415).
component("YJR073C",616).
component("YGR157W",483).
component("YDR120C",332).
component("YML008C",728).
component("YOR074C",846).
component("YDL033C",281).
component("YOL096C",834).
component("YLR172C",697).
component("YLR058C",685).
component("YDR019C",320).
component("YBR176W",240).
component("YDR408C",365).
component("YMR120C",755).
component("YLR028C",680).
component("YBL013W",198).
component("YJL130C",590).
component("YJL088W",583).
component("YKL024C",631).
component("YPR074C",933).
component("YBR117C",230).
component("YMR108W",753).
component("YCL009C",260).
component("YMR062C",748).
component("YNL071W",781).
component("YNR008W",807).
component("YIL160C",566).
component("YNR019W",810).
component("YCR048W",275).
component("U48_",143).
component("YMR062C",749).
component("YDR232W",345).
component("YPL231W",911).
component("YER061C",404).
component("YPL001W",885).
component("YDL052C",285).
component("U8_",181).
component("YDR148C",340).
component("YPL231W",912).
component("YPL028W",888).
component("YLR299W",708).
component("YGL017W",444).
component("YCR005C",267).
component("YML126C",742).
component("YNL104C",784).
component("YDL182W",310).
component("YDL131W",296).
component("YPR160W",940).
component("YDR307W",354).
component("YLR258W",705).
component("YFR015C",431).
component("YPL227C",908).
component("YNL029C",776).
component("YIL085C",554).
component("YNL192W",790).
component("YBR038W",221).
component("YBR023C",217).
component("YEL011W",380).
component("YMR306W",773).
component("YLR342W",716).
component("YGR032W",471).
component("YPR183W",944).
component("YBR248C",249).
component("YLR209C",700).
component("U104_",24).
component("U103_",23).
component("YOR209C",863).
component("YDR354W",359) :- not remove_orf("YDR354W",359).
component("YFR047C",435).
component("YJR133W",624).
component("YLR209C",701).
component("YML022W",730).
component("YDR441C",369).
component("YHR128W",531).
component("YPR176C",943).
component("YPL172C",901).
component("YNR041C",813).
component("YMR101C",751).
component("YDL090C",292).
component("YBR003W",209).
component("YBR002C",208).
component("YJL167W",597).
component("YJL167W",598).
component("YNL256W",795).
component("YPR069C",930).
component("YDR127W",335).
component("YHR190W",539).
component("YLR146C",694).
component("YPL214C",907).
component("YHR068W",523).
component("YLR303W",710).
component("YGR012W",469).
component("YML082W",738).
component("YJR130C",623).
component("YDR035W",322).
component("YBR249C",250).
component("YLR180W",699).
component("YDR502C",373).
component("YOR274W",869).
component("YOL143C",840).
component("YBR256C",252).
component("YHR137W",532).
component("YGL202W",461).
component("YLR027C",679).
component("YKL106W",639).
component("YOL140W",839).
component("YLR438W",725).
component("YGR019W",470).
component("YLR089C",689).
component("U64_",156).
component("U61_",153).
component("U51_",145).
component("YJR148W",627).
component("YHR208W",542).
component("YFL030W",426).
component("YOR184W",857).
component("YNR058W",817).
component("YIL116W",559).
component("YGL253W",466).
component("YFR053C",436).
component("YMR013C",746).
component("YMR205C",764).
component("YGR240C",495).
component("YOL016C",821).
component("YFR014C",430).
component("YLR240W",703).
component("YKL203C",656).
component("YJR066W",615).
component("YCR036W",274).
component("YGR194C",489).
component("YCL040W",263).
component("U15_",68).
component("YPL188W",903).
component("YJR049C",611).
component("YEL041W",384).
component("U96_",185).
component("YKL001C",630).
component("YDR236C",346).
component("YML070W",736).
component("YFL053W",428).
component("YHL032C",508).
component("YDR531W",377).
component("U83_",175).
component("U82_",174).
component("U81_",173).
component("YMR208W",765).
component("YPL203W",904).
component("YOR061W",845).
component("YKL166C",646).
component("YJL164C",596).
component("YIL035C",548).
component("YHR205W",541).
component("YHR102W",529).
component("YGL019W",445).
component("YHR025W",515).
component("YOR347C",876).
component("YAL038W",191).
component("YNR012W",808).
component("YPR121W",938).
component("YPL258C",914).
component("YOL055C",825).
component("YDR009W",319).
component("YDR127W",336).
component("U21_",113).
component("YDR147W",339).
component("YDR300C",353).
component("YCR012W",268).
component("YER069W",406).
component("U19_",103).
component("U18_",93).
component("U17_",83).
component("U76_",167).
component("YER170W",419).
component("YDR226W",344).
component("YKL067W",637).
component("YOL055C",826).
component("YDR454C",370).
component("YJR057W",613).
component("YOL061W",830).
component("YKL181W",648).
component("YHL011C",506).
component("YER099C",416).
component("YBL068W",205).
component("YOR143C",853).
component("YNL256W",796).
component("YLR328W",714).
component("YBR018C",212).
component("YBR018C",213).
component("YGR007W",468).
component("YGR202C",490).
component("YLR328W",715).
component("YDL045C",283).
component("U80_",172).
component("YDL103C",295).
component("U94_",184).
component("YJR010W",606).
component("YBR029C",218).
component("YCL050C",264).
component("YGL130W",455).
component("YDR530C",376).
component("YCL050C",265).
component("YPR190C",946).
component("YPR187W",945).
component("YPR110C",936).
component("YPR010C",923).
component("YOR341W",875).
component("YOR340C",874).
component("YOR224C",867).
component("YOR210W",864).
component("YOR207C",861).
component("YOR151C",854).
component("YOR116C",848).
component("YOL005C",819).
component("YNR003C",806).
component("YNL248C",794).
component("YNL151C",788).
component("YNL113W",785).
component("YKL144C",642).
component("YJR063W",614).
component("YJL148W",594).
component("YJL140W",593).
component("YIL021W",547).
component("YHR143W-A",533).
component("YGL070C",452).
component("YFL036W",427).
component("YDR404C",364).
component("YDR156W",341).
component("YDR045C",325).
component("YDL150W",304).
component("YDL140C",298).
component("YBR154C",238).
component("YPR175W",942).
component("YPL167C",899).
component("YOR330C",872).
component("YOL115W",837).
component("YNL299W",803).
component("YNL262W",798).
component("YNL102W",783).
component("YJR043C",610).
component("YJR006W",604).
component("YJL090C",584).
component("YIL139C",562).
component("YEL055C",387).
component("YDR419W",367).
component("YDR121W",333).
component("YDL102W",294).
component("YCR014C",269).
component("YBR278W",255).
component("YBL035C",201).
component("YKL035W",634).
component("YHL012W",507).
component("YHR123W",530).
component("YPR113W",937).
component("YBR243C",247).
component("YDL142C",303).
component("YPL148C",897).
component("YER026C",396).
component("YGR286C",503).
component("YJL068C",580).
component("YHR189W",538).
component("YDR058C",328).
component("YDL086W",291).
component("YOL011W",820).
component("YMR008C",744).
component("YMR006C",743).
component("U105_",25).
component("YBL015W",199).
component("YJL068C",581).
component("YJR019C",608).
component("YOR040W",844).
component("U84_",176).
component("U77_",168).
component("YDR481C",371).
component("YLR377C",720).
component("YFR025C",432).
component("YPL179W",902).
component("YNR032W",811).
component("YML057W",735).
component("YML016C",729).
component("YLR433C",724).
component("YGR123C",481).
component("YER133W",417).
component("YER089C",413).
component("YDR436W",368).
component("YDR075W",330).
component("YDL188C",311).
component("YDL134C",297).
component("YDL047W",284).
component("YDL006W",277).
component("YBR125C",233).
component("YBL056W",204).
component("YPR073C",931).
component("YHR215W",543).
component("YDL024C",280).
component("YBR093C",227).
component("YBR092C",226).
component("YAR071W",195).
component("YHR046C",519).
component("U9_",188).
component("YPL228W",909).
component("YMR180C",761).
component("YDL236W",315).
component("YJL155C",595).
component("YPR073C",932).
component("YOR208W",862).
component("YNL053W",780).
component("YMR036C",747).
component("YIR026C",572).
component("YIL113W",558).
component("YFR028C",433).
component("YER075C",409).
...
component("U25_",122).
component("U24_",121).
component("YHR044C",518).
component("YHR043C",517).
component("YOL064C",831).
component("YOR360C",878).
component("YGL248W",465).
component("YKR031C",663).
component("YPL206C",905).
component("YGL027C",447).
component("YLR286C",707).
component("YJR153W",628).
component("YJL221C",603).
component("YJL216C",601).
component("YIL172C",570).
component("YGR292W",505).
component("YGR287C",504).
component("YBR299W",259).
component("YBR184W",241).
component("YIL162W",567).
component("YPR026W",924).
component("YDR001C",317).
component("YBR001C",207).
component("YIR019C",571).
component("YIL099W",556).
component("YDL037C",282).
component("YOR190W",859).
component("YLR300W",709).
component("YGR282C",502).
component("YDR261C",349).
component("YDR400W",362).
component("U23_",120).
component("YML035C",731).
component("YJL070C",582).
component("YBR284W",256).
component("U106_",26).
component("U102_",22).
component("YER043C",398).
component("YNL045W",778).
component("YGL037C",448).
component("YDR242W",347).
component("YLR308W",713).
component("YLR307W",712).
component("YBR208C",243).
component("YMR281W",771).
component("U53_",147).
component("YIR032C",573).
component("YPR062W",929).
component("YMR120C",756).
component("YLR028C",681).
component("YHR144C",534).
component("YGR267C",501).
component("YBL033C",200).
component("YBR153W",237).
component("YNL141W",786).
component("YLR245C",704).
component("YML035C",732).
component("YGR204W",492).
component("YBR084W",224).
component("YJL126W",588).
component("U44_",139).
component("YDL100C",293).
component("U87_",178).
component("U40_",137).
component("U39_",135).
component("YBR011C",211).
component("YHR201C",540).
component("YBR111C",228).
component("YBR252W",251).
component("YPR080W",934).
component("YOR187W",858).
component("YOR133W",851).
component("YLR069C",687).
component("YKR084C",669).
component("YKL173W",647).
component("YJL102W",586).
component("YDR385W",361).
component("YBR118W",231).
component("YER005W",392).
component("YLL001W",672).
component("YIL048W",550).
component("YER166W",418).
component("YDR093W",331).
component("YAL026C",190).
component("YBL099W",206).
component("U60_",152).
component("YLR231C",702).
component("U88_",179).
component("YDR538W",379).
component("YLR134W",691).
component("YLR044C",683).
component("YGR087C",477).
component("YDR380W",360).
component("YDL080C",288).
component("U98_",186).
component("YMR250W",768).
component("YKL184W",652).
component("YOR128C",849).
component("YEL021W",382).
component("YNR043W",814).
component("U93_",183).
component("U54_",148).
component("YKL211C",657) :- not remove_orf("YKL211C",657).
component("YKR097W",671).
component("YOL052C",824).
component("YNL169C",789).
component("YGR170W",484).
component("YKL060C",636).
component("YNL256W",797).
component("YDR294C",351).
component("YEL046C",385).
component("YNR033W",812).
component("YKL211C",658) :- not remove_orf("YKL211C",658).
component("YER090W",658) :- not remove_orf("YER090W",658).
component("YER090W",414) :- not remove_orf("YER090W",414).
component("YDR127W",337).
component("YPL281C",921).
component("YOR393W",884).
component("YMR323W",774).
component("YHR174W",535).
component("YGR254W",497).
component("YOR202W",860).
component("YPL262W",915).
component("YGL026C",446) :- not remove_orf("YGL026C",446).
component("YGR155W",482).
component("YLR304C",711).
component("YJL200C",599).
component("YGL009C",441).
component("YNL316C",804).
component("YKL182W",650).
component("YPL212C",906).
component("YNL292W",802).
component("YGL063W",451).
component("YFL001W",422).
component("YPR002W",922).
component("YJR016C",607).
component("YCR053W",276).
component("YDR127W",338).
component("YGL148W",456).
component("YIL168W",569).
component("YIL167W",568).
component("YCL064C",266).
component("YER086W",411).
component("YLR359W",719).
component("YAL012W",189).
component("YML004C",727).
component("YFR055W",437).
component("YJL005W",576).
component("YJL121C",587).
component("YBR019C",214).
component("YBR019C",215).
component("YDR050C",327).
component("YIL020C",546).
component("YDR007W",318) :- not remove_orf("YDR007W",318).
component("YOR095C",847).
component("YER003C",391).
component("YBR196C",242).
component("YGL001C",439).
component("YPL117C",895).
component("U14_",60).
component("YOL056W",827).
component("YKL152C",645).
component("YDL021W",278).
component("YMR105C",752).
component("YKL127W",640).
component("YEL058W",388).
component("YPR060C",928).
component("YHR072W",524).
component("YPL097W",893).
component("YGR185C",487).
component("YGR264C",500).
component("YGR171C",485).
component("YHR011W",512).
component("YDR023W",321).
component("YPL104W",894).
component("YLL018C",673).
component("YPR081C",935).
component("YBR121C",232).
component("YHR020W",514).
component("YER087W",412).
component("YNL247W",793).
component("YOR168W",855).
component("YOL097C",835).
component("YDR268W",350).
component("YPR047W",927).
component("YLR060W",686).
component("YFL022C",425).
component("YPR033C",925).
component("YCR024C",270).
component("YHR019C",513).
component("YKL194C",655).
component("YIL078W",553).
component("YPL160W",898).
component("YLR382C",721).
component("YNL073W",782).
component("YDR037W",323).
component("YOR335C",873).
component("YGR094W",479).
component("YLR153C",695).
component("YAL054C",192).
component("YOR317W",870).
component("YMR246W",767).
component("YIL009W",545).
component("YER015W",394).
component("YOR142W",852).
component("YGR244C",496).
component("YPR035W",926).
component("YIL145C",563).
component("U89_",180).
component("YJL101C",585).
component("YOL049W",823).
component("YAR015W",194).
component("YGL234W",463).
component("YER183C",421).
component("U90_",182).
component("YNR057C",816).
component("YDL141W",299).
component("YDL141W",300).
component("YGL234W",464).
component("YDL141W",301).
component("YJR103W",620).
component("YBL039C",202).
component("YGR204W",493).
component("YBR084W",225).
component("YNL220W",791).
component("YOL058W",828).
component("YBR208C",244).
component("YDL141W",302).
component("YHR074W",525).
component("YMR217W",766).
component("YGR061C",475).
component("YJR109C",622).
component("YJL130C",591).
component("YGL062W",450).
component("YBR218C",245).
component("YPL231W",913).
component("YNR016C",809).
component("YKL182W",651).
component("YGR037C",472).
component("YPR138C",939).
component("YPL265W",916).
component("YPL134C",896).
component("YPL057C",890).
component("YPL036W",889).
component("YOR348C",877).
component("YOR222W",866).
component("YOR171C",856).
component("YOR130C",850).
component("YOR011W",843).
component("YOL156W",842).
component("YOL103W",836).
component("YOL020W",822) :- not remove_orf("YOL020W",822).
component("YNR072W",818).
component("YNR056C",815).
component("YNL318C",805).
component("YNL270C",799).
component("YNL142W",787).
component("YMR272C",770).
component("YMR202W",763).
component("YMR011W",745).
component("YLR348C",717).
component("YLR260W",706).
component("YLR138W",692).
component("YLR100C",690).
component("YLR081W",688).
component("YLL061W",677).
component("YLL043W",675).
component("YKR093W",670).
component("YKR053C",665).
component("YKR039W",664) :- not remove_orf("YKR039W",664).
component("YKL217W",660).
component("YJR158W",629).
component("YJR095W",619).
component("YJR077C",617).
component("YJL219W",602).
component("YJL214W",600).
component("YJL134W",592).
component("YJL129C",589).
component("YIL134W",561).
component("YHR096C",528).
component("YHR094C",527).
component("YHR092C",526).
component("YHL036W",509).
component("YGR121C",480).
component("YGR065C",476).
component("YGR055W",473).
component("YGL186C",458).
component("YGL077C",453).
component("YGL008C",440).
component("YFL055W",429).
component("YFL011W",423).
component("YER060W-A",402).
component("YER060W",401).
component("YER056C",400).
component("YER053C",399).
component("YEL069C",390).
component("YEL063C",389).
component("YEL017C-A",381).
component("YDR536W",378).
component("YDR508C",375).
component("YDR503C",374).
component("YDR497C",372).
component("YDR345C",357).
component("YDR343C",356).
component("YDR342C",355).
component("YDR297W",352).
component("YDR046C",326) :- not remove_orf("YDR046C",326).
component("YDL245C",316).
component("YDL210W",312).
component("YCR032W",273).
component("YCR028C",272).
component("YCR024C-A",271).
...
component("YBR036C",220).
component("YBR021W",216).
...
catalyst(2132,23).
catalyst(2220,863).
catalyst(3620,359) :- not remove_reaction(3620,359).
catalyst(2110,435).
catalyst(2190,435).
catalyst(5550,624).
catalyst(5791,701).
...
catalyst(2300,183).
catalyst(3460,148).
catalyst(3600,657) :- not remove_reaction(3600,657).
catalyst(8000,671).
catalyst(3941,824).
catalyst(3942,824).
catalyst(6890,789).
...
catalyst(4560,385).
catalyst(2550,812).
catalyst(1890,658) :- not remove_reaction(1890,658).
catalyst(3630,658) :- not remove_reaction(3630,658).
catalyst(1890,414) :- not remove_reaction(1890,414).
catalyst(3630,414) :- not remove_reaction(3630,414).
catalyst(3740,337).
catalyst(8231,921).
catalyst(8232,921).
catalyst(8231,884).
...
catalyst(8061,915).
catalyst(8062,915).
catalyst(3590,446) :- not remove_reaction(3590,446).
catalyst(10910,446) :- not remove_reaction(10910,446).
catalyst(4570,482).
catalyst(8181,711).
catalyst(8182,711).
catalyst(8181,599).
...
catalyst(8282,327).
catalyst(3840,546).
catalyst(3610,318) :- not remove_reaction(3610,318).
catalyst(7921,847).
catalyst(7922,847).
catalyst(7841,391).
catalyst(7842,391).
...
catalyst(1210,842).
catalyst(1160,836).
catalyst(801,822) :- not remove_reaction(801,822).
catalyst(802,822) :- not remove_reaction(802,822).
catalyst(811,822) :- not remove_reaction(811,822).
catalyst(812,822) :- not remove_reaction(812,822).
catalyst(831,822) :- not remove_reaction(831,822).
catalyst(832,822) :- not remove_reaction(832,822).
catalyst(901,822) :- not remove_reaction(901,822).
catalyst(902,822) :- not remove_reaction(902,822).
catalyst(1180,818).
catalyst(1210,818).
catalyst(700,815).
catalyst(1200,805).
...
catalyst(650,670).
catalyst(6560,665).
catalyst(681,664) :- not remove_reaction(681,664).
catalyst(682,664) :- not remove_reaction(682,664).
catalyst(771,664) :- not remove_reaction(771,664).
catalyst(772,664) :- not remove_reaction(772,664).
catalyst(781,664) :- not remove_reaction(781,664).
catalyst(782,664) :- not remove_reaction(782,664).
catalyst(791,664) :- not remove_reaction(791,664).
catalyst(792,664) :- not remove_reaction(792,664).
catalyst(801,664) :- not remove_reaction(801,664).
catalyst(802,664) :- not remove_reaction(802,664).
catalyst(811,664) :- not remove_reaction(811,664).
catalyst(812,664) :- not remove_reaction(812,664).
catalyst(831,664) :- not remove_reaction(831,664).
catalyst(832,664) :- not remove_reaction(832,664).
catalyst(841,664) :- not remove_reaction(841,664).
catalyst(842,664) :- not remove_reaction(842,664).
catalyst(851,664) :- not remove_reaction(851,664).
catalyst(852,664) :- not remove_reaction(852,664).
catalyst(881,664) :- not remove_reaction(881,664).
catalyst(882,664) :- not remove_reaction(882,664).
catalyst(901,664) :- not remove_reaction(901,664).
catalyst(902,664) :- not remove_reaction(902,664).
catalyst(911,664) :- not remove_reaction(911,664).
catalyst(912,664) :- not remove_reaction(912,664).
catalyst(921,664) :- not remove_reaction(921,664).
catalyst(922,664) :- not remove_reaction(922,664).
catalyst(931,664) :- not remove_reaction(931,664).
catalyst(932,664) :- not remove_reaction(932,664).
catalyst(1191,664) :- not remove_reaction(1191,664).
catalyst(1192,664) :- not remove_reaction(1192,664).
catalyst(390,660).
catalyst(1180,629).
catalyst(1210,629).
catalyst(1250,619).
...
catalyst(1210,355).
catalyst(6650,352).
catalyst(791,326) :- not remove_reaction(791,326).
catalyst(792,326) :- not remove_reaction(792,326).
catalyst(801,326) :- not remove_reaction(801,326).
catalyst(802,326) :- not remove_reaction(802,326).
catalyst(811,326) :- not remove_reaction(811,326).
catalyst(812,326) :- not remove_reaction(812,326).
catalyst(831,326) :- not remove_reaction(831,326).
catalyst(832,326) :- not remove_reaction(832,326).
catalyst(841,326) :- not remove_reaction(841,326).
catalyst(842,326) :- not remove_reaction(842,326).
catalyst(851,326) :- not remove_reaction(851,326).
catalyst(852,326) :- not remove_reaction(852,326).
catalyst(901,326) :- not remove_reaction(901,326).
catalyst(902,326) :- not remove_reaction(902,326).
catalyst(1180,316).
catalyst(1210,316).
catalyst(690,312).
catalyst(730,312).
...
catalyst(851,223) :- not remove_reaction(851,223).
catalyst(852,223) :- not remove_reaction(852,223).
...
modifiable_enzyme(658).
modifiable_enzyme(414).
modifiable_enzyme(446).
modifiable_enzyme(318).
modifiable_enzyme(822).
modifiable_enzyme(664).
modifiable_enzyme(326).
