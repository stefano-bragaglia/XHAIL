...
component("YNL280C",655).
component("YLR056W",562).
component("YGR060W",390).
component("YGL012W",362).
component("YKR009C",544).
component("YOL086C",680).
component("YMR303C",629).
component("YGL256W",384).
...
component("YIL094C",458).
component("U45_",107).
component("YML056C",606).
component("YLR432W",596).
component("YHR216W",450).
component("YAR075W",157).
component("YAR073W",156).
component("YDR127W",270).
component("YJR139C",518).
component("YML075C",608).
component("YLR450W",599).
component("YOL126C",686).
component("YKL085W",526).
component("YDL078C",232).
component("YNL037C",634).
component("YNL009W",632).
component("YLR174W",574).
component("YHR183W",443).
component("YGR256W",409).
component("YNL241C",648).
component("YOL059W",678).
component("YDL022W",225).
component("YCL018W",208).
component("YLR355C",591).
component("YIL074C",455).
component("YER081W",335).
component("YDL174C",249).
component("YML086C",610).
component("YIL155C",467).
component("YGR088W",393).
component("YDR256C",282).
component("YKL026C",524).
component("YIR037W",476).
component("YBR244W",196).
component("YJR078W",512).
component("U58_",117).
component("YJR025C",504).
component("U107_",24).
component("YHR007C",419).
component("YDR402C",296).
component("YGL055W",369).
component("YJR104C",514).
component("YHR008C",420).
component("YOR384W",722).
component("YOR381W",721).
component("YOL152W",688).
component("YLL051C",555).
component("YJL026W",478).
component("YIL066C",454).
component("YGR180C",399).
component("YER070W",332).
component("U37_",101).
component("U36_",100).
component("YDL168W",246).
component("YJR009C",501).
component("YJL052W",480).
component("YGR192C",401).
component("YBR006W",167).
component("YPL276W",750).
component("YPL275W",749).
component("YOR388C",723).
component("YOR374W",719).
component("YER073W",333).
component("YGL154C",376).
component("YBR115C",181).
component("U55_",116).
component("YER069W",330).
component("YOR323C",711).
component("YER178W",344).
component("YBR221C",194).
component("YIL125W",463).
component("U52_",113).
component("YBR166C",189).
component("YGL012W",363).
component("YKL182W",535).
component("YKL216W",543).
component("YDR044W",261).
component("YKR009C",545).
component("YIL160C",468).
component("YGL205W",381).
component("YMR118C",619).
component("YLR164W",572).
component("YLL041C",554).
component("YKL148C",530).
component("YKL141W",528).
component("YJL045W",479).
component("YDR178W",277).
component("YEL047C",315).
component("YDL171C",247).
component("YDL171C",248).
component("YOR375C",720).
component("YDL215C",253).
component("YAL062W",153).
component("U99_",148).
component("U100_",20).
component("YBR035C",173).
component("YKR080W",550).
component("YER023W",322).
component("YOR236W",709).
component("YGR204W",403).
component("YIR034C",475).
component("YLR142W",569).
component("U65_",123).
component("U63_",121).
component("U62_",120).
component("YHR068W",429).
component("YKL150W",531).
component("YIL043C",453).
component("YHR042W",424).
component("YPL171C",735).
component("YHR179W",442).
component("YMR145C",622).
component("YML120C",611).
component("YKL192C",538).
component("YDL085W",234).
component("YGR234W",405).
component("YFR030W",355).
component("YPL017C",725).
component("YFL018C",348).
component("YDR353W",292).
component("YPR167C",763).
component("YJR137C",517).
component("YNL052W",636).
component("YMR256C",628).
component("YLR395C",595).
component("YLR038C",560).
component("YIL111W",460).
component("YHR051W",428).
component("YGL191W",379).
component("YGL187C",378).
component("YDL067C",231).
component("Q0275",19).
component("Q0250",18).
component("YDR072C",266).
component("YPL266W",748).
component("YKR069W",549).
component("YOL096C",681).
component("U47_",109).
component("YER091C",340).
component("YJR073C",510).
component("YGR157W",397).
component("YDR120C",268).
component("YML008C",601).
component("YOR074C",693).
component("YDL033C",227).
component("YOL096C",682).
component("YLR172C",573).
component("YLR058C",563).
component("YDR019C",259).
component("YBR176W",190).
component("YDR408C",298).
component("YMR120C",620).
component("YLR028C",558).
component("YBL013W",158).
component("YJL130C",488).
component("YKL024C",523).
component("YPR074C",758).
component("YBR117C",182).
component("YMR108W",618).
component("YCL009C",207).
component("YNL071W",638).
component("YNR008W",660).
component("YIL160C",469).
component("YNR019W",663).
...
component("YPL028W",726).
component("YLR299W",584).
component("YGL017W",364).
component("YCR005C",213).
component("YML126C",612).
component("YNL104C",641).
component("YDL182W",250).
component("YDL131W",238).
component("YDR307W",288).
component("YLR258W",581).
component("YFR015C",353).
component("YNL029C",633).
component("YIL085C",457).
component("YMR306W",630).
component("YLR342W",590).
component("YGR032W",387).
component("YLR209C",576).
component("U104_",21).
component("YDR354W",293) :- not remove_orf("YDR354W",293).
component("YFR047C",356).
component("YJR133W",516).
component("YLR209C",577).
component("YML022W",603).
component("YDR441C",301).
component("YHR128W",437).
component("YJL167W",493).
component("YJL167W",494).
component("YDR127W",271).
component("YHR190W",445).
component("YLR146C",570).
component("YHR068W",430).
component("YLR303W",586).
component("YGR012W",385).
component("YML082W",609).
component("YJR130C",515).
component("YDR035W",260).
component("YBR249C",197).
component("YLR180W",575).
component("YDR502C",304).
component("YOR274W",710).
component("YBR256C",199).
component("YHR137W",438).
component("YGL202W",380).
component("YLR027C",557).
component("YKL106W",527).
component("YOL140W",687).
component("YLR438W",598).
component("YGR019W",386).
component("YLR089C",565).
component("U64_",122).
component("U61_",119).
component("U51_",112).
component("YJR148W",519).
component("YHR208W",448).
component("YFL030W",349).
component("YOR184W",702).
component("YNR058W",668).
component("YIL116W",462).
component("YGL253W",383).
component("YFR053C",357).
component("YMR013C",616).
component("YMR205C",624).
component("YGR240C",406).
component("YOL016C",672).
component("YFR014C",352).
component("YLR240W",579).
component("YKL203C",540).
component("YJR066W",509).
component("YCR036W",220).
component("YCL040W",210).
component("U15_",53).
component("YPL188W",737).
component("YJR049C",506).
component("YEL041W",313).
component("U96_",146).
component("YKL001C",522).
component("YDR236C",280).
component("YHL032C",417).
component("YDR531W",308).
component("U83_",139).
component("U82_",138).
component("U81_",137).
component("YMR208W",625).
component("YPL203W",738).
component("YOR061W",692).
component("YKL166C",533).
component("YJL164C",492).
component("YIL035C",452).
component("YHR205W",447).
component("YHR102W",436).
component("YGL019W",365).
component("YHR025W",423).
component("YOR347C",716).
component("YAL038W",151).
component("YNR012W",661).
...
component("U17_",64).
component("U76_",132).
component("YER170W",343).
component("YDR226W",278).
component("YKL067W",525).
component("YOL055C",675).
component("YDR454C",302).
component("YJR057W",507).
component("YOL061W",679).
component("YKL181W",534).
component("YHL011C",416).
component("YER099C",341).
component("YBL068W",165).
component("YOR143C",698).
component("YNL256W",651).
component("YLR328W",588).
component("YBR018C",169).
component("YGR202C",402).
component("YLR328W",589).
component("U80_",136).
component("U94_",145).
component("YJR010W",502).
component("YBR029C",172).
component("YCL050C",211).
component("YGL130W",374).
component("YDR530C",307).
component("YPR190C",766).
component("YPR187W",765).
component("YPR110C",760).
component("YPR010C",753).
component("YOR341W",715).
component("YOR340C",714).
component("YOR224C",708).
component("YOR210W",706).
component("YOR207C",704).
component("YOR151C",699).
component("YOR116C",695).
component("YOL005C",670).
component("YNR003C",659).
component("YNL248C",650).
component("YNL151C",645).
component("YNL113W",642).
component("YKL144C",529).
component("YJR063W",508).
component("YJL148W",491).
component("YJL140W",490).
component("YIL021W",451).
component("YHR143W-A",439).
component("YGL070C",372).
component("YFL036W",350).
...
component("YPR175W",764).
component("YPL167C",734).
component("YOR330C",712).
component("YOL115W",685).
component("YNL299W",657).
component("YNL262W",653).
component("YNL102W",640).
component("YJR043C",505).
component("YJR006W",500).
component("YJL090C",483).
component("YIL139C",465).
component("YEL055C",316).
...
component("YPR113W",761).
component("YBR243C",195).
component("YPL148C",732).
component("YER026C",323).
component("YGR286C",413).
component("YHR189W",444).
component("YDR058C",265).
component("YDL086W",235).
component("YOL011W",671).
component("YMR008C",614).
component("YMR006C",613).
component("U105_",22).
component("YBL015W",159).
component("YJL068C",481).
component("YOR040W",691).
component("U77_",133).
component("YLR377C",593).
component("YPL179W",736).
component("YNR032W",664).
component("YML057W",607).
component("YML016C",602).
component("YLR433C",597).
component("YGR123C",395).
component("YER133W",342).
component("YER089C",338).
...
component("YPR073C",756).
component("YHR215W",449).
component("YDL024C",226).
component("YBR093C",179).
component("YBR092C",178).
component("YAR071W",155).
component("YHR046C",427).
component("U9_",149).
component("YPL228W",741).
component("YMR180C",623).
component("YDL236W",255).
component("YPR073C",757).
component("YOR208W",705).
component("YNL053W",637).
component("YMR036C",617).
component("YIR026C",474).
component("YIL113W",461).
component("YFR028C",354).
component("YER075C",334).
...
component("U25_",92).
component("U24_",91).
component("YHR044C",426).
component("YHR043C",425).
component("YOR360C",718).
component("YKR031C",546).
component("YPL206C",739).
component("YGL027C",367).
component("YLR286C",583).
component("YJR153W",520).
component("YJL221C",499).
component("YJL216C",497).
component("YIL172C",472).
component("YGR292W",415).
component("YGR287C",414).
component("YBR299W",206).
component("YBR184W",191).
component("YIR019C",473).
component("YIL099W",459).
component("YDL037C",228).
component("YOR190W",703).
component("YLR300W",585).
component("YGR282C",412).
component("YDR261C",283).
component("YDR400W",295).
component("YML035C",604).
component("YJL070C",482).
component("YBR284W",203).
component("U106_",23).
component("YER043C",324).
component("YNL045W",635).
component("YGL037C",368).
component("YDR242W",281).
component("U53_",114).
component("YPR062W",755).
component("YMR120C",621).
component("YLR028C",559).
component("YHR144C",440).
component("YGR267C",411).
component("YBL033C",160).
component("YNL141W",643).
component("YLR245C",580).
component("YML035C",605).
component("YBR084W",176).
component("YJL126W",486).
component("U44_",106).
...
component("YHR201C",446).
component("YBR111C",180).
component("YBR252W",198).
component("YER005W",321).
component("YBL099W",166).
component("YLR231C",578).
component("YDR538W",310).
component("YLR134W",567).
component("YLR044C",561).
component("YGR087C",392).
component("YDR380W",294).
component("YDL080C",233).
component("U98_",147).
component("YMR250W",627).
component("YOR128C",696).
component("YEL021W",312).
component("YNR043W",666).
component("U93_",144).
component("U54_",115).
component("YKL211C",541) :- not remove_orf("YKL211C",541).
component("YKR097W",552).
component("YNL169C",646).
component("YNL256W",652).
component("YDR294C",285).
component("YEL046C",314).
component("YNR033W",665).
component("YKL211C",542) :- not remove_orf("YKL211C",542).
component("YER090W",542) :- not remove_orf("YER090W",542).
component("YER090W",339) :- not remove_orf("YER090W",339).
component("YDR127W",273).
component("YPL281C",751).
component("YOR393W",724).
component("YMR323W",631).
component("YHR174W",441).
component("YGR254W",408).
...
component("YNL316C",658).
component("YKL182W",536).
component("YPL212C",740).
component("YNL292W",656).
component("YGL063W",371).
component("YFL001W",346).
component("YPR002W",752).
component("YJR016C",503).
component("YCR053W",222).
component("YDR127W",274).
component("YGL148W",375).
component("YIL168W",471).
component("YIL167W",470).
component("YCL064C",212).
component("YER086W",336).
component("YLR359W",592).
component("YAL012W",150).
component("YML004C",600).
component("YFR055W",358).
component("YJL005W",477).
component("YJL121C",485).
component("YBR019C",170).
component("YDR050C",264).
component("YDR007W",257) :- not remove_orf("YDR007W",257).
component("YOR095C",694).
component("YER003C",320).
component("YBR196C",192).
component("YGL001C",360).
component("YPL117C",730).
component("U14_",45).
component("YOL056W",676).
component("YKL152C",532).
component("YDL021W",224).
component("YEL058W",317).
component("YPR060C",754).
component("YHR072W",431).
component("YPL097W",728).
component("YGR185C",400).
component("YGR264C",410).
component("YGR171C",398).
component("YPL104W",729).
component("YLL018C",553).
component("YPR081C",759).
component("YBR121C",183).
component("YHR020W",422).
component("YER087W",337).
component("YNL247W",649).
component("YOR168W",700).
component("YOL097C",683).
component("YDR268W",284).
component("YCR024C",216).
component("YHR019C",421).
component("YKL194C",539).
component("YIL078W",456).
component("YPL160W",733).
component("YLR382C",594).
component("YNL073W",639).
component("YOR335C",713).
component("YLR153C",571).
component("YAL054C",152).
component("YGR244C",407).
component("YIL145C",466).
component("YJL101C",484).
component("YOL049W",674).
component("YAR015W",154).
component("YER183C",345).
component("U90_",143).
component("YNR057C",667).
component("YDL141W",241).
component("YGL234W",382).
component("YDL141W",242).
component("YJR103W",513).
component("YBL039C",162).
component("YGR204W",404).
component("YBR084W",177).
component("YNL220W",647).
component("YOL058W",677).
component("YDL141W",243).
component("YHR074W",432).
component("YMR217W",626).
component("YGL062W",370).
component("YBR218C",193).
component("YPL231W",745).
component("YNR016C",662).
component("YKL182W",537).
component("YGR037C",388).
component("YPR138C",762).
component("YPL265W",747).
component("YPL134C",731).
component("YPL036W",727).
component("YOR348C",717).
component("YOR222W",707).
component("YOR171C",701).
component("YOR130C",697).
component("YOR011W",690).
component("YOL156W",689).
component("YOL103W",684).
component("YOL020W",673) :- not remove_orf("YOL020W",673).
component("YNR072W",669).
component("YNL270C",654).
component("YNL142W",644).
component("YMR011W",615).
component("YLR260W",582).
component("YLR138W",568).
component("YLR100C",566).
component("YLR081W",564).
component("YLL061W",556).
component("YKR093W",551).
component("YKR053C",548).
component("YKR039W",547) :- not remove_orf("YKR039W",547).
component("YJR158W",521).
component("YJR077C",511).
component("YJL219W",498).
component("YJL214W",496).
component("YJL134W",489).
component("YJL129C",487).
component("YIL134W",464).
component("YHR096C",435).
component("YHR094C",434).
component("YHR092C",433).
component("YHL036W",418).
component("YGR121C",394).
component("YGR065C",391).
component("YGR055W",389).
component("YGL186C",377).
component("YGL077C",373).
component("YGL008C",361).
component("YFL055W",351).
component("YFL011W",347).
component("YER060W-A",328).
component("YER060W",327).
component("YER056C",326).
component("YER053C",325).
component("YEL069C",319).
component("YEL063C",318).
component("YEL017C-A",311).
component("YDR536W",309).
component("YDR508C",306).
component("YDR503C",305).
component("YDR497C",303).
...
catalyst(1890,339) :- not remove_reaction(1890,339).
catalyst(3630,339) :- not remove_reaction(3630,339).
catalyst(3740,273).
catalyst(8231,751).
catalyst(8232,751).
catalyst(8231,724).
...
catalyst(640,551).
catalyst(6560,548).
catalyst(771,547) :- not remove_reaction(771,547).
catalyst(772,547) :- not remove_reaction(772,547).
catalyst(781,547) :- not remove_reaction(781,547).
catalyst(782,547) :- not remove_reaction(782,547).
catalyst(801,547) :- not remove_reaction(801,547).
catalyst(802,547) :- not remove_reaction(802,547).
catalyst(811,547) :- not remove_reaction(811,547).
catalyst(812,547) :- not remove_reaction(812,547).
catalyst(831,547) :- not remove_reaction(831,547).
catalyst(832,547) :- not remove_reaction(832,547).
catalyst(841,547) :- not remove_reaction(841,547).
catalyst(842,547) :- not remove_reaction(842,547).
catalyst(851,547) :- not remove_reaction(851,547).
catalyst(852,547) :- not remove_reaction(852,547).
catalyst(881,547) :- not remove_reaction(881,547).
catalyst(882,547) :- not remove_reaction(882,547).
catalyst(901,547) :- not remove_reaction(901,547).
catalyst(902,547) :- not remove_reaction(902,547).
catalyst(921,547) :- not remove_reaction(921,547).
catalyst(922,547) :- not remove_reaction(922,547).
catalyst(931,547) :- not remove_reaction(931,547).
catalyst(932,547) :- not remove_reaction(932,547).
catalyst(1191,547) :- not remove_reaction(1191,547).
catalyst(1192,547) :- not remove_reaction(1192,547).
catalyst(1180,521).
catalyst(1210,521).
catalyst(1581,511).
catalyst(1582,511).
