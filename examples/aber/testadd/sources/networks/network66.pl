...
component("YLR056W",357).
component("YKR009C",343).
component("YOL086C",433).
component("YMR303C",395).
component("YGL256W",249).
component("YDL168W",160).
component("YBR145W",124).
component("YPL231W",474).
component("U46_",72).
component("YBR149W",125).
component("YGL001C",229).
component("YIL094C",292).
component("U45_",71).
component("YML056C",385).
component("YLR432W",382).
component("YHR216W",287).
component("YAR075W",103).
component("YAR073W",102).
component("YDR127W",172).
component("YOL126C",437).
component("YKL085W",333).
component("YDL078C",153).
component("YNL037C",400).
component("YNL009W",398).
component("YLR174W",365).
component("YCL018W",138).
component("YLR355C",379).
component("YDL174C",162).
component("YML086C",386).
component("YGR088W",256).
component("YDR256C",182).
component("YJR078W",324).
component("YJR025C",317).
component("U107_",23).
component("YJR104C",326).
component("YHR008C",272).
component("YJL026W",303).
component("YIL066C",290).
component("YGR180C",259).
component("YER070W",212).
component("U36_",66).
component("YDL168W",161).
component("YBR006W",111).
component("YPL276W",482).
component("YPL275W",481).
component("YOR388C",460).
component("U55_",78).
component("YER069W",211).
component("YOR323C",453).
component("YER178W",217).
component("YBR221C",130).
component("YIL125W",295).
component("U52_",76).
component("YBR166C",127).
component("YGL012W",232).
component("YKL216W",342).
component("YKR009C",344).
component("YIL160C",298).
component("YGL205W",246).
component("U99_",97).
component("U100_",20).
component("YKR080W",349).
component("YER023W",205).
component("YGR204W",261).
component("YLR142W",362).
component("U65_",82).
component("U62_",81).
component("YHR068W",278).
component("YKL150W",336).
component("YIL043C",289).
component("YPL171C",470).
component("YHR179W",285).
component("YGR234W",263).
component("YPL017C",462).
component("YFL018C",220).
component("YDR353W",186).
component("YPR167C",494).
component("YNL052W",401).
component("YMR256C",394).
component("YLR395C",381).
component("YLR038C",355).
component("YIL111W",293).
component("YHR051W",277).
component("YGL191W",244).
component("YGL187C",243).
component("YDL067C",152).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",480).
component("YKR069W",348).
component("U47_",73).
component("YJR073C",322).
component("YDL033C",151).
component("YLR172C",364).
component("YLR058C",358).
component("YDR019C",167).
component("YBR176W",128).
component("YDR408C",191).
component("YMR120C",391).
component("YLR028C",353).
component("YBL013W",104).
component("YJL130C",309).
component("YKL024C",331).
component("YPR074C",490).
component("YBR117C",123).
component("YCL009C",137).
component("YNL071W",403).
component("YIL160C",299).
component("U48_",74).
component("YPL231W",475).
component("YPL231W",476).
component("YPL028W",463).
component("YLR299W",373).
component("YGL017W",233).
component("YML126C",387).
component("YNL104C",405).
component("YDL182W",163).
component("YDL131W",157).
component("YLR258W",370).
component("YFR015C",225).
component("YNL029C",399).
component("YIL085C",291).
component("YMR306W",396).
component("YLR342W",378).
component("YGR032W",251).
component("YLR209C",366).
component("U104_",21).
component("YDR354W",187) :- not remove_orf("YDR354W",187).
component("YFR047C",227).
component("YLR209C",367).
component("YML022W",383).
component("YDR441C",193).
component("YJL167W",313).
component("YDR127W",173).
component("YHR068W",279).
component("YLR303W",375).
component("YGR012W",250).
component("YJR130C",327).
component("YDR035W",168).
component("YBR249C",131).
component("YOR274W",452).
component("YHR137W",281).
component("YGL202W",245).
component("YLR027C",352).
component("YKL106W",334).
component("YOL140W",438).
component("YLR089C",359).
component("U61_",80).
component("YJR148W",328).
component("YFL030W",221).
component("YNR058W",424).
component("YGL253W",248).
component("YFR053C",228).
component("YMR205C",393).
component("YGR240C",264).
component("YOL016C",427).
component("YFR014C",224).
component("YCR036W",147).
component("YCL040W",140).
component("YPL188W",471).
component("YJR049C",319).
component("YEL041W",200).
component("U96_",95).
component("YKL001C",330).
component("YDR236C",180).
component("YHL032C",270).
component("U83_",92).
component("YOR347C",458).
component("YAL038W",100).
component("YNR012W",420).
component("YDR127W",174).
component("YDR147W",177).
component("YCR012W",142).
component("U76_",90).
component("YER170W",216).
component("YDR226W",179).
component("YKL067W",332).
component("YOL055C",430).
component("YDR454C",194).
component("YJR057W",320).
component("YOL061W",432).
component("YKL181W",338).
component("YHL011C",269).
component("YER099C",215).
component("YBL068W",109).
component("YOR143C",443).
component("YNL256W",413).
component("YBR018C",113).
component("YLR328W",377).
component("U94_",94).
component("YBR029C",115).
component("YGL130W",240).
component("YPR190C",497).
component("YPR187W",496).
component("YPR110C",491).
component("YPR010C",485).
component("YOR341W",457).
component("YOR340C",456).
component("YOR224C",451).
component("YOR210W",450).
component("YOR207C",448).
component("YOR151C",444).
component("YOR116C",441).
component("YOL005C",425).
component("YNR003C",419).
component("YNL248C",412).
component("YNL151C",409).
component("YNL113W",406).
component("YKL144C",335).
component("YJR063W",321).
component("YJL148W",312).
component("YJL140W",311).
component("YIL021W",288).
component("YHR143W-A",282).
component("YGL070C",238).
component("YFL036W",222).
component("YDR404C",190).
component("YDR156W",178).
component("YDR045C",169).
component("YDL150W",159).
component("YDL140C",158).
component("YBR154C",126).
component("YPR175W",495).
component("YPL167C",469).
component("YOR330C",454).
component("YOL115W",436).
component("YNL299W",417).
component("YNL262W",414).
component("YNL102W",404).
component("YJR043C",318).
component("YJR006W",315).
component("YJL090C",305).
component("YIL139C",296).
component("YEL055C",202).
component("YDR419W",192).
component("YDR121W",171).
component("YDL102W",156).
component("YCR014C",143).
component("YBR278W",134).
component("YBL035C",107).
component("YPR113W",492).
component("YPL148C",468).
component("YGR286C",268).
component("YOL011W",426).
component("YMR008C",389).
component("YMR006C",388).
component("U105_",22).
component("YBL015W",105).
component("U77_",91).
component("YLR377C",380).
component("YPR073C",488).
component("YHR215W",286).
component("YDL024C",150).
component("YBR093C",121).
component("YBR092C",120).
component("YHR046C",276).
component("U9_",98).
component("YDL236W",165).
component("YPR073C",489).
component("YOR208W",449).
component("YNL053W",402).
component("YMR036C",390).
component("YIR026C",302).
component("YIL113W",294).
component("YFR028C",226).
component("YER075C",213).
component("YDL230W",164).
...
component("U26_",61).
component("U24_",60).
component("YHR044C",275).
component("YHR043C",274).
component("YOR360C",459).
component("YKR031C",345).
component("YPL206C",472).
component("YGL027C",235).
component("YLR286C",372).
component("YJR153W",329).
component("YOR190W",447).
component("YLR300W",374).
component("YGR282C",267).
component("YDR261C",183).
component("YDR400W",189).
component("YML035C",384).
component("YJL070C",304).
component("YBR284W",135).
component("YER043C",206).
component("YDR242W",181).
component("U53_",77).
component("YPR062W",487).
component("YMR120C",392).
component("YLR028C",354).
component("YHR144C",283).
component("YBL033C",106).
component("YNL141W",407).
component("YLR245C",369).
component("YBR084W",118).
component("YJL126W",307).
component("YDL100C",155).
component("U40_",69).
component("U39_",67).
component("YBR011C",112).
component("YBR111C",122).
component("YBR252W",132).
component("YER005W",204).
component("YBL099W",110).
component("YLR231C",368).
component("YLR134W",361).
component("YLR044C",356).
component("YGR087C",255).
component("YDR380W",188).
component("YDL080C",154).
component("U98_",96).
component("YOR128C",442).
component("YKL211C",340) :- not remove_orf("YKL211C",340).
component("YKR097W",350).
component("YNL169C",410).
component("YEL046C",201).
component("YNR033W",422).
component("YKL211C",341) :- not remove_orf("YKL211C",341).
component("YER090W",341) :- not remove_orf("YER090W",341).
component("YER090W",214) :- not remove_orf("YER090W",214).
component("YDR127W",175).
component("YPL281C",483).
component("YOR393W",461).
component("YMR323W",397).
component("YHR174W",284).
component("YGR254W",265).
component("YPL262W",478).
component("YGL026C",234) :- not remove_orf("YGL026C",234).
component("YLR304C",376).
component("YJL200C",314).
component("YNL316C",418).
component("YPL212C",473).
component("YNL292W",416).
component("YGL063W",237).
component("YFL001W",219).
component("YPR002W",484).
component("YJR016C",316).
component("YCR053W",148).
component("YDR127W",176).
component("YGL148W",241).
component("YIL168W",301).
component("YIL167W",300).
component("YCL064C",141).
component("YAL012W",99).
component("YBR019C",114).
component("YDR007W",166) :- not remove_orf("YDR007W",166).
component("YOR095C",440).
component("YGL001C",230).
component("YPL117C",467).
component("U14_",32).
component("YOL056W",431).
component("YKL152C",337).
component("YDL021W",149).
component("YPR060C",486).
component("YPL097W",465).
component("YGR185C",260).
component("YGR264C",266).
component("YGR171C",258).
component("YPL104W",466).
component("YLL018C",351).
component("YNL247W",411).
component("YOR168W",445).
component("YOL097C",434).
component("YDR268W",184).
component("YCR024C",144).
component("YHR019C",273).
component("YOR335C",455).
component("YLR153C",363).
component("YAL054C",101).
component("YIL145C",297).
component("YJL101C",306).
component("YOL049W",429).
component("YER183C",218).
component("U90_",93).
component("YNR057C",423).
component("YGL234W",247).
component("YJR103W",325).
component("YBL039C",108).
component("YGR204W",262).
component("YBR084W",119).
component("YHR074W",280).
component("YGL062W",236).
component("YBR218C",129).
component("YPL231W",477).
component("YNR016C",421).
component("YKL182W",339).
component("YGR037C",252).
component("YPR138C",493).
component("YPL265W",479).
component("YPL036W",464).
component("YOR171C",446).
component("YOR011W",439).
component("YOL103W",435).
component("YOL020W",428) :- not remove_orf("YOL020W",428).
component("YNL270C",415).
component("YNL142W",408).
component("YLR260W",371).
component("YLR100C",360).
component("YKR053C",347).
component("YKR039W",346) :- not remove_orf("YKR039W",346).
component("YJR077C",323).
component("YJL134W",310).
component("YJL129C",308).
component("YHL036W",271).
component("YGR121C",257).
component("YGR065C",254).
component("YGR055W",253).
component("YGL186C",242).
component("YGL077C",239).
component("YGL008C",231).
component("YFL055W",223).
component("YER060W-A",210).
component("YER060W",209).
component("YER056C",208).
component("YER053C",207).
component("YEL063C",203).
component("YEL017C-A",199).
component("YDR536W",198).
component("YDR508C",197).
component("YDR503C",196).
component("YDR497C",195).
component("YDR297W",185).
component("YDR046C",170) :- not remove_orf("YDR046C",170).
component("YCR032W",146).
component("YCR024C-A",145).
component("YCL025C",139).
component("YBR298C",136).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,187) :- not remove_reaction(3620,187).
catalyst(2190,227).
catalyst(5791,367).
catalyst(5792,367).
catalyst(5801,367).
...
catalyst(6111,442).
catalyst(6112,442).
catalyst(3600,340) :- not remove_reaction(3600,340).
catalyst(8000,350).
catalyst(6890,410).
catalyst(4560,201).
catalyst(2550,422).
catalyst(3630,341) :- not remove_reaction(3630,341).
catalyst(3630,214) :- not remove_reaction(3630,214).
catalyst(3740,175).
catalyst(8231,483).
catalyst(8232,483).
catalyst(8231,461).
...
catalyst(8051,478).
catalyst(8052,478).
catalyst(3590,234) :- not remove_reaction(3590,234).
catalyst(10910,234) :- not remove_reaction(10910,234).
catalyst(8181,376).
catalyst(8182,376).
catalyst(8181,314).
catalyst(8182,314).
...
catalyst(7751,114).
catalyst(7752,114).
catalyst(3610,166) :- not remove_reaction(3610,166).
catalyst(7921,440).
catalyst(7922,440).
catalyst(6370,230).
catalyst(6461,467).
...
catalyst(901,428) :- not remove_reaction(901,428).
catalyst(902,428) :- not remove_reaction(902,428).
catalyst(931,415).
catalyst(932,415).
catalyst(371,408).
catalyst(372,408).
...
catalyst(6330,360).
catalyst(6560,347).
catalyst(771,346) :- not remove_reaction(771,346).
catalyst(772,346) :- not remove_reaction(772,346).
catalyst(781,346) :- not remove_reaction(781,346).
catalyst(782,346) :- not remove_reaction(782,346).
catalyst(801,346) :- not remove_reaction(801,346).
catalyst(802,346) :- not remove_reaction(802,346).
catalyst(811,346) :- not remove_reaction(811,346).
catalyst(812,346) :- not remove_reaction(812,346).
catalyst(831,346) :- not remove_reaction(831,346).
catalyst(832,346) :- not remove_reaction(832,346).
catalyst(841,346) :- not remove_reaction(841,346).
catalyst(842,346) :- not remove_reaction(842,346).
catalyst(851,346) :- not remove_reaction(851,346).
catalyst(852,346) :- not remove_reaction(852,346).
catalyst(881,346) :- not remove_reaction(881,346).
catalyst(882,346) :- not remove_reaction(882,346).
catalyst(901,346) :- not remove_reaction(901,346).
catalyst(902,346) :- not remove_reaction(902,346).
catalyst(931,346) :- not remove_reaction(931,346).
catalyst(932,346) :- not remove_reaction(932,346).
catalyst(1191,346) :- not remove_reaction(1191,346).
catalyst(1192,346) :- not remove_reaction(1192,346).
catalyst(1581,323).
catalyst(1582,323).
catalyst(6560,310).
catalyst(361,308).
...
catalyst(851,170) :- not remove_reaction(851,170).
catalyst(852,170) :- not remove_reaction(852,170).
...
catalyst(851,116) :- not remove_reaction(851,116).
catalyst(852,116) :- not remove_reaction(852,116).
catalyst(901,116) :- not remove_reaction(901,116).
catalyst(902,116) :- not remove_reaction(902,116).
catalyst(2920,89).
catalyst(2920,88).
catalyst(2920,87).
catalyst(2920,86).
