...
component("YNL280C",603).
component("YLR056W",515).
component("YGL012W",328).
component("YKR009C",497).
component("YOL086C",627).
component("YMR303C",577).
component("YGL256W",349).
component("YDL168W",221).
component("YBR145W",167).
component("YPL231W",686).
component("YBR265W",182).
component("U46_",98).
component("YBR149W",168).
component("YBR149W",169).
component("YGL001C",325).
component("YIL094C",417).
component("U45_",97).
component("YML056C",556).
component("YLR432W",548).
component("YHR216W",411).
component("YAR075W",143).
component("YAR073W",142).
component("YDR127W",242).
component("YML075C",557).
component("YLR450W",550).
component("YOL126C",633).
component("YKL085W",483).
component("YDL078C",209).
component("YNL037C",582).
component("YNL009W",580).
component("YLR174W",527).
component("YHR183W",404).
component("YGR256W",370).
component("YNL241C",596).
component("YOL059W",625).
component("YDL022W",203).
component("YCL018W",190).
component("YLR355C",543).
component("YDL174C",225).
component("YML086C",559).
component("YIL155C",426).
component("YGR088W",357).
component("YDR256C",254).
component("YKL026C",481).
component("YIR037W",435).
component("YBR244W",178).
component("YJR078W",470).
component("U58_",106).
component("YJR025C",463).
component("U107_",24).
component("YHR007C",380).
component("YGL055W",334).
component("YJR104C",472).
component("YHR008C",381).
component("YOR384W",668).
component("YOR381W",667).
component("YOL152W",635).
component("YLL051C",508).
component("YJL026W",437).
component("YIL066C",415).
component("YGR180C",361).
component("YER070W",301).
component("U37_",91).
component("U36_",90).
component("YDL168W",222).
component("YJR009C",460).
component("YJL052W",439).
component("YGR192C",363).
component("YBR006W",152).
component("YPL276W",694).
component("YPL275W",693).
component("YOR388C",669).
component("YOR374W",665).
component("YER073W",302).
component("YGL154C",341).
component("U55_",105).
component("YER069W",299).
component("YOR323C",658).
component("YER178W",310).
component("YBR221C",176).
component("YIL125W",422).
component("U52_",103).
component("YBR166C",171).
component("YGL012W",329).
component("YKL216W",496).
component("YDR044W",235).
component("YKR009C",498).
component("YIL160C",427).
component("YGL205W",346).
component("YMR118C",568).
component("YLR164W",525).
component("YLL041C",507).
component("YKL148C",487).
component("YKL141W",485).
component("YJL045W",438).
component("YDR178W",249).
component("YEL047C",285).
component("YDL171C",223).
component("YDL171C",224).
component("YOR375C",666).
component("YDL215C",227).
component("YAL062W",140).
component("U99_",135).
component("U100_",20).
component("YBR035C",158).
component("YKR080W",503).
component("YER023W",292).
component("YOR236W",656).
component("YGR204W",364).
component("YIR034C",434).
component("YLR142W",522).
component("U65_",112).
component("U63_",110).
component("U62_",109).
component("YHR068W",390).
component("YKL150W",488).
component("YIL043C",414).
component("YHR042W",385).
component("YPL171C",681).
component("YHR179W",403).
component("YMR145C",571).
component("YML120C",560).
component("YKL192C",493).
component("YDL085W",211).
component("YGR234W",366).
component("YFR030W",321).
component("YPL017C",671).
component("YFL018C",314).
component("YDR353W",264).
component("YPR167C",706).
component("YJR137C",475).
component("YNL052W",584).
component("YMR256C",576).
component("YLR395C",547).
component("YLR038C",513).
component("YIL111W",419).
component("YHR051W",389).
component("YGL191W",344).
component("YGL187C",343).
component("YDL067C",208).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",692).
component("YKR069W",502).
component("YOL096C",628).
component("U47_",99).
component("YER091C",307).
component("YJR073C",468).
component("YDR120C",240).
component("YML008C",552).
component("YOR074C",640).
component("YDL033C",205).
component("YOL096C",629).
component("YLR172C",526).
component("YLR058C",516).
component("YDR019C",233).
component("YBR176W",172).
component("YDR408C",269).
component("YMR120C",569).
component("YLR028C",511).
component("YBL013W",144).
component("YJL130C",447).
component("YKL024C",480).
component("YPR074C",702).
component("YBR117C",166).
component("YMR108W",567).
component("YCL009C",189).
component("YNL071W",586).
component("YNR008W",608).
component("YIL160C",428).
component("YNR019W",611).
component("YCR048W",200).
component("U48_",100).
component("YDR232W",251).
component("YPL231W",687).
component("YDL052C",207).
component("U8_",129).
component("YPL231W",688).
component("YPL028W",672).
component("YLR299W",536).
component("YGL017W",330).
component("YML126C",561).
component("YNL104C",589).
component("YDL182W",226).
component("YDL131W",215).
component("YDR307W",260).
component("YLR258W",533).
component("YFR015C",319).
component("YNL029C",581).
component("YIL085C",416).
component("YMR306W",578).
component("YLR342W",542).
component("YGR032W",352).
component("YLR209C",529).
component("U104_",21).
component("YDR354W",265) :- not remove_orf("YDR354W",265).
component("YFR047C",322).
component("YJR133W",474).
component("YLR209C",530).
component("YML022W",553).
component("YDR441C",271).
component("YHR128W",398).
component("YJL167W",452).
component("YJL167W",453).
component("YDR127W",243).
component("YHR190W",406).
component("YLR146C",523).
component("YHR068W",391).
component("YLR303W",538).
component("YGR012W",350).
component("YML082W",558).
component("YJR130C",473).
component("YDR035W",234).
component("YBR249C",179).
component("YLR180W",528).
component("YDR502C",274).
component("YOR274W",657).
component("YBR256C",181).
component("YHR137W",399).
component("YGL202W",345).
component("YLR027C",510).
component("YKL106W",484).
component("YOL140W",634).
component("YLR438W",549).
component("YGR019W",351).
component("YLR089C",518).
component("U64_",111).
component("U61_",108).
component("U51_",102).
component("YJR148W",476).
component("YHR208W",409).
component("YFL030W",315).
component("YOR184W",649).
component("YNR058W",615).
component("YIL116W",421).
component("YGL253W",348).
component("YFR053C",323).
component("YMR013C",565).
component("YMR205C",572).
component("YGR240C",367).
component("YOL016C",619).
component("YFR014C",318).
component("YCR036W",199).
component("YCL040W",192).
component("U15_",47).
component("YPL188W",682).
component("YJR049C",465).
component("YEL041W",283).
component("U96_",133).
component("YKL001C",479).
component("YDR236C",252).
component("YHL032C",378).
component("YDR531W",278).
component("U83_",128).
component("U82_",127).
component("U81_",126).
component("YMR208W",573).
component("YPL203W",683).
component("YOR061W",639).
component("YKL166C",490).
component("YJL164C",451).
component("YIL035C",413).
component("YHR205W",408).
component("YHR102W",397).
component("YGL019W",331).
component("YHR025W",384).
component("YOR347C",663).
component("YAL038W",138).
component("YNR012W",609).
component("YDR009W",232).
component("YDR127W",244).
component("YDR147W",247).
component("YDR300C",259).
component("YCR012W",194).
component("YER069W",300).
component("U18_",64).
component("U76_",121).
component("YER170W",309).
component("YDR226W",250).
component("YKL067W",482).
component("YOL055C",622).
component("YDR454C",272).
component("YJR057W",466).
component("YOL061W",626).
component("YKL181W",491).
component("YHL011C",377).
component("YER099C",308).
component("YBL068W",150).
component("YOR143C",645).
component("YNL256W",599).
component("YLR328W",540).
component("YBR018C",154).
component("YLR328W",541).
component("U80_",125).
component("U94_",132).
component("YJR010W",461).
component("YBR029C",157).
component("YGL130W",339).
component("YDR530C",277).
component("YPR190C",709).
component("YPR187W",708).
component("YPR110C",703).
component("YPR010C",697).
component("YOR341W",662).
component("YOR340C",661).
component("YOR224C",655).
component("YOR210W",653).
component("YOR207C",651).
component("YOR151C",646).
component("YOR116C",642).
component("YOL005C",617).
component("YNR003C",607).
component("YNL248C",598).
component("YNL151C",593).
component("YNL113W",590).
component("YKL144C",486).
component("YJR063W",467).
component("YJL148W",450).
component("YJL140W",449).
component("YIL021W",412).
component("YHR143W-A",400).
component("YGL070C",337).
component("YFL036W",316).
component("YDR404C",268).
component("YDR156W",248).
component("YDR045C",236).
component("YDL150W",220).
component("YDL140C",216).
component("YBR154C",170).
component("YPR175W",707).
component("YPL167C",680).
component("YOR330C",659).
component("YOL115W",632).
component("YNL299W",605).
component("YNL262W",601).
component("YNL102W",588).
component("YJR043C",464).
component("YJR006W",459).
component("YJL090C",442).
component("YIL139C",424).
component("YEL055C",286).
component("YDR419W",270).
component("YDR121W",241).
component("YDL102W",214).
component("YCR014C",195).
component("YBR278W",184).
component("YBL035C",147).
component("YPR113W",704).
component("YBR243C",177).
component("YPL148C",678).
component("YER026C",293).
component("YGR286C",374).
component("YHR189W",405).
component("YDR058C",239).
component("YDL086W",212).
component("YOL011W",618).
component("YMR008C",563).
component("YMR006C",562).
component("U105_",22).
component("YBL015W",145).
component("YJL068C",440).
component("YOR040W",638).
component("U77_",122).
component("YLR377C",545).
component("YPR073C",700).
component("YHR215W",410).
component("YDL024C",204).
component("YBR093C",164).
component("YBR092C",163).
component("YHR046C",388).
component("U9_",136).
component("YDL236W",229).
component("YPR073C",701).
component("YOR208W",652).
component("YNL053W",585).
component("YMR036C",566).
component("YIR026C",433).
component("YIL113W",420).
component("YFR028C",320).
component("YER075C",303).
...
component("U25_",82).
component("U24_",81).
component("YHR044C",387).
component("YHR043C",386).
component("YOR360C",664).
component("YKR031C",499).
component("YPL206C",684).
component("YGL027C",333).
component("YLR286C",535).
component("YJR153W",477).
component("YJL221C",458).
component("YJL216C",456).
component("YIL172C",431).
component("YGR292W",376).
component("YGR287C",375).
component("YBR299W",188).
component("YBR184W",173).
component("YIR019C",432).
component("YIL099W",418).
component("YDL037C",206).
component("YOR190W",650).
component("YLR300W",537).
component("YGR282C",373).
component("YDR261C",255).
component("YDR400W",267).
component("YML035C",554).
component("YJL070C",441).
component("YBR284W",185).
component("U106_",23).
component("YER043C",294).
component("YNL045W",583).
component("YDR242W",253).
component("U53_",104).
component("YPR062W",699).
component("YMR120C",570).
component("YLR028C",512).
component("YHR144C",401).
component("YGR267C",372).
component("YBL033C",146).
component("YNL141W",591).
component("YLR245C",532).
component("YML035C",555).
component("YBR084W",161).
component("YJL126W",445).
component("U44_",96).
component("YDL100C",213).
component("U40_",94).
component("U39_",92).
component("YBR011C",153).
component("YHR201C",407).
component("YBR111C",165).
component("YBR252W",180).
component("YER005W",291).
component("YBL099W",151).
component("YLR231C",531).
component("YDR538W",280).
component("YLR134W",520).
component("YLR044C",514).
component("YGR087C",356).
component("YDR380W",266).
component("YDL080C",210).
component("U98_",134).
component("YMR250W",575).
component("YOR128C",643).
component("YEL021W",282).
component("YNR043W",613).
component("U93_",131).
component("YKL211C",494) :- not remove_orf("YKL211C",494).
component("YKR097W",505).
component("YNL169C",594).
component("YNL256W",600).
component("YDR294C",257).
component("YEL046C",284).
component("YNR033W",612).
component("YKL211C",495) :- not remove_orf("YKL211C",495).
component("YER090W",495) :- not remove_orf("YER090W",495).
component("YER090W",306) :- not remove_orf("YER090W",306).
component("YDR127W",245).
component("YPL281C",695).
component("YOR393W",670).
component("YMR323W",579).
component("YHR174W",402).
component("YGR254W",369).
component("YPL262W",690).
component("YGL026C",332) :- not remove_orf("YGL026C",332).
component("YGR155W",359).
component("YLR304C",539).
component("YJL200C",454).
component("YNL316C",606).
component("YPL212C",685).
component("YNL292W",604).
component("YGL063W",336).
component("YFL001W",312).
component("YPR002W",696).
component("YJR016C",462).
component("YCR053W",201).
component("YDR127W",246).
component("YGL148W",340).
component("YIL168W",430).
component("YIL167W",429).
component("YCL064C",193).
component("YER086W",304).
component("YLR359W",544).
component("YAL012W",137).
component("YML004C",551).
component("YFR055W",324).
component("YJL005W",436).
component("YJL121C",444).
component("YBR019C",155).
component("YDR050C",238).
component("YDR007W",231) :- not remove_orf("YDR007W",231).
component("YOR095C",641).
component("YER003C",290).
component("YBR196C",174).
component("YGL001C",326).
component("YPL117C",676).
component("U14_",39).
component("YOL056W",623).
component("YKL152C",489).
component("YDL021W",202).
component("YEL058W",287).
component("YPR060C",698).
component("YHR072W",392).
component("YPL097W",674).
component("YGR185C",362).
component("YGR264C",371).
component("YGR171C",360).
component("YPL104W",675).
component("YLL018C",506).
component("YHR020W",383).
component("YER087W",305).
component("YNL247W",597).
component("YOR168W",647).
component("YOL097C",630).
component("YDR268W",256).
component("YCR024C",196).
component("YHR019C",382).
component("YPL160W",679).
component("YLR382C",546).
component("YNL073W",587).
component("YOR335C",660).
component("YLR153C",524).
component("YAL054C",139).
component("YGR244C",368).
component("YIL145C",425).
component("YJL101C",443).
component("YOL049W",621).
component("YAR015W",141).
component("YER183C",311).
component("U90_",130).
component("YNR057C",614).
component("YDL141W",217).
component("YGL234W",347).
component("YDL141W",218).
component("YJR103W",471).
component("YBL039C",148).
component("YGR204W",365).
component("YBR084W",162).
component("YNL220W",595).
component("YOL058W",624).
component("YDL141W",219).
component("YHR074W",393).
component("YMR217W",574).
component("YGL062W",335).
component("YBR218C",175).
component("YPL231W",689).
component("YNR016C",610).
component("YKL182W",492).
component("YGR037C",353).
component("YPR138C",705).
component("YPL265W",691).
component("YPL134C",677).
component("YPL036W",673).
component("YOR222W",654).
component("YOR171C",648).
component("YOR130C",644).
component("YOR011W",637).
component("YOL156W",636).
component("YOL103W",631).
component("YOL020W",620) :- not remove_orf("YOL020W",620).
component("YNR072W",616).
component("YNL270C",602).
component("YNL142W",592).
component("YMR011W",564).
component("YLR260W",534).
component("YLR138W",521).
component("YLR100C",519).
component("YLR081W",517).
component("YLL061W",509).
component("YKR093W",504).
component("YKR053C",501).
component("YKR039W",500) :- not remove_orf("YKR039W",500).
component("YJR158W",478).
component("YJR077C",469).
component("YJL219W",457).
component("YJL214W",455).
component("YJL134W",448).
component("YJL129C",446).
component("YIL134W",423).
component("YHR096C",396).
component("YHR094C",395).
component("YHR092C",394).
component("YHL036W",379).
component("YGR121C",358).
component("YGR065C",355).
component("YGR055W",354).
component("YGL186C",342).
component("YGL077C",338).
component("YGL008C",327).
component("YFL055W",317).
component("YFL011W",313).
component("YER060W-A",298).
component("YER060W",297).
component("YER056C",296).
component("YER053C",295).
component("YEL069C",289).
component("YEL063C",288).
component("YEL017C-A",281).
component("YDR536W",279).
component("YDR508C",276).
component("YDR503C",275).
component("YDR497C",273).
component("YDR345C",263).
component("YDR343C",262).
component("YDR342C",261).
component("YDR297W",258).
component("YDR046C",237) :- not remove_orf("YDR046C",237).
component("YDL245C",230).
component("YCR032W",198).
component("YCR024C-A",197).
component("YCL025C",191).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,265) :- not remove_reaction(3620,265).
catalyst(2110,322).
catalyst(2190,322).
catalyst(5550,474).
catalyst(5791,530).
...
catalyst(6470,613).
catalyst(2300,131).
catalyst(3600,494) :- not remove_reaction(3600,494).
catalyst(8000,505).
catalyst(6890,594).
catalyst(2570,600).
catalyst(8781,257).
...
catalyst(4560,284).
catalyst(2550,612).
catalyst(1890,495) :- not remove_reaction(1890,495).
catalyst(3630,495) :- not remove_reaction(3630,495).
catalyst(1890,306) :- not remove_reaction(1890,306).
...
catalyst(8051,690).
catalyst(8052,690).
catalyst(3590,332) :- not remove_reaction(3590,332).
catalyst(10910,332) :- not remove_reaction(10910,332).
catalyst(4570,359).
catalyst(8181,539).
catalyst(8182,539).
catalyst(8181,454).
...
catalyst(640,504).
catalyst(6560,501).
catalyst(771,500) :- not remove_reaction(771,500).
catalyst(772,500) :- not remove_reaction(772,500).
catalyst(781,500) :- not remove_reaction(781,500).
catalyst(782,500) :- not remove_reaction(782,500).
catalyst(801,500) :- not remove_reaction(801,500).
catalyst(802,500) :- not remove_reaction(802,500).
catalyst(811,500) :- not remove_reaction(811,500).
catalyst(812,500) :- not remove_reaction(812,500).
catalyst(831,500) :- not remove_reaction(831,500).
catalyst(832,500) :- not remove_reaction(832,500).
catalyst(841,500) :- not remove_reaction(841,500).
catalyst(842,500) :- not remove_reaction(842,500).
catalyst(851,500) :- not remove_reaction(851,500).
catalyst(852,500) :- not remove_reaction(852,500).
catalyst(881,500) :- not remove_reaction(881,500).
catalyst(882,500) :- not remove_reaction(882,500).
catalyst(901,500) :- not remove_reaction(901,500).
catalyst(902,500) :- not remove_reaction(902,500).
catalyst(921,500) :- not remove_reaction(921,500).
catalyst(922,500) :- not remove_reaction(922,500).
catalyst(931,500) :- not remove_reaction(931,500).
catalyst(932,500) :- not remove_reaction(932,500).
catalyst(1191,500) :- not remove_reaction(1191,500).
catalyst(1192,500) :- not remove_reaction(1192,500).
catalyst(1180,478).
catalyst(1210,478).
catalyst(1581,469).
catalyst(1582,469).
...
catalyst(851,160) :- not remove_reaction(851,160).
catalyst(852,160) :- not remove_reaction(852,160).
...
modifiable_enzyme(494).
modifiable_enzyme(495).
