...
component("YNL280C",771).
component("YLR056W",662).
component("YGR060W",457).
component("YGL012W",427).
component("YKR009C",640).
component("YOL086C",802).
component("YMR303C",743).
component("YMR083W",723).
component("YGL256W",450).
component("YDL168W",295).
component("YBR145W",225).
component("YPL231W",876).
...
component("U45_",133).
component("YML056C",710).
component("YLR432W",699).
component("YHR216W",526).
component("YAR075W",189).
component("YAR073W",188).
component("YDR127W",324).
component("YJR139C",606).
component("YML075C",712).
component("YLR450W",702).
component("YOL126C",808).
component("YKL085W",617).
component("YDL078C",277).
component("YKL029C",613).
component("YNL037C",748).
component("YNL009W",746).
component("YLR174W",676).
component("YHR183W",519).
component("YGR256W",481).
component("YNL241C",763).
component("YOL059W",799).
component("YDL022W",269).
component("YCL018W",251).
component("YLR355C",694).
component("YIL074C",533).
component("YER081W",397).
component("YML054C",709).
component("YDL174C",299).
component("YML086C",714).
component("YIL155C",545).
component("YEL024W",372).
component("YKR066C",645).
component("YGR088W",461).
component("YDR256C",338).
component("YKL026C",612).
component("YIR037W",555).
component("YBR244W",238).
component("YJR078W",598).
component("U58_",143).
component("YJR025C",589).
component("U107_",27).
component("YGR255C",480).
component("U108_",28).
component("YHR007C",492).
component("YDR402C",353).
component("YGL055W",434).
component("YJR104C",601).
component("YHR008C",493).
component("YOR384W",850).
component("YOR381W",849).
component("YOL152W",811).
component("YLL051C",655).
component("YJL026W",557).
component("YIL066C",532).
component("YGR180C",469).
component("YER070W",394).
component("U37_",127).
component("U36_",126).
component("U35_",125).
component("YDL168W",296).
component("YDR158W",332).
component("YJR009C",585).
component("YJL052W",559).
component("YGR192C",471).
component("YBR006W",202).
component("YPL276W",884).
component("YPL275W",883).
component("YOR388C",851).
component("YPL061W",859).
component("YOR374W",847).
component("YER073W",395).
component("YGL154C",442).
component("YBR115C",220).
component("U55_",142).
component("YER069W",392).
component("YOR323C",839).
component("YMR170C",733).
component("YMR169C",732).
component("YER178W",407).
component("YBR221C",236).
component("YIL125W",541).
component("U52_",139).
component("YBR166C",230).
component("YNL280C",772).
component("YGL012W",428).
component("YKL182W",628).
component("YKL216W",638).
component("YDR044W",314).
component("YER014W",382).
component("YKR009C",641).
component("YIL160C",546).
component("YGL205W",447).
component("YMR118C",727).
component("YLR164W",674).
component("YLL041C",653).
component("YKL148C",622).
component("YKL141W",620).
component("YJL045W",558).
component("YDR178W",333).
component("YJR051W",592).
component("YEL047C",375).
component("YDL171C",297).
component("YDL171C",298).
component("YOR375C",848).
component("YDL215C",303).
component("YAL062W",185).
component("U99_",179).
component("U100_",21).
component("YBR035C",210).
component("YKR080W",647).
component("YER023W",383).
component("YPL023C",855).
component("YGL125W",439).
component("YOR236W",837).
component("YGR204W",473).
component("YIR034C",554).
component("YLR142W",671).
component("U65_",150).
component("U63_",148).
component("U62_",147).
component("YHR068W",504).
component("YKL150W",623).
component("YIL043C",530).
component("YHR042W",498).
component("YOR221C",834).
component("YMR145C",730).
component("YKL192C",632).
component("YKL055C",615).
component("YER061C",390).
component("YDL085W",279).
component("YPL171C",867).
component("YHR179W",518).
component("YMR145C",731).
component("YML120C",715).
component("YKL192C",633).
component("YDL085W",280).
component("YGR234W",476).
component("YFR030W",420).
component("YPL017C",854).
component("YFL018C",411).
component("YDR353W",348).
component("YPR167C",903).
component("YJR137C",605).
component("YNL052W",750).
component("YMR256C",740).
component("YLR395C",698).
component("YLR038C",660).
component("YIL111W",538).
component("YHR051W",502).
component("YGL191W",445).
component("YGL187C",444).
component("YDL067C",276).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",319).
component("YPL266W",882).
component("YDR410C",356).
component("YKR069W",646).
component("YOL096C",803).
component("U47_",135).
component("YER091C",402).
component("YJR073C",596).
component("YGR157W",466).
component("YDR120C",322).
component("YML008C",704).
component("YOR074C",816).
component("YDL033C",271).
component("YOL096C",804).
component("YLR172C",675).
component("YLR058C",663).
component("YDR019C",310).
component("YBR176W",231).
component("YDR408C",355).
component("YMR120C",728).
component("YLR028C",658).
component("YBL013W",190).
component("YJL130C",570).
component("YJL088W",563).
component("YKL024C",611).
component("YPR074C",897).
component("YBR117C",221).
component("YMR108W",726).
component("YCL009C",250).
component("YNL071W",752).
component("YNR008W",778).
component("YIL160C",547).
component("YNR019W",781).
component("YCR048W",265).
component("U48_",136).
component("YMR062C",722).
component("YDR232W",335).
component("YPL231W",877).
component("YER061C",391).
component("YPL001W",853).
component("YDL052C",275).
component("U8_",173).
component("YDR148C",330).
component("YPL231W",878).
component("YPL028W",856).
component("YLR299W",686).
component("YGL017W",429).
component("YCR005C",257).
component("YML126C",716).
component("YNL104C",755).
component("YDL182W",300).
component("YDL131W",286).
component("YDR307W",344).
component("YLR258W",683).
component("YFR015C",417).
component("YPL227C",874).
component("YNL029C",747).
component("YIL085C",535).
component("YNL192W",761).
component("YBR038W",212).
component("YBR023C",208).
component("YMR306W",744).
component("YLR342W",692).
component("YGR032W",454).
component("YPR183W",906).
component("YBR248C",239).
component("YLR209C",678).
component("U104_",24).
component("U103_",23).
component("YDR354W",349) :- not remove_orf("YDR354W",349).
component("YFR047C",421).
component("YJR133W",604).
component("YLR209C",679).
component("YML022W",706).
component("YDR441C",359).
component("YHR128W",513).
component("YPR176C",905).
component("YPL172C",868).
component("YNR041C",784).
component("YMR101C",724).
component("YDL090C",282).
component("YBR003W",201).
component("YBR002C",200).
component("YJL167W",577).
component("YJL167W",578).
component("YNL256W",766).
component("YPR069C",894).
component("YDR127W",325).
component("YHR190W",521).
component("YLR146C",672).
component("YHR068W",505).
component("YLR303W",688).
component("YGR012W",452).
component("YML082W",713).
component("YJR130C",603).
component("YDR035W",312).
component("YBR249C",240).
component("YLR180W",677).
component("YDR502C",363).
component("YOR274W",838).
component("YOL143C",810).
component("YBR256C",242).
component("YHR137W",514).
component("YGL202W",446).
component("YLR027C",657).
component("YKL106W",618).
component("YOL140W",809).
component("YLR438W",701).
component("YGR019W",453).
component("YLR089C",667).
component("U64_",149).
component("U61_",146).
component("U51_",138).
component("YJR148W",607).
component("YHR208W",524).
component("YFL030W",413).
component("YOR184W",827).
component("YNR058W",788).
component("YIL116W",540).
component("YGL253W",449).
component("YFR053C",422).
component("YMR013C",720).
component("YMR205C",736).
component("YGR240C",477).
component("YOL016C",792).
component("YFR014C",416).
component("YLR240W",681).
component("YKL203C",635).
component("YJR066W",595).
component("YCR036W",264).
component("YCL040W",253).
component("U15_",65).
component("YPL188W",870).
component("YJR049C",591).
component("YEL041W",373).
component("U96_",177).
component("YKL001C",610).
component("YDR236C",336).
component("YHL032C",490).
component("YDR531W",367).
component("U83_",168).
component("U82_",167).
component("U81_",166).
component("YMR208W",737).
component("YPL203W",871).
component("YOR061W",815).
component("YKL166C",625).
component("YJL164C",576).
component("YIL035C",529).
component("YHR205W",523).
component("YHR102W",511).
component("YGL019W",430).
component("YHR025W",497).
component("YOR347C",844).
component("YAL038W",183).
component("YNR012W",779).
component("YDR009W",309).
component("YDR127W",326).
component("YDR147W",329).
component("YDR300C",343).
component("YCR012W",258).
component("YER069W",393).
component("U19_",98).
component("U18_",89).
component("U17_",80).
component("U76_",160).
component("YER170W",406).
component("YDR226W",334).
component("YKL067W",616).
component("YOL055C",796).
component("YDR454C",360).
component("YJR057W",593).
component("YOL061W",800).
component("YKL181W",627).
component("YHL011C",488).
component("YER099C",403).
component("YBL068W",197).
component("YOR143C",823).
component("YNL256W",767).
component("YLR328W",690).
component("YBR018C",204).
component("YBR018C",205).
component("YGR007W",451).
component("YGR202C",472).
component("YLR328W",691).
component("YDL045C",273).
component("U80_",165).
component("YDL103C",285).
component("U94_",176).
component("YJR010W",586).
component("YBR029C",209).
...
component("YPR010C",887).
component("YOR341W",843).
component("YOR340C",842).
component("YOR224C",836).
component("YOR210W",833).
component("YOR207C",831).
component("YOR151C",824).
component("YOR116C",818).
component("YOL005C",790).
component("YNR003C",777).
component("YNL248C",765).
component("YNL151C",759).
component("YNL113W",756).
component("YKL144C",621).
component("YJR063W",594).
component("YJL148W",574).
component("YJL140W",573).
component("YIL021W",528).
component("YHR143W-A",515).
component("YGL070C",437).
component("YFL036W",414).
component("YDR404C",354).
component("YDR156W",331).
component("YDR045C",315).
component("YDL150W",294).
component("YDL140C",288).
component("YBR154C",229).
component("YPR175W",904).
component("YPL167C",866).
component("YOR330C",840).
component("YOL115W",807).
component("YNL299W",774).
component("YNL262W",769).
component("YNL102W",754).
component("YJR043C",590).
component("YJR006W",584).
component("YJL090C",564).
component("YIL139C",543).
component("YEL055C",376).
component("YDR419W",357).
component("YDR121W",323).
component("YDL102W",284).
component("YCR014C",259).
component("YBR278W",245).
component("YBL035C",193).
component("YKL035W",614).
component("YHL012W",489).
component("YHR123W",512).
component("YPR113W",901).
component("YBR243C",237).
component("YDL142C",293).
component("YPL148C",864).
component("YER026C",384).
component("YGR286C",485).
component("YJL068C",560).
component("YHR189W",520).
component("YDR058C",318).
component("YDL086W",281).
component("YOL011W",791).
component("YMR008C",718).
component("YMR006C",717).
component("U105_",25).
component("YBL015W",191).
component("YJL068C",561).
component("YJR019C",588).
component("YOR040W",814).
component("U77_",161).
component("YDR481C",361).
component("YLR377C",696).
component("YFR025C",418).
component("YPL179W",869).
component("YNR032W",782).
component("YML057W",711).
component("YML016C",705).
component("YLR433C",700).
component("YGR123C",464).
component("YER133W",404).
component("YER089C",400).
component("YDR436W",358).
component("YDR075W",320).
component("YDL188C",301).
component("YDL134C",287).
component("YDL047W",274).
component("YDL006W",267).
component("YBR125C",224).
component("YBL056W",196).
component("YPR073C",895).
component("YHR215W",525).
component("YDL024C",270).
component("YBR093C",218).
component("YBR092C",217).
component("YAR071W",187).
component("YHR046C",501).
component("U9_",180).
component("YPL228W",875).
component("YMR180C",734).
component("YDL236W",305).
component("YJL155C",575).
component("YPR073C",896).
component("YOR208W",832).
component("YNL053W",751).
component("YMR036C",721).
component("YIR026C",553).
component("YIL113W",539).
component("YFR028C",419).
component("YER075C",396).
component("YDL230W",304).
...
component("U25_",115).
component("U24_",114).
component("YHR044C",500).
component("YHR043C",499).
component("YOL064C",801).
component("YOR360C",846).
component("YKR031C",642).
component("YPL206C",872).
component("YGL027C",432).
component("YLR286C",685).
component("YJR153W",608).
component("YJL221C",583).
component("YJL216C",581).
component("YIL172C",551).
component("YGR292W",487).
component("YGR287C",486).
component("YBR299W",249).
component("YBR184W",232).
component("YIL162W",548).
component("YPR026W",888).
component("YDR001C",307).
component("YBR001C",199).
component("YIR019C",552).
component("YIL099W",537).
component("YDL037C",272).
component("YOR190W",829).
component("YLR300W",687).
component("YGR282C",484).
component("YDR261C",339).
component("YDR400W",352).
component("U23_",113).
component("YML035C",707).
component("YJL070C",562).
component("YBR284W",246).
component("U106_",26).
component("U102_",22).
component("YER043C",385).
component("YNL045W",749).
component("YGL037C",433).
component("YDR242W",337).
component("YBR208C",234).
component("YMR281W",742).
component("U53_",140).
component("YPR062W",893).
component("YMR120C",729).
component("YLR028C",659).
component("YHR144C",516).
component("YGR267C",483).
component("YBL033C",192).
component("YBR153W",228).
component("YNL141W",757).
component("YLR245C",682).
component("YML035C",708).
...
component("YPR080W",898).
component("YOR187W",828).
component("YOR133W",821).
component("YLR069C",665).
component("YKR084C",648).
component("YKL173W",626).
component("YJL102W",566).
component("YDR385W",351).
component("YBR118W",222).
component("YER005W",381).
component("YLL001W",651).
component("YIL048W",531).
component("YER166W",405).
component("YDR093W",321).
component("YAL026C",182).
component("YBL099W",198).
component("U60_",145).
component("YLR231C",680).
component("U88_",171).
component("YDR538W",369).
component("YLR134W",669).
component("YLR044C",661).
component("YGR087C",460).
component("YDR380W",350).
component("YDL080C",278).
component("U98_",178).
component("YMR250W",739).
component("YKL184W",631).
component("YOR128C",819).
component("YEL021W",371).
component("YNR043W",785).
component("U93_",175).
component("U54_",141).
component("YKL211C",636) :- not remove_orf("YKL211C",636).
component("YKR097W",650).
component("YOL052C",795).
component("YNL169C",760).
component("YGR170W",467).
component("YNL256W",768).
component("YDR294C",341).
component("YEL046C",374).
component("YNR033W",783).
component("YKL211C",637) :- not remove_orf("YKL211C",637).
component("YER090W",637) :- not remove_orf("YER090W",637).
component("YER090W",401) :- not remove_orf("YER090W",401).
component("YDR127W",327).
component("YPL281C",885).
component("YOR393W",852).
component("YMR323W",745).
component("YHR174W",517).
component("YGR254W",479).
component("YOR202W",830).
component("YPL262W",880).
component("YGL026C",431) :- not remove_orf("YGL026C",431).
component("YGR155W",465).
component("YLR304C",689).
component("YJL200C",579).
component("YNL316C",775).
component("YKL182W",629).
component("YPL212C",873).
component("YNL292W",773).
component("YGL063W",436).
component("YFL001W",409).
component("YPR002W",886).
component("YJR016C",587).
component("YCR053W",266).
component("YDR127W",328).
component("YGL148W",441).
component("YIL168W",550).
component("YIL167W",549).
component("YCL064C",256).
component("YER086W",398).
component("YLR359W",695).
component("YAL012W",181).
component("YML004C",703).
component("YFR055W",423).
component("YJL005W",556).
component("YJL121C",567).
component("YBR019C",206).
component("YDR050C",317).
component("YIL020C",527).
component("YDR007W",308) :- not remove_orf("YDR007W",308).
component("YOR095C",817).
component("YER003C",380).
component("YBR196C",233).
component("YGL001C",425).
component("YPL117C",862).
component("U14_",57).
component("YOL056W",797).
component("YKL152C",624).
component("YDL021W",268).
component("YMR105C",725).
component("YKL127W",619).
component("YEL058W",377).
component("YPR060C",892).
component("YHR072W",506).
component("YPL097W",860).
component("YGR185C",470).
component("YGR264C",482).
component("YGR171C",468).
component("YHR011W",494).
component("YDR023W",311).
component("YPL104W",861).
component("YLL018C",652).
component("YPR081C",899).
component("YBR121C",223).
component("YHR020W",496).
component("YER087W",399).
component("YNL247W",764).
component("YOR168W",825).
component("YOL097C",805).
component("YDR268W",340).
component("YPR047W",891).
component("YLR060W",664).
component("YFL022C",412).
component("YPR033C",889).
component("YCR024C",260).
component("YHR019C",495).
component("YKL194C",634).
component("YIL078W",534).
component("YPL160W",865).
component("YLR382C",697).
component("YNL073W",753).
component("YDR037W",313).
component("YOR335C",841).
component("YGR094W",462).
component("YLR153C",673).
component("YAL054C",184).
component("YOR142W",822).
component("YGR244C",478).
component("YPR035W",890).
component("YIL145C",544).
component("U89_",172).
component("YJL101C",565).
component("YOL049W",794).
component("YAR015W",186).
component("YER183C",408).
component("U90_",174).
component("YNR057C",787).
component("YDL141W",289).
component("YDL141W",290).
component("YGL234W",448).
component("YDL141W",291).
component("YJR103W",600).
component("YBL039C",194).
component("YGR204W",475).
component("YBR084W",216).
component("YNL220W",762).
component("YOL058W",798).
component("YDL141W",292).
component("YHR074W",507).
component("YMR217W",738).
component("YGR061C",458).
component("YJR109C",602).
component("YJL130C",571).
component("YGL062W",435).
component("YBR218C",235).
component("YPL231W",879).
component("YNR016C",780).
component("YKL182W",630).
component("YGR037C",455).
component("YPR138C",902).
component("YPL265W",881).
component("YPL134C",863).
component("YPL057C",858).
component("YPL036W",857).
component("YOR348C",845).
component("YOR222W",835).
component("YOR171C",826).
component("YOR130C",820).
component("YOR011W",813).
component("YOL156W",812).
component("YOL103W",806).
component("YOL020W",793) :- not remove_orf("YOL020W",793).
component("YNR072W",789).
component("YNR056C",786).
component("YNL318C",776).
component("YNL270C",770).
component("YNL142W",758).
component("YMR272C",741).
component("YMR202W",735).
component("YMR011W",719).
component("YLR348C",693).
component("YLR260W",684).
component("YLR138W",670).
component("YLR100C",668).
component("YLR081W",666).
component("YLL061W",656).
component("YLL043W",654).
component("YKR093W",649).
component("YKR053C",644).
component("YKR039W",643) :- not remove_orf("YKR039W",643).
component("YKL217W",639).
component("YJR158W",609).
component("YJR095W",599).
component("YJR077C",597).
component("YJL219W",582).
component("YJL214W",580).
component("YJL134W",572).
component("YJL129C",569).
component("YIL134W",542).
component("YHR096C",510).
component("YHR094C",509).
component("YHR092C",508).
component("YHL036W",491).
component("YGR121C",463).
component("YGR065C",459).
...
component("YER060W-A",389).
component("YER060W",388).
component("YER056C",387).
component("YER053C",386).
component("YEL069C",379).
component("YEL063C",378).
component("YEL017C-A",370).
component("YDR536W",368).
component("YDR508C",365).
component("YDR503C",364).
component("YDR497C",362).
component("YDR345C",347).
component("YDR343C",346).
component("YDR342C",345).
component("YDR297W",342).
component("YDR046C",316) :- not remove_orf("YDR046C",316).
component("YDL245C",306).
component("YDL210W",302).
component("YCR032W",263).
component("YCR028C",262).
component("YCR024C-A",261).
component("YCL025C",252).
component("YBR298C",248).
component("YBR291C",247).
component("YBR069C",214) :- not remove_orf("YBR069C",214).
component("YBR068C",213) :- not remove_orf("YBR068C",213).
component("YBR036C",211).
component("YBR021W",207).
component("YBL042C",195).
component("U85_",169).
component("U7_",164).
component("U79_",163).
component("U78_",162).
...
catalyst(2131,23).
catalyst(2132,23).
catalyst(3620,349) :- not remove_reaction(3620,349).
catalyst(2110,421).
catalyst(2190,421).
catalyst(5550,604).
catalyst(5791,679).
...
catalyst(1890,401) :- not remove_reaction(1890,401).
catalyst(3630,401) :- not remove_reaction(3630,401).
catalyst(3740,327).
catalyst(8231,885).
catalyst(8232,885).
catalyst(8231,852).
...
catalyst(8282,317).
catalyst(3840,527).
catalyst(3610,308) :- not remove_reaction(3610,308).
catalyst(7921,817).
catalyst(7922,817).
catalyst(7841,380).
catalyst(7842,380).
...
catalyst(1210,812).
catalyst(1160,806).
catalyst(801,793) :- not remove_reaction(801,793).
catalyst(802,793) :- not remove_reaction(802,793).
catalyst(811,793) :- not remove_reaction(811,793).
catalyst(812,793) :- not remove_reaction(812,793).
catalyst(831,793) :- not remove_reaction(831,793).
catalyst(832,793) :- not remove_reaction(832,793).
catalyst(901,793) :- not remove_reaction(901,793).
catalyst(902,793) :- not remove_reaction(902,793).
catalyst(1180,789).
catalyst(1210,789).
catalyst(700,786).
catalyst(1200,776).
...
catalyst(851,643) :- not remove_reaction(851,643).
catalyst(852,643) :- not remove_reaction(852,643).
...
catalyst(931,643) :- not remove_reaction(931,643).
catalyst(932,643) :- not remove_reaction(932,643).
...
catalyst(1210,345).
catalyst(6650,342).
catalyst(791,316) :- not remove_reaction(791,316).
catalyst(792,316) :- not remove_reaction(792,316).
catalyst(801,316) :- not remove_reaction(801,316).
catalyst(802,316) :- not remove_reaction(802,316).
catalyst(811,316) :- not remove_reaction(811,316).
catalyst(812,316) :- not remove_reaction(812,316).
catalyst(831,316) :- not remove_reaction(831,316).
catalyst(832,316) :- not remove_reaction(832,316).
catalyst(841,316) :- not remove_reaction(841,316).
catalyst(842,316) :- not remove_reaction(842,316).
catalyst(851,316) :- not remove_reaction(851,316).
catalyst(852,316) :- not remove_reaction(852,316).
catalyst(901,316) :- not remove_reaction(901,316).
catalyst(902,316) :- not remove_reaction(902,316).
catalyst(1180,306).
catalyst(1210,306).
catalyst(690,302).
catalyst(730,302).
...
catalyst(1511,247).
catalyst(1512,247).
catalyst(771,214) :- not remove_reaction(771,214).
catalyst(772,214) :- not remove_reaction(772,214).
...
catalyst(851,214) :- not remove_reaction(851,214).
catalyst(852,214) :- not remove_reaction(852,214).
...
catalyst(831,213) :- not remove_reaction(831,213).
catalyst(832,213) :- not remove_reaction(832,213).
catalyst(841,213) :- not remove_reaction(841,213).
catalyst(842,213) :- not remove_reaction(842,213).
catalyst(851,213) :- not remove_reaction(851,213).
catalyst(852,213) :- not remove_reaction(852,213).
