...
component("YLR056W",332).
component("YKR009C",319).
component("YOL086C",401).
component("YMR303C",366).
component("YGL256W",228).
component("YDL168W",145).
component("YBR145W",110).
component("YPL231W",439).
component("U46_",67).
component("YBR149W",111).
component("YGL001C",209).
component("YIL094C",269).
component("U45_",66).
component("YDR127W",156).
component("YOL126C",405).
component("YKL085W",309).
component("YDL078C",138).
component("YNL037C",370).
component("YCL018W",124).
component("YLR355C",352).
component("YDL174C",147).
component("YML086C",357).
component("YGR088W",235).
component("YDR256C",166).
component("YJR078W",301).
component("YJR025C",294).
component("U107_",23).
component("YJR104C",303).
component("YHR008C",251).
component("YJL026W",280).
component("YIL066C",267).
component("YGR180C",238).
component("YER070W",194).
component("U36_",62).
component("YDL168W",146).
component("YPL276W",447).
component("YPL275W",446).
component("YOR388C",427).
component("YOR323C",420).
component("YER178W",199).
component("YBR221C",116).
component("YIL125W",272).
component("U52_",70).
component("YBR166C",113).
component("YGL012W",212).
component("YKL216W",318).
component("YKR009C",320).
component("YIL160C",275).
component("YGL205W",225).
component("U100_",20).
component("YKR080W",324).
component("YER023W",189).
component("YGR204W",240).
component("YLR142W",337).
component("U65_",75).
component("U62_",74).
component("YHR068W",257).
component("YKL150W",312).
component("YIL043C",266).
component("YPL171C",436).
component("YHR179W",264).
component("YGR234W",242).
component("YPL017C",429).
component("YFL018C",200).
component("YDR353W",170).
component("YPR167C",458).
component("YNL052W",371).
component("YMR256C",365).
component("YLR395C",354).
component("YLR038C",330).
component("YIL111W",270).
component("YHR051W",256).
component("YGL191W",223).
component("YGL187C",222).
component("YDL067C",137).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",445).
component("YKR069W",323).
component("YJR073C",299).
component("YDL033C",136).
component("YLR172C",339).
component("YLR058C",333).
component("YDR019C",151).
component("YBR176W",114).
component("YDR408C",175).
component("YMR120C",362).
component("YLR028C",328).
component("YBL013W",93).
component("YJL130C",286).
component("YKL024C",307).
component("YPR074C",454).
component("YBR117C",109).
component("YCL009C",123).
component("YNL071W",373).
component("YIL160C",276).
component("U48_",68).
component("YPL231W",440).
component("YPL231W",441).
component("YLR299W",346).
component("YGL017W",213).
component("YML126C",358).
component("YNL104C",375).
component("YDL182W",148).
component("YDL131W",142).
component("YLR258W",344).
component("YFR015C",205).
component("YNL029C",369).
component("YIL085C",268).
component("YMR306W",367).
component("YLR342W",351).
component("YGR032W",230).
component("YLR209C",340).
component("U104_",21).
component("YDR354W",171) :- not remove_orf("YDR354W",171).
component("YFR047C",207).
component("YLR209C",341).
component("YML022W",355).
component("YDR441C",177).
component("YJL167W",290).
component("YDR127W",157).
component("YHR068W",258).
component("YLR303W",348).
component("YGR012W",229).
component("YJR130C",304).
component("YDR035W",152).
component("YBR249C",117).
component("YOR274W",419).
component("YHR137W",260).
component("YGL202W",224).
component("YLR027C",327).
component("YKL106W",310).
component("YOL140W",406).
component("YLR089C",334).
component("U61_",73).
component("YJR148W",305).
component("YFL030W",201).
component("YNR058W",392).
component("YGL253W",227).
component("YFR053C",208).
component("YMR205C",364).
component("YGR240C",243).
component("YOL016C",395).
component("YFR014C",204).
component("YCR036W",133).
component("YCL040W",126).
component("YPL188W",437).
component("YJR049C",296).
component("YEL041W",184).
component("U96_",87).
component("YDR236C",164).
component("YHL032C",249).
component("YOR347C",425).
component("YAL038W",91).
component("YNR012W",388).
component("YDR127W",158).
component("YDR147W",161).
component("YCR012W",128).
component("U76_",83).
component("YER170W",198).
component("YDR226W",163).
component("YKL067W",308).
component("YOL055C",398).
component("YDR454C",178).
component("YJR057W",297).
component("YOL061W",400).
component("YKL181W",314).
component("YHL011C",248).
component("YER099C",197).
component("YBL068W",98).
component("YOR143C",411).
component("YNL256W",382).
component("YBR018C",101).
component("YLR328W",350).
component("U94_",86).
component("YBR029C",103).
component("YGL130W",219).
component("YPR190C",461).
component("YPR187W",460).
component("YPR110C",455).
component("YPR010C",450).
component("YOR341W",424).
component("YOR340C",423).
component("YOR224C",418).
component("YOR210W",417).
component("YOR207C",415).
component("YOR151C",412).
component("YOR116C",409).
component("YOL005C",393).
component("YNR003C",387).
component("YNL248C",381).
component("YNL151C",379).
component("YNL113W",376).
component("YKL144C",311).
component("YJR063W",298).
component("YJL148W",289).
component("YJL140W",288).
component("YIL021W",265).
component("YHR143W-A",261).
component("YGL070C",217).
component("YFL036W",202).
component("YDR404C",174).
component("YDR156W",162).
component("YDR045C",153).
component("YDL150W",144).
component("YDL140C",143).
component("YBR154C",112).
component("YPR175W",459).
component("YPL167C",435).
component("YOR330C",421).
component("YOL115W",404).
component("YNL299W",385).
component("YNL262W",383).
component("YNL102W",374).
component("YJR043C",295).
component("YJR006W",292).
component("YJL090C",282).
component("YIL139C",273).
component("YEL055C",186).
component("YDR419W",176).
component("YDR121W",155).
component("YDL102W",141).
component("YCR014C",129).
component("YBR278W",120).
component("YBL035C",96).
component("YPR113W",456).
component("YPL148C",434).
component("YGR286C",247).
component("YOL011W",394).
component("YMR008C",360).
component("YMR006C",359).
component("U105_",22).
component("YBL015W",94).
component("U77_",84).
component("YLR377C",353).
component("YHR046C",255).
component("U9_",89).
component("YPR073C",453).
component("YOR208W",416).
component("YNL053W",372).
component("YMR036C",361).
component("YIR026C",279).
component("YIL113W",271).
component("YFR028C",206).
component("YER075C",195).
component("YDL230W",149).
component("YBR276C",119).
component("U30_",61).
component("U29_",60).
component("U26_",59).
component("U24_",58).
component("YHR044C",254).
component("YHR043C",253).
component("YOR360C",426).
component("YPL206C",438).
component("YGL027C",215).
component("YJR153W",306).
component("YOR190W",414).
component("YLR300W",347).
component("YGR282C",246).
component("YDR261C",167).
component("YDR400W",173).
component("YML035C",356).
component("YJL070C",281).
component("YBR284W",121).
component("YDR242W",165).
component("U53_",71).
component("YPR062W",452).
component("YMR120C",363).
component("YLR028C",329).
component("YHR144C",262).
component("YBL033C",95).
component("YNL141W",377).
component("YLR245C",343).
component("YBR084W",106).
component("YJL126W",284).
component("YDL100C",140).
component("U39_",63).
component("YBR011C",100).
component("YBR111C",108).
component("YBR252W",118).
component("YER005W",188).
component("YBL099W",99).
component("YLR231C",342).
component("YLR134W",336).
component("YLR044C",331).
component("YGR087C",234).
component("YDR380W",172).
component("YDL080C",139).
component("U98_",88).
component("YOR128C",410).
component("YKL211C",316) :- not remove_orf("YKL211C",316).
component("YKR097W",325).
component("YNL169C",380).
component("YEL046C",185).
component("YNR033W",390).
component("YKL211C",317) :- not remove_orf("YKL211C",317).
component("YER090W",317) :- not remove_orf("YER090W",317).
component("YER090W",196) :- not remove_orf("YER090W",196).
component("YDR127W",159).
component("YPL281C",448).
component("YOR393W",428).
component("YMR323W",368).
component("YHR174W",263).
component("YGR254W",244).
component("YPL262W",443).
component("YGL026C",214) :- not remove_orf("YGL026C",214).
component("YLR304C",349).
component("YJL200C",291).
component("YNL316C",386).
component("YPR002W",449).
component("YJR016C",293).
component("YCR053W",134).
component("YDR127W",160).
component("YGL148W",220).
component("YIL168W",278).
component("YIL167W",277).
component("YCL064C",127).
component("YAL012W",90).
component("YBR019C",102).
component("YDR007W",150) :- not remove_orf("YDR007W",150).
component("YOR095C",408).
component("YGL001C",210).
component("YPL117C",433).
component("YOL056W",399).
component("YKL152C",313).
component("YDL021W",135).
component("YPR060C",451).
component("YPL097W",431).
component("YGR185C",239).
component("YGR264C",245).
component("YGR171C",237).
component("YPL104W",432).
component("YLL018C",326).
component("YOL097C",402).
component("YDR268W",168).
component("YCR024C",130).
component("YHR019C",252).
component("YOR335C",422).
component("YLR153C",338).
component("YAL054C",92).
component("YIL145C",274).
component("YJL101C",283).
component("YOL049W",397).
component("U90_",85).
component("YNR057C",391).
component("YGL234W",226).
component("YJR103W",302).
component("YBL039C",97).
component("YGR204W",241).
component("YBR084W",107).
component("YHR074W",259).
component("YGL062W",216).
component("YBR218C",115).
component("YPL231W",442).
component("YNR016C",389).
component("YKL182W",315).
component("YGR037C",231).
component("YPR138C",457).
component("YPL265W",444).
component("YPL036W",430).
component("YOR171C",413).
component("YOR011W",407).
component("YOL103W",403).
component("YOL020W",396) :- not remove_orf("YOL020W",396).
component("YNL270C",384).
component("YNL142W",378).
component("YLR260W",345).
component("YLR100C",335).
component("YKR053C",322).
component("YKR039W",321) :- not remove_orf("YKR039W",321).
component("YJR077C",300).
component("YJL134W",287).
component("YJL129C",285).
component("YHL036W",250).
component("YGR121C",236).
component("YGR065C",233).
component("YGR055W",232).
component("YGL186C",221).
component("YGL077C",218).
component("YGL008C",211).
component("YFL055W",203).
component("YER060W-A",193).
component("YER060W",192).
component("YER056C",191).
component("YER053C",190).
component("YEL063C",187).
component("YEL017C-A",183).
component("YDR536W",182).
component("YDR508C",181).
component("YDR503C",180).
component("YDR497C",179).
component("YDR297W",169).
component("YDR046C",154) :- not remove_orf("YDR046C",154).
component("YCR032W",132).
component("YCR024C-A",131).
component("YCL025C",125).
component("YBR298C",122).
component("YBR069C",105) :- not remove_orf("YBR069C",105).
component("YBR068C",104) :- not remove_orf("YBR068C",104).
component("U75_",82).
component("U74_",81).
component("U73_",80).
component("U72_",79).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,171) :- not remove_reaction(3620,171).
catalyst(2190,207).
catalyst(5791,341).
catalyst(5792,341).
catalyst(5801,341).
...
catalyst(6111,410).
catalyst(6112,410).
catalyst(3600,316) :- not remove_reaction(3600,316).
catalyst(8000,325).
catalyst(6890,380).
catalyst(4560,185).
catalyst(2550,390).
catalyst(3630,317) :- not remove_reaction(3630,317).
catalyst(3630,196) :- not remove_reaction(3630,196).
catalyst(3740,159).
catalyst(8231,448).
catalyst(8232,448).
catalyst(8231,428).
...
catalyst(8051,443).
catalyst(8052,443).
catalyst(3590,214) :- not remove_reaction(3590,214).
catalyst(10910,214) :- not remove_reaction(10910,214).
catalyst(8181,349).
catalyst(8182,349).
catalyst(8181,291).
catalyst(8182,291).
...
catalyst(7751,102).
catalyst(7752,102).
catalyst(3610,150) :- not remove_reaction(3610,150).
catalyst(7921,408).
catalyst(7922,408).
catalyst(6370,210).
catalyst(6461,433).
...
catalyst(901,396) :- not remove_reaction(901,396).
catalyst(902,396) :- not remove_reaction(902,396).
catalyst(931,384).
catalyst(932,384).
catalyst(371,378).
catalyst(372,378).
...
catalyst(6330,335).
catalyst(6560,322).
catalyst(771,321) :- not remove_reaction(771,321).
catalyst(772,321) :- not remove_reaction(772,321).
catalyst(781,321) :- not remove_reaction(781,321).
catalyst(782,321) :- not remove_reaction(782,321).
...
catalyst(851,321) :- not remove_reaction(851,321).
catalyst(852,321) :- not remove_reaction(852,321).
catalyst(881,321) :- not remove_reaction(881,321).
catalyst(882,321) :- not remove_reaction(882,321).
catalyst(901,321) :- not remove_reaction(901,321).
catalyst(902,321) :- not remove_reaction(902,321).
catalyst(931,321) :- not remove_reaction(931,321).
catalyst(932,321) :- not remove_reaction(932,321).
catalyst(1191,321) :- not remove_reaction(1191,321).
catalyst(1192,321) :- not remove_reaction(1192,321).
catalyst(1581,300).
catalyst(1582,300).
catalyst(6560,287).
catalyst(361,285).
...
catalyst(1121,122).
catalyst(1122,122).
catalyst(771,105) :- not remove_reaction(771,105).
catalyst(772,105) :- not remove_reaction(772,105).
...
catalyst(801,104) :- not remove_reaction(801,104).
catalyst(802,104) :- not remove_reaction(802,104).
catalyst(811,104) :- not remove_reaction(811,104).
catalyst(812,104) :- not remove_reaction(812,104).
catalyst(831,104) :- not remove_reaction(831,104).
catalyst(832,104) :- not remove_reaction(832,104).
catalyst(841,104) :- not remove_reaction(841,104).
catalyst(842,104) :- not remove_reaction(842,104).
catalyst(851,104) :- not remove_reaction(851,104).
catalyst(852,104) :- not remove_reaction(852,104).
catalyst(901,104) :- not remove_reaction(901,104).
catalyst(902,104) :- not remove_reaction(902,104).
catalyst(2920,82).
catalyst(2920,81).
catalyst(2920,80).
catalyst(2920,79).
