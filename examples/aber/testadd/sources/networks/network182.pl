...
retractable_reaction(8921).
retractable_reaction(8922).
...
component("YNL280C",924).
component("YLR056W",787).
component("YGR060W",550).
component("YGL012W",515).
component("YKR009C",763).
component("YOL086C",959).
component("YMR303C",890).
component("YMR083W",862).
component("YGL256W",542).
component("YDL168W",351).
component("YBR145W",271).
component("YPL231W",1055).
component("YBR265W",290).
component("U46_",162).
component("YBR149W",272).
component("YBR149W",273).
component("YJR159W",726).
component("YGL001C",511).
component("YIL094C",642).
component("YHR063C",605).
component("U45_",161).
component("YML056C",843).
component("YLR432W",831).
component("YHR216W",630).
component("YAR075W",226).
component("YAR073W",225).
component("YDR127W",388).
component("YJR139C",721).
component("YML075C",846).
component("YLR450W",834).
component("YOL126C",965).
component("YKL085W",737).
component("YDL078C",330).
component("YKL029C",732).
component("YOR136W",986).
component("YNL037C",896).
component("YNL009W",894).
component("YLR174W",801).
component("YDL066W",328).
component("YHR183W",623).
component("YGR256W",581).
component("YNL241C",913).
component("YOL059W",956).
component("YDL022W",320).
component("YCL018W",299).
component("YLR355C",826).
component("YIL074C",639).
component("YER081W",476).
component("YML054C",842).
component("YDL174C",355).
component("YML086C",848).
component("YIL155C",652).
component("YPR191W",1097).
component("YOR065W",974).
component("YJL166W",690).
component("YHR001W-A",592).
component("YGR183C",566).
component("YFR033C",507).
component("YEL024W",444).
component("YDR529C",434).
component("YBL045C",234).
component("Q0105",19).
component("YKR066C",768).
component("YGR088W",554).
component("YDR256C",404).
component("YKL026C",731).
component("YIR037W",665).
component("YBR244W",285).
component("YJR078W",713).
component("U58_",172).
component("YJR025C",704).
component("U107_",28).
component("YGR255C",580).
component("U108_",29).
component("YHR007C",593).
component("YDR402C",421).
component("YGL055W",522).
component("YJR104C",716).
component("YHR008C",594).
component("YOR384W",1024).
component("YOR381W",1023).
component("YOL152W",969).
component("YLL051C",779).
component("YJL026W",668).
component("YIL066C",638).
component("YGR180C",565).
component("YER070W",473).
component("U37_",153).
component("U36_",152).
component("U35_",151).
component("YDL168W",352).
component("YDR158W",396).
component("YJR009C",700).
component("YJL052W",670).
component("YGR192C",568).
component("YBR006W",243).
component("YPL276W",1067).
component("YPL275W",1066).
component("YOR388C",1025).
component("YPL061W",1034).
component("YOR374W",1020).
component("YER073W",474).
component("YGL154C",531).
component("YBR115C",266).
component("U55_",170).
component("YER069W",471).
component("YOR323C",1010).
component("YMR170C",873).
component("YMR169C",872).
component("U2_",145).
component("YER178W",490).
component("YBR221C",283).
component("YIL125W",648).
component("U52_",167).
component("YBR166C",276).
component("YNL280C",925).
component("YGL012W",516).
component("YKL182W",749).
component("U57_",171).
component("YKL216W",760).
component("YDR044W",371).
component("YER014W",455).
component("YKR009C",764).
component("YIL160C",654).
component("YGL205W",536).
component("YMR118C",866).
component("YLR164W",799).
component("YLL041C",777).
component("YKL148C",743).
component("YKL141W",741).
component("YJL045W",669).
component("YDR178W",398).
component("YJR051W",707).
component("YEL047C",448).
component("YDL171C",353).
component("YDL171C",354).
component("YOR375C",1021).
component("YDL215C",359).
component("YAL062W",221).
component("U99_",214).
component("U100_",22).
component("YBR035C",252).
component("YMR189W",875).
component("YKR080W",770).
component("YER023W",457).
component("YPL023C",1029).
component("YGL125W",528).
component("YOR236W",1005).
component("YGR204W",572).
component("YBR084W",259).
component("YIR034C",664).
component("YLR142W",796).
component("U65_",180).
component("U63_",178).
component("U62_",177).
component("YOR356W",1018).
component("YHR068W",606).
component("YKL150W",744).
component("YIL043C",635).
component("YHR042W",600).
component("YOR221C",1002).
component("YMR145C",869).
component("YML120C",850).
component("YKL192C",753).
component("YKL055C",734).
component("YER061C",467).
component("YDL085W",332).
component("YPL171C",1044).
component("YHR179W",622).
component("YMR145C",870).
component("YML120C",851).
component("YKL192C",754).
component("YDL085W",333).
component("YGR234W",575).
component("YFR030W",506).
component("YPL017C",1028).
component("YFL018C",494).
component("YPL091W",1036).
component("YDR353W",415).
component("YER042W",459).
component("YPR167C",1091).
component("YJR137C",720).
component("YNL052W",898).
component("YMR256C",884).
component("YLR395C",830).
component("YLR038C",785).
component("YIL111W",645).
component("YHR051W",604).
component("YGL191W",534).
component("YGL187C",533).
component("YDL067C",329).
component("Q0275",21).
component("Q0250",20).
component("Q0045",18).
component("YDR072C",380).
component("YPL266W",1062).
component("YPL273W",1064).
component("YLL062C",781).
component("YDR410C",424).
component("YKR069W",769).
component("YOL096C",960).
component("U47_",163).
component("YER091C",481).
component("YJR073C",711).
component("YGR157W",561).
component("YDR120C",386).
component("YML008C",836).
component("YOR074C",976).
component("YDL033C",322).
component("YOL096C",961).
component("YLR172C",800).
component("YLR058C",788).
component("YDR019C",367).
component("YBR176W",277).
component("YDR408C",423).
component("YMR120C",867).
component("YLR028C",783).
component("YBL013W",227).
component("YJL130C",682).
component("YJL088W",675).
component("YKL024C",729).
component("YPR074C",1082).
component("YBR117C",267).
component("YLR354C",825).
component("YGR043C",548).
component("YMR108W",865).
component("YCL009C",298).
component("YMR062C",860).
component("YNL071W",900).
component("YNR008W",932).
component("YIL160C",655).
component("YNR019W",935).
component("YCR048W",315).
component("U48_",164).
component("YNL277W",923).
component("YMR062C",861).
component("YDR232W",401).
component("YPL231W",1056).
component("YER061C",468).
component("U86_",202).
component("YPL001W",1027).
component("YDL052C",326).
component("U8_",206).
component("YDR148C",394).
component("YAR035W",223).
component("YOR377W",1022).
component("YGR177C",564).
component("YPL231W",1057).
component("YPL028W",1030).
component("YLR299W",812).
component("YGL017W",517).
component("YPR001W",1069).
component("YNR001C",930).
component("YCR005C",307).
component("YML126C",852).
component("YNL104C",903).
component("YDL182W",356).
component("YDL131W",342).
component("YPR160W",1090).
component("YOR321W",1009).
component("YJR143C",722).
component("YGR199W",570).
component("YDR307W",411).
component("YDL095W",337).
component("YDL093W",336).
component("YAL023C",217).
component("YLR258W",809).
component("YFR015C",502).
component("YPL227C",1053).
component("YOR103C",980).
component("YOR085W",977).
component("YMR149W",871).
component("YML019W",838).
component("YJL002C",666).
component("YEL002C",439).
component("YDL232W",361).
component("YCL043C",303).
component("YNL029C",895).
component("YIL085C",641).
component("YNL192W",911).
component("YBR038W",254).
component("YBR023C",250).
component("YEL011W",440).
component("YMR306W",892).
component("YLR342W",823).
component("YGR032W",546).
component("YPR183W",1094).
component("YBR248C",286).
component("YLR209C",803).
component("U104_",25).
component("U103_",24).
component("YMR271C",885).
component("YML106W",849).
component("YOR209C",1000).
component("YMR300C",889).
component("YER055C",463).
component("YDR354W",416) :- not remove_orf("YDR354W",416).
component("YFR047C",508).
component("YJR133W",719).
component("U22_",137).
component("YLR209C",804).
component("YML022W",839).
component("YDR441C",427).
component("YDR399W",419).
component("YHR128W",615).
component("YPR176C",1093).
component("YPL172C",1045).
component("YNR041C",939).
component("YMR101C",863).
component("YDL090C",335).
component("YBR003W",242).
component("YBR002C",241).
component("YJL167W",691).
component("YJL167W",692).
component("YNL256W",916).
component("YPR069C",1079).
component("YDR127W",389).
component("YHR190W",625).
component("YLR146C",797).
component("YPL214C",1051).
component("YHR068W",607).
component("YLR303W",814).
component("YGR012W",544).
component("YML082W",847).
component("YJR130C",718).
component("YLR303W",815).
component("YDR035W",369).
component("YBR249C",287).
component("YLR180W",802).
component("YDR502C",431).
component("YOR274W",1006).
component("YOL143C",968).
component("YBR256C",289).
component("YHR137W",616).
component("YGL202W",535).
component("YLR027C",782).
component("YKL106W",738).
component("YOL140W",967).
component("YLR438W",833).
component("YGR019W",545).
component("YLR089C",792).
component("YDR111C",385).
component("U64_",179).
component("U61_",176).
component("U51_",166).
component("YJR148W",723).
component("YHR208W",628).
component("YFL030W",496).
component("YOR184W",993).
component("YNR058W",943).
component("YIL116W",647).
component("YGL253W",541).
component("YFR053C",509).
component("YOL136C",966).
component("YIL107C",644).
component("YMR013C",856).
component("YMR205C",877).
component("YGR240C",576).
component("YOL016C",947).
component("YFR014C",501).
component("YLR240W",807).
component("YKL203C",756).
component("YJR066W",710).
component("YCR036W",314).
component("YGR194C",569).
component("YCL040W",302).
component("U15_",73).
component("YPL188W",1047).
component("YJR049C",706).
component("YEL041W",445).
component("U96_",212).
component("YKL001C",727).
component("YDR236C",402).
component("YML070W",845).
component("YFL053W",498).
component("YHL032C",590).
component("YDR531W",436).
component("U83_",199).
component("U82_",198).
component("U81_",197).
component("YMR208W",878).
component("YPL203W",1048).
component("YOR061W",973).
component("YKL166C",746).
component("YJL164C",689).
component("YIL035C",634).
component("YHR205W",627).
component("YHR102W",613).
component("YGL019W",518).
component("YHR025W",599).
component("YOR347C",1016).
component("YAL038W",219).
component("YNR012W",933).
component("YPR121W",1087).
component("YPL258C",1059).
component("YOL055C",952).
component("YPL214C",1052).
component("U1_",113).
component("YDR009W",366).
component("YNL267W",920).
component("YLR305C",817).
component("YFR019W",503).
component("YDR208W",399).
component("YDR127W",390).
component("U21_",128).
component("U20_",123).
component("YDR147W",393).
component("YDR300C",410).
component("YCR012W",308).
component("YER052C",461).
component("YER069W",472).
component("U19_",112).
...
component("YER170W",489).
component("YDR226W",400).
component("YKL067W",736).
component("YOL055C",953).
component("YDR454C",428).
component("YJR057W",708).
component("YOL061W",957).
component("YKL181W",748).
component("YHL011C",588).
component("YER099C",483).
component("YBL068W",237).
component("YOR143C",988).
component("YNL256W",917).
component("YLR328W",821).
component("YBR018C",245).
component("YBR018C",246).
component("YGR007W",543).
component("YGR202C",571).
component("YLR328W",822).
component("YKR002W",762).
component("YDL045C",324).
component("U80_",196).
component("YDL103C",340).
component("U94_",211).
component("YJR010W",701).
component("YBR029C",251).
component("YCL050C",304).
component("YGL130W",529).
component("YDR530C",435).
component("YCL050C",305).
component("YPR190C",1096).
component("YPR187W",1095).
component("YPR110C",1085).
component("YPR010C",1072).
component("YOR341W",1015).
component("YOR340C",1014).
component("YOR224C",1004).
component("YOR210W",1001).
component("YOR207C",998).
component("YOR151C",989).
component("YOR116C",981).
component("YOL005C",945).
component("YNR003C",931).
component("YNL248C",915).
component("YNL151C",908).
component("YNL113W",904).
component("YKL144C",742).
component("YJR063W",709).
component("YJL148W",686).
component("YJL140W",685).
component("YIL021W",633).
component("YHR143W-A",617).
component("YGL070C",526).
component("YFL036W",497).
component("YDR404C",422).
component("YDR156W",395).
component("YDR045C",372).
component("YDL150W",350).
component("YDL140C",344).
component("YBR154C",275).
component("YPR175W",1092).
component("YPL167C",1043).
component("YOR330C",1011).
component("YOL115W",964).
component("YNL299W",927).
component("YNL262W",919).
component("YNL102W",902).
component("YJR043C",705).
component("YJR006W",699).
component("YJL090C",676).
component("YIL139C",650).
component("YEL055C",449).
component("YDR419W",425).
component("YDR121W",387).
component("YDL102W",339).
component("YCR014C",309).
component("YBR278W",292).
component("YBL035C",231).
component("YKL035W",733).
component("YHL012W",589).
component("YHR123W",614).
component("YPR113W",1086).
component("YBR243C",284).
component("YNL130C",905).
component("YDL142C",349).
component("YPL148C",1041).
component("YER026C",458).
component("YCL004W",297).
component("YGR286C",585).
component("YJL068C",671).
component("YHR189W",624).
component("YDR058C",377).
component("YNR034W",938).
component("YHR163W",620).
component("YGR248W",578).
component("YCR073W-A",317).
component("YDL086W",334).
component("YOL011W",946).
component("YMR008C",854).
component("YMR006C",853).
component("U105_",26).
component("YBL015W",228).
component("YJL068C",672).
component("YPL072W",1035).
component("YOR124C",982).
component("YNL186W",910).
component("YMR304W",891).
component("YMR223W",881).
component("YKR098C",774).
component("YJL197W",693).
component("YIL156W",653).
component("YFR010W",500).
component("YER151C",487).
component("YER144C",486).
component("YER098W",482).
component("YDR069C",379).
component("YDL122W",341).
component("YBR058C",255).
component("YBL067C",236).
component("YJR019C",703).
component("YOR040W",972).
component("U84_",200).
component("U77_",192).
component("YDR481C",429).
component("YLR377C",828).
component("YDR074W",381).
component("YFR025C",504).
component("YPL179W",1046).
component("YNR032W",936).
component("YML057W",844).
component("YML016C",837).
component("YLR433C",832).
component("YGR123C",557).
component("YER133W",485).
component("YER089C",479).
component("YDR436W",426).
component("YDR075W",382).
component("YDL188C",357).
component("YDL134C",343).
component("YDL047W",325).
component("YDL006W",318).
component("YBR125C",270).
component("YBL056W",235).
component("YPR073C",1080).
component("YHR215W",629).
component("YDL024C",321).
component("YBR093C",264).
component("YBR092C",263).
component("YAR071W",224).
component("YIL053W",637).
component("YER062C",469).
component("YHR046C",603).
component("U9_",215).
component("YPL228W",1054).
component("YMR180C",874).
component("YDL236W",362).
component("YJL155C",688).
component("YPR073C",1081).
component("YOR208W",999).
component("YNL053W",899).
component("YMR036C",858).
component("YIR026C",661).
component("YIL113W",646).
component("YFR028C",505).
component("YER075C",475).
component("YDL230W",360).
component("YBR276C",291).
component("U34_",150).
component("U33_",149).
component("U32_",148).
component("U31_",147).
...
component("U25_",140).
component("U24_",139).
component("YHR044C",602).
component("YHR043C",601).
component("YOL064C",958).
component("YPL268W",1063).
component("YOR360C",1019).
component("YGL248W",540).
component("YKR031C",765).
component("YPL206C",1049).
component("YGL027C",520).
component("YLR286C",811).
component("YJR153W",724).
component("YJL221C",698).
component("YJL216C",696).
component("YIL172C",659).
component("YGR292W",587).
component("YGR287C",586).
component("YBR299W",296).
component("YBR184W",278).
component("YIL162W",656).
component("YPR026W",1073).
component("YDR001C",364).
component("YBR001C",240).
component("YIR019C",660).
component("YIL099W",643).
component("YDL037C",323).
component("YOR190W",995).
component("YLR300W",813).
component("YGR282C",584).
component("YDR261C",405).
component("YDR400W",420).
component("U23_",138).
component("YML035C",840).
component("YJL070C",673).
component("YBR284W",293).
component("U106_",27).
component("U102_",23).
component("YER043C",460).
component("YNL045W",897).
component("YGL037C",521).
component("U43_",159).
component("U42_",158).
component("YMR293C",888).
component("YDR242W",403).
component("YLR308W",820).
component("YLR307W",819).
component("YBR208C",280).
component("YMR281W",887).
component("U53_",168).
component("YIR032C",663).
component("YIR029W",662).
component("YPR062W",1078).
component("YMR120C",868).
component("YLR028C",784).
component("YHR144C",618).
component("YHR144C",619).
component("YGR267C",583).
component("YCL030C",301).
component("YBL033C",230).
component("YBR153W",274).
component("YNL141W",906).
component("YLR245C",808).
component("YML035C",841).
component("YGR204W",573).
component("YBR084W",260).
component("YJL126W",680).
component("U44_",160).
component("YDL100C",338).
component("U87_",203).
component("U40_",156).
component("U39_",154).
component("YBR011C",244).
component("YHR201C",626).
component("YBR111C",265).
component("YBR252W",288).
component("YEL042W",446).
component("YPR080W",1083).
component("YOR187W",994).
component("YOR133W",985).
component("YLR069C",790).
component("YKR084C",771).
component("YKL173W",747).
component("YJL102W",678).
component("YDR385W",418).
component("YBR118W",268).
component("YER005W",454).
component("YLL001W",775).
component("YIL048W",636).
component("YER166W",488).
component("YDR093W",384).
component("YAL026C",218).
component("YBL099W",239).
component("U60_",175).
component("YLR231C",805).
component("U88_",204).
component("YDR538W",438).
component("YLR134W",794).
component("YLR044C",786).
component("YGR087C",553).
component("YDR380W",417).
component("YDL080C",331).
component("U98_",213).
component("YMR250W",883).
component("YKL184W",752).
component("YOR128C",983).
component("YEL021W",443).
component("YNR043W",940).
component("U93_",210).
component("YDR047W",374).
component("U54_",169).
component("YKL211C",758) :- not remove_orf("YKL211C",758).
component("YKR097W",773).
component("YOL052C",951).
component("YNL169C",909).
component("YGR170W",562).
component("YKL060C",735).
component("YNL256W",918).
component("YDR294C",408).
component("YEL046C",447).
component("YNR033W",937).
component("YPR006C",1071).
component("YER065C",470).
component("YKL211C",759) :- not remove_orf("YKL211C",759).
component("YER090W",759) :- not remove_orf("YER090W",759).
component("YER090W",480) :- not remove_orf("YER090W",480).
component("YDR127W",391).
component("YPL281C",1068).
component("YOR393W",1026).
component("YMR323W",893).
component("YHR174W",621).
component("YGR254W",579).
component("YOR202W",997).
component("YPL262W",1060).
component("YGL026C",519) :- not remove_orf("YGL026C",519).
component("YGR155W",560).
component("YLR304C",816).
component("YJL200C",694).
component("YGL009C",514).
component("YNL316C",928).
component("YKL182W",750).
component("YPL212C",1050).
component("YNL292W",926).
component("YGL063W",525).
component("YFL001W",492).
component("YOR278W",1007).
component("YPR002W",1070).
component("YJR016C",702).
component("YCR053W",316).
component("YDR127W",392).
component("YGL148W",530).
component("YIL168W",658).
component("YIL167W",657).
component("YCL064C",306).
component("YER086W",477).
component("YLR359W",827).
component("YAL012W",216).
component("YML004C",835).
component("YFR055W",510).
component("YJL005W",667).
component("YOR176W",992).
component("YJL121C",679).
component("YBR019C",247).
component("YBR019C",248).
component("U59_",173).
component("YDR050C",375).
component("YIL020C",632).
component("YDR007W",365) :- not remove_orf("YDR007W",365).
component("YOR095C",978).
component("YER003C",453).
component("YBR196C",279).
component("YGL001C",512).
component("YPL117C",1039).
component("U14_",65).
component("YOL056W",954).
component("YKL152C",745).
component("YDL021W",319).
component("YMR105C",864).
component("YKL127W",740).
component("YEL058W",450).
component("YPR060C",1077).
component("YHR072W",608).
component("YJL153C",687).
component("YPL097W",1037).
component("YGR185C",567).
component("YGR264C",582).
component("YGR171C",563).
component("YHR011W",595).
component("YDR023W",368).
component("YPL104W",1038).
component("YLL018C",776).
component("YPR081C",1084).
component("YBR121C",269).
component("YHR020W",598).
component("YER087W",478).
component("YNL247W",914).
component("YOL033W",949).
component("YGL245W",539).
component("YOR168W",990).
component("YOL097C",962).
component("YDR268W",406).
component("YPR047W",1076).
component("YLR060W",789).
component("YFL022C",495).
component("YPR033C",1074).
component("YHR019C",596).
component("YCR024C",310).
component("YHR019C",597).
component("YKL194C",755).
component("YIL078W",640).
component("YPL160W",1042).
component("YLR382C",829).
component("YPL040C",1032).
component("YBL076C",238).
component("YNL073W",901).
component("YDR037W",370).
component("YOR335C",1012).
component("YGR094W",555).
component("YLR153C",798).
component("YAL054C",220).
component("YOR317W",1008).
component("YMR246W",882).
component("YIL009W",631).
component("YER015W",456).
component("YOR142W",987).
component("YGR244C",577).
component("YPR035W",1075).
component("YIL145C",651).
component("U89_",205).
component("YOR339C",1013).
component("YMR022W",857).
component("YLR306W",818).
component("YKL210W",757).
component("YGR133W",559).
component("YGL058W",523).
component("YER100W",484).
component("YEL012W",441).
component("YDR177W",397).
component("YDR092W",383).
component("YDR059C",378).
component("YDR054C",376).
component("YDL064W",327).
component("YBR082C",258).
component("YJL101C",677).
component("YOL049W",950).
component("U92_",209).
component("YAR015W",222).
component("YGL234W",537).
component("YER183C",491).
component("U91_",208).
component("U90_",207).
component("YNR057C",942).
component("YDL141W",345).
component("YDL141W",346).
component("YGL234W",538).
component("YDL141W",347).
component("YJR103W",715).
component("YBL039C",232).
component("YGR204W",574).
component("YBR084W",261).
component("YNL220W",912).
component("YOL058W",955).
component("YBR208C",281).
component("YDL141W",348).
component("YHR074W",609).
component("YMR217W",879).
component("YGR061C",551).
component("YPR145W",1089).
component("YGR124W",558).
component("YJR109C",717).
component("YJL130C",683).
component("YGL062W",524).
component("YBR218C",282).
component("YPL231W",1058).
component("YNR016C",934).
component("YKL182W",751).
component("YGR037C",547).
component("YJL087C",674).
component("YPR138C",1088).
component("YPL274W",1065).
component("YPL265W",1061).
component("YPL134C",1040).
component("YPL057C",1033).
component("YPL036W",1031).
component("YOR348C",1017).
component("YOR222W",1003).
component("YOR192C",996).
component("YOR171C",991).
component("YOR130C",984).
component("YOR100C",979).
component("YOR071C",975).
component("YOR011W",971).
component("YOL156W",970).
component("YOL103W",963).
component("YOL020W",948) :- not remove_orf("YOL020W",948).
component("YNR072W",944).
component("YNR056C",941).
component("YNL318C",929).
component("YNL270C",922).
component("YNL268W",921).
component("YNL142W",907).
component("YMR272C",886).
component("YMR202W",876).
component("YMR056C",859).
component("YMR011W",855).
component("YLR348C",824).
component("YLR260W",810).
component("YLR237W",806).
component("YLR138W",795).
component("YLR100C",793).
component("YLR081W",791).
component("YLL061W",780).
component("YLL043W",778).
component("YKR093W",772).
component("YKR053C",767).
component("YKR039W",766) :- not remove_orf("YKR039W",766).
component("YKL217W",761).
component("YKL120W",739).
component("YKL004W",728).
component("YJR158W",725).
component("YJR095W",714).
component("YJR077C",712).
component("YJL219W",697).
component("YJL214W",695).
component("YJL134W",684).
component("YJL129C",681).
component("YIL134W",649).
component("YHR096C",612).
component("YHR094C",611).
component("YHR092C",610).
component("YHL036W",591).
component("YGR121C",556).
component("YGR065C",552).
component("YGR055W",549).
component("YGL186C",532).
component("YGL077C",527).
component("YGL008C",513).
component("YFL055W",499).
component("YFL011W",493).
component("YER060W-A",466).
component("YER060W",465).
component("YER056C",464).
component("YER053C",462).
component("YEL069C",452).
component("YEL063C",451).
component("YEL017C-A",442).
component("YDR536W",437).
component("YDR508C",433).
component("YDR503C",432).
component("YDR497C",430).
component("YDR345C",414).
component("YDR343C",413).
component("YDR342C",412).
component("YDR297W",409).
component("YDR284C",407).
component("YDR046C",373) :- not remove_orf("YDR046C",373).
component("YDL245C",363).
component("YDL210W",358).
component("YCR032W",313).
component("YCR028C",312).
component("YCR024C-A",311).
component("YCL025C",300).
component("YBR298C",295).
component("YBR291C",294).
component("YBR085W",262).
component("YBR069C",257) :- not remove_orf("YBR069C",257).
component("YBR068C",256) :- not remove_orf("YBR068C",256).
component("YBR036C",253).
component("YBR021W",249).
component("YBL042C",233).
component("YBL030C",229).
component("U85_",201).
component("U7_",195).
component("U79_",194).
component("U78_",193).
...
catalyst(6160,889).
catalyst(3870,463).
catalyst(3620,416) :- not remove_reaction(3620,416).
catalyst(2110,508).
catalyst(2190,508).
catalyst(5550,719).
catalyst(5301,137).
...
catalyst(1960,374).
catalyst(3460,169).
catalyst(3600,758) :- not remove_reaction(3600,758).
catalyst(8000,773).
catalyst(3941,951).
catalyst(3942,951).
catalyst(6890,909).
...
catalyst(8020,1071).
catalyst(8020,470).
catalyst(1890,759) :- not remove_reaction(1890,759).
catalyst(3630,759) :- not remove_reaction(3630,759).
catalyst(1890,480) :- not remove_reaction(1890,480).
catalyst(3630,480) :- not remove_reaction(3630,480).
catalyst(3740,391).
catalyst(8231,1068).
catalyst(8232,1068).
catalyst(8231,1026).
...
catalyst(8061,1060).
catalyst(8062,1060).
catalyst(3590,519) :- not remove_reaction(3590,519).
catalyst(10910,519) :- not remove_reaction(10910,519).
catalyst(4570,560).
catalyst(8181,816).
catalyst(8182,816).
catalyst(8181,694).
...
catalyst(8282,375).
catalyst(3840,632).
catalyst(3610,365) :- not remove_reaction(3610,365).
catalyst(7921,978).
catalyst(7922,978).
catalyst(7841,453).
catalyst(7842,453).
...
catalyst(1210,970).
catalyst(1160,963).
catalyst(801,948) :- not remove_reaction(801,948).
catalyst(802,948) :- not remove_reaction(802,948).
catalyst(811,948) :- not remove_reaction(811,948).
catalyst(812,948) :- not remove_reaction(812,948).
catalyst(831,948) :- not remove_reaction(831,948).
catalyst(832,948) :- not remove_reaction(832,948).
catalyst(901,948) :- not remove_reaction(901,948).
catalyst(902,948) :- not remove_reaction(902,948).
catalyst(1180,944).
catalyst(1210,944).
catalyst(700,941).
catalyst(1200,929).
...
catalyst(650,772).
catalyst(6560,767).
catalyst(681,766) :- not remove_reaction(681,766).
catalyst(682,766) :- not remove_reaction(682,766).
catalyst(761,766) :- not remove_reaction(761,766).
catalyst(762,766) :- not remove_reaction(762,766).
catalyst(771,766) :- not remove_reaction(771,766).
catalyst(772,766) :- not remove_reaction(772,766).
catalyst(781,766) :- not remove_reaction(781,766).
catalyst(782,766) :- not remove_reaction(782,766).
catalyst(791,766) :- not remove_reaction(791,766).
catalyst(792,766) :- not remove_reaction(792,766).
catalyst(801,766) :- not remove_reaction(801,766).
catalyst(802,766) :- not remove_reaction(802,766).
catalyst(811,766) :- not remove_reaction(811,766).
catalyst(812,766) :- not remove_reaction(812,766).
catalyst(831,766) :- not remove_reaction(831,766).
catalyst(832,766) :- not remove_reaction(832,766).
catalyst(841,766) :- not remove_reaction(841,766).
catalyst(842,766) :- not remove_reaction(842,766).
catalyst(851,766) :- not remove_reaction(851,766).
catalyst(852,766) :- not remove_reaction(852,766).
catalyst(881,766) :- not remove_reaction(881,766).
catalyst(882,766) :- not remove_reaction(882,766).
catalyst(901,766) :- not remove_reaction(901,766).
catalyst(902,766) :- not remove_reaction(902,766).
catalyst(911,766) :- not remove_reaction(911,766).
catalyst(912,766) :- not remove_reaction(912,766).
catalyst(921,766) :- not remove_reaction(921,766).
catalyst(922,766) :- not remove_reaction(922,766).
catalyst(931,766) :- not remove_reaction(931,766).
catalyst(932,766) :- not remove_reaction(932,766).
catalyst(1191,766) :- not remove_reaction(1191,766).
catalyst(1192,766) :- not remove_reaction(1192,766).
catalyst(390,761).
catalyst(1021,761).
catalyst(1022,761).
catalyst(1521,739).
...
catalyst(6650,409).
catalyst(6690,407).
catalyst(791,373) :- not remove_reaction(791,373).
catalyst(792,373) :- not remove_reaction(792,373).
catalyst(801,373) :- not remove_reaction(801,373).
catalyst(802,373) :- not remove_reaction(802,373).
catalyst(811,373) :- not remove_reaction(811,373).
catalyst(812,373) :- not remove_reaction(812,373).
catalyst(831,373) :- not remove_reaction(831,373).
catalyst(832,373) :- not remove_reaction(832,373).
catalyst(841,373) :- not remove_reaction(841,373).
catalyst(842,373) :- not remove_reaction(842,373).
catalyst(851,373) :- not remove_reaction(851,373).
catalyst(852,373) :- not remove_reaction(852,373).
catalyst(901,373) :- not remove_reaction(901,373).
catalyst(902,373) :- not remove_reaction(902,373).
catalyst(1180,363).
catalyst(1210,363).
catalyst(690,358).
catalyst(730,358).
...
catalyst(1512,294).
catalyst(1590,262).
catalyst(771,257) :- not remove_reaction(771,257).
catalyst(772,257) :- not remove_reaction(772,257).
catalyst(791,257) :- not remove_reaction(791,257).
catalyst(792,257) :- not remove_reaction(792,257).
catalyst(801,257) :- not remove_reaction(801,257).
catalyst(802,257) :- not remove_reaction(802,257).
catalyst(811,257) :- not remove_reaction(811,257).
catalyst(812,257) :- not remove_reaction(812,257).
catalyst(851,257) :- not remove_reaction(851,257).
catalyst(852,257) :- not remove_reaction(852,257).
catalyst(901,257) :- not remove_reaction(901,257).
catalyst(902,257) :- not remove_reaction(902,257).
catalyst(791,256) :- not remove_reaction(791,256).
catalyst(792,256) :- not remove_reaction(792,256).
catalyst(801,256) :- not remove_reaction(801,256).
catalyst(802,256) :- not remove_reaction(802,256).
catalyst(811,256) :- not remove_reaction(811,256).
catalyst(812,256) :- not remove_reaction(812,256).
catalyst(831,256) :- not remove_reaction(831,256).
catalyst(832,256) :- not remove_reaction(832,256).
catalyst(841,256) :- not remove_reaction(841,256).
catalyst(842,256) :- not remove_reaction(842,256).
catalyst(851,256) :- not remove_reaction(851,256).
catalyst(852,256) :- not remove_reaction(852,256).
catalyst(901,256) :- not remove_reaction(901,256).
catalyst(902,256) :- not remove_reaction(902,256).
catalyst(6600,253).
catalyst(620,249).
catalyst(540,233).
catalyst(1590,229).
...
modifiable_enzyme(416).
modifiable_enzyme(758).
modifiable_enzyme(759).
modifiable_enzyme(480).
modifiable_enzyme(519).
modifiable_enzyme(365).
modifiable_enzyme(948).
modifiable_enzyme(766).
modifiable_enzyme(373).
modifiable_enzyme(257).
modifiable_enzyme(256).
