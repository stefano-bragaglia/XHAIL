...
component("YLR056W",564).
component("YGR060W",392).
component("YGL012W",364).
component("YKR009C",546).
component("YOL086C",684).
component("YMR303C",632).
component("YGL256W",386).
component("YDL168W",245).
component("YBR145W",185).
component("YPL231W",746).
component("YBR265W",200).
component("U46_",108).
component("YBR149W",186).
component("YBR149W",187).
component("YGL001C",361).
component("YIL094C",460).
component("U45_",107).
component("YML056C",609).
component("YLR432W",599).
component("YHR216W",452).
component("YAR075W",157).
component("YAR073W",156).
component("YDR127W",270).
component("YJR139C",520).
component("YML075C",611).
component("YLR450W",602).
component("YOL126C",690).
component("YKL085W",528).
component("YDL078C",232).
component("YNL037C",637).
component("YNL009W",635).
component("YLR174W",577).
component("YHR183W",445).
component("YGR256W",411).
component("YNL241C",651).
component("YOL059W",681).
component("YDL022W",225).
component("YCL018W",208).
component("YLR355C",594).
component("YIL074C",457).
component("YER081W",336).
component("YDL174C",249).
component("YML086C",613).
component("YIL155C",469).
component("YGR088W",395).
component("YDR256C",282).
component("YKL026C",526).
component("YIR037W",478).
component("YBR244W",196).
component("YJR078W",514).
component("U58_",117).
component("YJR025C",506).
component("U107_",24).
component("YHR007C",421).
component("YDR402C",296).
component("YGL055W",371).
component("YJR104C",516).
component("YHR008C",422).
component("YOR384W",726).
component("YOR381W",725).
component("YOL152W",692).
component("YLL051C",557).
component("YJL026W",480).
component("YIL066C",456).
component("YGR180C",401).
component("YER070W",333).
component("U37_",101).
component("U36_",100).
component("YDL168W",246).
component("YJR009C",503).
component("YJL052W",482).
component("YGR192C",403).
component("YBR006W",167).
component("YPL276W",754).
component("YPL275W",753).
component("YOR388C",727).
component("YOR374W",723).
component("YER073W",334).
component("YGL154C",378).
component("YBR115C",181).
component("U55_",116).
component("YER069W",331).
component("YOR323C",715).
component("YER178W",345).
component("YBR221C",194).
component("YIL125W",465).
component("U52_",113).
component("YBR166C",189).
component("YGL012W",365).
component("YKL182W",537).
component("YKL216W",545).
component("YDR044W",261).
component("YKR009C",547).
component("YIL160C",470).
component("YGL205W",383).
component("YMR118C",622).
component("YLR164W",575).
component("YLL041C",556).
component("YKL148C",532).
component("YKL141W",530).
component("YJL045W",481).
component("YDR178W",277).
component("YEL047C",316).
component("YDL171C",247).
component("YDL171C",248).
component("YOR375C",724).
component("YDL215C",253).
component("YAL062W",153).
component("U99_",148).
component("U100_",20).
component("YBR035C",173).
component("YKR080W",552).
component("YER023W",323).
component("YOR236W",713).
component("YGR204W",405).
component("YIR034C",477).
component("YLR142W",572).
component("U65_",123).
component("U63_",121).
component("U62_",120).
component("YHR068W",431).
component("YKL150W",533).
component("YIL043C",455).
component("YHR042W",426).
component("YPL171C",739).
component("YHR179W",444).
component("YMR145C",625).
component("YML120C",614).
component("YKL192C",540).
component("YDL085W",234).
component("YGR234W",407).
component("YFR030W",357).
component("YPL017C",729).
component("YFL018C",349).
component("YDR353W",292).
component("YPR167C",768).
component("YJR137C",519).
component("YNL052W",639).
component("YMR256C",631).
component("YLR395C",598).
component("YLR038C",562).
component("YIL111W",462).
component("YHR051W",430).
component("YGL191W",381).
component("YGL187C",380).
component("YDL067C",231).
component("Q0275",19).
component("Q0250",18).
component("YDR072C",266).
component("YPL266W",752).
component("YKR069W",551).
component("YOL096C",685).
component("U47_",109).
component("YER091C",341).
component("YJR073C",512).
component("YGR157W",399).
component("YDR120C",268).
component("YML008C",604).
component("YOR074C",697).
component("YDL033C",227).
component("YOL096C",686).
component("YLR172C",576).
component("YLR058C",565).
component("YDR019C",259).
component("YBR176W",190).
component("YDR408C",298).
component("YMR120C",623).
component("YLR028C",560).
component("YBL013W",158).
component("YJL130C",490).
component("YKL024C",525).
component("YPR074C",763).
component("YBR117C",182).
component("YMR108W",621).
component("YCL009C",207).
component("YNL071W",641).
component("YNR008W",663).
component("YIL160C",471).
component("YNR019W",666).
component("YCR048W",221).
component("U48_",110).
component("YDR232W",279).
component("YPL231W",747).
component("YER061C",330).
component("YDL052C",230).
component("U8_",142).
component("YPL231W",748).
component("YPL028W",730).
component("YLR299W",587).
component("YGL017W",366).
component("YCR005C",213).
component("YML126C",615).
component("YNL104C",644).
component("YDL182W",250).
component("YDL131W",238).
component("YDR307W",288).
component("YLR258W",584).
component("YFR015C",355).
component("YNL029C",636).
component("YIL085C",459).
component("YMR306W",633).
component("YLR342W",593).
component("YGR032W",389).
component("YLR209C",579).
component("U104_",21).
component("YDR354W",293) :- not remove_orf("YDR354W",293).
component("YFR047C",358).
component("YJR133W",518).
component("YLR209C",580).
component("YML022W",606).
component("YDR441C",301).
component("YHR128W",439).
component("YJL167W",495).
component("YJL167W",496).
component("YDR127W",271).
component("YHR190W",447).
component("YLR146C",573).
component("YHR068W",432).
component("YLR303W",589).
component("YGR012W",387).
component("YML082W",612).
component("YJR130C",517).
component("YDR035W",260).
component("YBR249C",197).
component("YLR180W",578).
component("YDR502C",305).
component("YOR274W",714).
component("YBR256C",199).
component("YHR137W",440).
component("YGL202W",382).
component("YLR027C",559).
component("YKL106W",529).
component("YOL140W",691).
component("YLR438W",601).
component("YGR019W",388).
component("YLR089C",568).
component("U64_",122).
component("U61_",119).
component("U51_",112).
component("YJR148W",521).
component("YHR208W",450).
component("YFL030W",351).
component("YOR184W",706).
component("YNR058W",671).
component("YIL116W",464).
component("YGL253W",385).
component("YFR053C",359).
component("YMR013C",619).
component("YMR205C",627).
component("YGR240C",408).
component("YOL016C",675).
component("YFR014C",354).
component("YLR240W",582).
component("YKL203C",542).
component("YJR066W",511).
component("YCR036W",220).
component("YCL040W",210).
component("U15_",53).
component("YPL188W",741).
component("YJR049C",508).
component("YEL041W",314).
component("U96_",146).
component("YKL001C",524).
component("YDR236C",280).
component("YHL032C",419).
component("YDR531W",309).
component("U83_",139).
component("U82_",138).
component("U81_",137).
component("YMR208W",628).
component("YPL203W",742).
component("YOR061W",696).
component("YKL166C",535).
component("YJL164C",494).
component("YIL035C",454).
component("YHR205W",449).
component("YHR102W",438).
component("YGL019W",367).
component("YHR025W",425).
component("YOR347C",720).
component("YAL038W",151).
component("YNR012W",664).
component("YDR009W",258).
component("YDR127W",272).
component("YDR147W",275).
component("YDR300C",287).
component("YCR012W",214).
component("YER069W",332).
component("U19_",80).
component("U18_",72).
component("U17_",64).
component("U76_",132).
component("YER170W",344).
component("YDR226W",278).
component("YKL067W",527).
component("YOL055C",678).
component("YDR454C",302).
component("YJR057W",509).
component("YOL061W",682).
component("YKL181W",536).
component("YHL011C",418).
component("YER099C",342).
component("YBL068W",165).
component("YOR143C",702).
component("YNL256W",654).
component("YLR328W",591).
component("YBR018C",169).
component("YGR202C",404).
component("YLR328W",592).
component("U80_",136).
component("U94_",145).
component("YJR010W",504).
component("YBR029C",172).
component("YCL050C",211).
component("YGL130W",376).
component("YDR530C",308).
component("YPR190C",771).
component("YPR187W",770).
component("YPR110C",765).
component("YPR010C",757).
component("YOR341W",719).
component("YOR340C",718).
component("YOR224C",712).
component("YOR210W",710).
component("YOR207C",708).
component("YOR151C",703).
component("YOR116C",699).
component("YOL005C",673).
component("YNR003C",662).
component("YNL248C",653).
component("YNL151C",648).
component("YNL113W",645).
component("YKL144C",531).
component("YJR063W",510).
component("YJL148W",493).
component("YJL140W",492).
component("YIL021W",453).
component("YHR143W-A",441).
component("YGL070C",374).
component("YFL036W",352).
component("YDR404C",297).
component("YDR156W",276).
component("YDR045C",262).
component("YDL150W",244).
component("YDL140C",240).
component("YBR154C",188).
component("YPR175W",769).
component("YPL167C",738).
component("YOR330C",716).
component("YOL115W",689).
component("YNL299W",660).
component("YNL262W",656).
component("YNL102W",643).
component("YJR043C",507).
component("YJR006W",502).
component("YJL090C",485).
component("YIL139C",467).
component("YEL055C",317).
component("YDR419W",299).
component("YDR121W",269).
component("YDL102W",237).
component("YCR014C",215).
component("YBR278W",202).
component("YBL035C",161).
component("YPR113W",766).
component("YBR243C",195).
component("YPL148C",736).
component("YER026C",324).
component("YGR286C",415).
component("YHR189W",446).
component("YDR058C",265).
component("YDL086W",235).
component("YOL011W",674).
component("YMR008C",617).
component("YMR006C",616).
component("U105_",22).
component("YBL015W",159).
component("YJL068C",483).
component("YOR040W",695).
component("U77_",133).
component("YDR481C",303).
component("YLR377C",596).
component("YPL179W",740).
component("YNR032W",667).
component("YML057W",610).
component("YML016C",605).
component("YLR433C",600).
component("YGR123C",397).
component("YER133W",343).
component("YER089C",339).
component("YDR436W",300).
component("YDR075W",267).
component("YDL188C",251).
component("YDL134C",239).
component("YDL047W",229).
component("YDL006W",223).
component("YBR125C",184).
component("YBL056W",164).
component("YPR073C",761).
component("YHR215W",451).
component("YDL024C",226).
...
component("YMR180C",626).
component("YDL236W",255).
component("YPR073C",762).
component("YOR208W",709).
component("YNL053W",640).
component("YMR036C",620).
component("YIR026C",476).
component("YIL113W",463).
component("YFR028C",356).
component("YER075C",335).
...
component("U25_",92).
component("U24_",91).
component("YHR044C",428).
component("YHR043C",427).
component("YOL064C",683).
component("YOR360C",722).
component("YKR031C",548).
component("YPL206C",743).
component("YGL027C",369).
component("YLR286C",586).
component("YJR153W",522).
component("YJL221C",501).
component("YJL216C",499).
component("YIL172C",474).
component("YGR292W",417).
component("YGR287C",416).
component("YBR299W",206).
component("YBR184W",191).
component("YIR019C",475).
component("YIL099W",461).
component("YDL037C",228).
component("YOR190W",707).
component("YLR300W",588).
component("YGR282C",414).
component("YDR261C",283).
component("YDR400W",295).
component("YML035C",607).
component("YJL070C",484).
component("YBR284W",203).
component("U106_",23).
component("YER043C",325).
component("YNL045W",638).
component("YGL037C",370).
component("YDR242W",281).
component("U53_",114).
component("YPR062W",760).
component("YMR120C",624).
component("YLR028C",561).
component("YHR144C",442).
component("YGR267C",413).
component("YBL033C",160).
component("YNL141W",646).
component("YLR245C",583).
component("YML035C",608).
component("YBR084W",176).
component("YJL126W",488).
component("U44_",106).
component("YDL100C",236).
component("U87_",141).
component("U40_",104).
component("U39_",102).
component("YBR011C",168).
component("YHR201C",448).
component("YBR111C",180).
component("YBR252W",198).
component("YER005W",322).
component("YBL099W",166).
component("YLR231C",581).
component("YDR538W",311).
component("YLR134W",570).
component("YLR044C",563).
component("YGR087C",394).
component("YDR380W",294).
component("YDL080C",233).
component("U98_",147).
component("YMR250W",630).
component("YOR128C",700).
component("YEL021W",313).
component("YNR043W",669).
component("U93_",144).
component("U54_",115).
component("YKL211C",543) :- not remove_orf("YKL211C",543).
component("YKR097W",554).
component("YNL169C",649).
component("YNL256W",655).
component("YDR294C",285).
component("YEL046C",315).
component("YNR033W",668).
component("YKL211C",544) :- not remove_orf("YKL211C",544).
component("YER090W",544) :- not remove_orf("YER090W",544).
component("YER090W",340) :- not remove_orf("YER090W",340).
component("YDR127W",273).
component("YPL281C",755).
component("YOR393W",728).
component("YMR323W",634).
component("YHR174W",443).
component("YGR254W",410).
component("YPL262W",750).
component("YGL026C",368) :- not remove_orf("YGL026C",368).
component("YGR155W",398).
component("YLR304C",590).
component("YJL200C",497).
...
component("YPR002W",756).
component("YJR016C",505).
component("YCR053W",222).
component("YDR127W",274).
component("YGL148W",377).
component("YIL168W",473).
component("YIL167W",472).
component("YCL064C",212).
component("YER086W",337).
component("YLR359W",595).
component("YAL012W",150).
component("YML004C",603).
component("YFR055W",360).
component("YJL005W",479).
component("YJL121C",487).
component("YBR019C",170).
component("YDR050C",264).
component("YDR007W",257) :- not remove_orf("YDR007W",257).
component("YOR095C",698).
component("YER003C",321).
component("YBR196C",192).
component("YGL001C",362).
component("YPL117C",734).
component("U14_",45).
component("YOL056W",679).
component("YKL152C",534).
component("YDL021W",224).
component("YEL058W",318).
component("YPR060C",759).
component("YHR072W",433).
component("YPL097W",732).
component("YGR185C",402).
component("YGR264C",412).
component("YGR171C",400).
component("YPL104W",733).
component("YLL018C",555).
component("YPR081C",764).
component("YBR121C",183).
component("YHR020W",424).
component("YER087W",338).
component("YNL247W",652).
component("YOR168W",704).
component("YOL097C",687).
component("YDR268W",284).
component("YPR047W",758).
component("YLR060W",566).
component("YFL022C",350).
component("YCR024C",216).
component("YHR019C",423).
component("YKL194C",541).
component("YIL078W",458).
component("YPL160W",737).
component("YLR382C",597).
component("YNL073W",642).
component("YOR335C",717).
component("YLR153C",574).
component("YAL054C",152).
component("YGR244C",409).
component("YIL145C",468).
component("YJL101C",486).
component("YOL049W",677).
component("YAR015W",154).
component("YER183C",346).
component("U90_",143).
component("YNR057C",670).
component("YDL141W",241).
component("YGL234W",384).
component("YDL141W",242).
component("YJR103W",515).
component("YBL039C",162).
component("YGR204W",406).
component("YBR084W",177).
component("YNL220W",650).
component("YOL058W",680).
component("YDL141W",243).
component("YHR074W",434).
component("YMR217W",629).
component("YGL062W",372).
component("YBR218C",193).
component("YPL231W",749).
component("YNR016C",665).
component("YKL182W",539).
component("YGR037C",390).
component("YPR138C",767).
component("YPL265W",751).
component("YPL134C",735).
component("YPL036W",731).
component("YOR348C",721).
component("YOR222W",711).
component("YOR171C",705).
component("YOR130C",701).
component("YOR011W",694).
component("YOL156W",693).
component("YOL103W",688).
component("YOL020W",676) :- not remove_orf("YOL020W",676).
component("YNR072W",672).
component("YNL270C",657).
component("YNL142W",647).
component("YMR011W",618).
component("YLR260W",585).
component("YLR138W",571).
component("YLR100C",569).
component("YLR081W",567).
component("YLL061W",558).
component("YKR093W",553).
component("YKR053C",550).
component("YKR039W",549) :- not remove_orf("YKR039W",549).
component("YJR158W",523).
component("YJR077C",513).
component("YJL219W",500).
component("YJL214W",498).
component("YJL134W",491).
component("YJL129C",489).
component("YIL134W",466).
component("YHR096C",437).
component("YHR094C",436).
component("YHR092C",435).
component("YHL036W",420).
component("YGR121C",396).
component("YGR065C",393).
component("YGR055W",391).
component("YGL186C",379).
component("YGL077C",375).
component("YGL008C",363).
component("YFL055W",353).
component("YFL011W",348).
component("YER060W-A",329).
component("YER060W",328).
component("YER056C",327).
component("YER053C",326).
component("YEL069C",320).
component("YEL063C",319).
component("YEL017C-A",312).
component("YDR536W",310).
component("YDR508C",307).
component("YDR503C",306).
component("YDR497C",304).
component("YDR345C",291).
component("YDR343C",290).
component("YDR342C",289).
component("YDR297W",286).
component("YDR046C",263) :- not remove_orf("YDR046C",263).
component("YDL245C",256).
component("YDL210W",252).
component("YCR032W",219).
component("YCR028C",218).
component("YCR024C-A",217).
component("YCL025C",209).
component("YBR298C",205).
component("YBR291C",204).
component("YBR069C",175) :- not remove_orf("YBR069C",175).
component("YBR068C",174) :- not remove_orf("YBR068C",174).
component("YBR021W",171).
...
catalyst(2300,144).
catalyst(3460,115).
catalyst(3600,543) :- not remove_reaction(3600,543).
catalyst(8000,554).
catalyst(6890,649).
catalyst(2570,655).
catalyst(8781,285).
...
catalyst(4560,315).
catalyst(2550,668).
catalyst(1890,544) :- not remove_reaction(1890,544).
catalyst(3630,544) :- not remove_reaction(3630,544).
catalyst(1890,340) :- not remove_reaction(1890,340).
catalyst(3630,340) :- not remove_reaction(3630,340).
catalyst(3740,273).
catalyst(8231,755).
catalyst(8232,755).
catalyst(8231,728).
...
catalyst(8061,750).
catalyst(8062,750).
catalyst(3590,368) :- not remove_reaction(3590,368).
catalyst(10910,368) :- not remove_reaction(10910,368).
catalyst(4570,398).
catalyst(8181,590).
catalyst(8182,590).
catalyst(8181,497).
...
catalyst(851,549) :- not remove_reaction(851,549).
catalyst(852,549) :- not remove_reaction(852,549).
...
catalyst(921,549) :- not remove_reaction(921,549).
catalyst(922,549) :- not remove_reaction(922,549).
catalyst(931,549) :- not remove_reaction(931,549).
catalyst(932,549) :- not remove_reaction(932,549).
...
catalyst(851,263) :- not remove_reaction(851,263).
catalyst(852,263) :- not remove_reaction(852,263).
...
catalyst(1511,204).
catalyst(1512,204).
catalyst(771,175) :- not remove_reaction(771,175).
catalyst(772,175) :- not remove_reaction(772,175).
...
catalyst(851,175) :- not remove_reaction(851,175).
catalyst(852,175) :- not remove_reaction(852,175).
...
catalyst(831,174) :- not remove_reaction(831,174).
catalyst(832,174) :- not remove_reaction(832,174).
catalyst(841,174) :- not remove_reaction(841,174).
catalyst(842,174) :- not remove_reaction(842,174).
catalyst(851,174) :- not remove_reaction(851,174).
catalyst(852,174) :- not remove_reaction(852,174).
