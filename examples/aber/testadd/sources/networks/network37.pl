...
component("YLR056W",238).
component("YKR009C",226).
component("YOL086C",290).
component("YMR303C",265).
component("YGL256W",164).
...
component("YIL094C",190).
component("U45_",46).
component("YDR127W",105).
component("YOL126C",294).
component("YKL085W",218).
component("YDL078C",90).
component("YNL037C",268).
component("YCL018W",81).
component("YLR355C",254).
component("YDL174C",97).
component("YML086C",259).
component("YGR088W",168).
component("YDR256C",114).
component("YJR078W",212).
component("YJR025C",208).
component("U107_",22).
component("YER070W",140).
component("U36_",43).
component("YPL276W",326).
component("YPL275W",325).
component("YOR388C",311).
component("YOR323C",305).
component("YIL125W",192).
component("U52_",49).
component("YBR166C",73).
component("YKL216W",225).
component("YKR009C",227).
component("YIL160C",195).
component("YGL205W",161).
component("YKR080W",231).
component("YER023W",135).
component("YGR204W",172).
component("YLR142W",243).
component("U62_",51).
component("YHR068W",181).
component("YKL150W",221).
component("YIL043C",188).
component("YPL171C",319).
component("YHR179W",186).
component("YDR353W",118).
component("YNL052W",269).
component("YMR256C",264).
component("YLR395C",256).
component("YLR038C",236).
component("YIL111W",191).
component("YHR051W",180).
component("YGL191W",159).
component("YGL187C",158).
component("YDL067C",89).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",324).
component("YKR069W",230).
component("YDL033C",88).
component("YLR172C",245).
component("YLR058C",239).
component("YDR019C",100).
component("YBR176W",74).
component("YDR408C",123).
component("YMR120C",263).
component("YLR028C",234).
component("YBL013W",58).
component("YJL130C",202).
component("YKL024C",216).
component("YPR074C",330).
component("YBR117C",69).
component("YPL231W",321).
component("YPL231W",322).
component("YLR299W",251).
component("YML126C",260).
component("YDL182W",98).
component("YDL131W",93).
component("YLR258W",249).
component("YFR015C",145).
component("YNL029C",267).
component("YIL085C",189).
component("YLR209C",246).
component("U104_",20).
component("YDR354W",119) :- not remove_orf("YDR354W",119).
component("YFR047C",146).
component("YLR209C",247).
component("YML022W",257).
component("YDR441C",125).
component("YJL167W",206).
component("YDR127W",106).
component("YLR303W",253).
component("YJR130C",214).
component("YDR035W",101).
component("YBR249C",76).
component("YOR274W",304).
component("YHR137W",182).
component("YGL202W",160).
component("YLR027C",233).
component("YKL106W",219).
component("YLR089C",240).
component("YJR148W",215).
component("YNR058W",284).
component("YGL253W",163).
component("YFR053C",147).
component("YCR036W",86).
component("U96_",54).
component("YNR012W",282).
...
component("YDR454C",126).
component("YOL061W",289).
component("YKL181W",222).
component("YHL011C",176).
component("YER099C",142).
component("YBL068W",62).
component("YNL256W",276).
component("YBR018C",65).
component("YGL130W",155).
component("YPR190C",336).
component("YPR187W",335).
component("YPR110C",331).
component("YPR010C",328).
component("YOR341W",309).
component("YOR340C",308).
component("YOR224C",303).
component("YOR210W",302).
component("YOR207C",301).
component("YOR151C",298).
component("YOR116C",297).
component("YOL005C",285).
component("YNR003C",281).
component("YNL248C",275).
component("YNL151C",274).
component("YNL113W",271).
component("YKL144C",220).
component("YJR063W",210).
component("YJL148W",205).
component("YJL140W",204).
component("YIL021W",187).
component("YHR143W-A",183).
component("YGL070C",154).
component("YFL036W",143).
component("YDR404C",122).
component("YDR156W",111).
component("YDR045C",102).
component("YDL150W",95).
component("YDL140C",94).
component("YBR154C",72).
component("YPR175W",334).
component("YPL167C",318).
component("YOR330C",306).
component("YOL115W",293).
component("YNL299W",279).
component("YNL262W",277).
component("YNL102W",270).
component("YJR043C",209).
component("YJR006W",207).
component("YJL090C",199).
component("YIL139C",193).
component("YEL055C",132).
component("YDR419W",124).
component("YDR121W",104).
component("YDL102W",92).
component("YCR014C",84).
component("YBR278W",78).
component("YBL035C",60).
component("YPR113W",332).
component("YPL148C",317).
component("YOL011W",286).
component("YMR008C",262).
component("YMR006C",261).
component("U105_",21).
component("YBL015W",59).
component("YLR377C",255).
component("U30_",42).
component("U29_",41).
component("U24_",40).
component("YHR044C",179).
component("YHR043C",178).
component("YOR360C",310).
component("YGL027C",152).
component("YOR190W",300).
component("YLR300W",252).
component("YGR282C",175).
component("YDR261C",115).
component("YDR400W",121).
component("YML035C",258).
component("YJL070C",198).
component("YBR284W",79).
component("YDR242W",113).
component("U53_",50).
component("YLR028C",235).
component("YHR144C",184).
component("YNL141W",272).
component("YJL126W",200).
component("U39_",44).
component("YBR011C",64).
component("YBR111C",68).
component("YBR252W",77).
component("YER005W",134).
component("YBL099W",63).
component("YLR231C",248).
component("YLR134W",242).
component("YLR044C",237).
component("YGR087C",167).
component("YDR380W",120).
component("YDL080C",91).
component("U98_",55).
component("YKL211C",223) :- not remove_orf("YKL211C",223).
component("YKL211C",224) :- not remove_orf("YKL211C",224).
component("YER090W",224) :- not remove_orf("YER090W",224).
component("YER090W",141) :- not remove_orf("YER090W",141).
component("YDR127W",108).
component("YPL281C",327).
component("YOR393W",312).
component("YMR323W",266).
component("YHR174W",185).
component("YGR254W",173).
component("YGL026C",151) :- not remove_orf("YGL026C",151).
component("YNL316C",280).
component("YCR053W",87).
component("YDR127W",109).
component("YGL148W",156).
component("YIL168W",197).
component("YIL167W",196).
component("YCL064C",83).
component("YAL012W",56).
component("YDR007W",99) :- not remove_orf("YDR007W",99).
component("YOR095C",296).
component("YGL001C",149).
component("YPL117C",316).
component("YPR060C",329).
component("YPL097W",314).
component("YGR185C",171).
component("YGR264C",174).
component("YGR171C",170).
component("YPL104W",315).
component("YLL018C",232).
component("YOL097C",291).
component("YDR268W",116).
component("YOR335C",307).
component("YLR153C",244).
component("YAL054C",57).
component("YIL145C",194).
component("U90_",53).
component("YNR057C",283).
component("YGL234W",162).
component("YJR103W",213).
component("YBL039C",61).
component("YGL062W",153).
component("YBR218C",75).
component("YPR138C",333).
component("YPL265W",323).
component("YPL036W",313).
component("YOR171C",299).
component("YOR011W",295).
component("YOL103W",292).
component("YOL020W",287) :- not remove_orf("YOL020W",287).
component("YNL270C",278).
component("YNL142W",273).
component("YLR260W",250).
component("YLR100C",241).
component("YKR053C",229).
component("YKR039W",228) :- not remove_orf("YKR039W",228).
component("YJR077C",211).
component("YJL134W",203).
component("YJL129C",201).
component("YHL036W",177).
component("YGR121C",169).
component("YGR065C",166).
component("YGR055W",165).
component("YGL186C",157).
component("YGL008C",150).
component("YFL055W",144).
component("YER060W-A",139).
component("YER060W",138).
component("YER056C",137).
component("YER053C",136).
component("YEL063C",133).
component("YEL017C-A",131).
component("YDR536W",130).
component("YDR508C",129).
component("YDR503C",128).
component("YDR497C",127).
component("YDR297W",117).
...
catalyst(2121,20).
catalyst(2122,20).
catalyst(3620,119) :- not remove_reaction(3620,119).
catalyst(2190,146).
catalyst(5791,247).
catalyst(5792,247).
catalyst(5801,247).
...
catalyst(8812,91).
catalyst(2250,55).
catalyst(3600,223) :- not remove_reaction(3600,223).
...
catalyst(931,228) :- not remove_reaction(931,228).
catalyst(932,228) :- not remove_reaction(932,228).
