...
component("YNL280C",467).
component("YLR056W",401).
component("YGL012W",254).
component("YKR009C",387).
component("YOL086C",485).
component("YMR303C",445).
component("YGL256W",274).
component("YDL168W",177).
component("YBR145W",135).
component("YPL231W",531).
component("U46_",78).
component("YBR149W",136).
component("YBR149W",137).
component("YGL001C",251).
component("YIL094C",326).
component("U45_",77).
component("YML056C",431).
component("YLR432W",428).
component("YHR216W",320).
component("YAR075W",113).
component("YAR073W",112).
component("YDR127W",190).
component("YOL126C",490).
component("YKL085W",375).
component("YDL078C",167).
component("YNL037C",450).
component("YNL009W",448).
component("YLR174W",409).
component("YCL018W",152).
component("YLR355C",424).
component("YDL174C",180).
component("YML086C",432).
component("YGR088W",282).
component("YDR256C",200).
component("YJR078W",365).
component("YJR025C",358).
component("U107_",23).
component("YJR104C",367).
component("YHR008C",300).
component("YJL026W",340).
component("YIL066C",324).
component("YGR180C",285).
component("YER070W",231).
component("U36_",71).
component("YDL168W",178).
component("YBR006W",121).
component("YPL276W",539).
component("YPL275W",538).
component("YOR388C",516).
component("YOR374W",515).
component("YER073W",232).
component("YGL154C",266).
component("U55_",84).
component("YER069W",230).
component("YOR323C",508).
component("YER178W",238).
component("YBR221C",143).
component("YIL125W",330).
component("U52_",82).
component("YBR166C",139).
component("YGL012W",255).
component("YKL216W",386).
component("YKR009C",388).
component("YIL160C",334).
component("YGL205W",271).
component("YDL171C",179).
component("U99_",107).
component("U100_",20).
component("YKR080W",393).
component("YER023W",224).
component("YOR236W",506).
component("YGR204W",287).
component("YLR142W",406).
component("U65_",89).
component("U62_",87).
component("YHR068W",308).
component("YKL150W",378).
component("YIL043C",323).
component("YPL171C",526).
component("YHR179W",316).
component("YMR145C",440).
component("YML120C",433).
component("YKL192C",383).
component("YDL085W",169).
component("YGR234W",289).
component("YFR030W",248).
component("YPL017C",518).
component("YFL018C",241).
component("YDR353W",204).
component("YPR167C",551).
component("YJR137C",369).
component("YNL052W",451).
component("YMR256C",444).
component("YLR395C",427).
component("YLR038C",399).
component("YIL111W",327).
component("YHR051W",307).
component("YGL191W",269).
component("YGL187C",268).
component("YDL067C",166).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",537).
component("YKR069W",392).
component("YOL096C",486).
component("U47_",79).
component("YJR073C",363).
component("YDL033C",165).
component("YLR172C",408).
component("YLR058C",402).
component("YDR019C",185).
component("YBR176W",140).
component("YDR408C",209).
component("YMR120C",438).
component("YLR028C",397).
component("YBL013W",114).
component("YJL130C",347).
component("YKL024C",373).
component("YPR074C",547).
component("YBR117C",134).
component("YCL009C",151).
component("YNL071W",453).
component("YIL160C",335).
component("U48_",80).
component("YPL231W",532).
component("YPL231W",533).
component("YPL028W",519).
component("YLR299W",417).
component("YGL017W",256).
component("YML126C",434).
component("YNL104C",455).
component("YDL182W",181).
component("YDL131W",173).
component("YLR258W",414).
component("YFR015C",246).
component("YNL029C",449).
component("YIL085C",325).
component("YMR306W",446).
component("YLR342W",423).
component("YGR032W",277).
component("YLR209C",410).
component("U104_",21).
component("YDR354W",205) :- not remove_orf("YDR354W",205).
component("YFR047C",249).
component("YLR209C",411).
component("YML022W",429).
component("YDR441C",211).
component("YJL167W",352).
component("YDR127W",191).
component("YHR068W",309).
component("YLR303W",419).
component("YGR012W",275).
component("YJR130C",368).
component("YDR035W",186).
component("YBR249C",144).
component("YOR274W",507).
component("YHR137W",312).
component("YGL202W",270).
component("YLR027C",396).
component("YKL106W",376).
component("YOL140W",491).
component("YGR019W",276).
component("YLR089C",403).
component("U64_",88).
component("U61_",86).
component("YJR148W",370).
component("YFL030W",242).
component("YNR058W",476).
component("YIL116W",329).
component("YGL253W",273).
component("YFR053C",250).
component("YMR205C",441).
component("YGR240C",290).
component("YOL016C",479).
component("YFR014C",245).
component("YCR036W",161).
component("YCL040W",154).
component("U15_",40).
component("YPL188W",527).
component("YJR049C",360).
component("YEL041W",219).
component("U96_",105).
component("YKL001C",372).
component("YDR236C",198).
component("YHL032C",298).
component("U83_",101).
component("YMR208W",442).
component("YPL203W",528).
component("YOR061W",493).
component("YKL166C",380).
component("YJL164C",351).
component("YIL035C",322).
component("YHR205W",318).
component("YHR102W",311).
component("YGL019W",257).
component("YHR025W",303).
component("YOR347C",513).
component("YAL038W",110).
component("YNR012W",472).
component("YDR127W",192).
component("YDR147W",195).
component("YCR012W",156).
component("U76_",98).
component("YER170W",237).
component("YDR226W",197).
component("YKL067W",374).
component("YOL055C",482).
component("YDR454C",212).
component("YJR057W",361).
component("YOL061W",484).
component("YKL181W",381).
component("YHL011C",297).
component("YER099C",236).
component("YBL068W",119).
component("YOR143C",497).
component("YNL256W",464).
component("YLR328W",421).
component("YBR018C",123).
component("YLR328W",422).
component("U94_",104).
component("YBR029C",126).
component("YGL130W",264).
component("YDR530C",216).
component("YPR190C",554).
component("YPR187W",553).
component("YPR110C",548).
component("YPR010C",542).
component("YOR341W",512).
component("YOR340C",511).
component("YOR224C",505).
component("YOR210W",504).
component("YOR207C",502).
component("YOR151C",498).
component("YOR116C",495).
component("YOL005C",477).
component("YNR003C",471).
component("YNL248C",463).
component("YNL151C",459).
component("YNL113W",456).
component("YKL144C",377).
component("YJR063W",362).
component("YJL148W",350).
component("YJL140W",349).
component("YIL021W",321).
component("YHR143W-A",313).
component("YGL070C",262).
component("YFL036W",243).
component("YDR404C",208).
component("YDR156W",196).
component("YDR045C",187).
component("YDL150W",176).
component("YDL140C",174).
component("YBR154C",138).
component("YPR175W",552).
component("YPL167C",525).
component("YOR330C",509).
component("YOL115W",489).
component("YNL299W",469).
component("YNL262W",465).
component("YNL102W",454).
component("YJR043C",359).
component("YJR006W",356).
component("YJL090C",343).
component("YIL139C",332).
component("YEL055C",221).
component("YDR419W",210).
component("YDR121W",189).
component("YDL102W",172).
component("YCR014C",157).
component("YBR278W",147).
component("YBL035C",117).
component("YPR113W",549).
component("YPL148C",524).
component("YGR286C",294).
component("YHR189W",317).
component("YDL086W",170).
component("YOL011W",478).
component("YMR008C",436).
component("YMR006C",435).
component("U105_",22).
component("YBL015W",115).
component("YJL068C",341).
component("U77_",99).
component("YLR377C",426).
component("YPR073C",545).
component("YHR215W",319).
component("YDL024C",164).
component("YBR093C",132).
component("YBR092C",131).
component("YHR046C",306).
component("U9_",108).
component("YDL236W",183).
component("YPR073C",546).
component("YOR208W",503).
component("YNL053W",452).
component("YMR036C",437).
component("YIR026C",339).
component("YIL113W",328).
component("YFR028C",247).
component("YER075C",233).
component("YDL230W",182).
...
component("U25_",65).
component("U24_",64).
component("YHR044C",305).
component("YHR043C",304).
component("YOR360C",514).
component("YKR031C",389).
component("YPL206C",529).
component("YGL027C",259).
component("YLR286C",416).
component("YJR153W",371).
component("YJL221C",355).
component("YJL216C",354).
component("YIL172C",338).
component("YGR292W",296).
component("YGR287C",295).
component("YBR299W",150).
component("YOR190W",501).
component("YLR300W",418).
component("YGR282C",293).
component("YDR261C",201).
component("YDR400W",207).
component("YML035C",430).
component("YJL070C",342).
component("YBR284W",148).
component("YER043C",225).
component("YDR242W",199).
component("U53_",83).
component("YPR062W",544).
component("YMR120C",439).
component("YLR028C",398).
component("YHR144C",314).
component("YBL033C",116).
component("YNL141W",457).
component("YLR245C",413).
component("YBR084W",129).
component("YJL126W",345).
component("U44_",76).
component("YDL100C",171).
component("U40_",74).
component("U39_",72).
component("YBR011C",122).
component("YBR111C",133).
component("YBR252W",145).
component("YER005W",223).
component("YBL099W",120).
component("YLR231C",412).
component("YLR134W",405).
component("YLR044C",400).
component("YGR087C",281).
component("YDR380W",206).
component("YDL080C",168).
component("U98_",106).
component("YMR250W",443).
component("YOR128C",496).
component("U93_",103).
component("YKL211C",384) :- not remove_orf("YKL211C",384).
component("YKR097W",394).
component("YNL169C",460).
component("YEL046C",220).
component("YNR033W",474).
component("YKL211C",385) :- not remove_orf("YKL211C",385).
component("YER090W",385) :- not remove_orf("YER090W",385).
component("YER090W",235) :- not remove_orf("YER090W",235).
component("YDR127W",193).
component("YPL281C",540).
component("YOR393W",517).
component("YMR323W",447).
component("YHR174W",315).
component("YGR254W",291).
component("YPL262W",535).
component("YGL026C",258) :- not remove_orf("YGL026C",258).
component("YLR304C",420).
component("YJL200C",353).
component("YNL316C",470).
component("YPL212C",530).
component("YNL292W",468).
component("YGL063W",261).
component("YFL001W",240).
component("YPR002W",541).
component("YJR016C",357).
component("YCR053W",162).
component("YDR127W",194).
component("YGL148W",265).
component("YIL168W",337).
component("YIL167W",336).
component("YCL064C",155).
component("YLR359W",425).
component("YAL012W",109).
component("YBR019C",124).
component("YDR007W",184) :- not remove_orf("YDR007W",184).
component("YOR095C",494).
component("YBR196C",141).
component("YGL001C",252).
component("YPL117C",523).
component("U14_",34).
component("YOL056W",483).
component("YKL152C",379).
component("YDL021W",163).
component("YPR060C",543).
component("YPL097W",521).
component("YGR185C",286).
component("YGR264C",292).
component("YGR171C",284).
component("YPL104W",522).
component("YLL018C",395).
component("YHR020W",302).
component("YER087W",234).
component("YNL247W",462).
component("YOR168W",499).
component("YOL097C",487).
component("YDR268W",202).
component("YCR024C",158).
component("YHR019C",301).
component("YOR335C",510).
component("YLR153C",407).
component("YAL054C",111).
component("YIL145C",333).
component("YJL101C",344).
component("YOL049W",481).
component("YER183C",239).
component("U90_",102).
component("YNR057C",475).
component("YGL234W",272).
component("YJR103W",366).
component("YBL039C",118).
component("YGR204W",288).
component("YBR084W",130).
component("YNL220W",461).
component("YDL141W",175).
component("YHR074W",310).
component("YGL062W",260).
component("YBR218C",142).
component("YPL231W",534).
component("YNR016C",473).
component("YKL182W",382).
component("YGR037C",278).
component("YPR138C",550).
component("YPL265W",536).
component("YPL036W",520).
component("YOR171C",500).
component("YOR011W",492).
component("YOL103W",488).
component("YOL020W",480) :- not remove_orf("YOL020W",480).
component("YNL270C",466).
component("YNL142W",458).
component("YLR260W",415).
component("YLR100C",404).
component("YKR053C",391).
component("YKR039W",390) :- not remove_orf("YKR039W",390).
component("YJR077C",364).
component("YJL134W",348).
component("YJL129C",346).
component("YIL134W",331).
component("YHL036W",299).
component("YGR121C",283).
component("YGR065C",280).
component("YGR055W",279).
component("YGL186C",267).
component("YGL077C",263).
component("YGL008C",253).
component("YFL055W",244).
component("YER060W-A",229).
component("YER060W",228).
component("YER056C",227).
component("YER053C",226).
component("YEL063C",222).
component("YEL017C-A",218).
component("YDR536W",217).
component("YDR508C",215).
component("YDR503C",214).
component("YDR497C",213).
component("YDR297W",203).
component("YDR046C",188) :- not remove_orf("YDR046C",188).
component("YCR032W",160).
component("YCR024C-A",159).
component("YCL025C",153).
component("YBR298C",149).
component("YBR069C",128) :- not remove_orf("YBR069C",128).
component("YBR068C",127) :- not remove_orf("YBR068C",127).
component("YBR021W",125).
component("U7_",100).
component("U75_",97).
component("U74_",96).
component("U73_",95).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,205) :- not remove_reaction(3620,205).
catalyst(2110,249).
catalyst(2190,249).
catalyst(5791,411).
catalyst(5792,411).
...
catalyst(6112,496).
catalyst(2300,103).
catalyst(3600,384) :- not remove_reaction(3600,384).
catalyst(8000,394).
catalyst(6890,460).
catalyst(4560,220).
catalyst(2550,474).
catalyst(1890,385) :- not remove_reaction(1890,385).
catalyst(3630,385) :- not remove_reaction(3630,385).
catalyst(1890,235) :- not remove_reaction(1890,235).
catalyst(3630,235) :- not remove_reaction(3630,235).
catalyst(3740,193).
catalyst(8231,540).
catalyst(8232,540).
catalyst(8231,517).
...
catalyst(8051,535).
catalyst(8052,535).
catalyst(3590,258) :- not remove_reaction(3590,258).
catalyst(10910,258) :- not remove_reaction(10910,258).
catalyst(8181,420).
catalyst(8182,420).
catalyst(8181,353).
catalyst(8182,353).
...
catalyst(6330,404).
catalyst(6560,391).
catalyst(771,390) :- not remove_reaction(771,390).
catalyst(772,390) :- not remove_reaction(772,390).
catalyst(781,390) :- not remove_reaction(781,390).
catalyst(782,390) :- not remove_reaction(782,390).
catalyst(801,390) :- not remove_reaction(801,390).
catalyst(802,390) :- not remove_reaction(802,390).
catalyst(811,390) :- not remove_reaction(811,390).
catalyst(812,390) :- not remove_reaction(812,390).
catalyst(831,390) :- not remove_reaction(831,390).
catalyst(832,390) :- not remove_reaction(832,390).
catalyst(841,390) :- not remove_reaction(841,390).
catalyst(842,390) :- not remove_reaction(842,390).
catalyst(851,390) :- not remove_reaction(851,390).
catalyst(852,390) :- not remove_reaction(852,390).
catalyst(881,390) :- not remove_reaction(881,390).
catalyst(882,390) :- not remove_reaction(882,390).
catalyst(901,390) :- not remove_reaction(901,390).
catalyst(902,390) :- not remove_reaction(902,390).
catalyst(921,390) :- not remove_reaction(921,390).
catalyst(922,390) :- not remove_reaction(922,390).
catalyst(931,390) :- not remove_reaction(931,390).
catalyst(932,390) :- not remove_reaction(932,390).
catalyst(1191,390) :- not remove_reaction(1191,390).
catalyst(1192,390) :- not remove_reaction(1192,390).
catalyst(1581,364).
catalyst(1582,364).
catalyst(6560,348).
catalyst(361,346).
...
catalyst(1121,149).
catalyst(1122,149).
catalyst(771,128) :- not remove_reaction(771,128).
catalyst(772,128) :- not remove_reaction(772,128).
...
catalyst(831,127) :- not remove_reaction(831,127).
catalyst(832,127) :- not remove_reaction(832,127).
catalyst(841,127) :- not remove_reaction(841,127).
catalyst(842,127) :- not remove_reaction(842,127).
catalyst(851,127) :- not remove_reaction(851,127).
catalyst(852,127) :- not remove_reaction(852,127).
catalyst(901,127) :- not remove_reaction(901,127).
catalyst(902,127) :- not remove_reaction(902,127).
catalyst(620,125).
catalyst(6960,100).
catalyst(2920,97).
catalyst(2920,96).
