...
component("YNL280C",664).
component("YLR056W",569).
component("YGR060W",397).
component("YGL012W",369).
component("YKR009C",551).
component("YOL086C",690).
component("YMR303C",638).
component("YGL256W",391).
component("YDL168W",249).
component("YBR145W",188).
component("YPL231W",752).
component("YBR265W",203).
component("U46_",110).
component("YBR149W",189).
component("YBR149W",190).
component("YGL001C",366).
component("YIL094C",465).
component("U45_",109).
component("YML056C",615).
component("YLR432W",605).
component("YHR216W",457).
component("YAR075W",160).
component("YAR073W",159).
component("YDR127W",274).
component("YJR139C",525).
component("YML075C",617).
component("YLR450W",608).
component("YOL126C",696).
component("YKL085W",533).
component("YDL078C",235).
component("YNL037C",643).
component("YNL009W",641).
component("YLR174W",582).
component("YHR183W",450).
component("YGR256W",416).
component("YNL241C",657).
component("YOL059W",687).
component("YDL022W",228).
component("YCL018W",211).
component("YLR355C",600).
component("YIL074C",462).
component("YER081W",341).
component("YDL174C",253).
component("YML086C",619).
component("YIL155C",474).
component("YGR088W",400).
component("YDR256C",287).
component("YKL026C",531).
component("YIR037W",483).
component("YBR244W",199).
component("YJR078W",519).
component("U58_",119).
component("YJR025C",511).
component("U107_",24).
component("YHR007C",426).
component("YDR402C",301).
component("YGL055W",376).
component("YJR104C",521).
component("YHR008C",427).
component("YOR384W",732).
component("YOR381W",731).
component("YOL152W",698).
component("YLL051C",562).
component("YJL026W",485).
component("YIL066C",461).
component("YGR180C",406).
component("YER070W",338).
component("U37_",103).
component("U36_",102).
component("YDL168W",250).
component("YDR158W",281).
component("YJR009C",508).
component("YJL052W",487).
component("YGR192C",408).
component("YBR006W",170).
component("YPL276W",760).
component("YPL275W",759).
component("YOR388C",733).
component("YOR374W",729).
component("YER073W",339).
component("YGL154C",383).
component("YBR115C",184).
component("U55_",118).
component("YER069W",336).
component("YOR323C",721).
component("YER178W",350).
component("YBR221C",197).
component("YIL125W",470).
component("U52_",115).
component("YBR166C",192).
component("YGL012W",370).
component("YKL182W",542).
component("YKL216W",550).
component("YDR044W",265).
component("YKR009C",552).
component("YIL160C",475).
component("YGL205W",388).
component("YMR118C",628).
component("YLR164W",580).
component("YLL041C",561).
component("YKL148C",537).
component("YKL141W",535).
component("YJL045W",486).
component("YDR178W",282).
component("YEL047C",321).
component("YDL171C",251).
component("YDL171C",252).
component("YOR375C",730).
component("YDL215C",257).
component("YAL062W",156).
component("U99_",151).
component("U100_",20).
component("YBR035C",176).
component("YKR080W",557).
component("YER023W",328).
component("YOR236W",719).
component("YGR204W",410).
component("YIR034C",482).
component("YLR142W",577).
component("U65_",125).
component("U63_",123).
component("U62_",122).
component("YHR068W",436).
component("YKL150W",538).
component("YIL043C",460).
component("YHR042W",431).
component("YPL171C",745).
component("YHR179W",449).
component("YMR145C",631).
component("YML120C",620).
component("YKL192C",545).
component("YDL085W",237).
component("YGR234W",412).
component("YFR030W",362).
component("YPL017C",735).
component("YFL018C",354).
component("YDR353W",297).
component("YPR167C",774).
component("YJR137C",524).
component("YNL052W",645).
component("YMR256C",637).
component("YLR395C",604).
component("YLR038C",567).
component("YIL111W",467).
component("YHR051W",435).
component("YGL191W",386).
component("YGL187C",385).
component("YDL067C",234).
component("Q0275",19).
component("Q0250",18).
component("YDR072C",270).
component("YPL266W",758).
component("YKR069W",556).
component("YOL096C",691).
component("U47_",111).
component("YER091C",346).
component("YJR073C",517).
component("YGR157W",404).
component("YDR120C",272).
component("YML008C",610).
component("YOR074C",703).
component("YDL033C",230).
component("YOL096C",692).
component("YLR172C",581).
component("YLR058C",570).
component("YDR019C",263).
component("YBR176W",193).
component("YDR408C",303).
component("YMR120C",629).
component("YLR028C",565).
component("YBL013W",161).
component("YJL130C",495).
component("YKL024C",530).
component("YPR074C",769).
component("YBR117C",185).
component("YMR108W",627).
component("YCL009C",210).
component("YNL071W",647).
component("YNR008W",669).
component("YIL160C",476).
component("YNR019W",672).
component("YCR048W",224).
component("U48_",112).
component("YDR232W",284).
component("YPL231W",753).
component("YER061C",335).
component("YDL052C",233).
component("U8_",145).
component("YPL231W",754).
component("YPL028W",736).
component("YLR299W",592).
component("YGL017W",371).
component("YCR005C",216).
component("YML126C",621).
component("YNL104C",650).
component("YDL182W",254).
component("YDL131W",241).
component("YDR307W",293).
component("YLR258W",589).
component("YFR015C",360).
component("YNL029C",642).
component("YIL085C",464).
component("YMR306W",639).
component("YLR342W",598).
component("YGR032W",394).
component("YLR209C",584).
component("U104_",21).
component("YDR354W",298) :- not remove_orf("YDR354W",298).
component("YFR047C",363).
component("YJR133W",523).
component("YLR209C",585).
component("YML022W",612).
component("YDR441C",306).
component("YHR128W",444).
component("YJL167W",500).
component("YJL167W",501).
component("YDR127W",275).
component("YHR190W",452).
component("YLR146C",578).
component("YHR068W",437).
component("YLR303W",594).
component("YGR012W",392).
component("YML082W",618).
component("YJR130C",522).
component("YDR035W",264).
component("YBR249C",200).
component("YLR180W",583).
component("YDR502C",310).
component("YOR274W",720).
component("YBR256C",202).
component("YHR137W",445).
component("YGL202W",387).
component("YLR027C",564).
component("YKL106W",534).
component("YOL140W",697).
component("YLR438W",607).
component("YGR019W",393).
component("YLR089C",573).
component("U64_",124).
component("U61_",121).
component("U51_",114).
component("YJR148W",526).
component("YHR208W",455).
component("YFL030W",356).
component("YOR184W",712).
component("YNR058W",677).
component("YIL116W",469).
component("YGL253W",390).
component("YFR053C",364).
component("YMR013C",625).
component("YMR205C",633).
component("YGR240C",413).
component("YOL016C",681).
component("YFR014C",359).
component("YLR240W",587).
component("YKL203C",547).
component("YJR066W",516).
component("YCR036W",223).
component("YCL040W",213).
component("U15_",54).
component("YPL188W",747).
component("YJR049C",513).
component("YEL041W",319).
component("U96_",149).
component("YKL001C",529).
component("YDR236C",285).
component("YHL032C",424).
component("YDR531W",314).
component("U83_",141).
component("U82_",140).
component("U81_",139).
component("YMR208W",634).
component("YPL203W",748).
component("YOR061W",702).
component("YKL166C",540).
component("YJL164C",499).
component("YIL035C",459).
component("YHR205W",454).
component("YHR102W",443).
component("YGL019W",372).
component("YHR025W",430).
component("YOR347C",726).
component("YAL038W",154).
component("YNR012W",670).
component("YDR009W",262).
component("YDR127W",276).
component("YDR147W",279).
component("YDR300C",292).
component("YCR012W",217).
component("YER069W",337).
component("U19_",81).
component("U18_",73).
component("U17_",65).
component("U76_",134).
component("YER170W",349).
component("YDR226W",283).
component("YKL067W",532).
component("YOL055C",684).
component("YDR454C",307).
component("YJR057W",514).
component("YOL061W",688).
component("YKL181W",541).
component("YHL011C",423).
component("YER099C",347).
component("YBL068W",168).
component("YOR143C",708).
component("YNL256W",660).
component("YLR328W",596).
component("YBR018C",172).
component("YGR202C",409).
component("YLR328W",597).
component("U80_",138).
component("U94_",148).
component("YJR010W",509).
component("YBR029C",175).
component("YCL050C",214).
component("YGL130W",381).
component("YDR530C",313).
component("YPR190C",777).
component("YPR187W",776).
component("YPR110C",771).
component("YPR010C",763).
component("YOR341W",725).
component("YOR340C",724).
component("YOR224C",718).
component("YOR210W",716).
component("YOR207C",714).
component("YOR151C",709).
component("YOR116C",705).
component("YOL005C",679).
component("YNR003C",668).
component("YNL248C",659).
component("YNL151C",654).
component("YNL113W",651).
component("YKL144C",536).
component("YJR063W",515).
component("YJL148W",498).
component("YJL140W",497).
component("YIL021W",458).
component("YHR143W-A",446).
component("YGL070C",379).
component("YFL036W",357).
component("YDR404C",302).
component("YDR156W",280).
component("YDR045C",266).
component("YDL150W",248).
component("YDL140C",243).
component("YBR154C",191).
component("YPR175W",775).
component("YPL167C",744).
component("YOR330C",722).
component("YOL115W",695).
component("YNL299W",666).
component("YNL262W",662).
component("YNL102W",649).
component("YJR043C",512).
component("YJR006W",507).
component("YJL090C",490).
component("YIL139C",472).
component("YEL055C",322).
component("YDR419W",304).
component("YDR121W",273).
component("YDL102W",240).
component("YCR014C",218).
component("YBR278W",205).
component("YBL035C",164).
component("YPR113W",772).
component("YBR243C",198).
component("YPL148C",742).
component("YER026C",329).
component("YGR286C",420).
component("YHR189W",451).
component("YDR058C",269).
component("YDL086W",238).
component("YOL011W",680).
component("YMR008C",623).
component("YMR006C",622).
component("U105_",22).
component("YBL015W",162).
component("YJL068C",488).
component("YOR040W",701).
component("U77_",135).
component("YDR481C",308).
component("YLR377C",602).
component("YPL179W",746).
component("YNR032W",673).
component("YML057W",616).
component("YML016C",611).
component("YLR433C",606).
component("YGR123C",402).
component("YER133W",348).
component("YER089C",344).
component("YDR436W",305).
component("YDR075W",271).
component("YDL188C",255).
component("YDL134C",242).
component("YDL047W",232).
component("YDL006W",226).
component("YBR125C",187).
component("YBL056W",167).
component("YPR073C",767).
component("YHR215W",456).
component("YDL024C",229).
component("YBR093C",182).
component("YBR092C",181).
component("YAR071W",158).
component("YHR046C",434).
component("U9_",152).
component("YPL228W",751).
component("YMR180C",632).
component("YDL236W",259).
component("YPR073C",768).
component("YOR208W",715).
component("YNL053W",646).
component("YMR036C",626).
component("YIR026C",481).
component("YIL113W",468).
component("YFR028C",361).
component("YER075C",340).
component("YDL230W",258).
...
component("YOL064C",689).
component("YOR360C",728).
component("YKR031C",553).
component("YPL206C",749).
component("YGL027C",374).
component("YLR286C",591).
component("YJR153W",527).
component("YJL221C",506).
component("YJL216C",504).
component("YIL172C",479).
component("YGR292W",422).
component("YGR287C",421).
component("YBR299W",209).
component("YBR184W",194).
component("YIR019C",480).
component("YIL099W",466).
component("YDL037C",231).
component("YOR190W",713).
component("YLR300W",593).
component("YGR282C",419).
component("YDR261C",288).
component("YDR400W",300).
component("YML035C",613).
component("YJL070C",489).
component("YBR284W",206).
component("U106_",23).
component("YER043C",330).
component("YNL045W",644).
component("YGL037C",375).
component("YDR242W",286).
component("U53_",116).
component("YPR062W",766).
component("YMR120C",630).
component("YLR028C",566).
component("YHR144C",447).
component("YGR267C",418).
component("YBL033C",163).
component("YNL141W",652).
component("YLR245C",588).
component("YML035C",614).
component("YBR084W",179).
component("YJL126W",493).
component("U44_",108).
...
component("YHR201C",453).
component("YBR111C",183).
component("YBR252W",201).
component("YER005W",327).
component("YBL099W",169).
component("YLR231C",586).
component("YDR538W",316).
component("YLR134W",575).
component("YLR044C",568).
component("YGR087C",399).
component("YDR380W",299).
component("YDL080C",236).
component("U98_",150).
component("YMR250W",636).
component("YOR128C",706).
component("YEL021W",318).
component("YNR043W",675).
component("U93_",147).
component("U54_",117).
component("YKL211C",548) :- not remove_orf("YKL211C",548).
component("YKR097W",559).
component("YNL169C",655).
component("YNL256W",661).
component("YDR294C",290).
component("YEL046C",320).
component("YNR033W",674).
component("YKL211C",549) :- not remove_orf("YKL211C",549).
component("YER090W",549) :- not remove_orf("YER090W",549).
component("YER090W",345) :- not remove_orf("YER090W",345).
component("YDR127W",277).
component("YPL281C",761).
component("YOR393W",734).
component("YMR323W",640).
component("YHR174W",448).
component("YGR254W",415).
component("YPL262W",756).
component("YGL026C",373) :- not remove_orf("YGL026C",373).
component("YGR155W",403).
component("YLR304C",595).
component("YJL200C",502).
component("YNL316C",667).
component("YKL182W",543).
component("YPL212C",750).
component("YNL292W",665).
component("YGL063W",378).
component("YFL001W",352).
component("YPR002W",762).
component("YJR016C",510).
component("YCR053W",225).
component("YDR127W",278).
component("YGL148W",382).
component("YIL168W",478).
component("YIL167W",477).
component("YCL064C",215).
component("YER086W",342).
component("YLR359W",601).
component("YAL012W",153).
component("YML004C",609).
component("YFR055W",365).
component("YJL005W",484).
component("YJL121C",492).
component("YBR019C",173).
component("YDR050C",268).
component("YDR007W",261) :- not remove_orf("YDR007W",261).
component("YOR095C",704).
component("YER003C",326).
component("YBR196C",195).
component("YGL001C",367).
component("YPL117C",740).
component("U14_",46).
component("YOL056W",685).
component("YKL152C",539).
component("YDL021W",227).
component("YEL058W",323).
component("YPR060C",765).
component("YHR072W",438).
component("YPL097W",738).
component("YGR185C",407).
component("YGR264C",417).
component("YGR171C",405).
component("YPL104W",739).
component("YLL018C",560).
component("YPR081C",770).
component("YBR121C",186).
component("YHR020W",429).
component("YER087W",343).
component("YNL247W",658).
component("YOR168W",710).
component("YOL097C",693).
component("YDR268W",289).
component("YPR047W",764).
component("YLR060W",571).
component("YFL022C",355).
component("YCR024C",219).
component("YHR019C",428).
component("YKL194C",546).
component("YIL078W",463).
component("YPL160W",743).
component("YLR382C",603).
component("YNL073W",648).
component("YOR335C",723).
component("YLR153C",579).
component("YAL054C",155).
component("YGR244C",414).
component("YIL145C",473).
component("U89_",144).
component("YJL101C",491).
component("YOL049W",683).
component("YAR015W",157).
component("YER183C",351).
component("U90_",146).
component("YNR057C",676).
component("YDL141W",244).
component("YDL141W",245).
component("YGL234W",389).
component("YDL141W",246).
component("YJR103W",520).
component("YBL039C",165).
component("YGR204W",411).
component("YBR084W",180).
component("YNL220W",656).
component("YOL058W",686).
component("YDL141W",247).
component("YHR074W",439).
component("YMR217W",635).
component("YGL062W",377).
component("YBR218C",196).
component("YPL231W",755).
component("YNR016C",671).
component("YKL182W",544).
component("YGR037C",395).
component("YPR138C",773).
component("YPL265W",757).
component("YPL134C",741).
component("YPL036W",737).
component("YOR348C",727).
component("YOR222W",717).
component("YOR171C",711).
component("YOR130C",707).
component("YOR011W",700).
component("YOL156W",699).
component("YOL103W",694).
component("YOL020W",682) :- not remove_orf("YOL020W",682).
component("YNR072W",678).
component("YNL270C",663).
component("YNL142W",653).
component("YMR011W",624).
component("YLR348C",599).
component("YLR260W",590).
component("YLR138W",576).
component("YLR100C",574).
component("YLR081W",572).
component("YLL061W",563).
component("YKR093W",558).
component("YKR053C",555).
component("YKR039W",554) :- not remove_orf("YKR039W",554).
component("YJR158W",528).
component("YJR077C",518).
component("YJL219W",505).
component("YJL214W",503).
component("YJL134W",496).
component("YJL129C",494).
component("YIL134W",471).
component("YHR096C",442).
component("YHR094C",441).
component("YHR092C",440).
component("YHL036W",425).
component("YGR121C",401).
component("YGR065C",398).
component("YGR055W",396).
component("YGL186C",384).
component("YGL077C",380).
component("YGL008C",368).
component("YFL055W",358).
component("YFL011W",353).
component("YER060W-A",334).
component("YER060W",333).
component("YER056C",332).
component("YER053C",331).
component("YEL069C",325).
component("YEL063C",324).
component("YEL017C-A",317).
component("YDR536W",315).
component("YDR508C",312).
component("YDR503C",311).
component("YDR497C",309).
component("YDR345C",296).
component("YDR343C",295).
component("YDR342C",294).
component("YDR297W",291).
component("YDR046C",267) :- not remove_orf("YDR046C",267).
component("YDL245C",260).
component("YDL210W",256).
component("YCR032W",222).
component("YCR028C",221).
component("YCR024C-A",220).
component("YCL025C",212).
...
component("YBR021W",174).
component("YBL042C",166).
component("U85_",142).
component("U7_",137).
component("U78_",136).
component("U75_",133).
...
catalyst(2300,147).
catalyst(3460,117).
catalyst(3600,548) :- not remove_reaction(3600,548).
catalyst(8000,559).
catalyst(6890,655).
catalyst(2570,661).
catalyst(8781,290).
...
catalyst(4560,320).
catalyst(2550,674).
catalyst(1890,549) :- not remove_reaction(1890,549).
catalyst(3630,549) :- not remove_reaction(3630,549).
...
catalyst(8061,756).
catalyst(8062,756).
catalyst(3590,373) :- not remove_reaction(3590,373).
catalyst(10910,373) :- not remove_reaction(10910,373).
catalyst(4570,403).
catalyst(8181,595).
catalyst(8182,595).
catalyst(8181,502).
...
catalyst(8281,268).
catalyst(8282,268).
catalyst(3610,261) :- not remove_reaction(3610,261).
catalyst(7921,704).
catalyst(7922,704).
catalyst(7841,326).
catalyst(7842,326).
...
catalyst(1210,699).
catalyst(1160,694).
catalyst(801,682) :- not remove_reaction(801,682).
catalyst(802,682) :- not remove_reaction(802,682).
catalyst(811,682) :- not remove_reaction(811,682).
catalyst(812,682) :- not remove_reaction(812,682).
catalyst(831,682) :- not remove_reaction(831,682).
catalyst(832,682) :- not remove_reaction(832,682).
catalyst(901,682) :- not remove_reaction(901,682).
catalyst(902,682) :- not remove_reaction(902,682).
catalyst(1180,678).
catalyst(1210,678).
catalyst(931,663).
catalyst(932,663).
...
catalyst(851,554) :- not remove_reaction(851,554).
catalyst(852,554) :- not remove_reaction(852,554).
...
catalyst(921,554) :- not remove_reaction(921,554).
catalyst(922,554) :- not remove_reaction(922,554).
catalyst(931,554) :- not remove_reaction(931,554).
catalyst(932,554) :- not remove_reaction(932,554).
...
catalyst(851,267) :- not remove_reaction(851,267).
catalyst(852,267) :- not remove_reaction(852,267).
...
catalyst(851,178) :- not remove_reaction(851,178).
catalyst(852,178) :- not remove_reaction(852,178).
...
catalyst(851,177) :- not remove_reaction(851,177).
catalyst(852,177) :- not remove_reaction(852,177).
...
modifiable_enzyme(548).
modifiable_enzyme(549).
modifiable_enzyme(345).
modifiable_enzyme(373).
modifiable_enzyme(261).
modifiable_enzyme(682).
