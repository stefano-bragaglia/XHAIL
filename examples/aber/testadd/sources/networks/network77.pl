...
component("YNL280C",490).
component("YLR056W",420).
component("YGL012W",262).
component("YKR009C",404).
component("YOL086C",509).
component("YMR303C",468).
component("YGL256W",282).
component("YDL168W",178).
component("YBR145W",136).
component("YPL231W",559).
component("U46_",78).
component("YBR149W",137).
component("YBR149W",138).
component("YGL001C",259).
component("YIL094C",338).
component("U45_",77).
component("YML056C",452).
component("YLR432W",449).
component("YHR216W",332).
component("YAR075W",114).
component("YAR073W",113).
component("YDR127W",192).
component("YOL126C",514).
component("YKL085W",391).
component("YDL078C",168).
component("YNL037C",473).
component("YNL009W",471).
component("YLR174W",430).
component("YCL018W",153).
component("YLR355C",445).
component("YDL174C",181).
component("YML086C",453).
component("YGR088W",290).
component("YDR256C",203).
component("YJR078W",380).
component("YJR025C",373).
component("U107_",23).
component("YJR104C",382).
component("YHR008C",309).
component("YOR384W",543).
component("YOR381W",542).
component("YOL152W",516).
component("YLL051C",414).
component("YJL026W",352).
component("YIL066C",336).
component("YGR180C",293).
component("YER070W",238).
component("U36_",71).
component("YDL168W",179).
component("YBR006W",122).
component("YPL276W",567).
component("YPL275W",566).
component("YOR388C",544).
component("YOR374W",541).
component("YER073W",239).
component("YGL154C",274).
component("U55_",84).
component("YER069W",237).
component("YOR323C",534).
component("YER178W",245).
component("YBR221C",144).
component("YIL125W",342).
component("U52_",82).
component("YBR166C",140).
component("YGL012W",263).
component("YKL216W",403).
component("YKR009C",405).
component("YIL160C",346).
component("YGL205W",279).
component("YMR118C",460).
component("YLR164W",428).
component("YLL041C",413).
component("YKL148C",394).
component("YJL045W",353).
component("YDR178W",199).
component("YDL171C",180).
component("U99_",108).
component("U100_",20).
component("YKR080W",410).
component("YER023W",231).
component("YOR236W",532).
component("YGR204W",295).
component("YLR142W",426).
component("U65_",90).
component("U63_",88).
component("U62_",87).
component("YHR068W",317).
component("YKL150W",395).
component("YIL043C",335).
component("YPL171C",554).
component("YHR179W",328).
component("YMR145C",463).
component("YML120C",454).
component("YKL192C",400).
component("YDL085W",170).
component("YGR234W",297).
component("YFR030W",256).
component("YPL017C",546).
component("YFL018C",249).
component("YDR353W",210).
component("YPR167C",579).
component("YJR137C",384).
component("YNL052W",474).
component("YMR256C",467).
component("YLR395C",448).
component("YLR038C",418).
component("YIL111W",339).
component("YHR051W",316).
component("YGL191W",277).
component("YGL187C",276).
component("YDL067C",167).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",565).
component("YKR069W",409).
component("YOL096C",510).
component("U47_",79).
component("YJR073C",378).
component("YDL033C",166).
component("YLR172C",429).
component("YLR058C",421).
component("YDR019C",187).
component("YBR176W",141).
component("YDR408C",215).
component("YMR120C",461).
component("YLR028C",416).
component("YBL013W",115).
component("YJL130C",360).
component("YKL024C",389).
component("YPR074C",575).
component("YBR117C",135).
component("YCL009C",152).
component("YNL071W",476).
component("YIL160C",347).
component("U48_",80).
component("YPL231W",560).
component("YPL231W",561).
component("YPL028W",547).
component("YLR299W",438).
component("YGL017W",264).
component("YML126C",455).
component("YNL104C",478).
component("YDL182W",182).
component("YDL131W",174).
component("YLR258W",435).
component("YFR015C",254).
component("YNL029C",472).
component("YIL085C",337).
component("YMR306W",469).
component("YLR342W",444).
component("YGR032W",285).
component("YLR209C",431).
component("U104_",21).
component("YDR354W",211) :- not remove_orf("YDR354W",211).
component("YFR047C",257).
component("YLR209C",432).
component("YML022W",450).
component("YDR441C",217).
component("YJL167W",365).
component("YDR127W",193).
component("YHR068W",318).
component("YLR303W",440).
component("YGR012W",283).
component("YJR130C",383).
component("YDR035W",188).
component("YBR249C",145).
component("YOR274W",533).
component("YHR137W",324).
component("YGL202W",278).
component("YLR027C",415).
component("YKL106W",392).
component("YOL140W",515).
component("YGR019W",284).
component("YLR089C",423).
component("U64_",89).
component("U61_",86).
component("YJR148W",385).
component("YFL030W",250).
component("YNR058W",499).
component("YIL116W",341).
component("YGL253W",281).
component("YFR053C",258).
component("YMR205C",464).
component("YGR240C",298).
component("YOL016C",503).
component("YFR014C",253).
component("YCR036W",162).
component("YCL040W",155).
component("U15_",40).
component("YPL188W",555).
component("YJR049C",375).
component("YEL041W",225).
component("U96_",106).
component("YKL001C",388).
component("YDR236C",201).
component("YHL032C",307).
component("U83_",102).
component("YMR208W",465).
component("YPL203W",556).
component("YOR061W",519).
component("YKL166C",397).
component("YJL164C",364).
component("YIL035C",334).
component("YHR205W",330).
component("YHR102W",323).
component("YGL019W",265).
component("YHR025W",312).
component("YOR347C",539).
component("YAL038W",111).
component("YNR012W",495).
component("YDR127W",194).
component("YDR147W",197).
component("YCR012W",157).
component("U76_",99).
component("YER170W",244).
component("YDR226W",200).
component("YKL067W",390).
component("YOL055C",506).
component("YDR454C",218).
component("YJR057W",376).
component("YOL061W",508).
component("YKL181W",398).
component("YHL011C",306).
component("YER099C",243).
component("YBL068W",120).
component("YOR143C",523).
component("YNL256W",487).
component("YLR328W",442).
component("YBR018C",124).
component("YLR328W",443).
component("U94_",105).
component("YBR029C",127).
component("YGL130W",272).
component("YDR530C",222).
component("YPR190C",582).
component("YPR187W",581).
component("YPR110C",576).
component("YPR010C",570).
component("YOR341W",538).
component("YOR340C",537).
component("YOR224C",531).
component("YOR210W",530).
component("YOR207C",528).
component("YOR151C",524).
component("YOR116C",521).
component("YOL005C",501).
component("YNR003C",494).
component("YNL248C",486).
component("YNL151C",482).
component("YNL113W",479).
component("YKL144C",393).
component("YJR063W",377).
component("YJL148W",363).
component("YJL140W",362).
component("YIL021W",333).
component("YHR143W-A",325).
component("YGL070C",270).
component("YFL036W",251).
component("YDR404C",214).
component("YDR156W",198).
component("YDR045C",189).
component("YDL150W",177).
component("YDL140C",175).
component("YBR154C",139).
component("YPR175W",580).
component("YPL167C",553).
component("YOR330C",535).
component("YOL115W",513).
component("YNL299W",492).
component("YNL262W",488).
component("YNL102W",477).
component("YJR043C",374).
component("YJR006W",371).
component("YJL090C",356).
component("YIL139C",344).
component("YEL055C",227).
component("YDR419W",216).
component("YDR121W",191).
component("YDL102W",173).
component("YCR014C",158).
component("YBR278W",148).
component("YBL035C",118).
component("YPR113W",577).
component("YPL148C",552).
component("YGR286C",303).
component("YHR189W",329).
component("YDL086W",171).
component("YOL011W",502).
component("YMR008C",457).
component("YMR006C",456).
component("U105_",22).
component("YBL015W",116).
component("YJL068C",354).
component("U77_",100).
component("YLR377C",447).
component("YPR073C",573).
component("YHR215W",331).
component("YDL024C",165).
component("YBR093C",133).
component("YBR092C",132).
component("YHR046C",315).
component("U9_",109).
component("YDL236W",184).
component("YPR073C",574).
component("YOR208W",529).
component("YNL053W",475).
component("YMR036C",459).
component("YIR026C",351).
component("YIL113W",340).
component("YFR028C",255).
component("YER075C",240).
component("YDL230W",183).
component("YBR276C",147).
component("U34_",70).
component("U31_",69).
component("U30_",68).
component("U29_",67).
...
component("U25_",65).
component("U24_",64).
component("YHR044C",314).
component("YHR043C",313).
component("YOR360C",540).
component("YKR031C",406).
component("YPL206C",557).
component("YGL027C",267).
component("YLR286C",437).
component("YJR153W",386).
component("YJL221C",370).
component("YJL216C",368).
component("YIL172C",350).
component("YGR292W",305).
component("YGR287C",304).
component("YBR299W",151).
component("YOR190W",527).
component("YLR300W",439).
component("YGR282C",302).
component("YDR261C",204).
component("YDR400W",213).
component("YML035C",451).
component("YJL070C",355).
component("YBR284W",149).
component("YER043C",232).
component("YDR242W",202).
component("U53_",83).
component("YPR062W",572).
component("YMR120C",462).
component("YLR028C",417).
component("YHR144C",326).
component("YBL033C",117).
component("YNL141W",480).
component("YLR245C",434).
component("YBR084W",130).
component("YJL126W",358).
component("U44_",76).
component("YDL100C",172).
component("U40_",74).
component("U39_",72).
component("YBR011C",123).
component("YBR111C",134).
component("YBR252W",146).
component("YER005W",230).
component("YBL099W",121).
component("YLR231C",433).
component("YLR134W",425).
component("YLR044C",419).
component("YGR087C",289).
component("YDR380W",212).
component("YDL080C",169).
component("U98_",107).
component("YMR250W",466).
component("YOR128C",522).
component("U93_",104).
component("YKL211C",401) :- not remove_orf("YKL211C",401).
component("YKR097W",411).
component("YNL169C",483).
component("YEL046C",226).
component("YNR033W",497).
component("YKL211C",402) :- not remove_orf("YKL211C",402).
component("YER090W",402) :- not remove_orf("YER090W",402).
component("YER090W",242) :- not remove_orf("YER090W",242).
component("YDR127W",195).
component("YPL281C",568).
component("YOR393W",545).
component("YMR323W",470).
component("YHR174W",327).
component("YGR254W",300).
component("YPL262W",563).
component("YGL026C",266) :- not remove_orf("YGL026C",266).
component("YLR304C",441).
component("YJL200C",366).
component("YNL316C",493).
component("YPL212C",558).
component("YNL292W",491).
component("YGL063W",269).
component("YFL001W",247).
component("YPR002W",569).
component("YJR016C",372).
component("YCR053W",163).
component("YDR127W",196).
component("YGL148W",273).
component("YIL168W",349).
component("YIL167W",348).
component("YCL064C",156).
component("YLR359W",446).
component("YAL012W",110).
component("YBR019C",125).
component("YDR007W",186) :- not remove_orf("YDR007W",186).
component("YOR095C",520).
component("YBR196C",142).
component("YGL001C",260).
component("YPL117C",551).
component("U14_",34).
component("YOL056W",507).
component("YKL152C",396).
component("YDL021W",164).
component("YPR060C",571).
component("YPL097W",549).
component("YGR185C",294).
component("YGR264C",301).
component("YGR171C",292).
component("YPL104W",550).
component("YLL018C",412).
component("YHR020W",311).
component("YER087W",241).
component("YNL247W",485).
component("YOR168W",525).
component("YOL097C",511).
component("YDR268W",205).
component("YCR024C",159).
component("YHR019C",310).
component("YOR335C",536).
component("YLR153C",427).
component("YAL054C",112).
component("YGR244C",299).
component("YIL145C",345).
component("YJL101C",357).
component("YOL049W",505).
component("YER183C",246).
component("U90_",103).
component("YNR057C",498).
component("YGL234W",280).
component("YJR103W",381).
component("YBL039C",119).
component("YGR204W",296).
component("YBR084W",131).
component("YNL220W",484).
component("YDL141W",176).
component("YHR074W",319).
component("YGL062W",268).
component("YBR218C",143).
component("YPL231W",562).
component("YNR016C",496).
component("YKL182W",399).
component("YGR037C",286).
component("YPR138C",578).
component("YPL265W",564).
component("YPL036W",548).
component("YOR171C",526).
component("YOR011W",518).
component("YOL156W",517).
component("YOL103W",512).
component("YOL020W",504) :- not remove_orf("YOL020W",504).
component("YNR072W",500).
component("YNL270C",489).
component("YNL142W",481).
component("YMR011W",458).
component("YLR260W",436).
component("YLR100C",424).
component("YLR081W",422).
component("YKR053C",408).
component("YKR039W",407) :- not remove_orf("YKR039W",407).
component("YJR158W",387).
component("YJR077C",379).
component("YJL219W",369).
component("YJL214W",367).
component("YJL134W",361).
component("YJL129C",359).
component("YIL134W",343).
component("YHR096C",322).
component("YHR094C",321).
component("YHR092C",320).
component("YHL036W",308).
component("YGR121C",291).
component("YGR065C",288).
component("YGR055W",287).
component("YGL186C",275).
component("YGL077C",271).
component("YGL008C",261).
component("YFL055W",252).
component("YFL011W",248).
component("YER060W-A",236).
component("YER060W",235).
component("YER056C",234).
component("YER053C",233).
component("YEL069C",229).
component("YEL063C",228).
component("YEL017C-A",224).
component("YDR536W",223).
component("YDR508C",221).
component("YDR503C",220).
component("YDR497C",219).
component("YDR345C",209).
component("YDR343C",208).
component("YDR342C",207).
component("YDR297W",206).
component("YDR046C",190) :- not remove_orf("YDR046C",190).
component("YDL245C",185).
component("YCR032W",161).
component("YCR024C-A",160).
component("YCL025C",154).
component("YBR298C",150).
component("YBR069C",129) :- not remove_orf("YBR069C",129).
component("YBR068C",128) :- not remove_orf("YBR068C",128).
component("YBR021W",126).
component("U7_",101).
component("U75_",98).
component("U74_",97).
component("U73_",96).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,211) :- not remove_reaction(3620,211).
catalyst(2110,257).
catalyst(2190,257).
catalyst(5791,432).
catalyst(5792,432).
...
catalyst(6112,522).
catalyst(2300,104).
catalyst(3600,401) :- not remove_reaction(3600,401).
catalyst(8000,411).
catalyst(6890,483).
catalyst(4560,226).
catalyst(2550,497).
...
catalyst(1890,242) :- not remove_reaction(1890,242).
catalyst(3630,242) :- not remove_reaction(3630,242).
catalyst(3740,195).
catalyst(8231,568).
catalyst(8232,568).
catalyst(8231,545).
...
catalyst(8051,563).
catalyst(8052,563).
catalyst(3590,266) :- not remove_reaction(3590,266).
catalyst(10910,266) :- not remove_reaction(10910,266).
catalyst(8181,441).
catalyst(8182,441).
catalyst(8181,366).
catalyst(8182,366).
...
catalyst(1210,517).
catalyst(1160,512).
catalyst(801,504) :- not remove_reaction(801,504).
catalyst(802,504) :- not remove_reaction(802,504).
catalyst(811,504) :- not remove_reaction(811,504).
catalyst(812,504) :- not remove_reaction(812,504).
catalyst(831,504) :- not remove_reaction(831,504).
catalyst(832,504) :- not remove_reaction(832,504).
catalyst(901,504) :- not remove_reaction(901,504).
catalyst(902,504) :- not remove_reaction(902,504).
catalyst(1210,500).
catalyst(931,489).
catalyst(932,489).
catalyst(371,481).
...
catalyst(851,407) :- not remove_reaction(851,407).
catalyst(852,407) :- not remove_reaction(852,407).
catalyst(881,407) :- not remove_reaction(881,407).
catalyst(882,407) :- not remove_reaction(882,407).
catalyst(901,407) :- not remove_reaction(901,407).
catalyst(902,407) :- not remove_reaction(902,407).
catalyst(921,407) :- not remove_reaction(921,407).
catalyst(922,407) :- not remove_reaction(922,407).
catalyst(931,407) :- not remove_reaction(931,407).
catalyst(932,407) :- not remove_reaction(932,407).
...
catalyst(1121,150).
catalyst(1122,150).
catalyst(771,129) :- not remove_reaction(771,129).
catalyst(772,129) :- not remove_reaction(772,129).
...
catalyst(851,129) :- not remove_reaction(851,129).
catalyst(852,129) :- not remove_reaction(852,129).
catalyst(901,129) :- not remove_reaction(901,129).
catalyst(902,129) :- not remove_reaction(902,129).
catalyst(801,128) :- not remove_reaction(801,128).
catalyst(802,128) :- not remove_reaction(802,128).
catalyst(811,128) :- not remove_reaction(811,128).
catalyst(812,128) :- not remove_reaction(812,128).
catalyst(831,128) :- not remove_reaction(831,128).
catalyst(832,128) :- not remove_reaction(832,128).
catalyst(841,128) :- not remove_reaction(841,128).
catalyst(842,128) :- not remove_reaction(842,128).
catalyst(851,128) :- not remove_reaction(851,128).
catalyst(852,128) :- not remove_reaction(852,128).
catalyst(901,128) :- not remove_reaction(901,128).
catalyst(902,128) :- not remove_reaction(902,128).
catalyst(620,126).
catalyst(6960,101).
catalyst(2920,98).
catalyst(2920,97).
