...
component("YNL280C",647).
component("YLR056W",555).
component("YGR060W",384).
component("YGL012W",356).
component("YKR009C",537).
component("YOL086C",672).
component("YMR303C",621).
component("YGL256W",378).
component("YDL168W",239).
component("YBR145W",179).
component("YPL231W",733).
...
component("U45_",103).
component("YML056C",599).
component("YLR432W",589).
component("YHR216W",443).
component("YAR075W",151).
component("YAR073W",150).
component("YDR127W",264).
component("YJR139C",511).
component("YML075C",601).
component("YLR450W",592).
component("YOL126C",678).
component("YKL085W",519).
component("YDL078C",226).
component("YNL037C",626).
component("YNL009W",624).
component("YLR174W",567).
component("YHR183W",436).
component("YGR256W",402).
component("YNL241C",640).
component("YOL059W",670).
component("YDL022W",219).
component("YCL018W",202).
component("YLR355C",584).
component("YIL074C",448).
component("YER081W",329).
component("YDL174C",243).
component("YML086C",603).
component("YIL155C",460).
component("YGR088W",387).
component("YDR256C",276).
component("YKL026C",517).
component("YIR037W",469).
component("YBR244W",190).
component("YJR078W",505).
component("U58_",112).
component("YJR025C",497).
component("U107_",24).
component("YHR007C",412).
component("YDR402C",290).
component("YGL055W",363).
component("YJR104C",507).
component("YHR008C",413).
component("YOR384W",714).
component("YOR381W",713).
component("YOL152W",680).
component("YLL051C",548).
component("YJL026W",471).
component("YIL066C",447).
component("YGR180C",393).
component("YER070W",326).
component("U37_",97).
component("U36_",96).
component("YDL168W",240).
component("YJR009C",494).
component("YJL052W",473).
component("YGR192C",395).
component("YBR006W",161).
component("YPL276W",741).
component("YPL275W",740).
component("YOR388C",715).
component("YOR374W",711).
component("YER073W",327).
component("YGL154C",370).
component("YBR115C",175).
component("U55_",111).
component("YER069W",324).
component("YOR323C",703).
component("YER178W",338).
component("YBR221C",188).
component("YIL125W",456).
component("U52_",109).
component("YBR166C",183).
component("YGL012W",357).
component("YKL182W",528).
component("YKL216W",536).
component("YDR044W",255).
component("YKR009C",538).
component("YIL160C",461).
component("YGL205W",375).
component("YMR118C",612).
component("YLR164W",565).
component("YLL041C",547).
component("YKL148C",523).
component("YKL141W",521).
component("YJL045W",472).
component("YDR178W",271).
component("YEL047C",309).
component("YDL171C",241).
component("YDL171C",242).
component("YOR375C",712).
...
component("YOR236W",701).
component("YGR204W",396).
component("YIR034C",468).
component("YLR142W",562).
component("U65_",118).
component("U63_",116).
component("U62_",115).
component("YHR068W",422).
component("YKL150W",524).
component("YIL043C",446).
component("YHR042W",417).
component("YPL171C",727).
component("YHR179W",435).
component("YMR145C",615).
component("YML120C",604).
component("YKL192C",531).
component("YDL085W",228).
component("YGR234W",398).
component("YFR030W",349).
component("YPL017C",717).
component("YFL018C",342).
component("YDR353W",286).
component("YPR167C",754).
component("YJR137C",510).
component("YNL052W",628).
component("YMR256C",620).
component("YLR395C",588).
component("YLR038C",553).
component("YIL111W",453).
component("YHR051W",421).
...
component("YPL266W",739).
component("YKR069W",542).
component("YOL096C",673).
component("U47_",105).
component("YER091C",334).
component("YJR073C",503).
component("YGR157W",391).
component("YDR120C",262).
component("YML008C",594).
component("YOR074C",685).
component("YDL033C",221).
component("YOL096C",674).
component("YLR172C",566).
component("YLR058C",556).
component("YDR019C",253).
component("YBR176W",184).
component("YDR408C",292).
component("YMR120C",613).
component("YLR028C",551).
component("YBL013W",152).
component("YJL130C",481).
component("YKL024C",516).
component("YPR074C",749).
component("YBR117C",176).
component("YMR108W",611).
component("YCL009C",201).
component("YNL071W",630).
component("YNR008W",652).
component("YIL160C",462).
component("YNR019W",655).
component("YCR048W",215).
component("U48_",106).
component("YDR232W",273).
component("YPL231W",734).
component("YER061C",323).
component("YDL052C",224).
component("U8_",137).
component("YPL231W",735).
component("YPL028W",718).
component("YLR299W",577).
component("YGL017W",358).
component("YCR005C",207).
component("YML126C",605).
component("YNL104C",633).
component("YDL182W",244).
component("YDL131W",232).
component("YDR307W",282).
component("YLR258W",574).
component("YFR015C",347).
component("YNL029C",625).
component("YIL085C",450).
component("YMR306W",622).
...
component("YJR133W",509).
component("YLR209C",570).
component("YML022W",596).
component("YDR441C",295).
component("YHR128W",430).
component("YJL167W",486).
component("YJL167W",487).
component("YDR127W",265).
component("YHR190W",438).
component("YLR146C",563).
component("YHR068W",423).
component("YLR303W",579).
component("YGR012W",379).
component("YML082W",602).
component("YJR130C",508).
component("YDR035W",254).
component("YBR249C",191).
component("YLR180W",568).
component("YDR502C",298).
component("YOR274W",702).
component("YBR256C",193).
component("YHR137W",431).
component("YGL202W",374).
component("YLR027C",550).
component("YKL106W",520).
component("YOL140W",679).
component("YLR438W",591).
component("YGR019W",380).
component("YLR089C",558).
component("U64_",117).
component("U61_",114).
component("U51_",108).
component("YJR148W",512).
component("YHR208W",441).
component("YFL030W",343).
component("YOR184W",694).
component("YNR058W",660).
component("YIL116W",455).
component("YGL253W",377).
component("YFR053C",351).
component("YMR013C",609).
component("YMR205C",616).
component("YGR240C",399).
component("YOL016C",664).
component("YFR014C",346).
component("YLR240W",572).
component("YKL203C",533).
component("YJR066W",502).
component("YCR036W",214).
component("YCL040W",204).
component("U15_",49).
component("YPL188W",729).
component("YJR049C",499).
component("YEL041W",307).
component("U96_",141).
component("YKL001C",515).
component("YDR236C",274).
component("YHL032C",410).
component("YDR531W",302).
component("U83_",134).
component("U82_",133).
component("U81_",132).
component("YMR208W",617).
component("YPL203W",730).
component("YOR061W",684).
component("YKL166C",526).
component("YJL164C",485).
component("YIL035C",445).
component("YHR205W",440).
component("YHR102W",429).
component("YGL019W",359).
component("YHR025W",416).
component("YOR347C",708).
component("YAL038W",146).
component("YNR012W",653).
...
component("YOL055C",667).
component("YDR454C",296).
component("YJR057W",500).
component("YOL061W",671).
component("YKL181W",527).
component("YHL011C",409).
component("YER099C",335).
component("YBL068W",159).
component("YOR143C",690).
component("YNL256W",643).
component("YLR328W",581).
component("YBR018C",163).
component("YLR328W",582).
component("U80_",131).
component("U94_",140).
component("YJR010W",495).
...
component("YPR110C",751).
component("YPR010C",744).
component("YOR341W",707).
component("YOR340C",706).
component("YOR224C",700).
component("YOR210W",698).
component("YOR207C",696).
component("YOR151C",691).
component("YOR116C",687).
component("YOL005C",662).
component("YNR003C",651).
component("YNL248C",642).
component("YNL151C",637).
component("YNL113W",634).
component("YKL144C",522).
component("YJR063W",501).
component("YJL148W",484).
component("YJL140W",483).
component("YIL021W",444).
component("YHR143W-A",432).
...
component("YPL167C",726).
component("YOR330C",704).
component("YOL115W",677).
component("YNL299W",649).
component("YNL262W",645).
component("YNL102W",632).
component("YJR043C",498).
component("YJR006W",493).
component("YJL090C",476).
component("YIL139C",458).
...
component("YPR113W",752).
component("YBR243C",189).
component("YPL148C",724).
component("YER026C",317).
component("YGR286C",406).
component("YHR189W",437).
component("YDR058C",259).
component("YDL086W",229).
component("YOL011W",663).
component("YMR008C",607).
component("YMR006C",606).
component("U105_",22).
component("YBL015W",153).
component("YJL068C",474).
component("YOR040W",683).
component("U77_",128).
component("YLR377C",586).
component("YPL179W",728).
component("YNR032W",656).
component("YML057W",600).
component("YML016C",595).
...
component("YPR073C",747).
component("YHR215W",442).
component("YDL024C",220).
component("YBR093C",173).
component("YBR092C",172).
component("YHR046C",420).
component("U9_",144).
component("YDL236W",249).
component("YPR073C",748).
component("YOR208W",697).
component("YNL053W",629).
component("YMR036C",610).
component("YIR026C",467).
component("YIL113W",454).
...
component("U25_",88).
component("U24_",87).
component("YHR044C",419).
component("YHR043C",418).
component("YOR360C",710).
component("YKR031C",539).
component("YPL206C",731).
component("YGL027C",361).
component("YLR286C",576).
component("YJR153W",513).
component("YJL221C",492).
component("YJL216C",490).
component("YIL172C",465).
component("YGR292W",408).
component("YGR287C",407).
component("YBR299W",200).
component("YBR184W",185).
component("YIR019C",466).
component("YIL099W",452).
component("YDL037C",222).
component("YOR190W",695).
component("YLR300W",578).
component("YGR282C",405).
component("YDR261C",277).
component("YDR400W",289).
component("YML035C",597).
component("YJL070C",475).
...
component("YLR044C",554).
component("YGR087C",386).
component("YDR380W",288).
component("YDL080C",227).
component("U98_",142).
component("YMR250W",619).
component("YOR128C",688).
component("YEL021W",306).
component("YNR043W",658).
component("U93_",139).
component("YKL211C",534) :- not remove_orf("YKL211C",534).
component("YKR097W",545).
component("YNL169C",638).
component("YNL256W",644).
component("YDR294C",279).
component("YEL046C",308).
component("YNR033W",657).
component("YKL211C",535) :- not remove_orf("YKL211C",535).
component("YER090W",535) :- not remove_orf("YER090W",535).
component("YER090W",333) :- not remove_orf("YER090W",333).
component("YDR127W",267).
component("YPL281C",742).
component("YOR393W",716).
component("YMR323W",623).
component("YHR174W",434).
component("YGR254W",401).
component("YPL262W",737).
component("YGL026C",360) :- not remove_orf("YGL026C",360).
component("YGR155W",390).
component("YLR304C",580).
component("YJL200C",488).
component("YNL316C",650).
component("YKL182W",529).
component("YPL212C",732).
component("YNL292W",648).
component("YGL063W",365).
component("YFL001W",340).
component("YPR002W",743).
component("YJR016C",496).
component("YCR053W",216).
component("YDR127W",268).
component("YGL148W",369).
component("YIL168W",464).
component("YIL167W",463).
component("YCL064C",206).
component("YER086W",330).
component("YLR359W",585).
component("YAL012W",145).
component("YML004C",593).
component("YFR055W",352).
component("YJL005W",470).
component("YJL121C",478).
component("YBR019C",164).
component("YDR050C",258).
component("YDR007W",251) :- not remove_orf("YDR007W",251).
component("YOR095C",686).
component("YER003C",314).
component("YBR196C",186).
component("YGL001C",354).
component("YPL117C",722).
component("U14_",41).
component("YOL056W",668).
component("YKL152C",525).
component("YDL021W",218).
component("YEL058W",311).
component("YPR060C",745).
component("YHR072W",424).
component("YPL097W",720).
component("YGR185C",394).
component("YGR264C",403).
component("YGR171C",392).
component("YPL104W",721).
component("YLL018C",546).
component("YPR081C",750).
component("YBR121C",177).
component("YHR020W",415).
component("YER087W",331).
component("YNL247W",641).
component("YOR168W",692).
component("YOL097C",675).
component("YDR268W",278).
component("YCR024C",210).
component("YHR019C",414).
component("YKL194C",532).
component("YIL078W",449).
component("YPL160W",725).
component("YLR382C",587).
component("YNL073W",631).
component("YOR335C",705).
component("YLR153C",564).
component("YAL054C",147).
component("YGR244C",400).
component("YIL145C",459).
component("YJL101C",477).
component("YOL049W",666).
component("YAR015W",149).
component("YER183C",339).
component("U90_",138).
component("YNR057C",659).
component("YDL141W",235).
component("YGL234W",376).
component("YDL141W",236).
component("YJR103W",506).
component("YBL039C",156).
component("YGR204W",397).
component("YBR084W",171).
component("YNL220W",639).
component("YOL058W",669).
component("YDL141W",237).
component("YHR074W",425).
component("YMR217W",618).
component("YGL062W",364).
component("YBR218C",187).
component("YPL231W",736).
component("YNR016C",654).
component("YKL182W",530).
component("YGR037C",382).
component("YPR138C",753).
component("YPL265W",738).
component("YPL134C",723).
component("YPL036W",719).
component("YOR348C",709).
component("YOR222W",699).
component("YOR171C",693).
component("YOR130C",689).
component("YOR011W",682).
component("YOL156W",681).
component("YOL103W",676).
component("YOL020W",665) :- not remove_orf("YOL020W",665).
component("YNR072W",661).
component("YNL270C",646).
component("YNL142W",636).
component("YMR011W",608).
component("YLR260W",575).
component("YLR138W",561).
component("YLR100C",559).
component("YLR081W",557).
component("YLL061W",549).
component("YKR093W",544).
component("YKR053C",541).
component("YKR039W",540) :- not remove_orf("YKR039W",540).
component("YJR158W",514).
component("YJR077C",504).
component("YJL219W",491).
component("YJL214W",489).
component("YJL134W",482).
component("YJL129C",480).
component("YIL134W",457).
component("YHR096C",428).
component("YHR094C",427).
component("YHR092C",426).
component("YHL036W",411).
...
catalyst(6470,658).
catalyst(2300,139).
catalyst(3600,534) :- not remove_reaction(3600,534).
catalyst(8000,545).
catalyst(6890,638).
catalyst(2570,644).
catalyst(8781,279).
...
catalyst(4560,308).
catalyst(2550,657).
catalyst(1890,535) :- not remove_reaction(1890,535).
catalyst(3630,535) :- not remove_reaction(3630,535).
...
catalyst(1210,681).
catalyst(1160,676).
catalyst(801,665) :- not remove_reaction(801,665).
catalyst(802,665) :- not remove_reaction(802,665).
catalyst(811,665) :- not remove_reaction(811,665).
catalyst(812,665) :- not remove_reaction(812,665).
catalyst(831,665) :- not remove_reaction(831,665).
catalyst(832,665) :- not remove_reaction(832,665).
catalyst(901,665) :- not remove_reaction(901,665).
catalyst(902,665) :- not remove_reaction(902,665).
catalyst(1180,661).
catalyst(1210,661).
catalyst(931,646).
catalyst(932,646).
...
catalyst(640,544).
catalyst(6560,541).
catalyst(771,540) :- not remove_reaction(771,540).
catalyst(772,540) :- not remove_reaction(772,540).
catalyst(781,540) :- not remove_reaction(781,540).
catalyst(782,540) :- not remove_reaction(782,540).
catalyst(801,540) :- not remove_reaction(801,540).
catalyst(802,540) :- not remove_reaction(802,540).
catalyst(811,540) :- not remove_reaction(811,540).
catalyst(812,540) :- not remove_reaction(812,540).
catalyst(831,540) :- not remove_reaction(831,540).
catalyst(832,540) :- not remove_reaction(832,540).
catalyst(841,540) :- not remove_reaction(841,540).
catalyst(842,540) :- not remove_reaction(842,540).
catalyst(851,540) :- not remove_reaction(851,540).
catalyst(852,540) :- not remove_reaction(852,540).
catalyst(881,540) :- not remove_reaction(881,540).
catalyst(882,540) :- not remove_reaction(882,540).
catalyst(901,540) :- not remove_reaction(901,540).
catalyst(902,540) :- not remove_reaction(902,540).
catalyst(921,540) :- not remove_reaction(921,540).
catalyst(922,540) :- not remove_reaction(922,540).
catalyst(931,540) :- not remove_reaction(931,540).
catalyst(932,540) :- not remove_reaction(932,540).
catalyst(1191,540) :- not remove_reaction(1191,540).
catalyst(1192,540) :- not remove_reaction(1192,540).
catalyst(1180,514).
catalyst(1210,514).
catalyst(1581,504).
catalyst(1582,504).
