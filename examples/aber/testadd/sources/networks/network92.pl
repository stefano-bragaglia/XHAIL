...
component("YNL280C",542).
component("YLR056W",464).
component("YGL012W",289).
component("YKR009C",446).
component("YOL086C",563).
component("YMR303C",518).
component("YGL256W",309).
...
component("U45_",85).
component("YML056C",500).
component("YLR432W",496).
component("YHR216W",367).
component("YAR075W",127).
component("YAR073W",126).
component("YDR127W",213).
component("YOL126C",569).
component("YKL085W",432).
component("YDL078C",186).
component("YNL037C",523).
component("YNL009W",521).
component("YLR174W",475).
component("YHR183W",362).
component("YGR256W",329).
component("YOL059W",561).
component("YDL022W",182).
component("YCL018W",170).
component("YLR355C",491).
component("YDL174C",199).
component("YML086C",502).
component("YGR088W",317).
component("YDR256C",224).
component("YJR078W",420).
component("YJR025C",413).
component("U107_",24).
component("YHR007C",339).
component("YJR104C",422).
component("YHR008C",340).
component("YOR384W",601).
component("YOR381W",600).
component("YOL152W",571).
component("YLL051C",457).
component("YJL026W",388).
component("YIL066C",371).
component("YGR180C",320).
component("YER070W",265).
component("U37_",79).
component("U36_",78).
component("YDL168W",197).
component("YJR009C",411).
component("YJL052W",390).
component("YGR192C",322).
component("YBR006W",136).
component("YPL276W",626).
component("YPL275W",625).
component("YOR388C",602).
component("YOR374W",598).
component("YER073W",266).
component("YGL154C",301).
component("U55_",92).
component("YER069W",263).
component("YOR323C",591).
component("YER178W",272).
component("YBR221C",159).
component("YIL125W",377).
component("U52_",90).
component("YBR166C",155).
component("YGL012W",290).
component("YKL216W",445).
component("YKR009C",447).
component("YIL160C",381).
component("YGL205W",306).
component("YMR118C",510).
component("YLR164W",473).
component("YLL041C",456).
component("YKL148C",436).
component("YKL141W",434).
component("YJL045W",389).
component("YDR178W",220).
component("YEL047C",251).
component("YDL171C",198).
component("YOR375C",599).
component("YDL215C",201).
component("YAL062W",124).
component("U99_",119).
component("U100_",20).
component("YBR035C",142).
component("YKR080W",452).
component("YER023W",257).
component("YOR236W",589).
...
component("YKL150W",437).
component("YIL043C",370).
component("YHR042W",344).
component("YPL171C",613).
component("YHR179W",361).
component("YMR145C",513).
component("YML120C",503).
component("YKL192C",442).
component("YDL085W",188).
component("YGR234W",325).
component("YFR030W",283).
component("YPL017C",604).
component("YFL018C",276).
component("YDR353W",231).
component("YPR167C",638).
component("YJR137C",425).
component("YNL052W",525).
component("YMR256C",517).
component("YLR395C",495).
component("YLR038C",462).
component("YIL111W",374).
component("YHR051W",348).
component("YGL191W",304).
component("YGL187C",303).
component("YDL067C",185).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",624).
component("YKR069W",451).
component("YOL096C",564).
component("U47_",87).
component("YJR073C",418).
component("YDR120C",211).
component("YML008C",497).
component("YDL033C",184).
component("YOL096C",565).
component("YLR172C",474).
component("YLR058C",465).
component("YDR019C",206).
component("YBR176W",156).
component("YDR408C",236).
component("YMR120C",511).
component("YLR028C",460).
component("YBL013W",128).
component("YJL130C",398).
component("YKL024C",430).
component("YPR074C",634).
component("YBR117C",150).
component("YCL009C",169).
component("YNL071W",527).
component("YNR008W",547).
component("YIL160C",382).
component("U48_",88).
component("YPL231W",619).
component("YPL231W",620).
component("YPL028W",605).
component("YLR299W",484).
component("YGL017W",291).
component("YML126C",504).
component("YNL104C",530).
component("YDL182W",200).
component("YDL131W",192).
component("YLR258W",481).
component("YFR015C",281).
component("YNL029C",522).
component("YIL085C",372).
component("YMR306W",519).
component("YLR342W",490).
component("YGR032W",312).
component("YLR209C",477).
component("U104_",21).
component("YDR354W",232) :- not remove_orf("YDR354W",232).
component("YFR047C",284).
component("YJR133W",424).
component("YLR209C",478).
component("YML022W",498).
component("YDR441C",238).
component("YJL167W",403).
component("YJL167W",404).
component("YDR127W",214).
component("YHR068W",350).
component("YLR303W",486).
component("YGR012W",310).
component("YML082W",501).
component("YJR130C",423).
component("YDR035W",207).
component("YBR249C",160).
component("YLR180W",476).
component("YDR502C",241).
component("YOR274W",590).
component("YHR137W",357).
component("YGL202W",305).
component("YLR027C",459).
component("YKL106W",433).
component("YOL140W",570).
component("YGR019W",311).
component("YLR089C",467).
component("U64_",97).
component("U61_",94).
component("YJR148W",426).
component("YFL030W",277).
component("YOR184W",583).
component("YNR058W",552).
component("YIL116W",376).
component("YGL253W",308).
component("YFR053C",285).
component("YMR013C",508).
component("YMR205C",514).
component("YGR240C",326).
component("YOL016C",556).
component("YFR014C",280).
component("YCR036W",179).
component("YCL040W",172).
component("U15_",43).
component("YPL188W",614).
component("YJR049C",415).
component("YEL041W",249).
component("U96_",117).
component("YKL001C",429).
component("YDR236C",222).
component("YHL032C",337).
component("YDR531W",245).
component("U83_",113).
component("U82_",112).
component("U81_",111).
component("YMR208W",515).
component("YPL203W",615).
component("YOR061W",574).
component("YKL166C",439).
component("YJL164C",402).
component("YIL035C",369).
component("YHR205W",365).
component("YHR102W",356).
component("YGL019W",292).
component("YHR025W",343).
component("YOR347C",596).
component("YAL038W",122).
component("YNR012W",548).
component("YDR127W",215).
component("YDR147W",218).
component("YCR012W",174).
component("YER069W",264).
component("U76_",107).
component("YER170W",271).
component("YDR226W",221).
component("YKL067W",431).
component("YOL055C",559).
component("YDR454C",239).
component("YJR057W",416).
component("YOL061W",562).
component("YKL181W",440).
component("YHL011C",336).
component("YER099C",270).
component("YBL068W",134).
component("YOR143C",579).
component("YNL256W",539).
component("YLR328W",488).
component("YBR018C",138).
component("YLR328W",489).
component("U94_",116).
component("YBR029C",141).
component("YGL130W",299).
component("YDR530C",244).
component("YPR190C",641).
component("YPR187W",640).
component("YPR110C",635).
component("YPR010C",629).
component("YOR341W",595).
component("YOR340C",594).
component("YOR224C",588).
component("YOR210W",587).
component("YOR207C",585).
component("YOR151C",580).
component("YOR116C",576).
component("YOL005C",554).
component("YNR003C",546).
component("YNL248C",538).
component("YNL151C",534).
component("YNL113W",531).
component("YKL144C",435).
component("YJR063W",417).
component("YJL148W",401).
component("YJL140W",400).
component("YIL021W",368).
component("YHR143W-A",358).
component("YGL070C",297).
component("YFL036W",278).
component("YDR404C",235).
component("YDR156W",219).
component("YDR045C",208).
component("YDL150W",195).
component("YDL140C",193).
component("YBR154C",154).
component("YPR175W",639).
component("YPL167C",612).
component("YOR330C",592).
component("YOL115W",568).
component("YNL299W",544).
component("YNL262W",540).
component("YNL102W",529).
component("YJR043C",414).
component("YJR006W",410).
component("YJL090C",393).
component("YIL139C",379).
component("YEL055C",252).
component("YDR419W",237).
component("YDR121W",212).
component("YDL102W",191).
component("YCR014C",175).
component("YBR278W",164).
component("YBL035C",131).
component("YPR113W",636).
component("YPL148C",610).
component("YGR286C",333).
component("YHR189W",363).
component("YDR058C",210).
component("YDL086W",189).
component("YOL011W",555).
component("YMR008C",506).
component("YMR006C",505).
component("U105_",22).
component("YBL015W",129).
component("YJL068C",391).
component("U77_",108).
component("YLR377C",493).
component("YPR073C",632).
component("YHR215W",366).
component("YDL024C",183).
component("YBR093C",148).
component("YBR092C",147).
component("YHR046C",347).
component("U9_",120).
component("YDL236W",203).
component("YPR073C",633).
component("YOR208W",586).
component("YNL053W",526).
component("YMR036C",509).
component("YIR026C",386).
component("YIL113W",375).
component("YFR028C",282).
component("YER075C",267).
...
component("U25_",71).
component("U24_",70).
component("YHR044C",346).
component("YHR043C",345).
component("YOR360C",597).
component("YKR031C",448).
component("YPL206C",616).
component("YGL027C",294).
component("YLR286C",483).
component("YJR153W",427).
component("YJL221C",409).
component("YJL216C",407).
component("YIL172C",385).
component("YGR292W",335).
component("YGR287C",334).
component("YBR299W",168).
component("YOR190W",584).
component("YLR300W",485).
component("YGR282C",332).
component("YDR261C",225).
component("YDR400W",234).
component("YML035C",499).
component("YJL070C",392).
component("YBR284W",165).
component("U106_",23).
component("YER043C",258).
component("YNL045W",524).
component("YDR242W",223).
component("U53_",91).
component("YPR062W",631).
component("YMR120C",512).
component("YLR028C",461).
component("YHR144C",359).
component("YGR267C",331).
component("YBL033C",130).
component("YNL141W",532).
component("YLR245C",480).
component("YBR084W",145).
component("YJL126W",396).
component("U44_",84).
component("YDL100C",190).
component("U40_",82).
component("U39_",80).
component("YBR011C",137).
component("YHR201C",364).
component("YBR111C",149).
component("YBR252W",161).
component("YER005W",256).
component("YBL099W",135).
component("YLR231C",479).
component("YLR134W",469).
component("YLR044C",463).
component("YGR087C",316).
component("YDR380W",233).
component("YDL080C",187).
component("U98_",118).
component("YMR250W",516).
component("YOR128C",577).
component("YEL021W",248).
component("U93_",115).
component("YKL211C",443) :- not remove_orf("YKL211C",443).
component("YKR097W",454).
component("YNL169C",535).
component("YEL046C",250).
component("YNR033W",550).
component("YKL211C",444) :- not remove_orf("YKL211C",444).
component("YER090W",444) :- not remove_orf("YER090W",444).
component("YER090W",269) :- not remove_orf("YER090W",269).
component("YDR127W",216).
component("YPL281C",627).
component("YOR393W",603).
component("YMR323W",520).
component("YHR174W",360).
component("YGR254W",328).
component("YPL262W",622).
component("YGL026C",293) :- not remove_orf("YGL026C",293).
component("YLR304C",487).
component("YJL200C",405).
component("YNL316C",545).
component("YPL212C",617).
component("YNL292W",543).
component("YGL063W",296).
component("YFL001W",274).
component("YPR002W",628).
component("YJR016C",412).
component("YCR053W",180).
component("YDR127W",217).
component("YGL148W",300).
component("YIL168W",384).
component("YIL167W",383).
component("YCL064C",173).
component("YLR359W",492).
component("YAL012W",121).
component("YJL005W",387).
component("YJL121C",395).
component("YBR019C",139).
component("YDR007W",205) :- not remove_orf("YDR007W",205).
component("YOR095C",575).
component("YBR196C",157).
component("YGL001C",287).
component("YPL117C",609).
component("U14_",37).
component("YOL056W",560).
component("YKL152C",438).
component("YDL021W",181).
component("YEL058W",253).
component("YPR060C",630).
component("YHR072W",351).
component("YPL097W",607).
component("YGR185C",321).
component("YGR264C",330).
component("YGR171C",319).
component("YPL104W",608).
component("YLL018C",455).
component("YHR020W",342).
component("YER087W",268).
component("YNL247W",537).
component("YOR168W",581).
component("YOL097C",566).
component("YDR268W",226).
component("YCR024C",176).
component("YHR019C",341).
component("YPL160W",611).
component("YLR382C",494).
component("YNL073W",528).
component("YOR335C",593).
component("YLR153C",472).
component("YAL054C",123).
component("YGR244C",327).
component("YIL145C",380).
component("YJL101C",394).
component("YOL049W",558).
component("YAR015W",125).
component("YER183C",273).
component("U90_",114).
component("YNR057C",551).
component("YGL234W",307).
component("YJR103W",421).
component("YBL039C",132).
component("YGR204W",324).
component("YBR084W",146).
component("YNL220W",536).
component("YDL141W",194).
component("YHR074W",352).
component("YGL062W",295).
component("YBR218C",158).
component("YPL231W",621).
component("YNR016C",549).
component("YKL182W",441).
component("YGR037C",313).
component("YPR138C",637).
component("YPL265W",623).
component("YPL036W",606).
component("YOR171C",582).
component("YOR130C",578).
component("YOR011W",573).
component("YOL156W",572).
component("YOL103W",567).
component("YOL020W",557) :- not remove_orf("YOL020W",557).
component("YNR072W",553).
component("YNL270C",541).
component("YNL142W",533).
component("YMR011W",507).
component("YLR260W",482).
component("YLR138W",470).
component("YLR100C",468).
component("YLR081W",466).
component("YLL061W",458).
component("YKR093W",453).
component("YKR053C",450).
component("YKR039W",449) :- not remove_orf("YKR039W",449).
component("YJR158W",428).
component("YJR077C",419).
component("YJL219W",408).
component("YJL214W",406).
component("YJL134W",399).
component("YJL129C",397).
component("YIL134W",378).
component("YHR096C",355).
component("YHR094C",354).
component("YHR092C",353).
component("YHL036W",338).
component("YGR121C",318).
component("YGR065C",315).
component("YGR055W",314).
component("YGL186C",302).
component("YGL077C",298).
component("YGL008C",288).
component("YFL055W",279).
component("YFL011W",275).
component("YER060W-A",262).
component("YER060W",261).
component("YER056C",260).
component("YER053C",259).
component("YEL069C",255).
component("YEL063C",254).
component("YEL017C-A",247).
component("YDR536W",246).
component("YDR508C",243).
component("YDR503C",242).
component("YDR497C",240).
component("YDR345C",230).
component("YDR343C",229).
component("YDR342C",228).
component("YDR297W",227).
component("YDR046C",209) :- not remove_orf("YDR046C",209).
component("YDL245C",204).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,232) :- not remove_reaction(3620,232).
catalyst(2110,284).
catalyst(2190,284).
catalyst(5550,424).
catalyst(5791,478).
...
catalyst(5880,248).
catalyst(2300,115).
catalyst(3600,443) :- not remove_reaction(3600,443).
catalyst(8000,454).
catalyst(6890,535).
catalyst(4560,250).
catalyst(2550,550).
catalyst(1890,444) :- not remove_reaction(1890,444).
catalyst(3630,444) :- not remove_reaction(3630,444).
catalyst(1890,269) :- not remove_reaction(1890,269).
...
catalyst(8051,622).
catalyst(8052,622).
catalyst(3590,293) :- not remove_reaction(3590,293).
catalyst(10910,293) :- not remove_reaction(10910,293).
catalyst(8181,487).
catalyst(8182,487).
catalyst(8181,405).
catalyst(8182,405).
...
catalyst(1210,572).
catalyst(1160,567).
catalyst(801,557) :- not remove_reaction(801,557).
catalyst(802,557) :- not remove_reaction(802,557).
catalyst(811,557) :- not remove_reaction(811,557).
catalyst(812,557) :- not remove_reaction(812,557).
catalyst(831,557) :- not remove_reaction(831,557).
catalyst(832,557) :- not remove_reaction(832,557).
catalyst(901,557) :- not remove_reaction(901,557).
catalyst(902,557) :- not remove_reaction(902,557).
catalyst(1210,553).
catalyst(931,541).
catalyst(932,541).
catalyst(371,533).
...
catalyst(640,453).
catalyst(6560,450).
catalyst(771,449) :- not remove_reaction(771,449).
catalyst(772,449) :- not remove_reaction(772,449).
catalyst(781,449) :- not remove_reaction(781,449).
catalyst(782,449) :- not remove_reaction(782,449).
catalyst(801,449) :- not remove_reaction(801,449).
catalyst(802,449) :- not remove_reaction(802,449).
catalyst(811,449) :- not remove_reaction(811,449).
catalyst(812,449) :- not remove_reaction(812,449).
catalyst(831,449) :- not remove_reaction(831,449).
catalyst(832,449) :- not remove_reaction(832,449).
catalyst(841,449) :- not remove_reaction(841,449).
catalyst(842,449) :- not remove_reaction(842,449).
catalyst(851,449) :- not remove_reaction(851,449).
catalyst(852,449) :- not remove_reaction(852,449).
catalyst(881,449) :- not remove_reaction(881,449).
catalyst(882,449) :- not remove_reaction(882,449).
catalyst(901,449) :- not remove_reaction(901,449).
catalyst(902,449) :- not remove_reaction(902,449).
catalyst(921,449) :- not remove_reaction(921,449).
catalyst(922,449) :- not remove_reaction(922,449).
catalyst(931,449) :- not remove_reaction(931,449).
catalyst(932,449) :- not remove_reaction(932,449).
catalyst(1191,449) :- not remove_reaction(1191,449).
catalyst(1192,449) :- not remove_reaction(1192,449).
catalyst(1210,428).
catalyst(1581,419).
catalyst(1582,419).
catalyst(1210,408).
