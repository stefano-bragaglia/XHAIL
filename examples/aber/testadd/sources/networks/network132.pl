...
component("YNL280C",712).
component("YLR056W",612).
component("YGR060W",423).
component("YGL012W",394).
component("YKR009C",593).
component("YOL086C",740).
component("YMR303C",686).
component("YMR083W",671).
component("YGL256W",416).
component("YDL168W",268).
component("YBR145W",202).
component("YPL231W",804).
component("YBR265W",219).
component("U46_",119).
component("YBR149W",203).
component("YBR149W",204).
component("YGL001C",391).
component("YIL094C",498).
component("U45_",118).
component("YML056C",658).
component("YLR432W",648).
component("YHR216W",489).
component("YAR075W",174).
component("YAR073W",173).
component("YDR127W",295).
component("YJR139C",563).
component("YML075C",660).
component("YLR450W",651).
component("YOL126C",746).
component("YKL085W",573).
component("YDL078C",251).
component("YNL037C",691).
component("YNL009W",689).
component("YLR174W",625).
component("YHR183W",482).
component("YGR256W",445).
component("YNL241C",705).
component("YOL059W",737).
component("YDL022W",244).
component("YCL018W",227).
component("YLR355C",643).
component("YIL074C",495).
component("YER081W",365).
component("YDL174C",272).
component("YML086C",662).
component("YIL155C",507).
component("YEL024W",341).
component("YKR066C",598).
component("YGR088W",427).
component("YDR256C",309).
component("YKL026C",569).
component("YIR037W",517).
component("YBR244W",214).
component("YJR078W",556).
component("U58_",128).
...
component("YGL055W",401).
component("YJR104C",558).
component("YHR008C",457).
component("YOR384W",783).
component("YOR381W",782).
component("YOL152W",748).
component("YLL051C",605).
component("YJL026W",519).
component("YIL066C",494).
component("YGR180C",434).
component("YER070W",362).
component("U37_",112).
component("U36_",111).
component("U35_",110).
component("YDL168W",269).
component("YDR158W",303).
component("YJR009C",545).
component("YJL052W",521).
component("YGR192C",436).
component("YBR006W",184).
component("YPL276W",812).
component("YPL275W",811).
component("YOR388C",784).
component("YPL061W",789).
component("YOR374W",780).
component("YER073W",363).
component("YGL154C",408).
component("YBR115C",198).
component("U55_",127).
component("YER069W",360).
component("YOR323C",772).
component("YER178W",375).
component("YBR221C",212).
component("YIL125W",503).
component("U52_",124).
component("YBR166C",207).
component("YNL280C",713).
component("YGL012W",395).
component("YKL182W",583).
component("YKL216W",592).
component("YDR044W",285).
component("YKR009C",594).
component("YIL160C",508).
component("YGL205W",413).
component("YMR118C",674).
component("YLR164W",623).
component("YLL041C",604).
component("YKL148C",578).
component("YKL141W",576).
component("YJL045W",520).
component("YDR178W",304).
component("YEL047C",344).
component("YDL171C",270).
component("YDL171C",271).
component("YOR375C",781).
component("YDL215C",276).
component("YAL062W",170).
component("U99_",164).
component("U100_",20).
component("YBR035C",190).
component("YKR080W",600).
component("YER023W",351).
component("YOR236W",770).
component("YGR204W",438).
component("YIR034C",516).
component("YLR142W",620).
component("U65_",135).
component("U63_",133).
component("U62_",132).
component("YHR068W",467).
component("YKL150W",579).
component("YIL043C",492).
component("YHR042W",462).
component("YOR221C",767).
component("YMR145C",677).
component("YKL192C",586).
component("YKL055C",571).
component("YER061C",358).
component("YDL085W",253).
component("YPL171C",797).
component("YHR179W",481).
component("YMR145C",678).
component("YML120C",663).
component("YKL192C",587).
component("YDL085W",254).
component("YGR234W",440).
component("YFR030W",387).
component("YPL017C",786).
component("YFL018C",379).
component("YDR353W",319).
component("YPR167C",827).
component("YJR137C",562).
component("YNL052W",693).
component("YMR256C",684).
component("YLR395C",647).
component("YLR038C",610).
component("YIL111W",500).
component("YHR051W",466).
component("YGL191W",411).
component("YGL187C",410).
component("YDL067C",250).
component("Q0275",19).
component("Q0250",18).
component("YDR072C",290).
component("YPL266W",810).
component("YKR069W",599).
component("YOL096C",741).
component("U47_",120).
component("YER091C",370).
component("YJR073C",554).
component("YGR157W",432).
component("YDR120C",293).
component("YML008C",653).
component("YOR074C",753).
component("YDL033C",246).
component("YOL096C",742).
component("YLR172C",624).
component("YLR058C",613).
component("YDR019C",282).
component("YBR176W",208).
component("YDR408C",325).
component("YMR120C",675).
component("YLR028C",608).
component("YBL013W",175).
component("YJL130C",530).
component("YJL088W",524).
component("YKL024C",568).
component("YPR074C",822).
component("YBR117C",199).
component("YMR108W",673).
component("YCL009C",226).
component("YNL071W",695).
component("YNR008W",718).
component("YIL160C",509).
component("YNR019W",721).
component("YCR048W",240).
component("U48_",121).
component("YMR062C",670).
component("YDR232W",306).
component("YPL231W",805).
component("YER061C",359).
component("YDL052C",249).
component("U8_",158).
component("YDR148C",301).
component("YPL231W",806).
component("YPL028W",787).
component("YLR299W",635).
component("YGL017W",396).
component("YCR005C",232).
component("YML126C",664).
component("YNL104C",698).
component("YDL182W",273).
component("YDL131W",259).
component("YDR307W",315).
component("YLR258W",632).
component("YFR015C",385).
component("YNL029C",690).
component("YIL085C",497).
component("YMR306W",687).
component("YLR342W",641).
component("YGR032W",420).
component("YPR183W",829).
component("YBR248C",215).
component("YLR209C",627).
component("U104_",21).
component("YDR354W",320) :- not remove_orf("YDR354W",320).
component("YFR047C",388).
component("YJR133W",561).
component("YLR209C",628).
component("YML022W",655).
component("YDR441C",328).
component("YHR128W",476).
component("YJL167W",537).
component("YJL167W",538).
component("YPR069C",819).
component("YDR127W",296).
component("YHR190W",484).
component("YLR146C",621).
component("YHR068W",468).
component("YLR303W",637).
component("YGR012W",418).
component("YML082W",661).
component("YJR130C",560).
component("YDR035W",284).
component("YBR249C",216).
component("YLR180W",626).
component("YDR502C",332).
component("YOR274W",771).
component("YBR256C",218).
component("YHR137W",477).
component("YGL202W",412).
component("YLR027C",607).
component("YKL106W",574).
component("YOL140W",747).
component("YLR438W",650).
component("YGR019W",419).
component("YLR089C",616).
component("U64_",134).
component("U61_",131).
component("U51_",123).
component("YJR148W",564).
component("YHR208W",487).
component("YFL030W",381).
component("YOR184W",762).
component("YNR058W",727).
component("YIL116W",502).
component("YGL253W",415).
component("YFR053C",389).
component("YMR013C",668).
component("YMR205C",680).
component("YGR240C",441).
component("YOL016C",731).
component("YFR014C",384).
component("YLR240W",630).
component("YKL203C",589).
component("YJR066W",553).
component("YCR036W",239).
component("YCL040W",229).
component("U15_",56).
component("YPL188W",799).
component("YJR049C",550).
component("YEL041W",342).
component("U96_",162).
component("YKL001C",567).
component("YDR236C",307).
component("YHL032C",454).
component("YDR531W",336).
component("U83_",153).
component("U82_",152).
component("U81_",151).
component("YMR208W",681).
component("YPL203W",800).
component("YOR061W",752).
component("YKL166C",581).
component("YJL164C",536).
component("YIL035C",491).
component("YHR205W",486).
component("YHR102W",474).
component("YGL019W",397).
component("YHR025W",461).
component("YOR347C",777).
component("YAL038W",168).
component("YNR012W",719).
component("YDR009W",281).
component("YDR127W",297).
component("YDR147W",300).
component("YDR300C",314).
component("YCR012W",233).
component("YER069W",361).
component("U19_",85).
component("U18_",77).
component("U17_",69).
component("U76_",145).
component("YER170W",374).
component("YDR226W",305).
component("YKL067W",572).
component("YOL055C",734).
component("YDR454C",329).
component("YJR057W",551).
component("YOL061W",738).
component("YKL181W",582).
component("YHL011C",452).
component("YER099C",371).
component("YBL068W",182).
component("YOR143C",758).
component("YNL256W",708).
component("YLR328W",639).
component("YBR018C",186).
component("YGR007W",417).
component("YGR202C",437).
component("YLR328W",640).
component("U80_",150).
component("YDL103C",258).
component("U94_",161).
component("YJR010W",546).
component("YBR029C",189).
component("YCL050C",230).
component("YGL130W",406).
component("YDR530C",335).
component("YPR190C",831).
component("YPR187W",830).
component("YPR110C",824).
component("YPR010C",815).
component("YOR341W",776).
component("YOR340C",775).
component("YOR224C",769).
component("YOR210W",766).
component("YOR207C",764).
component("YOR151C",759).
component("YOR116C",755).
component("YOL005C",729).
component("YNR003C",717).
component("YNL248C",707).
component("YNL151C",702).
component("YNL113W",699).
component("YKL144C",577).
component("YJR063W",552).
component("YJL148W",534).
component("YJL140W",533).
component("YIL021W",490).
component("YHR143W-A",478).
component("YGL070C",404).
component("YFL036W",382).
component("YDR404C",324).
component("YDR156W",302).
component("YDR045C",286).
component("YDL150W",267).
component("YDL140C",261).
component("YBR154C",206).
component("YPR175W",828).
component("YPL167C",796).
component("YOR330C",773).
component("YOL115W",745).
component("YNL299W",715).
component("YNL262W",710).
component("YNL102W",697).
component("YJR043C",549).
component("YJR006W",544).
component("YJL090C",525).
component("YIL139C",505).
component("YEL055C",345).
component("YDR419W",326).
component("YDR121W",294).
component("YDL102W",257).
component("YCR014C",234).
component("YBR278W",221).
component("YBL035C",178).
component("YKL035W",570).
component("YHL012W",453).
component("YHR123W",475).
component("YPR113W",825).
component("YBR243C",213).
component("YDL142C",266).
component("YPL148C",794).
component("YER026C",352).
component("YGR286C",449).
component("YHR189W",483).
component("YDR058C",289).
component("YDL086W",255).
component("YOL011W",730).
component("YMR008C",666).
component("YMR006C",665).
component("U105_",22).
component("YBL015W",176).
component("YJL068C",522).
component("YOR040W",751).
component("U77_",146).
component("YDR481C",330).
component("YLR377C",645).
component("YPL179W",798).
component("YNR032W",722).
component("YML057W",659).
component("YML016C",654).
component("YLR433C",649).
component("YGR123C",430).
component("YER133W",372).
component("YER089C",368).
component("YDR436W",327).
component("YDR075W",291).
component("YDL188C",274).
component("YDL134C",260).
component("YDL047W",248).
component("YDL006W",242).
component("YBR125C",201).
component("YBL056W",181).
component("YPR073C",820).
component("YHR215W",488).
component("YDL024C",245).
component("YBR093C",196).
component("YBR092C",195).
component("YAR071W",172).
component("YHR046C",465).
component("U9_",165).
component("YPL228W",803).
component("YMR180C",679).
component("YDL236W",278).
component("YJL155C",535).
component("YPR073C",821).
component("YOR208W",765).
component("YNL053W",694).
component("YMR036C",669).
component("YIR026C",515).
component("YIL113W",501).
component("YFR028C",386).
component("YER075C",364).
component("YDL230W",277).
component("YBR276C",220).
component("U34_",109).
component("U33_",108).
component("U32_",107).
component("U31_",106).
...
component("U25_",100).
component("U24_",99).
component("YHR044C",464).
component("YHR043C",463).
component("YOL064C",739).
component("YOR360C",779).
component("YKR031C",595).
component("YPL206C",801).
component("YGL027C",399).
component("YLR286C",634).
component("YJR153W",565).
component("YJL221C",543).
component("YJL216C",541).
component("YIL172C",513).
component("YGR292W",451).
component("YGR287C",450).
component("YBR299W",225).
component("YBR184W",209).
component("YIL162W",510).
component("YIR019C",514).
component("YIL099W",499).
component("YDL037C",247).
component("YOR190W",763).
component("YLR300W",636).
component("YGR282C",448).
component("YDR261C",310).
component("YDR400W",322).
component("YML035C",656).
component("YJL070C",523).
component("YBR284W",222).
component("U106_",23).
component("YER043C",353).
component("YNL045W",692).
component("YGL037C",400).
component("YDR242W",308).
component("U53_",125).
component("YPR062W",818).
component("YMR120C",676).
component("YLR028C",609).
component("YHR144C",479).
component("YGR267C",447).
component("YBL033C",177).
component("YBR153W",205).
component("YNL141W",700).
component("YLR245C",631).
component("YML035C",657).
component("YBR084W",193).
component("YJL126W",528).
component("U44_",117).
component("YDL100C",256).
component("U87_",155).
component("U40_",115).
component("U39_",113).
component("YBR011C",185).
component("YHR201C",485).
component("YBR111C",197).
component("YBR252W",217).
component("YER005W",350).
component("YIL048W",493).
component("YER166W",373).
component("YDR093W",292).
component("YAL026C",167).
component("YBL099W",183).
component("U60_",130).
component("YLR231C",629).
component("U88_",156).
component("YDR538W",338).
component("YLR134W",618).
component("YLR044C",611).
component("YGR087C",426).
component("YDR380W",321).
component("YDL080C",252).
component("U98_",163).
component("YMR250W",683).
component("YOR128C",756).
component("YEL021W",340).
component("YNR043W",724).
component("U93_",160).
component("U54_",126).
component("YKL211C",590) :- not remove_orf("YKL211C",590).
component("YKR097W",602).
component("YNL169C",703).
component("YNL256W",709).
component("YDR294C",312).
component("YEL046C",343).
component("YNR033W",723).
component("YKL211C",591) :- not remove_orf("YKL211C",591).
component("YER090W",591) :- not remove_orf("YER090W",591).
component("YER090W",369) :- not remove_orf("YER090W",369).
component("YDR127W",298).
component("YPL281C",813).
component("YOR393W",785).
component("YMR323W",688).
component("YHR174W",480).
component("YGR254W",443).
component("YPL262W",808).
component("YGL026C",398) :- not remove_orf("YGL026C",398).
component("YGR155W",431).
component("YLR304C",638).
component("YJL200C",539).
component("YNL316C",716).
component("YKL182W",584).
component("YPL212C",802).
component("YNL292W",714).
component("YGL063W",403).
component("YFL001W",377).
component("YPR002W",814).
component("YJR016C",547).
component("YCR053W",241).
component("YDR127W",299).
component("YGL148W",407).
component("YIL168W",512).
component("YIL167W",511).
component("YCL064C",231).
component("YER086W",366).
component("YLR359W",644).
component("YAL012W",166).
component("YML004C",652).
component("YFR055W",390).
component("YJL005W",518).
component("YJL121C",527).
component("YBR019C",187).
component("YDR050C",288).
component("YDR007W",280) :- not remove_orf("YDR007W",280).
component("YOR095C",754).
component("YER003C",349).
component("YBR196C",210).
component("YGL001C",392).
component("YPL117C",792).
component("U14_",48).
component("YOL056W",735).
component("YKL152C",580).
component("YDL021W",243).
component("YMR105C",672).
component("YKL127W",575).
component("YEL058W",346).
component("YPR060C",817).
component("YHR072W",469).
component("YPL097W",790).
component("YGR185C",435).
component("YGR264C",446).
component("YGR171C",433).
component("YHR011W",458).
component("YDR023W",283).
component("YPL104W",791).
component("YLL018C",603).
component("YPR081C",823).
component("YBR121C",200).
component("YHR020W",460).
component("YER087W",367).
component("YNL247W",706).
component("YOR168W",760).
component("YOL097C",743).
component("YDR268W",311).
component("YPR047W",816).
component("YLR060W",614).
component("YFL022C",380).
component("YCR024C",235).
component("YHR019C",459).
component("YKL194C",588).
component("YIL078W",496).
component("YPL160W",795).
component("YLR382C",646).
component("YNL073W",696).
component("YOR335C",774).
component("YGR094W",428).
component("YLR153C",622).
component("YAL054C",169).
component("YGR244C",442).
component("YIL145C",506).
component("U89_",157).
component("YJL101C",526).
component("YOL049W",733).
component("YAR015W",171).
component("YER183C",376).
component("U90_",159).
component("YNR057C",726).
component("YDL141W",262).
component("YDL141W",263).
component("YGL234W",414).
component("YDL141W",264).
component("YJR103W",557).
component("YBL039C",179).
component("YGR204W",439).
component("YBR084W",194).
component("YNL220W",704).
component("YOL058W",736).
component("YDL141W",265).
component("YHR074W",470).
component("YMR217W",682).
component("YGR061C",424).
component("YJR109C",559).
component("YJL130C",531).
component("YGL062W",402).
component("YBR218C",211).
component("YPL231W",807).
component("YNR016C",720).
component("YKL182W",585).
component("YGR037C",421).
component("YPR138C",826).
component("YPL265W",809).
component("YPL134C",793).
component("YPL036W",788).
component("YOR348C",778).
component("YOR222W",768).
component("YOR171C",761).
component("YOR130C",757).
component("YOR011W",750).
component("YOL156W",749).
component("YOL103W",744).
component("YOL020W",732) :- not remove_orf("YOL020W",732).
component("YNR072W",728).
component("YNR056C",725).
component("YNL270C",711).
component("YNL142W",701).
component("YMR272C",685).
component("YMR011W",667).
component("YLR348C",642).
component("YLR260W",633).
component("YLR138W",619).
component("YLR100C",617).
component("YLR081W",615).
component("YLL061W",606).
component("YKR093W",601).
component("YKR053C",597).
component("YKR039W",596) :- not remove_orf("YKR039W",596).
component("YJR158W",566).
component("YJR077C",555).
component("YJL219W",542).
component("YJL214W",540).
component("YJL134W",532).
component("YJL129C",529).
component("YIL134W",504).
component("YHR096C",473).
component("YHR094C",472).
component("YHR092C",471).
component("YHL036W",455).
component("YGR121C",429).
component("YGR065C",425).
component("YGR055W",422).
component("YGL186C",409).
component("YGL077C",405).
component("YGL008C",393).
component("YFL055W",383).
component("YFL011W",378).
component("YER060W-A",357).
component("YER060W",356).
component("YER056C",355).
component("YER053C",354).
component("YEL069C",348).
component("YEL063C",347).
component("YEL017C-A",339).
component("YDR536W",337).
component("YDR508C",334).
component("YDR503C",333).
component("YDR497C",331).
component("YDR345C",318).
component("YDR343C",317).
component("YDR342C",316).
component("YDR297W",313).
component("YDR046C",287) :- not remove_orf("YDR046C",287).
component("YDL245C",279).
component("YDL210W",275).
component("YCR032W",238).
component("YCR028C",237).
component("YCR024C-A",236).
component("YCL025C",228).
component("YBR298C",224).
component("YBR291C",223).
component("YBR069C",192) :- not remove_orf("YBR069C",192).
component("YBR068C",191) :- not remove_orf("YBR068C",191).
component("YBR021W",188).
component("YBL042C",180).
component("U85_",154).
component("U7_",149).
component("U79_",148).
component("U78_",147).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,320) :- not remove_reaction(3620,320).
catalyst(2110,388).
catalyst(2190,388).
catalyst(5550,561).
catalyst(5791,628).
...
catalyst(2300,160).
catalyst(3460,126).
catalyst(3600,590) :- not remove_reaction(3600,590).
catalyst(8000,602).
catalyst(6890,703).
catalyst(2570,709).
catalyst(8781,312).
...
catalyst(4560,343).
catalyst(2550,723).
catalyst(1890,591) :- not remove_reaction(1890,591).
catalyst(3630,591) :- not remove_reaction(3630,591).
catalyst(1890,369) :- not remove_reaction(1890,369).
catalyst(3630,369) :- not remove_reaction(3630,369).
catalyst(3740,298).
catalyst(8231,813).
catalyst(8232,813).
catalyst(8231,785).
...
catalyst(8061,808).
catalyst(8062,808).
catalyst(3590,398) :- not remove_reaction(3590,398).
catalyst(10910,398) :- not remove_reaction(10910,398).
catalyst(4570,431).
catalyst(8181,638).
catalyst(8182,638).
catalyst(8181,539).
...
catalyst(1210,749).
catalyst(1160,744).
catalyst(801,732) :- not remove_reaction(801,732).
catalyst(802,732) :- not remove_reaction(802,732).
catalyst(811,732) :- not remove_reaction(811,732).
catalyst(812,732) :- not remove_reaction(812,732).
catalyst(831,732) :- not remove_reaction(831,732).
catalyst(832,732) :- not remove_reaction(832,732).
catalyst(901,732) :- not remove_reaction(901,732).
catalyst(902,732) :- not remove_reaction(902,732).
catalyst(1180,728).
catalyst(1210,728).
catalyst(700,725).
catalyst(931,711).
...
catalyst(640,601).
catalyst(6560,597).
catalyst(771,596) :- not remove_reaction(771,596).
catalyst(772,596) :- not remove_reaction(772,596).
catalyst(781,596) :- not remove_reaction(781,596).
catalyst(782,596) :- not remove_reaction(782,596).
catalyst(801,596) :- not remove_reaction(801,596).
catalyst(802,596) :- not remove_reaction(802,596).
catalyst(811,596) :- not remove_reaction(811,596).
catalyst(812,596) :- not remove_reaction(812,596).
catalyst(831,596) :- not remove_reaction(831,596).
catalyst(832,596) :- not remove_reaction(832,596).
catalyst(841,596) :- not remove_reaction(841,596).
catalyst(842,596) :- not remove_reaction(842,596).
catalyst(851,596) :- not remove_reaction(851,596).
catalyst(852,596) :- not remove_reaction(852,596).
catalyst(881,596) :- not remove_reaction(881,596).
catalyst(882,596) :- not remove_reaction(882,596).
catalyst(901,596) :- not remove_reaction(901,596).
catalyst(902,596) :- not remove_reaction(902,596).
catalyst(921,596) :- not remove_reaction(921,596).
catalyst(922,596) :- not remove_reaction(922,596).
catalyst(931,596) :- not remove_reaction(931,596).
catalyst(932,596) :- not remove_reaction(932,596).
catalyst(1191,596) :- not remove_reaction(1191,596).
catalyst(1192,596) :- not remove_reaction(1192,596).
catalyst(1180,566).
catalyst(1210,566).
catalyst(1581,555).
catalyst(1582,555).
...
catalyst(1210,316).
catalyst(6650,313).
catalyst(801,287) :- not remove_reaction(801,287).
catalyst(802,287) :- not remove_reaction(802,287).
catalyst(811,287) :- not remove_reaction(811,287).
catalyst(812,287) :- not remove_reaction(812,287).
catalyst(831,287) :- not remove_reaction(831,287).
catalyst(832,287) :- not remove_reaction(832,287).
catalyst(841,287) :- not remove_reaction(841,287).
catalyst(842,287) :- not remove_reaction(842,287).
catalyst(851,287) :- not remove_reaction(851,287).
catalyst(852,287) :- not remove_reaction(852,287).
catalyst(901,287) :- not remove_reaction(901,287).
catalyst(902,287) :- not remove_reaction(902,287).
catalyst(1180,279).
catalyst(1210,279).
catalyst(730,275).
catalyst(431,238).
...
catalyst(851,192) :- not remove_reaction(851,192).
catalyst(852,192) :- not remove_reaction(852,192).
...
catalyst(851,191) :- not remove_reaction(851,191).
catalyst(852,191) :- not remove_reaction(852,191).
