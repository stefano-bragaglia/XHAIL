...
component("YLR056W",289).
component("YKR009C",277).
component("YOL086C",350).
component("YMR303C",321).
component("YGL256W",202).
component("YDL168W",126).
component("YBR145W",94).
component("YPL231W",382).
component("U46_",59).
component("YBR149W",95).
component("YGL001C",184).
component("YIL094C",236).
component("U45_",58).
component("YDR127W",137).
component("YOL126C",354).
component("YKL085W",269).
component("YDL078C",120).
component("YNL037C",325).
component("YCL018W",107).
component("YLR355C",308).
component("YDL174C",128).
component("YML086C",313).
component("YGR088W",208).
component("YDR256C",147).
component("YJR078W",263).
component("YJR025C",258).
component("U107_",22).
component("YJL026W",246).
component("YGR180C",211).
component("YER070W",173).
component("U36_",54).
component("YDL168W",127).
component("YPL276W",388).
component("YPL275W",387).
component("YOR388C",373).
component("YOR323C",367).
component("YIL125W",239).
component("U52_",62).
component("YBR166C",97).
component("YKL216W",276).
component("YKR009C",278).
component("YIL160C",242).
component("YGL205W",199).
component("YKR080W",282).
component("YER023W",168).
component("YGR204W",213).
component("YLR142W",294).
component("U65_",65).
component("U62_",64).
component("YHR068W",226).
component("YKL150W",272).
component("YIL043C",234).
component("YPL171C",381).
component("YHR179W",232).
component("YGR234W",214).
component("YDR353W",151).
component("YNL052W",326).
component("YMR256C",320).
component("YLR395C",310).
component("YLR038C",287).
component("YIL111W",237).
component("YHR051W",225).
component("YGL191W",197).
component("YGL187C",196).
component("YDL067C",119).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",386).
component("YKR069W",281).
component("YJR073C",261).
component("YDL033C",118).
component("YLR172C",296).
component("YLR058C",290).
component("YDR019C",132).
component("YBR176W",98).
component("YDR408C",156).
component("YMR120C",318).
component("YLR028C",285).
component("YBL013W",79).
component("YJL130C",251).
component("YKL024C",267).
component("YPR074C",393).
component("YBR117C",93).
component("YCL009C",106).
component("YNL071W",328).
component("U48_",60).
component("YPL231W",383).
component("YPL231W",384).
component("YLR299W",303).
component("YGL017W",187).
component("YML126C",314).
component("YDL182W",129).
component("YDL131W",123).
component("YLR258W",301).
component("YFR015C",180).
component("YNL029C",324).
component("YIL085C",235).
component("YMR306W",322).
component("YLR342W",307).
component("YGR032W",204).
component("YLR209C",297).
component("U104_",20).
component("YDR354W",152) :- not remove_orf("YDR354W",152).
component("YFR047C",182).
component("YLR209C",298).
component("YML022W",311).
component("YDR441C",158).
component("YJL167W",255).
component("YDR127W",138).
component("YLR303W",305).
component("YGR012W",203).
component("YJR130C",265).
component("YDR035W",133).
component("YBR249C",100).
component("YOR274W",366).
component("YHR137W",228).
component("YGL202W",198).
component("YLR027C",284).
component("YKL106W",270).
component("YOL140W",355).
component("YLR089C",291).
component("YJR148W",266).
component("YNR058W",344).
component("YGL253W",201).
component("YFR053C",183).
component("YCR036W",116).
component("YCL040W",109).
component("U96_",75).
component("YDR236C",145).
component("YHL032C",220).
component("YNR012W",342).
component("YDR127W",139).
component("YDR147W",142).
component("YCR012W",111).
component("U76_",72).
component("YER170W",177).
component("YDR226W",144).
component("YKL067W",268).
component("YOL055C",348).
component("YDR454C",159).
component("YOL061W",349).
component("YKL181W",273).
component("YHL011C",219).
component("YER099C",176).
component("YBL068W",83).
component("YNL256W",336).
component("YBR018C",86).
component("YBR029C",88).
component("YGL130W",193).
component("YPR190C",399).
component("YPR187W",398).
component("YPR110C",394).
component("YPR010C",390).
component("YOR341W",371).
component("YOR340C",370).
component("YOR224C",365).
component("YOR210W",364).
component("YOR207C",362).
component("YOR151C",359).
component("YOR116C",358).
component("YOL005C",345).
component("YNR003C",341).
component("YNL248C",335).
component("YNL151C",333).
component("YNL113W",330).
component("YKL144C",271).
component("YJR063W",260).
component("YJL148W",254).
component("YJL140W",253).
component("YIL021W",233).
component("YHR143W-A",229).
component("YGL070C",191).
component("YFL036W",178).
component("YDR404C",155).
component("YDR156W",143).
component("YDR045C",134).
component("YDL150W",125).
component("YDL140C",124).
component("YBR154C",96).
component("YPR175W",397).
component("YPL167C",380).
component("YOR330C",368).
component("YOL115W",353).
component("YNL299W",339).
component("YNL262W",337).
component("YNL102W",329).
component("YJR043C",259).
component("YJR006W",257).
component("YJL090C",248).
component("YIL139C",240).
component("YEL055C",165).
component("YDR419W",157).
component("YDR121W",136).
component("YDL102W",122).
component("YCR014C",112).
component("YBR278W",103).
component("YBL035C",81).
component("YPR113W",395).
component("YPL148C",379).
component("YGR286C",218).
component("YOL011W",346).
component("YMR008C",316).
component("YMR006C",315).
component("U105_",21).
component("YBL015W",80).
component("U77_",73).
component("YLR377C",309).
component("YPR073C",392).
component("YOR208W",363).
component("YNL053W",327).
component("YMR036C",317).
component("YIR026C",245).
component("YIL113W",238).
component("YFR028C",181).
component("YER075C",174).
component("YDL230W",130).
component("YBR276C",102).
component("U30_",53).
component("U29_",52).
component("U24_",51).
component("YHR044C",224).
component("YHR043C",223).
component("YOR360C",372).
component("YGL027C",189).
component("YOR190W",361).
component("YLR300W",304).
component("YGR282C",217).
component("YDR261C",148).
component("YDR400W",154).
component("YML035C",312).
component("YJL070C",247).
component("YBR284W",104).
component("YDR242W",146).
component("U53_",63).
component("YMR120C",319).
component("YLR028C",286).
component("YHR144C",230).
component("YNL141W",331).
component("YLR245C",300).
component("YJL126W",249).
component("U39_",55).
component("YBR011C",85).
component("YBR111C",92).
component("YBR252W",101).
component("YER005W",167).
component("YBL099W",84).
component("YLR231C",299).
component("YLR134W",293).
component("YLR044C",288).
component("YGR087C",207).
component("YDR380W",153).
component("YDL080C",121).
component("U98_",76).
component("YKL211C",274) :- not remove_orf("YKL211C",274).
component("YNL169C",334).
component("YKL211C",275) :- not remove_orf("YKL211C",275).
component("YER090W",275) :- not remove_orf("YER090W",275).
component("YER090W",175) :- not remove_orf("YER090W",175).
component("YDR127W",140).
component("YPL281C",389).
component("YOR393W",374).
component("YMR323W",323).
component("YHR174W",231).
component("YGR254W",215).
component("YGL026C",188) :- not remove_orf("YGL026C",188).
component("YLR304C",306).
component("YJL200C",256).
component("YNL316C",340).
component("YCR053W",117).
component("YDR127W",141).
component("YGL148W",194).
component("YIL168W",244).
component("YIL167W",243).
component("YCL064C",110).
component("YAL012W",77).
component("YBR019C",87).
component("YDR007W",131) :- not remove_orf("YDR007W",131).
component("YOR095C",357).
component("YGL001C",185).
component("YPL117C",378).
component("YPR060C",391).
component("YPL097W",376).
component("YGR185C",212).
component("YGR264C",216).
component("YGR171C",210).
component("YPL104W",377).
component("YLL018C",283).
component("YOL097C",351).
component("YDR268W",149).
component("YCR024C",113).
component("YHR019C",222).
component("YOR335C",369).
component("YLR153C",295).
component("YAL054C",78).
component("YIL145C",241).
component("U90_",74).
component("YNR057C",343).
component("YGL234W",200).
component("YJR103W",264).
component("YBL039C",82).
component("YBR084W",91).
component("YHR074W",227).
component("YGL062W",190).
component("YBR218C",99).
component("YPR138C",396).
component("YPL265W",385).
component("YPL036W",375).
component("YOR171C",360).
component("YOR011W",356).
component("YOL103W",352).
component("YOL020W",347) :- not remove_orf("YOL020W",347).
component("YNL270C",338).
component("YNL142W",332).
component("YLR260W",302).
component("YLR100C",292).
component("YKR053C",280).
component("YKR039W",279) :- not remove_orf("YKR039W",279).
component("YJR077C",262).
component("YJL134W",252).
component("YJL129C",250).
component("YHL036W",221).
component("YGR121C",209).
component("YGR065C",206).
component("YGR055W",205).
component("YGL186C",195).
component("YGL077C",192).
component("YGL008C",186).
component("YFL055W",179).
component("YER060W-A",172).
component("YER060W",171).
component("YER056C",170).
component("YER053C",169).
component("YEL063C",166).
component("YEL017C-A",164).
component("YDR536W",163).
component("YDR508C",162).
component("YDR503C",161).
component("YDR497C",160).
component("YDR297W",150).
component("YDR046C",135) :- not remove_orf("YDR046C",135).
component("YCR032W",115).
component("YCR024C-A",114).
component("YCL025C",108).
component("YBR298C",105).
component("YBR069C",90) :- not remove_orf("YBR069C",90).
component("YBR068C",89) :- not remove_orf("YBR068C",89).
component("U75_",71).
component("U74_",70).
component("U73_",69).
component("U72_",68).
...
catalyst(2121,20).
catalyst(2122,20).
catalyst(3620,152) :- not remove_reaction(3620,152).
catalyst(2190,182).
catalyst(5791,298).
catalyst(5792,298).
catalyst(5801,298).
...
catalyst(8812,121).
catalyst(2250,76).
catalyst(3600,274) :- not remove_reaction(3600,274).
catalyst(6890,334).
catalyst(3630,275) :- not remove_reaction(3630,275).
catalyst(3630,175) :- not remove_reaction(3630,175).
catalyst(3740,140).
catalyst(8231,389).
catalyst(8232,389).
catalyst(8231,374).
...
catalyst(8231,215).
catalyst(8232,215).
catalyst(3590,188) :- not remove_reaction(3590,188).
catalyst(10910,188) :- not remove_reaction(10910,188).
catalyst(8181,306).
catalyst(8182,306).
catalyst(8181,256).
catalyst(8182,256).
...
catalyst(7751,87).
catalyst(7752,87).
catalyst(3610,131) :- not remove_reaction(3610,131).
catalyst(7921,357).
catalyst(7922,357).
catalyst(6370,185).
catalyst(6461,378).
...
catalyst(6330,292).
catalyst(6560,280).
catalyst(771,279) :- not remove_reaction(771,279).
catalyst(772,279) :- not remove_reaction(772,279).
catalyst(781,279) :- not remove_reaction(781,279).
catalyst(782,279) :- not remove_reaction(782,279).
catalyst(801,279) :- not remove_reaction(801,279).
catalyst(802,279) :- not remove_reaction(802,279).
catalyst(811,279) :- not remove_reaction(811,279).
catalyst(812,279) :- not remove_reaction(812,279).
catalyst(831,279) :- not remove_reaction(831,279).
catalyst(832,279) :- not remove_reaction(832,279).
catalyst(841,279) :- not remove_reaction(841,279).
catalyst(842,279) :- not remove_reaction(842,279).
catalyst(851,279) :- not remove_reaction(851,279).
catalyst(852,279) :- not remove_reaction(852,279).
catalyst(881,279) :- not remove_reaction(881,279).
catalyst(882,279) :- not remove_reaction(882,279).
catalyst(901,279) :- not remove_reaction(901,279).
catalyst(902,279) :- not remove_reaction(902,279).
catalyst(931,279) :- not remove_reaction(931,279).
catalyst(932,279) :- not remove_reaction(932,279).
catalyst(1191,279) :- not remove_reaction(1191,279).
catalyst(1192,279) :- not remove_reaction(1192,279).
catalyst(1581,262).
catalyst(1582,262).
catalyst(6560,252).
catalyst(361,250).
...
catalyst(1121,105).
catalyst(1122,105).
catalyst(771,90) :- not remove_reaction(771,90).
catalyst(772,90) :- not remove_reaction(772,90).
...
catalyst(831,89) :- not remove_reaction(831,89).
catalyst(832,89) :- not remove_reaction(832,89).
catalyst(841,89) :- not remove_reaction(841,89).
catalyst(842,89) :- not remove_reaction(842,89).
