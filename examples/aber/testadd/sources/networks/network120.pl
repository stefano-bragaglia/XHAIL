...
component("YGR060W",395).
component("YGL012W",367).
component("YKR009C",549).
component("YOL086C",687).
component("YMR303C",635).
component("YGL256W",389).
component("YDL168W",247).
component("YBR145W",187).
component("YPL231W",749).
component("YBR265W",202).
component("U46_",109).
component("YBR149W",188).
component("YBR149W",189).
component("YGL001C",364).
component("YIL094C",463).
component("U45_",108).
component("YML056C",612).
component("YLR432W",602).
component("YHR216W",455).
component("YAR075W",159).
component("YAR073W",158).
component("YDR127W",272).
component("YJR139C",523).
component("YML075C",614).
component("YLR450W",605).
component("YOL126C",693).
component("YKL085W",531).
component("YDL078C",234).
component("YNL037C",640).
component("YNL009W",638).
component("YLR174W",580).
component("YHR183W",448).
component("YGR256W",414).
component("YNL241C",654).
component("YOL059W",684).
component("YDL022W",227).
component("YCL018W",210).
component("YLR355C",597).
component("YIL074C",460).
component("YER081W",339).
component("YDL174C",251).
component("YML086C",616).
component("YIL155C",472).
component("YGR088W",398).
component("YDR256C",285).
component("YKL026C",529).
component("YIR037W",481).
component("YBR244W",198).
component("YJR078W",517).
component("U58_",118).
component("YJR025C",509).
component("U107_",24).
component("YHR007C",424).
component("YDR402C",299).
component("YGL055W",374).
component("YJR104C",519).
component("YHR008C",425).
component("YOR384W",729).
component("YOR381W",728).
component("YOL152W",695).
component("YLL051C",560).
component("YJL026W",483).
...
component("YDR158W",279).
component("YJR009C",506).
component("YJL052W",485).
component("YGR192C",406).
...
component("YGL154C",381).
component("YBR115C",183).
component("U55_",117).
component("YER069W",334).
component("YOR323C",718).
component("YER178W",348).
component("YBR221C",196).
component("YIL125W",468).
component("U52_",114).
component("YBR166C",191).
component("YGL012W",368).
component("YKL182W",540).
component("YKL216W",548).
component("YDR044W",263).
component("YKR009C",550).
component("YIL160C",473).
component("YGL205W",386).
component("YMR118C",625).
component("YLR164W",578).
component("YLL041C",559).
component("YKL148C",535).
component("YKL141W",533).
component("YJL045W",484).
component("YDR178W",280).
component("YEL047C",319).
component("YDL171C",249).
component("YDL171C",250).
component("YOR375C",727).
component("YDL215C",255).
component("YAL062W",155).
component("U99_",150).
component("U100_",20).
component("YBR035C",175).
component("YKR080W",555).
component("YER023W",326).
component("YOR236W",716).
component("YGR204W",408).
component("YIR034C",480).
component("YLR142W",575).
component("U65_",124).
component("U63_",122).
component("U62_",121).
component("YHR068W",434).
component("YKL150W",536).
component("YIL043C",458).
component("YHR042W",429).
component("YPL171C",742).
component("YHR179W",447).
component("YMR145C",628).
component("YML120C",617).
component("YKL192C",543).
component("YDL085W",236).
component("YGR234W",410).
component("YFR030W",360).
component("YPL017C",732).
component("YFL018C",352).
component("YDR353W",295).
component("YPR167C",771).
component("YJR137C",522).
component("YNL052W",642).
component("YMR256C",634).
component("YLR395C",601).
component("YLR038C",565).
component("YIL111W",465).
component("YHR051W",433).
component("YGL191W",384).
component("YGL187C",383).
component("YDL067C",233).
component("Q0275",19).
component("Q0250",18).
component("YDR072C",268).
component("YPL266W",755).
component("YKR069W",554).
component("YOL096C",688).
component("U47_",110).
component("YER091C",344).
component("YJR073C",515).
component("YGR157W",402).
component("YDR120C",270).
component("YML008C",607).
component("YOR074C",700).
component("YDL033C",229).
component("YOL096C",689).
component("YLR172C",579).
component("YLR058C",568).
component("YDR019C",261).
component("YBR176W",192).
component("YDR408C",301).
component("YMR120C",626).
component("YLR028C",563).
component("YBL013W",160).
component("YJL130C",493).
component("YKL024C",528).
component("YPR074C",766).
component("YBR117C",184).
component("YMR108W",624).
component("YCL009C",209).
component("YNL071W",644).
component("YNR008W",666).
component("YIL160C",474).
component("YNR019W",669).
component("YCR048W",223).
component("U48_",111).
component("YDR232W",282).
component("YPL231W",750).
component("YER061C",333).
component("YDL052C",232).
component("U8_",144).
component("YPL231W",751).
component("YPL028W",733).
component("YLR299W",590).
component("YGL017W",369).
component("YCR005C",215).
component("YML126C",618).
component("YNL104C",647).
component("YDL182W",252).
component("YDL131W",240).
component("YDR307W",291).
component("YLR258W",587).
component("YFR015C",358).
component("YNL029C",639).
component("YIL085C",462).
component("YMR306W",636).
component("YLR342W",596).
component("YGR032W",392).
component("YLR209C",582).
component("U104_",21).
component("YDR354W",296) :- not remove_orf("YDR354W",296).
component("YFR047C",361).
component("YJR133W",521).
component("YLR209C",583).
component("YML022W",609).
component("YDR441C",304).
component("YHR128W",442).
component("YJL167W",498).
component("YJL167W",499).
component("YDR127W",273).
component("YHR190W",450).
component("YLR146C",576).
component("YHR068W",435).
component("YLR303W",592).
component("YGR012W",390).
component("YML082W",615).
component("YJR130C",520).
component("YDR035W",262).
component("YBR249C",199).
component("YLR180W",581).
component("YDR502C",308).
component("YOR274W",717).
component("YBR256C",201).
component("YHR137W",443).
component("YGL202W",385).
component("YLR027C",562).
component("YKL106W",532).
component("YOL140W",694).
component("YLR438W",604).
component("YGR019W",391).
component("YLR089C",571).
component("U64_",123).
component("U61_",120).
component("U51_",113).
component("YJR148W",524).
component("YHR208W",453).
component("YFL030W",354).
component("YOR184W",709).
component("YNR058W",674).
component("YIL116W",467).
component("YGL253W",388).
component("YFR053C",362).
component("YMR013C",622).
component("YMR205C",630).
component("YGR240C",411).
component("YOL016C",678).
component("YFR014C",357).
component("YLR240W",585).
component("YKL203C",545).
component("YJR066W",514).
component("YCR036W",222).
component("YCL040W",212).
component("U15_",54).
component("YPL188W",744).
component("YJR049C",511).
component("YEL041W",317).
component("U96_",148).
component("YKL001C",527).
component("YDR236C",283).
component("YHL032C",422).
component("YDR531W",312).
component("U83_",140).
component("U82_",139).
component("U81_",138).
component("YMR208W",631).
component("YPL203W",745).
component("YOR061W",699).
component("YKL166C",538).
component("YJL164C",497).
component("YIL035C",457).
component("YHR205W",452).
component("YHR102W",441).
component("YGL019W",370).
component("YHR025W",428).
component("YOR347C",723).
component("YAL038W",153).
component("YNR012W",667).
component("YDR009W",260).
component("YDR127W",274).
component("YDR147W",277).
component("YDR300C",290).
component("YCR012W",216).
component("YER069W",335).
component("U19_",81).
component("U18_",73).
component("U17_",65).
component("U76_",133).
component("YER170W",347).
component("YDR226W",281).
component("YKL067W",530).
component("YOL055C",681).
component("YDR454C",305).
component("YJR057W",512).
component("YOL061W",685).
component("YKL181W",539).
component("YHL011C",421).
component("YER099C",345).
component("YBL068W",167).
component("YOR143C",705).
component("YNL256W",657).
component("YLR328W",594).
component("YBR018C",171).
component("YGR202C",407).
component("YLR328W",595).
component("U80_",137).
component("U94_",147).
component("YJR010W",507).
component("YBR029C",174).
component("YCL050C",213).
component("YGL130W",379).
component("YDR530C",311).
component("YPR190C",774).
component("YPR187W",773).
component("YPR110C",768).
component("YPR010C",760).
component("YOR341W",722).
component("YOR340C",721).
component("YOR224C",715).
component("YOR210W",713).
component("YOR207C",711).
component("YOR151C",706).
component("YOR116C",702).
component("YOL005C",676).
component("YNR003C",665).
component("YNL248C",656).
component("YNL151C",651).
component("YNL113W",648).
component("YKL144C",534).
component("YJR063W",513).
component("YJL148W",496).
component("YJL140W",495).
component("YIL021W",456).
component("YHR143W-A",444).
component("YGL070C",377).
component("YFL036W",355).
component("YDR404C",300).
component("YDR156W",278).
component("YDR045C",264).
component("YDL150W",246).
component("YDL140C",242).
component("YBR154C",190).
component("YPR175W",772).
component("YPL167C",741).
component("YOR330C",719).
component("YOL115W",692).
component("YNL299W",663).
component("YNL262W",659).
component("YNL102W",646).
component("YJR043C",510).
component("YJR006W",505).
component("YJL090C",488).
component("YIL139C",470).
component("YEL055C",320).
component("YDR419W",302).
component("YDR121W",271).
component("YDL102W",239).
component("YCR014C",217).
component("YBR278W",204).
component("YBL035C",163).
component("YPR113W",769).
component("YBR243C",197).
component("YPL148C",739).
component("YER026C",327).
component("YGR286C",418).
component("YHR189W",449).
component("YDR058C",267).
component("YDL086W",237).
component("YOL011W",677).
component("YMR008C",620).
component("YMR006C",619).
component("U105_",22).
component("YBL015W",161).
component("YJL068C",486).
component("YOR040W",698).
component("U77_",134).
component("YDR481C",306).
component("YLR377C",599).
component("YPL179W",743).
component("YNR032W",670).
component("YML057W",613).
component("YML016C",608).
component("YLR433C",603).
component("YGR123C",400).
component("YER133W",346).
component("YER089C",342).
component("YDR436W",303).
component("YDR075W",269).
component("YDL188C",253).
component("YDL134C",241).
component("YDL047W",231).
component("YDL006W",225).
component("YBR125C",186).
component("YBL056W",166).
component("YPR073C",764).
component("YHR215W",454).
component("YDL024C",228).
component("YBR093C",181).
component("YBR092C",180).
component("YAR071W",157).
component("YHR046C",432).
component("U9_",151).
component("YPL228W",748).
component("YMR180C",629).
component("YDL236W",257).
component("YPR073C",765).
component("YOR208W",712).
component("YNL053W",643).
component("YMR036C",623).
component("YIR026C",479).
component("YIL113W",466).
component("YFR028C",359).
component("YER075C",338).
component("YDL230W",256).
...
component("U25_",93).
component("U24_",92).
component("YHR044C",431).
component("YHR043C",430).
component("YOL064C",686).
component("YOR360C",725).
component("YKR031C",551).
component("YPL206C",746).
component("YGL027C",372).
component("YLR286C",589).
component("YJR153W",525).
component("YJL221C",504).
component("YJL216C",502).
component("YIL172C",477).
component("YGR292W",420).
component("YGR287C",419).
component("YBR299W",208).
component("YBR184W",193).
component("YIR019C",478).
component("YIL099W",464).
component("YDL037C",230).
component("YOR190W",710).
component("YLR300W",591).
component("YGR282C",417).
component("YDR261C",286).
component("YDR400W",298).
component("YML035C",610).
component("YJL070C",487).
component("YBR284W",205).
component("U106_",23).
component("YER043C",328).
component("YNL045W",641).
component("YGL037C",373).
component("YDR242W",284).
component("U53_",115).
component("YPR062W",763).
component("YMR120C",627).
component("YLR028C",564).
component("YHR144C",445).
component("YGR267C",416).
component("YBL033C",162).
component("YNL141W",649).
component("YLR245C",586).
component("YML035C",611).
component("YBR084W",178).
component("YJL126W",491).
component("U44_",107).
...
component("YHR201C",451).
component("YBR111C",182).
component("YBR252W",200).
component("YER005W",325).
component("YBL099W",168).
component("YLR231C",584).
component("YDR538W",314).
component("YLR134W",573).
component("YLR044C",566).
component("YGR087C",397).
component("YDR380W",297).
component("YDL080C",235).
component("U98_",149).
component("YMR250W",633).
component("YOR128C",703).
component("YEL021W",316).
component("YNR043W",672).
component("U93_",146).
component("U54_",116).
component("YKL211C",546) :- not remove_orf("YKL211C",546).
component("YKR097W",557).
component("YNL169C",652).
component("YNL256W",658).
component("YDR294C",288).
component("YEL046C",318).
component("YNR033W",671).
component("YKL211C",547) :- not remove_orf("YKL211C",547).
component("YER090W",547) :- not remove_orf("YER090W",547).
component("YER090W",343) :- not remove_orf("YER090W",343).
component("YDR127W",275).
component("YPL281C",758).
component("YOR393W",731).
component("YMR323W",637).
component("YHR174W",446).
component("YGR254W",413).
component("YPL262W",753).
component("YGL026C",371) :- not remove_orf("YGL026C",371).
component("YGR155W",401).
component("YLR304C",593).
component("YJL200C",500).
component("YNL316C",664).
component("YKL182W",541).
component("YPL212C",747).
component("YNL292W",662).
component("YGL063W",376).
component("YFL001W",350).
component("YPR002W",759).
component("YJR016C",508).
component("YCR053W",224).
component("YDR127W",276).
component("YGL148W",380).
component("YIL168W",476).
component("YIL167W",475).
component("YCL064C",214).
component("YER086W",340).
component("YLR359W",598).
component("YAL012W",152).
component("YML004C",606).
component("YFR055W",363).
component("YJL005W",482).
component("YJL121C",490).
component("YBR019C",172).
component("YDR050C",266).
...
component("YPL117C",737).
component("U14_",46).
component("YOL056W",682).
component("YKL152C",537).
component("YDL021W",226).
component("YEL058W",321).
component("YPR060C",762).
component("YHR072W",436).
component("YPL097W",735).
component("YGR185C",405).
component("YGR264C",415).
component("YGR171C",403).
component("YPL104W",736).
component("YLL018C",558).
component("YPR081C",767).
component("YBR121C",185).
component("YHR020W",427).
component("YER087W",341).
component("YNL247W",655).
component("YOR168W",707).
component("YOL097C",690).
component("YDR268W",287).
component("YPR047W",761).
component("YLR060W",569).
component("YFL022C",353).
component("YCR024C",218).
component("YHR019C",426).
component("YKL194C",544).
component("YIL078W",461).
component("YPL160W",740).
component("YLR382C",600).
component("YNL073W",645).
component("YOR335C",720).
component("YLR153C",577).
component("YAL054C",154).
component("YGR244C",412).
component("YIL145C",471).
component("U89_",143).
component("YJL101C",489).
component("YOL049W",680).
component("YAR015W",156).
component("YER183C",349).
component("U90_",145).
component("YNR057C",673).
component("YDL141W",243).
component("YGL234W",387).
component("YDL141W",244).
component("YJR103W",518).
component("YBL039C",164).
component("YGR204W",409).
component("YBR084W",179).
component("YNL220W",653).
component("YOL058W",683).
component("YDL141W",245).
component("YHR074W",437).
component("YMR217W",632).
component("YGL062W",375).
component("YBR218C",195).
component("YPL231W",752).
component("YNR016C",668).
component("YKL182W",542).
component("YGR037C",393).
component("YPR138C",770).
component("YPL265W",754).
component("YPL134C",738).
component("YPL036W",734).
component("YOR348C",724).
component("YOR222W",714).
component("YOR171C",708).
component("YOR130C",704).
component("YOR011W",697).
component("YOL156W",696).
component("YOL103W",691).
component("YOL020W",679) :- not remove_orf("YOL020W",679).
component("YNR072W",675).
component("YNL270C",660).
component("YNL142W",650).
component("YMR011W",621).
component("YLR260W",588).
component("YLR138W",574).
component("YLR100C",572).
component("YLR081W",570).
component("YLL061W",561).
component("YKR093W",556).
component("YKR053C",553).
component("YKR039W",552) :- not remove_orf("YKR039W",552).
component("YJR158W",526).
component("YJR077C",516).
component("YJL219W",503).
component("YJL214W",501).
component("YJL134W",494).
component("YJL129C",492).
component("YIL134W",469).
component("YHR096C",440).
component("YHR094C",439).
component("YHR092C",438).
component("YHL036W",423).
component("YGR121C",399).
component("YGR065C",396).
component("YGR055W",394).
component("YGL186C",382).
component("YGL077C",378).
component("YGL008C",366).
component("YFL055W",356).
component("YFL011W",351).
component("YER060W-A",332).
component("YER060W",331).
component("YER056C",330).
component("YER053C",329).
component("YEL069C",323).
component("YEL063C",322).
component("YEL017C-A",315).
component("YDR536W",313).
component("YDR508C",310).
component("YDR503C",309).
component("YDR497C",307).
component("YDR345C",294).
component("YDR343C",293).
component("YDR342C",292).
component("YDR297W",289).
component("YDR046C",265) :- not remove_orf("YDR046C",265).
component("YDL245C",258).
component("YDL210W",254).
component("YCR032W",221).
component("YCR028C",220).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,296) :- not remove_reaction(3620,296).
catalyst(2110,361).
catalyst(2190,361).
catalyst(5550,521).
catalyst(5791,583).
...
catalyst(1890,343) :- not remove_reaction(1890,343).
catalyst(3630,343) :- not remove_reaction(3630,343).
catalyst(3740,275).
catalyst(8231,758).
catalyst(8232,758).
catalyst(8231,731).
...
catalyst(8061,753).
catalyst(8062,753).
catalyst(3590,371) :- not remove_reaction(3590,371).
catalyst(10910,371) :- not remove_reaction(10910,371).
catalyst(4570,401).
catalyst(8181,593).
catalyst(8182,593).
catalyst(8181,500).
...
catalyst(1210,696).
catalyst(1160,691).
catalyst(801,679) :- not remove_reaction(801,679).
catalyst(802,679) :- not remove_reaction(802,679).
catalyst(811,679) :- not remove_reaction(811,679).
catalyst(812,679) :- not remove_reaction(812,679).
catalyst(831,679) :- not remove_reaction(831,679).
catalyst(832,679) :- not remove_reaction(832,679).
catalyst(901,679) :- not remove_reaction(901,679).
catalyst(902,679) :- not remove_reaction(902,679).
catalyst(1180,675).
catalyst(1210,675).
catalyst(931,660).
catalyst(932,660).
...
catalyst(640,556).
catalyst(6560,553).
catalyst(771,552) :- not remove_reaction(771,552).
catalyst(772,552) :- not remove_reaction(772,552).
catalyst(781,552) :- not remove_reaction(781,552).
catalyst(782,552) :- not remove_reaction(782,552).
catalyst(801,552) :- not remove_reaction(801,552).
catalyst(802,552) :- not remove_reaction(802,552).
catalyst(811,552) :- not remove_reaction(811,552).
catalyst(812,552) :- not remove_reaction(812,552).
catalyst(831,552) :- not remove_reaction(831,552).
catalyst(832,552) :- not remove_reaction(832,552).
catalyst(841,552) :- not remove_reaction(841,552).
catalyst(842,552) :- not remove_reaction(842,552).
catalyst(851,552) :- not remove_reaction(851,552).
catalyst(852,552) :- not remove_reaction(852,552).
catalyst(881,552) :- not remove_reaction(881,552).
catalyst(882,552) :- not remove_reaction(882,552).
catalyst(901,552) :- not remove_reaction(901,552).
catalyst(902,552) :- not remove_reaction(902,552).
catalyst(921,552) :- not remove_reaction(921,552).
catalyst(922,552) :- not remove_reaction(922,552).
catalyst(931,552) :- not remove_reaction(931,552).
catalyst(932,552) :- not remove_reaction(932,552).
catalyst(1191,552) :- not remove_reaction(1191,552).
catalyst(1192,552) :- not remove_reaction(1192,552).
catalyst(1180,526).
catalyst(1210,526).
catalyst(1581,516).
catalyst(1582,516).
...
catalyst(851,265) :- not remove_reaction(851,265).
catalyst(852,265) :- not remove_reaction(852,265).
...
catalyst(851,176) :- not remove_reaction(851,176).
catalyst(852,176) :- not remove_reaction(852,176).
...
modifiable_enzyme(679).
modifiable_enzyme(552).
