...
component("YLR056W",371).
component("YGL012W",237).
component("YKR009C",357).
component("YOL086C",448).
component("YMR303C",410).
component("YGL256W",255).
component("YDL168W",163).
component("YBR145W",125).
component("YPL231W",489).
component("U46_",73).
component("YBR149W",126).
component("YGL001C",234).
component("YIL094C",303).
component("U45_",72).
component("YML056C",400).
component("YLR432W",397).
component("YHR216W",298).
component("YAR075W",104).
component("YAR073W",103).
component("YDR127W",176).
component("YOL126C",452).
component("YKL085W",347).
component("YDL078C",155).
component("YNL037C",415).
component("YNL009W",413).
component("YLR174W",379).
component("YCL018W",140).
component("YLR355C",394).
component("YDL174C",166).
component("YML086C",401).
component("YGR088W",263).
component("YDR256C",186).
component("YJR078W",338).
component("YJR025C",331).
component("U107_",23).
component("YJR104C",340).
component("YHR008C",281).
component("YJL026W",315).
component("YIL066C",301).
component("YGR180C",266).
component("YER070W",216).
component("U36_",66).
component("YDL168W",164).
component("YBR006W",112).
component("YPL276W",497).
component("YPL275W",496).
component("YOR388C",475).
component("U55_",79).
component("YER069W",215).
component("YOR323C",468).
component("YER178W",222).
component("YBR221C",131).
component("YIL125W",306).
component("U52_",77).
component("YBR166C",128).
component("YGL012W",238).
component("YKL216W",356).
component("YKR009C",358).
component("YIL160C",309).
component("YGL205W",252).
component("YDL171C",165).
component("U99_",98).
component("U100_",20).
component("YKR080W",363).
component("YER023W",209).
component("YGR204W",268).
component("YLR142W",376).
component("U65_",83).
component("U62_",82).
component("YHR068W",289).
component("YKL150W",350).
component("YIL043C",300).
component("YPL171C",485).
component("YHR179W",296).
component("YGR234W",270).
component("YPL017C",477).
component("YFL018C",225).
component("YDR353W",190).
component("YPR167C",509).
component("YNL052W",416).
component("YMR256C",409).
component("YLR395C",396).
component("YLR038C",369).
component("YIL111W",304).
component("YHR051W",288).
component("YGL191W",250).
component("YGL187C",249).
component("YDL067C",154).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",495).
component("YKR069W",362).
component("U47_",74).
component("YJR073C",336).
component("YDL033C",153).
component("YLR172C",378).
component("YLR058C",372).
component("YDR019C",171).
component("YBR176W",129).
component("YDR408C",195).
component("YMR120C",406).
component("YLR028C",367).
component("YBL013W",105).
component("YJL130C",321).
component("YKL024C",345).
component("YPR074C",505).
component("YBR117C",124).
component("YCL009C",139).
component("YNL071W",418).
component("YIL160C",310).
component("U48_",75).
component("YPL231W",490).
component("YPL231W",491).
component("YPL028W",478).
component("YLR299W",387).
component("YGL017W",239).
component("YML126C",402).
component("YNL104C",420).
component("YDL182W",167).
component("YDL131W",159).
component("YLR258W",384).
component("YFR015C",230).
component("YNL029C",414).
component("YIL085C",302).
component("YMR306W",411).
component("YLR342W",393).
component("YGR032W",258).
component("YLR209C",380).
component("U104_",21).
component("YDR354W",191) :- not remove_orf("YDR354W",191).
component("YFR047C",232).
component("YLR209C",381).
component("YML022W",398).
component("YDR441C",197).
component("YJL167W",325).
component("YDR127W",177).
component("YHR068W",290).
component("YLR303W",389).
component("YGR012W",256).
component("YJR130C",341).
component("YDR035W",172).
component("YBR249C",132).
component("YOR274W",467).
component("YHR137W",292).
component("YGL202W",251).
component("YLR027C",366).
component("YKL106W",348).
component("YOL140W",453).
component("YGR019W",257).
component("YLR089C",373).
component("U61_",81).
component("YJR148W",342).
component("YFL030W",226).
component("YNR058W",439).
component("YGL253W",254).
component("YFR053C",233).
component("YMR205C",408).
component("YGR240C",271).
component("YOL016C",442).
component("YFR014C",229).
component("YCR036W",149).
component("YCL040W",142).
component("YPL188W",486).
component("YJR049C",333).
component("YEL041W",204).
component("U96_",96).
component("YKL001C",344).
component("YDR236C",184).
component("YHL032C",279).
component("U83_",93).
component("YHR025W",284).
component("YOR347C",473).
component("YAL038W",101).
component("YNR012W",435).
component("YDR127W",178).
component("YDR147W",181).
component("YCR012W",144).
component("U76_",91).
component("YER170W",221).
component("YDR226W",183).
component("YKL067W",346).
component("YOL055C",445).
component("YDR454C",198).
component("YJR057W",334).
component("YOL061W",447).
component("YKL181W",352).
component("YHL011C",278).
component("YER099C",220).
component("YBL068W",110).
component("YOR143C",458).
component("YNL256W",428).
component("YLR328W",391).
component("YBR018C",114).
component("YLR328W",392).
component("U94_",95).
component("YBR029C",116).
component("YGL130W",246).
component("YPR190C",512).
component("YPR187W",511).
component("YPR110C",506).
component("YPR010C",500).
component("YOR341W",472).
component("YOR340C",471).
component("YOR224C",466).
component("YOR210W",465).
component("YOR207C",463).
component("YOR151C",459).
component("YOR116C",456).
component("YOL005C",440).
component("YNR003C",434).
component("YNL248C",427).
component("YNL151C",424).
component("YNL113W",421).
component("YKL144C",349).
component("YJR063W",335).
component("YJL148W",324).
component("YJL140W",323).
component("YIL021W",299).
component("YHR143W-A",293).
component("YGL070C",244).
component("YFL036W",227).
component("YDR404C",194).
component("YDR156W",182).
component("YDR045C",173).
component("YDL150W",162).
component("YDL140C",160).
component("YBR154C",127).
component("YPR175W",510).
component("YPL167C",484).
component("YOR330C",469).
component("YOL115W",451).
component("YNL299W",432).
component("YNL262W",429).
component("YNL102W",419).
component("YJR043C",332).
component("YJR006W",329).
component("YJL090C",317).
component("YIL139C",307).
component("YEL055C",206).
component("YDR419W",196).
component("YDR121W",175).
component("YDL102W",158).
component("YCR014C",145).
component("YBR278W",135).
component("YBL035C",108).
component("YPR113W",507).
component("YPL148C",483).
component("YGR286C",275).
component("YOL011W",441).
component("YMR008C",404).
component("YMR006C",403).
component("U105_",22).
component("YBL015W",106).
component("U77_",92).
component("YLR377C",395).
component("YPR073C",503).
component("YHR215W",297).
component("YDL024C",152).
component("YBR093C",122).
component("YBR092C",121).
component("YHR046C",287).
component("U9_",99).
component("YDL236W",169).
component("YPR073C",504).
component("YOR208W",464).
component("YNL053W",417).
component("YMR036C",405).
component("YIR026C",314).
component("YIL113W",305).
component("YFR028C",231).
component("YER075C",217).
component("YDL230W",168).
component("YBR276C",134).
component("U34_",65).
component("U31_",64).
component("U30_",63).
component("U29_",62).
component("U26_",61).
component("U24_",60).
component("YHR044C",286).
component("YHR043C",285).
component("YOR360C",474).
component("YKR031C",359).
component("YPL206C",487).
component("YGL027C",241).
component("YLR286C",386).
component("YJR153W",343).
component("YJL221C",328).
component("YJL216C",327).
component("YIL172C",313).
component("YGR292W",277).
component("YGR287C",276).
component("YBR299W",138).
component("YOR190W",462).
component("YLR300W",388).
component("YGR282C",274).
component("YDR261C",187).
component("YDR400W",193).
component("YML035C",399).
component("YJL070C",316).
component("YBR284W",136).
component("YER043C",210).
component("YDR242W",185).
component("U53_",78).
component("YPR062W",502).
component("YMR120C",407).
component("YLR028C",368).
component("YHR144C",294).
component("YBL033C",107).
component("YNL141W",422).
component("YLR245C",383).
component("YBR084W",119).
component("YJL126W",319).
component("U44_",71).
component("YDL100C",157).
component("U40_",69).
component("U39_",67).
component("YBR011C",113).
component("YBR111C",123).
component("YBR252W",133).
component("YER005W",208).
component("YBL099W",111).
component("YLR231C",382).
component("YLR134W",375).
component("YLR044C",370).
component("YGR087C",262).
component("YDR380W",192).
component("YDL080C",156).
component("U98_",97).
component("YOR128C",457).
component("YKL211C",354) :- not remove_orf("YKL211C",354).
component("YKR097W",364).
component("YNL169C",425).
component("YEL046C",205).
component("YNR033W",437).
component("YKL211C",355) :- not remove_orf("YKL211C",355).
component("YER090W",355) :- not remove_orf("YER090W",355).
component("YER090W",219) :- not remove_orf("YER090W",219).
component("YDR127W",179).
component("YPL281C",498).
component("YOR393W",476).
component("YMR323W",412).
component("YHR174W",295).
component("YGR254W",272).
component("YPL262W",493).
component("YGL026C",240) :- not remove_orf("YGL026C",240).
component("YLR304C",390).
component("YJL200C",326).
component("YNL316C",433).
component("YPL212C",488).
component("YNL292W",431).
component("YGL063W",243).
component("YFL001W",224).
component("YPR002W",499).
component("YJR016C",330).
component("YCR053W",150).
component("YDR127W",180).
component("YGL148W",247).
component("YIL168W",312).
component("YIL167W",311).
component("YCL064C",143).
component("YAL012W",100).
component("YBR019C",115).
component("YDR007W",170) :- not remove_orf("YDR007W",170).
component("YOR095C",455).
component("YGL001C",235).
component("YPL117C",482).
component("U14_",32).
component("YOL056W",446).
component("YKL152C",351).
component("YDL021W",151).
component("YPR060C",501).
component("YPL097W",480).
component("YGR185C",267).
component("YGR264C",273).
component("YGR171C",265).
component("YPL104W",481).
component("YLL018C",365).
component("YHR020W",283).
component("YER087W",218).
component("YNL247W",426).
component("YOR168W",460).
component("YOL097C",449).
component("YDR268W",188).
component("YCR024C",146).
component("YHR019C",282).
component("YOR335C",470).
component("YLR153C",377).
component("YAL054C",102).
component("YIL145C",308).
component("YJL101C",318).
component("YOL049W",444).
component("YER183C",223).
component("U90_",94).
component("YNR057C",438).
component("YGL234W",253).
component("YJR103W",339).
component("YBL039C",109).
component("YGR204W",269).
component("YBR084W",120).
component("YDL141W",161).
component("YHR074W",291).
component("YGL062W",242).
component("YBR218C",130).
component("YPL231W",492).
component("YNR016C",436).
component("YKL182W",353).
component("YGR037C",259).
component("YPR138C",508).
component("YPL265W",494).
component("YPL036W",479).
component("YOR171C",461).
component("YOR011W",454).
component("YOL103W",450).
component("YOL020W",443) :- not remove_orf("YOL020W",443).
component("YNL270C",430).
component("YNL142W",423).
component("YLR260W",385).
component("YLR100C",374).
component("YKR053C",361).
component("YKR039W",360) :- not remove_orf("YKR039W",360).
component("YJR077C",337).
component("YJL134W",322).
component("YJL129C",320).
component("YHL036W",280).
component("YGR121C",264).
component("YGR065C",261).
component("YGR055W",260).
component("YGL186C",248).
component("YGL077C",245).
component("YGL008C",236).
component("YFL055W",228).
component("YER060W-A",214).
component("YER060W",213).
component("YER056C",212).
component("YER053C",211).
component("YEL063C",207).
component("YEL017C-A",203).
component("YDR536W",202).
component("YDR508C",201).
component("YDR503C",200).
component("YDR497C",199).
component("YDR297W",189).
component("YDR046C",174) :- not remove_orf("YDR046C",174).
component("YCR032W",148).
component("YCR024C-A",147).
component("YCL025C",141).
component("YBR298C",137).
component("YBR069C",118) :- not remove_orf("YBR069C",118).
component("YBR068C",117) :- not remove_orf("YBR068C",117).
component("U75_",90).
component("U74_",89).
component("U73_",88).
component("U72_",87).
...
catalyst(6111,457).
catalyst(6112,457).
catalyst(3600,354) :- not remove_reaction(3600,354).
catalyst(8000,364).
catalyst(6890,425).
catalyst(4560,205).
catalyst(2550,437).
catalyst(3630,355) :- not remove_reaction(3630,355).
catalyst(3630,219) :- not remove_reaction(3630,219).
catalyst(3740,179).
catalyst(8231,498).
catalyst(8232,498).
catalyst(8231,476).
...
catalyst(8051,493).
catalyst(8052,493).
catalyst(3590,240) :- not remove_reaction(3590,240).
catalyst(10910,240) :- not remove_reaction(10910,240).
catalyst(8181,390).
catalyst(8182,390).
catalyst(8181,326).
catalyst(8182,326).
...
catalyst(7751,115).
catalyst(7752,115).
catalyst(3610,170) :- not remove_reaction(3610,170).
catalyst(7921,455).
catalyst(7922,455).
catalyst(6370,235).
catalyst(6461,482).
...
catalyst(931,360) :- not remove_reaction(931,360).
catalyst(932,360) :- not remove_reaction(932,360).
...
catalyst(1121,137).
catalyst(1122,137).
catalyst(771,118) :- not remove_reaction(771,118).
catalyst(772,118) :- not remove_reaction(772,118).
catalyst(801,118) :- not remove_reaction(801,118).
catalyst(802,118) :- not remove_reaction(802,118).
catalyst(811,118) :- not remove_reaction(811,118).
catalyst(812,118) :- not remove_reaction(812,118).
catalyst(851,118) :- not remove_reaction(851,118).
catalyst(852,118) :- not remove_reaction(852,118).
catalyst(901,118) :- not remove_reaction(901,118).
catalyst(902,118) :- not remove_reaction(902,118).
...
catalyst(831,117) :- not remove_reaction(831,117).
catalyst(832,117) :- not remove_reaction(832,117).
catalyst(841,117) :- not remove_reaction(841,117).
catalyst(842,117) :- not remove_reaction(842,117).
catalyst(851,117) :- not remove_reaction(851,117).
catalyst(852,117) :- not remove_reaction(852,117).
catalyst(901,117) :- not remove_reaction(901,117).
catalyst(902,117) :- not remove_reaction(902,117).
catalyst(2920,90).
catalyst(2920,89).
catalyst(2920,88).
catalyst(2920,87).
