...
component("YNL280C",592).
component("YLR056W",509).
component("YGL012W",323).
component("YKR009C",491).
component("YOL086C",616).
component("YMR303C",567).
component("YGL256W",344).
component("YDL168W",218).
component("YBR145W",164).
component("YPL231W",673).
component("YBR265W",179).
component("U46_",95).
component("YBR149W",165).
component("YBR149W",166).
component("YGL001C",320).
component("YIL094C",411).
component("U45_",94).
component("YML056C",548).
component("YLR432W",542).
component("YHR216W",405).
component("YAR075W",140).
component("YAR073W",139).
component("YDR127W",239).
component("YOL126C",622).
component("YKL085W",477).
component("YDL078C",206).
component("YNL037C",572).
component("YNL009W",570).
component("YLR174W",521).
component("YHR183W",398).
component("YGR256W",365).
component("YOL059W",614).
component("YDL022W",200).
component("YCL018W",187).
component("YLR355C",537).
component("YDL174C",222).
component("YML086C",550).
component("YIL155C",420).
component("YGR088W",352).
component("YDR256C",251).
component("YKL026C",475).
component("YIR037W",429).
component("YBR244W",175).
component("YJR078W",464).
component("U58_",103).
component("YJR025C",457).
component("U107_",24).
component("YHR007C",375).
component("YGL055W",329).
component("YJR104C",466).
component("YHR008C",376).
component("YOR384W",656).
component("YOR381W",655).
component("YOL152W",624).
component("YLL051C",502).
component("YJL026W",431).
component("YIL066C",409).
component("YGR180C",356).
component("YER070W",296).
component("U37_",88).
component("U36_",87).
component("YDL168W",219).
component("YJR009C",454).
component("YJL052W",433).
component("YGR192C",358).
component("YBR006W",149).
component("YPL276W",681).
component("YPL275W",680).
component("YOR388C",657).
component("YOR374W",653).
component("YER073W",297).
component("YGL154C",336).
component("U55_",102).
component("YER069W",294).
component("YOR323C",646).
component("YER178W",305).
component("YBR221C",173).
component("YIL125W",416).
component("U52_",100).
component("YBR166C",168).
component("YGL012W",324).
component("YKL216W",490).
component("YDR044W",232).
component("YKR009C",492).
component("YIL160C",421).
component("YGL205W",341).
component("YMR118C",558).
component("YLR164W",519).
component("YLL041C",501).
component("YKL148C",481).
component("YKL141W",479).
component("YJL045W",432).
component("YDR178W",246).
component("YEL047C",281).
component("YDL171C",220).
component("YDL171C",221).
component("YOR375C",654).
component("YDL215C",224).
component("YAL062W",137).
component("U99_",132).
component("U100_",20).
component("YBR035C",155).
component("YKR080W",497).
component("YER023W",287).
component("YOR236W",644).
component("YGR204W",359).
component("YIR034C",428).
component("YLR142W",516).
component("U65_",109).
component("U63_",107).
component("U62_",106).
component("YHR068W",385).
component("YKL150W",482).
component("YIL043C",408).
component("YHR042W",380).
component("YPL171C",668).
component("YHR179W",397).
component("YMR145C",561).
component("YML120C",551).
component("YKL192C",487).
component("YDL085W",208).
component("YGR234W",361).
component("YFR030W",316).
component("YPL017C",659).
component("YFL018C",309).
component("YDR353W",261).
component("YPR167C",693).
component("YJR137C",469).
component("YNL052W",574).
component("YMR256C",566).
component("YLR395C",541).
component("YLR038C",507).
component("YIL111W",413).
component("YHR051W",384).
component("YGL191W",339).
component("YGL187C",338).
component("YDL067C",205).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",679).
component("YKR069W",496).
component("YOL096C",617).
component("U47_",96).
component("YER091C",302).
component("YJR073C",462).
component("YDR120C",237).
component("YML008C",544).
component("YOR074C",629).
component("YDL033C",202).
component("YOL096C",618).
component("YLR172C",520).
component("YLR058C",510).
component("YDR019C",230).
component("YBR176W",169).
component("YDR408C",266).
component("YMR120C",559).
component("YLR028C",505).
component("YBL013W",141).
component("YJL130C",441).
component("YKL024C",474).
component("YPR074C",689).
component("YBR117C",163).
component("YCL009C",186).
component("YNL071W",576).
component("YNR008W",597).
component("YIL160C",422).
component("YNR019W",600).
component("YCR048W",197).
component("U48_",97).
component("YDR232W",248).
component("YPL231W",674).
component("YDL052C",204).
component("U8_",126).
component("YPL231W",675).
component("YPL028W",660).
component("YLR299W",530).
component("YGL017W",325).
component("YML126C",552).
component("YNL104C",579).
component("YDL182W",223).
component("YDL131W",212).
component("YDR307W",257).
component("YLR258W",527).
component("YFR015C",314).
component("YNL029C",571).
component("YIL085C",410).
component("YMR306W",568).
component("YLR342W",536).
component("YGR032W",347).
component("YLR209C",523).
component("U104_",21).
component("YDR354W",262) :- not remove_orf("YDR354W",262).
component("YFR047C",317).
component("YJR133W",468).
component("YLR209C",524).
component("YML022W",545).
component("YDR441C",268).
component("YJL167W",446).
component("YJL167W",447).
component("YDR127W",240).
component("YHR190W",400).
component("YLR146C",517).
component("YHR068W",386).
component("YLR303W",532).
component("YGR012W",345).
component("YML082W",549).
component("YJR130C",467).
component("YDR035W",231).
component("YBR249C",176).
component("YLR180W",522).
component("YDR502C",271).
component("YOR274W",645).
component("YBR256C",178).
component("YHR137W",393).
component("YGL202W",340).
component("YLR027C",504).
component("YKL106W",478).
component("YOL140W",623).
component("YLR438W",543).
component("YGR019W",346).
component("YLR089C",512).
component("U64_",108).
component("U61_",105).
component("U51_",99).
component("YJR148W",470).
component("YHR208W",403).
component("YFL030W",310).
component("YOR184W",638).
component("YNR058W",604).
component("YIL116W",415).
component("YGL253W",343).
component("YFR053C",318).
component("YMR013C",556).
component("YMR205C",562).
component("YGR240C",362).
component("YOL016C",608).
component("YFR014C",313).
component("YCR036W",196).
component("YCL040W",189).
component("U15_",45).
component("YPL188W",669).
component("YJR049C",459).
component("YEL041W",279).
component("U96_",130).
component("YKL001C",473).
component("YDR236C",249).
component("YHL032C",373).
component("YDR531W",275).
component("U83_",125).
component("U82_",124).
component("U81_",123).
component("YMR208W",563).
component("YPL203W",670).
component("YOR061W",628).
component("YKL166C",484).
component("YJL164C",445).
component("YIL035C",407).
component("YHR205W",402).
component("YHR102W",392).
component("YGL019W",326).
component("YHR025W",379).
component("YOR347C",651).
component("YAL038W",135).
component("YNR012W",598).
component("YDR009W",229).
component("YDR127W",241).
component("YDR147W",244).
component("YDR300C",256).
component("YCR012W",191).
component("YER069W",295).
component("U18_",62).
component("U76_",118).
component("YER170W",304).
component("YDR226W",247).
component("YKL067W",476).
component("YOL055C",611).
component("YDR454C",269).
component("YJR057W",460).
component("YOL061W",615).
component("YKL181W",485).
component("YHL011C",372).
component("YER099C",303).
component("YBL068W",147).
component("YOR143C",634).
component("YNL256W",588).
component("YLR328W",534).
component("YBR018C",151).
component("YLR328W",535).
component("U80_",122).
component("U94_",129).
component("YJR010W",455).
component("YBR029C",154).
component("YGL130W",334).
component("YDR530C",274).
component("YPR190C",696).
component("YPR187W",695).
component("YPR110C",690).
component("YPR010C",684).
component("YOR341W",650).
component("YOR340C",649).
component("YOR224C",643).
component("YOR210W",642).
component("YOR207C",640).
component("YOR151C",635).
component("YOR116C",631).
component("YOL005C",606).
component("YNR003C",596).
component("YNL248C",587).
component("YNL151C",583).
component("YNL113W",580).
component("YKL144C",480).
component("YJR063W",461).
component("YJL148W",444).
component("YJL140W",443).
component("YIL021W",406).
component("YHR143W-A",394).
component("YGL070C",332).
component("YFL036W",311).
component("YDR404C",265).
component("YDR156W",245).
component("YDR045C",233).
component("YDL150W",217).
component("YDL140C",213).
component("YBR154C",167).
component("YPR175W",694).
component("YPL167C",667).
component("YOR330C",647).
component("YOL115W",621).
component("YNL299W",594).
component("YNL262W",590).
component("YNL102W",578).
component("YJR043C",458).
component("YJR006W",453).
component("YJL090C",436).
component("YIL139C",418).
component("YEL055C",282).
component("YDR419W",267).
component("YDR121W",238).
component("YDL102W",211).
component("YCR014C",192).
component("YBR278W",181).
component("YBL035C",144).
component("YPR113W",691).
component("YBR243C",174).
component("YPL148C",665).
component("YER026C",288).
component("YGR286C",369).
component("YHR189W",399).
component("YDR058C",236).
component("YDL086W",209).
component("YOL011W",607).
component("YMR008C",554).
component("YMR006C",553).
component("U105_",22).
component("YBL015W",142).
component("YJL068C",434).
component("YOR040W",627).
component("U77_",119).
component("YLR377C",539).
component("YPR073C",687).
component("YHR215W",404).
component("YDL024C",201).
component("YBR093C",161).
component("YBR092C",160).
component("YHR046C",383).
component("U9_",133).
component("YDL236W",226).
component("YPR073C",688).
component("YOR208W",641).
component("YNL053W",575).
component("YMR036C",557).
component("YIR026C",427).
component("YIL113W",414).
component("YFR028C",315).
component("YER075C",298).
component("YDL230W",225).
component("YBR276C",180).
component("U34_",86).
component("U33_",85).
component("U32_",84).
component("U31_",83).
...
component("U25_",79).
component("U24_",78).
component("YHR044C",382).
component("YHR043C",381).
component("YOR360C",652).
component("YKR031C",493).
component("YPL206C",671).
component("YGL027C",328).
component("YLR286C",529).
component("YJR153W",471).
component("YJL221C",452).
component("YJL216C",450).
component("YIL172C",425).
component("YGR292W",371).
component("YGR287C",370).
component("YBR299W",185).
component("YBR184W",170).
component("YIR019C",426).
component("YIL099W",412).
component("YDL037C",203).
component("YOR190W",639).
component("YLR300W",531).
component("YGR282C",368).
component("YDR261C",252).
component("YDR400W",264).
component("YML035C",546).
component("YJL070C",435).
component("YBR284W",182).
component("U106_",23).
component("YER043C",289).
component("YNL045W",573).
component("YDR242W",250).
component("U53_",101).
component("YPR062W",686).
component("YMR120C",560).
component("YLR028C",506).
component("YHR144C",395).
component("YGR267C",367).
component("YBL033C",143).
component("YNL141W",581).
component("YLR245C",526).
component("YML035C",547).
component("YBR084W",158).
component("YJL126W",439).
component("U44_",93).
component("YDL100C",210).
component("U40_",91).
component("U39_",89).
component("YBR011C",150).
component("YHR201C",401).
component("YBR111C",162).
component("YBR252W",177).
component("YER005W",286).
component("YBL099W",148).
component("YLR231C",525).
component("YLR134W",514).
component("YLR044C",508).
component("YGR087C",351).
component("YDR380W",263).
component("YDL080C",207).
component("U98_",131).
component("YMR250W",565).
component("YOR128C",632).
component("YEL021W",278).
component("YNR043W",602).
component("U93_",128).
component("YKL211C",488) :- not remove_orf("YKL211C",488).
component("YKR097W",499).
component("YNL169C",584).
component("YNL256W",589).
component("YDR294C",254).
component("YEL046C",280).
component("YNR033W",601).
component("YKL211C",489) :- not remove_orf("YKL211C",489).
component("YER090W",489) :- not remove_orf("YER090W",489).
component("YER090W",301) :- not remove_orf("YER090W",301).
component("YDR127W",242).
component("YPL281C",682).
component("YOR393W",658).
component("YMR323W",569).
component("YHR174W",396).
component("YGR254W",364).
component("YPL262W",677).
component("YGL026C",327) :- not remove_orf("YGL026C",327).
component("YGR155W",354).
component("YLR304C",533).
component("YJL200C",448).
component("YNL316C",595).
component("YPL212C",672).
component("YNL292W",593).
component("YGL063W",331).
component("YFL001W",307).
component("YPR002W",683).
component("YJR016C",456).
component("YCR053W",198).
component("YDR127W",243).
component("YGL148W",335).
component("YIL168W",424).
component("YIL167W",423).
component("YCL064C",190).
component("YER086W",299).
component("YLR359W",538).
component("YAL012W",134).
component("YFR055W",319).
component("YJL005W",430).
component("YJL121C",438).
component("YBR019C",152).
component("YDR050C",235).
component("YDR007W",228) :- not remove_orf("YDR007W",228).
component("YOR095C",630).
component("YBR196C",171).
component("YGL001C",321).
component("YPL117C",664).
component("U14_",39).
component("YOL056W",612).
component("YKL152C",483).
component("YDL021W",199).
component("YEL058W",283).
component("YPR060C",685).
component("YHR072W",387).
component("YPL097W",662).
component("YGR185C",357).
component("YGR264C",366).
component("YGR171C",355).
component("YPL104W",663).
component("YLL018C",500).
component("YHR020W",378).
component("YER087W",300).
component("YNL247W",586).
component("YOR168W",636).
component("YOL097C",619).
component("YDR268W",253).
component("YCR024C",193).
component("YHR019C",377).
component("YPL160W",666).
component("YLR382C",540).
component("YNL073W",577).
component("YOR335C",648).
component("YLR153C",518).
component("YAL054C",136).
component("YGR244C",363).
component("YIL145C",419).
component("YJL101C",437).
component("YOL049W",610).
component("YAR015W",138).
component("YER183C",306).
component("U90_",127).
component("YNR057C",603).
component("YDL141W",214).
component("YGL234W",342).
component("YDL141W",215).
component("YJR103W",465).
component("YBL039C",145).
component("YGR204W",360).
component("YBR084W",159).
component("YNL220W",585).
component("YOL058W",613).
component("YDL141W",216).
component("YHR074W",388).
component("YMR217W",564).
component("YGL062W",330).
component("YBR218C",172).
component("YPL231W",676).
component("YNR016C",599).
component("YKL182W",486).
component("YGR037C",348).
component("YPR138C",692).
component("YPL265W",678).
component("YPL036W",661).
component("YOR171C",637).
component("YOR130C",633).
component("YOR011W",626).
component("YOL156W",625).
component("YOL103W",620).
component("YOL020W",609) :- not remove_orf("YOL020W",609).
component("YNR072W",605).
component("YNL270C",591).
component("YNL142W",582).
component("YMR011W",555).
component("YLR260W",528).
component("YLR138W",515).
component("YLR100C",513).
component("YLR081W",511).
component("YLL061W",503).
component("YKR093W",498).
component("YKR053C",495).
component("YKR039W",494) :- not remove_orf("YKR039W",494).
component("YJR158W",472).
component("YJR077C",463).
component("YJL219W",451).
component("YJL214W",449).
component("YJL134W",442).
component("YJL129C",440).
component("YIL134W",417).
component("YHR096C",391).
component("YHR094C",390).
component("YHR092C",389).
component("YHL036W",374).
component("YGR121C",353).
component("YGR065C",350).
component("YGR055W",349).
component("YGL186C",337).
component("YGL077C",333).
component("YGL008C",322).
component("YFL055W",312).
component("YFL011W",308).
component("YER060W-A",293).
component("YER060W",292).
component("YER056C",291).
component("YER053C",290).
component("YEL069C",285).
component("YEL063C",284).
component("YEL017C-A",277).
component("YDR536W",276).
component("YDR508C",273).
component("YDR503C",272).
component("YDR497C",270).
component("YDR345C",260).
component("YDR343C",259).
component("YDR342C",258).
component("YDR297W",255).
component("YDR046C",234) :- not remove_orf("YDR046C",234).
component("YDL245C",227).
component("YCR032W",195).
component("YCR024C-A",194).
component("YCL025C",188).
component("YBR298C",184).
component("YBR291C",183).
component("YBR069C",157) :- not remove_orf("YBR069C",157).
component("YBR068C",156) :- not remove_orf("YBR068C",156).
component("YBR021W",153).
component("YBL042C",146).
component("U7_",121).
component("U78_",120).
component("U75_",117).
component("U74_",116).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,262) :- not remove_reaction(3620,262).
catalyst(2110,317).
catalyst(2190,317).
catalyst(5550,468).
catalyst(5791,524).
...
catalyst(6470,602).
catalyst(2300,128).
catalyst(3600,488) :- not remove_reaction(3600,488).
catalyst(8000,499).
catalyst(6890,584).
catalyst(2570,589).
catalyst(8781,254).
...
catalyst(4560,280).
catalyst(2550,601).
catalyst(1890,489) :- not remove_reaction(1890,489).
catalyst(3630,489) :- not remove_reaction(3630,489).
...
catalyst(8051,677).
catalyst(8052,677).
catalyst(3590,327) :- not remove_reaction(3590,327).
catalyst(10910,327) :- not remove_reaction(10910,327).
catalyst(4570,354).
catalyst(8181,533).
catalyst(8182,533).
catalyst(8181,448).
...
catalyst(8281,235).
catalyst(8282,235).
catalyst(3610,228) :- not remove_reaction(3610,228).
catalyst(7921,630).
catalyst(7922,630).
catalyst(8331,171).
catalyst(8332,171).
...
catalyst(1210,625).
catalyst(1160,620).
catalyst(801,609) :- not remove_reaction(801,609).
catalyst(802,609) :- not remove_reaction(802,609).
catalyst(811,609) :- not remove_reaction(811,609).
catalyst(812,609) :- not remove_reaction(812,609).
catalyst(831,609) :- not remove_reaction(831,609).
catalyst(832,609) :- not remove_reaction(832,609).
catalyst(901,609) :- not remove_reaction(901,609).
catalyst(902,609) :- not remove_reaction(902,609).
catalyst(1180,605).
catalyst(1210,605).
catalyst(931,591).
catalyst(932,591).
...
catalyst(640,498).
catalyst(6560,495).
catalyst(771,494) :- not remove_reaction(771,494).
catalyst(772,494) :- not remove_reaction(772,494).
catalyst(781,494) :- not remove_reaction(781,494).
catalyst(782,494) :- not remove_reaction(782,494).
catalyst(801,494) :- not remove_reaction(801,494).
catalyst(802,494) :- not remove_reaction(802,494).
catalyst(811,494) :- not remove_reaction(811,494).
catalyst(812,494) :- not remove_reaction(812,494).
catalyst(831,494) :- not remove_reaction(831,494).
catalyst(832,494) :- not remove_reaction(832,494).
catalyst(841,494) :- not remove_reaction(841,494).
catalyst(842,494) :- not remove_reaction(842,494).
catalyst(851,494) :- not remove_reaction(851,494).
catalyst(852,494) :- not remove_reaction(852,494).
catalyst(881,494) :- not remove_reaction(881,494).
catalyst(882,494) :- not remove_reaction(882,494).
catalyst(901,494) :- not remove_reaction(901,494).
catalyst(902,494) :- not remove_reaction(902,494).
catalyst(921,494) :- not remove_reaction(921,494).
catalyst(922,494) :- not remove_reaction(922,494).
catalyst(931,494) :- not remove_reaction(931,494).
catalyst(932,494) :- not remove_reaction(932,494).
catalyst(1191,494) :- not remove_reaction(1191,494).
catalyst(1192,494) :- not remove_reaction(1192,494).
catalyst(1180,472).
catalyst(1210,472).
catalyst(1581,463).
catalyst(1582,463).
...
catalyst(1511,183).
catalyst(1512,183).
catalyst(771,157) :- not remove_reaction(771,157).
catalyst(772,157) :- not remove_reaction(772,157).
...
catalyst(851,157) :- not remove_reaction(851,157).
catalyst(852,157) :- not remove_reaction(852,157).
...
catalyst(851,156) :- not remove_reaction(851,156).
catalyst(852,156) :- not remove_reaction(852,156).
...
modifiable_enzyme(488).
modifiable_enzyme(489).
modifiable_enzyme(301).
modifiable_enzyme(327).
modifiable_enzyme(228).
modifiable_enzyme(609).
