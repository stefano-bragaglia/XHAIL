...
component("YNL280C",795).
component("YLR056W",679).
component("YGR060W",470).
component("YGL012W",439).
component("YKR009C",656).
component("YOL086C",826).
component("YMR303C",767).
component("YMR083W",745).
component("YGL256W",463).
component("YDL168W",303).
component("YBR145W",233).
component("YPL231W",903).
component("YBR265W",251).
component("U46_",141).
component("YBR149W",234).
component("YBR149W",235).
component("YGL001C",435).
component("YIL094C",551).
component("YHR063C",517).
component("U45_",140).
component("YML056C",729).
component("YLR432W",718).
component("YHR216W",540).
component("YAR075W",196).
component("YAR073W",195).
component("YDR127W",332).
component("YJR139C",621).
component("YML075C",732).
component("YLR450W",721).
component("YOL126C",832).
component("YKL085W",633).
component("YDL078C",285).
component("YKL029C",628).
component("YNL037C",772).
component("YNL009W",770).
component("YLR174W",693).
component("YHR183W",533).
component("YGR256W",495).
component("YNL241C",787).
component("YOL059W",823).
component("YDL022W",277).
component("YCL018W",259).
component("YLR355C",713).
component("YIL074C",548).
component("YER081W",407).
component("YML054C",728).
component("YDL174C",307).
component("YML086C",734).
component("YIL155C",560).
component("YEL024W",380).
component("YKR066C",661).
component("YGR088W",474).
component("YDR256C",346).
component("YKL026C",627).
component("YIR037W",570).
component("YBR244W",246).
component("YJR078W",613).
component("U58_",150).
component("YJR025C",604).
component("U107_",27).
component("YGR255C",494).
component("U108_",28).
component("YHR007C",506).
component("YDR402C",361).
component("YGL055W",446).
component("YJR104C",616).
component("YHR008C",507).
component("YOR384W",876).
component("YOR381W",875).
component("YOL152W",835).
component("YLL051C",671).
component("YJL026W",572).
component("YIL066C",547).
component("YGR180C",482).
component("YER070W",404).
component("U37_",134).
component("U36_",133).
component("U35_",132).
component("YDL168W",304).
component("YDR158W",340).
component("YJR009C",600).
component("YJL052W",574).
component("YGR192C",484).
component("YBR006W",209).
component("YPL276W",912).
component("YPL275W",911).
component("YOR388C",877).
component("YPL061W",885).
component("YOR374W",873).
component("YER073W",405).
component("YGL154C",454).
component("YBR115C",228).
component("U55_",149).
component("YER069W",402).
component("YOR323C",865).
component("YMR170C",755).
component("YMR169C",754).
component("YER178W",417).
component("YBR221C",244).
component("YIL125W",556).
component("U52_",146).
component("YBR166C",238).
component("YNL280C",796).
component("YGL012W",440).
component("YKL182W",644).
component("YKL216W",654).
component("YDR044W",322).
component("YER014W",390).
component("YKR009C",657).
component("YIL160C",561).
component("YGL205W",459).
component("YMR118C",749).
component("YLR164W",691).
component("YLL041C",669).
component("YKL148C",638).
component("YKL141W",636).
component("YJL045W",573).
component("YDR178W",341).
component("YJR051W",607).
component("YEL047C",383).
component("YDL171C",305).
component("YDL171C",306).
component("YOR375C",874).
component("YDL215C",311).
component("YAL062W",192).
component("U99_",186).
component("U100_",21).
component("YBR035C",218).
component("YMR189W",757).
component("YKR080W",663).
component("YER023W",392).
component("YPL023C",881).
component("YGL125W",451).
component("YOR236W",862).
component("YGR204W",487).
component("YIR034C",569).
component("YLR142W",688).
component("U65_",157).
component("U63_",155).
component("U62_",154).
component("YHR068W",518).
component("YKL150W",639).
component("YIL043C",545).
component("YHR042W",512).
component("YOR221C",859).
component("YMR145C",752).
component("YML120C",735).
component("YKL192C",648).
component("YKL055C",630).
component("YER061C",400).
component("YDL085W",287).
component("YPL171C",893).
component("YHR179W",532).
component("YMR145C",753).
component("YML120C",736).
component("YKL192C",649).
component("YDL085W",288).
component("YGR234W",490).
component("YFR030W",431).
component("YPL017C",880).
component("YFL018C",421).
component("YDR353W",356).
component("YER042W",394).
component("YPR167C",931).
component("YJR137C",620).
component("YNL052W",774).
component("YMR256C",764).
component("YLR395C",717).
component("YLR038C",677).
component("YIL111W",553).
component("YHR051W",516).
component("YGL191W",457).
component("YGL187C",456).
component("YDL067C",284).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",327).
component("YPL266W",909).
component("YPL273W",910).
component("YLL062C",673).
component("YDR410C",364).
component("YKR069W",662).
component("YOL096C",827).
component("U47_",142).
component("YER091C",412).
component("YJR073C",611).
component("YGR157W",479).
component("YDR120C",330).
component("YML008C",723).
component("YOR074C",840).
component("YDL033C",279).
component("YOL096C",828).
component("YLR172C",692).
component("YLR058C",680).
component("YDR019C",318).
component("YBR176W",239).
component("YDR408C",363).
component("YMR120C",750).
component("YLR028C",675).
component("YBL013W",197).
component("YJL130C",585).
component("YJL088W",578).
component("YKL024C",626).
component("YPR074C",925).
component("YBR117C",229).
component("YMR108W",748).
component("YCL009C",258).
component("YMR062C",743).
component("YNL071W",776).
component("YNR008W",802).
component("YIL160C",562).
component("YNR019W",805).
component("YCR048W",273).
component("U48_",143).
component("YMR062C",744).
component("YDR232W",343).
component("YPL231W",904).
component("YER061C",401).
component("YPL001W",879).
component("YDL052C",283).
component("U8_",180).
component("YDR148C",338).
component("YPL231W",905).
component("YPL028W",882).
component("YLR299W",703).
component("YGL017W",441).
component("YCR005C",265).
component("YML126C",737).
component("YNL104C",779).
component("YDL182W",308).
component("YDL131W",294).
component("YDR307W",352).
component("YLR258W",700).
component("YFR015C",428).
component("YPL227C",901).
component("YNL029C",771).
component("YIL085C",550).
component("YNL192W",785).
component("YBR038W",220).
component("YBR023C",216).
component("YMR306W",768).
component("YLR342W",711).
component("YGR032W",467).
component("YPR183W",934).
component("YBR248C",247).
component("YLR209C",695).
component("U104_",24).
component("U103_",23).
component("YOR209C",857).
component("YDR354W",357) :- not remove_orf("YDR354W",357).
component("YFR047C",432).
component("YJR133W",619).
component("YLR209C",696).
component("YML022W",725).
component("YDR441C",367).
component("YHR128W",527).
component("YPR176C",933).
component("YPL172C",894).
component("YNR041C",808).
component("YMR101C",746).
component("YDL090C",290).
component("YBR003W",208).
component("YBR002C",207).
component("YJL167W",592).
component("YJL167W",593).
component("YNL256W",790).
component("YPR069C",922).
component("YDR127W",333).
component("YHR190W",535).
component("YLR146C",689).
component("YPL214C",900).
component("YHR068W",519).
component("YLR303W",705).
component("YGR012W",465).
component("YML082W",733).
component("YJR130C",618).
component("YDR035W",320).
component("YBR249C",248).
component("YLR180W",694).
component("YDR502C",371).
component("YOR274W",863).
component("YOL143C",834).
component("YBR256C",250).
component("YHR137W",528).
component("YGL202W",458).
component("YLR027C",674).
component("YKL106W",634).
component("YOL140W",833).
component("YLR438W",720).
component("YGR019W",466).
component("YLR089C",684).
component("U64_",156).
component("U61_",153).
component("U51_",145).
component("YJR148W",622).
component("YHR208W",538).
component("YFL030W",423).
component("YOR184W",851).
component("YNR058W",812).
component("YIL116W",555).
component("YGL253W",462).
component("YFR053C",433).
component("YMR013C",741).
component("YMR205C",759).
component("YGR240C",491).
component("YOL016C",816).
component("YFR014C",427).
component("YLR240W",698).
component("YKL203C",651).
component("YJR066W",610).
component("YCR036W",272).
component("YGR194C",485).
component("YCL040W",261).
component("U15_",68).
component("YPL188W",896).
component("YJR049C",606).
component("YEL041W",381).
component("U96_",184).
component("YKL001C",625).
component("YDR236C",344).
component("YML070W",731).
component("YFL053W",425).
component("YHL032C",504).
component("YDR531W",375).
component("U83_",175).
component("U82_",174).
component("U81_",173).
component("YMR208W",760).
component("YPL203W",897).
component("YOR061W",839).
component("YKL166C",641).
component("YJL164C",591).
component("YIL035C",544).
component("YHR205W",537).
component("YHR102W",525).
component("YGL019W",442).
component("YHR025W",511).
component("YOR347C",870).
component("YAL038W",190).
component("YNR012W",803).
component("YDR009W",317).
component("YDR127W",334).
component("U21_",113).
component("YDR147W",337).
component("YDR300C",351).
component("YCR012W",266).
component("YER069W",403).
component("U19_",103).
component("U18_",93).
component("U17_",83).
component("U76_",167).
component("YER170W",416).
component("YDR226W",342).
component("YKL067W",632).
component("YOL055C",820).
component("YDR454C",368).
component("YJR057W",608).
component("YOL061W",824).
component("YKL181W",643).
component("YHL011C",502).
component("YER099C",413).
component("YBL068W",204).
component("YOR143C",847).
component("YNL256W",791).
component("YLR328W",709).
component("YBR018C",211).
component("YBR018C",212).
component("YGR007W",464).
component("YGR202C",486).
component("YLR328W",710).
component("YDL045C",281).
component("U80_",172).
component("YDL103C",293).
component("U94_",183).
component("YJR010W",601).
component("YBR029C",217).
component("YCL050C",262).
component("YGL130W",452).
component("YDR530C",374).
component("YCL050C",263).
component("YPR190C",936).
component("YPR187W",935).
component("YPR110C",928).
component("YPR010C",915).
component("YOR341W",869).
component("YOR340C",868).
component("YOR224C",861).
component("YOR210W",858).
component("YOR207C",855).
component("YOR151C",848).
component("YOR116C",842).
component("YOL005C",814).
component("YNR003C",801).
component("YNL248C",789).
component("YNL151C",783).
component("YNL113W",780).
component("YKL144C",637).
component("YJR063W",609).
component("YJL148W",589).
component("YJL140W",588).
component("YIL021W",543).
component("YHR143W-A",529).
component("YGL070C",449).
component("YFL036W",424).
component("YDR404C",362).
component("YDR156W",339).
component("YDR045C",323).
component("YDL150W",302).
component("YDL140C",296).
component("YBR154C",237).
component("YPR175W",932).
component("YPL167C",892).
component("YOR330C",866).
component("YOL115W",831).
component("YNL299W",798).
component("YNL262W",793).
component("YNL102W",778).
component("YJR043C",605).
component("YJR006W",599).
component("YJL090C",579).
component("YIL139C",558).
component("YEL055C",384).
component("YDR419W",365).
component("YDR121W",331).
component("YDL102W",292).
component("YCR014C",267).
component("YBR278W",253).
component("YBL035C",200).
component("YKL035W",629).
component("YHL012W",503).
component("YHR123W",526).
component("YPR113W",929).
component("YBR243C",245).
component("YDL142C",301).
component("YPL148C",890).
component("YER026C",393).
component("YGR286C",499).
component("YJL068C",575).
component("YHR189W",534).
component("YDR058C",326).
component("YDL086W",289).
component("YOL011W",815).
component("YMR008C",739).
component("YMR006C",738).
component("U105_",25).
component("YBL015W",198).
component("YJL068C",576).
component("YJR019C",603).
component("YOR040W",838).
component("U77_",168).
component("YDR481C",369).
component("YLR377C",715).
component("YFR025C",429).
component("YPL179W",895).
component("YNR032W",806).
component("YML057W",730).
component("YML016C",724).
component("YLR433C",719).
component("YGR123C",477).
component("YER133W",414).
component("YER089C",410).
component("YDR436W",366).
component("YDR075W",328).
component("YDL188C",309).
component("YDL134C",295).
component("YDL047W",282).
component("YDL006W",275).
component("YBR125C",232).
component("YBL056W",203).
component("YPR073C",923).
component("YHR215W",539).
component("YDL024C",278).
component("YBR093C",226).
component("YBR092C",225).
component("YAR071W",194).
component("YHR046C",515).
component("U9_",187).
component("YPL228W",902).
component("YMR180C",756).
component("YDL236W",313).
component("YJL155C",590).
component("YPR073C",924).
component("YOR208W",856).
component("YNL053W",775).
component("YMR036C",742).
component("YIR026C",568).
component("YIL113W",554).
component("YFR028C",430).
component("YER075C",406).
component("YDL230W",312).
component("YBR276C",252).
component("U34_",131).
component("U33_",130).
component("U32_",129).
component("U31_",128).
...
component("U25_",122).
component("U24_",121).
component("YHR044C",514).
component("YHR043C",513).
component("YOL064C",825).
component("YOR360C",872).
component("YGL248W",461).
component("YKR031C",658).
component("YPL206C",898).
component("YGL027C",444).
component("YLR286C",702).
component("YJR153W",623).
component("YJL221C",598).
component("YJL216C",596).
component("YIL172C",566).
component("YGR292W",501).
component("YGR287C",500).
component("YBR299W",257).
component("YBR184W",240).
component("YIL162W",563).
component("YPR026W",916).
component("YDR001C",315).
component("YBR001C",206).
component("YIR019C",567).
component("YIL099W",552).
component("YDL037C",280).
component("YOR190W",853).
component("YLR300W",704).
component("YGR282C",498).
component("YDR261C",347).
component("YDR400W",360).
component("U23_",120).
component("YML035C",726).
component("YJL070C",577).
component("YBR284W",254).
component("U106_",26).
component("U102_",22).
component("YER043C",395).
component("YNL045W",773).
component("YGL037C",445).
component("YDR242W",345).
component("YLR308W",708).
component("YLR307W",707).
component("YBR208C",242).
component("YMR281W",766).
component("U53_",147).
component("YPR062W",921).
component("YMR120C",751).
component("YLR028C",676).
component("YHR144C",530).
component("YGR267C",497).
component("YBL033C",199).
component("YBR153W",236).
component("YNL141W",781).
component("YLR245C",699).
component("YML035C",727).
component("YGR204W",488).
component("YBR084W",223).
component("YJL126W",583).
component("U44_",139).
component("YDL100C",291).
component("U87_",177).
component("U40_",137).
component("U39_",135).
component("YBR011C",210).
component("YHR201C",536).
component("YBR111C",227).
component("YBR252W",249).
component("YPR080W",926).
component("YOR187W",852).
component("YOR133W",845).
component("YLR069C",682).
component("YKR084C",664).
component("YKL173W",642).
component("YJL102W",581).
component("YDR385W",359).
component("YBR118W",230).
component("YER005W",389).
component("YLL001W",667).
component("YIL048W",546).
component("YER166W",415).
component("YDR093W",329).
component("YAL026C",189).
component("YBL099W",205).
component("U60_",152).
component("YLR231C",697).
component("U88_",178).
component("YDR538W",377).
component("YLR134W",686).
component("YLR044C",678).
component("YGR087C",473).
component("YDR380W",358).
component("YDL080C",286).
component("U98_",185).
component("YMR250W",763).
component("YKL184W",647).
component("YOR128C",843).
component("YEL021W",379).
component("YNR043W",809).
component("U93_",182).
component("U54_",148).
component("YKL211C",652) :- not remove_orf("YKL211C",652).
component("YKR097W",666).
component("YOL052C",819).
component("YNL169C",784).
component("YGR170W",480).
component("YKL060C",631).
component("YNL256W",792).
component("YDR294C",349).
component("YEL046C",382).
component("YNR033W",807).
component("YKL211C",653) :- not remove_orf("YKL211C",653).
component("YER090W",653) :- not remove_orf("YER090W",653).
component("YER090W",411) :- not remove_orf("YER090W",411).
component("YDR127W",335).
component("YPL281C",913).
component("YOR393W",878).
component("YMR323W",769).
component("YHR174W",531).
component("YGR254W",493).
component("YOR202W",854).
component("YPL262W",907).
component("YGL026C",443) :- not remove_orf("YGL026C",443).
component("YGR155W",478).
component("YLR304C",706).
component("YJL200C",594).
component("YGL009C",438).
component("YNL316C",799).
component("YKL182W",645).
component("YPL212C",899).
component("YNL292W",797).
component("YGL063W",448).
component("YFL001W",419).
component("YPR002W",914).
component("YJR016C",602).
component("YCR053W",274).
component("YDR127W",336).
component("YGL148W",453).
component("YIL168W",565).
component("YIL167W",564).
component("YCL064C",264).
component("YER086W",408).
component("YLR359W",714).
component("YAL012W",188).
component("YML004C",722).
component("YFR055W",434).
component("YJL005W",571).
component("YJL121C",582).
component("YBR019C",213).
component("YBR019C",214).
component("YDR050C",325).
component("YIL020C",542).
component("YDR007W",316) :- not remove_orf("YDR007W",316).
component("YOR095C",841).
component("YER003C",388).
component("YBR196C",241).
component("YGL001C",436).
component("YPL117C",888).
component("U14_",60).
component("YOL056W",821).
component("YKL152C",640).
component("YDL021W",276).
component("YMR105C",747).
component("YKL127W",635).
component("YEL058W",385).
component("YPR060C",920).
component("YHR072W",520).
component("YPL097W",886).
component("YGR185C",483).
component("YGR264C",496).
component("YGR171C",481).
component("YHR011W",508).
component("YDR023W",319).
component("YPL104W",887).
component("YLL018C",668).
component("YPR081C",927).
component("YBR121C",231).
component("YHR020W",510).
component("YER087W",409).
component("YNL247W",788).
component("YOR168W",849).
component("YOL097C",829).
component("YDR268W",348).
component("YPR047W",919).
component("YLR060W",681).
component("YFL022C",422).
component("YPR033C",917).
component("YCR024C",268).
component("YHR019C",509).
component("YKL194C",650).
component("YIL078W",549).
component("YPL160W",891).
component("YLR382C",716).
component("YNL073W",777).
component("YDR037W",321).
component("YOR335C",867).
component("YGR094W",475).
component("YLR153C",690).
component("YAL054C",191).
component("YOR317W",864).
component("YMR246W",762).
component("YIL009W",541).
component("YER015W",391).
component("YOR142W",846).
component("YGR244C",492).
component("YPR035W",918).
component("YIL145C",559).
component("U89_",179).
component("YJL101C",580).
component("YOL049W",818).
component("YAR015W",193).
component("YER183C",418).
component("U90_",181).
component("YNR057C",811).
component("YDL141W",297).
component("YDL141W",298).
component("YGL234W",460).
component("YDL141W",299).
component("YJR103W",615).
component("YBL039C",201).
component("YGR204W",489).
component("YBR084W",224).
component("YNL220W",786).
component("YOL058W",822).
component("YDL141W",300).
component("YHR074W",521).
component("YMR217W",761).
component("YGR061C",471).
component("YJR109C",617).
component("YJL130C",586).
component("YGL062W",447).
component("YBR218C",243).
component("YPL231W",906).
component("YNR016C",804).
component("YKL182W",646).
component("YGR037C",468).
component("YPR138C",930).
component("YPL265W",908).
component("YPL134C",889).
component("YPL057C",884).
component("YPL036W",883).
component("YOR348C",871).
component("YOR222W",860).
component("YOR171C",850).
component("YOR130C",844).
component("YOR011W",837).
component("YOL156W",836).
component("YOL103W",830).
component("YOL020W",817) :- not remove_orf("YOL020W",817).
component("YNR072W",813).
component("YNR056C",810).
component("YNL318C",800).
component("YNL270C",794).
component("YNL142W",782).
component("YMR272C",765).
component("YMR202W",758).
component("YMR011W",740).
component("YLR348C",712).
component("YLR260W",701).
component("YLR138W",687).
component("YLR100C",685).
component("YLR081W",683).
component("YLL061W",672).
component("YLL043W",670).
component("YKR093W",665).
component("YKR053C",660).
component("YKR039W",659) :- not remove_orf("YKR039W",659).
component("YKL217W",655).
component("YJR158W",624).
component("YJR095W",614).
component("YJR077C",612).
component("YJL219W",597).
component("YJL214W",595).
component("YJL134W",587).
component("YJL129C",584).
component("YIL134W",557).
component("YHR096C",524).
component("YHR094C",523).
component("YHR092C",522).
component("YHL036W",505).
component("YGR121C",476).
component("YGR065C",472).
component("YGR055W",469).
component("YGL186C",455).
component("YGL077C",450).
component("YGL008C",437).
component("YFL055W",426).
component("YFL011W",420).
component("YER060W-A",399).
component("YER060W",398).
component("YER056C",397).
component("YER053C",396).
component("YEL069C",387).
component("YEL063C",386).
component("YEL017C-A",378).
component("YDR536W",376).
component("YDR508C",373).
component("YDR503C",372).
component("YDR497C",370).
component("YDR345C",355).
component("YDR343C",354).
component("YDR342C",353).
component("YDR297W",350).
component("YDR046C",324) :- not remove_orf("YDR046C",324).
component("YDL245C",314).
component("YDL210W",310).
component("YCR032W",271).
component("YCR028C",270).
component("YCR024C-A",269).
component("YCL025C",260).
component("YBR298C",256).
component("YBR291C",255).
...
catalyst(2132,23).
catalyst(2220,857).
catalyst(3620,357) :- not remove_reaction(3620,357).
catalyst(2110,432).
catalyst(2190,432).
catalyst(5550,619).
catalyst(5791,696).
...
catalyst(2300,182).
catalyst(3460,148).
catalyst(3600,652) :- not remove_reaction(3600,652).
catalyst(8000,666).
catalyst(3941,819).
catalyst(3942,819).
catalyst(6890,784).
...
catalyst(4560,382).
catalyst(2550,807).
catalyst(1890,653) :- not remove_reaction(1890,653).
catalyst(3630,653) :- not remove_reaction(3630,653).
catalyst(1890,411) :- not remove_reaction(1890,411).
catalyst(3630,411) :- not remove_reaction(3630,411).
catalyst(3740,335).
catalyst(8231,913).
catalyst(8232,913).
catalyst(8231,878).
...
catalyst(8061,907).
catalyst(8062,907).
catalyst(3590,443) :- not remove_reaction(3590,443).
catalyst(10910,443) :- not remove_reaction(10910,443).
catalyst(4570,478).
catalyst(8181,706).
catalyst(8182,706).
catalyst(8181,594).
...
catalyst(1210,836).
catalyst(1160,830).
catalyst(801,817) :- not remove_reaction(801,817).
catalyst(802,817) :- not remove_reaction(802,817).
catalyst(811,817) :- not remove_reaction(811,817).
catalyst(812,817) :- not remove_reaction(812,817).
catalyst(831,817) :- not remove_reaction(831,817).
catalyst(832,817) :- not remove_reaction(832,817).
catalyst(901,817) :- not remove_reaction(901,817).
catalyst(902,817) :- not remove_reaction(902,817).
catalyst(1180,813).
catalyst(1210,813).
catalyst(700,810).
catalyst(1200,800).
...
catalyst(650,665).
catalyst(6560,660).
catalyst(681,659) :- not remove_reaction(681,659).
catalyst(682,659) :- not remove_reaction(682,659).
catalyst(771,659) :- not remove_reaction(771,659).
catalyst(772,659) :- not remove_reaction(772,659).
catalyst(781,659) :- not remove_reaction(781,659).
catalyst(782,659) :- not remove_reaction(782,659).
catalyst(791,659) :- not remove_reaction(791,659).
catalyst(792,659) :- not remove_reaction(792,659).
...
catalyst(841,659) :- not remove_reaction(841,659).
catalyst(842,659) :- not remove_reaction(842,659).
catalyst(851,659) :- not remove_reaction(851,659).
catalyst(852,659) :- not remove_reaction(852,659).
catalyst(881,659) :- not remove_reaction(881,659).
catalyst(882,659) :- not remove_reaction(882,659).
catalyst(901,659) :- not remove_reaction(901,659).
catalyst(902,659) :- not remove_reaction(902,659).
catalyst(911,659) :- not remove_reaction(911,659).
catalyst(912,659) :- not remove_reaction(912,659).
catalyst(921,659) :- not remove_reaction(921,659).
catalyst(922,659) :- not remove_reaction(922,659).
catalyst(931,659) :- not remove_reaction(931,659).
catalyst(932,659) :- not remove_reaction(932,659).
catalyst(1191,659) :- not remove_reaction(1191,659).
catalyst(1192,659) :- not remove_reaction(1192,659).
catalyst(390,655).
catalyst(1180,624).
catalyst(1210,624).
catalyst(1250,614).
...
modifiable_enzyme(652).
modifiable_enzyme(653).
modifiable_enzyme(411).
modifiable_enzyme(443).
modifiable_enzyme(316).
modifiable_enzyme(817).
