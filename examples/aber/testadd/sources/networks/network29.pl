...
component("YLR056W",200).
component("YPL231W",261).
component("U46_",42).
component("YBR149W",63).
component("YGL001C",130).
component("YIL094C",161).
component("U45_",41).
component("YDR127W",91).
component("YOL126C",240).
component("YKL085W",184).
component("YDL078C",78).
component("YNL037C",219).
component("YML086C",215).
component("YGR088W",143).
component("YDR256C",100).
component("YJR078W",179).
component("U107_",19).
component("YER070W",123).
component("U36_",38).
component("YPL276W",267).
component("YPL275W",266).
component("YOR388C",254).
component("YOR323C",249).
component("YIL125W",162).
component("U52_",44).
component("YBR166C",65).
component("YKL216W",191).
component("YKR009C",192).
component("YIL160C",164).
component("YGL205W",140).
component("YKR080W",195).
component("YER023W",119).
component("YLR142W",203).
component("U62_",46).
component("YHR068W",152).
component("YKL150W",187).
component("YIL043C",159).
component("YPL171C",260).
component("YHR179W",157).
component("YDR353W",104).
component("YPL266W",265).
component("YDL033C",77).
component("YLR172C",205).
component("YLR058C",201).
component("YDR019C",86).
component("YBR176W",66).
component("YDR408C",109).
component("YMR120C",216).
component("YLR028C",198).
component("YPR074C",271).
component("YBR117C",62).
component("YPL231W",262).
component("YPL231W",263).
component("YLR299W",210).
component("YDL182W",84).
component("YDL131W",81).
component("YLR258W",209).
component("YFR015C",128).
component("YNL029C",218).
component("YIL085C",160).
component("YLR209C",206).
component("YDR354W",105) :- not remove_orf("YDR354W",105).
component("YFR047C",129).
component("YLR209C",207).
component("YML022W",213).
component("YDR441C",111).
component("YJL167W",174).
component("YDR127W",92).
component("YJR130C",181).
component("YDR035W",87).
component("YBR249C",68).
component("YOR274W",248).
component("YHR137W",153).
component("YGL202W",139).
component("YLR027C",197).
component("YKL106W",185).
component("YJR148W",182).
component("YNR058W",233).
component("YCR036W",76).
component("U96_",49).
component("YNR012W",231).
component("YDR127W",93).
component("YDR147W",96).
component("U76_",47).
component("YDR226W",98).
component("YKL067W",183).
component("YDR454C",112).
component("YOL061W",236).
component("YKL181W",188).
component("YHL011C",150).
component("YER099C",125).
component("YBL068W",56).
component("YNL256W",225).
component("YBR018C",58).
component("YGL130W",136).
component("YPR190C",277).
component("YPR187W",276).
component("YPR110C",272).
component("YPR010C",269).
component("YOR341W",253).
component("YOR340C",252).
component("YOR224C",247).
component("YOR210W",246).
component("YOR207C",245).
component("YOR151C",243).
component("YOR116C",242).
component("YOL005C",234).
component("YNR003C",230).
component("YNL248C",224).
component("YNL151C",223).
component("YNL113W",221).
component("YKL144C",186).
component("YJR063W",177).
component("YJL148W",173).
component("YJL140W",172).
component("YIL021W",158).
component("YHR143W-A",154).
component("YGL070C",135).
component("YFL036W",126).
component("YDR404C",108).
component("YDR156W",97).
component("YDR045C",88).
component("YDL150W",83).
component("YDL140C",82).
component("YBR154C",64).
component("YPR175W",275).
component("YPL167C",259).
component("YOR330C",250).
component("YOL115W",239).
component("YNL299W",228).
component("YNL262W",226).
component("YNL102W",220).
component("YJR043C",176).
component("YJR006W",175).
component("YJL090C",168).
component("YIL139C",163).
component("YEL055C",116).
component("YDR419W",110).
component("YDR121W",90).
component("YDL102W",80).
component("YCR014C",75).
component("YBR278W",70).
component("YBL035C",54).
component("YPR113W",273).
component("U105_",18).
component("YBL015W",53).
component("YLR377C",212).
component("U30_",37).
component("U29_",36).
component("U24_",35).
component("YGL027C",133).
component("YOR190W",244).
component("YLR300W",211).
component("YGR282C",149).
component("YDR261C",101).
component("YDR400W",107).
component("YML035C",214).
component("YJL070C",167).
component("YBR284W",71).
component("YDR242W",99).
component("U53_",45).
component("YLR028C",199).
component("YHR144C",155).
component("YJL126W",169).
component("U39_",39).
component("YBR011C",57).
component("YBR111C",61).
component("YBR252W",69).
component("YER005W",118).
component("YLR231C",208).
component("YDR380W",106).
component("YDL080C",79).
component("U98_",50).
component("YKL211C",189) :- not remove_orf("YKL211C",189).
component("YKL211C",190) :- not remove_orf("YKL211C",190).
component("YER090W",190) :- not remove_orf("YER090W",190).
component("YER090W",124) :- not remove_orf("YER090W",124).
component("YDR127W",94).
component("YPL281C",268).
component("YOR393W",255).
component("YMR323W",217).
component("YHR174W",156).
component("YGR254W",147).
component("YGL026C",132) :- not remove_orf("YGL026C",132).
component("YNL316C",229).
component("YDR127W",95).
component("YGL148W",137).
component("YIL168W",166).
component("YIL167W",165).
component("YCL064C",74).
component("YAL012W",51).
component("YDR007W",85) :- not remove_orf("YDR007W",85).
component("YOR095C",241).
component("YGL001C",131).
component("YPL117C",258).
component("YPR060C",270).
component("YPL097W",256).
component("YGR185C",146).
component("YGR264C",148).
component("YGR171C",145).
component("YPL104W",257).
component("YLL018C",196).
component("YOL097C",237).
component("YDR268W",102).
component("YOR335C",251).
component("YLR153C",204).
component("YAL054C",52).
component("U90_",48).
component("YNR057C",232).
component("YJR103W",180).
component("YBL039C",55).
component("YGL062W",134).
component("YBR218C",67).
component("YPR138C",274).
component("YPL265W",264).
component("YOL103W",238).
component("YOL020W",235) :- not remove_orf("YOL020W",235).
component("YNL270C",227).
component("YNL142W",222).
component("YLR100C",202).
component("YKR053C",194).
component("YKR039W",193) :- not remove_orf("YKR039W",193).
component("YJR077C",178).
component("YJL134W",171).
component("YJL129C",170).
component("YHL036W",151).
component("YGR121C",144).
component("YGR065C",142).
component("YGR055W",141).
component("YGL186C",138).
component("YFL055W",127).
component("YER060W-A",122).
component("YER060W",121).
component("YER056C",120).
component("YEL063C",117).
component("YDR536W",115).
component("YDR508C",114).
component("YDR497C",113).
component("YDR297W",103).
component("YDR046C",89) :- not remove_orf("YDR046C",89).
...
catalyst(5601,206).
catalyst(5602,206).
catalyst(3620,105) :- not remove_reaction(3620,105).
catalyst(2190,129).
catalyst(5791,207).
catalyst(5792,207).
catalyst(5801,207).
...
catalyst(8812,79).
catalyst(2250,50).
catalyst(3600,189) :- not remove_reaction(3600,189).
catalyst(3630,190) :- not remove_reaction(3630,190).
catalyst(3630,124) :- not remove_reaction(3630,124).
catalyst(3740,94).
catalyst(8231,268).
catalyst(8232,268).
catalyst(8231,255).
...
catalyst(8231,147).
catalyst(8232,147).
catalyst(3590,132) :- not remove_reaction(3590,132).
catalyst(10910,132) :- not remove_reaction(10910,132).
catalyst(3680,229).
catalyst(3750,95).
catalyst(3700,137).
catalyst(8751,166).
...
catalyst(781,193) :- not remove_reaction(781,193).
catalyst(782,193) :- not remove_reaction(782,193).
...
catalyst(881,193) :- not remove_reaction(881,193).
catalyst(882,193) :- not remove_reaction(882,193).
catalyst(901,193) :- not remove_reaction(901,193).
catalyst(902,193) :- not remove_reaction(902,193).
catalyst(931,193) :- not remove_reaction(931,193).
catalyst(932,193) :- not remove_reaction(932,193).
catalyst(1191,193) :- not remove_reaction(1191,193).
catalyst(1192,193) :- not remove_reaction(1192,193).
catalyst(1581,178).
catalyst(1582,178).
catalyst(6560,171).
catalyst(361,170).
