...
component("YLR056W",323).
component("YKR009C",310).
component("YOL086C",391).
component("YMR303C",356).
component("YGL256W",224).
component("YDL168W",142).
component("YBR145W",108).
component("YPL231W",427).
component("U46_",66).
component("YBR149W",109).
component("YGL001C",205).
component("YIL094C",262).
component("U45_",65).
component("YDR127W",153).
component("YOL126C",395).
component("YKL085W",300).
component("YDL078C",135).
component("YNL037C",360).
component("YCL018W",121).
component("YLR355C",343).
component("YDL174C",144).
component("YML086C",348).
component("YGR088W",231).
component("YDR256C",163).
component("YJR078W",293).
component("YJR025C",286).
component("U107_",23).
component("YJR104C",295).
component("YHR008C",245).
component("YJL026W",273).
component("YGR180C",234).
component("YER070W",191).
component("U36_",61).
component("YDL168W",143).
component("YPL276W",435).
component("YPL275W",434).
component("YOR388C",416).
component("YOR323C",410).
component("YER178W",196).
component("YIL125W",265).
component("U52_",69).
component("YBR166C",111).
component("YGL012W",208).
component("YKL216W",309).
component("YKR009C",311).
component("YIL160C",268).
component("YGL205W",221).
component("U100_",20).
component("YKR080W",315).
component("YER023W",186).
component("YGR204W",236).
component("YLR142W",328).
component("U65_",74).
component("U62_",73).
component("YHR068W",251).
component("YKL150W",303).
component("YIL043C",260).
component("YPL171C",424).
component("YHR179W",258).
component("YGR234W",237).
component("YDR353W",167).
component("YPR167C",446).
component("YNL052W",361).
component("YMR256C",355).
component("YLR395C",345).
component("YLR038C",321).
component("YIL111W",263).
component("YHR051W",250).
component("YGL191W",219).
component("YGL187C",218).
component("YDL067C",134).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",433).
component("YKR069W",314).
component("YJR073C",291).
component("YDL033C",133).
component("YLR172C",330).
component("YLR058C",324).
component("YDR019C",148).
component("YBR176W",112).
component("YDR408C",172).
component("YMR120C",353).
component("YLR028C",319).
component("YBL013W",91).
component("YJL130C",278).
component("YKL024C",298).
component("YPR074C",442).
component("YBR117C",107).
component("YCL009C",120).
component("YNL071W",363).
component("YIL160C",269).
component("U48_",67).
component("YPL231W",428).
component("YPL231W",429).
component("YLR299W",337).
component("YGL017W",209).
component("YML126C",349).
component("YNL104C",365).
component("YDL182W",145).
component("YDL131W",139).
component("YLR258W",335).
component("YFR015C",201).
component("YNL029C",359).
component("YIL085C",261).
component("YMR306W",357).
component("YLR342W",342).
component("YGR032W",226).
component("YLR209C",331).
component("U104_",21).
component("YDR354W",168) :- not remove_orf("YDR354W",168).
component("YFR047C",203).
component("YLR209C",332).
component("YML022W",346).
component("YDR441C",174).
component("YJL167W",282).
component("YDR127W",154).
component("YHR068W",252).
component("YLR303W",339).
component("YGR012W",225).
component("YJR130C",296).
component("YDR035W",149).
component("YBR249C",114).
component("YOR274W",409).
component("YHR137W",254).
component("YGL202W",220).
component("YLR027C",318).
component("YKL106W",301).
component("YOL140W",396).
component("YLR089C",325).
component("U61_",72).
component("YJR148W",297).
component("YFL030W",197).
component("YNR058W",382).
component("YGL253W",223).
component("YFR053C",204).
component("YOL016C",385).
component("YFR014C",200).
component("YCR036W",130).
component("YCL040W",123).
component("YPL188W",425).
component("YJR049C",288).
component("YEL041W",181).
component("U96_",86).
component("YDR236C",161).
component("YHL032C",243).
component("YNR012W",378).
component("YDR127W",155).
component("YDR147W",158).
component("YCR012W",125).
component("U76_",82).
component("YER170W",195).
component("YDR226W",160).
component("YKL067W",299).
component("YOL055C",388).
component("YDR454C",175).
component("YJR057W",289).
component("YOL061W",390).
component("YKL181W",305).
component("YHL011C",242).
component("YER099C",194).
component("YBL068W",96).
component("YOR143C",401).
component("YNL256W",372).
component("YBR018C",99).
component("YLR328W",341).
component("U94_",85).
component("YBR029C",101).
component("YGL130W",215).
component("YPR190C",449).
component("YPR187W",448).
component("YPR110C",443).
component("YPR010C",438).
component("YOR341W",414).
component("YOR340C",413).
component("YOR224C",408).
component("YOR210W",407).
component("YOR207C",405).
component("YOR151C",402).
component("YOR116C",399).
component("YOL005C",383).
component("YNR003C",377).
component("YNL248C",371).
component("YNL151C",369).
component("YNL113W",366).
component("YKL144C",302).
component("YJR063W",290).
component("YJL148W",281).
component("YJL140W",280).
component("YIL021W",259).
component("YHR143W-A",255).
component("YGL070C",213).
component("YFL036W",198).
component("YDR404C",171).
component("YDR156W",159).
component("YDR045C",150).
component("YDL150W",141).
component("YDL140C",140).
component("YBR154C",110).
component("YPR175W",447).
component("YPL167C",423).
component("YOR330C",411).
component("YOL115W",394).
component("YNL299W",375).
component("YNL262W",373).
component("YNL102W",364).
component("YJR043C",287).
component("YJR006W",284).
component("YJL090C",275).
component("YIL139C",266).
component("YEL055C",183).
component("YDR419W",173).
component("YDR121W",152).
component("YDL102W",138).
component("YCR014C",126).
component("YBR278W",117).
component("YBL035C",94).
component("YPR113W",444).
component("YPL148C",422).
component("YGR286C",241).
component("YOL011W",384).
component("YMR008C",351).
component("YMR006C",350).
component("U105_",22).
component("YBL015W",92).
component("U77_",83).
component("YLR377C",344).
component("YHR046C",249).
component("U9_",88).
component("YPR073C",441).
component("YOR208W",406).
component("YNL053W",362).
component("YMR036C",352).
component("YIR026C",272).
component("YIL113W",264).
component("YFR028C",202).
component("YER075C",192).
component("YDL230W",146).
component("YBR276C",116).
component("U30_",60).
component("U29_",59).
component("U26_",58).
component("U24_",57).
component("YHR044C",248).
component("YHR043C",247).
component("YOR360C",415).
component("YPL206C",426).
component("YGL027C",211).
component("YOR190W",404).
component("YLR300W",338).
component("YGR282C",240).
component("YDR261C",164).
component("YDR400W",170).
component("YML035C",347).
component("YJL070C",274).
component("YBR284W",118).
component("YDR242W",162).
component("U53_",70).
component("YPR062W",440).
component("YMR120C",354).
component("YLR028C",320).
component("YHR144C",256).
component("YBL033C",93).
component("YNL141W",367).
component("YLR245C",334).
component("YBR084W",104).
component("YJL126W",276).
component("YDL100C",137).
component("U39_",62).
component("YBR011C",98).
component("YBR111C",106).
component("YBR252W",115).
component("YER005W",185).
component("YBL099W",97).
component("YLR231C",333).
component("YLR134W",327).
component("YLR044C",322).
component("YGR087C",230).
component("YDR380W",169).
component("YDL080C",136).
component("U98_",87).
component("YOR128C",400).
component("YKL211C",307) :- not remove_orf("YKL211C",307).
component("YKR097W",316).
component("YNL169C",370).
component("YEL046C",182).
component("YNR033W",380).
component("YKL211C",308) :- not remove_orf("YKL211C",308).
component("YER090W",308) :- not remove_orf("YER090W",308).
component("YER090W",193) :- not remove_orf("YER090W",193).
component("YDR127W",156).
component("YPL281C",436).
component("YOR393W",417).
component("YMR323W",358).
component("YHR174W",257).
component("YGR254W",238).
component("YPL262W",431).
component("YGL026C",210) :- not remove_orf("YGL026C",210).
component("YLR304C",340).
component("YJL200C",283).
component("YNL316C",376).
component("YPR002W",437).
component("YJR016C",285).
component("YCR053W",131).
component("YDR127W",157).
component("YGL148W",216).
component("YIL168W",271).
component("YIL167W",270).
component("YCL064C",124).
component("YAL012W",89).
component("YBR019C",100).
component("YDR007W",147) :- not remove_orf("YDR007W",147).
component("YOR095C",398).
component("YGL001C",206).
component("YPL117C",421).
component("YOL056W",389).
component("YKL152C",304).
component("YDL021W",132).
component("YPR060C",439).
component("YPL097W",419).
component("YGR185C",235).
component("YGR264C",239).
component("YGR171C",233).
component("YPL104W",420).
component("YLL018C",317).
component("YOL097C",392).
component("YDR268W",165).
component("YCR024C",127).
component("YHR019C",246).
component("YOR335C",412).
component("YLR153C",329).
component("YAL054C",90).
component("YIL145C",267).
component("YOL049W",387).
component("U90_",84).
component("YNR057C",381).
component("YGL234W",222).
component("YJR103W",294).
component("YBL039C",95).
component("YBR084W",105).
component("YHR074W",253).
component("YGL062W",212).
component("YBR218C",113).
component("YPL231W",430).
component("YNR016C",379).
component("YKL182W",306).
component("YGR037C",227).
component("YPR138C",445).
component("YPL265W",432).
component("YPL036W",418).
component("YOR171C",403).
component("YOR011W",397).
component("YOL103W",393).
component("YOL020W",386) :- not remove_orf("YOL020W",386).
component("YNL270C",374).
component("YNL142W",368).
component("YLR260W",336).
component("YLR100C",326).
component("YKR053C",313).
component("YKR039W",312) :- not remove_orf("YKR039W",312).
component("YJR077C",292).
component("YJL134W",279).
component("YJL129C",277).
component("YHL036W",244).
component("YGR121C",232).
component("YGR065C",229).
component("YGR055W",228).
component("YGL186C",217).
component("YGL077C",214).
component("YGL008C",207).
component("YFL055W",199).
component("YER060W-A",190).
component("YER060W",189).
component("YER056C",188).
component("YER053C",187).
component("YEL063C",184).
component("YEL017C-A",180).
component("YDR536W",179).
component("YDR508C",178).
component("YDR503C",177).
component("YDR497C",176).
component("YDR297W",166).
component("YDR046C",151) :- not remove_orf("YDR046C",151).
component("YCR032W",129).
component("YCR024C-A",128).
component("YCL025C",122).
component("YBR298C",119).
component("YBR069C",103) :- not remove_orf("YBR069C",103).
component("YBR068C",102) :- not remove_orf("YBR068C",102).
component("U75_",81).
component("U74_",80).
component("U73_",79).
component("U72_",78).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,168) :- not remove_reaction(3620,168).
catalyst(2190,203).
catalyst(5791,332).
catalyst(5792,332).
catalyst(5801,332).
...
catalyst(6111,400).
catalyst(6112,400).
catalyst(3600,307) :- not remove_reaction(3600,307).
catalyst(8000,316).
catalyst(6890,370).
catalyst(4560,182).
catalyst(2550,380).
catalyst(3630,308) :- not remove_reaction(3630,308).
...
catalyst(8051,431).
catalyst(8052,431).
catalyst(3590,210) :- not remove_reaction(3590,210).
catalyst(10910,210) :- not remove_reaction(10910,210).
catalyst(8181,340).
catalyst(8182,340).
catalyst(8181,283).
catalyst(8182,283).
...
catalyst(7751,100).
catalyst(7752,100).
catalyst(3610,147) :- not remove_reaction(3610,147).
catalyst(7921,398).
catalyst(7922,398).
catalyst(6370,206).
catalyst(6461,421).
...
catalyst(22,397).
catalyst(1160,393).
catalyst(801,386) :- not remove_reaction(801,386).
catalyst(802,386) :- not remove_reaction(802,386).
catalyst(811,386) :- not remove_reaction(811,386).
catalyst(812,386) :- not remove_reaction(812,386).
catalyst(831,386) :- not remove_reaction(831,386).
catalyst(832,386) :- not remove_reaction(832,386).
catalyst(901,386) :- not remove_reaction(901,386).
catalyst(902,386) :- not remove_reaction(902,386).
catalyst(931,374).
catalyst(932,374).
catalyst(371,368).
catalyst(372,368).
...
catalyst(6330,326).
catalyst(6560,313).
catalyst(771,312) :- not remove_reaction(771,312).
catalyst(772,312) :- not remove_reaction(772,312).
catalyst(781,312) :- not remove_reaction(781,312).
catalyst(782,312) :- not remove_reaction(782,312).
catalyst(801,312) :- not remove_reaction(801,312).
catalyst(802,312) :- not remove_reaction(802,312).
catalyst(811,312) :- not remove_reaction(811,312).
catalyst(812,312) :- not remove_reaction(812,312).
catalyst(831,312) :- not remove_reaction(831,312).
catalyst(832,312) :- not remove_reaction(832,312).
catalyst(841,312) :- not remove_reaction(841,312).
catalyst(842,312) :- not remove_reaction(842,312).
catalyst(851,312) :- not remove_reaction(851,312).
catalyst(852,312) :- not remove_reaction(852,312).
catalyst(881,312) :- not remove_reaction(881,312).
catalyst(882,312) :- not remove_reaction(882,312).
catalyst(901,312) :- not remove_reaction(901,312).
catalyst(902,312) :- not remove_reaction(902,312).
catalyst(931,312) :- not remove_reaction(931,312).
catalyst(932,312) :- not remove_reaction(932,312).
catalyst(1191,312) :- not remove_reaction(1191,312).
catalyst(1192,312) :- not remove_reaction(1192,312).
catalyst(1581,292).
catalyst(1582,292).
catalyst(6560,279).
catalyst(361,277).
...
catalyst(851,151) :- not remove_reaction(851,151).
catalyst(852,151) :- not remove_reaction(852,151).
...
catalyst(1121,119).
catalyst(1122,119).
catalyst(771,103) :- not remove_reaction(771,103).
catalyst(772,103) :- not remove_reaction(772,103).
...
catalyst(851,103) :- not remove_reaction(851,103).
catalyst(852,103) :- not remove_reaction(852,103).
catalyst(901,103) :- not remove_reaction(901,103).
catalyst(902,103) :- not remove_reaction(902,103).
...
catalyst(831,102) :- not remove_reaction(831,102).
catalyst(832,102) :- not remove_reaction(832,102).
catalyst(841,102) :- not remove_reaction(841,102).
catalyst(842,102) :- not remove_reaction(842,102).
