...
component("YLR056W",701).
component("YGR060W",485).
component("YGL012W",453).
component("YKR009C",678).
component("YOL086C",852).
component("YMR303C",791).
component("YMR083W",769).
component("YGL256W",478).
component("YDL168W",313).
component("YBR145W",240).
component("YPL231W",934).
component("YBR265W",259).
component("U46_",146).
component("YBR149W",241).
component("YBR149W",242).
component("YGL001C",449).
component("YIL094C",569).
component("YHR063C",533).
component("U45_",145).
component("YML056C",753).
component("YLR432W",742).
component("YHR216W",557).
component("YAR075W",203).
component("YAR073W",202).
component("YDR127W",343).
component("YJR139C",641).
component("YML075C",756).
component("YLR450W",745).
component("YOL126C",858).
component("YKL085W",655).
component("YDL078C",295).
component("YKL029C",650).
component("YNL037C",796).
component("YNL009W",794).
component("YLR174W",715).
component("YHR183W",550).
component("YGR256W",511).
component("YNL241C",811).
component("YOL059W",849).
component("YDL022W",287).
component("YCL018W",267).
component("YLR355C",737).
component("YIL074C",566).
component("YER081W",421).
component("YML054C",752).
component("YDL174C",317).
component("YML086C",758).
component("YIL155C",578).
component("YEL024W",392).
component("YKR066C",683).
component("YGR088W",489).
component("YDR256C",357).
component("YKL026C",649).
component("YIR037W",589).
component("YBR244W",254).
component("YJR078W",633).
component("U58_",155).
component("YJR025C",624).
component("U107_",27).
component("YGR255C",510).
component("U108_",28).
component("YHR007C",522).
component("YDR402C",372).
component("YGL055W",460).
component("YJR104C",636).
component("YHR008C",523).
component("YOR384W",905).
component("YOR381W",904).
component("YOL152W",861).
component("YLL051C",693).
component("YJL026W",591).
component("YIL066C",565).
component("YGR180C",497).
component("YER070W",418).
component("U37_",139).
component("U36_",138).
component("U35_",137).
component("YDL168W",314).
component("YDR158W",351).
component("YJR009C",620).
component("YJL052W",593).
component("YGR192C",499).
component("YBR006W",216).
component("YPL276W",944).
component("YPL275W",943).
component("YOR388C",906).
component("YPL061W",914).
component("YOR374W",902).
component("YER073W",419).
component("YGL154C",468).
component("YBR115C",235).
component("U55_",154).
component("YER069W",416).
component("YOR323C",893).
component("YMR170C",779).
component("YMR169C",778).
component("YER178W",431).
component("YBR221C",252).
component("YIL125W",574).
component("U52_",151).
component("YBR166C",245).
component("YNL280C",820).
component("YGL012W",454).
component("YKL182W",666).
component("YKL216W",676).
component("YDR044W",332).
component("YER014W",402).
component("YKR009C",679).
component("YIL160C",579).
component("YGL205W",473).
component("YMR118C",773).
component("YLR164W",713).
component("YLL041C",691).
component("YKL148C",660).
component("YKL141W",658).
component("YJL045W",592).
component("YDR178W",352).
component("YJR051W",627).
component("YEL047C",395).
component("YDL171C",315).
component("YDL171C",316).
component("YOR375C",903).
component("YDL215C",321).
component("YAL062W",199).
component("U99_",193).
component("U100_",21).
component("YBR035C",225).
component("YMR189W",781).
component("YKR080W",685).
component("YER023W",404).
component("YPL023C",910).
component("YGL125W",465).
component("YOR236W",890).
component("YGR204W",502).
component("YIR034C",588).
component("YLR142W",710).
component("U65_",162).
component("U63_",160).
component("U62_",159).
component("YOR356W",900).
component("YHR068W",534).
component("YKL150W",661).
component("YIL043C",562).
component("YHR042W",528).
component("YOR221C",887).
component("YMR145C",776).
component("YML120C",759).
component("YKL192C",670).
component("YKL055C",652).
component("YER061C",412).
component("YDL085W",297).
component("YPL171C",923).
component("YHR179W",549).
component("YMR145C",777).
component("YML120C",760).
component("YKL192C",671).
component("YDL085W",298).
component("YGR234W",505).
component("YFR030W",445).
component("YPL017C",909).
component("YFL018C",435).
component("YPL091W",915).
component("YDR353W",367).
component("YER042W",406).
component("YPR167C",966).
component("YJR137C",640).
component("YNL052W",798).
component("YMR256C",788).
component("YLR395C",741).
component("YLR038C",699).
component("YIL111W",571).
component("YHR051W",532).
...
component("Q0250",19).
component("Q0045",18).
component("YDR072C",337).
component("YPL266W",941).
component("YPL273W",942).
component("YLL062C",695).
component("YDR410C",375).
component("YKR069W",684).
component("YOL096C",853).
component("U47_",147).
component("YER091C",426).
component("YJR073C",631).
component("YGR157W",494).
component("YDR120C",341).
component("YML008C",747).
component("YOR074C",867).
component("YDL033C",289).
component("YOL096C",854).
component("YLR172C",714).
component("YLR058C",702).
component("YDR019C",328).
component("YBR176W",246).
component("YDR408C",374).
component("YMR120C",774).
component("YLR028C",697).
component("YBL013W",204).
component("YJL130C",605).
component("YJL088W",598).
component("YKL024C",647).
component("YPR074C",958).
component("YBR117C",236).
component("YMR108W",772).
component("YCL009C",266).
component("YMR062C",767).
component("YNL071W",800).
component("YNR008W",826).
component("YIL160C",580).
component("YNR019W",829).
component("YCR048W",282).
component("U48_",148).
component("YMR062C",768).
component("YDR232W",354).
component("YPL231W",935).
component("YER061C",413).
component("YPL001W",908).
component("YDL052C",293).
component("U8_",186).
component("YDR148C",349).
component("YPL231W",936).
component("YPL028W",911).
component("YLR299W",726).
component("YGL017W",455).
component("YCR005C",274).
component("YML126C",761).
component("YNL104C",803).
component("YDL182W",318).
component("YDL131W",304).
component("YPR160W",965).
component("YDR307W",363).
component("YLR258W",723).
component("YFR015C",442).
component("YPL227C",932).
component("YNL029C",795).
component("YIL085C",568).
component("YNL192W",809).
component("YBR038W",227).
component("YBR023C",223).
component("YEL011W",389).
component("YMR306W",792).
component("YLR342W",735).
component("YGR032W",482).
component("YPR183W",969).
component("YBR248C",255).
component("YLR209C",717).
component("U104_",24).
component("U103_",23).
component("YOR209C",885).
component("YDR354W",368) :- not remove_orf("YDR354W",368).
component("YFR047C",446).
component("YJR133W",639).
component("U22_",124).
component("YLR209C",718).
component("YML022W",749).
component("YDR441C",378).
component("YHR128W",543).
component("YPR176C",968).
component("YPL172C",924).
component("YNR041C",833).
component("YMR101C",770).
component("YDL090C",300).
component("YBR003W",215).
component("YBR002C",214).
component("YJL167W",612).
component("YJL167W",613).
component("YNL256W",814).
component("YPR069C",955).
component("YDR127W",344).
component("YHR190W",552).
component("YLR146C",711).
component("YPL214C",930).
component("YHR068W",535).
component("YLR303W",728).
component("YGR012W",480).
component("YML082W",757).
component("YJR130C",638).
component("YLR303W",729).
component("YDR035W",330).
component("YBR249C",256).
component("YLR180W",716).
component("YDR502C",382).
component("YOR274W",891).
component("YOL143C",860).
component("YBR256C",258).
component("YHR137W",544).
component("YGL202W",472).
component("YLR027C",696).
component("YKL106W",656).
component("YOL140W",859).
component("YLR438W",744).
component("YGR019W",481).
component("YLR089C",706).
component("YDR111C",340).
component("U64_",161).
component("U61_",158).
component("U51_",150).
component("YJR148W",642).
component("YHR208W",555).
component("YFL030W",437).
component("YOR184W",878).
component("YNR058W",837).
component("YIL116W",573).
component("YGL253W",477).
component("YFR053C",447).
component("YMR013C",765).
component("YMR205C",783).
component("YGR240C",506).
component("YOL016C",841).
component("YFR014C",441).
component("YLR240W",721).
component("YKL203C",673).
component("YJR066W",630).
component("YCR036W",281).
component("YGR194C",500).
component("YCL040W",270).
component("U15_",68).
component("YPL188W",926).
component("YJR049C",626).
component("YEL041W",393).
component("U96_",191).
component("YKL001C",645).
component("YDR236C",355).
component("YML070W",755).
component("YFL053W",439).
component("YHL032C",520).
component("YDR531W",386).
component("U83_",180).
component("U82_",179).
component("U81_",178).
component("YMR208W",784).
component("YPL203W",927).
component("YOR061W",865).
component("YKL166C",663).
component("YJL164C",611).
component("YIL035C",561).
component("YHR205W",554).
component("YHR102W",541).
component("YGL019W",456).
component("YHR025W",527).
component("YOR347C",898).
component("YAL038W",197).
component("YNR012W",827).
component("YPR121W",963).
component("YPL258C",938).
component("YOL055C",845).
component("YPL214C",931).
component("U1_",104).
component("YDR009W",327).
component("YDR127W",345).
component("U21_",116).
component("U20_",113).
component("YDR147W",348).
component("YDR300C",362).
component("YCR012W",275).
component("YER069W",417).
component("U19_",103).
component("YKL024C",648).
component("U18_",93).
component("U17_",83).
component("U76_",172).
component("YER170W",430).
component("YDR226W",353).
component("YKL067W",654).
component("YOL055C",846).
component("YDR454C",379).
component("YJR057W",628).
component("YOL061W",850).
component("YKL181W",665).
component("YHL011C",518).
component("YER099C",427).
component("YBL068W",211).
component("YOR143C",874).
component("YNL256W",815).
component("YLR328W",733).
component("YBR018C",218).
component("YBR018C",219).
component("YGR007W",479).
component("YGR202C",501).
component("YLR328W",734).
component("YDL045C",291).
component("U80_",177).
component("YDL103C",303).
component("U94_",190).
component("YJR010W",621).
component("YBR029C",224).
component("YCL050C",271).
component("YGL130W",466).
component("YDR530C",385).
component("YCL050C",272).
component("YPR190C",971).
component("YPR187W",970).
component("YPR110C",961).
component("YPR010C",948).
component("YOR341W",897).
component("YOR340C",896).
component("YOR224C",889).
component("YOR210W",886).
component("YOR207C",883).
component("YOR151C",875).
component("YOR116C",869).
component("YOL005C",839).
component("YNR003C",825).
component("YNL248C",813).
component("YNL151C",807).
component("YNL113W",804).
component("YKL144C",659).
component("YJR063W",629).
component("YJL148W",609).
component("YJL140W",608).
component("YIL021W",560).
component("YHR143W-A",545).
component("YGL070C",463).
component("YFL036W",438).
component("YDR404C",373).
component("YDR156W",350).
component("YDR045C",333).
component("YDL150W",312).
component("YDL140C",306).
component("YBR154C",244).
component("YPR175W",967).
component("YPL167C",922).
component("YOR330C",894).
component("YOL115W",857).
component("YNL299W",822).
component("YNL262W",817).
component("YNL102W",802).
component("YJR043C",625).
component("YJR006W",619).
component("YJL090C",599).
component("YIL139C",576).
component("YEL055C",396).
component("YDR419W",376).
component("YDR121W",342).
component("YDL102W",302).
component("YCR014C",276).
component("YBR278W",261).
component("YBL035C",207).
component("YKL035W",651).
component("YHL012W",519).
component("YHR123W",542).
component("YPR113W",962).
component("YBR243C",253).
component("YDL142C",311).
component("YPL148C",920).
component("YER026C",405).
component("YGR286C",515).
component("YJL068C",594).
component("YHR189W",551).
component("YDR058C",336).
component("YNR034W",832).
component("YHR163W",547).
component("YGR248W",508).
component("YCR073W-A",284).
component("YDL086W",299).
component("YOL011W",840).
component("YMR008C",763).
component("YMR006C",762).
component("U105_",25).
component("YBL015W",205).
component("YJL068C",595).
component("YJR019C",623).
component("YOR040W",864).
component("U84_",181).
component("U77_",173).
component("YDR481C",380).
component("YLR377C",739).
component("YFR025C",443).
component("YPL179W",925).
component("YNR032W",830).
component("YML057W",754).
component("YML016C",748).
component("YLR433C",743).
component("YGR123C",492).
component("YER133W",428).
component("YER089C",424).
component("YDR436W",377).
component("YDR075W",338).
component("YDL188C",319).
component("YDL134C",305).
component("YDL047W",292).
component("YDL006W",285).
component("YBR125C",239).
component("YBL056W",210).
component("YPR073C",956).
component("YHR215W",556).
component("YDL024C",288).
component("YBR093C",233).
component("YBR092C",232).
component("YAR071W",201).
component("YIL053W",564).
component("YER062C",414).
component("YHR046C",531).
component("U9_",194).
component("YPL228W",933).
component("YMR180C",780).
component("YDL236W",323).
component("YJL155C",610).
component("YPR073C",957).
component("YOR208W",884).
component("YNL053W",799).
component("YMR036C",766).
component("YIR026C",586).
component("YIL113W",572).
component("YFR028C",444).
component("YER075C",420).
component("YDL230W",322).
component("YBR276C",260).
component("U34_",136).
component("U33_",135).
component("U32_",134).
component("U31_",133).
...
component("U25_",127).
component("U24_",126).
component("YHR044C",530).
component("YHR043C",529).
component("YOL064C",851).
component("YOR360C",901).
component("YGL248W",476).
component("YKR031C",680).
component("YPL206C",928).
component("YGL027C",458).
component("YLR286C",725).
component("YJR153W",643).
component("YJL221C",618).
component("YJL216C",616).
component("YIL172C",584).
component("YGR292W",517).
component("YGR287C",516).
component("YBR299W",265).
component("YBR184W",247).
component("YIL162W",581).
component("YPR026W",949).
component("YDR001C",325).
component("YBR001C",213).
component("YIR019C",585).
component("YIL099W",570).
component("YDL037C",290).
component("YOR190W",880).
component("YLR300W",727).
component("YGR282C",514).
component("YDR261C",358).
component("YDR400W",371).
component("U23_",125).
component("YML035C",750).
component("YJL070C",596).
component("YBR284W",262).
component("U106_",26).
component("U102_",22).
component("YER043C",407).
component("YNL045W",797).
component("YGL037C",459).
component("YDR242W",356).
component("YLR308W",732).
component("YLR307W",731).
component("YBR208C",249).
component("YMR281W",790).
component("U53_",152).
component("YIR032C",587).
component("YPR062W",954).
component("YMR120C",775).
component("YLR028C",698).
component("YHR144C",546).
component("YGR267C",513).
component("YCL030C",269).
component("YBL033C",206).
component("YBR153W",243).
component("YNL141W",805).
component("YLR245C",722).
component("YML035C",751).
component("YGR204W",503).
component("YBR084W",230).
component("YJL126W",603).
component("U44_",144).
component("YDL100C",301).
component("U87_",183).
component("U40_",142).
component("U39_",140).
...
component("YBR252W",257).
component("YPR080W",959).
component("YOR187W",879).
component("YOR133W",872).
component("YLR069C",704).
component("YKR084C",686).
component("YKL173W",664).
component("YJL102W",601).
component("YDR385W",370).
component("YBR118W",237).
component("YER005W",401).
component("YLL001W",689).
component("YIL048W",563).
component("YER166W",429).
component("YDR093W",339).
component("YAL026C",196).
component("YBL099W",212).
component("U60_",157).
component("YLR231C",719).
component("U88_",184).
component("YDR538W",388).
component("YLR134W",708).
component("YLR044C",700).
component("YGR087C",488).
component("YDR380W",369).
component("YDL080C",296).
component("U98_",192).
component("YMR250W",787).
...
component("YKR097W",688).
component("YOL052C",844).
component("YNL169C",808).
component("YGR170W",495).
component("YKL060C",653).
component("YNL256W",816).
component("YDR294C",360).
component("YEL046C",394).
component("YNR033W",831).
component("YPR006C",947).
component("YER065C",415).
component("YKL211C",675) :- not remove_orf("YKL211C",675).
component("YER090W",675) :- not remove_orf("YER090W",675).
component("YER090W",425) :- not remove_orf("YER090W",425).
component("YDR127W",346).
component("YPL281C",945).
component("YOR393W",907).
component("YMR323W",793).
component("YHR174W",548).
component("YGR254W",509).
component("YOR202W",882).
component("YPL262W",939).
component("YGL026C",457) :- not remove_orf("YGL026C",457).
component("YGR155W",493).
component("YLR304C",730).
component("YJL200C",614).
component("YGL009C",452).
component("YNL316C",823).
component("YKL182W",667).
component("YPL212C",929).
component("YNL292W",821).
component("YGL063W",462).
component("YFL001W",433).
component("YPR002W",946).
component("YJR016C",622).
component("YCR053W",283).
component("YDR127W",347).
component("YGL148W",467).
component("YIL168W",583).
component("YIL167W",582).
component("YCL064C",273).
component("YER086W",422).
component("YLR359W",738).
component("YAL012W",195).
component("YML004C",746).
component("YFR055W",448).
component("YJL005W",590).
component("YJL121C",602).
component("YBR019C",220).
component("YBR019C",221).
component("YDR050C",335).
component("YIL020C",559).
component("YDR007W",326) :- not remove_orf("YDR007W",326).
component("YOR095C",868).
component("YER003C",400).
component("YBR196C",248).
component("YGL001C",450).
component("YPL117C",918).
component("U14_",60).
component("YOL056W",847).
component("YKL152C",662).
component("YDL021W",286).
component("YMR105C",771).
component("YKL127W",657).
component("YEL058W",397).
component("YPR060C",953).
component("YHR072W",536).
component("YPL097W",916).
component("YGR185C",498).
component("YGR264C",512).
component("YGR171C",496).
component("YHR011W",524).
component("YDR023W",329).
component("YPL104W",917).
component("YLL018C",690).
component("YPR081C",960).
component("YBR121C",238).
component("YHR020W",526).
component("YER087W",423).
component("YNL247W",812).
component("YOR168W",876).
component("YOL097C",855).
component("YDR268W",359).
component("YPR047W",952).
component("YLR060W",703).
component("YFL022C",436).
component("YPR033C",950).
component("YCR024C",277).
component("YHR019C",525).
component("YKL194C",672).
component("YIL078W",567).
component("YPL160W",921).
component("YLR382C",740).
component("YNL073W",801).
component("YDR037W",331).
component("YOR335C",895).
component("YGR094W",490).
component("YLR153C",712).
component("YAL054C",198).
component("YOR317W",892).
component("YMR246W",786).
component("YIL009W",558).
component("YER015W",403).
component("YOR142W",873).
component("YGR244C",507).
component("YPR035W",951).
component("YIL145C",577).
component("U89_",185).
component("YJL101C",600).
component("YOL049W",843).
component("YAR015W",200).
component("YGL234W",474).
component("YER183C",432).
component("U91_",188).
component("U90_",187).
component("YNR057C",836).
component("YDL141W",307).
component("YDL141W",308).
component("YGL234W",475).
component("YDL141W",309).
component("YJR103W",635).
component("YBL039C",208).
component("YGR204W",504).
component("YBR084W",231).
component("YNL220W",810).
component("YOL058W",848).
component("YBR208C",250).
component("YDL141W",310).
component("YHR074W",537).
component("YMR217W",785).
component("YGR061C",486).
component("YJR109C",637).
component("YJL130C",606).
component("YGL062W",461).
component("YBR218C",251).
component("YPL231W",937).
component("YNR016C",828).
component("YKL182W",668).
component("YGR037C",483).
component("YJL087C",597).
component("YPR138C",964).
component("YPL265W",940).
component("YPL134C",919).
component("YPL057C",913).
component("YPL036W",912).
component("YOR348C",899).
component("YOR222W",888).
component("YOR192C",881).
component("YOR171C",877).
component("YOR130C",871).
component("YOR071C",866).
component("YOR011W",863).
component("YOL156W",862).
component("YOL103W",856).
component("YOL020W",842) :- not remove_orf("YOL020W",842).
component("YNR072W",838).
component("YNR056C",835).
component("YNL318C",824).
component("YNL270C",818).
component("YNL142W",806).
component("YMR272C",789).
component("YMR202W",782).
component("YMR011W",764).
component("YLR348C",736).
component("YLR260W",724).
component("YLR237W",720).
component("YLR138W",709).
component("YLR100C",707).
component("YLR081W",705).
component("YLL061W",694).
component("YLL043W",692).
component("YKR093W",687).
component("YKR053C",682).
component("YKR039W",681) :- not remove_orf("YKR039W",681).
component("YKL217W",677).
component("YKL004W",646).
component("YJR158W",644).
component("YJR095W",634).
component("YJR077C",632).
component("YJL219W",617).
component("YJL214W",615).
component("YJL134W",607).
component("YJL129C",604).
component("YIL134W",575).
component("YHR096C",540).
component("YHR094C",539).
component("YHR092C",538).
component("YHL036W",521).
component("YGR121C",491).
component("YGR065C",487).
component("YGR055W",484).
component("YGL186C",469).
component("YGL077C",464).
component("YGL008C",451).
component("YFL055W",440).
component("YFL011W",434).
component("YER060W-A",411).
component("YER060W",410).
component("YER056C",409).
component("YER053C",408).
component("YEL069C",399).
component("YEL063C",398).
component("YEL017C-A",390).
component("YDR536W",387).
component("YDR508C",384).
component("YDR503C",383).
component("YDR497C",381).
component("YDR345C",366).
component("YDR343C",365).
component("YDR342C",364).
component("YDR297W",361).
component("YDR046C",334) :- not remove_orf("YDR046C",334).
component("YDL245C",324).
component("YDL210W",320).
component("YCR032W",280).
component("YCR028C",279).
component("YCR024C-A",278).
component("YCL025C",268).
component("YBR298C",264).
component("YBR291C",263).
...
catalyst(2300,189).
catalyst(3460,153).
catalyst(3600,674) :- not remove_reaction(3600,674).
catalyst(8000,688).
catalyst(3941,844).
catalyst(3942,844).
catalyst(6890,808).
...
catalyst(8020,947).
catalyst(8020,415).
catalyst(1890,675) :- not remove_reaction(1890,675).
catalyst(3630,675) :- not remove_reaction(3630,675).
catalyst(1890,425) :- not remove_reaction(1890,425).
catalyst(3630,425) :- not remove_reaction(3630,425).
catalyst(3740,346).
catalyst(8231,945).
catalyst(8232,945).
catalyst(8231,907).
...
catalyst(8061,939).
catalyst(8062,939).
catalyst(3590,457) :- not remove_reaction(3590,457).
catalyst(10910,457) :- not remove_reaction(10910,457).
catalyst(4570,493).
catalyst(8181,730).
catalyst(8182,730).
catalyst(8181,614).
...
catalyst(8282,335).
catalyst(3840,559).
catalyst(3610,326) :- not remove_reaction(3610,326).
catalyst(7921,868).
catalyst(7922,868).
catalyst(7841,400).
catalyst(7842,400).
...
catalyst(650,687).
catalyst(6560,682).
catalyst(681,681) :- not remove_reaction(681,681).
catalyst(682,681) :- not remove_reaction(682,681).
...
catalyst(851,681) :- not remove_reaction(851,681).
catalyst(852,681) :- not remove_reaction(852,681).
...
catalyst(931,681) :- not remove_reaction(931,681).
catalyst(932,681) :- not remove_reaction(932,681).
...
catalyst(1210,364).
catalyst(6650,361).
catalyst(791,334) :- not remove_reaction(791,334).
catalyst(792,334) :- not remove_reaction(792,334).
catalyst(801,334) :- not remove_reaction(801,334).
catalyst(802,334) :- not remove_reaction(802,334).
catalyst(811,334) :- not remove_reaction(811,334).
catalyst(812,334) :- not remove_reaction(812,334).
catalyst(831,334) :- not remove_reaction(831,334).
catalyst(832,334) :- not remove_reaction(832,334).
catalyst(841,334) :- not remove_reaction(841,334).
catalyst(842,334) :- not remove_reaction(842,334).
catalyst(851,334) :- not remove_reaction(851,334).
catalyst(852,334) :- not remove_reaction(852,334).
catalyst(901,334) :- not remove_reaction(901,334).
catalyst(902,334) :- not remove_reaction(902,334).
catalyst(1180,324).
catalyst(1210,324).
catalyst(690,320).
catalyst(730,320).
