...
component("YLR056W",591).
component("YGR060W",407).
component("YGL012W",379).
component("YKR009C",572).
component("YOL086C",715).
component("YMR303C",663).
component("YMR083W",650).
component("YGL256W",401).
component("YDL168W",256).
component("YBR145W",193).
component("YPL231W",779).
component("YBR265W",209).
component("U46_",114).
component("YBR149W",194).
component("YBR149W",195).
component("YGL001C",376).
component("YIL094C",478).
component("U45_",113).
component("YML056C",637).
component("YLR432W",627).
component("YHR216W",470).
component("YAR075W",165).
component("YAR073W",164).
component("YDR127W",281).
component("YJR139C",543).
component("YML075C",639).
component("YLR450W",630).
component("YOL126C",721).
component("YKL085W",553).
component("YDL078C",241).
component("YNL037C",668).
component("YNL009W",666).
component("YLR174W",604).
component("YHR183W",463).
component("YGR256W",428).
component("YNL241C",682).
component("YOL059W",712).
component("YDL022W",234).
component("YCL018W",217).
component("YLR355C",622).
component("YIL074C",475).
component("YER081W",351).
component("YDL174C",260).
component("YML086C",641).
component("YIL155C",487).
component("YEL024W",327).
component("YKR066C",577).
component("YGR088W",411).
component("YDR256C",295).
component("YKL026C",549).
component("YIR037W",497).
component("YBR244W",204).
component("YJR078W",536).
component("U58_",123).
component("YJR025C",528).
component("U107_",24).
component("YHR007C",439).
component("YDR402C",309).
component("YGL055W",386).
component("YJR104C",538).
component("YHR008C",440).
component("YOR384W",758).
component("YOR381W",757).
component("YOL152W",723).
component("YLL051C",584).
component("YJL026W",499).
component("YIL066C",474).
component("YGR180C",418).
component("YER070W",348).
component("U37_",107).
component("U36_",106).
component("U35_",105).
component("YDL168W",257).
component("YDR158W",289).
component("YJR009C",525).
component("YJL052W",501).
component("YGR192C",420).
component("YBR006W",175).
component("YPL276W",787).
component("YPL275W",786).
component("YOR388C",759).
component("YPL061W",764).
component("YOR374W",755).
component("YER073W",349).
component("YGL154C",393).
component("YBR115C",189).
component("U55_",122).
component("YER069W",346).
component("YOR323C",747).
component("YER178W",360).
component("YBR221C",202).
component("YIL125W",483).
component("U52_",119).
component("YBR166C",197).
component("YGL012W",380).
component("YKL182W",562).
component("YKL216W",571).
component("YDR044W",272).
component("YKR009C",573).
component("YIL160C",488).
component("YGL205W",398).
component("YMR118C",652).
component("YLR164W",602).
component("YLL041C",583).
component("YKL148C",557).
component("YKL141W",555).
component("YJL045W",500).
component("YDR178W",290).
component("YEL047C",330).
component("YDL171C",258).
component("YDL171C",259).
component("YOR375C",756).
component("YDL215C",264).
component("YAL062W",161).
component("U99_",156).
component("U100_",20).
component("YBR035C",181).
component("YKR080W",579).
component("YER023W",337).
component("YOR236W",745).
component("YGR204W",422).
component("YIR034C",496).
component("YLR142W",599).
component("U65_",129).
component("U63_",127).
component("U62_",126).
component("YHR068W",449).
component("YKL150W",558).
component("YIL043C",473).
component("YHR042W",444).
component("YOR221C",742).
component("YMR145C",655).
component("YKL192C",565).
component("YKL055C",551).
component("YER061C",344).
component("YDL085W",243).
component("YPL171C",772).
component("YHR179W",462).
component("YMR145C",656).
component("YML120C",642).
component("YKL192C",566).
component("YDL085W",244).
component("YGR234W",424).
component("YFR030W",372).
component("YPL017C",761).
component("YFL018C",364).
component("YDR353W",305).
component("YPR167C",802).
component("YJR137C",542).
component("YNL052W",670).
component("YMR256C",662).
component("YLR395C",626).
component("YLR038C",589).
component("YIL111W",480).
component("YHR051W",448).
component("YGL191W",396).
component("YGL187C",395).
component("YDL067C",240).
component("Q0275",19).
component("Q0250",18).
component("YDR072C",277).
component("YPL266W",785).
component("YKR069W",578).
component("YOL096C",716).
component("U47_",115).
component("YER091C",356).
component("YJR073C",534).
component("YGR157W",416).
component("YDR120C",279).
component("YML008C",632).
component("YOR074C",728).
component("YDL033C",236).
component("YOL096C",717).
component("YLR172C",603).
component("YLR058C",592).
component("YDR019C",270).
component("YBR176W",198).
component("YDR408C",311).
component("YMR120C",653).
component("YLR028C",587).
component("YBL013W",166).
component("YJL130C",510).
component("YJL088W",504).
component("YKL024C",548).
component("YPR074C",797).
component("YBR117C",190).
component("YMR108W",651).
component("YCL009C",216).
component("YNL071W",672).
component("YNR008W",694).
component("YIL160C",489).
component("YNR019W",697).
component("YCR048W",230).
component("U48_",116).
component("YMR062C",649).
component("YDR232W",292).
component("YPL231W",780).
component("YER061C",345).
component("YDL052C",239).
component("U8_",150).
component("YDR148C",287).
component("YPL231W",781).
component("YPL028W",762).
component("YLR299W",614).
component("YGL017W",381).
component("YCR005C",222).
component("YML126C",643).
component("YNL104C",675).
component("YDL182W",261).
component("YDL131W",248).
component("YDR307W",301).
component("YLR258W",611).
component("YFR015C",370).
component("YNL029C",667).
component("YIL085C",477).
component("YMR306W",664).
component("YLR342W",620).
component("YGR032W",404).
component("YBR248C",205).
component("YLR209C",606).
component("U104_",21).
component("YDR354W",306) :- not remove_orf("YDR354W",306).
component("YFR047C",373).
component("YJR133W",541).
component("YLR209C",607).
component("YML022W",634).
component("YDR441C",314).
component("YHR128W",457).
component("YJL167W",517).
component("YJL167W",518).
component("YPR069C",794).
component("YDR127W",282).
component("YHR190W",465).
component("YLR146C",600).
component("YHR068W",450).
component("YLR303W",616).
component("YGR012W",402).
component("YML082W",640).
component("YJR130C",540).
component("YDR035W",271).
component("YBR249C",206).
component("YLR180W",605).
component("YDR502C",318).
component("YOR274W",746).
component("YBR256C",208).
component("YHR137W",458).
component("YGL202W",397).
component("YLR027C",586).
component("YKL106W",554).
component("YOL140W",722).
component("YLR438W",629).
component("YGR019W",403).
component("YLR089C",595).
component("U64_",128).
component("U61_",125).
component("U51_",118).
component("YJR148W",544).
component("YHR208W",468).
component("YFL030W",366).
component("YOR184W",737).
component("YNR058W",702).
component("YIL116W",482).
component("YGL253W",400).
component("YFR053C",374).
component("YMR013C",647).
component("YMR205C",658).
component("YGR240C",425).
component("YOL016C",706).
component("YFR014C",369).
component("YLR240W",609).
component("YKL203C",568).
component("YJR066W",533).
component("YCR036W",229).
component("YCL040W",219).
component("U15_",54).
component("YPL188W",774).
component("YJR049C",530).
component("YEL041W",328).
component("U96_",154).
component("YKL001C",547).
component("YDR236C",293).
component("YHL032C",437).
component("YDR531W",322).
component("U83_",145).
component("U82_",144).
component("U81_",143).
component("YMR208W",659).
component("YPL203W",775).
component("YOR061W",727).
component("YKL166C",560).
component("YJL164C",516).
component("YIL035C",472).
component("YHR205W",467).
component("YHR102W",456).
component("YGL019W",382).
component("YHR025W",443).
component("YOR347C",752).
component("YAL038W",159).
component("YNR012W",695).
component("YDR009W",269).
component("YDR127W",283).
component("YDR147W",286).
component("YDR300C",300).
component("YCR012W",223).
component("YER069W",347).
component("U19_",82).
component("U18_",74).
component("U17_",66).
component("U76_",138).
...
component("YKL067W",552).
component("YOL055C",709).
component("YDR454C",315).
component("YJR057W",531).
component("YOL061W",713).
component("YKL181W",561).
component("YHL011C",435).
component("YER099C",357).
component("YBL068W",173).
component("YOR143C",733).
component("YNL256W",685).
component("YLR328W",618).
component("YBR018C",177).
component("YGR202C",421).
...
component("YPR190C",805).
component("YPR187W",804).
component("YPR110C",799).
component("YPR010C",790).
component("YOR341W",751).
component("YOR340C",750).
component("YOR224C",744).
component("YOR210W",741).
component("YOR207C",739).
component("YOR151C",734).
component("YOR116C",730).
component("YOL005C",704).
component("YNR003C",693).
component("YNL248C",684).
component("YNL151C",679).
component("YNL113W",676).
component("YKL144C",556).
component("YJR063W",532).
component("YJL148W",514).
component("YJL140W",513).
component("YIL021W",471).
component("YHR143W-A",459).
component("YGL070C",389).
component("YFL036W",367).
...
component("YPR175W",803).
component("YPL167C",771).
component("YOR330C",748).
component("YOL115W",720).
component("YNL299W",691).
component("YNL262W",687).
component("YNL102W",674).
component("YJR043C",529).
component("YJR006W",524).
component("YJL090C",505).
component("YIL139C",485).
component("YEL055C",331).
...
component("YKL035W",550).
component("YHL012W",436).
component("YPR113W",800).
component("YBR243C",203).
component("YPL148C",769).
component("YER026C",338).
component("YGR286C",432).
component("YHR189W",464).
component("YDR058C",276).
component("YDL086W",245).
component("YOL011W",705).
component("YMR008C",645).
component("YMR006C",644).
component("U105_",22).
component("YBL015W",167).
component("YJL068C",502).
component("YOR040W",726).
component("U77_",139).
component("YDR481C",316).
component("YLR377C",624).
component("YPL179W",773).
component("YNR032W",698).
component("YML057W",638).
component("YML016C",633).
component("YLR433C",628).
component("YGR123C",414).
component("YER133W",358).
component("YER089C",354).
...
component("YPR073C",795).
component("YHR215W",469).
component("YDL024C",235).
component("YBR093C",187).
component("YBR092C",186).
component("YAR071W",163).
component("YHR046C",447).
component("U9_",157).
component("YPL228W",778).
component("YMR180C",657).
component("YDL236W",266).
component("YJL155C",515).
component("YPR073C",796).
component("YOR208W",740).
component("YNL053W",671).
component("YMR036C",648).
component("YIR026C",495).
component("YIL113W",481).
component("YFR028C",371).
component("YER075C",350).
...
component("U25_",96).
component("U24_",95).
component("YHR044C",446).
component("YHR043C",445).
component("YOL064C",714).
component("YOR360C",754).
component("YKR031C",574).
component("YPL206C",776).
component("YGL027C",384).
component("YLR286C",613).
component("YJR153W",545).
component("YJL221C",523).
component("YJL216C",521).
component("YIL172C",493).
component("YGR292W",434).
component("YGR287C",433).
component("YBR299W",215).
component("YBR184W",199).
component("YIL162W",490).
component("YIR019C",494).
component("YIL099W",479).
component("YDL037C",237).
component("YOR190W",738).
component("YLR300W",615).
component("YGR282C",431).
component("YDR261C",296).
component("YDR400W",308).
component("YML035C",635).
component("YJL070C",503).
component("YBR284W",212).
component("U106_",23).
component("YER043C",339).
component("YNL045W",669).
component("YGL037C",385).
component("YDR242W",294).
component("U53_",120).
component("YPR062W",793).
component("YMR120C",654).
component("YLR028C",588).
component("YHR144C",460).
component("YGR267C",430).
component("YBL033C",168).
component("YNL141W",677).
component("YLR245C",610).
...
component("YHR201C",466).
component("YBR111C",188).
component("YBR252W",207).
component("YER005W",336).
component("YBL099W",174).
component("YLR231C",608).
component("U88_",148).
component("YDR538W",324).
component("YLR134W",597).
component("YLR044C",590).
component("YGR087C",410).
component("YDR380W",307).
component("YDL080C",242).
component("U98_",155).
component("YMR250W",661).
component("YOR128C",731).
component("YEL021W",326).
component("YNR043W",700).
component("U93_",152).
component("U54_",121).
component("YKL211C",569) :- not remove_orf("YKL211C",569).
component("YKR097W",581).
component("YNL169C",680).
component("YNL256W",686).
component("YDR294C",298).
component("YEL046C",329).
component("YNR033W",699).
component("YKL211C",570) :- not remove_orf("YKL211C",570).
component("YER090W",570) :- not remove_orf("YER090W",570).
component("YER090W",355) :- not remove_orf("YER090W",355).
component("YDR127W",284).
component("YPL281C",788).
component("YOR393W",760).
component("YMR323W",665).
component("YHR174W",461).
component("YGR254W",427).
component("YPL262W",783).
component("YGL026C",383) :- not remove_orf("YGL026C",383).
component("YGR155W",415).
component("YLR304C",617).
component("YJL200C",519).
component("YNL316C",692).
component("YKL182W",563).
component("YPL212C",777).
component("YNL292W",690).
component("YGL063W",388).
component("YFL001W",362).
component("YPR002W",789).
component("YJR016C",527).
component("YCR053W",231).
component("YDR127W",285).
component("YGL148W",392).
component("YIL168W",492).
component("YIL167W",491).
component("YCL064C",221).
component("YER086W",352).
component("YLR359W",623).
component("YAL012W",158).
component("YML004C",631).
component("YFR055W",375).
component("YJL005W",498).
...
component("YPL117C",767).
component("U14_",46).
component("YOL056W",710).
component("YKL152C",559).
component("YDL021W",233).
component("YEL058W",332).
component("YPR060C",792).
component("YHR072W",451).
component("YPL097W",765).
component("YGR185C",419).
component("YGR264C",429).
component("YGR171C",417).
component("YPL104W",766).
component("YLL018C",582).
component("YPR081C",798).
component("YBR121C",191).
component("YHR020W",442).
component("YER087W",353).
component("YNL247W",683).
component("YOR168W",735).
component("YOL097C",718).
component("YDR268W",297).
component("YPR047W",791).
component("YLR060W",593).
component("YFL022C",365).
component("YCR024C",225).
component("YHR019C",441).
component("YKL194C",567).
component("YIL078W",476).
component("YPL160W",770).
component("YLR382C",625).
component("YNL073W",673).
component("YOR335C",749).
component("YGR094W",412).
component("YLR153C",601).
component("YAL054C",160).
component("YGR244C",426).
component("YIL145C",486).
component("U89_",149).
component("YJL101C",506).
component("YOL049W",708).
component("YAR015W",162).
component("YER183C",361).
component("U90_",151).
component("YNR057C",701).
component("YDL141W",251).
component("YDL141W",252).
component("YGL234W",399).
component("YDL141W",253).
component("YJR103W",537).
component("YBL039C",170).
component("YGR204W",423).
component("YBR084W",185).
component("YNL220W",681).
component("YOL058W",711).
component("YDL141W",254).
component("YHR074W",452).
component("YMR217W",660).
component("YGR061C",408).
component("YJR109C",539).
component("YJL130C",511).
component("YGL062W",387).
component("YBR218C",201).
component("YPL231W",782).
component("YNR016C",696).
component("YKL182W",564).
component("YGR037C",405).
component("YPR138C",801).
component("YPL265W",784).
component("YPL134C",768).
component("YPL036W",763).
component("YOR348C",753).
component("YOR222W",743).
component("YOR171C",736).
component("YOR130C",732).
component("YOR011W",725).
component("YOL156W",724).
component("YOL103W",719).
component("YOL020W",707) :- not remove_orf("YOL020W",707).
component("YNR072W",703).
component("YNL270C",688).
component("YNL142W",678).
component("YMR011W",646).
component("YLR348C",621).
component("YLR260W",612).
component("YLR138W",598).
component("YLR100C",596).
component("YLR081W",594).
component("YLL061W",585).
component("YKR093W",580).
component("YKR053C",576).
component("YKR039W",575) :- not remove_orf("YKR039W",575).
component("YJR158W",546).
component("YJR077C",535).
component("YJL219W",522).
component("YJL214W",520).
component("YJL134W",512).
component("YJL129C",509).
component("YIL134W",484).
component("YHR096C",455).
component("YHR094C",454).
component("YHR092C",453).
component("YHL036W",438).
component("YGR121C",413).
component("YGR065C",409).
component("YGR055W",406).
component("YGL186C",394).
component("YGL077C",390).
component("YGL008C",378).
component("YFL055W",368).
component("YFL011W",363).
component("YER060W-A",343).
component("YER060W",342).
component("YER056C",341).
component("YER053C",340).
component("YEL069C",334).
component("YEL063C",333).
...
catalyst(2300,152).
catalyst(3460,121).
catalyst(3600,569) :- not remove_reaction(3600,569).
catalyst(8000,581).
catalyst(6890,680).
catalyst(2570,686).
catalyst(8781,298).
...
catalyst(4560,329).
catalyst(2550,699).
catalyst(1890,570) :- not remove_reaction(1890,570).
catalyst(3630,570) :- not remove_reaction(3630,570).
catalyst(1890,355) :- not remove_reaction(1890,355).
catalyst(3630,355) :- not remove_reaction(3630,355).
catalyst(3740,284).
catalyst(8231,788).
catalyst(8232,788).
catalyst(8231,760).
...
catalyst(1210,724).
catalyst(1160,719).
catalyst(801,707) :- not remove_reaction(801,707).
catalyst(802,707) :- not remove_reaction(802,707).
catalyst(811,707) :- not remove_reaction(811,707).
catalyst(812,707) :- not remove_reaction(812,707).
catalyst(831,707) :- not remove_reaction(831,707).
catalyst(832,707) :- not remove_reaction(832,707).
catalyst(901,707) :- not remove_reaction(901,707).
catalyst(902,707) :- not remove_reaction(902,707).
catalyst(1180,703).
catalyst(1210,703).
catalyst(931,688).
catalyst(932,688).
...
catalyst(640,580).
catalyst(6560,576).
catalyst(771,575) :- not remove_reaction(771,575).
catalyst(772,575) :- not remove_reaction(772,575).
catalyst(781,575) :- not remove_reaction(781,575).
catalyst(782,575) :- not remove_reaction(782,575).
catalyst(801,575) :- not remove_reaction(801,575).
catalyst(802,575) :- not remove_reaction(802,575).
catalyst(811,575) :- not remove_reaction(811,575).
catalyst(812,575) :- not remove_reaction(812,575).
catalyst(831,575) :- not remove_reaction(831,575).
catalyst(832,575) :- not remove_reaction(832,575).
catalyst(841,575) :- not remove_reaction(841,575).
catalyst(842,575) :- not remove_reaction(842,575).
catalyst(851,575) :- not remove_reaction(851,575).
catalyst(852,575) :- not remove_reaction(852,575).
catalyst(881,575) :- not remove_reaction(881,575).
catalyst(882,575) :- not remove_reaction(882,575).
catalyst(901,575) :- not remove_reaction(901,575).
catalyst(902,575) :- not remove_reaction(902,575).
catalyst(921,575) :- not remove_reaction(921,575).
catalyst(922,575) :- not remove_reaction(922,575).
catalyst(931,575) :- not remove_reaction(931,575).
catalyst(932,575) :- not remove_reaction(932,575).
catalyst(1191,575) :- not remove_reaction(1191,575).
catalyst(1192,575) :- not remove_reaction(1192,575).
catalyst(1180,546).
catalyst(1210,546).
catalyst(1581,535).
catalyst(1582,535).
