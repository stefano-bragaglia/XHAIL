...
component("YNL280C",631).
component("YLR056W",540).
component("YGR060W",375).
component("YGL012W",347).
component("YKR009C",522).
component("YOL086C",656).
component("YMR303C",605).
component("YGL256W",369).
component("YDL168W",231).
component("YBR145W",173).
component("YPL231W",716).
component("YBR265W",188).
component("U46_",101).
component("YBR149W",174).
component("YBR149W",175).
component("YGL001C",344).
component("YIL094C",441).
component("U45_",100).
component("YML056C",583).
component("YLR432W",573).
component("YHR216W",434).
component("YAR075W",147).
component("YAR073W",146).
component("YDR127W",255).
component("YJR139C",500).
component("YML075C",585).
component("YLR450W",576).
component("YOL126C",662).
component("YKL085W",508).
component("YDL078C",218).
component("YNL037C",610).
component("YNL009W",608).
component("YLR174W",552).
component("YHR183W",427).
component("YGR256W",393).
component("YNL241C",624).
component("YOL059W",654).
component("YDL022W",211).
component("YCL018W",196).
component("YLR355C",568).
component("YIL074C",439).
component("YER081W",320).
component("YDL174C",235).
component("YML086C",587).
component("YIL155C",450).
component("YGR088W",378).
component("YDR256C",267).
component("YKL026C",506).
component("YIR037W",459).
component("YBR244W",184).
component("YJR078W",494).
component("U58_",109).
component("YJR025C",487).
component("U107_",24).
component("YHR007C",403).
component("YDR402C",281).
component("YGL055W",354).
component("YJR104C",496).
component("YHR008C",404).
component("YOR384W",697).
component("YOR381W",696).
component("YOL152W",664).
component("YLL051C",533).
component("YJL026W",461).
component("YIL066C",438).
component("YGR180C",384).
component("YER070W",317).
component("U37_",94).
component("U36_",93).
component("YDL168W",232).
component("YJR009C",484).
component("YJL052W",463).
component("YGR192C",386).
component("YBR006W",157).
component("YPL276W",724).
component("YPL275W",723).
component("YOR388C",698).
component("YOR374W",694).
component("YER073W",318).
component("YGL154C",361).
component("U55_",108).
component("YER069W",315).
component("YOR323C",687).
component("YER178W",329).
component("YBR221C",182).
component("YIL125W",446).
component("U52_",106).
component("YBR166C",177).
component("YGL012W",348).
component("YKL216W",521).
component("YDR044W",246).
component("YKR009C",523).
component("YIL160C",451).
component("YGL205W",366).
component("YMR118C",596).
component("YLR164W",550).
component("YLL041C",532).
component("YKL148C",512).
component("YKL141W",510).
component("YJL045W",462).
component("YDR178W",262).
component("YEL047C",300).
component("YDL171C",233).
component("YDL171C",234).
component("YOR375C",695).
component("YDL215C",238).
component("YAL062W",144).
component("U99_",139).
component("U100_",20).
component("YBR035C",163).
component("YKR080W",528).
component("YER023W",307).
component("YOR236W",685).
component("YGR204W",387).
component("YIR034C",458).
component("YLR142W",547).
component("U65_",115).
component("U63_",113).
component("U62_",112).
component("YHR068W",413).
component("YKL150W",513).
component("YIL043C",437).
component("YHR042W",408).
component("YPL171C",710).
component("YHR179W",426).
component("YMR145C",599).
component("YML120C",588).
component("YKL192C",518).
component("YDL085W",220).
component("YGR234W",389).
component("YFR030W",340).
component("YPL017C",700).
component("YFL018C",333).
component("YDR353W",277).
component("YPR167C",736).
component("YJR137C",499).
component("YNL052W",612).
component("YMR256C",604).
component("YLR395C",572).
component("YLR038C",538).
component("YIL111W",443).
component("YHR051W",412).
component("YGL191W",364).
component("YGL187C",363).
component("YDL067C",217).
component("Q0275",19).
component("Q0250",18).
component("YDR072C",251).
component("YPL266W",722).
component("YKR069W",527).
component("YOL096C",657).
component("U47_",102).
component("YER091C",325).
component("YJR073C",492).
component("YGR157W",382).
component("YDR120C",253).
component("YML008C",578).
component("YOR074C",669).
component("YDL033C",213).
component("YOL096C",658).
component("YLR172C",551).
component("YLR058C",541).
component("YDR019C",244).
component("YBR176W",178).
component("YDR408C",283).
component("YMR120C",597).
component("YLR028C",536).
component("YBL013W",148).
component("YJL130C",471).
component("YKL024C",505).
component("YPR074C",732).
component("YBR117C",171).
component("YMR108W",595).
component("YCL009C",195).
component("YNL071W",614).
component("YNR008W",636).
component("YIL160C",452).
component("YNR019W",639).
component("YCR048W",207).
component("U48_",103).
component("YDR232W",264).
component("YPL231W",717).
component("YER061C",314).
component("YDL052C",216).
component("U8_",133).
component("YPL231W",718).
component("YPL028W",701).
component("YLR299W",561).
component("YGL017W",349).
component("YML126C",589).
component("YNL104C",617).
component("YDL182W",236).
component("YDL131W",224).
component("YDR307W",273).
component("YLR258W",558).
component("YFR015C",338).
component("YNL029C",609).
component("YIL085C",440).
component("YMR306W",606).
component("YLR342W",567).
component("YGR032W",372).
component("YLR209C",554).
component("U104_",21).
component("YDR354W",278) :- not remove_orf("YDR354W",278).
component("YFR047C",341).
component("YJR133W",498).
component("YLR209C",555).
component("YML022W",580).
component("YDR441C",286).
component("YHR128W",421).
component("YJL167W",476).
component("YJL167W",477).
component("YDR127W",256).
component("YHR190W",429).
component("YLR146C",548).
component("YHR068W",414).
component("YLR303W",563).
component("YGR012W",370).
component("YML082W",586).
component("YJR130C",497).
component("YDR035W",245).
component("YBR249C",185).
component("YLR180W",553).
component("YDR502C",289).
component("YOR274W",686).
component("YBR256C",187).
component("YHR137W",422).
component("YGL202W",365).
component("YLR027C",535).
component("YKL106W",509).
component("YOL140W",663).
component("YLR438W",575).
component("YGR019W",371).
component("YLR089C",543).
component("U64_",114).
component("U61_",111).
component("U51_",105).
component("YJR148W",501).
component("YHR208W",432).
component("YFL030W",334).
component("YOR184W",678).
component("YNR058W",644).
component("YIL116W",445).
component("YGL253W",368).
component("YFR053C",342).
component("YMR013C",593).
component("YMR205C",600).
component("YGR240C",390).
component("YOL016C",648).
component("YFR014C",337).
component("YCR036W",206).
component("YCL040W",198).
component("U15_",48).
component("YPL188W",712).
component("YJR049C",489).
component("YEL041W",298).
component("U96_",137).
component("YKL001C",504).
component("YDR236C",265).
component("YHL032C",401).
component("YDR531W",293).
component("U83_",131).
component("U82_",130).
component("U81_",129).
component("YMR208W",601).
component("YPL203W",713).
component("YOR061W",668).
component("YKL166C",515).
component("YJL164C",475).
component("YIL035C",436).
component("YHR205W",431).
component("YHR102W",420).
component("YGL019W",350).
component("YHR025W",407).
component("YOR347C",692).
component("YAL038W",142).
component("YNR012W",637).
component("YDR009W",243).
component("YDR127W",257).
component("YDR147W",260).
component("YDR300C",272).
...
component("U17_",58).
component("U76_",124).
component("YER170W",328).
component("YDR226W",263).
component("YKL067W",507).
component("YOL055C",651).
component("YDR454C",287).
component("YJR057W",490).
component("YOL061W",655).
component("YKL181W",516).
component("YHL011C",400).
component("YER099C",326).
component("YBL068W",155).
component("YOR143C",674).
component("YNL256W",627).
component("YLR328W",565).
component("YBR018C",159).
component("YLR328W",566).
component("U80_",128).
component("U94_",136).
component("YJR010W",485).
component("YBR029C",162).
component("YCL050C",199).
component("YGL130W",359).
component("YDR530C",292).
component("YPR190C",739).
component("YPR187W",738).
component("YPR110C",733).
component("YPR010C",727).
component("YOR341W",691).
component("YOR340C",690).
component("YOR224C",684).
component("YOR210W",682).
component("YOR207C",680).
component("YOR151C",675).
component("YOR116C",671).
component("YOL005C",646).
component("YNR003C",635).
component("YNL248C",626).
component("YNL151C",621).
component("YNL113W",618).
component("YKL144C",511).
component("YJR063W",491).
component("YJL148W",474).
component("YJL140W",473).
component("YIL021W",435).
component("YHR143W-A",423).
component("YGL070C",357).
component("YFL036W",335).
component("YDR404C",282).
...
component("YPL167C",709).
component("YOR330C",688).
component("YOL115W",661).
component("YNL299W",633).
component("YNL262W",629).
component("YNL102W",616).
component("YJR043C",488).
component("YJR006W",483).
component("YJL090C",466).
component("YIL139C",448).
component("YEL055C",301).
component("YDR419W",284).
component("YDR121W",254).
component("YDL102W",223).
component("YCR014C",202).
component("YBR278W",190).
component("YBL035C",151).
component("YPR113W",734).
component("YBR243C",183).
component("YPL148C",707).
component("YER026C",308).
component("YGR286C",397).
component("YHR189W",428).
component("YDR058C",250).
component("YDL086W",221).
component("YOL011W",647).
component("YMR008C",591).
component("YMR006C",590).
component("U105_",22).
component("YBL015W",149).
component("YJL068C",464).
component("YOR040W",667).
component("U77_",125).
component("YLR377C",570).
component("YPL179W",711).
component("YNR032W",640).
component("YML057W",584).
component("YML016C",579).
component("YLR433C",574).
component("YGR123C",380).
component("YER133W",327).
component("YER089C",323).
component("YDR436W",285).
component("YDR075W",252).
...
component("YHR215W",433).
component("YDL024C",212).
component("YBR093C",169).
component("YBR092C",168).
component("YHR046C",411).
component("U9_",140).
component("YDL236W",240).
component("YPR073C",731).
component("YOR208W",681).
component("YNL053W",613).
component("YMR036C",594).
component("YIR026C",457).
component("YIL113W",444).
component("YFR028C",339).
component("YER075C",319).
component("YDL230W",239).
...
component("U25_",85).
component("U24_",84).
component("YHR044C",410).
component("YHR043C",409).
component("YOR360C",693).
component("YKR031C",524).
component("YPL206C",714).
component("YGL027C",352).
component("YLR286C",560).
component("YJR153W",502).
component("YJL221C",482).
component("YJL216C",480).
component("YIL172C",455).
component("YGR292W",399).
component("YGR287C",398).
component("YBR299W",194).
component("YBR184W",179).
component("YIR019C",456).
component("YIL099W",442).
component("YDL037C",214).
component("YOR190W",679).
component("YLR300W",562).
component("YGR282C",396).
component("YDR261C",268).
component("YDR400W",280).
component("YML035C",581).
component("YJL070C",465).
component("YBR284W",191).
component("U106_",23).
component("YER043C",309).
component("YNL045W",611).
component("YGL037C",353).
component("YDR242W",266).
component("U53_",107).
component("YPR062W",729).
component("YMR120C",598).
component("YLR028C",537).
component("YHR144C",424).
component("YGR267C",395).
component("YBL033C",150).
component("YNL141W",619).
component("YLR245C",557).
component("YML035C",582).
...
component("YHR201C",430).
component("YBR111C",170).
component("YBR252W",186).
component("YER005W",306).
component("YBL099W",156).
component("YLR231C",556).
component("YDR538W",295).
component("YLR134W",545).
component("YLR044C",539).
component("YGR087C",377).
component("YDR380W",279).
component("YDL080C",219).
component("U98_",138).
component("YMR250W",603).
component("YOR128C",672).
component("YEL021W",297).
component("YNR043W",642).
component("U93_",135).
component("YKL211C",519) :- not remove_orf("YKL211C",519).
component("YKR097W",530).
component("YNL169C",622).
component("YNL256W",628).
component("YDR294C",270).
component("YEL046C",299).
component("YNR033W",641).
component("YKL211C",520) :- not remove_orf("YKL211C",520).
component("YER090W",520) :- not remove_orf("YER090W",520).
component("YER090W",324) :- not remove_orf("YER090W",324).
component("YDR127W",258).
component("YPL281C",725).
component("YOR393W",699).
component("YMR323W",607).
component("YHR174W",425).
component("YGR254W",392).
component("YPL262W",720).
component("YGL026C",351) :- not remove_orf("YGL026C",351).
component("YGR155W",381).
component("YLR304C",564).
component("YJL200C",478).
component("YNL316C",634).
component("YPL212C",715).
component("YNL292W",632).
component("YGL063W",356).
component("YFL001W",331).
component("YPR002W",726).
component("YJR016C",486).
component("YCR053W",208).
component("YDR127W",259).
component("YGL148W",360).
component("YIL168W",454).
component("YIL167W",453).
component("YCL064C",200).
component("YER086W",321).
component("YLR359W",569).
component("YAL012W",141).
component("YML004C",577).
component("YFR055W",343).
component("YJL005W",460).
component("YJL121C",468).
component("YBR019C",160).
component("YDR050C",249).
component("YDR007W",242) :- not remove_orf("YDR007W",242).
component("YOR095C",670).
component("YER003C",305).
component("YBR196C",180).
component("YGL001C",345).
component("YPL117C",705).
component("U14_",40).
component("YOL056W",652).
component("YKL152C",514).
component("YDL021W",210).
component("YEL058W",302).
component("YPR060C",728).
component("YHR072W",415).
component("YPL097W",703).
component("YGR185C",385).
component("YGR264C",394).
component("YGR171C",383).
component("YPL104W",704).
component("YLL018C",531).
component("YHR020W",406).
component("YER087W",322).
component("YNL247W",625).
component("YOR168W",676).
component("YOL097C",659).
component("YDR268W",269).
component("YCR024C",203).
component("YHR019C",405).
component("YPL160W",708).
component("YLR382C",571).
component("YNL073W",615).
component("YOR335C",689).
component("YLR153C",549).
component("YAL054C",143).
component("YGR244C",391).
component("YIL145C",449).
component("YJL101C",467).
component("YOL049W",650).
component("YAR015W",145).
component("YER183C",330).
component("U90_",134).
component("YNR057C",643).
component("YDL141W",227).
component("YGL234W",367).
component("YDL141W",228).
component("YJR103W",495).
component("YBL039C",152).
component("YGR204W",388).
component("YBR084W",167).
component("YNL220W",623).
component("YOL058W",653).
component("YDL141W",229).
component("YHR074W",416).
component("YMR217W",602).
component("YGL062W",355).
component("YBR218C",181).
component("YPL231W",719).
component("YNR016C",638).
component("YKL182W",517).
component("YGR037C",373).
component("YPR138C",735).
component("YPL265W",721).
component("YPL134C",706).
component("YPL036W",702).
component("YOR222W",683).
component("YOR171C",677).
component("YOR130C",673).
component("YOR011W",666).
component("YOL156W",665).
component("YOL103W",660).
component("YOL020W",649) :- not remove_orf("YOL020W",649).
component("YNR072W",645).
component("YNL270C",630).
component("YNL142W",620).
component("YMR011W",592).
component("YLR260W",559).
component("YLR138W",546).
component("YLR100C",544).
component("YLR081W",542).
component("YLL061W",534).
component("YKR093W",529).
component("YKR053C",526).
component("YKR039W",525) :- not remove_orf("YKR039W",525).
component("YJR158W",503).
component("YJR077C",493).
component("YJL219W",481).
component("YJL214W",479).
component("YJL134W",472).
component("YJL129C",470).
component("YIL134W",447).
component("YHR096C",419).
component("YHR094C",418).
component("YHR092C",417).
component("YHL036W",402).
component("YGR121C",379).
component("YGR065C",376).
component("YGR055W",374).
component("YGL186C",362).
component("YGL077C",358).
component("YGL008C",346).
component("YFL055W",336).
component("YFL011W",332).
component("YER060W-A",313).
component("YER060W",312).
component("YER056C",311).
component("YER053C",310).
component("YEL069C",304).
component("YEL063C",303).
component("YEL017C-A",296).
component("YDR536W",294).
component("YDR508C",291).
component("YDR503C",290).
component("YDR497C",288).
component("YDR345C",276).
component("YDR343C",275).
component("YDR342C",274).
component("YDR297W",271).
component("YDR046C",248) :- not remove_orf("YDR046C",248).
component("YDL245C",241).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,278) :- not remove_reaction(3620,278).
catalyst(2110,341).
catalyst(2190,341).
catalyst(5550,498).
catalyst(5791,555).
...
catalyst(6470,642).
catalyst(2300,135).
catalyst(3600,519) :- not remove_reaction(3600,519).
catalyst(8000,530).
catalyst(6890,622).
catalyst(2570,628).
catalyst(8781,270).
...
catalyst(4560,299).
catalyst(2550,641).
catalyst(1890,520) :- not remove_reaction(1890,520).
catalyst(3630,520) :- not remove_reaction(3630,520).
...
catalyst(8051,720).
catalyst(8052,720).
catalyst(3590,351) :- not remove_reaction(3590,351).
catalyst(10910,351) :- not remove_reaction(10910,351).
catalyst(4570,381).
catalyst(8181,564).
catalyst(8182,564).
catalyst(8181,478).
...
catalyst(8281,249).
catalyst(8282,249).
catalyst(3610,242) :- not remove_reaction(3610,242).
catalyst(7921,670).
catalyst(7922,670).
catalyst(7841,305).
catalyst(7842,305).
...
catalyst(1210,665).
catalyst(1160,660).
catalyst(801,649) :- not remove_reaction(801,649).
catalyst(802,649) :- not remove_reaction(802,649).
catalyst(811,649) :- not remove_reaction(811,649).
catalyst(812,649) :- not remove_reaction(812,649).
catalyst(831,649) :- not remove_reaction(831,649).
catalyst(832,649) :- not remove_reaction(832,649).
catalyst(901,649) :- not remove_reaction(901,649).
catalyst(902,649) :- not remove_reaction(902,649).
catalyst(1180,645).
catalyst(1210,645).
catalyst(931,630).
catalyst(932,630).
...
catalyst(640,529).
catalyst(6560,526).
catalyst(771,525) :- not remove_reaction(771,525).
catalyst(772,525) :- not remove_reaction(772,525).
catalyst(781,525) :- not remove_reaction(781,525).
catalyst(782,525) :- not remove_reaction(782,525).
...
catalyst(841,525) :- not remove_reaction(841,525).
catalyst(842,525) :- not remove_reaction(842,525).
catalyst(851,525) :- not remove_reaction(851,525).
catalyst(852,525) :- not remove_reaction(852,525).
catalyst(881,525) :- not remove_reaction(881,525).
catalyst(882,525) :- not remove_reaction(882,525).
catalyst(901,525) :- not remove_reaction(901,525).
catalyst(902,525) :- not remove_reaction(902,525).
catalyst(921,525) :- not remove_reaction(921,525).
catalyst(922,525) :- not remove_reaction(922,525).
catalyst(931,525) :- not remove_reaction(931,525).
catalyst(932,525) :- not remove_reaction(932,525).
catalyst(1191,525) :- not remove_reaction(1191,525).
catalyst(1192,525) :- not remove_reaction(1192,525).
catalyst(1180,503).
catalyst(1210,503).
catalyst(1581,493).
catalyst(1582,493).
