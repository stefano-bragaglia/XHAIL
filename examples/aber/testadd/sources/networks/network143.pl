...
component("YLR056W",642).
component("YGR060W",446).
component("YGL012W",417).
component("YKR009C",622).
component("YOL086C",777).
component("YMR303C",720).
component("YMR083W",701).
component("YGL256W",439).
...
component("YIL094C",522).
component("U45_",130).
component("YML056C",688).
component("YLR432W",678).
component("YHR216W",513).
component("YAR075W",186).
component("YAR073W",185).
component("YDR127W",316).
component("YJR139C",589).
component("YML075C",690).
component("YLR450W",681).
component("YOL126C",783).
component("YKL085W",600).
component("YDL078C",271).
component("YKL029C",596).
component("YNL037C",725).
component("YNL009W",723).
component("YLR174W",655).
component("YHR183W",506).
component("YGR256W",469).
component("YNL241C",740).
component("YOL059W",774).
component("YDL022W",263).
component("YCL018W",246).
component("YLR355C",673).
component("YIL074C",519).
component("YER081W",387).
component("YDL174C",293).
component("YML086C",692).
component("YIL155C",531).
component("YEL024W",362).
component("YKR066C",627).
component("YGR088W",450).
component("YDR256C",330).
component("YKL026C",595).
component("YIR037W",541).
component("YBR244W",233).
component("YJR078W",581).
component("U58_",140).
component("YJR025C",573).
component("U107_",27).
component("YGR255C",468).
component("U108_",28).
component("YHR007C",480).
component("YDR402C",344).
component("YGL055W",424).
component("YJR104C",584).
component("YHR008C",481).
component("YOR384W",821).
component("YOR381W",820).
component("YOL152W",785).
component("YLL051C",635).
component("YJL026W",543).
component("YIL066C",518).
component("YGR180C",457).
component("YER070W",384).
component("U37_",124).
component("U36_",123).
component("U35_",122).
component("YDL168W",290).
component("YDR158W",324).
component("YJR009C",570).
component("YJL052W",545).
component("YGR192C",459).
component("YBR006W",198).
component("YPL276W",853).
component("YPL275W",852).
component("YOR388C",822).
component("YPL061W",829).
component("YOR374W",818).
component("YER073W",385).
component("YGL154C",431).
component("YBR115C",216).
component("U55_",139).
component("YER069W",382).
component("YOR323C",810).
component("YMR170C",711).
component("YMR169C",710).
component("YER178W",397).
component("YBR221C",231).
component("YIL125W",527).
component("U52_",136).
component("YBR166C",225).
component("YNL280C",748).
component("YGL012W",418).
component("YKL182W",610).
component("YKL216W",620).
component("YDR044W",306).
component("YER014W",372).
component("YKR009C",623).
component("YIL160C",532).
component("YGL205W",436).
component("YMR118C",705).
component("YLR164W",653).
component("YLL041C",633).
component("YKL148C",605).
component("YKL141W",603).
component("YJL045W",544).
component("YDR178W",325).
component("YEL047C",365).
component("YDL171C",291).
component("YDL171C",292).
component("YOR375C",819).
component("YDL215C",297).
component("YAL062W",182).
component("U99_",176).
component("U100_",21).
component("YBR035C",206).
component("YKR080W",629).
component("YER023W",373).
component("YOR236W",808).
component("YGR204W",461).
component("YIR034C",540).
component("YLR142W",650).
component("U65_",147).
component("U63_",145).
component("U62_",144).
component("YHR068W",491).
component("YKL150W",606).
component("YIL043C",516).
component("YHR042W",486).
component("YOR221C",805).
component("YMR145C",708).
component("YKL192C",614).
component("YKL055C",598).
component("YER061C",380).
component("YDL085W",273).
component("YPL171C",837).
component("YHR179W",505).
component("YMR145C",709).
component("YML120C",693).
component("YKL192C",615).
component("YDL085W",274).
component("YGR234W",464).
component("YFR030W",410).
component("YPL017C",825).
component("YFL018C",401).
component("YDR353W",340).
component("YPR167C",870).
component("YJR137C",588).
component("YNL052W",727).
component("YMR256C",717).
component("YLR395C",677).
component("YLR038C",640).
component("YIL111W",524).
component("YHR051W",490).
component("YGL191W",434).
component("YGL187C",433).
component("YDL067C",270).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",311).
component("YPL266W",851).
component("YKR069W",628).
component("YOL096C",778).
component("U47_",132).
component("YER091C",392).
component("YJR073C",579).
component("YGR157W",455).
component("YDR120C",314).
component("YML008C",683).
component("YOR074C",790).
component("YDL033C",265).
component("YOL096C",779).
component("YLR172C",654).
component("YLR058C",643).
component("YDR019C",303).
component("YBR176W",226).
component("YDR408C",346).
component("YMR120C",706).
component("YLR028C",638).
component("YBL013W",187).
component("YJL130C",555).
component("YJL088W",549).
component("YKL024C",594).
component("YPR074C",865).
component("YBR117C",217).
component("YMR108W",704).
component("YCL009C",245).
component("YNL071W",729).
component("YNR008W",753).
component("YIL160C",533).
component("YNR019W",756).
component("YCR048W",259).
component("U48_",133).
component("YMR062C",700).
component("YDR232W",327).
component("YPL231W",846).
component("YER061C",381).
component("YPL001W",824).
component("YDL052C",269).
component("U8_",170).
component("YDR148C",322).
component("YPL231W",847).
component("YPL028W",826).
component("YLR299W",665).
component("YGL017W",419).
component("YCR005C",251).
component("YML126C",694).
component("YNL104C",732).
component("YDL182W",294).
component("YDL131W",280).
component("YDR307W",336).
component("YLR258W",662).
component("YFR015C",407).
component("YNL029C",724).
component("YIL085C",521).
component("YNL192W",738).
component("YBR038W",208).
component("YBR023C",204).
component("YMR306W",721).
component("YLR342W",671).
component("YGR032W",443).
component("YPR183W",873).
component("YBR248C",234).
component("YLR209C",657).
component("U104_",24).
component("U103_",23).
component("YDR354W",341) :- not remove_orf("YDR354W",341).
component("YFR047C",411).
component("YJR133W",587).
component("YLR209C",658).
component("YML022W",685).
component("YDR441C",349).
component("YHR128W",500).
component("YPR176C",872).
component("YPL172C",838).
component("YNR041C",759).
component("YMR101C",702).
component("YDL090C",276).
component("YBR003W",197).
component("YBR002C",196).
component("YJL167W",562).
component("YJL167W",563).
component("YPR069C",862).
component("YDR127W",317).
component("YHR190W",508).
component("YLR146C",651).
component("YHR068W",492).
component("YLR303W",667).
component("YGR012W",441).
component("YML082W",691).
component("YJR130C",586).
component("YDR035W",305).
component("YBR249C",235).
component("YLR180W",656).
component("YDR502C",353).
component("YOR274W",809).
component("YBR256C",237).
component("YHR137W",501).
component("YGL202W",435).
component("YLR027C",637).
component("YKL106W",601).
component("YOL140W",784).
component("YLR438W",680).
component("YGR019W",442).
component("YLR089C",646).
component("U64_",146).
component("U61_",143).
component("U51_",135).
component("YJR148W",590).
component("YHR208W",511).
component("YFL030W",403).
component("YOR184W",799).
component("YNR058W",763).
component("YIL116W",526).
component("YGL253W",438).
component("YFR053C",412).
component("YMR013C",698).
component("YMR205C",713).
component("YGR240C",465).
component("YOL016C",767).
component("YFR014C",406).
component("YLR240W",660).
component("YKL203C",617).
component("YJR066W",578).
component("YCR036W",258).
component("YCL040W",248).
component("U15_",63).
component("YPL188W",840).
component("YJR049C",575).
component("YEL041W",363).
component("U96_",174).
component("YKL001C",593).
component("YDR236C",328).
component("YHL032C",478).
component("YDR531W",357).
component("U83_",165).
component("U82_",164).
component("U81_",163).
component("YMR208W",714).
component("YPL203W",841).
component("YOR061W",789).
component("YKL166C",608).
component("YJL164C",561).
component("YIL035C",515).
component("YHR205W",510).
component("YHR102W",498).
component("YGL019W",420).
component("YHR025W",485).
component("YOR347C",815).
component("YAL038W",180).
component("YNR012W",754).
component("YDR009W",302).
component("YDR127W",318).
component("YDR147W",321).
component("YDR300C",335).
component("YCR012W",252).
component("YER069W",383).
component("U19_",95).
component("U18_",86).
component("U17_",77).
component("U76_",157).
component("YER170W",396).
component("YDR226W",326).
component("YKL067W",599).
component("YOL055C",771).
component("YDR454C",350).
component("YJR057W",576).
component("YOL061W",775).
component("YKL181W",609).
component("YHL011C",476).
component("YER099C",393).
component("YBL068W",194).
component("YOR143C",795).
component("YNL256W",743).
component("YLR328W",669).
component("YBR018C",200).
component("YBR018C",201).
component("YGR007W",440).
component("YGR202C",460).
component("YLR328W",670).
component("YDL045C",267).
component("U80_",162).
component("YDL103C",279).
component("U94_",173).
component("YJR010W",571).
component("YBR029C",205).
component("YCL050C",249).
component("YGL130W",429).
component("YDR530C",356).
component("YPR190C",875).
component("YPR187W",874).
component("YPR110C",867).
component("YPR010C",856).
component("YOR341W",814).
component("YOR340C",813).
component("YOR224C",807).
component("YOR210W",804).
component("YOR207C",802).
component("YOR151C",796).
component("YOR116C",792).
component("YOL005C",765).
component("YNR003C",752).
component("YNL248C",742).
component("YNL151C",736).
component("YNL113W",733).
component("YKL144C",604).
component("YJR063W",577).
component("YJL148W",559).
component("YJL140W",558).
component("YIL021W",514).
component("YHR143W-A",502).
component("YGL070C",427).
component("YFL036W",404).
component("YDR404C",345).
component("YDR156W",323).
component("YDR045C",307).
component("YDL150W",288).
component("YDL140C",282).
component("YBR154C",224).
component("YPR175W",871).
component("YPL167C",836).
component("YOR330C",811).
component("YOL115W",782).
component("YNL299W",750).
component("YNL262W",745).
component("YNL102W",731).
component("YJR043C",574).
component("YJR006W",569).
component("YJL090C",550).
component("YIL139C",529).
component("YEL055C",366).
component("YDR419W",347).
component("YDR121W",315).
component("YDL102W",278).
component("YCR014C",253).
component("YBR278W",240).
component("YBL035C",190).
component("YKL035W",597).
component("YHL012W",477).
component("YHR123W",499).
component("YPR113W",868).
component("YBR243C",232).
component("YDL142C",287).
component("YPL148C",834).
component("YER026C",374).
component("YGR286C",473).
component("YJL068C",546).
component("YHR189W",507).
component("YDR058C",310).
component("YDL086W",275).
component("YOL011W",766).
component("YMR008C",696).
component("YMR006C",695).
component("U105_",25).
component("YBL015W",188).
component("YJL068C",547).
component("YOR040W",788).
component("U77_",158).
component("YDR481C",351).
component("YLR377C",675).
component("YFR025C",408).
component("YPL179W",839).
component("YNR032W",757).
component("YML057W",689).
component("YML016C",684).
component("YLR433C",679).
component("YGR123C",453).
component("YER133W",394).
component("YER089C",390).
component("YDR436W",348).
component("YDR075W",312).
component("YDL188C",295).
component("YDL134C",281).
component("YDL047W",268).
component("YDL006W",261).
component("YBR125C",219).
component("YBL056W",193).
component("YPR073C",863).
component("YHR215W",512).
component("YDL024C",264).
component("YBR093C",214).
component("YBR092C",213).
component("YAR071W",184).
component("YHR046C",489).
component("U9_",177).
component("YPL228W",844).
component("YMR180C",712).
component("YDL236W",299).
component("YJL155C",560).
component("YPR073C",864).
component("YOR208W",803).
component("YNL053W",728).
component("YMR036C",699).
component("YIR026C",539).
component("YIL113W",525).
component("YFR028C",409).
component("YER075C",386).
component("YDL230W",298).
...
component("U25_",112).
component("U24_",111).
component("YHR044C",488).
component("YHR043C",487).
component("YOL064C",776).
component("YOR360C",817).
component("YKR031C",624).
component("YPL206C",842).
component("YGL027C",422).
component("YLR286C",664).
component("YJR153W",591).
component("YJL221C",568).
component("YJL216C",566).
component("YIL172C",537).
component("YGR292W",475).
component("YGR287C",474).
component("YBR299W",244).
component("YBR184W",227).
component("YIL162W",534).
component("YIR019C",538).
component("YIL099W",523).
component("YDL037C",266).
component("YOR190W",800).
component("YLR300W",666).
component("YGR282C",472).
component("YDR261C",331).
component("YDR400W",343).
component("U23_",110).
component("YML035C",686).
component("YJL070C",548).
component("YBR284W",241).
component("U106_",26).
component("U102_",22).
component("YER043C",375).
component("YNL045W",726).
component("YGL037C",423).
component("YDR242W",329).
component("YBR208C",229).
component("YMR281W",719).
component("U53_",137).
component("YPR062W",861).
component("YMR120C",707).
component("YLR028C",639).
component("YHR144C",503).
component("YGR267C",471).
component("YBL033C",189).
component("YBR153W",223).
component("YNL141W",734).
component("YLR245C",661).
component("YML035C",687).
component("YGR204W",462).
component("YBR084W",211).
component("YJL126W",553).
component("U44_",129).
component("YDL100C",277).
component("U87_",167).
component("U40_",127).
component("U39_",125).
component("YBR011C",199).
component("YHR201C",509).
component("YBR111C",215).
component("YBR252W",236).
component("YER005W",371).
component("YIL048W",517).
component("YER166W",395).
component("YDR093W",313).
component("YAL026C",179).
component("YBL099W",195).
component("U60_",142).
component("YLR231C",659).
component("U88_",168).
component("YDR538W",359).
component("YLR134W",648).
component("YLR044C",641).
component("YGR087C",449).
component("YDR380W",342).
component("YDL080C",272).
component("U98_",175).
component("YMR250W",716).
component("YKL184W",613).
component("YOR128C",793).
component("YEL021W",361).
component("YNR043W",760).
component("U93_",172).
component("U54_",138).
component("YKL211C",618) :- not remove_orf("YKL211C",618).
component("YKR097W",631).
component("YOL052C",770).
component("YNL169C",737).
component("YNL256W",744).
component("YDR294C",333).
component("YEL046C",364).
component("YNR033W",758).
component("YKL211C",619) :- not remove_orf("YKL211C",619).
component("YER090W",619) :- not remove_orf("YER090W",619).
component("YER090W",391) :- not remove_orf("YER090W",391).
component("YDR127W",319).
component("YPL281C",854).
component("YOR393W",823).
component("YMR323W",722).
component("YHR174W",504).
component("YGR254W",467).
component("YOR202W",801).
component("YPL262W",849).
component("YGL026C",421) :- not remove_orf("YGL026C",421).
component("YGR155W",454).
component("YLR304C",668).
component("YJL200C",564).
component("YNL316C",751).
component("YKL182W",611).
component("YPL212C",843).
component("YNL292W",749).
component("YGL063W",426).
component("YFL001W",399).
component("YPR002W",855).
component("YJR016C",572).
component("YCR053W",260).
component("YDR127W",320).
component("YGL148W",430).
component("YIL168W",536).
component("YIL167W",535).
component("YCL064C",250).
component("YER086W",388).
component("YLR359W",674).
component("YAL012W",178).
component("YML004C",682).
component("YFR055W",413).
component("YJL005W",542).
component("YJL121C",552).
component("YBR019C",202).
component("YDR050C",309).
component("YDR007W",301) :- not remove_orf("YDR007W",301).
component("YOR095C",791).
component("YER003C",370).
component("YBR196C",228).
component("YGL001C",415).
component("YPL117C",832).
component("U14_",55).
component("YOL056W",772).
component("YKL152C",607).
component("YDL021W",262).
component("YMR105C",703).
component("YKL127W",602).
component("YEL058W",367).
component("YPR060C",860).
component("YHR072W",493).
component("YPL097W",830).
component("YGR185C",458).
component("YGR264C",470).
component("YGR171C",456).
component("YHR011W",482).
component("YDR023W",304).
component("YPL104W",831).
component("YLL018C",632).
component("YPR081C",866).
component("YBR121C",218).
component("YHR020W",484).
component("YER087W",389).
component("YNL247W",741).
component("YOR168W",797).
component("YOL097C",780).
component("YDR268W",332).
component("YPR047W",859).
component("YLR060W",644).
component("YFL022C",402).
component("YPR033C",857).
component("YCR024C",254).
component("YHR019C",483).
component("YKL194C",616).
component("YIL078W",520).
component("YPL160W",835).
component("YLR382C",676).
component("YNL073W",730).
component("YOR335C",812).
component("YGR094W",451).
component("YLR153C",652).
component("YAL054C",181).
component("YGR244C",466).
component("YPR035W",858).
component("YIL145C",530).
component("U89_",169).
component("YJL101C",551).
component("YOL049W",769).
component("YAR015W",183).
component("YER183C",398).
component("U90_",171).
component("YNR057C",762).
component("YDL141W",283).
component("YDL141W",284).
component("YGL234W",437).
component("YDL141W",285).
component("YJR103W",583).
component("YBL039C",191).
component("YGR204W",463).
component("YBR084W",212).
component("YNL220W",739).
component("YOL058W",773).
component("YDL141W",286).
component("YHR074W",494).
component("YMR217W",715).
component("YGR061C",447).
component("YJR109C",585).
component("YJL130C",556).
component("YGL062W",425).
component("YBR218C",230).
component("YPL231W",848).
component("YNR016C",755).
component("YKL182W",612).
component("YGR037C",444).
component("YPR138C",869).
component("YPL265W",850).
component("YPL134C",833).
component("YPL057C",828).
component("YPL036W",827).
component("YOR348C",816).
component("YOR222W",806).
component("YOR171C",798).
component("YOR130C",794).
component("YOR011W",787).
component("YOL156W",786).
component("YOL103W",781).
component("YOL020W",768) :- not remove_orf("YOL020W",768).
component("YNR072W",764).
component("YNR056C",761).
component("YNL270C",746).
component("YNL142W",735).
component("YMR272C",718).
component("YMR011W",697).
component("YLR348C",672).
component("YLR260W",663).
component("YLR138W",649).
component("YLR100C",647).
component("YLR081W",645).
component("YLL061W",636).
component("YLL043W",634).
component("YKR093W",630).
component("YKR053C",626).
component("YKR039W",625) :- not remove_orf("YKR039W",625).
component("YKL217W",621).
component("YJR158W",592).
component("YJR095W",582).
component("YJR077C",580).
component("YJL219W",567).
component("YJL214W",565).
component("YJL134W",557).
component("YJL129C",554).
component("YIL134W",528).
component("YHR096C",497).
component("YHR094C",496).
component("YHR092C",495).
component("YHL036W",479).
component("YGR121C",452).
component("YGR065C",448).
component("YGR055W",445).
component("YGL186C",432).
component("YGL077C",428).
component("YGL008C",416).
component("YFL055W",405).
component("YFL011W",400).
component("YER060W-A",379).
component("YER060W",378).
component("YER056C",377).
component("YER053C",376).
component("YEL069C",369).
component("YEL063C",368).
...
component("YDR046C",308) :- not remove_orf("YDR046C",308).
component("YDL245C",300).
component("YDL210W",296).
component("YCR032W",257).
component("YCR028C",256).
component("YCR024C-A",255).
...
catalyst(2300,172).
catalyst(3460,138).
catalyst(3600,618) :- not remove_reaction(3600,618).
catalyst(8000,631).
catalyst(3941,770).
catalyst(3942,770).
catalyst(6890,737).
...
catalyst(4560,364).
catalyst(2550,758).
catalyst(1890,619) :- not remove_reaction(1890,619).
catalyst(3630,619) :- not remove_reaction(3630,619).
catalyst(1890,391) :- not remove_reaction(1890,391).
catalyst(3630,391) :- not remove_reaction(3630,391).
catalyst(3740,319).
catalyst(8231,854).
catalyst(8232,854).
catalyst(8231,823).
...
catalyst(8061,849).
catalyst(8062,849).
catalyst(3590,421) :- not remove_reaction(3590,421).
catalyst(10910,421) :- not remove_reaction(10910,421).
catalyst(4570,454).
catalyst(8181,668).
catalyst(8182,668).
catalyst(8181,564).
...
catalyst(8281,309).
catalyst(8282,309).
catalyst(3610,301) :- not remove_reaction(3610,301).
catalyst(7921,791).
catalyst(7922,791).
catalyst(7841,370).
catalyst(7842,370).
...
catalyst(640,630).
catalyst(6560,626).
catalyst(771,625) :- not remove_reaction(771,625).
catalyst(772,625) :- not remove_reaction(772,625).
catalyst(781,625) :- not remove_reaction(781,625).
catalyst(782,625) :- not remove_reaction(782,625).
catalyst(791,625) :- not remove_reaction(791,625).
catalyst(792,625) :- not remove_reaction(792,625).
catalyst(801,625) :- not remove_reaction(801,625).
catalyst(802,625) :- not remove_reaction(802,625).
catalyst(811,625) :- not remove_reaction(811,625).
catalyst(812,625) :- not remove_reaction(812,625).
catalyst(831,625) :- not remove_reaction(831,625).
catalyst(832,625) :- not remove_reaction(832,625).
catalyst(841,625) :- not remove_reaction(841,625).
catalyst(842,625) :- not remove_reaction(842,625).
catalyst(851,625) :- not remove_reaction(851,625).
catalyst(852,625) :- not remove_reaction(852,625).
catalyst(881,625) :- not remove_reaction(881,625).
catalyst(882,625) :- not remove_reaction(882,625).
catalyst(901,625) :- not remove_reaction(901,625).
catalyst(902,625) :- not remove_reaction(902,625).
catalyst(911,625) :- not remove_reaction(911,625).
catalyst(912,625) :- not remove_reaction(912,625).
catalyst(921,625) :- not remove_reaction(921,625).
catalyst(922,625) :- not remove_reaction(922,625).
catalyst(931,625) :- not remove_reaction(931,625).
catalyst(932,625) :- not remove_reaction(932,625).
catalyst(1191,625) :- not remove_reaction(1191,625).
catalyst(1192,625) :- not remove_reaction(1192,625).
catalyst(390,621).
catalyst(1180,592).
catalyst(1210,592).
catalyst(1250,582).
...
catalyst(1210,337).
catalyst(6650,334).
catalyst(791,308) :- not remove_reaction(791,308).
catalyst(792,308) :- not remove_reaction(792,308).
...
catalyst(851,308) :- not remove_reaction(851,308).
catalyst(852,308) :- not remove_reaction(852,308).
catalyst(901,308) :- not remove_reaction(901,308).
catalyst(902,308) :- not remove_reaction(902,308).
catalyst(1180,300).
catalyst(1210,300).
catalyst(730,296).
catalyst(431,257).
