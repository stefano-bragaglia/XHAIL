...
component("YNL280C",549).
component("YLR056W",470).
component("YGL012W",294).
component("YKR009C",452).
component("YOL086C",570).
component("YMR303C",525).
component("YGL256W",314).
component("YDL168W",200).
component("YBR145W",155).
component("YPL231W",625).
component("YBR265W",166).
component("U46_",90).
component("YBR149W",156).
component("YBR149W",157).
component("YGL001C",291).
component("YIL094C",379).
component("U45_",89).
component("YML056C",507).
component("YLR432W",503).
component("YHR216W",373).
component("YAR075W",131).
component("YAR073W",130).
component("YDR127W",218).
component("YOL126C",576).
component("YKL085W",438).
component("YDL078C",190).
component("YNL037C",530).
component("YNL009W",528).
component("YLR174W",482).
component("YHR183W",368).
component("YGR256W",335).
component("YOL059W",568).
component("YDL022W",186).
component("YCL018W",174).
component("YLR355C",498).
component("YDL174C",204).
component("YML086C",509).
component("YGR088W",322).
component("YDR256C",229).
component("YJR078W",426).
component("YJR025C",419).
component("U107_",24).
component("YHR007C",345).
component("YJR104C",428).
component("YHR008C",346).
component("YOR384W",608).
component("YOR381W",607).
component("YOL152W",578).
component("YLL051C",463).
...
component("U37_",83).
component("U36_",82).
component("YDL168W",201).
component("YJR009C",417).
component("YJL052W",396).
component("YGR192C",328).
component("YBR006W",140).
component("YPL276W",633).
component("YPL275W",632).
component("YOR388C",609).
component("YOR374W",605).
component("YER073W",271).
component("YGL154C",306).
component("U55_",96).
component("YER069W",268).
component("YOR323C",598).
component("YER178W",277).
component("YBR221C",163).
component("YIL125W",383).
component("U52_",94).
component("YBR166C",159).
component("YGL012W",295).
component("YKL216W",451).
component("YKR009C",453).
component("YIL160C",387).
component("YGL205W",311).
component("YMR118C",517).
component("YLR164W",480).
component("YLL041C",462).
component("YKL148C",442).
component("YKL141W",440).
component("YJL045W",395).
component("YDR178W",225).
component("YEL047C",256).
component("YDL171C",202).
component("YDL171C",203).
component("YOR375C",606).
...
component("YOR236W",596).
component("YGR204W",329).
component("YLR142W",477).
component("U65_",102).
component("U63_",100).
component("U62_",99).
component("YHR068W",355).
component("YKL150W",443).
component("YIL043C",376).
component("YHR042W",350).
component("YPL171C",620).
component("YHR179W",367).
component("YMR145C",520).
component("YML120C",510).
component("YKL192C",448).
component("YDL085W",192).
component("YGR234W",331).
component("YFR030W",288).
component("YPL017C",611).
component("YFL018C",281).
component("YDR353W",236).
component("YPR167C",645).
component("YJR137C",431).
component("YNL052W",532).
component("YMR256C",524).
component("YLR395C",502).
component("YLR038C",468).
component("YIL111W",380).
component("YHR051W",354).
component("YGL191W",309).
component("YGL187C",308).
component("YDL067C",189).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",631).
component("YKR069W",457).
component("YOL096C",571).
component("U47_",91).
component("YJR073C",424).
component("YDR120C",216).
component("YML008C",504).
component("YDL033C",188).
component("YOL096C",572).
component("YLR172C",481).
component("YLR058C",471).
component("YDR019C",211).
component("YBR176W",160).
component("YDR408C",241).
component("YMR120C",518).
component("YLR028C",466).
component("YBL013W",132).
component("YJL130C",404).
component("YKL024C",436).
component("YPR074C",641).
component("YBR117C",154).
component("YCL009C",173).
component("YNL071W",534).
component("YNR008W",554).
component("YIL160C",388).
component("U48_",92).
component("YPL231W",626).
component("YPL231W",627).
component("YPL028W",612).
component("YLR299W",491).
component("YGL017W",296).
component("YML126C",511).
component("YNL104C",537).
component("YDL182W",205).
component("YDL131W",196).
component("YLR258W",488).
component("YFR015C",286).
component("YNL029C",529).
component("YIL085C",378).
component("YMR306W",526).
component("YLR342W",497).
component("YGR032W",317).
component("YLR209C",484).
component("U104_",21).
component("YDR354W",237) :- not remove_orf("YDR354W",237).
component("YFR047C",289).
component("YJR133W",430).
component("YLR209C",485).
component("YML022W",505).
component("YDR441C",243).
component("YJL167W",409).
component("YJL167W",410).
component("YDR127W",219).
component("YLR146C",478).
component("YHR068W",356).
component("YLR303W",493).
component("YGR012W",315).
component("YML082W",508).
component("YJR130C",429).
component("YDR035W",212).
component("YBR249C",164).
component("YLR180W",483).
component("YDR502C",246).
component("YOR274W",597).
component("YHR137W",363).
component("YGL202W",310).
component("YLR027C",465).
component("YKL106W",439).
component("YOL140W",577).
component("YGR019W",316).
component("YLR089C",473).
component("U64_",101).
component("U61_",98).
component("YJR148W",432).
component("YFL030W",282).
component("YOR184W",590).
component("YNR058W",559).
component("YIL116W",382).
component("YGL253W",313).
component("YFR053C",290).
component("YMR013C",515).
component("YMR205C",521).
component("YGR240C",332).
component("YOL016C",563).
component("YFR014C",285).
component("YCR036W",183).
component("YCL040W",176).
component("U15_",43).
component("YPL188W",621).
component("YJR049C",421).
component("YEL041W",254).
component("U96_",121).
component("YKL001C",435).
component("YDR236C",227).
component("YHL032C",343).
component("YDR531W",250).
component("U83_",117).
component("U82_",116).
component("U81_",115).
component("YMR208W",522).
component("YPL203W",622).
component("YOR061W",581).
component("YKL166C",445).
component("YJL164C",408).
component("YIL035C",375).
component("YHR205W",371).
component("YHR102W",362).
component("YGL019W",297).
component("YHR025W",349).
component("YOR347C",603).
component("YAL038W",126).
component("YNR012W",555).
component("YDR127W",220).
component("YDR147W",223).
component("YCR012W",178).
component("YER069W",269).
component("U76_",111).
component("YER170W",276).
component("YDR226W",226).
component("YKL067W",437).
component("YOL055C",566).
component("YDR454C",244).
component("YJR057W",422).
component("YOL061W",569).
component("YKL181W",446).
component("YHL011C",342).
component("YER099C",275).
component("YBL068W",138).
component("YOR143C",586).
component("YNL256W",546).
component("YLR328W",495).
component("YBR018C",142).
component("YLR328W",496).
component("U94_",120).
component("YBR029C",145).
component("YGL130W",304).
component("YDR530C",249).
component("YPR190C",648).
component("YPR187W",647).
component("YPR110C",642).
component("YPR010C",636).
component("YOR341W",602).
component("YOR340C",601).
component("YOR224C",595).
component("YOR210W",594).
component("YOR207C",592).
component("YOR151C",587).
component("YOR116C",583).
component("YOL005C",561).
component("YNR003C",553).
component("YNL248C",545).
component("YNL151C",541).
component("YNL113W",538).
component("YKL144C",441).
component("YJR063W",423).
component("YJL148W",407).
component("YJL140W",406).
component("YIL021W",374).
component("YHR143W-A",364).
component("YGL070C",302).
component("YFL036W",283).
...
component("YPL167C",619).
component("YOR330C",599).
component("YOL115W",575).
component("YNL299W",551).
component("YNL262W",547).
component("YNL102W",536).
component("YJR043C",420).
component("YJR006W",416).
component("YJL090C",399).
component("YIL139C",385).
component("YEL055C",257).
component("YDR419W",242).
component("YDR121W",217).
component("YDL102W",195).
component("YCR014C",179).
component("YBR278W",168).
component("YBL035C",135).
component("YPR113W",643).
component("YPL148C",617).
component("YGR286C",339).
component("YHR189W",369).
component("YDR058C",215).
component("YDL086W",193).
component("YOL011W",562).
...
component("YNL053W",533).
component("YMR036C",516).
component("YIR026C",392).
component("YIL113W",381).
component("YFR028C",287).
component("YER075C",272).
component("YDL230W",207).
component("YBR276C",167).
component("U34_",81).
component("U32_",80).
component("U31_",79).
component("U30_",78).
...
component("U25_",75).
component("U24_",74).
component("YHR044C",352).
component("YHR043C",351).
component("YOR360C",604).
component("YKR031C",454).
component("YPL206C",623).
component("YGL027C",299).
component("YLR286C",490).
component("YJR153W",433).
component("YJL221C",415).
component("YJL216C",413).
component("YIL172C",391).
component("YGR292W",341).
component("YGR287C",340).
component("YBR299W",172).
component("YOR190W",591).
component("YLR300W",492).
component("YGR282C",338).
component("YDR261C",230).
component("YDR400W",239).
component("YML035C",506).
component("YJL070C",398).
component("YBR284W",169).
component("U106_",23).
component("YER043C",263).
component("YNL045W",531).
component("YDR242W",228).
component("U53_",95).
component("YPR062W",638).
component("YMR120C",519).
component("YLR028C",467).
component("YHR144C",365).
component("YGR267C",337).
component("YBL033C",134).
component("YNL141W",539).
component("YLR245C",487).
component("YBR084W",149).
component("YJL126W",402).
component("U44_",88).
component("YDL100C",194).
component("U40_",86).
component("U39_",84).
component("YBR011C",141).
component("YHR201C",370).
component("YBR111C",153).
component("YBR252W",165).
component("YER005W",261).
component("YBL099W",139).
component("YLR231C",486).
component("YLR134W",475).
component("YLR044C",469).
component("YGR087C",321).
component("YDR380W",238).
component("YDL080C",191).
component("U98_",122).
component("YMR250W",523).
component("YOR128C",584).
component("YEL021W",253).
component("U93_",119).
component("YKL211C",449) :- not remove_orf("YKL211C",449).
component("YKR097W",460).
component("YNL169C",542).
component("YEL046C",255).
component("YNR033W",557).
component("YKL211C",450) :- not remove_orf("YKL211C",450).
component("YER090W",450) :- not remove_orf("YER090W",450).
component("YER090W",274) :- not remove_orf("YER090W",274).
component("YDR127W",221).
component("YPL281C",634).
component("YOR393W",610).
component("YMR323W",527).
component("YHR174W",366).
component("YGR254W",334).
component("YPL262W",629).
component("YGL026C",298) :- not remove_orf("YGL026C",298).
component("YGR155W",324).
component("YLR304C",494).
component("YJL200C",411).
component("YNL316C",552).
component("YPL212C",624).
component("YNL292W",550).
component("YGL063W",301).
component("YFL001W",279).
component("YPR002W",635).
component("YJR016C",418).
component("YCR053W",184).
component("YDR127W",222).
component("YGL148W",305).
component("YIL168W",390).
component("YIL167W",389).
component("YCL064C",177).
component("YLR359W",499).
component("YAL012W",125).
component("YJL005W",393).
component("YJL121C",401).
...
component("YPL117C",616).
component("U14_",37).
component("YOL056W",567).
component("YKL152C",444).
component("YDL021W",185).
component("YEL058W",258).
component("YPR060C",637).
component("YHR072W",357).
component("YPL097W",614).
component("YGR185C",327).
component("YGR264C",336).
component("YGR171C",325).
component("YPL104W",615).
component("YLL018C",461).
component("YHR020W",348).
component("YER087W",273).
component("YNL247W",544).
component("YOR168W",588).
component("YOL097C",573).
component("YDR268W",231).
component("YCR024C",180).
component("YHR019C",347).
component("YPL160W",618).
component("YLR382C",501).
component("YNL073W",535).
component("YOR335C",600).
component("YLR153C",479).
component("YAL054C",127).
component("YGR244C",333).
component("YIL145C",386).
component("YJL101C",400).
component("YOL049W",565).
component("YAR015W",129).
component("YER183C",278).
component("U90_",118).
component("YNR057C",558).
component("YGL234W",312).
component("YJR103W",427).
component("YBL039C",136).
component("YGR204W",330).
component("YBR084W",150).
component("YNL220W",543).
component("YDL141W",198).
component("YHR074W",358).
component("YGL062W",300).
component("YBR218C",162).
component("YPL231W",628).
component("YNR016C",556).
component("YKL182W",447).
component("YGR037C",318).
component("YPR138C",644).
component("YPL265W",630).
component("YPL036W",613).
component("YOR171C",589).
component("YOR130C",585).
component("YOR011W",580).
component("YOL156W",579).
component("YOL103W",574).
component("YOL020W",564) :- not remove_orf("YOL020W",564).
component("YNR072W",560).
component("YNL270C",548).
component("YNL142W",540).
component("YMR011W",514).
component("YLR260W",489).
component("YLR138W",476).
component("YLR100C",474).
component("YLR081W",472).
component("YLL061W",464).
component("YKR093W",459).
component("YKR053C",456).
component("YKR039W",455) :- not remove_orf("YKR039W",455).
component("YJR158W",434).
component("YJR077C",425).
component("YJL219W",414).
component("YJL214W",412).
component("YJL134W",405).
component("YJL129C",403).
component("YIL134W",384).
component("YHR096C",361).
component("YHR094C",360).
component("YHR092C",359).
component("YHL036W",344).
component("YGR121C",323).
component("YGR065C",320).
component("YGR055W",319).
component("YGL186C",307).
component("YGL077C",303).
component("YGL008C",293).
component("YFL055W",284).
component("YFL011W",280).
component("YER060W-A",267).
component("YER060W",266).
component("YER056C",265).
component("YER053C",264).
component("YEL069C",260).
component("YEL063C",259).
component("YEL017C-A",252).
component("YDR536W",251).
component("YDR508C",248).
component("YDR503C",247).
component("YDR497C",245).
component("YDR345C",235).
component("YDR343C",234).
component("YDR342C",233).
component("YDR297W",232).
component("YDR046C",214) :- not remove_orf("YDR046C",214).
component("YDL245C",209).
component("YCR032W",182).
component("YCR024C-A",181).
component("YCL025C",175).
component("YBR298C",171).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,237) :- not remove_reaction(3620,237).
catalyst(2110,289).
catalyst(2190,289).
catalyst(5550,430).
catalyst(5791,485).
...
catalyst(5880,253).
catalyst(2300,119).
catalyst(3600,449) :- not remove_reaction(3600,449).
catalyst(8000,460).
catalyst(6890,542).
catalyst(4560,255).
catalyst(2550,557).
catalyst(1890,450) :- not remove_reaction(1890,450).
catalyst(3630,450) :- not remove_reaction(3630,450).
catalyst(1890,274) :- not remove_reaction(1890,274).
catalyst(3630,274) :- not remove_reaction(3630,274).
catalyst(3740,221).
catalyst(8231,634).
catalyst(8232,634).
catalyst(8231,610).
...
catalyst(1210,579).
catalyst(1160,574).
catalyst(801,564) :- not remove_reaction(801,564).
catalyst(802,564) :- not remove_reaction(802,564).
catalyst(811,564) :- not remove_reaction(811,564).
catalyst(812,564) :- not remove_reaction(812,564).
catalyst(831,564) :- not remove_reaction(831,564).
catalyst(832,564) :- not remove_reaction(832,564).
catalyst(901,564) :- not remove_reaction(901,564).
catalyst(902,564) :- not remove_reaction(902,564).
catalyst(1210,560).
catalyst(931,548).
catalyst(932,548).
catalyst(371,540).
...
catalyst(640,459).
catalyst(6560,456).
catalyst(771,455) :- not remove_reaction(771,455).
catalyst(772,455) :- not remove_reaction(772,455).
catalyst(781,455) :- not remove_reaction(781,455).
catalyst(782,455) :- not remove_reaction(782,455).
catalyst(801,455) :- not remove_reaction(801,455).
catalyst(802,455) :- not remove_reaction(802,455).
catalyst(811,455) :- not remove_reaction(811,455).
catalyst(812,455) :- not remove_reaction(812,455).
catalyst(831,455) :- not remove_reaction(831,455).
catalyst(832,455) :- not remove_reaction(832,455).
catalyst(841,455) :- not remove_reaction(841,455).
catalyst(842,455) :- not remove_reaction(842,455).
catalyst(851,455) :- not remove_reaction(851,455).
catalyst(852,455) :- not remove_reaction(852,455).
catalyst(881,455) :- not remove_reaction(881,455).
catalyst(882,455) :- not remove_reaction(882,455).
catalyst(901,455) :- not remove_reaction(901,455).
catalyst(902,455) :- not remove_reaction(902,455).
catalyst(921,455) :- not remove_reaction(921,455).
catalyst(922,455) :- not remove_reaction(922,455).
catalyst(931,455) :- not remove_reaction(931,455).
catalyst(932,455) :- not remove_reaction(932,455).
catalyst(1191,455) :- not remove_reaction(1191,455).
catalyst(1192,455) :- not remove_reaction(1192,455).
catalyst(1210,434).
catalyst(1581,425).
catalyst(1582,425).
catalyst(1210,414).
...
catalyst(851,147) :- not remove_reaction(851,147).
catalyst(852,147) :- not remove_reaction(852,147).
catalyst(901,147) :- not remove_reaction(901,147).
catalyst(902,147) :- not remove_reaction(902,147).
catalyst(620,144).
catalyst(540,137).
catalyst(6960,114).
catalyst(2840,113).
