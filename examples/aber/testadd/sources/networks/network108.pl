...
component("YLR056W",517).
component("YGL012W",330).
component("YKR009C",499).
component("YOL086C",629).
component("YMR303C",579).
component("YGL256W",351).
component("YDL168W",222).
component("YBR145W",168).
component("YPL231W",688).
component("YBR265W",183).
component("U46_",99).
component("YBR149W",169).
component("YBR149W",170).
component("YGL001C",327).
component("YIL094C",419).
component("U45_",98).
component("YML056C",558).
component("YLR432W",550).
component("YHR216W",413).
component("YAR075W",144).
component("YAR073W",143).
component("YDR127W",243).
component("YML075C",559).
component("YLR450W",552).
component("YOL126C",635).
component("YKL085W",485).
component("YDL078C",210).
component("YNL037C",584).
component("YNL009W",582).
component("YLR174W",529).
component("YHR183W",406).
component("YGR256W",372).
component("YNL241C",598).
component("YOL059W",627).
component("YDL022W",204).
component("YCL018W",191).
component("YLR355C",545).
component("YDL174C",226).
component("YML086C",561).
component("YIL155C",428).
component("YGR088W",359).
component("YDR256C",255).
component("YKL026C",483).
component("YIR037W",437).
component("YBR244W",179).
component("YJR078W",472).
component("U58_",107).
component("YJR025C",465).
component("U107_",24).
component("YHR007C",382).
component("YGL055W",336).
component("YJR104C",474).
component("YHR008C",383).
component("YOR384W",670).
component("YOR381W",669).
component("YOL152W",637).
component("YLL051C",510).
component("YJL026W",439).
component("YIL066C",417).
component("YGR180C",363).
component("YER070W",303).
component("U37_",92).
component("U36_",91).
component("YDL168W",223).
component("YJR009C",462).
component("YJL052W",441).
component("YGR192C",365).
component("YBR006W",153).
component("YPL276W",696).
component("YPL275W",695).
component("YOR388C",671).
component("YOR374W",667).
component("YER073W",304).
component("YGL154C",343).
component("U55_",106).
component("YER069W",301).
component("YOR323C",660).
component("YER178W",312).
component("YBR221C",177).
component("YIL125W",424).
component("U52_",104).
component("YBR166C",172).
component("YGL012W",331).
component("YKL216W",498).
component("YDR044W",236).
component("YKR009C",500).
component("YIL160C",429).
component("YGL205W",348).
component("YMR118C",570).
component("YLR164W",527).
component("YLL041C",509).
component("YKL148C",489).
component("YKL141W",487).
component("YJL045W",440).
component("YDR178W",250).
component("YEL047C",286).
component("YDL171C",224).
component("YDL171C",225).
component("YOR375C",668).
component("YDL215C",228).
component("YAL062W",141).
component("U99_",136).
component("U100_",20).
component("YBR035C",159).
component("YKR080W",505).
component("YER023W",293).
component("YOR236W",658).
component("YGR204W",366).
component("YIR034C",436).
component("YLR142W",524).
component("U65_",113).
component("U63_",111).
component("U62_",110).
component("YHR068W",392).
component("YKL150W",490).
component("YIL043C",416).
component("YHR042W",387).
component("YPL171C",683).
component("YHR179W",405).
component("YMR145C",573).
component("YML120C",562).
component("YKL192C",495).
component("YDL085W",212).
component("YGR234W",368).
component("YFR030W",323).
component("YPL017C",673).
component("YFL018C",316).
component("YDR353W",265).
component("YPR167C",708).
component("YJR137C",477).
component("YNL052W",586).
component("YMR256C",578).
component("YLR395C",549).
component("YLR038C",515).
component("YIL111W",421).
component("YHR051W",391).
component("YGL191W",346).
component("YGL187C",345).
component("YDL067C",209).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",694).
component("YKR069W",504).
component("YOL096C",630).
component("U47_",100).
component("YER091C",309).
component("YJR073C",470).
component("YDR120C",241).
component("YML008C",554).
component("YOR074C",642).
component("YDL033C",206).
component("YOL096C",631).
component("YLR172C",528).
component("YLR058C",518).
component("YDR019C",234).
component("YBR176W",173).
component("YDR408C",270).
component("YMR120C",571).
component("YLR028C",513).
component("YBL013W",145).
component("YJL130C",449).
component("YKL024C",482).
component("YPR074C",704).
component("YBR117C",167).
component("YMR108W",569).
component("YCL009C",190).
component("YNL071W",588).
component("YNR008W",610).
component("YIL160C",430).
component("YNR019W",613).
component("YCR048W",201).
component("U48_",101).
component("YDR232W",252).
component("YPL231W",689).
component("YER061C",300).
component("YDL052C",208).
component("U8_",130).
component("YPL231W",690).
component("YPL028W",674).
component("YLR299W",538).
component("YGL017W",332).
component("YML126C",563).
component("YNL104C",591).
component("YDL182W",227).
component("YDL131W",216).
component("YDR307W",261).
component("YLR258W",535).
component("YFR015C",321).
component("YNL029C",583).
component("YIL085C",418).
component("YMR306W",580).
component("YLR342W",544).
component("YGR032W",354).
component("YLR209C",531).
component("U104_",21).
component("YDR354W",266) :- not remove_orf("YDR354W",266).
component("YFR047C",324).
component("YJR133W",476).
component("YLR209C",532).
component("YML022W",555).
component("YDR441C",272).
component("YHR128W",400).
component("YJL167W",454).
component("YJL167W",455).
component("YDR127W",244).
component("YHR190W",408).
component("YLR146C",525).
component("YHR068W",393).
component("YLR303W",540).
component("YGR012W",352).
component("YML082W",560).
component("YJR130C",475).
component("YDR035W",235).
component("YBR249C",180).
component("YLR180W",530).
component("YDR502C",275).
component("YOR274W",659).
component("YBR256C",182).
component("YHR137W",401).
component("YGL202W",347).
component("YLR027C",512).
component("YKL106W",486).
component("YOL140W",636).
component("YLR438W",551).
component("YGR019W",353).
component("YLR089C",520).
component("U64_",112).
component("U61_",109).
component("U51_",103).
component("YJR148W",478).
component("YHR208W",411).
component("YFL030W",317).
component("YOR184W",651).
component("YNR058W",617).
component("YIL116W",423).
component("YGL253W",350).
component("YFR053C",325).
component("YMR013C",567).
component("YMR205C",574).
component("YGR240C",369).
component("YOL016C",621).
component("YFR014C",320).
component("YCR036W",200).
component("YCL040W",193).
component("U15_",48).
component("YPL188W",684).
component("YJR049C",467).
component("YEL041W",284).
component("U96_",134).
component("YKL001C",481).
component("YDR236C",253).
component("YHL032C",380).
component("YDR531W",279).
component("U83_",129).
component("U82_",128).
component("U81_",127).
component("YMR208W",575).
component("YPL203W",685).
component("YOR061W",641).
component("YKL166C",492).
component("YJL164C",453).
component("YIL035C",415).
component("YHR205W",410).
component("YHR102W",399).
component("YGL019W",333).
component("YHR025W",386).
component("YOR347C",665).
component("YAL038W",139).
component("YNR012W",611).
component("YDR009W",233).
component("YDR127W",245).
component("YDR147W",248).
component("YDR300C",260).
component("YCR012W",195).
component("YER069W",302).
component("U18_",65).
component("U76_",122).
component("YER170W",311).
component("YDR226W",251).
component("YKL067W",484).
component("YOL055C",624).
component("YDR454C",273).
component("YJR057W",468).
component("YOL061W",628).
component("YKL181W",493).
component("YHL011C",379).
component("YER099C",310).
component("YBL068W",151).
component("YOR143C",647).
...
component("U80_",126).
component("U94_",133).
component("YJR010W",463).
component("YBR029C",158).
component("YGL130W",341).
component("YDR530C",278).
component("YPR190C",711).
component("YPR187W",710).
component("YPR110C",705).
component("YPR010C",699).
component("YOR341W",664).
component("YOR340C",663).
component("YOR224C",657).
component("YOR210W",655).
component("YOR207C",653).
component("YOR151C",648).
component("YOR116C",644).
component("YOL005C",619).
component("YNR003C",609).
component("YNL248C",600).
component("YNL151C",595).
component("YNL113W",592).
component("YKL144C",488).
component("YJR063W",469).
component("YJL148W",452).
component("YJL140W",451).
component("YIL021W",414).
component("YHR143W-A",402).
component("YGL070C",339).
component("YFL036W",318).
component("YDR404C",269).
component("YDR156W",249).
component("YDR045C",237).
component("YDL150W",221).
component("YDL140C",217).
component("YBR154C",171).
component("YPR175W",709).
component("YPL167C",682).
component("YOR330C",661).
component("YOL115W",634).
component("YNL299W",607).
component("YNL262W",603).
component("YNL102W",590).
component("YJR043C",466).
component("YJR006W",461).
component("YJL090C",444).
component("YIL139C",426).
component("YEL055C",287).
component("YDR419W",271).
component("YDR121W",242).
component("YDL102W",215).
component("YCR014C",196).
component("YBR278W",185).
component("YBL035C",148).
component("YPR113W",706).
component("YBR243C",178).
component("YPL148C",680).
component("YER026C",294).
component("YGR286C",376).
component("YHR189W",407).
component("YDR058C",240).
component("YDL086W",213).
component("YOL011W",620).
component("YMR008C",565).
component("YMR006C",564).
component("U105_",22).
component("YBL015W",146).
component("YJL068C",442).
component("YOR040W",640).
component("U77_",123).
component("YLR377C",547).
component("YPR073C",702).
component("YHR215W",412).
component("YDL024C",205).
component("YBR093C",165).
component("YBR092C",164).
component("YHR046C",390).
component("U9_",137).
component("YDL236W",230).
component("YPR073C",703).
component("YOR208W",654).
component("YNL053W",587).
component("YMR036C",568).
component("YIR026C",435).
component("YIL113W",422).
component("YFR028C",322).
component("YER075C",305).
component("YDL230W",229).
component("YBR276C",184).
component("U34_",90).
component("U33_",89).
component("U32_",88).
component("U31_",87).
...
component("YOR360C",666).
component("YKR031C",501).
component("YPL206C",686).
component("YGL027C",335).
component("YLR286C",537).
component("YJR153W",479).
component("YJL221C",460).
component("YJL216C",458).
component("YIL172C",433).
component("YGR292W",378).
component("YGR287C",377).
component("YBR299W",189).
component("YBR184W",174).
component("YIR019C",434).
component("YIL099W",420).
component("YDL037C",207).
component("YOR190W",652).
component("YLR300W",539).
component("YGR282C",375).
component("YDR261C",256).
component("YDR400W",268).
component("YML035C",556).
component("YJL070C",443).
component("YBR284W",186).
component("U106_",23).
component("YER043C",295).
component("YNL045W",585).
component("YDR242W",254).
component("U53_",105).
component("YPR062W",701).
component("YMR120C",572).
component("YLR028C",514).
component("YHR144C",403).
component("YGR267C",374).
component("YBL033C",147).
component("YNL141W",593).
component("YLR245C",534).
component("YML035C",557).
component("YBR084W",162).
component("YJL126W",447).
component("U44_",97).
component("YDL100C",214).
component("U40_",95).
component("U39_",93).
component("YBR011C",154).
component("YHR201C",409).
component("YBR111C",166).
component("YBR252W",181).
component("YER005W",292).
component("YBL099W",152).
component("YLR231C",533).
component("YDR538W",281).
component("YLR134W",522).
component("YLR044C",516).
component("YGR087C",358).
component("YDR380W",267).
component("YDL080C",211).
component("U98_",135).
component("YMR250W",577).
component("YOR128C",645).
component("YEL021W",283).
component("YNR043W",615).
component("U93_",132).
component("YKL211C",496) :- not remove_orf("YKL211C",496).
component("YKR097W",507).
component("YNL169C",596).
component("YNL256W",602).
component("YDR294C",258).
component("YEL046C",285).
component("YNR033W",614).
component("YKL211C",497) :- not remove_orf("YKL211C",497).
component("YER090W",497) :- not remove_orf("YER090W",497).
component("YER090W",308) :- not remove_orf("YER090W",308).
component("YDR127W",246).
component("YPL281C",697).
component("YOR393W",672).
component("YMR323W",581).
component("YHR174W",404).
component("YGR254W",371).
component("YPL262W",692).
component("YGL026C",334) :- not remove_orf("YGL026C",334).
component("YGR155W",361).
component("YLR304C",541).
component("YJL200C",456).
component("YNL316C",608).
component("YPL212C",687).
component("YNL292W",606).
component("YGL063W",338).
component("YFL001W",314).
component("YPR002W",698).
component("YJR016C",464).
component("YCR053W",202).
component("YDR127W",247).
component("YGL148W",342).
component("YIL168W",432).
component("YIL167W",431).
component("YCL064C",194).
component("YER086W",306).
component("YLR359W",546).
component("YAL012W",138).
component("YML004C",553).
component("YFR055W",326).
component("YJL005W",438).
component("YJL121C",446).
component("YBR019C",156).
component("YDR050C",239).
component("YDR007W",232) :- not remove_orf("YDR007W",232).
component("YOR095C",643).
component("YER003C",291).
component("YBR196C",175).
component("YGL001C",328).
component("YPL117C",678).
component("U14_",40).
component("YOL056W",625).
component("YKL152C",491).
component("YDL021W",203).
component("YEL058W",288).
component("YPR060C",700).
component("YHR072W",394).
component("YPL097W",676).
component("YGR185C",364).
component("YGR264C",373).
component("YGR171C",362).
component("YPL104W",677).
component("YLL018C",508).
component("YHR020W",385).
component("YER087W",307).
component("YNL247W",599).
component("YOR168W",649).
component("YOL097C",632).
component("YDR268W",257).
component("YCR024C",197).
component("YHR019C",384).
component("YPL160W",681).
component("YLR382C",548).
component("YNL073W",589).
component("YOR335C",662).
component("YLR153C",526).
component("YAL054C",140).
component("YGR244C",370).
component("YIL145C",427).
component("YJL101C",445).
component("YOL049W",623).
component("YAR015W",142).
component("YER183C",313).
component("U90_",131).
component("YNR057C",616).
component("YDL141W",218).
component("YGL234W",349).
component("YDL141W",219).
component("YJR103W",473).
component("YBL039C",149).
component("YGR204W",367).
component("YBR084W",163).
component("YNL220W",597).
component("YOL058W",626).
component("YDL141W",220).
component("YHR074W",395).
component("YMR217W",576).
component("YGL062W",337).
component("YBR218C",176).
component("YPL231W",691).
component("YNR016C",612).
component("YKL182W",494).
component("YGR037C",355).
component("YPR138C",707).
component("YPL265W",693).
component("YPL134C",679).
component("YPL036W",675).
component("YOR222W",656).
component("YOR171C",650).
component("YOR130C",646).
component("YOR011W",639).
component("YOL156W",638).
component("YOL103W",633).
component("YOL020W",622) :- not remove_orf("YOL020W",622).
component("YNR072W",618).
component("YNL270C",604).
component("YNL142W",594).
component("YMR011W",566).
component("YLR260W",536).
component("YLR138W",523).
component("YLR100C",521).
component("YLR081W",519).
component("YLL061W",511).
component("YKR093W",506).
component("YKR053C",503).
component("YKR039W",502) :- not remove_orf("YKR039W",502).
component("YJR158W",480).
component("YJR077C",471).
component("YJL219W",459).
component("YJL214W",457).
component("YJL134W",450).
component("YJL129C",448).
component("YIL134W",425).
component("YHR096C",398).
component("YHR094C",397).
component("YHR092C",396).
component("YHL036W",381).
component("YGR121C",360).
component("YGR065C",357).
component("YGR055W",356).
component("YGL186C",344).
component("YGL077C",340).
component("YGL008C",329).
component("YFL055W",319).
component("YFL011W",315).
component("YER060W-A",299).
component("YER060W",298).
component("YER056C",297).
component("YER053C",296).
component("YEL069C",290).
component("YEL063C",289).
component("YEL017C-A",282).
component("YDR536W",280).
component("YDR508C",277).
component("YDR503C",276).
component("YDR497C",274).
component("YDR345C",264).
component("YDR343C",263).
component("YDR342C",262).
component("YDR297W",259).
component("YDR046C",238) :- not remove_orf("YDR046C",238).
component("YDL245C",231).
component("YCR032W",199).
component("YCR024C-A",198).
component("YCL025C",192).
component("YBR298C",188).
component("YBR291C",187).
component("YBR069C",161) :- not remove_orf("YBR069C",161).
component("YBR068C",160) :- not remove_orf("YBR068C",160).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,266) :- not remove_reaction(3620,266).
catalyst(2110,324).
catalyst(2190,324).
catalyst(5550,476).
catalyst(5791,532).
...
catalyst(6470,615).
catalyst(2300,132).
catalyst(3600,496) :- not remove_reaction(3600,496).
catalyst(8000,507).
catalyst(6890,596).
catalyst(2570,602).
catalyst(8781,258).
...
catalyst(4560,285).
catalyst(2550,614).
catalyst(1890,497) :- not remove_reaction(1890,497).
catalyst(3630,497) :- not remove_reaction(3630,497).
catalyst(1890,308) :- not remove_reaction(1890,308).
...
catalyst(8051,692).
catalyst(8052,692).
catalyst(3590,334) :- not remove_reaction(3590,334).
catalyst(10910,334) :- not remove_reaction(10910,334).
catalyst(4570,361).
catalyst(8181,541).
catalyst(8182,541).
catalyst(8181,456).
...
catalyst(1210,638).
catalyst(1160,633).
catalyst(801,622) :- not remove_reaction(801,622).
catalyst(802,622) :- not remove_reaction(802,622).
catalyst(811,622) :- not remove_reaction(811,622).
catalyst(812,622) :- not remove_reaction(812,622).
catalyst(831,622) :- not remove_reaction(831,622).
catalyst(832,622) :- not remove_reaction(832,622).
catalyst(901,622) :- not remove_reaction(901,622).
catalyst(902,622) :- not remove_reaction(902,622).
catalyst(1180,618).
catalyst(1210,618).
catalyst(931,604).
catalyst(932,604).
...
catalyst(640,506).
catalyst(6560,503).
catalyst(771,502) :- not remove_reaction(771,502).
catalyst(772,502) :- not remove_reaction(772,502).
catalyst(781,502) :- not remove_reaction(781,502).
catalyst(782,502) :- not remove_reaction(782,502).
...
catalyst(841,502) :- not remove_reaction(841,502).
catalyst(842,502) :- not remove_reaction(842,502).
catalyst(851,502) :- not remove_reaction(851,502).
catalyst(852,502) :- not remove_reaction(852,502).
catalyst(881,502) :- not remove_reaction(881,502).
catalyst(882,502) :- not remove_reaction(882,502).
catalyst(901,502) :- not remove_reaction(901,502).
catalyst(902,502) :- not remove_reaction(902,502).
catalyst(921,502) :- not remove_reaction(921,502).
catalyst(922,502) :- not remove_reaction(922,502).
catalyst(931,502) :- not remove_reaction(931,502).
catalyst(932,502) :- not remove_reaction(932,502).
catalyst(1191,502) :- not remove_reaction(1191,502).
catalyst(1192,502) :- not remove_reaction(1192,502).
catalyst(1180,480).
catalyst(1210,480).
catalyst(1581,471).
catalyst(1582,471).
...
catalyst(1511,187).
catalyst(1512,187).
catalyst(771,161) :- not remove_reaction(771,161).
catalyst(772,161) :- not remove_reaction(772,161).
catalyst(801,161) :- not remove_reaction(801,161).
catalyst(802,161) :- not remove_reaction(802,161).
catalyst(811,161) :- not remove_reaction(811,161).
catalyst(812,161) :- not remove_reaction(812,161).
catalyst(851,161) :- not remove_reaction(851,161).
catalyst(852,161) :- not remove_reaction(852,161).
catalyst(901,161) :- not remove_reaction(901,161).
catalyst(902,161) :- not remove_reaction(902,161).
...
catalyst(841,160) :- not remove_reaction(841,160).
catalyst(842,160) :- not remove_reaction(842,160).
