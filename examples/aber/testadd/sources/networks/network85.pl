...
component("YNL280C",518).
component("YLR056W",444).
component("YGL012W",281).
component("YKR009C",427).
component("YOL086C",538).
component("YMR303C",495).
component("YGL256W",301).
component("YDL168W",192).
component("YBR145W",147).
component("YPL231W",591).
component("YBR265W",158).
component("U46_",85).
component("YBR149W",148).
component("YBR149W",149).
component("YGL001C",278).
component("YIL094C",358).
component("U45_",84).
component("YML056C",478).
component("YLR432W",475).
component("YHR216W",352).
component("YAR075W",125).
component("YAR073W",124).
component("YDR127W",207).
component("YOL126C",543).
component("YKL085W",413).
component("YDL078C",182).
component("YNL037C",500).
component("YNL009W",498).
component("YLR174W",454).
component("YOL059W",536).
component("YDL022W",178).
component("YCL018W",166).
component("YLR355C",470).
component("YDL174C",195).
component("YML086C",480).
component("YGR088W",309).
component("YDR256C",218).
component("YJR078W",402).
component("YJR025C",395).
component("U107_",24).
component("YJR104C",404).
component("YHR008C",328).
component("YOR384W",574).
component("YOR381W",573).
component("YOL152W",545).
component("YLL051C",437).
component("YJL026W",372).
component("YIL066C",356).
component("YGR180C",312).
component("YER070W",257).
component("U37_",78).
component("U36_",77).
component("YDL168W",193).
component("YBR006W",133).
component("YPL276W",599).
component("YPL275W",598).
component("YOR388C",575).
component("YOR374W",571).
component("YER073W",258).
component("YGL154C",293).
component("U55_",91).
component("YER069W",255).
component("YOR323C",564).
component("YER178W",264).
component("YBR221C",155).
component("YIL125W",362).
component("U52_",89).
component("YBR166C",151).
component("YGL012W",282).
component("YKL216W",426).
component("YKR009C",428).
component("YIL160C",366).
component("YGL205W",298).
component("YMR118C",487).
component("YLR164W",452).
component("YLL041C",436).
component("YKL148C",417).
component("YKL141W",415).
component("YJL045W",373).
component("YDR178W",214).
component("YEL047C",244).
component("YDL171C",194).
component("YOR375C",572).
component("YAL062W",122).
component("U99_",117).
component("U100_",20).
component("YKR080W",433).
component("YER023W",249).
component("YOR236W",562).
component("YGR204W",314).
component("YLR142W",450).
component("U65_",97).
component("U63_",95).
component("U62_",94).
component("YHR068W",336).
component("YKL150W",418).
component("YIL043C",355).
component("YPL171C",586).
component("YHR179W",347).
component("YMR145C",490).
component("YML120C",481).
component("YKL192C",423).
component("YDL085W",184).
component("YGR234W",316).
component("YFR030W",275).
component("YPL017C",577).
component("YFL018C",268).
component("YDR353W",225).
component("YPR167C",611).
component("YJR137C",406).
component("YNL052W",501).
component("YMR256C",494).
component("YLR395C",474).
component("YLR038C",442).
component("YIL111W",359).
component("YHR051W",335).
component("YGL191W",296).
component("YGL187C",295).
component("YDL067C",181).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",597).
component("YKR069W",432).
component("YOL096C",539).
component("U47_",86).
component("YJR073C",400).
component("YDR120C",205).
component("YDL033C",180).
component("YLR172C",453).
component("YLR058C",445).
component("YDR019C",201).
component("YBR176W",152).
component("YDR408C",230).
component("YMR120C",488).
component("YLR028C",440).
component("YBL013W",126).
component("YJL130C",381).
component("YKL024C",411).
component("YPR074C",607).
component("YBR117C",146).
component("YCL009C",165).
component("YNL071W",503).
component("YIL160C",367).
component("U48_",87).
component("YPL231W",592).
component("YPL231W",593).
component("YPL028W",578).
component("YLR299W",463).
component("YGL017W",283).
component("YML126C",482).
component("YNL104C",506).
component("YDL182W",196).
component("YDL131W",188).
component("YLR258W",460).
component("YFR015C",273).
component("YNL029C",499).
component("YIL085C",357).
component("YMR306W",496).
component("YLR342W",469).
component("YGR032W",304).
component("YLR209C",456).
component("U104_",21).
component("YDR354W",226) :- not remove_orf("YDR354W",226).
component("YFR047C",276).
component("YLR209C",457).
component("YML022W",476).
component("YDR441C",232).
component("YJL167W",386).
component("YJL167W",387).
component("YDR127W",208).
component("YHR068W",337).
component("YLR303W",465).
component("YGR012W",302).
component("YML082W",479).
component("YJR130C",405).
component("YDR035W",202).
component("YBR249C",156).
component("YLR180W",455).
component("YDR502C",235).
component("YOR274W",563).
component("YHR137W",343).
component("YGL202W",297).
component("YLR027C",439).
component("YKL106W",414).
component("YOL140W",544).
component("YGR019W",303).
component("YLR089C",447).
component("U64_",96).
component("U61_",93).
component("YJR148W",407).
component("YFL030W",269).
component("YOR184W",556).
component("YNR058W",527).
component("YIL116W",361).
component("YGL253W",300).
component("YFR053C",277).
component("YMR205C",491).
component("YGR240C",317).
component("YOL016C",531).
component("YFR014C",272).
component("YCR036W",175).
component("YCL040W",168).
component("U15_",43).
component("YPL188W",587).
component("YJR049C",397).
component("YEL041W",242).
component("U96_",115).
component("YKL001C",410).
component("YDR236C",216).
component("YHL032C",326).
component("YDR531W",239).
component("U83_",111).
component("U81_",110).
component("YMR208W",492).
component("YPL203W",588).
component("YOR061W",548).
component("YKL166C",420).
component("YJL164C",385).
component("YIL035C",354).
component("YHR205W",350).
component("YHR102W",342).
component("YGL019W",284).
component("YHR025W",331).
component("YOR347C",569).
component("YAL038W",120).
component("YNR012W",523).
component("YDR127W",209).
component("YDR147W",212).
component("YCR012W",170).
component("YER069W",256).
component("U76_",106).
component("YER170W",263).
component("YDR226W",215).
component("YKL067W",412).
component("YOL055C",534).
component("YDR454C",233).
component("YJR057W",398).
component("YOL061W",537).
component("YKL181W",421).
component("YHL011C",325).
component("YER099C",262).
component("YBL068W",131).
component("YOR143C",552).
component("YNL256W",515).
component("YLR328W",467).
component("YBR018C",135).
component("YLR328W",468).
component("U94_",114).
component("YBR029C",138).
component("YGL130W",291).
component("YDR530C",238).
component("YPR190C",614).
component("YPR187W",613).
component("YPR110C",608).
component("YPR010C",602).
component("YOR341W",568).
component("YOR340C",567).
component("YOR224C",561).
component("YOR210W",560).
component("YOR207C",558).
component("YOR151C",553).
component("YOR116C",550).
component("YOL005C",529).
component("YNR003C",522).
component("YNL248C",514).
component("YNL151C",510).
component("YNL113W",507).
component("YKL144C",416).
component("YJR063W",399).
component("YJL148W",384).
component("YJL140W",383).
component("YIL021W",353).
component("YHR143W-A",344).
component("YGL070C",289).
component("YFL036W",270).
component("YDR404C",229).
component("YDR156W",213).
component("YDR045C",203).
component("YDL150W",191).
component("YDL140C",189).
component("YBR154C",150).
component("YPR175W",612).
component("YPL167C",585).
component("YOR330C",565).
component("YOL115W",542).
component("YNL299W",520).
component("YNL262W",516).
component("YNL102W",505).
component("YJR043C",396).
component("YJR006W",393).
component("YJL090C",376).
component("YIL139C",364).
component("YEL055C",245).
component("YDR419W",231).
component("YDR121W",206).
component("YDL102W",187).
component("YCR014C",171).
component("YBR278W",160).
component("YBL035C",129).
component("YPR113W",609).
component("YPL148C",583).
component("YGR286C",322).
component("YHR189W",348).
component("YDL086W",185).
component("YOL011W",530).
component("YMR008C",484).
component("YMR006C",483).
component("U105_",22).
component("YBL015W",127).
component("YJL068C",374).
component("U77_",107).
component("YLR377C",472).
component("YPR073C",605).
component("YHR215W",351).
component("YDL024C",179).
component("YBR093C",144).
component("YBR092C",143).
component("YHR046C",334).
component("U9_",118).
component("YDL236W",198).
component("YPR073C",606).
component("YOR208W",559).
component("YNL053W",502).
component("YMR036C",486).
component("YIR026C",371).
component("YIL113W",360).
component("YFR028C",274).
component("YER075C",259).
component("YDL230W",197).
component("YBR276C",159).
component("U34_",76).
component("U32_",75).
component("U31_",74).
component("U30_",73).
...
component("U25_",70).
component("U24_",69).
component("YHR044C",333).
component("YHR043C",332).
component("YOR360C",570).
component("YKR031C",429).
component("YPL206C",589).
component("YGL027C",286).
component("YLR286C",462).
component("YJR153W",408).
component("YJL221C",392).
component("YJL216C",390).
component("YIL172C",370).
component("YGR292W",324).
component("YGR287C",323).
component("YBR299W",164).
component("YOR190W",557).
component("YLR300W",464).
component("YGR282C",321).
component("YDR261C",219).
component("YDR400W",228).
component("YML035C",477).
component("YJL070C",375).
component("YBR284W",161).
component("U106_",23).
component("YER043C",250).
component("YDR242W",217).
component("U53_",90).
component("YPR062W",604).
component("YMR120C",489).
component("YLR028C",441).
component("YHR144C",345).
component("YBL033C",128).
component("YNL141W",508).
component("YLR245C",459).
component("YBR084W",141).
component("YJL126W",379).
component("U44_",83).
component("YDL100C",186).
component("U40_",81).
component("U39_",79).
component("YBR011C",134).
component("YHR201C",349).
component("YBR111C",145).
component("YBR252W",157).
component("YER005W",248).
component("YBL099W",132).
component("YLR231C",458).
component("YLR134W",449).
component("YLR044C",443).
component("YGR087C",308).
component("YDR380W",227).
component("YDL080C",183).
component("U98_",116).
component("YMR250W",493).
component("YOR128C",551).
component("U93_",113).
component("YKL211C",424) :- not remove_orf("YKL211C",424).
component("YKR097W",434).
component("YNL169C",511).
component("YEL046C",243).
component("YNR033W",525).
component("YKL211C",425) :- not remove_orf("YKL211C",425).
component("YER090W",425) :- not remove_orf("YER090W",425).
component("YER090W",261) :- not remove_orf("YER090W",261).
component("YDR127W",210).
component("YPL281C",600).
component("YOR393W",576).
component("YMR323W",497).
component("YHR174W",346).
component("YGR254W",319).
component("YPL262W",595).
component("YGL026C",285) :- not remove_orf("YGL026C",285).
component("YLR304C",466).
component("YJL200C",388).
component("YNL316C",521).
component("YPL212C",590).
component("YNL292W",519).
component("YGL063W",288).
component("YFL001W",266).
component("YPR002W",601).
component("YJR016C",394).
component("YCR053W",176).
component("YDR127W",211).
component("YGL148W",292).
component("YIL168W",369).
component("YIL167W",368).
component("YCL064C",169).
component("YLR359W",471).
component("YAL012W",119).
component("YJL121C",378).
component("YBR019C",136).
component("YDR007W",200) :- not remove_orf("YDR007W",200).
component("YOR095C",549).
component("YBR196C",153).
component("YGL001C",279).
component("YPL117C",582).
component("U14_",37).
component("YOL056W",535).
component("YKL152C",419).
component("YDL021W",177).
component("YPR060C",603).
component("YPL097W",580).
component("YGR185C",313).
component("YGR264C",320).
component("YGR171C",311).
component("YPL104W",581).
component("YLL018C",435).
component("YHR020W",330).
component("YER087W",260).
component("YNL247W",513).
component("YOR168W",554).
component("YOL097C",540).
component("YDR268W",220).
component("YCR024C",172).
component("YHR019C",329).
component("YPL160W",584).
component("YLR382C",473).
component("YNL073W",504).
component("YOR335C",566).
component("YLR153C",451).
component("YAL054C",121).
component("YGR244C",318).
component("YIL145C",365).
component("YJL101C",377).
component("YOL049W",533).
component("YAR015W",123).
component("YER183C",265).
component("U90_",112).
component("YNR057C",526).
component("YGL234W",299).
component("YJR103W",403).
component("YBL039C",130).
component("YGR204W",315).
component("YBR084W",142).
component("YNL220W",512).
component("YDL141W",190).
component("YHR074W",338).
component("YGL062W",287).
component("YBR218C",154).
component("YPL231W",594).
component("YNR016C",524).
component("YKL182W",422).
component("YGR037C",305).
component("YPR138C",610).
component("YPL265W",596).
component("YPL036W",579).
component("YOR171C",555).
component("YOR011W",547).
component("YOL156W",546).
component("YOL103W",541).
component("YOL020W",532) :- not remove_orf("YOL020W",532).
component("YNR072W",528).
component("YNL270C",517).
component("YNL142W",509).
component("YMR011W",485).
component("YLR260W",461).
component("YLR100C",448).
component("YLR081W",446).
component("YLL061W",438).
component("YKR053C",431).
component("YKR039W",430) :- not remove_orf("YKR039W",430).
component("YJR158W",409).
component("YJR077C",401).
component("YJL219W",391).
component("YJL214W",389).
component("YJL134W",382).
component("YJL129C",380).
component("YIL134W",363).
component("YHR096C",341).
component("YHR094C",340).
component("YHR092C",339).
component("YHL036W",327).
component("YGR121C",310).
component("YGR065C",307).
component("YGR055W",306).
component("YGL186C",294).
component("YGL077C",290).
component("YGL008C",280).
component("YFL055W",271).
component("YFL011W",267).
component("YER060W-A",254).
component("YER060W",253).
component("YER056C",252).
component("YER053C",251).
component("YEL069C",247).
component("YEL063C",246).
component("YEL017C-A",241).
component("YDR536W",240).
component("YDR508C",237).
component("YDR503C",236).
component("YDR497C",234).
component("YDR345C",224).
component("YDR343C",223).
component("YDR342C",222).
component("YDR297W",221).
component("YDR046C",204) :- not remove_orf("YDR046C",204).
component("YDL245C",199).
component("YCR032W",174).
component("YCR024C-A",173).
component("YCL025C",167).
component("YBR298C",163).
component("YBR291C",162).
component("YBR069C",140) :- not remove_orf("YBR069C",140).
component("YBR068C",139) :- not remove_orf("YBR068C",139).
...
catalyst(6112,551).
catalyst(2300,113).
catalyst(3600,424) :- not remove_reaction(3600,424).
catalyst(8000,434).
catalyst(6890,511).
catalyst(4560,243).
catalyst(2550,525).
...
catalyst(1890,261) :- not remove_reaction(1890,261).
catalyst(3630,261) :- not remove_reaction(3630,261).
catalyst(3740,210).
catalyst(8231,600).
catalyst(8232,600).
catalyst(8231,576).
...
catalyst(750,438).
catalyst(6560,431).
catalyst(771,430) :- not remove_reaction(771,430).
catalyst(772,430) :- not remove_reaction(772,430).
catalyst(781,430) :- not remove_reaction(781,430).
catalyst(782,430) :- not remove_reaction(782,430).
catalyst(801,430) :- not remove_reaction(801,430).
catalyst(802,430) :- not remove_reaction(802,430).
catalyst(811,430) :- not remove_reaction(811,430).
catalyst(812,430) :- not remove_reaction(812,430).
catalyst(831,430) :- not remove_reaction(831,430).
catalyst(832,430) :- not remove_reaction(832,430).
catalyst(841,430) :- not remove_reaction(841,430).
catalyst(842,430) :- not remove_reaction(842,430).
catalyst(851,430) :- not remove_reaction(851,430).
catalyst(852,430) :- not remove_reaction(852,430).
catalyst(881,430) :- not remove_reaction(881,430).
catalyst(882,430) :- not remove_reaction(882,430).
catalyst(901,430) :- not remove_reaction(901,430).
catalyst(902,430) :- not remove_reaction(902,430).
catalyst(921,430) :- not remove_reaction(921,430).
catalyst(922,430) :- not remove_reaction(922,430).
catalyst(931,430) :- not remove_reaction(931,430).
catalyst(932,430) :- not remove_reaction(932,430).
catalyst(1191,430) :- not remove_reaction(1191,430).
catalyst(1192,430) :- not remove_reaction(1192,430).
catalyst(1210,409).
catalyst(1581,401).
catalyst(1582,401).
catalyst(1210,391).
...
catalyst(831,204) :- not remove_reaction(831,204).
catalyst(832,204) :- not remove_reaction(832,204).
catalyst(841,204) :- not remove_reaction(841,204).
catalyst(842,204) :- not remove_reaction(842,204).
...
catalyst(1491,162).
catalyst(1492,162).
catalyst(771,140) :- not remove_reaction(771,140).
catalyst(772,140) :- not remove_reaction(772,140).
...
catalyst(851,140) :- not remove_reaction(851,140).
catalyst(852,140) :- not remove_reaction(852,140).
catalyst(901,140) :- not remove_reaction(901,140).
catalyst(902,140) :- not remove_reaction(902,140).
...
catalyst(841,139) :- not remove_reaction(841,139).
catalyst(842,139) :- not remove_reaction(842,139).
catalyst(851,139) :- not remove_reaction(851,139).
catalyst(852,139) :- not remove_reaction(852,139).
catalyst(901,139) :- not remove_reaction(901,139).
catalyst(902,139) :- not remove_reaction(902,139).
catalyst(620,137).
catalyst(6960,109).
catalyst(2840,108).
catalyst(2920,105).
