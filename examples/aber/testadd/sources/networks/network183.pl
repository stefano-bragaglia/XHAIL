...
component("YNL280C",926).
component("YLR056W",788).
component("YGR060W",551).
component("YGL012W",516).
component("YKR009C",764).
component("YOL086C",961).
component("YMR303C",892).
component("YMR083W",864).
component("YGL256W",543).
...
component("YJR159W",727).
component("YGL001C",512).
component("YIL094C",643).
component("YHR063C",606).
component("U45_",161).
component("YML056C",845).
component("YLR432W",833).
component("YHR216W",631).
component("YAR075W",226).
component("YAR073W",225).
component("YDR127W",389).
component("YJR139C",722).
component("YML075C",848).
component("YLR450W",836).
component("YOL126C",967).
component("YKL085W",738).
component("YDL078C",331).
component("YKL029C",733).
component("YOR136W",988).
component("YNL037C",898).
component("YNL009W",896).
component("YLR174W",802).
component("YDL066W",329).
component("YHR183W",624).
component("YGR256W",582).
component("YNL241C",915).
component("YOL059W",958).
component("YDL022W",320).
component("YCL018W",299).
component("YLR355C",827).
component("YIL074C",640).
component("YER081W",477).
component("YML054C",844).
component("YDL174C",356).
component("YML086C",850).
component("YIL155C",653).
component("YPR191W",1099).
component("YOR065W",976).
component("YJL166W",691).
component("YHR001W-A",593).
component("YGR183C",567).
component("YFR033C",508).
component("YEL024W",445).
component("YDR529C",435).
component("YBL045C",234).
component("Q0105",19).
component("YKR066C",769).
component("YGR088W",555).
component("YDR256C",405).
component("YKL026C",732).
component("YIR037W",666).
component("YBR244W",285).
component("YJR078W",714).
component("U58_",172).
component("YJR025C",705).
component("U107_",28).
component("YGR255C",581).
component("U108_",29).
component("YHR007C",594).
component("YDR402C",422).
component("YGL055W",523).
component("YJR104C",717).
component("YHR008C",595).
component("YOR384W",1026).
component("YOR381W",1025).
component("YOL152W",971).
component("YLL051C",780).
component("YJL026W",669).
component("YIL066C",639).
component("YGR180C",566).
component("YER070W",474).
component("U37_",153).
component("U36_",152).
component("U35_",151).
component("YDL168W",353).
component("YDR158W",397).
component("YJR009C",701).
component("YJL052W",671).
component("YGR192C",569).
component("YBR006W",243).
component("YPL276W",1069).
component("YPL275W",1068).
component("YOR388C",1027).
component("YPL061W",1036).
component("YOR374W",1022).
component("YER073W",475).
component("YGL154C",532).
component("YBR115C",266).
component("U55_",170).
component("YER069W",472).
component("YOR323C",1012).
component("YMR170C",875).
component("YMR169C",874).
component("U2_",145).
component("YER178W",491).
component("YBR221C",283).
component("YIL125W",649).
component("U52_",167).
component("YBR166C",276).
component("YNL280C",927).
component("YGL012W",517).
component("YKL182W",750).
component("U57_",171).
component("YKL216W",761).
component("YDR044W",372).
component("YER014W",456).
component("YKR009C",765).
component("YIL160C",655).
component("YGL205W",537).
component("YMR118C",868).
component("YLR164W",800).
component("YLL041C",778).
component("YKL148C",744).
component("YKL141W",742).
component("YJL045W",670).
component("YDR178W",399).
component("YJR051W",708).
component("YEL047C",449).
component("YDL171C",354).
component("YDL171C",355).
component("YOR375C",1023).
component("YDL215C",360).
component("YAL062W",221).
component("U99_",214).
component("U100_",22).
component("YBR035C",252).
component("YMR189W",877).
component("YKR080W",771).
component("YER023W",458).
component("YPL023C",1031).
component("YGL125W",529).
component("YOR236W",1007).
component("YGR204W",573).
component("YBR084W",259).
component("YIR034C",665).
component("YLR142W",797).
component("U65_",180).
component("U63_",178).
component("U62_",177).
component("YOR356W",1020).
component("YHR068W",607).
component("YKL150W",745).
component("YIL043C",636).
component("YHR042W",601).
component("YOR221C",1004).
component("YMR145C",871).
component("YML120C",852).
component("YKL192C",754).
component("YKL055C",735).
component("YER061C",468).
component("YDL085W",333).
component("YPL171C",1046).
component("YHR179W",623).
component("YMR145C",872).
component("YML120C",853).
component("YKL192C",755).
component("YDL085W",334).
component("YGR234W",576).
component("YFR030W",507).
component("YPL017C",1030).
component("YFL018C",495).
component("YPL091W",1038).
component("YDR353W",416).
component("YER042W",460).
component("YPR167C",1093).
component("YJR137C",721).
component("YNL052W",900).
component("YMR256C",886).
component("YLR395C",831).
component("YLR038C",786).
component("YIL111W",646).
component("YHR051W",605).
component("YGL191W",535).
component("YGL187C",534).
component("YDL067C",330).
component("Q0275",21).
component("Q0250",20).
component("Q0045",18).
component("YDR072C",381).
component("YPL266W",1064).
component("YPL273W",1066).
component("YLL062C",782).
component("YDR410C",425).
component("YKR069W",770).
component("YOL096C",962).
component("U47_",163).
component("YER091C",482).
component("YJR073C",712).
component("YGR157W",562).
component("YDR120C",387).
component("YML008C",838).
component("YOR074C",978).
component("YDL033C",322).
component("YOL096C",963).
component("YLR172C",801).
component("YLR058C",789).
component("YDR019C",368).
component("YBR176W",277).
component("YDR408C",424).
component("YMR120C",869).
component("YLR028C",784).
component("YBL013W",227).
component("YJL130C",683).
component("YJL088W",676).
component("YKL024C",730).
component("YPR074C",1084).
component("YBR117C",267).
component("YLR354C",826).
component("YGR043C",549).
component("YMR108W",867).
component("YCL009C",298).
component("YMR062C",862).
component("YNL071W",902).
component("YNR008W",934).
component("YIL160C",656).
component("YNR019W",937).
component("YCR048W",315).
component("U48_",164).
component("YNL277W",925).
component("YMR062C",863).
component("YDR232W",402).
component("YPL231W",1058).
component("YER061C",469).
component("U86_",202).
component("YPL001W",1029).
component("YDL052C",326).
component("U8_",206).
component("YDR148C",395).
component("YAR035W",223).
component("YOR377W",1024).
component("YGR177C",565).
component("YPL231W",1059).
component("YPL028W",1032).
component("YLR299W",813).
component("YGL017W",518).
component("YPR001W",1071).
component("YNR001C",932).
component("YCR005C",307).
component("YML126C",854).
component("YNL104C",905).
component("YDL182W",357).
component("YDL131W",343).
component("YPR160W",1092).
component("YOR321W",1011).
component("YJR143C",723).
component("YGR199W",571).
component("YDR307W",412).
component("YDL095W",338).
component("YDL093W",337).
component("YAL023C",217).
component("YLR258W",810).
component("YFR015C",503).
component("YPL227C",1055).
component("YOR103C",982).
component("YOR085W",979).
component("YMR149W",873).
component("YML019W",840).
component("YJL002C",667).
component("YEL002C",440).
component("YDL232W",362).
component("YCL043C",303).
component("YNL029C",897).
component("YIL085C",642).
component("YNL192W",913).
component("YBR038W",254).
component("YBR023C",250).
component("YEL011W",441).
component("YMR306W",894).
component("YLR342W",824).
component("YGR032W",547).
...
component("YOR209C",1002).
component("YMR300C",891).
component("YER055C",464).
component("YDR354W",417) :- not remove_orf("YDR354W",417).
component("YFR047C",509).
component("YJR133W",720).
component("U22_",137).
component("YLR209C",805).
component("YML022W",841).
component("YDR441C",428).
component("YDR399W",420).
component("YHR128W",616).
component("YPR176C",1095).
component("YPL172C",1047).
component("YNR041C",941).
component("YMR101C",865).
component("YDL090C",336).
component("YBR003W",242).
component("YBR002C",241).
component("YJL167W",692).
component("YJL167W",693).
component("YNL256W",918).
component("YPR069C",1081).
component("YDR127W",390).
component("YHR190W",626).
component("YLR146C",798).
component("YPL214C",1053).
component("YHR068W",608).
component("YLR303W",815).
component("YGR012W",545).
component("YML082W",849).
component("YJR130C",719).
component("YLR303W",816).
component("YDR035W",370).
component("YBR249C",287).
component("YLR180W",803).
component("YDR502C",432).
component("YOR274W",1008).
component("YOL143C",970).
component("YBR256C",289).
component("YHR137W",617).
component("YGL202W",536).
component("YLR027C",783).
component("YKL106W",739).
component("YOL140W",969).
component("YLR438W",835).
component("YGR019W",546).
component("YLR089C",793).
component("YDR111C",386).
component("U64_",179).
component("U61_",176).
component("U51_",166).
component("YJR148W",724).
component("YHR208W",629).
component("YFL030W",497).
component("YOR184W",995).
component("YNR058W",945).
component("YIL116W",648).
component("YGL253W",542).
component("YFR053C",510).
component("YOL136C",968).
component("YIL107C",645).
component("YMR013C",858).
component("YMR205C",879).
component("YGR240C",577).
component("YOL016C",949).
component("YFR014C",502).
component("YLR240W",808).
component("YKL203C",757).
component("YJR066W",711).
component("YCR036W",314).
component("YGR194C",570).
component("YCL040W",302).
component("U15_",73).
component("YPL188W",1049).
component("YJR049C",707).
component("YEL041W",446).
component("U96_",212).
component("YKL001C",728).
component("YDR236C",403).
component("YML070W",847).
component("YFL053W",499).
component("YHL032C",591).
component("YDR531W",437).
component("U83_",199).
component("U82_",198).
component("U81_",197).
component("YMR208W",880).
component("YPL203W",1050).
component("YOR061W",975).
component("YKL166C",747).
component("YJL164C",690).
component("YIL035C",635).
component("YHR205W",628).
component("YHR102W",614).
component("YGL019W",519).
component("YHR025W",600).
component("YOR347C",1018).
component("YAL038W",219).
component("YNR012W",935).
component("YPR121W",1089).
component("YPL258C",1061).
component("YOL055C",954).
component("YPL214C",1054).
component("U1_",113).
component("YDR009W",367).
component("YNL267W",922).
component("YLR305C",818).
component("YFR019W",504).
component("YDR208W",400).
component("YDR127W",391).
component("U21_",128).
component("U20_",123).
component("YDR147W",394).
component("YDR300C",411).
component("YCR012W",308).
component("YER052C",462).
component("YER069W",473).
component("U19_",112).
component("YKL024C",731).
component("U18_",101).
component("U17_",90).
component("U76_",191).
component("YMR220W",882).
component("YER170W",490).
component("YDR226W",401).
component("YKL067W",737).
component("YOL055C",955).
component("YDR454C",429).
component("YJR057W",709).
component("YOL061W",959).
component("YKL181W",749).
component("YHL011C",589).
component("YER099C",484).
component("YBL068W",237).
component("YOR143C",990).
component("YNL256W",919).
component("YLR328W",822).
component("YBR018C",245).
component("YBR018C",246).
component("YDL055C",327).
component("YGR007W",544).
component("YGR202C",572).
component("YLR328W",823).
component("YKR002W",763).
component("YDL045C",324).
component("U80_",196).
component("YDL103C",341).
component("U94_",211).
component("YJR010W",702).
component("YBR029C",251).
component("YCL050C",304).
component("YGL130W",530).
...
component("YOR341W",1017).
component("YOR340C",1016).
component("YOR224C",1006).
component("YOR210W",1003).
component("YOR207C",1000).
component("YOR151C",991).
component("YOR116C",983).
component("YOL005C",947).
component("YNR003C",933).
component("YNL248C",917).
component("YNL151C",910).
component("YNL113W",906).
component("YKL144C",743).
component("YJR063W",710).
component("YJL148W",687).
component("YJL140W",686).
component("YIL021W",634).
component("YHR143W-A",618).
component("YGL070C",527).
component("YFL036W",498).
component("YDR404C",423).
component("YDR156W",396).
component("YDR045C",373).
component("YDL150W",351).
component("YDL140C",345).
component("YBR154C",275).
component("YPR175W",1094).
component("YPL167C",1045).
component("YOR330C",1013).
component("YOL115W",966).
component("YNL299W",929).
component("YNL262W",921).
component("YNL102W",904).
component("YJR043C",706).
component("YJR006W",700).
component("YJL090C",677).
component("YIL139C",651).
component("YEL055C",450).
component("YDR419W",426).
component("YDR121W",388).
component("YDL102W",340).
component("YCR014C",309).
component("YBR278W",292).
component("YBL035C",231).
component("YKL035W",734).
component("YHL012W",590).
component("YHR123W",615).
component("YPR113W",1088).
component("YBR243C",284).
component("YNL130C",907).
component("YDL142C",350).
component("YPL148C",1043).
component("YER026C",459).
component("YCL004W",297).
component("YGR286C",586).
component("YJL068C",672).
component("YHR189W",625).
component("YDR058C",378).
component("YNR034W",940).
component("YHR163W",621).
component("YGR248W",579).
component("YCR073W-A",317).
component("YDL086W",335).
component("YOL011W",948).
component("YMR008C",856).
component("YMR006C",855).
component("U105_",26).
component("YBL015W",228).
component("YJL068C",673).
component("YPL072W",1037).
component("YOR124C",984).
component("YNL186W",912).
component("YMR304W",893).
component("YMR223W",883).
component("YKR098C",775).
component("YJL197W",694).
component("YIL156W",654).
component("YFR010W",501).
component("YER151C",488).
component("YER144C",487).
component("YER098W",483).
component("YDR069C",380).
component("YDL122W",342).
component("YBR058C",255).
component("YBL067C",236).
component("YJR019C",704).
component("YOR040W",974).
component("U84_",200).
component("U77_",192).
component("YDR481C",430).
component("YLR377C",829).
component("YDR074W",382).
component("YFR025C",505).
component("YPL179W",1048).
component("YNR032W",938).
component("YML057W",846).
component("YML016C",839).
component("YLR433C",834).
component("YGR123C",558).
component("YER133W",486).
component("YER089C",480).
component("YDR436W",427).
component("YDR075W",383).
component("YDL188C",358).
component("YDL134C",344).
...
component("YIL053W",638).
component("YER062C",470).
component("YHR046C",604).
component("U9_",215).
component("YPL228W",1056).
component("YMR180C",876).
component("YDL236W",363).
component("YJL155C",689).
component("YPR073C",1083).
component("YOR208W",1001).
component("YNL053W",901).
component("YMR036C",860).
component("YIR026C",662).
component("YIL113W",647).
component("YFR028C",506).
component("YER075C",476).
component("YDL230W",361).
...
component("U25_",140).
component("U24_",139).
component("YHR044C",603).
component("YHR043C",602).
component("YOL064C",960).
component("YPL268W",1065).
component("YOR360C",1021).
component("YGL248W",541).
component("YKR031C",766).
component("YPL206C",1051).
component("YGL027C",521).
component("YLR286C",812).
component("YJR153W",725).
component("YJL221C",699).
component("YJL216C",697).
component("YIL172C",660).
component("YGR292W",588).
component("YGR287C",587).
component("YBR299W",296).
component("YBR184W",278).
component("YIL162W",657).
component("YPR026W",1075).
component("YDR001C",365).
component("YBR001C",240).
component("YIR019C",661).
component("YIL099W",644).
component("YDL037C",323).
component("YOR190W",997).
component("YLR300W",814).
component("YGR282C",585).
component("YDR261C",406).
component("YDR400W",421).
component("U23_",138).
component("YML035C",842).
component("YJL070C",674).
component("YBR284W",293).
component("U106_",27).
component("U102_",23).
component("YER043C",461).
component("YNL045W",899).
component("YGL037C",522).
component("U43_",159).
component("U42_",158).
component("YMR293C",890).
component("YDR242W",404).
component("YLR308W",821).
component("YLR307W",820).
component("YBR208C",280).
component("YMR281W",889).
component("U53_",168).
component("YLR420W",832).
component("YIR032C",664).
component("YIR029W",663).
component("YPR062W",1080).
component("YMR120C",870).
component("YLR028C",785).
component("YHR144C",619).
component("YHR144C",620).
component("YGR267C",584).
component("YCL030C",301).
component("YBL033C",230).
component("YBR153W",274).
component("YNL141W",908).
component("YLR245C",809).
component("YML035C",843).
component("YGR204W",574).
component("YBR084W",260).
component("YJL126W",681).
component("U44_",160).
component("YDL100C",339).
component("U87_",203).
component("U40_",156).
component("U39_",154).
...
component("YEL042W",447).
component("YPR080W",1085).
component("YOR187W",996).
component("YOR133W",987).
component("YLR069C",791).
component("YKR084C",772).
component("YKL173W",748).
component("YJL102W",679).
component("YDR385W",419).
component("YBR118W",268).
component("YER005W",455).
component("YLL001W",776).
component("YIL048W",637).
component("YER166W",489).
component("YDR093W",385).
component("YAL026C",218).
component("YBL099W",239).
component("U60_",175).
component("YLR231C",806).
component("U88_",204).
component("YDR538W",439).
component("YLR134W",795).
component("YLR044C",787).
component("YGR087C",554).
component("YDR380W",418).
component("YDL080C",332).
component("U98_",213).
component("YMR250W",885).
component("YKL184W",753).
component("YOR128C",985).
component("YEL021W",444).
component("YNR043W",942).
component("U93_",210).
component("YDR047W",375).
component("U54_",169).
component("YKL211C",759) :- not remove_orf("YKL211C",759).
component("YKR097W",774).
component("YOL052C",953).
component("YNL169C",911).
component("YGR170W",563).
component("YKL060C",736).
component("YNL256W",920).
component("YDR294C",409).
component("YEL046C",448).
component("YNR033W",939).
component("YPR006C",1073).
component("YER065C",471).
component("YKL211C",760) :- not remove_orf("YKL211C",760).
component("YER090W",760) :- not remove_orf("YER090W",760).
component("YER090W",481) :- not remove_orf("YER090W",481).
component("YDR127W",392).
component("YPL281C",1070).
component("YOR393W",1028).
component("YMR323W",895).
component("YHR174W",622).
component("YGR254W",580).
component("YOR202W",999).
component("YPL262W",1062).
component("YGL026C",520) :- not remove_orf("YGL026C",520).
component("YGR155W",561).
component("YLR304C",817).
component("YJL200C",695).
component("YGL009C",515).
component("YNL316C",930).
component("YKL182W",751).
component("YPL212C",1052).
component("YNL292W",928).
component("YGL063W",526).
component("YFL001W",493).
component("YOR278W",1009).
component("YPR002W",1072).
component("YJR016C",703).
component("YCR053W",316).
component("YDR127W",393).
component("YGL148W",531).
component("YIL168W",659).
component("YIL167W",658).
component("YCL064C",306).
component("YER086W",478).
component("YLR359W",828).
component("YAL012W",216).
component("YML004C",837).
component("YFR055W",511).
component("YJL005W",668).
component("YOR176W",994).
component("YJL121C",680).
component("YBR019C",247).
component("YBR019C",248).
component("U59_",173).
component("YDR050C",376).
component("YIL020C",633).
component("YDR007W",366) :- not remove_orf("YDR007W",366).
component("YOR095C",980).
component("YER003C",454).
component("YBR196C",279).
component("YGL001C",513).
component("YPL117C",1041).
component("U14_",65).
component("YOL056W",956).
component("YKL152C",746).
component("YDL021W",319).
component("YMR105C",866).
component("YKL127W",741).
component("YEL058W",451).
component("YPR060C",1079).
component("YHR072W",609).
component("YJL153C",688).
component("YPL097W",1039).
component("YGR185C",568).
component("YGR264C",583).
component("YGR171C",564).
component("YHR011W",596).
component("YDR023W",369).
component("YPL104W",1040).
component("YLL018C",777).
component("YPR081C",1086).
component("YBR121C",269).
component("YHR020W",599).
component("YER087W",479).
component("YNL247W",916).
component("YOL033W",951).
component("YGL245W",540).
component("YOR168W",992).
component("YOL097C",964).
component("YDR268W",407).
component("YPR047W",1078).
component("YLR060W",790).
component("YFL022C",496).
component("YPR033C",1076).
component("YHR019C",597).
component("YCR024C",310).
component("YHR019C",598).
component("YKL194C",756).
component("YIL078W",641).
component("YPL160W",1044).
component("YLR382C",830).
component("YPL040C",1034).
component("YBL076C",238).
component("YNL073W",903).
component("YDR037W",371).
component("YOR335C",1014).
component("YGR094W",556).
component("YLR153C",799).
component("YAL054C",220).
component("YOR317W",1010).
component("YMR246W",884).
component("YIL009W",632).
component("YER015W",457).
component("YOR142W",989).
component("YGR244C",578).
component("YPR035W",1077).
component("YIL145C",652).
component("U89_",205).
component("YOR339C",1015).
component("YMR022W",859).
component("YLR306W",819).
component("YKL210W",758).
component("YGR133W",560).
component("YGL058W",524).
component("YER100W",485).
component("YEL012W",442).
component("YDR177W",398).
component("YDR092W",384).
component("YDR059C",379).
component("YDR054C",377).
component("YDL064W",328).
component("YBR082C",258).
component("YJL101C",678).
component("YOL049W",952).
component("U92_",209).
component("YAR015W",222).
component("YGL234W",538).
component("YER183C",492).
component("U91_",208).
component("U90_",207).
component("YNR057C",944).
component("YDL141W",346).
component("YDL141W",347).
component("YGL234W",539).
component("YDL141W",348).
component("YJR103W",716).
component("YBL039C",232).
component("YGR204W",575).
component("YBR084W",261).
component("YNL220W",914).
component("YOL058W",957).
component("YBR208C",281).
component("YDL141W",349).
component("YHR074W",610).
component("YMR217W",881).
component("YGR061C",552).
component("YPR145W",1091).
component("YGR124W",559).
component("YJR109C",718).
component("YJL130C",684).
component("YGL062W",525).
component("YBR218C",282).
component("YPL231W",1060).
component("YNR016C",936).
component("YKL182W",752).
component("YGR037C",548).
component("YJL087C",675).
component("YPR138C",1090).
component("YPL274W",1067).
component("YPL265W",1063).
component("YPL134C",1042).
component("YPL057C",1035).
component("YPL036W",1033).
component("YOR348C",1019).
component("YOR222W",1005).
component("YOR192C",998).
component("YOR171C",993).
component("YOR130C",986).
component("YOR100C",981).
component("YOR071C",977).
component("YOR011W",973).
component("YOL156W",972).
component("YOL103W",965).
component("YOL020W",950) :- not remove_orf("YOL020W",950).
component("YNR072W",946).
component("YNR056C",943).
component("YNL318C",931).
component("YNL270C",924).
component("YNL268W",923).
component("YNL142W",909).
component("YMR272C",888).
component("YMR202W",878).
component("YMR056C",861).
component("YMR011W",857).
component("YLR348C",825).
component("YLR260W",811).
component("YLR237W",807).
component("YLR138W",796).
component("YLR100C",794).
component("YLR081W",792).
component("YLL061W",781).
component("YLL043W",779).
component("YKR093W",773).
component("YKR053C",768).
component("YKR039W",767) :- not remove_orf("YKR039W",767).
component("YKL217W",762).
component("YKL120W",740).
component("YKL004W",729).
component("YJR158W",726).
component("YJR095W",715).
component("YJR077C",713).
component("YJL219W",698).
component("YJL214W",696).
component("YJL134W",685).
component("YJL129C",682).
component("YIL134W",650).
component("YHR096C",613).
component("YHR094C",612).
component("YHR092C",611).
component("YHL036W",592).
component("YGR121C",557).
component("YGR065C",553).
component("YGR055W",550).
component("YGL186C",533).
component("YGL077C",528).
component("YGL008C",514).
component("YFL055W",500).
component("YFL011W",494).
component("YER060W-A",467).
component("YER060W",466).
component("YER056C",465).
component("YER053C",463).
component("YEL069C",453).
component("YEL063C",452).
component("YEL017C-A",443).
component("YDR536W",438).
component("YDR508C",434).
component("YDR503C",433).
component("YDR497C",431).
component("YDR345C",415).
component("YDR343C",414).
component("YDR342C",413).
component("YDR297W",410).
component("YDR284C",408).
component("YDR046C",374) :- not remove_orf("YDR046C",374).
component("YDL245C",364).
component("YDL210W",359).
...
catalyst(6160,891).
catalyst(3870,464).
catalyst(3620,417) :- not remove_reaction(3620,417).
catalyst(2110,509).
catalyst(2190,509).
catalyst(5550,720).
catalyst(5301,137).
...
catalyst(1890,481) :- not remove_reaction(1890,481).
catalyst(3630,481) :- not remove_reaction(3630,481).
catalyst(3740,392).
catalyst(8231,1070).
catalyst(8232,1070).
catalyst(8231,1028).
...
catalyst(8061,1062).
catalyst(8062,1062).
catalyst(3590,520) :- not remove_reaction(3590,520).
catalyst(10910,520) :- not remove_reaction(10910,520).
catalyst(4570,561).
catalyst(8181,817).
catalyst(8182,817).
catalyst(8181,695).
...
catalyst(8282,376).
catalyst(3840,633).
catalyst(3610,366) :- not remove_reaction(3610,366).
catalyst(7921,980).
catalyst(7922,980).
catalyst(7841,454).
catalyst(7842,454).
...
catalyst(1210,972).
catalyst(1160,965).
catalyst(801,950) :- not remove_reaction(801,950).
catalyst(802,950) :- not remove_reaction(802,950).
catalyst(811,950) :- not remove_reaction(811,950).
catalyst(812,950) :- not remove_reaction(812,950).
catalyst(831,950) :- not remove_reaction(831,950).
catalyst(832,950) :- not remove_reaction(832,950).
catalyst(901,950) :- not remove_reaction(901,950).
catalyst(902,950) :- not remove_reaction(902,950).
catalyst(1180,946).
catalyst(1210,946).
catalyst(700,943).
catalyst(1200,931).
...
catalyst(851,767) :- not remove_reaction(851,767).
catalyst(852,767) :- not remove_reaction(852,767).
...
catalyst(931,767) :- not remove_reaction(931,767).
catalyst(932,767) :- not remove_reaction(932,767).
...
catalyst(6650,410).
catalyst(6690,408).
catalyst(791,374) :- not remove_reaction(791,374).
catalyst(792,374) :- not remove_reaction(792,374).
catalyst(801,374) :- not remove_reaction(801,374).
catalyst(802,374) :- not remove_reaction(802,374).
catalyst(811,374) :- not remove_reaction(811,374).
catalyst(812,374) :- not remove_reaction(812,374).
catalyst(831,374) :- not remove_reaction(831,374).
catalyst(832,374) :- not remove_reaction(832,374).
catalyst(841,374) :- not remove_reaction(841,374).
catalyst(842,374) :- not remove_reaction(842,374).
catalyst(851,374) :- not remove_reaction(851,374).
catalyst(852,374) :- not remove_reaction(852,374).
catalyst(901,374) :- not remove_reaction(901,374).
catalyst(902,374) :- not remove_reaction(902,374).
catalyst(1180,364).
catalyst(1210,364).
catalyst(690,359).
catalyst(730,359).
...
modifiable_enzyme(417).
modifiable_enzyme(759).
modifiable_enzyme(760).
modifiable_enzyme(481).
modifiable_enzyme(520).
modifiable_enzyme(366).
modifiable_enzyme(950).
