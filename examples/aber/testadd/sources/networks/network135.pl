...
component("YNL280C",724).
component("YLR056W",621).
component("YGR060W",431).
component("YGL012W",402).
component("YKR009C",602).
component("YOL086C",752).
component("YMR303C",697).
component("YMR083W",680).
component("YGL256W",424).
component("YDL168W",276).
component("YBR145W",209).
component("YPL231W",816).
...
component("YLR432W",657).
component("YHR216W",497).
component("YAR075W",179).
component("YAR073W",178).
component("YDR127W",303).
component("YJR139C",571).
component("YML075C",669).
component("YLR450W",660).
component("YOL126C",758).
component("YKL085W",582).
component("YDL078C",259).
component("YKL029C",578).
component("YNL037C",702).
component("YNL009W",700).
component("YLR174W",634).
component("YHR183W",490).
component("YGR256W",453).
component("YNL241C",717).
component("YOL059W",749).
component("YDL022W",252).
component("YCL018W",235).
component("YLR355C",652).
component("YIL074C",503).
component("YER081W",373).
component("YDL174C",280).
component("YML086C",671).
component("YIL155C",515).
component("YEL024W",349).
component("YKR066C",607).
component("YGR088W",435).
component("YDR256C",317).
component("YKL026C",577).
component("YIR037W",525).
component("YBR244W",222).
component("YJR078W",564).
component("U58_",133).
component("YJR025C",556).
component("U107_",24).
component("YGR255C",452).
component("U108_",25).
component("YHR007C",464).
component("YDR402C",331).
component("YGL055W",409).
component("YJR104C",566).
component("YHR008C",465).
component("YOR384W",795).
component("YOR381W",794).
component("YOL152W",760).
component("YLL051C",614).
component("YJL026W",527).
component("YIL066C",502).
component("YGR180C",442).
component("YER070W",370).
component("U37_",117).
component("U36_",116).
component("U35_",115).
component("YDL168W",277).
component("YDR158W",311).
component("YJR009C",553).
component("YJL052W",529).
component("YGR192C",444).
component("YBR006W",189).
component("YPL276W",824).
component("YPL275W",823).
component("YOR388C",796).
component("YPL061W",801).
component("YOR374W",792).
component("YER073W",371).
component("YGL154C",416).
component("YBR115C",205).
component("U55_",132).
component("YER069W",368).
component("YOR323C",784).
component("YMR170C",689).
component("YMR169C",688).
component("YER178W",383).
component("YBR221C",220).
component("YIL125W",511).
component("U52_",129).
component("YBR166C",214).
component("YNL280C",725).
component("YGL012W",403).
component("YKL182W",592).
component("YKL216W",601).
component("YDR044W",293).
component("YKR009C",603).
component("YIL160C",516).
component("YGL205W",421).
component("YMR118C",683).
component("YLR164W",632).
component("YLL041C",613).
component("YKL148C",587).
component("YKL141W",585).
component("YJL045W",528).
component("YDR178W",312).
component("YEL047C",352).
component("YDL171C",278).
component("YDL171C",279).
component("YOR375C",793).
component("YDL215C",284).
component("YAL062W",175).
component("U99_",169).
component("U100_",20).
component("YBR035C",196).
component("YKR080W",609).
component("YER023W",359).
component("YOR236W",782).
component("YGR204W",446).
component("YIR034C",524).
component("YLR142W",629).
component("U65_",140).
component("U63_",138).
component("U62_",137).
component("YHR068W",475).
component("YKL150W",588).
component("YIL043C",500).
component("YHR042W",470).
component("YOR221C",779).
component("YMR145C",686).
component("YKL192C",595).
component("YKL055C",580).
component("YER061C",366).
component("YDL085W",261).
component("YPL171C",809).
component("YHR179W",489).
component("YMR145C",687).
component("YML120C",672).
component("YKL192C",596).
component("YDL085W",262).
component("YGR234W",448).
component("YFR030W",395).
component("YPL017C",798).
component("YFL018C",387).
component("YDR353W",327).
component("YPR167C",839).
component("YJR137C",570).
component("YNL052W",704).
component("YMR256C",695).
component("YLR395C",656).
component("YLR038C",619).
component("YIL111W",508).
component("YHR051W",474).
component("YGL191W",419).
component("YGL187C",418).
component("YDL067C",258).
component("Q0275",19).
component("Q0250",18).
component("YDR072C",298).
component("YPL266W",822).
component("YKR069W",608).
component("YOL096C",753).
component("U47_",125).
component("YER091C",378).
component("YJR073C",562).
component("YGR157W",440).
component("YDR120C",301).
component("YML008C",662).
component("YOR074C",765).
component("YDL033C",254).
component("YOL096C",754).
component("YLR172C",633).
component("YLR058C",622).
component("YDR019C",290).
component("YBR176W",215).
component("YDR408C",333).
component("YMR120C",684).
component("YLR028C",617).
component("YBL013W",180).
component("YJL130C",538).
component("YJL088W",532).
component("YKL024C",576).
component("YPR074C",834).
component("YBR117C",206).
component("YMR108W",682).
component("YCL009C",234).
component("YNL071W",706).
component("YNR008W",730).
component("YIL160C",517).
component("YNR019W",733).
component("YCR048W",248).
component("U48_",126).
component("YMR062C",679).
component("YDR232W",314).
component("YPL231W",817).
component("YER061C",367).
component("YDL052C",257).
component("U8_",163).
component("YDR148C",309).
component("YPL231W",818).
component("YPL028W",799).
component("YLR299W",644).
component("YGL017W",404).
component("YCR005C",240).
component("YML126C",673).
component("YNL104C",709).
component("YDL182W",281).
component("YDL131W",267).
component("YDR307W",323).
component("YLR258W",641).
component("YFR015C",393).
component("YNL029C",701).
component("YIL085C",505).
component("YNL192W",715).
component("YBR038W",197).
component("YBR023C",194).
component("YMR306W",698).
component("YLR342W",650).
component("YGR032W",428).
component("YPR183W",841).
component("YBR248C",223).
component("YLR209C",636).
component("U104_",21).
component("YDR354W",328) :- not remove_orf("YDR354W",328).
component("YFR047C",396).
component("YJR133W",569).
component("YLR209C",637).
component("YML022W",664).
component("YDR441C",336).
component("YHR128W",484).
component("YJL167W",545).
component("YJL167W",546).
component("YPR069C",831).
component("YDR127W",304).
component("YHR190W",492).
component("YLR146C",630).
component("YHR068W",476).
component("YLR303W",646).
component("YGR012W",426).
component("YML082W",670).
component("YJR130C",568).
component("YDR035W",292).
component("YBR249C",224).
component("YLR180W",635).
component("YDR502C",340).
component("YOR274W",783).
component("YBR256C",226).
component("YHR137W",485).
component("YGL202W",420).
component("YLR027C",616).
component("YKL106W",583).
component("YOL140W",759).
component("YLR438W",659).
component("YGR019W",427).
component("YLR089C",625).
component("U64_",139).
component("U61_",136).
component("U51_",128).
component("YJR148W",572).
component("YHR208W",495).
component("YFL030W",389).
component("YOR184W",774).
component("YNR058W",739).
component("YIL116W",510).
component("YGL253W",423).
component("YFR053C",397).
component("YMR013C",677).
component("YMR205C",691).
component("YGR240C",449).
component("YOL016C",743).
component("YFR014C",392).
component("YLR240W",639).
component("YKL203C",598).
component("YJR066W",561).
component("YCR036W",247).
component("YCL040W",237).
component("U15_",58).
component("YPL188W",811).
component("YJR049C",558).
component("YEL041W",350).
component("U96_",167).
component("YKL001C",575).
component("YDR236C",315).
component("YHL032C",462).
component("YDR531W",344).
component("U83_",158).
component("U82_",157).
component("U81_",156).
component("YMR208W",692).
component("YPL203W",812).
component("YOR061W",764).
component("YKL166C",590).
component("YJL164C",544).
component("YIL035C",499).
component("YHR205W",494).
component("YHR102W",482).
component("YGL019W",405).
component("YHR025W",469).
component("YOR347C",789).
component("YAL038W",173).
component("YNR012W",731).
component("YDR009W",289).
component("YDR127W",305).
component("YDR147W",308).
component("YDR300C",322).
component("YCR012W",241).
component("YER069W",369).
component("U19_",90).
component("U18_",81).
component("U17_",72).
component("U76_",150).
component("YER170W",382).
component("YDR226W",313).
component("YKL067W",581).
component("YOL055C",746).
component("YDR454C",337).
component("YJR057W",559).
component("YOL061W",750).
component("YKL181W",591).
component("YHL011C",460).
component("YER099C",379).
component("YBL068W",187).
component("YOR143C",770).
component("YNL256W",720).
component("YLR328W",648).
component("YBR018C",191).
component("YGR007W",425).
component("YGR202C",445).
component("YLR328W",649).
component("U80_",155).
component("YDL103C",266).
component("U94_",166).
component("YJR010W",554).
component("YBR029C",195).
component("YCL050C",238).
component("YGL130W",414).
component("YDR530C",343).
component("YPR190C",843).
component("YPR187W",842).
component("YPR110C",836).
component("YPR010C",827).
component("YOR341W",788).
component("YOR340C",787).
component("YOR224C",781).
component("YOR210W",778).
component("YOR207C",776).
component("YOR151C",771).
component("YOR116C",767).
component("YOL005C",741).
component("YNR003C",729).
component("YNL248C",719).
component("YNL151C",713).
component("YNL113W",710).
component("YKL144C",586).
component("YJR063W",560).
component("YJL148W",542).
component("YJL140W",541).
component("YIL021W",498).
component("YHR143W-A",486).
component("YGL070C",412).
component("YFL036W",390).
component("YDR404C",332).
component("YDR156W",310).
component("YDR045C",294).
component("YDL150W",275).
component("YDL140C",269).
component("YBR154C",213).
component("YPR175W",840).
component("YPL167C",808).
component("YOR330C",785).
component("YOL115W",757).
component("YNL299W",727).
component("YNL262W",722).
component("YNL102W",708).
component("YJR043C",557).
component("YJR006W",552).
component("YJL090C",533).
component("YIL139C",513).
component("YEL055C",353).
component("YDR419W",334).
component("YDR121W",302).
component("YDL102W",265).
component("YCR014C",242).
component("YBR278W",229).
component("YBL035C",183).
component("YKL035W",579).
component("YHL012W",461).
component("YHR123W",483).
component("YPR113W",837).
component("YBR243C",221).
component("YDL142C",274).
component("YPL148C",806).
component("YER026C",360).
component("YGR286C",457).
component("YHR189W",491).
component("YDR058C",297).
component("YDL086W",263).
component("YOL011W",742).
component("YMR008C",675).
component("YMR006C",674).
component("U105_",22).
component("YBL015W",181).
component("YJL068C",530).
component("YOR040W",763).
component("U77_",151).
component("YDR481C",338).
component("YLR377C",654).
component("YPL179W",810).
component("YNR032W",734).
component("YML057W",668).
component("YML016C",663).
component("YLR433C",658).
component("YGR123C",438).
component("YER133W",380).
component("YER089C",376).
component("YDR436W",335).
component("YDR075W",299).
component("YDL188C",282).
component("YDL134C",268).
component("YDL047W",256).
component("YDL006W",250).
component("YBR125C",208).
component("YBL056W",186).
component("YPR073C",832).
component("YHR215W",496).
component("YDL024C",253).
component("YBR093C",203).
component("YBR092C",202).
component("YAR071W",177).
component("YHR046C",473).
component("U9_",170).
component("YPL228W",815).
component("YMR180C",690).
component("YDL236W",286).
component("YJL155C",543).
component("YPR073C",833).
component("YOR208W",777).
component("YNL053W",705).
component("YMR036C",678).
component("YIR026C",523).
component("YIL113W",509).
component("YFR028C",394).
component("YER075C",372).
...
component("U25_",105).
component("U24_",104).
component("YHR044C",472).
component("YHR043C",471).
component("YOL064C",751).
component("YOR360C",791).
component("YKR031C",604).
component("YPL206C",813).
component("YGL027C",407).
component("YLR286C",643).
component("YJR153W",573).
component("YJL221C",551).
component("YJL216C",549).
component("YIL172C",521).
component("YGR292W",459).
component("YGR287C",458).
component("YBR299W",233).
component("YBR184W",216).
component("YIL162W",518).
component("YIR019C",522).
component("YIL099W",507).
component("YDL037C",255).
component("YOR190W",775).
component("YLR300W",645).
component("YGR282C",456).
component("YDR261C",318).
component("YDR400W",330).
component("YML035C",665).
component("YJL070C",531).
component("YBR284W",230).
component("U106_",23).
component("YER043C",361).
component("YNL045W",703).
component("YGL037C",408).
component("YDR242W",316).
component("YBR208C",218).
component("U53_",130).
component("YPR062W",830).
component("YMR120C",685).
component("YLR028C",618).
component("YHR144C",487).
component("YGR267C",455).
component("YBL033C",182).
component("YBR153W",212).
component("YNL141W",711).
component("YLR245C",640).
component("YML035C",666).
...
component("U40_",120).
component("U39_",118).
component("YBR011C",190).
component("YHR201C",493).
component("YBR111C",204).
component("YBR252W",225).
component("YER005W",358).
component("YIL048W",501).
component("YER166W",381).
component("YDR093W",300).
component("YAL026C",172).
component("YBL099W",188).
component("U60_",135).
component("YLR231C",638).
component("U88_",161).
component("YDR538W",346).
component("YLR134W",627).
component("YLR044C",620).
component("YGR087C",434).
component("YDR380W",329).
component("YDL080C",260).
component("U98_",168).
component("YMR250W",694).
component("YOR128C",768).
component("YEL021W",348).
component("YNR043W",736).
component("U93_",165).
component("U54_",131).
component("YKL211C",599) :- not remove_orf("YKL211C",599).
component("YKR097W",611).
component("YNL169C",714).
component("YNL256W",721).
component("YDR294C",320).
component("YEL046C",351).
component("YNR033W",735).
component("YKL211C",600) :- not remove_orf("YKL211C",600).
component("YER090W",600) :- not remove_orf("YER090W",600).
component("YER090W",377) :- not remove_orf("YER090W",377).
component("YDR127W",306).
component("YPL281C",825).
component("YOR393W",797).
component("YMR323W",699).
component("YHR174W",488).
component("YGR254W",451).
component("YPL262W",820).
component("YGL026C",406) :- not remove_orf("YGL026C",406).
component("YGR155W",439).
component("YLR304C",647).
component("YJL200C",547).
component("YNL316C",728).
component("YKL182W",593).
component("YPL212C",814).
component("YNL292W",726).
component("YGL063W",411).
component("YFL001W",385).
component("YPR002W",826).
component("YJR016C",555).
component("YCR053W",249).
component("YDR127W",307).
component("YGL148W",415).
component("YIL168W",520).
component("YIL167W",519).
component("YCL064C",239).
component("YER086W",374).
component("YLR359W",653).
component("YAL012W",171).
component("YML004C",661).
component("YFR055W",398).
component("YJL005W",526).
component("YJL121C",535).
component("YBR019C",192).
component("YDR050C",296).
component("YDR007W",288) :- not remove_orf("YDR007W",288).
component("YOR095C",766).
component("YER003C",357).
component("YBR196C",217).
component("YGL001C",400).
component("YPL117C",804).
component("U14_",50).
component("YOL056W",747).
component("YKL152C",589).
component("YDL021W",251).
component("YMR105C",681).
component("YKL127W",584).
component("YEL058W",354).
component("YPR060C",829).
component("YHR072W",477).
component("YPL097W",802).
component("YGR185C",443).
component("YGR264C",454).
component("YGR171C",441).
component("YHR011W",466).
component("YDR023W",291).
component("YPL104W",803).
component("YLL018C",612).
component("YPR081C",835).
component("YBR121C",207).
component("YHR020W",468).
component("YER087W",375).
component("YNL247W",718).
component("YOR168W",772).
component("YOL097C",755).
component("YDR268W",319).
component("YPR047W",828).
component("YLR060W",623).
component("YFL022C",388).
component("YCR024C",243).
component("YHR019C",467).
component("YKL194C",597).
component("YIL078W",504).
component("YPL160W",807).
component("YLR382C",655).
component("YNL073W",707).
component("YOR335C",786).
component("YGR094W",436).
component("YLR153C",631).
component("YAL054C",174).
component("YGR244C",450).
component("YIL145C",514).
component("U89_",162).
component("YJL101C",534).
component("YOL049W",745).
component("YAR015W",176).
component("YER183C",384).
component("U90_",164).
component("YNR057C",738).
component("YDL141W",270).
component("YDL141W",271).
component("YGL234W",422).
component("YDL141W",272).
component("YJR103W",565).
component("YBL039C",184).
component("YGR204W",447).
component("YBR084W",201).
component("YNL220W",716).
component("YOL058W",748).
component("YDL141W",273).
component("YHR074W",478).
component("YMR217W",693).
component("YGR061C",432).
component("YJR109C",567).
component("YJL130C",539).
component("YGL062W",410).
component("YBR218C",219).
component("YPL231W",819).
component("YNR016C",732).
component("YKL182W",594).
component("YGR037C",429).
component("YPR138C",838).
component("YPL265W",821).
component("YPL134C",805).
component("YPL036W",800).
component("YOR348C",790).
component("YOR222W",780).
component("YOR171C",773).
component("YOR130C",769).
component("YOR011W",762).
component("YOL156W",761).
component("YOL103W",756).
component("YOL020W",744) :- not remove_orf("YOL020W",744).
component("YNR072W",740).
component("YNR056C",737).
component("YNL270C",723).
component("YNL142W",712).
component("YMR272C",696).
component("YMR011W",676).
component("YLR348C",651).
component("YLR260W",642).
component("YLR138W",628).
component("YLR100C",626).
component("YLR081W",624).
component("YLL061W",615).
component("YKR093W",610).
component("YKR053C",606).
component("YKR039W",605) :- not remove_orf("YKR039W",605).
component("YJR158W",574).
component("YJR077C",563).
component("YJL219W",550).
component("YJL214W",548).
component("YJL134W",540).
component("YJL129C",537).
component("YIL134W",512).
component("YHR096C",481).
component("YHR094C",480).
component("YHR092C",479).
component("YHL036W",463).
component("YGR121C",437).
component("YGR065C",433).
component("YGR055W",430).
component("YGL186C",417).
component("YGL077C",413).
component("YGL008C",401).
component("YFL055W",391).
component("YFL011W",386).
component("YER060W-A",365).
component("YER060W",364).
component("YER056C",363).
component("YER053C",362).
component("YEL069C",356).
component("YEL063C",355).
component("YEL017C-A",347).
component("YDR536W",345).
component("YDR508C",342).
component("YDR503C",341).
component("YDR497C",339).
component("YDR345C",326).
component("YDR343C",325).
component("YDR342C",324).
component("YDR297W",321).
component("YDR046C",295) :- not remove_orf("YDR046C",295).
component("YDL245C",287).
component("YDL210W",283).
component("YCR032W",246).
component("YCR028C",245).
component("YCR024C-A",244).
component("YCL025C",236).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,328) :- not remove_reaction(3620,328).
catalyst(2110,396).
catalyst(2190,396).
catalyst(5550,569).
catalyst(5791,637).
...
catalyst(2300,165).
catalyst(3460,131).
catalyst(3600,599) :- not remove_reaction(3600,599).
catalyst(8000,611).
catalyst(6890,714).
catalyst(2570,721).
catalyst(8781,320).
...
catalyst(4560,351).
catalyst(2550,735).
catalyst(1890,600) :- not remove_reaction(1890,600).
catalyst(3630,600) :- not remove_reaction(3630,600).
catalyst(1890,377) :- not remove_reaction(1890,377).
catalyst(3630,377) :- not remove_reaction(3630,377).
catalyst(3740,306).
catalyst(8231,825).
catalyst(8232,825).
catalyst(8231,797).
...
catalyst(1210,761).
catalyst(1160,756).
catalyst(801,744) :- not remove_reaction(801,744).
catalyst(802,744) :- not remove_reaction(802,744).
catalyst(811,744) :- not remove_reaction(811,744).
catalyst(812,744) :- not remove_reaction(812,744).
catalyst(831,744) :- not remove_reaction(831,744).
catalyst(832,744) :- not remove_reaction(832,744).
catalyst(901,744) :- not remove_reaction(901,744).
catalyst(902,744) :- not remove_reaction(902,744).
catalyst(1180,740).
catalyst(1210,740).
catalyst(700,737).
catalyst(931,723).
...
catalyst(640,610).
catalyst(6560,606).
catalyst(771,605) :- not remove_reaction(771,605).
catalyst(772,605) :- not remove_reaction(772,605).
catalyst(781,605) :- not remove_reaction(781,605).
catalyst(782,605) :- not remove_reaction(782,605).
catalyst(801,605) :- not remove_reaction(801,605).
catalyst(802,605) :- not remove_reaction(802,605).
catalyst(811,605) :- not remove_reaction(811,605).
catalyst(812,605) :- not remove_reaction(812,605).
catalyst(831,605) :- not remove_reaction(831,605).
catalyst(832,605) :- not remove_reaction(832,605).
catalyst(841,605) :- not remove_reaction(841,605).
catalyst(842,605) :- not remove_reaction(842,605).
catalyst(851,605) :- not remove_reaction(851,605).
catalyst(852,605) :- not remove_reaction(852,605).
catalyst(881,605) :- not remove_reaction(881,605).
catalyst(882,605) :- not remove_reaction(882,605).
catalyst(901,605) :- not remove_reaction(901,605).
catalyst(902,605) :- not remove_reaction(902,605).
catalyst(911,605) :- not remove_reaction(911,605).
catalyst(912,605) :- not remove_reaction(912,605).
catalyst(921,605) :- not remove_reaction(921,605).
catalyst(922,605) :- not remove_reaction(922,605).
catalyst(931,605) :- not remove_reaction(931,605).
catalyst(932,605) :- not remove_reaction(932,605).
catalyst(1191,605) :- not remove_reaction(1191,605).
catalyst(1192,605) :- not remove_reaction(1192,605).
catalyst(1180,574).
catalyst(1210,574).
catalyst(1581,563).
catalyst(1582,563).
...
catalyst(1210,324).
catalyst(6650,321).
catalyst(801,295) :- not remove_reaction(801,295).
catalyst(802,295) :- not remove_reaction(802,295).
catalyst(811,295) :- not remove_reaction(811,295).
catalyst(812,295) :- not remove_reaction(812,295).
catalyst(831,295) :- not remove_reaction(831,295).
catalyst(832,295) :- not remove_reaction(832,295).
catalyst(841,295) :- not remove_reaction(841,295).
catalyst(842,295) :- not remove_reaction(842,295).
catalyst(851,295) :- not remove_reaction(851,295).
catalyst(852,295) :- not remove_reaction(852,295).
catalyst(901,295) :- not remove_reaction(901,295).
catalyst(902,295) :- not remove_reaction(902,295).
catalyst(1180,287).
catalyst(1210,287).
catalyst(730,283).
catalyst(431,246).
...
catalyst(851,199) :- not remove_reaction(851,199).
catalyst(852,199) :- not remove_reaction(852,199).
...
catalyst(851,198) :- not remove_reaction(851,198).
catalyst(852,198) :- not remove_reaction(852,198).
