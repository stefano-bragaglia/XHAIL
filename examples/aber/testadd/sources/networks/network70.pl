...
component("YLR056W",378).
component("YGL012W",243).
component("YKR009C",364).
component("YOL086C",458).
component("YMR303C",419).
component("YGL256W",261).
component("YDL168W",168).
component("YBR145W",129).
component("YPL231W",499).
component("U46_",76).
component("YBR149W",130).
component("YGL001C",240).
component("YIL094C",309).
component("U45_",75).
component("YML056C",408).
component("YLR432W",405).
component("YHR216W",304).
component("YAR075W",108).
component("YAR073W",107).
component("YDR127W",181).
component("YOL126C",462).
component("YKL085W",354).
component("YDL078C",160).
component("YNL037C",424).
component("YNL009W",422).
component("YLR174W",386).
component("YCL018W",145).
component("YLR355C",401).
component("YDL174C",171).
component("YML086C",409).
component("YGR088W",269).
component("YDR256C",191).
component("YJR078W",344).
component("YJR025C",337).
component("U107_",23).
component("YJR104C",346).
component("YHR008C",287).
component("YJL026W",321).
component("YIL066C",307).
component("YGR180C",272).
component("YER070W",221).
component("U36_",69).
component("YDL168W",169).
component("YBR006W",116).
component("YPL276W",507).
component("YPL275W",506).
component("YOR388C",485).
component("U55_",82).
component("YER069W",220).
component("YOR323C",478).
component("YER178W",227).
component("YBR221C",136).
component("YIL125W",312).
component("U52_",80).
component("YBR166C",132).
component("YGL012W",244).
component("YKL216W",363).
component("YKR009C",365).
component("YIL160C",315).
component("YGL205W",258).
component("YDL171C",170).
component("U99_",102).
component("U100_",20).
component("YKR080W",370).
component("YER023W",214).
component("YGR204W",274).
component("YLR142W",383).
component("U65_",86).
component("U62_",85).
component("YHR068W",295).
component("YKL150W",357).
component("YIL043C",306).
component("YPL171C",495).
component("YHR179W",302).
component("YGR234W",276).
component("YFR030W",237).
component("YPL017C",487).
component("YFL018C",230).
component("YDR353W",195).
component("YPR167C",519).
component("YJR137C",348).
component("YNL052W",425).
component("YMR256C",418).
component("YLR395C",404).
component("YLR038C",376).
component("YIL111W",310).
component("YHR051W",294).
component("YGL191W",256).
component("YGL187C",255).
component("YDL067C",159).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",505).
component("YKR069W",369).
component("U47_",77).
component("YJR073C",342).
component("YDL033C",158).
component("YLR172C",385).
component("YLR058C",379).
component("YDR019C",176).
component("YBR176W",133).
component("YDR408C",200).
component("YMR120C",414).
component("YLR028C",374).
component("YBL013W",109).
component("YJL130C",327).
component("YKL024C",352).
component("YPR074C",515).
component("YBR117C",128).
component("YCL009C",144).
component("YNL071W",427).
component("YIL160C",316).
component("U48_",78).
component("YPL231W",500).
component("YPL231W",501).
component("YPL028W",488).
component("YLR299W",394).
component("YGL017W",245).
component("YML126C",410).
component("YNL104C",429).
component("YDL182W",172).
component("YDL131W",164).
component("YLR258W",391).
component("YFR015C",235).
component("YNL029C",423).
component("YIL085C",308).
component("YMR306W",420).
component("YLR342W",400).
component("YGR032W",264).
component("YLR209C",387).
component("U104_",21).
component("YDR354W",196) :- not remove_orf("YDR354W",196).
component("YFR047C",238).
component("YLR209C",388).
component("YML022W",406).
component("YDR441C",202).
component("YJL167W",331).
component("YDR127W",182).
component("YHR068W",296).
component("YLR303W",396).
component("YGR012W",262).
component("YJR130C",347).
component("YDR035W",177).
component("YBR249C",137).
component("YOR274W",477).
component("YHR137W",298).
component("YGL202W",257).
component("YLR027C",373).
component("YKL106W",355).
component("YOL140W",463).
component("YGR019W",263).
component("YLR089C",380).
component("U61_",84).
component("YJR148W",349).
component("YFL030W",231).
component("YNR058W",449).
component("YGL253W",260).
component("YFR053C",239).
component("YMR205C",416).
component("YGR240C",277).
component("YOL016C",452).
component("YFR014C",234).
component("YCR036W",154).
component("YCL040W",147).
component("YPL188W",496).
component("YJR049C",339).
component("YEL041W",209).
component("U96_",100).
component("YKL001C",351).
component("YDR236C",189).
component("YHL032C",285).
component("U83_",97).
component("YMR208W",417).
component("YHR025W",290).
component("YOR347C",483).
component("YAL038W",105).
component("YNR012W",445).
component("YDR127W",183).
component("YDR147W",186).
component("YCR012W",149).
component("U76_",94).
component("YER170W",226).
component("YDR226W",188).
component("YKL067W",353).
component("YOL055C",455).
component("YDR454C",203).
component("YJR057W",340).
component("YOL061W",457).
component("YKL181W",359).
component("YHL011C",284).
component("YER099C",225).
component("YBL068W",114).
component("YOR143C",468).
component("YNL256W",438).
component("YLR328W",398).
component("YBR018C",118).
component("YLR328W",399).
component("U94_",99).
component("YBR029C",120).
component("YGL130W",252).
component("YPR190C",522).
component("YPR187W",521).
component("YPR110C",516).
component("YPR010C",510).
component("YOR341W",482).
component("YOR340C",481).
component("YOR224C",476).
component("YOR210W",475).
component("YOR207C",473).
component("YOR151C",469).
component("YOR116C",466).
component("YOL005C",450).
component("YNR003C",444).
component("YNL248C",437).
component("YNL151C",433).
component("YNL113W",430).
component("YKL144C",356).
component("YJR063W",341).
component("YJL148W",330).
component("YJL140W",329).
component("YIL021W",305).
component("YHR143W-A",299).
component("YGL070C",250).
component("YFL036W",232).
component("YDR404C",199).
component("YDR156W",187).
component("YDR045C",178).
component("YDL150W",167).
component("YDL140C",165).
component("YBR154C",131).
component("YPR175W",520).
component("YPL167C",494).
component("YOR330C",479).
component("YOL115W",461).
component("YNL299W",442).
component("YNL262W",439).
component("YNL102W",428).
component("YJR043C",338).
component("YJR006W",335).
component("YJL090C",323).
component("YIL139C",313).
component("YEL055C",211).
component("YDR419W",201).
component("YDR121W",180).
component("YDL102W",163).
component("YCR014C",150).
component("YBR278W",140).
component("YBL035C",112).
component("YPR113W",517).
component("YPL148C",493).
component("YGR286C",281).
component("YOL011W",451).
component("YMR008C",412).
component("YMR006C",411).
component("U105_",22).
component("YBL015W",110).
component("U77_",95).
component("YLR377C",403).
component("YPR073C",513).
component("YHR215W",303).
component("YDL024C",157).
component("YBR093C",126).
component("YBR092C",125).
component("YHR046C",293).
component("U9_",103).
component("YDL236W",174).
component("YPR073C",514).
component("YOR208W",474).
component("YNL053W",426).
component("YMR036C",413).
component("YIR026C",320).
component("YIL113W",311).
component("YFR028C",236).
component("YER075C",222).
...
component("U25_",63).
component("U24_",62).
component("YHR044C",292).
component("YHR043C",291).
component("YOR360C",484).
component("YKR031C",366).
component("YPL206C",497).
component("YGL027C",247).
component("YLR286C",393).
component("YJR153W",350).
component("YJL221C",334).
component("YJL216C",333).
component("YIL172C",319).
component("YGR292W",283).
component("YGR287C",282).
component("YBR299W",143).
component("YOR190W",472).
component("YLR300W",395).
component("YGR282C",280).
component("YDR261C",192).
component("YDR400W",198).
component("YML035C",407).
component("YJL070C",322).
component("YBR284W",141).
component("YER043C",215).
component("YDR242W",190).
component("U53_",81).
component("YPR062W",512).
component("YMR120C",415).
component("YLR028C",375).
component("YHR144C",300).
component("YBL033C",111).
component("YNL141W",431).
component("YLR245C",390).
component("YBR084W",123).
component("YJL126W",325).
component("U44_",74).
component("YDL100C",162).
component("U40_",72).
component("U39_",70).
component("YBR011C",117).
component("YBR111C",127).
component("YBR252W",138).
component("YER005W",213).
component("YBL099W",115).
component("YLR231C",389).
component("YLR134W",382).
component("YLR044C",377).
component("YGR087C",268).
component("YDR380W",197).
component("YDL080C",161).
component("U98_",101).
component("YOR128C",467).
component("YKL211C",361) :- not remove_orf("YKL211C",361).
component("YKR097W",371).
component("YNL169C",434).
component("YEL046C",210).
component("YNR033W",447).
component("YKL211C",362) :- not remove_orf("YKL211C",362).
component("YER090W",362) :- not remove_orf("YER090W",362).
component("YER090W",224) :- not remove_orf("YER090W",224).
component("YDR127W",184).
component("YPL281C",508).
component("YOR393W",486).
component("YMR323W",421).
component("YHR174W",301).
component("YGR254W",278).
component("YPL262W",503).
component("YGL026C",246) :- not remove_orf("YGL026C",246).
component("YLR304C",397).
component("YJL200C",332).
component("YNL316C",443).
component("YPL212C",498).
component("YNL292W",441).
component("YGL063W",249).
component("YFL001W",229).
component("YPR002W",509).
component("YJR016C",336).
component("YCR053W",155).
component("YDR127W",185).
component("YGL148W",253).
component("YIL168W",318).
component("YIL167W",317).
component("YCL064C",148).
component("YLR359W",402).
component("YAL012W",104).
component("YBR019C",119).
component("YDR007W",175) :- not remove_orf("YDR007W",175).
component("YOR095C",465).
component("YBR196C",134).
component("YGL001C",241).
component("YPL117C",492).
component("U14_",34).
component("YOL056W",456).
component("YKL152C",358).
component("YDL021W",156).
component("YPR060C",511).
component("YPL097W",490).
component("YGR185C",273).
component("YGR264C",279).
component("YGR171C",271).
component("YPL104W",491).
component("YLL018C",372).
component("YHR020W",289).
component("YER087W",223).
component("YNL247W",436).
component("YOR168W",470).
component("YOL097C",459).
component("YDR268W",193).
component("YCR024C",151).
component("YHR019C",288).
component("YOR335C",480).
component("YLR153C",384).
component("YAL054C",106).
component("YIL145C",314).
component("YJL101C",324).
component("YOL049W",454).
component("YER183C",228).
component("U90_",98).
component("YNR057C",448).
component("YGL234W",259).
component("YJR103W",345).
component("YBL039C",113).
component("YGR204W",275).
component("YBR084W",124).
component("YNL220W",435).
component("YDL141W",166).
component("YHR074W",297).
component("YGL062W",248).
component("YBR218C",135).
component("YPL231W",502).
component("YNR016C",446).
component("YKL182W",360).
component("YGR037C",265).
component("YPR138C",518).
component("YPL265W",504).
component("YPL036W",489).
component("YOR171C",471).
component("YOR011W",464).
component("YOL103W",460).
component("YOL020W",453) :- not remove_orf("YOL020W",453).
component("YNL270C",440).
component("YNL142W",432).
component("YLR260W",392).
component("YLR100C",381).
component("YKR053C",368).
component("YKR039W",367) :- not remove_orf("YKR039W",367).
component("YJR077C",343).
component("YJL134W",328).
component("YJL129C",326).
component("YHL036W",286).
component("YGR121C",270).
component("YGR065C",267).
component("YGR055W",266).
component("YGL186C",254).
component("YGL077C",251).
component("YGL008C",242).
component("YFL055W",233).
component("YER060W-A",219).
component("YER060W",218).
component("YER056C",217).
component("YER053C",216).
component("YEL063C",212).
component("YEL017C-A",208).
component("YDR536W",207).
component("YDR508C",206).
component("YDR503C",205).
component("YDR497C",204).
component("YDR297W",194).
component("YDR046C",179) :- not remove_orf("YDR046C",179).
component("YCR032W",153).
component("YCR024C-A",152).
component("YCL025C",146).
component("YBR298C",142).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,196) :- not remove_reaction(3620,196).
catalyst(2190,238).
catalyst(5791,388).
catalyst(5792,388).
catalyst(5801,388).
...
catalyst(6111,467).
catalyst(6112,467).
catalyst(3600,361) :- not remove_reaction(3600,361).
catalyst(8000,371).
catalyst(6890,434).
catalyst(4560,210).
catalyst(2550,447).
catalyst(3630,362) :- not remove_reaction(3630,362).
catalyst(3630,224) :- not remove_reaction(3630,224).
catalyst(3740,184).
catalyst(8231,508).
catalyst(8232,508).
catalyst(8231,486).
...
catalyst(8051,503).
catalyst(8052,503).
catalyst(3590,246) :- not remove_reaction(3590,246).
catalyst(10910,246) :- not remove_reaction(10910,246).
catalyst(8181,397).
catalyst(8182,397).
catalyst(8181,332).
catalyst(8182,332).
...
catalyst(901,453) :- not remove_reaction(901,453).
catalyst(902,453) :- not remove_reaction(902,453).
catalyst(931,440).
catalyst(932,440).
catalyst(371,432).
catalyst(372,432).
...
catalyst(6330,381).
catalyst(6560,368).
catalyst(771,367) :- not remove_reaction(771,367).
catalyst(772,367) :- not remove_reaction(772,367).
catalyst(781,367) :- not remove_reaction(781,367).
catalyst(782,367) :- not remove_reaction(782,367).
...
catalyst(881,367) :- not remove_reaction(881,367).
catalyst(882,367) :- not remove_reaction(882,367).
catalyst(901,367) :- not remove_reaction(901,367).
catalyst(902,367) :- not remove_reaction(902,367).
catalyst(931,367) :- not remove_reaction(931,367).
catalyst(932,367) :- not remove_reaction(932,367).
catalyst(1191,367) :- not remove_reaction(1191,367).
catalyst(1192,367) :- not remove_reaction(1192,367).
catalyst(1581,343).
catalyst(1582,343).
catalyst(6560,328).
catalyst(361,326).
...
catalyst(851,179) :- not remove_reaction(851,179).
catalyst(852,179) :- not remove_reaction(852,179).
