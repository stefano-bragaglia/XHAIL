...
component("YNL280C",844).
component("YLR056W",722).
component("YGR060W",500).
component("YGL012W",466).
component("YKR009C",699).
component("YOL086C",878).
component("YMR303C",816).
component("YMR083W",794).
component("YGL256W",492).
component("YDL168W",318).
component("YBR145W",244).
component("YPL231W",962).
component("YBR265W",263).
component("U46_",146).
component("YBR149W",245).
component("YBR149W",246).
component("YGL001C",462).
component("YIL094C",586).
component("YHR063C",550).
component("U45_",145).
component("YML056C",776).
component("YLR432W",765).
component("YHR216W",574).
...
component("YOL126C",884).
component("YKL085W",674).
component("YDL078C",300).
component("YKL029C",669).
component("YNL037C",821).
component("YNL009W",819).
component("YLR174W",736).
component("YHR183W",567).
component("YGR256W",528).
component("YNL241C",836).
component("YOL059W",875).
component("YDL022W",291).
component("YCL018W",271).
component("YLR355C",760).
component("YIL074C",583).
component("YER081W",433).
component("YML054C",775).
component("YDL174C",322).
component("YML086C",781).
component("YIL155C",596).
component("YEL024W",402).
component("YKR066C",704).
component("YGR088W",504).
component("YDR256C",366).
component("YKL026C",668).
component("YIR037W",607).
component("YBR244W",258).
component("YJR078W",652).
component("U58_",155).
component("YJR025C",643).
component("U107_",27).
component("YGR255C",527).
component("U108_",28).
component("YHR007C",539).
component("YDR402C",381).
component("YGL055W",473).
component("YJR104C",655).
component("YHR008C",540).
component("YOR384W",933).
component("YOR381W",932).
component("YOL152W",888).
component("YLL051C",714).
component("YJL026W",609).
component("YIL066C",582).
component("YGR180C",514).
component("YER070W",430).
component("U37_",139).
component("U36_",138).
component("U35_",137).
component("YDL168W",319).
component("YDR158W",359).
component("YJR009C",639).
component("YJL052W",611).
component("YGR192C",516).
component("YBR006W",218).
component("YPL276W",972).
component("YPL275W",971).
component("YOR388C",934).
component("YPL061W",942).
component("YOR374W",930).
component("YER073W",431).
component("YGL154C",482).
component("YBR115C",239).
component("U55_",154).
component("YER069W",428).
component("YOR323C",920).
component("YMR170C",804).
component("YMR169C",803).
component("YER178W",444).
component("YBR221C",256).
component("YIL125W",592).
component("U52_",151).
component("YBR166C",249).
component("YNL280C",845).
component("YGL012W",467).
component("YKL182W",686).
component("YKL216W",697).
component("YDR044W",337).
component("YER014W",412).
component("YKR009C",700).
component("YIL160C",597).
component("YGL205W",487).
component("YMR118C",798).
component("YLR164W",734).
component("YLL041C",712).
component("YKL148C",680).
component("YKL141W",678).
component("YJL045W",610).
component("YDR178W",361).
component("YJR051W",646).
component("YEL047C",405).
component("YDL171C",320).
component("YDL171C",321).
component("YOR375C",931).
component("YDL215C",326).
component("YAL062W",200).
component("U99_",194).
component("U100_",21).
component("YBR035C",227).
component("YMR189W",806).
component("YKR080W",706).
component("YER023W",414).
component("YPL023C",938).
component("YGL125W",479).
component("YOR236W",917).
component("YGR204W",519).
component("YIR034C",606).
component("YLR142W",731).
component("U65_",162).
component("U63_",160).
component("U62_",159).
component("YOR356W",928).
component("YHR068W",551).
component("YKL150W",681).
component("YIL043C",579).
component("YHR042W",545).
component("YOR221C",914).
component("YMR145C",801).
component("YML120C",782).
component("YKL192C",690).
component("YKL055C",671).
component("YER061C",424).
component("YDL085W",302).
component("YPL171C",951).
component("YHR179W",566).
component("YMR145C",802).
component("YML120C",783).
component("YKL192C",691).
component("YDL085W",303).
component("YGR234W",522).
component("YFR030W",458).
component("YPL017C",937).
component("YFL018C",448).
component("YPL091W",943).
component("YDR353W",376).
component("YER042W",416).
component("YPR167C",995).
component("YJR137C",659).
component("YNL052W",823).
component("YMR256C",813).
component("YLR395C",764).
component("YLR038C",720).
component("YIL111W",589).
component("YHR051W",549).
component("YGL191W",485).
component("YGL187C",484).
component("YDL067C",299).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",344).
component("YPL266W",969).
component("YPL273W",970).
component("YLL062C",716).
component("YDR410C",384).
component("YKR069W",705).
component("YOL096C",879).
component("U47_",147).
component("YER091C",438).
component("YJR073C",650).
component("YGR157W",511).
component("YDR120C",349).
component("YML008C",770).
component("YOR074C",894).
component("YDL033C",293).
component("YOL096C",880).
component("YLR172C",735).
component("YLR058C",723).
component("YDR019C",333).
component("YBR176W",250).
component("YDR408C",383).
component("YMR120C",799).
component("YLR028C",718).
component("YBL013W",205).
component("YJL130C",623).
component("YJL088W",616).
component("YKL024C",666).
component("YPR074C",986).
component("YBR117C",240).
component("YLR354C",759).
component("YGR043C",498).
component("YMR108W",797).
component("YCL009C",270).
component("YMR062C",792).
component("YNL071W",825).
component("YNR008W",851).
component("YIL160C",598).
component("YNR019W",854).
component("YCR048W",286).
component("U48_",148).
component("YMR062C",793).
component("YDR232W",363).
component("YPL231W",963).
component("YER061C",425).
component("YPL001W",936).
component("YDL052C",297).
component("U8_",187).
component("YDR148C",357).
component("YPL231W",964).
component("YPL028W",939).
component("YLR299W",747).
component("YGL017W",468).
component("YCR005C",278).
component("YML126C",784).
component("YNL104C",828).
component("YDL182W",323).
component("YDL131W",309).
component("YPR160W",994).
component("YDR307W",372).
component("YLR258W",744).
component("YFR015C",455).
component("YPL227C",960).
component("YNL029C",820).
component("YIL085C",585).
component("YNL192W",834).
component("YBR038W",229).
component("YBR023C",225).
component("YEL011W",398).
component("YMR306W",817).
component("YLR342W",757).
component("YGR032W",496).
component("YPR183W",998).
component("YBR248C",259).
component("YLR209C",738).
component("U104_",24).
component("U103_",23).
component("YOR209C",912).
component("YER055C",420).
component("YDR354W",377) :- not remove_orf("YDR354W",377).
component("YFR047C",459).
component("YJR133W",658).
component("U22_",124).
component("YLR209C",739).
component("YML022W",772).
component("YDR441C",387).
component("YHR128W",560).
component("YPR176C",997).
component("YPL172C",952).
component("YNR041C",858).
component("YMR101C",795).
component("YDL090C",305).
component("YBR003W",217).
component("YBR002C",216).
component("YJL167W",631).
component("YJL167W",632).
component("YNL256W",839).
component("YPR069C",983).
component("YDR127W",352).
component("YHR190W",569).
component("YLR146C",732).
component("YPL214C",958).
component("YHR068W",552).
component("YLR303W",749).
component("YGR012W",494).
component("YML082W",780).
component("YJR130C",657).
component("YLR303W",750).
component("YDR035W",335).
component("YBR249C",260).
component("YLR180W",737).
component("YDR502C",391).
component("YOR274W",918).
component("YOL143C",887).
component("YBR256C",262).
component("YHR137W",561).
component("YGL202W",486).
component("YLR027C",717).
component("YKL106W",675).
component("YOL140W",886).
component("YLR438W",767).
component("YGR019W",495).
component("YLR089C",727).
component("YDR111C",348).
component("U64_",161).
component("U61_",158).
component("U51_",150).
component("YJR148W",661).
component("YHR208W",572).
component("YFL030W",450).
component("YOR184W",905).
component("YNR058W",862).
component("YIL116W",591).
component("YGL253W",491).
component("YFR053C",460).
component("YOL136C",885).
component("YIL107C",588).
component("YMR013C",788).
component("YMR205C",808).
component("YGR240C",523).
component("YOL016C",866).
component("YFR014C",454).
component("YLR240W",742).
component("YKL203C",693).
component("YJR066W",649).
component("YCR036W",285).
component("YGR194C",517).
component("YCL040W",274).
component("U15_",68).
component("YPL188W",954).
component("YJR049C",645).
component("YEL041W",403).
component("U96_",192).
component("YKL001C",664).
component("YDR236C",364).
component("YML070W",778).
component("YFL053W",452).
component("YHL032C",537).
component("YDR531W",395).
component("U83_",181).
component("U82_",180).
component("U81_",179).
component("YMR208W",809).
component("YPL203W",955).
component("YOR061W",892).
component("YKL166C",683).
component("YJL164C",630).
component("YIL035C",578).
component("YHR205W",571).
component("YHR102W",558).
component("YGL019W",469).
component("YHR025W",544).
component("YOR347C",926).
component("YAL038W",198).
component("YNR012W",852).
component("YPR121W",991).
component("YPL258C",966).
component("YOL055C",871).
component("YPL214C",959).
component("U1_",104).
component("YDR009W",332).
component("YDR127W",353).
component("U21_",116).
component("U20_",113).
component("YDR147W",356).
component("YDR300C",371).
component("YCR012W",279).
component("YER052C",418).
component("YER069W",429).
component("U19_",103).
component("YKL024C",667).
component("U18_",93).
component("U17_",83).
component("U76_",173).
component("YER170W",443).
component("YDR226W",362).
component("YKL067W",673).
component("YOL055C",872).
component("YDR454C",388).
component("YJR057W",647).
component("YOL061W",876).
component("YKL181W",685).
component("YHL011C",535).
component("YER099C",439).
component("YBL068W",213).
component("YOR143C",901).
component("YNL256W",840).
component("YLR328W",755).
component("YBR018C",220).
component("YBR018C",221).
component("YGR007W",493).
component("YGR202C",518).
component("YLR328W",756).
component("YDL045C",295).
component("U80_",178).
component("YDL103C",308).
component("U94_",191).
component("YJR010W",640).
component("YBR029C",226).
component("YCL050C",275).
component("YGL130W",480).
component("YDR530C",394).
component("YCL050C",276).
component("YPR190C",1000).
component("YPR187W",999).
component("YPR110C",989).
component("YPR010C",976).
component("YOR341W",925).
component("YOR340C",924).
component("YOR224C",916).
component("YOR210W",913).
component("YOR207C",910).
component("YOR151C",902).
component("YOR116C",896).
component("YOL005C",864).
component("YNR003C",850).
component("YNL248C",838).
component("YNL151C",832).
component("YNL113W",829).
component("YKL144C",679).
component("YJR063W",648).
component("YJL148W",627).
component("YJL140W",626).
component("YIL021W",577).
component("YHR143W-A",562).
component("YGL070C",477).
component("YFL036W",451).
component("YDR404C",382).
component("YDR156W",358).
component("YDR045C",338).
component("YDL150W",317).
component("YDL140C",311).
component("YBR154C",248).
component("YPR175W",996).
component("YPL167C",950).
component("YOR330C",921).
component("YOL115W",883).
component("YNL299W",847).
component("YNL262W",842).
component("YNL102W",827).
component("YJR043C",644).
component("YJR006W",638).
component("YJL090C",617).
component("YIL139C",594).
component("YEL055C",406).
component("YDR419W",385).
component("YDR121W",350).
component("YDL102W",307).
component("YCR014C",280).
component("YBR278W",265).
component("YBL035C",209).
component("YKL035W",670).
component("YHL012W",536).
component("YHR123W",559).
component("YPR113W",990).
component("YBR243C",257).
component("YDL142C",316).
component("YPL148C",948).
component("YER026C",415).
component("YGR286C",532).
component("YJL068C",612).
component("YHR189W",568).
component("YDR058C",342).
component("YNR034W",857).
component("YHR163W",564).
component("YGR248W",525).
component("YCR073W-A",288).
component("YDL086W",304).
component("YOL011W",865).
component("YMR008C",786).
component("YMR006C",785).
component("U105_",25).
component("YBL015W",206).
component("YJL068C",613).
component("YJR019C",642).
component("YOR040W",891).
component("U84_",182).
component("U77_",174).
component("YDR481C",389).
component("YLR377C",762).
component("YFR025C",456).
component("YPL179W",953).
component("YNR032W",855).
component("YML057W",777).
component("YML016C",771).
component("YLR433C",766).
component("YGR123C",507).
component("YER133W",441).
component("YER089C",436).
component("YDR436W",386).
component("YDR075W",345).
component("YDL188C",324).
component("YDL134C",310).
component("YDL047W",296).
component("YDL006W",289).
component("YBR125C",243).
component("YBL056W",212).
component("YPR073C",984).
component("YHR215W",573).
component("YDL024C",292).
component("YBR093C",237).
component("YBR092C",236).
component("YAR071W",202).
component("YIL053W",581).
component("YER062C",426).
component("YHR046C",548).
component("U9_",195).
component("YPL228W",961).
component("YMR180C",805).
component("YDL236W",328).
component("YJL155C",629).
component("YPR073C",985).
component("YOR208W",911).
component("YNL053W",824).
component("YMR036C",790).
component("YIR026C",604).
component("YIL113W",590).
component("YFR028C",457).
component("YER075C",432).
component("YDL230W",327).
component("YBR276C",264).
component("U34_",136).
component("U33_",135).
component("U32_",134).
component("U31_",133).
...
component("U25_",127).
component("U24_",126).
component("YHR044C",547).
component("YHR043C",546).
component("YOL064C",877).
component("YOR360C",929).
component("YGL248W",490).
component("YKR031C",701).
component("YPL206C",956).
component("YGL027C",471).
component("YLR286C",746).
component("YJR153W",662).
component("YJL221C",637).
component("YJL216C",635).
component("YIL172C",602).
component("YGR292W",534).
component("YGR287C",533).
component("YBR299W",269).
component("YBR184W",251).
component("YIL162W",599).
component("YPR026W",977).
component("YDR001C",330).
component("YBR001C",215).
component("YIR019C",603).
component("YIL099W",587).
component("YDL037C",294).
component("YOR190W",907).
component("YLR300W",748).
component("YGR282C",531).
component("YDR261C",367).
component("YDR400W",380).
component("U23_",125).
component("YML035C",773).
component("YJL070C",614).
component("YBR284W",266).
component("U106_",26).
component("U102_",22).
component("YER043C",417).
component("YNL045W",822).
component("YGL037C",472).
component("YDR242W",365).
component("YLR308W",754).
component("YLR307W",753).
component("YBR208C",253).
component("YMR281W",815).
component("U53_",152).
component("YIR032C",605).
component("YPR062W",982).
component("YMR120C",800).
component("YLR028C",719).
component("YHR144C",563).
component("YGR267C",530).
component("YCL030C",273).
component("YBL033C",208).
component("YBR153W",247).
component("YNL141W",830).
component("YLR245C",743).
component("YML035C",774).
component("YGR204W",520).
component("YBR084W",233).
component("YJL126W",621).
component("U44_",144).
...
component("YHR201C",570).
component("YBR111C",238).
component("YBR252W",261).
component("YPR080W",987).
component("YOR187W",906).
component("YOR133W",899).
component("YLR069C",725).
component("YKR084C",707).
component("YKL173W",684).
component("YJL102W",619).
component("YDR385W",379).
component("YBR118W",241).
component("YER005W",411).
component("YLL001W",710).
component("YIL048W",580).
component("YER166W",442).
component("YDR093W",347).
component("YAL026C",197).
component("YBL099W",214).
component("U60_",157).
component("YLR231C",740).
component("U88_",185).
component("YDR538W",397).
component("YLR134W",729).
component("YLR044C",721).
component("YGR087C",503).
component("YDR380W",378).
component("YDL080C",301).
component("U98_",193).
component("YMR250W",812).
component("YKL184W",689).
component("YOR128C",897).
component("YEL021W",401).
component("YNR043W",859).
component("U93_",190).
component("U54_",153).
component("YKL211C",695) :- not remove_orf("YKL211C",695).
component("YKR097W",709).
component("YOL052C",870).
component("YNL169C",833).
component("YGR170W",512).
component("YKL060C",672).
component("YNL256W",841).
component("YDR294C",369).
component("YEL046C",404).
component("YNR033W",856).
component("YPR006C",975).
component("YER065C",427).
component("YKL211C",696) :- not remove_orf("YKL211C",696).
component("YER090W",696) :- not remove_orf("YER090W",696).
component("YER090W",437) :- not remove_orf("YER090W",437).
component("YDR127W",354).
component("YPL281C",973).
component("YOR393W",935).
component("YMR323W",818).
component("YHR174W",565).
component("YGR254W",526).
component("YOR202W",909).
component("YPL262W",967).
component("YGL026C",470) :- not remove_orf("YGL026C",470).
component("YGR155W",510).
component("YLR304C",751).
component("YJL200C",633).
component("YGL009C",465).
component("YNL316C",848).
component("YKL182W",687).
component("YPL212C",957).
component("YNL292W",846).
component("YGL063W",476).
component("YFL001W",446).
component("YPR002W",974).
component("YJR016C",641).
component("YCR053W",287).
component("YDR127W",355).
component("YGL148W",481).
component("YIL168W",601).
component("YIL167W",600).
component("YCL064C",277).
component("YER086W",434).
component("YLR359W",761).
component("YAL012W",196).
component("YML004C",769).
component("YFR055W",461).
component("YJL005W",608).
component("YJL121C",620).
component("YBR019C",222).
component("YBR019C",223).
component("YDR050C",340).
component("YIL020C",576).
component("YDR007W",331) :- not remove_orf("YDR007W",331).
component("YOR095C",895).
component("YER003C",410).
component("YBR196C",252).
component("YGL001C",463).
component("YPL117C",946).
component("U14_",60).
component("YOL056W",873).
component("YKL152C",682).
component("YDL021W",290).
component("YMR105C",796).
component("YKL127W",677).
component("YEL058W",407).
component("YPR060C",981).
component("YHR072W",553).
component("YJL153C",628).
component("YPL097W",944).
component("YGR185C",515).
component("YGR264C",529).
component("YGR171C",513).
component("YHR011W",541).
component("YDR023W",334).
component("YPL104W",945).
component("YLL018C",711).
component("YPR081C",988).
component("YBR121C",242).
component("YHR020W",543).
component("YER087W",435).
component("YNL247W",837).
component("YOL033W",868).
component("YOR168W",903).
component("YOL097C",881).
component("YDR268W",368).
component("YPR047W",980).
component("YLR060W",724).
component("YFL022C",449).
component("YPR033C",978).
component("YCR024C",281).
component("YHR019C",542).
component("YKL194C",692).
component("YIL078W",584).
component("YPL160W",949).
component("YLR382C",763).
component("YNL073W",826).
component("YDR037W",336).
component("YOR335C",922).
component("YGR094W",505).
component("YLR153C",733).
component("YAL054C",199).
component("YOR317W",919).
component("YMR246W",811).
component("YIL009W",575).
component("YER015W",413).
component("YOR142W",900).
component("YGR244C",524).
component("YPR035W",979).
component("YIL145C",595).
component("U89_",186).
component("YOR339C",923).
component("YMR022W",789).
component("YLR306W",752).
component("YKL210W",694).
component("YGR133W",509).
component("YGL058W",474).
component("YER100W",440).
component("YEL012W",399).
component("YDR177W",360).
component("YDR092W",346).
component("YDR059C",343).
component("YDR054C",341).
component("YDL064W",298).
component("YBR082C",232).
component("YJL101C",618).
component("YOL049W",869).
component("YAR015W",201).
component("YGL234W",488).
component("YER183C",445).
component("U91_",189).
component("U90_",188).
component("YNR057C",861).
component("YDL141W",312).
component("YDL141W",313).
component("YGL234W",489).
component("YDL141W",314).
component("YJR103W",654).
component("YBL039C",210).
component("YGR204W",521).
component("YBR084W",234).
component("YNL220W",835).
component("YOL058W",874).
component("YBR208C",254).
component("YDL141W",315).
component("YHR074W",554).
component("YMR217W",810).
component("YGR061C",501).
component("YPR145W",993).
component("YGR124W",508).
component("YJR109C",656).
component("YJL130C",624).
component("YGL062W",475).
component("YBR218C",255).
component("YPL231W",965).
component("YNR016C",853).
component("YKL182W",688).
component("YGR037C",497).
component("YJL087C",615).
component("YPR138C",992).
component("YPL265W",968).
component("YPL134C",947).
component("YPL057C",941).
component("YPL036W",940).
component("YOR348C",927).
component("YOR222W",915).
component("YOR192C",908).
component("YOR171C",904).
component("YOR130C",898).
component("YOR071C",893).
component("YOR011W",890).
component("YOL156W",889).
component("YOL103W",882).
component("YOL020W",867) :- not remove_orf("YOL020W",867).
component("YNR072W",863).
component("YNR056C",860).
component("YNL318C",849).
component("YNL270C",843).
component("YNL142W",831).
component("YMR272C",814).
component("YMR202W",807).
component("YMR056C",791).
component("YMR011W",787).
component("YLR348C",758).
component("YLR260W",745).
component("YLR237W",741).
component("YLR138W",730).
component("YLR100C",728).
component("YLR081W",726).
component("YLL061W",715).
component("YLL043W",713).
component("YKR093W",708).
component("YKR053C",703).
component("YKR039W",702) :- not remove_orf("YKR039W",702).
component("YKL217W",698).
component("YKL120W",676).
component("YKL004W",665).
component("YJR158W",663).
component("YJR095W",653).
component("YJR077C",651).
component("YJL219W",636).
component("YJL214W",634).
component("YJL134W",625).
component("YJL129C",622).
component("YIL134W",593).
component("YHR096C",557).
component("YHR094C",556).
component("YHR092C",555).
component("YHL036W",538).
component("YGR121C",506).
component("YGR065C",502).
component("YGR055W",499).
component("YGL186C",483).
component("YGL077C",478).
component("YGL008C",464).
component("YFL055W",453).
component("YFL011W",447).
component("YER060W-A",423).
component("YER060W",422).
component("YER056C",421).
component("YER053C",419).
component("YEL069C",409).
component("YEL063C",408).
component("YEL017C-A",400).
component("YDR536W",396).
component("YDR508C",393).
component("YDR503C",392).
component("YDR497C",390).
component("YDR345C",375).
component("YDR343C",374).
component("YDR342C",373).
component("YDR297W",370).
component("YDR046C",339) :- not remove_orf("YDR046C",339).
component("YDL245C",329).
component("YDL210W",325).
component("YCR032W",284).
component("YCR028C",283).
component("YCR024C-A",282).
component("YCL025C",272).
component("YBR298C",268).
component("YBR291C",267).
component("YBR085W",235).
...
catalyst(2220,912).
catalyst(3870,420).
catalyst(3620,377) :- not remove_reaction(3620,377).
catalyst(2110,459).
catalyst(2190,459).
catalyst(5550,658).
catalyst(5301,124).
...
catalyst(2300,190).
catalyst(3460,153).
catalyst(3600,695) :- not remove_reaction(3600,695).
catalyst(8000,709).
catalyst(3941,870).
catalyst(3942,870).
catalyst(6890,833).
...
catalyst(8020,975).
catalyst(8020,427).
catalyst(1890,696) :- not remove_reaction(1890,696).
catalyst(3630,696) :- not remove_reaction(3630,696).
catalyst(1890,437) :- not remove_reaction(1890,437).
catalyst(3630,437) :- not remove_reaction(3630,437).
catalyst(3740,354).
catalyst(8231,973).
catalyst(8232,973).
catalyst(8231,935).
...
catalyst(8061,967).
catalyst(8062,967).
catalyst(3590,470) :- not remove_reaction(3590,470).
catalyst(10910,470) :- not remove_reaction(10910,470).
catalyst(4570,510).
catalyst(8181,751).
catalyst(8182,751).
catalyst(8181,633).
...
catalyst(8282,340).
catalyst(3840,576).
catalyst(3610,331) :- not remove_reaction(3610,331).
catalyst(7921,895).
catalyst(7922,895).
catalyst(7841,410).
catalyst(7842,410).
...
catalyst(1210,889).
catalyst(1160,882).
catalyst(801,867) :- not remove_reaction(801,867).
catalyst(802,867) :- not remove_reaction(802,867).
catalyst(811,867) :- not remove_reaction(811,867).
catalyst(812,867) :- not remove_reaction(812,867).
catalyst(831,867) :- not remove_reaction(831,867).
catalyst(832,867) :- not remove_reaction(832,867).
catalyst(901,867) :- not remove_reaction(901,867).
catalyst(902,867) :- not remove_reaction(902,867).
catalyst(1180,863).
catalyst(1210,863).
catalyst(700,860).
catalyst(1200,849).
...
catalyst(650,708).
catalyst(6560,703).
catalyst(681,702) :- not remove_reaction(681,702).
catalyst(682,702) :- not remove_reaction(682,702).
catalyst(771,702) :- not remove_reaction(771,702).
catalyst(772,702) :- not remove_reaction(772,702).
catalyst(781,702) :- not remove_reaction(781,702).
catalyst(782,702) :- not remove_reaction(782,702).
catalyst(791,702) :- not remove_reaction(791,702).
catalyst(792,702) :- not remove_reaction(792,702).
catalyst(801,702) :- not remove_reaction(801,702).
catalyst(802,702) :- not remove_reaction(802,702).
catalyst(811,702) :- not remove_reaction(811,702).
catalyst(812,702) :- not remove_reaction(812,702).
catalyst(831,702) :- not remove_reaction(831,702).
catalyst(832,702) :- not remove_reaction(832,702).
catalyst(841,702) :- not remove_reaction(841,702).
catalyst(842,702) :- not remove_reaction(842,702).
catalyst(851,702) :- not remove_reaction(851,702).
catalyst(852,702) :- not remove_reaction(852,702).
catalyst(881,702) :- not remove_reaction(881,702).
catalyst(882,702) :- not remove_reaction(882,702).
catalyst(901,702) :- not remove_reaction(901,702).
catalyst(902,702) :- not remove_reaction(902,702).
catalyst(911,702) :- not remove_reaction(911,702).
catalyst(912,702) :- not remove_reaction(912,702).
catalyst(921,702) :- not remove_reaction(921,702).
catalyst(922,702) :- not remove_reaction(922,702).
catalyst(931,702) :- not remove_reaction(931,702).
catalyst(932,702) :- not remove_reaction(932,702).
catalyst(1191,702) :- not remove_reaction(1191,702).
catalyst(1192,702) :- not remove_reaction(1192,702).
catalyst(390,698).
catalyst(1521,676).
catalyst(1522,676).
catalyst(6610,665).
...
catalyst(1210,373).
catalyst(6650,370).
catalyst(791,339) :- not remove_reaction(791,339).
catalyst(792,339) :- not remove_reaction(792,339).
catalyst(801,339) :- not remove_reaction(801,339).
catalyst(802,339) :- not remove_reaction(802,339).
catalyst(811,339) :- not remove_reaction(811,339).
catalyst(812,339) :- not remove_reaction(812,339).
catalyst(831,339) :- not remove_reaction(831,339).
catalyst(832,339) :- not remove_reaction(832,339).
catalyst(841,339) :- not remove_reaction(841,339).
catalyst(842,339) :- not remove_reaction(842,339).
catalyst(851,339) :- not remove_reaction(851,339).
catalyst(852,339) :- not remove_reaction(852,339).
catalyst(901,339) :- not remove_reaction(901,339).
catalyst(902,339) :- not remove_reaction(902,339).
catalyst(1180,329).
catalyst(1210,329).
catalyst(690,325).
catalyst(730,325).
...
modifiable_enzyme(695).
modifiable_enzyme(696).
modifiable_enzyme(437).
modifiable_enzyme(470).
modifiable_enzyme(331).
modifiable_enzyme(867).
