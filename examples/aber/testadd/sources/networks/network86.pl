...
component("YLR056W",446).
component("YGL012W",282).
component("YKR009C",429).
component("YOL086C",541).
component("YMR303C",497).
component("YGL256W",302).
...
component("YIL094C",360).
component("U45_",84).
component("YML056C",480).
component("YLR432W",477).
component("YHR216W",354).
component("YAR075W",125).
component("YAR073W",124).
component("YDR127W",208).
component("YOL126C",546).
component("YKL085W",415).
component("YDL078C",182).
component("YNL037C",502).
component("YNL009W",500).
component("YLR174W",456).
component("YOL059W",539).
component("YDL022W",178).
component("YCL018W",166).
component("YLR355C",472).
component("YDL174C",195).
component("YML086C",482).
component("YGR088W",310).
component("YDR256C",219).
component("YJR078W",404).
component("YJR025C",397).
component("U107_",24).
component("YHR007C",329).
component("YJR104C",406).
component("YHR008C",330).
component("YOR384W",577).
component("YOR381W",576).
component("YOL152W",548).
component("YLL051C",439).
component("YJL026W",374).
component("YIL066C",358).
component("YGR180C",313).
component("YER070W",258).
component("U37_",78).
component("U36_",77).
component("YDL168W",193).
component("YBR006W",133).
component("YPL276W",602).
component("YPL275W",601).
component("YOR388C",578).
component("YOR374W",574).
component("YER073W",259).
component("YGL154C",294).
component("U55_",91).
component("YER069W",256).
component("YOR323C",567).
component("YER178W",265).
component("YBR221C",155).
component("YIL125W",364).
component("U52_",89).
component("YBR166C",151).
component("YGL012W",283).
component("YKL216W",428).
component("YKR009C",430).
component("YIL160C",368).
component("YGL205W",299).
component("YMR118C",489).
component("YLR164W",454).
component("YLL041C",438).
component("YKL148C",419).
component("YKL141W",417).
component("YJL045W",375).
component("YDR178W",215).
component("YEL047C",245).
component("YDL171C",194).
component("YOR375C",575).
component("YAL062W",122).
component("U99_",117).
component("U100_",20).
component("YKR080W",435).
component("YER023W",250).
component("YOR236W",565).
component("YGR204W",315).
component("YLR142W",452).
component("U65_",97).
component("U63_",95).
component("U62_",94).
component("YHR068W",338).
component("YKL150W",420).
component("YIL043C",357).
component("YPL171C",589).
component("YHR179W",349).
component("YMR145C",492).
component("YML120C",483).
component("YKL192C",425).
component("YDL085W",184).
component("YGR234W",317).
component("YFR030W",276).
component("YPL017C",580).
component("YFL018C",269).
component("YDR353W",226).
component("YPR167C",614).
component("YJR137C",408).
component("YNL052W",503).
component("YMR256C",496).
component("YLR395C",476).
component("YLR038C",444).
component("YIL111W",361).
component("YHR051W",337).
component("YGL191W",297).
component("YGL187C",296).
component("YDL067C",181).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",600).
component("YKR069W",434).
component("YOL096C",542).
component("U47_",86).
component("YJR073C",402).
component("YDR120C",206).
component("YDL033C",180).
component("YLR172C",455).
component("YLR058C",447).
component("YDR019C",201).
component("YBR176W",152).
component("YDR408C",231).
component("YMR120C",490).
component("YLR028C",442).
component("YBL013W",126).
component("YJL130C",383).
component("YKL024C",413).
component("YPR074C",610).
component("YBR117C",146).
component("YCL009C",165).
component("YNL071W",505).
component("YNR008W",525).
component("YIL160C",369).
component("U48_",87).
component("YPL231W",595).
component("YPL231W",596).
component("YPL028W",581).
component("YLR299W",465).
component("YGL017W",284).
component("YML126C",484).
component("YNL104C",508).
component("YDL182W",196).
component("YDL131W",188).
component("YLR258W",462).
component("YFR015C",274).
component("YNL029C",501).
component("YIL085C",359).
component("YMR306W",498).
component("YLR342W",471).
component("YGR032W",305).
component("YLR209C",458).
component("U104_",21).
component("YDR354W",227) :- not remove_orf("YDR354W",227).
component("YFR047C",277).
component("YLR209C",459).
component("YML022W",478).
component("YDR441C",233).
component("YJL167W",388).
component("YJL167W",389).
component("YDR127W",209).
component("YHR068W",339).
component("YLR303W",467).
component("YGR012W",303).
component("YML082W",481).
component("YJR130C",407).
component("YDR035W",202).
component("YBR249C",156).
component("YLR180W",457).
component("YDR502C",236).
component("YOR274W",566).
component("YHR137W",345).
component("YGL202W",298).
component("YLR027C",441).
component("YKL106W",416).
component("YOL140W",547).
component("YGR019W",304).
component("YLR089C",449).
component("U64_",96).
component("U61_",93).
component("YJR148W",409).
component("YFL030W",270).
component("YOR184W",559).
component("YNR058W",530).
component("YIL116W",363).
component("YGL253W",301).
component("YFR053C",278).
component("YMR205C",493).
component("YGR240C",318).
component("YOL016C",534).
component("YFR014C",273).
component("YCR036W",175).
component("YCL040W",168).
component("U15_",43).
component("YPL188W",590).
component("YJR049C",399).
component("YEL041W",243).
component("U96_",115).
component("YKL001C",412).
component("YDR236C",217).
component("YHL032C",327).
component("YDR531W",240).
component("U83_",111).
component("U81_",110).
component("YMR208W",494).
component("YPL203W",591).
component("YOR061W",551).
component("YKL166C",422).
component("YJL164C",387).
component("YIL035C",356).
component("YHR205W",352).
component("YHR102W",344).
component("YGL019W",285).
component("YHR025W",333).
component("YOR347C",572).
component("YAL038W",120).
component("YNR012W",526).
component("YDR127W",210).
component("YDR147W",213).
component("YCR012W",170).
component("YER069W",257).
component("U76_",106).
component("YER170W",264).
component("YDR226W",216).
component("YKL067W",414).
component("YOL055C",537).
component("YDR454C",234).
component("YJR057W",400).
component("YOL061W",540).
component("YKL181W",423).
component("YHL011C",326).
component("YER099C",263).
component("YBL068W",131).
component("YOR143C",555).
component("YNL256W",517).
component("YLR328W",469).
component("YBR018C",135).
component("YLR328W",470).
component("U94_",114).
component("YBR029C",138).
component("YGL130W",292).
component("YDR530C",239).
component("YPR190C",617).
component("YPR187W",616).
component("YPR110C",611).
component("YPR010C",605).
component("YOR341W",571).
component("YOR340C",570).
component("YOR224C",564).
component("YOR210W",563).
component("YOR207C",561).
component("YOR151C",556).
component("YOR116C",553).
component("YOL005C",532).
component("YNR003C",524).
component("YNL248C",516).
component("YNL151C",512).
component("YNL113W",509).
component("YKL144C",418).
component("YJR063W",401).
component("YJL148W",386).
component("YJL140W",385).
component("YIL021W",355).
component("YHR143W-A",346).
component("YGL070C",290).
component("YFL036W",271).
component("YDR404C",230).
component("YDR156W",214).
component("YDR045C",203).
component("YDL150W",191).
component("YDL140C",189).
component("YBR154C",150).
component("YPR175W",615).
component("YPL167C",588).
component("YOR330C",568).
component("YOL115W",545).
component("YNL299W",522).
component("YNL262W",518).
component("YNL102W",507).
component("YJR043C",398).
component("YJR006W",395).
component("YJL090C",378).
component("YIL139C",366).
component("YEL055C",246).
component("YDR419W",232).
component("YDR121W",207).
component("YDL102W",187).
component("YCR014C",171).
component("YBR278W",160).
component("YBL035C",129).
component("YPR113W",612).
component("YPL148C",586).
component("YGR286C",323).
component("YHR189W",350).
component("YDR058C",205).
component("YDL086W",185).
component("YOL011W",533).
component("YMR008C",486).
component("YMR006C",485).
component("U105_",22).
component("YBL015W",127).
component("YJL068C",376).
component("U77_",107).
component("YLR377C",474).
component("YPR073C",608).
component("YHR215W",353).
component("YDL024C",179).
component("YBR093C",144).
component("YBR092C",143).
component("YHR046C",336).
component("U9_",118).
component("YDL236W",198).
component("YPR073C",609).
component("YOR208W",562).
component("YNL053W",504).
component("YMR036C",488).
component("YIR026C",373).
component("YIL113W",362).
component("YFR028C",275).
component("YER075C",260).
...
component("U25_",70).
component("U24_",69).
component("YHR044C",335).
component("YHR043C",334).
component("YOR360C",573).
component("YKR031C",431).
component("YPL206C",592).
component("YGL027C",287).
component("YLR286C",464).
component("YJR153W",410).
component("YJL221C",394).
component("YJL216C",392).
component("YIL172C",372).
component("YGR292W",325).
component("YGR287C",324).
component("YBR299W",164).
component("YOR190W",560).
component("YLR300W",466).
component("YGR282C",322).
component("YDR261C",220).
component("YDR400W",229).
component("YML035C",479).
component("YJL070C",377).
component("YBR284W",161).
component("U106_",23).
component("YER043C",251).
component("YDR242W",218).
component("U53_",90).
component("YPR062W",607).
component("YMR120C",491).
component("YLR028C",443).
component("YHR144C",347).
component("YBL033C",128).
component("YNL141W",510).
component("YLR245C",461).
...
component("YHR201C",351).
component("YBR111C",145).
component("YBR252W",157).
component("YER005W",249).
component("YBL099W",132).
component("YLR231C",460).
component("YLR134W",451).
component("YLR044C",445).
component("YGR087C",309).
component("YDR380W",228).
component("YDL080C",183).
component("U98_",116).
component("YMR250W",495).
component("YOR128C",554).
component("U93_",113).
component("YKL211C",426) :- not remove_orf("YKL211C",426).
component("YKR097W",436).
component("YNL169C",513).
component("YEL046C",244).
component("YNR033W",528).
component("YKL211C",427) :- not remove_orf("YKL211C",427).
component("YER090W",427) :- not remove_orf("YER090W",427).
component("YER090W",262) :- not remove_orf("YER090W",262).
component("YDR127W",211).
component("YPL281C",603).
component("YOR393W",579).
component("YMR323W",499).
component("YHR174W",348).
component("YGR254W",320).
component("YPL262W",598).
component("YGL026C",286) :- not remove_orf("YGL026C",286).
component("YLR304C",468).
component("YJL200C",390).
component("YNL316C",523).
component("YPL212C",593).
component("YNL292W",521).
component("YGL063W",289).
component("YFL001W",267).
component("YPR002W",604).
component("YJR016C",396).
component("YCR053W",176).
component("YDR127W",212).
component("YGL148W",293).
component("YIL168W",371).
component("YIL167W",370).
component("YCL064C",169).
component("YLR359W",473).
component("YAL012W",119).
component("YJL121C",380).
component("YBR019C",136).
component("YDR007W",200) :- not remove_orf("YDR007W",200).
component("YOR095C",552).
component("YBR196C",153).
component("YGL001C",280).
component("YPL117C",585).
component("U14_",37).
component("YOL056W",538).
component("YKL152C",421).
component("YDL021W",177).
component("YPR060C",606).
component("YPL097W",583).
component("YGR185C",314).
component("YGR264C",321).
component("YGR171C",312).
component("YPL104W",584).
component("YLL018C",437).
component("YHR020W",332).
component("YER087W",261).
component("YNL247W",515).
component("YOR168W",557).
component("YOL097C",543).
component("YDR268W",221).
component("YCR024C",172).
component("YHR019C",331).
component("YPL160W",587).
component("YLR382C",475).
component("YNL073W",506).
component("YOR335C",569).
component("YLR153C",453).
component("YAL054C",121).
component("YGR244C",319).
component("YIL145C",367).
component("YJL101C",379).
component("YOL049W",536).
component("YAR015W",123).
component("YER183C",266).
component("U90_",112).
component("YNR057C",529).
component("YGL234W",300).
component("YJR103W",405).
component("YBL039C",130).
component("YGR204W",316).
component("YBR084W",142).
component("YNL220W",514).
component("YDL141W",190).
component("YHR074W",340).
component("YGL062W",288).
component("YBR218C",154).
component("YPL231W",597).
component("YNR016C",527).
component("YKL182W",424).
component("YGR037C",306).
component("YPR138C",613).
component("YPL265W",599).
component("YPL036W",582).
component("YOR171C",558).
component("YOR011W",550).
component("YOL156W",549).
component("YOL103W",544).
component("YOL020W",535) :- not remove_orf("YOL020W",535).
component("YNR072W",531).
component("YNL270C",519).
component("YNL142W",511).
component("YMR011W",487).
component("YLR260W",463).
component("YLR100C",450).
component("YLR081W",448).
component("YLL061W",440).
component("YKR053C",433).
component("YKR039W",432) :- not remove_orf("YKR039W",432).
component("YJR158W",411).
component("YJR077C",403).
component("YJL219W",393).
component("YJL214W",391).
component("YJL134W",384).
component("YJL129C",382).
component("YIL134W",365).
component("YHR096C",343).
component("YHR094C",342).
component("YHR092C",341).
component("YHL036W",328).
component("YGR121C",311).
component("YGR065C",308).
component("YGR055W",307).
component("YGL186C",295).
component("YGL077C",291).
component("YGL008C",281).
component("YFL055W",272).
component("YFL011W",268).
component("YER060W-A",255).
component("YER060W",254).
component("YER056C",253).
component("YER053C",252).
component("YEL069C",248).
component("YEL063C",247).
component("YEL017C-A",242).
component("YDR536W",241).
component("YDR508C",238).
component("YDR503C",237).
component("YDR497C",235).
component("YDR345C",225).
component("YDR343C",224).
component("YDR342C",223).
component("YDR297W",222).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,227) :- not remove_reaction(3620,227).
catalyst(2110,277).
catalyst(2190,277).
catalyst(5791,459).
catalyst(5792,459).
...
catalyst(6112,554).
catalyst(2300,113).
catalyst(3600,426) :- not remove_reaction(3600,426).
catalyst(8000,436).
catalyst(6890,513).
catalyst(4560,244).
catalyst(2550,528).
...
catalyst(1890,262) :- not remove_reaction(1890,262).
catalyst(3630,262) :- not remove_reaction(3630,262).
catalyst(3740,211).
catalyst(8231,603).
catalyst(8232,603).
catalyst(8231,579).
...
catalyst(8051,598).
catalyst(8052,598).
catalyst(3590,286) :- not remove_reaction(3590,286).
catalyst(10910,286) :- not remove_reaction(10910,286).
catalyst(8181,468).
catalyst(8182,468).
catalyst(8181,390).
catalyst(8182,390).
...
catalyst(901,535) :- not remove_reaction(901,535).
catalyst(902,535) :- not remove_reaction(902,535).
catalyst(1210,531).
catalyst(931,519).
catalyst(932,519).
catalyst(371,511).
...
catalyst(750,440).
catalyst(6560,433).
catalyst(771,432) :- not remove_reaction(771,432).
catalyst(772,432) :- not remove_reaction(772,432).
catalyst(781,432) :- not remove_reaction(781,432).
catalyst(782,432) :- not remove_reaction(782,432).
catalyst(801,432) :- not remove_reaction(801,432).
catalyst(802,432) :- not remove_reaction(802,432).
catalyst(811,432) :- not remove_reaction(811,432).
catalyst(812,432) :- not remove_reaction(812,432).
catalyst(831,432) :- not remove_reaction(831,432).
catalyst(832,432) :- not remove_reaction(832,432).
catalyst(841,432) :- not remove_reaction(841,432).
catalyst(842,432) :- not remove_reaction(842,432).
catalyst(851,432) :- not remove_reaction(851,432).
catalyst(852,432) :- not remove_reaction(852,432).
catalyst(881,432) :- not remove_reaction(881,432).
catalyst(882,432) :- not remove_reaction(882,432).
catalyst(901,432) :- not remove_reaction(901,432).
catalyst(902,432) :- not remove_reaction(902,432).
catalyst(921,432) :- not remove_reaction(921,432).
catalyst(922,432) :- not remove_reaction(922,432).
catalyst(931,432) :- not remove_reaction(931,432).
catalyst(932,432) :- not remove_reaction(932,432).
catalyst(1191,432) :- not remove_reaction(1191,432).
catalyst(1192,432) :- not remove_reaction(1192,432).
catalyst(1210,411).
catalyst(1581,403).
catalyst(1582,403).
catalyst(1210,393).
