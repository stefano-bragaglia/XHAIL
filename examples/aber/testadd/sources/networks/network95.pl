...
component("YLR056W",481).
component("YGL012W",303).
component("YKR009C",463).
component("YOL086C",584).
component("YMR303C",538).
component("YGL256W",323).
...
component("U45_",91).
component("YML056C",520).
component("YLR432W",514).
component("YHR216W",382).
component("YAR075W",135).
component("YAR073W",134).
component("YDR127W",226).
component("YOL126C",590).
component("YKL085W",449).
component("YDL078C",197).
component("YNL037C",543).
component("YNL009W",541).
component("YLR174W",493).
component("YHR183W",377).
component("YGR256W",344).
component("YOL059W",582).
component("YDL022W",192).
component("YCL018W",179).
component("YLR355C",509).
component("YDL174C",212).
component("YML086C",522).
component("YGR088W",331).
component("YDR256C",238).
component("YKL026C",447).
component("YIR037W",402).
component("YBR244W",168).
component("YJR078W",436).
component("U58_",99).
component("YJR025C",429).
component("U107_",24).
component("YHR007C",354).
component("YJR104C",438).
component("YHR008C",355).
component("YOR384W",622).
component("YOR381W",621).
component("YOL152W",592).
component("YLL051C",474).
component("YJL026W",404).
...
component("YOR236W",610).
component("YGR204W",338).
component("YLR142W",488).
component("U65_",105).
component("U63_",103).
component("U62_",102).
component("YHR068W",364).
component("YKL150W",454).
component("YIL043C",385).
component("YHR042W",359).
component("YPL171C",634).
component("YHR179W",376).
component("YMR145C",533).
component("YML120C",523).
component("YKL192C",459).
component("YDL085W",199).
component("YGR234W",340).
component("YFR030W",297).
component("YPL017C",625).
component("YFL018C",290).
component("YDR353W",245).
component("YPR167C",659).
component("YJR137C",441).
component("YNL052W",545).
component("YMR256C",537).
component("YLR395C",513).
component("YLR038C",479).
component("YIL111W",389).
component("YHR051W",363).
component("YGL191W",318).
component("YGL187C",317).
component("YDL067C",196).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",645).
component("YKR069W",468).
component("YOL096C",585).
component("U47_",93).
component("YJR073C",434).
component("YDR120C",224).
component("YML008C",516).
component("YDL033C",194).
component("YOL096C",586).
component("YLR172C",492).
component("YLR058C",482).
component("YDR019C",219).
component("YBR176W",164).
component("YDR408C",250).
component("YMR120C",531).
component("YLR028C",477).
component("YBL013W",136).
component("YJL130C",414).
component("YKL024C",446).
component("YPR074C",655).
component("YBR117C",158).
component("YCL009C",178).
component("YNL071W",547).
component("YNR008W",567).
component("YIL160C",397).
component("YNR019W",570).
component("YCR048W",189).
component("U48_",94).
component("YDR232W",235).
component("YPL231W",640).
component("YDL052C",195).
component("U8_",121).
component("YPL231W",641).
component("YPL028W",626).
component("YLR299W",502).
component("YGL017W",305).
component("YML126C",524).
component("YNL104C",550).
component("YDL182W",213).
component("YDL131W",203).
component("YLR258W",499).
component("YFR015C",295).
component("YNL029C",542).
component("YIL085C",387).
component("YMR306W",539).
component("YLR342W",508).
component("YGR032W",326).
component("YLR209C",495).
component("U104_",21).
component("YDR354W",246) :- not remove_orf("YDR354W",246).
component("YFR047C",298).
component("YJR133W",440).
component("YLR209C",496).
component("YML022W",517).
component("YDR441C",252).
component("YJL167W",419).
component("YJL167W",420).
component("YDR127W",227).
component("YLR146C",489).
component("YHR068W",365).
component("YLR303W",504).
component("YGR012W",324).
component("YML082W",521).
component("YJR130C",439).
component("YDR035W",220).
component("YBR249C",169).
component("YLR180W",494).
component("YDR502C",255).
component("YOR274W",611).
component("YHR137W",372).
component("YGL202W",319).
component("YLR027C",476).
component("YKL106W",450).
component("YOL140W",591).
component("YLR438W",515).
component("YGR019W",325).
component("YLR089C",484).
component("U64_",104).
component("U61_",101).
component("YJR148W",442).
component("YFL030W",291).
component("YOR184W",604).
component("YNR058W",573).
component("YIL116W",391).
component("YGL253W",322).
component("YFR053C",299).
component("YMR013C",528).
component("YMR205C",534).
component("YGR240C",341).
component("YOL016C",577).
component("YFR014C",294).
component("YCR036W",188).
component("YCL040W",181).
component("U15_",44).
component("YPL188W",635).
component("YJR049C",431).
component("YEL041W",263).
component("U96_",125).
component("YKL001C",445).
component("YDR236C",236).
component("YHL032C",352).
component("YDR531W",259).
component("U83_",120).
component("U82_",119).
component("U81_",118).
component("YMR208W",535).
component("YPL203W",636).
component("YOR061W",595).
component("YKL166C",456).
component("YJL164C",418).
component("YIL035C",384).
component("YHR205W",380).
component("YHR102W",371).
component("YGL019W",306).
component("YHR025W",358).
component("YOR347C",617).
component("YAL038W",130).
component("YNR012W",568).
component("YDR127W",228).
component("YDR147W",231).
component("YCR012W",183).
component("YER069W",278).
component("U76_",114).
component("YER170W",285).
component("YDR226W",234).
component("YKL067W",448).
component("YOL055C",580).
component("YDR454C",253).
component("YJR057W",432).
component("YOL061W",583).
component("YKL181W",457).
component("YHL011C",351).
component("YER099C",284).
component("YBL068W",142).
component("YOR143C",600).
component("YNL256W",559).
component("YLR328W",506).
component("YBR018C",146).
component("YLR328W",507).
component("U94_",124).
component("YBR029C",149).
component("YGL130W",313).
component("YDR530C",258).
component("YPR190C",662).
component("YPR187W",661).
component("YPR110C",656).
component("YPR010C",650).
component("YOR341W",616).
component("YOR340C",615).
component("YOR224C",609).
component("YOR210W",608).
component("YOR207C",606).
component("YOR151C",601).
component("YOR116C",597).
component("YOL005C",575).
component("YNR003C",566).
component("YNL248C",558).
component("YNL151C",554).
component("YNL113W",551).
component("YKL144C",452).
component("YJR063W",433).
component("YJL148W",417).
component("YJL140W",416).
component("YIL021W",383).
component("YHR143W-A",373).
component("YGL070C",311).
component("YFL036W",292).
component("YDR404C",249).
component("YDR156W",232).
component("YDR045C",221).
component("YDL150W",207).
component("YDL140C",204).
component("YBR154C",162).
component("YPR175W",660).
component("YPL167C",633).
component("YOR330C",613).
component("YOL115W",589).
component("YNL299W",564).
component("YNL262W",560).
component("YNL102W",549).
component("YJR043C",430).
component("YJR006W",426).
component("YJL090C",409).
component("YIL139C",394).
component("YEL055C",266).
component("YDR419W",251).
component("YDR121W",225).
component("YDL102W",202).
component("YCR014C",184).
component("YBR278W",173).
component("YBL035C",139).
component("YPR113W",657).
component("YPL148C",631).
component("YGR286C",348).
component("YHR189W",378).
component("YDR058C",223).
component("YDL086W",200).
component("YOL011W",576).
...
component("U77_",115).
component("YLR377C",511).
component("YPR073C",653).
...
component("U9_",128).
component("YDL236W",216).
component("YPR073C",654).
component("YOR208W",607).
component("YNL053W",546).
component("YMR036C",529).
component("YIR026C",401).
component("YIL113W",390).
component("YFR028C",296).
component("YER075C",281).
component("YDL230W",215).
...
component("U25_",77).
component("U24_",76).
component("YHR044C",361).
component("YHR043C",360).
component("YOR360C",618).
component("YKR031C",465).
component("YPL206C",637).
component("YGL027C",308).
component("YLR286C",501).
component("YJR153W",443).
component("YJL221C",425).
component("YJL216C",423).
component("YIL172C",400).
component("YGR292W",350).
component("YGR287C",349).
component("YBR299W",177).
component("YOR190W",605).
component("YLR300W",503).
component("YGR282C",347).
component("YDR261C",239).
component("YDR400W",248).
component("YML035C",518).
component("YJL070C",408).
component("YBR284W",174).
component("U106_",23).
component("YER043C",272).
component("YNL045W",544).
component("YDR242W",237).
component("U53_",97).
component("YPR062W",652).
component("YMR120C",532).
component("YLR028C",478).
component("YHR144C",374).
component("YGR267C",346).
component("YBL033C",138).
component("YNL141W",552).
component("YLR245C",498).
component("YML035C",519).
component("YBR084W",153).
component("YJL126W",412).
component("U44_",90).
component("YDL100C",201).
component("U40_",88).
component("U39_",86).
component("YBR011C",145).
component("YHR201C",379).
component("YBR111C",157).
component("YBR252W",170).
component("YER005W",270).
component("YBL099W",143).
component("YLR231C",497).
component("YLR134W",486).
component("YLR044C",480).
component("YGR087C",330).
component("YDR380W",247).
component("YDL080C",198).
component("U98_",126).
component("YMR250W",536).
component("YOR128C",598).
component("YEL021W",262).
component("U93_",123).
component("YKL211C",460) :- not remove_orf("YKL211C",460).
component("YKR097W",471).
component("YNL169C",555).
component("YEL046C",264).
component("YNR033W",571).
...
component("YPL281C",648).
component("YOR393W",624).
component("YMR323W",540).
component("YHR174W",375).
component("YGR254W",343).
component("YPL262W",643).
component("YGL026C",307) :- not remove_orf("YGL026C",307).
component("YGR155W",333).
component("YLR304C",505).
component("YJL200C",421).
component("YNL316C",565).
component("YPL212C",638).
component("YNL292W",563).
component("YGL063W",310).
component("YFL001W",288).
component("YPR002W",649).
component("YJR016C",428).
component("YCR053W",190).
component("YDR127W",230).
component("YGL148W",314).
component("YIL168W",399).
component("YIL167W",398).
component("YCL064C",182).
component("YLR359W",510).
component("YAL012W",129).
component("YJL005W",403).
component("YJL121C",411).
component("YBR019C",147).
component("YDR007W",218) :- not remove_orf("YDR007W",218).
component("YOR095C",596).
component("YBR196C",165).
component("YGL001C",301).
component("YPL117C",630).
component("U14_",38).
component("YOL056W",581).
component("YKL152C",455).
component("YDL021W",191).
component("YEL058W",267).
component("YPR060C",651).
component("YHR072W",366).
component("YPL097W",628).
component("YGR185C",336).
component("YGR264C",345).
component("YGR171C",334).
component("YPL104W",629).
component("YLL018C",472).
component("YHR020W",357).
component("YER087W",282).
component("YNL247W",557).
component("YOR168W",602).
component("YOL097C",587).
component("YDR268W",240).
component("YCR024C",185).
component("YHR019C",356).
component("YPL160W",632).
component("YLR382C",512).
component("YNL073W",548).
component("YOR335C",614).
component("YLR153C",490).
component("YAL054C",131).
component("YGR244C",342).
component("YIL145C",395).
component("YJL101C",410).
component("YOL049W",579).
component("YAR015W",133).
component("YER183C",287).
component("U90_",122).
component("YNR057C",572).
component("YDL141W",205).
component("YGL234W",321).
component("YJR103W",437).
component("YBL039C",140).
component("YGR204W",339).
component("YBR084W",154).
component("YNL220W",556).
component("YDL141W",206).
component("YHR074W",367).
component("YGL062W",309).
component("YBR218C",166).
component("YPL231W",642).
component("YNR016C",569).
component("YKL182W",458).
component("YGR037C",327).
component("YPR138C",658).
component("YPL265W",644).
component("YPL036W",627).
component("YOR171C",603).
component("YOR130C",599).
component("YOR011W",594).
component("YOL156W",593).
component("YOL103W",588).
component("YOL020W",578) :- not remove_orf("YOL020W",578).
component("YNR072W",574).
component("YNL270C",561).
component("YNL142W",553).
component("YMR011W",527).
component("YLR260W",500).
component("YLR138W",487).
component("YLR100C",485).
component("YLR081W",483).
component("YLL061W",475).
component("YKR093W",470).
component("YKR053C",467).
component("YKR039W",466) :- not remove_orf("YKR039W",466).
component("YJR158W",444).
component("YJR077C",435).
component("YJL219W",424).
component("YJL214W",422).
component("YJL134W",415).
component("YJL129C",413).
component("YIL134W",393).
component("YHR096C",370).
component("YHR094C",369).
component("YHR092C",368).
component("YHL036W",353).
component("YGR121C",332).
component("YGR065C",329).
component("YGR055W",328).
component("YGL186C",316).
...
component("YER053C",273).
component("YEL069C",269).
component("YEL063C",268).
component("YEL017C-A",261).
component("YDR536W",260).
component("YDR508C",257).
component("YDR503C",256).
component("YDR497C",254).
component("YDR345C",244).
component("YDR343C",243).
component("YDR342C",242).
component("YDR297W",241).
component("YDR046C",222) :- not remove_orf("YDR046C",222).
component("YDL245C",217).
...
catalyst(8051,643).
catalyst(8052,643).
catalyst(3590,307) :- not remove_reaction(3590,307).
catalyst(10910,307) :- not remove_reaction(10910,307).
catalyst(4570,333).
catalyst(8181,505).
catalyst(8182,505).
catalyst(8181,421).
...
catalyst(7751,147).
catalyst(7752,147).
catalyst(3610,218) :- not remove_reaction(3610,218).
catalyst(7921,596).
catalyst(7922,596).
catalyst(8341,165).
catalyst(8342,165).
...
catalyst(640,470).
catalyst(6560,467).
catalyst(771,466) :- not remove_reaction(771,466).
catalyst(772,466) :- not remove_reaction(772,466).
catalyst(781,466) :- not remove_reaction(781,466).
catalyst(782,466) :- not remove_reaction(782,466).
catalyst(801,466) :- not remove_reaction(801,466).
catalyst(802,466) :- not remove_reaction(802,466).
catalyst(811,466) :- not remove_reaction(811,466).
catalyst(812,466) :- not remove_reaction(812,466).
catalyst(831,466) :- not remove_reaction(831,466).
catalyst(832,466) :- not remove_reaction(832,466).
catalyst(841,466) :- not remove_reaction(841,466).
catalyst(842,466) :- not remove_reaction(842,466).
catalyst(851,466) :- not remove_reaction(851,466).
catalyst(852,466) :- not remove_reaction(852,466).
catalyst(881,466) :- not remove_reaction(881,466).
catalyst(882,466) :- not remove_reaction(882,466).
catalyst(901,466) :- not remove_reaction(901,466).
catalyst(902,466) :- not remove_reaction(902,466).
catalyst(921,466) :- not remove_reaction(921,466).
catalyst(922,466) :- not remove_reaction(922,466).
catalyst(931,466) :- not remove_reaction(931,466).
catalyst(932,466) :- not remove_reaction(932,466).
catalyst(1191,466) :- not remove_reaction(1191,466).
catalyst(1192,466) :- not remove_reaction(1192,466).
catalyst(1210,444).
catalyst(1581,435).
catalyst(1582,435).
catalyst(1210,424).
