...
component("YLR056W",293).
component("YKR009C",281).
component("YOL086C",356).
...
component("YIL094C",239).
component("U45_",58).
component("YDR127W",138).
component("YOL126C",360).
component("YKL085W",273).
component("YDL078C",121).
component("YNL037C",330).
component("YCL018W",108).
component("YLR355C",313).
component("YDL174C",129).
component("YML086C",318).
component("YGR088W",210).
component("YDR256C",148).
component("YJR078W",267).
component("YJR025C",261).
component("U107_",22).
component("YJL026W",249).
component("YGR180C",213).
component("YER070W",174).
component("U36_",54).
component("YDL168W",128).
component("YPL276W",395).
component("YPL275W",394).
component("YOR388C",380).
component("YOR323C",374).
component("YIL125W",242).
component("U52_",62).
component("YBR166C",98).
component("YKL216W",280).
component("YKR009C",282).
component("YIL160C",245).
component("YGL205W",201).
component("YKR080W",286).
component("YER023W",169).
component("YGR204W",215).
component("YLR142W",298).
component("U65_",65).
component("U62_",64).
component("YHR068W",228).
component("YKL150W",276).
component("YIL043C",237).
component("YPL171C",388).
component("YHR179W",235).
component("YGR234W",216).
component("YDR353W",152).
component("YNL052W",331).
component("YMR256C",325).
component("YLR395C",315).
component("YLR038C",291).
component("YIL111W",240).
component("YHR051W",227).
component("YGL191W",199).
component("YGL187C",198).
component("YDL067C",120).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",393).
component("YKR069W",285).
component("YJR073C",265).
component("YDL033C",119).
component("YLR172C",300).
component("YLR058C",294).
component("YDR019C",133).
component("YBR176W",99).
component("YDR408C",157).
component("YMR120C",323).
component("YLR028C",289).
component("YBL013W",79).
component("YJL130C",254).
component("YKL024C",271).
component("YPR074C",402).
component("YBR117C",94).
component("YCL009C",107).
component("YNL071W",333).
component("U48_",60).
component("YPL231W",390).
component("YPL231W",391).
component("YLR299W",307).
component("YGL017W",189).
component("YML126C",319).
component("YDL182W",130).
component("YDL131W",124).
component("YLR258W",305).
component("YFR015C",182).
component("YNL029C",329).
component("YIL085C",238).
component("YMR306W",327).
component("YLR342W",312).
component("YGR032W",206).
component("YLR209C",301).
component("U104_",20).
component("YDR354W",153) :- not remove_orf("YDR354W",153).
component("YFR047C",184).
component("YLR209C",302).
component("YML022W",316).
component("YDR441C",159).
component("YJL167W",258).
component("YDR127W",139).
component("YHR068W",229).
component("YLR303W",309).
component("YGR012W",205).
component("YJR130C",269).
component("YDR035W",134).
component("YBR249C",101).
component("YOR274W",373).
component("YHR137W",231).
component("YGL202W",200).
component("YLR027C",288).
component("YKL106W",274).
component("YOL140W",361).
component("YLR089C",295).
component("YJR148W",270).
component("YNR058W",349).
component("YGL253W",203).
component("YFR053C",185).
component("YOL016C",352).
component("YFR014C",181).
component("YCR036W",117).
component("YCL040W",110).
component("U96_",75).
component("YDR236C",146).
component("YHL032C",222).
component("YNR012W",347).
...
component("YKL067W",272).
component("YOL055C",354).
component("YDR454C",160).
component("YJR057W",263).
component("YOL061W",355).
component("YKL181W",277).
component("YHL011C",221).
component("YER099C",177).
component("YBL068W",84).
component("YNL256W",341).
component("YBR018C",87).
component("YLR328W",311).
component("YBR029C",89).
component("YGL130W",195).
...
component("YOR207C",369).
component("YOR151C",366).
component("YOR116C",364).
component("YOL005C",350).
component("YNR003C",346).
component("YNL248C",340).
component("YNL151C",338).
component("YNL113W",335).
component("YKL144C",275).
component("YJR063W",264).
component("YJL148W",257).
component("YJL140W",256).
component("YIL021W",236).
component("YHR143W-A",232).
component("YGL070C",193).
...
component("YPR113W",404).
component("YPL148C",386).
component("YGR286C",220).
component("YOL011W",351).
component("YMR008C",321).
component("YMR006C",320).
component("U105_",21).
component("YBL015W",80).
component("U77_",73).
component("YLR377C",314).
component("YPR073C",401).
component("YOR208W",370).
component("YNL053W",332).
component("YMR036C",322).
component("YIR026C",248).
component("YIL113W",241).
component("YFR028C",183).
...
component("U29_",52).
component("U24_",51).
component("YHR044C",226).
component("YHR043C",225).
component("YOR360C",379).
component("YGL027C",191).
component("YOR190W",368).
component("YLR300W",308).
component("YGR282C",219).
component("YDR261C",149).
component("YDR400W",155).
component("YML035C",317).
component("YJL070C",250).
component("YBR284W",105).
component("YDR242W",147).
component("U53_",63).
component("YPR062W",400).
component("YMR120C",324).
component("YLR028C",290).
component("YHR144C",233).
component("YBL033C",81).
component("YNL141W",336).
component("YLR245C",304).
...
component("YLR231C",303).
component("YLR134W",297).
component("YLR044C",292).
component("YGR087C",209).
component("YDR380W",154).
component("YDL080C",122).
component("U98_",76).
component("YOR128C",365).
component("YKL211C",278) :- not remove_orf("YKL211C",278).
component("YNL169C",339).
component("YKL211C",279) :- not remove_orf("YKL211C",279).
component("YER090W",279) :- not remove_orf("YER090W",279).
component("YER090W",176) :- not remove_orf("YER090W",176).
component("YDR127W",141).
component("YPL281C",396).
component("YOR393W",381).
component("YMR323W",328).
component("YHR174W",234).
component("YGR254W",217).
component("YGL026C",190) :- not remove_orf("YGL026C",190).
component("YLR304C",310).
component("YJL200C",259).
component("YNL316C",345).
component("YPR002W",397).
component("YCR053W",118).
component("YDR127W",142).
component("YGL148W",196).
component("YIL168W",247).
component("YIL167W",246).
component("YCL064C",111).
component("YAL012W",77).
component("YBR019C",88).
component("YDR007W",132) :- not remove_orf("YDR007W",132).
component("YOR095C",363).
component("YGL001C",187).
component("YPL117C",385).
component("YPR060C",399).
component("YPL097W",383).
component("YGR185C",214).
component("YGR264C",218).
component("YGR171C",212).
component("YPL104W",384).
component("YLL018C",287).
component("YOL097C",357).
component("YDR268W",150).
component("YCR024C",114).
component("YHR019C",224).
component("YOR335C",376).
component("YLR153C",299).
component("YAL054C",78).
component("YIL145C",244).
component("U90_",74).
component("YNR057C",348).
component("YGL234W",202).
component("YJR103W",268).
component("YBL039C",83).
component("YBR084W",92).
component("YHR074W",230).
component("YGL062W",192).
component("YBR218C",100).
component("YPR138C",405).
component("YPL265W",392).
component("YPL036W",382).
component("YOR171C",367).
component("YOR011W",362).
component("YOL103W",358).
component("YOL020W",353) :- not remove_orf("YOL020W",353).
component("YNL270C",343).
component("YNL142W",337).
component("YLR260W",306).
component("YLR100C",296).
component("YKR053C",284).
component("YKR039W",283) :- not remove_orf("YKR039W",283).
component("YJR077C",266).
component("YJL134W",255).
component("YJL129C",253).
component("YHL036W",223).
component("YGR121C",211).
component("YGR065C",208).
component("YGR055W",207).
component("YGL186C",197).
component("YGL077C",194).
component("YGL008C",188).
...
catalyst(6111,365).
catalyst(6112,365).
catalyst(3600,278) :- not remove_reaction(3600,278).
catalyst(6890,339).
catalyst(3630,279) :- not remove_reaction(3630,279).
...
catalyst(8231,217).
catalyst(8232,217).
catalyst(3590,190) :- not remove_reaction(3590,190).
catalyst(10910,190) :- not remove_reaction(10910,190).
catalyst(8181,310).
catalyst(8182,310).
catalyst(8181,259).
catalyst(8182,259).
...
catalyst(851,283) :- not remove_reaction(851,283).
catalyst(852,283) :- not remove_reaction(852,283).
catalyst(881,283) :- not remove_reaction(881,283).
catalyst(882,283) :- not remove_reaction(882,283).
catalyst(901,283) :- not remove_reaction(901,283).
catalyst(902,283) :- not remove_reaction(902,283).
catalyst(931,283) :- not remove_reaction(931,283).
catalyst(932,283) :- not remove_reaction(932,283).
