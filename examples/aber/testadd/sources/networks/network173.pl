...
component("YNL280C",861).
component("YLR056W",736).
component("YGR060W",509).
component("YGL012W",475).
component("YKR009C",713).
component("YOL086C",895).
component("YMR303C",832).
component("YMR083W",808).
component("YGL256W",501).
component("YDL168W",324).
component("YBR145W",250).
component("YPL231W",983).
component("YBR265W",269).
component("U46_",148).
component("YBR149W",251).
component("YBR149W",252).
component("YJR159W",676).
component("YGL001C",471).
component("YIL094C",598).
component("YHR063C",561).
component("U45_",147).
component("YML056C",790).
component("YLR432W",779).
component("YHR216W",586).
component("YAR075W",208).
component("YAR073W",207).
component("YDR127W",359).
component("YJR139C",672).
component("YML075C",793).
component("YLR450W",782).
component("YOL126C",901).
component("YKL085W",687).
component("YDL078C",306).
component("YKL029C",682).
component("YOR136W",917).
component("YNL037C",837).
component("YNL009W",835).
component("YLR174W",750).
component("YHR183W",579).
component("YGR256W",538).
component("YNL241C",852).
component("YOL059W",892).
component("YDL022W",297).
component("YCL018W",277).
component("YLR355C",774).
component("YIL074C",595).
component("YER081W",442).
component("YML054C",789).
component("YDL174C",328).
component("YML086C",795).
component("YIL155C",608).
component("YEL024W",410).
component("YKR066C",718).
component("YGR088W",513).
component("YDR256C",374).
component("YKL026C",681).
component("YIR037W",619).
component("YBR244W",264).
component("YJR078W",664).
component("U58_",157).
component("YJR025C",655).
component("U107_",27).
component("YGR255C",537).
component("U108_",28).
component("YHR007C",549).
component("YDR402C",389).
component("YGL055W",482).
component("YJR104C",667).
component("YHR008C",550).
component("YOR384W",953).
component("YOR381W",952).
component("YOL152W",905).
component("YLL051C",728).
component("YJL026W",621).
component("YIL066C",594).
component("YGR180C",524).
component("YER070W",439).
component("U37_",141).
component("U36_",140).
component("U35_",139).
component("YDL168W",325).
component("YDR158W",367).
component("YJR009C",651).
component("YJL052W",623).
component("YGR192C",526).
component("YBR006W",223).
component("YPL276W",993).
component("YPL275W",992).
component("YOR388C",954).
component("YPL061W",963).
component("YOR374W",949).
component("YER073W",440).
component("YGL154C",491).
component("YBR115C",245).
component("U55_",156).
component("YER069W",437).
component("YOR323C",939).
component("YMR170C",818).
component("YMR169C",817).
component("YER178W",453).
component("YBR221C",262).
component("YIL125W",604).
component("U52_",153).
component("YBR166C",255).
component("YNL280C",862).
component("YGL012W",476).
component("YKL182W",699).
component("YKL216W",710).
component("YDR044W",343).
component("YER014W",421).
component("YKR009C",714).
component("YIL160C",609).
component("YGL205W",496).
component("YMR118C",812).
component("YLR164W",748).
component("YLL041C",726).
component("YKL148C",693).
component("YKL141W",691).
component("YJL045W",622).
component("YDR178W",369).
component("YJR051W",658).
component("YEL047C",414).
component("YDL171C",326).
component("YDL171C",327).
component("YOR375C",950).
component("YDL215C",332).
component("YAL062W",203).
component("U99_",197).
component("U100_",21).
component("YBR035C",232).
component("YMR189W",820).
component("YKR080W",720).
component("YER023W",423).
component("YPL023C",958).
component("YGL125W",488).
component("YOR236W",935).
component("YGR204W",529).
component("YBR084W",238).
component("YIR034C",618).
component("YLR142W",745).
component("U65_",164).
component("U63_",162).
component("U62_",161).
component("YOR356W",947).
component("YHR068W",562).
component("YKL150W",694).
component("YIL043C",591).
component("YHR042W",556).
component("YOR221C",932).
component("YMR145C",815).
component("YML120C",796).
component("YKL192C",703).
component("YKL055C",684).
component("YER061C",433).
component("YDL085W",308).
component("YPL171C",972).
component("YHR179W",578).
component("YMR145C",816).
component("YML120C",797).
component("YKL192C",704).
component("YDL085W",309).
component("YGR234W",532).
component("YFR030W",467).
component("YPL017C",957).
component("YFL018C",457).
component("YPL091W",964).
component("YDR353W",384).
component("YER042W",425).
component("YPR167C",1016).
component("YJR137C",671).
component("YNL052W",839).
component("YMR256C",828).
component("YLR395C",778).
component("YLR038C",734).
component("YIL111W",601).
component("YHR051W",560).
component("YGL191W",494).
component("YGL187C",493).
component("YDL067C",305).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",351).
component("YPL266W",990).
component("YPL273W",991).
component("YLL062C",730).
component("YDR410C",392).
component("YKR069W",719).
component("YOL096C",896).
component("U47_",149).
component("YER091C",447).
component("YJR073C",662).
component("YGR157W",520).
component("YDR120C",357).
component("YML008C",784).
component("YOR074C",911).
component("YDL033C",299).
component("YOL096C",897).
component("YLR172C",749).
component("YLR058C",737).
component("YDR019C",339).
component("YBR176W",256).
component("YDR408C",391).
component("YMR120C",813).
component("YLR028C",732).
component("YBL013W",209).
component("YJL130C",635).
component("YJL088W",628).
component("YKL024C",679).
component("YPR074C",1007).
component("YBR117C",246).
component("YLR354C",773).
component("YGR043C",507).
component("YMR108W",811).
component("YCL009C",276).
component("YMR062C",806).
component("YNL071W",841).
component("YNR008W",868).
component("YIL160C",610).
component("YNR019W",871).
component("YCR048W",292).
component("U48_",150).
component("YNL277W",860).
component("YMR062C",807).
component("YDR232W",371).
component("YPL231W",984).
component("YER061C",434).
component("YPL001W",956).
component("YDL052C",303).
component("U8_",189).
component("YDR148C",365).
component("YAR035W",205).
component("YOR377W",951).
component("YGR177C",523).
component("YPL231W",985).
component("YPL028W",959).
component("YLR299W",761).
component("YGL017W",477).
component("YCR005C",284).
component("YML126C",798).
component("YNL104C",844).
component("YDL182W",329).
component("YDL131W",315).
component("YPR160W",1015).
component("YDR307W",380).
component("YLR258W",758).
component("YFR015C",464).
component("YPL227C",981).
component("YNL029C",836).
component("YIL085C",597).
component("YNL192W",850).
component("YBR038W",234).
component("YBR023C",230).
component("YEL011W",406).
component("YMR306W",833).
component("YLR342W",771).
component("YGR032W",505).
component("YPR183W",1019).
component("YBR248C",265).
component("YLR209C",752).
component("U104_",24).
component("U103_",23).
component("YOR209C",930).
component("YMR300C",831).
component("YER055C",429).
component("YDR354W",385) :- not remove_orf("YDR354W",385).
component("YFR047C",468).
component("YJR133W",670).
component("U22_",126).
component("YLR209C",753).
component("YML022W",786).
component("YDR441C",395).
component("YHR128W",571).
component("YPR176C",1018).
component("YPL172C",973).
component("YNR041C",875).
component("YMR101C",809).
component("YDL090C",311).
component("YBR003W",222).
component("YBR002C",221).
component("YJL167W",643).
component("YJL167W",644).
component("YNL256W",855).
component("YPR069C",1004).
component("YDR127W",360).
component("YHR190W",581).
component("YLR146C",746).
component("YPL214C",979).
component("YHR068W",563).
component("YLR303W",763).
component("YGR012W",503).
component("YML082W",794).
component("YJR130C",669).
component("YLR303W",764).
component("YDR035W",341).
component("YBR249C",266).
component("YLR180W",751).
component("YDR502C",399).
component("YOR274W",936).
component("YOL143C",904).
component("YBR256C",268).
component("YHR137W",572).
component("YGL202W",495).
component("YLR027C",731).
component("YKL106W",688).
component("YOL140W",903).
component("YLR438W",781).
component("YGR019W",504).
component("YLR089C",741).
component("YDR111C",356).
component("U64_",163).
component("U61_",160).
component("U51_",152).
component("YJR148W",673).
component("YHR208W",584).
component("YFL030W",459).
component("YOR184W",923).
component("YNR058W",879).
component("YIL116W",603).
component("YGL253W",500).
component("YFR053C",469).
component("YOL136C",902).
component("YIL107C",600).
component("YMR013C",802).
component("YMR205C",822).
component("YGR240C",533).
component("YOL016C",883).
component("YFR014C",463).
component("YLR240W",756).
component("YKL203C",706).
component("YJR066W",661).
component("YCR036W",291).
component("YGR194C",527).
component("YCL040W",280).
component("U15_",69).
component("YPL188W",975).
component("YJR049C",657).
component("YEL041W",411).
component("U96_",195).
component("YKL001C",677).
component("YDR236C",372).
component("YML070W",792).
component("YFL053W",461).
component("YHL032C",547).
component("YDR531W",403).
component("U83_",183).
component("U82_",182).
component("U81_",181).
component("YMR208W",823).
component("YPL203W",976).
component("YOR061W",909).
component("YKL166C",696).
component("YJL164C",642).
component("YIL035C",590).
component("YHR205W",583).
component("YHR102W",569).
component("YGL019W",478).
component("YHR025W",555).
component("YOR347C",945).
component("YAL038W",201).
component("YNR012W",869).
component("YPR121W",1012).
component("YPL258C",987).
component("YOL055C",888).
component("YPL214C",980).
component("U1_",105).
component("YDR009W",338).
component("YDR127W",361).
component("U21_",117).
component("U20_",114).
component("YDR147W",364).
component("YDR300C",379).
component("YCR012W",285).
component("YER052C",427).
component("YER069W",438).
component("U19_",104).
component("YKL024C",680).
component("U18_",94).
component("U17_",84).
component("U76_",175).
component("YMR220W",825).
component("YER170W",452).
component("YDR226W",370).
component("YKL067W",686).
component("YOL055C",889).
component("YDR454C",396).
component("YJR057W",659).
component("YOL061W",893).
component("YKL181W",698).
component("YHL011C",545).
component("YER099C",448).
component("YBL068W",217).
component("YOR143C",919).
component("YNL256W",856).
component("YLR328W",769).
component("YBR018C",225).
component("YBR018C",226).
component("YGR007W",502).
component("YGR202C",528).
component("YLR328W",770).
component("YKR002W",712).
component("YDL045C",301).
component("U80_",180).
component("YDL103C",314).
component("U94_",194).
component("YJR010W",652).
component("YBR029C",231).
component("YCL050C",281).
component("YGL130W",489).
component("YDR530C",402).
component("YCL050C",282).
component("YPR190C",1021).
component("YPR187W",1020).
component("YPR110C",1010).
component("YPR010C",997).
component("YOR341W",944).
component("YOR340C",943).
component("YOR224C",934).
component("YOR210W",931).
component("YOR207C",928).
component("YOR151C",920).
component("YOR116C",913).
component("YOL005C",881).
component("YNR003C",867).
component("YNL248C",854).
component("YNL151C",848).
component("YNL113W",845).
component("YKL144C",692).
component("YJR063W",660).
component("YJL148W",639).
component("YJL140W",638).
component("YIL021W",589).
component("YHR143W-A",573).
component("YGL070C",486).
component("YFL036W",460).
component("YDR404C",390).
component("YDR156W",366).
component("YDR045C",344).
component("YDL150W",323).
component("YDL140C",317).
component("YBR154C",254).
component("YPR175W",1017).
component("YPL167C",971).
component("YOR330C",940).
component("YOL115W",900).
component("YNL299W",864).
component("YNL262W",858).
component("YNL102W",843).
component("YJR043C",656).
component("YJR006W",650).
component("YJL090C",629).
component("YIL139C",606).
component("YEL055C",415).
component("YDR419W",393).
component("YDR121W",358).
component("YDL102W",313).
component("YCR014C",286).
component("YBR278W",271).
component("YBL035C",213).
component("YKL035W",683).
component("YHL012W",546).
component("YHR123W",570).
component("YPR113W",1011).
component("YBR243C",263).
component("YDL142C",322).
component("YPL148C",969).
component("YER026C",424).
component("YGR286C",542).
component("YJL068C",624).
component("YHR189W",580).
component("YDR058C",349).
component("YNR034W",874).
component("YHR163W",576).
component("YGR248W",535).
component("YCR073W-A",294).
component("YDL086W",310).
component("YOL011W",882).
component("YMR008C",800).
component("YMR006C",799).
component("U105_",25).
component("YBL015W",210).
component("YJL068C",625).
component("YJR019C",654).
component("YOR040W",908).
component("U84_",184).
component("U77_",176).
component("YDR481C",397).
component("YLR377C",776).
component("YDR074W",352).
component("YFR025C",465).
component("YPL179W",974).
component("YNR032W",872).
component("YML057W",791).
component("YML016C",785).
component("YLR433C",780).
component("YGR123C",516).
component("YER133W",450).
component("YER089C",445).
component("YDR436W",394).
component("YDR075W",353).
component("YDL188C",330).
component("YDL134C",316).
component("YDL047W",302).
component("YDL006W",295).
component("YBR125C",249).
component("YBL056W",216).
component("YPR073C",1005).
component("YHR215W",585).
component("YDL024C",298).
component("YBR093C",243).
component("YBR092C",242).
component("YAR071W",206).
component("YIL053W",593).
component("YER062C",435).
component("YHR046C",559).
component("U9_",198).
component("YPL228W",982).
component("YMR180C",819).
component("YDL236W",334).
component("YJL155C",641).
component("YPR073C",1006).
component("YOR208W",929).
component("YNL053W",840).
component("YMR036C",804).
component("YIR026C",616).
component("YIL113W",602).
component("YFR028C",466).
component("YER075C",441).
component("YDL230W",333).
...
component("U25_",129).
component("U24_",128).
component("YHR044C",558).
component("YHR043C",557).
component("YOL064C",894).
component("YOR360C",948).
component("YGL248W",499).
component("YKR031C",715).
component("YPL206C",977).
component("YGL027C",480).
component("YLR286C",760).
component("YJR153W",674).
component("YJL221C",649).
component("YJL216C",647).
component("YIL172C",614).
component("YGR292W",544).
component("YGR287C",543).
component("YBR299W",275).
component("YBR184W",257).
component("YIL162W",611).
component("YPR026W",998).
component("YDR001C",336).
component("YBR001C",220).
component("YIR019C",615).
component("YIL099W",599).
component("YDL037C",300).
component("YOR190W",925).
component("YLR300W",762).
component("YGR282C",541).
component("YDR261C",375).
component("YDR400W",388).
component("U23_",127).
component("YML035C",787).
component("YJL070C",626).
component("YBR284W",272).
component("U106_",26).
component("U102_",22).
component("YER043C",426).
component("YNL045W",838).
component("YGL037C",481).
component("YDR242W",373).
component("YLR308W",768).
component("YLR307W",767).
component("YBR208C",259).
component("YMR281W",830).
component("U53_",154).
component("YIR032C",617).
component("YPR062W",1003).
component("YMR120C",814).
component("YLR028C",733).
component("YHR144C",574).
component("YHR144C",575).
component("YGR267C",540).
component("YCL030C",279).
component("YBL033C",212).
component("YBR153W",253).
component("YNL141W",846).
component("YLR245C",757).
component("YML035C",788).
component("YGR204W",530).
component("YBR084W",239).
component("YJL126W",633).
component("U44_",146).
component("YDL100C",312).
component("U87_",186).
component("U40_",144).
component("U39_",142).
component("YBR011C",224).
component("YHR201C",582).
component("YBR111C",244).
component("YBR252W",267).
component("YEL042W",412).
component("YPR080W",1008).
component("YOR187W",924).
component("YOR133W",916).
component("YLR069C",739).
component("YKR084C",721).
component("YKL173W",697).
component("YJL102W",631).
component("YDR385W",387).
component("YBR118W",247).
component("YER005W",420).
component("YLL001W",724).
component("YIL048W",592).
component("YER166W",451).
...
component("U88_",187).
component("YDR538W",405).
component("YLR134W",743).
component("YLR044C",735).
component("YGR087C",512).
component("YDR380W",386).
component("YDL080C",307).
component("U98_",196).
component("YMR250W",827).
component("YKL184W",702).
component("YOR128C",914).
component("YEL021W",409).
component("YNR043W",876).
component("U93_",193).
component("YDR047W",346).
component("U54_",155).
component("YKL211C",708) :- not remove_orf("YKL211C",708).
component("YKR097W",723).
component("YOL052C",887).
component("YNL169C",849).
component("YGR170W",521).
component("YKL060C",685).
component("YNL256W",857).
component("YDR294C",377).
component("YEL046C",413).
component("YNR033W",873).
component("YPR006C",996).
component("YER065C",436).
component("YKL211C",709) :- not remove_orf("YKL211C",709).
component("YER090W",709) :- not remove_orf("YER090W",709).
component("YER090W",446) :- not remove_orf("YER090W",446).
component("YDR127W",362).
component("YPL281C",994).
component("YOR393W",955).
component("YMR323W",834).
component("YHR174W",577).
component("YGR254W",536).
component("YOR202W",927).
component("YPL262W",988).
component("YGL026C",479) :- not remove_orf("YGL026C",479).
component("YGR155W",519).
component("YLR304C",765).
component("YJL200C",645).
component("YGL009C",474).
component("YNL316C",865).
component("YKL182W",700).
component("YPL212C",978).
component("YNL292W",863).
component("YGL063W",485).
component("YFL001W",455).
component("YOR278W",937).
component("YPR002W",995).
component("YJR016C",653).
component("YCR053W",293).
component("YDR127W",363).
component("YGL148W",490).
component("YIL168W",613).
component("YIL167W",612).
component("YCL064C",283).
component("YER086W",443).
component("YLR359W",775).
component("YAL012W",199).
component("YML004C",783).
component("YFR055W",470).
component("YJL005W",620).
component("YJL121C",632).
component("YBR019C",227).
component("YBR019C",228).
component("YDR050C",347).
component("YIL020C",588).
component("YDR007W",337) :- not remove_orf("YDR007W",337).
component("YOR095C",912).
component("YER003C",419).
component("YBR196C",258).
component("YGL001C",472).
component("YPL117C",967).
component("U14_",61).
component("YOL056W",890).
component("YKL152C",695).
component("YDL021W",296).
component("YMR105C",810).
component("YKL127W",690).
component("YEL058W",416).
component("YPR060C",1002).
component("YHR072W",564).
component("YJL153C",640).
component("YPL097W",965).
component("YGR185C",525).
component("YGR264C",539).
component("YGR171C",522).
component("YHR011W",551).
component("YDR023W",340).
component("YPL104W",966).
component("YLL018C",725).
component("YPR081C",1009).
component("YBR121C",248).
component("YHR020W",554).
component("YER087W",444).
component("YNL247W",853).
component("YOL033W",885).
component("YOR168W",921).
component("YOL097C",898).
component("YDR268W",376).
component("YPR047W",1001).
component("YLR060W",738).
component("YFL022C",458).
component("YPR033C",999).
component("YHR019C",552).
component("YCR024C",287).
component("YHR019C",553).
component("YKL194C",705).
component("YIL078W",596).
component("YPL160W",970).
component("YLR382C",777).
component("YPL040C",961).
component("YBL076C",218).
component("YNL073W",842).
component("YDR037W",342).
component("YOR335C",941).
component("YGR094W",514).
component("YLR153C",747).
component("YAL054C",202).
component("YOR317W",938).
component("YMR246W",826).
component("YIL009W",587).
component("YER015W",422).
component("YOR142W",918).
component("YGR244C",534).
component("YPR035W",1000).
component("YIL145C",607).
component("U89_",188).
component("YOR339C",942).
component("YMR022W",803).
component("YLR306W",766).
component("YKL210W",707).
component("YGR133W",518).
component("YGL058W",483).
component("YER100W",449).
component("YEL012W",407).
component("YDR177W",368).
component("YDR092W",354).
component("YDR059C",350).
component("YDR054C",348).
component("YDL064W",304).
component("YBR082C",237).
component("YJL101C",630).
component("YOL049W",886).
component("U92_",192).
component("YAR015W",204).
component("YGL234W",497).
component("YER183C",454).
component("U91_",191).
component("U90_",190).
component("YNR057C",878).
component("YDL141W",318).
component("YDL141W",319).
component("YGL234W",498).
component("YDL141W",320).
component("YJR103W",666).
component("YBL039C",214).
component("YGR204W",531).
component("YBR084W",240).
component("YNL220W",851).
component("YOL058W",891).
component("YBR208C",260).
component("YDL141W",321).
component("YHR074W",565).
component("YMR217W",824).
component("YGR061C",510).
component("YPR145W",1014).
component("YGR124W",517).
component("YJR109C",668).
component("YJL130C",636).
component("YGL062W",484).
component("YBR218C",261).
component("YPL231W",986).
component("YNR016C",870).
component("YKL182W",701).
component("YGR037C",506).
component("YJL087C",627).
component("YPR138C",1013).
component("YPL265W",989).
component("YPL134C",968).
component("YPL057C",962).
component("YPL036W",960).
component("YOR348C",946).
component("YOR222W",933).
component("YOR192C",926).
component("YOR171C",922).
component("YOR130C",915).
component("YOR071C",910).
component("YOR011W",907).
component("YOL156W",906).
component("YOL103W",899).
component("YOL020W",884) :- not remove_orf("YOL020W",884).
component("YNR072W",880).
component("YNR056C",877).
component("YNL318C",866).
component("YNL270C",859).
component("YNL142W",847).
component("YMR272C",829).
component("YMR202W",821).
component("YMR056C",805).
component("YMR011W",801).
component("YLR348C",772).
component("YLR260W",759).
component("YLR237W",755).
component("YLR138W",744).
component("YLR100C",742).
component("YLR081W",740).
component("YLL061W",729).
component("YLL043W",727).
component("YKR093W",722).
component("YKR053C",717).
component("YKR039W",716) :- not remove_orf("YKR039W",716).
component("YKL217W",711).
component("YKL120W",689).
component("YKL004W",678).
component("YJR158W",675).
component("YJR095W",665).
component("YJR077C",663).
component("YJL219W",648).
component("YJL214W",646).
component("YJL134W",637).
component("YJL129C",634).
component("YIL134W",605).
component("YHR096C",568).
component("YHR094C",567).
component("YHR092C",566).
component("YHL036W",548).
component("YGR121C",515).
component("YGR065C",511).
component("YGR055W",508).
component("YGL186C",492).
component("YGL077C",487).
component("YGL008C",473).
component("YFL055W",462).
component("YFL011W",456).
component("YER060W-A",432).
component("YER060W",431).
component("YER056C",430).
component("YER053C",428).
component("YEL069C",418).
component("YEL063C",417).
component("YEL017C-A",408).
component("YDR536W",404).
component("YDR508C",401).
component("YDR503C",400).
component("YDR497C",398).
component("YDR345C",383).
component("YDR343C",382).
component("YDR342C",381).
component("YDR297W",378).
component("YDR046C",345) :- not remove_orf("YDR046C",345).
component("YDL245C",335).
component("YDL210W",331).
component("YCR032W",290).
component("YCR028C",289).
component("YCR024C-A",288).
component("YCL025C",278).
component("YBR298C",274).
component("YBR291C",273).
component("YBR085W",241).
component("YBR069C",236) :- not remove_orf("YBR069C",236).
component("YBR068C",235) :- not remove_orf("YBR068C",235).
component("YBR036C",233).
component("YBR021W",229).
component("YBL042C",215).
component("YBL030C",211).
component("U85_",185).
component("U7_",179).
component("U79_",178).
component("U78_",177).
...
catalyst(6160,831).
catalyst(3870,429).
catalyst(3620,385) :- not remove_reaction(3620,385).
catalyst(2110,468).
catalyst(2190,468).
catalyst(5550,670).
catalyst(5301,126).
...
catalyst(1960,346).
catalyst(3460,155).
catalyst(3600,708) :- not remove_reaction(3600,708).
catalyst(8000,723).
catalyst(3941,887).
catalyst(3942,887).
catalyst(6890,849).
...
catalyst(8020,996).
catalyst(8020,436).
catalyst(1890,709) :- not remove_reaction(1890,709).
catalyst(3630,709) :- not remove_reaction(3630,709).
catalyst(1890,446) :- not remove_reaction(1890,446).
catalyst(3630,446) :- not remove_reaction(3630,446).
catalyst(3740,362).
catalyst(8231,994).
catalyst(8232,994).
catalyst(8231,955).
...
catalyst(8061,988).
catalyst(8062,988).
catalyst(3590,479) :- not remove_reaction(3590,479).
catalyst(10910,479) :- not remove_reaction(10910,479).
catalyst(4570,519).
catalyst(8181,765).
catalyst(8182,765).
catalyst(8181,645).
...
catalyst(8282,347).
catalyst(3840,588).
catalyst(3610,337) :- not remove_reaction(3610,337).
catalyst(7921,912).
catalyst(7922,912).
catalyst(7841,419).
catalyst(7842,419).
...
catalyst(1210,906).
catalyst(1160,899).
catalyst(801,884) :- not remove_reaction(801,884).
catalyst(802,884) :- not remove_reaction(802,884).
catalyst(811,884) :- not remove_reaction(811,884).
catalyst(812,884) :- not remove_reaction(812,884).
catalyst(831,884) :- not remove_reaction(831,884).
catalyst(832,884) :- not remove_reaction(832,884).
catalyst(901,884) :- not remove_reaction(901,884).
catalyst(902,884) :- not remove_reaction(902,884).
catalyst(1180,880).
catalyst(1210,880).
catalyst(700,877).
catalyst(1200,866).
...
catalyst(650,722).
catalyst(6560,717).
catalyst(681,716) :- not remove_reaction(681,716).
catalyst(682,716) :- not remove_reaction(682,716).
catalyst(771,716) :- not remove_reaction(771,716).
catalyst(772,716) :- not remove_reaction(772,716).
catalyst(781,716) :- not remove_reaction(781,716).
catalyst(782,716) :- not remove_reaction(782,716).
catalyst(791,716) :- not remove_reaction(791,716).
catalyst(792,716) :- not remove_reaction(792,716).
catalyst(801,716) :- not remove_reaction(801,716).
catalyst(802,716) :- not remove_reaction(802,716).
catalyst(811,716) :- not remove_reaction(811,716).
catalyst(812,716) :- not remove_reaction(812,716).
catalyst(831,716) :- not remove_reaction(831,716).
catalyst(832,716) :- not remove_reaction(832,716).
catalyst(841,716) :- not remove_reaction(841,716).
catalyst(842,716) :- not remove_reaction(842,716).
catalyst(851,716) :- not remove_reaction(851,716).
catalyst(852,716) :- not remove_reaction(852,716).
catalyst(881,716) :- not remove_reaction(881,716).
catalyst(882,716) :- not remove_reaction(882,716).
catalyst(901,716) :- not remove_reaction(901,716).
catalyst(902,716) :- not remove_reaction(902,716).
catalyst(911,716) :- not remove_reaction(911,716).
catalyst(912,716) :- not remove_reaction(912,716).
catalyst(921,716) :- not remove_reaction(921,716).
catalyst(922,716) :- not remove_reaction(922,716).
catalyst(931,716) :- not remove_reaction(931,716).
catalyst(932,716) :- not remove_reaction(932,716).
catalyst(1191,716) :- not remove_reaction(1191,716).
catalyst(1192,716) :- not remove_reaction(1192,716).
catalyst(390,711).
catalyst(1021,711).
catalyst(1022,711).
catalyst(1521,689).
...
catalyst(1210,381).
catalyst(6650,378).
catalyst(791,345) :- not remove_reaction(791,345).
catalyst(792,345) :- not remove_reaction(792,345).
catalyst(801,345) :- not remove_reaction(801,345).
catalyst(802,345) :- not remove_reaction(802,345).
catalyst(811,345) :- not remove_reaction(811,345).
catalyst(812,345) :- not remove_reaction(812,345).
catalyst(831,345) :- not remove_reaction(831,345).
catalyst(832,345) :- not remove_reaction(832,345).
catalyst(841,345) :- not remove_reaction(841,345).
catalyst(842,345) :- not remove_reaction(842,345).
catalyst(851,345) :- not remove_reaction(851,345).
catalyst(852,345) :- not remove_reaction(852,345).
catalyst(901,345) :- not remove_reaction(901,345).
catalyst(902,345) :- not remove_reaction(902,345).
catalyst(1180,335).
catalyst(1210,335).
catalyst(690,331).
catalyst(730,331).
...
catalyst(1512,273).
catalyst(1590,241).
catalyst(771,236) :- not remove_reaction(771,236).
catalyst(772,236) :- not remove_reaction(772,236).
...
catalyst(851,236) :- not remove_reaction(851,236).
catalyst(852,236) :- not remove_reaction(852,236).
catalyst(901,236) :- not remove_reaction(901,236).
catalyst(902,236) :- not remove_reaction(902,236).
catalyst(791,235) :- not remove_reaction(791,235).
catalyst(792,235) :- not remove_reaction(792,235).
catalyst(801,235) :- not remove_reaction(801,235).
catalyst(802,235) :- not remove_reaction(802,235).
catalyst(811,235) :- not remove_reaction(811,235).
catalyst(812,235) :- not remove_reaction(812,235).
catalyst(831,235) :- not remove_reaction(831,235).
catalyst(832,235) :- not remove_reaction(832,235).
catalyst(841,235) :- not remove_reaction(841,235).
catalyst(842,235) :- not remove_reaction(842,235).
catalyst(851,235) :- not remove_reaction(851,235).
catalyst(852,235) :- not remove_reaction(852,235).
catalyst(901,235) :- not remove_reaction(901,235).
catalyst(902,235) :- not remove_reaction(902,235).
catalyst(6600,233).
catalyst(620,229).
catalyst(540,215).
catalyst(1590,211).
...
modifiable_enzyme(385).
modifiable_enzyme(708).
modifiable_enzyme(709).
modifiable_enzyme(446).
modifiable_enzyme(479).
modifiable_enzyme(337).
modifiable_enzyme(884).
modifiable_enzyme(716).
