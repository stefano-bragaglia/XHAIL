...
component("YNL280C",894).
component("YLR056W",762).
component("YGR060W",529).
component("YGL012W",495).
component("YKR009C",738).
component("YOL086C",928).
component("YMR303C",862).
component("YMR083W",836).
component("YGL256W",521).
component("YDL168W",334).
...
component("YJR159W",701).
component("YGL001C",491).
component("YIL094C",620).
component("YHR063C",583).
component("U45_",152).
component("YML056C",817).
component("YLR432W",806).
component("YHR216W",608).
component("YAR075W",214).
component("YAR073W",213).
component("YDR127W",370).
component("YJR139C",697).
component("YML075C",820).
component("YLR450W",809).
component("YOL126C",934).
component("YKL085W",712).
component("YDL078C",315).
component("YKL029C",707).
component("YOR136W",953).
component("YNL037C",868).
component("YNL009W",866).
component("YLR174W",776).
component("YHR183W",601).
component("YGR256W",559).
component("YNL241C",884).
component("YOL059W",925).
component("YDL022W",306).
component("YCL018W",286).
component("YLR355C",801).
component("YIL074C",617).
component("YER081W",456).
component("YML054C",816).
component("YDL174C",338).
component("YML086C",822).
component("YIL155C",630).
component("YPR191W",1059).
component("YOR065W",943).
component("YJL166W",666).
component("YHR001W-A",570).
component("YGR183C",545).
component("YFR033C",487).
component("YEL024W",424).
component("YDR529C",415).
component("YBL045C",222).
component("Q0105",19).
component("YKR066C",743).
component("YGR088W",533).
component("YDR256C",386).
component("YKL026C",706).
component("YIR037W",642).
component("YBR244W",273).
component("YJR078W",689).
component("U58_",162).
component("YJR025C",680).
component("U107_",28).
component("YGR255C",558).
component("U108_",29).
component("YHR007C",571).
component("YDR402C",402).
component("YGL055W",502).
component("YJR104C",692).
component("YHR008C",572).
component("YOR384W",989).
component("YOR381W",988).
component("YOL152W",938).
component("YLL051C",754).
component("YJL026W",644).
component("YIL066C",616).
component("YGR180C",544).
component("YER070W",453).
component("U37_",146).
component("U36_",145).
component("U35_",144).
component("YDL168W",335).
component("YDR158W",378).
component("YJR009C",676).
component("YJL052W",646).
component("YGR192C",547).
component("YBR006W",231).
component("YPL276W",1030).
component("YPL275W",1029).
component("YOR388C",990).
component("YPL061W",999).
component("YOR374W",985).
component("YER073W",454).
component("YGL154C",511).
component("YBR115C",254).
component("U55_",161).
component("YER069W",451).
component("YOR323C",975).
component("YMR170C",846).
component("YMR169C",845).
component("U2_",138).
component("YER178W",470).
component("YBR221C",271).
component("YIL125W",626).
component("U52_",158).
component("YBR166C",264).
component("YNL280C",895).
component("YGL012W",496).
component("YKL182W",724).
component("YKL216W",735).
component("YDR044W",353).
component("YER014W",435).
component("YKR009C",739).
component("YIL160C",632).
component("YGL205W",516).
component("YMR118C",840).
component("YLR164W",774).
component("YLL041C",752).
component("YKL148C",718).
component("YKL141W",716).
component("YJL045W",645).
component("YDR178W",380).
component("YJR051W",683).
component("YEL047C",428).
component("YDL171C",336).
component("YDL171C",337).
component("YOR375C",986).
component("YDL215C",342).
component("YAL062W",209).
component("U99_",203).
component("U100_",22).
component("YBR035C",240).
component("YMR189W",848).
component("YKR080W",745).
component("YER023W",437).
component("YPL023C",994).
component("YGL125W",508).
component("YOR236W",971).
component("YGR204W",550).
component("YBR084W",247).
component("YIR034C",641).
component("YLR142W",771).
component("U65_",170).
component("U63_",168).
component("U62_",167).
component("YOR356W",983).
component("YHR068W",584).
component("YKL150W",719).
component("YIL043C",613).
component("YHR042W",578).
component("YOR221C",968).
component("YMR145C",843).
component("YML120C",824).
component("YKL192C",728).
component("YKL055C",709).
component("YER061C",447).
component("YDL085W",317).
component("YPL171C",1009).
component("YHR179W",600).
component("YMR145C",844).
component("YML120C",825).
component("YKL192C",729).
component("YDL085W",318).
component("YGR234W",553).
component("YFR030W",486).
component("YPL017C",993).
component("YFL018C",474).
component("YPL091W",1001).
component("YDR353W",397).
component("YER042W",439).
component("YPR167C",1053).
component("YJR137C",696).
component("YNL052W",870).
component("YMR256C",857).
component("YLR395C",805).
component("YLR038C",760).
component("YIL111W",623).
component("YHR051W",582).
component("YGL191W",514).
component("YGL187C",513).
component("YDL067C",314).
component("Q0275",21).
component("Q0250",20).
component("Q0045",18).
component("YDR072C",362).
component("YPL266W",1027).
component("YPL273W",1028).
component("YLL062C",756).
component("YDR410C",405).
component("YKR069W",744).
component("YOL096C",929).
component("U47_",154).
component("YER091C",461).
component("YJR073C",687).
component("YGR157W",540).
component("YDR120C",368).
component("YML008C",811).
component("YOR074C",945).
component("YDL033C",308).
component("YOL096C",930).
component("YLR172C",775).
component("YLR058C",763).
component("YDR019C",349).
component("YBR176W",265).
component("YDR408C",404).
component("YMR120C",841).
component("YLR028C",758).
component("YBL013W",215).
component("YJL130C",658).
component("YJL088W",651).
component("YKL024C",704).
component("YPR074C",1044).
component("YBR117C",255).
component("YLR354C",800).
component("YGR043C",527).
component("YMR108W",839).
component("YCL009C",285).
component("YMR062C",834).
component("YNL071W",872).
component("YNR008W",901).
component("YIL160C",633).
component("YNR019W",904).
component("YCR048W",301).
component("U48_",155).
component("YNL277W",893).
component("YMR062C",835).
component("YDR232W",383).
component("YPL231W",1021).
component("YER061C",448).
component("YPL001W",992).
component("YDL052C",312).
component("U8_",195).
component("YDR148C",376).
component("YAR035W",211).
component("YOR377W",987).
component("YGR177C",543).
component("YPL231W",1022).
component("YPL028W",995).
component("YLR299W",787).
component("YGL017W",497).
component("YCR005C",293).
component("YML126C",826).
component("YNL104C",875).
component("YDL182W",339).
component("YDL131W",325).
component("YPR160W",1052).
component("YDR307W",393).
component("YLR258W",784).
component("YFR015C",482).
component("YPL227C",1018).
component("YNL029C",867).
component("YIL085C",619).
component("YNL192W",882).
component("YBR038W",242).
component("YBR023C",238).
component("YEL011W",420).
component("YMR306W",864).
component("YLR342W",798).
component("YGR032W",525).
component("YPR183W",1056).
component("YBR248C",274).
component("YLR209C",778).
component("U104_",25).
component("U103_",24).
component("YMR271C",858).
component("YML106W",823).
component("YOR209C",966).
component("YMR300C",861).
component("YER055C",443).
component("YDR354W",398) :- not remove_orf("YDR354W",398).
component("YFR047C",488).
component("YJR133W",695).
component("U22_",130).
component("YLR209C",779).
component("YML022W",813).
component("YDR441C",408).
component("YHR128W",593).
component("YPR176C",1055).
component("YPL172C",1010).
component("YNR041C",908).
component("YMR101C",837).
component("YDL090C",320).
component("YBR003W",230).
component("YBR002C",229).
component("YJL167W",667).
component("YJL167W",668).
component("YNL256W",887).
component("YPR069C",1041).
component("YDR127W",371).
component("YHR190W",603).
component("YLR146C",772).
component("YPL214C",1016).
component("YHR068W",585).
component("YLR303W",789).
component("YGR012W",523).
component("YML082W",821).
component("YJR130C",694).
component("YLR303W",790).
component("YDR035W",351).
component("YBR249C",275).
component("YLR180W",777).
component("YDR502C",412).
component("YOR274W",972).
component("YOL143C",937).
component("YBR256C",277).
component("YHR137W",594).
component("YGL202W",515).
component("YLR027C",757).
component("YKL106W",713).
component("YOL140W",936).
component("YLR438W",808).
component("YGR019W",524).
component("YLR089C",767).
component("YDR111C",367).
component("U64_",169).
component("U61_",166).
component("U51_",157).
component("YJR148W",698).
component("YHR208W",606).
component("YFL030W",476).
component("YOR184W",959).
component("YNR058W",912).
component("YIL116W",625).
component("YGL253W",520).
component("YFR053C",489).
component("YOL136C",935).
component("YIL107C",622).
component("YMR013C",830).
component("YMR205C",850).
component("YGR240C",554).
component("YOL016C",916).
component("YFR014C",481).
component("YLR240W",782).
component("YKL203C",731).
component("YJR066W",686).
component("YCR036W",300).
component("YGR194C",548).
component("YCL040W",289).
component("U15_",71).
component("YPL188W",1012).
component("YJR049C",682).
component("YEL041W",425).
component("U96_",201).
component("YKL001C",702).
component("YDR236C",384).
component("YML070W",819).
component("YFL053W",478).
component("YHL032C",568).
component("YDR531W",417).
component("U83_",189).
component("U82_",188).
component("U81_",187).
component("YMR208W",851).
component("YPL203W",1013).
component("YOR061W",942).
component("YKL166C",721).
component("YJL164C",665).
component("YIL035C",612).
component("YHR205W",605).
component("YHR102W",591).
component("YGL019W",498).
component("YHR025W",577).
component("YOR347C",981).
component("YAL038W",207).
component("YNR012W",902).
component("YPR121W",1049).
component("YPL258C",1024).
component("YOL055C",921).
component("YPL214C",1017).
component("U1_",107).
component("YDR009W",348).
component("YNL267W",891).
component("YLR305C",792).
component("YFR019W",483).
component("YDR208W",381).
component("YDR127W",372).
component("U21_",121).
component("U20_",116).
component("YDR147W",375).
component("YDR300C",392).
component("YCR012W",294).
component("YER052C",441).
component("YER069W",452).
component("U19_",106).
component("YKL024C",705).
component("U18_",96).
component("U17_",86).
component("U76_",181).
component("YMR220W",853).
component("YER170W",469).
component("YDR226W",382).
component("YKL067W",711).
component("YOL055C",922).
component("YDR454C",409).
component("YJR057W",684).
component("YOL061W",926).
component("YKL181W",723).
component("YHL011C",566).
component("YER099C",463).
component("YBL068W",225).
component("YOR143C",955).
component("YNL256W",888).
component("YLR328W",796).
component("YBR018C",233).
component("YBR018C",234).
component("YGR007W",522).
component("YGR202C",549).
component("YLR328W",797).
component("YKR002W",737).
component("YDL045C",310).
component("U80_",186).
component("YDL103C",323).
component("U94_",200).
component("YJR010W",677).
component("YBR029C",239).
component("YCL050C",290).
component("YGL130W",509).
component("YDR530C",416).
component("YCL050C",291).
component("YPR190C",1058).
component("YPR187W",1057).
component("YPR110C",1047).
component("YPR010C",1034).
component("YOR341W",980).
component("YOR340C",979).
component("YOR224C",970).
component("YOR210W",967).
component("YOR207C",964).
component("YOR151C",956).
component("YOR116C",948).
component("YOL005C",914).
component("YNR003C",900).
component("YNL248C",886).
component("YNL151C",879).
component("YNL113W",876).
component("YKL144C",717).
component("YJR063W",685).
component("YJL148W",662).
component("YJL140W",661).
component("YIL021W",611).
component("YHR143W-A",595).
component("YGL070C",506).
component("YFL036W",477).
component("YDR404C",403).
component("YDR156W",377).
component("YDR045C",354).
component("YDL150W",333).
component("YDL140C",327).
component("YBR154C",263).
component("YPR175W",1054).
component("YPL167C",1008).
component("YOR330C",976).
component("YOL115W",933).
component("YNL299W",897).
component("YNL262W",890).
component("YNL102W",874).
component("YJR043C",681).
component("YJR006W",675).
component("YJL090C",652).
component("YIL139C",628).
component("YEL055C",429).
component("YDR419W",406).
component("YDR121W",369).
component("YDL102W",322).
component("YCR014C",295).
component("YBR278W",280).
component("YBL035C",219).
component("YKL035W",708).
component("YHL012W",567).
component("YHR123W",592).
component("YPR113W",1048).
component("YBR243C",272).
component("YDL142C",332).
component("YPL148C",1006).
component("YER026C",438).
component("YGR286C",563).
component("YJL068C",647).
component("YHR189W",602).
component("YDR058C",359).
component("YNR034W",907).
component("YHR163W",598).
component("YGR248W",556).
component("YCR073W-A",303).
component("YDL086W",319).
component("YOL011W",915).
component("YMR008C",828).
component("YMR006C",827).
component("U105_",26).
component("YBL015W",216).
component("YJL068C",648).
component("YPL072W",1000).
component("YOR124C",949).
component("YNL186W",881).
component("YMR304W",863).
component("YMR223W",854).
component("YKR098C",749).
component("YJL197W",669).
component("YIL156W",631).
component("YFR010W",480).
component("YER151C",467).
component("YER144C",466).
component("YER098W",462).
component("YDR069C",361).
component("YDL122W",324).
component("YBR058C",243).
component("YBL067C",224).
component("YJR019C",679).
component("YOR040W",941).
component("U84_",190).
component("U77_",182).
component("YDR481C",410).
component("YLR377C",803).
component("YDR074W",363).
component("YFR025C",484).
component("YPL179W",1011).
component("YNR032W",905).
component("YML057W",818).
component("YML016C",812).
component("YLR433C",807).
component("YGR123C",536).
component("YER133W",465).
component("YER089C",459).
component("YDR436W",407).
component("YDR075W",364).
component("YDL188C",340).
component("YDL134C",326).
component("YDL047W",311).
component("YDL006W",304).
component("YBR125C",258).
component("YBL056W",223).
component("YPR073C",1042).
component("YHR215W",607).
component("YDL024C",307).
component("YBR093C",252).
component("YBR092C",251).
component("YAR071W",212).
component("YIL053W",615).
component("YER062C",449).
component("YHR046C",581).
component("U9_",204).
component("YPL228W",1019).
component("YMR180C",847).
component("YDL236W",344).
component("YJL155C",664).
component("YPR073C",1043).
component("YOR208W",965).
component("YNL053W",871).
component("YMR036C",832).
component("YIR026C",639).
component("YIL113W",624).
component("YFR028C",485).
component("YER075C",455).
component("YDL230W",343).
...
component("U25_",133).
component("U24_",132).
component("YHR044C",580).
component("YHR043C",579).
component("YOL064C",927).
component("YOR360C",984).
component("YGL248W",519).
component("YKR031C",740).
component("YPL206C",1014).
component("YGL027C",500).
component("YLR286C",786).
component("YJR153W",699).
component("YJL221C",674).
component("YJL216C",672).
component("YIL172C",637).
component("YGR292W",565).
component("YGR287C",564).
component("YBR299W",284).
component("YBR184W",266).
component("YIL162W",634).
component("YPR026W",1035).
component("YDR001C",346).
component("YBR001C",228).
component("YIR019C",638).
component("YIL099W",621).
component("YDL037C",309).
component("YOR190W",961).
component("YLR300W",788).
component("YGR282C",562).
component("YDR261C",387).
component("YDR400W",401).
component("U23_",131).
component("YML035C",814).
component("YJL070C",649).
component("YBR284W",281).
component("U106_",27).
component("U102_",23).
component("YER043C",440).
component("YNL045W",869).
component("YGL037C",501).
component("YDR242W",385).
component("YLR308W",795).
component("YLR307W",794).
component("YBR208C",268).
component("YMR281W",860).
component("U53_",159).
component("YIR032C",640).
component("YPR062W",1040).
component("YMR120C",842).
component("YLR028C",759).
component("YHR144C",596).
component("YHR144C",597).
component("YGR267C",561).
component("YCL030C",288).
component("YBL033C",218).
component("YBR153W",262).
component("YNL141W",877).
component("YLR245C",783).
component("YML035C",815).
component("YGR204W",551).
component("YBR084W",248).
component("YJL126W",656).
component("U44_",151).
component("YDL100C",321).
component("U87_",192).
component("U40_",149).
component("U39_",147).
component("YBR011C",232).
component("YHR201C",604).
component("YBR111C",253).
component("YBR252W",276).
component("YEL042W",426).
component("YPR080W",1045).
component("YOR187W",960).
component("YOR133W",952).
component("YLR069C",765).
component("YKR084C",746).
component("YKL173W",722).
component("YJL102W",654).
component("YDR385W",400).
component("YBR118W",256).
component("YER005W",434).
component("YLL001W",750).
component("YIL048W",614).
component("YER166W",468).
component("YDR093W",366).
component("YAL026C",206).
component("YBL099W",227).
component("U60_",165).
component("YLR231C",780).
component("U88_",193).
component("YDR538W",419).
component("YLR134W",769).
component("YLR044C",761).
component("YGR087C",532).
component("YDR380W",399).
component("YDL080C",316).
component("U98_",202).
component("YMR250W",856).
component("YKL184W",727).
component("YOR128C",950).
component("YEL021W",423).
component("YNR043W",909).
component("U93_",199).
component("YDR047W",356).
component("U54_",160).
component("YKL211C",733) :- not remove_orf("YKL211C",733).
component("YKR097W",748).
component("YOL052C",920).
component("YNL169C",880).
component("YGR170W",541).
component("YKL060C",710).
component("YNL256W",889).
component("YDR294C",390).
component("YEL046C",427).
component("YNR033W",906).
component("YPR006C",1033).
component("YER065C",450).
component("YKL211C",734) :- not remove_orf("YKL211C",734).
component("YER090W",734) :- not remove_orf("YER090W",734).
component("YER090W",460) :- not remove_orf("YER090W",460).
component("YDR127W",373).
component("YPL281C",1031).
component("YOR393W",991).
component("YMR323W",865).
component("YHR174W",599).
component("YGR254W",557).
component("YOR202W",963).
component("YPL262W",1025).
component("YGL026C",499) :- not remove_orf("YGL026C",499).
component("YGR155W",539).
component("YLR304C",791).
component("YJL200C",670).
component("YGL009C",494).
component("YNL316C",898).
component("YKL182W",725).
component("YPL212C",1015).
component("YNL292W",896).
component("YGL063W",505).
component("YFL001W",472).
component("YOR278W",973).
component("YPR002W",1032).
component("YJR016C",678).
component("YCR053W",302).
component("YDR127W",374).
component("YGL148W",510).
component("YIL168W",636).
component("YIL167W",635).
component("YCL064C",292).
component("YER086W",457).
component("YLR359W",802).
component("YAL012W",205).
component("YML004C",810).
component("YFR055W",490).
component("YJL005W",643).
component("YJL121C",655).
component("YBR019C",235).
component("YBR019C",236).
component("U59_",163).
component("YDR050C",357).
component("YIL020C",610).
component("YDR007W",347) :- not remove_orf("YDR007W",347).
component("YOR095C",946).
component("YER003C",433).
component("YBR196C",267).
component("YGL001C",492).
component("YPL117C",1004).
component("U14_",63).
component("YOL056W",923).
component("YKL152C",720).
component("YDL021W",305).
component("YMR105C",838).
component("YKL127W",715).
component("YEL058W",430).
component("YPR060C",1039).
component("YHR072W",586).
component("YJL153C",663).
component("YPL097W",1002).
component("YGR185C",546).
component("YGR264C",560).
component("YGR171C",542).
component("YHR011W",573).
component("YDR023W",350).
component("YPL104W",1003).
component("YLL018C",751).
component("YPR081C",1046).
component("YBR121C",257).
component("YHR020W",576).
component("YER087W",458).
component("YNL247W",885).
component("YOL033W",918).
component("YOR168W",957).
component("YOL097C",931).
component("YDR268W",388).
component("YPR047W",1038).
component("YLR060W",764).
component("YFL022C",475).
component("YPR033C",1036).
component("YHR019C",574).
component("YCR024C",296).
component("YHR019C",575).
component("YKL194C",730).
component("YIL078W",618).
component("YPL160W",1007).
component("YLR382C",804).
component("YPL040C",997).
component("YBL076C",226).
component("YNL073W",873).
component("YDR037W",352).
component("YOR335C",977).
component("YGR094W",534).
component("YLR153C",773).
component("YAL054C",208).
component("YOR317W",974).
component("YMR246W",855).
component("YIL009W",609).
component("YER015W",436).
component("YOR142W",954).
component("YGR244C",555).
component("YPR035W",1037).
component("YIL145C",629).
component("U89_",194).
component("YOR339C",978).
component("YMR022W",831).
component("YLR306W",793).
component("YKL210W",732).
component("YGR133W",538).
component("YGL058W",503).
component("YER100W",464).
component("YEL012W",421).
component("YDR177W",379).
component("YDR092W",365).
component("YDR059C",360).
component("YDR054C",358).
component("YDL064W",313).
component("YBR082C",246).
component("YJL101C",653).
component("YOL049W",919).
component("U92_",198).
component("YAR015W",210).
component("YGL234W",517).
component("YER183C",471).
component("U91_",197).
component("U90_",196).
component("YNR057C",911).
component("YDL141W",328).
component("YDL141W",329).
component("YGL234W",518).
component("YDL141W",330).
component("YJR103W",691).
component("YBL039C",220).
component("YGR204W",552).
component("YBR084W",249).
component("YNL220W",883).
component("YOL058W",924).
component("YBR208C",269).
component("YDL141W",331).
component("YHR074W",587).
component("YMR217W",852).
component("YGR061C",530).
component("YPR145W",1051).
component("YGR124W",537).
component("YJR109C",693).
component("YJL130C",659).
component("YGL062W",504).
component("YBR218C",270).
component("YPL231W",1023).
component("YNR016C",903).
component("YKL182W",726).
component("YGR037C",526).
component("YJL087C",650).
component("YPR138C",1050).
component("YPL265W",1026).
component("YPL134C",1005).
component("YPL057C",998).
component("YPL036W",996).
component("YOR348C",982).
component("YOR222W",969).
component("YOR192C",962).
component("YOR171C",958).
component("YOR130C",951).
component("YOR100C",947).
component("YOR071C",944).
component("YOR011W",940).
component("YOL156W",939).
component("YOL103W",932).
component("YOL020W",917) :- not remove_orf("YOL020W",917).
component("YNR072W",913).
component("YNR056C",910).
component("YNL318C",899).
component("YNL270C",892).
component("YNL142W",878).
component("YMR272C",859).
component("YMR202W",849).
component("YMR056C",833).
component("YMR011W",829).
component("YLR348C",799).
component("YLR260W",785).
component("YLR237W",781).
component("YLR138W",770).
component("YLR100C",768).
component("YLR081W",766).
component("YLL061W",755).
component("YLL043W",753).
component("YKR093W",747).
component("YKR053C",742).
component("YKR039W",741) :- not remove_orf("YKR039W",741).
component("YKL217W",736).
component("YKL120W",714).
component("YKL004W",703).
component("YJR158W",700).
component("YJR095W",690).
component("YJR077C",688).
component("YJL219W",673).
component("YJL214W",671).
component("YJL134W",660).
component("YJL129C",657).
component("YIL134W",627).
component("YHR096C",590).
component("YHR094C",589).
component("YHR092C",588).
component("YHL036W",569).
component("YGR121C",535).
component("YGR065C",531).
component("YGR055W",528).
component("YGL186C",512).
component("YGL077C",507).
component("YGL008C",493).
component("YFL055W",479).
component("YFL011W",473).
component("YER060W-A",446).
component("YER060W",445).
component("YER056C",444).
component("YER053C",442).
component("YEL069C",432).
component("YEL063C",431).
component("YEL017C-A",422).
component("YDR536W",418).
component("YDR508C",414).
component("YDR503C",413).
component("YDR497C",411).
component("YDR345C",396).
component("YDR343C",395).
component("YDR342C",394).
component("YDR297W",391).
component("YDR284C",389).
component("YDR046C",355) :- not remove_orf("YDR046C",355).
component("YDL245C",345).
component("YDL210W",341).
component("YCR032W",299).
component("YCR028C",298).
component("YCR024C-A",297).
component("YCL025C",287).
component("YBR298C",283).
component("YBR291C",282).
component("YBR085W",250).
component("YBR069C",245) :- not remove_orf("YBR069C",245).
component("YBR068C",244) :- not remove_orf("YBR068C",244).
component("YBR036C",241).
component("YBR021W",237).
component("YBL042C",221).
component("YBL030C",217).
component("U85_",191).
component("U7_",185).
component("U79_",184).
component("U78_",183).
...
catalyst(6160,861).
catalyst(3870,443).
catalyst(3620,398) :- not remove_reaction(3620,398).
catalyst(2110,488).
catalyst(2190,488).
catalyst(5550,695).
catalyst(5301,130).
...
catalyst(1960,356).
catalyst(3460,160).
catalyst(3600,733) :- not remove_reaction(3600,733).
catalyst(8000,748).
catalyst(3941,920).
catalyst(3942,920).
catalyst(6890,880).
...
catalyst(8020,1033).
catalyst(8020,450).
catalyst(1890,734) :- not remove_reaction(1890,734).
catalyst(3630,734) :- not remove_reaction(3630,734).
catalyst(1890,460) :- not remove_reaction(1890,460).
catalyst(3630,460) :- not remove_reaction(3630,460).
catalyst(3740,373).
catalyst(8231,1031).
catalyst(8232,1031).
catalyst(8231,991).
...
catalyst(1210,939).
catalyst(1160,932).
catalyst(801,917) :- not remove_reaction(801,917).
catalyst(802,917) :- not remove_reaction(802,917).
catalyst(811,917) :- not remove_reaction(811,917).
catalyst(812,917) :- not remove_reaction(812,917).
catalyst(831,917) :- not remove_reaction(831,917).
catalyst(832,917) :- not remove_reaction(832,917).
catalyst(901,917) :- not remove_reaction(901,917).
catalyst(902,917) :- not remove_reaction(902,917).
catalyst(1180,913).
catalyst(1210,913).
catalyst(700,910).
catalyst(1200,899).
...
catalyst(650,747).
catalyst(6560,742).
catalyst(681,741) :- not remove_reaction(681,741).
catalyst(682,741) :- not remove_reaction(682,741).
catalyst(771,741) :- not remove_reaction(771,741).
catalyst(772,741) :- not remove_reaction(772,741).
catalyst(781,741) :- not remove_reaction(781,741).
catalyst(782,741) :- not remove_reaction(782,741).
catalyst(791,741) :- not remove_reaction(791,741).
catalyst(792,741) :- not remove_reaction(792,741).
catalyst(801,741) :- not remove_reaction(801,741).
catalyst(802,741) :- not remove_reaction(802,741).
catalyst(811,741) :- not remove_reaction(811,741).
catalyst(812,741) :- not remove_reaction(812,741).
catalyst(831,741) :- not remove_reaction(831,741).
catalyst(832,741) :- not remove_reaction(832,741).
catalyst(841,741) :- not remove_reaction(841,741).
catalyst(842,741) :- not remove_reaction(842,741).
catalyst(851,741) :- not remove_reaction(851,741).
catalyst(852,741) :- not remove_reaction(852,741).
catalyst(881,741) :- not remove_reaction(881,741).
catalyst(882,741) :- not remove_reaction(882,741).
catalyst(901,741) :- not remove_reaction(901,741).
catalyst(902,741) :- not remove_reaction(902,741).
catalyst(911,741) :- not remove_reaction(911,741).
catalyst(912,741) :- not remove_reaction(912,741).
catalyst(921,741) :- not remove_reaction(921,741).
catalyst(922,741) :- not remove_reaction(922,741).
catalyst(931,741) :- not remove_reaction(931,741).
catalyst(932,741) :- not remove_reaction(932,741).
catalyst(1191,741) :- not remove_reaction(1191,741).
catalyst(1192,741) :- not remove_reaction(1192,741).
catalyst(390,736).
catalyst(1021,736).
catalyst(1022,736).
catalyst(1521,714).
...
catalyst(851,355) :- not remove_reaction(851,355).
catalyst(852,355) :- not remove_reaction(852,355).
...
catalyst(791,244) :- not remove_reaction(791,244).
catalyst(792,244) :- not remove_reaction(792,244).
catalyst(801,244) :- not remove_reaction(801,244).
catalyst(802,244) :- not remove_reaction(802,244).
catalyst(811,244) :- not remove_reaction(811,244).
catalyst(812,244) :- not remove_reaction(812,244).
catalyst(831,244) :- not remove_reaction(831,244).
catalyst(832,244) :- not remove_reaction(832,244).
catalyst(841,244) :- not remove_reaction(841,244).
catalyst(842,244) :- not remove_reaction(842,244).
catalyst(851,244) :- not remove_reaction(851,244).
catalyst(852,244) :- not remove_reaction(852,244).
catalyst(901,244) :- not remove_reaction(901,244).
catalyst(902,244) :- not remove_reaction(902,244).
catalyst(6600,241).
catalyst(620,237).
catalyst(540,221).
catalyst(1590,217).
...
modifiable_enzyme(398).
modifiable_enzyme(733).
modifiable_enzyme(734).
modifiable_enzyme(460).
modifiable_enzyme(499).
modifiable_enzyme(347).
modifiable_enzyme(917).
modifiable_enzyme(741).
modifiable_enzyme(355).
modifiable_enzyme(245).
modifiable_enzyme(244).
