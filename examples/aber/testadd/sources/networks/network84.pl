...
component("YLR056W",440).
component("YGL012W",280).
component("YKR009C",424).
component("YOL086C",533).
component("YMR303C",490).
component("YGL256W",300).
component("YDL168W",191).
component("YBR145W",146).
component("YPL231W",584).
component("YBR265W",157).
component("U46_",85).
component("YBR149W",147).
component("YBR149W",148).
component("YGL001C",277).
component("YIL094C",357).
component("U45_",84).
component("YML056C",473).
component("YLR432W",470).
component("YHR216W",351).
component("YAR075W",124).
component("YAR073W",123).
component("YDR127W",206).
component("YOL126C",538).
component("YKL085W",411).
component("YDL078C",181).
component("YNL037C",495).
component("YNL009W",493).
component("YLR174W",450).
component("YOL059W",531).
component("YDL022W",177).
component("YCL018W",165).
component("YLR355C",466).
component("YDL174C",194).
component("YML086C",475).
component("YGR088W",308).
component("YDR256C",217).
component("YJR078W",400).
component("YJR025C",393).
component("U107_",24).
component("YJR104C",402).
component("YHR008C",327).
component("YOR384W",568).
component("YOR381W",567).
component("YOL152W",540).
component("YLL051C",434).
component("YJL026W",371).
component("YIL066C",355).
component("YGR180C",311).
component("YER070W",256).
component("U37_",78).
component("U36_",77).
component("YDL168W",192).
component("YBR006W",132).
component("YPL276W",592).
component("YPL275W",591).
component("YOR388C",569).
component("YOR374W",566).
component("YER073W",257).
component("YGL154C",292).
component("U55_",91).
component("YER069W",254).
component("YOR323C",559).
component("YER178W",263).
component("YBR221C",154).
component("YIL125W",361).
component("U52_",89).
component("YBR166C",150).
component("YGL012W",281).
component("YKL216W",423).
component("YKR009C",425).
component("YIL160C",365).
component("YGL205W",297).
component("YMR118C",482).
component("YLR164W",448).
component("YLL041C",433).
component("YKL148C",414).
component("YJL045W",372).
component("YDR178W",213).
component("YEL047C",243).
component("YDL171C",193).
component("U99_",117).
component("U100_",20).
component("YKR080W",430).
component("YER023W",248).
component("YOR236W",557).
component("YGR204W",313).
component("YLR142W",446).
component("U65_",97).
component("U63_",95).
component("U62_",94).
component("YHR068W",335).
component("YKL150W",415).
component("YIL043C",354).
component("YPL171C",579).
component("YHR179W",346).
component("YMR145C",485).
component("YML120C",476).
component("YKL192C",420).
component("YDL085W",183).
component("YGR234W",315).
component("YFR030W",274).
component("YPL017C",571).
component("YFL018C",267).
component("YDR353W",224).
component("YPR167C",604).
component("YJR137C",404).
component("YNL052W",496).
component("YMR256C",489).
component("YLR395C",469).
component("YLR038C",438).
component("YIL111W",358).
component("YHR051W",334).
component("YGL191W",295).
component("YGL187C",294).
component("YDL067C",180).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",590).
component("YKR069W",429).
component("YOL096C",534).
component("U47_",86).
component("YJR073C",398).
component("YDR120C",204).
component("YDL033C",179).
component("YLR172C",449).
component("YLR058C",441).
component("YDR019C",200).
component("YBR176W",151).
component("YDR408C",229).
component("YMR120C",483).
component("YLR028C",436).
component("YBL013W",125).
component("YJL130C",380).
component("YKL024C",409).
component("YPR074C",600).
component("YBR117C",145).
component("YCL009C",164).
component("YNL071W",498).
component("YIL160C",366).
component("U48_",87).
component("YPL231W",585).
component("YPL231W",586).
component("YPL028W",572).
component("YLR299W",459).
component("YGL017W",282).
component("YML126C",477).
component("YNL104C",501).
component("YDL182W",195).
component("YDL131W",187).
component("YLR258W",456).
component("YFR015C",272).
component("YNL029C",494).
component("YIL085C",356).
component("YMR306W",491).
component("YLR342W",465).
component("YGR032W",303).
component("YLR209C",452).
component("U104_",21).
component("YDR354W",225) :- not remove_orf("YDR354W",225).
component("YFR047C",275).
component("YLR209C",453).
component("YML022W",471).
component("YDR441C",231).
component("YJL167W",385).
component("YDR127W",207).
component("YHR068W",336).
component("YLR303W",461).
component("YGR012W",301).
component("YML082W",474).
component("YJR130C",403).
component("YDR035W",201).
component("YBR249C",155).
component("YLR180W",451).
component("YDR502C",234).
component("YOR274W",558).
component("YHR137W",342).
component("YGL202W",296).
component("YLR027C",435).
component("YKL106W",412).
component("YOL140W",539).
component("YGR019W",302).
component("YLR089C",443).
component("U64_",96).
component("U61_",93).
component("YJR148W",405).
component("YFL030W",268).
component("YOR184W",551).
component("YNR058W",522).
component("YIL116W",360).
component("YGL253W",299).
component("YFR053C",276).
component("YMR205C",486).
component("YGR240C",316).
component("YOL016C",526).
component("YFR014C",271).
component("YCR036W",174).
component("YCL040W",167).
component("U15_",43).
component("YPL188W",580).
component("YJR049C",395).
component("YEL041W",241).
component("U96_",115).
component("YKL001C",408).
component("YDR236C",215).
component("YHL032C",325).
component("YDR531W",238).
component("U83_",111).
component("U81_",110).
component("YMR208W",487).
component("YPL203W",581).
component("YOR061W",543).
component("YKL166C",417).
component("YJL164C",384).
component("YIL035C",353).
component("YHR205W",349).
component("YHR102W",341).
component("YGL019W",283).
component("YHR025W",330).
component("YOR347C",564).
component("YAL038W",120).
component("YNR012W",518).
component("YDR127W",208).
component("YDR147W",211).
component("YCR012W",169).
component("YER069W",255).
component("U76_",106).
component("YER170W",262).
component("YDR226W",214).
component("YKL067W",410).
component("YOL055C",529).
component("YDR454C",232).
component("YJR057W",396).
component("YOL061W",532).
component("YKL181W",418).
component("YHL011C",324).
component("YER099C",261).
component("YBL068W",130).
component("YOR143C",547).
component("YNL256W",510).
component("YLR328W",463).
component("YBR018C",134).
component("YLR328W",464).
component("U94_",114).
component("YBR029C",137).
component("YGL130W",290).
component("YDR530C",237).
component("YPR190C",607).
component("YPR187W",606).
component("YPR110C",601).
component("YPR010C",595).
component("YOR341W",563).
component("YOR340C",562).
component("YOR224C",556).
component("YOR210W",555).
component("YOR207C",553).
component("YOR151C",548).
component("YOR116C",545).
component("YOL005C",524).
component("YNR003C",517).
component("YNL248C",509).
component("YNL151C",505).
component("YNL113W",502).
component("YKL144C",413).
component("YJR063W",397).
component("YJL148W",383).
component("YJL140W",382).
component("YIL021W",352).
component("YHR143W-A",343).
...
component("YJR043C",394).
component("YJR006W",391).
component("YJL090C",375).
component("YIL139C",363).
component("YEL055C",244).
component("YDR419W",230).
component("YDR121W",205).
component("YDL102W",186).
component("YCR014C",170).
component("YBR278W",159).
component("YBL035C",128).
component("YPR113W",602).
component("YPL148C",577).
component("YGR286C",321).
component("YHR189W",347).
component("YDL086W",184).
component("YOL011W",525).
component("YMR008C",479).
component("YMR006C",478).
component("U105_",22).
component("YBL015W",126).
component("YJL068C",373).
component("U77_",107).
component("YLR377C",468).
component("YPR073C",598).
component("YHR215W",350).
component("YDL024C",178).
component("YBR093C",143).
component("YBR092C",142).
component("YHR046C",333).
component("U9_",118).
component("YDL236W",197).
component("YPR073C",599).
component("YOR208W",554).
component("YNL053W",497).
component("YMR036C",481).
component("YIR026C",370).
component("YIL113W",359).
component("YFR028C",273).
component("YER075C",258).
component("YDL230W",196).
component("YBR276C",158).
component("U34_",76).
component("U32_",75).
component("U31_",74).
component("U30_",73).
...
component("U25_",70).
component("U24_",69).
component("YHR044C",332).
component("YHR043C",331).
component("YOR360C",565).
component("YKR031C",426).
component("YPL206C",582).
component("YGL027C",285).
component("YLR286C",458).
component("YJR153W",406).
component("YJL221C",390).
component("YJL216C",388).
component("YIL172C",369).
component("YGR292W",323).
component("YGR287C",322).
component("YBR299W",163).
component("YOR190W",552).
component("YLR300W",460).
component("YGR282C",320).
component("YDR261C",218).
component("YDR400W",227).
component("YML035C",472).
component("YJL070C",374).
component("YBR284W",160).
component("U106_",23).
component("YER043C",249).
component("YDR242W",216).
component("U53_",90).
component("YPR062W",597).
component("YMR120C",484).
component("YLR028C",437).
component("YHR144C",344).
component("YBL033C",127).
component("YNL141W",503).
component("YLR245C",455).
component("YBR084W",140).
component("YJL126W",378).
component("U44_",83).
component("YDL100C",185).
component("U40_",81).
component("U39_",79).
component("YBR011C",133).
component("YHR201C",348).
component("YBR111C",144).
component("YBR252W",156).
component("YER005W",247).
component("YBL099W",131).
component("YLR231C",454).
component("YLR134W",445).
component("YLR044C",439).
component("YGR087C",307).
component("YDR380W",226).
component("YDL080C",182).
component("U98_",116).
component("YMR250W",488).
component("YOR128C",546).
component("U93_",113).
component("YKL211C",421) :- not remove_orf("YKL211C",421).
component("YKR097W",431).
component("YNL169C",506).
component("YEL046C",242).
component("YNR033W",520).
...
component("YHR174W",345).
component("YGR254W",318).
component("YPL262W",588).
component("YGL026C",284) :- not remove_orf("YGL026C",284).
component("YLR304C",462).
component("YJL200C",386).
component("YNL316C",516).
component("YPL212C",583).
component("YNL292W",514).
component("YGL063W",287).
component("YFL001W",265).
component("YPR002W",594).
component("YJR016C",392).
component("YCR053W",175).
component("YDR127W",210).
component("YGL148W",291).
component("YIL168W",368).
component("YIL167W",367).
component("YCL064C",168).
component("YLR359W",467).
component("YAL012W",119).
component("YJL121C",377).
component("YBR019C",135).
component("YDR007W",199) :- not remove_orf("YDR007W",199).
component("YOR095C",544).
component("YBR196C",152).
component("YGL001C",278).
component("YPL117C",576).
component("U14_",37).
component("YOL056W",530).
component("YKL152C",416).
component("YDL021W",176).
component("YPR060C",596).
component("YPL097W",574).
component("YGR185C",312).
component("YGR264C",319).
component("YGR171C",310).
component("YPL104W",575).
component("YLL018C",432).
component("YHR020W",329).
component("YER087W",259).
component("YNL247W",508).
component("YOR168W",549).
component("YOL097C",535).
component("YDR268W",219).
component("YCR024C",171).
component("YHR019C",328).
component("YNL073W",499).
component("YOR335C",561).
component("YLR153C",447).
component("YAL054C",121).
component("YGR244C",317).
component("YIL145C",364).
component("YJL101C",376).
component("YOL049W",528).
component("YAR015W",122).
component("YER183C",264).
component("U90_",112).
component("YNR057C",521).
component("YGL234W",298).
component("YJR103W",401).
component("YBL039C",129).
component("YGR204W",314).
component("YBR084W",141).
component("YNL220W",507).
component("YDL141W",189).
component("YHR074W",337).
component("YGL062W",286).
component("YBR218C",153).
component("YPL231W",587).
component("YNR016C",519).
component("YKL182W",419).
component("YGR037C",304).
component("YPR138C",603).
component("YPL265W",589).
component("YPL036W",573).
component("YOR171C",550).
component("YOR011W",542).
component("YOL156W",541).
component("YOL103W",536).
component("YOL020W",527) :- not remove_orf("YOL020W",527).
component("YNR072W",523).
component("YNL270C",512).
component("YNL142W",504).
component("YMR011W",480).
component("YLR260W",457).
component("YLR100C",444).
component("YLR081W",442).
component("YKR053C",428).
component("YKR039W",427) :- not remove_orf("YKR039W",427).
component("YJR158W",407).
component("YJR077C",399).
component("YJL219W",389).
component("YJL214W",387).
component("YJL134W",381).
component("YJL129C",379).
component("YIL134W",362).
component("YHR096C",340).
component("YHR094C",339).
component("YHR092C",338).
component("YHL036W",326).
component("YGR121C",309).
component("YGR065C",306).
component("YGR055W",305).
component("YGL186C",293).
component("YGL077C",289).
component("YGL008C",279).
component("YFL055W",270).
component("YFL011W",266).
component("YER060W-A",253).
component("YER060W",252).
component("YER056C",251).
component("YER053C",250).
component("YEL069C",246).
component("YEL063C",245).
component("YEL017C-A",240).
component("YDR536W",239).
component("YDR508C",236).
component("YDR503C",235).
component("YDR497C",233).
component("YDR345C",223).
component("YDR343C",222).
component("YDR342C",221).
component("YDR297W",220).
component("YDR046C",203) :- not remove_orf("YDR046C",203).
component("YDL245C",198).
component("YCR032W",173).
component("YCR024C-A",172).
component("YCL025C",166).
component("YBR298C",162).
component("YBR291C",161).
component("YBR069C",139) :- not remove_orf("YBR069C",139).
component("YBR068C",138) :- not remove_orf("YBR068C",138).
component("YBR021W",136).
component("U7_",109).
component("U78_",108).
component("U75_",105).
component("U74_",104).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,225) :- not remove_reaction(3620,225).
catalyst(2110,275).
catalyst(2190,275).
catalyst(5791,453).
catalyst(5792,453).
...
catalyst(4560,242).
catalyst(2550,520).
catalyst(1890,422) :- not remove_reaction(1890,422).
catalyst(3630,422) :- not remove_reaction(3630,422).
catalyst(1890,260) :- not remove_reaction(1890,260).
...
catalyst(7751,135).
catalyst(7752,135).
catalyst(3610,199) :- not remove_reaction(3610,199).
catalyst(7921,544).
catalyst(7922,544).
catalyst(8341,152).
catalyst(8342,152).
...
catalyst(1210,442).
catalyst(6560,428).
catalyst(771,427) :- not remove_reaction(771,427).
catalyst(772,427) :- not remove_reaction(772,427).
catalyst(781,427) :- not remove_reaction(781,427).
catalyst(782,427) :- not remove_reaction(782,427).
catalyst(801,427) :- not remove_reaction(801,427).
catalyst(802,427) :- not remove_reaction(802,427).
catalyst(811,427) :- not remove_reaction(811,427).
catalyst(812,427) :- not remove_reaction(812,427).
catalyst(831,427) :- not remove_reaction(831,427).
catalyst(832,427) :- not remove_reaction(832,427).
catalyst(841,427) :- not remove_reaction(841,427).
catalyst(842,427) :- not remove_reaction(842,427).
catalyst(851,427) :- not remove_reaction(851,427).
catalyst(852,427) :- not remove_reaction(852,427).
catalyst(881,427) :- not remove_reaction(881,427).
catalyst(882,427) :- not remove_reaction(882,427).
catalyst(901,427) :- not remove_reaction(901,427).
catalyst(902,427) :- not remove_reaction(902,427).
catalyst(921,427) :- not remove_reaction(921,427).
catalyst(922,427) :- not remove_reaction(922,427).
catalyst(931,427) :- not remove_reaction(931,427).
catalyst(932,427) :- not remove_reaction(932,427).
catalyst(1191,427) :- not remove_reaction(1191,427).
catalyst(1192,427) :- not remove_reaction(1192,427).
catalyst(1210,407).
catalyst(1581,399).
catalyst(1582,399).
catalyst(1210,389).
...
catalyst(1491,161).
catalyst(1492,161).
catalyst(771,139) :- not remove_reaction(771,139).
catalyst(772,139) :- not remove_reaction(772,139).
...
catalyst(841,138) :- not remove_reaction(841,138).
catalyst(842,138) :- not remove_reaction(842,138).
