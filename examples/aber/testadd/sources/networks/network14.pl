...
component("YOL126C",148).
component("YDL078C",52).
component("YNL037C",135).
component("YML086C",132).
component("YJR078W",109).
component("U107_",19).
component("YER070W",82).
component("U36_",30).
component("YOR323C",150).
component("YIL125W",101).
component("U52_",34).
component("YBR166C",44).
component("YKL216W",118).
component("YKR009C",119).
component("YIL160C",103).
component("YGL205W",90).
component("YKR080W",121).
component("YER023W",78).
component("YLR142W",128).
component("YHR068W",97).
component("YKL150W",114).
component("YIL043C",100).
component("YPL266W",161).
component("YLR058C",126).
component("YDR019C",57).
component("YBR176W",45).
component("YMR120C",133).
component("YLR028C",124).
component("YPR074C",164).
component("YBR117C",43).
component("YPL231W",159).
component("YDL182W",55).
component("YDL131W",54).
component("YLR209C",129).
component("YDR354W",69) :- not remove_orf("YDR354W",69).
component("YFR047C",86).
component("YML022W",131).
component("YDR441C",72).
component("YJL167W",105).
component("YDR127W",62).
component("YDR035W",58).
component("YBR249C",46).
component("YHR137W",98).
component("YLR027C",123).
component("YKL106W",113).
component("YJR148W",111).
component("YNR058W",143).
component("YCR036W",51).
component("YNR012W",141).
component("YDR127W",63).
component("YDR226W",66).
component("YKL067W",112).
component("YDR454C",73).
component("YOL061W",145).
component("YKL181W",115).
component("YHL011C",96).
component("YER099C",84).
component("YBL068W",39).
component("YPR175W",166).
component("YPL167C",157).
component("YOR330C",151).
component("YOL115W",147).
component("YNL299W",139).
component("YNL262W",138).
component("YNL102W",136).
component("YJR043C",107).
component("YJR006W",106).
component("YJL090C",104).
component("YIL139C",102).
component("YEL055C",77).
component("YDR419W",71).
component("YDR121W",60).
component("YDL102W",53).
component("YCR014C",50).
component("YBR278W",48).
component("YBL035C",37).
component("U105_",18).
component("U30_",29).
component("U24_",28).
component("YDR400W",70).
component("YDR242W",67).
component("U53_",35).
component("YLR028C",125).
component("U39_",31).
component("YBR111C",42).
component("YBR252W",47).
component("YLR231C",130).
component("YKL211C",116) :- not remove_orf("YKL211C",116).
component("YKL211C",117) :- not remove_orf("YKL211C",117).
component("YER090W",117) :- not remove_orf("YER090W",117).
component("YER090W",83) :- not remove_orf("YER090W",83).
component("YDR127W",64).
component("YPL281C",162).
component("YOR393W",153).
component("YMR323W",134).
component("YHR174W",99).
component("YGR254W",94).
component("YGL026C",87) :- not remove_orf("YGL026C",87).
component("YNL316C",140).
component("YDR127W",65).
component("YGL148W",88).
component("YAL012W",36).
component("YDR007W",56) :- not remove_orf("YDR007W",56).
component("YOR095C",149).
component("YPL117C",156).
component("YPR060C",163).
component("YPL097W",154).
component("YGR185C",93).
component("YGR264C",95).
component("YGR171C",92).
component("YPL104W",155).
component("YLL018C",122).
component("YOR335C",152).
component("YNR057C",142).
component("YJR103W",110).
component("YBL039C",38).
component("YPR138C",165).
component("YPL265W",160).
component("YOL103W",146).
component("YOL020W",144) :- not remove_orf("YOL020W",144).
component("YNL142W",137).
component("YLR100C",127).
component("YKR039W",120) :- not remove_orf("YKR039W",120).
component("YJR077C",108).
component("YGR121C",91).
component("YGL186C",89).
component("YFL055W",85).
component("YER060W-A",81).
component("YER060W",80).
component("YER056C",79).
component("YDR536W",76).
component("YDR508C",75).
component("YDR497C",74).
component("YDR297W",68).
component("YDR046C",59) :- not remove_orf("YDR046C",59).
component("YCL025C",49).
...
catalyst(5601,129).
catalyst(5602,129).
catalyst(3620,69) :- not remove_reaction(3620,69).
catalyst(2190,86).
catalyst(5650,131).
catalyst(5650,72).
catalyst(6440,105).
...
catalyst(5730,47).
catalyst(3500,130).
catalyst(3600,116) :- not remove_reaction(3600,116).
catalyst(3630,117) :- not remove_reaction(3630,117).
...
catalyst(8231,94).
catalyst(8232,94).
catalyst(3590,87) :- not remove_reaction(3590,87).
catalyst(10910,87) :- not remove_reaction(10910,87).
catalyst(3680,140).
catalyst(3750,65).
catalyst(3700,88).
catalyst(4460,36).
catalyst(3610,56) :- not remove_reaction(3610,56).
catalyst(7921,149).
catalyst(7922,149).
catalyst(6461,156).
catalyst(6462,156).
...
catalyst(781,120) :- not remove_reaction(781,120).
catalyst(782,120) :- not remove_reaction(782,120).
...
catalyst(881,120) :- not remove_reaction(881,120).
catalyst(882,120) :- not remove_reaction(882,120).
catalyst(1191,120) :- not remove_reaction(1191,120).
catalyst(1192,120) :- not remove_reaction(1192,120).
catalyst(1581,108).
catalyst(1582,108).
catalyst(371,91).
catalyst(372,91).
...
catalyst(1191,49).
catalyst(1192,49).
catalyst(771,41) :- not remove_reaction(771,41).
catalyst(772,41) :- not remove_reaction(772,41).
