...
component("YLR056W",308).
component("YKR009C",295).
component("YOL086C",373).
component("YMR303C",341).
component("YGL256W",214).
component("YDL168W",136).
component("YBR145W",103).
component("YPL231W",406).
component("U46_",64).
component("YBR149W",104).
component("YGL001C",196).
component("YIL094C",250).
component("U45_",63).
component("YDR127W",147).
component("YOL126C",377).
component("YKL085W",285).
component("YDL078C",130).
component("YNL037C",345).
component("YCL018W",116).
component("YLR355C",328).
component("YDL174C",138).
component("YML086C",333).
component("YGR088W",221).
component("YDR256C",157).
component("YJR078W",279).
component("YJR025C",273).
component("U107_",23).
component("YJL026W",260).
component("YGR180C",224).
component("YER070W",183).
component("U36_",59).
component("YDL168W",137).
component("YPL276W",413).
component("YPL275W",412).
component("YOR388C",397).
component("YOR323C",391).
component("YIL125W",253).
component("U52_",67).
component("YBR166C",106).
component("YKL216W",294).
component("YKR009C",296).
component("YIL160C",256).
component("YGL205W",211).
component("U100_",20).
component("YKR080W",300).
component("YER023W",178).
component("YGR204W",226).
component("YLR142W",313).
component("U65_",72).
component("U62_",71).
component("YHR068W",239).
component("YKL150W",288).
component("YIL043C",248).
component("YPL171C",405).
component("YHR179W",246).
component("YGR234W",227).
component("YDR353W",161).
component("YNL052W",346).
component("YMR256C",340).
component("YLR395C",330).
component("YLR038C",306).
component("YIL111W",251).
component("YHR051W",238).
component("YGL191W",209).
component("YGL187C",208).
component("YDL067C",129).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",411).
component("YKR069W",299).
component("YJR073C",277).
component("YDL033C",128).
component("YLR172C",315).
component("YLR058C",309).
component("YDR019C",142).
component("YBR176W",107).
component("YDR408C",166).
component("YMR120C",338).
component("YLR028C",304).
component("YBL013W",87).
component("YJL130C",265).
component("YKL024C",283).
component("YPR074C",420).
component("YBR117C",102).
component("YCL009C",115).
component("YNL071W",348).
component("U48_",65).
component("YPL231W",407).
component("YPL231W",408).
component("YLR299W",322).
component("YGL017W",199).
component("YML126C",334).
component("YDL182W",139).
component("YDL131W",133).
component("YLR258W",320).
component("YFR015C",192).
component("YNL029C",344).
component("YIL085C",249).
component("YMR306W",342).
component("YLR342W",327).
component("YGR032W",216).
component("YLR209C",316).
component("U104_",21).
component("YDR354W",162) :- not remove_orf("YDR354W",162).
component("YFR047C",194).
component("YLR209C",317).
component("YML022W",331).
component("YDR441C",168).
component("YJL167W",269).
component("YDR127W",148).
component("YHR068W",240).
component("YLR303W",324).
component("YGR012W",215).
component("YJR130C",281).
component("YDR035W",143).
component("YBR249C",109).
component("YOR274W",390).
component("YHR137W",242).
component("YGL202W",210).
component("YLR027C",303).
component("YKL106W",286).
component("YOL140W",378).
component("YLR089C",310).
component("U61_",70).
component("YJR148W",282).
component("YFL030W",188).
component("YNR058W",365).
component("YGL253W",213).
component("YFR053C",195).
component("YOL016C",368).
component("YFR014C",191).
component("YCR036W",125).
component("YCL040W",118).
component("U96_",83).
component("YDR236C",155).
component("YHL032C",233).
component("YNR012W",362).
component("YDR127W",149).
component("YDR147W",152).
component("YCR012W",120).
component("U76_",80).
component("YER170W",187).
component("YDR226W",154).
component("YKL067W",284).
component("YOL055C",370).
component("YDR454C",169).
component("YJR057W",275).
component("YOL061W",372).
component("YKL181W",290).
component("YHL011C",232).
component("YER099C",186).
component("YBL068W",92).
component("YNL256W",356).
component("YBR018C",95).
component("YLR328W",326).
component("YBR029C",97).
component("YGL130W",205).
component("YPR190C",426).
component("YPR187W",425).
component("YPR110C",421).
component("YPR010C",416).
component("YOR341W",395).
component("YOR340C",394).
component("YOR224C",389).
component("YOR210W",388).
component("YOR207C",386).
component("YOR151C",383).
component("YOR116C",381).
component("YOL005C",366).
component("YNR003C",361).
component("YNL248C",355).
component("YNL151C",353).
component("YNL113W",350).
component("YKL144C",287).
component("YJR063W",276).
component("YJL148W",268).
component("YJL140W",267).
component("YIL021W",247).
component("YHR143W-A",243).
component("YGL070C",203).
component("YFL036W",189).
component("YDR404C",165).
component("YDR156W",153).
component("YDR045C",144).
component("YDL150W",135).
component("YDL140C",134).
component("YBR154C",105).
component("YPR175W",424).
component("YPL167C",404).
component("YOR330C",392).
component("YOL115W",376).
component("YNL299W",359).
component("YNL262W",357).
component("YNL102W",349).
component("YJR043C",274).
component("YJR006W",271).
component("YJL090C",262).
component("YIL139C",254).
component("YEL055C",175).
component("YDR419W",167).
component("YDR121W",146).
component("YDL102W",132).
component("YCR014C",121).
component("YBR278W",112).
component("YBL035C",90).
component("YPR113W",422).
component("YPL148C",403).
component("YGR286C",231).
component("YOL011W",367).
component("YMR008C",336).
component("YMR006C",335).
component("U105_",22).
component("YBL015W",88).
component("U77_",81).
component("YLR377C",329).
component("YPR073C",419).
component("YOR208W",387).
component("YNL053W",347).
component("YMR036C",337).
component("YIR026C",259).
component("YIL113W",252).
component("YFR028C",193).
component("YER075C",184).
component("YDL230W",140).
component("YBR276C",111).
component("U30_",58).
component("U29_",57).
component("U26_",56).
component("U24_",55).
component("YHR044C",237).
component("YHR043C",236).
component("YOR360C",396).
component("YGL027C",201).
component("YOR190W",385).
component("YLR300W",323).
component("YGR282C",230).
component("YDR261C",158).
component("YDR400W",164).
component("YML035C",332).
component("YJL070C",261).
component("YBR284W",113).
component("YDR242W",156).
component("U53_",68).
component("YPR062W",418).
component("YMR120C",339).
component("YLR028C",305).
component("YHR144C",244).
component("YBL033C",89).
component("YNL141W",351).
component("YLR245C",319).
component("YJL126W",263).
component("U39_",60).
component("YBR011C",94).
component("YBR111C",101).
component("YBR252W",110).
component("YER005W",177).
component("YBL099W",93).
component("YLR231C",318).
component("YLR134W",312).
component("YLR044C",307).
component("YGR087C",220).
component("YDR380W",163).
component("YDL080C",131).
component("U98_",84).
component("YOR128C",382).
component("YKL211C",292) :- not remove_orf("YKL211C",292).
component("YKR097W",301).
component("YNL169C",354).
component("YKL211C",293) :- not remove_orf("YKL211C",293).
component("YER090W",293) :- not remove_orf("YER090W",293).
component("YER090W",185) :- not remove_orf("YER090W",185).
component("YDR127W",150).
component("YPL281C",414).
component("YOR393W",398).
component("YMR323W",343).
component("YHR174W",245).
component("YGR254W",228).
component("YGL026C",200) :- not remove_orf("YGL026C",200).
component("YLR304C",325).
component("YJL200C",270).
component("YNL316C",360).
component("YPR002W",415).
component("YJR016C",272).
component("YCR053W",126).
component("YDR127W",151).
component("YGL148W",206).
component("YIL168W",258).
component("YIL167W",257).
component("YCL064C",119).
component("YAL012W",85).
component("YBR019C",96).
component("YDR007W",141) :- not remove_orf("YDR007W",141).
component("YOR095C",380).
component("YGL001C",197).
component("YPL117C",402).
component("YOL056W",371).
component("YKL152C",289).
component("YDL021W",127).
component("YPR060C",417).
component("YPL097W",400).
component("YGR185C",225).
component("YGR264C",229).
component("YGR171C",223).
component("YPL104W",401).
component("YLL018C",302).
component("YOL097C",374).
component("YDR268W",159).
component("YCR024C",122).
component("YHR019C",235).
component("YOR335C",393).
component("YLR153C",314).
component("YAL054C",86).
component("YIL145C",255).
component("U90_",82).
component("YNR057C",364).
component("YGL234W",212).
component("YJR103W",280).
component("YBL039C",91).
component("YBR084W",100).
component("YHR074W",241).
component("YGL062W",202).
component("YBR218C",108).
component("YPL231W",409).
component("YNR016C",363).
component("YKL182W",291).
component("YGR037C",217).
component("YPR138C",423).
component("YPL265W",410).
component("YPL036W",399).
component("YOR171C",384).
component("YOR011W",379).
component("YOL103W",375).
component("YOL020W",369) :- not remove_orf("YOL020W",369).
component("YNL270C",358).
component("YNL142W",352).
component("YLR260W",321).
component("YLR100C",311).
component("YKR053C",298).
component("YKR039W",297) :- not remove_orf("YKR039W",297).
component("YJR077C",278).
component("YJL134W",266).
component("YJL129C",264).
component("YHL036W",234).
component("YGR121C",222).
component("YGR065C",219).
component("YGR055W",218).
component("YGL186C",207).
component("YGL077C",204).
component("YGL008C",198).
component("YFL055W",190).
component("YER060W-A",182).
component("YER060W",181).
component("YER056C",180).
component("YER053C",179).
component("YEL063C",176).
component("YEL017C-A",174).
component("YDR536W",173).
component("YDR508C",172).
component("YDR503C",171).
component("YDR497C",170).
component("YDR297W",160).
component("YDR046C",145) :- not remove_orf("YDR046C",145).
component("YCR032W",124).
component("YCR024C-A",123).
component("YCL025C",117).
component("YBR298C",114).
component("YBR069C",99) :- not remove_orf("YBR069C",99).
component("YBR068C",98) :- not remove_orf("YBR068C",98).
component("U75_",79).
component("U74_",78).
component("U73_",77).
component("U72_",76).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,162) :- not remove_reaction(3620,162).
catalyst(2190,194).
catalyst(5791,317).
catalyst(5792,317).
catalyst(5801,317).
...
catalyst(6111,382).
catalyst(6112,382).
catalyst(3600,292) :- not remove_reaction(3600,292).
catalyst(8000,301).
catalyst(6890,354).
catalyst(3630,293) :- not remove_reaction(3630,293).
catalyst(3630,185) :- not remove_reaction(3630,185).
catalyst(3740,150).
catalyst(8231,414).
catalyst(8232,414).
catalyst(8231,398).
...
catalyst(8231,228).
catalyst(8232,228).
catalyst(3590,200) :- not remove_reaction(3590,200).
catalyst(10910,200) :- not remove_reaction(10910,200).
catalyst(8181,325).
catalyst(8182,325).
catalyst(8181,270).
catalyst(8182,270).
...
catalyst(7751,96).
catalyst(7752,96).
catalyst(3610,141) :- not remove_reaction(3610,141).
catalyst(7921,380).
catalyst(7922,380).
catalyst(6370,197).
catalyst(6461,402).
...
catalyst(6330,311).
catalyst(6560,298).
catalyst(771,297) :- not remove_reaction(771,297).
catalyst(772,297) :- not remove_reaction(772,297).
catalyst(781,297) :- not remove_reaction(781,297).
catalyst(782,297) :- not remove_reaction(782,297).
...
catalyst(881,297) :- not remove_reaction(881,297).
catalyst(882,297) :- not remove_reaction(882,297).
catalyst(901,297) :- not remove_reaction(901,297).
catalyst(902,297) :- not remove_reaction(902,297).
catalyst(931,297) :- not remove_reaction(931,297).
catalyst(932,297) :- not remove_reaction(932,297).
catalyst(1191,297) :- not remove_reaction(1191,297).
catalyst(1192,297) :- not remove_reaction(1192,297).
catalyst(1581,278).
catalyst(1582,278).
catalyst(6560,266).
catalyst(361,264).
...
catalyst(851,145) :- not remove_reaction(851,145).
catalyst(852,145) :- not remove_reaction(852,145).
catalyst(901,145) :- not remove_reaction(901,145).
catalyst(902,145) :- not remove_reaction(902,145).
catalyst(431,124).
catalyst(432,124).
catalyst(220,123).
catalyst(771,117).
...
catalyst(1121,114).
catalyst(1122,114).
catalyst(771,99) :- not remove_reaction(771,99).
catalyst(772,99) :- not remove_reaction(772,99).
...
catalyst(841,98) :- not remove_reaction(841,98).
catalyst(842,98) :- not remove_reaction(842,98).
catalyst(851,98) :- not remove_reaction(851,98).
catalyst(852,98) :- not remove_reaction(852,98).
catalyst(901,98) :- not remove_reaction(901,98).
catalyst(902,98) :- not remove_reaction(902,98).
catalyst(2920,79).
catalyst(2920,78).
catalyst(2920,77).
catalyst(2920,76).
