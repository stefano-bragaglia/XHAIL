...
component("YNL280C",589).
component("YLR056W",506).
component("YGL012W",321).
component("YKR009C",488).
component("YOL086C",613).
component("YMR303C",564).
component("YGL256W",342).
...
component("YIL094C",408).
component("U45_",94).
component("YML056C",545).
component("YLR432W",539).
component("YHR216W",402).
component("YAR075W",139).
component("YAR073W",138).
component("YDR127W",238).
component("YOL126C",619).
component("YKL085W",474).
component("YDL078C",205).
component("YNL037C",569).
component("YNL009W",567).
component("YLR174W",518).
component("YHR183W",396).
component("YGR256W",363).
component("YOL059W",611).
component("YDL022W",199).
component("YCL018W",186).
component("YLR355C",534).
component("YDL174C",221).
component("YML086C",547).
component("YIL155C",417).
component("YGR088W",350).
component("YDR256C",250).
component("YKL026C",472).
component("YIR037W",426).
component("YBR244W",174).
component("YJR078W",461).
component("U58_",103).
component("YJR025C",454).
component("U107_",24).
component("YHR007C",373).
component("YGL055W",327).
component("YJR104C",463).
component("YHR008C",374).
component("YOR384W",653).
component("YOR381W",652).
component("YOL152W",621).
component("YLL051C",499).
component("YJL026W",428).
component("YIL066C",406).
...
component("YJL052W",430).
component("YGR192C",356).
component("YBR006W",148).
component("YPL276W",678).
component("YPL275W",677).
component("YOR388C",654).
component("YOR374W",650).
component("YER073W",295).
component("YGL154C",334).
component("U55_",102).
component("YER069W",292).
component("YOR323C",643).
component("YER178W",303).
component("YBR221C",172).
component("YIL125W",413).
component("U52_",100).
component("YBR166C",167).
component("YGL012W",322).
component("YKL216W",487).
component("YDR044W",231).
component("YKR009C",489).
component("YIL160C",418).
component("YGL205W",339).
component("YMR118C",555).
component("YLR164W",516).
component("YLL041C",498).
component("YKL148C",478).
component("YKL141W",476).
component("YJL045W",429).
component("YDR178W",245).
component("YEL047C",279).
component("YDL171C",219).
component("YDL171C",220).
component("YOR375C",651).
...
component("YOR236W",641).
component("YGR204W",357).
component("YIR034C",425).
...
component("YHR042W",378).
component("YPL171C",665).
component("YHR179W",395).
component("YMR145C",558).
component("YML120C",548).
component("YKL192C",484).
component("YDL085W",207).
component("YGR234W",359).
component("YFR030W",314).
component("YPL017C",656).
component("YFL018C",307).
component("YDR353W",259).
component("YPR167C",690).
component("YJR137C",466).
component("YNL052W",571).
component("YMR256C",563).
component("YLR395C",538).
component("YLR038C",504).
component("YIL111W",410).
component("YHR051W",382).
component("YGL191W",337).
component("YGL187C",336).
component("YDL067C",204).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",676).
component("YKR069W",493).
component("YOL096C",614).
component("U47_",96).
component("YER091C",300).
component("YJR073C",459).
component("YDR120C",236).
component("YML008C",541).
component("YOR074C",626).
component("YDL033C",201).
component("YOL096C",615).
component("YLR172C",517).
component("YLR058C",507).
...
component("YJL130C",438).
component("YKL024C",471).
component("YPR074C",686).
component("YBR117C",162).
component("YCL009C",185).
component("YNL071W",573).
component("YNR008W",594).
component("YIL160C",419).
component("YNR019W",597).
...
component("U8_",125).
component("YPL231W",672).
component("YPL028W",657).
component("YLR299W",527).
component("YGL017W",323).
component("YML126C",549).
component("YNL104C",576).
component("YDL182W",222).
component("YDL131W",211).
component("YLR258W",524).
component("YFR015C",312).
component("YNL029C",568).
component("YIL085C",407).
component("YMR306W",565).
component("YLR342W",533).
component("YGR032W",345).
component("YLR209C",520).
component("U104_",21).
component("YDR354W",260) :- not remove_orf("YDR354W",260).
component("YFR047C",315).
component("YJR133W",465).
component("YLR209C",521).
component("YML022W",542).
component("YDR441C",266).
component("YJL167W",443).
component("YJL167W",444).
component("YDR127W",239).
component("YLR146C",514).
component("YHR068W",384).
component("YLR303W",529).
component("YGR012W",343).
component("YML082W",546).
component("YJR130C",464).
component("YDR035W",230).
component("YBR249C",175).
component("YLR180W",519).
component("YDR502C",269).
component("YOR274W",642).
component("YBR256C",177).
component("YHR137W",391).
component("YGL202W",338).
component("YLR027C",501).
component("YKL106W",475).
component("YOL140W",620).
component("YLR438W",540).
component("YGR019W",344).
component("YLR089C",509).
component("U64_",108).
component("U61_",105).
component("U51_",99).
component("YJR148W",467).
component("YHR208W",400).
component("YFL030W",308).
component("YOR184W",635).
component("YNR058W",601).
component("YIL116W",412).
component("YGL253W",341).
component("YFR053C",316).
component("YMR013C",553).
component("YMR205C",559).
component("YGR240C",360).
component("YOL016C",605).
component("YFR014C",311).
component("YCR036W",195).
component("YCL040W",188).
component("U15_",45).
component("YPL188W",666).
component("YJR049C",456).
...
component("YPL203W",667).
component("YOR061W",625).
component("YKL166C",481).
component("YJL164C",442).
component("YIL035C",404).
component("YHR205W",399).
component("YHR102W",390).
component("YGL019W",324).
component("YHR025W",377).
component("YOR347C",648).
component("YAL038W",134).
component("YNR012W",595).
...
component("YOL055C",608).
component("YDR454C",267).
component("YJR057W",457).
component("YOL061W",612).
component("YKL181W",482).
component("YHL011C",370).
component("YER099C",301).
component("YBL068W",146).
component("YOR143C",631).
...
component("YGL130W",332).
component("YDR530C",272).
component("YPR190C",693).
component("YPR187W",692).
component("YPR110C",687).
component("YPR010C",681).
component("YOR341W",647).
component("YOR340C",646).
component("YOR224C",640).
component("YOR210W",639).
component("YOR207C",637).
component("YOR151C",632).
component("YOR116C",628).
component("YOL005C",603).
component("YNR003C",593).
component("YNL248C",584).
component("YNL151C",580).
component("YNL113W",577).
component("YKL144C",477).
component("YJR063W",458).
component("YJL148W",441).
component("YJL140W",440).
component("YIL021W",403).
component("YHR143W-A",392).
component("YGL070C",330).
...
component("YPR175W",691).
component("YPL167C",664).
component("YOR330C",644).
component("YOL115W",618).
component("YNL299W",591).
component("YNL262W",587).
component("YNL102W",575).
component("YJR043C",455).
...
component("YPR113W",688).
component("YBR243C",173).
component("YPL148C",662).
component("YER026C",286).
component("YGR286C",367).
component("YHR189W",397).
component("YDR058C",235).
component("YDL086W",208).
component("YOL011W",604).
component("YMR008C",551).
component("YMR006C",550).
component("U105_",22).
component("YBL015W",141).
component("YJL068C",431).
component("YOR040W",624).
component("U77_",119).
component("YLR377C",536).
component("YPR073C",684).
component("YHR215W",401).
component("YDL024C",200).
component("YBR093C",160).
component("YBR092C",159).
component("YHR046C",381).
component("U9_",132).
component("YDL236W",225).
component("YPR073C",685).
component("YOR208W",638).
component("YNL053W",572).
component("YMR036C",554).
component("YIR026C",424).
component("YIL113W",411).
...
component("U25_",79).
component("U24_",78).
component("YHR044C",380).
component("YHR043C",379).
component("YOR360C",649).
component("YKR031C",490).
component("YPL206C",668).
component("YGL027C",326).
component("YLR286C",526).
component("YJR153W",468).
component("YJL221C",449).
component("YJL216C",447).
component("YIL172C",422).
component("YGR292W",369).
component("YGR287C",368).
component("YBR299W",184).
component("YBR184W",169).
component("YIR019C",423).
component("YIL099W",409).
component("YDL037C",202).
component("YOR190W",636).
component("YLR300W",528).
component("YGR282C",366).
component("YDR261C",251).
component("YDR400W",262).
component("YML035C",543).
component("YJL070C",432).
component("YBR284W",181).
component("U106_",23).
component("YER043C",287).
component("YNL045W",570).
component("YDR242W",249).
component("U53_",101).
component("YPR062W",683).
component("YMR120C",557).
component("YLR028C",503).
component("YHR144C",393).
component("YGR267C",365).
component("YBL033C",142).
component("YNL141W",578).
component("YLR245C",523).
component("YML035C",544).
component("YBR084W",157).
component("YJL126W",436).
component("U44_",93).
component("YDL100C",209).
component("U40_",91).
component("U39_",89).
component("YBR011C",149).
component("YHR201C",398).
component("YBR111C",161).
component("YBR252W",176).
component("YER005W",284).
component("YBL099W",147).
component("YLR231C",522).
component("YLR134W",511).
component("YLR044C",505).
component("YGR087C",349).
component("YDR380W",261).
component("YDL080C",206).
component("U98_",130).
component("YMR250W",562).
component("YOR128C",629).
component("YEL021W",276).
component("YNR043W",599).
component("U93_",127).
component("YKL211C",485) :- not remove_orf("YKL211C",485).
component("YKR097W",496).
component("YNL169C",581).
component("YNL256W",586).
component("YDR294C",253).
component("YEL046C",278).
component("YNR033W",598).
component("YKL211C",486) :- not remove_orf("YKL211C",486).
component("YER090W",486) :- not remove_orf("YER090W",486).
component("YER090W",299) :- not remove_orf("YER090W",299).
component("YDR127W",241).
component("YPL281C",679).
component("YOR393W",655).
component("YMR323W",566).
component("YHR174W",394).
component("YGR254W",362).
component("YPL262W",674).
component("YGL026C",325) :- not remove_orf("YGL026C",325).
component("YGR155W",352).
component("YLR304C",530).
component("YJL200C",445).
component("YNL316C",592).
component("YPL212C",669).
component("YNL292W",590).
component("YGL063W",329).
component("YFL001W",305).
component("YPR002W",680).
component("YJR016C",453).
component("YCR053W",197).
component("YDR127W",242).
component("YGL148W",333).
component("YIL168W",421).
component("YIL167W",420).
component("YCL064C",189).
component("YER086W",297).
component("YLR359W",535).
component("YAL012W",133).
component("YFR055W",317).
component("YJL005W",427).
component("YJL121C",435).
component("YBR019C",151).
component("YDR050C",234).
component("YDR007W",227) :- not remove_orf("YDR007W",227).
component("YOR095C",627).
component("YBR196C",170).
component("YGL001C",319).
component("YPL117C",661).
component("U14_",39).
component("YOL056W",609).
component("YKL152C",480).
component("YDL021W",198).
component("YEL058W",281).
component("YPR060C",682).
component("YHR072W",385).
component("YPL097W",659).
component("YGR185C",355).
component("YGR264C",364).
component("YGR171C",353).
component("YPL104W",660).
component("YLL018C",497).
component("YHR020W",376).
component("YER087W",298).
component("YNL247W",583).
component("YOR168W",633).
component("YOL097C",616).
component("YDR268W",252).
component("YCR024C",192).
component("YHR019C",375).
component("YPL160W",663).
component("YLR382C",537).
component("YNL073W",574).
component("YOR335C",645).
component("YLR153C",515).
component("YAL054C",135).
component("YGR244C",361).
component("YIL145C",416).
component("YJL101C",434).
component("YOL049W",607).
component("YAR015W",137).
component("YER183C",304).
component("U90_",126).
component("YNR057C",600).
component("YDL141W",213).
component("YGL234W",340).
component("YDL141W",214).
component("YJR103W",462).
component("YBL039C",144).
component("YGR204W",358).
component("YBR084W",158).
component("YNL220W",582).
component("YOL058W",610).
component("YDL141W",215).
component("YHR074W",386).
component("YMR217W",561).
component("YGL062W",328).
component("YBR218C",171).
component("YPL231W",673).
component("YNR016C",596).
component("YKL182W",483).
component("YGR037C",346).
component("YPR138C",689).
component("YPL265W",675).
component("YPL036W",658).
component("YOR171C",634).
component("YOR130C",630).
component("YOR011W",623).
component("YOL156W",622).
component("YOL103W",617).
component("YOL020W",606) :- not remove_orf("YOL020W",606).
component("YNR072W",602).
component("YNL270C",588).
component("YNL142W",579).
component("YMR011W",552).
component("YLR260W",525).
component("YLR138W",512).
component("YLR100C",510).
component("YLR081W",508).
component("YLL061W",500).
component("YKR093W",495).
component("YKR053C",492).
component("YKR039W",491) :- not remove_orf("YKR039W",491).
component("YJR158W",469).
component("YJR077C",460).
component("YJL219W",448).
component("YJL214W",446).
component("YJL134W",439).
component("YJL129C",437).
component("YIL134W",414).
component("YHR096C",389).
component("YHR094C",388).
component("YHR092C",387).
component("YHL036W",372).
component("YGR121C",351).
component("YGR065C",348).
component("YGR055W",347).
component("YGL186C",335).
component("YGL077C",331).
...
catalyst(6470,599).
catalyst(2300,127).
catalyst(3600,485) :- not remove_reaction(3600,485).
catalyst(8000,496).
catalyst(6890,581).
catalyst(2570,586).
catalyst(8781,253).
...
catalyst(4560,278).
catalyst(2550,598).
catalyst(1890,486) :- not remove_reaction(1890,486).
catalyst(3630,486) :- not remove_reaction(3630,486).
...
catalyst(1210,622).
catalyst(1160,617).
catalyst(801,606) :- not remove_reaction(801,606).
catalyst(802,606) :- not remove_reaction(802,606).
catalyst(811,606) :- not remove_reaction(811,606).
catalyst(812,606) :- not remove_reaction(812,606).
catalyst(831,606) :- not remove_reaction(831,606).
catalyst(832,606) :- not remove_reaction(832,606).
catalyst(901,606) :- not remove_reaction(901,606).
catalyst(902,606) :- not remove_reaction(902,606).
catalyst(1180,602).
catalyst(1210,602).
catalyst(931,588).
catalyst(932,588).
...
catalyst(851,491) :- not remove_reaction(851,491).
catalyst(852,491) :- not remove_reaction(852,491).
...
catalyst(921,491) :- not remove_reaction(921,491).
catalyst(922,491) :- not remove_reaction(922,491).
catalyst(931,491) :- not remove_reaction(931,491).
catalyst(932,491) :- not remove_reaction(932,491).
