...
component("YLR056W",559).
component("YGR060W",387).
component("YGL012W",359).
component("YKR009C",541).
component("YOL086C",677).
component("YMR303C",626).
component("YGL256W",381).
component("YDL168W",242).
component("YBR145W",182).
component("YPL231W",739).
component("YBR265W",197).
component("U46_",106).
component("YBR149W",183).
component("YBR149W",184).
component("YGL001C",356).
component("YIL094C",455).
component("U45_",105).
component("YML056C",603).
component("YLR432W",593).
component("YHR216W",447).
component("YAR075W",154).
component("YAR073W",153).
component("YDR127W",267).
component("YJR139C",515).
component("YML075C",605).
component("YLR450W",596).
component("YOL126C",683).
component("YKL085W",523).
component("YDL078C",229).
component("YNL037C",631).
component("YNL009W",629).
component("YLR174W",571).
component("YHR183W",440).
component("YGR256W",406).
component("YNL241C",645).
component("YOL059W",675).
component("YDL022W",222).
component("YCL018W",205).
component("YLR355C",588).
component("YIL074C",452).
component("YER081W",332).
component("YDL174C",246).
component("YML086C",607).
component("YIL155C",464).
component("YGR088W",390).
component("YDR256C",279).
component("YKL026C",521).
component("YIR037W",473).
component("YBR244W",193).
component("YJR078W",509).
component("U58_",115).
component("YJR025C",501).
component("U107_",24).
component("YHR007C",416).
component("YDR402C",293).
component("YGL055W",366).
component("YJR104C",511).
component("YHR008C",417).
component("YOR384W",719).
component("YOR381W",718).
component("YOL152W",685).
component("YLL051C",552).
component("YJL026W",475).
component("YIL066C",451).
component("YGR180C",396).
component("YER070W",329).
component("U37_",99).
component("U36_",98).
component("YDL168W",243).
component("YJR009C",498).
component("YJL052W",477).
component("YGR192C",398).
component("YBR006W",164).
component("YPL276W",747).
component("YPL275W",746).
component("YOR388C",720).
component("YOR374W",716).
component("YER073W",330).
component("YGL154C",373).
component("YBR115C",178).
component("U55_",114).
component("YER069W",327).
component("YOR323C",708).
component("YER178W",341).
component("YBR221C",191).
component("YIL125W",460).
component("U52_",111).
component("YBR166C",186).
component("YGL012W",360).
component("YKL182W",532).
component("YKL216W",540).
component("YDR044W",258).
component("YKR009C",542).
component("YIL160C",465).
component("YGL205W",378).
component("YMR118C",616).
component("YLR164W",569).
component("YLL041C",551).
component("YKL148C",527).
component("YKL141W",525).
component("YJL045W",476).
component("YDR178W",274).
component("YEL047C",312).
component("YDL171C",244).
component("YDL171C",245).
component("YOR375C",717).
component("YDL215C",250).
component("YAL062W",151).
component("U99_",146).
component("U100_",20).
component("YBR035C",170).
component("YKR080W",547).
component("YER023W",319).
component("YOR236W",706).
component("YGR204W",400).
component("YIR034C",472).
component("YLR142W",566).
component("U65_",121).
component("U63_",119).
component("U62_",118).
component("YHR068W",426).
component("YKL150W",528).
component("YIL043C",450).
component("YHR042W",421).
component("YPL171C",732).
component("YHR179W",439).
component("YMR145C",619).
component("YML120C",608).
component("YKL192C",535).
component("YDL085W",231).
component("YGR234W",402).
component("YFR030W",352).
component("YPL017C",722).
component("YFL018C",345).
component("YDR353W",289).
component("YPR167C",760).
component("YJR137C",514).
component("YNL052W",633).
component("YMR256C",625).
component("YLR395C",592).
component("YLR038C",557).
component("YIL111W",457).
component("YHR051W",425).
component("YGL191W",376).
component("YGL187C",375).
component("YDL067C",228).
component("Q0275",19).
component("Q0250",18).
component("YDR072C",263).
component("YPL266W",745).
component("YKR069W",546).
component("YOL096C",678).
component("U47_",107).
component("YER091C",337).
component("YJR073C",507).
component("YGR157W",394).
component("YDR120C",265).
component("YML008C",598).
component("YOR074C",690).
component("YDL033C",224).
component("YOL096C",679).
component("YLR172C",570).
component("YLR058C",560).
component("YDR019C",256).
component("YBR176W",187).
component("YDR408C",295).
component("YMR120C",617).
component("YLR028C",555).
component("YBL013W",155).
component("YJL130C",485).
component("YKL024C",520).
component("YPR074C",755).
component("YBR117C",179).
component("YMR108W",615).
component("YCL009C",204).
component("YNL071W",635).
component("YNR008W",657).
component("YIL160C",466).
component("YNR019W",660).
component("YCR048W",218).
component("U48_",108).
component("YDR232W",276).
component("YPL231W",740).
component("YER061C",326).
component("YDL052C",227).
component("U8_",140).
component("YPL231W",741).
component("YPL028W",723).
component("YLR299W",581).
component("YGL017W",361).
component("YCR005C",210).
component("YML126C",609).
component("YNL104C",638).
component("YDL182W",247).
component("YDL131W",235).
component("YDR307W",285).
component("YLR258W",578).
component("YFR015C",350).
component("YNL029C",630).
component("YIL085C",454).
component("YMR306W",627).
component("YLR342W",587).
component("YGR032W",384).
component("YLR209C",573).
component("U104_",21).
component("YDR354W",290) :- not remove_orf("YDR354W",290).
component("YFR047C",353).
component("YJR133W",513).
component("YLR209C",574).
component("YML022W",600).
component("YDR441C",298).
component("YHR128W",434).
component("YJL167W",490).
component("YJL167W",491).
component("YDR127W",268).
component("YHR190W",442).
component("YLR146C",567).
component("YHR068W",427).
component("YLR303W",583).
component("YGR012W",382).
component("YML082W",606).
component("YJR130C",512).
component("YDR035W",257).
component("YBR249C",194).
component("YLR180W",572).
component("YDR502C",301).
component("YOR274W",707).
component("YBR256C",196).
component("YHR137W",435).
component("YGL202W",377).
component("YLR027C",554).
component("YKL106W",524).
component("YOL140W",684).
component("YLR438W",595).
component("YGR019W",383).
component("YLR089C",562).
component("U64_",120).
component("U61_",117).
component("U51_",110).
component("YJR148W",516).
component("YHR208W",445).
component("YFL030W",346).
component("YOR184W",699).
component("YNR058W",665).
component("YIL116W",459).
component("YGL253W",380).
component("YFR053C",354).
component("YMR013C",613).
component("YMR205C",621).
component("YGR240C",403).
component("YOL016C",669).
component("YFR014C",349).
component("YLR240W",576).
component("YKL203C",537).
component("YJR066W",506).
component("YCR036W",217).
component("YCL040W",207).
component("U15_",51).
component("YPL188W",734).
component("YJR049C",503).
component("YEL041W",310).
component("U96_",144).
component("YKL001C",519).
component("YDR236C",277).
component("YHL032C",414).
component("YDR531W",305).
component("U83_",137).
component("U82_",136).
component("U81_",135).
component("YMR208W",622).
component("YPL203W",735).
component("YOR061W",689).
component("YKL166C",530).
component("YJL164C",489).
component("YIL035C",449).
component("YHR205W",444).
component("YHR102W",433).
component("YGL019W",362).
component("YHR025W",420).
component("YOR347C",713).
component("YAL038W",149).
component("YNR012W",658).
component("YDR009W",255).
component("YDR127W",269).
component("YDR147W",272).
component("YDR300C",284).
component("YCR012W",211).
component("YER069W",328).
component("U19_",78).
component("U18_",70).
component("U17_",62).
component("U76_",130).
component("YER170W",340).
component("YDR226W",275).
component("YKL067W",522).
component("YOL055C",672).
component("YDR454C",299).
component("YJR057W",504).
component("YOL061W",676).
component("YKL181W",531).
component("YHL011C",413).
component("YER099C",338).
component("YBL068W",162).
component("YOR143C",695).
component("YNL256W",648).
component("YLR328W",585).
component("YBR018C",166).
component("YGR202C",399).
component("YLR328W",586).
component("U80_",134).
component("U94_",143).
component("YJR010W",499).
component("YBR029C",169).
component("YCL050C",208).
component("YGL130W",371).
component("YDR530C",304).
component("YPR190C",763).
component("YPR187W",762).
component("YPR110C",757).
component("YPR010C",750).
component("YOR341W",712).
component("YOR340C",711).
component("YOR224C",705).
component("YOR210W",703).
component("YOR207C",701).
component("YOR151C",696).
component("YOR116C",692).
component("YOL005C",667).
component("YNR003C",656).
component("YNL248C",647).
component("YNL151C",642).
component("YNL113W",639).
component("YKL144C",526).
component("YJR063W",505).
component("YJL148W",488).
component("YJL140W",487).
component("YIL021W",448).
component("YHR143W-A",436).
component("YGL070C",369).
component("YFL036W",347).
component("YDR404C",294).
component("YDR156W",273).
component("YDR045C",259).
component("YDL150W",241).
component("YDL140C",237).
component("YBR154C",185).
component("YPR175W",761).
component("YPL167C",731).
component("YOR330C",709).
component("YOL115W",682).
component("YNL299W",654).
component("YNL262W",650).
component("YNL102W",637).
component("YJR043C",502).
component("YJR006W",497).
component("YJL090C",480).
component("YIL139C",462).
component("YEL055C",313).
component("YDR419W",296).
component("YDR121W",266).
component("YDL102W",234).
component("YCR014C",212).
component("YBR278W",199).
component("YBL035C",158).
component("YPR113W",758).
component("YBR243C",192).
component("YPL148C",729).
component("YER026C",320).
component("YGR286C",410).
component("YHR189W",441).
component("YDR058C",262).
component("YDL086W",232).
component("YOL011W",668).
component("YMR008C",611).
component("YMR006C",610).
component("U105_",22).
component("YBL015W",156).
component("YJL068C",478).
component("YOR040W",688).
component("U77_",131).
component("YLR377C",590).
component("YPL179W",733).
component("YNR032W",661).
component("YML057W",604).
component("YML016C",599).
component("YLR433C",594).
component("YGR123C",392).
component("YER133W",339).
component("YER089C",335).
component("YDR436W",297).
...
component("YBL056W",161).
component("YPR073C",753).
component("YHR215W",446).
component("YDL024C",223).
component("YBR093C",176).
component("YBR092C",175).
component("YHR046C",424).
component("U9_",147).
component("YPL228W",738).
component("YMR180C",620).
component("YDL236W",252).
component("YPR073C",754).
component("YOR208W",702).
component("YNL053W",634).
component("YMR036C",614).
component("YIR026C",471).
component("YIL113W",458).
component("YFR028C",351).
component("YER075C",331).
component("YDL230W",251).
...
component("U25_",90).
component("U24_",89).
component("YHR044C",423).
component("YHR043C",422).
component("YOR360C",715).
component("YKR031C",543).
component("YPL206C",736).
component("YGL027C",364).
component("YLR286C",580).
component("YJR153W",517).
component("YJL221C",496).
component("YJL216C",494).
component("YIL172C",469).
component("YGR292W",412).
component("YGR287C",411).
component("YBR299W",203).
component("YBR184W",188).
component("YIR019C",470).
component("YIL099W",456).
component("YDL037C",225).
component("YOR190W",700).
component("YLR300W",582).
component("YGR282C",409).
component("YDR261C",280).
component("YDR400W",292).
component("YML035C",601).
component("YJL070C",479).
component("YBR284W",200).
component("U106_",23).
component("YER043C",321).
component("YNL045W",632).
component("YGL037C",365).
component("YDR242W",278).
component("U53_",112).
component("YPR062W",752).
component("YMR120C",618).
component("YLR028C",556).
component("YHR144C",437).
component("YGR267C",408).
component("YBL033C",157).
component("YNL141W",640).
component("YLR245C",577).
component("YML035C",602).
component("YBR084W",173).
component("YJL126W",483).
component("U44_",104).
component("YDL100C",233).
component("U87_",139).
component("U40_",102).
component("U39_",100).
component("YBR011C",165).
component("YHR201C",443).
component("YBR111C",177).
component("YBR252W",195).
component("YER005W",318).
component("YBL099W",163).
component("YLR231C",575).
component("YDR538W",307).
component("YLR134W",564).
component("YLR044C",558).
component("YGR087C",389).
component("YDR380W",291).
component("YDL080C",230).
component("U98_",145).
component("YMR250W",624).
component("YOR128C",693).
component("YEL021W",309).
component("YNR043W",663).
component("U93_",142).
component("U54_",113).
component("YKL211C",538) :- not remove_orf("YKL211C",538).
component("YKR097W",549).
component("YNL169C",643).
component("YNL256W",649).
component("YDR294C",282).
component("YEL046C",311).
component("YNR033W",662).
component("YKL211C",539) :- not remove_orf("YKL211C",539).
component("YER090W",539) :- not remove_orf("YER090W",539).
component("YER090W",336) :- not remove_orf("YER090W",336).
component("YDR127W",270).
component("YPL281C",748).
component("YOR393W",721).
component("YMR323W",628).
component("YHR174W",438).
component("YGR254W",405).
component("YPL262W",743).
component("YGL026C",363) :- not remove_orf("YGL026C",363).
component("YGR155W",393).
component("YLR304C",584).
component("YJL200C",492).
component("YNL316C",655).
component("YKL182W",533).
component("YPL212C",737).
component("YNL292W",653).
component("YGL063W",368).
component("YFL001W",343).
component("YPR002W",749).
component("YJR016C",500).
component("YCR053W",219).
component("YDR127W",271).
component("YGL148W",372).
component("YIL168W",468).
component("YIL167W",467).
component("YCL064C",209).
component("YER086W",333).
component("YLR359W",589).
component("YAL012W",148).
component("YML004C",597).
component("YFR055W",355).
component("YJL005W",474).
component("YJL121C",482).
component("YBR019C",167).
component("YDR050C",261).
component("YDR007W",254) :- not remove_orf("YDR007W",254).
component("YOR095C",691).
component("YER003C",317).
component("YBR196C",189).
component("YGL001C",357).
component("YPL117C",727).
component("U14_",43).
component("YOL056W",673).
component("YKL152C",529).
component("YDL021W",221).
component("YEL058W",314).
component("YPR060C",751).
component("YHR072W",428).
component("YPL097W",725).
component("YGR185C",397).
component("YGR264C",407).
component("YGR171C",395).
component("YPL104W",726).
component("YLL018C",550).
component("YPR081C",756).
component("YBR121C",180).
component("YHR020W",419).
component("YER087W",334).
component("YNL247W",646).
component("YOR168W",697).
component("YOL097C",680).
component("YDR268W",281).
component("YCR024C",213).
component("YHR019C",418).
component("YKL194C",536).
component("YIL078W",453).
component("YPL160W",730).
component("YLR382C",591).
component("YNL073W",636).
component("YOR335C",710).
component("YLR153C",568).
component("YAL054C",150).
component("YGR244C",404).
component("YIL145C",463).
component("YJL101C",481).
component("YOL049W",671).
component("YAR015W",152).
component("YER183C",342).
component("U90_",141).
component("YNR057C",664).
component("YDL141W",238).
component("YGL234W",379).
component("YDL141W",239).
component("YJR103W",510).
component("YBL039C",159).
component("YGR204W",401).
component("YBR084W",174).
component("YNL220W",644).
component("YOL058W",674).
component("YDL141W",240).
component("YHR074W",429).
component("YMR217W",623).
component("YGL062W",367).
component("YBR218C",190).
component("YPL231W",742).
component("YNR016C",659).
component("YKL182W",534).
component("YGR037C",385).
component("YPR138C",759).
component("YPL265W",744).
component("YPL134C",728).
component("YPL036W",724).
component("YOR348C",714).
component("YOR222W",704).
component("YOR171C",698).
component("YOR130C",694).
component("YOR011W",687).
component("YOL156W",686).
component("YOL103W",681).
component("YOL020W",670) :- not remove_orf("YOL020W",670).
component("YNR072W",666).
component("YNL270C",651).
component("YNL142W",641).
component("YMR011W",612).
component("YLR260W",579).
component("YLR138W",565).
component("YLR100C",563).
component("YLR081W",561).
component("YLL061W",553).
component("YKR093W",548).
component("YKR053C",545).
component("YKR039W",544) :- not remove_orf("YKR039W",544).
component("YJR158W",518).
component("YJR077C",508).
component("YJL219W",495).
component("YJL214W",493).
component("YJL134W",486).
component("YJL129C",484).
component("YIL134W",461).
component("YHR096C",432).
component("YHR094C",431).
component("YHR092C",430).
component("YHL036W",415).
component("YGR121C",391).
component("YGR065C",388).
component("YGR055W",386).
component("YGL186C",374).
component("YGL077C",370).
component("YGL008C",358).
component("YFL055W",348).
component("YFL011W",344).
component("YER060W-A",325).
component("YER060W",324).
component("YER056C",323).
component("YER053C",322).
component("YEL069C",316).
component("YEL063C",315).
component("YEL017C-A",308).
component("YDR536W",306).
component("YDR508C",303).
component("YDR503C",302).
component("YDR497C",300).
component("YDR345C",288).
component("YDR343C",287).
component("YDR342C",286).
component("YDR297W",283).
component("YDR046C",260) :- not remove_orf("YDR046C",260).
component("YDL245C",253).
component("YDL210W",249).
component("YCR032W",216).
component("YCR028C",215).
component("YCR024C-A",214).
component("YCL025C",206).
...
catalyst(2300,142).
catalyst(3460,113).
catalyst(3600,538) :- not remove_reaction(3600,538).
catalyst(8000,549).
catalyst(6890,643).
catalyst(2570,649).
catalyst(8781,282).
...
catalyst(4560,311).
catalyst(2550,662).
catalyst(1890,539) :- not remove_reaction(1890,539).
catalyst(3630,539) :- not remove_reaction(3630,539).
catalyst(1890,336) :- not remove_reaction(1890,336).
catalyst(3630,336) :- not remove_reaction(3630,336).
catalyst(3740,270).
catalyst(8231,748).
catalyst(8232,748).
catalyst(8231,721).
...
catalyst(8281,261).
catalyst(8282,261).
catalyst(3610,254) :- not remove_reaction(3610,254).
catalyst(7921,691).
catalyst(7922,691).
catalyst(7841,317).
catalyst(7842,317).
...
catalyst(1210,686).
catalyst(1160,681).
catalyst(801,670) :- not remove_reaction(801,670).
catalyst(802,670) :- not remove_reaction(802,670).
catalyst(811,670) :- not remove_reaction(811,670).
catalyst(812,670) :- not remove_reaction(812,670).
catalyst(831,670) :- not remove_reaction(831,670).
catalyst(832,670) :- not remove_reaction(832,670).
catalyst(901,670) :- not remove_reaction(901,670).
catalyst(902,670) :- not remove_reaction(902,670).
catalyst(1180,666).
catalyst(1210,666).
catalyst(931,651).
catalyst(932,651).
...
catalyst(640,548).
catalyst(6560,545).
catalyst(771,544) :- not remove_reaction(771,544).
catalyst(772,544) :- not remove_reaction(772,544).
catalyst(781,544) :- not remove_reaction(781,544).
catalyst(782,544) :- not remove_reaction(782,544).
catalyst(801,544) :- not remove_reaction(801,544).
catalyst(802,544) :- not remove_reaction(802,544).
catalyst(811,544) :- not remove_reaction(811,544).
catalyst(812,544) :- not remove_reaction(812,544).
catalyst(831,544) :- not remove_reaction(831,544).
catalyst(832,544) :- not remove_reaction(832,544).
catalyst(841,544) :- not remove_reaction(841,544).
catalyst(842,544) :- not remove_reaction(842,544).
catalyst(851,544) :- not remove_reaction(851,544).
catalyst(852,544) :- not remove_reaction(852,544).
catalyst(881,544) :- not remove_reaction(881,544).
catalyst(882,544) :- not remove_reaction(882,544).
catalyst(901,544) :- not remove_reaction(901,544).
catalyst(902,544) :- not remove_reaction(902,544).
catalyst(921,544) :- not remove_reaction(921,544).
catalyst(922,544) :- not remove_reaction(922,544).
catalyst(931,544) :- not remove_reaction(931,544).
catalyst(932,544) :- not remove_reaction(932,544).
catalyst(1191,544) :- not remove_reaction(1191,544).
catalyst(1192,544) :- not remove_reaction(1192,544).
catalyst(1180,518).
catalyst(1210,518).
catalyst(1581,508).
catalyst(1582,508).
...
catalyst(1210,286).
catalyst(6650,283).
catalyst(801,260) :- not remove_reaction(801,260).
catalyst(802,260) :- not remove_reaction(802,260).
catalyst(811,260) :- not remove_reaction(811,260).
catalyst(812,260) :- not remove_reaction(812,260).
catalyst(831,260) :- not remove_reaction(831,260).
catalyst(832,260) :- not remove_reaction(832,260).
catalyst(841,260) :- not remove_reaction(841,260).
catalyst(842,260) :- not remove_reaction(842,260).
catalyst(851,260) :- not remove_reaction(851,260).
catalyst(852,260) :- not remove_reaction(852,260).
catalyst(901,260) :- not remove_reaction(901,260).
catalyst(902,260) :- not remove_reaction(902,260).
catalyst(1180,253).
catalyst(1210,253).
catalyst(730,249).
catalyst(431,216).
...
catalyst(851,172) :- not remove_reaction(851,172).
catalyst(852,172) :- not remove_reaction(852,172).
...
catalyst(851,171) :- not remove_reaction(851,171).
catalyst(852,171) :- not remove_reaction(852,171).
