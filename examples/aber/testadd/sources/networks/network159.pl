...
component("YNL280C",798).
component("YLR056W",682).
component("YGR060W",472).
component("YGL012W",441).
component("YKR009C",659).
component("YOL086C",829).
component("YMR303C",770).
component("YMR083W",748).
component("YGL256W",465).
component("YDL168W",304).
component("YBR145W",233).
component("YPL231W",906).
component("YBR265W",252).
component("U46_",141).
component("YBR149W",234).
component("YBR149W",235).
component("YGL001C",437).
component("YIL094C",553).
component("YHR063C",519).
component("U45_",140).
component("YML056C",732).
component("YLR432W",721).
component("YHR216W",542).
component("YAR075W",196).
component("YAR073W",195).
component("YDR127W",333).
component("YJR139C",624).
component("YML075C",735).
component("YLR450W",724).
component("YOL126C",835).
component("YKL085W",636).
component("YDL078C",286).
component("YKL029C",631).
component("YNL037C",775).
component("YNL009W",773).
component("YLR174W",696).
component("YHR183W",535).
component("YGR256W",497).
component("YNL241C",790).
component("YOL059W",826).
component("YDL022W",278).
component("YCL018W",260).
component("YLR355C",716).
component("YIL074C",550).
component("YER081W",409).
component("YML054C",731).
component("YDL174C",308).
component("YML086C",737).
component("YIL155C",562).
component("YEL024W",382).
component("YKR066C",664).
component("YGR088W",476).
component("YDR256C",347).
component("YKL026C",630).
component("YIR037W",573).
component("YBR244W",247).
component("YJR078W",616).
component("U58_",150).
component("YJR025C",607).
component("U107_",27).
component("YGR255C",496).
component("U108_",28).
component("YHR007C",508).
component("YDR402C",362).
component("YGL055W",448).
component("YJR104C",619).
component("YHR008C",509).
component("YOR384W",879).
component("YOR381W",878).
component("YOL152W",838).
component("YLL051C",674).
component("YJL026W",575).
component("YIL066C",549).
component("YGR180C",484).
component("YER070W",406).
component("U37_",134).
component("U36_",133).
component("U35_",132).
component("YDL168W",305).
component("YDR158W",341).
component("YJR009C",603).
component("YJL052W",577).
component("YGR192C",486).
component("YBR006W",209).
component("YPL276W",915).
component("YPL275W",914).
component("YOR388C",880).
component("YPL061W",888).
component("YOR374W",876).
component("YER073W",407).
component("YGL154C",456).
component("YBR115C",228).
component("U55_",149).
component("YER069W",404).
component("YOR323C",868).
component("YMR170C",758).
component("YMR169C",757).
component("YER178W",419).
component("YBR221C",245).
component("YIL125W",558).
component("U52_",146).
component("YBR166C",238).
component("YNL280C",799).
component("YGL012W",442).
component("YKL182W",647).
component("YKL216W",657).
component("YDR044W",323).
component("YER014W",392).
component("YKR009C",660).
component("YIL160C",563).
component("YGL205W",461).
component("YMR118C",752).
component("YLR164W",694).
component("YLL041C",672).
component("YKL148C",641).
component("YKL141W",639).
component("YJL045W",576).
component("YDR178W",342).
component("YJR051W",610).
component("YEL047C",385).
component("YDL171C",306).
component("YDL171C",307).
component("YOR375C",877).
component("YDL215C",312).
component("YAL062W",192).
component("U99_",186).
component("U100_",21).
component("YBR035C",218).
component("YMR189W",760).
component("YKR080W",666).
component("YER023W",394).
component("YPL023C",884).
component("YGL125W",453).
component("YOR236W",865).
component("YGR204W",489).
component("YIR034C",572).
component("YLR142W",691).
component("U65_",157).
component("U63_",155).
component("U62_",154).
component("YHR068W",520).
component("YKL150W",642).
component("YIL043C",547).
component("YHR042W",514).
component("YOR221C",862).
component("YMR145C",755).
component("YML120C",738).
component("YKL192C",651).
component("YKL055C",633).
component("YER061C",402).
component("YDL085W",288).
component("YPL171C",896).
component("YHR179W",534).
component("YMR145C",756).
component("YML120C",739).
component("YKL192C",652).
component("YDL085W",289).
component("YGR234W",492).
component("YFR030W",433).
component("YPL017C",883).
component("YFL018C",423).
component("YDR353W",357).
component("YER042W",396).
component("YPR167C",935).
component("YJR137C",623).
component("YNL052W",777).
component("YMR256C",767).
component("YLR395C",720).
component("YLR038C",680).
component("YIL111W",555).
component("YHR051W",518).
component("YGL191W",459).
component("YGL187C",458).
component("YDL067C",285).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",328).
component("YPL266W",912).
component("YPL273W",913).
component("YLL062C",676).
component("YDR410C",365).
component("YKR069W",665).
component("YOL096C",830).
component("U47_",142).
component("YER091C",414).
component("YJR073C",614).
component("YGR157W",481).
component("YDR120C",331).
component("YML008C",726).
component("YOR074C",843).
component("YDL033C",280).
component("YOL096C",831).
component("YLR172C",695).
component("YLR058C",683).
component("YDR019C",319).
component("YBR176W",239).
component("YDR408C",364).
component("YMR120C",753).
component("YLR028C",678).
component("YBL013W",197).
component("YJL130C",588).
component("YJL088W",581).
component("YKL024C",629).
component("YPR074C",928).
component("YBR117C",229).
component("YMR108W",751).
component("YCL009C",259).
component("YMR062C",746).
component("YNL071W",779).
component("YNR008W",805).
component("YIL160C",564).
component("YNR019W",808).
component("YCR048W",274).
component("U48_",143).
component("YMR062C",747).
component("YDR232W",344).
component("YPL231W",907).
component("YER061C",403).
component("YPL001W",882).
component("YDL052C",284).
component("U8_",180).
component("YDR148C",339).
component("YPL231W",908).
component("YPL028W",885).
component("YLR299W",706).
component("YGL017W",443).
component("YCR005C",266).
component("YML126C",740).
component("YNL104C",782).
component("YDL182W",309).
component("YDL131W",295).
component("YPR160W",934).
component("YDR307W",353).
component("YLR258W",703).
component("YFR015C",430).
component("YPL227C",904).
component("YNL029C",774).
component("YIL085C",552).
component("YNL192W",788).
component("YBR038W",220).
component("YBR023C",216).
component("YEL011W",379).
component("YMR306W",771).
component("YLR342W",714).
component("YGR032W",469).
component("YPR183W",938).
component("YBR248C",248).
component("YLR209C",698).
component("U104_",24).
component("U103_",23).
component("YOR209C",860).
component("YDR354W",358) :- not remove_orf("YDR354W",358).
component("YFR047C",434).
component("YJR133W",622).
component("YLR209C",699).
component("YML022W",728).
component("YDR441C",368).
component("YHR128W",529).
component("YPR176C",937).
component("YPL172C",897).
component("YNR041C",811).
component("YMR101C",749).
component("YDL090C",291).
component("YBR003W",208).
component("YBR002C",207).
component("YJL167W",595).
component("YJL167W",596).
component("YNL256W",793).
component("YPR069C",925).
component("YDR127W",334).
component("YHR190W",537).
component("YLR146C",692).
component("YPL214C",903).
component("YHR068W",521).
component("YLR303W",708).
component("YGR012W",467).
component("YML082W",736).
component("YJR130C",621).
component("YDR035W",321).
component("YBR249C",249).
component("YLR180W",697).
component("YDR502C",372).
component("YOR274W",866).
component("YOL143C",837).
component("YBR256C",251).
component("YHR137W",530).
component("YGL202W",460).
component("YLR027C",677).
component("YKL106W",637).
component("YOL140W",836).
component("YLR438W",723).
component("YGR019W",468).
component("YLR089C",687).
component("U64_",156).
component("U61_",153).
component("U51_",145).
component("YJR148W",625).
component("YHR208W",540).
component("YFL030W",425).
component("YOR184W",854).
component("YNR058W",815).
component("YIL116W",557).
component("YGL253W",464).
component("YFR053C",435).
component("YMR013C",744).
component("YMR205C",762).
component("YGR240C",493).
component("YOL016C",819).
component("YFR014C",429).
component("YLR240W",701).
component("YKL203C",654).
component("YJR066W",613).
component("YCR036W",273).
component("YGR194C",487).
component("YCL040W",262).
component("U15_",68).
component("YPL188W",899).
component("YJR049C",609).
component("YEL041W",383).
component("U96_",184).
component("YKL001C",628).
component("YDR236C",345).
component("YML070W",734).
component("YFL053W",427).
component("YHL032C",506).
component("YDR531W",376).
component("U83_",175).
component("U82_",174).
component("U81_",173).
component("YMR208W",763).
component("YPL203W",900).
component("YOR061W",842).
component("YKL166C",644).
component("YJL164C",594).
component("YIL035C",546).
component("YHR205W",539).
component("YHR102W",527).
component("YGL019W",444).
component("YHR025W",513).
component("YOR347C",873).
component("YAL038W",190).
component("YNR012W",806).
component("YDR009W",318).
component("YDR127W",335).
component("U21_",113).
component("YDR147W",338).
component("YDR300C",352).
component("YCR012W",267).
component("YER069W",405).
component("U19_",103).
component("U18_",93).
component("U17_",83).
component("U76_",167).
component("YER170W",418).
component("YDR226W",343).
component("YKL067W",635).
component("YOL055C",823).
component("YDR454C",369).
component("YJR057W",611).
component("YOL061W",827).
component("YKL181W",646).
component("YHL011C",504).
component("YER099C",415).
component("YBL068W",204).
component("YOR143C",850).
component("YNL256W",794).
component("YLR328W",712).
component("YBR018C",211).
component("YBR018C",212).
component("YGR007W",466).
component("YGR202C",488).
component("YLR328W",713).
component("YDL045C",282).
component("U80_",172).
component("YDL103C",294).
component("U94_",183).
component("YJR010W",604).
component("YBR029C",217).
component("YCL050C",263).
component("YGL130W",454).
component("YDR530C",375).
component("YCL050C",264).
component("YPR190C",940).
component("YPR187W",939).
component("YPR110C",931).
component("YPR010C",918).
component("YOR341W",872).
component("YOR340C",871).
component("YOR224C",864).
component("YOR210W",861).
component("YOR207C",858).
component("YOR151C",851).
component("YOR116C",845).
component("YOL005C",817).
component("YNR003C",804).
component("YNL248C",792).
component("YNL151C",786).
component("YNL113W",783).
component("YKL144C",640).
component("YJR063W",612).
component("YJL148W",592).
component("YJL140W",591).
component("YIL021W",545).
component("YHR143W-A",531).
component("YGL070C",451).
component("YFL036W",426).
component("YDR404C",363).
component("YDR156W",340).
component("YDR045C",324).
component("YDL150W",303).
component("YDL140C",297).
component("YBR154C",237).
component("YPR175W",936).
component("YPL167C",895).
component("YOR330C",869).
component("YOL115W",834).
component("YNL299W",801).
component("YNL262W",796).
component("YNL102W",781).
component("YJR043C",608).
component("YJR006W",602).
component("YJL090C",582).
component("YIL139C",560).
component("YEL055C",386).
component("YDR419W",366).
component("YDR121W",332).
component("YDL102W",293).
component("YCR014C",268).
component("YBR278W",254).
component("YBL035C",200).
component("YKL035W",632).
component("YHL012W",505).
component("YHR123W",528).
component("YPR113W",932).
component("YBR243C",246).
component("YDL142C",302).
component("YPL148C",893).
component("YER026C",395).
component("YGR286C",501).
component("YJL068C",578).
component("YHR189W",536).
component("YDR058C",327).
component("YDL086W",290).
component("YOL011W",818).
component("YMR008C",742).
component("YMR006C",741).
component("U105_",25).
component("YBL015W",198).
component("YJL068C",579).
component("YJR019C",606).
component("YOR040W",841).
component("U77_",168).
component("YDR481C",370).
component("YLR377C",718).
component("YFR025C",431).
component("YPL179W",898).
component("YNR032W",809).
component("YML057W",733).
component("YML016C",727).
component("YLR433C",722).
component("YGR123C",479).
component("YER133W",416).
component("YER089C",412).
component("YDR436W",367).
component("YDR075W",329).
component("YDL188C",310).
component("YDL134C",296).
component("YDL047W",283).
component("YDL006W",276).
component("YBR125C",232).
component("YBL056W",203).
component("YPR073C",926).
component("YHR215W",541).
component("YDL024C",279).
component("YBR093C",226).
component("YBR092C",225).
component("YAR071W",194).
component("YHR046C",517).
component("U9_",187).
component("YPL228W",905).
component("YMR180C",759).
component("YDL236W",314).
component("YJL155C",593).
component("YPR073C",927).
component("YOR208W",859).
component("YNL053W",778).
component("YMR036C",745).
component("YIR026C",570).
component("YIL113W",556).
component("YFR028C",432).
component("YER075C",408).
component("YDL230W",313).
component("YBR276C",253).
component("U34_",131).
component("U33_",130).
component("U32_",129).
component("U31_",128).
...
component("U25_",122).
component("U24_",121).
component("YHR044C",516).
component("YHR043C",515).
component("YOL064C",828).
component("YOR360C",875).
component("YGL248W",463).
component("YKR031C",661).
component("YPL206C",901).
component("YGL027C",446).
component("YLR286C",705).
component("YJR153W",626).
component("YJL221C",601).
component("YJL216C",599).
component("YIL172C",568).
component("YGR292W",503).
component("YGR287C",502).
component("YBR299W",258).
component("YBR184W",240).
component("YIL162W",565).
component("YPR026W",919).
component("YDR001C",316).
component("YBR001C",206).
component("YIR019C",569).
component("YIL099W",554).
component("YDL037C",281).
component("YOR190W",856).
component("YLR300W",707).
component("YGR282C",500).
component("YDR261C",348).
component("YDR400W",361).
component("U23_",120).
component("YML035C",729).
component("YJL070C",580).
component("YBR284W",255).
component("U106_",26).
component("U102_",22).
component("YER043C",397).
component("YNL045W",776).
component("YGL037C",447).
component("YDR242W",346).
component("YLR308W",711).
component("YLR307W",710).
component("YBR208C",242).
component("YMR281W",769).
component("U53_",147).
component("YIR032C",571).
component("YPR062W",924).
component("YMR120C",754).
component("YLR028C",679).
component("YHR144C",532).
component("YGR267C",499).
component("YBL033C",199).
component("YBR153W",236).
component("YNL141W",784).
component("YLR245C",702).
component("YML035C",730).
component("YGR204W",490).
component("YBR084W",223).
component("YJL126W",586).
component("U44_",139).
component("YDL100C",292).
component("U87_",177).
component("U40_",137).
component("U39_",135).
component("YBR011C",210).
component("YHR201C",538).
component("YBR111C",227).
component("YBR252W",250).
component("YPR080W",929).
component("YOR187W",855).
component("YOR133W",848).
component("YLR069C",685).
component("YKR084C",667).
component("YKL173W",645).
component("YJL102W",584).
component("YDR385W",360).
component("YBR118W",230).
component("YER005W",391).
component("YLL001W",670).
component("YIL048W",548).
component("YER166W",417).
component("YDR093W",330).
component("YAL026C",189).
component("YBL099W",205).
component("U60_",152).
component("YLR231C",700).
component("U88_",178).
component("YDR538W",378).
component("YLR134W",689).
component("YLR044C",681).
component("YGR087C",475).
component("YDR380W",359).
component("YDL080C",287).
component("U98_",185).
component("YMR250W",766).
component("YKL184W",650).
component("YOR128C",846).
component("YEL021W",381).
component("YNR043W",812).
component("U93_",182).
component("U54_",148).
component("YKL211C",655) :- not remove_orf("YKL211C",655).
component("YKR097W",669).
component("YOL052C",822).
component("YNL169C",787).
component("YGR170W",482).
component("YKL060C",634).
component("YNL256W",795).
component("YDR294C",350).
component("YEL046C",384).
component("YNR033W",810).
component("YKL211C",656) :- not remove_orf("YKL211C",656).
component("YER090W",656) :- not remove_orf("YER090W",656).
component("YER090W",413) :- not remove_orf("YER090W",413).
component("YDR127W",336).
component("YPL281C",916).
component("YOR393W",881).
component("YMR323W",772).
component("YHR174W",533).
component("YGR254W",495).
component("YOR202W",857).
component("YPL262W",910).
component("YGL026C",445) :- not remove_orf("YGL026C",445).
component("YGR155W",480).
component("YLR304C",709).
component("YJL200C",597).
component("YGL009C",440).
component("YNL316C",802).
component("YKL182W",648).
component("YPL212C",902).
component("YNL292W",800).
component("YGL063W",450).
component("YFL001W",421).
component("YPR002W",917).
component("YJR016C",605).
component("YCR053W",275).
component("YDR127W",337).
component("YGL148W",455).
component("YIL168W",567).
component("YIL167W",566).
component("YCL064C",265).
component("YER086W",410).
component("YLR359W",717).
component("YAL012W",188).
component("YML004C",725).
component("YFR055W",436).
component("YJL005W",574).
component("YJL121C",585).
component("YBR019C",213).
component("YBR019C",214).
component("YDR050C",326).
component("YIL020C",544).
component("YDR007W",317) :- not remove_orf("YDR007W",317).
component("YOR095C",844).
component("YER003C",390).
component("YBR196C",241).
component("YGL001C",438).
component("YPL117C",891).
component("U14_",60).
component("YOL056W",824).
component("YKL152C",643).
component("YDL021W",277).
component("YMR105C",750).
component("YKL127W",638).
component("YEL058W",387).
component("YPR060C",923).
component("YHR072W",522).
component("YPL097W",889).
component("YGR185C",485).
component("YGR264C",498).
component("YGR171C",483).
component("YHR011W",510).
component("YDR023W",320).
component("YPL104W",890).
component("YLL018C",671).
component("YPR081C",930).
component("YBR121C",231).
component("YHR020W",512).
component("YER087W",411).
component("YNL247W",791).
component("YOR168W",852).
component("YOL097C",832).
component("YDR268W",349).
component("YPR047W",922).
component("YLR060W",684).
component("YFL022C",424).
component("YPR033C",920).
component("YCR024C",269).
component("YHR019C",511).
component("YKL194C",653).
component("YIL078W",551).
component("YPL160W",894).
component("YLR382C",719).
component("YNL073W",780).
component("YDR037W",322).
component("YOR335C",870).
component("YGR094W",477).
component("YLR153C",693).
component("YAL054C",191).
component("YOR317W",867).
component("YMR246W",765).
component("YIL009W",543).
component("YER015W",393).
component("YOR142W",849).
component("YGR244C",494).
component("YPR035W",921).
component("YIL145C",561).
component("U89_",179).
component("YJL101C",583).
component("YOL049W",821).
component("YAR015W",193).
component("YER183C",420).
component("U90_",181).
component("YNR057C",814).
component("YDL141W",298).
component("YDL141W",299).
component("YGL234W",462).
component("YDL141W",300).
component("YJR103W",618).
component("YBL039C",201).
component("YGR204W",491).
component("YBR084W",224).
component("YNL220W",789).
component("YOL058W",825).
component("YBR208C",243).
component("YDL141W",301).
component("YHR074W",523).
component("YMR217W",764).
component("YGR061C",473).
component("YJR109C",620).
component("YJL130C",589).
component("YGL062W",449).
component("YBR218C",244).
component("YPL231W",909).
component("YNR016C",807).
component("YKL182W",649).
component("YGR037C",470).
component("YPR138C",933).
component("YPL265W",911).
component("YPL134C",892).
component("YPL057C",887).
component("YPL036W",886).
component("YOR348C",874).
component("YOR222W",863).
component("YOR171C",853).
component("YOR130C",847).
component("YOR011W",840).
component("YOL156W",839).
component("YOL103W",833).
component("YOL020W",820) :- not remove_orf("YOL020W",820).
component("YNR072W",816).
component("YNR056C",813).
component("YNL318C",803).
component("YNL270C",797).
component("YNL142W",785).
component("YMR272C",768).
component("YMR202W",761).
component("YMR011W",743).
component("YLR348C",715).
component("YLR260W",704).
component("YLR138W",690).
component("YLR100C",688).
component("YLR081W",686).
component("YLL061W",675).
component("YLL043W",673).
component("YKR093W",668).
component("YKR053C",663).
component("YKR039W",662) :- not remove_orf("YKR039W",662).
component("YKL217W",658).
component("YJR158W",627).
component("YJR095W",617).
component("YJR077C",615).
component("YJL219W",600).
component("YJL214W",598).
component("YJL134W",590).
component("YJL129C",587).
component("YIL134W",559).
component("YHR096C",526).
component("YHR094C",525).
component("YHR092C",524).
component("YHL036W",507).
component("YGR121C",478).
component("YGR065C",474).
component("YGR055W",471).
component("YGL186C",457).
component("YGL077C",452).
component("YGL008C",439).
component("YFL055W",428).
component("YFL011W",422).
component("YER060W-A",401).
component("YER060W",400).
component("YER056C",399).
component("YER053C",398).
component("YEL069C",389).
component("YEL063C",388).
component("YEL017C-A",380).
component("YDR536W",377).
component("YDR508C",374).
component("YDR503C",373).
component("YDR497C",371).
component("YDR345C",356).
component("YDR343C",355).
component("YDR342C",354).
component("YDR297W",351).
component("YDR046C",325) :- not remove_orf("YDR046C",325).
component("YDL245C",315).
component("YDL210W",311).
component("YCR032W",272).
component("YCR028C",271).
component("YCR024C-A",270).
component("YCL025C",261).
component("YBR298C",257).
component("YBR291C",256).
component("YBR069C",222) :- not remove_orf("YBR069C",222).
component("YBR068C",221) :- not remove_orf("YBR068C",221).
component("YBR036C",219).
component("YBR021W",215).
...
catalyst(2132,23).
catalyst(2220,860).
catalyst(3620,358) :- not remove_reaction(3620,358).
catalyst(2110,434).
catalyst(2190,434).
catalyst(5550,622).
catalyst(5791,699).
...
catalyst(2300,182).
catalyst(3460,148).
catalyst(3600,655) :- not remove_reaction(3600,655).
catalyst(8000,669).
catalyst(3941,822).
catalyst(3942,822).
catalyst(6890,787).
...
catalyst(4560,384).
catalyst(2550,810).
catalyst(1890,656) :- not remove_reaction(1890,656).
catalyst(3630,656) :- not remove_reaction(3630,656).
catalyst(1890,413) :- not remove_reaction(1890,413).
catalyst(3630,413) :- not remove_reaction(3630,413).
catalyst(3740,336).
catalyst(8231,916).
catalyst(8232,916).
catalyst(8231,881).
...
catalyst(8061,910).
catalyst(8062,910).
catalyst(3590,445) :- not remove_reaction(3590,445).
catalyst(10910,445) :- not remove_reaction(10910,445).
catalyst(4570,480).
catalyst(8181,709).
catalyst(8182,709).
catalyst(8181,597).
...
catalyst(8282,326).
catalyst(3840,544).
catalyst(3610,317) :- not remove_reaction(3610,317).
catalyst(7921,844).
catalyst(7922,844).
catalyst(7841,390).
catalyst(7842,390).
...
catalyst(1210,839).
catalyst(1160,833).
catalyst(801,820) :- not remove_reaction(801,820).
catalyst(802,820) :- not remove_reaction(802,820).
catalyst(811,820) :- not remove_reaction(811,820).
catalyst(812,820) :- not remove_reaction(812,820).
catalyst(831,820) :- not remove_reaction(831,820).
catalyst(832,820) :- not remove_reaction(832,820).
catalyst(901,820) :- not remove_reaction(901,820).
catalyst(902,820) :- not remove_reaction(902,820).
catalyst(1180,816).
catalyst(1210,816).
catalyst(700,813).
catalyst(1200,803).
...
catalyst(650,668).
catalyst(6560,663).
catalyst(681,662) :- not remove_reaction(681,662).
catalyst(682,662) :- not remove_reaction(682,662).
catalyst(771,662) :- not remove_reaction(771,662).
catalyst(772,662) :- not remove_reaction(772,662).
catalyst(781,662) :- not remove_reaction(781,662).
catalyst(782,662) :- not remove_reaction(782,662).
catalyst(791,662) :- not remove_reaction(791,662).
catalyst(792,662) :- not remove_reaction(792,662).
catalyst(801,662) :- not remove_reaction(801,662).
catalyst(802,662) :- not remove_reaction(802,662).
catalyst(811,662) :- not remove_reaction(811,662).
catalyst(812,662) :- not remove_reaction(812,662).
catalyst(831,662) :- not remove_reaction(831,662).
catalyst(832,662) :- not remove_reaction(832,662).
catalyst(841,662) :- not remove_reaction(841,662).
catalyst(842,662) :- not remove_reaction(842,662).
catalyst(851,662) :- not remove_reaction(851,662).
catalyst(852,662) :- not remove_reaction(852,662).
catalyst(881,662) :- not remove_reaction(881,662).
catalyst(882,662) :- not remove_reaction(882,662).
catalyst(901,662) :- not remove_reaction(901,662).
catalyst(902,662) :- not remove_reaction(902,662).
catalyst(911,662) :- not remove_reaction(911,662).
catalyst(912,662) :- not remove_reaction(912,662).
catalyst(921,662) :- not remove_reaction(921,662).
catalyst(922,662) :- not remove_reaction(922,662).
catalyst(931,662) :- not remove_reaction(931,662).
catalyst(932,662) :- not remove_reaction(932,662).
catalyst(1191,662) :- not remove_reaction(1191,662).
catalyst(1192,662) :- not remove_reaction(1192,662).
catalyst(390,658).
catalyst(1180,627).
catalyst(1210,627).
catalyst(1250,617).
...
catalyst(1210,354).
catalyst(6650,351).
catalyst(791,325) :- not remove_reaction(791,325).
catalyst(792,325) :- not remove_reaction(792,325).
catalyst(801,325) :- not remove_reaction(801,325).
catalyst(802,325) :- not remove_reaction(802,325).
catalyst(811,325) :- not remove_reaction(811,325).
catalyst(812,325) :- not remove_reaction(812,325).
catalyst(831,325) :- not remove_reaction(831,325).
catalyst(832,325) :- not remove_reaction(832,325).
catalyst(841,325) :- not remove_reaction(841,325).
catalyst(842,325) :- not remove_reaction(842,325).
catalyst(851,325) :- not remove_reaction(851,325).
catalyst(852,325) :- not remove_reaction(852,325).
catalyst(901,325) :- not remove_reaction(901,325).
catalyst(902,325) :- not remove_reaction(902,325).
catalyst(1180,315).
catalyst(1210,315).
catalyst(690,311).
catalyst(730,311).
...
catalyst(1511,256).
catalyst(1512,256).
catalyst(771,222) :- not remove_reaction(771,222).
catalyst(772,222) :- not remove_reaction(772,222).
...
catalyst(851,222) :- not remove_reaction(851,222).
catalyst(852,222) :- not remove_reaction(852,222).
...
catalyst(831,221) :- not remove_reaction(831,221).
catalyst(832,221) :- not remove_reaction(832,221).
catalyst(841,221) :- not remove_reaction(841,221).
catalyst(842,221) :- not remove_reaction(842,221).
catalyst(851,221) :- not remove_reaction(851,221).
catalyst(852,221) :- not remove_reaction(852,221).
...
modifiable_enzyme(655).
modifiable_enzyme(656).
modifiable_enzyme(413).
modifiable_enzyme(445).
modifiable_enzyme(317).
modifiable_enzyme(820).
modifiable_enzyme(662).
