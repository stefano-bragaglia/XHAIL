...
component("YLR056W",265).
component("YKR009C",253).
component("YOL086C",322).
component("YMR303C",296).
component("YGL256W",181).
component("YDL168W",110).
component("YBR145W",83).
component("YPL231W",352).
component("U46_",50).
component("YBR149W",84).
component("YGL001C",163).
component("YIL094C",214).
component("U45_",49).
component("YDR127W",119).
component("YOL126C",326).
component("YKL085W",245).
component("YDL078C",104).
component("YNL037C",300).
component("YCL018W",95).
component("YLR355C",284).
component("YDL174C",111).
component("YML086C",289).
component("YGR088W",187).
component("YDR256C",129).
component("YJR078W",239).
component("YJR025C",234).
component("U107_",22).
component("YJL026W",222).
component("YGR180C",190).
component("YER070W",155).
component("U36_",45).
component("YPL276W",358).
component("YPL275W",357).
component("YOR388C",343).
component("YOR323C",337).
component("YIL125W",216).
component("U52_",53).
component("YBR166C",86).
component("YKL216W",252).
component("YKR009C",254).
component("YIL160C",219).
component("YGL205W",178).
component("YKR080W",258).
component("YER023W",150).
component("YGR204W",192).
component("YLR142W",270).
component("U65_",56).
component("U62_",55).
component("YHR068W",204).
component("YKL150W",248).
component("YIL043C",212).
component("YPL171C",351).
component("YHR179W",210).
component("YDR353W",133).
component("YNL052W",301).
component("YMR256C",295).
component("YLR395C",286).
component("YLR038C",263).
component("YIL111W",215).
component("YHR051W",203).
component("YGL191W",176).
component("YGL187C",175).
component("YDL067C",103).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",356).
component("YKR069W",257).
component("YJR073C",237).
component("YDL033C",102).
component("YLR172C",272).
component("YLR058C",266).
component("YDR019C",114).
component("YBR176W",87).
component("YDR408C",138).
component("YMR120C",293).
component("YLR028C",261).
component("YBL013W",68).
component("YJL130C",227).
component("YKL024C",243).
component("YPR074C",362).
component("YBR117C",82).
component("YCL009C",94).
component("U48_",51).
component("YPL231W",353).
component("YPL231W",354).
component("YLR299W",279).
component("YGL017W",166).
component("YML126C",290).
component("YDL182W",112).
component("YDL131W",107).
component("YLR258W",277).
component("YFR015C",160).
component("YNL029C",299).
component("YIL085C",213).
component("YMR306W",297).
component("YLR342W",283).
component("YGR032W",183).
component("YLR209C",273).
component("U104_",20).
component("YDR354W",134) :- not remove_orf("YDR354W",134).
component("YFR047C",161).
component("YLR209C",274).
component("YML022W",287).
component("YDR441C",140).
component("YJL167W",231).
component("YDR127W",120).
component("YLR303W",281).
component("YGR012W",182).
component("YJR130C",241).
component("YDR035W",115).
component("YBR249C",89).
component("YOR274W",336).
component("YHR137W",206).
component("YGL202W",177).
component("YLR027C",260).
component("YKL106W",246).
component("YLR089C",267).
component("YJR148W",242).
component("YNR058W",316).
component("YGL253W",180).
component("YFR053C",162).
component("YCR036W",100).
component("U96_",64).
component("YDR236C",127).
component("YHL032C",198).
component("YNR012W",314).
component("YDR127W",121).
component("YDR147W",124).
component("U76_",61).
component("YDR226W",126).
component("YKL067W",244).
component("YOL055C",320).
component("YDR454C",141).
component("YOL061W",321).
component("YKL181W",249).
component("YHL011C",197).
component("YER099C",157).
component("YBL068W",72).
component("YNL256W",308).
component("YBR018C",75).
component("YBR029C",77).
component("YGL130W",172).
component("YPR190C",368).
component("YPR187W",367).
component("YPR110C",363).
component("YPR010C",360).
component("YOR341W",341).
component("YOR340C",340).
component("YOR224C",335).
component("YOR210W",334).
component("YOR207C",333).
component("YOR151C",330).
component("YOR116C",329).
component("YOL005C",317).
component("YNR003C",313).
component("YNL248C",307).
component("YNL151C",306).
component("YNL113W",303).
component("YKL144C",247).
component("YJR063W",236).
component("YJL148W",230).
component("YJL140W",229).
component("YIL021W",211).
component("YHR143W-A",207).
component("YGL070C",170).
component("YFL036W",158).
component("YDR404C",137).
component("YDR156W",125).
component("YDR045C",116).
component("YDL150W",109).
component("YDL140C",108).
component("YBR154C",85).
component("YPR175W",366).
component("YPL167C",350).
component("YOR330C",338).
component("YOL115W",325).
component("YNL299W",311).
component("YNL262W",309).
component("YNL102W",302).
component("YJR043C",235).
component("YJR006W",233).
component("YJL090C",224).
component("YIL139C",217).
component("YEL055C",147).
component("YDR419W",139).
component("YDR121W",118).
component("YDL102W",106).
component("YCR014C",98).
component("YBR278W",91).
component("YBL035C",70).
component("YPR113W",364).
component("YPL148C",349).
component("YGR286C",196).
component("YOL011W",318).
component("YMR008C",292).
component("YMR006C",291).
component("U105_",21).
component("YBL015W",69).
component("U77_",62).
component("YLR377C",285).
component("U30_",44).
component("U29_",43).
component("U24_",42).
component("YHR044C",202).
component("YHR043C",201).
component("YOR360C",342).
component("YGL027C",168).
component("YOR190W",332).
component("YLR300W",280).
component("YGR282C",195).
component("YDR261C",130).
component("YDR400W",136).
component("YML035C",288).
component("YJL070C",223).
component("YBR284W",92).
component("YDR242W",128).
component("U53_",54).
component("YMR120C",294).
component("YLR028C",262).
component("YHR144C",208).
component("YNL141W",304).
component("YLR245C",276).
component("YJL126W",225).
component("U39_",46).
component("YBR011C",74).
component("YBR111C",81).
component("YBR252W",90).
component("YER005W",149).
component("YBL099W",73).
component("YLR231C",275).
component("YLR134W",269).
component("YLR044C",264).
component("YGR087C",186).
component("YDR380W",135).
component("YDL080C",105).
component("U98_",65).
component("YKL211C",250) :- not remove_orf("YKL211C",250).
component("YKL211C",251) :- not remove_orf("YKL211C",251).
component("YER090W",251) :- not remove_orf("YER090W",251).
component("YER090W",156) :- not remove_orf("YER090W",156).
component("YDR127W",122).
component("YPL281C",359).
component("YOR393W",344).
component("YMR323W",298).
component("YHR174W",209).
component("YGR254W",193).
component("YGL026C",167) :- not remove_orf("YGL026C",167).
component("YLR304C",282).
component("YJL200C",232).
component("YNL316C",312).
component("YCR053W",101).
component("YDR127W",123).
component("YGL148W",173).
component("YIL168W",221).
component("YIL167W",220).
component("YCL064C",97).
component("YAL012W",66).
component("YBR019C",76).
component("YDR007W",113) :- not remove_orf("YDR007W",113).
component("YOR095C",328).
component("YGL001C",164).
component("YPL117C",348).
component("YPR060C",361).
component("YPL097W",346).
component("YGR185C",191).
component("YGR264C",194).
component("YGR171C",189).
component("YPL104W",347).
component("YLL018C",259).
component("YOL097C",323).
component("YDR268W",131).
component("YHR019C",200).
component("YOR335C",339).
component("YLR153C",271).
component("YAL054C",67).
component("YIL145C",218).
component("U90_",63).
component("YNR057C",315).
component("YGL234W",179).
component("YJR103W",240).
component("YBL039C",71).
component("YBR084W",80).
component("YHR074W",205).
component("YGL062W",169).
component("YBR218C",88).
component("YPR138C",365).
component("YPL265W",355).
component("YPL036W",345).
component("YOR171C",331).
component("YOR011W",327).
component("YOL103W",324).
component("YOL020W",319) :- not remove_orf("YOL020W",319).
component("YNL270C",310).
component("YNL142W",305).
component("YLR260W",278).
component("YLR100C",268).
component("YKR053C",256).
component("YKR039W",255) :- not remove_orf("YKR039W",255).
component("YJR077C",238).
component("YJL134W",228).
component("YJL129C",226).
component("YHL036W",199).
component("YGR121C",188).
component("YGR065C",185).
component("YGR055W",184).
component("YGL186C",174).
component("YGL077C",171).
component("YGL008C",165).
component("YFL055W",159).
component("YER060W-A",154).
component("YER060W",153).
component("YER056C",152).
component("YER053C",151).
component("YEL063C",148).
component("YEL017C-A",146).
component("YDR536W",145).
component("YDR508C",144).
component("YDR503C",143).
component("YDR497C",142).
component("YDR297W",132).
component("YDR046C",117) :- not remove_orf("YDR046C",117).
component("YCR024C-A",99).
component("YCL025C",96).
component("YBR298C",93).
component("YBR069C",79) :- not remove_orf("YBR069C",79).
component("YBR068C",78) :- not remove_orf("YBR068C",78).
component("U75_",60).
component("U74_",59).
component("U73_",58).
component("U72_",57).
...
catalyst(2121,20).
catalyst(2122,20).
catalyst(3620,134) :- not remove_reaction(3620,134).
catalyst(2190,161).
catalyst(5791,274).
catalyst(5792,274).
catalyst(5801,274).
...
catalyst(8812,105).
catalyst(2250,65).
catalyst(3600,250) :- not remove_reaction(3600,250).
catalyst(3630,251) :- not remove_reaction(3630,251).
...
catalyst(8231,193).
catalyst(8232,193).
catalyst(3590,167) :- not remove_reaction(3590,167).
catalyst(10910,167) :- not remove_reaction(10910,167).
catalyst(8181,282).
catalyst(8182,282).
catalyst(8181,232).
catalyst(8182,232).
...
catalyst(7751,76).
catalyst(7752,76).
catalyst(3610,113) :- not remove_reaction(3610,113).
catalyst(7921,328).
catalyst(7922,328).
catalyst(6370,164).
catalyst(6461,348).
...
catalyst(22,327).
catalyst(1160,324).
catalyst(801,319) :- not remove_reaction(801,319).
catalyst(802,319) :- not remove_reaction(802,319).
catalyst(811,319) :- not remove_reaction(811,319).
catalyst(812,319) :- not remove_reaction(812,319).
catalyst(831,319) :- not remove_reaction(831,319).
catalyst(832,319) :- not remove_reaction(832,319).
catalyst(901,319) :- not remove_reaction(901,319).
catalyst(902,319) :- not remove_reaction(902,319).
catalyst(931,310).
catalyst(932,310).
catalyst(371,305).
catalyst(372,305).
...
catalyst(781,255) :- not remove_reaction(781,255).
catalyst(782,255) :- not remove_reaction(782,255).
...
catalyst(881,255) :- not remove_reaction(881,255).
catalyst(882,255) :- not remove_reaction(882,255).
catalyst(901,255) :- not remove_reaction(901,255).
catalyst(902,255) :- not remove_reaction(902,255).
catalyst(931,255) :- not remove_reaction(931,255).
catalyst(932,255) :- not remove_reaction(932,255).
catalyst(1191,255) :- not remove_reaction(1191,255).
catalyst(1192,255) :- not remove_reaction(1192,255).
catalyst(1581,238).
catalyst(1582,238).
catalyst(6560,228).
catalyst(361,226).
...
catalyst(1121,93).
catalyst(1122,93).
catalyst(771,79) :- not remove_reaction(771,79).
catalyst(772,79) :- not remove_reaction(772,79).
...
catalyst(851,79) :- not remove_reaction(851,79).
catalyst(852,79) :- not remove_reaction(852,79).
catalyst(901,79) :- not remove_reaction(901,79).
catalyst(902,79) :- not remove_reaction(902,79).
catalyst(801,78) :- not remove_reaction(801,78).
catalyst(802,78) :- not remove_reaction(802,78).
catalyst(811,78) :- not remove_reaction(811,78).
catalyst(812,78) :- not remove_reaction(812,78).
catalyst(831,78) :- not remove_reaction(831,78).
catalyst(832,78) :- not remove_reaction(832,78).
catalyst(841,78) :- not remove_reaction(841,78).
catalyst(842,78) :- not remove_reaction(842,78).
catalyst(851,78) :- not remove_reaction(851,78).
catalyst(852,78) :- not remove_reaction(852,78).
catalyst(901,78) :- not remove_reaction(901,78).
catalyst(902,78) :- not remove_reaction(902,78).
catalyst(2920,60).
catalyst(2920,59).
catalyst(2920,58).
catalyst(2920,57).
