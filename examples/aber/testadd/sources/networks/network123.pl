...
component("YNL280C",673).
component("YLR056W",576).
component("YGR060W",401).
component("YGL012W",373).
component("YKR009C",558).
component("YOL086C",699).
component("YMR303C",647).
component("YMR083W",634).
component("YGL256W",395).
component("YDL168W",253).
component("YBR145W",191).
component("YPL231W",761).
component("YBR265W",206).
component("U46_",112).
component("YBR149W",192).
component("YBR149W",193).
component("YGL001C",370).
component("YIL094C",469).
component("U45_",111).
component("YML056C",622).
component("YLR432W",612).
component("YHR216W",461).
component("YAR075W",163).
component("YAR073W",162).
component("YDR127W",278).
component("YJR139C",532).
component("YML075C",624).
component("YLR450W",615).
component("YOL126C",705).
component("YKL085W",540).
component("YDL078C",238).
component("YNL037C",652).
component("YNL009W",650).
component("YLR174W",589).
component("YHR183W",454).
component("YGR256W",420).
component("YNL241C",666).
component("YOL059W",696).
component("YDL022W",231).
component("YCL018W",214).
component("YLR355C",607).
component("YIL074C",466).
component("YER081W",345).
component("YDL174C",257).
component("YML086C",626).
component("YIL155C",478).
component("YGR088W",404).
component("YDR256C",291).
component("YKL026C",538).
component("YIR037W",488).
component("YBR244W",202).
component("YJR078W",525).
component("U58_",121).
component("YJR025C",517).
component("U107_",24).
component("YHR007C",430).
component("YDR402C",305).
component("YGL055W",380).
component("YJR104C",527).
component("YHR008C",431).
component("YOR384W",741).
component("YOR381W",740).
component("YOL152W",707).
component("YLL051C",569).
component("YJL026W",490).
component("YIL066C",465).
component("YGR180C",410).
component("YER070W",342).
component("U37_",105).
component("U36_",104).
component("U35_",103).
component("YDL168W",254).
component("YDR158W",285).
component("YJR009C",514).
component("YJL052W",492).
component("YGR192C",412).
component("YBR006W",173).
component("YPL276W",769).
component("YPL275W",768).
component("YOR388C",742).
component("YOR374W",738).
component("YER073W",343).
component("YGL154C",387).
component("YBR115C",187).
component("U55_",120).
component("YER069W",340).
component("YOR323C",730).
component("YER178W",354).
component("YBR221C",200).
component("YIL125W",474).
component("U52_",117).
component("YBR166C",195).
component("YGL012W",374).
component("YKL182W",549).
component("YKL216W",557).
component("YDR044W",269).
component("YKR009C",559).
component("YIL160C",479).
component("YGL205W",392).
component("YMR118C",636).
component("YLR164W",587).
component("YLL041C",568).
component("YKL148C",544).
component("YKL141W",542).
component("YJL045W",491).
component("YDR178W",286).
component("YEL047C",325).
component("YDL171C",255).
component("YDL171C",256).
component("YOR375C",739).
component("YDL215C",261).
component("YAL062W",159).
component("U99_",154).
component("U100_",20).
component("YBR035C",179).
component("YKR080W",564).
component("YER023W",332).
component("YOR236W",728).
component("YGR204W",414).
component("YIR034C",487).
component("YLR142W",584).
component("U65_",127).
component("U63_",125).
component("U62_",124).
component("YHR068W",440).
component("YKL150W",545).
component("YIL043C",464).
component("YHR042W",435).
component("YMR145C",639).
component("YDL085W",240).
component("YPL171C",754).
component("YHR179W",453).
component("YMR145C",640).
component("YML120C",627).
component("YKL192C",552).
component("YDL085W",241).
component("YGR234W",416).
component("YFR030W",366).
component("YPL017C",744).
component("YFL018C",358).
component("YDR353W",301).
component("YPR167C",784).
component("YJR137C",531).
component("YNL052W",654).
component("YMR256C",646).
component("YLR395C",611).
component("YLR038C",574).
component("YIL111W",471).
component("YHR051W",439).
component("YGL191W",390).
component("YGL187C",389).
component("YDL067C",237).
component("Q0275",19).
component("Q0250",18).
component("YDR072C",274).
component("YPL266W",767).
component("YKR069W",563).
component("YOL096C",700).
component("U47_",113).
component("YER091C",350).
component("YJR073C",523).
component("YGR157W",408).
component("YDR120C",276).
component("YML008C",617).
component("YOR074C",712).
component("YDL033C",233).
component("YOL096C",701).
component("YLR172C",588).
component("YLR058C",577).
component("YDR019C",267).
component("YBR176W",196).
component("YDR408C",307).
component("YMR120C",637).
component("YLR028C",572).
component("YBL013W",164).
component("YJL130C",500).
component("YKL024C",537).
component("YPR074C",779).
component("YBR117C",188).
component("YMR108W",635).
component("YCL009C",213).
component("YNL071W",656).
component("YNR008W",678).
component("YIL160C",480).
component("YNR019W",681).
component("YCR048W",227).
component("U48_",114).
component("YDR232W",288).
component("YPL231W",762).
component("YER061C",339).
component("YDL052C",236).
component("U8_",148).
component("YPL231W",763).
component("YPL028W",745).
component("YLR299W",599).
component("YGL017W",375).
component("YCR005C",219).
component("YML126C",628).
component("YNL104C",659).
component("YDL182W",258).
component("YDL131W",245).
component("YDR307W",297).
component("YLR258W",596).
component("YFR015C",364).
component("YNL029C",651).
component("YIL085C",468).
component("YMR306W",648).
component("YLR342W",605).
component("YGR032W",398).
component("YLR209C",591).
component("U104_",21).
component("YDR354W",302) :- not remove_orf("YDR354W",302).
component("YFR047C",367).
component("YJR133W",530).
component("YLR209C",592).
component("YML022W",619).
component("YDR441C",310).
component("YHR128W",448).
component("YJL167W",506).
component("YJL167W",507).
component("YPR069C",776).
component("YDR127W",279).
component("YHR190W",456).
component("YLR146C",585).
component("YHR068W",441).
component("YLR303W",601).
component("YGR012W",396).
component("YML082W",625).
component("YJR130C",529).
component("YDR035W",268).
component("YBR249C",203).
component("YLR180W",590).
component("YDR502C",314).
component("YOR274W",729).
component("YBR256C",205).
component("YHR137W",449).
component("YGL202W",391).
component("YLR027C",571).
component("YKL106W",541).
component("YOL140W",706).
component("YLR438W",614).
component("YGR019W",397).
component("YLR089C",580).
component("U64_",126).
component("U61_",123).
component("U51_",116).
component("YJR148W",533).
component("YHR208W",459).
component("YFL030W",360).
component("YOR184W",721).
component("YNR058W",686).
component("YIL116W",473).
component("YGL253W",394).
component("YFR053C",368).
component("YMR013C",632).
component("YMR205C",642).
component("YGR240C",417).
component("YOL016C",690).
component("YFR014C",363).
component("YLR240W",594).
component("YKL203C",554).
component("YJR066W",522).
component("YCR036W",226).
component("YCL040W",216).
component("U15_",54).
component("YPL188W",756).
component("YJR049C",519).
component("YEL041W",323).
component("U96_",152).
component("YKL001C",536).
component("YDR236C",289).
component("YHL032C",428).
component("YDR531W",318).
component("U83_",143).
component("U82_",142).
component("U81_",141).
component("YMR208W",643).
component("YPL203W",757).
component("YOR061W",711).
component("YKL166C",547).
component("YJL164C",505).
component("YIL035C",463).
component("YHR205W",458).
component("YHR102W",447).
component("YGL019W",376).
component("YHR025W",434).
component("YOR347C",735).
component("YAL038W",157).
component("YNR012W",679).
component("YDR009W",266).
component("YDR127W",280).
component("YDR147W",283).
component("YDR300C",296).
component("YCR012W",220).
component("YER069W",341).
component("U19_",81).
component("U18_",73).
component("U17_",65).
component("U76_",136).
...
component("YKL067W",539).
component("YOL055C",693).
component("YDR454C",311).
component("YJR057W",520).
component("YOL061W",697).
component("YKL181W",548).
component("YHL011C",427).
component("YER099C",351).
component("YBL068W",171).
component("YOR143C",717).
component("YNL256W",669).
component("YLR328W",603).
component("YBR018C",175).
component("YGR202C",413).
component("YLR328W",604).
component("U80_",140).
component("U94_",151).
component("YJR010W",515).
component("YBR029C",178).
component("YCL050C",217).
component("YGL130W",385).
component("YDR530C",317).
component("YPR190C",787).
component("YPR187W",786).
component("YPR110C",781).
component("YPR010C",772).
component("YOR341W",734).
component("YOR340C",733).
component("YOR224C",727).
component("YOR210W",725).
component("YOR207C",723).
component("YOR151C",718).
component("YOR116C",714).
component("YOL005C",688).
component("YNR003C",677).
component("YNL248C",668).
component("YNL151C",663).
component("YNL113W",660).
component("YKL144C",543).
component("YJR063W",521).
component("YJL148W",504).
component("YJL140W",503).
component("YIL021W",462).
component("YHR143W-A",450).
component("YGL070C",383).
component("YFL036W",361).
component("YDR404C",306).
component("YDR156W",284).
component("YDR045C",270).
component("YDL150W",252).
component("YDL140C",247).
component("YBR154C",194).
component("YPR175W",785).
component("YPL167C",753).
component("YOR330C",731).
component("YOL115W",704).
component("YNL299W",675).
component("YNL262W",671).
component("YNL102W",658).
component("YJR043C",518).
component("YJR006W",513).
component("YJL090C",495).
component("YIL139C",476).
component("YEL055C",326).
component("YDR419W",308).
component("YDR121W",277).
component("YDL102W",244).
component("YCR014C",221).
component("YBR278W",208).
component("YBL035C",167).
component("YPR113W",782).
component("YBR243C",201).
component("YPL148C",751).
component("YER026C",333).
component("YGR286C",424).
component("YHR189W",455).
component("YDR058C",273).
component("YDL086W",242).
component("YOL011W",689).
component("YMR008C",630).
component("YMR006C",629).
component("U105_",22).
component("YBL015W",165).
component("YJL068C",493).
component("YOR040W",710).
component("U77_",137).
component("YDR481C",312).
component("YLR377C",609).
component("YPL179W",755).
component("YNR032W",682).
component("YML057W",623).
component("YML016C",618).
component("YLR433C",613).
component("YGR123C",406).
component("YER133W",352).
component("YER089C",348).
component("YDR436W",309).
component("YDR075W",275).
component("YDL188C",259).
component("YDL134C",246).
component("YDL047W",235).
component("YDL006W",229).
component("YBR125C",190).
component("YBL056W",170).
component("YPR073C",777).
component("YHR215W",460).
component("YDL024C",232).
component("YBR093C",185).
component("YBR092C",184).
component("YAR071W",161).
component("YHR046C",438).
component("U9_",155).
component("YPL228W",760).
component("YMR180C",641).
component("YDL236W",263).
component("YPR073C",778).
component("YOR208W",724).
component("YNL053W",655).
component("YMR036C",633).
component("YIR026C",486).
component("YIL113W",472).
component("YFR028C",365).
component("YER075C",344).
component("YDL230W",262).
...
component("U25_",95).
component("U24_",94).
component("YHR044C",437).
component("YHR043C",436).
component("YOL064C",698).
component("YOR360C",737).
component("YKR031C",560).
component("YPL206C",758).
component("YGL027C",378).
component("YLR286C",598).
component("YJR153W",534).
component("YJL221C",512).
component("YJL216C",510).
component("YIL172C",484).
component("YGR292W",426).
component("YGR287C",425).
component("YBR299W",212).
component("YBR184W",197).
component("YIL162W",481).
component("YIR019C",485).
component("YIL099W",470).
component("YDL037C",234).
component("YOR190W",722).
component("YLR300W",600).
component("YGR282C",423).
component("YDR261C",292).
component("YDR400W",304).
component("YML035C",620).
component("YJL070C",494).
component("YBR284W",209).
component("U106_",23).
component("YER043C",334).
component("YNL045W",653).
component("YGL037C",379).
component("YDR242W",290).
component("U53_",118).
component("YPR062W",775).
component("YMR120C",638).
component("YLR028C",573).
component("YHR144C",451).
component("YGR267C",422).
component("YBL033C",166).
component("YNL141W",661).
component("YLR245C",595).
component("YML035C",621).
component("YBR084W",182).
component("YJL126W",498).
component("U44_",110).
component("YDL100C",243).
component("U87_",145).
component("U40_",108).
component("U39_",106).
component("YBR011C",174).
component("YHR201C",457).
component("YBR111C",186).
component("YBR252W",204).
component("YER005W",331).
component("YBL099W",172).
component("YLR231C",593).
component("U88_",146).
component("YDR538W",320).
component("YLR134W",582).
component("YLR044C",575).
component("YGR087C",403).
component("YDR380W",303).
component("YDL080C",239).
component("U98_",153).
component("YMR250W",645).
component("YOR128C",715).
component("YEL021W",322).
component("YNR043W",684).
component("U93_",150).
component("U54_",119).
component("YKL211C",555) :- not remove_orf("YKL211C",555).
component("YKR097W",566).
component("YNL169C",664).
component("YNL256W",670).
component("YDR294C",294).
component("YEL046C",324).
component("YNR033W",683).
component("YKL211C",556) :- not remove_orf("YKL211C",556).
component("YER090W",556) :- not remove_orf("YER090W",556).
component("YER090W",349) :- not remove_orf("YER090W",349).
component("YDR127W",281).
component("YPL281C",770).
component("YOR393W",743).
component("YMR323W",649).
component("YHR174W",452).
component("YGR254W",419).
component("YPL262W",765).
component("YGL026C",377) :- not remove_orf("YGL026C",377).
component("YGR155W",407).
component("YLR304C",602).
component("YJL200C",508).
component("YNL316C",676).
component("YKL182W",550).
component("YPL212C",759).
component("YNL292W",674).
component("YGL063W",382).
component("YFL001W",356).
component("YPR002W",771).
component("YJR016C",516).
component("YCR053W",228).
component("YDR127W",282).
component("YGL148W",386).
component("YIL168W",483).
component("YIL167W",482).
component("YCL064C",218).
component("YER086W",346).
component("YLR359W",608).
component("YAL012W",156).
component("YML004C",616).
component("YFR055W",369).
component("YJL005W",489).
component("YJL121C",497).
component("YBR019C",176).
component("YDR050C",272).
component("YDR007W",265) :- not remove_orf("YDR007W",265).
component("YOR095C",713).
component("YER003C",330).
component("YBR196C",198).
component("YGL001C",371).
component("YPL117C",749).
component("U14_",46).
component("YOL056W",694).
component("YKL152C",546).
component("YDL021W",230).
component("YEL058W",327).
component("YPR060C",774).
component("YHR072W",442).
component("YPL097W",747).
component("YGR185C",411).
component("YGR264C",421).
component("YGR171C",409).
component("YPL104W",748).
component("YLL018C",567).
component("YPR081C",780).
component("YBR121C",189).
component("YHR020W",433).
component("YER087W",347).
component("YNL247W",667).
component("YOR168W",719).
component("YOL097C",702).
component("YDR268W",293).
component("YPR047W",773).
component("YLR060W",578).
component("YFL022C",359).
component("YCR024C",222).
component("YHR019C",432).
component("YKL194C",553).
component("YIL078W",467).
component("YPL160W",752).
component("YLR382C",610).
component("YNL073W",657).
component("YOR335C",732).
component("YLR153C",586).
component("YAL054C",158).
component("YGR244C",418).
component("YIL145C",477).
component("U89_",147).
component("YJL101C",496).
component("YOL049W",692).
component("YAR015W",160).
component("YER183C",355).
component("U90_",149).
component("YNR057C",685).
component("YDL141W",248).
component("YDL141W",249).
component("YGL234W",393).
component("YDL141W",250).
component("YJR103W",526).
component("YBL039C",168).
component("YGR204W",415).
component("YBR084W",183).
component("YNL220W",665).
component("YOL058W",695).
component("YDL141W",251).
component("YHR074W",443).
component("YMR217W",644).
component("YJR109C",528).
component("YJL130C",501).
component("YGL062W",381).
component("YBR218C",199).
component("YPL231W",764).
component("YNR016C",680).
component("YKL182W",551).
component("YGR037C",399).
component("YPR138C",783).
component("YPL265W",766).
component("YPL134C",750).
component("YPL036W",746).
component("YOR348C",736).
component("YOR222W",726).
component("YOR171C",720).
component("YOR130C",716).
component("YOR011W",709).
component("YOL156W",708).
component("YOL103W",703).
component("YOL020W",691) :- not remove_orf("YOL020W",691).
component("YNR072W",687).
component("YNL270C",672).
component("YNL142W",662).
component("YMR011W",631).
component("YLR348C",606).
component("YLR260W",597).
component("YLR138W",583).
component("YLR100C",581).
component("YLR081W",579).
component("YLL061W",570).
component("YKR093W",565).
component("YKR053C",562).
component("YKR039W",561) :- not remove_orf("YKR039W",561).
component("YJR158W",535).
component("YJR077C",524).
component("YJL219W",511).
component("YJL214W",509).
component("YJL134W",502).
component("YJL129C",499).
component("YIL134W",475).
component("YHR096C",446).
component("YHR094C",445).
component("YHR092C",444).
component("YHL036W",429).
component("YGR121C",405).
component("YGR065C",402).
component("YGR055W",400).
component("YGL186C",388).
component("YGL077C",384).
component("YGL008C",372).
component("YFL055W",362).
component("YFL011W",357).
component("YER060W-A",338).
component("YER060W",337).
component("YER056C",336).
component("YER053C",335).
component("YEL069C",329).
component("YEL063C",328).
component("YEL017C-A",321).
component("YDR536W",319).
component("YDR508C",316).
component("YDR503C",315).
component("YDR497C",313).
component("YDR345C",300).
component("YDR343C",299).
component("YDR342C",298).
component("YDR297W",295).
component("YDR046C",271) :- not remove_orf("YDR046C",271).
component("YDL245C",264).
component("YDL210W",260).
component("YCR032W",225).
component("YCR028C",224).
component("YCR024C-A",223).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,302) :- not remove_reaction(3620,302).
catalyst(2110,367).
catalyst(2190,367).
catalyst(5550,530).
catalyst(5791,592).
...
catalyst(2300,150).
catalyst(3460,119).
catalyst(3600,555) :- not remove_reaction(3600,555).
catalyst(8000,566).
catalyst(6890,664).
catalyst(2570,670).
catalyst(8781,294).
...
catalyst(4560,324).
catalyst(2550,683).
catalyst(1890,556) :- not remove_reaction(1890,556).
catalyst(3630,556) :- not remove_reaction(3630,556).
catalyst(1890,349) :- not remove_reaction(1890,349).
catalyst(3630,349) :- not remove_reaction(3630,349).
catalyst(3740,281).
catalyst(8231,770).
catalyst(8232,770).
catalyst(8231,743).
...
catalyst(8281,272).
catalyst(8282,272).
catalyst(3610,265) :- not remove_reaction(3610,265).
catalyst(7921,713).
catalyst(7922,713).
catalyst(7841,330).
catalyst(7842,330).
...
catalyst(1210,708).
catalyst(1160,703).
catalyst(801,691) :- not remove_reaction(801,691).
catalyst(802,691) :- not remove_reaction(802,691).
catalyst(811,691) :- not remove_reaction(811,691).
catalyst(812,691) :- not remove_reaction(812,691).
catalyst(831,691) :- not remove_reaction(831,691).
catalyst(832,691) :- not remove_reaction(832,691).
catalyst(901,691) :- not remove_reaction(901,691).
catalyst(902,691) :- not remove_reaction(902,691).
catalyst(1180,687).
catalyst(1210,687).
catalyst(931,672).
catalyst(932,672).
...
catalyst(640,565).
catalyst(6560,562).
catalyst(771,561) :- not remove_reaction(771,561).
catalyst(772,561) :- not remove_reaction(772,561).
catalyst(781,561) :- not remove_reaction(781,561).
catalyst(782,561) :- not remove_reaction(782,561).
catalyst(801,561) :- not remove_reaction(801,561).
catalyst(802,561) :- not remove_reaction(802,561).
catalyst(811,561) :- not remove_reaction(811,561).
catalyst(812,561) :- not remove_reaction(812,561).
catalyst(831,561) :- not remove_reaction(831,561).
catalyst(832,561) :- not remove_reaction(832,561).
catalyst(841,561) :- not remove_reaction(841,561).
catalyst(842,561) :- not remove_reaction(842,561).
catalyst(851,561) :- not remove_reaction(851,561).
catalyst(852,561) :- not remove_reaction(852,561).
catalyst(881,561) :- not remove_reaction(881,561).
catalyst(882,561) :- not remove_reaction(882,561).
catalyst(901,561) :- not remove_reaction(901,561).
catalyst(902,561) :- not remove_reaction(902,561).
catalyst(921,561) :- not remove_reaction(921,561).
catalyst(922,561) :- not remove_reaction(922,561).
catalyst(931,561) :- not remove_reaction(931,561).
catalyst(932,561) :- not remove_reaction(932,561).
catalyst(1191,561) :- not remove_reaction(1191,561).
catalyst(1192,561) :- not remove_reaction(1192,561).
catalyst(1180,535).
catalyst(1210,535).
catalyst(1581,524).
catalyst(1582,524).
...
catalyst(851,271) :- not remove_reaction(851,271).
catalyst(852,271) :- not remove_reaction(852,271).
...
catalyst(851,181) :- not remove_reaction(851,181).
catalyst(852,181) :- not remove_reaction(852,181).
...
catalyst(851,180) :- not remove_reaction(851,180).
catalyst(852,180) :- not remove_reaction(852,180).
...
modifiable_enzyme(555).
modifiable_enzyme(556).
