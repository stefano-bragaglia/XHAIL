...
component("YNL280C",685).
component("YLR056W",588).
component("YGR060W",406).
component("YGL012W",378).
component("YKR009C",570).
component("YOL086C",711).
component("YMR303C",659).
component("YMR083W",646).
component("YGL256W",400).
component("YDL168W",256).
component("YBR145W",193).
component("YPL231W",775).
component("YBR265W",209).
component("U46_",114).
component("YBR149W",194).
component("YBR149W",195).
component("YGL001C",375).
component("YIL094C",477).
component("U45_",113).
component("YML056C",634).
component("YLR432W",624).
component("YHR216W",469).
component("YAR075W",165).
component("YAR073W",164).
component("YDR127W",281).
component("YJR139C",541).
component("YML075C",636).
component("YLR450W",627).
component("YOL126C",717).
component("YKL085W",551).
component("YDL078C",241).
component("YNL037C",664).
component("YNL009W",662).
component("YLR174W",601).
component("YHR183W",462).
component("YGR256W",427).
component("YNL241C",678).
component("YOL059W",708).
component("YDL022W",234).
component("YCL018W",217).
component("YLR355C",619).
component("YIL074C",474).
component("YER081W",350).
component("YDL174C",260).
component("YML086C",638).
component("YIL155C",486).
component("YGR088W",410).
component("YDR256C",295).
component("YKL026C",547).
component("YIR037W",496).
component("YBR244W",204).
component("YJR078W",534).
component("U58_",123).
component("YJR025C",526).
component("U107_",24).
component("YHR007C",438).
component("YDR402C",309).
component("YGL055W",385).
component("YJR104C",536).
component("YHR008C",439).
component("YOR384W",754).
component("YOR381W",753).
component("YOL152W",719).
component("YLL051C",581).
component("YJL026W",498).
component("YIL066C",473).
component("YGR180C",417).
component("YER070W",347).
component("U37_",107).
component("U36_",106).
component("U35_",105).
component("YDL168W",257).
component("YDR158W",289).
component("YJR009C",523).
component("YJL052W",500).
component("YGR192C",419).
component("YBR006W",175).
component("YPL276W",783).
component("YPL275W",782).
component("YOR388C",755).
component("YPL061W",760).
component("YOR374W",751).
component("YER073W",348).
component("YGL154C",392).
component("YBR115C",189).
component("U55_",122).
component("YER069W",345).
component("YOR323C",743).
component("YER178W",359).
component("YBR221C",202).
component("YIL125W",482).
component("U52_",119).
component("YBR166C",197).
component("YGL012W",379).
component("YKL182W",560).
component("YKL216W",569).
component("YDR044W",272).
component("YKR009C",571).
component("YIL160C",487).
component("YGL205W",397).
component("YMR118C",648).
component("YLR164W",599).
component("YLL041C",580).
component("YKL148C",555).
component("YKL141W",553).
component("YJL045W",499).
component("YDR178W",290).
component("YEL047C",329).
component("YDL171C",258).
component("YDL171C",259).
component("YOR375C",752).
component("YDL215C",264).
component("YAL062W",161).
component("U99_",156).
component("U100_",20).
component("YBR035C",181).
component("YKR080W",576).
component("YER023W",336).
component("YOR236W",741).
component("YGR204W",421).
component("YIR034C",495).
component("YLR142W",596).
component("U65_",129).
component("U63_",127).
component("U62_",126).
component("YHR068W",448).
component("YKL150W",556).
component("YIL043C",472).
component("YHR042W",443).
component("YOR221C",738).
component("YMR145C",651).
component("YKL192C",563).
component("YKL055C",549).
component("YER061C",343).
component("YDL085W",243).
component("YPL171C",768).
component("YHR179W",461).
component("YMR145C",652).
component("YML120C",639).
component("YKL192C",564).
component("YDL085W",244).
component("YGR234W",423).
component("YFR030W",371).
component("YPL017C",757).
component("YFL018C",363).
component("YDR353W",305).
component("YPR167C",798).
component("YJR137C",540).
component("YNL052W",666).
component("YMR256C",658).
component("YLR395C",623).
component("YLR038C",586).
component("YIL111W",479).
component("YHR051W",447).
component("YGL191W",395).
component("YGL187C",394).
component("YDL067C",240).
component("Q0275",19).
component("Q0250",18).
component("YDR072C",277).
component("YPL266W",781).
component("YKR069W",575).
component("YOL096C",712).
component("U47_",115).
component("YER091C",355).
component("YJR073C",532).
component("YGR157W",415).
component("YDR120C",279).
component("YML008C",629).
component("YOR074C",724).
component("YDL033C",236).
component("YOL096C",713).
component("YLR172C",600).
component("YLR058C",589).
component("YDR019C",270).
component("YBR176W",198).
component("YDR408C",311).
component("YMR120C",649).
component("YLR028C",584).
component("YBL013W",166).
component("YJL130C",508).
component("YKL024C",546).
component("YPR074C",793).
component("YBR117C",190).
component("YMR108W",647).
component("YCL009C",216).
component("YNL071W",668).
component("YNR008W",690).
component("YIL160C",488).
component("YNR019W",693).
component("YCR048W",230).
component("U48_",116).
component("YDR232W",292).
component("YPL231W",776).
component("YER061C",344).
component("YDL052C",239).
component("U8_",150).
component("YDR148C",287).
component("YPL231W",777).
component("YPL028W",758).
component("YLR299W",611).
component("YGL017W",380).
component("YCR005C",222).
component("YML126C",640).
component("YNL104C",671).
component("YDL182W",261).
component("YDL131W",248).
component("YDR307W",301).
component("YLR258W",608).
component("YFR015C",369).
component("YNL029C",663).
component("YIL085C",476).
component("YMR306W",660).
component("YLR342W",617).
component("YGR032W",403).
component("YBR248C",205).
component("YLR209C",603).
component("U104_",21).
component("YDR354W",306) :- not remove_orf("YDR354W",306).
component("YFR047C",372).
component("YJR133W",539).
component("YLR209C",604).
component("YML022W",631).
component("YDR441C",314).
component("YHR128W",456).
component("YJL167W",515).
component("YJL167W",516).
component("YPR069C",790).
component("YDR127W",282).
component("YHR190W",464).
component("YLR146C",597).
component("YHR068W",449).
component("YLR303W",613).
component("YGR012W",401).
component("YML082W",637).
component("YJR130C",538).
component("YDR035W",271).
component("YBR249C",206).
component("YLR180W",602).
component("YDR502C",318).
component("YOR274W",742).
component("YBR256C",208).
component("YHR137W",457).
component("YGL202W",396).
component("YLR027C",583).
component("YKL106W",552).
component("YOL140W",718).
component("YLR438W",626).
component("YGR019W",402).
component("YLR089C",592).
component("U64_",128).
component("U61_",125).
component("U51_",118).
component("YJR148W",542).
component("YHR208W",467).
component("YFL030W",365).
component("YOR184W",733).
component("YNR058W",698).
component("YIL116W",481).
component("YGL253W",399).
component("YFR053C",373).
component("YMR013C",644).
component("YMR205C",654).
component("YGR240C",424).
component("YOL016C",702).
component("YFR014C",368).
component("YLR240W",606).
component("YKL203C",566).
component("YJR066W",531).
component("YCR036W",229).
component("YCL040W",219).
component("U15_",54).
component("YPL188W",770).
component("YJR049C",528).
component("YEL041W",327).
component("U96_",154).
component("YKL001C",545).
component("YDR236C",293).
component("YHL032C",436).
component("YDR531W",322).
component("U83_",145).
component("U82_",144).
component("U81_",143).
component("YMR208W",655).
component("YPL203W",771).
component("YOR061W",723).
component("YKL166C",558).
component("YJL164C",514).
component("YIL035C",471).
component("YHR205W",466).
component("YHR102W",455).
component("YGL019W",381).
component("YHR025W",442).
component("YOR347C",748).
component("YAL038W",159).
component("YNR012W",691).
component("YDR009W",269).
component("YDR127W",283).
component("YDR147W",286).
component("YDR300C",300).
component("YCR012W",223).
component("YER069W",346).
component("U19_",82).
component("U18_",74).
component("U17_",66).
component("U76_",138).
component("YER170W",358).
component("YDR226W",291).
component("YKL067W",550).
component("YOL055C",705).
component("YDR454C",315).
component("YJR057W",529).
component("YOL061W",709).
component("YKL181W",559).
component("YHL011C",434).
component("YER099C",356).
component("YBL068W",173).
component("YOR143C",729).
component("YNL256W",681).
component("YLR328W",615).
component("YBR018C",177).
component("YGR202C",420).
component("YLR328W",616).
component("U80_",142).
component("U94_",153).
component("YJR010W",524).
component("YBR029C",180).
component("YCL050C",220).
component("YGL130W",390).
component("YDR530C",321).
component("YPR190C",801).
component("YPR187W",800).
component("YPR110C",795).
component("YPR010C",786).
component("YOR341W",747).
component("YOR340C",746).
component("YOR224C",740).
component("YOR210W",737).
component("YOR207C",735).
component("YOR151C",730).
component("YOR116C",726).
component("YOL005C",700).
component("YNR003C",689).
component("YNL248C",680).
component("YNL151C",675).
component("YNL113W",672).
component("YKL144C",554).
component("YJR063W",530).
component("YJL148W",512).
component("YJL140W",511).
component("YIL021W",470).
component("YHR143W-A",458).
component("YGL070C",388).
component("YFL036W",366).
component("YDR404C",310).
component("YDR156W",288).
component("YDR045C",273).
component("YDL150W",255).
component("YDL140C",250).
component("YBR154C",196).
component("YPR175W",799).
component("YPL167C",767).
component("YOR330C",744).
component("YOL115W",716).
component("YNL299W",687).
component("YNL262W",683).
component("YNL102W",670).
component("YJR043C",527).
component("YJR006W",522).
component("YJL090C",503).
component("YIL139C",484).
component("YEL055C",330).
component("YDR419W",312).
component("YDR121W",280).
component("YDL102W",247).
component("YCR014C",224).
component("YBR278W",211).
component("YBL035C",169).
component("YKL035W",548).
component("YHL012W",435).
component("YPR113W",796).
component("YBR243C",203).
component("YPL148C",765).
component("YER026C",337).
component("YGR286C",431).
component("YHR189W",463).
component("YDR058C",276).
component("YDL086W",245).
component("YOL011W",701).
component("YMR008C",642).
component("YMR006C",641).
component("U105_",22).
component("YBL015W",167).
component("YJL068C",501).
component("YOR040W",722).
component("U77_",139).
component("YDR481C",316).
component("YLR377C",621).
component("YPL179W",769).
component("YNR032W",694).
component("YML057W",635).
component("YML016C",630).
component("YLR433C",625).
component("YGR123C",413).
component("YER133W",357).
component("YER089C",353).
component("YDR436W",313).
component("YDR075W",278).
component("YDL188C",262).
component("YDL134C",249).
component("YDL047W",238).
component("YDL006W",232).
component("YBR125C",192).
component("YBL056W",172).
component("YPR073C",791).
component("YHR215W",468).
component("YDL024C",235).
component("YBR093C",187).
component("YBR092C",186).
component("YAR071W",163).
component("YHR046C",446).
component("U9_",157).
component("YPL228W",774).
component("YMR180C",653).
component("YDL236W",266).
component("YJL155C",513).
component("YPR073C",792).
component("YOR208W",736).
component("YNL053W",667).
component("YMR036C",645).
component("YIR026C",494).
component("YIL113W",480).
component("YFR028C",370).
component("YER075C",349).
component("YDL230W",265).
...
component("U25_",96).
component("U24_",95).
component("YHR044C",445).
component("YHR043C",444).
component("YOL064C",710).
component("YOR360C",750).
component("YKR031C",572).
component("YPL206C",772).
component("YGL027C",383).
component("YLR286C",610).
component("YJR153W",543).
component("YJL221C",521).
component("YJL216C",519).
component("YIL172C",492).
component("YGR292W",433).
component("YGR287C",432).
component("YBR299W",215).
component("YBR184W",199).
component("YIL162W",489).
component("YIR019C",493).
component("YIL099W",478).
component("YDL037C",237).
component("YOR190W",734).
component("YLR300W",612).
component("YGR282C",430).
component("YDR261C",296).
component("YDR400W",308).
component("YML035C",632).
component("YJL070C",502).
component("YBR284W",212).
component("U106_",23).
component("YER043C",338).
component("YNL045W",665).
component("YGL037C",384).
component("YDR242W",294).
component("U53_",120).
component("YPR062W",789).
component("YMR120C",650).
component("YLR028C",585).
component("YHR144C",459).
component("YGR267C",429).
component("YBL033C",168).
component("YNL141W",673).
component("YLR245C",607).
component("YML035C",633).
component("YBR084W",184).
component("YJL126W",506).
component("U44_",112).
component("YDL100C",246).
component("U87_",147).
component("U40_",110).
component("U39_",108).
component("YBR011C",176).
component("YHR201C",465).
component("YBR111C",188).
component("YBR252W",207).
component("YER005W",335).
component("YBL099W",174).
component("YLR231C",605).
component("U88_",148).
component("YDR538W",324).
component("YLR134W",594).
component("YLR044C",587).
component("YGR087C",409).
component("YDR380W",307).
component("YDL080C",242).
component("U98_",155).
component("YMR250W",657).
component("YOR128C",727).
component("YEL021W",326).
component("YNR043W",696).
component("U93_",152).
component("U54_",121).
component("YKL211C",567) :- not remove_orf("YKL211C",567).
component("YKR097W",578).
component("YNL169C",676).
component("YNL256W",682).
component("YDR294C",298).
component("YEL046C",328).
component("YNR033W",695).
component("YKL211C",568) :- not remove_orf("YKL211C",568).
component("YER090W",568) :- not remove_orf("YER090W",568).
component("YER090W",354) :- not remove_orf("YER090W",354).
component("YDR127W",284).
component("YPL281C",784).
component("YOR393W",756).
component("YMR323W",661).
component("YHR174W",460).
component("YGR254W",426).
component("YPL262W",779).
component("YGL026C",382) :- not remove_orf("YGL026C",382).
component("YGR155W",414).
component("YLR304C",614).
component("YJL200C",517).
component("YNL316C",688).
component("YKL182W",561).
component("YPL212C",773).
component("YNL292W",686).
component("YGL063W",387).
component("YFL001W",361).
component("YPR002W",785).
component("YJR016C",525).
component("YCR053W",231).
component("YDR127W",285).
component("YGL148W",391).
component("YIL168W",491).
component("YIL167W",490).
component("YCL064C",221).
component("YER086W",351).
component("YLR359W",620).
component("YAL012W",158).
component("YML004C",628).
component("YFR055W",374).
component("YJL005W",497).
component("YJL121C",505).
component("YBR019C",178).
component("YDR050C",275).
component("YDR007W",268) :- not remove_orf("YDR007W",268).
component("YOR095C",725).
component("YER003C",334).
component("YBR196C",200).
component("YGL001C",376).
component("YPL117C",763).
component("U14_",46).
component("YOL056W",706).
component("YKL152C",557).
component("YDL021W",233).
component("YEL058W",331).
component("YPR060C",788).
component("YHR072W",450).
component("YPL097W",761).
component("YGR185C",418).
component("YGR264C",428).
component("YGR171C",416).
component("YPL104W",762).
component("YLL018C",579).
component("YPR081C",794).
component("YBR121C",191).
component("YHR020W",441).
component("YER087W",352).
component("YNL247W",679).
component("YOR168W",731).
component("YOL097C",714).
component("YDR268W",297).
component("YPR047W",787).
component("YLR060W",590).
component("YFL022C",364).
component("YCR024C",225).
component("YHR019C",440).
component("YKL194C",565).
component("YIL078W",475).
component("YPL160W",766).
component("YLR382C",622).
component("YNL073W",669).
component("YOR335C",745).
component("YGR094W",411).
component("YLR153C",598).
component("YAL054C",160).
component("YGR244C",425).
component("YIL145C",485).
component("U89_",149).
component("YJL101C",504).
component("YOL049W",704).
component("YAR015W",162).
component("YER183C",360).
component("U90_",151).
component("YNR057C",697).
component("YDL141W",251).
component("YDL141W",252).
component("YGL234W",398).
component("YDL141W",253).
component("YJR103W",535).
component("YBL039C",170).
component("YGR204W",422).
component("YBR084W",185).
component("YNL220W",677).
component("YOL058W",707).
component("YDL141W",254).
component("YHR074W",451).
component("YMR217W",656).
component("YGR061C",407).
component("YJR109C",537).
component("YJL130C",509).
component("YGL062W",386).
component("YBR218C",201).
component("YPL231W",778).
component("YNR016C",692).
component("YKL182W",562).
component("YGR037C",404).
component("YPR138C",797).
component("YPL265W",780).
component("YPL134C",764).
component("YPL036W",759).
component("YOR348C",749).
component("YOR222W",739).
component("YOR171C",732).
component("YOR130C",728).
component("YOR011W",721).
component("YOL156W",720).
component("YOL103W",715).
component("YOL020W",703) :- not remove_orf("YOL020W",703).
component("YNR072W",699).
component("YNL270C",684).
component("YNL142W",674).
component("YMR011W",643).
component("YLR348C",618).
component("YLR260W",609).
component("YLR138W",595).
component("YLR100C",593).
component("YLR081W",591).
component("YLL061W",582).
component("YKR093W",577).
component("YKR053C",574).
component("YKR039W",573) :- not remove_orf("YKR039W",573).
component("YJR158W",544).
component("YJR077C",533).
component("YJL219W",520).
component("YJL214W",518).
component("YJL134W",510).
component("YJL129C",507).
component("YIL134W",483).
component("YHR096C",454).
component("YHR094C",453).
component("YHR092C",452).
component("YHL036W",437).
component("YGR121C",412).
component("YGR065C",408).
component("YGR055W",405).
component("YGL186C",393).
component("YGL077C",389).
component("YGL008C",377).
component("YFL055W",367).
component("YFL011W",362).
component("YER060W-A",342).
component("YER060W",341).
component("YER056C",340).
component("YER053C",339).
component("YEL069C",333).
component("YEL063C",332).
component("YEL017C-A",325).
component("YDR536W",323).
component("YDR508C",320).
component("YDR503C",319).
component("YDR497C",317).
component("YDR345C",304).
component("YDR343C",303).
component("YDR342C",302).
component("YDR297W",299).
component("YDR046C",274) :- not remove_orf("YDR046C",274).
component("YDL245C",267).
component("YDL210W",263).
component("YCR032W",228).
component("YCR028C",227).
component("YCR024C-A",226).
component("YCL025C",218).
component("YBR298C",214).
component("YBR291C",213).
component("YBR069C",183) :- not remove_orf("YBR069C",183).
component("YBR068C",182) :- not remove_orf("YBR068C",182).
component("YBR021W",179).
component("YBL042C",171).
component("U85_",146).
component("U7_",141).
component("U78_",140).
component("U75_",137).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,306) :- not remove_reaction(3620,306).
catalyst(2110,372).
catalyst(2190,372).
catalyst(5550,539).
catalyst(5791,604).
...
catalyst(2300,152).
catalyst(3460,121).
catalyst(3600,567) :- not remove_reaction(3600,567).
catalyst(8000,578).
catalyst(6890,676).
catalyst(2570,682).
catalyst(8781,298).
...
catalyst(4560,328).
catalyst(2550,695).
catalyst(1890,568) :- not remove_reaction(1890,568).
catalyst(3630,568) :- not remove_reaction(3630,568).
catalyst(1890,354) :- not remove_reaction(1890,354).
catalyst(3630,354) :- not remove_reaction(3630,354).
catalyst(3740,284).
catalyst(8231,784).
catalyst(8232,784).
catalyst(8231,756).
...
catalyst(8061,779).
catalyst(8062,779).
catalyst(3590,382) :- not remove_reaction(3590,382).
catalyst(10910,382) :- not remove_reaction(10910,382).
catalyst(4570,414).
catalyst(8181,614).
catalyst(8182,614).
catalyst(8181,517).
...
catalyst(8281,275).
catalyst(8282,275).
catalyst(3610,268) :- not remove_reaction(3610,268).
catalyst(7921,725).
catalyst(7922,725).
catalyst(7841,334).
catalyst(7842,334).
...
catalyst(1210,720).
catalyst(1160,715).
catalyst(801,703) :- not remove_reaction(801,703).
catalyst(802,703) :- not remove_reaction(802,703).
catalyst(811,703) :- not remove_reaction(811,703).
catalyst(812,703) :- not remove_reaction(812,703).
catalyst(831,703) :- not remove_reaction(831,703).
catalyst(832,703) :- not remove_reaction(832,703).
catalyst(901,703) :- not remove_reaction(901,703).
catalyst(902,703) :- not remove_reaction(902,703).
catalyst(1180,699).
catalyst(1210,699).
catalyst(931,684).
catalyst(932,684).
...
catalyst(640,577).
catalyst(6560,574).
catalyst(771,573) :- not remove_reaction(771,573).
catalyst(772,573) :- not remove_reaction(772,573).
catalyst(781,573) :- not remove_reaction(781,573).
catalyst(782,573) :- not remove_reaction(782,573).
catalyst(801,573) :- not remove_reaction(801,573).
catalyst(802,573) :- not remove_reaction(802,573).
catalyst(811,573) :- not remove_reaction(811,573).
catalyst(812,573) :- not remove_reaction(812,573).
catalyst(831,573) :- not remove_reaction(831,573).
catalyst(832,573) :- not remove_reaction(832,573).
catalyst(841,573) :- not remove_reaction(841,573).
catalyst(842,573) :- not remove_reaction(842,573).
catalyst(851,573) :- not remove_reaction(851,573).
catalyst(852,573) :- not remove_reaction(852,573).
catalyst(881,573) :- not remove_reaction(881,573).
catalyst(882,573) :- not remove_reaction(882,573).
catalyst(901,573) :- not remove_reaction(901,573).
catalyst(902,573) :- not remove_reaction(902,573).
catalyst(921,573) :- not remove_reaction(921,573).
catalyst(922,573) :- not remove_reaction(922,573).
catalyst(931,573) :- not remove_reaction(931,573).
catalyst(932,573) :- not remove_reaction(932,573).
catalyst(1191,573) :- not remove_reaction(1191,573).
catalyst(1192,573) :- not remove_reaction(1192,573).
catalyst(1180,544).
catalyst(1210,544).
catalyst(1581,533).
catalyst(1582,533).
...
catalyst(1210,302).
catalyst(6650,299).
catalyst(801,274) :- not remove_reaction(801,274).
catalyst(802,274) :- not remove_reaction(802,274).
catalyst(811,274) :- not remove_reaction(811,274).
catalyst(812,274) :- not remove_reaction(812,274).
catalyst(831,274) :- not remove_reaction(831,274).
catalyst(832,274) :- not remove_reaction(832,274).
catalyst(841,274) :- not remove_reaction(841,274).
catalyst(842,274) :- not remove_reaction(842,274).
catalyst(851,274) :- not remove_reaction(851,274).
catalyst(852,274) :- not remove_reaction(852,274).
catalyst(901,274) :- not remove_reaction(901,274).
catalyst(902,274) :- not remove_reaction(902,274).
catalyst(1180,267).
catalyst(1210,267).
catalyst(730,263).
catalyst(431,228).
...
catalyst(1511,213).
catalyst(1512,213).
catalyst(771,183) :- not remove_reaction(771,183).
catalyst(772,183) :- not remove_reaction(772,183).
...
catalyst(851,183) :- not remove_reaction(851,183).
catalyst(852,183) :- not remove_reaction(852,183).
catalyst(901,183) :- not remove_reaction(901,183).
catalyst(902,183) :- not remove_reaction(902,183).
catalyst(801,182) :- not remove_reaction(801,182).
catalyst(802,182) :- not remove_reaction(802,182).
catalyst(811,182) :- not remove_reaction(811,182).
catalyst(812,182) :- not remove_reaction(812,182).
catalyst(831,182) :- not remove_reaction(831,182).
catalyst(832,182) :- not remove_reaction(832,182).
catalyst(841,182) :- not remove_reaction(841,182).
catalyst(842,182) :- not remove_reaction(842,182).
catalyst(851,182) :- not remove_reaction(851,182).
catalyst(852,182) :- not remove_reaction(852,182).
catalyst(901,182) :- not remove_reaction(901,182).
catalyst(902,182) :- not remove_reaction(902,182).
catalyst(620,179).
catalyst(540,171).
catalyst(2660,146).
catalyst(6960,141).
