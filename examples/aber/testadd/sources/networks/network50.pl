...
component("YLR056W",297).
component("YKR009C",284).
component("YOL086C",360).
component("YMR303C",330).
component("YGL256W",207).
component("YDL168W",130).
component("YBR145W",98).
component("YPL231W",393).
component("U46_",62).
component("YBR149W",99).
component("YGL001C",189).
component("YIL094C",242).
component("U45_",61).
component("YDR127W",141).
component("YOL126C",364).
component("YKL085W",276).
component("YDL078C",124).
component("YNL037C",334).
component("YCL018W",111).
component("YLR355C",317).
component("YDL174C",132).
component("YML086C",322).
component("YGR088W",213).
component("YDR256C",151).
component("YJR078W",270).
component("YJR025C",264).
component("U107_",22).
component("YJL026W",252).
component("YGR180C",216).
component("YER070W",177).
component("U36_",57).
component("YDL168W",131).
component("YPL276W",399).
component("YPL275W",398).
component("YOR388C",384).
component("YOR323C",378).
component("YIL125W",245).
component("U52_",65).
component("YBR166C",101).
component("YKL216W",283).
component("YKR009C",285).
component("YIL160C",248).
component("YGL205W",204).
component("YKR080W",289).
component("YER023W",172).
component("YGR204W",218).
component("YLR142W",302).
component("U65_",68).
component("U62_",67).
component("YHR068W",231).
component("YKL150W",279).
component("YIL043C",240).
component("YPL171C",392).
component("YHR179W",238).
component("YGR234W",219).
component("YDR353W",155).
component("YNL052W",335).
component("YMR256C",329).
component("YLR395C",319).
component("YLR038C",295).
component("YIL111W",243).
component("YHR051W",230).
component("YGL191W",202).
component("YGL187C",201).
component("YDL067C",123).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",397).
component("YKR069W",288).
component("YJR073C",268).
component("YDL033C",122).
component("YLR172C",304).
component("YLR058C",298).
component("YDR019C",136).
component("YBR176W",102).
component("YDR408C",160).
component("YMR120C",327).
component("YLR028C",293).
component("YBL013W",82).
component("YJL130C",257).
component("YKL024C",274).
component("YPR074C",406).
component("YBR117C",97).
component("YCL009C",110).
component("YNL071W",337).
component("U48_",63).
component("YPL231W",394).
component("YPL231W",395).
component("YLR299W",311).
component("YGL017W",192).
component("YML126C",323).
component("YDL182W",133).
component("YDL131W",127).
component("YLR258W",309).
component("YFR015C",185).
component("YNL029C",333).
component("YIL085C",241).
component("YMR306W",331).
component("YLR342W",316).
component("YGR032W",209).
component("YLR209C",305).
component("U104_",20).
component("YDR354W",156) :- not remove_orf("YDR354W",156).
component("YFR047C",187).
component("YLR209C",306).
component("YML022W",320).
component("YDR441C",162).
component("YJL167W",261).
component("YDR127W",142).
component("YHR068W",232).
component("YLR303W",313).
component("YGR012W",208).
component("YJR130C",272).
component("YDR035W",137).
component("YBR249C",104).
component("YOR274W",377).
component("YHR137W",234).
component("YGL202W",203).
component("YLR027C",292).
component("YKL106W",277).
component("YOL140W",365).
component("YLR089C",299).
component("YJR148W",273).
component("YNR058W",353).
component("YGL253W",206).
component("YFR053C",188).
component("YOL016C",356).
component("YFR014C",184).
component("YCR036W",120).
component("YCL040W",113).
component("U96_",78).
component("YDR236C",149).
component("YHL032C",225).
component("YNR012W",351).
component("YDR127W",143).
component("YDR147W",146).
component("YCR012W",115).
component("U76_",75).
component("YER170W",181).
component("YDR226W",148).
component("YKL067W",275).
component("YOL055C",358).
component("YDR454C",163).
component("YJR057W",266).
component("YOL061W",359).
component("YKL181W",280).
component("YHL011C",224).
component("YER099C",180).
component("YBL068W",87).
component("YNL256W",345).
component("YBR018C",90).
component("YLR328W",315).
component("YBR029C",92).
component("YGL130W",198).
component("YPR190C",412).
component("YPR187W",411).
component("YPR110C",407).
component("YPR010C",402).
component("YOR341W",382).
component("YOR340C",381).
component("YOR224C",376).
component("YOR210W",375).
component("YOR207C",373).
component("YOR151C",370).
component("YOR116C",368).
component("YOL005C",354).
component("YNR003C",350).
component("YNL248C",344).
component("YNL151C",342).
component("YNL113W",339).
component("YKL144C",278).
component("YJR063W",267).
component("YJL148W",260).
component("YJL140W",259).
component("YIL021W",239).
component("YHR143W-A",235).
component("YGL070C",196).
component("YFL036W",182).
component("YDR404C",159).
component("YDR156W",147).
component("YDR045C",138).
component("YDL150W",129).
component("YDL140C",128).
component("YBR154C",100).
component("YPR175W",410).
component("YPL167C",391).
component("YOR330C",379).
component("YOL115W",363).
component("YNL299W",348).
component("YNL262W",346).
component("YNL102W",338).
component("YJR043C",265).
component("YJR006W",263).
component("YJL090C",254).
component("YIL139C",246).
component("YEL055C",169).
component("YDR419W",161).
component("YDR121W",140).
component("YDL102W",126).
component("YCR014C",116).
component("YBR278W",107).
component("YBL035C",85).
component("YPR113W",408).
component("YPL148C",390).
component("YGR286C",223).
component("YOL011W",355).
component("YMR008C",325).
component("YMR006C",324).
component("U105_",21).
component("YBL015W",83).
component("U77_",76).
component("YLR377C",318).
component("YPR073C",405).
component("YOR208W",374).
component("YNL053W",336).
component("YMR036C",326).
component("YIR026C",251).
component("YIL113W",244).
component("YFR028C",186).
component("YER075C",178).
component("YDL230W",134).
component("YBR276C",106).
component("U30_",56).
component("U29_",55).
component("U26_",54).
component("U24_",53).
component("YHR044C",229).
component("YHR043C",228).
component("YOR360C",383).
component("YGL027C",194).
component("YOR190W",372).
component("YLR300W",312).
component("YGR282C",222).
component("YDR261C",152).
component("YDR400W",158).
component("YML035C",321).
component("YJL070C",253).
component("YBR284W",108).
component("YDR242W",150).
component("U53_",66).
component("YPR062W",404).
component("YMR120C",328).
component("YLR028C",294).
component("YHR144C",236).
component("YBL033C",84).
component("YNL141W",340).
component("YLR245C",308).
component("YJL126W",255).
component("U39_",58).
component("YBR011C",89).
component("YBR111C",96).
component("YBR252W",105).
component("YER005W",171).
component("YBL099W",88).
component("YLR231C",307).
component("YLR134W",301).
component("YLR044C",296).
component("YGR087C",212).
component("YDR380W",157).
component("YDL080C",125).
component("U98_",79).
component("YOR128C",369).
component("YKL211C",281) :- not remove_orf("YKL211C",281).
component("YKR097W",290).
component("YNL169C",343).
component("YKL211C",282) :- not remove_orf("YKL211C",282).
component("YER090W",282) :- not remove_orf("YER090W",282).
component("YER090W",179) :- not remove_orf("YER090W",179).
component("YDR127W",144).
component("YPL281C",400).
component("YOR393W",385).
component("YMR323W",332).
component("YHR174W",237).
component("YGR254W",220).
component("YGL026C",193) :- not remove_orf("YGL026C",193).
component("YLR304C",314).
component("YJL200C",262).
component("YNL316C",349).
component("YPR002W",401).
component("YCR053W",121).
component("YDR127W",145).
component("YGL148W",199).
component("YIL168W",250).
component("YIL167W",249).
component("YCL064C",114).
component("YAL012W",80).
component("YBR019C",91).
component("YDR007W",135) :- not remove_orf("YDR007W",135).
component("YOR095C",367).
component("YGL001C",190).
component("YPL117C",389).
component("YPR060C",403).
component("YPL097W",387).
component("YGR185C",217).
component("YGR264C",221).
component("YGR171C",215).
component("YPL104W",388).
component("YLL018C",291).
component("YOL097C",361).
component("YDR268W",153).
component("YCR024C",117).
component("YHR019C",227).
component("YOR335C",380).
component("YLR153C",303).
component("YAL054C",81).
component("YIL145C",247).
component("U90_",77).
component("YNR057C",352).
component("YGL234W",205).
component("YJR103W",271).
component("YBL039C",86).
component("YBR084W",95).
component("YHR074W",233).
component("YGL062W",195).
component("YBR218C",103).
component("YPR138C",409).
component("YPL265W",396).
component("YPL036W",386).
component("YOR171C",371).
component("YOR011W",366).
component("YOL103W",362).
component("YOL020W",357) :- not remove_orf("YOL020W",357).
component("YNL270C",347).
component("YNL142W",341).
component("YLR260W",310).
component("YLR100C",300).
component("YKR053C",287).
component("YKR039W",286) :- not remove_orf("YKR039W",286).
component("YJR077C",269).
component("YJL134W",258).
component("YJL129C",256).
component("YHL036W",226).
component("YGR121C",214).
component("YGR065C",211).
component("YGR055W",210).
component("YGL186C",200).
component("YGL077C",197).
component("YGL008C",191).
component("YFL055W",183).
component("YER060W-A",176).
component("YER060W",175).
component("YER056C",174).
component("YER053C",173).
component("YEL063C",170).
component("YEL017C-A",168).
component("YDR536W",167).
component("YDR508C",166).
component("YDR503C",165).
component("YDR497C",164).
component("YDR297W",154).
component("YDR046C",139) :- not remove_orf("YDR046C",139).
component("YCR032W",119).
component("YCR024C-A",118).
component("YCL025C",112).
component("YBR298C",109).
...
catalyst(2121,20).
catalyst(2122,20).
catalyst(3620,156) :- not remove_reaction(3620,156).
catalyst(2190,187).
catalyst(5791,306).
catalyst(5792,306).
catalyst(5801,306).
...
catalyst(6111,369).
catalyst(6112,369).
catalyst(3600,281) :- not remove_reaction(3600,281).
catalyst(8000,290).
catalyst(6890,343).
catalyst(3630,282) :- not remove_reaction(3630,282).
catalyst(3630,179) :- not remove_reaction(3630,179).
catalyst(3740,144).
catalyst(8231,400).
catalyst(8232,400).
catalyst(8231,385).
...
catalyst(8231,220).
catalyst(8232,220).
catalyst(3590,193) :- not remove_reaction(3590,193).
catalyst(10910,193) :- not remove_reaction(10910,193).
catalyst(8181,314).
catalyst(8182,314).
catalyst(8181,262).
catalyst(8182,262).
...
catalyst(7751,91).
catalyst(7752,91).
catalyst(3610,135) :- not remove_reaction(3610,135).
catalyst(7921,367).
catalyst(7922,367).
catalyst(6370,190).
catalyst(6461,389).
...
catalyst(6330,300).
catalyst(6560,287).
catalyst(771,286) :- not remove_reaction(771,286).
catalyst(772,286) :- not remove_reaction(772,286).
catalyst(781,286) :- not remove_reaction(781,286).
catalyst(782,286) :- not remove_reaction(782,286).
catalyst(801,286) :- not remove_reaction(801,286).
catalyst(802,286) :- not remove_reaction(802,286).
catalyst(811,286) :- not remove_reaction(811,286).
catalyst(812,286) :- not remove_reaction(812,286).
catalyst(831,286) :- not remove_reaction(831,286).
catalyst(832,286) :- not remove_reaction(832,286).
catalyst(841,286) :- not remove_reaction(841,286).
catalyst(842,286) :- not remove_reaction(842,286).
catalyst(851,286) :- not remove_reaction(851,286).
catalyst(852,286) :- not remove_reaction(852,286).
catalyst(881,286) :- not remove_reaction(881,286).
catalyst(882,286) :- not remove_reaction(882,286).
catalyst(901,286) :- not remove_reaction(901,286).
catalyst(902,286) :- not remove_reaction(902,286).
catalyst(931,286) :- not remove_reaction(931,286).
catalyst(932,286) :- not remove_reaction(932,286).
catalyst(1191,286) :- not remove_reaction(1191,286).
catalyst(1192,286) :- not remove_reaction(1192,286).
catalyst(1581,269).
catalyst(1582,269).
catalyst(6560,258).
catalyst(361,256).
...
catalyst(851,94) :- not remove_reaction(851,94).
catalyst(852,94) :- not remove_reaction(852,94).
catalyst(901,94) :- not remove_reaction(901,94).
catalyst(902,94) :- not remove_reaction(902,94).
...
catalyst(851,93) :- not remove_reaction(851,93).
catalyst(852,93) :- not remove_reaction(852,93).
catalyst(901,93) :- not remove_reaction(901,93).
catalyst(902,93) :- not remove_reaction(902,93).
catalyst(2920,74).
catalyst(2920,73).
catalyst(2920,72).
catalyst(2920,71).
