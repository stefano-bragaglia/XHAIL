...
component("YLR056W",160).
component("YPL231W",204).
component("U46_",36).
component("YBR149W",55).
component("YGL001C",108).
component("YIL094C",130).
component("U45_",35).
component("YDR127W",78).
component("YOL126C",192).
component("YDL078C",69).
component("YNL037C",176).
component("YML086C",172).
component("YGR088W",116).
component("YDR256C",85).
component("YJR078W",142).
component("U107_",19).
component("YER070W",103).
component("U36_",32).
component("YPL276W",210).
component("YPL275W",209).
component("YOR388C",198).
component("YOR323C",195).
component("YIL125W",131).
component("U52_",38).
component("YBR166C",56).
component("YKL216W",152).
component("YKR009C",153).
component("YIL160C",133).
component("YGL205W",114).
component("YKR080W",155).
component("YER023W",99).
component("YLR142W",163).
component("U62_",40).
component("YHR068W",124).
component("YKL150W",148).
component("YIL043C",128).
component("YPL266W",208).
component("YDL033C",68).
component("YLR058C",161).
component("YDR019C",74).
component("YBR176W",57).
component("YDR408C",89).
component("YMR120C",173).
component("YLR028C",158).
component("YPR074C",213).
component("YBR117C",54).
component("YPL231W",205).
component("YPL231W",206).
component("YLR299W",168).
component("YDL182W",72).
component("YDL131W",71).
component("YNL029C",175).
component("YIL085C",129).
component("YLR209C",165).
component("YDR354W",87) :- not remove_orf("YDR354W",87).
component("YFR047C",107).
component("YLR209C",166).
component("YML022W",170).
component("YDR441C",91).
component("YJL167W",138).
component("YDR127W",79).
component("YJR130C",144).
component("YDR035W",75).
component("YBR249C",59).
component("YOR274W",194).
component("YHR137W",125).
component("YLR027C",157).
component("YKL106W",147).
component("YJR148W",145).
component("YNR058W",186).
component("YCR036W",67).
component("U96_",42).
component("YNR012W",184).
component("YDR127W",80).
component("YDR226W",83).
component("YKL067W",146).
component("YDR454C",92).
component("YOL061W",188).
component("YKL181W",149).
component("YHL011C",122).
component("YER099C",105).
component("YBL068W",48).
component("YNL256W",179).
component("YBR018C",50).
component("YPR175W",216).
component("YPL167C",203).
component("YOR330C",196).
component("YOL115W",191).
component("YNL299W",182).
component("YNL262W",180).
component("YNL102W",177).
component("YJR043C",140).
component("YJR006W",139).
component("YJL090C",137).
component("YIL139C",132).
component("YEL055C",96).
component("YDR419W",90).
component("YDR121W",77).
component("YDL102W",70).
component("YCR014C",66).
component("YBR278W",61).
component("YBL035C",46).
component("YPR113W",214).
component("U105_",18).
component("YLR377C",169).
component("U30_",31).
component("U29_",30).
component("U24_",29).
component("YGL027C",110).
component("YDR400W",88).
component("YML035C",171).
component("YJL070C",136).
component("YBR284W",62).
component("YDR242W",84).
component("U53_",39).
component("YLR028C",159).
component("YHR144C",126).
component("U39_",33).
component("YBR011C",49).
component("YBR111C",53).
component("YBR252W",60).
component("YER005W",98).
component("YLR231C",167).
component("U98_",43).
component("YKL211C",150) :- not remove_orf("YKL211C",150).
component("YKL211C",151) :- not remove_orf("YKL211C",151).
component("YER090W",151) :- not remove_orf("YER090W",151).
component("YER090W",104) :- not remove_orf("YER090W",104).
component("YDR127W",81).
component("YPL281C",211).
component("YOR393W",199).
component("YMR323W",174).
component("YHR174W",127).
component("YGR254W",120).
component("YGL026C",109) :- not remove_orf("YGL026C",109).
component("YNL316C",183).
component("YDR127W",82).
component("YGL148W",112).
component("YIL168W",135).
component("YIL167W",134).
component("YCL064C",65).
component("YAL012W",44).
component("YDR007W",73) :- not remove_orf("YDR007W",73).
component("YOR095C",193).
component("YPL117C",202).
component("YPR060C",212).
component("YPL097W",200).
component("YGR185C",119).
component("YGR264C",121).
component("YGR171C",118).
component("YPL104W",201).
component("YLL018C",156).
component("YOL097C",189).
component("YOR335C",197).
component("YLR153C",164).
component("YAL054C",45).
component("U90_",41).
component("YNR057C",185).
component("YJR103W",143).
component("YBL039C",47).
component("YGL062W",111).
component("YBR218C",58).
component("YPR138C",215).
component("YPL265W",207).
component("YOL103W",190).
component("YOL020W",187) :- not remove_orf("YOL020W",187).
component("YNL270C",181).
component("YNL142W",178).
component("YLR100C",162).
component("YKR039W",154) :- not remove_orf("YKR039W",154).
component("YJR077C",141).
component("YHL036W",123).
component("YGR121C",117).
component("YGR055W",115).
component("YGL186C",113).
component("YFL055W",106).
component("YER060W-A",102).
component("YER060W",101).
component("YER056C",100).
component("YEL063C",97).
component("YDR536W",95).
component("YDR508C",94).
component("YDR497C",93).
component("YDR297W",86).
...
catalyst(5601,165).
catalyst(5602,165).
catalyst(3620,87) :- not remove_reaction(3620,87).
catalyst(2190,107).
catalyst(5791,166).
catalyst(5792,166).
catalyst(5801,166).
...
catalyst(3500,167).
catalyst(2250,43).
catalyst(3600,150) :- not remove_reaction(3600,150).
...
catalyst(8231,120).
catalyst(8232,120).
catalyst(3590,109) :- not remove_reaction(3590,109).
catalyst(10910,109) :- not remove_reaction(10910,109).
catalyst(3680,183).
catalyst(3750,82).
catalyst(3700,112).
catalyst(8751,135).
...
catalyst(781,154) :- not remove_reaction(781,154).
catalyst(782,154) :- not remove_reaction(782,154).
...
catalyst(881,154) :- not remove_reaction(881,154).
catalyst(882,154) :- not remove_reaction(882,154).
catalyst(931,154) :- not remove_reaction(931,154).
catalyst(932,154) :- not remove_reaction(932,154).
catalyst(1191,154) :- not remove_reaction(1191,154).
catalyst(1192,154) :- not remove_reaction(1192,154).
catalyst(1581,141).
catalyst(1582,141).
catalyst(841,123).
catalyst(842,123).
