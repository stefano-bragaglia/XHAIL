...
component("YLR056W",213).
component("YPL231W",285).
component("U46_",43).
component("YBR149W",64).
component("YGL001C",136).
component("YIL094C",170).
component("U45_",42).
component("YDR127W",94).
component("YOL126C",259).
component("YKL085W",195).
component("YDL078C",80).
component("YNL037C",237).
component("YLR355C",229).
component("YDL174C",86).
component("YML086C",233).
component("YGR088W",152).
component("YDR256C",103).
component("YJR078W",189).
component("U107_",20).
component("YER070W",128).
component("U36_",39).
component("YPL276W",291).
component("YPL275W",290).
component("YOR388C",276).
component("YOR323C",270).
component("YIL125W",171).
component("U52_",45).
component("YBR166C",66).
component("YKL216W",202).
component("YKR009C",203).
component("YIL160C",173).
component("YGL205W",147).
component("YKR080W",207).
component("YER023W",124).
component("YLR142W",218).
component("U62_",47).
component("YHR068W",161).
component("YKL150W",198).
component("YIL043C",168).
component("YPL171C",284).
component("YHR179W",166).
component("YDR353W",107).
component("YPL266W",289).
component("YKR069W",206).
component("YDL033C",79).
component("YLR172C",220).
component("YLR058C",214).
component("YDR019C",89).
component("YBR176W",67).
component("YDR408C",112).
component("YMR120C",234).
component("YLR028C",210).
component("YJL130C",180).
component("YKL024C",193).
component("YPR074C",295).
component("YBR117C",63).
component("YPL231W",286).
component("YPL231W",287).
component("YLR299W",226).
component("YDL182W",87).
component("YDL131W",83).
component("YLR258W",224).
component("YFR015C",133).
component("YNL029C",236).
component("YIL085C",169).
component("YLR209C",221).
component("U104_",18).
component("YDR354W",108) :- not remove_orf("YDR354W",108).
component("YFR047C",134).
component("YLR209C",222).
component("YML022W",231).
component("YDR441C",114).
component("YJL167W",184).
component("YDR127W",95).
component("YLR303W",228).
component("YJR130C",191).
component("YDR035W",90).
component("YBR249C",69).
component("YOR274W",269).
component("YHR137W",162).
component("YGL202W",146).
component("YLR027C",209).
component("YKL106W",196).
component("YLR089C",215).
component("YJR148W",192).
component("YNR058W",251).
component("YGL253W",148).
component("YFR053C",135).
component("YCR036W",78).
component("U96_",50).
component("YNR012W",249).
component("YDR127W",96).
component("YDR147W",99).
component("U76_",48).
component("YDR226W",101).
component("YKL067W",194).
component("YOL055C",254).
component("YDR454C",115).
component("YOL061W",255).
component("YKL181W",199).
component("YHL011C",159).
component("YER099C",130).
component("YBL068W",57).
component("YNL256W",243).
component("YBR018C",59).
component("YGL130W",143).
component("YPR190C",301).
component("YPR187W",300).
component("YPR110C",296).
component("YPR010C",293).
component("YOR341W",274).
component("YOR340C",273).
component("YOR224C",268).
component("YOR210W",267).
component("YOR207C",266).
component("YOR151C",263).
component("YOR116C",262).
component("YOL005C",252).
component("YNR003C",248).
component("YNL248C",242).
component("YNL151C",241).
component("YNL113W",239).
component("YKL144C",197).
component("YJR063W",187).
component("YJL148W",183).
component("YJL140W",182).
component("YIL021W",167).
component("YHR143W-A",163).
component("YGL070C",142).
component("YFL036W",131).
component("YDR404C",111).
component("YDR156W",100).
component("YDR045C",91).
component("YDL150W",85).
component("YDL140C",84).
component("YBR154C",65).
component("YPR175W",299).
component("YPL167C",283).
component("YOR330C",271).
component("YOL115W",258).
component("YNL299W",246).
component("YNL262W",244).
component("YNL102W",238).
component("YJR043C",186).
component("YJR006W",185).
component("YJL090C",177).
component("YIL139C",172).
component("YEL055C",121).
component("YDR419W",113).
component("YDR121W",93).
component("YDL102W",82).
component("YCR014C",76).
component("YBR278W",71).
component("YBL035C",55).
component("YPR113W",297).
component("YPL148C",282).
component("U105_",19).
component("YBL015W",54).
component("YLR377C",230).
component("U30_",38).
component("U29_",37).
component("U24_",36).
component("YOR360C",275).
component("YGL027C",140).
component("YOR190W",265).
component("YLR300W",227).
component("YGR282C",158).
component("YDR261C",104).
component("YDR400W",110).
component("YML035C",232).
component("YJL070C",176).
component("YBR284W",72).
component("YDR242W",102).
component("U53_",46).
component("YLR028C",211).
component("YHR144C",164).
component("YJL126W",178).
component("U39_",40).
component("YBR011C",58).
component("YBR111C",62).
component("YBR252W",70).
component("YER005W",123).
component("YLR231C",223).
component("YLR134W",217).
component("YLR044C",212).
component("YGR087C",151).
component("YDR380W",109).
component("YDL080C",81).
component("U98_",51).
component("YKL211C",200) :- not remove_orf("YKL211C",200).
component("YKL211C",201) :- not remove_orf("YKL211C",201).
component("YER090W",201) :- not remove_orf("YER090W",201).
component("YER090W",129) :- not remove_orf("YER090W",129).
component("YDR127W",97).
component("YPL281C",292).
component("YOR393W",277).
component("YMR323W",235).
component("YHR174W",165).
component("YGR254W",156).
component("YGL026C",139) :- not remove_orf("YGL026C",139).
component("YNL316C",247).
component("YDR127W",98).
component("YGL148W",144).
component("YIL168W",175).
component("YIL167W",174).
component("YCL064C",75).
component("YAL012W",52).
component("YDR007W",88) :- not remove_orf("YDR007W",88).
component("YOR095C",261).
component("YGL001C",137).
component("YPL117C",281).
component("YPR060C",294).
component("YPL097W",279).
component("YGR185C",155).
component("YGR264C",157).
component("YGR171C",154).
component("YPL104W",280).
component("YLL018C",208).
component("YOL097C",256).
component("YDR268W",105).
component("YOR335C",272).
component("YLR153C",219).
component("YAL054C",53).
component("U90_",49).
component("YNR057C",250).
component("YJR103W",190).
component("YBL039C",56).
component("YGL062W",141).
component("YBR218C",68).
component("YPR138C",298).
component("YPL265W",288).
component("YPL036W",278).
component("YOR171C",264).
component("YOR011W",260).
component("YOL103W",257).
component("YOL020W",253) :- not remove_orf("YOL020W",253).
component("YNL270C",245).
component("YNL142W",240).
component("YLR260W",225).
component("YLR100C",216).
component("YKR053C",205).
component("YKR039W",204) :- not remove_orf("YKR039W",204).
component("YJR077C",188).
component("YJL134W",181).
component("YJL129C",179).
component("YHL036W",160).
component("YGR121C",153).
component("YGR065C",150).
component("YGR055W",149).
component("YGL186C",145).
component("YGL008C",138).
component("YFL055W",132).
component("YER060W-A",127).
component("YER060W",126).
component("YER056C",125).
component("YEL063C",122).
component("YEL017C-A",120).
component("YDR536W",119).
component("YDR508C",118).
component("YDR503C",117).
component("YDR497C",116).
component("YDR297W",106).
component("YDR046C",92) :- not remove_orf("YDR046C",92).
component("YCR024C-A",77).
component("YCL025C",74).
component("YBR298C",73).
component("YBR069C",61) :- not remove_orf("YBR069C",61).
component("YBR068C",60) :- not remove_orf("YBR068C",60).
component("U4_",44).
component("U3_",41).
component("U228_",35).
component("U223_",34).
...
catalyst(2121,18).
catalyst(2122,18).
catalyst(3620,108) :- not remove_reaction(3620,108).
catalyst(2190,134).
catalyst(5791,222).
catalyst(5792,222).
catalyst(5801,222).
...
catalyst(8812,81).
catalyst(2250,51).
catalyst(3600,200) :- not remove_reaction(3600,200).
catalyst(3630,201) :- not remove_reaction(3630,201).
catalyst(3630,129) :- not remove_reaction(3630,129).
catalyst(3740,97).
catalyst(8231,292).
catalyst(8232,292).
catalyst(8231,277).
...
catalyst(8231,156).
catalyst(8232,156).
catalyst(3590,139) :- not remove_reaction(3590,139).
catalyst(10910,139) :- not remove_reaction(10910,139).
catalyst(3680,247).
catalyst(3750,98).
catalyst(3700,144).
catalyst(8751,175).
...
catalyst(4520,75).
catalyst(4460,52).
catalyst(3610,88) :- not remove_reaction(3610,88).
catalyst(7921,261).
catalyst(7922,261).
catalyst(6370,137).
catalyst(6461,281).
...
catalyst(781,204) :- not remove_reaction(781,204).
catalyst(782,204) :- not remove_reaction(782,204).
...
catalyst(881,204) :- not remove_reaction(881,204).
catalyst(882,204) :- not remove_reaction(882,204).
catalyst(901,204) :- not remove_reaction(901,204).
catalyst(902,204) :- not remove_reaction(902,204).
catalyst(931,204) :- not remove_reaction(931,204).
catalyst(932,204) :- not remove_reaction(932,204).
catalyst(1191,204) :- not remove_reaction(1191,204).
catalyst(1192,204) :- not remove_reaction(1192,204).
catalyst(1581,188).
catalyst(1582,188).
catalyst(6560,181).
catalyst(361,179).
...
catalyst(841,92) :- not remove_reaction(841,92).
catalyst(842,92) :- not remove_reaction(842,92).
catalyst(851,92) :- not remove_reaction(851,92).
catalyst(852,92) :- not remove_reaction(852,92).
catalyst(901,92) :- not remove_reaction(901,92).
catalyst(902,92) :- not remove_reaction(902,92).
catalyst(220,77).
catalyst(771,74).
catalyst(772,74).
catalyst(781,74).
...
catalyst(1121,73).
catalyst(1122,73).
catalyst(771,61) :- not remove_reaction(771,61).
catalyst(772,61) :- not remove_reaction(772,61).
catalyst(801,61) :- not remove_reaction(801,61).
catalyst(802,61) :- not remove_reaction(802,61).
catalyst(811,61) :- not remove_reaction(811,61).
catalyst(812,61) :- not remove_reaction(812,61).
catalyst(851,61) :- not remove_reaction(851,61).
catalyst(852,61) :- not remove_reaction(852,61).
catalyst(901,61) :- not remove_reaction(901,61).
catalyst(902,61) :- not remove_reaction(902,61).
catalyst(801,60) :- not remove_reaction(801,60).
catalyst(802,60) :- not remove_reaction(802,60).
catalyst(811,60) :- not remove_reaction(811,60).
catalyst(812,60) :- not remove_reaction(812,60).
catalyst(831,60) :- not remove_reaction(831,60).
catalyst(832,60) :- not remove_reaction(832,60).
catalyst(841,60) :- not remove_reaction(841,60).
catalyst(842,60) :- not remove_reaction(842,60).
catalyst(851,60) :- not remove_reaction(851,60).
catalyst(852,60) :- not remove_reaction(852,60).
catalyst(901,60) :- not remove_reaction(901,60).
catalyst(902,60) :- not remove_reaction(902,60).
catalyst(6980,44).
catalyst(6980,41).
catalyst(41,35).
catalyst(42,35).
