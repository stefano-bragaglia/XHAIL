...
component("YLR056W",628).
component("YGR060W",436).
component("YGL012W",407).
component("YKR009C",608).
component("YOL086C",760).
component("YMR303C",705).
component("YMR083W",687).
component("YGL256W",429).
component("YDL168W",280).
component("YBR145W",212).
component("YPL231W",826).
component("YBR265W",230).
component("U46_",127).
component("YBR149W",213).
component("YBR149W",214).
component("YGL001C",404).
component("YIL094C",511).
component("U45_",126).
component("YML056C",674).
component("YLR432W",664).
component("YHR216W",502).
component("YAR075W",182).
component("YAR073W",181).
component("YDR127W",307).
component("YJR139C",576).
component("YML075C",676).
component("YLR450W",667).
component("YOL126C",766).
component("YKL085W",587).
component("YDL078C",263).
component("YKL029C",583).
component("YNL037C",710).
component("YNL009W",708).
component("YLR174W",641).
component("YHR183W",495).
component("YGR256W",458).
component("YNL241C",725).
component("YOL059W",757).
component("YDL022W",255).
component("YCL018W",238).
component("YLR355C",659).
component("YIL074C",508).
component("YER081W",378).
component("YDL174C",284).
component("YML086C",678).
component("YIL155C",520).
component("YEL024W",353).
component("YKR066C",613).
component("YGR088W",440).
component("YDR256C",321).
component("YKL026C",582).
component("YIR037W",530).
component("YBR244W",225).
component("YJR078W",569).
component("U58_",136).
component("YJR025C",561).
component("U107_",26).
component("YGR255C",457).
component("U108_",27).
component("YHR007C",469).
component("YDR402C",335).
component("YGL055W",414).
component("YJR104C",571).
component("YHR008C",470).
component("YOR384W",804).
component("YOR381W",803).
component("YOL152W",768).
component("YLL051C",621).
component("YJL026W",532).
component("YIL066C",507).
component("YGR180C",447).
component("YER070W",375).
component("U37_",120).
component("U36_",119).
component("U35_",118).
component("YDL168W",281).
component("YDR158W",315).
component("YJR009C",558).
component("YJL052W",534).
component("YGR192C",449).
component("YBR006W",192).
component("YPL276W",834).
component("YPL275W",833).
component("YOR388C",805).
component("YPL061W",811).
component("YOR374W",801).
component("YER073W",376).
component("YGL154C",421).
component("YBR115C",208).
component("U55_",135).
component("YER069W",373).
component("YOR323C",793).
component("YMR170C",696).
component("YMR169C",695).
component("YER178W",388).
component("YBR221C",223).
component("YIL125W",516).
component("U52_",132).
component("YBR166C",217).
component("YNL280C",733).
component("YGL012W",408).
component("YKL182W",597).
component("YKL216W",607).
component("YDR044W",297).
component("YER014W",363).
component("YKR009C",609).
component("YIL160C",521).
component("YGL205W",426).
component("YMR118C",690).
component("YLR164W",639).
component("YLL041C",619).
component("YKL148C",592).
component("YKL141W",590).
component("YJL045W",533).
component("YDR178W",316).
component("YEL047C",356).
component("YDL171C",282).
component("YDL171C",283).
component("YOR375C",802).
component("YDL215C",288).
component("YAL062W",178).
component("U99_",172).
component("U100_",21).
component("YBR035C",199).
component("YKR080W",615).
component("YER023W",364).
component("YOR236W",791).
component("YGR204W",451).
component("YIR034C",529).
component("YLR142W",636).
component("U65_",143).
component("U63_",141).
component("U62_",140).
component("YHR068W",480).
component("YKL150W",593).
component("YIL043C",505).
component("YHR042W",475).
component("YOR221C",788).
component("YMR145C",693).
component("YKL192C",601).
component("YKL055C",585).
component("YER061C",371).
component("YDL085W",265).
component("YPL171C",819).
component("YHR179W",494).
component("YMR145C",694).
component("YML120C",679).
component("YKL192C",602).
component("YDL085W",266).
component("YGR234W",453).
component("YFR030W",400).
component("YPL017C",808).
component("YFL018C",392).
component("YDR353W",331).
component("YPR167C",850).
component("YJR137C",575).
component("YNL052W",712).
component("YMR256C",702).
component("YLR395C",663).
component("YLR038C",626).
component("YIL111W",513).
component("YHR051W",479).
component("YGL191W",424).
component("YGL187C",423).
component("YDL067C",262).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",302).
component("YPL266W",832).
component("YKR069W",614).
component("YOL096C",761).
component("U47_",128).
component("YER091C",383).
component("YJR073C",567).
component("YGR157W",445).
component("YDR120C",305).
component("YML008C",669).
component("YOR074C",773).
component("YDL033C",257).
component("YOL096C",762).
component("YLR172C",640).
component("YLR058C",629).
component("YDR019C",294).
component("YBR176W",218).
component("YDR408C",337).
component("YMR120C",691).
component("YLR028C",624).
component("YBL013W",183).
component("YJL130C",543).
component("YJL088W",537).
component("YKL024C",581).
component("YPR074C",845).
component("YBR117C",209).
component("YMR108W",689).
component("YCL009C",237).
component("YNL071W",714).
component("YNR008W",738).
component("YIL160C",522).
component("YNR019W",741).
component("YCR048W",251).
component("U48_",129).
component("YMR062C",686).
component("YDR232W",318).
component("YPL231W",827).
component("YER061C",372).
component("YPL001W",807).
component("YDL052C",261).
component("U8_",166).
component("YDR148C",313).
component("YPL231W",828).
component("YPL028W",809).
component("YLR299W",651).
component("YGL017W",409).
component("YCR005C",243).
component("YML126C",680).
component("YNL104C",717).
component("YDL182W",285).
component("YDL131W",271).
component("YDR307W",327).
component("YLR258W",648).
component("YFR015C",398).
component("YNL029C",709).
component("YIL085C",510).
component("YNL192W",723).
component("YBR038W",200).
component("YBR023C",197).
component("YMR306W",706).
component("YLR342W",657).
component("YGR032W",433).
component("YPR183W",852).
component("YBR248C",226).
component("YLR209C",643).
component("U104_",23).
component("U103_",22).
component("YDR354W",332) :- not remove_orf("YDR354W",332).
component("YFR047C",401).
component("YJR133W",574).
component("YLR209C",644).
component("YML022W",671).
component("YDR441C",340).
component("YHR128W",489).
component("YJL167W",550).
component("YJL167W",551).
component("YPR069C",842).
component("YDR127W",308).
component("YHR190W",497).
component("YLR146C",637).
component("YHR068W",481).
component("YLR303W",653).
component("YGR012W",431).
component("YML082W",677).
component("YJR130C",573).
component("YDR035W",296).
component("YBR249C",227).
component("YLR180W",642).
component("YDR502C",344).
component("YOR274W",792).
component("YBR256C",229).
component("YHR137W",490).
component("YGL202W",425).
component("YLR027C",623).
component("YKL106W",588).
component("YOL140W",767).
component("YLR438W",666).
component("YGR019W",432).
component("YLR089C",632).
component("U64_",142).
component("U61_",139).
component("U51_",131).
component("YJR148W",577).
component("YHR208W",500).
component("YFL030W",394).
component("YOR184W",782).
component("YNR058W",747).
component("YIL116W",515).
component("YGL253W",428).
component("YFR053C",402).
component("YMR013C",684).
component("YMR205C",698).
component("YGR240C",454).
component("YOL016C",751).
component("YFR014C",397).
component("YLR240W",646).
component("YKL203C",604).
component("YJR066W",566).
component("YCR036W",250).
component("YCL040W",240).
component("U15_",60).
component("YPL188W",821).
component("YJR049C",563).
component("YEL041W",354).
component("U96_",170).
component("YKL001C",580).
component("YDR236C",319).
component("YHL032C",467).
component("YDR531W",348).
component("U83_",161).
component("U82_",160).
component("U81_",159).
component("YMR208W",699).
component("YPL203W",822).
component("YOR061W",772).
component("YKL166C",595).
component("YJL164C",549).
component("YIL035C",504).
component("YHR205W",499).
component("YHR102W",487).
component("YGL019W",410).
component("YHR025W",474).
component("YOR347C",798).
component("YAL038W",176).
component("YNR012W",739).
component("YDR009W",293).
component("YDR127W",309).
component("YDR147W",312).
component("YDR300C",326).
component("YCR012W",244).
component("YER069W",374).
component("U19_",92).
component("U18_",83).
component("U17_",74).
component("U76_",153).
...
component("YKL067W",586).
component("YOL055C",754).
component("YDR454C",341).
component("YJR057W",564).
component("YOL061W",758).
component("YKL181W",596).
component("YHL011C",465).
component("YER099C",384).
component("YBL068W",190).
component("YOR143C",778).
component("YNL256W",728).
component("YLR328W",655).
component("YBR018C",194).
component("YGR007W",430).
component("YGR202C",450).
component("YLR328W",656).
component("YDL045C",259).
component("U80_",158).
component("YDL103C",270).
component("U94_",169).
component("YJR010W",559).
component("YBR029C",198).
component("YCL050C",241).
component("YGL130W",419).
component("YDR530C",347).
component("YPR190C",854).
component("YPR187W",853).
component("YPR110C",847).
component("YPR010C",837).
component("YOR341W",797).
component("YOR340C",796).
component("YOR224C",790).
component("YOR210W",787).
component("YOR207C",785).
component("YOR151C",779).
component("YOR116C",775).
component("YOL005C",749).
component("YNR003C",737).
component("YNL248C",727).
component("YNL151C",721).
component("YNL113W",718).
component("YKL144C",591).
component("YJR063W",565).
component("YJL148W",547).
component("YJL140W",546).
component("YIL021W",503).
component("YHR143W-A",491).
component("YGL070C",417).
component("YFL036W",395).
component("YDR404C",336).
component("YDR156W",314).
component("YDR045C",298).
component("YDL150W",279).
component("YDL140C",273).
component("YBR154C",216).
component("YPR175W",851).
component("YPL167C",818).
component("YOR330C",794).
component("YOL115W",765).
component("YNL299W",735).
component("YNL262W",730).
component("YNL102W",716).
component("YJR043C",562).
component("YJR006W",557).
component("YJL090C",538).
component("YIL139C",518).
component("YEL055C",357).
component("YDR419W",338).
component("YDR121W",306).
component("YDL102W",269).
component("YCR014C",245).
component("YBR278W",232).
component("YBL035C",186).
component("YKL035W",584).
component("YHL012W",466).
component("YHR123W",488).
component("YPR113W",848).
component("YBR243C",224).
component("YDL142C",278).
component("YPL148C",816).
component("YER026C",365).
component("YGR286C",462).
component("YHR189W",496).
component("YDR058C",301).
component("YDL086W",267).
component("YOL011W",750).
component("YMR008C",682).
component("YMR006C",681).
component("U105_",24).
component("YBL015W",184).
component("YJL068C",535).
component("YOR040W",771).
component("U77_",154).
component("YDR481C",342).
component("YLR377C",661).
component("YPL179W",820).
component("YNR032W",742).
component("YML057W",675).
component("YML016C",670).
component("YLR433C",665).
component("YGR123C",443).
component("YER133W",385).
component("YER089C",381).
component("YDR436W",339).
component("YDR075W",303).
component("YDL188C",286).
component("YDL134C",272).
component("YDL047W",260).
component("YDL006W",253).
component("YBR125C",211).
component("YBL056W",189).
component("YPR073C",843).
component("YHR215W",501).
component("YDL024C",256).
component("YBR093C",206).
component("YBR092C",205).
component("YAR071W",180).
component("YHR046C",478).
component("U9_",173).
component("YPL228W",825).
component("YMR180C",697).
component("YDL236W",290).
component("YJL155C",548).
component("YPR073C",844).
component("YOR208W",786).
component("YNL053W",713).
component("YMR036C",685).
component("YIR026C",528).
component("YIL113W",514).
component("YFR028C",399).
component("YER075C",377).
component("YDL230W",289).
component("YBR276C",231).
component("U34_",117).
component("U33_",116).
component("U32_",115).
component("U31_",114).
...
component("U25_",108).
component("U24_",107).
component("YHR044C",477).
component("YHR043C",476).
component("YOL064C",759).
component("YOR360C",800).
component("YKR031C",610).
component("YPL206C",823).
component("YGL027C",412).
component("YLR286C",650).
component("YJR153W",578).
component("YJL221C",556).
component("YJL216C",554).
component("YIL172C",526).
component("YGR292W",464).
component("YGR287C",463).
component("YBR299W",236).
component("YBR184W",219).
component("YIL162W",523).
component("YIR019C",527).
component("YIL099W",512).
component("YDL037C",258).
component("YOR190W",783).
component("YLR300W",652).
component("YGR282C",461).
component("YDR261C",322).
component("YDR400W",334).
component("U23_",106).
component("YML035C",672).
component("YJL070C",536).
component("YBR284W",233).
component("U106_",25).
component("YER043C",366).
component("YNL045W",711).
component("YGL037C",413).
component("YDR242W",320).
component("YBR208C",221).
component("YMR281W",704).
component("U53_",133).
component("YPR062W",841).
component("YMR120C",692).
component("YLR028C",625).
component("YHR144C",492).
component("YGR267C",460).
component("YBL033C",185).
component("YBR153W",215).
component("YNL141W",719).
component("YLR245C",647).
component("YML035C",673).
component("YBR084W",203).
...
component("U40_",123).
component("U39_",121).
component("YBR011C",193).
component("YHR201C",498).
component("YBR111C",207).
component("YBR252W",228).
component("YER005W",362).
component("YIL048W",506).
component("YER166W",386).
component("YDR093W",304).
component("YAL026C",175).
component("YBL099W",191).
component("U60_",138).
component("YLR231C",645).
component("U88_",164).
component("YDR538W",350).
component("YLR134W",634).
component("YLR044C",627).
component("YGR087C",439).
component("YDR380W",333).
component("YDL080C",264).
component("U98_",171).
component("YMR250W",701).
component("YKL184W",600).
component("YOR128C",776).
component("YEL021W",352).
component("YNR043W",744).
component("U93_",168).
component("U54_",134).
component("YKL211C",605) :- not remove_orf("YKL211C",605).
component("YKR097W",617).
component("YNL169C",722).
component("YNL256W",729).
component("YDR294C",324).
component("YEL046C",355).
component("YNR033W",743).
component("YKL211C",606) :- not remove_orf("YKL211C",606).
component("YER090W",606) :- not remove_orf("YER090W",606).
component("YER090W",382) :- not remove_orf("YER090W",382).
component("YDR127W",310).
component("YPL281C",835).
component("YOR393W",806).
component("YMR323W",707).
component("YHR174W",493).
component("YGR254W",456).
component("YOR202W",784).
component("YPL262W",830).
component("YGL026C",411) :- not remove_orf("YGL026C",411).
component("YGR155W",444).
component("YLR304C",654).
component("YJL200C",552).
component("YNL316C",736).
component("YKL182W",598).
component("YPL212C",824).
component("YNL292W",734).
component("YGL063W",416).
component("YFL001W",390).
component("YPR002W",836).
component("YJR016C",560).
component("YCR053W",252).
component("YDR127W",311).
component("YGL148W",420).
component("YIL168W",525).
component("YIL167W",524).
component("YCL064C",242).
component("YER086W",379).
component("YLR359W",660).
component("YAL012W",174).
component("YML004C",668).
component("YFR055W",403).
component("YJL005W",531).
component("YJL121C",540).
component("YBR019C",195).
component("YDR050C",300).
component("YDR007W",292) :- not remove_orf("YDR007W",292).
component("YOR095C",774).
component("YER003C",361).
component("YBR196C",220).
component("YGL001C",405).
component("YPL117C",814).
component("U14_",52).
component("YOL056W",755).
component("YKL152C",594).
component("YDL021W",254).
component("YMR105C",688).
component("YKL127W",589).
component("YEL058W",358).
component("YPR060C",840).
component("YHR072W",482).
component("YPL097W",812).
component("YGR185C",448).
component("YGR264C",459).
component("YGR171C",446).
component("YHR011W",471).
component("YDR023W",295).
component("YPL104W",813).
component("YLL018C",618).
component("YPR081C",846).
component("YBR121C",210).
component("YHR020W",473).
component("YER087W",380).
component("YNL247W",726).
component("YOR168W",780).
component("YOL097C",763).
component("YDR268W",323).
component("YPR047W",839).
component("YLR060W",630).
component("YFL022C",393).
component("YCR024C",246).
component("YHR019C",472).
component("YKL194C",603).
component("YIL078W",509).
component("YPL160W",817).
component("YLR382C",662).
component("YNL073W",715).
component("YOR335C",795).
component("YGR094W",441).
component("YLR153C",638).
component("YAL054C",177).
component("YGR244C",455).
component("YPR035W",838).
component("YIL145C",519).
component("U89_",165).
component("YJL101C",539).
component("YOL049W",753).
component("YAR015W",179).
component("YER183C",389).
component("U90_",167).
component("YNR057C",746).
component("YDL141W",274).
component("YDL141W",275).
component("YGL234W",427).
component("YDL141W",276).
component("YJR103W",570).
component("YBL039C",187).
component("YGR204W",452).
component("YBR084W",204).
component("YNL220W",724).
component("YOL058W",756).
component("YDL141W",277).
component("YHR074W",483).
component("YMR217W",700).
component("YGR061C",437).
component("YJR109C",572).
component("YJL130C",544).
component("YGL062W",415).
component("YBR218C",222).
component("YPL231W",829).
component("YNR016C",740).
component("YKL182W",599).
component("YGR037C",434).
component("YPR138C",849).
component("YPL265W",831).
component("YPL134C",815).
component("YPL036W",810).
component("YOR348C",799).
component("YOR222W",789).
component("YOR171C",781).
component("YOR130C",777).
component("YOR011W",770).
component("YOL156W",769).
component("YOL103W",764).
component("YOL020W",752) :- not remove_orf("YOL020W",752).
component("YNR072W",748).
component("YNR056C",745).
component("YNL270C",731).
component("YNL142W",720).
component("YMR272C",703).
component("YMR011W",683).
component("YLR348C",658).
component("YLR260W",649).
component("YLR138W",635).
component("YLR100C",633).
component("YLR081W",631).
component("YLL061W",622).
component("YLL043W",620).
component("YKR093W",616).
component("YKR053C",612).
component("YKR039W",611) :- not remove_orf("YKR039W",611).
component("YJR158W",579).
component("YJR077C",568).
component("YJL219W",555).
component("YJL214W",553).
component("YJL134W",545).
component("YJL129C",542).
component("YIL134W",517).
component("YHR096C",486).
component("YHR094C",485).
component("YHR092C",484).
component("YHL036W",468).
component("YGR121C",442).
component("YGR065C",438).
component("YGR055W",435).
component("YGL186C",422).
component("YGL077C",418).
component("YGL008C",406).
component("YFL055W",396).
component("YFL011W",391).
component("YER060W-A",370).
component("YER060W",369).
component("YER056C",368).
component("YER053C",367).
component("YEL069C",360).
component("YEL063C",359).
component("YEL017C-A",351).
component("YDR536W",349).
component("YDR508C",346).
component("YDR503C",345).
component("YDR497C",343).
component("YDR345C",330).
component("YDR343C",329).
component("YDR342C",328).
component("YDR297W",325).
component("YDR046C",299) :- not remove_orf("YDR046C",299).
component("YDL245C",291).
component("YDL210W",287).
component("YCR032W",249).
component("YCR028C",248).
component("YCR024C-A",247).
component("YCL025C",239).
component("YBR298C",235).
component("YBR291C",234).
component("YBR069C",202) :- not remove_orf("YBR069C",202).
component("YBR068C",201) :- not remove_orf("YBR068C",201).
component("YBR021W",196).
component("YBL042C",188).
component("U85_",162).
component("U7_",157).
component("U79_",156).
component("U78_",155).
...
catalyst(2131,22).
catalyst(2132,22).
catalyst(3620,332) :- not remove_reaction(3620,332).
catalyst(2110,401).
catalyst(2190,401).
catalyst(5550,574).
catalyst(5791,644).
...
catalyst(2300,168).
catalyst(3460,134).
catalyst(3600,605) :- not remove_reaction(3600,605).
catalyst(8000,617).
catalyst(6890,722).
catalyst(2570,729).
catalyst(8781,324).
...
catalyst(4560,355).
catalyst(2550,743).
catalyst(1890,606) :- not remove_reaction(1890,606).
catalyst(3630,606) :- not remove_reaction(3630,606).
...
catalyst(8061,830).
catalyst(8062,830).
catalyst(3590,411) :- not remove_reaction(3590,411).
catalyst(10910,411) :- not remove_reaction(10910,411).
catalyst(4570,444).
catalyst(8181,654).
catalyst(8182,654).
catalyst(8181,552).
...
catalyst(8281,300).
catalyst(8282,300).
catalyst(3610,292) :- not remove_reaction(3610,292).
catalyst(7921,774).
catalyst(7922,774).
catalyst(7841,361).
catalyst(7842,361).
...
catalyst(1210,769).
catalyst(1160,764).
catalyst(801,752) :- not remove_reaction(801,752).
catalyst(802,752) :- not remove_reaction(802,752).
catalyst(811,752) :- not remove_reaction(811,752).
catalyst(812,752) :- not remove_reaction(812,752).
catalyst(831,752) :- not remove_reaction(831,752).
catalyst(832,752) :- not remove_reaction(832,752).
catalyst(901,752) :- not remove_reaction(901,752).
catalyst(902,752) :- not remove_reaction(902,752).
catalyst(1180,748).
catalyst(1210,748).
catalyst(700,745).
catalyst(931,731).
...
catalyst(640,616).
catalyst(6560,612).
catalyst(771,611) :- not remove_reaction(771,611).
catalyst(772,611) :- not remove_reaction(772,611).
catalyst(781,611) :- not remove_reaction(781,611).
catalyst(782,611) :- not remove_reaction(782,611).
catalyst(791,611) :- not remove_reaction(791,611).
catalyst(792,611) :- not remove_reaction(792,611).
catalyst(801,611) :- not remove_reaction(801,611).
catalyst(802,611) :- not remove_reaction(802,611).
catalyst(811,611) :- not remove_reaction(811,611).
catalyst(812,611) :- not remove_reaction(812,611).
catalyst(831,611) :- not remove_reaction(831,611).
catalyst(832,611) :- not remove_reaction(832,611).
catalyst(841,611) :- not remove_reaction(841,611).
catalyst(842,611) :- not remove_reaction(842,611).
catalyst(851,611) :- not remove_reaction(851,611).
catalyst(852,611) :- not remove_reaction(852,611).
catalyst(881,611) :- not remove_reaction(881,611).
catalyst(882,611) :- not remove_reaction(882,611).
catalyst(901,611) :- not remove_reaction(901,611).
catalyst(902,611) :- not remove_reaction(902,611).
catalyst(911,611) :- not remove_reaction(911,611).
catalyst(912,611) :- not remove_reaction(912,611).
catalyst(921,611) :- not remove_reaction(921,611).
catalyst(922,611) :- not remove_reaction(922,611).
catalyst(931,611) :- not remove_reaction(931,611).
catalyst(932,611) :- not remove_reaction(932,611).
catalyst(1191,611) :- not remove_reaction(1191,611).
catalyst(1192,611) :- not remove_reaction(1192,611).
catalyst(1180,579).
catalyst(1210,579).
catalyst(1581,568).
catalyst(1582,568).
...
catalyst(851,299) :- not remove_reaction(851,299).
catalyst(852,299) :- not remove_reaction(852,299).
...
catalyst(1511,234).
catalyst(1512,234).
catalyst(771,202) :- not remove_reaction(771,202).
catalyst(772,202) :- not remove_reaction(772,202).
catalyst(791,202) :- not remove_reaction(791,202).
catalyst(792,202) :- not remove_reaction(792,202).
catalyst(801,202) :- not remove_reaction(801,202).
catalyst(802,202) :- not remove_reaction(802,202).
catalyst(811,202) :- not remove_reaction(811,202).
catalyst(812,202) :- not remove_reaction(812,202).
catalyst(851,202) :- not remove_reaction(851,202).
catalyst(852,202) :- not remove_reaction(852,202).
catalyst(901,202) :- not remove_reaction(901,202).
catalyst(902,202) :- not remove_reaction(902,202).
catalyst(791,201) :- not remove_reaction(791,201).
catalyst(792,201) :- not remove_reaction(792,201).
catalyst(801,201) :- not remove_reaction(801,201).
catalyst(802,201) :- not remove_reaction(802,201).
catalyst(811,201) :- not remove_reaction(811,201).
catalyst(812,201) :- not remove_reaction(812,201).
catalyst(831,201) :- not remove_reaction(831,201).
catalyst(832,201) :- not remove_reaction(832,201).
catalyst(841,201) :- not remove_reaction(841,201).
catalyst(842,201) :- not remove_reaction(842,201).
catalyst(851,201) :- not remove_reaction(851,201).
catalyst(852,201) :- not remove_reaction(852,201).
catalyst(901,201) :- not remove_reaction(901,201).
catalyst(902,201) :- not remove_reaction(902,201).
catalyst(620,196).
catalyst(540,188).
catalyst(2660,162).
catalyst(6960,157).
...
modifiable_enzyme(605).
modifiable_enzyme(606).
modifiable_enzyme(382).
modifiable_enzyme(411).
modifiable_enzyme(292).
modifiable_enzyme(752).
