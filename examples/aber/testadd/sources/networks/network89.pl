...
component("YLR056W",458).
component("YGL012W",284).
component("YKR009C",440).
component("YOL086C",556).
component("YMR303C",511).
component("YGL256W",304).
component("YDL168W",194).
component("YBR145W",149).
component("YPL231W",609).
component("YBR265W",160).
component("U46_",86).
component("YBR149W",150).
component("YBR149W",151).
component("YGL001C",281).
component("YIL094C",368).
component("U45_",85).
component("YML056C",493).
component("YLR432W",489).
component("YHR216W",362).
component("YAR075W",127).
component("YAR073W",126).
component("YDR127W",210).
component("YOL126C",561).
component("YKL085W",426).
component("YDL078C",184).
component("YNL037C",516).
component("YNL009W",514).
component("YLR174W",468).
component("YHR183W",357).
component("YGR256W",324).
component("YOL059W",554).
component("YDL022W",180).
component("YCL018W",168).
component("YLR355C",484).
component("YDL174C",197).
component("YML086C",495).
component("YGR088W",312).
component("YDR256C",221).
component("YJR078W",414).
component("YJR025C",407).
component("U107_",24).
component("YHR007C",334).
component("YJR104C",416).
component("YHR008C",335).
component("YOR384W",592).
component("YOR381W",591).
component("YOL152W",563).
component("YLL051C",451).
component("YJL026W",382).
component("YIL066C",366).
component("YGR180C",315).
component("YER070W",260).
component("U37_",79).
component("U36_",78).
component("YDL168W",195).
component("YJR009C",405).
component("YJL052W",384).
component("YGR192C",317).
component("YBR006W",135).
component("YPL276W",617).
component("YPL275W",616).
component("YOR388C",593).
component("YOR374W",589).
component("YER073W",261).
component("YGL154C",296).
component("U55_",92).
component("YER069W",258).
component("YOR323C",582).
component("YER178W",267).
component("YBR221C",157).
component("YIL125W",372).
component("U52_",90).
component("YBR166C",153).
component("YGL012W",285).
component("YKL216W",439).
component("YKR009C",441).
component("YIL160C",376).
component("YGL205W",301).
component("YMR118C",503).
component("YLR164W",466).
component("YLL041C",450).
component("YKL148C",430).
component("YKL141W",428).
component("YJL045W",383).
component("YDR178W",217).
component("YEL047C",247).
component("YDL171C",196).
component("YOR375C",590).
component("YAL062W",124).
component("U99_",119).
component("U100_",20).
component("YKR080W",446).
component("YER023W",252).
component("YOR236W",580).
component("YGR204W",318).
component("YLR142W",464).
component("U65_",98).
component("U63_",96).
component("U62_",95).
component("YHR068W",344).
component("YKL150W",431).
component("YIL043C",365).
component("YHR042W",339).
component("YPL171C",604).
component("YHR179W",356).
component("YMR145C",506).
component("YML120C",496).
component("YKL192C",436).
component("YDL085W",186).
component("YGR234W",320).
component("YFR030W",278).
component("YPL017C",595).
component("YFL018C",271).
component("YDR353W",228).
component("YPR167C",629).
component("YJR137C",419).
component("YNL052W",518).
component("YMR256C",510).
component("YLR395C",488).
component("YLR038C",456).
component("YIL111W",369).
component("YHR051W",343).
component("YGL191W",299).
component("YGL187C",298).
component("YDL067C",183).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",615).
component("YKR069W",445).
component("YOL096C",557).
component("U47_",87).
component("YJR073C",412).
component("YDR120C",208).
component("YML008C",490).
component("YDL033C",182).
component("YLR172C",467).
component("YLR058C",459).
component("YDR019C",203).
component("YBR176W",154).
component("YDR408C",233).
component("YMR120C",504).
component("YLR028C",454).
component("YBL013W",128).
component("YJL130C",392).
component("YKL024C",424).
component("YPR074C",625).
component("YBR117C",148).
component("YCL009C",167).
component("YNL071W",520).
component("YNR008W",540).
component("YIL160C",377).
component("U48_",88).
component("YPL231W",610).
component("YPL231W",611).
component("YPL028W",596).
component("YLR299W",477).
component("YGL017W",286).
component("YML126C",497).
component("YNL104C",523).
component("YDL182W",198).
component("YDL131W",190).
component("YLR258W",474).
component("YFR015C",276).
component("YNL029C",515).
component("YIL085C",367).
component("YMR306W",512).
component("YLR342W",483).
component("YGR032W",307).
component("YLR209C",470).
component("U104_",21).
component("YDR354W",229) :- not remove_orf("YDR354W",229).
component("YFR047C",279).
component("YJR133W",418).
component("YLR209C",471).
component("YML022W",491).
component("YDR441C",235).
component("YJL167W",397).
component("YJL167W",398).
component("YDR127W",211).
component("YHR068W",345).
component("YLR303W",479).
component("YGR012W",305).
component("YML082W",494).
component("YJR130C",417).
component("YDR035W",204).
component("YBR249C",158).
component("YLR180W",469).
component("YDR502C",238).
component("YOR274W",581).
component("YHR137W",352).
component("YGL202W",300).
component("YLR027C",453).
component("YKL106W",427).
component("YOL140W",562).
component("YGR019W",306).
component("YLR089C",461).
component("U64_",97).
component("U61_",94).
component("YJR148W",420).
component("YFL030W",272).
component("YOR184W",574).
component("YNR058W",545).
component("YIL116W",371).
component("YGL253W",303).
component("YFR053C",280).
component("YMR013C",501).
component("YMR205C",507).
component("YGR240C",321).
component("YOL016C",549).
component("YFR014C",275).
component("YCR036W",177).
component("YCL040W",170).
component("U15_",43).
component("YPL188W",605).
component("YJR049C",409).
component("YEL041W",245).
component("U96_",117).
component("YKL001C",423).
component("YDR236C",219).
component("YHL032C",332).
component("YDR531W",242).
component("U83_",113).
component("U82_",112).
component("U81_",111).
component("YMR208W",508).
component("YPL203W",606).
component("YOR061W",566).
component("YKL166C",433).
component("YJL164C",396).
component("YIL035C",364).
component("YHR205W",360).
component("YHR102W",351).
component("YGL019W",287).
component("YHR025W",338).
component("YOR347C",587).
component("YAL038W",122).
component("YNR012W",541).
component("YDR127W",212).
component("YDR147W",215).
component("YCR012W",172).
component("YER069W",259).
component("U76_",107).
component("YER170W",266).
component("YDR226W",218).
component("YKL067W",425).
component("YOL055C",552).
component("YDR454C",236).
component("YJR057W",410).
component("YOL061W",555).
component("YKL181W",434).
component("YHL011C",331).
component("YER099C",265).
component("YBL068W",133).
component("YOR143C",570).
component("YNL256W",532).
component("YLR328W",481).
component("YBR018C",137).
component("YLR328W",482).
component("U94_",116).
component("YBR029C",140).
component("YGL130W",294).
component("YDR530C",241).
component("YPR190C",632).
component("YPR187W",631).
component("YPR110C",626).
component("YPR010C",620).
component("YOR341W",586).
component("YOR340C",585).
component("YOR224C",579).
component("YOR210W",578).
component("YOR207C",576).
component("YOR151C",571).
component("YOR116C",568).
component("YOL005C",547).
component("YNR003C",539).
component("YNL248C",531).
component("YNL151C",527).
component("YNL113W",524).
component("YKL144C",429).
component("YJR063W",411).
component("YJL148W",395).
component("YJL140W",394).
component("YIL021W",363).
component("YHR143W-A",353).
component("YGL070C",292).
component("YFL036W",273).
component("YDR404C",232).
component("YDR156W",216).
component("YDR045C",205).
component("YDL150W",193).
component("YDL140C",191).
component("YBR154C",152).
component("YPR175W",630).
component("YPL167C",603).
component("YOR330C",583).
component("YOL115W",560).
component("YNL299W",537).
component("YNL262W",533).
component("YNL102W",522).
component("YJR043C",408).
component("YJR006W",404).
component("YJL090C",387).
component("YIL139C",374).
component("YEL055C",248).
component("YDR419W",234).
component("YDR121W",209).
component("YDL102W",189).
component("YCR014C",173).
component("YBR278W",162).
component("YBL035C",131).
component("YPR113W",627).
component("YPL148C",601).
component("YGR286C",328).
component("YHR189W",358).
component("YDR058C",207).
component("YDL086W",187).
component("YOL011W",548).
...
component("U77_",108).
component("YLR377C",486).
component("YPR073C",623).
component("YHR215W",361).
component("YDL024C",181).
component("YBR093C",146).
component("YBR092C",145).
component("YHR046C",342).
component("U9_",120).
component("YDL236W",200).
component("YPR073C",624).
component("YOR208W",577).
component("YNL053W",519).
component("YMR036C",502).
component("YIR026C",381).
component("YIL113W",370).
component("YFR028C",277).
component("YER075C",262).
component("YDL230W",199).
...
component("U25_",71).
component("U24_",70).
component("YHR044C",341).
component("YHR043C",340).
component("YOR360C",588).
component("YKR031C",442).
component("YPL206C",607).
component("YGL027C",289).
component("YLR286C",476).
component("YJR153W",421).
component("YJL221C",403).
component("YJL216C",401).
component("YIL172C",380).
component("YGR292W",330).
component("YGR287C",329).
component("YBR299W",166).
component("YOR190W",575).
component("YLR300W",478).
component("YGR282C",327).
component("YDR261C",222).
component("YDR400W",231).
component("YML035C",492).
component("YJL070C",386).
component("YBR284W",163).
component("U106_",23).
component("YER043C",253).
component("YNL045W",517).
component("YDR242W",220).
component("U53_",91).
component("YPR062W",622).
component("YMR120C",505).
component("YLR028C",455).
component("YHR144C",354).
component("YGR267C",326).
component("YBL033C",130).
component("YNL141W",525).
component("YLR245C",473).
component("YBR084W",143).
component("YJL126W",390).
component("U44_",84).
component("YDL100C",188).
component("U40_",82).
component("U39_",80).
component("YBR011C",136).
component("YHR201C",359).
component("YBR111C",147).
component("YBR252W",159).
component("YER005W",251).
component("YBL099W",134).
component("YLR231C",472).
component("YLR134W",463).
component("YLR044C",457).
component("YGR087C",311).
component("YDR380W",230).
component("YDL080C",185).
component("U98_",118).
component("YMR250W",509).
component("YOR128C",569).
component("U93_",115).
component("YKL211C",437) :- not remove_orf("YKL211C",437).
component("YKR097W",448).
component("YNL169C",528).
component("YEL046C",246).
component("YNR033W",543).
component("YKL211C",438) :- not remove_orf("YKL211C",438).
component("YER090W",438) :- not remove_orf("YER090W",438).
component("YER090W",264) :- not remove_orf("YER090W",264).
component("YDR127W",213).
component("YPL281C",618).
component("YOR393W",594).
component("YMR323W",513).
component("YHR174W",355).
component("YGR254W",323).
component("YPL262W",613).
component("YGL026C",288) :- not remove_orf("YGL026C",288).
component("YLR304C",480).
component("YJL200C",399).
component("YNL316C",538).
component("YPL212C",608).
component("YNL292W",536).
component("YGL063W",291).
component("YFL001W",269).
component("YPR002W",619).
component("YJR016C",406).
component("YCR053W",178).
component("YDR127W",214).
component("YGL148W",295).
component("YIL168W",379).
component("YIL167W",378).
component("YCL064C",171).
component("YLR359W",485).
component("YAL012W",121).
component("YJL121C",389).
component("YBR019C",138).
component("YDR007W",202) :- not remove_orf("YDR007W",202).
component("YOR095C",567).
component("YBR196C",155).
component("YGL001C",282).
component("YPL117C",600).
component("U14_",37).
component("YOL056W",553).
component("YKL152C",432).
component("YDL021W",179).
component("YPR060C",621).
component("YHR072W",346).
component("YPL097W",598).
component("YGR185C",316).
component("YGR264C",325).
component("YGR171C",314).
component("YPL104W",599).
component("YLL018C",449).
component("YHR020W",337).
component("YER087W",263).
component("YNL247W",530).
component("YOR168W",572).
component("YOL097C",558).
component("YDR268W",223).
component("YCR024C",174).
component("YHR019C",336).
component("YPL160W",602).
component("YLR382C",487).
component("YNL073W",521).
component("YOR335C",584).
component("YLR153C",465).
component("YAL054C",123).
component("YGR244C",322).
component("YIL145C",375).
component("YJL101C",388).
component("YOL049W",551).
component("YAR015W",125).
component("YER183C",268).
component("U90_",114).
component("YNR057C",544).
component("YGL234W",302).
component("YJR103W",415).
component("YBL039C",132).
component("YGR204W",319).
component("YBR084W",144).
component("YNL220W",529).
component("YDL141W",192).
component("YHR074W",347).
component("YGL062W",290).
component("YBR218C",156).
component("YPL231W",612).
component("YNR016C",542).
component("YKL182W",435).
component("YGR037C",308).
component("YPR138C",628).
component("YPL265W",614).
component("YPL036W",597).
component("YOR171C",573).
component("YOR011W",565).
component("YOL156W",564).
component("YOL103W",559).
component("YOL020W",550) :- not remove_orf("YOL020W",550).
component("YNR072W",546).
component("YNL270C",534).
component("YNL142W",526).
component("YMR011W",500).
component("YLR260W",475).
component("YLR100C",462).
component("YLR081W",460).
component("YLL061W",452).
component("YKR093W",447).
component("YKR053C",444).
component("YKR039W",443) :- not remove_orf("YKR039W",443).
component("YJR158W",422).
component("YJR077C",413).
component("YJL219W",402).
component("YJL214W",400).
component("YJL134W",393).
component("YJL129C",391).
component("YIL134W",373).
component("YHR096C",350).
component("YHR094C",349).
component("YHR092C",348).
component("YHL036W",333).
component("YGR121C",313).
component("YGR065C",310).
component("YGR055W",309).
component("YGL186C",297).
component("YGL077C",293).
component("YGL008C",283).
component("YFL055W",274).
component("YFL011W",270).
component("YER060W-A",257).
component("YER060W",256).
component("YER056C",255).
component("YER053C",254).
component("YEL069C",250).
component("YEL063C",249).
component("YEL017C-A",244).
component("YDR536W",243).
component("YDR508C",240).
component("YDR503C",239).
component("YDR497C",237).
component("YDR345C",227).
component("YDR343C",226).
component("YDR342C",225).
component("YDR297W",224).
component("YDR046C",206) :- not remove_orf("YDR046C",206).
component("YDL245C",201).
component("YCR032W",176).
component("YCR024C-A",175).
component("YCL025C",169).
component("YBR298C",165).
component("YBR291C",164).
component("YBR069C",142) :- not remove_orf("YBR069C",142).
component("YBR068C",141) :- not remove_orf("YBR068C",141).
component("YBR021W",139).
component("U7_",110).
component("U78_",109).
component("U75_",106).
component("U74_",105).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,229) :- not remove_reaction(3620,229).
catalyst(2110,279).
catalyst(2190,279).
catalyst(5550,418).
catalyst(5791,471).
...
catalyst(6112,569).
catalyst(2300,115).
catalyst(3600,437) :- not remove_reaction(3600,437).
catalyst(8000,448).
catalyst(6890,528).
catalyst(4560,246).
catalyst(2550,543).
...
catalyst(1890,264) :- not remove_reaction(1890,264).
catalyst(3630,264) :- not remove_reaction(3630,264).
catalyst(3740,213).
catalyst(8231,618).
catalyst(8232,618).
catalyst(8231,594).
...
catalyst(8051,613).
catalyst(8052,613).
catalyst(3590,288) :- not remove_reaction(3590,288).
catalyst(10910,288) :- not remove_reaction(10910,288).
catalyst(8181,480).
catalyst(8182,480).
catalyst(8181,399).
catalyst(8182,399).
...
catalyst(7751,138).
catalyst(7752,138).
catalyst(3610,202) :- not remove_reaction(3610,202).
catalyst(7921,567).
catalyst(7922,567).
catalyst(8341,155).
catalyst(8342,155).
...
catalyst(901,550) :- not remove_reaction(901,550).
catalyst(902,550) :- not remove_reaction(902,550).
catalyst(1210,546).
catalyst(931,534).
catalyst(932,534).
catalyst(371,526).
...
catalyst(640,447).
catalyst(6560,444).
catalyst(771,443) :- not remove_reaction(771,443).
catalyst(772,443) :- not remove_reaction(772,443).
catalyst(781,443) :- not remove_reaction(781,443).
catalyst(782,443) :- not remove_reaction(782,443).
catalyst(801,443) :- not remove_reaction(801,443).
catalyst(802,443) :- not remove_reaction(802,443).
catalyst(811,443) :- not remove_reaction(811,443).
catalyst(812,443) :- not remove_reaction(812,443).
catalyst(831,443) :- not remove_reaction(831,443).
catalyst(832,443) :- not remove_reaction(832,443).
catalyst(841,443) :- not remove_reaction(841,443).
catalyst(842,443) :- not remove_reaction(842,443).
catalyst(851,443) :- not remove_reaction(851,443).
catalyst(852,443) :- not remove_reaction(852,443).
catalyst(881,443) :- not remove_reaction(881,443).
catalyst(882,443) :- not remove_reaction(882,443).
catalyst(901,443) :- not remove_reaction(901,443).
catalyst(902,443) :- not remove_reaction(902,443).
catalyst(921,443) :- not remove_reaction(921,443).
catalyst(922,443) :- not remove_reaction(922,443).
catalyst(931,443) :- not remove_reaction(931,443).
catalyst(932,443) :- not remove_reaction(932,443).
catalyst(1191,443) :- not remove_reaction(1191,443).
catalyst(1192,443) :- not remove_reaction(1192,443).
catalyst(1210,422).
catalyst(1581,413).
catalyst(1582,413).
catalyst(1210,402).
...
catalyst(1210,225).
catalyst(6650,224).
catalyst(801,206) :- not remove_reaction(801,206).
catalyst(802,206) :- not remove_reaction(802,206).
catalyst(811,206) :- not remove_reaction(811,206).
catalyst(812,206) :- not remove_reaction(812,206).
catalyst(831,206) :- not remove_reaction(831,206).
catalyst(832,206) :- not remove_reaction(832,206).
catalyst(841,206) :- not remove_reaction(841,206).
catalyst(842,206) :- not remove_reaction(842,206).
catalyst(851,206) :- not remove_reaction(851,206).
catalyst(852,206) :- not remove_reaction(852,206).
catalyst(901,206) :- not remove_reaction(901,206).
catalyst(902,206) :- not remove_reaction(902,206).
catalyst(1210,201).
catalyst(431,176).
catalyst(432,176).
catalyst(220,175).
...
catalyst(1491,164).
catalyst(1492,164).
catalyst(771,142) :- not remove_reaction(771,142).
catalyst(772,142) :- not remove_reaction(772,142).
...
catalyst(851,142) :- not remove_reaction(851,142).
catalyst(852,142) :- not remove_reaction(852,142).
catalyst(901,142) :- not remove_reaction(901,142).
catalyst(902,142) :- not remove_reaction(902,142).
...
catalyst(851,141) :- not remove_reaction(851,141).
catalyst(852,141) :- not remove_reaction(852,141).
catalyst(901,141) :- not remove_reaction(901,141).
catalyst(902,141) :- not remove_reaction(902,141).
catalyst(620,139).
catalyst(6960,110).
catalyst(2840,109).
catalyst(2920,106).
