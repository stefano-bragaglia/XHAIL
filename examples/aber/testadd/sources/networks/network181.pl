...
component("YDR402C",419).
component("YGL055W",520).
component("YJR104C",714).
component("YHR008C",592).
component("YOR384W",1021).
component("YOR381W",1020).
component("YOL152W",967).
component("YLL051C",777).
component("YJL026W",666).
component("YIL066C",636).
component("YGR180C",563).
component("YER070W",471).
component("U37_",153).
component("U36_",152).
component("U35_",151).
component("YDL168W",350).
component("YDR158W",394).
component("YJR009C",698).
component("YJL052W",668).
component("YGR192C",566).
component("YBR006W",242).
component("YPL276W",1064).
component("YPL275W",1063).
component("YOR388C",1022).
component("YPL061W",1031).
component("YOR374W",1017).
component("YER073W",472).
component("YGL154C",529).
component("YBR115C",265).
component("U55_",170).
component("YER069W",469).
component("YOR323C",1007).
component("YMR170C",871).
component("YMR169C",870).
component("U2_",145).
...
component("YOR375C",1018).
component("YDL215C",357).
component("YAL062W",220).
component("U99_",213).
component("U100_",22).
component("YBR035C",251).
component("YMR189W",873).
component("YKR080W",768).
component("YER023W",455).
component("YPL023C",1026).
component("YGL125W",526).
component("YOR236W",1002).
component("YGR204W",570).
component("YBR084W",258).
component("YIR034C",662).
component("YLR142W",794).
component("U65_",179).
component("U63_",177).
component("U62_",176).
component("YOR356W",1015).
component("YHR068W",604).
component("YKL150W",742).
component("YIL043C",633).
component("YHR042W",598).
component("YOR221C",999).
component("YMR145C",867).
component("YML120C",848).
component("YKL192C",751).
component("YKL055C",732).
component("YER061C",465).
component("YDL085W",330).
component("YPL171C",1041).
component("YHR179W",620).
component("YMR145C",868).
component("YML120C",849).
component("YKL192C",752).
component("YDL085W",331).
component("YGR234W",573).
component("YFR030W",504).
component("YPL017C",1025).
component("YFL018C",492).
component("YPL091W",1033).
component("YDR353W",413).
component("YER042W",457).
component("YPR167C",1088).
component("YJR137C",718).
component("YNL052W",896).
component("YMR256C",882).
component("YLR395C",828).
component("YLR038C",783).
component("YIL111W",643).
component("YHR051W",602).
component("YGL191W",532).
component("YGL187C",531).
component("YDL067C",327).
component("Q0275",21).
component("Q0250",20).
component("Q0045",18).
component("YDR072C",378).
component("YPL266W",1059).
component("YPL273W",1061).
component("YLL062C",779).
component("YDR410C",422).
component("YKR069W",767).
component("YOL096C",958).
component("U47_",163).
component("YER091C",479).
component("YJR073C",709).
component("YGR157W",559).
component("YDR120C",384).
component("YML008C",834).
component("YOR074C",974).
component("YDL033C",321).
component("YOL096C",959).
component("YLR172C",798).
component("YLR058C",786).
component("YDR019C",365).
component("YBR176W",276).
component("YDR408C",421).
component("YMR120C",865).
component("YLR028C",781).
component("YBL013W",226).
component("YJL130C",680).
component("YJL088W",673).
component("YKL024C",727).
component("YPR074C",1079).
component("YBR117C",266).
component("YLR354C",823).
component("YGR043C",546).
component("YMR108W",863).
component("YCL009C",297).
component("YMR062C",858).
component("YNL071W",898).
component("YNR008W",930).
component("YIL160C",653).
component("YNR019W",933).
component("YCR048W",314).
component("U48_",164).
component("YNL277W",921).
component("YMR062C",859).
component("YDR232W",399).
component("YPL231W",1053).
component("YER061C",466).
component("U86_",201).
component("YPL001W",1024).
component("YDL052C",325).
component("U8_",205).
component("YDR148C",392).
component("YAR035W",222).
component("YOR377W",1019).
component("YGR177C",562).
component("YPL231W",1054).
component("YPL028W",1027).
component("YLR299W",810).
component("YGL017W",515).
component("YPR001W",1066).
component("YNR001C",928).
component("YCR005C",306).
component("YML126C",850).
component("YNL104C",901).
component("YDL182W",354).
component("YDL131W",340).
component("YPR160W",1087).
component("YOR321W",1006).
component("YJR143C",720).
component("YGR199W",568).
component("YDR307W",409).
component("YDL095W",335).
component("YDL093W",334).
component("YAL023C",216).
component("YLR258W",807).
component("YFR015C",500).
component("YPL227C",1050).
component("YOR103C",978).
component("YOR085W",975).
component("YMR149W",869).
component("YML019W",836).
component("YJL002C",664).
component("YEL002C",437).
component("YDL232W",359).
component("YCL043C",302).
component("YNL029C",893).
component("YIL085C",639).
component("YNL192W",909).
component("YBR038W",253).
component("YBR023C",249).
component("YEL011W",438).
component("YMR306W",890).
component("YLR342W",821).
component("YGR032W",544).
component("YPR183W",1091).
component("YBR248C",285).
component("YLR209C",801).
component("U104_",25).
component("U103_",24).
component("YMR271C",883).
component("YML106W",847).
component("YOR209C",997).
component("YMR300C",887).
component("YER055C",461).
component("YDR354W",414) :- not remove_orf("YDR354W",414).
component("YFR047C",506).
component("YJR133W",717).
component("U22_",137).
component("YLR209C",802).
component("YML022W",837).
component("YDR441C",425).
component("YDR399W",417).
component("YHR128W",613).
component("YPR176C",1090).
component("YPL172C",1042).
component("YNR041C",937).
component("YMR101C",861).
component("YDL090C",333).
component("YBR003W",241).
component("YBR002C",240).
component("YJL167W",689).
component("YJL167W",690).
component("YNL256W",914).
component("YPR069C",1076).
component("YDR127W",387).
component("YHR190W",623).
component("YLR146C",795).
component("YPL214C",1048).
component("YHR068W",605).
component("YLR303W",812).
component("YGR012W",542).
component("YML082W",845).
component("YJR130C",716).
component("YLR303W",813).
component("YDR035W",367).
component("YBR249C",286).
component("YLR180W",800).
component("YDR502C",429).
component("YOR274W",1003).
component("YOL143C",966).
component("YBR256C",288).
component("YHR137W",614).
component("YGL202W",533).
component("YLR027C",780).
component("YKL106W",736).
component("YOL140W",965).
...
component("YHR208W",626).
component("YFL030W",494).
component("YOR184W",990).
component("YNR058W",941).
component("YIL116W",645).
component("YGL253W",539).
component("YFR053C",507).
component("YOL136C",964).
component("YIL107C",642).
component("YMR013C",854).
component("YMR205C",875).
component("YGR240C",574).
component("YOL016C",945).
component("YFR014C",499).
...
component("U15_",73).
component("YPL188W",1044).
component("YJR049C",704).
component("YEL041W",443).
component("U96_",211).
component("YKL001C",725).
component("YDR236C",400).
component("YML070W",843).
component("YFL053W",496).
component("YHL032C",588).
component("YDR531W",434).
component("U83_",198).
component("U82_",197).
component("U81_",196).
component("YMR208W",876).
component("YPL203W",1045).
component("YOR061W",971).
component("YKL166C",744).
component("YJL164C",687).
component("YIL035C",632).
component("YHR205W",625).
component("YHR102W",611).
component("YGL019W",516).
component("YHR025W",597).
component("YOR347C",1013).
component("YAL038W",218).
component("YNR012W",931).
component("YPR121W",1084).
component("YPL258C",1056).
component("YOL055C",950).
component("YPL214C",1049).
component("U1_",113).
component("YDR009W",364).
component("YNL267W",918).
component("YLR305C",815).
...
component("U17_",90).
component("U76_",190).
component("YMR220W",878).
component("YER170W",487).
component("YDR226W",398).
component("YKL067W",734).
component("YOL055C",951).
component("YDR454C",426).
component("YJR057W",706).
component("YOL061W",955).
...
component("YLR328W",820).
component("YKR002W",760).
component("YDL045C",323).
component("U80_",195).
component("YDL103C",338).
component("U94_",210).
component("YJR010W",699).
component("YBR029C",250).
component("YCL050C",303).
component("YGL130W",527).
component("YDR530C",433).
component("YCL050C",304).
component("YPR190C",1093).
component("YPR187W",1092).
component("YPR110C",1082).
component("YPR010C",1069).
component("YOR341W",1012).
component("YOR340C",1011).
component("YOR224C",1001).
component("YOR210W",998).
component("YOR207C",995).
component("YOR151C",987).
component("YOR116C",979).
component("YOL005C",943).
component("YNR003C",929).
...
component("YDR404C",420).
component("YDR156W",393).
component("YDR045C",370).
component("YDL150W",348).
component("YDL140C",342).
component("YBR154C",274).
component("YPR175W",1089).
component("YPL167C",1040).
component("YOR330C",1008).
component("YOL115W",962).
component("YNL299W",925).
component("YNL262W",917).
component("YNL102W",900).
component("YJR043C",703).
component("YJR006W",697).
component("YJL090C",674).
component("YIL139C",648).
component("YEL055C",447).
component("YDR419W",423).
component("YDR121W",385).
component("YDL102W",337).
...
component("U25_",140).
component("U24_",139).
component("YHR044C",600).
component("YHR043C",599).
component("YOL064C",956).
component("YPL268W",1060).
component("YOR360C",1016).
component("YGL248W",538).
component("YKR031C",763).
component("YPL206C",1046).
component("YGL027C",518).
component("YLR286C",809).
component("YJR153W",722).
...
component("YPR026W",1070).
component("YDR001C",362).
component("YBR001C",239).
component("YIR019C",658).
component("YIL099W",641).
component("YDL037C",322).
component("YOR190W",992).
component("YLR300W",811).
component("YGR282C",582).
component("YDR261C",403).
component("YDR400W",418).
component("U23_",138).
...
component("YNL045W",895).
component("YGL037C",519).
component("U43_",159).
component("U42_",158).
component("YMR293C",886).
component("YDR242W",401).
component("YLR308W",818).
component("YLR307W",817).
component("YBR208C",279).
component("YMR281W",885).
component("U53_",168).
component("YIR032C",661).
component("YIR029W",660).
component("YPR062W",1075).
component("YMR120C",866).
...
component("U44_",160).
component("YDL100C",336).
component("U87_",202).
component("U40_",156).
component("U39_",154).
component("YBR011C",243).
component("YHR201C",624).
component("YBR111C",264).
component("YBR252W",287).
component("YEL042W",444).
component("YPR080W",1080).
component("YOR187W",991).
component("YOR133W",983).
component("YLR069C",788).
component("YKR084C",769).
component("YKL173W",745).
component("YJL102W",676).
component("YDR385W",416).
component("YBR118W",267).
component("YER005W",452).
component("YLL001W",773).
component("YIL048W",634).
component("YER166W",486).
component("YDR093W",382).
component("YAL026C",217).
component("YBL099W",238).
component("U60_",174).
component("YLR231C",803).
component("U88_",203).
component("YDR538W",436).
component("YLR134W",792).
component("YLR044C",784).
component("YGR087C",551).
component("YDR380W",415).
component("YDL080C",329).
component("U98_",212).
component("YMR250W",881).
component("YKL184W",750).
component("YOR128C",981).
component("YEL021W",441).
component("YNR043W",938).
component("U93_",209).
component("YDR047W",372).
component("U54_",169).
component("YKL211C",756) :- not remove_orf("YKL211C",756).
component("YKR097W",771).
component("YOL052C",949).
...
component("YNR033W",935).
component("YPR006C",1068).
...
component("YPL281C",1065).
component("YOR393W",1023).
component("YMR323W",891).
component("YHR174W",619).
component("YGR254W",577).
component("YOR202W",994).
component("YPL262W",1057).
component("YGL026C",517) :- not remove_orf("YGL026C",517).
component("YGR155W",558).
component("YLR304C",814).
component("YJL200C",692).
component("YGL009C",512).
component("YNL316C",926).
component("YKL182W",748).
component("YPL212C",1047).
component("YNL292W",924).
component("YGL063W",523).
component("YFL001W",490).
component("YOR278W",1004).
component("YPR002W",1067).
...
component("YLR359W",825).
component("YAL012W",215).
component("YML004C",833).
...
component("U59_",172).
component("YDR050C",373).
component("YIL020C",630).
component("YDR007W",363) :- not remove_orf("YDR007W",363).
component("YOR095C",976).
component("YER003C",451).
component("YBR196C",278).
component("YGL001C",510).
component("YPL117C",1036).
component("U14_",65).
component("YOL056W",952).
component("YKL152C",743).
component("YDL021W",318).
component("YMR105C",862).
component("YKL127W",738).
component("YEL058W",448).
component("YPR060C",1074).
component("YHR072W",606).
component("YJL153C",685).
component("YPL097W",1034).
component("YGR185C",565).
component("YGR264C",580).
component("YGR171C",561).
component("YHR011W",593).
component("YDR023W",366).
component("YPL104W",1035).
component("YLL018C",774).
component("YPR081C",1081).
component("YBR121C",268).
component("YHR020W",596).
component("YER087W",476).
component("YNL247W",912).
component("YOL033W",947).
component("YGL245W",537).
component("YOR168W",988).
component("YOL097C",960).
component("YDR268W",404).
component("YPR047W",1073).
component("YLR060W",787).
component("YFL022C",493).
component("YPR033C",1071).
component("YHR019C",594).
component("YCR024C",309).
component("YHR019C",595).
component("YKL194C",753).
component("YIL078W",638).
component("YPL160W",1039).
component("YLR382C",827).
component("YPL040C",1029).
component("YBL076C",237).
component("YNL073W",899).
component("YDR037W",368).
component("YOR335C",1009).
component("YGR094W",553).
component("YLR153C",796).
component("YAL054C",219).
component("YOR317W",1005).
component("YMR246W",880).
component("YIL009W",629).
component("YER015W",454).
component("YOR142W",985).
component("YGR244C",575).
component("YPR035W",1072).
component("YIL145C",649).
component("U89_",204).
component("YOR339C",1010).
component("YMR022W",855).
component("YLR306W",816).
component("YKL210W",755).
component("YGR133W",557).
component("YGL058W",521).
component("YER100W",482).
component("YEL012W",439).
component("YDR177W",395).
component("YDR092W",381).
component("YDR059C",376).
component("YDR054C",374).
component("YDL064W",326).
component("YBR082C",257).
component("YJL101C",675).
component("YOL049W",948).
component("U92_",208).
...
component("YNR016C",932).
component("YKL182W",749).
component("YGR037C",545).
component("YJL087C",672).
component("YPR138C",1085).
component("YPL274W",1062).
component("YPL265W",1058).
component("YPL134C",1037).
component("YPL057C",1030).
component("YPL036W",1028).
component("YOR348C",1014).
component("YOR222W",1000).
component("YOR192C",993).
component("YOR171C",989).
component("YOR130C",982).
component("YOR100C",977).
component("YOR071C",973).
component("YOR011W",969).
component("YOL156W",968).
component("YOL103W",961).
component("YOL020W",946) :- not remove_orf("YOL020W",946).
component("YNR072W",942).
component("YNR056C",939).
component("YNL318C",927).
component("YNL270C",920).
component("YNL268W",919).
component("YNL142W",905).
component("YMR272C",884).
component("YMR202W",874).
component("YMR056C",857).
component("YMR011W",853).
component("YLR348C",822).
...
component("YEL017C-A",440).
component("YDR536W",435).
component("YDR508C",431).
component("YDR503C",430).
component("YDR497C",428).
component("YDR345C",412).
component("YDR343C",411).
component("YDR342C",410).
component("YDR297W",407).
component("YDR284C",405).
component("YDR046C",371) :- not remove_orf("YDR046C",371).
component("YDL245C",361).
...
component("YBR069C",256) :- not remove_orf("YBR069C",256).
component("YBR068C",255) :- not remove_orf("YBR068C",255).
component("YBR036C",252).
component("YBR021W",248).
...
catalyst(6160,887).
catalyst(3870,461).
catalyst(3620,414) :- not remove_reaction(3620,414).
catalyst(2110,506).
catalyst(2190,506).
catalyst(5550,717).
catalyst(5301,137).
...
catalyst(8282,373).
catalyst(3840,630).
catalyst(3610,363) :- not remove_reaction(3610,363).
catalyst(7921,976).
catalyst(7922,976).
catalyst(7841,451).
catalyst(7842,451).
...
catalyst(1210,968).
catalyst(1160,961).
catalyst(801,946) :- not remove_reaction(801,946).
catalyst(802,946) :- not remove_reaction(802,946).
catalyst(811,946) :- not remove_reaction(811,946).
catalyst(812,946) :- not remove_reaction(812,946).
catalyst(831,946) :- not remove_reaction(831,946).
catalyst(832,946) :- not remove_reaction(832,946).
catalyst(901,946) :- not remove_reaction(901,946).
catalyst(902,946) :- not remove_reaction(902,946).
catalyst(1180,942).
catalyst(1210,942).
catalyst(700,939).
catalyst(1200,927).
...
catalyst(851,764) :- not remove_reaction(851,764).
catalyst(852,764) :- not remove_reaction(852,764).
...
catalyst(931,764) :- not remove_reaction(931,764).
catalyst(932,764) :- not remove_reaction(932,764).
...
catalyst(6650,407).
catalyst(6690,405).
catalyst(791,371) :- not remove_reaction(791,371).
catalyst(792,371) :- not remove_reaction(792,371).
...
catalyst(1512,293).
catalyst(1590,261).
catalyst(771,256) :- not remove_reaction(771,256).
catalyst(772,256) :- not remove_reaction(772,256).
