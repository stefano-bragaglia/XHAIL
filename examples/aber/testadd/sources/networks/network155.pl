...
component("YNL280C",787).
component("YLR056W",674).
component("YGR060W",466).
component("YGL012W",436).
component("YKR009C",651).
component("YOL086C",818).
component("YMR303C",759).
component("YMR083W",737).
component("YGL256W",459).
component("YDL168W",301).
component("YBR145W",231).
component("YPL231W",894).
component("YBR265W",249).
component("U46_",140).
component("YBR149W",232).
component("YBR149W",233).
component("YGL001C",432).
component("YIL094C",547).
component("YHR063C",513).
component("U45_",139).
component("YML056C",722).
component("YLR432W",711).
component("YHR216W",536).
component("YAR075W",195).
component("YAR073W",194).
component("YDR127W",330).
component("YJR139C",617).
component("YML075C",725).
component("YLR450W",714).
component("YOL126C",824).
component("YKL085W",628).
component("YDL078C",283).
component("YKL029C",624).
component("YNL037C",764).
component("YNL009W",762).
component("YLR174W",688).
component("YHR183W",529).
component("YGR256W",491).
component("YNL241C",779).
component("YOL059W",815).
component("YDL022W",275).
component("YCL018W",257).
component("YLR355C",706).
component("YIL074C",544).
component("YER081W",404).
component("YML054C",721).
component("YDL174C",305).
component("YML086C",727).
component("YIL155C",556).
component("YEL024W",378).
component("YKR066C",656).
component("YGR088W",470).
component("YDR256C",344).
component("YKL026C",623).
component("YIR037W",566).
component("YBR244W",244).
component("YJR078W",609).
component("U58_",149).
component("YJR025C",600).
component("U107_",27).
component("YGR255C",490).
component("U108_",28).
component("YHR007C",502).
component("YDR402C",359).
component("YGL055W",443).
component("YJR104C",612).
component("YHR008C",503).
component("YOR384W",867).
component("YOR381W",866).
component("YOL152W",827).
component("YLL051C",666).
component("YJL026W",568).
component("YIL066C",543).
component("YGR180C",478).
component("YER070W",401).
component("U37_",133).
component("U36_",132).
component("U35_",131).
component("YDL168W",302).
component("YDR158W",338).
component("YJR009C",596).
component("YJL052W",570).
component("YGR192C",480).
component("YBR006W",208).
component("YPL276W",903).
component("YPL275W",902).
component("YOR388C",868).
component("YPL061W",876).
component("YOR374W",864).
component("YER073W",402).
component("YGL154C",451).
component("YBR115C",226).
component("U55_",148).
component("YER069W",399).
component("YOR323C",856).
component("YMR170C",747).
component("YMR169C",746).
component("YER178W",414).
component("YBR221C",242).
component("YIL125W",552).
component("U52_",145).
component("YBR166C",236).
component("YNL280C",788).
component("YGL012W",437).
component("YKL182W",639).
component("YKL216W",649).
component("YDR044W",320).
component("YER014W",388).
component("YKR009C",652).
component("YIL160C",557).
component("YGL205W",456).
component("YMR118C",741).
component("YLR164W",686).
component("YLL041C",664).
component("YKL148C",633).
component("YKL141W",631).
component("YJL045W",569).
component("YDR178W",339).
component("YJR051W",603).
component("YEL047C",381).
component("YDL171C",303).
component("YDL171C",304).
component("YOR375C",865).
component("YDL215C",309).
component("YAL062W",191).
component("U99_",185).
component("U100_",21).
component("YBR035C",216).
component("YMR189W",749).
component("YKR080W",658).
component("YER023W",390).
component("YPL023C",872).
component("YGL125W",448).
component("YOR236W",853).
component("YGR204W",483).
component("YIR034C",565).
component("YLR142W",683).
component("U65_",156).
component("U63_",154).
component("U62_",153).
component("YHR068W",514).
component("YKL150W",634).
component("YIL043C",541).
component("YHR042W",508).
component("YOR221C",850).
component("YMR145C",744).
component("YML120C",728).
component("YKL192C",643).
component("YKL055C",626).
component("YER061C",397).
component("YDL085W",285).
component("YPL171C",884).
component("YHR179W",528).
component("YMR145C",745).
component("YML120C",729).
component("YKL192C",644).
component("YDL085W",286).
component("YGR234W",486).
component("YFR030W",428).
component("YPL017C",871).
component("YFL018C",418).
component("YDR353W",354).
component("YPR167C",922).
component("YJR137C",616).
component("YNL052W",766).
component("YMR256C",756).
component("YLR395C",710).
component("YLR038C",672).
component("YIL111W",549).
component("YHR051W",512).
component("YGL191W",454).
component("YGL187C",453).
component("YDL067C",282).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",325).
component("YPL266W",900).
component("YPL273W",901).
component("YLL062C",668).
component("YDR410C",362).
component("YKR069W",657).
component("YOL096C",819).
component("U47_",141).
component("YER091C",409).
component("YJR073C",607).
component("YGR157W",475).
component("YDR120C",328).
component("YML008C",716).
component("YOR074C",832).
component("YDL033C",277).
component("YOL096C",820).
component("YLR172C",687).
component("YLR058C",675).
component("YDR019C",316).
component("YBR176W",237).
component("YDR408C",361).
component("YMR120C",742).
component("YLR028C",670).
component("YBL013W",196).
component("YJL130C",581).
component("YJL088W",574).
component("YKL024C",622).
component("YPR074C",916).
component("YBR117C",227).
component("YMR108W",740).
component("YCL009C",256).
component("YNL071W",768).
component("YNR008W",794).
component("YIL160C",558).
component("YNR019W",797).
component("YCR048W",271).
component("U48_",142).
component("YMR062C",736).
component("YDR232W",341).
component("YPL231W",895).
component("YER061C",398).
component("YPL001W",870).
component("YDL052C",281).
component("U8_",179).
component("YDR148C",336).
component("YPL231W",896).
component("YPL028W",873).
component("YLR299W",698).
component("YGL017W",438).
component("YCR005C",263).
component("YML126C",730).
component("YNL104C",771).
component("YDL182W",306).
component("YDL131W",292).
component("YDR307W",350).
component("YLR258W",695).
component("YFR015C",425).
component("YPL227C",892).
component("YNL029C",763).
component("YIL085C",546).
component("YNL192W",777).
component("YBR038W",218).
component("YBR023C",214).
component("YMR306W",760).
component("YLR342W",704).
component("YGR032W",463).
component("YPR183W",925).
component("YBR248C",245).
component("YLR209C",690).
component("U104_",24).
component("U103_",23).
component("YDR354W",355) :- not remove_orf("YDR354W",355).
component("YFR047C",429).
component("YJR133W",615).
component("YLR209C",691).
component("YML022W",718).
component("YDR441C",365).
component("YHR128W",523).
component("YPR176C",924).
component("YPL172C",885).
component("YNR041C",800).
component("YMR101C",738).
component("YDL090C",288).
component("YBR003W",207).
component("YBR002C",206).
component("YJL167W",588).
component("YJL167W",589).
component("YNL256W",782).
component("YPR069C",913).
component("YDR127W",331).
component("YHR190W",531).
component("YLR146C",684).
component("YPL214C",891).
component("YHR068W",515).
component("YLR303W",700).
component("YGR012W",461).
component("YML082W",726).
component("YJR130C",614).
component("YDR035W",318).
component("YBR249C",246).
component("YLR180W",689).
component("YDR502C",369).
component("YOR274W",854).
component("YOL143C",826).
component("YBR256C",248).
component("YHR137W",524).
component("YGL202W",455).
component("YLR027C",669).
component("YKL106W",629).
component("YOL140W",825).
component("YLR438W",713).
component("YGR019W",462).
component("YLR089C",679).
component("U64_",155).
component("U61_",152).
component("U51_",144).
component("YJR148W",618).
component("YHR208W",534).
component("YFL030W",420).
component("YOR184W",843).
component("YNR058W",804).
component("YIL116W",551).
component("YGL253W",458).
component("YFR053C",430).
component("YMR013C",734).
component("YMR205C",751).
component("YGR240C",487).
component("YOL016C",808).
component("YFR014C",424).
component("YLR240W",693).
component("YKL203C",646).
component("YJR066W",606).
component("YCR036W",270).
component("YGR194C",481).
component("YCL040W",259).
component("U15_",67).
component("YPL188W",887).
component("YJR049C",602).
component("YEL041W",379).
component("U96_",183).
component("YKL001C",621).
component("YDR236C",342).
component("YML070W",724).
component("YFL053W",422).
component("YHL032C",500).
component("YDR531W",373).
component("U83_",174).
component("U82_",173).
component("U81_",172).
component("YMR208W",752).
component("YPL203W",888).
component("YOR061W",831).
component("YKL166C",636).
component("YJL164C",587).
component("YIL035C",540).
component("YHR205W",533).
component("YHR102W",521).
component("YGL019W",439).
component("YHR025W",507).
component("YOR347C",861).
component("YAL038W",189).
component("YNR012W",795).
component("YDR009W",315).
component("YDR127W",332).
component("U21_",112).
component("YDR147W",335).
component("YDR300C",349).
component("YCR012W",264).
component("YER069W",400).
component("U19_",102).
component("U18_",92).
component("U17_",82).
component("U76_",166).
component("YER170W",413).
component("YDR226W",340).
component("YKL067W",627).
component("YOL055C",812).
component("YDR454C",366).
component("YJR057W",604).
component("YOL061W",816).
component("YKL181W",638).
component("YHL011C",498).
component("YER099C",410).
component("YBL068W",203).
component("YOR143C",839).
component("YNL256W",783).
component("YLR328W",702).
component("YBR018C",210).
component("YBR018C",211).
component("YGR007W",460).
component("YGR202C",482).
component("YLR328W",703).
component("YDL045C",279).
component("U80_",171).
component("YDL103C",291).
component("U94_",182).
component("YJR010W",597).
component("YBR029C",215).
component("YCL050C",260).
component("YGL130W",449).
component("YDR530C",372).
component("YCL050C",261).
component("YPR190C",927).
component("YPR187W",926).
component("YPR110C",919).
component("YPR010C",906).
component("YOR341W",860).
component("YOR340C",859).
component("YOR224C",852).
component("YOR210W",849).
component("YOR207C",847).
component("YOR151C",840).
component("YOR116C",834).
component("YOL005C",806).
component("YNR003C",793).
component("YNL248C",781).
component("YNL151C",775).
component("YNL113W",772).
component("YKL144C",632).
component("YJR063W",605).
component("YJL148W",585).
component("YJL140W",584).
component("YIL021W",539).
component("YHR143W-A",525).
component("YGL070C",446).
component("YFL036W",421).
component("YDR404C",360).
component("YDR156W",337).
component("YDR045C",321).
component("YDL150W",300).
component("YDL140C",294).
component("YBR154C",235).
component("YPR175W",923).
component("YPL167C",883).
component("YOR330C",857).
component("YOL115W",823).
component("YNL299W",790).
component("YNL262W",785).
component("YNL102W",770).
component("YJR043C",601).
component("YJR006W",595).
component("YJL090C",575).
component("YIL139C",554).
component("YEL055C",382).
component("YDR419W",363).
component("YDR121W",329).
component("YDL102W",290).
component("YCR014C",265).
component("YBR278W",251).
component("YBL035C",199).
component("YKL035W",625).
component("YHL012W",499).
component("YHR123W",522).
component("YPR113W",920).
component("YBR243C",243).
component("YDL142C",299).
component("YPL148C",881).
component("YER026C",391).
component("YGR286C",495).
component("YJL068C",571).
component("YHR189W",530).
component("YDR058C",324).
component("YDL086W",287).
component("YOL011W",807).
component("YMR008C",732).
component("YMR006C",731).
component("U105_",25).
component("YBL015W",197).
component("YJL068C",572).
component("YJR019C",599).
component("YOR040W",830).
component("U77_",167).
component("YDR481C",367).
component("YLR377C",708).
component("YFR025C",426).
component("YPL179W",886).
component("YNR032W",798).
component("YML057W",723).
component("YML016C",717).
component("YLR433C",712).
component("YGR123C",473).
component("YER133W",411).
component("YER089C",407).
component("YDR436W",364).
component("YDR075W",326).
component("YDL188C",307).
component("YDL134C",293).
component("YDL047W",280).
component("YDL006W",273).
component("YBR125C",230).
component("YBL056W",202).
component("YPR073C",914).
component("YHR215W",535).
component("YDL024C",276).
component("YBR093C",224).
component("YBR092C",223).
component("YAR071W",193).
component("YHR046C",511).
component("U9_",186).
component("YPL228W",893).
component("YMR180C",748).
component("YDL236W",311).
component("YJL155C",586).
component("YPR073C",915).
component("YOR208W",848).
component("YNL053W",767).
component("YMR036C",735).
component("YIR026C",564).
component("YIL113W",550).
component("YFR028C",427).
component("YER075C",403).
component("YDL230W",310).
...
component("U25_",121).
component("U24_",120).
component("YHR044C",510).
component("YHR043C",509).
component("YOL064C",817).
component("YOR360C",863).
component("YKR031C",653).
component("YPL206C",889).
component("YGL027C",441).
component("YLR286C",697).
component("YJR153W",619).
component("YJL221C",594).
component("YJL216C",592).
component("YIL172C",562).
component("YGR292W",497).
component("YGR287C",496).
component("YBR299W",255).
component("YBR184W",238).
component("YIL162W",559).
component("YPR026W",907).
component("YDR001C",313).
component("YBR001C",205).
component("YIR019C",563).
component("YIL099W",548).
component("YDL037C",278).
component("YOR190W",845).
component("YLR300W",699).
component("YGR282C",494).
component("YDR261C",345).
component("YDR400W",358).
component("U23_",119).
component("YML035C",719).
component("YJL070C",573).
component("YBR284W",252).
component("U106_",26).
component("U102_",22).
component("YER043C",392).
component("YNL045W",765).
component("YGL037C",442).
component("YDR242W",343).
component("YBR208C",240).
component("YMR281W",758).
component("U53_",146).
component("YPR062W",912).
component("YMR120C",743).
component("YLR028C",671).
component("YHR144C",526).
component("YGR267C",493).
component("YBL033C",198).
component("YBR153W",234).
component("YNL141W",773).
component("YLR245C",694).
component("YML035C",720).
component("YGR204W",484).
component("YBR084W",221).
component("YJL126W",579).
component("U44_",138).
component("YDL100C",289).
component("U87_",176).
component("U40_",136).
component("U39_",134).
component("YBR011C",209).
component("YHR201C",532).
component("YBR111C",225).
component("YBR252W",247).
component("YPR080W",917).
component("YOR187W",844).
component("YOR133W",837).
component("YLR069C",677).
component("YKR084C",659).
component("YKL173W",637).
component("YJL102W",577).
component("YDR385W",357).
component("YBR118W",228).
component("YER005W",387).
component("YLL001W",662).
component("YIL048W",542).
component("YER166W",412).
component("YDR093W",327).
component("YAL026C",188).
component("YBL099W",204).
component("U60_",151).
component("YLR231C",692).
component("U88_",177).
component("YDR538W",375).
component("YLR134W",681).
component("YLR044C",673).
component("YGR087C",469).
component("YDR380W",356).
component("YDL080C",284).
component("U98_",184).
component("YMR250W",755).
component("YKL184W",642).
component("YOR128C",835).
component("YEL021W",377).
component("YNR043W",801).
component("U93_",181).
component("U54_",147).
component("YKL211C",647) :- not remove_orf("YKL211C",647).
component("YKR097W",661).
component("YOL052C",811).
component("YNL169C",776).
component("YGR170W",476).
component("YNL256W",784).
component("YDR294C",347).
component("YEL046C",380).
component("YNR033W",799).
component("YKL211C",648) :- not remove_orf("YKL211C",648).
component("YER090W",648) :- not remove_orf("YER090W",648).
component("YER090W",408) :- not remove_orf("YER090W",408).
component("YDR127W",333).
component("YPL281C",904).
component("YOR393W",869).
component("YMR323W",761).
component("YHR174W",527).
component("YGR254W",489).
component("YOR202W",846).
component("YPL262W",898).
component("YGL026C",440) :- not remove_orf("YGL026C",440).
component("YGR155W",474).
component("YLR304C",701).
component("YJL200C",590).
component("YGL009C",435).
component("YNL316C",791).
component("YKL182W",640).
component("YPL212C",890).
component("YNL292W",789).
component("YGL063W",445).
component("YFL001W",416).
component("YPR002W",905).
component("YJR016C",598).
component("YCR053W",272).
component("YDR127W",334).
component("YGL148W",450).
component("YIL168W",561).
component("YIL167W",560).
component("YCL064C",262).
component("YER086W",405).
component("YLR359W",707).
component("YAL012W",187).
component("YML004C",715).
component("YFR055W",431).
component("YJL005W",567).
component("YJL121C",578).
component("YBR019C",212).
component("YDR050C",323).
component("YIL020C",538).
component("YDR007W",314) :- not remove_orf("YDR007W",314).
component("YOR095C",833).
component("YER003C",386).
component("YBR196C",239).
component("YGL001C",433).
component("YPL117C",879).
component("U14_",59).
component("YOL056W",813).
component("YKL152C",635).
component("YDL021W",274).
component("YMR105C",739).
component("YKL127W",630).
component("YEL058W",383).
component("YPR060C",911).
component("YHR072W",516).
component("YPL097W",877).
component("YGR185C",479).
component("YGR264C",492).
component("YGR171C",477).
component("YHR011W",504).
component("YDR023W",317).
component("YPL104W",878).
component("YLL018C",663).
component("YPR081C",918).
component("YBR121C",229).
component("YHR020W",506).
component("YER087W",406).
component("YNL247W",780).
component("YOR168W",841).
component("YOL097C",821).
component("YDR268W",346).
component("YPR047W",910).
component("YLR060W",676).
component("YFL022C",419).
component("YPR033C",908).
component("YCR024C",266).
component("YHR019C",505).
component("YKL194C",645).
component("YIL078W",545).
component("YPL160W",882).
component("YLR382C",709).
component("YNL073W",769).
component("YDR037W",319).
component("YOR335C",858).
component("YGR094W",471).
component("YLR153C",685).
component("YAL054C",190).
component("YOR317W",855).
component("YMR246W",754).
component("YIL009W",537).
component("YER015W",389).
component("YOR142W",838).
component("YGR244C",488).
component("YPR035W",909).
component("YIL145C",555).
component("U89_",178).
component("YJL101C",576).
component("YOL049W",810).
component("YAR015W",192).
component("YER183C",415).
component("U90_",180).
component("YNR057C",803).
component("YDL141W",295).
component("YDL141W",296).
component("YGL234W",457).
component("YDL141W",297).
component("YJR103W",611).
component("YBL039C",200).
component("YGR204W",485).
component("YBR084W",222).
component("YNL220W",778).
component("YOL058W",814).
component("YDL141W",298).
component("YHR074W",517).
component("YMR217W",753).
component("YGR061C",467).
component("YJR109C",613).
component("YJL130C",582).
component("YGL062W",444).
component("YBR218C",241).
component("YPL231W",897).
component("YNR016C",796).
component("YKL182W",641).
component("YGR037C",464).
component("YPR138C",921).
component("YPL265W",899).
component("YPL134C",880).
component("YPL057C",875).
component("YPL036W",874).
component("YOR348C",862).
component("YOR222W",851).
component("YOR171C",842).
component("YOR130C",836).
component("YOR011W",829).
component("YOL156W",828).
component("YOL103W",822).
component("YOL020W",809) :- not remove_orf("YOL020W",809).
component("YNR072W",805).
component("YNR056C",802).
component("YNL318C",792).
component("YNL270C",786).
component("YNL142W",774).
component("YMR272C",757).
component("YMR202W",750).
component("YMR011W",733).
component("YLR348C",705).
component("YLR260W",696).
component("YLR138W",682).
component("YLR100C",680).
component("YLR081W",678).
component("YLL061W",667).
component("YLL043W",665).
component("YKR093W",660).
component("YKR053C",655).
component("YKR039W",654) :- not remove_orf("YKR039W",654).
component("YKL217W",650).
component("YJR158W",620).
component("YJR095W",610).
component("YJR077C",608).
component("YJL219W",593).
component("YJL214W",591).
component("YJL134W",583).
component("YJL129C",580).
component("YIL134W",553).
component("YHR096C",520).
component("YHR094C",519).
component("YHR092C",518).
component("YHL036W",501).
component("YGR121C",472).
component("YGR065C",468).
component("YGR055W",465).
component("YGL186C",452).
component("YGL077C",447).
component("YGL008C",434).
component("YFL055W",423).
component("YFL011W",417).
component("YER060W-A",396).
component("YER060W",395).
component("YER056C",394).
component("YER053C",393).
component("YEL069C",385).
component("YEL063C",384).
component("YEL017C-A",376).
component("YDR536W",374).
component("YDR508C",371).
component("YDR503C",370).
component("YDR497C",368).
component("YDR345C",353).
component("YDR343C",352).
component("YDR342C",351).
component("YDR297W",348).
component("YDR046C",322) :- not remove_orf("YDR046C",322).
component("YDL245C",312).
component("YDL210W",308).
component("YCR032W",269).
component("YCR028C",268).
component("YCR024C-A",267).
component("YCL025C",258).
component("YBR298C",254).
component("YBR291C",253).
component("YBR069C",220) :- not remove_orf("YBR069C",220).
component("YBR068C",219) :- not remove_orf("YBR068C",219).
component("YBR036C",217).
component("YBR021W",213).
component("YBL042C",201).
component("U85_",175).
component("U7_",170).
component("U79_",169).
component("U78_",168).
...
catalyst(2131,23).
catalyst(2132,23).
catalyst(3620,355) :- not remove_reaction(3620,355).
catalyst(2110,429).
catalyst(2190,429).
catalyst(5550,615).
catalyst(5791,691).
...
catalyst(2300,181).
catalyst(3460,147).
catalyst(3600,647) :- not remove_reaction(3600,647).
catalyst(8000,661).
catalyst(3941,811).
catalyst(3942,811).
catalyst(6890,776).
...
catalyst(4560,380).
catalyst(2550,799).
catalyst(1890,648) :- not remove_reaction(1890,648).
catalyst(3630,648) :- not remove_reaction(3630,648).
catalyst(1890,408) :- not remove_reaction(1890,408).
catalyst(3630,408) :- not remove_reaction(3630,408).
catalyst(3740,333).
catalyst(8231,904).
catalyst(8232,904).
catalyst(8231,869).
...
catalyst(8061,898).
catalyst(8062,898).
catalyst(3590,440) :- not remove_reaction(3590,440).
catalyst(10910,440) :- not remove_reaction(10910,440).
catalyst(4570,474).
catalyst(8181,701).
catalyst(8182,701).
catalyst(8181,590).
...
catalyst(8282,323).
catalyst(3840,538).
catalyst(3610,314) :- not remove_reaction(3610,314).
catalyst(7921,833).
catalyst(7922,833).
catalyst(7841,386).
catalyst(7842,386).
...
catalyst(1210,828).
catalyst(1160,822).
catalyst(801,809) :- not remove_reaction(801,809).
catalyst(802,809) :- not remove_reaction(802,809).
catalyst(811,809) :- not remove_reaction(811,809).
catalyst(812,809) :- not remove_reaction(812,809).
catalyst(831,809) :- not remove_reaction(831,809).
catalyst(832,809) :- not remove_reaction(832,809).
catalyst(901,809) :- not remove_reaction(901,809).
catalyst(902,809) :- not remove_reaction(902,809).
catalyst(1180,805).
catalyst(1210,805).
catalyst(700,802).
catalyst(1200,792).
...
catalyst(650,660).
catalyst(6560,655).
catalyst(771,654) :- not remove_reaction(771,654).
catalyst(772,654) :- not remove_reaction(772,654).
catalyst(781,654) :- not remove_reaction(781,654).
catalyst(782,654) :- not remove_reaction(782,654).
catalyst(791,654) :- not remove_reaction(791,654).
catalyst(792,654) :- not remove_reaction(792,654).
...
catalyst(841,654) :- not remove_reaction(841,654).
catalyst(842,654) :- not remove_reaction(842,654).
catalyst(851,654) :- not remove_reaction(851,654).
catalyst(852,654) :- not remove_reaction(852,654).
catalyst(881,654) :- not remove_reaction(881,654).
catalyst(882,654) :- not remove_reaction(882,654).
catalyst(901,654) :- not remove_reaction(901,654).
catalyst(902,654) :- not remove_reaction(902,654).
catalyst(911,654) :- not remove_reaction(911,654).
catalyst(912,654) :- not remove_reaction(912,654).
catalyst(921,654) :- not remove_reaction(921,654).
catalyst(922,654) :- not remove_reaction(922,654).
catalyst(931,654) :- not remove_reaction(931,654).
catalyst(932,654) :- not remove_reaction(932,654).
catalyst(1191,654) :- not remove_reaction(1191,654).
catalyst(1192,654) :- not remove_reaction(1192,654).
catalyst(390,650).
catalyst(1180,620).
catalyst(1210,620).
catalyst(1250,610).
...
catalyst(1210,351).
catalyst(6650,348).
catalyst(791,322) :- not remove_reaction(791,322).
catalyst(792,322) :- not remove_reaction(792,322).
catalyst(801,322) :- not remove_reaction(801,322).
catalyst(802,322) :- not remove_reaction(802,322).
catalyst(811,322) :- not remove_reaction(811,322).
catalyst(812,322) :- not remove_reaction(812,322).
catalyst(831,322) :- not remove_reaction(831,322).
catalyst(832,322) :- not remove_reaction(832,322).
catalyst(841,322) :- not remove_reaction(841,322).
catalyst(842,322) :- not remove_reaction(842,322).
catalyst(851,322) :- not remove_reaction(851,322).
catalyst(852,322) :- not remove_reaction(852,322).
catalyst(901,322) :- not remove_reaction(901,322).
catalyst(902,322) :- not remove_reaction(902,322).
catalyst(1180,312).
catalyst(1210,312).
catalyst(690,308).
catalyst(730,308).
...
catalyst(1511,253).
catalyst(1512,253).
catalyst(771,220) :- not remove_reaction(771,220).
catalyst(772,220) :- not remove_reaction(772,220).
...
catalyst(791,219) :- not remove_reaction(791,219).
catalyst(792,219) :- not remove_reaction(792,219).
catalyst(801,219) :- not remove_reaction(801,219).
catalyst(802,219) :- not remove_reaction(802,219).
catalyst(811,219) :- not remove_reaction(811,219).
catalyst(812,219) :- not remove_reaction(812,219).
catalyst(831,219) :- not remove_reaction(831,219).
catalyst(832,219) :- not remove_reaction(832,219).
catalyst(841,219) :- not remove_reaction(841,219).
catalyst(842,219) :- not remove_reaction(842,219).
catalyst(851,219) :- not remove_reaction(851,219).
catalyst(852,219) :- not remove_reaction(852,219).
catalyst(901,219) :- not remove_reaction(901,219).
catalyst(902,219) :- not remove_reaction(902,219).
catalyst(6600,217).
catalyst(620,213).
catalyst(540,201).
catalyst(2660,175).
...
modifiable_enzyme(647).
modifiable_enzyme(648).
modifiable_enzyme(408).
modifiable_enzyme(440).
modifiable_enzyme(314).
modifiable_enzyme(809).
modifiable_enzyme(654).
modifiable_enzyme(322).
modifiable_enzyme(220).
modifiable_enzyme(219).
