...
component("YGR060W",478).
component("YGL012W",446).
component("YKR009C",669).
component("YOL086C",842).
component("YMR303C",782).
component("YMR083W",760).
component("YGL256W",471).
...
component("YIL094C",560).
component("YHR063C",525).
component("U45_",141).
component("YML056C",744).
component("YLR432W",733).
component("YHR216W",548).
component("YAR075W",199).
component("YAR073W",198).
component("YDR127W",336).
component("YJR139C",632).
component("YML075C",747).
component("YLR450W",736).
component("YOL126C",848).
component("YKL085W",646).
component("YDL078C",289).
component("YKL029C",641).
component("YNL037C",787).
component("YNL009W",785).
component("YLR174W",706).
component("YHR183W",541).
component("YGR256W",503).
component("YNL241C",802).
component("YOL059W",839).
component("YDL022W",281).
component("YCL018W",263).
component("YLR355C",728).
component("YIL074C",557).
component("YER081W",414).
component("YML054C",743).
component("YDL174C",311).
component("YML086C",749).
component("YIL155C",569).
component("YEL024W",385).
component("YKR066C",674).
component("YGR088W",482).
component("YDR256C",350).
component("YKL026C",640).
component("YIR037W",580).
component("YBR244W",250).
component("YJR078W",624).
component("U58_",151).
component("YJR025C",615).
component("U107_",27).
component("YGR255C",502).
component("U108_",28).
component("YHR007C",514).
component("YDR402C",365).
component("YGL055W",453).
component("YJR104C",627).
component("YHR008C",515).
component("YOR384W",894).
component("YOR381W",893).
component("YOL152W",851).
component("YLL051C",684).
component("YJL026W",582).
component("YIL066C",556).
component("YGR180C",490).
component("YER070W",411).
component("U37_",135).
component("U36_",134).
component("U35_",133).
component("YDL168W",308).
component("YDR158W",344).
component("YJR009C",611).
component("YJL052W",584).
component("YGR192C",492).
component("YBR006W",212).
component("YPL276W",933).
component("YPL275W",932).
component("YOR388C",895).
component("YPL061W",903).
component("YOR374W",891).
component("YER073W",412).
component("YGL154C",461).
component("YBR115C",231).
component("U55_",150).
component("YER069W",409).
component("YOR323C",883).
component("YMR170C",770).
component("YMR169C",769).
component("YER178W",424).
component("YBR221C",248).
component("YIL125W",565).
component("U52_",147).
component("YBR166C",241).
component("YNL280C",811).
...
component("YPL023C",899).
component("YGL125W",458).
component("YOR236W",880).
component("YGR204W",495).
component("YIR034C",579).
component("YLR142W",701).
component("U65_",158).
component("U63_",156).
component("U62_",155).
component("YHR068W",526).
component("YKL150W",652).
component("YIL043C",553).
component("YHR042W",520).
component("YOR221C",877).
component("YMR145C",767).
component("YML120C",750).
component("YKL192C",661).
component("YKL055C",643).
component("YER061C",405).
component("YDL085W",291).
component("YPL171C",912).
component("YHR179W",540).
component("YMR145C",768).
component("YML120C",751).
component("YKL192C",662).
component("YDL085W",292).
component("YGR234W",498).
component("YFR030W",438).
component("YPL017C",898).
component("YFL018C",428).
component("YPL091W",904).
component("YDR353W",360).
component("YER042W",399).
component("YPR167C",955).
component("YJR137C",631).
component("YNL052W",789).
component("YMR256C",779).
component("YLR395C",732).
component("YLR038C",690).
component("YIL111W",562).
component("YHR051W",524).
component("YGL191W",464).
component("YGL187C",463).
component("YDL067C",288).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",331).
component("YPL266W",930).
component("YPL273W",931).
component("YLL062C",686).
component("YDR410C",368).
component("YKR069W",675).
component("YOL096C",843).
component("U47_",143).
component("YER091C",419).
component("YJR073C",622).
component("YGR157W",487).
component("YDR120C",334).
component("YML008C",738).
component("YOR074C",857).
component("YDL033C",283).
component("YOL096C",844).
component("YLR172C",705).
component("YLR058C",693).
...
component("YKL024C",638).
component("YPR074C",947).
component("YBR117C",232).
component("YMR108W",763).
component("YCL009C",262).
component("YMR062C",758).
component("YNL071W",791).
component("YNR008W",817).
component("YIL160C",571).
component("YNR019W",820).
component("YCR048W",277).
component("U48_",144).
component("YMR062C",759).
component("YDR232W",347).
component("YPL231W",924).
component("YER061C",406).
component("YPL001W",897).
component("YDL052C",287).
component("U8_",182).
component("YDR148C",342).
component("YPL231W",925).
component("YPL028W",900).
component("YLR299W",717).
component("YGL017W",448).
component("YCR005C",269).
component("YML126C",752).
component("YNL104C",794).
component("YDL182W",312).
component("YDL131W",298).
component("YPR160W",954).
component("YDR307W",356).
component("YLR258W",714).
component("YFR015C",435).
component("YPL227C",921).
component("YNL029C",786).
component("YIL085C",559).
component("YNL192W",800).
component("YBR038W",223).
component("YBR023C",219).
component("YEL011W",382).
component("YMR306W",783).
component("YLR342W",726).
component("YGR032W",475).
component("YPR183W",958).
...
component("YFR047C",439).
component("YJR133W",630).
component("YLR209C",709).
component("YML022W",740).
component("YDR441C",371).
component("YHR128W",535).
component("YPR176C",957).
component("YPL172C",913).
component("YNR041C",823).
component("YMR101C",761).
...
component("YPR069C",944).
component("YDR127W",337).
component("YHR190W",543).
component("YLR146C",702).
component("YPL214C",919).
component("YHR068W",527).
component("YLR303W",719).
component("YGR012W",473).
component("YML082W",748).
component("YJR130C",629).
component("YLR303W",720).
component("YDR035W",324).
component("YBR249C",252).
component("YLR180W",707).
component("YDR502C",375).
component("YOR274W",881).
component("YOL143C",850).
component("YBR256C",254).
component("YHR137W",536).
component("YGL202W",465).
component("YLR027C",687).
component("YKL106W",647).
component("YOL140W",849).
component("YLR438W",735).
component("YGR019W",474).
component("YLR089C",697).
component("U64_",157).
component("U61_",154).
component("U51_",146).
component("YJR148W",633).
component("YHR208W",546).
component("YFL030W",430).
component("YOR184W",868).
component("YNR058W",827).
component("YIL116W",564).
component("YGL253W",470).
component("YFR053C",440).
component("YMR013C",756).
component("YMR205C",774).
component("YGR240C",499).
component("YOL016C",831).
component("YFR014C",434).
component("YLR240W",712).
component("YKL203C",664).
component("YJR066W",621).
component("YCR036W",276).
component("YGR194C",493).
component("YCL040W",265).
component("U15_",68).
component("YPL188W",915).
component("YJR049C",617).
component("YEL041W",386).
component("U96_",187).
component("YKL001C",636).
component("YDR236C",348).
component("YML070W",746).
...
component("YPL203W",916).
component("YOR061W",855).
component("YKL166C",654).
component("YJL164C",602).
component("YIL035C",552).
component("YHR205W",545).
component("YHR102W",533).
component("YGL019W",449).
component("YHR025W",519).
component("YOR347C",888).
component("YAL038W",193).
component("YNR012W",818).
component("YPR121W",952).
component("YPL258C",927).
component("YOL055C",835).
component("YPL214C",920).
component("YDR009W",321).
component("YDR127W",338).
component("U21_",114).
component("YDR147W",341).
component("YDR300C",355).
component("YCR012W",270).
component("YER069W",410).
component("U19_",103).
component("YKL024C",639).
component("U18_",93).
component("U17_",83).
component("U76_",168).
component("YER170W",423).
component("YDR226W",346).
component("YKL067W",645).
component("YOL055C",836).
component("YDR454C",372).
component("YJR057W",619).
component("YOL061W",840).
component("YKL181W",656).
component("YHL011C",510).
component("YER099C",420).
component("YBL068W",207).
component("YOR143C",864).
component("YNL256W",806).
component("YLR328W",724).
component("YBR018C",214).
component("YBR018C",215).
component("YGR007W",472).
component("YGR202C",494).
component("YLR328W",725).
component("YDL045C",285).
component("U80_",173).
...
component("YGL130W",459).
component("YDR530C",378).
component("YCL050C",267).
component("YPR190C",960).
component("YPR187W",959).
component("YPR110C",950).
component("YPR010C",937).
component("YOR341W",887).
component("YOR340C",886).
component("YOR224C",879).
component("YOR210W",876).
component("YOR207C",873).
component("YOR151C",865).
component("YOR116C",859).
component("YOL005C",829).
component("YNR003C",816).
component("YNL248C",804).
component("YNL151C",798).
component("YNL113W",795).
component("YKL144C",650).
component("YJR063W",620).
component("YJL148W",600).
component("YJL140W",599).
component("YIL021W",551).
component("YHR143W-A",537).
component("YGL070C",456).
component("YFL036W",431).
component("YDR404C",366).
component("YDR156W",343).
component("YDR045C",327).
component("YDL150W",306).
component("YDL140C",300).
component("YBR154C",240).
component("YPR175W",956).
component("YPL167C",911).
component("YOR330C",884).
component("YOL115W",847).
component("YNL299W",813).
component("YNL262W",808).
component("YNL102W",793).
...
component("YPR113W",951).
component("YBR243C",249).
component("YDL142C",305).
component("YPL148C",909).
component("YER026C",398).
component("YGR286C",507).
component("YJL068C",585).
component("YHR189W",542).
component("YDR058C",330).
component("YDL086W",293).
component("YOL011W",830).
component("YMR008C",754).
component("YMR006C",753).
component("U105_",25).
component("YBL015W",201).
component("YJL068C",586).
component("YJR019C",614).
component("YOR040W",854).
component("U84_",177).
component("U77_",169).
component("YDR481C",373).
component("YLR377C",730).
component("YFR025C",436).
component("YPL179W",914).
component("YNR032W",821).
component("YML057W",745).
component("YML016C",739).
...
component("YHR046C",523).
component("U9_",190).
component("YPL228W",922).
component("YMR180C",771).
component("YDL236W",317).
component("YJL155C",601).
component("YPR073C",946).
component("YOR208W",874).
component("YNL053W",790).
component("YMR036C",757).
component("YIR026C",577).
component("YIL113W",563).
component("YFR028C",437).
component("YER075C",413).
component("YDL230W",316).
...
component("U25_",123).
component("U24_",122).
component("YHR044C",522).
component("YHR043C",521).
component("YOL064C",841).
component("YOR360C",890).
component("YGL248W",469).
component("YKR031C",671).
component("YPL206C",917).
component("YGL027C",451).
component("YLR286C",716).
...
component("YIL162W",572).
component("YPR026W",938).
component("YDR001C",319).
component("YBR001C",209).
component("YIR019C",576).
component("YIL099W",561).
component("YDL037C",284).
component("YOR190W",870).
component("YLR300W",718).
component("YGR282C",506).
component("YDR261C",351).
component("YDR400W",364).
component("U23_",121).
component("YML035C",741).
component("YJL070C",587).
component("YBR284W",258).
component("U106_",26).
component("U102_",22).
component("YER043C",400).
component("YNL045W",788).
component("YGL037C",452).
component("YDR242W",349).
component("YLR308W",723).
component("YLR307W",722).
component("YBR208C",245).
component("YMR281W",781).
component("U53_",148).
component("YIR032C",578).
component("YPR062W",943).
component("YMR120C",766).
component("YLR028C",689).
component("YHR144C",538).
component("YGR267C",505).
component("YBL033C",202).
component("YBR153W",239).
component("YNL141W",796).
component("YLR245C",713).
component("YML035C",742).
component("YGR204W",496).
component("YBR084W",226).
component("YJL126W",594).
component("U44_",140).
...
component("YHR201C",544).
component("YBR111C",230).
component("YBR252W",253).
component("YPR080W",948).
component("YOR187W",869).
component("YOR133W",862).
component("YLR069C",695).
component("YKR084C",677).
component("YKL173W",655).
component("YJL102W",592).
component("YDR385W",363).
component("YBR118W",233).
component("YER005W",394).
component("YLL001W",680).
component("YIL048W",554).
component("YER166W",422).
component("YDR093W",333).
...
component("YLR134W",699).
component("YLR044C",691).
component("YGR087C",481).
component("YDR380W",362).
component("YDL080C",290).
component("U98_",188).
component("YMR250W",778).
component("YKL184W",660).
component("YOR128C",860).
component("YEL021W",384).
component("YNR043W",824).
component("U93_",185).
component("U54_",149).
component("YKL211C",665) :- not remove_orf("YKL211C",665).
component("YKR097W",679).
component("YOL052C",834).
component("YNL169C",799).
component("YGR170W",488).
component("YKL060C",644).
component("YNL256W",807).
component("YDR294C",353).
component("YEL046C",387).
component("YNR033W",822).
component("YPR006C",936).
component("YER065C",408).
component("YKL211C",666) :- not remove_orf("YKL211C",666).
component("YER090W",666) :- not remove_orf("YER090W",666).
component("YER090W",418) :- not remove_orf("YER090W",418).
component("YDR127W",339).
component("YPL281C",934).
component("YOR393W",896).
component("YMR323W",784).
component("YHR174W",539).
component("YGR254W",501).
component("YOR202W",872).
component("YPL262W",928).
component("YGL026C",450) :- not remove_orf("YGL026C",450).
component("YGR155W",486).
component("YLR304C",721).
component("YJL200C",605).
component("YGL009C",445).
component("YNL316C",814).
component("YKL182W",658).
component("YPL212C",918).
component("YNL292W",812).
component("YGL063W",455).
component("YFL001W",426).
component("YPR002W",935).
component("YJR016C",613).
component("YCR053W",278).
component("YDR127W",340).
component("YGL148W",460).
component("YIL168W",574).
component("YIL167W",573).
component("YCL064C",268).
component("YER086W",415).
component("YLR359W",729).
component("YAL012W",191).
component("YML004C",737).
component("YFR055W",441).
component("YJL005W",581).
component("YJL121C",593).
component("YBR019C",216).
component("YBR019C",217).
component("YDR050C",329).
component("YIL020C",550).
component("YDR007W",320) :- not remove_orf("YDR007W",320).
component("YOR095C",858).
component("YER003C",393).
component("YBR196C",244).
component("YGL001C",443).
component("YPL117C",907).
component("U14_",60).
component("YOL056W",837).
component("YKL152C",653).
component("YDL021W",280).
component("YMR105C",762).
component("YKL127W",648).
component("YEL058W",390).
component("YPR060C",942).
component("YHR072W",528).
component("YPL097W",905).
component("YGR185C",491).
component("YGR264C",504).
component("YGR171C",489).
component("YHR011W",516).
component("YDR023W",323).
component("YPL104W",906).
component("YLL018C",681).
component("YPR081C",949).
component("YBR121C",234).
component("YHR020W",518).
component("YER087W",416).
component("YNL247W",803).
component("YOR168W",866).
component("YOL097C",845).
component("YDR268W",352).
component("YPR047W",941).
component("YLR060W",694).
component("YFL022C",429).
component("YPR033C",939).
component("YCR024C",272).
component("YHR019C",517).
component("YKL194C",663).
component("YIL078W",558).
component("YPL160W",910).
component("YLR382C",731).
component("YNL073W",792).
component("YDR037W",325).
component("YOR335C",885).
component("YGR094W",483).
component("YLR153C",703).
component("YAL054C",194).
component("YOR317W",882).
component("YMR246W",777).
component("YIL009W",549).
component("YER015W",396).
component("YOR142W",863).
component("YGR244C",500).
component("YPR035W",940).
component("YIL145C",568).
component("U89_",181).
component("YJL101C",591).
component("YOL049W",833).
component("YAR015W",196).
component("YGL234W",467).
component("YER183C",425).
component("U91_",184).
component("U90_",183).
component("YNR057C",826).
component("YDL141W",301).
component("YDL141W",302).
component("YGL234W",468).
component("YDL141W",303).
component("YJR103W",626).
component("YBL039C",204).
component("YGR204W",497).
component("YBR084W",227).
component("YNL220W",801).
component("YOL058W",838).
component("YBR208C",246).
component("YDL141W",304).
component("YHR074W",529).
component("YMR217W",776).
component("YGR061C",479).
component("YJR109C",628).
component("YJL130C",597).
component("YGL062W",454).
component("YBR218C",247).
component("YPL231W",926).
component("YNR016C",819).
component("YKL182W",659).
component("YGR037C",476).
component("YJL087C",588).
component("YPR138C",953).
component("YPL265W",929).
component("YPL134C",908).
component("YPL057C",902).
component("YPL036W",901).
component("YOR348C",889).
component("YOR222W",878).
component("YOR192C",871).
component("YOR171C",867).
component("YOR130C",861).
component("YOR071C",856).
component("YOR011W",853).
component("YOL156W",852).
component("YOL103W",846).
component("YOL020W",832) :- not remove_orf("YOL020W",832).
component("YNR072W",828).
component("YNR056C",825).
component("YNL318C",815).
component("YNL270C",809).
component("YNL142W",797).
component("YMR272C",780).
component("YMR202W",773).
component("YMR011W",755).
component("YLR348C",727).
component("YLR260W",715).
component("YLR237W",711).
component("YLR138W",700).
component("YLR100C",698).
component("YLR081W",696).
component("YLL061W",685).
component("YLL043W",683).
component("YKR093W",678).
component("YKR053C",673).
component("YKR039W",672) :- not remove_orf("YKR039W",672).
component("YKL217W",668).
component("YKL004W",637).
component("YJR158W",635).
component("YJR095W",625).
component("YJR077C",623).
component("YJL219W",608).
component("YJL214W",606).
component("YJL134W",598).
component("YJL129C",595).
component("YIL134W",566).
component("YHR096C",532).
component("YHR094C",531).
component("YHR092C",530).
component("YHL036W",513).
component("YGR121C",484).
component("YGR065C",480).
component("YGR055W",477).
component("YGL186C",462).
component("YGL077C",457).
component("YGL008C",444).
component("YFL055W",433).
component("YFL011W",427).
...
component("YDR297W",354).
component("YDR046C",328) :- not remove_orf("YDR046C",328).
component("YDL245C",318).
component("YDL210W",314).
component("YCR032W",275).
component("YCR028C",274).
...
catalyst(1890,418) :- not remove_reaction(1890,418).
catalyst(3630,418) :- not remove_reaction(3630,418).
catalyst(3740,339).
catalyst(8231,934).
catalyst(8232,934).
catalyst(8231,896).
...
catalyst(8061,928).
catalyst(8062,928).
catalyst(3590,450) :- not remove_reaction(3590,450).
catalyst(10910,450) :- not remove_reaction(10910,450).
catalyst(4570,486).
catalyst(8181,721).
catalyst(8182,721).
catalyst(8181,605).
...
catalyst(8282,329).
catalyst(3840,550).
catalyst(3610,320) :- not remove_reaction(3610,320).
catalyst(7921,858).
catalyst(7922,858).
catalyst(7841,393).
catalyst(7842,393).
...
catalyst(1210,852).
catalyst(1160,846).
catalyst(801,832) :- not remove_reaction(801,832).
catalyst(802,832) :- not remove_reaction(802,832).
catalyst(811,832) :- not remove_reaction(811,832).
catalyst(812,832) :- not remove_reaction(812,832).
catalyst(831,832) :- not remove_reaction(831,832).
catalyst(832,832) :- not remove_reaction(832,832).
catalyst(901,832) :- not remove_reaction(901,832).
catalyst(902,832) :- not remove_reaction(902,832).
catalyst(1180,828).
catalyst(1210,828).
catalyst(700,825).
catalyst(1200,815).
...
catalyst(650,678).
catalyst(6560,673).
catalyst(681,672) :- not remove_reaction(681,672).
catalyst(682,672) :- not remove_reaction(682,672).
catalyst(771,672) :- not remove_reaction(771,672).
catalyst(772,672) :- not remove_reaction(772,672).
catalyst(781,672) :- not remove_reaction(781,672).
catalyst(782,672) :- not remove_reaction(782,672).
catalyst(791,672) :- not remove_reaction(791,672).
catalyst(792,672) :- not remove_reaction(792,672).
catalyst(801,672) :- not remove_reaction(801,672).
catalyst(802,672) :- not remove_reaction(802,672).
catalyst(811,672) :- not remove_reaction(811,672).
catalyst(812,672) :- not remove_reaction(812,672).
catalyst(831,672) :- not remove_reaction(831,672).
catalyst(832,672) :- not remove_reaction(832,672).
catalyst(841,672) :- not remove_reaction(841,672).
catalyst(842,672) :- not remove_reaction(842,672).
catalyst(851,672) :- not remove_reaction(851,672).
catalyst(852,672) :- not remove_reaction(852,672).
catalyst(881,672) :- not remove_reaction(881,672).
catalyst(882,672) :- not remove_reaction(882,672).
catalyst(901,672) :- not remove_reaction(901,672).
catalyst(902,672) :- not remove_reaction(902,672).
catalyst(911,672) :- not remove_reaction(911,672).
catalyst(912,672) :- not remove_reaction(912,672).
catalyst(921,672) :- not remove_reaction(921,672).
catalyst(922,672) :- not remove_reaction(922,672).
catalyst(931,672) :- not remove_reaction(931,672).
catalyst(932,672) :- not remove_reaction(932,672).
catalyst(1191,672) :- not remove_reaction(1191,672).
catalyst(1192,672) :- not remove_reaction(1192,672).
catalyst(390,668).
catalyst(6610,637).
catalyst(1180,635).
catalyst(1210,635).
...
catalyst(1210,357).
catalyst(6650,354).
catalyst(791,328) :- not remove_reaction(791,328).
catalyst(792,328) :- not remove_reaction(792,328).
...
catalyst(841,328) :- not remove_reaction(841,328).
catalyst(842,328) :- not remove_reaction(842,328).
catalyst(851,328) :- not remove_reaction(851,328).
catalyst(852,328) :- not remove_reaction(852,328).
...
modifiable_enzyme(832).
modifiable_enzyme(672).
