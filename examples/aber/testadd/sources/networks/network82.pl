...
component("YLR056W",434).
component("YGL012W",274).
component("YKR009C",418).
component("YOL086C",526).
component("YMR303C",483).
component("YGL256W",294).
component("YDL168W",187).
component("YBR145W",143).
component("YPL231W",577).
component("YBR265W",154).
component("U46_",83).
component("YBR149W",144).
component("YBR149W",145).
component("YGL001C",271).
component("YIL094C",351).
component("U45_",82).
component("YML056C",466).
component("YLR432W",463).
component("YHR216W",345).
component("YAR075W",121).
component("YAR073W",120).
component("YDR127W",202).
component("YOL126C",531).
component("YKL085W",405).
component("YDL078C",177).
component("YNL037C",488).
component("YNL009W",486).
component("YLR174W",444).
component("YOL059W",524).
component("YDL022W",173).
component("YCL018W",161).
component("YLR355C",459).
component("YDL174C",190).
component("YML086C",468).
component("YGR088W",302).
component("YDR256C",213).
component("YJR078W",394).
component("YJR025C",387).
component("U107_",24).
component("YJR104C",396).
component("YHR008C",321).
component("YOR384W",561).
component("YOR381W",560).
component("YOL152W",533).
component("YLL051C",428).
component("YJL026W",365).
component("YIL066C",349).
component("YGR180C",305).
component("YER070W",250).
component("U36_",76).
component("YDL168W",188).
component("YBR006W",129).
component("YPL276W",585).
component("YPL275W",584).
component("YOR388C",562).
component("YOR374W",559).
component("YER073W",251).
component("YGL154C",286).
component("U55_",89).
component("YER069W",248).
component("YOR323C",552).
component("YER178W",257).
component("YBR221C",151).
component("YIL125W",355).
component("U52_",87).
component("YBR166C",147).
component("YGL012W",275).
component("YKL216W",417).
component("YKR009C",419).
component("YIL160C",359).
component("YGL205W",291).
component("YMR118C",475).
component("YLR164W",442).
component("YLL041C",427).
component("YKL148C",408).
component("YJL045W",366).
component("YDR178W",209).
component("YEL047C",237).
component("YDL171C",189).
component("U99_",114).
component("U100_",20).
component("YKR080W",424).
component("YER023W",242).
component("YOR236W",550).
component("YGR204W",307).
component("YLR142W",440).
component("U65_",95).
component("U63_",93).
component("U62_",92).
component("YHR068W",329).
component("YKL150W",409).
component("YIL043C",348).
component("YPL171C",572).
component("YHR179W",340).
component("YMR145C",478).
component("YML120C",469).
component("YKL192C",414).
component("YDL085W",179).
component("YGR234W",309).
component("YFR030W",268).
component("YPL017C",564).
component("YFL018C",261).
component("YDR353W",220).
component("YPR167C",597).
component("YJR137C",398).
component("YNL052W",489).
component("YMR256C",482).
component("YLR395C",462).
component("YLR038C",432).
component("YIL111W",352).
component("YHR051W",328).
component("YGL191W",289).
component("YGL187C",288).
component("YDL067C",176).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",583).
component("YKR069W",423).
component("YOL096C",527).
component("U47_",84).
component("YJR073C",392).
component("YDR120C",200).
component("YDL033C",175).
component("YLR172C",443).
component("YLR058C",435).
component("YDR019C",196).
component("YBR176W",148).
component("YDR408C",225).
component("YMR120C",476).
component("YLR028C",430).
component("YBL013W",122).
component("YJL130C",374).
component("YKL024C",403).
component("YPR074C",593).
component("YBR117C",142).
component("YCL009C",160).
component("YNL071W",491).
component("YIL160C",360).
component("U48_",85).
component("YPL231W",578).
component("YPL231W",579).
component("YPL028W",565).
component("YLR299W",452).
component("YGL017W",276).
component("YML126C",470).
component("YNL104C",494).
component("YDL182W",191).
component("YDL131W",183).
component("YLR258W",449).
component("YFR015C",266).
component("YNL029C",487).
component("YIL085C",350).
component("YMR306W",484).
component("YLR342W",458).
component("YGR032W",297).
component("YLR209C",445).
component("U104_",21).
component("YDR354W",221) :- not remove_orf("YDR354W",221).
component("YFR047C",269).
component("YLR209C",446).
component("YML022W",464).
component("YDR441C",227).
component("YJL167W",379).
component("YDR127W",203).
component("YHR068W",330).
component("YLR303W",454).
component("YGR012W",295).
component("YML082W",467).
component("YJR130C",397).
component("YDR035W",197).
component("YBR249C",152).
component("YOR274W",551).
component("YHR137W",336).
component("YGL202W",290).
component("YLR027C",429).
component("YKL106W",406).
component("YOL140W",532).
component("YGR019W",296).
component("YLR089C",437).
component("U64_",94).
component("U61_",91).
component("YJR148W",399).
component("YFL030W",262).
component("YOR184W",544).
component("YNR058W",515).
component("YIL116W",354).
component("YGL253W",293).
component("YFR053C",270).
component("YMR205C",479).
component("YGR240C",310).
component("YOL016C",519).
component("YFR014C",265).
component("YCR036W",170).
component("YCL040W",163).
component("U15_",42).
component("YPL188W",573).
component("YJR049C",389).
component("YEL041W",235).
component("U96_",112).
component("YKL001C",402).
component("YDR236C",211).
component("YHL032C",319).
component("U83_",108).
component("U81_",107).
component("YMR208W",480).
component("YPL203W",574).
component("YOR061W",536).
component("YKL166C",411).
component("YJL164C",378).
component("YIL035C",347).
component("YHR205W",343).
component("YHR102W",335).
component("YGL019W",277).
component("YHR025W",324).
component("YOR347C",557).
component("YAL038W",117).
component("YNR012W",511).
component("YDR127W",204).
component("YDR147W",207).
component("YCR012W",165).
component("YER069W",249).
component("U76_",104).
component("YER170W",256).
component("YDR226W",210).
component("YKL067W",404).
component("YOL055C",522).
component("YDR454C",228).
component("YJR057W",390).
component("YOL061W",525).
component("YKL181W",412).
component("YHL011C",318).
component("YER099C",255).
component("YBL068W",127).
component("YOR143C",540).
component("YNL256W",503).
component("YLR328W",456).
component("YBR018C",131).
component("YLR328W",457).
component("U94_",111).
component("YBR029C",134).
component("YGL130W",284).
component("YDR530C",232).
component("YPR190C",600).
component("YPR187W",599).
component("YPR110C",594).
component("YPR010C",588).
component("YOR341W",556).
component("YOR340C",555).
component("YOR224C",549).
component("YOR210W",548).
component("YOR207C",546).
component("YOR151C",541).
component("YOR116C",538).
component("YOL005C",517).
component("YNR003C",510).
component("YNL248C",502).
component("YNL151C",498).
component("YNL113W",495).
component("YKL144C",407).
component("YJR063W",391).
component("YJL148W",377).
component("YJL140W",376).
component("YIL021W",346).
component("YHR143W-A",337).
component("YGL070C",282).
component("YFL036W",263).
component("YDR404C",224).
component("YDR156W",208).
component("YDR045C",198).
component("YDL150W",186).
component("YDL140C",184).
component("YBR154C",146).
component("YPR175W",598).
component("YPL167C",571).
component("YOR330C",553).
component("YOL115W",530).
component("YNL299W",508).
component("YNL262W",504).
component("YNL102W",493).
component("YJR043C",388).
component("YJR006W",385).
component("YJL090C",369).
component("YIL139C",357).
component("YEL055C",238).
component("YDR419W",226).
component("YDR121W",201).
component("YDL102W",182).
component("YCR014C",166).
component("YBR278W",156).
component("YBL035C",125).
component("YPR113W",595).
component("YPL148C",570).
component("YGR286C",315).
component("YHR189W",341).
component("YDL086W",180).
component("YOL011W",518).
component("YMR008C",472).
component("YMR006C",471).
component("U105_",22).
component("YBL015W",123).
component("YJL068C",367).
component("U77_",105).
component("YLR377C",461).
component("YPR073C",591).
component("YHR215W",344).
component("YDL024C",174).
component("YBR093C",140).
component("YBR092C",139).
component("YHR046C",327).
component("U9_",115).
component("YDL236W",193).
component("YPR073C",592).
component("YOR208W",547).
component("YNL053W",490).
component("YMR036C",474).
component("YIR026C",364).
component("YIL113W",353).
component("YFR028C",267).
component("YER075C",252).
component("YDL230W",192).
component("YBR276C",155).
component("U34_",75).
component("U32_",74).
component("U31_",73).
component("U30_",72).
...
component("U25_",69).
component("U24_",68).
component("YHR044C",326).
component("YHR043C",325).
component("YOR360C",558).
component("YKR031C",420).
component("YPL206C",575).
component("YGL027C",279).
component("YLR286C",451).
component("YJR153W",400).
component("YJL221C",384).
component("YJL216C",382).
component("YIL172C",363).
component("YGR292W",317).
component("YGR287C",316).
component("YBR299W",159).
component("YOR190W",545).
component("YLR300W",453).
component("YGR282C",314).
component("YDR261C",214).
component("YDR400W",223).
component("YML035C",465).
component("YJL070C",368).
component("YBR284W",157).
component("U106_",23).
component("YER043C",243).
component("YDR242W",212).
component("U53_",88).
component("YPR062W",590).
component("YMR120C",477).
component("YLR028C",431).
component("YHR144C",338).
component("YBL033C",124).
component("YNL141W",496).
component("YLR245C",448).
component("YBR084W",137).
component("YJL126W",372).
component("U44_",81).
component("YDL100C",181).
component("U40_",79).
component("U39_",77).
component("YBR011C",130).
component("YHR201C",342).
component("YBR111C",141).
component("YBR252W",153).
component("YER005W",241).
component("YBL099W",128).
component("YLR231C",447).
component("YLR134W",439).
component("YLR044C",433).
component("YGR087C",301).
component("YDR380W",222).
component("YDL080C",178).
component("U98_",113).
component("YMR250W",481).
component("YOR128C",539).
component("U93_",110).
component("YKL211C",415) :- not remove_orf("YKL211C",415).
component("YKR097W",425).
component("YNL169C",499).
component("YEL046C",236).
component("YNR033W",513).
component("YKL211C",416) :- not remove_orf("YKL211C",416).
component("YER090W",416) :- not remove_orf("YER090W",416).
component("YER090W",254) :- not remove_orf("YER090W",254).
component("YDR127W",205).
component("YPL281C",586).
component("YOR393W",563).
component("YMR323W",485).
component("YHR174W",339).
component("YGR254W",312).
component("YPL262W",581).
component("YGL026C",278) :- not remove_orf("YGL026C",278).
component("YLR304C",455).
component("YJL200C",380).
component("YNL316C",509).
component("YPL212C",576).
component("YNL292W",507).
component("YGL063W",281).
component("YFL001W",259).
component("YPR002W",587).
component("YJR016C",386).
component("YCR053W",171).
component("YDR127W",206).
component("YGL148W",285).
component("YIL168W",362).
component("YIL167W",361).
component("YCL064C",164).
component("YLR359W",460).
component("YAL012W",116).
component("YJL121C",371).
component("YBR019C",132).
component("YDR007W",195) :- not remove_orf("YDR007W",195).
component("YOR095C",537).
component("YBR196C",149).
component("YGL001C",272).
component("YPL117C",569).
component("U14_",36).
component("YOL056W",523).
component("YKL152C",410).
component("YDL021W",172).
component("YPR060C",589).
component("YPL097W",567).
component("YGR185C",306).
component("YGR264C",313).
component("YGR171C",304).
component("YPL104W",568).
component("YLL018C",426).
component("YHR020W",323).
component("YER087W",253).
component("YNL247W",501).
component("YOR168W",542).
component("YOL097C",528).
component("YDR268W",215).
component("YCR024C",167).
component("YHR019C",322).
component("YNL073W",492).
component("YOR335C",554).
component("YLR153C",441).
component("YAL054C",118).
component("YGR244C",311).
component("YIL145C",358).
component("YJL101C",370).
component("YOL049W",521).
component("YAR015W",119).
component("YER183C",258).
component("U90_",109).
component("YNR057C",514).
component("YGL234W",292).
component("YJR103W",395).
component("YBL039C",126).
component("YGR204W",308).
component("YBR084W",138).
component("YNL220W",500).
component("YDL141W",185).
component("YHR074W",331).
component("YGL062W",280).
component("YBR218C",150).
component("YPL231W",580).
component("YNR016C",512).
component("YKL182W",413).
component("YGR037C",298).
component("YPR138C",596).
component("YPL265W",582).
component("YPL036W",566).
component("YOR171C",543).
component("YOR011W",535).
component("YOL156W",534).
component("YOL103W",529).
component("YOL020W",520) :- not remove_orf("YOL020W",520).
component("YNR072W",516).
component("YNL270C",505).
component("YNL142W",497).
component("YMR011W",473).
component("YLR260W",450).
component("YLR100C",438).
component("YLR081W",436).
component("YKR053C",422).
component("YKR039W",421) :- not remove_orf("YKR039W",421).
component("YJR158W",401).
component("YJR077C",393).
component("YJL219W",383).
component("YJL214W",381).
component("YJL134W",375).
component("YJL129C",373).
component("YIL134W",356).
component("YHR096C",334).
component("YHR094C",333).
component("YHR092C",332).
component("YHL036W",320).
component("YGR121C",303).
component("YGR065C",300).
component("YGR055W",299).
component("YGL186C",287).
component("YGL077C",283).
component("YGL008C",273).
component("YFL055W",264).
component("YFL011W",260).
component("YER060W-A",247).
component("YER060W",246).
component("YER056C",245).
component("YER053C",244).
component("YEL069C",240).
component("YEL063C",239).
component("YEL017C-A",234).
component("YDR536W",233).
component("YDR508C",231).
component("YDR503C",230).
component("YDR497C",229).
component("YDR345C",219).
component("YDR343C",218).
component("YDR342C",217).
component("YDR297W",216).
component("YDR046C",199) :- not remove_orf("YDR046C",199).
component("YDL245C",194).
component("YCR032W",169).
component("YCR024C-A",168).
component("YCL025C",162).
component("YBR298C",158).
component("YBR069C",136) :- not remove_orf("YBR069C",136).
component("YBR068C",135) :- not remove_orf("YBR068C",135).
...
catalyst(6112,539).
catalyst(2300,110).
catalyst(3600,415) :- not remove_reaction(3600,415).
catalyst(8000,425).
catalyst(6890,499).
catalyst(4560,236).
catalyst(2550,513).
...
catalyst(1890,254) :- not remove_reaction(1890,254).
catalyst(3630,254) :- not remove_reaction(3630,254).
catalyst(3740,205).
catalyst(8231,586).
catalyst(8232,586).
catalyst(8231,563).
...
catalyst(8051,581).
catalyst(8052,581).
catalyst(3590,278) :- not remove_reaction(3590,278).
catalyst(10910,278) :- not remove_reaction(10910,278).
catalyst(8181,455).
catalyst(8182,455).
catalyst(8181,380).
catalyst(8182,380).
...
catalyst(7751,132).
catalyst(7752,132).
catalyst(3610,195) :- not remove_reaction(3610,195).
catalyst(7921,537).
catalyst(7922,537).
catalyst(8341,149).
catalyst(8342,149).
...
catalyst(851,421) :- not remove_reaction(851,421).
catalyst(852,421) :- not remove_reaction(852,421).
catalyst(881,421) :- not remove_reaction(881,421).
catalyst(882,421) :- not remove_reaction(882,421).
catalyst(901,421) :- not remove_reaction(901,421).
catalyst(902,421) :- not remove_reaction(902,421).
catalyst(921,421) :- not remove_reaction(921,421).
catalyst(922,421) :- not remove_reaction(922,421).
catalyst(931,421) :- not remove_reaction(931,421).
catalyst(932,421) :- not remove_reaction(932,421).
...
catalyst(1121,158).
catalyst(1122,158).
catalyst(771,136) :- not remove_reaction(771,136).
catalyst(772,136) :- not remove_reaction(772,136).
...
catalyst(831,135) :- not remove_reaction(831,135).
catalyst(832,135) :- not remove_reaction(832,135).
catalyst(841,135) :- not remove_reaction(841,135).
catalyst(842,135) :- not remove_reaction(842,135).
catalyst(851,135) :- not remove_reaction(851,135).
catalyst(852,135) :- not remove_reaction(852,135).
catalyst(901,135) :- not remove_reaction(901,135).
catalyst(902,135) :- not remove_reaction(902,135).
catalyst(620,133).
catalyst(6960,106).
catalyst(2920,103).
catalyst(2920,102).
