...
component("YNL280C",752).
component("YLR056W",644).
component("YGR060W",448).
component("YGL012W",419).
component("YKR009C",624).
component("YOL086C",783).
component("YMR303C",724).
...
component("YIL094C",524).
component("U45_",130).
component("YML056C",691).
component("YLR432W",680).
component("YHR216W",515).
component("YAR075W",186).
component("YAR073W",185).
component("YDR127W",318).
component("YJR139C",591).
component("YML075C",693).
component("YLR450W",683).
component("YOL126C",789).
component("YKL085W",602).
component("YDL078C",272).
component("YKL029C",598).
component("YNL037C",729).
component("YNL009W",727).
component("YLR174W",657).
component("YHR183W",508).
component("YGR256W",471).
component("YNL241C",744).
component("YOL059W",780).
component("YDL022W",264).
component("YCL018W",246).
component("YLR355C",675).
component("YIL074C",521).
component("YER081W",389).
component("YML054C",690).
component("YDL174C",294).
component("YML086C",695).
component("YIL155C",533).
component("YEL024W",364).
component("YKR066C",629).
component("YGR088W",452).
component("YDR256C",332).
component("YKL026C",597).
component("YIR037W",543).
...
component("YOR384W",828).
component("YOR381W",827).
component("YOL152W",791).
component("YLL051C",637).
component("YJL026W",545).
component("YIL066C",520).
component("YGR180C",459).
...
component("YJR009C",572).
component("YJL052W",547).
component("YGR192C",461).
component("YBR006W",198).
component("YPL276W",860).
component("YPL275W",859).
component("YOR388C",829).
component("YPL061W",836).
...
component("YIL125W",529).
component("U52_",136).
component("YBR166C",225).
component("YNL280C",753).
component("YGL012W",420).
component("YKL182W",612).
component("YKL216W",622).
component("YDR044W",308).
component("YER014W",374).
component("YKR009C",625).
component("YIL160C",534).
component("YGL205W",438).
component("YMR118C",708).
component("YLR164W",655).
component("YLL041C",635).
component("YKL148C",607).
component("YKL141W",605).
...
component("YOR236W",815).
component("YGR204W",463).
component("YIR034C",542).
component("YLR142W",652).
component("U65_",147).
component("U63_",145).
component("U62_",144).
component("YHR068W",493).
component("YKL150W",608).
component("YIL043C",518).
component("YHR042W",488).
component("YOR221C",812).
component("YMR145C",711).
component("YKL192C",616).
component("YKL055C",600).
component("YER061C",382).
component("YDL085W",274).
component("YPL171C",844).
component("YHR179W",507).
component("YMR145C",712).
component("YML120C",696).
component("YKL192C",617).
...
component("YPR167C",877).
component("YJR137C",590).
component("YNL052W",731).
component("YMR256C",721).
component("YLR395C",679).
component("YLR038C",642).
component("YIL111W",526).
component("YHR051W",492).
...
component("YLR299W",667).
component("YGL017W",421).
component("YCR005C",252).
component("YML126C",697).
component("YNL104C",736).
component("YDL182W",295).
component("YDL131W",281).
component("YDR307W",338).
component("YLR258W",664).
component("YFR015C",409).
component("YNL029C",728).
component("YIL085C",523).
component("YNL192W",742).
component("YBR038W",208).
component("YBR023C",204).
component("YMR306W",725).
component("YLR342W",673).
component("YGR032W",445).
component("YPR183W",880).
...
component("YHR128W",502).
component("YPR176C",879).
component("YPL172C",845).
component("YNR041C",765).
...
component("YNL256W",747).
component("YPR069C",869).
component("YDR127W",319).
component("YHR190W",510).
component("YLR146C",653).
component("YHR068W",494).
component("YLR303W",669).
component("YGR012W",443).
component("YML082W",694).
component("YJR130C",588).
component("YDR035W",306).
component("YBR249C",235).
component("YLR180W",658).
component("YDR502C",355).
component("YOR274W",816).
component("YBR256C",237).
component("YHR137W",503).
component("YGL202W",437).
component("YLR027C",639).
component("YKL106W",603).
component("YOL140W",790).
component("YLR438W",682).
...
component("YKL067W",601).
component("YOL055C",777).
component("YDR454C",352).
component("YJR057W",578).
component("YOL061W",781).
component("YKL181W",611).
component("YHL011C",478).
component("YER099C",395).
component("YBL068W",194).
component("YOR143C",802).
component("YNL256W",748).
component("YLR328W",671).
component("YBR018C",200).
component("YBR018C",201).
component("YGR007W",442).
component("YGR202C",462).
...
component("YPR010C",863).
component("YOR341W",821).
component("YOR340C",820).
component("YOR224C",814).
component("YOR210W",811).
component("YOR207C",809).
component("YOR151C",803).
component("YOR116C",798).
component("YOL005C",771).
component("YNR003C",758).
component("YNL248C",746).
component("YNL151C",740).
component("YNL113W",737).
component("YKL144C",606).
component("YJR063W",579).
component("YJL148W",561).
component("YJL140W",560).
component("YIL021W",516).
component("YHR143W-A",504).
...
component("YPR175W",878).
component("YPL167C",843).
component("YOR330C",818).
component("YOL115W",788).
component("YNL299W",755).
component("YNL262W",750).
component("YNL102W",735).
...
component("YKL035W",599).
component("YHL012W",479).
component("YHR123W",501).
...
component("YOR208W",810).
component("YNL053W",732).
component("YMR036C",702).
component("YIR026C",541).
component("YIL113W",527).
...
component("U25_",112).
component("U24_",111).
component("YHR044C",490).
component("YHR043C",489).
component("YOL064C",782).
component("YOR360C",824).
component("YKR031C",626).
component("YPL206C",849).
component("YGL027C",424).
component("YLR286C",666).
component("YJR153W",593).
component("YJL221C",570).
component("YJL216C",568).
component("YIL172C",539).
component("YGR292W",477).
component("YGR287C",476).
component("YBR299W",244).
component("YBR184W",227).
component("YIL162W",536).
component("YIR019C",540).
component("YIL099W",525).
component("YDL037C",267).
component("YOR190W",807).
...
component("YNL220W",743).
component("YOL058W",779).
component("YDL141W",287).
component("YHR074W",496).
...
component("YNR016C",761).
component("YKL182W",614).
component("YGR037C",446).
component("YPR138C",876).
component("YPL265W",857).
component("YPL134C",840).
component("YPL057C",835).
component("YPL036W",834).
component("YOR348C",823).
component("YOR222W",813).
component("YOR171C",805).
component("YOR130C",800).
component("YOR011W",793).
component("YOL156W",792).
component("YOL103W",787).
component("YOL020W",774) :- not remove_orf("YOL020W",774).
component("YNR072W",770).
component("YNR056C",767).
component("YNL318C",757).
component("YNL270C",751).
component("YNL142W",739).
component("YMR272C",722).
component("YMR202W",716).
component("YMR011W",700).
component("YLR348C",674).
component("YLR260W",665).
component("YLR138W",651).
component("YLR100C",649).
component("YLR081W",647).
component("YLL061W",638).
component("YLL043W",636).
component("YKR093W",632).
component("YKR053C",628).
component("YKR039W",627) :- not remove_orf("YKR039W",627).
component("YKL217W",623).
component("YJR158W",594).
component("YJR095W",584).
component("YJR077C",582).
component("YJL219W",569).
component("YJL214W",567).
component("YJL134W",559).
component("YJL129C",556).
component("YIL134W",530).
component("YHR096C",499).
component("YHR094C",498).
component("YHR092C",497).
component("YHL036W",481).
...
catalyst(2300,172).
catalyst(3460,138).
catalyst(3600,620) :- not remove_reaction(3600,620).
catalyst(8000,633).
catalyst(3941,776).
catalyst(3942,776).
catalyst(6890,741).
...
catalyst(4560,366).
catalyst(2550,764).
catalyst(1890,621) :- not remove_reaction(1890,621).
catalyst(3630,621) :- not remove_reaction(3630,621).
...
catalyst(1210,792).
catalyst(1160,787).
catalyst(801,774) :- not remove_reaction(801,774).
catalyst(802,774) :- not remove_reaction(802,774).
catalyst(811,774) :- not remove_reaction(811,774).
catalyst(812,774) :- not remove_reaction(812,774).
catalyst(831,774) :- not remove_reaction(831,774).
catalyst(832,774) :- not remove_reaction(832,774).
catalyst(901,774) :- not remove_reaction(901,774).
catalyst(902,774) :- not remove_reaction(902,774).
catalyst(1180,770).
catalyst(1210,770).
catalyst(700,767).
catalyst(1200,757).
...
catalyst(650,632).
catalyst(6560,628).
catalyst(771,627) :- not remove_reaction(771,627).
catalyst(772,627) :- not remove_reaction(772,627).
catalyst(781,627) :- not remove_reaction(781,627).
catalyst(782,627) :- not remove_reaction(782,627).
catalyst(791,627) :- not remove_reaction(791,627).
catalyst(792,627) :- not remove_reaction(792,627).
...
catalyst(841,627) :- not remove_reaction(841,627).
catalyst(842,627) :- not remove_reaction(842,627).
catalyst(851,627) :- not remove_reaction(851,627).
catalyst(852,627) :- not remove_reaction(852,627).
catalyst(881,627) :- not remove_reaction(881,627).
catalyst(882,627) :- not remove_reaction(882,627).
catalyst(901,627) :- not remove_reaction(901,627).
catalyst(902,627) :- not remove_reaction(902,627).
catalyst(911,627) :- not remove_reaction(911,627).
catalyst(912,627) :- not remove_reaction(912,627).
catalyst(921,627) :- not remove_reaction(921,627).
catalyst(922,627) :- not remove_reaction(922,627).
catalyst(931,627) :- not remove_reaction(931,627).
catalyst(932,627) :- not remove_reaction(932,627).
catalyst(1191,627) :- not remove_reaction(1191,627).
catalyst(1192,627) :- not remove_reaction(1192,627).
catalyst(390,623).
catalyst(1180,594).
catalyst(1210,594).
catalyst(1250,584).
