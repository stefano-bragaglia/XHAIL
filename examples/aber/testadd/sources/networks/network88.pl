...
component("YNL280C",529).
component("YLR056W",452).
component("YGL012W",283).
component("YKR009C",435).
component("YOL086C",550).
component("YMR303C",505).
component("YGL256W",303).
component("YDL168W",193).
component("YBR145W",148).
component("YPL231W",603).
component("YBR265W",159).
component("U46_",86).
component("YBR149W",149).
component("YBR149W",150).
component("YGL001C",280).
component("YIL094C",364).
component("U45_",85).
component("YML056C",487).
component("YLR432W",483).
component("YHR216W",358).
component("YAR075W",126).
component("YAR073W",125).
component("YDR127W",209).
component("YOL126C",555).
component("YKL085W",421).
component("YDL078C",183).
component("YNL037C",510).
component("YNL009W",508).
component("YLR174W",462).
component("YOL059W",548).
component("YDL022W",179).
component("YCL018W",167).
component("YLR355C",478).
component("YDL174C",196).
component("YML086C",489).
component("YGR088W",311).
component("YDR256C",220).
component("YJR078W",410).
component("YJR025C",403).
component("U107_",24).
component("YHR007C",332).
component("YJR104C",412).
component("YHR008C",333).
component("YOR384W",586).
component("YOR381W",585).
component("YOL152W",557).
component("YLL051C",445).
component("YJL026W",378).
component("YIL066C",362).
component("YGR180C",314).
component("YER070W",259).
component("U37_",79).
component("U36_",78).
component("YDL168W",194).
component("YJR009C",401).
component("YJL052W",380).
component("YGR192C",316).
component("YBR006W",134).
component("YPL276W",611).
component("YPL275W",610).
component("YOR388C",587).
component("YOR374W",583).
component("YER073W",260).
component("YGL154C",295).
component("U55_",92).
component("YER069W",257).
component("YOR323C",576).
component("YER178W",266).
component("YBR221C",156).
component("YIL125W",368).
component("U52_",90).
component("YBR166C",152).
component("YGL012W",284).
component("YKL216W",434).
component("YKR009C",436).
component("YIL160C",372).
component("YGL205W",300).
component("YMR118C",497).
component("YLR164W",460).
component("YLL041C",444).
component("YKL148C",425).
component("YKL141W",423).
component("YJL045W",379).
component("YDR178W",216).
component("YEL047C",246).
component("YDL171C",195).
component("YOR375C",584).
component("YAL062W",123).
component("U99_",118).
component("U100_",20).
component("YKR080W",441).
component("YER023W",251).
component("YOR236W",574).
component("YGR204W",317).
component("YLR142W",458).
component("U65_",98).
component("U63_",96).
component("U62_",95).
component("YHR068W",341).
component("YKL150W",426).
component("YIL043C",361).
component("YPL171C",598).
component("YHR179W",353).
component("YMR145C",500).
component("YML120C",490).
component("YKL192C",431).
component("YDL085W",185).
component("YGR234W",319).
component("YFR030W",277).
component("YPL017C",589).
component("YFL018C",270).
component("YDR353W",227).
component("YPR167C",623).
component("YJR137C",414).
component("YNL052W",512).
component("YMR256C",504).
component("YLR395C",482).
component("YLR038C",450).
component("YIL111W",365).
component("YHR051W",340).
component("YGL191W",298).
component("YGL187C",297).
component("YDL067C",182).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",609).
component("YKR069W",440).
component("YOL096C",551).
component("U47_",87).
component("YJR073C",408).
component("YDR120C",207).
component("YML008C",484).
component("YDL033C",181).
component("YLR172C",461).
component("YLR058C",453).
component("YDR019C",202).
component("YBR176W",153).
component("YDR408C",232).
component("YMR120C",498).
component("YLR028C",448).
component("YBL013W",127).
component("YJL130C",388).
component("YKL024C",419).
component("YPR074C",619).
component("YBR117C",147).
component("YCL009C",166).
component("YNL071W",514).
component("YNR008W",534).
component("YIL160C",373).
component("U48_",88).
component("YPL231W",604).
component("YPL231W",605).
component("YPL028W",590).
component("YLR299W",471).
component("YGL017W",285).
component("YML126C",491).
component("YNL104C",517).
component("YDL182W",197).
component("YDL131W",189).
component("YLR258W",468).
component("YFR015C",275).
component("YNL029C",509).
component("YIL085C",363).
component("YMR306W",506).
component("YLR342W",477).
component("YGR032W",306).
component("YLR209C",464).
component("U104_",21).
component("YDR354W",228) :- not remove_orf("YDR354W",228).
component("YFR047C",278).
component("YLR209C",465).
component("YML022W",485).
component("YDR441C",234).
component("YJL167W",393).
component("YJL167W",394).
component("YDR127W",210).
component("YHR068W",342).
component("YLR303W",473).
component("YGR012W",304).
component("YML082W",488).
component("YJR130C",413).
component("YDR035W",203).
component("YBR249C",157).
component("YLR180W",463).
component("YDR502C",237).
component("YOR274W",575).
component("YHR137W",349).
component("YGL202W",299).
component("YLR027C",447).
component("YKL106W",422).
component("YOL140W",556).
component("YGR019W",305).
component("YLR089C",455).
component("U64_",97).
component("U61_",94).
component("YJR148W",415).
component("YFL030W",271).
component("YOR184W",568).
component("YNR058W",539).
component("YIL116W",367).
component("YGL253W",302).
component("YFR053C",279).
component("YMR013C",495).
component("YMR205C",501).
component("YGR240C",320).
component("YOL016C",543).
component("YFR014C",274).
component("YCR036W",176).
component("YCL040W",169).
component("U15_",43).
component("YPL188W",599).
component("YJR049C",405).
component("YEL041W",244).
component("U96_",116).
component("YKL001C",418).
component("YDR236C",218).
component("YHL032C",330).
component("YDR531W",241).
component("U83_",112).
component("U81_",111).
component("YMR208W",502).
component("YPL203W",600).
component("YOR061W",560).
component("YKL166C",428).
component("YJL164C",392).
component("YIL035C",360).
component("YHR205W",356).
component("YHR102W",348).
component("YGL019W",286).
component("YHR025W",336).
component("YOR347C",581).
component("YAL038W",121).
component("YNR012W",535).
component("YDR127W",211).
component("YDR147W",214).
component("YCR012W",171).
component("YER069W",258).
component("U76_",107).
component("YER170W",265).
component("YDR226W",217).
component("YKL067W",420).
component("YOL055C",546).
component("YDR454C",235).
component("YJR057W",406).
component("YOL061W",549).
component("YKL181W",429).
component("YHL011C",329).
component("YER099C",264).
component("YBL068W",132).
component("YOR143C",564).
component("YNL256W",526).
component("YLR328W",475).
component("YBR018C",136).
component("YLR328W",476).
component("U94_",115).
component("YBR029C",139).
component("YGL130W",293).
component("YDR530C",240).
component("YPR190C",626).
component("YPR187W",625).
component("YPR110C",620).
component("YPR010C",614).
component("YOR341W",580).
component("YOR340C",579).
component("YOR224C",573).
component("YOR210W",572).
component("YOR207C",570).
component("YOR151C",565).
component("YOR116C",562).
component("YOL005C",541).
component("YNR003C",533).
component("YNL248C",525).
component("YNL151C",521).
component("YNL113W",518).
component("YKL144C",424).
component("YJR063W",407).
component("YJL148W",391).
component("YJL140W",390).
component("YIL021W",359).
component("YHR143W-A",350).
component("YGL070C",291).
component("YFL036W",272).
component("YDR404C",231).
component("YDR156W",215).
component("YDR045C",204).
component("YDL150W",192).
component("YDL140C",190).
component("YBR154C",151).
component("YPR175W",624).
component("YPL167C",597).
component("YOR330C",577).
component("YOL115W",554).
component("YNL299W",531).
component("YNL262W",527).
component("YNL102W",516).
component("YJR043C",404).
component("YJR006W",400).
component("YJL090C",383).
component("YIL139C",370).
component("YEL055C",247).
component("YDR419W",233).
component("YDR121W",208).
component("YDL102W",188).
component("YCR014C",172).
component("YBR278W",161).
component("YBL035C",130).
component("YPR113W",621).
component("YPL148C",595).
component("YGR286C",326).
component("YHR189W",354).
component("YDR058C",206).
component("YDL086W",186).
component("YOL011W",542).
component("YMR008C",493).
component("YMR006C",492).
component("U105_",22).
component("YBL015W",128).
component("YJL068C",381).
component("U77_",108).
component("YLR377C",480).
component("YPR073C",617).
component("YHR215W",357).
component("YDL024C",180).
component("YBR093C",145).
component("YBR092C",144).
component("YHR046C",339).
component("U9_",119).
component("YDL236W",199).
component("YPR073C",618).
component("YOR208W",571).
component("YNL053W",513).
component("YMR036C",496).
component("YIR026C",377).
component("YIL113W",366).
component("YFR028C",276).
component("YER075C",261).
component("YDL230W",198).
component("YBR276C",160).
component("U34_",77).
component("U32_",76).
component("U31_",75).
component("U30_",74).
...
component("U25_",71).
component("U24_",70).
component("YHR044C",338).
component("YHR043C",337).
component("YOR360C",582).
component("YKR031C",437).
component("YPL206C",601).
component("YGL027C",288).
component("YLR286C",470).
component("YJR153W",416).
component("YJL221C",399).
component("YJL216C",397).
component("YIL172C",376).
component("YGR292W",328).
component("YGR287C",327).
component("YBR299W",165).
component("YOR190W",569).
component("YLR300W",472).
component("YGR282C",325).
component("YDR261C",221).
component("YDR400W",230).
component("YML035C",486).
component("YJL070C",382).
component("YBR284W",162).
component("U106_",23).
component("YER043C",252).
component("YNL045W",511).
component("YDR242W",219).
component("U53_",91).
component("YPR062W",616).
component("YMR120C",499).
component("YLR028C",449).
component("YHR144C",351).
component("YGR267C",324).
component("YBL033C",129).
component("YNL141W",519).
component("YLR245C",467).
component("YBR084W",142).
component("YJL126W",386).
component("U44_",84).
component("YDL100C",187).
component("U40_",82).
component("U39_",80).
component("YBR011C",135).
component("YHR201C",355).
component("YBR111C",146).
component("YBR252W",158).
component("YER005W",250).
component("YBL099W",133).
component("YLR231C",466).
component("YLR134W",457).
component("YLR044C",451).
component("YGR087C",310).
component("YDR380W",229).
component("YDL080C",184).
component("U98_",117).
component("YMR250W",503).
component("YOR128C",563).
component("U93_",114).
component("YKL211C",432) :- not remove_orf("YKL211C",432).
component("YKR097W",442).
component("YNL169C",522).
component("YEL046C",245).
component("YNR033W",537).
component("YKL211C",433) :- not remove_orf("YKL211C",433).
component("YER090W",433) :- not remove_orf("YER090W",433).
component("YER090W",263) :- not remove_orf("YER090W",263).
component("YDR127W",212).
component("YPL281C",612).
component("YOR393W",588).
component("YMR323W",507).
component("YHR174W",352).
component("YGR254W",322).
component("YPL262W",607).
component("YGL026C",287) :- not remove_orf("YGL026C",287).
component("YLR304C",474).
component("YJL200C",395).
component("YNL316C",532).
component("YPL212C",602).
component("YNL292W",530).
component("YGL063W",290).
component("YFL001W",268).
component("YPR002W",613).
component("YJR016C",402).
component("YCR053W",177).
component("YDR127W",213).
component("YGL148W",294).
component("YIL168W",375).
component("YIL167W",374).
component("YCL064C",170).
component("YLR359W",479).
component("YAL012W",120).
component("YJL121C",385).
component("YBR019C",137).
component("YDR007W",201) :- not remove_orf("YDR007W",201).
component("YOR095C",561).
component("YBR196C",154).
component("YGL001C",281).
component("YPL117C",594).
component("U14_",37).
component("YOL056W",547).
component("YKL152C",427).
component("YDL021W",178).
component("YPR060C",615).
component("YHR072W",343).
component("YPL097W",592).
component("YGR185C",315).
component("YGR264C",323).
component("YGR171C",313).
component("YPL104W",593).
component("YLL018C",443).
component("YHR020W",335).
component("YER087W",262).
component("YNL247W",524).
component("YOR168W",566).
component("YOL097C",552).
component("YDR268W",222).
component("YCR024C",173).
component("YHR019C",334).
component("YPL160W",596).
component("YLR382C",481).
component("YNL073W",515).
component("YOR335C",578).
component("YLR153C",459).
component("YAL054C",122).
component("YGR244C",321).
component("YIL145C",371).
component("YJL101C",384).
component("YOL049W",545).
component("YAR015W",124).
component("YER183C",267).
component("U90_",113).
component("YNR057C",538).
component("YGL234W",301).
component("YJR103W",411).
component("YBL039C",131).
component("YGR204W",318).
component("YBR084W",143).
component("YNL220W",523).
component("YDL141W",191).
component("YHR074W",344).
component("YGL062W",289).
component("YBR218C",155).
component("YPL231W",606).
component("YNR016C",536).
component("YKL182W",430).
component("YGR037C",307).
component("YPR138C",622).
component("YPL265W",608).
component("YPL036W",591).
component("YOR171C",567).
component("YOR011W",559).
component("YOL156W",558).
component("YOL103W",553).
component("YOL020W",544) :- not remove_orf("YOL020W",544).
component("YNR072W",540).
component("YNL270C",528).
component("YNL142W",520).
component("YMR011W",494).
component("YLR260W",469).
component("YLR100C",456).
component("YLR081W",454).
component("YLL061W",446).
component("YKR053C",439).
component("YKR039W",438) :- not remove_orf("YKR039W",438).
component("YJR158W",417).
component("YJR077C",409).
component("YJL219W",398).
component("YJL214W",396).
component("YJL134W",389).
component("YJL129C",387).
component("YIL134W",369).
component("YHR096C",347).
component("YHR094C",346).
component("YHR092C",345).
component("YHL036W",331).
component("YGR121C",312).
component("YGR065C",309).
component("YGR055W",308).
component("YGL186C",296).
component("YGL077C",292).
component("YGL008C",282).
component("YFL055W",273).
component("YFL011W",269).
component("YER060W-A",256).
component("YER060W",255).
component("YER056C",254).
component("YER053C",253).
component("YEL069C",249).
component("YEL063C",248).
component("YEL017C-A",243).
component("YDR536W",242).
component("YDR508C",239).
component("YDR503C",238).
component("YDR497C",236).
component("YDR345C",226).
component("YDR343C",225).
component("YDR342C",224).
component("YDR297W",223).
component("YDR046C",205) :- not remove_orf("YDR046C",205).
component("YDL245C",200).
component("YCR032W",175).
component("YCR024C-A",174).
component("YCL025C",168).
component("YBR298C",164).
component("YBR291C",163).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,228) :- not remove_reaction(3620,228).
catalyst(2110,278).
catalyst(2190,278).
catalyst(5791,465).
catalyst(5792,465).
...
catalyst(6112,563).
catalyst(2300,114).
catalyst(3600,432) :- not remove_reaction(3600,432).
catalyst(8000,442).
catalyst(6890,522).
catalyst(4560,245).
catalyst(2550,537).
...
catalyst(1890,263) :- not remove_reaction(1890,263).
catalyst(3630,263) :- not remove_reaction(3630,263).
catalyst(3740,212).
catalyst(8231,612).
catalyst(8232,612).
catalyst(8231,588).
...
catalyst(8051,607).
catalyst(8052,607).
catalyst(3590,287) :- not remove_reaction(3590,287).
catalyst(10910,287) :- not remove_reaction(10910,287).
catalyst(8181,474).
catalyst(8182,474).
catalyst(8181,395).
catalyst(8182,395).
...
catalyst(7751,137).
catalyst(7752,137).
catalyst(3610,201) :- not remove_reaction(3610,201).
catalyst(7921,561).
catalyst(7922,561).
catalyst(8341,154).
catalyst(8342,154).
...
catalyst(750,446).
catalyst(6560,439).
catalyst(771,438) :- not remove_reaction(771,438).
catalyst(772,438) :- not remove_reaction(772,438).
catalyst(781,438) :- not remove_reaction(781,438).
catalyst(782,438) :- not remove_reaction(782,438).
catalyst(801,438) :- not remove_reaction(801,438).
catalyst(802,438) :- not remove_reaction(802,438).
catalyst(811,438) :- not remove_reaction(811,438).
catalyst(812,438) :- not remove_reaction(812,438).
catalyst(831,438) :- not remove_reaction(831,438).
catalyst(832,438) :- not remove_reaction(832,438).
catalyst(841,438) :- not remove_reaction(841,438).
catalyst(842,438) :- not remove_reaction(842,438).
catalyst(851,438) :- not remove_reaction(851,438).
catalyst(852,438) :- not remove_reaction(852,438).
catalyst(881,438) :- not remove_reaction(881,438).
catalyst(882,438) :- not remove_reaction(882,438).
catalyst(901,438) :- not remove_reaction(901,438).
catalyst(902,438) :- not remove_reaction(902,438).
catalyst(921,438) :- not remove_reaction(921,438).
catalyst(922,438) :- not remove_reaction(922,438).
catalyst(931,438) :- not remove_reaction(931,438).
catalyst(932,438) :- not remove_reaction(932,438).
catalyst(1191,438) :- not remove_reaction(1191,438).
catalyst(1192,438) :- not remove_reaction(1192,438).
catalyst(1210,417).
catalyst(1581,409).
catalyst(1582,409).
catalyst(1210,398).
...
catalyst(851,205) :- not remove_reaction(851,205).
catalyst(852,205) :- not remove_reaction(852,205).
catalyst(901,205) :- not remove_reaction(901,205).
catalyst(902,205) :- not remove_reaction(902,205).
catalyst(1210,200).
catalyst(431,175).
catalyst(432,175).
catalyst(220,174).
