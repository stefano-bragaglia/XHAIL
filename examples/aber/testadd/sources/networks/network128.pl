...
component("YGR060W",410).
component("YGL012W",381).
component("YKR009C",576).
component("YOL086C",719).
component("YMR303C",667).
component("YMR083W",654).
component("YGL256W",403).
component("YDL168W",257).
component("YBR145W",193).
component("YPL231W",783).
component("YBR265W",209).
component("U46_",114).
component("YBR149W",194).
component("YBR149W",195).
component("YGL001C",378).
component("YIL094C",482).
component("U45_",113).
component("YML056C",641).
component("YLR432W",631).
component("YHR216W",474).
component("YAR075W",165).
component("YAR073W",164).
component("YDR127W",283).
component("YJR139C",547).
component("YML075C",643).
component("YLR450W",634).
component("YOL126C",725).
component("YKL085W",557).
component("YDL078C",241).
component("YNL037C",672).
component("YNL009W",670).
component("YLR174W",608).
component("YHR183W",467).
component("YGR256W",431).
component("YNL241C",686).
component("YOL059W",716).
component("YDL022W",234).
component("YCL018W",217).
component("YLR355C",626).
component("YIL074C",479).
component("YER081W",353).
component("YDL174C",261).
component("YML086C",645).
component("YIL155C",491).
component("YEL024W",329).
component("YKR066C",581).
component("YGR088W",414).
component("YDR256C",297).
component("YKL026C",553).
component("YIR037W",501).
component("YBR244W",204).
component("YJR078W",540).
component("U58_",123).
component("YJR025C",532).
component("U107_",24).
component("YHR007C",442).
component("YDR402C",311).
component("YGL055W",388).
component("YJR104C",542).
component("YHR008C",443).
component("YOR384W",762).
component("YOR381W",761).
component("YOL152W",727).
component("YLL051C",588).
component("YJL026W",503).
component("YIL066C",478).
component("YGR180C",421).
component("YER070W",350).
component("U37_",107).
component("U36_",106).
component("U35_",105).
component("YDL168W",258).
component("YDR158W",291).
component("YJR009C",529).
component("YJL052W",505).
component("YGR192C",423).
component("YBR006W",175).
component("YPL276W",791).
component("YPL275W",790).
component("YOR388C",763).
component("YPL061W",768).
component("YOR374W",759).
component("YER073W",351).
component("YGL154C",395).
component("YBR115C",189).
component("U55_",122).
component("YER069W",348).
component("YOR323C",751).
component("YER178W",362).
component("YBR221C",202).
component("YIL125W",487).
component("U52_",119).
component("YBR166C",197).
component("YGL012W",382).
component("YKL182W",566).
component("YKL216W",575).
component("YDR044W",274).
component("YKR009C",577).
component("YIL160C",492).
component("YGL205W",400).
component("YMR118C",656).
component("YLR164W",606).
component("YLL041C",587).
component("YKL148C",561).
component("YKL141W",559).
component("YJL045W",504).
component("YDR178W",292).
component("YEL047C",332).
component("YDL171C",259).
component("YDL171C",260).
component("YOR375C",760).
...
component("YOR236W",749).
component("YGR204W",425).
component("YIR034C",500).
component("YLR142W",603).
component("U65_",129).
component("U63_",127).
component("U62_",126).
component("YHR068W",453).
component("YKL150W",562).
component("YIL043C",477).
component("YHR042W",448).
component("YOR221C",746).
component("YMR145C",659).
component("YKL192C",569).
component("YKL055C",555).
component("YER061C",346).
component("YDL085W",243).
component("YPL171C",776).
component("YHR179W",466).
component("YMR145C",660).
component("YML120C",646).
component("YKL192C",570).
component("YDL085W",244).
component("YGR234W",427).
component("YFR030W",374).
component("YPL017C",765).
component("YFL018C",366).
component("YDR353W",307).
component("YPR167C",806).
component("YJR137C",546).
component("YNL052W",674).
component("YMR256C",666).
component("YLR395C",630).
component("YLR038C",593).
component("YIL111W",484).
component("YHR051W",452).
component("YGL191W",398).
component("YGL187C",397).
component("YDL067C",240).
component("Q0275",19).
component("Q0250",18).
component("YDR072C",279).
component("YPL266W",789).
component("YKR069W",582).
component("YOL096C",720).
component("U47_",115).
component("YER091C",358).
component("YJR073C",538).
component("YGR157W",419).
component("YDR120C",281).
component("YML008C",636).
component("YOR074C",732).
component("YDL033C",236).
component("YOL096C",721).
component("YLR172C",607).
component("YLR058C",596).
component("YDR019C",271).
component("YBR176W",198).
component("YDR408C",313).
component("YMR120C",657).
component("YLR028C",591).
component("YBL013W",166).
component("YJL130C",514).
component("YJL088W",508).
component("YKL024C",552).
component("YPR074C",801).
component("YBR117C",190).
component("YMR108W",655).
component("YCL009C",216).
component("YNL071W",676).
component("YNR008W",698).
component("YIL160C",493).
component("YNR019W",701).
component("YCR048W",230).
component("U48_",116).
component("YMR062C",653).
component("YDR232W",294).
component("YPL231W",784).
component("YER061C",347).
component("YDL052C",239).
component("U8_",150).
component("YDR148C",289).
component("YPL231W",785).
component("YPL028W",766).
component("YLR299W",618).
component("YGL017W",383).
component("YCR005C",222).
component("YML126C",647).
component("YNL104C",679).
component("YDL182W",262).
component("YDL131W",248).
component("YDR307W",303).
component("YLR258W",615).
component("YFR015C",372).
component("YNL029C",671).
component("YIL085C",481).
component("YMR306W",668).
component("YLR342W",624).
component("YGR032W",407).
component("YBR248C",205).
component("YLR209C",610).
component("U104_",21).
component("YDR354W",308) :- not remove_orf("YDR354W",308).
component("YFR047C",375).
component("YJR133W",545).
component("YLR209C",611).
component("YML022W",638).
component("YDR441C",316).
component("YHR128W",461).
component("YJL167W",521).
component("YJL167W",522).
component("YPR069C",798).
component("YDR127W",284).
component("YHR190W",469).
component("YLR146C",604).
component("YHR068W",454).
component("YLR303W",620).
component("YGR012W",405).
component("YML082W",644).
component("YJR130C",544).
component("YDR035W",273).
component("YBR249C",206).
component("YLR180W",609).
component("YDR502C",320).
component("YOR274W",750).
component("YBR256C",208).
component("YHR137W",462).
component("YGL202W",399).
component("YLR027C",590).
component("YKL106W",558).
component("YOL140W",726).
component("YLR438W",633).
component("YGR019W",406).
component("YLR089C",599).
component("U64_",128).
component("U61_",125).
component("U51_",118).
component("YJR148W",548).
component("YHR208W",472).
component("YFL030W",368).
component("YOR184W",741).
component("YNR058W",706).
component("YIL116W",486).
component("YGL253W",402).
component("YFR053C",376).
component("YMR013C",651).
component("YMR205C",662).
component("YGR240C",428).
component("YOL016C",710).
component("YFR014C",371).
component("YLR240W",613).
component("YKL203C",572).
component("YJR066W",537).
component("YCR036W",229).
component("YCL040W",219).
component("U15_",54).
component("YPL188W",778).
component("YJR049C",534).
component("YEL041W",330).
component("U96_",154).
component("YKL001C",551).
component("YDR236C",295).
component("YHL032C",440).
component("YDR531W",324).
component("U83_",145).
component("U82_",144).
component("U81_",143).
component("YMR208W",663).
component("YPL203W",779).
component("YOR061W",731).
component("YKL166C",564).
component("YJL164C",520).
component("YIL035C",476).
component("YHR205W",471).
component("YHR102W",460).
component("YGL019W",384).
component("YHR025W",447).
component("YOR347C",756).
component("YAL038W",159).
component("YNR012W",699).
component("YDR009W",270).
component("YDR127W",285).
component("YDR147W",288).
component("YDR300C",302).
component("YCR012W",223).
component("YER069W",349).
component("U19_",82).
component("U18_",74).
component("U17_",66).
component("U76_",138).
component("YER170W",361).
component("YDR226W",293).
component("YKL067W",556).
component("YOL055C",713).
component("YDR454C",317).
component("YJR057W",535).
component("YOL061W",717).
component("YKL181W",565).
component("YHL011C",438).
component("YER099C",359).
component("YBL068W",173).
component("YOR143C",737).
component("YNL256W",689).
component("YLR328W",622).
component("YBR018C",177).
component("YGR007W",404).
component("YGR202C",424).
component("YLR328W",623).
component("U80_",142).
component("U94_",153).
component("YJR010W",530).
component("YBR029C",180).
component("YCL050C",220).
component("YGL130W",393).
component("YDR530C",323).
component("YPR190C",809).
component("YPR187W",808).
component("YPR110C",803).
component("YPR010C",794).
component("YOR341W",755).
component("YOR340C",754).
component("YOR224C",748).
component("YOR210W",745).
component("YOR207C",743).
component("YOR151C",738).
component("YOR116C",734).
component("YOL005C",708).
component("YNR003C",697).
component("YNL248C",688).
component("YNL151C",683).
component("YNL113W",680).
component("YKL144C",560).
component("YJR063W",536).
component("YJL148W",518).
component("YJL140W",517).
component("YIL021W",475).
component("YHR143W-A",463).
component("YGL070C",391).
component("YFL036W",369).
component("YDR404C",312).
component("YDR156W",290).
component("YDR045C",275).
component("YDL150W",256).
component("YDL140C",250).
component("YBR154C",196).
component("YPR175W",807).
component("YPL167C",775).
component("YOR330C",752).
component("YOL115W",724).
component("YNL299W",695).
component("YNL262W",691).
component("YNL102W",678).
component("YJR043C",533).
component("YJR006W",528).
component("YJL090C",509).
component("YIL139C",489).
component("YEL055C",333).
component("YDR419W",314).
component("YDR121W",282).
...
component("YPR113W",804).
component("YBR243C",203).
component("YDL142C",255).
component("YPL148C",773).
component("YER026C",340).
component("YGR286C",435).
component("YHR189W",468).
component("YDR058C",278).
component("YDL086W",245).
component("YOL011W",709).
component("YMR008C",649).
component("YMR006C",648).
component("U105_",22).
component("YBL015W",167).
component("YJL068C",506).
component("YOR040W",730).
component("U77_",139).
component("YDR481C",318).
component("YLR377C",628).
component("YPL179W",777).
component("YNR032W",702).
component("YML057W",642).
component("YML016C",637).
component("YLR433C",632).
component("YGR123C",417).
component("YER133W",360).
component("YER089C",356).
component("YDR436W",315).
component("YDR075W",280).
component("YDL188C",263).
component("YDL134C",249).
component("YDL047W",238).
component("YDL006W",232).
component("YBR125C",192).
component("YBL056W",172).
component("YPR073C",799).
component("YHR215W",473).
...
component("U9_",157).
component("YPL228W",782).
component("YMR180C",661).
component("YDL236W",267).
component("YJL155C",519).
component("YPR073C",800).
component("YOR208W",744).
component("YNL053W",675).
component("YMR036C",652).
component("YIR026C",499).
component("YIL113W",485).
component("YFR028C",373).
component("YER075C",352).
...
component("U25_",96).
component("U24_",95).
component("YHR044C",450).
component("YHR043C",449).
component("YOL064C",718).
component("YOR360C",758).
component("YKR031C",578).
component("YPL206C",780).
component("YGL027C",386).
component("YLR286C",617).
component("YJR153W",549).
component("YJL221C",527).
component("YJL216C",525).
component("YIL172C",497).
component("YGR292W",437).
component("YGR287C",436).
component("YBR299W",215).
component("YBR184W",199).
component("YIL162W",494).
component("YIR019C",498).
component("YIL099W",483).
component("YDL037C",237).
component("YOR190W",742).
component("YLR300W",619).
component("YGR282C",434).
component("YDR261C",298).
component("YDR400W",310).
component("YML035C",639).
component("YJL070C",507).
component("YBR284W",212).
component("U106_",23).
component("YER043C",341).
component("YNL045W",673).
component("YGL037C",387).
component("YDR242W",296).
component("U53_",120).
component("YPR062W",797).
component("YMR120C",658).
component("YLR028C",592).
component("YHR144C",464).
component("YGR267C",433).
component("YBL033C",168).
component("YNL141W",681).
component("YLR245C",614).
component("YML035C",640).
component("YBR084W",184).
component("YJL126W",512).
component("U44_",112).
...
component("U88_",148).
component("YDR538W",326).
component("YLR134W",601).
component("YLR044C",594).
component("YGR087C",413).
component("YDR380W",309).
component("YDL080C",242).
component("U98_",155).
component("YMR250W",665).
component("YOR128C",735).
component("YEL021W",328).
component("YNR043W",704).
component("U93_",152).
component("U54_",121).
component("YKL211C",573) :- not remove_orf("YKL211C",573).
component("YKR097W",585).
component("YNL169C",684).
component("YNL256W",690).
component("YDR294C",300).
component("YEL046C",331).
component("YNR033W",703).
...
component("YPL281C",792).
component("YOR393W",764).
component("YMR323W",669).
component("YHR174W",465).
component("YGR254W",430).
component("YPL262W",787).
component("YGL026C",385) :- not remove_orf("YGL026C",385).
component("YGR155W",418).
component("YLR304C",621).
component("YJL200C",523).
component("YNL316C",696).
component("YKL182W",567).
component("YPL212C",781).
component("YNL292W",694).
component("YGL063W",390).
component("YFL001W",364).
component("YPR002W",793).
component("YJR016C",531).
component("YCR053W",231).
component("YDR127W",287).
component("YGL148W",394).
component("YIL168W",496).
component("YIL167W",495).
component("YCL064C",221).
component("YER086W",354).
component("YLR359W",627).
component("YAL012W",158).
component("YML004C",635).
component("YFR055W",377).
component("YJL005W",502).
component("YJL121C",511).
component("YBR019C",178).
component("YDR050C",277).
component("YDR007W",269) :- not remove_orf("YDR007W",269).
component("YOR095C",733).
component("YER003C",337).
component("YBR196C",200).
component("YGL001C",379).
component("YPL117C",771).
component("U14_",46).
component("YOL056W",714).
component("YKL152C",563).
component("YDL021W",233).
component("YEL058W",334).
component("YPR060C",796).
component("YHR072W",455).
component("YPL097W",769).
component("YGR185C",422).
component("YGR264C",432).
component("YGR171C",420).
component("YHR011W",444).
component("YDR023W",272).
component("YPL104W",770).
component("YLL018C",586).
component("YPR081C",802).
component("YBR121C",191).
component("YHR020W",446).
component("YER087W",355).
component("YNL247W",687).
component("YOR168W",739).
component("YOL097C",722).
component("YDR268W",299).
component("YPR047W",795).
component("YLR060W",597).
component("YFL022C",367).
component("YCR024C",225).
component("YHR019C",445).
component("YKL194C",571).
component("YIL078W",480).
component("YPL160W",774).
component("YLR382C",629).
component("YNL073W",677).
component("YOR335C",753).
component("YGR094W",415).
component("YLR153C",605).
component("YAL054C",160).
component("YGR244C",429).
component("YIL145C",490).
component("U89_",149).
component("YJL101C",510).
component("YOL049W",712).
component("YAR015W",162).
component("YER183C",363).
component("U90_",151).
component("YNR057C",705).
component("YDL141W",251).
component("YDL141W",252).
component("YGL234W",401).
component("YDL141W",253).
component("YJR103W",541).
component("YBL039C",170).
component("YGR204W",426).
component("YBR084W",185).
component("YNL220W",685).
component("YOL058W",715).
component("YDL141W",254).
component("YHR074W",456).
component("YMR217W",664).
component("YGR061C",411).
component("YJR109C",543).
component("YJL130C",515).
component("YGL062W",389).
component("YBR218C",201).
component("YPL231W",786).
component("YNR016C",700).
component("YKL182W",568).
component("YGR037C",408).
component("YPR138C",805).
component("YPL265W",788).
component("YPL134C",772).
component("YPL036W",767).
component("YOR348C",757).
component("YOR222W",747).
component("YOR171C",740).
component("YOR130C",736).
component("YOR011W",729).
component("YOL156W",728).
component("YOL103W",723).
component("YOL020W",711) :- not remove_orf("YOL020W",711).
component("YNR072W",707).
component("YNL270C",692).
component("YNL142W",682).
component("YMR011W",650).
component("YLR348C",625).
component("YLR260W",616).
component("YLR138W",602).
component("YLR100C",600).
component("YLR081W",598).
component("YLL061W",589).
component("YKR093W",584).
component("YKR053C",580).
component("YKR039W",579) :- not remove_orf("YKR039W",579).
component("YJR158W",550).
component("YJR077C",539).
component("YJL219W",526).
component("YJL214W",524).
component("YJL134W",516).
component("YJL129C",513).
component("YIL134W",488).
component("YHR096C",459).
component("YHR094C",458).
component("YHR092C",457).
component("YHL036W",441).
component("YGR121C",416).
component("YGR065C",412).
component("YGR055W",409).
component("YGL186C",396).
component("YGL077C",392).
component("YGL008C",380).
component("YFL055W",370).
component("YFL011W",365).
component("YER060W-A",345).
component("YER060W",344).
component("YER056C",343).
component("YER053C",342).
component("YEL069C",336).
component("YEL063C",335).
component("YEL017C-A",327).
component("YDR536W",325).
component("YDR508C",322).
component("YDR503C",321).
component("YDR497C",319).
component("YDR345C",306).
component("YDR343C",305).
component("YDR342C",304).
component("YDR297W",301).
component("YDR046C",276) :- not remove_orf("YDR046C",276).
component("YDL245C",268).
component("YDL210W",264).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,308) :- not remove_reaction(3620,308).
catalyst(2110,375).
catalyst(2190,375).
catalyst(5550,545).
catalyst(5791,611).
...
catalyst(8061,787).
catalyst(8062,787).
catalyst(3590,385) :- not remove_reaction(3590,385).
catalyst(10910,385) :- not remove_reaction(10910,385).
catalyst(4570,418).
catalyst(8181,621).
catalyst(8182,621).
catalyst(8181,523).
...
catalyst(8281,277).
catalyst(8282,277).
catalyst(3610,269) :- not remove_reaction(3610,269).
catalyst(7921,733).
catalyst(7922,733).
catalyst(7841,337).
catalyst(7842,337).
...
catalyst(640,584).
catalyst(6560,580).
catalyst(771,579) :- not remove_reaction(771,579).
catalyst(772,579) :- not remove_reaction(772,579).
catalyst(781,579) :- not remove_reaction(781,579).
catalyst(782,579) :- not remove_reaction(782,579).
catalyst(801,579) :- not remove_reaction(801,579).
catalyst(802,579) :- not remove_reaction(802,579).
catalyst(811,579) :- not remove_reaction(811,579).
catalyst(812,579) :- not remove_reaction(812,579).
catalyst(831,579) :- not remove_reaction(831,579).
catalyst(832,579) :- not remove_reaction(832,579).
catalyst(841,579) :- not remove_reaction(841,579).
catalyst(842,579) :- not remove_reaction(842,579).
catalyst(851,579) :- not remove_reaction(851,579).
catalyst(852,579) :- not remove_reaction(852,579).
catalyst(881,579) :- not remove_reaction(881,579).
catalyst(882,579) :- not remove_reaction(882,579).
catalyst(901,579) :- not remove_reaction(901,579).
catalyst(902,579) :- not remove_reaction(902,579).
catalyst(921,579) :- not remove_reaction(921,579).
catalyst(922,579) :- not remove_reaction(922,579).
catalyst(931,579) :- not remove_reaction(931,579).
catalyst(932,579) :- not remove_reaction(932,579).
catalyst(1191,579) :- not remove_reaction(1191,579).
catalyst(1192,579) :- not remove_reaction(1192,579).
catalyst(1180,550).
catalyst(1210,550).
catalyst(1581,539).
catalyst(1582,539).
...
catalyst(1210,304).
catalyst(6650,301).
catalyst(801,276) :- not remove_reaction(801,276).
catalyst(802,276) :- not remove_reaction(802,276).
catalyst(811,276) :- not remove_reaction(811,276).
catalyst(812,276) :- not remove_reaction(812,276).
catalyst(831,276) :- not remove_reaction(831,276).
catalyst(832,276) :- not remove_reaction(832,276).
catalyst(841,276) :- not remove_reaction(841,276).
catalyst(842,276) :- not remove_reaction(842,276).
catalyst(851,276) :- not remove_reaction(851,276).
catalyst(852,276) :- not remove_reaction(852,276).
catalyst(901,276) :- not remove_reaction(901,276).
catalyst(902,276) :- not remove_reaction(902,276).
catalyst(1180,268).
catalyst(1210,268).
catalyst(730,264).
catalyst(431,228).
