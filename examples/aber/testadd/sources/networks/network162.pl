...
component("YGR060W",477).
component("YGL012W",445).
component("YKR009C",666).
component("YOL086C",838).
component("YMR303C",778).
component("YMR083W",756).
component("YGL256W",470).
...
component("YIL094C",559).
component("YHR063C",524).
component("U45_",140).
component("YML056C",740).
component("YLR432W",729).
component("YHR216W",547).
component("YAR075W",198).
component("YAR073W",197).
component("YDR127W",335).
component("YJR139C",630).
component("YML075C",743).
component("YLR450W",732).
component("YOL126C",844).
component("YKL085W",643).
component("YDL078C",288).
component("YKL029C",638).
component("YNL037C",783).
component("YNL009W",781).
component("YLR174W",703).
component("YHR183W",540).
component("YGR256W",502).
component("YNL241C",798).
component("YOL059W",835).
component("YDL022W",280).
component("YCL018W",262).
component("YLR355C",724).
component("YIL074C",556).
component("YER081W",413).
component("YML054C",739).
component("YDL174C",310).
component("YML086C",745).
component("YIL155C",568).
component("YEL024W",384).
component("YKR066C",671).
component("YGR088W",481).
component("YDR256C",349).
component("YKL026C",637).
component("YIR037W",579).
component("YBR244W",249).
component("YJR078W",622).
component("U58_",150).
component("YJR025C",613).
component("U107_",27).
component("YGR255C",501).
component("U108_",28).
component("YHR007C",513).
component("YDR402C",364).
component("YGL055W",452).
component("YJR104C",625).
component("YHR008C",514).
component("YOR384W",888).
component("YOR381W",887).
component("YOL152W",847).
component("YLL051C",681).
component("YJL026W",581).
component("YIL066C",555).
...
component("YPL023C",893).
component("YGL125W",457).
component("YOR236W",874).
component("YGR204W",494).
component("YIR034C",578).
component("YLR142W",698).
component("U65_",157).
component("U63_",155).
component("U62_",154).
component("YHR068W",525).
component("YKL150W",649).
component("YIL043C",552).
component("YHR042W",519).
component("YOR221C",871).
component("YMR145C",763).
component("YML120C",746).
component("YKL192C",658).
component("YKL055C",640).
component("YER061C",404).
component("YDL085W",290).
component("YPL171C",906).
component("YHR179W",539).
component("YMR145C",764).
component("YML120C",747).
component("YKL192C",659).
component("YDL085W",291).
component("YGR234W",497).
component("YFR030W",437).
component("YPL017C",892).
component("YFL018C",427).
component("YPL091W",898).
component("YDR353W",359).
component("YER042W",398).
component("YPR167C",949).
component("YJR137C",629).
component("YNL052W",785).
component("YMR256C",775).
component("YLR395C",728).
component("YLR038C",687).
component("YIL111W",561).
component("YHR051W",523).
component("YGL191W",463).
component("YGL187C",462).
component("YDL067C",287).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",330).
component("YPL266W",924).
component("YPL273W",925).
...
component("YPL001W",891).
component("YDL052C",286).
component("U8_",181).
component("YDR148C",341).
component("YPL231W",919).
component("YPL028W",894).
component("YLR299W",713).
component("YGL017W",447).
component("YCR005C",268).
component("YML126C",748).
component("YNL104C",790).
component("YDL182W",311).
component("YDL131W",297).
component("YPR160W",948).
component("YDR307W",355).
component("YLR258W",710).
component("YFR015C",434).
component("YPL227C",915).
component("YNL029C",782).
component("YIL085C",558).
component("YNL192W",796).
component("YBR038W",222).
component("YBR023C",218).
component("YEL011W",381).
component("YMR306W",779).
component("YLR342W",722).
component("YGR032W",474).
component("YPR183W",952).
component("YBR248C",250).
component("YLR209C",705).
component("U104_",24).
component("U103_",23).
component("YOR209C",869).
component("YDR354W",360) :- not remove_orf("YDR354W",360).
component("YFR047C",438).
component("YJR133W",628).
component("YLR209C",706).
component("YML022W",736).
component("YDR441C",370).
component("YHR128W",534).
component("YPR176C",951).
component("YPL172C",907).
component("YNR041C",819).
...
component("YPR069C",938).
component("YDR127W",336).
component("YHR190W",542).
component("YLR146C",699).
component("YPL214C",913).
component("YHR068W",526).
component("YLR303W",715).
component("YGR012W",472).
...
component("YOR274W",875).
component("YOL143C",846).
component("YBR256C",253).
component("YHR137W",535).
component("YGL202W",464).
component("YLR027C",684).
component("YKL106W",644).
component("YOL140W",845).
component("YLR438W",731).
component("YGR019W",473).
component("YLR089C",694).
component("U64_",156).
component("U61_",153).
component("U51_",145).
component("YJR148W",631).
component("YHR208W",545).
component("YFL030W",429).
component("YOR184W",863).
component("YNR058W",823).
component("YIL116W",563).
component("YGL253W",469).
component("YFR053C",439).
component("YMR013C",752).
component("YMR205C",770).
component("YGR240C",498).
component("YOL016C",827).
component("YFR014C",433).
component("YLR240W",708).
component("YKL203C",661).
component("YJR066W",619).
component("YCR036W",275).
component("YGR194C",492).
component("YCL040W",264).
component("U15_",68).
component("YPL188W",909).
component("YJR049C",615).
component("YEL041W",385).
component("U96_",186).
component("YKL001C",634).
component("YDR236C",347).
component("YML070W",742).
component("YFL053W",431).
component("YHL032C",511).
component("YDR531W",378).
component("U83_",175).
component("U82_",174).
component("U81_",173).
component("YMR208W",771).
component("YPL203W",910).
component("YOR061W",851).
component("YKL166C",651).
component("YJL164C",600).
component("YIL035C",551).
component("YHR205W",544).
component("YHR102W",532).
component("YGL019W",448).
component("YHR025W",518).
component("YOR347C",882).
component("YAL038W",192).
component("YNR012W",814).
component("YPR121W",946).
component("YPL258C",921).
component("YOL055C",831).
component("YPL214C",914).
...
component("U19_",103).
component("YKL024C",636).
component("U18_",93).
component("U17_",83).
component("U76_",167).
component("YER170W",422).
component("YDR226W",345).
component("YKL067W",642).
component("YOL055C",832).
component("YDR454C",371).
component("YJR057W",617).
component("YOL061W",836).
component("YKL181W",653).
component("YHL011C",509).
...
component("YGR007W",471).
component("YGR202C",493).
component("YLR328W",721).
component("YDL045C",284).
component("U80_",172).
component("YDL103C",296).
component("U94_",185).
component("YJR010W",610).
component("YBR029C",219).
component("YCL050C",265).
component("YGL130W",458).
component("YDR530C",377).
component("YCL050C",266).
component("YPR190C",954).
component("YPR187W",953).
component("YPR110C",944).
component("YPR010C",931).
component("YOR341W",881).
component("YOR340C",880).
component("YOR224C",873).
component("YOR210W",870).
component("YOR207C",867).
component("YOR151C",860).
component("YOR116C",854).
component("YOL005C",825).
component("YNR003C",812).
component("YNL248C",800).
component("YNL151C",794).
component("YNL113W",791).
component("YKL144C",647).
component("YJR063W",618).
component("YJL148W",598).
component("YJL140W",597).
component("YIL021W",550).
component("YHR143W-A",536).
...
component("YPR175W",950).
component("YPL167C",905).
component("YOR330C",878).
component("YOL115W",843).
component("YNL299W",809).
component("YNL262W",804).
component("YNL102W",789).
component("YJR043C",614).
component("YJR006W",608).
component("YJL090C",588).
component("YIL139C",566).
...
component("YKL035W",639).
component("YHL012W",510).
component("YHR123W",533).
component("YPR113W",945).
component("YBR243C",248).
component("YDL142C",304).
component("YPL148C",903).
component("YER026C",397).
component("YGR286C",506).
component("YJL068C",584).
component("YHR189W",541).
component("YDR058C",329).
component("YDL086W",292).
component("YOL011W",826).
component("YMR008C",750).
component("YMR006C",749).
component("U105_",25).
component("YBL015W",200).
component("YJL068C",585).
component("YJR019C",612).
component("YOR040W",850).
component("U84_",176).
component("U77_",168).
component("YDR481C",372).
component("YLR377C",726).
component("YFR025C",435).
component("YPL179W",908).
component("YNR032W",817).
component("YML057W",741).
component("YML016C",735).
component("YLR433C",730).
component("YGR123C",484).
component("YER133W",420).
...
component("YPR073C",939).
component("YHR215W",546).
component("YDL024C",281).
component("YBR093C",228).
component("YBR092C",227).
component("YAR071W",196).
component("YIL053W",554).
component("YER062C",406).
component("YHR046C",522).
component("U9_",189).
component("YPL228W",916).
component("YMR180C",767).
component("YDL236W",316).
component("YJL155C",599).
component("YPR073C",940).
component("YOR208W",868).
component("YNL053W",786).
component("YMR036C",753).
component("YIR026C",576).
component("YIL113W",562).
component("YFR028C",436).
...
component("U25_",122).
component("U24_",121).
component("YHR044C",521).
component("YHR043C",520).
component("YOL064C",837).
component("YOR360C",884).
component("YGL248W",468).
component("YKR031C",668).
component("YPL206C",911).
component("YGL027C",450).
component("YLR286C",712).
component("YJR153W",632).
component("YJL221C",607).
component("YJL216C",605).
component("YIL172C",574).
component("YGR292W",508).
component("YGR287C",507).
component("YBR299W",260).
component("YBR184W",242).
component("YIL162W",571).
component("YPR026W",932).
component("YDR001C",318).
component("YBR001C",208).
component("YIR019C",575).
component("YIL099W",560).
component("YDL037C",283).
component("YOR190W",865).
component("YLR300W",714).
component("YGR282C",505).
component("YDR261C",350).
component("YDR400W",363).
component("U23_",120).
component("YML035C",737).
component("YJL070C",586).
component("YBR284W",257).
component("U106_",26).
component("U102_",22).
component("YER043C",399).
component("YNL045W",784).
component("YGL037C",451).
component("YDR242W",348).
component("YLR308W",719).
component("YLR307W",718).
component("YBR208C",244).
component("YMR281W",777).
component("U53_",147).
component("YIR032C",577).
component("YPR062W",937).
component("YMR120C",762).
component("YLR028C",686).
component("YHR144C",537).
component("YGR267C",504).
component("YBL033C",201).
component("YBR153W",238).
component("YNL141W",792).
...
component("YHR201C",543).
component("YBR111C",229).
component("YBR252W",252).
component("YPR080W",942).
component("YOR187W",864).
component("YOR133W",857).
component("YLR069C",692).
component("YKR084C",674).
component("YKL173W",652).
component("YJL102W",590).
component("YDR385W",362).
component("YBR118W",232).
component("YER005W",393).
component("YLL001W",677).
component("YIL048W",553).
component("YER166W",421).
...
component("YLR134W",696).
component("YLR044C",688).
component("YGR087C",480).
component("YDR380W",361).
component("YDL080C",289).
component("U98_",187).
component("YMR250W",774).
component("YKL184W",657).
component("YOR128C",855).
component("YEL021W",383).
component("YNR043W",820).
component("U93_",184).
component("U54_",148).
component("YKL211C",662) :- not remove_orf("YKL211C",662).
component("YKR097W",676).
component("YOL052C",830).
component("YNL169C",795).
component("YGR170W",487).
component("YKL060C",641).
component("YNL256W",803).
component("YDR294C",352).
component("YEL046C",386).
component("YNR033W",818).
component("YPR006C",930).
component("YER065C",407).
component("YKL211C",663) :- not remove_orf("YKL211C",663).
component("YER090W",663) :- not remove_orf("YER090W",663).
component("YER090W",417) :- not remove_orf("YER090W",417).
component("YDR127W",338).
component("YPL281C",928).
component("YOR393W",890).
component("YMR323W",780).
component("YHR174W",538).
component("YGR254W",500).
component("YOR202W",866).
component("YPL262W",922).
component("YGL026C",449) :- not remove_orf("YGL026C",449).
component("YGR155W",485).
component("YLR304C",717).
component("YJL200C",603).
component("YGL009C",444).
component("YNL316C",810).
component("YKL182W",655).
component("YPL212C",912).
component("YNL292W",808).
component("YGL063W",454).
component("YFL001W",425).
component("YPR002W",929).
component("YJR016C",611).
component("YCR053W",277).
component("YDR127W",339).
component("YGL148W",459).
component("YIL168W",573).
component("YIL167W",572).
component("YCL064C",267).
component("YER086W",414).
component("YLR359W",725).
component("YAL012W",190).
component("YML004C",733).
component("YFR055W",440).
component("YJL005W",580).
component("YJL121C",591).
component("YBR019C",215).
component("YBR019C",216).
component("YDR050C",328).
component("YIL020C",549).
component("YDR007W",319) :- not remove_orf("YDR007W",319).
component("YOR095C",853).
component("YER003C",392).
component("YBR196C",243).
component("YGL001C",442).
component("YPL117C",901).
component("U14_",60).
component("YOL056W",833).
component("YKL152C",650).
component("YDL021W",279).
component("YMR105C",758).
component("YKL127W",645).
component("YEL058W",389).
component("YPR060C",936).
component("YHR072W",527).
component("YPL097W",899).
component("YGR185C",490).
component("YGR264C",503).
component("YGR171C",488).
component("YHR011W",515).
component("YDR023W",322).
component("YPL104W",900).
component("YLL018C",678).
component("YPR081C",943).
component("YBR121C",233).
component("YHR020W",517).
component("YER087W",415).
component("YNL247W",799).
component("YOR168W",861).
component("YOL097C",841).
component("YDR268W",351).
component("YPR047W",935).
component("YLR060W",691).
component("YFL022C",428).
component("YPR033C",933).
component("YCR024C",271).
component("YHR019C",516).
component("YKL194C",660).
component("YIL078W",557).
component("YPL160W",904).
component("YLR382C",727).
component("YNL073W",788).
component("YDR037W",324).
component("YOR335C",879).
component("YGR094W",482).
component("YLR153C",700).
component("YAL054C",193).
component("YOR317W",876).
component("YMR246W",773).
component("YIL009W",548).
component("YER015W",395).
component("YOR142W",858).
component("YGR244C",499).
component("YPR035W",934).
component("YIL145C",567).
component("U89_",180).
component("YJL101C",589).
component("YOL049W",829).
component("YAR015W",195).
component("YGL234W",466).
component("YER183C",424).
component("U91_",183).
component("U90_",182).
component("YNR057C",822).
component("YDL141W",300).
component("YDL141W",301).
component("YGL234W",467).
component("YDL141W",302).
component("YJR103W",624).
component("YBL039C",203).
component("YGR204W",496).
component("YBR084W",226).
component("YNL220W",797).
component("YOL058W",834).
component("YBR208C",245).
component("YDL141W",303).
component("YHR074W",528).
component("YMR217W",772).
component("YGR061C",478).
component("YJR109C",626).
component("YJL130C",595).
component("YGL062W",453).
component("YBR218C",246).
component("YPL231W",920).
component("YNR016C",815).
component("YKL182W",656).
component("YGR037C",475).
component("YPR138C",947).
component("YPL265W",923).
component("YPL134C",902).
component("YPL057C",896).
component("YPL036W",895).
component("YOR348C",883).
component("YOR222W",872).
component("YOR171C",862).
component("YOR130C",856).
component("YOR011W",849).
component("YOL156W",848).
component("YOL103W",842).
component("YOL020W",828) :- not remove_orf("YOL020W",828).
component("YNR072W",824).
component("YNR056C",821).
component("YNL318C",811).
component("YNL270C",805).
component("YNL142W",793).
component("YMR272C",776).
component("YMR202W",769).
component("YMR011W",751).
component("YLR348C",723).
component("YLR260W",711).
component("YLR138W",697).
component("YLR100C",695).
component("YLR081W",693).
component("YLL061W",682).
component("YLL043W",680).
component("YKR093W",675).
component("YKR053C",670).
component("YKR039W",669) :- not remove_orf("YKR039W",669).
component("YKL217W",665).
component("YJR158W",633).
component("YJR095W",623).
component("YJR077C",621).
component("YJL219W",606).
component("YJL214W",604).
component("YJL134W",596).
component("YJL129C",593).
component("YIL134W",565).
component("YHR096C",531).
component("YHR094C",530).
component("YHR092C",529).
component("YHL036W",512).
component("YGR121C",483).
component("YGR065C",479).
component("YGR055W",476).
component("YGL186C",461).
component("YGL077C",456).
component("YGL008C",443).
component("YFL055W",432).
component("YFL011W",426).
...
catalyst(2300,184).
catalyst(3460,148).
catalyst(3600,662) :- not remove_reaction(3600,662).
catalyst(8000,676).
catalyst(3941,830).
catalyst(3942,830).
catalyst(6890,795).
...
catalyst(8020,930).
catalyst(8020,407).
catalyst(1890,663) :- not remove_reaction(1890,663).
catalyst(3630,663) :- not remove_reaction(3630,663).
...
catalyst(8061,922).
catalyst(8062,922).
catalyst(3590,449) :- not remove_reaction(3590,449).
catalyst(10910,449) :- not remove_reaction(10910,449).
catalyst(4570,485).
catalyst(8181,717).
catalyst(8182,717).
catalyst(8181,603).
...
catalyst(1210,848).
catalyst(1160,842).
catalyst(801,828) :- not remove_reaction(801,828).
catalyst(802,828) :- not remove_reaction(802,828).
catalyst(811,828) :- not remove_reaction(811,828).
catalyst(812,828) :- not remove_reaction(812,828).
catalyst(831,828) :- not remove_reaction(831,828).
catalyst(832,828) :- not remove_reaction(832,828).
catalyst(901,828) :- not remove_reaction(901,828).
catalyst(902,828) :- not remove_reaction(902,828).
catalyst(1180,824).
catalyst(1210,824).
catalyst(700,821).
catalyst(1200,811).
...
catalyst(650,675).
catalyst(6560,670).
catalyst(681,669) :- not remove_reaction(681,669).
catalyst(682,669) :- not remove_reaction(682,669).
catalyst(771,669) :- not remove_reaction(771,669).
catalyst(772,669) :- not remove_reaction(772,669).
catalyst(781,669) :- not remove_reaction(781,669).
catalyst(782,669) :- not remove_reaction(782,669).
catalyst(791,669) :- not remove_reaction(791,669).
catalyst(792,669) :- not remove_reaction(792,669).
catalyst(801,669) :- not remove_reaction(801,669).
catalyst(802,669) :- not remove_reaction(802,669).
catalyst(811,669) :- not remove_reaction(811,669).
catalyst(812,669) :- not remove_reaction(812,669).
catalyst(831,669) :- not remove_reaction(831,669).
catalyst(832,669) :- not remove_reaction(832,669).
catalyst(841,669) :- not remove_reaction(841,669).
catalyst(842,669) :- not remove_reaction(842,669).
catalyst(851,669) :- not remove_reaction(851,669).
catalyst(852,669) :- not remove_reaction(852,669).
catalyst(881,669) :- not remove_reaction(881,669).
catalyst(882,669) :- not remove_reaction(882,669).
catalyst(901,669) :- not remove_reaction(901,669).
catalyst(902,669) :- not remove_reaction(902,669).
catalyst(911,669) :- not remove_reaction(911,669).
catalyst(912,669) :- not remove_reaction(912,669).
catalyst(921,669) :- not remove_reaction(921,669).
catalyst(922,669) :- not remove_reaction(922,669).
catalyst(931,669) :- not remove_reaction(931,669).
catalyst(932,669) :- not remove_reaction(932,669).
catalyst(1191,669) :- not remove_reaction(1191,669).
catalyst(1192,669) :- not remove_reaction(1192,669).
catalyst(390,665).
catalyst(1180,633).
catalyst(1210,633).
catalyst(1250,623).
