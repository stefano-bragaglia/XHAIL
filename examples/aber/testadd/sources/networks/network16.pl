...
component("YPL231W",166).
component("U46_",34).
component("U45_",33).
component("YDR127W",64).
component("YOL126C",155).
component("YDL078C",55).
component("YNL037C",141).
component("YML086C",138).
component("YGR088W",96).
component("YDR256C",71).
component("YJR078W",115).
component("U107_",19).
component("YER070W",87).
component("U36_",31).
component("YPL276W",172).
component("YPL275W",171).
component("YOR388C",160).
component("YOR323C",157).
component("YIL125W",107).
component("U52_",35).
component("YBR166C",46).
component("YKL216W",124).
component("YKR009C",125).
component("YIL160C",109).
component("YGL205W",95).
component("YKR080W",127).
component("YER023W",83).
component("YLR142W",134).
component("YHR068W",103).
component("YKL150W",120).
component("YIL043C",106).
component("YPL266W",170).
component("YDL033C",54).
component("YLR058C",132).
component("YDR019C",60).
component("YBR176W",47).
component("YMR120C",139).
component("YLR028C",130).
component("YPR074C",175).
component("YBR117C",45).
component("YPL231W",167).
component("YPL231W",168).
component("YDL182W",58).
component("YDL131W",57).
component("YLR209C",135).
component("YDR354W",73) :- not remove_orf("YDR354W",73).
component("YFR047C",91).
component("YML022W",137).
component("YDR441C",76).
component("YJL167W",111).
component("YDR127W",65).
component("YDR035W",61).
component("YBR249C",48).
component("YHR137W",104).
component("YLR027C",129).
component("YKL106W",119).
component("YJR148W",117).
component("YNR058W",150).
component("YCR036W",53).
component("YNR012W",148).
component("YDR127W",66).
component("YDR226W",69).
component("YKL067W",118).
component("YDR454C",77).
component("YOL061W",152).
component("YKL181W",121).
component("YHL011C",102).
component("YER099C",89).
component("YBL068W",40).
component("YBR018C",41).
component("YPR175W",177).
component("YPL167C",165).
component("YOR330C",158).
component("YOL115W",154).
component("YNL299W",146).
component("YNL262W",144).
component("YNL102W",142).
component("YJR043C",113).
component("YJR006W",112).
component("YJL090C",110).
component("YIL139C",108).
component("YEL055C",81).
component("YDR419W",75).
component("YDR121W",63).
component("YDL102W",56).
component("YCR014C",52).
component("YBR278W",50).
component("YBL035C",38).
component("U105_",18).
component("U30_",30).
component("U24_",29).
component("YDR400W",74).
component("YDR242W",70).
component("U53_",36).
component("YLR028C",131).
component("U39_",32).
component("YBR111C",44).
component("YBR252W",49).
component("YLR231C",136).
component("YKL211C",122) :- not remove_orf("YKL211C",122).
component("YKL211C",123) :- not remove_orf("YKL211C",123).
component("YER090W",123) :- not remove_orf("YER090W",123).
component("YER090W",88) :- not remove_orf("YER090W",88).
component("YDR127W",67).
component("YPL281C",173).
component("YOR393W",161).
component("YMR323W",140).
component("YHR174W",105).
component("YGR254W",100).
component("YGL026C",92) :- not remove_orf("YGL026C",92).
component("YNL316C",147).
component("YDR127W",68).
component("YGL148W",93).
component("YAL012W",37).
component("YDR007W",59) :- not remove_orf("YDR007W",59).
component("YOR095C",156).
component("YPL117C",164).
component("YPR060C",174).
component("YPL097W",162).
component("YGR185C",99).
component("YGR264C",101).
component("YGR171C",98).
component("YPL104W",163).
component("YLL018C",128).
component("YOR335C",159).
component("YNR057C",149).
component("YJR103W",116).
component("YBL039C",39).
component("YPR138C",176).
component("YPL265W",169).
component("YOL103W",153).
component("YOL020W",151) :- not remove_orf("YOL020W",151).
component("YNL270C",145).
component("YNL142W",143).
component("YLR100C",133).
component("YKR039W",126) :- not remove_orf("YKR039W",126).
component("YJR077C",114).
component("YGR121C",97).
component("YGL186C",94).
component("YFL055W",90).
component("YER060W-A",86).
component("YER060W",85).
component("YER056C",84).
component("YEL063C",82).
component("YDR536W",80).
component("YDR508C",79).
component("YDR497C",78).
component("YDR297W",72).
component("YDR046C",62) :- not remove_orf("YDR046C",62).
component("YCL025C",51).
...
catalyst(5730,49).
catalyst(3500,136).
catalyst(3600,122) :- not remove_reaction(3600,122).
catalyst(3630,123) :- not remove_reaction(3630,123).
catalyst(3630,88) :- not remove_reaction(3630,88).
catalyst(3740,67).
catalyst(8231,173).
catalyst(8232,173).
catalyst(8231,161).
...
catalyst(931,126) :- not remove_reaction(931,126).
catalyst(932,126) :- not remove_reaction(932,126).
...
catalyst(851,62) :- not remove_reaction(851,62).
catalyst(852,62) :- not remove_reaction(852,62).
catalyst(771,51).
catalyst(772,51).
catalyst(781,51).
catalyst(782,51).
...
catalyst(1191,51).
catalyst(1192,51).
catalyst(771,43) :- not remove_reaction(771,43).
catalyst(772,43) :- not remove_reaction(772,43).
...
catalyst(851,42) :- not remove_reaction(851,42).
catalyst(852,42) :- not remove_reaction(852,42).
catalyst(41,28).
catalyst(42,28).
catalyst(91,27).
catalyst(92,27).
