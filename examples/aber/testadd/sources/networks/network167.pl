...
component("YNL280C",839).
component("YLR056W",718).
component("YGR060W",498).
component("YGL012W",464).
component("YKR009C",695).
component("YOL086C",872).
component("YMR303C",811).
component("YMR083W",789).
component("YGL256W",490).
component("YDL168W",316).
component("YBR145W",242).
component("YPL231W",956).
component("YBR265W",261).
component("U46_",146).
component("YBR149W",243).
component("YBR149W",244).
component("YGL001C",460).
component("YIL094C",584).
component("YHR063C",548).
component("U45_",145).
component("YML056C",772).
component("YLR432W",761).
component("YHR216W",572).
component("YAR075W",204).
component("YAR073W",203).
component("YDR127W",349).
component("YJR139C",657).
component("YML075C",775).
component("YLR450W",764).
component("YOL126C",878).
component("YKL085W",671).
component("YDL078C",298).
component("YKL029C",666).
component("YNL037C",816).
component("YNL009W",814).
component("YLR174W",732).
component("YHR183W",565).
component("YGR256W",526).
component("YNL241C",831).
component("YOL059W",869).
component("YDL022W",289).
component("YCL018W",269).
component("YLR355C",756).
component("YIL074C",581).
component("YER081W",431).
component("YML054C",771).
component("YDL174C",320).
component("YML086C",777).
component("YIL155C",594).
component("YEL024W",400).
component("YKR066C",700).
component("YGR088W",502).
component("YDR256C",364).
component("YKL026C",665).
component("YIR037W",605).
component("YBR244W",256).
component("YJR078W",649).
component("U58_",155).
component("YJR025C",640).
component("U107_",27).
component("YGR255C",525).
component("U108_",28).
component("YHR007C",537).
component("YDR402C",379).
component("YGL055W",471).
component("YJR104C",652).
component("YHR008C",538).
component("YOR384W",927).
component("YOR381W",926).
component("YOL152W",882).
component("YLL051C",710).
component("YJL026W",607).
component("YIL066C",580).
component("YGR180C",512).
component("YER070W",428).
component("U37_",139).
component("U36_",138).
component("U35_",137).
component("YDL168W",317).
component("YDR158W",357).
component("YJR009C",636).
component("YJL052W",609).
component("YGR192C",514).
component("YBR006W",217).
component("YPL276W",966).
component("YPL275W",965).
component("YOR388C",928).
component("YPL061W",936).
component("YOR374W",924).
component("YER073W",429).
component("YGL154C",480).
component("YBR115C",237).
component("U55_",154).
component("YER069W",426).
component("YOR323C",914).
component("YMR170C",799).
component("YMR169C",798).
component("YER178W",442).
component("YBR221C",254).
component("YIL125W",590).
component("U52_",151).
component("YBR166C",247).
component("YNL280C",840).
component("YGL012W",465).
component("YKL182W",682).
component("YKL216W",693).
component("YDR044W",335).
component("YER014W",410).
component("YKR009C",696).
component("YIL160C",595).
component("YGL205W",485).
component("YMR118C",793).
component("YLR164W",730).
component("YLL041C",708).
component("YKL148C",676).
component("YKL141W",674).
component("YJL045W",608).
component("YDR178W",359).
component("YJR051W",643).
component("YEL047C",403).
component("YDL171C",318).
component("YDL171C",319).
component("YOR375C",925).
component("YDL215C",324).
component("YAL062W",200).
component("U99_",194).
component("U100_",21).
component("YBR035C",226).
component("YMR189W",801).
component("YKR080W",702).
component("YER023W",412).
component("YPL023C",932).
component("YGL125W",477).
component("YOR236W",911).
component("YGR204W",517).
component("YIR034C",604).
component("YLR142W",727).
component("U65_",162).
component("U63_",160).
component("U62_",159).
component("YOR356W",922).
component("YHR068W",549).
component("YKL150W",677).
component("YIL043C",577).
component("YHR042W",543).
component("YOR221C",908).
component("YMR145C",796).
component("YML120C",778).
component("YKL192C",686).
component("YKL055C",668).
component("YER061C",422).
component("YDL085W",300).
component("YPL171C",945).
component("YHR179W",564).
component("YMR145C",797).
component("YML120C",779).
component("YKL192C",687).
component("YDL085W",301).
component("YGR234W",520).
component("YFR030W",456).
component("YPL017C",931).
component("YFL018C",446).
component("YPL091W",937).
component("YDR353W",374).
component("YER042W",414).
component("YPR167C",989).
component("YJR137C",656).
component("YNL052W",818).
component("YMR256C",808).
component("YLR395C",760).
component("YLR038C",716).
component("YIL111W",587).
component("YHR051W",547).
component("YGL191W",483).
component("YGL187C",482).
component("YDL067C",297).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",342).
component("YPL266W",963).
component("YPL273W",964).
component("YLL062C",712).
component("YDR410C",382).
component("YKR069W",701).
component("YOL096C",873).
component("U47_",147).
component("YER091C",436).
component("YJR073C",647).
component("YGR157W",509).
component("YDR120C",347).
component("YML008C",766).
component("YOR074C",888).
component("YDL033C",291).
component("YOL096C",874).
component("YLR172C",731).
component("YLR058C",719).
component("YDR019C",331).
component("YBR176W",248).
component("YDR408C",381).
component("YMR120C",794).
component("YLR028C",714).
component("YBL013W",205).
component("YJL130C",621).
component("YJL088W",614).
component("YKL024C",663).
component("YPR074C",980).
component("YBR117C",238).
component("YLR354C",755).
component("YGR043C",496).
component("YMR108W",792).
component("YCL009C",268).
component("YMR062C",787).
component("YNL071W",820).
component("YNR008W",846).
component("YIL160C",596).
component("YNR019W",849).
component("YCR048W",284).
component("U48_",148).
component("YMR062C",788).
component("YDR232W",361).
component("YPL231W",957).
component("YER061C",423).
component("YPL001W",930).
component("YDL052C",295).
component("U8_",187).
component("YDR148C",355).
component("YPL231W",958).
component("YPL028W",933).
component("YLR299W",743).
component("YGL017W",466).
component("YCR005C",276).
component("YML126C",780).
component("YNL104C",823).
component("YDL182W",321).
component("YDL131W",307).
component("YPR160W",988).
component("YDR307W",370).
component("YLR258W",740).
component("YFR015C",453).
component("YPL227C",954).
component("YNL029C",815).
component("YIL085C",583).
component("YNL192W",829).
component("YBR038W",228).
component("YBR023C",224).
component("YEL011W",396).
component("YMR306W",812).
component("YLR342W",753).
component("YGR032W",494).
component("YPR183W",992).
component("YBR248C",257).
component("YLR209C",734).
component("U104_",24).
component("U103_",23).
component("YOR209C",906).
component("YER055C",418).
component("YDR354W",375) :- not remove_orf("YDR354W",375).
component("YFR047C",457).
component("YJR133W",655).
component("U22_",124).
component("YLR209C",735).
component("YML022W",768).
component("YDR441C",385).
component("YHR128W",558).
component("YPR176C",991).
component("YPL172C",946).
component("YNR041C",853).
component("YMR101C",790).
component("YDL090C",303).
component("YBR003W",216).
component("YBR002C",215).
component("YJL167W",628).
component("YJL167W",629).
component("YNL256W",834).
component("YPR069C",977).
component("YDR127W",350).
component("YHR190W",567).
component("YLR146C",728).
component("YPL214C",952).
component("YHR068W",550).
component("YLR303W",745).
component("YGR012W",492).
component("YML082W",776).
component("YJR130C",654).
component("YLR303W",746).
component("YDR035W",333).
component("YBR249C",258).
component("YLR180W",733).
component("YDR502C",389).
component("YOR274W",912).
component("YOL143C",881).
component("YBR256C",260).
component("YHR137W",559).
component("YGL202W",484).
component("YLR027C",713).
component("YKL106W",672).
component("YOL140W",880).
component("YLR438W",763).
component("YGR019W",493).
component("YLR089C",723).
component("YDR111C",346).
component("U64_",161).
component("U61_",158).
component("U51_",150).
component("YJR148W",658).
component("YHR208W",570).
component("YFL030W",448).
component("YOR184W",899).
component("YNR058W",857).
component("YIL116W",589).
component("YGL253W",489).
component("YFR053C",458).
component("YOL136C",879).
component("YIL107C",586).
component("YMR013C",784).
component("YMR205C",803).
component("YGR240C",521).
component("YOL016C",861).
component("YFR014C",452).
component("YLR240W",738).
component("YKL203C",689).
component("YJR066W",646).
component("YCR036W",283).
component("YGR194C",515).
component("YCL040W",272).
component("U15_",68).
component("YPL188W",948).
component("YJR049C",642).
component("YEL041W",401).
component("U96_",192).
component("YKL001C",661).
component("YDR236C",362).
component("YML070W",774).
component("YFL053W",450).
component("YHL032C",535).
component("YDR531W",393).
component("U83_",181).
component("U82_",180).
component("U81_",179).
component("YMR208W",804).
component("YPL203W",949).
component("YOR061W",886).
component("YKL166C",679).
component("YJL164C",627).
component("YIL035C",576).
component("YHR205W",569).
component("YHR102W",556).
component("YGL019W",467).
component("YHR025W",542).
component("YOR347C",920).
component("YAL038W",198).
component("YNR012W",847).
component("YPR121W",985).
component("YPL258C",960).
component("YOL055C",865).
component("YPL214C",953).
component("U1_",104).
component("YDR009W",330).
component("YDR127W",351).
component("U21_",116).
component("U20_",113).
component("YDR147W",354).
component("YDR300C",369).
component("YCR012W",277).
component("YER052C",416).
component("YER069W",427).
component("U19_",103).
component("YKL024C",664).
component("U18_",93).
component("U17_",83).
component("U76_",173).
component("YER170W",441).
component("YDR226W",360).
component("YKL067W",670).
component("YOL055C",866).
component("YDR454C",386).
component("YJR057W",644).
component("YOL061W",870).
component("YKL181W",681).
component("YHL011C",533).
component("YER099C",437).
component("YBL068W",212).
component("YOR143C",895).
component("YNL256W",835).
component("YLR328W",751).
component("YBR018C",219).
component("YBR018C",220).
component("YGR007W",491).
component("YGR202C",516).
component("YLR328W",752).
component("YDL045C",293).
component("U80_",178).
component("YDL103C",306).
component("U94_",191).
component("YJR010W",637).
component("YBR029C",225).
component("YCL050C",273).
component("YGL130W",478).
component("YDR530C",392).
component("YCL050C",274).
component("YPR190C",994).
component("YPR187W",993).
component("YPR110C",983).
component("YPR010C",970).
component("YOR341W",919).
component("YOR340C",918).
component("YOR224C",910).
component("YOR210W",907).
component("YOR207C",904).
component("YOR151C",896).
component("YOR116C",890).
component("YOL005C",859).
component("YNR003C",845).
component("YNL248C",833).
component("YNL151C",827).
component("YNL113W",824).
component("YKL144C",675).
component("YJR063W",645).
component("YJL148W",625).
component("YJL140W",624).
component("YIL021W",575).
component("YHR143W-A",560).
component("YGL070C",475).
component("YFL036W",449).
component("YDR404C",380).
component("YDR156W",356).
component("YDR045C",336).
component("YDL150W",315).
component("YDL140C",309).
component("YBR154C",246).
component("YPR175W",990).
component("YPL167C",944).
component("YOR330C",915).
component("YOL115W",877).
component("YNL299W",842).
component("YNL262W",837).
component("YNL102W",822).
component("YJR043C",641).
component("YJR006W",635).
component("YJL090C",615).
component("YIL139C",592).
component("YEL055C",404).
component("YDR419W",383).
component("YDR121W",348).
component("YDL102W",305).
component("YCR014C",278).
component("YBR278W",263).
component("YBL035C",208).
component("YKL035W",667).
component("YHL012W",534).
component("YHR123W",557).
component("YPR113W",984).
component("YBR243C",255).
component("YDL142C",314).
component("YPL148C",942).
component("YER026C",413).
component("YGR286C",530).
component("YJL068C",610).
component("YHR189W",566).
component("YDR058C",340).
component("YNR034W",852).
component("YHR163W",562).
component("YGR248W",523).
component("YCR073W-A",286).
component("YDL086W",302).
component("YOL011W",860).
component("YMR008C",782).
component("YMR006C",781).
component("U105_",25).
component("YBL015W",206).
component("YJL068C",611).
component("YJR019C",639).
component("YOR040W",885).
component("U84_",182).
component("U77_",174).
component("YDR481C",387).
component("YLR377C",758).
component("YFR025C",454).
component("YPL179W",947).
component("YNR032W",850).
component("YML057W",773).
component("YML016C",767).
component("YLR433C",762).
component("YGR123C",505).
component("YER133W",439).
component("YER089C",434).
component("YDR436W",384).
component("YDR075W",343).
component("YDL188C",322).
component("YDL134C",308).
component("YDL047W",294).
component("YDL006W",287).
component("YBR125C",241).
component("YBL056W",211).
component("YPR073C",978).
component("YHR215W",571).
component("YDL024C",290).
component("YBR093C",235).
component("YBR092C",234).
component("YAR071W",202).
component("YIL053W",579).
component("YER062C",424).
component("YHR046C",546).
component("U9_",195).
component("YPL228W",955).
component("YMR180C",800).
component("YDL236W",326).
component("YJL155C",626).
component("YPR073C",979).
component("YOR208W",905).
component("YNL053W",819).
component("YMR036C",786).
component("YIR026C",602).
component("YIL113W",588).
component("YFR028C",455).
component("YER075C",430).
component("YDL230W",325).
component("YBR276C",262).
component("U34_",136).
component("U33_",135).
component("U32_",134).
component("U31_",133).
...
component("U25_",127).
component("U24_",126).
component("YHR044C",545).
component("YHR043C",544).
component("YOL064C",871).
component("YOR360C",923).
component("YGL248W",488).
component("YKR031C",697).
component("YPL206C",950).
component("YGL027C",469).
component("YLR286C",742).
component("YJR153W",659).
component("YJL221C",634).
component("YJL216C",632).
component("YIL172C",600).
component("YGR292W",532).
component("YGR287C",531).
component("YBR299W",267).
component("YBR184W",249).
component("YIL162W",597).
component("YPR026W",971).
component("YDR001C",328).
component("YBR001C",214).
component("YIR019C",601).
component("YIL099W",585).
component("YDL037C",292).
component("YOR190W",901).
component("YLR300W",744).
component("YGR282C",529).
component("YDR261C",365).
component("YDR400W",378).
component("U23_",125).
component("YML035C",769).
component("YJL070C",612).
component("YBR284W",264).
component("U106_",26).
component("U102_",22).
component("YER043C",415).
component("YNL045W",817).
component("YGL037C",470).
component("YDR242W",363).
component("YLR308W",750).
component("YLR307W",749).
component("YBR208C",251).
component("YMR281W",810).
component("U53_",152).
component("YIR032C",603).
component("YPR062W",976).
component("YMR120C",795).
component("YLR028C",715).
component("YHR144C",561).
component("YGR267C",528).
component("YCL030C",271).
component("YBL033C",207).
component("YBR153W",245).
component("YNL141W",825).
component("YLR245C",739).
component("YML035C",770).
component("YGR204W",518).
component("YBR084W",232).
component("YJL126W",619).
component("U44_",144).
component("YDL100C",304).
component("U87_",184).
component("U40_",142).
component("U39_",140).
component("YBR011C",218).
component("YHR201C",568).
component("YBR111C",236).
component("YBR252W",259).
component("YPR080W",981).
component("YOR187W",900).
component("YOR133W",893).
component("YLR069C",721).
component("YKR084C",703).
component("YKL173W",680).
component("YJL102W",617).
component("YDR385W",377).
component("YBR118W",239).
component("YER005W",409).
component("YLL001W",706).
component("YIL048W",578).
component("YER166W",440).
component("YDR093W",345).
component("YAL026C",197).
component("YBL099W",213).
component("U60_",157).
component("YLR231C",736).
component("U88_",185).
component("YDR538W",395).
component("YLR134W",725).
component("YLR044C",717).
component("YGR087C",501).
component("YDR380W",376).
component("YDL080C",299).
component("U98_",193).
component("YMR250W",807).
component("YKL184W",685).
component("YOR128C",891).
component("YEL021W",399).
component("YNR043W",854).
component("U93_",190).
component("U54_",153).
component("YKL211C",691) :- not remove_orf("YKL211C",691).
component("YKR097W",705).
component("YOL052C",864).
component("YNL169C",828).
component("YGR170W",510).
component("YKL060C",669).
component("YNL256W",836).
component("YDR294C",367).
component("YEL046C",402).
component("YNR033W",851).
component("YPR006C",969).
component("YER065C",425).
component("YKL211C",692) :- not remove_orf("YKL211C",692).
component("YER090W",692) :- not remove_orf("YER090W",692).
component("YER090W",435) :- not remove_orf("YER090W",435).
component("YDR127W",352).
component("YPL281C",967).
component("YOR393W",929).
component("YMR323W",813).
component("YHR174W",563).
component("YGR254W",524).
component("YOR202W",903).
component("YPL262W",961).
component("YGL026C",468) :- not remove_orf("YGL026C",468).
component("YGR155W",508).
component("YLR304C",747).
component("YJL200C",630).
component("YGL009C",463).
component("YNL316C",843).
component("YKL182W",683).
component("YPL212C",951).
component("YNL292W",841).
component("YGL063W",474).
component("YFL001W",444).
component("YPR002W",968).
component("YJR016C",638).
component("YCR053W",285).
component("YDR127W",353).
component("YGL148W",479).
component("YIL168W",599).
component("YIL167W",598).
component("YCL064C",275).
component("YER086W",432).
component("YLR359W",757).
component("YAL012W",196).
component("YML004C",765).
component("YFR055W",459).
component("YJL005W",606).
component("YJL121C",618).
component("YBR019C",221).
component("YBR019C",222).
component("YDR050C",338).
component("YIL020C",574).
component("YDR007W",329) :- not remove_orf("YDR007W",329).
component("YOR095C",889).
component("YER003C",408).
component("YBR196C",250).
component("YGL001C",461).
component("YPL117C",940).
component("U14_",60).
component("YOL056W",867).
component("YKL152C",678).
component("YDL021W",288).
component("YMR105C",791).
component("YKL127W",673).
component("YEL058W",405).
component("YPR060C",975).
component("YHR072W",551).
component("YPL097W",938).
component("YGR185C",513).
component("YGR264C",527).
component("YGR171C",511).
component("YHR011W",539).
component("YDR023W",332).
component("YPL104W",939).
component("YLL018C",707).
component("YPR081C",982).
component("YBR121C",240).
component("YHR020W",541).
component("YER087W",433).
component("YNL247W",832).
component("YOR168W",897).
component("YOL097C",875).
component("YDR268W",366).
component("YPR047W",974).
component("YLR060W",720).
component("YFL022C",447).
component("YPR033C",972).
component("YCR024C",279).
component("YHR019C",540).
component("YKL194C",688).
component("YIL078W",582).
component("YPL160W",943).
component("YLR382C",759).
component("YNL073W",821).
component("YDR037W",334).
component("YOR335C",916).
component("YGR094W",503).
component("YLR153C",729).
component("YAL054C",199).
component("YOR317W",913).
component("YMR246W",806).
component("YIL009W",573).
component("YER015W",411).
component("YOR142W",894).
component("YGR244C",522).
component("YPR035W",973).
component("YIL145C",593).
component("U89_",186).
component("YOR339C",917).
component("YMR022W",785).
component("YLR306W",748).
component("YKL210W",690).
component("YGR133W",507).
component("YGL058W",472).
component("YER100W",438).
component("YEL012W",397).
component("YDR177W",358).
component("YDR092W",344).
component("YDR059C",341).
component("YDR054C",339).
component("YDL064W",296).
component("YBR082C",231).
component("YJL101C",616).
component("YOL049W",863).
component("YAR015W",201).
component("YGL234W",486).
component("YER183C",443).
component("U91_",189).
component("U90_",188).
component("YNR057C",856).
component("YDL141W",310).
component("YDL141W",311).
component("YGL234W",487).
component("YDL141W",312).
component("YJR103W",651).
component("YBL039C",209).
component("YGR204W",519).
component("YBR084W",233).
component("YNL220W",830).
component("YOL058W",868).
component("YBR208C",252).
component("YDL141W",313).
component("YHR074W",552).
component("YMR217W",805).
component("YGR061C",499).
component("YPR145W",987).
component("YGR124W",506).
component("YJR109C",653).
component("YJL130C",622).
component("YGL062W",473).
component("YBR218C",253).
component("YPL231W",959).
component("YNR016C",848).
component("YKL182W",684).
component("YGR037C",495).
component("YJL087C",613).
component("YPR138C",986).
component("YPL265W",962).
component("YPL134C",941).
component("YPL057C",935).
component("YPL036W",934).
component("YOR348C",921).
component("YOR222W",909).
component("YOR192C",902).
component("YOR171C",898).
component("YOR130C",892).
component("YOR071C",887).
component("YOR011W",884).
component("YOL156W",883).
component("YOL103W",876).
component("YOL020W",862) :- not remove_orf("YOL020W",862).
component("YNR072W",858).
component("YNR056C",855).
component("YNL318C",844).
component("YNL270C",838).
component("YNL142W",826).
component("YMR272C",809).
component("YMR202W",802).
component("YMR011W",783).
component("YLR348C",754).
component("YLR260W",741).
component("YLR237W",737).
component("YLR138W",726).
component("YLR100C",724).
component("YLR081W",722).
component("YLL061W",711).
component("YLL043W",709).
component("YKR093W",704).
component("YKR053C",699).
component("YKR039W",698) :- not remove_orf("YKR039W",698).
component("YKL217W",694).
component("YKL004W",662).
component("YJR158W",660).
component("YJR095W",650).
component("YJR077C",648).
component("YJL219W",633).
component("YJL214W",631).
component("YJL134W",623).
component("YJL129C",620).
component("YIL134W",591).
component("YHR096C",555).
component("YHR094C",554).
component("YHR092C",553).
component("YHL036W",536).
component("YGR121C",504).
component("YGR065C",500).
component("YGR055W",497).
component("YGL186C",481).
component("YGL077C",476).
component("YGL008C",462).
component("YFL055W",451).
component("YFL011W",445).
component("YER060W-A",421).
component("YER060W",420).
component("YER056C",419).
component("YER053C",417).
component("YEL069C",407).
component("YEL063C",406).
component("YEL017C-A",398).
component("YDR536W",394).
component("YDR508C",391).
component("YDR503C",390).
component("YDR497C",388).
component("YDR345C",373).
component("YDR343C",372).
component("YDR342C",371).
component("YDR297W",368).
component("YDR046C",337) :- not remove_orf("YDR046C",337).
component("YDL245C",327).
component("YDL210W",323).
component("YCR032W",282).
component("YCR028C",281).
component("YCR024C-A",280).
component("YCL025C",270).
component("YBR298C",266).
component("YBR291C",265).
component("YBR069C",230) :- not remove_orf("YBR069C",230).
component("YBR068C",229) :- not remove_orf("YBR068C",229).
component("YBR036C",227).
component("YBR021W",223).
component("YBL042C",210).
component("U85_",183).
component("U7_",177).
component("U79_",176).
component("U78_",175).
...
catalyst(2220,906).
catalyst(3870,418).
catalyst(3620,375) :- not remove_reaction(3620,375).
catalyst(2110,457).
catalyst(2190,457).
catalyst(5550,655).
catalyst(5301,124).
...
catalyst(2300,190).
catalyst(3460,153).
catalyst(3600,691) :- not remove_reaction(3600,691).
catalyst(8000,705).
catalyst(3941,864).
catalyst(3942,864).
catalyst(6890,828).
...
catalyst(8020,969).
catalyst(8020,425).
catalyst(1890,692) :- not remove_reaction(1890,692).
catalyst(3630,692) :- not remove_reaction(3630,692).
catalyst(1890,435) :- not remove_reaction(1890,435).
catalyst(3630,435) :- not remove_reaction(3630,435).
catalyst(3740,352).
catalyst(8231,967).
catalyst(8232,967).
catalyst(8231,929).
...
catalyst(8061,961).
catalyst(8062,961).
catalyst(3590,468) :- not remove_reaction(3590,468).
catalyst(10910,468) :- not remove_reaction(10910,468).
catalyst(4570,508).
catalyst(8181,747).
catalyst(8182,747).
catalyst(8181,630).
...
catalyst(1210,883).
catalyst(1160,876).
catalyst(801,862) :- not remove_reaction(801,862).
catalyst(802,862) :- not remove_reaction(802,862).
catalyst(811,862) :- not remove_reaction(811,862).
catalyst(812,862) :- not remove_reaction(812,862).
catalyst(831,862) :- not remove_reaction(831,862).
catalyst(832,862) :- not remove_reaction(832,862).
catalyst(901,862) :- not remove_reaction(901,862).
catalyst(902,862) :- not remove_reaction(902,862).
catalyst(1180,858).
catalyst(1210,858).
catalyst(700,855).
catalyst(1200,844).
...
catalyst(650,704).
catalyst(6560,699).
catalyst(681,698) :- not remove_reaction(681,698).
catalyst(682,698) :- not remove_reaction(682,698).
catalyst(771,698) :- not remove_reaction(771,698).
catalyst(772,698) :- not remove_reaction(772,698).
catalyst(781,698) :- not remove_reaction(781,698).
catalyst(782,698) :- not remove_reaction(782,698).
catalyst(791,698) :- not remove_reaction(791,698).
catalyst(792,698) :- not remove_reaction(792,698).
catalyst(801,698) :- not remove_reaction(801,698).
catalyst(802,698) :- not remove_reaction(802,698).
catalyst(811,698) :- not remove_reaction(811,698).
catalyst(812,698) :- not remove_reaction(812,698).
catalyst(831,698) :- not remove_reaction(831,698).
catalyst(832,698) :- not remove_reaction(832,698).
catalyst(841,698) :- not remove_reaction(841,698).
catalyst(842,698) :- not remove_reaction(842,698).
catalyst(851,698) :- not remove_reaction(851,698).
catalyst(852,698) :- not remove_reaction(852,698).
catalyst(881,698) :- not remove_reaction(881,698).
catalyst(882,698) :- not remove_reaction(882,698).
catalyst(901,698) :- not remove_reaction(901,698).
catalyst(902,698) :- not remove_reaction(902,698).
catalyst(911,698) :- not remove_reaction(911,698).
catalyst(912,698) :- not remove_reaction(912,698).
catalyst(921,698) :- not remove_reaction(921,698).
catalyst(922,698) :- not remove_reaction(922,698).
catalyst(931,698) :- not remove_reaction(931,698).
catalyst(932,698) :- not remove_reaction(932,698).
catalyst(1191,698) :- not remove_reaction(1191,698).
catalyst(1192,698) :- not remove_reaction(1192,698).
catalyst(390,694).
catalyst(6610,662).
catalyst(1180,660).
catalyst(1210,660).
...
catalyst(851,337) :- not remove_reaction(851,337).
catalyst(852,337) :- not remove_reaction(852,337).
...
modifiable_enzyme(691).
modifiable_enzyme(692).
modifiable_enzyme(435).
modifiable_enzyme(468).
modifiable_enzyme(329).
modifiable_enzyme(862).
