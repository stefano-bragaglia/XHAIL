...
component("YLR056W",498).
component("YGL012W",316).
component("YKR009C",480).
component("YOL086C",603).
component("YMR303C",556).
component("YGL256W",336).
...
component("YIL094C",402).
component("U45_",94).
component("YML056C",537).
component("YLR432W",531).
component("YHR216W",396).
component("YAR075W",139).
component("YAR073W",138).
component("YDR127W",237).
component("YOL126C",609).
component("YKL085W",466).
component("YDL078C",205).
component("YNL037C",561).
component("YNL009W",559).
component("YLR174W",510).
component("YHR183W",390).
component("YGR256W",357).
component("YOL059W",601).
component("YDL022W",199).
component("YCL018W",186).
component("YLR355C",526).
component("YDL174C",221).
component("YML086C",539).
component("YGR088W",344).
component("YDR256C",249).
component("YKL026C",464).
component("YIR037W",419).
component("YBR244W",174).
component("YJR078W",453).
component("U58_",103).
component("YJR025C",446).
component("U107_",24).
component("YHR007C",367).
component("YJR104C",455).
component("YHR008C",368).
component("YOR384W",641).
component("YOR381W",640).
component("YOL152W",611).
component("YLL051C",491).
component("YJL026W",421).
component("YIL066C",400).
component("YGR180C",348).
component("YER070W",291).
component("U37_",88).
component("U36_",87).
component("YDL168W",218).
component("YJR009C",444).
component("YJL052W",423).
component("YGR192C",350).
component("YBR006W",148).
component("YPL276W",666).
component("YPL275W",665).
component("YOR388C",642).
component("YOR374W",638).
component("YER073W",292).
component("YGL154C",328).
component("U55_",102).
component("YER069W",289).
component("YOR323C",631).
component("YER178W",299).
component("YBR221C",172).
component("YIL125W",407).
component("U52_",100).
component("YBR166C",167).
component("YGL012W",317).
component("YKL216W",479).
component("YDR044W",230).
component("YKR009C",481).
component("YIL160C",411).
component("YGL205W",333).
component("YMR118C",547).
component("YLR164W",508).
component("YLL041C",490).
component("YKL148C",470).
component("YKL141W",468).
component("YJL045W",422).
component("YDR178W",244).
component("YEL047C",277).
component("YDL171C",219).
component("YDL171C",220).
component("YOR375C",639).
component("YDL215C",223).
component("YAL062W",136).
component("U99_",131).
component("U100_",20).
component("YBR035C",154).
component("YKR080W",486).
component("YER023W",283).
component("YOR236W",629).
component("YGR204W",351).
component("YIR034C",418).
component("YLR142W",505).
component("U65_",109).
component("U63_",107).
component("U62_",106).
component("YHR068W",377).
component("YKL150W",471).
component("YIL043C",399).
component("YHR042W",372).
component("YPL171C",653).
component("YHR179W",389).
component("YMR145C",550).
component("YML120C",540).
component("YKL192C",476).
component("YDL085W",207).
component("YGR234W",353).
component("YFR030W",310).
component("YPL017C",644).
component("YFL018C",303).
component("YDR353W",257).
component("YPR167C",678).
component("YJR137C",458).
component("YNL052W",563).
component("YMR256C",555).
component("YLR395C",530).
component("YLR038C",496).
component("YIL111W",404).
component("YHR051W",376).
component("YGL191W",331).
component("YGL187C",330).
component("YDL067C",204).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",664).
component("YKR069W",485).
component("YOL096C",604).
component("U47_",96).
component("YER091C",296).
component("YJR073C",451).
component("YDR120C",235).
component("YML008C",533).
component("YDL033C",201).
component("YOL096C",605).
component("YLR172C",509).
component("YLR058C",499).
component("YDR019C",228).
component("YBR176W",168).
component("YDR408C",262).
component("YMR120C",548).
component("YLR028C",494).
component("YBL013W",140).
component("YJL130C",431).
component("YKL024C",463).
component("YPR074C",674).
component("YBR117C",162).
component("YCL009C",185).
component("YNL071W",565).
component("YNR008W",586).
component("YIL160C",412).
component("YNR019W",589).
component("YCR048W",196).
component("U48_",97).
component("YDR232W",246).
component("YPL231W",659).
component("YDL052C",203).
component("U8_",125).
component("YPL231W",660).
component("YPL028W",645).
component("YLR299W",519).
component("YGL017W",318).
component("YML126C",541).
component("YNL104C",568).
component("YDL182W",222).
component("YDL131W",211).
component("YLR258W",516).
component("YFR015C",308).
component("YNL029C",560).
component("YIL085C",401).
component("YMR306W",557).
component("YLR342W",525).
component("YGR032W",339).
component("YLR209C",512).
component("U104_",21).
component("YDR354W",258) :- not remove_orf("YDR354W",258).
component("YFR047C",311).
component("YJR133W",457).
component("YLR209C",513).
component("YML022W",534).
component("YDR441C",264).
component("YJL167W",436).
component("YJL167W",437).
component("YDR127W",238).
component("YLR146C",506).
component("YHR068W",378).
component("YLR303W",521).
component("YGR012W",337).
component("YML082W",538).
component("YJR130C",456).
component("YDR035W",229).
component("YBR249C",175).
component("YLR180W",511).
component("YDR502C",267).
component("YOR274W",630).
component("YBR256C",177).
component("YHR137W",385).
component("YGL202W",332).
component("YLR027C",493).
component("YKL106W",467).
component("YOL140W",610).
component("YLR438W",532).
component("YGR019W",338).
component("YLR089C",501).
component("U64_",108).
component("U61_",105).
component("U51_",99).
component("YJR148W",459).
component("YHR208W",394).
component("YFL030W",304).
component("YOR184W",623).
component("YNR058W",592).
component("YIL116W",406).
component("YGL253W",335).
component("YFR053C",312).
component("YMR013C",545).
component("YMR205C",551).
component("YGR240C",354).
component("YOL016C",596).
component("YFR014C",307).
component("YCR036W",195).
component("YCL040W",188).
component("U15_",45).
component("YPL188W",654).
component("YJR049C",448).
component("YEL041W",275).
component("U96_",129).
component("YKL001C",462).
component("YDR236C",247).
component("YHL032C",365).
component("YDR531W",271).
component("U83_",124).
component("U82_",123).
component("U81_",122).
component("YMR208W",552).
component("YPL203W",655).
component("YOR061W",614).
component("YKL166C",473).
component("YJL164C",435).
component("YIL035C",398).
component("YHR205W",393).
component("YHR102W",384).
component("YGL019W",319).
component("YHR025W",371).
component("YOR347C",636).
component("YAL038W",134).
component("YNR012W",587).
component("YDR127W",239).
component("YDR147W",242).
component("YDR300C",253).
component("YCR012W",190).
component("YER069W",290).
component("U18_",62).
component("U76_",118).
component("YER170W",298).
component("YDR226W",245).
component("YKL067W",465).
component("YOL055C",599).
component("YDR454C",265).
component("YJR057W",449).
component("YOL061W",602).
component("YKL181W",474).
component("YHL011C",364).
component("YER099C",297).
component("YBL068W",146).
component("YOR143C",619).
component("YNL256W",577).
component("YLR328W",523).
component("YBR018C",150).
component("YLR328W",524).
component("U94_",128).
component("YBR029C",153).
component("YGL130W",326).
component("YDR530C",270).
component("YPR190C",681).
component("YPR187W",680).
component("YPR110C",675).
component("YPR010C",669).
component("YOR341W",635).
component("YOR340C",634).
component("YOR224C",628).
component("YOR210W",627).
component("YOR207C",625).
component("YOR151C",620).
component("YOR116C",616).
component("YOL005C",594).
component("YNR003C",585).
component("YNL248C",576).
component("YNL151C",572).
component("YNL113W",569).
component("YKL144C",469).
component("YJR063W",450).
component("YJL148W",434).
component("YJL140W",433).
component("YIL021W",397).
component("YHR143W-A",386).
component("YGL070C",324).
component("YFL036W",305).
component("YDR404C",261).
component("YDR156W",243).
component("YDR045C",231).
component("YDL150W",216).
component("YDL140C",212).
component("YBR154C",166).
component("YPR175W",679).
component("YPL167C",652).
component("YOR330C",632).
component("YOL115W",608).
component("YNL299W",583).
component("YNL262W",579).
component("YNL102W",567).
component("YJR043C",447).
component("YJR006W",443).
component("YJL090C",426).
component("YIL139C",409).
component("YEL055C",278).
component("YDR419W",263).
component("YDR121W",236).
component("YDL102W",210).
component("YCR014C",191).
component("YBR278W",180).
component("YBL035C",143).
component("YPR113W",676).
component("YBR243C",173).
component("YPL148C",650).
component("YGR286C",361).
component("YHR189W",391).
component("YDR058C",234).
component("YDL086W",208).
component("YOL011W",595).
component("YMR008C",543).
component("YMR006C",542).
component("U105_",22).
component("YBL015W",141).
component("YJL068C",424).
component("U77_",119).
component("YLR377C",528).
component("YPR073C",672).
component("YHR215W",395).
...
component("YPR073C",673).
component("YOR208W",626).
component("YNL053W",564).
component("YMR036C",546).
component("YIR026C",417).
component("YIL113W",405).
component("YFR028C",309).
component("YER075C",293).
...
component("U25_",79).
component("U24_",78).
component("YHR044C",374).
component("YHR043C",373).
component("YOR360C",637).
component("YKR031C",482).
component("YPL206C",656).
component("YGL027C",321).
component("YLR286C",518).
component("YJR153W",460).
component("YJL221C",442).
component("YJL216C",440).
component("YIL172C",415).
component("YGR292W",363).
component("YGR287C",362).
component("YBR299W",184).
component("YBR184W",169).
component("YIR019C",416).
component("YIL099W",403).
component("YDL037C",202).
component("YOR190W",624).
component("YLR300W",520).
component("YGR282C",360).
component("YDR261C",250).
component("YDR400W",260).
component("YML035C",535).
component("YJL070C",425).
component("YBR284W",181).
component("U106_",23).
component("YER043C",284).
component("YNL045W",562).
component("YDR242W",248).
component("U53_",101).
component("YPR062W",671).
component("YMR120C",549).
component("YLR028C",495).
component("YHR144C",387).
component("YGR267C",359).
component("YBL033C",142).
component("YNL141W",570).
component("YLR245C",515).
component("YML035C",536).
component("YBR084W",157).
component("YJL126W",429).
component("U44_",93).
component("YDL100C",209).
component("U40_",91).
component("U39_",89).
component("YBR011C",149).
component("YHR201C",392).
component("YBR111C",161).
component("YBR252W",176).
component("YER005W",282).
component("YBL099W",147).
component("YLR231C",514).
component("YLR134W",503).
component("YLR044C",497).
component("YGR087C",343).
component("YDR380W",259).
component("YDL080C",206).
component("U98_",130).
component("YMR250W",554).
component("YOR128C",617).
component("YEL021W",274).
component("U93_",127).
component("YKL211C",477) :- not remove_orf("YKL211C",477).
component("YKR097W",488).
component("YNL169C",573).
component("YNL256W",578).
component("YEL046C",276).
component("YNR033W",590).
component("YKL211C",478) :- not remove_orf("YKL211C",478).
component("YER090W",478) :- not remove_orf("YER090W",478).
component("YER090W",295) :- not remove_orf("YER090W",295).
component("YDR127W",240).
component("YPL281C",667).
component("YOR393W",643).
component("YMR323W",558).
component("YHR174W",388).
component("YGR254W",356).
component("YPL262W",662).
component("YGL026C",320) :- not remove_orf("YGL026C",320).
component("YGR155W",346).
component("YLR304C",522).
component("YJL200C",438).
component("YNL316C",584).
component("YPL212C",657).
component("YNL292W",582).
component("YGL063W",323).
component("YFL001W",301).
component("YPR002W",668).
component("YJR016C",445).
component("YCR053W",197).
component("YDR127W",241).
component("YGL148W",327).
component("YIL168W",414).
component("YIL167W",413).
component("YCL064C",189).
component("YLR359W",527).
component("YAL012W",133).
component("YJL005W",420).
component("YJL121C",428).
component("YBR019C",151).
component("YDR050C",233).
component("YDR007W",227) :- not remove_orf("YDR007W",227).
component("YOR095C",615).
component("YBR196C",170).
component("YGL001C",314).
component("YPL117C",649).
component("U14_",39).
component("YOL056W",600).
component("YKL152C",472).
component("YDL021W",198).
component("YEL058W",279).
component("YPR060C",670).
component("YHR072W",379).
component("YPL097W",647).
component("YGR185C",349).
component("YGR264C",358).
component("YGR171C",347).
component("YPL104W",648).
component("YLL018C",489).
component("YHR020W",370).
component("YER087W",294).
component("YNL247W",575).
component("YOR168W",621).
component("YOL097C",606).
component("YDR268W",251).
component("YCR024C",192).
component("YHR019C",369).
component("YPL160W",651).
component("YLR382C",529).
component("YNL073W",566).
component("YOR335C",633).
component("YLR153C",507).
component("YAL054C",135).
component("YGR244C",355).
component("YIL145C",410).
component("YJL101C",427).
component("YOL049W",598).
component("YAR015W",137).
component("YER183C",300).
component("U90_",126).
component("YNR057C",591).
component("YDL141W",213).
component("YGL234W",334).
component("YDL141W",214).
component("YJR103W",454).
component("YBL039C",144).
component("YGR204W",352).
component("YBR084W",158).
component("YNL220W",574).
component("YDL141W",215).
component("YHR074W",380).
component("YMR217W",553).
component("YGL062W",322).
component("YBR218C",171).
component("YPL231W",661).
component("YNR016C",588).
component("YKL182W",475).
component("YGR037C",340).
component("YPR138C",677).
component("YPL265W",663).
component("YPL036W",646).
component("YOR171C",622).
component("YOR130C",618).
component("YOR011W",613).
component("YOL156W",612).
component("YOL103W",607).
component("YOL020W",597) :- not remove_orf("YOL020W",597).
component("YNR072W",593).
component("YNL270C",580).
component("YNL142W",571).
component("YMR011W",544).
component("YLR260W",517).
component("YLR138W",504).
component("YLR100C",502).
component("YLR081W",500).
component("YLL061W",492).
component("YKR093W",487).
component("YKR053C",484).
component("YKR039W",483) :- not remove_orf("YKR039W",483).
component("YJR158W",461).
component("YJR077C",452).
component("YJL219W",441).
component("YJL214W",439).
component("YJL134W",432).
component("YJL129C",430).
component("YIL134W",408).
component("YHR096C",383).
component("YHR094C",382).
component("YHR092C",381).
component("YHL036W",366).
component("YGR121C",345).
component("YGR065C",342).
component("YGR055W",341).
component("YGL186C",329).
component("YGL077C",325).
component("YGL008C",315).
component("YFL055W",306).
component("YFL011W",302).
component("YER060W-A",288).
component("YER060W",287).
component("YER056C",286).
component("YER053C",285).
component("YEL069C",281).
component("YEL063C",280).
component("YEL017C-A",273).
component("YDR536W",272).
component("YDR508C",269).
component("YDR503C",268).
component("YDR497C",266).
component("YDR345C",256).
component("YDR343C",255).
component("YDR342C",254).
component("YDR297W",252).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,258) :- not remove_reaction(3620,258).
catalyst(2110,311).
catalyst(2190,311).
catalyst(5550,457).
catalyst(5791,513).
...
catalyst(5880,274).
catalyst(2300,127).
catalyst(3600,477) :- not remove_reaction(3600,477).
catalyst(8000,488).
catalyst(6890,573).
catalyst(2570,578).
catalyst(4560,276).
...
catalyst(1890,295) :- not remove_reaction(1890,295).
catalyst(3630,295) :- not remove_reaction(3630,295).
catalyst(3740,240).
catalyst(8231,667).
catalyst(8232,667).
catalyst(8231,643).
...
catalyst(8051,662).
catalyst(8052,662).
catalyst(3590,320) :- not remove_reaction(3590,320).
catalyst(10910,320) :- not remove_reaction(10910,320).
catalyst(4570,346).
catalyst(8181,522).
catalyst(8182,522).
catalyst(8181,438).
...
catalyst(640,487).
catalyst(6560,484).
catalyst(771,483) :- not remove_reaction(771,483).
catalyst(772,483) :- not remove_reaction(772,483).
catalyst(781,483) :- not remove_reaction(781,483).
catalyst(782,483) :- not remove_reaction(782,483).
catalyst(801,483) :- not remove_reaction(801,483).
catalyst(802,483) :- not remove_reaction(802,483).
catalyst(811,483) :- not remove_reaction(811,483).
catalyst(812,483) :- not remove_reaction(812,483).
catalyst(831,483) :- not remove_reaction(831,483).
catalyst(832,483) :- not remove_reaction(832,483).
catalyst(841,483) :- not remove_reaction(841,483).
catalyst(842,483) :- not remove_reaction(842,483).
catalyst(851,483) :- not remove_reaction(851,483).
catalyst(852,483) :- not remove_reaction(852,483).
catalyst(881,483) :- not remove_reaction(881,483).
catalyst(882,483) :- not remove_reaction(882,483).
catalyst(901,483) :- not remove_reaction(901,483).
catalyst(902,483) :- not remove_reaction(902,483).
catalyst(921,483) :- not remove_reaction(921,483).
catalyst(922,483) :- not remove_reaction(922,483).
catalyst(931,483) :- not remove_reaction(931,483).
catalyst(932,483) :- not remove_reaction(932,483).
catalyst(1191,483) :- not remove_reaction(1191,483).
catalyst(1192,483) :- not remove_reaction(1192,483).
catalyst(1180,461).
catalyst(1210,461).
catalyst(1581,452).
catalyst(1582,452).
