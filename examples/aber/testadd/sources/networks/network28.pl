...
component("YLR056W",197).
component("YPL231W",257).
component("U46_",41).
component("YBR149W",61).
component("YGL001C",128).
component("YIL094C",159).
component("U45_",40).
component("YDR127W",89).
component("YOL126C",236).
component("YDL078C",76).
component("YNL037C",215).
component("YML086C",211).
component("YGR088W",141).
component("YDR256C",98).
component("YJR078W",177).
component("U107_",19).
component("YER070W",121).
component("U36_",37).
component("YPL276W",263).
component("YPL275W",262).
component("YOR388C",250).
component("YOR323C",245).
component("YIL125W",160).
component("U52_",43).
component("YBR166C",63).
component("YKL216W",188).
component("YKR009C",189).
component("YIL160C",162).
component("YGL205W",138).
component("YKR080W",192).
component("YER023W",117).
component("YLR142W",200).
component("U62_",45).
component("YHR068W",150).
component("YKL150W",184).
component("YIL043C",157).
component("YPL171C",256).
component("YHR179W",155).
component("YDR353W",102).
component("YPL266W",261).
component("YDL033C",75).
component("YLR058C",198).
component("YDR019C",84).
component("YBR176W",64).
component("YDR408C",107).
component("YMR120C",212).
component("YLR028C",195).
component("YPR074C",267).
component("YBR117C",60).
component("YPL231W",258).
component("YPL231W",259).
component("YLR299W",206).
component("YDL182W",82).
component("YDL131W",79).
component("YLR258W",205).
component("YFR015C",126).
component("YNL029C",214).
component("YIL085C",158).
component("YLR209C",202).
component("YDR354W",103) :- not remove_orf("YDR354W",103).
component("YFR047C",127).
component("YLR209C",203).
component("YML022W",209).
component("YDR441C",109).
component("YJL167W",172).
component("YDR127W",90).
component("YJR130C",179).
component("YDR035W",85).
component("YBR249C",66).
component("YOR274W",244).
component("YHR137W",151).
component("YGL202W",137).
component("YLR027C",194).
component("YKL106W",182).
component("YJR148W",180).
component("YNR058W",229).
component("YCR036W",74).
component("U96_",48).
component("YNR012W",227).
component("YDR127W",91).
component("YDR147W",94).
component("U76_",46).
component("YDR226W",96).
component("YKL067W",181).
component("YDR454C",110).
component("YOL061W",232).
component("YKL181W",185).
component("YHL011C",148).
component("YER099C",123).
component("YBL068W",54).
component("YNL256W",221).
component("YBR018C",56).
component("YGL130W",134).
component("YPR190C",273).
component("YPR187W",272).
component("YPR110C",268).
component("YPR010C",265).
component("YOR341W",249).
component("YOR340C",248).
component("YOR224C",243).
component("YOR210W",242).
component("YOR207C",241).
component("YOR151C",239).
component("YOR116C",238).
component("YOL005C",230).
component("YNR003C",226).
component("YNL248C",220).
component("YNL151C",219).
component("YNL113W",217).
component("YKL144C",183).
component("YJR063W",175).
component("YJL148W",171).
component("YJL140W",170).
component("YIL021W",156).
component("YHR143W-A",152).
component("YGL070C",133).
component("YFL036W",124).
component("YDR404C",106).
component("YDR156W",95).
component("YDR045C",86).
component("YDL150W",81).
component("YDL140C",80).
component("YBR154C",62).
component("YPR175W",271).
component("YPL167C",255).
component("YOR330C",246).
component("YOL115W",235).
component("YNL299W",224).
component("YNL262W",222).
component("YNL102W",216).
component("YJR043C",174).
component("YJR006W",173).
component("YJL090C",166).
component("YIL139C",161).
component("YEL055C",114).
component("YDR419W",108).
component("YDR121W",88).
component("YDL102W",78).
component("YCR014C",73).
component("YBR278W",68).
component("YBL035C",52).
component("YPR113W",269).
component("U105_",18).
component("YLR377C",208).
component("U30_",36).
component("U29_",35).
component("U24_",34).
component("YGL027C",131).
component("YOR190W",240).
component("YLR300W",207).
component("YGR282C",147).
component("YDR261C",99).
component("YDR400W",105).
component("YML035C",210).
component("YJL070C",165).
component("YBR284W",69).
component("YDR242W",97).
component("U53_",44).
component("YLR028C",196).
component("YHR144C",153).
component("YJL126W",167).
component("U39_",38).
component("YBR011C",55).
component("YBR111C",59).
component("YBR252W",67).
component("YER005W",116).
component("YLR231C",204).
component("YDR380W",104).
component("YDL080C",77).
component("U98_",49).
component("YKL211C",186) :- not remove_orf("YKL211C",186).
component("YKL211C",187) :- not remove_orf("YKL211C",187).
component("YER090W",187) :- not remove_orf("YER090W",187).
component("YER090W",122) :- not remove_orf("YER090W",122).
component("YDR127W",92).
component("YPL281C",264).
component("YOR393W",251).
component("YMR323W",213).
component("YHR174W",154).
component("YGR254W",145).
component("YGL026C",130) :- not remove_orf("YGL026C",130).
component("YNL316C",225).
component("YDR127W",93).
component("YGL148W",135).
component("YIL168W",164).
component("YIL167W",163).
component("YCL064C",72).
component("YAL012W",50).
component("YDR007W",83) :- not remove_orf("YDR007W",83).
component("YOR095C",237).
component("YGL001C",129).
component("YPL117C",254).
component("YPR060C",266).
component("YPL097W",252).
component("YGR185C",144).
component("YGR264C",146).
component("YGR171C",143).
component("YPL104W",253).
component("YLL018C",193).
component("YOL097C",233).
component("YDR268W",100).
component("YOR335C",247).
component("YLR153C",201).
component("YAL054C",51).
component("U90_",47).
component("YNR057C",228).
component("YJR103W",178).
component("YBL039C",53).
component("YGL062W",132).
component("YBR218C",65).
component("YPR138C",270).
component("YPL265W",260).
component("YOL103W",234).
component("YOL020W",231) :- not remove_orf("YOL020W",231).
component("YNL270C",223).
component("YNL142W",218).
component("YLR100C",199).
component("YKR053C",191).
component("YKR039W",190) :- not remove_orf("YKR039W",190).
component("YJR077C",176).
component("YJL134W",169).
component("YJL129C",168).
component("YHL036W",149).
component("YGR121C",142).
component("YGR065C",140).
component("YGR055W",139).
component("YGL186C",136).
component("YFL055W",125).
component("YER060W-A",120).
component("YER060W",119).
component("YER056C",118).
component("YEL063C",115).
component("YDR536W",113).
component("YDR508C",112).
component("YDR497C",111).
component("YDR297W",101).
component("YDR046C",87) :- not remove_orf("YDR046C",87).
component("YCL025C",71).
component("YBR298C",70).
component("YBR069C",58) :- not remove_orf("YBR069C",58).
component("YBR068C",57) :- not remove_orf("YBR068C",57).
component("U4_",42).
component("U3_",39).
component("U228_",33).
component("U223_",32).
...
catalyst(8812,77).
catalyst(2250,49).
catalyst(3600,186) :- not remove_reaction(3600,186).
catalyst(3630,187) :- not remove_reaction(3630,187).
catalyst(3630,122) :- not remove_reaction(3630,122).
catalyst(3740,92).
catalyst(8231,264).
catalyst(8232,264).
catalyst(8231,251).
...
catalyst(4520,72).
catalyst(4460,50).
catalyst(3610,83) :- not remove_reaction(3610,83).
catalyst(7921,237).
catalyst(7922,237).
catalyst(6370,129).
catalyst(6461,254).
...
catalyst(781,190) :- not remove_reaction(781,190).
catalyst(782,190) :- not remove_reaction(782,190).
...
catalyst(881,190) :- not remove_reaction(881,190).
catalyst(882,190) :- not remove_reaction(882,190).
catalyst(901,190) :- not remove_reaction(901,190).
catalyst(902,190) :- not remove_reaction(902,190).
catalyst(931,190) :- not remove_reaction(931,190).
catalyst(932,190) :- not remove_reaction(932,190).
catalyst(1191,190) :- not remove_reaction(1191,190).
catalyst(1192,190) :- not remove_reaction(1192,190).
catalyst(1581,176).
catalyst(1582,176).
catalyst(6560,169).
catalyst(361,168).
...
catalyst(1160,111).
catalyst(6650,101).
catalyst(801,87) :- not remove_reaction(801,87).
catalyst(802,87) :- not remove_reaction(802,87).
catalyst(811,87) :- not remove_reaction(811,87).
catalyst(812,87) :- not remove_reaction(812,87).
catalyst(831,87) :- not remove_reaction(831,87).
catalyst(832,87) :- not remove_reaction(832,87).
catalyst(841,87) :- not remove_reaction(841,87).
catalyst(842,87) :- not remove_reaction(842,87).
catalyst(851,87) :- not remove_reaction(851,87).
catalyst(852,87) :- not remove_reaction(852,87).
catalyst(901,87) :- not remove_reaction(901,87).
catalyst(902,87) :- not remove_reaction(902,87).
catalyst(771,71).
catalyst(772,71).
catalyst(781,71).
catalyst(782,71).
...
catalyst(1121,70).
catalyst(1122,70).
catalyst(771,58) :- not remove_reaction(771,58).
catalyst(772,58) :- not remove_reaction(772,58).
...
catalyst(851,58) :- not remove_reaction(851,58).
catalyst(852,58) :- not remove_reaction(852,58).
catalyst(901,58) :- not remove_reaction(901,58).
catalyst(902,58) :- not remove_reaction(902,58).
...
catalyst(831,57) :- not remove_reaction(831,57).
catalyst(832,57) :- not remove_reaction(832,57).
catalyst(841,57) :- not remove_reaction(841,57).
catalyst(842,57) :- not remove_reaction(842,57).
catalyst(851,57) :- not remove_reaction(851,57).
catalyst(852,57) :- not remove_reaction(852,57).
catalyst(901,57) :- not remove_reaction(901,57).
catalyst(902,57) :- not remove_reaction(902,57).
catalyst(6980,42).
catalyst(6980,39).
catalyst(41,33).
catalyst(42,33).
