...
component("YLR056W",607).
component("YGR060W",420).
component("YGL012W",391).
component("YKR009C",588).
component("YOL086C",732).
component("YMR303C",679).
component("YMR083W",666).
component("YGL256W",413).
component("YDL168W",265).
component("YBR145W",199).
component("YPL231W",796).
component("YBR265W",216).
component("U46_",118).
component("YBR149W",200).
component("YBR149W",201).
component("YGL001C",388).
component("YIL094C",494).
component("U45_",117).
component("YML056C",653).
component("YLR432W",643).
component("YHR216W",485).
component("YAR075W",171).
component("YAR073W",170).
component("YDR127W",292).
component("YJR139C",559).
component("YML075C",655).
component("YLR450W",646).
component("YOL126C",738).
component("YKL085W",569).
component("YDL078C",248).
component("YNL037C",684).
component("YNL009W",682).
component("YLR174W",620).
component("YHR183W",478).
component("YGR256W",441).
component("YNL241C",698).
component("YOL059W",729).
component("YDL022W",241).
component("YCL018W",224).
component("YLR355C",638).
component("YIL074C",491).
component("YER081W",362).
component("YDL174C",269).
component("YML086C",657).
component("YIL155C",503).
component("YEL024W",338).
component("YKR066C",593).
component("YGR088W",424).
component("YDR256C",306).
component("YKL026C",565).
component("YIR037W",513).
component("YBR244W",211).
component("YJR078W",552).
component("U58_",127).
component("YJR025C",544).
component("U107_",24).
component("U108_",25).
component("YHR007C",452).
component("YDR402C",320).
component("YGL055W",398).
component("YJR104C",554).
component("YHR008C",453).
component("YOR384W",775).
component("YOR381W",774).
component("YOL152W",740).
component("YLL051C",600).
component("YJL026W",515).
component("YIL066C",490).
component("YGR180C",431).
component("YER070W",359).
component("U37_",111).
component("U36_",110).
component("U35_",109).
component("YDL168W",266).
component("YDR158W",300).
component("YJR009C",541).
component("YJL052W",517).
component("YGR192C",433).
component("YBR006W",181).
component("YPL276W",804).
component("YPL275W",803).
component("YOR388C",776).
component("YPL061W",781).
component("YOR374W",772).
component("YER073W",360).
component("YGL154C",405).
component("YBR115C",195).
component("U55_",126).
component("YER069W",357).
component("YOR323C",764).
component("YER178W",372).
component("YBR221C",209).
component("YIL125W",499).
component("U52_",123).
component("YBR166C",204).
component("YNL280C",706).
component("YGL012W",392).
component("YKL182W",578).
component("YKL216W",587).
component("YDR044W",282).
component("YKR009C",589).
component("YIL160C",504).
component("YGL205W",410).
component("YMR118C",668).
component("YLR164W",618).
component("YLL041C",599).
component("YKL148C",573).
component("YKL141W",571).
component("YJL045W",516).
component("YDR178W",301).
component("YEL047C",341).
component("YDL171C",267).
component("YDL171C",268).
component("YOR375C",773).
component("YDL215C",273).
component("YAL062W",167).
component("U99_",161).
component("U100_",20).
component("YBR035C",187).
component("YKR080W",595).
component("YER023W",348).
component("YOR236W",762).
component("YGR204W",435).
component("YIR034C",512).
component("YLR142W",615).
component("U65_",133).
component("U63_",131).
component("U62_",130).
component("YHR068W",463).
component("YKL150W",574).
component("YIL043C",488).
component("YHR042W",458).
component("YOR221C",759).
component("YMR145C",671).
component("YKL192C",581).
component("YKL055C",567).
component("YER061C",355).
component("YDL085W",250).
component("YPL171C",789).
component("YHR179W",477).
component("YMR145C",672).
component("YML120C",658).
component("YKL192C",582).
component("YDL085W",251).
component("YGR234W",437).
component("YFR030W",384).
component("YPL017C",778).
component("YFL018C",376).
component("YDR353W",316).
component("YPR167C",819).
component("YJR137C",558).
component("YNL052W",686).
component("YMR256C",678).
component("YLR395C",642).
component("YLR038C",605).
component("YIL111W",496).
component("YHR051W",462).
component("YGL191W",408).
component("YGL187C",407).
component("YDL067C",247).
component("Q0275",19).
component("Q0250",18).
component("YDR072C",287).
component("YPL266W",802).
component("YKR069W",594).
component("YOL096C",733).
component("U47_",119).
component("YER091C",367).
component("YJR073C",550).
component("YGR157W",429).
component("YDR120C",290).
component("YML008C",648).
component("YOR074C",745).
component("YDL033C",243).
component("YOL096C",734).
component("YLR172C",619).
component("YLR058C",608).
component("YDR019C",279).
component("YBR176W",205).
component("YDR408C",322).
component("YMR120C",669).
component("YLR028C",603).
component("YBL013W",172).
component("YJL130C",526).
component("YJL088W",520).
component("YKL024C",564).
component("YPR074C",814).
component("YBR117C",196).
component("YMR108W",667).
component("YCL009C",223).
component("YNL071W",688).
component("YNR008W",711).
component("YIL160C",505).
component("YNR019W",714).
component("YCR048W",237).
component("U48_",120).
component("YMR062C",665).
component("YDR232W",303).
component("YPL231W",797).
component("YER061C",356).
component("YDL052C",246).
component("U8_",155).
component("YDR148C",298).
component("YPL231W",798).
component("YPL028W",779).
component("YLR299W",630).
component("YGL017W",393).
component("YCR005C",229).
component("YML126C",659).
component("YNL104C",691).
component("YDL182W",270).
component("YDL131W",256).
component("YDR307W",312).
component("YLR258W",627).
component("YFR015C",382).
component("YNL029C",683).
component("YIL085C",493).
component("YMR306W",680).
component("YLR342W",636).
component("YGR032W",417).
component("YBR248C",212).
component("YLR209C",622).
component("U104_",21).
component("YDR354W",317) :- not remove_orf("YDR354W",317).
component("YFR047C",385).
component("YJR133W",557).
component("YLR209C",623).
component("YML022W",650).
component("YDR441C",325).
component("YHR128W",472).
component("YJL167W",533).
component("YJL167W",534).
component("YPR069C",811).
component("YDR127W",293).
component("YHR190W",480).
component("YLR146C",616).
component("YHR068W",464).
component("YLR303W",632).
component("YGR012W",415).
component("YML082W",656).
component("YJR130C",556).
component("YDR035W",281).
component("YBR249C",213).
component("YLR180W",621).
component("YDR502C",329).
component("YOR274W",763).
component("YBR256C",215).
component("YHR137W",473).
component("YGL202W",409).
component("YLR027C",602).
component("YKL106W",570).
component("YOL140W",739).
component("YLR438W",645).
component("YGR019W",416).
component("YLR089C",611).
component("U64_",132).
component("U61_",129).
component("U51_",122).
component("YJR148W",560).
component("YHR208W",483).
component("YFL030W",378).
component("YOR184W",754).
component("YNR058W",719).
component("YIL116W",498).
component("YGL253W",412).
component("YFR053C",386).
component("YMR013C",663).
component("YMR205C",674).
component("YGR240C",438).
component("YOL016C",723).
component("YFR014C",381).
component("YLR240W",625).
component("YKL203C",584).
component("YJR066W",549).
component("YCR036W",236).
component("YCL040W",226).
component("U15_",56).
component("YPL188W",791).
component("YJR049C",546).
component("YEL041W",339).
component("U96_",159).
component("YKL001C",563).
...
component("YPL203W",792).
component("YOR061W",744).
component("YKL166C",576).
component("YJL164C",532).
component("YIL035C",487).
component("YHR205W",482).
component("YHR102W",470).
component("YGL019W",394).
component("YHR025W",457).
component("YOR347C",769).
component("YAL038W",165).
component("YNR012W",712).
component("YDR009W",278).
component("YDR127W",294).
component("YDR147W",297).
component("YDR300C",311).
component("YCR012W",230).
component("YER069W",358).
component("U19_",85).
component("U18_",77).
component("U17_",69).
component("U76_",143).
component("YER170W",371).
component("YDR226W",302).
component("YKL067W",568).
component("YOL055C",726).
component("YDR454C",326).
component("YJR057W",547).
component("YOL061W",730).
component("YKL181W",577).
component("YHL011C",448).
component("YER099C",368).
component("YBL068W",179).
component("YOR143C",750).
component("YNL256W",701).
component("YLR328W",634).
component("YBR018C",183).
component("YGR007W",414).
component("YGR202C",434).
component("YLR328W",635).
component("U80_",147).
component("YDL103C",255).
component("U94_",158).
component("YJR010W",542).
component("YBR029C",186).
component("YCL050C",227).
component("YGL130W",403).
component("YDR530C",332).
component("YPR190C",822).
component("YPR187W",821).
component("YPR110C",816).
component("YPR010C",807).
component("YOR341W",768).
component("YOR340C",767).
component("YOR224C",761).
component("YOR210W",758).
component("YOR207C",756).
component("YOR151C",751).
component("YOR116C",747).
component("YOL005C",721).
component("YNR003C",710).
component("YNL248C",700).
component("YNL151C",695).
component("YNL113W",692).
component("YKL144C",572).
component("YJR063W",548).
component("YJL148W",530).
component("YJL140W",529).
component("YIL021W",486).
...
component("YDL150W",264).
component("YDL140C",258).
component("YBR154C",203).
component("YPR175W",820).
component("YPL167C",788).
component("YOR330C",765).
component("YOL115W",737).
component("YNL299W",708).
component("YNL262W",703).
component("YNL102W",690).
component("YJR043C",545).
component("YJR006W",540).
component("YJL090C",521).
component("YIL139C",501).
component("YEL055C",342).
component("YDR419W",323).
component("YDR121W",291).
component("YDL102W",254).
component("YCR014C",231).
component("YBR278W",218).
component("YBL035C",175).
component("YKL035W",566).
component("YHL012W",449).
component("YHR123W",471).
component("YPR113W",817).
component("YBR243C",210).
component("YDL142C",263).
component("YPL148C",786).
component("YER026C",349).
component("YGR286C",445).
component("YHR189W",479).
component("YDR058C",286).
component("YDL086W",252).
component("YOL011W",722).
component("YMR008C",661).
component("YMR006C",660).
component("U105_",22).
component("YBL015W",173).
component("YJL068C",518).
component("YOR040W",743).
component("U77_",144).
component("YDR481C",327).
component("YLR377C",640).
component("YPL179W",790).
component("YNR032W",715).
component("YML057W",654).
component("YML016C",649).
component("YLR433C",644).
component("YGR123C",427).
component("YER133W",369).
component("YER089C",365).
component("YDR436W",324).
component("YDR075W",288).
component("YDL188C",271).
component("YDL134C",257).
component("YDL047W",245).
component("YDL006W",239).
component("YBR125C",198).
component("YBL056W",178).
component("YPR073C",812).
component("YHR215W",484).
component("YDL024C",242).
component("YBR093C",193).
component("YBR092C",192).
component("YAR071W",169).
component("YHR046C",461).
component("U9_",162).
component("YPL228W",795).
component("YMR180C",673).
component("YDL236W",275).
component("YJL155C",531).
component("YPR073C",813).
component("YOR208W",757).
component("YNL053W",687).
component("YMR036C",664).
component("YIR026C",511).
component("YIL113W",497).
component("YFR028C",383).
component("YER075C",361).
component("YDL230W",274).
...
component("U25_",99).
component("U24_",98).
component("YHR044C",460).
component("YHR043C",459).
component("YOL064C",731).
component("YOR360C",771).
component("YKR031C",590).
component("YPL206C",793).
component("YGL027C",396).
component("YLR286C",629).
component("YJR153W",561).
component("YJL221C",539).
component("YJL216C",537).
component("YIL172C",509).
component("YGR292W",447).
component("YGR287C",446).
component("YBR299W",222).
component("YBR184W",206).
component("YIL162W",506).
component("YIR019C",510).
component("YIL099W",495).
component("YDL037C",244).
component("YOR190W",755).
component("YLR300W",631).
component("YGR282C",444).
component("YDR261C",307).
component("YDR400W",319).
component("YML035C",651).
component("YJL070C",519).
component("YBR284W",219).
component("U106_",23).
component("YER043C",350).
component("YNL045W",685).
...
component("YGR267C",443).
component("YBL033C",174).
component("YBR153W",202).
component("YNL141W",693).
component("YLR245C",626).
component("YML035C",652).
component("YBR084W",190).
component("YJL126W",524).
component("U44_",116).
component("YDL100C",253).
component("U87_",152).
component("U40_",114).
component("U39_",112).
component("YBR011C",182).
component("YHR201C",481).
component("YBR111C",194).
component("YBR252W",214).
component("YER005W",347).
component("YIL048W",489).
component("YER166W",370).
component("YDR093W",289).
component("YAL026C",164).
component("YBL099W",180).
component("YLR231C",624).
component("U88_",153).
component("YDR538W",335).
component("YLR134W",613).
component("YLR044C",606).
component("YGR087C",423).
component("YDR380W",318).
component("YDL080C",249).
component("U98_",160).
component("YMR250W",677).
component("YOR128C",748).
component("YEL021W",337).
component("YNR043W",717).
component("U93_",157).
component("U54_",125).
component("YKL211C",585) :- not remove_orf("YKL211C",585).
component("YKR097W",597).
component("YNL169C",696).
component("YNL256W",702).
component("YDR294C",309).
component("YEL046C",340).
component("YNR033W",716).
component("YKL211C",586) :- not remove_orf("YKL211C",586).
component("YER090W",586) :- not remove_orf("YER090W",586).
component("YER090W",366) :- not remove_orf("YER090W",366).
component("YDR127W",295).
component("YPL281C",805).
component("YOR393W",777).
component("YMR323W",681).
component("YHR174W",476).
component("YGR254W",440).
component("YPL262W",800).
component("YGL026C",395) :- not remove_orf("YGL026C",395).
component("YGR155W",428).
component("YLR304C",633).
component("YJL200C",535).
component("YNL316C",709).
component("YKL182W",579).
component("YPL212C",794).
component("YNL292W",707).
component("YGL063W",400).
component("YFL001W",374).
component("YPR002W",806).
component("YJR016C",543).
component("YCR053W",238).
component("YDR127W",296).
component("YGL148W",404).
component("YIL168W",508).
component("YIL167W",507).
component("YCL064C",228).
component("YER086W",363).
component("YLR359W",639).
component("YAL012W",163).
component("YML004C",647).
component("YFR055W",387).
component("YJL005W",514).
component("YJL121C",523).
component("YBR019C",184).
component("YDR050C",285).
component("YDR007W",277) :- not remove_orf("YDR007W",277).
component("YOR095C",746).
component("YER003C",346).
component("YBR196C",207).
component("YGL001C",389).
component("YPL117C",784).
component("U14_",48).
component("YOL056W",727).
component("YKL152C",575).
component("YDL021W",240).
component("YEL058W",343).
component("YPR060C",809).
component("YHR072W",465).
component("YPL097W",782).
component("YGR185C",432).
component("YGR264C",442).
component("YGR171C",430).
component("YHR011W",454).
component("YDR023W",280).
component("YPL104W",783).
component("YLL018C",598).
component("YPR081C",815).
component("YBR121C",197).
component("YHR020W",456).
component("YER087W",364).
component("YNL247W",699).
component("YOR168W",752).
component("YOL097C",735).
component("YDR268W",308).
component("YPR047W",808).
component("YLR060W",609).
component("YFL022C",377).
component("YCR024C",232).
component("YHR019C",455).
component("YKL194C",583).
component("YIL078W",492).
component("YPL160W",787).
component("YLR382C",641).
component("YNL073W",689).
component("YOR335C",766).
component("YGR094W",425).
component("YLR153C",617).
component("YAL054C",166).
component("YGR244C",439).
component("YIL145C",502).
component("U89_",154).
component("YJL101C",522).
component("YOL049W",725).
component("YAR015W",168).
component("YER183C",373).
component("U90_",156).
component("YNR057C",718).
component("YDL141W",259).
component("YDL141W",260).
component("YGL234W",411).
component("YDL141W",261).
component("YJR103W",553).
component("YBL039C",176).
component("YGR204W",436).
component("YBR084W",191).
component("YNL220W",697).
component("YOL058W",728).
component("YDL141W",262).
component("YHR074W",466).
component("YMR217W",676).
component("YGR061C",421).
component("YJR109C",555).
component("YJL130C",527).
component("YGL062W",399).
component("YBR218C",208).
component("YPL231W",799).
component("YNR016C",713).
component("YKL182W",580).
component("YGR037C",418).
component("YPR138C",818).
component("YPL265W",801).
component("YPL134C",785).
component("YPL036W",780).
component("YOR348C",770).
component("YOR222W",760).
component("YOR171C",753).
component("YOR130C",749).
component("YOR011W",742).
component("YOL156W",741).
component("YOL103W",736).
component("YOL020W",724) :- not remove_orf("YOL020W",724).
component("YNR072W",720).
component("YNL270C",704).
component("YNL142W",694).
component("YMR011W",662).
component("YLR348C",637).
component("YLR260W",628).
component("YLR138W",614).
component("YLR100C",612).
component("YLR081W",610).
component("YLL061W",601).
component("YKR093W",596).
component("YKR053C",592).
component("YKR039W",591) :- not remove_orf("YKR039W",591).
component("YJR158W",562).
component("YJR077C",551).
component("YJL219W",538).
component("YJL214W",536).
component("YJL134W",528).
component("YJL129C",525).
component("YIL134W",500).
component("YHR096C",469).
component("YHR094C",468).
component("YHR092C",467).
component("YHL036W",451).
component("YGR121C",426).
component("YGR065C",422).
component("YGR055W",419).
component("YGL186C",406).
component("YGL077C",402).
component("YGL008C",390).
component("YFL055W",380).
component("YFL011W",375).
component("YER060W-A",354).
component("YER060W",353).
component("YER056C",352).
component("YER053C",351).
component("YEL069C",345).
component("YEL063C",344).
component("YEL017C-A",336).
component("YDR536W",334).
component("YDR508C",331).
component("YDR503C",330).
component("YDR497C",328).
component("YDR345C",315).
component("YDR343C",314).
component("YDR342C",313).
component("YDR297W",310).
component("YDR046C",284) :- not remove_orf("YDR046C",284).
component("YDL245C",276).
component("YDL210W",272).
component("YCR032W",235).
component("YCR028C",234).
component("YCR024C-A",233).
component("YCL025C",225).
component("YBR298C",221).
component("YBR291C",220).
component("YBR069C",189) :- not remove_orf("YBR069C",189).
component("YBR068C",188) :- not remove_orf("YBR068C",188).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,317) :- not remove_reaction(3620,317).
catalyst(2110,385).
catalyst(2190,385).
catalyst(5550,557).
catalyst(5791,623).
...
catalyst(2300,157).
catalyst(3460,125).
catalyst(3600,585) :- not remove_reaction(3600,585).
catalyst(8000,597).
catalyst(6890,696).
catalyst(2570,702).
catalyst(8781,309).
...
catalyst(4560,340).
catalyst(2550,716).
catalyst(1890,586) :- not remove_reaction(1890,586).
catalyst(3630,586) :- not remove_reaction(3630,586).
catalyst(1890,366) :- not remove_reaction(1890,366).
catalyst(3630,366) :- not remove_reaction(3630,366).
catalyst(3740,295).
catalyst(8231,805).
catalyst(8232,805).
catalyst(8231,777).
...
catalyst(8061,800).
catalyst(8062,800).
catalyst(3590,395) :- not remove_reaction(3590,395).
catalyst(10910,395) :- not remove_reaction(10910,395).
catalyst(4570,428).
catalyst(8181,633).
catalyst(8182,633).
catalyst(8181,535).
...
catalyst(8281,285).
catalyst(8282,285).
catalyst(3610,277) :- not remove_reaction(3610,277).
catalyst(7921,746).
catalyst(7922,746).
catalyst(7841,346).
catalyst(7842,346).
...
catalyst(1210,741).
catalyst(1160,736).
catalyst(801,724) :- not remove_reaction(801,724).
catalyst(802,724) :- not remove_reaction(802,724).
catalyst(811,724) :- not remove_reaction(811,724).
catalyst(812,724) :- not remove_reaction(812,724).
catalyst(831,724) :- not remove_reaction(831,724).
catalyst(832,724) :- not remove_reaction(832,724).
catalyst(901,724) :- not remove_reaction(901,724).
catalyst(902,724) :- not remove_reaction(902,724).
catalyst(1180,720).
catalyst(1210,720).
catalyst(931,704).
catalyst(932,704).
...
catalyst(640,596).
catalyst(6560,592).
catalyst(771,591) :- not remove_reaction(771,591).
catalyst(772,591) :- not remove_reaction(772,591).
catalyst(781,591) :- not remove_reaction(781,591).
catalyst(782,591) :- not remove_reaction(782,591).
catalyst(801,591) :- not remove_reaction(801,591).
catalyst(802,591) :- not remove_reaction(802,591).
catalyst(811,591) :- not remove_reaction(811,591).
catalyst(812,591) :- not remove_reaction(812,591).
catalyst(831,591) :- not remove_reaction(831,591).
catalyst(832,591) :- not remove_reaction(832,591).
catalyst(841,591) :- not remove_reaction(841,591).
catalyst(842,591) :- not remove_reaction(842,591).
catalyst(851,591) :- not remove_reaction(851,591).
catalyst(852,591) :- not remove_reaction(852,591).
catalyst(881,591) :- not remove_reaction(881,591).
catalyst(882,591) :- not remove_reaction(882,591).
catalyst(901,591) :- not remove_reaction(901,591).
catalyst(902,591) :- not remove_reaction(902,591).
catalyst(921,591) :- not remove_reaction(921,591).
catalyst(922,591) :- not remove_reaction(922,591).
catalyst(931,591) :- not remove_reaction(931,591).
catalyst(932,591) :- not remove_reaction(932,591).
catalyst(1191,591) :- not remove_reaction(1191,591).
catalyst(1192,591) :- not remove_reaction(1192,591).
catalyst(1180,562).
catalyst(1210,562).
catalyst(1581,551).
catalyst(1582,551).
...
catalyst(851,284) :- not remove_reaction(851,284).
catalyst(852,284) :- not remove_reaction(852,284).
...
catalyst(1511,220).
catalyst(1512,220).
catalyst(771,189) :- not remove_reaction(771,189).
catalyst(772,189) :- not remove_reaction(772,189).
...
catalyst(851,189) :- not remove_reaction(851,189).
catalyst(852,189) :- not remove_reaction(852,189).
...
catalyst(831,188) :- not remove_reaction(831,188).
catalyst(832,188) :- not remove_reaction(832,188).
catalyst(841,188) :- not remove_reaction(841,188).
catalyst(842,188) :- not remove_reaction(842,188).
catalyst(851,188) :- not remove_reaction(851,188).
catalyst(852,188) :- not remove_reaction(852,188).
