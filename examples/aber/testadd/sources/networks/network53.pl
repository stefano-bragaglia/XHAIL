...
component("YLR056W",311).
component("YKR009C",298).
component("YOL086C",377).
component("YMR303C",344).
component("YGL256W",215).
component("YDL168W",137).
component("YBR145W",104).
component("YPL231W",410).
component("U46_",64).
component("YBR149W",105).
component("YGL001C",197).
component("YIL094C",252).
component("U45_",63).
component("YDR127W",148).
component("YOL126C",381).
component("YKL085W",288).
component("YDL078C",131).
component("YNL037C",348).
component("YCL018W",117).
component("YLR355C",331).
component("YDL174C",139).
component("YML086C",336).
component("YGR088W",222).
component("YDR256C",158).
component("YJR078W",282).
component("YJR025C",276).
component("U107_",23).
component("YJL026W",263).
component("YGR180C",225).
component("YER070W",184).
component("U36_",59).
component("YDL168W",138).
component("YPL276W",417).
component("YPL275W",416).
component("YOR388C",401).
component("YOR323C",395).
component("YIL125W",255).
component("U52_",67).
component("YBR166C",107).
component("YKL216W",297).
component("YKR009C",299).
component("YIL160C",258).
component("YGL205W",212).
component("U100_",20).
component("YKR080W",303).
component("YER023W",179).
component("YGR204W",227).
component("YLR142W",316).
component("U65_",72).
component("U62_",71).
component("YHR068W",241).
component("YKL150W",291).
component("YIL043C",250).
component("YPL171C",409).
component("YHR179W",248).
component("YGR234W",228).
component("YDR353W",162).
component("YNL052W",349).
component("YMR256C",343).
component("YLR395C",333).
component("YLR038C",309).
component("YIL111W",253).
component("YHR051W",240).
component("YGL191W",210).
component("YGL187C",209).
component("YDL067C",130).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",415).
component("YKR069W",302).
component("YJR073C",280).
component("YDL033C",129).
component("YLR172C",318).
component("YLR058C",312).
component("YDR019C",143).
component("YBR176W",108).
component("YDR408C",167).
component("YMR120C",341).
component("YLR028C",307).
component("YBL013W",88).
component("YJL130C",268).
component("YKL024C",286).
component("YPR074C",424).
component("YBR117C",103).
component("YCL009C",116).
component("YNL071W",351).
component("YIL160C",259).
component("U48_",65).
component("YPL231W",411).
component("YPL231W",412).
component("YLR299W",325).
component("YGL017W",200).
component("YML126C",337).
component("YDL182W",140).
component("YDL131W",134).
component("YLR258W",323).
component("YFR015C",193).
component("YNL029C",347).
component("YIL085C",251).
component("YMR306W",345).
component("YLR342W",330).
component("YGR032W",217).
component("YLR209C",319).
component("U104_",21).
component("YDR354W",163) :- not remove_orf("YDR354W",163).
component("YFR047C",195).
component("YLR209C",320).
component("YML022W",334).
component("YDR441C",169).
component("YJL167W",272).
component("YDR127W",149).
component("YHR068W",242).
component("YLR303W",327).
component("YGR012W",216).
component("YJR130C",284).
component("YDR035W",144).
component("YBR249C",110).
component("YOR274W",394).
component("YHR137W",244).
component("YGL202W",211).
component("YLR027C",306).
component("YKL106W",289).
component("YOL140W",382).
component("YLR089C",313).
component("U61_",70).
component("YJR148W",285).
component("YFL030W",189).
component("YNR058W",368).
component("YGL253W",214).
component("YFR053C",196).
component("YOL016C",371).
component("YFR014C",192).
component("YCR036W",126).
component("YCL040W",119).
component("U96_",83).
component("YDR236C",156).
component("YHL032C",234).
component("YNR012W",365).
component("YDR127W",150).
component("YDR147W",153).
component("YCR012W",121).
component("U76_",80).
component("YER170W",188).
component("YDR226W",155).
component("YKL067W",287).
component("YOL055C",374).
component("YDR454C",170).
component("YJR057W",278).
component("YOL061W",376).
component("YKL181W",293).
component("YHL011C",233).
component("YER099C",187).
component("YBL068W",93).
component("YNL256W",359).
component("YBR018C",96).
component("YLR328W",329).
component("YBR029C",98).
component("YGL130W",206).
component("YPR190C",430).
component("YPR187W",429).
component("YPR110C",425).
component("YPR010C",420).
component("YOR341W",399).
component("YOR340C",398).
component("YOR224C",393).
component("YOR210W",392).
component("YOR207C",390).
component("YOR151C",387).
component("YOR116C",385).
component("YOL005C",369).
component("YNR003C",364).
component("YNL248C",358).
component("YNL151C",356).
component("YNL113W",353).
component("YKL144C",290).
component("YJR063W",279).
component("YJL148W",271).
component("YJL140W",270).
component("YIL021W",249).
component("YHR143W-A",245).
component("YGL070C",204).
component("YFL036W",190).
...
component("YPR175W",428).
component("YPL167C",408).
component("YOR330C",396).
component("YOL115W",380).
component("YNL299W",362).
component("YNL262W",360).
component("YNL102W",352).
component("YJR043C",277).
component("YJR006W",274).
component("YJL090C",265).
component("YIL139C",256).
component("YEL055C",176).
...
component("YPR113W",426).
component("YPL148C",407).
component("YGR286C",232).
component("YOL011W",370).
component("YMR008C",339).
component("YMR006C",338).
component("U105_",22).
component("YBL015W",89).
component("U77_",81).
component("YLR377C",332).
component("YHR046C",239).
component("U9_",85).
component("YPR073C",423).
component("YOR208W",391).
component("YNL053W",350).
component("YMR036C",340).
component("YIR026C",262).
component("YIL113W",254).
component("YFR028C",194).
component("YER075C",185).
...
component("U26_",56).
component("U24_",55).
component("YHR044C",238).
component("YHR043C",237).
component("YOR360C",400).
component("YGL027C",202).
component("YOR190W",389).
component("YLR300W",326).
component("YGR282C",231).
component("YDR261C",159).
component("YDR400W",165).
component("YML035C",335).
component("YJL070C",264).
component("YBR284W",114).
component("YDR242W",157).
component("U53_",68).
component("YPR062W",422).
component("YMR120C",342).
component("YLR028C",308).
component("YHR144C",246).
component("YBL033C",90).
component("YNL141W",354).
component("YLR245C",322).
component("YJL126W",266).
component("U39_",60).
component("YBR011C",95).
component("YBR111C",102).
component("YBR252W",111).
component("YER005W",178).
component("YBL099W",94).
component("YLR231C",321).
component("YLR134W",315).
component("YLR044C",310).
component("YGR087C",221).
component("YDR380W",164).
component("YDL080C",132).
component("U98_",84).
component("YOR128C",386).
component("YKL211C",295) :- not remove_orf("YKL211C",295).
component("YKR097W",304).
component("YNL169C",357).
component("YKL211C",296) :- not remove_orf("YKL211C",296).
component("YER090W",296) :- not remove_orf("YER090W",296).
component("YER090W",186) :- not remove_orf("YER090W",186).
component("YDR127W",151).
component("YPL281C",418).
component("YOR393W",402).
component("YMR323W",346).
component("YHR174W",247).
component("YGR254W",229).
component("YGL026C",201) :- not remove_orf("YGL026C",201).
component("YLR304C",328).
component("YJL200C",273).
component("YNL316C",363).
component("YPR002W",419).
component("YJR016C",275).
component("YCR053W",127).
component("YDR127W",152).
component("YGL148W",207).
component("YIL168W",261).
component("YIL167W",260).
...
component("YGL001C",198).
component("YPL117C",406).
component("YOL056W",375).
component("YKL152C",292).
component("YDL021W",128).
component("YPR060C",421).
component("YPL097W",404).
component("YGR185C",226).
component("YGR264C",230).
component("YGR171C",224).
component("YPL104W",405).
component("YLL018C",305).
component("YOL097C",378).
component("YDR268W",160).
component("YCR024C",123).
component("YHR019C",236).
component("YOR335C",397).
component("YLR153C",317).
component("YAL054C",87).
component("YIL145C",257).
component("YOL049W",373).
component("U90_",82).
component("YNR057C",367).
component("YGL234W",213).
component("YJR103W",283).
component("YBL039C",92).
component("YBR084W",101).
component("YHR074W",243).
component("YGL062W",203).
component("YBR218C",109).
component("YPL231W",413).
component("YNR016C",366).
component("YKL182W",294).
component("YGR037C",218).
component("YPR138C",427).
component("YPL265W",414).
component("YPL036W",403).
component("YOR171C",388).
component("YOR011W",383).
component("YOL103W",379).
component("YOL020W",372) :- not remove_orf("YOL020W",372).
component("YNL270C",361).
component("YNL142W",355).
component("YLR260W",324).
component("YLR100C",314).
component("YKR053C",301).
component("YKR039W",300) :- not remove_orf("YKR039W",300).
component("YJR077C",281).
component("YJL134W",269).
component("YJL129C",267).
component("YHL036W",235).
component("YGR121C",223).
component("YGR065C",220).
component("YGR055W",219).
component("YGL186C",208).
component("YGL077C",205).
component("YGL008C",199).
component("YFL055W",191).
component("YER060W-A",183).
component("YER060W",182).
component("YER056C",181).
component("YER053C",180).
component("YEL063C",177).
...
catalyst(6111,386).
catalyst(6112,386).
catalyst(3600,295) :- not remove_reaction(3600,295).
catalyst(8000,304).
catalyst(6890,357).
catalyst(3630,296) :- not remove_reaction(3630,296).
catalyst(3630,186) :- not remove_reaction(3630,186).
catalyst(3740,151).
catalyst(8231,418).
catalyst(8232,418).
catalyst(8231,402).
...
catalyst(8231,229).
catalyst(8232,229).
catalyst(3590,201) :- not remove_reaction(3590,201).
catalyst(10910,201) :- not remove_reaction(10910,201).
catalyst(8181,328).
catalyst(8182,328).
catalyst(8181,273).
catalyst(8182,273).
...
catalyst(901,372) :- not remove_reaction(901,372).
catalyst(902,372) :- not remove_reaction(902,372).
catalyst(931,361).
catalyst(932,361).
catalyst(371,355).
catalyst(372,355).
...
catalyst(6330,314).
catalyst(6560,301).
catalyst(771,300) :- not remove_reaction(771,300).
catalyst(772,300) :- not remove_reaction(772,300).
catalyst(781,300) :- not remove_reaction(781,300).
catalyst(782,300) :- not remove_reaction(782,300).
catalyst(801,300) :- not remove_reaction(801,300).
catalyst(802,300) :- not remove_reaction(802,300).
catalyst(811,300) :- not remove_reaction(811,300).
catalyst(812,300) :- not remove_reaction(812,300).
catalyst(831,300) :- not remove_reaction(831,300).
catalyst(832,300) :- not remove_reaction(832,300).
catalyst(841,300) :- not remove_reaction(841,300).
catalyst(842,300) :- not remove_reaction(842,300).
catalyst(851,300) :- not remove_reaction(851,300).
catalyst(852,300) :- not remove_reaction(852,300).
catalyst(881,300) :- not remove_reaction(881,300).
catalyst(882,300) :- not remove_reaction(882,300).
catalyst(901,300) :- not remove_reaction(901,300).
catalyst(902,300) :- not remove_reaction(902,300).
catalyst(931,300) :- not remove_reaction(931,300).
catalyst(932,300) :- not remove_reaction(932,300).
catalyst(1191,300) :- not remove_reaction(1191,300).
catalyst(1192,300) :- not remove_reaction(1192,300).
catalyst(1581,281).
catalyst(1582,281).
catalyst(6560,269).
catalyst(361,267).
