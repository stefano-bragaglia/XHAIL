...
component("YNL280C",586).
component("YLR056W",503).
component("YGL012W",319).
component("YKR009C",485).
component("YOL086C",608).
component("YMR303C",561).
component("YGL256W",339).
component("YDL168W",217).
component("YBR145W",163).
component("YPL231W",663).
component("YBR265W",178).
component("U46_",95).
...
component("U45_",94).
component("YML056C",542).
component("YLR432W",536).
component("YHR216W",399).
component("YAR075W",139).
component("YAR073W",138).
component("YDR127W",238).
component("YOL126C",614).
component("YKL085W",471).
component("YDL078C",205).
component("YNL037C",566).
component("YNL009W",564).
component("YLR174W",515).
component("YHR183W",393).
component("YGR256W",360).
component("YOL059W",606).
component("YDL022W",199).
component("YCL018W",186).
component("YLR355C",531).
component("YDL174C",221).
component("YML086C",544).
component("YIL155C",414).
component("YGR088W",347).
component("YDR256C",250).
component("YKL026C",469).
component("YIR037W",423).
component("YBR244W",174).
component("YJR078W",458).
component("U58_",103).
component("YJR025C",451).
component("U107_",24).
component("YHR007C",370).
component("YJR104C",460).
component("YHR008C",371).
component("YOR384W",646).
component("YOR381W",645).
component("YOL152W",616).
component("YLL051C",496).
component("YJL026W",425).
component("YIL066C",403).
component("YGR180C",351).
component("YER070W",293).
component("U37_",88).
component("U36_",87).
component("YDL168W",218).
component("YJR009C",448).
component("YJL052W",427).
component("YGR192C",353).
component("YBR006W",148).
component("YPL276W",671).
component("YPL275W",670).
component("YOR388C",647).
component("YOR374W",643).
component("YER073W",294).
component("YGL154C",331).
component("U55_",102).
component("YER069W",291).
component("YOR323C",636).
component("YER178W",302).
component("YBR221C",172).
component("YIL125W",410).
component("U52_",100).
component("YBR166C",167).
component("YGL012W",320).
component("YKL216W",484).
component("YDR044W",231).
component("YKR009C",486).
component("YIL160C",415).
component("YGL205W",336).
component("YMR118C",552).
component("YLR164W",513).
component("YLL041C",495).
component("YKL148C",475).
component("YKL141W",473).
component("YJL045W",426).
component("YDR178W",245).
component("YEL047C",279).
component("YDL171C",219).
component("YDL171C",220).
component("YOR375C",644).
component("YDL215C",223).
...
component("YOR236W",634).
component("YGR204W",354).
component("YIR034C",422).
component("YLR142W",510).
component("U65_",109).
component("U63_",107).
component("U62_",106).
component("YHR068W",380).
component("YKL150W",476).
component("YIL043C",402).
component("YHR042W",375).
component("YPL171C",658).
component("YHR179W",392).
component("YMR145C",555).
component("YML120C",545).
component("YKL192C",481).
component("YDL085W",207).
component("YGR234W",356).
component("YFR030W",313).
component("YPL017C",649).
component("YFL018C",306).
component("YDR353W",259).
component("YPR167C",683).
component("YJR137C",463).
component("YNL052W",568).
component("YMR256C",560).
component("YLR395C",535).
component("YLR038C",501).
component("YIL111W",407).
component("YHR051W",379).
component("YGL191W",334).
component("YGL187C",333).
component("YDL067C",204).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",669).
component("YKR069W",490).
component("YOL096C",609).
component("U47_",96).
component("YER091C",299).
component("YJR073C",456).
component("YDR120C",236).
component("YML008C",538).
component("YDL033C",201).
component("YOL096C",610).
component("YLR172C",514).
component("YLR058C",504).
component("YDR019C",229).
component("YBR176W",168).
component("YDR408C",264).
component("YMR120C",553).
component("YLR028C",499).
component("YBL013W",140).
component("YJL130C",435).
component("YKL024C",468).
component("YPR074C",679).
component("YBR117C",162).
component("YCL009C",185).
component("YNL071W",570).
component("YNR008W",591).
component("YIL160C",416).
component("YNR019W",594).
component("YCR048W",196).
component("U48_",97).
component("YDR232W",247).
component("YPL231W",664).
component("YDL052C",203).
component("U8_",125).
component("YPL231W",665).
component("YPL028W",650).
component("YLR299W",524).
component("YGL017W",321).
component("YML126C",546).
component("YNL104C",573).
component("YDL182W",222).
component("YDL131W",211).
component("YLR258W",521).
component("YFR015C",311).
component("YNL029C",565).
component("YIL085C",404).
component("YMR306W",562).
component("YLR342W",530).
component("YGR032W",342).
component("YLR209C",517).
component("U104_",21).
component("YDR354W",260) :- not remove_orf("YDR354W",260).
component("YFR047C",314).
component("YJR133W",462).
component("YLR209C",518).
component("YML022W",539).
component("YDR441C",266).
component("YJL167W",440).
component("YJL167W",441).
component("YDR127W",239).
component("YLR146C",511).
component("YHR068W",381).
component("YLR303W",526).
component("YGR012W",340).
component("YML082W",543).
component("YJR130C",461).
component("YDR035W",230).
component("YBR249C",175).
component("YLR180W",516).
component("YDR502C",269).
component("YOR274W",635).
component("YBR256C",177).
component("YHR137W",388).
component("YGL202W",335).
component("YLR027C",498).
component("YKL106W",472).
component("YOL140W",615).
component("YLR438W",537).
component("YGR019W",341).
component("YLR089C",506).
component("U64_",108).
component("U61_",105).
component("U51_",99).
component("YJR148W",464).
component("YHR208W",397).
component("YFL030W",307).
component("YOR184W",628).
component("YNR058W",597).
component("YIL116W",409).
component("YGL253W",338).
component("YFR053C",315).
component("YMR013C",550).
component("YMR205C",556).
component("YGR240C",357).
component("YOL016C",601).
component("YFR014C",310).
component("YCR036W",195).
component("YCL040W",188).
component("U15_",45).
component("YPL188W",659).
component("YJR049C",453).
component("YEL041W",277).
component("U96_",129).
component("YKL001C",467).
component("YDR236C",248).
component("YHL032C",368).
component("YDR531W",273).
component("U83_",124).
component("U82_",123).
component("U81_",122).
component("YMR208W",557).
component("YPL203W",660).
component("YOR061W",619).
component("YKL166C",478).
component("YJL164C",439).
component("YIL035C",401).
component("YHR205W",396).
component("YHR102W",387).
component("YGL019W",322).
component("YHR025W",374).
component("YOR347C",641).
component("YAL038W",134).
component("YNR012W",592).
component("YDR009W",228).
component("YDR127W",240).
component("YDR147W",243).
component("YDR300C",255).
component("YCR012W",190).
component("YER069W",292).
component("U18_",62).
component("U76_",118).
component("YER170W",301).
component("YDR226W",246).
component("YKL067W",470).
component("YOL055C",604).
component("YDR454C",267).
component("YJR057W",454).
component("YOL061W",607).
component("YKL181W",479).
component("YHL011C",367).
component("YER099C",300).
component("YBL068W",146).
component("YOR143C",624).
component("YNL256W",582).
component("YLR328W",528).
component("YBR018C",150).
component("YLR328W",529).
component("U94_",128).
component("YJR010W",449).
component("YBR029C",153).
component("YGL130W",329).
component("YDR530C",272).
component("YPR190C",686).
component("YPR187W",685).
component("YPR110C",680).
component("YPR010C",674).
component("YOR341W",640).
component("YOR340C",639).
component("YOR224C",633).
component("YOR210W",632).
component("YOR207C",630).
component("YOR151C",625).
component("YOR116C",621).
component("YOL005C",599).
component("YNR003C",590).
component("YNL248C",581).
component("YNL151C",577).
component("YNL113W",574).
component("YKL144C",474).
component("YJR063W",455).
component("YJL148W",438).
component("YJL140W",437).
component("YIL021W",400).
component("YHR143W-A",389).
component("YGL070C",327).
component("YFL036W",308).
component("YDR404C",263).
component("YDR156W",244).
component("YDR045C",232).
component("YDL150W",216).
component("YDL140C",212).
component("YBR154C",166).
component("YPR175W",684).
component("YPL167C",657).
component("YOR330C",637).
component("YOL115W",613).
component("YNL299W",588).
component("YNL262W",584).
component("YNL102W",572).
component("YJR043C",452).
component("YJR006W",447).
component("YJL090C",430).
component("YIL139C",412).
component("YEL055C",280).
component("YDR419W",265).
component("YDR121W",237).
component("YDL102W",210).
component("YCR014C",191).
component("YBR278W",180).
component("YBL035C",143).
component("YPR113W",681).
component("YBR243C",173).
component("YPL148C",655).
component("YGR286C",364).
component("YHR189W",394).
component("YDR058C",235).
component("YDL086W",208).
component("YOL011W",600).
component("YMR008C",548).
component("YMR006C",547).
component("U105_",22).
component("YBL015W",141).
component("YJL068C",428).
component("U77_",119).
component("YLR377C",533).
...
component("U9_",132).
component("YDL236W",225).
component("YPR073C",678).
component("YOR208W",631).
component("YNL053W",569).
component("YMR036C",551).
component("YIR026C",421).
component("YIL113W",408).
component("YFR028C",312).
component("YER075C",295).
component("YDL230W",224).
component("YBR276C",179).
component("U34_",86).
component("U33_",85).
component("U32_",84).
component("U31_",83).
...
component("U25_",79).
component("U24_",78).
component("YHR044C",377).
component("YHR043C",376).
component("YOR360C",642).
component("YKR031C",487).
component("YPL206C",661).
component("YGL027C",324).
component("YLR286C",523).
component("YJR153W",465).
component("YJL221C",446).
component("YJL216C",444).
component("YIL172C",419).
component("YGR292W",366).
component("YGR287C",365).
component("YBR299W",184).
component("YBR184W",169).
component("YIR019C",420).
component("YIL099W",406).
component("YDL037C",202).
component("YOR190W",629).
component("YLR300W",525).
component("YGR282C",363).
component("YDR261C",251).
component("YDR400W",262).
component("YML035C",540).
component("YJL070C",429).
component("YBR284W",181).
component("U106_",23).
component("YER043C",286).
component("YNL045W",567).
component("YDR242W",249).
component("U53_",101).
component("YPR062W",676).
component("YMR120C",554).
component("YLR028C",500).
component("YHR144C",390).
component("YGR267C",362).
component("YBL033C",142).
component("YNL141W",575).
component("YLR245C",520).
component("YML035C",541).
component("YBR084W",157).
component("YJL126W",433).
component("U44_",93).
component("YDL100C",209).
component("U40_",91).
component("U39_",89).
component("YBR011C",149).
component("YHR201C",395).
component("YBR111C",161).
component("YBR252W",176).
component("YER005W",284).
component("YBL099W",147).
component("YLR231C",519).
component("YLR134W",508).
component("YLR044C",502).
component("YGR087C",346).
component("YDR380W",261).
component("YDL080C",206).
component("U98_",130).
component("YMR250W",559).
component("YOR128C",622).
component("YEL021W",276).
component("U93_",127).
component("YKL211C",482) :- not remove_orf("YKL211C",482).
component("YKR097W",493).
component("YNL169C",578).
component("YNL256W",583).
component("YDR294C",253).
component("YEL046C",278).
component("YNR033W",595).
component("YKL211C",483) :- not remove_orf("YKL211C",483).
component("YER090W",483) :- not remove_orf("YER090W",483).
component("YER090W",298) :- not remove_orf("YER090W",298).
component("YDR127W",241).
component("YPL281C",672).
component("YOR393W",648).
component("YMR323W",563).
component("YHR174W",391).
component("YGR254W",359).
component("YPL262W",667).
component("YGL026C",323) :- not remove_orf("YGL026C",323).
component("YGR155W",349).
component("YLR304C",527).
component("YJL200C",442).
component("YNL316C",589).
component("YPL212C",662).
component("YNL292W",587).
component("YGL063W",326).
component("YFL001W",304).
component("YPR002W",673).
component("YJR016C",450).
component("YCR053W",197).
component("YDR127W",242).
component("YGL148W",330).
component("YIL168W",418).
component("YIL167W",417).
component("YCL064C",189).
component("YER086W",296).
component("YLR359W",532).
component("YAL012W",133).
component("YJL005W",424).
component("YJL121C",432).
component("YBR019C",151).
component("YDR050C",234).
component("YDR007W",227) :- not remove_orf("YDR007W",227).
component("YOR095C",620).
component("YBR196C",170).
component("YGL001C",317).
component("YPL117C",654).
component("U14_",39).
component("YOL056W",605).
component("YKL152C",477).
component("YDL021W",198).
component("YEL058W",281).
component("YPR060C",675).
component("YHR072W",382).
component("YPL097W",652).
component("YGR185C",352).
component("YGR264C",361).
component("YGR171C",350).
component("YPL104W",653).
component("YLL018C",494).
component("YHR020W",373).
component("YER087W",297).
component("YNL247W",580).
component("YOR168W",626).
component("YOL097C",611).
component("YDR268W",252).
component("YCR024C",192).
component("YHR019C",372).
component("YPL160W",656).
component("YLR382C",534).
component("YNL073W",571).
component("YOR335C",638).
component("YLR153C",512).
component("YAL054C",135).
component("YGR244C",358).
component("YIL145C",413).
component("YJL101C",431).
component("YOL049W",603).
component("YAR015W",137).
component("YER183C",303).
component("U90_",126).
component("YNR057C",596).
component("YDL141W",213).
component("YGL234W",337).
component("YDL141W",214).
component("YJR103W",459).
component("YBL039C",144).
component("YGR204W",355).
component("YBR084W",158).
component("YNL220W",579).
component("YDL141W",215).
component("YHR074W",383).
component("YMR217W",558).
component("YGL062W",325).
component("YBR218C",171).
component("YPL231W",666).
component("YNR016C",593).
component("YKL182W",480).
component("YGR037C",343).
component("YPR138C",682).
component("YPL265W",668).
component("YPL036W",651).
component("YOR171C",627).
component("YOR130C",623).
component("YOR011W",618).
component("YOL156W",617).
component("YOL103W",612).
component("YOL020W",602) :- not remove_orf("YOL020W",602).
component("YNR072W",598).
component("YNL270C",585).
component("YNL142W",576).
component("YMR011W",549).
component("YLR260W",522).
component("YLR138W",509).
component("YLR100C",507).
component("YLR081W",505).
component("YLL061W",497).
component("YKR093W",492).
component("YKR053C",489).
component("YKR039W",488) :- not remove_orf("YKR039W",488).
component("YJR158W",466).
component("YJR077C",457).
component("YJL219W",445).
component("YJL214W",443).
component("YJL134W",436).
component("YJL129C",434).
component("YIL134W",411).
component("YHR096C",386).
component("YHR094C",385).
component("YHR092C",384).
component("YHL036W",369).
component("YGR121C",348).
component("YGR065C",345).
component("YGR055W",344).
component("YGL186C",332).
component("YGL077C",328).
component("YGL008C",318).
component("YFL055W",309).
component("YFL011W",305).
component("YER060W-A",290).
component("YER060W",289).
component("YER056C",288).
component("YER053C",287).
component("YEL069C",283).
component("YEL063C",282).
component("YEL017C-A",275).
component("YDR536W",274).
component("YDR508C",271).
component("YDR503C",270).
component("YDR497C",268).
component("YDR345C",258).
component("YDR343C",257).
component("YDR342C",256).
component("YDR297W",254).
component("YDR046C",233) :- not remove_orf("YDR046C",233).
component("YDL245C",226).
component("YCR032W",194).
component("YCR024C-A",193).
component("YCL025C",187).
component("YBR298C",183).
component("YBR291C",182).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,260) :- not remove_reaction(3620,260).
catalyst(2110,314).
catalyst(2190,314).
catalyst(5550,462).
catalyst(5791,518).
...
catalyst(1890,298) :- not remove_reaction(1890,298).
catalyst(3630,298) :- not remove_reaction(3630,298).
catalyst(3740,241).
catalyst(8231,672).
catalyst(8232,672).
catalyst(8231,648).
...
catalyst(8051,667).
catalyst(8052,667).
catalyst(3590,323) :- not remove_reaction(3590,323).
catalyst(10910,323) :- not remove_reaction(10910,323).
catalyst(4570,349).
catalyst(8181,527).
catalyst(8182,527).
catalyst(8181,442).
...
catalyst(8281,234).
catalyst(8282,234).
catalyst(3610,227) :- not remove_reaction(3610,227).
catalyst(7921,620).
catalyst(7922,620).
catalyst(8341,170).
catalyst(8342,170).
...
catalyst(1210,617).
catalyst(1160,612).
catalyst(801,602) :- not remove_reaction(801,602).
catalyst(802,602) :- not remove_reaction(802,602).
catalyst(811,602) :- not remove_reaction(811,602).
catalyst(812,602) :- not remove_reaction(812,602).
catalyst(831,602) :- not remove_reaction(831,602).
catalyst(832,602) :- not remove_reaction(832,602).
catalyst(901,602) :- not remove_reaction(901,602).
catalyst(902,602) :- not remove_reaction(902,602).
catalyst(1180,598).
catalyst(1210,598).
catalyst(931,585).
catalyst(932,585).
...
catalyst(640,492).
catalyst(6560,489).
catalyst(771,488) :- not remove_reaction(771,488).
catalyst(772,488) :- not remove_reaction(772,488).
catalyst(781,488) :- not remove_reaction(781,488).
catalyst(782,488) :- not remove_reaction(782,488).
catalyst(801,488) :- not remove_reaction(801,488).
catalyst(802,488) :- not remove_reaction(802,488).
catalyst(811,488) :- not remove_reaction(811,488).
catalyst(812,488) :- not remove_reaction(812,488).
catalyst(831,488) :- not remove_reaction(831,488).
catalyst(832,488) :- not remove_reaction(832,488).
catalyst(841,488) :- not remove_reaction(841,488).
catalyst(842,488) :- not remove_reaction(842,488).
catalyst(851,488) :- not remove_reaction(851,488).
catalyst(852,488) :- not remove_reaction(852,488).
catalyst(881,488) :- not remove_reaction(881,488).
catalyst(882,488) :- not remove_reaction(882,488).
catalyst(901,488) :- not remove_reaction(901,488).
catalyst(902,488) :- not remove_reaction(902,488).
catalyst(921,488) :- not remove_reaction(921,488).
catalyst(922,488) :- not remove_reaction(922,488).
catalyst(931,488) :- not remove_reaction(931,488).
catalyst(932,488) :- not remove_reaction(932,488).
catalyst(1191,488) :- not remove_reaction(1191,488).
catalyst(1192,488) :- not remove_reaction(1192,488).
catalyst(1180,466).
catalyst(1210,466).
catalyst(1581,457).
catalyst(1582,457).
...
catalyst(841,233) :- not remove_reaction(841,233).
catalyst(842,233) :- not remove_reaction(842,233).
