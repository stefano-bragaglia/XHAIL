...
component("YLR056W",462).
component("YGL012W",288).
component("YKR009C",444).
component("YOL086C",561).
component("YMR303C",516).
component("YGL256W",308).
component("YDL168W",196).
component("YBR145W",151).
component("YPL231W",615).
component("YBR265W",162).
component("U46_",86).
component("YBR149W",152).
component("YBR149W",153).
component("YGL001C",285).
component("YIL094C",372).
component("U45_",85).
component("YML056C",498).
component("YLR432W",494).
component("YHR216W",366).
component("YAR075W",127).
component("YAR073W",126).
component("YDR127W",212).
component("YOL126C",566).
component("YKL085W",430).
component("YDL078C",186).
component("YNL037C",521).
component("YNL009W",519).
component("YLR174W",473).
component("YHR183W",361).
component("YGR256W",328).
component("YOL059W",559).
component("YDL022W",182).
component("YCL018W",170).
component("YLR355C",489).
component("YDL174C",199).
component("YML086C",500).
component("YGR088W",316).
component("YDR256C",223).
component("YJR078W",418).
component("YJR025C",411).
component("U107_",24).
component("YHR007C",338).
component("YJR104C",420).
component("YHR008C",339).
component("YOR384W",598).
component("YOR381W",597).
component("YOL152W",568).
component("YLL051C",455).
component("YJL026W",386).
component("YIL066C",370).
component("YGR180C",319).
component("YER070W",264).
component("U37_",79).
component("U36_",78).
component("YDL168W",197).
component("YJR009C",409).
component("YJL052W",388).
component("YGR192C",321).
component("YBR006W",136).
component("YPL276W",623).
component("YPL275W",622).
component("YOR388C",599).
component("YOR374W",595).
component("YER073W",265).
component("YGL154C",300).
component("U55_",92).
component("YER069W",262).
component("YOR323C",588).
component("YER178W",271).
component("YBR221C",159).
component("YIL125W",376).
component("U52_",90).
component("YBR166C",155).
component("YGL012W",289).
component("YKL216W",443).
component("YKR009C",445).
component("YIL160C",380).
component("YGL205W",305).
component("YMR118C",508).
component("YLR164W",471).
component("YLL041C",454).
component("YKL148C",434).
component("YKL141W",432).
component("YJL045W",387).
component("YDR178W",219).
component("YEL047C",250).
component("YDL171C",198).
component("YOR375C",596).
component("YAL062W",124).
component("U99_",119).
component("U100_",20).
component("YBR035C",142).
component("YKR080W",450).
component("YER023W",256).
component("YOR236W",586).
component("YGR204W",322).
component("YLR142W",469).
component("U65_",98).
component("U63_",96).
component("U62_",95).
component("YHR068W",348).
component("YKL150W",435).
component("YIL043C",369).
component("YHR042W",343).
component("YPL171C",610).
component("YHR179W",360).
component("YMR145C",511).
component("YML120C",501).
component("YKL192C",440).
component("YDL085W",188).
component("YGR234W",324).
component("YFR030W",282).
component("YPL017C",601).
component("YFL018C",275).
component("YDR353W",230).
component("YPR167C",635).
component("YJR137C",423).
component("YNL052W",523).
component("YMR256C",515).
component("YLR395C",493).
component("YLR038C",460).
component("YIL111W",373).
component("YHR051W",347).
component("YGL191W",303).
component("YGL187C",302).
component("YDL067C",185).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",621).
component("YKR069W",449).
component("YOL096C",562).
component("U47_",87).
component("YJR073C",416).
component("YDR120C",210).
component("YML008C",495).
component("YDL033C",184).
component("YLR172C",472).
component("YLR058C",463).
component("YDR019C",205).
component("YBR176W",156).
component("YDR408C",235).
component("YMR120C",509).
component("YLR028C",458).
component("YBL013W",128).
component("YJL130C",396).
component("YKL024C",428).
component("YPR074C",631).
component("YBR117C",150).
component("YCL009C",169).
component("YNL071W",525).
component("YNR008W",545).
component("YIL160C",381).
component("U48_",88).
component("YPL231W",616).
component("YPL231W",617).
component("YPL028W",602).
component("YLR299W",482).
component("YGL017W",290).
component("YML126C",502).
component("YNL104C",528).
component("YDL182W",200).
component("YDL131W",192).
component("YLR258W",479).
component("YFR015C",280).
component("YNL029C",520).
component("YIL085C",371).
component("YMR306W",517).
component("YLR342W",488).
component("YGR032W",311).
component("YLR209C",475).
component("U104_",21).
component("YDR354W",231) :- not remove_orf("YDR354W",231).
component("YFR047C",283).
component("YJR133W",422).
component("YLR209C",476).
component("YML022W",496).
component("YDR441C",237).
component("YJL167W",401).
component("YJL167W",402).
component("YDR127W",213).
component("YHR068W",349).
component("YLR303W",484).
component("YGR012W",309).
component("YML082W",499).
component("YJR130C",421).
component("YDR035W",206).
component("YBR249C",160).
component("YLR180W",474).
component("YDR502C",240).
component("YOR274W",587).
component("YHR137W",356).
component("YGL202W",304).
component("YLR027C",457).
component("YKL106W",431).
component("YOL140W",567).
component("YGR019W",310).
component("YLR089C",465).
component("U64_",97).
component("U61_",94).
component("YJR148W",424).
component("YFL030W",276).
component("YOR184W",580).
component("YNR058W",550).
component("YIL116W",375).
component("YGL253W",307).
component("YFR053C",284).
component("YMR013C",506).
component("YMR205C",512).
component("YGR240C",325).
component("YOL016C",554).
component("YFR014C",279).
component("YCR036W",179).
component("YCL040W",172).
component("U15_",43).
component("YPL188W",611).
component("YJR049C",413).
component("YEL041W",248).
component("U96_",117).
component("YKL001C",427).
component("YDR236C",221).
component("YHL032C",336).
component("YDR531W",244).
component("U83_",113).
component("U82_",112).
component("U81_",111).
component("YMR208W",513).
component("YPL203W",612).
component("YOR061W",571).
component("YKL166C",437).
component("YJL164C",400).
component("YIL035C",368).
component("YHR205W",364).
component("YHR102W",355).
component("YGL019W",291).
component("YHR025W",342).
component("YOR347C",593).
component("YAL038W",122).
component("YNR012W",546).
component("YDR127W",214).
component("YDR147W",217).
component("YCR012W",174).
component("YER069W",263).
component("U76_",107).
component("YER170W",270).
component("YDR226W",220).
component("YKL067W",429).
component("YOL055C",557).
component("YDR454C",238).
component("YJR057W",414).
component("YOL061W",560).
component("YKL181W",438).
component("YHL011C",335).
component("YER099C",269).
component("YBL068W",134).
component("YOR143C",576).
component("YNL256W",537).
component("YLR328W",486).
component("YBR018C",138).
component("YLR328W",487).
component("U94_",116).
component("YBR029C",141).
component("YGL130W",298).
component("YDR530C",243).
component("YPR190C",638).
component("YPR187W",637).
component("YPR110C",632).
component("YPR010C",626).
component("YOR341W",592).
component("YOR340C",591).
component("YOR224C",585).
component("YOR210W",584).
component("YOR207C",582).
component("YOR151C",577).
component("YOR116C",573).
component("YOL005C",552).
component("YNR003C",544).
component("YNL248C",536).
component("YNL151C",532).
component("YNL113W",529).
component("YKL144C",433).
component("YJR063W",415).
component("YJL148W",399).
component("YJL140W",398).
component("YIL021W",367).
component("YHR143W-A",357).
component("YGL070C",296).
component("YFL036W",277).
component("YDR404C",234).
component("YDR156W",218).
component("YDR045C",207).
component("YDL150W",195).
component("YDL140C",193).
component("YBR154C",154).
component("YPR175W",636).
component("YPL167C",609).
component("YOR330C",589).
component("YOL115W",565).
component("YNL299W",542).
component("YNL262W",538).
component("YNL102W",527).
component("YJR043C",412).
component("YJR006W",408).
component("YJL090C",391).
component("YIL139C",378).
component("YEL055C",251).
component("YDR419W",236).
component("YDR121W",211).
component("YDL102W",191).
component("YCR014C",175).
component("YBR278W",164).
component("YBL035C",131).
component("YPR113W",633).
component("YPL148C",607).
component("YGR286C",332).
component("YHR189W",362).
component("YDR058C",209).
component("YDL086W",189).
component("YOL011W",553).
component("YMR008C",504).
component("YMR006C",503).
component("U105_",22).
component("YBL015W",129).
component("YJL068C",389).
component("U77_",108).
component("YLR377C",491).
component("YPR073C",629).
component("YHR215W",365).
component("YDL024C",183).
component("YBR093C",148).
component("YBR092C",147).
component("YHR046C",346).
component("U9_",120).
component("YDL236W",202).
component("YPR073C",630).
component("YOR208W",583).
component("YNL053W",524).
component("YMR036C",507).
component("YIR026C",385).
component("YIL113W",374).
component("YFR028C",281).
component("YER075C",266).
component("YDL230W",201).
...
component("U25_",71).
component("U24_",70).
component("YHR044C",345).
component("YHR043C",344).
component("YOR360C",594).
component("YKR031C",446).
component("YPL206C",613).
component("YGL027C",293).
component("YLR286C",481).
component("YJR153W",425).
component("YJL221C",407).
component("YJL216C",405).
component("YIL172C",384).
component("YGR292W",334).
component("YGR287C",333).
component("YBR299W",168).
component("YOR190W",581).
component("YLR300W",483).
component("YGR282C",331).
component("YDR261C",224).
component("YDR400W",233).
component("YML035C",497).
component("YJL070C",390).
component("YBR284W",165).
component("U106_",23).
component("YER043C",257).
component("YNL045W",522).
component("YDR242W",222).
component("U53_",91).
component("YPR062W",628).
component("YMR120C",510).
component("YLR028C",459).
component("YHR144C",358).
component("YGR267C",330).
component("YBL033C",130).
component("YNL141W",530).
component("YLR245C",478).
component("YBR084W",145).
component("YJL126W",394).
component("U44_",84).
component("YDL100C",190).
component("U40_",82).
component("U39_",80).
component("YBR011C",137).
component("YHR201C",363).
component("YBR111C",149).
component("YBR252W",161).
component("YER005W",255).
component("YBL099W",135).
component("YLR231C",477).
component("YLR134W",467).
component("YLR044C",461).
component("YGR087C",315).
component("YDR380W",232).
component("YDL080C",187).
component("U98_",118).
component("YMR250W",514).
component("YOR128C",574).
component("YEL021W",247).
component("U93_",115).
component("YKL211C",441) :- not remove_orf("YKL211C",441).
component("YKR097W",452).
component("YNL169C",533).
component("YEL046C",249).
component("YNR033W",548).
component("YKL211C",442) :- not remove_orf("YKL211C",442).
component("YER090W",442) :- not remove_orf("YER090W",442).
component("YER090W",268) :- not remove_orf("YER090W",268).
component("YDR127W",215).
component("YPL281C",624).
component("YOR393W",600).
component("YMR323W",518).
component("YHR174W",359).
component("YGR254W",327).
component("YPL262W",619).
component("YGL026C",292) :- not remove_orf("YGL026C",292).
component("YLR304C",485).
component("YJL200C",403).
component("YNL316C",543).
component("YPL212C",614).
component("YNL292W",541).
component("YGL063W",295).
component("YFL001W",273).
component("YPR002W",625).
component("YJR016C",410).
component("YCR053W",180).
component("YDR127W",216).
component("YGL148W",299).
component("YIL168W",383).
component("YIL167W",382).
component("YCL064C",173).
component("YLR359W",490).
component("YAL012W",121).
component("YJL121C",393).
component("YBR019C",139).
component("YDR007W",204) :- not remove_orf("YDR007W",204).
component("YOR095C",572).
component("YBR196C",157).
component("YGL001C",286).
component("YPL117C",606).
component("U14_",37).
component("YOL056W",558).
component("YKL152C",436).
component("YDL021W",181).
component("YEL058W",252).
component("YPR060C",627).
component("YHR072W",350).
component("YPL097W",604).
component("YGR185C",320).
component("YGR264C",329).
component("YGR171C",318).
component("YPL104W",605).
component("YLL018C",453).
component("YHR020W",341).
component("YER087W",267).
component("YNL247W",535).
component("YOR168W",578).
component("YOL097C",563).
component("YDR268W",225).
component("YCR024C",176).
component("YHR019C",340).
component("YPL160W",608).
component("YLR382C",492).
component("YNL073W",526).
component("YOR335C",590).
component("YLR153C",470).
component("YAL054C",123).
component("YGR244C",326).
component("YIL145C",379).
component("YJL101C",392).
component("YOL049W",556).
component("YAR015W",125).
component("YER183C",272).
component("U90_",114).
component("YNR057C",549).
component("YGL234W",306).
component("YJR103W",419).
component("YBL039C",132).
component("YGR204W",323).
component("YBR084W",146).
component("YNL220W",534).
component("YDL141W",194).
component("YHR074W",351).
component("YGL062W",294).
component("YBR218C",158).
component("YPL231W",618).
component("YNR016C",547).
component("YKL182W",439).
component("YGR037C",312).
component("YPR138C",634).
component("YPL265W",620).
component("YPL036W",603).
component("YOR171C",579).
component("YOR130C",575).
component("YOR011W",570).
component("YOL156W",569).
component("YOL103W",564).
component("YOL020W",555) :- not remove_orf("YOL020W",555).
component("YNR072W",551).
component("YNL270C",539).
component("YNL142W",531).
component("YMR011W",505).
component("YLR260W",480).
component("YLR138W",468).
component("YLR100C",466).
component("YLR081W",464).
component("YLL061W",456).
component("YKR093W",451).
component("YKR053C",448).
component("YKR039W",447) :- not remove_orf("YKR039W",447).
component("YJR158W",426).
component("YJR077C",417).
component("YJL219W",406).
component("YJL214W",404).
component("YJL134W",397).
component("YJL129C",395).
component("YIL134W",377).
component("YHR096C",354).
component("YHR094C",353).
component("YHR092C",352).
component("YHL036W",337).
component("YGR121C",317).
component("YGR065C",314).
component("YGR055W",313).
component("YGL186C",301).
component("YGL077C",297).
component("YGL008C",287).
component("YFL055W",278).
component("YFL011W",274).
component("YER060W-A",261).
component("YER060W",260).
component("YER056C",259).
component("YER053C",258).
component("YEL069C",254).
component("YEL063C",253).
component("YEL017C-A",246).
component("YDR536W",245).
component("YDR508C",242).
component("YDR503C",241).
component("YDR497C",239).
component("YDR345C",229).
component("YDR343C",228).
component("YDR342C",227).
component("YDR297W",226).
component("YDR046C",208) :- not remove_orf("YDR046C",208).
component("YDL245C",203).
component("YCR032W",178).
component("YCR024C-A",177).
component("YCL025C",171).
component("YBR298C",167).
component("YBR291C",166).
component("YBR069C",144) :- not remove_orf("YBR069C",144).
component("YBR068C",143) :- not remove_orf("YBR068C",143).
component("YBR021W",140).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,231) :- not remove_reaction(3620,231).
catalyst(2110,283).
catalyst(2190,283).
catalyst(5550,422).
catalyst(5791,476).
...
catalyst(5880,247).
catalyst(2300,115).
catalyst(3600,441) :- not remove_reaction(3600,441).
catalyst(8000,452).
catalyst(6890,533).
catalyst(4560,249).
catalyst(2550,548).
...
catalyst(1890,268) :- not remove_reaction(1890,268).
catalyst(3630,268) :- not remove_reaction(3630,268).
catalyst(3740,215).
catalyst(8231,624).
catalyst(8232,624).
catalyst(8231,600).
...
catalyst(8051,619).
catalyst(8052,619).
catalyst(3590,292) :- not remove_reaction(3590,292).
catalyst(10910,292) :- not remove_reaction(10910,292).
catalyst(8181,485).
catalyst(8182,485).
catalyst(8181,403).
catalyst(8182,403).
...
catalyst(7751,139).
catalyst(7752,139).
catalyst(3610,204) :- not remove_reaction(3610,204).
catalyst(7921,572).
catalyst(7922,572).
catalyst(8341,157).
catalyst(8342,157).
...
catalyst(901,555) :- not remove_reaction(901,555).
catalyst(902,555) :- not remove_reaction(902,555).
catalyst(1210,551).
catalyst(931,539).
catalyst(932,539).
catalyst(371,531).
...
catalyst(640,451).
catalyst(6560,448).
catalyst(771,447) :- not remove_reaction(771,447).
catalyst(772,447) :- not remove_reaction(772,447).
catalyst(781,447) :- not remove_reaction(781,447).
catalyst(782,447) :- not remove_reaction(782,447).
catalyst(801,447) :- not remove_reaction(801,447).
catalyst(802,447) :- not remove_reaction(802,447).
catalyst(811,447) :- not remove_reaction(811,447).
catalyst(812,447) :- not remove_reaction(812,447).
catalyst(831,447) :- not remove_reaction(831,447).
catalyst(832,447) :- not remove_reaction(832,447).
catalyst(841,447) :- not remove_reaction(841,447).
catalyst(842,447) :- not remove_reaction(842,447).
catalyst(851,447) :- not remove_reaction(851,447).
catalyst(852,447) :- not remove_reaction(852,447).
catalyst(881,447) :- not remove_reaction(881,447).
catalyst(882,447) :- not remove_reaction(882,447).
catalyst(901,447) :- not remove_reaction(901,447).
catalyst(902,447) :- not remove_reaction(902,447).
catalyst(921,447) :- not remove_reaction(921,447).
catalyst(922,447) :- not remove_reaction(922,447).
catalyst(931,447) :- not remove_reaction(931,447).
catalyst(932,447) :- not remove_reaction(932,447).
catalyst(1191,447) :- not remove_reaction(1191,447).
catalyst(1192,447) :- not remove_reaction(1192,447).
catalyst(1210,426).
catalyst(1581,417).
catalyst(1582,417).
catalyst(1210,406).
...
catalyst(1491,166).
catalyst(1492,166).
catalyst(771,144) :- not remove_reaction(771,144).
catalyst(772,144) :- not remove_reaction(772,144).
...
catalyst(851,144) :- not remove_reaction(851,144).
catalyst(852,144) :- not remove_reaction(852,144).
catalyst(901,144) :- not remove_reaction(901,144).
catalyst(902,144) :- not remove_reaction(902,144).
...
catalyst(831,143) :- not remove_reaction(831,143).
catalyst(832,143) :- not remove_reaction(832,143).
catalyst(841,143) :- not remove_reaction(841,143).
catalyst(842,143) :- not remove_reaction(842,143).
catalyst(851,143) :- not remove_reaction(851,143).
catalyst(852,143) :- not remove_reaction(852,143).
catalyst(901,143) :- not remove_reaction(901,143).
catalyst(902,143) :- not remove_reaction(902,143).
catalyst(620,140).
catalyst(540,133).
catalyst(6960,110).
catalyst(2840,109).
