...
component("YLR056W",154).
component("YPL231W",198).
component("U46_",36).
component("YBR149W",55).
component("YIL094C",127).
component("U45_",35).
component("YDR127W",76).
component("YOL126C",186).
component("YDL078C",67).
component("YNL037C",170).
component("YML086C",166).
component("YGR088W",113).
component("YDR256C",83).
component("YJR078W",137).
component("U107_",19).
component("YER070W",101).
component("U36_",32).
component("YPL276W",204).
component("YPL275W",203).
component("YOR388C",192).
component("YOR323C",189).
component("YIL125W",128).
component("U52_",38).
component("YBR166C",56).
component("YKL216W",146).
component("YKR009C",147).
component("YIL160C",130).
component("YGL205W",111).
component("YKR080W",149).
component("YER023W",97).
component("YLR142W",157).
component("U62_",40).
component("YHR068W",121).
component("YKL150W",142).
component("YIL043C",125).
component("YPL266W",202).
component("YDL033C",66).
component("YLR058C",155).
component("YDR019C",72).
component("YBR176W",57).
component("YDR408C",87).
component("YMR120C",167).
component("YLR028C",152).
component("YPR074C",207).
component("YBR117C",54).
component("YPL231W",199).
component("YPL231W",200).
component("YLR299W",162).
component("YDL182W",70).
component("YDL131W",69).
component("YNL029C",169).
component("YIL085C",126).
component("YLR209C",159).
component("YDR354W",85) :- not remove_orf("YDR354W",85).
component("YFR047C",105).
component("YLR209C",160).
component("YML022W",164).
component("YDR441C",89).
component("YJL167W",133).
component("YDR127W",77).
component("YDR035W",73).
component("YBR249C",59).
component("YOR274W",188).
component("YHR137W",122).
component("YLR027C",151).
component("YKL106W",141).
component("YJR148W",139).
component("YNR058W",180).
component("YCR036W",65).
component("U96_",42).
component("YNR012W",178).
component("YDR127W",78).
component("YDR226W",81).
component("YKL067W",140).
component("YDR454C",90).
component("YOL061W",182).
component("YKL181W",143).
component("YHL011C",119).
component("YER099C",103).
component("YBL068W",48).
component("YNL256W",173).
component("YBR018C",50).
component("YPR175W",210).
component("YPL167C",197).
component("YOR330C",190).
component("YOL115W",185).
component("YNL299W",176).
component("YNL262W",174).
component("YNL102W",171).
component("YJR043C",135).
component("YJR006W",134).
component("YJL090C",132).
component("YIL139C",129).
component("YEL055C",94).
component("YDR419W",88).
component("YDR121W",75).
component("YDL102W",68).
component("YCR014C",64).
component("YBR278W",61).
component("YBL035C",46).
component("YPR113W",208).
component("U105_",18).
component("YLR377C",163).
component("U30_",31).
component("U29_",30).
component("U24_",29).
component("YGL027C",107).
component("YDR400W",86).
component("YML035C",165).
component("YJL070C",131).
component("YBR284W",62).
component("YDR242W",82).
component("U53_",39).
component("YLR028C",153).
component("YHR144C",123).
component("U39_",33).
component("YBR011C",49).
component("YBR111C",53).
component("YBR252W",60).
component("YER005W",96).
component("YLR231C",161).
component("U98_",43).
component("YKL211C",144) :- not remove_orf("YKL211C",144).
component("YKL211C",145) :- not remove_orf("YKL211C",145).
component("YER090W",145) :- not remove_orf("YER090W",145).
component("YER090W",102) :- not remove_orf("YER090W",102).
component("YDR127W",79).
component("YPL281C",205).
component("YOR393W",193).
component("YMR323W",168).
component("YHR174W",124).
component("YGR254W",117).
component("YGL026C",106) :- not remove_orf("YGL026C",106).
component("YNL316C",177).
component("YDR127W",80).
component("YGL148W",109).
component("YAL012W",44).
component("YDR007W",71) :- not remove_orf("YDR007W",71).
component("YOR095C",187).
component("YPL117C",196).
component("YPR060C",206).
component("YPL097W",194).
component("YGR185C",116).
component("YGR264C",118).
component("YGR171C",115).
component("YPL104W",195).
component("YLL018C",150).
component("YOL097C",183).
component("YOR335C",191).
component("YLR153C",158).
component("YAL054C",45).
component("U90_",41).
component("YNR057C",179).
component("YJR103W",138).
component("YBL039C",47).
component("YGL062W",108).
component("YBR218C",58).
component("YPR138C",209).
component("YPL265W",201).
component("YOL103W",184).
component("YOL020W",181) :- not remove_orf("YOL020W",181).
component("YNL270C",175).
component("YNL142W",172).
component("YLR100C",156).
component("YKR039W",148) :- not remove_orf("YKR039W",148).
component("YJR077C",136).
component("YHL036W",120).
component("YGR121C",114).
component("YGR055W",112).
component("YGL186C",110).
component("YFL055W",104).
component("YER060W-A",100).
component("YER060W",99).
component("YER056C",98).
component("YEL063C",95).
component("YDR536W",93).
component("YDR508C",92).
component("YDR497C",91).
component("YDR297W",84).
component("YDR046C",74) :- not remove_orf("YDR046C",74).
component("YCL025C",63).
...
catalyst(5601,159).
catalyst(5602,159).
catalyst(3620,85) :- not remove_reaction(3620,85).
catalyst(2190,105).
catalyst(5791,160).
catalyst(5792,160).
catalyst(5801,160).
...
catalyst(3500,161).
catalyst(2250,43).
catalyst(3600,144) :- not remove_reaction(3600,144).
catalyst(3630,145) :- not remove_reaction(3630,145).
catalyst(3630,102) :- not remove_reaction(3630,102).
catalyst(3740,79).
catalyst(8231,205).
catalyst(8232,205).
catalyst(8231,193).
...
catalyst(8231,117).
catalyst(8232,117).
catalyst(3590,106) :- not remove_reaction(3590,106).
catalyst(10910,106) :- not remove_reaction(10910,106).
catalyst(3680,177).
catalyst(3750,80).
catalyst(3700,109).
catalyst(4460,44).
catalyst(3610,71) :- not remove_reaction(3610,71).
catalyst(7921,187).
catalyst(7922,187).
catalyst(6461,196).
catalyst(6462,196).
...
catalyst(372,172).
catalyst(6330,156).
catalyst(771,148) :- not remove_reaction(771,148).
catalyst(772,148) :- not remove_reaction(772,148).
catalyst(781,148) :- not remove_reaction(781,148).
catalyst(782,148) :- not remove_reaction(782,148).
...
catalyst(881,148) :- not remove_reaction(881,148).
catalyst(882,148) :- not remove_reaction(882,148).
catalyst(931,148) :- not remove_reaction(931,148).
catalyst(932,148) :- not remove_reaction(932,148).
catalyst(1191,148) :- not remove_reaction(1191,148).
catalyst(1192,148) :- not remove_reaction(1192,148).
catalyst(1581,136).
catalyst(1582,136).
catalyst(841,120).
catalyst(842,120).
...
catalyst(841,74) :- not remove_reaction(841,74).
catalyst(842,74) :- not remove_reaction(842,74).
