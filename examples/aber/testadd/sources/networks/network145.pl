...
component("YNL280C",750).
component("YLR056W",643).
component("YGR060W",447).
component("YGL012W",418).
component("YKR009C",623).
component("YOL086C",781).
component("YMR303C",723).
component("YMR083W",703).
component("YGL256W",440).
...
component("YIL094C",523).
component("U45_",130).
component("YML056C",690).
component("YLR432W",679).
component("YHR216W",514).
component("YAR075W",186).
component("YAR073W",185).
component("YDR127W",317).
component("YJR139C",590).
component("YML075C",692).
component("YLR450W",682).
component("YOL126C",787).
component("YKL085W",601).
component("YDL078C",272).
component("YKL029C",597).
component("YNL037C",728).
component("YNL009W",726).
component("YLR174W",656).
component("YHR183W",507).
component("YGR256W",470).
component("YNL241C",743).
component("YOL059W",778).
component("YDL022W",264).
component("YCL018W",246).
component("YLR355C",674).
component("YIL074C",520).
component("YER081W",388).
component("YML054C",689).
component("YDL174C",294).
component("YML086C",694).
component("YIL155C",532).
component("YEL024W",363).
component("YKR066C",628).
component("YGR088W",451).
component("YDR256C",331).
component("YKL026C",596).
...
component("U107_",27).
component("YGR255C",469).
component("U108_",28).
component("YHR007C",481).
component("YDR402C",345).
component("YGL055W",425).
component("YJR104C",585).
component("YHR008C",482).
component("YOR384W",826).
component("YOR381W",825).
component("YOL152W",789).
component("YLL051C",636).
component("YJL026W",544).
component("YIL066C",519).
...
component("YDR158W",325).
component("YJR009C",571).
component("YJL052W",546).
component("YGR192C",460).
component("YBR006W",198).
component("YPL276W",858).
component("YPL275W",857).
component("YOR388C",827).
component("YPL061W",834).
component("YOR374W",823).
component("YER073W",386).
component("YGL154C",432).
component("YBR115C",216).
component("U55_",139).
component("YER069W",383).
component("YOR323C",815).
component("YMR170C",713).
component("YMR169C",712).
component("YER178W",398).
component("YBR221C",231).
component("YIL125W",528).
component("U52_",136).
component("YBR166C",225).
component("YNL280C",751).
component("YGL012W",419).
component("YKL182W",611).
component("YKL216W",621).
component("YDR044W",307).
component("YER014W",373).
component("YKR009C",624).
component("YIL160C",533).
component("YGL205W",437).
component("YMR118C",707).
component("YLR164W",654).
component("YLL041C",634).
component("YKL148C",606).
component("YKL141W",604).
component("YJL045W",545).
component("YDR178W",326).
component("YEL047C",366).
component("YDL171C",292).
component("YDL171C",293).
component("YOR375C",824).
component("YDL215C",298).
component("YAL062W",182).
component("U99_",176).
component("U100_",21).
component("YBR035C",206).
component("YKR080W",630).
component("YER023W",374).
component("YOR236W",813).
component("YGR204W",462).
component("YIR034C",541).
component("YLR142W",651).
component("U65_",147).
component("U63_",145).
component("U62_",144).
component("YHR068W",492).
component("YKL150W",607).
component("YIL043C",517).
component("YHR042W",487).
component("YOR221C",810).
component("YMR145C",710).
component("YKL192C",615).
component("YKL055C",599).
component("YER061C",381).
component("YDL085W",274).
component("YPL171C",842).
component("YHR179W",506).
...
component("YPL017C",830).
component("YFL018C",402).
component("YDR353W",341).
component("YPR167C",875).
component("YJR137C",589).
component("YNL052W",730).
component("YMR256C",720).
component("YLR395C",678).
component("YLR038C",641).
component("YIL111W",525).
component("YHR051W",491).
component("YGL191W",435).
component("YGL187C",434).
component("YDL067C",271).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",312).
component("YPL266W",856).
component("YKR069W",629).
component("YOL096C",782).
component("U47_",132).
component("YER091C",393).
component("YJR073C",580).
component("YGR157W",456).
component("YDR120C",315).
component("YML008C",684).
component("YOR074C",794).
component("YDL033C",266).
component("YOL096C",783).
component("YLR172C",655).
component("YLR058C",644).
...
component("YJL088W",550).
component("YKL024C",595).
component("YPR074C",870).
component("YBR117C",217).
component("YMR108W",706).
component("YCL009C",245).
component("YNL071W",732).
component("YNR008W",757).
component("YIL160C",534).
component("YNR019W",760).
component("YCR048W",260).
component("U48_",133).
component("YMR062C",702).
component("YDR232W",328).
component("YPL231W",851).
component("YER061C",382).
component("YPL001W",829).
component("YDL052C",270).
component("U8_",170).
component("YDR148C",323).
component("YPL231W",852).
component("YPL028W",831).
component("YLR299W",666).
component("YGL017W",420).
component("YCR005C",252).
component("YML126C",696).
component("YNL104C",735).
component("YDL182W",295).
component("YDL131W",281).
component("YDR307W",337).
component("YLR258W",663).
component("YFR015C",408).
component("YNL029C",727).
component("YIL085C",522).
component("YNL192W",741).
component("YBR038W",208).
component("YBR023C",204).
component("YMR306W",724).
component("YLR342W",672).
component("YGR032W",444).
component("YPR183W",878).
component("YBR248C",234).
component("YLR209C",658).
component("U104_",24).
component("U103_",23).
component("YDR354W",342) :- not remove_orf("YDR354W",342).
component("YFR047C",412).
component("YJR133W",588).
component("YLR209C",659).
component("YML022W",686).
component("YDR441C",350).
component("YHR128W",501).
component("YPR176C",877).
component("YPL172C",843).
component("YNR041C",763).
component("YMR101C",704).
component("YDL090C",277).
component("YBR003W",197).
component("YBR002C",196).
component("YJL167W",563).
component("YJL167W",564).
component("YPR069C",867).
component("YDR127W",318).
component("YHR190W",509).
component("YLR146C",652).
component("YHR068W",493).
component("YLR303W",668).
component("YGR012W",442).
component("YML082W",693).
component("YJR130C",587).
component("YDR035W",306).
component("YBR249C",235).
component("YLR180W",657).
component("YDR502C",354).
component("YOR274W",814).
component("YBR256C",237).
component("YHR137W",502).
component("YGL202W",436).
component("YLR027C",638).
component("YKL106W",602).
component("YOL140W",788).
component("YLR438W",681).
component("YGR019W",443).
component("YLR089C",647).
component("U64_",146).
component("U61_",143).
component("U51_",135).
component("YJR148W",591).
component("YHR208W",512).
component("YFL030W",404).
component("YOR184W",804).
component("YNR058W",767).
component("YIL116W",527).
component("YGL253W",439).
component("YFR053C",413).
component("YMR013C",700).
component("YMR205C",716).
component("YGR240C",466).
component("YOL016C",771).
component("YFR014C",407).
component("YLR240W",661).
component("YKL203C",618).
component("YJR066W",579).
component("YCR036W",259).
component("YCL040W",248).
component("U15_",63).
component("YPL188W",845).
component("YJR049C",576).
component("YEL041W",364).
component("U96_",174).
component("YKL001C",594).
component("YDR236C",329).
component("YHL032C",479).
component("YDR531W",358).
component("U83_",165).
component("U82_",164).
component("U81_",163).
component("YMR208W",717).
component("YPL203W",846).
component("YOR061W",793).
component("YKL166C",609).
component("YJL164C",562).
component("YIL035C",516).
component("YHR205W",511).
component("YHR102W",499).
component("YGL019W",421).
component("YHR025W",486).
component("YOR347C",820).
component("YAL038W",180).
component("YNR012W",758).
component("YDR009W",303).
component("YDR127W",319).
component("YDR147W",322).
...
component("U17_",77).
component("U76_",157).
component("YER170W",397).
component("YDR226W",327).
component("YKL067W",600).
component("YOL055C",775).
component("YDR454C",351).
component("YJR057W",577).
component("YOL061W",779).
component("YKL181W",610).
component("YHL011C",477).
component("YER099C",394).
component("YBL068W",194).
component("YOR143C",800).
component("YNL256W",746).
component("YLR328W",670).
component("YBR018C",200).
component("YBR018C",201).
component("YGR007W",441).
component("YGR202C",461).
...
component("YGL130W",430).
component("YDR530C",357).
component("YCL050C",250).
component("YPR190C",880).
component("YPR187W",879).
component("YPR110C",872).
component("YPR010C",861).
component("YOR341W",819).
component("YOR340C",818).
component("YOR224C",812).
component("YOR210W",809).
component("YOR207C",807).
component("YOR151C",801).
component("YOR116C",796).
component("YOL005C",769).
component("YNR003C",756).
component("YNL248C",745).
component("YNL151C",739).
component("YNL113W",736).
component("YKL144C",605).
component("YJR063W",578).
component("YJL148W",560).
component("YJL140W",559).
component("YIL021W",515).
component("YHR143W-A",503).
component("YGL070C",428).
component("YFL036W",405).
component("YDR404C",346).
component("YDR156W",324).
component("YDR045C",308).
component("YDL150W",289).
component("YDL140C",283).
component("YBR154C",224).
component("YPR175W",876).
component("YPL167C",841).
component("YOR330C",816).
component("YOL115W",786).
component("YNL299W",753).
component("YNL262W",748).
component("YNL102W",734).
component("YJR043C",575).
component("YJR006W",570).
component("YJL090C",551).
component("YIL139C",530).
component("YEL055C",367).
component("YDR419W",348).
component("YDR121W",316).
component("YDL102W",279).
component("YCR014C",254).
component("YBR278W",240).
component("YBL035C",190).
component("YKL035W",598).
component("YHL012W",478).
component("YHR123W",500).
component("YPR113W",873).
component("YBR243C",232).
component("YDL142C",288).
component("YPL148C",839).
component("YER026C",375).
component("YGR286C",474).
component("YJL068C",547).
component("YHR189W",508).
component("YDR058C",311).
component("YDL086W",276).
component("YOL011W",770).
component("YMR008C",698).
component("YMR006C",697).
component("U105_",25).
component("YBL015W",188).
component("YJL068C",548).
component("YOR040W",792).
component("U77_",158).
component("YDR481C",352).
component("YLR377C",676).
component("YFR025C",409).
component("YPL179W",844).
component("YNR032W",761).
component("YML057W",691).
component("YML016C",685).
component("YLR433C",680).
component("YGR123C",454).
component("YER133W",395).
component("YER089C",391).
component("YDR436W",349).
component("YDR075W",313).
...
component("YPR073C",868).
component("YHR215W",513).
...
component("U9_",177).
component("YPL228W",849).
component("YMR180C",714).
component("YDL236W",300).
component("YJL155C",561).
component("YPR073C",869).
component("YOR208W",808).
component("YNL053W",731).
component("YMR036C",701).
component("YIR026C",540).
component("YIL113W",526).
...
component("U25_",112).
component("U24_",111).
component("YHR044C",489).
component("YHR043C",488).
component("YOL064C",780).
component("YOR360C",822).
component("YKR031C",625).
component("YPL206C",847).
component("YGL027C",423).
component("YLR286C",665).
component("YJR153W",592).
component("YJL221C",569).
component("YJL216C",567).
component("YIL172C",538).
component("YGR292W",476).
component("YGR287C",475).
component("YBR299W",244).
component("YBR184W",227).
component("YIL162W",535).
component("YIR019C",539).
component("YIL099W",524).
component("YDL037C",267).
component("YOR190W",805).
component("YLR300W",667).
component("YGR282C",473).
component("YDR261C",332).
...
component("YHR201C",510).
component("YBR111C",215).
component("YBR252W",236).
component("YER005W",372).
component("YIL048W",518).
component("YER166W",396).
component("YDR093W",314).
component("YAL026C",179).
component("YBL099W",195).
component("U60_",142).
component("YLR231C",660).
component("U88_",168).
component("YDR538W",360).
component("YLR134W",649).
component("YLR044C",642).
component("YGR087C",450).
component("YDR380W",343).
component("YDL080C",273).
component("U98_",175).
component("YMR250W",719).
component("YKL184W",614).
component("YOR128C",797).
component("YEL021W",362).
component("YNR043W",764).
component("U93_",172).
component("U54_",138).
component("YKL211C",619) :- not remove_orf("YKL211C",619).
component("YKR097W",632).
component("YOL052C",774).
component("YNL169C",740).
component("YNL256W",747).
component("YDR294C",334).
component("YEL046C",365).
component("YNR033W",762).
component("YKL211C",620) :- not remove_orf("YKL211C",620).
component("YER090W",620) :- not remove_orf("YER090W",620).
component("YER090W",392) :- not remove_orf("YER090W",392).
component("YDR127W",320).
component("YPL281C",859).
component("YOR393W",828).
component("YMR323W",725).
component("YHR174W",505).
component("YGR254W",468).
component("YOR202W",806).
component("YPL262W",854).
component("YGL026C",422) :- not remove_orf("YGL026C",422).
component("YGR155W",455).
component("YLR304C",669).
component("YJL200C",565).
component("YNL316C",754).
component("YKL182W",612).
component("YPL212C",848).
component("YNL292W",752).
component("YGL063W",427).
component("YFL001W",400).
component("YPR002W",860).
component("YJR016C",573).
component("YCR053W",261).
component("YDR127W",321).
component("YGL148W",431).
component("YIL168W",537).
component("YIL167W",536).
component("YCL064C",251).
component("YER086W",389).
component("YLR359W",675).
component("YAL012W",178).
component("YML004C",683).
component("YFR055W",414).
component("YJL005W",543).
component("YJL121C",553).
component("YBR019C",202).
component("YDR050C",310).
component("YDR007W",302) :- not remove_orf("YDR007W",302).
component("YOR095C",795).
component("YER003C",371).
component("YBR196C",228).
component("YGL001C",416).
component("YPL117C",837).
component("U14_",55).
component("YOL056W",776).
component("YKL152C",608).
component("YDL021W",263).
component("YMR105C",705).
component("YKL127W",603).
component("YEL058W",368).
component("YPR060C",865).
component("YHR072W",494).
component("YPL097W",835).
component("YGR185C",459).
component("YGR264C",471).
component("YGR171C",457).
component("YHR011W",483).
component("YDR023W",305).
component("YPL104W",836).
component("YLL018C",633).
component("YPR081C",871).
component("YBR121C",218).
component("YHR020W",485).
component("YER087W",390).
component("YNL247W",744).
component("YOR168W",802).
component("YOL097C",784).
component("YDR268W",333).
component("YPR047W",864).
component("YLR060W",645).
component("YFL022C",403).
component("YPR033C",862).
component("YCR024C",255).
component("YHR019C",484).
component("YKL194C",617).
component("YIL078W",521).
component("YPL160W",840).
component("YLR382C",677).
component("YNL073W",733).
component("YOR335C",817).
component("YGR094W",452).
component("YLR153C",653).
component("YAL054C",181).
component("YOR142W",799).
component("YGR244C",467).
component("YPR035W",863).
component("YIL145C",531).
component("U89_",169).
component("YJL101C",552).
component("YOL049W",773).
component("YAR015W",183).
component("YER183C",399).
component("U90_",171).
component("YNR057C",766).
...
component("YNL220W",742).
component("YOL058W",777).
component("YDL141W",287).
component("YHR074W",495).
component("YMR217W",718).
component("YGR061C",448).
component("YJR109C",586).
component("YJL130C",557).
component("YGL062W",426).
component("YBR218C",230).
component("YPL231W",853).
component("YNR016C",759).
component("YKL182W",613).
component("YGR037C",445).
component("YPR138C",874).
component("YPL265W",855).
component("YPL134C",838).
component("YPL057C",833).
component("YPL036W",832).
component("YOR348C",821).
component("YOR222W",811).
component("YOR171C",803).
component("YOR130C",798).
component("YOR011W",791).
component("YOL156W",790).
component("YOL103W",785).
component("YOL020W",772) :- not remove_orf("YOL020W",772).
component("YNR072W",768).
component("YNR056C",765).
component("YNL318C",755).
component("YNL270C",749).
component("YNL142W",738).
component("YMR272C",721).
component("YMR202W",715).
component("YMR011W",699).
component("YLR348C",673).
component("YLR260W",664).
component("YLR138W",650).
component("YLR100C",648).
component("YLR081W",646).
component("YLL061W",637).
component("YLL043W",635).
component("YKR093W",631).
component("YKR053C",627).
component("YKR039W",626) :- not remove_orf("YKR039W",626).
component("YKL217W",622).
component("YJR158W",593).
component("YJR095W",583).
component("YJR077C",581).
component("YJL219W",568).
component("YJL214W",566).
component("YJL134W",558).
component("YJL129C",555).
component("YIL134W",529).
component("YHR096C",498).
component("YHR094C",497).
component("YHR092C",496).
component("YHL036W",480).
component("YGR121C",453).
component("YGR065C",449).
component("YGR055W",446).
component("YGL186C",433).
component("YGL077C",429).
component("YGL008C",417).
component("YFL055W",406).
component("YFL011W",401).
component("YER060W-A",380).
component("YER060W",379).
component("YER056C",378).
component("YER053C",377).
component("YEL069C",370).
component("YEL063C",369).
component("YEL017C-A",361).
component("YDR536W",359).
component("YDR508C",356).
component("YDR503C",355).
component("YDR497C",353).
component("YDR345C",340).
component("YDR343C",339).
component("YDR342C",338).
component("YDR297W",335).
component("YDR046C",309) :- not remove_orf("YDR046C",309).
...
catalyst(2131,23).
catalyst(2132,23).
catalyst(3620,342) :- not remove_reaction(3620,342).
catalyst(2110,412).
catalyst(2190,412).
catalyst(5550,588).
catalyst(5791,659).
...
catalyst(2300,172).
catalyst(3460,138).
catalyst(3600,619) :- not remove_reaction(3600,619).
catalyst(8000,632).
catalyst(3941,774).
catalyst(3942,774).
catalyst(6890,740).
...
catalyst(4560,365).
catalyst(2550,762).
catalyst(1890,620) :- not remove_reaction(1890,620).
catalyst(3630,620) :- not remove_reaction(3630,620).
...
catalyst(8061,854).
catalyst(8062,854).
catalyst(3590,422) :- not remove_reaction(3590,422).
catalyst(10910,422) :- not remove_reaction(10910,422).
catalyst(4570,455).
catalyst(8181,669).
catalyst(8182,669).
catalyst(8181,565).
...
catalyst(1210,790).
catalyst(1160,785).
catalyst(801,772) :- not remove_reaction(801,772).
catalyst(802,772) :- not remove_reaction(802,772).
catalyst(811,772) :- not remove_reaction(811,772).
catalyst(812,772) :- not remove_reaction(812,772).
catalyst(831,772) :- not remove_reaction(831,772).
catalyst(832,772) :- not remove_reaction(832,772).
catalyst(901,772) :- not remove_reaction(901,772).
catalyst(902,772) :- not remove_reaction(902,772).
catalyst(1180,768).
catalyst(1210,768).
catalyst(700,765).
catalyst(1200,755).
...
catalyst(640,631).
catalyst(6560,627).
catalyst(771,626) :- not remove_reaction(771,626).
catalyst(772,626) :- not remove_reaction(772,626).
catalyst(781,626) :- not remove_reaction(781,626).
catalyst(782,626) :- not remove_reaction(782,626).
catalyst(791,626) :- not remove_reaction(791,626).
catalyst(792,626) :- not remove_reaction(792,626).
catalyst(801,626) :- not remove_reaction(801,626).
catalyst(802,626) :- not remove_reaction(802,626).
catalyst(811,626) :- not remove_reaction(811,626).
catalyst(812,626) :- not remove_reaction(812,626).
catalyst(831,626) :- not remove_reaction(831,626).
catalyst(832,626) :- not remove_reaction(832,626).
catalyst(841,626) :- not remove_reaction(841,626).
catalyst(842,626) :- not remove_reaction(842,626).
catalyst(851,626) :- not remove_reaction(851,626).
catalyst(852,626) :- not remove_reaction(852,626).
catalyst(881,626) :- not remove_reaction(881,626).
catalyst(882,626) :- not remove_reaction(882,626).
catalyst(901,626) :- not remove_reaction(901,626).
catalyst(902,626) :- not remove_reaction(902,626).
catalyst(911,626) :- not remove_reaction(911,626).
catalyst(912,626) :- not remove_reaction(912,626).
catalyst(921,626) :- not remove_reaction(921,626).
catalyst(922,626) :- not remove_reaction(922,626).
catalyst(931,626) :- not remove_reaction(931,626).
catalyst(932,626) :- not remove_reaction(932,626).
catalyst(1191,626) :- not remove_reaction(1191,626).
catalyst(1192,626) :- not remove_reaction(1192,626).
catalyst(390,622).
catalyst(1180,593).
catalyst(1210,593).
catalyst(1250,583).
...
catalyst(1210,338).
catalyst(6650,335).
catalyst(791,309) :- not remove_reaction(791,309).
catalyst(792,309) :- not remove_reaction(792,309).
...
modifiable_enzyme(422).
modifiable_enzyme(302).
modifiable_enzyme(772).
