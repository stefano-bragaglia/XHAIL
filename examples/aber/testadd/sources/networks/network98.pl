...
component("YLR056W",490).
component("YGL012W",310).
component("YKR009C",472).
component("YOL086C",595).
component("YMR303C",548).
component("YGL256W",330).
component("YDL168W",213).
component("YBR145W",162).
component("YPL231W",650).
component("YBR265W",175).
component("U46_",95).
...
component("U45_",94).
component("YML056C",529).
component("YLR432W",523).
component("YHR216W",390).
component("YAR075W",138).
component("YAR073W",137).
component("YDR127W",232).
component("YOL126C",601).
component("YKL085W",458).
component("YDL078C",201).
component("YNL037C",553).
component("YNL009W",551).
component("YLR174W",502).
component("YHR183W",384).
component("YGR256W",351).
component("YOL059W",593).
component("YDL022W",196).
component("YCL018W",183).
component("YLR355C",518).
component("YDL174C",217).
component("YML086C",531).
component("YGR088W",338).
component("YDR256C",244).
component("YKL026C",456).
component("YIR037W",411).
component("YBR244W",172).
component("YJR078W",445).
component("U58_",102).
component("YJR025C",438).
component("U107_",24).
component("YHR007C",361).
component("YJR104C",447).
component("YHR008C",362).
component("YOR384W",633).
component("YOR381W",632).
component("YOL152W",603).
component("YLL051C",483).
component("YJL026W",413).
component("YIL066C",394).
component("YGR180C",342).
component("YER070W",286).
component("U37_",88).
component("U36_",87).
component("YDL168W",214).
component("YJR009C",436).
component("YJL052W",415).
component("YGR192C",344).
component("YBR006W",147).
component("YPL276W",658).
component("YPL275W",657).
component("YOR388C",634).
component("YOR374W",630).
component("YER073W",287).
component("YGL154C",322).
component("U55_",101).
component("YER069W",284).
component("YOR323C",623).
component("YER178W",293).
component("YBR221C",170).
component("YIL125W",400).
component("U52_",99).
component("YBR166C",166).
component("YGL012W",311).
component("YKL216W",471).
component("YDR044W",226).
component("YKR009C",473).
component("YIL160C",404).
component("YGL205W",327).
component("YMR118C",539).
component("YLR164W",500).
component("YLL041C",482).
component("YKL148C",462).
component("YKL141W",460).
component("YJL045W",414).
component("YDR178W",239).
component("YEL047C",272).
component("YDL171C",215).
component("YDL171C",216).
component("YOR375C",631).
component("YDL215C",219).
component("YAL062W",135).
component("U99_",130).
component("U100_",20).
component("YBR035C",153).
component("YKR080W",478).
component("YER023W",278).
component("YOR236W",621).
component("YGR204W",345).
component("YIR034C",410).
component("YLR142W",497).
component("U65_",108).
component("U63_",106).
component("U62_",105).
component("YHR068W",371).
component("YKL150W",463).
component("YIL043C",393).
component("YHR042W",366).
component("YPL171C",645).
component("YHR179W",383).
component("YMR145C",542).
component("YML120C",532).
component("YKL192C",468).
component("YDL085W",203).
component("YGR234W",347).
component("YFR030W",304).
component("YPL017C",636).
component("YFL018C",297).
component("YDR353W",252).
component("YPR167C",670).
component("YJR137C",450).
component("YNL052W",555).
component("YMR256C",547).
component("YLR395C",522).
component("YLR038C",488).
component("YIL111W",397).
component("YHR051W",370).
component("YGL191W",325).
component("YGL187C",324).
component("YDL067C",200).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",656).
component("YKR069W",477).
component("YOL096C",596).
component("U47_",96).
component("YJR073C",443).
component("YDR120C",230).
component("YML008C",525).
component("YDL033C",198).
component("YOL096C",597).
component("YLR172C",501).
component("YLR058C",491).
component("YDR019C",224).
component("YBR176W",167).
component("YDR408C",257).
component("YMR120C",540).
component("YLR028C",486).
component("YBL013W",139).
component("YJL130C",423).
component("YKL024C",455).
component("YPR074C",666).
component("YBR117C",161).
component("YCL009C",182).
component("YNL071W",557).
component("YNR008W",578).
component("YIL160C",405).
component("YNR019W",581).
component("YCR048W",193).
component("U48_",97).
component("YDR232W",241).
component("YPL231W",651).
component("YDL052C",199).
component("U8_",124).
component("YPL231W",652).
component("YPL028W",637).
component("YLR299W",511).
component("YGL017W",312).
component("YML126C",533).
component("YNL104C",560).
component("YDL182W",218).
component("YDL131W",207).
component("YLR258W",508).
component("YFR015C",302).
component("YNL029C",552).
component("YIL085C",395).
component("YMR306W",549).
component("YLR342W",517).
component("YGR032W",333).
component("YLR209C",504).
component("U104_",21).
component("YDR354W",253) :- not remove_orf("YDR354W",253).
component("YFR047C",305).
component("YJR133W",449).
component("YLR209C",505).
component("YML022W",526).
component("YDR441C",259).
component("YJL167W",428).
component("YJL167W",429).
component("YDR127W",233).
component("YLR146C",498).
component("YHR068W",372).
component("YLR303W",513).
component("YGR012W",331).
component("YML082W",530).
component("YJR130C",448).
component("YDR035W",225).
component("YBR249C",173).
component("YLR180W",503).
component("YDR502C",262).
component("YOR274W",622).
component("YHR137W",379).
component("YGL202W",326).
component("YLR027C",485).
component("YKL106W",459).
component("YOL140W",602).
component("YLR438W",524).
component("YGR019W",332).
component("YLR089C",493).
component("U64_",107).
component("U61_",104).
component("YJR148W",451).
component("YHR208W",388).
component("YFL030W",298).
component("YOR184W",615).
component("YNR058W",584).
component("YIL116W",399).
component("YGL253W",329).
component("YFR053C",306).
component("YMR013C",537).
component("YMR205C",543).
component("YGR240C",348).
component("YOL016C",588).
component("YFR014C",301).
component("YCR036W",192).
component("YCL040W",185).
component("U15_",45).
component("YPL188W",646).
component("YJR049C",440).
component("YEL041W",270).
component("U96_",128).
component("YKL001C",454).
component("YDR236C",242).
component("YHL032C",359).
component("YDR531W",266).
component("U83_",123).
component("U82_",122).
component("U81_",121).
component("YMR208W",544).
component("YPL203W",647).
component("YOR061W",606).
component("YKL166C",465).
component("YJL164C",427).
component("YIL035C",392).
component("YHR205W",387).
component("YHR102W",378).
component("YGL019W",313).
component("YHR025W",365).
component("YOR347C",628).
component("YAL038W",133).
component("YNR012W",579).
component("YDR127W",234).
component("YDR147W",237).
component("YDR300C",248).
component("YCR012W",187).
component("YER069W",285).
component("U18_",62).
component("U76_",117).
component("YER170W",292).
component("YDR226W",240).
component("YKL067W",457).
component("YOL055C",591).
component("YDR454C",260).
component("YJR057W",441).
component("YOL061W",594).
component("YKL181W",466).
component("YHL011C",358).
component("YER099C",291).
component("YBL068W",145).
component("YOR143C",611).
component("YNL256W",569).
component("YLR328W",515).
component("YBR018C",149).
component("YLR328W",516).
component("U94_",127).
component("YBR029C",152).
component("YGL130W",320).
component("YDR530C",265).
component("YPR190C",673).
component("YPR187W",672).
component("YPR110C",667).
component("YPR010C",661).
component("YOR341W",627).
component("YOR340C",626).
component("YOR224C",620).
component("YOR210W",619).
component("YOR207C",617).
component("YOR151C",612).
component("YOR116C",608).
component("YOL005C",586).
component("YNR003C",577).
component("YNL248C",568).
component("YNL151C",564).
component("YNL113W",561).
component("YKL144C",461).
component("YJR063W",442).
component("YJL148W",426).
component("YJL140W",425).
component("YIL021W",391).
component("YHR143W-A",380).
component("YGL070C",318).
component("YFL036W",299).
component("YDR404C",256).
component("YDR156W",238).
component("YDR045C",227).
component("YDL150W",212).
component("YDL140C",208).
component("YBR154C",165).
component("YPR175W",671).
component("YPL167C",644).
component("YOR330C",624).
component("YOL115W",600).
component("YNL299W",575).
component("YNL262W",571).
component("YNL102W",559).
component("YJR043C",439).
component("YJR006W",435).
component("YJL090C",418).
component("YIL139C",402).
component("YEL055C",273).
component("YDR419W",258).
component("YDR121W",231).
component("YDL102W",206).
component("YCR014C",188).
component("YBR278W",177).
component("YBL035C",142).
component("YPR113W",668).
component("YBR243C",171).
component("YPL148C",642).
component("YGR286C",355).
component("YHR189W",385).
component("YDR058C",229).
component("YDL086W",204).
component("YOL011W",587).
component("YMR008C",535).
component("YMR006C",534).
component("U105_",22).
component("YBL015W",140).
component("YJL068C",416).
component("U77_",118).
component("YLR377C",520).
component("YPR073C",664).
component("YHR215W",389).
component("YDL024C",197).
component("YBR093C",159).
component("YBR092C",158).
component("YHR046C",369).
component("U9_",131).
component("YDL236W",221).
component("YPR073C",665).
component("YOR208W",618).
component("YNL053W",556).
component("YMR036C",538).
component("YIR026C",409).
component("YIL113W",398).
component("YFR028C",303).
component("YER075C",288).
component("YDL230W",220).
component("YBR276C",176).
component("U34_",86).
component("U33_",85).
component("U32_",84).
component("U31_",83).
...
component("U25_",79).
component("U24_",78).
component("YHR044C",368).
component("YHR043C",367).
component("YOR360C",629).
component("YKR031C",474).
component("YPL206C",648).
component("YGL027C",315).
component("YLR286C",510).
component("YJR153W",452).
component("YJL221C",434).
component("YJL216C",432).
component("YIL172C",408).
component("YGR292W",357).
component("YGR287C",356).
component("YBR299W",181).
component("YOR190W",616).
component("YLR300W",512).
component("YGR282C",354).
component("YDR261C",245).
component("YDR400W",255).
component("YML035C",527).
component("YJL070C",417).
component("YBR284W",178).
component("U106_",23).
component("YER043C",279).
component("YNL045W",554).
component("YDR242W",243).
component("U53_",100).
component("YPR062W",663).
component("YMR120C",541).
component("YLR028C",487).
component("YHR144C",381).
component("YGR267C",353).
component("YBL033C",141).
component("YNL141W",562).
component("YLR245C",507).
component("YML035C",528).
component("YBR084W",156).
component("YJL126W",421).
component("U44_",93).
component("YDL100C",205).
component("U40_",91).
component("U39_",89).
component("YBR011C",148).
component("YHR201C",386).
component("YBR111C",160).
component("YBR252W",174).
component("YER005W",277).
component("YBL099W",146).
component("YLR231C",506).
component("YLR134W",495).
component("YLR044C",489).
component("YGR087C",337).
component("YDR380W",254).
component("YDL080C",202).
component("U98_",129).
component("YMR250W",546).
component("YOR128C",609).
component("YEL021W",269).
component("U93_",126).
component("YKL211C",469) :- not remove_orf("YKL211C",469).
component("YKR097W",480).
component("YNL169C",565).
component("YNL256W",570).
component("YEL046C",271).
component("YNR033W",582).
component("YKL211C",470) :- not remove_orf("YKL211C",470).
...
component("YOR393W",635).
component("YMR323W",550).
component("YHR174W",382).
component("YGR254W",350).
component("YPL262W",654).
component("YGL026C",314) :- not remove_orf("YGL026C",314).
component("YGR155W",340).
component("YLR304C",514).
component("YJL200C",430).
component("YNL316C",576).
component("YPL212C",649).
component("YNL292W",574).
component("YGL063W",317).
component("YFL001W",295).
component("YPR002W",660).
component("YJR016C",437).
component("YCR053W",194).
component("YDR127W",236).
component("YGL148W",321).
component("YIL168W",407).
component("YIL167W",406).
component("YCL064C",186).
component("YLR359W",519).
component("YAL012W",132).
component("YJL005W",412).
component("YJL121C",420).
component("YBR019C",150).
component("YDR007W",223) :- not remove_orf("YDR007W",223).
component("YOR095C",607).
component("YBR196C",168).
component("YGL001C",308).
component("YPL117C",641).
component("U14_",39).
component("YOL056W",592).
component("YKL152C",464).
component("YDL021W",195).
component("YEL058W",274).
component("YPR060C",662).
component("YHR072W",373).
component("YPL097W",639).
component("YGR185C",343).
component("YGR264C",352).
component("YGR171C",341).
component("YPL104W",640).
component("YLL018C",481).
component("YHR020W",364).
component("YER087W",289).
component("YNL247W",567).
component("YOR168W",613).
component("YOL097C",598).
component("YDR268W",246).
component("YCR024C",189).
component("YHR019C",363).
component("YPL160W",643).
component("YLR382C",521).
component("YNL073W",558).
component("YOR335C",625).
component("YLR153C",499).
component("YAL054C",134).
component("YGR244C",349).
component("YIL145C",403).
component("YJL101C",419).
component("YOL049W",590).
component("YAR015W",136).
component("YER183C",294).
component("U90_",125).
component("YNR057C",583).
component("YDL141W",209).
component("YGL234W",328).
component("YDL141W",210).
component("YJR103W",446).
component("YBL039C",143).
component("YGR204W",346).
component("YBR084W",157).
component("YNL220W",566).
component("YDL141W",211).
component("YHR074W",374).
component("YMR217W",545).
component("YGL062W",316).
component("YBR218C",169).
component("YPL231W",653).
component("YNR016C",580).
component("YKL182W",467).
component("YGR037C",334).
component("YPR138C",669).
component("YPL265W",655).
component("YPL036W",638).
component("YOR171C",614).
component("YOR130C",610).
component("YOR011W",605).
component("YOL156W",604).
component("YOL103W",599).
component("YOL020W",589) :- not remove_orf("YOL020W",589).
component("YNR072W",585).
component("YNL270C",572).
component("YNL142W",563).
component("YMR011W",536).
component("YLR260W",509).
component("YLR138W",496).
component("YLR100C",494).
component("YLR081W",492).
component("YLL061W",484).
component("YKR093W",479).
component("YKR053C",476).
component("YKR039W",475) :- not remove_orf("YKR039W",475).
component("YJR158W",453).
component("YJR077C",444).
component("YJL219W",433).
component("YJL214W",431).
component("YJL134W",424).
component("YJL129C",422).
component("YIL134W",401).
component("YHR096C",377).
component("YHR094C",376).
component("YHR092C",375).
component("YHL036W",360).
component("YGR121C",339).
component("YGR065C",336).
component("YGR055W",335).
component("YGL186C",323).
component("YGL077C",319).
component("YGL008C",309).
component("YFL055W",300).
component("YFL011W",296).
component("YER060W-A",283).
component("YER060W",282).
component("YER056C",281).
component("YER053C",280).
component("YEL069C",276).
component("YEL063C",275).
component("YEL017C-A",268).
component("YDR536W",267).
component("YDR508C",264).
component("YDR503C",263).
component("YDR497C",261).
component("YDR345C",251).
component("YDR343C",250).
component("YDR342C",249).
component("YDR297W",247).
component("YDR046C",228) :- not remove_orf("YDR046C",228).
component("YDL245C",222).
component("YCR032W",191).
component("YCR024C-A",190).
component("YCL025C",184).
component("YBR298C",180).
component("YBR291C",179).
...
catalyst(5880,269).
catalyst(2300,126).
catalyst(3600,469) :- not remove_reaction(3600,469).
catalyst(8000,480).
catalyst(6890,565).
catalyst(2570,570).
catalyst(4560,271).
...
catalyst(8051,654).
catalyst(8052,654).
catalyst(3590,314) :- not remove_reaction(3590,314).
catalyst(10910,314) :- not remove_reaction(10910,314).
catalyst(4570,340).
catalyst(8181,514).
catalyst(8182,514).
catalyst(8181,430).
...
catalyst(7751,150).
catalyst(7752,150).
catalyst(3610,223) :- not remove_reaction(3610,223).
catalyst(7921,607).
catalyst(7922,607).
catalyst(8341,168).
catalyst(8342,168).
...
catalyst(1210,604).
catalyst(1160,599).
catalyst(801,589) :- not remove_reaction(801,589).
catalyst(802,589) :- not remove_reaction(802,589).
catalyst(811,589) :- not remove_reaction(811,589).
catalyst(812,589) :- not remove_reaction(812,589).
catalyst(831,589) :- not remove_reaction(831,589).
catalyst(832,589) :- not remove_reaction(832,589).
catalyst(901,589) :- not remove_reaction(901,589).
catalyst(902,589) :- not remove_reaction(902,589).
catalyst(1180,585).
catalyst(1210,585).
catalyst(931,572).
catalyst(932,572).
...
catalyst(851,475) :- not remove_reaction(851,475).
catalyst(852,475) :- not remove_reaction(852,475).
...
catalyst(921,475) :- not remove_reaction(921,475).
catalyst(922,475) :- not remove_reaction(922,475).
catalyst(931,475) :- not remove_reaction(931,475).
catalyst(932,475) :- not remove_reaction(932,475).
