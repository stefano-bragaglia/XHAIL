...
component("YLR056W",619).
component("YGR060W",429).
component("YGL012W",400).
component("YKR009C",600).
component("YOL086C",748).
component("YMR303C",693).
component("YMR083W",678).
component("YGL256W",422).
component("YDL168W",274).
component("YBR145W",207).
component("YPL231W",812).
component("YBR265W",225).
component("U46_",122).
component("YBR149W",208).
component("YBR149W",209).
component("YGL001C",397).
component("YIL094C",504).
component("U45_",121).
component("YML056C",665).
component("YLR432W",655).
component("YHR216W",495).
component("YAR075W",177).
component("YAR073W",176).
component("YDR127W",301).
component("YJR139C",569).
component("YML075C",667).
component("YLR450W",658).
component("YOL126C",754).
component("YKL085W",580).
component("YDL078C",257).
component("YKL029C",576).
component("YNL037C",698).
component("YNL009W",696).
component("YLR174W",632).
component("YHR183W",488).
component("YGR256W",451).
component("YNL241C",713).
...
component("YML086C",669).
component("YIL155C",513).
component("YEL024W",347).
component("YKR066C",605).
component("YGR088W",433).
component("YDR256C",315).
component("YKL026C",575).
component("YIR037W",523).
component("YBR244W",220).
component("YJR078W",562).
component("U58_",131).
component("YJR025C",554).
component("U107_",24).
...
component("YOR384W",791).
component("YOR381W",790).
component("YOL152W",756).
component("YLL051C",612).
component("YJL026W",525).
component("YIL066C",500).
component("YGR180C",440).
...
component("YJR009C",551).
component("YJL052W",527).
component("YGR192C",442).
component("YBR006W",187).
component("YPL276W",820).
component("YPL275W",819).
component("YOR388C",792).
component("YPL061W",797).
component("YOR374W",788).
component("YER073W",369).
component("YGL154C",414).
component("YBR115C",203).
component("U55_",130).
component("YER069W",366).
component("YOR323C",780).
component("YER178W",381).
component("YBR221C",218).
component("YIL125W",509).
component("U52_",127).
component("YBR166C",212).
component("YNL280C",721).
component("YGL012W",401).
component("YKL182W",590).
component("YKL216W",599).
component("YDR044W",291).
component("YKR009C",601).
component("YIL160C",514).
component("YGL205W",419).
component("YMR118C",681).
component("YLR164W",630).
component("YLL041C",611).
component("YKL148C",585).
component("YKL141W",583).
component("YJL045W",526).
component("YDR178W",310).
component("YEL047C",350).
component("YDL171C",276).
component("YDL171C",277).
...
component("YKR080W",607).
component("YER023W",357).
component("YOR236W",778).
component("YGR204W",444).
component("YIR034C",522).
component("YLR142W",627).
component("U65_",138).
component("U63_",136).
component("U62_",135).
component("YHR068W",473).
component("YKL150W",586).
component("YIL043C",498).
component("YHR042W",468).
component("YOR221C",775).
component("YMR145C",684).
component("YKL192C",593).
component("YKL055C",578).
component("YER061C",364).
component("YDL085W",259).
component("YPL171C",805).
component("YHR179W",487).
component("YMR145C",685).
component("YML120C",670).
component("YKL192C",594).
component("YDL085W",260).
component("YGR234W",446).
component("YFR030W",393).
component("YPL017C",794).
component("YFL018C",385).
component("YDR353W",325).
component("YPR167C",835).
component("YJR137C",568).
component("YNL052W",700).
component("YMR256C",691).
component("YLR395C",654).
component("YLR038C",617).
component("YIL111W",506).
component("YHR051W",472).
component("YGL191W",417).
component("YGL187C",416).
component("YDL067C",256).
component("Q0275",19).
component("Q0250",18).
component("YDR072C",296).
component("YPL266W",818).
component("YKR069W",606).
component("YOL096C",749).
component("U47_",123).
component("YER091C",376).
component("YJR073C",560).
component("YGR157W",438).
component("YDR120C",299).
component("YML008C",660).
component("YOR074C",761).
component("YDL033C",252).
component("YOL096C",750).
component("YLR172C",631).
component("YLR058C",620).
component("YDR019C",288).
component("YBR176W",213).
component("YDR408C",331).
component("YMR120C",682).
component("YLR028C",615).
component("YBL013W",178).
component("YJL130C",536).
component("YJL088W",530).
component("YKL024C",574).
component("YPR074C",830).
component("YBR117C",204).
component("YMR108W",680).
component("YCL009C",232).
component("YNL071W",702).
component("YNR008W",726).
component("YIL160C",515).
component("YNR019W",729).
component("YCR048W",246).
component("U48_",124).
component("YMR062C",677).
component("YDR232W",312).
...
component("YPL028W",795).
component("YLR299W",642).
component("YGL017W",402).
component("YCR005C",238).
component("YML126C",671).
component("YNL104C",705).
component("YDL182W",279).
component("YDL131W",265).
component("YDR307W",321).
component("YLR258W",639).
component("YFR015C",391).
component("YNL029C",697).
component("YIL085C",503).
component("YNL192W",711).
component("YBR038W",195).
component("YBR023C",192).
component("YMR306W",694).
component("YLR342W",648).
component("YGR032W",426).
component("YPR183W",837).
component("YBR248C",221).
component("YLR209C",634).
component("U104_",21).
component("YDR354W",326) :- not remove_orf("YDR354W",326).
component("YFR047C",394).
component("YJR133W",567).
component("YLR209C",635).
component("YML022W",662).
component("YDR441C",334).
component("YHR128W",482).
component("YJL167W",543).
component("YJL167W",544).
component("YPR069C",827).
component("YDR127W",302).
component("YHR190W",490).
component("YLR146C",628).
component("YHR068W",474).
component("YLR303W",644).
component("YGR012W",424).
component("YML082W",668).
component("YJR130C",566).
component("YDR035W",290).
component("YBR249C",222).
component("YLR180W",633).
component("YDR502C",338).
component("YOR274W",779).
component("YBR256C",224).
component("YHR137W",483).
component("YGL202W",418).
component("YLR027C",614).
component("YKL106W",581).
component("YOL140W",755).
component("YLR438W",657).
component("YGR019W",425).
component("YLR089C",623).
component("U64_",137).
component("U61_",134).
component("U51_",126).
component("YJR148W",570).
component("YHR208W",493).
component("YFL030W",387).
component("YOR184W",770).
component("YNR058W",735).
component("YIL116W",508).
component("YGL253W",421).
component("YFR053C",395).
component("YMR013C",675).
component("YMR205C",687).
component("YGR240C",447).
component("YOL016C",739).
component("YFR014C",390).
component("YLR240W",637).
component("YKL203C",596).
component("YJR066W",559).
component("YCR036W",245).
component("YCL040W",235).
component("U15_",56).
component("YPL188W",807).
component("YJR049C",556).
component("YEL041W",348).
component("U96_",165).
component("YKL001C",573).
component("YDR236C",313).
component("YHL032C",460).
component("YDR531W",342).
component("U83_",156).
component("U82_",155).
component("U81_",154).
component("YMR208W",688).
component("YPL203W",808).
component("YOR061W",760).
component("YKL166C",588).
component("YJL164C",542).
component("YIL035C",497).
component("YHR205W",492).
component("YHR102W",480).
component("YGL019W",403).
component("YHR025W",467).
component("YOR347C",785).
component("YAL038W",171).
component("YNR012W",727).
component("YDR009W",287).
component("YDR127W",303).
component("YDR147W",306).
component("YDR300C",320).
component("YCR012W",239).
component("YER069W",367).
component("U19_",88).
component("U18_",79).
component("U17_",70).
component("U76_",148).
component("YER170W",380).
component("YDR226W",311).
component("YKL067W",579).
component("YOL055C",742).
component("YDR454C",335).
component("YJR057W",557).
component("YOL061W",746).
component("YKL181W",589).
component("YHL011C",458).
component("YER099C",377).
component("YBL068W",185).
component("YOR143C",766).
component("YNL256W",716).
component("YLR328W",646).
component("YBR018C",189).
component("YGR007W",423).
component("YGR202C",443).
component("YLR328W",647).
component("U80_",153).
component("YDL103C",264).
component("U94_",164).
component("YJR010W",552).
component("YBR029C",193).
component("YCL050C",236).
component("YGL130W",412).
component("YDR530C",341).
component("YPR190C",839).
component("YPR187W",838).
component("YPR110C",832).
component("YPR010C",823).
component("YOR341W",784).
component("YOR340C",783).
component("YOR224C",777).
component("YOR210W",774).
component("YOR207C",772).
component("YOR151C",767).
component("YOR116C",763).
component("YOL005C",737).
component("YNR003C",725).
component("YNL248C",715).
component("YNL151C",709).
component("YNL113W",706).
component("YKL144C",584).
component("YJR063W",558).
component("YJL148W",540).
component("YJL140W",539).
component("YIL021W",496).
component("YHR143W-A",484).
component("YGL070C",410).
component("YFL036W",388).
component("YDR404C",330).
component("YDR156W",308).
component("YDR045C",292).
component("YDL150W",273).
component("YDL140C",267).
component("YBR154C",211).
component("YPR175W",836).
component("YPL167C",804).
component("YOR330C",781).
component("YOL115W",753).
component("YNL299W",723).
component("YNL262W",718).
component("YNL102W",704).
component("YJR043C",555).
component("YJR006W",550).
component("YJL090C",531).
component("YIL139C",511).
component("YEL055C",351).
component("YDR419W",332).
component("YDR121W",300).
component("YDL102W",263).
component("YCR014C",240).
component("YBR278W",227).
component("YBL035C",181).
component("YKL035W",577).
component("YHL012W",459).
component("YHR123W",481).
component("YPR113W",833).
component("YBR243C",219).
component("YDL142C",272).
component("YPL148C",802).
component("YER026C",358).
component("YGR286C",455).
component("YHR189W",489).
component("YDR058C",295).
component("YDL086W",261).
component("YOL011W",738).
component("YMR008C",673).
component("YMR006C",672).
component("U105_",22).
component("YBL015W",179).
component("YJL068C",528).
component("YOR040W",759).
component("U77_",149).
component("YDR481C",336).
component("YLR377C",652).
component("YPL179W",806).
component("YNR032W",730).
component("YML057W",666).
component("YML016C",661).
component("YLR433C",656).
component("YGR123C",436).
component("YER133W",378).
component("YER089C",374).
component("YDR436W",333).
component("YDR075W",297).
component("YDL188C",280).
component("YDL134C",266).
component("YDL047W",254).
component("YDL006W",248).
component("YBR125C",206).
component("YBL056W",184).
component("YPR073C",828).
component("YHR215W",494).
component("YDL024C",251).
component("YBR093C",201).
component("YBR092C",200).
component("YAR071W",175).
component("YHR046C",471).
component("U9_",168).
component("YPL228W",811).
component("YMR180C",686).
component("YDL236W",284).
component("YJL155C",541).
component("YPR073C",829).
component("YOR208W",773).
component("YNL053W",701).
component("YMR036C",676).
component("YIR026C",521).
component("YIL113W",507).
component("YFR028C",392).
...
component("U25_",103).
component("U24_",102).
component("YHR044C",470).
component("YHR043C",469).
component("YOL064C",747).
component("YOR360C",787).
component("YKR031C",602).
component("YPL206C",809).
component("YGL027C",405).
component("YLR286C",641).
component("YJR153W",571).
component("YJL221C",549).
component("YJL216C",547).
component("YIL172C",519).
component("YGR292W",457).
component("YGR287C",456).
component("YBR299W",231).
component("YBR184W",214).
component("YIL162W",516).
component("YIR019C",520).
component("YIL099W",505).
component("YDL037C",253).
component("YOR190W",771).
component("YLR300W",643).
component("YGR282C",454).
component("YDR261C",316).
component("YDR400W",328).
component("YML035C",663).
component("YJL070C",529).
component("YBR284W",228).
component("U106_",23).
component("YER043C",359).
component("YNL045W",699).
component("YGL037C",406).
component("YDR242W",314).
component("YBR208C",216).
component("U53_",128).
component("YPR062W",826).
component("YMR120C",683).
component("YLR028C",616).
component("YHR144C",485).
component("YGR267C",453).
component("YBL033C",180).
component("YBR153W",210).
component("YNL141W",707).
component("YLR245C",638).
...
component("YHR201C",491).
component("YBR111C",202).
component("YBR252W",223).
component("YER005W",356).
component("YIL048W",499).
component("YER166W",379).
component("YDR093W",298).
component("YAL026C",170).
component("YBL099W",186).
component("U60_",133).
component("YLR231C",636).
component("U88_",159).
component("YDR538W",344).
component("YLR134W",625).
component("YLR044C",618).
component("YGR087C",432).
component("YDR380W",327).
component("YDL080C",258).
component("U98_",166).
component("YMR250W",690).
component("YOR128C",764).
component("YEL021W",346).
component("YNR043W",732).
component("U93_",163).
component("U54_",129).
component("YKL211C",597) :- not remove_orf("YKL211C",597).
component("YKR097W",609).
component("YNL169C",710).
component("YNL256W",717).
component("YDR294C",318).
component("YEL046C",349).
component("YNR033W",731).
component("YKL211C",598) :- not remove_orf("YKL211C",598).
component("YER090W",598) :- not remove_orf("YER090W",598).
component("YER090W",375) :- not remove_orf("YER090W",375).
component("YDR127W",304).
component("YPL281C",821).
component("YOR393W",793).
component("YMR323W",695).
component("YHR174W",486).
component("YGR254W",449).
component("YPL262W",816).
component("YGL026C",404) :- not remove_orf("YGL026C",404).
component("YGR155W",437).
component("YLR304C",645).
component("YJL200C",545).
...
component("YJR016C",553).
component("YCR053W",247).
component("YDR127W",305).
component("YGL148W",413).
component("YIL168W",518).
component("YIL167W",517).
component("YCL064C",237).
component("YER086W",372).
component("YLR359W",651).
component("YAL012W",169).
component("YML004C",659).
component("YFR055W",396).
component("YJL005W",524).
component("YJL121C",533).
component("YBR019C",190).
component("YDR050C",294).
component("YDR007W",286) :- not remove_orf("YDR007W",286).
component("YOR095C",762).
component("YER003C",355).
component("YBR196C",215).
component("YGL001C",398).
component("YPL117C",800).
component("U14_",48).
component("YOL056W",743).
component("YKL152C",587).
component("YDL021W",249).
component("YMR105C",679).
component("YKL127W",582).
component("YEL058W",352).
component("YPR060C",825).
component("YHR072W",475).
component("YPL097W",798).
component("YGR185C",441).
...
component("YPR081C",831).
component("YBR121C",205).
component("YHR020W",466).
component("YER087W",373).
component("YNL247W",714).
component("YOR168W",768).
component("YOL097C",751).
component("YDR268W",317).
component("YPR047W",824).
component("YLR060W",621).
component("YFL022C",386).
component("YCR024C",241).
component("YHR019C",465).
component("YKL194C",595).
component("YIL078W",502).
component("YPL160W",803).
component("YLR382C",653).
component("YNL073W",703).
component("YOR335C",782).
component("YGR094W",434).
component("YLR153C",629).
component("YAL054C",172).
component("YGR244C",448).
component("YIL145C",512).
component("U89_",160).
component("YJL101C",532).
component("YOL049W",741).
component("YAR015W",174).
component("YER183C",382).
component("U90_",162).
component("YNR057C",734).
component("YDL141W",268).
component("YDL141W",269).
component("YGL234W",420).
component("YDL141W",270).
component("YJR103W",563).
component("YBL039C",182).
component("YGR204W",445).
component("YBR084W",199).
component("YNL220W",712).
component("YOL058W",744).
component("YDL141W",271).
component("YHR074W",476).
component("YMR217W",689).
component("YGR061C",430).
component("YJR109C",565).
component("YJL130C",537).
component("YGL062W",408).
component("YBR218C",217).
component("YPL231W",815).
component("YNR016C",728).
component("YKL182W",592).
component("YGR037C",427).
component("YPR138C",834).
component("YPL265W",817).
component("YPL134C",801).
component("YPL036W",796).
component("YOR348C",786).
component("YOR222W",776).
component("YOR171C",769).
component("YOR130C",765).
component("YOR011W",758).
component("YOL156W",757).
component("YOL103W",752).
component("YOL020W",740) :- not remove_orf("YOL020W",740).
component("YNR072W",736).
component("YNR056C",733).
component("YNL270C",719).
component("YNL142W",708).
component("YMR272C",692).
component("YMR011W",674).
component("YLR348C",649).
component("YLR260W",640).
component("YLR138W",626).
component("YLR100C",624).
component("YLR081W",622).
component("YLL061W",613).
component("YKR093W",608).
component("YKR053C",604).
component("YKR039W",603) :- not remove_orf("YKR039W",603).
component("YJR158W",572).
component("YJR077C",561).
component("YJL219W",548).
component("YJL214W",546).
component("YJL134W",538).
component("YJL129C",535).
component("YIL134W",510).
component("YHR096C",479).
component("YHR094C",478).
component("YHR092C",477).
component("YHL036W",461).
component("YGR121C",435).
component("YGR065C",431).
component("YGR055W",428).
component("YGL186C",415).
component("YGL077C",411).
component("YGL008C",399).
component("YFL055W",389).
component("YFL011W",384).
component("YER060W-A",363).
component("YER060W",362).
component("YER056C",361).
component("YER053C",360).
component("YEL069C",354).
component("YEL063C",353).
component("YEL017C-A",345).
component("YDR536W",343).
component("YDR508C",340).
component("YDR503C",339).
component("YDR497C",337).
component("YDR345C",324).
component("YDR343C",323).
component("YDR342C",322).
component("YDR297W",319).
component("YDR046C",293) :- not remove_orf("YDR046C",293).
component("YDL245C",285).
component("YDL210W",281).
component("YCR032W",244).
component("YCR028C",243).
component("YCR024C-A",242).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,326) :- not remove_reaction(3620,326).
catalyst(2110,394).
catalyst(2190,394).
catalyst(5550,567).
catalyst(5791,635).
...
catalyst(2300,163).
catalyst(3460,129).
catalyst(3600,597) :- not remove_reaction(3600,597).
catalyst(8000,609).
catalyst(6890,710).
catalyst(2570,717).
catalyst(8781,318).
...
catalyst(4560,349).
catalyst(2550,731).
catalyst(1890,598) :- not remove_reaction(1890,598).
catalyst(3630,598) :- not remove_reaction(3630,598).
...
catalyst(8061,816).
catalyst(8062,816).
catalyst(3590,404) :- not remove_reaction(3590,404).
catalyst(10910,404) :- not remove_reaction(10910,404).
catalyst(4570,437).
catalyst(8181,645).
catalyst(8182,645).
catalyst(8181,545).
...
catalyst(8281,294).
catalyst(8282,294).
catalyst(3610,286) :- not remove_reaction(3610,286).
catalyst(7921,762).
catalyst(7922,762).
catalyst(7841,355).
catalyst(7842,355).
...
catalyst(640,608).
catalyst(6560,604).
catalyst(771,603) :- not remove_reaction(771,603).
catalyst(772,603) :- not remove_reaction(772,603).
catalyst(781,603) :- not remove_reaction(781,603).
catalyst(782,603) :- not remove_reaction(782,603).
catalyst(801,603) :- not remove_reaction(801,603).
catalyst(802,603) :- not remove_reaction(802,603).
catalyst(811,603) :- not remove_reaction(811,603).
catalyst(812,603) :- not remove_reaction(812,603).
catalyst(831,603) :- not remove_reaction(831,603).
catalyst(832,603) :- not remove_reaction(832,603).
catalyst(841,603) :- not remove_reaction(841,603).
catalyst(842,603) :- not remove_reaction(842,603).
catalyst(851,603) :- not remove_reaction(851,603).
catalyst(852,603) :- not remove_reaction(852,603).
catalyst(881,603) :- not remove_reaction(881,603).
catalyst(882,603) :- not remove_reaction(882,603).
catalyst(901,603) :- not remove_reaction(901,603).
catalyst(902,603) :- not remove_reaction(902,603).
catalyst(911,603) :- not remove_reaction(911,603).
catalyst(912,603) :- not remove_reaction(912,603).
catalyst(921,603) :- not remove_reaction(921,603).
catalyst(922,603) :- not remove_reaction(922,603).
catalyst(931,603) :- not remove_reaction(931,603).
catalyst(932,603) :- not remove_reaction(932,603).
catalyst(1191,603) :- not remove_reaction(1191,603).
catalyst(1192,603) :- not remove_reaction(1192,603).
catalyst(1180,572).
catalyst(1210,572).
catalyst(1581,561).
catalyst(1582,561).
...
catalyst(1210,322).
catalyst(6650,319).
catalyst(801,293) :- not remove_reaction(801,293).
catalyst(802,293) :- not remove_reaction(802,293).
catalyst(811,293) :- not remove_reaction(811,293).
catalyst(812,293) :- not remove_reaction(812,293).
catalyst(831,293) :- not remove_reaction(831,293).
catalyst(832,293) :- not remove_reaction(832,293).
catalyst(841,293) :- not remove_reaction(841,293).
catalyst(842,293) :- not remove_reaction(842,293).
catalyst(851,293) :- not remove_reaction(851,293).
catalyst(852,293) :- not remove_reaction(852,293).
catalyst(901,293) :- not remove_reaction(901,293).
catalyst(902,293) :- not remove_reaction(902,293).
catalyst(1180,285).
catalyst(1210,285).
catalyst(730,281).
catalyst(431,244).
...
catalyst(851,197) :- not remove_reaction(851,197).
catalyst(852,197) :- not remove_reaction(852,197).
...
catalyst(851,196) :- not remove_reaction(851,196).
catalyst(852,196) :- not remove_reaction(852,196).
