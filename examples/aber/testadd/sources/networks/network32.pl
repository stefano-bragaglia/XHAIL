...
component("YOL126C",256).
component("YKL085W",194).
component("YDL078C",80).
component("YNL037C",234).
component("YLR355C",226).
component("YDL174C",86).
component("YML086C",230).
component("YGR088W",152).
component("YDR256C",103).
component("YJR078W",188).
component("U107_",20).
component("YER070W",128).
component("U36_",39).
component("YPL276W",287).
component("YPL275W",286).
component("YOR388C",273).
component("YOR323C",267).
component("YIL125W",171).
component("U52_",45).
component("YBR166C",66).
component("YKL216W",201).
component("YKR009C",202).
component("YIL160C",173).
component("YGL205W",147).
component("YKR080W",206).
component("YER023W",124).
component("YLR142W",216).
component("U62_",47).
component("YHR068W",161).
component("YKL150W",197).
component("YIL043C",168).
component("YPL171C",280).
component("YHR179W",166).
component("YDR353W",107).
component("YPL266W",285).
component("YKR069W",205).
component("YDL033C",79).
component("YLR172C",218).
component("YLR058C",213).
component("YDR019C",89).
component("YBR176W",67).
component("YDR408C",112).
component("YMR120C",231).
component("YLR028C",209).
component("YKL024C",192).
component("YPR074C",291).
component("YBR117C",63).
component("YPL231W",282).
component("YPL231W",283).
component("YLR299W",224).
component("YDL182W",87).
component("YDL131W",83).
component("YLR258W",222).
component("YFR015C",133).
component("YNL029C",233).
component("YIL085C",169).
component("YLR209C",219).
component("U104_",18).
component("YDR354W",108) :- not remove_orf("YDR354W",108).
component("YFR047C",134).
component("YLR209C",220).
component("YML022W",228).
component("YDR441C",114).
component("YJL167W",183).
component("YDR127W",95).
component("YJR130C",190).
component("YDR035W",90).
component("YBR249C",69).
component("YOR274W",266).
component("YHR137W",162).
component("YGL202W",146).
component("YLR027C",208).
component("YKL106W",195).
component("YJR148W",191).
component("YNR058W",248).
component("YGL253W",148).
component("YFR053C",135).
component("YCR036W",78).
component("U96_",50).
component("YNR012W",246).
component("YDR127W",96).
component("YDR147W",99).
component("U76_",48).
component("YDR226W",101).
component("YKL067W",193).
component("YOL055C",251).
component("YDR454C",115).
component("YOL061W",252).
component("YKL181W",198).
component("YHL011C",159).
component("YER099C",130).
component("YBL068W",57).
component("YNL256W",240).
component("YBR018C",59).
component("YGL130W",143).
component("YPR190C",297).
component("YPR187W",296).
component("YPR110C",292).
component("YPR010C",289).
component("YOR341W",271).
component("YOR340C",270).
component("YOR224C",265).
component("YOR210W",264).
component("YOR207C",263).
component("YOR151C",260).
component("YOR116C",259).
component("YOL005C",249).
component("YNR003C",245).
component("YNL248C",239).
component("YNL151C",238).
component("YNL113W",236).
component("YKL144C",196).
component("YJR063W",186).
component("YJL148W",182).
component("YJL140W",181).
...
component("YPR175W",295).
component("YPL167C",279).
component("YOR330C",268).
component("YOL115W",255).
component("YNL299W",243).
component("YNL262W",241).
component("YNL102W",235).
component("YJR043C",185).
component("YJR006W",184).
...
component("YPR113W",293).
component("U105_",19).
component("YBL015W",54).
component("YLR377C",227).
component("U30_",38).
component("U29_",37).
component("U24_",36).
component("YOR360C",272).
component("YGL027C",140).
component("YOR190W",262).
component("YLR300W",225).
component("YGR282C",158).
component("YDR261C",104).
component("YDR400W",110).
component("YML035C",229).
...
component("YPL117C",278).
component("YPR060C",290).
component("YPL097W",276).
component("YGR185C",155).
component("YGR264C",157).
component("YGR171C",154).
component("YPL104W",277).
component("YLL018C",207).
component("YOL097C",253).
component("YDR268W",105).
component("YOR335C",269).
component("YLR153C",217).
component("YAL054C",53).
component("U90_",49).
component("YNR057C",247).
component("YJR103W",189).
component("YBL039C",56).
component("YGL062W",141).
component("YBR218C",68).
component("YPR138C",294).
component("YPL265W",284).
component("YPL036W",275).
component("YOR171C",261).
component("YOR011W",257).
component("YOL103W",254).
component("YOL020W",250) :- not remove_orf("YOL020W",250).
component("YNL270C",242).
component("YNL142W",237).
component("YLR260W",223).
component("YLR100C",214).
component("YKR053C",204).
component("YKR039W",203) :- not remove_orf("YKR039W",203).
component("YJR077C",187).
component("YJL134W",180).
...
catalyst(8812,81).
catalyst(2250,51).
catalyst(3600,199) :- not remove_reaction(3600,199).
catalyst(3630,200) :- not remove_reaction(3630,200).
...
catalyst(6330,214).
catalyst(6560,204).
catalyst(771,203) :- not remove_reaction(771,203).
catalyst(772,203) :- not remove_reaction(772,203).
catalyst(781,203) :- not remove_reaction(781,203).
catalyst(782,203) :- not remove_reaction(782,203).
...
catalyst(881,203) :- not remove_reaction(881,203).
catalyst(882,203) :- not remove_reaction(882,203).
catalyst(901,203) :- not remove_reaction(901,203).
catalyst(902,203) :- not remove_reaction(902,203).
catalyst(931,203) :- not remove_reaction(931,203).
catalyst(932,203) :- not remove_reaction(932,203).
catalyst(1191,203) :- not remove_reaction(1191,203).
catalyst(1192,203) :- not remove_reaction(1192,203).
catalyst(1581,187).
catalyst(1582,187).
catalyst(6560,180).
catalyst(361,179).
