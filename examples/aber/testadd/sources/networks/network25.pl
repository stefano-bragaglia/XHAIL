...
component("YLR056W",180).
component("YPL231W",238).
component("U46_",37).
component("YBR149W",56).
component("YGL001C",119).
component("YIL094C",145).
component("U45_",36).
component("YDR127W",83).
component("YOL126C",218).
component("YDL078C",71).
component("YNL037C",197).
component("YML086C",193).
component("YGR088W",128).
component("YDR256C",91).
component("YJR078W",161).
component("U107_",19).
component("YER070W",112).
component("U36_",33).
component("YPL276W",244).
component("YPL275W",243).
component("YOR388C",231).
component("YOR323C",226).
component("YIL125W",146).
component("U52_",39).
component("YBR166C",58).
component("YKL216W",172).
component("YKR009C",173).
component("YIL160C",148).
component("YGL205W",126).
component("YKR080W",175).
component("YER023W",108).
component("YLR142W",183).
component("U62_",41).
component("YHR068W",136).
component("YKL150W",168).
component("YIL043C",143).
component("YPL171C",237).
component("YHR179W",141).
component("YDR353W",94).
component("YPL266W",242).
component("YDL033C",70).
component("YLR058C",181).
component("YDR019C",78).
component("YBR176W",59).
component("YDR408C",98).
component("YMR120C",194).
component("YLR028C",178).
component("YPR074C",248).
component("YBR117C",55).
component("YPL231W",239).
component("YPL231W",240).
component("YLR299W",189).
component("YDL182W",76).
component("YDL131W",73).
component("YLR258W",188).
component("YFR015C",117).
component("YNL029C",196).
component("YIL085C",144).
component("YLR209C",185).
component("YDR354W",95) :- not remove_orf("YDR354W",95).
component("YFR047C",118).
component("YLR209C",186).
component("YML022W",191).
component("YDR441C",100).
component("YJL167W",156).
component("YDR127W",84).
component("YJR130C",163).
component("YDR035W",79).
component("YBR249C",61).
component("YOR274W",225).
component("YHR137W",137).
component("YLR027C",177).
component("YKL106W",166).
component("YJR148W",164).
component("YNR058W",211).
component("YCR036W",69).
component("U96_",43).
component("YNR012W",209).
component("YDR127W",85).
component("YDR226W",89).
component("YKL067W",165).
component("YDR454C",101).
component("YOL061W",214).
component("YKL181W",169).
component("YHL011C",134).
component("YER099C",114).
component("YBL068W",49).
component("YNL256W",203).
component("YBR018C",51).
component("YPR190C",254).
component("YPR187W",253).
component("YPR110C",249).
component("YPR010C",246).
component("YOR341W",230).
component("YOR340C",229).
component("YOR224C",224).
component("YOR210W",223).
component("YOR207C",222).
component("YOR151C",221).
component("YOR116C",220).
component("YOL005C",212).
component("YNR003C",208).
component("YNL248C",202).
component("YNL151C",201).
component("YNL113W",199).
component("YKL144C",167).
component("YJR063W",159).
component("YJL148W",155).
component("YJL140W",154).
component("YIL021W",142).
component("YHR143W-A",138).
component("YGL070C",123).
component("YFL036W",115).
component("YDR404C",97).
component("YDR156W",88).
component("YDR045C",80).
component("YDL150W",75).
component("YDL140C",74).
component("YBR154C",57).
component("YPR175W",252).
component("YPL167C",236).
component("YOR330C",227).
component("YOL115W",217).
component("YNL299W",206).
component("YNL262W",204).
component("YNL102W",198).
component("YJR043C",158).
component("YJR006W",157).
component("YJL090C",152).
component("YIL139C",147).
component("YEL055C",105).
component("YDR419W",99).
component("YDR121W",82).
component("YDL102W",72).
component("YCR014C",68).
component("YBR278W",63).
component("YBL035C",47).
component("YPR113W",250).
component("U105_",18).
component("YLR377C",190).
component("U30_",32).
component("U29_",31).
component("U24_",30).
component("YGL027C",121).
component("YDR400W",96).
component("YML035C",192).
component("YJL070C",151).
component("YBR284W",64).
component("YDR242W",90).
component("U53_",40).
component("YLR028C",179).
component("YHR144C",139).
component("U39_",34).
component("YBR011C",50).
component("YBR111C",54).
component("YBR252W",62).
component("YER005W",107).
component("YLR231C",187).
component("U98_",44).
...
component("YER090W",113) :- not remove_orf("YER090W",113).
component("YDR127W",86).
component("YPL281C",245).
component("YOR393W",232).
component("YMR323W",195).
component("YHR174W",140).
component("YGR254W",132).
component("YGL026C",120) :- not remove_orf("YGL026C",120).
component("YNL316C",207).
component("YDR127W",87).
component("YGL148W",124).
component("YIL168W",150).
component("YIL167W",149).
component("YCL064C",67).
component("YAL012W",45).
component("YDR007W",77) :- not remove_orf("YDR007W",77).
component("YOR095C",219).
component("YPL117C",235).
component("YPR060C",247).
component("YPL097W",233).
component("YGR185C",131).
component("YGR264C",133).
component("YGR171C",130).
component("YPL104W",234).
component("YLL018C",176).
component("YOL097C",215).
component("YDR268W",92).
component("YOR335C",228).
component("YLR153C",184).
component("YAL054C",46).
component("U90_",42).
component("YNR057C",210).
component("YJR103W",162).
component("YBL039C",48).
component("YGL062W",122).
component("YBR218C",60).
component("YPR138C",251).
component("YPL265W",241).
component("YOL103W",216).
component("YOL020W",213) :- not remove_orf("YOL020W",213).
component("YNL270C",205).
component("YNL142W",200).
component("YLR100C",182).
component("YKR039W",174) :- not remove_orf("YKR039W",174).
component("YJR077C",160).
component("YJL129C",153).
component("YHL036W",135).
component("YGR121C",129).
component("YGR055W",127).
component("YGL186C",125).
component("YFL055W",116).
component("YER060W-A",111).
component("YER060W",110).
component("YER056C",109).
component("YEL063C",106).
component("YDR536W",104).
component("YDR508C",103).
component("YDR497C",102).
component("YDR297W",93).
component("YDR046C",81) :- not remove_orf("YDR046C",81).
component("YCL025C",66).
component("YBR298C",65).
component("YBR069C",53) :- not remove_orf("YBR069C",53).
component("YBR068C",52) :- not remove_orf("YBR068C",52).
component("U4_",38).
component("U3_",35).
component("U228_",29).
component("U223_",28).
...
catalyst(5601,185).
catalyst(5602,185).
catalyst(3620,95) :- not remove_reaction(3620,95).
catalyst(2190,118).
catalyst(5791,186).
catalyst(5792,186).
catalyst(5801,186).
...
catalyst(3630,113) :- not remove_reaction(3630,113).
catalyst(3740,86).
catalyst(8231,245).
catalyst(8232,245).
catalyst(8231,232).
...
catalyst(8231,132).
catalyst(8232,132).
catalyst(3590,120) :- not remove_reaction(3590,120).
catalyst(10910,120) :- not remove_reaction(10910,120).
catalyst(3680,207).
catalyst(3750,87).
catalyst(3700,124).
catalyst(8751,150).
...
catalyst(4520,67).
catalyst(4460,45).
catalyst(3610,77) :- not remove_reaction(3610,77).
catalyst(7921,219).
catalyst(7922,219).
catalyst(6461,235).
catalyst(6462,235).
...
catalyst(781,174) :- not remove_reaction(781,174).
catalyst(782,174) :- not remove_reaction(782,174).
...
catalyst(881,174) :- not remove_reaction(881,174).
catalyst(882,174) :- not remove_reaction(882,174).
catalyst(931,174) :- not remove_reaction(931,174).
catalyst(932,174) :- not remove_reaction(932,174).
catalyst(1191,174) :- not remove_reaction(1191,174).
catalyst(1192,174) :- not remove_reaction(1192,174).
catalyst(1581,160).
catalyst(1582,160).
catalyst(361,153).
catalyst(362,153).
...
catalyst(851,81) :- not remove_reaction(851,81).
catalyst(852,81) :- not remove_reaction(852,81).
catalyst(771,66).
catalyst(772,66).
catalyst(781,66).
catalyst(782,66).
...
catalyst(1121,65).
catalyst(1122,65).
catalyst(771,53) :- not remove_reaction(771,53).
catalyst(772,53) :- not remove_reaction(772,53).
catalyst(801,53) :- not remove_reaction(801,53).
catalyst(802,53) :- not remove_reaction(802,53).
catalyst(811,53) :- not remove_reaction(811,53).
catalyst(812,53) :- not remove_reaction(812,53).
catalyst(851,53) :- not remove_reaction(851,53).
catalyst(852,53) :- not remove_reaction(852,53).
catalyst(801,52) :- not remove_reaction(801,52).
catalyst(802,52) :- not remove_reaction(802,52).
catalyst(811,52) :- not remove_reaction(811,52).
catalyst(812,52) :- not remove_reaction(812,52).
catalyst(831,52) :- not remove_reaction(831,52).
catalyst(832,52) :- not remove_reaction(832,52).
catalyst(841,52) :- not remove_reaction(841,52).
catalyst(842,52) :- not remove_reaction(842,52).
catalyst(851,52) :- not remove_reaction(851,52).
catalyst(852,52) :- not remove_reaction(852,52).
catalyst(6980,38).
catalyst(6980,35).
catalyst(41,29).
catalyst(42,29).
