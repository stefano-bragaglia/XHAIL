...
component("YIL094C",362).
component("U45_",85).
component("YML056C",484).
component("YLR432W",481).
component("YHR216W",356).
component("YAR075W",126).
component("YAR073W",125).
component("YDR127W",209).
component("YOL126C",550).
component("YKL085W",419).
component("YDL078C",183).
component("YNL037C",506).
component("YNL009W",504).
component("YLR174W",460).
component("YOL059W",543).
component("YDL022W",179).
component("YCL018W",167).
component("YLR355C",476).
component("YDL174C",196).
component("YML086C",486).
component("YGR088W",311).
component("YDR256C",220).
component("YJR078W",408).
component("YJR025C",401).
component("U107_",24).
component("YHR007C",331).
component("YJR104C",410).
component("YHR008C",332).
component("YOR384W",581).
component("YOR381W",580).
component("YOL152W",552).
component("YLL051C",443).
component("YJL026W",376).
component("YIL066C",360).
component("YGR180C",314).
component("YER070W",259).
component("U37_",79).
component("U36_",78).
component("YDL168W",194).
component("YJR009C",399).
component("YJL052W",378).
component("YGR192C",316).
component("YBR006W",134).
component("YPL276W",606).
component("YPL275W",605).
component("YOR388C",582).
component("YOR374W",578).
...
component("YIL125W",366).
component("U52_",90).
component("YBR166C",152).
component("YGL012W",284).
component("YKL216W",432).
component("YKR009C",434).
component("YIL160C",370).
component("YGL205W",300).
component("YMR118C",493).
component("YLR164W",458).
component("YLL041C",442).
component("YKL148C",423).
component("YKL141W",421).
...
component("U99_",118).
component("U100_",20).
component("YKR080W",439).
component("YER023W",251).
component("YOR236W",569).
component("YGR204W",317).
component("YLR142W",456).
component("U65_",98).
component("U63_",96).
component("U62_",95).
component("YHR068W",340).
component("YKL150W",424).
component("YIL043C",359).
component("YPL171C",593).
component("YHR179W",351).
component("YMR145C",496).
component("YML120C",487).
component("YKL192C",429).
...
component("YML082W",485).
component("YJR130C",411).
component("YDR035W",203).
component("YBR249C",157).
component("YLR180W",461).
component("YDR502C",237).
component("YOR274W",570).
component("YHR137W",347).
component("YGL202W",299).
component("YLR027C",445).
...
component("YOR184W",563).
component("YNR058W",534).
component("YIL116W",365).
component("YGL253W",302).
component("YFR053C",279).
component("YMR205C",497).
component("YGR240C",320).
component("YOL016C",538).
component("YFR014C",274).
component("YCR036W",176).
component("YCL040W",169).
component("U15_",43).
component("YPL188W",594).
component("YJR049C",403).
component("YEL041W",244).
component("U96_",116).
component("YKL001C",416).
component("YDR236C",218).
component("YHL032C",329).
component("YDR531W",241).
component("U83_",112).
component("U81_",111).
component("YMR208W",498).
component("YPL203W",595).
component("YOR061W",555).
component("YKL166C",426).
component("YJL164C",390).
component("YIL035C",358).
component("YHR205W",354).
component("YHR102W",346).
component("YGL019W",286).
component("YHR025W",335).
component("YOR347C",576).
component("YAL038W",121).
component("YNR012W",530).
...
component("YPR190C",621).
component("YPR187W",620).
component("YPR110C",615).
component("YPR010C",609).
component("YOR341W",575).
component("YOR340C",574).
component("YOR224C",568).
component("YOR210W",567).
component("YOR207C",565).
component("YOR151C",560).
component("YOR116C",557).
component("YOL005C",536).
component("YNR003C",528).
component("YNL248C",520).
component("YNL151C",516).
component("YNL113W",513).
component("YKL144C",422).
component("YJR063W",405).
component("YJL148W",389).
component("YJL140W",388).
component("YIL021W",357).
...
component("YPR175W",619).
component("YPL167C",592).
component("YOR330C",572).
component("YOL115W",549).
component("YNL299W",526).
component("YNL262W",522).
component("YNL102W",511).
component("YJR043C",402).
component("YJR006W",398).
component("YJL090C",381).
component("YIL139C",368).
...
component("YPR113W",616).
component("YPL148C",590).
component("YGR286C",325).
component("YHR189W",352).
component("YDR058C",206).
component("YDL086W",186).
component("YOL011W",537).
component("YMR008C",490).
component("YMR006C",489).
component("U105_",22).
component("YBL015W",128).
component("YJL068C",379).
component("U77_",108).
component("YLR377C",478).
component("YPR073C",612).
component("YHR215W",355).
...
component("YOR208W",566).
component("YNL053W",508).
component("YMR036C",492).
component("YIR026C",375).
component("YIL113W",364).
...
component("U25_",71).
component("U24_",70).
component("YHR044C",337).
component("YHR043C",336).
component("YOR360C",577).
component("YKR031C",435).
component("YPL206C",596).
component("YGL027C",288).
component("YLR286C",468).
component("YJR153W",414).
component("YJL221C",397).
component("YJL216C",395).
component("YIL172C",374).
component("YGR292W",327).
component("YGR287C",326).
component("YBR299W",165).
component("YOR190W",564).
component("YLR300W",470).
...
component("YPL117C",589).
component("U14_",37).
component("YOL056W",542).
component("YKL152C",425).
component("YDL021W",178).
component("YPR060C",610).
component("YPL097W",587).
component("YGR185C",315).
component("YGR264C",323).
component("YGR171C",313).
component("YPL104W",588).
component("YLL018C",441).
component("YHR020W",334).
component("YER087W",262).
component("YNL247W",519).
component("YOR168W",561).
component("YOL097C",547).
component("YDR268W",222).
component("YCR024C",173).
component("YHR019C",333).
component("YPL160W",591).
component("YLR382C",479).
component("YNL073W",510).
component("YOR335C",573).
component("YLR153C",457).
component("YAL054C",122).
component("YGR244C",321).
component("YIL145C",369).
component("YJL101C",382).
component("YOL049W",540).
component("YAR015W",124).
component("YER183C",267).
component("U90_",113).
component("YNR057C",533).
component("YGL234W",301).
component("YJR103W",409).
component("YBL039C",131).
component("YGR204W",318).
component("YBR084W",143).
component("YNL220W",518).
component("YDL141W",191).
component("YHR074W",342).
component("YGL062W",289).
component("YBR218C",155).
component("YPL231W",601).
component("YNR016C",531).
component("YKL182W",428).
component("YGR037C",307).
component("YPR138C",617).
component("YPL265W",603).
component("YPL036W",586).
component("YOR171C",562).
component("YOR011W",554).
component("YOL156W",553).
component("YOL103W",548).
component("YOL020W",539) :- not remove_orf("YOL020W",539).
component("YNR072W",535).
component("YNL270C",523).
component("YNL142W",515).
component("YMR011W",491).
component("YLR260W",467).
...
component("YJR158W",415).
component("YJR077C",407).
component("YJL219W",396).
component("YJL214W",394).
component("YJL134W",387).
component("YJL129C",385).
component("YIL134W",367).
component("YHR096C",345).
component("YHR094C",344).
component("YHR092C",343).
component("YHL036W",330).
...
catalyst(6112,558).
catalyst(2300,114).
catalyst(3600,430) :- not remove_reaction(3600,430).
catalyst(8000,440).
catalyst(6890,517).
catalyst(4560,245).
catalyst(2550,532).
catalyst(1890,431) :- not remove_reaction(1890,431).
catalyst(3630,431) :- not remove_reaction(3630,431).
...
catalyst(1210,553).
catalyst(1160,548).
catalyst(801,539) :- not remove_reaction(801,539).
catalyst(802,539) :- not remove_reaction(802,539).
catalyst(811,539) :- not remove_reaction(811,539).
catalyst(812,539) :- not remove_reaction(812,539).
catalyst(831,539) :- not remove_reaction(831,539).
catalyst(832,539) :- not remove_reaction(832,539).
catalyst(901,539) :- not remove_reaction(901,539).
catalyst(902,539) :- not remove_reaction(902,539).
catalyst(1210,535).
catalyst(931,523).
catalyst(932,523).
catalyst(371,515).
...
catalyst(851,436) :- not remove_reaction(851,436).
catalyst(852,436) :- not remove_reaction(852,436).
catalyst(881,436) :- not remove_reaction(881,436).
catalyst(882,436) :- not remove_reaction(882,436).
catalyst(901,436) :- not remove_reaction(901,436).
catalyst(902,436) :- not remove_reaction(902,436).
catalyst(921,436) :- not remove_reaction(921,436).
catalyst(922,436) :- not remove_reaction(922,436).
catalyst(931,436) :- not remove_reaction(931,436).
catalyst(932,436) :- not remove_reaction(932,436).
