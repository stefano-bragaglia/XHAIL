...
component("YNL280C",804).
component("YLR056W",688).
component("YGR060W",476).
component("YGL012W",444).
component("YKR009C",665).
component("YOL086C",836).
component("YMR303C",776).
component("YMR083W",754).
component("YGL256W",469).
component("YDL168W",306).
component("YBR145W",235).
component("YPL231W",915).
component("YBR265W",254).
component("U46_",141).
component("YBR149W",236).
component("YBR149W",237).
component("YGL001C",440).
component("YIL094C",558).
component("YHR063C",523).
component("U45_",140).
component("YML056C",738).
component("YLR432W",727).
component("YHR216W",546).
component("YAR075W",198).
component("YAR073W",197).
component("YDR127W",335).
component("YJR139C",629).
component("YML075C",741).
component("YLR450W",730).
component("YOL126C",842).
component("YKL085W",642).
component("YDL078C",288).
component("YKL029C",637).
component("YNL037C",781).
component("YNL009W",779).
component("YLR174W",702).
component("YHR183W",539).
component("YGR256W",501).
component("YNL241C",796).
component("YOL059W",833).
component("YDL022W",280).
component("YCL018W",262).
component("YLR355C",722).
component("YIL074C",555).
component("YER081W",412).
component("YML054C",737).
component("YDL174C",310).
component("YML086C",743).
component("YIL155C",567).
component("YEL024W",384).
component("YKR066C",670).
component("YGR088W",480).
component("YDR256C",349).
component("YKL026C",636).
component("YIR037W",578).
component("YBR244W",249).
component("YJR078W",621).
component("U58_",150).
component("YJR025C",612).
component("U107_",27).
component("YGR255C",500).
component("U108_",28).
component("YHR007C",512).
component("YDR402C",364).
component("YGL055W",451).
component("YJR104C",624).
component("YHR008C",513).
component("YOR384W",886).
component("YOR381W",885).
component("YOL152W",845).
component("YLL051C",680).
component("YJL026W",580).
component("YIL066C",554).
component("YGR180C",488).
component("YER070W",409).
component("U37_",134).
component("U36_",133).
component("U35_",132).
component("YDL168W",307).
component("YDR158W",343).
component("YJR009C",608).
component("YJL052W",582).
component("YGR192C",490).
component("YBR006W",211).
component("YPL276W",925).
component("YPL275W",924).
component("YOR388C",887).
component("YPL061W",895).
component("YOR374W",883).
component("YER073W",410).
component("YGL154C",459).
component("YBR115C",230).
component("U55_",149).
component("YER069W",407).
component("YOR323C",875).
component("YMR170C",764).
component("YMR169C",763).
component("YER178W",422).
component("YBR221C",247).
component("YIL125W",563).
component("U52_",146).
component("YBR166C",240).
component("YNL280C",805).
component("YGL012W",445).
component("YKL182W",653).
component("YKL216W",663).
component("YDR044W",325).
component("YER014W",394).
component("YKR009C",666).
component("YIL160C",568).
component("YGL205W",464).
component("YMR118C",758).
component("YLR164W",700).
component("YLL041C",678).
component("YKL148C",647).
component("YKL141W",645).
component("YJL045W",581).
component("YDR178W",344).
component("YJR051W",615).
component("YEL047C",387).
component("YDL171C",308).
component("YDL171C",309).
component("YOR375C",884).
component("YDL215C",314).
component("YAL062W",194).
component("U99_",188).
component("U100_",21).
component("YBR035C",220).
component("YMR189W",766).
component("YKR080W",672).
component("YER023W",396).
component("YPL023C",891).
component("YGL125W",456).
component("YOR236W",872).
component("YGR204W",493).
component("YIR034C",577).
component("YLR142W",697).
component("U65_",157).
component("U63_",155).
component("U62_",154).
component("YHR068W",524).
component("YKL150W",648).
component("YIL043C",551).
component("YHR042W",518).
component("YOR221C",869).
component("YMR145C",761).
component("YML120C",744).
component("YKL192C",657).
component("YKL055C",639).
component("YER061C",404).
component("YDL085W",290).
component("YPL171C",904).
component("YHR179W",538).
component("YMR145C",762).
component("YML120C",745).
component("YKL192C",658).
component("YDL085W",291).
component("YGR234W",496).
component("YFR030W",436).
component("YPL017C",890).
component("YFL018C",426).
component("YPL091W",896).
component("YDR353W",359).
component("YER042W",398).
component("YPR167C",946).
component("YJR137C",628).
component("YNL052W",783).
component("YMR256C",773).
component("YLR395C",726).
component("YLR038C",686).
component("YIL111W",560).
component("YHR051W",522).
component("YGL191W",462).
component("YGL187C",461).
component("YDL067C",287).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",330).
component("YPL266W",922).
component("YPL273W",923).
component("YLL062C",682).
component("YDR410C",367).
component("YKR069W",671).
component("YOL096C",837).
component("U47_",142).
component("YER091C",417).
component("YJR073C",619).
component("YGR157W",485).
component("YDR120C",333).
component("YML008C",732).
component("YOR074C",850).
component("YDL033C",282).
component("YOL096C",838).
component("YLR172C",701).
component("YLR058C",689).
component("YDR019C",321).
component("YBR176W",241).
component("YDR408C",366).
component("YMR120C",759).
component("YLR028C",684).
component("YBL013W",199).
component("YJL130C",593).
component("YJL088W",586).
component("YKL024C",634).
component("YPR074C",938).
component("YBR117C",231).
component("YMR108W",757).
component("YCL009C",261).
component("YMR062C",752).
component("YNL071W",785).
component("YNR008W",811).
component("YIL160C",569).
component("YNR019W",814).
component("YCR048W",276).
component("U48_",143).
component("YMR062C",753).
component("YDR232W",346).
component("YPL231W",916).
component("YER061C",405).
component("YPL001W",889).
component("YDL052C",286).
component("U8_",181).
component("YDR148C",341).
component("YPL231W",917).
component("YPL028W",892).
component("YLR299W",712).
component("YGL017W",446).
component("YCR005C",268).
component("YML126C",746).
component("YNL104C",788).
component("YDL182W",311).
component("YDL131W",297).
component("YPR160W",945).
component("YDR307W",355).
component("YLR258W",709).
component("YFR015C",433).
component("YPL227C",913).
component("YNL029C",780).
component("YIL085C",557).
component("YNL192W",794).
component("YBR038W",222).
component("YBR023C",218).
component("YEL011W",381).
component("YMR306W",777).
component("YLR342W",720).
component("YGR032W",473).
component("YPR183W",949).
component("YBR248C",250).
component("YLR209C",704).
component("U104_",24).
component("U103_",23).
component("YOR209C",867).
component("YDR354W",360) :- not remove_orf("YDR354W",360).
component("YFR047C",437).
component("YJR133W",627).
component("YLR209C",705).
component("YML022W",734).
component("YDR441C",370).
component("YHR128W",533).
component("YPR176C",948).
component("YPL172C",905).
component("YNR041C",817).
component("YMR101C",755).
component("YDL090C",293).
component("YBR003W",210).
component("YBR002C",209).
component("YJL167W",600).
component("YJL167W",601).
component("YNL256W",799).
component("YPR069C",935).
component("YDR127W",336).
component("YHR190W",541).
component("YLR146C",698).
component("YPL214C",911).
component("YHR068W",525).
component("YLR303W",714).
component("YGR012W",471).
component("YML082W",742).
component("YJR130C",626).
component("YDR035W",323).
component("YBR249C",251).
component("YLR180W",703).
component("YDR502C",374).
component("YOR274W",873).
component("YOL143C",844).
component("YBR256C",253).
component("YHR137W",534).
component("YGL202W",463).
component("YLR027C",683).
component("YKL106W",643).
component("YOL140W",843).
component("YLR438W",729).
component("YGR019W",472).
component("YLR089C",693).
component("U64_",156).
component("U61_",153).
component("U51_",145).
component("YJR148W",630).
component("YHR208W",544).
component("YFL030W",428).
component("YOR184W",861).
component("YNR058W",821).
component("YIL116W",562).
component("YGL253W",468).
component("YFR053C",438).
component("YMR013C",750).
component("YMR205C",768).
component("YGR240C",497).
component("YOL016C",825).
component("YFR014C",432).
component("YLR240W",707).
component("YKL203C",660).
component("YJR066W",618).
component("YCR036W",275).
component("YGR194C",491).
component("YCL040W",264).
component("U15_",68).
component("YPL188W",907).
component("YJR049C",614).
component("YEL041W",385).
component("U96_",186).
component("YKL001C",633).
component("YDR236C",347).
component("YML070W",740).
component("YFL053W",430).
component("YHL032C",510).
component("YDR531W",378).
component("U83_",175).
component("U82_",174).
component("U81_",173).
component("YMR208W",769).
component("YPL203W",908).
component("YOR061W",849).
component("YKL166C",650).
component("YJL164C",599).
component("YIL035C",550).
component("YHR205W",543).
component("YHR102W",531).
component("YGL019W",447).
component("YHR025W",517).
component("YOR347C",880).
component("YAL038W",192).
component("YNR012W",812).
component("YPR121W",943).
component("YPL258C",919).
component("YOL055C",829).
component("YPL214C",912).
component("YDR009W",320).
component("YDR127W",337).
component("U21_",113).
component("YDR147W",340).
component("YDR300C",354).
component("YCR012W",269).
component("YER069W",408).
component("U19_",103).
component("YKL024C",635).
component("U18_",93).
component("U17_",83).
component("U76_",167).
component("YER170W",421).
component("YDR226W",345).
component("YKL067W",641).
component("YOL055C",830).
component("YDR454C",371).
component("YJR057W",616).
component("YOL061W",834).
component("YKL181W",652).
component("YHL011C",508).
component("YER099C",418).
component("YBL068W",206).
component("YOR143C",857).
component("YNL256W",800).
component("YLR328W",718).
component("YBR018C",213).
component("YBR018C",214).
component("YGR007W",470).
component("YGR202C",492).
component("YLR328W",719).
component("YDL045C",284).
component("U80_",172).
component("YDL103C",296).
component("U94_",185).
component("YJR010W",609).
component("YBR029C",219).
component("YCL050C",265).
component("YGL130W",457).
component("YDR530C",377).
component("YCL050C",266).
component("YPR190C",951).
component("YPR187W",950).
component("YPR110C",941).
component("YPR010C",928).
component("YOR341W",879).
component("YOR340C",878).
component("YOR224C",871).
component("YOR210W",868).
component("YOR207C",865).
component("YOR151C",858).
component("YOR116C",852).
component("YOL005C",823).
component("YNR003C",810).
component("YNL248C",798).
component("YNL151C",792).
component("YNL113W",789).
component("YKL144C",646).
component("YJR063W",617).
component("YJL148W",597).
component("YJL140W",596).
component("YIL021W",549).
component("YHR143W-A",535).
component("YGL070C",454).
component("YFL036W",429).
component("YDR404C",365).
component("YDR156W",342).
component("YDR045C",326).
component("YDL150W",305).
component("YDL140C",299).
component("YBR154C",239).
component("YPR175W",947).
component("YPL167C",903).
component("YOR330C",876).
component("YOL115W",841).
component("YNL299W",807).
component("YNL262W",802).
component("YNL102W",787).
component("YJR043C",613).
component("YJR006W",607).
component("YJL090C",587).
component("YIL139C",565).
component("YEL055C",388).
component("YDR419W",368).
component("YDR121W",334).
component("YDL102W",295).
component("YCR014C",270).
component("YBR278W",256).
component("YBL035C",202).
component("YKL035W",638).
component("YHL012W",509).
component("YHR123W",532).
component("YPR113W",942).
component("YBR243C",248).
component("YDL142C",304).
component("YPL148C",901).
component("YER026C",397).
component("YGR286C",505).
component("YJL068C",583).
component("YHR189W",540).
component("YDR058C",329).
component("YDL086W",292).
component("YOL011W",824).
component("YMR008C",748).
component("YMR006C",747).
component("U105_",25).
component("YBL015W",200).
component("YJL068C",584).
component("YJR019C",611).
component("YOR040W",848).
component("U84_",176).
component("U77_",168).
component("YDR481C",372).
component("YLR377C",724).
component("YFR025C",434).
component("YPL179W",906).
component("YNR032W",815).
component("YML057W",739).
component("YML016C",733).
component("YLR433C",728).
component("YGR123C",483).
component("YER133W",419).
component("YER089C",415).
component("YDR436W",369).
component("YDR075W",331).
component("YDL188C",312).
component("YDL134C",298).
component("YDL047W",285).
component("YDL006W",278).
component("YBR125C",234).
component("YBL056W",205).
component("YPR073C",936).
component("YHR215W",545).
component("YDL024C",281).
component("YBR093C",228).
component("YBR092C",227).
component("YAR071W",196).
component("YIL053W",553).
component("YER062C",406).
component("YHR046C",521).
component("U9_",189).
component("YPL228W",914).
component("YMR180C",765).
component("YDL236W",316).
component("YJL155C",598).
component("YPR073C",937).
component("YOR208W",866).
component("YNL053W",784).
component("YMR036C",751).
component("YIR026C",575).
component("YIL113W",561).
component("YFR028C",435).
component("YER075C",411).
component("YDL230W",315).
component("YBR276C",255).
component("U34_",131).
component("U33_",130).
component("U32_",129).
component("U31_",128).
...
component("U25_",122).
component("U24_",121).
component("YHR044C",520).
component("YHR043C",519).
component("YOL064C",835).
component("YOR360C",882).
component("YGL248W",467).
component("YKR031C",667).
component("YPL206C",909).
component("YGL027C",449).
component("YLR286C",711).
component("YJR153W",631).
component("YJL221C",606).
component("YJL216C",604).
component("YIL172C",573).
component("YGR292W",507).
component("YGR287C",506).
component("YBR299W",260).
component("YBR184W",242).
component("YIL162W",570).
component("YPR026W",929).
component("YDR001C",318).
component("YBR001C",208).
component("YIR019C",574).
component("YIL099W",559).
component("YDL037C",283).
component("YOR190W",863).
component("YLR300W",713).
component("YGR282C",504).
component("YDR261C",350).
component("YDR400W",363).
component("U23_",120).
component("YML035C",735).
component("YJL070C",585).
component("YBR284W",257).
component("U106_",26).
component("U102_",22).
component("YER043C",399).
component("YNL045W",782).
component("YGL037C",450).
component("YDR242W",348).
component("YLR308W",717).
component("YLR307W",716).
component("YBR208C",244).
component("YMR281W",775).
component("U53_",147).
component("YIR032C",576).
component("YPR062W",934).
component("YMR120C",760).
component("YLR028C",685).
component("YHR144C",536).
component("YGR267C",503).
component("YBL033C",201).
component("YBR153W",238).
component("YNL141W",790).
component("YLR245C",708).
component("YML035C",736).
component("YGR204W",494).
component("YBR084W",225).
component("YJL126W",591).
component("U44_",139).
component("YDL100C",294).
component("U87_",178).
component("U40_",137).
component("U39_",135).
component("YBR011C",212).
component("YHR201C",542).
component("YBR111C",229).
component("YBR252W",252).
component("YPR080W",939).
component("YOR187W",862).
component("YOR133W",855).
component("YLR069C",691).
component("YKR084C",673).
component("YKL173W",651).
component("YJL102W",589).
component("YDR385W",362).
component("YBR118W",232).
component("YER005W",393).
component("YLL001W",676).
component("YIL048W",552).
component("YER166W",420).
component("YDR093W",332).
component("YAL026C",191).
component("YBL099W",207).
component("U60_",152).
component("YLR231C",706).
component("U88_",179).
component("YDR538W",380).
component("YLR134W",695).
component("YLR044C",687).
component("YGR087C",479).
component("YDR380W",361).
component("YDL080C",289).
component("U98_",187).
component("YMR250W",772).
component("YKL184W",656).
component("YOR128C",853).
component("YEL021W",383).
component("YNR043W",818).
component("U93_",184).
component("U54_",148).
component("YKL211C",661) :- not remove_orf("YKL211C",661).
component("YKR097W",675).
component("YOL052C",828).
component("YNL169C",793).
component("YGR170W",486).
component("YKL060C",640).
component("YNL256W",801).
component("YDR294C",352).
component("YEL046C",386).
component("YNR033W",816).
component("YKL211C",662) :- not remove_orf("YKL211C",662).
component("YER090W",662) :- not remove_orf("YER090W",662).
component("YER090W",416) :- not remove_orf("YER090W",416).
component("YDR127W",338).
component("YPL281C",926).
component("YOR393W",888).
component("YMR323W",778).
component("YHR174W",537).
component("YGR254W",499).
component("YOR202W",864).
component("YPL262W",920).
component("YGL026C",448) :- not remove_orf("YGL026C",448).
component("YGR155W",484).
component("YLR304C",715).
component("YJL200C",602).
component("YGL009C",443).
component("YNL316C",808).
component("YKL182W",654).
component("YPL212C",910).
component("YNL292W",806).
component("YGL063W",453).
component("YFL001W",424).
component("YPR002W",927).
component("YJR016C",610).
component("YCR053W",277).
component("YDR127W",339).
component("YGL148W",458).
component("YIL168W",572).
component("YIL167W",571).
component("YCL064C",267).
component("YER086W",413).
component("YLR359W",723).
component("YAL012W",190).
component("YML004C",731).
component("YFR055W",439).
component("YJL005W",579).
component("YJL121C",590).
component("YBR019C",215).
component("YBR019C",216).
component("YDR050C",328).
component("YIL020C",548).
component("YDR007W",319) :- not remove_orf("YDR007W",319).
component("YOR095C",851).
component("YER003C",392).
component("YBR196C",243).
component("YGL001C",441).
component("YPL117C",899).
component("U14_",60).
component("YOL056W",831).
component("YKL152C",649).
component("YDL021W",279).
component("YMR105C",756).
component("YKL127W",644).
component("YEL058W",389).
component("YPR060C",933).
component("YHR072W",526).
component("YPL097W",897).
component("YGR185C",489).
component("YGR264C",502).
component("YGR171C",487).
component("YHR011W",514).
component("YDR023W",322).
component("YPL104W",898).
component("YLL018C",677).
component("YPR081C",940).
component("YBR121C",233).
component("YHR020W",516).
component("YER087W",414).
component("YNL247W",797).
component("YOR168W",859).
component("YOL097C",839).
component("YDR268W",351).
component("YPR047W",932).
component("YLR060W",690).
component("YFL022C",427).
component("YPR033C",930).
component("YCR024C",271).
component("YHR019C",515).
component("YKL194C",659).
component("YIL078W",556).
component("YPL160W",902).
component("YLR382C",725).
component("YNL073W",786).
component("YDR037W",324).
component("YOR335C",877).
component("YGR094W",481).
component("YLR153C",699).
component("YAL054C",193).
component("YOR317W",874).
component("YMR246W",771).
component("YIL009W",547).
component("YER015W",395).
component("YOR142W",856).
component("YGR244C",498).
component("YPR035W",931).
component("YIL145C",566).
component("U89_",180).
component("YJL101C",588).
component("YOL049W",827).
component("YAR015W",195).
component("YGL234W",465).
component("YER183C",423).
component("U91_",183).
component("U90_",182).
component("YNR057C",820).
component("YDL141W",300).
component("YDL141W",301).
component("YGL234W",466).
component("YDL141W",302).
component("YJR103W",623).
component("YBL039C",203).
component("YGR204W",495).
component("YBR084W",226).
component("YNL220W",795).
component("YOL058W",832).
component("YBR208C",245).
component("YDL141W",303).
component("YHR074W",527).
component("YMR217W",770).
component("YGR061C",477).
component("YJR109C",625).
component("YJL130C",594).
component("YGL062W",452).
component("YBR218C",246).
component("YPL231W",918).
component("YNR016C",813).
component("YKL182W",655).
component("YGR037C",474).
component("YPR138C",944).
component("YPL265W",921).
component("YPL134C",900).
component("YPL057C",894).
component("YPL036W",893).
component("YOR348C",881).
component("YOR222W",870).
component("YOR171C",860).
component("YOR130C",854).
component("YOR011W",847).
component("YOL156W",846).
component("YOL103W",840).
component("YOL020W",826) :- not remove_orf("YOL020W",826).
component("YNR072W",822).
component("YNR056C",819).
component("YNL318C",809).
component("YNL270C",803).
component("YNL142W",791).
component("YMR272C",774).
component("YMR202W",767).
component("YMR011W",749).
component("YLR348C",721).
component("YLR260W",710).
component("YLR138W",696).
component("YLR100C",694).
component("YLR081W",692).
component("YLL061W",681).
component("YLL043W",679).
component("YKR093W",674).
component("YKR053C",669).
component("YKR039W",668) :- not remove_orf("YKR039W",668).
component("YKL217W",664).
component("YJR158W",632).
component("YJR095W",622).
component("YJR077C",620).
component("YJL219W",605).
component("YJL214W",603).
component("YJL134W",595).
component("YJL129C",592).
component("YIL134W",564).
component("YHR096C",530).
component("YHR094C",529).
component("YHR092C",528).
component("YHL036W",511).
component("YGR121C",482).
component("YGR065C",478).
component("YGR055W",475).
component("YGL186C",460).
component("YGL077C",455).
component("YGL008C",442).
component("YFL055W",431).
...
component("YEL063C",390).
component("YEL017C-A",382).
component("YDR536W",379).
...
component("YDL245C",317).
component("YDL210W",313).
component("YCR032W",274).
component("YCR028C",273).
component("YCR024C-A",272).
component("YCL025C",263).
component("YBR298C",259).
component("YBR291C",258).
component("YBR069C",224) :- not remove_orf("YBR069C",224).
component("YBR068C",223) :- not remove_orf("YBR068C",223).
component("YBR036C",221).
component("YBR021W",217).
component("YBL042C",204).
component("U85_",177).
component("U7_",171).
component("U79_",170).
component("U78_",169).
...
catalyst(2132,23).
catalyst(2220,867).
catalyst(3620,360) :- not remove_reaction(3620,360).
catalyst(2110,437).
catalyst(2190,437).
catalyst(5550,627).
catalyst(5791,705).
...
catalyst(2300,184).
catalyst(3460,148).
catalyst(3600,661) :- not remove_reaction(3600,661).
catalyst(8000,675).
catalyst(3941,828).
catalyst(3942,828).
catalyst(6890,793).
...
catalyst(4560,386).
catalyst(2550,816).
catalyst(1890,662) :- not remove_reaction(1890,662).
catalyst(3630,662) :- not remove_reaction(3630,662).
...
catalyst(8061,920).
catalyst(8062,920).
catalyst(3590,448) :- not remove_reaction(3590,448).
catalyst(10910,448) :- not remove_reaction(10910,448).
catalyst(4570,484).
catalyst(8181,715).
catalyst(8182,715).
catalyst(8181,602).
...
catalyst(1210,846).
catalyst(1160,840).
catalyst(801,826) :- not remove_reaction(801,826).
catalyst(802,826) :- not remove_reaction(802,826).
catalyst(811,826) :- not remove_reaction(811,826).
catalyst(812,826) :- not remove_reaction(812,826).
catalyst(831,826) :- not remove_reaction(831,826).
catalyst(832,826) :- not remove_reaction(832,826).
catalyst(901,826) :- not remove_reaction(901,826).
catalyst(902,826) :- not remove_reaction(902,826).
catalyst(1180,822).
catalyst(1210,822).
catalyst(700,819).
catalyst(1200,809).
...
catalyst(650,674).
catalyst(6560,669).
catalyst(681,668) :- not remove_reaction(681,668).
catalyst(682,668) :- not remove_reaction(682,668).
catalyst(771,668) :- not remove_reaction(771,668).
catalyst(772,668) :- not remove_reaction(772,668).
catalyst(781,668) :- not remove_reaction(781,668).
catalyst(782,668) :- not remove_reaction(782,668).
catalyst(791,668) :- not remove_reaction(791,668).
catalyst(792,668) :- not remove_reaction(792,668).
catalyst(801,668) :- not remove_reaction(801,668).
catalyst(802,668) :- not remove_reaction(802,668).
catalyst(811,668) :- not remove_reaction(811,668).
catalyst(812,668) :- not remove_reaction(812,668).
catalyst(831,668) :- not remove_reaction(831,668).
catalyst(832,668) :- not remove_reaction(832,668).
catalyst(841,668) :- not remove_reaction(841,668).
catalyst(842,668) :- not remove_reaction(842,668).
catalyst(851,668) :- not remove_reaction(851,668).
catalyst(852,668) :- not remove_reaction(852,668).
catalyst(881,668) :- not remove_reaction(881,668).
catalyst(882,668) :- not remove_reaction(882,668).
catalyst(901,668) :- not remove_reaction(901,668).
catalyst(902,668) :- not remove_reaction(902,668).
catalyst(911,668) :- not remove_reaction(911,668).
catalyst(912,668) :- not remove_reaction(912,668).
catalyst(921,668) :- not remove_reaction(921,668).
catalyst(922,668) :- not remove_reaction(922,668).
catalyst(931,668) :- not remove_reaction(931,668).
catalyst(932,668) :- not remove_reaction(932,668).
catalyst(1191,668) :- not remove_reaction(1191,668).
catalyst(1192,668) :- not remove_reaction(1192,668).
catalyst(390,664).
catalyst(1180,632).
catalyst(1210,632).
catalyst(1250,622).
...
catalyst(851,327) :- not remove_reaction(851,327).
catalyst(852,327) :- not remove_reaction(852,327).
...
catalyst(1511,258).
catalyst(1512,258).
catalyst(771,224) :- not remove_reaction(771,224).
catalyst(772,224) :- not remove_reaction(772,224).
...
catalyst(831,223) :- not remove_reaction(831,223).
catalyst(832,223) :- not remove_reaction(832,223).
catalyst(841,223) :- not remove_reaction(841,223).
catalyst(842,223) :- not remove_reaction(842,223).
...
modifiable_enzyme(661).
modifiable_enzyme(662).
modifiable_enzyme(416).
modifiable_enzyme(448).
modifiable_enzyme(319).
modifiable_enzyme(826).
modifiable_enzyme(668).
