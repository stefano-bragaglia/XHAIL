...
component("YLR056W",207).
component("YPL231W",272).
component("U46_",43).
component("YBR149W",64).
component("YGL001C",133).
component("YIL094C",165).
component("U45_",42).
component("YDR127W",93).
component("YOL126C",249).
component("YKL085W",189).
component("YDL078C",79).
component("YNL037C",227).
component("YDL174C",85).
component("YML086C",223).
component("YGR088W",147).
component("YDR256C",102).
component("YJR078W",183).
component("U107_",20).
component("YER070W",126).
component("U36_",39).
component("YPL276W",278).
component("YPL275W",277).
component("YOR388C",265).
component("YOR323C",259).
component("YIL125W",166).
component("U52_",45).
component("YBR166C",66).
component("YKL216W",196).
component("YKR009C",197).
component("YIL160C",168).
component("YGL205W",143).
component("YKR080W",201).
component("YER023W",122).
component("YLR142W",211).
component("U62_",47).
component("YHR068W",156).
component("YKL150W",192).
component("YIL043C",163).
component("YPL171C",271).
component("YHR179W",161).
component("YDR353W",106).
component("YPL266W",276).
component("YKR069W",200).
component("YDL033C",78).
component("YLR172C",213).
component("YLR058C",208).
component("YDR019C",88).
component("YBR176W",67).
component("YDR408C",111).
component("YMR120C",224).
component("YLR028C",204).
component("YKL024C",187).
component("YPR074C",282).
component("YBR117C",63).
component("YPL231W",273).
component("YPL231W",274).
component("YLR299W",218).
component("YDL182W",86).
component("YDL131W",82).
component("YLR258W",217).
component("YFR015C",131).
component("YNL029C",226).
component("YIL085C",164).
component("YLR209C",214).
component("U104_",18).
component("YDR354W",107) :- not remove_orf("YDR354W",107).
component("YFR047C",132).
component("YLR209C",215).
component("YML022W",221).
component("YDR441C",113).
component("YJL167W",178).
component("YDR127W",94).
component("YJR130C",185).
component("YDR035W",89).
component("YBR249C",69).
component("YOR274W",258).
component("YHR137W",157).
component("YGL202W",142).
component("YLR027C",203).
component("YKL106W",190).
component("YJR148W",186).
component("YNR058W",241).
component("YCR036W",77).
component("U96_",50).
component("YNR012W",239).
component("YDR127W",95).
component("YDR147W",98).
component("U76_",48).
component("YDR226W",100).
component("YKL067W",188).
component("YOL055C",244).
component("YDR454C",114).
component("YOL061W",245).
component("YKL181W",193).
component("YHL011C",154).
component("YER099C",128).
component("YBL068W",57).
component("YNL256W",233).
component("YBR018C",59).
component("YGL130W",139).
component("YPR190C",288).
component("YPR187W",287).
component("YPR110C",283).
component("YPR010C",280).
component("YOR341W",263).
component("YOR340C",262).
component("YOR224C",257).
component("YOR210W",256).
component("YOR207C",255).
component("YOR151C",253).
component("YOR116C",252).
component("YOL005C",242).
component("YNR003C",238).
component("YNL248C",232).
component("YNL151C",231).
component("YNL113W",229).
component("YKL144C",191).
component("YJR063W",181).
component("YJL148W",177).
component("YJL140W",176).
component("YIL021W",162).
component("YHR143W-A",158).
component("YGL070C",138).
component("YFL036W",129).
component("YDR404C",110).
component("YDR156W",99).
component("YDR045C",90).
component("YDL150W",84).
component("YDL140C",83).
component("YBR154C",65).
component("YPR175W",286).
component("YPL167C",270).
component("YOR330C",260).
component("YOL115W",248).
component("YNL299W",236).
component("YNL262W",234).
component("YNL102W",228).
component("YJR043C",180).
component("YJR006W",179).
component("YJL090C",172).
component("YIL139C",167).
component("YEL055C",119).
component("YDR419W",112).
component("YDR121W",92).
component("YDL102W",81).
component("YCR014C",76).
component("YBR278W",71).
component("YBL035C",55).
component("YPR113W",284).
component("U105_",19).
component("YBL015W",54).
component("YLR377C",220).
component("U30_",38).
component("U29_",37).
component("U24_",36).
component("YOR360C",264).
component("YGL027C",136).
component("YOR190W",254).
component("YLR300W",219).
component("YGR282C",153).
component("YDR261C",103).
component("YDR400W",109).
component("YML035C",222).
component("YJL070C",171).
component("YBR284W",72).
component("YDR242W",101).
component("U53_",46).
component("YLR028C",205).
component("YHR144C",159).
component("YJL126W",173).
component("U39_",40).
component("YBR011C",58).
component("YBR111C",62).
component("YBR252W",70).
component("YER005W",121).
component("YLR231C",216).
component("YLR134W",210).
component("YLR044C",206).
component("YGR087C",146).
component("YDR380W",108).
component("YDL080C",80).
component("U98_",51).
component("YKL211C",194) :- not remove_orf("YKL211C",194).
component("YKL211C",195) :- not remove_orf("YKL211C",195).
component("YER090W",195) :- not remove_orf("YER090W",195).
component("YER090W",127) :- not remove_orf("YER090W",127).
component("YDR127W",96).
component("YPL281C",279).
component("YOR393W",266).
component("YMR323W",225).
component("YHR174W",160).
component("YGR254W",151).
component("YGL026C",135) :- not remove_orf("YGL026C",135).
component("YNL316C",237).
component("YDR127W",97).
component("YGL148W",140).
component("YIL168W",170).
component("YIL167W",169).
component("YCL064C",75).
component("YAL012W",52).
component("YDR007W",87) :- not remove_orf("YDR007W",87).
component("YOR095C",251).
component("YGL001C",134).
component("YPL117C",269).
component("YPR060C",281).
component("YPL097W",267).
component("YGR185C",150).
component("YGR264C",152).
component("YGR171C",149).
component("YPL104W",268).
component("YLL018C",202).
component("YOL097C",246).
component("YDR268W",104).
component("YOR335C",261).
component("YLR153C",212).
component("YAL054C",53).
component("U90_",49).
component("YNR057C",240).
component("YJR103W",184).
component("YBL039C",56).
component("YGL062W",137).
component("YBR218C",68).
component("YPR138C",285).
component("YPL265W",275).
component("YOR011W",250).
component("YOL103W",247).
component("YOL020W",243) :- not remove_orf("YOL020W",243).
component("YNL270C",235).
component("YNL142W",230).
component("YLR100C",209).
component("YKR053C",199).
component("YKR039W",198) :- not remove_orf("YKR039W",198).
component("YJR077C",182).
component("YJL134W",175).
component("YJL129C",174).
component("YHL036W",155).
component("YGR121C",148).
component("YGR065C",145).
component("YGR055W",144).
component("YGL186C",141).
component("YFL055W",130).
component("YER060W-A",125).
component("YER060W",124).
component("YER056C",123).
component("YEL063C",120).
component("YDR536W",118).
component("YDR508C",117).
component("YDR503C",116).
component("YDR497C",115).
component("YDR297W",105).
component("YDR046C",91) :- not remove_orf("YDR046C",91).
...
catalyst(2121,18).
catalyst(2122,18).
catalyst(3620,107) :- not remove_reaction(3620,107).
catalyst(2190,132).
catalyst(5791,215).
catalyst(5792,215).
catalyst(5801,215).
...
catalyst(8812,80).
catalyst(2250,51).
catalyst(3600,194) :- not remove_reaction(3600,194).
catalyst(3630,195) :- not remove_reaction(3630,195).
catalyst(3630,127) :- not remove_reaction(3630,127).
catalyst(3740,96).
catalyst(8231,279).
catalyst(8232,279).
catalyst(8231,266).
...
catalyst(8231,151).
catalyst(8232,151).
catalyst(3590,135) :- not remove_reaction(3590,135).
catalyst(10910,135) :- not remove_reaction(10910,135).
catalyst(3680,237).
catalyst(3750,97).
catalyst(3700,140).
catalyst(8751,170).
...
catalyst(4520,75).
catalyst(4460,52).
catalyst(3610,87) :- not remove_reaction(3610,87).
catalyst(7921,251).
catalyst(7922,251).
catalyst(6370,134).
catalyst(6461,269).
...
catalyst(831,243) :- not remove_reaction(831,243).
catalyst(832,243) :- not remove_reaction(832,243).
...
catalyst(781,198) :- not remove_reaction(781,198).
catalyst(782,198) :- not remove_reaction(782,198).
...
catalyst(881,198) :- not remove_reaction(881,198).
catalyst(882,198) :- not remove_reaction(882,198).
catalyst(901,198) :- not remove_reaction(901,198).
catalyst(902,198) :- not remove_reaction(902,198).
catalyst(931,198) :- not remove_reaction(931,198).
catalyst(932,198) :- not remove_reaction(932,198).
catalyst(1191,198) :- not remove_reaction(1191,198).
catalyst(1192,198) :- not remove_reaction(1192,198).
catalyst(1581,182).
catalyst(1582,182).
catalyst(6560,175).
catalyst(361,174).
