...
component("YNL280C",638).
component("YLR056W",547).
component("YGR060W",380).
component("YGL012W",352).
component("YKR009C",529).
component("YOL086C",663).
component("YMR303C",612).
component("YGL256W",374).
component("YDL168W",235).
component("YBR145W",176).
component("YPL231W",724).
component("YBR265W",191).
component("U46_",101).
component("YBR149W",177).
component("YBR149W",178).
component("YGL001C",349).
component("YIL094C",446).
component("U45_",100).
component("YML056C",590).
component("YLR432W",580).
component("YHR216W",439).
component("YAR075W",148).
component("YAR073W",147).
component("YDR127W",260).
component("YJR139C",505).
component("YML075C",592).
component("YLR450W",583).
component("YOL126C",669).
component("YKL085W",513).
component("YDL078C",222).
component("YNL037C",617).
component("YNL009W",615).
component("YLR174W",559).
component("YHR183W",432).
component("YGR256W",398).
component("YNL241C",631).
component("YOL059W",661).
component("YDL022W",215).
component("YCL018W",199).
component("YLR355C",575).
component("YIL074C",444).
component("YER081W",325).
component("YDL174C",239).
component("YML086C",594).
component("YIL155C",455).
component("YGR088W",383).
component("YDR256C",272).
component("YKL026C",511).
component("YIR037W",464).
component("YBR244W",187).
component("YJR078W",499).
component("U58_",109).
component("YJR025C",492).
component("U107_",24).
component("YHR007C",408).
component("YDR402C",286).
component("YGL055W",359).
component("YJR104C",501).
component("YHR008C",409).
component("YOR384W",705).
component("YOR381W",704).
component("YOL152W",671).
component("YLL051C",540).
component("YJL026W",466).
component("YIL066C",443).
component("YGR180C",389).
component("YER070W",322).
component("U37_",94).
component("U36_",93).
component("YDL168W",236).
component("YJR009C",489).
component("YJL052W",468).
component("YGR192C",391).
component("YBR006W",158).
component("YPL276W",732).
component("YPL275W",731).
component("YOR388C",706).
component("YOR374W",702).
component("YER073W",323).
component("YGL154C",366).
component("YBR115C",172).
component("U55_",108).
component("YER069W",320).
component("YOR323C",694).
component("YER178W",334).
component("YBR221C",185).
component("YIL125W",451).
component("U52_",106).
component("YBR166C",180).
component("YGL012W",353).
component("YKL182W",522).
component("YKL216W",528).
component("YDR044W",251).
component("YKR009C",530).
component("YIL160C",456).
component("YGL205W",371).
component("YMR118C",603).
component("YLR164W",557).
component("YLL041C",539).
component("YKL148C",517).
component("YKL141W",515).
component("YJL045W",467).
component("YDR178W",267).
component("YEL047C",305).
component("YDL171C",237).
component("YDL171C",238).
...
component("YER023W",312).
component("YOR236W",692).
component("YGR204W",392).
component("YIR034C",463).
component("YLR142W",554).
component("U65_",115).
component("U63_",113).
component("U62_",112).
component("YHR068W",418).
component("YKL150W",518).
component("YIL043C",442).
component("YHR042W",413).
component("YPL171C",718).
component("YHR179W",431).
component("YMR145C",606).
component("YML120C",595).
component("YKL192C",525).
component("YDL085W",224).
component("YGR234W",394).
component("YFR030W",345).
component("YPL017C",708).
component("YFL018C",338).
component("YDR353W",282).
component("YPR167C",745).
component("YJR137C",504).
component("YNL052W",619).
component("YMR256C",611).
component("YLR395C",579).
component("YLR038C",545).
component("YIL111W",448).
component("YHR051W",417).
component("YGL191W",369).
component("YGL187C",368).
component("YDL067C",221).
component("Q0275",19).
component("Q0250",18).
component("YDR072C",256).
component("YPL266W",730).
component("YKR069W",534).
component("YOL096C",664).
component("U47_",102).
component("YER091C",330).
component("YJR073C",497).
component("YGR157W",387).
component("YDR120C",258).
component("YML008C",585).
component("YOR074C",676).
component("YDL033C",217).
component("YOL096C",665).
component("YLR172C",558).
component("YLR058C",548).
component("YDR019C",249).
component("YBR176W",181).
component("YDR408C",288).
component("YMR120C",604).
component("YLR028C",543).
component("YBL013W",149).
component("YJL130C",476).
component("YKL024C",510).
component("YPR074C",740).
component("YBR117C",173).
component("YMR108W",602).
component("YCL009C",198).
component("YNL071W",621).
component("YNR008W",643).
component("YIL160C",457).
component("YNR019W",646).
component("YCR048W",211).
component("U48_",103).
component("YDR232W",269).
component("YPL231W",725).
component("YER061C",319).
component("YDL052C",220).
component("U8_",134).
component("YPL231W",726).
component("YPL028W",709).
component("YLR299W",568).
component("YGL017W",354).
component("YML126C",596).
component("YNL104C",624).
component("YDL182W",240).
component("YDL131W",228).
component("YDR307W",278).
component("YLR258W",565).
component("YFR015C",343).
component("YNL029C",616).
component("YIL085C",445).
component("YMR306W",613).
component("YLR342W",574).
component("YGR032W",377).
component("YLR209C",561).
component("U104_",21).
component("YDR354W",283) :- not remove_orf("YDR354W",283).
component("YFR047C",346).
component("YJR133W",503).
component("YLR209C",562).
component("YML022W",587).
component("YDR441C",291).
component("YHR128W",426).
component("YJL167W",481).
component("YJL167W",482).
component("YDR127W",261).
component("YHR190W",434).
component("YLR146C",555).
component("YHR068W",419).
component("YLR303W",570).
component("YGR012W",375).
component("YML082W",593).
component("YJR130C",502).
component("YDR035W",250).
component("YBR249C",188).
component("YLR180W",560).
component("YDR502C",294).
component("YOR274W",693).
component("YBR256C",190).
component("YHR137W",427).
component("YGL202W",370).
component("YLR027C",542).
component("YKL106W",514).
component("YOL140W",670).
component("YLR438W",582).
component("YGR019W",376).
component("YLR089C",550).
component("U64_",114).
component("U61_",111).
component("U51_",105).
component("YJR148W",506).
component("YHR208W",437).
component("YFL030W",339).
component("YOR184W",685).
component("YNR058W",651).
component("YIL116W",450).
component("YGL253W",373).
component("YFR053C",347).
component("YMR013C",600).
component("YMR205C",607).
component("YGR240C",395).
component("YOL016C",655).
component("YFR014C",342).
component("YCR036W",210).
component("YCL040W",201).
component("U15_",48).
component("YPL188W",720).
component("YJR049C",494).
component("YEL041W",303).
component("U96_",138).
component("YKL001C",509).
component("YDR236C",270).
component("YHL032C",406).
component("YDR531W",298).
component("U83_",131).
component("U82_",130).
component("U81_",129).
component("YMR208W",608).
component("YPL203W",721).
component("YOR061W",675).
component("YKL166C",520).
component("YJL164C",480).
component("YIL035C",441).
component("YHR205W",436).
component("YHR102W",425).
component("YGL019W",355).
component("YHR025W",412).
component("YOR347C",699).
component("YAL038W",143).
component("YNR012W",644).
component("YDR009W",248).
component("YDR127W",262).
component("YDR147W",265).
component("YDR300C",277).
component("YCR012W",204).
component("YER069W",321).
component("U19_",73).
component("U18_",66).
component("U17_",58).
component("U76_",124).
component("YER170W",333).
component("YDR226W",268).
component("YKL067W",512).
component("YOL055C",658).
component("YDR454C",292).
component("YJR057W",495).
component("YOL061W",662).
component("YKL181W",521).
component("YHL011C",405).
component("YER099C",331).
component("YBL068W",156).
component("YOR143C",681).
component("YNL256W",634).
component("YLR328W",572).
component("YBR018C",160).
component("YLR328W",573).
component("U80_",128).
component("U94_",137).
component("YJR010W",490).
component("YBR029C",163).
component("YCL050C",202).
component("YGL130W",364).
component("YDR530C",297).
component("YPR190C",748).
component("YPR187W",747).
component("YPR110C",742).
component("YPR010C",735).
component("YOR341W",698).
component("YOR340C",697).
component("YOR224C",691).
component("YOR210W",689).
component("YOR207C",687).
component("YOR151C",682).
component("YOR116C",678).
component("YOL005C",653).
component("YNR003C",642).
component("YNL248C",633).
component("YNL151C",628).
component("YNL113W",625).
component("YKL144C",516).
component("YJR063W",496).
component("YJL148W",479).
component("YJL140W",478).
component("YIL021W",440).
component("YHR143W-A",428).
component("YGL070C",362).
component("YFL036W",340).
component("YDR404C",287).
component("YDR156W",266).
component("YDR045C",252).
component("YDL150W",234).
component("YDL140C",230).
component("YBR154C",179).
component("YPR175W",746).
component("YPL167C",717).
component("YOR330C",695).
component("YOL115W",668).
component("YNL299W",640).
component("YNL262W",636).
component("YNL102W",623).
component("YJR043C",493).
component("YJR006W",488).
component("YJL090C",471).
component("YIL139C",453).
component("YEL055C",306).
component("YDR419W",289).
component("YDR121W",259).
component("YDL102W",227).
component("YCR014C",205).
component("YBR278W",193).
component("YBL035C",152).
component("YPR113W",743).
component("YBR243C",186).
component("YPL148C",715).
component("YER026C",313).
component("YGR286C",402).
component("YHR189W",433).
component("YDR058C",255).
component("YDL086W",225).
component("YOL011W",654).
component("YMR008C",598).
component("YMR006C",597).
component("U105_",22).
component("YBL015W",150).
component("YJL068C",469).
component("YOR040W",674).
component("U77_",125).
component("YLR377C",577).
component("YPL179W",719).
component("YNR032W",647).
component("YML057W",591).
component("YML016C",586).
component("YLR433C",581).
component("YGR123C",385).
component("YER133W",332).
component("YER089C",328).
component("YDR436W",290).
component("YDR075W",257).
component("YDL188C",241).
component("YDL134C",229).
component("YDL047W",219).
component("YDL006W",213).
component("YBR125C",175).
component("YBL056W",155).
component("YPR073C",738).
component("YHR215W",438).
component("YDL024C",216).
component("YBR093C",170).
component("YBR092C",169).
component("YHR046C",416).
component("U9_",141).
component("YDL236W",245).
component("YPR073C",739).
component("YOR208W",688).
component("YNL053W",620).
component("YMR036C",601).
component("YIR026C",462).
component("YIL113W",449).
component("YFR028C",344).
component("YER075C",324).
component("YDL230W",244).
component("YBR276C",192).
component("U34_",92).
component("U33_",91).
component("U32_",90).
component("U31_",89).
...
component("U25_",85).
component("U24_",84).
component("YHR044C",415).
component("YHR043C",414).
component("YOR360C",701).
component("YKR031C",531).
component("YPL206C",722).
component("YGL027C",357).
component("YLR286C",567).
component("YJR153W",507).
component("YJL221C",487).
component("YJL216C",485).
component("YIL172C",460).
component("YGR292W",404).
component("YGR287C",403).
component("YBR299W",197).
component("YBR184W",182).
component("YIR019C",461).
component("YIL099W",447).
component("YDL037C",218).
component("YOR190W",686).
component("YLR300W",569).
component("YGR282C",401).
component("YDR261C",273).
component("YDR400W",285).
component("YML035C",588).
component("YJL070C",470).
component("YBR284W",194).
component("U106_",23).
component("YER043C",314).
component("YNL045W",618).
component("YGL037C",358).
component("YDR242W",271).
component("U53_",107).
component("YPR062W",737).
component("YMR120C",605).
component("YLR028C",544).
component("YHR144C",429).
component("YGR267C",400).
component("YBL033C",151).
component("YNL141W",626).
component("YLR245C",564).
component("YML035C",589).
component("YBR084W",167).
component("YJL126W",474).
component("U44_",99).
component("YDL100C",226).
component("U87_",133).
component("U40_",97).
component("U39_",95).
component("YBR011C",159).
component("YHR201C",435).
component("YBR111C",171).
component("YBR252W",189).
component("YER005W",311).
component("YBL099W",157).
component("YLR231C",563).
component("YDR538W",300).
component("YLR134W",552).
component("YLR044C",546).
component("YGR087C",382).
component("YDR380W",284).
component("YDL080C",223).
component("U98_",139).
component("YMR250W",610).
component("YOR128C",679).
component("YEL021W",302).
component("YNR043W",649).
component("U93_",136).
component("YKL211C",526) :- not remove_orf("YKL211C",526).
component("YKR097W",537).
component("YNL169C",629).
component("YNL256W",635).
component("YDR294C",275).
component("YEL046C",304).
component("YNR033W",648).
component("YKL211C",527) :- not remove_orf("YKL211C",527).
component("YER090W",527) :- not remove_orf("YER090W",527).
component("YER090W",329) :- not remove_orf("YER090W",329).
component("YDR127W",263).
component("YPL281C",733).
component("YOR393W",707).
component("YMR323W",614).
component("YHR174W",430).
component("YGR254W",397).
component("YPL262W",728).
component("YGL026C",356) :- not remove_orf("YGL026C",356).
component("YGR155W",386).
component("YLR304C",571).
component("YJL200C",483).
component("YNL316C",641).
component("YKL182W",523).
component("YPL212C",723).
component("YNL292W",639).
component("YGL063W",361).
component("YFL001W",336).
component("YPR002W",734).
component("YJR016C",491).
component("YCR053W",212).
component("YDR127W",264).
component("YGL148W",365).
component("YIL168W",459).
component("YIL167W",458).
component("YCL064C",203).
component("YER086W",326).
component("YLR359W",576).
component("YAL012W",142).
component("YML004C",584).
component("YFR055W",348).
component("YJL005W",465).
component("YJL121C",473).
component("YBR019C",161).
component("YDR050C",254).
component("YDR007W",247) :- not remove_orf("YDR007W",247).
component("YOR095C",677).
component("YER003C",310).
component("YBR196C",183).
component("YGL001C",350).
component("YPL117C",713).
component("U14_",40).
component("YOL056W",659).
component("YKL152C",519).
component("YDL021W",214).
component("YEL058W",307).
component("YPR060C",736).
component("YHR072W",420).
component("YPL097W",711).
component("YGR185C",390).
component("YGR264C",399).
component("YGR171C",388).
component("YPL104W",712).
component("YLL018C",538).
component("YPR081C",741).
component("YBR121C",174).
component("YHR020W",411).
component("YER087W",327).
component("YNL247W",632).
component("YOR168W",683).
component("YOL097C",666).
component("YDR268W",274).
component("YCR024C",206).
component("YHR019C",410).
component("YPL160W",716).
component("YLR382C",578).
component("YNL073W",622).
component("YOR335C",696).
component("YLR153C",556).
component("YAL054C",144).
component("YGR244C",396).
component("YIL145C",454).
component("YJL101C",472).
component("YOL049W",657).
component("YAR015W",146).
component("YER183C",335).
component("U90_",135).
component("YNR057C",650).
component("YDL141W",231).
component("YGL234W",372).
component("YDL141W",232).
component("YJR103W",500).
component("YBL039C",153).
component("YGR204W",393).
component("YBR084W",168).
component("YNL220W",630).
component("YOL058W",660).
component("YDL141W",233).
component("YHR074W",421).
component("YMR217W",609).
component("YGL062W",360).
component("YBR218C",184).
component("YPL231W",727).
component("YNR016C",645).
component("YKL182W",524).
component("YGR037C",378).
component("YPR138C",744).
component("YPL265W",729).
component("YPL134C",714).
component("YPL036W",710).
component("YOR348C",700).
component("YOR222W",690).
component("YOR171C",684).
component("YOR130C",680).
component("YOR011W",673).
component("YOL156W",672).
component("YOL103W",667).
component("YOL020W",656) :- not remove_orf("YOL020W",656).
component("YNR072W",652).
component("YNL270C",637).
component("YNL142W",627).
component("YMR011W",599).
component("YLR260W",566).
component("YLR138W",553).
component("YLR100C",551).
component("YLR081W",549).
component("YLL061W",541).
component("YKR093W",536).
component("YKR053C",533).
component("YKR039W",532) :- not remove_orf("YKR039W",532).
component("YJR158W",508).
component("YJR077C",498).
component("YJL219W",486).
component("YJL214W",484).
component("YJL134W",477).
component("YJL129C",475).
component("YIL134W",452).
component("YHR096C",424).
component("YHR094C",423).
component("YHR092C",422).
component("YHL036W",407).
component("YGR121C",384).
component("YGR065C",381).
component("YGR055W",379).
component("YGL186C",367).
component("YGL077C",363).
component("YGL008C",351).
component("YFL055W",341).
component("YFL011W",337).
component("YER060W-A",318).
component("YER060W",317).
component("YER056C",316).
component("YER053C",315).
component("YEL069C",309).
component("YEL063C",308).
component("YEL017C-A",301).
component("YDR536W",299).
component("YDR508C",296).
component("YDR503C",295).
component("YDR497C",293).
component("YDR345C",281).
component("YDR343C",280).
component("YDR342C",279).
component("YDR297W",276).
component("YDR046C",253) :- not remove_orf("YDR046C",253).
component("YDL245C",246).
component("YDL210W",242).
component("YCR032W",209).
component("YCR028C",208).
component("YCR024C-A",207).
component("YCL025C",200).
component("YBR298C",196).
component("YBR291C",195).
...
catalyst(6470,649).
catalyst(2300,136).
catalyst(3600,526) :- not remove_reaction(3600,526).
catalyst(8000,537).
catalyst(6890,629).
catalyst(2570,635).
catalyst(8781,275).
...
catalyst(4560,304).
catalyst(2550,648).
catalyst(1890,527) :- not remove_reaction(1890,527).
catalyst(3630,527) :- not remove_reaction(3630,527).
catalyst(1890,329) :- not remove_reaction(1890,329).
catalyst(3630,329) :- not remove_reaction(3630,329).
catalyst(3740,263).
catalyst(8231,733).
catalyst(8232,733).
catalyst(8231,707).
...
catalyst(8051,728).
catalyst(8052,728).
catalyst(3590,356) :- not remove_reaction(3590,356).
catalyst(10910,356) :- not remove_reaction(10910,356).
catalyst(4570,386).
catalyst(8181,571).
catalyst(8182,571).
catalyst(8181,483).
...
catalyst(640,536).
catalyst(6560,533).
catalyst(771,532) :- not remove_reaction(771,532).
catalyst(772,532) :- not remove_reaction(772,532).
catalyst(781,532) :- not remove_reaction(781,532).
catalyst(782,532) :- not remove_reaction(782,532).
catalyst(801,532) :- not remove_reaction(801,532).
catalyst(802,532) :- not remove_reaction(802,532).
catalyst(811,532) :- not remove_reaction(811,532).
catalyst(812,532) :- not remove_reaction(812,532).
catalyst(831,532) :- not remove_reaction(831,532).
catalyst(832,532) :- not remove_reaction(832,532).
catalyst(841,532) :- not remove_reaction(841,532).
catalyst(842,532) :- not remove_reaction(842,532).
catalyst(851,532) :- not remove_reaction(851,532).
catalyst(852,532) :- not remove_reaction(852,532).
catalyst(881,532) :- not remove_reaction(881,532).
catalyst(882,532) :- not remove_reaction(882,532).
catalyst(901,532) :- not remove_reaction(901,532).
catalyst(902,532) :- not remove_reaction(902,532).
catalyst(921,532) :- not remove_reaction(921,532).
catalyst(922,532) :- not remove_reaction(922,532).
catalyst(931,532) :- not remove_reaction(931,532).
catalyst(932,532) :- not remove_reaction(932,532).
catalyst(1191,532) :- not remove_reaction(1191,532).
catalyst(1192,532) :- not remove_reaction(1192,532).
catalyst(1180,508).
catalyst(1210,508).
catalyst(1581,498).
catalyst(1582,498).
