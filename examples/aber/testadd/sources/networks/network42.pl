...
component("YLR056W",260).
component("YKR009C",248).
component("YOL086C",317).
component("YMR303C",291).
component("YGL256W",177).
component("YDL168W",106).
component("YBR145W",79).
component("YPL231W",347).
component("U46_",48).
component("YBR149W",80).
component("YGL001C",159).
component("YIL094C",209).
component("U45_",47).
component("YDR127W",115).
component("YOL126C",321).
component("YKL085W",240).
component("YDL078C",100).
component("YNL037C",295).
component("YCL018W",91).
component("YLR355C",279).
component("YDL174C",107).
component("YML086C",284).
component("YGR088W",183).
component("YDR256C",125).
component("YJR078W",234).
component("YJR025C",229).
component("U107_",22).
component("YJL026W",217).
component("YGR180C",186).
component("YER070W",151).
component("U36_",44).
component("YPL276W",353).
component("YPL275W",352).
component("YOR388C",338).
component("YOR323C",332).
component("YIL125W",211).
component("U52_",51).
component("YBR166C",82).
component("YKL216W",247).
component("YKR009C",249).
component("YIL160C",214).
component("YGL205W",174).
component("YKR080W",253).
component("YER023W",146).
component("YGR204W",188).
component("YLR142W",265).
component("U65_",54).
component("U62_",53).
component("YHR068W",200).
component("YKL150W",243).
component("YIL043C",207).
component("YPL171C",346).
component("YHR179W",205).
component("YDR353W",129).
component("YNL052W",296).
component("YMR256C",290).
component("YLR395C",281).
component("YLR038C",258).
component("YIL111W",210).
component("YHR051W",199).
component("YGL191W",172).
component("YGL187C",171).
component("YDL067C",99).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",351).
component("YKR069W",252).
component("YJR073C",232).
component("YDL033C",98).
component("YLR172C",267).
component("YLR058C",261).
component("YDR019C",110).
component("YBR176W",83).
component("YDR408C",134).
component("YMR120C",288).
component("YLR028C",256).
component("YBL013W",65).
component("YJL130C",222).
component("YKL024C",238).
component("YPR074C",357).
component("YBR117C",78).
component("YCL009C",90).
component("U48_",49).
component("YPL231W",348).
component("YPL231W",349).
component("YLR299W",274).
component("YGL017W",162).
component("YML126C",285).
component("YDL182W",108).
component("YDL131W",103).
component("YLR258W",272).
component("YFR015C",156).
component("YNL029C",294).
component("YIL085C",208).
component("YMR306W",292).
component("YLR342W",278).
component("YGR032W",179).
component("YLR209C",268).
component("U104_",20).
component("YDR354W",130) :- not remove_orf("YDR354W",130).
component("YFR047C",157).
component("YLR209C",269).
component("YML022W",282).
component("YDR441C",136).
component("YJL167W",226).
component("YDR127W",116).
component("YLR303W",276).
component("YGR012W",178).
component("YJR130C",236).
component("YDR035W",111).
component("YBR249C",85).
component("YOR274W",331).
component("YHR137W",201).
component("YGL202W",173).
component("YLR027C",255).
component("YKL106W",241).
component("YLR089C",262).
component("YJR148W",237).
component("YNR058W",311).
component("YGL253W",176).
component("YFR053C",158).
component("YCR036W",96).
component("U96_",61).
component("YDR236C",123).
component("YHL032C",194).
component("YNR012W",309).
component("YDR127W",117).
component("YDR147W",120).
component("U76_",59).
component("YDR226W",122).
component("YKL067W",239).
component("YOL055C",315).
component("YDR454C",137).
component("YOL061W",316).
component("YKL181W",244).
component("YHL011C",193).
component("YER099C",153).
component("YBL068W",69).
component("YNL256W",303).
component("YBR018C",72).
component("YBR029C",74).
component("YGL130W",168).
component("YPR190C",363).
component("YPR187W",362).
component("YPR110C",358).
component("YPR010C",355).
component("YOR341W",336).
component("YOR340C",335).
component("YOR224C",330).
component("YOR210W",329).
component("YOR207C",328).
component("YOR151C",325).
component("YOR116C",324).
component("YOL005C",312).
component("YNR003C",308).
component("YNL248C",302).
component("YNL151C",301).
component("YNL113W",298).
component("YKL144C",242).
component("YJR063W",231).
component("YJL148W",225).
component("YJL140W",224).
component("YIL021W",206).
component("YHR143W-A",202).
component("YGL070C",166).
component("YFL036W",154).
component("YDR404C",133).
component("YDR156W",121).
component("YDR045C",112).
component("YDL150W",105).
component("YDL140C",104).
component("YBR154C",81).
component("YPR175W",361).
component("YPL167C",345).
component("YOR330C",333).
component("YOL115W",320).
component("YNL299W",306).
component("YNL262W",304).
component("YNL102W",297).
component("YJR043C",230).
component("YJR006W",228).
component("YJL090C",219).
component("YIL139C",212).
component("YEL055C",143).
component("YDR419W",135).
component("YDR121W",114).
component("YDL102W",102).
component("YCR014C",94).
component("YBR278W",87).
component("YBL035C",67).
component("YPR113W",359).
component("YPL148C",344).
component("YGR286C",192).
component("YOL011W",313).
component("YMR008C",287).
component("YMR006C",286).
component("U105_",21).
component("YBL015W",66).
component("YLR377C",280).
component("U30_",43).
component("U29_",42).
component("U24_",41).
component("YHR044C",198).
component("YHR043C",197).
component("YOR360C",337).
component("YGL027C",164).
component("YOR190W",327).
component("YLR300W",275).
component("YGR282C",191).
component("YDR261C",126).
component("YDR400W",132).
component("YML035C",283).
component("YJL070C",218).
component("YBR284W",88).
component("YDR242W",124).
component("U53_",52).
component("YMR120C",289).
component("YLR028C",257).
component("YHR144C",203).
component("YNL141W",299).
component("YLR245C",271).
component("YJL126W",220).
component("U39_",45).
component("YBR011C",71).
component("YBR111C",77).
component("YBR252W",86).
component("YER005W",145).
component("YBL099W",70).
component("YLR231C",270).
component("YLR134W",264).
component("YLR044C",259).
component("YGR087C",182).
component("YDR380W",131).
component("YDL080C",101).
component("U98_",62).
component("YKL211C",245) :- not remove_orf("YKL211C",245).
component("YKL211C",246) :- not remove_orf("YKL211C",246).
component("YER090W",246) :- not remove_orf("YER090W",246).
component("YER090W",152) :- not remove_orf("YER090W",152).
component("YDR127W",118).
component("YPL281C",354).
component("YOR393W",339).
component("YMR323W",293).
component("YHR174W",204).
component("YGR254W",189).
component("YGL026C",163) :- not remove_orf("YGL026C",163).
component("YLR304C",277).
component("YJL200C",227).
component("YNL316C",307).
component("YCR053W",97).
component("YDR127W",119).
component("YGL148W",169).
component("YIL168W",216).
component("YIL167W",215).
component("YCL064C",93).
component("YAL012W",63).
component("YBR019C",73).
component("YDR007W",109) :- not remove_orf("YDR007W",109).
component("YOR095C",323).
component("YGL001C",160).
component("YPL117C",343).
component("YPR060C",356).
component("YPL097W",341).
component("YGR185C",187).
component("YGR264C",190).
component("YGR171C",185).
component("YPL104W",342).
component("YLL018C",254).
component("YOL097C",318).
component("YDR268W",127).
component("YHR019C",196).
component("YOR335C",334).
component("YLR153C",266).
component("YAL054C",64).
component("YIL145C",213).
component("U90_",60).
component("YNR057C",310).
component("YGL234W",175).
component("YJR103W",235).
component("YBL039C",68).
component("YGL062W",165).
component("YBR218C",84).
component("YPR138C",360).
component("YPL265W",350).
component("YPL036W",340).
component("YOR171C",326).
component("YOR011W",322).
component("YOL103W",319).
component("YOL020W",314) :- not remove_orf("YOL020W",314).
component("YNL270C",305).
component("YNL142W",300).
component("YLR260W",273).
component("YLR100C",263).
component("YKR053C",251).
component("YKR039W",250) :- not remove_orf("YKR039W",250).
component("YJR077C",233).
component("YJL134W",223).
component("YJL129C",221).
component("YHL036W",195).
component("YGR121C",184).
component("YGR065C",181).
component("YGR055W",180).
component("YGL186C",170).
component("YGL077C",167).
component("YGL008C",161).
component("YFL055W",155).
component("YER060W-A",150).
component("YER060W",149).
component("YER056C",148).
component("YER053C",147).
component("YEL063C",144).
component("YEL017C-A",142).
component("YDR536W",141).
component("YDR508C",140).
component("YDR503C",139).
component("YDR497C",138).
component("YDR297W",128).
component("YDR046C",113) :- not remove_orf("YDR046C",113).
component("YCR024C-A",95).
component("YCL025C",92).
...
catalyst(2121,20).
catalyst(2122,20).
catalyst(3620,130) :- not remove_reaction(3620,130).
catalyst(2190,157).
catalyst(5791,269).
catalyst(5792,269).
catalyst(5801,269).
...
catalyst(8812,101).
catalyst(2250,62).
catalyst(3600,245) :- not remove_reaction(3600,245).
catalyst(3630,246) :- not remove_reaction(3630,246).
catalyst(3630,152) :- not remove_reaction(3630,152).
catalyst(3740,118).
catalyst(8231,354).
catalyst(8232,354).
catalyst(8231,339).
...
catalyst(8231,189).
catalyst(8232,189).
catalyst(3590,163) :- not remove_reaction(3590,163).
catalyst(10910,163) :- not remove_reaction(10910,163).
catalyst(8181,277).
catalyst(8182,277).
catalyst(8181,227).
catalyst(8182,227).
...
catalyst(7751,73).
catalyst(7752,73).
catalyst(3610,109) :- not remove_reaction(3610,109).
catalyst(7921,323).
catalyst(7922,323).
catalyst(6370,160).
catalyst(6461,343).
...
catalyst(781,250) :- not remove_reaction(781,250).
catalyst(782,250) :- not remove_reaction(782,250).
...
catalyst(881,250) :- not remove_reaction(881,250).
catalyst(882,250) :- not remove_reaction(882,250).
catalyst(901,250) :- not remove_reaction(901,250).
catalyst(902,250) :- not remove_reaction(902,250).
catalyst(931,250) :- not remove_reaction(931,250).
catalyst(932,250) :- not remove_reaction(932,250).
catalyst(1191,250) :- not remove_reaction(1191,250).
catalyst(1192,250) :- not remove_reaction(1192,250).
catalyst(1581,233).
catalyst(1582,233).
catalyst(6560,223).
catalyst(361,221).
...
catalyst(851,113) :- not remove_reaction(851,113).
catalyst(852,113) :- not remove_reaction(852,113).
catalyst(901,113) :- not remove_reaction(901,113).
catalyst(902,113) :- not remove_reaction(902,113).
catalyst(220,95).
catalyst(771,92).
catalyst(772,92).
catalyst(781,92).
...
catalyst(901,76) :- not remove_reaction(901,76).
catalyst(902,76) :- not remove_reaction(902,76).
...
catalyst(841,75) :- not remove_reaction(841,75).
catalyst(842,75) :- not remove_reaction(842,75).
catalyst(851,75) :- not remove_reaction(851,75).
catalyst(852,75) :- not remove_reaction(852,75).
catalyst(901,75) :- not remove_reaction(901,75).
catalyst(902,75) :- not remove_reaction(902,75).
catalyst(2920,58).
catalyst(2920,57).
catalyst(2920,56).
catalyst(2920,55).
