...
component("YNL280C",908).
component("YLR056W",774).
component("YGR060W",539).
component("YGL012W",505).
component("YKR009C",750).
component("YOL086C",943).
component("YMR303C",875).
component("YMR083W",848).
component("YGL256W",531).
component("YDL168W",344).
component("YBR145W",267).
component("YPL231W",1036).
component("YBR265W",286).
component("U46_",160).
component("YBR149W",268).
component("YBR149W",269).
component("YJR159W",713).
component("YGL001C",501).
component("YIL094C",631).
component("YHR063C",594).
component("U45_",159).
component("YML056C",829).
component("YLR432W",818).
component("YHR216W",619).
component("YAR075W",222).
component("YAR073W",221).
component("YDR127W",380).
component("YJR139C",708).
component("YML075C",832).
component("YLR450W",821).
component("YOL126C",949).
component("YKL085W",724).
component("YDL078C",323).
component("YKL029C",719).
component("YOR136W",968).
component("YNL037C",881).
component("YNL009W",879).
component("YLR174W",788).
component("YHR183W",612).
component("YGR256W",570).
component("YNL241C",897).
component("YOL059W",940).
component("YDL022W",314).
component("YCL018W",294).
component("YLR355C",813).
component("YIL074C",628).
component("YER081W",466).
component("YML054C",828).
component("YDL174C",348).
component("YML086C",834).
component("YIL155C",641).
component("YPR191W",1077).
component("YOR065W",958).
component("YJL166W",677).
component("YHR001W-A",581).
component("YGR183C",555).
component("YFR033C",497).
component("YEL024W",434).
component("YDR529C",425).
component("YBL045C",230).
component("Q0105",19).
component("YKR066C",755).
component("YGR088W",543).
component("YDR256C",396).
component("YKL026C",718).
component("YIR037W",653).
component("YBR244W",281).
component("YJR078W",700).
component("U58_",169).
component("YJR025C",691).
component("U107_",28).
component("YGR255C",569).
component("U108_",29).
component("YHR007C",582).
component("YDR402C",412).
component("YGL055W",512).
component("YJR104C",703).
component("YHR008C",583).
component("YOR384W",1005).
component("YOR381W",1004).
component("YOL152W",953).
component("YLL051C",766).
component("YJL026W",655).
component("YIL066C",627).
component("YGR180C",554).
component("YER070W",463).
component("U37_",151).
component("U36_",150).
component("U35_",149).
component("YDL168W",345).
component("YDR158W",388).
component("YJR009C",687).
component("YJL052W",657).
component("YGR192C",557).
component("YBR006W",239).
component("YPL276W",1047).
component("YPL275W",1046).
component("YOR388C",1006).
component("YPL061W",1015).
component("YOR374W",1001).
component("YER073W",464).
component("YGL154C",521).
component("YBR115C",262).
component("U55_",168).
component("YER069W",461).
component("YOR323C",991).
component("YMR170C",858).
component("YMR169C",857).
component("U2_",143).
component("YER178W",480).
component("YBR221C",279).
component("YIL125W",637).
component("U52_",165).
component("YBR166C",272).
component("YNL280C",909).
component("YGL012W",506).
component("YKL182W",736).
component("YKL216W",747).
component("YDR044W",363).
component("YER014W",445).
component("YKR009C",751).
component("YIL160C",643).
component("YGL205W",526).
component("YMR118C",852).
component("YLR164W",786).
component("YLL041C",764).
component("YKL148C",730).
component("YKL141W",728).
component("YJL045W",656).
component("YDR178W",390).
component("YJR051W",694).
component("YEL047C",438).
component("YDL171C",346).
component("YDL171C",347).
component("YOR375C",1002).
component("YDL215C",352).
component("YAL062W",217).
component("U99_",210).
component("U100_",22).
component("YBR035C",248).
component("YMR189W",860).
component("YKR080W",757).
component("YER023W",447).
component("YPL023C",1010).
component("YGL125W",518).
component("YOR236W",986).
component("YGR204W",561).
component("YBR084W",255).
component("YIR034C",652).
component("YLR142W",783).
component("U65_",177).
component("U63_",175).
component("U62_",174).
component("YOR356W",999).
component("YHR068W",595).
component("YKL150W",731).
component("YIL043C",624).
component("YHR042W",589).
component("YOR221C",983).
component("YMR145C",855).
component("YML120C",836).
component("YKL192C",740).
component("YKL055C",721).
component("YER061C",457).
component("YDL085W",325).
component("YPL171C",1025).
component("YHR179W",611).
component("YMR145C",856).
component("YML120C",837).
component("YKL192C",741).
component("YDL085W",326).
component("YGR234W",564).
component("YFR030W",496).
component("YPL017C",1009).
component("YFL018C",484).
component("YPL091W",1017).
component("YDR353W",407).
component("YER042W",449).
component("YPR167C",1071).
component("YJR137C",707).
component("YNL052W",883).
component("YMR256C",869).
component("YLR395C",817).
component("YLR038C",772).
component("YIL111W",634).
component("YHR051W",593).
component("YGL191W",524).
component("YGL187C",523).
component("YDL067C",322).
component("Q0275",21).
component("Q0250",20).
component("Q0045",18).
component("YDR072C",372).
component("YPL266W",1043).
component("YPL273W",1045).
component("YLL062C",768).
component("YDR410C",415).
component("YKR069W",756).
component("YOL096C",944).
component("U47_",161).
component("YER091C",471).
component("YJR073C",698).
component("YGR157W",550).
component("YDR120C",378).
component("YML008C",823).
component("YOR074C",960).
component("YDL033C",316).
component("YOL096C",945).
component("YLR172C",787).
component("YLR058C",775).
component("YDR019C",359).
component("YBR176W",273).
component("YDR408C",414).
component("YMR120C",853).
component("YLR028C",770).
component("YBL013W",223).
component("YJL130C",669).
component("YJL088W",662).
component("YKL024C",716).
component("YPR074C",1062).
component("YBR117C",263).
component("YLR354C",812).
component("YGR043C",537).
component("YMR108W",851).
component("YCL009C",293).
component("YMR062C",846).
component("YNL071W",885).
component("YNR008W",916).
component("YIL160C",644).
component("YNR019W",919).
component("YCR048W",309).
component("U48_",162).
component("YNL277W",907).
component("YMR062C",847).
component("YDR232W",393).
component("YPL231W",1037).
component("YER061C",458).
component("YPL001W",1008).
component("YDL052C",320).
component("U8_",202).
component("YDR148C",386).
component("YAR035W",219).
component("YOR377W",1003).
component("YGR177C",553).
component("YPL231W",1038).
component("YPL028W",1011).
component("YLR299W",799).
component("YGL017W",507).
component("YPR001W",1049).
component("YNR001C",914).
component("YCR005C",301).
component("YML126C",838).
component("YNL104C",888).
component("YDL182W",349).
component("YDL131W",335).
component("YPR160W",1070).
component("YOR321W",990).
component("YJR143C",709).
component("YGR199W",559).
component("YDR307W",403).
component("YDL095W",330).
component("YDL093W",329).
component("YAL023C",213).
component("YLR258W",796).
component("YFR015C",492).
component("YPL227C",1034).
component("YNL029C",880).
component("YIL085C",630).
component("YNL192W",895).
component("YBR038W",250).
component("YBR023C",246).
component("YEL011W",430).
component("YMR306W",877).
component("YLR342W",810).
component("YGR032W",535).
component("YPR183W",1074).
component("YBR248C",282).
component("YLR209C",790).
component("U104_",25).
component("U103_",24).
component("YMR271C",870).
component("YML106W",835).
component("YOR209C",981).
component("YMR300C",874).
component("YER055C",453).
component("YDR354W",408) :- not remove_orf("YDR354W",408).
component("YFR047C",498).
component("YJR133W",706).
component("U22_",135).
component("YLR209C",791).
component("YML022W",825).
component("YDR441C",418).
component("YHR128W",604).
component("YPR176C",1073).
component("YPL172C",1026).
component("YNR041C",923).
component("YMR101C",849).
component("YDL090C",328).
component("YBR003W",238).
component("YBR002C",237).
component("YJL167W",678).
component("YJL167W",679).
component("YNL256W",900).
component("YPR069C",1059).
component("YDR127W",381).
component("YHR190W",614).
component("YLR146C",784).
component("YPL214C",1032).
component("YHR068W",596).
component("YLR303W",801).
component("YGR012W",533).
component("YML082W",833).
component("YJR130C",705).
component("YLR303W",802).
component("YDR035W",361).
component("YBR249C",283).
component("YLR180W",789).
component("YDR502C",422).
component("YOR274W",987).
component("YOL143C",952).
component("YBR256C",285).
component("YHR137W",605).
component("YGL202W",525).
component("YLR027C",769).
component("YKL106W",725).
component("YOL140W",951).
component("YLR438W",820).
component("YGR019W",534).
component("YLR089C",779).
component("YDR111C",377).
component("U64_",176).
component("U61_",173).
component("U51_",164).
component("YJR148W",710).
component("YHR208W",617).
component("YFL030W",486).
component("YOR184W",974).
component("YNR058W",927).
component("YIL116W",636).
component("YGL253W",530).
component("YFR053C",499).
component("YOL136C",950).
component("YIL107C",633).
component("YMR013C",842).
component("YMR205C",862).
component("YGR240C",565).
component("YOL016C",931).
component("YFR014C",491).
component("YLR240W",794).
component("YKL203C",743).
component("YJR066W",697).
component("YCR036W",308).
component("YGR194C",558).
component("YCL040W",297).
component("U15_",72).
component("YPL188W",1028).
component("YJR049C",693).
component("YEL041W",435).
component("U96_",208).
component("YKL001C",714).
component("YDR236C",394).
component("YML070W",831).
component("YFL053W",488).
component("YHL032C",579).
component("YDR531W",427).
component("U83_",196).
component("U82_",195).
component("U81_",194).
component("YMR208W",863).
component("YPL203W",1029).
component("YOR061W",957).
component("YKL166C",733).
component("YJL164C",676).
component("YIL035C",623).
component("YHR205W",616).
component("YHR102W",602).
component("YGL019W",508).
component("YHR025W",588).
component("YOR347C",997).
component("YAL038W",215).
component("YNR012W",917).
component("YPR121W",1067).
component("YPL258C",1040).
component("YOL055C",936).
component("YPL214C",1033).
component("U1_",112).
component("YDR009W",358).
component("YNL267W",904).
component("YLR305C",804).
component("YFR019W",493).
component("YDR208W",391).
component("YDR127W",382).
component("U21_",126).
component("U20_",121).
component("YDR147W",385).
component("YDR300C",402).
component("YCR012W",302).
component("YER052C",451).
component("YER069W",462).
component("U19_",111).
component("YKL024C",717).
component("U18_",100).
component("U17_",89).
component("U76_",188).
component("YMR220W",865).
component("YER170W",479).
component("YDR226W",392).
component("YKL067W",723).
component("YOL055C",937).
component("YDR454C",419).
component("YJR057W",695).
component("YOL061W",941).
component("YKL181W",735).
component("YHL011C",577).
component("YER099C",473).
component("YBL068W",233).
component("YOR143C",970).
component("YNL256W",901).
component("YLR328W",808).
component("YBR018C",241).
component("YBR018C",242).
component("YGR007W",532).
component("YGR202C",560).
component("YLR328W",809).
component("YKR002W",749).
component("YDL045C",318).
component("U80_",193).
component("YDL103C",333).
component("U94_",207).
component("YJR010W",688).
component("YBR029C",247).
component("YCL050C",298).
component("YGL130W",519).
component("YDR530C",426).
component("YCL050C",299).
component("YPR190C",1076).
component("YPR187W",1075).
component("YPR110C",1065).
component("YPR010C",1052).
component("YOR341W",996).
component("YOR340C",995).
component("YOR224C",985).
component("YOR210W",982).
component("YOR207C",979).
component("YOR151C",971).
component("YOR116C",963).
component("YOL005C",929).
component("YNR003C",915).
component("YNL248C",899).
component("YNL151C",892).
component("YNL113W",889).
component("YKL144C",729).
component("YJR063W",696).
component("YJL148W",673).
component("YJL140W",672).
component("YIL021W",622).
component("YHR143W-A",606).
component("YGL070C",516).
component("YFL036W",487).
component("YDR404C",413).
component("YDR156W",387).
component("YDR045C",364).
component("YDL150W",343).
component("YDL140C",337).
component("YBR154C",271).
component("YPR175W",1072).
component("YPL167C",1024).
component("YOR330C",992).
component("YOL115W",948).
component("YNL299W",911).
component("YNL262W",903).
component("YNL102W",887).
component("YJR043C",692).
component("YJR006W",686).
component("YJL090C",663).
component("YIL139C",639).
component("YEL055C",439).
component("YDR419W",416).
component("YDR121W",379).
component("YDL102W",332).
component("YCR014C",303).
component("YBR278W",288).
component("YBL035C",227).
component("YKL035W",720).
component("YHL012W",578).
component("YHR123W",603).
component("YPR113W",1066).
component("YBR243C",280).
component("YDL142C",342).
component("YPL148C",1022).
component("YER026C",448).
component("YGR286C",574).
component("YJL068C",658).
component("YHR189W",613).
component("YDR058C",369).
component("YNR034W",922).
component("YHR163W",609).
component("YGR248W",567).
component("YCR073W-A",311).
component("YDL086W",327).
component("YOL011W",930).
component("YMR008C",840).
component("YMR006C",839).
component("U105_",26).
component("YBL015W",224).
component("YJL068C",659).
component("YPL072W",1016).
component("YOR124C",964).
component("YNL186W",894).
component("YMR304W",876).
component("YMR223W",866).
component("YKR098C",761).
component("YJL197W",680).
component("YIL156W",642).
component("YFR010W",490).
component("YER151C",477).
component("YER144C",476).
component("YER098W",472).
component("YDR069C",371).
component("YDL122W",334).
component("YBR058C",251).
component("YBL067C",232).
component("YJR019C",690).
component("YOR040W",956).
component("U84_",197).
component("U77_",189).
component("YDR481C",420).
component("YLR377C",815).
component("YDR074W",373).
component("YFR025C",494).
component("YPL179W",1027).
component("YNR032W",920).
component("YML057W",830).
component("YML016C",824).
component("YLR433C",819).
component("YGR123C",546).
component("YER133W",475).
component("YER089C",469).
component("YDR436W",417).
component("YDR075W",374).
component("YDL188C",350).
component("YDL134C",336).
component("YDL047W",319).
component("YDL006W",312).
component("YBR125C",266).
component("YBL056W",231).
component("YPR073C",1060).
component("YHR215W",618).
component("YDL024C",315).
component("YBR093C",260).
component("YBR092C",259).
component("YAR071W",220).
component("YIL053W",626).
component("YER062C",459).
component("YHR046C",592).
component("U9_",211).
component("YPL228W",1035).
component("YMR180C",859).
component("YDL236W",354).
component("YJL155C",675).
component("YPR073C",1061).
component("YOR208W",980).
component("YNL053W",884).
component("YMR036C",844).
component("YIR026C",650).
component("YIL113W",635).
component("YFR028C",495).
component("YER075C",465).
component("YDL230W",353).
...
component("U25_",138).
component("U24_",137).
component("YHR044C",591).
component("YHR043C",590).
component("YOL064C",942).
component("YPL268W",1044).
component("YOR360C",1000).
component("YGL248W",529).
component("YKR031C",752).
component("YPL206C",1030).
component("YGL027C",510).
component("YLR286C",798).
component("YJR153W",711).
component("YJL221C",685).
component("YJL216C",683).
component("YIL172C",648).
component("YGR292W",576).
component("YGR287C",575).
component("YBR299W",292).
component("YBR184W",274).
component("YIL162W",645).
component("YPR026W",1053).
component("YDR001C",356).
component("YBR001C",236).
component("YIR019C",649).
component("YIL099W",632).
component("YDL037C",317).
component("YOR190W",976).
component("YLR300W",800).
component("YGR282C",573).
component("YDR261C",397).
component("YDR400W",411).
component("U23_",136).
component("YML035C",826).
component("YJL070C",660).
component("YBR284W",289).
component("U106_",27).
component("U102_",23).
component("YER043C",450).
component("YNL045W",882).
component("YGL037C",511).
component("U43_",157).
component("U42_",156).
component("YMR293C",873).
component("YDR242W",395).
component("YLR308W",807).
component("YLR307W",806).
component("YBR208C",276).
component("YMR281W",872).
component("U53_",166).
component("YIR032C",651).
component("YPR062W",1058).
component("YMR120C",854).
component("YLR028C",771).
component("YHR144C",607).
component("YHR144C",608).
component("YGR267C",572).
component("YCL030C",296).
component("YBL033C",226).
component("YBR153W",270).
component("YNL141W",890).
component("YLR245C",795).
component("YML035C",827).
component("YGR204W",562).
component("YBR084W",256).
component("YJL126W",667).
component("U44_",158).
component("YDL100C",331).
component("U87_",199).
component("U40_",154).
component("U39_",152).
component("YBR011C",240).
component("YHR201C",615).
component("YBR111C",261).
component("YBR252W",284).
component("YEL042W",436).
component("YPR080W",1063).
component("YOR187W",975).
component("YOR133W",967).
component("YLR069C",777).
component("YKR084C",758).
component("YKL173W",734).
component("YJL102W",665).
component("YDR385W",410).
component("YBR118W",264).
component("YER005W",444).
component("YLL001W",762).
component("YIL048W",625).
component("YER166W",478).
component("YDR093W",376).
component("YAL026C",214).
component("YBL099W",235).
component("U60_",172).
component("YLR231C",792).
component("U88_",200).
component("YDR538W",429).
component("YLR134W",781).
component("YLR044C",773).
component("YGR087C",542).
component("YDR380W",409).
component("YDL080C",324).
component("U98_",209).
component("YMR250W",868).
component("YKL184W",739).
component("YOR128C",965).
component("YEL021W",433).
component("YNR043W",924).
component("U93_",206).
component("YDR047W",366).
component("U54_",167).
component("YKL211C",745) :- not remove_orf("YKL211C",745).
component("YKR097W",760).
component("YOL052C",935).
component("YNL169C",893).
component("YGR170W",551).
component("YKL060C",722).
component("YNL256W",902).
component("YDR294C",400).
component("YEL046C",437).
component("YNR033W",921).
component("YPR006C",1051).
component("YER065C",460).
component("YKL211C",746) :- not remove_orf("YKL211C",746).
component("YER090W",746) :- not remove_orf("YER090W",746).
component("YER090W",470) :- not remove_orf("YER090W",470).
component("YDR127W",383).
component("YPL281C",1048).
component("YOR393W",1007).
component("YMR323W",878).
component("YHR174W",610).
component("YGR254W",568).
component("YOR202W",978).
component("YPL262W",1041).
component("YGL026C",509) :- not remove_orf("YGL026C",509).
component("YGR155W",549).
component("YLR304C",803).
component("YJL200C",681).
component("YGL009C",504).
component("YNL316C",912).
component("YKL182W",737).
component("YPL212C",1031).
component("YNL292W",910).
component("YGL063W",515).
component("YFL001W",482).
component("YOR278W",988).
component("YPR002W",1050).
component("YJR016C",689).
component("YCR053W",310).
component("YDR127W",384).
component("YGL148W",520).
component("YIL168W",647).
component("YIL167W",646).
component("YCL064C",300).
component("YER086W",467).
component("YLR359W",814).
component("YAL012W",212).
component("YML004C",822).
component("YFR055W",500).
component("YJL005W",654).
component("YJL121C",666).
component("YBR019C",243).
component("YBR019C",244).
component("U59_",170).
component("YDR050C",367).
component("YIL020C",621).
component("YDR007W",357) :- not remove_orf("YDR007W",357).
component("YOR095C",961).
component("YER003C",443).
component("YBR196C",275).
component("YGL001C",502).
component("YPL117C",1020).
component("U14_",64).
component("YOL056W",938).
component("YKL152C",732).
component("YDL021W",313).
component("YMR105C",850).
component("YKL127W",727).
component("YEL058W",440).
component("YPR060C",1057).
component("YHR072W",597).
component("YJL153C",674).
component("YPL097W",1018).
component("YGR185C",556).
component("YGR264C",571).
component("YGR171C",552).
component("YHR011W",584).
component("YDR023W",360).
component("YPL104W",1019).
component("YLL018C",763).
component("YPR081C",1064).
component("YBR121C",265).
component("YHR020W",587).
component("YER087W",468).
component("YNL247W",898).
component("YOL033W",933).
component("YOR168W",972).
component("YOL097C",946).
component("YDR268W",398).
component("YPR047W",1056).
component("YLR060W",776).
component("YFL022C",485).
component("YPR033C",1054).
component("YHR019C",585).
component("YCR024C",304).
component("YHR019C",586).
component("YKL194C",742).
component("YIL078W",629).
component("YPL160W",1023).
component("YLR382C",816).
component("YPL040C",1013).
component("YBL076C",234).
component("YNL073W",886).
component("YDR037W",362).
component("YOR335C",993).
component("YGR094W",544).
component("YLR153C",785).
component("YAL054C",216).
component("YOR317W",989).
component("YMR246W",867).
component("YIL009W",620).
component("YER015W",446).
component("YOR142W",969).
component("YGR244C",566).
component("YPR035W",1055).
component("YIL145C",640).
component("U89_",201).
component("YOR339C",994).
component("YMR022W",843).
component("YLR306W",805).
component("YKL210W",744).
component("YGR133W",548).
component("YGL058W",513).
component("YER100W",474).
component("YEL012W",431).
component("YDR177W",389).
component("YDR092W",375).
component("YDR059C",370).
component("YDR054C",368).
component("YDL064W",321).
component("YBR082C",254).
component("YJL101C",664).
component("YOL049W",934).
component("U92_",205).
component("YAR015W",218).
component("YGL234W",527).
component("YER183C",481).
component("U91_",204).
component("U90_",203).
component("YNR057C",926).
component("YDL141W",338).
component("YDL141W",339).
component("YGL234W",528).
component("YDL141W",340).
component("YJR103W",702).
component("YBL039C",228).
component("YGR204W",563).
component("YBR084W",257).
component("YNL220W",896).
component("YOL058W",939).
component("YBR208C",277).
component("YDL141W",341).
component("YHR074W",598).
component("YMR217W",864).
component("YGR061C",540).
component("YPR145W",1069).
component("YGR124W",547).
component("YJR109C",704).
component("YJL130C",670).
component("YGL062W",514).
component("YBR218C",278).
component("YPL231W",1039).
component("YNR016C",918).
component("YKL182W",738).
component("YGR037C",536).
component("YJL087C",661).
component("YPR138C",1068).
component("YPL265W",1042).
component("YPL134C",1021).
component("YPL057C",1014).
component("YPL036W",1012).
component("YOR348C",998).
component("YOR222W",984).
component("YOR192C",977).
component("YOR171C",973).
component("YOR130C",966).
component("YOR100C",962).
component("YOR071C",959).
component("YOR011W",955).
component("YOL156W",954).
component("YOL103W",947).
component("YOL020W",932) :- not remove_orf("YOL020W",932).
component("YNR072W",928).
component("YNR056C",925).
component("YNL318C",913).
component("YNL270C",906).
component("YNL268W",905).
component("YNL142W",891).
component("YMR272C",871).
component("YMR202W",861).
component("YMR056C",845).
component("YMR011W",841).
component("YLR348C",811).
component("YLR260W",797).
component("YLR237W",793).
component("YLR138W",782).
component("YLR100C",780).
component("YLR081W",778).
component("YLL061W",767).
component("YLL043W",765).
component("YKR093W",759).
component("YKR053C",754).
component("YKR039W",753) :- not remove_orf("YKR039W",753).
component("YKL217W",748).
component("YKL120W",726).
component("YKL004W",715).
component("YJR158W",712).
component("YJR095W",701).
component("YJR077C",699).
component("YJL219W",684).
component("YJL214W",682).
component("YJL134W",671).
component("YJL129C",668).
component("YIL134W",638).
component("YHR096C",601).
component("YHR094C",600).
component("YHR092C",599).
component("YHL036W",580).
component("YGR121C",545).
component("YGR065C",541).
component("YGR055W",538).
component("YGL186C",522).
component("YGL077C",517).
component("YGL008C",503).
component("YFL055W",489).
component("YFL011W",483).
component("YER060W-A",456).
component("YER060W",455).
component("YER056C",454).
component("YER053C",452).
component("YEL069C",442).
component("YEL063C",441).
component("YEL017C-A",432).
component("YDR536W",428).
component("YDR508C",424).
component("YDR503C",423).
component("YDR497C",421).
component("YDR345C",406).
component("YDR343C",405).
component("YDR342C",404).
component("YDR297W",401).
component("YDR284C",399).
component("YDR046C",365) :- not remove_orf("YDR046C",365).
component("YDL245C",355).
component("YDL210W",351).
component("YCR032W",307).
component("YCR028C",306).
component("YCR024C-A",305).
...
catalyst(6160,874).
catalyst(3870,453).
catalyst(3620,408) :- not remove_reaction(3620,408).
catalyst(2110,498).
catalyst(2190,498).
catalyst(5550,706).
catalyst(5301,135).
...
catalyst(1960,366).
catalyst(3460,167).
catalyst(3600,745) :- not remove_reaction(3600,745).
catalyst(8000,760).
catalyst(3941,935).
catalyst(3942,935).
catalyst(6890,893).
...
catalyst(8020,1051).
catalyst(8020,460).
catalyst(1890,746) :- not remove_reaction(1890,746).
catalyst(3630,746) :- not remove_reaction(3630,746).
catalyst(1890,470) :- not remove_reaction(1890,470).
catalyst(3630,470) :- not remove_reaction(3630,470).
catalyst(3740,383).
catalyst(8231,1048).
catalyst(8232,1048).
catalyst(8231,1007).
...
catalyst(8061,1041).
catalyst(8062,1041).
catalyst(3590,509) :- not remove_reaction(3590,509).
catalyst(10910,509) :- not remove_reaction(10910,509).
catalyst(4570,549).
catalyst(8181,803).
catalyst(8182,803).
catalyst(8181,681).
...
catalyst(8282,367).
catalyst(3840,621).
catalyst(3610,357) :- not remove_reaction(3610,357).
catalyst(7921,961).
catalyst(7922,961).
catalyst(7841,443).
catalyst(7842,443).
...
catalyst(1210,954).
catalyst(1160,947).
catalyst(801,932) :- not remove_reaction(801,932).
catalyst(802,932) :- not remove_reaction(802,932).
catalyst(811,932) :- not remove_reaction(811,932).
catalyst(812,932) :- not remove_reaction(812,932).
catalyst(831,932) :- not remove_reaction(831,932).
catalyst(832,932) :- not remove_reaction(832,932).
catalyst(901,932) :- not remove_reaction(901,932).
catalyst(902,932) :- not remove_reaction(902,932).
catalyst(1180,928).
catalyst(1210,928).
catalyst(700,925).
catalyst(1200,913).
...
catalyst(650,759).
catalyst(6560,754).
catalyst(681,753) :- not remove_reaction(681,753).
catalyst(682,753) :- not remove_reaction(682,753).
catalyst(761,753) :- not remove_reaction(761,753).
catalyst(762,753) :- not remove_reaction(762,753).
catalyst(771,753) :- not remove_reaction(771,753).
catalyst(772,753) :- not remove_reaction(772,753).
catalyst(781,753) :- not remove_reaction(781,753).
catalyst(782,753) :- not remove_reaction(782,753).
catalyst(791,753) :- not remove_reaction(791,753).
catalyst(792,753) :- not remove_reaction(792,753).
catalyst(801,753) :- not remove_reaction(801,753).
catalyst(802,753) :- not remove_reaction(802,753).
catalyst(811,753) :- not remove_reaction(811,753).
catalyst(812,753) :- not remove_reaction(812,753).
catalyst(831,753) :- not remove_reaction(831,753).
catalyst(832,753) :- not remove_reaction(832,753).
catalyst(841,753) :- not remove_reaction(841,753).
catalyst(842,753) :- not remove_reaction(842,753).
catalyst(851,753) :- not remove_reaction(851,753).
catalyst(852,753) :- not remove_reaction(852,753).
catalyst(881,753) :- not remove_reaction(881,753).
catalyst(882,753) :- not remove_reaction(882,753).
catalyst(901,753) :- not remove_reaction(901,753).
catalyst(902,753) :- not remove_reaction(902,753).
catalyst(911,753) :- not remove_reaction(911,753).
catalyst(912,753) :- not remove_reaction(912,753).
catalyst(921,753) :- not remove_reaction(921,753).
catalyst(922,753) :- not remove_reaction(922,753).
catalyst(931,753) :- not remove_reaction(931,753).
catalyst(932,753) :- not remove_reaction(932,753).
catalyst(1191,753) :- not remove_reaction(1191,753).
catalyst(1192,753) :- not remove_reaction(1192,753).
catalyst(390,748).
catalyst(1021,748).
catalyst(1022,748).
catalyst(1521,726).
...
catalyst(6650,401).
catalyst(6690,399).
catalyst(791,365) :- not remove_reaction(791,365).
catalyst(792,365) :- not remove_reaction(792,365).
catalyst(801,365) :- not remove_reaction(801,365).
catalyst(802,365) :- not remove_reaction(802,365).
catalyst(811,365) :- not remove_reaction(811,365).
catalyst(812,365) :- not remove_reaction(812,365).
catalyst(831,365) :- not remove_reaction(831,365).
catalyst(832,365) :- not remove_reaction(832,365).
catalyst(841,365) :- not remove_reaction(841,365).
catalyst(842,365) :- not remove_reaction(842,365).
catalyst(851,365) :- not remove_reaction(851,365).
catalyst(852,365) :- not remove_reaction(852,365).
catalyst(901,365) :- not remove_reaction(901,365).
catalyst(902,365) :- not remove_reaction(902,365).
catalyst(1180,355).
catalyst(1210,355).
catalyst(690,351).
catalyst(730,351).
...
modifiable_enzyme(745).
modifiable_enzyme(746).
modifiable_enzyme(470).
modifiable_enzyme(509).
modifiable_enzyme(357).
modifiable_enzyme(932).
modifiable_enzyme(753).
