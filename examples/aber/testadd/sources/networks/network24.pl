...
component("YLR056W",165).
component("YPL231W",211).
component("U46_",36).
component("YBR149W",55).
component("YGL001C",111).
component("YIL094C",134).
component("U45_",35).
component("YDR127W",78).
component("YOL126C",198).
component("YDL078C",69).
component("YNL037C",182).
component("YML086C",178).
component("YGR088W",119).
component("YDR256C",85).
component("YJR078W",147).
component("U107_",19).
component("YER070W",105).
component("U36_",32).
component("YPL276W",217).
component("YPL275W",216).
component("YOR388C",204).
component("YOR323C",201).
component("YIL125W",135).
component("U52_",38).
component("YBR166C",56).
component("YKL216W",157).
component("YKR009C",158).
component("YIL160C",137).
component("YGL205W",117).
component("YKR080W",160).
component("YER023W",101).
component("YLR142W",168).
component("U62_",40).
component("YHR068W",127).
component("YKL150W",153).
component("YIL043C",132).
component("YPL171C",210).
component("YHR179W",131).
component("YDR353W",88).
component("YPL266W",215).
component("YDL033C",68).
component("YLR058C",166).
component("YDR019C",74).
component("YBR176W",57).
component("YDR408C",91).
component("YMR120C",179).
component("YLR028C",163).
component("YPR074C",220).
component("YBR117C",54).
component("YPL231W",212).
component("YPL231W",213).
component("YLR299W",174).
component("YDL182W",72).
component("YDL131W",71).
component("YLR258W",173).
component("YFR015C",109).
component("YNL029C",181).
component("YIL085C",133).
component("YLR209C",170).
component("YDR354W",89) :- not remove_orf("YDR354W",89).
component("YFR047C",110).
component("YLR209C",171).
component("YML022W",176).
component("YDR441C",93).
component("YJL167W",143).
component("YDR127W",79).
component("YJR130C",149).
component("YDR035W",75).
component("YBR249C",59).
component("YOR274W",200).
component("YHR137W",128).
component("YLR027C",162).
component("YKL106W",152).
component("YJR148W",150).
component("YNR058W",192).
component("YCR036W",67).
component("U96_",42).
component("YNR012W",190).
component("YDR127W",80).
component("YDR226W",83).
component("YKL067W",151).
component("YDR454C",94).
component("YOL061W",194).
component("YKL181W",154).
component("YHL011C",125).
component("YER099C",107).
component("YBL068W",48).
component("YNL256W",185).
component("YBR018C",50).
component("YPR175W",223).
component("YPL167C",209).
component("YOR330C",202).
component("YOL115W",197).
component("YNL299W",188).
component("YNL262W",186).
component("YNL102W",183).
component("YJR043C",145).
component("YJR006W",144).
component("YJL090C",141).
component("YIL139C",136).
component("YEL055C",98).
component("YDR419W",92).
component("YDR121W",77).
component("YDL102W",70).
component("YCR014C",66).
component("YBR278W",61).
component("YBL035C",46).
component("YPR113W",221).
component("U105_",18).
component("YLR377C",175).
component("U30_",31).
component("U29_",30).
component("U24_",29).
component("YGL027C",113).
component("YDR400W",90).
component("YML035C",177).
component("YJL070C",140).
component("YBR284W",62).
component("YDR242W",84).
component("U53_",39).
component("YLR028C",164).
component("YHR144C",129).
component("U39_",33).
component("YBR011C",49).
component("YBR111C",53).
component("YBR252W",60).
component("YER005W",100).
component("YLR231C",172).
component("U98_",43).
component("YKL211C",155) :- not remove_orf("YKL211C",155).
component("YKL211C",156) :- not remove_orf("YKL211C",156).
component("YER090W",156) :- not remove_orf("YER090W",156).
component("YER090W",106) :- not remove_orf("YER090W",106).
component("YDR127W",81).
component("YPL281C",218).
component("YOR393W",205).
component("YMR323W",180).
component("YHR174W",130).
component("YGR254W",123).
component("YGL026C",112) :- not remove_orf("YGL026C",112).
component("YNL316C",189).
component("YDR127W",82).
component("YGL148W",115).
component("YIL168W",139).
component("YIL167W",138).
component("YCL064C",65).
component("YAL012W",44).
component("YDR007W",73) :- not remove_orf("YDR007W",73).
component("YOR095C",199).
component("YPL117C",208).
component("YPR060C",219).
component("YPL097W",206).
component("YGR185C",122).
component("YGR264C",124).
component("YGR171C",121).
component("YPL104W",207).
component("YLL018C",161).
component("YOL097C",195).
component("YDR268W",86).
component("YOR335C",203).
component("YLR153C",169).
component("YAL054C",45).
component("U90_",41).
component("YNR057C",191).
component("YJR103W",148).
component("YBL039C",47).
component("YGL062W",114).
component("YBR218C",58).
component("YPR138C",222).
component("YPL265W",214).
component("YOL103W",196).
component("YOL020W",193) :- not remove_orf("YOL020W",193).
component("YNL270C",187).
component("YNL142W",184).
component("YLR100C",167).
component("YKR039W",159) :- not remove_orf("YKR039W",159).
component("YJR077C",146).
component("YJL129C",142).
component("YHL036W",126).
component("YGR121C",120).
component("YGR055W",118).
component("YGL186C",116).
component("YFL055W",108).
component("YER060W-A",104).
component("YER060W",103).
component("YER056C",102).
component("YEL063C",99).
component("YDR536W",97).
component("YDR508C",96).
component("YDR497C",95).
component("YDR297W",87).
component("YDR046C",76) :- not remove_orf("YDR046C",76).
component("YCL025C",64).
component("YBR298C",63).
...
catalyst(5601,170).
catalyst(5602,170).
catalyst(3620,89) :- not remove_reaction(3620,89).
catalyst(2190,110).
catalyst(5791,171).
catalyst(5792,171).
catalyst(5801,171).
...
catalyst(3500,172).
catalyst(2250,43).
catalyst(3600,155) :- not remove_reaction(3600,155).
catalyst(3630,156) :- not remove_reaction(3630,156).
catalyst(3630,106) :- not remove_reaction(3630,106).
catalyst(3740,81).
catalyst(8231,218).
catalyst(8232,218).
catalyst(8231,205).
...
catalyst(8231,123).
catalyst(8232,123).
catalyst(3590,112) :- not remove_reaction(3590,112).
catalyst(10910,112) :- not remove_reaction(10910,112).
catalyst(3680,189).
catalyst(3750,82).
catalyst(3700,115).
catalyst(8751,139).
...
catalyst(4520,65).
catalyst(4460,44).
catalyst(3610,73) :- not remove_reaction(3610,73).
catalyst(7921,199).
catalyst(7922,199).
catalyst(6461,208).
catalyst(6462,208).
...
catalyst(781,159) :- not remove_reaction(781,159).
catalyst(782,159) :- not remove_reaction(782,159).
...
catalyst(881,159) :- not remove_reaction(881,159).
catalyst(882,159) :- not remove_reaction(882,159).
catalyst(931,159) :- not remove_reaction(931,159).
catalyst(932,159) :- not remove_reaction(932,159).
catalyst(1191,159) :- not remove_reaction(1191,159).
catalyst(1192,159) :- not remove_reaction(1192,159).
catalyst(1581,146).
catalyst(1582,146).
catalyst(361,142).
catalyst(362,142).
...
catalyst(841,76) :- not remove_reaction(841,76).
catalyst(842,76) :- not remove_reaction(842,76).
catalyst(851,76) :- not remove_reaction(851,76).
catalyst(852,76) :- not remove_reaction(852,76).
catalyst(771,64).
catalyst(772,64).
catalyst(781,64).
catalyst(782,64).
...
catalyst(841,51) :- not remove_reaction(841,51).
catalyst(842,51) :- not remove_reaction(842,51).
catalyst(851,51) :- not remove_reaction(851,51).
catalyst(852,51) :- not remove_reaction(852,51).
catalyst(6980,37).
catalyst(6980,34).
catalyst(41,28).
catalyst(42,28).
