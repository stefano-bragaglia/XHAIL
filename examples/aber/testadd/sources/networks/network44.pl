...
component("YLR056W",271).
component("YKR009C",259).
component("YOL086C",328).
component("YMR303C",302).
component("YGL256W",187).
component("YDL168W",115).
component("YBR145W",88).
component("YPL231W",358).
component("U46_",54).
component("YBR149W",89).
component("YGL001C",169).
component("YIL094C",220).
component("U45_",53).
component("YDR127W",124).
component("YOL126C",332).
component("YKL085W",251).
component("YDL078C",109).
component("YNL037C",306).
component("YCL018W",100).
component("YLR355C",290).
component("YDL174C",116).
component("YML086C",295).
component("YGR088W",193).
component("YDR256C",134).
component("YJR078W",245).
component("YJR025C",240).
component("U107_",22).
component("YJL026W",228).
component("YGR180C",196).
component("YER070W",160).
component("U36_",49).
component("YPL276W",364).
component("YPL275W",363).
component("YOR388C",349).
component("YOR323C",343).
component("YIL125W",222).
component("U52_",57).
component("YBR166C",91).
component("YKL216W",258).
component("YKR009C",260).
component("YIL160C",225).
component("YGL205W",184).
component("YKR080W",264).
component("YER023W",155).
component("YGR204W",198).
component("YLR142W",276).
component("U65_",60).
component("U62_",59).
component("YHR068W",210).
component("YKL150W",254).
component("YIL043C",218).
component("YPL171C",357).
component("YHR179W",216).
component("YDR353W",138).
component("YNL052W",307).
component("YMR256C",301).
component("YLR395C",292).
component("YLR038C",269).
component("YIL111W",221).
component("YHR051W",209).
component("YGL191W",182).
component("YGL187C",181).
component("YDL067C",108).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",362).
component("YKR069W",263).
component("YJR073C",243).
component("YDL033C",107).
component("YLR172C",278).
component("YLR058C",272).
component("YDR019C",119).
component("YBR176W",92).
component("YDR408C",143).
component("YMR120C",299).
component("YLR028C",267).
component("YBL013W",73).
component("YJL130C",233).
component("YKL024C",249).
component("YPR074C",368).
component("YBR117C",87).
component("YCL009C",99).
component("U48_",55).
component("YPL231W",359).
component("YPL231W",360).
component("YLR299W",285).
component("YGL017W",172).
component("YML126C",296).
component("YDL182W",117).
component("YDL131W",112).
component("YLR258W",283).
component("YFR015C",166).
component("YNL029C",305).
component("YIL085C",219).
component("YMR306W",303).
component("YLR342W",289).
component("YGR032W",189).
component("YLR209C",279).
component("U104_",20).
component("YDR354W",139) :- not remove_orf("YDR354W",139).
component("YFR047C",167).
component("YLR209C",280).
component("YML022W",293).
component("YDR441C",145).
component("YJL167W",237).
component("YDR127W",125).
component("YLR303W",287).
component("YGR012W",188).
component("YJR130C",247).
component("YDR035W",120).
component("YBR249C",94).
component("YOR274W",342).
component("YHR137W",212).
component("YGL202W",183).
component("YLR027C",266).
component("YKL106W",252).
component("YLR089C",273).
component("YJR148W",248).
component("YNR058W",322).
component("YGL253W",186).
component("YFR053C",168).
component("YCR036W",105).
component("U96_",69).
component("YDR236C",132).
component("YHL032C",204).
component("YNR012W",320).
component("YDR127W",126).
component("YDR147W",129).
component("U76_",66).
component("YER170W",163).
component("YDR226W",131).
component("YKL067W",250).
component("YOL055C",326).
component("YDR454C",146).
component("YOL061W",327).
component("YKL181W",255).
component("YHL011C",203).
component("YER099C",162).
component("YBL068W",77).
component("YNL256W",314).
component("YBR018C",80).
component("YBR029C",82).
component("YGL130W",178).
component("YPR190C",374).
component("YPR187W",373).
component("YPR110C",369).
component("YPR010C",366).
component("YOR341W",347).
component("YOR340C",346).
component("YOR224C",341).
component("YOR210W",340).
component("YOR207C",339).
component("YOR151C",336).
component("YOR116C",335).
component("YOL005C",323).
component("YNR003C",319).
component("YNL248C",313).
component("YNL151C",312).
component("YNL113W",309).
component("YKL144C",253).
component("YJR063W",242).
component("YJL148W",236).
component("YJL140W",235).
component("YIL021W",217).
component("YHR143W-A",213).
component("YGL070C",176).
component("YFL036W",164).
component("YDR404C",142).
component("YDR156W",130).
component("YDR045C",121).
component("YDL150W",114).
component("YDL140C",113).
component("YBR154C",90).
component("YPR175W",372).
component("YPL167C",356).
component("YOR330C",344).
component("YOL115W",331).
component("YNL299W",317).
component("YNL262W",315).
component("YNL102W",308).
component("YJR043C",241).
component("YJR006W",239).
component("YJL090C",230).
component("YIL139C",223).
component("YEL055C",152).
component("YDR419W",144).
component("YDR121W",123).
component("YDL102W",111).
component("YCR014C",103).
component("YBR278W",96).
component("YBL035C",75).
component("YPR113W",370).
component("YPL148C",355).
component("YGR286C",202).
component("YOL011W",324).
component("YMR008C",298).
component("YMR006C",297).
component("U105_",21).
component("YBL015W",74).
component("U77_",67).
component("YLR377C",291).
component("U30_",48).
component("U29_",47).
component("U24_",46).
component("YHR044C",208).
component("YHR043C",207).
component("YOR360C",348).
component("YGL027C",174).
component("YOR190W",338).
component("YLR300W",286).
component("YGR282C",201).
component("YDR261C",135).
component("YDR400W",141).
component("YML035C",294).
component("YJL070C",229).
component("YBR284W",97).
component("YDR242W",133).
component("U53_",58).
component("YMR120C",300).
component("YLR028C",268).
component("YHR144C",214).
component("YNL141W",310).
component("YLR245C",282).
component("YJL126W",231).
component("U39_",50).
component("YBR011C",79).
component("YBR111C",86).
component("YBR252W",95).
component("YER005W",154).
component("YBL099W",78).
component("YLR231C",281).
component("YLR134W",275).
component("YLR044C",270).
component("YGR087C",192).
component("YDR380W",140).
component("YDL080C",110).
component("U98_",70).
component("YKL211C",256) :- not remove_orf("YKL211C",256).
component("YKL211C",257) :- not remove_orf("YKL211C",257).
component("YER090W",257) :- not remove_orf("YER090W",257).
component("YER090W",161) :- not remove_orf("YER090W",161).
component("YDR127W",127).
component("YPL281C",365).
component("YOR393W",350).
component("YMR323W",304).
component("YHR174W",215).
component("YGR254W",199).
component("YGL026C",173) :- not remove_orf("YGL026C",173).
component("YLR304C",288).
component("YJL200C",238).
component("YNL316C",318).
component("YCR053W",106).
component("YDR127W",128).
component("YGL148W",179).
component("YIL168W",227).
component("YIL167W",226).
component("YCL064C",102).
component("YAL012W",71).
component("YBR019C",81).
component("YDR007W",118) :- not remove_orf("YDR007W",118).
component("YOR095C",334).
component("YGL001C",170).
component("YPL117C",354).
component("YPR060C",367).
component("YPL097W",352).
component("YGR185C",197).
component("YGR264C",200).
component("YGR171C",195).
component("YPL104W",353).
component("YLL018C",265).
component("YOL097C",329).
component("YDR268W",136).
component("YHR019C",206).
component("YOR335C",345).
component("YLR153C",277).
component("YAL054C",72).
component("YIL145C",224).
component("U90_",68).
component("YNR057C",321).
component("YGL234W",185).
component("YJR103W",246).
component("YBL039C",76).
component("YBR084W",85).
component("YHR074W",211).
component("YGL062W",175).
component("YBR218C",93).
component("YPR138C",371).
component("YPL265W",361).
component("YPL036W",351).
component("YOR171C",337).
component("YOR011W",333).
component("YOL103W",330).
component("YOL020W",325) :- not remove_orf("YOL020W",325).
component("YNL270C",316).
component("YNL142W",311).
component("YLR260W",284).
component("YLR100C",274).
component("YKR053C",262).
component("YKR039W",261) :- not remove_orf("YKR039W",261).
component("YJR077C",244).
component("YJL134W",234).
component("YJL129C",232).
component("YHL036W",205).
component("YGR121C",194).
component("YGR065C",191).
component("YGR055W",190).
component("YGL186C",180).
component("YGL077C",177).
component("YGL008C",171).
component("YFL055W",165).
component("YER060W-A",159).
component("YER060W",158).
component("YER056C",157).
component("YER053C",156).
component("YEL063C",153).
component("YEL017C-A",151).
component("YDR536W",150).
component("YDR508C",149).
component("YDR503C",148).
component("YDR497C",147).
component("YDR297W",137).
component("YDR046C",122) :- not remove_orf("YDR046C",122).
component("YCR024C-A",104).
component("YCL025C",101).
component("YBR298C",98).
component("YBR069C",84) :- not remove_orf("YBR069C",84).
component("YBR068C",83) :- not remove_orf("YBR068C",83).
component("U75_",65).
component("U74_",64).
component("U73_",63).
component("U72_",62).
...
catalyst(2121,20).
catalyst(2122,20).
catalyst(3620,139) :- not remove_reaction(3620,139).
catalyst(2190,167).
catalyst(5791,280).
catalyst(5792,280).
catalyst(5801,280).
...
catalyst(8812,110).
catalyst(2250,70).
catalyst(3600,256) :- not remove_reaction(3600,256).
catalyst(3630,257) :- not remove_reaction(3630,257).
catalyst(3630,161) :- not remove_reaction(3630,161).
catalyst(3740,127).
catalyst(8231,365).
catalyst(8232,365).
catalyst(8231,350).
...
catalyst(8231,199).
catalyst(8232,199).
catalyst(3590,173) :- not remove_reaction(3590,173).
catalyst(10910,173) :- not remove_reaction(10910,173).
catalyst(8181,288).
catalyst(8182,288).
catalyst(8181,238).
catalyst(8182,238).
...
catalyst(7751,81).
catalyst(7752,81).
catalyst(3610,118) :- not remove_reaction(3610,118).
catalyst(7921,334).
catalyst(7922,334).
catalyst(6370,170).
catalyst(6461,354).
...
catalyst(851,261) :- not remove_reaction(851,261).
catalyst(852,261) :- not remove_reaction(852,261).
...
catalyst(931,261) :- not remove_reaction(931,261).
catalyst(932,261) :- not remove_reaction(932,261).
...
catalyst(1121,98).
catalyst(1122,98).
catalyst(771,84) :- not remove_reaction(771,84).
catalyst(772,84) :- not remove_reaction(772,84).
...
catalyst(831,83) :- not remove_reaction(831,83).
catalyst(832,83) :- not remove_reaction(832,83).
catalyst(841,83) :- not remove_reaction(841,83).
catalyst(842,83) :- not remove_reaction(842,83).
catalyst(851,83) :- not remove_reaction(851,83).
catalyst(852,83) :- not remove_reaction(852,83).
catalyst(901,83) :- not remove_reaction(901,83).
catalyst(902,83) :- not remove_reaction(902,83).
catalyst(2920,65).
catalyst(2920,64).
catalyst(2920,63).
catalyst(2920,62).
