...
component("YLR056W",602).
component("YGR060W",416).
component("YGL012W",387).
component("YKR009C",583).
component("YOL086C",727).
component("YMR303C",674).
component("YMR083W",661).
component("YGL256W",409).
component("YDL168W",261).
component("YBR145W",196).
component("YPL231W",791).
component("YBR265W",213).
component("U46_",115).
component("YBR149W",197).
component("YBR149W",198).
component("YGL001C",384).
component("YIL094C",489).
component("U45_",114).
component("YML056C",648).
component("YLR432W",638).
component("YHR216W",480).
component("YAR075W",168).
component("YAR073W",167).
component("YDR127W",288).
component("YJR139C",554).
component("YML075C",650).
component("YLR450W",641).
component("YOL126C",733).
component("YKL085W",564).
component("YDL078C",245).
component("YNL037C",679).
component("YNL009W",677).
component("YLR174W",615).
component("YHR183W",473).
component("YGR256W",437).
component("YNL241C",693).
component("YOL059W",724).
component("YDL022W",238).
component("YCL018W",221).
component("YLR355C",633).
component("YIL074C",486).
component("YER081W",358).
component("YDL174C",265).
component("YML086C",652).
component("YIL155C",498).
component("YEL024W",334).
component("YKR066C",588).
component("YGR088W",420).
component("YDR256C",302).
component("YKL026C",560).
component("YIR037W",508).
component("YBR244W",208).
component("YJR078W",547).
component("U58_",124).
component("YJR025C",539).
component("U107_",24).
component("YHR007C",448).
component("YDR402C",316).
component("YGL055W",394).
component("YJR104C",549).
component("YHR008C",449).
component("YOR384W",770).
component("YOR381W",769).
component("YOL152W",735).
component("YLL051C",595).
component("YJL026W",510).
component("YIL066C",485).
component("YGR180C",427).
component("YER070W",355).
component("U37_",108).
component("U36_",107).
component("U35_",106).
component("YDL168W",262).
component("YDR158W",296).
component("YJR009C",536).
component("YJL052W",512).
component("YGR192C",429).
component("YBR006W",178).
component("YPL276W",799).
component("YPL275W",798).
component("YOR388C",771).
component("YPL061W",776).
component("YOR374W",767).
component("YER073W",356).
component("YGL154C",401).
component("YBR115C",192).
component("U55_",123).
component("YER069W",353).
component("YOR323C",759).
component("YER178W",368).
component("YBR221C",206).
component("YIL125W",494).
component("U52_",120).
component("YBR166C",201).
component("YNL280C",701).
component("YGL012W",388).
component("YKL182W",573).
component("YKL216W",582).
...
component("YLL041C",594).
component("YKL148C",568).
component("YKL141W",566).
component("YJL045W",511).
...
component("YKR080W",590).
component("YER023W",344).
component("YOR236W",757).
component("YGR204W",431).
component("YIR034C",507).
component("YLR142W",610).
component("U65_",130).
component("U63_",128).
component("U62_",127).
component("YHR068W",459).
component("YKL150W",569).
component("YIL043C",483).
component("YHR042W",454).
component("YOR221C",754).
component("YMR145C",666).
component("YKL192C",576).
component("YKL055C",562).
component("YER061C",351).
component("YDL085W",247).
component("YPL171C",784).
component("YHR179W",472).
component("YMR145C",667).
component("YML120C",653).
component("YKL192C",577).
component("YDL085W",248).
component("YGR234W",433).
component("YFR030W",380).
component("YPL017C",773).
component("YFL018C",372).
component("YDR353W",312).
component("YPR167C",814).
component("YJR137C",553).
component("YNL052W",681).
component("YMR256C",673).
component("YLR395C",637).
component("YLR038C",600).
component("YIL111W",491).
component("YHR051W",458).
component("YGL191W",404).
component("YGL187C",403).
component("YDL067C",244).
component("Q0275",19).
component("Q0250",18).
component("YDR072C",283).
component("YPL266W",797).
component("YKR069W",589).
component("YOL096C",728).
component("U47_",116).
component("YER091C",363).
component("YJR073C",545).
component("YGR157W",425).
component("YDR120C",286).
component("YML008C",643).
component("YOR074C",740).
component("YDL033C",240).
component("YOL096C",729).
component("YLR172C",614).
component("YLR058C",603).
component("YDR019C",275).
component("YBR176W",202).
...
component("YKL024C",559).
component("YPR074C",809).
component("YBR117C",193).
component("YMR108W",662).
component("YCL009C",220).
component("YNL071W",683).
component("YNR008W",706).
component("YIL160C",500).
component("YNR019W",709).
component("YCR048W",234).
component("U48_",117).
component("YMR062C",660).
component("YDR232W",299).
component("YPL231W",792).
component("YER061C",352).
component("YDL052C",243).
component("U8_",152).
component("YDR148C",294).
component("YPL231W",793).
component("YPL028W",774).
component("YLR299W",625).
component("YGL017W",389).
component("YCR005C",226).
component("YML126C",654).
component("YNL104C",686).
component("YDL182W",266).
component("YDL131W",252).
component("YDR307W",308).
component("YLR258W",622).
component("YFR015C",378).
component("YNL029C",678).
component("YIL085C",488).
component("YMR306W",675).
component("YLR342W",631).
component("YGR032W",413).
component("YBR248C",209).
component("YLR209C",617).
component("U104_",21).
component("YDR354W",313) :- not remove_orf("YDR354W",313).
component("YFR047C",381).
component("YJR133W",552).
component("YLR209C",618).
component("YML022W",645).
component("YDR441C",321).
component("YHR128W",467).
component("YJL167W",528).
component("YJL167W",529).
component("YPR069C",806).
component("YDR127W",289).
component("YHR190W",475).
component("YLR146C",611).
component("YHR068W",460).
component("YLR303W",627).
component("YGR012W",411).
component("YML082W",651).
component("YJR130C",551).
component("YDR035W",277).
component("YBR249C",210).
component("YLR180W",616).
component("YDR502C",325).
component("YOR274W",758).
component("YBR256C",212).
component("YHR137W",468).
component("YGL202W",405).
component("YLR027C",597).
component("YKL106W",565).
component("YOL140W",734).
component("YLR438W",640).
component("YGR019W",412).
component("YLR089C",606).
component("U64_",129).
component("U61_",126).
component("U51_",119).
component("YJR148W",555).
component("YHR208W",478).
component("YFL030W",374).
component("YOR184W",749).
component("YNR058W",714).
component("YIL116W",493).
component("YGL253W",408).
component("YFR053C",382).
component("YMR013C",658).
component("YMR205C",669).
component("YGR240C",434).
component("YOL016C",718).
component("YFR014C",377).
component("YLR240W",620).
component("YKL203C",579).
...
component("U82_",146).
component("U81_",145).
component("YMR208W",670).
component("YPL203W",787).
component("YOR061W",739).
component("YKL166C",571).
component("YJL164C",527).
component("YIL035C",482).
component("YHR205W",477).
component("YHR102W",466).
component("YGL019W",390).
component("YHR025W",453).
component("YOR347C",764).
component("YAL038W",162).
component("YNR012W",707).
component("YDR009W",274).
component("YDR127W",290).
component("YDR147W",293).
component("YDR300C",307).
component("YCR012W",227).
component("YER069W",354).
component("U19_",82).
component("U18_",74).
component("U17_",66).
component("U76_",140).
component("YER170W",367).
component("YDR226W",298).
component("YKL067W",563).
component("YOL055C",721).
component("YDR454C",322).
component("YJR057W",542).
component("YOL061W",725).
component("YKL181W",572).
component("YHL011C",444).
component("YER099C",364).
component("YBL068W",176).
component("YOR143C",745).
component("YNL256W",696).
component("YLR328W",629).
component("YBR018C",180).
component("YGR007W",410).
component("YGR202C",430).
component("YLR328W",630).
component("U80_",144).
component("U94_",155).
component("YJR010W",537).
...
component("YPR110C",811).
component("YPR010C",802).
component("YOR341W",763).
component("YOR340C",762).
component("YOR224C",756).
component("YOR210W",753).
component("YOR207C",751).
component("YOR151C",746).
component("YOR116C",742).
component("YOL005C",716).
component("YNR003C",705).
component("YNL248C",695).
component("YNL151C",690).
component("YNL113W",687).
component("YKL144C",567).
component("YJR063W",543).
component("YJL148W",525).
component("YJL140W",524).
component("YIL021W",481).
component("YHR143W-A",469).
...
component("YDL140C",254).
component("YBR154C",200).
component("YPR175W",815).
component("YPL167C",783).
component("YOR330C",760).
component("YOL115W",732).
component("YNL299W",703).
component("YNL262W",698).
...
component("YKL035W",561).
component("YHL012W",445).
component("YPR113W",812).
component("YBR243C",207).
component("YDL142C",259).
component("YPL148C",781).
component("YER026C",345).
component("YGR286C",441).
component("YHR189W",474).
component("YDR058C",282).
component("YDL086W",249).
component("YOL011W",717).
component("YMR008C",656).
component("YMR006C",655).
component("U105_",22).
component("YBL015W",170).
component("YJL068C",513).
component("YOR040W",738).
component("U77_",141).
component("YDR481C",323).
component("YLR377C",635).
component("YPL179W",785).
component("YNR032W",710).
component("YML057W",649).
component("YML016C",644).
component("YLR433C",639).
component("YGR123C",423).
component("YER133W",365).
component("YER089C",361).
component("YDR436W",320).
component("YDR075W",284).
component("YDL188C",267).
component("YDL134C",253).
component("YDL047W",242).
component("YDL006W",236).
component("YBR125C",195).
component("YBL056W",175).
component("YPR073C",807).
component("YHR215W",479).
component("YDL024C",239).
component("YBR093C",190).
component("YBR092C",189).
component("YAR071W",166).
component("YHR046C",457).
component("U9_",159).
component("YPL228W",790).
component("YMR180C",668).
component("YDL236W",271).
component("YJL155C",526).
component("YPR073C",808).
component("YOR208W",752).
component("YNL053W",682).
component("YMR036C",659).
component("YIR026C",506).
component("YIL113W",492).
component("YFR028C",379).
component("YER075C",357).
component("YDL230W",270).
component("YBR276C",214).
component("U34_",105).
component("U33_",104).
component("U32_",103).
component("U31_",102).
...
component("U25_",96).
component("U24_",95).
component("YHR044C",456).
component("YHR043C",455).
component("YOL064C",726).
component("YOR360C",766).
component("YKR031C",585).
component("YPL206C",788).
component("YGL027C",392).
component("YLR286C",624).
component("YJR153W",556).
component("YJL221C",534).
component("YJL216C",532).
component("YIL172C",504).
component("YGR292W",443).
component("YGR287C",442).
component("YBR299W",219).
component("YBR184W",203).
component("YIL162W",501).
component("YIR019C",505).
component("YIL099W",490).
component("YDL037C",241).
component("YOR190W",750).
component("YLR300W",626).
component("YGR282C",440).
component("YDR261C",303).
component("YDR400W",315).
component("YML035C",646).
component("YJL070C",514).
component("YBR284W",216).
component("U106_",23).
component("YER043C",346).
component("YNL045W",680).
component("YGL037C",393).
component("YDR242W",301).
component("U53_",121).
component("YPR062W",805).
component("YMR120C",665).
component("YLR028C",599).
component("YHR144C",470).
component("YGR267C",439).
component("YBL033C",171).
component("YBR153W",199).
component("YNL141W",688).
component("YLR245C",621).
...
component("U88_",150).
component("YDR538W",331).
component("YLR134W",608).
component("YLR044C",601).
component("YGR087C",419).
component("YDR380W",314).
component("YDL080C",246).
component("U98_",157).
component("YMR250W",672).
component("YOR128C",743).
component("YEL021W",333).
component("YNR043W",712).
component("U93_",154).
component("U54_",122).
component("YKL211C",580) :- not remove_orf("YKL211C",580).
component("YKR097W",592).
component("YNL169C",691).
component("YNL256W",697).
component("YDR294C",305).
component("YEL046C",336).
component("YNR033W",711).
component("YKL211C",581) :- not remove_orf("YKL211C",581).
component("YER090W",581) :- not remove_orf("YER090W",581).
component("YER090W",362) :- not remove_orf("YER090W",362).
component("YDR127W",291).
component("YPL281C",800).
component("YOR393W",772).
component("YMR323W",676).
component("YHR174W",471).
component("YGR254W",436).
...
component("YPL212C",789).
component("YNL292W",702).
component("YGL063W",396).
component("YFL001W",370).
component("YPR002W",801).
component("YJR016C",538).
...
component("YER086W",359).
component("YLR359W",634).
component("YAL012W",160).
component("YML004C",642).
component("YFR055W",383).
component("YJL005W",509).
component("YJL121C",518).
component("YBR019C",181).
component("YDR050C",281).
component("YDR007W",273) :- not remove_orf("YDR007W",273).
component("YOR095C",741).
component("YER003C",342).
component("YBR196C",204).
component("YGL001C",385).
component("YPL117C",779).
component("U14_",46).
component("YOL056W",722).
component("YKL152C",570).
component("YDL021W",237).
component("YEL058W",339).
component("YPR060C",804).
component("YHR072W",461).
component("YPL097W",777).
component("YGR185C",428).
component("YGR264C",438).
component("YGR171C",426).
component("YHR011W",450).
component("YDR023W",276).
component("YPL104W",778).
component("YLL018C",593).
component("YPR081C",810).
component("YBR121C",194).
component("YHR020W",452).
component("YER087W",360).
component("YNL247W",694).
component("YOR168W",747).
component("YOL097C",730).
component("YDR268W",304).
component("YPR047W",803).
component("YLR060W",604).
component("YFL022C",373).
component("YCR024C",229).
component("YHR019C",451).
component("YKL194C",578).
component("YIL078W",487).
component("YPL160W",782).
component("YLR382C",636).
component("YNL073W",684).
component("YOR335C",761).
component("YGR094W",421).
component("YLR153C",612).
component("YAL054C",163).
component("YGR244C",435).
component("YIL145C",497).
component("U89_",151).
component("YJL101C",517).
component("YOL049W",720).
component("YAR015W",165).
component("YER183C",369).
component("U90_",153).
component("YNR057C",713).
component("YDL141W",255).
component("YDL141W",256).
component("YGL234W",407).
component("YDL141W",257).
component("YJR103W",548).
component("YBL039C",173).
component("YGR204W",432).
component("YBR084W",188).
component("YNL220W",692).
component("YOL058W",723).
component("YDL141W",258).
component("YHR074W",462).
component("YMR217W",671).
component("YGR061C",417).
component("YJR109C",550).
component("YJL130C",522).
component("YGL062W",395).
component("YBR218C",205).
component("YPL231W",794).
component("YNR016C",708).
component("YKL182W",575).
component("YGR037C",414).
component("YPR138C",813).
component("YPL265W",796).
component("YPL134C",780).
component("YPL036W",775).
component("YOR348C",765).
component("YOR222W",755).
component("YOR171C",748).
component("YOR130C",744).
component("YOR011W",737).
component("YOL156W",736).
component("YOL103W",731).
component("YOL020W",719) :- not remove_orf("YOL020W",719).
component("YNR072W",715).
component("YNL270C",699).
component("YNL142W",689).
component("YMR011W",657).
component("YLR348C",632).
component("YLR260W",623).
component("YLR138W",609).
component("YLR100C",607).
component("YLR081W",605).
component("YLL061W",596).
component("YKR093W",591).
component("YKR053C",587).
component("YKR039W",586) :- not remove_orf("YKR039W",586).
component("YJR158W",557).
component("YJR077C",546).
component("YJL219W",533).
component("YJL214W",531).
component("YJL134W",523).
component("YJL129C",520).
component("YIL134W",495).
...
component("YER053C",347).
component("YEL069C",341).
component("YEL063C",340).
component("YEL017C-A",332).
component("YDR536W",330).
component("YDR508C",327).
component("YDR503C",326).
component("YDR497C",324).
component("YDR345C",311).
component("YDR343C",310).
component("YDR342C",309).
component("YDR297W",306).
component("YDR046C",280) :- not remove_orf("YDR046C",280).
component("YDL245C",272).
component("YDL210W",268).
component("YCR032W",232).
component("YCR028C",231).
component("YCR024C-A",230).
component("YCL025C",222).
component("YBR298C",218).
component("YBR291C",217).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,313) :- not remove_reaction(3620,313).
catalyst(2110,381).
catalyst(2190,381).
catalyst(5550,552).
catalyst(5791,618).
...
catalyst(2300,154).
catalyst(3460,122).
catalyst(3600,580) :- not remove_reaction(3600,580).
catalyst(8000,592).
catalyst(6890,691).
catalyst(2570,697).
catalyst(8781,305).
...
catalyst(4560,336).
catalyst(2550,711).
catalyst(1890,581) :- not remove_reaction(1890,581).
catalyst(3630,581) :- not remove_reaction(3630,581).
catalyst(1890,362) :- not remove_reaction(1890,362).
...
catalyst(8281,281).
catalyst(8282,281).
catalyst(3610,273) :- not remove_reaction(3610,273).
catalyst(7921,741).
catalyst(7922,741).
catalyst(7841,342).
catalyst(7842,342).
...
catalyst(1210,736).
catalyst(1160,731).
catalyst(801,719) :- not remove_reaction(801,719).
catalyst(802,719) :- not remove_reaction(802,719).
catalyst(811,719) :- not remove_reaction(811,719).
catalyst(812,719) :- not remove_reaction(812,719).
catalyst(831,719) :- not remove_reaction(831,719).
catalyst(832,719) :- not remove_reaction(832,719).
catalyst(901,719) :- not remove_reaction(901,719).
catalyst(902,719) :- not remove_reaction(902,719).
catalyst(1180,715).
catalyst(1210,715).
catalyst(931,699).
catalyst(932,699).
...
catalyst(851,586) :- not remove_reaction(851,586).
catalyst(852,586) :- not remove_reaction(852,586).
...
catalyst(921,586) :- not remove_reaction(921,586).
catalyst(922,586) :- not remove_reaction(922,586).
catalyst(931,586) :- not remove_reaction(931,586).
catalyst(932,586) :- not remove_reaction(932,586).
...
catalyst(851,280) :- not remove_reaction(851,280).
catalyst(852,280) :- not remove_reaction(852,280).
...
catalyst(851,186) :- not remove_reaction(851,186).
catalyst(852,186) :- not remove_reaction(852,186).
...
catalyst(851,185) :- not remove_reaction(851,185).
catalyst(852,185) :- not remove_reaction(852,185).
