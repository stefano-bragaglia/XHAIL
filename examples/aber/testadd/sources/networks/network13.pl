...
component("YOL126C",144).
component("YDL078C",51).
component("YNL037C",132).
component("YML086C",129).
component("YJR078W",107).
component("YER070W",80).
component("U36_",29).
component("YOR323C",146).
component("YIL125W",99).
component("U52_",33).
component("YBR166C",43).
component("YKR009C",116).
component("YIL160C",101).
component("YGL205W",88).
component("YKR080W",118).
component("YER023W",76).
component("YLR142W",125).
component("YHR068W",95).
component("YKL150W",112).
component("YIL043C",98).
component("YLR058C",123).
component("YDR019C",56).
component("YBR176W",44).
component("YMR120C",130).
component("YLR028C",121).
component("YPR074C",158).
component("YBR117C",42).
component("YPL231W",154).
component("YDL182W",54).
component("YDL131W",53).
component("YLR209C",126).
component("YDR354W",68) :- not remove_orf("YDR354W",68).
component("YFR047C",84).
component("YML022W",128).
component("YDR441C",71).
component("YJL167W",103).
component("YDR127W",61).
component("YDR035W",57).
component("YBR249C",45).
component("YHR137W",96).
component("YLR027C",120).
component("YKL106W",111).
component("YJR148W",109).
component("YNR058W",140).
component("YCR036W",50).
component("YNR012W",138).
component("YDR127W",62).
component("YDR226W",65).
component("YKL067W",110).
component("YDR454C",72).
component("YOL061W",142).
component("YKL181W",113).
component("YHL011C",94).
component("YER099C",82).
component("YBL068W",38).
component("YPR175W",160).
component("YPL167C",152).
component("YOR330C",147).
component("YOL115W",143).
component("YNL299W",136).
component("YNL262W",135).
component("YNL102W",133).
component("YJR043C",105).
component("YJR006W",104).
component("YJL090C",102).
component("YIL139C",100).
component("YEL055C",75).
component("YDR419W",70).
component("YDR121W",59).
...
component("U30_",28).
component("U24_",27).
component("YDR400W",69).
component("YDR242W",66).
component("U53_",34).
component("YLR028C",122).
component("U39_",30).
...
component("YER090W",115) :- not remove_orf("YER090W",115).
component("YER090W",81) :- not remove_orf("YER090W",81).
component("YDR127W",63).
component("YPL281C",156).
component("YOR393W",148).
component("YMR323W",131).
component("YHR174W",97).
component("YGR254W",92).
component("YGL026C",85) :- not remove_orf("YGL026C",85).
component("YNL316C",137).
component("YDR127W",64).
component("YGL148W",86).
component("YAL012W",35).
component("YDR007W",55) :- not remove_orf("YDR007W",55).
component("YOR095C",145).
component("YPL117C",151).
component("YPR060C",157).
component("YPL097W",149).
component("YGR185C",91).
component("YGR264C",93).
component("YGR171C",90).
component("YPL104W",150).
component("YLL018C",119).
component("YNR057C",139).
component("YJR103W",108).
component("YBL039C",37).
component("YPR138C",159).
component("YPL265W",155).
component("YOL020W",141) :- not remove_orf("YOL020W",141).
component("YNL142W",134).
component("YLR100C",124).
component("YKR039W",117) :- not remove_orf("YKR039W",117).
component("YJR077C",106).
component("YGR121C",89).
component("YGL186C",87).
component("YFL055W",83).
component("YER060W-A",79).
component("YER060W",78).
component("YER056C",77).
component("YDR536W",74).
component("YDR508C",73).
component("YDR297W",67).
component("YDR046C",58) :- not remove_orf("YDR046C",58).
...
catalyst(5601,126).
catalyst(5602,126).
catalyst(3620,68) :- not remove_reaction(3620,68).
catalyst(2190,84).
catalyst(5650,128).
catalyst(5650,71).
catalyst(6440,103).
...
catalyst(5730,46).
catalyst(3500,127).
catalyst(3600,114) :- not remove_reaction(3600,114).
catalyst(3630,115) :- not remove_reaction(3630,115).
...
catalyst(8231,92).
catalyst(8232,92).
catalyst(3590,85) :- not remove_reaction(3590,85).
catalyst(10910,85) :- not remove_reaction(10910,85).
catalyst(3680,137).
catalyst(3750,64).
catalyst(3700,86).
catalyst(4460,35).
catalyst(3610,55) :- not remove_reaction(3610,55).
catalyst(7921,145).
catalyst(7922,145).
catalyst(6461,151).
catalyst(6462,151).
...
catalyst(1191,48).
catalyst(1192,48).
catalyst(771,40) :- not remove_reaction(771,40).
catalyst(772,40) :- not remove_reaction(772,40).
