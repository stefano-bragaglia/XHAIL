...
component("YLR056W",317).
component("YKR009C",304).
component("YOL086C",384).
component("YMR303C",350).
component("YGL256W",220).
component("YDL168W",138).
component("YBR145W",105).
component("YPL231W",418).
component("U46_",65).
component("YBR149W",106).
component("YGL001C",201).
component("YIL094C",257).
component("U45_",64).
component("YDR127W",149).
component("YOL126C",388).
component("YKL085W",294).
component("YDL078C",132).
component("YNL037C",354).
component("YCL018W",118).
component("YLR355C",337).
component("YDL174C",140).
component("YML086C",342).
component("YGR088W",227).
component("YDR256C",159).
component("YJR078W",288).
component("YJR025C",281).
component("U107_",23).
component("YJL026W",268).
component("YGR180C",230).
component("YER070W",187).
component("U36_",60).
component("YDL168W",139).
component("YPL276W",425).
component("YPL275W",424).
component("YOR388C",408).
component("YOR323C",402).
component("YER178W",192).
component("YIL125W",260).
component("U52_",68).
component("YBR166C",108).
component("YGL012W",204).
component("YKL216W",303).
component("YKR009C",305).
component("YIL160C",263).
component("YGL205W",217).
component("U100_",20).
component("YKR080W",309).
component("YER023W",182).
component("YGR204W",232).
component("YLR142W",322).
component("U65_",73).
component("U62_",72).
component("YHR068W",246).
component("YKL150W",297).
component("YIL043C",255).
component("YPL171C",416).
component("YHR179W",253).
component("YGR234W",233).
component("YDR353W",163).
component("YPR167C",436).
component("YNL052W",355).
component("YMR256C",349).
component("YLR395C",339).
component("YLR038C",315).
component("YIL111W",258).
component("YHR051W",245).
component("YGL191W",215).
component("YGL187C",214).
component("YDL067C",131).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",423).
component("YKR069W",308).
component("YJR073C",286).
component("YDL033C",130).
component("YLR172C",324).
component("YLR058C",318).
component("YDR019C",144).
component("YBR176W",109).
component("YDR408C",168).
component("YMR120C",347).
component("YLR028C",313).
component("YBL013W",89).
component("YJL130C",273).
component("YKL024C",292).
component("YPR074C",432).
component("YBR117C",104).
component("YCL009C",117).
component("YNL071W",357).
component("YIL160C",264).
component("U48_",66).
component("YPL231W",419).
component("YPL231W",420).
component("YLR299W",331).
component("YGL017W",205).
component("YML126C",343).
component("YNL104C",359).
component("YDL182W",141).
component("YDL131W",135).
component("YLR258W",329).
component("YFR015C",197).
component("YNL029C",353).
component("YIL085C",256).
component("YMR306W",351).
component("YLR342W",336).
component("YGR032W",222).
component("YLR209C",325).
component("U104_",21).
component("YDR354W",164) :- not remove_orf("YDR354W",164).
component("YFR047C",199).
component("YLR209C",326).
component("YML022W",340).
component("YDR441C",170).
component("YJL167W",277).
component("YDR127W",150).
component("YHR068W",247).
component("YLR303W",333).
component("YGR012W",221).
component("YJR130C",290).
component("YDR035W",145).
component("YBR249C",111).
component("YOR274W",401).
component("YHR137W",249).
component("YGL202W",216).
component("YLR027C",312).
component("YKL106W",295).
component("YOL140W",389).
component("YLR089C",319).
component("U61_",71).
component("YJR148W",291).
component("YFL030W",193).
component("YNR058W",375).
component("YGL253W",219).
component("YFR053C",200).
component("YOL016C",378).
component("YFR014C",196).
component("YCR036W",127).
component("YCL040W",120).
component("YPL188W",417).
component("YJR049C",283).
component("YEL041W",177).
component("U96_",84).
component("YDR236C",157).
component("YHL032C",239).
component("YNR012W",372).
component("YDR127W",151).
component("YDR147W",154).
component("YCR012W",122).
component("U76_",81).
component("YER170W",191).
component("YDR226W",156).
component("YKL067W",293).
component("YOL055C",381).
component("YDR454C",171).
component("YJR057W",284).
component("YOL061W",383).
component("YKL181W",299).
component("YHL011C",238).
component("YER099C",190).
component("YBL068W",94).
component("YNL256W",366).
component("YBR018C",97).
component("YLR328W",335).
component("YBR029C",99).
component("YGL130W",211).
component("YPR190C",439).
component("YPR187W",438).
component("YPR110C",433).
component("YPR010C",428).
component("YOR341W",406).
component("YOR340C",405).
component("YOR224C",400).
component("YOR210W",399).
component("YOR207C",397).
component("YOR151C",394).
component("YOR116C",392).
component("YOL005C",376).
component("YNR003C",371).
component("YNL248C",365).
component("YNL151C",363).
component("YNL113W",360).
component("YKL144C",296).
component("YJR063W",285).
component("YJL148W",276).
component("YJL140W",275).
component("YIL021W",254).
component("YHR143W-A",250).
component("YGL070C",209).
component("YFL036W",194).
component("YDR404C",167).
component("YDR156W",155).
component("YDR045C",146).
component("YDL150W",137).
component("YDL140C",136).
component("YBR154C",107).
component("YPR175W",437).
component("YPL167C",415).
component("YOR330C",403).
component("YOL115W",387).
component("YNL299W",369).
component("YNL262W",367).
component("YNL102W",358).
component("YJR043C",282).
component("YJR006W",279).
component("YJL090C",270).
component("YIL139C",261).
component("YEL055C",179).
component("YDR419W",169).
component("YDR121W",148).
component("YDL102W",134).
component("YCR014C",123).
component("YBR278W",114).
component("YBL035C",92).
component("YPR113W",434).
component("YPL148C",414).
component("YGR286C",237).
component("YOL011W",377).
component("YMR008C",345).
component("YMR006C",344).
component("U105_",22).
component("YBL015W",90).
component("U77_",82).
component("YLR377C",338).
component("YHR046C",244).
component("U9_",86).
component("YPR073C",431).
component("YOR208W",398).
component("YNL053W",356).
component("YMR036C",346).
component("YIR026C",267).
component("YIL113W",259).
component("YFR028C",198).
component("YER075C",188).
component("YDL230W",142).
component("YBR276C",113).
component("U30_",59).
component("U29_",58).
component("U26_",57).
component("U24_",56).
component("YHR044C",243).
component("YHR043C",242).
component("YOR360C",407).
component("YGL027C",207).
component("YOR190W",396).
component("YLR300W",332).
component("YGR282C",236).
component("YDR261C",160).
component("YDR400W",166).
component("YML035C",341).
component("YJL070C",269).
component("YBR284W",115).
component("YDR242W",158).
component("U53_",69).
component("YPR062W",430).
component("YMR120C",348).
component("YLR028C",314).
component("YHR144C",251).
component("YBL033C",91).
component("YNL141W",361).
component("YLR245C",328).
component("YJL126W",271).
component("U39_",61).
component("YBR011C",96).
component("YBR111C",103).
component("YBR252W",112).
component("YER005W",181).
component("YBL099W",95).
component("YLR231C",327).
component("YLR134W",321).
component("YLR044C",316).
component("YGR087C",226).
component("YDR380W",165).
component("YDL080C",133).
component("U98_",85).
component("YOR128C",393).
component("YKL211C",301) :- not remove_orf("YKL211C",301).
component("YKR097W",310).
component("YNL169C",364).
component("YEL046C",178).
...
component("YOR393W",409).
component("YMR323W",352).
component("YHR174W",252).
component("YGR254W",234).
component("YGL026C",206) :- not remove_orf("YGL026C",206).
component("YLR304C",334).
component("YJL200C",278).
component("YNL316C",370).
component("YPR002W",427).
component("YJR016C",280).
component("YCR053W",128).
component("YDR127W",153).
component("YGL148W",212).
component("YIL168W",266).
component("YIL167W",265).
component("YCL064C",121).
component("YAL012W",87).
component("YBR019C",98).
component("YDR007W",143) :- not remove_orf("YDR007W",143).
component("YOR095C",391).
component("YGL001C",202).
component("YPL117C",413).
component("YOL056W",382).
component("YKL152C",298).
component("YDL021W",129).
component("YPR060C",429).
component("YPL097W",411).
component("YGR185C",231).
component("YGR264C",235).
component("YGR171C",229).
component("YPL104W",412).
component("YLL018C",311).
component("YOL097C",385).
component("YDR268W",161).
component("YCR024C",124).
component("YHR019C",241).
component("YOR335C",404).
component("YLR153C",323).
component("YAL054C",88).
component("YIL145C",262).
component("YOL049W",380).
component("U90_",83).
component("YNR057C",374).
component("YGL234W",218).
component("YJR103W",289).
component("YBL039C",93).
component("YBR084W",102).
component("YHR074W",248).
component("YGL062W",208).
component("YBR218C",110).
...
component("YPL036W",410).
component("YOR171C",395).
component("YOR011W",390).
component("YOL103W",386).
component("YOL020W",379) :- not remove_orf("YOL020W",379).
component("YNL270C",368).
component("YNL142W",362).
component("YLR260W",330).
component("YLR100C",320).
component("YKR053C",307).
component("YKR039W",306) :- not remove_orf("YKR039W",306).
component("YJR077C",287).
component("YJL134W",274).
component("YJL129C",272).
component("YHL036W",240).
component("YGR121C",228).
component("YGR065C",225).
component("YGR055W",224).
component("YGL186C",213).
component("YGL077C",210).
component("YGL008C",203).
component("YFL055W",195).
component("YER060W-A",186).
component("YER060W",185).
component("YER056C",184).
component("YER053C",183).
component("YEL063C",180).
component("YEL017C-A",176).
component("YDR536W",175).
component("YDR508C",174).
component("YDR503C",173).
component("YDR497C",172).
component("YDR297W",162).
component("YDR046C",147) :- not remove_orf("YDR046C",147).
component("YCR032W",126).
component("YCR024C-A",125).
component("YCL025C",119).
component("YBR298C",116).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,164) :- not remove_reaction(3620,164).
catalyst(2190,199).
catalyst(5791,326).
catalyst(5792,326).
catalyst(5801,326).
...
catalyst(6111,393).
catalyst(6112,393).
catalyst(3600,301) :- not remove_reaction(3600,301).
catalyst(8000,310).
catalyst(6890,364).
catalyst(4560,178).
...
catalyst(8231,234).
catalyst(8232,234).
catalyst(3590,206) :- not remove_reaction(3590,206).
catalyst(10910,206) :- not remove_reaction(10910,206).
catalyst(8181,334).
catalyst(8182,334).
catalyst(8181,278).
catalyst(8182,278).
...
catalyst(7751,98).
catalyst(7752,98).
catalyst(3610,143) :- not remove_reaction(3610,143).
catalyst(7921,391).
catalyst(7922,391).
catalyst(6370,202).
catalyst(6461,413).
...
catalyst(22,390).
catalyst(1160,386).
catalyst(801,379) :- not remove_reaction(801,379).
catalyst(802,379) :- not remove_reaction(802,379).
catalyst(811,379) :- not remove_reaction(811,379).
catalyst(812,379) :- not remove_reaction(812,379).
catalyst(831,379) :- not remove_reaction(831,379).
catalyst(832,379) :- not remove_reaction(832,379).
catalyst(901,379) :- not remove_reaction(901,379).
catalyst(902,379) :- not remove_reaction(902,379).
catalyst(931,368).
catalyst(932,368).
catalyst(371,362).
catalyst(372,362).
...
catalyst(6330,320).
catalyst(6560,307).
catalyst(771,306) :- not remove_reaction(771,306).
catalyst(772,306) :- not remove_reaction(772,306).
catalyst(781,306) :- not remove_reaction(781,306).
catalyst(782,306) :- not remove_reaction(782,306).
...
catalyst(881,306) :- not remove_reaction(881,306).
catalyst(882,306) :- not remove_reaction(882,306).
catalyst(901,306) :- not remove_reaction(901,306).
catalyst(902,306) :- not remove_reaction(902,306).
catalyst(931,306) :- not remove_reaction(931,306).
catalyst(932,306) :- not remove_reaction(932,306).
catalyst(1191,306) :- not remove_reaction(1191,306).
catalyst(1192,306) :- not remove_reaction(1192,306).
catalyst(1581,287).
catalyst(1582,287).
catalyst(6560,274).
catalyst(361,272).
