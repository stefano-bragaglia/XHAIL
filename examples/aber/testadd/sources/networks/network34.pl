...
component("YLR056W",214).
component("YPL231W",291).
component("U46_",43).
component("YBR149W",64).
component("YGL001C",136).
component("YIL094C",171).
component("U45_",42).
component("YDR127W",94).
component("YOL126C",265).
component("YKL085W",196).
component("YDL078C",80).
component("YNL037C",241).
component("YLR355C",230).
component("YDL174C",86).
component("YML086C",234).
component("YGR088W",152).
component("YDR256C",103).
component("YJR078W",190).
component("U107_",20).
component("YER070W",128).
component("U36_",39).
component("YPL276W",297).
component("YPL275W",296).
component("YOR388C",282).
component("YOR323C",276).
component("YIL125W",172).
component("U52_",45).
component("YBR166C",66).
component("YKL216W",203).
component("YKR009C",204).
component("YIL160C",174).
component("YGL205W",147).
component("YKR080W",208).
component("YER023W",124).
component("YGR204W",156).
component("YLR142W",219).
component("U62_",47).
component("YHR068W",162).
component("YKL150W",199).
component("YIL043C",169).
component("YPL171C",290).
component("YHR179W",167).
component("YDR353W",107).
component("YPL266W",295).
component("YKR069W",207).
component("YDL033C",79).
component("YLR172C",221).
component("YLR058C",215).
component("YDR019C",89).
component("YBR176W",67).
component("YDR408C",112).
component("YMR120C",238).
component("YLR028C",211).
component("YJL130C",181).
component("YKL024C",194).
component("YPR074C",301).
component("YBR117C",63).
component("YPL231W",292).
component("YPL231W",293).
component("YLR299W",227).
component("YML126C",235).
component("YDL182W",87).
component("YDL131W",83).
component("YLR258W",225).
component("YFR015C",133).
component("YNL029C",240).
component("YIL085C",170).
component("YLR209C",222).
component("U104_",18).
component("YDR354W",108) :- not remove_orf("YDR354W",108).
component("YFR047C",134).
component("YLR209C",223).
component("YML022W",232).
component("YDR441C",114).
component("YJL167W",185).
component("YDR127W",95).
component("YLR303W",229).
component("YJR130C",192).
component("YDR035W",90).
component("YBR249C",69).
component("YOR274W",275).
component("YHR137W",163).
component("YGL202W",146).
component("YLR027C",210).
component("YKL106W",197).
component("YLR089C",216).
component("YJR148W",193).
component("YNR058W",256).
component("YGL253W",148).
component("YFR053C",135).
component("YCR036W",78).
component("U96_",50).
component("YNR012W",254).
component("YDR127W",96).
component("YDR147W",99).
component("U76_",48).
component("YDR226W",101).
component("YKL067W",195).
component("YOL055C",260).
component("YDR454C",115).
component("YOL061W",261).
component("YKL181W",200).
component("YHL011C",160).
component("YER099C",130).
component("YBL068W",57).
component("YNL256W",248).
component("YBR018C",59).
component("YGL130W",143).
component("YPR190C",307).
component("YPR187W",306).
component("YPR110C",302).
component("YPR010C",299).
component("YOR341W",280).
component("YOR340C",279).
component("YOR224C",274).
component("YOR210W",273).
component("YOR207C",272).
component("YOR151C",269).
component("YOR116C",268).
component("YOL005C",257).
component("YNR003C",253).
component("YNL248C",247).
component("YNL151C",246).
component("YNL113W",243).
component("YKL144C",198).
component("YJR063W",188).
component("YJL148W",184).
component("YJL140W",183).
component("YIL021W",168).
component("YHR143W-A",164).
...
component("YPR175W",305).
component("YPL167C",289).
component("YOR330C",277).
component("YOL115W",264).
component("YNL299W",251).
component("YNL262W",249).
component("YNL102W",242).
component("YJR043C",187).
component("YJR006W",186).
component("YJL090C",178).
component("YIL139C",173).
...
component("YPR113W",303).
component("YPL148C",288).
component("YOL011W",258).
component("YMR008C",237).
component("YMR006C",236).
component("U105_",19).
component("YBL015W",54).
component("YLR377C",231).
component("U30_",38).
component("U29_",37).
component("U24_",36).
component("YOR360C",281).
component("YGL027C",140).
component("YOR190W",271).
component("YLR300W",228).
component("YGR282C",159).
component("YDR261C",104).
component("YDR400W",110).
component("YML035C",233).
component("YJL070C",177).
component("YBR284W",72).
component("YDR242W",102).
component("U53_",46).
component("YLR028C",212).
component("YHR144C",165).
component("YNL141W",244).
component("YJL126W",179).
component("U39_",40).
component("YBR011C",58).
component("YBR111C",62).
component("YBR252W",70).
component("YER005W",123).
component("YLR231C",224).
component("YLR134W",218).
component("YLR044C",213).
component("YGR087C",151).
component("YDR380W",109).
component("YDL080C",81).
component("U98_",51).
component("YKL211C",201) :- not remove_orf("YKL211C",201).
component("YKL211C",202) :- not remove_orf("YKL211C",202).
component("YER090W",202) :- not remove_orf("YER090W",202).
component("YER090W",129) :- not remove_orf("YER090W",129).
component("YDR127W",97).
component("YPL281C",298).
component("YOR393W",283).
component("YMR323W",239).
component("YHR174W",166).
component("YGR254W",157).
component("YGL026C",139) :- not remove_orf("YGL026C",139).
component("YNL316C",252).
component("YDR127W",98).
component("YGL148W",144).
component("YIL168W",176).
component("YIL167W",175).
component("YCL064C",75).
component("YAL012W",52).
component("YDR007W",88) :- not remove_orf("YDR007W",88).
component("YOR095C",267).
component("YGL001C",137).
component("YPL117C",287).
component("YPR060C",300).
component("YPL097W",285).
component("YGR185C",155).
component("YGR264C",158).
component("YGR171C",154).
component("YPL104W",286).
component("YLL018C",209).
component("YOL097C",262).
component("YDR268W",105).
component("YOR335C",278).
component("YLR153C",220).
component("YAL054C",53).
component("U90_",49).
component("YNR057C",255).
component("YJR103W",191).
component("YBL039C",56).
component("YGL062W",141).
component("YBR218C",68).
component("YPR138C",304).
component("YPL265W",294).
component("YPL036W",284).
component("YOR171C",270).
component("YOR011W",266).
component("YOL103W",263).
component("YOL020W",259) :- not remove_orf("YOL020W",259).
component("YNL270C",250).
component("YNL142W",245).
component("YLR260W",226).
component("YLR100C",217).
component("YKR053C",206).
component("YKR039W",205) :- not remove_orf("YKR039W",205).
component("YJR077C",189).
component("YJL134W",182).
component("YJL129C",180).
component("YHL036W",161).
...
catalyst(8812,81).
catalyst(2250,51).
catalyst(3600,201) :- not remove_reaction(3600,201).
...
catalyst(6330,217).
catalyst(6560,206).
catalyst(771,205) :- not remove_reaction(771,205).
catalyst(772,205) :- not remove_reaction(772,205).
catalyst(781,205) :- not remove_reaction(781,205).
catalyst(782,205) :- not remove_reaction(782,205).
...
catalyst(881,205) :- not remove_reaction(881,205).
catalyst(882,205) :- not remove_reaction(882,205).
catalyst(901,205) :- not remove_reaction(901,205).
catalyst(902,205) :- not remove_reaction(902,205).
catalyst(931,205) :- not remove_reaction(931,205).
catalyst(932,205) :- not remove_reaction(932,205).
catalyst(1191,205) :- not remove_reaction(1191,205).
catalyst(1192,205) :- not remove_reaction(1192,205).
catalyst(1581,189).
catalyst(1582,189).
catalyst(6560,182).
catalyst(361,180).
