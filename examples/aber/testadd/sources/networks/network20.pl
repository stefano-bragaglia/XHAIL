...
component("YLR056W",147).
component("YPL231W",189).
component("U46_",35).
component("YIL094C",120).
component("U45_",34).
component("YDR127W",71).
component("YOL126C",177).
component("YDL078C",62).
component("YNL037C",161).
component("YML086C",157).
component("YGR088W",106).
component("YDR256C",78).
component("YJR078W",130).
component("U107_",19).
component("YER070W",95).
component("U36_",32).
component("YPL276W",195).
component("YPL275W",194).
component("YOR388C",183).
component("YOR323C",180).
component("YIL125W",121).
component("U52_",36).
component("YBR166C",52).
component("YKL216W",139).
component("YKR009C",140).
component("YIL160C",123).
component("YGL205W",104).
component("YKR080W",142).
component("YER023W",91).
component("YLR142W",150).
component("U62_",38).
component("YHR068W",114).
component("YKL150W",135).
component("YIL043C",118).
component("YPL266W",193).
component("YDL033C",61).
component("YLR058C",148).
component("YDR019C",67).
component("YBR176W",53).
component("YDR408C",82).
component("YMR120C",158).
component("YLR028C",145).
component("YPR074C",198).
component("YBR117C",51).
component("YPL231W",190).
component("YPL231W",191).
component("YDL182W",65).
component("YDL131W",64).
component("YNL029C",160).
component("YIL085C",119).
component("YLR209C",152).
component("YDR354W",80) :- not remove_orf("YDR354W",80).
component("YFR047C",99).
component("YLR209C",153).
component("YML022W",155).
component("YDR441C",84).
component("YJL167W",126).
component("YDR127W",72).
component("YDR035W",68).
component("YBR249C",54).
component("YOR274W",179).
component("YHR137W",115).
component("YLR027C",144).
component("YKL106W",134).
component("YJR148W",132).
component("YNR058W",171).
component("YCR036W",60).
component("U96_",40).
component("YNR012W",169).
component("YDR127W",73).
component("YDR226W",76).
component("YKL067W",133).
component("YDR454C",85).
component("YOL061W",173).
component("YKL181W",136).
component("YHL011C",112).
component("YER099C",97).
component("YBL068W",46).
component("YNL256W",164).
component("YBR018C",47).
component("YPR175W",200).
component("YPL167C",188).
component("YOR330C",181).
component("YOL115W",176).
component("YNL299W",167).
component("YNL262W",165).
component("YNL102W",162).
component("YJR043C",128).
component("YJR006W",127).
component("YJL090C",125).
component("YIL139C",122).
component("YEL055C",89).
component("YDR419W",83).
component("YDR121W",70).
component("YDL102W",63).
component("YCR014C",59).
component("YBR278W",56).
component("YBL035C",44).
component("U105_",18).
component("U30_",31).
component("U29_",30).
component("U24_",29).
component("YGL027C",101).
component("YDR400W",81).
component("YML035C",156).
component("YJL070C",124).
component("YBR284W",57).
component("YDR242W",77).
component("U53_",37).
component("YLR028C",146).
component("YHR144C",116).
component("U39_",33).
component("YBR111C",50).
component("YBR252W",55).
...
component("YER090W",96) :- not remove_orf("YER090W",96).
component("YDR127W",74).
component("YPL281C",196).
component("YOR393W",184).
component("YMR323W",159).
component("YHR174W",117).
component("YGR254W",110).
component("YGL026C",100) :- not remove_orf("YGL026C",100).
component("YNL316C",168).
component("YDR127W",75).
component("YGL148W",102).
component("YAL012W",42).
component("YDR007W",66) :- not remove_orf("YDR007W",66).
component("YOR095C",178).
component("YPL117C",187).
component("YPR060C",197).
component("YPL097W",185).
component("YGR185C",109).
component("YGR264C",111).
component("YGR171C",108).
component("YPL104W",186).
component("YLL018C",143).
component("YOL097C",174).
component("YOR335C",182).
component("YLR153C",151).
component("YAL054C",43).
component("U90_",39).
component("YNR057C",170).
component("YJR103W",131).
component("YBL039C",45).
component("YPR138C",199).
component("YPL265W",192).
component("YOL103W",175).
component("YOL020W",172) :- not remove_orf("YOL020W",172).
component("YNL270C",166).
component("YNL142W",163).
component("YLR100C",149).
component("YKR039W",141) :- not remove_orf("YKR039W",141).
component("YJR077C",129).
component("YHL036W",113).
component("YGR121C",107).
component("YGR055W",105).
component("YGL186C",103).
component("YFL055W",98).
component("YER060W-A",94).
component("YER060W",93).
component("YER056C",92).
component("YEL063C",90).
component("YDR536W",88).
component("YDR508C",87).
component("YDR497C",86).
component("YDR297W",79).
component("YDR046C",69) :- not remove_orf("YDR046C",69).
...
catalyst(5601,152).
catalyst(5602,152).
catalyst(3620,80) :- not remove_reaction(3620,80).
catalyst(2190,99).
catalyst(5791,153).
catalyst(5792,153).
catalyst(5801,153).
...
catalyst(3630,96) :- not remove_reaction(3630,96).
catalyst(3740,74).
catalyst(8231,196).
catalyst(8232,196).
catalyst(8231,184).
...
catalyst(8231,110).
catalyst(8232,110).
catalyst(3590,100) :- not remove_reaction(3590,100).
catalyst(10910,100) :- not remove_reaction(10910,100).
catalyst(3680,168).
catalyst(3750,75).
catalyst(3700,102).
catalyst(4460,42).
catalyst(3610,66) :- not remove_reaction(3610,66).
catalyst(7921,178).
catalyst(7922,178).
catalyst(6461,187).
catalyst(6462,187).
...
catalyst(781,141) :- not remove_reaction(781,141).
catalyst(782,141) :- not remove_reaction(782,141).
...
catalyst(881,141) :- not remove_reaction(881,141).
catalyst(882,141) :- not remove_reaction(882,141).
catalyst(931,141) :- not remove_reaction(931,141).
catalyst(932,141) :- not remove_reaction(932,141).
catalyst(1191,141) :- not remove_reaction(1191,141).
catalyst(1192,141) :- not remove_reaction(1192,141).
catalyst(1581,129).
catalyst(1582,129).
catalyst(841,113).
catalyst(842,113).
...
catalyst(841,69) :- not remove_reaction(841,69).
catalyst(842,69) :- not remove_reaction(842,69).
