...
component("YNL280C",902).
component("YLR056W",769).
component("YGR060W",534).
component("YGL012W",500).
component("YKR009C",745).
component("YOL086C",936).
component("YMR303C",869).
component("YMR083W",843).
component("YGL256W",526).
component("YDL168W",339).
component("YBR145W",262).
component("YPL231W",1029).
component("YBR265W",281).
component("U46_",155).
component("YBR149W",263).
component("YBR149W",264).
component("YJR159W",708).
component("YGL001C",496).
component("YIL094C",626).
component("YHR063C",589).
component("U45_",154).
component("YML056C",824).
component("YLR432W",813).
component("YHR216W",614).
component("YAR075W",217).
component("YAR073W",216).
component("YDR127W",375).
component("YJR139C",703).
component("YML075C",827).
component("YLR450W",816).
component("YOL126C",942).
component("YKL085W",719).
component("YDL078C",318).
component("YKL029C",714).
component("YOR136W",961).
component("YNL037C",875).
component("YNL009W",873).
component("YLR174W",783).
component("YHR183W",607).
component("YGR256W",565).
component("YNL241C",891).
component("YOL059W",933).
component("YDL022W",309).
component("YCL018W",289).
component("YLR355C",808).
component("YIL074C",623).
component("YER081W",461).
component("YML054C",823).
component("YDL174C",343).
component("YML086C",829).
component("YIL155C",636).
component("YPR191W",1069).
component("YOR065W",951).
component("YJL166W",672).
component("YHR001W-A",576).
component("YGR183C",550).
component("YFR033C",492).
component("YEL024W",429).
component("YDR529C",420).
component("YBL045C",225).
component("Q0105",19).
component("YKR066C",750).
component("YGR088W",538).
component("YDR256C",391).
component("YKL026C",713).
component("YIR037W",648).
component("YBR244W",276).
component("YJR078W",695).
component("U58_",164).
component("YJR025C",686).
component("U107_",28).
component("YGR255C",564).
component("U108_",29).
component("YHR007C",577).
component("YDR402C",407).
component("YGL055W",507).
component("YJR104C",698).
component("YHR008C",578).
component("YOR384W",998).
component("YOR381W",997).
component("YOL152W",946).
component("YLL051C",761).
component("YJL026W",650).
component("YIL066C",622).
component("YGR180C",549).
component("YER070W",458).
component("U37_",148).
component("U36_",147).
component("U35_",146).
component("YDL168W",340).
component("YDR158W",383).
component("YJR009C",682).
component("YJL052W",652).
component("YGR192C",552).
component("YBR006W",234).
component("YPL276W",1040).
component("YPL275W",1039).
component("YOR388C",999).
component("YPL061W",1008).
component("YOR374W",994).
component("YER073W",459).
component("YGL154C",516).
component("YBR115C",257).
component("U55_",163).
component("YER069W",456).
component("YOR323C",984).
component("YMR170C",853).
component("YMR169C",852).
component("U2_",140).
component("YER178W",475).
component("YBR221C",274).
component("YIL125W",632).
component("U52_",160).
component("YBR166C",267).
component("YNL280C",903).
component("YGL012W",501).
component("YKL182W",731).
component("YKL216W",742).
component("YDR044W",358).
component("YER014W",440).
component("YKR009C",746).
component("YIL160C",638).
component("YGL205W",521).
component("YMR118C",847).
component("YLR164W",781).
component("YLL041C",759).
component("YKL148C",725).
component("YKL141W",723).
component("YJL045W",651).
component("YDR178W",385).
component("YJR051W",689).
component("YEL047C",433).
component("YDL171C",341).
component("YDL171C",342).
component("YOR375C",995).
component("YDL215C",347).
component("YAL062W",212).
component("U99_",205).
component("U100_",22).
component("YBR035C",243).
component("YMR189W",855).
component("YKR080W",752).
component("YER023W",442).
component("YPL023C",1003).
component("YGL125W",513).
component("YOR236W",979).
component("YGR204W",556).
component("YBR084W",250).
component("YIR034C",647).
component("YLR142W",778).
component("U65_",172).
component("U63_",170).
component("U62_",169).
component("YOR356W",992).
component("YHR068W",590).
component("YKL150W",726).
component("YIL043C",619).
component("YHR042W",584).
component("YOR221C",976).
component("YMR145C",850).
component("YML120C",831).
component("YKL192C",735).
component("YKL055C",716).
component("YER061C",452).
component("YDL085W",320).
component("YPL171C",1018).
component("YHR179W",606).
component("YMR145C",851).
component("YML120C",832).
component("YKL192C",736).
component("YDL085W",321).
component("YGR234W",559).
component("YFR030W",491).
component("YPL017C",1002).
component("YFL018C",479).
component("YPL091W",1010).
component("YDR353W",402).
component("YER042W",444).
component("YPR167C",1063).
component("YJR137C",702).
component("YNL052W",877).
component("YMR256C",864).
component("YLR395C",812).
component("YLR038C",767).
component("YIL111W",629).
component("YHR051W",588).
component("YGL191W",519).
component("YGL187C",518).
component("YDL067C",317).
component("Q0275",21).
component("Q0250",20).
component("Q0045",18).
component("YDR072C",367).
component("YPL266W",1036).
component("YPL273W",1038).
component("YLL062C",763).
component("YDR410C",410).
component("YKR069W",751).
component("YOL096C",937).
component("U47_",156).
component("YER091C",466).
component("YJR073C",693).
component("YGR157W",545).
component("YDR120C",373).
component("YML008C",818).
component("YOR074C",953).
component("YDL033C",311).
component("YOL096C",938).
component("YLR172C",782).
component("YLR058C",770).
component("YDR019C",354).
component("YBR176W",268).
component("YDR408C",409).
component("YMR120C",848).
component("YLR028C",765).
component("YBL013W",218).
component("YJL130C",664).
component("YJL088W",657).
component("YKL024C",711).
component("YPR074C",1054).
component("YBR117C",258).
component("YLR354C",807).
component("YGR043C",532).
component("YMR108W",846).
component("YCL009C",288).
component("YMR062C",841).
component("YNL071W",879).
component("YNR008W",909).
component("YIL160C",639).
component("YNR019W",912).
component("YCR048W",304).
component("U48_",157).
component("YNL277W",901).
component("YMR062C",842).
component("YDR232W",388).
component("YPL231W",1030).
component("YER061C",453).
component("YPL001W",1001).
component("YDL052C",315).
component("U8_",197).
component("YDR148C",381).
component("YAR035W",214).
component("YOR377W",996).
component("YGR177C",548).
component("YPL231W",1031).
component("YPL028W",1004).
component("YLR299W",794).
component("YGL017W",502).
component("YCR005C",296).
component("YML126C",833).
component("YNL104C",882).
component("YDL182W",344).
component("YDL131W",330).
component("YPR160W",1062).
component("YOR321W",983).
component("YJR143C",704).
component("YGR199W",554).
component("YDR307W",398).
component("YDL095W",325).
component("YDL093W",324).
component("YAL023C",208).
component("YLR258W",791).
component("YFR015C",487).
component("YPL227C",1027).
component("YNL029C",874).
component("YIL085C",625).
component("YNL192W",889).
component("YBR038W",245).
component("YBR023C",241).
component("YEL011W",425).
component("YMR306W",871).
component("YLR342W",805).
component("YGR032W",530).
component("YPR183W",1066).
component("YBR248C",277).
component("YLR209C",785).
component("U104_",25).
component("U103_",24).
component("YMR271C",865).
component("YML106W",830).
component("YOR209C",974).
component("YMR300C",868).
component("YER055C",448).
component("YDR354W",403) :- not remove_orf("YDR354W",403).
component("YFR047C",493).
component("YJR133W",701).
component("U22_",132).
component("YLR209C",786).
component("YML022W",820).
component("YDR441C",413).
component("YHR128W",599).
component("YPR176C",1065).
component("YPL172C",1019).
component("YNR041C",916).
component("YMR101C",844).
component("YDL090C",323).
component("YBR003W",233).
component("YBR002C",232).
component("YJL167W",673).
component("YJL167W",674).
component("YNL256W",894).
component("YPR069C",1051).
component("YDR127W",376).
component("YHR190W",609).
component("YLR146C",779).
component("YPL214C",1025).
component("YHR068W",591).
component("YLR303W",796).
component("YGR012W",528).
component("YML082W",828).
component("YJR130C",700).
component("YLR303W",797).
component("YDR035W",356).
component("YBR249C",278).
component("YLR180W",784).
component("YDR502C",417).
component("YOR274W",980).
component("YOL143C",945).
component("YBR256C",280).
component("YHR137W",600).
component("YGL202W",520).
component("YLR027C",764).
component("YKL106W",720).
component("YOL140W",944).
component("YLR438W",815).
component("YGR019W",529).
component("YLR089C",774).
component("YDR111C",372).
component("U64_",171).
component("U61_",168).
component("U51_",159).
component("YJR148W",705).
component("YHR208W",612).
component("YFL030W",481).
component("YOR184W",967).
component("YNR058W",920).
component("YIL116W",631).
component("YGL253W",525).
component("YFR053C",494).
component("YOL136C",943).
component("YIL107C",628).
component("YMR013C",837).
component("YMR205C",857).
component("YGR240C",560).
component("YOL016C",924).
component("YFR014C",486).
component("YLR240W",789).
component("YKL203C",738).
component("YJR066W",692).
component("YCR036W",303).
component("YGR194C",553).
component("YCL040W",292).
component("U15_",72).
component("YPL188W",1021).
component("YJR049C",688).
component("YEL041W",430).
component("U96_",203).
component("YKL001C",709).
component("YDR236C",389).
component("YML070W",826).
component("YFL053W",483).
component("YHL032C",574).
component("YDR531W",422).
component("U83_",191).
component("U82_",190).
component("U81_",189).
component("YMR208W",858).
component("YPL203W",1022).
component("YOR061W",950).
component("YKL166C",728).
component("YJL164C",671).
component("YIL035C",618).
component("YHR205W",611).
component("YHR102W",597).
component("YGL019W",503).
component("YHR025W",583).
component("YOR347C",990).
component("YAL038W",210).
component("YNR012W",910).
component("YPR121W",1059).
component("YPL258C",1033).
component("YOL055C",929).
component("YPL214C",1026).
component("U1_",109).
component("YDR009W",353).
component("YNL267W",898).
component("YLR305C",799).
component("YFR019W",488).
component("YDR208W",386).
component("YDR127W",377).
component("U21_",123).
component("U20_",118).
component("YDR147W",380).
component("YDR300C",397).
component("YCR012W",297).
component("YER052C",446).
component("YER069W",457).
component("U19_",108).
component("YKL024C",712).
component("U18_",98).
component("U17_",88).
component("U76_",183).
component("YMR220W",860).
component("YER170W",474).
component("YDR226W",387).
component("YKL067W",718).
component("YOL055C",930).
component("YDR454C",414).
component("YJR057W",690).
component("YOL061W",934).
component("YKL181W",730).
component("YHL011C",572).
component("YER099C",468).
component("YBL068W",228).
component("YOR143C",963).
component("YNL256W",895).
component("YLR328W",803).
component("YBR018C",236).
component("YBR018C",237).
component("YGR007W",527).
component("YGR202C",555).
component("YLR328W",804).
component("YKR002W",744).
component("YDL045C",313).
component("U80_",188).
component("YDL103C",328).
component("U94_",202).
component("YJR010W",683).
component("YBR029C",242).
component("YCL050C",293).
component("YGL130W",514).
component("YDR530C",421).
component("YCL050C",294).
component("YPR190C",1068).
component("YPR187W",1067).
component("YPR110C",1057).
component("YPR010C",1044).
component("YOR341W",989).
component("YOR340C",988).
component("YOR224C",978).
component("YOR210W",975).
component("YOR207C",972).
component("YOR151C",964).
component("YOR116C",956).
component("YOL005C",922).
component("YNR003C",908).
component("YNL248C",893).
component("YNL151C",886).
component("YNL113W",883).
component("YKL144C",724).
component("YJR063W",691).
component("YJL148W",668).
component("YJL140W",667).
component("YIL021W",617).
component("YHR143W-A",601).
component("YGL070C",511).
component("YFL036W",482).
component("YDR404C",408).
component("YDR156W",382).
component("YDR045C",359).
component("YDL150W",338).
component("YDL140C",332).
component("YBR154C",266).
component("YPR175W",1064).
component("YPL167C",1017).
component("YOR330C",985).
component("YOL115W",941).
component("YNL299W",905).
component("YNL262W",897).
component("YNL102W",881).
component("YJR043C",687).
component("YJR006W",681).
component("YJL090C",658).
component("YIL139C",634).
component("YEL055C",434).
component("YDR419W",411).
component("YDR121W",374).
component("YDL102W",327).
component("YCR014C",298).
component("YBR278W",283).
component("YBL035C",222).
component("YKL035W",715).
component("YHL012W",573).
component("YHR123W",598).
component("YPR113W",1058).
component("YBR243C",275).
component("YDL142C",337).
component("YPL148C",1015).
component("YER026C",443).
component("YGR286C",569).
component("YJL068C",653).
component("YHR189W",608).
component("YDR058C",364).
component("YNR034W",915).
component("YHR163W",604).
component("YGR248W",562).
component("YCR073W-A",306).
component("YDL086W",322).
component("YOL011W",923).
component("YMR008C",835).
component("YMR006C",834).
component("U105_",26).
component("YBL015W",219).
component("YJL068C",654).
component("YPL072W",1009).
component("YOR124C",957).
component("YNL186W",888).
component("YMR304W",870).
component("YMR223W",861).
component("YKR098C",756).
component("YJL197W",675).
component("YIL156W",637).
component("YFR010W",485).
component("YER151C",472).
component("YER144C",471).
component("YER098W",467).
component("YDR069C",366).
component("YDL122W",329).
component("YBR058C",246).
component("YBL067C",227).
component("YJR019C",685).
component("YOR040W",949).
component("U84_",192).
component("U77_",184).
component("YDR481C",415).
component("YLR377C",810).
component("YDR074W",368).
component("YFR025C",489).
component("YPL179W",1020).
component("YNR032W",913).
component("YML057W",825).
component("YML016C",819).
component("YLR433C",814).
component("YGR123C",541).
component("YER133W",470).
component("YER089C",464).
component("YDR436W",412).
component("YDR075W",369).
component("YDL188C",345).
component("YDL134C",331).
component("YDL047W",314).
component("YDL006W",307).
component("YBR125C",261).
component("YBL056W",226).
component("YPR073C",1052).
component("YHR215W",613).
component("YDL024C",310).
component("YBR093C",255).
component("YBR092C",254).
component("YAR071W",215).
component("YIL053W",621).
component("YER062C",454).
component("YHR046C",587).
component("U9_",206).
component("YPL228W",1028).
component("YMR180C",854).
component("YDL236W",349).
component("YJL155C",670).
component("YPR073C",1053).
component("YOR208W",973).
component("YNL053W",878).
component("YMR036C",839).
component("YIR026C",645).
component("YIL113W",630).
component("YFR028C",490).
component("YER075C",460).
component("YDL230W",348).
component("YBR276C",282).
component("U34_",145).
component("U33_",144).
component("U32_",143).
component("U31_",142).
...
component("U25_",135).
component("U24_",134).
component("YHR044C",586).
component("YHR043C",585).
component("YOL064C",935).
component("YPL268W",1037).
component("YOR360C",993).
component("YGL248W",524).
component("YKR031C",747).
component("YPL206C",1023).
component("YGL027C",505).
component("YLR286C",793).
component("YJR153W",706).
component("YJL221C",680).
component("YJL216C",678).
component("YIL172C",643).
component("YGR292W",571).
component("YGR287C",570).
component("YBR299W",287).
component("YBR184W",269).
component("YIL162W",640).
component("YPR026W",1045).
component("YDR001C",351).
component("YBR001C",231).
component("YIR019C",644).
component("YIL099W",627).
component("YDL037C",312).
component("YOR190W",969).
component("YLR300W",795).
component("YGR282C",568).
component("YDR261C",392).
component("YDR400W",406).
component("U23_",133).
component("YML035C",821).
component("YJL070C",655).
component("YBR284W",284).
component("U106_",27).
component("U102_",23).
component("YER043C",445).
component("YNL045W",876).
component("YGL037C",506).
component("YDR242W",390).
component("YLR308W",802).
component("YLR307W",801).
component("YBR208C",271).
component("YMR281W",867).
component("U53_",161).
component("YIR032C",646).
component("YPR062W",1050).
component("YMR120C",849).
component("YLR028C",766).
component("YHR144C",602).
component("YHR144C",603).
component("YGR267C",567).
component("YCL030C",291).
component("YBL033C",221).
component("YBR153W",265).
component("YNL141W",884).
component("YLR245C",790).
component("YML035C",822).
component("YGR204W",557).
component("YBR084W",251).
component("YJL126W",662).
component("U44_",153).
component("YDL100C",326).
component("U87_",194).
component("U40_",151).
component("U39_",149).
component("YBR011C",235).
component("YHR201C",610).
component("YBR111C",256).
component("YBR252W",279).
component("YEL042W",431).
component("YPR080W",1055).
component("YOR187W",968).
component("YOR133W",960).
component("YLR069C",772).
component("YKR084C",753).
component("YKL173W",729).
component("YJL102W",660).
component("YDR385W",405).
component("YBR118W",259).
component("YER005W",439).
component("YLL001W",757).
component("YIL048W",620).
component("YER166W",473).
component("YDR093W",371).
component("YAL026C",209).
component("YBL099W",230).
component("U60_",167).
component("YLR231C",787).
component("U88_",195).
component("YDR538W",424).
component("YLR134W",776).
component("YLR044C",768).
component("YGR087C",537).
component("YDR380W",404).
component("YDL080C",319).
component("U98_",204).
component("YMR250W",863).
component("YKL184W",734).
component("YOR128C",958).
component("YEL021W",428).
component("YNR043W",917).
component("U93_",201).
component("YDR047W",361).
component("U54_",162).
component("YKL211C",740) :- not remove_orf("YKL211C",740).
component("YKR097W",755).
component("YOL052C",928).
component("YNL169C",887).
component("YGR170W",546).
component("YKL060C",717).
component("YNL256W",896).
component("YDR294C",395).
component("YEL046C",432).
component("YNR033W",914).
component("YPR006C",1043).
component("YER065C",455).
component("YKL211C",741) :- not remove_orf("YKL211C",741).
component("YER090W",741) :- not remove_orf("YER090W",741).
component("YER090W",465) :- not remove_orf("YER090W",465).
component("YDR127W",378).
component("YPL281C",1041).
component("YOR393W",1000).
component("YMR323W",872).
component("YHR174W",605).
component("YGR254W",563).
component("YOR202W",971).
component("YPL262W",1034).
component("YGL026C",504) :- not remove_orf("YGL026C",504).
component("YGR155W",544).
component("YLR304C",798).
component("YJL200C",676).
component("YGL009C",499).
component("YNL316C",906).
component("YKL182W",732).
component("YPL212C",1024).
component("YNL292W",904).
component("YGL063W",510).
component("YFL001W",477).
component("YOR278W",981).
component("YPR002W",1042).
component("YJR016C",684).
component("YCR053W",305).
component("YDR127W",379).
component("YGL148W",515).
component("YIL168W",642).
component("YIL167W",641).
component("YCL064C",295).
component("YER086W",462).
component("YLR359W",809).
component("YAL012W",207).
component("YML004C",817).
component("YFR055W",495).
component("YJL005W",649).
component("YJL121C",661).
component("YBR019C",238).
component("YBR019C",239).
component("U59_",165).
component("YDR050C",362).
component("YIL020C",616).
component("YDR007W",352) :- not remove_orf("YDR007W",352).
component("YOR095C",954).
component("YER003C",438).
component("YBR196C",270).
component("YGL001C",497).
component("YPL117C",1013).
component("U14_",64).
component("YOL056W",931).
component("YKL152C",727).
component("YDL021W",308).
component("YMR105C",845).
component("YKL127W",722).
component("YEL058W",435).
component("YPR060C",1049).
component("YHR072W",592).
component("YJL153C",669).
component("YPL097W",1011).
component("YGR185C",551).
component("YGR264C",566).
component("YGR171C",547).
component("YHR011W",579).
component("YDR023W",355).
component("YPL104W",1012).
component("YLL018C",758).
component("YPR081C",1056).
component("YBR121C",260).
component("YHR020W",582).
component("YER087W",463).
component("YNL247W",892).
component("YOL033W",926).
component("YOR168W",965).
component("YOL097C",939).
component("YDR268W",393).
component("YPR047W",1048).
component("YLR060W",771).
component("YFL022C",480).
component("YPR033C",1046).
component("YHR019C",580).
component("YCR024C",299).
component("YHR019C",581).
component("YKL194C",737).
component("YIL078W",624).
component("YPL160W",1016).
component("YLR382C",811).
component("YPL040C",1006).
component("YBL076C",229).
component("YNL073W",880).
component("YDR037W",357).
component("YOR335C",986).
component("YGR094W",539).
component("YLR153C",780).
component("YAL054C",211).
component("YOR317W",982).
component("YMR246W",862).
component("YIL009W",615).
component("YER015W",441).
component("YOR142W",962).
component("YGR244C",561).
component("YPR035W",1047).
component("YIL145C",635).
component("U89_",196).
component("YOR339C",987).
component("YMR022W",838).
component("YLR306W",800).
component("YKL210W",739).
component("YGR133W",543).
component("YGL058W",508).
component("YER100W",469).
component("YEL012W",426).
component("YDR177W",384).
component("YDR092W",370).
component("YDR059C",365).
component("YDR054C",363).
component("YDL064W",316).
component("YBR082C",249).
component("YJL101C",659).
component("YOL049W",927).
component("U92_",200).
component("YAR015W",213).
component("YGL234W",522).
component("YER183C",476).
component("U91_",199).
component("U90_",198).
component("YNR057C",919).
component("YDL141W",333).
component("YDL141W",334).
component("YGL234W",523).
component("YDL141W",335).
component("YJR103W",697).
component("YBL039C",223).
component("YGR204W",558).
component("YBR084W",252).
component("YNL220W",890).
component("YOL058W",932).
component("YBR208C",272).
component("YDL141W",336).
component("YHR074W",593).
component("YMR217W",859).
component("YGR061C",535).
component("YPR145W",1061).
component("YGR124W",542).
component("YJR109C",699).
component("YJL130C",665).
component("YGL062W",509).
component("YBR218C",273).
component("YPL231W",1032).
component("YNR016C",911).
component("YKL182W",733).
component("YGR037C",531).
component("YJL087C",656).
component("YPR138C",1060).
component("YPL265W",1035).
component("YPL134C",1014).
component("YPL057C",1007).
component("YPL036W",1005).
component("YOR348C",991).
component("YOR222W",977).
component("YOR192C",970).
component("YOR171C",966).
component("YOR130C",959).
component("YOR100C",955).
component("YOR071C",952).
component("YOR011W",948).
component("YOL156W",947).
component("YOL103W",940).
component("YOL020W",925) :- not remove_orf("YOL020W",925).
component("YNR072W",921).
component("YNR056C",918).
component("YNL318C",907).
component("YNL270C",900).
component("YNL268W",899).
component("YNL142W",885).
component("YMR272C",866).
component("YMR202W",856).
component("YMR056C",840).
component("YMR011W",836).
component("YLR348C",806).
component("YLR260W",792).
component("YLR237W",788).
component("YLR138W",777).
component("YLR100C",775).
component("YLR081W",773).
component("YLL061W",762).
component("YLL043W",760).
component("YKR093W",754).
component("YKR053C",749).
component("YKR039W",748) :- not remove_orf("YKR039W",748).
component("YKL217W",743).
component("YKL120W",721).
component("YKL004W",710).
component("YJR158W",707).
component("YJR095W",696).
component("YJR077C",694).
component("YJL219W",679).
component("YJL214W",677).
component("YJL134W",666).
component("YJL129C",663).
component("YIL134W",633).
component("YHR096C",596).
component("YHR094C",595).
component("YHR092C",594).
component("YHL036W",575).
component("YGR121C",540).
component("YGR065C",536).
component("YGR055W",533).
component("YGL186C",517).
component("YGL077C",512).
component("YGL008C",498).
component("YFL055W",484).
component("YFL011W",478).
component("YER060W-A",451).
component("YER060W",450).
component("YER056C",449).
component("YER053C",447).
component("YEL069C",437).
component("YEL063C",436).
component("YEL017C-A",427).
component("YDR536W",423).
component("YDR508C",419).
component("YDR503C",418).
component("YDR497C",416).
component("YDR345C",401).
component("YDR343C",400).
component("YDR342C",399).
component("YDR297W",396).
component("YDR284C",394).
component("YDR046C",360) :- not remove_orf("YDR046C",360).
component("YDL245C",350).
component("YDL210W",346).
component("YCR032W",302).
component("YCR028C",301).
component("YCR024C-A",300).
component("YCL025C",290).
component("YBR298C",286).
component("YBR291C",285).
component("YBR085W",253).
component("YBR069C",248) :- not remove_orf("YBR069C",248).
component("YBR068C",247) :- not remove_orf("YBR068C",247).
component("YBR036C",244).
component("YBR021W",240).
component("YBL042C",224).
component("YBL030C",220).
component("U85_",193).
component("U7_",187).
component("U79_",186).
component("U78_",185).
...
catalyst(6160,868).
catalyst(3870,448).
catalyst(3620,403) :- not remove_reaction(3620,403).
catalyst(2110,493).
catalyst(2190,493).
catalyst(5550,701).
catalyst(5301,132).
...
catalyst(1960,361).
catalyst(3460,162).
catalyst(3600,740) :- not remove_reaction(3600,740).
catalyst(8000,755).
catalyst(3941,928).
catalyst(3942,928).
catalyst(6890,887).
...
catalyst(8020,1043).
catalyst(8020,455).
catalyst(1890,741) :- not remove_reaction(1890,741).
catalyst(3630,741) :- not remove_reaction(3630,741).
catalyst(1890,465) :- not remove_reaction(1890,465).
catalyst(3630,465) :- not remove_reaction(3630,465).
catalyst(3740,378).
catalyst(8231,1041).
catalyst(8232,1041).
catalyst(8231,1000).
...
catalyst(8061,1034).
catalyst(8062,1034).
catalyst(3590,504) :- not remove_reaction(3590,504).
catalyst(10910,504) :- not remove_reaction(10910,504).
catalyst(4570,544).
catalyst(8181,798).
catalyst(8182,798).
catalyst(8181,676).
...
catalyst(8282,362).
catalyst(3840,616).
catalyst(3610,352) :- not remove_reaction(3610,352).
catalyst(7921,954).
catalyst(7922,954).
catalyst(7841,438).
catalyst(7842,438).
...
catalyst(1210,947).
catalyst(1160,940).
catalyst(801,925) :- not remove_reaction(801,925).
catalyst(802,925) :- not remove_reaction(802,925).
catalyst(811,925) :- not remove_reaction(811,925).
catalyst(812,925) :- not remove_reaction(812,925).
catalyst(831,925) :- not remove_reaction(831,925).
catalyst(832,925) :- not remove_reaction(832,925).
catalyst(901,925) :- not remove_reaction(901,925).
catalyst(902,925) :- not remove_reaction(902,925).
catalyst(1180,921).
catalyst(1210,921).
catalyst(700,918).
catalyst(1200,907).
...
catalyst(650,754).
catalyst(6560,749).
catalyst(681,748) :- not remove_reaction(681,748).
catalyst(682,748) :- not remove_reaction(682,748).
catalyst(761,748) :- not remove_reaction(761,748).
catalyst(762,748) :- not remove_reaction(762,748).
catalyst(771,748) :- not remove_reaction(771,748).
catalyst(772,748) :- not remove_reaction(772,748).
catalyst(781,748) :- not remove_reaction(781,748).
catalyst(782,748) :- not remove_reaction(782,748).
catalyst(791,748) :- not remove_reaction(791,748).
catalyst(792,748) :- not remove_reaction(792,748).
catalyst(801,748) :- not remove_reaction(801,748).
catalyst(802,748) :- not remove_reaction(802,748).
catalyst(811,748) :- not remove_reaction(811,748).
catalyst(812,748) :- not remove_reaction(812,748).
catalyst(831,748) :- not remove_reaction(831,748).
catalyst(832,748) :- not remove_reaction(832,748).
catalyst(841,748) :- not remove_reaction(841,748).
catalyst(842,748) :- not remove_reaction(842,748).
catalyst(851,748) :- not remove_reaction(851,748).
catalyst(852,748) :- not remove_reaction(852,748).
catalyst(881,748) :- not remove_reaction(881,748).
catalyst(882,748) :- not remove_reaction(882,748).
catalyst(901,748) :- not remove_reaction(901,748).
catalyst(902,748) :- not remove_reaction(902,748).
catalyst(911,748) :- not remove_reaction(911,748).
catalyst(912,748) :- not remove_reaction(912,748).
catalyst(921,748) :- not remove_reaction(921,748).
catalyst(922,748) :- not remove_reaction(922,748).
catalyst(931,748) :- not remove_reaction(931,748).
catalyst(932,748) :- not remove_reaction(932,748).
catalyst(1191,748) :- not remove_reaction(1191,748).
catalyst(1192,748) :- not remove_reaction(1192,748).
catalyst(390,743).
catalyst(1021,743).
catalyst(1022,743).
catalyst(1521,721).
...
catalyst(6650,396).
catalyst(6690,394).
catalyst(791,360) :- not remove_reaction(791,360).
catalyst(792,360) :- not remove_reaction(792,360).
catalyst(801,360) :- not remove_reaction(801,360).
catalyst(802,360) :- not remove_reaction(802,360).
catalyst(811,360) :- not remove_reaction(811,360).
catalyst(812,360) :- not remove_reaction(812,360).
catalyst(831,360) :- not remove_reaction(831,360).
catalyst(832,360) :- not remove_reaction(832,360).
catalyst(841,360) :- not remove_reaction(841,360).
catalyst(842,360) :- not remove_reaction(842,360).
catalyst(851,360) :- not remove_reaction(851,360).
catalyst(852,360) :- not remove_reaction(852,360).
catalyst(901,360) :- not remove_reaction(901,360).
catalyst(902,360) :- not remove_reaction(902,360).
catalyst(1180,350).
catalyst(1210,350).
catalyst(690,346).
catalyst(730,346).
...
catalyst(1512,285).
catalyst(1590,253).
catalyst(771,248) :- not remove_reaction(771,248).
catalyst(772,248) :- not remove_reaction(772,248).
...
catalyst(851,248) :- not remove_reaction(851,248).
catalyst(852,248) :- not remove_reaction(852,248).
catalyst(901,248) :- not remove_reaction(901,248).
catalyst(902,248) :- not remove_reaction(902,248).
catalyst(791,247) :- not remove_reaction(791,247).
catalyst(792,247) :- not remove_reaction(792,247).
catalyst(801,247) :- not remove_reaction(801,247).
catalyst(802,247) :- not remove_reaction(802,247).
catalyst(811,247) :- not remove_reaction(811,247).
catalyst(812,247) :- not remove_reaction(812,247).
catalyst(831,247) :- not remove_reaction(831,247).
catalyst(832,247) :- not remove_reaction(832,247).
catalyst(841,247) :- not remove_reaction(841,247).
catalyst(842,247) :- not remove_reaction(842,247).
catalyst(851,247) :- not remove_reaction(851,247).
catalyst(852,247) :- not remove_reaction(852,247).
catalyst(901,247) :- not remove_reaction(901,247).
catalyst(902,247) :- not remove_reaction(902,247).
catalyst(6600,244).
catalyst(620,240).
catalyst(540,224).
catalyst(1590,220).
...
modifiable_enzyme(403).
modifiable_enzyme(740).
modifiable_enzyme(741).
modifiable_enzyme(465).
modifiable_enzyme(504).
modifiable_enzyme(352).
modifiable_enzyme(925).
modifiable_enzyme(748).
modifiable_enzyme(360).
modifiable_enzyme(248).
modifiable_enzyme(247).
