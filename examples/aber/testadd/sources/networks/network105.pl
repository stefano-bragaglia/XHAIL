...
component("YNL280C",598).
component("YLR056W",512).
component("YGL012W",326).
component("YKR009C",494).
component("YOL086C",622).
component("YMR303C",572).
component("YGL256W",347).
component("YDL168W",220).
component("YBR145W",166).
component("YPL231W",679).
component("YBR265W",181).
component("U46_",97).
component("YBR149W",167).
component("YBR149W",168).
component("YGL001C",323).
component("YIL094C",414).
component("U45_",96).
component("YML056C",552).
component("YLR432W",545).
component("YHR216W",408).
component("YAR075W",142).
component("YAR073W",141).
component("YDR127W",241).
component("YML075C",553).
component("YLR450W",547).
component("YOL126C",628).
component("YKL085W",480).
component("YDL078C",208).
component("YNL037C",577).
component("YNL009W",575).
component("YLR174W",524).
component("YHR183W",401).
component("YGR256W",368).
component("YNL241C",591).
component("YOL059W",620).
component("YDL022W",202).
component("YCL018W",189).
component("YLR355C",540).
component("YDL174C",224).
component("YML086C",555).
component("YIL155C",423).
component("YGR088W",355).
component("YDR256C",253).
component("YKL026C",478).
component("YIR037W",432).
component("YBR244W",177).
component("YJR078W",467).
component("U58_",105).
component("YJR025C",460).
component("U107_",24).
component("YHR007C",378).
component("YGL055W",332).
component("YJR104C",469).
component("YHR008C",379).
component("YOR384W",662).
component("YOR381W",661).
component("YOL152W",630).
component("YLL051C",505).
component("YJL026W",434).
component("YIL066C",412).
component("YGR180C",359).
component("YER070W",299).
component("U37_",90).
component("U36_",89).
component("YDL168W",221).
component("YJR009C",457).
component("YJL052W",436).
component("YGR192C",361).
component("YBR006W",151).
component("YPL276W",687).
component("YPL275W",686).
component("YOR388C",663).
component("YOR374W",659).
component("YER073W",300).
component("YGL154C",339).
component("U55_",104).
component("YER069W",297).
component("YOR323C",652).
component("YER178W",308).
component("YBR221C",175).
component("YIL125W",419).
component("U52_",102).
component("YBR166C",170).
component("YGL012W",327).
component("YKL216W",493).
component("YDR044W",234).
component("YKR009C",495).
component("YIL160C",424).
component("YGL205W",344).
component("YMR118C",563).
component("YLR164W",522).
component("YLL041C",504).
component("YKL148C",484).
component("YKL141W",482).
component("YJL045W",435).
component("YDR178W",248).
component("YEL047C",284).
component("YDL171C",222).
component("YDL171C",223).
component("YOR375C",660).
component("YDL215C",226).
component("YAL062W",139).
component("U99_",134).
component("U100_",20).
component("YBR035C",157).
component("YKR080W",500).
component("YER023W",290).
component("YOR236W",650).
component("YGR204W",362).
component("YIR034C",431).
component("YLR142W",519).
component("U65_",111).
component("U63_",109).
component("U62_",108).
component("YHR068W",388).
component("YKL150W",485).
component("YIL043C",411).
component("YHR042W",383).
component("YPL171C",674).
component("YHR179W",400).
component("YMR145C",566).
component("YML120C",556).
component("YKL192C",490).
component("YDL085W",210).
component("YGR234W",364).
component("YFR030W",319).
component("YPL017C",665).
component("YFL018C",312).
component("YDR353W",263).
component("YPR167C",699).
component("YJR137C",472).
component("YNL052W",579).
component("YMR256C",571).
component("YLR395C",544).
component("YLR038C",510).
component("YIL111W",416).
component("YHR051W",387).
component("YGL191W",342).
component("YGL187C",341).
component("YDL067C",207).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",685).
component("YKR069W",499).
component("YOL096C",623).
component("U47_",98).
component("YER091C",305).
component("YJR073C",465).
component("YDR120C",239).
component("YML008C",548).
component("YOR074C",635).
component("YDL033C",204).
component("YOL096C",624).
component("YLR172C",523).
component("YLR058C",513).
component("YDR019C",232).
component("YBR176W",171).
component("YDR408C",268).
component("YMR120C",564).
component("YLR028C",508).
component("YBL013W",143).
component("YJL130C",444).
component("YKL024C",477).
component("YPR074C",695).
component("YBR117C",165).
component("YCL009C",188).
component("YNL071W",581).
component("YNR008W",603).
component("YIL160C",425).
component("YNR019W",606).
component("YCR048W",199).
component("U48_",99).
component("YDR232W",250).
component("YPL231W",680).
component("YDL052C",206).
component("U8_",128).
component("YPL231W",681).
component("YPL028W",666).
component("YLR299W",533).
component("YGL017W",328).
component("YML126C",557).
component("YNL104C",584).
component("YDL182W",225).
component("YDL131W",214).
component("YDR307W",259).
component("YLR258W",530).
component("YFR015C",317).
component("YNL029C",576).
component("YIL085C",413).
component("YMR306W",573).
component("YLR342W",539).
component("YGR032W",350).
component("YLR209C",526).
component("U104_",21).
component("YDR354W",264) :- not remove_orf("YDR354W",264).
component("YFR047C",320).
component("YJR133W",471).
component("YLR209C",527).
component("YML022W",549).
component("YDR441C",270).
component("YJL167W",449).
component("YJL167W",450).
component("YDR127W",242).
component("YHR190W",403).
component("YLR146C",520).
component("YHR068W",389).
component("YLR303W",535).
component("YGR012W",348).
component("YML082W",554).
component("YJR130C",470).
component("YDR035W",233).
component("YBR249C",178).
component("YLR180W",525).
component("YDR502C",273).
component("YOR274W",651).
component("YBR256C",180).
component("YHR137W",396).
component("YGL202W",343).
component("YLR027C",507).
component("YKL106W",481).
component("YOL140W",629).
component("YLR438W",546).
component("YGR019W",349).
component("YLR089C",515).
component("U64_",110).
component("U61_",107).
component("U51_",101).
component("YJR148W",473).
component("YHR208W",406).
component("YFL030W",313).
component("YOR184W",644).
component("YNR058W",610).
component("YIL116W",418).
component("YGL253W",346).
component("YFR053C",321).
component("YMR013C",561).
component("YMR205C",567).
component("YGR240C",365).
component("YOL016C",614).
component("YFR014C",316).
component("YCR036W",198).
component("YCL040W",191).
component("U15_",47).
component("YPL188W",675).
component("YJR049C",462).
component("YEL041W",282).
component("U96_",132).
component("YKL001C",476).
component("YDR236C",251).
component("YHL032C",376).
component("YDR531W",277).
component("U83_",127).
component("U82_",126).
component("U81_",125).
component("YMR208W",568).
component("YPL203W",676).
component("YOR061W",634).
component("YKL166C",487).
component("YJL164C",448).
component("YIL035C",410).
component("YHR205W",405).
component("YHR102W",395).
component("YGL019W",329).
component("YHR025W",382).
component("YOR347C",657).
component("YAL038W",137).
component("YNR012W",604).
component("YDR009W",231).
component("YDR127W",243).
component("YDR147W",246).
component("YDR300C",258).
component("YCR012W",193).
component("YER069W",298).
component("U18_",64).
component("U76_",120).
component("YER170W",307).
component("YDR226W",249).
component("YKL067W",479).
component("YOL055C",617).
component("YDR454C",271).
component("YJR057W",463).
component("YOL061W",621).
component("YKL181W",488).
component("YHL011C",375).
component("YER099C",306).
component("YBL068W",149).
component("YOR143C",640).
component("YNL256W",594).
component("YLR328W",537).
component("YBR018C",153).
component("YLR328W",538).
component("U80_",124).
component("U94_",131).
component("YJR010W",458).
component("YBR029C",156).
component("YGL130W",337).
component("YDR530C",276).
component("YPR190C",702).
component("YPR187W",701).
component("YPR110C",696).
component("YPR010C",690).
component("YOR341W",656).
component("YOR340C",655).
component("YOR224C",649).
component("YOR210W",648).
component("YOR207C",646).
component("YOR151C",641).
component("YOR116C",637).
component("YOL005C",612).
component("YNR003C",602).
component("YNL248C",593).
component("YNL151C",588).
component("YNL113W",585).
component("YKL144C",483).
component("YJR063W",464).
component("YJL148W",447).
component("YJL140W",446).
component("YIL021W",409).
component("YHR143W-A",397).
component("YGL070C",335).
component("YFL036W",314).
component("YDR404C",267).
component("YDR156W",247).
component("YDR045C",235).
component("YDL150W",219).
component("YDL140C",215).
component("YBR154C",169).
component("YPR175W",700).
component("YPL167C",673).
component("YOR330C",653).
component("YOL115W",627).
component("YNL299W",600).
component("YNL262W",596).
component("YNL102W",583).
component("YJR043C",461).
component("YJR006W",456).
component("YJL090C",439).
component("YIL139C",421).
component("YEL055C",285).
component("YDR419W",269).
component("YDR121W",240).
component("YDL102W",213).
component("YCR014C",194).
component("YBR278W",183).
component("YBL035C",146).
component("YPR113W",697).
component("YBR243C",176).
component("YPL148C",671).
component("YER026C",291).
component("YGR286C",372).
component("YHR189W",402).
component("YDR058C",238).
component("YDL086W",211).
component("YOL011W",613).
component("YMR008C",559).
component("YMR006C",558).
component("U105_",22).
component("YBL015W",144).
component("YJL068C",437).
component("YOR040W",633).
component("U77_",121).
component("YLR377C",542).
component("YPR073C",693).
component("YHR215W",407).
component("YDL024C",203).
component("YBR093C",163).
component("YBR092C",162).
component("YHR046C",386).
component("U9_",135).
component("YDL236W",228).
component("YPR073C",694).
component("YOR208W",647).
component("YNL053W",580).
component("YMR036C",562).
component("YIR026C",430).
component("YIL113W",417).
component("YFR028C",318).
component("YER075C",301).
component("YDL230W",227).
...
component("U25_",81).
component("U24_",80).
component("YHR044C",385).
component("YHR043C",384).
component("YOR360C",658).
component("YKR031C",496).
component("YPL206C",677).
component("YGL027C",331).
component("YLR286C",532).
component("YJR153W",474).
component("YJL221C",455).
component("YJL216C",453).
component("YIL172C",428).
component("YGR292W",374).
component("YGR287C",373).
component("YBR299W",187).
component("YBR184W",172).
component("YIR019C",429).
component("YIL099W",415).
component("YDL037C",205).
component("YOR190W",645).
component("YLR300W",534).
component("YGR282C",371).
component("YDR261C",254).
component("YDR400W",266).
component("YML035C",550).
component("YJL070C",438).
component("YBR284W",184).
component("U106_",23).
component("YER043C",292).
component("YNL045W",578).
component("YDR242W",252).
component("U53_",103).
component("YPR062W",692).
component("YMR120C",565).
component("YLR028C",509).
component("YHR144C",398).
component("YGR267C",370).
component("YBL033C",145).
component("YNL141W",586).
component("YLR245C",529).
component("YML035C",551).
component("YBR084W",160).
component("YJL126W",442).
component("U44_",95).
component("YDL100C",212).
component("U40_",93).
component("U39_",91).
component("YBR011C",152).
component("YHR201C",404).
component("YBR111C",164).
component("YBR252W",179).
component("YER005W",289).
component("YBL099W",150).
component("YLR231C",528).
component("YDR538W",279).
component("YLR134W",517).
component("YLR044C",511).
component("YGR087C",354).
component("YDR380W",265).
component("YDL080C",209).
component("U98_",133).
component("YMR250W",570).
component("YOR128C",638).
component("YEL021W",281).
component("YNR043W",608).
component("U93_",130).
component("YKL211C",491) :- not remove_orf("YKL211C",491).
component("YKR097W",502).
component("YNL169C",589).
component("YNL256W",595).
component("YDR294C",256).
component("YEL046C",283).
component("YNR033W",607).
component("YKL211C",492) :- not remove_orf("YKL211C",492).
component("YER090W",492) :- not remove_orf("YER090W",492).
component("YER090W",304) :- not remove_orf("YER090W",304).
component("YDR127W",244).
component("YPL281C",688).
component("YOR393W",664).
component("YMR323W",574).
component("YHR174W",399).
component("YGR254W",367).
component("YPL262W",683).
component("YGL026C",330) :- not remove_orf("YGL026C",330).
component("YGR155W",357).
component("YLR304C",536).
component("YJL200C",451).
component("YNL316C",601).
component("YPL212C",678).
component("YNL292W",599).
component("YGL063W",334).
component("YFL001W",310).
component("YPR002W",689).
component("YJR016C",459).
component("YCR053W",200).
component("YDR127W",245).
component("YGL148W",338).
component("YIL168W",427).
component("YIL167W",426).
component("YCL064C",192).
component("YER086W",302).
component("YLR359W",541).
component("YAL012W",136).
component("YFR055W",322).
component("YJL005W",433).
component("YJL121C",441).
component("YBR019C",154).
component("YDR050C",237).
component("YDR007W",230) :- not remove_orf("YDR007W",230).
component("YOR095C",636).
component("YBR196C",173).
component("YGL001C",324).
component("YPL117C",670).
component("U14_",39).
component("YOL056W",618).
component("YKL152C",486).
component("YDL021W",201).
component("YEL058W",286).
component("YPR060C",691).
component("YHR072W",390).
component("YPL097W",668).
component("YGR185C",360).
component("YGR264C",369).
component("YGR171C",358).
component("YPL104W",669).
component("YLL018C",503).
component("YHR020W",381).
component("YER087W",303).
component("YNL247W",592).
component("YOR168W",642).
component("YOL097C",625).
component("YDR268W",255).
component("YCR024C",195).
component("YHR019C",380).
component("YPL160W",672).
component("YLR382C",543).
component("YNL073W",582).
component("YOR335C",654).
component("YLR153C",521).
component("YAL054C",138).
component("YGR244C",366).
component("YIL145C",422).
component("YJL101C",440).
component("YOL049W",616).
component("YAR015W",140).
component("YER183C",309).
component("U90_",129).
component("YNR057C",609).
component("YDL141W",216).
component("YGL234W",345).
component("YDL141W",217).
component("YJR103W",468).
component("YBL039C",147).
component("YGR204W",363).
component("YBR084W",161).
component("YNL220W",590).
component("YOL058W",619).
component("YDL141W",218).
component("YHR074W",391).
component("YMR217W",569).
component("YGL062W",333).
component("YBR218C",174).
component("YPL231W",682).
component("YNR016C",605).
component("YKL182W",489).
component("YGR037C",351).
component("YPR138C",698).
component("YPL265W",684).
component("YPL036W",667).
component("YOR171C",643).
component("YOR130C",639).
component("YOR011W",632).
component("YOL156W",631).
component("YOL103W",626).
component("YOL020W",615) :- not remove_orf("YOL020W",615).
component("YNR072W",611).
component("YNL270C",597).
component("YNL142W",587).
component("YMR011W",560).
component("YLR260W",531).
component("YLR138W",518).
component("YLR100C",516).
component("YLR081W",514).
component("YLL061W",506).
component("YKR093W",501).
component("YKR053C",498).
component("YKR039W",497) :- not remove_orf("YKR039W",497).
component("YJR158W",475).
component("YJR077C",466).
component("YJL219W",454).
component("YJL214W",452).
component("YJL134W",445).
component("YJL129C",443).
component("YIL134W",420).
component("YHR096C",394).
component("YHR094C",393).
component("YHR092C",392).
component("YHL036W",377).
component("YGR121C",356).
component("YGR065C",353).
component("YGR055W",352).
component("YGL186C",340).
component("YGL077C",336).
component("YGL008C",325).
component("YFL055W",315).
component("YFL011W",311).
component("YER060W-A",296).
component("YER060W",295).
component("YER056C",294).
component("YER053C",293).
component("YEL069C",288).
component("YEL063C",287).
component("YEL017C-A",280).
component("YDR536W",278).
component("YDR508C",275).
component("YDR503C",274).
component("YDR497C",272).
component("YDR345C",262).
component("YDR343C",261).
component("YDR342C",260).
component("YDR297W",257).
component("YDR046C",236) :- not remove_orf("YDR046C",236).
component("YDL245C",229).
component("YCR032W",197).
...
catalyst(2121,21).
catalyst(2122,21).
catalyst(3620,264) :- not remove_reaction(3620,264).
catalyst(2110,320).
catalyst(2190,320).
catalyst(5550,471).
catalyst(5791,527).
...
catalyst(6470,608).
catalyst(2300,130).
catalyst(3600,491) :- not remove_reaction(3600,491).
catalyst(8000,502).
catalyst(6890,589).
catalyst(2570,595).
catalyst(8781,256).
...
catalyst(4560,283).
catalyst(2550,607).
catalyst(1890,492) :- not remove_reaction(1890,492).
catalyst(3630,492) :- not remove_reaction(3630,492).
catalyst(1890,304) :- not remove_reaction(1890,304).
catalyst(3630,304) :- not remove_reaction(3630,304).
catalyst(3740,244).
catalyst(8231,688).
catalyst(8232,688).
catalyst(8231,664).
...
catalyst(8281,237).
catalyst(8282,237).
catalyst(3610,230) :- not remove_reaction(3610,230).
catalyst(7921,636).
catalyst(7922,636).
catalyst(8331,173).
catalyst(8332,173).
...
catalyst(640,501).
catalyst(6560,498).
catalyst(771,497) :- not remove_reaction(771,497).
catalyst(772,497) :- not remove_reaction(772,497).
catalyst(781,497) :- not remove_reaction(781,497).
catalyst(782,497) :- not remove_reaction(782,497).
catalyst(801,497) :- not remove_reaction(801,497).
catalyst(802,497) :- not remove_reaction(802,497).
catalyst(811,497) :- not remove_reaction(811,497).
catalyst(812,497) :- not remove_reaction(812,497).
catalyst(831,497) :- not remove_reaction(831,497).
catalyst(832,497) :- not remove_reaction(832,497).
catalyst(841,497) :- not remove_reaction(841,497).
catalyst(842,497) :- not remove_reaction(842,497).
catalyst(851,497) :- not remove_reaction(851,497).
catalyst(852,497) :- not remove_reaction(852,497).
catalyst(881,497) :- not remove_reaction(881,497).
catalyst(882,497) :- not remove_reaction(882,497).
catalyst(901,497) :- not remove_reaction(901,497).
catalyst(902,497) :- not remove_reaction(902,497).
catalyst(921,497) :- not remove_reaction(921,497).
catalyst(922,497) :- not remove_reaction(922,497).
catalyst(931,497) :- not remove_reaction(931,497).
catalyst(932,497) :- not remove_reaction(932,497).
catalyst(1191,497) :- not remove_reaction(1191,497).
catalyst(1192,497) :- not remove_reaction(1192,497).
catalyst(1180,475).
catalyst(1210,475).
catalyst(1581,466).
catalyst(1582,466).
...
catalyst(851,158) :- not remove_reaction(851,158).
catalyst(852,158) :- not remove_reaction(852,158).
