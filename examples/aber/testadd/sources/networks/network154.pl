...
component("YLR056W",668).
component("YGR060W",461).
component("YGL012W",431).
component("YKR009C",645).
component("YOL086C",810).
component("YMR303C",751).
component("YMR083W",731).
component("YGL256W",454).
component("YDL168W",297).
component("YBR145W",227).
component("YPL231W",885).
component("YBR265W",245).
component("U46_",136).
component("YBR149W",228).
component("YBR149W",229).
component("YGL001C",427).
component("YIL094C",541).
component("YHR063C",508).
component("U45_",135).
component("YML056C",716).
component("YLR432W",705).
component("YHR216W",531).
component("YAR075W",191).
component("YAR073W",190).
component("YDR127W",326).
component("YJR139C",611).
component("YML075C",719).
component("YLR450W",708).
component("YOL126C",816).
component("YKL085W",622).
component("YDL078C",279).
component("YKL029C",618).
component("YNL037C",756).
component("YNL009W",754).
component("YLR174W",682).
component("YHR183W",524).
component("YGR256W",486).
component("YNL241C",771).
component("YOL059W",807).
component("YDL022W",271).
component("YCL018W",253).
component("YLR355C",700).
component("YIL074C",538).
component("YER081W",399).
component("YML054C",715).
component("YDL174C",301).
component("YML086C",721).
component("YIL155C",550).
component("YEL024W",374).
component("YKR066C",650).
component("YGR088W",465).
component("YDR256C",340).
component("YKL026C",617).
component("YIR037W",560).
component("YBR244W",240).
component("YJR078W",603).
component("U58_",145).
component("YJR025C",594).
component("U107_",27).
component("YGR255C",485).
component("U108_",28).
component("YHR007C",497).
component("YDR402C",355).
component("YGL055W",438).
component("YJR104C",606).
component("YHR008C",498).
component("YOR384W",858).
component("YOR381W",857).
component("YOL152W",819).
component("YLL051C",660).
component("YJL026W",562).
...
component("U36_",128).
component("U35_",127).
component("YDL168W",298).
component("YDR158W",334).
component("YJR009C",590).
component("YJL052W",564).
component("YGR192C",475).
component("YBR006W",204).
component("YPL276W",894).
component("YPL275W",893).
component("YOR388C",859).
component("YPL061W",867).
component("YOR374W",855).
component("YER073W",397).
component("YGL154C",446).
component("YBR115C",222).
component("U55_",144).
component("YER069W",394).
component("YOR323C",847).
component("YMR170C",741).
component("YMR169C",740).
component("YER178W",409).
component("YBR221C",238).
component("YIL125W",546).
component("U52_",141).
component("YBR166C",232).
component("YNL280C",780).
component("YGL012W",432).
component("YKL182W",633).
component("YKL216W",643).
component("YDR044W",316).
component("YER014W",384).
component("YKR009C",646).
component("YIL160C",551).
component("YGL205W",451).
component("YMR118C",735).
component("YLR164W",680).
component("YLL041C",658).
component("YKL148C",627).
component("YKL141W",625).
component("YJL045W",563).
component("YDR178W",335).
component("YJR051W",597).
component("YEL047C",377).
component("YDL171C",299).
component("YDL171C",300).
component("YOR375C",856).
component("YDL215C",305).
component("YAL062W",187).
component("U99_",181).
component("U100_",21).
component("YBR035C",212).
component("YKR080W",652).
component("YER023W",385).
component("YPL023C",863).
component("YGL125W",443).
component("YOR236W",845).
component("YGR204W",478).
component("YIR034C",559).
component("YLR142W",677).
component("U65_",152).
component("U63_",150).
component("U62_",149).
component("YHR068W",509).
component("YKL150W",628).
component("YIL043C",535).
component("YHR042W",503).
component("YOR221C",842).
component("YMR145C",738).
component("YML120C",722).
component("YKL192C",637).
component("YKL055C",620).
component("YER061C",392).
component("YDL085W",281).
component("YPL171C",875).
component("YHR179W",523).
component("YMR145C",739).
component("YML120C",723).
component("YKL192C",638).
component("YDL085W",282).
component("YGR234W",481).
component("YFR030W",423).
component("YPL017C",862).
component("YFL018C",413).
component("YDR353W",350).
component("YPR167C",913).
component("YJR137C",610).
component("YNL052W",758).
component("YMR256C",748).
component("YLR395C",704).
component("YLR038C",666).
component("YIL111W",543).
component("YHR051W",507).
component("YGL191W",449).
component("YGL187C",448).
component("YDL067C",278).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",321).
component("YPL266W",891).
component("YPL273W",892).
component("YLL062C",662).
component("YDR410C",358).
component("YKR069W",651).
component("YOL096C",811).
component("U47_",137).
component("YER091C",404).
component("YJR073C",601).
component("YGR157W",470).
component("YDR120C",324).
component("YML008C",710).
component("YOR074C",824).
component("YDL033C",273).
component("YOL096C",812).
component("YLR172C",681).
component("YLR058C",669).
component("YDR019C",312).
component("YBR176W",233).
component("YDR408C",357).
component("YMR120C",736).
component("YLR028C",664).
component("YBL013W",192).
component("YJL130C",575).
component("YJL088W",568).
component("YKL024C",616).
component("YPR074C",907).
component("YBR117C",223).
component("YMR108W",734).
component("YCL009C",252).
component("YNL071W",760).
component("YNR008W",786).
component("YIL160C",552).
component("YNR019W",789).
component("YCR048W",267).
component("U48_",138).
component("YMR062C",730).
component("YDR232W",337).
component("YPL231W",886).
component("YER061C",393).
component("YPL001W",861).
component("YDL052C",277).
component("U8_",175).
component("YDR148C",332).
component("YPL231W",887).
component("YPL028W",864).
component("YLR299W",692).
component("YGL017W",433).
component("YCR005C",259).
component("YML126C",724).
component("YNL104C",763).
component("YDL182W",302).
component("YDL131W",288).
component("YDR307W",346).
component("YLR258W",689).
component("YFR015C",420).
component("YPL227C",883).
component("YNL029C",755).
component("YIL085C",540).
component("YNL192W",769).
component("YBR038W",214).
component("YBR023C",210).
component("YMR306W",752).
component("YLR342W",698).
component("YGR032W",458).
component("YPR183W",916).
component("YBR248C",241).
component("YLR209C",684).
component("U104_",24).
component("U103_",23).
component("YDR354W",351) :- not remove_orf("YDR354W",351).
component("YFR047C",424).
component("YJR133W",609).
component("YLR209C",685).
component("YML022W",712).
component("YDR441C",361).
component("YHR128W",518).
component("YPR176C",915).
component("YPL172C",876).
component("YNR041C",792).
component("YMR101C",732).
component("YDL090C",284).
component("YBR003W",203).
component("YBR002C",202).
component("YJL167W",582).
component("YJL167W",583).
component("YNL256W",774).
component("YPR069C",904).
component("YDR127W",327).
component("YHR190W",526).
component("YLR146C",678).
component("YPL214C",882).
component("YHR068W",510).
component("YLR303W",694).
component("YGR012W",456).
component("YML082W",720).
component("YJR130C",608).
component("YDR035W",314).
component("YBR249C",242).
component("YLR180W",683).
component("YDR502C",365).
component("YOR274W",846).
component("YOL143C",818).
component("YBR256C",244).
component("YHR137W",519).
component("YGL202W",450).
component("YLR027C",663).
component("YKL106W",623).
component("YOL140W",817).
component("YLR438W",707).
component("YGR019W",457).
component("YLR089C",673).
component("U64_",151).
component("U61_",148).
component("U51_",140).
component("YJR148W",612).
component("YHR208W",529).
component("YFL030W",415).
component("YOR184W",835).
component("YNR058W",796).
component("YIL116W",545).
component("YGL253W",453).
component("YFR053C",425).
component("YMR013C",728).
component("YMR205C",744).
component("YGR240C",482).
component("YOL016C",800).
component("YFR014C",419).
component("YLR240W",687).
component("YKL203C",640).
component("YJR066W",600).
component("YCR036W",266).
component("YGR194C",476).
component("YCL040W",255).
component("U15_",66).
component("YPL188W",878).
component("YJR049C",596).
component("YEL041W",375).
component("U96_",179).
component("YKL001C",615).
component("YDR236C",338).
component("YML070W",718).
component("YFL053W",417).
component("YHL032C",495).
component("YDR531W",369).
component("U83_",170).
component("U82_",169).
component("U81_",168).
component("YMR208W",745).
component("YPL203W",879).
component("YOR061W",823).
component("YKL166C",630).
component("YJL164C",581).
component("YIL035C",534).
component("YHR205W",528).
component("YHR102W",516).
component("YGL019W",434).
component("YHR025W",502).
component("YOR347C",852).
component("YAL038W",185).
component("YNR012W",787).
component("YDR009W",311).
component("YDR127W",328).
component("U21_",108).
component("YDR147W",331).
component("YDR300C",345).
...
component("YDR226W",336).
component("YKL067W",621).
component("YOL055C",804).
component("YDR454C",362).
component("YJR057W",598).
component("YOL061W",808).
component("YKL181W",632).
component("YHL011C",493).
component("YER099C",405).
component("YBL068W",199).
...
component("YGR202C",477).
component("YLR328W",697).
component("YDL045C",275).
component("U80_",167).
component("YDL103C",287).
component("U94_",178).
component("YJR010W",591).
component("YBR029C",211).
component("YCL050C",256).
component("YGL130W",444).
component("YDR530C",368).
component("YCL050C",257).
component("YPR190C",918).
component("YPR187W",917).
component("YPR110C",910).
component("YPR010C",897).
component("YOR341W",851).
component("YOR340C",850).
component("YOR224C",844).
component("YOR210W",841).
component("YOR207C",839).
component("YOR151C",832).
component("YOR116C",826).
component("YOL005C",798).
component("YNR003C",785).
component("YNL248C",773).
component("YNL151C",767).
component("YNL113W",764).
component("YKL144C",626).
component("YJR063W",599).
component("YJL148W",579).
component("YJL140W",578).
component("YIL021W",533).
component("YHR143W-A",520).
component("YGL070C",441).
component("YFL036W",416).
component("YDR404C",356).
component("YDR156W",333).
component("YDR045C",317).
component("YDL150W",296).
component("YDL140C",290).
component("YBR154C",231).
component("YPR175W",914).
component("YPL167C",874).
component("YOR330C",848).
component("YOL115W",815).
component("YNL299W",782).
component("YNL262W",777).
component("YNL102W",762).
component("YJR043C",595).
component("YJR006W",589).
component("YJL090C",569).
component("YIL139C",548).
component("YEL055C",378).
component("YDR419W",359).
component("YDR121W",325).
component("YDL102W",286).
component("YCR014C",261).
component("YBR278W",247).
component("YBL035C",195).
component("YKL035W",619).
component("YHL012W",494).
component("YHR123W",517).
component("YPR113W",911).
component("YBR243C",239).
component("YDL142C",295).
component("YPL148C",872).
component("YER026C",386).
component("YGR286C",490).
component("YJL068C",565).
component("YHR189W",525).
component("YDR058C",320).
component("YDL086W",283).
component("YOL011W",799).
component("YMR008C",726).
component("YMR006C",725).
component("U105_",25).
component("YBL015W",193).
component("YJL068C",566).
component("YJR019C",593).
component("YOR040W",822).
component("U77_",163).
component("YDR481C",363).
component("YLR377C",702).
component("YFR025C",421).
component("YPL179W",877).
component("YNR032W",790).
component("YML057W",717).
component("YML016C",711).
component("YLR433C",706).
component("YGR123C",468).
component("YER133W",406).
component("YER089C",402).
component("YDR436W",360).
component("YDR075W",322).
component("YDL188C",303).
component("YDL134C",289).
component("YDL047W",276).
component("YDL006W",269).
component("YBR125C",226).
component("YBL056W",198).
component("YPR073C",905).
component("YHR215W",530).
component("YDL024C",272).
component("YBR093C",220).
component("YBR092C",219).
component("YAR071W",189).
component("YHR046C",506).
component("U9_",182).
component("YPL228W",884).
component("YMR180C",742).
component("YDL236W",307).
component("YJL155C",580).
component("YPR073C",906).
component("YOR208W",840).
component("YNL053W",759).
component("YMR036C",729).
component("YIR026C",558).
component("YIL113W",544).
component("YFR028C",422).
component("YER075C",398).
component("YDL230W",306).
component("YBR276C",246).
component("U34_",126).
component("U33_",125).
component("U32_",124).
component("U31_",123).
...
component("YOL064C",809).
component("YOR360C",854).
component("YKR031C",647).
component("YPL206C",880).
component("YGL027C",436).
component("YLR286C",691).
component("YJR153W",613).
component("YJL221C",588).
component("YJL216C",586).
component("YIL172C",556).
component("YGR292W",492).
component("YGR287C",491).
component("YBR299W",251).
component("YBR184W",234).
component("YIL162W",553).
component("YPR026W",898).
component("YDR001C",309).
component("YBR001C",201).
component("YIR019C",557).
component("YIL099W",542).
component("YDL037C",274).
component("YOR190W",837).
component("YLR300W",693).
component("YGR282C",489).
component("YDR261C",341).
component("YDR400W",354).
component("U23_",115).
component("YML035C",713).
component("YJL070C",567).
component("YBR284W",248).
component("U106_",26).
component("U102_",22).
component("YER043C",387).
component("YNL045W",757).
component("YGL037C",437).
component("YDR242W",339).
component("YBR208C",236).
component("YMR281W",750).
component("U53_",142).
component("YPR062W",903).
component("YMR120C",737).
component("YLR028C",665).
component("YHR144C",521).
component("YGR267C",488).
component("YBL033C",194).
component("YBR153W",230).
component("YNL141W",765).
component("YLR245C",688).
component("YML035C",714).
component("YGR204W",479).
component("YBR084W",217).
component("YJL126W",573).
component("U44_",134).
...
component("YHR201C",527).
component("YBR111C",221).
component("YBR252W",243).
component("YPR080W",908).
component("YOR187W",836).
component("YOR133W",829).
component("YLR069C",671).
component("YKR084C",653).
component("YKL173W",631).
component("YJL102W",571).
component("YDR385W",353).
component("YBR118W",224).
component("YER005W",383).
component("YLL001W",656).
component("YIL048W",536).
component("YER166W",407).
component("YDR093W",323).
component("YAL026C",184).
component("YBL099W",200).
component("U60_",147).
component("YLR231C",686).
component("U88_",173).
component("YDR538W",371).
component("YLR134W",675).
component("YLR044C",667).
component("YGR087C",464).
component("YDR380W",352).
component("YDL080C",280).
component("U98_",180).
component("YMR250W",747).
component("YKL184W",636).
component("YOR128C",827).
component("YEL021W",373).
component("YNR043W",793).
component("U93_",177).
component("U54_",143).
component("YKL211C",641) :- not remove_orf("YKL211C",641).
component("YKR097W",655).
component("YOL052C",803).
component("YNL169C",768).
component("YGR170W",471).
component("YNL256W",776).
component("YDR294C",343).
component("YEL046C",376).
component("YNR033W",791).
component("YKL211C",642) :- not remove_orf("YKL211C",642).
component("YER090W",642) :- not remove_orf("YER090W",642).
component("YER090W",403) :- not remove_orf("YER090W",403).
component("YDR127W",329).
component("YPL281C",895).
component("YOR393W",860).
component("YMR323W",753).
component("YHR174W",522).
component("YGR254W",484).
component("YOR202W",838).
component("YPL262W",889).
component("YGL026C",435) :- not remove_orf("YGL026C",435).
component("YGR155W",469).
component("YLR304C",695).
component("YJL200C",584).
component("YGL009C",430).
component("YNL316C",783).
component("YKL182W",634).
component("YPL212C",881).
component("YNL292W",781).
component("YGL063W",440).
component("YFL001W",411).
component("YPR002W",896).
component("YJR016C",592).
component("YCR053W",268).
component("YDR127W",330).
component("YGL148W",445).
component("YIL168W",555).
component("YIL167W",554).
component("YCL064C",258).
component("YER086W",400).
component("YLR359W",701).
component("YAL012W",183).
component("YML004C",709).
component("YFR055W",426).
component("YJL005W",561).
component("YJL121C",572).
component("YBR019C",208).
component("YDR050C",319).
component("YIL020C",532).
component("YDR007W",310) :- not remove_orf("YDR007W",310).
component("YOR095C",825).
component("YER003C",382).
component("YBR196C",235).
component("YGL001C",428).
component("YPL117C",870).
component("U14_",58).
component("YOL056W",805).
component("YKL152C",629).
component("YDL021W",270).
component("YMR105C",733).
component("YKL127W",624).
component("YEL058W",379).
component("YPR060C",902).
component("YHR072W",511).
component("YPL097W",868).
component("YGR185C",474).
component("YGR264C",487).
component("YGR171C",472).
component("YHR011W",499).
component("YDR023W",313).
component("YPL104W",869).
component("YLL018C",657).
component("YPR081C",909).
component("YBR121C",225).
component("YHR020W",501).
component("YER087W",401).
component("YNL247W",772).
component("YOR168W",833).
component("YOL097C",813).
component("YDR268W",342).
component("YPR047W",901).
component("YLR060W",670).
component("YFL022C",414).
component("YPR033C",899).
component("YCR024C",262).
component("YHR019C",500).
component("YKL194C",639).
component("YIL078W",539).
component("YPL160W",873).
component("YLR382C",703).
component("YNL073W",761).
component("YDR037W",315).
component("YOR335C",849).
component("YGR094W",466).
component("YLR153C",679).
component("YAL054C",186).
component("YOR142W",830).
component("YGR244C",483).
component("YPR035W",900).
component("YIL145C",549).
component("U89_",174).
component("YJL101C",570).
component("YOL049W",802).
component("YAR015W",188).
component("YER183C",410).
component("U90_",176).
component("YNR057C",795).
component("YDL141W",291).
component("YDL141W",292).
component("YGL234W",452).
component("YDL141W",293).
component("YJR103W",605).
component("YBL039C",196).
component("YGR204W",480).
component("YBR084W",218).
component("YNL220W",770).
component("YOL058W",806).
component("YDL141W",294).
component("YHR074W",512).
component("YMR217W",746).
component("YGR061C",462).
component("YJR109C",607).
component("YJL130C",576).
component("YGL062W",439).
component("YBR218C",237).
component("YPL231W",888).
component("YNR016C",788).
component("YKL182W",635).
component("YGR037C",459).
component("YPR138C",912).
component("YPL265W",890).
component("YPL134C",871).
component("YPL057C",866).
component("YPL036W",865).
component("YOR348C",853).
component("YOR222W",843).
component("YOR171C",834).
component("YOR130C",828).
component("YOR011W",821).
component("YOL156W",820).
component("YOL103W",814).
component("YOL020W",801) :- not remove_orf("YOL020W",801).
component("YNR072W",797).
component("YNR056C",794).
component("YNL318C",784).
component("YNL270C",778).
component("YNL142W",766).
component("YMR272C",749).
component("YMR202W",743).
component("YMR011W",727).
component("YLR348C",699).
component("YLR260W",690).
component("YLR138W",676).
component("YLR100C",674).
component("YLR081W",672).
component("YLL061W",661).
component("YLL043W",659).
component("YKR093W",654).
component("YKR053C",649).
component("YKR039W",648) :- not remove_orf("YKR039W",648).
component("YKL217W",644).
component("YJR158W",614).
component("YJR095W",604).
component("YJR077C",602).
component("YJL219W",587).
component("YJL214W",585).
component("YJL134W",577).
component("YJL129C",574).
component("YIL134W",547).
component("YHR096C",515).
component("YHR094C",514).
component("YHR092C",513).
component("YHL036W",496).
component("YGR121C",467).
component("YGR065C",463).
component("YGR055W",460).
component("YGL186C",447).
component("YGL077C",442).
component("YGL008C",429).
component("YFL055W",418).
component("YFL011W",412).
component("YER060W-A",391).
component("YER060W",390).
component("YER056C",389).
component("YER053C",388).
component("YEL069C",381).
component("YEL063C",380).
component("YEL017C-A",372).
component("YDR536W",370).
component("YDR508C",367).
component("YDR503C",366).
component("YDR497C",364).
component("YDR345C",349).
component("YDR343C",348).
component("YDR342C",347).
component("YDR297W",344).
component("YDR046C",318) :- not remove_orf("YDR046C",318).
component("YDL245C",308).
component("YDL210W",304).
component("YCR032W",265).
component("YCR028C",264).
component("YCR024C-A",263).
component("YCL025C",254).
component("YBR298C",250).
component("YBR291C",249).
component("YBR069C",216) :- not remove_orf("YBR069C",216).
component("YBR068C",215) :- not remove_orf("YBR068C",215).
component("YBR036C",213).
component("YBR021W",209).
component("YBL042C",197).
component("U85_",171).
component("U7_",166).
component("U79_",165).
component("U78_",164).
...
catalyst(2131,23).
catalyst(2132,23).
catalyst(3620,351) :- not remove_reaction(3620,351).
catalyst(2110,424).
catalyst(2190,424).
catalyst(5550,609).
catalyst(5791,685).
...
catalyst(2300,177).
catalyst(3460,143).
catalyst(3600,641) :- not remove_reaction(3600,641).
catalyst(8000,655).
catalyst(3941,803).
catalyst(3942,803).
catalyst(6890,768).
...
catalyst(4560,376).
catalyst(2550,791).
catalyst(1890,642) :- not remove_reaction(1890,642).
catalyst(3630,642) :- not remove_reaction(3630,642).
catalyst(1890,403) :- not remove_reaction(1890,403).
catalyst(3630,403) :- not remove_reaction(3630,403).
catalyst(3740,329).
catalyst(8231,895).
catalyst(8232,895).
catalyst(8231,860).
...
catalyst(8061,889).
catalyst(8062,889).
catalyst(3590,435) :- not remove_reaction(3590,435).
catalyst(10910,435) :- not remove_reaction(10910,435).
catalyst(4570,469).
catalyst(8181,695).
catalyst(8182,695).
catalyst(8181,584).
...
catalyst(650,654).
catalyst(6560,649).
catalyst(771,648) :- not remove_reaction(771,648).
catalyst(772,648) :- not remove_reaction(772,648).
catalyst(781,648) :- not remove_reaction(781,648).
catalyst(782,648) :- not remove_reaction(782,648).
catalyst(791,648) :- not remove_reaction(791,648).
catalyst(792,648) :- not remove_reaction(792,648).
catalyst(801,648) :- not remove_reaction(801,648).
catalyst(802,648) :- not remove_reaction(802,648).
catalyst(811,648) :- not remove_reaction(811,648).
catalyst(812,648) :- not remove_reaction(812,648).
catalyst(831,648) :- not remove_reaction(831,648).
catalyst(832,648) :- not remove_reaction(832,648).
catalyst(841,648) :- not remove_reaction(841,648).
catalyst(842,648) :- not remove_reaction(842,648).
catalyst(851,648) :- not remove_reaction(851,648).
catalyst(852,648) :- not remove_reaction(852,648).
catalyst(881,648) :- not remove_reaction(881,648).
catalyst(882,648) :- not remove_reaction(882,648).
catalyst(901,648) :- not remove_reaction(901,648).
catalyst(902,648) :- not remove_reaction(902,648).
catalyst(911,648) :- not remove_reaction(911,648).
catalyst(912,648) :- not remove_reaction(912,648).
catalyst(921,648) :- not remove_reaction(921,648).
catalyst(922,648) :- not remove_reaction(922,648).
catalyst(931,648) :- not remove_reaction(931,648).
catalyst(932,648) :- not remove_reaction(932,648).
catalyst(1191,648) :- not remove_reaction(1191,648).
catalyst(1192,648) :- not remove_reaction(1192,648).
catalyst(390,644).
catalyst(1180,614).
catalyst(1210,614).
catalyst(1250,604).
...
catalyst(851,318) :- not remove_reaction(851,318).
catalyst(852,318) :- not remove_reaction(852,318).
...
catalyst(1511,249).
catalyst(1512,249).
catalyst(771,216) :- not remove_reaction(771,216).
catalyst(772,216) :- not remove_reaction(772,216).
...
catalyst(851,216) :- not remove_reaction(851,216).
catalyst(852,216) :- not remove_reaction(852,216).
...
catalyst(831,215) :- not remove_reaction(831,215).
catalyst(832,215) :- not remove_reaction(832,215).
catalyst(841,215) :- not remove_reaction(841,215).
catalyst(842,215) :- not remove_reaction(842,215).
catalyst(851,215) :- not remove_reaction(851,215).
catalyst(852,215) :- not remove_reaction(852,215).
