...
component("YPL231W",101).
component("U46_",27).
component("YDR127W",43).
component("YOL126C",96).
component("YDL078C",39).
component("YNL037C",89).
component("YJR078W",74).
component("YOR323C",98).
component("U52_",28).
component("YBR166C",35).
component("YKR009C",80).
component("YIL160C",71).
component("YGL205W",63).
component("YKR080W",82).
component("YLR058C",85).
component("YLR209C",86).
component("YDR354W",48) :- not remove_orf("YDR354W",48).
component("YFR047C",59).
component("YJL167W",72).
component("YDR127W",44).
component("YDR035W",41).
component("YBR249C",36).
component("YHR137W",69).
component("YLR027C",84).
component("YKL106W",76).
component("YCR036W",38).
component("YNR012W",92).
component("YDR127W",45).
component("YKL067W",75).
component("YDR454C",50).
component("YOL061W",95).
component("YKL181W",77).
component("YHL011C",68).
component("YER099C",57).
component("YBL068W",31).
component("U105_",18).
component("U30_",25).
component("U24_",24).
component("YDR400W",49).
component("U53_",29).
component("U39_",26).
component("YBR111C",34).
component("YLR231C",87).
component("YKL211C",78) :- not remove_orf("YKL211C",78).
component("YKL211C",79) :- not remove_orf("YKL211C",79).
component("YER090W",79) :- not remove_orf("YER090W",79).
component("YER090W",56) :- not remove_orf("YER090W",56).
component("YDR127W",46).
component("YPL281C",103).
component("YOR393W",99).
component("YMR323W",88).
component("YHR174W",70).
component("YGR254W",66).
component("YGL026C",60) :- not remove_orf("YGL026C",60).
component("YNL316C",91).
component("YDR127W",47).
component("YGL148W",61).
component("YAL012W",30).
component("YDR007W",40) :- not remove_orf("YDR007W",40).
component("YOR095C",97).
component("YPR060C",104).
component("YGR264C",67).
component("YGR171C",65).
component("YPL104W",100).
component("YLL018C",83).
component("YNR057C",93).
component("YPR138C",105).
component("YPL265W",102).
component("YOL020W",94) :- not remove_orf("YOL020W",94).
component("YNL142W",90).
component("YKR039W",81) :- not remove_orf("YKR039W",81).
component("YJR077C",73).
component("YGR121C",64).
component("YGL186C",62).
component("YFL055W",58).
component("YER060W-A",55).
component("YER060W",54).
component("YER056C",53).
...
catalyst(8822,34).
catalyst(3500,87).
catalyst(3600,78) :- not remove_reaction(3600,78).
catalyst(3630,79) :- not remove_reaction(3630,79).
catalyst(3630,56) :- not remove_reaction(3630,56).
catalyst(3740,46).
catalyst(8231,103).
catalyst(8232,103).
catalyst(8231,99).
