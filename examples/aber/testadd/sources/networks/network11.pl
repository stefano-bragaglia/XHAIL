...
component("YPL231W",143).
component("U46_",30).
component("U45_",29).
component("YDR127W",55).
component("YOL126C",135).
component("YDL078C",49).
component("YNL037C",124).
component("YML086C",121).
component("YJR078W",99).
component("U36_",27).
component("YOR323C",137).
component("YIL125W",91).
component("U52_",31).
component("YBR166C",41).
component("YKR009C",108).
component("YIL160C",93).
component("YGL205W",82).
component("YKR080W",110).
component("YER023W",71).
component("YLR142W",117).
component("YKL150W",104).
component("YIL043C",90).
component("YLR058C",115).
component("YBR176W",42).
component("YMR120C",122).
component("YLR028C",113).
component("YPR074C",148).
component("YBR117C",40).
component("YPL231W",144).
component("YLR209C",118).
component("YDR354W",63) :- not remove_orf("YDR354W",63).
component("YFR047C",78).
component("YML022W",120).
component("YDR441C",66).
component("YJL167W",95).
component("YDR127W",56).
component("YDR035W",52).
component("YBR249C",43).
component("YHR137W",88).
component("YLR027C",112).
component("YKL106W",103).
component("YJR148W",101).
component("YCR036W",48).
component("YNR012W",130).
component("YDR127W",57).
component("YDR226W",60).
component("YKL067W",102).
component("YDR454C",67).
component("YOL061W",133).
component("YKL181W",105).
component("YHL011C",87).
component("YER099C",76).
component("YBL068W",36).
component("YPR175W",150).
component("YPL167C",142).
component("YOR330C",138).
component("YOL115W",134).
component("YNL299W",128).
...
component("YEL055C",70).
component("YDR419W",65).
component("YDR121W",54).
component("YDL102W",50).
component("YCR014C",47).
component("YBR278W",45).
component("YBL035C",34).
component("U105_",18).
component("U30_",26).
component("U24_",25).
component("YDR400W",64).
component("YDR242W",61).
component("U53_",32).
component("YLR028C",114).
component("U39_",28).
component("YBR111C",39).
component("YBR252W",44).
...
component("YOR393W",139).
component("YMR323W",123).
component("YHR174W",89).
component("YGR254W",85).
component("YGL026C",79) :- not remove_orf("YGL026C",79).
component("YNL316C",129).
component("YDR127W",59).
component("YGL148W",80).
component("YAL012W",33).
component("YDR007W",51) :- not remove_orf("YDR007W",51).
component("YOR095C",136).
component("YPL117C",141).
component("YPR060C",147).
component("YGR264C",86).
component("YGR171C",84).
component("YPL104W",140).
component("YLL018C",111).
component("YNR057C",131).
component("YJR103W",100).
component("YBL039C",35).
component("YPR138C",149).
component("YPL265W",145).
component("YOL020W",132) :- not remove_orf("YOL020W",132).
component("YNL142W",126).
component("YLR100C",116).
component("YKR039W",109) :- not remove_orf("YKR039W",109).
component("YJR077C",98).
component("YGR121C",83).
component("YGL186C",81).
component("YFL055W",77).
component("YER060W-A",74).
component("YER060W",73).
component("YER056C",72).
component("YDR536W",69).
component("YDR508C",68).
component("YDR297W",62).
component("YDR046C",53) :- not remove_orf("YDR046C",53).
component("YCL025C",46).
component("YBR069C",38) :- not remove_orf("YBR069C",38).
component("YBR068C",37) :- not remove_orf("YBR068C",37).
component("U228_",24).
component("U223_",23).
component("U194_",22).
component("U178_",21).
...
catalyst(372,126).
catalyst(6330,116).
catalyst(781,109) :- not remove_reaction(781,109).
catalyst(782,109) :- not remove_reaction(782,109).
...
catalyst(881,109) :- not remove_reaction(881,109).
catalyst(882,109) :- not remove_reaction(882,109).
catalyst(1191,109) :- not remove_reaction(1191,109).
catalyst(1192,109) :- not remove_reaction(1192,109).
catalyst(1581,98).
catalyst(1582,98).
catalyst(371,83).
catalyst(372,83).
...
catalyst(1191,46).
catalyst(1192,46).
catalyst(801,38) :- not remove_reaction(801,38).
catalyst(802,38) :- not remove_reaction(802,38).
catalyst(811,38) :- not remove_reaction(811,38).
catalyst(812,38) :- not remove_reaction(812,38).
catalyst(801,37) :- not remove_reaction(801,37).
catalyst(802,37) :- not remove_reaction(802,37).
catalyst(811,37) :- not remove_reaction(811,37).
catalyst(812,37) :- not remove_reaction(812,37).
catalyst(831,37) :- not remove_reaction(831,37).
catalyst(832,37) :- not remove_reaction(832,37).
catalyst(41,24).
catalyst(42,24).
catalyst(91,23).
catalyst(92,23).
