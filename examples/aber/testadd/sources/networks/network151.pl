...
component("YNL280C",769).
component("YLR056W",660).
component("YGR060W",455).
component("YGL012W",425).
component("YKR009C",638).
component("YOL086C",800).
component("YMR303C",741).
component("YMR083W",721).
component("YGL256W",448).
component("YDL168W",293).
component("YBR145W",223).
component("YPL231W",872).
component("YBR265W",241).
component("U46_",132).
component("YBR149W",224).
component("YBR149W",225).
component("YGL001C",422).
component("YIL094C",534).
component("YHR063C",501).
component("U45_",131).
component("YML056C",708).
component("YLR432W",697).
component("YHR216W",524).
component("YAR075W",187).
component("YAR073W",186).
component("YDR127W",322).
component("YJR139C",604).
component("YML075C",710).
component("YLR450W",700).
component("YOL126C",806).
component("YKL085W",615).
component("YDL078C",275).
component("YKL029C",611).
component("YNL037C",746).
component("YNL009W",744).
component("YLR174W",674).
component("YHR183W",517).
component("YGR256W",479).
component("YNL241C",761).
component("YOL059W",797).
component("YDL022W",267).
component("YCL018W",249).
component("YLR355C",692).
component("YIL074C",531).
component("YER081W",395).
component("YML054C",707).
component("YDL174C",297).
component("YML086C",712).
component("YIL155C",543).
component("YEL024W",370).
component("YKR066C",643).
component("YGR088W",459).
component("YDR256C",336).
component("YKL026C",610).
component("YIR037W",553).
component("YBR244W",236).
component("YJR078W",596).
component("U58_",141).
component("YJR025C",587).
component("U107_",27).
component("YGR255C",478).
component("U108_",28).
component("YHR007C",490).
component("YDR402C",351).
component("YGL055W",432).
component("YJR104C",599).
component("YHR008C",491).
component("YOR384W",847).
component("YOR381W",846).
component("YOL152W",808).
component("YLL051C",653).
component("YJL026W",555).
component("YIL066C",530).
...
component("YER023W",381).
component("YPL023C",852).
component("YGL125W",437).
component("YOR236W",834).
component("YGR204W",471).
component("YIR034C",552).
component("YLR142W",669).
component("U65_",148).
component("U63_",146).
component("U62_",145).
component("YHR068W",502).
component("YKL150W",621).
component("YIL043C",528).
component("YHR042W",496).
component("YOR221C",831).
component("YMR145C",728).
component("YKL192C",630).
component("YKL055C",613).
component("YER061C",388).
component("YDL085W",277).
component("YPL171C",864).
component("YHR179W",516).
component("YMR145C",729).
component("YML120C",713).
component("YKL192C",631).
component("YDL085W",278).
component("YGR234W",474).
component("YFR030W",418).
component("YPL017C",851).
component("YFL018C",409).
component("YDR353W",346).
component("YPR167C",899).
component("YJR137C",603).
component("YNL052W",748).
component("YMR256C",738).
component("YLR395C",696).
component("YLR038C",658).
component("YIL111W",536).
component("YHR051W",500).
component("YGL191W",443).
component("YGL187C",442).
component("YDL067C",274).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",317).
component("YPL266W",878).
component("YDR410C",354).
component("YKR069W",644).
component("YOL096C",801).
component("U47_",133).
component("YER091C",400).
component("YJR073C",594).
component("YGR157W",464).
component("YDR120C",320).
component("YML008C",702).
component("YOR074C",813).
component("YDL033C",269).
component("YOL096C",802).
component("YLR172C",673).
component("YLR058C",661).
component("YDR019C",308).
component("YBR176W",229).
component("YDR408C",353).
component("YMR120C",726).
component("YLR028C",656).
component("YBL013W",188).
component("YJL130C",568).
component("YJL088W",561).
component("YKL024C",609).
component("YPR074C",893).
component("YBR117C",219).
component("YMR108W",724).
component("YCL009C",248).
component("YNL071W",750).
component("YNR008W",776).
component("YIL160C",545).
component("YNR019W",779).
component("YCR048W",263).
component("U48_",134).
component("YMR062C",720).
component("YDR232W",333).
component("YPL231W",873).
component("YER061C",389).
component("YPL001W",850).
component("YDL052C",273).
component("U8_",171).
component("YDR148C",328).
component("YPL231W",874).
component("YPL028W",853).
component("YLR299W",684).
component("YGL017W",427).
component("YCR005C",255).
component("YML126C",714).
component("YNL104C",753).
component("YDL182W",298).
component("YDL131W",284).
component("YDR307W",342).
component("YLR258W",681).
component("YFR015C",415).
component("YNL029C",745).
component("YIL085C",533).
component("YNL192W",759).
component("YBR038W",210).
component("YBR023C",206).
component("YMR306W",742).
component("YLR342W",690).
component("YGR032W",452).
component("YPR183W",902).
component("YBR248C",237).
component("YLR209C",676).
component("U104_",24).
component("U103_",23).
component("YDR354W",347) :- not remove_orf("YDR354W",347).
component("YFR047C",419).
component("YJR133W",602).
component("YLR209C",677).
component("YML022W",704).
component("YDR441C",357).
component("YHR128W",511).
component("YPR176C",901).
component("YPL172C",865).
component("YNR041C",782).
...
component("YNL256W",764).
component("YPR069C",890).
component("YDR127W",323).
component("YHR190W",519).
component("YLR146C",670).
component("YHR068W",503).
component("YLR303W",686).
component("YGR012W",450).
component("YML082W",711).
component("YJR130C",601).
component("YDR035W",310).
component("YBR249C",238).
component("YLR180W",675).
component("YDR502C",361).
component("YOR274W",835).
component("YBR256C",240).
component("YHR137W",512).
component("YGL202W",444).
component("YLR027C",655).
component("YKL106W",616).
component("YOL140W",807).
component("YLR438W",699).
component("YGR019W",451).
component("YLR089C",665).
component("U64_",147).
component("U61_",144).
component("U51_",136).
component("YJR148W",605).
component("YHR208W",522).
component("YFL030W",411).
component("YOR184W",824).
component("YNR058W",786).
component("YIL116W",538).
component("YGL253W",447).
component("YFR053C",420).
component("YMR013C",718).
component("YMR205C",734).
component("YGR240C",475).
component("YOL016C",790).
component("YFR014C",414).
component("YLR240W",679).
component("YKL203C",633).
component("YJR066W",593).
component("YCR036W",262).
component("YCL040W",251).
component("U15_",64).
component("YPL188W",867).
component("YJR049C",589).
component("YEL041W",371).
component("U96_",175).
component("YKL001C",608).
component("YDR236C",334).
component("YHL032C",488).
component("YDR531W",365).
component("U83_",166).
component("U82_",165).
component("U81_",164).
component("YMR208W",735).
component("YPL203W",868).
component("YOR061W",812).
component("YKL166C",623).
component("YJL164C",574).
component("YIL035C",527).
component("YHR205W",521).
component("YHR102W",509).
component("YGL019W",428).
component("YHR025W",495).
component("YOR347C",841).
component("YAL038W",181).
component("YNR012W",777).
component("YDR009W",307).
component("YDR127W",324).
component("YDR147W",327).
component("YDR300C",341).
component("YCR012W",256).
...
component("YDR226W",332).
component("YKL067W",614).
component("YOL055C",794).
component("YDR454C",358).
component("YJR057W",591).
component("YOL061W",798).
component("YKL181W",625).
component("YHL011C",486).
component("YER099C",401).
component("YBL068W",195).
component("YOR143C",820).
component("YNL256W",765).
component("YLR328W",688).
component("YBR018C",202).
component("YBR018C",203).
component("YGR007W",449).
component("YGR202C",470).
component("YLR328W",689).
component("YDL045C",271).
component("U80_",163).
...
component("YDR530C",364).
component("YCL050C",253).
component("YPR190C",904).
component("YPR187W",903).
component("YPR110C",896).
component("YPR010C",883).
component("YOR341W",840).
component("YOR340C",839).
component("YOR224C",833).
component("YOR210W",830).
component("YOR207C",828).
component("YOR151C",821).
component("YOR116C",815).
component("YOL005C",788).
component("YNR003C",775).
component("YNL248C",763).
component("YNL151C",757).
component("YNL113W",754).
component("YKL144C",619).
component("YJR063W",592).
component("YJL148W",572).
component("YJL140W",571).
component("YIL021W",526).
component("YHR143W-A",513).
component("YGL070C",435).
component("YFL036W",412).
component("YDR404C",352).
component("YDR156W",329).
component("YDR045C",313).
component("YDL150W",292).
component("YDL140C",286).
component("YBR154C",227).
component("YPR175W",900).
component("YPL167C",863).
component("YOR330C",837).
component("YOL115W",805).
component("YNL299W",772).
component("YNL262W",767).
component("YNL102W",752).
component("YJR043C",588).
component("YJR006W",582).
component("YJL090C",562).
component("YIL139C",541).
component("YEL055C",374).
component("YDR419W",355).
component("YDR121W",321).
component("YDL102W",282).
component("YCR014C",257).
component("YBR278W",243).
component("YBL035C",191).
component("YKL035W",612).
...
component("YER026C",382).
component("YGR286C",483).
component("YJL068C",558).
component("YHR189W",518).
component("YDR058C",316).
component("YDL086W",279).
component("YOL011W",789).
component("YMR008C",716).
component("YMR006C",715).
component("U105_",25).
component("YBL015W",189).
component("YJL068C",559).
component("YJR019C",586).
component("YOR040W",811).
component("U77_",159).
component("YDR481C",359).
component("YLR377C",694).
component("YFR025C",416).
component("YPL179W",866).
component("YNR032W",780).
component("YML057W",709).
component("YML016C",703).
component("YLR433C",698).
component("YGR123C",462).
component("YER133W",402).
component("YER089C",398).
component("YDR436W",356).
component("YDR075W",318).
component("YDL188C",299).
component("YDL134C",285).
component("YDL047W",272).
component("YDL006W",265).
component("YBR125C",222).
component("YBL056W",194).
component("YPR073C",891).
component("YHR215W",523).
component("YDL024C",268).
component("YBR093C",216).
component("YBR092C",215).
component("YAR071W",185).
component("YHR046C",499).
component("U9_",178).
component("YPL228W",871).
component("YMR180C",732).
component("YDL236W",303).
component("YJL155C",573).
component("YPR073C",892).
component("YOR208W",829).
component("YNL053W",749).
...
component("U25_",113).
component("U24_",112).
component("YHR044C",498).
component("YHR043C",497).
component("YOL064C",799).
component("YOR360C",843).
component("YKR031C",640).
component("YPL206C",869).
component("YGL027C",430).
component("YLR286C",683).
component("YJR153W",606).
component("YJL221C",581).
component("YJL216C",579).
component("YIL172C",549).
component("YGR292W",485).
component("YGR287C",484).
component("YBR299W",247).
component("YBR184W",230).
component("YIL162W",546).
component("YPR026W",884).
component("YDR001C",305).
component("YBR001C",197).
component("YIR019C",550).
component("YIL099W",535).
component("YDL037C",270).
component("YOR190W",826).
component("YLR300W",685).
component("YGR282C",482).
component("YDR261C",337).
component("YDR400W",350).
component("U23_",111).
component("YML035C",705).
component("YJL070C",560).
component("YBR284W",244).
component("U106_",26).
component("U102_",22).
component("YER043C",383).
component("YNL045W",747).
component("YGL037C",431).
component("YDR242W",335).
component("YBR208C",232).
component("YMR281W",740).
component("U53_",138).
component("YPR062W",889).
component("YMR120C",727).
component("YLR028C",657).
component("YHR144C",514).
component("YGR267C",481).
component("YBL033C",190).
component("YBR153W",226).
component("YNL141W",755).
component("YLR245C",680).
component("YML035C",706).
component("YGR204W",472).
component("YBR084W",213).
component("YJL126W",566).
component("U44_",130).
...
component("YHR201C",520).
component("YBR111C",217).
component("YBR252W",239).
component("YPR080W",894).
component("YOR187W",825).
component("YOR133W",818).
component("YLR069C",663).
component("YKR084C",646).
component("YKL173W",624).
component("YJL102W",564).
component("YDR385W",349).
component("YBR118W",220).
component("YER005W",379).
component("YLL001W",649).
component("YIL048W",529).
component("YER166W",403).
component("YDR093W",319).
component("YAL026C",180).
component("YBL099W",196).
component("U60_",143).
component("YLR231C",678).
component("U88_",169).
component("YDR538W",367).
component("YLR134W",667).
component("YLR044C",659).
component("YGR087C",458).
component("YDR380W",348).
component("YDL080C",276).
component("U98_",176).
component("YMR250W",737).
component("YKL184W",629).
component("YOR128C",816).
component("YEL021W",369).
component("YNR043W",783).
component("U93_",173).
component("U54_",139).
component("YKL211C",634) :- not remove_orf("YKL211C",634).
component("YKR097W",648).
component("YOL052C",793).
component("YNL169C",758).
component("YGR170W",465).
component("YNL256W",766).
component("YDR294C",339).
component("YEL046C",372).
component("YNR033W",781).
...
component("YOR393W",849).
component("YMR323W",743).
component("YHR174W",515).
component("YGR254W",477).
component("YOR202W",827).
component("YPL262W",876).
component("YGL026C",429) :- not remove_orf("YGL026C",429).
component("YGR155W",463).
component("YLR304C",687).
component("YJL200C",577).
component("YNL316C",773).
component("YKL182W",627).
component("YPL212C",870).
component("YNL292W",771).
component("YGL063W",434).
component("YFL001W",407).
component("YPR002W",882).
component("YJR016C",585).
component("YCR053W",264).
component("YDR127W",326).
component("YGL148W",439).
component("YIL168W",548).
component("YIL167W",547).
component("YCL064C",254).
component("YER086W",396).
component("YLR359W",693).
component("YAL012W",179).
component("YML004C",701).
component("YFR055W",421).
component("YJL005W",554).
component("YJL121C",565).
component("YBR019C",204).
component("YDR050C",315).
component("YIL020C",525).
component("YDR007W",306) :- not remove_orf("YDR007W",306).
component("YOR095C",814).
component("YER003C",378).
component("YBR196C",231).
component("YGL001C",423).
component("YPL117C",859).
component("U14_",56).
component("YOL056W",795).
component("YKL152C",622).
component("YDL021W",266).
component("YMR105C",723).
component("YKL127W",617).
component("YEL058W",375).
component("YPR060C",888).
component("YHR072W",504).
component("YPL097W",857).
component("YGR185C",468).
component("YGR264C",480).
component("YGR171C",466).
component("YHR011W",492).
component("YDR023W",309).
component("YPL104W",858).
component("YLL018C",650).
component("YPR081C",895).
component("YBR121C",221).
component("YHR020W",494).
component("YER087W",397).
component("YNL247W",762).
component("YOR168W",822).
component("YOL097C",803).
component("YDR268W",338).
component("YPR047W",887).
component("YLR060W",662).
component("YFL022C",410).
component("YPR033C",885).
component("YCR024C",258).
component("YHR019C",493).
component("YKL194C",632).
component("YIL078W",532).
component("YPL160W",862).
component("YLR382C",695).
component("YNL073W",751).
component("YDR037W",311).
component("YOR335C",838).
component("YGR094W",460).
component("YLR153C",671).
component("YAL054C",182).
component("YOR142W",819).
component("YGR244C",476).
component("YPR035W",886).
component("YIL145C",542).
component("U89_",170).
component("YJL101C",563).
component("YOL049W",792).
component("YAR015W",184).
component("YER183C",406).
component("U90_",172).
component("YNR057C",785).
...
component("YNL220W",760).
component("YOL058W",796).
component("YDL141W",290).
component("YHR074W",505).
component("YMR217W",736).
component("YGR061C",456).
component("YJR109C",600).
component("YJL130C",569).
component("YGL062W",433).
component("YBR218C",233).
component("YPL231W",875).
component("YNR016C",778).
component("YKL182W",628).
component("YGR037C",453).
component("YPR138C",898).
component("YPL265W",877).
component("YPL134C",860).
component("YPL057C",855).
component("YPL036W",854).
component("YOR348C",842).
component("YOR222W",832).
component("YOR171C",823).
component("YOR130C",817).
component("YOR011W",810).
component("YOL156W",809).
component("YOL103W",804).
component("YOL020W",791) :- not remove_orf("YOL020W",791).
component("YNR072W",787).
component("YNR056C",784).
component("YNL318C",774).
component("YNL270C",768).
component("YNL142W",756).
component("YMR272C",739).
component("YMR202W",733).
component("YMR011W",717).
component("YLR348C",691).
component("YLR260W",682).
component("YLR138W",668).
component("YLR100C",666).
component("YLR081W",664).
component("YLL061W",654).
component("YLL043W",652).
component("YKR093W",647).
component("YKR053C",642).
component("YKR039W",641) :- not remove_orf("YKR039W",641).
...
component("YJL129C",567).
component("YIL134W",540).
component("YHR096C",508).
component("YHR094C",507).
component("YHR092C",506).
component("YHL036W",489).
component("YGR121C",461).
component("YGR065C",457).
component("YGR055W",454).
component("YGL186C",441).
component("YGL077C",436).
component("YGL008C",424).
component("YFL055W",413).
component("YFL011W",408).
component("YER060W-A",387).
component("YER060W",386).
component("YER056C",385).
component("YER053C",384).
component("YEL069C",377).
component("YEL063C",376).
component("YEL017C-A",368).
component("YDR536W",366).
component("YDR508C",363).
component("YDR503C",362).
component("YDR497C",360).
component("YDR345C",345).
component("YDR343C",344).
component("YDR342C",343).
component("YDR297W",340).
component("YDR046C",314) :- not remove_orf("YDR046C",314).
component("YDL245C",304).
component("YDL210W",300).
component("YCR032W",261).
component("YCR028C",260).
component("YCR024C-A",259).
component("YCL025C",250).
component("YBR298C",246).
...
catalyst(2131,23).
catalyst(2132,23).
catalyst(3620,347) :- not remove_reaction(3620,347).
catalyst(2110,419).
catalyst(2190,419).
catalyst(5550,602).
catalyst(5791,677).
...
catalyst(8061,876).
catalyst(8062,876).
catalyst(3590,429) :- not remove_reaction(3590,429).
catalyst(10910,429) :- not remove_reaction(10910,429).
catalyst(4570,463).
catalyst(8181,687).
catalyst(8182,687).
catalyst(8181,577).
...
catalyst(8282,315).
catalyst(3840,525).
catalyst(3610,306) :- not remove_reaction(3610,306).
catalyst(7921,814).
catalyst(7922,814).
catalyst(7841,378).
catalyst(7842,378).
...
catalyst(1210,809).
catalyst(1160,804).
catalyst(801,791) :- not remove_reaction(801,791).
catalyst(802,791) :- not remove_reaction(802,791).
catalyst(811,791) :- not remove_reaction(811,791).
catalyst(812,791) :- not remove_reaction(812,791).
catalyst(831,791) :- not remove_reaction(831,791).
catalyst(832,791) :- not remove_reaction(832,791).
catalyst(901,791) :- not remove_reaction(901,791).
catalyst(902,791) :- not remove_reaction(902,791).
catalyst(1180,787).
catalyst(1210,787).
catalyst(700,784).
catalyst(1200,774).
...
catalyst(650,647).
catalyst(6560,642).
catalyst(771,641) :- not remove_reaction(771,641).
catalyst(772,641) :- not remove_reaction(772,641).
catalyst(781,641) :- not remove_reaction(781,641).
catalyst(782,641) :- not remove_reaction(782,641).
catalyst(791,641) :- not remove_reaction(791,641).
catalyst(792,641) :- not remove_reaction(792,641).
...
catalyst(841,641) :- not remove_reaction(841,641).
catalyst(842,641) :- not remove_reaction(842,641).
catalyst(851,641) :- not remove_reaction(851,641).
catalyst(852,641) :- not remove_reaction(852,641).
catalyst(881,641) :- not remove_reaction(881,641).
catalyst(882,641) :- not remove_reaction(882,641).
catalyst(901,641) :- not remove_reaction(901,641).
catalyst(902,641) :- not remove_reaction(902,641).
catalyst(911,641) :- not remove_reaction(911,641).
catalyst(912,641) :- not remove_reaction(912,641).
catalyst(921,641) :- not remove_reaction(921,641).
catalyst(922,641) :- not remove_reaction(922,641).
catalyst(931,641) :- not remove_reaction(931,641).
catalyst(932,641) :- not remove_reaction(932,641).
catalyst(1191,641) :- not remove_reaction(1191,641).
catalyst(1192,641) :- not remove_reaction(1192,641).
catalyst(390,637).
catalyst(1180,607).
catalyst(1210,607).
catalyst(1250,597).
...
catalyst(1210,343).
catalyst(6650,340).
catalyst(791,314) :- not remove_reaction(791,314).
catalyst(792,314) :- not remove_reaction(792,314).
catalyst(801,314) :- not remove_reaction(801,314).
catalyst(802,314) :- not remove_reaction(802,314).
catalyst(811,314) :- not remove_reaction(811,314).
catalyst(812,314) :- not remove_reaction(812,314).
catalyst(831,314) :- not remove_reaction(831,314).
catalyst(832,314) :- not remove_reaction(832,314).
catalyst(841,314) :- not remove_reaction(841,314).
catalyst(842,314) :- not remove_reaction(842,314).
catalyst(851,314) :- not remove_reaction(851,314).
catalyst(852,314) :- not remove_reaction(852,314).
catalyst(901,314) :- not remove_reaction(901,314).
catalyst(902,314) :- not remove_reaction(902,314).
catalyst(1180,304).
catalyst(1210,304).
catalyst(690,300).
catalyst(730,300).
