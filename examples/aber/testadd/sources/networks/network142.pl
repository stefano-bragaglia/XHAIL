...
component("YNL280C",745).
component("YLR056W",640).
component("YGR060W",445).
component("YGL012W",416).
component("YKR009C",620).
component("YOL086C",774).
component("YMR303C",718).
component("YMR083W",699).
component("YGL256W",438).
component("YDL168W",288).
component("YBR145W",219).
component("YPL231W",842).
component("YBR265W",237).
component("U46_",131).
component("YBR149W",220).
component("YBR149W",221).
component("YGL001C",413).
component("YIL094C",520).
component("U45_",130).
component("YML056C",686).
component("YLR432W",676).
component("YHR216W",511).
component("YAR075W",186).
component("YAR073W",185).
component("YDR127W",315).
component("YJR139C",587).
component("YML075C",688).
component("YLR450W",679).
component("YOL126C",780).
component("YKL085W",598).
component("YDL078C",270).
component("YKL029C",594).
component("YNL037C",723).
component("YNL009W",721).
component("YLR174W",653).
component("YHR183W",504).
component("YGR256W",467).
component("YNL241C",738).
component("YOL059W",771).
component("YDL022W",262).
component("YCL018W",245).
component("YLR355C",671).
component("YIL074C",517).
component("YER081W",386).
component("YDL174C",292).
component("YML086C",690).
component("YIL155C",529).
component("YEL024W",361).
component("YKR066C",625).
component("YGR088W",449).
component("YDR256C",329).
component("YKL026C",593).
component("YIR037W",539).
component("YBR244W",232).
component("YJR078W",579).
component("U58_",140).
component("YJR025C",571).
component("U107_",27).
component("YGR255C",466).
component("U108_",28).
component("YHR007C",478).
component("YDR402C",343).
component("YGL055W",423).
component("YJR104C",582).
component("YHR008C",479).
component("YOR384W",818).
component("YOR381W",817).
component("YOL152W",782).
component("YLL051C",633).
component("YJL026W",541).
component("YIL066C",516).
component("YGR180C",456).
component("YER070W",383).
component("U37_",124).
component("U36_",123).
component("U35_",122).
component("YDL168W",289).
component("YDR158W",323).
component("YJR009C",568).
component("YJL052W",543).
component("YGR192C",458).
component("YBR006W",198).
component("YPL276W",850).
component("YPL275W",849).
component("YOR388C",819).
component("YPL061W",826).
component("YOR374W",815).
component("YER073W",384).
component("YGL154C",430).
component("YBR115C",215).
component("U55_",139).
component("YER069W",381).
component("YOR323C",807).
component("YMR170C",709).
component("YMR169C",708).
component("YER178W",396).
component("YBR221C",230).
component("YIL125W",525).
component("U52_",136).
component("YBR166C",224).
component("YNL280C",746).
component("YGL012W",417).
component("YKL182W",608).
component("YKL216W",618).
component("YDR044W",305).
component("YER014W",371).
component("YKR009C",621).
component("YIL160C",530).
component("YGL205W",435).
component("YMR118C",703).
component("YLR164W",651).
component("YLL041C",631).
component("YKL148C",603).
component("YKL141W",601).
component("YJL045W",542).
component("YDR178W",324).
component("YEL047C",364).
component("YDL171C",290).
component("YDL171C",291).
component("YOR375C",816).
component("YDL215C",296).
component("YAL062W",182).
component("U99_",176).
component("U100_",21).
component("YBR035C",205).
component("YKR080W",627).
component("YER023W",372).
component("YOR236W",805).
component("YGR204W",460).
component("YIR034C",538).
component("YLR142W",648).
component("U65_",147).
component("U63_",145).
component("U62_",144).
component("YHR068W",489).
component("YKL150W",604).
component("YIL043C",514).
component("YHR042W",484).
component("YOR221C",802).
component("YMR145C",706).
component("YKL192C",612).
component("YKL055C",596).
component("YER061C",379).
component("YDL085W",272).
component("YPL171C",834).
component("YHR179W",503).
component("YMR145C",707).
component("YML120C",691).
component("YKL192C",613).
component("YDL085W",273).
component("YGR234W",462).
component("YFR030W",409).
component("YPL017C",822).
component("YFL018C",400).
component("YDR353W",339).
component("YPR167C",867).
component("YJR137C",586).
component("YNL052W",725).
component("YMR256C",715).
component("YLR395C",675).
component("YLR038C",638).
component("YIL111W",522).
component("YHR051W",488).
component("YGL191W",433).
component("YGL187C",432).
component("YDL067C",269).
component("Q0275",20).
component("Q0250",19).
component("Q0045",18).
component("YDR072C",310).
component("YPL266W",848).
component("YKR069W",626).
component("YOL096C",775).
component("U47_",132).
component("YER091C",391).
component("YJR073C",577).
component("YGR157W",454).
component("YDR120C",313).
component("YML008C",681).
component("YOR074C",787).
component("YDL033C",264).
component("YOL096C",776).
component("YLR172C",652).
component("YLR058C",641).
component("YDR019C",302).
component("YBR176W",225).
component("YDR408C",345).
component("YMR120C",704).
component("YLR028C",636).
component("YBL013W",187).
component("YJL130C",553).
component("YJL088W",547).
component("YKL024C",592).
component("YPR074C",862).
component("YBR117C",216).
component("YMR108W",702).
component("YCL009C",244).
component("YNL071W",727).
component("YNR008W",751).
component("YIL160C",531).
component("YNR019W",754).
component("YCR048W",258).
component("U48_",133).
component("YMR062C",698).
component("YDR232W",326).
component("YPL231W",843).
component("YER061C",380).
component("YPL001W",821).
component("YDL052C",268).
component("U8_",170).
component("YDR148C",321).
component("YPL231W",844).
component("YPL028W",823).
component("YLR299W",663).
component("YGL017W",418).
component("YCR005C",250).
component("YML126C",692).
component("YNL104C",730).
component("YDL182W",293).
component("YDL131W",279).
component("YDR307W",335).
component("YLR258W",660).
component("YFR015C",406).
component("YNL029C",722).
component("YIL085C",519).
component("YNL192W",736).
component("YBR038W",207).
component("YBR023C",203).
component("YMR306W",719).
component("YLR342W",669).
component("YGR032W",442).
component("YPR183W",870).
component("YBR248C",233).
component("YLR209C",655).
component("U104_",24).
component("U103_",23).
component("YDR354W",340) :- not remove_orf("YDR354W",340).
component("YFR047C",410).
component("YJR133W",585).
component("YLR209C",656).
component("YML022W",683).
component("YDR441C",348).
component("YHR128W",498).
component("YPR176C",869).
component("YPL172C",835).
component("YNR041C",757).
component("YMR101C",700).
component("YDL090C",275).
component("YBR003W",197).
component("YBR002C",196).
component("YJL167W",560).
component("YJL167W",561).
component("YPR069C",859).
component("YDR127W",316).
component("YHR190W",506).
component("YLR146C",649).
component("YHR068W",490).
component("YLR303W",665).
component("YGR012W",440).
component("YML082W",689).
component("YJR130C",584).
component("YDR035W",304).
component("YBR249C",234).
component("YLR180W",654).
component("YDR502C",352).
component("YOR274W",806).
component("YBR256C",236).
component("YHR137W",499).
component("YGL202W",434).
component("YLR027C",635).
component("YKL106W",599).
component("YOL140W",781).
component("YLR438W",678).
component("YGR019W",441).
component("YLR089C",644).
component("U64_",146).
component("U61_",143).
component("U51_",135).
component("YJR148W",588).
component("YHR208W",509).
component("YFL030W",402).
component("YOR184W",796).
component("YNR058W",761).
component("YIL116W",524).
component("YGL253W",437).
component("YFR053C",411).
component("YMR013C",696).
component("YMR205C",711).
component("YGR240C",463).
component("YOL016C",765).
component("YFR014C",405).
component("YLR240W",658).
component("YKL203C",615).
component("YJR066W",576).
component("YCR036W",257).
component("YCL040W",247).
component("U15_",63).
component("YPL188W",837).
component("YJR049C",573).
component("YEL041W",362).
component("U96_",174).
component("YKL001C",591).
component("YDR236C",327).
component("YHL032C",476).
component("YDR531W",356).
component("U83_",165).
component("U82_",164).
component("U81_",163).
component("YMR208W",712).
component("YPL203W",838).
component("YOR061W",786).
component("YKL166C",606).
component("YJL164C",559).
component("YIL035C",513).
component("YHR205W",508).
component("YHR102W",496).
component("YGL019W",419).
component("YHR025W",483).
component("YOR347C",812).
component("YAL038W",180).
component("YNR012W",752).
component("YDR009W",301).
component("YDR127W",317).
component("YDR147W",320).
component("YDR300C",334).
component("YCR012W",251).
component("YER069W",382).
component("U19_",95).
component("U18_",86).
component("U17_",77).
component("U76_",157).
component("YER170W",395).
component("YDR226W",325).
component("YKL067W",597).
component("YOL055C",768).
component("YDR454C",349).
component("YJR057W",574).
component("YOL061W",772).
component("YKL181W",607).
component("YHL011C",474).
component("YER099C",392).
component("YBL068W",194).
component("YOR143C",792).
component("YNL256W",741).
component("YLR328W",667).
component("YBR018C",200).
component("YGR007W",439).
component("YGR202C",459).
component("YLR328W",668).
component("YDL045C",266).
component("U80_",162).
component("YDL103C",278).
component("U94_",173).
component("YJR010W",569).
component("YBR029C",204).
component("YCL050C",248).
component("YGL130W",428).
component("YDR530C",355).
component("YPR190C",872).
component("YPR187W",871).
component("YPR110C",864).
component("YPR010C",853).
component("YOR341W",811).
component("YOR340C",810).
component("YOR224C",804).
component("YOR210W",801).
component("YOR207C",799).
component("YOR151C",793).
component("YOR116C",789).
component("YOL005C",763).
component("YNR003C",750).
component("YNL248C",740).
component("YNL151C",734).
component("YNL113W",731).
component("YKL144C",602).
component("YJR063W",575).
component("YJL148W",557).
component("YJL140W",556).
component("YIL021W",512).
component("YHR143W-A",500).
component("YGL070C",426).
component("YFL036W",403).
component("YDR404C",344).
component("YDR156W",322).
component("YDR045C",306).
component("YDL150W",287).
component("YDL140C",281).
component("YBR154C",223).
component("YPR175W",868).
component("YPL167C",833).
component("YOR330C",808).
component("YOL115W",779).
component("YNL299W",748).
component("YNL262W",743).
component("YNL102W",729).
component("YJR043C",572).
component("YJR006W",567).
component("YJL090C",548).
component("YIL139C",527).
component("YEL055C",365).
component("YDR419W",346).
component("YDR121W",314).
component("YDL102W",277).
component("YCR014C",252).
component("YBR278W",239).
component("YBL035C",190).
component("YKL035W",595).
component("YHL012W",475).
component("YHR123W",497).
component("YPR113W",865).
component("YBR243C",231).
component("YDL142C",286).
component("YPL148C",831).
component("YER026C",373).
component("YGR286C",471).
component("YJL068C",544).
component("YHR189W",505).
component("YDR058C",309).
component("YDL086W",274).
component("YOL011W",764).
component("YMR008C",694).
component("YMR006C",693).
component("U105_",25).
component("YBL015W",188).
component("YJL068C",545).
component("YOR040W",785).
component("U77_",158).
component("YDR481C",350).
component("YLR377C",673).
component("YFR025C",407).
component("YPL179W",836).
component("YNR032W",755).
component("YML057W",687).
component("YML016C",682).
component("YLR433C",677).
component("YGR123C",452).
component("YER133W",393).
component("YER089C",389).
component("YDR436W",347).
component("YDR075W",311).
component("YDL188C",294).
component("YDL134C",280).
component("YDL047W",267).
component("YDL006W",260).
component("YBR125C",218).
component("YBL056W",193).
component("YPR073C",860).
component("YHR215W",510).
component("YDL024C",263).
component("YBR093C",213).
component("YBR092C",212).
component("YAR071W",184).
component("YHR046C",487).
component("U9_",177).
component("YPL228W",841).
component("YMR180C",710).
component("YDL236W",298).
component("YJL155C",558).
component("YPR073C",861).
component("YOR208W",800).
component("YNL053W",726).
component("YMR036C",697).
component("YIR026C",537).
component("YIL113W",523).
component("YFR028C",408).
component("YER075C",385).
component("YDL230W",297).
component("YBR276C",238).
component("U34_",121).
component("U33_",120).
component("U32_",119).
component("U31_",118).
...
component("U25_",112).
component("U24_",111).
component("YHR044C",486).
component("YHR043C",485).
component("YOL064C",773).
component("YOR360C",814).
component("YKR031C",622).
component("YPL206C",839).
component("YGL027C",421).
component("YLR286C",662).
component("YJR153W",589).
component("YJL221C",566).
component("YJL216C",564).
component("YIL172C",535).
component("YGR292W",473).
component("YGR287C",472).
component("YBR299W",243).
component("YBR184W",226).
component("YIL162W",532).
component("YIR019C",536).
component("YIL099W",521).
component("YDL037C",265).
component("YOR190W",797).
component("YLR300W",664).
component("YGR282C",470).
component("YDR261C",330).
component("YDR400W",342).
component("U23_",110).
component("YML035C",684).
component("YJL070C",546).
component("YBR284W",240).
component("U106_",26).
component("U102_",22).
component("YER043C",374).
component("YNL045W",724).
component("YGL037C",422).
component("YDR242W",328).
component("YBR208C",228).
component("YMR281W",717).
component("U53_",137).
component("YPR062W",858).
component("YMR120C",705).
component("YLR028C",637).
component("YHR144C",501).
component("YGR267C",469).
component("YBL033C",189).
component("YBR153W",222).
component("YNL141W",732).
component("YLR245C",659).
component("YML035C",685).
component("YBR084W",210).
component("YJL126W",551).
component("U44_",129).
component("YDL100C",276).
component("U87_",167).
component("U40_",127).
component("U39_",125).
component("YBR011C",199).
component("YHR201C",507).
component("YBR111C",214).
component("YBR252W",235).
component("YER005W",370).
component("YIL048W",515).
component("YER166W",394).
component("YDR093W",312).
component("YAL026C",179).
component("YBL099W",195).
component("U60_",142).
component("YLR231C",657).
component("U88_",168).
component("YDR538W",358).
component("YLR134W",646).
component("YLR044C",639).
component("YGR087C",448).
component("YDR380W",341).
component("YDL080C",271).
component("U98_",175).
component("YMR250W",714).
component("YKL184W",611).
component("YOR128C",790).
component("YEL021W",360).
component("YNR043W",758).
component("U93_",172).
component("U54_",138).
component("YKL211C",616) :- not remove_orf("YKL211C",616).
component("YKR097W",629).
component("YNL169C",735).
component("YNL256W",742).
component("YDR294C",332).
component("YEL046C",363).
component("YNR033W",756).
component("YKL211C",617) :- not remove_orf("YKL211C",617).
component("YER090W",617) :- not remove_orf("YER090W",617).
component("YER090W",390) :- not remove_orf("YER090W",390).
component("YDR127W",318).
component("YPL281C",851).
component("YOR393W",820).
component("YMR323W",720).
component("YHR174W",502).
component("YGR254W",465).
component("YOR202W",798).
component("YPL262W",846).
component("YGL026C",420) :- not remove_orf("YGL026C",420).
component("YGR155W",453).
component("YLR304C",666).
component("YJL200C",562).
component("YNL316C",749).
component("YKL182W",609).
component("YPL212C",840).
component("YNL292W",747).
component("YGL063W",425).
component("YFL001W",398).
component("YPR002W",852).
component("YJR016C",570).
component("YCR053W",259).
component("YDR127W",319).
component("YGL148W",429).
component("YIL168W",534).
component("YIL167W",533).
component("YCL064C",249).
component("YER086W",387).
component("YLR359W",672).
component("YAL012W",178).
component("YML004C",680).
component("YFR055W",412).
component("YJL005W",540).
component("YJL121C",550).
component("YBR019C",201).
component("YDR050C",308).
component("YDR007W",300) :- not remove_orf("YDR007W",300).
component("YOR095C",788).
component("YER003C",369).
component("YBR196C",227).
component("YGL001C",414).
component("YPL117C",829).
component("U14_",55).
component("YOL056W",769).
component("YKL152C",605).
component("YDL021W",261).
component("YMR105C",701).
component("YKL127W",600).
component("YEL058W",366).
component("YPR060C",857).
component("YHR072W",491).
component("YPL097W",827).
component("YGR185C",457).
component("YGR264C",468).
component("YGR171C",455).
component("YHR011W",480).
component("YDR023W",303).
component("YPL104W",828).
component("YLL018C",630).
component("YPR081C",863).
component("YBR121C",217).
component("YHR020W",482).
component("YER087W",388).
component("YNL247W",739).
component("YOR168W",794).
component("YOL097C",777).
component("YDR268W",331).
component("YPR047W",856).
component("YLR060W",642).
component("YFL022C",401).
component("YPR033C",854).
component("YCR024C",253).
component("YHR019C",481).
component("YKL194C",614).
component("YIL078W",518).
component("YPL160W",832).
component("YLR382C",674).
component("YNL073W",728).
component("YOR335C",809).
component("YGR094W",450).
component("YLR153C",650).
component("YAL054C",181).
component("YGR244C",464).
component("YPR035W",855).
component("YIL145C",528).
component("U89_",169).
component("YJL101C",549).
component("YOL049W",767).
component("YAR015W",183).
component("YER183C",397).
component("U90_",171).
component("YNR057C",760).
component("YDL141W",282).
component("YDL141W",283).
component("YGL234W",436).
component("YDL141W",284).
component("YJR103W",581).
component("YBL039C",191).
component("YGR204W",461).
component("YBR084W",211).
component("YNL220W",737).
component("YOL058W",770).
component("YDL141W",285).
component("YHR074W",492).
component("YMR217W",713).
component("YGR061C",446).
component("YJR109C",583).
component("YJL130C",554).
component("YGL062W",424).
component("YBR218C",229).
component("YPL231W",845).
component("YNR016C",753).
component("YKL182W",610).
component("YGR037C",443).
component("YPR138C",866).
component("YPL265W",847).
component("YPL134C",830).
component("YPL057C",825).
component("YPL036W",824).
component("YOR348C",813).
component("YOR222W",803).
component("YOR171C",795).
component("YOR130C",791).
component("YOR011W",784).
component("YOL156W",783).
component("YOL103W",778).
component("YOL020W",766) :- not remove_orf("YOL020W",766).
component("YNR072W",762).
component("YNR056C",759).
component("YNL270C",744).
component("YNL142W",733).
component("YMR272C",716).
component("YMR011W",695).
component("YLR348C",670).
component("YLR260W",661).
component("YLR138W",647).
component("YLR100C",645).
component("YLR081W",643).
component("YLL061W",634).
component("YLL043W",632).
component("YKR093W",628).
component("YKR053C",624).
component("YKR039W",623) :- not remove_orf("YKR039W",623).
component("YKL217W",619).
component("YJR158W",590).
component("YJR095W",580).
component("YJR077C",578).
component("YJL219W",565).
component("YJL214W",563).
component("YJL134W",555).
component("YJL129C",552).
component("YIL134W",526).
component("YHR096C",495).
component("YHR094C",494).
component("YHR092C",493).
component("YHL036W",477).
component("YGR121C",451).
component("YGR065C",447).
component("YGR055W",444).
component("YGL186C",431).
component("YGL077C",427).
component("YGL008C",415).
component("YFL055W",404).
component("YFL011W",399).
component("YER060W-A",378).
component("YER060W",377).
component("YER056C",376).
component("YER053C",375).
component("YEL069C",368).
component("YEL063C",367).
...
component("YDR297W",333).
component("YDR046C",307) :- not remove_orf("YDR046C",307).
component("YDL245C",299).
component("YDL210W",295).
component("YCR032W",256).
component("YCR028C",255).
component("YCR024C-A",254).
component("YCL025C",246).
component("YBR298C",242).
...
catalyst(2300,172).
catalyst(3460,138).
catalyst(3600,616) :- not remove_reaction(3600,616).
catalyst(8000,629).
catalyst(6890,735).
catalyst(2570,742).
catalyst(8781,332).
...
catalyst(4560,363).
catalyst(2550,756).
catalyst(1890,617) :- not remove_reaction(1890,617).
catalyst(3630,617) :- not remove_reaction(3630,617).
...
catalyst(8061,846).
catalyst(8062,846).
catalyst(3590,420) :- not remove_reaction(3590,420).
catalyst(10910,420) :- not remove_reaction(10910,420).
catalyst(4570,453).
catalyst(8181,666).
catalyst(8182,666).
catalyst(8181,562).
...
catalyst(8281,308).
catalyst(8282,308).
catalyst(3610,300) :- not remove_reaction(3610,300).
catalyst(7921,788).
catalyst(7922,788).
catalyst(7841,369).
catalyst(7842,369).
...
catalyst(640,628).
catalyst(6560,624).
catalyst(771,623) :- not remove_reaction(771,623).
catalyst(772,623) :- not remove_reaction(772,623).
catalyst(781,623) :- not remove_reaction(781,623).
catalyst(782,623) :- not remove_reaction(782,623).
catalyst(791,623) :- not remove_reaction(791,623).
catalyst(792,623) :- not remove_reaction(792,623).
catalyst(801,623) :- not remove_reaction(801,623).
catalyst(802,623) :- not remove_reaction(802,623).
catalyst(811,623) :- not remove_reaction(811,623).
catalyst(812,623) :- not remove_reaction(812,623).
catalyst(831,623) :- not remove_reaction(831,623).
catalyst(832,623) :- not remove_reaction(832,623).
catalyst(841,623) :- not remove_reaction(841,623).
catalyst(842,623) :- not remove_reaction(842,623).
catalyst(851,623) :- not remove_reaction(851,623).
catalyst(852,623) :- not remove_reaction(852,623).
catalyst(881,623) :- not remove_reaction(881,623).
catalyst(882,623) :- not remove_reaction(882,623).
catalyst(901,623) :- not remove_reaction(901,623).
catalyst(902,623) :- not remove_reaction(902,623).
catalyst(911,623) :- not remove_reaction(911,623).
catalyst(912,623) :- not remove_reaction(912,623).
catalyst(921,623) :- not remove_reaction(921,623).
catalyst(922,623) :- not remove_reaction(922,623).
catalyst(931,623) :- not remove_reaction(931,623).
catalyst(932,623) :- not remove_reaction(932,623).
catalyst(1191,623) :- not remove_reaction(1191,623).
catalyst(1192,623) :- not remove_reaction(1192,623).
catalyst(390,619).
catalyst(1180,590).
catalyst(1210,590).
catalyst(1250,580).
...
catalyst(1210,336).
catalyst(6650,333).
catalyst(791,307) :- not remove_reaction(791,307).
catalyst(792,307) :- not remove_reaction(792,307).
catalyst(801,307) :- not remove_reaction(801,307).
catalyst(802,307) :- not remove_reaction(802,307).
catalyst(811,307) :- not remove_reaction(811,307).
catalyst(812,307) :- not remove_reaction(812,307).
catalyst(831,307) :- not remove_reaction(831,307).
catalyst(832,307) :- not remove_reaction(832,307).
catalyst(841,307) :- not remove_reaction(841,307).
catalyst(842,307) :- not remove_reaction(842,307).
catalyst(851,307) :- not remove_reaction(851,307).
catalyst(852,307) :- not remove_reaction(852,307).
catalyst(901,307) :- not remove_reaction(901,307).
catalyst(902,307) :- not remove_reaction(902,307).
catalyst(1180,299).
catalyst(1210,299).
catalyst(730,295).
catalyst(431,256).
...
modifiable_enzyme(616).
modifiable_enzyme(617).
modifiable_enzyme(390).
modifiable_enzyme(420).
modifiable_enzyme(300).
