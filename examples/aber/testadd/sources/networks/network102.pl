...
component("YNL280C",588).
component("YLR056W",505).
component("YGL012W",321).
component("YKR009C",487).
component("YOL086C",611).
component("YMR303C",563).
component("YGL256W",341).
component("YDL168W",217).
component("YBR145W",163).
component("YPL231W",667).
component("YBR265W",178).
component("U46_",95).
component("YBR149W",164).
component("YBR149W",165).
component("YGL001C",318).
component("YIL094C",407).
component("U45_",94).
component("YML056C",544).
component("YLR432W",538).
component("YHR216W",401).
component("YAR075W",139).
component("YAR073W",138).
component("YDR127W",238).
component("YOL126C",617).
component("YKL085W",473).
component("YDL078C",205).
component("YNL037C",568).
component("YNL009W",566).
component("YLR174W",517).
component("YHR183W",395).
component("YGR256W",362).
component("YOL059W",609).
component("YDL022W",199).
component("YCL018W",186).
component("YLR355C",533).
component("YDL174C",221).
component("YML086C",546).
component("YIL155C",416).
component("YGR088W",349).
component("YDR256C",250).
component("YKL026C",471).
component("YIR037W",425).
component("YBR244W",174).
component("YJR078W",460).
component("U58_",103).
component("YJR025C",453).
component("U107_",24).
component("YHR007C",372).
component("YJR104C",462).
component("YHR008C",373).
component("YOR384W",650).
component("YOR381W",649).
component("YOL152W",619).
component("YLL051C",498).
component("YJL026W",427).
component("YIL066C",405).
component("YGR180C",353).
component("YER070W",294).
component("U37_",88).
component("U36_",87).
component("YDL168W",218).
component("YJR009C",450).
component("YJL052W",429).
component("YGR192C",355).
component("YBR006W",148).
component("YPL276W",675).
component("YPL275W",674).
component("YOR388C",651).
component("YOR374W",647).
component("YER073W",295).
component("YGL154C",333).
component("U55_",102).
component("YER069W",292).
component("YOR323C",640).
component("YER178W",303).
component("YBR221C",172).
component("YIL125W",412).
component("U52_",100).
component("YBR166C",167).
component("YGL012W",322).
component("YKL216W",486).
component("YDR044W",231).
component("YKR009C",488).
component("YIL160C",417).
component("YGL205W",338).
component("YMR118C",554).
component("YLR164W",515).
component("YLL041C",497).
component("YKL148C",477).
component("YKL141W",475).
component("YJL045W",428).
component("YDR178W",245).
component("YEL047C",279).
component("YDL171C",219).
component("YDL171C",220).
component("YOR375C",648).
component("YDL215C",223).
component("YAL062W",136).
component("U99_",131).
component("U100_",20).
component("YBR035C",154).
component("YKR080W",493).
component("YER023W",285).
component("YOR236W",638).
component("YGR204W",356).
component("YIR034C",424).
component("YLR142W",512).
component("U65_",109).
component("U63_",107).
component("U62_",106).
component("YHR068W",382).
component("YKL150W",478).
component("YIL043C",404).
component("YHR042W",377).
component("YPL171C",662).
component("YHR179W",394).
component("YMR145C",557).
component("YML120C",547).
component("YKL192C",483).
component("YDL085W",207).
component("YGR234W",358).
component("YFR030W",314).
component("YPL017C",653).
component("YFL018C",307).
component("YDR353W",259).
component("YPR167C",687).
component("YJR137C",465).
component("YNL052W",570).
component("YMR256C",562).
component("YLR395C",537).
component("YLR038C",503).
component("YIL111W",409).
component("YHR051W",381).
component("YGL191W",336).
component("YGL187C",335).
component("YDL067C",204).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",673).
component("YKR069W",492).
component("YOL096C",612).
component("U47_",96).
component("YER091C",300).
component("YJR073C",458).
component("YDR120C",236).
component("YML008C",540).
component("YDL033C",201).
component("YOL096C",613).
component("YLR172C",516).
component("YLR058C",506).
component("YDR019C",229).
component("YBR176W",168).
component("YDR408C",264).
component("YMR120C",555).
component("YLR028C",501).
component("YBL013W",140).
component("YJL130C",437).
component("YKL024C",470).
component("YPR074C",683).
component("YBR117C",162).
component("YCL009C",185).
component("YNL071W",572).
component("YNR008W",593).
component("YIL160C",418).
component("YNR019W",596).
component("YCR048W",196).
component("U48_",97).
component("YDR232W",247).
component("YPL231W",668).
component("YDL052C",203).
component("U8_",125).
component("YPL231W",669).
component("YPL028W",654).
component("YLR299W",526).
component("YGL017W",323).
component("YML126C",548).
component("YNL104C",575).
component("YDL182W",222).
component("YDL131W",211).
component("YLR258W",523).
component("YFR015C",312).
component("YNL029C",567).
component("YIL085C",406).
component("YMR306W",564).
component("YLR342W",532).
component("YGR032W",344).
component("YLR209C",519).
component("U104_",21).
component("YDR354W",260) :- not remove_orf("YDR354W",260).
component("YFR047C",315).
component("YJR133W",464).
component("YLR209C",520).
component("YML022W",541).
component("YDR441C",266).
component("YJL167W",442).
component("YJL167W",443).
component("YDR127W",239).
component("YLR146C",513).
component("YHR068W",383).
component("YLR303W",528).
component("YGR012W",342).
component("YML082W",545).
component("YJR130C",463).
component("YDR035W",230).
component("YBR249C",175).
component("YLR180W",518).
component("YDR502C",269).
component("YOR274W",639).
component("YBR256C",177).
component("YHR137W",390).
component("YGL202W",337).
component("YLR027C",500).
component("YKL106W",474).
component("YOL140W",618).
component("YLR438W",539).
component("YGR019W",343).
component("YLR089C",508).
component("U64_",108).
component("U61_",105).
component("U51_",99).
component("YJR148W",466).
component("YHR208W",399).
component("YFL030W",308).
component("YOR184W",632).
component("YNR058W",599).
component("YIL116W",411).
component("YGL253W",340).
component("YFR053C",316).
component("YMR013C",552).
component("YMR205C",558).
component("YGR240C",359).
component("YOL016C",603).
component("YFR014C",311).
component("YCR036W",195).
component("YCL040W",188).
component("U15_",45).
component("YPL188W",663).
component("YJR049C",455).
component("YEL041W",277).
component("U96_",129).
component("YKL001C",469).
component("YDR236C",248).
component("YHL032C",370).
component("YDR531W",273).
component("U83_",124).
component("U82_",123).
component("U81_",122).
component("YMR208W",559).
component("YPL203W",664).
component("YOR061W",623).
component("YKL166C",480).
component("YJL164C",441).
component("YIL035C",403).
component("YHR205W",398).
component("YHR102W",389).
component("YGL019W",324).
component("YHR025W",376).
component("YOR347C",645).
component("YAL038W",134).
component("YNR012W",594).
component("YDR009W",228).
component("YDR127W",240).
component("YDR147W",243).
component("YDR300C",255).
component("YCR012W",190).
component("YER069W",293).
component("U18_",62).
component("U76_",118).
component("YER170W",302).
component("YDR226W",246).
component("YKL067W",472).
component("YOL055C",606).
component("YDR454C",267).
component("YJR057W",456).
component("YOL061W",610).
component("YKL181W",481).
component("YHL011C",369).
component("YER099C",301).
component("YBL068W",146).
component("YOR143C",628).
component("YNL256W",584).
component("YLR328W",530).
component("YBR018C",150).
component("YLR328W",531).
component("U94_",128).
component("YJR010W",451).
component("YBR029C",153).
component("YGL130W",331).
component("YDR530C",272).
component("YPR190C",690).
component("YPR187W",689).
component("YPR110C",684).
component("YPR010C",678).
component("YOR341W",644).
component("YOR340C",643).
component("YOR224C",637).
component("YOR210W",636).
component("YOR207C",634).
component("YOR151C",629).
component("YOR116C",625).
component("YOL005C",601).
component("YNR003C",592).
component("YNL248C",583).
component("YNL151C",579).
component("YNL113W",576).
component("YKL144C",476).
component("YJR063W",457).
component("YJL148W",440).
component("YJL140W",439).
component("YIL021W",402).
component("YHR143W-A",391).
component("YGL070C",329).
component("YFL036W",309).
...
component("YPR175W",688).
component("YPL167C",661).
component("YOR330C",641).
component("YOL115W",616).
component("YNL299W",590).
component("YNL262W",586).
component("YNL102W",574).
component("YJR043C",454).
component("YJR006W",449).
component("YJL090C",432).
component("YIL139C",414).
...
component("YPR113W",685).
component("YBR243C",173).
component("YPL148C",659).
component("YER026C",286).
component("YGR286C",366).
component("YHR189W",396).
component("YDR058C",235).
component("YDL086W",208).
component("YOL011W",602).
component("YMR008C",550).
component("YMR006C",549).
component("U105_",22).
component("YBL015W",141).
component("YJL068C",430).
component("YOR040W",622).
component("U77_",119).
component("YLR377C",535).
component("YPR073C",681).
component("YHR215W",400).
component("YDL024C",200).
component("YBR093C",160).
component("YBR092C",159).
component("YHR046C",380).
component("U9_",132).
component("YDL236W",225).
component("YPR073C",682).
component("YOR208W",635).
component("YNL053W",571).
component("YMR036C",553).
component("YIR026C",423).
component("YIL113W",410).
component("YFR028C",313).
component("YER075C",296).
...
component("U25_",79).
component("U24_",78).
component("YHR044C",379).
component("YHR043C",378).
component("YOR360C",646).
component("YKR031C",489).
component("YPL206C",665).
component("YGL027C",326).
component("YLR286C",525).
component("YJR153W",467).
component("YJL221C",448).
component("YJL216C",446).
component("YIL172C",421).
component("YGR292W",368).
component("YGR287C",367).
component("YBR299W",184).
component("YBR184W",169).
component("YIR019C",422).
component("YIL099W",408).
component("YDL037C",202).
component("YOR190W",633).
component("YLR300W",527).
component("YGR282C",365).
component("YDR261C",251).
component("YDR400W",262).
component("YML035C",542).
component("YJL070C",431).
component("YBR284W",181).
component("U106_",23).
component("YER043C",287).
component("YNL045W",569).
component("YDR242W",249).
component("U53_",101).
component("YPR062W",680).
component("YMR120C",556).
component("YLR028C",502).
component("YHR144C",392).
component("YGR267C",364).
component("YBL033C",142).
component("YNL141W",577).
component("YLR245C",522).
component("YML035C",543).
component("YBR084W",157).
component("YJL126W",435).
component("U44_",93).
component("YDL100C",209).
component("U40_",91).
component("U39_",89).
component("YBR011C",149).
component("YHR201C",397).
component("YBR111C",161).
component("YBR252W",176).
component("YER005W",284).
component("YBL099W",147).
component("YLR231C",521).
component("YLR134W",510).
component("YLR044C",504).
component("YGR087C",348).
component("YDR380W",261).
component("YDL080C",206).
component("U98_",130).
component("YMR250W",561).
component("YOR128C",626).
component("YEL021W",276).
component("U93_",127).
component("YKL211C",484) :- not remove_orf("YKL211C",484).
component("YKR097W",495).
component("YNL169C",580).
component("YNL256W",585).
component("YDR294C",253).
component("YEL046C",278).
component("YNR033W",597).
component("YKL211C",485) :- not remove_orf("YKL211C",485).
component("YER090W",485) :- not remove_orf("YER090W",485).
component("YER090W",299) :- not remove_orf("YER090W",299).
component("YDR127W",241).
component("YPL281C",676).
component("YOR393W",652).
component("YMR323W",565).
component("YHR174W",393).
component("YGR254W",361).
component("YPL262W",671).
component("YGL026C",325) :- not remove_orf("YGL026C",325).
component("YGR155W",351).
component("YLR304C",529).
component("YJL200C",444).
component("YNL316C",591).
component("YPL212C",666).
component("YNL292W",589).
component("YGL063W",328).
component("YFL001W",305).
component("YPR002W",677).
component("YJR016C",452).
component("YCR053W",197).
component("YDR127W",242).
component("YGL148W",332).
component("YIL168W",420).
component("YIL167W",419).
component("YCL064C",189).
component("YER086W",297).
component("YLR359W",534).
component("YAL012W",133).
component("YFR055W",317).
component("YJL005W",426).
component("YJL121C",434).
component("YBR019C",151).
component("YDR050C",234).
component("YDR007W",227) :- not remove_orf("YDR007W",227).
component("YOR095C",624).
component("YBR196C",170).
component("YGL001C",319).
component("YPL117C",658).
component("U14_",39).
component("YOL056W",607).
component("YKL152C",479).
component("YDL021W",198).
component("YEL058W",281).
component("YPR060C",679).
component("YHR072W",384).
component("YPL097W",656).
component("YGR185C",354).
component("YGR264C",363).
component("YGR171C",352).
component("YPL104W",657).
component("YLL018C",496).
component("YHR020W",375).
component("YER087W",298).
component("YNL247W",582).
component("YOR168W",630).
component("YOL097C",614).
component("YDR268W",252).
component("YCR024C",192).
component("YHR019C",374).
component("YPL160W",660).
component("YLR382C",536).
component("YNL073W",573).
component("YOR335C",642).
component("YLR153C",514).
component("YAL054C",135).
component("YGR244C",360).
component("YIL145C",415).
component("YJL101C",433).
component("YOL049W",605).
component("YAR015W",137).
component("YER183C",304).
component("U90_",126).
component("YNR057C",598).
component("YDL141W",213).
component("YGL234W",339).
component("YDL141W",214).
component("YJR103W",461).
component("YBL039C",144).
component("YGR204W",357).
component("YBR084W",158).
component("YNL220W",581).
component("YOL058W",608).
component("YDL141W",215).
component("YHR074W",385).
component("YMR217W",560).
component("YGL062W",327).
component("YBR218C",171).
component("YPL231W",670).
component("YNR016C",595).
component("YKL182W",482).
component("YGR037C",345).
component("YPR138C",686).
component("YPL265W",672).
component("YPL036W",655).
component("YOR171C",631).
component("YOR130C",627).
component("YOR011W",621).
component("YOL156W",620).
component("YOL103W",615).
component("YOL020W",604) :- not remove_orf("YOL020W",604).
component("YNR072W",600).
component("YNL270C",587).
component("YNL142W",578).
component("YMR011W",551).
component("YLR260W",524).
component("YLR138W",511).
component("YLR100C",509).
component("YLR081W",507).
component("YLL061W",499).
component("YKR093W",494).
component("YKR053C",491).
component("YKR039W",490) :- not remove_orf("YKR039W",490).
component("YJR158W",468).
component("YJR077C",459).
component("YJL219W",447).
component("YJL214W",445).
component("YJL134W",438).
component("YJL129C",436).
component("YIL134W",413).
component("YHR096C",388).
component("YHR094C",387).
component("YHR092C",386).
component("YHL036W",371).
component("YGR121C",350).
component("YGR065C",347).
component("YGR055W",346).
component("YGL186C",334).
component("YGL077C",330).
component("YGL008C",320).
component("YFL055W",310).
component("YFL011W",306).
...
catalyst(5880,276).
catalyst(2300,127).
catalyst(3600,484) :- not remove_reaction(3600,484).
catalyst(8000,495).
catalyst(6890,580).
catalyst(2570,585).
catalyst(8781,253).
...
catalyst(4560,278).
catalyst(2550,597).
catalyst(1890,485) :- not remove_reaction(1890,485).
catalyst(3630,485) :- not remove_reaction(3630,485).
catalyst(1890,299) :- not remove_reaction(1890,299).
...
catalyst(8051,671).
catalyst(8052,671).
catalyst(3590,325) :- not remove_reaction(3590,325).
catalyst(10910,325) :- not remove_reaction(10910,325).
catalyst(4570,351).
catalyst(8181,529).
catalyst(8182,529).
catalyst(8181,444).
...
catalyst(851,490) :- not remove_reaction(851,490).
catalyst(852,490) :- not remove_reaction(852,490).
...
catalyst(921,490) :- not remove_reaction(921,490).
catalyst(922,490) :- not remove_reaction(922,490).
catalyst(931,490) :- not remove_reaction(931,490).
catalyst(932,490) :- not remove_reaction(932,490).
