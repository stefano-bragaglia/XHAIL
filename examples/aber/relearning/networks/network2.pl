...
component("YLR056W",279).
component("YKR009C",267).
component("YOL086C",338).
component("YMR303C",310).
component("YGL256W",194).
component("YDL168W",122).
component("YBR145W",93).
component("YPL231W",369).
component("U46_",59).
component("YBR149W",94).
component("YGL001C",176).
component("YIL094C",228).
component("U45_",58).
component("YDR127W",131).
component("YOL126C",342).
component("YKL085W",259).
component("YDL078C",116).
component("YNL037C",314).
component("YCL018W",105).
component("YLR355C",298).
component("YDL174C",123).
component("YML086C",303).
component("YGR088W",200).
component("YDR256C",141).
component("YJR078W",253).
component("YJR025C",248).
component("U107_",22).
component("YJL026W",236).
component("YGR180C",203).
component("YER070W",167).
component("U36_",54).
component("YPL276W",375).
component("YPL275W",374).
component("YOR388C",360).
component("YOR323C",354).
component("YIL125W",230).
component("U52_",62).
component("YBR166C",96).
component("YKL216W",266).
component("YKR009C",268).
component("YIL160C",233).
component("YGL205W",191).
component("YKR080W",272).
component("YER023W",162).
component("YGR204W",205).
component("YLR142W",284).
component("U65_",65).
component("U62_",64).
component("YHR068W",218).
component("YKL150W",262).
component("YIL043C",226).
component("YPL171C",368).
component("YHR179W",224).
component("YGR234W",206).
component("YDR353W",145).
component("YNL052W",315).
component("YMR256C",309).
component("YLR395C",300).
component("YLR038C",277).
component("YIL111W",229).
component("YHR051W",217).
component("YGL191W",189).
component("YGL187C",188).
component("YDL067C",115).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",373).
component("YKR069W",271).
component("YJR073C",251).
component("YDL033C",114).
component("YLR172C",286).
component("YLR058C",280).
component("YDR019C",126).
component("YBR176W",97).
component("YDR408C",150).
component("YMR120C",307).
component("YLR028C",275).
component("YBL013W",78).
component("YJL130C",241).
component("YKL024C",257).
component("YPR074C",379).
component("YBR117C",92).
component("YCL009C",104).
component("YNL071W",316).
component("U48_",60).
component("YPL231W",370).
component("YPL231W",371).
component("YLR299W",293).
component("YGL017W",179).
component("YML126C",304).
component("YDL182W",124).
component("YDL131W",119).
component("YLR258W",291).
component("YFR015C",173).
component("YNL029C",313).
component("YIL085C",227).
component("YMR306W",311).
component("YLR342W",297).
component("YGR032W",196).
component("YLR209C",287).
component("U104_",20).
component("YDR354W",146) :- not remove_orf("YDR354W",146).
component("YFR047C",174).
component("YLR209C",288).
component("YML022W",301).
component("YDR441C",152).
component("YJL167W",245).
component("YDR127W",132).
component("YLR303W",295).
component("YGR012W",195).
component("YJR130C",255).
component("YDR035W",127).
component("YBR249C",99).
component("YOR274W",353).
component("YHR137W",220).
component("YGL202W",190).
component("YLR027C",274).
component("YKL106W",260).
component("YOL140W",343).
component("YLR089C",281).
component("YJR148W",256).
component("YNR058W",332).
component("YGL253W",193).
component("YFR053C",175).
component("YCR036W",112).
component("U96_",74).
component("YDR236C",139).
component("YHL032C",212).
component("YNR012W",330).
component("YDR127W",133).
component("YDR147W",136).
component("U76_",71).
component("YER170W",170).
component("YDR226W",138).
component("YKL067W",258).
component("YOL055C",336).
component("YDR454C",153).
component("YOL061W",337).
component("YKL181W",263).
component("YHL011C",211).
component("YER099C",169).
component("YBL068W",82).
component("YNL256W",324).
component("YBR018C",85).
component("YBR029C",87).
component("YGL130W",185).
component("YPR190C",385).
component("YPR187W",384).
component("YPR110C",380).
component("YPR010C",377).
component("YOR341W",358).
component("YOR340C",357).
component("YOR224C",352).
component("YOR210W",351).
component("YOR207C",350).
component("YOR151C",347).
component("YOR116C",346).
component("YOL005C",333).
component("YNR003C",329).
component("YNL248C",323).
component("YNL151C",321).
component("YNL113W",318).
component("YKL144C",261).
component("YJR063W",250).
component("YJL148W",244).
component("YJL140W",243).
component("YIL021W",225).
component("YHR143W-A",221).
component("YGL070C",183).
component("YFL036W",171).
component("YDR404C",149).
component("YDR156W",137).
component("YDR045C",128).
component("YDL150W",121).
component("YDL140C",120).
component("YBR154C",95).
component("YPR175W",383).
component("YPL167C",367).
component("YOR330C",355).
component("YOL115W",341).
component("YNL299W",327).
component("YNL262W",325).
component("YNL102W",317).
component("YJR043C",249).
component("YJR006W",247).
component("YJL090C",238).
component("YIL139C",231).
component("YEL055C",159).
component("YDR419W",151).
component("YDR121W",130).
component("YDL102W",118).
component("YCR014C",108).
component("YBR278W",101).
component("YBL035C",80).
component("YPR113W",381).
component("YPL148C",366).
component("YGR286C",210).
component("YOL011W",334).
component("YMR008C",306).
component("YMR006C",305).
component("U105_",21).
component("YBL015W",79).
component("U77_",72).
component("YLR377C",299).
component("U30_",53).
component("U29_",52).
component("U24_",51).
component("YHR044C",216).
component("YHR043C",215).
component("YOR360C",359).
component("YGL027C",181).
component("YOR190W",349).
component("YLR300W",294).
component("YGR282C",209).
component("YDR261C",142).
component("YDR400W",148).
component("YML035C",302).
component("YJL070C",237).
component("YBR284W",102).
component("YDR242W",140).
component("U53_",63).
component("YMR120C",308).
component("YLR028C",276).
component("YHR144C",222).
component("YNL141W",319).
component("YLR245C",290).
component("YJL126W",239).
component("U39_",55).
component("YBR011C",84).
component("YBR111C",91).
component("YBR252W",100).
component("YER005W",161).
component("YBL099W",83).
component("YLR231C",289).
component("YLR134W",283).
component("YLR044C",278).
component("YGR087C",199).
component("YDR380W",147).
component("YDL080C",117).
component("U98_",75).
component("YKL211C",264) :- not remove_orf("YKL211C",264).
component("YNL169C",322).
component("YKL211C",265) :- not remove_orf("YKL211C",265).
component("YER090W",168) :- not remove_orf("YER090W",168).
component("YDR127W",134).
component("YPL281C",376).
component("YOR393W",361).
component("YMR323W",312).
component("YHR174W",223).
component("YGR254W",207).
component("YGL026C",180) :- not remove_orf("YGL026C",180).
component("YLR304C",296).
component("YJL200C",246).
component("YNL316C",328).
component("YCR053W",113).
component("YDR127W",135).
component("YGL148W",186).
component("YIL168W",235).
component("YIL167W",234).
component("YCL064C",107).
component("YAL012W",76).
component("YBR019C",86).
component("YDR007W",125) :- not remove_orf("YDR007W",125).
component("YOR095C",345).
component("YGL001C",177).
component("YPL117C",365).
component("YPR060C",378).
component("YPL097W",363).
component("YGR185C",204).
component("YGR264C",208).
component("YGR171C",202).
component("YPL104W",364).
component("YLL018C",273).
component("YOL097C",339).
component("YDR268W",143).
component("YCR024C",109).
component("YHR019C",214).
component("YOR335C",356).
component("YLR153C",285).
component("YAL054C",77).
component("YIL145C",232).
component("U90_",73).
component("YNR057C",331).
component("YGL234W",192).
component("YJR103W",254).
component("YBL039C",81).
component("YBR084W",90).
component("YHR074W",219).
component("YGL062W",182).
component("YBR218C",98).
component("YPR138C",382).
component("YPL265W",372).
component("YPL036W",362).
component("YOR171C",348).
component("YOR011W",344).
component("YOL103W",340).
component("YOL020W",335) :- not remove_orf("YOL020W",335).
component("YNL270C",326).
component("YNL142W",320).
component("YLR260W",292).
component("YLR100C",282).
component("YKR053C",270).
component("YKR039W",269) :- not remove_orf("YKR039W",269).
component("YJR077C",252).
component("YJL134W",242).
component("YJL129C",240).
component("YHL036W",213).
component("YGR121C",201).
component("YGR065C",198).
component("YGR055W",197).
component("YGL186C",187).
component("YGL077C",184).
component("YGL008C",178).
component("YFL055W",172).
component("YER060W-A",166).
component("YER060W",165).
component("YER056C",164).
component("YER053C",163).
component("YEL063C",160).
component("YEL017C-A",158).
component("YDR536W",157).
component("YDR508C",156).
component("YDR503C",155).
component("YDR497C",154).
component("YDR297W",144).
component("YDR046C",129) :- not remove_orf("YDR046C",129).
component("YCR032W",111).
component("YCR024C-A",110).
component("YCL025C",106).
component("YBR298C",103).
component("YBR069C",89) :- not remove_orf("YBR069C",89).
component("YBR068C",88) :- not remove_orf("YBR068C",88).
component("U75_",70).
component("U74_",69).
component("U73_",68).
component("U72_",67).
...
catalyst(2121,20).
catalyst(2122,20).
catalyst(3620,146) :- not remove_reaction(3620,146).
catalyst(2190,174).
catalyst(5791,288).
catalyst(5792,288).
catalyst(5801,288).
...
catalyst(8812,117).
catalyst(2250,75).
catalyst(3600,264) :- not remove_reaction(3600,264).
catalyst(6890,322).
catalyst(3630,265) :- not remove_reaction(3630,265).
catalyst(3630,168) :- not remove_reaction(3630,168).
catalyst(3740,134).
catalyst(8231,376).
catalyst(8232,376).
catalyst(8231,361).
...
catalyst(8231,207).
catalyst(8232,207).
catalyst(3590,180) :- not remove_reaction(3590,180).
catalyst(8181,296).
catalyst(8182,296).
catalyst(8181,246).
catalyst(8182,246).
...
catalyst(7751,86).
catalyst(7752,86).
catalyst(3610,125) :- not remove_reaction(3610,125).
catalyst(7921,345).
catalyst(7922,345).
catalyst(6370,177).
catalyst(6461,365).
...
catalyst(901,335) :- not remove_reaction(901,335).
catalyst(902,335) :- not remove_reaction(902,335).
catalyst(931,326).
catalyst(932,326).
catalyst(371,320).
catalyst(372,320).
...
catalyst(6330,282).
catalyst(6560,270).
catalyst(771,269) :- not remove_reaction(771,269).
catalyst(772,269) :- not remove_reaction(772,269).
catalyst(781,269) :- not remove_reaction(781,269).
catalyst(782,269) :- not remove_reaction(782,269).
catalyst(801,269) :- not remove_reaction(801,269).
catalyst(802,269) :- not remove_reaction(802,269).
catalyst(811,269) :- not remove_reaction(811,269).
catalyst(812,269) :- not remove_reaction(812,269).
catalyst(831,269) :- not remove_reaction(831,269).
catalyst(832,269) :- not remove_reaction(832,269).
catalyst(841,269) :- not remove_reaction(841,269).
catalyst(842,269) :- not remove_reaction(842,269).
catalyst(851,269) :- not remove_reaction(851,269).
catalyst(852,269) :- not remove_reaction(852,269).
catalyst(881,269) :- not remove_reaction(881,269).
catalyst(882,269) :- not remove_reaction(882,269).
catalyst(901,269) :- not remove_reaction(901,269).
catalyst(902,269) :- not remove_reaction(902,269).
catalyst(931,269) :- not remove_reaction(931,269).
catalyst(932,269) :- not remove_reaction(932,269).
catalyst(1191,269) :- not remove_reaction(1191,269).
catalyst(1192,269) :- not remove_reaction(1192,269).
catalyst(1581,252).
catalyst(1582,252).
catalyst(6560,242).
catalyst(361,240).
...
catalyst(1121,103).
catalyst(1122,103).
catalyst(771,89) :- not remove_reaction(771,89).
catalyst(772,89) :- not remove_reaction(772,89).
catalyst(801,89) :- not remove_reaction(801,89).
catalyst(802,89) :- not remove_reaction(802,89).
catalyst(811,89) :- not remove_reaction(811,89).
catalyst(812,89) :- not remove_reaction(812,89).
catalyst(851,89) :- not remove_reaction(851,89).
catalyst(852,89) :- not remove_reaction(852,89).
catalyst(901,89) :- not remove_reaction(901,89).
catalyst(902,89) :- not remove_reaction(902,89).
...
catalyst(841,88) :- not remove_reaction(841,88).
catalyst(842,88) :- not remove_reaction(842,88).
catalyst(851,88) :- not remove_reaction(851,88).
catalyst(852,88) :- not remove_reaction(852,88).
catalyst(901,88) :- not remove_reaction(901,88).
catalyst(902,88) :- not remove_reaction(902,88).
catalyst(2920,70).
catalyst(2920,69).
catalyst(2920,68).
catalyst(2920,67).
