...
component("YNL280C",514).
component("YLR056W",430).
component("YKR009C",419).
component("YMR083W",478).
component("YPL231W",579).
component("YJR159W",399).
component("YGL001C",280).
component("YML056C",464).
...
component("YJR139C",396).
component("YOR136W",545).
component("YNL009W",495).
component("YLR174W",442).
component("YDL066W",177).
component("YHR183W",344).
component("YGR256W",320).
component("YOL059W",534).
component("YDL022W",172).
component("YCL018W",158).
component("YLR355C",454).
component("YML054C",463).
component("YEL024W",241).
component("YJR078W",392).
component("U58_",91).
component("YGR255C",319).
component("YMR015C",475).
component("YDR402C",229).
component("YGL055W",286).
component("YJL026W",364).
component("YIL066C",353).
component("YGR180C",311).
component("YER070W",256).
component("U36_",79).
component("U35_",78).
component("YJR009C",383).
component("YJL052W",365).
...
component("YNL280C",515).
component("YER014W",245).
component("YKL141W",406).
component("YJR051W",387).
component("YOR375C",565).
component("YDL215C",197).
component("YAL062W",114).
component("U100_",20).
component("YBR035C",131).
component("YMR189W",483).
component("U56_",90).
component("YPL023C",568).
component("YGL125W",289).
component("YOR236W",553).
...
component("YKL150W",408).
component("YIL043C",351).
component("YHR042W",329).
component("YMR145C",482).
component("YML120C",469).
component("YKL192C",413).
component("YDL085W",180).
component("YBR046C",133).
component("YPL091W",571).
component("YER042W",246).
component("YNL052W",497).
component("YMR256C",490).
component("YLR395C",457).
...
component("YPL273W",587).
component("YLL062C",425).
component("YDR410C",231).
component("YER091C",261).
component("YJR073C",390).
component("YDL033C",173).
component("YOL096C",536).
component("YLR172C",441).
component("YMR120C",481).
component("YBL013W",117).
component("YJL130C",373).
component("YJL088W",368).
component("YPR074C",597).
component("YBR117C",141).
component("YMR108W",480).
component("YCL009C",157).
component("YMR062C",477).
component("YNL071W",498).
component("YIL160C",358).
component("YNR019W",522).
component("YCR048W",169).
component("U48_",84).
component("YNL277W",513).
...
component("YJL167W",380).
component("YPR069C",596).
...
component("YLR027C",426).
component("YKL106W",404).
component("YOL140W",539).
component("YLR438W",461).
component("YKL104C",403).
...
component("YMR013C",474).
component("YLR240W",446).
component("YKL203C",415).
component("YJR066W",389).
component("YCR036W",168).
component("YGR194C",314).
component("YCL040W",162).
component("YJR105W",393).
component("U16_",46).
component("YKL001C",400).
component("YML070W",466).
component("YFL053W",272).
component("U82_",106).
component("U81_",105).
component("YMR208W",485).
component("YPL203W",577).
component("YOR061W",540).
component("YKL166C",409).
component("YJL164C",379).
component("YIL035C",350).
component("YHR205W",346).
component("YHR102W",337).
component("YGL019W",282).
component("YHR025W",328).
component("YNR012W",520).
component("YPR121W",599).
component("YPL258C",583).
component("YOL055C",532).
component("U1_",58).
...
component("U17_",50).
component("U76_",102).
component("YMR220W",487).
component("YER170W",267).
component("YDR226W",221).
component("YKL067W",402).
component("YOL055C",533).
component("YDR454C",234).
component("YOL061W",535).
component("YKL181W",410).
component("YHL011C",323).
component("YER099C",263).
component("YBL068W",123).
component("YOR143C",546).
component("YNL256W",511).
component("YBR018C",126).
component("YDL055C",176).
component("YLR328W",452).
component("YDL103C",184).
component("U94_",111).
component("YJR010W",384).
component("YBR029C",130).
component("YPR190C",604).
component("YPR187W",603).
component("YPR110C",598).
component("YPR010C",591).
component("YOR341W",561).
component("YOR340C",560).
component("YOR224C",552).
component("YOR210W",551).
component("YOR207C",550).
component("YOR151C",547).
component("YOR116C",542).
component("YOL005C",527).
component("YNR003C",519).
component("YNL248C",510).
component("YNL151C",507).
component("YNL113W",501).
component("YKL144C",407).
component("YJR063W",388).
component("YJL148W",376).
component("YJL140W",375).
...
component("YPR175W",602).
component("YPL167C",575).
component("YOR330C",558).
component("YOL115W",538).
component("YNL299W",516).
component("YNL262W",512).
component("YNL102W",500).
component("YJR043C",386).
component("YJR006W",382).
...
component("YKL035W",401).
component("YHL012W",324).
component("YHR123W",338).
component("YNL130C",503).
component("YPL148C",573).
component("YOR251C",554).
component("YGR286C",322).
component("YDR058C",206).
component("YOL011W",529).
component("YMR008C",473).
component("YMR006C",472).
component("U105_",24).
component("U101_",21).
component("YJL068C",366).
component("YPL072W",570).
component("YOR124C",543).
component("YNL186W",508).
component("YMR304W",493).
component("YMR223W",488).
component("YKR098C",424).
component("YJL197W",381).
component("YIL156W",357).
...
component("YJR019C",385).
component("YDR074W",208).
component("YFR025C",276).
component("YPL179W",576).
component("YNR032W",523).
component("YML057W",465).
component("YML016C",462).
component("YLR433C",460).
...
component("YIL162W",359).
component("YPR026W",592).
component("YDR001C",199).
component("YBR001C",125).
component("YDR400W",228).
component("U102_",22).
component("YER043C",247).
component("YNL045W",496).
component("YLR160C",440).
component("YLR158C",439).
component("YLR157C",438).
component("YLR155C",437).
component("YDR321W",224).
component("YGL037C",285).
component("U43_",82).
component("U42_",81).
component("YLR308W",451).
component("YLR307W",450).
component("U53_",88).
component("YLR420W",458).
component("YIR032C",363).
component("YLR028C",427).
component("YHR144C",341).
component("YHR144C",342).
component("YNL141W",504).
component("YBR153W",144).
component("YDL238C",198).
component("YNL141W",505).
component("YBR084W",138).
component("YJL126W",371).
component("U44_",83).
...
component("YOR168W",548).
component("YPR047W",594).
component("YLR060W",431).
component("YFL022C",270).
component("YPR033C",593).
component("YHR019C",326).
component("YKL194C",414).
component("YIL078W",354).
component("YPL160W",574).
component("YLR382C",456).
component("YPL040C",569).
component("YBL076C",124).
component("YNL073W",499).
...
component("YMR217W",486).
component("YPR145W",601).
component("YGR124W",306).
component("YOR303W",555).
component("YGL062W",287).
component("YBR218C",149).
component("YPL231W",582).
component("YNR016C",521).
component("YKL182W",411).
component("YGR037C",300).
component("YJL087C",367).
component("YOL010W",528).
component("YPR138C",600).
component("YPL265W",584).
component("YOR348C",562).
component("YOR130C",544).
component("YOL103W",537).
component("YOL020W",530).
component("YNL142W",506).
component("YMR272C",492).
component("YMR202W",484).
component("YMR056C",476).
component("YML123C",470).
component("YLR348C",453).
component("YLR138W",435).
component("YLR100C",433).
component("YLR092W",432).
component("YKR053C",422).
component("YKR039W",421).
component("YKL217W",418).
component("YJR077C",391).
component("YJL134W",374).
component("YJL129C",372).
