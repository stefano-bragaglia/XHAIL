...
component("YNL280C",386).
component("YLR056W",323).
component("YMR083W",359).
component("YPL231W",433).
component("YJR159W",297).
component("YGL001C",208).
component("YML056C",347).
component("YLR432W",345).
component("YHR216W",259).
component("YAR075W",88).
component("YAR073W",87).
component("YDR127W",157).
component("YJR139C",294).
component("YNL009W",374).
component("YLR174W",332).
component("YHR183W",255).
component("YGR256W",236).
component("YCL018W",118).
component("YJR078W",290).
component("U58_",70).
component("YGR255C",235).
component("YMR015C",356).
component("YDR402C",171).
component("YGL055W",213).
component("YJL026W",269).
component("YGR180C",230).
component("YOR374W",423).
component("YER073W",190).
component("U68_",74).
component("U55_",68).
component("YER069W",189).
component("YOR323C",418).
component("YBR166C",111).
component("YNL280C",387).
component("YKL141W",303).
component("YOR375C",424).
component("YDL215C",145).
component("YAL062W",86).
component("U100_",20).
component("YBR035C",98).
component("YMR189W",363).
component("U56_",69).
component("YPL023C",426).
component("YGL125W",215).
component("YOR236W",416).
component("YBR084W",103).
component("YLR142W",327).
component("U65_",73).
component("U62_",72).
component("YHR068W",246).
component("YMR145C",362).
component("YML120C",350).
component("YKL192C",309).
component("YDL085W",131).
component("YBR046C",99).
component("YPL091W",429).
component("YNL052W",375).
component("YMR256C",369).
component("YLR395C",343).
component("YLR038C",321).
component("YIL111W",263).
component("YHR051W",245).
component("YGL191W",219).
component("YGL187C",218).
component("YDL067C",129).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",439).
component("YLL062C",318).
component("YDR410C",173).
component("YER091C",192).
component("YJR073C",288).
component("YOL096C",402).
component("YMR120C",361).
component("YBL013W",89).
component("YJL130C",275).
component("YJL088W",271).
component("YPR074C",445).
component("YBR117C",107).
component("YCL009C",117).
component("YMR062C",358).
component("YNL071W",376).
component("YNR019W",393).
component("YCR048W",126).
component("U48_",64).
component("YFL017C",198).
component("YPL231W",434).
component("YDL052C",128).
component("U8_",81).
component("YPL231W",435).
component("YLR299W",336).
component("YCR005C",123).
component("YML126C",352).
component("YDL182W",143).
component("YDL131W",136).
component("YNL117W",379).
component("YIR031C",267).
component("YOR321W",417).
component("YJR143C",295).
component("YGR199W",233).
component("YDL095W",133).
component("YDL093W",132).
component("YAL023C",85).
component("YMR261C",370).
component("YML100W",349).
component("YBR126C",108).
component("YLR209C",333).
component("YDR354W",168).
component("YFR047C",205).
component("YJR133W",293).
component("U22_",54).
component("YDR399W",170).
component("YJL167W",282).
component("YPR069C",444).
component("YDR127W",158).
component("YHR068W",247).
component("YLR303W",337).
component("YML082W",348).
component("YJR130C",292).
component("YDR035W",149).
component("YBR249C",113).
component("YBR256C",114).
component("YHR137W",250).
component("YGL202W",220).
component("YLR027C",319).
component("YKL106W",301).
component("YOL140W",405).
component("YLR438W",346).
component("YKL104C",300).
component("YDR111C",155).
component("U51_",66).
component("YJR148W",296).
component("YHR208W",258).
component("YGL253W",223).
component("YFR053C",206).
component("YMR013C",355).
component("YCR036W",125).
component("YGR194C",232).
component("YCL040W",121).
component("YJR105W",291).
component("U81_",79).
component("YMR208W",365).
component("YPL203W",432).
component("YOR061W",406).
component("YKL166C",305).
component("YJL164C",281).
component("YIL035C",261).
component("YHR205W",257).
component("YHR102W",249).
component("YGL019W",209).
component("YHR025W",242).
component("YNR012W",391).
component("YPR121W",447).
component("YPL258C",437).
component("YOL055C",400).
component("YFR019W",203).
component("YDR208W",164).
component("YDR127W",159).
component("U21_",51).
component("YDR147W",162).
component("YER052C",185).
component("U19_",45).
component("U18_",41).
component("U17_",38).
component("U76_",77).
component("YMR220W",366).
component("YDR226W",165).
component("YKL067W",299).
component("YDR454C",175).
component("YOL061W",401).
component("YKL181W",306).
component("YHL011C",238).
component("YER099C",194).
component("YBL068W",94).
component("YOR143C",410).
component("YLR328W",340).
component("U94_",83).
component("YBR029C",97).
component("YPR190C",452).
component("YPR187W",451).
component("YPR110C",446).
component("YPR010C",441).
component("YOR341W",421).
component("YOR340C",420).
component("YOR224C",415).
component("YOR210W",414).
component("YOR207C",413).
component("YOR151C",411).
component("YOR116C",408).
component("YOL005C",396).
component("YNR003C",390).
component("YNL248C",384).
component("YNL151C",382).
component("YNL113W",378).
component("YKL144C",304).
component("YJR063W",287).
component("YJL148W",278).
component("YJL140W",277).
component("YIL021W",260).
component("YHR143W-A",251).
component("YGL070C",214).
component("YFL036W",200).
component("YDR404C",172).
component("YDR156W",163).
component("YDR045C",150).
component("YDL150W",142).
component("YDL140C",137).
component("YBR154C",110).
component("YPR175W",450).
component("YPL167C",431).
component("YOR330C",419).
component("YOL115W",404).
component("YNL299W",388).
component("YNL262W",385).
component("YNL102W",377).
component("YJR043C",286).
component("YJR006W",284).
component("YJL090C",272).
component("YIL139C",264).
component("YEL055C",182).
component("YDR419W",174).
component("YDR121W",156).
component("YDL102W",134).
component("YCR014C",124).
component("YBR278W",115).
component("YBL035C",91).
component("YKL035W",298).
component("YHL012W",239).
component("YDR058C",152).
component("YOL011W",398).
component("YMR008C",354).
component("YMR006C",353).
component("U105_",22).
component("U101_",21).
component("YPL072W",428).
component("YOR124C",409).
component("YNL186W",383).
component("YMR304W",372).
component("YMR223W",367).
component("YKR098C",317).
component("YJL197W",283).
component("YIL156W",265).
component("YFR010W",202).
component("YER151C",196).
component("YER144C",195).
component("YER098W",193).
component("YDR069C",153).
component("YDL122W",135).
component("YBR058C",100).
component("YBL067C",93).
component("YJR019C",285).
component("YDR074W",154).
component("YFR025C",204).
component("U9_",84).
component("YJL155C",280).
component("U34_",60).
component("U33_",59).
component("U32_",58).
component("U30_",57).
component("U29_",56).
component("U24_",55).
component("YHR044C",244).
component("YHR043C",243).
component("YGL027C",211).
component("YLR286C",335).
component("YLR160C",331).
component("YLR158C",330).
component("YLR157C",329).
component("YLR155C",328).
component("YDR321W",167).
component("YGL037C",212).
component("U43_",62).
component("U42_",61).
component("YLR308W",339).
component("YLR307W",338).
component("U53_",67).
component("YLR420W",344).
component("YIR032C",268).
component("YLR028C",320).
component("YHR144C",252).
component("YHR144C",253).
component("YBR153W",109).
component("YDL238C",146).
component("YNL141W",380).
component("YBR084W",104).
component("YJL126W",274).
component("U44_",63).
component("YHR201C",256).
component("YBR111C",106).
component("YCL030C",120).
component("YER005W",184).
component("YLR231C",334).
component("U88_",80).
component("YDR538W",180).
component("YLR134W",326).
component("YLR044C",322).
component("YGR087C",225).
component("YDR380W",169).
component("YDL080C",130).
component("YMR250W",368).
component("YKL184W",308).
component("YEL021W",181).
component("YKL211C",311).
component("YKR097W",316).
component("YNR033W",394).
component("YKL211C",312).
component("YER090W",191).
component("YDR127W",160).
component("YPL281C",440).
component("YOR393W",425).
component("YMR323W",373).
component("YHR174W",254).
component("YGR254W",234).
component("YGL026C",210).
component("YGR155W",228).
component("YNL316C",389).
component("YCR053W",127).
component("YDR127W",161).
component("YGL148W",216).
component("YIL167W",266).
component("YCL064C",122).
component("YFR055W",207).
component("YJL121C",273).
component("YBR019C",96).
component("YDR007W",147).
component("YOR095C",407).
component("YBR196C",112).
component("U14_",31).
component("YMR105C",360).
component("YKL127W",302).
component("YEL058W",183).
component("YPR060C",443).
component("YHR072W",248).
component("YJL153C",279).
component("YGR264C",237).
component("YGR171C",229).
component("YHR011W",240).
component("YDR023W",148).
component("YGL245W",222).
component("YOR168W",412).
component("YPR047W",442).
component("YLR060W",324).
component("YFL022C",199).
component("YHR019C",241).
component("YKL194C",310).
component("YIL078W",262).
component("YPL160W",430).
component("YLR382C",342).
component("YPL040C",427).
component("YBL076C",95).
component("YGL234W",221).
component("YER183C",197).
component("U90_",82).
component("YNR057C",395).
component("YDL141W",138).
component("YDL141W",139).
component("YDL141W",140).
component("YDL141W",141).
component("YPR145W",449).
component("YGR124W",227).
component("YPL231W",436).
component("YNR016C",392).
component("YKL182W",307).
component("YGR037C",224).
component("YJL087C",270).
component("YOL010W",397).
component("YPR138C",448).
component("YPL265W",438).
component("YOR348C",422).
component("YOL103W",403).
component("YOL020W",399).
component("YNL142W",381).
component("YMR272C",371).
component("YMR202W",364).
component("YMR056C",357).
component("YML123C",351).
component("YLR348C",341).
component("YLR100C",325).
component("YKR053C",315).
component("YKR039W",314).
component("YKL217W",313).
component("YJR077C",289).
component("YJL134W",276).
component("YGR191W",231).
component("YGR121C",226).
component("YGL186C",217).
component("YFL055W",201).
component("YER060W-A",188).
component("YER060W",187).
component("YER056C",186).
component("YDR536W",179).
component("YDR508C",178).
component("YDR503C",177).
component("YDR497C",176).
component("YDR294C",166).
component("YDR046C",151).
component("YDL210W",144).
component("YCL025C",119).
component("YBR291C",116).
component("YBR085W",105).
component("YBR069C",102).
component("YBR068C",101).
component("YBL042C",92).
component("YBL030C",90).
component("U7_",78).
component("U6_",76).
component("U69_",75).
component("U5_",71).
