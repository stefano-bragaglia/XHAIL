...
component("YNL280C",427).
component("YLR056W",357).
component("YMR083W",398).
component("YPL231W",481).
component("YJR159W",331).
...
component("YLR174W",368).
component("YHR183W",283).
component("YGR256W",264).
component("YCL018W",129).
component("YJR078W",324).
component("U58_",78).
component("YGR255C",263).
component("YMR015C",395).
component("YDR402C",189).
component("YGL055W",236).
component("YJL026W",298).
component("YGR180C",257).
component("U35_",68).
component("YJR009C",316).
component("YJL052W",299).
component("YGR192C",259).
component("YOR374W",467).
component("YER073W",210).
component("U68_",82).
component("U55_",76).
component("YER069W",209).
component("YOR323C",461).
component("U2_",63).
component("YBR166C",121).
component("YNL280C",428).
component("YKL141W",337).
component("YJR051W",320).
component("YOR375C",468).
component("YDL215C",161).
component("YAL062W",94).
component("U100_",20).
component("YBR035C",107).
component("YMR189W",402).
component("U56_",77).
component("YPL023C",470).
component("YGL125W",239).
component("YOR236W",459).
component("YBR084W",112).
component("YLR142W",362).
component("U65_",81).
component("U62_",80).
component("YHR068W",274).
component("YMR145C",401).
component("YML120C",389).
component("YKL192C",343).
component("YDL085W",144).
component("YBR046C",108).
component("YPL091W",473).
component("YNL052W",414).
component("YMR256C",408).
component("YLR395C",379).
component("YLR038C",355).
component("YIL111W",291).
component("YHR051W",273).
component("YGL191W",243).
component("YGL187C",242).
component("YDL067C",142).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",487).
component("YLL062C",352).
component("YDR410C",191).
component("YER091C",213).
component("YJR073C",322).
component("YOL096C",445).
component("YLR172C",367).
component("YMR120C",400).
component("YBL013W",97).
component("YJL130C",306).
component("YJL088W",302).
component("YPR074C",493).
component("YBR117C",116).
component("YCL009C",128).
component("YMR062C",397).
component("YNL071W",415).
component("YNR019W",434).
component("YCR048W",137).
component("U48_",72).
component("YFL017C",221).
component("YPL231W",482).
component("YDL052C",141).
component("U8_",89).
component("YPL231W",483).
component("YLR299W",372).
component("YCR005C",134).
component("YML126C",391).
component("YDL182W",158).
component("YDL131W",150).
component("YNL117W",418).
component("YIR031C",296).
component("YOR321W",460).
component("YJR143C",329).
component("YGR199W",261).
component("YDL095W",146).
component("YDL093W",145).
component("YAL023C",93).
component("YPL227C",480).
component("YMR261C",409).
component("YML100W",388).
component("YBR126C",118).
component("YLR209C",369).
component("YDR354W",186).
component("YFR047C",228).
component("YJR133W",327).
component("U22_",58).
component("YDR399W",188).
component("YJL167W",313).
component("YPR069C",492).
component("YDR127W",176).
component("YHR068W",275).
component("YLR303W",373).
component("YML082W",387).
component("YJR130C",326).
component("YDR035W",165).
component("YBR249C",124).
component("YBR256C",125).
component("YHR137W",278).
component("YGL202W",244).
component("YLR027C",353).
component("YKL106W",335).
component("YOL140W",448).
component("YLR438W",383).
component("YKL104C",334).
component("YDR111C",173).
component("U51_",74).
component("YJR148W",330).
component("YHR208W",286).
component("YGL253W",248).
component("YFR053C",229).
component("YMR013C",394).
component("YCR036W",136).
component("YGR194C",260).
component("YCL040W",132).
component("YJR105W",325).
component("U81_",87).
component("YMR208W",404).
component("YPL203W",479).
component("YOR061W",449).
component("YKL166C",339).
component("YJL164C",312).
component("YIL035C",289).
component("YHR205W",285).
component("YHR102W",277).
component("YGL019W",232).
component("YHR025W",270).
component("YNR012W",432).
component("YPR121W",495).
component("YPL258C",485).
component("YOL055C",442).
component("YFR019W",226).
component("YDR208W",182).
component("YDR127W",177).
component("U21_",55).
component("YDR147W",180).
component("YER052C",205).
component("U19_",48).
component("U18_",44).
component("U17_",41).
component("U76_",85).
component("YMR220W",405).
component("YER170W",219).
component("YDR226W",183).
component("YKL067W",333).
component("YOL055C",443).
component("YDR454C",194).
component("YOL061W",444).
component("YKL181W",340).
component("YHL011C",266).
component("YER099C",215).
component("YBL068W",103).
component("YOR143C",453).
component("YNL256W",425).
component("YLR328W",376).
component("YDL103C",148).
component("U94_",91).
component("YJR010W",317).
component("YBR029C",106).
component("YPR190C",500).
component("YPR187W",499).
component("YPR110C",494).
component("YPR010C",489).
component("YOR341W",464).
component("YOR340C",463).
component("YOR224C",458).
component("YOR210W",457).
component("YOR207C",456).
component("YOR151C",454).
component("YOR116C",451).
component("YOL005C",438).
component("YNR003C",431).
component("YNL248C",424).
component("YNL151C",422).
component("YNL113W",417).
component("YKL144C",338).
component("YJR063W",321).
component("YJL148W",309).
component("YJL140W",308).
component("YIL021W",288).
component("YHR143W-A",279).
component("YGL070C",238).
component("YFL036W",223).
component("YDR404C",190).
component("YDR156W",181).
component("YDR045C",167).
component("YDL150W",157).
component("YDL140C",152).
component("YBR154C",120).
component("YPR175W",498).
component("YPL167C",477).
component("YOR330C",462).
component("YOL115W",447).
component("YNL299W",429).
component("YNL262W",426).
component("YNL102W",416).
component("YJR043C",319).
component("YJR006W",315).
component("YJL090C",303).
component("YIL139C",292).
component("YEL055C",201).
component("YDR419W",192).
component("YDR121W",174).
component("YDL102W",147).
component("YCR014C",135).
component("YBR278W",126).
component("YBL035C",99).
component("YKL035W",332).
component("YHL012W",267).
component("YPL148C",475).
component("YDR058C",169).
component("YOL011W",440).
component("YMR008C",393).
component("YMR006C",392).
component("U105_",22).
component("U101_",21).
component("YJL068C",300).
component("YPL072W",472).
component("YOR124C",452).
component("YNL186W",423).
component("YMR304W",411).
component("YMR223W",406).
component("YKR098C",351).
component("YJL197W",314).
component("YIL156W",293).
component("YFR010W",225).
component("YER151C",218).
component("YER144C",217).
component("YER098W",214).
component("YDR069C",170).
component("YDL122W",149).
component("YBR058C",109).
component("YBL067C",102).
component("YJR019C",318).
component("YDR074W",171).
component("YFR025C",227).
component("YPL179W",478).
component("YNR032W",435).
component("YML057W",386).
component("YML016C",384).
component("YLR433C",382).
component("YGR123C",253).
component("YER133W",216).
component("YER089C",211).
component("YDR436W",193).
component("YDR075W",172).
component("YDL188C",159).
component("YDL134C",151).
component("YDL047W",140).
component("YDL006W",139).
component("YBR125C",117).
...
component("U26_",60).
component("U24_",59).
component("YHR044C",272).
component("YHR043C",271).
component("YOR360C",466).
component("YGL248W",247).
component("YGL027C",234).
component("YLR286C",371).
component("YER043C",204).
component("YLR160C",366).
component("YLR158C",365).
component("YLR157C",364).
component("YLR155C",363).
component("YDR321W",185).
component("YGL037C",235).
component("U43_",70).
component("U42_",69).
component("YLR308W",375).
component("YLR307W",374).
component("U53_",75).
component("YLR420W",380).
component("YIR032C",297).
component("YLR028C",354).
component("YHR144C",280).
component("YHR144C",281).
component("YNL141W",419).
component("YBR153W",119).
component("YDL238C",162).
component("YNL141W",420).
component("YBR084W",113).
component("YJL126W",305).
component("U44_",71).
component("YHR201C",284).
component("YBR111C",115).
component("YCL030C",131).
component("YER005W",203).
component("YLR231C",370).
component("U88_",88).
component("YDR538W",199).
component("YLR134W",360).
component("YLR044C",356).
component("YGR087C",250).
component("YDR380W",187).
component("YDL080C",143).
component("YMR250W",407).
component("YKL184W",342).
component("YEL021W",200).
component("YKL211C",345).
component("YKR097W",350).
component("YNR033W",436).
component("YKL211C",346).
component("YER090W",212).
component("YDR127W",178).
component("YPL281C",488).
component("YOR393W",469).
component("YMR323W",412).
component("YHR174W",282).
component("YGR254W",262).
component("YGL026C",233).
component("YGR155W",255).
component("YNL316C",430).
component("YCR053W",138).
component("YDR127W",179).
component("YGL148W",240).
component("YIL168W",295).
component("YIL167W",294).
component("YCL064C",133).
component("YFR055W",230).
component("YJL121C",304).
component("YBR019C",105).
component("YDR007W",163).
component("YOR095C",450).
component("YBR196C",122).
component("YPL117C",474).
component("U14_",32).
component("YMR105C",399).
component("YKL127W",336).
component("YEL058W",202).
component("YPR060C",491).
component("YHR072W",276).
component("YJL153C",310).
component("YGR264C",265).
component("YGR171C",256).
component("YHR011W",268).
component("YDR023W",164).
component("YGL245W",246).
component("YOR168W",455).
component("YPR047W",490).
component("YLR060W",358).
component("YFL022C",222).
component("YHR019C",269).
component("YKL194C",344).
component("YIL078W",290).
component("YPL160W",476).
component("YLR382C",378).
component("YPL040C",471).
component("YBL076C",104).
component("YDR037W",166).
component("YGR094W",251).
component("YGL234W",245).
component("YER183C",220).
component("U90_",90).
component("YNR057C",437).
component("YDL141W",153).
component("YDL141W",154).
component("YDL141W",155).
component("YDL141W",156).
component("YPR145W",497).
component("YGR124W",254).
component("YGL062W",237).
component("YBR218C",123).
component("YPL231W",484).
component("YNR016C",433).
component("YKL182W",341).
component("YGR037C",249).
component("YJL087C",301).
component("YOL010W",439).
component("YPR138C",496).
component("YPL265W",486).
component("YOR348C",465).
component("YOL103W",446).
component("YOL020W",441).
component("YNL142W",421).
component("YMR272C",410).
component("YMR202W",403).
component("YMR056C",396).
component("YML123C",390).
component("YLR348C",377).
component("YLR138W",361).
component("YLR100C",359).
component("YKR053C",349).
component("YKR039W",348).
component("YKL217W",347).
component("YJR077C",323).
component("YJL134W",307).
component("YGR191W",258).
component("YGR121C",252).
...
component("YDR046C",168).
component("YDL210W",160).
component("YCL025C",130).
component("YBR291C",127).
component("YBR085W",114).
component("YBR069C",111).
component("YBR068C",110).
