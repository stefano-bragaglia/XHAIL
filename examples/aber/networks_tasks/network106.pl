...
component("YNL280C",602).
component("YLR056W",503).
component("YKR009C",488).
component("YMR083W",559).
component("YPL231W",680).
component("YJR159W",462).
component("YGL001C",319).
component("YHR063C",385).
component("YML056C",544).
component("YLR432W",538).
component("YHR216W",402).
component("YAR075W",137).
component("YAR073W",136).
component("YCL030C",185).
component("YDR127W",240).
component("YJR139C",458).
component("YOR136W",639).
component("YNL009W",581).
component("YLR174W",516).
component("YDL066W",202).
component("YHR183W",397).
component("YGR256W",368).
component("YNL241C",596).
component("YOL059W",625).
component("YDL022W",197).
component("YCL018W",183).
component("YLR355C",532).
component("YML054C",543).
component("YIL155C",411).
component("YEL024W",276).
component("YJR078W",453).
component("U58_",108).
component("YGR255C",367).
component("U108_",26).
component("YMR015C",556).
component("YDR402C",259).
component("YGL055W",326).
component("YJL026W",421).
component("YIL066C",407).
component("YGR180C",357).
component("YER070W",292).
component("U36_",94).
component("U35_",93).
component("YJR009C",444).
component("YJL052W",422).
component("YGR192C",359).
component("YOR374W",661).
component("YER073W",293).
component("U68_",114).
...
component("YKL150W",474).
component("YIL043C",405).
component("YHR042W",380).
component("YOR221C",647).
component("YMR145C",564).
component("YML120C",549).
component("YKL192C",481).
component("YKL055C",465).
component("YER061C",287).
component("YDL085W",205).
component("YBR046C",156).
component("YMR145C",565).
component("YML120C",550).
component("YKL192C",482).
component("YDL085W",206).
component("YPL017C",665).
component("YFL018C",308).
component("YPL091W",669).
component("YER042W",281).
component("YNL052W",583).
component("YMR256C",575).
component("YLR395C",536).
component("YLR038C",501).
component("YIL111W",409).
component("YHR051W",384).
component("YGL191W",336).
component("YGL187C",335).
component("YDL067C",203).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",686).
component("YBR034C",153).
component("YPL273W",688).
component("YLL062C",498).
component("YDR410C",261).
component("YKR069W",493).
component("YER091C",297).
component("YJR073C",451).
component("YDL033C",198).
component("YOL096C",628).
component("YLR172C",515).
component("YMR120C",563).
component("YBL013W",138).
component("YJL130C",430).
component("YJL088W",425).
component("YPR074C",699).
component("YBR117C",164).
component("YMR108W",561).
component("YCL009C",182).
component("YMR062C",558).
component("YNL071W",584).
component("YIL160C",414).
component("YNR019W",612).
component("YCR048W",194).
component("U48_",101).
component("YNL277W",601).
component("YFL017C",307).
component("YPL231W",681).
component("YER061C",288).
component("U86_",127).
component("YDL052C",200).
component("U8_",130).
component("YDR148C",246).
component("YOR377W",663).
component("YGR177C",356).
component("YPL231W",682).
component("YLR195C",518).
component("YLR299W",524).
component("YPR001W",690).
component("YNR001C",608).
component("YCR005C",190).
component("YML126C",552).
component("YDL182W",220).
component("YDL131W",212).
component("YNL117W",588).
component("YIR031C",419).
component("YPR160W",705).
component("YOR321W",653).
component("YJR143C",459).
component("YGR199W",361).
component("YDL095W",208).
component("YDL093W",207).
component("YAL023C",134).
component("YPL227C",678).
component("YMR261C",576).
component("YML100W",548).
component("YBR126C",167).
component("YNL192W",595).
component("YBR038W",155).
component("YBR023C",151).
component("YEL011W",274).
component("YLR209C",519).
component("U104_",24).
component("U103_",23).
component("YOR209C",645).
component("YMR300C",578).
component("YDR354W",255).
component("YFR047C",316).
component("YJR133W",457).
component("U22_",83).
component("YLR209C",520).
component("YDR399W",257).
component("YJL167W",437).
component("YNL256W",598).
component("YPR069C",698).
component("YDR127W",241).
component("YHR190W",398).
component("YHR068W",387).
component("YLR303W",525).
component("YML082W",547).
component("YJR130C",456).
component("YDR035W",229).
component("YBR249C",175).
component("YLR180W",517).
component("YDR502C",267).
component("YOL143C",632).
component("YBR256C",177).
component("YHR137W",392).
component("YGL202W",337).
component("YLR027C",499).
component("YKL106W",468).
component("YOL140W",631).
component("YLR438W",540).
component("YKL104C",467).
component("YGR019W",344).
component("YDR111C",238).
component("U64_",111).
component("U51_",104).
component("YJR148W",460).
component("YHR208W",401).
component("YOR184W",643).
component("YNR058W",617).
component("YGL253W",343).
component("YFR053C",317).
component("YMR013C",555).
component("YMR205C",569).
component("YGR240C",365).
component("YLR240W",522).
component("YKL203C",484).
component("YJR066W",450).
component("YCR036W",193).
component("YGR194C",360).
component("YCL040W",187).
component("YJR105W",455).
component("U16_",55).
component("YKL001C",463).
component("YML070W",546).
component("YFL053W",311).
...
component("YKL166C",476).
component("YJL164C",436).
component("YIL035C",404).
component("YHR205W",400).
component("YHR102W",390).
component("YGL019W",322).
component("YHR025W",379).
component("YNR012W",610).
component("YPR121W",702).
component("YPL258C",684).
component("YOL055C",623).
component("U1_",72).
component("YDR009W",227).
component("YBR020W",150).
component("YFR019W",314).
component("YDR208W",248).
component("YDR127W",242).
component("U21_",80).
component("YDR147W",245).
component("YDR300C",253).
component("YCR012W",191).
component("YER052C",283).
component("U19_",71).
component("U18_",65).
component("U17_",60).
component("U76_",121).
component("YMR220W",572).
component("YER170W",303).
component("YDR226W",249).
component("YKL067W",466).
component("YOL055C",624).
component("YDR454C",264).
component("YOL061W",626).
component("YKL181W",477).
component("YHL011C",373).
component("YER099C",299).
component("YBL068W",144).
component("YOR143C",640).
component("YNL256W",599).
component("YLR328W",529).
component("YBR018C",148).
component("YDL055C",201).
component("YLR328W",530).
component("YDL103C",210).
component("U94_",132).
component("YJR010W",445).
component("YBR029C",152).
component("YGL130W",331).
component("YDR530C",270).
component("YPR190C",708).
component("YPR187W",707).
component("YPR110C",701).
component("YPR010C",692).
component("YOR341W",658).
component("YOR340C",657).
component("YOR224C",648).
component("YOR210W",646).
component("YOR207C",644).
component("YOR151C",641).
component("YOR116C",636).
component("YOL005C",618).
component("YNR003C",609).
component("YNL248C",597).
component("YNL151C",593).
component("YNL113W",587).
component("YKL144C",473).
component("YJR063W",449).
component("YJL148W",433).
component("YJL140W",432).
component("YIL021W",403).
component("YHR143W-A",393).
component("YGL070C",329).
component("YFL036W",310).
component("YDR404C",260).
component("YDR156W",247).
component("YDR045C",232).
component("YDL150W",219).
component("YDL140C",214).
component("YBR154C",169).
component("YPR175W",706).
component("YPL167C",674).
component("YOR330C",655).
component("YOL115W",630).
component("YNL299W",605).
component("YNL262W",600).
component("YNL102W",586).
component("YJR043C",447).
component("YJR006W",443).
component("YJL090C",426).
component("YIL139C",410).
component("YEL055C",277).
component("YDR419W",262).
component("YDR121W",239).
component("YDL102W",209).
component("YCR014C",192).
component("YBR278W",178).
component("YBL035C",140).
component("YKL035W",464).
component("YHL012W",374).
component("YHR123W",391).
component("YNL130C",589).
component("YPL148C",672).
component("YOR251C",651).
component("YGR286C",370).
component("YDR058C",234).
component("YOL011W",620).
component("YMR008C",554).
component("YMR006C",553).
component("U105_",25).
component("U101_",21).
component("YJL068C",423).
component("YPL072W",668).
component("YOR124C",637).
component("YNL186W",594).
component("YMR304W",579).
component("YMR223W",573).
component("YKR098C",496).
component("YJL197W",438).
component("YIL156W",412).
component("YFR010W",313).
component("YER151C",302).
component("YER144C",301).
component("YER098W",298).
component("YDR069C",235).
component("YDL122W",211).
component("YBR058C",157).
component("YBL067C",143).
component("YJR019C",446).
component("YDR481C",265).
component("YLR377C",534).
component("YDR074W",236).
component("YFR025C",315).
component("YPL179W",675).
component("YNR032W",613).
component("YML057W",545).
component("YML016C",541).
component("YLR433C",539).
component("YGR123C",351).
component("YER133W",300).
component("YER089C",295).
component("YDR436W",263).
component("YDR075W",237).
component("YDL188C",221).
component("YDL134C",213).
component("YDL047W",199).
component("YDL006W",196).
component("YBR125C",166).
component("YBL056W",142).
component("YIL053W",406).
component("YER062C",289).
component("YHR046C",383).
component("U9_",133).
component("YGR208W",364).
component("YPL228W",679).
component("YMR180C",566).
component("YJL155C",435).
component("U34_",92).
component("U33_",91).
component("U32_",90).
component("U30_",89).
...
component("YOL064C",627).
component("YPL268W",687).
component("YOR360C",660).
component("YGL248W",342).
component("YKR031C",490).
component("YGL027C",324).
component("YLR286C",523).
component("YJR153W",461).
component("YJL221C",442).
component("YJL216C",440).
component("YIL172C",418).
component("YGR292W",372).
component("YGR287C",371).
component("YBR299W",181).
component("YBR184W",171).
component("YIL162W",415).
component("YPR026W",693).
component("YDR001C",225).
component("YBR001C",147).
component("YDR400W",258).
component("U102_",22).
component("YER043C",282).
component("YNL045W",582).
component("YLR160C",514).
component("YLR158C",513).
component("YLR157C",512).
component("YLR155C",511).
component("YDR321W",254).
component("YGL037C",325).
component("U43_",99).
component("U42_",98).
component("YLR308W",528).
component("YLR307W",527).
component("U53_",105).
component("YLR420W",537).
component("YPL111W",670).
component("YIR032C",420).
component("YLR028C",500).
component("YHR144C",394).
component("YHR144C",395).
component("YNL141W",590).
component("YBR153W",168).
component("YDL238C",224).
component("YNL141W",591).
component("YML035C",542).
component("YBR084W",161).
component("YJL126W",428).
component("U44_",100).
component("U39_",95).
component("YHR201C",399).
...
component("U88_",128).
component("YDR538W",273).
component("YLR134W",508).
component("YLR044C",502).
component("YGR087C",348).
component("YDR380W",256).
component("YDL080C",204).
component("YMR250W",574).
component("YKL184W",480).
component("YEL021W",275).
component("YNR043W",615).
component("YKL211C",485).
component("YKR097W",495).
component("YOL052C",622).
component("YDR294C",250).
component("YNR033W",614).
component("YPR006C",691).
component("YER065C",290).
component("YKL211C",486).
component("YER090W",296).
component("YDR127W",243).
component("YPL281C",689).
component("YOR393W",664).
component("YMR323W",580).
component("YHR174W",396).
component("YGR254W",366).
component("YGL026C",323).
component("YGR155W",354).
component("YLR304C",526).
component("YJL200C",439).
component("YNL316C",606).
component("YPL212C",677).
...
component("YIL168W",417).
component("YIL167W",416).
component("YCL064C",188).
component("YCL064C",189).
component("YLR359W",533).
component("YFR055W",318).
component("YJL121C",427).
component("YBR019C",149).
component("YDR007W",226).
component("YOR095C",635).
component("YBR196C",172).
component("YGL001C",320).
component("YPL117C",671).
component("U14_",46).
component("YKL152C",475).
component("YMR105C",560).
component("YKL127W",470).
component("YEL058W",278).
component("YPR060C",697).
component("YHR072W",388).
component("YJL153C",434).
component("YGR264C",369).
component("YGR171C",355).
component("YHR011W",376).
component("YDR023W",228).
component("YPR081C",700).
component("YBR121C",165).
component("YHR020W",378).
component("YER087W",294).
component("YGL245W",341).
component("YOR168W",642).
component("YPR047W",696).
component("YLR060W",504).
component("YFL022C",309).
component("YPR033C",694).
component("YHR019C",377).
component("YKL194C",483).
component("YIL078W",408).
component("YPL160W",673).
component("YLR382C",535).
component("YPL040C",667).
component("YBL076C",145).
component("YNL073W",585).
component("YDR037W",230).
component("YOR335C",656).
component("YGR094W",349).
component("YPR035W",695).
component("U89_",129).
component("YOR241W",650).
component("YMR113W",562).
component("YKL132C",471).
component("YGL234W",339).
component("YER183C",304).
component("U90_",131).
component("YNR057C",616).
component("YDL141W",215).
component("YDL141W",216).
component("YGL234W",340).
component("YDL141W",217).
component("YGR204W",363).
component("YDL141W",218).
component("YHR074W",389).
component("YMR217W",571).
component("YPR145W",704).
component("YGR124W",352).
component("YOR303W",652).
component("YGL062W",327).
component("YBR218C",173).
component("YPL231W",683).
component("YNR016C",611).
component("YKL182W",479).
component("YGR037C",345).
component("YJL087C",424).
component("YOL010W",619).
component("YPR138C",703).
component("YPL265W",685).
component("YOR348C",659).
component("YOR130C",638).
component("YOL156W",633).
component("YOL103W",629).
component("YOL020W",621).
component("YNL318C",607).
component("YNL142W",592).
component("YMR272C",577).
component("YMR202W",568).
component("YMR056C",557).
component("YML123C",551).
component("YLR348C",531).
component("YLR138W",509).
component("YLR100C",507).
component("YLR092W",506).
component("YLR081W",505).
component("YLL061W",497).
component("YKR053C",492).
component("YKR039W",491).
component("YKL217W",487).
component("YKL120W",469).
component("YJR095W",454).
component("YJR077C",452).
component("YJL219W",441).
component("YJL134W",431).
component("YJL129C",429).
component("YHL036W",375).
component("YGR191W",358).
component("YGR125W",353).
...
component("YER060W-A",286).
component("YER060W",285).
component("YER056C",284).
component("YDR536W",272).
component("YDR508C",269).
component("YDR503C",268).
component("YDR497C",266).
component("YDR297W",252).
component("YDR294C",251).
component("YDR046C",233).
component("YDL210W",222).
component("YCL025C",184).
component("YBR294W",180).
component("YBR291C",179).
component("YBR085W",162).
component("YBR069C",159).
component("YBR068C",158).
component("YBL042C",141).
component("YBL030C",139).
component("U85_",126).
component("U7_",123).
component("U79_",122).
component("U75_",120).
