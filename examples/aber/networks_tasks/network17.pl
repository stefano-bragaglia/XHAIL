...
component("YNL280C",156).
component("YLR056W",136).
component("YGL001C",95).
component("YDR127W",70).
component("YNL009W",150).
component("YLR174W",138).
component("YHR183W",115).
component("YGR256W",106).
component("YCL018W",52).
component("YJR078W",123).
component("YGL055W",98).
component("YOR323C",168).
component("YBR166C",48).
component("YNL280C",157).
component("YKL141W",128).
component("YOR375C",170).
component("YAL062W",38).
component("U100_",18).
component("YMR145C",145).
component("YDL085W",60).
component("YBR046C",42).
component("YDR410C",79).
component("YPR074C",180).
component("YBR117C",46).
component("YNL071W",151).
component("YNR019W",160).
component("YCR048W",57).
component("U48_",32).
component("YPL231W",173).
component("YPL231W",174).
component("YLR299W",140).
component("YCR005C",54).
component("YOR321W",167).
component("YJR143C",126).
component("YGR199W",104).
component("YDL095W",62).
component("YDL093W",61).
component("YAL023C",37).
component("YDR354W",77).
component("YFR047C",93).
component("U22_",29).
component("YPR069C",179).
component("YDR127W",71).
component("YML082W",143).
component("YJR130C",125).
component("YDR035W",67).
component("YBR249C",50).
component("YHR137W",112).
component("YGL202W",100).
component("YLR027C",135).
component("YKL106W",127).
component("YLR438W",142).
component("U51_",33).
component("YMR013C",144).
component("YCR036W",56).
component("YJR105W",124).
component("YMR208W",147).
component("YHR025W",109).
component("YFR019W",92).
component("YDR208W",75).
component("YDR127W",72).
component("YER052C",86).
component("U19_",26).
component("YDR226W",76).
component("YDR454C",81).
component("YOL061W",164).
component("YKL181W",129).
component("YHL011C",108).
component("YER099C",88).
component("YBL068W",41).
component("YLR328W",141).
component("YPR175W",182).
component("YPL167C",172).
component("YOR330C",169).
component("YOL115W",165).
component("YNL299W",158).
component("YNL262W",155).
component("YNL102W",152).
component("YJR043C",121).
component("YJR006W",120).
component("YJL090C",118).
component("YIL139C",116).
component("YEL055C",84).
component("YDR419W",80).
component("YDR121W",69).
component("YDL102W",63).
component("YCR014C",55).
component("YBR278W",51).
component("YBL035C",39).
component("U32_",31).
component("U30_",30).
component("YHR044C",111).
component("YHR043C",110).
component("YGL037C",97).
component("U53_",34).
component("YHR144C",113).
component("YBR153W",47).
component("YNL141W",153).
component("YBR111C",45).
component("YER005W",85).
component("YLR231C",139).
component("YDR380W",78).
component("YDL080C",59).
component("YMR250W",148).
component("YKL184W",130).
component("YKL211C",131).
component("YNR033W",161).
component("YKL211C",132).
component("YER090W",87).
component("YDR127W",73).
component("YPL281C",176).
component("YOR393W",171).
component("YMR323W",149).
component("YHR174W",114).
component("YGR254W",105).
component("YGL026C",96).
component("YNL316C",159).
component("YCR053W",58).
component("YDR127W",74).
component("YGL148W",99).
component("YFR055W",94).
component("YDR007W",66).
component("YOR095C",166).
component("YBR196C",49).
component("YPR060C",178).
component("YGR264C",107).
component("YGR171C",103).
component("YGL245W",101).
component("YPR047W",177).
component("YLR060W",137).
component("YFL022C",90).
component("YER183C",89).
component("YDL141W",64).
component("YDL141W",65).
component("YJL087C",117).
component("YOL010W",162).
component("YPR138C",181).
component("YPL265W",175).
component("YOL020W",163).
component("YNL142W",154).
component("YMR202W",146).
component("YKR053C",134).
component("YKR039W",133).
component("YJR077C",122).
component("YJL134W",119).
component("YGR121C",102).
component("YFL055W",91).
component("YDR536W",83).
component("YDR508C",82).
component("YDR046C",68).
component("YCL025C",53).
component("YBR069C",44).
component("YBR068C",43).
component("YBL042C",40).
component("U6_",36).
component("U5_",35).
component("U228_",28).
component("U222_",27).
