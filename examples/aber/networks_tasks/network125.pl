...
component("YOR136W",714).
component("YNL009W",649).
component("YLR174W",580).
component("YDL066W",235).
component("YHR183W",449).
component("YGR256W",418).
component("YNL241C",664).
component("YOL059W",695).
component("YDL022W",229).
component("YCL018W",214).
component("YLR355C",599).
component("YIL074C",461).
component("YER081W",339).
component("YML054C",611).
component("YIL155C",466).
component("YEL024W",318).
component("YKR066C",554).
component("YJR078W",511).
component("U58_",129).
component("U107_",26).
component("YGR255C",417).
component("U108_",27).
component("YMR015C",624).
component("YDR402C",300).
component("YGL055W",373).
component("YJL026W",476).
component("YIL066C",460).
...
component("U68_",135).
component("YGL154C",380).
component("U55_",126).
component("YER069W",336).
component("YOR323C",731).
component("U2_",104).
...
component("YMR189W",635).
component("U56_",127).
component("YKR080W",556).
component("YPL023C",744).
component("YGL125W",377).
component("YOR236W",726).
component("YGR204W",412).
component("YBR084W",186).
component("YLR142W",574).
component("U65_",133).
component("U62_",131).
...
component("YMR145C",633).
component("YML120C",618).
component("YKL192C",542).
component("YDL085W",239).
component("YPL017C",743).
component("YFL018C",354).
component("YPL091W",747).
component("YER042W",326).
component("YPR167C",789).
component("YNL052W",651).
component("YMR256C",643).
component("YLR395C",603).
component("YLR038C",565).
component("YIL111W",463).
component("YHR051W",436).
component("YGL191W",383).
component("YGL187C",382).
component("YDL067C",236).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",768).
component("YBR034C",179).
component("YPL273W",770).
component("YLL062C",562).
component("YDR410C",303).
component("YKR069W",555).
component("YOL096C",698).
component("U47_",120).
component("YER091C",343).
component("YJR073C",509).
component("YML008C",608).
component("YDL033C",231).
component("YOL096C",699).
component("YLR172C",579).
component("YDR408C",302).
component("YMR120C",631).
component("YBL013W",162).
component("YJL130C",485).
component("YJL088W",480).
component("YPR074C",782).
component("YBR117C",192).
component("YLR354C",598).
component("YGR043C",394).
component("YMR108W",629).
component("YCL009C",213).
component("YMR062C",626).
component("YNL071W",652).
component("YIL160C",469).
component("YNR019W",680).
...
component("U86_",150).
component("YPL001W",742).
component("YDL052C",233).
component("U8_",153).
component("YDR148C",284).
component("YOR377W",740).
component("YGR177C",405).
component("YPL231W",763).
component("YLR195C",582).
component("YLR299W",590).
component("YPR001W",772).
component("YNR001C",676).
component("YCR005C",222).
component("YML126C",620).
component("YDL182W",256).
component("YDL131W",246).
component("YNL117W",656).
component("YIR031C",474).
component("YPR160W",788).
component("YOR321W",730).
component("YJR143C",518).
component("YGR199W",410).
component("YDL095W",241).
component("YDL093W",240).
component("YAL023C",158).
component("YPL227C",759).
component("YMR261C",644).
component("YML100W",616).
component("YBR126C",195).
component("YNL192W",663).
...
component("U104_",24).
component("U103_",23).
component("YOR209C",722).
component("YMR300C",646).
component("YDR354W",296).
component("YFR047C",362).
...
component("YHR068W",439).
component("YLR303W",591).
component("YGR012W",391).
...
component("YOL143C",704).
component("YBR256C",207).
component("YHR137W",444).
component("YGL202W",384).
component("YLR027C",563).
component("YKL106W",527).
component("YOL140W",703).
component("YLR438W",607).
component("YKL104C",526).
component("YGR019W",392).
component("YDR111C",276).
component("U64_",132).
component("U51_",124).
component("YJR148W",519).
component("YHR208W",453).
component("YOR184W",719).
component("YNR058W",685).
component("YGL253W",390).
component("YFR053C",363).
component("YMR013C",623).
component("YMR205C",637).
component("YGR240C",415).
component("YLR240W",587).
component("YKL203C",544).
component("YJR066W",508).
component("YCR036W",225).
component("YGR194C",409).
component("YCL040W",219).
component("YJR105W",513).
component("U16_",67).
component("YPL188W",755).
component("YJR049C",505).
component("YEL041W",319).
component("YKL001C",522).
component("YDR236C",289).
component("YML070W",614).
component("YFL053W",357).
component("YDR531W",313).
component("U82_",147).
component("U81_",146).
component("YMR208W",638).
component("YPL203W",756).
component("YOR061W",708).
component("YKL166C",535).
component("YJL164C",492).
component("YIL035C",457).
component("YHR205W",452).
component("YHR102W",442).
component("YGL019W",369).
component("YHR025W",431).
component("YNR012W",678).
component("YPR121W",785).
component("YPL258C",765).
component("YOL055C",692).
component("YPL214C",758).
component("U1_",84).
component("YDR009W",264).
component("YBR020W",176).
component("YFR019W",360).
...
component("YPR175W",790).
component("YPL167C",753).
component("YOR330C",732).
component("YOL115W",702).
component("YNL299W",673).
component("YNL262W",668).
component("YNL102W",654).
component("YJR043C",504).
component("YJR006W",500).
component("YJL090C",481).
...
component("YHL012W",424).
component("YHR123W",443).
component("YNL130C",657).
component("YPL148C",751).
component("YOR251C",728).
component("YGR286C",420).
component("YDR058C",272).
component("YOL011W",688).
component("YMR008C",622).
component("YMR006C",621).
component("U105_",25).
component("U101_",21).
component("YJL068C",478).
component("YPL072W",746).
component("YOR124C",712).
component("YNL186W",662).
component("YMR304W",647).
component("YMR223W",641).
component("YKR098C",559).
component("YJL197W",495).
component("YIL156W",467).
...
component("YJR019C",503).
component("U84_",148).
component("YDR481C",307).
component("YLR377C",601).
component("YDR074W",274).
component("YFR025C",361).
component("YPL179W",754).
component("YNR032W",681).
component("YML057W",613).
component("YML016C",609).
...
component("YIL053W",459).
component("YER062C",334).
component("YHR046C",435).
component("U9_",157).
component("YGR208W",414).
component("YPL228W",760).
component("YMR180C",634).
component("YDL236W",260).
component("YJL155C",491).
component("U34_",108).
component("U33_",107).
component("U32_",106).
component("U30_",105).
...
component("U26_",100).
component("U24_",99).
component("YHR044C",434).
component("YHR043C",433).
component("YOL064C",697).
component("YPL268W",769).
component("YOR360C",737).
component("YGL248W",389).
component("YKR031C",551).
component("YGL027C",371).
component("YLR286C",589).
component("YJR153W",520).
component("YJL221C",499).
component("YJL216C",497).
component("YIL172C",473).
component("YGR292W",422).
component("YGR287C",421).
component("YBR299W",212).
component("YBR184W",201).
component("YIL162W",470).
component("YPR026W",775).
component("YDR001C",262).
component("YBR001C",171).
component("YDR400W",299).
component("U102_",22).
component("YER043C",327).
component("YNL045W",650).
component("YLR160C",578).
component("YLR158C",577).
component("YLR157C",576).
component("YLR155C",575).
component("YDR321W",295).
component("YGL037C",372).
component("U43_",117).
component("U42_",116).
component("YLR308W",594).
component("YLR307W",593).
component("U53_",125).
component("YLR420W",604).
component("YPL111W",749).
component("YIR032C",475).
...
component("YPL117C",750).
component("U14_",55).
component("YKL152C",534).
component("YMR105C",628).
component("YKL127W",529).
component("YEL058W",323).
component("YPR060C",779).
component("YHR072W",440).
component("YJL153C",490).
component("YGR264C",419).
component("YGR171C",404).
component("YHR011W",426).
component("YDR023W",265).
component("YPL104W",748).
component("YLL018C",560).
component("YPR081C",783).
component("YBR121C",193).
component("YHR020W",430).
component("YER087W",340).
component("YOL033W",690).
component("YGL245W",388).
component("YOR168W",717).
component("YOL097C",700).
component("YDR268W",290).
component("YPR047W",778).
component("YLR060W",568).
component("YFL022C",355).
component("YPR033C",776).
component("YHR019C",428).
component("YHR019C",429).
component("YKL194C",543).
component("YIL078W",462).
component("YPL160W",752).
component("YLR382C",602).
component("YPL040C",745).
component("YBL076C",169).
component("YNL073W",653).
component("YDR037W",267).
component("YOR335C",733).
component("YGR094W",398).
component("YPR035W",777).
component("YIL145C",465).
component("U89_",152).
component("YOR241W",727).
component("YMR113W",630).
component("YKL132C",530).
component("YGL234W",386).
component("YER183C",350).
component("U90_",154).
component("YNR057C",684).
component("YDL141W",249).
component("YDL141W",250).
component("YGL234W",387).
component("YDL141W",251).
component("YGR204W",413).
component("YOL058W",694).
component("YDL141W",252).
component("YHR074W",441).
component("YMR217W",639).
component("YPR145W",787).
component("YGR124W",401).
component("YOR303W",729).
component("YJR109C",514).
component("YJL130C",486).
component("YGL062W",374).
component("YBR218C",203).
component("YPL231W",764).
component("YNR016C",679).
component("YKL182W",539).
component("YGR037C",393).
component("YOR005C",706).
component("YDL164C",254).
component("YJL087C",479).
component("YOL010W",687).
component("YPR138C",786).
component("YPL265W",767).
component("YOR348C",736).
component("YOR192C",720).
component("YOR171C",718).
component("YOR130C",713).
component("YOR071C",709).
component("YOR011W",707).
component("YOL156W",705).
component("YOL103W",701).
component("YOL020W",689).
component("YNL318C",675).
component("YNL142W",660).
component("YMR272C",645).
component("YMR202W",636).
component("YMR056C",625).
component("YML123C",619).
component("YLR348C",597).
component("YLR260W",588).
component("YLR237W",586).
component("YLR138W",573).
component("YLR100C",571).
component("YLR092W",570).
component("YLR081W",569).
component("YLL061W",561).
component("YKR093W",557).
component("YKR053C",553).
component("YKR039W",552).
component("YKL217W",548).
component("YKL120W",528).
component("YJR095W",512).
component("YJR077C",510).
component("YJL219W",498).
component("YJL134W",487).
component("YJL129C",484).
component("YHL036W",425).
component("YGR191W",407).
component("YGR125W",402).
component("YGR121C",399).
component("YGR065C",396).
component("YGR055W",395).
component("YGL186C",381).
