...
component("YNL280C",577).
component("YLR056W",484).
component("YKR009C",471).
component("YMR083W",536).
component("YPL231W",653).
component("YJR159W",448).
component("YGL001C",309).
component("YHR063C",373).
component("YML056C",522).
component("YLR432W",517).
component("YHR216W",389).
component("YAR075W",133).
component("YAR073W",132).
component("YCL030C",180).
component("YDR127W",233).
component("YJR139C",444).
component("YOR136W",612).
component("YNL009W",556).
component("YLR174W",496).
component("YDL066W",197).
component("YHR183W",384).
component("YGR256W",356).
component("YNL241C",571).
component("YOL059W",599).
component("YDL022W",192).
component("YCL018W",178).
component("YLR355C",512).
component("YML054C",521).
component("YIL155C",398).
component("YEL024W",267).
component("YJR078W",439).
component("U58_",106).
component("YGR255C",355).
component("U108_",26).
component("YMR015C",533).
component("YDR402C",250).
component("YGL055W",316).
component("YJL026W",408).
component("YIL066C",394).
component("YGR180C",346).
component("YER070W",283).
component("U36_",93).
component("U35_",92).
component("YJR009C",430).
component("YJL052W",409).
component("YGR192C",348).
component("YOR374W",634).
...
component("YKL182W",462).
component("YER014W",271).
component("YKR009C",472).
component("YIL160C",400).
component("YGL205W",327).
component("YKL141W",457).
component("YJR051W",434).
component("YOR375C",635).
component("YDL215C",217).
component("YAL062W",131).
component("U100_",20).
component("YBR035C",149).
component("YMR189W",543).
component("U56_",105).
component("YPL023C",639).
component("YGL125W",320).
component("YOR236W",622).
component("YGR204W",351).
component("YBR084W",155).
component("YLR142W",490).
component("U65_",109).
component("U62_",108).
component("YHR068W",374).
component("YKL150W",459).
component("YIL043C",392).
component("YHR042W",368).
component("YOR221C",620).
component("YMR145C",541).
component("YML120C",527).
component("YKL192C",465).
component("YKL055C",451).
component("YER061C",278).
component("YDL085W",200).
component("YBR046C",151).
component("YPL017C",638).
component("YFL018C",298).
component("YPL091W",642).
component("YER042W",272).
component("YNL052W",558).
component("YMR256C",550).
component("YLR395C",515).
component("YLR038C",482).
component("YIL111W",396).
component("YHR051W",372).
component("YGL191W",325).
component("YGL187C",324).
component("YDL067C",198).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",659).
component("YPL273W",661).
component("YLL062C",479).
component("YDR410C",252).
component("YER091C",288).
component("YJR073C",437).
component("YDL033C",193).
component("YOL096C",602).
component("YLR172C",495).
component("YMR120C",540).
component("YBL013W",134).
component("YJL130C",417).
component("YJL088W",412).
component("YPR074C",672).
component("YBR117C",159).
component("YMR108W",538).
component("YCL009C",177).
component("YMR062C",535).
component("YNL071W",559).
component("YIL160C",401).
component("YNR019W",586).
component("YCR048W",189).
component("U48_",99).
component("YNL277W",576).
component("YFL017C",297).
component("YPL231W",654).
component("YER061C",279).
component("U86_",123).
component("YDL052C",195).
component("U8_",126).
component("YDR148C",239).
component("YOR377W",636).
component("YGR177C",345).
component("YPL231W",655).
component("YLR195C",498).
component("YLR299W",504).
component("YPR001W",663).
component("YNR001C",582).
component("YCR005C",185).
component("YML126C",529).
component("YDL182W",214).
component("YDL131W",206).
component("YNL117W",563).
component("YIR031C",406).
component("YPR160W",678).
component("YOR321W",626).
component("YJR143C",445).
component("YGR199W",350).
component("YDL095W",202).
component("YDL093W",201).
component("YAL023C",130).
component("YPL227C",651).
component("YMR261C",551).
component("YML100W",526).
component("YBR126C",162).
component("YNL192W",570).
component("YBR038W",150).
component("YBR023C",147).
component("YEL011W",265).
component("YLR209C",499).
component("U104_",24).
component("U103_",23).
component("YOR209C",618).
component("YMR300C",553).
component("YDR354W",246).
...
component("YNL256W",573).
component("YPR069C",671).
component("YDR127W",234).
component("YHR190W",385).
component("YHR068W",375).
component("YLR303W",505).
component("YML082W",525).
component("YJR130C",442).
component("YDR035W",223).
component("YBR249C",170).
component("YLR180W",497).
component("YDR502C",258).
component("YOL143C",606).
component("YBR256C",172).
component("YHR137W",379).
component("YGL202W",326).
component("YLR027C",480).
component("YKL106W",454).
component("YOL140W",605).
component("YLR438W",519).
component("YKL104C",453).
component("YGR019W",333).
component("YDR111C",231).
component("U51_",102).
component("YJR148W",446).
component("YHR208W",388).
component("YOR184W",616).
component("YNR058W",591).
component("YGL253W",332).
component("YFR053C",307).
component("YMR013C",532).
component("YLR240W",502).
component("YKL203C",467).
component("YJR066W",436).
component("YCR036W",188).
component("YGR194C",349).
component("YCL040W",182).
component("YJR105W",441).
component("U16_",54).
component("YKL001C",449).
component("YML070W",524).
component("YFL053W",301).
component("YDR531W",262).
component("U82_",121).
component("U81_",120).
component("YMR208W",545).
component("YPL203W",649).
component("YOR061W",607).
component("YKL166C",460).
component("YJL164C",423).
component("YIL035C",391).
component("YHR205W",387).
component("YHR102W",377).
component("YGL019W",312).
component("YHR025W",367).
component("YNR012W",584).
component("YPR121W",675).
component("YPL258C",657).
component("YOL055C",597).
component("U1_",71).
component("YDR009W",221).
component("YBR020W",146).
component("YFR019W",304).
component("YDR208W",241).
component("YDR127W",235).
component("U21_",79).
component("YDR147W",238).
component("YCR012W",186).
component("YER052C",274).
component("U19_",70).
component("U18_",64).
component("U17_",59).
component("U76_",117).
component("YMR220W",547).
component("YER170W",294).
component("YDR226W",242).
component("YKL067W",452).
component("YOL055C",598).
component("YDR454C",255).
component("YOL061W",600).
component("YKL181W",461).
component("YHL011C",361).
component("YER099C",290).
component("YBL068W",140).
component("YOR143C",613).
component("YNL256W",574).
component("YLR328W",509).
component("YBR018C",144).
component("YDL055C",196).
component("YLR328W",510).
component("YDL103C",204).
component("U94_",128).
component("YJR010W",431).
component("YBR029C",148).
component("YDR530C",261).
...
component("YOR224C",621).
component("YOR210W",619).
component("YOR207C",617).
component("YOR151C",614).
component("YOR116C",609).
component("YOL005C",592).
component("YNR003C",583).
component("YNL248C",572).
component("YNL151C",568).
component("YNL113W",562).
component("YKL144C",458).
component("YJR063W",435).
component("YJL148W",420).
component("YJL140W",419).
component("YIL021W",390).
component("YHR143W-A",380).
component("YGL070C",319).
component("YFL036W",300).
...
component("YPL167C",647).
component("YOR330C",628).
component("YOL115W",604).
component("YNL299W",580).
component("YNL262W",575).
component("YNL102W",561).
component("YJR043C",433).
component("YJR006W",429).
component("YJL090C",413).
component("YIL139C",397).
component("YEL055C",268).
component("YDR419W",253).
component("YDR121W",232).
component("YDL102W",203).
component("YCR014C",187).
component("YBR278W",173).
component("YBL035C",136).
component("YKL035W",450).
component("YHL012W",362).
component("YHR123W",378).
component("YNL130C",564).
component("YPL148C",645).
component("YOR251C",624).
component("YGR286C",358).
component("YDR058C",227).
component("YOL011W",594).
component("YMR008C",531).
component("YMR006C",530).
component("U105_",25).
component("U101_",21).
component("YJL068C",410).
component("YPL072W",641).
component("YOR124C",610).
component("YNL186W",569).
component("YMR304W",554).
component("YMR223W",548).
component("YKR098C",477).
component("YJL197W",425).
component("YIL156W",399).
component("YFR010W",303).
component("YER151C",293).
component("YER144C",292).
component("YER098W",289).
component("YDR069C",228).
component("YDL122W",205).
component("YBR058C",152).
component("YBL067C",139).
component("YJR019C",432).
component("YDR481C",256).
component("YDR074W",229).
component("YFR025C",305).
component("YPL179W",648).
component("YNR032W",587).
component("YML057W",523).
component("YML016C",520).
component("YLR433C",518).
component("YGR123C",340).
component("YER133W",291).
component("YER089C",286).
component("YDR436W",254).
component("YDR075W",230).
component("YDL188C",215).
component("YDL134C",207).
component("YDL047W",194).
component("YDL006W",191).
component("YBR125C",161).
component("YBL056W",138).
component("YIL053W",393).
component("YER062C",280).
component("YHR046C",371).
component("U9_",129).
component("YGR208W",353).
component("YPL228W",652).
component("YMR180C",542).
...
component("U26_",84).
component("U24_",83).
component("YHR044C",370).
component("YHR043C",369).
component("YOL064C",601).
component("YPL268W",660).
component("YOR360C",633).
component("YGL248W",331).
component("YKR031C",473).
component("YGL027C",314).
component("YLR286C",503).
component("YJR153W",447).
component("YJL221C",428).
component("YJL216C",427).
component("YIL172C",405).
component("YGR292W",360).
component("YGR287C",359).
component("YBR299W",176).
component("YBR184W",166).
component("YIL162W",402).
component("YPR026W",666).
component("YDR001C",219).
component("YBR001C",143).
component("YDR400W",249).
component("U102_",22).
component("YER043C",273).
component("YNL045W",557).
component("YLR160C",494).
component("YLR158C",493).
component("YLR157C",492).
component("YLR155C",491).
component("YDR321W",245).
component("YGL037C",315).
component("U43_",97).
component("U42_",96).
component("YLR308W",508).
component("YLR307W",507).
component("U53_",103).
component("YLR420W",516).
component("YPL111W",643).
component("YIR032C",407).
component("YLR028C",481).
component("YHR144C",381).
component("YHR144C",382).
component("YNL141W",565).
component("YBR153W",163).
component("YDL238C",218).
...
component("YBR111C",158).
component("YBR252W",171).
component("YCL030C",181).
component("YER005W",270).
component("YBL099W",142).
component("YLR231C",501).
component("U88_",124).
component("YDR538W",264).
component("YLR134W",488).
component("YLR044C",483).
component("YGR087C",337).
component("YDR380W",247).
component("YDL080C",199).
component("YMR250W",549).
component("YKL184W",464).
component("YEL021W",266).
component("YNR043W",589).
component("YKL211C",468).
component("YKR097W",476).
component("YOL052C",596).
component("YDR294C",243).
component("YNR033W",588).
component("YPR006C",664).
component("YER065C",281).
component("YKL211C",469).
component("YER090W",287).
component("YDR127W",236).
component("YPL281C",662).
component("YOR393W",637).
component("YMR323W",555).
component("YHR174W",383).
component("YGR254W",354).
component("YGL026C",313).
component("YGR155W",343).
component("YLR304C",506).
component("YJL200C",426).
component("YNL316C",581).
component("YPL212C",650).
component("YNL292W",579).
component("YGL063W",318).
component("YFL001W",296).
component("YCR053W",190).
component("YDR127W",237).
component("YGL148W",321).
component("YIL168W",404).
component("YIL167W",403).
component("YCL064C",183).
component("YCL064C",184).
component("YLR359W",513).
component("YFR055W",308).
component("YJL121C",414).
component("YBR019C",145).
component("YDR007W",220).
component("YOR095C",608).
component("YBR196C",167).
component("YGL001C",310).
component("YPL117C",644).
component("U14_",46).
component("YMR105C",537).
component("YKL127W",455).
component("YEL058W",269).
component("YPR060C",670).
component("YHR072W",376).
component("YJL153C",421).
component("YGR264C",357).
component("YGR171C",344).
component("YHR011W",364).
component("YDR023W",222).
component("YPR081C",673).
component("YBR121C",160).
component("YHR020W",366).
component("YER087W",285).
component("YGL245W",330).
component("YOR168W",615).
component("YPR047W",669).
component("YLR060W",485).
component("YFL022C",299).
component("YPR033C",667).
component("YHR019C",365).
component("YKL194C",466).
component("YIL078W",395).
component("YPL160W",646).
component("YLR382C",514).
component("YPL040C",640).
component("YBL076C",141).
component("YNL073W",560).
component("YDR037W",224).
component("YOR335C",629).
component("YGR094W",338).
component("YPR035W",668).
component("U89_",125).
component("YOR241W",623).
component("YMR113W",539).
component("YKL132C",456).
component("YGL234W",328).
component("YER183C",295).
component("U90_",127).
component("YNR057C",590).
component("YDL141W",209).
component("YDL141W",210).
component("YGL234W",329).
component("YDL141W",211).
component("YGR204W",352).
component("YDL141W",212).
component("YMR217W",546).
component("YPR145W",677).
component("YGR124W",341).
component("YOR303W",625).
component("YGL062W",317).
component("YBR218C",168).
component("YPL231W",656).
component("YNR016C",585).
component("YKL182W",463).
component("YGR037C",334).
component("YJL087C",411).
component("YOL010W",593).
component("YPR138C",676).
component("YPL265W",658).
component("YOR348C",632).
component("YOR130C",611).
component("YOL103W",603).
component("YOL020W",595).
component("YNL142W",567).
component("YMR272C",552).
component("YMR202W",544).
component("YMR056C",534).
component("YML123C",528).
component("YLR348C",511).
component("YLR138W",489).
component("YLR100C",487).
component("YLR092W",486).
component("YLL061W",478).
component("YKR053C",475).
component("YKR039W",474).
...
component("YGR191W",347).
component("YGR125W",342).
component("YGR121C",339).
component("YGR065C",336).
component("YGR055W",335).
component("YGL186C",323).
component("YFL055W",302).
component("YER060W-A",277).
component("YER060W",276).
component("YER056C",275).
component("YDR536W",263).
component("YDR508C",260).
component("YDR503C",259).
component("YDR497C",257).
component("YDR294C",244).
component("YDR046C",226).
component("YDL210W",216).
component("YCL025C",179).
component("YBR294W",175).
component("YBR291C",174).
component("YBR085W",157).
component("YBR069C",154).
component("YBR068C",153).
component("YBL042C",137).
component("YBL030C",135).
component("U85_",122).
component("U7_",119).
component("U79_",118).
component("U75_",116).
