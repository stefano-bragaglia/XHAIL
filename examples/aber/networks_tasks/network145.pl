...
component("YJR139C",585).
component("YML075C",693).
component("YLR450W",684).
component("YKL085W",596).
component("YOR136W",803).
component("YNL009W",730).
component("YLR174W",654).
component("YDL066W",264).
component("YHR183W",509).
component("YGR256W",472).
component("YNL241C",746).
component("YOL059W",781).
component("YDL022W",257).
component("YCL018W",237).
component("YLR355C",675).
component("YIL074C",521).
component("YER081W",383).
component("YML054C",689).
component("YIL155C",528).
component("YPR191W",889).
component("YOR065W",795).
component("YJL166W",558).
component("YHR001W-A",481).
component("YGR183C",457).
component("YFR033C",409).
component("YEL024W",359).
component("YDR529C",351).
component("YBL045C",180).
component("Q0105",19).
component("YKR066C",626).
component("YKL026C",592).
component("YIR037W",538).
component("YBR244W",226).
component("YJR078W",577).
component("U58_",140).
component("U107_",28).
...
component("U56_",138).
component("YKR080W",628).
component("YPL023C",836).
...
component("YMR145C",713).
component("YML120C",697).
component("YKL192C",613).
component("YDL085W",268).
component("YFR030W",408).
component("YPL017C",835).
component("YFL018C",399).
component("YPL091W",839).
component("YDR353W",334).
component("YER042W",369).
component("YPR167C",884).
component("YJR137C",584).
component("YNL052W",733).
...
component("YNL071W",734).
component("YIL160C",531).
component("YNR019W",763).
component("YCR048W",252).
component("U48_",132).
component("YNL277W",752).
component("YDR232W",323).
component("YFL017C",398).
component("YPL231W",855).
component("YER061C",377).
component("U86_",162).
component("YPL001W",834).
component("YDL052C",262).
component("U8_",165).
component("YDR148C",318).
component("YOR377W",831).
component("YGR177C",455).
component("YPL231W",856).
component("YLR195C",656).
component("YLR299W",666).
component("YPR001W",867).
component("YNR001C",759).
component("YCR005C",247).
component("YML126C",699).
component("YDL182W",287).
component("YDL131W",277).
component("YNL117W",738).
component("YIR031C",536).
component("YPR160W",883).
component("YOR321W",821).
component("YJR143C",586).
component("YGR199W",461).
component("YDL095W",272).
component("YDL093W",271).
component("YAL023C",172).
component("YLR258W",663).
component("YFR015C",405).
component("YPL227C",852).
component("YOR103C",799).
component("YOR085W",797).
component("YMR149W",714).
component("YML019W",687).
component("YJL002C",539).
...
component("YEL011W",357).
component("YLR209C",657).
component("U104_",26).
component("U103_",25).
component("YOR209C",811).
component("YMR300C",727).
component("YDR354W",335).
component("YFR047C",410).
component("YJR133W",583).
component("U22_",109).
component("YLR209C",658).
component("YDR399W",337).
component("YPR176C",886).
component("YPL172C",846).
component("YNR041C",767).
component("YMR101C",707).
component("YDL090C",270).
component("YBR003W",189).
component("YBR002C",188).
component("YJL167W",559).
...
component("YJR130C",582).
component("YDR035W",299).
component("YBR249C",227).
component("YLR180W",655).
component("YDR502C",348).
component("YOR274W",818).
component("YOL143C",790).
...
component("YLR438W",683).
component("YKL104C",597).
component("YGR019W",441).
component("YDR111C",310).
component("U64_",143).
component("U51_",135).
component("YJR148W",587).
component("YHR208W",513).
component("YOR184W",808).
component("YNR058W",770).
...
component("YNL130C",739).
component("YPL148C",843).
component("YOR251C",817).
component("YGR286C",474).
component("YDR058C",306).
component("YNR034W",766).
component("YHR163W",507).
component("YGR248W",469).
component("YCR073W-A",254).
component("YDL086W",269).
component("YOL011W",773).
component("YMR008C",701).
component("YMR006C",700).
component("U105_",27).
component("U101_",23).
component("YJL068C",542).
component("YPL072W",838).
component("YOR124C",801).
component("YNL186W",744).
component("YMR304W",728).
component("YMR223W",722).
component("YKR098C",631).
component("YJL197W",561).
component("YIL156W",529).
component("YFR010W",404).
component("YER151C",392).
component("YER144C",391).
component("YER098W",388).
component("YDR069C",307).
component("YDL122W",276).
component("YBR058C",202).
component("YBL067C",182).
component("YJR019C",569).
component("YDR272W",327).
component("U84_",160).
component("YDR481C",346).
component("YLR377C",677).
component("YDR074W",308).
component("YFR025C",407).
component("YPL179W",847).
component("YNR032W",764).
component("YML057W",691).
component("YML016C",686).
component("YLR433C",682).
component("YGR123C",449).
component("YER133W",390).
component("YER089C",385).
component("YDR436W",344).
component("YDR075W",309).
component("YDL188C",288).
component("YDL134C",278).
component("YDL047W",261).
...
component("YIL053W",519).
component("YER062C",378).
component("YHR046C",493).
component("U9_",171).
component("YGR208W",466).
component("YPL228W",853).
component("YMR180C",715).
component("YDL236W",292).
component("YJL155C",556).
component("U34_",119).
component("U33_",118).
component("U32_",117).
component("U30_",116).
...
component("YOL064C",783).
component("YPL268W",862).
component("YOR360C",828).
component("YGL248W",437).
component("YKR031C",623).
component("YGL027C",419).
component("YLR286C",665).
component("YJR153W",588).
component("YJL221C",565).
component("YJL216C",563).
...
component("YPR026W",870).
component("YDR001C",294).
component("YBR001C",187).
component("YDR400W",338).
component("U102_",24).
component("YER043C",370).
component("YNL045W",732).
component("YLR160C",652).
component("YLR158C",651).
component("YLR157C",650).
component("YLR155C",649).
component("YDR321W",332).
component("YGL037C",420).
component("U43_",128).
component("U42_",127).
component("YDR242W",325).
component("YLR308W",670).
component("YLR307W",669).
component("U53_",136).
component("YLR420W",680).
component("YPL111W",841).
component("YIR032C",537).
component("YLR028C",637).
component("YHR144C",505).
component("YHR144C",506).
component("YCL030C",240).
component("YNL141W",740).
...
component("YPR081C",878).
component("YBR121C",213).
component("YHR020W",488).
component("YER087W",384).
component("YOL033W",775).
component("YGL245W",436).
component("YOR168W",806).
component("YHR091C",500).
component("YDR341C",333).
component("YOL097C",786).
component("YDR268W",326).
component("YPR047W",873).
component("YLR060W",641).
...
component("YPL160W",844).
component("YLR382C",678).
component("YPL040C",837).
component("YBL076C",184).
component("YNL073W",735).
component("YDR037W",300).
component("YOR335C",824).
component("YGR094W",447).
component("YGR244C",468).
component("YPR035W",872).
component("YIL145C",527).
component("U89_",164).
component("YOR241W",816).
component("YMR113W",710).
component("YKL132C",601).
component("YJL101C",546).
component("YGL234W",434).
component("YER183C",395).
component("U90_",166).
component("YNR057C",769).
component("YDL141W",280).
component("YDL141W",281).
component("YGL234W",435).
component("YDL141W",282).
component("YGR204W",465).
component("YOL058W",780).
component("YDL141W",283).
component("YHR074W",499).
component("YMR217W",720).
component("YPR145W",882).
component("YGR124W",450).
component("YOR303W",820).
component("YJR109C",581).
component("YJL130C",551).
component("YGL062W",422).
component("YBR218C",223).
component("YPL231W",857).
component("YNR016C",762).
component("YKL182W",610).
component("YGR037C",442).
component("YOR005C",792).
component("YDL164C",285).
component("YJL087C",543).
component("YOL010W",772).
component("YPR138C",881).
component("YPL265W",860).
component("YOR348C",827).
component("YOR192C",809).
component("YOR171C",807).
component("YOR130C",802).
component("YOR071C",796).
component("YOR011W",793).
component("YOL156W",791).
component("YOL103W",787).
component("YOL020W",774).
component("YNL318C",758).
component("YNL270C",751).
component("YNL142W",742).
component("YMR272C",726).
component("YMR202W",717).
component("YMR056C",704).
component("YML123C",698).
component("YLR348C",673).
component("YLR260W",664).
component("YLR237W",660).
component("YLR138W",647).
component("YLR100C",644).
component("YLR092W",643).
component("YLR081W",642).
component("YLL061W",633).
component("YKR093W",629).
component("YKR053C",625).
component("YKR039W",624).
component("YKL217W",619).
component("YKL120W",599).
component("YKL004W",591).
component("YJR095W",578).
component("YJR077C",576).
component("YJL219W",564).
component("YJL134W",552).
component("YJL129C",549).
component("YHL036W",480).
component("YGR191W",458).
component("YGR125W",451).
component("YGR121C",448).
component("YGR065C",445).
component("YGR055W",444).
component("YGL186C",429).
component("YFL055W",403).
component("YFL011W",397).
component("YER060W-A",375).
component("YER060W",374).
component("YER056C",373).
component("YER053C",372).
component("YEL063C",365).
component("YDR536W",354).
component("YDR508C",350).
component("YDR503C",349).
component("YDR497C",347).
component("YDR297W",330).
component("YDR294C",329).
component("YDR046C",303).
