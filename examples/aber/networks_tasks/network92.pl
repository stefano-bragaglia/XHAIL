...
component("YKR009C",438).
component("YMR083W",499).
component("YPL231W",612).
component("YJR159W",415).
component("YGL001C",288).
component("YML056C",485).
...
component("YJR139C",411).
component("YOR136W",572).
component("YNL009W",518).
component("YLR174W",462).
component("YDL066W",180).
component("YHR183W",357).
component("YGR256W",332).
component("YNL241C",533).
component("YOL059W",560).
component("YDL022W",175).
component("YCL018W",161).
component("YLR355C",475).
component("YML054C",484).
component("YIL155C",371).
component("YEL024W",246).
component("YJR078W",407).
component("U58_",93).
component("YGR255C",331).
component("YMR015C",496).
component("YDR402C",232).
component("YGL055W",294).
component("YJL026W",379).
component("YIL066C",367).
component("YGR180C",323).
component("YER070W",262).
component("U36_",81).
component("U35_",80).
component("YJR009C",398).
component("YJL052W",380).
component("YGR192C",325).
component("YOR374W",593).
component("YER073W",263).
component("U68_",97).
...
component("YER014W",250).
component("YKL141W",424).
component("YJR051W",402).
component("YOR375C",594).
component("YDL215C",200).
component("YAL062W",116).
component("U100_",20).
component("YBR035C",134).
component("YMR189W",506).
component("U56_",92).
component("YPL023C",598).
component("YGL125W",298).
component("YOR236W",581).
...
component("YOR221C",579).
component("YMR145C",504).
component("YML120C",490).
component("YKL192C",432).
component("YKL055C",418).
component("YER061C",257).
component("YDL085W",183).
component("YBR046C",136).
component("YPL017C",597).
component("YFL018C",277).
component("YPL091W",601).
component("YER042W",251).
component("YNL052W",520).
component("YMR256C",513).
component("YLR395C",478).
...
component("YPL273W",620).
component("YLL062C",445).
component("YDR410C",234).
component("YER091C",267).
component("YJR073C",405).
component("YDL033C",176).
component("YOL096C",563).
component("YLR172C",461).
component("YMR120C",503).
component("YBL013W",119).
component("YJL130C",388).
component("YJL088W",383).
component("YPR074C",630).
component("YBR117C",144).
component("YMR108W",501).
component("YCL009C",160).
component("YMR062C",498).
component("YNL071W",521).
component("YIL160C",373).
component("YNR019W",548).
component("YCR048W",172).
component("U48_",86).
component("YNL277W",538).
component("YFL017C",276).
component("YPL231W",613).
component("YER061C",258).
component("U86_",109).
component("YDL052C",178).
component("U8_",111).
component("YDR148C",221).
component("YOR377W",595).
component("YGR177C",322).
component("YPL231W",614).
component("YLR195C",464).
component("YLR299W",469).
component("YPR001W",622).
component("YNR001C",544).
component("YCR005C",168).
component("YML126C",492).
component("YDL182W",197).
component("YDL131W",189).
component("YNL117W",525).
component("YIR031C",377).
component("YOR321W",585).
component("YJR143C",412).
component("YGR199W",327).
component("YDL095W",185).
component("YDL093W",184).
component("YAL023C",115).
component("YPL227C",610).
component("YMR261C",514).
component("YML100W",489).
component("YBR126C",146).
component("YNL192W",532).
component("YBR038W",135).
component("YBR023C",132).
component("YLR209C",465).
component("U104_",23).
component("YDR354W",228).
component("YFR047C",285).
component("YJR133W",410).
component("U22_",70).
component("YDR399W",230).
component("YJL167W",395).
component("YNL256W",535).
component("YPR069C",629).
component("YDR127W",216).
component("YHR190W",358).
...
component("YKL106W",421).
component("YOL140W",566).
component("YLR438W",482).
component("YKL104C",420).
component("YGR019W",310).
component("YDR111C",213).
component("U51_",89).
component("YJR148W",413).
component("YHR208W",361).
component("YOR184W",576).
component("YGL253W",309).
component("YFR053C",286).
component("YMR013C",495).
component("YLR240W",467).
component("YKL203C",434).
component("YJR066W",404).
component("YCR036W",171).
component("YGR194C",326).
component("YCL040W",165).
component("YJR105W",408).
component("U16_",48).
component("YKL001C",416).
component("YML070W",487).
component("YFL053W",280).
component("YDR531W",242).
component("U82_",108).
component("U81_",107).
component("YMR208W",508).
component("YPL203W",608).
component("YOR061W",567).
component("YKL166C",427).
component("YJL164C",394).
component("YIL035C",364).
component("YHR205W",360).
component("YHR102W",350).
component("YGL019W",290).
component("YHR025W",341).
component("YNR012W",546).
component("YPR121W",632).
component("YPL258C",616).
component("YOL055C",558).
component("U1_",60).
component("YBR020W",131).
component("YFR019W",283).
component("YDR208W",223).
component("YDR127W",217).
component("U21_",67).
component("YDR147W",220).
component("YCR012W",169).
component("YER052C",253).
component("U19_",59).
component("U18_",55).
component("U17_",52).
component("U76_",104).
component("YMR220W",510).
component("YER170W",273).
component("YDR226W",224).
component("YKL067W",419).
component("YOL055C",559).
component("YDR454C",237).
component("YOL061W",561).
component("YKL181W",428).
component("YHL011C",335).
component("YER099C",269).
component("YBL068W",125).
component("YOR143C",573).
component("YNL256W",536).
component("YBR018C",129).
component("YDL055C",179).
component("YLR328W",473).
component("YDL103C",187).
component("U94_",113).
component("YJR010W",399).
component("YBR029C",133).
component("YPR190C",637).
component("YPR187W",636).
component("YPR110C",631).
component("YPR010C",624).
component("YOR341W",590).
component("YOR340C",589).
component("YOR224C",580).
component("YOR210W",578).
component("YOR207C",577).
component("YOR151C",574).
component("YOR116C",569).
component("YOL005C",553).
component("YNR003C",545).
component("YNL248C",534).
component("YNL151C",530).
component("YNL113W",524).
component("YKL144C",425).
component("YJR063W",403).
...
component("YDR156W",222).
component("YDR045C",207).
component("YDL150W",196).
component("YDL140C",191).
component("YBR154C",148).
component("YPR175W",635).
component("YPL167C",606).
component("YOR330C",587).
component("YOL115W",565).
component("YNL299W",542).
component("YNL262W",537).
component("YNL102W",523).
component("YJR043C",401).
component("YJR006W",397).
component("YJL090C",384).
component("YIL139C",370).
component("YEL055C",247).
component("YDR419W",235).
component("YDR121W",214).
component("YDL102W",186).
component("YCR014C",170).
component("YBR278W",157).
component("YBL035C",121).
component("YKL035W",417).
component("YHL012W",336).
component("YHR123W",351).
component("YNL130C",526).
component("YPL148C",604).
component("YOR251C",583).
component("YGR286C",334).
component("YDR058C",209).
component("YOL011W",555).
component("YMR008C",494).
component("YMR006C",493).
component("U105_",24).
component("U101_",21).
component("YJL068C",381).
component("YPL072W",600).
component("YOR124C",570).
component("YNL186W",531).
component("YMR304W",516).
component("YMR223W",511).
...
component("YER098W",268).
component("YDR069C",210).
component("YDL122W",188).
component("YBR058C",137).
component("YBL067C",124).
component("YJR019C",400).
component("YDR074W",211).
component("YFR025C",284).
component("YPL179W",607).
component("YNR032W",549).
component("YML057W",486).
component("YML016C",483).
component("YLR433C",481).
component("YGR123C",317).
component("YER133W",270).
component("YER089C",265).
component("YDR436W",236).
component("YDR075W",212).
component("YDL188C",198).
component("YDL134C",190).
component("YDL047W",177).
component("YDL006W",174).
component("YBR125C",145).
component("YBL056W",123).
component("YIL053W",366).
component("YER062C",259).
component("YHR046C",345).
component("U9_",114).
component("YGR208W",329).
component("YPL228W",611).
component("YMR180C",505).
...
component("YOL064C",562).
component("YPL268W",619).
component("YOR360C",592).
component("YGL248W",308).
component("YKR031C",439).
component("YGL027C",292).
component("YLR286C",468).
component("YJR153W",414).
component("YBR184W",150).
component("YIL162W",374).
component("YPR026W",625).
component("YDR001C",202).
component("YBR001C",128).
component("YDR400W",231).
component("U102_",22).
component("YER043C",252).
component("YNL045W",519).
component("YLR160C",460).
component("YLR158C",459).
component("YLR157C",458).
component("YLR155C",457).
component("YDR321W",227).
component("YGL037C",293).
component("U43_",84).
component("U42_",83).
component("YLR308W",472).
component("YLR307W",471).
component("U53_",90).
component("YLR420W",479).
component("YPL111W",602).
component("YIR032C",378).
component("YLR028C",447).
component("YHR144C",354).
component("YHR144C",355).
component("YNL141W",527).
component("YBR153W",147).
component("YDL238C",201).
...
component("YCL030C",164).
component("YER005W",249).
component("YBL099W",127).
component("YLR231C",466).
component("U88_",110).
component("YDR538W",244).
component("YLR134W",454).
component("YLR044C",449).
component("YGR087C",314).
component("YDR380W",229).
component("YDL080C",182).
component("YMR250W",512).
component("YKL184W",431).
component("YEL021W",245).
component("YNR043W",551).
component("YKL211C",435).
component("YKR097W",442).
component("YOL052C",557).
component("YDR294C",225).
component("YNR033W",550).
component("YPR006C",623).
component("YER065C",260).
component("YKL211C",436).
component("YER090W",266).
component("YDR127W",218).
component("YPL281C",621).
component("YOR393W",596).
component("YMR323W",517).
component("YHR174W",356).
component("YGR254W",330).
component("YGL026C",291).
component("YGR155W",320).
...
component("YIL168W",376).
component("YIL167W",375).
component("YCL064C",166).
component("YCL064C",167).
component("YLR359W",476).
component("YFR055W",287).
component("YJL121C",385).
component("YBR019C",130).
component("YDR007W",203).
component("YOR095C",568).
component("YBR196C",151).
component("YGL001C",289).
component("YPL117C",603).
component("U14_",40).
component("YMR105C",500).
component("YKL127W",422).
component("YEL058W",248).
component("YPR060C",628).
component("YHR072W",349).
component("YJL153C",392).
component("YGR264C",333).
component("YGR171C",321).
component("YHR011W",338).
component("YDR023W",204).
component("YHR020W",340).
component("YER087W",264).
component("YGL245W",307).
component("YOR168W",575).
component("YPR047W",627).
component("YLR060W",451).
component("YFL022C",278).
component("YPR033C",626).
component("YHR019C",339).
component("YKL194C",433).
component("YIL078W",368).
component("YPL160W",605).
component("YLR382C",477).
component("YPL040C",599).
component("YBL076C",126).
component("YNL073W",522).
component("YDR037W",206).
component("YOR335C",588).
component("YGR094W",315).
component("YOR241W",582).
component("YMR113W",502).
component("YKL132C",423).
component("YGL234W",305).
component("YER183C",274).
component("U90_",112).
component("YNR057C",552).
...
component("YPR145W",634).
component("YGR124W",318).
component("YOR303W",584).
...
component("YJL087C",382).
component("YOL010W",554).
component("YPR138C",633).
component("YPL265W",617).
component("YOR348C",591).
component("YOR130C",571).
component("YOL103W",564).
component("YOL020W",556).
component("YNL142W",529).
component("YMR272C",515).
component("YMR202W",507).
component("YMR056C",497).
component("YML123C",491).
component("YLR348C",474).
component("YLR138W",455).
component("YLR100C",453).
component("YLR092W",452).
component("YLL061W",444).
component("YKR053C",441).
component("YKR039W",440).
component("YKL217W",437).
component("YJR077C",406).
component("YJL134W",389).
component("YJL129C",387).
component("YHL036W",337).
component("YGR191W",324).
component("YGR125W",319).
...
component("YDR046C",208).
component("YDL210W",199).
component("YCL025C",162).
component("YBR294W",159).
component("YBR291C",158).
component("YBR085W",142).
component("YBR069C",139).
component("YBR068C",138).
component("YBL042C",122).
component("YBL030C",120).
component("U7_",106).
component("U79_",105).
component("U75_",103).
component("U74_",102).
