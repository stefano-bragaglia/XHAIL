...
component("YLR056W",780).
component("YGR060W",550).
component("YKR009C",759).
component("YMR083W",862).
component("YPL231W",1041).
component("YBR265W",293).
component("U46_",165).
component("YBR149W",274).
component("YBR149W",275).
component("YJR159W",722).
component("YGL001C",514).
component("YHR063C",609).
component("U45_",164).
component("YBR153W",276).
component("YML056C",841).
component("YLR432W",829).
component("YHR216W",634).
component("YAR075W",226).
component("YAR073W",225).
component("YCL030C",303).
component("YDR127W",392).
component("YJR139C",717).
component("YML075C",844).
component("YLR450W",832).
component("YOL126C",961).
component("YKL085W",732).
component("YDL078C",336).
component("YKL029C",727).
component("YOR136W",980).
component("YNL037C",896).
component("YNL009W",894).
component("YLR174W",798).
component("YDL066W",334).
component("YHR183W",628).
component("YGR256W",584).
component("YNL241C",912).
component("YOL059W",953).
component("YDL022W",325).
component("YCL018W",301).
component("YLR355C",823).
component("YIL074C",642).
component("YER081W",480).
component("YML054C",840).
component("YDL174C",359).
component("YIL155C",652).
component("YPR191W",1079).
component("YOR065W",970).
component("YJL166W",687).
component("YHR001W-A",595).
component("YGR183C",567).
component("YFR033C",510).
component("YEL024W",450).
component("YDR529C",440).
component("YBL045C",233).
component("Q0105",19).
component("YKR066C",764).
component("YKL026C",726).
component("YIR037W",663).
component("YBR244W",288).
component("YJR078W",708).
component("U58_",177).
component("YJR025C",700).
component("U107_",29).
component("YGR255C",583).
component("U108_",30).
component("YBL098W",238).
component("YMR015C",857).
component("YHR007C",596).
component("YDR402C",427).
component("YGL055W",524).
component("YGR175C",564).
component("YJR104C",711).
component("YHR008C",597).
component("YJL026W",666).
component("YIL066C",641).
component("YGR180C",566).
component("YER070W",478).
component("U37_",156).
component("U36_",155).
component("U35_",154).
component("YDR158W",400).
component("YJR009C",697).
component("YJL052W",668).
component("YGR192C",570).
component("YBR006W",243).
component("YPL276W",1052).
component("YPL275W",1051).
component("YOR388C",1014).
component("YOR374W",1011).
component("YER073W",479).
component("U68_",188).
component("YGL154C",532).
component("YBR115C",268).
component("U55_",174).
component("YER069W",476).
component("YOR323C",1001).
component("U2_",148).
component("YER178W",493).
component("YBR221C",286).
component("YIL125W",648).
component("YBR166C",279).
component("YNL280C",922).
component("YGL012W",518).
component("YKL182W",745).
component("U57_",176).
component("YKL216W",756).
component("YDR044W",376).
component("YER014W",461).
component("YKR009C",760).
component("YIL160C",654).
component("YGL205W",537).
component("YMR118C",867).
component("YLR164W",796).
component("YLL041C",771).
component("YKL148C",740).
component("YKL141W",738).
component("YJL045W",667).
component("YDR178W",402).
component("YJR051W",703).
component("YEL047C",454).
component("YDL171C",358).
component("YDL215C",363).
component("YOR375C",1012).
component("YDL215C",364).
component("YAL062W",223).
component("U99_",216).
component("U100_",22).
component("YBR035C",253).
component("YMR189W",874).
component("U56_",175).
component("YNR050C",937).
component("YKR080W",766).
component("YER023W",462).
component("YPL023C",1018).
component("YGL125W",529).
component("YOR236W",994).
component("YGR204W",574).
component("YBR084W",261).
component("YLR142W",789).
component("U65_",185).
component("U63_",183).
component("U62_",182).
component("YOR356W",1009).
component("YHR068W",610).
component("YKL150W",741).
component("YIL043C",638).
component("YHR042W",604).
component("YOR221C",992).
component("YMR145C",870).
component("YML120C",849).
component("YKL192C",749).
component("YKL055C",729).
component("YER061C",472).
component("YDL085W",338).
component("YBR046C",256).
component("YMR145C",871).
component("YML120C",850).
component("YKL192C",750).
component("YDL085W",339).
component("YGR234W",578).
component("YFR030W",509).
component("YPL017C",1017).
component("YFL018C",498).
component("YPL091W",1024).
component("YHR106W",619).
component("YDR353W",422).
component("YER042W",464).
component("YPR167C",1073).
component("YJR137C",716).
component("YNL052W",898).
component("YMR256C",882).
component("YLR395C",827).
component("YLR038C",778).
component("YIL111W",646).
component("YHR051W",608).
component("YGL191W",535).
component("YGL187C",534).
component("YDL067C",335).
component("Q0275",21).
component("Q0250",20).
component("Q0045",18).
component("YDR072C",385).
component("YPL266W",1048).
component("YML110C",848).
component("YBR034C",252).
component("YPL273W",1050).
component("YLL062C",774).
component("YDR410C",430).
component("YKR069W",765).
component("YOL096C",956).
component("U47_",166).
component("YER091C",484).
component("YJR073C",706).
component("YGR157W",561).
component("YML008C",833).
component("YDL033C",327).
component("YOL096C",957).
component("YLR172C",797).
component("YLR058C",781).
component("YBR263W",292).
component("YDR019C",372).
component("YBR176W",280).
component("YDR408C",429).
...
component("YPR074C",1065).
component("YBR117C",269).
component("YLR354C",822).
component("YGR043C",548).
component("YMR108W",865).
component("YCL009C",300).
component("YMR062C",860).
component("YNL071W",899).
component("YIL160C",655).
component("YNR019W",931).
component("YCR048W",320).
component("U48_",167).
component("YNL277W",920).
component("YMR062C",861).
component("YDR232W",405).
component("YFL017C",497).
component("YPL231W",1042).
component("YER061C",473).
component("U86_",206).
component("YPL001W",1016).
component("YDL052C",331).
component("U8_",209).
component("YDR148C",398).
component("YML042W",839).
component("YOR377W",1013).
component("YGR177C",565).
component("YPL231W",1043).
component("YGR147C",559).
component("YDL040C",328).
component("YPL028W",1019).
component("YLR195C",800).
component("YLR299W",810).
component("YGL017W",519).
component("YPR001W",1054).
component("YNR001C",927).
component("YCR005C",312).
component("YML126C",852).
component("YDL182W",360).
component("YDL131W",348).
component("YNL117W",903).
component("YIR031C",661).
component("YPR160W",1072).
component("YOR321W",1000).
component("YJR143C",718).
component("YGR199W",572).
component("YDL095W",343).
component("YDL093W",342).
component("YAL023C",219).
component("YLR258W",807).
component("YFR015C",506).
component("YPL227C",1039).
component("YOR103C",975).
component("YOR085W",972).
component("YMR149W",872).
component("YML019W",835).
component("YJL002C",664).
component("YEL002C",445).
component("YDL232W",365).
component("YCL043C",307).
component("YNL029C",895).
component("YIL085C",644).
component("YMR261C",883).
component("YML100W",846).
component("YBR126C",272).
component("YNL192W",910).
component("YBR038W",255).
component("YBR023C",250).
component("YEL011W",446).
component("YMR306W",892).
component("YLR342W",820).
component("YGR032W",546).
component("YPR183W",1076).
component("YLR209C",801).
component("U104_",26).
component("U103_",25).
component("YMR271C",885).
component("YML106W",847).
component("YOR209C",990).
component("YMR300C",890).
component("YER055C",468).
component("YDR354W",423).
component("YFR047C",511).
component("YJR133W",715).
component("U22_",142).
component("YLR209C",802).
component("YML022W",836).
component("YDR441C",433).
component("YDR399W",425).
component("YHR128W",621).
component("YPR176C",1075).
component("YPL172C",1032).
component("YNR041C",935).
component("YMR101C",863).
component("YDL090C",341).
component("YBR003W",242).
component("YBR002C",241).
component("YJL167W",688).
component("YJL167W",689).
component("YNL256W",915).
component("YPR069C",1063).
component("YDR127W",393).
component("YHR190W",629).
component("YLR146C",790).
component("YHR068W",611).
component("YLR303W",812).
component("YGR012W",544).
component("YML082W",845).
component("YJR130C",714).
component("YDR035W",374).
component("YBR249C",289).
component("YLR180W",799).
component("YDR502C",437).
component("YOR274W",997).
component("YOL143C",964).
component("YBR256C",291).
component("YHR137W",622).
component("YGL202W",536).
component("YLR027C",775).
component("YKL106W",734).
component("YOL140W",963).
component("YLR438W",831).
component("YKL104C",733).
component("YGR019W",545).
component("YDR111C",390).
component("U64_",184).
component("U61_",181).
component("U51_",171).
component("YJR148W",719).
component("YHR208W",632).
component("YFL030W",500).
component("YOR184W",986).
component("YNR058W",940).
component("YIL116W",647).
component("YGL253W",542).
component("YFR053C",512).
component("YOL136C",962).
component("YIL107C",645).
component("YMR013C",856).
component("YMR205C",876).
component("YGR240C",579).
component("YOL016C",945).
component("YFR014C",505).
component("YLR240W",805).
component("YKL203C",752).
component("YJR066W",705).
component("YCR036W",319).
component("YGR194C",571).
component("YCL040W",306).
component("YJR105W",712).
component("U16_",89).
component("U15_",80).
component("YPL188W",1034).
component("YJR049C",702).
component("YEL041W",451).
component("U96_",214).
component("YKL001C",723).
component("YDR236C",407).
component("YML070W",843).
component("YFL053W",502).
component("YHL032C",593).
component("YLR133W",786).
component("YDR531W",442).
component("U83_",203).
component("U82_",202).
component("U81_",201).
component("YMR208W",877).
component("YPL203W",1035).
component("YOR061W",969).
component("YKL166C",743).
component("YJL164C",686).
component("YIL035C",637).
component("YHR205W",631).
component("YHR102W",618).
component("YGL019W",520).
component("YHR025W",603).
component("YOR347C",1007).
component("YAL038W",221).
component("YNR012W",929).
component("YPR121W",1069).
component("YPL258C",1045).
component("YOL055C",949).
component("YPL214C",1038).
component("U1_",120).
component("YDR009W",371).
component("YBR020W",249).
component("YNL267W",918).
component("YLR305C",814).
component("YFR019W",507).
component("YDR208W",403).
component("YDR127W",394).
component("U21_",133).
component("U20_",128).
component("YDR147W",397).
component("YDR300C",416).
component("YCR012W",313).
component("YER052C",466).
component("YER069W",477).
component("U19_",119).
component("U18_",109).
component("U17_",98).
component("U76_",197).
component("YMR220W",879).
component("YER170W",492).
component("YDR226W",404).
component("YKL067W",731).
component("YOL055C",950).
component("YDR454C",434).
component("YOL061W",954).
component("YKL181W",744).
component("YHL011C",590).
component("YER099C",486).
component("YBL068W",236).
component("YOR143C",981).
component("YNL256W",916).
component("YLR328W",818).
component("YBR018C",245).
component("YBR018C",246).
component("YDL055C",332).
component("YGR007W",543).
component("YGR202C",573).
component("YLR328W",819).
component("YKR002W",758).
component("YDL045C",329).
component("YDL103C",346).
component("U94_",213).
component("YJR010W",698).
component("YBR029C",251).
component("YCL050C",308).
component("YGL130W",530).
component("YDR530C",441).
component("YCL050C",309).
component("YPR190C",1078).
component("YPR187W",1077).
component("YPR110C",1067).
component("YPR010C",1056).
component("YOR341W",1006).
component("YOR340C",1005).
component("YOR224C",993).
component("YOR210W",991).
component("YOR207C",989).
component("YOR151C",982).
component("YOR116C",976).
component("YOL005C",942).
component("YNR003C",928).
component("YNL248C",914).
component("YNL151C",908).
component("YNL113W",902).
component("YKL144C",739).
component("YJR063W",704).
component("YJL148W",683).
component("YJL140W",682).
component("YIL021W",636).
component("YHR143W-A",623).
component("YGL070C",528).
component("YFL036W",501).
component("YDR404C",428).
component("YDR156W",399).
component("YDR045C",377).
component("YDL150W",356).
component("YDL140C",350).
component("YBR154C",278).
component("YPR175W",1074).
component("YPL167C",1031).
component("YOR330C",1002).
component("YOL115W",960).
component("YNL299W",924).
component("YNL262W",917).
component("YNL102W",901).
component("YJR043C",701).
component("YJR006W",696).
component("YJL090C",674).
component("YIL139C",650).
component("YEL055C",455).
component("YDR419W",431).
component("YDR121W",391).
component("YDL102W",345).
component("YCR014C",314).
component("YBR278W",294).
component("YBL035C",230).
component("YKL035W",728).
component("YHL012W",591).
component("YHR123W",620).
component("YPR113W",1068).
component("YBR243C",287).
component("YNL130C",904).
component("YDL142C",355).
component("YPL148C",1029).
component("YER026C",463).
component("YOR251C",996).
component("YGR286C",587).
component("YJL068C",669).
component("YDR058C",382).
component("YNR034W",934).
component("YHR163W",626).
component("YGR248W",581).
component("YCR073W-A",322).
component("YDL086W",340).
...
component("YPL072W",1023).
component("YOR124C",977).
component("YNL186W",909).
component("YMR304W",891).
component("YMR223W",880).
component("YKR098C",769).
component("YJL197W",690).
component("YIL156W",653).
component("YFR010W",504).
component("YER151C",490).
component("YER144C",489).
component("YER098W",485).
component("YDR069C",384).
component("YDL122W",347).
component("YBR058C",257).
component("YBL067C",235).
component("YJR019C",699).
component("YOR040W",968).
component("YDR272W",411).
component("U84_",204).
component("YDR481C",435).
component("YLR377C",825).
component("YDR074W",386).
component("YFR025C",508).
component("YPL179W",1033).
component("YNR032W",932).
component("YML057W",842).
component("YML016C",834).
component("YLR433C",830).
component("YGR123C",555).
component("YER133W",488).
component("YER089C",482).
component("YDR436W",432).
component("YDR075W",387).
component("YDL188C",361).
component("YDL134C",349).
component("YDL047W",330).
component("YDL006W",323).
component("YBR125C",271).
component("YBL056W",234).
component("YPR073C",1064).
component("YHR215W",633).
component("YDL024C",326).
component("YBR093C",266).
component("YBR092C",265).
component("YIL053W",640).
component("YER062C",474).
component("YHR046C",607).
component("U9_",217).
component("YGR208W",577).
component("YPL228W",1040).
component("YMR180C",873).
component("YDL236W",366).
component("YJL155C",685).
component("U34_",153).
component("U33_",152).
component("U32_",151).
component("U31_",150).
...
component("U26_",144).
component("U24_",143).
component("YHR044C",606).
component("YHR043C",605).
component("YOL064C",955).
component("YPL268W",1049).
component("YOR360C",1010).
component("YGL248W",541).
component("YKR031C",761).
component("YPL206C",1036).
component("YGL027C",522).
component("YLR286C",809).
component("YJR153W",720).
component("YJL221C",695).
component("YJL216C",693).
component("YIL172C",659).
component("YGR292W",589).
component("YGR287C",588).
component("YBR299W",299).
component("YBR184W",281).
component("YIL162W",656).
component("YPR026W",1057).
component("YDR001C",369).
component("YBR001C",240).
component("YOR190W",987).
component("YLR300W",811).
component("YGR282C",586).
component("YDR261C",409).
component("YDR400W",426).
component("YML035C",837).
component("YJL070C",671).
component("YBR284W",295).
component("U106_",28).
component("U102_",24).
component("YER043C",465).
component("YNL045W",897).
component("YLR160C",795).
component("YLR158C",794).
component("YLR157C",793).
component("YLR155C",792).
component("YDR321W",417).
component("YGL037C",523).
component("U43_",162).
component("U42_",161).
component("YMR293C",889).
component("YDR242W",408).
component("YLR308W",817).
component("YLR307W",816).
component("YBR208C",283).
component("YMR281W",888).
component("U53_",172).
component("YLR420W",828).
component("YPL111W",1027).
component("YIR032C",662).
component("YIR029W",660).
component("YPR062W",1062).
component("YMR120C",869).
component("YLR028C",777).
component("YHR144C",624).
component("YHR144C",625).
component("YCL030C",304).
component("YNL141W",905).
component("YBL033C",229).
component("YBR153W",277).
component("YDL238C",367).
component("YNL141W",906).
component("YLR245C",806).
component("YML035C",838).
component("YGR204W",575).
component("YBR084W",262).
component("YJL126W",677).
component("U44_",163).
component("YDL100C",344).
component("U40_",159).
component("U39_",157).
component("YMR267W",884).
component("YBR011C",244).
component("YHR201C",630).
component("YBR111C",267).
component("YBR252W",290).
component("YCL030C",305).
component("YEL042W",452).
component("YER005W",460).
component("YIL048W",639).
component("YER166W",491).
component("YDR093W",389).
component("YAL026C",220).
component("YBL099W",239).
component("U60_",180).
component("YLR231C",803).
component("U88_",207).
component("YDR538W",444).
component("YLR134W",787).
component("YLR044C",779).
component("YGR087C",552).
component("YDR380W",424).
component("YDL080C",337).
component("U98_",215).
component("YMR250W",881).
component("YKL184W",748).
component("YOR128C",978).
component("YEL021W",449).
component("YNR043W",936).
component("U93_",212).
component("YDR047W",379).
component("U54_",173).
component("YKL211C",754).
component("YKR097W",768).
component("YOL052C",948).
component("YGR170W",562).
component("YKL060C",730).
component("YDR294C",413).
component("YEL046C",453).
component("YNR033W",933).
component("YPR006C",1055).
component("YER065C",475).
component("YKL211C",755).
component("YER090W",483).
component("YDR127W",395).
component("YPL281C",1053).
component("YOR393W",1015).
component("YMR323W",893).
component("YHR174W",627).
component("YGR254W",582).
component("YPL262W",1046).
component("YGL026C",521).
component("YGR155W",560).
component("YLR304C",813).
component("YJL200C",691).
component("YGL009C",517).
component("YDR234W",406).
component("YNL316C",925).
component("YKL182W",746).
component("YPL212C",1037).
component("YNL292W",923).
component("YGL063W",527).
component("YFL001W",495).
component("YOR278W",998).
component("U49_",168).
component("YCR053W",321).
component("YDR127W",396).
component("YGL148W",531).
component("YIL168W",658).
component("YIL167W",657).
component("YCL064C",310).
component("YCL064C",311).
component("YHR018C",599).
component("YLR359W",824).
component("YAL012W",218).
component("YFR055W",513).
component("YJL005W",665).
component("YOR176W",985).
component("YJL121C",676).
component("YBR019C",247).
component("YBR019C",248).
component("U59_",178).
component("YDR050C",380).
component("YIL020C",635).
component("YDR007W",370).
component("YOR095C",973).
component("YER003C",459).
component("YBR196C",282).
component("YGL001C",515).
component("YPL117C",1028).
component("U14_",73).
component("YOL056W",951).
component("YKL152C",742).
component("YDL021W",324).
component("YMR105C",864).
component("YKL127W",736).
component("YEL058W",456).
component("YMR278W",887).
component("YPR060C",1061).
component("YHR072W",612).
component("YJL153C",684).
component("YPL097W",1025).
component("YGR185C",568).
component("YGR264C",585).
component("YGR171C",563).
component("YHR011W",598).
component("YDR023W",373).
component("YPL104W",1026).
component("YLL018C",770).
component("YPR081C",1066).
component("YBR121C",270).
component("YHR020W",602).
component("YER087W",481).
component("YNL247W",913).
component("YOL033W",947).
component("YGL245W",540).
component("YOR168W",983).
component("YHR091C",614).
component("YDR341C",418).
component("YOL097C",958).
component("YDR268W",410).
component("YPR047W",1060).
component("YLR060W",782).
component("YFL022C",499).
component("YPR033C",1058).
component("YHR019C",600).
component("YCR024C",315).
component("YHR019C",601).
component("YKL194C",751).
component("YIL078W",643).
component("YPL160W",1030).
component("YLR382C",826).
component("YPL040C",1021).
component("YBL076C",237).
component("YNL073W",900).
component("YDR037W",375).
component("YOR335C",1003).
component("YGR094W",553).
component("YLR153C",791).
component("YAL054C",222).
component("YGR244C",580).
component("YPR035W",1059).
component("YIL145C",651).
component("U89_",208).
component("YOR241W",995).
component("YMR113W",866).
component("YKL132C",737).
component("YOR339C",1004).
component("YMR022W",858).
component("YLR306W",815).
component("YKL210W",753).
component("YGR133W",558).
component("YGL058W",525).
component("YER100W",487).
component("YEL012W",447).
component("YDR177W",401).
component("YDR092W",388).
component("YDR059C",383).
component("YDR054C",381).
component("YDL064W",333).
component("YBR082C",260).
component("YJL101C",675).
component("U92_",211).
component("YAR015W",224).
component("YGL234W",538).
component("YER183C",494).
component("U90_",210).
component("YNR057C",939).
component("YDL141W",351).
component("YDL141W",352).
component("YGL234W",539).
component("YDL141W",353).
component("YJR103W",710).
component("YBL039C",231).
component("YGR204W",576).
component("YBR084W",263).
component("YNL220W",911).
component("YOL058W",952).
component("YBR208C",284).
component("YDL141W",354).
component("YHR074W",613).
component("YMR217W",878).
component("YPR145W",1071).
component("YGR124W",556).
component("YOR303W",999).
component("YJR109C",713).
component("YJL130C",680).
component("YGL062W",526).
component("YBR218C",285).
component("YPL231W",1044).
component("YNR016C",930).
component("YKL182W",747).
component("YGR037C",547).
component("YOR005C",966).
component("YDL164C",357).
component("YJL087C",672).
component("YOL010W",943).
component("YPR138C",1070).
component("YPL265W",1047).
component("YPL057C",1022).
component("YPL036W",1020).
component("YOR348C",1008).
component("YOR192C",988).
component("YOR171C",984).
component("YOR130C",979).
component("YOR100C",974).
component("YOR071C",971).
component("YOR011W",967).
component("YOL156W",965).
component("YOL103W",959).
component("YOL020W",946).
component("YNR072W",941).
component("YNR056C",938).
component("YNL318C",926).
component("YNL270C",919).
component("YNL142W",907).
component("YMR272C",886).
component("YMR202W",875).
component("YMR056C",859).
component("YMR011W",855).
component("YML123C",851).
component("YLR348C",821).
component("YLR260W",808).
component("YLR237W",804).
component("YLR138W",788).
component("YLR100C",785).
component("YLR092W",784).
component("YLR081W",783).
component("YLL061W",773).
component("YLL043W",772).
component("YKR093W",767).
component("YKR053C",763).
component("YKR039W",762).
component("YKL217W",757).
component("YKL120W",735).
component("YKL004W",724).
component("YJR158W",721).
component("YJR095W",709).
component("YJR077C",707).
component("YJL219W",694).
component("YJL214W",692).
component("YJL134W",681).
component("YJL129C",678).
component("YIL134W",649).
component("YHR096C",617).
component("YHR094C",616).
component("YHR092C",615).
component("YHL036W",594).
component("YHL016C",592).
component("YGR191W",569).
component("YGR125W",557).
component("YGR121C",554).
component("YGR065C",551).
component("YGR055W",549).
component("YGL186C",533).
component("YGL008C",516).
component("YFL055W",503).
component("YFL011W",496).
component("YER060W-A",471).
component("YER060W",470).
component("YER056C",469).
component("YER053C",467).
component("YEL069C",458).
component("YEL063C",457).
component("YEL017C-A",448).
component("YDR536W",443).
component("YDR508C",439).
component("YDR503C",438).
component("YDR497C",436).
component("YDR345C",421).
component("YDR343C",420).
component("YDR342C",419).
component("YDR297W",415).
component("YDR294C",414).
component("YDR284C",412).
component("YDR046C",378).
component("YDL245C",368).
component("YDL210W",362).
component("YCR032W",318).
component("YCR028C",317).
component("YCR024C-A",316).
component("YCL025C",302).
component("YBR298C",298).
component("YBR294W",297).
component("YBR291C",296).
component("YBR132C",273).
component("YBR085W",264).
component("YBR069C",259).
component("YBR068C",258).
component("YBR036C",254).
component("YBL042C",232).
component("YBL030C",228).
component("U85_",205).
component("U7_",200).
component("U79_",199).
component("U78_",198).
