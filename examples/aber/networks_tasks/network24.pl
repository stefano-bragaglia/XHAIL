...
component("YNL280C",210).
component("YLR056W",178).
component("YGL001C",122).
component("YDR127W",85).
component("YNL009W",202).
component("YLR174W",185).
component("YHR183W",149).
component("YGR256W",137).
component("YCL018W",62).
component("YJR078W",163).
component("YMR015C",194).
component("YDR402C",96).
component("YGL055W",125).
component("YJL026W",154).
component("YGR180C",134).
component("YOR323C",225).
component("YBR166C",58).
component("YNL280C",211).
component("YKL141W",168).
component("YOR375C",228).
component("YAL062W",46).
component("U100_",18).
component("YMR145C",195).
component("YDL085W",71).
component("YBR046C",51).
component("YDR410C",97).
component("YJL088W",156).
component("YPR074C",239).
component("YBR117C",56).
component("YNL071W",203).
component("YNR019W",214).
component("YCR048W",68).
component("U48_",39).
component("YPL231W",232).
component("YPL231W",233).
component("YLR299W",187).
component("YCR005C",65).
component("YNL117W",205).
component("YIR031C",153).
component("YOR321W",224).
component("YJR143C",166).
component("YGR199W",135).
component("YDL095W",73).
component("YDL093W",72).
component("YAL023C",45).
component("YDR354W",93).
component("YFR047C",120).
component("U22_",33).
component("YDR399W",95).
component("YPR069C",238).
component("YDR127W",86).
component("YML082W",190).
component("YJR130C",165).
component("YDR035W",81).
component("YBR249C",60).
component("YHR137W",145).
component("YGL202W",128).
component("YLR027C",176).
component("YKL106W",167).
component("YLR438W",189).
component("U51_",40).
component("YMR013C",193).
component("YCR036W",67).
component("YCL040W",64).
component("YJR105W",164).
component("YMR208W",197).
component("YHR025W",141).
component("YFR019W",119).
component("YDR208W",90).
component("YDR127W",87).
component("YER052C",106).
component("U19_",29).
component("U76_",44).
component("YDR226W",91).
component("YDR454C",99).
component("YOL061W",219).
component("YKL181W",169).
component("YHL011C",139).
component("YER099C",112).
component("YBL068W",50).
component("YLR328W",188).
component("YPR175W",242).
component("YPL167C",231).
component("YOR330C",226).
component("YOL115W",221).
component("YNL299W",212).
component("YNL262W",209).
component("YNL102W",204).
component("YJR043C",161).
component("YJR006W",160).
component("YJL090C",157).
component("YIL139C",151).
component("YEL055C",104).
component("YDR419W",98).
component("YDR121W",84).
component("YDL102W",74).
component("YCR014C",66).
component("YBR278W",61).
component("YBL035C",47).
component("YOL011W",217).
component("YMR008C",192).
component("YMR006C",191).
component("U105_",19).
component("YPL072W",230).
component("YOR124C",223).
component("YNL186W",208).
component("YMR304W",200).
component("YMR223W",198).
component("YKR098C",175).
component("YJL197W",159).
component("YIL156W",152).
component("YFR010W",118).
component("YER151C",114).
component("YER144C",113).
component("YER098W",111).
component("YDR069C",83).
component("YDL122W",75).
component("YBR058C",52).
component("YBL067C",49).
component("U32_",35).
component("U30_",34).
component("YHR044C",143).
component("YHR043C",142).
component("YLR160C",184).
component("YLR158C",183).
component("YLR157C",182).
component("YLR155C",181).
component("YDR321W",92).
component("YGL037C",124).
component("U43_",37).
component("U42_",36).
component("U53_",41).
component("YHR144C",146).
component("YHR144C",147).
component("YBR153W",57).
component("YDL238C",79).
component("YNL141W",206).
component("U44_",38).
component("YHR201C",150).
component("YBR111C",55).
component("YER005W",105).
component("YLR231C",186).
component("YLR134W",180).
component("YLR044C",177).
component("YGR087C",130).
component("YDR380W",94).
component("YDL080C",70).
component("YMR250W",199).
component("YKL184W",170).
component("YEL021W",103).
component("YKL211C",171).
component("YNR033W",215).
component("YKL211C",172).
component("YER090W",110).
component("YDR127W",88).
component("YPL281C",235).
component("YOR393W",229).
component("YMR323W",201).
component("YHR174W",148).
component("YGR254W",136).
component("YGL026C",123).
component("YNL316C",213).
component("YCR053W",69).
component("YDR127W",89).
component("YGL148W",126).
component("YFR055W",121).
component("YDR007W",80).
component("YOR095C",222).
component("YBR196C",59).
component("YPR060C",237).
component("YHR072W",144).
component("YGR264C",138).
component("YGR171C",133).
component("YGL245W",129).
component("YPR047W",236).
component("YLR060W",179).
component("YFL022C",116).
component("YHR019C",140).
component("YER183C",115).
component("YDL141W",76).
component("YDL141W",77).
component("YPR145W",241).
component("YGR124W",132).
component("YJL087C",155).
component("YOL010W",216).
component("YPR138C",240).
component("YPL265W",234).
component("YOR348C",227).
component("YOL103W",220).
component("YOL020W",218).
component("YNL142W",207).
component("YMR202W",196).
component("YKR053C",174).
component("YKR039W",173).
component("YJR077C",162).
component("YJL134W",158).
component("YGR121C",131).
component("YGL186C",127).
component("YFL055W",117).
component("YER060W-A",109).
component("YER060W",108).
component("YER056C",107).
component("YDR536W",102).
component("YDR508C",101).
component("YDR497C",100).
component("YDR046C",82).
component("YDL210W",78).
component("YCL025C",63).
component("YBR069C",54).
component("YBR068C",53).
component("YBL042C",48).
component("U6_",43).
component("U5_",42).
component("U228_",32).
component("U222_",31).
