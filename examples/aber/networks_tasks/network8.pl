...
component("YNL280C",92).
component("YLR056W",81).
component("YGL001C",56).
component("YDR127W",39).
component("YNL009W",90).
component("YLR174W",82).
component("YCL018W",30).
component("YJR078W",71).
component("YOR323C",100).
component("YBR166C",28).
component("YNL280C",93).
component("YMR145C",86).
component("YDL085W",35).
component("YBR046C",23).
component("U48_",20).
component("YPL231W",102).
component("YLR299W",84).
component("YDR354W",45).
component("YFR047C",55).
component("YPR069C",106).
component("YDR127W",40).
component("YDR035W",37).
component("YBR249C",29).
component("YHR137W",66).
component("YLR027C",80).
component("YKL106W",73).
component("YCR036W",32).
component("YJR105W",72).
component("YMR208W",87).
component("YDR127W",41).
component("YDR226W",44).
component("YDR454C",47).
component("YOL061W",98).
component("YKL181W",74).
component("YHL011C",63).
component("YER099C",52).
component("YBL068W",22).
component("YLR328W",85).
component("YHR044C",65).
component("YHR043C",64).
component("YGL037C",58).
component("U53_",21).
component("YHR144C",67).
component("YBR153W",27).
component("YBR111C",26).
component("YER005W",50).
component("YLR231C",83).
component("YDR380W",46).
component("YDL080C",34).
component("YMR250W",88).
component("YKL184W",75).
component("YKL211C",76).
component("YNR033W",95).
component("YKL211C",77).
component("YER090W",51).
component("YDR127W",42).
component("YPL281C",104).
component("YOR393W",101).
component("YMR323W",89).
component("YHR174W",68).
component("YGR254W",62).
component("YGL026C",57).
component("YNL316C",94).
component("YCR053W",33).
component("YDR127W",43).
component("YGL148W",59).
component("YDR007W",36).
component("YOR095C",99).
component("YPR060C",105).
component("YGL245W",60).
component("YER183C",53).
component("YJL087C",69).
component("YOL010W",96).
component("YPR138C",107).
component("YPL265W",103).
component("YOL020W",97).
component("YNL142W",91).
component("YKR053C",79).
component("YKR039W",78).
component("YJL134W",70).
component("YGR121C",61).
component("YFL055W",54).
component("YDR536W",49).
component("YDR508C",48).
component("YDR046C",38).
component("YCL025C",31).
component("YBR069C",25).
component("YBR068C",24).
component("U228_",19).
component("U165_",18).
component("I01179",17).
component("I00631",16).
