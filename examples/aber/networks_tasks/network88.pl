...
component("YMR083W",482).
component("YPL231W",588).
component("YJR159W",403).
component("YGL001C",282).
component("YML056C",468).
...
component("YJR139C",399).
component("YOR136W",551).
component("YNL009W",500).
component("YLR174W",446).
component("YDL066W",178).
component("YHR183W",346).
component("YGR256W",322).
component("YOL059W",540).
component("YDL022W",173).
component("YCL018W",159).
component("YLR355C",458).
component("YML054C",467).
component("YIL155C",359).
component("YEL024W",242).
component("YJR078W",395).
component("U58_",91).
component("YGR255C",321).
component("YMR015C",479).
component("YDR402C",230).
component("YGL055W",288).
component("YJL026W",367).
component("YIL066C",355).
component("YGR180C",313).
component("YER070W",257).
component("U36_",79).
component("U35_",78).
component("YJR009C",386).
component("YJL052W",368).
component("YGR192C",315).
component("YOR374W",570).
component("YER073W",258).
component("U68_",95).
component("YGL154C",293).
component("U55_",89).
component("YER069W",256).
component("YOR323C",563).
component("U2_",73).
component("YBR221C",151).
component("YBR166C",147).
component("YNL280C",521).
component("YER014W",246).
component("YKL141W",410).
component("YJR051W",390).
component("YOR375C",571).
component("YDL215C",198).
component("YAL062W",114).
component("U100_",20).
component("YBR035C",132).
component("YMR189W",488).
component("U56_",90).
component("YPL023C",575).
component("YGL125W",291).
component("YOR236W",559).
...
component("YKL150W",412).
component("YIL043C",353).
component("YHR042W",331).
component("YMR145C",486).
component("YML120C",473).
component("YKL192C",417).
component("YDL085W",181).
component("YBR046C",134).
component("YPL017C",574).
component("YFL018C",271).
component("YPL091W",578).
component("YER042W",247).
component("YNL052W",502).
component("YMR256C",495).
component("YLR395C",461).
component("YLR038C",432).
component("YIL111W",357).
component("YHR051W",335).
component("YGL191W",296).
component("YGL187C",295).
component("YDL067C",179).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",594).
component("YPL273W",596).
component("YLL062C",429).
component("YDR410C",232).
component("YER091C",262).
component("YJR073C",393).
component("YDL033C",174).
component("YOL096C",542).
component("YLR172C",445).
component("YMR120C",485).
component("YBL013W",117).
component("YJL130C",376).
component("YJL088W",371).
component("YPR074C",606).
component("YBR117C",142).
component("YMR108W",484).
component("YCL009C",158).
component("YMR062C",481).
component("YNL071W",503).
component("YIL160C",361).
component("YNR019W",528).
component("YCR048W",170).
component("U48_",84).
component("YNL277W",519).
component("YFL017C",270).
component("YPL231W",589).
component("YER061C",253).
component("U86_",107).
component("YDL052C",176).
component("U8_",109).
component("YDR148C",219).
component("YOR377W",572).
component("YGR177C",312).
component("YPL231W",590).
component("YLR195C",447).
component("YLR299W",452).
component("YPR001W",598).
component("YNR001C",524).
component("YCR005C",166).
component("YML126C",475).
component("YDL182W",195).
component("YDL131W",187).
component("YNL117W",507).
component("YIR031C",365).
component("YOR321W",562).
component("YJR143C",400).
component("YGR199W",317).
component("YDL095W",183).
component("YDL093W",182).
component("YAL023C",113).
component("YPL227C",586).
component("YMR261C",496).
component("YML100W",472).
component("YBR126C",144).
component("YNL192W",514).
component("YBR038W",133).
component("YBR023C",130).
component("YLR209C",448).
component("U104_",23).
component("YDR354W",226).
component("YFR047C",279).
component("YJR133W",398).
component("U22_",68).
component("YDR399W",228).
component("YJL167W",383).
component("YNL256W",516).
component("YPR069C",605).
component("YDR127W",214).
component("YHR068W",337).
component("YLR303W",453).
component("YML082W",471).
component("YJR130C",397).
component("YDR035W",203).
component("YBR249C",152).
component("YBR256C",154).
component("YHR137W",341).
component("YGL202W",297).
component("YLR027C",430).
component("YKL106W",408).
component("YOL140W",545).
component("YLR438W",465).
component("YKL104C",407).
component("YDR111C",211).
component("U51_",87).
component("YJR148W",401).
component("YHR208W",349).
component("YOR184W",555).
component("YGL253W",301).
component("YFR053C",280).
component("YMR013C",478).
component("YLR240W",450).
component("YKL203C",419).
component("YJR066W",392).
component("YCR036W",169).
component("YGR194C",316).
component("YCL040W",163).
component("YJR105W",396).
component("U16_",46).
component("YKL001C",404).
component("YML070W",470).
component("YFL053W",274).
component("U82_",106).
component("U81_",105).
component("YMR208W",490).
component("YPL203W",585).
component("YOR061W",546).
component("YKL166C",413).
component("YJL164C",382).
component("YIL035C",352).
component("YHR205W",348).
component("YHR102W",339).
component("YGL019W",284).
component("YHR025W",330).
component("YNR012W",526).
component("YPR121W",608).
component("YPL258C",592).
component("YOL055C",538).
component("U1_",58).
component("YBR020W",129).
component("YFR019W",277).
component("YDR208W",221).
component("YDR127W",215).
component("U21_",65).
component("YDR147W",218).
component("YCR012W",167).
component("YER052C",249).
component("U19_",57).
component("U18_",53).
component("U17_",50).
component("U76_",102).
component("YMR220W",492).
component("YER170W",268).
component("YDR226W",222).
component("YKL067W",406).
component("YOL055C",539).
component("YDR454C",235).
component("YOL061W",541).
component("YKL181W",414).
...
component("YKL035W",405).
component("YHL012W",326).
component("YHR123W",340).
component("YNL130C",508).
component("YPL148C",581).
component("YOR251C",560).
component("YGR286C",324).
component("YDR058C",207).
component("YOL011W",535).
component("YMR008C",477).
component("YMR006C",476).
component("U105_",24).
component("U101_",21).
component("YJL068C",369).
component("YPL072W",577).
component("YOR124C",549).
component("YNL186W",513).
component("YMR304W",498).
component("YMR223W",493).
component("YKR098C",428).
component("YJL197W",384).
component("YIL156W",360).
component("YFR010W",276).
component("YER151C",267).
component("YER144C",266).
component("YER098W",263).
component("YDR069C",208).
component("YDL122W",186).
component("YBR058C",135).
component("YBL067C",122).
component("YJR019C",388).
component("YDR074W",209).
component("YFR025C",278).
component("YPL179W",584).
component("YNR032W",529).
component("YML057W",469).
component("YML016C",466).
component("YLR433C",464).
component("YGR123C",307).
component("YER133W",265).
component("YER089C",260).
component("YDR436W",234).
component("YDR075W",210).
component("YDL188C",196).
component("YDL134C",188).
component("YDL047W",175).
component("YDL006W",172).
component("YBR125C",143).
component("YBL056W",121).
component("YIL053W",354).
component("YER062C",254).
component("YHR046C",334).
component("U9_",112).
component("YGR208W",319).
component("YPL228W",587).
component("YMR180C",487).
component("YJL155C",381).
component("U34_",77).
component("U33_",76).
component("U32_",75).
component("U30_",74).
...
component("YPL268W",595).
component("YOR360C",569).
component("YGL248W",300).
component("YKR031C",424).
component("YGL027C",286).
component("YLR286C",451).
component("YJR153W",402).
component("YBR184W",148).
component("YIL162W",362).
component("YPR026W",601).
component("YDR001C",200).
component("YBR001C",126).
component("YDR400W",229).
component("U102_",22).
component("YER043C",248).
component("YNL045W",501).
component("YLR160C",444).
component("YLR158C",443).
component("YLR157C",442).
component("YLR155C",441).
component("YDR321W",225).
component("YGL037C",287).
component("U43_",82).
component("U42_",81).
component("YLR308W",455).
component("YLR307W",454).
component("U53_",88).
component("YLR420W",462).
component("YPL111W",579).
component("YIR032C",366).
component("YLR028C",431).
component("YHR144C",343).
component("YHR144C",344).
component("YNL141W",509).
...
component("U44_",83).
component("YHR201C",347).
component("YBR111C",141).
component("YBR252W",153).
component("YCL030C",162).
component("YER005W",245).
component("YBL099W",125).
component("YLR231C",449).
component("U88_",108).
component("YDR538W",240).
component("YLR134W",438).
component("YLR044C",433).
component("YGR087C",304).
component("YDR380W",227).
component("YDL080C",180).
component("YMR250W",494).
component("YKL184W",416).
component("YEL021W",241).
component("YNR043W",531).
component("YKL211C",420).
component("YKR097W",427).
component("YOL052C",537).
component("YDR294C",223).
component("YNR033W",530).
component("YPR006C",599).
component("YER065C",255).
component("YKL211C",421).
component("YER090W",261).
component("YDR127W",216).
component("YPL281C",597).
component("YOR393W",573).
component("YMR323W",499).
component("YHR174W",345).
component("YGR254W",320).
component("YGL026C",285).
component("YGR155W",310).
component("YNL316C",523).
component("YCR053W",171).
component("YDR127W",217).
component("YGL148W",292).
component("YIL168W",364).
component("YIL167W",363).
component("YCL064C",164).
component("YCL064C",165).
component("YLR359W",459).
component("YFR055W",281).
component("YJL121C",373).
component("YBR019C",128).
component("YDR007W",201).
component("YOR095C",547).
component("YBR196C",149).
component("YGL001C",283).
component("YPL117C",580).
component("U14_",39).
component("YMR105C",483).
component("YKL127W",409).
component("YEL058W",244).
component("YPR060C",604).
component("YHR072W",338).
component("YJL153C",380).
component("YGR264C",323).
component("YGR171C",311).
component("YHR011W",327).
component("YDR023W",202).
component("YHR020W",329).
component("YER087W",259).
component("YGL245W",299).
component("YOR168W",554).
component("YPR047W",603).
component("YLR060W",435).
component("YFL022C",272).
component("YPR033C",602).
component("YHR019C",328).
component("YKL194C",418).
component("YIL078W",356).
component("YPL160W",582).
component("YLR382C",460).
component("YPL040C",576).
component("YBL076C",124).
component("YNL073W",504).
component("YDR037W",204).
component("YOR335C",565).
component("YGR094W",305).
component("YGL234W",298).
component("YER183C",269).
component("U90_",110).
component("YNR057C",532).
component("YDL141W",190).
component("YDL141W",191).
component("YDL141W",192).
component("YDL141W",193).
component("YMR217W",491).
component("YPR145W",610).
component("YGR124W",308).
component("YOR303W",561).
component("YGL062W",289).
component("YBR218C",150).
component("YPL231W",591).
component("YNR016C",527).
component("YKL182W",415).
component("YGR037C",302).
component("YJL087C",370).
component("YOL010W",534).
component("YPR138C",609).
component("YPL265W",593).
component("YOR348C",568).
component("YOR130C",550).
component("YOL103W",543).
component("YOL020W",536).
component("YNL142W",511).
component("YMR272C",497).
component("YMR202W",489).
component("YMR056C",480).
component("YML123C",474).
component("YLR348C",457).
component("YLR138W",439).
component("YLR100C",437).
component("YLR092W",436).
component("YKR053C",426).
component("YKR039W",425).
component("YKL217W",422).
component("YJR077C",394).
component("YJL134W",377).
component("YJL129C",375).
component("YGR191W",314).
component("YGR125W",309).
component("YGR121C",306).
component("YGR065C",303).
component("YGL186C",294).
component("YFL055W",275).
...
component("YDR046C",206).
component("YDL210W",197).
component("YCL025C",160).
component("YBR294W",157).
component("YBR291C",156).
component("YBR085W",140).
component("YBR069C",137).
component("YBR068C",136).
