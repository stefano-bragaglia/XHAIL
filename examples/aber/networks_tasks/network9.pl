...
component("YNL280C",97).
component("YLR056W",85).
component("YGL001C",60).
component("YDR127W",41).
component("YNL009W",95).
component("YLR174W",87).
component("YCL018W",32).
component("YJR078W",75).
component("YOR323C",105).
component("YBR166C",30).
component("YNL280C",98).
component("U100_",18).
component("YMR145C",91).
component("YDL085W",37).
component("YBR046C",25).
component("U48_",22).
component("YPL231W",107).
component("YPL231W",108).
component("YLR299W",89).
component("YDR354W",47).
component("YFR047C",58).
component("U22_",21).
component("YPR069C",113).
component("YDR127W",42).
component("YDR035W",39).
component("YBR249C",31).
component("YHR137W",70).
component("YLR027C",84).
component("YKL106W",77).
component("YCR036W",34).
component("YJR105W",76).
component("YMR208W",92).
component("YDR127W",43).
component("YDR226W",46).
component("YDR454C",49).
component("YOL061W",103).
component("YKL181W",78).
component("YHL011C",67).
component("YER099C",54).
component("YBL068W",24).
component("YLR328W",90).
component("YHR044C",69).
component("YHR043C",68).
component("YGL037C",62).
component("U53_",23).
component("YHR144C",71).
component("YBR153W",29).
component("YBR111C",28).
component("YER005W",52).
component("YLR231C",88).
component("YDR380W",48).
component("YDL080C",36).
component("YMR250W",93).
component("YKL184W",79).
component("YKL211C",80).
component("YNR033W",100).
component("YKL211C",81).
component("YER090W",53).
component("YDR127W",44).
component("YPL281C",110).
component("YOR393W",106).
component("YMR323W",94).
component("YHR174W",72).
component("YGR254W",66).
component("YGL026C",61).
component("YNL316C",99).
component("YCR053W",35).
component("YDR127W",45).
component("YGL148W",63).
component("YFR055W",59).
component("YDR007W",38).
component("YOR095C",104).
component("YPR060C",112).
component("YGL245W",64).
component("YPR047W",111).
component("YLR060W",86).
component("YFL022C",56).
component("YER183C",55).
component("YJL087C",73).
component("YOL010W",101).
component("YPR138C",114).
component("YPL265W",109).
component("YOL020W",102).
component("YNL142W",96).
component("YKR053C",83).
component("YKR039W",82).
component("YJL134W",74).
component("YGR121C",65).
component("YFL055W",57).
component("YDR536W",51).
component("YDR508C",50).
component("YDR046C",40).
component("YCL025C",33).
component("YBR069C",27).
component("YBR068C",26).
component("U228_",20).
component("U165_",19).
component("I01179",17).
component("I00631",16).
