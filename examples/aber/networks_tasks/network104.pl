...
component("YLR056W",494).
component("YKR009C",479).
component("YMR083W",549).
component("YPL231W",668).
component("YJR159W",454).
component("YGL001C",312).
component("YHR063C",378).
component("YML056C",534).
component("YLR432W",528).
component("YHR216W",395).
component("YAR075W",134).
component("YAR073W",133).
component("YCL030C",181).
component("YDR127W",235).
component("YJR139C",450).
component("YOR136W",627).
component("YNL009W",571).
component("YLR174W",506).
component("YDL066W",198).
component("YHR183W",390).
component("YGR256W",361).
component("YNL241C",586).
component("YOL059W",614).
component("YDL022W",193).
component("YCL018W",179).
component("YLR355C",522).
component("YML054C",533).
component("YIL155C",404).
component("YEL024W",270).
component("YJR078W",445).
component("U58_",106).
component("YGR255C",360).
component("U108_",26).
component("YMR015C",546).
component("YDR402C",253).
component("YGL055W",319).
component("YJL026W",414).
component("YIL066C",400).
component("YGR180C",350).
component("YER070W",286).
component("U36_",93).
component("U35_",92).
component("YJR009C",436).
component("YJL052W",415).
component("YGR192C",352).
component("YOR374W",649).
component("YER073W",287).
component("U68_",111).
component("YGL154C",326).
component("U55_",104).
component("YER069W",285).
component("YOR323C",642).
component("U2_",87).
...
component("YIL160C",406).
component("YGL205W",331).
component("YKL141W",463).
component("YJR051W",440).
component("YOR375C",650).
component("YDL215C",219).
component("YAL062W",132).
component("U100_",20).
component("YBR035C",150).
component("YMR189W",557).
component("U56_",105).
component("YKR080W",485).
component("YPL023C",654).
component("YGL125W",323).
component("YOR236W",637).
component("YGR204W",355).
component("YBR084W",156).
component("YLR142W",500).
component("U65_",109).
component("U62_",108).
component("YHR068W",379).
component("YKL150W",465).
component("YIL043C",398).
component("YHR042W",373).
component("YOR221C",635).
component("YMR145C",554).
component("YML120C",539).
...
component("YDL085W",202).
component("YPL017C",653).
component("YFL018C",301).
component("YPL091W",657).
component("YER042W",275).
component("YNL052W",573).
component("YMR256C",565).
component("YLR395C",526).
component("YLR038C",492).
component("YIL111W",402).
component("YHR051W",377).
component("YGL191W",329).
component("YGL187C",328).
component("YDL067C",199).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",674).
component("YPL273W",676).
component("YLL062C",489).
component("YDR410C",255).
component("YKR069W",484).
component("YER091C",291).
component("YJR073C",443).
component("YDL033C",194).
component("YOL096C",617).
component("YLR172C",505).
component("YMR120C",553).
component("YBL013W",135).
component("YJL130C",423).
component("YJL088W",418).
component("YPR074C",687).
component("YBR117C",160).
component("YMR108W",551).
component("YCL009C",178).
component("YMR062C",548).
component("YNL071W",574).
component("YIL160C",407).
component("YNR019W",601).
component("YCR048W",190).
component("U48_",99).
component("YNL277W",591).
component("YFL017C",300).
component("YPL231W",669).
component("YER061C",282).
component("U86_",124).
component("YDL052C",196).
component("U8_",127).
component("YDR148C",241).
component("YOR377W",651).
component("YGR177C",349).
component("YPL231W",670).
component("YLR195C",508).
component("YLR299W",514).
component("YPR001W",678).
component("YNR001C",597).
component("YCR005C",186).
component("YML126C",542).
component("YDL182W",216).
component("YDL131W",208).
component("YNL117W",578).
component("YIR031C",412).
component("YPR160W",693).
component("YOR321W",641).
component("YJR143C",451).
component("YGR199W",354).
component("YDL095W",204).
component("YDL093W",203).
component("YAL023C",131).
component("YPL227C",666).
component("YMR261C",566).
component("YML100W",538).
component("YBR126C",163).
component("YNL192W",585).
component("YBR038W",151).
component("YBR023C",148).
component("YEL011W",268).
component("YLR209C",509).
component("U104_",24).
component("U103_",23).
component("YOR209C",633).
component("YMR300C",568).
component("YDR354W",249).
component("YFR047C",309).
component("YJR133W",449).
component("U22_",82).
component("YLR209C",510).
component("YDR399W",251).
component("YJL167W",430).
component("YNL256W",588).
component("YPR069C",686).
component("YDR127W",236).
component("YHR190W",391).
component("YHR068W",380).
component("YLR303W",515).
component("YML082W",537).
component("YJR130C",448).
component("YDR035W",225).
component("YBR249C",171).
component("YLR180W",507).
component("YDR502C",261).
component("YOL143C",621).
component("YBR256C",173).
component("YHR137W",385).
component("YGL202W",330).
component("YLR027C",490).
component("YKL106W",460).
component("YOL140W",620).
component("YLR438W",530).
component("YKL104C",459).
component("YGR019W",337).
component("YDR111C",233).
component("U51_",102).
component("YJR148W",452).
component("YHR208W",394).
component("YOR184W",631).
component("YNR058W",606).
component("YGL253W",336).
component("YFR053C",310).
component("YMR013C",545).
component("YMR205C",559).
component("YGR240C",358).
component("YLR240W",512).
component("YKL203C",475).
component("YJR066W",442).
component("YCR036W",189).
component("YGR194C",353).
component("YCL040W",183).
component("YJR105W",447).
component("U16_",54).
component("YKL001C",455).
component("YML070W",536).
component("YFL053W",304).
component("YDR531W",265).
component("U82_",122).
component("U81_",121).
component("YMR208W",560).
component("YPL203W",664).
component("YOR061W",622).
component("YKL166C",467).
component("YJL164C",429).
component("YIL035C",397).
component("YHR205W",393).
component("YHR102W",383).
component("YGL019W",315).
component("YHR025W",372).
component("YNR012W",599).
component("YPR121W",690).
component("YPL258C",672).
component("YOL055C",612).
component("U1_",71).
component("YDR009W",223).
component("YBR020W",147).
component("YFR019W",307).
component("YDR208W",243).
component("YDR127W",237).
component("U21_",79).
component("YDR147W",240).
component("YDR300C",247).
component("YCR012W",187).
component("YER052C",277).
component("U19_",70).
component("U18_",64).
component("U17_",59).
component("U76_",118).
component("YMR220W",562).
component("YER170W",297).
component("YDR226W",244).
component("YKL067W",458).
component("YOL055C",613).
component("YDR454C",258).
component("YOL061W",615).
component("YKL181W",468).
component("YHL011C",366).
component("YER099C",293).
component("YBL068W",141).
component("YOR143C",628).
component("YNL256W",589).
component("YLR328W",519).
component("YBR018C",145).
component("YDL055C",197).
component("YLR328W",520).
component("YDL103C",206).
component("U94_",129).
component("YJR010W",437).
component("YBR029C",149).
component("YGL130W",324).
component("YDR530C",264).
component("YPR190C",696).
component("YPR187W",695).
component("YPR110C",689).
component("YPR010C",680).
component("YOR341W",646).
component("YOR340C",645).
component("YOR224C",636).
component("YOR210W",634).
component("YOR207C",632).
component("YOR151C",629).
component("YOR116C",624).
component("YOL005C",607).
component("YNR003C",598).
component("YNL248C",587).
component("YNL151C",583).
component("YNL113W",577).
component("YKL144C",464).
component("YJR063W",441).
component("YJL148W",426).
component("YJL140W",425).
component("YIL021W",396).
component("YHR143W-A",386).
component("YGL070C",322).
component("YFL036W",303).
component("YDR404C",254).
component("YDR156W",242).
component("YDR045C",227).
component("YDL150W",215).
component("YDL140C",210).
component("YBR154C",165).
component("YPR175W",694).
component("YPL167C",662).
component("YOR330C",643).
component("YOL115W",619).
component("YNL299W",595).
component("YNL262W",590).
component("YNL102W",576).
component("YJR043C",439).
component("YJR006W",435).
component("YJL090C",419).
component("YIL139C",403).
component("YEL055C",271).
component("YDR419W",256).
component("YDR121W",234).
component("YDL102W",205).
component("YCR014C",188).
component("YBR278W",174).
component("YBL035C",137).
component("YKL035W",456).
component("YHL012W",367).
component("YHR123W",384).
component("YNL130C",579).
component("YPL148C",660).
component("YOR251C",639).
component("YGR286C",363).
component("YDR058C",229).
component("YOL011W",609).
component("YMR008C",544).
component("YMR006C",543).
component("U105_",25).
component("U101_",21).
component("YJL068C",416).
component("YPL072W",656).
component("YOR124C",625).
component("YNL186W",584).
component("YMR304W",569).
component("YMR223W",563).
component("YKR098C",487).
component("YJL197W",431).
component("YIL156W",405).
component("YFR010W",306).
component("YER151C",296).
component("YER144C",295).
component("YER098W",292).
component("YDR069C",230).
component("YDL122W",207).
component("YBR058C",153).
component("YBL067C",140).
component("YJR019C",438).
component("YDR481C",259).
component("YLR377C",524).
component("YDR074W",231).
component("YFR025C",308).
component("YPL179W",663).
component("YNR032W",602).
component("YML057W",535).
component("YML016C",531).
component("YLR433C",529).
component("YGR123C",344).
component("YER133W",294).
component("YER089C",289).
component("YDR436W",257).
component("YDR075W",232).
component("YDL188C",217).
component("YDL134C",209).
component("YDL047W",195).
component("YDL006W",192).
component("YBR125C",162).
component("YBL056W",139).
component("YIL053W",399).
component("YER062C",283).
component("YHR046C",376).
component("U9_",130).
component("YGR208W",357).
component("YPL228W",667).
component("YMR180C",556).
component("YJL155C",428).
component("U34_",91).
component("U33_",90).
component("U32_",89).
component("U30_",88).
...
component("U26_",84).
component("U24_",83).
component("YHR044C",375).
component("YHR043C",374).
component("YOL064C",616).
component("YPL268W",675).
component("YOR360C",648).
component("YGL248W",335).
component("YKR031C",481).
component("YGL027C",317).
component("YLR286C",513).
component("YJR153W",453).
component("YJL221C",434).
component("YJL216C",433).
component("YIL172C",411).
component("YGR292W",365).
component("YGR287C",364).
component("YBR299W",177).
component("YBR184W",167).
component("YIL162W",408).
component("YPR026W",681).
component("YDR001C",221).
component("YBR001C",144).
component("YDR400W",252).
component("U102_",22).
component("YER043C",276).
component("YNL045W",572).
component("YLR160C",504).
component("YLR158C",503).
component("YLR157C",502).
component("YLR155C",501).
component("YDR321W",248).
component("YGL037C",318).
component("U43_",97).
component("U42_",96).
component("YLR308W",518).
component("YLR307W",517).
component("U53_",103).
component("YLR420W",527).
component("YPL111W",658).
component("YIR032C",413).
component("YLR028C",491).
component("YHR144C",387).
component("YHR144C",388).
component("YNL141W",580).
component("YBR153W",164).
component("YDL238C",220).
...
component("U88_",125).
component("YDR538W",267).
component("YLR134W",498).
component("YLR044C",493).
component("YGR087C",341).
component("YDR380W",250).
component("YDL080C",200).
component("YMR250W",564).
component("YKL184W",471).
component("YEL021W",269).
component("YNR043W",604).
component("YKL211C",476).
component("YKR097W",486).
component("YOL052C",611).
component("YDR294C",245).
component("YNR033W",603).
component("YPR006C",679).
component("YER065C",284).
component("YKL211C",477).
component("YER090W",290).
component("YDR127W",238).
component("YPL281C",677).
component("YOR393W",652).
component("YMR323W",570).
component("YHR174W",389).
component("YGR254W",359).
component("YGL026C",316).
component("YGR155W",347).
component("YLR304C",516).
component("YJL200C",432).
component("YNL316C",596).
component("YPL212C",665).
component("YNL292W",594).
component("YGL063W",321).
component("YFL001W",299).
component("YCR053W",191).
component("YDR127W",239).
component("YGL148W",325).
component("YIL168W",410).
component("YIL167W",409).
component("YCL064C",184).
component("YCL064C",185).
component("YLR359W",523).
component("YFR055W",311).
component("YJL121C",420).
component("YBR019C",146).
component("YDR007W",222).
component("YOR095C",623).
component("YBR196C",168).
component("YGL001C",313).
component("YPL117C",659).
component("U14_",46).
component("YKL152C",466).
component("YMR105C",550).
component("YKL127W",461).
component("YEL058W",272).
component("YPR060C",685).
component("YHR072W",381).
component("YJL153C",427).
component("YGR264C",362).
component("YGR171C",348).
component("YHR011W",369).
component("YDR023W",224).
component("YPR081C",688).
component("YBR121C",161).
component("YHR020W",371).
component("YER087W",288).
component("YGL245W",334).
component("YOR168W",630).
component("YPR047W",684).
component("YLR060W",495).
component("YFL022C",302).
component("YPR033C",682).
component("YHR019C",370).
component("YKL194C",474).
component("YIL078W",401).
component("YPL160W",661).
component("YLR382C",525).
component("YPL040C",655).
component("YBL076C",142).
component("YNL073W",575).
component("YDR037W",226).
component("YOR335C",644).
component("YGR094W",342).
component("YPR035W",683).
component("U89_",126).
component("YOR241W",638).
component("YMR113W",552).
component("YKL132C",462).
component("YGL234W",332).
component("YER183C",298).
component("U90_",128).
component("YNR057C",605).
component("YDL141W",211).
component("YDL141W",212).
component("YGL234W",333).
component("YDL141W",213).
component("YGR204W",356).
component("YDL141W",214).
component("YHR074W",382).
component("YMR217W",561).
component("YPR145W",692).
component("YGR124W",345).
component("YOR303W",640).
component("YGL062W",320).
component("YBR218C",169).
component("YPL231W",671).
component("YNR016C",600).
component("YKL182W",470).
component("YGR037C",338).
component("YJL087C",417).
component("YOL010W",608).
component("YPR138C",691).
component("YPL265W",673).
component("YOR348C",647).
component("YOR130C",626).
component("YOL103W",618).
component("YOL020W",610).
component("YNL142W",582).
component("YMR272C",567).
component("YMR202W",558).
component("YMR056C",547).
component("YML123C",541).
component("YLR348C",521).
component("YLR138W",499).
component("YLR100C",497).
component("YLR092W",496).
component("YLL061W",488).
component("YKR053C",483).
component("YKR039W",482).
component("YKL217W",478).
component("YJR095W",446).
component("YJR077C",444).
component("YJL134W",424).
component("YJL129C",422).
component("YHL036W",368).
component("YGR191W",351).
component("YGR125W",346).
component("YGR121C",343).
component("YGR065C",340).
component("YGR055W",339).
component("YGL186C",327).
component("YFL055W",305).
component("YER060W-A",280).
component("YER060W",279).
component("YER056C",278).
component("YDR536W",266).
component("YDR508C",263).
component("YDR503C",262).
component("YDR497C",260).
component("YDR294C",246).
component("YDR046C",228).
