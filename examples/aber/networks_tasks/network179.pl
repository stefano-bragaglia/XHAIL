...
component("YLR056W",765).
component("YGR060W",537).
component("YKR009C",744).
component("YMR083W",846).
...
component("YJR139C",702).
component("YML075C",829).
component("YLR450W",817).
component("YOL126C",944).
component("YKL085W",717).
component("YDL078C",327).
component("YKL029C",712).
component("YOR136W",963).
component("YNL037C",879).
component("YNL009W",877).
component("YLR174W",783).
component("YDL066W",325).
component("YHR183W",615).
component("YGR256W",571).
component("YNL241C",895).
component("YOL059W",936).
component("YDL022W",316).
component("YCL018W",293).
component("YLR355C",808).
component("YIL074C",628).
component("YER081W",468).
component("YML054C",825).
component("YDL174C",350).
component("YIL155C",638).
component("YPR191W",1062).
component("YOR065W",953).
component("YJL166W",673).
component("YHR001W-A",582).
component("YGR183C",554).
component("YFR033C",497).
component("YEL024W",438).
component("YDR529C",428).
component("YBL045C",227).
component("Q0105",19).
component("YKR066C",749).
component("YKL026C",711).
component("YIR037W",649).
component("YBR244W",280).
component("YJR078W",693).
component("U58_",172).
component("U107_",29).
component("YGR255C",570).
component("U108_",30).
component("YBL098W",232).
component("YMR015C",842).
component("YHR007C",583).
component("YDR402C",415).
component("YGL055W",511).
component("YGR175C",551).
component("YJR104C",696).
component("YHR008C",584).
component("YJL026W",652).
...
component("YJR009C",683).
component("YJL052W",654).
...
component("YNL280C",905).
component("YGL012W",505).
component("YKL182W",730).
component("U57_",171).
component("YKL216W",741).
component("YDR044W",367).
component("YER014W",449).
component("YKR009C",745).
component("YIL160C",640).
component("YGL205W",524).
component("YMR118C",851).
component("YLR164W",781).
component("YLL041C",756).
component("YKL148C",725).
component("YKL141W",723).
component("YJL045W",653).
component("YDR178W",391).
component("YJR051W",688).
component("YEL047C",442).
...
component("YHR042W",591).
component("YOR221C",975).
component("YMR145C",854).
component("YML120C",834).
component("YKL192C",734).
component("YKL055C",714).
...
component("YGR234W",565).
component("YFR030W",496).
component("YPL017C",1000).
component("YFL018C",485).
component("YPL091W",1007).
component("YHR106W",606).
component("YDR353W",410).
component("YER042W",452).
component("YPR167C",1056).
component("YJR137C",701).
component("YNL052W",881).
component("YMR256C",866).
component("YLR395C",812).
component("YLR038C",763).
component("YIL111W",632).
component("YHR051W",595).
component("YGL191W",522).
component("YGL187C",521).
component("YDL067C",326).
component("Q0275",21).
component("Q0250",20).
component("Q0045",18).
component("YPL266W",1031).
component("YML110C",833).
component("YBR034C",246).
component("YPL273W",1033).
component("YLL062C",759).
component("YDR410C",418).
component("YKR069W",750).
component("YOL096C",939).
component("U47_",161).
component("YER091C",472).
component("YJR073C",691).
component("YGR157W",548).
component("YML008C",818).
component("YDL033C",318).
component("YOL096C",940).
component("YLR172C",782).
component("YLR058C",766).
component("YBR263W",284).
component("YDR019C",363).
component("YBR176W",273).
component("YDR408C",417).
component("YMR120C",852).
component("YLR028C",761).
component("YBL013W",221).
component("YJL130C",665).
component("YJL088W",659).
component("YKL024C",710).
component("YPR074C",1048).
component("YBR117C",262).
component("YLR354C",807).
component("YGR043C",535).
component("YMR108W",849).
component("YCL009C",292).
component("YMR062C",845).
component("YNL071W",882).
component("YIL160C",641).
component("YNR019W",914).
component("YCR048W",311).
component("U48_",162).
component("YNL277W",903).
component("YDR232W",394).
component("YFL017C",484).
...
component("YGL017W",506).
component("YPR001W",1037).
component("YNR001C",910).
component("YCR005C",304).
component("YML126C",837).
component("YDL182W",351).
component("YDL131W",339).
component("YNL117W",886).
component("YIR031C",647).
component("YPR160W",1055).
component("YOR321W",983).
component("YJR143C",703).
component("YGR199W",559).
component("YDL095W",334).
component("YDL093W",333).
component("YAL023C",214).
component("YLR258W",792).
component("YFR015C",493).
component("YPL227C",1022).
component("YOR103C",958).
component("YOR085W",955).
component("YMR149W",856).
component("YML019W",820).
component("YJL002C",650).
component("YEL002C",433).
component("YDL232W",356).
component("YCL043C",299).
component("YNL029C",878).
component("YIL085C",630).
component("YMR261C",867).
component("YML100W",831).
component("YBR126C",265).
component("YNL192W",893).
component("YBR038W",249).
component("YBR023C",244).
component("YEL011W",434).
component("YMR306W",875).
component("YLR342W",805).
component("YGR032W",533).
component("YPR183W",1059).
component("YLR209C",786).
component("U104_",26).
component("U103_",25).
component("YMR271C",868).
component("YML106W",832).
component("YOR209C",973).
component("YMR300C",873).
component("YER055C",456).
component("YDR354W",411).
component("YFR047C",498).
component("YJR133W",700).
component("U22_",137).
component("YLR209C",787).
component("YML022W",821).
component("YDR441C",421).
component("YDR399W",413).
component("YHR128W",608).
component("YPR176C",1058).
component("YPL172C",1015).
component("YNR041C",918).
component("YMR101C",847).
...
component("YKL067W",716).
component("YOL055C",933).
component("YDR454C",422).
component("YOL061W",937).
component("YKL181W",729).
component("YHL011C",577).
component("YER099C",474).
component("YBL068W",230).
component("YOR143C",964).
component("YNL256W",899).
component("YLR328W",803).
component("YBR018C",239).
component("YBR018C",240).
component("YDL055C",323).
component("YGR007W",530).
component("YGR202C",560).
component("YLR328W",804).
component("YKR002W",743).
...
component("YGL130W",517).
component("YDR530C",429).
component("YCL050C",301).
component("YPR190C",1061).
component("YPR187W",1060).
component("YPR110C",1050).
component("YPR010C",1039).
component("YOR341W",989).
component("YOR340C",988).
component("YOR224C",976).
component("YOR210W",974).
component("YOR207C",972).
component("YOR151C",965).
component("YOR116C",959).
component("YOL005C",925).
component("YNR003C",911).
component("YNL248C",897).
component("YNL151C",891).
component("YNL113W",885).
component("YKL144C",724).
component("YJR063W",689).
component("YJL148W",669).
component("YJL140W",668).
component("YIL021W",623).
component("YHR143W-A",610).
component("YGL070C",515).
component("YFL036W",488).
component("YDR404C",416).
component("YDR156W",388).
component("YDR045C",368).
component("YDL150W",347).
component("YDL140C",341).
component("YBR154C",271).
component("YPR175W",1057).
component("YPL167C",1014).
component("YOR330C",985).
component("YOL115W",943).
component("YNL299W",907).
component("YNL262W",900).
component("YNL102W",884).
component("YJR043C",686).
component("YJR006W",682).
component("YJL090C",660).
component("YIL139C",636).
component("YEL055C",443).
component("YDR419W",419).
component("YDR121W",380).
component("YDL102W",336).
component("YCR014C",306).
component("YBR278W",286).
component("YBL035C",224).
component("YKL035W",713).
component("YHL012W",578).
component("YHR123W",607).
component("YPR113W",1051).
component("YBR243C",279).
component("YNL130C",887).
component("YDL142C",346).
component("YPL148C",1012).
component("YER026C",451).
component("YOR251C",979).
component("YGR286C",574).
component("YJL068C",655).
component("YDR058C",373).
component("YNR034W",917).
component("YHR163W",613).
component("YGR248W",568).
component("YCR073W-A",313).
component("YDL086W",331).
component("YOL011W",927).
component("YMR008C",839).
component("YMR006C",838).
component("U105_",27).
component("U101_",23).
component("YJL068C",656).
component("YPL072W",1006).
component("YOR124C",960).
component("YNL186W",892).
component("YMR304W",874).
component("YMR223W",864).
component("YKR098C",754).
component("YJL197W",676).
component("YIL156W",639).
component("YFR010W",491).
component("YER151C",478).
component("YER144C",477).
component("YER098W",473).
component("YDR069C",375).
component("YDL122W",338).
component("YBR058C",251).
component("YBL067C",229).
component("YJR019C",685).
component("YOR040W",951).
component("YDR272W",399).
component("U84_",199).
component("YDR481C",423).
component("YLR377C",810).
component("YDR074W",376).
component("YFR025C",495).
component("YPL179W",1016).
component("YNR032W",915).
component("YML057W",827).
component("YML016C",819).
component("YLR433C",815).
component("YGR123C",542).
component("YER133W",476).
component("YER089C",470).
component("YDR436W",420).
component("YDR075W",377).
...
component("U9_",212).
component("YGR208W",564).
component("YPL228W",1023).
component("YMR180C",857).
component("YDL236W",357).
component("YJL155C",671).
component("U34_",148).
component("U33_",147).
component("U32_",146).
component("U31_",145).
...
component("U26_",139).
component("U24_",138).
component("YHR044C",593).
component("YHR043C",592).
component("YOL064C",938).
component("YPL268W",1032).
component("YOR360C",993).
component("YGL248W",528).
component("YKR031C",746).
component("YPL206C",1019).
component("YGL027C",509).
component("YLR286C",794).
component("YJR153W",705).
component("YJL221C",681).
component("YJL216C",679).
component("YIL172C",645).
component("YGR292W",576).
component("YGR287C",575).
component("YBR299W",291).
component("YBR184W",274).
component("YIL162W",642).
component("YPR026W",1040).
component("YDR001C",360).
component("YBR001C",234).
component("YOR190W",970).
component("YLR300W",796).
component("YGR282C",573).
component("YDR261C",397).
component("YDR400W",414).
component("YML035C",822).
component("YJL070C",657).
component("YBR284W",287).
component("U106_",28).
component("U102_",24).
component("YER043C",453).
component("YNL045W",880).
component("YLR160C",780).
component("YLR158C",779).
component("YLR157C",778).
component("YLR155C",777).
component("YDR321W",405).
component("YGL037C",510).
component("U43_",157).
component("U42_",156).
component("YMR293C",872).
component("YDR242W",396).
component("YLR308W",802).
component("YLR307W",801).
component("YBR208C",276).
component("YMR281W",871).
component("U53_",167).
component("YLR420W",813).
component("YPL111W",1010).
component("YIR032C",648).
component("YIR029W",646).
component("YPR062W",1045).
component("YMR120C",853).
component("YLR028C",762).
component("YHR144C",611).
component("YHR144C",612).
component("YCL030C",296).
component("YNL141W",888).
component("YBL033C",223).
component("YBR153W",270).
component("YDL238C",358).
component("YNL141W",889).
component("YLR245C",791).
component("YML035C",823).
component("YGR204W",562).
component("YBR084W",256).
component("YJL126W",663).
component("U44_",158).
...
component("YEL042W",440).
component("YER005W",448).
component("YBL099W",233).
component("U60_",175).
component("YLR231C",788).
component("U88_",202).
component("YDR538W",432).
component("YLR134W",772).
component("YLR044C",764).
component("YGR087C",539).
component("YDR380W",412).
component("YDL080C",328).
component("U98_",210).
component("YMR250W",865).
component("YKL184W",733).
component("YOR128C",961).
component("YEL021W",437).
component("YNR043W",919).
component("U93_",207).
component("YDR047W",370).
component("U54_",168).
component("YKL211C",739).
component("YKR097W",753).
component("YOL052C",931).
component("YGR170W",549).
component("YKL060C",715).
component("YDR294C",401).
component("YEL046C",441).
component("YNR033W",916).
component("YPR006C",1038).
component("YER065C",463).
component("YKL211C",740).
component("YER090W",471).
component("YDR127W",384).
component("YPL281C",1036).
component("YOR393W",998).
component("YMR323W",876).
component("YHR174W",614).
component("YGR254W",569).
component("YPL262W",1029).
component("YGL026C",508).
component("YGR155W",547).
component("YLR304C",798).
component("YJL200C",677).
component("YGL009C",504).
component("YNL316C",908).
component("YKL182W",731).
component("YPL212C",1020).
component("YNL292W",906).
component("YGL063W",514).
component("YFL001W",482).
component("YOR278W",981).
component("U49_",163).
component("YCR053W",312).
component("YDR127W",385).
component("YGL148W",518).
component("YIL168W",644).
component("YIL167W",643).
component("YCL064C",302).
component("YCL064C",303).
component("YHR018C",586).
component("YLR359W",809).
component("YAL012W",213).
component("YFR055W",500).
component("YJL005W",651).
component("YOR176W",968).
component("YJL121C",662).
component("YBR019C",241).
component("YBR019C",242).
component("U59_",173).
component("YDR050C",371).
component("YIL020C",622).
component("YDR007W",361).
component("YOR095C",956).
component("YER003C",447).
component("YBR196C",275).
component("YGL001C",502).
component("YPL117C",1011).
component("U14_",69).
component("YOL056W",934).
component("YKL152C",727).
component("YDL021W",315).
component("YMR105C",848).
component("YKL127W",721).
component("YEL058W",444).
component("YMR278W",870).
component("YPR060C",1044).
component("YHR072W",599).
component("YJL153C",670).
component("YPL097W",1008).
component("YGR185C",555).
component("YGR264C",572).
component("YGR171C",550).
component("YHR011W",585).
component("YDR023W",364).
component("YPL104W",1009).
component("YLL018C",755).
component("YPR081C",1049).
component("YBR121C",263).
component("YHR020W",589).
component("YER087W",469).
component("YNL247W",896).
component("YOL033W",930).
component("YGL245W",527).
component("YOR168W",966).
component("YHR091C",601).
component("YDR341C",406).
component("YOL097C",941).
component("YDR268W",398).
component("YPR047W",1043).
component("YLR060W",767).
component("YFL022C",486).
component("YPR033C",1041).
component("YHR019C",587).
component("YHR019C",588).
component("YKL194C",736).
component("YIL078W",629).
component("YPL160W",1013).
component("YLR382C",811).
component("YPL040C",1004).
component("YBL076C",231).
component("YNL073W",883).
component("YDR037W",366).
component("YOR335C",986).
component("YGR094W",540).
component("YLR153C",776).
component("YAL054C",216).
component("YGR244C",567).
component("YPR035W",1042).
component("YIL145C",637).
component("U89_",203).
component("YOR241W",978).
component("YMR113W",850).
component("YKL132C",722).
component("YOR339C",987).
component("YMR022W",843).
component("YLR306W",800).
component("YKL210W",738).
component("YGR133W",545).
component("YGL058W",512).
component("YER100W",475).
component("YEL012W",435).
component("YDR177W",390).
component("YDR092W",378).
component("YDR059C",374).
component("YDR054C",372).
component("YDL064W",324).
...
component("U90_",205).
component("YNR057C",922).
component("YDL141W",342).
component("YDL141W",343).
component("YGL234W",526).
component("YDL141W",344).
component("YJR103W",695).
component("YBL039C",225).
component("YGR204W",563).
component("YNL220W",894).
component("YOL058W",935).
component("YDL141W",345).
component("YHR074W",600).
component("YMR217W",862).
component("YPR145W",1054).
component("YGR124W",543).
component("YOR303W",982).
component("YJR109C",698).
component("YJL130C",666).
component("YGL062W",513).
...
component("YDL164C",348).
component("YJL087C",658).
component("YOL010W",926).
component("YPR138C",1053).
component("YPL265W",1030).
component("YPL057C",1005).
component("YPL036W",1003).
component("YOR348C",991).
component("YOR192C",971).
component("YOR171C",967).
component("YOR130C",962).
component("YOR100C",957).
component("YOR071C",954).
component("YOR011W",950).
component("YOL156W",948).
component("YOL103W",942).
component("YOL020W",929).
component("YNR072W",924).
component("YNR056C",921).
component("YNL318C",909).
component("YNL270C",902).
component("YNL142W",890).
component("YMR272C",869).
component("YMR202W",859).
component("YMR056C",844).
component("YMR011W",840).
component("YML123C",836).
component("YLR348C",806).
component("YLR260W",793).
component("YLR237W",789).
component("YLR138W",773).
component("YLR100C",770).
component("YLR092W",769).
component("YLR081W",768).
component("YLL061W",758).
component("YLL043W",757).
component("YKR093W",752).
component("YKR053C",748).
component("YKR039W",747).
component("YKL217W",742).
component("YKL120W",720).
component("YKL004W",709).
component("YJR158W",706).
component("YJR095W",694).
component("YJR077C",692).
component("YJL219W",680).
component("YJL214W",678).
component("YJL134W",667).
component("YJL129C",664).
component("YIL134W",635).
component("YHR096C",604).
component("YHR094C",603).
component("YHR092C",602).
component("YHL036W",581).
component("YHL016C",579).
component("YGR191W",556).
component("YGR125W",544).
component("YGR121C",541).
component("YGR065C",538).
component("YGR055W",536).
component("YGL186C",520).
component("YGL008C",503).
component("YFL055W",490).
component("YFL011W",483).
component("YER060W-A",459).
component("YER060W",458).
component("YER056C",457).
component("YER053C",455).
component("YEL069C",446).
component("YEL063C",445).
component("YEL017C-A",436).
component("YDR536W",431).
component("YDR508C",427).
component("YDR503C",426).
component("YDR497C",424).
component("YDR345C",409).
component("YDR343C",408).
component("YDR342C",407).
component("YDR297W",403).
component("YDR294C",402).
component("YDR284C",400).
component("YDR046C",369).
component("YDL245C",359).
component("YDL210W",353).
component("YCR032W",309).
component("YCR028C",308).
component("YCR024C-A",307).
component("YCL025C",294).
component("YBR298C",290).
component("YBR294W",289).
component("YBR291C",288).
component("YBR132C",266).
