...
component("YGL001C",50).
component("YDR127W",35).
component("YNL009W",78).
component("YLR174W",71).
component("YJR078W",62).
component("YOR323C",87).
component("YBR166C",25).
component("YNL280C",80).
component("YMR145C",74).
component("YDL085W",31).
component("YPL231W",89).
component("YLR299W",73).
component("YDR354W",41).
component("YFR047C",49).
component("YPR069C",93).
component("YDR127W",36).
component("YDR035W",33).
component("YBR249C",26).
component("YHR137W",58).
component("YLR027C",70).
component("YKL106W",63).
component("YCR036W",28).
component("YMR208W",75).
component("YDR127W",37).
component("YDR226W",40).
component("YDR454C",43).
component("YOL061W",85).
component("YKL181W",64).
component("YHL011C",55).
component("YER099C",47).
component("YBL068W",21).
component("YHR044C",57).
component("YHR043C",56).
component("U53_",20).
component("YHR144C",59).
component("YBR111C",24).
component("YLR231C",72).
component("YDR380W",42).
component("YDL080C",30).
component("YMR250W",76).
component("YKL184W",65).
component("YKL211C",66).
component("YNR033W",82).
component("YKL211C",67).
component("YER090W",46).
component("YDR127W",38).
component("YPL281C",91).
component("YOR393W",88).
component("YMR323W",77).
component("YHR174W",60).
component("YGR254W",54).
component("YGL026C",51).
component("YNL316C",81).
component("YCR053W",29).
component("YDR127W",39).
component("YGL148W",52).
component("YDR007W",32).
component("YOR095C",86).
component("YPR060C",92).
component("YOL010W",83).
component("YPR138C",94).
component("YPL265W",90).
component("YOL020W",84).
component("YNL142W",79).
component("YKR053C",69).
component("YKR039W",68).
component("YJL134W",61).
component("YGR121C",53).
component("YFL055W",48).
component("YDR536W",45).
component("YDR508C",44).
component("YDR046C",34).
