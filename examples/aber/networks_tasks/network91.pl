...
component("YLR056W",445).
component("YKR009C",433).
component("YMR083W",494).
component("YPL231W",605).
component("YJR159W",411).
...
component("YJR139C",407).
component("YOR136W",566).
component("YNL009W",513).
component("YLR174W",457).
component("YDL066W",179).
component("YHR183W",353).
component("YGR256W",328).
component("YNL241C",528).
component("YOL059W",554).
component("YDL022W",174).
component("YCL018W",160).
component("YLR355C",470).
component("YML054C",479).
component("YIL155C",367).
component("YEL024W",245).
component("YJR078W",403).
component("U58_",92).
component("YGR255C",327).
component("YMR015C",491).
component("YDR402C",231).
component("YGL055W",292).
component("YJL026W",375).
component("YIL066C",363).
component("YGR180C",319).
component("YER070W",261).
component("U36_",80).
component("U35_",79).
component("YJR009C",394).
component("YJL052W",376).
component("YGR192C",321).
component("YOR374W",587).
component("YER073W",262).
component("U68_",96).
component("YGL154C",297).
component("U55_",90).
component("YER069W",260).
component("YOR323C",580).
component("U2_",74).
component("YBR221C",152).
component("YBR166C",148).
component("YNL280C",535).
component("YER014W",249).
component("YKL141W",420).
component("YJR051W",398).
component("YOR375C",588).
component("YDL215C",199).
component("YAL062W",115).
component("U100_",20).
component("YBR035C",133).
component("YMR189W",501).
component("U56_",91).
component("YPL023C",592).
component("YGL125W",295).
component("YOR236W",575).
component("YGR204W",324).
component("YBR084W",139).
component("YLR142W",451).
component("U65_",95).
component("U62_",94).
component("YHR068W",343).
component("YKL150W",422).
component("YIL043C",361).
component("YHR042W",338).
component("YOR221C",573).
component("YMR145C",499).
component("YML120C",485).
component("YKL192C",427).
component("YKL055C",414).
component("YER061C",256).
component("YDL085W",182).
component("YBR046C",135).
component("YPL017C",591).
component("YFL018C",275).
component("YPL091W",595).
component("YER042W",250).
component("YNL052W",515).
component("YMR256C",508).
component("YLR395C",473).
component("YLR038C",443).
component("YIL111W",365).
component("YHR051W",342).
component("YGL191W",300).
component("YGL187C",299).
component("YDL067C",180).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",611).
component("YPL273W",613).
component("YLL062C",440).
component("YDR410C",233).
component("YER091C",266).
component("YJR073C",401).
component("YDL033C",175).
component("YOL096C",557).
component("YLR172C",456).
component("YMR120C",498).
component("YBL013W",118).
component("YJL130C",384).
component("YJL088W",379).
component("YPR074C",623).
component("YBR117C",143).
component("YMR108W",496).
component("YCL009C",159).
component("YMR062C",493).
component("YNL071W",516).
component("YIL160C",369).
component("YNR019W",542).
component("YCR048W",171).
component("U48_",85).
component("YNL277W",533).
component("YFL017C",274).
component("YPL231W",606).
component("YER061C",257).
component("U86_",108).
component("YDL052C",177).
component("U8_",110).
component("YDR148C",220).
component("YOR377W",589).
component("YGR177C",318).
component("YPL231W",607).
component("YLR195C",459).
component("YLR299W",464).
component("YPR001W",615).
component("YNR001C",538).
component("YCR005C",167).
component("YML126C",487).
component("YDL182W",196).
component("YDL131W",188).
component("YNL117W",520).
component("YIR031C",373).
component("YOR321W",579).
component("YJR143C",408).
component("YGR199W",323).
component("YDL095W",184).
component("YDL093W",183).
component("YAL023C",114).
component("YPL227C",603).
component("YMR261C",509).
component("YML100W",484).
component("YBR126C",145).
component("YNL192W",527).
component("YBR038W",134).
component("YBR023C",131).
component("YLR209C",460).
component("U104_",23).
component("YDR354W",227).
component("YFR047C",283).
component("YJR133W",406).
component("U22_",69).
component("YDR399W",229).
component("YJL167W",391).
component("YNL256W",530).
component("YPR069C",622).
component("YDR127W",215).
component("YHR190W",354).
component("YHR068W",344).
component("YLR303W",465).
component("YML082W",483).
component("YJR130C",405).
component("YDR035W",204).
component("YBR249C",153).
component("YLR180W",458).
component("YDR502C",238).
component("YBR256C",155).
component("YHR137W",348).
component("YGL202W",301).
component("YLR027C",441).
component("YKL106W",417).
component("YOL140W",560).
component("YLR438W",477).
component("YKL104C",416).
component("YGR019W",306).
component("YDR111C",212).
component("U51_",88).
component("YJR148W",409).
component("YHR208W",357).
component("YOR184W",570).
component("YGL253W",305).
component("YFR053C",284).
component("YMR013C",490).
component("YLR240W",462).
component("YKL203C",429).
component("YJR066W",400).
component("YCR036W",170).
component("YGR194C",322).
component("YCL040W",164).
component("YJR105W",404).
component("U16_",47).
component("YKL001C",412).
component("YML070W",482).
component("YFL053W",278).
component("YDR531W",241).
component("U82_",107).
component("U81_",106).
component("YMR208W",503).
component("YPL203W",602).
component("YOR061W",561).
component("YKL166C",423).
component("YJL164C",390).
component("YIL035C",360).
component("YHR205W",356).
component("YHR102W",346).
component("YGL019W",288).
component("YHR025W",337).
component("YNR012W",540).
component("YPR121W",625).
component("YPL258C",609).
component("YOL055C",552).
component("U1_",59).
component("YBR020W",130).
component("YFR019W",281).
component("YDR208W",222).
component("YDR127W",216).
component("U21_",66).
component("YDR147W",219).
component("YCR012W",168).
component("YER052C",252).
component("U19_",58).
component("U18_",54).
component("U17_",51).
component("U76_",103).
component("YMR220W",505).
component("YER170W",272).
component("YDR226W",223).
component("YKL067W",415).
component("YOL055C",553).
component("YDR454C",236).
component("YOL061W",555).
component("YKL181W",424).
component("YHL011C",331).
component("YER099C",268).
component("YBL068W",124).
component("YOR143C",567).
component("YNL256W",531).
component("YBR018C",128).
component("YDL055C",178).
component("YLR328W",468).
component("YDL103C",186).
component("U94_",112).
component("YJR010W",395).
component("YBR029C",132).
component("YPR190C",630).
component("YPR187W",629).
component("YPR110C",624).
component("YPR010C",617).
component("YOR341W",584).
component("YOR340C",583).
component("YOR224C",574).
component("YOR210W",572).
component("YOR207C",571).
component("YOR151C",568).
component("YOR116C",563).
component("YOL005C",547).
component("YNR003C",539).
component("YNL248C",529).
component("YNL151C",525).
component("YNL113W",519).
component("YKL144C",421).
component("YJR063W",399).
component("YJL148W",387).
component("YJL140W",386).
...
component("YPR175W",628).
component("YPL167C",600).
component("YOR330C",581).
component("YOL115W",559).
component("YNL299W",536).
component("YNL262W",532).
component("YNL102W",518).
component("YJR043C",397).
component("YJR006W",393).
component("YJL090C",380).
...
component("YKL035W",413).
component("YHL012W",332).
component("YHR123W",347).
component("YNL130C",521).
component("YPL148C",598).
component("YOR251C",577).
component("YGR286C",330).
component("YDR058C",208).
component("YOL011W",549).
component("YMR008C",489).
component("YMR006C",488).
component("U105_",24).
component("U101_",21).
component("YJL068C",377).
component("YPL072W",594).
component("YOR124C",564).
component("YNL186W",526).
component("YMR304W",511).
component("YMR223W",506).
component("YKR098C",438).
component("YJL197W",392).
component("YIL156W",368).
component("YFR010W",280).
component("YER151C",271).
component("YER144C",270).
component("YER098W",267).
component("YDR069C",209).
component("YDL122W",187).
component("YBR058C",136).
component("YBL067C",123).
component("YJR019C",396).
component("YDR074W",210).
component("YFR025C",282).
component("YPL179W",601).
component("YNR032W",543).
component("YML057W",481).
component("YML016C",478).
component("YLR433C",476).
component("YGR123C",313).
component("YER133W",269).
component("YER089C",264).
...
component("YIL053W",362).
component("YER062C",258).
component("YHR046C",341).
component("U9_",113).
component("YGR208W",325).
component("YPL228W",604).
component("YMR180C",500).
component("YJL155C",389).
component("U34_",78).
component("U33_",77).
component("U32_",76).
component("U30_",75).
...
component("U26_",71).
component("U24_",70).
component("YHR044C",340).
component("YHR043C",339).
component("YOL064C",556).
component("YPL268W",612).
component("YOR360C",586).
component("YGL248W",304).
component("YKR031C",434).
component("YGL027C",290).
component("YLR286C",463).
component("YJR153W",410).
component("YBR184W",149).
component("YIL162W",370).
component("YPR026W",618).
component("YDR001C",201).
component("YBR001C",127).
component("YDR400W",230).
component("U102_",22).
component("YER043C",251).
component("YNL045W",514).
component("YLR160C",455).
component("YLR158C",454).
component("YLR157C",453).
component("YLR155C",452).
component("YDR321W",226).
component("YGL037C",291).
component("U43_",83).
component("U42_",82).
component("YLR308W",467).
component("YLR307W",466).
component("U53_",89).
component("YLR420W",474).
component("YPL111W",596).
component("YIR032C",374).
...
component("YLR231C",461).
component("U88_",109).
component("YDR538W",243).
component("YLR134W",449).
component("YLR044C",444).
component("YGR087C",310).
component("YDR380W",228).
component("YDL080C",181).
component("YMR250W",507).
component("YKL184W",426).
component("YEL021W",244).
component("YNR043W",545).
component("YKL211C",430).
component("YKR097W",437).
component("YOL052C",551).
component("YDR294C",224).
component("YNR033W",544).
component("YPR006C",616).
component("YER065C",259).
component("YKL211C",431).
component("YER090W",265).
component("YDR127W",217).
component("YPL281C",614).
component("YOR393W",590).
component("YMR323W",512).
component("YHR174W",352).
component("YGR254W",326).
component("YGL026C",289).
component("YGR155W",316).
component("YNL316C",537).
component("YCR053W",172).
component("YDR127W",218).
component("YGL148W",296).
component("YIL168W",372).
component("YIL167W",371).
component("YCL064C",165).
component("YCL064C",166).
component("YLR359W",471).
component("YFR055W",285).
component("YJL121C",381).
component("YBR019C",129).
component("YDR007W",202).
component("YOR095C",562).
component("YBR196C",150).
component("YGL001C",287).
component("YPL117C",597).
component("U14_",39).
component("YMR105C",495).
component("YKL127W",418).
component("YEL058W",247).
component("YPR060C",621).
component("YHR072W",345).
component("YJL153C",388).
component("YGR264C",329).
component("YGR171C",317).
component("YHR011W",334).
component("YDR023W",203).
component("YHR020W",336).
component("YER087W",263).
component("YGL245W",303).
component("YOR168W",569).
component("YPR047W",620).
component("YLR060W",446).
component("YFL022C",276).
component("YPR033C",619).
component("YHR019C",335).
component("YKL194C",428).
component("YIL078W",364).
component("YPL160W",599).
component("YLR382C",472).
component("YPL040C",593).
component("YBL076C",125).
component("YNL073W",517).
component("YDR037W",205).
component("YOR335C",582).
component("YGR094W",311).
component("YOR241W",576).
component("YMR113W",497).
component("YKL132C",419).
component("YGL234W",302).
component("YER183C",273).
component("U90_",111).
component("YNR057C",546).
component("YDL141W",191).
component("YDL141W",192).
component("YDL141W",193).
component("YDL141W",194).
component("YMR217W",504).
component("YPR145W",627).
component("YGR124W",314).
component("YOR303W",578).
component("YGL062W",293).
component("YBR218C",151).
component("YPL231W",608).
component("YNR016C",541).
component("YKL182W",425).
component("YGR037C",307).
component("YJL087C",378).
component("YOL010W",548).
component("YPR138C",626).
component("YPL265W",610).
component("YOR348C",585).
component("YOR130C",565).
component("YOL103W",558).
component("YOL020W",550).
component("YNL142W",524).
component("YMR272C",510).
component("YMR202W",502).
component("YMR056C",492).
component("YML123C",486).
component("YLR348C",469).
component("YLR138W",450).
component("YLR100C",448).
component("YLR092W",447).
component("YLL061W",439).
component("YKR053C",436).
component("YKR039W",435).
component("YKL217W",432).
component("YJR077C",402).
component("YJL134W",385).
component("YJL129C",383).
component("YHL036W",333).
component("YGR191W",320).
component("YGR125W",315).
