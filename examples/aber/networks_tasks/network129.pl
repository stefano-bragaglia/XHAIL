...
component("YNL280C",687).
component("YLR056W",582).
component("YKR009C",563).
component("YMR083W",644).
component("YPL231W",778).
component("U46_",119).
component("YBR149W",197).
component("YBR149W",198).
component("YJR159W",534).
component("YGL001C",373).
component("YHR063C",449).
component("YML056C",629).
component("YLR432W",622).
component("YHR216W",467).
component("YAR075W",162).
component("YAR073W",161).
component("YCL030C",219).
component("YDR127W",282).
component("YJR139C",530).
component("YOR136W",731).
component("YNL009W",666).
component("YLR174W",596).
component("YDL066W",239).
component("YHR183W",461).
component("YGR256W",430).
component("YNL241C",681).
component("YOL059W",712).
component("YDL022W",233).
component("YCL018W",217).
component("YLR355C",616).
component("YIL074C",473).
component("YER081W",346).
component("YML054C",628).
component("YIL155C",478).
component("YEL024W",325).
component("YKR066C",568).
component("YKL026C",536).
component("YIR037W",488).
component("YBR244W",206).
component("YJR078W",524).
component("U58_",129).
component("U107_",26).
component("YGR255C",429).
component("U108_",27).
component("YMR015C",641).
component("YDR402C",307).
component("YGL055W",381).
component("YJL026W",489).
component("YIL066C",472).
component("YGR180C",416).
component("YER070W",344).
component("U37_",111).
component("U36_",110).
component("U35_",109).
component("YDR158W",290).
component("YJR009C",514).
component("YJL052W",490).
component("YGR192C",418).
component("YOR374W",755).
component("YER073W",345).
component("U68_",135).
component("YGL154C",388).
component("U55_",126).
component("YER069W",343).
component("YOR323C",748).
component("U2_",104).
component("YBR221C",205).
component("YBR166C",201).
component("YNL280C",688).
component("YGL012W",376).
...
component("YGL205W",393).
component("YKL141W",545).
component("YJR051W",519).
component("YEL047C",328).
component("YDL171C",259).
component("YOR375C",756).
component("YDL215C",263).
component("YAL062W",160).
component("U100_",20).
component("YBR035C",181).
component("YMR189W",652).
component("U56_",127).
component("YKR080W",570).
component("YPL023C",761).
component("YGL125W",385).
component("YOR236W",743).
component("YGR204W",422).
component("YBR084W",187).
component("YLR142W",590).
component("U65_",133).
component("U62_",131).
component("YHR068W",450).
component("YKL150W",547).
component("YIL043C",470).
component("YHR042W",444).
component("YOR221C",741).
component("YMR145C",649).
component("YML120C",634).
component("YKL192C",555).
component("YKL055C",538).
component("YER061C",339).
component("YDL085W",242).
component("YBR046C",183).
component("YMR145C",650).
component("YML120C",635).
component("YKL192C",556).
component("YDL085W",243).
component("YPL017C",760).
component("YFL018C",361).
component("YPL091W",764).
component("YER042W",333).
component("YPR167C",806).
component("YNL052W",668).
component("YMR256C",660).
component("YLR395C",620).
component("YLR038C",580).
component("YIL111W",475).
component("YHR051W",448).
component("YGL191W",391).
component("YGL187C",390).
component("YDL067C",240).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",785).
component("YBR034C",180).
component("YPL273W",787).
component("YLL062C",576).
component("YDR410C",310).
component("YKR069W",569).
component("YOL096C",715).
component("U47_",120).
component("YER091C",350).
component("YJR073C",522).
component("YML008C",625).
component("YDL033C",235).
component("YOL096C",716).
component("YLR172C",595).
component("YBR263W",210).
component("YDR408C",309).
component("YMR120C",648).
component("YLR028C",578).
component("YBL013W",163).
component("YJL130C",498).
component("YJL088W",493).
component("YPR074C",799).
component("YBR117C",193).
component("YLR354C",615).
component("YGR043C",403).
component("YMR108W",646).
component("YCL009C",216).
component("YMR062C",643).
component("YNL071W",669).
component("YIL160C",481).
component("YNR019W",697).
component("YCR048W",230).
component("U48_",121).
component("YNL277W",686).
component("YDR232W",293).
component("YFL017C",360).
component("YPL231W",779).
component("YER061C",340).
component("U86_",151).
component("YPL001W",759).
component("YDL052C",237).
component("U8_",154).
component("YDR148C",288).
component("YOR377W",757).
component("YGR177C",415).
component("YPL231W",780).
component("YLR195C",598).
component("YLR299W",607).
component("YPR001W",789).
component("YNR001C",693).
component("YCR005C",226).
component("YML126C",637).
component("YDL182W",260).
component("YDL131W",250).
component("YNL117W",673).
component("YIR031C",486).
component("YPR160W",805).
component("YOR321W",747).
component("YJR143C",531).
component("YGR199W",420).
component("YDL095W",245).
component("YDL093W",244).
component("YAL023C",159).
component("YLR258W",604).
component("YFR015C",367).
component("YPL227C",776).
component("YMR261C",661).
component("YML100W",633).
component("YBR126C",196).
component("YNL192W",680).
component("YBR038W",182).
component("YBR023C",178).
component("YEL011W",323).
component("YLR209C",599).
component("U104_",24).
component("U103_",23).
component("YOR209C",739).
component("YMR300C",663).
component("YDR354W",303).
component("YFR047C",370).
component("YJR133W",529).
component("U22_",98).
component("YLR209C",600).
component("YDR399W",305).
component("YJL167W",506).
component("YJL167W",507).
component("YNL256W",683).
component("YPR069C",797).
component("YDR127W",283).
component("YHR190W",462).
component("YHR068W",451).
component("YLR303W",608).
component("YGR012W",400).
component("YML082W",632).
component("YJR130C",528).
component("YDR035W",270).
component("YBR249C",207).
component("YLR180W",597).
component("YDR502C",316).
component("YOL143C",721).
component("YBR256C",209).
component("YHR137W",456).
component("YGL202W",392).
component("YLR027C",577).
component("YKL106W",541).
component("YOL140W",720).
component("YLR438W",624).
component("YKL104C",540).
component("YGR019W",401).
component("YDR111C",280).
component("U64_",132).
component("U51_",124).
component("YJR148W",532).
component("YHR208W",465).
component("YOR184W",736).
component("YNR058W",702).
component("YGL253W",398).
component("YFR053C",371).
component("YMR013C",640).
component("YMR205C",654).
component("YGR240C",426).
component("YLR240W",603).
component("YKL203C",558).
component("YJR066W",521).
component("YCR036W",229).
component("YGR194C",419).
component("YCL040W",222).
component("YJR105W",526).
component("U16_",67).
component("YPL188W",772).
component("YJR049C",518).
component("YEL041W",326).
component("YKL001C",535).
component("YDR236C",294).
component("YML070W",631).
component("YFL053W",364).
component("YLR133W",587).
component("YDR531W",320).
component("U83_",148).
component("U82_",147).
component("U81_",146).
component("YMR208W",655).
component("YPL203W",773).
component("YOR061W",725).
component("YKL166C",549).
component("YJL164C",505).
component("YIL035C",469).
component("YHR205W",464).
component("YHR102W",454).
component("YGL019W",377).
component("YHR025W",443).
component("YNR012W",695).
component("YPR121W",802).
component("YPL258C",782).
component("YOL055C",709).
component("YPL214C",775).
component("U1_",84).
component("YDR009W",268).
component("YBR020W",177).
component("YFR019W",368).
component("YDR208W",291).
component("YDR127W",284).
component("U21_",93).
component("U20_",89).
component("YDR147W",287).
component("YDR300C",301).
component("YCR012W",227).
component("YER052C",335).
component("U19_",83).
component("U18_",77).
component("U17_",72).
component("U76_",143).
component("YMR220W",657).
component("YER170W",356).
component("YDR226W",292).
component("YKL067W",539).
component("YOL055C",710).
component("YDR454C",313).
component("YOL061W",713).
component("YKL181W",550).
component("YHL011C",435).
component("YER099C",352).
component("YBL068W",169).
component("YOR143C",732).
component("YNL256W",684).
component("YLR328W",612).
component("YBR018C",174).
component("YBR018C",175).
component("YDL055C",238).
component("YGR007W",399).
component("YGR202C",421).
component("YLR328W",613).
component("YDL103C",248).
component("U94_",157).
component("YJR010W",515).
component("YBR029C",179).
component("YGL130W",386).
component("YDR530C",319).
component("YCL050C",223).
component("YPR190C",809).
component("YPR187W",808).
component("YPR110C",801).
component("YPR010C",791).
component("YOR341W",752).
component("YOR340C",751).
component("YOR224C",742).
component("YOR210W",740).
component("YOR207C",738).
component("YOR151C",733).
component("YOR116C",728).
component("YOL005C",703).
component("YNR003C",694).
component("YNL248C",682).
component("YNL151C",678).
component("YNL113W",672).
component("YKL144C",546).
component("YJR063W",520).
component("YJL148W",502).
component("YJL140W",501).
component("YIL021W",468).
component("YHR143W-A",457).
component("YGL070C",384).
component("YFL036W",363).
component("YDR404C",308).
component("YDR156W",289).
component("YDR045C",273).
component("YDL150W",257).
component("YDL140C",252).
component("YBR154C",200).
component("YPR175W",807).
component("YPL167C",770).
component("YOR330C",749).
component("YOL115W",719).
component("YNL299W",690).
component("YNL262W",685).
component("YNL102W",671).
component("YJR043C",517).
component("YJR006W",513).
component("YJL090C",494).
component("YIL139C",476).
component("YEL055C",329).
component("YDR419W",311).
component("YDR121W",281).
component("YDL102W",247).
component("YCR014C",228).
component("YBR278W",211).
component("YBL035C",165).
component("YKL035W",537).
component("YHL012W",436).
component("YHR123W",455).
component("YNL130C",674).
component("YPL148C",768).
component("YOR251C",745).
...
component("YPL072W",763).
component("YOR124C",729).
component("YNL186W",679).
component("YMR304W",664).
component("YMR223W",658).
component("YKR098C",573).
component("YJL197W",508).
component("YIL156W",479).
component("YFR010W",366).
component("YER151C",355).
component("YER144C",354).
component("YER098W",351).
component("YDR069C",277).
component("YDL122W",249).
component("YBR058C",184).
component("YBL067C",168).
component("YJR019C",516).
component("YDR272W",297).
component("U84_",149).
component("YDR481C",314).
component("YLR377C",618).
component("YDR074W",278).
component("YFR025C",369).
component("YPL179W",771).
component("YNR032W",698).
component("YML057W",630).
component("YML016C",626).
component("YLR433C",623).
component("YGR123C",409).
component("YER133W",353).
component("YER089C",348).
component("YDR436W",312).
component("YDR075W",279).
component("YDL188C",261).
component("YDL134C",251).
component("YDL047W",236).
component("YDL006W",232).
component("YBR125C",195).
component("YBL056W",167).
component("YPR073C",798).
component("YHR215W",466).
component("YDL024C",234).
component("YBR093C",191).
component("YBR092C",190).
component("YIL053W",471).
component("YER062C",341).
component("YHR046C",447).
component("U9_",158).
component("YGR208W",425).
component("YPL228W",777).
component("YMR180C",651).
component("YDL236W",264).
component("YJL155C",504).
component("U34_",108).
component("U33_",107).
component("U32_",106).
component("U30_",105).
...
component("YPL268W",786).
component("YOR360C",754).
component("YGL248W",397).
component("YKR031C",565).
component("YGL027C",379).
component("YLR286C",606).
component("YJR153W",533).
component("YJL221C",512).
component("YJL216C",510).
component("YIL172C",485).
component("YGR292W",434).
component("YGR287C",433).
component("YBR299W",215).
component("YBR184W",202).
component("YIL162W",482).
component("YPR026W",792).
component("YDR001C",266).
component("YBR001C",172).
component("YDR400W",306).
component("U102_",22).
component("YER043C",334).
component("YNL045W",667).
component("YLR160C",594).
component("YLR158C",593).
component("YLR157C",592).
component("YLR155C",591).
component("YDR321W",302).
component("YGL037C",380).
component("U43_",117).
component("U42_",116).
component("YDR242W",295).
component("YLR308W",611).
component("YLR307W",610).
component("U53_",125).
component("YLR420W",621).
component("YPL111W",766).
component("YIR032C",487).
component("YLR028C",579).
component("YHR144C",458).
component("YHR144C",459).
component("YCL030C",220).
component("YNL141W",675).
...
component("U40_",114).
component("U39_",112).
component("YBR011C",173).
component("YHR201C",463).
component("YBR111C",192).
component("YBR252W",208).
component("YCL030C",221).
component("YER005W",331).
component("YBL099W",171).
component("YLR231C",601).
component("U88_",152).
component("YDR538W",322).
component("YLR134W",588).
component("YLR044C",581).
component("YGR087C",406).
component("YDR380W",304).
component("YDL080C",241).
component("YMR250W",659).
component("YKL184W",554).
component("YEL021W",324).
component("YNR043W",700).
component("U93_",156).
component("YDR047W",275).
component("YKL211C",559).
component("YKR097W",572).
component("YOL052C",708).
component("YGR170W",413).
component("YDR294C",298).
component("YEL046C",327).
component("YNR033W",699).
component("YPR006C",790).
component("YER065C",342).
component("YKL211C",560).
component("YER090W",349).
component("YDR127W",285).
component("YPL281C",788).
component("YOR393W",758).
component("YMR323W",665).
component("YHR174W",460).
component("YGR254W",428).
component("YPL262W",783).
component("YGL026C",378).
component("YGR155W",412).
component("YLR304C",609).
component("YJL200C",509).
component("YGL009C",375).
component("YNL316C",691).
component("YKL182W",552).
component("YPL212C",774).
component("YNL292W",689).
component("YGL063W",383).
component("YFL001W",358).
component("YCR053W",231).
component("YDR127W",286).
component("YGL148W",387).
component("YIL168W",484).
component("YIL167W",483).
component("YCL064C",224).
component("YCL064C",225).
component("YHR018C",439).
component("YLR359W",617).
component("YFR055W",372).
component("YJL121C",495).
component("YBR019C",176).
component("YDR007W",267).
component("YOR095C",727).
component("YBR196C",203).
component("YGL001C",374).
component("YPL117C",767).
component("U14_",55).
component("YKL152C",548).
component("YMR105C",645).
component("YKL127W",543).
component("YEL058W",330).
component("YPR060C",796).
component("YHR072W",452).
component("YJL153C",503).
component("YGR264C",431).
component("YGR171C",414).
component("YHR011W",438).
component("YDR023W",269).
component("YPL104W",765).
component("YLL018C",574).
component("YPR081C",800).
component("YBR121C",194).
component("YHR020W",442).
component("YER087W",347).
component("YOL033W",707).
component("YGL245W",396).
component("YOR168W",734).
component("YOL097C",717).
component("YDR268W",296).
component("YPR047W",795).
component("YLR060W",583).
component("YFL022C",362).
component("YPR033C",793).
component("YHR019C",440).
component("YHR019C",441).
component("YKL194C",557).
component("YIL078W",474).
component("YPL160W",769).
component("YLR382C",619).
component("YPL040C",762).
component("YBL076C",170).
component("YNL073W",670).
component("YDR037W",271).
component("YOR335C",750).
component("YGR094W",407).
component("YGR244C",427).
component("YPR035W",794).
component("YIL145C",477).
component("U89_",153).
component("YOR241W",744).
component("YMR113W",647).
component("YKL132C",544).
component("YGL234W",394).
component("YER183C",357).
component("U90_",155).
component("YNR057C",701).
component("YDL141W",253).
component("YDL141W",254).
component("YGL234W",395).
component("YDL141W",255).
component("YGR204W",424).
component("YOL058W",711).
component("YDL141W",256).
component("YHR074W",453).
component("YMR217W",656).
component("YPR145W",804).
component("YGR124W",410).
component("YOR303W",746).
component("YJR109C",527).
component("YJL130C",499).
component("YGL062W",382).
component("YBR218C",204).
component("YPL231W",781).
component("YNR016C",696).
component("YKL182W",553).
component("YGR037C",402).
component("YOR005C",723).
component("YDL164C",258).
component("YJL087C",492).
component("YOL010W",704).
component("YPR138C",803).
component("YPL265W",784).
component("YOR348C",753).
component("YOR192C",737).
component("YOR171C",735).
component("YOR130C",730).
component("YOR071C",726).
component("YOR011W",724).
component("YOL156W",722).
component("YOL103W",718).
component("YOL020W",706).
component("YNL318C",692).
component("YNL142W",677).
component("YMR272C",662).
component("YMR202W",653).
component("YMR056C",642).
component("YML123C",636).
component("YLR348C",614).
component("YLR260W",605).
component("YLR237W",602).
component("YLR138W",589).
component("YLR100C",586).
component("YLR092W",585).
component("YLR081W",584).
component("YLL061W",575).
component("YKR093W",571).
component("YKR053C",567).
component("YKR039W",566).
component("YKL217W",562).
component("YKL120W",542).
component("YJR095W",525).
component("YJR077C",523).
component("YJL219W",511).
component("YJL134W",500).
component("YJL129C",497).
component("YHL036W",437).
component("YGR191W",417).
component("YGR125W",411).
component("YGR121C",408).
component("YGR065C",405).
component("YGR055W",404).
component("YGL186C",389).
component("YFL055W",365).
component("YFL011W",359).
component("YER060W-A",338).
component("YER060W",337).
component("YER056C",336).
component("YDR536W",321).
component("YDR508C",318).
component("YDR503C",317).
component("YDR497C",315).
component("YDR297W",300).
component("YDR294C",299).
component("YDR046C",274).
component("YDL210W",262).
component("YCL025C",218).
component("YBR298C",214).
component("YBR294W",213).
component("YBR291C",212).
component("YBR085W",189).
component("YBR069C",186).
component("YBR068C",185).
component("YBL042C",166).
component("YBL030C",164).
component("U85_",150).
component("U7_",145).
component("U79_",144).
component("U75_",142).
