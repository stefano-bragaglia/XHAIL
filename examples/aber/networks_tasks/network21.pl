...
component("YNL280C",191).
component("YLR056W",165).
component("YGL001C",114).
component("YDR127W",81).
component("YNL009W",183).
component("YLR174W",168).
component("YHR183W",138).
component("YGR256W",128).
component("YCL018W",59).
component("YJR078W",150).
component("YMR015C",175).
component("YGL055W",117).
component("YOR323C",204).
component("YBR166C",55).
component("YNL280C",192).
component("YKL141W",155).
component("YOR375C",207).
component("YAL062W",43).
component("U100_",18).
component("YMR145C",176).
component("YDL085W",67).
component("YBR046C",48).
component("YDR410C",91).
component("YJL088W",143).
component("YPR074C",218).
component("YBR117C",53).
component("YNL071W",184).
component("YNR019W",195).
component("YCR048W",64).
component("U48_",36).
component("YPL231W",211).
component("YPL231W",212).
component("YLR299W",170).
component("YCR005C",61).
component("YNL117W",186).
component("YIR031C",141).
component("YOR321W",203).
component("YJR143C",153).
component("YGR199W",126).
component("YDL095W",69).
component("YDL093W",68).
component("YAL023C",42).
component("YDR354W",88).
component("YFR047C",112).
component("U22_",32).
component("YDR399W",90).
component("YPR069C",217).
component("YDR127W",82).
component("YML082W",173).
component("YJR130C",152).
component("YDR035W",77).
component("YBR249C",57).
component("YHR137W",135).
component("YGL202W",120).
component("YLR027C",163).
component("YKL106W",154).
component("YLR438W",172).
component("U51_",37).
component("YMR013C",174).
component("YCR036W",63).
component("YJR105W",151).
component("YMR208W",178).
component("YHR025W",131).
component("YFR019W",111).
component("YDR208W",86).
component("YDR127W",83).
component("YER052C",98).
component("U19_",28).
component("U76_",41).
component("YDR226W",87).
component("YDR454C",93).
component("YOL061W",199).
component("YKL181W",156).
component("YHL011C",130).
component("YER099C",104).
component("YBL068W",47).
component("YLR328W",171).
component("YPR175W",221).
component("YPL167C",210).
component("YOR330C",205).
component("YOL115W",200).
component("YNL299W",193).
component("YNL262W",190).
component("YNL102W",185).
component("YJR043C",148).
component("YJR006W",147).
component("YJL090C",144).
component("YIL139C",139).
component("YEL055C",96).
component("YDR419W",92).
component("YDR121W",80).
component("YDL102W",70).
component("YCR014C",62).
component("YBR278W",58).
component("YBL035C",44).
component("YPL072W",209).
component("YOR124C",202).
component("YNL186W",189).
component("YMR304W",181).
component("YMR223W",179).
component("YKR098C",162).
component("YJL197W",146).
component("YIL156W",140).
component("YFR010W",110).
component("YER151C",106).
component("YER144C",105).
component("YER098W",103).
component("YDR069C",79).
component("YDL122W",71).
component("YBR058C",49).
component("YBL067C",46).
component("U32_",34).
component("U30_",33).
component("YHR044C",133).
component("YHR043C",132).
component("YGL037C",116).
component("U53_",38).
component("YHR144C",136).
component("YBR153W",54).
component("YDL238C",75).
component("YNL141W",187).
component("U44_",35).
component("YBR111C",52).
component("YER005W",97).
component("YLR231C",169).
component("YLR134W",167).
component("YLR044C",164).
component("YGR087C",122).
component("YDR380W",89).
component("YDL080C",66).
component("YMR250W",180).
component("YKL184W",157).
component("YKL211C",158).
component("YNR033W",196).
component("YKL211C",159).
component("YER090W",102).
component("YDR127W",84).
component("YPL281C",214).
component("YOR393W",208).
component("YMR323W",182).
component("YHR174W",137).
component("YGR254W",127).
component("YGL026C",115).
component("YNL316C",194).
component("YCR053W",65).
component("YDR127W",85).
component("YGL148W",118).
component("YFR055W",113).
component("YDR007W",76).
component("YOR095C",201).
component("YBR196C",56).
component("YPR060C",216).
component("YHR072W",134).
component("YGR264C",129).
component("YGR171C",125).
component("YGL245W",121).
component("YPR047W",215).
component("YLR060W",166).
component("YFL022C",108).
component("YER183C",107).
component("YDL141W",72).
component("YDL141W",73).
component("YPR145W",220).
component("YGR124W",124).
component("YJL087C",142).
component("YOL010W",197).
component("YPR138C",219).
component("YPL265W",213).
component("YOR348C",206).
component("YOL020W",198).
component("YNL142W",188).
component("YMR202W",177).
component("YKR053C",161).
component("YKR039W",160).
component("YJR077C",149).
component("YJL134W",145).
component("YGR121C",123).
component("YGL186C",119).
component("YFL055W",109).
component("YER060W-A",101).
component("YER060W",100).
component("YER056C",99).
component("YDR536W",95).
component("YDR508C",94).
component("YDR046C",78).
component("YDL210W",74).
component("YCL025C",60).
component("YBR069C",51).
component("YBR068C",50).
component("YBL042C",45).
component("U6_",40).
component("U5_",39).
component("U228_",31).
component("U222_",30).
