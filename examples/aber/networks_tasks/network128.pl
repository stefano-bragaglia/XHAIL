...
component("YLR056W",578).
component("YKR009C",559).
component("YMR083W",639).
component("YPL231W",773).
component("U46_",119).
component("YBR149W",196).
component("YBR149W",197).
component("YJR159W",530).
component("YGL001C",371).
component("YHR063C",445).
component("YML056C",624).
component("YLR432W",617).
component("YHR216W",463).
component("YAR075W",161).
component("YAR073W",160).
component("YCL030C",218).
component("YDR127W",281).
component("YJR139C",526).
component("YOR136W",726).
component("YNL009W",661).
component("YLR174W",591).
component("YDL066W",238).
component("YHR183W",457).
component("YGR256W",426).
component("YNL241C",676).
component("YOL059W",707).
component("YDL022W",232).
component("YCL018W",216).
component("YLR355C",611).
component("YIL074C",469).
component("YER081W",344).
component("YML054C",623).
component("YIL155C",474).
component("YEL024W",323).
component("YKR066C",564).
component("YKL026C",532).
component("YIR037W",484).
component("YBR244W",205).
component("YJR078W",520).
component("U58_",129).
component("U107_",26).
component("YGR255C",425).
component("U108_",27).
component("YMR015C",636).
component("YDR402C",305).
component("YGL055W",379).
component("YJL026W",485).
component("YIL066C",468).
component("YGR180C",413).
component("YER070W",342).
component("U37_",111).
component("U36_",110).
component("U35_",109).
component("YDR158W",289).
component("YJR009C",510).
component("YJL052W",486).
component("YGR192C",415).
component("YOR374W",750).
component("YER073W",343).
component("U68_",135).
component("YGL154C",386).
component("U55_",126).
...
component("YNL280C",683).
component("YGL012W",374).
component("YKL182W",547).
component("U57_",128).
component("YKL216W",557).
component("YDR044W",271).
component("YER014W",330).
component("YKR009C",560).
component("YIL160C",476).
component("YGL205W",391).
component("YKL141W",541).
component("YJR051W",515).
component("YEL047C",326).
component("YDL171C",258).
component("YOR375C",751).
component("YDL215C",262).
component("YAL062W",159).
component("U100_",20).
component("YBR035C",180).
component("YMR189W",647).
component("U56_",127).
component("YKR080W",566).
component("YPL023C",756).
component("YGL125W",383).
component("YOR236W",738).
component("YGR204W",419).
component("YBR084W",186).
component("YLR142W",585).
component("U65_",133).
component("U62_",131).
component("YHR068W",446).
component("YKL150W",543).
component("YIL043C",466).
component("YHR042W",440).
component("YOR221C",736).
component("YMR145C",644).
component("YML120C",629).
component("YKL192C",551).
component("YKL055C",534).
component("YER061C",337).
component("YDL085W",241).
component("YBR046C",182).
component("YMR145C",645).
component("YML120C",630).
component("YKL192C",552).
component("YDL085W",242).
component("YPL017C",755).
component("YFL018C",359).
component("YPL091W",759).
component("YER042W",331).
component("YPR167C",801).
component("YNL052W",663).
component("YMR256C",655).
component("YLR395C",615).
component("YLR038C",576).
component("YIL111W",471).
component("YHR051W",444).
component("YGL191W",389).
component("YGL187C",388).
component("YDL067C",239).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",780).
component("YBR034C",179).
component("YPL273W",782).
component("YLL062C",572).
component("YDR410C",308).
component("YKR069W",565).
component("YOL096C",710).
component("U47_",120).
component("YER091C",348).
component("YJR073C",518).
component("YML008C",620).
component("YDL033C",234).
component("YOL096C",711).
component("YLR172C",590).
component("YBR263W",209).
component("YDR408C",307).
component("YMR120C",643).
component("YLR028C",574).
component("YBL013W",162).
component("YJL130C",494).
component("YJL088W",489).
component("YPR074C",794).
component("YBR117C",192).
component("YLR354C",610).
component("YGR043C",400).
component("YMR108W",641).
component("YCL009C",215).
component("YMR062C",638).
component("YNL071W",664).
component("YIL160C",477).
component("YNR019W",692).
component("YCR048W",229).
component("U48_",121).
component("YNL277W",681).
component("YDR232W",292).
component("YFL017C",358).
component("YPL231W",774).
component("YER061C",338).
component("U86_",150).
component("YPL001W",754).
component("YDL052C",236).
component("U8_",153).
component("YDR148C",287).
component("YOR377W",752).
component("YGR177C",412).
component("YPL231W",775).
component("YLR195C",593).
component("YLR299W",602).
component("YPR001W",784).
component("YNR001C",688).
component("YCR005C",225).
component("YML126C",632).
component("YDL182W",259).
component("YDL131W",249).
component("YNL117W",668).
component("YIR031C",482).
component("YPR160W",800).
component("YOR321W",742).
component("YJR143C",527).
component("YGR199W",417).
component("YDL095W",244).
component("YDL093W",243).
component("YAL023C",158).
component("YLR258W",599).
component("YFR015C",365).
component("YPL227C",771).
component("YMR261C",656).
component("YML100W",628).
component("YBR126C",195).
component("YNL192W",675).
component("YBR038W",181).
component("YBR023C",177).
component("YEL011W",321).
component("YLR209C",594).
component("U104_",24).
component("U103_",23).
component("YOR209C",734).
component("YMR300C",658).
component("YDR354W",301).
component("YFR047C",368).
component("YJR133W",525).
component("U22_",98).
component("YLR209C",595).
component("YDR399W",303).
component("YJL167W",502).
component("YJL167W",503).
component("YNL256W",678).
component("YPR069C",792).
component("YDR127W",282).
component("YHR190W",458).
component("YHR068W",447).
component("YLR303W",603).
component("YGR012W",397).
component("YML082W",627).
component("YJR130C",524).
component("YDR035W",269).
component("YBR249C",206).
component("YLR180W",592).
component("YDR502C",314).
component("YOL143C",716).
component("YBR256C",208).
component("YHR137W",452).
component("YGL202W",390).
component("YLR027C",573).
component("YKL106W",537).
component("YOL140W",715).
component("YLR438W",619).
component("YKL104C",536).
component("YGR019W",398).
component("YDR111C",279).
component("U64_",132).
component("U51_",124).
component("YJR148W",528).
component("YHR208W",461).
component("YOR184W",731).
component("YNR058W",697).
component("YGL253W",396).
component("YFR053C",369).
component("YMR013C",635).
component("YMR205C",649).
component("YGR240C",423).
component("YLR240W",598).
component("YKL203C",554).
component("YJR066W",517).
component("YCR036W",228).
component("YGR194C",416).
component("YCL040W",221).
component("YJR105W",522).
component("U16_",67).
component("YPL188W",767).
component("YJR049C",514).
component("YEL041W",324).
component("YKL001C",531).
component("YDR236C",293).
component("YML070W",626).
component("YFL053W",362).
component("YDR531W",318).
component("U82_",147).
component("U81_",146).
component("YMR208W",650).
component("YPL203W",768).
component("YOR061W",720).
component("YKL166C",545).
component("YJL164C",501).
component("YIL035C",465).
component("YHR205W",460).
component("YHR102W",450).
component("YGL019W",375).
component("YHR025W",439).
component("YNR012W",690).
component("YPR121W",797).
component("YPL258C",777).
component("YOL055C",704).
component("YPL214C",770).
component("U1_",84).
component("YDR009W",267).
component("YBR020W",176).
component("YFR019W",366).
component("YDR208W",290).
component("YDR127W",283).
component("U21_",93).
component("U20_",89).
component("YDR147W",286).
component("YDR300C",299).
component("YCR012W",226).
component("YER052C",333).
component("U19_",83).
component("U18_",77).
component("U17_",72).
component("U76_",143).
component("YMR220W",652).
component("YER170W",354).
component("YDR226W",291).
component("YKL067W",535).
component("YOL055C",705).
component("YDR454C",311).
component("YOL061W",708).
component("YKL181W",546).
component("YHL011C",431).
component("YER099C",350).
component("YBL068W",168).
component("YOR143C",727).
component("YNL256W",679).
component("YLR328W",607).
component("YBR018C",173).
component("YBR018C",174).
component("YDL055C",237).
component("YGR202C",418).
component("YLR328W",608).
component("YDL103C",247).
component("U94_",156).
component("YJR010W",511).
component("YBR029C",178).
component("YGL130W",384).
component("YDR530C",317).
component("YCL050C",222).
component("YPR190C",804).
component("YPR187W",803).
component("YPR110C",796).
component("YPR010C",786).
component("YOR341W",747).
component("YOR340C",746).
component("YOR224C",737).
component("YOR210W",735).
component("YOR207C",733).
component("YOR151C",728).
component("YOR116C",723).
component("YOL005C",698).
component("YNR003C",689).
component("YNL248C",677).
component("YNL151C",673).
component("YNL113W",667).
component("YKL144C",542).
component("YJR063W",516).
component("YJL148W",498).
component("YJL140W",497).
component("YIL021W",464).
component("YHR143W-A",453).
component("YGL070C",382).
component("YFL036W",361).
component("YDR404C",306).
component("YDR156W",288).
component("YDR045C",272).
component("YDL150W",256).
component("YDL140C",251).
component("YBR154C",199).
component("YPR175W",802).
component("YPL167C",765).
component("YOR330C",744).
component("YOL115W",714).
component("YNL299W",685).
component("YNL262W",680).
component("YNL102W",666).
component("YJR043C",513).
component("YJR006W",509).
component("YJL090C",490).
component("YIL139C",472).
component("YEL055C",327).
component("YDR419W",309).
component("YDR121W",280).
component("YDL102W",246).
component("YCR014C",227).
component("YBR278W",210).
component("YBL035C",164).
component("YKL035W",533).
component("YHL012W",432).
component("YHR123W",451).
component("YNL130C",669).
component("YPL148C",763).
component("YOR251C",740).
component("YGR286C",428).
component("YDR058C",275).
component("YOL011W",700).
component("YMR008C",634).
component("YMR006C",633).
component("U105_",25).
component("U101_",21).
component("YJL068C",487).
component("YPL072W",758).
component("YOR124C",724).
component("YNL186W",674).
component("YMR304W",659).
component("YMR223W",653).
component("YKR098C",569).
component("YJL197W",504).
component("YIL156W",475).
component("YFR010W",364).
component("YER151C",353).
component("YER144C",352).
component("YER098W",349).
component("YDR069C",276).
component("YDL122W",248).
component("YBR058C",183).
component("YBL067C",167).
component("YJR019C",512).
component("U84_",148).
component("YDR481C",312).
component("YLR377C",613).
component("YDR074W",277).
component("YFR025C",367).
component("YPL179W",766).
component("YNR032W",693).
component("YML057W",625).
component("YML016C",621).
component("YLR433C",618).
component("YGR123C",406).
component("YER133W",351).
component("YER089C",346).
component("YDR436W",310).
component("YDR075W",278).
component("YDL188C",260).
component("YDL134C",250).
component("YDL047W",235).
component("YDL006W",231).
component("YBR125C",194).
component("YBL056W",166).
component("YPR073C",793).
component("YHR215W",462).
component("YDL024C",233).
component("YBR093C",190).
component("YBR092C",189).
component("YIL053W",467).
component("YER062C",339).
component("YHR046C",443).
component("U9_",157).
component("YGR208W",422).
component("YPL228W",772).
component("YMR180C",646).
component("YDL236W",263).
component("YJL155C",500).
component("U34_",108).
component("U33_",107).
component("U32_",106).
component("U30_",105).
...
component("U26_",100).
component("U24_",99).
component("YHR044C",442).
component("YHR043C",441).
component("YOL064C",709).
component("YPL268W",781).
component("YOR360C",749).
component("YGL248W",395).
component("YKR031C",561).
component("YGL027C",377).
component("YLR286C",601).
component("YJR153W",529).
component("YJL221C",508).
component("YJL216C",506).
component("YIL172C",481).
component("YGR292W",430).
component("YGR287C",429).
component("YBR299W",214).
component("YBR184W",201).
component("YIL162W",478).
component("YPR026W",787).
component("YDR001C",265).
component("YBR001C",171).
component("YDR400W",304).
component("U102_",22).
component("YER043C",332).
component("YNL045W",662).
component("YLR160C",589).
component("YLR158C",588).
component("YLR157C",587).
component("YLR155C",586).
component("YDR321W",300).
component("YGL037C",378).
component("U43_",117).
component("U42_",116).
component("YDR242W",294).
component("YLR308W",606).
component("YLR307W",605).
component("U53_",125).
component("YLR420W",616).
component("YPL111W",761).
component("YIR032C",483).
component("YLR028C",575).
component("YHR144C",454).
component("YHR144C",455).
component("YCL030C",219).
component("YNL141W",670).
component("YBR153W",198).
component("YDL238C",264).
component("YNL141W",671).
component("YML035C",622).
component("YGR204W",420).
component("YBR084W",187).
component("YJL126W",492).
component("U44_",118).
component("YDL100C",245).
component("U40_",114).
component("U39_",112).
component("YBR011C",172).
component("YHR201C",459).
component("YBR111C",191).
component("YBR252W",207).
component("YCL030C",220).
component("YER005W",329).
component("YBL099W",170).
component("YLR231C",596).
component("U88_",151).
component("YDR538W",320).
component("YLR134W",583).
component("YLR044C",577).
component("YGR087C",403).
component("YDR380W",302).
component("YDL080C",240).
component("YMR250W",654).
component("YKL184W",550).
component("YEL021W",322).
component("YNR043W",695).
component("U93_",155).
component("YDR047W",274).
component("YKL211C",555).
component("YKR097W",568).
component("YOL052C",703).
component("YGR170W",410).
component("YDR294C",296).
component("YEL046C",325).
component("YNR033W",694).
component("YPR006C",785).
component("YER065C",340).
component("YKL211C",556).
component("YER090W",347).
component("YDR127W",284).
component("YPL281C",783).
component("YOR393W",753).
component("YMR323W",660).
component("YHR174W",456).
component("YGR254W",424).
component("YPL262W",778).
component("YGL026C",376).
component("YGR155W",409).
component("YLR304C",604).
component("YJL200C",505).
component("YGL009C",373).
component("YNL316C",686).
component("YKL182W",548).
component("YPL212C",769).
component("YNL292W",684).
component("YGL063W",381).
component("YFL001W",356).
component("YCR053W",230).
component("YDR127W",285).
component("YGL148W",385).
component("YIL168W",480).
component("YIL167W",479).
component("YCL064C",223).
component("YCL064C",224).
component("YHR018C",435).
component("YLR359W",612).
component("YFR055W",370).
component("YJL121C",491).
component("YBR019C",175).
component("YDR007W",266).
component("YOR095C",722).
component("YBR196C",202).
component("YGL001C",372).
component("YPL117C",762).
component("U14_",55).
component("YKL152C",544).
component("YMR105C",640).
component("YKL127W",539).
component("YEL058W",328).
component("YPR060C",791).
component("YHR072W",448).
component("YJL153C",499).
component("YGR264C",427).
component("YGR171C",411).
component("YHR011W",434).
component("YDR023W",268).
component("YPL104W",760).
component("YLL018C",570).
component("YPR081C",795).
component("YBR121C",193).
component("YHR020W",438).
component("YER087W",345).
component("YOL033W",702).
component("YGL245W",394).
component("YOR168W",729).
component("YOL097C",712).
component("YDR268W",295).
component("YPR047W",790).
component("YLR060W",579).
component("YFL022C",360).
component("YPR033C",788).
component("YHR019C",436).
component("YHR019C",437).
component("YKL194C",553).
component("YIL078W",470).
component("YPL160W",764).
component("YLR382C",614).
component("YPL040C",757).
component("YBL076C",169).
component("YNL073W",665).
component("YDR037W",270).
component("YOR335C",745).
component("YGR094W",404).
component("YPR035W",789).
component("YIL145C",473).
component("U89_",152).
component("YOR241W",739).
component("YMR113W",642).
component("YKL132C",540).
component("YGL234W",392).
component("YER183C",355).
component("U90_",154).
component("YNR057C",696).
component("YDL141W",252).
component("YDL141W",253).
component("YGL234W",393).
component("YDL141W",254).
component("YGR204W",421).
component("YOL058W",706).
component("YDL141W",255).
component("YHR074W",449).
component("YMR217W",651).
component("YPR145W",799).
component("YGR124W",407).
component("YOR303W",741).
component("YJR109C",523).
component("YJL130C",495).
component("YGL062W",380).
component("YBR218C",203).
component("YPL231W",776).
component("YNR016C",691).
component("YKL182W",549).
component("YGR037C",399).
component("YOR005C",718).
component("YDL164C",257).
component("YJL087C",488).
component("YOL010W",699).
component("YPR138C",798).
component("YPL265W",779).
component("YOR348C",748).
component("YOR192C",732).
component("YOR171C",730).
component("YOR130C",725).
component("YOR071C",721).
component("YOR011W",719).
component("YOL156W",717).
component("YOL103W",713).
component("YOL020W",701).
component("YNL318C",687).
component("YNL142W",672).
component("YMR272C",657).
component("YMR202W",648).
component("YMR056C",637).
component("YML123C",631).
component("YLR348C",609).
component("YLR260W",600).
component("YLR237W",597).
component("YLR138W",584).
component("YLR100C",582).
component("YLR092W",581).
component("YLR081W",580).
component("YLL061W",571).
component("YKR093W",567).
component("YKR053C",563).
component("YKR039W",562).
component("YKL217W",558).
component("YKL120W",538).
component("YJR095W",521).
component("YJR077C",519).
component("YJL219W",507).
component("YJL134W",496).
component("YJL129C",493).
component("YHL036W",433).
component("YGR191W",414).
component("YGR125W",408).
component("YGR121C",405).
component("YGR065C",402).
component("YGR055W",401).
component("YGL186C",387).
component("YFL055W",363).
component("YFL011W",357).
component("YER060W-A",336).
component("YER060W",335).
component("YER056C",334).
component("YDR536W",319).
component("YDR508C",316).
component("YDR503C",315).
component("YDR497C",313).
component("YDR297W",298).
component("YDR294C",297).
component("YDR046C",273).
component("YDL210W",261).
component("YCL025C",217).
component("YBR298C",213).
component("YBR294W",212).
component("YBR291C",211).
