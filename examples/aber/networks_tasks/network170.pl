...
component("YJR159W",682).
component("YGL001C",481).
component("YHR063C",572).
component("U45_",148).
component("YBR153W",257).
component("YML056C",798).
component("YLR432W",786).
component("YHR216W",596).
component("YAR075W",209).
component("YAR073W",208).
component("YCL030C",281).
component("YDR127W",364).
component("YJR139C",677).
component("YML075C",801).
component("YLR450W",789).
component("YOL126C",912).
component("YKL085W",691).
component("YDL078C",311).
component("YKL029C",686).
component("YOR136W",929).
component("YNL037C",850).
component("YNL009W",848).
component("YLR174W",757).
component("YDL066W",309).
component("YHR183W",590).
component("YGR256W",548).
component("YNL241C",866).
component("YOL059W",904).
component("YDL022W",300).
component("YCL018W",279).
component("YLR355C",780).
component("YIL074C",603).
component("YER081W",448).
component("YML054C",797).
component("YDL174C",334).
component("YIL155C",613).
component("YPR191W",1025).
component("YOR065W",920).
component("YJL166W",648).
component("YHR001W-A",558).
component("YGR183C",532).
component("YFR033C",477).
component("YEL024W",419).
component("YDR529C",410).
component("YBL045C",216).
component("Q0105",19).
component("YKR066C",723).
component("YKL026C",685).
component("YIR037W",624).
component("YBR244W",267).
component("YJR078W",668).
component("U58_",161).
component("U107_",28).
component("YGR255C",547).
component("U108_",29).
component("YBL098W",221).
component("YMR015C",814).
component("YHR007C",559).
component("YDR402C",397).
component("YGL055W",490).
component("YGR175C",529).
component("YJR104C",671).
component("YHR008C",560).
component("YJL026W",627).
component("YIL066C",602).
component("YGR180C",531).
component("YER070W",446).
component("U37_",140).
component("U36_",139).
component("U35_",138).
component("YDR158W",372).
component("YJR009C",658).
component("YJL052W",629).
component("YGR192C",535).
component("YBR006W",226).
component("YPL276W",999).
component("YPL275W",998).
component("YOR388C",962).
component("YOR374W",959).
component("YER073W",447).
component("U68_",172).
component("YGL154C",498).
component("YBR115C",250).
component("U55_",158).
component("YER069W",444).
component("YOR323C",949).
component("U2_",132).
component("YER178W",460).
component("YBR221C",265).
component("YIL125W",609).
component("YBR166C",260).
component("YNL280C",874).
component("YGL012W",484).
component("YKL182W",704).
component("U57_",160).
component("YKL216W",715).
component("YDR044W",350).
component("YER014W",430).
component("YKR009C",719).
component("YIL160C",615).
component("YGL205W",503).
component("YMR118C",823).
component("YLR164W",755).
component("YLL041C",730).
component("YKL148C",699).
component("YKL141W",697).
component("YJL045W",628).
component("YDR178W",374).
component("YJR051W",663).
component("YEL047C",423).
component("YDL171C",333).
component("YOR375C",960).
component("YDL215C",338).
component("YAL062W",206).
component("U99_",200).
component("U100_",22).
component("YBR035C",236).
component("YMR189W",830).
component("U56_",159).
component("YNR050C",889).
component("YKR080W",725).
component("YER023W",431).
component("YPL023C",966).
component("YGL125W",495).
component("YOR236W",942).
component("YGR204W",539).
component("YBR084W",244).
component("YLR142W",748).
component("U65_",169).
component("U63_",167).
component("U62_",166).
component("YOR356W",957).
component("YHR068W",573).
component("YKL150W",700).
component("YIL043C",600).
component("YHR042W",567).
component("YOR221C",940).
component("YMR145C",826).
component("YML120C",806).
component("YKL192C",708).
component("YKL055C",688).
component("YER061C",440).
component("YDL085W",313).
component("YBR046C",239).
component("YMR145C",827).
component("YML120C",807).
component("YKL192C",709).
component("YDL085W",314).
component("YFR030W",476).
component("YPL017C",965).
component("YFL018C",465).
component("YPL091W",971).
component("YDR353W",392).
component("YER042W",432).
component("YPR167C",1019).
component("YJR137C",676).
component("YNL052W",852).
component("YMR256C",838).
component("YLR395C",784).
component("YLR038C",737).
component("YIL111W",607).
component("YHR051W",571).
component("YGL191W",501).
component("YGL187C",500).
component("YDL067C",310).
component("Q0275",21).
component("Q0250",20).
component("Q0045",18).
component("YPL266W",995).
component("YML110C",805).
component("YBR034C",235).
component("YPL273W",997).
component("YLL062C",733).
component("YDR410C",400).
component("YKR069W",724).
component("YOL096C",907).
component("U47_",150).
component("YER091C",452).
component("YJR073C",666).
component("YML008C",790).
component("YDL033C",302).
component("YOL096C",908).
component("YLR172C",756).
component("YLR058C",740).
component("YBR263W",271).
component("YDR019C",346).
component("YBR176W",261).
component("YDR408C",399).
component("YMR120C",824).
component("YLR028C",735).
component("YBL013W",210).
component("YJL130C",640).
component("YJL088W",634).
component("YPR074C",1012).
component("YBR117C",251).
component("YLR354C",779).
component("YGR043C",514).
component("YMR108W",821).
component("YCL009C",278).
component("YMR062C",817).
component("YNL071W",853).
component("YIL160C",616).
component("YNR019W",883).
component("YCR048W",295).
component("U48_",151).
component("YNL277W",872).
component("YDR232W",377).
component("YFL017C",464).
component("YPL231W",989).
component("YER061C",441).
component("U86_",190).
component("YPL001W",964).
component("YDL052C",306).
component("U8_",193).
component("YDR148C",370).
component("YML042W",796).
component("YOR377W",961).
component("YGR177C",530).
component("YPL231W",990).
component("YGR147C",525).
component("YDL040C",303).
component("YPL028W",967).
component("YLR195C",759).
component("YLR299W",769).
component("YGL017W",485).
component("YPR001W",1001).
component("YNR001C",879).
component("YCR005C",290).
component("YML126C",809).
component("YDL182W",335).
component("YDL131W",323).
component("YNL117W",857).
component("YIR031C",622).
component("YPR160W",1018).
component("YOR321W",948).
component("YJR143C",678).
component("YGR199W",537).
component("YDL095W",318).
component("YDL093W",317).
component("YAL023C",203).
component("YLR258W",766).
component("YFR015C",473).
component("YPL227C",986).
component("YOR103C",924).
component("YOR085W",922).
component("YMR149W",828).
component("YML019W",792).
component("YJL002C",625).
component("YEL002C",415).
component("YDL232W",339).
component("YCL043C",285).
component("YNL029C",849).
component("YIL085C",605).
component("YMR261C",839).
component("YML100W",803).
component("YBR126C",254).
component("YNL192W",864).
component("YBR038W",238).
component("YBR023C",233).
component("YEL011W",416).
component("YMR306W",846).
component("YLR342W",777).
component("YGR032W",512).
component("YPR183W",1022).
component("YLR209C",760).
component("U104_",26).
component("U103_",25).
component("YMR271C",840).
component("YML106W",804).
component("YOR209C",938).
component("YMR300C",844).
component("YER055C",436).
component("YDR354W",393).
component("YFR047C",478).
component("YJR133W",675).
component("U22_",126).
component("YLR209C",761).
component("YML022W",793).
component("YDR441C",403).
component("YDR399W",395).
component("YHR128W",583).
component("YPR176C",1021).
component("YPL172C",979).
component("YNR041C",887).
component("YMR101C",819).
component("YDL090C",316).
component("YBR003W",225).
component("YBR002C",224).
component("YJL167W",649).
component("YJL167W",650).
component("YNL256W",868).
component("YPR069C",1010).
component("YDR127W",365).
component("YHR190W",591).
component("YLR146C",749).
component("YHR068W",574).
component("YLR303W",770).
component("YGR012W",510).
component("YML082W",802).
component("YJR130C",674).
component("YDR035W",348).
component("YBR249C",268).
component("YLR180W",758).
component("YDR502C",407).
component("YOR274W",945).
component("YOL143C",915).
component("YBR256C",270).
component("YHR137W",584).
component("YGL202W",502).
component("YLR027C",734).
component("YKL106W",693).
component("YOL140W",914).
component("YLR438W",788).
component("YKL104C",692).
component("YGR019W",511).
component("YDR111C",362).
component("U64_",168).
component("U61_",165).
component("U51_",155).
component("YJR148W",679).
component("YHR208W",594).
component("YFL030W",467).
component("YOR184W",935).
component("YNR058W",891).
component("YIL116W",608).
component("YGL253W",508).
component("YFR053C",479).
component("YOL136C",913).
component("YIL107C",606).
component("YMR013C",813).
component("YMR205C",832).
component("YGR240C",543).
component("YOL016C",896).
component("YFR014C",472).
component("YLR240W",764).
component("YKL203C",711).
component("YJR066W",665).
component("YCR036W",294).
component("YGR194C",536).
component("YCL040W",284).
component("YJR105W",672).
component("U16_",79).
component("YPL188W",981).
component("YJR049C",662).
component("YEL041W",420).
component("U96_",198).
component("YKL001C",683).
component("YDR236C",378).
component("YML070W",800).
component("YFL053W",469).
component("YHL032C",556).
component("YLR133W",745).
component("YDR531W",412).
component("U83_",187).
component("U82_",186).
component("U81_",185).
component("YMR208W",833).
component("YPL203W",982).
component("YOR061W",919).
component("YKL166C",702).
component("YJL164C",647).
component("YIL035C",599).
component("YHR205W",593).
component("YHR102W",581).
component("YGL019W",486).
component("YHR025W",566).
component("YOR347C",955).
component("YAL038W",204).
component("YNR012W",881).
component("YPR121W",1015).
component("YPL258C",992).
component("YOL055C",900).
component("YPL214C",985).
component("U1_",106).
component("YDR009W",345).
component("YBR020W",232).
component("YFR019W",474).
component("YDR208W",375).
component("YDR127W",366).
component("U21_",118).
component("U20_",113).
component("YDR147W",369).
component("YDR300C",386).
component("YCR012W",291).
component("YER052C",434).
component("YER069W",445).
component("U19_",105).
component("U18_",96).
component("U17_",87).
component("U76_",181).
component("YMR220W",835).
component("YER170W",459).
component("YDR226W",376).
component("YKL067W",690).
component("YOL055C",901).
component("YDR454C",404).
component("YOL061W",905).
component("YKL181W",703).
component("YHL011C",553).
component("YER099C",454).
component("YBL068W",219).
component("YOR143C",930).
component("YNL256W",869).
component("YLR328W",775).
component("YBR018C",228).
component("YBR018C",229).
component("YDL055C",307).
component("YGR007W",509).
component("YGR202C",538).
component("YLR328W",776).
component("YKR002W",717).
component("YDL045C",304).
component("YDL103C",321).
component("U94_",197).
component("YJR010W",659).
component("YBR029C",234).
component("YCL050C",286).
component("YGL130W",496).
component("YDR530C",411).
component("YCL050C",287).
component("YPR190C",1024).
component("YPR187W",1023).
component("YPR110C",1014).
component("YPR010C",1003).
component("YOR341W",954).
component("YOR340C",953).
component("YOR224C",941).
component("YOR210W",939).
component("YOR207C",937).
component("YOR151C",931).
component("YOR116C",925).
component("YOL005C",893).
component("YNR003C",880).
component("YNL248C",867).
component("YNL151C",862).
component("YNL113W",856).
component("YKL144C",698).
component("YJR063W",664).
component("YJL148W",644).
component("YJL140W",643).
component("YIL021W",598).
component("YHR143W-A",585).
component("YGL070C",494).
component("YFL036W",468).
component("YDR404C",398).
component("YDR156W",371).
component("YDR045C",351).
component("YDL150W",331).
component("YDL140C",325).
component("YBR154C",259).
component("YPR175W",1020).
component("YPL167C",978).
component("YOR330C",950).
component("YOL115W",911).
component("YNL299W",876).
component("YNL262W",870).
component("YNL102W",855).
component("YJR043C",661).
component("YJR006W",657).
component("YJL090C",635).
component("YIL139C",611).
component("YEL055C",424).
component("YDR419W",401).
component("YDR121W",363).
component("YDL102W",320).
component("YCR014C",292).
component("YBR278W",272).
component("YBL035C",213).
component("YKL035W",687).
component("YHL012W",554).
component("YHR123W",582).
component("YBR243C",266).
component("YNL130C",858).
component("YDL142C",330).
component("YPL148C",976).
component("YOR251C",944).
component("YGR286C",550).
component("YJL068C",630).
component("YDR058C",356).
component("YNR034W",886).
component("YHR163W",588).
component("YGR248W",545).
component("YCR073W-A",297).
component("YDL086W",315).
component("YOL011W",895).
component("YMR008C",811).
component("YMR006C",810).
component("U105_",27).
component("U101_",23).
component("YJL068C",631).
component("YPL072W",970).
component("YOR124C",926).
component("YNL186W",863).
component("YMR304W",845).
component("YMR223W",836).
component("YKR098C",728).
component("YJL197W",651).
component("YIL156W",614).
component("YFR010W",471).
component("YER151C",458).
component("YER144C",457).
component("YER098W",453).
component("YDR069C",358).
component("YDL122W",322).
component("YBR058C",240).
component("YBL067C",218).
component("YJR019C",660).
component("YDR272W",381).
component("U84_",188).
component("YDR481C",405).
component("YLR377C",782).
component("YDR074W",359).
component("YFR025C",475).
component("YPL179W",980).
component("YNR032W",884).
component("YML057W",799).
component("YML016C",791).
component("YLR433C",787).
component("YGR123C",521).
component("YER133W",456).
component("YER089C",450).
component("YDR436W",402).
component("YDR075W",360).
component("YDL188C",336).
component("YDL134C",324).
component("YDL047W",305).
component("YDL006W",298).
component("YBR125C",253).
component("YBL056W",217).
component("YPR073C",1011).
component("YHR215W",595).
component("YDL024C",301).
component("YBR093C",248).
component("YBR092C",247).
component("YIL053W",601).
component("YER062C",442).
component("YHR046C",570).
component("U9_",201).
component("YGR208W",542).
component("YPL228W",987).
component("YMR180C",829).
component("YDL236W",340).
component("YJL155C",646).
component("U34_",137).
component("U33_",136).
component("U32_",135).
component("U31_",134).
...
component("U26_",128).
component("U24_",127).
component("YHR044C",569).
component("YHR043C",568).
component("YOL064C",906).
component("YPL268W",996).
component("YOR360C",958).
component("YGL248W",507).
component("YKR031C",720).
component("YPL206C",983).
component("YGL027C",488).
component("YLR286C",768).
component("YJR153W",680).
component("YJL221C",656).
component("YJL216C",654).
component("YIL172C",620).
component("YGR292W",552).
component("YGR287C",551).
component("YBR299W",277).
component("YBR184W",262).
component("YIL162W",617).
component("YPR026W",1004).
component("YDR001C",343).
component("YBR001C",223).
component("YDR400W",396).
component("YML035C",794).
component("YJL070C",632).
component("YBR284W",273).
component("U102_",24).
component("YER043C",433).
component("YNL045W",851).
component("YLR160C",754).
component("YLR158C",753).
component("YLR157C",752).
component("YLR155C",751).
component("YDR321W",387).
component("YGL037C",489).
component("U43_",146).
component("U42_",145).
component("YMR293C",843).
component("YDR242W",379).
component("YLR308W",774).
component("YLR307W",773).
component("YMR281W",842).
component("U53_",156).
component("YLR420W",785).
component("YPL111W",974).
component("YIR032C",623).
component("YIR029W",621).
component("YPR062W",1009).
component("YMR120C",825).
component("YLR028C",736).
component("YHR144C",586).
component("YHR144C",587).
component("YCL030C",282).
component("YNL141W",859).
component("YBL033C",212).
component("YBR153W",258).
component("YDL238C",341).
component("YNL141W",860).
component("YLR245C",765).
component("YML035C",795).
component("YGR204W",540).
component("YBR084W",245).
component("YJL126W",638).
component("U44_",147).
component("YDL100C",319).
component("U40_",143).
component("U39_",141).
component("YBR011C",227).
component("YHR201C",592).
component("YBR111C",249).
component("YBR252W",269).
component("YCL030C",283).
component("YEL042W",421).
component("YER005W",429).
component("YBL099W",222).
component("U60_",164).
component("YLR231C",762).
component("U88_",191).
component("YDR538W",414).
component("YLR134W",746).
component("YLR044C",738).
component("YGR087C",518).
component("YDR380W",394).
component("YDL080C",312).
component("U98_",199).
component("YMR250W",837).
component("YKL184W",707).
component("YOR128C",927).
component("YEL021W",418).
component("YNR043W",888).
component("U93_",196).
component("YDR047W",353).
component("U54_",157).
component("YKL211C",713).
component("YKR097W",727).
component("YOL052C",899).
component("YGR170W",527).
component("YKL060C",689).
component("YDR294C",383).
component("YEL046C",422).
component("YNR033W",885).
component("YPR006C",1002).
component("YER065C",443).
component("YKL211C",714).
component("YER090W",451).
component("YDR127W",367).
component("YPL281C",1000).
component("YOR393W",963).
component("YMR323W",847).
component("YHR174W",589).
component("YGR254W",546).
component("YPL262W",993).
component("YGL026C",487).
component("YGR155W",526).
component("YLR304C",771).
component("YJL200C",652).
component("YGL009C",483).
component("YNL316C",877).
component("YKL182W",705).
component("YPL212C",984).
component("YNL292W",875).
component("YGL063W",493).
component("YFL001W",462).
component("YOR278W",946).
component("U49_",152).
component("YCR053W",296).
component("YDR127W",368).
component("YGL148W",497).
component("YIL168W",619).
component("YIL167W",618).
component("YCL064C",288).
component("YCL064C",289).
component("YHR018C",562).
component("YLR359W",781).
component("YAL012W",202).
component("YFR055W",480).
component("YJL005W",626).
component("YOR176W",934).
component("YJL121C",637).
component("YBR019C",230).
component("YBR019C",231).
component("U59_",162).
component("YDR050C",354).
component("YIL020C",597).
component("YDR007W",344).
component("YOR095C",923).
component("YER003C",428).
component("YBR196C",263).
component("YGL001C",482).
component("YPL117C",975).
component("U14_",64).
component("YOL056W",902).
component("YKL152C",701).
component("YDL021W",299).
component("YMR105C",820).
component("YKL127W",695).
component("YEL058W",425).
component("YPR060C",1008).
component("YHR072W",575).
component("YJL153C",645).
component("YPL097W",972).
component("YGR185C",533).
component("YGR264C",549).
component("YGR171C",528).
component("YHR011W",561).
component("YDR023W",347).
component("YPL104W",973).
component("YLL018C",729).
component("YPR081C",1013).
component("YBR121C",252).
component("YHR020W",565).
component("YER087W",449).
component("YOL033W",898).
component("YGL245W",506).
component("YOR168W",932).
component("YHR091C",577).
component("YDR341C",388).
component("YOL097C",909).
component("YDR268W",380).
component("YPR047W",1007).
component("YLR060W",741).
component("YFL022C",466).
component("YPR033C",1005).
component("YHR019C",563).
component("YHR019C",564).
component("YKL194C",710).
component("YIL078W",604).
component("YPL160W",977).
component("YLR382C",783).
component("YPL040C",968).
component("YBL076C",220).
component("YNL073W",854).
component("YDR037W",349).
component("YOR335C",951).
component("YGR094W",519).
component("YLR153C",750).
component("YAL054C",205).
component("YGR244C",544).
component("YPR035W",1006).
component("YIL145C",612).
component("U89_",192).
component("YOR241W",943).
component("YMR113W",822).
component("YKL132C",696).
component("YOR339C",952).
component("YMR022W",815).
component("YLR306W",772).
component("YKL210W",712).
component("YGR133W",524).
component("YGL058W",491).
component("YER100W",455).
component("YEL012W",417).
component("YDR177W",373).
component("YDR092W",361).
component("YDR059C",357).
component("YDR054C",355).
component("YDL064W",308).
component("YBR082C",243).
component("YJL101C",636).
component("U92_",195).
component("YAR015W",207).
component("YGL234W",504).
component("YER183C",461).
component("U90_",194).
...
component("YJR103W",670).
component("YBL039C",214).
component("YGR204W",541).
component("YNL220W",865).
component("YOL058W",903).
component("YDL141W",329).
component("YHR074W",576).
component("YMR217W",834).
component("YPR145W",1017).
component("YGR124W",522).
component("YOR303W",947).
component("YJR109C",673).
component("YJL130C",641).
component("YGL062W",492).
component("YBR218C",264).
component("YPL231W",991).
component("YNR016C",882).
component("YKL182W",706).
component("YGR037C",513).
component("YOR005C",917).
component("YDL164C",332).
component("YJL087C",633).
component("YOL010W",894).
component("YPR138C",1016).
component("YPL265W",994).
component("YPL057C",969).
component("YOR348C",956).
component("YOR192C",936).
component("YOR171C",933).
component("YOR130C",928).
component("YOR071C",921).
component("YOR011W",918).
component("YOL156W",916).
component("YOL103W",910).
component("YOL020W",897).
component("YNR072W",892).
component("YNL318C",878).
component("YNL270C",871).
component("YNL142W",861).
component("YMR272C",841).
component("YMR202W",831).
component("YMR056C",816).
component("YMR011W",812).
component("YML123C",808).
component("YLR348C",778).
component("YLR260W",767).
component("YLR237W",763).
component("YLR138W",747).
component("YLR100C",744).
component("YLR092W",743).
component("YLR081W",742).
component("YLL061W",732).
component("YLL043W",731).
component("YKR093W",726).
component("YKR053C",722).
component("YKR039W",721).
component("YKL217W",716).
component("YKL120W",694).
component("YKL004W",684).
component("YJR158W",681).
component("YJR095W",669).
component("YJR077C",667).
component("YJL219W",655).
component("YJL214W",653).
component("YJL134W",642).
component("YJL129C",639).
component("YIL134W",610).
component("YHR096C",580).
component("YHR094C",579).
component("YHR092C",578).
component("YHL036W",557).
component("YHL016C",555).
component("YGR191W",534).
component("YGR125W",523).
component("YGR121C",520).
component("YGR065C",517).
component("YGR055W",515).
component("YGL186C",499).
component("YFL055W",470).
component("YFL011W",463).
component("YER060W-A",439).
component("YER060W",438).
component("YER056C",437).
component("YER053C",435).
component("YEL069C",427).
component("YEL063C",426).
component("YDR536W",413).
component("YDR508C",409).
component("YDR503C",408).
component("YDR497C",406).
component("YDR345C",391).
component("YDR343C",390).
component("YDR342C",389).
component("YDR297W",385).
component("YDR294C",384).
component("YDR284C",382).
component("YDR046C",352).
component("YDL245C",342).
component("YDL210W",337).
component("YCR028C",293).
component("YCL025C",280).
component("YBR298C",276).
component("YBR294W",275).
component("YBR291C",274).
component("YBR085W",246).
component("YBR069C",242).
component("YBR068C",241).
component("YBR036C",237).
