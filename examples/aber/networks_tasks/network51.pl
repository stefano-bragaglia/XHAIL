...
component("YNL280C",358).
component("YLR056W",298).
component("YMR083W",331).
component("YPL231W",403).
component("YJR159W",275).
component("YGL001C",195).
component("YML056C",320).
component("YLR432W",318).
component("YHR216W",240).
component("YAR075W",80).
component("YAR073W",79).
component("YDR127W",145).
component("YJR139C",272).
component("YNL009W",346).
component("YLR174W",307).
component("YHR183W",237).
component("YGR256W",219).
component("YCL018W",108).
component("YJR078W",268).
component("YGR255C",218).
component("YMR015C",328).
component("YDR402C",159).
component("YGL055W",200).
component("YJL026W",247).
component("YGR180C",215).
component("YOR374W",393).
component("YER073W",178).
component("U68_",67).
component("U55_",63).
component("YER069W",177).
component("YOR323C",388).
component("YBR166C",101).
component("YNL280C",359).
component("YKL141W",281).
component("YOR375C",394).
component("YDL215C",134).
component("YAL062W",78).
component("U100_",20).
component("YBR035C",90).
component("YMR189W",335).
component("U56_",64).
component("YPL023C",396).
component("YGL125W",202).
component("YOR236W",386).
component("YLR142W",302).
component("U65_",66).
component("YHR068W",229).
component("YMR145C",334).
component("YDL085W",120).
component("YBR046C",91).
component("YPL091W",399).
component("YNL052W",347).
component("YMR256C",341).
component("YLR395C",317).
component("YLR038C",296).
component("YIL111W",243).
component("YHR051W",228).
component("YGL191W",206).
component("YGL187C",205).
component("YDL067C",118).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",408).
component("YLL062C",293).
component("YDR410C",161).
component("YER091C",180).
component("YJR073C",266).
component("YOL096C",373).
component("YMR120C",333).
component("YBL013W",81).
component("YJL130C",253).
component("YJL088W",249).
component("YPR074C",414).
component("YBR117C",97).
component("YCL009C",107).
component("YMR062C",330).
component("YNL071W",348).
component("YNR019W",365).
component("YCR048W",115).
component("U48_",59).
component("YFL017C",186).
component("YPL231W",404).
component("YDL052C",117).
component("U8_",73).
component("YPL231W",405).
component("YLR299W",311).
component("YCR005C",112).
component("YML126C",324).
component("YDL182W",132).
component("YDL131W",125).
component("YNL117W",351).
component("YIR031C",246).
component("YOR321W",387).
component("YJR143C",273).
component("YGR199W",216).
component("YDL095W",122).
component("YDL093W",121).
component("YAL023C",77).
component("YMR261C",342).
component("YML100W",322).
component("YBR126C",98).
component("YLR209C",308).
component("YDR354W",156).
component("YFR047C",193).
component("YJR133W",271).
component("U22_",50).
component("YDR399W",158).
component("YJL167W",260).
component("YPR069C",413).
component("YDR127W",146).
component("YML082W",321).
component("YJR130C",270).
component("YDR035W",138).
component("YBR249C",103).
component("YBR256C",104).
component("YHR137W",232).
component("YGL202W",207).
component("YLR027C",294).
component("YKL106W",279).
component("YOL140W",376).
component("YLR438W",319).
component("YKL104C",278).
component("YDR111C",143).
component("U51_",61).
component("YJR148W",274).
component("YMR013C",327).
component("YCR036W",114).
component("YCL040W",111).
component("YJR105W",269).
component("U81_",72).
component("YMR208W",337).
component("YPL203W",402).
component("YOR061W",377).
component("YKL166C",283).
component("YJL164C",259).
component("YIL035C",242).
component("YHR205W",239).
component("YHR102W",231).
component("YGL019W",196).
component("YHR025W",225).
component("YNR012W",363).
component("YFR019W",191).
component("YDR208W",152).
component("YDR127W",147).
component("U21_",47).
component("YDR147W",150).
component("YER052C",173).
component("U19_",43).
component("U18_",39).
component("U17_",36).
component("U76_",70).
component("YMR220W",338).
component("YDR226W",153).
component("YKL067W",277).
component("YDR454C",163).
component("YOL061W",372).
component("YKL181W",284).
component("YHL011C",221).
component("YER099C",182).
component("YBL068W",86).
component("YOR143C",381).
component("YLR328W",314).
component("U94_",75).
component("YBR029C",89).
component("YPR190C",420).
component("YPR187W",419).
component("YPR110C",415).
component("YPR010C",410).
component("YOR341W",391).
component("YOR340C",390).
component("YOR224C",385).
component("YOR210W",384).
component("YOR207C",383).
component("YOR151C",382).
component("YOR116C",379).
component("YOL005C",368).
component("YNR003C",362).
component("YNL248C",356).
component("YNL151C",354).
component("YNL113W",350).
component("YKL144C",282).
component("YJR063W",265).
component("YJL148W",256).
component("YJL140W",255).
component("YIL021W",241).
component("YHR143W-A",233).
component("YGL070C",201).
component("YFL036W",188).
component("YDR404C",160).
component("YDR156W",151).
component("YDR045C",139).
component("YDL150W",131).
component("YDL140C",126).
component("YBR154C",100).
component("YPR175W",418).
component("YPL167C",401).
component("YOR330C",389).
component("YOL115W",375).
component("YNL299W",360).
component("YNL262W",357).
component("YNL102W",349).
component("YJR043C",264).
component("YJR006W",262).
component("YJL090C",250).
component("YIL139C",244).
...
component("YHL012W",222).
component("YOL011W",370).
component("YMR008C",326).
component("YMR006C",325).
component("U105_",21).
component("YPL072W",398).
component("YOR124C",380).
component("YNL186W",355).
component("YMR304W",344).
component("YMR223W",339).
component("YKR098C",292).
component("YJL197W",261).
component("YIL156W",245).
component("YFR010W",190).
component("YER151C",184).
component("YER144C",183).
component("YER098W",181).
component("YDR069C",141).
component("YDL122W",124).
component("YBR058C",92).
component("YBL067C",85).
component("YJR019C",263).
component("YDR074W",142).
component("YFR025C",192).
component("U9_",76).
component("YJL155C",258).
component("U34_",55).
component("U33_",54).
component("U32_",53).
component("U30_",52).
component("U24_",51).
component("YHR044C",227).
component("YHR043C",226).
component("YGL027C",198).
component("YLR286C",310).
component("YLR160C",306).
component("YLR158C",305).
component("YLR157C",304).
component("YLR155C",303).
component("YDR321W",155).
component("YGL037C",199).
component("U43_",57).
component("U42_",56).
component("YLR308W",313).
component("YLR307W",312).
component("U53_",62).
component("YLR028C",295).
component("YHR144C",234).
component("YHR144C",235).
component("YBR153W",99).
component("YDL238C",135).
component("YNL141W",352).
component("YJL126W",252).
component("U44_",58).
component("YHR201C",238).
component("YBR111C",96).
component("YCL030C",110).
component("YER005W",172).
component("YLR231C",309).
component("YDR538W",168).
component("YLR134W",301).
component("YLR044C",297).
component("YGR087C",210).
component("YDR380W",157).
component("YDL080C",119).
component("YMR250W",340).
component("YKL184W",286).
component("YEL021W",169).
component("YKL211C",287).
component("YNR033W",366).
component("YKL211C",288).
component("YER090W",179).
component("YDR127W",148).
component("YPL281C",409).
component("YOR393W",395).
component("YMR323W",345).
component("YHR174W",236).
component("YGR254W",217).
component("YGL026C",197).
component("YGR155W",213).
component("YNL316C",361).
component("YCR053W",116).
component("YDR127W",149).
component("YGL148W",203).
component("YFR055W",194).
component("YJL121C",251).
component("YBR019C",88).
component("YDR007W",136).
component("YOR095C",378).
component("YBR196C",102).
component("U14_",30).
component("YMR105C",332).
component("YKL127W",280).
component("YEL058W",171).
component("YPR060C",412).
component("YHR072W",230).
component("YJL153C",257).
component("YGR264C",220).
component("YGR171C",214).
component("YHR011W",223).
component("YDR023W",137).
component("YGL245W",208).
component("YPR047W",411).
component("YLR060W",299).
component("YFL022C",187).
component("YHR019C",224).
component("YPL160W",400).
component("YLR382C",316).
component("YPL040C",397).
component("YBL076C",87).
component("YER183C",185).
component("U90_",74).
...
component("YPR145W",417).
component("YGR124W",212).
component("YPL231W",406).
component("YNR016C",364).
component("YKL182W",285).
component("YGR037C",209).
component("YJL087C",248).
component("YOL010W",369).
component("YPR138C",416).
component("YPL265W",407).
component("YOR348C",392).
component("YOL103W",374).
component("YOL020W",371).
component("YNL142W",353).
component("YMR272C",343).
component("YMR202W",336).
component("YMR056C",329).
component("YML123C",323).
component("YLR348C",315).
component("YLR100C",300).
component("YKR053C",291).
component("YKR039W",290).
component("YKL217W",289).
component("YJR077C",267).
component("YJL134W",254).
component("YGR121C",211).
component("YGL186C",204).
component("YFL055W",189).
...
component("YDR046C",140).
component("YDL210W",133).
component("YCL025C",109).
component("YBR291C",106).
component("YBR085W",95).
component("YBR069C",94).
component("YBR068C",93).
component("YBL042C",84).
component("YBL030C",82).
component("U7_",71).
component("U6_",69).
component("U69_",68).
component("U5_",65).
