...
component("YLR056W",757).
component("YGR060W",529).
component("YKR009C",736).
component("YMR083W",838).
component("YPL231W",1013).
component("U46_",158).
component("YBR149W",264).
component("YBR149W",265).
component("YJR159W",699).
component("YGL001C",494).
component("YHR063C",588).
component("U45_",157).
component("YBR153W",266).
component("YML056C",818).
component("YLR432W",806).
component("YHR216W",613).
component("YAR075W",218).
component("YAR073W",217).
component("YCL030C",291).
component("YDR127W",375).
component("YJR139C",694).
component("YML075C",821).
component("YLR450W",809).
component("YOL126C",935).
component("YKL085W",709).
component("YDL078C",322).
component("YKL029C",704).
component("YOR136W",953).
component("YNL037C",871).
component("YNL009W",869).
component("YLR174W",775).
component("YDL066W",320).
component("YHR183W",607).
component("YGR256W",563).
component("YNL241C",887).
component("YOL059W",927).
component("YDL022W",311).
component("YCL018W",289).
component("YLR355C",800).
component("YIL074C",620).
component("YER081W",461).
component("YML054C",817).
component("YDL174C",345).
component("YIL155C",630).
component("YPR191W",1051).
component("YOR065W",943).
component("YJL166W",665).
component("YHR001W-A",574).
component("YGR183C",546).
component("YFR033C",490).
component("YEL024W",431).
component("YDR529C",422).
component("YBL045C",225).
component("Q0105",19).
component("YKR066C",741).
component("YKL026C",703).
component("YIR037W",641).
component("YBR244W",277).
component("YJR078W",685).
component("U58_",170).
component("U107_",29).
component("YGR255C",562).
component("U108_",30).
component("YBL098W",230).
component("YMR015C",834).
component("YHR007C",575).
component("YDR402C",409).
component("YGL055W",503).
component("YGR175C",543).
component("YJR104C",688).
component("YHR008C",576).
component("YJL026W",644).
component("YIL066C",619).
component("YGR180C",545).
component("YER070W",459).
component("U37_",149).
component("U36_",148).
component("U35_",147).
component("YDR158W",383).
component("YJR009C",675).
component("YJL052W",646).
component("YGR192C",549).
component("YBR006W",235).
component("YPL276W",1024).
component("YPL275W",1023).
component("YOR388C",987).
component("YOR374W",984).
component("YER073W",460).
component("U68_",181).
component("YGL154C",511).
component("YBR115C",259).
component("U55_",167).
component("YER069W",457).
component("YOR323C",974).
component("U2_",141).
component("YER178W",473).
component("YBR221C",275).
component("YIL125W",626).
component("YBR166C",269).
component("YNL280C",897).
component("YGL012W",497).
component("YKL182W",722).
component("U57_",169).
component("YKL216W",733).
component("YDR044W",361).
component("YER014W",442).
component("YKR009C",737).
component("YIL160C",632).
component("YGL205W",516).
component("YMR118C",843).
component("YLR164W",773).
component("YLL041C",748).
component("YKL148C",717).
component("YKL141W",715).
component("YJL045W",645).
component("YDR178W",385).
component("YJR051W",680).
component("YEL047C",435).
component("YDL171C",344).
component("YOR375C",985).
component("YDL215C",349).
component("YAL062W",215).
component("U99_",209).
component("U100_",22).
component("YBR035C",245).
component("YMR189W",850).
component("U56_",168).
component("YNR050C",912).
component("YKR080W",743).
component("YER023W",443).
component("YPL023C",991).
component("YGL125W",508).
component("YOR236W",967).
component("YGR204W",553).
component("YBR084W",253).
component("YLR142W",766).
component("U65_",178).
component("U63_",176).
component("U62_",175).
component("YOR356W",982).
component("YHR068W",589).
component("YKL150W",718).
component("YIL043C",617).
component("YHR042W",583).
component("YOR221C",965).
component("YMR145C",846).
component("YML120C",826).
component("YKL192C",726).
component("YKL055C",706).
component("YER061C",453).
component("YDL085W",324).
component("YBR046C",248).
component("YMR145C",847).
component("YML120C",827).
component("YKL192C",727).
component("YDL085W",325).
component("YGR234W",557).
component("YFR030W",489).
component("YPL017C",990).
component("YFL018C",478).
component("YPL091W",996).
component("YHR106W",598).
component("YDR353W",404).
component("YER042W",445).
component("YPR167C",1045).
component("YJR137C",693).
component("YNL052W",873).
component("YMR256C",858).
component("YLR395C",804).
component("YLR038C",755).
component("YIL111W",624).
component("YHR051W",587).
component("YGL191W",514).
component("YGL187C",513).
component("YDL067C",321).
component("Q0275",21).
component("Q0250",20).
component("Q0045",18).
component("YPL266W",1020).
component("YML110C",825).
component("YBR034C",244).
component("YPL273W",1022).
component("YLL062C",751).
component("YDR410C",412).
component("YKR069W",742).
component("YOL096C",930).
component("U47_",159).
component("YER091C",465).
component("YJR073C",683).
component("YGR157W",540).
component("YML008C",810).
component("YDL033C",313).
component("YOL096C",931).
component("YLR172C",774).
component("YLR058C",758).
component("YBR263W",281).
component("YDR019C",357).
component("YBR176W",270).
component("YDR408C",411).
component("YMR120C",844).
component("YLR028C",753).
component("YBL013W",219).
component("YJL130C",657).
component("YJL088W",651).
component("YKL024C",702).
component("YPR074C",1037).
component("YBR117C",260).
component("YLR354C",799).
component("YGR043C",527).
component("YMR108W",841).
component("YCL009C",288).
component("YMR062C",837).
component("YNL071W",874).
component("YIL160C",633).
component("YNR019W",906).
component("YCR048W",306).
component("U48_",160).
component("YNL277W",895).
component("YDR232W",388).
component("YFL017C",477).
component("YPL231W",1014).
component("YER061C",454).
component("U86_",199).
component("YPL001W",989).
component("YDL052C",317).
component("U8_",202).
component("YDR148C",381).
component("YML042W",816).
component("YOR377W",986).
component("YGR177C",544).
component("YPL231W",1015).
component("YGR147C",538).
component("YDL040C",314).
component("YPL028W",992).
component("YLR195C",777).
component("YLR299W",787).
component("YGL017W",498).
component("YPR001W",1026).
component("YNR001C",902).
component("YCR005C",300).
component("YML126C",829).
component("YDL182W",346).
component("YDL131W",334).
component("YNL117W",878).
component("YIR031C",639).
component("YPR160W",1044).
component("YOR321W",973).
component("YJR143C",695).
component("YGR199W",551).
component("YDL095W",329).
component("YDL093W",328).
component("YAL023C",212).
component("YLR258W",784).
component("YFR015C",486).
component("YPL227C",1011).
component("YOR103C",948).
component("YOR085W",945).
component("YMR149W",848).
component("YML019W",812).
component("YJL002C",642).
component("YEL002C",427).
component("YDL232W",350).
component("YCL043C",295).
component("YNL029C",870).
component("YIL085C",622).
component("YMR261C",859).
component("YML100W",823).
component("YBR126C",263).
component("YNL192W",885).
component("YBR038W",247).
component("YBR023C",242).
component("YEL011W",428).
component("YMR306W",867).
component("YLR342W",797).
component("YGR032W",525).
component("YPR183W",1048).
component("YLR209C",778).
component("U104_",26).
component("U103_",25).
component("YMR271C",860).
component("YML106W",824).
component("YOR209C",963).
component("YMR300C",865).
component("YER055C",449).
component("YDR354W",405).
component("YFR047C",491).
component("YJR133W",692).
component("U22_",135).
component("YLR209C",779).
component("YML022W",813).
component("YDR441C",415).
component("YDR399W",407).
component("YHR128W",600).
component("YPR176C",1047).
component("YPL172C",1004).
component("YNR041C",910).
component("YMR101C",839).
component("YDL090C",327).
component("YBR003W",234).
component("YBR002C",233).
component("YJL167W",666).
component("YJL167W",667).
component("YNL256W",890).
component("YPR069C",1035).
component("YDR127W",376).
component("YHR190W",608).
component("YLR146C",767).
component("YHR068W",590).
component("YLR303W",789).
component("YGR012W",523).
component("YML082W",822).
component("YJR130C",691).
component("YDR035W",359).
component("YBR249C",278).
component("YLR180W",776).
component("YDR502C",419).
component("YOR274W",970).
component("YOL143C",938).
component("YBR256C",280).
component("YHR137W",601).
component("YGL202W",515).
component("YLR027C",752).
component("YKL106W",711).
component("YOL140W",937).
component("YLR438W",808).
component("YKL104C",710).
component("YGR019W",524).
component("YDR111C",373).
component("U64_",177).
component("U61_",174).
component("U51_",164).
component("YJR148W",696).
component("YHR208W",611).
component("YFL030W",480).
component("YOR184W",959).
component("YNR058W",914).
component("YIL116W",625).
component("YGL253W",521).
component("YFR053C",492).
component("YOL136C",936).
component("YIL107C",623).
component("YMR013C",833).
component("YMR205C",852).
component("YGR240C",558).
component("YOL016C",919).
component("YFR014C",485).
component("YLR240W",782).
component("YKL203C",729).
component("YJR066W",682).
component("YCR036W",305).
component("YGR194C",550).
component("YCL040W",294).
component("YJR105W",689).
component("U16_",82).
component("YPL188W",1006).
component("YJR049C",679).
component("YEL041W",432).
component("U96_",207).
component("YKL001C",700).
component("YDR236C",389).
component("YML070W",820).
component("YFL053W",482).
component("YHL032C",572).
component("YLR133W",763).
component("YDR531W",424).
component("U83_",196).
component("U82_",195).
component("U81_",194).
component("YMR208W",853).
component("YPL203W",1007).
component("YOR061W",942).
component("YKL166C",720).
component("YJL164C",664).
component("YIL035C",616).
component("YHR205W",610).
component("YHR102W",597).
component("YGL019W",499).
component("YHR025W",582).
component("YOR347C",980).
component("YAL038W",213).
component("YNR012W",904).
component("YPR121W",1041).
component("YPL258C",1017).
component("YOL055C",923).
component("YPL214C",1010).
component("U1_",113).
component("YDR009W",356).
component("YBR020W",241).
component("YNL267W",893).
component("YLR305C",791).
component("YFR019W",487).
component("YDR208W",386).
component("YDR127W",377).
component("U21_",126).
component("U20_",121).
component("YDR147W",380).
component("YDR300C",398).
component("YCR012W",301).
component("YER052C",447).
component("YER069W",458).
component("U19_",112).
component("U18_",102).
component("U17_",91).
component("U76_",190).
component("YMR220W",855).
component("YER170W",472).
component("YDR226W",387).
component("YKL067W",708).
component("YOL055C",924).
component("YDR454C",416).
component("YOL061W",928).
component("YKL181W",721).
component("YHL011C",569).
component("YER099C",467).
component("YBL068W",228).
component("YOR143C",954).
component("YNL256W",891).
component("YLR328W",795).
component("YBR018C",237).
component("YBR018C",238).
component("YDL055C",318).
component("YGR007W",522).
component("YGR202C",552).
component("YLR328W",796).
component("YKR002W",735).
component("YDL045C",315).
component("YDL103C",332).
component("U94_",206).
component("YJR010W",676).
component("YBR029C",243).
component("YCL050C",296).
component("YGL130W",509).
component("YDR530C",423).
component("YCL050C",297).
component("YPR190C",1050).
component("YPR187W",1049).
component("YPR110C",1039).
component("YPR010C",1028).
component("YOR341W",979).
component("YOR340C",978).
component("YOR224C",966).
component("YOR210W",964).
component("YOR207C",962).
component("YOR151C",955).
component("YOR116C",949).
component("YOL005C",916).
component("YNR003C",903).
component("YNL248C",889).
component("YNL151C",883).
component("YNL113W",877).
component("YKL144C",716).
component("YJR063W",681).
component("YJL148W",661).
component("YJL140W",660).
component("YIL021W",615).
component("YHR143W-A",602).
component("YGL070C",507).
component("YFL036W",481).
component("YDR404C",410).
component("YDR156W",382).
component("YDR045C",362).
component("YDL150W",342).
component("YDL140C",336).
component("YBR154C",268).
component("YPR175W",1046).
component("YPL167C",1003).
component("YOR330C",975).
component("YOL115W",934).
component("YNL299W",899).
component("YNL262W",892).
component("YNL102W",876).
component("YJR043C",678).
component("YJR006W",674).
component("YJL090C",652).
component("YIL139C",628).
component("YEL055C",436).
component("YDR419W",413).
component("YDR121W",374).
component("YDL102W",331).
component("YCR014C",302).
component("YBR278W",282).
component("YBL035C",222).
component("YKL035W",705).
component("YHL012W",570).
component("YHR123W",599).
component("YPR113W",1040).
component("YBR243C",276).
component("YNL130C",879).
component("YDL142C",341).
component("YPL148C",1001).
component("YER026C",444).
component("YOR251C",969).
component("YGR286C",566).
component("YJL068C",647).
component("YDR058C",367).
component("YNR034W",909).
component("YHR163W",605).
component("YGR248W",560).
component("YCR073W-A",308).
component("YDL086W",326).
component("YOL011W",918).
component("YMR008C",831).
component("YMR006C",830).
component("U105_",27).
component("U101_",23).
component("YJL068C",648).
component("YPL072W",995).
component("YOR124C",950).
component("YNL186W",884).
component("YMR304W",866).
component("YMR223W",856).
component("YKR098C",746).
component("YJL197W",668).
component("YIL156W",631).
component("YFR010W",484).
component("YER151C",471).
component("YER144C",470).
component("YER098W",466).
component("YDR069C",369).
component("YDL122W",333).
component("YBR058C",249).
component("YBL067C",227).
component("YJR019C",677).
component("YDR272W",393).
component("U84_",197).
component("YDR481C",417).
component("YLR377C",802).
component("YDR074W",370).
component("YFR025C",488).
component("YPL179W",1005).
component("YNR032W",907).
component("YML057W",819).
component("YML016C",811).
component("YLR433C",807).
component("YGR123C",534).
component("YER133W",469).
component("YER089C",463).
component("YDR436W",414).
component("YDR075W",371).
component("YDL188C",347).
component("YDL134C",335).
component("YDL047W",316).
component("YDL006W",309).
component("YBR125C",262).
component("YBL056W",226).
component("YPR073C",1036).
component("YHR215W",612).
component("YDL024C",312).
component("YBR093C",257).
component("YBR092C",256).
component("YIL053W",618).
component("YER062C",455).
component("YHR046C",586).
component("U9_",210).
component("YGR208W",556).
component("YPL228W",1012).
component("YMR180C",849).
component("YDL236W",351).
component("YJL155C",663).
component("U34_",146).
component("U33_",145).
component("U32_",144).
component("U31_",143).
...
component("U26_",137).
component("U24_",136).
component("YHR044C",585).
component("YHR043C",584).
component("YOL064C",929).
component("YPL268W",1021).
component("YOR360C",983).
component("YGL248W",520).
component("YKR031C",738).
component("YPL206C",1008).
component("YGL027C",501).
component("YLR286C",786).
component("YJR153W",697).
component("YJL221C",673).
component("YJL216C",671).
component("YIL172C",637).
component("YGR292W",568).
component("YGR287C",567).
component("YBR299W",287).
component("YBR184W",271).
component("YIL162W",634).
component("YPR026W",1029).
component("YDR001C",354).
component("YBR001C",232).
component("YOR190W",960).
component("YLR300W",788).
component("YGR282C",565).
component("YDR261C",391).
component("YDR400W",408).
component("YML035C",814).
component("YJL070C",649).
component("YBR284W",283).
component("U106_",28).
component("U102_",24).
component("YER043C",446).
component("YNL045W",872).
component("YLR160C",772).
component("YLR158C",771).
component("YLR157C",770).
component("YLR155C",769).
component("YDR321W",399).
component("YGL037C",502).
component("U43_",155).
component("U42_",154).
component("YMR293C",864).
component("YDR242W",390).
component("YLR308W",794).
component("YLR307W",793).
component("YBR208C",273).
component("YMR281W",863).
component("U53_",165).
component("YLR420W",805).
component("YPL111W",999).
component("YIR032C",640).
component("YIR029W",638).
component("YPR062W",1034).
component("YMR120C",845).
component("YLR028C",754).
component("YHR144C",603).
component("YHR144C",604).
component("YCL030C",292).
component("YNL141W",880).
component("YBL033C",221).
component("YBR153W",267).
component("YDL238C",352).
component("YNL141W",881).
component("YLR245C",783).
component("YML035C",815).
component("YGR204W",554).
component("YBR084W",254).
component("YJL126W",655).
component("U44_",156).
component("YDL100C",330).
component("U40_",152).
component("U39_",150).
component("YBR011C",236).
component("YHR201C",609).
component("YBR111C",258).
component("YBR252W",279).
component("YCL030C",293).
component("YEL042W",433).
component("YER005W",441).
component("YBL099W",231).
component("U60_",173).
component("YLR231C",780).
component("U88_",200).
component("YDR538W",426).
component("YLR134W",764).
component("YLR044C",756).
component("YGR087C",531).
component("YDR380W",406).
component("YDL080C",323).
component("U98_",208).
component("YMR250W",857).
component("YKL184W",725).
component("YOR128C",951).
component("YEL021W",430).
component("YNR043W",911).
component("U93_",205).
component("YDR047W",364).
component("U54_",166).
component("YKL211C",731).
component("YKR097W",745).
component("YOL052C",922).
component("YGR170W",541).
component("YKL060C",707).
component("YDR294C",395).
component("YEL046C",434).
component("YNR033W",908).
component("YPR006C",1027).
component("YER065C",456).
component("YKL211C",732).
component("YER090W",464).
component("YDR127W",378).
component("YPL281C",1025).
component("YOR393W",988).
component("YMR323W",868).
component("YHR174W",606).
component("YGR254W",561).
component("YPL262W",1018).
component("YGL026C",500).
component("YGR155W",539).
component("YLR304C",790).
component("YJL200C",669).
component("YGL009C",496).
component("YNL316C",900).
component("YKL182W",723).
component("YPL212C",1009).
component("YNL292W",898).
component("YGL063W",506).
component("YFL001W",475).
component("YOR278W",971).
component("U49_",161).
component("YCR053W",307).
component("YDR127W",379).
component("YGL148W",510).
component("YIL168W",636).
component("YIL167W",635).
component("YCL064C",298).
component("YCL064C",299).
component("YHR018C",578).
component("YLR359W",801).
component("YAL012W",211).
component("YFR055W",493).
component("YJL005W",643).
component("YOR176W",958).
component("YJL121C",654).
component("YBR019C",239).
component("YBR019C",240).
component("U59_",171).
component("YDR050C",365).
component("YIL020C",614).
component("YDR007W",355).
component("YOR095C",946).
component("YER003C",440).
component("YBR196C",272).
component("YGL001C",495).
component("YPL117C",1000).
component("U14_",67).
component("YOL056W",925).
component("YKL152C",719).
component("YDL021W",310).
component("YMR105C",840).
component("YKL127W",713).
component("YEL058W",437).
component("YMR278W",862).
component("YPR060C",1033).
component("YHR072W",591).
component("YJL153C",662).
component("YPL097W",997).
component("YGR185C",547).
component("YGR264C",564).
component("YGR171C",542).
component("YHR011W",577).
component("YDR023W",358).
component("YPL104W",998).
component("YLL018C",747).
component("YPR081C",1038).
component("YBR121C",261).
component("YHR020W",581).
component("YER087W",462).
component("YNL247W",888).
component("YOL033W",921).
component("YGL245W",519).
component("YOR168W",956).
component("YHR091C",593).
component("YDR341C",400).
component("YOL097C",932).
component("YDR268W",392).
component("YPR047W",1032).
component("YLR060W",759).
component("YFL022C",479).
component("YPR033C",1030).
component("YHR019C",579).
component("YHR019C",580).
component("YKL194C",728).
component("YIL078W",621).
component("YPL160W",1002).
component("YLR382C",803).
component("YPL040C",993).
component("YBL076C",229).
component("YNL073W",875).
component("YDR037W",360).
component("YOR335C",976).
component("YGR094W",532).
component("YLR153C",768).
component("YAL054C",214).
component("YGR244C",559).
component("YPR035W",1031).
component("YIL145C",629).
component("U89_",201).
component("YOR241W",968).
component("YMR113W",842).
component("YKL132C",714).
component("YOR339C",977).
component("YMR022W",835).
component("YLR306W",792).
component("YKL210W",730).
component("YGR133W",537).
component("YGL058W",504).
component("YER100W",468).
component("YEL012W",429).
component("YDR177W",384).
component("YDR092W",372).
component("YDR059C",368).
component("YDR054C",366).
component("YDL064W",319).
component("YBR082C",252).
component("YJL101C",653).
component("U92_",204).
component("YAR015W",216).
component("YGL234W",517).
component("YER183C",474).
component("U90_",203).
component("YNR057C",913).
component("YDL141W",337).
component("YDL141W",338).
component("YGL234W",518).
component("YDL141W",339).
component("YJR103W",687).
component("YBL039C",223).
component("YGR204W",555).
component("YNL220W",886).
component("YOL058W",926).
component("YDL141W",340).
component("YHR074W",592).
component("YMR217W",854).
component("YPR145W",1043).
component("YGR124W",535).
component("YOR303W",972).
component("YJR109C",690).
component("YJL130C",658).
component("YGL062W",505).
component("YBR218C",274).
component("YPL231W",1016).
component("YNR016C",905).
component("YKL182W",724).
component("YGR037C",526).
component("YOR005C",940).
component("YDL164C",343).
component("YJL087C",650).
component("YOL010W",917).
component("YPR138C",1042).
component("YPL265W",1019).
component("YPL057C",994).
component("YOR348C",981).
component("YOR192C",961).
component("YOR171C",957).
component("YOR130C",952).
component("YOR100C",947).
component("YOR071C",944).
component("YOR011W",941).
component("YOL156W",939).
component("YOL103W",933).
component("YOL020W",920).
component("YNR072W",915).
component("YNL318C",901).
component("YNL270C",894).
component("YNL142W",882).
component("YMR272C",861).
component("YMR202W",851).
component("YMR056C",836).
component("YMR011W",832).
component("YML123C",828).
component("YLR348C",798).
component("YLR260W",785).
component("YLR237W",781).
component("YLR138W",765).
component("YLR100C",762).
component("YLR092W",761).
component("YLR081W",760).
component("YLL061W",750).
component("YLL043W",749).
component("YKR093W",744).
component("YKR053C",740).
component("YKR039W",739).
component("YKL217W",734).
component("YKL120W",712).
component("YKL004W",701).
component("YJR158W",698).
component("YJR095W",686).
component("YJR077C",684).
component("YJL219W",672).
component("YJL214W",670).
component("YJL134W",659).
component("YJL129C",656).
component("YIL134W",627).
component("YHR096C",596).
component("YHR094C",595).
component("YHR092C",594).
component("YHL036W",573).
component("YHL016C",571).
component("YGR191W",548).
component("YGR125W",536).
component("YGR121C",533).
component("YGR065C",530).
component("YGR055W",528).
component("YGL186C",512).
component("YFL055W",483).
component("YFL011W",476).
component("YER060W-A",452).
component("YER060W",451).
component("YER056C",450).
component("YER053C",448).
component("YEL069C",439).
component("YEL063C",438).
component("YDR536W",425).
component("YDR508C",421).
component("YDR503C",420).
component("YDR497C",418).
component("YDR345C",403).
component("YDR343C",402).
component("YDR342C",401).
component("YDR297W",397).
component("YDR294C",396).
component("YDR284C",394).
component("YDR046C",363).
component("YDL245C",353).
component("YDL210W",348).
component("YCR032W",304).
component("YCR028C",303).
component("YCL025C",290).
component("YBR298C",286).
component("YBR294W",285).
component("YBR291C",284).
component("YBR085W",255).
component("YBR069C",251).
component("YBR068C",250).
component("YBR036C",246).
