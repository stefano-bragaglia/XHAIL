...
component("YNL280C",703).
component("YLR056W",596).
...
component("YOR136W",748).
component("YNL009W",680).
component("YLR174W",610).
component("YDL066W",244).
component("YHR183W",471).
component("YGR256W",438).
component("YNL241C",696).
component("YOL059W",729).
component("YDL022W",238).
component("YCL018W",221).
component("YLR355C",630).
component("YIL074C",483).
component("YER081W",354).
component("YML054C",642).
component("YIL155C",489).
component("YEL024W",332).
component("YKR066C",582).
...
component("YMR189W",666).
component("U56_",131).
component("YKR080W",584).
component("YPL023C",778).
component("YGL125W",393).
component("YOR236W",760).
component("YGR204W",430).
component("YBR084W",191).
component("YLR142W",604).
component("U65_",137).
component("U62_",135).
component("YHR068W",459).
component("YKL150W",561).
component("YIL043C",480).
component("YHR042W",453).
component("YOR221C",758).
component("YMR145C",663).
component("YML120C",648).
component("YKL192C",569).
component("YKL055C",551).
component("YER061C",347).
component("YDL085W",247).
component("YBR046C",187).
component("YMR145C",664).
component("YML120C",649).
component("YKL192C",570).
component("YDL085W",248).
component("YPL017C",777).
component("YFL018C",369).
component("YPL091W",781).
component("YER042W",341).
component("YPR167C",823).
component("YNL052W",683).
component("YMR256C",674).
component("YLR395C",634).
component("YLR038C",594).
component("YIL111W",486).
component("YHR051W",457).
component("YGL191W",399).
component("YGL187C",398).
component("YDL067C",245).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",802).
component("YBR034C",184).
component("YPL273W",804).
component("YLL062C",590).
component("YDR410C",317).
component("YKR069W",583).
component("YOL096C",732).
component("U47_",124).
component("YER091C",358).
component("YJR073C",534).
component("YML008C",639).
component("YDL033C",240).
component("YOL096C",733).
component("YLR172C",609).
component("YBR263W",214).
component("YDR408C",316).
component("YMR120C",662).
component("YLR028C",592).
component("YBL013W",167).
component("YJL130C",510).
component("YJL088W",504).
component("YPR074C",816).
component("YBR117C",197).
component("YLR354C",629).
component("YGR043C",411).
component("YMR108W",660).
component("YCL009C",220).
component("YMR062C",657).
component("YNL071W",684).
component("YIL160C",492).
component("YNR019W",713).
component("YCR048W",234).
component("U48_",125).
component("YNL277W",702).
component("YDR232W",299).
component("YFL017C",368).
component("YPL231W",796).
component("YER061C",348).
component("U86_",155).
component("YPL001W",776).
component("YDL052C",242).
component("U8_",158).
component("YDR148C",294).
component("YOR377W",774).
component("YGR177C",423).
component("YPL231W",797).
component("YLR195C",612).
component("YLR299W",621).
component("YPR001W",806).
component("YNR001C",709).
component("YCR005C",230).
component("YML126C",651).
component("YDL182W",265).
component("YDL131W",255).
component("YNL117W",688).
component("YIR031C",497).
component("YPR160W",822).
component("YOR321W",764).
component("YJR143C",543).
component("YGR199W",428).
component("YDL095W",250).
component("YDL093W",249).
component("YAL023C",163).
component("YLR258W",618).
component("YFR015C",375).
component("YPL227C",793).
component("YNL029C",681).
component("YIL085C",485).
component("YMR261C",675).
component("YML100W",647).
component("YBR126C",200).
component("YNL192W",695).
component("YBR038W",186).
component("YBR023C",182).
component("YEL011W",330).
component("YLR209C",613).
component("U104_",24).
component("U103_",23).
component("YOR209C",756).
component("YMR300C",677).
component("YDR354W",310).
component("YFR047C",378).
component("YJR133W",541).
component("U22_",102).
component("YLR209C",614).
...
component("YHR190W",472).
component("YHR068W",460).
component("YLR303W",622).
component("YGR012W",408).
component("YML082W",646).
component("YJR130C",540).
component("YDR035W",275).
component("YBR249C",211).
component("YLR180W",611).
component("YDR502C",323).
component("YOL143C",738).
component("YBR256C",213).
component("YHR137W",466).
component("YGL202W",400).
component("YLR027C",591).
component("YKL106W",555).
component("YOL140W",737).
component("YLR438W",638).
component("YKL104C",554).
component("YGR019W",409).
component("YDR111C",286).
component("U64_",136).
component("U51_",128).
component("YJR148W",544).
component("YHR208W",475).
component("YOR184W",753).
component("YNR058W",718).
component("YGL253W",406).
component("YFR053C",379).
component("YMR013C",654).
component("YMR205C",668).
component("YGR240C",434).
component("YLR240W",617).
component("YKL203C",572).
component("YJR066W",533).
component("YCR036W",233).
component("YGR194C",427).
component("YCL040W",226).
component("YJR105W",538).
component("U16_",67).
component("YPL188W",789).
component("YJR049C",530).
component("YEL041W",333).
component("YKL001C",547).
component("YDR236C",300).
component("YML070W",645).
component("YFL053W",372).
component("YHL032C",445).
component("YLR133W",601).
component("YDR531W",327).
component("U83_",152).
component("U82_",151).
component("U81_",150).
component("YMR208W",669).
component("YPL203W",790).
component("YOR061W",742).
component("YKL166C",563).
component("YJL164C",517).
component("YIL035C",479).
component("YHR205W",474).
component("YHR102W",464).
component("YGL019W",385).
component("YHR025W",452).
component("YNR012W",711).
component("YPR121W",819).
component("YPL258C",799).
component("YOL055C",725).
component("YPL214C",792).
component("U1_",87).
component("YDR009W",273).
component("YBR020W",181).
component("YFR019W",376).
component("YDR208W",297).
...
component("YPR110C",818).
component("YPR010C",808).
component("YOR341W",769).
component("YOR340C",768).
component("YOR224C",759).
component("YOR210W",757).
component("YOR207C",755).
component("YOR151C",750).
component("YOR116C",745).
component("YOL005C",719).
...
component("YIL021W",478).
component("YHR143W-A",467).
component("YGL070C",392).
component("YFL036W",371).
...
component("YPR175W",824).
component("YPL167C",787).
component("YOR330C",766).
component("YOL115W",736).
component("YNL299W",706).
component("YNL262W",700).
component("YNL102W",686).
component("YJR043C",529).
component("YJR006W",525).
component("YJL090C",505).
component("YIL139C",487).
component("YEL055C",336).
...
component("YHL012W",444).
component("YHR123W",465).
component("YNL130C",689).
component("YPL148C",785).
component("YOR251C",762).
component("YGR286C",440).
component("YDR058C",282).
component("YOL011W",721).
component("YMR008C",653).
component("YMR006C",652).
component("U105_",25).
component("U101_",21).
component("YJL068C",502).
component("YPL072W",780).
component("YOR124C",746).
component("YNL186W",694).
component("YMR304W",678).
component("YMR223W",672).
component("YKR098C",587).
component("YJL197W",520).
component("YIL156W",490).
component("YFR010W",374).
component("YER151C",363).
component("YER144C",362).
component("YER098W",359).
component("YDR069C",283).
component("YDL122W",254).
component("YBR058C",188).
component("YBL067C",172).
component("YJR019C",528).
component("YDR272W",303).
component("U84_",153).
component("YDR481C",321).
component("YLR377C",632).
component("YDR074W",284).
component("YFR025C",377).
component("YPL179W",788).
component("YNR032W",714).
component("YML057W",644).
component("YML016C",640).
component("YLR433C",637).
component("YGR123C",417).
component("YER133W",361).
component("YER089C",356).
component("YDR436W",319).
component("YDR075W",285).
...
component("YIL053W",481).
component("YER062C",349).
component("YHR046C",456).
component("U9_",162).
component("YGR208W",433).
component("YPL228W",794).
component("YMR180C",665).
component("YDL236W",269).
component("YJL155C",516).
component("U34_",112).
component("U33_",111).
component("U32_",110).
component("U30_",109).
...
component("U26_",104).
component("U24_",103).
component("YHR044C",455).
component("YHR043C",454).
component("YOL064C",731).
component("YPL268W",803).
component("YOR360C",771).
component("YGL248W",405).
component("YKR031C",579).
component("YGL027C",387).
component("YLR286C",620).
component("YJR153W",545).
component("YJL221C",524).
component("YJL216C",522).
component("YIL172C",496).
component("YGR292W",442).
component("YGR287C",441).
component("YBR299W",219).
component("YBR184W",206).
component("YIL162W",493).
component("YPR026W",809).
component("YDR001C",271).
component("YBR001C",176).
component("YDR400W",313).
component("U102_",22).
component("YER043C",342).
component("YNL045W",682).
component("YLR160C",608).
component("YLR158C",607).
component("YLR157C",606).
component("YLR155C",605).
component("YDR321W",308).
component("YGL037C",388).
component("U43_",121).
component("U42_",120).
component("YDR242W",301).
component("YLR308W",625).
component("YLR307W",624).
component("U53_",129).
component("YLR420W",635).
component("YPL111W",783).
component("YIR032C",498).
component("YLR028C",593).
component("YHR144C",468).
...
component("YHR201C",473).
component("YBR111C",196).
component("YBR252W",212).
component("YCL030C",225).
component("YER005W",339).
component("YBL099W",175).
component("YLR231C",615).
component("U88_",156).
component("YDR538W",329).
component("YLR134W",602).
component("YLR044C",595).
component("YGR087C",414).
component("YDR380W",311).
component("YDL080C",246).
component("YMR250W",673).
component("YKL184W",568).
component("YEL021W",331).
component("YNR043W",716).
component("U93_",160).
component("YDR047W",280).
component("YKL211C",573).
component("YKR097W",586).
component("YOL052C",724).
component("YGR170W",421).
component("YDR294C",304).
component("YEL046C",334).
component("YNR033W",715).
component("YPR006C",807).
component("YER065C",350).
component("YKL211C",574).
component("YER090W",357).
component("YDR127W",291).
component("YPL281C",805).
component("YOR393W",775).
component("YMR323W",679).
component("YHR174W",470).
component("YGR254W",436).
component("YPL262W",800).
component("YGL026C",386).
component("YGR155W",420).
component("YLR304C",623).
component("YJL200C",521).
component("YGL009C",383).
component("YNL316C",707).
component("YKL182W",566).
component("YPL212C",791).
component("YNL292W",705).
component("YGL063W",391).
component("YFL001W",366).
component("YCR053W",235).
component("YDR127W",292).
component("YGL148W",395).
component("YIL168W",495).
component("YIL167W",494).
component("YCL064C",228).
component("YCL064C",229).
component("YHR018C",448).
component("YLR359W",631).
component("YFR055W",380).
component("YJL121C",507).
component("YBR019C",180).
component("YDR050C",281).
component("YDR007W",272).
component("YOR095C",744).
component("YBR196C",207).
component("YGL001C",382).
component("YPL117C",784).
component("U14_",55).
component("YOL056W",727).
component("YKL152C",562).
component("YDL021W",237).
component("YMR105C",659).
component("YKL127W",557).
component("YEL058W",337).
component("YPR060C",813).
component("YHR072W",461).
component("YJL153C",515).
component("YGR264C",439).
component("YGR171C",422).
component("YHR011W",447).
component("YDR023W",274).
component("YPL104W",782).
component("YLL018C",588).
component("YPR081C",817).
component("YBR121C",198).
component("YHR020W",451).
component("YER087W",355).
component("YOL033W",723).
component("YGL245W",404).
component("YOR168W",751).
component("YHR091C",463).
component("YDR341C",309).
component("YOL097C",734).
component("YDR268W",302).
component("YPR047W",812).
component("YLR060W",597).
component("YFL022C",370).
component("YPR033C",810).
component("YHR019C",449).
component("YHR019C",450).
component("YKL194C",571).
component("YIL078W",484).
component("YPL160W",786).
component("YLR382C",633).
component("YPL040C",779).
component("YBL076C",174).
component("YNL073W",685).
component("YDR037W",276).
component("YOR335C",767).
component("YGR094W",415).
component("YGR244C",435).
component("YPR035W",811).
component("YIL145C",488).
component("U89_",157).
component("YOR241W",761).
component("YMR113W",661).
component("YKL132C",558).
component("YJL101C",506).
component("YGL234W",402).
component("YER183C",365).
component("U90_",159).
component("YNR057C",717).
...
component("YMR217W",670).
component("YPR145W",821).
component("YGR124W",418).
component("YOR303W",763).
component("YJR109C",539).
component("YJL130C",511).
component("YGL062W",390).
component("YBR218C",208).
component("YPL231W",798).
component("YNR016C",712).
component("YKL182W",567).
component("YGR037C",410).
component("YOR005C",740).
component("YDL164C",263).
component("YJL087C",503).
component("YOL010W",720).
component("YPR138C",820).
component("YPL265W",801).
component("YOR348C",770).
component("YOR192C",754).
component("YOR171C",752).
component("YOR130C",747).
component("YOR071C",743).
component("YOR011W",741).
component("YOL156W",739).
component("YOL103W",735).
component("YOL020W",722).
component("YNL318C",708).
component("YNL270C",701).
component("YNL142W",692).
component("YMR272C",676).
component("YMR202W",667).
component("YMR056C",656).
component("YML123C",650).
component("YLR348C",628).
component("YLR260W",619).
component("YLR237W",616).
component("YLR138W",603).
component("YLR100C",600).
component("YLR092W",599).
component("YLR081W",598).
component("YLL061W",589).
component("YKR093W",585).
component("YKR053C",581).
component("YKR039W",580).
component("YKL217W",576).
component("YKL120W",556).
component("YKL004W",548).
component("YJR095W",537).
component("YJR077C",535).
component("YJL219W",523).
component("YJL134W",512).
component("YJL129C",509).
component("YHL036W",446).
component("YGR191W",425).
component("YGR125W",419).
component("YGR121C",416).
component("YGR065C",413).
component("YGR055W",412).
component("YGL186C",397).
component("YFL055W",373).
component("YFL011W",367).
component("YER060W-A",346).
component("YER060W",345).
component("YER056C",344).
component("YEL063C",338).
