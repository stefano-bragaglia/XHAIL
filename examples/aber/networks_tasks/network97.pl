...
component("YLR056W",468).
component("YKR009C",455).
component("YMR083W",518).
component("YPL231W",633).
component("YJR159W",432).
component("YGL001C",300).
component("YHR063C",362).
component("YML056C",504).
component("YLR432W",499).
component("YHR216W",378).
component("YAR075W",128).
component("YAR073W",127).
component("YCL030C",173).
component("YDR127W",226).
component("YJR139C",428).
component("YOR136W",593).
component("YNL009W",537).
component("YLR174W",480).
component("YDL066W",190).
component("YHR183W",373).
component("YGR256W",347).
component("YNL241C",552).
component("YOL059W",580).
component("YDL022W",185).
component("YCL018W",171).
component("YLR355C",494).
component("YML054C",503).
component("YIL155C",387).
component("YEL024W",258).
component("YJR078W",424).
component("U58_",102).
component("YGR255C",346).
component("U108_",26).
component("YMR015C",515).
component("YDR402C",243).
component("YGL055W",307).
component("YJL026W",396).
component("YIL066C",383).
component("YGR180C",337).
component("YER070W",274).
component("U36_",89).
component("U35_",88).
component("YJR009C",415).
component("YJL052W",397).
component("YGR192C",339).
component("YOR374W",614).
component("YER073W",275).
component("U68_",106).
component("YGL154C",313).
component("U55_",100).
component("YER069W",273).
component("YOR323C",607).
component("U2_",83).
component("YBR221C",163).
component("YBR166C",159).
component("YNL280C",559).
component("YGL012W",302).
component("YKL182W",446).
component("YER014W",262).
component("YKR009C",456).
component("YIL160C",389).
component("YGL205W",318).
component("YKL141W",441).
component("YJR051W",419).
component("YOR375C",615).
component("YDL215C",210).
component("YAL062W",126).
component("U100_",20).
component("YBR035C",144).
component("YMR189W",525).
component("U56_",101).
component("YPL023C",619).
component("YGL125W",311).
component("YOR236W",602).
component("YGR204W",342).
component("YBR084W",150).
component("YLR142W",474).
component("U65_",105).
component("U62_",104).
component("YHR068W",363).
component("YKL150W",443).
component("YIL043C",381).
component("YHR042W",357).
component("YOR221C",600).
component("YMR145C",523).
component("YML120C",509).
component("YKL192C",449).
component("YKL055C",435).
component("YER061C",269).
component("YDL085W",193).
component("YBR046C",146).
component("YPL017C",618).
component("YFL018C",289).
component("YPL091W",622).
component("YER042W",263).
component("YNL052W",539).
component("YMR256C",532).
component("YLR395C",497).
component("YLR038C",466).
component("YIL111W",385).
component("YHR051W",361).
component("YGL191W",316).
component("YGL187C",315).
component("YDL067C",191).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",639).
component("YPL273W",641).
component("YLL062C",463).
component("YDR410C",245).
component("YER091C",279).
component("YJR073C",422).
component("YDL033C",186).
component("YOL096C",583).
component("YLR172C",479).
component("YMR120C",522).
component("YBL013W",129).
component("YJL130C",405).
component("YJL088W",400).
component("YPR074C",651).
component("YBR117C",154).
component("YMR108W",520).
component("YCL009C",170).
component("YMR062C",517).
component("YNL071W",540).
component("YIL160C",390).
component("YNR019W",567).
component("YCR048W",182).
component("U48_",95).
component("YNL277W",557).
component("YFL017C",288).
component("YPL231W",634).
component("YER061C",270).
component("U86_",118).
component("YDL052C",188).
component("U8_",121).
component("YDR148C",232).
component("YOR377W",616).
component("YGR177C",336).
component("YPL231W",635).
component("YLR195C",482).
component("YLR299W",488).
component("YPR001W",643).
component("YNR001C",563).
component("YCR005C",178).
component("YML126C",511).
component("YDL182W",207).
component("YDL131W",199).
component("YNL117W",544).
component("YIR031C",394).
component("YOR321W",606).
component("YJR143C",429).
component("YGR199W",341).
component("YDL095W",195).
component("YDL093W",194).
component("YAL023C",125).
component("YPL227C",631).
component("YMR261C",533).
component("YML100W",508).
component("YBR126C",156).
component("YNL192W",551).
component("YBR038W",145).
component("YBR023C",142).
component("YLR209C",483).
component("U104_",24).
component("U103_",23).
component("YDR354W",239).
component("YFR047C",297).
component("YJR133W",427).
component("U22_",78).
component("YLR209C",484).
component("YDR399W",241).
component("YJL167W",412).
component("YNL256W",554).
component("YPR069C",650).
component("YDR127W",227).
component("YHR190W",374).
component("YHR068W",364).
component("YLR303W",489).
component("YML082W",507).
component("YJR130C",426).
component("YDR035W",216).
component("YBR249C",164).
component("YLR180W",481).
component("YDR502C",251).
component("YOL143C",587).
component("YBR256C",166).
component("YHR137W",368).
component("YGL202W",317).
component("YLR027C",464).
component("YKL106W",438).
component("YOL140W",586).
component("YLR438W",501).
component("YKL104C",437).
component("YGR019W",324).
component("YDR111C",224).
component("U51_",98).
component("YJR148W",430).
component("YHR208W",377).
component("YOR184W",597).
component("YNR058W",572).
component("YGL253W",323).
component("YFR053C",298).
component("YMR013C",514).
component("YLR240W",486).
component("YKL203C",451).
component("YJR066W",421).
component("YCR036W",181).
component("YGR194C",340).
component("YCL040W",175).
component("YJR105W",425).
component("U16_",53).
component("YKL001C",433).
component("YML070W",506).
component("YFL053W",292).
component("YDR531W",254).
component("U82_",117).
component("U81_",116).
component("YMR208W",527).
component("YPL203W",629).
component("YOR061W",588).
component("YKL166C",444).
component("YJL164C",411).
component("YIL035C",380).
component("YHR205W",376).
component("YHR102W",366).
component("YGL019W",303).
component("YHR025W",356).
component("YNR012W",565).
component("YPR121W",653).
component("YPL258C",637).
component("YOL055C",578).
component("U1_",68).
component("YDR009W",214).
component("YBR020W",141).
component("YFR019W",295).
component("YDR208W",234).
component("YDR127W",228).
component("U21_",75).
component("YDR147W",231).
component("YCR012W",179).
component("YER052C",265).
component("U19_",67).
component("U18_",62).
component("U17_",58).
component("U76_",113).
component("YMR220W",529).
component("YER170W",285).
component("YDR226W",235).
component("YKL067W",436).
component("YOL055C",579).
component("YDR454C",248).
component("YOL061W",581).
component("YKL181W",445).
component("YHL011C",350).
component("YER099C",281).
component("YBL068W",135).
component("YOR143C",594).
component("YNL256W",555).
component("YBR018C",139).
component("YDL055C",189).
component("YLR328W",492).
component("YDL103C",197).
component("U94_",123).
component("YJR010W",416).
component("YBR029C",143).
component("YPR190C",658).
component("YPR187W",657).
component("YPR110C",652).
component("YPR010C",645).
component("YOR341W",611).
component("YOR340C",610).
component("YOR224C",601).
component("YOR210W",599).
component("YOR207C",598).
component("YOR151C",595).
component("YOR116C",590).
component("YOL005C",573).
component("YNR003C",564).
component("YNL248C",553).
component("YNL151C",549).
component("YNL113W",543).
component("YKL144C",442).
component("YJR063W",420).
component("YJL148W",408).
component("YJL140W",407).
component("YIL021W",379).
component("YHR143W-A",369).
component("YGL070C",310).
component("YFL036W",291).
component("YDR404C",244).
component("YDR156W",233).
component("YDR045C",218).
component("YDL150W",206).
component("YDL140C",201).
component("YBR154C",158).
component("YPR175W",656).
component("YPL167C",627).
component("YOR330C",608).
component("YOL115W",585).
component("YNL299W",561).
component("YNL262W",556).
component("YNL102W",542).
component("YJR043C",418).
component("YJR006W",414).
component("YJL090C",401).
component("YIL139C",386).
component("YEL055C",259).
component("YDR419W",246).
component("YDR121W",225).
component("YDL102W",196).
component("YCR014C",180).
component("YBR278W",167).
component("YBL035C",131).
component("YKL035W",434).
component("YHL012W",351).
component("YHR123W",367).
component("YNL130C",545).
component("YPL148C",625).
component("YOR251C",604).
component("YGR286C",349).
...
component("YPL072W",621).
component("YOR124C",591).
component("YNL186W",550).
component("YMR304W",535).
component("YMR223W",530).
component("YKR098C",461).
component("YJL197W",413).
component("YIL156W",388).
component("YFR010W",294).
component("YER151C",284).
component("YER144C",283).
component("YER098W",280).
component("YDR069C",221).
component("YDL122W",198).
component("YBR058C",147).
component("YBL067C",134).
component("YJR019C",417).
component("YDR481C",249).
component("YDR074W",222).
component("YFR025C",296).
component("YPL179W",628).
component("YNR032W",568).
component("YML057W",505).
component("YML016C",502).
component("YLR433C",500).
component("YGR123C",331).
component("YER133W",282).
component("YER089C",277).
component("YDR436W",247).
component("YDR075W",223).
component("YDL188C",208).
component("YDL134C",200).
component("YDL047W",187).
component("YDL006W",184).
component("YBR125C",155).
component("YBL056W",133).
component("YIL053W",382).
component("YER062C",271).
component("YHR046C",360).
component("U9_",124).
component("YGR208W",344).
component("YPL228W",632).
component("YMR180C",524).
...
component("U26_",80).
component("U24_",79).
component("YHR044C",359).
component("YHR043C",358).
component("YOL064C",582).
component("YPL268W",640).
component("YOR360C",613).
component("YGL248W",322).
component("YKR031C",457).
component("YGL027C",305).
component("YLR286C",487).
component("YJR153W",431).
component("YBR184W",160).
component("YIL162W",391).
component("YPR026W",646).
component("YDR001C",212).
component("YBR001C",138).
component("YDR400W",242).
component("U102_",22).
component("YER043C",264).
...
component("YGL037C",306).
component("U43_",93).
component("U42_",92).
component("YLR308W",491).
component("YLR307W",490).
component("U53_",99).
component("YLR420W",498).
component("YPL111W",623).
component("YIR032C",395).
component("YLR028C",465).
component("YHR144C",370).
component("YHR144C",371).
component("YNL141W",546).
component("YBR153W",157).
component("YDL238C",211).
component("YNL141W",547).
component("YBR084W",151).
component("YJL126W",403).
component("U44_",94).
component("U39_",90).
component("YHR201C",375).
component("YBR111C",153).
component("YBR252W",165).
component("YCL030C",174).
component("YER005W",261).
component("YBL099W",137).
component("YLR231C",485).
component("U88_",119).
component("YDR538W",256).
component("YLR134W",472).
component("YLR044C",467).
component("YGR087C",328).
component("YDR380W",240).
component("YDL080C",192).
component("YMR250W",531).
component("YKL184W",448).
component("YEL021W",257).
component("YNR043W",570).
component("YKL211C",452).
component("YKR097W",460).
component("YOL052C",577).
component("YDR294C",236).
component("YNR033W",569).
component("YPR006C",644).
component("YER065C",272).
component("YKL211C",453).
component("YER090W",278).
component("YDR127W",229).
component("YPL281C",642).
component("YOR393W",617).
component("YMR323W",536).
component("YHR174W",372).
component("YGR254W",345).
component("YGL026C",304).
component("YGR155W",334).
component("YNL316C",562).
component("YPL212C",630).
component("YNL292W",560).
component("YGL063W",309).
component("YFL001W",287).
component("YCR053W",183).
component("YDR127W",230).
component("YGL148W",312).
component("YIL168W",393).
component("YIL167W",392).
component("YCL064C",176).
component("YCL064C",177).
component("YLR359W",495).
component("YFR055W",299).
component("YJL121C",402).
component("YBR019C",140).
component("YDR007W",213).
component("YOR095C",589).
component("YBR196C",161).
component("YGL001C",301).
component("YPL117C",624).
component("U14_",45).
component("YMR105C",519).
component("YKL127W",439).
component("YEL058W",260).
component("YPR060C",649).
component("YHR072W",365).
component("YJL153C",409).
component("YGR264C",348).
component("YGR171C",335).
component("YHR011W",353).
component("YDR023W",215).
component("YHR020W",355).
component("YER087W",276).
component("YGL245W",321).
component("YOR168W",596).
component("YPR047W",648).
component("YLR060W",469).
component("YFL022C",290).
component("YPR033C",647).
component("YHR019C",354).
component("YKL194C",450).
component("YIL078W",384).
component("YPL160W",626).
component("YLR382C",496).
component("YPL040C",620).
component("YBL076C",136).
component("YNL073W",541).
component("YDR037W",217).
component("YOR335C",609).
component("YGR094W",329).
component("U89_",120).
component("YOR241W",603).
component("YMR113W",521).
component("YKL132C",440).
component("YGL234W",319).
component("YER183C",286).
component("U90_",122).
component("YNR057C",571).
component("YDL141W",202).
component("YDL141W",203).
component("YGL234W",320).
component("YDL141W",204).
component("YGR204W",343).
component("YDL141W",205).
component("YMR217W",528).
component("YPR145W",655).
component("YGR124W",332).
component("YOR303W",605).
component("YGL062W",308).
component("YBR218C",162).
component("YPL231W",636).
component("YNR016C",566).
component("YKL182W",447).
component("YGR037C",325).
component("YJL087C",399).
component("YOL010W",574).
component("YPR138C",654).
component("YPL265W",638).
component("YOR348C",612).
component("YOR130C",592).
component("YOL103W",584).
component("YOL020W",576).
component("YNL142W",548).
component("YMR272C",534).
component("YMR202W",526).
component("YMR056C",516).
component("YML123C",510).
component("YLR348C",493).
component("YLR138W",473).
component("YLR100C",471).
component("YLR092W",470).
component("YLL061W",462).
component("YKR053C",459).
component("YKR039W",458).
component("YKL217W",454).
component("YJR077C",423).
component("YJL134W",406).
component("YJL129C",404).
component("YHL036W",352).
component("YGR191W",338).
component("YGR125W",333).
component("YGR121C",330).
component("YGR065C",327).
component("YGR055W",326).
component("YGL186C",314).
component("YFL055W",293).
component("YER060W-A",268).
component("YER060W",267).
component("YER056C",266).
component("YDR536W",255).
component("YDR508C",253).
component("YDR503C",252).
component("YDR497C",250).
component("YDR294C",237).
component("YDR046C",219).
component("YDL210W",209).
component("YCL025C",172).
component("YBR294W",169).
component("YBR291C",168).
component("YBR085W",152).
component("YBR069C",149).
component("YBR068C",148).
component("YBL042C",132).
component("YBL030C",130).
component("U7_",115).
component("U79_",114).
component("U75_",112).
component("U74_",111).
