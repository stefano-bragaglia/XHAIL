...
component("YNL280C",119).
component("YLR056W",104).
component("YGL001C",72).
component("YDR127W",51).
component("YNL009W",115).
component("YLR174W",106).
component("YCL018W",37).
component("YJR078W",93).
component("YOR323C",130).
component("YBR166C",34).
component("YNL280C",120).
component("YKL141W",96).
component("U100_",18).
component("YMR145C",111).
component("YDL085W",44).
component("YBR046C",28).
component("YPR074C",141).
component("YBR117C",32).
component("YNR019W",123).
component("YCR048W",41).
component("U48_",23).
component("YPL231W",134).
component("YPL231W",135).
component("YLR299W",108).
component("YDR354W",57).
component("YFR047C",70).
component("U22_",22).
component("YPR069C",140).
component("YDR127W",52).
component("YDR035W",48).
component("YBR249C",35).
component("YHR137W",84).
component("YGL202W",76).
component("YLR027C",103).
component("YKL106W",95).
component("YMR013C",110).
component("YCR036W",40).
component("YJR105W",94).
component("YMR208W",112).
component("YHR025W",81).
component("YDR127W",53).
component("YDR226W",56).
component("YDR454C",60).
component("YOL061W",127).
component("YKL181W",97).
component("YHL011C",80).
component("YER099C",66).
component("YBL068W",27).
component("YLR328W",109).
component("YPR175W",143).
component("YPL167C",133).
component("YOR330C",131).
component("YOL115W",128).
component("YNL299W",121).
component("YNL262W",118).
component("YNL102W",116).
component("YJR043C",92).
component("YJR006W",91).
component("YJL090C",89).
component("YIL139C",87).
component("YEL055C",63).
component("YDR419W",59).
component("YDR121W",50).
component("YDL102W",45).
component("YCR014C",39).
component("YBR278W",36).
component("YBL035C",25).
component("YHR044C",83).
component("YHR043C",82).
component("YGL037C",74).
component("U53_",24).
component("YHR144C",85).
component("YBR153W",33).
component("YBR111C",31).
component("YER005W",64).
component("YLR231C",107).
component("YDR380W",58).
component("YDL080C",43).
component("YMR250W",113).
component("YKL184W",98).
component("YKL211C",99).
component("YNR033W",124).
component("YKL211C",100).
component("YER090W",65).
component("YDR127W",54).
component("YPL281C",137).
component("YOR393W",132).
component("YMR323W",114).
component("YHR174W",86).
component("YGR254W",79).
component("YGL026C",73).
component("YNL316C",122).
component("YCR053W",42).
component("YDR127W",55).
component("YGL148W",75).
component("YFR055W",71).
component("YDR007W",47).
component("YOR095C",129).
component("YPR060C",139).
component("YGL245W",77).
component("YPR047W",138).
component("YLR060W",105).
component("YFL022C",68).
component("YER183C",67).
component("YDL141W",46).
component("YJL087C",88).
component("YOL010W",125).
component("YPR138C",142).
component("YPL265W",136).
component("YOL020W",126).
component("YNL142W",117).
component("YKR053C",102).
component("YKR039W",101).
component("YJL134W",90).
component("YGR121C",78).
component("YFL055W",69).
component("YDR536W",62).
component("YDR508C",61).
component("YDR046C",49).
component("YCL025C",38).
component("YBR069C",30).
component("YBR068C",29).
component("YBL042C",26).
component("U228_",21).
component("U222_",20).
component("U165_",19).
component("I01179",17).
