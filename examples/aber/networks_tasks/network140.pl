...
component("YJR159W",562).
component("YGL001C",395).
component("YHR063C",473).
component("YML056C",661).
component("YLR432W",654).
component("YHR216W",492).
component("YAR075W",170).
component("YAR073W",169).
component("YCL030C",230).
component("YDR127W",299).
component("YJR139C",558).
component("YKL085W",569).
component("YOR136W",768).
component("YNL009W",699).
component("YLR174W",627).
component("YDL066W",253).
component("YHR183W",486).
component("YGR256W",452).
component("YNL241C",715).
component("YOL059W",749).
component("YDL022W",246).
component("YCL018W",228).
component("YLR355C",648).
component("YIL074C",498).
component("YER081W",368).
component("YML054C",660).
component("YIL155C",504).
component("YEL024W",344).
component("YKR066C",599).
component("YKL026C",565).
component("YIR037W",514).
component("YBR244W",217).
component("YJR078W",551).
component("U58_",137).
component("U107_",26).
component("YGR255C",451).
component("U108_",27).
component("YMR015C",673).
component("YDR402C",326).
component("YGL055W",403).
component("YJR104C",553).
component("YHR008C",461).
component("YJL026W",515).
component("YIL066C",497).
component("YGR180C",438).
component("YER070W",366).
component("U37_",119).
component("U36_",118).
component("U35_",117).
component("YDR158W",307).
component("YJR009C",541).
component("YJL052W",516).
component("YGR192C",440).
...
component("YIL043C",495).
component("YHR042W",468).
component("YOR221C",778).
component("YMR145C",682).
component("YML120C",666).
component("YKL192C",585).
component("YKL055C",567).
component("YER061C",361).
component("YDL085W",256).
component("YBR046C",194).
component("YMR145C",683).
component("YML120C",667).
component("YKL192C",586).
component("YDL085W",257).
component("YPL017C",800).
component("YFL018C",383).
component("YPL091W",804).
component("YDR353W",321).
component("YER042W",354).
component("YPR167C",849).
component("YNL052W",702).
component("YMR256C",693).
component("YLR395C",652).
component("YLR038C",611).
component("YIL111W",501).
component("YHR051W",472).
component("YGL191W",413).
component("YGL187C",412).
component("YDL067C",254).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",826).
component("YBR034C",191).
component("YPL273W",828).
component("YLL062C",607).
component("YDR410C",329).
component("YKR069W",600).
component("YOL096C",752).
component("U47_",128).
component("YER091C",372).
component("YJR073C",549).
component("YML008C",657).
component("YDL033C",248).
component("YOL096C",753).
component("YLR172C",626).
component("YBR263W",221).
component("YDR019C",284).
component("YDR408C",328).
component("YMR120C",681).
component("YLR028C",609).
component("YBL013W",171).
component("YJL130C",525).
component("YJL088W",519).
component("YPR074C",842).
component("YBR117C",204).
component("YLR354C",647).
component("YGR043C",425).
component("YMR108W",679).
component("YCL009C",227).
component("YMR062C",675).
component("YNL071W",703).
component("YIL160C",507).
component("YNR019W",732).
component("YCR048W",242).
component("U48_",129).
component("YNL277W",721).
component("YDR232W",310).
component("YFL017C",382).
component("YPL231W",820).
component("YER061C",362).
component("U86_",159).
component("YPL001W",799).
component("YDL052C",251).
component("U8_",162).
component("YDR148C",305).
component("YOR377W",796).
component("YGR177C",437).
component("YPL231W",821).
component("YLR195C",629).
component("YLR299W",639).
component("YPR001W",832).
component("YNR001C",728).
component("YCR005C",237).
component("YML126C",669).
component("YDL182W",275).
component("YDL131W",265).
component("YNL117W",707).
component("YIR031C",512).
component("YPR160W",848).
component("YOR321W",786).
component("YJR143C",559).
component("YGR199W",442).
component("YDL095W",260).
component("YDL093W",259).
component("YAL023C",167).
component("YLR258W",636).
component("YFR015C",389).
component("YPL227C",817).
component("YNL029C",700).
component("YIL085C",500).
component("YMR261C",694).
component("YML100W",665).
component("YBR126C",207).
component("YNL192W",714).
component("YBR038W",193).
component("YBR023C",189).
component("YEL011W",342).
component("YLR209C",630).
component("U104_",24).
component("U103_",23).
component("YOR209C",776).
component("YMR300C",696).
component("YDR354W",322).
component("YFR047C",392).
component("YJR133W",557).
component("U22_",106).
component("YLR209C",631).
component("YDR399W",324).
component("YPR176C",851).
component("YPL172C",811).
component("YNR041C",735).
component("YMR101C",677).
component("YDL090C",258).
...
component("YHR190W",487).
component("YHR068W",475).
component("YLR303W",640).
component("YGR012W",422).
component("YML082W",664).
component("YJR130C",556).
component("YDR035W",286).
component("YBR249C",218).
component("YLR180W",628).
component("YDR502C",335).
component("YOR274W",783).
component("YOL143C",758).
component("YBR256C",220).
component("YHR137W",481).
component("YGL202W",414).
component("YLR027C",608).
component("YKL106W",571).
component("YOL140W",757).
component("YLR438W",656).
component("YKL104C",570).
component("YGR019W",423).
component("YDR111C",297).
component("U64_",140).
component("U51_",132).
component("YJR148W",560).
component("YHR208W",490).
component("YOR184W",773).
component("YNR058W",738).
component("YGL253W",420).
component("YFR053C",393).
component("YMR013C",672).
component("YMR205C",687).
component("YGR240C",448).
component("YLR240W",634).
component("YKL203C",588).
component("YJR066W",548).
component("YCR036W",241).
component("YGR194C",441).
component("YCL040W",233).
component("YJR105W",554).
component("U16_",69).
component("YPL188W",813).
component("YJR049C",545).
component("YEL041W",345).
component("YKL001C",563).
component("YDR236C",311).
component("YML070W",663).
component("YFL053W",386).
component("YHL032C",459).
component("YLR133W",618).
component("YDR531W",339).
component("U83_",156).
component("U82_",155).
component("U81_",154).
component("YMR208W",688).
component("YPL203W",814).
component("YOR061W",762).
component("YKL166C",579).
component("YJL164C",532).
component("YIL035C",494).
component("YHR205W",489).
component("YHR102W",479).
component("YGL019W",399).
component("YHR025W",467).
component("YNR012W",730).
component("YPR121W",845).
component("YPL258C",823).
component("YOL055C",745).
component("YPL214C",816).
component("U1_",89).
component("YDR009W",283).
component("YBR020W",188).
component("YFR019W",390).
component("YDR208W",308).
component("YDR127W",301).
component("U21_",99).
component("U20_",94).
component("YDR147W",304).
component("YDR300C",318).
...
component("YKL181W",580).
component("YHL011C",457).
component("YER099C",374).
component("YBL068W",177).
component("YOR143C",769).
component("YNL256W",718).
component("YLR328W",644).
component("YBR018C",184).
component("YBR018C",185).
component("YDL055C",252).
component("YGR007W",421).
component("YGR202C",443).
component("YLR328W",645).
component("YKR002W",593).
component("YDL045C",249).
component("YDL103C",263).
component("U94_",165).
component("YJR010W",542).
component("YBR029C",190).
component("YGL130W",408).
component("YDR530C",338).
component("YCL050C",234).
component("YPR190C",853).
component("YPR187W",852).
component("YPR110C",844).
component("YPR010C",834).
component("YOR341W",791).
component("YOR340C",790).
component("YOR224C",779).
component("YOR210W",777).
component("YOR207C",775).
component("YOR151C",770).
component("YOR116C",765).
component("YOL005C",739).
component("YNR003C",729).
component("YNL248C",716).
component("YNL151C",712).
component("YNL113W",706).
component("YKL144C",576).
component("YJR063W",547).
component("YJL148W",529).
component("YJL140W",528).
component("YIL021W",493).
component("YHR143W-A",482).
component("YGL070C",406).
component("YFL036W",385).
component("YDR404C",327).
component("YDR156W",306).
component("YDR045C",289).
component("YDL150W",272).
component("YDL140C",267).
component("YBR154C",211).
component("YPR175W",850).
component("YPL167C",810).
component("YOR330C",788).
component("YOL115W",756).
component("YNL299W",725).
component("YNL262W",719).
component("YNL102W",705).
component("YJR043C",544).
component("YJR006W",540).
component("YJL090C",520).
component("YIL139C",502).
component("YEL055C",348).
component("YDR419W",330).
component("YDR121W",298).
component("YDL102W",262).
component("YCR014C",239).
component("YBR278W",222).
component("YBL035C",173).
component("YKL035W",566).
component("YHL012W",458).
component("YHR123W",480).
component("YNL130C",708).
component("YPL148C",808).
component("YOR251C",782).
component("YGR286C",454).
component("YDR058C",293).
component("YOL011W",741).
component("YMR008C",671).
component("YMR006C",670).
component("U105_",25).
component("U101_",21).
component("YJL068C",517).
component("YPL072W",803).
component("YOR124C",766).
component("YNL186W",713).
component("YMR304W",697).
component("YMR223W",691).
component("YKR098C",604).
component("YJL197W",535).
component("YIL156W",505).
component("YFR010W",388).
component("YER151C",377).
component("YER144C",376).
component("YER098W",373).
component("YDR069C",294).
component("YDL122W",264).
component("YBR058C",195).
component("YBL067C",176).
component("YJR019C",543).
component("YDR272W",314).
component("U84_",157).
component("YDR481C",333).
component("YLR377C",650).
component("YDR074W",295).
component("YFR025C",391).
component("YPL179W",812).
component("YNR032W",733).
component("YML057W",662).
component("YML016C",658).
component("YLR433C",655).
component("YGR123C",431).
component("YER133W",375).
component("YER089C",370).
component("YDR436W",331).
component("YDR075W",296).
component("YDL188C",276).
component("YDL134C",266).
component("YDL047W",250).
component("YDL006W",244).
component("YBR125C",206).
component("YBL056W",175).
component("YPR073C",841).
component("YHR215W",491).
component("YDL024C",247).
component("YBR093C",202).
component("YBR092C",201).
component("YIL053W",496).
component("YER062C",363).
component("YHR046C",471).
component("U9_",166).
component("YGR208W",447).
component("YPL228W",818).
component("YMR180C",684).
...
component("YPL268W",827).
component("YOR360C",793).
component("YGL248W",419).
component("YKR031C",596).
component("YGL027C",401).
component("YLR286C",638).
component("YJR153W",561).
component("YJL221C",539).
component("YJL216C",537).
component("YIL172C",511).
component("YGR292W",456).
component("YGR287C",455).
component("YBR299W",226).
component("YBR184W",213).
component("YIL162W",508).
component("YPR026W",835).
component("YDR001C",281).
component("YBR001C",180).
component("YDR400W",325).
component("U102_",22).
component("YER043C",355).
component("YNL045W",701).
component("YLR160C",625).
component("YLR158C",624).
component("YLR157C",623).
component("YLR155C",622).
component("YDR321W",319).
component("YGL037C",402).
component("U43_",125).
component("U42_",124).
component("YDR242W",312).
component("YLR308W",643).
component("YLR307W",642).
component("U53_",133).
component("YLR420W",653).
component("YPL111W",806).
component("YIR032C",513).
component("YLR028C",610).
component("YHR144C",483).
component("YHR144C",484).
component("YCL030C",231).
component("YNL141W",709).
component("YBR153W",210).
component("YDL238C",280).
component("YNL141W",710).
component("YLR245C",635).
component("YML035C",659).
component("YGR204W",445).
component("YBR084W",199).
component("YJL126W",523).
component("U44_",126).
component("YDL100C",261).
component("U40_",122).
component("U39_",120).
component("YBR011C",183).
component("YHR201C",488).
...
component("U88_",160).
component("YDR538W",341).
component("YLR134W",619).
component("YLR044C",612).
component("YGR087C",428).
component("YDR380W",323).
component("YDL080C",255).
component("YMR250W",692).
component("YKL184W",584).
component("YEL021W",343).
component("YNR043W",736).
component("U93_",164).
component("YDR047W",291).
component("YKL211C",589).
component("YKR097W",603).
component("YOL052C",744).
component("YGR170W",435).
component("YDR294C",315).
component("YEL046C",346).
component("YNR033W",734).
component("YPR006C",833).
component("YER065C",364).
component("YKL211C",590).
component("YER090W",371).
component("YDR127W",302).
component("YPL281C",831).
component("YOR393W",798).
component("YMR323W",698).
component("YHR174W",485).
component("YGR254W",450).
component("YPL262W",824).
component("YGL026C",400).
component("YGR155W",434).
component("YLR304C",641).
component("YJL200C",536).
component("YGL009C",397).
component("YNL316C",726).
component("YKL182W",582).
component("YPL212C",815).
component("YNL292W",724).
component("YGL063W",405).
component("YFL001W",380).
component("YOR278W",784).
component("YCR053W",243).
component("YDR127W",303).
component("YGL148W",409).
component("YIL168W",510).
component("YIL167W",509).
component("YCL064C",235).
component("YCL064C",236).
component("YHR018C",463).
component("YLR359W",649).
component("YFR055W",394).
component("YJL121C",522).
component("YBR019C",186).
component("YBR019C",187).
component("YDR050C",292).
component("YDR007W",282).
component("YOR095C",764).
component("YER003C",351).
component("YBR196C",214).
component("YGL001C",396).
component("YPL117C",807).
component("U14_",56).
component("YOL056W",747).
component("YKL152C",578).
component("YDL021W",245).
component("YMR105C",678).
component("YKL127W",573).
component("YEL058W",349).
component("YPR060C",839).
component("YHR072W",476).
component("YJL153C",530).
component("YGR264C",453).
component("YGR171C",436).
component("YHR011W",462).
component("YDR023W",285).
component("YPL104W",805).
component("YLL018C",605).
component("YPR081C",843).
component("YBR121C",205).
component("YHR020W",466).
component("YER087W",369).
component("YOL033W",743).
component("YGL245W",418).
component("YOR168W",771).
component("YHR091C",478).
component("YDR341C",320).
component("YOL097C",754).
component("YDR268W",313).
component("YPR047W",838).
component("YLR060W",614).
component("YFL022C",384).
component("YPR033C",836).
component("YHR019C",464).
component("YHR019C",465).
component("YKL194C",587).
component("YIL078W",499).
component("YPL160W",809).
component("YLR382C",651).
component("YPL040C",802).
component("YBL076C",178).
component("YNL073W",704).
component("YDR037W",287).
component("YOR335C",789).
component("YGR094W",429).
component("YGR244C",449).
component("YPR035W",837).
component("YIL145C",503).
component("U89_",161).
component("YOR241W",781).
component("YMR113W",680).
component("YKL132C",574).
component("YJL101C",521).
component("YGL234W",416).
component("YER183C",379).
component("U90_",163).
component("YNR057C",737).
component("YDL141W",268).
component("YDL141W",269).
component("YGL234W",417).
component("YDL141W",270).
component("YGR204W",446).
component("YOL058W",748).
component("YDL141W",271).
component("YHR074W",477).
component("YMR217W",689).
component("YPR145W",847).
component("YGR124W",432).
...
component("YNR016C",731).
component("YKL182W",583).
component("YGR037C",424).
component("YOR005C",760).
component("YDL164C",273).
component("YJL087C",518).
component("YOL010W",740).
component("YPR138C",846).
component("YPL265W",825).
component("YOR348C",792).
component("YOR192C",774).
component("YOR171C",772).
component("YOR130C",767).
component("YOR071C",763).
component("YOR011W",761).
component("YOL156W",759).
component("YOL103W",755).
component("YOL020W",742).
component("YNL318C",727).
component("YNL270C",720).
component("YNL142W",711).
component("YMR272C",695).
component("YMR202W",686).
component("YMR056C",674).
component("YML123C",668).
component("YLR348C",646).
component("YLR260W",637).
component("YLR237W",633).
component("YLR138W",620).
component("YLR100C",617).
component("YLR092W",616).
component("YLR081W",615).
component("YLL061W",606).
component("YKR093W",602).
component("YKR053C",598).
component("YKR039W",597).
component("YKL217W",592).
component("YKL120W",572).
component("YKL004W",564).
component("YJR095W",552).
component("YJR077C",550).
component("YJL219W",538).
component("YJL134W",527).
component("YJL129C",524).
component("YHL036W",460).
component("YGR191W",439).
component("YGR125W",433).
component("YGR121C",430).
component("YGR065C",427).
component("YGR055W",426).
component("YGL186C",411).
component("YFL055W",387).
component("YFL011W",381).
component("YER060W-A",360).
component("YER060W",359).
component("YER056C",358).
component("YER053C",357).
component("YEL063C",350).
component("YDR536W",340).
component("YDR508C",337).
component("YDR503C",336).
component("YDR497C",334).
component("YDR297W",317).
component("YDR294C",316).
component("YDR046C",290).
component("YDL210W",277).
component("YCR028C",240).
