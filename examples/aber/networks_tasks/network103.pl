...
component("YNL280C",584).
component("YLR056W",489).
component("YKR009C",475).
component("YMR083W",542).
component("YPL231W",660).
component("YJR159W",452).
component("YGL001C",311).
component("YHR063C",377).
component("YML056C",528).
component("YLR432W",522).
component("YHR216W",393).
component("YAR075W",134).
component("YAR073W",133).
component("YCL030C",181).
component("YDR127W",234).
component("YJR139C",448).
component("YOR136W",619).
component("YNL009W",563).
component("YLR174W",501).
component("YDL066W",198).
component("YHR183W",388).
component("YGR256W",360).
component("YNL241C",578).
component("YOL059W",606).
component("YDL022W",193).
component("YCL018W",179).
component("YLR355C",517).
component("YML054C",527).
component("YIL155C",402).
component("YEL024W",269).
component("YJR078W",443).
component("U58_",106).
component("YGR255C",359).
component("U108_",26).
component("YMR015C",539).
component("YDR402C",252).
component("YGL055W",318).
component("YJL026W",412).
component("YIL066C",398).
component("YGR180C",349).
component("YER070W",285).
component("U36_",93).
component("U35_",92).
component("YJR009C",434).
component("YJL052W",413).
component("YGR192C",351).
...
component("YOR323C",634).
component("U2_",87).
component("YBR221C",170).
component("YBR166C",166).
component("YNL280C",585).
component("YGL012W",313).
component("YKL182W",466).
component("YER014W",273).
component("YKR009C",476).
component("YIL160C",404).
component("YGL205W",330).
component("YKL141W",461).
component("YJR051W",438).
component("YOR375C",642).
component("YDL215C",218).
component("YAL062W",132).
component("U100_",20).
component("YBR035C",150).
component("YMR189W",549).
component("U56_",105).
component("YKR080W",480).
component("YPL023C",646).
component("YGL125W",322).
component("YOR236W",629).
component("YGR204W",354).
component("YBR084W",156).
component("YLR142W",495).
component("U65_",109).
component("U62_",108).
...
component("YOR221C",627).
component("YMR145C",547).
component("YML120C",533).
component("YKL192C",469).
component("YKL055C",455).
component("YER061C",280).
component("YDL085W",201).
component("YBR046C",152).
component("YPL017C",645).
component("YFL018C",300).
component("YPL091W",649).
component("YER042W",274).
component("YNL052W",565).
component("YMR256C",557).
component("YLR395C",520).
component("YLR038C",487).
component("YIL111W",400).
component("YHR051W",376).
component("YGL191W",328).
component("YGL187C",327).
component("YDL067C",199).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",666).
component("YPL273W",668).
component("YLL062C",484).
component("YDR410C",254).
component("YER091C",290).
component("YJR073C",441).
component("YDL033C",194).
component("YOL096C",609).
component("YLR172C",500).
component("YMR120C",546).
component("YBL013W",135).
component("YJL130C",421).
component("YJL088W",416).
component("YPR074C",679).
component("YBR117C",160).
component("YMR108W",544).
component("YCL009C",178).
component("YMR062C",541).
component("YNL071W",566).
component("YIL160C",405).
component("YNR019W",593).
component("YCR048W",190).
component("U48_",99).
component("YNL277W",583).
component("YFL017C",299).
component("YPL231W",661).
component("YER061C",281).
component("U86_",124).
component("YDL052C",196).
component("U8_",127).
component("YDR148C",240).
component("YOR377W",643).
component("YGR177C",348).
component("YPL231W",662).
component("YLR195C",503).
component("YLR299W",509).
component("YPR001W",670).
component("YNR001C",589).
component("YCR005C",186).
component("YML126C",535).
component("YDL182W",215).
component("YDL131W",207).
component("YNL117W",570).
component("YIR031C",410).
component("YPR160W",685).
component("YOR321W",633).
component("YJR143C",449).
component("YGR199W",353).
component("YDL095W",203).
component("YDL093W",202).
component("YAL023C",131).
component("YPL227C",658).
component("YMR261C",558).
component("YML100W",532).
component("YBR126C",163).
component("YNL192W",577).
component("YBR038W",151).
component("YBR023C",148).
component("YEL011W",267).
component("YLR209C",504).
component("U104_",24).
component("U103_",23).
component("YOR209C",625).
component("YMR300C",560).
component("YDR354W",248).
component("YFR047C",308).
component("YJR133W",447).
component("U22_",82).
component("YLR209C",505).
component("YDR399W",250).
component("YJL167W",428).
component("YNL256W",580).
component("YPR069C",678).
component("YDR127W",235).
component("YHR190W",389).
component("YHR068W",379).
component("YLR303W",510).
component("YML082W",531).
component("YJR130C",446).
component("YDR035W",224).
component("YBR249C",171).
component("YLR180W",502).
component("YDR502C",260).
component("YOL143C",613).
component("YBR256C",173).
component("YHR137W",383).
component("YGL202W",329).
component("YLR027C",485).
component("YKL106W",458).
component("YOL140W",612).
component("YLR438W",524).
component("YKL104C",457).
component("YGR019W",336).
component("YDR111C",232).
component("U51_",102).
component("YJR148W",450).
component("YHR208W",392).
component("YOR184W",623).
component("YNR058W",598).
component("YGL253W",335).
component("YFR053C",309).
component("YMR013C",538).
component("YMR205C",551).
component("YGR240C",357).
component("YLR240W",507).
component("YKL203C",471).
component("YJR066W",440).
component("YCR036W",189).
component("YGR194C",352).
component("YCL040W",183).
component("YJR105W",445).
component("U16_",54).
component("YKL001C",453).
component("YML070W",530).
component("YFL053W",303).
component("YDR531W",264).
component("U82_",122).
component("U81_",121).
component("YMR208W",552).
component("YPL203W",656).
component("YOR061W",614).
component("YKL166C",464).
component("YJL164C",427).
component("YIL035C",395).
component("YHR205W",391).
component("YHR102W",381).
component("YGL019W",314).
component("YHR025W",371).
component("YNR012W",591).
component("YPR121W",682).
component("YPL258C",664).
component("YOL055C",604).
component("U1_",71).
component("YDR009W",222).
...
component("YER052C",276).
component("U19_",70).
component("U18_",64).
component("U17_",59).
component("U76_",118).
component("YMR220W",554).
component("YER170W",296).
component("YDR226W",243).
component("YKL067W",456).
component("YOL055C",605).
component("YDR454C",257).
component("YOL061W",607).
component("YKL181W",465).
component("YHL011C",365).
component("YER099C",292).
component("YBL068W",141).
component("YOR143C",620).
component("YNL256W",581).
component("YLR328W",514).
component("YBR018C",145).
component("YDL055C",197).
component("YLR328W",515).
component("YDL103C",205).
component("U94_",129).
component("YJR010W",435).
component("YBR029C",149).
component("YGL130W",323).
component("YDR530C",263).
component("YPR190C",688).
component("YPR187W",687).
component("YPR110C",681).
component("YPR010C",672).
component("YOR341W",638).
component("YOR340C",637).
component("YOR224C",628).
component("YOR210W",626).
component("YOR207C",624).
component("YOR151C",621).
component("YOR116C",616).
component("YOL005C",599).
component("YNR003C",590).
component("YNL248C",579).
component("YNL151C",575).
component("YNL113W",569).
component("YKL144C",462).
component("YJR063W",439).
component("YJL148W",424).
component("YJL140W",423).
component("YIL021W",394).
component("YHR143W-A",384).
component("YGL070C",321).
component("YFL036W",302).
component("YDR404C",253).
component("YDR156W",241).
component("YDR045C",226).
component("YDL150W",214).
component("YDL140C",209).
component("YBR154C",165).
component("YPR175W",686).
component("YPL167C",654).
component("YOR330C",635).
component("YOL115W",611).
component("YNL299W",587).
component("YNL262W",582).
component("YNL102W",568).
component("YJR043C",437).
component("YJR006W",433).
component("YJL090C",417).
...
component("YBR278W",174).
component("YBL035C",137).
component("YKL035W",454).
component("YHL012W",366).
component("YHR123W",382).
component("YNL130C",571).
component("YPL148C",652).
component("YOR251C",631).
component("YGR286C",362).
component("YDR058C",228).
component("YOL011W",601).
component("YMR008C",537).
component("YMR006C",536).
component("U105_",25).
component("U101_",21).
component("YJL068C",414).
component("YPL072W",648).
component("YOR124C",617).
component("YNL186W",576).
component("YMR304W",561).
component("YMR223W",555).
component("YKR098C",482).
component("YJL197W",429).
component("YIL156W",403).
component("YFR010W",305).
component("YER151C",295).
component("YER144C",294).
component("YER098W",291).
component("YDR069C",229).
component("YDL122W",206).
component("YBR058C",153).
component("YBL067C",140).
component("YJR019C",436).
component("YDR481C",258).
component("YDR074W",230).
component("YFR025C",307).
component("YPL179W",655).
component("YNR032W",594).
component("YML057W",529).
component("YML016C",525).
component("YLR433C",523).
component("YGR123C",343).
component("YER133W",293).
component("YER089C",288).
component("YDR436W",256).
component("YDR075W",231).
component("YDL188C",216).
component("YDL134C",208).
component("YDL047W",195).
component("YDL006W",192).
component("YBR125C",162).
component("YBL056W",139).
component("YIL053W",397).
component("YER062C",282).
component("YHR046C",375).
component("U9_",130).
component("YGR208W",356).
component("YPL228W",659).
component("YMR180C",548).
component("YJL155C",426).
component("U34_",91).
component("U33_",90).
component("U32_",89).
component("U30_",88).
...
component("YOL064C",608).
component("YPL268W",667).
component("YOR360C",640).
component("YGL248W",334).
component("YKR031C",477).
component("YGL027C",316).
component("YLR286C",508).
component("YJR153W",451).
component("YJL221C",432).
component("YJL216C",431).
component("YIL172C",409).
component("YGR292W",364).
component("YGR287C",363).
component("YBR299W",177).
component("YBR184W",167).
component("YIL162W",406).
component("YPR026W",673).
component("YDR001C",220).
component("YBR001C",144).
component("YDR400W",251).
component("U102_",22).
component("YER043C",275).
component("YNL045W",564).
component("YLR160C",499).
component("YLR158C",498).
component("YLR157C",497).
component("YLR155C",496).
component("YDR321W",247).
component("YGL037C",317).
component("U43_",97).
component("U42_",96).
component("YLR308W",513).
component("YLR307W",512).
component("U53_",103).
component("YLR420W",521).
component("YPL111W",650).
component("YIR032C",411).
component("YLR028C",486).
component("YHR144C",385).
component("YHR144C",386).
component("YNL141W",572).
component("YBR153W",164).
component("YDL238C",219).
component("YNL141W",573).
component("YML035C",526).
component("YBR084W",157).
component("YJL126W",419).
component("U44_",98).
component("U39_",94).
component("YHR201C",390).
component("YBR111C",159).
component("YBR252W",172).
component("YCL030C",182).
component("YER005W",272).
component("YBL099W",143).
component("YLR231C",506).
component("U88_",125).
component("YDR538W",266).
component("YLR134W",493).
component("YLR044C",488).
component("YGR087C",340).
component("YDR380W",249).
component("YDL080C",200).
component("YMR250W",556).
component("YKL184W",468).
component("YEL021W",268).
component("YNR043W",596).
component("YKL211C",472).
component("YKR097W",481).
component("YOL052C",603).
component("YDR294C",244).
component("YNR033W",595).
component("YPR006C",671).
component("YER065C",283).
component("YKL211C",473).
component("YER090W",289).
component("YDR127W",237).
component("YPL281C",669).
component("YOR393W",644).
component("YMR323W",562).
component("YHR174W",387).
component("YGR254W",358).
component("YGL026C",315).
component("YGR155W",346).
component("YLR304C",511).
component("YJL200C",430).
component("YNL316C",588).
component("YPL212C",657).
component("YNL292W",586).
component("YGL063W",320).
component("YFL001W",298).
component("YCR053W",191).
component("YDR127W",238).
component("YGL148W",324).
component("YIL168W",408).
component("YIL167W",407).
component("YCL064C",184).
component("YCL064C",185).
component("YLR359W",518).
component("YFR055W",310).
component("YJL121C",418).
component("YBR019C",146).
component("YDR007W",221).
component("YOR095C",615).
component("YBR196C",168).
component("YGL001C",312).
component("YPL117C",651).
component("U14_",46).
component("YMR105C",543).
component("YKL127W",459).
component("YEL058W",271).
component("YPR060C",677).
component("YHR072W",380).
component("YJL153C",425).
component("YGR264C",361).
component("YGR171C",347).
component("YHR011W",368).
component("YDR023W",223).
component("YPR081C",680).
component("YBR121C",161).
component("YHR020W",370).
component("YER087W",287).
component("YGL245W",333).
component("YOR168W",622).
component("YPR047W",676).
component("YLR060W",490).
component("YFL022C",301).
component("YPR033C",674).
component("YHR019C",369).
component("YKL194C",470).
component("YIL078W",399).
component("YPL160W",653).
component("YLR382C",519).
component("YPL040C",647).
component("YBL076C",142).
component("YNL073W",567).
component("YDR037W",225).
component("YOR335C",636).
component("YGR094W",341).
component("YPR035W",675).
component("U89_",126).
component("YOR241W",630).
component("YMR113W",545).
component("YKL132C",460).
component("YGL234W",331).
component("YER183C",297).
component("U90_",128).
component("YNR057C",597).
component("YDL141W",210).
component("YDL141W",211).
component("YGL234W",332).
component("YDL141W",212).
component("YGR204W",355).
component("YDL141W",213).
component("YMR217W",553).
component("YPR145W",684).
component("YGR124W",344).
component("YOR303W",632).
component("YGL062W",319).
component("YBR218C",169).
component("YPL231W",663).
component("YNR016C",592).
component("YKL182W",467).
component("YGR037C",337).
component("YJL087C",415).
component("YOL010W",600).
component("YPR138C",683).
component("YPL265W",665).
component("YOR348C",639).
component("YOR130C",618).
component("YOL103W",610).
component("YOL020W",602).
component("YNL142W",574).
component("YMR272C",559).
component("YMR202W",550).
component("YMR056C",540).
component("YML123C",534).
component("YLR348C",516).
component("YLR138W",494).
component("YLR100C",492).
component("YLR092W",491).
component("YLL061W",483).
component("YKR053C",479).
component("YKR039W",478).
component("YKL217W",474).
component("YJR095W",444).
component("YJR077C",442).
component("YJL134W",422).
component("YJL129C",420).
component("YHL036W",367).
component("YGR191W",350).
component("YGR125W",345).
...
component("YDR536W",265).
component("YDR508C",262).
component("YDR503C",261).
component("YDR497C",259).
component("YDR294C",245).
component("YDR046C",227).
component("YDL210W",217).
component("YCL025C",180).
component("YBR294W",176).
component("YBR291C",175).
component("YBR085W",158).
component("YBR069C",155).
component("YBR068C",154).
component("YBL042C",138).
component("YBL030C",136).
component("U85_",123).
component("U7_",120).
component("U79_",119).
component("U75_",117).
