...
component("YKL085W",645).
component("YKL029C",640).
component("YOR136W",866).
component("YNL037C",791).
component("YNL009W",789).
component("YLR174W",709).
component("YDL066W",286).
component("YHR183W",549).
component("YGR256W",509).
component("YNL241C",806).
component("YOL059W",844).
component("YDL022W",278).
component("YCL018W",257).
component("YLR355C",730).
component("YIL074C",561).
component("YER081W",415).
component("YML054C",745).
component("YDL174C",310).
component("YIL155C",569).
component("YPR191W",957).
component("YOR065W",858).
component("YJL166W",603).
component("YHR001W-A",518).
component("YGR183C",494).
component("YFR033C",443).
component("YEL024W",389).
component("YDR529C",381).
component("YBL045C",197).
component("Q0105",19).
component("YKR066C",676).
component("YKL026C",639).
component("YIR037W",580).
component("YBR244W",246).
component("YJR078W",623).
component("U58_",149).
component("U107_",28).
component("YGR255C",508).
component("U108_",29).
component("YBL098W",202).
component("YMR015C",761).
component("YHR007C",519).
component("YDR402C",368).
component("YGL055W",456).
component("YJR104C",625).
component("YHR008C",520).
component("YJL026W",583).
...
component("U36_",128).
component("U35_",127).
component("YDR158W",345).
component("YJR009C",613).
component("YJL052W",585).
component("YGR192C",496).
component("YBR006W",207).
component("YPL276W",932).
component("YPL275W",931).
component("YOR388C",896).
component("YOR374W",893).
component("YER073W",414).
component("U68_",159).
component("YGL154C",463).
component("YBR115C",230).
component("U55_",146).
component("YER069W",412).
component("YOR323C",886).
component("U2_",122).
component("YER178W",426).
component("YBR221C",244).
component("YIL125W",566).
component("YBR166C",240).
component("YNL280C",814).
component("YGL012W",450).
component("YKL182W",658).
component("U57_",148).
component("YKL216W",668).
component("YDR044W",326).
component("YER014W",399).
component("YKR009C",672).
component("YIL160C",571).
component("YGL205W",468).
component("YMR118C",769).
component("YLR164W",707).
component("YLL041C",683).
component("YKL148C",653).
component("YKL141W",651).
component("YJL045W",584).
component("YDR178W",346).
component("YJR051W",618).
component("YEL047C",392).
component("YDL171C",309).
component("YOR375C",894).
component("YDL215C",314).
component("YAL062W",189).
component("U99_",185).
component("U100_",22).
component("YBR035C",217).
component("YMR189W",775).
component("U56_",147).
component("YNR050C",829).
component("YKR080W",678).
component("YER023W",400).
component("YPL023C",900).
component("YGL125W",460).
component("YOR236W",879).
component("YGR204W",500).
component("YBR084W",224).
component("YLR142W",700).
component("U65_",156).
component("U62_",154).
component("YHR068W",533).
component("YKL150W",654).
component("YIL043C",558).
component("YHR042W",527).
component("YOR221C",877).
component("YMR145C",771).
component("YML120C",753).
component("YKL192C",662).
component("YKL055C",642).
...
component("YFR030W",442).
component("YPL017C",899).
component("YFL018C",431).
component("YPL091W",905).
component("YDR353W",363).
component("YER042W",401).
component("YPR167C",951).
component("YJR137C",630).
component("YNL052W",793).
component("YMR256C",783).
component("YLR395C",734).
component("YLR038C",690).
component("YIL111W",564).
component("YHR051W",531).
component("YGL191W",466).
component("YGL187C",465).
component("YDL067C",287).
component("Q0275",21).
component("Q0250",20).
component("Q0045",18).
component("YPL266W",928).
component("YML110C",752).
component("YBR034C",216).
component("YPL273W",930).
component("YLL062C",686).
component("YDR410C",371).
component("YKR069W",677).
component("YOL096C",847).
component("U47_",138).
component("YER091C",419).
component("YJR073C",621).
component("YML008C",740).
component("YDL033C",280).
component("YOL096C",848).
component("YLR172C",708).
component("YBR263W",250).
component("YDR019C",322).
component("YDR408C",370).
component("YMR120C",770).
component("YLR028C",688).
component("YBL013W",193).
component("YJL130C",595).
component("YJL088W",589).
component("YPR074C",944).
component("YBR117C",231).
component("YLR354C",729).
component("YGR043C",478).
component("YMR108W",767).
component("YCL009C",256).
component("YMR062C",763).
component("YNL071W",794).
component("YIL160C",572).
component("YNR019W",823).
component("YCR048W",273).
component("U48_",139).
component("YNL277W",812).
component("YDR232W",349).
component("YFL017C",430).
component("YPL231W",922).
component("YER061C",409).
component("U86_",177).
component("YPL001W",898).
component("YDL052C",284).
component("U8_",180).
component("YDR148C",343).
component("YOR377W",895).
component("YGR177C",492).
component("YPL231W",923).
component("YGR147C",488).
component("YDL040C",281).
component("YPL028W",901).
component("YLR195C",711).
component("YLR299W",721).
component("YGL017W",451).
component("YPR001W",934).
component("YNR001C",819).
component("YCR005C",268).
component("YML126C",756).
component("YDL182W",311).
component("YDL131W",299).
component("YNL117W",798).
component("YIR031C",578).
component("YPR160W",950).
component("YOR321W",885).
component("YJR143C",632).
component("YGR199W",498).
component("YDL095W",294).
component("YDL093W",293).
component("YAL023C",187).
component("YLR258W",718).
component("YFR015C",439).
component("YPL227C",919).
component("YOR103C",862).
component("YOR085W",860).
component("YMR149W",773).
component("YML019W",742).
component("YJL002C",581).
component("YEL002C",386).
component("YDL232W",315).
component("YCL043C",263).
component("YNL029C",790).
component("YIL085C",563).
component("YMR261C",784).
component("YML100W",751).
component("YBR126C",234).
component("YNL192W",805).
component("YBR038W",219).
component("YBR023C",214).
component("YEL011W",387).
component("YPR183W",954).
component("YLR209C",712).
component("U104_",26).
component("U103_",25).
component("YOR209C",875).
component("YMR300C",786).
component("YDR354W",364).
component("YFR047C",444).
component("YJR133W",629).
component("U22_",116).
component("YLR209C",713).
component("YML022W",743).
component("YDR441C",374).
component("YDR399W",366).
component("YPR176C",953).
component("YPL172C",912).
component("YNR041C",827).
component("YMR101C",765).
component("YDL090C",292).
component("YBR003W",206).
component("YBR002C",205).
component("YJL167W",604).
component("YJL167W",605).
component("YNL256W",808).
component("YPR069C",942).
component("YDR127W",338).
component("YHR190W",550).
component("YLR146C",701).
component("YHR068W",534).
component("YLR303W",722).
component("YGR012W",475).
component("YML082W",750).
component("YJR130C",628).
component("YDR035W",324).
component("YBR249C",247).
component("YLR180W",710).
component("YDR502C",378).
component("YOR274W",882).
component("YOL143C",853).
component("YBR256C",249).
component("YHR137W",543).
component("YGL202W",467).
component("YLR027C",687).
component("YKL106W",647).
component("YOL140W",852).
component("YLR438W",738).
component("YKL104C",646).
component("YGR019W",476).
component("YDR111C",335).
component("U64_",155).
component("U61_",153).
component("U51_",143).
component("YJR148W",633).
component("YHR208W",553).
component("YFL030W",433).
component("YOR184W",872).
component("YNR058W",831).
component("YIL116W",565).
component("YGL253W",473).
component("YFR053C",445).
component("YMR013C",760).
component("YMR205C",777).
component("YGR240C",504).
component("YOL016C",836).
component("YFR014C",438).
component("YLR240W",716).
component("YKL203C",665).
component("YJR066W",620).
component("YCR036W",272).
component("YGR194C",497).
component("YCL040W",262).
component("YJR105W",626).
component("U16_",76).
component("YPL188W",914).
component("YJR049C",617).
component("YEL041W",390).
component("U96_",184).
component("YKL001C",637).
component("YDR236C",350).
...
component("U82_",173).
component("U81_",172).
component("YMR208W",778).
component("YPL203W",915).
component("YOR061W",857).
component("YKL166C",656).
component("YJL164C",602).
component("YIL035C",557).
component("YHR205W",552).
component("YHR102W",541).
component("YGL019W",452).
component("YHR025W",526).
component("YNR012W",821).
component("YPR121W",947).
component("YPL258C",925).
component("YOL055C",840).
component("YPL214C",918).
component("U1_",97).
component("YDR009W",321).
component("YBR020W",213).
component("YFR019W",440).
component("YDR208W",347).
component("YDR127W",339).
component("U21_",108).
component("U20_",103).
component("YDR147W",342).
component("YDR300C",357).
component("YCR012W",269).
component("YER052C",403).
component("U19_",96).
component("U18_",89).
component("U17_",83).
component("U76_",168).
component("YMR220W",780).
component("YER170W",425).
component("YDR226W",348).
component("YKL067W",644).
component("YOL055C",841).
component("YDR454C",375).
component("YOL061W",845).
component("YKL181W",657).
component("YHL011C",514).
component("YER099C",421).
component("YBL068W",200).
component("YOR143C",867).
component("YNL256W",809).
component("YLR328W",726).
component("YBR018C",209).
component("YBR018C",210).
component("YDL055C",285).
component("YGR007W",474).
component("YGR202C",499).
component("YLR328W",727).
component("YKR002W",670).
component("YDL045C",282).
component("YDL103C",297).
component("U94_",183).
component("YJR010W",614).
component("YBR029C",215).
component("YCL050C",264).
component("YGL130W",461).
component("YDR530C",382).
component("YCL050C",265).
component("YPR190C",956).
component("YPR187W",955).
component("YPR110C",946).
component("YPR010C",936).
component("YOR341W",890).
component("YOR340C",889).
component("YOR224C",878).
component("YOR210W",876).
component("YOR207C",874).
component("YOR151C",868).
component("YOR116C",863).
component("YOL005C",833).
component("YNR003C",820).
component("YNL248C",807).
component("YNL151C",803).
component("YNL113W",797).
component("YKL144C",652).
component("YJR063W",619).
component("YJL148W",599).
component("YJL140W",598).
component("YIL021W",556).
component("YHR143W-A",544).
component("YGL070C",459).
component("YFL036W",434).
component("YDR404C",369).
component("YDR156W",344).
component("YDR045C",327).
component("YDL150W",307).
component("YDL140C",301).
component("YBR154C",239).
component("YPR175W",952).
component("YPL167C",911).
component("YOR330C",887).
component("YOL115W",851).
component("YNL299W",816).
component("YNL262W",810).
component("YNL102W",796).
component("YJR043C",616).
component("YJR006W",612).
component("YJL090C",590).
component("YIL139C",567).
component("YEL055C",393).
component("YDR419W",372).
component("YDR121W",336).
component("YDL102W",296).
component("YCR014C",270).
component("YBR278W",251).
component("YBL035C",195).
component("YKL035W",641).
component("YHL012W",515).
component("YHR123W",542).
component("YBR243C",245).
component("YNL130C",799).
component("YDL142C",306).
component("YPL148C",909).
component("YOR251C",881).
component("YGR286C",511).
component("YJL068C",586).
component("YDR058C",331).
component("YNR034W",826).
component("YHR163W",547).
component("YGR248W",506).
component("YCR073W-A",275).
component("YDL086W",291).
component("YOL011W",835).
component("YMR008C",758).
component("YMR006C",757).
component("U105_",27).
component("U101_",23).
component("YJL068C",587).
component("YPL072W",904).
component("YOR124C",864).
component("YNL186W",804).
component("YMR304W",787).
component("YMR223W",781).
component("YKR098C",681).
component("YJL197W",606).
component("YIL156W",570).
component("YFR010W",437).
component("YER151C",424).
component("YER144C",423).
component("YER098W",420).
component("YDR069C",332).
component("YDL122W",298).
component("YBR058C",221).
component("YBL067C",199).
component("YJR019C",615).
component("YDR272W",353).
component("U84_",175).
component("YDR481C",376).
component("YLR377C",732).
component("YDR074W",333).
component("YFR025C",441).
component("YPL179W",913).
component("YNR032W",824).
component("YML057W",747).
component("YML016C",741).
component("YLR433C",737).
component("YGR123C",485).
component("YER133W",422).
component("YER089C",417).
component("YDR436W",373).
component("YDR075W",334).
component("YDL188C",312).
component("YDL134C",300).
component("YDL047W",283).
component("YDL006W",276).
component("YBR125C",233).
component("YBL056W",198).
component("YPR073C",943).
component("YHR215W",554).
component("YDL024C",279).
component("YBR093C",228).
component("YBR092C",227).
component("YIL053W",559).
component("YER062C",410).
component("YHR046C",530).
component("U9_",186).
component("YGR208W",503).
component("YPL228W",920).
component("YMR180C",774).
component("YDL236W",316).
component("YJL155C",601).
component("U34_",126).
component("U33_",125).
component("U32_",124).
component("U30_",123).
...
component("U26_",118).
component("U24_",117).
component("YHR044C",529).
component("YHR043C",528).
component("YOL064C",846).
component("YPL268W",929).
component("YOR360C",892).
component("YGL248W",472).
component("YKR031C",673).
component("YPL206C",916).
component("YGL027C",454).
component("YLR286C",720).
component("YJR153W",634).
component("YJL221C",611).
component("YJL216C",609).
component("YIL172C",576).
component("YGR292W",513).
component("YGR287C",512).
component("YBR299W",255).
component("YBR184W",241).
component("YIL162W",573).
component("YPR026W",937).
component("YDR001C",319).
component("YBR001C",204).
component("YDR400W",367).
component("U102_",24).
component("YER043C",402).
component("YNL045W",792).
component("YLR160C",706).
component("YLR158C",705).
component("YLR157C",704).
component("YLR155C",703).
component("YDR321W",358).
component("YGL037C",455).
component("U43_",135).
component("U42_",134).
component("YDR242W",351).
component("YLR308W",725).
component("YLR307W",724).
component("U53_",144).
component("YLR420W",735).
component("YPL111W",907).
component("YIR032C",579).
component("YIR029W",577).
component("YLR028C",689).
component("YHR144C",545).
component("YHR144C",546).
component("YCL030C",260).
component("YNL141W",800).
component("YBR153W",238).
component("YDL238C",317).
component("YNL141W",801).
component("YLR245C",717).
component("YML035C",744).
component("YGR204W",501).
component("YBR084W",225).
component("YJL126W",593).
component("U44_",136).
component("YDL100C",295).
component("U40_",132).
component("U39_",130).
component("YBR011C",208).
component("YHR201C",551).
component("YBR111C",229).
component("YBR252W",248).
component("YCL030C",261).
component("YER005W",398).
component("YBL099W",203).
component("U60_",152).
component("YLR231C",714).
component("U88_",178).
component("YDR538W",385).
component("YLR134W",698).
component("YLR044C",691).
component("YGR087C",482).
component("YDR380W",365).
component("YDL080C",288).
component("YMR250W",782).
component("YKL184W",661).
component("YEL021W",388).
component("YNR043W",828).
component("U93_",182).
component("YDR047W",329).
component("U54_",145).
component("YKL211C",666).
component("YKR097W",680).
component("YOL052C",839).
component("YGR170W",490).
component("YKL060C",643).
component("YDR294C",354).
component("YEL046C",391).
component("YNR033W",825).
component("YPR006C",935).
component("YER065C",411).
component("YKL211C",667).
component("YER090W",418).
component("YDR127W",340).
component("YPL281C",933).
component("YOR393W",897).
component("YMR323W",788).
component("YHR174W",548).
component("YGR254W",507).
component("YPL262W",926).
component("YGL026C",453).
component("YGR155W",489).
component("YLR304C",723).
component("YJL200C",607).
component("YGL009C",449).
component("YNL316C",817).
component("YKL182W",659).
component("YPL212C",917).
component("YNL292W",815).
component("YGL063W",458).
component("YFL001W",428).
component("YOR278W",883).
component("U49_",140).
component("YCR053W",274).
component("YDR127W",341).
component("YGL148W",462).
component("YIL168W",575).
component("YIL167W",574).
component("YCL064C",266).
component("YCL064C",267).
component("YHR018C",522).
component("YLR359W",731).
component("YFR055W",446).
component("YJL005W",582).
component("YOR176W",871).
component("YJL121C",592).
component("YBR019C",211).
component("YBR019C",212).
component("U59_",150).
component("YDR050C",330).
component("YDR007W",320).
component("YOR095C",861).
component("YER003C",397).
component("YBR196C",242).
component("YGL001C",448).
component("YPL117C",908).
component("U14_",61).
component("YOL056W",842).
component("YKL152C",655).
component("YDL021W",277).
component("YMR105C",766).
component("YKL127W",649).
component("YEL058W",394).
component("YPR060C",941).
component("YHR072W",535).
component("YJL153C",600).
component("YGR264C",510).
component("YGR171C",491).
component("YHR011W",521).
component("YDR023W",323).
component("YPL104W",906).
component("YLL018C",682).
component("YPR081C",945).
component("YBR121C",232).
component("YHR020W",525).
component("YER087W",416).
component("YOL033W",838).
component("YGL245W",471).
component("YOR168W",869).
component("YHR091C",537).
component("YDR341C",359).
component("YOL097C",849).
component("YDR268W",352).
component("YPR047W",940).
component("YLR060W",693).
component("YFL022C",432).
component("YPR033C",938).
component("YHR019C",523).
component("YHR019C",524).
component("YKL194C",664).
component("YIL078W",562).
component("YPL160W",910).
component("YLR382C",733).
component("YPL040C",902).
component("YBL076C",201).
component("YNL073W",795).
component("YDR037W",325).
component("YOR335C",888).
component("YGR094W",483).
component("YLR153C",702).
component("YAL054C",188).
component("YGR244C",505).
component("YPR035W",939).
component("YIL145C",568).
component("U89_",179).
component("YOR241W",880).
component("YMR113W",768).
component("YKL132C",650).
component("YJL101C",591).
component("YAR015W",190).
component("YGL234W",469).
component("YER183C",427).
component("U90_",181).
component("YNR057C",830).
component("YDL141W",302).
component("YDL141W",303).
component("YGL234W",470).
component("YDL141W",304).
component("YGR204W",502).
component("YOL058W",843).
component("YDL141W",305).
component("YHR074W",536).
component("YMR217W",779).
component("YPR145W",949).
component("YGR124W",486).
component("YOR303W",884).
component("YJR109C",627).
component("YJL130C",596).
component("YGL062W",457).
component("YBR218C",243).
component("YPL231W",924).
component("YNR016C",822).
component("YKL182W",660).
component("YGR037C",477).
component("YOR005C",855).
component("YDL164C",308).
component("YJL087C",588).
component("YOL010W",834).
component("YPR138C",948).
component("YPL265W",927).
component("YPL057C",903).
component("YOR348C",891).
component("YOR192C",873).
component("YOR171C",870).
component("YOR130C",865).
component("YOR071C",859).
component("YOR011W",856).
component("YOL156W",854).
component("YOL103W",850).
component("YOL020W",837).
component("YNR072W",832).
component("YNL318C",818).
component("YNL270C",811).
component("YNL142W",802).
component("YMR272C",785).
component("YMR202W",776).
component("YMR056C",762).
component("YMR011W",759).
component("YML123C",755).
component("YLR348C",728).
component("YLR260W",719).
component("YLR237W",715).
component("YLR138W",699).
component("YLR100C",696).
component("YLR092W",695).
component("YLR081W",694).
component("YLL061W",685).
component("YLL043W",684).
component("YKR093W",679).
component("YKR053C",675).
component("YKR039W",674).
component("YKL217W",669).
component("YKL120W",648).
component("YKL004W",638).
component("YJR158W",635).
component("YJR095W",624).
component("YJR077C",622).
component("YJL219W",610).
component("YJL214W",608).
component("YJL134W",597).
component("YJL129C",594).
component("YHR096C",540).
component("YHR094C",539).
component("YHR092C",538).
component("YHL036W",517).
component("YGR191W",495).
component("YGR125W",487).
component("YGR121C",484).
component("YGR065C",481).
component("YGR055W",479).
component("YGL186C",464).
...
component("YEL069C",396).
component("YEL063C",395).
...
component("YDR046C",328).
component("YDL245C",318).
component("YDL210W",313).
component("YCR028C",271).
component("YCL025C",258).
component("YBR298C",254).
component("YBR294W",253).
component("YBR291C",252).
component("YBR085W",226).
component("YBR069C",223).
component("YBR068C",222).
component("YBR036C",218).
component("YBL042C",196).
component("YBL030C",194).
component("U85_",176).
component("U7_",171).
component("U79_",170).
component("U78_",169).
