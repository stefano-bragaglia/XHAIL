...
component("YLR056W",750).
component("YGR060W",525).
component("YKR009C",729).
component("YMR083W",830).
component("YPL231W",1002).
component("U46_",155).
component("YBR149W",261).
component("YBR149W",262).
component("YJR159W",693).
component("YGL001C",490).
component("YHR063C",582).
component("U45_",154).
component("YBR153W",263).
component("YML056C",810).
component("YLR432W",798).
component("YHR216W",607).
component("YAR075W",215).
component("YAR073W",214).
component("YCL030C",288).
component("YDR127W",372).
component("YJR139C",688).
component("YML075C",813).
component("YLR450W",801).
component("YOL126C",926).
component("YKL085W",702).
component("YDL078C",319).
component("YKL029C",697).
component("YOR136W",943).
component("YNL037C",862).
component("YNL009W",860).
component("YLR174W",768).
component("YDL066W",317).
...
component("YML054C",809).
component("YDL174C",342).
component("YIL155C",624).
component("YPR191W",1040).
component("YOR065W",934).
component("YJL166W",659).
component("YHR001W-A",568).
component("YGR183C",542).
component("YFR033C",486).
component("YEL024W",427).
component("YDR529C",418).
component("YBL045C",222).
component("Q0105",19).
component("YKR066C",734).
component("YKL026C",696).
component("YIR037W",635).
component("YBR244W",274).
component("YJR078W",679).
component("U58_",167).
component("U107_",28).
component("YGR255C",557).
component("U108_",29).
component("YBL098W",227).
component("YMR015C",826).
component("YHR007C",569).
component("YDR402C",405).
component("YGL055W",499).
component("YGR175C",539).
component("YJR104C",682).
component("YHR008C",570).
component("YJL026W",638).
component("YIL066C",613).
component("YGR180C",541).
component("YER070W",455).
component("U37_",146).
component("U36_",145).
component("U35_",144).
component("YDR158W",380).
component("YJR009C",669).
component("YJL052W",640).
component("YGR192C",545).
component("YBR006W",232).
component("YPL276W",1013).
component("YPL275W",1012).
component("YOR388C",976).
component("YOR374W",973).
component("YER073W",456).
component("U68_",178).
component("YGL154C",507).
component("YBR115C",256).
component("U55_",164).
component("YER069W",453).
component("YOR323C",963).
component("U2_",138).
component("YER178W",469).
component("YBR221C",272).
component("YIL125W",620).
component("YBR166C",266).
component("YNL280C",888).
component("YGL012W",493).
component("YKL182W",715).
component("U57_",166).
component("YKL216W",726).
component("YDR044W",358).
component("YER014W",438).
component("YKR009C",730).
component("YIL160C",626).
component("YGL205W",512).
component("YMR118C",835).
component("YLR164W",766).
component("YLL041C",741).
component("YKL148C",710).
component("YKL141W",708).
component("YJL045W",639).
component("YDR178W",382).
component("YJR051W",674).
component("YEL047C",431).
component("YDL171C",341).
component("YOR375C",974).
component("YDL215C",346).
component("YAL062W",212).
component("U99_",206).
component("U100_",22).
component("YBR035C",242).
component("YMR189W",842).
component("U56_",165).
component("YNR050C",903).
component("YKR080W",736).
component("YER023W",439).
component("YPL023C",980).
component("YGL125W",504).
component("YOR236W",956).
component("YGR204W",549).
component("YBR084W",250).
component("YLR142W",759).
component("U65_",175).
component("U63_",173).
component("U62_",172).
component("YOR356W",971).
component("YHR068W",583).
component("YKL150W",711).
component("YIL043C",611).
component("YHR042W",577).
component("YOR221C",954).
component("YMR145C",838).
component("YML120C",818).
component("YKL192C",719).
component("YKL055C",699).
component("YER061C",449).
component("YDL085W",321).
component("YBR046C",245).
component("YMR145C",839).
component("YML120C",819).
component("YKL192C",720).
component("YDL085W",322).
component("YFR030W",485).
component("YPL017C",979).
component("YFL018C",474).
component("YPL091W",985).
component("YHR106W",592).
component("YDR353W",400).
component("YER042W",441).
component("YPR167C",1034).
component("YJR137C",687).
component("YNL052W",864).
component("YMR256C",850).
component("YLR395C",796).
component("YLR038C",748).
component("YIL111W",618).
component("YHR051W",581).
component("YGL191W",510).
component("YGL187C",509).
component("YDL067C",318).
component("Q0275",21).
component("Q0250",20).
component("Q0045",18).
component("YPL266W",1009).
component("YML110C",817).
component("YBR034C",241).
component("YPL273W",1011).
component("YLL062C",744).
component("YDR410C",408).
component("YKR069W",735).
component("YOL096C",921).
component("U47_",156).
component("YER091C",461).
component("YJR073C",677).
component("YGR157W",536).
component("YML008C",802).
component("YDL033C",310).
component("YOL096C",922).
component("YLR172C",767).
component("YLR058C",751).
component("YBR263W",278).
component("YDR019C",354).
component("YBR176W",267).
component("YDR408C",407).
component("YMR120C",836).
component("YLR028C",746).
component("YBL013W",216).
component("YJL130C",651).
component("YJL088W",645).
component("YPR074C",1026).
component("YBR117C",257).
component("YLR354C",791).
component("YGR043C",523).
component("YMR108W",833).
component("YCL009C",285).
component("YMR062C",829).
component("YNL071W",865).
component("YIL160C",627).
component("YNR019W",897).
component("YCR048W",303).
component("U48_",157).
component("YNL277W",886).
component("YDR232W",385).
component("YFL017C",473).
component("YPL231W",1003).
component("YER061C",450).
component("U86_",196).
component("YPL001W",978).
component("YDL052C",314).
component("U8_",199).
component("YDR148C",378).
component("YML042W",808).
component("YOR377W",975).
component("YGR177C",540).
component("YPL231W",1004).
component("YGR147C",534).
component("YDL040C",311).
component("YPL028W",981).
component("YLR195C",770).
component("YLR299W",780).
component("YGL017W",494).
component("YPR001W",1015).
component("YNR001C",893).
component("YCR005C",297).
component("YML126C",821).
component("YDL182W",343).
component("YDL131W",331).
component("YNL117W",869).
component("YIR031C",633).
component("YPR160W",1033).
component("YOR321W",962).
component("YJR143C",689).
component("YGR199W",547).
component("YDL095W",326).
component("YDL093W",325).
component("YAL023C",209).
component("YLR258W",777).
component("YFR015C",482).
component("YPL227C",1000).
component("YOR103C",938).
component("YOR085W",936).
component("YMR149W",840).
component("YML019W",804).
component("YJL002C",636).
component("YEL002C",423).
component("YDL232W",347).
component("YCL043C",292).
component("YNL029C",861).
component("YIL085C",616).
component("YMR261C",851).
component("YML100W",815).
component("YBR126C",260).
component("YNL192W",876).
component("YBR038W",244).
component("YBR023C",239).
component("YEL011W",424).
component("YMR306W",858).
component("YLR342W",789).
component("YGR032W",521).
component("YPR183W",1037).
component("YLR209C",771).
component("U104_",26).
component("U103_",25).
component("YMR271C",852).
component("YML106W",816).
component("YOR209C",952).
component("YMR300C",856).
component("YER055C",445).
component("YDR354W",401).
component("YFR047C",487).
component("YJR133W",686).
component("U22_",132).
component("YLR209C",772).
component("YML022W",805).
component("YDR441C",411).
component("YDR399W",403).
component("YHR128W",594).
component("YPR176C",1036).
component("YPL172C",993).
component("YNR041C",901).
component("YMR101C",831).
component("YDL090C",324).
component("YBR003W",231).
component("YBR002C",230).
component("YJL167W",660).
component("YJL167W",661).
component("YNL256W",881).
component("YPR069C",1024).
component("YDR127W",373).
component("YHR190W",602).
component("YLR146C",760).
component("YHR068W",584).
component("YLR303W",781).
component("YGR012W",519).
component("YML082W",814).
component("YJR130C",685).
component("YDR035W",356).
component("YBR249C",275).
component("YLR180W",769).
component("YDR502C",415).
component("YOR274W",959).
component("YOL143C",929).
component("YBR256C",277).
component("YHR137W",595).
component("YGL202W",511).
component("YLR027C",745).
component("YKL106W",704).
component("YOL140W",928).
component("YLR438W",800).
component("YKL104C",703).
component("YGR019W",520).
component("YDR111C",370).
component("U64_",174).
component("U61_",171).
component("U51_",161).
component("YJR148W",690).
component("YHR208W",605).
component("YFL030W",476).
component("YOR184W",949).
component("YNR058W",905).
component("YIL116W",619).
component("YGL253W",517).
component("YFR053C",488).
component("YOL136C",927).
component("YIL107C",617).
component("YMR013C",825).
component("YMR205C",844).
component("YGR240C",553).
component("YOL016C",910).
component("YFR014C",481).
component("YLR240W",775).
component("YKL203C",722).
component("YJR066W",676).
component("YCR036W",302).
component("YGR194C",546).
component("YCL040W",291).
component("YJR105W",683).
component("U16_",80).
component("YPL188W",995).
component("YJR049C",673).
component("YEL041W",428).
component("U96_",204).
component("YKL001C",694).
component("YDR236C",386).
component("YML070W",812).
component("YFL053W",478).
component("YHL032C",566).
component("YLR133W",756).
component("YDR531W",420).
component("U83_",193).
component("U82_",192).
component("U81_",191).
component("YMR208W",845).
component("YPL203W",996).
component("YOR061W",933).
component("YKL166C",713).
component("YJL164C",658).
component("YIL035C",610).
component("YHR205W",604).
component("YHR102W",591).
component("YGL019W",495).
component("YHR025W",576).
component("YOR347C",969).
component("YAL038W",210).
component("YNR012W",895).
component("YPR121W",1030).
component("YPL258C",1006).
component("YOL055C",914).
component("YPL214C",999).
component("U1_",111).
component("YDR009W",353).
component("YBR020W",238).
component("YNL267W",884).
component("YLR305C",783).
component("YFR019W",483).
component("YDR208W",383).
component("YDR127W",374).
component("U21_",124).
component("U20_",119).
component("YDR147W",377).
component("YDR300C",394).
component("YCR012W",298).
component("YER052C",443).
component("YER069W",454).
component("U19_",110).
component("U18_",100).
component("U17_",89).
component("U76_",187).
component("YMR220W",847).
component("YER170W",468).
component("YDR226W",384).
component("YKL067W",701).
component("YOL055C",915).
component("YDR454C",412).
component("YOL061W",919).
component("YKL181W",714).
component("YHL011C",563).
component("YER099C",463).
component("YBL068W",225).
component("YOR143C",944).
component("YNL256W",882).
component("YLR328W",787).
component("YBR018C",234).
component("YBR018C",235).
component("YDL055C",315).
component("YGR007W",518).
component("YGR202C",548).
component("YLR328W",788).
component("YKR002W",728).
component("YDL045C",312).
component("YDL103C",329).
component("U94_",203).
component("YJR010W",670).
component("YBR029C",240).
component("YCL050C",293).
component("YGL130W",505).
component("YDR530C",419).
component("YCL050C",294).
component("YPR190C",1039).
component("YPR187W",1038).
component("YPR110C",1028).
component("YPR010C",1017).
component("YOR341W",968).
component("YOR340C",967).
component("YOR224C",955).
component("YOR210W",953).
component("YOR207C",951).
component("YOR151C",945).
component("YOR116C",939).
component("YOL005C",907).
component("YNR003C",894).
component("YNL248C",880).
component("YNL151C",874).
component("YNL113W",868).
component("YKL144C",709).
component("YJR063W",675).
component("YJL148W",655).
component("YJL140W",654).
component("YIL021W",609).
component("YHR143W-A",596).
component("YGL070C",503).
component("YFL036W",477).
component("YDR404C",406).
component("YDR156W",379).
component("YDR045C",359).
component("YDL150W",339).
component("YDL140C",333).
component("YBR154C",265).
component("YPR175W",1035).
component("YPL167C",992).
component("YOR330C",964).
component("YOL115W",925).
component("YNL299W",890).
component("YNL262W",883).
component("YNL102W",867).
component("YJR043C",672).
component("YJR006W",668).
component("YJL090C",646).
component("YIL139C",622).
component("YEL055C",432).
component("YDR419W",409).
component("YDR121W",371).
component("YDL102W",328).
component("YCR014C",299).
component("YBR278W",279).
component("YBL035C",219).
component("YKL035W",698).
component("YHL012W",564).
component("YHR123W",593).
component("YPR113W",1029).
component("YBR243C",273).
component("YNL130C",870).
component("YDL142C",338).
component("YPL148C",990).
component("YER026C",440).
component("YOR251C",958).
component("YGR286C",560).
component("YJL068C",641).
component("YDR058C",364).
component("YNR034W",900).
component("YHR163W",599).
component("YGR248W",555).
component("YCR073W-A",305).
component("YDL086W",323).
component("YOL011W",909).
component("YMR008C",823).
component("YMR006C",822).
component("U105_",27).
component("U101_",23).
component("YJL068C",642).
component("YPL072W",984).
component("YOR124C",940).
component("YNL186W",875).
component("YMR304W",857).
component("YMR223W",848).
component("YKR098C",739).
component("YJL197W",662).
component("YIL156W",625).
component("YFR010W",480).
component("YER151C",467).
component("YER144C",466).
component("YER098W",462).
component("YDR069C",366).
component("YDL122W",330).
component("YBR058C",246).
component("YBL067C",224).
component("YJR019C",671).
component("YDR272W",389).
component("U84_",194).
component("YDR481C",413).
component("YLR377C",794).
component("YDR074W",367).
component("YFR025C",484).
component("YPL179W",994).
component("YNR032W",898).
component("YML057W",811).
component("YML016C",803).
component("YLR433C",799).
component("YGR123C",530).
component("YER133W",465).
component("YER089C",459).
component("YDR436W",410).
component("YDR075W",368).
component("YDL188C",344).
component("YDL134C",332).
component("YDL047W",313).
component("YDL006W",306).
component("YBR125C",259).
component("YBL056W",223).
component("YPR073C",1025).
component("YHR215W",606).
component("YDL024C",309).
component("YBR093C",254).
component("YBR092C",253).
component("YIL053W",612).
component("YER062C",451).
component("YHR046C",580).
component("U9_",207).
component("YGR208W",552).
component("YPL228W",1001).
component("YMR180C",841).
component("YDL236W",348).
component("YJL155C",657).
component("U34_",143).
component("U33_",142).
component("U32_",141).
component("U31_",140).
...
component("U26_",134).
component("U24_",133).
component("YHR044C",579).
component("YHR043C",578).
component("YOL064C",920).
component("YPL268W",1010).
component("YOR360C",972).
component("YGL248W",516).
component("YKR031C",731).
component("YPL206C",997).
component("YGL027C",497).
component("YLR286C",779).
component("YJR153W",691).
component("YJL221C",667).
component("YJL216C",665).
component("YIL172C",631).
component("YGR292W",562).
component("YGR287C",561).
component("YBR299W",284).
component("YBR184W",268).
component("YIL162W",628).
component("YPR026W",1018).
component("YDR001C",351).
component("YBR001C",229).
component("YDR400W",404).
component("YML035C",806).
component("YJL070C",643).
component("YBR284W",280).
component("U102_",24).
component("YER043C",442).
component("YNL045W",863).
component("YLR160C",765).
component("YLR158C",764).
component("YLR157C",763).
component("YLR155C",762).
component("YDR321W",395).
component("YGL037C",498).
component("U43_",152).
component("U42_",151).
component("YMR293C",855).
component("YDR242W",387).
component("YLR308W",786).
component("YLR307W",785).
component("YBR208C",270).
component("YMR281W",854).
component("U53_",162).
component("YLR420W",797).
component("YPL111W",988).
component("YIR032C",634).
component("YIR029W",632).
component("YPR062W",1023).
component("YMR120C",837).
component("YLR028C",747).
component("YHR144C",597).
component("YHR144C",598).
component("YCL030C",289).
component("YNL141W",871).
component("YBL033C",218).
component("YBR153W",264).
component("YDL238C",349).
component("YNL141W",872).
component("YLR245C",776).
component("YML035C",807).
component("YGR204W",550).
component("YBR084W",251).
component("YJL126W",649).
component("U44_",153).
component("YDL100C",327).
component("U40_",149).
component("U39_",147).
component("YBR011C",233).
component("YHR201C",603).
component("YBR111C",255).
component("YBR252W",276).
component("YCL030C",290).
component("YEL042W",429).
component("YER005W",437).
component("YBL099W",228).
component("U60_",170).
component("YLR231C",773).
component("U88_",197).
component("YDR538W",422).
component("YLR134W",757).
component("YLR044C",749).
component("YGR087C",527).
component("YDR380W",402).
component("YDL080C",320).
component("U98_",205).
component("YMR250W",849).
component("YKL184W",718).
component("YOR128C",941).
component("YEL021W",426).
component("YNR043W",902).
component("U93_",202).
component("YDR047W",361).
component("U54_",163).
component("YKL211C",724).
component("YKR097W",738).
component("YOL052C",913).
component("YGR170W",537).
component("YKL060C",700).
component("YDR294C",391).
component("YEL046C",430).
component("YNR033W",899).
component("YPR006C",1016).
component("YER065C",452).
component("YKL211C",725).
component("YER090W",460).
component("YDR127W",375).
component("YPL281C",1014).
component("YOR393W",977).
component("YMR323W",859).
component("YHR174W",600).
component("YGR254W",556).
component("YPL262W",1007).
component("YGL026C",496).
component("YGR155W",535).
component("YLR304C",782).
component("YJL200C",663).
component("YGL009C",492).
component("YNL316C",891).
component("YKL182W",716).
component("YPL212C",998).
component("YNL292W",889).
component("YGL063W",502).
component("YFL001W",471).
component("YOR278W",960).
component("U49_",158).
component("YCR053W",304).
component("YDR127W",376).
component("YGL148W",506).
component("YIL168W",630).
component("YIL167W",629).
component("YCL064C",295).
component("YCL064C",296).
component("YHR018C",572).
component("YLR359W",793).
component("YAL012W",208).
component("YFR055W",489).
component("YJL005W",637).
component("YOR176W",948).
component("YJL121C",648).
component("YBR019C",236).
component("YBR019C",237).
component("U59_",168).
component("YDR050C",362).
component("YIL020C",608).
component("YDR007W",352).
component("YOR095C",937).
component("YER003C",436).
component("YBR196C",269).
component("YGL001C",491).
component("YPL117C",989).
component("U14_",65).
component("YOL056W",916).
component("YKL152C",712).
component("YDL021W",307).
component("YMR105C",832).
component("YKL127W",706).
component("YEL058W",433).
component("YPR060C",1022).
component("YHR072W",585).
component("YJL153C",656).
component("YPL097W",986).
component("YGR185C",543).
component("YGR264C",559).
component("YGR171C",538).
component("YHR011W",571).
component("YDR023W",355).
component("YPL104W",987).
component("YLL018C",740).
component("YPR081C",1027).
component("YBR121C",258).
component("YHR020W",575).
component("YER087W",458).
component("YNL247W",879).
component("YOL033W",912).
component("YGL245W",515).
component("YOR168W",946).
component("YHR091C",587).
component("YDR341C",396).
component("YOL097C",923).
component("YDR268W",388).
component("YPR047W",1021).
component("YLR060W",752).
component("YFL022C",475).
component("YPR033C",1019).
component("YHR019C",573).
component("YHR019C",574).
component("YKL194C",721).
component("YIL078W",615).
component("YPL160W",991).
component("YLR382C",795).
component("YPL040C",982).
component("YBL076C",226).
component("YNL073W",866).
component("YDR037W",357).
component("YOR335C",965).
component("YGR094W",528).
component("YLR153C",761).
component("YAL054C",211).
component("YGR244C",554).
component("YPR035W",1020).
component("YIL145C",623).
component("U89_",198).
component("YOR241W",957).
component("YMR113W",834).
component("YKL132C",707).
component("YOR339C",966).
component("YMR022W",827).
component("YLR306W",784).
component("YKL210W",723).
component("YGR133W",533).
component("YGL058W",500).
component("YER100W",464).
component("YEL012W",425).
component("YDR177W",381).
component("YDR092W",369).
component("YDR059C",365).
component("YDR054C",363).
component("YDL064W",316).
component("YBR082C",249).
component("YJL101C",647).
component("U92_",201).
component("YAR015W",213).
component("YGL234W",513).
component("YER183C",470).
component("U90_",200).
...
component("YMR217W",846).
component("YPR145W",1032).
component("YGR124W",531).
component("YOR303W",961).
component("YJR109C",684).
component("YJL130C",652).
component("YGL062W",501).
component("YBR218C",271).
component("YPL231W",1005).
component("YNR016C",896).
component("YKL182W",717).
component("YGR037C",522).
component("YOR005C",931).
component("YDL164C",340).
component("YJL087C",644).
component("YOL010W",908).
component("YPR138C",1031).
component("YPL265W",1008).
component("YPL057C",983).
component("YOR348C",970).
component("YOR192C",950).
component("YOR171C",947).
component("YOR130C",942).
component("YOR071C",935).
component("YOR011W",932).
component("YOL156W",930).
component("YOL103W",924).
component("YOL020W",911).
component("YNR072W",906).
component("YNL318C",892).
component("YNL270C",885).
component("YNL142W",873).
component("YMR272C",853).
component("YMR202W",843).
component("YMR056C",828).
component("YMR011W",824).
component("YML123C",820).
component("YLR348C",790).
component("YLR260W",778).
component("YLR237W",774).
component("YLR138W",758).
component("YLR100C",755).
component("YLR092W",754).
component("YLR081W",753).
component("YLL061W",743).
component("YLL043W",742).
component("YKR093W",737).
component("YKR053C",733).
component("YKR039W",732).
component("YKL217W",727).
component("YKL120W",705).
component("YKL004W",695).
component("YJR158W",692).
component("YJR095W",680).
component("YJR077C",678).
component("YJL219W",666).
component("YJL214W",664).
component("YJL134W",653).
component("YJL129C",650).
component("YIL134W",621).
component("YHR096C",590).
component("YHR094C",589).
component("YHR092C",588).
component("YHL036W",567).
component("YHL016C",565).
component("YGR191W",544).
component("YGR125W",532).
component("YGR121C",529).
component("YGR065C",526).
component("YGR055W",524).
component("YGL186C",508).
component("YFL055W",479).
component("YFL011W",472).
component("YER060W-A",448).
component("YER060W",447).
component("YER056C",446).
component("YER053C",444).
component("YEL069C",435).
component("YEL063C",434).
component("YDR536W",421).
component("YDR508C",417).
component("YDR503C",416).
component("YDR497C",414).
component("YDR345C",399).
component("YDR343C",398).
component("YDR342C",397).
component("YDR297W",393).
component("YDR294C",392).
component("YDR284C",390).
component("YDR046C",360).
component("YDL245C",350).
component("YDL210W",345).
component("YCR032W",301).
component("YCR028C",300).
component("YCL025C",287).
component("YBR298C",283).
component("YBR294W",282).
component("YBR291C",281).
component("YBR085W",252).
component("YBR069C",248).
component("YBR068C",247).
component("YBR036C",243).
