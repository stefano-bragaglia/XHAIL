...
component("YNL280C",185).
component("YLR056W",160).
component("YGL001C",112).
component("YDR127W",80).
component("YNL009W",177).
component("YLR174W",162).
component("YHR183W",134).
component("YGR256W",125).
component("YCL018W",59).
component("YJR078W",146).
component("YMR015C",169).
component("YGL055W",115).
component("YOR323C",198).
component("YBR166C",55).
component("YNL280C",186).
component("YKL141W",151).
component("YOR375C",201).
component("YAL062W",43).
component("U100_",18).
component("YMR145C",170).
component("YDL085W",67).
component("YBR046C",48).
component("YDR410C",89).
component("YJL088W",139).
component("YPR074C",212).
component("YBR117C",53).
component("YNL071W",178).
component("YNR019W",189).
component("YCR048W",64).
component("U48_",36).
component("YPL231W",205).
component("YPL231W",206).
component("YLR299W",164).
component("YCR005C",61).
component("YNL117W",180).
component("YIR031C",137).
component("YOR321W",197).
component("YJR143C",149).
component("YGR199W",123).
component("YDL095W",69).
component("YDL093W",68).
component("YAL023C",42).
component("YDR354W",87).
component("YFR047C",110).
component("U22_",32).
component("YPR069C",211).
component("YDR127W",81).
component("YML082W",167).
component("YJR130C",148).
component("YDR035W",76).
component("YBR249C",57).
component("YHR137W",131).
component("YGL202W",118).
component("YLR027C",159).
component("YKL106W",150).
component("YLR438W",166).
component("U51_",37).
component("YMR013C",168).
component("YCR036W",63).
component("YJR105W",147).
component("YMR208W",172).
component("YHR025W",128).
component("YFR019W",109).
component("YDR208W",85).
component("YDR127W",82).
component("YER052C",96).
component("U19_",28).
component("U76_",41).
component("YDR226W",86).
component("YDR454C",91).
component("YOL061W",193).
component("YKL181W",152).
component("YHL011C",127).
component("YER099C",102).
component("YBL068W",47).
component("YLR328W",165).
component("YPR175W",215).
component("YPL167C",204).
component("YOR330C",199).
component("YOL115W",194).
component("YNL299W",187).
component("YNL262W",184).
component("YNL102W",179).
component("YJR043C",144).
component("YJR006W",143).
component("YJL090C",140).
component("YIL139C",135).
component("YEL055C",94).
component("YDR419W",90).
component("YDR121W",79).
component("YDL102W",70).
component("YCR014C",62).
component("YBR278W",58).
component("YBL035C",44).
component("YPL072W",203).
component("YOR124C",196).
component("YNL186W",183).
component("YMR304W",175).
component("YMR223W",173).
component("YKR098C",158).
component("YJL197W",142).
component("YIL156W",136).
component("YFR010W",108).
component("YER151C",104).
component("YER144C",103).
component("YER098W",101).
component("YDR069C",78).
component("YDL122W",71).
component("YBR058C",49).
component("YBL067C",46).
component("U32_",34).
component("U30_",33).
component("YHR044C",130).
component("YHR043C",129).
component("YGL037C",114).
component("U53_",38).
component("YHR144C",132).
component("YBR153W",54).
component("YNL141W",181).
component("U44_",35).
component("YBR111C",52).
component("YER005W",95).
component("YLR231C",163).
component("YDR380W",88).
component("YDL080C",66).
component("YMR250W",174).
component("YKL184W",153).
component("YKL211C",154).
component("YNR033W",190).
component("YKL211C",155).
component("YER090W",100).
component("YDR127W",83).
component("YPL281C",208).
component("YOR393W",202).
component("YMR323W",176).
component("YHR174W",133).
component("YGR254W",124).
component("YGL026C",113).
component("YNL316C",188).
component("YCR053W",65).
component("YDR127W",84).
component("YGL148W",116).
component("YFR055W",111).
component("YDR007W",75).
component("YOR095C",195).
component("YBR196C",56).
component("YPR060C",210).
component("YGR264C",126).
component("YGR171C",122).
component("YGL245W",119).
component("YPR047W",209).
component("YLR060W",161).
component("YFL022C",106).
component("YER183C",105).
component("YDL141W",72).
component("YDL141W",73).
component("YPR145W",214).
component("YGR124W",121).
component("YJL087C",138).
component("YOL010W",191).
component("YPR138C",213).
component("YPL265W",207).
component("YOR348C",200).
component("YOL020W",192).
component("YNL142W",182).
component("YMR202W",171).
component("YKR053C",157).
component("YKR039W",156).
component("YJR077C",145).
component("YJL134W",141).
component("YGR121C",120).
component("YGL186C",117).
component("YFL055W",107).
component("YER060W-A",99).
component("YER060W",98).
component("YER056C",97).
component("YDR536W",93).
component("YDR508C",92).
component("YDR046C",77).
