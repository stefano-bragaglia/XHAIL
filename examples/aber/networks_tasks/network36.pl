...
component("YNL280C",265).
component("YLR056W",220).
component("YGL001C",150).
component("YDR127W",107).
component("YNL009W",257).
component("YLR174W",227).
component("YHR183W",181).
component("YGR256W",167).
component("YCL018W",81).
component("YJR078W",199).
component("YMR015C",243).
component("YDR402C",119).
component("YGL055W",153).
component("YJL026W",186).
component("YGR180C",164).
component("YER069W",136).
component("YOR323C",286).
component("YBR166C",76).
component("YNL280C",266).
component("YKL141W",207).
component("YOR375C",289).
component("YDL215C",99).
component("YAL062W",59).
component("U100_",18).
component("U56_",51).
component("YPL023C",291).
component("YGL125W",154).
component("YOR236W",284).
component("YMR145C",247).
component("YDL085W",91).
component("YBR046C",67).
component("YPL273W",300).
component("YLL062C",216).
component("YDR410C",120).
component("YJR073C",197).
component("YOL096C",277).
component("YMR120C",246).
component("YJL130C",190).
component("YJL088W",188).
component("YPR074C",305).
component("YBR117C",73).
component("YCL009C",80).
component("YNL071W",258).
component("YNR019W",271).
component("YCR048W",87).
component("U48_",48).
component("YPL231W",296).
component("YDL052C",89).
component("U8_",55).
component("YPL231W",297).
component("YLR299W",230).
component("YCR005C",84).
component("YNL117W",260).
component("YIR031C",185).
component("YOR321W",285).
component("YJR143C",202).
component("YGR199W",165).
component("YDL095W",93).
component("YDL093W",92).
component("YAL023C",58).
component("YMR261C",253).
component("YML100W",238).
component("YBR126C",74).
component("YDR354W",116).
component("YFR047C",148).
component("U22_",39).
component("YDR399W",118).
component("YPR069C",304).
component("YDR127W",108).
component("YML082W",237).
component("YJR130C",201).
component("YDR035W",103).
component("YBR249C",78).
component("YHR137W",177).
component("YGL202W",157).
component("YLR027C",217).
component("YKL106W",205).
component("YOL140W",280).
component("YLR438W",236).
component("U51_",49).
component("YJR148W",203).
component("YMR013C",242).
component("YCR036W",86).
component("YCL040W",83).
component("YJR105W",200).
component("YMR208W",249).
component("YHR025W",173).
component("YNR012W",269).
component("YFR019W",146).
component("YDR208W",113).
component("YDR127W",109).
component("YDR147W",112).
component("YER052C",132).
component("U19_",34).
component("U18_",31).
component("U76_",54).
component("YMR220W",250).
component("YDR226W",114).
component("YDR454C",122).
component("YOL061W",276).
component("YKL181W",208).
component("YHL011C",169).
component("YER099C",139).
component("YBL068W",64).
component("YOR143C",283).
component("YLR328W",233).
component("U94_",56).
component("YBR029C",66).
component("YPR175W",308).
component("YPL167C",295).
component("YOR330C",287).
component("YOL115W",279).
component("YNL299W",267).
component("YNL262W",264).
component("YNL102W",259).
component("YJR043C",196).
component("YJR006W",195).
component("YJL090C",189).
component("YIL139C",183).
...
component("YKL035W",204).
component("YHL012W",170).
component("YOL011W",274).
component("YMR008C",241).
component("YMR006C",240).
component("U105_",19).
component("YPL072W",293).
component("YOR124C",282).
component("YNL186W",263).
component("YMR304W",255).
component("YMR223W",251).
component("YKR098C",215).
component("YJL197W",194).
component("YIL156W",184).
component("YFR010W",145).
component("YER151C",141).
component("YER144C",140).
component("YER098W",138).
component("YDR069C",105).
component("YDL122W",95).
component("YBR058C",68).
component("YBL067C",63).
component("YFR025C",147).
component("U9_",57).
component("YJL155C",193).
component("U34_",44).
component("U33_",43).
component("U32_",42).
component("U30_",41).
component("U24_",40).
component("YHR044C",175).
component("YHR043C",174).
component("YLR286C",229).
component("YLR160C",226).
component("YLR158C",225).
component("YLR157C",224).
component("YLR155C",223).
component("YDR321W",115).
component("YGL037C",152).
component("U43_",46).
component("U42_",45).
component("YLR308W",232).
component("YLR307W",231).
component("U53_",50).
component("YLR028C",218).
component("YHR144C",178).
component("YHR144C",179).
component("YBR153W",75).
component("YDL238C",100).
component("YNL141W",261).
component("U44_",47).
component("YHR201C",182).
component("YBR111C",72).
component("YER005W",131).
component("YLR231C",228).
component("YDR538W",127).
component("YLR134W",222).
component("YLR044C",219).
component("YGR087C",160).
component("YDR380W",117).
component("YDL080C",90).
component("YMR250W",252).
component("YKL184W",210).
component("YEL021W",128).
component("YKL211C",211).
component("YNR033W",272).
component("YKL211C",212).
component("YER090W",137).
component("YDR127W",110).
component("YPL281C",301).
component("YOR393W",290).
component("YMR323W",256).
component("YHR174W",180).
component("YGR254W",166).
component("YGL026C",151).
component("YNL316C",268).
component("YCR053W",88).
component("YDR127W",111).
component("YGL148W",155).
component("YFR055W",149).
component("YDR007W",101).
component("YOR095C",281).
component("YBR196C",77).
component("U14_",25).
component("YMR105C",245).
component("YKL127W",206).
component("YEL058W",130).
component("YPR060C",303).
component("YHR072W",176).
component("YJL153C",192).
component("YGR264C",168).
component("YGR171C",163).
component("YHR011W",171).
component("YDR023W",102).
component("YGL245W",158).
component("YPR047W",302).
component("YLR060W",221).
component("YFL022C",143).
component("YHR019C",172).
component("YPL160W",294).
component("YLR382C",235).
component("YPL040C",292).
component("YBL076C",65).
component("YER183C",142).
component("YDL141W",96).
component("YDL141W",97).
component("YPR145W",307).
component("YGR124W",162).
component("YPL231W",298).
component("YNR016C",270).
component("YKL182W",209).
component("YGR037C",159).
component("YJL087C",187).
component("YOL010W",273).
component("YPR138C",306).
component("YPL265W",299).
component("YOR348C",288).
component("YOL103W",278).
component("YOL020W",275).
component("YNL142W",262).
component("YMR272C",254).
component("YMR202W",248).
component("YMR056C",244).
component("YML123C",239).
component("YLR348C",234).
component("YKR053C",214).
component("YKR039W",213).
component("YJR077C",198).
component("YJL134W",191).
component("YGR121C",161).
component("YGL186C",156).
component("YFL055W",144).
component("YER060W-A",135).
component("YER060W",134).
component("YER056C",133).
