...
component("YNL280C",441).
component("YLR056W",368).
component("YMR083W",410).
component("YPL231W",500).
component("YJR159W",342).
component("YGL001C",236).
component("YML056C",397).
component("YLR432W",393).
component("YHR216W",297).
component("YAR075W",97).
component("YAR073W",96).
component("YDR127W",180).
component("YJR139C",339).
component("YOR136W",470).
component("YNL009W",425).
component("YLR174W",380).
component("YHR183W",293).
component("YGR256W",273).
component("YOL059W",460).
component("YDL022W",144).
component("YCL018W",133).
component("YJR078W",335).
component("U58_",79).
component("YGR255C",272).
component("YMR015C",407).
component("YDR402C",194).
component("YGL055W",242).
component("YJL026W",309).
component("YGR180C",265).
component("U35_",69).
component("YJR009C",327).
component("YJL052W",310).
component("YGR192C",267).
component("YOR374W",485).
component("YER073W",215).
component("U68_",83).
component("U55_",77).
component("YER069W",214).
component("YOR323C",479).
component("U2_",64).
component("YBR166C",124).
component("YNL280C",442).
component("YKL141W",348).
component("YJR051W",331).
component("YOR375C",486).
component("YDL215C",166).
component("YAL062W",95).
component("U100_",20).
component("YBR035C",109).
component("YMR189W",414).
component("U56_",78).
component("YPL023C",489).
component("YGL125W",245).
component("YOR236W",477).
component("YBR084W",115).
component("YLR142W",374).
component("U65_",82).
component("U62_",81).
component("YHR068W",284).
component("YMR145C",413).
component("YML120C",401).
component("YKL192C",354).
component("YDL085W",149).
component("YBR046C",111).
component("YPL091W",492).
component("YNL052W",426).
component("YMR256C",420).
component("YLR395C",391).
component("YLR038C",366).
component("YIL111W",301).
component("YHR051W",283).
component("YGL191W",249).
component("YGL187C",248).
component("YDL067C",147).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",506).
component("YLL062C",363).
component("YDR410C",196).
component("YER091C",218).
component("YJR073C",333).
component("YOL096C",462).
component("YLR172C",379).
component("YMR120C",412).
component("YBL013W",98).
component("YJL130C",317).
component("YJL088W",313).
component("YPR074C",513).
component("YBR117C",119).
component("YCL009C",132).
component("YMR062C",409).
component("YNL071W",427).
component("YIL160C",304).
component("YNR019W",449).
component("YCR048W",141).
component("U48_",73).
component("YFL017C",226).
component("YPL231W",501).
component("YDL052C",146).
component("U8_",90).
component("YOR377W",487).
component("YGR177C",264).
component("YPL231W",502).
component("YLR299W",384).
component("YPR001W",508).
component("YNR001C",445).
component("YCR005C",138).
component("YML126C",403).
component("YDL182W",163).
component("YDL131W",155).
component("YNL117W",430).
component("YIR031C",307).
component("YOR321W",478).
component("YJR143C",340).
component("YGR199W",269).
component("YDL095W",151).
component("YDL093W",150).
component("YAL023C",94).
component("YPL227C",499).
component("YMR261C",421).
component("YML100W",400).
component("YBR126C",121).
component("YNL192W",437).
component("YBR038W",110).
component("YBR023C",107).
component("YLR209C",381).
component("YDR354W",191).
component("YFR047C",233).
component("YJR133W",338).
component("U22_",59).
component("YDR399W",193).
component("YJL167W",324).
component("YPR069C",512).
component("YDR127W",181).
component("YHR068W",285).
component("YLR303W",385).
component("YML082W",399).
component("YJR130C",337).
component("YDR035W",170).
component("YBR249C",127).
component("YBR256C",128).
component("YHR137W",288).
component("YGL202W",250).
component("YLR027C",364).
component("YKL106W",346).
component("YOL140W",465).
component("YLR438W",395).
component("YKL104C",345).
component("YDR111C",178).
component("U51_",75).
component("YJR148W",341).
component("YHR208W",296).
component("YGL253W",254).
component("YFR053C",234).
component("YMR013C",406).
component("YCR036W",140).
component("YGR194C",268).
component("YCL040W",136).
component("YJR105W",336).
component("U81_",88).
component("YMR208W",416).
component("YPL203W",498).
component("YOR061W",466).
component("YKL166C",350).
component("YJL164C",323).
component("YIL035C",299).
component("YHR205W",295).
component("YHR102W",287).
component("YGL019W",238).
component("YHR025W",279).
component("YNR012W",447).
component("YPR121W",515).
component("YPL258C",504).
component("YOL055C",458).
component("YFR019W",231).
component("YDR208W",187).
component("YDR127W",182).
component("U21_",56).
component("YDR147W",185).
component("YER052C",210).
component("U19_",49).
component("U18_",45).
component("U17_",42).
component("U76_",86).
component("YMR220W",417).
component("YER170W",224).
component("YDR226W",188).
component("YKL067W",344).
component("YOL055C",459).
component("YDR454C",199).
component("YOL061W",461).
component("YKL181W",351).
component("YHL011C",275).
component("YER099C",220).
component("YBL068W",104).
component("YOR143C",471).
component("YNL256W",439).
component("YLR328W",388).
component("YDL103C",153).
component("U94_",92).
component("YJR010W",328).
component("YBR029C",108).
component("YPR190C",520).
component("YPR187W",519).
component("YPR110C",514).
component("YPR010C",509).
component("YOR341W",482).
component("YOR340C",481).
component("YOR224C",476).
component("YOR210W",475).
component("YOR207C",474).
component("YOR151C",472).
component("YOR116C",468).
component("YOL005C",454).
component("YNR003C",446).
component("YNL248C",438).
component("YNL151C",435).
component("YNL113W",429).
component("YKL144C",349).
component("YJR063W",332).
component("YJL148W",320).
component("YJL140W",319).
component("YIL021W",298).
component("YHR143W-A",289).
component("YGL070C",244).
component("YFL036W",228).
component("YDR404C",195).
component("YDR156W",186).
component("YDR045C",172).
component("YDL150W",162).
component("YDL140C",157).
component("YBR154C",123).
component("YPR175W",518).
component("YPL167C",496).
component("YOR330C",480).
component("YOL115W",464).
component("YNL299W",443).
component("YNL262W",440).
component("YNL102W",428).
component("YJR043C",330).
component("YJR006W",326).
component("YJL090C",314).
component("YIL139C",302).
component("YEL055C",206).
component("YDR419W",197).
...
component("YHL012W",276).
component("YNL130C",431).
component("YPL148C",494).
component("YDR058C",174).
component("YOL011W",456).
component("YMR008C",405).
component("YMR006C",404).
component("U105_",22).
component("U101_",21).
component("YJL068C",311).
component("YPL072W",491).
component("YOR124C",469).
component("YNL186W",436).
component("YMR304W",423).
component("YMR223W",418).
component("YKR098C",362).
component("YJL197W",325).
component("YIL156W",303).
component("YFR010W",230).
component("YER151C",223).
component("YER144C",222).
component("YER098W",219).
component("YDR069C",175).
component("YDL122W",154).
component("YBR058C",112).
component("YBL067C",103).
component("YJR019C",329).
component("YDR074W",176).
component("YFR025C",232).
component("YPL179W",497).
component("YNR032W",450).
component("YML057W",398).
component("YML016C",396).
component("YLR433C",394).
component("YGR123C",259).
component("YER133W",221).
component("YER089C",216).
component("YDR436W",198).
...
component("YHR046C",282).
component("U9_",93).
component("YGR208W",270).
component("YJL155C",322).
component("U34_",68).
component("U33_",67).
component("U32_",66).
component("U30_",65).
...
component("U26_",61).
component("U24_",60).
component("YHR044C",281).
component("YHR043C",280).
component("YOR360C",484).
component("YGL248W",253).
component("YGL027C",240).
component("YLR286C",383).
component("YER043C",209).
component("YLR160C",378).
component("YLR158C",377).
component("YLR157C",376).
component("YLR155C",375).
component("YDR321W",190).
component("YGL037C",241).
component("U43_",71).
component("U42_",70).
component("YLR308W",387).
component("YLR307W",386).
component("U53_",76).
component("YLR420W",392).
component("YIR032C",308).
component("YLR028C",365).
component("YHR144C",290).
component("YHR144C",291).
component("YNL141W",432).
...
component("U44_",72).
component("YHR201C",294).
component("YBR111C",118).
component("YCL030C",135).
component("YER005W",208).
component("YLR231C",382).
component("U88_",89).
component("YDR538W",204).
component("YLR134W",372).
component("YLR044C",367).
component("YGR087C",256).
component("YDR380W",192).
component("YDL080C",148).
component("YMR250W",419).
component("YKL184W",353).
component("YEL021W",205).
component("YNR043W",452).
component("YKL211C",356).
component("YKR097W",361).
component("YNR033W",451).
component("YKL211C",357).
component("YER090W",217).
component("YDR127W",183).
component("YPL281C",507).
component("YOR393W",488).
component("YMR323W",424).
component("YHR174W",292).
component("YGR254W",271).
component("YGL026C",239).
component("YGR155W",262).
component("YNL316C",444).
component("YCR053W",142).
component("YDR127W",184).
component("YGL148W",246).
component("YIL168W",306).
component("YIL167W",305).
component("YCL064C",137).
component("YFR055W",235).
component("YJL121C",315).
component("YBR019C",106).
component("YDR007W",168).
component("YOR095C",467).
component("YBR196C",125).
component("YGL001C",237).
component("YPL117C",493).
component("U14_",33).
component("YMR105C",411).
component("YKL127W",347).
component("YEL058W",207).
component("YPR060C",511).
component("YHR072W",286).
component("YJL153C",321).
component("YGR264C",274).
component("YGR171C",263).
component("YHR011W",277).
component("YDR023W",169).
component("YGL245W",252).
component("YOR168W",473).
component("YPR047W",510).
component("YLR060W",369).
component("YFL022C",227).
component("YHR019C",278).
component("YKL194C",355).
component("YIL078W",300).
component("YPL160W",495).
component("YLR382C",390).
component("YPL040C",490).
component("YBL076C",105).
component("YDR037W",171).
component("YGR094W",257).
component("YGL234W",251).
component("YER183C",225).
component("U90_",91).
...
component("YPR145W",517).
component("YGR124W",260).
component("YGL062W",243).
component("YBR218C",126).
component("YPL231W",503).
component("YNR016C",448).
component("YKL182W",352).
component("YGR037C",255).
component("YJL087C",312).
component("YOL010W",455).
component("YPR138C",516).
component("YPL265W",505).
component("YOR348C",483).
component("YOL103W",463).
component("YOL020W",457).
component("YNL142W",434).
component("YMR272C",422).
component("YMR202W",415).
component("YMR056C",408).
component("YML123C",402).
component("YLR348C",389).
component("YLR138W",373).
component("YLR100C",371).
component("YLR092W",370).
component("YKR053C",360).
component("YKR039W",359).
component("YKL217W",358).
component("YJR077C",334).
component("YJL134W",318).
component("YGR191W",266).
component("YGR125W",261).
component("YGR121C",258).
component("YGL186C",247).
component("YFL055W",229).
component("YER060W-A",213).
component("YER060W",212).
component("YER056C",211).
component("YDR536W",203).
component("YDR508C",202).
component("YDR503C",201).
component("YDR497C",200).
