...
component("YKR009C",483).
component("YMR083W",553).
component("YPL231W",672).
component("YJR159W",457).
component("YGL001C",315).
...
component("YJR139C",453).
component("YOR136W",631).
component("YNL009W",575).
component("YLR174W",510).
component("YDL066W",199).
component("YHR183W",393).
component("YGR256W",364).
component("YNL241C",590).
component("YOL059W",618).
component("YDL022W",194).
component("YCL018W",180).
component("YLR355C",526).
component("YML054C",537).
component("YIL155C",407).
component("YEL024W",273).
component("YJR078W",448).
component("U58_",107).
component("YGR255C",363).
component("U108_",26).
component("YMR015C",550).
component("YDR402C",256).
component("YGL055W",322).
component("YJL026W",417).
component("YIL066C",403).
component("YGR180C",353).
component("YER070W",289).
component("U36_",94).
component("U35_",93).
component("YJR009C",439).
component("YJL052W",418).
component("YGR192C",355).
component("YOR374W",653).
component("YER073W",290).
component("U68_",112).
component("YGL154C",329).
component("U55_",105).
component("YER069W",288).
...
component("YKL182W",473).
component("YDR044W",228).
component("YER014W",277).
component("YKR009C",484).
component("YIL160C",409).
component("YGL205W",334).
component("YKL141W",467).
component("YJR051W",443).
component("YOR375C",654).
component("YDL215C",220).
component("YAL062W",133).
component("U100_",20).
component("YBR035C",151).
component("YMR189W",561).
component("U56_",106).
component("YKR080W",489).
component("YPL023C",658).
component("YGL125W",326).
component("YOR236W",641).
component("YGR204W",358).
component("YBR084W",157).
component("YLR142W",504).
component("U65_",110).
component("U62_",109).
component("YHR068W",382).
component("YKL150W",469).
component("YIL043C",401).
component("YHR042W",376).
component("YOR221C",639).
component("YMR145C",558).
component("YML120C",543).
component("YKL192C",476).
component("YKL055C",460).
component("YER061C",284).
component("YDL085W",202).
component("YBR046C",153).
component("YMR145C",559).
component("YML120C",544).
component("YKL192C",477).
component("YDL085W",203).
component("YPL017C",657).
component("YFL018C",304).
component("YPL091W",661).
component("YER042W",278).
component("YNL052W",577).
component("YMR256C",569).
component("YLR395C",530).
component("YLR038C",496).
component("YIL111W",405).
component("YHR051W",380).
component("YGL191W",332).
component("YGL187C",331).
component("YDL067C",200).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",678).
component("YPL273W",680).
component("YLL062C",493).
component("YDR410C",258).
component("YKR069W",488).
component("YER091C",294).
component("YJR073C",446).
component("YDL033C",195).
component("YOL096C",621).
component("YLR172C",509).
component("YMR120C",557).
component("YBL013W",136).
component("YJL130C",426).
component("YJL088W",421).
component("YPR074C",691).
component("YBR117C",161).
component("YMR108W",555).
component("YCL009C",179).
component("YMR062C",552).
component("YNL071W",578).
component("YIL160C",410).
component("YNR019W",605).
component("YCR048W",191).
component("U48_",100).
component("YNL277W",595).
component("YFL017C",303).
component("YPL231W",673).
component("YER061C",285).
component("U86_",125).
component("YDL052C",197).
component("U8_",128).
component("YDR148C",243).
component("YOR377W",655).
component("YGR177C",352).
component("YPL231W",674).
component("YLR195C",512).
component("YLR299W",518).
component("YPR001W",682).
component("YNR001C",601).
component("YCR005C",187).
component("YML126C",546).
component("YDL182W",217).
component("YDL131W",209).
component("YNL117W",582).
component("YIR031C",415).
component("YPR160W",697).
component("YOR321W",645).
component("YJR143C",454).
component("YGR199W",357).
component("YDL095W",205).
component("YDL093W",204).
component("YAL023C",132).
component("YPL227C",670).
component("YMR261C",570).
component("YML100W",542).
component("YBR126C",164).
component("YNL192W",589).
component("YBR038W",152).
component("YBR023C",149).
component("YEL011W",271).
component("YLR209C",513).
component("U104_",24).
component("U103_",23).
component("YOR209C",637).
component("YMR300C",572).
component("YDR354W",252).
component("YFR047C",312).
component("YJR133W",452).
component("U22_",83).
component("YLR209C",514).
component("YDR399W",254).
component("YJL167W",433).
component("YNL256W",592).
component("YPR069C",690).
component("YDR127W",238).
component("YHR190W",394).
component("YHR068W",383).
component("YLR303W",519).
component("YML082W",541).
component("YJR130C",451).
component("YDR035W",226).
component("YBR249C",172).
component("YLR180W",511).
component("YDR502C",264).
component("YOL143C",625).
component("YBR256C",174).
component("YHR137W",388).
component("YGL202W",333).
component("YLR027C",494).
component("YKL106W",463).
component("YOL140W",624).
component("YLR438W",534).
component("YKL104C",462).
component("YGR019W",340).
component("YDR111C",235).
component("U51_",103).
component("YJR148W",455).
component("YHR208W",397).
component("YOR184W",635).
component("YNR058W",610).
component("YGL253W",339).
component("YFR053C",313).
component("YMR013C",549).
component("YMR205C",563).
component("YGR240C",361).
component("YLR240W",516).
component("YKL203C",479).
component("YJR066W",445).
component("YCR036W",190).
component("YGR194C",356).
component("YCL040W",184).
component("YJR105W",450).
component("U16_",55).
component("YKL001C",458).
component("YML070W",540).
component("YFL053W",307).
component("YDR531W",268).
component("U82_",123).
component("U81_",122).
component("YMR208W",564).
component("YPL203W",668).
component("YOR061W",626).
component("YKL166C",471).
component("YJL164C",432).
component("YIL035C",400).
component("YHR205W",396).
component("YHR102W",386).
component("YGL019W",318).
component("YHR025W",375).
component("YNR012W",603).
component("YPR121W",694).
component("YPL258C",676).
component("YOL055C",616).
component("U1_",72).
component("YDR009W",224).
component("YBR020W",148).
component("YFR019W",310).
component("YDR208W",245).
component("YDR127W",239).
component("U21_",80).
component("YDR147W",242).
component("YDR300C",250).
component("YCR012W",188).
component("YER052C",280).
component("U19_",71).
component("U18_",65).
component("U17_",60).
component("U76_",119).
component("YMR220W",566).
component("YER170W",300).
component("YDR226W",246).
component("YKL067W",461).
component("YOL055C",617).
component("YDR454C",261).
component("YOL061W",619).
component("YKL181W",472).
component("YHL011C",369).
component("YER099C",296).
component("YBL068W",142).
component("YOR143C",632).
component("YNL256W",593).
component("YLR328W",523).
component("YBR018C",146).
component("YDL055C",198).
component("YLR328W",524).
component("YDL103C",207).
component("U94_",130).
component("YJR010W",440).
component("YBR029C",150).
component("YGL130W",327).
component("YDR530C",267).
component("YPR190C",700).
component("YPR187W",699).
component("YPR110C",693).
component("YPR010C",684).
component("YOR341W",650).
component("YOR340C",649).
component("YOR224C",640).
component("YOR210W",638).
component("YOR207C",636).
component("YOR151C",633).
component("YOR116C",628).
component("YOL005C",611).
component("YNR003C",602).
component("YNL248C",591).
component("YNL151C",587).
component("YNL113W",581).
component("YKL144C",468).
component("YJR063W",444).
component("YJL148W",429).
component("YJL140W",428).
component("YIL021W",399).
component("YHR143W-A",389).
component("YGL070C",325).
component("YFL036W",306).
component("YDR404C",257).
component("YDR156W",244).
component("YDR045C",229).
component("YDL150W",216).
component("YDL140C",211).
component("YBR154C",166).
component("YPR175W",698).
component("YPL167C",666).
component("YOR330C",647).
component("YOL115W",623).
component("YNL299W",599).
component("YNL262W",594).
component("YNL102W",580).
component("YJR043C",442).
component("YJR006W",438).
component("YJL090C",422).
component("YIL139C",406).
component("YEL055C",274).
component("YDR419W",259).
component("YDR121W",236).
component("YDL102W",206).
component("YCR014C",189).
component("YBR278W",175).
component("YBL035C",138).
component("YKL035W",459).
component("YHL012W",370).
component("YHR123W",387).
component("YNL130C",583).
component("YPL148C",664).
component("YOR251C",643).
...
component("U105_",25).
component("U101_",21).
component("YJL068C",419).
component("YPL072W",660).
component("YOR124C",629).
component("YNL186W",588).
component("YMR304W",573).
component("YMR223W",567).
component("YKR098C",491).
component("YJL197W",434).
component("YIL156W",408).
component("YFR010W",309).
component("YER151C",299).
component("YER144C",298).
component("YER098W",295).
component("YDR069C",232).
component("YDL122W",208).
component("YBR058C",154).
component("YBL067C",141).
component("YJR019C",441).
component("YDR481C",262).
component("YLR377C",528).
component("YDR074W",233).
component("YFR025C",311).
component("YPL179W",667).
component("YNR032W",606).
component("YML057W",539).
component("YML016C",535).
component("YLR433C",533).
component("YGR123C",347).
component("YER133W",297).
component("YER089C",292).
component("YDR436W",260).
component("YDR075W",234).
component("YDL188C",218).
component("YDL134C",210).
component("YDL047W",196).
component("YDL006W",193).
component("YBR125C",163).
component("YBL056W",140).
component("YIL053W",402).
component("YER062C",286).
component("YHR046C",379).
component("U9_",131).
component("YGR208W",360).
component("YPL228W",671).
component("YMR180C",560).
component("YJL155C",431).
component("U34_",92).
component("U33_",91).
component("U32_",90).
component("U30_",89).
...
component("U26_",85).
component("U24_",84).
component("YHR044C",378).
component("YHR043C",377).
component("YOL064C",620).
component("YPL268W",679).
component("YOR360C",652).
component("YGL248W",338).
component("YKR031C",485).
component("YGL027C",320).
component("YLR286C",517).
component("YJR153W",456).
component("YJL221C",437).
component("YJL216C",436).
component("YIL172C",414).
component("YGR292W",368).
component("YGR287C",367).
component("YBR299W",178).
component("YBR184W",168).
component("YIL162W",411).
component("YPR026W",685).
component("YDR001C",222).
component("YBR001C",145).
component("YDR400W",255).
component("U102_",22).
component("YER043C",279).
component("YNL045W",576).
component("YLR160C",508).
component("YLR158C",507).
component("YLR157C",506).
component("YLR155C",505).
component("YDR321W",251).
component("YGL037C",321).
component("U43_",98).
component("U42_",97).
component("YLR308W",522).
component("YLR307W",521).
component("U53_",104).
component("YLR420W",531).
component("YPL111W",662).
component("YIR032C",416).
component("YLR028C",495).
component("YHR144C",390).
component("YHR144C",391).
component("YNL141W",584).
component("YBR153W",165).
component("YDL238C",221).
component("YNL141W",585).
component("YML035C",536).
component("YBR084W",158).
component("YJL126W",424).
component("U44_",99).
component("U39_",95).
component("YHR201C",395).
component("YBR111C",160).
component("YBR252W",173).
component("YCL030C",183).
component("YER005W",276).
component("YBL099W",144).
component("YLR231C",515).
component("U88_",126).
component("YDR538W",270).
component("YLR134W",502).
component("YLR044C",497).
component("YGR087C",344).
component("YDR380W",253).
component("YDL080C",201).
component("YMR250W",568).
component("YKL184W",475).
component("YEL021W",272).
component("YNR043W",608).
component("YKL211C",480).
component("YKR097W",490).
component("YOL052C",615).
component("YDR294C",247).
component("YNR033W",607).
component("YPR006C",683).
component("YER065C",287).
component("YKL211C",481).
component("YER090W",293).
component("YDR127W",240).
component("YPL281C",681).
component("YOR393W",656).
component("YMR323W",574).
component("YHR174W",392).
component("YGR254W",362).
component("YGL026C",319).
component("YGR155W",350).
component("YLR304C",520).
component("YJL200C",435).
component("YNL316C",600).
component("YPL212C",669).
component("YNL292W",598).
component("YGL063W",324).
component("YFL001W",302).
component("YCR053W",192).
component("YDR127W",241).
component("YGL148W",328).
component("YIL168W",413).
component("YIL167W",412).
component("YCL064C",185).
component("YCL064C",186).
component("YLR359W",527).
component("YFR055W",314).
component("YJL121C",423).
component("YBR019C",147).
component("YDR007W",223).
component("YOR095C",627).
component("YBR196C",169).
component("YGL001C",316).
component("YPL117C",663).
component("U14_",46).
component("YKL152C",470).
component("YMR105C",554).
component("YKL127W",465).
component("YEL058W",275).
component("YPR060C",689).
component("YHR072W",384).
component("YJL153C",430).
component("YGR264C",365).
component("YGR171C",351).
component("YHR011W",372).
component("YDR023W",225).
component("YPR081C",692).
component("YBR121C",162).
component("YHR020W",374).
component("YER087W",291).
component("YGL245W",337).
component("YOR168W",634).
component("YPR047W",688).
component("YLR060W",499).
component("YFL022C",305).
component("YPR033C",686).
component("YHR019C",373).
component("YKL194C",478).
component("YIL078W",404).
component("YPL160W",665).
component("YLR382C",529).
component("YPL040C",659).
component("YBL076C",143).
component("YNL073W",579).
component("YDR037W",227).
component("YOR335C",648).
component("YGR094W",345).
component("YPR035W",687).
component("U89_",127).
component("YOR241W",642).
component("YMR113W",556).
component("YKL132C",466).
component("YGL234W",335).
component("YER183C",301).
component("U90_",129).
...
component("YMR217W",565).
component("YPR145W",696).
component("YGR124W",348).
component("YOR303W",644).
component("YGL062W",323).
component("YBR218C",170).
component("YPL231W",675).
component("YNR016C",604).
component("YKL182W",474).
component("YGR037C",341).
component("YJL087C",420).
component("YOL010W",612).
component("YPR138C",695).
component("YPL265W",677).
component("YOR348C",651).
component("YOR130C",630).
component("YOL103W",622).
component("YOL020W",614).
component("YNL142W",586).
component("YMR272C",571).
component("YMR202W",562).
component("YMR056C",551).
component("YML123C",545).
component("YLR348C",525).
component("YLR138W",503).
component("YLR100C",501).
component("YLR092W",500).
component("YLL061W",492).
component("YKR053C",487).
component("YKR039W",486).
component("YKL217W",482).
component("YKL120W",464).
component("YJR095W",449).
component("YJR077C",447).
component("YJL134W",427).
component("YJL129C",425).
component("YHL036W",371).
component("YGR191W",354).
component("YGR125W",349).
component("YGR121C",346).
component("YGR065C",343).
component("YGR055W",342).
component("YGL186C",330).
component("YFL055W",308).
...
component("YDR046C",230).
component("YDL210W",219).
component("YCL025C",181).
component("YBR294W",177).
component("YBR291C",176).
component("YBR085W",159).
component("YBR069C",156).
component("YBR068C",155).
component("YBL042C",139).
component("YBL030C",137).
component("U85_",124).
component("U7_",121).
component("U79_",120).
component("U75_",118).
