...
component("YNL280C",243).
component("YLR056W",206).
component("YGL001C",139).
component("YDR127W",98).
component("YNL009W",235).
component("YLR174W",213).
component("YHR183W",169).
component("YGR256W",156).
component("YCL018W",73).
component("YJR078W",186).
component("YMR015C",224).
component("YDR402C",110).
component("YGL055W",142).
component("YJL026W",174).
component("YGR180C",153).
component("YER069W",125).
component("YOR323C",262).
component("YBR166C",69).
component("YNL280C",244).
component("YKL141W",194).
component("YOR375C",265).
component("YDL215C",91).
component("YAL062W",53).
component("U100_",18).
component("U56_",46).
component("YPL023C",267).
component("YGL125W",143).
component("YMR145C",227).
component("YDL085W",83).
component("YBR046C",61).
component("YPL273W",275).
component("YLL062C",203).
component("YDR410C",111).
component("YJR073C",184).
component("YOL096C",255).
component("YJL088W",176).
component("YPR074C",280).
component("YBR117C",67).
component("YNL071W",236).
component("YNR019W",249).
component("YCR048W",79).
component("U48_",43).
component("YPL231W",271).
component("YDL052C",81).
component("U8_",50).
component("YPL231W",272).
component("YLR299W",215).
component("YCR005C",76).
component("YNL117W",238).
component("YIR031C",173).
component("YOR321W",261).
component("YJR143C",189).
component("YGR199W",154).
component("YDL095W",85).
component("YDL093W",84).
component("YAL023C",52).
component("YDR354W",107).
component("YFR047C",137).
component("U22_",37).
component("YDR399W",109).
component("YPR069C",279).
component("YDR127W",99).
component("YML082W",220).
component("YJR130C",188).
component("YDR035W",94).
component("YBR249C",71).
component("YHR137W",165).
component("YGL202W",146).
component("YLR027C",204).
component("YKL106W",192).
component("YLR438W",219).
component("U51_",44).
component("YJR148W",190).
component("YMR013C",223).
component("YCR036W",78).
component("YCL040W",75).
component("YJR105W",187).
component("YMR208W",229).
component("YHR025W",161).
component("YNR012W",247).
component("YFR019W",135).
component("YDR208W",104).
component("YDR127W",100).
component("YDR147W",103).
component("YER052C",121).
component("U19_",32).
component("U76_",49).
component("YMR220W",230).
component("YDR226W",105).
component("YDR454C",113).
component("YOL061W",254).
component("YKL181W",195).
component("YHL011C",158).
component("YER099C",128).
component("YBL068W",58).
component("YOR143C",260).
component("YLR328W",218).
component("YBR029C",60).
component("YPR175W",283).
component("YPL167C",270).
component("YOR330C",263).
component("YOL115W",257).
component("YNL299W",245).
component("YNL262W",242).
component("YNL102W",237).
component("YJR043C",183).
component("YJR006W",182).
component("YJL090C",177).
component("YIL139C",171).
component("YEL055C",119).
component("YDR419W",112).
component("YDR121W",97).
component("YDL102W",86).
component("YCR014C",77).
component("YBR278W",72).
component("YBL035C",55).
component("YKL035W",191).
component("YHL012W",159).
component("YOL011W",252).
component("YMR008C",222).
component("YMR006C",221).
component("U105_",19).
component("YPL072W",269).
component("YOR124C",259).
component("YNL186W",241).
component("YMR304W",233).
component("YMR223W",231).
component("YKR098C",202).
component("YJL197W",181).
component("YIL156W",172).
component("YFR010W",134).
component("YER151C",130).
component("YER144C",129).
component("YER098W",127).
component("YDR069C",96).
component("YDL122W",87).
component("YBR058C",62).
component("YBL067C",57).
component("YFR025C",136).
component("U9_",51).
component("YJL155C",180).
component("U32_",39).
component("U30_",38).
component("YHR044C",163).
component("YHR043C",162).
component("YLR160C",212).
component("YLR158C",211).
component("YLR157C",210).
component("YLR155C",209).
component("YDR321W",106).
component("YGL037C",141).
component("U43_",41).
component("U42_",40).
component("YLR308W",217).
component("YLR307W",216).
component("U53_",45).
component("YHR144C",166).
component("YHR144C",167).
component("YBR153W",68).
component("YDL238C",92).
component("YNL141W",239).
component("U44_",42).
component("YHR201C",170).
component("YBR111C",66).
component("YER005W",120).
component("YLR231C",214).
component("YDR538W",117).
component("YLR134W",208).
component("YLR044C",205).
component("YGR087C",149).
component("YDR380W",108).
component("YDL080C",82).
component("YMR250W",232).
component("YKL184W",197).
component("YEL021W",118).
component("YKL211C",198).
component("YNR033W",250).
component("YKL211C",199).
component("YER090W",126).
component("YDR127W",101).
component("YPL281C",276).
component("YOR393W",266).
component("YMR323W",234).
component("YHR174W",168).
component("YGR254W",155).
component("YGL026C",140).
component("YNL316C",246).
component("YCR053W",80).
component("YDR127W",102).
component("YGL148W",144).
component("YFR055W",138).
component("YDR007W",93).
component("YOR095C",258).
component("YBR196C",70).
component("U14_",25).
component("YMR105C",226).
component("YKL127W",193).
component("YPR060C",278).
component("YHR072W",164).
component("YJL153C",179).
component("YGR264C",157).
component("YGR171C",152).
component("YGL245W",147).
component("YPR047W",277).
component("YLR060W",207).
component("YFL022C",132).
component("YHR019C",160).
component("YPL040C",268).
component("YBL076C",59).
component("YER183C",131).
component("YDL141W",88).
component("YDL141W",89).
component("YPR145W",282).
component("YGR124W",151).
component("YPL231W",273).
component("YNR016C",248).
component("YKL182W",196).
component("YGR037C",148).
component("YJL087C",175).
component("YOL010W",251).
component("YPR138C",281).
component("YPL265W",274).
component("YOR348C",264).
component("YOL103W",256).
component("YOL020W",253).
component("YNL142W",240).
component("YMR202W",228).
component("YMR056C",225).
component("YKR053C",201).
component("YKR039W",200).
component("YJR077C",185).
component("YJL134W",178).
component("YGR121C",150).
component("YGL186C",145).
component("YFL055W",133).
component("YER060W-A",124).
component("YER060W",123).
component("YER056C",122).
component("YDR536W",116).
component("YDR508C",115).
component("YDR497C",114).
component("YDR046C",95).
component("YDL210W",90).
component("YCL025C",74).
component("YBR085W",65).
component("YBR069C",64).
component("YBR068C",63).
component("YBL042C",56).
component("YBL030C",54).
component("U6_",48).
component("U5_",47).
component("U228_",36).
component("U222_",35).
