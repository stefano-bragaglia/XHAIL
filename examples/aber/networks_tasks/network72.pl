...
component("YLR056W",384).
component("YKR009C",374).
component("YMR083W",427).
component("YPL231W",520).
component("YJR159W",357).
component("YGL001C",250).
component("YML056C",414).
component("YLR432W",410).
component("YHR216W",312).
component("YAR075W",100).
component("YAR073W",99).
component("YDR127W",188).
component("YJR139C",354).
component("YOR136W",488).
component("YNL009W",442).
component("YLR174W",396).
component("YHR183W",308).
component("YGR256W",287).
component("YOL059W",477).
component("YDL022W",150).
component("YCL018W",138).
component("YLR355C",406).
component("YJR078W",350).
component("U58_",82).
component("YGR255C",286).
component("YMR015C",424).
component("YDR402C",204).
component("YGL055W",256).
component("YJL026W",324).
component("YGR180C",279).
component("YER070W",227).
component("U35_",70).
component("YJR009C",342).
component("YJL052W",325).
component("YGR192C",281).
component("YOR374W",505).
component("YER073W",228).
component("U68_",86).
component("U55_",80).
component("YER069W",226).
component("YOR323C",499).
component("U2_",65).
component("YBR166C",128).
component("YNL280C",459).
component("YER014W",219).
component("YKL141W",363).
component("YJR051W",346).
component("YOR375C",506).
component("YDL215C",173).
component("YAL062W",98).
component("U100_",20).
component("YBR035C",113).
component("YMR189W",431).
component("U56_",81).
component("YPL023C",509).
component("YGL125W",259).
component("YOR236W",496).
component("YBR084W",119).
component("YLR142W",390).
component("U65_",85).
component("U62_",84).
component("YHR068W",299).
component("YMR145C",430).
component("YML120C",418).
component("YKL192C",369).
component("YDL085W",156).
component("YBR046C",115).
component("YPL091W",512).
component("YNL052W",443).
component("YMR256C",437).
component("YLR395C",408).
component("YLR038C",382).
component("YIL111W",316).
component("YHR051W",298).
component("YGL191W",263).
component("YGL187C",262).
component("YDL067C",154).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",526).
component("YLL062C",379).
component("YDR410C",206).
component("YER091C",232).
component("YJR073C",348).
component("YOL096C",479).
component("YLR172C",395).
component("YMR120C",429).
component("YBL013W",101).
component("YJL130C",332).
component("YJL088W",328).
component("YPR074C",535).
component("YBR117C",123).
component("YCL009C",137).
component("YMR062C",426).
component("YNL071W",444).
component("YIL160C",319).
component("YNR019W",466).
component("YCR048W",147).
component("U48_",75).
component("YFL017C",240).
component("YPL231W",521).
component("YER061C",225).
component("YDL052C",152).
component("U8_",93).
component("YDR148C",194).
component("YOR377W",507).
component("YGR177C",278).
component("YPL231W",522).
component("YLR299W",400).
component("YPR001W",528).
component("YNR001C",462).
component("YCR005C",144).
component("YML126C",420).
component("YDL182W",170).
component("YDL131W",162).
component("YNL117W",447).
component("YIR031C",322).
component("YOR321W",498).
component("YJR143C",355).
component("YGR199W",283).
component("YDL095W",158).
component("YDL093W",157).
component("YAL023C",97).
component("YPL227C",519).
component("YMR261C",438).
component("YML100W",417).
component("YBR126C",125).
component("YNL192W",454).
component("YBR038W",114).
component("YBR023C",111).
component("YLR209C",397).
component("YDR354W",201).
component("YFR047C",247).
component("YJR133W",353).
component("U22_",60).
component("YDR399W",203).
component("YJL167W",339).
component("YPR069C",534).
component("YDR127W",189).
component("YHR068W",300).
component("YLR303W",401).
component("YML082W",416).
component("YJR130C",352).
component("YDR035W",178).
component("YBR249C",132).
component("YBR256C",133).
component("YHR137W",303).
component("YGL202W",264).
component("YLR027C",380).
component("YKL106W",361).
component("YOL140W",482).
component("YLR438W",412).
component("YKL104C",360).
component("YDR111C",186).
component("U51_",78).
component("YJR148W",356).
component("YHR208W",311).
component("YOR184W",492).
component("YGL253W",268).
component("YFR053C",248).
component("YMR013C",423).
component("YCR036W",146).
component("YGR194C",282).
component("YCL040W",141).
component("YJR105W",351).
component("U81_",91).
component("YMR208W",433).
component("YPL203W",518).
component("YOR061W",483).
component("YKL166C",365).
component("YJL164C",338).
component("YIL035C",314).
component("YHR205W",310).
component("YHR102W",302).
component("YGL019W",252).
component("YHR025W",294).
component("YNR012W",464).
component("YPR121W",537).
component("YPL258C",524).
component("YOL055C",475).
component("U1_",50).
component("YFR019W",245).
component("YDR208W",196).
component("YDR127W",190).
component("U21_",57).
component("YDR147W",193).
component("YER052C",221).
component("U19_",49).
component("U18_",45).
component("U17_",42).
component("U76_",89).
component("YMR220W",434).
component("YER170W",238).
component("YDR226W",197).
component("YKL067W",359).
component("YOL055C",476).
component("YDR454C",209).
component("YOL061W",478).
component("YKL181W",366).
component("YHL011C",289).
component("YER099C",234).
component("YBL068W",107).
component("YOR143C",489).
component("YNL256W",456).
component("YDL055C",153).
component("YLR328W",404).
component("YDL103C",160).
component("U94_",95).
component("YJR010W",343).
component("YBR029C",112).
component("YPR190C",542).
component("YPR187W",541).
component("YPR110C",536).
component("YPR010C",529).
component("YOR341W",502).
component("YOR340C",501).
component("YOR224C",495).
component("YOR210W",494).
component("YOR207C",493).
component("YOR151C",490).
component("YOR116C",485).
component("YOL005C",471).
component("YNR003C",463).
component("YNL248C",455).
component("YNL151C",452).
component("YNL113W",446).
component("YKL144C",364).
component("YJR063W",347).
component("YJL148W",335).
component("YJL140W",334).
component("YIL021W",313).
component("YHR143W-A",304).
component("YGL070C",258).
component("YFL036W",242).
component("YDR404C",205).
component("YDR156W",195).
component("YDR045C",180).
component("YDL150W",169).
component("YDL140C",164).
component("YBR154C",127).
component("YPR175W",540).
component("YPL167C",516).
component("YOR330C",500).
component("YOL115W",481).
component("YNL299W",460).
component("YNL262W",457).
component("YNL102W",445).
component("YJR043C",345).
component("YJR006W",341).
component("YJL090C",329).
...
component("YKL035W",358).
component("YHL012W",290).
component("YNL130C",448).
component("YPL148C",514).
component("YOR251C",497).
component("YDR058C",182).
component("YOL011W",473).
component("YMR008C",422).
component("YMR006C",421).
component("U105_",22).
component("U101_",21).
component("YJL068C",326).
component("YPL072W",511).
component("YOR124C",486).
component("YNL186W",453).
component("YMR304W",440).
component("YMR223W",435).
component("YKR098C",378).
component("YJL197W",340).
component("YIL156W",318).
component("YFR010W",244).
component("YER151C",237).
component("YER144C",236).
component("YER098W",233).
component("YDR069C",183).
component("YDL122W",161).
component("YBR058C",116).
component("YBL067C",106).
component("YJR019C",344).
component("YDR074W",184).
component("YFR025C",246).
component("YPL179W",517).
component("YNR032W",467).
component("YML057W",415).
component("YML016C",413).
component("YLR433C",411).
component("YGR123C",273).
component("YER133W",235).
component("YER089C",230).
component("YDR436W",208).
component("YDR075W",185).
component("YDL188C",171).
component("YDL134C",163).
component("YDL047W",151).
component("YDL006W",149).
component("YBR125C",124).
component("YBL056W",105).
component("YHR046C",297).
component("U9_",96).
component("YGR208W",284).
...
component("U26_",62).
component("U24_",61).
component("YHR044C",296).
component("YHR043C",295).
component("YOR360C",504).
component("YGL248W",267).
component("YGL027C",254).
component("YLR286C",399).
component("YBR184W",129).
component("YPR026W",530).
component("YDR001C",175).
component("YBR001C",109).
component("YER043C",220).
component("YLR160C",394).
component("YLR158C",393).
component("YLR157C",392).
component("YLR155C",391).
component("YDR321W",200).
component("YGL037C",255).
component("U43_",73).
component("U42_",72).
component("YLR308W",403).
component("YLR307W",402).
component("U53_",79).
component("YLR420W",409).
component("YIR032C",323).
component("YLR028C",381).
component("YHR144C",305).
component("YHR144C",306).
component("YNL141W",449).
component("YBR153W",126).
component("YDL238C",174).
component("YNL141W",450).
component("YBR084W",120).
component("YJL126W",331).
component("U44_",74).
component("YHR201C",309).
component("YBR111C",122).
component("YCL030C",140).
component("YER005W",218).
component("YLR231C",398).
component("U88_",92).
component("YDR538W",214).
component("YLR134W",388).
component("YLR044C",383).
component("YGR087C",270).
component("YDR380W",202).
component("YDL080C",155).
component("YMR250W",436).
component("YKL184W",368).
component("YEL021W",215).
component("YNR043W",469).
component("YKL211C",371).
component("YKR097W",377).
component("YDR294C",198).
component("YNR033W",468).
component("YKL211C",372).
component("YER090W",231).
component("YDR127W",191).
component("YPL281C",527).
component("YOR393W",508).
component("YMR323W",441).
component("YHR174W",307).
component("YGR254W",285).
component("YGL026C",253).
component("YGR155W",276).
component("YNL316C",461).
component("YCR053W",148).
component("YDR127W",192).
component("YGL148W",260).
component("YIL168W",321).
component("YIL167W",320).
component("YCL064C",142).
component("YCL064C",143).
component("YFR055W",249).
component("YJL121C",330).
component("YBR019C",110).
component("YDR007W",176).
component("YOR095C",484).
component("YBR196C",130).
component("YGL001C",251).
component("YPL117C",513).
component("U14_",33).
component("YMR105C",428).
component("YKL127W",362).
component("YEL058W",217).
component("YPR060C",533).
component("YHR072W",301).
component("YJL153C",336).
component("YGR264C",288).
component("YGR171C",277).
component("YHR011W",291).
component("YDR023W",177).
component("YHR020W",293).
component("YER087W",229).
component("YGL245W",266).
component("YOR168W",491).
component("YPR047W",532).
component("YLR060W",385).
component("YFL022C",241).
component("YPR033C",531).
component("YHR019C",292).
component("YKL194C",370).
component("YIL078W",315).
component("YPL160W",515).
component("YLR382C",407).
component("YPL040C",510).
component("YBL076C",108).
component("YDR037W",179).
component("YGR094W",271).
component("YGL234W",265).
component("YER183C",239).
component("U90_",94).
component("YNR057C",470).
component("YDL141W",165).
component("YDL141W",166).
component("YDL141W",167).
component("YDL141W",168).
component("YPR145W",539).
component("YGR124W",274).
component("YGL062W",257).
component("YBR218C",131).
component("YPL231W",523).
component("YNR016C",465).
component("YKL182W",367).
component("YGR037C",269).
component("YJL087C",327).
component("YOL010W",472).
component("YPR138C",538).
component("YPL265W",525).
component("YOR348C",503).
component("YOR130C",487).
component("YOL103W",480).
component("YOL020W",474).
component("YNL142W",451).
component("YMR272C",439).
component("YMR202W",432).
component("YMR056C",425).
component("YML123C",419).
component("YLR348C",405).
component("YLR138W",389).
component("YLR100C",387).
component("YLR092W",386).
component("YKR053C",376).
component("YKR039W",375).
component("YKL217W",373).
component("YJR077C",349).
component("YJL134W",333).
component("YGR191W",280).
component("YGR125W",275).
component("YGR121C",272).
component("YGL186C",261).
component("YFL055W",243).
...
component("YDR497C",210).
component("YDR294C",199).
component("YDR046C",181).
component("YDL210W",172).
