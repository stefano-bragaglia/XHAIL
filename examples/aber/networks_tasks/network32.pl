...
component("YNL280C",249).
component("YLR056W",210).
component("YGL001C",141).
component("YDR127W",99).
component("YNL009W",241).
component("YLR174W",217).
component("YHR183W",171).
component("YGR256W",158).
component("YCL018W",74).
component("YJR078W",189).
component("YMR015C",228).
component("YDR402C",111).
component("YGL055W",144).
component("YJL026W",176).
component("YGR180C",155).
component("YER069W",127).
component("YOR323C",268).
component("YBR166C",69).
component("YNL280C",250).
component("YKL141W",197).
component("YOR375C",271).
component("YDL215C",92).
component("YAL062W",53).
component("U100_",18).
component("U56_",46).
component("YPL023C",273).
component("YGL125W",145).
component("YMR145C",232).
component("YDL085W",84).
component("YBR046C",61).
component("YPL273W",281).
component("YLL062C",206).
component("YDR410C",112).
component("YJR073C",187).
component("YOL096C",261).
component("YMR120C",231).
component("YJL130C",180).
component("YJL088W",178).
component("YPR074C",286).
component("YBR117C",67).
component("YCL009C",73).
component("YNL071W",242).
component("YNR019W",255).
component("YCR048W",80).
component("U48_",43).
component("YPL231W",277).
component("YDL052C",82).
component("U8_",50).
component("YPL231W",278).
component("YLR299W",219).
component("YCR005C",77).
component("YNL117W",244).
component("YIR031C",175).
component("YOR321W",267).
component("YJR143C",192).
component("YGR199W",156).
component("YDL095W",86).
component("YDL093W",85).
component("YAL023C",52).
component("YDR354W",108).
component("YFR047C",139).
component("U22_",37).
component("YDR399W",110).
component("YPR069C",285).
component("YDR127W",100).
component("YML082W",224).
component("YJR130C",191).
component("YDR035W",95).
component("YBR249C",71).
component("YHR137W",167).
component("YGL202W",148).
component("YLR027C",207).
component("YKL106W",195).
component("YLR438W",223).
component("U51_",44).
component("YJR148W",193).
component("YMR013C",227).
component("YCR036W",79).
component("YCL040W",76).
component("YJR105W",190).
component("YMR208W",234).
component("YHR025W",163).
component("YNR012W",253).
component("YFR019W",137).
component("YDR208W",105).
component("YDR127W",101).
component("YDR147W",104).
component("YER052C",123).
component("U19_",32).
component("U76_",49).
component("YMR220W",235).
component("YDR226W",106).
component("YDR454C",114).
component("YOL061W",260).
component("YKL181W",198).
component("YHL011C",160).
component("YER099C",130).
component("YBL068W",58).
component("YOR143C",266).
component("YLR328W",222).
component("YBR029C",60).
component("YPR175W",289).
component("YPL167C",276).
component("YOR330C",269).
component("YOL115W",263).
component("YNL299W",251).
component("YNL262W",248).
component("YNL102W",243).
component("YJR043C",186).
component("YJR006W",185).
component("YJL090C",179).
component("YIL139C",173).
component("YEL055C",121).
component("YDR419W",113).
component("YDR121W",98).
component("YDL102W",87).
component("YCR014C",78).
component("YBR278W",72).
component("YBL035C",55).
component("YKL035W",194).
component("YHL012W",161).
component("YOL011W",258).
component("YMR008C",226).
component("YMR006C",225).
component("U105_",19).
component("YPL072W",275).
component("YOR124C",265).
component("YNL186W",247).
component("YMR304W",239).
component("YMR223W",236).
component("YKR098C",205).
component("YJL197W",184).
component("YIL156W",174).
component("YFR010W",136).
component("YER151C",132).
component("YER144C",131).
component("YER098W",129).
component("YDR069C",97).
component("YDL122W",88).
component("YBR058C",62).
component("YBL067C",57).
component("YFR025C",138).
component("U9_",51).
component("YJL155C",183).
component("U32_",39).
component("U30_",38).
component("YHR044C",165).
component("YHR043C",164).
component("YLR160C",216).
component("YLR158C",215).
component("YLR157C",214).
component("YLR155C",213).
component("YDR321W",107).
component("YGL037C",143).
component("U43_",41).
component("U42_",40).
component("YLR308W",221).
component("YLR307W",220).
component("U53_",45).
component("YLR028C",208).
component("YHR144C",168).
component("YHR144C",169).
component("YBR153W",68).
component("YDL238C",93).
component("YNL141W",245).
component("U44_",42).
component("YHR201C",172).
component("YBR111C",66).
component("YER005W",122).
component("YLR231C",218).
component("YDR538W",119).
component("YLR134W",212).
component("YLR044C",209).
component("YGR087C",151).
component("YDR380W",109).
component("YDL080C",83).
component("YMR250W",237).
component("YKL184W",200).
component("YEL021W",120).
component("YKL211C",201).
component("YNR033W",256).
component("YKL211C",202).
component("YER090W",128).
component("YDR127W",102).
component("YPL281C",282).
component("YOR393W",272).
component("YMR323W",240).
component("YHR174W",170).
component("YGR254W",157).
component("YGL026C",142).
component("YNL316C",252).
component("YCR053W",81).
component("YDR127W",103).
component("YGL148W",146).
component("YFR055W",140).
component("YDR007W",94).
component("YOR095C",264).
component("YBR196C",70).
component("U14_",25).
component("YMR105C",230).
component("YKL127W",196).
component("YPR060C",284).
component("YHR072W",166).
component("YJL153C",182).
component("YGR264C",159).
component("YGR171C",154).
component("YGL245W",149).
component("YPR047W",283).
component("YLR060W",211).
component("YFL022C",134).
component("YHR019C",162).
component("YPL040C",274).
component("YBL076C",59).
component("YER183C",133).
component("YDL141W",89).
component("YDL141W",90).
component("YPR145W",288).
component("YGR124W",153).
component("YPL231W",279).
component("YNR016C",254).
component("YKL182W",199).
component("YGR037C",150).
component("YJL087C",177).
component("YOL010W",257).
component("YPR138C",287).
component("YPL265W",280).
component("YOR348C",270).
component("YOL103W",262).
component("YOL020W",259).
component("YNL142W",246).
component("YMR272C",238).
component("YMR202W",233).
component("YMR056C",229).
component("YKR053C",204).
component("YKR039W",203).
component("YJR077C",188).
component("YJL134W",181).
component("YGR121C",152).
component("YGL186C",147).
component("YFL055W",135).
component("YER060W-A",126).
component("YER060W",125).
component("YER056C",124).
component("YDR536W",118).
component("YDR508C",117).
component("YDR503C",116).
component("YDR497C",115).
component("YDR046C",96).
component("YDL210W",91).
