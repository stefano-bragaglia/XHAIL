...
component("YLR056W",387).
component("YKR009C",377).
component("YMR083W",431).
component("YPL231W",524).
component("YJR159W",360).
component("YGL001C",253).
component("YML056C",418).
component("YLR432W",414).
component("YHR216W",315).
component("YAR075W",101).
component("YAR073W",100).
component("YCL030C",141).
component("YDR127W",191).
component("YJR139C",357).
component("YOR136W",492).
component("YNL009W",446).
component("YLR174W",399).
component("YHR183W",311).
component("YGR256W",290).
component("YOL059W",481).
component("YDL022W",153).
component("YCL018W",139).
component("YLR355C",409).
component("YJR078W",353).
component("U58_",82).
component("YGR255C",289).
component("YMR015C",428).
component("YDR402C",207).
component("YGL055W",259).
component("YJL026W",327).
component("YGR180C",282).
component("YER070W",230).
component("U35_",70).
component("YJR009C",345).
component("YJL052W",328).
component("YGR192C",284).
component("YOR374W",509).
component("YER073W",231).
component("U68_",86).
component("U55_",80).
component("YER069W",229).
component("YOR323C",503).
component("U2_",65).
component("YBR166C",129).
component("YNL280C",463).
component("YER014W",222).
component("YKL141W",366).
component("YJR051W",349).
component("YOR375C",510).
component("YDL215C",176).
component("YAL062W",99).
component("U100_",20).
component("YBR035C",114).
component("YMR189W",435).
component("U56_",81).
component("YPL023C",513).
component("YGL125W",262).
component("YOR236W",500).
component("YBR084W",120).
component("YLR142W",393).
component("U65_",85).
component("U62_",84).
component("YHR068W",302).
component("YMR145C",434).
component("YML120C",422).
component("YKL192C",372).
component("YDL085W",159).
component("YBR046C",116).
component("YPL091W",516).
component("YNL052W",447).
component("YMR256C",441).
component("YLR395C",412).
component("YLR038C",385).
component("YIL111W",319).
component("YHR051W",301).
component("YGL191W",266).
component("YGL187C",265).
component("YDL067C",157).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",530).
component("YLL062C",382).
component("YDR410C",209).
component("YER091C",235).
component("YJR073C",351).
component("YOL096C",483).
component("YLR172C",398).
component("YMR120C",433).
component("YBL013W",102).
component("YJL130C",335).
component("YJL088W",331).
component("YPR074C",539).
component("YBR117C",124).
component("YCL009C",138).
component("YMR062C",430).
component("YNL071W",448).
component("YIL160C",322).
component("YNR019W",470).
component("YCR048W",150).
component("U48_",75).
component("YFL017C",243).
component("YPL231W",525).
component("YER061C",228).
component("YDL052C",155).
component("U8_",94).
component("YDR148C",197).
component("YOR377W",511).
component("YGR177C",281).
component("YPL231W",526).
component("YLR299W",403).
component("YPR001W",532).
component("YNR001C",466).
component("YCR005C",146).
component("YML126C",424).
component("YDL182W",173).
component("YDL131W",165).
component("YNL117W",451).
component("YIR031C",325).
component("YOR321W",502).
component("YJR143C",358).
component("YGR199W",286).
component("YDL095W",161).
component("YDL093W",160).
component("YAL023C",98).
component("YPL227C",523).
component("YMR261C",442).
component("YML100W",421).
component("YBR126C",126).
component("YNL192W",458).
component("YBR038W",115).
component("YBR023C",112).
component("YLR209C",400).
component("YDR354W",204).
component("YFR047C",250).
component("YJR133W",356).
component("U22_",60).
component("YDR399W",206).
component("YJL167W",342).
component("YPR069C",538).
component("YDR127W",192).
component("YHR068W",303).
component("YLR303W",404).
component("YML082W",420).
component("YJR130C",355).
component("YDR035W",181).
component("YBR249C",133).
component("YBR256C",134).
component("YHR137W",306).
component("YGL202W",267).
component("YLR027C",383).
component("YKL106W",364).
component("YOL140W",486).
component("YLR438W",416).
component("YKL104C",363).
component("YDR111C",189).
component("U51_",78).
component("YJR148W",359).
component("YHR208W",314).
component("YOR184W",496).
component("YGL253W",271).
component("YFR053C",251).
component("YMR013C",427).
component("YCR036W",149).
component("YGR194C",285).
component("YCL040W",143).
component("YJR105W",354).
component("U81_",92).
component("YMR208W",437).
component("YPL203W",522).
component("YOR061W",487).
component("YKL166C",368).
component("YJL164C",341).
component("YIL035C",317).
component("YHR205W",313).
component("YHR102W",305).
component("YGL019W",255).
component("YHR025W",297).
component("YNR012W",468).
component("YPR121W",541).
component("YPL258C",528).
component("YOL055C",479).
component("U1_",50).
component("YFR019W",248).
component("YDR208W",199).
component("YDR127W",193).
component("U21_",57).
component("YDR147W",196).
component("YCR012W",147).
component("YER052C",224).
component("U19_",49).
component("U18_",45).
component("U17_",42).
component("U76_",89).
component("YMR220W",438).
component("YER170W",241).
component("YDR226W",200).
component("YKL067W",362).
...
component("YBL068W",108).
component("YOR143C",493).
component("YNL256W",460).
component("YDL055C",156).
component("YLR328W",407).
component("YDL103C",163).
component("U94_",96).
component("YJR010W",346).
component("YBR029C",113).
component("YPR190C",546).
component("YPR187W",545).
component("YPR110C",540).
component("YPR010C",533).
component("YOR341W",506).
component("YOR340C",505).
component("YOR224C",499).
component("YOR210W",498).
component("YOR207C",497).
component("YOR151C",494).
component("YOR116C",489).
component("YOL005C",475).
component("YNR003C",467).
component("YNL248C",459).
component("YNL151C",456).
component("YNL113W",450).
component("YKL144C",367).
component("YJR063W",350).
component("YJL148W",338).
component("YJL140W",337).
component("YIL021W",316).
component("YHR143W-A",307).
component("YGL070C",261).
component("YFL036W",245).
component("YDR404C",208).
component("YDR156W",198).
component("YDR045C",183).
component("YDL150W",172).
component("YDL140C",167).
component("YBR154C",128).
component("YPR175W",544).
component("YPL167C",520).
component("YOR330C",504).
component("YOL115W",485).
component("YNL299W",464).
component("YNL262W",461).
component("YNL102W",449).
component("YJR043C",348).
component("YJR006W",344).
component("YJL090C",332).
component("YIL139C",320).
component("YEL055C",219).
component("YDR419W",210).
component("YDR121W",190).
component("YDL102W",162).
component("YCR014C",148).
component("YBR278W",135).
component("YBL035C",104).
component("YKL035W",361).
component("YHL012W",293).
component("YNL130C",452).
component("YPL148C",518).
component("YOR251C",501).
component("YDR058C",185).
component("YOL011W",477).
component("YMR008C",426).
component("YMR006C",425).
component("U105_",22).
component("U101_",21).
component("YJL068C",329).
component("YPL072W",515).
component("YOR124C",490).
component("YNL186W",457).
component("YMR304W",444).
component("YMR223W",439).
component("YKR098C",381).
component("YJL197W",343).
component("YIL156W",321).
component("YFR010W",247).
component("YER151C",240).
component("YER144C",239).
component("YER098W",236).
component("YDR069C",186).
component("YDL122W",164).
component("YBR058C",117).
component("YBL067C",107).
component("YJR019C",347).
component("YDR074W",187).
component("YFR025C",249).
component("YPL179W",521).
component("YNR032W",471).
component("YML057W",419).
component("YML016C",417).
component("YLR433C",415).
component("YGR123C",276).
component("YER133W",238).
component("YER089C",233).
component("YDR436W",211).
component("YDR075W",188).
component("YDL188C",174).
component("YDL134C",166).
component("YDL047W",154).
component("YDL006W",152).
component("YBR125C",125).
component("YBL056W",106).
component("YHR046C",300).
component("U9_",97).
component("YGR208W",287).
...
component("U26_",62).
component("U24_",61).
component("YHR044C",299).
component("YHR043C",298).
component("YOR360C",508).
component("YGL248W",270).
component("YGL027C",257).
component("YLR286C",402).
component("YBR184W",130).
component("YPR026W",534).
component("YDR001C",178).
component("YBR001C",110).
component("YER043C",223).
component("YLR160C",397).
component("YLR158C",396).
component("YLR157C",395).
component("YLR155C",394).
component("YDR321W",203).
component("YGL037C",258).
component("U43_",73).
component("U42_",72).
component("YLR308W",406).
component("YLR307W",405).
component("U53_",79).
component("YLR420W",413).
component("YIR032C",326).
component("YLR028C",384).
component("YHR144C",308).
component("YHR144C",309).
component("YNL141W",453).
component("YBR153W",127).
component("YDL238C",177).
component("YNL141W",454).
component("YBR084W",121).
component("YJL126W",334).
component("U44_",74).
component("YHR201C",312).
component("YBR111C",123).
component("YCL030C",142).
component("YER005W",221).
component("YLR231C",401).
component("U88_",93).
component("YDR538W",217).
component("YLR134W",391).
component("YLR044C",386).
component("YGR087C",273).
component("YDR380W",205).
component("YDL080C",158).
component("YMR250W",440).
component("YKL184W",371).
component("YEL021W",218).
component("YNR043W",473).
component("YKL211C",374).
component("YKR097W",380).
component("YDR294C",201).
component("YNR033W",472).
component("YKL211C",375).
component("YER090W",234).
component("YDR127W",194).
component("YPL281C",531).
component("YOR393W",512).
component("YMR323W",445).
component("YHR174W",310).
component("YGR254W",288).
component("YGL026C",256).
component("YGR155W",279).
component("YNL316C",465).
component("YCR053W",151).
component("YDR127W",195).
component("YGL148W",263).
component("YIL168W",324).
component("YIL167W",323).
component("YCL064C",144).
component("YCL064C",145).
component("YLR359W",410).
component("YFR055W",252).
component("YJL121C",333).
component("YBR019C",111).
component("YDR007W",179).
component("YOR095C",488).
component("YBR196C",131).
component("YGL001C",254).
component("YPL117C",517).
component("U14_",33).
component("YMR105C",432).
component("YKL127W",365).
component("YEL058W",220).
component("YPR060C",537).
component("YHR072W",304).
component("YJL153C",339).
component("YGR264C",291).
component("YGR171C",280).
component("YHR011W",294).
component("YDR023W",180).
component("YHR020W",296).
component("YER087W",232).
component("YGL245W",269).
component("YOR168W",495).
component("YPR047W",536).
component("YLR060W",388).
component("YFL022C",244).
component("YPR033C",535).
component("YHR019C",295).
component("YKL194C",373).
component("YIL078W",318).
component("YPL160W",519).
component("YLR382C",411).
component("YPL040C",514).
component("YBL076C",109).
component("YDR037W",182).
component("YGR094W",274).
component("YGL234W",268).
component("YER183C",242).
component("U90_",95).
component("YNR057C",474).
component("YDL141W",168).
component("YDL141W",169).
component("YDL141W",170).
component("YDL141W",171).
component("YPR145W",543).
component("YGR124W",277).
component("YGL062W",260).
component("YBR218C",132).
component("YPL231W",527).
component("YNR016C",469).
component("YKL182W",370).
component("YGR037C",272).
component("YJL087C",330).
component("YOL010W",476).
component("YPR138C",542).
component("YPL265W",529).
component("YOR348C",507).
component("YOR130C",491).
component("YOL103W",484).
component("YOL020W",478).
component("YNL142W",455).
component("YMR272C",443).
component("YMR202W",436).
component("YMR056C",429).
component("YML123C",423).
component("YLR348C",408).
component("YLR138W",392).
component("YLR100C",390).
component("YLR092W",389).
component("YKR053C",379).
component("YKR039W",378).
component("YKL217W",376).
component("YJR077C",352).
component("YJL134W",336).
component("YGR191W",283).
component("YGR125W",278).
component("YGR121C",275).
component("YGL186C",264).
component("YFL055W",246).
component("YER060W-A",227).
component("YER060W",226).
component("YER056C",225).
component("YDR536W",216).
component("YDR508C",215).
component("YDR503C",214).
component("YDR497C",213).
component("YDR294C",202).
component("YDR046C",184).
component("YDL210W",175).
component("YCL025C",140).
component("YBR294W",137).
component("YBR291C",136).
component("YBR085W",122).
component("YBR069C",119).
component("YBR068C",118).
component("YBL042C",105).
component("YBL030C",103).
component("U7_",91).
component("U79_",90).
component("U6_",88).
component("U69_",87).
