...
component("YLR056W",284).
component("YMR083W",314).
component("YPL231W",385).
component("YJR159W",262).
component("YGL001C",187).
component("YDR127W",138).
component("YJR139C",259).
component("YNL009W",329).
component("YLR174W",292).
component("YHR183W",226).
component("YGR256W",209).
component("YCL018W",102).
component("YJR078W",255).
component("YMR015C",311).
component("YDR402C",152).
component("YGL055W",191).
component("YJL026W",235).
component("YGR180C",206).
component("U68_",65).
component("U55_",61).
component("YER069W",170).
component("YOR323C",371).
component("YBR166C",95).
component("YNL280C",342).
component("YKL141W",267).
component("YOR375C",376).
component("YDL215C",128).
component("YAL062W",76).
component("U100_",20).
component("YBR035C",84).
component("YMR189W",318).
component("U56_",62).
component("YPL023C",378).
component("YGL125W",193).
component("YOR236W",369).
component("YLR142W",287).
component("U65_",64).
component("YMR145C",317).
component("YDL085W",114).
component("YBR046C",85).
component("YPL091W",381).
component("YNL052W",330).
component("YMR256C",324).
component("YLR395C",302).
component("YLR038C",282).
component("YIL111W",231).
component("YHR051W",218).
component("YGL191W",197).
component("YGL187C",196).
component("YDL067C",112).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",390).
component("YLL062C",279).
component("YDR410C",154).
component("YER091C",172).
component("YJR073C",253).
component("YOL096C",356).
component("YMR120C",316).
component("YJL130C",241).
component("YJL088W",237).
component("YPR074C",396).
component("YBR117C",91).
component("YCL009C",101).
component("YMR062C",313).
component("YNL071W",331).
component("YNR019W",348).
component("YCR048W",109).
component("U48_",58).
component("YFL017C",178).
component("YPL231W",386).
component("YDL052C",111).
component("U8_",71).
component("YPL231W",387).
component("YLR299W",296).
component("YCR005C",106).
component("YML126C",307).
component("YDL182W",126).
component("YDL131W",119).
component("YNL117W",334).
component("YIR031C",234).
component("YOR321W",370).
component("YJR143C",260).
component("YGR199W",207).
component("YDL095W",116).
component("YDL093W",115).
component("YAL023C",75).
component("YMR261C",325).
component("YML100W",305).
component("YBR126C",92).
component("YLR209C",293).
component("YDR354W",149).
component("YFR047C",185).
component("YJR133W",258).
component("U22_",49).
component("YDR399W",151).
component("YPR069C",395).
component("YDR127W",139).
component("YML082W",304).
component("YJR130C",257).
component("YDR035W",132).
component("YBR249C",97).
component("YBR256C",98).
component("YHR137W",221).
component("YGL202W",198).
component("YLR027C",280).
component("YKL106W",265).
component("YOL140W",359).
component("YLR438W",303).
component("YDR111C",136).
component("U51_",59).
component("YJR148W",261).
component("YMR013C",310).
component("YCR036W",108).
component("YCL040W",105).
component("YJR105W",256).
component("U81_",70).
component("YMR208W",320).
component("YPL203W",384).
component("YOR061W",360).
component("YKL166C",269).
component("YJL164C",247).
component("YIL035C",230).
component("YHR205W",228).
component("YHR102W",220).
component("YGL019W",188).
component("YHR025W",215).
component("YNR012W",346).
component("YFR019W",183).
component("YDR208W",145).
component("YDR127W",140).
component("U21_",46).
component("YDR147W",143).
component("YER052C",166).
component("U19_",42).
component("U18_",38).
component("U76_",68).
component("YMR220W",321).
component("YDR226W",146).
component("YKL067W",264).
component("YDR454C",156).
component("YOL061W",355).
component("YKL181W",270).
component("YHL011C",211).
component("YER099C",174).
component("YBL068W",81).
component("YOR143C",364).
component("YLR328W",299).
component("U94_",73).
component("YBR029C",83).
component("YPR190C",402).
component("YPR187W",401).
component("YPR110C",397).
component("YPR010C",392).
component("YOR341W",374).
component("YOR340C",373).
component("YOR224C",368).
component("YOR210W",367).
component("YOR207C",366).
component("YOR151C",365).
component("YOR116C",362).
component("YOL005C",351).
component("YNR003C",345).
component("YNL248C",339).
component("YNL151C",337).
component("YNL113W",333).
component("YKL144C",268).
component("YJR063W",252).
component("YJL148W",244).
component("YJL140W",243).
component("YIL021W",229).
component("YHR143W-A",222).
component("YGL070C",192).
component("YFL036W",180).
...
component("YPR175W",400).
component("YPL167C",383).
component("YOR330C",372).
component("YOL115W",358).
component("YNL299W",343).
component("YNL262W",340).
component("YNL102W",332).
component("YJR043C",251).
component("YJR006W",249).
component("YJL090C",238).
component("YIL139C",232).
component("YEL055C",163).
component("YDR419W",155).
component("YDR121W",137).
component("YDL102W",117).
component("YCR014C",107).
component("YBR278W",99).
component("YBL035C",78).
component("YKL035W",263).
component("YHL012W",212).
component("YOL011W",353).
component("YMR008C",309).
component("YMR006C",308).
component("U105_",21).
component("YPL072W",380).
component("YOR124C",363).
component("YNL186W",338).
component("YMR304W",327).
component("YMR223W",322).
component("YKR098C",278).
component("YJL197W",248).
component("YIL156W",233).
component("YFR010W",182).
component("YER151C",176).
component("YER144C",175).
component("YER098W",173).
component("YDR069C",135).
component("YDL122W",118).
component("YBR058C",86).
component("YBL067C",80).
component("YJR019C",250).
component("YFR025C",184).
component("U9_",74).
component("YJL155C",246).
component("U34_",54).
component("U33_",53).
component("U32_",52).
component("U30_",51).
component("U24_",50).
component("YHR044C",217).
component("YHR043C",216).
component("YLR286C",295).
component("YLR160C",291).
component("YLR158C",290).
component("YLR157C",289).
component("YLR155C",288).
component("YDR321W",148).
component("YGL037C",190).
component("U43_",56).
component("U42_",55).
component("YLR308W",298).
component("YLR307W",297).
component("U53_",60).
component("YLR028C",281).
component("YHR144C",223).
component("YHR144C",224).
component("YBR153W",93).
component("YDL238C",129).
component("YNL141W",335).
component("YJL126W",240).
component("U44_",57).
component("YHR201C",227).
component("YBR111C",90).
component("YCL030C",104).
component("YER005W",165).
component("YLR231C",294).
component("YDR538W",161).
component("YLR134W",286).
component("YLR044C",283).
component("YGR087C",201).
component("YDR380W",150).
component("YDL080C",113).
component("YMR250W",323).
component("YKL184W",272).
component("YEL021W",162).
component("YKL211C",273).
component("YNR033W",349).
component("YKL211C",274).
component("YER090W",171).
component("YDR127W",141).
component("YPL281C",391).
component("YOR393W",377).
component("YMR323W",328).
component("YHR174W",225).
component("YGR254W",208).
component("YGL026C",189).
component("YGR155W",204).
component("YNL316C",344).
component("YCR053W",110).
component("YDR127W",142).
component("YGL148W",194).
component("YFR055W",186).
component("YJL121C",239).
component("YDR007W",130).
component("YOR095C",361).
component("YBR196C",96).
component("U14_",30).
component("YMR105C",315).
component("YKL127W",266).
component("YEL058W",164).
component("YPR060C",394).
component("YHR072W",219).
component("YJL153C",245).
component("YGR264C",210).
component("YGR171C",205).
component("YHR011W",213).
component("YDR023W",131).
component("YGL245W",199).
component("YPR047W",393).
component("YLR060W",285).
component("YFL022C",179).
component("YHR019C",214).
component("YPL160W",382).
component("YLR382C",301).
component("YPL040C",379).
component("YBL076C",82).
component("YER183C",177).
component("U90_",72).
component("YNR057C",350).
component("YDL141W",121).
component("YDL141W",122).
component("YDL141W",123).
component("YDL141W",124).
component("YPR145W",399).
component("YGR124W",203).
component("YPL231W",388).
component("YNR016C",347).
component("YKL182W",271).
component("YGR037C",200).
component("YJL087C",236).
component("YOL010W",352).
component("YPR138C",398).
component("YPL265W",389).
component("YOR348C",375).
component("YOL103W",357).
component("YOL020W",354).
component("YNL142W",336).
component("YMR272C",326).
component("YMR202W",319).
component("YMR056C",312).
component("YML123C",306).
component("YLR348C",300).
component("YKR053C",277).
component("YKR039W",276).
component("YKL217W",275).
component("YJR077C",254).
component("YJL134W",242).
component("YGR121C",202).
component("YGL186C",195).
component("YFL055W",181).
component("YER060W-A",169).
component("YER060W",168).
component("YER056C",167).
component("YDR536W",160).
component("YDR508C",159).
component("YDR503C",158).
component("YDR497C",157).
component("YDR294C",147).
