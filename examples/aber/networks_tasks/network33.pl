...
component("YNL280C",253).
component("YLR056W",213).
component("YGL001C",143).
component("YDR127W",101).
component("YNL009W",245).
component("YLR174W",220).
component("YHR183W",174).
component("YGR256W",160).
component("YCL018W",75).
component("YJR078W",192).
component("YMR015C",232).
component("YDR402C",113).
component("YGL055W",146).
component("YJL026W",179).
component("YGR180C",157).
component("YER069W",129).
component("YOR323C",272).
component("YBR166C",70).
component("YNL280C",254).
component("YKL141W",200).
component("YOR375C",275).
component("YDL215C",93).
component("YAL062W",54).
component("U100_",18).
component("U56_",47).
component("YPL023C",277).
component("YGL125W",147).
component("YMR145C",236).
component("YDL085W",85).
component("YBR046C",62).
component("YPL273W",285).
component("YLL062C",209).
component("YDR410C",114).
component("YJR073C",190).
component("YOL096C",265).
component("YMR120C",235).
component("YJL130C",183).
component("YJL088W",181).
component("YPR074C",290).
component("YBR117C",68).
component("YCL009C",74).
component("YNL071W",246).
component("YNR019W",259).
component("YCR048W",81).
component("U48_",44).
component("YPL231W",281).
component("YDL052C",83).
component("U8_",51).
component("YPL231W",282).
component("YLR299W",222).
component("YCR005C",78).
component("YNL117W",248).
component("YIR031C",178).
component("YOR321W",271).
component("YJR143C",195).
component("YGR199W",158).
component("YDL095W",87).
component("YDL093W",86).
component("YAL023C",53).
component("YDR354W",110).
component("YFR047C",141).
component("U22_",37).
component("YDR399W",112).
component("YPR069C",289).
component("YDR127W",102).
component("YML082W",228).
component("YJR130C",194).
component("YDR035W",97).
component("YBR249C",72).
component("YHR137W",170).
component("YGL202W",150).
component("YLR027C",210).
component("YKL106W",198).
component("YLR438W",227).
component("U51_",45).
component("YJR148W",196).
component("YMR013C",231).
component("YCR036W",80).
component("YCL040W",77).
component("YJR105W",193).
component("YMR208W",238).
component("YHR025W",166).
component("YNR012W",257).
component("YFR019W",139).
component("YDR208W",107).
component("YDR127W",103).
component("YDR147W",106).
component("YER052C",125).
component("U19_",32).
component("U76_",50).
component("YMR220W",239).
component("YDR226W",108).
component("YDR454C",116).
component("YOL061W",264).
component("YKL181W",201).
component("YHL011C",162).
component("YER099C",132).
component("YBL068W",59).
component("YOR143C",270).
component("YLR328W",225).
component("YBR029C",61).
component("YPR175W",293).
component("YPL167C",280).
component("YOR330C",273).
component("YOL115W",267).
component("YNL299W",255).
component("YNL262W",252).
component("YNL102W",247).
component("YJR043C",189).
component("YJR006W",188).
component("YJL090C",182).
component("YIL139C",176).
component("YEL055C",123).
component("YDR419W",115).
component("YDR121W",100).
component("YDL102W",88).
component("YCR014C",79).
component("YBR278W",73).
component("YBL035C",56).
component("YKL035W",197).
component("YHL012W",163).
component("YOL011W",262).
component("YMR008C",230).
component("YMR006C",229).
component("U105_",19).
component("YPL072W",279).
component("YOR124C",269).
component("YNL186W",251).
component("YMR304W",243).
component("YMR223W",240).
component("YKR098C",208).
component("YJL197W",187).
component("YIL156W",177).
component("YFR010W",138).
component("YER151C",134).
component("YER144C",133).
component("YER098W",131).
component("YDR069C",99).
component("YDL122W",89).
component("YBR058C",63).
component("YBL067C",58).
component("YFR025C",140).
component("U9_",52).
component("YJL155C",186).
component("U32_",40).
component("U30_",39).
component("U24_",38).
component("YHR044C",168).
component("YHR043C",167).
component("YLR160C",219).
component("YLR158C",218).
component("YLR157C",217).
component("YLR155C",216).
component("YDR321W",109).
component("YGL037C",145).
component("U43_",42).
component("U42_",41).
component("YLR308W",224).
component("YLR307W",223).
component("U53_",46).
component("YLR028C",211).
component("YHR144C",171).
component("YHR144C",172).
component("YBR153W",69).
component("YDL238C",94).
component("YNL141W",249).
component("U44_",43).
component("YHR201C",175).
component("YBR111C",67).
component("YER005W",124).
component("YLR231C",221).
component("YDR538W",121).
component("YLR134W",215).
component("YLR044C",212).
component("YGR087C",153).
component("YDR380W",111).
component("YDL080C",84).
component("YMR250W",241).
component("YKL184W",203).
component("YEL021W",122).
component("YKL211C",204).
component("YNR033W",260).
component("YKL211C",205).
component("YER090W",130).
component("YDR127W",104).
component("YPL281C",286).
component("YOR393W",276).
component("YMR323W",244).
component("YHR174W",173).
component("YGR254W",159).
component("YGL026C",144).
component("YNL316C",256).
component("YCR053W",82).
component("YDR127W",105).
component("YGL148W",148).
component("YFR055W",142).
component("YDR007W",95).
component("YOR095C",268).
component("YBR196C",71).
component("U14_",25).
component("YMR105C",234).
component("YKL127W",199).
component("YPR060C",288).
component("YHR072W",169).
component("YJL153C",185).
component("YGR264C",161).
component("YGR171C",156).
component("YHR011W",164).
component("YDR023W",96).
component("YGL245W",151).
component("YPR047W",287).
component("YLR060W",214).
component("YFL022C",136).
component("YHR019C",165).
component("YPL040C",278).
component("YBL076C",60).
component("YER183C",135).
component("YDL141W",90).
component("YDL141W",91).
component("YPR145W",292).
component("YGR124W",155).
component("YPL231W",283).
component("YNR016C",258).
component("YKL182W",202).
component("YGR037C",152).
component("YJL087C",180).
component("YOL010W",261).
component("YPR138C",291).
component("YPL265W",284).
component("YOR348C",274).
component("YOL103W",266).
component("YOL020W",263).
component("YNL142W",250).
component("YMR272C",242).
component("YMR202W",237).
component("YMR056C",233).
component("YLR348C",226).
component("YKR053C",207).
component("YKR039W",206).
component("YJR077C",191).
component("YJL134W",184).
component("YGR121C",154).
component("YGL186C",149).
component("YFL055W",137).
component("YER060W-A",128).
component("YER060W",127).
component("YER056C",126).
component("YDR536W",120).
component("YDR508C",119).
component("YDR503C",118).
component("YDR497C",117).
component("YDR046C",98).
component("YDL210W",92).
component("YCL025C",76).
component("YBR085W",66).
component("YBR069C",65).
component("YBR068C",64).
component("YBL042C",57).
component("YBL030C",55).
component("U6_",49).
component("U5_",48).
component("U228_",36).
component("U222_",35).
