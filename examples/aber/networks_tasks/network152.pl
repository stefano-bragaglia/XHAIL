...
component("YNL280C",783).
component("YLR056W",667).
component("YGR060W",464).
component("YKR009C",646).
component("YMR083W",735).
component("YPL231W",887).
component("U46_",134).
component("YBR149W",228).
component("YBR149W",229).
component("YJR159W",612).
component("YGL001C",431).
component("YHR063C",515).
component("YBR153W",230).
component("YML056C",719).
component("YLR432W",709).
component("YHR216W",535).
component("YAR075W",185).
component("YAR073W",184).
component("YCL030C",252).
component("YDR127W",327).
component("YJR139C",608).
component("YML075C",722).
component("YLR450W",712).
component("YKL085W",620).
component("YOR136W",833).
component("YNL009W",760).
component("YLR174W",682).
component("YDL066W",278).
component("YHR183W",529).
component("YGR256W",492).
component("YNL241C",776).
component("YOL059W",811).
component("YDL022W",271).
component("YCL018W",250).
component("YLR355C",703).
component("YIL074C",541).
component("YER081W",401).
component("YML054C",718).
component("YIL155C",548).
component("YPR191W",923).
component("YOR065W",825).
component("YJL166W",581).
component("YHR001W-A",501).
component("YGR183C",477).
component("YFR033C",427).
component("YEL024W",376).
component("YDR529C",368).
component("YBL045C",190).
component("Q0105",19).
component("YKR066C",651).
component("YKL026C",615).
component("YIR037W",558).
component("YBR244W",239).
component("YJR078W",600).
component("U58_",145).
component("U107_",28).
component("YGR255C",491).
component("U108_",29).
component("YBL098W",195).
component("YMR015C",732).
component("YHR007C",502).
component("YDR402C",355).
component("YGL055W",440).
component("YJR104C",602).
component("YHR008C",503).
component("YJL026W",561).
component("YIL066C",540).
component("YGR180C",476).
component("YER070W",399).
component("U37_",126).
component("U36_",125).
component("U35_",124).
component("YDR158W",335).
component("YJR009C",590).
component("YJL052W",563).
component("YGR192C",479).
component("YBR006W",200).
component("YPL276W",898).
component("YPL275W",897).
component("YOR388C",863).
component("YOR374W",860).
component("YER073W",400).
component("U68_",153).
component("YGL154C",447).
component("YBR115C",223).
component("U55_",142).
component("YER069W",398).
component("YOR323C",853).
component("U2_",119).
component("YER178W",412).
component("YBR221C",237).
component("YIL125W",545).
component("YBR166C",233).
component("YNL280C",784).
...
component("YKR009C",647).
component("YIL160C",550).
component("YGL205W",452).
component("YMR118C",740).
component("YLR164W",680).
component("YLL041C",658).
component("YKL148C",628).
component("YKL141W",626).
component("YJL045W",562).
component("YDR178W",336).
component("YJR051W",595).
component("YEL047C",379).
component("YDL171C",301).
component("YOR375C",861).
component("YDL215C",305).
component("YAL062W",182).
component("U99_",179).
component("U100_",22).
component("YBR035C",210).
component("YMR189W",746).
component("U56_",143).
component("YKR080W",653).
component("YER023W",386).
component("YPL023C",867).
component("YGL125W",444).
component("YOR236W",846).
component("YGR204W",483).
component("YBR084W",217).
component("YLR142W",675).
component("U65_",151).
component("U62_",149).
component("YHR068W",516).
component("YKL150W",629).
component("YIL043C",538).
component("YHR042W",510).
component("YOR221C",844).
component("YMR145C",742).
component("YML120C",725).
component("YKL192C",637).
component("YKL055C",617).
component("YER061C",394).
component("YDL085W",281).
component("YBR046C",213).
component("YMR145C",743).
component("YML120C",726).
component("YKL192C",638).
component("YDL085W",282).
component("YFR030W",426).
component("YPL017C",866).
component("YFL018C",417).
component("YPL091W",871).
component("YDR353W",350).
component("YER042W",387).
component("YPR167C",917).
component("YJR137C",607).
component("YNL052W",763).
component("YMR256C",754).
component("YLR395C",707).
component("YLR038C",665).
component("YIL111W",544).
component("YHR051W",514).
component("YGL191W",450).
component("YGL187C",449).
component("YDL067C",279).
component("Q0275",21).
component("Q0250",20).
component("Q0045",18).
...
component("YLL062C",661).
component("YDR410C",358).
component("YKR069W",652).
component("YOL096C",814).
component("U47_",135).
component("YER091C",405).
component("YJR073C",598).
component("YML008C",713).
component("YDL033C",273).
component("YOL096C",815).
component("YLR172C",681).
component("YBR263W",243).
component("YDR019C",312).
component("YDR408C",357).
component("YMR120C",741).
component("YLR028C",663).
component("YBL013W",186).
component("YJL130C",573).
component("YJL088W",567).
component("YPR074C",910).
component("YBR117C",224).
component("YLR354C",702).
component("YGR043C",462).
component("YMR108W",738).
component("YCL009C",249).
component("YMR062C",734).
component("YNL071W",764).
component("YIL160C",551).
component("YNR019W",793).
component("YCR048W",266).
component("U48_",136).
component("YNL277W",782).
component("YDR232W",339).
component("YFL017C",416).
component("YPL231W",888).
component("YER061C",395).
component("U86_",171).
component("YPL001W",865).
component("YDL052C",276).
component("U8_",174).
component("YDR148C",333).
component("YOR377W",862).
component("YGR177C",475).
component("YPL231W",889).
component("YLR195C",684).
component("YLR299W",694).
component("YGL017W",435).
component("YPR001W",900).
component("YNR001C",789).
component("YCR005C",261).
component("YML126C",728).
component("YDL182W",302).
component("YDL131W",291).
component("YNL117W",768).
component("YIR031C",556).
component("YPR160W",916).
component("YOR321W",852).
component("YJR143C",609).
component("YGR199W",481).
component("YDL095W",286).
component("YDL093W",285).
component("YAL023C",181).
component("YLR258W",691).
component("YFR015C",423).
component("YPL227C",885).
component("YOR103C",829).
component("YOR085W",827).
component("YMR149W",744).
component("YML019W",715).
component("YJL002C",559).
component("YEL002C",373).
component("YDL232W",306).
component("YCL043C",256).
component("YNL029C",761).
component("YIL085C",543).
component("YMR261C",755).
component("YML100W",724).
component("YBR126C",227).
component("YNL192W",775).
component("YBR038W",212).
component("YBR023C",207).
component("YEL011W",374).
component("YPR183W",920).
component("YLR209C",685).
component("U104_",26).
component("U103_",25).
component("YOR209C",842).
component("YMR300C",757).
component("YDR354W",351).
component("YFR047C",428).
component("YJR133W",606).
component("U22_",113).
component("YLR209C",686).
component("YML022W",716).
component("YDR441C",361).
component("YDR399W",353).
component("YPR176C",919).
component("YPL172C",878).
component("YNR041C",797).
component("YMR101C",736).
component("YDL090C",284).
component("YBR003W",199).
component("YBR002C",198).
component("YJL167W",582).
component("YJL167W",583).
component("YNL256W",778).
component("YPR069C",908).
component("YDR127W",328).
component("YHR190W",530).
component("YHR068W",517).
component("YLR303W",695).
component("YGR012W",459).
component("YML082W",723).
component("YJR130C",605).
component("YDR035W",314).
component("YBR249C",240).
component("YLR180W",683).
component("YDR502C",365).
component("YOR274W",849).
component("YOL143C",820).
component("YBR256C",242).
component("YHR137W",523).
component("YGL202W",451).
component("YLR027C",662).
component("YKL106W",622).
component("YOL140W",819).
component("YLR438W",711).
component("YKL104C",621).
component("YGR019W",460).
component("YDR111C",325).
component("U64_",150).
component("U51_",139).
component("YJR148W",610).
component("YHR208W",533).
component("YOR184W",839).
component("YNR058W",800).
component("YGL253W",457).
component("YFR053C",429).
component("YMR013C",731).
component("YMR205C",748).
component("YGR240C",487).
component("YLR240W",689).
component("YKL203C",640).
component("YJR066W",597).
component("YCR036W",265).
component("YGR194C",480).
component("YCL040W",255).
component("YJR105W",603).
component("U16_",74).
component("YPL188W",880).
component("YJR049C",594).
component("YEL041W",377).
component("U96_",178).
component("YKL001C",613).
component("YDR236C",340).
component("YML070W",721).
component("YFL053W",420).
component("YHL032C",499).
component("YLR133W",672).
component("YDR531W",370).
component("U83_",168).
component("U82_",167).
component("U81_",166).
component("YMR208W",749).
component("YPL203W",881).
component("YOR061W",824).
component("YKL166C",631).
component("YJL164C",580).
component("YIL035C",537).
component("YHR205W",532).
component("YHR102W",521).
component("YGL019W",436).
component("YHR025W",509).
component("YNR012W",791).
component("YPR121W",913).
component("YPL258C",891).
component("YOL055C",807).
component("YPL214C",884).
component("U1_",94).
component("YDR009W",311).
component("YBR020W",206).
component("YFR019W",424).
component("YDR208W",337).
component("YDR127W",329).
component("U21_",105).
component("U20_",100).
component("YDR147W",332).
component("YDR300C",347).
component("YCR012W",262).
component("YER052C",389).
component("U19_",93).
component("U18_",86).
component("U17_",80).
component("U76_",162).
component("YMR220W",751).
component("YER170W",411).
component("YDR226W",338).
component("YKL067W",619).
component("YOL055C",808).
component("YDR454C",362).
component("YOL061W",812).
component("YKL181W",632).
component("YHL011C",497).
component("YER099C",407).
component("YBL068W",193).
component("YOR143C",834).
component("YNL256W",779).
component("YLR328W",699).
component("YBR018C",202).
component("YBR018C",203).
component("YDL055C",277).
component("YGR007W",458).
component("YGR202C",482).
component("YLR328W",700).
component("YKR002W",645).
component("YDL045C",274).
component("YDL103C",289).
component("U94_",177).
component("YJR010W",591).
component("YBR029C",208).
component("YCL050C",257).
component("YGL130W",445).
component("YDR530C",369).
component("YCL050C",258).
component("YPR190C",922).
component("YPR187W",921).
component("YPR110C",912).
component("YPR010C",902).
component("YOR341W",857).
component("YOR340C",856).
component("YOR224C",845).
component("YOR210W",843).
component("YOR207C",841).
component("YOR151C",835).
component("YOR116C",830).
component("YOL005C",801).
component("YNR003C",790).
component("YNL248C",777).
component("YNL151C",773).
component("YNL113W",767).
component("YKL144C",627).
component("YJR063W",596).
component("YJL148W",577).
component("YJL140W",576).
component("YIL021W",536).
component("YHR143W-A",524).
component("YGL070C",443).
component("YFL036W",419).
component("YDR404C",356).
component("YDR156W",334).
component("YDR045C",317).
component("YDL150W",299).
component("YDL140C",293).
component("YBR154C",232).
component("YPR175W",918).
component("YPL167C",877).
component("YOR330C",854).
component("YOL115W",818).
component("YNL299W",786).
component("YNL262W",780).
component("YNL102W",766).
component("YJR043C",593).
component("YJR006W",589).
component("YJL090C",568).
component("YIL139C",546).
component("YEL055C",380).
component("YDR419W",359).
component("YDR121W",326).
component("YDL102W",288).
component("YCR014C",263).
component("YBR278W",244).
component("YBL035C",188).
component("YKL035W",616).
component("YHL012W",498).
component("YHR123W",522).
component("YBR243C",238).
component("YNL130C",769).
component("YDL142C",298).
component("YPL148C",875).
component("YOR251C",848).
component("YGR286C",494).
component("YJL068C",564).
component("YDR058C",321).
component("YNR034W",796).
component("YHR163W",527).
component("YGR248W",489).
...
component("YOL064C",813).
component("YPL268W",895).
component("YOR360C",859).
component("YGL248W",456).
component("YKR031C",648).
component("YPL206C",882).
component("YGL027C",438).
component("YLR286C",693).
component("YJR153W",611).
component("YJL221C",588).
component("YJL216C",586).
component("YIL172C",555).
component("YGR292W",496).
component("YGR287C",495).
component("YBR299W",248).
component("YBR184W",234).
component("YIL162W",552).
component("YPR026W",903).
component("YDR001C",309).
component("YBR001C",197).
component("YDR400W",354).
component("U102_",24).
component("YER043C",388).
component("YNL045W",762).
component("YLR160C",679).
component("YLR158C",678).
component("YLR157C",677).
component("YLR155C",676).
component("YDR321W",348).
component("YGL037C",439).
component("U43_",132).
component("U42_",131).
component("YDR242W",341).
component("YLR308W",698).
component("YLR307W",697).
component("U53_",140).
component("YLR420W",708).
component("YPL111W",873).
component("YIR032C",557).
component("YLR028C",664).
component("YHR144C",525).
component("YHR144C",526).
component("YCL030C",253).
component("YNL141W",770).
component("YBR153W",231).
component("YDL238C",308).
component("YNL141W",771).
component("YLR245C",690).
component("YML035C",717).
component("YGR204W",484).
component("YBR084W",218).
component("YJL126W",571).
component("U44_",133).
component("YDL100C",287).
component("U40_",129).
component("U39_",127).
component("YBR011C",201).
component("YHR201C",531).
...
component("U60_",148).
component("YLR231C",687).
component("U88_",172).
component("YDR538W",372).
component("YLR134W",673).
component("YLR044C",666).
component("YGR087C",466).
component("YDR380W",352).
component("YDL080C",280).
component("YMR250W",753).
component("YKL184W",636).
component("YEL021W",375).
component("YNR043W",798).
component("U93_",176).
component("YDR047W",319).
component("U54_",141).
component("YKL211C",641).
component("YKR097W",655).
component("YOL052C",806).
component("YGR170W",473).
component("YKL060C",618).
component("YDR294C",344).
component("YEL046C",378).
component("YNR033W",795).
component("YPR006C",901).
component("YER065C",397).
component("YKL211C",642).
component("YER090W",404).
component("YDR127W",330).
component("YPL281C",899).
component("YOR393W",864).
component("YMR323W",759).
component("YHR174W",528).
component("YGR254W",490).
component("YPL262W",892).
component("YGL026C",437).
component("YGR155W",472).
component("YLR304C",696).
component("YJL200C",585).
component("YGL009C",433).
component("YNL316C",787).
component("YKL182W",634).
component("YPL212C",883).
component("YNL292W",785).
component("YGL063W",442).
component("YFL001W",414).
component("YOR278W",850).
component("YCR053W",267).
component("YDR127W",331).
component("YGL148W",446).
component("YIL168W",554).
component("YIL167W",553).
component("YCL064C",259).
component("YCL064C",260).
component("YHR018C",505).
component("YLR359W",704).
component("YFR055W",430).
component("YJL005W",560).
component("YOR176W",838).
component("YJL121C",570).
component("YBR019C",204).
component("YBR019C",205).
component("U59_",146).
component("YDR050C",320).
component("YDR007W",310).
component("YOR095C",828).
component("YER003C",383).
component("YBR196C",235).
component("YGL001C",432).
component("YPL117C",874).
component("U14_",60).
component("YOL056W",809).
component("YKL152C",630).
component("YDL021W",270).
component("YMR105C",737).
component("YKL127W",624).
component("YEL058W",381).
component("YPR060C",907).
component("YHR072W",518).
component("YJL153C",578).
component("YGR264C",493).
component("YGR171C",474).
component("YHR011W",504).
component("YDR023W",313).
component("YPL104W",872).
component("YLL018C",657).
component("YPR081C",911).
component("YBR121C",225).
component("YHR020W",508).
component("YER087W",402).
component("YOL033W",805).
component("YGL245W",455).
component("YOR168W",836).
component("YHR091C",520).
component("YDR341C",349).
component("YOL097C",816).
component("YDR268W",342).
component("YPR047W",906).
component("YLR060W",668).
component("YFL022C",418).
component("YPR033C",904).
component("YHR019C",506).
component("YHR019C",507).
component("YKL194C",639).
component("YIL078W",542).
component("YPL160W",876).
component("YLR382C",706).
component("YPL040C",868).
component("YBL076C",194).
component("YNL073W",765).
component("YDR037W",315).
component("YOR335C",855).
component("YGR094W",467).
component("YGR244C",488).
component("YPR035W",905).
component("YIL145C",547).
component("U89_",173).
component("YOR241W",847).
component("YMR113W",739).
component("YKL132C",625).
component("YJL101C",569).
component("YAR015W",183).
component("YGL234W",453).
component("YER183C",413).
component("U90_",175).
component("YNR057C",799).
component("YDL141W",294).
component("YDL141W",295).
component("YGL234W",454).
component("YDL141W",296).
component("YGR204W",485).
component("YOL058W",810).
component("YDL141W",297).
component("YHR074W",519).
component("YMR217W",750).
component("YPR145W",915).
component("YGR124W",470).
component("YOR303W",851).
component("YJR109C",604).
component("YJL130C",574).
component("YGL062W",441).
component("YBR218C",236).
component("YPL231W",890).
component("YNR016C",792).
component("YKL182W",635).
component("YGR037C",461).
component("YOR005C",822).
component("YDL164C",300).
component("YJL087C",566).
component("YOL010W",802).
component("YPR138C",914).
component("YPL265W",893).
component("YPL057C",869).
component("YOR348C",858).
component("YOR192C",840).
component("YOR171C",837).
component("YOR130C",832).
component("YOR071C",826).
component("YOR011W",823).
component("YOL156W",821).
component("YOL103W",817).
component("YOL020W",804).
component("YNL318C",788).
component("YNL270C",781).
component("YNL142W",772).
component("YMR272C",756).
component("YMR202W",747).
component("YMR056C",733).
component("YML123C",727).
component("YLR348C",701).
component("YLR260W",692).
component("YLR237W",688).
component("YLR138W",674).
component("YLR100C",671).
component("YLR092W",670).
component("YLR081W",669).
component("YLL061W",660).
component("YLL043W",659).
component("YKR093W",654).
component("YKR053C",650).
component("YKR039W",649).
component("YKL217W",644).
component("YKL120W",623).
component("YKL004W",614).
component("YJR095W",601).
component("YJR077C",599).
component("YJL219W",587).
component("YJL134W",575).
component("YJL129C",572).
component("YHL036W",500).
component("YGR191W",478).
component("YGR125W",471).
component("YGR121C",468).
component("YGR065C",465).
component("YGR055W",463).
component("YGL186C",448).
component("YFL055W",421).
component("YFL011W",415).
component("YER060W-A",393).
component("YER060W",392).
component("YER056C",391).
component("YER053C",390).
component("YEL063C",382).
component("YDR536W",371).
component("YDR508C",367).
component("YDR503C",366).
component("YDR497C",364).
component("YDR297W",346).
component("YDR294C",345).
component("YDR046C",318).
