...
component("YNL280C",128).
component("YLR056W",111).
component("YGL001C",76).
component("YDR127W",54).
component("YNL009W",124).
component("YLR174W",113).
component("YCL018W",38).
component("YJR078W",99).
component("YOR323C",140).
component("YBR166C",35).
component("YNL280C",129).
component("YKL141W",103).
component("U100_",18).
component("YMR145C",120).
component("YDL085W",45).
component("YBR046C",29).
component("YPR074C",151).
component("YBR117C",33).
component("YNR019W",132).
component("YCR048W",42).
component("U48_",23).
component("YPL231W",144).
component("YPL231W",145).
component("YLR299W",115).
component("YOR321W",139).
component("YJR143C",101).
component("YGR199W",83).
component("YDL095W",47).
component("YDL093W",46).
component("YAL023C",25).
component("YDR354W",60).
component("YFR047C",74).
component("U22_",22).
component("YPR069C",150).
component("YDR127W",55).
component("YML082W",118).
component("YDR035W",51).
component("YBR249C",36).
component("YHR137W",89).
component("YGL202W",80).
component("YLR027C",110).
component("YKL106W",102).
component("YLR438W",117).
component("YMR013C",119).
component("YCR036W",41).
component("YJR105W",100).
component("YMR208W",121).
component("YHR025W",86).
component("YDR127W",56).
component("YER052C",68).
component("YDR226W",59).
component("YDR454C",63).
component("YOL061W",136).
component("YKL181W",104).
component("YHL011C",85).
component("YER099C",70).
component("YBL068W",28).
component("YLR328W",116).
component("YPR175W",153).
component("YPL167C",143).
component("YOR330C",141).
component("YOL115W",137).
component("YNL299W",130).
component("YNL262W",127).
component("YNL102W",125).
component("YJR043C",97).
component("YJR006W",96).
component("YJL090C",94).
component("YIL139C",92).
component("YEL055C",66).
component("YDR419W",62).
component("YDR121W",53).
component("YDL102W",48).
component("YCR014C",40).
component("YBR278W",37).
component("YBL035C",26).
component("YHR044C",88).
component("YHR043C",87).
component("YGL037C",78).
component("U53_",24).
component("YHR144C",90).
component("YBR153W",34).
component("YBR111C",32).
component("YER005W",67).
component("YLR231C",114).
component("YDR380W",61).
component("YDL080C",44).
component("YMR250W",122).
component("YKL184W",105).
component("YKL211C",106).
component("YNR033W",133).
component("YKL211C",107).
component("YER090W",69).
component("YDR127W",57).
component("YPL281C",147).
component("YOR393W",142).
component("YMR323W",123).
component("YHR174W",91).
component("YGR254W",84).
component("YGL026C",77).
component("YNL316C",131).
component("YCR053W",43).
component("YDR127W",58).
component("YGL148W",79).
component("YFR055W",75).
component("YDR007W",50).
component("YOR095C",138).
component("YPR060C",149).
component("YGL245W",81).
component("YPR047W",148).
component("YLR060W",112).
component("YFL022C",72).
component("YER183C",71).
component("YDL141W",49).
component("YJL087C",93).
component("YOL010W",134).
component("YPR138C",152).
component("YPL265W",146).
component("YOL020W",135).
component("YNL142W",126).
component("YKR053C",109).
component("YKR039W",108).
component("YJR077C",98).
component("YJL134W",95).
component("YGR121C",82).
component("YFL055W",73).
component("YDR536W",65).
component("YDR508C",64).
component("YDR046C",52).
component("YCL025C",39).
component("YBR069C",31).
component("YBR068C",30).
component("YBL042C",27).
component("U228_",21).
component("U222_",20).
component("U165_",19).
component("I01179",17).
