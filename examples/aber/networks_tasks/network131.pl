...
component("YNL280C",696).
component("YLR056W",590).
...
component("U104_",24).
component("U103_",23).
component("YOR209C",749).
component("YMR300C",671).
component("YDR354W",307).
component("YFR047C",374).
component("YJR133W",535).
component("U22_",101).
...
component("YPR069C",807).
component("YDR127W",287).
component("YHR190W",467).
component("YHR068W",456).
component("YLR303W",616).
component("YGR012W",404).
component("YML082W",640).
component("YJR130C",534).
component("YDR035W",274).
component("YBR249C",210).
component("YLR180W",605).
component("YDR502C",320).
component("YOL143C",731).
component("YBR256C",212).
component("YHR137W",461).
component("YGL202W",396).
component("YLR027C",585).
component("YKL106W",549).
component("YOL140W",730).
component("YLR438W",632).
component("YKL104C",548).
component("YGR019W",405).
component("YDR111C",284).
component("U64_",135).
component("U51_",127).
component("YJR148W",538).
component("YHR208W",470).
component("YOR184W",746).
component("YNR058W",711).
component("YGL253W",402).
component("YFR053C",375).
component("YMR013C",648).
component("YMR205C",662).
component("YGR240C",430).
component("YLR240W",611).
component("YKL203C",566).
component("YJR066W",527).
component("YCR036W",232).
component("YGR194C",423).
component("YCL040W",225).
component("YJR105W",532).
component("U16_",67).
component("YPL188W",782).
component("YJR049C",524).
component("YEL041W",330).
component("YKL001C",541).
component("YDR236C",298).
component("YML070W",639).
component("YFL053W",368).
component("YHL032C",441).
component("YLR133W",595).
component("YDR531W",324).
component("U83_",151).
component("U82_",150).
component("U81_",149).
component("YMR208W",663).
component("YPL203W",783).
component("YOR061W",735).
component("YKL166C",557).
component("YJL164C",511).
component("YIL035C",474).
component("YHR205W",469).
component("YHR102W",459).
component("YGL019W",381).
component("YHR025W",448).
component("YNR012W",704).
component("YPR121W",812).
component("YPL258C",792).
component("YOL055C",718).
component("YPL214C",785).
component("U1_",87).
...
component("YOL055C",719).
component("YDR454C",317).
component("YOL061W",723).
component("YKL181W",558).
component("YHL011C",439).
component("YER099C",356).
component("YBL068W",172).
component("YOR143C",742).
...
component("U94_",160).
component("YJR010W",521).
component("YBR029C",182).
component("YGL130W",390).
component("YDR530C",323).
component("YCL050C",226).
component("YPR190C",819).
component("YPR187W",818).
component("YPR110C",811).
component("YPR010C",801).
component("YOR341W",762).
component("YOR340C",761).
component("YOR224C",752).
component("YOR210W",750).
component("YOR207C",748).
component("YOR151C",743).
component("YOR116C",738).
component("YOL005C",712).
component("YNR003C",703).
component("YNL248C",691).
component("YNL151C",687).
component("YNL113W",681).
component("YKL144C",554).
component("YJR063W",526).
component("YJL148W",508).
component("YJL140W",507).
component("YIL021W",473).
component("YHR143W-A",462).
...
component("YPR175W",817).
component("YPL167C",780).
component("YOR330C",759).
component("YOL115W",729).
component("YNL299W",699).
component("YNL262W",694).
component("YNL102W",680).
component("YJR043C",523).
component("YJR006W",519).
...
component("YKL035W",544).
component("YHL012W",440).
component("YHR123W",460).
component("YNL130C",683).
component("YPL148C",778).
component("YOR251C",755).
component("YGR286C",436).
component("YDR058C",280).
component("YOL011W",714).
component("YMR008C",647).
component("YMR006C",646).
component("U105_",25).
component("U101_",21).
component("YJL068C",497).
component("YPL072W",773).
component("YOR124C",739).
component("YNL186W",688).
component("YMR304W",672).
component("YMR223W",666).
component("YKR098C",581).
component("YJL197W",514).
component("YIL156W",485).
...
component("YPL179W",781).
component("YNR032W",707).
component("YML057W",638).
component("YML016C",634).
...
component("YHR215W",471).
component("YDL024C",238).
component("YBR093C",194).
component("YBR092C",193).
component("YIL053W",476).
component("YER062C",345).
component("YHR046C",452).
component("U9_",161).
component("YGR208W",429).
component("YPL228W",787).
component("YMR180C",659).
...
component("U26_",103).
component("U24_",102).
component("YHR044C",451).
component("YHR043C",450).
component("YOL064C",724).
component("YPL268W",796).
component("YOR360C",764).
component("YGL248W",401).
component("YKR031C",573).
component("YGL027C",383).
component("YLR286C",614).
component("YJR153W",539).
component("YJL221C",518).
component("YJL216C",516).
component("YIL172C",491).
component("YGR292W",438).
component("YGR287C",437).
component("YBR299W",218).
component("YBR184W",205).
component("YIL162W",488).
component("YPR026W",802).
component("YDR001C",270).
component("YBR001C",175).
component("YDR400W",310).
component("U102_",22).
component("YER043C",338).
component("YNL045W",676).
component("YLR160C",602).
component("YLR158C",601).
component("YLR157C",600).
component("YLR155C",599).
component("YDR321W",306).
component("YGL037C",384).
component("U43_",120).
component("U42_",119).
component("YDR242W",299).
component("YLR308W",619).
component("YLR307W",618).
component("U53_",128).
component("YLR420W",629).
component("YPL111W",776).
component("YIR032C",493).
component("YLR028C",587).
component("YHR144C",463).
component("YHR144C",464).
component("YCL030C",223).
component("YNL141W",684).
component("YBR153W",202).
component("YDL238C",269).
component("YNL141W",685).
...
component("YLR134W",596).
component("YLR044C",589).
component("YGR087C",410).
component("YDR380W",308).
component("YDL080C",245).
component("YMR250W",667).
component("YKL184W",562).
component("YEL021W",328).
component("YNR043W",709).
component("U93_",159).
component("YDR047W",279).
component("YKL211C",567).
component("YKR097W",580).
component("YOL052C",717).
component("YGR170W",417).
component("YDR294C",302).
component("YEL046C",331).
component("YNR033W",708).
component("YPR006C",800).
component("YER065C",346).
component("YKL211C",568).
component("YER090W",353).
component("YDR127W",289).
component("YPL281C",798).
component("YOR393W",768).
component("YMR323W",673).
component("YHR174W",465).
component("YGR254W",432).
component("YPL262W",793).
component("YGL026C",382).
component("YGR155W",416).
component("YLR304C",617).
component("YJL200C",515).
component("YGL009C",379).
component("YNL316C",700).
component("YKL182W",560).
component("YPL212C",784).
component("YNL292W",698).
component("YGL063W",387).
component("YFL001W",362).
component("YCR053W",234).
component("YDR127W",290).
component("YGL148W",391).
component("YIL168W",490).
component("YIL167W",489).
component("YCL064C",227).
component("YCL064C",228).
component("YHR018C",444).
component("YLR359W",625).
component("YFR055W",376).
component("YJL121C",501).
component("YBR019C",179).
component("YDR007W",271).
component("YOR095C",737).
component("YBR196C",206).
component("YGL001C",378).
component("YPL117C",777).
component("U14_",55).
component("YOL056W",720).
component("YKL152C",556).
component("YDL021W",236).
component("YMR105C",653).
component("YKL127W",551).
component("YEL058W",334).
component("YPR060C",806).
component("YHR072W",457).
component("YJL153C",509).
component("YGR264C",435).
component("YGR171C",418).
component("YHR011W",443).
component("YDR023W",273).
component("YPL104W",775).
component("YLL018C",582).
component("YPR081C",810).
component("YBR121C",197).
component("YHR020W",447).
component("YER087W",351).
component("YOL033W",716).
component("YGL245W",400).
component("YOR168W",744).
component("YOL097C",727).
component("YDR268W",300).
component("YPR047W",805).
component("YLR060W",591).
component("YFL022C",366).
component("YPR033C",803).
component("YHR019C",445).
component("YHR019C",446).
component("YKL194C",565).
component("YIL078W",479).
component("YPL160W",779).
component("YLR382C",627).
component("YPL040C",772).
component("YBL076C",173).
component("YNL073W",679).
component("YDR037W",275).
component("YOR335C",760).
component("YGR094W",411).
component("YGR244C",431).
component("YPR035W",804).
component("YIL145C",483).
component("U89_",156).
component("YOR241W",754).
component("YMR113W",655).
component("YKL132C",552).
component("YGL234W",398).
component("YER183C",361).
component("U90_",158).
component("YNR057C",710).
component("YDL141W",257).
component("YDL141W",258).
component("YGL234W",399).
component("YDL141W",259).
component("YGR204W",428).
component("YOL058W",721).
component("YDL141W",260).
component("YHR074W",458).
component("YMR217W",664).
component("YPR145W",814).
component("YGR124W",414).
component("YOR303W",756).
component("YJR109C",533).
component("YJL130C",505).
component("YGL062W",386).
component("YBR218C",207).
component("YPL231W",791).
component("YNR016C",705).
component("YKL182W",561).
component("YGR037C",406).
component("YOR005C",733).
component("YDL164C",262).
component("YJL087C",498).
component("YOL010W",713).
component("YPR138C",813).
component("YPL265W",794).
component("YOR348C",763).
component("YOR192C",747).
component("YOR171C",745).
component("YOR130C",740).
component("YOR071C",736).
component("YOR011W",734).
component("YOL156W",732).
component("YOL103W",728).
component("YOL020W",715).
component("YNL318C",701).
component("YNL142W",686).
component("YMR272C",670).
component("YMR202W",661).
component("YMR056C",650).
component("YML123C",644).
component("YLR348C",622).
component("YLR260W",613).
component("YLR237W",610).
component("YLR138W",597).
component("YLR100C",594).
component("YLR092W",593).
component("YLR081W",592).
component("YLL061W",583).
component("YKR093W",579).
component("YKR053C",575).
component("YKR039W",574).
component("YKL217W",570).
component("YKL120W",550).
component("YKL004W",542).
component("YJR095W",531).
component("YJR077C",529).
component("YJL219W",517).
component("YJL134W",506).
component("YJL129C",503).
component("YHL036W",442).
