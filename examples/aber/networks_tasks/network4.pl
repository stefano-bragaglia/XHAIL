...
component("YGL001C",49).
component("YDR127W",34).
component("YNL009W",75).
component("YLR174W",68).
component("YJR078W",60).
component("YOR323C",81).
component("YBR166C",25).
component("YMR145C",71).
component("YDL085W",30).
component("YPL231W",83).
component("YLR299W",70).
component("YDR354W",40).
component("YFR047C",48).
component("YPR069C",87).
component("YDR127W",35).
component("YDR035W",32).
component("YBR249C",26).
component("YHR137W",57).
component("YLR027C",67).
component("YKL106W",61).
component("YCR036W",28).
component("YMR208W",72).
component("YDR127W",36).
component("YDR226W",39).
component("YDR454C",42).
component("YOL061W",79).
component("YKL181W",62).
component("YHL011C",54).
component("YER099C",46).
component("YBL068W",21).
component("YHR044C",56).
component("YHR043C",55).
component("U53_",20).
component("YHR144C",58).
component("YBR111C",24).
component("YLR231C",69).
component("YDR380W",41).
component("YDL080C",29).
component("YMR250W",73).
component("YKL184W",63).
component("YKL211C",64).
component("YKL211C",65).
component("YER090W",45).
component("YDR127W",37).
component("YPL281C",85).
component("YOR393W",82).
component("YMR323W",74).
component("YHR174W",59).
component("YGR254W",53).
component("YGL026C",50).
component("YNL316C",77).
component("YDR127W",38).
component("YGL148W",51).
component("YDR007W",31).
component("YOR095C",80).
component("YPR060C",86).
component("YPR138C",88).
component("YPL265W",84).
component("YOL020W",78).
component("YNL142W",76).
component("YKR039W",66).
component("YGR121C",52).
component("YFL055W",47).
component("YDR536W",44).
component("YDR508C",43).
