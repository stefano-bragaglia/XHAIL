...
component("YNL280C",256).
component("YLR056W",216).
component("YGL001C",146).
component("YDR127W",104).
component("YNL009W",248).
component("YLR174W",223).
component("YHR183W",177).
component("YGR256W",163).
component("YCL018W",78).
component("YJR078W",195).
component("YMR015C",235).
component("YDR402C",116).
component("YGL055W",149).
component("YJL026W",182).
component("YGR180C",160).
component("YER069W",132).
component("YOR323C",275).
component("YBR166C",73).
component("YNL280C",257).
component("YKL141W",203).
component("YOR375C",278).
component("YDL215C",96).
component("YAL062W",57).
component("U100_",18).
component("U56_",49).
component("YPL023C",280).
component("YGL125W",150).
component("YMR145C",239).
component("YDL085W",88).
component("YBR046C",65).
component("YPL273W",288).
component("YLL062C",212).
component("YDR410C",117).
component("YJR073C",193).
component("YOL096C",268).
component("YMR120C",238).
component("YJL130C",186).
component("YJL088W",184).
component("YPR074C",293).
component("YBR117C",71).
component("YCL009C",77).
component("YNL071W",249).
component("YNR019W",262).
component("YCR048W",84).
component("U48_",46).
component("YPL231W",284).
component("YDL052C",86).
component("U8_",53).
component("YPL231W",285).
component("YLR299W",225).
component("YCR005C",81).
component("YNL117W",251).
component("YIR031C",181).
component("YOR321W",274).
component("YJR143C",198).
component("YGR199W",161).
component("YDL095W",90).
component("YDL093W",89).
component("YAL023C",56).
component("YDR354W",113).
component("YFR047C",144).
component("U22_",38).
component("YDR399W",115).
component("YPR069C",292).
component("YDR127W",105).
component("YML082W",231).
component("YJR130C",197).
component("YDR035W",100).
component("YBR249C",75).
component("YHR137W",173).
component("YGL202W",153).
component("YLR027C",213).
component("YKL106W",201).
component("YLR438W",230).
component("U51_",47).
component("YJR148W",199).
component("YMR013C",234).
component("YCR036W",83).
component("YCL040W",80).
component("YJR105W",196).
component("YMR208W",241).
component("YHR025W",169).
component("YNR012W",260).
component("YFR019W",142).
component("YDR208W",110).
component("YDR127W",106).
component("YDR147W",109).
component("YER052C",128).
component("U19_",33).
component("U18_",30).
component("U76_",52).
component("YMR220W",242).
component("YDR226W",111).
component("YDR454C",119).
component("YOL061W",267).
component("YKL181W",204).
component("YHL011C",165).
component("YER099C",135).
component("YBL068W",62).
component("YOR143C",273).
component("YLR328W",228).
component("U94_",54).
component("YBR029C",64).
component("YPR175W",296).
component("YPL167C",283).
component("YOR330C",276).
component("YOL115W",270).
component("YNL299W",258).
component("YNL262W",255).
component("YNL102W",250).
component("YJR043C",192).
component("YJR006W",191).
component("YJL090C",185).
component("YIL139C",179).
component("YEL055C",126).
component("YDR419W",118).
component("YDR121W",103).
component("YDL102W",91).
component("YCR014C",82).
component("YBR278W",76).
component("YBL035C",59).
component("YKL035W",200).
component("YHL012W",166).
component("YOL011W",265).
component("YMR008C",233).
component("YMR006C",232).
component("U105_",19).
component("YPL072W",282).
component("YOR124C",272).
component("YNL186W",254).
component("YMR304W",246).
component("YMR223W",243).
component("YKR098C",211).
component("YJL197W",190).
component("YIL156W",180).
component("YFR010W",141).
component("YER151C",137).
component("YER144C",136).
component("YER098W",134).
component("YDR069C",102).
component("YDL122W",92).
component("YBR058C",66).
component("YBL067C",61).
component("YFR025C",143).
component("U9_",55).
component("YJL155C",189).
component("U33_",42).
component("U32_",41).
component("U30_",40).
component("U24_",39).
component("YHR044C",171).
component("YHR043C",170).
component("YLR160C",222).
component("YLR158C",221).
component("YLR157C",220).
component("YLR155C",219).
component("YDR321W",112).
component("YGL037C",148).
component("U43_",44).
component("U42_",43).
component("YLR308W",227).
component("YLR307W",226).
component("U53_",48).
component("YLR028C",214).
component("YHR144C",174).
component("YHR144C",175).
component("YBR153W",72).
component("YDL238C",97).
component("YNL141W",252).
component("U44_",45).
component("YHR201C",178).
component("YBR111C",70).
component("YER005W",127).
component("YLR231C",224).
component("YDR538W",124).
component("YLR134W",218).
component("YLR044C",215).
component("YGR087C",156).
component("YDR380W",114).
component("YDL080C",87).
component("YMR250W",244).
component("YKL184W",206).
component("YEL021W",125).
component("YKL211C",207).
component("YNR033W",263).
component("YKL211C",208).
component("YER090W",133).
component("YDR127W",107).
component("YPL281C",289).
component("YOR393W",279).
component("YMR323W",247).
component("YHR174W",176).
component("YGR254W",162).
component("YGL026C",147).
component("YNL316C",259).
component("YCR053W",85).
component("YDR127W",108).
component("YGL148W",151).
component("YFR055W",145).
component("YDR007W",98).
component("YOR095C",271).
component("YBR196C",74).
component("U14_",25).
component("YMR105C",237).
component("YKL127W",202).
component("YPR060C",291).
component("YHR072W",172).
component("YJL153C",188).
component("YGR264C",164).
component("YGR171C",159).
component("YHR011W",167).
component("YDR023W",99).
component("YGL245W",154).
component("YPR047W",290).
component("YLR060W",217).
component("YFL022C",139).
component("YHR019C",168).
component("YPL040C",281).
component("YBL076C",63).
component("YER183C",138).
component("YDL141W",93).
component("YDL141W",94).
component("YPR145W",295).
component("YGR124W",158).
component("YPL231W",286).
component("YNR016C",261).
component("YKL182W",205).
component("YGR037C",155).
component("YJL087C",183).
component("YOL010W",264).
component("YPR138C",294).
component("YPL265W",287).
component("YOR348C",277).
component("YOL103W",269).
component("YOL020W",266).
component("YNL142W",253).
component("YMR272C",245).
component("YMR202W",240).
component("YMR056C",236).
component("YLR348C",229).
component("YKR053C",210).
component("YKR039W",209).
component("YJR077C",194).
component("YJL134W",187).
component("YGR121C",157).
component("YGL186C",152).
component("YFL055W",140).
component("YER060W-A",131).
component("YER060W",130).
component("YER056C",129).
component("YDR536W",123).
component("YDR508C",122).
component("YDR503C",121).
component("YDR497C",120).
component("YDR046C",101).
component("YDL210W",95).
component("YCL025C",79).
component("YBR085W",69).
component("YBR069C",68).
component("YBR068C",67).
component("YBL042C",60).
component("YBL030C",58).
component("U6_",51).
component("U5_",50).
component("U228_",37).
component("U222_",36).
