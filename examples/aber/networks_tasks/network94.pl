...
component("YNL280C",545).
component("YLR056W",455).
component("YKR009C",443).
component("YMR083W",505).
component("YPL231W",619).
component("YJR159W",420).
component("YGL001C",293).
component("YML056C",491).
component("YLR432W",486).
component("YHR216W",367).
component("YAR075W",122).
component("YAR073W",121).
component("YCL030C",167).
component("YDR127W",220).
component("YJR139C",416).
component("YOR136W",579).
component("YNL009W",524).
component("YLR174W",467).
component("YDL066W",184).
component("YHR183W",362).
component("YGR256W",337).
component("YNL241C",539).
component("YOL059W",566).
component("YDL022W",179).
component("YCL018W",165).
component("YLR355C",481).
component("YML054C",490).
component("YIL155C",376).
component("YEL024W",251).
component("YJR078W",412).
component("U58_",96).
component("YGR255C",336).
component("YMR015C",502).
component("YDR402C",237).
component("YGL055W",299).
component("YJL026W",384).
component("YIL066C",372).
component("YGR180C",328).
component("YER070W",267).
component("U36_",83).
component("U35_",82).
component("YJR009C",403).
component("YJL052W",385).
component("YGR192C",330).
component("YOR374W",600).
component("YER073W",268).
component("U68_",100).
component("YGL154C",305).
component("U55_",94).
component("YER069W",266).
component("YOR323C",593).
component("U2_",77).
component("YBR221C",157).
component("YBR166C",153).
component("YNL280C",546).
component("YKL182W",434).
component("YER014W",255).
component("YKL141W",429).
component("YJR051W",407).
component("YOR375C",601).
component("YDL215C",204).
component("YAL062W",120).
component("U100_",20).
component("YBR035C",138).
component("YMR189W",512).
component("U56_",95).
component("YPL023C",605).
component("YGL125W",303).
component("YOR236W",588).
component("YGR204W",333).
component("YBR084W",144).
component("YLR142W",461).
component("U65_",99).
component("U62_",98).
component("YHR068W",352).
component("YKL150W",431).
component("YIL043C",370).
component("YHR042W",347).
component("YOR221C",586).
component("YMR145C",510).
component("YML120C",496).
component("YKL192C",437).
component("YKL055C",423).
component("YER061C",262).
component("YDL085W",187).
component("YBR046C",140).
component("YPL017C",604).
component("YFL018C",282).
component("YPL091W",608).
component("YER042W",256).
component("YNL052W",526).
component("YMR256C",519).
component("YLR395C",484).
component("YLR038C",453).
component("YIL111W",374).
component("YHR051W",351).
component("YGL191W",308).
component("YGL187C",307).
component("YDL067C",185).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",625).
component("YPL273W",627).
component("YLL062C",450).
component("YDR410C",239).
component("YER091C",272).
component("YJR073C",410).
component("YDL033C",180).
component("YOL096C",569).
component("YLR172C",466).
component("YMR120C",509).
component("YBL013W",123).
component("YJL130C",393).
component("YJL088W",388).
component("YPR074C",637).
component("YBR117C",148).
component("YMR108W",507).
component("YCL009C",164).
component("YMR062C",504).
component("YNL071W",527).
component("YIL160C",378).
component("YNR019W",554).
component("YCR048W",176).
component("U48_",89).
component("YNL277W",544).
component("YFL017C",281).
component("YPL231W",620).
component("YER061C",263).
component("U86_",112).
component("YDL052C",182).
component("U8_",115).
component("YDR148C",226).
component("YOR377W",602).
component("YGR177C",327).
component("YPL231W",621).
component("YLR195C",469).
component("YLR299W",475).
component("YPR001W",629).
component("YNR001C",550).
component("YCR005C",172).
component("YML126C",498).
component("YDL182W",201).
component("YDL131W",193).
component("YNL117W",531).
component("YIR031C",382).
component("YOR321W",592).
component("YJR143C",417).
component("YGR199W",332).
component("YDL095W",189).
component("YDL093W",188).
component("YAL023C",119).
component("YPL227C",617).
component("YMR261C",520).
component("YML100W",495).
component("YBR126C",150).
component("YNL192W",538).
component("YBR038W",139).
component("YBR023C",136).
component("YLR209C",470).
component("U104_",24).
component("U103_",23).
component("YDR354W",233).
component("YFR047C",290).
component("YJR133W",415).
component("U22_",72).
component("YLR209C",471).
component("YDR399W",235).
component("YJL167W",400).
component("YNL256W",541).
component("YPR069C",636).
component("YDR127W",221).
component("YHR190W",363).
component("YHR068W",353).
component("YLR303W",476).
component("YML082W",494).
component("YJR130C",414).
component("YDR035W",210).
component("YBR249C",158).
component("YLR180W",468).
component("YDR502C",244).
component("YOL143C",573).
component("YBR256C",160).
component("YHR137W",357).
component("YGL202W",309).
component("YLR027C",451).
component("YKL106W",426).
component("YOL140W",572).
component("YLR438W",488).
component("YKL104C",425).
component("YGR019W",315).
component("YDR111C",218).
component("U51_",92).
component("YJR148W",418).
component("YHR208W",366).
component("YOR184W",583).
component("YGL253W",314).
component("YFR053C",291).
component("YMR013C",501).
component("YLR240W",473).
component("YKL203C",439).
component("YJR066W",409).
component("YCR036W",175).
component("YGR194C",331).
component("YCL040W",169).
component("YJR105W",413).
component("U16_",50).
component("YKL001C",421).
component("YML070W",493).
component("YFL053W",285).
component("YDR531W",247).
component("U82_",111).
component("U81_",110).
component("YMR208W",514).
component("YPL203W",615).
component("YOR061W",574).
component("YKL166C",432).
component("YJL164C",399).
component("YIL035C",369).
component("YHR205W",365).
component("YHR102W",355).
component("YGL019W",295).
component("YHR025W",346).
component("YNR012W",552).
component("YPR121W",639).
component("YPL258C",623).
component("YOL055C",564).
component("U1_",62).
component("YDR009W",208).
component("YBR020W",135).
component("YFR019W",288).
component("YDR208W",228).
component("YDR127W",222).
component("U21_",69).
component("YDR147W",225).
component("YCR012W",173).
component("YER052C",258).
component("U19_",61).
component("U18_",57).
component("U17_",54).
component("U76_",107).
component("YMR220W",516).
component("YER170W",278).
component("YDR226W",229).
component("YKL067W",424).
component("YOL055C",565).
component("YDR454C",242).
component("YOL061W",567).
component("YKL181W",433).
component("YHL011C",340).
component("YER099C",274).
component("YBL068W",129).
component("YOR143C",580).
component("YNL256W",542).
component("YBR018C",133).
component("YDL055C",183).
component("YLR328W",479).
component("YDL103C",191).
component("U94_",117).
component("YJR010W",404).
component("YBR029C",137).
component("YPR190C",644).
component("YPR187W",643).
component("YPR110C",638).
component("YPR010C",631).
component("YOR341W",597).
component("YOR340C",596).
component("YOR224C",587).
component("YOR210W",585).
component("YOR207C",584).
component("YOR151C",581).
component("YOR116C",576).
component("YOL005C",559).
component("YNR003C",551).
component("YNL248C",540).
component("YNL151C",536).
component("YNL113W",530).
component("YKL144C",430).
component("YJR063W",408).
component("YJL148W",396).
component("YJL140W",395).
component("YIL021W",368).
component("YHR143W-A",358).
component("YGL070C",302).
component("YFL036W",284).
component("YDR404C",238).
component("YDR156W",227).
component("YDR045C",212).
component("YDL150W",200).
component("YDL140C",195).
component("YBR154C",152).
component("YPR175W",642).
component("YPL167C",613).
component("YOR330C",594).
component("YOL115W",571).
component("YNL299W",548).
component("YNL262W",543).
component("YNL102W",529).
component("YJR043C",406).
component("YJR006W",402).
component("YJL090C",389).
component("YIL139C",375).
component("YEL055C",252).
component("YDR419W",240).
component("YDR121W",219).
component("YDL102W",190).
component("YCR014C",174).
component("YBR278W",161).
component("YBL035C",125).
component("YKL035W",422).
component("YHL012W",341).
component("YHR123W",356).
component("YNL130C",532).
component("YPL148C",611).
component("YOR251C",590).
component("YGR286C",339).
component("YDR058C",214).
component("YOL011W",561).
component("YMR008C",500).
component("YMR006C",499).
component("U105_",25).
component("U101_",21).
component("YJL068C",386).
component("YPL072W",607).
component("YOR124C",577).
component("YNL186W",537).
component("YMR304W",522).
component("YMR223W",517).
component("YKR098C",448).
component("YJL197W",401).
component("YIL156W",377).
component("YFR010W",287).
component("YER151C",277).
component("YER144C",276).
component("YER098W",273).
component("YDR069C",215).
component("YDL122W",192).
component("YBR058C",141).
component("YBL067C",128).
component("YJR019C",405).
component("YDR074W",216).
component("YFR025C",289).
component("YPL179W",614).
component("YNR032W",555).
component("YML057W",492).
component("YML016C",489).
component("YLR433C",487).
component("YGR123C",322).
component("YER133W",275).
component("YER089C",270).
component("YDR436W",241).
component("YDR075W",217).
component("YDL188C",202).
component("YDL134C",194).
component("YDL047W",181).
component("YDL006W",178).
component("YBR125C",149).
component("YBL056W",127).
component("YIL053W",371).
component("YER062C",264).
component("YHR046C",350).
component("U9_",118).
component("YGR208W",334).
component("YPL228W",618).
component("YMR180C",511).
component("YJL155C",398).
component("U34_",81).
component("U33_",80).
component("U32_",79).
component("U30_",78).
...
component("U26_",74).
component("U24_",73).
component("YHR044C",349).
component("YHR043C",348).
component("YOL064C",568).
component("YPL268W",626).
component("YOR360C",599).
component("YGL248W",313).
component("YKR031C",444).
component("YGL027C",297).
component("YLR286C",474).
component("YJR153W",419).
component("YBR184W",154).
component("YIL162W",379).
component("YPR026W",632).
component("YDR001C",206).
component("YBR001C",132).
component("YDR400W",236).
component("U102_",22).
component("YER043C",257).
component("YNL045W",525).
component("YLR160C",465).
component("YLR158C",464).
component("YLR157C",463).
component("YLR155C",462).
component("YDR321W",232).
component("YGL037C",298).
component("U43_",87).
component("U42_",86).
component("YLR308W",478).
component("YLR307W",477).
component("U53_",93).
component("YLR420W",485).
component("YPL111W",609).
component("YIR032C",383).
component("YLR028C",452).
component("YHR144C",359).
component("YHR144C",360).
component("YNL141W",533).
component("YBR153W",151).
component("YDL238C",205).
component("YNL141W",534).
component("YBR084W",145).
component("YJL126W",391).
component("U44_",88).
component("U39_",84).
component("YHR201C",364).
component("YBR111C",147).
component("YBR252W",159).
component("YCL030C",168).
component("YER005W",254).
component("YBL099W",131).
component("YLR231C",472).
component("U88_",113).
component("YDR538W",249).
component("YLR134W",459).
component("YLR044C",454).
component("YGR087C",319).
component("YDR380W",234).
component("YDL080C",186).
component("YMR250W",518).
component("YKL184W",436).
component("YEL021W",250).
component("YNR043W",557).
component("YKL211C",440).
component("YKR097W",447).
component("YOL052C",563).
component("YDR294C",230).
component("YNR033W",556).
component("YPR006C",630).
component("YER065C",265).
component("YKL211C",441).
component("YER090W",271).
component("YDR127W",223).
component("YPL281C",628).
component("YOR393W",603).
component("YMR323W",523).
component("YHR174W",361).
component("YGR254W",335).
component("YGL026C",296).
component("YGR155W",325).
component("YNL316C",549).
component("YPL212C",616).
component("YNL292W",547).
component("YGL063W",301).
component("YFL001W",280).
component("YCR053W",177).
component("YDR127W",224).
component("YGL148W",304).
component("YIL168W",381).
component("YIL167W",380).
component("YCL064C",170).
component("YCL064C",171).
component("YLR359W",482).
component("YFR055W",292).
component("YJL121C",390).
component("YBR019C",134).
component("YDR007W",207).
component("YOR095C",575).
component("YBR196C",155).
component("YGL001C",294).
component("YPL117C",610).
component("U14_",42).
component("YMR105C",506).
component("YKL127W",427).
component("YEL058W",253).
component("YPR060C",635).
component("YHR072W",354).
component("YJL153C",397).
component("YGR264C",338).
component("YGR171C",326).
component("YHR011W",343).
component("YDR023W",209).
component("YHR020W",345).
component("YER087W",269).
component("YGL245W",312).
component("YOR168W",582).
component("YPR047W",634).
component("YLR060W",456).
component("YFL022C",283).
component("YPR033C",633).
component("YHR019C",344).
component("YKL194C",438).
component("YIL078W",373).
component("YPL160W",612).
component("YLR382C",483).
component("YPL040C",606).
component("YBL076C",130).
component("YNL073W",528).
component("YDR037W",211).
component("YOR335C",595).
component("YGR094W",320).
component("U89_",114).
component("YOR241W",589).
component("YMR113W",508).
component("YKL132C",428).
component("YGL234W",310).
component("YER183C",279).
component("U90_",116).
component("YNR057C",558).
component("YDL141W",196).
component("YDL141W",197).
component("YGL234W",311).
component("YDL141W",198).
component("YDL141W",199).
component("YMR217W",515).
component("YPR145W",641).
component("YGR124W",323).
component("YOR303W",591).
...
component("YJL087C",387).
component("YOL010W",560).
component("YPR138C",640).
component("YPL265W",624).
component("YOR348C",598).
component("YOR130C",578).
component("YOL103W",570).
component("YOL020W",562).
component("YNL142W",535).
component("YMR272C",521).
component("YMR202W",513).
component("YMR056C",503).
component("YML123C",497).
component("YLR348C",480).
component("YLR138W",460).
component("YLR100C",458).
component("YLR092W",457).
component("YLL061W",449).
component("YKR053C",446).
component("YKR039W",445).
component("YKL217W",442).
component("YJR077C",411).
component("YJL134W",394).
component("YJL129C",392).
component("YHL036W",342).
component("YGR191W",329).
component("YGR125W",324).
component("YGR121C",321).
component("YGR065C",318).
component("YGR055W",317).
component("YGL186C",306).
component("YFL055W",286).
...
component("YDR497C",243).
component("YDR294C",231).
component("YDR046C",213).
component("YDL210W",203).
component("YCL025C",166).
component("YBR294W",163).
component("YBR291C",162).
component("YBR085W",146).
component("YBR069C",143).
component("YBR068C",142).
component("YBL042C",126).
component("YBL030C",124).
component("U7_",109).
component("U79_",108).
component("U75_",106).
component("U74_",105).
