...
component("YNL280C",375).
component("YLR056W",314).
component("YMR083W",348).
component("YPL231W",422).
component("YJR159W",288).
component("YGL001C",201).
component("YML056C",336).
component("YLR432W",334).
component("YHR216W",251).
component("YAR075W",84).
component("YAR073W",83).
component("YDR127W",151).
component("YJR139C",285).
component("YNL009W",363).
component("YLR174W",323).
component("YHR183W",247).
component("YGR256W",228).
component("YCL018W",113).
component("YJR078W",281).
component("U58_",67).
component("YGR255C",227).
component("YMR015C",345).
component("YDR402C",165).
component("YGL055W",206).
component("YJL026W",260).
component("YGR180C",222).
component("YOR374W",412).
component("YER073W",184).
component("U68_",71).
component("U55_",65).
component("YER069W",183).
component("YOR323C",407).
component("YBR166C",106).
component("YNL280C",376).
component("YKL141W",294).
component("YOR375C",413).
component("YDL215C",139).
component("YAL062W",82).
component("U100_",20).
component("YBR035C",94).
component("YMR189W",352).
component("U56_",66).
component("YPL023C",415).
component("YGL125W",208).
component("YOR236W",405).
component("YLR142W",318).
component("U65_",70).
component("U62_",69).
component("YHR068W",238).
component("YMR145C",351).
component("YML120C",339).
component("YKL192C",300).
component("YDL085W",125).
component("YBR046C",95).
component("YPL091W",418).
component("YNL052W",364).
component("YMR256C",358).
component("YLR395C",333).
component("YLR038C",312).
component("YIL111W",255).
component("YHR051W",237).
component("YGL191W",212).
component("YGL187C",211).
component("YDL067C",123).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",428).
component("YLL062C",309).
component("YDR410C",167).
component("YER091C",186).
component("YJR073C",279).
component("YOL096C",391).
component("YMR120C",350).
component("YBL013W",85).
component("YJL130C",266).
component("YJL088W",262).
component("YPR074C",434).
component("YBR117C",102).
component("YCL009C",112).
component("YMR062C",347).
component("YNL071W",365).
component("YNR019W",382).
component("YCR048W",120).
component("U48_",61).
component("YFL017C",192).
component("YPL231W",423).
component("YDL052C",122).
component("U8_",77).
component("YPL231W",424).
component("YLR299W",327).
component("YCR005C",117).
component("YML126C",341).
component("YDL182W",137).
component("YDL131W",130).
component("YNL117W",368).
component("YIR031C",258).
component("YOR321W",406).
component("YJR143C",286).
component("YGR199W",225).
component("YDL095W",127).
component("YDL093W",126).
component("YAL023C",81).
component("YMR261C",359).
component("YML100W",338).
component("YBR126C",103).
component("YLR209C",324).
component("YDR354W",162).
component("YFR047C",199).
component("YJR133W",284).
component("U22_",51).
component("YDR399W",164).
component("YJL167W",273).
component("YPR069C",433).
component("YDR127W",152).
component("YHR068W",239).
component("YML082W",337).
component("YJR130C",283).
component("YDR035W",143).
component("YBR249C",108).
component("YBR256C",109).
component("YHR137W",242).
component("YGL202W",213).
component("YLR027C",310).
component("YKL106W",292).
component("YOL140W",394).
component("YLR438W",335).
component("YKL104C",291).
component("YDR111C",149).
component("U51_",63).
component("YJR148W",287).
component("YHR208W",250).
component("YMR013C",344).
component("YCR036W",119).
component("YGR194C",224).
component("YCL040W",116).
component("YJR105W",282).
component("U81_",76).
component("YMR208W",354).
component("YPL203W",421).
component("YOR061W",395).
component("YKL166C",296).
component("YJL164C",272).
component("YIL035C",253).
component("YHR205W",249).
component("YHR102W",241).
component("YGL019W",202).
component("YHR025W",234).
component("YNR012W",380).
component("YPR121W",436).
component("YPL258C",426).
component("YOL055C",389).
component("YFR019W",197).
component("YDR208W",158).
component("YDR127W",153).
component("U21_",48).
component("YDR147W",156).
component("YER052C",179).
component("U19_",44).
component("U18_",40).
component("U17_",37).
component("U76_",74).
component("YMR220W",355).
component("YDR226W",159).
component("YKL067W",290).
component("YDR454C",169).
component("YOL061W",390).
component("YKL181W",297).
component("YHL011C",230).
component("YER099C",188).
component("YBL068W",90).
component("YOR143C",399).
component("YLR328W",330).
component("U94_",79).
component("YBR029C",93).
component("YPR190C",441).
component("YPR187W",440).
component("YPR110C",435).
component("YPR010C",430).
component("YOR341W",410).
component("YOR340C",409).
component("YOR224C",404).
component("YOR210W",403).
component("YOR207C",402).
component("YOR151C",400).
component("YOR116C",397).
component("YOL005C",385).
component("YNR003C",379).
component("YNL248C",373).
component("YNL151C",371).
component("YNL113W",367).
component("YKL144C",295).
component("YJR063W",278).
component("YJL148W",269).
component("YJL140W",268).
component("YIL021W",252).
component("YHR143W-A",243).
component("YGL070C",207).
component("YFL036W",194).
component("YDR404C",166).
component("YDR156W",157).
component("YDR045C",144).
component("YDL150W",136).
component("YDL140C",131).
component("YBR154C",105).
component("YPR175W",439).
component("YPL167C",420).
component("YOR330C",408).
component("YOL115W",393).
component("YNL299W",377).
component("YNL262W",374).
component("YNL102W",366).
...
component("YDR121W",150).
component("YDL102W",128).
component("YCR014C",118).
component("YBR278W",110).
component("YBL035C",87).
component("YKL035W",289).
component("YHL012W",231).
component("YDR058C",146).
component("YOL011W",387).
component("YMR008C",343).
component("YMR006C",342).
component("U105_",21).
component("YPL072W",417).
component("YOR124C",398).
component("YNL186W",372).
component("YMR304W",361).
component("YMR223W",356).
component("YKR098C",308).
component("YJL197W",274).
component("YIL156W",257).
component("YFR010W",196).
component("YER151C",190).
component("YER144C",189).
component("YER098W",187).
component("YDR069C",147).
component("YDL122W",129).
component("YBR058C",96).
component("YBL067C",89).
component("YJR019C",276).
component("YDR074W",148).
component("YFR025C",198).
component("U9_",80).
component("YJL155C",271).
component("U34_",57).
component("U33_",56).
component("U32_",55).
component("U30_",54).
component("U29_",53).
component("U24_",52).
component("YHR044C",236).
component("YHR043C",235).
component("YGL027C",204).
component("YLR286C",326).
component("YLR160C",322).
component("YLR158C",321).
component("YLR157C",320).
component("YLR155C",319).
component("YDR321W",161).
component("YGL037C",205).
component("U43_",59).
component("U42_",58).
component("YLR308W",329).
component("YLR307W",328).
component("U53_",64).
component("YIR032C",259).
component("YLR028C",311).
component("YHR144C",244).
component("YHR144C",245).
component("YBR153W",104).
component("YDL238C",140).
component("YNL141W",369).
component("YBR084W",99).
component("YJL126W",265).
component("U44_",60).
component("YHR201C",248).
component("YBR111C",101).
component("YCL030C",115).
component("YER005W",178).
component("YLR231C",325).
component("YDR538W",174).
component("YLR134W",317).
component("YLR044C",313).
component("YGR087C",217).
component("YDR380W",163).
component("YDL080C",124).
component("YMR250W",357).
component("YKL184W",299).
component("YEL021W",175).
component("YKL211C",302).
component("YKR097W",307).
component("YNR033W",383).
component("YKL211C",303).
component("YER090W",185).
component("YDR127W",154).
component("YPL281C",429).
component("YOR393W",414).
component("YMR323W",362).
component("YHR174W",246).
component("YGR254W",226).
component("YGL026C",203).
component("YGR155W",220).
component("YNL316C",378).
component("YCR053W",121).
component("YDR127W",155).
component("YGL148W",209).
component("YFR055W",200).
component("YJL121C",264).
component("YBR019C",92).
component("YDR007W",141).
component("YOR095C",396).
component("YBR196C",107).
component("U14_",30).
component("YMR105C",349).
component("YKL127W",293).
component("YEL058W",177).
component("YPR060C",432).
component("YHR072W",240).
component("YJL153C",270).
component("YGR264C",229).
component("YGR171C",221).
component("YHR011W",232).
component("YDR023W",142).
component("YGL245W",215).
component("YOR168W",401).
component("YPR047W",431).
component("YLR060W",315).
component("YFL022C",193).
component("YHR019C",233).
component("YKL194C",301).
component("YIL078W",254).
component("YPL160W",419).
component("YLR382C",332).
component("YPL040C",416).
component("YBL076C",91).
component("YGL234W",214).
component("YER183C",191).
component("U90_",78).
component("YNR057C",384).
component("YDL141W",132).
component("YDL141W",133).
component("YDL141W",134).
component("YDL141W",135).
component("YPR145W",438).
component("YGR124W",219).
component("YPL231W",425).
component("YNR016C",381).
component("YKL182W",298).
component("YGR037C",216).
component("YJL087C",261).
component("YOL010W",386).
component("YPR138C",437).
component("YPL265W",427).
component("YOR348C",411).
component("YOL103W",392).
component("YOL020W",388).
component("YNL142W",370).
component("YMR272C",360).
component("YMR202W",353).
component("YMR056C",346).
component("YML123C",340).
component("YLR348C",331).
component("YLR100C",316).
component("YKR053C",306).
component("YKR039W",305).
component("YKL217W",304).
component("YJR077C",280).
component("YJL134W",267).
component("YGR191W",223).
component("YGR121C",218).
component("YGL186C",210).
component("YFL055W",195).
component("YER060W-A",182).
component("YER060W",181).
component("YER056C",180).
component("YDR536W",173).
component("YDR508C",172).
component("YDR503C",171).
component("YDR497C",170).
component("YDR294C",160).
component("YDR046C",145).
component("YDL210W",138).
component("YCL025C",114).
component("YBR291C",111).
component("YBR085W",100).
component("YBR069C",98).
component("YBR068C",97).
component("YBL042C",88).
component("YBL030C",86).
component("U7_",75).
component("U6_",73).
component("U69_",72).
component("U5_",68).
