...
component("YLR056W",610).
component("YKR009C",591).
component("YMR083W",672).
component("YPL231W",815).
component("U46_",127).
component("YBR149W",208).
component("YBR149W",209).
component("YJR159W",560).
component("YGL001C",393).
component("YHR063C",471).
component("YML056C",657).
component("YLR432W",650).
component("YHR216W",490).
component("YAR075W",170).
component("YAR073W",169).
component("YCL030C",230).
component("YDR127W",298).
component("YJR139C",556).
component("YKL085W",567).
component("YOR136W",764).
component("YNL009W",695).
component("YLR174W",624).
component("YDL066W",252).
component("YHR183W",484).
component("YGR256W",450).
component("YNL241C",711).
component("YOL059W",745).
component("YDL022W",245).
component("YCL018W",228).
component("YLR355C",644).
component("YIL074C",496).
component("YER081W",366).
component("YML054C",656).
component("YIL155C",502).
component("YEL024W",342).
component("YKR066C",596).
component("YKL026C",563).
component("YIR037W",512).
component("YBR244W",217).
component("YJR078W",549).
component("U58_",137).
component("U107_",26).
component("YGR255C",449).
component("U108_",27).
component("YMR015C",669).
component("YDR402C",324).
component("YGL055W",401).
component("YJR104C",551).
component("YHR008C",459).
component("YJL026W",513).
component("YIL066C",495).
component("YGR180C",436).
component("YER070W",364).
component("U37_",119).
component("U36_",118).
component("U35_",117).
component("YDR158W",306).
component("YJR009C",539).
component("YJL052W",514).
component("YGR192C",438).
component("YPL276W",826).
component("YPL275W",825).
component("YOR388C",793).
component("YOR374W",790).
component("YER073W",365).
component("U68_",143).
component("YGL154C",408).
component("U55_",134).
component("YER069W",363).
component("YOR323C",783).
component("U2_",112).
component("YBR221C",216).
component("YBR166C",212).
component("YNL280C",719).
component("YGL012W",396).
component("YKL182W",579).
component("U57_",136).
component("YKL216W",589).
component("YDR044W",287).
component("YER014W",351).
component("YKR009C",592).
component("YIL160C",504).
component("YGL205W",413).
component("YKL141W",573).
component("YJR051W",544).
component("YEL047C",345).
component("YDL171C",273).
component("YOR375C",791).
component("YDL215C",277).
component("YAL062W",168).
component("U100_",20).
component("YBR035C",192).
component("YMR189W",681).
component("U56_",135).
component("YKR080W",598).
component("YPL023C",797).
component("YGL125W",405).
component("YOR236W",776).
component("YGR204W",442).
component("YBR084W",198).
component("YLR142W",618).
component("U65_",141).
component("U62_",139).
component("YHR068W",472).
component("YKL150W",575).
component("YIL043C",493).
component("YHR042W",466).
component("YOR221C",774).
component("YMR145C",678).
component("YML120C",662).
component("YKL192C",583).
component("YKL055C",565).
component("YER061C",359).
component("YDL085W",255).
component("YBR046C",194).
component("YMR145C",679).
component("YML120C",663).
component("YKL192C",584).
component("YDL085W",256).
component("YPL017C",796).
component("YFL018C",381).
component("YPL091W",800).
component("YER042W",352).
component("YPR167C",845).
component("YNL052W",698).
component("YMR256C",689).
component("YLR395C",648).
component("YLR038C",608).
component("YIL111W",499).
component("YHR051W",470).
component("YGL191W",411).
component("YGL187C",410).
component("YDL067C",253).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",822).
component("YBR034C",191).
component("YPL273W",824).
component("YLL062C",604).
component("YDR410C",327).
component("YKR069W",597).
component("YOL096C",748).
component("U47_",128).
component("YER091C",370).
component("YJR073C",547).
component("YML008C",653).
component("YDL033C",247).
component("YOL096C",749).
component("YLR172C",623).
component("YBR263W",221).
component("YDR019C",283).
component("YDR408C",326).
component("YMR120C",677).
component("YLR028C",606).
component("YBL013W",171).
component("YJL130C",523).
component("YJL088W",517).
component("YPR074C",838).
component("YBR117C",204).
component("YLR354C",643).
component("YGR043C",423).
component("YMR108W",675).
component("YCL009C",227).
component("YMR062C",671).
component("YNL071W",699).
component("YIL160C",505).
component("YNR019W",728).
component("YCR048W",241).
component("U48_",129).
component("YNL277W",717).
component("YDR232W",309).
component("YFL017C",380).
component("YPL231W",816).
component("YER061C",360).
component("U86_",159).
component("YPL001W",795).
component("YDL052C",250).
component("U8_",162).
component("YDR148C",304).
component("YOR377W",792).
component("YGR177C",435).
component("YPL231W",817).
component("YLR195C",626).
component("YLR299W",635).
component("YPR001W",828).
component("YNR001C",724).
component("YCR005C",237).
component("YML126C",665).
component("YDL182W",274).
component("YDL131W",264).
component("YNL117W",703).
component("YIR031C",510).
component("YPR160W",844).
component("YOR321W",782).
component("YJR143C",557).
component("YGR199W",440).
component("YDL095W",259).
component("YDL093W",258).
component("YAL023C",167).
component("YLR258W",632).
component("YFR015C",387).
component("YPL227C",813).
component("YNL029C",696).
component("YIL085C",498).
component("YMR261C",690).
component("YML100W",661).
component("YBR126C",207).
component("YNL192W",710).
component("YBR038W",193).
component("YBR023C",189).
component("YEL011W",340).
component("YLR209C",627).
component("U104_",24).
component("U103_",23).
component("YOR209C",772).
component("YMR300C",692).
component("YDR354W",320).
component("YFR047C",390).
component("YJR133W",555).
component("U22_",106).
component("YLR209C",628).
component("YDR399W",322).
component("YPR176C",847).
component("YPL172C",807).
component("YNR041C",731).
component("YMR101C",673).
component("YDL090C",257).
component("YBR003W",182).
component("YBR002C",181).
component("YJL167W",531).
component("YJL167W",532).
component("YNL256W",713).
component("YPR069C",836).
component("YDR127W",299).
component("YHR190W",485).
component("YHR068W",473).
component("YLR303W",636).
component("YGR012W",420).
component("YML082W",660).
component("YJR130C",554).
component("YDR035W",285).
component("YBR249C",218).
component("YLR180W",625).
component("YDR502C",333).
component("YOR274W",779).
component("YOL143C",754).
component("YBR256C",220).
component("YHR137W",479).
component("YGL202W",412).
component("YLR027C",605).
component("YKL106W",569).
component("YOL140W",753).
component("YLR438W",652).
component("YKL104C",568).
component("YGR019W",421).
component("YDR111C",296).
component("U64_",140).
component("U51_",132).
component("YJR148W",558).
component("YHR208W",488).
component("YOR184W",769).
component("YNR058W",734).
component("YGL253W",418).
component("YFR053C",391).
component("YMR013C",668).
component("YMR205C",683).
component("YGR240C",446).
component("YLR240W",631).
component("YKL203C",586).
component("YJR066W",546).
component("YCR036W",240).
component("YGR194C",439).
component("YCL040W",233).
component("YJR105W",552).
component("U16_",69).
component("YPL188W",809).
component("YJR049C",543).
component("YEL041W",343).
component("YKL001C",561).
component("YDR236C",310).
component("YML070W",659).
component("YFL053W",384).
component("YHL032C",457).
component("YLR133W",615).
component("YDR531W",337).
component("U83_",156).
component("U82_",155).
component("U81_",154).
component("YMR208W",684).
component("YPL203W",810).
component("YOR061W",758).
component("YKL166C",577).
component("YJL164C",530).
component("YIL035C",492).
component("YHR205W",487).
component("YHR102W",477).
component("YGL019W",397).
component("YHR025W",465).
component("YNR012W",726).
component("YPR121W",841).
component("YPL258C",819).
component("YOL055C",741).
component("YPL214C",812).
component("U1_",89).
component("YDR009W",282).
component("YBR020W",188).
component("YFR019W",388).
component("YDR208W",307).
component("YDR127W",300).
component("U21_",99).
component("U20_",94).
component("YDR147W",303).
component("YDR300C",317).
component("YCR012W",238).
component("YER052C",354).
component("U19_",88).
component("U18_",81).
component("U17_",75).
component("U76_",151).
component("YMR220W",686).
component("YER170W",376).
component("YDR226W",308).
component("YKL067W",566).
component("YOL055C",742).
component("YDR454C",330).
component("YOL061W",746).
component("YKL181W",578).
component("YHL011C",455).
component("YER099C",372).
component("YBL068W",177).
component("YOR143C",765).
component("YNL256W",714).
component("YLR328W",640).
component("YBR018C",184).
component("YBR018C",185).
component("YDL055C",251).
component("YGR007W",419).
component("YGR202C",441).
component("YLR328W",641).
component("YDL045C",248).
component("YDL103C",262).
component("U94_",165).
component("YJR010W",540).
component("YBR029C",190).
component("YGL130W",406).
component("YDR530C",336).
component("YCL050C",234).
component("YPR190C",849).
component("YPR187W",848).
component("YPR110C",840).
component("YPR010C",830).
component("YOR341W",787).
component("YOR340C",786).
component("YOR224C",775).
component("YOR210W",773).
component("YOR207C",771).
component("YOR151C",766).
component("YOR116C",761).
component("YOL005C",735).
component("YNR003C",725).
component("YNL248C",712).
component("YNL151C",708).
component("YNL113W",702).
component("YKL144C",574).
component("YJR063W",545).
component("YJL148W",527).
component("YJL140W",526).
...
component("YDR045C",288).
component("YDL150W",271).
component("YDL140C",266).
component("YBR154C",211).
component("YPR175W",846).
component("YPL167C",806).
component("YOR330C",784).
component("YOL115W",752).
component("YNL299W",721).
component("YNL262W",715).
component("YNL102W",701).
component("YJR043C",542).
component("YJR006W",538).
component("YJL090C",518).
component("YIL139C",500).
component("YEL055C",346).
component("YDR419W",328).
component("YDR121W",297).
component("YDL102W",261).
component("YCR014C",239).
component("YBR278W",222).
component("YBL035C",173).
component("YKL035W",564).
component("YHL012W",456).
component("YHR123W",478).
component("YNL130C",704).
component("YPL148C",804).
component("YOR251C",778).
component("YGR286C",452).
component("YDR058C",292).
component("YOL011W",737).
component("YMR008C",667).
component("YMR006C",666).
component("U105_",25).
component("U101_",21).
component("YJL068C",515).
component("YPL072W",799).
component("YOR124C",762).
component("YNL186W",709).
component("YMR304W",693).
component("YMR223W",687).
component("YKR098C",601).
component("YJL197W",533).
component("YIL156W",503).
component("YFR010W",386).
component("YER151C",375).
component("YER144C",374).
component("YER098W",371).
component("YDR069C",293).
component("YDL122W",263).
component("YBR058C",195).
component("YBL067C",176).
component("YJR019C",541).
component("YDR272W",313).
component("U84_",157).
component("YDR481C",331).
component("YLR377C",646).
component("YDR074W",294).
component("YFR025C",389).
component("YPL179W",808).
component("YNR032W",729).
component("YML057W",658).
component("YML016C",654).
component("YLR433C",651).
component("YGR123C",429).
component("YER133W",373).
component("YER089C",368).
component("YDR436W",329).
component("YDR075W",295).
component("YDL188C",275).
component("YDL134C",265).
component("YDL047W",249).
component("YDL006W",243).
component("YBR125C",206).
component("YBL056W",175).
component("YPR073C",837).
component("YHR215W",489).
component("YDL024C",246).
component("YBR093C",202).
component("YBR092C",201).
component("YIL053W",494).
component("YER062C",361).
component("YHR046C",469).
component("U9_",166).
component("YGR208W",445).
component("YPL228W",814).
component("YMR180C",680).
component("YDL236W",278).
component("YJL155C",529).
component("U34_",116).
component("U33_",115).
component("U32_",114).
component("U30_",113).
...
component("U26_",108).
component("U24_",107).
component("YHR044C",468).
component("YHR043C",467).
component("YOL064C",747).
component("YPL268W",823).
component("YOR360C",789).
component("YGL248W",417).
component("YKR031C",593).
component("YGL027C",399).
component("YLR286C",634).
component("YJR153W",559).
component("YJL221C",537).
component("YJL216C",535).
component("YIL172C",509).
component("YGR292W",454).
component("YGR287C",453).
component("YBR299W",226).
component("YBR184W",213).
component("YIL162W",506).
component("YPR026W",831).
component("YDR001C",280).
component("YBR001C",180).
component("YDR400W",323).
component("U102_",22).
component("YER043C",353).
component("YNL045W",697).
component("YLR160C",622).
component("YLR158C",621).
component("YLR157C",620).
component("YLR155C",619).
component("YDR321W",318).
component("YGL037C",400).
component("U43_",125).
component("U42_",124).
component("YDR242W",311).
component("YLR308W",639).
component("YLR307W",638).
component("U53_",133).
component("YLR420W",649).
component("YPL111W",802).
component("YIR032C",511).
component("YLR028C",607).
component("YHR144C",481).
component("YHR144C",482).
component("YCL030C",231).
component("YNL141W",705).
component("YBR153W",210).
component("YDL238C",279).
component("YNL141W",706).
component("YML035C",655).
component("YGR204W",443).
component("YBR084W",199).
component("YJL126W",521).
component("U44_",126).
component("YDL100C",260).
component("U40_",122).
component("U39_",120).
...
component("YCL030C",232).
component("YER005W",350).
component("YBL099W",179).
component("YLR231C",629).
component("U88_",160).
component("YDR538W",339).
component("YLR134W",616).
component("YLR044C",609).
component("YGR087C",426).
component("YDR380W",321).
component("YDL080C",254).
component("YMR250W",688).
component("YKL184W",582).
component("YEL021W",341).
component("YNR043W",732).
component("U93_",164).
component("YDR047W",290).
component("YKL211C",587).
component("YKR097W",600).
component("YOL052C",740).
component("YGR170W",433).
component("YDR294C",314).
component("YEL046C",344).
component("YNR033W",730).
component("YPR006C",829).
component("YER065C",362).
component("YKL211C",588).
component("YER090W",369).
component("YDR127W",301).
component("YPL281C",827).
component("YOR393W",794).
component("YMR323W",694).
component("YHR174W",483).
component("YGR254W",448).
component("YPL262W",820).
component("YGL026C",398).
component("YGR155W",432).
component("YLR304C",637).
component("YJL200C",534).
component("YGL009C",395).
component("YNL316C",722).
component("YKL182W",580).
component("YPL212C",811).
component("YNL292W",720).
component("YGL063W",403).
component("YFL001W",378).
component("YOR278W",780).
component("YCR053W",242).
component("YDR127W",302).
component("YGL148W",407).
component("YIL168W",508).
component("YIL167W",507).
component("YCL064C",235).
component("YCL064C",236).
component("YHR018C",461).
component("YLR359W",645).
component("YFR055W",392).
component("YJL121C",520).
component("YBR019C",186).
component("YBR019C",187).
component("YDR050C",291).
component("YDR007W",281).
component("YOR095C",760).
component("YER003C",349).
component("YBR196C",214).
component("YGL001C",394).
component("YPL117C",803).
component("U14_",56).
component("YOL056W",743).
component("YKL152C",576).
component("YDL021W",244).
component("YMR105C",674).
component("YKL127W",571).
component("YEL058W",347).
component("YPR060C",835).
component("YHR072W",474).
component("YJL153C",528).
component("YGR264C",451).
component("YGR171C",434).
component("YHR011W",460).
component("YDR023W",284).
component("YPL104W",801).
component("YLL018C",602).
component("YPR081C",839).
component("YBR121C",205).
component("YHR020W",464).
component("YER087W",367).
component("YOL033W",739).
component("YGL245W",416).
component("YOR168W",767).
component("YHR091C",476).
component("YDR341C",319).
component("YOL097C",750).
component("YDR268W",312).
component("YPR047W",834).
component("YLR060W",611).
component("YFL022C",382).
component("YPR033C",832).
component("YHR019C",462).
component("YHR019C",463).
component("YKL194C",585).
component("YIL078W",497).
component("YPL160W",805).
component("YLR382C",647).
component("YPL040C",798).
component("YBL076C",178).
component("YNL073W",700).
component("YDR037W",286).
component("YOR335C",785).
component("YGR094W",427).
component("YGR244C",447).
component("YPR035W",833).
component("YIL145C",501).
component("U89_",161).
component("YOR241W",777).
component("YMR113W",676).
component("YKL132C",572).
component("YJL101C",519).
component("YGL234W",414).
component("YER183C",377).
component("U90_",163).
component("YNR057C",733).
component("YDL141W",267).
component("YDL141W",268).
component("YGL234W",415).
component("YDL141W",269).
component("YGR204W",444).
component("YOL058W",744).
component("YDL141W",270).
component("YHR074W",475).
component("YMR217W",685).
component("YPR145W",843).
component("YGR124W",430).
component("YOR303W",781).
component("YJR109C",553).
component("YJL130C",524).
component("YGL062W",402).
component("YBR218C",215).
component("YPL231W",818).
component("YNR016C",727).
component("YKL182W",581).
component("YGR037C",422).
component("YOR005C",756).
component("YDL164C",272).
component("YJL087C",516).
component("YOL010W",736).
component("YPR138C",842).
component("YPL265W",821).
component("YOR348C",788).
component("YOR192C",770).
component("YOR171C",768).
component("YOR130C",763).
component("YOR071C",759).
component("YOR011W",757).
component("YOL156W",755).
component("YOL103W",751).
component("YOL020W",738).
component("YNL318C",723).
component("YNL270C",716).
component("YNL142W",707).
component("YMR272C",691).
component("YMR202W",682).
component("YMR056C",670).
component("YML123C",664).
component("YLR348C",642).
component("YLR260W",633).
component("YLR237W",630).
component("YLR138W",617).
component("YLR100C",614).
component("YLR092W",613).
component("YLR081W",612).
component("YLL061W",603).
component("YKR093W",599).
component("YKR053C",595).
component("YKR039W",594).
component("YKL217W",590).
component("YKL120W",570).
component("YKL004W",562).
component("YJR095W",550).
component("YJR077C",548).
component("YJL219W",536).
component("YJL134W",525).
component("YJL129C",522).
component("YHL036W",458).
component("YGR191W",437).
component("YGR125W",431).
component("YGR121C",428).
component("YGR065C",425).
component("YGR055W",424).
component("YGL186C",409).
component("YFL055W",385).
...
component("YDR046C",289).
component("YDL210W",276).
component("YCL025C",229).
component("YBR298C",225).
component("YBR294W",224).
component("YBR291C",223).
component("YBR085W",200).
component("YBR069C",197).
component("YBR068C",196).
component("YBL042C",174).
component("YBL030C",172).
component("U85_",158).
component("U7_",153).
component("U79_",152).
component("U75_",150).
