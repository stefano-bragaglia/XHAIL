...
component("YNL280C",623).
component("YLR056W",522).
component("YKR009C",506).
component("YMR083W",580).
component("YPL231W",706).
component("YBR149W",175).
component("YBR149W",176).
component("YJR159W",480).
component("YGL001C",332).
component("YHR063C",400).
component("YML056C",565).
component("YLR432W",559).
component("YHR216W",417).
component("YAR075W",144).
component("YAR073W",143).
component("YCL030C",194).
component("YDR127W",251).
component("YJR139C",476).
component("YOR136W",661).
component("YNL009W",602).
component("YLR174W",535).
component("YDL066W",211).
component("YHR183W",412).
component("YGR256W",382).
component("YNL241C",617).
component("YOL059W",646).
component("YDL022W",206).
component("YCL018W",192).
component("YLR355C",553).
component("YIL074C",423).
component("YER081W",306).
component("YML054C",564).
component("YIL155C",428).
component("YEL024W",287).
component("YJR078W",471).
component("U58_",114).
component("YGR255C",381).
component("U108_",26).
component("YMR015C",577).
component("YDR402C",270).
component("YGL055W",339).
component("YJL026W",438).
component("YIL066C",422).
component("YGR180C",371).
component("YER070W",304).
component("U36_",99).
component("U35_",98).
component("YJR009C",461).
component("YJL052W",439).
component("YGR192C",373).
component("YOR374W",684).
component("YER073W",305).
component("U68_",120).
component("YGL154C",346).
component("U55_",112).
component("YER069W",303).
component("YOR323C",677).
component("U2_",93).
...
component("YDR044W",241).
component("YER014W",292).
component("YKR009C",507).
component("YIL160C",430).
component("YGL205W",351).
component("YKL141W",490).
component("YJR051W",466).
component("YOR375C",685).
component("YDL215C",233).
component("YAL062W",142).
component("U100_",20).
component("YBR035C",161).
component("YMR189W",588).
component("U56_",113).
component("YKR080W",512).
component("YPL023C",689).
component("YGL125W",343).
component("YOR236W",672).
component("YGR204W",376).
component("YBR084W",167).
component("YLR142W",529).
component("U65_",118).
component("U62_",116).
component("YHR068W",401).
component("YKL150W",492).
component("YIL043C",420).
component("YHR042W",395).
component("YOR221C",670).
component("YMR145C",585).
component("YML120C",570).
component("YKL192C",499).
component("YKL055C",483).
component("YER061C",299).
component("YDL085W",214).
component("YBR046C",163).
component("YMR145C",586).
component("YML120C",571).
component("YKL192C",500).
component("YDL085W",215).
component("YPL017C",688).
component("YFL018C",321).
component("YPL091W",692).
component("YER042W",293).
component("YPR167C",733).
component("YNL052W",604).
component("YMR256C",596).
component("YLR395C",557).
component("YLR038C",520).
component("YIL111W",425).
component("YHR051W",399).
component("YGL191W",349).
component("YGL187C",348).
component("YDL067C",212).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",713).
component("YBR034C",160).
component("YPL273W",715).
component("YLL062C",517).
component("YDR410C",272).
component("YKR069W",511).
component("U47_",106).
component("YER091C",310).
component("YJR073C",469).
component("YDL033C",207).
component("YOL096C",649).
component("YLR172C",534).
component("YMR120C",584).
component("YBL013W",145).
component("YJL130C",447).
component("YJL088W",442).
component("YPR074C",726).
component("YBR117C",171).
component("YLR354C",552).
component("YGR043C",359).
component("YMR108W",582).
component("YCL009C",191).
component("YMR062C",579).
component("YNL071W",605).
component("YIL160C",431).
component("YNR019W",633).
component("YCR048W",203).
component("U48_",107).
component("YNL277W",622).
component("YFL017C",320).
component("YPL231W",707).
component("YER061C",300).
component("U86_",134).
component("YDL052C",209).
component("U8_",137).
component("YDR148C",257).
component("YOR377W",686).
component("YGR177C",370).
component("YPL231W",708).
component("YLR195C",537).
component("YLR299W",544).
component("YPR001W",717).
component("YNR001C",629).
component("YCR005C",199).
component("YML126C",573).
component("YDL182W",230).
component("YDL131W",222).
component("YNL117W",609).
component("YIR031C",436).
component("YPR160W",732).
component("YOR321W",676).
component("YJR143C",477).
component("YGR199W",375).
component("YDL095W",217).
component("YDL093W",216).
component("YAL023C",141).
component("YPL227C",704).
component("YMR261C",597).
component("YML100W",569).
component("YBR126C",174).
component("YNL192W",616).
component("YBR038W",162).
component("YBR023C",158).
component("YEL011W",285).
component("YLR209C",538).
component("U104_",24).
component("U103_",23).
component("YOR209C",668).
component("YMR300C",599).
component("YDR354W",266).
component("YFR047C",329).
component("YJR133W",475).
component("U22_",88).
component("YLR209C",539).
component("YDR399W",268).
component("YJL167W",454).
component("YNL256W",619).
component("YPR069C",725).
component("YDR127W",252).
component("YHR190W",413).
component("YHR068W",402).
component("YLR303W",545).
component("YML082W",568).
component("YJR130C",474).
component("YDR035W",239).
component("YBR249C",184).
component("YLR180W",536).
component("YDR502C",278).
component("YOL143C",654).
component("YBR256C",186).
component("YHR137W",407).
component("YGL202W",350).
component("YLR027C",518).
component("YKL106W",486).
component("YOL140W",653).
component("YLR438W",561).
component("YKL104C",485).
component("YGR019W",357).
component("YDR111C",249).
component("U64_",117).
component("U51_",110).
component("YJR148W",478).
component("YHR208W",416).
component("YOR184W",666).
component("YNR058W",638).
component("YGL253W",356).
component("YFR053C",330).
component("YMR013C",576).
component("YMR205C",590).
component("YGR240C",379).
component("YLR240W",541).
component("YKL203C",502).
component("YJR066W",468).
component("YCR036W",202).
component("YGR194C",374).
component("YCL040W",196).
component("YJR105W",473).
component("U16_",58).
component("YPL188W",700).
component("YJR049C",465).
component("YEL041W",288).
component("YKL001C",481).
component("YML070W",567).
component("YFL053W",324).
component("YDR531W",282).
component("U82_",131).
component("U81_",130).
component("YMR208W",591).
component("YPL203W",701).
component("YOR061W",656).
component("YKL166C",494).
component("YJL164C",453).
component("YIL035C",419).
component("YHR205W",415).
component("YHR102W",405).
component("YGL019W",335).
component("YHR025W",394).
component("YNR012W",631).
component("YPR121W",729).
component("YPL258C",710).
component("YOL055C",644).
component("YPL214C",703).
component("U1_",75).
component("YDR009W",237).
component("YBR020W",157).
component("YFR019W",327).
component("YDR208W",259).
component("YDR127W",253).
component("U21_",84).
component("U20_",80).
component("YDR147W",256).
component("YDR300C",264).
component("YCR012W",200).
component("YER052C",295).
component("U19_",74).
component("U18_",68).
component("U17_",63).
component("U76_",127).
component("YMR220W",593).
component("YER170W",316).
component("YDR226W",260).
component("YKL067W",484).
component("YOL055C",645).
component("YDR454C",275).
component("YOL061W",647).
component("YKL181W",495).
component("YHL011C",387).
component("YER099C",312).
component("YBL068W",151).
component("YOR143C",662).
component("YNL256W",620).
component("YLR328W",549).
component("YBR018C",155).
component("YDL055C",210).
component("YLR328W",550).
component("YDL103C",220).
component("U94_",139).
component("YJR010W",462).
component("YBR029C",159).
component("YGL130W",344).
component("YDR530C",281).
component("YPR190C",736).
component("YPR187W",735).
component("YPR110C",728).
component("YPR010C",719).
component("YOR341W",681).
component("YOR340C",680).
component("YOR224C",671).
component("YOR210W",669).
component("YOR207C",667).
component("YOR151C",663).
component("YOR116C",658).
component("YOL005C",639).
component("YNR003C",630).
component("YNL248C",618).
component("YNL151C",614).
component("YNL113W",608).
component("YKL144C",491).
component("YJR063W",467).
component("YJL148W",450).
component("YJL140W",449).
component("YIL021W",418).
component("YHR143W-A",408).
component("YGL070C",342).
component("YFL036W",323).
component("YDR404C",271).
component("YDR156W",258).
component("YDR045C",242).
component("YDL150W",229).
component("YDL140C",224).
component("YBR154C",178).
component("YPR175W",734).
component("YPL167C",698).
component("YOR330C",678).
component("YOL115W",652).
component("YNL299W",626).
component("YNL262W",621).
component("YNL102W",607).
component("YJR043C",464).
component("YJR006W",460).
component("YJL090C",443).
component("YIL139C",426).
component("YEL055C",289).
component("YDR419W",273).
component("YDR121W",250).
component("YDL102W",219).
component("YCR014C",201).
component("YBR278W",187).
component("YBL035C",147).
component("YKL035W",482).
component("YHL012W",388).
component("YHR123W",406).
component("YNL130C",610).
component("YPL148C",696).
component("YOR251C",674).
component("YGR286C",384).
component("YDR058C",245).
component("YOL011W",641).
component("YMR008C",575).
component("YMR006C",574).
component("U105_",25).
component("U101_",21).
component("YJL068C",440).
component("YPL072W",691).
component("YOR124C",659).
component("YNL186W",615).
component("YMR304W",600).
component("YMR223W",594).
component("YKR098C",514).
component("YJL197W",455).
component("YIL156W",429).
component("YFR010W",326).
component("YER151C",315).
component("YER144C",314).
component("YER098W",311).
component("YDR069C",246).
component("YDL122W",221).
component("YBR058C",164).
component("YBL067C",150).
component("YJR019C",463).
component("U84_",132).
component("YDR481C",276).
component("YLR377C",555).
component("YDR074W",247).
component("YFR025C",328).
component("YPL179W",699).
component("YNR032W",634).
component("YML057W",566).
component("YML016C",562).
component("YLR433C",560).
component("YGR123C",365).
component("YER133W",313).
component("YER089C",308).
component("YDR436W",274).
component("YDR075W",248).
component("YDL188C",231).
component("YDL134C",223).
component("YDL047W",208).
component("YDL006W",205).
component("YBR125C",173).
component("YBL056W",149).
component("YIL053W",421).
component("YER062C",301).
component("YHR046C",398).
component("U9_",140).
component("YGR208W",378).
component("YPL228W",705).
component("YMR180C",587).
component("YJL155C",452).
component("U34_",97).
component("U33_",96).
component("U32_",95).
component("U30_",94).
...
component("U26_",90).
component("U24_",89).
component("YHR044C",397).
component("YHR043C",396).
component("YOL064C",648).
component("YPL268W",714).
component("YOR360C",683).
component("YGL248W",355).
component("YKR031C",508).
component("YGL027C",337).
component("YLR286C",543).
component("YJR153W",479).
component("YJL221C",459).
component("YJL216C",457).
component("YIL172C",435).
component("YGR292W",386).
component("YGR287C",385).
component("YBR299W",190).
component("YBR184W",180).
component("YIL162W",432).
component("YPR026W",720).
component("YDR001C",235).
component("YBR001C",154).
component("YDR400W",269).
component("U102_",22).
component("YER043C",294).
component("YNL045W",603).
component("YLR160C",533).
component("YLR158C",532).
component("YLR157C",531).
component("YLR155C",530).
component("YDR321W",265).
component("YGL037C",338).
component("U43_",104).
component("U42_",103).
component("YLR308W",548).
component("YLR307W",547).
component("U53_",111).
component("YLR420W",558).
component("YPL111W",694).
component("YIR032C",437).
component("YLR028C",519).
component("YHR144C",409).
component("YHR144C",410).
component("YNL141W",611).
component("YBR153W",177).
component("YDL238C",234).
component("YNL141W",612).
component("YML035C",563).
...
component("YCL030C",195).
component("YER005W",291).
component("YBL099W",153).
component("YLR231C",540).
component("U88_",135).
component("YDR538W",284).
component("YLR134W",527).
component("YLR044C",521).
component("YGR087C",362).
component("YDR380W",267).
component("YDL080C",213).
component("YMR250W",595).
component("YKL184W",498).
component("YEL021W",286).
component("YNR043W",636).
component("YDR047W",244).
component("YKL211C",503).
component("YKR097W",513).
component("YOL052C",643).
component("YDR294C",261).
component("YNR033W",635).
component("YPR006C",718).
component("YER065C",302).
component("YKL211C",504).
component("YER090W",309).
component("YDR127W",254).
component("YPL281C",716).
component("YOR393W",687).
component("YMR323W",601).
component("YHR174W",411).
component("YGR254W",380).
component("YPL262W",711).
component("YGL026C",336).
component("YGR155W",368).
component("YLR304C",546).
component("YJL200C",456).
component("YNL316C",627).
component("YPL212C",702).
component("YNL292W",625).
component("YGL063W",341).
component("YFL001W",318).
component("YCR053W",204).
component("YDR127W",255).
component("YGL148W",345).
component("YIL168W",434).
component("YIL167W",433).
component("YCL064C",197).
component("YCL064C",198).
component("YHR018C",391).
component("YLR359W",554).
component("YFR055W",331).
component("YJL121C",444).
component("YBR019C",156).
component("YDR007W",236).
component("YOR095C",657).
component("YBR196C",181).
component("YGL001C",333).
component("YPL117C",695).
component("U14_",48).
component("YKL152C",493).
component("YMR105C",581).
component("YKL127W",488).
component("YEL058W",290).
component("YPR060C",724).
component("YHR072W",403).
component("YJL153C",451).
component("YGR264C",383).
component("YGR171C",369).
component("YHR011W",390).
component("YDR023W",238).
component("YPL104W",693).
component("YLL018C",515).
component("YPR081C",727).
component("YBR121C",172).
component("YHR020W",393).
component("YER087W",307).
component("YGL245W",354).
component("YOR168W",664).
component("YOL097C",650).
component("YPR047W",723).
component("YLR060W",523).
component("YFL022C",322).
component("YPR033C",721).
component("YHR019C",392).
component("YKL194C",501).
component("YIL078W",424).
component("YPL160W",697).
component("YLR382C",556).
component("YPL040C",690).
component("YBL076C",152).
component("YNL073W",606).
component("YDR037W",240).
component("YOR335C",679).
component("YGR094W",363).
component("YPR035W",722).
component("YIL145C",427).
component("U89_",136).
component("YOR241W",673).
component("YMR113W",583).
component("YKL132C",489).
component("YGL234W",352).
component("YER183C",317).
component("U90_",138).
component("YNR057C",637).
component("YDL141W",225).
component("YDL141W",226).
component("YGL234W",353).
component("YDL141W",227).
component("YGR204W",377).
component("YDL141W",228).
component("YHR074W",404).
component("YMR217W",592).
component("YPR145W",731).
component("YGR124W",366).
component("YOR303W",675).
component("YGL062W",340).
component("YBR218C",182).
component("YPL231W",709).
component("YNR016C",632).
component("YKL182W",497).
component("YGR037C",358).
component("YJL087C",441).
component("YOL010W",640).
component("YPR138C",730).
component("YPL265W",712).
component("YOR348C",682).
component("YOR171C",665).
component("YOR130C",660).
component("YOL156W",655).
component("YOL103W",651).
component("YOL020W",642).
component("YNL318C",628).
component("YNL142W",613).
component("YMR272C",598).
component("YMR202W",589).
component("YMR056C",578).
component("YML123C",572).
component("YLR348C",551).
component("YLR260W",542).
component("YLR138W",528).
component("YLR100C",526).
component("YLR092W",525).
component("YLR081W",524).
component("YLL061W",516).
component("YKR053C",510).
component("YKR039W",509).
component("YKL217W",505).
component("YKL120W",487).
component("YJR095W",472).
component("YJR077C",470).
component("YJL219W",458).
component("YJL134W",448).
component("YJL129C",446).
component("YHL036W",389).
component("YGR191W",372).
component("YGR125W",367).
component("YGR121C",364).
component("YGR065C",361).
component("YGR055W",360).
component("YGL186C",347).
component("YFL055W",325).
component("YFL011W",319).
...
component("YDR297W",263).
component("YDR294C",262).
component("YDR046C",243).
component("YDL210W",232).
component("YCL025C",193).
component("YBR294W",189).
component("YBR291C",188).
component("YBR085W",169).
component("YBR069C",166).
component("YBR068C",165).
component("YBL042C",148).
component("YBL030C",146).
component("U85_",133).
component("U7_",129).
component("U79_",128).
component("U75_",126).
