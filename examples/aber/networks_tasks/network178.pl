...
component("YLR056W",763).
component("YGR060W",535).
component("YKR009C",742).
component("YMR083W",844).
component("YPL231W",1021).
component("U46_",160).
component("YBR149W",266).
component("YBR149W",267).
component("YJR159W",705).
component("YGL001C",499).
component("YHR063C",594).
component("U45_",159).
component("YBR153W",268).
component("YML056C",824).
component("YLR432W",812).
component("YHR216W",619).
component("YAR075W",220).
component("YAR073W",219).
component("YCL030C",293).
component("YDR127W",379).
component("YJR139C",700).
component("YML075C",827).
component("YLR450W",815).
component("YOL126C",941).
component("YKL085W",715).
component("YDL078C",325).
component("YKL029C",710).
component("YOR136W",960).
component("YNL037C",877).
component("YNL009W",875).
component("YLR174W",781).
component("YDL066W",323).
component("YHR183W",613).
component("YGR256W",569).
component("YNL241C",893).
component("YOL059W",933).
component("YDL022W",314).
component("YCL018W",291).
component("YLR355C",806).
...
component("YOR065W",950).
component("YJL166W",671).
component("YHR001W-A",580).
component("YGR183C",552).
component("YFR033C",495).
component("YEL024W",436).
component("YDR529C",426).
component("YBL045C",227).
component("Q0105",19).
component("YKR066C",747).
component("YKL026C",709).
component("YIR037W",647).
component("YBR244W",279).
component("YJR078W",691).
component("U58_",172).
component("U107_",29).
component("YGR255C",568).
component("U108_",30).
component("YBL098W",232).
component("YMR015C",840).
component("YHR007C",581).
component("YDR402C",413).
component("YGL055W",509).
component("YGR175C",549).
component("YJR104C",694).
component("YHR008C",582).
component("YJL026W",650).
component("YIL066C",625).
component("YGR180C",551).
component("YER070W",464).
component("U37_",151).
component("U36_",150).
component("U35_",149).
component("YDR158W",387).
component("YJR009C",681).
component("YJL052W",652).
component("YGR192C",555).
component("YBR006W",237).
component("YPL276W",1032).
component("YPL275W",1031).
component("YOR388C",994).
component("YOR374W",991).
component("YER073W",465).
component("U68_",183).
component("YGL154C",517).
component("YBR115C",261).
component("U55_",169).
component("YER069W",462).
component("YOR323C",981).
component("U2_",143).
component("YER178W",478).
component("YBR221C",277).
component("YIL125W",632).
component("YBR166C",271).
component("YNL280C",903).
component("YGL012W",503).
component("YKL182W",728).
component("U57_",171).
component("YKL216W",739).
component("YDR044W",365).
component("YER014W",447).
component("YKR009C",743).
component("YIL160C",638).
component("YGL205W",522).
component("YMR118C",849).
component("YLR164W",779).
component("YLL041C",754).
component("YKL148C",723).
component("YKL141W",721).
component("YJL045W",651).
component("YDR178W",389).
component("YJR051W",686).
component("YEL047C",440).
component("YDL171C",347).
component("YDL215C",352).
component("YOR375C",992).
component("YDL215C",353).
component("YAL062W",217).
component("U99_",211).
component("U100_",22).
component("YBR035C",247).
component("YMR189W",856).
component("U56_",170).
component("YNR050C",918).
component("YKR080W",749).
component("YER023W",448).
component("YPL023C",998).
component("YGL125W",514).
component("YOR236W",974).
component("YGR204W",559).
component("YBR084W",255).
component("YLR142W",772).
component("U65_",180).
component("U63_",178).
component("U62_",177).
component("YOR356W",989).
component("YHR068W",595).
component("YKL150W",724).
component("YIL043C",623).
component("YHR042W",589).
component("YOR221C",972).
component("YMR145C",852).
component("YML120C",832).
component("YKL192C",732).
component("YKL055C",712).
component("YER061C",458).
component("YDL085W",327).
component("YBR046C",250).
component("YMR145C",853).
component("YML120C",833).
component("YKL192C",733).
component("YDL085W",328).
component("YGR234W",563).
component("YFR030W",494).
component("YPL017C",997).
component("YFL018C",483).
component("YPL091W",1004).
component("YHR106W",604).
component("YDR353W",408).
component("YER042W",450).
component("YPR167C",1053).
component("YJR137C",699).
component("YNL052W",879).
component("YMR256C",864).
component("YLR395C",810).
component("YLR038C",761).
component("YIL111W",630).
component("YHR051W",593).
component("YGL191W",520).
component("YGL187C",519).
component("YDL067C",324).
component("Q0275",21).
component("Q0250",20).
component("Q0045",18).
component("YPL266W",1028).
component("YML110C",831).
component("YBR034C",246).
component("YPL273W",1030).
component("YLL062C",757).
component("YDR410C",416).
component("YKR069W",748).
component("YOL096C",936).
component("U47_",161).
component("YER091C",470).
component("YJR073C",689).
component("YGR157W",546).
component("YML008C",816).
component("YDL033C",316).
component("YOL096C",937).
component("YLR172C",780).
component("YLR058C",764).
component("YBR263W",283).
component("YDR019C",361).
component("YBR176W",272).
component("YDR408C",415).
component("YMR120C",850).
component("YLR028C",759).
component("YBL013W",221).
component("YJL130C",663).
component("YJL088W",657).
component("YKL024C",708).
component("YPR074C",1045).
component("YBR117C",262).
component("YLR354C",805).
component("YGR043C",533).
component("YMR108W",847).
component("YCL009C",290).
component("YMR062C",843).
component("YNL071W",880).
component("YIL160C",639).
component("YNR019W",912).
component("YCR048W",309).
component("U48_",162).
component("YNL277W",901).
component("YDR232W",392).
component("YFL017C",482).
component("YPL231W",1022).
component("YER061C",459).
component("U86_",201).
component("YPL001W",996).
component("YDL052C",320).
component("U8_",204).
component("YDR148C",385).
component("YML042W",822).
component("YOR377W",993).
component("YGR177C",550).
component("YPL231W",1023).
component("YGR147C",544).
component("YDL040C",317).
component("YPL028W",999).
component("YLR195C",783).
component("YLR299W",793).
component("YGL017W",504).
component("YPR001W",1034).
component("YNR001C",908).
component("YCR005C",302).
component("YML126C",835).
component("YDL182W",349).
component("YDL131W",337).
component("YNL117W",884).
component("YIR031C",645).
component("YPR160W",1052).
component("YOR321W",980).
component("YJR143C",701).
component("YGR199W",557).
component("YDL095W",332).
component("YDL093W",331).
component("YAL023C",214).
component("YLR258W",790).
component("YFR015C",491).
component("YPL227C",1019).
component("YOR103C",955).
component("YOR085W",952).
component("YMR149W",854).
component("YML019W",818).
component("YJL002C",648).
component("YEL002C",431).
component("YDL232W",354).
component("YCL043C",297).
component("YNL029C",876).
component("YIL085C",628).
component("YMR261C",865).
component("YML100W",829).
component("YBR126C",265).
component("YNL192W",891).
component("YBR038W",249).
component("YBR023C",244).
component("YEL011W",432).
component("YMR306W",873).
component("YLR342W",803).
component("YGR032W",531).
component("YPR183W",1056).
component("YLR209C",784).
component("U104_",26).
component("U103_",25).
component("YMR271C",866).
component("YML106W",830).
component("YOR209C",970).
component("YMR300C",871).
component("YER055C",454).
component("YDR354W",409).
component("YFR047C",496).
component("YJR133W",698).
component("U22_",137).
component("YLR209C",785).
component("YML022W",819).
component("YDR441C",419).
component("YDR399W",411).
component("YHR128W",606).
component("YPR176C",1055).
component("YPL172C",1012).
component("YNR041C",916).
component("YMR101C",845).
...
component("YLR146C",773).
component("YHR068W",596).
component("YLR303W",795).
component("YGR012W",529).
component("YML082W",828).
component("YJR130C",697).
component("YDR035W",363).
component("YBR249C",280).
component("YLR180W",782).
component("YDR502C",423).
component("YOR274W",977).
component("YOL143C",944).
component("YBR256C",282).
component("YHR137W",607).
component("YGL202W",521).
component("YLR027C",758).
component("YKL106W",717).
component("YOL140W",943).
component("YLR438W",814).
component("YKL104C",716).
component("YGR019W",530).
component("YDR111C",377).
component("U64_",179).
component("U61_",176).
component("U51_",166).
component("YJR148W",702).
component("YHR208W",617).
component("YFL030W",485).
component("YOR184W",966).
component("YNR058W",920).
component("YIL116W",631).
component("YGL253W",527).
component("YFR053C",497).
component("YOL136C",942).
component("YIL107C",629).
component("YMR013C",839).
component("YMR205C",858).
component("YGR240C",564).
component("YOL016C",925).
component("YFR014C",490).
component("YLR240W",788).
component("YKL203C",735).
component("YJR066W",688).
component("YCR036W",308).
component("YGR194C",556).
component("YCL040W",296).
component("YJR105W",695).
component("U16_",84).
component("YPL188W",1014).
component("YJR049C",685).
component("YEL041W",437).
component("U96_",209).
component("YKL001C",706).
component("YDR236C",393).
component("YML070W",826).
component("YFL053W",487).
component("YHL032C",578).
component("YLR133W",769).
component("YDR531W",428).
component("U83_",198).
component("U82_",197).
component("U81_",196).
component("YMR208W",859).
component("YPL203W",1015).
component("YOR061W",949).
component("YKL166C",726).
component("YJL164C",670).
component("YIL035C",622).
component("YHR205W",616).
component("YHR102W",603).
component("YGL019W",505).
component("YHR025W",588).
component("YOR347C",987).
component("YAL038W",215).
component("YNR012W",910).
component("YPR121W",1049).
component("YPL258C",1025).
component("YOL055C",929).
component("YPL214C",1018).
component("U1_",115).
component("YDR009W",360).
component("YBR020W",243).
component("YNL267W",899).
component("YLR305C",797).
component("YFR019W",492).
component("YDR208W",390).
component("YDR127W",381).
component("U21_",128).
component("U20_",123).
component("YDR147W",384).
component("YDR300C",402).
component("YCR012W",303).
component("YER052C",452).
component("YER069W",463).
component("U19_",114).
component("U18_",104).
component("U17_",93).
component("U76_",192).
component("YMR220W",861).
component("YER170W",477).
component("YDR226W",391).
component("YKL067W",714).
component("YOL055C",930).
component("YDR454C",420).
component("YOL061W",934).
component("YKL181W",727).
component("YHL011C",575).
component("YER099C",472).
component("YBL068W",230).
component("YOR143C",961).
component("YNL256W",897).
component("YLR328W",801).
component("YBR018C",239).
component("YBR018C",240).
component("YDL055C",321).
component("YGR007W",528).
component("YGR202C",558).
component("YLR328W",802).
component("YKR002W",741).
component("YDL045C",318).
component("YDL103C",335).
component("U94_",208).
component("YJR010W",682).
component("YBR029C",245).
component("YCL050C",298).
component("YGL130W",515).
...
component("YOR341W",986).
component("YOR340C",985).
component("YOR224C",973).
component("YOR210W",971).
component("YOR207C",969).
component("YOR151C",962).
component("YOR116C",956).
component("YOL005C",922).
component("YNR003C",909).
component("YNL248C",895).
component("YNL151C",889).
component("YNL113W",883).
component("YKL144C",722).
component("YJR063W",687).
component("YJL148W",667).
component("YJL140W",666).
component("YIL021W",621).
component("YHR143W-A",608).
component("YGL070C",513).
component("YFL036W",486).
component("YDR404C",414).
component("YDR156W",386).
component("YDR045C",366).
component("YDL150W",345).
component("YDL140C",339).
component("YBR154C",270).
component("YPR175W",1054).
component("YPL167C",1011).
component("YOR330C",982).
component("YOL115W",940).
component("YNL299W",905).
component("YNL262W",898).
component("YNL102W",882).
component("YJR043C",684).
component("YJR006W",680).
component("YJL090C",658).
component("YIL139C",634).
component("YEL055C",441).
component("YDR419W",417).
component("YDR121W",378).
component("YDL102W",334).
component("YCR014C",304).
component("YBR278W",284).
component("YBL035C",224).
component("YKL035W",711).
component("YHL012W",576).
component("YHR123W",605).
component("YPR113W",1048).
component("YBR243C",278).
component("YNL130C",885).
component("YDL142C",344).
component("YPL148C",1009).
component("YER026C",449).
component("YOR251C",976).
component("YGR286C",572).
component("YJL068C",653).
component("YDR058C",371).
component("YNR034W",915).
component("YHR163W",611).
component("YGR248W",566).
component("YCR073W-A",311).
component("YDL086W",329).
component("YOL011W",924).
component("YMR008C",837).
component("YMR006C",836).
component("U105_",27).
component("U101_",23).
component("YJL068C",654).
component("YPL072W",1003).
component("YOR124C",957).
component("YNL186W",890).
component("YMR304W",872).
component("YMR223W",862).
component("YKR098C",752).
component("YJL197W",674).
component("YIL156W",637).
component("YFR010W",489).
component("YER151C",476).
component("YER144C",475).
component("YER098W",471).
component("YDR069C",373).
component("YDL122W",336).
component("YBR058C",251).
component("YBL067C",229).
component("YJR019C",683).
component("YOR040W",948).
component("YDR272W",397).
component("U84_",199).
component("YDR481C",421).
component("YLR377C",808).
component("YDR074W",374).
component("YFR025C",493).
component("YPL179W",1013).
component("YNR032W",913).
component("YML057W",825).
component("YML016C",817).
component("YLR433C",813).
component("YGR123C",540).
component("YER133W",474).
component("YER089C",468).
component("YDR436W",418).
component("YDR075W",375).
...
component("YBR093C",259).
component("YBR092C",258).
component("YIL053W",624).
component("YER062C",460).
component("YHR046C",592).
component("U9_",212).
component("YGR208W",562).
component("YPL228W",1020).
component("YMR180C",855).
component("YDL236W",355).
component("YJL155C",669).
component("U34_",148).
component("U33_",147).
component("U32_",146).
component("U31_",145).
...
component("YPL268W",1029).
component("YOR360C",990).
component("YGL248W",526).
component("YKR031C",744).
component("YPL206C",1016).
component("YGL027C",507).
component("YLR286C",792).
component("YJR153W",703).
component("YJL221C",679).
component("YJL216C",677).
component("YIL172C",643).
component("YGR292W",574).
component("YGR287C",573).
component("YBR299W",289).
component("YBR184W",273).
component("YIL162W",640).
component("YPR026W",1037).
component("YDR001C",358).
component("YBR001C",234).
component("YOR190W",967).
component("YLR300W",794).
component("YGR282C",571).
component("YDR261C",395).
component("YDR400W",412).
component("YML035C",820).
component("YJL070C",655).
component("YBR284W",285).
component("U106_",28).
component("U102_",24).
component("YER043C",451).
component("YNL045W",878).
component("YLR160C",778).
component("YLR158C",777).
component("YLR157C",776).
component("YLR155C",775).
component("YDR321W",403).
component("YGL037C",508).
component("U43_",157).
component("U42_",156).
component("YMR293C",870).
component("YDR242W",394).
component("YLR308W",800).
component("YLR307W",799).
component("YBR208C",275).
component("YMR281W",869).
component("U53_",167).
component("YLR420W",811).
component("YPL111W",1007).
component("YIR032C",646).
component("YIR029W",644).
component("YPR062W",1042).
component("YMR120C",851).
component("YLR028C",760).
component("YHR144C",609).
component("YHR144C",610).
component("YCL030C",294).
component("YNL141W",886).
component("YBL033C",223).
component("YBR153W",269).
component("YDL238C",356).
component("YNL141W",887).
component("YLR245C",789).
component("YML035C",821).
component("YGR204W",560).
component("YBR084W",256).
component("YJL126W",661).
component("U44_",158).
...
component("YBR111C",260).
component("YBR252W",281).
component("YCL030C",295).
component("YEL042W",438).
component("YER005W",446).
component("YBL099W",233).
component("U60_",175).
component("YLR231C",786).
component("U88_",202).
component("YDR538W",430).
component("YLR134W",770).
component("YLR044C",762).
component("YGR087C",537).
component("YDR380W",410).
component("YDL080C",326).
component("U98_",210).
component("YMR250W",863).
component("YKL184W",731).
component("YOR128C",958).
component("YEL021W",435).
component("YNR043W",917).
component("U93_",207).
component("YDR047W",368).
component("U54_",168).
component("YKL211C",737).
component("YKR097W",751).
component("YOL052C",928).
component("YGR170W",547).
component("YKL060C",713).
component("YDR294C",399).
component("YEL046C",439).
component("YNR033W",914).
component("YPR006C",1035).
component("YER065C",461).
component("YKL211C",738).
component("YER090W",469).
component("YDR127W",382).
component("YPL281C",1033).
component("YOR393W",995).
component("YMR323W",874).
component("YHR174W",612).
component("YGR254W",567).
component("YPL262W",1026).
component("YGL026C",506).
component("YGR155W",545).
component("YLR304C",796).
component("YJL200C",675).
component("YGL009C",502).
component("YNL316C",906).
component("YKL182W",729).
component("YPL212C",1017).
component("YNL292W",904).
component("YGL063W",512).
component("YFL001W",480).
component("YOR278W",978).
component("U49_",163).
component("YCR053W",310).
component("YDR127W",383).
component("YGL148W",516).
component("YIL168W",642).
component("YIL167W",641).
component("YCL064C",300).
component("YCL064C",301).
component("YHR018C",584).
component("YLR359W",807).
component("YAL012W",213).
component("YFR055W",498).
component("YJL005W",649).
component("YOR176W",965).
component("YJL121C",660).
component("YBR019C",241).
component("YBR019C",242).
component("U59_",173).
component("YDR050C",369).
component("YIL020C",620).
component("YDR007W",359).
component("YOR095C",953).
component("YER003C",445).
component("YBR196C",274).
component("YGL001C",500).
component("YPL117C",1008).
component("U14_",69).
component("YOL056W",931).
component("YKL152C",725).
component("YDL021W",313).
component("YMR105C",846).
component("YKL127W",719).
component("YEL058W",442).
component("YMR278W",868).
component("YPR060C",1041).
component("YHR072W",597).
component("YJL153C",668).
component("YPL097W",1005).
component("YGR185C",553).
component("YGR264C",570).
component("YGR171C",548).
component("YHR011W",583).
component("YDR023W",362).
component("YPL104W",1006).
component("YLL018C",753).
component("YPR081C",1046).
component("YBR121C",263).
component("YHR020W",587).
component("YER087W",467).
component("YNL247W",894).
component("YOL033W",927).
component("YGL245W",525).
component("YOR168W",963).
component("YHR091C",599).
component("YDR341C",404).
component("YOL097C",938).
component("YDR268W",396).
component("YPR047W",1040).
component("YLR060W",765).
component("YFL022C",484).
component("YPR033C",1038).
component("YHR019C",585).
component("YHR019C",586).
component("YKL194C",734).
component("YIL078W",627).
component("YPL160W",1010).
component("YLR382C",809).
component("YPL040C",1001).
component("YBL076C",231).
component("YNL073W",881).
component("YDR037W",364).
component("YOR335C",983).
component("YGR094W",538).
component("YLR153C",774).
component("YAL054C",216).
component("YGR244C",565).
component("YPR035W",1039).
component("YIL145C",635).
component("U89_",203).
component("YOR241W",975).
component("YMR113W",848).
component("YKL132C",720).
component("YOR339C",984).
component("YMR022W",841).
component("YLR306W",798).
component("YKL210W",736).
component("YGR133W",543).
component("YGL058W",510).
component("YER100W",473).
component("YEL012W",433).
component("YDR177W",388).
component("YDR092W",376).
...
component("YJR103W",693).
component("YBL039C",225).
component("YGR204W",561).
component("YNL220W",892).
component("YOL058W",932).
component("YDL141W",343).
component("YHR074W",598).
component("YMR217W",860).
component("YPR145W",1051).
component("YGR124W",541).
component("YOR303W",979).
component("YJR109C",696).
component("YJL130C",664).
component("YGL062W",511).
component("YBR218C",276).
component("YPL231W",1024).
component("YNR016C",911).
component("YKL182W",730).
component("YGR037C",532).
component("YOR005C",946).
component("YDL164C",346).
component("YJL087C",656).
component("YOL010W",923).
component("YPR138C",1050).
component("YPL265W",1027).
component("YPL057C",1002).
component("YPL036W",1000).
component("YOR348C",988).
component("YOR192C",968).
component("YOR171C",964).
component("YOR130C",959).
component("YOR100C",954).
component("YOR071C",951).
component("YOR011W",947).
component("YOL156W",945).
component("YOL103W",939).
component("YOL020W",926).
component("YNR072W",921).
component("YNL318C",907).
component("YNL270C",900).
component("YNL142W",888).
component("YMR272C",867).
component("YMR202W",857).
component("YMR056C",842).
component("YMR011W",838).
component("YML123C",834).
component("YLR348C",804).
component("YLR260W",791).
component("YLR237W",787).
component("YLR138W",771).
component("YLR100C",768).
component("YLR092W",767).
component("YLR081W",766).
component("YLL061W",756).
component("YLL043W",755).
component("YKR093W",750).
component("YKR053C",746).
component("YKR039W",745).
component("YKL217W",740).
component("YKL120W",718).
component("YKL004W",707).
component("YJR158W",704).
component("YJR095W",692).
component("YJR077C",690).
component("YJL219W",678).
component("YJL214W",676).
component("YJL134W",665).
component("YJL129C",662).
component("YIL134W",633).
component("YHR096C",602).
component("YHR094C",601).
component("YHR092C",600).
component("YHL036W",579).
component("YHL016C",577).
component("YGR191W",554).
component("YGR125W",542).
component("YGR121C",539).
component("YGR065C",536).
component("YGR055W",534).
component("YGL186C",518).
component("YGL008C",501).
component("YFL055W",488).
component("YFL011W",481).
component("YER060W-A",457).
component("YER060W",456).
component("YER056C",455).
component("YER053C",453).
component("YEL069C",444).
component("YEL063C",443).
component("YEL017C-A",434).
component("YDR536W",429).
component("YDR508C",425).
component("YDR503C",424).
component("YDR497C",422).
component("YDR345C",407).
component("YDR343C",406).
component("YDR342C",405).
component("YDR297W",401).
component("YDR294C",400).
component("YDR284C",398).
component("YDR046C",367).
component("YDL245C",357).
component("YDL210W",351).
component("YCR032W",307).
component("YCR028C",306).
component("YCR024C-A",305).
component("YCL025C",292).
component("YBR298C",288).
component("YBR294W",287).
component("YBR291C",286).
component("YBR085W",257).
component("YBR069C",253).
component("YBR068C",252).
component("YBR036C",248).
component("YBL042C",226).
component("YBL030C",222).
component("U85_",200).
component("U7_",195).
component("U79_",194).
component("U78_",193).
