...
component("YNL280C",230).
component("YLR056W",195).
component("YGL001C",130).
component("YDR127W",91).
component("YNL009W",222).
component("YLR174W",202).
component("YHR183W",160).
component("YGR256W",147).
component("YCL018W",66).
component("YJR078W",176).
component("YMR015C",213).
component("YDR402C",103).
component("YGL055W",133).
component("YJL026W",165).
component("YGR180C",144).
component("YOR323C",248).
component("YBR166C",62).
component("YNL280C",231).
component("YKL141W",183).
component("YOR375C",251).
component("YDL215C",84).
component("YAL062W",48).
component("U100_",18).
component("YPL023C",253).
component("YGL125W",134).
component("YMR145C",215).
component("YDL085W",76).
component("YBR046C",55).
component("YPL273W",261).
component("YLL062C",192).
component("YDR410C",104).
component("YJR073C",174).
component("YOL096C",242).
component("YJL088W",167).
component("YPR074C",266).
component("YBR117C",60).
component("YNL071W",223).
component("YNR019W",236).
component("YCR048W",72).
component("U48_",40).
component("YPL231W",257).
component("YDL052C",74).
component("U8_",46).
component("YPL231W",258).
component("YLR299W",204).
component("YCR005C",69).
component("YNL117W",225).
component("YIR031C",164).
component("YOR321W",247).
component("YJR143C",179).
component("YGR199W",145).
component("YDL095W",78).
component("YDL093W",77).
component("YAL023C",47).
component("YDR354W",100).
component("YFR047C",128).
component("U22_",34).
component("YDR399W",102).
component("YPR069C",265).
component("YDR127W",92).
component("YML082W",209).
component("YJR130C",178).
component("YDR035W",87).
component("YBR249C",64).
component("YHR137W",156).
component("YGL202W",137).
component("YLR027C",193).
component("YKL106W",181).
component("YLR438W",208).
component("U51_",41).
component("YMR013C",212).
component("YCR036W",71).
component("YCL040W",68).
component("YJR105W",177).
component("YMR208W",217).
component("YHR025W",152).
component("YNR012W",234).
component("YFR019W",126).
component("YDR208W",97).
component("YDR127W",93).
component("YDR147W",96).
component("YER052C",113).
component("U19_",30).
component("U76_",45).
component("YDR226W",98).
component("YDR454C",106).
component("YOL061W",241).
component("YKL181W",184).
component("YHL011C",149).
component("YER099C",119).
component("YBL068W",52).
component("YLR328W",207).
component("YBR029C",54).
component("YPR175W",269).
component("YPL167C",256).
component("YOR330C",249).
component("YOL115W",244).
component("YNL299W",232).
component("YNL262W",229).
component("YNL102W",224).
component("YJR043C",173).
component("YJR006W",172).
component("YJL090C",168).
component("YIL139C",162).
component("YEL055C",111).
component("YDR419W",105).
component("YDR121W",90).
component("YDL102W",79).
component("YCR014C",70).
component("YBR278W",65).
component("YBL035C",49).
component("YKL035W",180).
component("YHL012W",150).
component("YOL011W",239).
component("YMR008C",211).
component("YMR006C",210).
component("U105_",19).
component("YPL072W",255).
component("YOR124C",246).
component("YNL186W",228).
component("YMR304W",220).
component("YMR223W",218).
component("YKR098C",191).
component("YJL197W",171).
component("YIL156W",163).
component("YFR010W",125).
component("YER151C",121).
component("YER144C",120).
component("YER098W",118).
component("YDR069C",89).
component("YDL122W",80).
component("YBR058C",56).
component("YBL067C",51).
component("YFR025C",127).
component("U32_",36).
component("U30_",35).
component("YHR044C",154).
component("YHR043C",153).
component("YLR160C",201).
component("YLR158C",200).
component("YLR157C",199).
component("YLR155C",198).
component("YDR321W",99).
component("YGL037C",132).
component("U43_",38).
component("U42_",37).
component("YLR308W",206).
component("YLR307W",205).
component("U53_",42).
component("YHR144C",157).
component("YHR144C",158).
component("YBR153W",61).
component("YDL238C",85).
component("YNL141W",226).
component("U44_",39).
component("YHR201C",161).
component("YBR111C",59).
component("YER005W",112).
component("YLR231C",203).
component("YLR134W",197).
component("YLR044C",194).
component("YGR087C",140).
component("YDR380W",101).
component("YDL080C",75).
component("YMR250W",219).
component("YKL184W",186).
component("YEL021W",110).
component("YKL211C",187).
component("YNR033W",237).
component("YKL211C",188).
component("YER090W",117).
component("YDR127W",94).
component("YPL281C",262).
component("YOR393W",252).
component("YMR323W",221).
component("YHR174W",159).
component("YGR254W",146).
component("YGL026C",131).
component("YNL316C",233).
component("YCR053W",73).
component("YDR127W",95).
component("YGL148W",135).
component("YFR055W",129).
component("YDR007W",86).
component("YOR095C",245).
component("YBR196C",63).
component("YMR105C",214).
component("YKL127W",182).
component("YPR060C",264).
component("YHR072W",155).
component("YJL153C",170).
component("YGR264C",148).
component("YGR171C",143).
component("YGL245W",138).
component("YPR047W",263).
component("YLR060W",196).
component("YFL022C",123).
component("YHR019C",151).
component("YPL040C",254).
component("YBL076C",53).
component("YER183C",122).
component("YDL141W",81).
component("YDL141W",82).
component("YPR145W",268).
component("YGR124W",142).
component("YPL231W",259).
component("YNR016C",235).
component("YKL182W",185).
component("YGR037C",139).
component("YJL087C",166).
component("YOL010W",238).
component("YPR138C",267).
component("YPL265W",260).
component("YOR348C",250).
component("YOL103W",243).
component("YOL020W",240).
component("YNL142W",227).
component("YMR202W",216).
component("YKR053C",190).
component("YKR039W",189).
component("YJR077C",175).
component("YJL134W",169).
component("YGR121C",141).
component("YGL186C",136).
component("YFL055W",124).
...
component("YDR046C",88).
component("YDL210W",83).
component("YCL025C",67).
component("YBR069C",58).
component("YBR068C",57).
