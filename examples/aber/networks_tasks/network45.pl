...
component("YNL280C",333).
component("YLR056W",277).
component("YMR083W",306).
component("YPL231W",376).
component("YJR159W",255).
component("YGL001C",181).
component("YDR127W",132).
component("YJR139C",252).
component("YNL009W",321).
component("YLR174W",284).
component("YHR183W",220).
component("YGR256W",203).
component("YCL018W",96).
component("YJR078W",248).
component("YMR015C",303).
component("YDR402C",146).
component("YGL055W",185).
component("YJL026W",229).
component("YGR180C",200).
component("U68_",61).
component("U55_",58).
component("YER069W",164).
component("YOR323C",362).
component("YBR166C",89).
component("YNL280C",334).
component("YKL141W",260).
component("YOR375C",367).
component("YDL215C",122).
component("YAL062W",71).
component("U100_",20).
component("YMR189W",310).
component("U56_",59).
component("YPL023C",369).
component("YGL125W",187).
component("YOR236W",360).
component("YMR145C",309).
component("YDL085W",108).
component("YBR046C",79).
component("YPL091W",372).
component("YNL052W",322).
component("YMR256C",316).
component("YLR395C",294).
component("YLR038C",275).
component("YIL111W",225).
component("YHR051W",212).
component("YGL191W",191).
component("YGL187C",190).
component("YDL067C",106).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",381).
component("YLL062C",272).
component("YDR410C",148).
component("YER091C",166).
component("YJR073C",246).
component("YOL096C",347).
component("YMR120C",308).
component("YJL130C",234).
component("YJL088W",231).
component("YPR074C",387).
component("YBR117C",85).
component("YCL009C",95).
component("YMR062C",305).
component("YNL071W",323).
component("YNR019W",340).
component("YCR048W",103).
component("U48_",55).
component("YFL017C",172).
component("YPL231W",377).
component("YDL052C",105).
component("U8_",67).
component("YPL231W",378).
component("YLR299W",288).
component("YCR005C",100).
component("YML126C",299).
component("YDL182W",120).
component("YDL131W",113).
component("YNL117W",326).
component("YIR031C",228).
component("YOR321W",361).
component("YJR143C",253).
component("YGR199W",201).
component("YDL095W",110).
component("YDL093W",109).
component("YAL023C",70).
component("YMR261C",317).
component("YML100W",297).
component("YBR126C",86).
component("YLR209C",285).
component("YDR354W",143).
component("YFR047C",179).
component("YJR133W",251).
component("U22_",46).
component("YDR399W",145).
component("YPR069C",386).
component("YDR127W",133).
component("YML082W",296).
component("YJR130C",250).
component("YDR035W",126).
component("YBR249C",91).
component("YBR256C",92).
component("YHR137W",215).
component("YGL202W",192).
component("YLR027C",273).
component("YKL106W",258).
component("YOL140W",350).
component("YLR438W",295).
component("YDR111C",130).
component("U51_",56).
component("YJR148W",254).
component("YMR013C",302).
component("YCR036W",102).
component("YCL040W",99).
component("YJR105W",249).
component("U81_",66).
component("YMR208W",312).
component("YPL203W",375).
component("YOR061W",351).
component("YKL166C",262).
component("YJL164C",240).
component("YIL035C",224).
component("YHR205W",222).
component("YHR102W",214).
component("YGL019W",182).
component("YHR025W",209).
component("YNR012W",338).
component("YFR019W",177).
component("YDR208W",139).
component("YDR127W",134).
component("U21_",43).
component("YDR147W",137).
component("YER052C",160).
component("U19_",39).
component("U18_",36).
component("U76_",64).
component("YMR220W",313).
component("YDR226W",140).
component("YKL067W",257).
component("YDR454C",150).
component("YOL061W",346).
component("YKL181W",263).
component("YHL011C",205).
component("YER099C",168).
component("YBL068W",76).
component("YOR143C",355).
component("YLR328W",291).
component("U94_",68).
component("YBR029C",78).
component("YPR190C",393).
component("YPR187W",392).
component("YPR110C",388).
component("YPR010C",383).
component("YOR341W",365).
component("YOR340C",364).
component("YOR224C",359).
component("YOR210W",358).
component("YOR207C",357).
component("YOR151C",356).
component("YOR116C",353).
component("YOL005C",342).
component("YNR003C",337).
component("YNL248C",331).
component("YNL151C",329).
component("YNL113W",325).
component("YKL144C",261).
component("YJR063W",245).
component("YJL148W",237).
component("YJL140W",236).
component("YIL021W",223).
component("YHR143W-A",216).
component("YGL070C",186).
component("YFL036W",174).
component("YDR404C",147).
component("YDR156W",138).
component("YDR045C",127).
component("YDL150W",119).
component("YDL140C",114).
component("YBR154C",88).
component("YPR175W",391).
component("YPL167C",374).
component("YOR330C",363).
component("YOL115W",349).
component("YNL299W",335).
component("YNL262W",332).
component("YNL102W",324).
component("YJR043C",244).
component("YJR006W",242).
component("YJL090C",232).
component("YIL139C",226).
component("YEL055C",157).
component("YDR419W",149).
component("YDR121W",131).
component("YDL102W",111).
component("YCR014C",101).
component("YBR278W",93).
component("YBL035C",73).
component("YKL035W",256).
component("YHL012W",206).
component("YOL011W",344).
component("YMR008C",301).
component("YMR006C",300).
component("U105_",21).
component("YPL072W",371).
component("YOR124C",354).
component("YNL186W",330).
component("YMR304W",319).
component("YMR223W",314).
component("YKR098C",271).
component("YJL197W",241).
component("YIL156W",227).
component("YFR010W",176).
component("YER151C",170).
component("YER144C",169).
component("YER098W",167).
component("YDR069C",129).
component("YDL122W",112).
component("YBR058C",80).
component("YBL067C",75).
component("YJR019C",243).
component("YFR025C",178).
component("U9_",69).
...
component("YLR286C",287).
component("YLR160C",283).
component("YLR158C",282).
component("YLR157C",281).
component("YLR155C",280).
component("YDR321W",142).
component("YGL037C",184).
component("U43_",53).
component("U42_",52).
component("YLR308W",290).
component("YLR307W",289).
component("U53_",57).
component("YLR028C",274).
component("YHR144C",217).
component("YHR144C",218).
component("YBR153W",87).
component("YDL238C",123).
component("YNL141W",327).
component("U44_",54).
component("YHR201C",221).
component("YBR111C",84).
component("YCL030C",98).
component("YER005W",159).
component("YLR231C",286).
component("YDR538W",155).
component("YLR134W",279).
component("YLR044C",276).
component("YGR087C",195).
component("YDR380W",144).
component("YDL080C",107).
component("YMR250W",315).
component("YKL184W",265).
component("YEL021W",156).
component("YKL211C",266).
component("YNR033W",341).
component("YKL211C",267).
component("YER090W",165).
component("YDR127W",135).
component("YPL281C",382).
component("YOR393W",368).
component("YMR323W",320).
component("YHR174W",219).
component("YGR254W",202).
component("YGL026C",183).
component("YGR155W",198).
component("YNL316C",336).
component("YCR053W",104).
component("YDR127W",136).
component("YGL148W",188).
component("YFR055W",180).
component("YJL121C",233).
component("YDR007W",124).
component("YOR095C",352).
component("YBR196C",90).
component("U14_",30).
component("YMR105C",307).
component("YKL127W",259).
component("YEL058W",158).
component("YPR060C",385).
component("YHR072W",213).
component("YJL153C",238).
component("YGR264C",204).
component("YGR171C",199).
component("YHR011W",207).
component("YDR023W",125).
component("YGL245W",193).
component("YPR047W",384).
component("YLR060W",278).
component("YFL022C",173).
component("YHR019C",208).
component("YPL160W",373).
component("YLR382C",293).
component("YPL040C",370).
component("YBL076C",77).
component("YER183C",171).
component("YDL141W",115).
component("YDL141W",116).
component("YDL141W",117).
component("YDL141W",118).
component("YPR145W",390).
component("YGR124W",197).
component("YPL231W",379).
component("YNR016C",339).
component("YKL182W",264).
component("YGR037C",194).
component("YJL087C",230).
component("YOL010W",343).
component("YPR138C",389).
component("YPL265W",380).
component("YOR348C",366).
component("YOL103W",348).
component("YOL020W",345).
component("YNL142W",328).
component("YMR272C",318).
component("YMR202W",311).
component("YMR056C",304).
component("YML123C",298).
component("YLR348C",292).
component("YKR053C",270).
component("YKR039W",269).
component("YKL217W",268).
component("YJR077C",247).
component("YJL134W",235).
component("YGR121C",196).
component("YGL186C",189).
component("YFL055W",175).
component("YER060W-A",163).
component("YER060W",162).
component("YER056C",161).
component("YDR536W",154).
component("YDR508C",153).
component("YDR503C",152).
component("YDR497C",151).
component("YDR294C",141).
component("YDR046C",128).
component("YDL210W",121).
component("YCL025C",97).
component("YBR291C",94).
component("YBR085W",83).
component("YBR069C",82).
component("YBR068C",81).
component("YBL042C",74).
component("YBL030C",72).
component("U7_",65).
component("U6_",63).
component("U69_",62).
component("U5_",60).
