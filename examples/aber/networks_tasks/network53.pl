...
component("YNL280C",366).
component("YLR056W",306).
component("YMR083W",339).
component("YPL231W",411).
component("YJR159W",283).
component("YGL001C",198).
component("YML056C",328).
component("YLR432W",326).
component("YHR216W",248).
component("YAR075W",83).
component("YAR073W",82).
component("YDR127W",148).
component("YJR139C",280).
component("YNL009W",354).
component("YLR174W",315).
component("YHR183W",244).
component("YGR256W",225).
component("YCL018W",111).
component("YJR078W",276).
component("YGR255C",224).
component("YMR015C",336).
component("YDR402C",162).
component("YGL055W",203).
component("YJL026W",255).
component("YGR180C",219).
component("YOR374W",401).
component("YER073W",181).
component("U68_",70).
component("U55_",65).
component("YER069W",180).
component("YOR323C",396).
component("YBR166C",104).
component("YNL280C",367).
component("YKL141W",289).
component("YOR375C",402).
component("YDL215C",137).
component("YAL062W",81).
component("U100_",20).
component("YBR035C",93).
component("YMR189W",343).
component("U56_",66).
component("YPL023C",404).
component("YGL125W",205).
component("YOR236W",394).
component("YLR142W",310).
component("U65_",69).
component("U62_",68).
component("YHR068W",235).
component("YMR145C",342).
component("YDL085W",123).
component("YBR046C",94).
component("YPL091W",407).
component("YNL052W",355).
component("YMR256C",349).
component("YLR395C",325).
component("YLR038C",304).
component("YIL111W",251).
component("YHR051W",234).
component("YGL191W",209).
component("YGL187C",208).
component("YDL067C",121).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",416).
component("YLL062C",301).
component("YDR410C",164).
component("YER091C",183).
component("YJR073C",274).
component("YOL096C",381).
component("YMR120C",341).
component("YBL013W",84).
component("YJL130C",261).
component("YJL088W",257).
component("YPR074C",422).
component("YBR117C",100).
component("YCL009C",110).
component("YMR062C",338).
component("YNL071W",356).
component("YNR019W",373).
component("YCR048W",118).
component("U48_",61).
component("YFL017C",189).
component("YPL231W",412).
component("YDL052C",120).
component("U8_",76).
component("YPL231W",413).
component("YLR299W",319).
component("YCR005C",115).
component("YML126C",332).
component("YDL182W",135).
component("YDL131W",128).
component("YNL117W",359).
component("YIR031C",254).
component("YOR321W",395).
component("YJR143C",281).
component("YGR199W",222).
component("YDL095W",125).
component("YDL093W",124).
component("YAL023C",80).
component("YMR261C",350).
component("YML100W",330).
component("YBR126C",101).
component("YLR209C",316).
component("YDR354W",159).
component("YFR047C",196).
component("YJR133W",279).
component("U22_",51).
component("YDR399W",161).
component("YJL167W",268).
component("YPR069C",421).
component("YDR127W",149).
component("YHR068W",236).
component("YML082W",329).
component("YJR130C",278).
component("YDR035W",141).
component("YBR249C",106).
component("YBR256C",107).
component("YHR137W",239).
component("YGL202W",210).
component("YLR027C",302).
component("YKL106W",287).
component("YOL140W",384).
component("YLR438W",327).
component("YKL104C",286).
component("YDR111C",146).
component("U51_",63).
component("YJR148W",282).
component("YHR208W",247).
component("YMR013C",335).
component("YCR036W",117).
component("YGR194C",221).
component("YCL040W",114).
component("YJR105W",277).
component("U81_",75).
component("YMR208W",345).
component("YPL203W",410).
component("YOR061W",385).
component("YKL166C",291).
component("YJL164C",267).
component("YIL035C",250).
component("YHR205W",246).
component("YHR102W",238).
component("YGL019W",199).
component("YHR025W",231).
component("YNR012W",371).
component("YFR019W",194).
component("YDR208W",155).
component("YDR127W",150).
component("U21_",48).
component("YDR147W",153).
component("YER052C",176).
component("U19_",44).
component("U18_",40).
component("U17_",37).
component("U76_",73).
component("YMR220W",346).
component("YDR226W",156).
component("YKL067W",285).
component("YDR454C",166).
component("YOL061W",380).
component("YKL181W",292).
component("YHL011C",227).
component("YER099C",185).
component("YBL068W",89).
component("YOR143C",389).
component("YLR328W",322).
component("U94_",78).
component("YBR029C",92).
component("YPR190C",428).
component("YPR187W",427).
component("YPR110C",423).
component("YPR010C",418).
...
component("YOR116C",387).
component("YOL005C",376).
component("YNR003C",370).
component("YNL248C",364).
component("YNL151C",362).
component("YNL113W",358).
component("YKL144C",290).
component("YJR063W",273).
component("YJL148W",264).
component("YJL140W",263).
component("YIL021W",249).
component("YHR143W-A",240).
component("YGL070C",204).
component("YFL036W",191).
component("YDR404C",163).
component("YDR156W",154).
component("YDR045C",142).
component("YDL150W",134).
component("YDL140C",129).
component("YBR154C",103).
component("YPR175W",426).
component("YPL167C",409).
component("YOR330C",397).
component("YOL115W",383).
component("YNL299W",368).
component("YNL262W",365).
component("YNL102W",357).
component("YJR043C",272).
component("YJR006W",270).
component("YJL090C",258).
component("YIL139C",252).
component("YEL055C",173).
component("YDR419W",165).
component("YDR121W",147).
component("YDL102W",126).
component("YCR014C",116).
component("YBR278W",108).
component("YBL035C",86).
component("YKL035W",284).
component("YHL012W",228).
component("YOL011W",378).
component("YMR008C",334).
component("YMR006C",333).
component("U105_",21).
component("YPL072W",406).
component("YOR124C",388).
component("YNL186W",363).
component("YMR304W",352).
component("YMR223W",347).
component("YKR098C",300).
component("YJL197W",269).
component("YIL156W",253).
component("YFR010W",193).
component("YER151C",187).
component("YER144C",186).
component("YER098W",184).
component("YDR069C",144).
component("YDL122W",127).
component("YBR058C",95).
component("YBL067C",88).
component("YJR019C",271).
component("YDR074W",145).
component("YFR025C",195).
component("U9_",79).
component("YJL155C",266).
component("U34_",57).
component("U33_",56).
component("U32_",55).
component("U30_",54).
component("U29_",53).
component("U24_",52).
component("YHR044C",233).
component("YHR043C",232).
component("YGL027C",201).
component("YLR286C",318).
component("YLR160C",314).
component("YLR158C",313).
component("YLR157C",312).
component("YLR155C",311).
component("YDR321W",158).
component("YGL037C",202).
component("U43_",59).
component("U42_",58).
component("YLR308W",321).
component("YLR307W",320).
component("U53_",64).
component("YLR028C",303).
component("YHR144C",241).
component("YHR144C",242).
component("YBR153W",102).
component("YDL238C",138).
component("YNL141W",360).
component("YJL126W",260).
component("U44_",60).
component("YHR201C",245).
component("YBR111C",99).
component("YCL030C",113).
component("YER005W",175).
component("YLR231C",317).
component("YDR538W",171).
component("YLR134W",309).
component("YLR044C",305).
component("YGR087C",214).
component("YDR380W",160).
component("YDL080C",122).
component("YMR250W",348).
component("YKL184W",294).
component("YEL021W",172).
component("YKL211C",295).
component("YNR033W",374).
component("YKL211C",296).
component("YER090W",182).
component("YDR127W",151).
component("YPL281C",417).
component("YOR393W",403).
component("YMR323W",353).
component("YHR174W",243).
component("YGR254W",223).
component("YGL026C",200).
component("YGR155W",217).
component("YNL316C",369).
component("YCR053W",119).
component("YDR127W",152).
component("YGL148W",206).
component("YFR055W",197).
component("YJL121C",259).
component("YBR019C",91).
component("YDR007W",139).
component("YOR095C",386).
component("YBR196C",105).
component("U14_",30).
component("YMR105C",340).
component("YKL127W",288).
component("YEL058W",174).
component("YPR060C",420).
component("YHR072W",237).
component("YJL153C",265).
component("YGR264C",226).
component("YGR171C",218).
component("YHR011W",229).
component("YDR023W",140).
component("YGL245W",212).
component("YPR047W",419).
component("YLR060W",307).
component("YFL022C",190).
component("YHR019C",230).
component("YPL160W",408).
component("YLR382C",324).
component("YPL040C",405).
component("YBL076C",90).
component("YGL234W",211).
component("YER183C",188).
component("U90_",77).
component("YNR057C",375).
component("YDL141W",130).
component("YDL141W",131).
component("YDL141W",132).
component("YDL141W",133).
component("YPR145W",425).
component("YGR124W",216).
component("YPL231W",414).
component("YNR016C",372).
component("YKL182W",293).
component("YGR037C",213).
component("YJL087C",256).
component("YOL010W",377).
component("YPR138C",424).
component("YPL265W",415).
component("YOR348C",400).
component("YOL103W",382).
component("YOL020W",379).
component("YNL142W",361).
component("YMR272C",351).
component("YMR202W",344).
component("YMR056C",337).
component("YML123C",331).
component("YLR348C",323).
component("YLR100C",308).
component("YKR053C",299).
component("YKR039W",298).
component("YKL217W",297).
component("YJR077C",275).
component("YJL134W",262).
component("YGR191W",220).
component("YGR121C",215).
component("YGL186C",207).
component("YFL055W",192).
component("YER060W-A",179).
component("YER060W",178).
component("YER056C",177).
component("YDR536W",170).
component("YDR508C",169).
component("YDR503C",168).
component("YDR497C",167).
component("YDR294C",157).
component("YDR046C",143).
component("YDL210W",136).
component("YCL025C",112).
component("YBR291C",109).
component("YBR085W",98).
component("YBR069C",97).
component("YBR068C",96).
component("YBL042C",87).
component("YBL030C",85).
component("U7_",74).
component("U6_",72).
component("U69_",71).
component("U5_",67).
