...
component("YNL280C",151).
component("YLR056W",132).
component("YGL001C",91).
component("YDR127W",67).
component("YNL009W",146).
component("YLR174W",134).
component("YHR183W",111).
component("YGR256W",102).
component("YCL018W",50).
component("YJR078W",119).
component("YGL055W",94).
component("YOR323C",163).
component("YBR166C",47).
component("YNL280C",152).
component("YKL141W",124).
component("YOR375C",165).
component("YAL062W",37).
component("U100_",18).
component("YMR145C",141).
component("YDL085W",58).
component("YBR046C",41).
component("YPR074C",175).
component("YBR117C",45).
component("YNL071W",147).
component("YNR019W",155).
component("YCR048W",55).
component("U48_",31).
component("YPL231W",168).
component("YPL231W",169).
component("YLR299W",136).
component("YCR005C",52).
component("YOR321W",162).
component("YJR143C",122).
component("YGR199W",100).
component("YDL095W",60).
component("YDL093W",59).
component("YAL023C",36).
component("YDR354W",74).
component("YFR047C",89).
component("U22_",28).
component("YPR069C",174).
component("YDR127W",68).
component("YML082W",139).
component("YJR130C",121).
component("YDR035W",64).
component("YBR249C",48).
component("YHR137W",108).
component("YGL202W",96).
component("YLR027C",131).
component("YKL106W",123).
component("YLR438W",138).
component("U51_",32).
component("YMR013C",140).
component("YCR036W",54).
component("YJR105W",120).
component("YMR208W",143).
component("YHR025W",105).
component("YFR019W",88).
component("YDR208W",72).
component("YDR127W",69).
component("YER052C",82).
component("U19_",25).
component("YDR226W",73).
component("YDR454C",77).
component("YOL061W",159).
component("YKL181W",125).
component("YHL011C",104).
component("YER099C",84).
component("YBL068W",40).
component("YLR328W",137).
component("YPR175W",177).
component("YPL167C",167).
component("YOR330C",164).
component("YOL115W",160).
component("YNL299W",153).
component("YNL262W",150).
component("YNL102W",148).
component("YJR043C",117).
component("YJR006W",116).
component("YJL090C",114).
component("YIL139C",112).
component("YEL055C",80).
component("YDR419W",76).
component("YDR121W",66).
component("YDL102W",61).
component("YCR014C",53).
component("YBR278W",49).
component("YBL035C",38).
component("U32_",30).
component("U30_",29).
component("YHR044C",107).
component("YHR043C",106).
component("YGL037C",93).
component("U53_",33).
component("YHR144C",109).
component("YBR153W",46).
component("YBR111C",44).
component("YER005W",81).
component("YLR231C",135).
component("YDR380W",75).
component("YDL080C",57).
component("YMR250W",144).
component("YKL184W",126).
component("YKL211C",127).
component("YNR033W",156).
component("YKL211C",128).
component("YER090W",83).
component("YDR127W",70).
component("YPL281C",171).
component("YOR393W",166).
component("YMR323W",145).
component("YHR174W",110).
component("YGR254W",101).
component("YGL026C",92).
component("YNL316C",154).
component("YCR053W",56).
component("YDR127W",71).
component("YGL148W",95).
component("YFR055W",90).
component("YDR007W",63).
component("YOR095C",161).
component("YPR060C",173).
component("YGR264C",103).
component("YGR171C",99).
component("YGL245W",97).
component("YPR047W",172).
component("YLR060W",133).
component("YFL022C",86).
component("YER183C",85).
component("YDL141W",62).
component("YJL087C",113).
component("YOL010W",157).
component("YPR138C",176).
component("YPL265W",170).
component("YOL020W",158).
component("YNL142W",149).
component("YMR202W",142).
component("YKR053C",130).
component("YKR039W",129).
...
component("YDR046C",65).
component("YCL025C",51).
component("YBR069C",43).
component("YBR068C",42).
component("YBL042C",39).
component("U6_",35).
component("U5_",34).
component("U228_",27).
component("U222_",26).
