...
component("YNL280C",432).
component("YLR056W",360).
component("YMR083W",401).
component("YPL231W",488).
component("YJR159W",334).
component("YGL001C",234).
component("YML056C",388).
component("YLR432W",384).
component("YHR216W",290).
component("YAR075W",96).
component("YAR073W",95).
component("YDR127W",178).
component("YJR139C",331).
component("YNL009W",416).
component("YLR174W",371).
component("YHR183W",286).
component("YGR256W",267).
component("YOL059W",450).
component("YDL022W",142).
component("YCL018W",131).
component("YJR078W",327).
component("U58_",78).
component("YGR255C",266).
component("YMR015C",398).
component("YDR402C",192).
component("YGL055W",239).
component("YJL026W",301).
component("YGR180C",260).
component("U35_",68).
component("YJR009C",319).
component("YJL052W",302).
component("YGR192C",262).
component("YOR374W",474).
component("YER073W",213).
component("U68_",82).
component("U55_",76).
component("YER069W",212).
component("YOR323C",468).
component("U2_",63).
component("YBR166C",123).
component("YNL280C",433).
component("YKL141W",340).
component("YJR051W",323).
component("YOR375C",475).
component("YDL215C",164).
component("YAL062W",94).
component("U100_",20).
component("YBR035C",108).
component("YMR189W",405).
component("U56_",77).
component("YPL023C",477).
component("YGL125W",242).
component("YOR236W",466).
component("YBR084W",114).
component("YLR142W",365).
component("U65_",81).
component("U62_",80).
component("YHR068W",277).
component("YMR145C",404).
component("YML120C",392).
component("YKL192C",346).
component("YDL085W",147).
component("YBR046C",110).
component("YPL091W",480).
component("YNL052W",417).
component("YMR256C",411).
component("YLR395C",382).
component("YLR038C",358).
component("YIL111W",294).
component("YHR051W",276).
component("YGL191W",246).
component("YGL187C",245).
component("YDL067C",145).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",494).
component("YLL062C",355).
component("YDR410C",194).
component("YER091C",216).
component("YJR073C",325).
component("YOL096C",452).
component("YLR172C",370).
component("YMR120C",403).
component("YBL013W",97).
component("YJL130C",309).
component("YJL088W",305).
component("YPR074C",500).
component("YBR117C",118).
component("YCL009C",130).
component("YMR062C",400).
component("YNL071W",418).
component("YNR019W",439).
component("YCR048W",139).
component("U48_",72).
component("YFL017C",224).
component("YPL231W",489).
component("YDL052C",144).
component("U8_",89).
component("YPL231W",490).
component("YLR299W",375).
component("YCR005C",136).
component("YML126C",394).
component("YDL182W",161).
component("YDL131W",153).
component("YNL117W",421).
component("YIR031C",299).
component("YOR321W",467).
component("YJR143C",332).
component("YGR199W",264).
component("YDL095W",149).
component("YDL093W",148).
component("YAL023C",93).
component("YPL227C",487).
component("YMR261C",412).
component("YML100W",391).
component("YBR126C",120).
component("YNL192W",428).
component("YBR038W",109).
component("YBR023C",106).
component("YLR209C",372).
component("YDR354W",189).
component("YFR047C",231).
component("YJR133W",330).
component("U22_",58).
component("YDR399W",191).
component("YJL167W",316).
component("YPR069C",499).
component("YDR127W",179).
component("YHR068W",278).
component("YLR303W",376).
component("YML082W",390).
component("YJR130C",329).
component("YDR035W",168).
component("YBR249C",126).
component("YBR256C",127).
component("YHR137W",281).
component("YGL202W",247).
component("YLR027C",356).
component("YKL106W",338).
component("YOL140W",455).
component("YLR438W",386).
component("YKL104C",337).
component("YDR111C",176).
component("U51_",74).
component("YJR148W",333).
component("YHR208W",289).
component("YGL253W",251).
component("YFR053C",232).
component("YMR013C",397).
component("YCR036W",138).
component("YGR194C",263).
component("YCL040W",134).
component("YJR105W",328).
component("U81_",87).
component("YMR208W",407).
component("YPL203W",486).
component("YOR061W",456).
component("YKL166C",342).
component("YJL164C",315).
component("YIL035C",292).
component("YHR205W",288).
component("YHR102W",280).
component("YGL019W",235).
component("YHR025W",273).
component("YNR012W",437).
component("YPR121W",502).
component("YPL258C",492).
component("YOL055C",448).
component("YFR019W",229).
component("YDR208W",185).
component("YDR127W",180).
component("U21_",55).
component("YDR147W",183).
component("YER052C",208).
component("U19_",48).
component("U18_",44).
component("U17_",41).
component("U76_",85).
component("YMR220W",408).
component("YER170W",222).
component("YDR226W",186).
component("YKL067W",336).
component("YOL055C",449).
component("YDR454C",197).
component("YOL061W",451).
component("YKL181W",343).
component("YHL011C",269).
component("YER099C",218).
component("YBL068W",103).
component("YOR143C",460).
component("YNL256W",430).
component("YLR328W",379).
component("YDL103C",151).
component("U94_",91).
component("YJR010W",320).
component("YBR029C",107).
component("YPR190C",507).
component("YPR187W",506).
component("YPR110C",501).
component("YPR010C",496).
component("YOR341W",471).
component("YOR340C",470).
component("YOR224C",465).
component("YOR210W",464).
component("YOR207C",463).
component("YOR151C",461).
component("YOR116C",458).
component("YOL005C",444).
component("YNR003C",436).
component("YNL248C",429).
component("YNL151C",426).
component("YNL113W",420).
component("YKL144C",341).
component("YJR063W",324).
component("YJL148W",312).
component("YJL140W",311).
component("YIL021W",291).
component("YHR143W-A",282).
component("YGL070C",241).
component("YFL036W",226).
component("YDR404C",193).
component("YDR156W",184).
component("YDR045C",170).
component("YDL150W",160).
component("YDL140C",155).
component("YBR154C",122).
component("YPR175W",505).
component("YPL167C",484).
component("YOR330C",469).
component("YOL115W",454).
component("YNL299W",434).
component("YNL262W",431).
component("YNL102W",419).
component("YJR043C",322).
component("YJR006W",318).
component("YJL090C",306).
component("YIL139C",295).
component("YEL055C",204).
component("YDR419W",195).
component("YDR121W",177).
component("YDL102W",150).
component("YCR014C",137).
component("YBR278W",128).
component("YBL035C",99).
component("YKL035W",335).
component("YHL012W",270).
component("YNL130C",422).
component("YPL148C",482).
component("YDR058C",172).
component("YOL011W",446).
component("YMR008C",396).
component("YMR006C",395).
component("U105_",22).
component("U101_",21).
component("YJL068C",303).
component("YPL072W",479).
component("YOR124C",459).
component("YNL186W",427).
component("YMR304W",414).
component("YMR223W",409).
component("YKR098C",354).
component("YJL197W",317).
component("YIL156W",296).
component("YFR010W",228).
component("YER151C",221).
component("YER144C",220).
component("YER098W",217).
component("YDR069C",173).
component("YDL122W",152).
component("YBR058C",111).
component("YBL067C",102).
component("YJR019C",321).
component("YDR074W",174).
component("YFR025C",230).
component("YPL179W",485).
component("YNR032W",440).
component("YML057W",389).
component("YML016C",387).
component("YLR433C",385).
component("YGR123C",256).
component("YER133W",219).
component("YER089C",214).
component("YDR436W",196).
component("YDR075W",175).
component("YDL188C",162).
component("YDL134C",154).
component("YDL047W",143).
component("YDL006W",141).
component("YBR125C",119).
component("YBL056W",101).
component("U9_",92).
component("YJL155C",314).
component("U34_",67).
component("U33_",66).
component("U32_",65).
component("U30_",64).
...
component("YGL248W",250).
component("YGL027C",237).
component("YLR286C",374).
component("YER043C",207).
component("YLR160C",369).
component("YLR158C",368).
component("YLR157C",367).
component("YLR155C",366).
component("YDR321W",188).
component("YGL037C",238).
component("U43_",70).
component("U42_",69).
component("YLR308W",378).
component("YLR307W",377).
component("U53_",75).
component("YLR420W",383).
component("YIR032C",300).
component("YLR028C",357).
component("YHR144C",283).
component("YHR144C",284).
component("YNL141W",423).
component("YBR153W",121).
component("YDL238C",165).
component("YNL141W",424).
component("YBR084W",115).
component("YJL126W",308).
component("U44_",71).
component("YHR201C",287).
component("YBR111C",117).
component("YCL030C",133).
component("YER005W",206).
component("YLR231C",373).
component("U88_",88).
component("YDR538W",202).
component("YLR134W",363).
component("YLR044C",359).
component("YGR087C",253).
component("YDR380W",190).
component("YDL080C",146).
component("YMR250W",410).
component("YKL184W",345).
component("YEL021W",203).
component("YNR043W",442).
component("YKL211C",348).
component("YKR097W",353).
component("YNR033W",441).
component("YKL211C",349).
component("YER090W",215).
component("YDR127W",181).
component("YPL281C",495).
component("YOR393W",476).
component("YMR323W",415).
component("YHR174W",285).
component("YGR254W",265).
component("YGL026C",236).
component("YGR155W",258).
component("YNL316C",435).
component("YCR053W",140).
component("YDR127W",182).
component("YGL148W",243).
component("YIL168W",298).
component("YIL167W",297).
component("YCL064C",135).
component("YFR055W",233).
component("YJL121C",307).
component("YBR019C",105).
component("YDR007W",166).
component("YOR095C",457).
component("YBR196C",124).
component("YPL117C",481).
component("U14_",32).
component("YMR105C",402).
component("YKL127W",339).
component("YEL058W",205).
component("YPR060C",498).
component("YHR072W",279).
component("YJL153C",313).
component("YGR264C",268).
component("YGR171C",259).
component("YHR011W",271).
component("YDR023W",167).
component("YGL245W",249).
component("YOR168W",462).
component("YPR047W",497).
component("YLR060W",361).
component("YFL022C",225).
component("YHR019C",272).
component("YKL194C",347).
component("YIL078W",293).
component("YPL160W",483).
component("YLR382C",381).
component("YPL040C",478).
component("YBL076C",104).
component("YDR037W",169).
component("YGR094W",254).
component("YGL234W",248).
component("YER183C",223).
component("U90_",90).
component("YNR057C",443).
component("YDL141W",156).
component("YDL141W",157).
component("YDL141W",158).
component("YDL141W",159).
component("YPR145W",504).
component("YGR124W",257).
component("YGL062W",240).
component("YBR218C",125).
component("YPL231W",491).
component("YNR016C",438).
component("YKL182W",344).
component("YGR037C",252).
component("YJL087C",304).
component("YOL010W",445).
component("YPR138C",503).
component("YPL265W",493).
component("YOR348C",472).
component("YOL103W",453).
component("YOL020W",447).
component("YNL142W",425).
component("YMR272C",413).
component("YMR202W",406).
component("YMR056C",399).
component("YML123C",393).
component("YLR348C",380).
component("YLR138W",364).
component("YLR100C",362).
component("YKR053C",352).
component("YKR039W",351).
component("YKL217W",350).
component("YJR077C",326).
component("YJL134W",310).
component("YGR191W",261).
component("YGR121C",255).
component("YGL186C",244).
component("YFL055W",227).
component("YER060W-A",211).
component("YER060W",210).
component("YER056C",209).
component("YDR536W",201).
component("YDR508C",200).
component("YDR503C",199).
component("YDR497C",198).
component("YDR294C",187).
component("YDR046C",171).
component("YDL210W",163).
component("YCL025C",132).
