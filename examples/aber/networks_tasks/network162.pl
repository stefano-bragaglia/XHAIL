...
component("YNL280C",831).
component("YLR056W",705).
component("YGR060W",490).
component("YKR009C",684).
component("YMR083W",779).
component("YPL231W",939).
component("U46_",143).
component("YBR149W",244).
component("YBR149W",245).
component("YJR159W",649).
component("YGL001C",457).
component("YHR063C",544).
component("YBR153W",246).
component("YML056C",760).
component("YLR432W",749).
component("YHR216W",567).
component("YAR075W",200).
component("YAR073W",199).
component("YCL030C",269).
component("YDR127W",347).
component("YJR139C",644).
component("YML075C",763).
component("YLR450W",752).
component("YKL085W",658).
component("YKL029C",653).
component("YOR136W",884).
component("YNL037C",809).
component("YNL009W",807).
component("YLR174W",722).
component("YDL066W",296).
component("YHR183W",561).
component("YGR256W",520).
component("YNL241C",824).
component("YOL059W",862).
component("YDL022W",288).
component("YCL018W",267).
component("YLR355C",743).
component("YIL074C",573).
component("YER081W",425).
component("YML054C",759).
component("YDL174C",320).
component("YIL155C",581).
component("YPR191W",975).
component("YOR065W",876).
component("YJL166W",616).
component("YHR001W-A",530).
component("YGR183C",505).
component("YFR033C",453).
component("YEL024W",399).
component("YDR529C",391).
component("YBL045C",206).
component("Q0105",19).
component("YKR066C",689).
component("YKL026C",652).
component("YIR037W",592).
component("YBR244W",255).
component("YJR078W",636).
component("U58_",155).
component("U107_",28).
component("YGR255C",519).
component("U108_",29).
component("YBL098W",211).
component("YMR015C",776).
component("YHR007C",531).
component("YDR402C",378).
component("YGL055W",466).
component("YGR175C",502).
component("YJR104C",638).
component("YHR008C",532).
component("YJL026W",595).
component("YIL066C",572).
component("YGR180C",504).
component("YER070W",423).
component("U37_",135).
component("U36_",134).
component("U35_",133).
component("YDR158W",355).
component("YJR009C",626).
component("YJL052W",597).
component("YGR192C",507).
component("YBR006W",216).
component("YPL276W",950).
component("YPL275W",949).
component("YOR388C",914).
component("YOR374W",911).
component("YER073W",424).
component("U68_",166).
component("YGL154C",473).
component("YBR115C",239).
component("U55_",152).
component("YER069W",422).
component("YOR323C",904).
component("U2_",128).
component("YER178W",436).
component("YBR221C",253).
component("YIL125W",578).
component("YBR166C",249).
component("YNL280C",832).
component("YGL012W",460).
component("YKL182W",671).
component("U57_",154).
component("YKL216W",681).
component("YDR044W",336).
component("YER014W",409).
component("YKR009C",685).
component("YIL160C",583).
component("YGL205W",478).
component("YMR118C",784).
component("YLR164W",720).
component("YLL041C",696).
component("YKL148C",666).
component("YKL141W",664).
component("YJL045W",596).
component("YDR178W",356).
component("YJR051W",631).
component("YEL047C",402).
component("YDL171C",319).
component("YOR375C",912).
component("YDL215C",324).
component("YAL062W",197).
component("U99_",193).
component("U100_",22).
component("YBR035C",226).
component("YMR189W",791).
component("U56_",153).
component("YNR050C",847).
component("YKR080W",691).
component("YER023W",410).
component("YPL023C",918).
component("YGL125W",470).
component("YOR236W",897).
component("YGR204W",511).
component("YBR084W",233).
component("YLR142W",713).
component("U65_",163).
component("U63_",161).
component("U62_",160).
component("YHR068W",545).
component("YKL150W",667).
component("YIL043C",570).
component("YHR042W",539).
component("YOR221C",895).
component("YMR145C",787).
component("YML120C",768).
component("YKL192C",675).
component("YKL055C",655).
component("YER061C",418).
component("YDL085W",299).
component("YBR046C",229).
component("YMR145C",788).
component("YML120C",769).
component("YKL192C",676).
component("YDL085W",300).
component("YFR030W",452).
component("YPL017C",917).
component("YFL018C",441).
component("YPL091W",923).
component("YDR353W",373).
component("YER042W",411).
component("YPR167C",969).
component("YJR137C",643).
component("YNL052W",811).
component("YMR256C",799).
component("YLR395C",747).
component("YLR038C",703).
component("YIL111W",576).
component("YHR051W",543).
component("YGL191W",476).
component("YGL187C",475).
component("YDL067C",297).
component("Q0275",21).
component("Q0250",20).
component("Q0045",18).
component("YPL266W",946).
component("YML110C",767).
component("YBR034C",225).
component("YPL273W",948).
component("YLL062C",699).
component("YDR410C",381).
component("YKR069W",690).
component("YOL096C",865).
component("U47_",144).
component("YER091C",429).
component("YJR073C",634).
component("YML008C",753).
component("YDL033C",290).
component("YOL096C",866).
component("YLR172C",721).
component("YBR263W",259).
component("YDR019C",332).
component("YDR408C",380).
component("YMR120C",785).
component("YLR028C",701).
component("YBL013W",201).
component("YJL130C",608).
component("YJL088W",602).
component("YPR074C",962).
component("YBR117C",240).
component("YLR354C",742).
component("YGR043C",488).
component("YMR108W",782).
component("YCL009C",266).
component("YMR062C",778).
component("YNL071W",812).
component("YIL160C",584).
component("YNR019W",841).
component("YCR048W",283).
component("U48_",145).
component("YNL277W",830).
component("YDR232W",359).
component("YFL017C",440).
...
component("U8_",187).
component("YDR148C",353).
component("YOR377W",913).
component("YGR177C",503).
component("YPL231W",941).
component("YGR147C",498).
component("YDL040C",291).
component("YPL028W",919).
component("YLR195C",724).
component("YLR299W",734).
component("YGL017W",461).
component("YPR001W",952).
component("YNR001C",837).
component("YCR005C",278).
component("YML126C",771).
component("YDL182W",321).
component("YDL131W",309).
component("YNL117W",816).
component("YIR031C",590).
component("YPR160W",968).
component("YOR321W",903).
component("YJR143C",645).
component("YGR199W",509).
component("YDL095W",304).
component("YDL093W",303).
component("YAL023C",195).
component("YLR258W",731).
component("YFR015C",449).
component("YPL227C",937).
component("YOR103C",880).
component("YOR085W",878).
component("YMR149W",789).
component("YML019W",755).
component("YJL002C",593).
component("YEL002C",396).
component("YDL232W",325).
component("YCL043C",273).
component("YNL029C",808).
component("YIL085C",575).
component("YMR261C",800).
component("YML100W",765).
component("YBR126C",243).
component("YNL192W",823).
component("YBR038W",228).
component("YBR023C",223).
component("YEL011W",397).
component("YPR183W",972).
component("YLR209C",725).
component("U104_",26).
component("U103_",25).
component("YMR271C",801).
component("YML106W",766).
component("YOR209C",893).
component("YMR300C",804).
component("YDR354W",374).
component("YFR047C",454).
component("YJR133W",642).
component("U22_",122).
component("YLR209C",726).
component("YML022W",756).
component("YDR441C",384).
component("YDR399W",376).
component("YPR176C",971).
component("YPL172C",930).
component("YNR041C",845).
component("YMR101C",780).
component("YDL090C",302).
component("YBR003W",215).
component("YBR002C",214).
component("YJL167W",617).
component("YJL167W",618).
component("YNL256W",826).
component("YPR069C",960).
component("YDR127W",348).
component("YHR190W",562).
component("YLR146C",714).
component("YHR068W",546).
component("YLR303W",735).
component("YGR012W",485).
component("YML082W",764).
component("YJR130C",641).
component("YDR035W",334).
component("YBR249C",256).
component("YLR180W",723).
component("YDR502C",388).
component("YOR274W",900).
component("YOL143C",871).
component("YBR256C",258).
component("YHR137W",555).
component("YGL202W",477).
component("YLR027C",700).
component("YKL106W",660).
component("YOL140W",870).
component("YLR438W",751).
component("YKL104C",659).
component("YGR019W",486).
...
component("YFL030W",443).
component("YOR184W",890).
component("YNR058W",849).
component("YIL116W",577).
component("YGL253W",483).
component("YFR053C",455).
component("YMR013C",775).
component("YMR205C",793).
component("YGR240C",515).
component("YOL016C",854).
component("YFR014C",448).
component("YLR240W",729).
component("YKL203C",678).
component("YJR066W",633).
component("YCR036W",282).
component("YGR194C",508).
component("YCL040W",272).
component("YJR105W",639).
component("U16_",76).
component("YPL188W",932).
component("YJR049C",630).
component("YEL041W",400).
component("U96_",192).
component("YKL001C",650).
component("YDR236C",360).
component("YML070W",762).
component("YFL053W",445).
component("YHL032C",528).
component("YLR133W",710).
component("YDR531W",393).
component("U83_",181).
component("U82_",180).
component("U81_",179).
component("YMR208W",794).
component("YPL203W",933).
component("YOR061W",875).
component("YKL166C",669).
component("YJL164C",615).
component("YIL035C",569).
component("YHR205W",564).
component("YHR102W",553).
component("YGL019W",462).
component("YHR025W",538).
component("YNR012W",839).
component("YPR121W",965).
component("YPL258C",943).
component("YOL055C",858).
component("YPL214C",936).
component("U1_",102).
component("YDR009W",331).
component("YBR020W",222).
component("YFR019W",450).
component("YDR208W",357).
component("YDR127W",349).
component("U21_",114).
component("U20_",109).
component("YDR147W",352).
component("YDR300C",367).
component("YCR012W",279).
component("YER052C",413).
component("U19_",101).
component("U18_",92).
component("U17_",83).
component("U76_",175).
component("YMR220W",796).
component("YER170W",435).
component("YDR226W",358).
component("YKL067W",657).
component("YOL055C",859).
component("YDR454C",385).
component("YOL061W",863).
component("YKL181W",670).
component("YHL011C",525).
component("YER099C",431).
component("YBL068W",209).
component("YOR143C",885).
component("YNL256W",827).
component("YLR328W",739).
component("YBR018C",218).
component("YBR018C",219).
component("YDL055C",295).
component("YGR007W",484).
component("YGR202C",510).
component("YLR328W",740).
component("YKR002W",683).
component("YDL045C",292).
component("YDL103C",307).
component("U94_",191).
component("YJR010W",627).
component("YBR029C",224).
component("YCL050C",274).
component("YGL130W",471).
component("YDR530C",392).
component("YCL050C",275).
component("YPR190C",974).
component("YPR187W",973).
component("YPR110C",964).
component("YPR010C",954).
component("YOR341W",908).
component("YOR340C",907).
component("YOR224C",896).
component("YOR210W",894).
component("YOR207C",892).
component("YOR151C",886).
component("YOR116C",881).
component("YOL005C",851).
component("YNR003C",838).
component("YNL248C",825).
component("YNL151C",821).
component("YNL113W",815).
component("YKL144C",665).
component("YJR063W",632).
component("YJL148W",612).
component("YJL140W",611).
component("YIL021W",568).
component("YHR143W-A",556).
component("YGL070C",469).
component("YFL036W",444).
component("YDR404C",379).
component("YDR156W",354).
component("YDR045C",337).
component("YDL150W",317).
component("YDL140C",311).
component("YBR154C",248).
component("YPR175W",970).
component("YPL167C",929).
component("YOR330C",905).
component("YOL115W",869).
component("YNL299W",834).
component("YNL262W",828).
component("YNL102W",814).
component("YJR043C",629).
component("YJR006W",625).
component("YJL090C",603).
component("YIL139C",579).
component("YEL055C",403).
component("YDR419W",382).
component("YDR121W",346).
component("YDL102W",306).
component("YCR014C",280).
component("YBR278W",260).
component("YBL035C",204).
component("YKL035W",654).
component("YHL012W",526).
component("YHR123W",554).
component("YBR243C",254).
component("YNL130C",817).
component("YDL142C",316).
component("YPL148C",927).
component("YOR251C",899).
component("YGR286C",522).
component("YJL068C",598).
component("YDR058C",341).
component("YNR034W",844).
component("YHR163W",559).
component("YGR248W",517).
component("YCR073W-A",285).
component("YDL086W",301).
component("YOL011W",853).
...
component("YOR124C",882).
component("YNL186W",822).
component("YMR304W",805).
component("YMR223W",797).
component("YKR098C",694).
component("YJL197W",619).
component("YIL156W",582).
component("YFR010W",447).
component("YER151C",434).
component("YER144C",433).
component("YER098W",430).
component("YDR069C",342).
component("YDL122W",308).
component("YBR058C",230).
component("YBL067C",208).
component("YJR019C",628).
component("YDR272W",363).
component("U84_",182).
component("YDR481C",386).
component("YLR377C",745).
component("YDR074W",343).
component("YFR025C",451).
component("YPL179W",931).
component("YNR032W",842).
component("YML057W",761).
component("YML016C",754).
component("YLR433C",750).
component("YGR123C",495).
component("YER133W",432).
component("YER089C",427).
component("YDR436W",383).
component("YDR075W",344).
component("YDL188C",322).
component("YDL134C",310).
component("YDL047W",293).
component("YDL006W",286).
component("YBR125C",242).
component("YBL056W",207).
component("YPR073C",961).
component("YHR215W",566).
component("YDL024C",289).
component("YBR093C",237).
component("YBR092C",236).
component("YIL053W",571).
component("YER062C",420).
component("YHR046C",542).
component("U9_",194).
component("YGR208W",514).
component("YPL228W",938).
component("YMR180C",790).
component("YDL236W",326).
component("YJL155C",614).
component("U34_",132).
component("U33_",131).
component("U32_",130).
component("U30_",129).
...
component("YOL064C",864).
component("YPL268W",947).
component("YOR360C",910).
component("YGL248W",482).
component("YKR031C",686).
component("YPL206C",934).
component("YGL027C",464).
component("YLR286C",733).
component("YJR153W",647).
component("YJL221C",624).
component("YJL216C",622).
component("YIL172C",588).
component("YGR292W",524).
component("YGR287C",523).
component("YBR299W",265).
component("YBR184W",250).
component("YIL162W",585).
component("YPR026W",955).
component("YDR001C",329).
component("YBR001C",213).
component("YDR400W",377).
component("YML035C",757).
component("YJL070C",600).
component("YBR284W",261).
component("U102_",24).
component("YER043C",412).
component("YNL045W",810).
component("YLR160C",719).
component("YLR158C",718).
component("YLR157C",717).
component("YLR155C",716).
component("YDR321W",368).
component("YGL037C",465).
component("U43_",141).
component("U42_",140).
component("YMR293C",803).
component("YDR242W",361).
component("YLR308W",738).
component("YLR307W",737).
component("U53_",150).
component("YLR420W",748).
component("YPL111W",925).
component("YIR032C",591).
component("YIR029W",589).
component("YMR120C",786).
component("YLR028C",702).
component("YHR144C",557).
component("YHR144C",558).
component("YCL030C",270).
component("YNL141W",818).
component("YBL033C",203).
component("YBR153W",247).
component("YDL238C",327).
component("YNL141W",819).
component("YLR245C",730).
component("YML035C",758).
component("YGR204W",512).
component("YBR084W",234).
component("YJL126W",606).
component("U44_",142).
component("YDL100C",305).
component("U40_",138).
component("U39_",136).
...
component("U60_",158).
component("YLR231C",727).
component("U88_",185).
component("YDR538W",395).
component("YLR134W",711).
component("YLR044C",704).
component("YGR087C",492).
component("YDR380W",375).
component("YDL080C",298).
component("YMR250W",798).
component("YKL184W",674).
component("YEL021W",398).
component("YNR043W",846).
component("U93_",190).
component("YDR047W",339).
component("U54_",151).
component("YKL211C",679).
component("YKR097W",693).
component("YOL052C",857).
component("YGR170W",500).
component("YKL060C",656).
component("YDR294C",364).
component("YEL046C",401).
component("YNR033W",843).
component("YPR006C",953).
component("YER065C",421).
component("YKL211C",680).
component("YER090W",428).
component("YDR127W",350).
component("YPL281C",951).
component("YOR393W",915).
component("YMR323W",806).
component("YHR174W",560).
component("YGR254W",518).
component("YPL262W",944).
component("YGL026C",463).
component("YGR155W",499).
component("YLR304C",736).
component("YJL200C",620).
component("YGL009C",459).
component("YNL316C",835).
component("YKL182W",672).
component("YPL212C",935).
component("YNL292W",833).
component("YGL063W",468).
component("YFL001W",438).
component("YOR278W",901).
component("U49_",146).
component("YCR053W",284).
component("YDR127W",351).
component("YGL148W",472).
component("YIL168W",587).
component("YIL167W",586).
component("YCL064C",276).
component("YCL064C",277).
component("YHR018C",534).
component("YLR359W",744).
component("YFR055W",456).
component("YJL005W",594).
component("YOR176W",889).
component("YJL121C",605).
component("YBR019C",220).
component("YBR019C",221).
component("U59_",156).
component("YDR050C",340).
component("YDR007W",330).
component("YOR095C",879).
component("YER003C",407).
component("YBR196C",251).
component("YGL001C",458).
component("YPL117C",926).
component("U14_",61).
component("YOL056W",860).
component("YKL152C",668).
component("YDL021W",287).
component("YMR105C",781).
component("YKL127W",662).
component("YEL058W",404).
component("YPR060C",959).
component("YHR072W",547).
component("YJL153C",613).
component("YGR264C",521).
component("YGR171C",501).
component("YHR011W",533).
component("YDR023W",333).
component("YPL104W",924).
component("YLL018C",695).
component("YPR081C",963).
component("YBR121C",241).
component("YHR020W",537).
component("YER087W",426).
component("YOL033W",856).
component("YGL245W",481).
component("YOR168W",887).
component("YHR091C",549).
component("YDR341C",369).
component("YOL097C",867).
component("YDR268W",362).
component("YPR047W",958).
component("YLR060W",706).
component("YFL022C",442).
component("YPR033C",956).
component("YHR019C",535).
component("YHR019C",536).
component("YKL194C",677).
component("YIL078W",574).
component("YPL160W",928).
component("YLR382C",746).
component("YPL040C",920).
component("YBL076C",210).
component("YNL073W",813).
component("YDR037W",335).
component("YOR335C",906).
component("YGR094W",493).
component("YLR153C",715).
component("YAL054C",196).
component("YGR244C",516).
component("YPR035W",957).
component("YIL145C",580).
component("U89_",186).
component("YOR241W",898).
component("YMR113W",783).
component("YKL132C",663).
component("YJL101C",604).
component("U92_",189).
component("YAR015W",198).
component("YGL234W",479).
component("YER183C",437).
component("U90_",188).
component("YNR057C",848).
component("YDL141W",312).
component("YDL141W",313).
component("YGL234W",480).
component("YDL141W",314).
component("YGR204W",513).
component("YOL058W",861).
component("YDL141W",315).
component("YHR074W",548).
component("YMR217W",795).
component("YPR145W",967).
component("YGR124W",496).
component("YOR303W",902).
component("YJR109C",640).
component("YJL130C",609).
component("YGL062W",467).
component("YBR218C",252).
component("YPL231W",942).
component("YNR016C",840).
component("YKL182W",673).
component("YGR037C",487).
component("YOR005C",873).
component("YDL164C",318).
component("YJL087C",601).
component("YOL010W",852).
component("YPR138C",966).
component("YPL265W",945).
component("YPL057C",921).
component("YOR348C",909).
component("YOR192C",891).
component("YOR171C",888).
component("YOR130C",883).
component("YOR071C",877).
component("YOR011W",874).
component("YOL156W",872).
component("YOL103W",868).
component("YOL020W",855).
component("YNR072W",850).
component("YNL318C",836).
component("YNL270C",829).
component("YNL142W",820).
component("YMR272C",802).
component("YMR202W",792).
component("YMR056C",777).
component("YMR011W",774).
component("YML123C",770).
component("YLR348C",741).
component("YLR260W",732).
component("YLR237W",728).
component("YLR138W",712).
component("YLR100C",709).
component("YLR092W",708).
component("YLR081W",707).
component("YLL061W",698).
component("YLL043W",697).
component("YKR093W",692).
component("YKR053C",688).
component("YKR039W",687).
component("YKL217W",682).
component("YKL120W",661).
component("YKL004W",651).
component("YJR158W",648).
component("YJR095W",637).
component("YJR077C",635).
component("YJL219W",623).
component("YJL214W",621).
component("YJL134W",610).
...
component("YGR191W",506).
component("YGR125W",497).
component("YGR121C",494).
component("YGR065C",491).
component("YGR055W",489).
component("YGL186C",474).
component("YFL055W",446).
component("YFL011W",439).
component("YER060W-A",417).
component("YER060W",416).
component("YER056C",415).
component("YER053C",414).
