...
component("YNL280C",329).
component("YLR056W",273).
component("YMR083W",302).
component("YPL231W",372).
component("YJR159W",251).
component("YGL001C",177).
component("YDR127W",128).
component("YJR139C",248).
component("YNL009W",317).
component("YLR174W",280).
component("YHR183W",216).
component("YGR256W",199).
component("YCL018W",93).
component("YJR078W",244).
component("YMR015C",299).
component("YDR402C",142).
component("YGL055W",181).
component("YJL026W",225).
component("YGR180C",196).
component("U68_",60).
component("U55_",57).
component("YER069W",160).
component("YOR323C",358).
component("YBR166C",87).
component("YNL280C",330).
component("YKL141W",256).
component("YOR375C",363).
component("YDL215C",118).
component("YAL062W",69).
component("U100_",20).
component("YMR189W",306).
component("U56_",58).
component("YPL023C",365).
component("YGL125W",183).
component("YOR236W",356).
component("YMR145C",305).
component("YDL085W",105).
component("YBR046C",77).
component("YPL091W",368).
component("YNL052W",318).
component("YMR256C",312).
component("YLR395C",290).
component("YLR038C",271).
component("YIL111W",221).
component("YHR051W",208).
component("YGL191W",187).
component("YGL187C",186).
component("YDL067C",103).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",377).
component("YLL062C",268).
component("YDR410C",144).
component("YER091C",162).
component("YJR073C",242).
component("YOL096C",343).
component("YMR120C",304).
component("YJL130C",230).
component("YJL088W",227).
component("YPR074C",383).
component("YBR117C",83).
component("YCL009C",92).
component("YMR062C",301).
component("YNL071W",319).
component("YNR019W",336).
component("YCR048W",100).
component("U48_",54).
component("YFL017C",168).
component("YPL231W",373).
component("YDL052C",102).
component("U8_",65).
component("YPL231W",374).
component("YLR299W",284).
component("YCR005C",97).
component("YML126C",295).
component("YDL182W",116).
component("YDL131W",110).
component("YNL117W",322).
component("YIR031C",224).
component("YOR321W",357).
component("YJR143C",249).
component("YGR199W",197).
component("YDL095W",107).
component("YDL093W",106).
component("YAL023C",68).
component("YMR261C",313).
component("YML100W",293).
component("YBR126C",84).
component("YLR209C",281).
component("YDR354W",139).
component("YFR047C",175).
component("YJR133W",247).
component("U22_",45).
component("YDR399W",141).
component("YPR069C",382).
component("YDR127W",129).
component("YML082W",292).
component("YJR130C",246).
component("YDR035W",122).
component("YBR249C",89).
component("YHR137W",211).
component("YGL202W",188).
component("YLR027C",269).
component("YKL106W",254).
component("YOL140W",346).
component("YLR438W",291).
component("YDR111C",126).
component("U51_",55).
component("YJR148W",250).
component("YMR013C",298).
component("YCR036W",99).
component("YCL040W",96).
component("YJR105W",245).
component("YMR208W",308).
component("YPL203W",371).
component("YOR061W",347).
component("YKL166C",258).
component("YJL164C",236).
component("YIL035C",220).
component("YHR205W",218).
component("YHR102W",210).
component("YGL019W",178).
component("YHR025W",205).
component("YNR012W",334).
component("YFR019W",173).
component("YDR208W",135).
component("YDR127W",130).
component("U21_",42).
component("YDR147W",133).
component("YER052C",156).
component("U19_",38).
component("U18_",35).
component("U76_",63).
component("YMR220W",309).
component("YDR226W",136).
component("YKL067W",253).
component("YDR454C",146).
component("YOL061W",342).
component("YKL181W",259).
component("YHL011C",201).
component("YER099C",164).
component("YBL068W",74).
component("YOR143C",351).
component("YLR328W",287).
component("U94_",66).
component("YBR029C",76).
component("YPR190C",389).
component("YPR187W",388).
component("YPR110C",384).
component("YPR010C",379).
component("YOR341W",361).
component("YOR340C",360).
component("YOR224C",355).
component("YOR210W",354).
component("YOR207C",353).
component("YOR151C",352).
component("YOR116C",349).
component("YOL005C",338).
component("YNR003C",333).
component("YNL248C",327).
component("YNL151C",325).
component("YNL113W",321).
component("YKL144C",257).
component("YJR063W",241).
component("YJL148W",233).
component("YJL140W",232).
component("YIL021W",219).
component("YHR143W-A",212).
component("YGL070C",182).
component("YFL036W",170).
component("YDR404C",143).
component("YDR156W",134).
component("YDR045C",123).
component("YDL150W",115).
component("YDL140C",111).
component("YBR154C",86).
component("YPR175W",387).
component("YPL167C",370).
component("YOR330C",359).
component("YOL115W",345).
component("YNL299W",331).
component("YNL262W",328).
component("YNL102W",320).
component("YJR043C",240).
component("YJR006W",238).
component("YJL090C",228).
component("YIL139C",222).
component("YEL055C",153).
component("YDR419W",145).
component("YDR121W",127).
component("YDL102W",108).
component("YCR014C",98).
component("YBR278W",90).
component("YBL035C",71).
component("YKL035W",252).
component("YHL012W",202).
component("YOL011W",340).
component("YMR008C",297).
component("YMR006C",296).
component("U105_",21).
component("YPL072W",367).
component("YOR124C",350).
component("YNL186W",326).
component("YMR304W",315).
component("YMR223W",310).
component("YKR098C",267).
component("YJL197W",237).
component("YIL156W",223).
component("YFR010W",172).
component("YER151C",166).
component("YER144C",165).
component("YER098W",163).
component("YDR069C",125).
component("YDL122W",109).
component("YBR058C",78).
component("YBL067C",73).
component("YJR019C",239).
component("YFR025C",174).
component("U9_",67).
component("YJL155C",235).
component("U34_",50).
component("U33_",49).
component("U32_",48).
component("U30_",47).
component("U24_",46).
component("YHR044C",207).
component("YHR043C",206).
component("YLR286C",283).
component("YLR160C",279).
component("YLR158C",278).
component("YLR157C",277).
component("YLR155C",276).
component("YDR321W",138).
component("YGL037C",180).
component("U43_",52).
component("U42_",51).
component("YLR308W",286).
component("YLR307W",285).
component("U53_",56).
component("YLR028C",270).
component("YHR144C",213).
component("YHR144C",214).
component("YBR153W",85).
component("YDL238C",119).
component("YNL141W",323).
component("U44_",53).
component("YHR201C",217).
component("YBR111C",82).
component("YCL030C",95).
component("YER005W",155).
component("YLR231C",282).
component("YDR538W",151).
component("YLR134W",275).
component("YLR044C",272).
component("YGR087C",191).
component("YDR380W",140).
component("YDL080C",104).
component("YMR250W",311).
component("YKL184W",261).
component("YEL021W",152).
component("YKL211C",262).
component("YNR033W",337).
component("YKL211C",263).
component("YER090W",161).
component("YDR127W",131).
component("YPL281C",378).
component("YOR393W",364).
component("YMR323W",316).
component("YHR174W",215).
component("YGR254W",198).
component("YGL026C",179).
component("YGR155W",194).
component("YNL316C",332).
component("YCR053W",101).
component("YDR127W",132).
component("YGL148W",184).
component("YFR055W",176).
component("YJL121C",229).
component("YDR007W",120).
component("YOR095C",348).
component("YBR196C",88).
component("U14_",29).
component("YMR105C",303).
component("YKL127W",255).
component("YEL058W",154).
component("YPR060C",381).
component("YHR072W",209).
component("YJL153C",234).
component("YGR264C",200).
component("YGR171C",195).
component("YHR011W",203).
component("YDR023W",121).
component("YGL245W",189).
component("YPR047W",380).
component("YLR060W",274).
component("YFL022C",169).
component("YHR019C",204).
component("YPL160W",369).
component("YLR382C",289).
component("YPL040C",366).
component("YBL076C",75).
component("YER183C",167).
component("YDL141W",112).
component("YDL141W",113).
component("YDL141W",114).
component("YPR145W",386).
component("YGR124W",193).
component("YPL231W",375).
component("YNR016C",335).
component("YKL182W",260).
component("YGR037C",190).
component("YJL087C",226).
component("YOL010W",339).
component("YPR138C",385).
component("YPL265W",376).
component("YOR348C",362).
component("YOL103W",344).
component("YOL020W",341).
component("YNL142W",324).
component("YMR272C",314).
component("YMR202W",307).
component("YMR056C",300).
component("YML123C",294).
component("YLR348C",288).
component("YKR053C",266).
component("YKR039W",265).
component("YKL217W",264).
component("YJR077C",243).
component("YJL134W",231).
component("YGR121C",192).
component("YGL186C",185).
component("YFL055W",171).
component("YER060W-A",159).
component("YER060W",158).
component("YER056C",157).
component("YDR536W",150).
component("YDR508C",149).
component("YDR503C",148).
component("YDR497C",147).
component("YDR294C",137).
component("YDR046C",124).
component("YDL210W",117).
component("YCL025C",94).
component("YBR291C",91).
component("YBR085W",81).
component("YBR069C",80).
component("YBR068C",79).
component("YBL042C",72).
component("YBL030C",70).
component("U7_",64).
component("U6_",62).
component("U69_",61).
component("U5_",59).
