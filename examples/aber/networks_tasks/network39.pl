...
component("YNL280C",287).
component("YLR056W",236).
component("YMR083W",264).
component("YPL231W",318).
component("YGL001C",157).
component("YDR127W",113).
component("YJR139C",215).
component("YNL009W",278).
component("YLR174W",243).
component("YHR183W",192).
component("YGR256W",177).
component("YCL018W",86).
component("YJR078W",212).
component("YMR015C",262).
component("YDR402C",125).
component("YGL055W",160).
component("YJL026W",198).
component("YGR180C",174).
component("YER069W",142).
component("YOR323C",308).
component("YBR166C",80).
component("YNL280C",288).
component("YKL141W",222).
component("YOR375C",311).
component("YDL215C",105).
component("YAL062W",63).
component("U100_",20).
component("U56_",55).
component("YPL023C",313).
component("YGL125W",161).
component("YOR236W",306).
component("YMR145C",267).
component("YDL085W",97).
component("YBR046C",71).
component("YNL052W",279).
component("YMR256C",273).
component("YLR395C",253).
component("YLR038C",234).
component("YIL111W",194).
component("YHR051W",186).
component("YGL191W",165).
component("YGL187C",164).
component("YDL067C",95).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",323).
component("YLL062C",231).
component("YDR410C",126).
component("YJR073C",210).
component("YOL096C",299).
component("YMR120C",266).
component("YJL130C",203).
component("YJL088W",200).
component("YPR074C",328).
component("YBR117C",77).
component("YCL009C",85).
component("YNL071W",280).
component("YNR019W",293).
component("YCR048W",92).
component("U48_",52).
component("YFL017C",149).
component("YPL231W",319).
component("YDL052C",94).
component("U8_",59).
component("YPL231W",320).
component("YLR299W",247).
component("YCR005C",89).
component("YML126C",258).
component("YNL117W",282).
component("YIR031C",197).
component("YOR321W",307).
component("YJR143C",216).
component("YGR199W",175).
component("YDL095W",99).
component("YDL093W",98).
component("YAL023C",62).
component("YMR261C",274).
component("YML100W",256).
component("YBR126C",78).
component("YLR209C",244).
component("YDR354W",122).
component("YFR047C",155).
component("U22_",43).
component("YDR399W",124).
component("YPR069C",327).
component("YDR127W",114).
component("YML082W",255).
component("YJR130C",214).
component("YDR035W",109).
component("YBR249C",82).
component("YHR137W",188).
component("YGL202W",166).
component("YLR027C",232).
component("YKL106W",220).
component("YOL140W",302).
component("YLR438W",254).
component("U51_",53).
component("YJR148W",217).
component("YMR013C",261).
component("YCR036W",91).
component("YCL040W",88).
component("YJR105W",213).
component("YMR208W",269).
component("YHR025W",183).
component("YNR012W",291).
component("YFR019W",153).
component("YDR208W",119).
component("YDR127W",115).
component("YDR147W",118).
component("YER052C",138).
component("U19_",38).
component("U18_",35).
component("U76_",58).
component("YMR220W",270).
component("YDR226W",120).
component("YKL067W",219).
component("YDR454C",128).
component("YOL061W",298).
component("YKL181W",223).
component("YHL011C",179).
component("YER099C",145).
component("YBL068W",68).
component("YOR143C",305).
component("YLR328W",250).
component("U94_",60).
component("YBR029C",70).
component("YPR175W",331).
component("YPL167C",317).
component("YOR330C",309).
component("YOL115W",301).
component("YNL299W",289).
component("YNL262W",286).
component("YNL102W",281).
component("YJR043C",209).
component("YJR006W",208).
component("YJL090C",201).
component("YIL139C",195).
component("YEL055C",135).
component("YDR419W",127).
component("YDR121W",112).
component("YDL102W",100).
component("YCR014C",90).
component("YBR278W",83).
component("YBL035C",65).
component("YKL035W",218).
component("YHL012W",180).
component("YOL011W",296).
component("YMR008C",260).
component("YMR006C",259).
component("U105_",21).
component("YPL072W",315).
component("YOR124C",304).
component("YNL186W",285).
component("YMR304W",276).
component("YMR223W",271).
component("YKR098C",230).
component("YJL197W",207).
component("YIL156W",196).
component("YFR010W",152).
component("YER151C",147).
component("YER144C",146).
component("YER098W",144).
component("YDR069C",111).
component("YDL122W",101).
component("YBR058C",72).
component("YBL067C",67).
component("YFR025C",154).
component("U9_",61).
...
component("U30_",45).
component("U24_",44).
component("YHR044C",185).
component("YHR043C",184).
component("YLR286C",246).
component("YLR160C",242).
component("YLR158C",241).
component("YLR157C",240).
component("YLR155C",239).
component("YDR321W",121).
component("YGL037C",159).
component("U43_",50).
component("U42_",49).
component("YLR308W",249).
component("YLR307W",248).
component("U53_",54).
component("YLR028C",233).
component("YHR144C",189).
component("YHR144C",190).
component("YBR153W",79).
component("YDL238C",106).
component("YNL141W",283).
component("U44_",51).
component("YHR201C",193).
component("YBR111C",76).
component("YER005W",137).
component("YLR231C",245).
component("YDR538W",133).
component("YLR134W",238).
component("YLR044C",235).
component("YGR087C",169).
component("YDR380W",123).
component("YDL080C",96).
component("YMR250W",272).
component("YKL184W",225).
component("YEL021W",134).
component("YKL211C",226).
component("YNR033W",294).
component("YKL211C",227).
component("YER090W",143).
component("YDR127W",116).
component("YPL281C",324).
component("YOR393W",312).
component("YMR323W",277).
component("YHR174W",191).
component("YGR254W",176).
component("YGL026C",158).
component("YGR155W",172).
component("YNL316C",290).
component("YCR053W",93).
component("YDR127W",117).
component("YGL148W",162).
component("YFR055W",156).
component("YJL121C",202).
component("YDR007W",107).
component("YOR095C",303).
component("YBR196C",81).
component("U14_",29).
component("YMR105C",265).
component("YKL127W",221).
component("YEL058W",136).
component("YPR060C",326).
component("YHR072W",187).
component("YJL153C",205).
component("YGR264C",178).
component("YGR171C",173).
component("YHR011W",181).
component("YDR023W",108).
component("YGL245W",167).
component("YPR047W",325).
component("YLR060W",237).
component("YFL022C",150).
component("YHR019C",182).
component("YPL160W",316).
component("YLR382C",252).
component("YPL040C",314).
component("YBL076C",69).
component("YER183C",148).
component("YDL141W",102).
component("YDL141W",103).
component("YPR145W",330).
component("YGR124W",171).
component("YPL231W",321).
component("YNR016C",292).
component("YKL182W",224).
component("YGR037C",168).
component("YJL087C",199).
component("YOL010W",295).
component("YPR138C",329).
component("YPL265W",322).
component("YOR348C",310).
component("YOL103W",300).
component("YOL020W",297).
component("YNL142W",284).
component("YMR272C",275).
component("YMR202W",268).
component("YMR056C",263).
component("YML123C",257).
component("YLR348C",251).
component("YKR053C",229).
component("YKR039W",228).
component("YJR077C",211).
component("YJL134W",204).
component("YGR121C",170).
component("YGL186C",163).
component("YFL055W",151).
component("YER060W-A",141).
component("YER060W",140).
component("YER056C",139).
component("YDR536W",132).
component("YDR508C",131).
component("YDR503C",130).
component("YDR497C",129).
component("YDR046C",110).
component("YDL210W",104).
