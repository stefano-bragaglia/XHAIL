...
component("YLR056W",600).
component("YKR009C",581).
component("YMR083W",662).
component("YPL231W",804).
component("U46_",123).
component("YBR149W",204).
component("YBR149W",205).
component("YJR159W",550).
component("YGL001C",385).
component("YHR063C",462).
component("YML056C",647).
component("YLR432W",640).
component("YHR216W",481).
component("YAR075W",166).
component("YAR073W",165).
component("YCL030C",226).
component("YDR127W",292).
component("YJR139C",546).
component("YKL085W",557).
component("YOR136W",754).
component("YNL009W",685).
component("YLR174W",614).
component("YDL066W",247).
component("YHR183W",475).
component("YGR256W",442).
component("YNL241C",701).
component("YOL059W",735).
component("YDL022W",241).
component("YCL018W",224).
component("YLR355C",634).
component("YIL074C",487).
component("YER081W",358).
component("YML054C",646).
component("YIL155C",493).
component("YEL024W",336).
component("YKR066C",586).
component("YKL026C",553).
component("YIR037W",503).
component("YBR244W",213).
component("YJR078W",540).
component("U58_",133).
component("U107_",26).
component("YGR255C",441).
component("U108_",27).
component("YMR015C",659).
component("YDR402C",318).
component("YGL055W",393).
component("YJL026W",504).
component("YIL066C",486).
component("YGR180C",428).
component("YER070W",356).
component("U37_",115).
component("U36_",114).
component("U35_",113).
component("YDR158W",300).
component("YJR009C",530).
component("YJL052W",505).
component("YGR192C",430).
component("YPL276W",815).
component("YPL275W",814).
component("YOR388C",782).
component("YOR374W",779).
component("YER073W",357).
component("U68_",139).
component("YGL154C",400).
component("U55_",130).
component("YER069W",355).
...
component("U57_",132).
component("YKL216W",579).
component("YDR044W",281).
component("YER014W",344).
component("YKR009C",582).
component("YIL160C",495).
component("YGL205W",405).
component("YKL141W",563).
component("YJR051W",535).
component("YEL047C",339).
component("YDL171C",268).
component("YOR375C",780).
component("YDL215C",272).
component("YAL062W",164).
component("U100_",20).
component("YBR035C",188).
component("YMR189W",671).
component("U56_",131).
component("YKR080W",588).
component("YPL023C",786).
component("YGL125W",397).
component("YOR236W",766).
component("YGR204W",434).
component("YBR084W",194).
component("YLR142W",608).
component("U65_",137).
component("U62_",135).
component("YHR068W",463).
component("YKL150W",565).
component("YIL043C",484).
component("YHR042W",457).
component("YOR221C",764).
component("YMR145C",668).
component("YML120C",652).
component("YKL192C",573).
component("YKL055C",555).
component("YER061C",351).
component("YDL085W",250).
component("YBR046C",190).
component("YMR145C",669).
component("YML120C",653).
component("YKL192C",574).
component("YDL085W",251).
component("YPL017C",785).
component("YFL018C",373).
component("YPL091W",789).
component("YER042W",345).
component("YPR167C",834).
component("YNL052W",688).
component("YMR256C",679).
component("YLR395C",638).
component("YLR038C",598).
component("YIL111W",490).
component("YHR051W",461).
component("YGL191W",403).
component("YGL187C",402).
component("YDL067C",248).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",811).
component("YBR034C",187).
component("YPL273W",813).
component("YLL062C",594).
component("YDR410C",321).
component("YKR069W",587).
component("YOL096C",738).
component("U47_",124).
component("YER091C",362).
component("YJR073C",538).
component("YML008C",643).
component("YDL033C",243).
component("YOL096C",739).
component("YLR172C",613).
component("YBR263W",217).
component("YDR408C",320).
component("YMR120C",667).
component("YLR028C",596).
component("YBL013W",167).
component("YJL130C",514).
component("YJL088W",508).
component("YPR074C",827).
component("YBR117C",200).
component("YLR354C",633).
component("YGR043C",415).
component("YMR108W",665).
component("YCL009C",223).
component("YMR062C",661).
component("YNL071W",689).
component("YIL160C",496).
component("YNR019W",718).
component("YCR048W",237).
component("U48_",125).
component("YNL277W",707).
component("YDR232W",303).
component("YFL017C",372).
component("YPL231W",805).
component("YER061C",352).
component("U86_",155).
component("YPL001W",784).
component("YDL052C",245).
component("U8_",158).
component("YDR148C",298).
component("YOR377W",781).
component("YGR177C",427).
component("YPL231W",806).
component("YLR195C",616).
component("YLR299W",625).
component("YPR001W",817).
component("YNR001C",714).
component("YCR005C",233).
component("YML126C",655).
component("YDL182W",269).
component("YDL131W",259).
component("YNL117W",693).
component("YIR031C",501).
component("YPR160W",833).
component("YOR321W",771).
component("YJR143C",547).
component("YGR199W",432).
component("YDL095W",254).
component("YDL093W",253).
component("YAL023C",163).
component("YLR258W",622).
component("YFR015C",379).
component("YPL227C",802).
component("YNL029C",686).
component("YIL085C",489).
component("YMR261C",680).
component("YML100W",651).
component("YBR126C",203).
component("YNL192W",700).
component("YBR038W",189).
component("YBR023C",185).
component("YEL011W",334).
component("YLR209C",617).
component("U104_",24).
component("U103_",23).
component("YOR209C",762).
component("YMR300C",682).
component("YDR354W",314).
component("YFR047C",382).
component("YJR133W",545).
component("U22_",102).
component("YLR209C",618).
component("YDR399W",316).
component("YPR176C",836).
component("YPL172C",796).
component("YNR041C",721).
component("YMR101C",663).
component("YDL090C",252).
component("YBR003W",178).
component("YBR002C",177).
component("YJL167W",522).
component("YJL167W",523).
component("YNL256W",703).
component("YPR069C",825).
component("YDR127W",293).
component("YHR190W",476).
component("YHR068W",464).
component("YLR303W",626).
component("YGR012W",412).
component("YML082W",650).
component("YJR130C",544).
component("YDR035W",279).
component("YBR249C",214).
component("YLR180W",615).
component("YDR502C",327).
component("YOR274W",769).
component("YOL143C",744).
component("YBR256C",216).
component("YHR137W",470).
component("YGL202W",404).
component("YLR027C",595).
component("YKL106W",559).
component("YOL140W",743).
component("YLR438W",642).
component("YKL104C",558).
component("YGR019W",413).
component("YDR111C",290).
component("U64_",136).
component("U51_",128).
component("YJR148W",548).
component("YHR208W",479).
component("YOR184W",759).
component("YNR058W",724).
component("YGL253W",410).
component("YFR053C",383).
component("YMR013C",658).
component("YMR205C",673).
component("YGR240C",438).
component("YLR240W",621).
component("YKL203C",576).
component("YJR066W",537).
component("YCR036W",236).
component("YGR194C",431).
component("YCL040W",229).
component("YJR105W",542).
component("U16_",67).
component("YPL188W",798).
component("YJR049C",534).
component("YEL041W",337).
component("YKL001C",551).
component("YDR236C",304).
component("YML070W",649).
component("YFL053W",376).
component("YHL032C",449).
component("YLR133W",605).
component("YDR531W",331).
component("U83_",152).
component("U82_",151).
component("U81_",150).
component("YMR208W",674).
component("YPL203W",799).
component("YOR061W",748).
component("YKL166C",567).
component("YJL164C",521).
component("YIL035C",483).
component("YHR205W",478).
component("YHR102W",468).
component("YGL019W",389).
component("YHR025W",456).
component("YNR012W",716).
component("YPR121W",830).
component("YPL258C",808).
component("YOL055C",731).
component("YPL214C",801).
component("U1_",87).
component("YDR009W",277).
component("YBR020W",184).
component("YFR019W",380).
component("YDR208W",301).
...
component("YHL012W",448).
component("YHR123W",469).
component("YNL130C",694).
component("YPL148C",793).
component("YOR251C",768).
component("YGR286C",444).
component("YDR058C",286).
component("YOL011W",727).
component("YMR008C",657).
component("YMR006C",656).
component("U105_",25).
component("U101_",21).
component("YJL068C",506).
component("YPL072W",788).
component("YOR124C",752).
component("YNL186W",699).
component("YMR304W",683).
component("YMR223W",677).
component("YKR098C",591).
component("YJL197W",524).
component("YIL156W",494).
component("YFR010W",378).
component("YER151C",367).
component("YER144C",366).
component("YER098W",363).
component("YDR069C",287).
component("YDL122W",258).
component("YBR058C",191).
component("YBL067C",172).
component("YJR019C",532).
component("YDR272W",307).
component("U84_",153).
component("YDR481C",325).
component("YLR377C",636).
component("YDR074W",288).
component("YFR025C",381).
component("YPL179W",797).
component("YNR032W",719).
component("YML057W",648).
component("YML016C",644).
component("YLR433C",641).
component("YGR123C",421).
component("YER133W",365).
component("YER089C",360).
component("YDR436W",323).
component("YDR075W",289).
component("YDL188C",270).
component("YDL134C",260).
component("YDL047W",244).
component("YDL006W",239).
component("YBR125C",202).
component("YBL056W",171).
component("YPR073C",826).
component("YHR215W",480).
component("YDL024C",242).
component("YBR093C",198).
component("YBR092C",197).
component("YIL053W",485).
component("YER062C",353).
component("YHR046C",460).
component("U9_",162).
component("YGR208W",437).
component("YPL228W",803).
component("YMR180C",670).
component("YDL236W",273).
component("YJL155C",520).
component("U34_",112).
component("U33_",111).
component("U32_",110).
component("U30_",109).
...
component("U26_",104).
component("U24_",103).
component("YHR044C",459).
component("YHR043C",458).
component("YOL064C",737).
component("YPL268W",812).
component("YOR360C",778).
component("YGL248W",409).
component("YKR031C",583).
component("YGL027C",391).
component("YLR286C",624).
component("YJR153W",549).
component("YJL221C",528).
component("YJL216C",526).
component("YIL172C",500).
component("YGR292W",446).
component("YGR287C",445).
component("YBR299W",222).
component("YBR184W",209).
component("YIL162W",497).
component("YPR026W",820).
component("YDR001C",275).
component("YBR001C",176).
component("YDR400W",317).
component("U102_",22).
component("YER043C",346).
component("YNL045W",687).
component("YLR160C",612).
component("YLR158C",611).
component("YLR157C",610).
component("YLR155C",609).
component("YDR321W",312).
component("YGL037C",392).
component("U43_",121).
component("U42_",120).
component("YDR242W",305).
component("YLR308W",629).
component("YLR307W",628).
component("U53_",129).
component("YLR420W",639).
component("YPL111W",791).
component("YIR032C",502).
component("YLR028C",597).
component("YHR144C",472).
component("YHR144C",473).
component("YCL030C",227).
component("YNL141W",695).
component("YBR153W",206).
component("YDL238C",274).
component("YNL141W",696).
...
component("YHR201C",477).
component("YBR111C",199).
component("YBR252W",215).
component("YCL030C",228).
component("YER005W",343).
component("YBL099W",175).
component("YLR231C",619).
component("U88_",156).
component("YDR538W",333).
component("YLR134W",606).
component("YLR044C",599).
component("YGR087C",418).
component("YDR380W",315).
component("YDL080C",249).
component("YMR250W",678).
component("YKL184W",572).
component("YEL021W",335).
component("YNR043W",722).
component("U93_",160).
component("YDR047W",284).
component("YKL211C",577).
component("YKR097W",590).
component("YOL052C",730).
component("YGR170W",425).
component("YDR294C",308).
component("YEL046C",338).
component("YNR033W",720).
component("YPR006C",818).
component("YER065C",354).
component("YKL211C",578).
component("YER090W",361).
component("YDR127W",295).
component("YPL281C",816).
component("YOR393W",783).
component("YMR323W",684).
component("YHR174W",474).
component("YGR254W",440).
component("YPL262W",809).
component("YGL026C",390).
component("YGR155W",424).
component("YLR304C",627).
component("YJL200C",525).
component("YGL009C",387).
component("YNL316C",712).
component("YKL182W",570).
component("YPL212C",800).
component("YNL292W",710).
component("YGL063W",395).
component("YFL001W",370).
component("YCR053W",238).
component("YDR127W",296).
component("YGL148W",399).
component("YIL168W",499).
component("YIL167W",498).
component("YCL064C",231).
component("YCL064C",232).
component("YHR018C",452).
component("YLR359W",635).
component("YFR055W",384).
component("YJL121C",511).
component("YBR019C",182).
component("YBR019C",183).
component("YDR050C",285).
component("YDR007W",276).
component("YOR095C",750).
component("YBR196C",210).
component("YGL001C",386).
component("YPL117C",792).
component("U14_",55).
component("YOL056W",733).
component("YKL152C",566).
component("YDL021W",240).
component("YMR105C",664).
component("YKL127W",561).
component("YEL058W",341).
component("YPR060C",824).
component("YHR072W",465).
component("YJL153C",519).
component("YGR264C",443).
component("YGR171C",426).
component("YHR011W",451).
component("YDR023W",278).
component("YPL104W",790).
component("YLL018C",592).
component("YPR081C",828).
component("YBR121C",201).
component("YHR020W",455).
component("YER087W",359).
component("YOL033W",729).
component("YGL245W",408).
component("YOR168W",757).
component("YHR091C",467).
component("YDR341C",313).
component("YOL097C",740).
component("YDR268W",306).
component("YPR047W",823).
component("YLR060W",601).
component("YFL022C",374).
component("YPR033C",821).
component("YHR019C",453).
component("YHR019C",454).
component("YKL194C",575).
component("YIL078W",488).
component("YPL160W",794).
component("YLR382C",637).
component("YPL040C",787).
component("YBL076C",174).
component("YNL073W",690).
component("YDR037W",280).
component("YOR335C",774).
component("YGR094W",419).
component("YGR244C",439).
component("YPR035W",822).
component("YIL145C",492).
component("U89_",157).
component("YOR241W",767).
component("YMR113W",666).
component("YKL132C",562).
component("YJL101C",510).
component("YGL234W",406).
component("YER183C",369).
component("U90_",159).
component("YNR057C",723).
component("YDL141W",262).
component("YDL141W",263).
component("YGL234W",407).
component("YDL141W",264).
component("YGR204W",436).
component("YOL058W",734).
component("YDL141W",265).
component("YHR074W",466).
component("YMR217W",675).
component("YPR145W",832).
component("YGR124W",422).
...
component("YKL182W",571).
component("YGR037C",414).
component("YOR005C",746).
component("YDL164C",267).
component("YJL087C",507).
component("YOL010W",726).
component("YPR138C",831).
component("YPL265W",810).
component("YOR348C",777).
component("YOR192C",760).
component("YOR171C",758).
component("YOR130C",753).
component("YOR071C",749).
component("YOR011W",747).
component("YOL156W",745).
component("YOL103W",741).
component("YOL020W",728).
component("YNL318C",713).
component("YNL270C",706).
component("YNL142W",697).
component("YMR272C",681).
component("YMR202W",672).
component("YMR056C",660).
component("YML123C",654).
component("YLR348C",632).
component("YLR260W",623).
component("YLR237W",620).
component("YLR138W",607).
component("YLR100C",604).
component("YLR092W",603).
component("YLR081W",602).
component("YLL061W",593).
component("YKR093W",589).
component("YKR053C",585).
component("YKR039W",584).
component("YKL217W",580).
component("YKL120W",560).
component("YKL004W",552).
component("YJR095W",541).
component("YJR077C",539).
component("YJL219W",527).
component("YJL134W",516).
component("YJL129C",513).
component("YHL036W",450).
component("YGR191W",429).
component("YGR125W",423).
component("YGR121C",420).
component("YGR065C",417).
component("YGR055W",416).
component("YGL186C",401).
component("YFL055W",377).
component("YFL011W",371).
component("YER060W-A",350).
component("YER060W",349).
component("YER056C",348).
component("YEL063C",342).
component("YDR536W",332).
component("YDR508C",329).
component("YDR503C",328).
component("YDR497C",326).
component("YDR297W",310).
component("YDR294C",309).
component("YDR046C",283).
component("YDL210W",271).
component("YCL025C",225).
component("YBR298C",221).
component("YBR294W",220).
component("YBR291C",219).
component("YBR085W",196).
component("YBR069C",193).
component("YBR068C",192).
component("YBL042C",170).
component("YBL030C",168).
component("U85_",154).
component("U7_",149).
component("U79_",148).
component("U75_",146).
