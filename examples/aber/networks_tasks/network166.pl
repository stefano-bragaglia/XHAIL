...
component("YLR056W",716).
component("YGR060W",498).
component("YKR009C",695).
component("YMR083W",792).
component("YPL231W",960).
component("U46_",145).
component("YBR149W",248).
component("YBR149W",249).
component("YJR159W",660).
component("YGL001C",464).
component("YHR063C",553).
component("YBR153W",250).
component("YML056C",773).
component("YLR432W",761).
component("YHR216W",576).
component("YAR075W",203).
component("YAR073W",202).
component("YCL030C",273).
component("YDR127W",352).
component("YJR139C",655).
component("YML075C",776).
component("YLR450W",764).
component("YOL126C",885).
component("YKL085W",669).
component("YDL078C",302).
component("YKL029C",664).
component("YOR136W",902).
component("YNL037C",823).
component("YNL009W",821).
component("YLR174W",733).
component("YDL066W",300).
component("YHR183W",570).
component("YGR256W",529).
component("YNL241C",839).
component("YOL059W",877).
component("YDL022W",292).
component("YCL018W",271).
component("YLR355C",755).
component("YIL074C",582).
component("YER081W",432).
component("YML054C",772).
component("YDL174C",325).
component("YIL155C",591).
component("YPR191W",997).
component("YOR065W",893).
component("YJL166W",626).
component("YHR001W-A",539).
component("YGR183C",513).
component("YFR033C",460).
component("YEL024W",405).
component("YDR529C",397).
component("YBL045C",210).
component("Q0105",19).
component("YKR066C",700).
component("YKL026C",663).
component("YIR037W",602).
component("YBR244W",259).
component("YJR078W",646).
component("U58_",157).
component("U107_",28).
component("YGR255C",528).
component("U108_",29).
component("YBL098W",215).
component("YMR015C",789).
component("YHR007C",540).
component("YDR402C",384).
component("YGL055W",473).
component("YGR175C",510).
component("YJR104C",649).
component("YHR008C",541).
component("YJL026W",605).
component("YIL066C",581).
...
component("YJL052W",607).
component("YGR192C",516).
component("YBR006W",220).
component("YPL276W",971).
component("YPL275W",970).
component("YOR388C",934).
component("YOR374W",931).
component("YER073W",431).
component("U68_",168).
component("YGL154C",480).
component("YBR115C",243).
component("U55_",154).
component("YER069W",428).
component("YOR323C",922).
component("U2_",129).
component("YER178W",443).
component("YBR221C",257).
component("YIL125W",588).
component("YBR166C",253).
component("YNL280C",847).
component("YGL012W",467).
component("YKL182W",682).
component("U57_",156).
component("YKL216W",692).
component("YDR044W",341).
component("YER014W",415).
component("YKR009C",696).
component("YIL160C",593).
component("YGL205W",485).
component("YMR118C",797).
component("YLR164W",731).
component("YLL041C",707).
component("YKL148C",677).
component("YKL141W",675).
component("YJL045W",606).
component("YDR178W",361).
component("YJR051W",641).
component("YEL047C",408).
component("YDL171C",324).
component("YOR375C",932).
component("YDL215C",329).
component("YAL062W",200).
component("U99_",195).
component("U100_",22).
component("YBR035C",230).
component("YMR189W",804).
component("U56_",155).
component("YNR050C",862).
...
component("YLR142W",724).
component("U65_",165).
component("U63_",163).
component("U62_",162).
component("YOR356W",929).
component("YHR068W",554).
component("YKL150W",678).
component("YIL043C",579).
component("YHR042W",548).
component("YOR221C",913).
component("YMR145C",800).
component("YML120C",781).
component("YKL192C",686).
component("YKL055C",666).
component("YER061C",424).
component("YDL085W",304).
component("YBR046C",233).
component("YMR145C",801).
component("YML120C",782).
component("YKL192C",687).
component("YDL085W",305).
component("YFR030W",459).
component("YPL017C",937).
component("YFL018C",448).
component("YPL091W",943).
component("YDR353W",379).
component("YER042W",417).
component("YPR167C",991).
component("YJR137C",654).
component("YNL052W",825).
component("YMR256C",812).
component("YLR395C",759).
component("YLR038C",714).
component("YIL111W",586).
...
component("Q0250",20).
component("Q0045",18).
component("YPL266W",967).
component("YML110C",780).
component("YBR034C",229).
component("YPL273W",969).
component("YLL062C",710).
component("YDR410C",387).
component("YKR069W",701).
component("YOL096C",880).
component("U47_",146).
component("YER091C",436).
component("YJR073C",644).
component("YML008C",765).
component("YDL033C",294).
component("YOL096C",881).
component("YLR172C",732).
component("YBR263W",263).
component("YDR019C",337).
component("YDR408C",386).
component("YMR120C",798).
component("YLR028C",712).
component("YBL013W",204).
component("YJL130C",618).
component("YJL088W",612).
component("YPR074C",984).
component("YBR117C",244).
component("YLR354C",754).
component("YGR043C",496).
component("YMR108W",795).
component("YCL009C",270).
component("YMR062C",791).
component("YNL071W",826).
component("YIL160C",594).
component("YNR019W",856).
component("YCR048W",287).
component("U48_",147).
component("YNL277W",845).
component("YDR232W",364).
component("YFL017C",447).
...
component("YML042W",771).
component("YOR377W",933).
component("YGR177C",511).
component("YPL231W",962).
component("YGR147C",506).
component("YDL040C",295).
component("YPL028W",939).
component("YLR195C",735).
component("YLR299W",745).
component("YGL017W",468).
component("YPR001W",973).
component("YNR001C",852).
component("YCR005C",282).
component("YML126C",784).
component("YDL182W",326).
component("YDL131W",314).
component("YNL117W",830).
component("YIR031C",600).
component("YPR160W",990).
component("YOR321W",921).
component("YJR143C",656).
component("YGR199W",518).
component("YDL095W",309).
component("YDL093W",308).
component("YAL023C",197).
component("YLR258W",742).
component("YFR015C",456).
component("YPL227C",958).
component("YOR103C",897).
component("YOR085W",895).
component("YMR149W",802).
component("YML019W",767).
component("YJL002C",603).
component("YEL002C",402).
component("YDL232W",330).
component("YCL043C",277).
component("YNL029C",822).
component("YIL085C",584).
component("YMR261C",813).
component("YML100W",778).
component("YBR126C",247).
component("YNL192W",837).
component("YBR038W",232).
component("YBR023C",227).
component("YEL011W",403).
component("YMR306W",819).
component("YLR342W",752).
component("YGR032W",494).
component("YPR183W",994).
component("YLR209C",736).
component("U104_",26).
component("U103_",25).
component("YMR271C",814).
component("YML106W",779).
component("YOR209C",911).
component("YMR300C",817).
component("YDR354W",380).
component("YFR047C",461).
component("YJR133W",653).
component("U22_",123).
component("YLR209C",737).
component("YML022W",768).
component("YDR441C",390).
component("YDR399W",382).
component("YPR176C",993).
component("YPL172C",951).
component("YNR041C",860).
component("YMR101C",793).
component("YDL090C",307).
component("YBR003W",219).
component("YBR002C",218).
component("YJL167W",627).
component("YJL167W",628).
component("YNL256W",841).
component("YPR069C",982).
component("YDR127W",353).
component("YHR190W",571).
component("YLR146C",725).
component("YHR068W",555).
component("YLR303W",746).
component("YGR012W",492).
component("YML082W",777).
component("YJR130C",652).
component("YDR035W",339).
component("YBR249C",260).
component("YLR180W",734).
component("YDR502C",394).
component("YOR274W",918).
component("YOL143C",888).
component("YBR256C",262).
component("YHR137W",564).
component("YGL202W",484).
component("YLR027C",711).
component("YKL106W",671).
component("YOL140W",887).
component("YLR438W",763).
component("YKL104C",670).
component("YGR019W",493).
component("YDR111C",350).
component("U64_",164).
component("U61_",161).
component("U51_",151).
component("YJR148W",657).
component("YHR208W",574).
component("YFL030W",450).
component("YOR184W",908).
component("YNR058W",864).
component("YIL116W",587).
component("YGL253W",490).
component("YFR053C",462).
component("YOL136C",886).
component("YIL107C",585).
component("YMR013C",788).
component("YMR205C",806).
component("YGR240C",524).
component("YOL016C",869).
component("YFR014C",455).
component("YLR240W",740).
component("YKL203C",689).
component("YJR066W",643).
component("YCR036W",286).
component("YGR194C",517).
component("YCL040W",276).
component("YJR105W",650).
component("U16_",77).
component("YPL188W",953).
component("YJR049C",640).
component("YEL041W",406).
component("U96_",194).
component("YKL001C",661).
component("YDR236C",365).
component("YML070W",775).
component("YFL053W",452).
component("YHL032C",537).
component("YLR133W",721).
component("YDR531W",399).
component("U83_",183).
component("U82_",182).
component("U81_",181).
component("YMR208W",807).
component("YPL203W",954).
component("YOR061W",892).
component("YKL166C",680).
component("YJL164C",625).
component("YIL035C",578).
component("YHR205W",573).
component("YHR102W",562).
component("YGL019W",469).
component("YHR025W",547).
component("YOR347C",927).
component("YAL038W",198).
component("YNR012W",854).
component("YPR121W",987).
component("YPL258C",964).
component("YOL055C",873).
component("YPL214C",957).
component("U1_",103).
component("YDR009W",336).
component("YBR020W",226).
component("YFR019W",457).
component("YDR208W",362).
component("YDR127W",354).
component("U21_",115).
component("U20_",110).
component("YDR147W",357).
component("YDR300C",373).
component("YCR012W",283).
...
component("U17_",84).
component("U76_",177).
component("YMR220W",809).
component("YER170W",442).
component("YDR226W",363).
component("YKL067W",668).
component("YOL055C",874).
component("YDR454C",391).
component("YOL061W",878).
component("YKL181W",681).
component("YHL011C",534).
component("YER099C",438).
component("YBL068W",213).
component("YOR143C",903).
component("YNL256W",842).
component("YLR328W",750).
component("YBR018C",222).
component("YBR018C",223).
component("YDL055C",299).
component("YGR007W",491).
component("YGR202C",519).
component("YLR328W",751).
component("YKR002W",694).
component("YDL045C",296).
component("YDL103C",312).
component("U94_",193).
...
component("YPR190C",996).
component("YPR187W",995).
component("YPR110C",986).
component("YPR010C",975).
component("YOR341W",926).
component("YOR340C",925).
component("YOR224C",914).
component("YOR210W",912).
component("YOR207C",910).
component("YOR151C",904).
component("YOR116C",898).
component("YOL005C",866).
component("YNR003C",853).
component("YNL248C",840).
component("YNL151C",835).
component("YNL113W",829).
component("YKL144C",676).
component("YJR063W",642).
component("YJL148W",622).
component("YJL140W",621).
component("YIL021W",577).
component("YHR143W-A",565).
component("YGL070C",476).
component("YFL036W",451).
component("YDR404C",385).
component("YDR156W",359).
component("YDR045C",342).
component("YDL150W",322).
component("YDL140C",316).
component("YBR154C",252).
component("YPR175W",992).
component("YPL167C",950).
component("YOR330C",923).
component("YOL115W",884).
component("YNL299W",849).
component("YNL262W",843).
component("YNL102W",828).
component("YJR043C",639).
component("YJR006W",635).
component("YJL090C",613).
component("YIL139C",589).
component("YEL055C",409).
component("YDR419W",388).
component("YDR121W",351).
component("YDL102W",311).
component("YCR014C",284).
component("YBR278W",264).
component("YBL035C",207).
component("YKL035W",665).
component("YHL012W",535).
component("YHR123W",563).
component("YBR243C",258).
component("YNL130C",831).
component("YDL142C",321).
component("YPL148C",948).
component("YOR251C",917).
component("YGR286C",531).
component("YJL068C",608).
component("YDR058C",346).
component("YNR034W",859).
component("YHR163W",568).
component("YGR248W",526).
...
component("U105_",27).
component("U101_",23).
component("YJL068C",609).
component("YPL072W",942).
component("YOR124C",899).
component("YNL186W",836).
component("YMR304W",818).
component("YMR223W",810).
component("YKR098C",705).
component("YJL197W",629).
component("YIL156W",592).
component("YFR010W",454).
component("YER151C",441).
component("YER144C",440).
component("YER098W",437).
component("YDR069C",347).
component("YDL122W",313).
component("YBR058C",234).
component("YBL067C",212).
component("YJR019C",638).
component("YDR272W",368).
component("U84_",184).
component("YDR481C",392).
component("YLR377C",757).
component("YDR074W",348).
component("YFR025C",458).
component("YPL179W",952).
component("YNR032W",857).
component("YML057W",774).
component("YML016C",766).
component("YLR433C",762).
component("YGR123C",503).
component("YER133W",439).
component("YER089C",434).
component("YDR436W",389).
...
component("YPR073C",983).
component("YHR215W",575).
component("YDL024C",293).
component("YBR093C",241).
component("YBR092C",240).
component("YIL053W",580).
component("YER062C",426).
component("YHR046C",551).
component("U9_",196).
component("YGR208W",523).
component("YPL228W",959).
component("YMR180C",803).
component("YDL236W",331).
component("YJL155C",624).
component("U34_",134).
component("U33_",133).
component("U32_",132).
component("U31_",131).
...
component("U26_",125).
component("U24_",124).
component("YHR044C",550).
component("YHR043C",549).
component("YOL064C",879).
component("YPL268W",968).
component("YOR360C",930).
component("YGL248W",489).
component("YKR031C",697).
component("YPL206C",955).
component("YGL027C",471).
component("YLR286C",744).
component("YJR153W",658).
component("YJL221C",634).
component("YJL216C",632).
component("YIL172C",598).
component("YGR292W",533).
component("YGR287C",532).
component("YBR299W",269).
component("YBR184W",254).
component("YIL162W",595).
component("YPR026W",976).
component("YDR001C",334).
component("YBR001C",217).
component("YDR400W",383).
component("YML035C",769).
component("YJL070C",610).
component("YBR284W",265).
component("U102_",24).
component("YER043C",418).
component("YNL045W",824).
component("YLR160C",730).
component("YLR158C",729).
component("YLR157C",728).
component("YLR155C",727).
component("YDR321W",374).
component("YGL037C",472).
component("U43_",143).
component("U42_",142).
component("YMR293C",816).
component("YDR242W",366).
component("YLR308W",749).
component("YLR307W",748).
component("U53_",152).
component("YLR420W",760).
component("YPL111W",946).
component("YIR032C",601).
component("YIR029W",599).
component("YPR062W",981).
component("YMR120C",799).
component("YLR028C",713).
component("YHR144C",566).
component("YHR144C",567).
component("YCL030C",274).
component("YNL141W",832).
component("YBL033C",206).
component("YBR153W",251).
component("YDL238C",332).
component("YNL141W",833).
component("YLR245C",741).
component("YML035C",770).
component("YGR204W",521).
component("YBR084W",238).
component("YJL126W",616).
component("U44_",144).
component("YDL100C",310).
component("U40_",140).
component("U39_",138).
component("YBR011C",221).
component("YHR201C",572).
component("YBR111C",242).
component("YBR252W",261).
component("YCL030C",275).
component("YER005W",414).
component("YBL099W",216).
component("U60_",160).
component("YLR231C",738).
component("U88_",187).
component("YDR538W",401).
component("YLR134W",722).
component("YLR044C",715).
component("YGR087C",500).
component("YDR380W",381).
component("YDL080C",303).
component("YMR250W",811).
component("YKL184W",685).
component("YOR128C",900).
component("YEL021W",404).
component("YNR043W",861).
component("U93_",192).
component("YDR047W",344).
component("U54_",153).
component("YKL211C",690).
component("YKR097W",704).
component("YOL052C",872).
component("YGR170W",508).
component("YKL060C",667).
component("YDR294C",370).
component("YEL046C",407).
component("YNR033W",858).
component("YPR006C",974).
component("YER065C",427).
component("YKL211C",691).
component("YER090W",435).
component("YDR127W",355).
component("YPL281C",972).
component("YOR393W",935).
component("YMR323W",820).
component("YHR174W",569).
component("YGR254W",527).
component("YPL262W",965).
component("YGL026C",470).
component("YGR155W",507).
component("YLR304C",747).
component("YJL200C",630).
component("YGL009C",466).
component("YNL316C",850).
component("YKL182W",683).
component("YPL212C",956).
component("YNL292W",848).
component("YGL063W",475).
component("YFL001W",445).
component("YOR278W",919).
component("U49_",148).
component("YCR053W",288).
component("YDR127W",356).
component("YGL148W",479).
component("YIL168W",597).
component("YIL167W",596).
component("YCL064C",280).
component("YCL064C",281).
component("YHR018C",543).
component("YLR359W",756).
component("YFR055W",463).
component("YJL005W",604).
component("YOR176W",907).
component("YJL121C",615).
component("YBR019C",224).
component("YBR019C",225).
component("U59_",158).
component("YDR050C",345).
component("YDR007W",335).
component("YOR095C",896).
component("YER003C",413).
component("YBR196C",255).
component("YGL001C",465).
component("YPL117C",947).
component("U14_",62).
component("YOL056W",875).
component("YKL152C",679).
component("YDL021W",291).
component("YMR105C",794).
component("YKL127W",673).
component("YEL058W",410).
component("YPR060C",980).
component("YHR072W",556).
component("YJL153C",623).
component("YPL097W",944).
component("YGR185C",514).
component("YGR264C",530).
component("YGR171C",509).
component("YHR011W",542).
component("YDR023W",338).
component("YPL104W",945).
component("YLL018C",706).
component("YPR081C",985).
component("YBR121C",245).
component("YHR020W",546).
component("YER087W",433).
component("YOL033W",871).
component("YGL245W",488).
component("YOR168W",905).
component("YHR091C",558).
component("YDR341C",375).
component("YOL097C",882).
component("YDR268W",367).
component("YPR047W",979).
component("YLR060W",717).
component("YFL022C",449).
component("YPR033C",977).
component("YHR019C",544).
component("YHR019C",545).
component("YKL194C",688).
component("YIL078W",583).
component("YPL160W",949).
component("YLR382C",758).
component("YPL040C",940).
component("YBL076C",214).
component("YNL073W",827).
component("YDR037W",340).
component("YOR335C",924).
component("YGR094W",501).
component("YLR153C",726).
component("YAL054C",199).
component("YGR244C",525).
component("YPR035W",978).
component("YIL145C",590).
component("U89_",188).
component("YOR241W",916).
component("YMR113W",796).
component("YKL132C",674).
component("YJL101C",614).
component("U92_",191).
component("YAR015W",201).
component("YGL234W",486).
component("YER183C",444).
component("U90_",190).
...
component("YJR103W",648).
component("YBL039C",208).
component("YGR204W",522).
component("YNL220W",838).
component("YOL058W",876).
component("YDL141W",320).
component("YHR074W",557).
component("YMR217W",808).
component("YPR145W",989).
component("YGR124W",504).
component("YOR303W",920).
component("YJR109C",651).
component("YJL130C",619).
component("YGL062W",474).
...
component("YDL164C",323).
component("YJL087C",611).
component("YOL010W",867).
component("YPR138C",988).
component("YPL265W",966).
component("YPL057C",941).
component("YOR348C",928).
component("YOR192C",909).
component("YOR171C",906).
component("YOR130C",901).
component("YOR071C",894).
component("YOR011W",891).
component("YOL156W",889).
component("YOL103W",883).
component("YOL020W",870).
component("YNR072W",865).
component("YNL318C",851).
component("YNL270C",844).
component("YNL142W",834).
component("YMR272C",815).
component("YMR202W",805).
component("YMR056C",790).
component("YMR011W",787).
component("YML123C",783).
component("YLR348C",753).
component("YLR260W",743).
component("YLR237W",739).
component("YLR138W",723).
component("YLR100C",720).
component("YLR092W",719).
component("YLR081W",718).
component("YLL061W",709).
component("YLL043W",708).
component("YKR093W",703).
component("YKR053C",699).
component("YKR039W",698).
component("YKL217W",693).
component("YKL120W",672).
component("YKL004W",662).
component("YJR158W",659).
component("YJR095W",647).
component("YJR077C",645).
component("YJL219W",633).
component("YJL214W",631).
component("YJL134W",620).
component("YJL129C",617).
component("YHR096C",561).
component("YHR094C",560).
component("YHR092C",559).
component("YHL036W",538).
component("YHL016C",536).
component("YGR191W",515).
component("YGR125W",505).
component("YGR121C",502).
component("YGR065C",499).
component("YGR055W",497).
component("YGL186C",481).
component("YFL055W",453).
component("YFL011W",446).
component("YER060W-A",423).
component("YER060W",422).
component("YER056C",421).
component("YER053C",420).
component("YEL069C",412).
component("YEL063C",411).
component("YDR536W",400).
component("YDR508C",396).
component("YDR503C",395).
component("YDR497C",393).
component("YDR345C",378).
component("YDR343C",377).
component("YDR342C",376).
component("YDR297W",372).
component("YDR294C",371).
component("YDR284C",369).
component("YDR046C",343).
component("YDL245C",333).
component("YDL210W",328).
component("YCR028C",285).
component("YCL025C",272).
component("YBR298C",268).
component("YBR294W",267).
component("YBR291C",266).
component("YBR085W",239).
component("YBR069C",236).
component("YBR068C",235).
component("YBR036C",231).
component("YBL042C",209).
component("YBL030C",205).
component("U85_",185).
component("U7_",180).
component("U79_",179).
component("U78_",178).
