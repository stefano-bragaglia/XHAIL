...
component("YNL280C",135).
component("YLR056W",118).
component("YGL001C",83).
component("YDR127W",59).
component("YNL009W",131).
component("YLR174W",120).
component("YCL018W",43).
component("YJR078W",106).
component("YOR323C",147).
component("YBR166C",40).
component("YNL280C",136).
component("YKL141W",110).
component("YOR375C",149).
component("YAL062W",30).
component("U100_",18).
component("YMR145C",127).
component("YDL085W",50).
component("YBR046C",34).
component("YPR074C",159).
component("YBR117C",38).
component("YNR019W",139).
component("YCR048W",47).
component("U48_",24).
component("YPL231W",152).
component("YPL231W",153).
component("YLR299W",122).
component("YOR321W",146).
component("YJR143C",108).
component("YGR199W",90).
component("YDL095W",52).
component("YDL093W",51).
component("YAL023C",29).
component("YDR354W",66).
component("YFR047C",81).
component("U22_",23).
component("YPR069C",158).
component("YDR127W",60).
component("YML082W",125).
component("YDR035W",56).
component("YBR249C",41).
component("YHR137W",96).
component("YGL202W",87).
component("YLR027C",117).
component("YKL106W",109).
component("YLR438W",124).
component("U51_",25).
component("YMR013C",126).
component("YCR036W",46).
component("YJR105W",107).
component("YMR208W",128).
component("YHR025W",93).
component("YFR019W",80).
component("YDR208W",64).
component("YDR127W",61).
component("YER052C",74).
component("U19_",20).
component("YDR226W",65).
component("YDR454C",69).
component("YOL061W",143).
component("YKL181W",111).
component("YHL011C",92).
component("YER099C",76).
component("YBL068W",33).
component("YLR328W",123).
component("YPR175W",161).
component("YPL167C",151).
component("YOR330C",148).
component("YOL115W",144).
component("YNL299W",137).
component("YNL262W",134).
component("YNL102W",132).
component("YJR043C",104).
component("YJR006W",103).
component("YJL090C",101).
component("YIL139C",99).
component("YEL055C",72).
component("YDR419W",68).
component("YDR121W",58).
component("YDL102W",53).
component("YCR014C",45).
component("YBR278W",42).
component("YBL035C",31).
component("YHR044C",95).
component("YHR043C",94).
component("YGL037C",85).
component("U53_",26).
component("YHR144C",97).
component("YBR153W",39).
component("YBR111C",37).
component("YER005W",73).
component("YLR231C",121).
component("YDR380W",67).
component("YDL080C",49).
component("YMR250W",129).
component("YKL184W",112).
component("YKL211C",113).
component("YNR033W",140).
component("YKL211C",114).
component("YER090W",75).
component("YDR127W",62).
component("YPL281C",155).
component("YOR393W",150).
component("YMR323W",130).
component("YHR174W",98).
component("YGR254W",91).
component("YGL026C",84).
component("YNL316C",138).
component("YCR053W",48).
component("YDR127W",63).
component("YGL148W",86).
component("YFR055W",82).
component("YDR007W",55).
component("YOR095C",145).
component("YPR060C",157).
component("YGL245W",88).
component("YPR047W",156).
component("YLR060W",119).
component("YFL022C",78).
component("YER183C",77).
component("YDL141W",54).
component("YJL087C",100).
component("YOL010W",141).
component("YPR138C",160).
component("YPL265W",154).
component("YOL020W",142).
component("YNL142W",133).
component("YKR053C",116).
component("YKR039W",115).
component("YJR077C",105).
component("YJL134W",102).
component("YGR121C",89).
component("YFL055W",79).
component("YDR536W",71).
component("YDR508C",70).
component("YDR046C",57).
component("YCL025C",44).
component("YBR069C",36).
component("YBR068C",35).
component("YBL042C",32).
component("U6_",28).
component("U5_",27).
component("U228_",22).
component("U222_",21).
