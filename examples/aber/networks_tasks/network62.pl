...
component("YNL280C",422).
component("YLR056W",352).
component("YMR083W",393).
component("YPL231W",475).
component("YJR159W",326).
component("YGL001C",228).
component("YML056C",380).
component("YLR432W",376).
component("YHR216W",284).
component("YAR075W",95).
component("YAR073W",94).
component("YDR127W",173).
component("YJR139C",323).
component("YNL009W",408).
component("YLR174W",363).
component("YHR183W",280).
component("YGR256W",261).
component("YCL018W",128).
component("YJR078W",319).
component("U58_",77).
component("YGR255C",260).
component("YMR015C",390).
component("YDR402C",187).
component("YGL055W",233).
component("YJL026W",294).
component("YGR180C",254).
component("U35_",67).
component("YJR009C",312).
component("YJL052W",295).
component("YGR192C",256).
component("YOR374W",462).
component("YER073W",208).
component("U68_",81).
component("U55_",75).
component("YER069W",207).
component("YOR323C",456).
component("U2_",62).
component("YBR166C",120).
component("YNL280C",423).
component("YKL141W",332).
component("YOR375C",463).
component("YDL215C",160).
component("YAL062W",93).
component("U100_",20).
component("YBR035C",106).
component("YMR189W",397).
component("U56_",76).
component("YPL023C",465).
component("YGL125W",236).
component("YOR236W",454).
component("YBR084W",111).
component("YLR142W",357).
component("U65_",80).
component("U62_",79).
component("YHR068W",271).
component("YMR145C",396).
component("YML120C",384).
component("YKL192C",338).
component("YDL085W",143).
component("YBR046C",107).
component("YPL091W",468).
component("YNL052W",409).
component("YMR256C",403).
component("YLR395C",374).
component("YLR038C",350).
component("YIL111W",288).
component("YHR051W",270).
component("YGL191W",240).
component("YGL187C",239).
component("YDL067C",141).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",481).
component("YLL062C",347).
component("YDR410C",189).
component("YER091C",211).
component("YJR073C",317).
component("YOL096C",440).
component("YLR172C",362).
component("YMR120C",395).
component("YBL013W",96).
component("YJL130C",302).
component("YJL088W",298).
component("YPR074C",487).
component("YBR117C",115).
component("YCL009C",127).
component("YMR062C",392).
component("YNL071W",410).
component("YNR019W",429).
component("YCR048W",136).
component("U48_",71).
component("YFL017C",218).
component("YPL231W",476).
component("YDL052C",140).
component("U8_",88).
component("YPL231W",477).
component("YLR299W",367).
component("YCR005C",133).
component("YML126C",386).
component("YDL182W",157).
component("YDL131W",149).
component("YNL117W",413).
component("YIR031C",292).
component("YOR321W",455).
component("YJR143C",324).
component("YGR199W",258).
component("YDL095W",145).
component("YDL093W",144).
component("YAL023C",92).
component("YPL227C",474).
component("YMR261C",404).
component("YML100W",383).
component("YBR126C",117).
component("YLR209C",364).
component("YDR354W",184).
component("YFR047C",225).
component("YJR133W",322).
component("U22_",58).
component("YDR399W",186).
component("YJL167W",309).
component("YPR069C",486).
component("YDR127W",174).
component("YHR068W",272).
component("YLR303W",368).
component("YML082W",382).
component("YJR130C",321).
component("YDR035W",164).
component("YBR249C",123).
component("YBR256C",124).
component("YHR137W",275).
component("YGL202W",241).
component("YLR027C",348).
component("YKL106W",330).
component("YOL140W",443).
component("YLR438W",378).
component("YKL104C",329).
component("YDR111C",171).
component("U51_",73).
component("YJR148W",325).
component("YHR208W",283).
component("YGL253W",245).
component("YFR053C",226).
component("YMR013C",389).
component("YCR036W",135).
component("YGR194C",257).
component("YCL040W",131).
component("YJR105W",320).
component("U81_",86).
component("YMR208W",399).
component("YPL203W",473).
component("YOR061W",444).
component("YKL166C",334).
component("YJL164C",308).
component("YIL035C",286).
component("YHR205W",282).
component("YHR102W",274).
component("YGL019W",229).
component("YHR025W",267).
component("YNR012W",427).
component("YPR121W",489).
component("YPL258C",479).
component("YOL055C",437).
component("YFR019W",223).
component("YDR208W",180).
component("YDR127W",175).
component("U21_",55).
component("YDR147W",178).
component("YER052C",203).
component("U19_",48).
component("U18_",44).
component("U17_",41).
component("U76_",84).
component("YMR220W",400).
component("YDR226W",181).
component("YKL067W",328).
component("YOL055C",438).
component("YDR454C",192).
component("YOL061W",439).
component("YKL181W",335).
component("YHL011C",263).
component("YER099C",213).
component("YBL068W",102).
component("YOR143C",448).
component("YNL256W",420).
component("YLR328W",371).
component("YDL103C",147).
component("U94_",90).
component("YJR010W",313).
component("YBR029C",105).
component("YPR190C",494).
component("YPR187W",493).
component("YPR110C",488).
component("YPR010C",483).
component("YOR341W",459).
component("YOR340C",458).
component("YOR224C",453).
component("YOR210W",452).
component("YOR207C",451).
component("YOR151C",449).
component("YOR116C",446).
component("YOL005C",433).
component("YNR003C",426).
component("YNL248C",419).
component("YNL151C",417).
component("YNL113W",412).
component("YKL144C",333).
component("YJR063W",316).
component("YJL148W",305).
component("YJL140W",304).
component("YIL021W",285).
component("YHR143W-A",276).
component("YGL070C",235).
component("YFL036W",220).
component("YDR404C",188).
component("YDR156W",179).
component("YDR045C",165).
component("YDL150W",156).
component("YDL140C",151).
component("YBR154C",119).
component("YPR175W",492).
component("YPL167C",471).
component("YOR330C",457).
component("YOL115W",442).
component("YNL299W",424).
component("YNL262W",421).
component("YNL102W",411).
component("YJR043C",315).
component("YJR006W",311).
component("YJL090C",299).
component("YIL139C",289).
component("YEL055C",199).
component("YDR419W",190).
component("YDR121W",172).
component("YDL102W",146).
component("YCR014C",134).
component("YBR278W",125).
component("YBL035C",98).
component("YKL035W",327).
component("YHL012W",264).
component("YDR058C",167).
component("YOL011W",435).
component("YMR008C",388).
component("YMR006C",387).
component("U105_",22).
component("U101_",21).
component("YJL068C",296).
component("YPL072W",467).
component("YOR124C",447).
component("YNL186W",418).
component("YMR304W",406).
component("YMR223W",401).
component("YKR098C",346).
component("YJL197W",310).
component("YIL156W",290).
component("YFR010W",222).
component("YER151C",216).
component("YER144C",215).
component("YER098W",212).
component("YDR069C",168).
component("YDL122W",148).
component("YBR058C",108).
component("YBL067C",101).
component("YJR019C",314).
component("YDR074W",169).
component("YFR025C",224).
component("YPL179W",472).
component("YNR032W",430).
component("YML057W",381).
component("YML016C",379).
component("YLR433C",377).
component("YGR123C",250).
component("YER133W",214).
component("YER089C",209).
component("YDR436W",191).
component("YDR075W",170).
component("YDL188C",158).
component("YDL134C",150).
component("YDL047W",139).
component("YDL006W",138).
component("YBR125C",116).
component("YBL056W",100).
component("U9_",91).
component("YJL155C",307).
component("U34_",66).
component("U33_",65).
component("U32_",64).
component("U30_",63).
...
component("U26_",60).
component("U24_",59).
component("YHR044C",269).
component("YHR043C",268).
component("YOR360C",461).
component("YGL248W",244).
component("YGL027C",231).
component("YLR286C",366).
component("YER043C",202).
component("YLR160C",361).
component("YLR158C",360).
component("YLR157C",359).
component("YLR155C",358).
component("YDR321W",183).
component("YGL037C",232).
component("U43_",69).
component("U42_",68).
component("YLR308W",370).
component("YLR307W",369).
component("U53_",74).
component("YLR420W",375).
component("YIR032C",293).
component("YLR028C",349).
component("YHR144C",277).
component("YHR144C",278).
component("YNL141W",414).
component("YBR153W",118).
component("YDL238C",161).
component("YNL141W",415).
component("YBR084W",112).
component("YJL126W",301).
component("U44_",70).
component("YHR201C",281).
component("YBR111C",114).
component("YCL030C",130).
component("YER005W",201).
component("YLR231C",365).
component("U88_",87).
component("YDR538W",197).
component("YLR134W",355).
component("YLR044C",351).
component("YGR087C",247).
component("YDR380W",185).
component("YDL080C",142).
component("YMR250W",402).
component("YKL184W",337).
component("YEL021W",198).
component("YKL211C",340).
component("YKR097W",345).
component("YNR033W",431).
component("YKL211C",341).
component("YER090W",210).
component("YDR127W",176).
component("YPL281C",482).
component("YOR393W",464).
component("YMR323W",407).
component("YHR174W",279).
component("YGR254W",259).
component("YGL026C",230).
component("YGR155W",252).
component("YNL316C",425).
component("YCR053W",137).
component("YDR127W",177).
component("YGL148W",237).
component("YIL167W",291).
component("YCL064C",132).
component("YFR055W",227).
component("YJL121C",300).
component("YBR019C",104).
component("YDR007W",162).
component("YOR095C",445).
component("YBR196C",121).
component("YPL117C",469).
component("U14_",32).
component("YMR105C",394).
component("YKL127W",331).
component("YEL058W",200).
component("YPR060C",485).
component("YHR072W",273).
component("YJL153C",306).
component("YGR264C",262).
component("YGR171C",253).
component("YHR011W",265).
component("YDR023W",163).
component("YGL245W",243).
component("YOR168W",450).
component("YPR047W",484).
component("YLR060W",353).
component("YFL022C",219).
component("YHR019C",266).
component("YKL194C",339).
component("YIL078W",287).
component("YPL160W",470).
component("YLR382C",373).
component("YPL040C",466).
component("YBL076C",103).
component("YGR094W",248).
component("YGL234W",242).
component("YER183C",217).
component("U90_",89).
component("YNR057C",432).
component("YDL141W",152).
component("YDL141W",153).
component("YDL141W",154).
component("YDL141W",155).
component("YPR145W",491).
component("YGR124W",251).
component("YGL062W",234).
component("YBR218C",122).
component("YPL231W",478).
component("YNR016C",428).
component("YKL182W",336).
component("YGR037C",246).
component("YJL087C",297).
component("YOL010W",434).
component("YPR138C",490).
component("YPL265W",480).
component("YOR348C",460).
component("YOL103W",441).
component("YOL020W",436).
component("YNL142W",416).
component("YMR272C",405).
component("YMR202W",398).
component("YMR056C",391).
component("YML123C",385).
component("YLR348C",372).
component("YLR138W",356).
component("YLR100C",354).
component("YKR053C",344).
component("YKR039W",343).
component("YKL217W",342).
component("YJR077C",318).
component("YJL134W",303).
component("YGR191W",255).
component("YGR121C",249).
component("YGL186C",238).
component("YFL055W",221).
component("YER060W-A",206).
component("YER060W",205).
component("YER056C",204).
component("YDR536W",196).
component("YDR508C",195).
component("YDR503C",194).
component("YDR497C",193).
component("YDR294C",182).
component("YDR046C",166).
component("YDL210W",159).
component("YCL025C",129).
component("YBR291C",126).
component("YBR085W",113).
component("YBR069C",110).
component("YBR068C",109).
component("YBL042C",99).
component("YBL030C",97).
component("U7_",85).
component("U6_",83).
component("U69_",82).
component("U5_",78).
