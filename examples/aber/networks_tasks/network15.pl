...
component("YNL280C",145).
component("YLR056W",127).
component("YGL001C",88).
component("YDR127W",64).
component("YNL009W",141).
component("YLR174W",129).
component("YHR183W",106).
component("YGR256W",98).
component("YCL018W",47).
component("YJR078W",114).
component("YGL055W",91).
component("YOR323C",157).
component("YBR166C",44).
component("YNL280C",146).
component("YKL141W",119).
component("YOR375C",159).
component("YAL062W",34).
component("U100_",18).
component("YMR145C",136).
component("YDL085W",55).
component("YBR046C",38).
component("YPR074C",169).
component("YBR117C",42).
component("YNR019W",149).
component("YCR048W",52).
component("U48_",28).
component("YPL231W",162).
component("YPL231W",163).
component("YLR299W",131).
component("YCR005C",49).
component("YOR321W",156).
component("YJR143C",117).
component("YGR199W",96).
component("YDL095W",57).
component("YDL093W",56).
component("YAL023C",33).
component("YDR354W",71).
component("YFR047C",86).
component("U22_",25).
component("YPR069C",168).
component("YDR127W",65).
component("YML082W",134).
component("YJR130C",116).
component("YDR035W",61).
component("YBR249C",45).
component("YHR137W",103).
component("YGL202W",93).
component("YLR027C",126).
component("YKL106W",118).
component("YLR438W",133).
component("U51_",29).
component("YMR013C",135).
component("YCR036W",51).
component("YJR105W",115).
component("YMR208W",138).
component("YHR025W",100).
component("YFR019W",85).
component("YDR208W",69).
component("YDR127W",66).
component("YER052C",79).
component("U19_",22).
component("YDR226W",70).
component("YDR454C",74).
component("YOL061W",153).
component("YKL181W",120).
component("YHL011C",99).
component("YER099C",81).
component("YBL068W",37).
component("YLR328W",132).
component("YPR175W",171).
component("YPL167C",161).
component("YOR330C",158).
component("YOL115W",154).
component("YNL299W",147).
component("YNL262W",144).
component("YNL102W",142).
component("YJR043C",112).
component("YJR006W",111).
component("YJL090C",109).
component("YIL139C",107).
component("YEL055C",77).
component("YDR419W",73).
component("YDR121W",63).
component("YDL102W",58).
component("YCR014C",50).
component("YBR278W",46).
component("YBL035C",35).
component("U32_",27).
component("U30_",26).
component("YHR044C",102).
component("YHR043C",101).
component("YGL037C",90).
component("U53_",30).
component("YHR144C",104).
component("YBR153W",43).
component("YBR111C",41).
component("YER005W",78).
component("YLR231C",130).
component("YDR380W",72).
component("YDL080C",54).
component("YMR250W",139).
component("YKL184W",121).
component("YKL211C",122).
component("YNR033W",150).
component("YKL211C",123).
component("YER090W",80).
component("YDR127W",67).
component("YPL281C",165).
component("YOR393W",160).
component("YMR323W",140).
component("YHR174W",105).
component("YGR254W",97).
component("YGL026C",89).
component("YNL316C",148).
component("YCR053W",53).
component("YDR127W",68).
component("YGL148W",92).
component("YFR055W",87).
component("YDR007W",60).
component("YOR095C",155).
component("YPR060C",167).
component("YGL245W",94).
component("YPR047W",166).
component("YLR060W",128).
component("YFL022C",83).
component("YER183C",82).
component("YDL141W",59).
component("YJL087C",108).
component("YOL010W",151).
component("YPR138C",170).
component("YPL265W",164).
component("YOL020W",152).
component("YNL142W",143).
component("YMR202W",137).
component("YKR053C",125).
component("YKR039W",124).
component("YJR077C",113).
component("YJL134W",110).
component("YGR121C",95).
component("YFL055W",84).
component("YDR536W",76).
component("YDR508C",75).
component("YDR046C",62).
component("YCL025C",48).
component("YBR069C",40).
component("YBR068C",39).
component("YBL042C",36).
component("U6_",32).
component("U5_",31).
component("U228_",24).
component("U222_",23).
