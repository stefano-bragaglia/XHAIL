...
component("YLR056W",514).
component("YKR009C",498).
component("YMR083W",572).
component("YPL231W",698).
component("YBR149W",171).
component("YJR159W",472).
component("YGL001C",325).
component("YHR063C",393).
component("YML056C",557).
component("YLR432W",551).
component("YHR216W",410).
component("YAR075W",140).
component("YAR073W",139).
component("YCL030C",189).
component("YDR127W",245).
component("YJR139C",468).
component("YOR136W",653).
component("YNL009W",594).
component("YLR174W",527).
component("YDL066W",206).
component("YHR183W",405).
component("YGR256W",375).
component("YNL241C",609).
component("YOL059W",638).
component("YDL022W",201).
component("YCL018W",187).
component("YLR355C",545).
component("YML054C",556).
...
component("U108_",26).
component("YMR015C",569).
component("YDR402C",264).
component("YGL055W",332).
component("YJL026W",430).
component("YIL066C",415).
component("YGR180C",364).
component("YER070W",298).
component("U36_",96).
component("U35_",95).
component("YJR009C",453).
component("YJL052W",431).
component("YGR192C",366).
component("YOR374W",676).
component("YER073W",299).
component("U68_",117).
component("YGL154C",339).
component("U55_",109).
component("YER069W",297).
component("YOR323C",669).
component("U2_",90).
component("YBR221C",178).
component("YBR166C",174).
component("YNL280C",616).
component("YGL012W",327).
component("YKL182W",488).
component("YDR044W",236).
component("YER014W",286).
component("YKR009C",499).
component("YIL160C",422).
component("YGL205W",344).
component("YKL141W",482).
component("YJR051W",458).
component("YOR375C",677).
component("YDL215C",228).
component("YAL062W",138).
component("U100_",20).
component("YBR035C",157).
component("YMR189W",580).
component("U56_",110).
component("YKR080W",504).
component("YPL023C",681).
component("YGL125W",336).
component("YOR236W",664).
component("YGR204W",369).
component("YBR084W",163).
component("YLR142W",521).
component("U65_",115).
component("U62_",113).
component("YHR068W",394).
component("YKL150W",484).
component("YIL043C",413).
component("YHR042W",388).
component("YOR221C",662).
component("YMR145C",577).
component("YML120C",562).
component("YKL192C",491).
component("YKL055C",475).
component("YER061C",293).
component("YDL085W",209).
component("YBR046C",159).
component("YMR145C",578).
component("YML120C",563).
component("YKL192C",492).
component("YDL085W",210).
component("YPL017C",680).
component("YFL018C",314).
component("YPL091W",684).
component("YER042W",287).
component("YNL052W",596).
component("YMR256C",588).
component("YLR395C",549).
component("YLR038C",512).
component("YIL111W",417).
component("YHR051W",392).
component("YGL191W",342).
component("YGL187C",341).
component("YDL067C",207).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",704).
component("YBR034C",156).
component("YPL273W",706).
component("YLL062C",509).
component("YDR410C",266).
component("YKR069W",503).
component("U47_",103).
component("YER091C",303).
component("YJR073C",461).
component("YDL033C",202).
component("YOL096C",641).
component("YLR172C",526).
component("YMR120C",576).
component("YBL013W",141).
component("YJL130C",439).
component("YJL088W",434).
component("YPR074C",717).
component("YBR117C",167).
component("YLR354C",544).
component("YGR043C",352).
component("YMR108W",574).
component("YCL009C",186).
component("YMR062C",571).
component("YNL071W",597).
component("YIL160C",423).
component("YNR019W",625).
component("YCR048W",198).
component("U48_",104).
component("YNL277W",614).
component("YFL017C",313).
component("YPL231W",699).
component("YER061C",294).
component("U86_",130).
component("YDL052C",204).
component("U8_",133).
component("YDR148C",251).
component("YOR377W",678).
component("YGR177C",363).
component("YPL231W",700).
component("YLR195C",529).
component("YLR299W",536).
component("YPR001W",708).
component("YNR001C",621).
component("YCR005C",194).
component("YML126C",565).
component("YDL182W",225).
component("YDL131W",217).
component("YNL117W",601).
component("YIR031C",428).
component("YPR160W",723).
component("YOR321W",668).
component("YJR143C",469).
component("YGR199W",368).
component("YDL095W",212).
component("YDL093W",211).
component("YAL023C",137).
component("YPL227C",696).
component("YMR261C",589).
component("YML100W",561).
component("YBR126C",170).
component("YNL192W",608).
...
component("YOR184W",658).
component("YNR058W",630).
component("YGL253W",349).
component("YFR053C",323).
component("YMR013C",568).
component("YMR205C",582).
component("YGR240C",372).
component("YLR240W",533).
component("YKL203C",494).
component("YJR066W",460).
component("YCR036W",197).
component("YGR194C",367).
component("YCL040W",191).
component("YJR105W",465).
component("U16_",56).
component("YPL188W",692).
component("YJR049C",457).
component("YEL041W",282).
component("YKL001C",473).
component("YML070W",559).
component("YFL053W",317).
component("YDR531W",276).
component("U82_",128).
component("U81_",127).
component("YMR208W",583).
component("YPL203W",693).
component("YOR061W",648).
component("YKL166C",486).
component("YJL164C",445).
component("YIL035C",412).
component("YHR205W",408).
component("YHR102W",398).
component("YGL019W",328).
component("YHR025W",387).
component("YNR012W",623).
component("YPR121W",720).
component("YPL258C",702).
component("YOL055C",636).
component("YPL214C",695).
component("U1_",73).
component("YDR009W",232).
component("YBR020W",153).
component("YFR019W",320).
...
component("YOL061W",639).
component("YKL181W",487).
component("YHL011C",380).
component("YER099C",305).
component("YBL068W",147).
component("YOR143C",654).
component("YNL256W",612).
...
component("U94_",135).
component("YJR010W",454).
component("YBR029C",155).
component("YGL130W",337).
component("YDR530C",275).
component("YPR190C",726).
component("YPR187W",725).
component("YPR110C",719).
component("YPR010C",710).
component("YOR341W",673).
component("YOR340C",672).
component("YOR224C",663).
component("YOR210W",661).
component("YOR207C",659).
component("YOR151C",655).
component("YOR116C",650).
component("YOL005C",631).
component("YNR003C",622).
component("YNL248C",610).
component("YNL151C",606).
component("YNL113W",600).
component("YKL144C",483).
component("YJR063W",459).
component("YJL148W",442).
component("YJL140W",441).
component("YIL021W",411).
component("YHR143W-A",401).
...
component("YPR175W",724).
component("YPL167C",690).
component("YOR330C",670).
component("YOL115W",644).
component("YNL299W",618).
component("YNL262W",613).
component("YNL102W",599).
component("YJR043C",456).
component("YJR006W",452).
component("YJL090C",435).
component("YIL139C",418).
component("YEL055C",283).
...
component("YKL035W",474).
component("YHL012W",381).
component("YHR123W",399).
component("YNL130C",602).
component("YPL148C",688).
component("YOR251C",666).
component("YGR286C",377).
component("YDR058C",239).
component("YOL011W",633).
component("YMR008C",567).
component("YMR006C",566).
component("U105_",25).
component("U101_",21).
component("YJL068C",432).
component("YPL072W",683).
component("YOR124C",651).
component("YNL186W",607).
component("YMR304W",592).
component("YMR223W",586).
component("YKR098C",506).
component("YJL197W",447).
component("YIL156W",421).
component("YFR010W",319).
component("YER151C",308).
component("YER144C",307).
component("YER098W",304).
component("YDR069C",240).
component("YDL122W",216).
component("YBR058C",160).
component("YBL067C",146).
component("YJR019C",455).
component("YDR481C",270).
component("YLR377C",547).
component("YDR074W",241).
component("YFR025C",321).
component("YPL179W",691).
component("YNR032W",626).
component("YML057W",558).
component("YML016C",554).
component("YLR433C",552).
component("YGR123C",358).
component("YER133W",306).
component("YER089C",301).
...
component("YIL053W",414).
component("YER062C",295).
component("YHR046C",391).
component("U9_",136).
component("YGR208W",371).
component("YPL228W",697).
component("YMR180C",579).
component("YJL155C",444).
component("U34_",94).
component("U33_",93).
component("U32_",92).
component("U30_",91).
...
component("U26_",87).
component("U24_",86).
component("YHR044C",390).
component("YHR043C",389).
component("YOL064C",640).
component("YPL268W",705).
component("YOR360C",675).
component("YGL248W",348).
component("YKR031C",500).
component("YGL027C",330).
component("YLR286C",535).
component("YJR153W",471).
component("YJL221C",451).
component("YJL216C",449).
component("YIL172C",427).
component("YGR292W",379).
component("YGR287C",378).
component("YBR299W",185).
component("YBR184W",175).
component("YIL162W",424).
component("YPR026W",711).
component("YDR001C",230).
component("YBR001C",150).
component("YDR400W",263).
component("U102_",22).
component("YER043C",288).
component("YNL045W",595).
component("YLR160C",525).
component("YLR158C",524).
component("YLR157C",523).
component("YLR155C",522).
component("YDR321W",259).
component("YGL037C",331).
component("U43_",101).
component("U42_",100).
component("YLR308W",540).
component("YLR307W",539).
component("U53_",108).
component("YLR420W",550).
component("YPL111W",686).
component("YIR032C",429).
...
component("YER005W",285).
component("YBL099W",149).
component("YLR231C",532).
component("U88_",131).
component("YDR538W",278).
component("YLR134W",519).
component("YLR044C",513).
component("YGR087C",355).
component("YDR380W",261).
component("YDL080C",208).
component("YMR250W",587).
component("YKL184W",490).
component("YEL021W",280).
component("YNR043W",628).
component("YKL211C",495).
component("YKR097W",505).
component("YOL052C",635).
component("YDR294C",255).
component("YNR033W",627).
component("YPR006C",709).
component("YER065C",296).
component("YKL211C",496).
component("YER090W",302).
component("YDR127W",248).
component("YPL281C",707).
component("YOR393W",679).
component("YMR323W",593).
component("YHR174W",404).
component("YGR254W",373).
component("YGL026C",329).
component("YGR155W",361).
component("YLR304C",538).
component("YJL200C",448).
component("YNL316C",619).
component("YPL212C",694).
component("YNL292W",617).
component("YGL063W",334).
component("YFL001W",311).
component("YCR053W",199).
component("YDR127W",249).
component("YGL148W",338).
component("YIL168W",426).
component("YIL167W",425).
component("YCL064C",192).
component("YCL064C",193).
component("YHR018C",384).
component("YLR359W",546).
component("YFR055W",324).
component("YJL121C",436).
component("YBR019C",152).
component("YDR007W",231).
component("YOR095C",649).
component("YBR196C",176).
component("YGL001C",326).
component("YPL117C",687).
component("U14_",47).
component("YKL152C",485).
component("YMR105C",573).
component("YKL127W",480).
component("YEL058W",284).
component("YPR060C",715).
component("YHR072W",396).
component("YJL153C",443).
component("YGR264C",376).
component("YGR171C",362).
component("YHR011W",383).
component("YDR023W",233).
component("YPL104W",685).
component("YLL018C",507).
component("YPR081C",718).
component("YBR121C",168).
component("YHR020W",386).
component("YER087W",300).
component("YGL245W",347).
component("YOR168W",656).
component("YOL097C",642).
component("YPR047W",714).
component("YLR060W",515).
component("YFL022C",315).
component("YPR033C",712).
component("YHR019C",385).
component("YKL194C",493).
component("YIL078W",416).
component("YPL160W",689).
component("YLR382C",548).
component("YPL040C",682).
component("YBL076C",148).
component("YNL073W",598).
component("YDR037W",235).
component("YOR335C",671).
component("YGR094W",356).
component("YPR035W",713).
component("YIL145C",419).
component("U89_",132).
component("YOR241W",665).
component("YMR113W",575).
component("YKL132C",481).
component("YGL234W",345).
component("YER183C",310).
component("U90_",134).
component("YNR057C",629).
component("YDL141W",220).
component("YDL141W",221).
component("YGL234W",346).
component("YDL141W",222).
component("YGR204W",370).
component("YDL141W",223).
component("YHR074W",397).
component("YMR217W",584).
component("YPR145W",722).
component("YGR124W",359).
component("YOR303W",667).
...
component("YJL087C",433).
component("YOL010W",632).
component("YPR138C",721).
component("YPL265W",703).
component("YOR348C",674).
component("YOR171C",657).
component("YOR130C",652).
component("YOL156W",647).
component("YOL103W",643).
component("YOL020W",634).
component("YNL318C",620).
component("YNL142W",605).
component("YMR272C",590).
component("YMR202W",581).
component("YMR056C",570).
component("YML123C",564).
component("YLR348C",543).
component("YLR260W",534).
component("YLR138W",520).
component("YLR100C",518).
component("YLR092W",517).
component("YLR081W",516).
component("YLL061W",508).
component("YKR053C",502).
component("YKR039W",501).
component("YKL217W",497).
component("YKL120W",479).
component("YJR095W",464).
component("YJR077C",462).
component("YJL219W",450).
component("YJL134W",440).
component("YJL129C",438).
component("YHL036W",382).
component("YGR191W",365).
component("YGR125W",360).
component("YGR121C",357).
component("YGR065C",354).
component("YGR055W",353).
component("YGL186C",340).
component("YFL055W",318).
