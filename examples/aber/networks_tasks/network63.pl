...
component("YNL280C",425).
component("YLR056W",355).
component("YMR083W",396).
component("YPL231W",478).
component("YJR159W",329).
component("YGL001C",229).
component("YML056C",383).
component("YLR432W",379).
component("YHR216W",285).
component("YAR075W",95).
component("YAR073W",94).
component("YDR127W",174).
component("YJR139C",326).
component("YNL009W",411).
component("YLR174W",366).
component("YHR183W",281).
component("YGR256W",262).
component("YCL018W",128).
component("YJR078W",322).
component("U58_",77).
component("YGR255C",261).
component("YMR015C",393).
component("YDR402C",188).
component("YGL055W",234).
component("YJL026W",296).
component("YGR180C",255).
component("U35_",67).
component("YJR009C",314).
component("YJL052W",297).
component("YGR192C",257).
component("YOR374W",465).
component("YER073W",209).
component("U68_",81).
component("U55_",75).
...
component("YNL280C",426).
component("YKL141W",335).
component("YJR051W",318).
component("YOR375C",466).
component("YDL215C",160).
component("YAL062W",93).
component("U100_",20).
component("YBR035C",106).
component("YMR189W",400).
component("U56_",76).
component("YPL023C",468).
component("YGL125W",237).
component("YOR236W",457).
component("YBR084W",111).
component("YLR142W",360).
component("U65_",80).
component("U62_",79).
component("YHR068W",272).
component("YMR145C",399).
component("YML120C",387).
component("YKL192C",341).
component("YDL085W",143).
component("YBR046C",107).
component("YPL091W",471).
component("YNL052W",412).
component("YMR256C",406).
component("YLR395C",377).
component("YLR038C",353).
component("YIL111W",289).
component("YHR051W",271).
component("YGL191W",241).
component("YGL187C",240).
component("YDL067C",141).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",484).
component("YLL062C",350).
component("YDR410C",190).
component("YER091C",212).
component("YJR073C",320).
component("YOL096C",443).
component("YLR172C",365).
component("YMR120C",398).
component("YBL013W",96).
component("YJL130C",304).
component("YJL088W",300).
component("YPR074C",490).
component("YBR117C",115).
component("YCL009C",127).
component("YMR062C",395).
component("YNL071W",413).
component("YNR019W",432).
component("YCR048W",136).
component("U48_",71).
component("YFL017C",219).
component("YPL231W",479).
component("YDL052C",140).
component("U8_",88).
component("YPL231W",480).
component("YLR299W",370).
component("YCR005C",133).
component("YML126C",389).
component("YDL182W",157).
component("YDL131W",149).
component("YNL117W",416).
component("YIR031C",294).
component("YOR321W",458).
component("YJR143C",327).
component("YGR199W",259).
component("YDL095W",145).
component("YDL093W",144).
component("YAL023C",92).
component("YPL227C",477).
component("YMR261C",407).
component("YML100W",386).
component("YBR126C",117).
component("YLR209C",367).
component("YDR354W",185).
component("YFR047C",226).
component("YJR133W",325).
component("U22_",58).
component("YDR399W",187).
component("YJL167W",311).
component("YPR069C",489).
component("YDR127W",175).
component("YHR068W",273).
component("YLR303W",371).
component("YML082W",385).
component("YJR130C",324).
component("YDR035W",164).
component("YBR249C",123).
component("YBR256C",124).
component("YHR137W",276).
component("YGL202W",242).
component("YLR027C",351).
component("YKL106W",333).
component("YOL140W",446).
component("YLR438W",381).
component("YKL104C",332).
component("YDR111C",172).
component("U51_",73).
component("YJR148W",328).
component("YHR208W",284).
component("YGL253W",246).
component("YFR053C",227).
component("YMR013C",392).
component("YCR036W",135).
component("YGR194C",258).
component("YCL040W",131).
component("YJR105W",323).
component("U81_",86).
component("YMR208W",402).
component("YPL203W",476).
component("YOR061W",447).
component("YKL166C",337).
component("YJL164C",310).
component("YIL035C",287).
component("YHR205W",283).
component("YHR102W",275).
component("YGL019W",230).
component("YHR025W",268).
component("YNR012W",430).
component("YPR121W",492).
component("YPL258C",482).
component("YOL055C",440).
component("YFR019W",224).
component("YDR208W",181).
component("YDR127W",176).
component("U21_",55).
component("YDR147W",179).
component("YER052C",204).
component("U19_",48).
component("U18_",44).
component("U17_",41).
component("U76_",84).
component("YMR220W",403).
component("YDR226W",182).
component("YKL067W",331).
component("YOL055C",441).
component("YDR454C",193).
component("YOL061W",442).
component("YKL181W",338).
component("YHL011C",264).
component("YER099C",214).
component("YBL068W",102).
component("YOR143C",451).
component("YNL256W",423).
component("YLR328W",374).
component("YDL103C",147).
component("U94_",90).
component("YJR010W",315).
component("YBR029C",105).
component("YPR190C",497).
component("YPR187W",496).
component("YPR110C",491).
component("YPR010C",486).
component("YOR341W",462).
component("YOR340C",461).
component("YOR224C",456).
component("YOR210W",455).
component("YOR207C",454).
component("YOR151C",452).
component("YOR116C",449).
component("YOL005C",436).
component("YNR003C",429).
component("YNL248C",422).
component("YNL151C",420).
component("YNL113W",415).
component("YKL144C",336).
component("YJR063W",319).
component("YJL148W",307).
component("YJL140W",306).
component("YIL021W",286).
component("YHR143W-A",277).
component("YGL070C",236).
component("YFL036W",221).
component("YDR404C",189).
component("YDR156W",180).
component("YDR045C",166).
component("YDL150W",156).
component("YDL140C",151).
component("YBR154C",119).
component("YPR175W",495).
component("YPL167C",474).
component("YOR330C",460).
component("YOL115W",445).
component("YNL299W",427).
component("YNL262W",424).
component("YNL102W",414).
component("YJR043C",317).
component("YJR006W",313).
component("YJL090C",301).
component("YIL139C",290).
component("YEL055C",200).
component("YDR419W",191).
component("YDR121W",173).
component("YDL102W",146).
component("YCR014C",134).
component("YBR278W",125).
component("YBL035C",98).
component("YKL035W",330).
component("YHL012W",265).
component("YDR058C",168).
component("YOL011W",438).
component("YMR008C",391).
component("YMR006C",390).
component("U105_",22).
component("U101_",21).
component("YJL068C",298).
component("YPL072W",470).
component("YOR124C",450).
component("YNL186W",421).
component("YMR304W",409).
component("YMR223W",404).
component("YKR098C",349).
component("YJL197W",312).
component("YIL156W",291).
component("YFR010W",223).
component("YER151C",217).
component("YER144C",216).
component("YER098W",213).
component("YDR069C",169).
component("YDL122W",148).
component("YBR058C",108).
component("YBL067C",101).
component("YJR019C",316).
component("YDR074W",170).
component("YFR025C",225).
component("YPL179W",475).
component("YNR032W",433).
component("YML057W",384).
component("YML016C",382).
component("YLR433C",380).
component("YGR123C",251).
component("YER133W",215).
component("YER089C",210).
component("YDR436W",192).
component("YDR075W",171).
...
component("U26_",60).
component("U24_",59).
component("YHR044C",270).
component("YHR043C",269).
component("YOR360C",464).
component("YGL248W",245).
component("YGL027C",232).
component("YLR286C",369).
component("YER043C",203).
component("YLR160C",364).
component("YLR158C",363).
component("YLR157C",362).
component("YLR155C",361).
component("YDR321W",184).
component("YGL037C",233).
component("U43_",69).
component("U42_",68).
component("YLR308W",373).
component("YLR307W",372).
component("U53_",74).
component("YLR420W",378).
component("YIR032C",295).
component("YLR028C",352).
component("YHR144C",278).
component("YHR144C",279).
component("YNL141W",417).
...
component("U44_",70).
component("YHR201C",282).
component("YBR111C",114).
component("YCL030C",130).
component("YER005W",202).
component("YLR231C",368).
component("U88_",87).
component("YDR538W",198).
component("YLR134W",358).
component("YLR044C",354).
component("YGR087C",248).
component("YDR380W",186).
component("YDL080C",142).
component("YMR250W",405).
component("YKL184W",340).
component("YEL021W",199).
component("YKL211C",343).
component("YKR097W",348).
component("YNR033W",434).
component("YKL211C",344).
component("YER090W",211).
component("YDR127W",177).
component("YPL281C",485).
component("YOR393W",467).
component("YMR323W",410).
component("YHR174W",280).
component("YGR254W",260).
component("YGL026C",231).
component("YGR155W",253).
component("YNL316C",428).
component("YCR053W",137).
component("YDR127W",178).
component("YGL148W",238).
component("YIL168W",293).
component("YIL167W",292).
component("YCL064C",132).
component("YFR055W",228).
component("YJL121C",302).
component("YBR019C",104).
component("YDR007W",162).
component("YOR095C",448).
component("YBR196C",121).
component("YPL117C",472).
component("U14_",32).
component("YMR105C",397).
component("YKL127W",334).
component("YEL058W",201).
component("YPR060C",488).
component("YHR072W",274).
component("YJL153C",308).
component("YGR264C",263).
component("YGR171C",254).
component("YHR011W",266).
component("YDR023W",163).
component("YGL245W",244).
component("YOR168W",453).
component("YPR047W",487).
component("YLR060W",356).
component("YFL022C",220).
component("YHR019C",267).
component("YKL194C",342).
component("YIL078W",288).
component("YPL160W",473).
component("YLR382C",376).
component("YPL040C",469).
component("YBL076C",103).
component("YDR037W",165).
component("YGR094W",249).
component("YGL234W",243).
component("YER183C",218).
component("U90_",89).
component("YNR057C",435).
component("YDL141W",152).
component("YDL141W",153).
component("YDL141W",154).
component("YDL141W",155).
component("YPR145W",494).
component("YGR124W",252).
component("YGL062W",235).
component("YBR218C",122).
component("YPL231W",481).
component("YNR016C",431).
component("YKL182W",339).
component("YGR037C",247).
component("YJL087C",299).
component("YOL010W",437).
component("YPR138C",493).
component("YPL265W",483).
component("YOR348C",463).
component("YOL103W",444).
component("YOL020W",439).
component("YNL142W",419).
component("YMR272C",408).
component("YMR202W",401).
component("YMR056C",394).
component("YML123C",388).
component("YLR348C",375).
component("YLR138W",359).
component("YLR100C",357).
component("YKR053C",347).
component("YKR039W",346).
component("YKL217W",345).
component("YJR077C",321).
component("YJL134W",305).
component("YGR191W",256).
...
component("YDR536W",197).
component("YDR508C",196).
component("YDR503C",195).
component("YDR497C",194).
component("YDR294C",183).
component("YDR046C",167).
