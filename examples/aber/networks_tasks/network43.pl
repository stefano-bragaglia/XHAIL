...
component("YNL280C",324).
component("YLR056W",269).
component("YMR083W",297).
component("YPL231W",367).
component("YJR159W",247).
component("YGL001C",174).
component("YDR127W",127).
component("YJR139C",244).
component("YNL009W",312).
component("YLR174W",276).
component("YHR183W",213).
component("YGR256W",196).
component("YCL018W",92).
component("YJR078W",240).
component("YMR015C",295).
component("YDR402C",140).
component("YGL055W",178).
component("YJL026W",222).
component("YGR180C",193).
component("U68_",59).
component("U55_",56).
component("YER069W",158).
component("YOR323C",353).
component("YBR166C",86).
component("YNL280C",325).
component("YKL141W",252).
component("YOR375C",358).
component("YDL215C",117).
component("YAL062W",68).
component("U100_",20).
component("YMR189W",301).
component("U56_",57).
component("YPL023C",360).
component("YGL125W",180).
component("YOR236W",351).
component("YMR145C",300).
component("YDL085W",104).
component("YBR046C",76).
component("YPL091W",363).
component("YNL052W",313).
component("YMR256C",307).
component("YLR395C",286).
component("YLR038C",267).
component("YIL111W",218).
component("YHR051W",205).
component("YGL191W",184).
component("YGL187C",183).
component("YDL067C",102).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",372).
component("YLL062C",264).
component("YDR410C",142).
component("YJR073C",238).
component("YOL096C",338).
component("YMR120C",299).
component("YJL130C",227).
component("YJL088W",224).
component("YPR074C",378).
component("YBR117C",82).
component("YCL009C",91).
component("YNL071W",314).
component("YNR019W",331).
component("YCR048W",99).
component("U48_",53).
component("YFL017C",165).
component("YPL231W",368).
component("YDL052C",101).
component("U8_",64).
component("YPL231W",369).
component("YLR299W",280).
component("YCR005C",96).
component("YML126C",291).
component("YDL182W",115).
component("YDL131W",109).
component("YNL117W",317).
component("YIR031C",221).
component("YOR321W",352).
component("YJR143C",245).
component("YGR199W",194).
component("YDL095W",106).
component("YDL093W",105).
component("YAL023C",67).
component("YMR261C",308).
component("YML100W",289).
component("YBR126C",83).
component("YLR209C",277).
component("YDR354W",137).
component("YFR047C",172).
component("YJR133W",243).
component("U22_",44).
component("YDR399W",139).
component("YPR069C",377).
component("YDR127W",128).
component("YML082W",288).
component("YJR130C",242).
component("YDR035W",121).
component("YBR249C",88).
component("YHR137W",208).
component("YGL202W",185).
component("YLR027C",265).
component("YKL106W",250).
component("YOL140W",341).
component("YLR438W",287).
component("YDR111C",125).
component("U51_",54).
component("YJR148W",246).
component("YMR013C",294).
component("YCR036W",98).
component("YCL040W",95).
component("YJR105W",241).
component("YMR208W",303).
component("YPL203W",366).
component("YOR061W",342).
component("YKL166C",254).
component("YJL164C",233).
component("YIL035C",217).
component("YHR205W",215).
component("YHR102W",207).
component("YGL019W",175).
component("YHR025W",202).
component("YNR012W",329).
component("YFR019W",170).
component("YDR208W",134).
component("YDR127W",129).
component("U21_",41).
component("YDR147W",132).
component("YER052C",154).
component("U19_",38).
component("U18_",35).
component("U76_",62).
component("YMR220W",304).
component("YDR226W",135).
component("YKL067W",249).
component("YDR454C",144).
component("YOL061W",337).
component("YKL181W",255).
component("YHL011C",198).
component("YER099C",161).
component("YBL068W",73).
component("YOR143C",346).
component("YLR328W",283).
component("U94_",65).
component("YBR029C",75).
component("YPR190C",384).
component("YPR187W",383).
component("YPR110C",379).
component("YPR010C",374).
component("YOR341W",356).
component("YOR340C",355).
component("YOR224C",350).
component("YOR210W",349).
component("YOR207C",348).
component("YOR151C",347).
component("YOR116C",344).
component("YOL005C",333).
component("YNR003C",328).
component("YNL248C",322).
component("YNL151C",320).
component("YNL113W",316).
component("YKL144C",253).
component("YJR063W",237).
component("YJL148W",230).
component("YJL140W",229).
component("YIL021W",216).
component("YHR143W-A",209).
component("YGL070C",179).
component("YFL036W",167).
component("YDR404C",141).
component("YDR156W",133).
component("YDR045C",122).
component("YDL150W",114).
component("YDL140C",110).
component("YBR154C",85).
component("YPR175W",382).
component("YPL167C",365).
component("YOR330C",354).
component("YOL115W",340).
component("YNL299W",326).
component("YNL262W",323).
component("YNL102W",315).
component("YJR043C",236).
component("YJR006W",235).
component("YJL090C",225).
component("YIL139C",219).
component("YEL055C",151).
component("YDR419W",143).
component("YDR121W",126).
component("YDL102W",107).
component("YCR014C",97).
component("YBR278W",89).
component("YBL035C",70).
component("YKL035W",248).
component("YHL012W",199).
component("YOL011W",335).
component("YMR008C",293).
component("YMR006C",292).
component("U105_",21).
component("YPL072W",362).
component("YOR124C",345).
component("YNL186W",321).
component("YMR304W",310).
component("YMR223W",305).
component("YKR098C",263).
component("YJL197W",234).
component("YIL156W",220).
component("YFR010W",169).
component("YER151C",163).
component("YER144C",162).
component("YER098W",160).
component("YDR069C",124).
component("YDL122W",108).
component("YBR058C",77).
component("YBL067C",72).
component("YFR025C",171).
component("U9_",66).
component("YJL155C",232).
component("U34_",49).
component("U33_",48).
component("U32_",47).
component("U30_",46).
component("U24_",45).
component("YHR044C",204).
component("YHR043C",203).
component("YLR286C",279).
component("YLR160C",275).
component("YLR158C",274).
component("YLR157C",273).
component("YLR155C",272).
component("YDR321W",136).
component("YGL037C",177).
component("U43_",51).
component("U42_",50).
component("YLR308W",282).
component("YLR307W",281).
component("U53_",55).
component("YLR028C",266).
component("YHR144C",210).
component("YHR144C",211).
component("YBR153W",84).
component("YDL238C",118).
component("YNL141W",318).
component("U44_",52).
component("YHR201C",214).
component("YBR111C",81).
component("YCL030C",94).
component("YER005W",153).
component("YLR231C",278).
component("YDR538W",149).
component("YLR134W",271).
component("YLR044C",268).
component("YGR087C",188).
component("YDR380W",138).
component("YDL080C",103).
component("YMR250W",306).
component("YKL184W",257).
component("YEL021W",150).
component("YKL211C",258).
component("YNR033W",332).
component("YKL211C",259).
component("YER090W",159).
component("YDR127W",130).
component("YPL281C",373).
component("YOR393W",359).
component("YMR323W",311).
component("YHR174W",212).
component("YGR254W",195).
component("YGL026C",176).
component("YGR155W",191).
component("YNL316C",327).
component("YCR053W",100).
component("YDR127W",131).
component("YGL148W",181).
component("YFR055W",173).
component("YJL121C",226).
component("YDR007W",119).
component("YOR095C",343).
component("YBR196C",87).
component("U14_",29).
component("YMR105C",298).
component("YKL127W",251).
component("YEL058W",152).
component("YPR060C",376).
component("YHR072W",206).
component("YJL153C",231).
component("YGR264C",197).
component("YGR171C",192).
component("YHR011W",200).
component("YDR023W",120).
component("YGL245W",186).
component("YPR047W",375).
component("YLR060W",270).
component("YFL022C",166).
component("YHR019C",201).
component("YPL160W",364).
component("YLR382C",285).
component("YPL040C",361).
component("YBL076C",74).
component("YER183C",164).
component("YDL141W",111).
component("YDL141W",112).
component("YDL141W",113).
component("YPR145W",381).
component("YGR124W",190).
component("YPL231W",370).
component("YNR016C",330).
component("YKL182W",256).
component("YGR037C",187).
component("YJL087C",223).
component("YOL010W",334).
component("YPR138C",380).
component("YPL265W",371).
component("YOR348C",357).
component("YOL103W",339).
component("YOL020W",336).
component("YNL142W",319).
component("YMR272C",309).
component("YMR202W",302).
component("YMR056C",296).
component("YML123C",290).
component("YLR348C",284).
component("YKR053C",262).
component("YKR039W",261).
component("YKL217W",260).
component("YJR077C",239).
component("YJL134W",228).
component("YGR121C",189).
component("YGL186C",182).
component("YFL055W",168).
component("YER060W-A",157).
component("YER060W",156).
component("YER056C",155).
component("YDR536W",148).
component("YDR508C",147).
component("YDR503C",146).
component("YDR497C",145).
component("YDR046C",123).
component("YDL210W",116).
component("YCL025C",93).
component("YBR291C",90).
component("YBR085W",80).
component("YBR069C",79).
component("YBR068C",78).
component("YBL042C",71).
component("YBL030C",69).
component("U7_",63).
component("U6_",61).
component("U69_",60).
component("U5_",58).
