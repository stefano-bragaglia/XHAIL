...
component("YNL280C",641).
component("YLR056W",540).
component("YKR009C",523).
component("YMR083W",598).
component("YPL231W",726).
component("U46_",110).
component("YBR149W",181).
component("YBR149W",182).
component("YJR159W",495).
component("YGL001C",343).
component("YHR063C",413).
component("YML056C",583).
component("YLR432W",577).
component("YHR216W",430).
component("YAR075W",150).
component("YAR073W",149).
component("YCL030C",201).
component("YDR127W",258).
component("YJR139C",491).
component("YOR136W",680).
component("YNL009W",620).
component("YLR174W",553).
component("YDL066W",218).
component("YHR183W",425).
component("YGR256W",394).
component("YNL241C",635).
component("YOL059W",664).
component("YDL022W",213).
component("YCL018W",199).
component("YLR355C",571).
component("YIL074C",436).
component("YER081W",317).
component("YML054C",582).
component("YIL155C",441).
component("YEL024W",296).
component("YKR066C",528).
component("YJR078W",485).
component("U58_",120).
component("YGR255C",393).
component("U108_",26).
component("YMR015C",595).
component("YDR402C",279).
component("YGL055W",351).
component("YJL026W",451).
component("YIL066C",435).
component("YGR180C",383).
component("YER070W",315).
component("U36_",102).
component("U35_",101).
component("YJR009C",475).
component("YJL052W",452).
component("YGR192C",385).
component("YOR374W",703).
component("YER073W",316).
component("U68_",126).
component("YGL154C",358).
component("U55_",117).
component("YER069W",314).
component("YOR323C",696).
component("U2_",96).
component("YBR221C",189).
component("YBR166C",185).
component("YNL280C",642).
component("YGL012W",346).
component("YKL182W",511).
component("U57_",119).
component("YKL216W",521).
component("YDR044W",248).
component("YER014W",303).
component("YKR009C",524).
component("YIL160C",443).
component("YGL205W",363).
component("YKL141W",505).
component("YJR051W",480).
component("YEL047C",299).
component("YOR375C",704).
component("YDL215C",240).
component("YAL062W",148).
component("U100_",20).
component("YBR035C",167).
component("YMR189W",606).
component("U56_",118).
component("YKR080W",530).
component("YPL023C",709).
component("YGL125W",355).
component("YOR236W",691).
...
component("YIL043C",433).
component("YHR042W",408).
component("YOR221C",689).
component("YMR145C",603).
component("YML120C",588).
component("YKL192C",515).
component("YKL055C",498).
component("YER061C",310).
component("YDL085W",221).
component("YBR046C",169).
component("YMR145C",604).
component("YML120C",589).
component("YKL192C",516).
component("YDL085W",222).
component("YPL017C",708).
component("YFL018C",332).
component("YPL091W",712).
component("YER042W",304).
component("YPR167C",753).
component("YNL052W",622).
component("YMR256C",614).
component("YLR395C",575).
component("YLR038C",538).
component("YIL111W",438).
component("YHR051W",412).
component("YGL191W",361).
component("YGL187C",360).
component("YDL067C",219).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",733).
component("YBR034C",166).
component("YPL273W",735).
component("YLL062C",535).
component("YDR410C",281).
component("YKR069W",529).
component("U47_",111).
component("YER091C",321).
component("YJR073C",483).
component("YDL033C",214).
component("YOL096C",667).
component("YLR172C",552).
component("YMR120C",602).
component("YBL013W",151).
component("YJL130C",460).
component("YJL088W",455).
component("YPR074C",746).
component("YBR117C",177).
component("YLR354C",570).
component("YGR043C",371).
component("YMR108W",600).
component("YCL009C",198).
component("YMR062C",597).
component("YNL071W",623).
component("YIL160C",444).
component("YNR019W",651).
component("YCR048W",210).
component("U48_",112).
component("YNL277W",640).
component("YDR232W",268).
component("YFL017C",331).
component("YPL231W",727).
component("YER061C",311).
component("U86_",140).
component("YPL001W",707).
component("YDL052C",216).
component("U8_",143).
component("YDR148C",264).
component("YOR377W",705).
component("YGR177C",382).
component("YPL231W",728).
component("YLR195C",555).
component("YLR299W",562).
component("YPR001W",737).
component("YNR001C",647).
component("YCR005C",206).
component("YML126C",591).
component("YDL182W",237).
component("YDL131W",229).
component("YNL117W",627).
component("YIR031C",449).
component("YPR160W",752).
component("YOR321W",695).
component("YJR143C",492).
component("YGR199W",387).
component("YDL095W",224).
component("YDL093W",223).
component("YAL023C",147).
component("YPL227C",724).
component("YMR261C",615).
component("YML100W",587).
component("YBR126C",180).
component("YNL192W",634).
component("YBR038W",168).
component("YBR023C",164).
component("YEL011W",294).
component("YLR209C",556).
component("U104_",24).
component("U103_",23).
component("YOR209C",687).
component("YMR300C",617).
component("YDR354W",275).
component("YFR047C",340).
component("YJR133W",490).
component("U22_",90).
component("YLR209C",557).
component("YDR399W",277).
component("YJL167W",468).
component("YNL256W",637).
component("YPR069C",745).
component("YDR127W",259).
component("YHR190W",426).
component("YHR068W",415).
component("YLR303W",563).
component("YML082W",586).
component("YJR130C",489).
component("YDR035W",246).
component("YBR249C",190).
component("YLR180W",554).
component("YDR502C",287).
component("YOL143C",672).
component("YBR256C",192).
component("YHR137W",420).
component("YGL202W",362).
component("YLR027C",536).
component("YKL106W",501).
component("YOL140W",671).
component("YLR438W",579).
component("YKL104C",500).
component("YGR019W",369).
component("YDR111C",256).
component("U64_",123).
component("U51_",115).
component("YJR148W",493).
component("YHR208W",429).
component("YOR184W",685).
component("YNR058W",656).
component("YGL253W",368).
component("YFR053C",341).
component("YMR013C",594).
component("YMR205C",608).
component("YGR240C",391).
component("YLR240W",559).
component("YKL203C",518).
component("YJR066W",482).
component("YCR036W",209).
component("YGR194C",386).
component("YCL040W",203).
component("YJR105W",487).
component("U16_",60).
component("YPL188W",720).
component("YJR049C",479).
component("YEL041W",297).
component("YKL001C",496).
component("YML070W",585).
component("YFL053W",335).
component("YDR531W",291).
component("U82_",137).
component("U81_",136).
component("YMR208W",609).
component("YPL203W",721).
component("YOR061W",675).
component("YKL166C",509).
component("YJL164C",467).
component("YIL035C",432).
component("YHR205W",428).
component("YHR102W",418).
component("YGL019W",347).
component("YHR025W",407).
component("YNR012W",649).
component("YPR121W",749).
component("YPL258C",730).
component("YOL055C",662).
component("YPL214C",723).
component("U1_",77).
component("YDR009W",244).
component("YBR020W",163).
component("YFR019W",338).
component("YDR208W",266).
component("YDR127W",260).
component("U21_",86).
component("U20_",82).
component("YDR147W",263).
component("YDR300C",273).
component("YCR012W",207).
component("YER052C",306).
component("U19_",76).
component("U18_",70).
component("U17_",65).
component("U76_",133).
component("YMR220W",611).
component("YER170W",327).
component("YDR226W",267).
component("YKL067W",499).
component("YOL055C",663).
component("YDR454C",284).
component("YOL061W",665).
component("YKL181W",510).
component("YHL011C",399).
component("YER099C",323).
component("YBL068W",157).
component("YOR143C",681).
component("YNL256W",638).
component("YLR328W",567).
component("YBR018C",161).
component("YDL055C",217).
component("YLR328W",568).
component("YDL103C",227).
component("U94_",145).
component("YJR010W",476).
component("YBR029C",165).
component("YGL130W",356).
component("YDR530C",290).
component("YPR190C",756).
component("YPR187W",755).
component("YPR110C",748).
component("YPR010C",739).
component("YOR341W",700).
component("YOR340C",699).
component("YOR224C",690).
component("YOR210W",688).
component("YOR207C",686).
component("YOR151C",682).
component("YOR116C",677).
component("YOL005C",657).
component("YNR003C",648).
component("YNL248C",636).
component("YNL151C",632).
component("YNL113W",626).
component("YKL144C",506).
component("YJR063W",481).
component("YJL148W",464).
component("YJL140W",463).
component("YIL021W",431).
component("YHR143W-A",421).
component("YGL070C",354).
component("YFL036W",334).
component("YDR404C",280).
component("YDR156W",265).
component("YDR045C",249).
component("YDL150W",236).
component("YDL140C",231).
component("YBR154C",184).
component("YPR175W",754).
component("YPL167C",718).
component("YOR330C",697).
component("YOL115W",670).
component("YNL299W",644).
component("YNL262W",639).
component("YNL102W",625).
component("YJR043C",478).
component("YJR006W",474).
component("YJL090C",456).
component("YIL139C",439).
component("YEL055C",300).
component("YDR419W",282).
component("YDR121W",257).
component("YDL102W",226).
component("YCR014C",208).
component("YBR278W",193).
component("YBL035C",153).
component("YKL035W",497).
component("YHL012W",400).
component("YHR123W",419).
component("YNL130C",628).
component("YPL148C",716).
component("YOR251C",693).
component("YGR286C",396).
component("YDR058C",252).
component("YOL011W",659).
component("YMR008C",593).
component("YMR006C",592).
component("U105_",25).
component("U101_",21).
component("YJL068C",453).
component("YPL072W",711).
component("YOR124C",678).
component("YNL186W",633).
component("YMR304W",618).
component("YMR223W",612).
component("YKR098C",532).
component("YJL197W",469).
component("YIL156W",442).
component("YFR010W",337).
component("YER151C",326).
component("YER144C",325).
component("YER098W",322).
component("YDR069C",253).
component("YDL122W",228).
component("YBR058C",170).
component("YBL067C",156).
component("YJR019C",477).
component("U84_",138).
component("YDR481C",285).
component("YLR377C",573).
component("YDR074W",254).
component("YFR025C",339).
component("YPL179W",719).
component("YNR032W",652).
component("YML057W",584).
component("YML016C",580).
component("YLR433C",578).
component("YGR123C",377).
component("YER133W",324).
component("YER089C",319).
component("YDR436W",283).
component("YDR075W",255).
...
component("YER062C",312).
component("YHR046C",411).
component("U9_",146).
component("YGR208W",390).
component("YPL228W",725).
component("YMR180C",605).
component("YJL155C",466).
component("U34_",100).
component("U33_",99).
component("U32_",98).
component("U30_",97).
...
component("YOL064C",666).
component("YPL268W",734).
component("YOR360C",702).
component("YGL248W",367).
component("YKR031C",525).
component("YGL027C",349).
component("YLR286C",561).
component("YJR153W",494).
component("YJL221C",473).
component("YJL216C",471).
component("YIL172C",448).
component("YGR292W",398).
component("YGR287C",397).
component("YBR299W",197).
component("YBR184W",186).
component("YIL162W",445).
component("YPR026W",740).
component("YDR001C",242).
component("YBR001C",160).
component("YDR400W",278).
component("U102_",22).
component("YER043C",305).
component("YNL045W",621).
component("YLR160C",551).
component("YLR158C",550).
component("YLR157C",549).
component("YLR155C",548).
component("YDR321W",274).
component("YGL037C",350).
component("U43_",108).
component("U42_",107).
component("YLR308W",566).
component("YLR307W",565).
component("U53_",116).
component("YLR420W",576).
component("YPL111W",714).
component("YIR032C",450).
component("YLR028C",537).
component("YHR144C",422).
component("YHR144C",423).
component("YNL141W",629).
component("YBR153W",183).
component("YDL238C",241).
component("YNL141W",630).
...
component("YBR252W",191).
component("YCL030C",202).
component("YER005W",302).
component("YBL099W",159).
component("YLR231C",558).
component("U88_",141).
component("YDR538W",293).
component("YLR134W",545).
component("YLR044C",539).
component("YGR087C",374).
component("YDR380W",276).
component("YDL080C",220).
component("YMR250W",613).
component("YKL184W",514).
component("YEL021W",295).
component("YNR043W",654).
component("YDR047W",251).
component("YKL211C",519).
component("YKR097W",531).
component("YOL052C",661).
component("YDR294C",270).
component("YEL046C",298).
component("YNR033W",653).
component("YPR006C",738).
component("YER065C",313).
component("YKL211C",520).
component("YER090W",320).
component("YDR127W",261).
component("YPL281C",736).
component("YOR393W",706).
component("YMR323W",619).
component("YHR174W",424).
component("YGR254W",392).
component("YPL262W",731).
component("YGL026C",348).
component("YGR155W",380).
component("YLR304C",564).
component("YJL200C",470).
component("YGL009C",345).
component("YNL316C",645).
component("YKL182W",512).
component("YPL212C",722).
component("YNL292W",643).
component("YGL063W",353).
component("YFL001W",329).
component("YCR053W",211).
component("YDR127W",262).
component("YGL148W",357).
component("YIL168W",447).
component("YIL167W",446).
component("YCL064C",204).
component("YCL064C",205).
component("YHR018C",403).
component("YLR359W",572).
component("YFR055W",342).
component("YJL121C",457).
component("YBR019C",162).
component("YDR007W",243).
component("YOR095C",676).
component("YBR196C",187).
component("YGL001C",344).
component("YPL117C",715).
component("U14_",49).
component("YKL152C",508).
component("YMR105C",599).
component("YKL127W",503).
component("YEL058W",301).
component("YPR060C",744).
component("YHR072W",416).
component("YJL153C",465).
component("YGR264C",395).
component("YGR171C",381).
component("YHR011W",402).
component("YDR023W",245).
component("YPL104W",713).
component("YLL018C",533).
component("YPR081C",747).
component("YBR121C",178).
component("YHR020W",406).
component("YER087W",318).
component("YGL245W",366).
component("YOR168W",683).
component("YOL097C",668).
component("YDR268W",269).
component("YPR047W",743).
component("YLR060W",541).
component("YFL022C",333).
component("YPR033C",741).
component("YHR019C",404).
component("YHR019C",405).
component("YKL194C",517).
component("YIL078W",437).
component("YPL160W",717).
component("YLR382C",574).
component("YPL040C",710).
component("YBL076C",158).
component("YNL073W",624).
component("YDR037W",247).
component("YOR335C",698).
component("YGR094W",375).
component("YPR035W",742).
component("YIL145C",440).
component("U89_",142).
component("YOR241W",692).
component("YMR113W",601).
component("YKL132C",504).
component("YGL234W",364).
component("YER183C",328).
component("U90_",144).
component("YNR057C",655).
component("YDL141W",232).
component("YDL141W",233).
component("YGL234W",365).
component("YDL141W",234).
component("YGR204W",389).
component("YDL141W",235).
component("YHR074W",417).
component("YMR217W",610).
component("YPR145W",751).
component("YGR124W",378).
component("YOR303W",694).
component("YJR109C",488).
component("YJL130C",461).
component("YGL062W",352).
component("YBR218C",188).
component("YPL231W",729).
component("YNR016C",650).
component("YKL182W",513).
component("YGR037C",370).
component("YJL087C",454).
component("YOL010W",658).
component("YPR138C",750).
component("YPL265W",732).
component("YOR348C",701).
component("YOR171C",684).
component("YOR130C",679).
component("YOR011W",674).
component("YOL156W",673).
component("YOL103W",669).
component("YOL020W",660).
component("YNL318C",646).
component("YNL142W",631).
component("YMR272C",616).
component("YMR202W",607).
component("YMR056C",596).
component("YML123C",590).
component("YLR348C",569).
component("YLR260W",560).
component("YLR138W",546).
component("YLR100C",544).
component("YLR092W",543).
component("YLR081W",542).
component("YLL061W",534).
component("YKR053C",527).
component("YKR039W",526).
component("YKL217W",522).
component("YKL120W",502).
component("YJR095W",486).
component("YJR077C",484).
component("YJL219W",472).
component("YJL134W",462).
component("YJL129C",459).
component("YHL036W",401).
component("YGR191W",384).
component("YGR125W",379).
component("YGR121C",376).
component("YGR065C",373).
component("YGR055W",372).
component("YGL186C",359).
component("YFL055W",336).
component("YFL011W",330).
component("YER060W-A",309).
component("YER060W",308).
component("YER056C",307).
...
component("YDR046C",250).
component("YDL210W",239).
component("YCL025C",200).
component("YBR298C",196).
component("YBR294W",195).
component("YBR291C",194).
component("YBR085W",175).
component("YBR069C",172).
component("YBR068C",171).
component("YBL042C",154).
component("YBL030C",152).
component("U85_",139).
component("U7_",135).
component("U79_",134).
component("U75_",132).
