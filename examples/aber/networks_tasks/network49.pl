...
component("YNL280C",353).
component("YLR056W",293).
component("YMR083W",326).
component("YPL231W",398).
component("YJR159W",270).
component("YGL001C",192).
component("YML056C",315).
component("YLR432W",313).
component("YHR216W",235).
component("YAR075W",79).
component("YAR073W",78).
component("YDR127W",142).
component("YJR139C",267).
component("YNL009W",341).
component("YLR174W",302).
component("YHR183W",232).
component("YGR256W",215).
component("YCL018W",105).
component("YJR078W",263).
component("YMR015C",323).
component("YDR402C",156).
component("YGL055W",197).
component("YJL026W",242).
component("YGR180C",212).
component("YOR374W",388).
component("YER073W",175).
component("U68_",66).
component("U55_",62).
component("YER069W",174).
component("YOR323C",383).
component("YBR166C",98).
component("YNL280C",354).
component("YKL141W",276).
component("YOR375C",389).
component("YDL215C",131).
component("YAL062W",77).
component("U100_",20).
component("YBR035C",87).
component("YMR189W",330).
component("U56_",63).
component("YPL023C",391).
component("YGL125W",199).
component("YOR236W",381).
component("YLR142W",297).
component("U65_",65).
component("YMR145C",329).
component("YDL085W",117).
component("YBR046C",88).
component("YPL091W",394).
component("YNL052W",342).
component("YMR256C",336).
component("YLR395C",312).
component("YLR038C",291).
component("YIL111W",238).
component("YHR051W",224).
component("YGL191W",203).
component("YGL187C",202).
component("YDL067C",115).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",403).
component("YLL062C",288).
component("YDR410C",158).
component("YER091C",177).
component("YJR073C",261).
component("YOL096C",368).
component("YMR120C",328).
component("YJL130C",248).
component("YJL088W",244).
component("YPR074C",409).
component("YBR117C",94).
component("YCL009C",104).
component("YMR062C",325).
component("YNL071W",343).
component("YNR019W",360).
component("YCR048W",112).
component("U48_",59).
component("YFL017C",183).
component("YPL231W",399).
component("YDL052C",114).
component("U8_",72).
component("YPL231W",400).
component("YLR299W",306).
component("YCR005C",109).
component("YML126C",319).
component("YDL182W",129).
component("YDL131W",122).
component("YNL117W",346).
component("YIR031C",241).
component("YOR321W",382).
component("YJR143C",268).
component("YGR199W",213).
component("YDL095W",119).
component("YDL093W",118).
component("YAL023C",76).
component("YMR261C",337).
component("YML100W",317).
component("YBR126C",95).
component("YLR209C",303).
component("YDR354W",153).
component("YFR047C",190).
component("YJR133W",266).
component("U22_",50).
component("YDR399W",155).
component("YJL167W",255).
component("YPR069C",408).
component("YDR127W",143).
component("YML082W",316).
component("YJR130C",265).
component("YDR035W",135).
component("YBR249C",100).
component("YBR256C",101).
component("YHR137W",227).
component("YGL202W",204).
component("YLR027C",289).
component("YKL106W",274).
component("YOL140W",371).
component("YLR438W",314).
component("YKL104C",273).
component("YDR111C",140).
component("U51_",60).
component("YJR148W",269).
component("YMR013C",322).
component("YCR036W",111).
component("YCL040W",108).
component("YJR105W",264).
component("U81_",71).
component("YMR208W",332).
component("YPL203W",397).
component("YOR061W",372).
component("YKL166C",278).
component("YJL164C",254).
component("YIL035C",237).
component("YHR205W",234).
component("YHR102W",226).
component("YGL019W",193).
component("YHR025W",221).
component("YNR012W",358).
component("YFR019W",188).
component("YDR208W",149).
component("YDR127W",144).
component("U21_",47).
component("YDR147W",147).
component("YER052C",170).
component("U19_",43).
component("U18_",39).
component("U17_",36).
component("U76_",69).
component("YMR220W",333).
component("YDR226W",150).
component("YKL067W",272).
component("YDR454C",160).
component("YOL061W",367).
component("YKL181W",279).
component("YHL011C",217).
component("YER099C",179).
component("YBL068W",84).
component("YOR143C",376).
component("YLR328W",309).
component("U94_",74).
component("YBR029C",86).
component("YPR190C",415).
component("YPR187W",414).
component("YPR110C",410).
component("YPR010C",405).
component("YOR341W",386).
component("YOR340C",385).
component("YOR224C",380).
component("YOR210W",379).
component("YOR207C",378).
component("YOR151C",377).
component("YOR116C",374).
component("YOL005C",363).
component("YNR003C",357).
component("YNL248C",351).
component("YNL151C",349).
component("YNL113W",345).
component("YKL144C",277).
component("YJR063W",260).
component("YJL148W",251).
component("YJL140W",250).
component("YIL021W",236).
component("YHR143W-A",228).
component("YGL070C",198).
component("YFL036W",185).
component("YDR404C",157).
component("YDR156W",148).
component("YDR045C",136).
component("YDL150W",128).
component("YDL140C",123).
component("YBR154C",97).
component("YPR175W",413).
component("YPL167C",396).
component("YOR330C",384).
component("YOL115W",370).
component("YNL299W",355).
component("YNL262W",352).
component("YNL102W",344).
component("YJR043C",259).
component("YJR006W",257).
component("YJL090C",245).
component("YIL139C",239).
component("YEL055C",167).
component("YDR419W",159).
component("YDR121W",141).
component("YDL102W",120).
component("YCR014C",110).
component("YBR278W",102).
component("YBL035C",81).
component("YKL035W",271).
component("YHL012W",218).
component("YOL011W",365).
component("YMR008C",321).
component("YMR006C",320).
component("U105_",21).
component("YPL072W",393).
component("YOR124C",375).
component("YNL186W",350).
component("YMR304W",339).
component("YMR223W",334).
component("YKR098C",287).
component("YJL197W",256).
component("YIL156W",240).
component("YFR010W",187).
component("YER151C",181).
component("YER144C",180).
component("YER098W",178).
component("YDR069C",138).
component("YDL122W",121).
component("YBR058C",89).
component("YBL067C",83).
component("YJR019C",258).
component("YDR074W",139).
component("YFR025C",189).
component("U9_",75).
...
component("U30_",52).
component("U24_",51).
component("YHR044C",223).
component("YHR043C",222).
component("YGL027C",195).
component("YLR286C",305).
component("YLR160C",301).
component("YLR158C",300).
component("YLR157C",299).
component("YLR155C",298).
component("YDR321W",152).
component("YGL037C",196).
component("U43_",57).
component("U42_",56).
component("YLR308W",308).
component("YLR307W",307).
component("U53_",61).
component("YLR028C",290).
component("YHR144C",229).
component("YHR144C",230).
component("YBR153W",96).
component("YDL238C",132).
component("YNL141W",347).
component("YJL126W",247).
component("U44_",58).
component("YHR201C",233).
component("YBR111C",93).
component("YCL030C",107).
component("YER005W",169).
component("YLR231C",304).
component("YDR538W",165).
component("YLR134W",296).
component("YLR044C",292).
component("YGR087C",207).
component("YDR380W",154).
component("YDL080C",116).
component("YMR250W",335).
component("YKL184W",281).
component("YEL021W",166).
component("YKL211C",282).
component("YNR033W",361).
component("YKL211C",283).
component("YER090W",176).
component("YDR127W",145).
component("YPL281C",404).
component("YOR393W",390).
component("YMR323W",340).
component("YHR174W",231).
component("YGR254W",214).
component("YGL026C",194).
component("YGR155W",210).
component("YNL316C",356).
component("YCR053W",113).
component("YDR127W",146).
component("YGL148W",200).
component("YFR055W",191).
component("YJL121C",246).
component("YDR007W",133).
component("YOR095C",373).
component("YBR196C",99).
component("U14_",30).
component("YMR105C",327).
component("YKL127W",275).
component("YEL058W",168).
component("YPR060C",407).
component("YHR072W",225).
component("YJL153C",252).
component("YGR264C",216).
component("YGR171C",211).
component("YHR011W",219).
component("YDR023W",134).
component("YGL245W",205).
component("YPR047W",406).
component("YLR060W",294).
component("YFL022C",184).
component("YHR019C",220).
component("YPL160W",395).
component("YLR382C",311).
component("YPL040C",392).
component("YBL076C",85).
component("YER183C",182).
component("U90_",73).
component("YNR057C",362).
component("YDL141W",124).
component("YDL141W",125).
component("YDL141W",126).
component("YDL141W",127).
component("YPR145W",412).
component("YGR124W",209).
component("YPL231W",401).
component("YNR016C",359).
component("YKL182W",280).
component("YGR037C",206).
component("YJL087C",243).
component("YOL010W",364).
component("YPR138C",411).
component("YPL265W",402).
component("YOR348C",387).
component("YOL103W",369).
component("YOL020W",366).
component("YNL142W",348).
component("YMR272C",338).
component("YMR202W",331).
component("YMR056C",324).
component("YML123C",318).
component("YLR348C",310).
component("YLR100C",295).
component("YKR053C",286).
component("YKR039W",285).
component("YKL217W",284).
component("YJR077C",262).
component("YJL134W",249).
component("YGR121C",208).
component("YGL186C",201).
component("YFL055W",186).
...
component("YDR294C",151).
component("YDR046C",137).
component("YDL210W",130).
component("YCL025C",106).
component("YBR291C",103).
component("YBR085W",92).
component("YBR069C",91).
component("YBR068C",90).
component("YBL042C",82).
component("YBL030C",80).
component("U7_",70).
component("U6_",68).
component("U69_",67).
component("U5_",64).
