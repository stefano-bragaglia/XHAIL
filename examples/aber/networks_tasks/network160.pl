...
component("YLR450W",746).
component("YKL085W",652).
component("YKL029C",647).
component("YOR136W",874).
component("YNL037C",799).
component("YNL009W",797).
component("YLR174W",716).
component("YDL066W",292).
component("YHR183W",556).
component("YGR256W",515).
component("YNL241C",814).
component("YOL059W",852).
component("YDL022W",284).
component("YCL018W",263).
component("YLR355C",737).
component("YIL074C",568).
component("YER081W",421).
component("YML054C",752).
component("YDL174C",316).
component("YIL155C",576).
component("YPR191W",965).
component("YOR065W",866).
component("YJL166W",610).
component("YHR001W-A",525).
component("YGR183C",500).
component("YFR033C",449).
component("YEL024W",395).
component("YDR529C",387).
component("YBL045C",203).
component("Q0105",19).
component("YKR066C",683).
component("YKL026C",646).
component("YIR037W",587).
component("YBR244W",252).
component("YJR078W",630).
component("U58_",153).
component("U107_",28).
component("YGR255C",514).
component("U108_",29).
component("YBL098W",208).
component("YMR015C",768).
component("YHR007C",526).
component("YDR402C",374).
component("YGL055W",462).
component("YJR104C",632).
component("YHR008C",527).
component("YJL026W",590).
component("YIL066C",567).
component("YGR180C",499).
component("YER070W",419).
component("U37_",133).
component("U36_",132).
component("U35_",131).
component("YDR158W",351).
component("YJR009C",620).
component("YJL052W",592).
component("YGR192C",502).
component("YBR006W",213).
component("YPL276W",940).
component("YPL275W",939).
component("YOR388C",904).
component("YOR374W",901).
component("YER073W",420).
component("U68_",164).
component("YGL154C",469).
component("YBR115C",236).
component("U55_",150).
component("YER069W",418).
component("YOR323C",894).
component("U2_",126).
component("YER178W",432).
component("YBR221C",250).
component("YIL125W",573).
component("YBR166C",246).
component("YNL280C",822).
component("YGL012W",456).
component("YKL182W",665).
component("U57_",152).
component("YKL216W",675).
component("YDR044W",332).
component("YER014W",405).
component("YKR009C",679).
component("YIL160C",578).
component("YGL205W",474).
component("YMR118C",776).
component("YLR164W",714).
component("YLL041C",690).
component("YKL148C",660).
component("YKL141W",658).
component("YJL045W",591).
component("YDR178W",352).
component("YJR051W",625).
component("YEL047C",398).
component("YDL171C",315).
component("YOR375C",902).
component("YDL215C",320).
component("YAL062W",195).
component("U99_",191).
component("U100_",22).
component("YBR035C",223).
component("YMR189W",782).
component("U56_",151).
component("YNR050C",837).
component("YKR080W",685).
component("YER023W",406).
component("YPL023C",908).
component("YGL125W",466).
...
component("YIL043C",565).
component("YHR042W",534).
component("YOR221C",885).
component("YMR145C",778).
component("YML120C",760).
component("YKL192C",669).
component("YKL055C",649).
component("YER061C",414).
component("YDL085W",295).
component("YBR046C",226).
component("YMR145C",779).
component("YML120C",761).
component("YKL192C",670).
component("YDL085W",296).
component("YFR030W",448).
component("YPL017C",907).
component("YFL018C",437).
component("YPL091W",913).
component("YDR353W",369).
component("YER042W",407).
component("YPR167C",959).
component("YJR137C",637).
component("YNL052W",801).
component("YMR256C",790).
component("YLR395C",741).
component("YLR038C",697).
component("YIL111W",571).
component("YHR051W",538).
component("YGL191W",472).
component("YGL187C",471).
component("YDL067C",293).
component("Q0275",21).
component("Q0250",20).
component("Q0045",18).
component("YPL266W",936).
component("YML110C",759).
component("YBR034C",222).
component("YPL273W",938).
component("YLL062C",693).
component("YDR410C",377).
component("YKR069W",684).
component("YOL096C",855).
component("U47_",142).
component("YER091C",425).
component("YJR073C",628).
component("YML008C",747).
component("YDL033C",286).
component("YOL096C",856).
component("YLR172C",715).
component("YBR263W",256).
component("YDR019C",328).
component("YDR408C",376).
component("YMR120C",777).
component("YLR028C",695).
component("YBL013W",199).
component("YJL130C",602).
component("YJL088W",596).
component("YPR074C",952).
component("YBR117C",237).
component("YLR354C",736).
component("YGR043C",484).
component("YMR108W",774).
component("YCL009C",262).
component("YMR062C",770).
component("YNL071W",802).
component("YIL160C",579).
component("YNR019W",831).
component("YCR048W",279).
component("U48_",143).
component("YNL277W",820).
component("YDR232W",355).
component("YFL017C",436).
component("YPL231W",930).
component("YER061C",415).
component("U86_",182).
component("YPL001W",906).
component("YDL052C",290).
component("U8_",185).
component("YDR148C",349).
component("YOR377W",903).
component("YGR177C",498).
component("YPL231W",931).
component("YGR147C",494).
component("YDL040C",287).
component("YPL028W",909).
component("YLR195C",718).
component("YLR299W",728).
component("YGL017W",457).
component("YPR001W",942).
component("YNR001C",827).
component("YCR005C",274).
component("YML126C",763).
component("YDL182W",317).
component("YDL131W",305).
component("YNL117W",806).
component("YIR031C",585).
component("YPR160W",958).
component("YOR321W",893).
component("YJR143C",639).
component("YGR199W",504).
component("YDL095W",300).
component("YDL093W",299).
component("YAL023C",193).
component("YLR258W",725).
component("YFR015C",445).
component("YPL227C",927).
component("YOR103C",870).
component("YOR085W",868).
component("YMR149W",780).
component("YML019W",749).
component("YJL002C",588).
component("YEL002C",392).
component("YDL232W",321).
component("YCL043C",269).
component("YNL029C",798).
component("YIL085C",570).
component("YMR261C",791).
component("YML100W",758).
component("YBR126C",240).
component("YNL192W",813).
component("YBR038W",225).
component("YBR023C",220).
component("YEL011W",393).
component("YPR183W",962).
component("YLR209C",719).
component("U104_",26).
component("U103_",25).
component("YOR209C",883).
component("YMR300C",794).
component("YDR354W",370).
component("YFR047C",450).
component("YJR133W",636).
component("U22_",120).
component("YLR209C",720).
component("YML022W",750).
component("YDR441C",380).
component("YDR399W",372).
component("YPR176C",961).
component("YPL172C",920).
component("YNR041C",835).
component("YMR101C",772).
component("YDL090C",298).
component("YBR003W",212).
component("YBR002C",211).
component("YJL167W",611).
component("YJL167W",612).
component("YNL256W",816).
component("YPR069C",950).
component("YDR127W",344).
component("YHR190W",557).
component("YLR146C",708).
component("YHR068W",541).
component("YLR303W",729).
component("YGR012W",481).
component("YML082W",757).
component("YJR130C",635).
component("YDR035W",330).
component("YBR249C",253).
component("YLR180W",717).
component("YDR502C",384).
component("YOR274W",890).
component("YOL143C",861).
component("YBR256C",255).
component("YHR137W",550).
component("YGL202W",473).
component("YLR027C",694).
component("YKL106W",654).
component("YOL140W",860).
component("YLR438W",745).
component("YKL104C",653).
component("YGR019W",482).
component("YDR111C",341).
component("U64_",160).
component("U61_",157).
component("U51_",147).
component("YJR148W",640).
component("YHR208W",560).
component("YFL030W",439).
component("YOR184W",880).
component("YNR058W",839).
component("YIL116W",572).
component("YGL253W",479).
component("YFR053C",451).
component("YMR013C",767).
component("YMR205C",784).
component("YGR240C",510).
component("YOL016C",844).
component("YFR014C",444).
component("YLR240W",723).
component("YKL203C",672).
component("YJR066W",627).
component("YCR036W",278).
component("YGR194C",503).
component("YCL040W",268).
component("YJR105W",633).
component("U16_",76).
component("YPL188W",922).
component("YJR049C",624).
component("YEL041W",396).
component("U96_",190).
component("YKL001C",644).
component("YDR236C",356).
component("YML070W",755).
component("YFL053W",441).
component("YHL032C",523).
component("YLR133W",704).
component("YDR531W",389).
component("U83_",179).
component("U82_",178).
component("U81_",177).
component("YMR208W",785).
component("YPL203W",923).
component("YOR061W",865).
component("YKL166C",663).
component("YJL164C",609).
component("YIL035C",564).
component("YHR205W",559).
component("YHR102W",548).
component("YGL019W",458).
component("YHR025W",533).
component("YNR012W",829).
component("YPR121W",955).
component("YPL258C",933).
component("YOL055C",848).
component("YPL214C",926).
component("U1_",100).
component("YDR009W",327).
component("YBR020W",219).
component("YFR019W",446).
component("YDR208W",353).
...
component("U17_",83).
component("U76_",173).
component("YMR220W",787).
component("YER170W",431).
component("YDR226W",354).
component("YKL067W",651).
component("YOL055C",849).
component("YDR454C",381).
component("YOL061W",853).
component("YKL181W",664).
component("YHL011C",520).
...
component("YDL055C",291).
component("YGR007W",480).
component("YGR202C",505).
component("YLR328W",734).
component("YKR002W",677).
component("YDL045C",288).
component("YDL103C",303).
component("U94_",189).
component("YJR010W",621).
component("YBR029C",221).
component("YCL050C",270).
component("YGL130W",467).
component("YDR530C",388).
component("YCL050C",271).
component("YPR190C",964).
component("YPR187W",963).
component("YPR110C",954).
component("YPR010C",944).
component("YOR341W",898).
component("YOR340C",897).
component("YOR224C",886).
component("YOR210W",884).
component("YOR207C",882).
component("YOR151C",876).
component("YOR116C",871).
component("YOL005C",841).
component("YNR003C",828).
component("YNL248C",815).
component("YNL151C",811).
component("YNL113W",805).
component("YKL144C",659).
component("YJR063W",626).
component("YJL148W",606).
component("YJL140W",605).
component("YIL021W",563).
component("YHR143W-A",551).
component("YGL070C",465).
component("YFL036W",440).
component("YDR404C",375).
component("YDR156W",350).
component("YDR045C",333).
component("YDL150W",313).
component("YDL140C",307).
component("YBR154C",245).
component("YPR175W",960).
component("YPL167C",919).
component("YOR330C",895).
component("YOL115W",859).
component("YNL299W",824).
component("YNL262W",818).
component("YNL102W",804).
component("YJR043C",623).
component("YJR006W",619).
component("YJL090C",597).
component("YIL139C",574).
...
component("YKL035W",648).
component("YHL012W",521).
component("YHR123W",549).
component("YBR243C",251).
component("YNL130C",807).
component("YDL142C",312).
component("YPL148C",917).
component("YOR251C",889).
component("YGR286C",517).
component("YJL068C",593).
component("YDR058C",337).
component("YNR034W",834).
component("YHR163W",554).
component("YGR248W",512).
component("YCR073W-A",281).
component("YDL086W",297).
component("YOL011W",843).
component("YMR008C",765).
component("YMR006C",764).
component("U105_",27).
component("U101_",23).
component("YJL068C",594).
component("YPL072W",912).
component("YOR124C",872).
component("YNL186W",812).
component("YMR304W",795).
component("YMR223W",788).
component("YKR098C",688).
component("YJL197W",613).
component("YIL156W",577).
component("YFR010W",443).
component("YER151C",430).
component("YER144C",429).
component("YER098W",426).
component("YDR069C",338).
component("YDL122W",304).
component("YBR058C",227).
component("YBL067C",205).
component("YJR019C",622).
component("YDR272W",359).
component("U84_",180).
component("YDR481C",382).
component("YLR377C",739).
component("YDR074W",339).
component("YFR025C",447).
component("YPL179W",921).
component("YNR032W",832).
component("YML057W",754).
component("YML016C",748).
component("YLR433C",744).
component("YGR123C",491).
component("YER133W",428).
component("YER089C",423).
component("YDR436W",379).
component("YDR075W",340).
component("YDL188C",318).
component("YDL134C",306).
component("YDL047W",289).
component("YDL006W",282).
component("YBR125C",239).
component("YBL056W",204).
component("YPR073C",951).
component("YHR215W",561).
component("YDL024C",285).
component("YBR093C",234).
component("YBR092C",233).
component("YIL053W",566).
component("YER062C",416).
component("YHR046C",537).
component("U9_",192).
component("YGR208W",509).
component("YPL228W",928).
component("YMR180C",781).
component("YDL236W",322).
component("YJL155C",608).
component("U34_",130).
component("U33_",129).
component("U32_",128).
component("U30_",127).
...
component("U26_",122).
component("U24_",121).
component("YHR044C",536).
component("YHR043C",535).
component("YOL064C",854).
component("YPL268W",937).
component("YOR360C",900).
component("YGL248W",478).
component("YKR031C",680).
component("YPL206C",924).
component("YGL027C",460).
component("YLR286C",727).
component("YJR153W",641).
component("YJL221C",618).
component("YJL216C",616).
component("YIL172C",583).
component("YGR292W",519).
component("YGR287C",518).
component("YBR299W",261).
component("YBR184W",247).
component("YIL162W",580).
component("YPR026W",945).
component("YDR001C",325).
component("YBR001C",210).
component("YDR400W",373).
component("U102_",24).
component("YER043C",408).
component("YNL045W",800).
component("YLR160C",713).
component("YLR158C",712).
component("YLR157C",711).
component("YLR155C",710).
component("YDR321W",364).
component("YGL037C",461).
component("U43_",139).
component("U42_",138).
component("YMR293C",793).
component("YDR242W",357).
component("YLR308W",732).
component("YLR307W",731).
component("U53_",148).
component("YLR420W",742).
component("YPL111W",915).
component("YIR032C",586).
component("YIR029W",584).
...
component("U40_",136).
component("U39_",134).
component("YBR011C",214).
component("YHR201C",558).
component("YBR111C",235).
component("YBR252W",254).
component("YCL030C",267).
component("YER005W",404).
component("YBL099W",209).
component("U60_",156).
component("YLR231C",721).
component("U88_",183).
component("YDR538W",391).
component("YLR134W",705).
component("YLR044C",698).
component("YGR087C",488).
component("YDR380W",371).
component("YDL080C",294).
component("YMR250W",789).
component("YKL184W",668).
component("YEL021W",394).
component("YNR043W",836).
component("U93_",188).
component("YDR047W",335).
component("U54_",149).
component("YKL211C",673).
component("YKR097W",687).
component("YOL052C",847).
component("YGR170W",496).
component("YKL060C",650).
component("YDR294C",360).
component("YEL046C",397).
component("YNR033W",833).
component("YPR006C",943).
component("YER065C",417).
component("YKL211C",674).
component("YER090W",424).
component("YDR127W",346).
component("YPL281C",941).
component("YOR393W",905).
component("YMR323W",796).
component("YHR174W",555).
component("YGR254W",513).
component("YPL262W",934).
component("YGL026C",459).
component("YGR155W",495).
component("YLR304C",730).
component("YJL200C",614).
component("YGL009C",455).
component("YNL316C",825).
component("YKL182W",666).
component("YPL212C",925).
component("YNL292W",823).
component("YGL063W",464).
component("YFL001W",434).
component("YOR278W",891).
component("U49_",144).
component("YCR053W",280).
component("YDR127W",347).
component("YGL148W",468).
component("YIL168W",582).
component("YIL167W",581).
component("YCL064C",272).
component("YCL064C",273).
component("YHR018C",529).
component("YLR359W",738).
component("YFR055W",452).
component("YJL005W",589).
component("YOR176W",879).
component("YJL121C",599).
component("YBR019C",217).
component("YBR019C",218).
component("U59_",154).
component("YDR050C",336).
component("YDR007W",326).
component("YOR095C",869).
component("YER003C",403).
component("YBR196C",248).
component("YGL001C",454).
component("YPL117C",916).
component("U14_",61).
component("YOL056W",850).
component("YKL152C",662).
component("YDL021W",283).
component("YMR105C",773).
component("YKL127W",656).
component("YEL058W",400).
component("YPR060C",949).
component("YHR072W",542).
component("YJL153C",607).
component("YGR264C",516).
component("YGR171C",497).
component("YHR011W",528).
component("YDR023W",329).
component("YPL104W",914).
component("YLL018C",689).
component("YPR081C",953).
component("YBR121C",238).
component("YHR020W",532).
component("YER087W",422).
component("YOL033W",846).
component("YGL245W",477).
component("YOR168W",877).
component("YHR091C",544).
component("YDR341C",365).
component("YOL097C",857).
component("YDR268W",358).
component("YPR047W",948).
component("YLR060W",700).
component("YFL022C",438).
component("YPR033C",946).
component("YHR019C",530).
component("YHR019C",531).
component("YKL194C",671).
component("YIL078W",569).
component("YPL160W",918).
component("YLR382C",740).
component("YPL040C",910).
component("YBL076C",207).
component("YNL073W",803).
component("YDR037W",331).
component("YOR335C",896).
component("YGR094W",489).
component("YLR153C",709).
component("YAL054C",194).
component("YGR244C",511).
component("YPR035W",947).
component("YIL145C",575).
component("U89_",184).
component("YOR241W",888).
component("YMR113W",775).
component("YKL132C",657).
component("YJL101C",598).
component("U92_",187).
component("YAR015W",196).
component("YGL234W",475).
component("YER183C",433).
component("U90_",186).
component("YNR057C",838).
component("YDL141W",308).
component("YDL141W",309).
component("YGL234W",476).
component("YDL141W",310).
component("YGR204W",508).
component("YOL058W",851).
component("YDL141W",311).
component("YHR074W",543).
component("YMR217W",786).
component("YPR145W",957).
component("YGR124W",492).
component("YOR303W",892).
component("YJR109C",634).
component("YJL130C",603).
component("YGL062W",463).
component("YBR218C",249).
component("YPL231W",932).
component("YNR016C",830).
component("YKL182W",667).
component("YGR037C",483).
component("YOR005C",863).
component("YDL164C",314).
component("YJL087C",595).
component("YOL010W",842).
component("YPR138C",956).
component("YPL265W",935).
component("YPL057C",911).
component("YOR348C",899).
component("YOR192C",881).
component("YOR171C",878).
component("YOR130C",873).
component("YOR071C",867).
component("YOR011W",864).
component("YOL156W",862).
component("YOL103W",858).
component("YOL020W",845).
component("YNR072W",840).
component("YNL318C",826).
component("YNL270C",819).
component("YNL142W",810).
component("YMR272C",792).
component("YMR202W",783).
component("YMR056C",769).
component("YMR011W",766).
component("YML123C",762).
component("YLR348C",735).
component("YLR260W",726).
component("YLR237W",722).
component("YLR138W",706).
component("YLR100C",703).
component("YLR092W",702).
component("YLR081W",701).
component("YLL061W",692).
component("YLL043W",691).
component("YKR093W",686).
component("YKR053C",682).
component("YKR039W",681).
component("YKL217W",676).
component("YKL120W",655).
component("YKL004W",645).
component("YJR158W",642).
component("YJR095W",631).
component("YJR077C",629).
component("YJL219W",617).
component("YJL214W",615).
component("YJL134W",604).
component("YJL129C",601).
component("YHR096C",547).
component("YHR094C",546).
component("YHR092C",545).
component("YHL036W",524).
component("YHL016C",522).
component("YGR191W",501).
component("YGR125W",493).
component("YGR121C",490).
component("YGR065C",487).
component("YGR055W",485).
component("YGL186C",470).
component("YFL055W",442).
component("YFL011W",435).
component("YER060W-A",413).
component("YER060W",412).
component("YER056C",411).
component("YER053C",410).
component("YEL069C",402).
component("YEL063C",401).
component("YDR536W",390).
component("YDR508C",386).
component("YDR503C",385).
...
component("YDR046C",334).
component("YDL245C",324).
component("YDL210W",319).
component("YCR028C",277).
component("YCL025C",264).
component("YBR298C",260).
component("YBR294W",259).
component("YBR291C",258).
component("YBR085W",232).
component("YBR069C",229).
component("YBR068C",228).
component("YBR036C",224).
