...
component("YJR159W",492).
component("YGL001C",340).
component("YHR063C",410).
component("YML056C",580).
component("YLR432W",574).
component("YHR216W",427).
component("YAR075W",147).
component("YAR073W",146).
component("YCL030C",198).
component("YDR127W",255).
component("YJR139C",488).
component("YOR136W",676).
component("YNL009W",617).
component("YLR174W",550).
component("YDL066W",215).
component("YHR183W",422).
component("YGR256W",391).
component("YNL241C",632).
component("YOL059W",661).
component("YDL022W",210).
component("YCL018W",196).
component("YLR355C",568).
component("YIL074C",433).
component("YER081W",314).
component("YML054C",579).
component("YIL155C",438).
component("YEL024W",293).
component("YKR066C",525).
component("YJR078W",482).
component("U58_",117).
component("YGR255C",390).
component("U108_",26).
component("YMR015C",592).
component("YDR402C",276).
component("YGL055W",348).
component("YJL026W",448).
component("YIL066C",432).
component("YGR180C",380).
component("YER070W",312).
component("U36_",101).
component("U35_",100).
component("YJR009C",472).
component("YJL052W",449).
component("YGR192C",382).
component("YOR374W",699).
component("YER073W",313).
component("U68_",123).
component("YGL154C",355).
component("U55_",115).
component("YER069W",311).
component("YOR323C",692).
component("U2_",95).
...
component("YER014W",300).
component("YKR009C",521).
component("YIL160C",440).
component("YGL205W",360).
component("YKL141W",502).
component("YJR051W",477).
component("YEL047C",296).
component("YOR375C",700).
component("YDL215C",237).
component("YAL062W",145).
component("U100_",20).
component("YBR035C",164).
component("YMR189W",603).
component("U56_",116).
component("YKR080W",527).
component("YPL023C",705).
component("YGL125W",352).
...
component("YKL150W",504).
component("YIL043C",430).
component("YHR042W",405).
component("YOR221C",685).
component("YMR145C",600).
component("YML120C",585).
component("YKL192C",512).
component("YKL055C",495).
component("YER061C",307).
component("YDL085W",218).
component("YBR046C",166).
component("YMR145C",601).
component("YML120C",586).
component("YKL192C",513).
component("YDL085W",219).
component("YPL017C",704).
component("YFL018C",329).
component("YPL091W",708).
component("YER042W",301).
component("YPR167C",749).
component("YNL052W",619).
component("YMR256C",611).
component("YLR395C",572).
component("YLR038C",535).
component("YIL111W",435).
component("YHR051W",409).
component("YGL191W",358).
component("YGL187C",357).
component("YDL067C",216).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",729).
component("YBR034C",163).
component("YPL273W",731).
component("YLL062C",532).
component("YDR410C",278).
component("YKR069W",526).
component("U47_",109).
component("YER091C",318).
component("YJR073C",480).
component("YDL033C",211).
component("YOL096C",664).
component("YLR172C",549).
component("YMR120C",599).
component("YBL013W",148).
component("YJL130C",457).
component("YJL088W",452).
component("YPR074C",742).
component("YBR117C",174).
component("YLR354C",567).
component("YGR043C",368).
component("YMR108W",597).
component("YCL009C",195).
component("YMR062C",594).
component("YNL071W",620).
component("YIL160C",441).
component("YNR019W",648).
component("YCR048W",207).
component("U48_",110).
component("YNL277W",637).
component("YDR232W",265).
component("YFL017C",328).
component("YPL231W",723).
component("YER061C",308).
component("U86_",137).
component("YPL001W",703).
component("YDL052C",213).
component("U8_",140).
component("YDR148C",261).
component("YOR377W",701).
component("YGR177C",379).
component("YPL231W",724).
component("YLR195C",552).
component("YLR299W",559).
component("YPR001W",733).
component("YNR001C",644).
component("YCR005C",203).
component("YML126C",588).
component("YDL182W",234).
component("YDL131W",226).
component("YNL117W",624).
component("YIR031C",446).
component("YPR160W",748).
component("YOR321W",691).
component("YJR143C",489).
component("YGR199W",384).
component("YDL095W",221).
component("YDL093W",220).
component("YAL023C",144).
component("YPL227C",720).
component("YMR261C",612).
component("YML100W",584).
component("YBR126C",177).
component("YNL192W",631).
component("YBR038W",165).
component("YBR023C",161).
component("YEL011W",291).
component("YLR209C",553).
component("U104_",24).
component("U103_",23).
component("YOR209C",683).
component("YMR300C",614).
component("YDR354W",272).
component("YFR047C",337).
component("YJR133W",487).
component("U22_",89).
component("YLR209C",554).
component("YDR399W",274).
component("YJL167W",465).
component("YNL256W",634).
component("YPR069C",741).
component("YDR127W",256).
component("YHR190W",423).
component("YHR068W",412).
component("YLR303W",560).
component("YML082W",583).
component("YJR130C",486).
component("YDR035W",243).
component("YBR249C",187).
component("YLR180W",551).
component("YDR502C",284).
component("YOL143C",669).
component("YBR256C",189).
component("YHR137W",417).
component("YGL202W",359).
component("YLR027C",533).
component("YKL106W",498).
component("YOL140W",668).
component("YLR438W",576).
component("YKL104C",497).
component("YGR019W",366).
component("YDR111C",253).
component("U64_",120).
component("U51_",113).
component("YJR148W",490).
component("YHR208W",426).
component("YOR184W",681).
component("YNR058W",653).
component("YGL253W",365).
component("YFR053C",338).
component("YMR013C",591).
component("YMR205C",605).
component("YGR240C",388).
component("YLR240W",556).
component("YKL203C",515).
component("YJR066W",479).
component("YCR036W",206).
component("YGR194C",383).
component("YCL040W",200).
component("YJR105W",484).
component("U16_",59).
component("YPL188W",716).
component("YJR049C",476).
component("YEL041W",294).
component("YKL001C",493).
component("YML070W",582).
...
component("YKL166C",506).
component("YJL164C",464).
component("YIL035C",429).
component("YHR205W",425).
component("YHR102W",415).
component("YGL019W",344).
component("YHR025W",404).
component("YNR012W",646).
component("YPR121W",745).
component("YPL258C",726).
component("YOL055C",659).
component("YPL214C",719).
component("U1_",76).
...
component("YER052C",303).
component("U19_",75).
component("U18_",69).
component("U17_",64).
component("U76_",130).
component("YMR220W",608).
component("YER170W",324).
component("YDR226W",264).
component("YKL067W",496).
component("YOL055C",660).
component("YDR454C",281).
component("YOL061W",662).
component("YKL181W",507).
component("YHL011C",396).
...
component("U94_",142).
component("YJR010W",473).
component("YBR029C",162).
component("YGL130W",353).
component("YDR530C",287).
component("YPR190C",752).
component("YPR187W",751).
component("YPR110C",744).
component("YPR010C",735).
component("YOR341W",696).
component("YOR340C",695).
component("YOR224C",686).
component("YOR210W",684).
component("YOR207C",682).
component("YOR151C",678).
component("YOR116C",673).
component("YOL005C",654).
component("YNR003C",645).
component("YNL248C",633).
component("YNL151C",629).
component("YNL113W",623).
component("YKL144C",503).
component("YJR063W",478).
component("YJL148W",461).
component("YJL140W",460).
component("YIL021W",428).
component("YHR143W-A",418).
component("YGL070C",351).
component("YFL036W",331).
component("YDR404C",277).
component("YDR156W",262).
component("YDR045C",246).
component("YDL150W",233).
component("YDL140C",228).
component("YBR154C",181).
component("YPR175W",750).
component("YPL167C",714).
component("YOR330C",693).
component("YOL115W",667).
component("YNL299W",641).
component("YNL262W",636).
component("YNL102W",622).
component("YJR043C",475).
component("YJR006W",471).
component("YJL090C",453).
component("YIL139C",436).
component("YEL055C",297).
component("YDR419W",279).
component("YDR121W",254).
component("YDL102W",223).
component("YCR014C",205).
component("YBR278W",190).
component("YBL035C",150).
component("YKL035W",494).
component("YHL012W",397).
component("YHR123W",416).
component("YNL130C",625).
component("YPL148C",712).
component("YOR251C",689).
component("YGR286C",393).
component("YDR058C",249).
component("YOL011W",656).
component("YMR008C",590).
component("YMR006C",589).
component("U105_",25).
component("U101_",21).
component("YJL068C",450).
component("YPL072W",707).
component("YOR124C",674).
component("YNL186W",630).
component("YMR304W",615).
component("YMR223W",609).
component("YKR098C",529).
...
component("YJR019C",474).
component("U84_",135).
component("YDR481C",282).
component("YLR377C",570).
component("YDR074W",251).
component("YFR025C",336).
component("YPL179W",715).
component("YNR032W",649).
component("YML057W",581).
component("YML016C",577).
component("YLR433C",575).
component("YGR123C",374).
component("YER133W",321).
component("YER089C",316).
component("YDR436W",280).
...
component("YIL053W",431).
component("YER062C",309).
component("YHR046C",408).
component("U9_",143).
component("YGR208W",387).
component("YPL228W",721).
component("YMR180C",602).
...
component("YOL064C",663).
component("YPL268W",730).
component("YOR360C",698).
component("YGL248W",364).
component("YKR031C",522).
component("YGL027C",346).
component("YLR286C",558).
component("YJR153W",491).
component("YJL221C",470).
component("YJL216C",468).
component("YIL172C",445).
component("YGR292W",395).
component("YGR287C",394).
component("YBR299W",194).
component("YBR184W",183).
component("YIL162W",442).
component("YPR026W",736).
component("YDR001C",239).
component("YBR001C",157).
component("YDR400W",275).
component("U102_",22).
component("YER043C",302).
component("YNL045W",618).
component("YLR160C",548).
component("YLR158C",547).
component("YLR157C",546).
component("YLR155C",545).
component("YDR321W",271).
component("YGL037C",347).
component("U43_",106).
component("U42_",105).
component("YLR308W",563).
component("YLR307W",562).
component("U53_",114).
component("YLR420W",573).
component("YPL111W",710).
component("YIR032C",447).
component("YLR028C",534).
component("YHR144C",419).
component("YHR144C",420).
