...
component("YKR009C",716).
component("YMR083W",816).
component("YPL231W",986).
component("U46_",149).
component("YBR149W",254).
component("YBR149W",255).
component("YJR159W",680).
component("YGL001C",480).
component("YHR063C",571).
component("U45_",148).
component("YBR153W",256).
component("YML056C",796).
component("YLR432W",784).
component("YHR216W",594).
component("YAR075W",208).
component("YAR073W",207).
component("YCL030C",280).
component("YDR127W",363).
component("YJR139C",675).
component("YML075C",799).
component("YLR450W",787).
component("YOL126C",910).
component("YKL085W",689).
component("YDL078C",310).
component("YKL029C",684).
component("YOR136W",927).
component("YNL037C",848).
component("YNL009W",846).
component("YLR174W",755).
component("YDL066W",308).
component("YHR183W",588).
component("YGR256W",547).
component("YNL241C",864).
component("YOL059W",902).
component("YDL022W",299).
component("YCL018W",278).
component("YLR355C",778).
component("YIL074C",601).
component("YER081W",447).
component("YML054C",795).
component("YDL174C",333).
component("YIL155C",611).
component("YPR191W",1023).
component("YOR065W",918).
component("YJL166W",646).
component("YHR001W-A",557).
component("YGR183C",531).
component("YFR033C",476).
component("YEL024W",418).
component("YDR529C",409).
component("YBL045C",215).
component("Q0105",19).
component("YKR066C",721).
component("YKL026C",683).
component("YIR037W",622).
...
component("YMR015C",812).
component("YHR007C",558).
component("YDR402C",396).
component("YGL055W",489).
component("YGR175C",528).
component("YJR104C",669).
component("YHR008C",559).
component("YJL026W",625).
component("YIL066C",600).
component("YGR180C",530).
component("YER070W",445).
component("U37_",140).
component("U36_",139).
component("U35_",138).
component("YDR158W",371).
component("YJR009C",656).
component("YJL052W",627).
component("YGR192C",534).
component("YBR006W",225).
component("YPL276W",997).
component("YPL275W",996).
component("YOR388C",960).
component("YOR374W",957).
component("YER073W",446).
component("U68_",172).
component("YGL154C",497).
component("YBR115C",249).
component("U55_",158).
component("YER069W",443).
component("YOR323C",947).
component("U2_",132).
component("YER178W",459).
component("YBR221C",264).
component("YIL125W",607).
component("YBR166C",259).
component("YNL280C",872).
component("YGL012W",483).
component("YKL182W",702).
component("U57_",160).
component("YKL216W",713).
component("YDR044W",349).
component("YER014W",429).
component("YKR009C",717).
component("YIL160C",613).
component("YGL205W",502).
component("YMR118C",821).
component("YLR164W",753).
component("YLL041C",728).
component("YKL148C",697).
component("YKL141W",695).
component("YJL045W",626).
component("YDR178W",373).
component("YJR051W",661).
component("YEL047C",422).
component("YDL171C",332).
component("YOR375C",958).
component("YDL215C",337).
component("YAL062W",205).
component("U99_",199).
component("U100_",22).
component("YBR035C",235).
component("YMR189W",828).
component("U56_",159).
component("YNR050C",887).
component("YKR080W",723).
component("YER023W",430).
component("YPL023C",964).
component("YGL125W",494).
component("YOR236W",940).
...
component("U63_",167).
component("U62_",166).
component("YOR356W",955).
component("YHR068W",572).
component("YKL150W",698).
component("YIL043C",598).
component("YHR042W",566).
component("YOR221C",938).
component("YMR145C",824).
component("YML120C",804).
component("YKL192C",706).
component("YKL055C",686).
component("YER061C",439).
component("YDL085W",312).
component("YBR046C",238).
component("YMR145C",825).
component("YML120C",805).
component("YKL192C",707).
component("YDL085W",313).
component("YFR030W",475).
component("YPL017C",963).
component("YFL018C",464).
component("YPL091W",969).
component("YDR353W",391).
component("YER042W",431).
component("YPR167C",1017).
component("YJR137C",674).
component("YNL052W",850).
component("YMR256C",836).
component("YLR395C",782).
component("YLR038C",735).
component("YIL111W",605).
component("YHR051W",570).
component("YGL191W",500).
component("YGL187C",499).
component("YDL067C",309).
component("Q0275",21).
component("Q0250",20).
component("Q0045",18).
component("YPL266W",993).
component("YML110C",803).
component("YBR034C",234).
component("YPL273W",995).
component("YLL062C",731).
component("YDR410C",399).
component("YKR069W",722).
component("YOL096C",905).
component("U47_",150).
component("YER091C",451).
component("YJR073C",664).
component("YML008C",788).
component("YDL033C",301).
component("YOL096C",906).
component("YLR172C",754).
component("YLR058C",738).
component("YBR263W",270).
component("YDR019C",345).
component("YBR176W",260).
component("YDR408C",398).
component("YMR120C",822).
component("YLR028C",733).
component("YBL013W",209).
component("YJL130C",638).
component("YJL088W",632).
component("YPR074C",1010).
component("YBR117C",250).
component("YLR354C",777).
component("YGR043C",513).
component("YMR108W",819).
component("YCL009C",277).
component("YMR062C",815).
component("YNL071W",851).
component("YIL160C",614).
component("YNR019W",881).
component("YCR048W",294).
component("U48_",151).
component("YNL277W",870).
component("YDR232W",376).
component("YFL017C",463).
component("YPL231W",987).
component("YER061C",440).
component("U86_",190).
component("YPL001W",962).
component("YDL052C",305).
component("U8_",193).
component("YDR148C",369).
component("YML042W",794).
component("YOR377W",959).
component("YGR177C",529).
component("YPL231W",988).
component("YGR147C",524).
component("YDL040C",302).
component("YPL028W",965).
component("YLR195C",757).
component("YLR299W",767).
component("YGL017W",484).
component("YPR001W",999).
component("YNR001C",877).
component("YCR005C",289).
component("YML126C",807).
component("YDL182W",334).
component("YDL131W",322).
component("YNL117W",855).
component("YIR031C",620).
component("YPR160W",1016).
component("YOR321W",946).
component("YJR143C",676).
component("YGR199W",536).
component("YDL095W",317).
component("YDL093W",316).
component("YAL023C",202).
component("YLR258W",764).
component("YFR015C",472).
component("YPL227C",984).
component("YOR103C",922).
component("YOR085W",920).
component("YMR149W",826).
component("YML019W",790).
component("YJL002C",623).
component("YEL002C",414).
component("YDL232W",338).
component("YCL043C",284).
component("YNL029C",847).
component("YIL085C",603).
component("YMR261C",837).
component("YML100W",801).
component("YBR126C",253).
component("YNL192W",862).
component("YBR038W",237).
component("YBR023C",232).
component("YEL011W",415).
component("YMR306W",844).
component("YLR342W",775).
component("YGR032W",511).
component("YPR183W",1020).
component("YLR209C",758).
component("U104_",26).
component("U103_",25).
component("YMR271C",838).
component("YML106W",802).
component("YOR209C",936).
component("YMR300C",842).
component("YER055C",435).
component("YDR354W",392).
component("YFR047C",477).
component("YJR133W",673).
component("U22_",126).
component("YLR209C",759).
component("YML022W",791).
component("YDR441C",402).
component("YDR399W",394).
component("YPR176C",1019).
component("YPL172C",977).
component("YNR041C",885).
component("YMR101C",817).
component("YDL090C",315).
component("YBR003W",224).
component("YBR002C",223).
component("YJL167W",647).
component("YJL167W",648).
component("YNL256W",866).
component("YPR069C",1008).
component("YDR127W",364).
component("YHR190W",589).
component("YLR146C",747).
component("YHR068W",573).
component("YLR303W",768).
component("YGR012W",509).
component("YML082W",800).
component("YJR130C",672).
component("YDR035W",347).
component("YBR249C",267).
component("YLR180W",756).
component("YDR502C",406).
component("YOR274W",943).
component("YOL143C",913).
component("YBR256C",269).
component("YHR137W",582).
component("YGL202W",501).
component("YLR027C",732).
component("YKL106W",691).
component("YOL140W",912).
component("YLR438W",786).
component("YKL104C",690).
component("YGR019W",510).
component("YDR111C",361).
component("U64_",168).
component("U61_",165).
component("U51_",155).
component("YJR148W",677).
component("YHR208W",592).
component("YFL030W",466).
component("YOR184W",933).
component("YNR058W",889).
component("YIL116W",606).
component("YGL253W",507).
component("YFR053C",478).
component("YOL136C",911).
component("YIL107C",604).
component("YMR013C",811).
component("YMR205C",830).
component("YGR240C",542).
component("YOL016C",894).
component("YFR014C",471).
component("YLR240W",762).
component("YKL203C",709).
component("YJR066W",663).
component("YCR036W",293).
component("YGR194C",535).
component("YCL040W",283).
component("YJR105W",670).
component("U16_",79).
component("YPL188W",979).
component("YJR049C",660).
component("YEL041W",419).
component("U96_",198).
component("YKL001C",681).
component("YDR236C",377).
component("YML070W",798).
...
component("U82_",186).
component("U81_",185).
component("YMR208W",831).
component("YPL203W",980).
component("YOR061W",917).
component("YKL166C",700).
component("YJL164C",645).
component("YIL035C",597).
component("YHR205W",591).
component("YHR102W",580).
component("YGL019W",485).
component("YHR025W",565).
component("YOR347C",953).
component("YAL038W",203).
component("YNR012W",879).
component("YPR121W",1013).
component("YPL258C",990).
component("YOL055C",898).
component("YPL214C",983).
component("U1_",106).
component("YDR009W",344).
component("YBR020W",231).
component("YFR019W",473).
component("YDR208W",374).
component("YDR127W",365).
component("U21_",118).
component("U20_",113).
component("YDR147W",368).
component("YDR300C",385).
component("YCR012W",290).
component("YER052C",433).
component("YER069W",444).
component("U19_",105).
component("U18_",96).
component("U17_",87).
component("U76_",181).
component("YMR220W",833).
component("YER170W",458).
component("YDR226W",375).
component("YKL067W",688).
component("YOL055C",899).
component("YDR454C",403).
component("YOL061W",903).
component("YKL181W",701).
component("YHL011C",552).
component("YER099C",453).
component("YBL068W",218).
component("YOR143C",928).
component("YNL256W",867).
component("YLR328W",773).
component("YBR018C",227).
component("YBR018C",228).
component("YDL055C",306).
component("YGR007W",508).
component("YGR202C",537).
component("YLR328W",774).
component("YKR002W",715).
component("YDL045C",303).
component("YDL103C",320).
component("U94_",197).
component("YJR010W",657).
component("YBR029C",233).
component("YCL050C",285).
component("YGL130W",495).
component("YDR530C",410).
component("YCL050C",286).
component("YPR190C",1022).
component("YPR187W",1021).
component("YPR110C",1012).
component("YPR010C",1001).
component("YOR341W",952).
component("YOR340C",951).
component("YOR224C",939).
component("YOR210W",937).
component("YOR207C",935).
component("YOR151C",929).
component("YOR116C",923).
component("YOL005C",891).
component("YNR003C",878).
component("YNL248C",865).
component("YNL151C",860).
component("YNL113W",854).
component("YKL144C",696).
component("YJR063W",662).
component("YJL148W",642).
component("YJL140W",641).
component("YIL021W",596).
component("YHR143W-A",583).
component("YGL070C",493).
component("YFL036W",467).
component("YDR404C",397).
component("YDR156W",370).
component("YDR045C",350).
component("YDL150W",330).
component("YDL140C",324).
component("YBR154C",258).
component("YPR175W",1018).
component("YPL167C",976).
component("YOR330C",948).
component("YOL115W",909).
component("YNL299W",874).
component("YNL262W",868).
component("YNL102W",853).
component("YJR043C",659).
component("YJR006W",655).
component("YJL090C",633).
component("YIL139C",609).
component("YEL055C",423).
component("YDR419W",400).
component("YDR121W",362).
component("YDL102W",319).
component("YCR014C",291).
component("YBR278W",271).
component("YBL035C",212).
component("YKL035W",685).
component("YHL012W",553).
component("YHR123W",581).
component("YBR243C",265).
component("YNL130C",856).
component("YDL142C",329).
component("YPL148C",974).
component("YOR251C",942).
component("YGR286C",549).
component("YJL068C",628).
component("YDR058C",355).
component("YNR034W",884).
component("YHR163W",586).
component("YGR248W",544).
component("YCR073W-A",296).
component("YDL086W",314).
component("YOL011W",893).
component("YMR008C",809).
component("YMR006C",808).
component("U105_",27).
component("U101_",23).
component("YJL068C",629).
component("YPL072W",968).
component("YOR124C",924).
component("YNL186W",861).
component("YMR304W",843).
component("YMR223W",834).
component("YKR098C",726).
component("YJL197W",649).
component("YIL156W",612).
component("YFR010W",470).
component("YER151C",457).
component("YER144C",456).
component("YER098W",452).
component("YDR069C",357).
component("YDL122W",321).
component("YBR058C",239).
component("YBL067C",217).
component("YJR019C",658).
component("YDR272W",380).
component("U84_",188).
component("YDR481C",404).
component("YLR377C",780).
component("YDR074W",358).
component("YFR025C",474).
component("YPL179W",978).
component("YNR032W",882).
component("YML057W",797).
component("YML016C",789).
component("YLR433C",785).
component("YGR123C",520).
component("YER133W",455).
component("YER089C",449).
component("YDR436W",401).
component("YDR075W",359).
...
component("YHR215W",593).
component("YDL024C",300).
component("YBR093C",247).
component("YBR092C",246).
component("YIL053W",599).
component("YER062C",441).
component("YHR046C",569).
component("U9_",200).
component("YGR208W",541).
component("YPL228W",985).
component("YMR180C",827).
...
component("U26_",128).
component("U24_",127).
component("YHR044C",568).
component("YHR043C",567).
component("YOL064C",904).
component("YPL268W",994).
component("YOR360C",956).
component("YGL248W",506).
component("YKR031C",718).
component("YPL206C",981).
component("YGL027C",487).
component("YLR286C",766).
component("YJR153W",678).
component("YJL221C",654).
component("YJL216C",652).
component("YIL172C",618).
component("YGR292W",551).
component("YGR287C",550).
component("YBR299W",276).
component("YBR184W",261).
component("YIL162W",615).
component("YPR026W",1002).
component("YDR001C",342).
component("YBR001C",222).
component("YDR400W",395).
component("YML035C",792).
component("YJL070C",630).
component("YBR284W",272).
component("U102_",24).
component("YER043C",432).
component("YNL045W",849).
component("YLR160C",752).
component("YLR158C",751).
component("YLR157C",750).
component("YLR155C",749).
component("YDR321W",386).
component("YGL037C",488).
component("U43_",146).
component("U42_",145).
component("YMR293C",841).
component("YDR242W",378).
component("YLR308W",772).
component("YLR307W",771).
component("YMR281W",840).
component("U53_",156).
component("YLR420W",783).
component("YPL111W",972).
component("YIR032C",621).
component("YIR029W",619).
component("YPR062W",1007).
component("YMR120C",823).
component("YLR028C",734).
component("YHR144C",584).
component("YHR144C",585).
...
component("YLR245C",763).
component("YML035C",793).
...
component("YHR201C",590).
component("YBR111C",248).
component("YBR252W",268).
component("YCL030C",282).
component("YEL042W",420).
component("YER005W",428).
component("YBL099W",221).
component("U60_",164).
component("YLR231C",760).
component("U88_",191).
component("YDR538W",413).
component("YLR134W",744).
component("YLR044C",736).
component("YGR087C",517).
component("YDR380W",393).
component("YDL080C",311).
component("YMR250W",835).
component("YKL184W",705).
component("YOR128C",925).
component("YEL021W",417).
component("YNR043W",886).
component("U93_",196).
component("YDR047W",352).
component("U54_",157).
component("YKL211C",711).
component("YKR097W",725).
component("YOL052C",897).
component("YGR170W",526).
component("YKL060C",687).
component("YDR294C",382).
component("YEL046C",421).
component("YNR033W",883).
component("YPR006C",1000).
component("YER065C",442).
component("YKL211C",712).
component("YER090W",450).
component("YDR127W",366).
component("YPL281C",998).
component("YOR393W",961).
component("YMR323W",845).
component("YHR174W",587).
component("YGR254W",545).
component("YPL262W",991).
component("YGL026C",486).
component("YGR155W",525).
component("YLR304C",769).
component("YJL200C",650).
component("YGL009C",482).
component("YNL316C",875).
component("YKL182W",703).
component("YPL212C",982).
component("YNL292W",873).
component("YGL063W",492).
component("YFL001W",461).
component("YOR278W",944).
component("U49_",152).
component("YCR053W",295).
component("YDR127W",367).
component("YGL148W",496).
component("YIL168W",617).
component("YIL167W",616).
component("YCL064C",287).
component("YCL064C",288).
component("YHR018C",561).
component("YLR359W",779).
component("YAL012W",201).
component("YFR055W",479).
component("YJL005W",624).
component("YOR176W",932).
component("YJL121C",635).
component("YBR019C",229).
component("YBR019C",230).
component("U59_",162).
component("YDR050C",353).
component("YIL020C",595).
component("YDR007W",343).
component("YOR095C",921).
component("YER003C",427).
component("YBR196C",262).
component("YGL001C",481).
component("YPL117C",973).
component("U14_",64).
component("YOL056W",900).
component("YKL152C",699).
component("YDL021W",298).
component("YMR105C",818).
component("YKL127W",693).
component("YEL058W",424).
component("YPR060C",1006).
component("YHR072W",574).
component("YJL153C",643).
component("YPL097W",970).
component("YGR185C",532).
component("YGR264C",548).
component("YGR171C",527).
component("YHR011W",560).
component("YDR023W",346).
component("YPL104W",971).
component("YLL018C",727).
component("YPR081C",1011).
component("YBR121C",251).
component("YHR020W",564).
component("YER087W",448).
component("YOL033W",896).
component("YGL245W",505).
component("YOR168W",930).
component("YHR091C",576).
component("YDR341C",387).
component("YOL097C",907).
component("YDR268W",379).
component("YPR047W",1005).
component("YLR060W",739).
component("YFL022C",465).
component("YPR033C",1003).
component("YHR019C",562).
component("YHR019C",563).
component("YKL194C",708).
component("YIL078W",602).
component("YPL160W",975).
component("YLR382C",781).
component("YPL040C",966).
component("YBL076C",219).
component("YNL073W",852).
component("YDR037W",348).
component("YOR335C",949).
component("YGR094W",518).
component("YLR153C",748).
component("YAL054C",204).
component("YGR244C",543).
component("YPR035W",1004).
component("YIL145C",610).
component("U89_",192).
component("YOR241W",941).
component("YMR113W",820).
component("YKL132C",694).
component("YOR339C",950).
component("YMR022W",813).
component("YLR306W",770).
component("YKL210W",710).
component("YGR133W",523).
component("YGL058W",490).
component("YER100W",454).
component("YEL012W",416).
component("YDR177W",372).
component("YDR092W",360).
component("YDR059C",356).
component("YDR054C",354).
component("YDL064W",307).
component("YBR082C",242).
component("YJL101C",634).
component("U92_",195).
component("YAR015W",206).
...
component("YGR204W",540).
component("YNL220W",863).
component("YOL058W",901).
component("YDL141W",328).
component("YHR074W",575).
component("YMR217W",832).
component("YPR145W",1015).
component("YGR124W",521).
component("YOR303W",945).
component("YJR109C",671).
component("YJL130C",639).
component("YGL062W",491).
component("YBR218C",263).
component("YPL231W",989).
component("YNR016C",880).
component("YKL182W",704).
component("YGR037C",512).
component("YOR005C",915).
component("YDL164C",331).
component("YJL087C",631).
component("YOL010W",892).
component("YPR138C",1014).
component("YPL265W",992).
component("YPL057C",967).
component("YOR348C",954).
component("YOR192C",934).
component("YOR171C",931).
component("YOR130C",926).
component("YOR071C",919).
component("YOR011W",916).
component("YOL156W",914).
component("YOL103W",908).
component("YOL020W",895).
component("YNR072W",890).
component("YNL318C",876).
component("YNL270C",869).
component("YNL142W",859).
component("YMR272C",839).
component("YMR202W",829).
component("YMR056C",814).
component("YMR011W",810).
component("YML123C",806).
component("YLR348C",776).
component("YLR260W",765).
component("YLR237W",761).
component("YLR138W",745).
component("YLR100C",742).
component("YLR092W",741).
component("YLR081W",740).
component("YLL061W",730).
component("YLL043W",729).
component("YKR093W",724).
component("YKR053C",720).
component("YKR039W",719).
component("YKL217W",714).
component("YKL120W",692).
component("YKL004W",682).
component("YJR158W",679).
...
component("YGR191W",533).
component("YGR125W",522).
component("YGR121C",519).
component("YGR065C",516).
component("YGR055W",514).
component("YGL186C",498).
component("YFL055W",469).
component("YFL011W",462).
component("YER060W-A",438).
component("YER060W",437).
component("YER056C",436).
component("YER053C",434).
component("YEL069C",426).
component("YEL063C",425).
component("YDR536W",412).
component("YDR508C",408).
component("YDR503C",407).
component("YDR497C",405).
component("YDR345C",390).
component("YDR343C",389).
component("YDR342C",388).
component("YDR297W",384).
component("YDR294C",383).
component("YDR284C",381).
component("YDR046C",351).
component("YDL245C",341).
component("YDL210W",336).
component("YCR028C",292).
component("YCL025C",279).
component("YBR298C",275).
component("YBR294W",274).
component("YBR291C",273).
component("YBR085W",245).
component("YBR069C",241).
component("YBR068C",240).
