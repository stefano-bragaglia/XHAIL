...
component("YNL280C",809).
component("YLR056W",689).
component("YGR060W",477).
component("YKR009C",668).
component("YMR083W",761).
component("YPL231W",917).
component("U46_",137).
component("YBR149W",233).
component("YBR149W",234).
component("YJR159W",633).
component("YGL001C",444).
component("YHR063C",529).
component("YBR153W",235).
component("YML056C",743).
component("YLR432W",733).
component("YHR216W",552).
component("YAR075W",190).
component("YAR073W",189).
component("YCL030C",257).
component("YDR127W",334).
component("YJR139C",628).
component("YML075C",746).
component("YLR450W",736).
component("YKL085W",642).
component("YKL029C",637).
component("YOR136W",862).
component("YNL009W",786).
component("YLR174W",706).
component("YDL066W",284).
component("YHR183W",546).
component("YGR256W",506).
component("YNL241C",802).
component("YOL059W",840).
component("YDL022W",276).
component("YCL018W",255).
component("YLR355C",727).
component("YIL074C",558).
component("YER081W",412).
component("YML054C",742).
component("YIL155C",566).
component("YPR191W",953).
component("YOR065W",854).
component("YJL166W",600).
component("YHR001W-A",515).
component("YGR183C",491).
component("YFR033C",440).
component("YEL024W",386).
component("YDR529C",378).
component("YBL045C",195).
component("Q0105",19).
component("YKR066C",673).
component("YKL026C",636).
component("YIR037W",577).
component("YBR244W",244).
component("YJR078W",620).
component("U58_",149).
component("U107_",28).
component("YGR255C",505).
component("U108_",29).
component("YBL098W",200).
component("YMR015C",758).
component("YHR007C",516).
component("YDR402C",365).
component("YGL055W",453).
component("YJR104C",622).
component("YHR008C",517).
component("YJL026W",580).
component("YIL066C",557).
component("YGR180C",490).
component("YER070W",410).
component("U37_",129).
component("U36_",128).
component("U35_",127).
component("YDR158W",342).
component("YJR009C",610).
component("YJL052W",582).
component("YGR192C",493).
component("YBR006W",205).
component("YPL276W",928).
component("YPL275W",927).
component("YOR388C",892).
component("YOR374W",889).
...
component("YKL150W",651).
component("YIL043C",555).
component("YHR042W",524).
component("YOR221C",873).
component("YMR145C",768).
component("YML120C",750).
component("YKL192C",659).
component("YKL055C",639).
component("YER061C",405).
component("YDL085W",287).
component("YBR046C",218).
component("YMR145C",769).
component("YML120C",751).
component("YKL192C",660).
component("YDL085W",288).
component("YFR030W",439).
component("YPL017C",895).
component("YFL018C",428).
component("YPL091W",901).
component("YDR353W",360).
component("YER042W",398).
component("YPR167C",947).
component("YJR137C",627).
component("YNL052W",789).
component("YMR256C",780).
component("YLR395C",731).
...
component("YBR034C",214).
component("YPL273W",926).
component("YLL062C",683).
component("YDR410C",368).
component("YKR069W",674).
component("YOL096C",843).
component("U47_",138).
component("YER091C",416).
component("YJR073C",618).
component("YML008C",737).
component("YDL033C",278).
component("YOL096C",844).
component("YLR172C",705).
component("YBR263W",248).
component("YDR019C",319).
component("YDR408C",367).
component("YMR120C",767).
component("YLR028C",685).
component("YBL013W",191).
component("YJL130C",592).
component("YJL088W",586).
component("YPR074C",940).
component("YBR117C",229).
component("YLR354C",726).
component("YGR043C",475).
component("YMR108W",764).
component("YCL009C",254).
component("YMR062C",760).
component("YNL071W",790).
component("YIL160C",569).
component("YNR019W",819).
component("YCR048W",271).
component("U48_",139).
component("YNL277W",808).
component("YDR232W",346).
component("YFL017C",427).
component("YPL231W",918).
component("YER061C",406).
component("U86_",175).
component("YPL001W",894).
component("YDL052C",282).
component("U8_",178).
component("YDR148C",340).
component("YOR377W",891).
component("YGR177C",489).
component("YPL231W",919).
component("YGR147C",485).
component("YDL040C",279).
component("YPL028W",897).
component("YLR195C",708).
component("YLR299W",718).
component("YGL017W",448).
component("YPR001W",930).
component("YNR001C",815).
component("YCR005C",266).
component("YML126C",753).
component("YDL182W",308).
component("YDL131W",297).
component("YNL117W",794).
component("YIR031C",575).
component("YPR160W",946).
component("YOR321W",881).
component("YJR143C",629).
component("YGR199W",495).
component("YDL095W",292).
component("YDL093W",291).
component("YAL023C",185).
component("YLR258W",715).
component("YFR015C",436).
component("YPL227C",915).
component("YOR103C",858).
component("YOR085W",856).
component("YMR149W",770).
component("YML019W",739).
component("YJL002C",578).
component("YEL002C",383).
component("YDL232W",312).
component("YCL043C",261).
component("YNL029C",787).
component("YIL085C",560).
component("YMR261C",781).
component("YML100W",748).
component("YBR126C",232).
component("YNL192W",801).
component("YBR038W",217).
component("YBR023C",212).
component("YEL011W",384).
component("YPR183W",950).
component("YLR209C",709).
component("U104_",26).
component("U103_",25).
component("YOR209C",871).
component("YMR300C",783).
component("YDR354W",361).
component("YFR047C",441).
component("YJR133W",626).
component("U22_",116).
component("YLR209C",710).
component("YML022W",740).
component("YDR441C",371).
component("YDR399W",363).
component("YPR176C",949).
component("YPL172C",908).
component("YNR041C",823).
component("YMR101C",762).
component("YDL090C",290).
component("YBR003W",204).
component("YBR002C",203).
component("YJL167W",601).
component("YJL167W",602).
component("YNL256W",804).
component("YPR069C",938).
component("YDR127W",335).
component("YHR190W",547).
component("YLR146C",698).
component("YHR068W",531).
component("YLR303W",719).
component("YGR012W",472).
component("YML082W",747).
component("YJR130C",625).
component("YDR035W",321).
component("YBR249C",245).
component("YLR180W",707).
component("YDR502C",375).
component("YOR274W",878).
component("YOL143C",849).
component("YBR256C",247).
component("YHR137W",540).
component("YGL202W",464).
component("YLR027C",684).
component("YKL106W",644).
component("YOL140W",848).
component("YLR438W",735).
component("YKL104C",643).
component("YGR019W",473).
component("YDR111C",332).
component("U64_",154).
component("U51_",143).
component("YJR148W",630).
component("YHR208W",550).
component("YFL030W",430).
component("YOR184W",868).
component("YNR058W",827).
component("YIL116W",562).
component("YGL253W",470).
component("YFR053C",442).
component("YMR013C",757).
component("YMR205C",774).
component("YGR240C",501).
component("YOL016C",832).
component("YFR014C",435).
component("YLR240W",713).
component("YKL203C",662).
component("YJR066W",617).
component("YCR036W",270).
component("YGR194C",494).
component("YCL040W",260).
component("YJR105W",623).
component("U16_",76).
component("YPL188W",910).
component("YJR049C",614).
component("YEL041W",387).
component("U96_",182).
component("YKL001C",634).
component("YDR236C",347).
component("YML070W",745).
component("YFL053W",432).
component("YHL032C",513).
...
component("YPL203W",911).
component("YOR061W",853).
component("YKL166C",653).
component("YJL164C",599).
component("YIL035C",554).
component("YHR205W",549).
component("YHR102W",538).
component("YGL019W",449).
component("YHR025W",523).
component("YNR012W",817).
component("YPR121W",943).
component("YPL258C",921).
component("YOL055C",836).
component("YPL214C",914).
component("U1_",97).
component("YDR009W",318).
component("YBR020W",211).
component("YFR019W",437).
component("YDR208W",344).
...
component("YOL055C",837).
component("YDR454C",372).
component("YOL061W",841).
component("YKL181W",654).
component("YHL011C",511).
component("YER099C",418).
component("YBL068W",198).
component("YOR143C",863).
component("YNL256W",805).
component("YLR328W",723).
component("YBR018C",207).
component("YBR018C",208).
component("YDL055C",283).
component("YGR007W",471).
component("YGR202C",496).
component("YLR328W",724).
component("YKR002W",667).
component("YDL045C",280).
component("YDL103C",295).
component("U94_",181).
component("YJR010W",611).
component("YBR029C",213).
component("YCL050C",262).
component("YGL130W",458).
component("YDR530C",379).
component("YCL050C",263).
component("YPR190C",952).
component("YPR187W",951).
component("YPR110C",942).
component("YPR010C",932).
component("YOR341W",886).
component("YOR340C",885).
component("YOR224C",874).
component("YOR210W",872).
component("YOR207C",870).
component("YOR151C",864).
component("YOR116C",859).
component("YOL005C",829).
component("YNR003C",816).
component("YNL248C",803).
component("YNL151C",799).
component("YNL113W",793).
component("YKL144C",649).
component("YJR063W",616).
component("YJL148W",596).
component("YJL140W",595).
component("YIL021W",553).
component("YHR143W-A",541).
component("YGL070C",456).
component("YFL036W",431).
...
component("YPR175W",948).
component("YPL167C",907).
component("YOR330C",883).
component("YOL115W",847).
component("YNL299W",812).
component("YNL262W",806).
component("YNL102W",792).
component("YJR043C",613).
component("YJR006W",609).
component("YJL090C",587).
component("YIL139C",564).
component("YEL055C",390).
component("YDR419W",369).
component("YDR121W",333).
component("YDL102W",294).
component("YCR014C",268).
component("YBR278W",249).
component("YBL035C",193).
component("YKL035W",638).
component("YHL012W",512).
component("YHR123W",539).
component("YBR243C",243).
component("YNL130C",795).
component("YDL142C",304).
component("YPL148C",905).
component("YOR251C",877).
component("YGR286C",508).
component("YJL068C",583).
component("YDR058C",328).
component("YNR034W",822).
component("YHR163W",544).
component("YGR248W",503).
component("YCR073W-A",273).
component("YDL086W",289).
component("YOL011W",831).
component("YMR008C",755).
component("YMR006C",754).
component("U105_",27).
component("U101_",23).
component("YJL068C",584).
component("YPL072W",900).
component("YOR124C",860).
component("YNL186W",800).
component("YMR304W",784).
component("YMR223W",778).
component("YKR098C",678).
component("YJL197W",603).
component("YIL156W",567).
component("YFR010W",434).
component("YER151C",421).
component("YER144C",420).
component("YER098W",417).
component("YDR069C",329).
component("YDL122W",296).
component("YBR058C",219).
component("YBL067C",197).
component("YJR019C",612).
component("YDR272W",350).
component("U84_",173).
component("YDR481C",373).
component("YLR377C",729).
component("YDR074W",330).
component("YFR025C",438).
component("YPL179W",909).
component("YNR032W",820).
component("YML057W",744).
component("YML016C",738).
component("YLR433C",734).
component("YGR123C",482).
component("YER133W",419).
component("YER089C",414).
...
component("YOL064C",842).
component("YPL268W",925).
component("YOR360C",888).
component("YGL248W",469).
component("YKR031C",670).
component("YPL206C",912).
component("YGL027C",451).
component("YLR286C",717).
component("YJR153W",631).
component("YJL221C",608).
component("YJL216C",606).
component("YIL172C",573).
component("YGR292W",510).
component("YGR287C",509).
component("YBR299W",253).
component("YBR184W",239).
component("YIL162W",570).
component("YPR026W",933).
component("YDR001C",316).
component("YBR001C",202).
component("YDR400W",364).
component("U102_",24).
component("YER043C",399).
component("YNL045W",788).
component("YLR160C",703).
component("YLR158C",702).
component("YLR157C",701).
component("YLR155C",700).
component("YDR321W",355).
component("YGL037C",452).
component("U43_",135).
component("U42_",134).
...
component("U53_",144).
component("YLR420W",732).
component("YPL111W",903).
component("YIR032C",576).
component("YIR029W",574).
component("YLR028C",686).
component("YHR144C",542).
component("YHR144C",543).
component("YCL030C",258).
component("YNL141W",796).
component("YBR153W",236).
component("YDL238C",314).
component("YNL141W",797).
component("YLR245C",714).
component("YML035C",741).
component("YGR204W",498).
component("YBR084W",223).
component("YJL126W",590).
component("U44_",136).
component("YDL100C",293).
component("U40_",132).
component("U39_",130).
component("YBR011C",206).
component("YHR201C",548).
component("YBR111C",227).
component("YBR252W",246).
component("YCL030C",259).
component("YER005W",395).
component("YBL099W",201).
component("U60_",152).
component("YLR231C",711).
component("U88_",176).
component("YDR538W",382).
component("YLR134W",695).
component("YLR044C",688).
component("YGR087C",479).
component("YDR380W",362).
component("YDL080C",286).
component("YMR250W",779).
component("YKL184W",658).
component("YEL021W",385).
component("YNR043W",824).
component("U93_",180).
component("YDR047W",326).
component("U54_",145).
component("YKL211C",663).
component("YKR097W",677).
component("YOL052C",835).
component("YGR170W",487).
component("YKL060C",640).
component("YDR294C",351).
component("YEL046C",388).
component("YNR033W",821).
component("YPR006C",931).
component("YER065C",408).
component("YKL211C",664).
component("YER090W",415).
component("YDR127W",337).
component("YPL281C",929).
component("YOR393W",893).
component("YMR323W",785).
component("YHR174W",545).
component("YGR254W",504).
component("YPL262W",922).
component("YGL026C",450).
component("YGR155W",486).
component("YLR304C",720).
component("YJL200C",604).
component("YGL009C",446).
component("YNL316C",813).
component("YKL182W",656).
component("YPL212C",913).
component("YNL292W",811).
component("YGL063W",455).
component("YFL001W",425).
component("YOR278W",879).
component("U49_",140).
...
component("YHR018C",519).
component("YLR359W",728).
component("YFR055W",443).
component("YJL005W",579).
component("YOR176W",867).
component("YJL121C",589).
component("YBR019C",209).
component("YBR019C",210).
component("U59_",150).
component("YDR050C",327).
component("YDR007W",317).
component("YOR095C",857).
component("YER003C",394).
component("YBR196C",240).
component("YGL001C",445).
component("YPL117C",904).
component("U14_",61).
component("YOL056W",838).
component("YKL152C",652).
component("YDL021W",275).
component("YMR105C",763).
component("YKL127W",646).
component("YEL058W",391).
component("YPR060C",937).
component("YHR072W",532).
component("YJL153C",597).
component("YGR264C",507).
component("YGR171C",488).
component("YHR011W",518).
component("YDR023W",320).
component("YPL104W",902).
component("YLL018C",679).
component("YPR081C",941).
component("YBR121C",230).
component("YHR020W",522).
component("YER087W",413).
component("YOL033W",834).
component("YGL245W",468).
component("YOR168W",865).
component("YHR091C",534).
component("YDR341C",356).
component("YOL097C",845).
component("YDR268W",349).
component("YPR047W",936).
component("YLR060W",690).
component("YFL022C",429).
component("YPR033C",934).
component("YHR019C",520).
component("YHR019C",521).
component("YKL194C",661).
component("YIL078W",559).
component("YPL160W",906).
component("YLR382C",730).
component("YPL040C",898).
component("YBL076C",199).
component("YNL073W",791).
component("YDR037W",322).
component("YOR335C",884).
component("YGR094W",480).
component("YLR153C",699).
component("YAL054C",186).
component("YGR244C",502).
component("YPR035W",935).
component("YIL145C",565).
component("U89_",177).
component("YOR241W",876).
component("YMR113W",765).
component("YKL132C",647).
component("YJL101C",588).
component("YAR015W",188).
component("YGL234W",466).
component("YER183C",424).
component("U90_",179).
component("YNR057C",826).
component("YDL141W",300).
component("YDL141W",301).
component("YGL234W",467).
component("YDL141W",302).
component("YGR204W",499).
component("YOL058W",839).
component("YDL141W",303).
component("YHR074W",533).
component("YMR217W",776).
component("YPR145W",945).
component("YGR124W",483).
component("YOR303W",880).
component("YJR109C",624).
component("YJL130C",593).
component("YGL062W",454).
component("YBR218C",241).
component("YPL231W",920).
component("YNR016C",818).
component("YKL182W",657).
component("YGR037C",474).
component("YOR005C",851).
component("YDL164C",306).
component("YJL087C",585).
component("YOL010W",830).
component("YPR138C",944).
component("YPL265W",923).
component("YPL057C",899).
component("YOR348C",887).
component("YOR192C",869).
component("YOR171C",866).
component("YOR130C",861).
component("YOR071C",855).
component("YOR011W",852).
component("YOL156W",850).
component("YOL103W",846).
component("YOL020W",833).
component("YNR072W",828).
component("YNL318C",814).
component("YNL270C",807).
component("YNL142W",798).
component("YMR272C",782).
component("YMR202W",773).
component("YMR056C",759).
component("YMR011W",756).
component("YML123C",752).
component("YLR348C",725).
component("YLR260W",716).
component("YLR237W",712).
component("YLR138W",696).
component("YLR100C",693).
component("YLR092W",692).
component("YLR081W",691).
component("YLL061W",682).
component("YLL043W",681).
component("YKR093W",676).
component("YKR053C",672).
component("YKR039W",671).
component("YKL217W",666).
component("YKL120W",645).
component("YKL004W",635).
component("YJR158W",632).
component("YJR095W",621).
component("YJR077C",619).
component("YJL219W",607).
component("YJL214W",605).
component("YJL134W",594).
component("YJL129C",591).
component("YHR096C",537).
component("YHR094C",536).
component("YHR092C",535).
component("YHL036W",514).
component("YGR191W",492).
component("YGR125W",484).
component("YGR121C",481).
component("YGR065C",478).
component("YGR055W",476).
component("YGL186C",461).
component("YFL055W",433).
component("YFL011W",426).
component("YER060W-A",404).
component("YER060W",403).
component("YER056C",402).
component("YER053C",401).
component("YEL069C",393).
component("YEL063C",392).
...
component("YDR046C",325).
component("YDL245C",315).
component("YDL210W",310).
component("YCR028C",269).
component("YCL025C",256).
component("YBR298C",252).
component("YBR294W",251).
component("YBR291C",250).
component("YBR085W",224).
component("YBR069C",221).
component("YBR068C",220).
component("YBR036C",216).
component("YBL042C",194).
component("YBL030C",192).
component("U85_",174).
component("U7_",169).
component("U79_",168).
component("U78_",167).
