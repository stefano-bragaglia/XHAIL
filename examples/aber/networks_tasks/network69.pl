...
component("YLR056W",370).
component("YMR083W",413).
component("YPL231W",505).
component("YJR159W",344).
component("YGL001C",238).
component("YML056C",400).
component("YLR432W",396).
component("YHR216W",299).
component("YAR075W",97).
component("YAR073W",96).
component("YDR127W",181).
component("YJR139C",341).
component("YOR136W",474).
component("YNL009W",428).
component("YLR174W",382).
component("YHR183W",295).
component("YGR256W",275).
component("YOL059W",463).
component("YDL022W",145).
component("YCL018W",133).
component("YLR355C",392).
component("YJR078W",337).
component("U58_",79).
component("YGR255C",274).
component("YMR015C",410).
component("YDR402C",196).
component("YGL055W",244).
component("YJL026W",311).
component("YGR180C",267).
component("U35_",69).
component("YJR009C",329).
component("YJL052W",312).
component("YGR192C",269).
component("YOR374W",490).
component("YER073W",217).
component("U68_",83).
component("U55_",77).
component("YER069W",216).
component("YOR323C",484).
component("U2_",64).
component("YBR166C",124).
component("YNL280C",445).
component("YKL141W",350).
component("YJR051W",333).
component("YOR375C",491).
component("YDL215C",167).
component("YAL062W",95).
component("U100_",20).
component("YBR035C",109).
component("YMR189W",417).
component("U56_",78).
component("YPL023C",494).
component("YGL125W",247).
component("YOR236W",482).
component("YBR084W",115).
component("YLR142W",376).
component("U65_",82).
component("U62_",81).
component("YHR068W",286).
component("YMR145C",416).
component("YML120C",404).
component("YKL192C",356).
component("YDL085W",150).
component("YBR046C",111).
component("YPL091W",497).
component("YNL052W",429).
component("YMR256C",423).
component("YLR395C",394).
component("YLR038C",368).
component("YIL111W",303).
component("YHR051W",285).
component("YGL191W",251).
component("YGL187C",250).
component("YDL067C",148).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",511).
component("YLL062C",365).
component("YDR410C",198).
component("YER091C",220).
component("YJR073C",335).
component("YOL096C",465).
component("YLR172C",381).
component("YMR120C",415).
component("YBL013W",98).
component("YJL130C",319).
component("YJL088W",315).
component("YPR074C",519).
component("YBR117C",119).
component("YCL009C",132).
component("YMR062C",412).
component("YNL071W",430).
component("YIL160C",306).
component("YNR019W",452).
component("YCR048W",142).
component("U48_",73).
component("YFL017C",228).
component("YPL231W",506).
component("YDL052C",147).
component("U8_",90).
component("YOR377W",492).
component("YGR177C",266).
component("YPL231W",507).
component("YLR299W",386).
component("YPR001W",513).
component("YNR001C",448).
component("YCR005C",139).
component("YML126C",406).
component("YDL182W",164).
component("YDL131W",156).
component("YNL117W",433).
component("YIR031C",309).
component("YOR321W",483).
component("YJR143C",342).
component("YGR199W",271).
component("YDL095W",152).
component("YDL093W",151).
component("YAL023C",94).
component("YPL227C",504).
component("YMR261C",424).
component("YML100W",403).
component("YBR126C",121).
component("YNL192W",440).
component("YBR038W",110).
component("YBR023C",107).
component("YLR209C",383).
component("YDR354W",193).
component("YFR047C",235).
component("YJR133W",340).
component("U22_",59).
component("YDR399W",195).
component("YJL167W",326).
component("YPR069C",518).
component("YDR127W",182).
component("YHR068W",287).
component("YLR303W",387).
component("YML082W",402).
component("YJR130C",339).
component("YDR035W",171).
component("YBR249C",127).
component("YBR256C",128).
component("YHR137W",290).
component("YGL202W",252).
component("YLR027C",366).
component("YKL106W",348).
component("YOL140W",468).
component("YLR438W",398).
component("YKL104C",347).
component("YDR111C",179).
component("U51_",75).
component("YJR148W",343).
component("YHR208W",298).
component("YOR184W",478).
component("YGL253W",256).
component("YFR053C",236).
component("YMR013C",409).
component("YCR036W",141).
component("YGR194C",270).
component("YCL040W",136).
component("YJR105W",338).
component("U81_",88).
component("YMR208W",419).
component("YPL203W",503).
component("YOR061W",469).
component("YKL166C",352).
component("YJL164C",325).
component("YIL035C",301).
component("YHR205W",297).
component("YHR102W",289).
component("YGL019W",240).
component("YHR025W",281).
component("YNR012W",450).
component("YPR121W",521).
component("YPL258C",509).
component("YOL055C",461).
component("YFR019W",233).
component("YDR208W",188).
component("YDR127W",183).
component("U21_",56).
component("YDR147W",186).
component("YER052C",212).
component("U19_",49).
component("U18_",45).
component("U17_",42).
component("U76_",86).
component("YMR220W",420).
...
component("YKL181W",353).
component("YHL011C",277).
component("YER099C",222).
component("YBL068W",104).
component("YOR143C",475).
component("YNL256W",442).
component("YLR328W",390).
component("YDL103C",154).
component("U94_",92).
component("YJR010W",330).
component("YBR029C",108).
component("YPR190C",526).
component("YPR187W",525).
component("YPR110C",520).
component("YPR010C",514).
component("YOR341W",487).
component("YOR340C",486).
component("YOR224C",481).
component("YOR210W",480).
component("YOR207C",479).
component("YOR151C",476).
component("YOR116C",471).
component("YOL005C",457).
component("YNR003C",449).
component("YNL248C",441).
component("YNL151C",438).
component("YNL113W",432).
component("YKL144C",351).
component("YJR063W",334).
component("YJL148W",322).
component("YJL140W",321).
component("YIL021W",300).
component("YHR143W-A",291).
component("YGL070C",246).
...
component("YPL072W",496).
component("YOR124C",472).
component("YNL186W",439).
component("YMR304W",426).
component("YMR223W",421).
component("YKR098C",364).
component("YJL197W",327).
component("YIL156W",305).
component("YFR010W",232).
component("YER151C",225).
component("YER144C",224).
component("YER098W",221).
component("YDR069C",176).
component("YDL122W",155).
component("YBR058C",112).
component("YBL067C",103).
component("YJR019C",331).
component("YDR074W",177).
component("YFR025C",234).
component("YPL179W",502).
component("YNR032W",453).
component("YML057W",401).
component("YML016C",399).
component("YLR433C",397).
component("YGR123C",261).
component("YER133W",223).
component("YER089C",218).
component("YDR436W",200).
component("YDR075W",178).
component("YDL188C",165).
component("YDL134C",157).
component("YDL047W",146).
component("YDL006W",144).
component("YBR125C",120).
component("YBL056W",102).
component("YHR046C",284).
component("U9_",93).
component("YGR208W",272).
component("YJL155C",324).
component("U34_",68).
component("U33_",67).
component("U32_",66).
component("U30_",65).
...
component("YGL248W",255).
component("YGL027C",242).
component("YLR286C",385).
component("YER043C",211).
component("YLR160C",380).
component("YLR158C",379).
component("YLR157C",378).
component("YLR155C",377).
component("YDR321W",192).
component("YGL037C",243).
component("U43_",71).
component("U42_",70).
component("YLR308W",389).
component("YLR307W",388).
component("U53_",76).
component("YLR420W",395).
component("YIR032C",310).
component("YLR028C",367).
component("YHR144C",292).
component("YHR144C",293).
component("YNL141W",435).
component("YBR153W",122).
component("YDL238C",168).
component("YNL141W",436).
component("YBR084W",116).
component("YJL126W",318).
component("U44_",72).
component("YHR201C",296).
component("YBR111C",118).
component("YCL030C",135).
component("YER005W",210).
component("YLR231C",384).
component("U88_",89).
component("YDR538W",206).
component("YLR134W",374).
component("YLR044C",369).
component("YGR087C",258).
component("YDR380W",194).
component("YDL080C",149).
component("YMR250W",422).
component("YKL184W",355).
component("YEL021W",207).
component("YNR043W",455).
component("YKL211C",358).
component("YKR097W",363).
component("YDR294C",190).
component("YNR033W",454).
component("YKL211C",359).
component("YER090W",219).
component("YDR127W",184).
component("YPL281C",512).
component("YOR393W",493).
component("YMR323W",427).
component("YHR174W",294).
component("YGR254W",273).
component("YGL026C",241).
component("YGR155W",264).
component("YNL316C",447).
component("YCR053W",143).
component("YDR127W",185).
component("YGL148W",248).
component("YIL168W",308).
component("YIL167W",307).
component("YCL064C",137).
component("YCL064C",138).
component("YFR055W",237).
component("YJL121C",317).
component("YBR019C",106).
component("YDR007W",169).
component("YOR095C",470).
component("YBR196C",125).
component("YGL001C",239).
component("YPL117C",498).
component("U14_",33).
component("YMR105C",414).
component("YKL127W",349).
component("YEL058W",209).
component("YPR060C",517).
component("YHR072W",288).
component("YJL153C",323).
component("YGR264C",276).
component("YGR171C",265).
component("YHR011W",279).
component("YDR023W",170).
component("YGL245W",254).
component("YOR168W",477).
component("YPR047W",516).
component("YLR060W",371).
component("YFL022C",229).
component("YPR033C",515).
component("YHR019C",280).
component("YKL194C",357).
component("YIL078W",302).
component("YPL160W",500).
component("YLR382C",393).
component("YPL040C",495).
component("YBL076C",105).
component("YDR037W",172).
component("YGR094W",259).
component("YGL234W",253).
component("YER183C",227).
component("U90_",91).
component("YNR057C",456).
component("YDL141W",159).
component("YDL141W",160).
component("YDL141W",161).
component("YDL141W",162).
component("YPR145W",523).
component("YGR124W",262).
...
component("YJL087C",314).
component("YOL010W",458).
component("YPR138C",522).
component("YPL265W",510).
component("YOR348C",488).
component("YOR130C",473).
component("YOL103W",466).
component("YOL020W",460).
component("YNL142W",437).
component("YMR272C",425).
component("YMR202W",418).
component("YMR056C",411).
component("YML123C",405).
component("YLR348C",391).
component("YLR138W",375).
component("YLR100C",373).
component("YLR092W",372).
component("YKR053C",362).
component("YKR039W",361).
component("YKL217W",360).
component("YJR077C",336).
component("YJL134W",320).
component("YGR191W",268).
component("YGR125W",263).
component("YGR121C",260).
component("YGL186C",249).
component("YFL055W",231).
component("YER060W-A",215).
component("YER060W",214).
component("YER056C",213).
component("YDR536W",205).
component("YDR508C",204).
component("YDR503C",203).
component("YDR497C",202).
component("YDR294C",191).
component("YDR046C",174).
component("YDL210W",166).
