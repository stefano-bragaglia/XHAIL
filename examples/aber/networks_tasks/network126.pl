...
component("YNL280C",674).
component("YLR056W",570).
component("YKR009C",551).
component("YMR083W",631).
component("YPL231W",765).
component("U46_",119).
component("YBR149W",196).
component("YBR149W",197).
component("YJR159W",523).
component("YGL001C",366).
component("YHR063C",439).
component("YML056C",616).
component("YLR432W",609).
component("YHR216W",457).
component("YAR075W",161).
component("YAR073W",160).
component("YCL030C",216).
component("YDR127W",278).
component("YJR139C",519).
component("YOR136W",718).
component("YNL009W",653).
component("YLR174W",583).
component("YDL066W",235).
component("YHR183W",451).
component("YGR256W",420).
component("YNL241C",668).
component("YOL059W",699).
component("YDL022W",229).
component("YCL018W",214).
component("YLR355C",603).
component("YIL074C",463).
component("YER081W",339).
component("YML054C",615).
component("YIL155C",468).
component("YEL024W",318).
component("YKR066C",556).
component("YJR078W",513).
component("U58_",129).
component("U107_",26).
component("YGR255C",419).
component("U108_",27).
component("YMR015C",628).
component("YDR402C",300).
component("YGL055W",374).
component("YJL026W",478).
component("YIL066C",462).
component("YGR180C",407).
component("YER070W",337).
component("U37_",111).
component("U36_",110).
component("U35_",109).
component("YJR009C",503).
component("YJL052W",479).
component("YGR192C",409).
component("YOR374W",742).
component("YER073W",338).
component("U68_",135).
component("YGL154C",381).
component("U55_",126).
component("YER069W",336).
component("YOR323C",735).
component("U2_",104).
...
component("YMR189W",639).
component("U56_",127).
component("YKR080W",558).
component("YPL023C",748).
component("YGL125W",378).
component("YOR236W",730).
component("YGR204W",413).
component("YBR084W",186).
component("YLR142W",577).
component("U65_",133).
component("U62_",131).
component("YHR068W",440).
component("YKL150W",535).
component("YIL043C",460).
component("YHR042W",434).
component("YOR221C",728).
component("YMR145C",636).
component("YML120C",621).
component("YKL192C",543).
component("YKL055C",526).
component("YER061C",332).
component("YDL085W",238).
component("YBR046C",182).
component("YMR145C",637).
component("YML120C",622).
component("YKL192C",544).
component("YDL085W",239).
component("YPL017C",747).
component("YFL018C",354).
component("YPL091W",751).
component("YER042W",326).
component("YPR167C",793).
component("YNL052W",655).
component("YMR256C",647).
component("YLR395C",607).
component("YLR038C",568).
component("YIL111W",465).
component("YHR051W",438).
component("YGL191W",384).
component("YGL187C",383).
component("YDL067C",236).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",772).
component("YBR034C",179).
component("YPL273W",774).
component("YLL062C",564).
component("YDR410C",303).
component("YKR069W",557).
component("YOL096C",702).
component("U47_",120).
component("YER091C",343).
component("YJR073C",511).
component("YML008C",612).
component("YDL033C",231).
component("YOL096C",703).
component("YLR172C",582).
component("YDR408C",302).
component("YMR120C",635).
component("YLR028C",566).
component("YBL013W",162).
component("YJL130C",487).
component("YJL088W",482).
component("YPR074C",786).
component("YBR117C",192).
component("YLR354C",602).
component("YGR043C",395).
component("YMR108W",633).
component("YCL009C",213).
component("YMR062C",630).
component("YNL071W",656).
component("YIL160C",471).
component("YNR019W",684).
component("YCR048W",226).
component("U48_",121).
component("YNL277W",673).
component("YDR232W",288).
component("YFL017C",353).
component("YPL231W",766).
component("YER061C",333).
component("U86_",150).
component("YPL001W",746).
component("YDL052C",233).
component("U8_",153).
component("YDR148C",284).
component("YOR377W",744).
component("YGR177C",406).
component("YPL231W",767).
component("YLR195C",585).
component("YLR299W",594).
component("YPR001W",776).
component("YNR001C",680).
component("YCR005C",222).
component("YML126C",624).
component("YDL182W",256).
component("YDL131W",246).
component("YNL117W",660).
component("YIR031C",476).
component("YPR160W",792).
component("YOR321W",734).
component("YJR143C",520).
component("YGR199W",411).
component("YDL095W",241).
component("YDL093W",240).
component("YAL023C",158).
component("YLR258W",591).
component("YFR015C",360).
component("YPL227C",763).
component("YMR261C",648).
component("YML100W",620).
component("YBR126C",195).
component("YNL192W",667).
component("YBR038W",181).
component("YBR023C",177).
component("YEL011W",316).
component("YLR209C",586).
component("U104_",24).
component("U103_",23).
component("YOR209C",726).
component("YMR300C",650).
component("YDR354W",296).
component("YFR047C",363).
component("YJR133W",518).
component("U22_",98).
component("YLR209C",587).
component("YDR399W",298).
component("YJL167W",495).
component("YJL167W",496).
component("YNL256W",670).
component("YPR069C",784).
component("YDR127W",279).
component("YHR190W",452).
component("YHR068W",441).
component("YLR303W",595).
component("YGR012W",392).
component("YML082W",619).
component("YJR130C",517).
component("YDR035W",266).
component("YBR249C",205).
component("YLR180W",584).
component("YDR502C",309).
component("YOL143C",708).
component("YBR256C",207).
component("YHR137W",446).
component("YGL202W",385).
component("YLR027C",565).
component("YKL106W",529).
component("YOL140W",707).
component("YLR438W",611).
component("YKL104C",528).
...
component("YNR058W",689).
component("YGL253W",391).
component("YFR053C",364).
component("YMR013C",627).
component("YMR205C",641).
component("YGR240C",417).
component("YLR240W",590).
component("YKL203C",546).
component("YJR066W",510).
component("YCR036W",225).
component("YGR194C",410).
component("YCL040W",219).
component("YJR105W",515).
component("U16_",67).
component("YPL188W",759).
component("YJR049C",507).
component("YEL041W",319).
component("YKL001C",524).
component("YDR236C",289).
component("YML070W",618).
component("YFL053W",357).
component("YDR531W",313).
component("U82_",147).
component("U81_",146).
component("YMR208W",642).
component("YPL203W",760).
component("YOR061W",712).
component("YKL166C",537).
component("YJL164C",494).
component("YIL035C",459).
component("YHR205W",454).
component("YHR102W",444).
component("YGL019W",370).
component("YHR025W",433).
component("YNR012W",682).
component("YPR121W",789).
component("YPL258C",769).
component("YOL055C",696).
component("YPL214C",762).
component("U1_",84).
...
component("YER052C",328).
component("U19_",83).
component("U18_",77).
component("U17_",72).
component("U76_",143).
component("YMR220W",644).
component("YER170W",349).
component("YDR226W",287).
component("YKL067W",527).
component("YOL055C",697).
component("YDR454C",306).
component("YOL061W",700).
component("YKL181W",538).
component("YHL011C",425).
component("YER099C",345).
component("YBL068W",168).
component("YOR143C",719).
component("YNL256W",671).
component("YLR328W",599).
component("YBR018C",173).
component("YBR018C",174).
component("YDL055C",234).
component("YGR202C",412).
component("YLR328W",600).
component("YDL103C",244).
component("U94_",156).
component("YJR010W",504).
component("YBR029C",178).
component("YGL130W",379).
component("YDR530C",312).
component("YPR190C",796).
component("YPR187W",795).
component("YPR110C",788).
component("YPR010C",778).
component("YOR341W",739).
component("YOR340C",738).
component("YOR224C",729).
component("YOR210W",727).
component("YOR207C",725).
component("YOR151C",720).
component("YOR116C",715).
component("YOL005C",690).
component("YNR003C",681).
component("YNL248C",669).
component("YNL151C",665).
component("YNL113W",659).
component("YKL144C",534).
component("YJR063W",509).
component("YJL148W",491).
component("YJL140W",490).
component("YIL021W",458).
component("YHR143W-A",447).
component("YGL070C",377).
component("YFL036W",356).
...
component("YPR175W",794).
component("YPL167C",757).
component("YOR330C",736).
component("YOL115W",706).
component("YNL299W",677).
component("YNL262W",672).
component("YNL102W",658).
component("YJR043C",506).
component("YJR006W",502).
component("YJL090C",483).
component("YIL139C",466).
...
component("YKL035W",525).
component("YHL012W",426).
component("YHR123W",445).
component("YNL130C",661).
component("YPL148C",755).
component("YOR251C",732).
component("YGR286C",422).
component("YDR058C",272).
component("YOL011W",692).
component("YMR008C",626).
component("YMR006C",625).
component("U105_",25).
component("U101_",21).
component("YJL068C",480).
component("YPL072W",750).
component("YOR124C",716).
component("YNL186W",666).
component("YMR304W",651).
component("YMR223W",645).
component("YKR098C",561).
component("YJL197W",497).
component("YIL156W",469).
component("YFR010W",359).
...
component("YJR019C",505).
component("U84_",148).
component("YDR481C",307).
component("YLR377C",605).
component("YDR074W",274).
component("YFR025C",362).
component("YPL179W",758).
component("YNR032W",685).
component("YML057W",617).
component("YML016C",613).
component("YLR433C",610).
component("YGR123C",401).
...
component("U26_",100).
component("U24_",99).
component("YHR044C",436).
component("YHR043C",435).
component("YOL064C",701).
component("YPL268W",773).
component("YOR360C",741).
component("YGL248W",390).
component("YKR031C",553).
component("YGL027C",372).
component("YLR286C",593).
component("YJR153W",522).
component("YJL221C",501).
component("YJL216C",499).
component("YIL172C",475).
component("YGR292W",424).
component("YGR287C",423).
component("YBR299W",212).
component("YBR184W",201).
component("YIL162W",472).
component("YPR026W",779).
component("YDR001C",262).
component("YBR001C",171).
component("YDR400W",299).
component("U102_",22).
component("YER043C",327).
component("YNL045W",654).
component("YLR160C",581).
component("YLR158C",580).
component("YLR157C",579).
component("YLR155C",578).
component("YDR321W",295).
component("YGL037C",373).
component("U43_",117).
component("U42_",116).
component("YLR308W",598).
component("YLR307W",597).
component("U53_",125).
component("YLR420W",608).
component("YPL111W",753).
component("YIR032C",477).
component("YLR028C",567).
component("YHR144C",448).
component("YHR144C",449).
component("YCL030C",217).
component("YNL141W",662).
component("YBR153W",198).
component("YDL238C",261).
component("YNL141W",663).
component("YML035C",614).
component("YGR204W",414).
component("YBR084W",187).
component("YJL126W",485).
component("U44_",118).
...
component("YER005W",324).
component("YBL099W",170).
component("YLR231C",588).
component("U88_",151).
component("YDR538W",315).
component("YLR134W",575).
component("YLR044C",569).
component("YGR087C",398).
component("YDR380W",297).
component("YDL080C",237).
component("YMR250W",646).
component("YKL184W",542).
component("YEL021W",317).
component("YNR043W",687).
component("U93_",155).
component("YDR047W",271).
component("YKL211C",547).
component("YKR097W",560).
component("YOL052C",695).
component("YDR294C",291).
component("YEL046C",320).
component("YNR033W",686).
component("YPR006C",777).
component("YER065C",335).
component("YKL211C",548).
component("YER090W",342).
component("YDR127W",281).
component("YPL281C",775).
component("YOR393W",745).
component("YMR323W",652).
component("YHR174W",450).
component("YGR254W",418).
component("YPL262W",770).
component("YGL026C",371).
component("YGR155W",404).
component("YLR304C",596).
component("YJL200C",498).
component("YGL009C",368).
component("YNL316C",678).
component("YKL182W",540).
component("YPL212C",761).
component("YNL292W",676).
component("YGL063W",376).
component("YFL001W",351).
component("YCR053W",227).
component("YDR127W",282).
component("YGL148W",380).
component("YIL168W",474).
component("YIL167W",473).
component("YCL064C",220).
component("YCL064C",221).
component("YHR018C",429).
component("YLR359W",604).
component("YFR055W",365).
component("YJL121C",484).
component("YBR019C",175).
component("YDR007W",263).
component("YOR095C",714).
component("YBR196C",202).
component("YGL001C",367).
component("YPL117C",754).
component("U14_",55).
component("YKL152C",536).
component("YMR105C",632).
component("YKL127W",531).
component("YEL058W",323).
component("YPR060C",783).
component("YHR072W",442).
component("YJL153C",492).
component("YGR264C",421).
component("YGR171C",405).
component("YHR011W",428).
component("YDR023W",265).
component("YPL104W",752).
component("YLL018C",562).
component("YPR081C",787).
component("YBR121C",193).
component("YHR020W",432).
component("YER087W",340).
component("YOL033W",694).
component("YGL245W",389).
component("YOR168W",721).
component("YOL097C",704).
component("YDR268W",290).
component("YPR047W",782).
component("YLR060W",571).
component("YFL022C",355).
component("YPR033C",780).
component("YHR019C",430).
component("YHR019C",431).
component("YKL194C",545).
component("YIL078W",464).
component("YPL160W",756).
component("YLR382C",606).
component("YPL040C",749).
component("YBL076C",169).
component("YNL073W",657).
component("YDR037W",267).
component("YOR335C",737).
component("YGR094W",399).
component("YPR035W",781).
component("YIL145C",467).
component("U89_",152).
component("YOR241W",731).
component("YMR113W",634).
component("YKL132C",532).
component("YGL234W",387).
component("YER183C",350).
component("U90_",154).
component("YNR057C",688).
component("YDL141W",249).
component("YDL141W",250).
component("YGL234W",388).
component("YDL141W",251).
component("YGR204W",415).
component("YOL058W",698).
component("YDL141W",252).
component("YHR074W",443).
component("YMR217W",643).
component("YPR145W",791).
component("YGR124W",402).
component("YOR303W",733).
component("YJR109C",516).
component("YJL130C",488).
component("YGL062W",375).
component("YBR218C",203).
component("YPL231W",768).
component("YNR016C",683).
component("YKL182W",541).
component("YGR037C",394).
component("YOR005C",710).
component("YDL164C",254).
component("YJL087C",481).
component("YOL010W",691).
component("YPR138C",790).
component("YPL265W",771).
component("YOR348C",740).
component("YOR192C",724).
component("YOR171C",722).
component("YOR130C",717).
component("YOR071C",713).
component("YOR011W",711).
component("YOL156W",709).
component("YOL103W",705).
component("YOL020W",693).
component("YNL318C",679).
component("YNL142W",664).
component("YMR272C",649).
component("YMR202W",640).
component("YMR056C",629).
component("YML123C",623).
component("YLR348C",601).
component("YLR260W",592).
component("YLR237W",589).
component("YLR138W",576).
component("YLR100C",574).
component("YLR092W",573).
component("YLR081W",572).
component("YLL061W",563).
component("YKR093W",559).
component("YKR053C",555).
component("YKR039W",554).
component("YKL217W",550).
component("YKL120W",530).
component("YJR095W",514).
component("YJR077C",512).
component("YJL219W",500).
component("YJL134W",489).
component("YJL129C",486).
component("YHL036W",427).
component("YGR191W",408).
component("YGR125W",403).
component("YGR121C",400).
component("YGR065C",397).
component("YGR055W",396).
component("YGL186C",382).
component("YFL055W",358).
component("YFL011W",352).
component("YER060W-A",331).
component("YER060W",330).
component("YER056C",329).
component("YDR536W",314).
component("YDR508C",311).
component("YDR503C",310).
component("YDR497C",308).
