...
component("YNL280C",141).
component("YLR056W",124).
component("YGL001C",86).
component("YDR127W",62).
component("YNL009W",137).
component("YLR174W",126).
component("YHR183W",103).
component("YGR256W",95).
component("YCL018W",46).
component("YJR078W",111).
component("YOR323C",153).
component("YBR166C",43).
component("YNL280C",142).
component("YKL141W",116).
component("YOR375C",155).
component("YAL062W",33).
component("U100_",18).
component("YMR145C",133).
component("YDL085W",53).
component("YBR046C",37).
component("YPR074C",165).
component("YBR117C",41).
component("YNR019W",145).
component("YCR048W",50).
component("U48_",27).
component("YPL231W",158).
component("YPL231W",159).
component("YLR299W",128).
component("YOR321W",152).
component("YJR143C",114).
component("YGR199W",93).
component("YDL095W",55).
component("YDL093W",54).
component("YAL023C",32).
component("YDR354W",69).
component("YFR047C",84).
component("U22_",25).
component("YPR069C",164).
component("YDR127W",63).
component("YML082W",131).
component("YJR130C",113).
component("YDR035W",59).
component("YBR249C",44).
component("YHR137W",100).
component("YGL202W",90).
component("YLR027C",123).
component("YKL106W",115).
component("YLR438W",130).
component("U51_",28).
component("YMR013C",132).
component("YCR036W",49).
component("YJR105W",112).
component("YMR208W",134).
component("YHR025W",97).
component("YFR019W",83).
component("YDR208W",67).
component("YDR127W",64).
component("YER052C",77).
component("U19_",22).
component("YDR226W",68).
component("YDR454C",72).
component("YOL061W",149).
component("YKL181W",117).
component("YHL011C",96).
component("YER099C",79).
component("YBL068W",36).
component("YLR328W",129).
component("YPR175W",167).
component("YPL167C",157).
component("YOR330C",154).
component("YOL115W",150).
component("YNL299W",143).
component("YNL262W",140).
component("YNL102W",138).
component("YJR043C",109).
component("YJR006W",108).
component("YJL090C",106).
component("YIL139C",104).
component("YEL055C",75).
component("YDR419W",71).
component("YDR121W",61).
component("YDL102W",56).
component("YCR014C",48).
component("YBR278W",45).
component("YBL035C",34).
component("U30_",26).
component("YHR044C",99).
component("YHR043C",98).
component("YGL037C",88).
component("U53_",29).
component("YHR144C",101).
component("YBR153W",42).
component("YBR111C",40).
component("YER005W",76).
component("YLR231C",127).
component("YDR380W",70).
component("YDL080C",52).
component("YMR250W",135).
component("YKL184W",118).
component("YKL211C",119).
component("YNR033W",146).
component("YKL211C",120).
component("YER090W",78).
component("YDR127W",65).
component("YPL281C",161).
component("YOR393W",156).
component("YMR323W",136).
component("YHR174W",102).
component("YGR254W",94).
component("YGL026C",87).
component("YNL316C",144).
component("YCR053W",51).
component("YDR127W",66).
component("YGL148W",89).
component("YFR055W",85).
component("YDR007W",58).
component("YOR095C",151).
component("YPR060C",163).
component("YGL245W",91).
component("YPR047W",162).
component("YLR060W",125).
component("YFL022C",81).
component("YER183C",80).
component("YDL141W",57).
component("YJL087C",105).
component("YOL010W",147).
component("YPR138C",166).
component("YPL265W",160).
component("YOL020W",148).
component("YNL142W",139).
component("YKR053C",122).
component("YKR039W",121).
component("YJR077C",110).
component("YJL134W",107).
component("YGR121C",92).
component("YFL055W",82).
component("YDR536W",74).
component("YDR508C",73).
component("YDR046C",60).
component("YCL025C",47).
component("YBR069C",39).
component("YBR068C",38).
component("YBL042C",35).
component("U6_",31).
component("U5_",30).
component("U228_",24).
component("U222_",23).
