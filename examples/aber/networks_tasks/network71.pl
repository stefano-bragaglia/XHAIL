...
component("YNL280C",455).
component("YLR056W",381).
component("YKR009C",371).
component("YMR083W",424).
component("YPL231W",517).
component("YJR159W",354).
component("YGL001C",247).
component("YML056C",411).
component("YLR432W",407).
component("YHR216W",309).
component("YAR075W",100).
component("YAR073W",99).
component("YDR127W",187).
component("YJR139C",351).
component("YOR136W",485).
component("YNL009W",439).
component("YLR174W",393).
component("YHR183W",305).
component("YGR256W",284).
component("YOL059W",474).
component("YDL022W",150).
component("YCL018W",138).
component("YLR355C",403).
component("YJR078W",347).
component("U58_",82).
component("YGR255C",283).
component("YMR015C",421).
component("YDR402C",203).
component("YGL055W",253).
component("YJL026W",321).
component("YGR180C",276).
component("U35_",70).
component("YJR009C",339).
component("YJL052W",322).
component("YGR192C",278).
component("YOR374W",502).
component("YER073W",225).
component("U68_",86).
component("U55_",80).
component("YER069W",224).
component("YOR323C",496).
component("U2_",65).
component("YBR166C",128).
component("YNL280C",456).
component("YKL141W",360).
component("YJR051W",343).
component("YOR375C",503).
component("YDL215C",172).
component("YAL062W",98).
component("U100_",20).
component("YBR035C",113).
component("YMR189W",428).
component("U56_",81).
component("YPL023C",506).
component("YGL125W",256).
component("YOR236W",493).
component("YBR084W",119).
component("YLR142W",387).
component("U65_",85).
component("U62_",84).
component("YHR068W",296).
component("YMR145C",427).
component("YML120C",415).
component("YKL192C",366).
component("YDL085W",155).
component("YBR046C",115).
component("YPL091W",509).
component("YNL052W",440).
component("YMR256C",434).
component("YLR395C",405).
component("YLR038C",379).
component("YIL111W",313).
component("YHR051W",295).
component("YGL191W",260).
component("YGL187C",259).
component("YDL067C",153).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",523).
component("YLL062C",376).
component("YDR410C",205).
component("YER091C",229).
component("YJR073C",345).
component("YOL096C",476).
component("YLR172C",392).
component("YMR120C",426).
component("YBL013W",101).
component("YJL130C",329).
component("YJL088W",325).
component("YPR074C",532).
component("YBR117C",123).
component("YCL009C",137).
component("YMR062C",423).
component("YNL071W",441).
component("YIL160C",316).
component("YNR019W",463).
component("YCR048W",147).
component("U48_",75).
component("YFL017C",237).
component("YPL231W",518).
component("YER061C",223).
component("YDL052C",152).
component("U8_",93).
component("YDR148C",193).
component("YOR377W",504).
component("YGR177C",275).
component("YPL231W",519).
component("YLR299W",397).
component("YPR001W",525).
component("YNR001C",459).
component("YCR005C",144).
component("YML126C",417).
component("YDL182W",169).
component("YDL131W",161).
component("YNL117W",444).
component("YIR031C",319).
component("YOR321W",495).
component("YJR143C",352).
component("YGR199W",280).
component("YDL095W",157).
component("YDL093W",156).
component("YAL023C",97).
component("YPL227C",516).
component("YMR261C",435).
component("YML100W",414).
component("YBR126C",125).
component("YNL192W",451).
component("YBR038W",114).
component("YBR023C",111).
component("YLR209C",394).
component("YDR354W",200).
component("YFR047C",244).
component("YJR133W",350).
component("U22_",60).
component("YDR399W",202).
component("YJL167W",336).
component("YPR069C",531).
component("YDR127W",188).
component("YHR068W",297).
component("YLR303W",398).
component("YML082W",413).
component("YJR130C",349).
component("YDR035W",177).
component("YBR249C",132).
component("YBR256C",133).
component("YHR137W",300).
component("YGL202W",261).
component("YLR027C",377).
component("YKL106W",358).
component("YOL140W",479).
component("YLR438W",409).
component("YKL104C",357).
component("YDR111C",185).
component("U51_",78).
component("YJR148W",353).
component("YHR208W",308).
component("YOR184W",489).
component("YGL253W",265).
component("YFR053C",245).
component("YMR013C",420).
component("YCR036W",146).
component("YGR194C",279).
component("YCL040W",141).
component("YJR105W",348).
component("U81_",91).
component("YMR208W",430).
component("YPL203W",515).
component("YOR061W",480).
component("YKL166C",362).
component("YJL164C",335).
component("YIL035C",311).
component("YHR205W",307).
component("YHR102W",299).
component("YGL019W",249).
component("YHR025W",291).
component("YNR012W",461).
component("YPR121W",534).
component("YPL258C",521).
component("YOL055C",472).
component("U1_",50).
component("YFR019W",242).
component("YDR208W",195).
component("YDR127W",189).
component("U21_",57).
component("YDR147W",192).
component("YER052C",219).
component("U19_",49).
component("U18_",45).
component("U17_",42).
component("U76_",89).
component("YMR220W",431).
component("YER170W",235).
component("YDR226W",196).
component("YKL067W",356).
component("YOL055C",473).
component("YDR454C",208).
component("YOL061W",475).
component("YKL181W",363).
component("YHL011C",286).
component("YER099C",231).
component("YBL068W",107).
component("YOR143C",486).
component("YNL256W",453).
component("YLR328W",401).
component("YDL103C",159).
component("U94_",95).
component("YJR010W",340).
component("YBR029C",112).
component("YPR190C",539).
component("YPR187W",538).
component("YPR110C",533).
component("YPR010C",526).
component("YOR341W",499).
component("YOR340C",498).
component("YOR224C",492).
component("YOR210W",491).
component("YOR207C",490).
component("YOR151C",487).
component("YOR116C",482).
component("YOL005C",468).
component("YNR003C",460).
component("YNL248C",452).
component("YNL151C",449).
component("YNL113W",443).
component("YKL144C",361).
component("YJR063W",344).
component("YJL148W",332).
component("YJL140W",331).
component("YIL021W",310).
component("YHR143W-A",301).
component("YGL070C",255).
component("YFL036W",239).
...
component("YPR175W",537).
component("YPL167C",513).
component("YOR330C",497).
component("YOL115W",478).
component("YNL299W",457).
component("YNL262W",454).
component("YNL102W",442).
component("YJR043C",342).
component("YJR006W",338).
component("YJL090C",326).
component("YIL139C",314).
component("YEL055C",215).
...
component("YHL012W",287).
component("YNL130C",445).
component("YPL148C",511).
component("YOR251C",494).
component("YDR058C",181).
component("YOL011W",470).
component("YMR008C",419).
component("YMR006C",418).
component("U105_",22).
component("U101_",21).
component("YJL068C",323).
component("YPL072W",508).
component("YOR124C",483).
component("YNL186W",450).
component("YMR304W",437).
component("YMR223W",432).
component("YKR098C",375).
component("YJL197W",337).
component("YIL156W",315).
component("YFR010W",241).
component("YER151C",234).
component("YER144C",233).
component("YER098W",230).
component("YDR069C",182).
component("YDL122W",160).
component("YBR058C",116).
component("YBL067C",106).
component("YJR019C",341).
component("YDR074W",183).
component("YFR025C",243).
component("YPL179W",514).
component("YNR032W",464).
component("YML057W",412).
component("YML016C",410).
component("YLR433C",408).
component("YGR123C",270).
component("YER133W",232).
component("YER089C",227).
component("YDR436W",207).
component("YDR075W",184).
component("YDL188C",170).
component("YDL134C",162).
component("YDL047W",151).
component("YDL006W",149).
component("YBR125C",124).
component("YBL056W",105).
component("YHR046C",294).
component("U9_",96).
component("YGR208W",281).
component("YJL155C",334).
component("U34_",69).
component("U33_",68).
component("U32_",67).
component("U30_",66).
...
component("U26_",62).
component("U24_",61).
component("YHR044C",293).
component("YHR043C",292).
component("YOR360C",501).
component("YGL248W",264).
component("YGL027C",251).
component("YLR286C",396).
component("YBR184W",129).
component("YPR026W",527).
component("YDR001C",174).
component("YBR001C",109).
component("YER043C",218).
component("YLR160C",391).
component("YLR158C",390).
component("YLR157C",389).
component("YLR155C",388).
component("YDR321W",199).
component("YGL037C",252).
component("U43_",73).
component("U42_",72).
component("YLR308W",400).
component("YLR307W",399).
component("U53_",79).
component("YLR420W",406).
component("YIR032C",320).
component("YLR028C",378).
component("YHR144C",302).
component("YHR144C",303).
component("YNL141W",446).
component("YBR153W",126).
component("YDL238C",173).
component("YNL141W",447).
component("YBR084W",120).
component("YJL126W",328).
component("U44_",74).
component("YHR201C",306).
component("YBR111C",122).
component("YCL030C",140).
component("YER005W",217).
component("YLR231C",395).
component("U88_",92).
component("YDR538W",213).
component("YLR134W",385).
component("YLR044C",380).
component("YGR087C",267).
component("YDR380W",201).
component("YDL080C",154).
component("YMR250W",433).
component("YKL184W",365).
component("YEL021W",214).
component("YNR043W",466).
component("YKL211C",368).
component("YKR097W",374).
component("YDR294C",197).
component("YNR033W",465).
component("YKL211C",369).
component("YER090W",228).
component("YDR127W",190).
component("YPL281C",524).
component("YOR393W",505).
component("YMR323W",438).
component("YHR174W",304).
component("YGR254W",282).
component("YGL026C",250).
component("YGR155W",273).
component("YNL316C",458).
component("YCR053W",148).
component("YDR127W",191).
component("YGL148W",257).
component("YIL168W",318).
component("YIL167W",317).
component("YCL064C",142).
component("YCL064C",143).
component("YFR055W",246).
component("YJL121C",327).
component("YBR019C",110).
component("YDR007W",175).
component("YOR095C",481).
component("YBR196C",130).
component("YGL001C",248).
component("YPL117C",510).
component("U14_",33).
component("YMR105C",425).
component("YKL127W",359).
component("YEL058W",216).
component("YPR060C",530).
component("YHR072W",298).
component("YJL153C",333).
component("YGR264C",285).
component("YGR171C",274).
component("YHR011W",288).
component("YDR023W",176).
component("YHR020W",290).
component("YER087W",226).
component("YGL245W",263).
component("YOR168W",488).
component("YPR047W",529).
component("YLR060W",382).
component("YFL022C",238).
component("YPR033C",528).
component("YHR019C",289).
component("YKL194C",367).
component("YIL078W",312).
component("YPL160W",512).
component("YLR382C",404).
component("YPL040C",507).
component("YBL076C",108).
component("YDR037W",178).
component("YGR094W",268).
component("YGL234W",262).
component("YER183C",236).
component("U90_",94).
component("YNR057C",467).
component("YDL141W",164).
component("YDL141W",165).
component("YDL141W",166).
component("YDL141W",167).
component("YPR145W",536).
component("YGR124W",271).
component("YGL062W",254).
component("YBR218C",131).
component("YPL231W",520).
component("YNR016C",462).
component("YKL182W",364).
component("YGR037C",266).
component("YJL087C",324).
component("YOL010W",469).
component("YPR138C",535).
component("YPL265W",522).
component("YOR348C",500).
component("YOR130C",484).
component("YOL103W",477).
component("YOL020W",471).
component("YNL142W",448).
component("YMR272C",436).
component("YMR202W",429).
component("YMR056C",422).
component("YML123C",416).
component("YLR348C",402).
component("YLR138W",386).
component("YLR100C",384).
component("YLR092W",383).
component("YKR053C",373).
component("YKR039W",372).
component("YKL217W",370).
component("YJR077C",346).
component("YJL134W",330).
component("YGR191W",277).
component("YGR125W",272).
component("YGR121C",269).
component("YGL186C",258).
component("YFL055W",240).
component("YER060W-A",222).
component("YER060W",221).
component("YER056C",220).
component("YDR536W",212).
component("YDR508C",211).
component("YDR503C",210).
component("YDR497C",209).
component("YDR294C",198).
component("YDR046C",180).
component("YDL210W",171).
component("YCL025C",139).
component("YBR294W",136).
component("YBR291C",135).
component("YBR085W",121).
component("YBR069C",118).
component("YBR068C",117).
component("YBL042C",104).
component("YBL030C",102).
component("U7_",90).
component("U6_",88).
component("U69_",87).
component("U5_",83).
