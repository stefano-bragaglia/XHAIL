...
component("YNL280C",569).
component("YLR056W",476).
component("YKR009C",463).
component("YMR083W",528).
component("YPL231W",644).
component("YJR159W",440).
component("YGL001C",307).
component("YHR063C",369).
component("YML056C",514).
component("YLR432W",509).
component("YHR216W",385).
component("YAR075W",132).
component("YAR073W",131).
component("YCL030C",178).
component("YDR127W",231).
component("YJR139C",436).
component("YOR136W",604).
component("YNL009W",548).
component("YLR174W",488).
component("YDL066W",195).
component("YHR183W",380).
component("YGR256W",354).
component("YNL241C",563).
component("YOL059W",591).
component("YDL022W",190).
component("YCL018W",176).
component("YLR355C",504).
component("YML054C",513).
component("YIL155C",394).
component("YEL024W",265).
component("YJR078W",432).
component("U58_",105).
component("YGR255C",353).
component("U108_",26).
component("YMR015C",525).
component("YDR402C",248).
component("YGL055W",314).
component("YJL026W",403).
component("YIL066C",390).
component("YGR180C",344).
component("YER070W",281).
component("U36_",92).
component("U35_",91).
component("YJR009C",423).
component("YJL052W",404).
component("YGR192C",346).
...
component("YER014W",269).
component("YKR009C",464).
component("YIL160C",396).
component("YGL205W",325).
component("YKL141W",449).
component("YJR051W",427).
component("YOR375C",626).
component("YDL215C",215).
component("YAL062W",130).
component("U100_",20).
component("YBR035C",148).
component("YMR189W",535).
component("U56_",104).
component("YPL023C",630).
component("YGL125W",318).
component("YOR236W",613).
component("YGR204W",349).
component("YBR084W",154).
component("YLR142W",482).
component("U65_",108).
component("U62_",107).
component("YHR068W",370).
component("YKL150W",451).
component("YIL043C",388).
component("YHR042W",364).
component("YOR221C",611).
component("YMR145C",533).
component("YML120C",519).
component("YKL192C",457).
component("YKL055C",443).
component("YER061C",276).
component("YDL085W",198).
component("YBR046C",150).
component("YPL017C",629).
component("YFL018C",296).
component("YPL091W",633).
component("YER042W",270).
component("YNL052W",550).
component("YMR256C",542).
component("YLR395C",507).
component("YLR038C",474).
component("YIL111W",392).
component("YHR051W",368).
component("YGL191W",323).
component("YGL187C",322).
component("YDL067C",196).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",650).
component("YPL273W",652).
component("YLL062C",471).
component("YDR410C",250).
component("YER091C",286).
component("YJR073C",430).
component("YDL033C",191).
component("YOL096C",594).
component("YLR172C",487).
component("YMR120C",532).
component("YBL013W",133).
component("YJL130C",412).
component("YJL088W",407).
component("YPR074C",663).
component("YBR117C",158).
component("YMR108W",530).
component("YCL009C",175).
component("YMR062C",527).
component("YNL071W",551).
component("YIL160C",397).
component("YNR019W",578).
component("YCR048W",187).
component("U48_",98).
component("YNL277W",568).
component("YFL017C",295).
component("YPL231W",645).
component("YER061C",277).
component("U86_",122).
component("YDL052C",193).
component("U8_",125).
component("YDR148C",237).
component("YOR377W",627).
component("YGR177C",343).
component("YPL231W",646).
component("YLR195C",490).
component("YLR299W",496).
component("YPR001W",654).
component("YNR001C",574).
component("YCR005C",183).
component("YML126C",521).
component("YDL182W",212).
component("YDL131W",204).
component("YNL117W",555).
component("YIR031C",401).
component("YPR160W",669).
component("YOR321W",617).
component("YJR143C",437).
component("YGR199W",348).
component("YDL095W",200).
component("YDL093W",199).
component("YAL023C",129).
component("YPL227C",642).
component("YMR261C",543).
component("YML100W",518).
component("YBR126C",161).
component("YNL192W",562).
component("YBR038W",149).
component("YBR023C",146).
component("YEL011W",263).
component("YLR209C",491).
component("U104_",24).
component("U103_",23).
component("YMR300C",545).
component("YDR354W",244).
component("YFR047C",304).
component("YJR133W",435).
component("U22_",81).
component("YLR209C",492).
component("YDR399W",246).
component("YJL167W",419).
component("YNL256W",565).
component("YPR069C",662).
component("YDR127W",232).
component("YHR190W",381).
component("YHR068W",371).
component("YLR303W",497).
component("YML082W",517).
component("YJR130C",434).
component("YDR035W",221).
component("YBR249C",169).
component("YLR180W",489).
component("YDR502C",256).
component("YOL143C",598).
component("YBR256C",171).
component("YHR137W",375).
component("YGL202W",324).
component("YLR027C",472).
component("YKL106W",446).
component("YOL140W",597).
component("YLR438W",511).
component("YKL104C",445).
component("YGR019W",331).
component("YDR111C",229).
component("U51_",101).
component("YJR148W",438).
component("YHR208W",384).
component("YOR184W",608).
component("YNR058W",583).
component("YGL253W",330).
component("YFR053C",305).
component("YMR013C",524).
component("YLR240W",494).
component("YKL203C",459).
component("YJR066W",429).
component("YCR036W",186).
component("YGR194C",347).
component("YCL040W",180).
component("YJR105W",433).
component("U16_",53).
component("YKL001C",441).
component("YML070W",516).
component("YFL053W",299).
component("YDR531W",260).
component("U82_",120).
component("U81_",119).
component("YMR208W",537).
component("YPL203W",640).
component("YOR061W",599).
component("YKL166C",452).
component("YJL164C",418).
component("YIL035C",387).
component("YHR205W",383).
component("YHR102W",373).
component("YGL019W",310).
component("YHR025W",363).
component("YNR012W",576).
component("YPR121W",666).
component("YPL258C",648).
component("YOL055C",589).
component("U1_",70).
component("YDR009W",219).
component("YBR020W",145).
component("YFR019W",302).
component("YDR208W",239).
component("YDR127W",233).
component("U21_",78).
component("YDR147W",236).
component("YCR012W",184).
component("YER052C",272).
component("U19_",69).
component("U18_",63).
component("U17_",58).
component("U76_",116).
component("YMR220W",539).
component("YER170W",292).
component("YDR226W",240).
component("YKL067W",444).
component("YOL055C",590).
component("YDR454C",253).
component("YOL061W",592).
component("YKL181W",453).
component("YHL011C",357).
component("YER099C",288).
component("YBL068W",139).
component("YOR143C",605).
component("YNL256W",566).
component("YLR328W",501).
component("YBR018C",143).
component("YDL055C",194).
component("YLR328W",502).
component("YDL103C",202).
component("U94_",127).
component("YJR010W",424).
component("YBR029C",147).
component("YDR530C",259).
component("YPR190C",672).
component("YPR187W",671).
component("YPR110C",665).
component("YPR010C",656).
component("YOR341W",622).
component("YOR340C",621).
component("YOR224C",612).
component("YOR210W",610).
component("YOR207C",609).
component("YOR151C",606).
component("YOR116C",601).
component("YOL005C",584).
component("YNR003C",575).
component("YNL248C",564).
component("YNL151C",560).
component("YNL113W",554).
component("YKL144C",450).
component("YJR063W",428).
component("YJL148W",415).
component("YJL140W",414).
component("YIL021W",386).
component("YHR143W-A",376).
component("YGL070C",317).
component("YFL036W",298).
component("YDR404C",249).
component("YDR156W",238).
component("YDR045C",223).
component("YDL150W",211).
component("YDL140C",206).
component("YBR154C",163).
component("YPR175W",670).
component("YPL167C",638).
component("YOR330C",619).
component("YOL115W",596).
component("YNL299W",572).
component("YNL262W",567).
component("YNL102W",553).
component("YJR043C",426).
component("YJR006W",422).
component("YJL090C",408).
component("YIL139C",393).
component("YEL055C",266).
component("YDR419W",251).
component("YDR121W",230).
component("YDL102W",201).
component("YCR014C",185).
component("YBR278W",172).
component("YBL035C",135).
component("YKL035W",442).
component("YHL012W",358).
component("YHR123W",374).
component("YNL130C",556).
component("YPL148C",636).
component("YOR251C",615).
component("YGR286C",356).
component("YDR058C",225).
component("YOL011W",586).
component("YMR008C",523).
component("YMR006C",522).
component("U105_",25).
component("U101_",21).
component("YJL068C",405).
component("YPL072W",632).
component("YOR124C",602).
component("YNL186W",561).
component("YMR304W",546).
component("YMR223W",540).
component("YKR098C",469).
component("YJL197W",420).
component("YIL156W",395).
component("YFR010W",301).
component("YER151C",291).
component("YER144C",290).
component("YER098W",287).
component("YDR069C",226).
component("YDL122W",203).
component("YBR058C",151).
component("YBL067C",138).
component("YJR019C",425).
component("YDR481C",254).
component("YDR074W",227).
component("YFR025C",303).
component("YPL179W",639).
component("YNR032W",579).
component("YML057W",515).
component("YML016C",512).
component("YLR433C",510).
component("YGR123C",338).
component("YER133W",289).
component("YER089C",284).
component("YDR436W",252).
component("YDR075W",228).
component("YDL188C",213).
component("YDL134C",205).
component("YDL047W",192).
component("YDL006W",189).
component("YBR125C",160).
component("YBL056W",137).
component("YIL053W",389).
component("YER062C",278).
component("YHR046C",367).
component("U9_",128).
component("YGR208W",351).
component("YPL228W",643).
component("YMR180C",534).
component("YJL155C",417).
component("U34_",90).
component("U33_",89).
component("U32_",88).
component("U30_",87).
...
component("U26_",83).
component("U24_",82).
component("YHR044C",366).
component("YHR043C",365).
component("YOL064C",593).
component("YPL268W",651).
component("YOR360C",624).
component("YGL248W",329).
component("YKR031C",465).
component("YGL027C",312).
component("YLR286C",495).
component("YJR153W",439).
component("YBR184W",165).
component("YIL162W",398).
component("YPR026W",657).
component("YDR001C",217).
component("YBR001C",142).
component("YDR400W",247).
component("U102_",22).
component("YER043C",271).
component("YNL045W",549).
...
component("U43_",96).
component("U42_",95).
component("YLR308W",500).
component("YLR307W",499).
component("U53_",102).
component("YLR420W",508).
component("YPL111W",634).
component("YIR032C",402).
component("YLR028C",473).
component("YHR144C",377).
component("YHR144C",378).
component("YNL141W",557).
component("YBR153W",162).
component("YDL238C",216).
component("YNL141W",558).
component("YBR084W",155).
component("YJL126W",410).
component("U44_",97).
component("U39_",93).
component("YHR201C",382).
component("YBR111C",157).
component("YBR252W",170).
component("YCL030C",179).
component("YER005W",268).
component("YBL099W",141).
component("YLR231C",493).
component("U88_",123).
component("YDR538W",262).
component("YLR134W",480).
component("YLR044C",475).
component("YGR087C",335).
component("YDR380W",245).
component("YDL080C",197).
component("YMR250W",541).
component("YKL184W",456).
component("YEL021W",264).
component("YNR043W",581).
component("YKL211C",460).
component("YKR097W",468).
component("YOL052C",588).
component("YDR294C",241).
component("YNR033W",580).
component("YPR006C",655).
component("YER065C",279).
component("YKL211C",461).
component("YER090W",285).
component("YDR127W",234).
component("YPL281C",653).
component("YOR393W",628).
component("YMR323W",547).
component("YHR174W",379).
component("YGR254W",352).
component("YGL026C",311).
component("YGR155W",341).
component("YLR304C",498).
component("YJL200C",421).
component("YNL316C",573).
component("YPL212C",641).
...
component("YIL168W",400).
component("YIL167W",399).
component("YCL064C",181).
component("YCL064C",182).
component("YLR359W",505).
component("YFR055W",306).
component("YJL121C",409).
component("YBR019C",144).
component("YDR007W",218).
component("YOR095C",600).
component("YBR196C",166).
component("YGL001C",308).
component("YPL117C",635).
component("U14_",45).
component("YMR105C",529).
component("YKL127W",447).
component("YEL058W",267).
component("YPR060C",661).
component("YHR072W",372).
component("YJL153C",416).
component("YGR264C",355).
component("YGR171C",342).
component("YHR011W",360).
component("YDR023W",220).
component("YPR081C",664).
component("YBR121C",159).
component("YHR020W",362).
component("YER087W",283).
component("YGL245W",328).
component("YOR168W",607).
component("YPR047W",660).
component("YLR060W",477).
component("YFL022C",297).
component("YPR033C",658).
component("YHR019C",361).
component("YKL194C",458).
component("YIL078W",391).
component("YPL160W",637).
component("YLR382C",506).
component("YPL040C",631).
component("YBL076C",140).
component("YNL073W",552).
component("YDR037W",222).
component("YOR335C",620).
component("YGR094W",336).
component("YPR035W",659).
component("U89_",124).
component("YOR241W",614).
component("YMR113W",531).
component("YKL132C",448).
component("YGL234W",326).
component("YER183C",293).
component("U90_",126).
component("YNR057C",582).
...
component("YMR217W",538).
component("YPR145W",668).
component("YGR124W",339).
...
component("YGR037C",332).
component("YJL087C",406).
component("YOL010W",585).
component("YPR138C",667).
component("YPL265W",649).
component("YOR348C",623).
component("YOR130C",603).
component("YOL103W",595).
component("YOL020W",587).
component("YNL142W",559).
component("YMR272C",544).
component("YMR202W",536).
component("YMR056C",526).
component("YML123C",520).
component("YLR348C",503).
component("YLR138W",481).
component("YLR100C",479).
component("YLR092W",478).
component("YLL061W",470).
component("YKR053C",467).
component("YKR039W",466).
component("YKL217W",462).
component("YJR077C",431).
component("YJL134W",413).
component("YJL129C",411).
component("YHL036W",359).
component("YGR191W",345).
component("YGR125W",340).
component("YGR121C",337).
component("YGR065C",334).
...
component("YDR536W",261).
component("YDR508C",258).
component("YDR503C",257).
component("YDR497C",255).
component("YDR294C",242).
component("YDR046C",224).
component("YDL210W",214).
component("YCL025C",177).
component("YBR294W",174).
component("YBR291C",173).
component("YBR085W",156).
component("YBR069C",153).
component("YBR068C",152).
component("YBL042C",136).
component("YBL030C",134).
component("U85_",121).
component("U7_",118).
component("U79_",117).
component("U75_",115).
