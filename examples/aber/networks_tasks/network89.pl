...
component("YKR009C",426).
component("YMR083W",487).
component("YPL231W",594).
component("YJR159W",406).
component("YGL001C",284).
component("YML056C",473).
component("YLR432W",468).
component("YHR216W",353).
component("YAR075W",117).
component("YAR073W",116).
component("YCL030C",162).
component("YDR127W",214).
component("YJR139C",402).
component("YOR136W",557).
component("YNL009W",505).
component("YLR174W",450).
component("YDL066W",179).
component("YHR183W",348).
component("YGR256W",324).
component("YOL059W",545).
component("YDL022W",174).
component("YCL018W",160).
component("YLR355C",463).
component("YML054C",472).
component("YIL155C",362).
component("YEL024W",244).
component("YJR078W",398).
component("U58_",92).
component("YGR255C",323).
component("YMR015C",484).
component("YDR402C",231).
component("YGL055W",290).
component("YJL026W",370).
component("YIL066C",358).
component("YGR180C",315).
component("YER070W",259).
component("U36_",80).
component("U35_",79).
component("YJR009C",389).
component("YJL052W",371).
component("YGR192C",317).
component("YOR374W",576).
component("YER073W",260).
component("U68_",96).
component("YGL154C",295).
component("U55_",90).
component("YER069W",258).
component("YOR323C",569).
component("U2_",74).
component("YBR221C",152).
component("YBR166C",148).
component("YNL280C",526).
component("YER014W",248).
component("YKL141W",413).
component("YJR051W",393).
component("YOR375C",577).
component("YDL215C",199).
component("YAL062W",115).
component("U100_",20).
component("YBR035C",133).
component("YMR189W",493).
component("U56_",91).
component("YPL023C",581).
component("YGL125W",293).
component("YOR236W",565).
component("YGR204W",320).
...
component("YHR042W",333).
component("YMR145C",491).
component("YML120C",478).
component("YKL192C",420).
component("YDL085W",182).
component("YBR046C",135).
component("YPL017C",580).
component("YFL018C",273).
component("YPL091W",584).
component("YER042W",249).
component("YNL052W",507).
component("YMR256C",500).
component("YLR395C",466).
component("YLR038C",436).
component("YIL111W",360).
component("YHR051W",337).
component("YGL191W",298).
component("YGL187C",297).
component("YDL067C",180).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",600).
component("YPL273W",602).
component("YLL062C",433).
component("YDR410C",233).
component("YER091C",264).
component("YJR073C",396).
component("YDL033C",175).
component("YOL096C",548).
component("YLR172C",449).
component("YMR120C",490).
component("YBL013W",118).
component("YJL130C",379).
component("YJL088W",374).
component("YPR074C",612).
component("YBR117C",143).
component("YMR108W",489).
component("YCL009C",159).
component("YMR062C",486).
component("YNL071W",508).
component("YIL160C",364).
component("YNR019W",533).
component("YCR048W",171).
component("U48_",85).
component("YNL277W",524).
component("YFL017C",272).
component("YPL231W",595).
component("YER061C",255).
component("U86_",108).
component("YDL052C",177).
component("U8_",110).
component("YDR148C",220).
component("YOR377W",578).
component("YGR177C",314).
component("YPL231W",596).
component("YLR195C",452).
component("YLR299W",457).
component("YPR001W",604).
component("YNR001C",529).
component("YCR005C",167).
component("YML126C",480).
component("YDL182W",196).
component("YDL131W",188).
component("YNL117W",512).
component("YIR031C",368).
component("YOR321W",568).
component("YJR143C",403).
component("YGR199W",319).
component("YDL095W",184).
component("YDL093W",183).
component("YAL023C",114).
component("YPL227C",592).
component("YMR261C",501).
component("YML100W",477).
component("YBR126C",145).
component("YNL192W",519).
component("YBR038W",134).
component("YBR023C",131).
component("YLR209C",453).
component("U104_",23).
component("YDR354W",227).
component("YFR047C",281).
component("YJR133W",401).
component("U22_",69).
component("YDR399W",229).
component("YJL167W",386).
component("YNL256W",521).
component("YPR069C",611).
component("YDR127W",215).
component("YHR190W",349).
component("YHR068W",339).
component("YLR303W",458).
component("YML082W",476).
component("YJR130C",400).
component("YDR035W",204).
component("YBR249C",153).
component("YLR180W",451).
component("YDR502C",238).
component("YBR256C",155).
component("YHR137W",343).
component("YGL202W",299).
component("YLR027C",434).
component("YKL106W",411).
component("YOL140W",551).
component("YLR438W",470).
component("YKL104C",410).
component("YDR111C",212).
component("U51_",88).
component("YJR148W",404).
component("YHR208W",352).
component("YOR184W",561).
component("YGL253W",303).
component("YFR053C",282).
component("YMR013C",483).
component("YLR240W",455).
component("YKL203C",422).
component("YJR066W",395).
component("YCR036W",170).
component("YGR194C",318).
component("YCL040W",164).
component("YJR105W",399).
component("U16_",47).
component("YKL001C",407).
component("YML070W",475).
component("YFL053W",276).
component("U82_",107).
component("U81_",106).
component("YMR208W",495).
component("YPL203W",591).
component("YOR061W",552).
component("YKL166C",416).
component("YJL164C",385).
component("YIL035C",355).
component("YHR205W",351).
component("YHR102W",341).
component("YGL019W",286).
component("YHR025W",332).
component("YNR012W",531).
component("YPR121W",614).
component("YPL258C",598).
component("YOL055C",543).
component("U1_",59).
component("YBR020W",130).
component("YFR019W",279).
component("YDR208W",222).
component("YDR127W",216).
component("U21_",66).
component("YDR147W",219).
component("YCR012W",168).
component("YER052C",251).
component("U19_",58).
component("U18_",54).
component("U17_",51).
component("U76_",103).
component("YMR220W",497).
component("YER170W",270).
component("YDR226W",223).
component("YKL067W",409).
component("YOL055C",544).
component("YDR454C",236).
component("YOL061W",546).
component("YKL181W",417).
component("YHL011C",327).
component("YER099C",266).
component("YBL068W",124).
component("YOR143C",558).
component("YNL256W",522).
component("YBR018C",128).
component("YDL055C",178).
component("YLR328W",461).
component("YDL103C",186).
component("U94_",112).
component("YJR010W",390).
component("YBR029C",132).
component("YPR190C",619).
component("YPR187W",618).
component("YPR110C",613).
component("YPR010C",606).
component("YOR341W",573).
component("YOR340C",572).
component("YOR224C",564).
component("YOR210W",563).
component("YOR207C",562).
component("YOR151C",559).
component("YOR116C",554).
component("YOL005C",538).
component("YNR003C",530).
component("YNL248C",520).
component("YNL151C",517).
component("YNL113W",511).
component("YKL144C",414).
component("YJR063W",394).
component("YJL148W",382).
component("YJL140W",381).
component("YIL021W",354).
component("YHR143W-A",344).
component("YGL070C",292).
component("YFL036W",275).
component("YDR404C",232).
component("YDR156W",221).
component("YDR045C",206).
component("YDL150W",195).
component("YDL140C",190).
component("YBR154C",147).
component("YPR175W",617).
component("YPL167C",589).
component("YOR330C",570).
component("YOL115W",550).
component("YNL299W",527).
component("YNL262W",523).
component("YNL102W",510).
component("YJR043C",392).
component("YJR006W",388).
...
component("YCR014C",169).
component("YBR278W",156).
component("YBL035C",120).
component("YKL035W",408).
component("YHL012W",328).
component("YHR123W",342).
component("YNL130C",513).
component("YPL148C",587).
component("YOR251C",566).
component("YGR286C",326).
component("YDR058C",208).
component("YOL011W",540).
component("YMR008C",482).
component("YMR006C",481).
component("U105_",24).
component("U101_",21).
component("YJL068C",372).
component("YPL072W",583).
component("YOR124C",555).
component("YNL186W",518).
component("YMR304W",503).
component("YMR223W",498).
component("YKR098C",431).
component("YJL197W",387).
component("YIL156W",363).
component("YFR010W",278).
component("YER151C",269).
component("YER144C",268).
component("YER098W",265).
component("YDR069C",209).
component("YDL122W",187).
component("YBR058C",136).
component("YBL067C",123).
component("YJR019C",391).
component("YDR074W",210).
component("YFR025C",280).
component("YPL179W",590).
component("YNR032W",534).
component("YML057W",474).
component("YML016C",471).
component("YLR433C",469).
component("YGR123C",309).
component("YER133W",267).
component("YER089C",262).
component("YDR436W",235).
component("YDR075W",211).
component("YDL188C",197).
component("YDL134C",189).
component("YDL047W",176).
component("YDL006W",173).
component("YBR125C",144).
component("YBL056W",122).
component("YIL053W",357).
component("YER062C",256).
component("YHR046C",336).
component("U9_",113).
component("YGR208W",321).
component("YPL228W",593).
component("YMR180C",492).
...
component("YOL064C",547).
component("YPL268W",601).
component("YOR360C",575).
component("YGL248W",302).
component("YKR031C",427).
component("YGL027C",288).
component("YLR286C",456).
component("YJR153W",405).
component("YBR184W",149).
component("YIL162W",365).
component("YPR026W",607).
component("YDR001C",201).
component("YBR001C",127).
component("YDR400W",230).
component("U102_",22).
component("YER043C",250).
component("YNL045W",506).
component("YLR160C",448).
component("YLR158C",447).
component("YLR157C",446).
component("YLR155C",445).
component("YDR321W",226).
component("YGL037C",289).
component("U43_",83).
component("U42_",82).
component("YLR308W",460).
component("YLR307W",459).
component("U53_",89).
component("YLR420W",467).
component("YPL111W",585).
component("YIR032C",369).
component("YLR028C",435).
component("YHR144C",345).
component("YHR144C",346).
component("YNL141W",514).
component("YBR153W",146).
component("YDL238C",200).
component("YNL141W",515).
component("YBR084W",140).
component("YJL126W",377).
component("U44_",84).
component("YHR201C",350).
component("YBR111C",142).
component("YBR252W",154).
component("YCL030C",163).
component("YER005W",247).
component("YBL099W",126).
component("YLR231C",454).
component("U88_",109).
component("YDR538W",242).
component("YLR134W",442).
component("YLR044C",437).
component("YGR087C",306).
component("YDR380W",228).
component("YDL080C",181).
component("YMR250W",499).
component("YKL184W",419).
component("YEL021W",243).
component("YNR043W",536).
component("YKL211C",423).
component("YKR097W",430).
component("YOL052C",542).
component("YDR294C",224).
component("YNR033W",535).
component("YPR006C",605).
component("YER065C",257).
component("YKL211C",424).
component("YER090W",263).
component("YDR127W",217).
component("YPL281C",603).
component("YOR393W",579).
component("YMR323W",504).
component("YHR174W",347).
component("YGR254W",322).
component("YGL026C",287).
component("YGR155W",312).
component("YNL316C",528).
component("YCR053W",172).
component("YDR127W",218).
component("YGL148W",294).
component("YIL168W",367).
component("YIL167W",366).
component("YCL064C",165).
component("YCL064C",166).
component("YLR359W",464).
component("YFR055W",283).
component("YJL121C",376).
component("YBR019C",129).
component("YDR007W",202).
component("YOR095C",553).
component("YBR196C",150).
component("YGL001C",285).
component("YPL117C",586).
component("U14_",39).
component("YMR105C",488).
component("YKL127W",412).
component("YEL058W",246).
component("YPR060C",610).
component("YHR072W",340).
component("YJL153C",383).
component("YGR264C",325).
component("YGR171C",313).
component("YHR011W",329).
component("YDR023W",203).
component("YHR020W",331).
component("YER087W",261).
component("YGL245W",301).
component("YOR168W",560).
component("YPR047W",609).
component("YLR060W",439).
component("YFL022C",274).
component("YPR033C",608).
component("YHR019C",330).
component("YKL194C",421).
component("YIL078W",359).
component("YPL160W",588).
component("YLR382C",465).
component("YPL040C",582).
component("YBL076C",125).
component("YNL073W",509).
component("YDR037W",205).
component("YOR335C",571).
component("YGR094W",307).
component("YGL234W",300).
component("YER183C",271).
component("U90_",111).
component("YNR057C",537).
component("YDL141W",191).
component("YDL141W",192).
component("YDL141W",193).
component("YDL141W",194).
component("YMR217W",496).
component("YPR145W",616).
component("YGR124W",310).
component("YOR303W",567).
component("YGL062W",291).
component("YBR218C",151).
component("YPL231W",597).
component("YNR016C",532).
component("YKL182W",418).
component("YGR037C",304).
component("YJL087C",373).
component("YOL010W",539).
component("YPR138C",615).
component("YPL265W",599).
component("YOR348C",574).
component("YOR130C",556).
component("YOL103W",549).
component("YOL020W",541).
component("YNL142W",516).
component("YMR272C",502).
component("YMR202W",494).
component("YMR056C",485).
component("YML123C",479).
component("YLR348C",462).
component("YLR138W",443).
component("YLR100C",441).
component("YLR092W",440).
component("YLL061W",432).
component("YKR053C",429).
component("YKR039W",428).
component("YKL217W",425).
component("YJR077C",397).
component("YJL134W",380).
component("YJL129C",378).
component("YGR191W",316).
component("YGR125W",311).
component("YGR121C",308).
component("YGR065C",305).
component("YGL186C",296).
component("YFL055W",277).
...
component("YDR046C",207).
component("YDL210W",198).
component("YCL025C",161).
component("YBR294W",158).
component("YBR291C",157).
component("YBR085W",141).
component("YBR069C",138).
component("YBR068C",137).
component("YBL042C",121).
component("YBL030C",119).
component("U7_",105).
component("U79_",104).
component("U75_",102).
component("U74_",101).
