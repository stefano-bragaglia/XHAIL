...
component("YNL280C",338).
component("YLR056W",282).
component("YMR083W",311).
component("YPL231W",382).
component("YJR159W",260).
component("YGL001C",185).
component("YDR127W",136).
component("YJR139C",257).
component("YNL009W",326).
component("YLR174W",289).
component("YHR183W",224).
component("YGR256W",207).
component("YCL018W",100).
component("YJR078W",253).
component("YMR015C",308).
component("YDR402C",150).
component("YGL055W",189).
component("YJL026W",233).
component("YGR180C",204).
component("U68_",64).
component("U55_",61).
component("YER069W",168).
component("YOR323C",368).
component("YBR166C",93).
component("YNL280C",339).
component("YKL141W",265).
component("YOR375C",373).
component("YDL215C",126).
component("YAL062W",74).
component("U100_",20).
component("YBR035C",82).
component("YMR189W",315).
component("U56_",62).
component("YPL023C",375).
component("YGL125W",191).
component("YOR236W",366).
component("YMR145C",314).
component("YDL085W",112).
component("YBR046C",83).
component("YPL091W",378).
component("YNL052W",327).
component("YMR256C",321).
component("YLR395C",299).
component("YLR038C",280).
component("YIL111W",229).
component("YHR051W",216).
component("YGL191W",195).
component("YGL187C",194).
component("YDL067C",110).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",387).
component("YLL062C",277).
component("YDR410C",152).
component("YER091C",170).
component("YJR073C",251).
component("YOL096C",353).
component("YMR120C",313).
component("YJL130C",239).
component("YJL088W",235).
component("YPR074C",393).
component("YBR117C",89).
component("YCL009C",99).
component("YMR062C",310).
component("YNL071W",328).
component("YNR019W",345).
component("YCR048W",107).
component("U48_",58).
component("YFL017C",176).
component("YPL231W",383).
component("YDL052C",109).
component("U8_",70).
component("YPL231W",384).
component("YLR299W",293).
component("YCR005C",104).
component("YML126C",304).
component("YDL182W",124).
component("YDL131W",117).
component("YNL117W",331).
component("YIR031C",232).
component("YOR321W",367).
component("YJR143C",258).
component("YGR199W",205).
component("YDL095W",114).
component("YDL093W",113).
component("YAL023C",73).
component("YMR261C",322).
component("YML100W",302).
component("YBR126C",90).
component("YLR209C",290).
component("YDR354W",147).
component("YFR047C",183).
component("YJR133W",256).
component("U22_",49).
component("YDR399W",149).
component("YPR069C",392).
component("YDR127W",137).
component("YML082W",301).
component("YJR130C",255).
component("YDR035W",130).
component("YBR249C",95).
component("YBR256C",96).
component("YHR137W",219).
component("YGL202W",196).
component("YLR027C",278).
component("YKL106W",263).
component("YOL140W",356).
component("YLR438W",300).
component("YDR111C",134).
component("U51_",59).
component("YJR148W",259).
component("YMR013C",307).
component("YCR036W",106).
component("YCL040W",103).
component("YJR105W",254).
component("U81_",69).
component("YMR208W",317).
component("YPL203W",381).
component("YOR061W",357).
component("YKL166C",267).
component("YJL164C",245).
component("YIL035C",228).
component("YHR205W",226).
component("YHR102W",218).
component("YGL019W",186).
component("YHR025W",213).
component("YNR012W",343).
component("YFR019W",181).
component("YDR208W",143).
component("YDR127W",138).
component("U21_",46).
component("YDR147W",141).
component("YER052C",164).
component("U19_",42).
component("U18_",38).
component("U76_",67).
component("YMR220W",318).
component("YDR226W",144).
component("YKL067W",262).
component("YDR454C",154).
component("YOL061W",352).
component("YKL181W",268).
component("YHL011C",209).
component("YER099C",172).
component("YBL068W",79).
component("YOR143C",361).
component("YLR328W",296).
component("U94_",71).
component("YBR029C",81).
component("YPR190C",399).
component("YPR187W",398).
component("YPR110C",394).
component("YPR010C",389).
component("YOR341W",371).
component("YOR340C",370).
component("YOR224C",365).
component("YOR210W",364).
component("YOR207C",363).
component("YOR151C",362).
component("YOR116C",359).
component("YOL005C",348).
component("YNR003C",342).
component("YNL248C",336).
component("YNL151C",334).
component("YNL113W",330).
component("YKL144C",266).
component("YJR063W",250).
component("YJL148W",242).
component("YJL140W",241).
component("YIL021W",227).
component("YHR143W-A",220).
component("YGL070C",190).
component("YFL036W",178).
component("YDR404C",151).
component("YDR156W",142).
component("YDR045C",131).
component("YDL150W",123).
component("YDL140C",118).
component("YBR154C",92).
component("YPR175W",397).
component("YPL167C",380).
component("YOR330C",369).
component("YOL115W",355).
component("YNL299W",340).
component("YNL262W",337).
component("YNL102W",329).
component("YJR043C",249).
component("YJR006W",247).
component("YJL090C",236).
component("YIL139C",230).
component("YEL055C",161).
component("YDR419W",153).
component("YDR121W",135).
component("YDL102W",115).
component("YCR014C",105).
component("YBR278W",97).
component("YBL035C",76).
component("YKL035W",261).
component("YHL012W",210).
component("YOL011W",350).
component("YMR008C",306).
component("YMR006C",305).
component("U105_",21).
component("YPL072W",377).
component("YOR124C",360).
component("YNL186W",335).
component("YMR304W",324).
component("YMR223W",319).
component("YKR098C",276).
component("YJL197W",246).
component("YIL156W",231).
component("YFR010W",180).
component("YER151C",174).
component("YER144C",173).
component("YER098W",171).
component("YDR069C",133).
component("YDL122W",116).
component("YBR058C",84).
component("YBL067C",78).
component("YJR019C",248).
component("YFR025C",182).
component("U9_",72).
component("YJL155C",244).
component("U34_",54).
component("U33_",53).
component("U32_",52).
component("U30_",51).
component("U24_",50).
component("YHR044C",215).
component("YHR043C",214).
component("YLR286C",292).
component("YLR160C",288).
component("YLR158C",287).
component("YLR157C",286).
component("YLR155C",285).
component("YDR321W",146).
component("YGL037C",188).
component("U43_",56).
component("U42_",55).
component("YLR308W",295).
component("YLR307W",294).
component("U53_",60).
component("YLR028C",279).
component("YHR144C",221).
component("YHR144C",222).
component("YBR153W",91).
component("YDL238C",127).
component("YNL141W",332).
component("YJL126W",238).
component("U44_",57).
component("YHR201C",225).
component("YBR111C",88).
component("YCL030C",102).
component("YER005W",163).
component("YLR231C",291).
component("YDR538W",159).
component("YLR134W",284).
component("YLR044C",281).
component("YGR087C",199).
component("YDR380W",148).
component("YDL080C",111).
component("YMR250W",320).
component("YKL184W",270).
component("YEL021W",160).
component("YKL211C",271).
component("YNR033W",346).
component("YKL211C",272).
component("YER090W",169).
component("YDR127W",139).
component("YPL281C",388).
component("YOR393W",374).
component("YMR323W",325).
component("YHR174W",223).
component("YGR254W",206).
component("YGL026C",187).
component("YGR155W",202).
component("YNL316C",341).
component("YCR053W",108).
component("YDR127W",140).
component("YGL148W",192).
component("YFR055W",184).
component("YJL121C",237).
component("YDR007W",128).
component("YOR095C",358).
component("YBR196C",94).
component("U14_",30).
component("YMR105C",312).
component("YKL127W",264).
component("YEL058W",162).
component("YPR060C",391).
component("YHR072W",217).
component("YJL153C",243).
component("YGR264C",208).
component("YGR171C",203).
component("YHR011W",211).
component("YDR023W",129).
component("YGL245W",197).
component("YPR047W",390).
component("YLR060W",283).
component("YFL022C",177).
component("YHR019C",212).
component("YPL160W",379).
component("YLR382C",298).
component("YPL040C",376).
component("YBL076C",80).
component("YER183C",175).
component("YNR057C",347).
component("YDL141W",119).
component("YDL141W",120).
component("YDL141W",121).
component("YDL141W",122).
component("YPR145W",396).
component("YGR124W",201).
component("YPL231W",385).
component("YNR016C",344).
component("YKL182W",269).
component("YGR037C",198).
component("YJL087C",234).
component("YOL010W",349).
component("YPR138C",395).
component("YPL265W",386).
component("YOR348C",372).
component("YOL103W",354).
component("YOL020W",351).
component("YNL142W",333).
component("YMR272C",323).
component("YMR202W",316).
component("YMR056C",309).
component("YML123C",303).
component("YLR348C",297).
component("YKR053C",275).
component("YKR039W",274).
component("YKL217W",273).
component("YJR077C",252).
component("YJL134W",240).
component("YGR121C",200).
component("YGL186C",193).
component("YFL055W",179).
component("YER060W-A",167).
component("YER060W",166).
component("YER056C",165).
component("YDR536W",158).
component("YDR508C",157).
component("YDR503C",156).
component("YDR497C",155).
component("YDR294C",145).
component("YDR046C",132).
component("YDL210W",125).
component("YCL025C",101).
component("YBR291C",98).
component("YBR085W",87).
component("YBR069C",86).
component("YBR068C",85).
component("YBL042C",77).
component("YBL030C",75).
component("U7_",68).
component("U6_",66).
component("U69_",65).
component("U5_",63).
