...
component("YNL280C",345).
component("YLR056W",287).
component("YMR083W",318).
component("YPL231W",390).
component("YJR159W",265).
component("YGL001C",189).
component("YDR127W",139).
component("YJR139C",262).
component("YNL009W",333).
component("YLR174W",296).
component("YHR183W",229).
component("YGR256W",212).
component("YCL018W",102).
component("YJR078W",258).
component("YMR015C",315).
component("YDR402C",153).
component("YGL055W",194).
component("YJL026W",238).
component("YGR180C",209).
component("YOR374W",380).
component("YER073W",172).
component("U68_",65).
component("U55_",61).
component("YER069W",171).
component("YOR323C",375).
component("YBR166C",95).
component("YNL280C",346).
component("YKL141W",270).
component("YOR375C",381).
component("YDL215C",128).
component("YAL062W",76).
component("U100_",20).
component("YBR035C",84).
component("YMR189W",322).
component("U56_",62).
component("YPL023C",383).
component("YGL125W",196).
component("YOR236W",373).
component("YLR142W",291).
component("U65_",64).
component("YMR145C",321).
component("YDL085W",114).
component("YBR046C",85).
component("YPL091W",386).
component("YNL052W",334).
component("YMR256C",328).
component("YLR395C",306).
component("YLR038C",285).
component("YIL111W",234).
component("YHR051W",221).
component("YGL191W",200).
component("YGL187C",199).
component("YDL067C",112).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",395).
component("YLL062C",282).
component("YDR410C",155).
component("YER091C",174).
component("YJR073C",256).
component("YOL096C",360).
component("YMR120C",320).
component("YJL130C",244).
component("YJL088W",240).
component("YPR074C",401).
component("YBR117C",91).
component("YCL009C",101).
component("YMR062C",317).
component("YNL071W",335).
component("YNR019W",352).
component("YCR048W",109).
component("U48_",58).
component("YFL017C",180).
component("YPL231W",391).
component("YDL052C",111).
component("U8_",71).
component("YPL231W",392).
component("YLR299W",300).
component("YCR005C",106).
component("YML126C",311).
component("YDL182W",126).
component("YDL131W",119).
component("YNL117W",338).
component("YIR031C",237).
component("YOR321W",374).
component("YJR143C",263).
component("YGR199W",210).
component("YDL095W",116).
component("YDL093W",115).
component("YAL023C",75).
component("YMR261C",329).
component("YML100W",309).
component("YBR126C",92).
component("YLR209C",297).
component("YDR354W",150).
component("YFR047C",187).
component("YJR133W",261).
component("U22_",49).
component("YDR399W",152).
component("YPR069C",400).
component("YDR127W",140).
component("YML082W",308).
component("YJR130C",260).
component("YDR035W",132).
component("YBR249C",97).
component("YBR256C",98).
component("YHR137W",224).
component("YGL202W",201).
component("YLR027C",283).
component("YKL106W",268).
component("YOL140W",363).
component("YLR438W",307).
component("YDR111C",137).
component("U51_",59).
component("YJR148W",264).
component("YMR013C",314).
component("YCR036W",108).
component("YCL040W",105).
component("YJR105W",259).
component("U81_",70).
component("YMR208W",324).
component("YPL203W",389).
component("YOR061W",364).
component("YKL166C",272).
component("YJL164C",250).
component("YIL035C",233).
component("YHR205W",231).
component("YHR102W",223).
component("YGL019W",190).
component("YHR025W",218).
component("YNR012W",350).
component("YFR019W",185).
component("YDR208W",146).
component("YDR127W",141).
component("U21_",46).
component("YDR147W",144).
component("YER052C",167).
component("U19_",42).
component("U18_",38).
component("U76_",68).
component("YMR220W",325).
component("YDR226W",147).
component("YKL067W",267).
component("YDR454C",157).
component("YOL061W",359).
component("YKL181W",273).
component("YHL011C",214).
component("YER099C",176).
component("YBL068W",81).
component("YOR143C",368).
component("YLR328W",303).
component("U94_",73).
component("YBR029C",83).
component("YPR190C",407).
component("YPR187W",406).
component("YPR110C",402).
component("YPR010C",397).
component("YOR341W",378).
component("YOR340C",377).
component("YOR224C",372).
component("YOR210W",371).
component("YOR207C",370).
component("YOR151C",369).
component("YOR116C",366).
component("YOL005C",355).
component("YNR003C",349).
component("YNL248C",343).
component("YNL151C",341).
component("YNL113W",337).
component("YKL144C",271).
component("YJR063W",255).
component("YJL148W",247).
component("YJL140W",246).
component("YIL021W",232).
component("YHR143W-A",225).
component("YGL070C",195).
component("YFL036W",182).
component("YDR404C",154).
component("YDR156W",145).
component("YDR045C",133).
component("YDL150W",125).
component("YDL140C",120).
component("YBR154C",94).
component("YPR175W",405).
component("YPL167C",388).
component("YOR330C",376).
component("YOL115W",362).
component("YNL299W",347).
component("YNL262W",344).
component("YNL102W",336).
component("YJR043C",254).
component("YJR006W",252).
component("YJL090C",241).
component("YIL139C",235).
component("YEL055C",164).
component("YDR419W",156).
component("YDR121W",138).
component("YDL102W",117).
component("YCR014C",107).
component("YBR278W",99).
component("YBL035C",78).
component("YKL035W",266).
component("YHL012W",215).
component("YOL011W",357).
component("YMR008C",313).
component("YMR006C",312).
component("U105_",21).
component("YPL072W",385).
component("YOR124C",367).
component("YNL186W",342).
component("YMR304W",331).
component("YMR223W",326).
component("YKR098C",281).
component("YJL197W",251).
component("YIL156W",236).
component("YFR010W",184).
component("YER151C",178).
component("YER144C",177).
component("YER098W",175).
component("YDR069C",135).
component("YDL122W",118).
component("YBR058C",86).
component("YBL067C",80).
component("YJR019C",253).
component("YDR074W",136).
component("YFR025C",186).
component("U9_",74).
component("YJL155C",249).
component("U34_",54).
component("U33_",53).
component("U32_",52).
component("U30_",51).
component("U24_",50).
component("YHR044C",220).
component("YHR043C",219).
component("YGL027C",192).
component("YLR286C",299).
component("YLR160C",295).
component("YLR158C",294).
component("YLR157C",293).
component("YLR155C",292).
component("YDR321W",149).
component("YGL037C",193).
component("U43_",56).
component("U42_",55).
component("YLR308W",302).
component("YLR307W",301).
component("U53_",60).
component("YLR028C",284).
component("YHR144C",226).
component("YHR144C",227).
component("YBR153W",93).
component("YDL238C",129).
component("YNL141W",339).
component("YJL126W",243).
component("U44_",57).
component("YHR201C",230).
component("YBR111C",90).
component("YCL030C",104).
component("YER005W",166).
component("YLR231C",298).
component("YDR538W",162).
component("YLR134W",290).
component("YLR044C",286).
component("YGR087C",204).
component("YDR380W",151).
component("YDL080C",113).
component("YMR250W",327).
component("YKL184W",275).
component("YEL021W",163).
component("YKL211C",276).
component("YNR033W",353).
component("YKL211C",277).
component("YER090W",173).
component("YDR127W",142).
component("YPL281C",396).
component("YOR393W",382).
component("YMR323W",332).
component("YHR174W",228).
component("YGR254W",211).
component("YGL026C",191).
component("YGR155W",207).
component("YNL316C",348).
component("YCR053W",110).
component("YDR127W",143).
component("YGL148W",197).
component("YFR055W",188).
component("YJL121C",242).
component("YDR007W",130).
component("YOR095C",365).
component("YBR196C",96).
component("U14_",30).
component("YMR105C",319).
component("YKL127W",269).
component("YEL058W",165).
component("YPR060C",399).
component("YHR072W",222).
component("YJL153C",248).
component("YGR264C",213).
component("YGR171C",208).
component("YHR011W",216).
component("YDR023W",131).
component("YGL245W",202).
component("YPR047W",398).
component("YLR060W",288).
component("YFL022C",181).
component("YHR019C",217).
component("YPL160W",387).
component("YLR382C",305).
component("YPL040C",384).
component("YBL076C",82).
component("YER183C",179).
component("U90_",72).
component("YNR057C",354).
component("YDL141W",121).
component("YDL141W",122).
component("YDL141W",123).
component("YDL141W",124).
component("YPR145W",404).
component("YGR124W",206).
component("YPL231W",393).
component("YNR016C",351).
component("YKL182W",274).
component("YGR037C",203).
component("YJL087C",239).
component("YOL010W",356).
component("YPR138C",403).
component("YPL265W",394).
component("YOR348C",379).
component("YOL103W",361).
component("YOL020W",358).
component("YNL142W",340).
component("YMR272C",330).
component("YMR202W",323).
component("YMR056C",316).
component("YML123C",310).
component("YLR348C",304).
component("YLR100C",289).
component("YKR053C",280).
component("YKR039W",279).
component("YKL217W",278).
component("YJR077C",257).
component("YJL134W",245).
component("YGR121C",205).
component("YGL186C",198).
component("YFL055W",183).
component("YER060W-A",170).
component("YER060W",169).
component("YER056C",168).
component("YDR536W",161).
component("YDR508C",160).
component("YDR503C",159).
component("YDR497C",158).
component("YDR294C",148).
component("YDR046C",134).
component("YDL210W",127).
component("YCL025C",103).
component("YBR291C",100).
component("YBR085W",89).
component("YBR069C",88).
component("YBR068C",87).
component("YBL042C",79).
component("YBL030C",77).
component("U7_",69).
component("U6_",67).
component("U69_",66).
component("U5_",63).
