...
component("YNL280C",234).
component("YLR056W",199).
component("YGL001C",134).
component("YDR127W",95).
component("YNL009W",226).
component("YLR174W",206).
component("YHR183W",164).
component("YGR256W",151).
component("YCL018W",70).
component("YJR078W",180).
component("YMR015C",217).
component("YDR402C",107).
component("YGL055W",137).
component("YJL026W",169).
component("YGR180C",148).
component("YOR323C",252).
component("YBR166C",66).
component("YNL280C",235).
component("YKL141W",187).
component("YOR375C",255).
component("YDL215C",88).
component("YAL062W",52).
component("U100_",18).
component("YPL023C",257).
component("YGL125W",138).
component("YMR145C",219).
component("YDL085W",80).
component("YBR046C",59).
component("YPL273W",265).
component("YLL062C",196).
component("YDR410C",108).
component("YJR073C",178).
component("YOL096C",246).
component("YJL088W",171).
component("YPR074C",270).
component("YBR117C",64).
component("YNL071W",227).
component("YNR019W",240).
component("YCR048W",76).
component("U48_",43).
component("YPL231W",261).
component("YDL052C",78).
component("U8_",49).
component("YPL231W",262).
component("YLR299W",208).
component("YCR005C",73).
component("YNL117W",229).
component("YIR031C",168).
component("YOR321W",251).
component("YJR143C",183).
component("YGR199W",149).
component("YDL095W",82).
component("YDL093W",81).
component("YAL023C",51).
component("YDR354W",104).
component("YFR047C",132).
component("U22_",37).
component("YDR399W",106).
component("YPR069C",269).
component("YDR127W",96).
component("YML082W",213).
component("YJR130C",182).
component("YDR035W",91).
component("YBR249C",68).
component("YHR137W",160).
component("YGL202W",141).
component("YLR027C",197).
component("YKL106W",185).
component("YLR438W",212).
component("U51_",44).
component("YMR013C",216).
component("YCR036W",75).
component("YCL040W",72).
component("YJR105W",181).
component("YMR208W",221).
component("YHR025W",156).
component("YNR012W",238).
component("YFR019W",130).
component("YDR208W",101).
component("YDR127W",97).
component("YDR147W",100).
component("YER052C",117).
component("U19_",32).
component("U76_",48).
...
component("YHL011C",153).
component("YER099C",123).
component("YBL068W",56).
component("YLR328W",211).
component("YBR029C",58).
component("YPR175W",273).
component("YPL167C",260).
component("YOR330C",253).
component("YOL115W",248).
component("YNL299W",236).
component("YNL262W",233).
component("YNL102W",228).
component("YJR043C",177).
component("YJR006W",176).
component("YJL090C",172).
component("YIL139C",166).
component("YEL055C",115).
component("YDR419W",109).
component("YDR121W",94).
component("YDL102W",83).
component("YCR014C",74).
component("YBR278W",69).
component("YBL035C",53).
component("YKL035W",184).
component("YHL012W",154).
component("YOL011W",243).
component("YMR008C",215).
component("YMR006C",214).
component("U105_",19).
component("YPL072W",259).
component("YOR124C",250).
component("YNL186W",232).
component("YMR304W",224).
component("YMR223W",222).
component("YKR098C",195).
component("YJL197W",175).
component("YIL156W",167).
component("YFR010W",129).
component("YER151C",125).
component("YER144C",124).
component("YER098W",122).
component("YDR069C",93).
component("YDL122W",84).
component("YBR058C",60).
component("YBL067C",55).
component("YFR025C",131).
component("U9_",50).
component("U32_",39).
component("U30_",38).
component("YHR044C",158).
component("YHR043C",157).
component("YLR160C",205).
component("YLR158C",204).
component("YLR157C",203).
component("YLR155C",202).
component("YDR321W",103).
component("YGL037C",136).
component("U43_",41).
component("U42_",40).
component("YLR308W",210).
component("YLR307W",209).
component("U53_",45).
component("YHR144C",161).
component("YHR144C",162).
component("YBR153W",65).
component("YDL238C",89).
component("YNL141W",230).
component("U44_",42).
component("YHR201C",165).
component("YBR111C",63).
component("YER005W",116).
component("YLR231C",207).
component("YLR134W",201).
component("YLR044C",198).
component("YGR087C",144).
component("YDR380W",105).
component("YDL080C",79).
component("YMR250W",223).
component("YKL184W",190).
component("YEL021W",114).
component("YKL211C",191).
component("YNR033W",241).
component("YKL211C",192).
component("YER090W",121).
component("YDR127W",98).
component("YPL281C",266).
component("YOR393W",256).
component("YMR323W",225).
component("YHR174W",163).
component("YGR254W",150).
component("YGL026C",135).
component("YNL316C",237).
component("YCR053W",77).
component("YDR127W",99).
component("YGL148W",139).
component("YFR055W",133).
component("YDR007W",90).
component("YOR095C",249).
component("YBR196C",67).
component("U14_",25).
component("YMR105C",218).
component("YKL127W",186).
component("YPR060C",268).
component("YHR072W",159).
component("YJL153C",174).
component("YGR264C",152).
component("YGR171C",147).
component("YGL245W",142).
component("YPR047W",267).
component("YLR060W",200).
component("YFL022C",127).
component("YHR019C",155).
component("YPL040C",258).
component("YBL076C",57).
component("YER183C",126).
component("YDL141W",85).
component("YDL141W",86).
component("YPR145W",272).
component("YGR124W",146).
component("YPL231W",263).
component("YNR016C",239).
component("YKL182W",189).
component("YGR037C",143).
component("YJL087C",170).
component("YOL010W",242).
component("YPR138C",271).
component("YPL265W",264).
component("YOR348C",254).
component("YOL103W",247).
component("YOL020W",244).
component("YNL142W",231).
component("YMR202W",220).
component("YKR053C",194).
component("YKR039W",193).
component("YJR077C",179).
component("YJL134W",173).
component("YGR121C",145).
component("YGL186C",140).
component("YFL055W",128).
...
component("YDR046C",92).
component("YDL210W",87).
component("YCL025C",71).
component("YBR069C",62).
component("YBR068C",61).
component("YBL042C",54).
component("U6_",47).
component("U5_",46).
component("U228_",36).
component("U222_",35).
