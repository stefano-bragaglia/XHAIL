...
component("YNL280C",176).
component("YLR056W",153).
component("YGL001C",107).
component("YDR127W",75).
component("YNL009W",169).
component("YLR174W",155).
component("YHR183W",128).
component("YGR256W",119).
component("YCL018W",54).
component("YJR078W",139).
component("YGL055W",110).
component("YOR323C",189).
component("YBR166C",50).
component("YNL280C",177).
component("YKL141W",144).
component("YOR375C",191).
component("YAL062W",38).
component("U100_",18).
component("YMR145C",162).
component("YDL085W",62).
component("YBR046C",43).
component("YDR410C",84).
component("YJL088W",132).
component("YPR074C",202).
component("YBR117C",48).
component("YNL071W",170).
component("YNR019W",180).
component("YCR048W",59).
component("U48_",32).
component("YPL231W",195).
component("YPL231W",196).
component("YLR299W",157).
component("YCR005C",56).
component("YOR321W",188).
component("YJR143C",142).
component("YGR199W",117).
component("YDL095W",64).
component("YDL093W",63).
component("YAL023C",37).
component("YDR354W",82).
component("YFR047C",105).
component("U22_",29).
component("YPR069C",201).
component("YDR127W",76).
component("YML082W",160).
component("YJR130C",141).
component("YDR035W",71).
component("YBR249C",52).
component("YHR137W",125).
component("YGL202W",113).
component("YLR027C",152).
component("YKL106W",143).
component("YLR438W",159).
component("U51_",33).
component("YMR013C",161).
component("YCR036W",58).
component("YJR105W",140).
component("YMR208W",164).
component("YHR025W",122).
component("YFR019W",104).
component("YDR208W",80).
component("YDR127W",77).
component("YER052C",91).
component("U19_",26).
component("YDR226W",81).
component("YDR454C",86).
component("YOL061W",184).
component("YKL181W",145).
component("YHL011C",121).
component("YER099C",97).
component("YBL068W",42).
component("YLR328W",158).
component("YPR175W",204).
component("YPL167C",194).
component("YOR330C",190).
component("YOL115W",185).
component("YNL299W",178).
component("YNL262W",175).
component("YNL102W",171).
component("YJR043C",137).
component("YJR006W",136).
component("YJL090C",133).
component("YIL139C",129).
component("YEL055C",89).
component("YDR419W",85).
component("YDR121W",74).
component("YDL102W",65).
component("YCR014C",57).
component("YBR278W",53).
component("YBL035C",39).
component("YPL072W",193).
component("YOR124C",187).
component("YNL186W",174).
component("YMR304W",167).
component("YMR223W",165).
component("YKR098C",151).
component("YJL197W",135).
component("YIL156W",130).
component("YFR010W",103).
component("YER151C",99).
component("YER144C",98).
component("YER098W",96).
component("YDR069C",73).
component("YDL122W",66).
component("YBR058C",44).
component("YBL067C",41).
component("U32_",31).
component("U30_",30).
component("YHR044C",124).
component("YHR043C",123).
component("YGL037C",109).
component("U53_",34).
component("YHR144C",126).
component("YBR153W",49).
component("YNL141W",172).
component("YBR111C",47).
component("YER005W",90).
component("YLR231C",156).
component("YDR380W",83).
component("YDL080C",61).
component("YMR250W",166).
component("YKL184W",146).
component("YKL211C",147).
component("YNR033W",181).
component("YKL211C",148).
component("YER090W",95).
component("YDR127W",78).
component("YPL281C",198).
component("YOR393W",192).
component("YMR323W",168).
component("YHR174W",127).
component("YGR254W",118).
component("YGL026C",108).
component("YNL316C",179).
component("YCR053W",60).
component("YDR127W",79).
component("YGL148W",111).
component("YFR055W",106).
component("YDR007W",70).
component("YOR095C",186).
component("YBR196C",51).
component("YPR060C",200).
component("YGR264C",120).
component("YGR171C",116).
component("YGL245W",114).
component("YPR047W",199).
component("YLR060W",154).
component("YFL022C",101).
component("YER183C",100).
component("YDL141W",67).
component("YDL141W",68).
component("YJL087C",131).
component("YOL010W",182).
component("YPR138C",203).
component("YPL265W",197).
component("YOL020W",183).
component("YNL142W",173).
component("YMR202W",163).
component("YKR053C",150).
component("YKR039W",149).
component("YJR077C",138).
component("YJL134W",134).
component("YGR121C",115).
component("YGL186C",112).
...
component("YDR046C",72).
component("YDL210W",69).
component("YCL025C",55).
component("YBR069C",46).
component("YBR068C",45).
