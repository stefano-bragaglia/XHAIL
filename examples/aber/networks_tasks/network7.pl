...
component("YLR056W",78).
component("YGL001C",53).
component("YDR127W",37).
component("YNL009W",87).
component("YLR174W",79).
component("YJR078W",68).
component("YOR323C",96).
component("YBR166C",27).
component("YNL280C",89).
component("YMR145C",83).
component("YDL085W",33).
component("YBR046C",22).
component("YPL231W",98).
component("YLR299W",81).
component("YDR354W",43).
component("YFR047C",52).
component("YPR069C",102).
component("YDR127W",38).
component("YDR035W",35).
component("YBR249C",28).
component("YHR137W",63).
component("YLR027C",77).
component("YKL106W",70).
component("YCR036W",30).
component("YJR105W",69).
component("YMR208W",84).
component("YDR127W",39).
component("YDR226W",42).
component("YDR454C",45).
component("YOL061W",94).
component("YKL181W",71).
component("YHL011C",60).
component("YER099C",50).
component("YBL068W",21).
component("YLR328W",82).
component("YHR044C",62).
component("YHR043C",61).
component("YGL037C",55).
component("U53_",20).
component("YHR144C",64).
component("YBR153W",26).
component("YBR111C",25).
component("YER005W",48).
component("YLR231C",80).
component("YDR380W",44).
component("YDL080C",32).
component("YMR250W",85).
component("YKL184W",72).
component("YKL211C",73).
component("YNR033W",91).
component("YKL211C",74).
component("YER090W",49).
component("YDR127W",40).
component("YPL281C",100).
component("YOR393W",97).
component("YMR323W",86).
component("YHR174W",65).
component("YGR254W",59).
component("YGL026C",54).
component("YNL316C",90).
component("YCR053W",31).
component("YDR127W",41).
component("YGL148W",56).
component("YDR007W",34).
component("YOR095C",95).
component("YPR060C",101).
component("YGL245W",57).
component("YJL087C",66).
component("YOL010W",92).
component("YPR138C",103).
component("YPL265W",99).
component("YOL020W",93).
component("YNL142W",88).
component("YKR053C",76).
component("YKR039W",75).
component("YJL134W",67).
component("YGR121C",58).
component("YFL055W",51).
