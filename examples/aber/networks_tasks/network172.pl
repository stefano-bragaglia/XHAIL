...
component("YNL280C",881).
component("YLR056W",746).
component("YGR060W",523).
component("YKR009C",725).
component("YMR083W",825).
component("YPL231W",996).
component("U46_",154).
component("YBR149W",260).
component("YBR149W",261).
component("YJR159W",689).
component("YGL001C",488).
component("YHR063C",579).
component("U45_",153).
component("YBR153W",262).
component("YML056C",805).
component("YLR432W",793).
component("YHR216W",603).
component("YAR075W",214).
component("YAR073W",213).
component("YCL030C",287).
component("YDR127W",370).
component("YJR139C",684).
component("YML075C",808).
component("YLR450W",796).
component("YOL126C",920).
component("YKL085W",698).
component("YDL078C",317).
component("YKL029C",693).
component("YOR136W",937).
component("YNL037C",857).
component("YNL009W",855).
component("YLR174W",764).
component("YDL066W",315).
component("YHR183W",597).
component("YGR256W",555).
component("YNL241C",873).
component("YOL059W",912).
component("YDL022W",306).
component("YCL018W",285).
component("YLR355C",787).
component("YIL074C",610).
component("YER081W",455).
component("YML054C",804).
component("YDL174C",340).
component("YIL155C",620).
component("YPR191W",1033).
component("YOR065W",928).
component("YJL166W",655).
component("YHR001W-A",565).
component("YGR183C",539).
component("YFR033C",484).
component("YEL024W",425).
component("YDR529C",416).
component("YBL045C",221).
component("Q0105",19).
component("YKR066C",730).
component("YKL026C",692).
component("YIR037W",631).
component("YBR244W",273).
component("YJR078W",675).
component("U58_",166).
component("U107_",28).
component("YGR255C",554).
component("U108_",29).
component("YBL098W",226).
component("YMR015C",821).
component("YHR007C",566).
component("YDR402C",403).
component("YGL055W",497).
component("YGR175C",536).
component("YJR104C",678).
component("YHR008C",567).
component("YJL026W",634).
component("YIL066C",609).
component("YGR180C",538).
component("YER070W",453).
component("U37_",145).
component("U36_",144).
component("U35_",143).
component("YDR158W",378).
component("YJR009C",665).
component("YJL052W",636).
component("YGR192C",542).
component("YBR006W",231).
component("YPL276W",1007).
component("YPL275W",1006).
component("YOR388C",970).
component("YOR374W",967).
component("YER073W",454).
component("U68_",177).
component("YGL154C",505).
component("YBR115C",255).
component("U55_",163).
component("YER069W",451).
component("YOR323C",957).
component("U2_",137).
component("YER178W",467).
component("YBR221C",271).
component("YIL125W",616).
component("YBR166C",265).
component("YNL280C",882).
component("YGL012W",491).
component("YKL182W",711).
component("U57_",165).
component("YKL216W",722).
component("YDR044W",356).
component("YER014W",436).
component("YKR009C",726).
component("YIL160C",622).
component("YGL205W",510).
component("YMR118C",830).
component("YLR164W",762).
component("YLL041C",737).
component("YKL148C",706).
component("YKL141W",704).
component("YJL045W",635).
component("YDR178W",380).
component("YJR051W",670).
component("YEL047C",429).
component("YDL171C",339).
component("YOR375C",968).
component("YDL215C",344).
component("YAL062W",211).
component("U99_",205).
component("U100_",22).
component("YBR035C",241).
component("YMR189W",837).
component("U56_",164).
component("YNR050C",897).
component("YKR080W",732).
component("YER023W",437).
component("YPL023C",974).
...
component("U63_",172).
component("U62_",171).
component("YOR356W",965).
component("YHR068W",580).
component("YKL150W",707).
component("YIL043C",607).
component("YHR042W",574).
component("YOR221C",948).
component("YMR145C",833).
component("YML120C",813).
component("YKL192C",715).
component("YKL055C",695).
component("YER061C",447).
component("YDL085W",319).
component("YBR046C",244).
component("YMR145C",834).
component("YML120C",814).
component("YKL192C",716).
component("YDL085W",320).
component("YFR030W",483).
component("YPL017C",973).
component("YFL018C",472).
component("YPL091W",979).
component("YDR353W",398).
component("YER042W",439).
component("YPR167C",1027).
component("YJR137C",683).
component("YNL052W",859).
component("YMR256C",845).
component("YLR395C",791).
component("YLR038C",744).
component("YIL111W",614).
component("YHR051W",578).
...
component("YML110C",812).
component("YBR034C",240).
component("YPL273W",1005).
component("YLL062C",740).
component("YDR410C",406).
component("YKR069W",731).
component("YOL096C",915).
component("U47_",155).
component("YER091C",459).
component("YJR073C",673).
component("YML008C",797).
component("YDL033C",308).
component("YOL096C",916).
component("YLR172C",763).
component("YLR058C",747).
component("YBR263W",277).
component("YDR019C",352).
component("YBR176W",266).
component("YDR408C",405).
component("YMR120C",831).
component("YLR028C",742).
component("YBL013W",215).
component("YJL130C",647).
component("YJL088W",641).
component("YPR074C",1020).
component("YBR117C",256).
component("YLR354C",786).
component("YGR043C",521).
component("YMR108W",828).
component("YCL009C",284).
component("YMR062C",824).
component("YNL071W",860).
component("YIL160C",623).
component("YNR019W",891).
component("YCR048W",301).
component("U48_",156).
component("YNL277W",880).
component("YDR232W",383).
component("YFL017C",471).
component("YPL231W",997).
component("YER061C",448).
component("U86_",195).
component("YPL001W",972).
component("YDL052C",312).
component("U8_",198).
component("YDR148C",376).
component("YML042W",803).
component("YOR377W",969).
component("YGR177C",537).
component("YPL231W",998).
component("YGR147C",532).
component("YDL040C",309).
component("YPL028W",975).
component("YLR195C",766).
component("YLR299W",776).
component("YGL017W",492).
component("YPR001W",1009).
component("YNR001C",887).
component("YCR005C",296).
component("YML126C",816).
component("YDL182W",341).
component("YDL131W",329).
component("YNL117W",864).
component("YIR031C",629).
component("YPR160W",1026).
component("YOR321W",956).
component("YJR143C",685).
component("YGR199W",544).
component("YDL095W",324).
component("YDL093W",323).
component("YAL023C",208).
component("YLR258W",773).
component("YFR015C",480).
component("YPL227C",994).
component("YOR103C",932).
component("YOR085W",930).
component("YMR149W",835).
component("YML019W",799).
component("YJL002C",632).
component("YEL002C",421).
component("YDL232W",345).
component("YCL043C",291).
component("YNL029C",856).
component("YIL085C",612).
component("YMR261C",846).
component("YML100W",810).
component("YBR126C",259).
component("YNL192W",871).
component("YBR038W",243).
component("YBR023C",238).
component("YEL011W",422).
component("YMR306W",853).
component("YLR342W",784).
component("YGR032W",519).
component("YPR183W",1030).
component("YLR209C",767).
component("U104_",26).
component("U103_",25).
component("YMR271C",847).
component("YML106W",811).
component("YOR209C",946).
component("YMR300C",851).
component("YER055C",443).
component("YDR354W",399).
component("YFR047C",485).
component("YJR133W",682).
component("U22_",131).
component("YLR209C",768).
component("YML022W",800).
component("YDR441C",409).
component("YDR399W",401).
component("YHR128W",590).
component("YPR176C",1029).
component("YPL172C",987).
component("YNR041C",895).
component("YMR101C",826).
component("YDL090C",322).
component("YBR003W",230).
component("YBR002C",229).
component("YJL167W",656).
component("YJL167W",657).
component("YNL256W",876).
component("YPR069C",1018).
component("YDR127W",371).
component("YHR190W",598).
component("YLR146C",756).
component("YHR068W",581).
component("YLR303W",777).
component("YGR012W",517).
component("YML082W",809).
component("YJR130C",681).
component("YDR035W",354).
component("YBR249C",274).
component("YLR180W",765).
component("YDR502C",413).
component("YOR274W",953).
component("YOL143C",923).
component("YBR256C",276).
component("YHR137W",591).
component("YGL202W",509).
component("YLR027C",741).
component("YKL106W",700).
component("YOL140W",922).
component("YLR438W",795).
component("YKL104C",699).
component("YGR019W",518).
component("YDR111C",368).
component("U64_",173).
component("U61_",170).
component("U51_",160).
component("YJR148W",686).
component("YHR208W",601).
component("YFL030W",474).
component("YOR184W",943).
component("YNR058W",899).
component("YIL116W",615).
component("YGL253W",515).
component("YFR053C",486).
component("YOL136C",921).
component("YIL107C",613).
component("YMR013C",820).
component("YMR205C",839).
component("YGR240C",550).
component("YOL016C",904).
component("YFR014C",479).
component("YLR240W",771).
component("YKL203C",718).
component("YJR066W",672).
component("YCR036W",300).
component("YGR194C",543).
component("YCL040W",290).
component("YJR105W",679).
component("U16_",80).
component("YPL188W",989).
component("YJR049C",669).
component("YEL041W",426).
component("U96_",203).
component("YKL001C",690).
component("YDR236C",384).
component("YML070W",807).
component("YFL053W",476).
component("YHL032C",563).
component("YLR133W",752).
component("YDR531W",418).
component("U83_",192).
component("U82_",191).
component("U81_",190).
component("YMR208W",840).
component("YPL203W",990).
component("YOR061W",927).
component("YKL166C",709).
component("YJL164C",654).
component("YIL035C",606).
component("YHR205W",600).
component("YHR102W",588).
component("YGL019W",493).
component("YHR025W",573).
component("YOR347C",963).
component("YAL038W",209).
component("YNR012W",889).
component("YPR121W",1023).
component("YPL258C",1000).
component("YOL055C",908).
component("YPL214C",993).
component("U1_",111).
component("YDR009W",351).
component("YBR020W",237).
...
component("U17_",89).
component("U76_",186).
component("YMR220W",842).
component("YER170W",466).
component("YDR226W",382).
component("YKL067W",697).
component("YOL055C",909).
component("YDR454C",410).
component("YOL061W",913).
component("YKL181W",710).
component("YHL011C",560).
component("YER099C",461).
component("YBL068W",224).
component("YOR143C",938).
component("YNL256W",877).
component("YLR328W",782).
component("YBR018C",233).
component("YBR018C",234).
component("YDL055C",313).
component("YGR007W",516).
component("YGR202C",545).
component("YLR328W",783).
component("YKR002W",724).
component("YDL045C",310).
component("YDL103C",327).
component("U94_",202).
component("YJR010W",666).
component("YBR029C",239).
component("YCL050C",292).
component("YGL130W",503).
component("YDR530C",417).
component("YCL050C",293).
component("YPR190C",1032).
component("YPR187W",1031).
component("YPR110C",1022).
component("YPR010C",1011).
component("YOR341W",962).
component("YOR340C",961).
component("YOR224C",949).
component("YOR210W",947).
component("YOR207C",945).
component("YOR151C",939).
component("YOR116C",933).
component("YOL005C",901).
component("YNR003C",888).
component("YNL248C",875).
component("YNL151C",869).
component("YNL113W",863).
component("YKL144C",705).
component("YJR063W",671).
component("YJL148W",651).
component("YJL140W",650).
component("YIL021W",605).
component("YHR143W-A",592).
component("YGL070C",501).
component("YFL036W",475).
component("YDR404C",404).
component("YDR156W",377).
component("YDR045C",357).
component("YDL150W",337).
component("YDL140C",331).
component("YBR154C",264).
component("YPR175W",1028).
component("YPL167C",986).
component("YOR330C",958).
component("YOL115W",919).
component("YNL299W",884).
component("YNL262W",878).
component("YNL102W",862).
component("YJR043C",668).
component("YJR006W",664).
component("YJL090C",642).
component("YIL139C",618).
component("YEL055C",430).
component("YDR419W",407).
component("YDR121W",369).
component("YDL102W",326).
component("YCR014C",298).
component("YBR278W",278).
component("YBL035C",218).
component("YKL035W",694).
component("YHL012W",561).
component("YHR123W",589).
component("YBR243C",272).
component("YNL130C",865).
component("YDL142C",336).
component("YPL148C",984).
component("YER026C",438).
component("YOR251C",952).
component("YGR286C",557).
component("YJL068C",637).
component("YDR058C",362).
component("YNR034W",894).
component("YHR163W",595).
component("YGR248W",552).
component("YCR073W-A",303).
component("YDL086W",321).
component("YOL011W",903).
component("YMR008C",818).
component("YMR006C",817).
component("U105_",27).
component("U101_",23).
component("YJL068C",638).
component("YPL072W",978).
component("YOR124C",934).
component("YNL186W",870).
component("YMR304W",852).
component("YMR223W",843).
component("YKR098C",735).
component("YJL197W",658).
component("YIL156W",621).
component("YFR010W",478).
component("YER151C",465).
component("YER144C",464).
component("YER098W",460).
component("YDR069C",364).
component("YDL122W",328).
component("YBR058C",245).
component("YBL067C",223).
component("YJR019C",667).
component("YDR272W",387).
component("U84_",193).
component("YDR481C",411).
component("YLR377C",789).
component("YDR074W",365).
component("YFR025C",482).
component("YPL179W",988).
component("YNR032W",892).
component("YML057W",806).
component("YML016C",798).
component("YLR433C",794).
component("YGR123C",528).
component("YER133W",463).
component("YER089C",457).
component("YDR436W",408).
component("YDR075W",366).
component("YDL188C",342).
component("YDL134C",330).
...
component("YBR093C",253).
component("YBR092C",252).
component("YIL053W",608).
component("YER062C",449).
component("YHR046C",577).
component("U9_",206).
component("YGR208W",549).
component("YPL228W",995).
component("YMR180C",836).
component("YDL236W",346).
component("YJL155C",653).
component("U34_",142).
component("U33_",141).
component("U32_",140).
component("U31_",139).
...
component("U26_",133).
component("U24_",132).
component("YHR044C",576).
component("YHR043C",575).
component("YOL064C",914).
component("YPL268W",1004).
component("YOR360C",966).
component("YGL248W",514).
component("YKR031C",727).
component("YPL206C",991).
component("YGL027C",495).
component("YLR286C",775).
component("YJR153W",687).
component("YJL221C",663).
component("YJL216C",661).
component("YIL172C",627).
component("YGR292W",559).
component("YGR287C",558).
component("YBR299W",283).
component("YBR184W",267).
component("YIL162W",624).
component("YPR026W",1012).
component("YDR001C",349).
component("YBR001C",228).
component("YDR400W",402).
component("YML035C",801).
component("YJL070C",639).
component("YBR284W",279).
component("U102_",24).
component("YER043C",440).
component("YNL045W",858).
component("YLR160C",761).
component("YLR158C",760).
component("YLR157C",759).
component("YLR155C",758).
component("YDR321W",393).
component("YGL037C",496).
component("U43_",151).
component("U42_",150).
component("YMR293C",850).
component("YDR242W",385).
component("YLR308W",781).
component("YLR307W",780).
component("YBR208C",269).
component("YMR281W",849).
component("U53_",161).
component("YLR420W",792).
component("YPL111W",982).
component("YIR032C",630).
component("YIR029W",628).
component("YPR062W",1017).
component("YMR120C",832).
component("YLR028C",743).
component("YHR144C",593).
component("YHR144C",594).
component("YCL030C",288).
component("YNL141W",866).
component("YBL033C",217).
component("YBR153W",263).
component("YDL238C",347).
component("YNL141W",867).
component("YLR245C",772).
component("YML035C",802).
component("YGR204W",547).
component("YBR084W",250).
component("YJL126W",645).
component("U44_",152).
component("YDL100C",325).
component("U40_",148).
component("U39_",146).
component("YBR011C",232).
component("YHR201C",599).
component("YBR111C",254).
component("YBR252W",275).
component("YCL030C",289).
component("YEL042W",427).
component("YER005W",435).
component("YBL099W",227).
component("U60_",169).
component("YLR231C",769).
component("U88_",196).
component("YDR538W",420).
component("YLR134W",753).
component("YLR044C",745).
component("YGR087C",525).
component("YDR380W",400).
component("YDL080C",318).
component("U98_",204).
component("YMR250W",844).
component("YKL184W",714).
component("YOR128C",935).
component("YEL021W",424).
component("YNR043W",896).
component("U93_",201).
component("YDR047W",359).
component("U54_",162).
component("YKL211C",720).
component("YKR097W",734).
component("YOL052C",907).
component("YGR170W",534).
component("YKL060C",696).
component("YDR294C",389).
component("YEL046C",428).
component("YNR033W",893).
component("YPR006C",1010).
component("YER065C",450).
component("YKL211C",721).
component("YER090W",458).
component("YDR127W",373).
component("YPL281C",1008).
component("YOR393W",971).
component("YMR323W",854).
component("YHR174W",596).
component("YGR254W",553).
component("YPL262W",1001).
component("YGL026C",494).
component("YGR155W",533).
component("YLR304C",778).
component("YJL200C",659).
component("YGL009C",490).
component("YNL316C",885).
component("YKL182W",712).
component("YPL212C",992).
component("YNL292W",883).
component("YGL063W",500).
...
component("YIL168W",626).
component("YIL167W",625).
component("YCL064C",294).
component("YCL064C",295).
component("YHR018C",569).
component("YLR359W",788).
component("YAL012W",207).
component("YFR055W",487).
component("YJL005W",633).
component("YOR176W",942).
component("YJL121C",644).
component("YBR019C",235).
component("YBR019C",236).
component("U59_",167).
component("YDR050C",360).
component("YIL020C",604).
component("YDR007W",350).
component("YOR095C",931).
component("YER003C",434).
component("YBR196C",268).
component("YGL001C",489).
component("YPL117C",983).
component("U14_",65).
component("YOL056W",910).
component("YKL152C",708).
component("YDL021W",305).
component("YMR105C",827).
component("YKL127W",702).
component("YEL058W",431).
component("YPR060C",1016).
component("YHR072W",582).
component("YJL153C",652).
component("YPL097W",980).
component("YGR185C",540).
component("YGR264C",556).
component("YGR171C",535).
component("YHR011W",568).
component("YDR023W",353).
component("YPL104W",981).
component("YLL018C",736).
component("YPR081C",1021).
component("YBR121C",257).
component("YHR020W",572).
component("YER087W",456).
component("YNL247W",874).
component("YOL033W",906).
component("YGL245W",513).
component("YOR168W",940).
component("YHR091C",584).
component("YDR341C",394).
component("YOL097C",917).
component("YDR268W",386).
component("YPR047W",1015).
component("YLR060W",748).
component("YFL022C",473).
component("YPR033C",1013).
component("YHR019C",570).
component("YHR019C",571).
component("YKL194C",717).
component("YIL078W",611).
component("YPL160W",985).
component("YLR382C",790).
component("YPL040C",976).
component("YBL076C",225).
component("YNL073W",861).
component("YDR037W",355).
component("YOR335C",959).
component("YGR094W",526).
component("YLR153C",757).
component("YAL054C",210).
component("YGR244C",551).
component("YPR035W",1014).
component("YIL145C",619).
component("U89_",197).
component("YOR241W",951).
component("YMR113W",829).
component("YKL132C",703).
component("YOR339C",960).
component("YMR022W",822).
component("YLR306W",779).
component("YKL210W",719).
component("YGR133W",531).
component("YGL058W",498).
component("YER100W",462).
component("YEL012W",423).
component("YDR177W",379).
component("YDR092W",367).
component("YDR059C",363).
component("YDR054C",361).
component("YDL064W",314).
component("YBR082C",248).
component("YJL101C",643).
component("U92_",200).
component("YAR015W",212).
component("YGL234W",511).
component("YER183C",468).
component("U90_",199).
component("YNR057C",898).
component("YDL141W",332).
component("YDL141W",333).
component("YGL234W",512).
component("YDL141W",334).
component("YJR103W",677).
component("YBL039C",219).
component("YGR204W",548).
component("YNL220W",872).
component("YOL058W",911).
component("YDL141W",335).
component("YHR074W",583).
component("YMR217W",841).
component("YPR145W",1025).
component("YGR124W",529).
component("YOR303W",955).
component("YJR109C",680).
component("YJL130C",648).
component("YGL062W",499).
component("YBR218C",270).
component("YPL231W",999).
component("YNR016C",890).
component("YKL182W",713).
component("YGR037C",520).
component("YOR005C",925).
component("YDL164C",338).
component("YJL087C",640).
component("YOL010W",902).
component("YPR138C",1024).
component("YPL265W",1002).
component("YPL057C",977).
component("YOR348C",964).
component("YOR192C",944).
component("YOR171C",941).
component("YOR130C",936).
component("YOR071C",929).
component("YOR011W",926).
component("YOL156W",924).
component("YOL103W",918).
component("YOL020W",905).
component("YNR072W",900).
component("YNL318C",886).
component("YNL270C",879).
component("YNL142W",868).
component("YMR272C",848).
component("YMR202W",838).
component("YMR056C",823).
component("YMR011W",819).
component("YML123C",815).
component("YLR348C",785).
component("YLR260W",774).
component("YLR237W",770).
component("YLR138W",754).
component("YLR100C",751).
component("YLR092W",750).
component("YLR081W",749).
component("YLL061W",739).
component("YLL043W",738).
component("YKR093W",733).
component("YKR053C",729).
component("YKR039W",728).
component("YKL217W",723).
component("YKL120W",701).
component("YKL004W",691).
component("YJR158W",688).
component("YJR095W",676).
component("YJR077C",674).
component("YJL219W",662).
component("YJL214W",660).
component("YJL134W",649).
component("YJL129C",646).
component("YIL134W",617).
component("YHR096C",587).
component("YHR094C",586).
component("YHR092C",585).
component("YHL036W",564).
component("YHL016C",562).
component("YGR191W",541).
component("YGR125W",530).
component("YGR121C",527).
component("YGR065C",524).
component("YGR055W",522).
component("YGL186C",506).
component("YFL055W",477).
...
component("YEL063C",432).
component("YDR536W",419).
component("YDR508C",415).
component("YDR503C",414).
component("YDR497C",412).
component("YDR345C",397).
component("YDR343C",396).
component("YDR342C",395).
component("YDR297W",391).
component("YDR294C",390).
component("YDR284C",388).
component("YDR046C",358).
component("YDL245C",348).
component("YDL210W",343).
component("YCR028C",299).
component("YCL025C",286).
component("YBR298C",282).
component("YBR294W",281).
component("YBR291C",280).
component("YBR085W",251).
component("YBR069C",247).
component("YBR068C",246).
component("YBR036C",242).
component("YBL042C",220).
component("YBL030C",216).
component("U85_",194).
component("U7_",189).
component("U79_",188).
component("U78_",187).
