...
component("YKR009C",409).
component("YMR083W",467).
component("YPL231W",563).
component("YJR159W",390).
component("YGL001C",273).
component("YML056C",453).
component("YLR432W",449).
component("YHR216W",340).
component("YAR075W",112).
component("YAR073W",111).
component("YCL030C",156).
component("YDR127W",206).
component("YJR139C",387).
component("YOR136W",531).
component("YNL009W",482).
component("YLR174W",432).
component("YHR183W",336).
component("YGR256W",312).
component("YOL059W",520).
component("YDL022W",168).
component("YCL018W",154).
component("YLR355C",444).
component("YEL024W",235).
component("YJR078W",383).
component("U58_",88).
component("YGR255C",311).
component("YMR015C",464).
component("YDR402C",223).
component("YGL055W",279).
component("YJL026W",355).
component("YIL066C",345).
component("YGR180C",303).
component("YER070W",249).
component("U35_",76).
component("YJR009C",374).
component("YJL052W",356).
component("YGR192C",305).
component("YOR374W",548).
component("YER073W",250).
component("U68_",92).
component("U55_",86).
...
component("YNL280C",501).
component("YER014W",239).
component("YKL141W",396).
component("YJR051W",378).
component("YOR375C",549).
component("YDL215C",191).
component("YAL062W",110).
component("U100_",20).
component("YBR035C",127).
component("YMR189W",471).
component("U56_",87).
component("YPL023C",552).
component("YGL125W",282).
component("YOR236W",539).
...
component("YML120C",458).
component("YKL192C",403).
component("YDL085W",174).
component("YBR046C",129).
component("YPL091W",555).
component("YNL052W",483).
component("YMR256C",477).
component("YLR395C",447).
component("YLR038C",418).
component("YIL111W",347).
component("YHR051W",325).
component("YGL191W",286).
component("YGL187C",285).
component("YDL067C",172).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",569).
component("YPL273W",571).
component("YLL062C",415).
component("YDR410C",225).
component("YER091C",254).
component("YJR073C",381).
component("YOL096C",522).
component("YLR172C",431).
component("YMR120C",469).
component("YBL013W",113).
component("YJL130C",364).
component("YJL088W",359).
component("YPR074C",581).
component("YBR117C",137).
component("YCL009C",153).
component("YMR062C",466).
component("YNL071W",484).
component("YIL160C",350).
component("YNR019W",508).
component("YCR048W",165).
component("U48_",81).
component("YNL277W",499).
component("YFL017C",262).
component("YPL231W",564).
component("YER061C",245).
component("YDL052C",170).
component("U8_",105).
component("YDR148C",212).
component("YOR377W",550).
component("YGR177C",302).
component("YPL231W",565).
component("YLR195C",433).
component("YLR299W",438).
component("YPR001W",573).
component("YNR001C",504).
component("YCR005C",161).
component("YML126C",460).
component("YDL182W",188).
component("YDL131W",180).
component("YNL117W",488).
component("YIR031C",353).
component("YOR321W",541).
component("YJR143C",388).
component("YGR199W",307).
component("YDL095W",176).
component("YDL093W",175).
component("YAL023C",109).
component("YPL227C",562).
component("YMR261C",478).
component("YML100W",457).
component("YBR126C",139).
component("YNL192W",495).
component("YBR038W",128).
component("YBR023C",125).
component("YLR209C",434).
component("U104_",23).
component("YDR354W",219).
component("YFR047C",270).
component("YJR133W",386).
component("U22_",66).
component("YDR399W",221).
component("YJL167W",371).
component("YPR069C",580).
component("YDR127W",207).
component("YHR068W",327).
component("YLR303W",439).
component("YML082W",456).
component("YJR130C",385).
component("YDR035W",196).
component("YBR249C",147).
component("YBR256C",149).
component("YHR137W",331).
component("YGL202W",287).
component("YLR027C",416).
component("YKL106W",394).
component("YOL140W",525).
component("YLR438W",451).
component("YKL104C",393).
component("YDR111C",204).
component("U51_",84).
component("YJR148W",389).
component("YHR208W",339).
component("YOR184W",535).
component("YGL253W",291).
component("YFR053C",271).
component("YMR013C",463).
component("YLR240W",436).
component("YKL203C",405).
component("YJR066W",380).
component("YCR036W",164).
component("YGR194C",306).
component("YCL040W",158).
component("YJR105W",384).
component("YML070W",455).
component("YFL053W",265).
component("U82_",103).
component("U81_",102).
component("YMR208W",473).
component("YPL203W",561).
component("YOR061W",526).
component("YKL166C",399).
component("YJL164C",370).
component("YIL035C",342).
component("YHR205W",338).
component("YHR102W",329).
component("YGL019W",275).
component("YHR025W",320).
component("YNR012W",506).
component("YPR121W",583).
component("YPL258C",567).
component("YOL055C",518).
component("U1_",56).
component("YBR020W",124).
component("YFR019W",268).
component("YDR208W",214).
component("YDR127W",208).
component("U21_",63).
component("YDR147W",211).
component("YCR012W",162).
component("YER052C",241).
component("U19_",55).
component("U18_",51).
component("U17_",48).
component("U76_",99).
component("YMR220W",474).
component("YER170W",260).
component("YDR226W",215).
component("YKL067W",392).
component("YOL055C",519).
component("YDR454C",228).
component("YOL061W",521).
component("YKL181W",400).
component("YHL011C",315).
component("YER099C",256).
component("YBL068W",119).
component("YOR143C",532).
component("YNL256W",497).
component("YBR018C",122).
component("YDL055C",171).
component("YLR328W",442).
component("YDL103C",178).
component("U94_",107).
component("YJR010W",375).
component("YBR029C",126).
component("YPR190C",588).
component("YPR187W",587).
component("YPR110C",582).
component("YPR010C",575).
component("YOR341W",545).
component("YOR340C",544).
component("YOR224C",538).
component("YOR210W",537).
component("YOR207C",536).
component("YOR151C",533).
component("YOR116C",528).
component("YOL005C",513).
component("YNR003C",505).
component("YNL248C",496).
component("YNL151C",493).
component("YNL113W",487).
component("YKL144C",397).
component("YJR063W",379).
component("YJL148W",367).
component("YJL140W",366).
...
component("YPR175W",586).
component("YPL167C",559).
component("YOR330C",543).
component("YOL115W",524).
component("YNL299W",502).
component("YNL262W",498).
component("YNL102W",486).
component("YJR043C",377).
component("YJR006W",373).
component("YJL090C",360).
component("YIL139C",348).
component("YEL055C",236).
...
component("YKL035W",391).
component("YHL012W",316).
component("YHR123W",330).
component("YNL130C",489).
component("YPL148C",557).
component("YOR251C",540).
component("YGR286C",314).
component("YDR058C",200).
component("YOL011W",515).
component("YMR008C",462).
component("YMR006C",461).
component("U105_",24).
component("U101_",21).
component("YJL068C",357).
component("YPL072W",554).
component("YOR124C",529).
component("YNL186W",494).
component("YMR304W",480).
component("YMR223W",475).
component("YKR098C",414).
component("YJL197W",372).
component("YIL156W",349).
component("YFR010W",267).
component("YER151C",259).
component("YER144C",258).
component("YER098W",255).
component("YDR069C",201).
component("YDL122W",179).
component("YBR058C",130).
component("YBL067C",118).
component("YJR019C",376).
component("YDR074W",202).
component("YFR025C",269).
component("YPL179W",560).
component("YNR032W",509).
component("YML057W",454).
component("YML016C",452).
component("YLR433C",450).
component("YGR123C",297).
component("YER133W",257).
component("YER089C",252).
component("YDR436W",227).
component("YDR075W",203).
component("YDL188C",189).
component("YDL134C",181).
component("YDL047W",169).
component("YDL006W",167).
component("YBR125C",138).
component("YBL056W",117).
component("YIL053W",344).
component("YER062C",246).
component("YHR046C",324).
component("U9_",108).
component("YGR208W",309).
component("YJL155C",369).
component("U34_",75).
component("U33_",74).
component("U32_",73).
component("U30_",72).
...
component("U26_",68).
component("U24_",67).
component("YHR044C",323).
component("YHR043C",322).
component("YPL268W",570).
component("YOR360C",547).
component("YGL248W",290).
component("YKR031C",410).
component("YGL027C",277).
component("YLR286C",437).
component("YBR184W",143).
component("YPR026W",576).
component("YDR001C",193).
component("YBR001C",121).
component("YDR400W",222).
component("U102_",22).
component("YER043C",240).
component("YLR160C",430).
component("YLR158C",429).
component("YLR157C",428).
component("YLR155C",427).
component("YDR321W",218).
component("YGL037C",278).
component("U43_",79).
component("U42_",78).
component("YLR308W",441).
component("YLR307W",440).
component("U53_",85).
component("YLR420W",448).
component("YIR032C",354).
component("YLR028C",417).
component("YHR144C",333).
component("YHR144C",334).
component("YNL141W",490).
component("YBR153W",140).
component("YDL238C",192).
component("YNL141W",491).
component("YBR084W",134).
component("YJL126W",362).
component("U44_",80).
component("YHR201C",337).
component("YBR111C",136).
component("YBR252W",148).
component("YCL030C",157).
component("YER005W",238).
component("YLR231C",435).
component("U88_",104).
component("YDR538W",233).
component("YLR134W",424).
component("YLR044C",419).
component("YGR087C",294).
component("YDR380W",220).
component("YDL080C",173).
component("YMR250W",476).
component("YKL184W",402).
component("YEL021W",234).
component("YNR043W",511).
component("YKL211C",406).
component("YKR097W",413).
component("YOL052C",517).
component("YDR294C",216).
component("YNR033W",510).
component("YPR006C",574).
component("YER065C",247).
component("YKL211C",407).
component("YER090W",253).
component("YDR127W",209).
component("YPL281C",572).
component("YOR393W",551).
component("YMR323W",481).
component("YHR174W",335).
component("YGR254W",310).
component("YGL026C",276).
component("YGR155W",300).
...
component("YFR055W",272).
component("YJL121C",361).
component("YBR019C",123).
component("YDR007W",194).
component("YOR095C",527).
component("YBR196C",144).
component("YGL001C",274).
component("YPL117C",556).
component("U14_",38).
component("YMR105C",468).
component("YKL127W",395).
component("YEL058W",237).
component("YPR060C",579).
component("YHR072W",328).
component("YJL153C",368).
component("YGR264C",313).
component("YGR171C",301).
component("YHR011W",317).
component("YDR023W",195).
component("YHR020W",319).
component("YER087W",251).
component("YGL245W",289).
component("YOR168W",534).
component("YPR047W",578).
component("YLR060W",421).
component("YFL022C",263).
component("YPR033C",577).
component("YHR019C",318).
component("YKL194C",404).
component("YIL078W",346).
component("YPL160W",558).
component("YLR382C",446).
component("YPL040C",553).
component("YBL076C",120).
component("YNL073W",485).
component("YDR037W",197).
component("YGR094W",295).
component("YGL234W",288).
component("YER183C",261).
component("U90_",106).
component("YNR057C",512).
component("YDL141W",183).
component("YDL141W",184).
component("YDL141W",185).
component("YDL141W",186).
component("YPR145W",585).
component("YGR124W",298).
component("YGL062W",280).
component("YBR218C",145).
component("YPL231W",566).
component("YNR016C",507).
component("YKL182W",401).
component("YGR037C",292).
component("YJL087C",358).
component("YOL010W",514).
component("YPR138C",584).
component("YPL265W",568).
component("YOR348C",546).
component("YOR130C",530).
component("YOL103W",523).
component("YOL020W",516).
component("YNL142W",492).
component("YMR272C",479).
component("YMR202W",472).
component("YMR056C",465).
component("YML123C",459).
component("YLR348C",443).
component("YLR138W",425).
component("YLR100C",423).
component("YLR092W",422).
component("YKR053C",412).
component("YKR039W",411).
component("YKL217W",408).
component("YJR077C",382).
component("YJL134W",365).
component("YJL129C",363).
component("YGR191W",304).
component("YGR125W",299).
component("YGR121C",296).
component("YGR065C",293).
component("YGL186C",284).
component("YFL055W",266).
component("YER060W-A",244).
component("YER060W",243).
component("YER056C",242).
component("YDR536W",232).
component("YDR508C",231).
component("YDR503C",230).
component("YDR497C",229).
component("YDR294C",217).
component("YDR046C",199).
component("YDL210W",190).
component("YCL025C",155).
component("YBR294W",152).
component("YBR291C",151).
component("YBR085W",135).
component("YBR069C",132).
component("YBR068C",131).
component("YBL042C",116).
component("YBL030C",114).
component("U7_",101).
component("U79_",100).
component("U75_",98).
component("U74_",97).
