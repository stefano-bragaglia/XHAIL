...
component("YNL280C",221).
component("YLR056W",189).
component("YGL001C",128).
component("YDR127W",90).
component("YNL009W",213).
component("YLR174W",196).
component("YHR183W",157).
component("YGR256W",144).
component("YCL018W",65).
component("YJR078W",172).
component("YMR015C",205).
component("YDR402C",101).
component("YGL055W",131).
component("YJL026W",162).
component("YGR180C",141).
component("YOR323C",236).
component("YBR166C",61).
component("YNL280C",222).
component("YKL141W",178).
component("YOR375C",239).
component("YDL215C",83).
component("YAL062W",48).
component("U100_",18).
component("YPL023C",241).
component("YGL125W",132).
component("YMR145C",206).
component("YDL085W",75).
component("YBR046C",54).
component("YPL273W",247).
component("YLL062C",186).
component("YDR410C",102).
component("YJR073C",170).
component("YJL088W",164).
component("YPR074C",252).
component("YBR117C",59).
component("YNL071W",214).
component("YNR019W",225).
...
component("YLR299W",198).
component("YCR005C",68).
component("YNL117W",216).
component("YIR031C",161).
component("YOR321W",235).
component("YJR143C",175).
component("YGR199W",142).
component("YDL095W",77).
component("YDL093W",76).
component("YAL023C",47).
component("YDR354W",98).
component("YFR047C",126).
component("U22_",34).
component("YDR399W",100).
component("YPR069C",251).
component("YDR127W",91).
component("YML082W",201).
component("YJR130C",174).
component("YDR035W",86).
component("YBR249C",63).
component("YHR137W",153).
component("YGL202W",135).
component("YLR027C",187).
component("YKL106W",177).
component("YLR438W",200).
component("U51_",41).
component("YMR013C",204).
component("YCR036W",70).
component("YCL040W",67).
component("YJR105W",173).
component("YMR208W",208).
component("YHR025W",149).
component("YFR019W",124).
component("YDR208W",95).
component("YDR127W",92).
component("YER052C",111).
component("U19_",30).
component("U76_",45).
component("YDR226W",96).
component("YDR454C",104).
component("YOL061W",230).
component("YKL181W",179).
component("YHL011C",146).
component("YER099C",117).
component("YBL068W",52).
component("YLR328W",199).
component("YBR029C",53).
component("YPR175W",255).
component("YPL167C",243).
component("YOR330C",237).
component("YOL115W",232).
component("YNL299W",223).
component("YNL262W",220).
component("YNL102W",215).
component("YJR043C",169).
component("YJR006W",168).
component("YJL090C",165).
component("YIL139C",159).
component("YEL055C",109).
component("YDR419W",103).
component("YDR121W",89).
component("YDL102W",78).
component("YCR014C",69).
component("YBR278W",64).
component("YBL035C",49).
component("YKL035W",176).
component("YHL012W",147).
component("YOL011W",228).
component("YMR008C",203).
component("YMR006C",202).
component("U105_",19).
component("YPL072W",242).
component("YOR124C",234).
component("YNL186W",219).
component("YMR304W",211).
component("YMR223W",209).
component("YKR098C",185).
component("YJL197W",167).
component("YIL156W",160).
component("YFR010W",123).
component("YER151C",119).
component("YER144C",118).
component("YER098W",116).
component("YDR069C",88).
component("YDL122W",79).
component("YBR058C",55).
component("YBL067C",51).
component("YFR025C",125).
component("U32_",36).
component("U30_",35).
component("YHR044C",151).
component("YHR043C",150).
component("YLR160C",195).
component("YLR158C",194).
component("YLR157C",193).
component("YLR155C",192).
component("YDR321W",97).
component("YGL037C",130).
component("U43_",38).
component("U42_",37).
component("U53_",42).
component("YHR144C",154).
component("YHR144C",155).
component("YBR153W",60).
component("YDL238C",84).
component("YNL141W",217).
component("U44_",39).
component("YHR201C",158).
component("YBR111C",58).
component("YER005W",110).
component("YLR231C",197).
component("YLR134W",191).
component("YLR044C",188).
component("YGR087C",137).
component("YDR380W",99).
component("YDL080C",74).
component("YMR250W",210).
component("YKL184W",180).
component("YEL021W",108).
component("YKL211C",181).
component("YNR033W",226).
component("YKL211C",182).
component("YER090W",115).
component("YDR127W",93).
component("YPL281C",248).
component("YOR393W",240).
component("YMR323W",212).
component("YHR174W",156).
component("YGR254W",143).
component("YGL026C",129).
component("YNL316C",224).
component("YCR053W",72).
component("YDR127W",94).
component("YGL148W",133).
component("YFR055W",127).
component("YDR007W",85).
component("YOR095C",233).
component("YBR196C",62).
component("YPR060C",250).
component("YHR072W",152).
component("YGR264C",145).
component("YGR171C",140).
component("YGL245W",136).
component("YPR047W",249).
component("YLR060W",190).
component("YFL022C",121).
component("YHR019C",148).
component("YER183C",120).
component("YDL141W",80).
component("YDL141W",81).
component("YPR145W",254).
component("YGR124W",139).
component("YJL087C",163).
component("YOL010W",227).
component("YPR138C",253).
component("YPL265W",246).
component("YOR348C",238).
component("YOL103W",231).
component("YOL020W",229).
component("YNL142W",218).
component("YMR202W",207).
component("YKR053C",184).
component("YKR039W",183).
component("YJR077C",171).
component("YJL134W",166).
component("YGR121C",138).
component("YGL186C",134).
component("YFL055W",122).
component("YER060W-A",114).
component("YER060W",113).
component("YER056C",112).
component("YDR536W",107).
component("YDR508C",106).
component("YDR497C",105).
