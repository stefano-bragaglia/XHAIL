...
component("YKR009C",680).
component("YMR083W",773).
component("YPL231W",932).
component("U46_",141).
component("YBR149W",242).
component("YBR149W",243).
component("YJR159W",645).
component("YGL001C",454).
component("YHR063C",541).
component("YBR153W",244).
component("YML056C",755).
component("YLR432W",745).
component("YHR216W",564).
component("YAR075W",198).
component("YAR073W",197).
component("YCL030C",266).
component("YDR127W",344).
component("YJR139C",640).
component("YML075C",758).
component("YLR450W",748).
component("YKL085W",654).
component("YKL029C",649).
component("YOR136W",877).
component("YNL037C",802).
component("YNL009W",800).
component("YLR174W",718).
component("YDL066W",293).
component("YHR183W",558).
component("YGR256W",517).
component("YNL241C",817).
component("YOL059W",855).
component("YDL022W",285).
component("YCL018W",264).
component("YLR355C",739).
component("YIL074C",570).
component("YER081W",422).
component("YML054C",754).
component("YDL174C",317).
component("YIL155C",578).
component("YPR191W",968).
component("YOR065W",869).
component("YJL166W",612).
component("YHR001W-A",527).
component("YGR183C",502).
component("YFR033C",450).
component("YEL024W",396).
component("YDR529C",388).
component("YBL045C",204).
component("Q0105",19).
component("YKR066C",685).
component("YKL026C",648).
component("YIR037W",589).
component("YBR244W",253).
component("YJR078W",632).
component("U58_",153).
component("U107_",28).
component("YGR255C",516).
component("U108_",29).
component("YBL098W",209).
component("YMR015C",770).
component("YHR007C",528).
component("YDR402C",375).
component("YGL055W",463).
component("YGR175C",499).
component("YJR104C",634).
component("YHR008C",529).
component("YJL026W",592).
component("YIL066C",569).
component("YGR180C",501).
component("YER070W",420).
component("U37_",133).
component("U36_",132).
component("U35_",131).
component("YDR158W",352).
component("YJR009C",622).
component("YJL052W",594).
component("YGR192C",504).
component("YBR006W",214).
component("YPL276W",943).
component("YPL275W",942).
component("YOR388C",907).
component("YOR374W",904).
component("YER073W",421).
component("U68_",164).
component("YGL154C",470).
...
component("YBR221C",251).
component("YIL125W",575).
component("YBR166C",247).
component("YNL280C",825).
component("YGL012W",457).
component("YKL182W",667).
component("U57_",152).
component("YKL216W",677).
component("YDR044W",333).
component("YER014W",406).
component("YKR009C",681).
component("YIL160C",580).
component("YGL205W",475).
component("YMR118C",778).
component("YLR164W",716).
component("YLL041C",692).
component("YKL148C",662).
component("YKL141W",660).
component("YJL045W",593).
component("YDR178W",353).
component("YJR051W",627).
component("YEL047C",399).
component("YDL171C",316).
component("YOR375C",905).
component("YDL215C",321).
component("YAL062W",195).
component("U99_",191).
component("U100_",22).
component("YBR035C",224).
component("YMR189W",785).
component("U56_",151).
component("YNR050C",840).
component("YKR080W",687).
component("YER023W",407).
component("YPL023C",911).
component("YGL125W",467).
component("YOR236W",890).
component("YGR204W",508).
component("YBR084W",231).
component("YLR142W",709).
component("U65_",161).
component("U63_",159).
component("U62_",158).
component("YHR068W",542).
component("YKL150W",663).
component("YIL043C",567).
component("YHR042W",536).
component("YOR221C",888).
component("YMR145C",781).
component("YML120C",762).
component("YKL192C",671).
component("YKL055C",651).
component("YER061C",415).
component("YDL085W",296).
component("YBR046C",227).
component("YMR145C",782).
component("YML120C",763).
component("YKL192C",672).
component("YDL085W",297).
component("YFR030W",449).
component("YPL017C",910).
component("YFL018C",438).
component("YPL091W",916).
component("YDR353W",370).
component("YER042W",408).
component("YPR167C",962).
component("YJR137C",639).
component("YNL052W",804).
component("YMR256C",793).
component("YLR395C",743).
component("YLR038C",699).
component("YIL111W",573).
component("YHR051W",540).
component("YGL191W",473).
component("YGL187C",472).
component("YDL067C",294).
component("Q0275",21).
component("Q0250",20).
component("Q0045",18).
component("YPL266W",939).
component("YML110C",761).
component("YBR034C",223).
component("YPL273W",941).
component("YLL062C",695).
component("YDR410C",378).
component("YKR069W",686).
component("YOL096C",858).
component("U47_",142).
component("YER091C",426).
component("YJR073C",630).
component("YML008C",749).
component("YDL033C",287).
component("YOL096C",859).
component("YLR172C",717).
component("YBR263W",257).
component("YDR019C",329).
component("YDR408C",377).
component("YMR120C",779).
component("YLR028C",697).
component("YBL013W",199).
component("YJL130C",604).
component("YJL088W",598).
component("YPR074C",955).
component("YBR117C",238).
component("YLR354C",738).
component("YGR043C",485).
component("YMR108W",776).
component("YCL009C",263).
component("YMR062C",772).
component("YNL071W",805).
component("YIL160C",581).
component("YNR019W",834).
component("YCR048W",280).
component("U48_",143).
component("YNL277W",823).
component("YDR232W",356).
component("YFL017C",437).
component("YPL231W",933).
component("YER061C",416).
component("U86_",182).
component("YPL001W",909).
component("YDL052C",291).
component("U8_",185).
component("YDR148C",350).
component("YOR377W",906).
component("YGR177C",500).
component("YPL231W",934).
component("YGR147C",495).
component("YDL040C",288).
component("YPL028W",912).
component("YLR195C",720).
component("YLR299W",730).
component("YGL017W",458).
component("YPR001W",945).
component("YNR001C",830).
component("YCR005C",275).
component("YML126C",765).
component("YDL182W",318).
component("YDL131W",306).
component("YNL117W",809).
component("YIR031C",587).
component("YPR160W",961).
component("YOR321W",896).
component("YJR143C",641).
component("YGR199W",506).
component("YDL095W",301).
component("YDL093W",300).
component("YAL023C",193).
component("YLR258W",727).
component("YFR015C",446).
component("YPL227C",930).
component("YOR103C",873).
component("YOR085W",871).
component("YMR149W",783).
component("YML019W",751).
component("YJL002C",590).
component("YEL002C",393).
component("YDL232W",322).
component("YCL043C",270).
component("YNL029C",801).
component("YIL085C",572).
component("YMR261C",794).
component("YML100W",760).
component("YBR126C",241).
component("YNL192W",816).
component("YBR038W",226).
component("YBR023C",221).
component("YEL011W",394).
component("YPR183W",965).
component("YLR209C",721).
component("U104_",26).
component("U103_",25).
component("YOR209C",886).
component("YMR300C",797).
component("YDR354W",371).
component("YFR047C",451).
component("YJR133W",638).
component("U22_",120).
component("YLR209C",722).
component("YML022W",752).
component("YDR441C",381).
component("YDR399W",373).
component("YPR176C",964).
component("YPL172C",923).
component("YNR041C",838).
component("YMR101C",774).
component("YDL090C",299).
component("YBR003W",213).
component("YBR002C",212).
component("YJL167W",613).
component("YJL167W",614).
component("YNL256W",819).
component("YPR069C",953).
component("YDR127W",345).
component("YHR190W",559).
component("YLR146C",710).
component("YHR068W",543).
component("YLR303W",731).
component("YGR012W",482).
component("YML082W",759).
component("YJR130C",637).
component("YDR035W",331).
component("YBR249C",254).
component("YLR180W",719).
component("YDR502C",385).
component("YOR274W",893).
component("YOL143C",864).
component("YBR256C",256).
component("YHR137W",552).
component("YGL202W",474).
component("YLR027C",696).
component("YKL106W",656).
component("YOL140W",863).
component("YLR438W",747).
component("YKL104C",655).
component("YGR019W",483).
component("YDR111C",342).
component("U64_",160).
component("U61_",157).
component("U51_",147).
...
component("YNR058W",842).
component("YIL116W",574).
component("YGL253W",480).
component("YFR053C",452).
component("YMR013C",769).
component("YMR205C",787).
component("YGR240C",512).
component("YOL016C",847).
component("YFR014C",445).
component("YLR240W",725).
component("YKL203C",674).
component("YJR066W",629).
component("YCR036W",279).
component("YGR194C",505).
component("YCL040W",269).
component("YJR105W",635).
component("U16_",76).
component("YPL188W",925).
component("YJR049C",626).
component("YEL041W",397).
component("U96_",190).
component("YKL001C",646).
component("YDR236C",357).
component("YML070W",757).
component("YFL053W",442).
component("YHL032C",525).
component("YLR133W",706).
component("YDR531W",390).
component("U83_",179).
component("U82_",178).
component("U81_",177).
component("YMR208W",788).
component("YPL203W",926).
component("YOR061W",868).
component("YKL166C",665).
component("YJL164C",611).
component("YIL035C",566).
component("YHR205W",561).
component("YHR102W",550).
component("YGL019W",459).
component("YHR025W",535).
component("YNR012W",832).
component("YPR121W",958).
component("YPL258C",936).
component("YOL055C",851).
component("YPL214C",929).
component("U1_",100).
component("YDR009W",328).
component("YBR020W",220).
component("YFR019W",447).
component("YDR208W",354).
component("YDR127W",346).
component("U21_",112).
component("U20_",107).
component("YDR147W",349).
component("YDR300C",364).
component("YCR012W",276).
component("YER052C",410).
component("U19_",99).
component("U18_",91).
component("U17_",83).
component("U76_",173).
component("YMR220W",790).
component("YER170W",432).
component("YDR226W",355).
component("YKL067W",653).
component("YOL055C",852).
component("YDR454C",382).
component("YOL061W",856).
component("YKL181W",666).
component("YHL011C",522).
component("YER099C",428).
component("YBL068W",207).
component("YOR143C",878).
component("YNL256W",820).
component("YLR328W",735).
component("YBR018C",216).
component("YBR018C",217).
component("YDL055C",292).
component("YGR007W",481).
component("YGR202C",507).
component("YLR328W",736).
component("YKR002W",679).
component("YDL045C",289).
component("YDL103C",304).
component("U94_",189).
component("YJR010W",623).
component("YBR029C",222).
component("YCL050C",271).
component("YGL130W",468).
component("YDR530C",389).
component("YCL050C",272).
component("YPR190C",967).
component("YPR187W",966).
component("YPR110C",957).
component("YPR010C",947).
component("YOR341W",901).
component("YOR340C",900).
component("YOR224C",889).
component("YOR210W",887).
component("YOR207C",885).
component("YOR151C",879).
component("YOR116C",874).
component("YOL005C",844).
component("YNR003C",831).
component("YNL248C",818).
component("YNL151C",814).
component("YNL113W",808).
component("YKL144C",661).
component("YJR063W",628).
component("YJL148W",608).
component("YJL140W",607).
component("YIL021W",565).
component("YHR143W-A",553).
component("YGL070C",466).
component("YFL036W",441).
component("YDR404C",376).
component("YDR156W",351).
component("YDR045C",334).
...
component("YNL299W",827).
component("YNL262W",821).
component("YNL102W",807).
component("YJR043C",625).
component("YJR006W",621).
component("YJL090C",599).
component("YIL139C",576).
component("YEL055C",400).
component("YDR419W",379).
component("YDR121W",343).
component("YDL102W",303).
component("YCR014C",277).
component("YBR278W",258).
component("YBL035C",202).
component("YKL035W",650).
component("YHL012W",523).
component("YHR123W",551).
component("YBR243C",252).
component("YNL130C",810).
component("YDL142C",313).
component("YPL148C",920).
component("YOR251C",892).
component("YGR286C",519).
component("YJL068C",595).
component("YDR058C",338).
component("YNR034W",837).
component("YHR163W",556).
component("YGR248W",514).
component("YCR073W-A",282).
component("YDL086W",298).
component("YOL011W",846).
component("YMR008C",767).
component("YMR006C",766).
component("U105_",27).
component("U101_",23).
component("YJL068C",596).
component("YPL072W",915).
component("YOR124C",875).
component("YNL186W",815).
component("YMR304W",798).
component("YMR223W",791).
component("YKR098C",690).
component("YJL197W",615).
component("YIL156W",579).
component("YFR010W",444).
component("YER151C",431).
component("YER144C",430).
component("YER098W",427).
component("YDR069C",339).
component("YDL122W",305).
component("YBR058C",228).
component("YBL067C",206).
component("YJR019C",624).
component("YDR272W",360).
component("U84_",180).
component("YDR481C",383).
component("YLR377C",741).
component("YDR074W",340).
component("YFR025C",448).
component("YPL179W",924).
component("YNR032W",835).
component("YML057W",756).
component("YML016C",750).
component("YLR433C",746).
component("YGR123C",492).
component("YER133W",429).
component("YER089C",424).
component("YDR436W",380).
component("YDR075W",341).
component("YDL188C",319).
component("YDL134C",307).
component("YDL047W",290).
component("YDL006W",283).
component("YBR125C",240).
component("YBL056W",205).
component("YPR073C",954).
component("YHR215W",563).
component("YDL024C",286).
component("YBR093C",235).
component("YBR092C",234).
component("YIL053W",568).
component("YER062C",417).
component("YHR046C",539).
component("U9_",192).
component("YGR208W",511).
component("YPL228W",931).
component("YMR180C",784).
...
component("U26_",122).
component("U24_",121).
component("YHR044C",538).
component("YHR043C",537).
component("YOL064C",857).
component("YPL268W",940).
component("YOR360C",903).
component("YGL248W",479).
component("YKR031C",682).
component("YPL206C",927).
component("YGL027C",461).
component("YLR286C",729).
component("YJR153W",643).
component("YJL221C",620).
component("YJL216C",618).
component("YIL172C",585).
component("YGR292W",521).
component("YGR287C",520).
component("YBR299W",262).
component("YBR184W",248).
component("YIL162W",582).
component("YPR026W",948).
component("YDR001C",326).
component("YBR001C",211).
component("YDR400W",374).
component("U102_",24).
component("YER043C",409).
component("YNL045W",803).
component("YLR160C",715).
component("YLR158C",714).
component("YLR157C",713).
component("YLR155C",712).
component("YDR321W",365).
component("YGL037C",462).
component("U43_",139).
component("U42_",138).
component("YMR293C",796).
component("YDR242W",358).
component("YLR308W",734).
component("YLR307W",733).
component("U53_",148).
component("YLR420W",744).
component("YPL111W",918).
component("YIR032C",588).
component("YIR029W",586).
component("YMR120C",780).
component("YLR028C",698).
component("YHR144C",554).
component("YHR144C",555).
component("YCL030C",267).
component("YNL141W",811).
component("YBL033C",201).
component("YBR153W",245).
component("YDL238C",324).
component("YNL141W",812).
component("YLR245C",726).
component("YML035C",753).
component("YGR204W",509).
component("YBR084W",232).
component("YJL126W",602).
component("U44_",140).
...
component("YBR252W",255).
component("YCL030C",268).
component("YER005W",405).
component("YBL099W",210).
component("U60_",156).
component("YLR231C",723).
component("U88_",183).
component("YDR538W",392).
component("YLR134W",707).
component("YLR044C",700).
component("YGR087C",489).
component("YDR380W",372).
component("YDL080C",295).
component("YMR250W",792).
component("YKL184W",670).
component("YEL021W",395).
component("YNR043W",839).
component("U93_",188).
component("YDR047W",336).
component("U54_",149).
component("YKL211C",675).
component("YKR097W",689).
component("YOL052C",850).
component("YGR170W",497).
component("YKL060C",652).
component("YDR294C",361).
component("YEL046C",398).
component("YNR033W",836).
component("YPR006C",946).
component("YER065C",418).
component("YKL211C",676).
component("YER090W",425).
component("YDR127W",347).
component("YPL281C",944).
component("YOR393W",908).
component("YMR323W",799).
component("YHR174W",557).
component("YGR254W",515).
component("YPL262W",937).
component("YGL026C",460).
component("YGR155W",496).
component("YLR304C",732).
component("YJL200C",616).
component("YGL009C",456).
component("YNL316C",828).
component("YKL182W",668).
component("YPL212C",928).
component("YNL292W",826).
component("YGL063W",465).
component("YFL001W",435).
component("YOR278W",894).
component("U49_",144).
component("YCR053W",281).
component("YDR127W",348).
component("YGL148W",469).
component("YIL168W",584).
component("YIL167W",583).
component("YCL064C",273).
component("YCL064C",274).
component("YHR018C",531).
component("YLR359W",740).
component("YFR055W",453).
component("YJL005W",591).
component("YOR176W",882).
component("YJL121C",601).
component("YBR019C",218).
component("YBR019C",219).
component("U59_",154).
component("YDR050C",337).
component("YDR007W",327).
component("YOR095C",872).
component("YER003C",404).
component("YBR196C",249).
component("YGL001C",455).
component("YPL117C",919).
component("U14_",61).
component("YOL056W",853).
component("YKL152C",664).
component("YDL021W",284).
component("YMR105C",775).
component("YKL127W",658).
component("YEL058W",401).
component("YPR060C",952).
component("YHR072W",544).
component("YJL153C",609).
component("YGR264C",518).
component("YGR171C",498).
component("YHR011W",530).
component("YDR023W",330).
component("YPL104W",917).
component("YLL018C",691).
component("YPR081C",956).
component("YBR121C",239).
component("YHR020W",534).
component("YER087W",423).
component("YOL033W",849).
component("YGL245W",478).
component("YOR168W",880).
component("YHR091C",546).
component("YDR341C",366).
component("YOL097C",860).
component("YDR268W",359).
component("YPR047W",951).
component("YLR060W",702).
component("YFL022C",439).
component("YPR033C",949).
component("YHR019C",532).
component("YHR019C",533).
component("YKL194C",673).
component("YIL078W",571).
component("YPL160W",921).
component("YLR382C",742).
component("YPL040C",913).
component("YBL076C",208).
component("YNL073W",806).
component("YDR037W",332).
component("YOR335C",899).
component("YGR094W",490).
component("YLR153C",711).
component("YAL054C",194).
component("YGR244C",513).
component("YPR035W",950).
component("YIL145C",577).
component("U89_",184).
component("YOR241W",891).
component("YMR113W",777).
component("YKL132C",659).
component("YJL101C",600).
component("U92_",187).
component("YAR015W",196).
component("YGL234W",476).
component("YER183C",434).
component("U90_",186).
component("YNR057C",841).
component("YDL141W",309).
component("YDL141W",310).
component("YGL234W",477).
component("YDL141W",311).
component("YGR204W",510).
component("YOL058W",854).
component("YDL141W",312).
component("YHR074W",545).
component("YMR217W",789).
component("YPR145W",960).
component("YGR124W",493).
component("YOR303W",895).
component("YJR109C",636).
component("YJL130C",605).
component("YGL062W",464).
component("YBR218C",250).
component("YPL231W",935).
component("YNR016C",833).
component("YKL182W",669).
component("YGR037C",484).
component("YOR005C",866).
component("YDL164C",315).
component("YJL087C",597).
component("YOL010W",845).
component("YPR138C",959).
component("YPL265W",938).
component("YPL057C",914).
component("YOR348C",902).
component("YOR192C",884).
component("YOR171C",881).
component("YOR130C",876).
component("YOR071C",870).
component("YOR011W",867).
component("YOL156W",865).
component("YOL103W",861).
component("YOL020W",848).
component("YNR072W",843).
component("YNL318C",829).
component("YNL270C",822).
component("YNL142W",813).
component("YMR272C",795).
component("YMR202W",786).
component("YMR056C",771).
component("YMR011W",768).
component("YML123C",764).
component("YLR348C",737).
component("YLR260W",728).
component("YLR237W",724).
component("YLR138W",708).
component("YLR100C",705).
component("YLR092W",704).
component("YLR081W",703).
component("YLL061W",694).
component("YLL043W",693).
component("YKR093W",688).
component("YKR053C",684).
component("YKR039W",683).
component("YKL217W",678).
component("YKL120W",657).
component("YKL004W",647).
component("YJR158W",644).
component("YJR095W",633).
component("YJR077C",631).
component("YJL219W",619).
component("YJL214W",617).
component("YJL134W",606).
component("YJL129C",603).
component("YHR096C",549).
component("YHR094C",548).
component("YHR092C",547).
component("YHL036W",526).
component("YHL016C",524).
component("YGR191W",503).
component("YGR125W",494).
component("YGR121C",491).
component("YGR065C",488).
component("YGR055W",486).
component("YGL186C",471).
component("YFL055W",443).
component("YFL011W",436).
component("YER060W-A",414).
component("YER060W",413).
component("YER056C",412).
component("YER053C",411).
component("YEL069C",403).
component("YEL063C",402).
component("YDR536W",391).
component("YDR508C",387).
component("YDR503C",386).
component("YDR497C",384).
component("YDR345C",369).
component("YDR343C",368).
component("YDR342C",367).
component("YDR297W",363).
component("YDR294C",362).
component("YDR046C",335).
component("YDL245C",325).
component("YDL210W",320).
component("YCR028C",278).
component("YCL025C",265).
component("YBR298C",261).
component("YBR294W",260).
component("YBR291C",259).
component("YBR085W",233).
component("YBR069C",230).
component("YBR068C",229).
component("YBR036C",225).
component("YBL042C",203).
component("YBL030C",200).
component("U85_",181).
component("U7_",176).
component("U79_",175).
component("U78_",174).
