...
component("YNL280C",605).
component("YLR056W",506).
component("YKR009C",491).
component("YMR083W",562).
component("YPL231W",683).
component("YBR149W",170).
component("YJR159W",465).
component("YGL001C",322).
component("YHR063C",388).
component("YML056C",547).
component("YLR432W",541).
component("YHR216W",405).
component("YAR075W",139).
component("YAR073W",138).
component("YCL030C",188).
component("YDR127W",243).
component("YJR139C",461).
component("YOR136W",642).
component("YNL009W",584).
component("YLR174W",519).
component("YDL066W",205).
component("YHR183W",400).
component("YGR256W",371).
component("YNL241C",599).
component("YOL059W",628).
component("YDL022W",200).
component("YCL018W",186).
component("YLR355C",535).
component("YML054C",546).
component("YIL155C",414).
component("YEL024W",279).
component("YJR078W",456).
component("U58_",110).
component("YGR255C",370).
component("U108_",26).
component("YMR015C",559).
component("YDR402C",262).
component("YGL055W",329).
component("YJL026W",424).
component("YIL066C",410).
component("YGR180C",360).
component("YER070W",295).
component("U36_",95).
component("U35_",94).
component("YJR009C",447).
component("YJL052W",425).
component("YGR192C",362).
component("YOR374W",664).
component("YER073W",296).
component("U68_",116).
component("YGL154C",336).
component("U55_",108).
component("YER069W",294).
component("YOR323C",657).
component("U2_",89).
component("YBR221C",177).
component("YBR166C",173).
component("YNL280C",606).
component("YGL012W",324).
component("YKL182W",481).
...
component("YJR051W",451).
component("YOR375C",665).
component("YDL215C",226).
component("YAL062W",137).
component("U100_",20).
component("YBR035C",156).
component("YMR189W",570).
component("U56_",109).
component("YKR080W",497).
component("YPL023C",669).
component("YGL125W",333).
component("YOR236W",652).
component("YGR204W",365).
component("YBR084W",162).
component("YLR142W",513).
component("U65_",114).
component("U62_",112).
component("YHR068W",389).
component("YKL150W",477).
component("YIL043C",408).
component("YHR042W",383).
component("YOR221C",650).
component("YMR145C",567).
component("YML120C",552).
component("YKL192C",484).
component("YKL055C",468).
component("YER061C",290).
component("YDL085W",208).
component("YBR046C",158).
component("YMR145C",568).
component("YML120C",553).
component("YKL192C",485).
component("YDL085W",209).
component("YPL017C",668).
component("YFL018C",311).
component("YPL091W",672).
component("YER042W",284).
component("YNL052W",586).
component("YMR256C",578).
component("YLR395C",539).
component("YLR038C",504).
component("YIL111W",412).
component("YHR051W",387).
component("YGL191W",339).
component("YGL187C",338).
component("YDL067C",206).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",689).
component("YBR034C",155).
component("YPL273W",691).
component("YLL062C",501).
component("YDR410C",264).
component("YKR069W",496).
component("U47_",102).
component("YER091C",300).
component("YJR073C",454).
component("YDL033C",201).
component("YOL096C",631).
component("YLR172C",518).
component("YMR120C",566).
component("YBL013W",140).
component("YJL130C",433).
component("YJL088W",428).
component("YPR074C",702).
component("YBR117C",166).
component("YMR108W",564).
component("YCL009C",185).
component("YMR062C",561).
component("YNL071W",587).
component("YIL160C",417).
component("YNR019W",615).
component("YCR048W",197).
component("U48_",103).
component("YNL277W",604).
component("YFL017C",310).
component("YPL231W",684).
component("YER061C",291).
component("U86_",129).
component("YDL052C",203).
component("U8_",132).
component("YDR148C",249).
component("YOR377W",666).
component("YGR177C",359).
component("YPL231W",685).
component("YLR195C",521).
component("YLR299W",527).
component("YPR001W",693).
component("YNR001C",611).
component("YCR005C",193).
component("YML126C",555).
component("YDL182W",223).
component("YDL131W",215).
component("YNL117W",591).
component("YIR031C",422).
component("YPR160W",708).
component("YOR321W",656).
component("YJR143C",462).
component("YGR199W",364).
component("YDL095W",211).
component("YDL093W",210).
component("YAL023C",136).
component("YPL227C",681).
component("YMR261C",579).
component("YML100W",551).
component("YBR126C",169).
component("YNL192W",598).
component("YBR038W",157).
component("YBR023C",153).
component("YEL011W",277).
component("YLR209C",522).
component("U104_",24).
component("U103_",23).
component("YOR209C",648).
component("YMR300C",581).
component("YDR354W",258).
component("YFR047C",319).
component("YJR133W",460).
component("U22_",84).
component("YLR209C",523).
component("YDR399W",260).
component("YJL167W",440).
component("YNL256W",601).
component("YPR069C",701).
component("YDR127W",244).
component("YHR190W",401).
component("YHR068W",390).
component("YLR303W",528).
component("YML082W",550).
component("YJR130C",459).
component("YDR035W",232).
component("YBR249C",178).
component("YLR180W",520).
component("YDR502C",270).
component("YOL143C",635).
component("YBR256C",180).
component("YHR137W",395).
component("YGL202W",340).
component("YLR027C",502).
component("YKL106W",471).
component("YOL140W",634).
component("YLR438W",543).
component("YKL104C",470).
component("YGR019W",347).
component("YDR111C",241).
component("U64_",113).
component("U51_",106).
component("YJR148W",463).
component("YHR208W",404).
component("YOR184W",646).
component("YNR058W",620).
component("YGL253W",346).
component("YFR053C",320).
component("YMR013C",558).
component("YMR205C",572).
component("YGR240C",368).
component("YLR240W",525).
component("YKL203C",487).
component("YJR066W",453).
component("YCR036W",196).
component("YGR194C",363).
component("YCL040W",190).
component("YJR105W",458).
component("U16_",56).
component("YKL001C",466).
component("YML070W",549).
component("YFL053W",314).
component("YDR531W",274).
component("U82_",127).
component("U81_",126).
component("YMR208W",573).
component("YPL203W",679).
component("YOR061W",637).
component("YKL166C",479).
component("YJL164C",439).
component("YIL035C",407).
component("YHR205W",403).
component("YHR102W",393).
component("YGL019W",325).
component("YHR025W",382).
component("YNR012W",613).
component("YPR121W",705).
component("YPL258C",687).
component("YOL055C",626).
component("U1_",73).
component("YDR009W",230).
component("YBR020W",152).
component("YFR019W",317).
component("YDR208W",251).
component("YDR127W",245).
component("U21_",81).
component("YDR147W",248).
component("YDR300C",256).
component("YCR012W",194).
component("YER052C",286).
component("U19_",72).
component("U18_",66).
component("U17_",61).
component("U76_",123).
component("YMR220W",575).
component("YER170W",306).
component("YDR226W",252).
component("YKL067W",469).
component("YOL055C",627).
component("YDR454C",267).
component("YOL061W",629).
component("YKL181W",480).
component("YHL011C",376).
component("YER099C",302).
component("YBL068W",146).
component("YOR143C",643).
component("YNL256W",602).
component("YLR328W",532).
component("YBR018C",150).
component("YDL055C",204).
component("YLR328W",533).
component("YDL103C",213).
component("U94_",134).
component("YJR010W",448).
component("YBR029C",154).
component("YGL130W",334).
component("YDR530C",273).
component("YPR190C",711).
component("YPR187W",710).
component("YPR110C",704).
component("YPR010C",695).
component("YOR341W",661).
component("YOR340C",660).
component("YOR224C",651).
component("YOR210W",649).
component("YOR207C",647).
component("YOR151C",644).
component("YOR116C",639).
component("YOL005C",621).
component("YNR003C",612).
component("YNL248C",600).
component("YNL151C",596).
component("YNL113W",590).
component("YKL144C",476).
component("YJR063W",452).
component("YJL148W",436).
component("YJL140W",435).
component("YIL021W",406).
component("YHR143W-A",396).
component("YGL070C",332).
component("YFL036W",313).
component("YDR404C",263).
component("YDR156W",250).
component("YDR045C",235).
component("YDL150W",222).
component("YDL140C",217).
component("YBR154C",172).
component("YPR175W",709).
component("YPL167C",677).
component("YOR330C",658).
component("YOL115W",633).
component("YNL299W",608).
component("YNL262W",603).
component("YNL102W",589).
component("YJR043C",450).
component("YJR006W",446).
component("YJL090C",429).
component("YIL139C",413).
component("YEL055C",280).
component("YDR419W",265).
component("YDR121W",242).
component("YDL102W",212).
component("YCR014C",195).
component("YBR278W",181).
component("YBL035C",142).
component("YKL035W",467).
component("YHL012W",377).
component("YHR123W",394).
component("YNL130C",592).
component("YPL148C",675).
component("YOR251C",654).
component("YGR286C",373).
component("YDR058C",237).
component("YOL011W",623).
component("YMR008C",557).
component("YMR006C",556).
component("U105_",25).
component("U101_",21).
component("YJL068C",426).
component("YPL072W",671).
component("YOR124C",640).
component("YNL186W",597).
component("YMR304W",582).
component("YMR223W",576).
component("YKR098C",499).
component("YJL197W",441).
component("YIL156W",415).
component("YFR010W",316).
component("YER151C",305).
component("YER144C",304).
component("YER098W",301).
component("YDR069C",238).
component("YDL122W",214).
component("YBR058C",159).
component("YBL067C",145).
component("YJR019C",449).
component("YDR481C",268).
component("YLR377C",537).
component("YDR074W",239).
component("YFR025C",318).
component("YPL179W",678).
component("YNR032W",616).
component("YML057W",548).
component("YML016C",544).
component("YLR433C",542).
component("YGR123C",354).
component("YER133W",303).
component("YER089C",298).
component("YDR436W",266).
component("YDR075W",240).
component("YDL188C",224).
component("YDL134C",216).
component("YDL047W",202).
component("YDL006W",199).
component("YBR125C",168).
component("YBL056W",144).
component("YIL053W",409).
component("YER062C",292).
component("YHR046C",386).
component("U9_",135).
component("YGR208W",367).
component("YPL228W",682).
component("YMR180C",569).
component("YJL155C",438).
component("U34_",93).
component("U33_",92).
component("U32_",91).
component("U30_",90).
...
component("YOL064C",630).
component("YPL268W",690).
component("YOR360C",663).
component("YGL248W",345).
component("YKR031C",493).
component("YGL027C",327).
component("YLR286C",526).
component("YJR153W",464).
component("YJL221C",445).
component("YJL216C",443).
component("YIL172C",421).
component("YGR292W",375).
component("YGR287C",374).
component("YBR299W",184).
component("YBR184W",174).
component("YIL162W",418).
component("YPR026W",696).
component("YDR001C",228).
component("YBR001C",149).
component("YDR400W",261).
component("U102_",22).
component("YER043C",285).
component("YNL045W",585).
component("YLR160C",517).
component("YLR158C",516).
component("YLR157C",515).
component("YLR155C",514).
component("YDR321W",257).
component("YGL037C",328).
component("U43_",100).
component("U42_",99).
component("YLR308W",531).
component("YLR307W",530).
component("U53_",107).
component("YLR420W",540).
component("YPL111W",673).
component("YIR032C",423).
component("YLR028C",503).
component("YHR144C",397).
component("YHR144C",398).
component("YNL141W",593).
component("YBR153W",171).
component("YDL238C",227).
component("YNL141W",594).
component("YML035C",545).
component("YBR084W",163).
component("YJL126W",431).
component("U44_",101).
component("U39_",96).
component("YHR201C",402).
component("YBR111C",165).
component("YBR252W",179).
component("YCL030C",189).
component("YER005W",282).
component("YBL099W",148).
component("YLR231C",524).
component("U88_",130).
component("YDR538W",276).
component("YLR134W",511).
component("YLR044C",505).
component("YGR087C",351).
component("YDR380W",259).
component("YDL080C",207).
component("YMR250W",577).
component("YKL184W",483).
component("YEL021W",278).
component("YNR043W",618).
component("YKL211C",488).
component("YKR097W",498).
component("YOL052C",625).
component("YDR294C",253).
component("YNR033W",617).
component("YPR006C",694).
component("YER065C",293).
component("YKL211C",489).
component("YER090W",299).
component("YDR127W",246).
component("YPL281C",692).
component("YOR393W",667).
component("YMR323W",583).
component("YHR174W",399).
component("YGR254W",369).
component("YGL026C",326).
component("YGR155W",357).
component("YLR304C",529).
component("YJL200C",442).
component("YNL316C",609).
component("YPL212C",680).
component("YNL292W",607).
...
component("YCL064C",191).
component("YCL064C",192).
component("YLR359W",536).
component("YFR055W",321).
component("YJL121C",430).
component("YBR019C",151).
component("YDR007W",229).
component("YOR095C",638).
component("YBR196C",175).
component("YGL001C",323).
component("YPL117C",674).
component("U14_",47).
component("YKL152C",478).
component("YMR105C",563).
component("YKL127W",473).
component("YEL058W",281).
component("YPR060C",700).
component("YHR072W",391).
component("YJL153C",437).
component("YGR264C",372).
component("YGR171C",358).
component("YHR011W",379).
component("YDR023W",231).
component("YPR081C",703).
component("YBR121C",167).
component("YHR020W",381).
component("YER087W",297).
component("YGL245W",344).
component("YOR168W",645).
component("YPR047W",699).
component("YLR060W",507).
component("YFL022C",312).
component("YPR033C",697).
component("YHR019C",380).
component("YKL194C",486).
component("YIL078W",411).
component("YPL160W",676).
component("YLR382C",538).
component("YPL040C",670).
component("YBL076C",147).
component("YNL073W",588).
component("YDR037W",233).
component("YOR335C",659).
component("YGR094W",352).
component("YPR035W",698).
component("U89_",131).
component("YOR241W",653).
component("YMR113W",565).
component("YKL132C",474).
component("YGL234W",342).
component("YER183C",307).
component("U90_",133).
component("YNR057C",619).
component("YDL141W",218).
component("YDL141W",219).
component("YGL234W",343).
component("YDL141W",220).
component("YGR204W",366).
component("YDL141W",221).
component("YHR074W",392).
component("YMR217W",574).
component("YPR145W",707).
component("YGR124W",355).
component("YOR303W",655).
component("YGL062W",330).
component("YBR218C",176).
component("YPL231W",686).
component("YNR016C",614).
component("YKL182W",482).
component("YGR037C",348).
component("YJL087C",427).
component("YOL010W",622).
component("YPR138C",706).
component("YPL265W",688).
component("YOR348C",662).
component("YOR130C",641).
component("YOL156W",636).
component("YOL103W",632).
component("YOL020W",624).
component("YNL318C",610).
component("YNL142W",595).
component("YMR272C",580).
component("YMR202W",571).
component("YMR056C",560).
component("YML123C",554).
component("YLR348C",534).
component("YLR138W",512).
component("YLR100C",510).
component("YLR092W",509).
component("YLR081W",508).
component("YLL061W",500).
component("YKR053C",495).
component("YKR039W",494).
component("YKL217W",490).
component("YKL120W",472).
component("YJR095W",457).
component("YJR077C",455).
component("YJL219W",444).
component("YJL134W",434).
component("YJL129C",432).
component("YHL036W",378).
component("YGR191W",361).
component("YGR125W",356).
...
component("YER060W-A",289).
component("YER060W",288).
component("YER056C",287).
component("YDR536W",275).
component("YDR508C",272).
component("YDR503C",271).
component("YDR497C",269).
component("YDR297W",255).
component("YDR294C",254).
component("YDR046C",236).
component("YDL210W",225).
component("YCL025C",187).
component("YBR294W",183).
component("YBR291C",182).
component("YBR085W",164).
component("YBR069C",161).
component("YBR068C",160).
component("YBL042C",143).
component("YBL030C",141).
component("U85_",128).
component("U7_",125).
component("U79_",124).
component("U75_",122).
