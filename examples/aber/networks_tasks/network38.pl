...
component("YNL280C",284).
component("YLR056W",234).
component("YMR083W",261).
component("YGL001C",155).
component("YDR127W",112).
component("YJR139C",213).
component("YNL009W",275).
component("YLR174W",241).
component("YHR183W",190).
component("YGR256W",175).
component("YCL018W",85).
component("YJR078W",210).
component("YMR015C",259).
component("YDR402C",124).
component("YGL055W",158).
component("YJL026W",196).
component("YGR180C",172).
component("YER069W",141).
component("YOR323C",305).
component("YBR166C",80).
component("YNL280C",285).
component("YKL141W",220).
component("YOR375C",308).
component("YDL215C",104).
component("YAL062W",63).
component("U100_",20).
component("U56_",55).
component("YPL023C",310).
component("YGL125W",159).
component("YOR236W",303).
component("YMR145C",264).
component("YDL085W",96).
component("YBR046C",71).
component("YNL052W",276).
component("YMR256C",270).
component("YLR395C",250).
component("YLR038C",232).
component("YIL111W",192).
component("YHR051W",184).
component("YGL191W",163).
component("YGL187C",162).
component("YDL067C",94).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",319).
component("YLL062C",229).
component("YDR410C",125).
component("YJR073C",208).
component("YOL096C",296).
component("YMR120C",263).
component("YJL130C",201).
component("YJL088W",198).
component("YPR074C",324).
component("YBR117C",77).
component("YCL009C",84).
component("YNL071W",277).
component("YNR019W",290).
component("YCR048W",91).
component("U48_",52).
component("YPL231W",315).
component("YDL052C",93).
component("U8_",59).
component("YPL231W",316).
component("YLR299W",244).
component("YCR005C",88).
component("YML126C",255).
component("YNL117W",279).
component("YIR031C",195).
component("YOR321W",304).
component("YJR143C",214).
component("YGR199W",173).
component("YDL095W",98).
component("YDL093W",97).
component("YAL023C",62).
component("YMR261C",271).
component("YML100W",253).
component("YBR126C",78).
component("YDR354W",121).
component("YFR047C",153).
component("U22_",43).
component("YDR399W",123).
component("YPR069C",323).
component("YDR127W",113).
component("YML082W",252).
component("YJR130C",212).
component("YDR035W",108).
component("YBR249C",82).
component("YHR137W",186).
component("YGL202W",164).
component("YLR027C",230).
component("YKL106W",218).
component("YOL140W",299).
component("YLR438W",251).
component("U51_",53).
component("YJR148W",215).
component("YMR013C",258).
component("YCR036W",90).
component("YCL040W",87).
component("YJR105W",211).
component("YMR208W",266).
component("YHR025W",181).
component("YNR012W",288).
component("YFR019W",151).
component("YDR208W",118).
component("YDR127W",114).
component("YDR147W",117).
component("YER052C",137).
component("U19_",38).
component("U18_",35).
component("U76_",58).
component("YMR220W",267).
component("YDR226W",119).
component("YKL067W",217).
component("YDR454C",127).
component("YOL061W",295).
component("YKL181W",221).
component("YHL011C",177).
component("YER099C",144).
component("YBL068W",68).
component("YOR143C",302).
component("YLR328W",247).
component("U94_",60).
component("YBR029C",70).
component("YPR175W",327).
component("YPL167C",314).
component("YOR330C",306).
component("YOL115W",298).
component("YNL299W",286).
component("YNL262W",283).
component("YNL102W",278).
component("YJR043C",207).
component("YJR006W",206).
component("YJL090C",199).
component("YIL139C",193).
component("YEL055C",134).
component("YDR419W",126).
component("YDR121W",111).
component("YDL102W",99).
component("YCR014C",89).
component("YBR278W",83).
component("YBL035C",65).
component("YKL035W",216).
component("YHL012W",178).
component("YOL011W",293).
component("YMR008C",257).
component("YMR006C",256).
component("U105_",21).
component("YPL072W",312).
component("YOR124C",301).
component("YNL186W",282).
component("YMR304W",273).
component("YMR223W",268).
component("YKR098C",228).
component("YJL197W",205).
component("YIL156W",194).
component("YFR010W",150).
component("YER151C",146).
component("YER144C",145).
component("YER098W",143).
component("YDR069C",110).
component("YDL122W",100).
component("YBR058C",72).
component("YBL067C",67).
component("YFR025C",152).
component("U9_",61).
...
component("U30_",45).
component("U24_",44).
component("YHR044C",183).
component("YHR043C",182).
component("YLR286C",243).
component("YLR160C",240).
component("YLR158C",239).
component("YLR157C",238).
component("YLR155C",237).
component("YDR321W",120).
component("YGL037C",157).
component("U43_",50).
component("U42_",49).
component("YLR308W",246).
component("YLR307W",245).
component("U53_",54).
component("YLR028C",231).
component("YHR144C",187).
component("YHR144C",188).
component("YBR153W",79).
component("YDL238C",105).
component("YNL141W",280).
component("U44_",51).
component("YHR201C",191).
component("YBR111C",76).
component("YER005W",136).
component("YLR231C",242).
component("YDR538W",132).
component("YLR134W",236).
component("YLR044C",233).
component("YGR087C",167).
component("YDR380W",122).
component("YDL080C",95).
component("YMR250W",269).
component("YKL184W",223).
component("YEL021W",133).
component("YKL211C",224).
component("YNR033W",291).
component("YKL211C",225).
component("YER090W",142).
component("YDR127W",115).
component("YPL281C",320).
component("YOR393W",309).
component("YMR323W",274).
component("YHR174W",189).
component("YGR254W",174).
component("YGL026C",156).
component("YGR155W",170).
component("YNL316C",287).
component("YCR053W",92).
component("YDR127W",116).
component("YGL148W",160).
component("YFR055W",154).
component("YJL121C",200).
component("YDR007W",106).
component("YOR095C",300).
component("YBR196C",81).
component("U14_",29).
component("YMR105C",262).
component("YKL127W",219).
component("YEL058W",135).
component("YPR060C",322).
component("YHR072W",185).
component("YJL153C",203).
component("YGR264C",176).
component("YGR171C",171).
component("YHR011W",179).
component("YDR023W",107).
component("YGL245W",165).
component("YPR047W",321).
component("YLR060W",235).
component("YFL022C",148).
component("YHR019C",180).
component("YPL160W",313).
component("YLR382C",249).
component("YPL040C",311).
component("YBL076C",69).
component("YER183C",147).
component("YDL141W",101).
component("YDL141W",102).
component("YPR145W",326).
component("YGR124W",169).
component("YPL231W",317).
component("YNR016C",289).
component("YKL182W",222).
component("YGR037C",166).
component("YJL087C",197).
component("YOL010W",292).
component("YPR138C",325).
component("YPL265W",318).
component("YOR348C",307).
component("YOL103W",297).
component("YOL020W",294).
component("YNL142W",281).
component("YMR272C",272).
component("YMR202W",265).
component("YMR056C",260).
component("YML123C",254).
component("YLR348C",248).
component("YKR053C",227).
component("YKR039W",226).
component("YJR077C",209).
component("YJL134W",202).
component("YGR121C",168).
...
component("YDR046C",109).
component("YDL210W",103).
component("YCL025C",86).
component("YBR085W",75).
component("YBR069C",74).
component("YBR068C",73).
component("YBL042C",66).
component("YBL030C",64).
component("U6_",57).
component("U5_",56).
component("U228_",42).
component("U222_",41).
