...
component("YML056C",589).
component("YLR432W",583).
...
component("YOR136W",687).
component("YNL009W",626).
component("YLR174W",559).
component("YDL066W",223).
component("YHR183W",431).
component("YGR256W",400).
component("YNL241C",641).
component("YOL059W",671).
component("YDL022W",218).
component("YCL018W",204).
component("YLR355C",577).
component("YIL074C",442).
component("YER081W",323).
component("YML054C",588).
component("YIL155C",447).
component("YEL024W",302).
component("YKR066C",534).
component("YJR078W",491).
component("U58_",124).
component("YGR255C",399).
component("U108_",26).
component("YMR015C",601).
component("YDR402C",285).
component("YGL055W",357).
component("YJL026W",457).
component("YIL066C",441).
...
component("YJL052W",458).
component("YGR192C",391).
component("YOR374W",710).
...
component("YOR375C",711).
component("YDL215C",245).
component("YAL062W",152).
component("U100_",20).
component("YBR035C",172).
component("YMR189W",612).
component("U56_",122).
component("YKR080W",536).
component("YPL023C",716).
component("YGL125W",361).
component("YOR236W",698).
component("YGR204W",394).
component("YBR084W",178).
component("YLR142W",553).
component("U65_",128).
component("U62_",126).
component("YHR068W",420).
component("YKL150W",513).
component("YIL043C",439).
component("YHR042W",414).
component("YOR221C",696).
component("YMR145C",609).
component("YML120C",594).
component("YKL192C",521).
component("YKL055C",504).
component("YER061C",316).
component("YDL085W",226).
component("YBR046C",174).
component("YMR145C",610).
component("YML120C",595).
component("YKL192C",522).
component("YDL085W",227).
component("YPL017C",715).
component("YFL018C",338).
component("YPL091W",719).
component("YER042W",310).
component("YPR167C",760).
component("YNL052W",628).
component("YMR256C",620).
component("YLR395C",581).
component("YLR038C",544).
component("YIL111W",444).
component("YHR051W",418).
component("YGL191W",367).
component("YGL187C",366).
component("YDL067C",224).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",740).
component("YBR034C",171).
component("YPL273W",742).
component("YLL062C",541).
component("YDR410C",287).
component("YKR069W",535).
component("U47_",115).
...
component("YMR120C",608).
component("YBL013W",155).
component("YJL130C",466).
component("YJL088W",461).
component("YPR074C",753).
component("YBR117C",182).
component("YLR354C",576).
component("YGR043C",377).
component("YMR108W",606).
component("YCL009C",203).
component("YMR062C",603).
component("YNL071W",629).
component("YIL160C",450).
component("YNR019W",657).
component("YCR048W",215).
component("U48_",116).
component("YNL277W",646).
component("YDR232W",273).
component("YFL017C",337).
component("YPL231W",734).
component("YER061C",317).
component("U86_",144).
component("YPL001W",714).
component("YDL052C",221).
component("U8_",147).
component("YDR148C",269).
component("YOR377W",712).
component("YGR177C",388).
component("YPL231W",735).
component("YLR195C",561).
component("YLR299W",568).
component("YPR001W",744).
component("YNR001C",653).
component("YCR005C",211).
component("YML126C",597).
component("YDL182W",242).
component("YDL131W",234).
component("YNL117W",633).
component("YIR031C",455).
component("YPR160W",759).
component("YOR321W",702).
component("YJR143C",498).
component("YGR199W",393).
component("YDL095W",229).
component("YDL093W",228).
component("YAL023C",151).
component("YPL227C",731).
component("YMR261C",621).
component("YML100W",593).
component("YBR126C",185).
component("YNL192W",640).
component("YBR038W",173).
component("YBR023C",169).
component("YEL011W",300).
component("YLR209C",562).
component("U104_",24).
component("U103_",23).
component("YOR209C",694).
component("YMR300C",623).
component("YDR354W",281).
component("YFR047C",346).
component("YJR133W",496).
component("U22_",93).
component("YLR209C",563).
component("YDR399W",283).
component("YJL167W",474).
component("YNL256W",643).
component("YPR069C",752).
component("YDR127W",264).
component("YHR190W",432).
component("YHR068W",421).
component("YLR303W",569).
component("YML082W",592).
component("YJR130C",495).
component("YDR035W",251).
component("YBR249C",195).
component("YLR180W",560).
component("YDR502C",293).
component("YOL143C",679).
component("YBR256C",197).
component("YHR137W",426).
component("YGL202W",368).
component("YLR027C",542).
component("YKL106W",507).
component("YOL140W",678).
component("YLR438W",585).
component("YKL104C",506).
component("YGR019W",375).
component("YDR111C",261).
component("U64_",127).
component("U51_",119).
component("YJR148W",499).
component("YHR208W",435).
component("YOR184W",692).
component("YNR058W",662).
component("YGL253W",374).
component("YFR053C",347).
component("YMR013C",600).
component("YMR205C",614).
component("YGR240C",397).
component("YLR240W",565).
component("YKL203C",524).
component("YJR066W",488).
component("YCR036W",214).
component("YGR194C",392).
component("YCL040W",208).
component("YJR105W",493).
component("U16_",63).
component("YPL188W",727).
component("YJR049C",485).
component("YEL041W",303).
component("YKL001C",502).
component("YDR236C",274).
component("YML070W",591).
component("YFL053W",341).
component("YDR531W",297).
component("U82_",141).
component("U81_",140).
component("YMR208W",615).
component("YPL203W",728).
component("YOR061W",682).
component("YKL166C",515).
component("YJL164C",473).
component("YIL035C",438).
component("YHR205W",434).
component("YHR102W",424).
component("YGL019W",353).
component("YHR025W",413).
component("YNR012W",655).
component("YPR121W",756).
component("YPL258C",737).
component("YOL055C",669).
component("YPL214C",730).
component("U1_",80).
component("YDR009W",249).
component("YBR020W",168).
component("YFR019W",344).
...
component("YBR278W",198).
component("YBL035C",157).
component("YKL035W",503).
component("YHL012W",406).
component("YHR123W",425).
component("YNL130C",634).
component("YPL148C",723).
component("YOR251C",700).
component("YGR286C",402).
component("YDR058C",257).
component("YOL011W",665).
component("YMR008C",599).
component("YMR006C",598).
component("U105_",25).
component("U101_",21).
component("YJL068C",459).
component("YPL072W",718).
component("YOR124C",685).
component("YNL186W",639).
component("YMR304W",624).
component("YMR223W",618).
component("YKR098C",538).
component("YJL197W",475).
component("YIL156W",448).
component("YFR010W",343).
component("YER151C",332).
component("YER144C",331).
component("YER098W",328).
component("YDR069C",258).
component("YDL122W",233).
component("YBR058C",175).
component("YBL067C",160).
component("YJR019C",483).
component("U84_",142).
component("YDR481C",291).
component("YLR377C",579).
component("YDR074W",259).
component("YFR025C",345).
component("YPL179W",726).
component("YNR032W",658).
component("YML057W",590).
component("YML016C",586).
component("YLR433C",584).
component("YGR123C",383).
component("YER133W",330).
component("YER089C",325).
component("YDR436W",289).
component("YDR075W",260).
component("YDL188C",243).
component("YDL134C",235).
component("YDL047W",220).
component("YDL006W",217).
component("YBR125C",184).
component("YBL056W",159).
component("YIL053W",440).
component("YER062C",318).
component("YHR046C",417).
component("U9_",150).
component("YGR208W",396).
component("YPL228W",732).
component("YMR180C",611).
component("YJL155C",472).
component("U34_",103).
component("U33_",102).
component("U32_",101).
component("U30_",100).
...
component("U26_",95).
component("U24_",94).
component("YHR044C",416).
component("YHR043C",415).
component("YOL064C",673).
component("YPL268W",741).
component("YOR360C",709).
component("YGL248W",373).
component("YKR031C",531).
component("YGL027C",355).
component("YLR286C",567).
component("YJR153W",500).
component("YJL221C",479).
component("YJL216C",477).
component("YIL172C",454).
component("YGR292W",404).
component("YGR287C",403).
component("YBR299W",202).
component("YBR184W",191).
component("YIL162W",451).
component("YPR026W",747).
component("YDR001C",247).
component("YBR001C",164).
component("YDR400W",284).
component("U102_",22).
component("YER043C",311).
component("YNL045W",627).
component("YLR160C",557).
component("YLR158C",556).
component("YLR157C",555).
component("YLR155C",554).
component("YDR321W",280).
component("YGL037C",356).
component("U43_",112).
component("U42_",111).
component("YLR308W",572).
component("YLR307W",571).
component("U53_",120).
component("YLR420W",582).
...
component("YNL141W",636).
component("YML035C",587).
component("YBR084W",179).
component("YJL126W",464).
component("U44_",113).
component("YDL100C",230).
component("U40_",109).
component("U39_",107).
component("YBR011C",165).
component("YHR201C",433).
component("YBR111C",181).
component("YBR252W",196).
component("YCL030C",207).
component("YER005W",308).
component("YBL099W",163).
component("YLR231C",564).
component("U88_",145).
component("YDR538W",299).
component("YLR134W",551).
component("YLR044C",545).
component("YGR087C",380).
component("YDR380W",282).
component("YDL080C",225).
component("YMR250W",619).
component("YKL184W",520).
component("YEL021W",301).
component("YNR043W",660).
component("YDR047W",256).
component("YKL211C",525).
component("YKR097W",537).
component("YOL052C",668).
component("YDR294C",276).
component("YEL046C",304).
component("YNR033W",659).
component("YPR006C",745).
component("YER065C",319).
component("YKL211C",526).
component("YER090W",326).
component("YDR127W",266).
component("YPL281C",743).
component("YOR393W",713).
component("YMR323W",625).
component("YHR174W",430).
component("YGR254W",398).
component("YPL262W",738).
component("YGL026C",354).
component("YGR155W",386).
component("YLR304C",570).
component("YJL200C",476).
component("YGL009C",351).
component("YNL316C",651).
component("YKL182W",518).
component("YPL212C",729).
component("YNL292W",649).
component("YGL063W",359).
component("YFL001W",335).
component("YCR053W",216).
component("YDR127W",267).
component("YGL148W",363).
component("YIL168W",453).
component("YIL167W",452).
component("YCL064C",209).
component("YCL064C",210).
component("YHR018C",409).
component("YLR359W",578).
component("YFR055W",348).
component("YJL121C",463).
component("YBR019C",167).
component("YDR007W",248).
...
component("YKL127W",509).
component("YEL058W",307).
component("YPR060C",751).
component("YHR072W",422).
component("YJL153C",471).
component("YGR264C",401).
component("YGR171C",387).
component("YHR011W",408).
component("YDR023W",250).
component("YPL104W",720).
component("YLL018C",539).
component("YPR081C",754).
component("YBR121C",183).
component("YHR020W",412).
component("YER087W",324).
component("YOL033W",667).
component("YGL245W",372).
component("YOR168W",690).
component("YOL097C",675).
component("YDR268W",275).
component("YPR047W",750).
component("YLR060W",547).
component("YFL022C",339).
component("YPR033C",748).
component("YHR019C",410).
component("YHR019C",411).
component("YKL194C",523).
component("YIL078W",443).
component("YPL160W",724).
component("YLR382C",580).
component("YPL040C",717).
component("YBL076C",162).
component("YNL073W",630).
component("YDR037W",252).
component("YOR335C",705).
component("YGR094W",381).
component("YPR035W",749).
component("YIL145C",446).
component("U89_",146).
component("YOR241W",699).
component("YMR113W",607).
component("YKL132C",510).
component("YGL234W",370).
component("YER183C",334).
component("U90_",148).
...
component("YPR145W",758).
component("YGR124W",384).
component("YOR303W",701).
component("YJR109C",494).
component("YJL130C",467).
component("YGL062W",358).
component("YBR218C",193).
component("YPL231W",736).
component("YNR016C",656).
component("YKL182W",519).
component("YGR037C",376).
component("YJL087C",460).
component("YOL010W",664).
component("YPR138C",757).
component("YPL265W",739).
component("YOR348C",708).
component("YOR171C",691).
component("YOR130C",686).
component("YOR011W",681).
component("YOL156W",680).
component("YOL103W",676).
component("YOL020W",666).
component("YNL318C",652).
component("YNL142W",637).
component("YMR272C",622).
component("YMR202W",613).
component("YMR056C",602).
component("YML123C",596).
component("YLR348C",575).
component("YLR260W",566).
component("YLR138W",552).
component("YLR100C",550).
component("YLR092W",549).
component("YLR081W",548).
component("YLL061W",540).
component("YKR053C",533).
component("YKR039W",532).
component("YKL217W",528).
component("YKL120W",508).
component("YJR095W",492).
component("YJR077C",490).
component("YJL219W",478).
component("YJL134W",468).
component("YJL129C",465).
component("YHL036W",407).
component("YGR191W",390).
component("YGR125W",385).
component("YGR121C",382).
component("YGR065C",379).
component("YGR055W",378).
component("YGL186C",365).
component("YFL055W",342).
component("YFL011W",336).
...
component("YDR046C",255).
component("YDL210W",244).
component("YCL025C",205).
component("YBR298C",201).
component("YBR294W",200).
component("YBR291C",199).
component("YBR085W",180).
component("YBR069C",177).
component("YBR068C",176).
component("YBL042C",158).
component("YBL030C",156).
component("U85_",143).
component("U7_",139).
component("U79_",138).
component("U75_",136).
