...
component("YNL280C",356).
component("YLR056W",296).
component("YMR083W",329).
component("YPL231W",401).
component("YJR159W",273).
component("YGL001C",194).
component("YML056C",318).
component("YLR432W",316).
component("YHR216W",238).
component("YAR075W",79).
component("YAR073W",78).
component("YDR127W",144).
component("YJR139C",270).
component("YNL009W",344).
component("YLR174W",305).
component("YHR183W",235).
component("YGR256W",217).
component("YCL018W",107).
component("YJR078W",266).
component("YMR015C",326).
component("YDR402C",158).
component("YGL055W",199).
component("YJL026W",245).
component("YGR180C",214).
component("YOR374W",391).
component("YER073W",177).
component("U68_",66).
component("U55_",62).
component("YER069W",176).
component("YOR323C",386).
component("YBR166C",100).
component("YNL280C",357).
component("YKL141W",279).
component("YOR375C",392).
component("YDL215C",133).
component("YAL062W",77).
component("U100_",20).
component("YBR035C",89).
component("YMR189W",333).
component("U56_",63).
component("YPL023C",394).
component("YGL125W",201).
component("YOR236W",384).
component("YLR142W",300).
component("U65_",65).
component("YHR068W",227).
component("YMR145C",332).
component("YDL085W",119).
component("YBR046C",90).
component("YPL091W",397).
component("YNL052W",345).
component("YMR256C",339).
component("YLR395C",315).
component("YLR038C",294).
component("YIL111W",241).
component("YHR051W",226).
component("YGL191W",205).
component("YGL187C",204).
component("YDL067C",117).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",406).
component("YLL062C",291).
component("YDR410C",160).
component("YER091C",179).
component("YJR073C",264).
component("YOL096C",371).
component("YMR120C",331).
component("YBL013W",80).
component("YJL130C",251).
component("YJL088W",247).
component("YPR074C",412).
component("YBR117C",96).
component("YCL009C",106).
component("YMR062C",328).
component("YNL071W",346).
component("YNR019W",363).
component("YCR048W",114).
component("U48_",59).
component("YFL017C",185).
component("YPL231W",402).
component("YDL052C",116).
component("U8_",72).
component("YPL231W",403).
component("YLR299W",309).
component("YCR005C",111).
component("YML126C",322).
component("YDL182W",131).
component("YDL131W",124).
component("YNL117W",349).
component("YIR031C",244).
component("YOR321W",385).
component("YJR143C",271).
component("YGR199W",215).
component("YDL095W",121).
component("YDL093W",120).
component("YAL023C",76).
component("YMR261C",340).
component("YML100W",320).
component("YBR126C",97).
component("YLR209C",306).
component("YDR354W",155).
component("YFR047C",192).
component("YJR133W",269).
component("U22_",50).
component("YDR399W",157).
component("YJL167W",258).
component("YPR069C",411).
component("YDR127W",145).
component("YML082W",319).
component("YJR130C",268).
component("YDR035W",137).
component("YBR249C",102).
component("YBR256C",103).
component("YHR137W",230).
component("YGL202W",206).
component("YLR027C",292).
component("YKL106W",277).
component("YOL140W",374).
component("YLR438W",317).
component("YKL104C",276).
component("YDR111C",142).
component("U51_",60).
component("YJR148W",272).
component("YMR013C",325).
component("YCR036W",113).
component("YCL040W",110).
component("YJR105W",267).
component("U81_",71).
component("YMR208W",335).
component("YPL203W",400).
component("YOR061W",375).
component("YKL166C",281).
component("YJL164C",257).
component("YIL035C",240).
component("YHR205W",237).
component("YHR102W",229).
component("YGL019W",195).
component("YHR025W",223).
component("YNR012W",361).
component("YFR019W",190).
component("YDR208W",151).
component("YDR127W",146).
component("U21_",47).
component("YDR147W",149).
component("YER052C",172).
component("U19_",43).
component("U18_",39).
component("U17_",36).
component("U76_",69).
component("YMR220W",336).
component("YDR226W",152).
component("YKL067W",275).
component("YDR454C",162).
component("YOL061W",370).
component("YKL181W",282).
component("YHL011C",219).
component("YER099C",181).
component("YBL068W",85).
component("YOR143C",379).
component("YLR328W",312).
component("U94_",74).
component("YBR029C",88).
component("YPR190C",418).
component("YPR187W",417).
component("YPR110C",413).
component("YPR010C",408).
component("YOR341W",389).
component("YOR340C",388).
component("YOR224C",383).
component("YOR210W",382).
component("YOR207C",381).
component("YOR151C",380).
component("YOR116C",377).
component("YOL005C",366).
component("YNR003C",360).
component("YNL248C",354).
component("YNL151C",352).
component("YNL113W",348).
component("YKL144C",280).
component("YJR063W",263).
component("YJL148W",254).
component("YJL140W",253).
component("YIL021W",239).
component("YHR143W-A",231).
component("YGL070C",200).
component("YFL036W",187).
...
component("YPR175W",416).
component("YPL167C",399).
component("YOR330C",387).
component("YOL115W",373).
component("YNL299W",358).
component("YNL262W",355).
component("YNL102W",347).
component("YJR043C",262).
component("YJR006W",260).
component("YJL090C",248).
component("YIL139C",242).
component("YEL055C",169).
component("YDR419W",161).
component("YDR121W",143).
...
component("YOL011W",368).
component("YMR008C",324).
component("YMR006C",323).
component("U105_",21).
component("YPL072W",396).
component("YOR124C",378).
component("YNL186W",353).
component("YMR304W",342).
component("YMR223W",337).
component("YKR098C",290).
component("YJL197W",259).
component("YIL156W",243).
component("YFR010W",189).
component("YER151C",183).
component("YER144C",182).
component("YER098W",180).
component("YDR069C",140).
component("YDL122W",123).
component("YBR058C",91).
component("YBL067C",84).
component("YJR019C",261).
component("YDR074W",141).
component("YFR025C",191).
component("U9_",75).
component("YJL155C",256).
component("U34_",55).
component("U33_",54).
component("U32_",53).
component("U30_",52).
...
component("YGL027C",197).
component("YLR286C",308).
component("YLR160C",304).
component("YLR158C",303).
component("YLR157C",302).
component("YLR155C",301).
component("YDR321W",154).
component("YGL037C",198).
component("U43_",57).
component("U42_",56).
component("YLR308W",311).
component("YLR307W",310).
component("U53_",61).
component("YLR028C",293).
component("YHR144C",232).
component("YHR144C",233).
component("YBR153W",98).
component("YDL238C",134).
component("YNL141W",350).
component("YJL126W",250).
component("U44_",58).
component("YHR201C",236).
component("YBR111C",95).
component("YCL030C",109).
component("YER005W",171).
component("YLR231C",307).
component("YDR538W",167).
component("YLR134W",299).
component("YLR044C",295).
component("YGR087C",209).
component("YDR380W",156).
component("YDL080C",118).
component("YMR250W",338).
component("YKL184W",284).
component("YEL021W",168).
component("YKL211C",285).
component("YNR033W",364).
component("YKL211C",286).
component("YER090W",178).
component("YDR127W",147).
component("YPL281C",407).
component("YOR393W",393).
component("YMR323W",343).
component("YHR174W",234).
component("YGR254W",216).
component("YGL026C",196).
component("YGR155W",212).
component("YNL316C",359).
component("YCR053W",115).
component("YDR127W",148).
component("YGL148W",202).
component("YFR055W",193).
component("YJL121C",249).
component("YBR019C",87).
component("YDR007W",135).
component("YOR095C",376).
component("YBR196C",101).
component("U14_",30).
component("YMR105C",330).
component("YKL127W",278).
component("YEL058W",170).
component("YPR060C",410).
component("YHR072W",228).
component("YJL153C",255).
component("YGR264C",218).
component("YGR171C",213).
component("YHR011W",221).
component("YDR023W",136).
component("YGL245W",207).
component("YPR047W",409).
component("YLR060W",297).
component("YFL022C",186).
component("YHR019C",222).
component("YPL160W",398).
component("YLR382C",314).
component("YPL040C",395).
component("YBL076C",86).
component("YER183C",184).
component("U90_",73).
component("YNR057C",365).
component("YDL141W",126).
component("YDL141W",127).
component("YDL141W",128).
component("YDL141W",129).
component("YPR145W",415).
component("YGR124W",211).
component("YPL231W",404).
component("YNR016C",362).
component("YKL182W",283).
component("YGR037C",208).
component("YJL087C",246).
component("YOL010W",367).
component("YPR138C",414).
component("YPL265W",405).
component("YOR348C",390).
component("YOL103W",372).
component("YOL020W",369).
component("YNL142W",351).
component("YMR272C",341).
component("YMR202W",334).
component("YMR056C",327).
component("YML123C",321).
component("YLR348C",313).
component("YLR100C",298).
component("YKR053C",289).
component("YKR039W",288).
component("YKL217W",287).
component("YJR077C",265).
component("YJL134W",252).
component("YGR121C",210).
component("YGL186C",203).
component("YFL055W",188).
component("YER060W-A",175).
component("YER060W",174).
component("YER056C",173).
component("YDR536W",166).
component("YDR508C",165).
component("YDR503C",164).
component("YDR497C",163).
component("YDR294C",153).
component("YDR046C",139).
component("YDL210W",132).
component("YCL025C",108).
component("YBR291C",105).
component("YBR085W",94).
component("YBR069C",93).
component("YBR068C",92).
component("YBL042C",83).
component("YBL030C",81).
component("U7_",70).
component("U6_",68).
component("U69_",67).
component("U5_",64).
