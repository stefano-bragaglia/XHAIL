...
component("YGL001C",52).
component("YDR127W",37).
component("YNL009W",83).
component("YLR174W",76).
component("YJR078W",66).
component("YOR323C",92).
component("YBR166C",27).
component("YNL280C",85).
component("YMR145C",79).
component("YDL085W",33).
component("YBR046C",22).
component("YPL231W",94).
component("YLR299W",78).
component("YDR354W",43).
component("YFR047C",51).
component("YPR069C",98).
component("YDR127W",38).
component("YDR035W",35).
component("YBR249C",28).
component("YHR137W",61).
component("YLR027C",75).
component("YKL106W",68).
component("YCR036W",30).
component("YJR105W",67).
component("YMR208W",80).
component("YDR127W",39).
component("YDR226W",42).
component("YDR454C",45).
component("YOL061W",90).
component("YKL181W",69).
component("YHL011C",58).
component("YER099C",49).
component("YBL068W",21).
component("YHR044C",60).
component("YHR043C",59).
component("U53_",20).
component("YHR144C",62).
component("YBR153W",26).
component("YBR111C",25).
component("YLR231C",77).
component("YDR380W",44).
component("YDL080C",32).
component("YMR250W",81).
component("YKL184W",70).
component("YKL211C",71).
component("YNR033W",87).
component("YKL211C",72).
component("YER090W",48).
component("YDR127W",40).
component("YPL281C",96).
component("YOR393W",93).
component("YMR323W",82).
component("YHR174W",63).
component("YGR254W",57).
component("YGL026C",53).
component("YNL316C",86).
component("YCR053W",31).
component("YDR127W",41).
component("YGL148W",54).
component("YDR007W",34).
component("YOR095C",91).
component("YPR060C",97).
component("YGL245W",55).
component("YJL087C",64).
component("YOL010W",88).
component("YPR138C",99).
component("YPL265W",95).
component("YOL020W",89).
component("YNL142W",84).
component("YKR053C",74).
component("YKR039W",73).
component("YJL134W",65).
component("YGR121C",56).
component("YFL055W",50).
component("YDR536W",47).
component("YDR508C",46).
component("YDR046C",36).
component("YCL025C",29).
component("YBR069C",24).
component("YBR068C",23).
component("U228_",19).
component("U165_",18).
component("I01179",17).
component("I00631",16).
