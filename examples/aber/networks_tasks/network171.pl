...
component("YLR056W",741).
component("YGR060W",518).
component("YKR009C",720).
component("YMR083W",820).
component("YPL231W",991).
component("U46_",151).
component("YBR149W",257).
component("YBR149W",258).
component("YJR159W",684).
component("YGL001C",483).
component("YHR063C",574).
component("U45_",150).
component("YBR153W",259).
component("YML056C",800).
component("YLR432W",788).
component("YHR216W",598).
component("YAR075W",211).
component("YAR073W",210).
component("YCL030C",283).
component("YDR127W",366).
component("YJR139C",679).
component("YML075C",803).
component("YLR450W",791).
component("YOL126C",915).
component("YKL085W",693).
component("YDL078C",313).
component("YKL029C",688).
component("YOR136W",932).
component("YNL037C",852).
component("YNL009W",850).
component("YLR174W",759).
component("YDL066W",311).
component("YHR183W",592).
component("YGR256W",550).
component("YNL241C",868).
component("YOL059W",907).
component("YDL022W",302).
component("YCL018W",281).
component("YLR355C",782).
component("YIL074C",605).
component("YER081W",450).
component("YML054C",799).
component("YDL174C",336).
component("YIL155C",615).
component("YPR191W",1028).
component("YOR065W",923).
component("YJL166W",650).
component("YHR001W-A",560).
component("YGR183C",534).
component("YFR033C",479).
component("YEL024W",421).
component("YDR529C",412).
component("YBL045C",218).
component("Q0105",19).
component("YKR066C",725).
component("YKL026C",687).
component("YIR037W",626).
component("YBR244W",269).
component("YJR078W",670).
component("U58_",163).
component("U107_",28).
component("YGR255C",549).
component("U108_",29).
component("YBL098W",223).
component("YMR015C",816).
component("YHR007C",561).
component("YDR402C",399).
component("YGL055W",492).
component("YGR175C",531).
component("YJR104C",673).
component("YHR008C",562).
component("YJL026W",629).
component("YIL066C",604).
component("YGR180C",533).
component("YER070W",448).
component("U37_",142).
component("U36_",141).
component("U35_",140).
component("YDR158W",374).
component("YJR009C",660).
component("YJL052W",631).
component("YGR192C",537).
component("YBR006W",228).
component("YPL276W",1002).
component("YPL275W",1001).
component("YOR388C",965).
component("YOR374W",962).
component("YER073W",449).
component("U68_",174).
component("YGL154C",500).
component("YBR115C",252).
component("U55_",160).
component("YER069W",446).
component("YOR323C",952).
component("U2_",134).
component("YER178W",462).
component("YBR221C",267).
component("YIL125W",611).
component("YBR166C",262).
component("YNL280C",877).
component("YGL012W",486).
component("YKL182W",706).
component("U57_",162).
component("YKL216W",717).
component("YDR044W",352).
component("YER014W",432).
component("YKR009C",721).
component("YIL160C",617).
component("YGL205W",505).
component("YMR118C",825).
component("YLR164W",757).
component("YLL041C",732).
component("YKL148C",701).
component("YKL141W",699).
component("YJL045W",630).
component("YDR178W",376).
component("YJR051W",665).
component("YEL047C",425).
component("YDL171C",335).
component("YOR375C",963).
component("YDL215C",340).
component("YAL062W",208).
component("U99_",202).
component("U100_",22).
component("YBR035C",238).
component("YMR189W",832).
component("U56_",161).
component("YNR050C",892).
component("YKR080W",727).
component("YER023W",433).
component("YPL023C",969).
component("YGL125W",497).
component("YOR236W",945).
component("YGR204W",541).
component("YBR084W",246).
component("YLR142W",750).
component("U65_",171).
component("U63_",169).
component("U62_",168).
component("YOR356W",960).
component("YHR068W",575).
component("YKL150W",702).
component("YIL043C",602).
component("YHR042W",569).
component("YOR221C",943).
component("YMR145C",828).
component("YML120C",808).
component("YKL192C",710).
component("YKL055C",690).
component("YER061C",442).
component("YDL085W",315).
component("YBR046C",241).
component("YMR145C",829).
component("YML120C",809).
component("YKL192C",711).
component("YDL085W",316).
component("YFR030W",478).
component("YPL017C",968).
component("YFL018C",467).
component("YPL091W",974).
component("YDR353W",394).
component("YER042W",434).
component("YPR167C",1022).
component("YJR137C",678).
component("YNL052W",854).
component("YMR256C",840).
component("YLR395C",786).
component("YLR038C",739).
component("YIL111W",609).
component("YHR051W",573).
component("YGL191W",503).
component("YGL187C",502).
component("YDL067C",312).
component("Q0275",21).
component("Q0250",20).
component("Q0045",18).
component("YPL266W",998).
component("YML110C",807).
component("YBR034C",237).
component("YPL273W",1000).
component("YLL062C",735).
component("YDR410C",402).
component("YKR069W",726).
component("YOL096C",910).
component("U47_",152).
component("YER091C",454).
component("YJR073C",668).
component("YML008C",792).
component("YDL033C",304).
component("YOL096C",911).
component("YLR172C",758).
component("YLR058C",742).
component("YBR263W",273).
component("YDR019C",348).
component("YBR176W",263).
component("YDR408C",401).
component("YMR120C",826).
component("YLR028C",737).
component("YBL013W",212).
component("YJL130C",642).
component("YJL088W",636).
component("YPR074C",1015).
component("YBR117C",253).
component("YLR354C",781).
component("YGR043C",516).
component("YMR108W",823).
component("YCL009C",280).
component("YMR062C",819).
component("YNL071W",855).
component("YIL160C",618).
component("YNR019W",886).
component("YCR048W",297).
component("U48_",153).
component("YNL277W",875).
component("YDR232W",379).
component("YFL017C",466).
component("YPL231W",992).
component("YER061C",443).
component("U86_",192).
component("YPL001W",967).
component("YDL052C",308).
component("U8_",195).
component("YDR148C",372).
component("YML042W",798).
component("YOR377W",964).
component("YGR177C",532).
component("YPL231W",993).
component("YGR147C",527).
component("YDL040C",305).
component("YPL028W",970).
component("YLR195C",761).
component("YLR299W",771).
component("YGL017W",487).
component("YPR001W",1004).
component("YNR001C",882).
component("YCR005C",292).
component("YML126C",811).
component("YDL182W",337).
component("YDL131W",325).
component("YNL117W",859).
component("YIR031C",624).
component("YPR160W",1021).
component("YOR321W",951).
component("YJR143C",680).
component("YGR199W",539).
component("YDL095W",320).
component("YDL093W",319).
component("YAL023C",205).
component("YLR258W",768).
component("YFR015C",475).
component("YPL227C",989).
component("YOR103C",927).
component("YOR085W",925).
component("YMR149W",830).
component("YML019W",794).
component("YJL002C",627).
component("YEL002C",417).
component("YDL232W",341).
component("YCL043C",287).
component("YNL029C",851).
component("YIL085C",607).
component("YMR261C",841).
component("YML100W",805).
component("YBR126C",256).
component("YNL192W",866).
component("YBR038W",240).
component("YBR023C",235).
component("YEL011W",418).
component("YMR306W",848).
component("YLR342W",779).
component("YGR032W",514).
component("YPR183W",1025).
component("YLR209C",762).
component("U104_",26).
component("U103_",25).
component("YMR271C",842).
component("YML106W",806).
component("YOR209C",941).
component("YMR300C",846).
component("YER055C",438).
component("YDR354W",395).
component("YFR047C",480).
component("YJR133W",677).
component("U22_",128).
component("YLR209C",763).
component("YML022W",795).
component("YDR441C",405).
component("YDR399W",397).
component("YHR128W",585).
component("YPR176C",1024).
component("YPL172C",982).
component("YNR041C",890).
component("YMR101C",821).
component("YDL090C",318).
component("YBR003W",227).
component("YBR002C",226).
component("YJL167W",651).
component("YJL167W",652).
component("YNL256W",871).
component("YPR069C",1013).
component("YDR127W",367).
component("YHR190W",593).
component("YLR146C",751).
component("YHR068W",576).
component("YLR303W",772).
component("YGR012W",512).
component("YML082W",804).
component("YJR130C",676).
component("YDR035W",350).
component("YBR249C",270).
component("YLR180W",760).
component("YDR502C",409).
component("YOR274W",948).
component("YOL143C",918).
component("YBR256C",272).
component("YHR137W",586).
component("YGL202W",504).
component("YLR027C",736).
component("YKL106W",695).
component("YOL140W",917).
component("YLR438W",790).
component("YKL104C",694).
component("YGR019W",513).
component("YDR111C",364).
component("U64_",170).
component("U61_",167).
component("U51_",157).
component("YJR148W",681).
component("YHR208W",596).
component("YFL030W",469).
component("YOR184W",938).
component("YNR058W",894).
component("YIL116W",610).
component("YGL253W",510).
component("YFR053C",481).
component("YOL136C",916).
component("YIL107C",608).
component("YMR013C",815).
component("YMR205C",834).
component("YGR240C",545).
component("YOL016C",899).
component("YFR014C",474).
component("YLR240W",766).
component("YKL203C",713).
component("YJR066W",667).
component("YCR036W",296).
component("YGR194C",538).
component("YCL040W",286).
component("YJR105W",674).
component("U16_",80).
component("YPL188W",984).
component("YJR049C",664).
component("YEL041W",422).
component("U96_",200).
component("YKL001C",685).
component("YDR236C",380).
component("YML070W",802).
component("YFL053W",471).
component("YHL032C",558).
component("YLR133W",747).
component("YDR531W",414).
component("U83_",189).
component("U82_",188).
component("U81_",187).
component("YMR208W",835).
component("YPL203W",985).
component("YOR061W",922).
component("YKL166C",704).
component("YJL164C",649).
component("YIL035C",601).
component("YHR205W",595).
component("YHR102W",583).
component("YGL019W",488).
component("YHR025W",568).
component("YOR347C",958).
component("YAL038W",206).
component("YNR012W",884).
component("YPR121W",1018).
component("YPL258C",995).
component("YOL055C",903).
component("YPL214C",988).
component("U1_",108).
component("YDR009W",347).
component("YBR020W",234).
component("YFR019W",476).
component("YDR208W",377).
component("YDR127W",368).
component("U21_",120).
component("U20_",115).
component("YDR147W",371).
component("YDR300C",388).
component("YCR012W",293).
component("YER052C",436).
component("YER069W",447).
component("U19_",107).
component("U18_",98).
component("U17_",89).
component("U76_",183).
component("YMR220W",837).
component("YER170W",461).
component("YDR226W",378).
component("YKL067W",692).
component("YOL055C",904).
component("YDR454C",406).
component("YOL061W",908).
component("YKL181W",705).
component("YHL011C",555).
component("YER099C",456).
component("YBL068W",221).
component("YOR143C",933).
component("YNL256W",872).
component("YLR328W",777).
component("YBR018C",230).
component("YBR018C",231).
component("YDL055C",309).
component("YGR007W",511).
component("YGR202C",540).
component("YLR328W",778).
component("YKR002W",719).
component("YDL045C",306).
component("YDL103C",323).
component("U94_",199).
component("YJR010W",661).
component("YBR029C",236).
component("YCL050C",288).
component("YGL130W",498).
component("YDR530C",413).
component("YCL050C",289).
component("YPR190C",1027).
component("YPR187W",1026).
component("YPR110C",1017).
component("YPR010C",1006).
component("YOR341W",957).
component("YOR340C",956).
component("YOR224C",944).
component("YOR210W",942).
component("YOR207C",940).
component("YOR151C",934).
component("YOR116C",928).
component("YOL005C",896).
component("YNR003C",883).
component("YNL248C",870).
component("YNL151C",864).
component("YNL113W",858).
component("YKL144C",700).
component("YJR063W",666).
component("YJL148W",646).
component("YJL140W",645).
component("YIL021W",600).
component("YHR143W-A",587).
component("YGL070C",496).
component("YFL036W",470).
component("YDR404C",400).
component("YDR156W",373).
component("YDR045C",353).
component("YDL150W",333).
component("YDL140C",327).
component("YBR154C",261).
component("YPR175W",1023).
component("YPL167C",981).
component("YOR330C",953).
component("YOL115W",914).
component("YNL299W",879).
component("YNL262W",873).
component("YNL102W",857).
component("YJR043C",663).
component("YJR006W",659).
component("YJL090C",637).
component("YIL139C",613).
component("YEL055C",426).
component("YDR419W",403).
component("YDR121W",365).
component("YDL102W",322).
component("YCR014C",294).
component("YBR278W",274).
component("YBL035C",215).
component("YKL035W",689).
component("YHL012W",556).
component("YHR123W",584).
component("YBR243C",268).
component("YNL130C",860).
component("YDL142C",332).
component("YPL148C",979).
component("YOR251C",947).
component("YGR286C",552).
component("YJL068C",632).
component("YDR058C",358).
component("YNR034W",889).
component("YHR163W",590).
component("YGR248W",547).
component("YCR073W-A",299).
component("YDL086W",317).
component("YOL011W",898).
component("YMR008C",813).
component("YMR006C",812).
component("U105_",27).
component("U101_",23).
component("YJL068C",633).
component("YPL072W",973).
component("YOR124C",929).
component("YNL186W",865).
component("YMR304W",847).
component("YMR223W",838).
component("YKR098C",730).
component("YJL197W",653).
component("YIL156W",616).
component("YFR010W",473).
component("YER151C",460).
component("YER144C",459).
component("YER098W",455).
component("YDR069C",360).
component("YDL122W",324).
component("YBR058C",242).
component("YBL067C",220).
component("YJR019C",662).
component("YDR272W",383).
component("U84_",190).
component("YDR481C",407).
component("YLR377C",784).
component("YDR074W",361).
component("YFR025C",477).
component("YPL179W",983).
component("YNR032W",887).
component("YML057W",801).
component("YML016C",793).
component("YLR433C",789).
component("YGR123C",523).
component("YER133W",458).
component("YER089C",452).
component("YDR436W",404).
component("YDR075W",362).
component("YDL188C",338).
component("YDL134C",326).
component("YDL047W",307).
component("YDL006W",300).
component("YBR125C",255).
component("YBL056W",219).
component("YPR073C",1014).
component("YHR215W",597).
component("YDL024C",303).
component("YBR093C",250).
component("YBR092C",249).
component("YIL053W",603).
component("YER062C",444).
component("YHR046C",572).
component("U9_",203).
component("YGR208W",544).
component("YPL228W",990).
component("YMR180C",831).
component("YDL236W",342).
component("YJL155C",648).
component("U34_",139).
component("U33_",138).
component("U32_",137).
component("U31_",136).
...
component("U26_",130).
component("U24_",129).
component("YHR044C",571).
component("YHR043C",570).
component("YOL064C",909).
component("YPL268W",999).
component("YOR360C",961).
component("YGL248W",509).
component("YKR031C",722).
component("YPL206C",986).
component("YGL027C",490).
component("YLR286C",770).
component("YJR153W",682).
component("YJL221C",658).
component("YJL216C",656).
component("YIL172C",622).
component("YGR292W",554).
component("YGR287C",553).
component("YBR299W",279).
component("YBR184W",264).
component("YIL162W",619).
component("YPR026W",1007).
component("YDR001C",345).
component("YBR001C",225).
component("YDR400W",398).
component("YML035C",796).
component("YJL070C",634).
component("YBR284W",275).
component("U102_",24).
component("YER043C",435).
component("YNL045W",853).
component("YLR160C",756).
component("YLR158C",755).
component("YLR157C",754).
component("YLR155C",753).
component("YDR321W",389).
component("YGL037C",491).
component("U43_",148).
component("U42_",147).
...
component("U53_",158).
component("YLR420W",787).
component("YPL111W",977).
component("YIR032C",625).
component("YIR029W",623).
component("YPR062W",1012).
component("YMR120C",827).
component("YLR028C",738).
component("YHR144C",588).
component("YHR144C",589).
component("YCL030C",284).
component("YNL141W",861).
component("YBL033C",214).
component("YBR153W",260).
component("YDL238C",343).
component("YNL141W",862).
component("YLR245C",767).
component("YML035C",797).
component("YGR204W",542).
component("YBR084W",247).
component("YJL126W",640).
component("U44_",149).
component("YDL100C",321).
component("U40_",145).
component("U39_",143).
component("YBR011C",229).
component("YHR201C",594).
component("YBR111C",251).
...
component("YLR134W",748).
component("YLR044C",740).
component("YGR087C",520).
component("YDR380W",396).
component("YDL080C",314).
component("U98_",201).
component("YMR250W",839).
component("YKL184W",709).
component("YOR128C",930).
component("YEL021W",420).
component("YNR043W",891).
component("U93_",198).
component("YDR047W",355).
component("U54_",159).
component("YKL211C",715).
component("YKR097W",729).
component("YOL052C",902).
component("YGR170W",529).
component("YKL060C",691).
component("YDR294C",385).
component("YEL046C",424).
component("YNR033W",888).
component("YPR006C",1005).
component("YER065C",445).
component("YKL211C",716).
component("YER090W",453).
component("YDR127W",369).
component("YPL281C",1003).
component("YOR393W",966).
component("YMR323W",849).
component("YHR174W",591).
component("YGR254W",548).
component("YPL262W",996).
component("YGL026C",489).
component("YGR155W",528).
component("YLR304C",773).
component("YJL200C",654).
component("YGL009C",485).
component("YNL316C",880).
component("YKL182W",707).
component("YPL212C",987).
component("YNL292W",878).
component("YGL063W",495).
component("YFL001W",464).
component("YOR278W",949).
component("U49_",154).
component("YCR053W",298).
component("YDR127W",370).
component("YGL148W",499).
component("YIL168W",621).
component("YIL167W",620).
component("YCL064C",290).
component("YCL064C",291).
component("YHR018C",564).
component("YLR359W",783).
component("YAL012W",204).
component("YFR055W",482).
component("YJL005W",628).
component("YOR176W",937).
component("YJL121C",639).
component("YBR019C",232).
component("YBR019C",233).
component("U59_",164).
component("YDR050C",356).
component("YIL020C",599).
component("YDR007W",346).
component("YOR095C",926).
component("YER003C",430).
component("YBR196C",265).
component("YGL001C",484).
component("YPL117C",978).
component("U14_",65).
component("YOL056W",905).
component("YKL152C",703).
component("YDL021W",301).
component("YMR105C",822).
component("YKL127W",697).
component("YEL058W",427).
component("YPR060C",1011).
component("YHR072W",577).
component("YJL153C",647).
component("YPL097W",975).
component("YGR185C",535).
component("YGR264C",551).
component("YGR171C",530).
component("YHR011W",563).
component("YDR023W",349).
component("YPL104W",976).
component("YLL018C",731).
component("YPR081C",1016).
component("YBR121C",254).
component("YHR020W",567).
component("YER087W",451).
component("YNL247W",869).
component("YOL033W",901).
component("YGL245W",508).
component("YOR168W",935).
component("YHR091C",579).
component("YDR341C",390).
component("YOL097C",912).
component("YDR268W",382).
component("YPR047W",1010).
component("YLR060W",743).
component("YFL022C",468).
component("YPR033C",1008).
component("YHR019C",565).
component("YHR019C",566).
component("YKL194C",712).
component("YIL078W",606).
component("YPL160W",980).
component("YLR382C",785).
component("YPL040C",971).
component("YBL076C",222).
component("YNL073W",856).
component("YDR037W",351).
component("YOR335C",954).
component("YGR094W",521).
component("YLR153C",752).
component("YAL054C",207).
component("YGR244C",546).
component("YPR035W",1009).
component("YIL145C",614).
component("U89_",194).
component("YOR241W",946).
component("YMR113W",824).
component("YKL132C",698).
component("YOR339C",955).
component("YMR022W",817).
component("YLR306W",774).
component("YKL210W",714).
component("YGR133W",526).
component("YGL058W",493).
component("YER100W",457).
component("YEL012W",419).
component("YDR177W",375).
component("YDR092W",363).
component("YDR059C",359).
component("YDR054C",357).
component("YDL064W",310).
component("YBR082C",245).
component("YJL101C",638).
component("U92_",197).
component("YAR015W",209).
component("YGL234W",506).
component("YER183C",463).
component("U90_",196).
component("YNR057C",893).
component("YDL141W",328).
component("YDL141W",329).
component("YGL234W",507).
component("YDL141W",330).
component("YJR103W",672).
component("YBL039C",216).
component("YGR204W",543).
component("YNL220W",867).
component("YOL058W",906).
component("YDL141W",331).
component("YHR074W",578).
component("YMR217W",836).
component("YPR145W",1020).
component("YGR124W",524).
component("YOR303W",950).
component("YJR109C",675).
component("YJL130C",643).
component("YGL062W",494).
component("YBR218C",266).
component("YPL231W",994).
component("YNR016C",885).
component("YKL182W",708).
component("YGR037C",515).
component("YOR005C",920).
component("YDL164C",334).
component("YJL087C",635).
component("YOL010W",897).
component("YPR138C",1019).
component("YPL265W",997).
component("YPL057C",972).
component("YOR348C",959).
component("YOR192C",939).
component("YOR171C",936).
component("YOR130C",931).
component("YOR071C",924).
component("YOR011W",921).
component("YOL156W",919).
component("YOL103W",913).
component("YOL020W",900).
component("YNR072W",895).
component("YNL318C",881).
component("YNL270C",874).
component("YNL142W",863).
component("YMR272C",843).
component("YMR202W",833).
component("YMR056C",818).
component("YMR011W",814).
component("YML123C",810).
component("YLR348C",780).
component("YLR260W",769).
component("YLR237W",765).
component("YLR138W",749).
component("YLR100C",746).
component("YLR092W",745).
component("YLR081W",744).
component("YLL061W",734).
component("YLL043W",733).
component("YKR093W",728).
component("YKR053C",724).
component("YKR039W",723).
component("YKL217W",718).
component("YKL120W",696).
component("YKL004W",686).
component("YJR158W",683).
component("YJR095W",671).
component("YJR077C",669).
component("YJL219W",657).
component("YJL214W",655).
component("YJL134W",644).
component("YJL129C",641).
component("YIL134W",612).
component("YHR096C",582).
component("YHR094C",581).
component("YHR092C",580).
component("YHL036W",559).
component("YHL016C",557).
component("YGR191W",536).
component("YGR125W",525).
component("YGR121C",522).
component("YGR065C",519).
component("YGR055W",517).
component("YGL186C",501).
component("YFL055W",472).
component("YFL011W",465).
component("YER060W-A",441).
component("YER060W",440).
component("YER056C",439).
component("YER053C",437).
...
component("YDR297W",387).
component("YDR294C",386).
component("YDR284C",384).
component("YDR046C",354).
component("YDL245C",344).
component("YDL210W",339).
component("YCR028C",295).
component("YCL025C",282).
component("YBR298C",278).
component("YBR294W",277).
component("YBR291C",276).
component("YBR085W",248).
component("YBR069C",244).
component("YBR068C",243).
component("YBR036C",239).
component("YBL042C",217).
component("YBL030C",213).
component("U85_",191).
component("U7_",186).
component("U79_",185).
component("U78_",184).
