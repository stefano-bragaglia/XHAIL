...
component("YNL280C",292).
component("YLR056W",241).
component("YMR083W",269).
component("YPL231W",323).
component("YGL001C",162).
component("YDR127W",118).
component("YJR139C",220).
component("YNL009W",283).
component("YLR174W",248).
component("YHR183W",197).
component("YGR256W",182).
component("YCL018W",88).
component("YJR078W",217).
component("YMR015C",267).
component("YDR402C",130).
component("YGL055W",165).
component("YJL026W",203).
component("YGR180C",179).
component("U68_",57).
component("YER069W",147).
component("YOR323C",313).
component("YBR166C",82).
component("YNL280C",293).
component("YKL141W",227).
component("YOR375C",316).
component("YDL215C",110).
component("YAL062W",65).
component("U100_",20).
component("U56_",55).
component("YPL023C",318).
component("YGL125W",166).
component("YOR236W",311).
component("YMR145C",272).
component("YDL085W",99).
component("YBR046C",73).
component("YNL052W",284).
component("YMR256C",278).
component("YLR395C",258).
component("YLR038C",239).
component("YIL111W",199).
component("YHR051W",191).
component("YGL191W",170).
component("YGL187C",169).
component("YDL067C",97).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",328).
component("YLL062C",236).
component("YDR410C",131).
component("YJR073C",215).
component("YOL096C",304).
component("YMR120C",271).
component("YJL130C",208).
component("YJL088W",205).
component("YPR074C",333).
component("YBR117C",79).
component("YCL009C",87).
component("YNL071W",285).
component("YNR019W",298).
component("YCR048W",94).
component("U48_",52).
component("YFL017C",154).
component("YPL231W",324).
component("YDL052C",96).
component("U8_",61).
component("YPL231W",325).
component("YLR299W",252).
component("YCR005C",91).
component("YML126C",263).
component("YDL182W",108).
component("YDL131W",104).
component("YNL117W",287).
component("YIR031C",202).
component("YOR321W",312).
component("YJR143C",221).
component("YGR199W",180).
component("YDL095W",101).
component("YDL093W",100).
component("YAL023C",64).
component("YMR261C",279).
component("YML100W",261).
component("YBR126C",80).
component("YLR209C",249).
component("YDR354W",127).
component("YFR047C",160).
component("U22_",43).
component("YDR399W",129).
component("YPR069C",332).
component("YDR127W",119).
component("YML082W",260).
component("YJR130C",219).
component("YDR035W",114).
component("YBR249C",84).
component("YHR137W",193).
component("YGL202W",171).
component("YLR027C",237).
component("YKL106W",225).
component("YOL140W",307).
component("YLR438W",259).
component("U51_",53).
component("YJR148W",222).
component("YMR013C",266).
component("YCR036W",93).
component("YCL040W",90).
component("YJR105W",218).
component("YMR208W",274).
component("YHR025W",188).
component("YNR012W",296).
component("YFR019W",158).
component("YDR208W",124).
component("YDR127W",120).
component("YDR147W",123).
component("YER052C",143).
component("U19_",38).
component("U18_",35).
component("U76_",60).
component("YMR220W",275).
component("YDR226W",125).
component("YKL067W",224).
component("YDR454C",133).
component("YOL061W",303).
component("YKL181W",228).
component("YHL011C",184).
component("YER099C",150).
component("YBL068W",70).
component("YOR143C",310).
component("YLR328W",255).
component("U94_",62).
component("YBR029C",72).
component("YPR175W",336).
component("YPL167C",322).
component("YOR330C",314).
component("YOL115W",306).
component("YNL299W",294).
component("YNL262W",291).
component("YNL102W",286).
component("YJR043C",214).
component("YJR006W",213).
component("YJL090C",206).
component("YIL139C",200).
component("YEL055C",140).
component("YDR419W",132).
component("YDR121W",117).
component("YDL102W",102).
component("YCR014C",92).
component("YBR278W",85).
component("YBL035C",67).
component("YKL035W",223).
component("YHL012W",185).
component("YOL011W",301).
component("YMR008C",265).
component("YMR006C",264).
component("U105_",21).
component("YPL072W",320).
component("YOR124C",309).
component("YNL186W",290).
component("YMR304W",281).
component("YMR223W",276).
component("YKR098C",235).
component("YJL197W",212).
component("YIL156W",201).
component("YFR010W",157).
component("YER151C",152).
component("YER144C",151).
component("YER098W",149).
component("YDR069C",116).
component("YDL122W",103).
component("YBR058C",74).
component("YBL067C",69).
component("YFR025C",159).
component("U9_",63).
component("YJL155C",211).
component("U34_",48).
component("U33_",47).
component("U32_",46).
component("U30_",45).
component("U24_",44).
component("YHR044C",190).
component("YHR043C",189).
component("YLR286C",251).
component("YLR160C",247).
component("YLR158C",246).
component("YLR157C",245).
component("YLR155C",244).
component("YDR321W",126).
component("YGL037C",164).
component("U43_",50).
component("U42_",49).
component("YLR308W",254).
component("YLR307W",253).
component("U53_",54).
component("YLR028C",238).
component("YHR144C",194).
component("YHR144C",195).
component("YBR153W",81).
component("YDL238C",111).
component("YNL141W",288).
component("U44_",51).
component("YHR201C",198).
component("YBR111C",78).
component("YER005W",142).
component("YLR231C",250).
component("YDR538W",138).
component("YLR134W",243).
component("YLR044C",240).
component("YGR087C",174).
component("YDR380W",128).
component("YDL080C",98).
component("YMR250W",277).
component("YKL184W",230).
component("YEL021W",139).
component("YKL211C",231).
component("YNR033W",299).
component("YKL211C",232).
component("YER090W",148).
component("YDR127W",121).
component("YPL281C",329).
component("YOR393W",317).
component("YMR323W",282).
component("YHR174W",196).
component("YGR254W",181).
component("YGL026C",163).
component("YGR155W",177).
component("YNL316C",295).
component("YCR053W",95).
component("YDR127W",122).
component("YGL148W",167).
component("YFR055W",161).
component("YJL121C",207).
component("YDR007W",112).
component("YOR095C",308).
component("YBR196C",83).
component("U14_",29).
component("YMR105C",270).
component("YKL127W",226).
component("YEL058W",141).
component("YPR060C",331).
component("YHR072W",192).
component("YJL153C",210).
component("YGR264C",183).
component("YGR171C",178).
component("YHR011W",186).
component("YDR023W",113).
component("YGL245W",172).
component("YPR047W",330).
component("YLR060W",242).
component("YFL022C",155).
component("YHR019C",187).
component("YPL160W",321).
component("YLR382C",257).
component("YPL040C",319).
component("YBL076C",71).
component("YER183C",153).
component("YDL141W",105).
component("YDL141W",106).
component("YDL141W",107).
component("YPR145W",335).
component("YGR124W",176).
component("YPL231W",326).
component("YNR016C",297).
component("YKL182W",229).
component("YGR037C",173).
component("YJL087C",204).
component("YOL010W",300).
component("YPR138C",334).
component("YPL265W",327).
component("YOR348C",315).
component("YOL103W",305).
component("YOL020W",302).
component("YNL142W",289).
component("YMR272C",280).
component("YMR202W",273).
component("YMR056C",268).
component("YML123C",262).
component("YLR348C",256).
component("YKR053C",234).
component("YKR039W",233).
component("YJR077C",216).
component("YJL134W",209).
component("YGR121C",175).
component("YGL186C",168).
component("YFL055W",156).
component("YER060W-A",146).
component("YER060W",145).
component("YER056C",144).
component("YDR536W",137).
component("YDR508C",136).
component("YDR503C",135).
component("YDR497C",134).
component("YDR046C",115).
component("YDL210W",109).
component("YCL025C",89).
component("YBR291C",86).
component("YBR085W",77).
component("YBR069C",76).
component("YBR068C",75).
component("YBL042C",68).
component("YBL030C",66).
component("U6_",59).
component("U69_",58).
component("U5_",56).
component("U228_",42).
