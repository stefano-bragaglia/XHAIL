...
component("YNL280C",680).
component("YLR056W",576).
component("YKR009C",557).
component("YMR083W",637).
component("YPL231W",771).
component("U46_",119).
component("YBR149W",196).
component("YBR149W",197).
component("YJR159W",528).
component("YGL001C",369).
component("YHR063C",443).
component("YML056C",622).
component("YLR432W",615).
component("YHR216W",461).
component("YAR075W",161).
component("YAR073W",160).
component("YCL030C",217).
component("YDR127W",280).
component("YJR139C",524).
component("YOR136W",724).
component("YNL009W",659).
component("YLR174W",589).
component("YDL066W",237).
component("YHR183W",455).
component("YGR256W",424).
component("YNL241C",674).
component("YOL059W",705).
component("YDL022W",231).
component("YCL018W",215).
component("YLR355C",609).
component("YIL074C",467).
component("YER081W",342).
component("YML054C",621).
component("YIL155C",472).
component("YEL024W",321).
component("YKR066C",562).
component("YKL026C",530).
component("YIR037W",482).
component("YBR244W",205).
component("YJR078W",518).
component("U58_",129).
component("U107_",26).
component("YGR255C",423).
component("U108_",27).
component("YMR015C",634).
component("YDR402C",303).
component("YGL055W",377).
component("YJL026W",483).
component("YIL066C",466).
component("YGR180C",411).
component("YER070W",340).
component("U37_",111).
component("U36_",110).
component("U35_",109).
component("YDR158W",288).
component("YJR009C",508).
component("YJL052W",484).
component("YGR192C",413).
component("YOR374W",748).
component("YER073W",341).
component("U68_",135).
component("YGL154C",384).
component("U55_",126).
component("YER069W",339).
component("YOR323C",741).
component("U2_",104).
component("YBR221C",204).
component("YBR166C",200).
component("YNL280C",681).
component("YGL012W",372).
component("YKL182W",545).
component("U57_",128).
component("YKL216W",555).
component("YDR044W",270).
component("YER014W",328).
component("YKR009C",558).
component("YIL160C",474).
component("YGL205W",389).
component("YKL141W",539).
component("YJR051W",513).
component("YEL047C",324).
component("YDL171C",257).
component("YOR375C",749).
component("YDL215C",261).
component("YAL062W",159).
component("U100_",20).
component("YBR035C",180).
component("YMR189W",645).
component("U56_",127).
component("YKR080W",564).
component("YPL023C",754).
component("YGL125W",381).
component("YOR236W",736).
component("YGR204W",417).
component("YBR084W",186).
component("YLR142W",583).
component("U65_",133).
component("U62_",131).
component("YHR068W",444).
component("YKL150W",541).
component("YIL043C",464).
component("YHR042W",438).
component("YOR221C",734).
component("YMR145C",642).
component("YML120C",627).
component("YKL192C",549).
component("YKL055C",532).
component("YER061C",335).
component("YDL085W",240).
component("YBR046C",182).
component("YMR145C",643).
component("YML120C",628).
component("YKL192C",550).
component("YDL085W",241).
component("YPL017C",753).
component("YFL018C",357).
component("YPL091W",757).
component("YER042W",329).
component("YPR167C",799).
component("YNL052W",661).
component("YMR256C",653).
component("YLR395C",613).
component("YLR038C",574).
component("YIL111W",469).
component("YHR051W",442).
component("YGL191W",387).
component("YGL187C",386).
component("YDL067C",238).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",778).
component("YBR034C",179).
component("YPL273W",780).
component("YLL062C",570).
component("YDR410C",306).
component("YKR069W",563).
component("YOL096C",708).
component("U47_",120).
component("YER091C",346).
component("YJR073C",516).
component("YML008C",618).
component("YDL033C",233).
component("YOL096C",709).
component("YLR172C",588).
component("YDR408C",305).
component("YMR120C",641).
component("YLR028C",572).
component("YBL013W",162).
component("YJL130C",492).
component("YJL088W",487).
component("YPR074C",792).
component("YBR117C",192).
component("YLR354C",608).
component("YGR043C",398).
component("YMR108W",639).
component("YCL009C",214).
component("YMR062C",636).
component("YNL071W",662).
component("YIL160C",475).
component("YNR019W",690).
component("YCR048W",228).
component("U48_",121).
component("YNL277W",679).
component("YDR232W",291).
component("YFL017C",356).
component("YPL231W",772).
component("YER061C",336).
component("U86_",150).
component("YPL001W",752).
component("YDL052C",235).
component("U8_",153).
component("YDR148C",286).
component("YOR377W",750).
component("YGR177C",410).
component("YPL231W",773).
component("YLR195C",591).
component("YLR299W",600).
component("YPR001W",782).
component("YNR001C",686).
component("YCR005C",224).
component("YML126C",630).
component("YDL182W",258).
component("YDL131W",248).
component("YNL117W",666).
component("YIR031C",480).
component("YPR160W",798).
component("YOR321W",740).
component("YJR143C",525).
component("YGR199W",415).
component("YDL095W",243).
component("YDL093W",242).
component("YAL023C",158).
component("YLR258W",597).
component("YFR015C",363).
component("YPL227C",769).
component("YMR261C",654).
component("YML100W",626).
component("YBR126C",195).
component("YNL192W",673).
component("YBR038W",181).
component("YBR023C",177).
component("YEL011W",319).
component("YLR209C",592).
component("U104_",24).
component("U103_",23).
component("YOR209C",732).
component("YMR300C",656).
component("YDR354W",299).
component("YFR047C",366).
component("YJR133W",523).
component("U22_",98).
component("YLR209C",593).
component("YDR399W",301).
component("YJL167W",500).
component("YJL167W",501).
component("YNL256W",676).
component("YPR069C",790).
component("YDR127W",281).
component("YHR190W",456).
component("YHR068W",445).
component("YLR303W",601).
component("YGR012W",395).
component("YML082W",625).
component("YJR130C",522).
component("YDR035W",268).
component("YBR249C",206).
component("YLR180W",590).
component("YDR502C",312).
component("YOL143C",714).
component("YBR256C",208).
component("YHR137W",450).
component("YGL202W",388).
component("YLR027C",571).
component("YKL106W",535).
component("YOL140W",713).
component("YLR438W",617).
component("YKL104C",534).
component("YGR019W",396).
component("YDR111C",278).
component("U64_",132).
component("U51_",124).
component("YJR148W",526).
component("YHR208W",459).
component("YOR184W",729).
component("YNR058W",695).
component("YGL253W",394).
component("YFR053C",367).
component("YMR013C",633).
component("YMR205C",647).
component("YGR240C",421).
component("YLR240W",596).
component("YKL203C",552).
component("YJR066W",515).
component("YCR036W",227).
component("YGR194C",414).
component("YCL040W",220).
component("YJR105W",520).
component("U16_",67).
component("YPL188W",765).
component("YJR049C",512).
component("YEL041W",322).
component("YKL001C",529).
component("YDR236C",292).
component("YML070W",624).
component("YFL053W",360).
component("YDR531W",316).
component("U82_",147).
component("U81_",146).
component("YMR208W",648).
component("YPL203W",766).
component("YOR061W",718).
component("YKL166C",543).
component("YJL164C",499).
component("YIL035C",463).
component("YHR205W",458).
component("YHR102W",448).
component("YGL019W",373).
component("YHR025W",437).
component("YNR012W",688).
component("YPR121W",795).
component("YPL258C",775).
component("YOL055C",702).
component("YPL214C",768).
component("U1_",84).
...
component("YDR300C",297).
component("YCR012W",225).
component("YER052C",331).
component("U19_",83).
component("U18_",77).
component("U17_",72).
component("U76_",143).
component("YMR220W",650).
component("YER170W",352).
component("YDR226W",290).
component("YKL067W",533).
component("YOL055C",703).
component("YDR454C",309).
component("YOL061W",706).
component("YKL181W",544).
component("YHL011C",429).
component("YER099C",348).
component("YBL068W",168).
component("YOR143C",725).
component("YNL256W",677).
component("YLR328W",605).
component("YBR018C",173).
component("YBR018C",174).
component("YDL055C",236).
component("YGR202C",416).
component("YLR328W",606).
component("YDL103C",246).
component("U94_",156).
component("YJR010W",509).
component("YBR029C",178).
component("YGL130W",382).
component("YDR530C",315).
component("YCL050C",221).
component("YPR190C",802).
component("YPR187W",801).
component("YPR110C",794).
component("YPR010C",784).
component("YOR341W",745).
component("YOR340C",744).
component("YOR224C",735).
component("YOR210W",733).
component("YOR207C",731).
component("YOR151C",726).
component("YOR116C",721).
component("YOL005C",696).
component("YNR003C",687).
component("YNL248C",675).
component("YNL151C",671).
component("YNL113W",665).
component("YKL144C",540).
component("YJR063W",514).
component("YJL148W",496).
component("YJL140W",495).
component("YIL021W",462).
component("YHR143W-A",451).
component("YGL070C",380).
component("YFL036W",359).
component("YDR404C",304).
component("YDR156W",287).
component("YDR045C",271).
component("YDL150W",255).
component("YDL140C",250).
component("YBR154C",199).
component("YPR175W",800).
component("YPL167C",763).
component("YOR330C",742).
component("YOL115W",712).
component("YNL299W",683).
component("YNL262W",678).
component("YNL102W",664).
component("YJR043C",511).
component("YJR006W",507).
component("YJL090C",488).
component("YIL139C",470).
component("YEL055C",325).
component("YDR419W",307).
component("YDR121W",279).
component("YDL102W",245).
component("YCR014C",226).
component("YBR278W",209).
component("YBL035C",164).
component("YKL035W",531).
component("YHL012W",430).
component("YHR123W",449).
component("YNL130C",667).
component("YPL148C",761).
component("YOR251C",738).
component("YGR286C",426).
component("YDR058C",274).
component("YOL011W",698).
component("YMR008C",632).
component("YMR006C",631).
component("U105_",25).
component("U101_",21).
component("YJL068C",485).
component("YPL072W",756).
component("YOR124C",722).
component("YNL186W",672).
component("YMR304W",657).
component("YMR223W",651).
component("YKR098C",567).
component("YJL197W",502).
component("YIL156W",473).
component("YFR010W",362).
component("YER151C",351).
component("YER144C",350).
component("YER098W",347).
component("YDR069C",275).
component("YDL122W",247).
component("YBR058C",183).
component("YBL067C",167).
component("YJR019C",510).
component("U84_",148).
component("YDR481C",310).
component("YLR377C",611).
component("YDR074W",276).
component("YFR025C",365).
component("YPL179W",764).
component("YNR032W",691).
component("YML057W",623).
component("YML016C",619).
component("YLR433C",616).
component("YGR123C",404).
component("YER133W",349).
component("YER089C",344).
component("YDR436W",308).
component("YDR075W",277).
component("YDL188C",259).
component("YDL134C",249).
component("YDL047W",234).
component("YDL006W",230).
...
component("YIL053W",465).
component("YER062C",337).
component("YHR046C",441).
component("U9_",157).
component("YGR208W",420).
component("YPL228W",770).
component("YMR180C",644).
component("YDL236W",262).
component("YJL155C",498).
component("U34_",108).
component("U33_",107).
component("U32_",106).
component("U30_",105).
...
component("U26_",100).
component("U24_",99).
component("YHR044C",440).
component("YHR043C",439).
component("YOL064C",707).
component("YPL268W",779).
component("YOR360C",747).
component("YGL248W",393).
component("YKR031C",559).
component("YGL027C",375).
component("YLR286C",599).
component("YJR153W",527).
component("YJL221C",506).
component("YJL216C",504).
component("YIL172C",479).
component("YGR292W",428).
component("YGR287C",427).
component("YBR299W",213).
component("YBR184W",201).
component("YIL162W",476).
component("YPR026W",785).
component("YDR001C",264).
component("YBR001C",171).
component("YDR400W",302).
component("U102_",22).
component("YER043C",330).
component("YNL045W",660).
component("YLR160C",587).
component("YLR158C",586).
component("YLR157C",585).
component("YLR155C",584).
component("YDR321W",298).
component("YGL037C",376).
component("U43_",117).
component("U42_",116).
component("YLR308W",604).
component("YLR307W",603).
component("U53_",125).
component("YLR420W",614).
component("YPL111W",759).
component("YIR032C",481).
component("YLR028C",573).
component("YHR144C",452).
component("YHR144C",453).
component("YCL030C",218).
component("YNL141W",668).
component("YBR153W",198).
component("YDL238C",263).
component("YNL141W",669).
component("YML035C",620).
component("YGR204W",418).
component("YBR084W",187).
component("YJL126W",490).
component("U44_",118).
component("YDL100C",244).
component("U40_",114).
component("U39_",112).
...
component("YLR231C",594).
component("U88_",151).
component("YDR538W",318).
component("YLR134W",581).
component("YLR044C",575).
component("YGR087C",401).
component("YDR380W",300).
component("YDL080C",239).
component("YMR250W",652).
component("YKL184W",548).
component("YEL021W",320).
component("YNR043W",693).
component("U93_",155).
component("YDR047W",273).
component("YKL211C",553).
component("YKR097W",566).
component("YOL052C",701).
component("YGR170W",408).
component("YDR294C",294).
component("YEL046C",323).
component("YNR033W",692).
component("YPR006C",783).
component("YER065C",338).
component("YKL211C",554).
component("YER090W",345).
component("YDR127W",283).
component("YPL281C",781).
component("YOR393W",751).
component("YMR323W",658).
component("YHR174W",454).
component("YGR254W",422).
component("YPL262W",776).
component("YGL026C",374).
component("YGR155W",407).
component("YLR304C",602).
component("YJL200C",503).
component("YGL009C",371).
component("YNL316C",684).
component("YKL182W",546).
component("YPL212C",767).
component("YNL292W",682).
component("YGL063W",379).
component("YFL001W",354).
component("YCR053W",229).
component("YDR127W",284).
component("YGL148W",383).
component("YIL168W",478).
component("YIL167W",477).
component("YCL064C",222).
component("YCL064C",223).
component("YHR018C",433).
component("YLR359W",610).
component("YFR055W",368).
component("YJL121C",489).
component("YBR019C",175).
component("YDR007W",265).
component("YOR095C",720).
component("YBR196C",202).
component("YGL001C",370).
component("YPL117C",760).
component("U14_",55).
component("YKL152C",542).
component("YMR105C",638).
component("YKL127W",537).
component("YEL058W",326).
component("YPR060C",789).
component("YHR072W",446).
component("YJL153C",497).
component("YGR264C",425).
component("YGR171C",409).
component("YHR011W",432).
component("YDR023W",267).
component("YPL104W",758).
component("YLL018C",568).
component("YPR081C",793).
component("YBR121C",193).
component("YHR020W",436).
component("YER087W",343).
component("YOL033W",700).
component("YGL245W",392).
component("YOR168W",727).
component("YOL097C",710).
component("YDR268W",293).
component("YPR047W",788).
component("YLR060W",577).
component("YFL022C",358).
component("YPR033C",786).
component("YHR019C",434).
component("YHR019C",435).
component("YKL194C",551).
component("YIL078W",468).
component("YPL160W",762).
component("YLR382C",612).
component("YPL040C",755).
component("YBL076C",169).
component("YNL073W",663).
component("YDR037W",269).
component("YOR335C",743).
component("YGR094W",402).
component("YPR035W",787).
component("YIL145C",471).
component("U89_",152).
component("YOR241W",737).
component("YMR113W",640).
component("YKL132C",538).
component("YGL234W",390).
component("YER183C",353).
component("U90_",154).
...
component("YMR217W",649).
component("YPR145W",797).
component("YGR124W",405).
component("YOR303W",739).
component("YJR109C",521).
component("YJL130C",493).
component("YGL062W",378).
component("YBR218C",203).
component("YPL231W",774).
component("YNR016C",689).
component("YKL182W",547).
component("YGR037C",397).
component("YOR005C",716).
component("YDL164C",256).
component("YJL087C",486).
component("YOL010W",697).
component("YPR138C",796).
component("YPL265W",777).
component("YOR348C",746).
component("YOR192C",730).
component("YOR171C",728).
component("YOR130C",723).
component("YOR071C",719).
component("YOR011W",717).
component("YOL156W",715).
component("YOL103W",711).
component("YOL020W",699).
component("YNL318C",685).
component("YNL142W",670).
component("YMR272C",655).
component("YMR202W",646).
component("YMR056C",635).
component("YML123C",629).
component("YLR348C",607).
component("YLR260W",598).
component("YLR237W",595).
component("YLR138W",582).
component("YLR100C",580).
component("YLR092W",579).
component("YLR081W",578).
component("YLL061W",569).
component("YKR093W",565).
component("YKR053C",561).
component("YKR039W",560).
component("YKL217W",556).
component("YKL120W",536).
component("YJR095W",519).
component("YJR077C",517).
component("YJL219W",505).
component("YJL134W",494).
component("YJL129C",491).
component("YHL036W",431).
component("YGR191W",412).
component("YGR125W",406).
component("YGR121C",403).
component("YGR065C",400).
component("YGR055W",399).
component("YGL186C",385).
component("YFL055W",361).
component("YFL011W",355).
component("YER060W-A",334).
component("YER060W",333).
component("YER056C",332).
component("YDR536W",317).
component("YDR508C",314).
component("YDR503C",313).
component("YDR497C",311).
component("YDR297W",296).
component("YDR294C",295).
component("YDR046C",272).
component("YDL210W",260).
component("YCL025C",216).
component("YBR298C",212).
component("YBR294W",211).
