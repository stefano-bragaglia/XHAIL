...
component("YNL280C",362).
component("YLR056W",302).
component("YMR083W",335).
component("YPL231W",407).
component("YJR159W",279).
component("YGL001C",197).
component("YML056C",324).
component("YLR432W",322).
component("YHR216W",244).
component("YAR075W",82).
component("YAR073W",81).
component("YDR127W",147).
component("YJR139C",276).
component("YNL009W",350).
component("YLR174W",311).
component("YHR183W",241).
component("YGR256W",222).
component("YCL018W",110).
component("YJR078W",272).
component("YGR255C",221).
component("YMR015C",332).
component("YDR402C",161).
component("YGL055W",202).
component("YJL026W",251).
component("YGR180C",218).
component("YOR374W",397).
component("YER073W",180).
component("U68_",69).
component("U55_",65).
component("YER069W",179).
component("YOR323C",392).
component("YBR166C",103).
component("YNL280C",363).
component("YKL141W",285).
component("YOR375C",398).
component("YDL215C",136).
component("YAL062W",80).
component("U100_",20).
component("YBR035C",92).
component("YMR189W",339).
component("U56_",66).
component("YPL023C",400).
component("YGL125W",204).
component("YOR236W",390).
component("YLR142W",306).
component("U65_",68).
component("YHR068W",232).
component("YMR145C",338).
component("YDL085W",122).
component("YBR046C",93).
component("YPL091W",403).
component("YNL052W",351).
component("YMR256C",345).
component("YLR395C",321).
component("YLR038C",300).
component("YIL111W",247).
component("YHR051W",231).
component("YGL191W",208).
component("YGL187C",207).
component("YDL067C",120).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",412).
component("YLL062C",297).
component("YDR410C",163).
component("YER091C",182).
component("YJR073C",270).
component("YOL096C",377).
component("YMR120C",337).
component("YBL013W",83).
component("YJL130C",257).
component("YJL088W",253).
component("YPR074C",418).
component("YBR117C",99).
component("YCL009C",109).
component("YMR062C",334).
component("YNL071W",352).
component("YNR019W",369).
component("YCR048W",117).
component("U48_",61).
component("YFL017C",188).
component("YPL231W",408).
component("YDL052C",119).
component("U8_",75).
component("YPL231W",409).
component("YLR299W",315).
component("YCR005C",114).
component("YML126C",328).
component("YDL182W",134).
component("YDL131W",127).
component("YNL117W",355).
component("YIR031C",250).
component("YOR321W",391).
component("YJR143C",277).
component("YGR199W",219).
component("YDL095W",124).
component("YDL093W",123).
component("YAL023C",79).
component("YMR261C",346).
component("YML100W",326).
component("YBR126C",100).
component("YLR209C",312).
component("YDR354W",158).
component("YFR047C",195).
component("YJR133W",275).
component("U22_",51).
component("YDR399W",160).
component("YJL167W",264).
component("YPR069C",417).
component("YDR127W",148).
component("YHR068W",233).
component("YML082W",325).
component("YJR130C",274).
component("YDR035W",140).
component("YBR249C",105).
component("YBR256C",106).
component("YHR137W",236).
component("YGL202W",209).
component("YLR027C",298).
component("YKL106W",283).
component("YOL140W",380).
component("YLR438W",323).
component("YKL104C",282).
component("YDR111C",145).
component("U51_",63).
component("YJR148W",278).
component("YMR013C",331).
component("YCR036W",116).
component("YCL040W",113).
component("YJR105W",273).
component("U81_",74).
component("YMR208W",341).
component("YPL203W",406).
component("YOR061W",381).
component("YKL166C",287).
component("YJL164C",263).
component("YIL035C",246).
component("YHR205W",243).
component("YHR102W",235).
component("YGL019W",198).
component("YHR025W",228).
component("YNR012W",367).
component("YFR019W",193).
component("YDR208W",154).
component("YDR127W",149).
component("U21_",48).
component("YDR147W",152).
component("YER052C",175).
component("U19_",44).
component("U18_",40).
component("U17_",37).
component("U76_",72).
component("YMR220W",342).
component("YDR226W",155).
component("YKL067W",281).
component("YDR454C",165).
component("YOL061W",376).
component("YKL181W",288).
component("YHL011C",224).
component("YER099C",184).
component("YBL068W",88).
component("YOR143C",385).
component("YLR328W",318).
component("U94_",77).
component("YBR029C",91).
...
component("YOR207C",387).
component("YOR151C",386).
component("YOR116C",383).
component("YOL005C",372).
component("YNR003C",366).
component("YNL248C",360).
component("YNL151C",358).
component("YNL113W",354).
component("YKL144C",286).
component("YJR063W",269).
component("YJL148W",260).
component("YJL140W",259).
component("YIL021W",245).
...
component("YPL167C",405).
component("YOR330C",393).
component("YOL115W",379).
component("YNL299W",364).
component("YNL262W",361).
component("YNL102W",353).
component("YJR043C",268).
component("YJR006W",266).
component("YJL090C",254).
component("YIL139C",248).
component("YEL055C",172).
component("YDR419W",164).
component("YDR121W",146).
component("YDL102W",125).
component("YCR014C",115).
component("YBR278W",107).
component("YBL035C",85).
component("YKL035W",280).
component("YHL012W",225).
component("YOL011W",374).
component("YMR008C",330).
component("YMR006C",329).
component("U105_",21).
component("YPL072W",402).
component("YOR124C",384).
component("YNL186W",359).
component("YMR304W",348).
component("YMR223W",343).
component("YKR098C",296).
component("YJL197W",265).
component("YIL156W",249).
component("YFR010W",192).
component("YER151C",186).
component("YER144C",185).
component("YER098W",183).
component("YDR069C",143).
component("YDL122W",126).
component("YBR058C",94).
component("YBL067C",87).
component("YJR019C",267).
component("YDR074W",144).
component("YFR025C",194).
component("U9_",78).
component("YJL155C",262).
component("U34_",57).
component("U33_",56).
component("U32_",55).
component("U30_",54).
component("U29_",53).
component("U24_",52).
component("YHR044C",230).
component("YHR043C",229).
component("YGL027C",200).
component("YLR286C",314).
component("YLR160C",310).
component("YLR158C",309).
component("YLR157C",308).
component("YLR155C",307).
component("YDR321W",157).
component("YGL037C",201).
component("U43_",59).
component("U42_",58).
component("YLR308W",317).
component("YLR307W",316).
component("U53_",64).
component("YLR028C",299).
component("YHR144C",238).
component("YHR144C",239).
component("YBR153W",101).
component("YDL238C",137).
component("YNL141W",356).
component("YJL126W",256).
component("U44_",60).
component("YHR201C",242).
component("YBR111C",98).
component("YCL030C",112).
component("YER005W",174).
component("YLR231C",313).
component("YDR538W",170).
component("YLR134W",305).
component("YLR044C",301).
component("YGR087C",213).
component("YDR380W",159).
component("YDL080C",121).
component("YMR250W",344).
component("YKL184W",290).
component("YEL021W",171).
component("YKL211C",291).
component("YNR033W",370).
component("YKL211C",292).
component("YER090W",181).
component("YDR127W",150).
component("YPL281C",413).
component("YOR393W",399).
component("YMR323W",349).
component("YHR174W",240).
component("YGR254W",220).
component("YGL026C",199).
component("YGR155W",216).
component("YNL316C",365).
component("YCR053W",118).
component("YDR127W",151).
component("YGL148W",205).
component("YFR055W",196).
component("YJL121C",255).
component("YBR019C",90).
component("YDR007W",138).
component("YOR095C",382).
component("YBR196C",104).
component("U14_",30).
component("YMR105C",336).
component("YKL127W",284).
component("YEL058W",173).
component("YPR060C",416).
component("YHR072W",234).
component("YJL153C",261).
component("YGR264C",223).
component("YGR171C",217).
component("YHR011W",226).
component("YDR023W",139).
component("YGL245W",211).
component("YPR047W",415).
component("YLR060W",303).
component("YFL022C",189).
component("YHR019C",227).
component("YPL160W",404).
component("YLR382C",320).
component("YPL040C",401).
component("YBL076C",89).
component("YGL234W",210).
component("YER183C",187).
component("U90_",76).
component("YNR057C",371).
component("YDL141W",129).
component("YDL141W",130).
component("YDL141W",131).
component("YDL141W",132).
component("YPR145W",421).
component("YGR124W",215).
component("YPL231W",410).
component("YNR016C",368).
component("YKL182W",289).
component("YGR037C",212).
component("YJL087C",252).
component("YOL010W",373).
component("YPR138C",420).
component("YPL265W",411).
component("YOR348C",396).
component("YOL103W",378).
component("YOL020W",375).
component("YNL142W",357).
component("YMR272C",347).
component("YMR202W",340).
component("YMR056C",333).
component("YML123C",327).
component("YLR348C",319).
component("YLR100C",304).
component("YKR053C",295).
component("YKR039W",294).
component("YKL217W",293).
component("YJR077C",271).
component("YJL134W",258).
component("YGR121C",214).
component("YGL186C",206).
component("YFL055W",191).
component("YER060W-A",178).
component("YER060W",177).
component("YER056C",176).
component("YDR536W",169).
component("YDR508C",168).
component("YDR503C",167).
component("YDR497C",166).
component("YDR294C",156).
component("YDR046C",142).
component("YDL210W",135).
component("YCL025C",111).
component("YBR291C",108).
component("YBR085W",97).
component("YBR069C",96).
component("YBR068C",95).
component("YBL042C",86).
component("YBL030C",84).
component("U7_",73).
component("U6_",71).
component("U69_",70).
component("U5_",67).
