...
component("YNL280C",410).
component("YLR056W",343).
component("YMR083W",382).
component("YPL231W",459).
component("YJR159W",317).
component("YGL001C",223).
component("YML056C",369).
component("YLR432W",365).
component("YHR216W",276).
component("YAR075W",91).
component("YAR073W",90).
component("YDR127W",168).
component("YJR139C",314).
component("YNL009W",397).
component("YLR174W",352).
component("YHR183W",272).
component("YGR256W",253).
component("YCL018W",123).
component("YJR078W",310).
component("U58_",73).
component("YGR255C",252).
component("YMR015C",379).
component("YDR402C",182).
component("YGL055W",228).
component("YJL026W",286).
component("YGR180C",246).
component("YJR009C",303).
component("YJL052W",287).
component("YGR192C",248).
component("YOR374W",448).
component("YER073W",203).
component("U68_",77).
component("U55_",71).
component("YER069W",202).
component("YOR323C",443).
component("YBR166C",116).
component("YNL280C",411).
component("YKL141W",323).
component("YOR375C",449).
component("YDL215C",155).
component("YAL062W",89).
component("U100_",20).
component("YBR035C",102).
component("YMR189W",386).
component("U56_",72).
component("YPL023C",451).
component("YGL125W",230).
component("YOR236W",441).
component("YBR084W",107).
component("YLR142W",347).
component("U65_",76).
component("U62_",75).
component("YHR068W",263).
component("YMR145C",385).
component("YML120C",373).
component("YKL192C",329).
component("YDL085W",138).
component("YBR046C",103).
component("YPL091W",454).
component("YNL052W",398).
component("YMR256C",392).
component("YLR395C",363).
component("YLR038C",341).
component("YIL111W",280).
component("YHR051W",262).
component("YGL191W",234).
component("YGL187C",233).
component("YDL067C",136).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",465).
component("YLL062C",338).
component("YDR410C",184).
component("YER091C",206).
component("YJR073C",308).
component("YOL096C",427).
component("YMR120C",384).
component("YBL013W",92).
component("YJL130C",293).
component("YJL088W",289).
component("YPR074C",471).
component("YBR117C",111).
component("YCL009C",122).
component("YMR062C",381).
component("YNL071W",399).
component("YNR019W",417).
component("YCR048W",131).
component("U48_",67).
component("YFL017C",213).
component("YPL231W",460).
component("YDL052C",135).
component("U8_",84).
component("YPL231W",461).
component("YLR299W",356).
component("YCR005C",128).
component("YML126C",375).
component("YDL182W",152).
component("YDL131W",144).
component("YNL117W",402).
component("YIR031C",284).
component("YOR321W",442).
component("YJR143C",315).
component("YGR199W",250).
component("YDL095W",140).
component("YDL093W",139).
component("YAL023C",88).
component("YMR261C",393).
component("YML100W",372).
component("YBR126C",113).
component("YLR209C",353).
component("YDR354W",179).
component("YFR047C",220).
component("YJR133W",313).
component("U22_",57).
component("YDR399W",181).
component("YJL167W",300).
component("YPR069C",470).
component("YDR127W",169).
component("YHR068W",264).
component("YLR303W",357).
component("YML082W",371).
component("YJR130C",312).
component("YDR035W",159).
component("YBR249C",118).
component("YBR256C",119).
component("YHR137W",267).
component("YGL202W",235).
component("YLR027C",339).
component("YKL106W",321).
component("YOL140W",430).
component("YLR438W",367).
component("YKL104C",320).
component("YDR111C",166).
component("U51_",69).
component("YJR148W",316).
component("YHR208W",275).
component("YGL253W",238).
component("YFR053C",221).
component("YMR013C",378).
component("YCR036W",130).
component("YGR194C",249).
component("YCL040W",126).
component("YJR105W",311).
component("U81_",82).
component("YMR208W",388).
component("YPL203W",458).
component("YOR061W",431).
component("YKL166C",325).
component("YJL164C",299).
component("YIL035C",278).
component("YHR205W",274).
component("YHR102W",266).
component("YGL019W",224).
component("YHR025W",259).
component("YNR012W",415).
component("YPR121W",473).
component("YPL258C",463).
component("YOL055C",425).
component("YFR019W",218).
component("YDR208W",175).
component("YDR127W",170).
component("U21_",54).
component("YDR147W",173).
component("YER052C",198).
component("U19_",47).
component("U18_",43).
component("U17_",40).
component("U76_",80).
component("YMR220W",389).
component("YDR226W",176).
component("YKL067W",319).
component("YDR454C",187).
component("YOL061W",426).
component("YKL181W",326).
component("YHL011C",255).
component("YER099C",208).
component("YBL068W",98).
component("YOR143C",435).
component("YLR328W",360).
component("YDL103C",142).
component("U94_",86).
component("YJR010W",304).
component("YBR029C",101).
component("YPR190C",478).
component("YPR187W",477).
component("YPR110C",472).
component("YPR010C",467).
component("YOR341W",446).
component("YOR340C",445).
component("YOR224C",440).
component("YOR210W",439).
component("YOR207C",438).
component("YOR151C",436).
component("YOR116C",433).
component("YOL005C",421).
component("YNR003C",414).
component("YNL248C",408).
component("YNL151C",406).
component("YNL113W",401).
component("YKL144C",324).
component("YJR063W",307).
component("YJL148W",296).
component("YJL140W",295).
component("YIL021W",277).
component("YHR143W-A",268).
component("YGL070C",229).
component("YFL036W",215).
component("YDR404C",183).
component("YDR156W",174).
component("YDR045C",160).
component("YDL150W",151).
component("YDL140C",146).
component("YBR154C",115).
component("YPR175W",476).
component("YPL167C",456).
component("YOR330C",444).
component("YOL115W",429).
component("YNL299W",412).
component("YNL262W",409).
component("YNL102W",400).
component("YJR043C",306).
component("YJR006W",302).
component("YJL090C",290).
component("YIL139C",281).
component("YEL055C",194).
component("YDR419W",185).
component("YDR121W",167).
component("YDL102W",141).
component("YCR014C",129).
component("YBR278W",120).
component("YBL035C",94).
component("YKL035W",318).
component("YHL012W",256).
component("YDR058C",162).
component("YOL011W",423).
component("YMR008C",377).
component("YMR006C",376).
component("U105_",22).
component("U101_",21).
component("YPL072W",453).
component("YOR124C",434).
component("YNL186W",407).
component("YMR304W",395).
component("YMR223W",390).
component("YKR098C",337).
component("YJL197W",301).
component("YIL156W",282).
component("YFR010W",217).
component("YER151C",211).
component("YER144C",210).
component("YER098W",207).
component("YDR069C",163).
component("YDL122W",143).
component("YBR058C",104).
component("YBL067C",97).
component("YJR019C",305).
component("YDR074W",164).
component("YFR025C",219).
component("YPL179W",457).
component("YNR032W",418).
component("YML057W",370).
component("YML016C",368).
component("YLR433C",366).
component("YGR123C",242).
component("YER133W",209).
component("YER089C",204).
component("YDR436W",186).
component("YDR075W",165).
component("YDL188C",153).
component("YDL134C",145).
component("YDL047W",134).
component("YDL006W",133).
component("YBR125C",112).
component("YBL056W",96).
component("U9_",87).
component("YJL155C",298).
component("U34_",63).
component("U33_",62).
component("U32_",61).
component("U30_",60).
...
component("YGL027C",226).
component("YLR286C",355).
component("YER043C",197).
component("YLR160C",351).
component("YLR158C",350).
component("YLR157C",349).
component("YLR155C",348).
component("YDR321W",178).
component("YGL037C",227).
component("U43_",65).
component("U42_",64).
component("YLR308W",359).
component("YLR307W",358).
component("U53_",70).
component("YLR420W",364).
component("YIR032C",285).
component("YLR028C",340).
component("YHR144C",269).
component("YHR144C",270).
component("YNL141W",403).
component("YBR153W",114).
component("YDL238C",156).
component("YNL141W",404).
component("YBR084W",108).
component("YJL126W",292).
component("U44_",66).
component("YHR201C",273).
component("YBR111C",110).
component("YCL030C",125).
component("YER005W",196).
component("YLR231C",354).
component("U88_",83).
component("YDR538W",192).
component("YLR134W",346).
component("YLR044C",342).
component("YGR087C",240).
component("YDR380W",180).
component("YDL080C",137).
component("YMR250W",391).
component("YKL184W",328).
component("YEL021W",193).
component("YKL211C",331).
component("YKR097W",336).
component("YNR033W",419).
component("YKL211C",332).
component("YER090W",205).
component("YDR127W",171).
component("YPL281C",466).
component("YOR393W",450).
component("YMR323W",396).
component("YHR174W",271).
component("YGR254W",251).
component("YGL026C",225).
component("YGR155W",244).
component("YNL316C",413).
component("YCR053W",132).
component("YDR127W",172).
component("YGL148W",231).
component("YIL167W",283).
component("YCL064C",127).
component("YFR055W",222).
component("YJL121C",291).
component("YBR019C",100).
component("YDR007W",157).
component("YOR095C",432).
component("YBR196C",117).
component("U14_",31).
component("YMR105C",383).
component("YKL127W",322).
component("YEL058W",195).
component("YPR060C",469).
component("YHR072W",265).
component("YJL153C",297).
component("YGR264C",254).
component("YGR171C",245).
component("YHR011W",257).
component("YDR023W",158).
component("YGL245W",237).
component("YOR168W",437).
component("YPR047W",468).
component("YLR060W",344).
component("YFL022C",214).
component("YHR019C",258).
component("YKL194C",330).
component("YIL078W",279).
component("YPL160W",455).
component("YLR382C",362).
component("YPL040C",452).
component("YBL076C",99).
component("YGL234W",236).
component("YER183C",212).
component("U90_",85).
component("YNR057C",420).
component("YDL141W",147).
component("YDL141W",148).
component("YDL141W",149).
component("YDL141W",150).
component("YPR145W",475).
component("YGR124W",243).
component("YPL231W",462).
component("YNR016C",416).
component("YKL182W",327).
component("YGR037C",239).
component("YJL087C",288).
component("YOL010W",422).
component("YPR138C",474).
component("YPL265W",464).
component("YOR348C",447).
component("YOL103W",428).
component("YOL020W",424).
component("YNL142W",405).
component("YMR272C",394).
component("YMR202W",387).
component("YMR056C",380).
component("YML123C",374).
component("YLR348C",361).
component("YLR100C",345).
component("YKR053C",335).
component("YKR039W",334).
component("YKL217W",333).
component("YJR077C",309).
component("YJL134W",294).
component("YGR191W",247).
component("YGR121C",241).
component("YGL186C",232).
...
component("YDR046C",161).
component("YDL210W",154).
component("YCL025C",124).
component("YBR291C",121).
component("YBR085W",109).
component("YBR069C",106).
component("YBR068C",105).
component("YBL042C",95).
component("YBL030C",93).
component("U7_",81).
component("U6_",79).
component("U69_",78).
component("U5_",74).
