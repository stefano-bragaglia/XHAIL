...
component("YNL280C",907).
component("YLR056W",768).
component("YGR060W",540).
component("YKR009C",747).
component("YMR083W",849).
component("YPL231W",1027).
component("YBR265W",287).
component("U46_",162).
component("YBR149W",269).
component("YBR149W",270).
component("YJR159W",710).
component("YGL001C",504).
component("YHR063C",599).
component("U45_",161).
component("YBR153W",271).
component("YML056C",829).
component("YLR432W",817).
component("YHR216W",624).
...
component("YLR450W",820).
component("YOL126C",947).
component("YKL085W",720).
component("YDL078C",330).
component("YKL029C",715).
component("YOR136W",966).
component("YNL037C",882).
component("YNL009W",880).
component("YLR174W",786).
component("YDL066W",328).
component("YHR183W",618).
component("YGR256W",574).
component("YNL241C",898).
component("YOL059W",939).
component("YDL022W",319).
component("YCL018W",295).
component("YLR355C",811).
component("YIL074C",631).
component("YER081W",471).
component("YML054C",828).
component("YDL174C",353).
component("YIL155C",641).
component("YPR191W",1065).
component("YOR065W",956).
component("YJL166W",676).
component("YHR001W-A",585).
component("YGR183C",557).
component("YFR033C",500).
component("YEL024W",441).
component("YDR529C",431).
component("YBL045C",229).
component("Q0105",19).
component("YKR066C",752).
component("YKL026C",714).
component("YIR037W",652).
component("YBR244W",282).
...
component("YMR015C",845).
component("YHR007C",586).
component("YDR402C",418).
component("YGL055W",514).
component("YGR175C",554).
component("YJR104C",699).
component("YHR008C",587).
component("YJL026W",655).
component("YIL066C",630).
component("YGR180C",556).
component("YER070W",469).
component("U37_",153).
component("U36_",152).
component("U35_",151).
component("YDR158W",392).
component("YJR009C",686).
component("YJL052W",657).
component("YGR192C",560).
component("YBR006W",239).
component("YPL276W",1038).
component("YPL275W",1037).
component("YOR388C",1000).
component("YOR374W",997).
...
component("YOR323C",987).
component("U2_",145).
component("YER178W",483).
component("YBR221C",280).
...
component("U57_",173).
component("YKL216W",744).
component("YDR044W",370).
component("YER014W",452).
component("YKR009C",748).
component("YIL160C",643).
component("YGL205W",527).
component("YMR118C",854).
component("YLR164W",784).
component("YLL041C",759).
component("YKL148C",728).
component("YKL141W",726).
component("YJL045W",656).
component("YDR178W",394).
component("YJR051W",691).
component("YEL047C",445).
component("YDL171C",352).
component("YDL215C",357).
component("YOR375C",998).
component("YDL215C",358).
component("YAL062W",219).
component("U99_",213).
component("U100_",22).
component("YBR035C",249).
component("YMR189W",861).
component("U56_",172).
component("YNR050C",923).
component("YKR080W",754).
component("YER023W",453).
component("YPL023C",1004).
component("YGL125W",519).
component("YOR236W",980).
...
component("U63_",180).
component("U62_",179).
component("YOR356W",995).
component("YHR068W",600).
component("YKL150W",729).
component("YIL043C",628).
component("YHR042W",594).
component("YOR221C",978).
component("YMR145C",857).
component("YML120C",837).
component("YKL192C",737).
component("YKL055C",717).
component("YER061C",463).
component("YDL085W",332).
component("YBR046C",252).
component("YMR145C",858).
component("YML120C",838).
component("YKL192C",738).
component("YDL085W",333).
component("YGR234W",568).
component("YFR030W",499).
component("YPL017C",1003).
component("YFL018C",488).
component("YPL091W",1010).
component("YHR106W",609).
component("YDR353W",413).
component("YER042W",455).
component("YPR167C",1059).
component("YJR137C",704).
component("YNL052W",884).
component("YMR256C",869).
component("YLR395C",815).
component("YLR038C",766).
component("YIL111W",635).
component("YHR051W",598).
...
component("Q0250",20).
component("Q0045",18).
component("YPL266W",1034).
component("YML110C",836).
component("YBR034C",248).
component("YPL273W",1036).
component("YLL062C",762).
component("YDR410C",421).
component("YKR069W",753).
component("YOL096C",942).
component("U47_",163).
component("YER091C",475).
component("YJR073C",694).
component("YGR157W",551).
component("YML008C",821).
component("YDL033C",321).
component("YOL096C",943).
component("YLR172C",785).
component("YLR058C",769).
component("YBR263W",286).
component("YDR019C",366).
component("YBR176W",275).
component("YDR408C",420).
component("YMR120C",855).
component("YLR028C",764).
component("YBL013W",223).
component("YJL130C",668).
component("YJL088W",662).
component("YKL024C",713).
component("YPR074C",1051).
component("YBR117C",264).
component("YLR354C",810).
component("YGR043C",538).
component("YMR108W",852).
component("YCL009C",294).
component("YMR062C",848).
component("YNL071W",885).
component("YIL160C",644).
component("YNR019W",917).
component("YCR048W",314).
component("U48_",164).
component("YNL277W",906).
component("YDR232W",397).
component("YFL017C",487).
component("YPL231W",1028).
component("YER061C",464).
component("U86_",203).
component("YPL001W",1002).
component("YDL052C",325).
component("U8_",206).
component("YDR148C",390).
component("YML042W",827).
component("YOR377W",999).
component("YGR177C",555).
component("YPL231W",1029).
component("YGR147C",549).
component("YDL040C",322).
component("YPL028W",1005).
component("YLR195C",788).
component("YLR299W",798).
component("YGL017W",509).
component("YPR001W",1040).
component("YNR001C",913).
component("YCR005C",306).
component("YML126C",840).
component("YDL182W",354).
component("YDL131W",342).
component("YNL117W",889).
component("YIR031C",650).
component("YPR160W",1058).
component("YOR321W",986).
component("YJR143C",706).
component("YGR199W",562).
component("YDL095W",337).
component("YDL093W",336).
component("YAL023C",216).
component("YLR258W",795).
component("YFR015C",496).
component("YPL227C",1025).
component("YOR103C",961).
component("YOR085W",958).
component("YMR149W",859).
component("YML019W",823).
component("YJL002C",653).
component("YEL002C",436).
component("YDL232W",359).
component("YCL043C",301).
component("YNL029C",881).
component("YIL085C",633).
component("YMR261C",870).
component("YML100W",834).
component("YBR126C",267).
component("YNL192W",896).
component("YBR038W",251).
component("YBR023C",246).
component("YEL011W",437).
component("YMR306W",878).
component("YLR342W",808).
component("YGR032W",536).
component("YPR183W",1062).
component("YLR209C",789).
component("U104_",26).
component("U103_",25).
component("YMR271C",871).
component("YML106W",835).
component("YOR209C",976).
component("YMR300C",876).
component("YER055C",459).
component("YDR354W",414).
component("YFR047C",501).
component("YJR133W",703).
component("U22_",139).
component("YLR209C",790).
component("YML022W",824).
component("YDR441C",424).
component("YDR399W",416).
component("YHR128W",611).
component("YPR176C",1061).
component("YPL172C",1018).
component("YNR041C",921).
component("YMR101C",850).
component("YDL090C",335).
component("YBR003W",238).
component("YBR002C",237).
component("YJL167W",677).
component("YJL167W",678).
component("YNL256W",901).
component("YPR069C",1049).
component("YDR127W",385).
component("YHR190W",619).
component("YLR146C",778).
component("YHR068W",601).
component("YLR303W",800).
component("YGR012W",534).
component("YML082W",833).
component("YJR130C",702).
component("YDR035W",368).
component("YBR249C",283).
component("YLR180W",787).
component("YDR502C",428).
component("YOR274W",983).
component("YOL143C",950).
component("YBR256C",285).
component("YHR137W",612).
component("YGL202W",526).
component("YLR027C",763).
component("YKL106W",722).
component("YOL140W",949).
component("YLR438W",819).
component("YKL104C",721).
component("YGR019W",535).
component("YDR111C",382).
component("U64_",181).
component("U61_",178).
component("U51_",168).
component("YJR148W",707).
component("YHR208W",622).
component("YFL030W",490).
component("YOR184W",972).
component("YNR058W",926).
component("YIL116W",636).
component("YGL253W",532).
component("YFR053C",502).
component("YOL136C",948).
component("YIL107C",634).
component("YMR013C",844).
component("YMR205C",863).
component("YGR240C",569).
component("YOL016C",931).
component("YFR014C",495).
component("YLR240W",793).
component("YKL203C",740).
component("YJR066W",693).
component("YCR036W",313).
component("YGR194C",561).
component("YCL040W",300).
component("YJR105W",700).
component("U16_",86).
component("U15_",77).
component("YPL188W",1020).
component("YJR049C",690).
component("YEL041W",442).
component("U96_",211).
component("YKL001C",711).
component("YDR236C",398).
component("YML070W",831).
component("YFL053W",492).
component("YHL032C",583).
component("YLR133W",774).
component("YDR531W",433).
component("U83_",200).
component("U82_",199).
component("U81_",198).
component("YMR208W",864).
component("YPL203W",1021).
component("YOR061W",955).
component("YKL166C",731).
component("YJL164C",675).
component("YIL035C",627).
component("YHR205W",621).
component("YHR102W",608).
component("YGL019W",510).
component("YHR025W",593).
component("YOR347C",993).
component("YAL038W",217).
component("YNR012W",915).
component("YPR121W",1055).
component("YPL258C",1031).
component("YOL055C",935).
component("YPL214C",1024).
component("U1_",117).
component("YDR009W",365).
component("YBR020W",245).
component("YNL267W",904).
component("YLR305C",802).
component("YFR019W",497).
...
component("U17_",95).
component("U76_",194).
component("YMR220W",866).
component("YER170W",482).
component("YDR226W",396).
component("YKL067W",719).
component("YOL055C",936).
component("YDR454C",425).
component("YOL061W",940).
component("YKL181W",732).
component("YHL011C",580).
component("YER099C",477).
component("YBL068W",232).
component("YOR143C",967).
component("YNL256W",902).
component("YLR328W",806).
component("YBR018C",241).
component("YBR018C",242).
component("YDL055C",326).
component("YGR007W",533).
component("YGR202C",563).
component("YLR328W",807).
component("YKR002W",746).
component("YDL045C",323).
component("YDL103C",340).
component("U94_",210).
component("YJR010W",687).
component("YBR029C",247).
component("YCL050C",302).
component("YGL130W",520).
component("YDR530C",432).
component("YCL050C",303).
component("YPR190C",1064).
component("YPR187W",1063).
component("YPR110C",1053).
component("YPR010C",1042).
component("YOR341W",992).
component("YOR340C",991).
component("YOR224C",979).
component("YOR210W",977).
component("YOR207C",975).
component("YOR151C",968).
component("YOR116C",962).
component("YOL005C",928).
component("YNR003C",914).
component("YNL248C",900).
component("YNL151C",894).
component("YNL113W",888).
component("YKL144C",727).
component("YJR063W",692).
component("YJL148W",672).
component("YJL140W",671).
component("YIL021W",626).
component("YHR143W-A",613).
component("YGL070C",518).
component("YFL036W",491).
component("YDR404C",419).
component("YDR156W",391).
component("YDR045C",371).
component("YDL150W",350).
component("YDL140C",344).
component("YBR154C",273).
component("YPR175W",1060).
component("YPL167C",1017).
component("YOR330C",988).
component("YOL115W",946).
component("YNL299W",910).
component("YNL262W",903).
component("YNL102W",887).
component("YJR043C",689).
component("YJR006W",685).
...
component("YCR014C",308).
component("YBR278W",288).
component("YBL035C",226).
component("YKL035W",716).
component("YHL012W",581).
component("YHR123W",610).
component("YPR113W",1054).
component("YBR243C",281).
component("YNL130C",890).
component("YDL142C",349).
component("YPL148C",1015).
component("YER026C",454).
component("YOR251C",982).
component("YGR286C",577).
component("YJL068C",658).
component("YDR058C",376).
component("YNR034W",920).
component("YHR163W",616).
component("YGR248W",571).
component("YCR073W-A",316).
component("YDL086W",334).
component("YOL011W",930).
component("YMR008C",842).
component("YMR006C",841).
component("U105_",27).
component("U101_",23).
component("YJL068C",659).
component("YPL072W",1009).
component("YOR124C",963).
component("YNL186W",895).
component("YMR304W",877).
component("YMR223W",867).
component("YKR098C",757).
component("YJL197W",679).
component("YIL156W",642).
component("YFR010W",494).
component("YER151C",481).
component("YER144C",480).
component("YER098W",476).
component("YDR069C",378).
component("YDL122W",341).
component("YBR058C",253).
component("YBL067C",231).
component("YJR019C",688).
component("YOR040W",954).
component("YDR272W",402).
component("U84_",201).
component("YDR481C",426).
component("YLR377C",813).
component("YDR074W",379).
component("YFR025C",498).
component("YPL179W",1019).
component("YNR032W",918).
component("YML057W",830).
component("YML016C",822).
component("YLR433C",818).
component("YGR123C",545).
component("YER133W",479).
component("YER089C",473).
component("YDR436W",423).
component("YDR075W",380).
component("YDL188C",355).
component("YDL134C",343).
component("YDL047W",324).
component("YDL006W",317).
component("YBR125C",266).
component("YBL056W",230).
component("YPR073C",1050).
component("YHR215W",623).
component("YDL024C",320).
component("YBR093C",261).
component("YBR092C",260).
component("YIL053W",629).
component("YER062C",465).
component("YHR046C",597).
component("U9_",214).
component("YGR208W",567).
component("YPL228W",1026).
component("YMR180C",860).
component("YDL236W",360).
component("YJL155C",674).
component("U34_",150).
component("U33_",149).
component("U32_",148).
component("U31_",147).
...
component("U26_",141).
component("U24_",140).
component("YHR044C",596).
component("YHR043C",595).
component("YOL064C",941).
component("YPL268W",1035).
component("YOR360C",996).
component("YGL248W",531).
component("YKR031C",749).
component("YPL206C",1022).
component("YGL027C",512).
component("YLR286C",797).
component("YJR153W",708).
component("YJL221C",684).
component("YJL216C",682).
component("YIL172C",648).
component("YGR292W",579).
component("YGR287C",578).
component("YBR299W",293).
component("YBR184W",276).
component("YIL162W",645).
component("YPR026W",1043).
component("YDR001C",363).
component("YBR001C",236).
component("YOR190W",973).
component("YLR300W",799).
component("YGR282C",576).
component("YDR261C",400).
...
component("YNL045W",883).
component("YLR160C",783).
component("YLR158C",782).
component("YLR157C",781).
component("YLR155C",780).
component("YDR321W",408).
component("YGL037C",513).
component("U43_",159).
component("U42_",158).
component("YMR293C",875).
component("YDR242W",399).
component("YLR308W",805).
component("YLR307W",804).
component("YBR208C",278).
component("YMR281W",874).
component("U53_",169).
component("YLR420W",816).
component("YPL111W",1013).
component("YIR032C",651).
component("YIR029W",649).
component("YPR062W",1048).
component("YMR120C",856).
component("YLR028C",765).
component("YHR144C",614).
component("YHR144C",615).
component("YCL030C",298).
component("YNL141W",891).
component("YBL033C",225).
component("YBR153W",272).
component("YDL238C",361).
component("YNL141W",892).
component("YLR245C",794).
component("YML035C",826).
component("YGR204W",565).
component("YBR084W",258).
component("YJL126W",666).
component("U44_",160).
component("YDL100C",338).
component("U40_",156).
component("U39_",154).
component("YBR011C",240).
component("YHR201C",620).
component("YBR111C",262).
component("YBR252W",284).
component("YCL030C",299).
component("YEL042W",443).
component("YER005W",451).
component("YBL099W",235).
component("U60_",177).
component("YLR231C",791).
component("U88_",204).
component("YDR538W",435).
component("YLR134W",775).
component("YLR044C",767).
component("YGR087C",542).
component("YDR380W",415).
component("YDL080C",331).
component("U98_",212).
component("YMR250W",868).
component("YKL184W",736).
component("YOR128C",964).
component("YEL021W",440).
component("YNR043W",922).
component("U93_",209).
component("YDR047W",373).
component("U54_",170).
component("YKL211C",742).
component("YKR097W",756).
component("YOL052C",934).
component("YGR170W",552).
component("YKL060C",718).
component("YDR294C",404).
component("YEL046C",444).
component("YNR033W",919).
component("YPR006C",1041).
component("YER065C",466).
component("YKL211C",743).
component("YER090W",474).
component("YDR127W",387).
component("YPL281C",1039).
component("YOR393W",1001).
component("YMR323W",879).
component("YHR174W",617).
component("YGR254W",572).
component("YPL262W",1032).
component("YGL026C",511).
component("YGR155W",550).
component("YLR304C",801).
component("YJL200C",680).
component("YGL009C",507).
component("YNL316C",911).
component("YKL182W",734).
component("YPL212C",1023).
component("YNL292W",909).
component("YGL063W",517).
component("YFL001W",485).
component("YOR278W",984).
component("U49_",165).
component("YCR053W",315).
...
component("YHR018C",589).
component("YLR359W",812).
component("YAL012W",215).
component("YFR055W",503).
component("YJL005W",654).
component("YOR176W",971).
component("YJL121C",665).
component("YBR019C",243).
component("YBR019C",244).
component("U59_",175).
component("YDR050C",374).
component("YIL020C",625).
component("YDR007W",364).
component("YOR095C",959).
component("YER003C",450).
component("YBR196C",277).
component("YGL001C",505).
component("YPL117C",1014).
component("U14_",70).
component("YOL056W",937).
component("YKL152C",730).
component("YDL021W",318).
component("YMR105C",851).
component("YKL127W",724).
component("YEL058W",447).
component("YMR278W",873).
component("YPR060C",1047).
component("YHR072W",602).
component("YJL153C",673).
component("YPL097W",1011).
component("YGR185C",558).
component("YGR264C",575).
component("YGR171C",553).
component("YHR011W",588).
component("YDR023W",367).
component("YPL104W",1012).
component("YLL018C",758).
component("YPR081C",1052).
component("YBR121C",265).
component("YHR020W",592).
component("YER087W",472).
component("YNL247W",899).
component("YOL033W",933).
component("YGL245W",530).
component("YOR168W",969).
component("YHR091C",604).
component("YDR341C",409).
component("YOL097C",944).
component("YDR268W",401).
component("YPR047W",1046).
component("YLR060W",770).
component("YFL022C",489).
component("YPR033C",1044).
component("YHR019C",590).
component("YCR024C",309).
component("YHR019C",591).
component("YKL194C",739).
component("YIL078W",632).
component("YPL160W",1016).
component("YLR382C",814).
component("YPL040C",1007).
component("YBL076C",233).
component("YNL073W",886).
component("YDR037W",369).
component("YOR335C",989).
component("YGR094W",543).
component("YLR153C",779).
component("YAL054C",218).
component("YGR244C",570).
component("YPR035W",1045).
component("YIL145C",640).
component("U89_",205).
component("YOR241W",981).
component("YMR113W",853).
component("YKL132C",725).
component("YOR339C",990).
component("YMR022W",846).
component("YLR306W",803).
component("YKL210W",741).
component("YGR133W",548).
component("YGL058W",515).
component("YER100W",478).
component("YEL012W",438).
component("YDR177W",393).
component("YDR092W",381).
component("YDR059C",377).
component("YDR054C",375).
...
component("YNL220W",897).
component("YOL058W",938).
component("YDL141W",348).
component("YHR074W",603).
component("YMR217W",865).
component("YPR145W",1057).
component("YGR124W",546).
component("YOR303W",985).
component("YJR109C",701).
component("YJL130C",669).
component("YGL062W",516).
component("YBR218C",279).
component("YPL231W",1030).
component("YNR016C",916).
component("YKL182W",735).
component("YGR037C",537).
component("YOR005C",952).
component("YDL164C",351).
component("YJL087C",661).
component("YOL010W",929).
component("YPR138C",1056).
component("YPL265W",1033).
component("YPL057C",1008).
component("YPL036W",1006).
component("YOR348C",994).
component("YOR192C",974).
component("YOR171C",970).
component("YOR130C",965).
component("YOR100C",960).
component("YOR071C",957).
component("YOR011W",953).
component("YOL156W",951).
component("YOL103W",945).
component("YOL020W",932).
component("YNR072W",927).
component("YNR056C",924).
component("YNL318C",912).
component("YNL270C",905).
component("YNL142W",893).
component("YMR272C",872).
component("YMR202W",862).
component("YMR056C",847).
component("YMR011W",843).
component("YML123C",839).
component("YLR348C",809).
component("YLR260W",796).
component("YLR237W",792).
component("YLR138W",776).
component("YLR100C",773).
component("YLR092W",772).
component("YLR081W",771).
component("YLL061W",761).
component("YLL043W",760).
component("YKR093W",755).
component("YKR053C",751).
component("YKR039W",750).
component("YKL217W",745).
component("YKL120W",723).
component("YKL004W",712).
component("YJR158W",709).
component("YJR095W",697).
component("YJR077C",695).
component("YJL219W",683).
component("YJL214W",681).
component("YJL134W",670).
component("YJL129C",667).
component("YIL134W",638).
component("YHR096C",607).
component("YHR094C",606).
component("YHR092C",605).
component("YHL036W",584).
component("YHL016C",582).
component("YGR191W",559).
component("YGR125W",547).
component("YGR121C",544).
component("YGR065C",541).
component("YGR055W",539).
component("YGL186C",523).
component("YGL008C",506).
component("YFL055W",493).
...
component("YEL017C-A",439).
component("YDR536W",434).
component("YDR508C",430).
component("YDR503C",429).
component("YDR497C",427).
component("YDR345C",412).
component("YDR343C",411).
component("YDR342C",410).
component("YDR297W",406).
component("YDR294C",405).
component("YDR284C",403).
component("YDR046C",372).
component("YDL245C",362).
component("YDL210W",356).
component("YCR032W",312).
component("YCR028C",311).
component("YCR024C-A",310).
component("YCL025C",296).
component("YBR298C",292).
component("YBR294W",291).
