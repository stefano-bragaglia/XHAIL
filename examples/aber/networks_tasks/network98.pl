...
component("YNL280C",563).
component("YLR056W",471).
component("YKR009C",458).
component("YMR083W",522).
component("YPL231W",638).
component("YJR159W",435).
component("YGL001C",303).
component("YHR063C",365).
component("YML056C",508).
component("YLR432W",503).
component("YHR216W",381).
component("YAR075W",129).
component("YAR073W",128).
component("YCL030C",175).
component("YDR127W",228).
component("YJR139C",431).
component("YOR136W",598).
component("YNL009W",542).
component("YLR174W",483).
component("YDL066W",192).
component("YHR183W",376).
component("YGR256W",350).
component("YNL241C",557).
component("YOL059W",585).
component("YDL022W",187).
component("YCL018W",173).
component("YLR355C",498).
component("YML054C",507).
component("YIL155C",390).
component("YEL024W",261).
component("YJR078W",427).
component("U58_",102).
component("YGR255C",349).
component("U108_",26).
component("YMR015C",519).
component("YDR402C",245).
component("YGL055W",310).
component("YJL026W",399).
component("YIL066C",386).
component("YGR180C",340).
component("YER070W",277).
component("U36_",89).
component("U35_",88).
component("YJR009C",418).
component("YJL052W",400).
component("YGR192C",342).
component("YOR374W",619).
component("YER073W",278).
component("U68_",106).
component("YGL154C",316).
component("U55_",100).
component("YER069W",276).
component("YOR323C",612).
component("U2_",83).
component("YBR221C",165).
component("YBR166C",161).
component("YNL280C",564).
component("YGL012W",305).
component("YKL182W",449).
component("YER014W",265).
component("YKR009C",459).
component("YIL160C",392).
component("YGL205W",321).
component("YKL141W",444).
component("YJR051W",422).
component("YOR375C",620).
component("YDL215C",212).
component("YAL062W",127).
component("U100_",20).
component("YBR035C",145).
component("YMR189W",529).
component("U56_",101).
component("YPL023C",624).
component("YGL125W",314).
component("YOR236W",607).
component("YGR204W",345).
component("YBR084W",151).
component("YLR142W",477).
component("U65_",105).
component("U62_",104).
component("YHR068W",366).
component("YKL150W",446).
component("YIL043C",384).
component("YHR042W",360).
component("YOR221C",605).
component("YMR145C",527).
component("YML120C",513).
component("YKL192C",452).
component("YKL055C",438).
component("YER061C",272).
component("YDL085W",195).
component("YBR046C",147).
component("YPL017C",623).
component("YFL018C",292).
component("YPL091W",627).
component("YER042W",266).
component("YNL052W",544).
component("YMR256C",536).
component("YLR395C",501).
component("YLR038C",469).
component("YIL111W",388).
component("YHR051W",364).
component("YGL191W",319).
component("YGL187C",318).
component("YDL067C",193).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",644).
component("YPL273W",646).
component("YLL062C",466).
component("YDR410C",247).
component("YER091C",282).
component("YJR073C",425).
component("YDL033C",188).
component("YOL096C",588).
component("YLR172C",482).
component("YMR120C",526).
component("YBL013W",130).
component("YJL130C",408).
component("YJL088W",403).
component("YPR074C",656).
component("YBR117C",155).
component("YMR108W",524).
component("YCL009C",172).
component("YMR062C",521).
component("YNL071W",545).
component("YIL160C",393).
component("YNR019W",572).
component("YCR048W",184).
component("U48_",95).
component("YNL277W",562).
component("YFL017C",291).
component("YPL231W",639).
component("YER061C",273).
component("U86_",119).
component("YDL052C",190).
component("U8_",122).
component("YDR148C",234).
component("YOR377W",621).
component("YGR177C",339).
component("YPL231W",640).
component("YLR195C",485).
component("YLR299W",491).
component("YPR001W",648).
component("YNR001C",568).
component("YCR005C",180).
component("YML126C",515).
component("YDL182W",209).
component("YDL131W",201).
component("YNL117W",549).
component("YIR031C",397).
component("YPR160W",662).
component("YOR321W",611).
component("YJR143C",432).
component("YGR199W",344).
component("YDL095W",197).
component("YDL093W",196).
component("YAL023C",126).
component("YPL227C",636).
component("YMR261C",537).
component("YML100W",512).
component("YBR126C",158).
component("YNL192W",556).
component("YBR038W",146).
component("YBR023C",143).
component("YEL011W",259).
component("YLR209C",486).
component("U104_",24).
component("U103_",23).
component("YMR300C",539).
component("YDR354W",241).
component("YFR047C",300).
component("YJR133W",430).
component("U22_",78).
component("YLR209C",487).
component("YDR399W",243).
component("YJL167W",415).
component("YNL256W",559).
component("YPR069C",655).
component("YDR127W",229).
component("YHR190W",377).
component("YHR068W",367).
component("YLR303W",492).
component("YML082W",511).
component("YJR130C",429).
component("YDR035W",218).
component("YBR249C",166).
component("YLR180W",484).
component("YDR502C",253).
component("YOL143C",592).
component("YBR256C",168).
component("YHR137W",371).
component("YGL202W",320).
component("YLR027C",467).
component("YKL106W",441).
component("YOL140W",591).
component("YLR438W",505).
component("YKL104C",440).
component("YGR019W",327).
component("YDR111C",226).
component("U51_",98).
component("YJR148W",433).
component("YHR208W",380).
component("YOR184W",602).
component("YNR058W",577).
component("YGL253W",326).
component("YFR053C",301).
component("YMR013C",518).
component("YLR240W",489).
component("YKL203C",454).
component("YJR066W",424).
component("YCR036W",183).
component("YGR194C",343).
component("YCL040W",177).
component("YJR105W",428).
component("U16_",53).
component("YKL001C",436).
component("YML070W",510).
component("YFL053W",295).
component("YDR531W",256).
component("U82_",117).
component("U81_",116).
component("YMR208W",531).
component("YPL203W",634).
component("YOR061W",593).
component("YKL166C",447).
component("YJL164C",414).
component("YIL035C",383).
component("YHR205W",379).
component("YHR102W",369).
component("YGL019W",306).
component("YHR025W",359).
component("YNR012W",570).
component("YPR121W",659).
component("YPL258C",642).
component("YOL055C",583).
component("U1_",68).
component("YDR009W",216).
component("YBR020W",142).
component("YFR019W",298).
component("YDR208W",236).
component("YDR127W",230).
component("U21_",75).
component("YDR147W",233).
component("YCR012W",181).
component("YER052C",268).
component("U19_",67).
component("U18_",62).
component("U17_",58).
component("U76_",113).
component("YMR220W",533).
component("YER170W",288).
component("YDR226W",237).
component("YKL067W",439).
component("YOL055C",584).
component("YDR454C",250).
component("YOL061W",586).
component("YKL181W",448).
component("YHL011C",353).
component("YER099C",284).
component("YBL068W",136).
component("YOR143C",599).
component("YNL256W",560).
component("YLR328W",495).
component("YBR018C",140).
component("YDL055C",191).
component("YLR328W",496).
component("YDL103C",199).
component("U94_",124).
component("YJR010W",419).
component("YBR029C",144).
component("YPR190C",665).
component("YPR187W",664).
component("YPR110C",658).
component("YPR010C",650).
component("YOR341W",616).
component("YOR340C",615).
component("YOR224C",606).
component("YOR210W",604).
component("YOR207C",603).
component("YOR151C",600).
component("YOR116C",595).
component("YOL005C",578).
component("YNR003C",569).
component("YNL248C",558).
component("YNL151C",554).
component("YNL113W",548).
component("YKL144C",445).
component("YJR063W",423).
component("YJL148W",411).
component("YJL140W",410).
component("YIL021W",382).
component("YHR143W-A",372).
component("YGL070C",313).
component("YFL036W",294).
component("YDR404C",246).
component("YDR156W",235).
component("YDR045C",220).
component("YDL150W",208).
component("YDL140C",203).
component("YBR154C",160).
component("YPR175W",663).
component("YPL167C",632).
component("YOR330C",613).
component("YOL115W",590).
component("YNL299W",566).
component("YNL262W",561).
component("YNL102W",547).
component("YJR043C",421).
component("YJR006W",417).
component("YJL090C",404).
component("YIL139C",389).
component("YEL055C",262).
component("YDR419W",248).
component("YDR121W",227).
component("YDL102W",198).
component("YCR014C",182).
component("YBR278W",169).
component("YBL035C",132).
component("YKL035W",437).
component("YHL012W",354).
component("YHR123W",370).
component("YNL130C",550).
component("YPL148C",630).
component("YOR251C",609).
component("YGR286C",352).
component("YDR058C",222).
component("YOL011W",580).
...
component("YOR124C",596).
component("YNL186W",555).
component("YMR304W",540).
component("YMR223W",534).
component("YKR098C",464).
component("YJL197W",416).
component("YIL156W",391).
component("YFR010W",297).
component("YER151C",287).
component("YER144C",286).
component("YER098W",283).
component("YDR069C",223).
component("YDL122W",200).
component("YBR058C",148).
component("YBL067C",135).
component("YJR019C",420).
component("YDR481C",251).
component("YDR074W",224).
component("YFR025C",299).
component("YPL179W",633).
component("YNR032W",573).
component("YML057W",509).
component("YML016C",506).
component("YLR433C",504).
component("YGR123C",334).
component("YER133W",285).
component("YER089C",280).
component("YDR436W",249).
component("YDR075W",225).
component("YDL188C",210).
component("YDL134C",202).
component("YDL047W",189).
component("YDL006W",186).
component("YBR125C",157).
component("YBL056W",134).
component("YIL053W",385).
component("YER062C",274).
component("YHR046C",363).
component("U9_",125).
component("YGR208W",347).
component("YPL228W",637).
component("YMR180C",528).
...
component("U26_",80).
component("U24_",79).
component("YHR044C",362).
component("YHR043C",361).
component("YOL064C",587).
component("YPL268W",645).
component("YOR360C",618).
component("YGL248W",325).
component("YKR031C",460).
component("YGL027C",308).
component("YLR286C",490).
component("YJR153W",434).
component("YBR184W",162).
component("YIL162W",394).
component("YPR026W",651).
component("YDR001C",214).
component("YBR001C",139).
component("YDR400W",244).
component("U102_",22).
component("YER043C",267).
component("YNL045W",543).
component("YLR160C",481).
component("YLR158C",480).
component("YLR157C",479).
component("YLR155C",478).
component("YDR321W",240).
component("YGL037C",309).
component("U43_",93).
component("U42_",92).
component("YLR308W",494).
component("YLR307W",493).
component("U53_",99).
component("YLR420W",502).
component("YPL111W",628).
component("YIR032C",398).
component("YLR028C",468).
component("YHR144C",373).
component("YHR144C",374).
component("YNL141W",551).
component("YBR153W",159).
component("YDL238C",213).
component("YNL141W",552).
component("YBR084W",152).
component("YJL126W",406).
component("U44_",94).
component("U39_",90).
component("YHR201C",378).
component("YBR111C",154).
component("YBR252W",167).
component("YCL030C",176).
component("YER005W",264).
component("YBL099W",138).
component("YLR231C",488).
component("U88_",120).
component("YDR538W",258).
component("YLR134W",475).
component("YLR044C",470).
component("YGR087C",331).
component("YDR380W",242).
component("YDL080C",194).
component("YMR250W",535).
component("YKL184W",451).
component("YEL021W",260).
component("YNR043W",575).
component("YKL211C",455).
component("YKR097W",463).
component("YOL052C",582).
component("YDR294C",238).
component("YNR033W",574).
component("YPR006C",649).
component("YER065C",275).
component("YKL211C",456).
component("YER090W",281).
component("YDR127W",231).
component("YPL281C",647).
component("YOR393W",622).
component("YMR323W",541).
component("YHR174W",375).
component("YGR254W",348).
component("YGL026C",307).
component("YGR155W",337).
component("YNL316C",567).
component("YPL212C",635).
component("YNL292W",565).
component("YGL063W",312).
component("YFL001W",290).
component("YCR053W",185).
component("YDR127W",232).
component("YGL148W",315).
component("YIL168W",396).
component("YIL167W",395).
component("YCL064C",178).
component("YCL064C",179).
component("YLR359W",499).
component("YFR055W",302).
component("YJL121C",405).
component("YBR019C",141).
component("YDR007W",215).
component("YOR095C",594).
component("YBR196C",163).
component("YGL001C",304).
component("YPL117C",629).
component("U14_",45).
component("YMR105C",523).
component("YKL127W",442).
component("YEL058W",263).
component("YPR060C",654).
component("YHR072W",368).
component("YJL153C",412).
component("YGR264C",351).
component("YGR171C",338).
component("YHR011W",356).
component("YDR023W",217).
component("YPR081C",657).
component("YBR121C",156).
component("YHR020W",358).
component("YER087W",279).
component("YGL245W",324).
component("YOR168W",601).
component("YPR047W",653).
component("YLR060W",472).
component("YFL022C",293).
component("YPR033C",652).
component("YHR019C",357).
component("YKL194C",453).
component("YIL078W",387).
component("YPL160W",631).
component("YLR382C",500).
component("YPL040C",625).
component("YBL076C",137).
component("YNL073W",546).
component("YDR037W",219).
component("YOR335C",614).
component("YGR094W",332).
component("U89_",121).
component("YOR241W",608).
component("YMR113W",525).
component("YKL132C",443).
component("YGL234W",322).
component("YER183C",289).
component("U90_",123).
component("YNR057C",576).
component("YDL141W",204).
component("YDL141W",205).
component("YGL234W",323).
component("YDL141W",206).
component("YGR204W",346).
component("YDL141W",207).
component("YMR217W",532).
component("YPR145W",661).
component("YGR124W",335).
component("YOR303W",610).
component("YGL062W",311).
component("YBR218C",164).
component("YPL231W",641).
component("YNR016C",571).
component("YKL182W",450).
component("YGR037C",328).
component("YJL087C",402).
component("YOL010W",579).
component("YPR138C",660).
component("YPL265W",643).
component("YOR348C",617).
component("YOR130C",597).
component("YOL103W",589).
component("YOL020W",581).
component("YNL142W",553).
component("YMR272C",538).
component("YMR202W",530).
component("YMR056C",520).
component("YML123C",514).
component("YLR348C",497).
component("YLR138W",476).
component("YLR100C",474).
component("YLR092W",473).
component("YLL061W",465).
component("YKR053C",462).
component("YKR039W",461).
component("YKL217W",457).
component("YJR077C",426).
component("YJL134W",409).
component("YJL129C",407).
component("YHL036W",355).
component("YGR191W",341).
component("YGR125W",336).
component("YGR121C",333).
component("YGR065C",330).
component("YGR055W",329).
component("YGL186C",317).
component("YFL055W",296).
component("YER060W-A",271).
component("YER060W",270).
component("YER056C",269).
component("YDR536W",257).
component("YDR508C",255).
component("YDR503C",254).
component("YDR497C",252).
component("YDR294C",239).
component("YDR046C",221).
component("YDL210W",211).
component("YCL025C",174).
component("YBR294W",171).
component("YBR291C",170).
component("YBR085W",153).
component("YBR069C",150).
component("YBR068C",149).
component("YBL042C",133).
component("YBL030C",131).
component("U85_",118).
component("U7_",115).
component("U79_",114).
component("U75_",112).
