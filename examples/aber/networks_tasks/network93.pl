...
component("YLR056W",453).
component("YKR009C",441).
component("YMR083W",502).
component("YPL231W",616).
component("YJR159W",418).
component("YGL001C",291).
component("YML056C",488).
component("YLR432W",483).
component("YHR216W",365).
component("YAR075W",121).
component("YAR073W",120).
component("YCL030C",166).
component("YDR127W",218).
component("YJR139C",414).
component("YOR136W",576).
component("YNL009W",521).
component("YLR174W",465).
component("YDL066W",183).
component("YHR183W",360).
component("YGR256W",335).
component("YNL241C",536).
component("YOL059W",563).
component("YDL022W",178).
component("YCL018W",164).
component("YLR355C",478).
component("YML054C",487).
component("YIL155C",374).
component("YEL024W",249).
component("YJR078W",410).
component("U58_",96).
component("YGR255C",334).
component("YMR015C",499).
component("YDR402C",235).
component("YGL055W",297).
component("YJL026W",382).
component("YIL066C",370).
component("YGR180C",326).
component("YER070W",265).
component("U36_",83).
component("U35_",82).
component("YJR009C",401).
component("YJL052W",383).
component("YGR192C",328).
component("YOR374W",597).
component("YER073W",266).
component("U68_",100).
component("YGL154C",303).
component("U55_",94).
component("YER069W",264).
component("YOR323C",590).
component("U2_",77).
component("YBR221C",156).
component("YBR166C",152).
component("YNL280C",543).
component("YKL182W",432).
component("YER014W",253).
component("YKL141W",427).
component("YJR051W",405).
component("YOR375C",598).
component("YDL215C",203).
component("YAL062W",119).
component("U100_",20).
component("YBR035C",137).
component("YMR189W",509).
component("U56_",95).
component("YPL023C",602).
component("YGL125W",301).
component("YOR236W",585).
component("YGR204W",331).
component("YBR084W",143).
component("YLR142W",459).
component("U65_",99).
component("U62_",98).
component("YHR068W",350).
component("YKL150W",429).
component("YIL043C",368).
component("YHR042W",345).
component("YOR221C",583).
component("YMR145C",507).
component("YML120C",493).
component("YKL192C",435).
component("YKL055C",421).
component("YER061C",260).
component("YDL085W",186).
component("YBR046C",139).
component("YPL017C",601).
component("YFL018C",280).
component("YPL091W",605).
component("YER042W",254).
component("YNL052W",523).
component("YMR256C",516).
component("YLR395C",481).
component("YLR038C",451).
component("YIL111W",372).
component("YHR051W",349).
component("YGL191W",306).
component("YGL187C",305).
component("YDL067C",184).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",622).
component("YPL273W",624).
component("YLL062C",448).
component("YDR410C",237).
component("YER091C",270).
component("YJR073C",408).
component("YDL033C",179).
component("YOL096C",566).
component("YLR172C",464).
component("YMR120C",506).
component("YBL013W",122).
component("YJL130C",391).
component("YJL088W",386).
component("YPR074C",634).
component("YBR117C",147).
component("YMR108W",504).
component("YCL009C",163).
component("YMR062C",501).
component("YNL071W",524).
component("YIL160C",376).
component("YNR019W",551).
component("YCR048W",175).
component("U48_",89).
component("YNL277W",541).
component("YFL017C",279).
component("YPL231W",617).
component("YER061C",261).
component("U86_",112).
component("YDL052C",181).
component("U8_",114).
component("YDR148C",224).
component("YOR377W",599).
component("YGR177C",325).
component("YPL231W",618).
component("YLR195C",467).
component("YLR299W",472).
component("YPR001W",626).
component("YNR001C",547).
component("YCR005C",171).
component("YML126C",495).
component("YDL182W",200).
component("YDL131W",192).
component("YNL117W",528).
component("YIR031C",380).
component("YOR321W",589).
component("YJR143C",415).
component("YGR199W",330).
component("YDL095W",188).
component("YDL093W",187).
component("YAL023C",118).
component("YPL227C",614).
component("YMR261C",517).
component("YML100W",492).
component("YBR126C",149).
component("YNL192W",535).
component("YBR038W",138).
component("YBR023C",135).
component("YLR209C",468).
component("U104_",24).
component("U103_",23).
component("YDR354W",231).
component("YFR047C",288).
component("YJR133W",413).
component("U22_",72).
component("YDR399W",233).
component("YJL167W",398).
component("YNL256W",538).
component("YPR069C",633).
component("YDR127W",219).
component("YHR190W",361).
component("YHR068W",351).
component("YLR303W",473).
component("YML082W",491).
component("YJR130C",412).
component("YDR035W",208).
component("YBR249C",157).
component("YLR180W",466).
component("YDR502C",242).
component("YOL143C",570).
component("YBR256C",159).
component("YHR137W",355).
component("YGL202W",307).
component("YLR027C",449).
component("YKL106W",424).
component("YOL140W",569).
component("YLR438W",485).
component("YKL104C",423).
component("YGR019W",313).
component("YDR111C",216).
component("U51_",92).
component("YJR148W",416).
component("YHR208W",364).
component("YOR184W",580).
component("YGL253W",312).
component("YFR053C",289).
component("YMR013C",498).
component("YLR240W",470).
component("YKL203C",437).
component("YJR066W",407).
component("YCR036W",174).
component("YGR194C",329).
component("YCL040W",168).
component("YJR105W",411).
component("U16_",50).
component("YKL001C",419).
component("YML070W",490).
component("YFL053W",283).
...
component("YKL166C",430).
component("YJL164C",397).
component("YIL035C",367).
component("YHR205W",363).
component("YHR102W",353).
component("YGL019W",293).
component("YHR025W",344).
component("YNR012W",549).
component("YPR121W",636).
component("YPL258C",620).
component("YOL055C",561).
component("U1_",62).
component("YBR020W",134).
component("YFR019W",286).
component("YDR208W",226).
component("YDR127W",220).
component("U21_",69).
component("YDR147W",223).
component("YCR012W",172).
component("YER052C",256).
component("U19_",61).
component("U18_",57).
component("U17_",54).
component("U76_",107).
component("YMR220W",513).
component("YER170W",276).
component("YDR226W",227).
component("YKL067W",422).
component("YOL055C",562).
component("YDR454C",240).
component("YOL061W",564).
component("YKL181W",431).
component("YHL011C",338).
component("YER099C",272).
component("YBL068W",128).
component("YOR143C",577).
component("YNL256W",539).
component("YBR018C",132).
component("YDL055C",182).
component("YLR328W",476).
component("YDL103C",190).
component("U94_",116).
component("YJR010W",402).
component("YBR029C",136).
component("YPR190C",641).
component("YPR187W",640).
component("YPR110C",635).
component("YPR010C",628).
component("YOR341W",594).
component("YOR340C",593).
component("YOR224C",584).
component("YOR210W",582).
component("YOR207C",581).
component("YOR151C",578).
component("YOR116C",573).
component("YOL005C",556).
component("YNR003C",548).
component("YNL248C",537).
component("YNL151C",533).
component("YNL113W",527).
component("YKL144C",428).
component("YJR063W",406).
component("YJL148W",394).
component("YJL140W",393).
component("YIL021W",366).
component("YHR143W-A",356).
component("YGL070C",300).
component("YFL036W",282).
component("YDR404C",236).
component("YDR156W",225).
component("YDR045C",210).
component("YDL150W",199).
component("YDL140C",194).
component("YBR154C",151).
component("YPR175W",639).
component("YPL167C",610).
component("YOR330C",591).
component("YOL115W",568).
component("YNL299W",545).
component("YNL262W",540).
component("YNL102W",526).
component("YJR043C",404).
component("YJR006W",400).
component("YJL090C",387).
component("YIL139C",373).
component("YEL055C",250).
component("YDR419W",238).
component("YDR121W",217).
component("YDL102W",189).
component("YCR014C",173).
component("YBR278W",160).
component("YBL035C",124).
component("YKL035W",420).
component("YHL012W",339).
component("YHR123W",354).
component("YNL130C",529).
component("YPL148C",608).
component("YOR251C",587).
component("YGR286C",337).
component("YDR058C",212).
component("YOL011W",558).
component("YMR008C",497).
component("YMR006C",496).
component("U105_",25).
component("U101_",21).
component("YJL068C",384).
component("YPL072W",604).
component("YOR124C",574).
component("YNL186W",534).
component("YMR304W",519).
component("YMR223W",514).
component("YKR098C",446).
component("YJL197W",399).
component("YIL156W",375).
component("YFR010W",285).
component("YER151C",275).
component("YER144C",274).
component("YER098W",271).
component("YDR069C",213).
component("YDL122W",191).
component("YBR058C",140).
component("YBL067C",127).
component("YJR019C",403).
component("YDR074W",214).
component("YFR025C",287).
component("YPL179W",611).
component("YNR032W",552).
component("YML057W",489).
component("YML016C",486).
component("YLR433C",484).
component("YGR123C",320).
component("YER133W",273).
component("YER089C",268).
component("YDR436W",239).
component("YDR075W",215).
component("YDL188C",201).
component("YDL134C",193).
component("YDL047W",180).
component("YDL006W",177).
component("YBR125C",148).
component("YBL056W",126).
component("YIL053W",369).
component("YER062C",262).
component("YHR046C",348).
component("U9_",117).
component("YGR208W",332).
component("YPL228W",615).
component("YMR180C",508).
component("YJL155C",396).
component("U34_",81).
component("U33_",80).
component("U32_",79).
component("U30_",78).
...
component("U26_",74).
component("U24_",73).
component("YHR044C",347).
component("YHR043C",346).
component("YOL064C",565).
component("YPL268W",623).
component("YOR360C",596).
component("YGL248W",311).
component("YKR031C",442).
component("YGL027C",295).
component("YLR286C",471).
component("YJR153W",417).
component("YBR184W",153).
component("YIL162W",377).
component("YPR026W",629).
component("YDR001C",205).
component("YBR001C",131).
component("YDR400W",234).
component("U102_",22).
component("YER043C",255).
component("YNL045W",522).
component("YLR160C",463).
component("YLR158C",462).
component("YLR157C",461).
component("YLR155C",460).
component("YDR321W",230).
component("YGL037C",296).
component("U43_",87).
component("U42_",86).
component("YLR308W",475).
component("YLR307W",474).
component("U53_",93).
component("YLR420W",482).
component("YPL111W",606).
component("YIR032C",381).
component("YLR028C",450).
...
component("YJL126W",389).
component("U44_",88).
component("U39_",84).
component("YHR201C",362).
component("YBR111C",146).
component("YBR252W",158).
component("YCL030C",167).
component("YER005W",252).
component("YBL099W",130).
component("YLR231C",469).
component("U88_",113).
component("YDR538W",247).
component("YLR134W",457).
component("YLR044C",452).
component("YGR087C",317).
component("YDR380W",232).
component("YDL080C",185).
component("YMR250W",515).
component("YKL184W",434).
component("YEL021W",248).
component("YNR043W",554).
component("YKL211C",438).
component("YKR097W",445).
component("YOL052C",560).
component("YDR294C",228).
component("YNR033W",553).
component("YPR006C",627).
component("YER065C",263).
component("YKL211C",439).
component("YER090W",269).
component("YDR127W",221).
component("YPL281C",625).
component("YOR393W",600).
component("YMR323W",520).
component("YHR174W",359).
component("YGR254W",333).
component("YGL026C",294).
component("YGR155W",323).
component("YNL316C",546).
component("YPL212C",613).
component("YNL292W",544).
component("YGL063W",299).
component("YFL001W",278).
component("YCR053W",176).
component("YDR127W",222).
component("YGL148W",302).
component("YIL168W",379).
component("YIL167W",378).
component("YCL064C",169).
component("YCL064C",170).
component("YLR359W",479).
component("YFR055W",290).
component("YJL121C",388).
component("YBR019C",133).
component("YDR007W",206).
component("YOR095C",572).
component("YBR196C",154).
component("YGL001C",292).
component("YPL117C",607).
component("U14_",42).
component("YMR105C",503).
component("YKL127W",425).
component("YEL058W",251).
component("YPR060C",632).
component("YHR072W",352).
component("YJL153C",395).
component("YGR264C",336).
component("YGR171C",324).
component("YHR011W",341).
component("YDR023W",207).
component("YHR020W",343).
component("YER087W",267).
component("YGL245W",310).
component("YOR168W",579).
component("YPR047W",631).
component("YLR060W",454).
component("YFL022C",281).
component("YPR033C",630).
component("YHR019C",342).
component("YKL194C",436).
component("YIL078W",371).
component("YPL160W",609).
component("YLR382C",480).
component("YPL040C",603).
component("YBL076C",129).
component("YNL073W",525).
component("YDR037W",209).
component("YOR335C",592).
component("YGR094W",318).
component("YOR241W",586).
component("YMR113W",505).
component("YKL132C",426).
component("YGL234W",308).
component("YER183C",277).
component("U90_",115).
component("YNR057C",555).
component("YDL141W",195).
component("YDL141W",196).
component("YGL234W",309).
component("YDL141W",197).
component("YDL141W",198).
component("YMR217W",512).
component("YPR145W",638).
component("YGR124W",321).
component("YOR303W",588).
component("YGL062W",298).
component("YBR218C",155).
component("YPL231W",619).
component("YNR016C",550).
component("YKL182W",433).
component("YGR037C",314).
component("YJL087C",385).
component("YOL010W",557).
component("YPR138C",637).
component("YPL265W",621).
component("YOR348C",595).
component("YOR130C",575).
component("YOL103W",567).
component("YOL020W",559).
component("YNL142W",532).
component("YMR272C",518).
component("YMR202W",510).
component("YMR056C",500).
component("YML123C",494).
component("YLR348C",477).
component("YLR138W",458).
component("YLR100C",456).
component("YLR092W",455).
component("YLL061W",447).
component("YKR053C",444).
component("YKR039W",443).
component("YKL217W",440).
component("YJR077C",409).
component("YJL134W",392).
component("YJL129C",390).
component("YHL036W",340).
component("YGR191W",327).
component("YGR125W",322).
component("YGR121C",319).
component("YGR065C",316).
component("YGR055W",315).
component("YGL186C",304).
component("YFL055W",284).
...
component("YDR497C",241).
component("YDR294C",229).
component("YDR046C",211).
component("YDL210W",202).
component("YCL025C",165).
component("YBR294W",162).
component("YBR291C",161).
component("YBR085W",145).
component("YBR069C",142).
component("YBR068C",141).
component("YBL042C",125).
component("YBL030C",123).
component("U7_",109).
component("U79_",108).
component("U75_",106).
component("U74_",105).
