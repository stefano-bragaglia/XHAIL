...
component("YGR060W",545).
component("YKR009C",753).
component("YMR083W",856).
component("YPL231W",1035).
component("YBR265W",290).
component("U46_",163).
component("YBR149W",271).
component("YBR149W",272).
component("YJR159W",716).
component("YGL001C",509).
component("YHR063C",604).
component("U45_",162).
component("YBR153W",273).
component("YML056C",835).
component("YLR432W",823).
component("YHR216W",629).
component("YAR075W",223).
component("YAR073W",222).
component("YCL030C",300).
component("YDR127W",388).
component("YJR139C",711).
component("YML075C",838).
component("YLR450W",826).
component("YOL126C",955).
component("YKL085W",726).
component("YDL078C",333).
component("YKL029C",721).
component("YOR136W",974).
component("YNL037C",890).
component("YNL009W",888).
component("YLR174W",792).
component("YDL066W",331).
component("YHR183W",623).
component("YGR256W",579).
component("YNL241C",906).
component("YOL059W",947).
component("YDL022W",322).
component("YCL018W",298).
component("YLR355C",817).
component("YIL074C",636).
component("YER081W",476).
component("YML054C",834).
component("YDL174C",356).
component("YIL155C",646).
component("YPR191W",1073).
component("YOR065W",964).
component("YJL166W",681).
component("YHR001W-A",590).
component("YGR183C",562).
component("YFR033C",505).
component("YEL024W",446).
component("YDR529C",436).
component("YBL045C",230).
component("Q0105",19).
component("YKR066C",758).
component("YKL026C",720).
component("YIR037W",657).
component("YBR244W",285).
component("YJR078W",702).
component("U58_",175).
component("YJR025C",694).
component("U107_",29).
component("YGR255C",578).
component("U108_",30).
component("YBL098W",235).
component("YMR015C",851).
component("YHR007C",591).
component("YDR402C",423).
component("YGL055W",519).
component("YGR175C",559).
component("YJR104C",705).
component("YHR008C",592).
component("YJL026W",660).
component("YIL066C",635).
...
component("YJR009C",691).
component("YJL052W",662).
component("YGR192C",565).
component("YBR006W",240).
...
component("YIL043C",633).
component("YHR042W",599).
component("YOR221C",986).
component("YMR145C",864).
component("YML120C",843).
component("YKL192C",743).
component("YKL055C",723).
component("YER061C",468).
component("YDL085W",335).
component("YBR046C",253).
component("YMR145C",865).
component("YML120C",844).
component("YKL192C",744).
component("YDL085W",336).
component("YGR234W",573).
component("YFR030W",504).
component("YPL017C",1011).
component("YFL018C",493).
component("YPL091W",1018).
component("YHR106W",614).
component("YDR353W",418).
component("YER042W",460).
component("YPR167C",1067).
component("YJR137C",710).
component("YNL052W",892).
component("YMR256C",876).
component("YLR395C",821).
component("YLR038C",772).
component("YIL111W",640).
component("YHR051W",603).
component("YGL191W",530).
component("YGL187C",529).
component("YDL067C",332).
component("Q0275",21).
component("Q0250",20).
component("Q0045",18).
component("YDR072C",382).
component("YPL266W",1042).
component("YML110C",842).
component("YBR034C",249).
component("YPL273W",1044).
component("YLL062C",768).
component("YDR410C",426).
component("YKR069W",759).
component("YOL096C",950).
component("U47_",164).
component("YER091C",480).
component("YJR073C",700).
component("YGR157W",556).
component("YML008C",827).
component("YDL033C",324).
component("YOL096C",951).
component("YLR172C",791).
component("YLR058C",775).
component("YBR263W",289).
component("YDR019C",369).
component("YBR176W",277).
component("YDR408C",425).
component("YMR120C",862).
component("YLR028C",770).
component("YBL013W",224).
component("YJL130C",673).
component("YJL088W",667).
component("YKL024C",719).
component("YPR074C",1059).
component("YBR117C",266).
component("YLR354C",816).
component("YGR043C",543).
component("YMR108W",859).
component("YCL009C",297).
component("YMR062C",854).
component("YNL071W",893).
component("YIL160C",649).
component("YNR019W",925).
component("YCR048W",317).
component("U48_",165).
component("YNL277W",914).
component("YMR062C",855).
...
component("YDL052C",328).
component("U8_",207).
component("YDR148C",394).
component("YML042W",833).
component("YOR377W",1007).
component("YGR177C",560).
component("YPL231W",1037).
component("YGR147C",554).
component("YDL040C",325).
component("YPL028W",1013).
component("YLR195C",794).
component("YLR299W",804).
component("YGL017W",514).
component("YPR001W",1048).
component("YNR001C",921).
component("YCR005C",309).
component("YML126C",846).
component("YDL182W",357).
component("YDL131W",345).
component("YNL117W",897).
component("YIR031C",655).
component("YPR160W",1066).
component("YOR321W",994).
component("YJR143C",712).
component("YGR199W",567).
component("YDL095W",340).
component("YDL093W",339).
component("YAL023C",217).
component("YLR258W",801).
component("YFR015C",501).
component("YPL227C",1033).
component("YOR103C",969).
component("YOR085W",966).
component("YMR149W",866).
component("YML019W",829).
component("YJL002C",658).
component("YEL002C",441).
component("YDL232W",362).
component("YCL043C",304).
component("YNL029C",889).
component("YIL085C",638).
component("YMR261C",877).
component("YML100W",840).
component("YBR126C",269).
component("YNL192W",904).
component("YBR038W",252).
component("YBR023C",247).
component("YEL011W",442).
component("YMR306W",886).
component("YLR342W",814).
component("YGR032W",541).
component("YPR183W",1070).
component("YLR209C",795).
component("U104_",26).
component("U103_",25).
component("YMR271C",879).
component("YML106W",841).
component("YOR209C",984).
component("YMR300C",884).
component("YER055C",464).
component("YDR354W",419).
component("YFR047C",506).
component("YJR133W",709).
component("U22_",140).
component("YLR209C",796).
component("YML022W",830).
component("YDR441C",429).
component("YDR399W",421).
component("YHR128W",616).
component("YPR176C",1069).
component("YPL172C",1026).
component("YNR041C",929).
component("YMR101C",857).
component("YDL090C",338).
component("YBR003W",239).
component("YBR002C",238).
component("YJL167W",682).
component("YJL167W",683).
component("YNL256W",909).
component("YPR069C",1057).
component("YDR127W",389).
component("YHR190W",624).
component("YLR146C",784).
component("YHR068W",606).
component("YLR303W",806).
component("YGR012W",539).
component("YML082W",839).
component("YJR130C",708).
component("YDR035W",371).
component("YBR249C",286).
component("YLR180W",793).
component("YDR502C",433).
component("YOR274W",991).
component("YOL143C",958).
component("YBR256C",288).
component("YHR137W",617).
component("YGL202W",531).
component("YLR027C",769).
component("YKL106W",728).
component("YOL140W",957).
component("YLR438W",825).
component("YKL104C",727).
component("YGR019W",540).
component("YDR111C",386).
component("U64_",182).
component("U61_",179).
component("U51_",169).
component("YJR148W",713).
component("YHR208W",627).
component("YFL030W",495).
component("YOR184W",980).
component("YNR058W",934).
component("YIL116W",641).
component("YGL253W",537).
component("YFR053C",507).
component("YOL136C",956).
component("YIL107C",639).
component("YMR013C",850).
component("YMR205C",870).
component("YGR240C",574).
component("YOL016C",939).
component("YFR014C",500).
component("YLR240W",799).
component("YKL203C",746).
component("YJR066W",699).
component("YCR036W",316).
component("YGR194C",566).
component("YCL040W",303).
component("YJR105W",706).
component("U16_",87).
component("U15_",78).
component("YPL188W",1028).
component("YJR049C",696).
component("YEL041W",447).
component("U96_",212).
component("YKL001C",717).
component("YDR236C",403).
component("YML070W",837).
component("YFL053W",497).
component("YHL032C",588).
component("YLR133W",780).
...
component("YOR061W",963).
component("YKL166C",737).
component("YJL164C",680).
component("YIL035C",632).
component("YHR205W",626).
component("YHR102W",613).
component("YGL019W",515).
component("YHR025W",598).
component("YOR347C",1001).
component("YAL038W",218).
component("YNR012W",923).
component("YPR121W",1063).
component("YPL258C",1039).
component("YOL055C",943).
component("YPL214C",1032).
component("U1_",118).
component("YDR009W",368).
component("YBR020W",246).
component("YNL267W",912).
component("YLR305C",808).
...
component("YDR300C",412).
component("YCR012W",310).
...
component("YKL181W",738).
component("YHL011C",585).
component("YER099C",482).
component("YBL068W",233).
component("YOR143C",975).
component("YNL256W",910).
component("YLR328W",812).
component("YBR018C",242).
component("YBR018C",243).
component("YDL055C",329).
component("YGR007W",538).
component("YGR202C",568).
component("YLR328W",813).
component("YKR002W",752).
component("YDL045C",326).
component("YDL103C",343).
component("U94_",211).
component("YJR010W",692).
component("YBR029C",248).
component("YCL050C",305).
component("YGL130W",525).
component("YDR530C",437).
component("YCL050C",306).
component("YPR190C",1072).
component("YPR187W",1071).
component("YPR110C",1061).
component("YPR010C",1050).
component("YOR341W",1000).
component("YOR340C",999).
component("YOR224C",987).
component("YOR210W",985).
component("YOR207C",983).
component("YOR151C",976).
component("YOR116C",970).
component("YOL005C",936).
component("YNR003C",922).
component("YNL248C",908).
component("YNL151C",902).
component("YNL113W",896).
component("YKL144C",733).
component("YJR063W",698).
component("YJL148W",677).
component("YJL140W",676).
component("YIL021W",631).
component("YHR143W-A",618).
component("YGL070C",523).
component("YFL036W",496).
component("YDR404C",424).
component("YDR156W",395).
component("YDR045C",374).
component("YDL150W",353).
component("YDL140C",347).
component("YBR154C",275).
component("YPR175W",1068).
component("YPL167C",1025).
component("YOR330C",996).
component("YOL115W",954).
component("YNL299W",918).
component("YNL262W",911).
component("YNL102W",895).
component("YJR043C",695).
component("YJR006W",690).
component("YJL090C",668).
component("YIL139C",644).
component("YEL055C",451).
component("YDR419W",427).
component("YDR121W",387).
component("YDL102W",342).
component("YCR014C",311).
component("YBR278W",291).
component("YBL035C",227).
component("YKL035W",722).
component("YHL012W",586).
component("YHR123W",615).
component("YPR113W",1062).
component("YBR243C",284).
component("YNL130C",898).
component("YDL142C",352).
component("YPL148C",1023).
component("YER026C",459).
component("YOR251C",990).
component("YGR286C",582).
component("YJL068C",663).
component("YDR058C",379).
component("YNR034W",928).
component("YHR163W",621).
component("YGR248W",576).
component("YCR073W-A",319).
component("YDL086W",337).
component("YOL011W",938).
...
component("YOR124C",971).
component("YNL186W",903).
component("YMR304W",885).
component("YMR223W",874).
component("YKR098C",763).
component("YJL197W",684).
component("YIL156W",647).
component("YFR010W",499).
component("YER151C",486).
component("YER144C",485).
component("YER098W",481).
component("YDR069C",381).
component("YDL122W",344).
component("YBR058C",254).
component("YBL067C",232).
component("YJR019C",693).
component("YOR040W",962).
component("YDR272W",407).
component("U84_",202).
component("YDR481C",431).
component("YLR377C",819).
component("YDR074W",383).
component("YFR025C",503).
component("YPL179W",1027).
component("YNR032W",926).
component("YML057W",836).
component("YML016C",828).
component("YLR433C",824).
component("YGR123C",550).
component("YER133W",484).
component("YER089C",478).
component("YDR436W",428).
component("YDR075W",384).
component("YDL188C",358).
component("YDL134C",346).
component("YDL047W",327).
component("YDL006W",320).
component("YBR125C",268).
component("YBL056W",231).
component("YPR073C",1058).
component("YHR215W",628).
component("YDL024C",323).
component("YBR093C",263).
component("YBR092C",262).
component("YIL053W",634).
component("YER062C",470).
component("YHR046C",602).
component("U9_",215).
component("YGR208W",572).
component("YPL228W",1034).
component("YMR180C",867).
component("YDL236W",363).
component("YJL155C",679).
component("U34_",151).
component("U33_",150).
component("U32_",149).
component("U31_",148).
...
component("U26_",142).
component("U24_",141).
component("YHR044C",601).
component("YHR043C",600).
component("YOL064C",949).
component("YPL268W",1043).
component("YOR360C",1004).
component("YGL248W",536).
component("YKR031C",755).
component("YPL206C",1030).
component("YGL027C",517).
component("YLR286C",803).
component("YJR153W",714).
component("YJL221C",689).
component("YJL216C",687).
component("YIL172C",653).
component("YGR292W",584).
component("YGR287C",583).
component("YBR299W",296).
component("YBR184W",278).
component("YIL162W",650).
component("YPR026W",1051).
component("YDR001C",366).
component("YBR001C",237).
component("YOR190W",981).
component("YLR300W",805).
component("YGR282C",581).
component("YDR261C",405).
component("YDR400W",422).
component("YML035C",831).
component("YJL070C",665).
component("YBR284W",292).
component("U106_",28).
component("U102_",24).
component("YER043C",461).
component("YNL045W",891).
component("YLR160C",789).
component("YLR158C",788).
component("YLR157C",787).
component("YLR155C",786).
...
component("YLR308W",811).
component("YLR307W",810).
component("YBR208C",280).
component("YMR281W",882).
component("U53_",170).
component("YLR420W",822).
component("YPL111W",1021).
component("YIR032C",656).
component("YIR029W",654).
component("YPR062W",1056).
...
component("YDL238C",364).
component("YNL141W",900).
component("YLR245C",800).
component("YML035C",832).
component("YGR204W",570).
component("YBR084W",259).
component("YJL126W",671).
component("U44_",161).
component("YDL100C",341).
component("U40_",157).
component("U39_",155).
component("YMR267W",878).
component("YBR011C",241).
component("YHR201C",625).
component("YBR111C",264).
component("YBR252W",287).
component("YCL030C",302).
component("YEL042W",448).
component("YER005W",456).
component("YBL099W",236).
component("U60_",178).
component("YLR231C",797).
component("U88_",205).
component("YDR538W",440).
component("YLR134W",781).
component("YLR044C",773).
component("YGR087C",547).
component("YDR380W",420).
component("YDL080C",334).
component("U98_",213).
component("YMR250W",875).
component("YKL184W",742).
component("YOR128C",972).
component("YEL021W",445).
component("YNR043W",930).
component("U93_",210).
component("YDR047W",376).
component("U54_",171).
component("YKL211C",748).
component("YKR097W",762).
component("YOL052C",942).
component("YGR170W",557).
component("YKL060C",724).
component("YDR294C",409).
component("YEL046C",449).
component("YNR033W",927).
component("YPR006C",1049).
component("YER065C",471).
component("YKL211C",749).
component("YER090W",479).
component("YDR127W",391).
component("YPL281C",1047).
component("YOR393W",1009).
component("YMR323W",887).
component("YHR174W",622).
component("YGR254W",577).
component("YPL262W",1040).
component("YGL026C",516).
component("YGR155W",555).
component("YLR304C",807).
component("YJL200C",685).
component("YGL009C",512).
component("YDR234W",402).
...
component("YOR278W",992).
component("U49_",166).
component("YCR053W",318).
component("YDR127W",392).
component("YGL148W",526).
component("YIL168W",652).
component("YIL167W",651).
component("YCL064C",307).
component("YCL064C",308).
component("YHR018C",594).
component("YLR359W",818).
component("YAL012W",216).
component("YFR055W",508).
component("YJL005W",659).
component("YOR176W",979).
component("YJL121C",670).
component("YBR019C",244).
component("YBR019C",245).
component("U59_",176).
component("YDR050C",377).
component("YIL020C",630).
component("YDR007W",367).
component("YOR095C",967).
component("YER003C",455).
component("YBR196C",279).
component("YGL001C",510).
component("YPL117C",1022).
component("U14_",71).
component("YOL056W",945).
component("YKL152C",736).
component("YDL021W",321).
component("YMR105C",858).
component("YKL127W",730).
component("YEL058W",452).
component("YMR278W",881).
component("YPR060C",1055).
component("YHR072W",607).
component("YJL153C",678).
component("YPL097W",1019).
component("YGR185C",563).
component("YGR264C",580).
component("YGR171C",558).
component("YHR011W",593).
component("YDR023W",370).
component("YPL104W",1020).
component("YLL018C",764).
component("YPR081C",1060).
component("YBR121C",267).
component("YHR020W",597).
component("YER087W",477).
component("YNL247W",907).
component("YOL033W",941).
component("YGL245W",535).
component("YOR168W",977).
component("YHR091C",609).
component("YDR341C",414).
component("YOL097C",952).
component("YDR268W",406).
component("YPR047W",1054).
component("YLR060W",776).
component("YFL022C",494).
component("YPR033C",1052).
component("YHR019C",595).
component("YCR024C",312).
component("YHR019C",596).
component("YKL194C",745).
component("YIL078W",637).
component("YPL160W",1024).
component("YLR382C",820).
component("YPL040C",1015).
component("YBL076C",234).
component("YNL073W",894).
component("YDR037W",372).
component("YOR335C",997).
component("YGR094W",548).
component("YLR153C",785).
component("YAL054C",219).
component("YGR244C",575).
component("YPR035W",1053).
component("YIL145C",645).
component("U89_",206).
component("YOR241W",989).
component("YMR113W",860).
component("YKL132C",731).
component("YOR339C",998).
component("YMR022W",852).
component("YLR306W",809).
component("YKL210W",747).
component("YGR133W",553).
component("YGL058W",520).
component("YER100W",483).
component("YEL012W",443).
component("YDR177W",397).
component("YDR092W",385).
component("YDR059C",380).
component("YDR054C",378).
component("YDL064W",330).
component("YBR082C",257).
component("YJL101C",669).
component("U92_",209).
component("YAR015W",221).
...
component("YDL141W",350).
component("YJR103W",704).
component("YBL039C",228).
component("YGR204W",571).
component("YBR084W",260).
component("YNL220W",905).
component("YOL058W",946).
component("YBR208C",281).
component("YDL141W",351).
component("YHR074W",608).
component("YMR217W",872).
component("YPR145W",1065).
component("YGR124W",551).
component("YOR303W",993).
component("YJR109C",707).
component("YJL130C",674).
component("YGL062W",521).
component("YBR218C",282).
component("YPL231W",1038).
component("YNR016C",924).
component("YKL182W",741).
component("YGR037C",542).
component("YOR005C",960).
component("YDL164C",354).
component("YJL087C",666).
component("YOL010W",937).
component("YPR138C",1064).
component("YPL265W",1041).
component("YPL057C",1016).
component("YPL036W",1014).
component("YOR348C",1002).
component("YOR192C",982).
component("YOR171C",978).
component("YOR130C",973).
component("YOR100C",968).
component("YOR071C",965).
component("YOR011W",961).
component("YOL156W",959).
component("YOL103W",953).
component("YOL020W",940).
component("YNR072W",935).
component("YNR056C",932).
component("YNL318C",920).
component("YNL270C",913).
component("YNL142W",901).
component("YMR272C",880).
component("YMR202W",869).
component("YMR056C",853).
component("YMR011W",849).
component("YML123C",845).
component("YLR348C",815).
component("YLR260W",802).
component("YLR237W",798).
component("YLR138W",782).
component("YLR100C",779).
component("YLR092W",778).
component("YLR081W",777).
component("YLL061W",767).
component("YLL043W",766).
component("YKR093W",761).
component("YKR053C",757).
component("YKR039W",756).
component("YKL217W",751).
component("YKL120W",729).
component("YKL004W",718).
component("YJR158W",715).
component("YJR095W",703).
component("YJR077C",701).
component("YJL219W",688).
component("YJL214W",686).
component("YJL134W",675).
component("YJL129C",672).
component("YIL134W",643).
component("YHR096C",612).
component("YHR094C",611).
component("YHR092C",610).
component("YHL036W",589).
component("YHL016C",587).
component("YGR191W",564).
component("YGR125W",552).
component("YGR121C",549).
component("YGR065C",546).
component("YGR055W",544).
...
component("YEL069C",454).
component("YEL063C",453).
component("YEL017C-A",444).
...
component("YDR297W",411).
component("YDR294C",410).
component("YDR284C",408).
component("YDR046C",375).
component("YDL245C",365).
component("YDL210W",359).
component("YCR032W",315).
component("YCR028C",314).
component("YCR024C-A",313).
component("YCL025C",299).
component("YBR298C",295).
component("YBR294W",294).
component("YBR291C",293).
component("YBR132C",270).
component("YBR085W",261).
component("YBR069C",256).
component("YBR068C",255).
