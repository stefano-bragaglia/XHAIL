...
component("YNL280C",504).
component("YLR056W",424).
component("YKR009C",413).
component("YMR083W",471).
component("YPL231W",567).
component("YJR159W",394).
component("YGL001C",275).
component("YML056C",457).
component("YLR432W",453).
component("YHR216W",343).
component("YAR075W",114).
component("YAR073W",113).
component("YCL030C",158).
component("YDR127W",208).
component("YJR139C",391).
component("YOR136W",535).
component("YNL009W",486).
component("YLR174W",436).
component("YHR183W",339).
component("YGR256W",315).
component("YOL059W",524).
component("YDL022W",170).
component("YCL018W",156).
component("YLR355C",448).
component("YEL024W",237).
component("YJR078W",387).
component("U58_",90).
component("YGR255C",314).
component("YMR015C",468).
component("YDR402C",225).
component("YGL055W",281).
component("YJL026W",359).
component("YIL066C",348).
component("YGR180C",306).
component("YER070W",251).
component("U36_",78).
component("U35_",77).
component("YJR009C",378).
component("YJL052W",360).
component("YGR192C",308).
component("YOR374W",552).
component("YER073W",252).
component("U68_",94).
component("YGL154C",286).
component("U55_",88).
component("YER069W",250).
component("YOR323C",546).
component("U2_",72).
component("YBR221C",148).
component("YBR166C",144).
component("YNL280C",505).
component("YER014W",241).
component("YKL141W",400).
component("YJR051W",382).
component("YOR375C",553).
component("YDL215C",193).
component("YAL062W",112).
component("U100_",20).
component("YBR035C",129).
component("YMR189W",475).
component("U56_",89).
component("YPL023C",556).
component("YGL125W",284).
component("YOR236W",543).
component("YGR204W",311).
component("YBR084W",135).
component("YLR142W",430).
component("U65_",93).
component("U62_",92).
component("YHR068W",329).
component("YKL150W",402).
component("YIL043C",346).
component("YHR042W",324).
component("YMR145C",474).
component("YML120C",462).
component("YKL192C",407).
component("YDL085W",176).
component("YBR046C",131).
component("YPL091W",559).
component("YNL052W",487).
component("YMR256C",481).
component("YLR395C",451).
component("YLR038C",422).
component("YIL111W",350).
component("YHR051W",328).
component("YGL191W",289).
component("YGL187C",288).
component("YDL067C",174).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",573).
component("YPL273W",575).
component("YLL062C",419).
component("YDR410C",227).
component("YER091C",256).
component("YJR073C",385).
component("YOL096C",526).
component("YLR172C",435).
component("YMR120C",473).
component("YBL013W",115).
component("YJL130C",368).
component("YJL088W",363).
component("YPR074C",585).
component("YBR117C",139).
component("YCL009C",155).
component("YMR062C",470).
component("YNL071W",488).
component("YIL160C",353).
component("YNR019W",512).
component("YCR048W",167).
component("U48_",83).
component("YNL277W",503).
component("YFL017C",264).
component("YPL231W",568).
component("YER061C",247).
component("YDL052C",172).
component("U8_",107).
component("YDR148C",214).
component("YOR377W",554).
component("YGR177C",305).
component("YPL231W",569).
component("YLR195C",437).
component("YLR299W",442).
component("YPR001W",577).
component("YNR001C",508).
component("YCR005C",163).
component("YML126C",464).
component("YDL182W",190).
component("YDL131W",182).
component("YNL117W",492).
component("YIR031C",357).
component("YOR321W",545).
component("YJR143C",392).
component("YGR199W",310).
component("YDL095W",178).
component("YDL093W",177).
component("YAL023C",111).
component("YPL227C",566).
component("YMR261C",482).
component("YML100W",461).
component("YBR126C",141).
component("YNL192W",499).
component("YBR038W",130).
component("YBR023C",127).
component("YLR209C",438).
component("U104_",23).
component("YDR354W",221).
component("YFR047C",272).
component("YJR133W",390).
component("U22_",67).
component("YDR399W",223).
component("YJL167W",375).
component("YPR069C",584).
component("YDR127W",209).
component("YHR068W",330).
component("YLR303W",443).
component("YML082W",460).
component("YJR130C",389).
component("YDR035W",198).
component("YBR249C",149).
component("YBR256C",151).
component("YHR137W",334).
component("YGL202W",290).
component("YLR027C",420).
component("YKL106W",398).
component("YOL140W",529).
component("YLR438W",455).
component("YKL104C",397).
component("YDR111C",206).
component("U51_",86).
component("YJR148W",393).
component("YHR208W",342).
component("YOR184W",539).
component("YGL253W",294).
component("YFR053C",273).
component("YMR013C",467).
component("YLR240W",440).
component("YKL203C",409).
component("YJR066W",384).
component("YCR036W",166).
component("YGR194C",309).
component("YCL040W",160).
component("YJR105W",388).
component("U16_",45).
component("YML070W",459).
component("YFL053W",267).
component("U82_",105).
component("U81_",104).
component("YMR208W",477).
component("YPL203W",565).
component("YOR061W",530).
component("YKL166C",403).
component("YJL164C",374).
component("YIL035C",345).
component("YHR205W",341).
component("YHR102W",332).
component("YGL019W",277).
component("YHR025W",323).
component("YNR012W",510).
component("YPR121W",587).
component("YPL258C",571).
component("YOL055C",522).
component("U1_",57).
component("YBR020W",126).
component("YFR019W",270).
component("YDR208W",216).
component("YDR127W",210).
component("U21_",64).
component("YDR147W",213).
component("YCR012W",164).
component("YER052C",243).
component("U19_",56).
component("U18_",52).
component("U17_",49).
component("U76_",101).
component("YMR220W",478).
component("YER170W",262).
component("YDR226W",217).
component("YKL067W",396).
component("YOL055C",523).
component("YDR454C",230).
component("YOL061W",525).
component("YKL181W",404).
component("YHL011C",318).
component("YER099C",258).
component("YBL068W",121).
component("YOR143C",536).
component("YNL256W",501).
component("YBR018C",124).
component("YDL055C",173).
component("YLR328W",446).
component("YDL103C",180).
component("U94_",109).
component("YJR010W",379).
component("YBR029C",128).
component("YPR190C",592).
component("YPR187W",591).
component("YPR110C",586).
component("YPR010C",579).
component("YOR341W",549).
component("YOR340C",548).
component("YOR224C",542).
component("YOR210W",541).
component("YOR207C",540).
component("YOR151C",537).
component("YOR116C",532).
component("YOL005C",517).
component("YNR003C",509).
component("YNL248C",500).
component("YNL151C",497).
component("YNL113W",491).
component("YKL144C",401).
component("YJR063W",383).
component("YJL148W",371).
component("YJL140W",370).
component("YIL021W",344).
component("YHR143W-A",335).
component("YGL070C",283).
component("YFL036W",266).
component("YDR404C",226).
component("YDR156W",215).
component("YDR045C",200).
component("YDL150W",189).
component("YDL140C",184).
component("YBR154C",143).
component("YPR175W",590).
component("YPL167C",563).
component("YOR330C",547).
component("YOL115W",528).
component("YNL299W",506).
component("YNL262W",502).
component("YNL102W",490).
component("YJR043C",381).
component("YJR006W",377).
component("YJL090C",364).
component("YIL139C",351).
...
component("YKL035W",395).
component("YHL012W",319).
component("YHR123W",333).
component("YNL130C",493).
component("YPL148C",561).
component("YOR251C",544).
component("YGR286C",317).
component("YDR058C",202).
component("YOL011W",519).
...
component("YOR124C",533).
component("YNL186W",498).
component("YMR304W",484).
component("YMR223W",479).
component("YKR098C",418).
component("YJL197W",376).
component("YIL156W",352).
component("YFR010W",269).
component("YER151C",261).
component("YER144C",260).
component("YER098W",257).
component("YDR069C",203).
component("YDL122W",181).
component("YBR058C",132).
component("YBL067C",120).
component("YJR019C",380).
component("YDR074W",204).
component("YFR025C",271).
component("YPL179W",564).
component("YNR032W",513).
component("YML057W",458).
component("YML016C",456).
component("YLR433C",454).
component("YGR123C",300).
component("YER133W",259).
component("YER089C",254).
component("YDR436W",229).
component("YDR075W",205).
component("YDL188C",191).
component("YDL134C",183).
component("YDL047W",171).
component("YDL006W",169).
component("YBR125C",140).
component("YBL056W",119).
component("YIL053W",347).
component("YER062C",248).
component("YHR046C",327).
component("U9_",110).
component("YGR208W",312).
...
component("YPL268W",574).
component("YOR360C",551).
component("YGL248W",293).
component("YKR031C",414).
component("YGL027C",279).
component("YLR286C",441).
component("YBR184W",145).
component("YIL162W",354).
component("YPR026W",580).
component("YDR001C",195).
component("YBR001C",123).
component("YDR400W",224).
component("U102_",22).
component("YER043C",242).
component("YLR160C",434).
component("YLR158C",433).
component("YLR157C",432).
component("YLR155C",431).
component("YDR321W",220).
component("YGL037C",280).
component("U43_",81).
component("U42_",80).
component("YLR308W",445).
component("YLR307W",444).
component("U53_",87).
component("YLR420W",452).
component("YIR032C",358).
component("YLR028C",421).
component("YHR144C",336).
component("YHR144C",337).
component("YNL141W",494).
component("YBR153W",142).
component("YDL238C",194).
component("YNL141W",495).
component("YBR084W",136).
component("YJL126W",366).
component("U44_",82).
component("YHR201C",340).
component("YBR111C",138).
component("YBR252W",150).
component("YCL030C",159).
component("YER005W",240).
component("YLR231C",439).
component("U88_",106).
component("YDR538W",235).
component("YLR134W",428).
component("YLR044C",423).
component("YGR087C",297).
component("YDR380W",222).
component("YDL080C",175).
component("YMR250W",480).
component("YKL184W",406).
component("YEL021W",236).
component("YNR043W",515).
component("YKL211C",410).
component("YKR097W",417).
component("YOL052C",521).
component("YDR294C",218).
component("YNR033W",514).
component("YPR006C",578).
component("YER065C",249).
component("YKL211C",411).
component("YER090W",255).
component("YDR127W",211).
component("YPL281C",576).
component("YOR393W",555).
component("YMR323W",485).
component("YHR174W",338).
component("YGR254W",313).
component("YGL026C",278).
component("YGR155W",303).
component("YNL316C",507).
component("YCR053W",168).
component("YDR127W",212).
component("YGL148W",285).
component("YIL168W",356).
component("YIL167W",355).
component("YCL064C",161).
component("YCL064C",162).
component("YLR359W",449).
component("YFR055W",274).
component("YJL121C",365).
component("YBR019C",125).
component("YDR007W",196).
component("YOR095C",531).
component("YBR196C",146).
component("YGL001C",276).
component("YPL117C",560).
component("U14_",38).
component("YMR105C",472).
component("YKL127W",399).
component("YEL058W",239).
component("YPR060C",583).
component("YHR072W",331).
component("YJL153C",372).
component("YGR264C",316).
component("YGR171C",304).
component("YHR011W",320).
component("YDR023W",197).
component("YHR020W",322).
component("YER087W",253).
component("YGL245W",292).
component("YOR168W",538).
component("YPR047W",582).
component("YLR060W",425).
component("YFL022C",265).
component("YPR033C",581).
component("YHR019C",321).
component("YKL194C",408).
component("YIL078W",349).
component("YPL160W",562).
component("YLR382C",450).
component("YPL040C",557).
component("YBL076C",122).
component("YNL073W",489).
component("YDR037W",199).
component("YGR094W",298).
component("YGL234W",291).
component("YER183C",263).
component("U90_",108).
component("YNR057C",516).
component("YDL141W",185).
component("YDL141W",186).
component("YDL141W",187).
component("YDL141W",188).
component("YPR145W",589).
component("YGR124W",301).
component("YGL062W",282).
component("YBR218C",147).
component("YPL231W",570).
component("YNR016C",511).
component("YKL182W",405).
component("YGR037C",295).
component("YJL087C",362).
component("YOL010W",518).
component("YPR138C",588).
component("YPL265W",572).
component("YOR348C",550).
component("YOR130C",534).
component("YOL103W",527).
component("YOL020W",520).
component("YNL142W",496).
component("YMR272C",483).
component("YMR202W",476).
component("YMR056C",469).
component("YML123C",463).
component("YLR348C",447).
component("YLR138W",429).
component("YLR100C",427).
component("YLR092W",426).
component("YKR053C",416).
component("YKR039W",415).
component("YKL217W",412).
component("YJR077C",386).
component("YJL134W",369).
component("YJL129C",367).
component("YGR191W",307).
component("YGR125W",302).
component("YGR121C",299).
component("YGR065C",296).
component("YGL186C",287).
component("YFL055W",268).
component("YER060W-A",246).
component("YER060W",245).
component("YER056C",244).
component("YDR536W",234).
component("YDR508C",233).
component("YDR503C",232).
component("YDR497C",231).
component("YDR294C",219).
component("YDR046C",201).
component("YDL210W",192).
component("YCL025C",157).
component("YBR294W",154).
component("YBR291C",153).
component("YBR085W",137).
component("YBR069C",134).
component("YBR068C",133).
component("YBL042C",118).
component("YBL030C",116).
component("U7_",103).
component("U79_",102).
component("U75_",100).
component("U74_",99).
