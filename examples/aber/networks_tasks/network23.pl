...
component("YNL280C",205).
component("YLR056W",175).
component("YGL001C",121).
component("YDR127W",84).
component("YNL009W",197).
component("YLR174W",182).
component("YHR183W",147).
component("YGR256W",136).
component("YCL018W",61).
component("YJR078W",160).
component("YMR015C",189).
component("YDR402C",95).
component("YGL055W",124).
component("YJL026W",151).
component("YGR180C",133).
component("YOR323C",219).
component("YBR166C",57).
component("YNL280C",206).
component("YKL141W",165).
component("YOR375C",222).
component("YAL062W",45).
component("U100_",18).
component("YMR145C",190).
component("YDL085W",70).
component("YBR046C",50).
component("YDR410C",96).
component("YJL088W",153).
component("YPR074C",233).
component("YBR117C",55).
component("YNL071W",198).
component("YNR019W",209).
component("YCR048W",67).
component("U48_",38).
component("YPL231W",226).
component("YPL231W",227).
component("YLR299W",184).
component("YCR005C",64).
component("YNL117W",200).
component("YIR031C",150).
component("YOR321W",218).
component("YJR143C",163).
component("YGR199W",134).
component("YDL095W",72).
component("YDL093W",71).
component("YAL023C",44).
component("YDR354W",92).
component("YFR047C",119).
component("U22_",32).
component("YDR399W",94).
component("YPR069C",232).
component("YDR127W",85).
component("YML082W",187).
component("YJR130C",162).
component("YDR035W",80).
component("YBR249C",59).
component("YHR137W",143).
component("YGL202W",127).
component("YLR027C",173).
component("YKL106W",164).
component("YLR438W",186).
component("U51_",39).
component("YMR013C",188).
component("YCR036W",66).
component("YCL040W",63).
component("YJR105W",161).
component("YMR208W",192).
component("YHR025W",139).
component("YFR019W",118).
component("YDR208W",89).
component("YDR127W",86).
component("YER052C",105).
component("U19_",28).
component("U76_",43).
component("YDR226W",90).
component("YDR454C",98).
component("YOL061W",213).
component("YKL181W",166).
component("YHL011C",138).
component("YER099C",111).
component("YBL068W",49).
component("YLR328W",185).
component("YPR175W",236).
component("YPL167C",225).
component("YOR330C",220).
component("YOL115W",215).
component("YNL299W",207).
component("YNL262W",204).
component("YNL102W",199).
component("YJR043C",158).
component("YJR006W",157).
component("YJL090C",154).
component("YIL139C",148).
component("YEL055C",103).
component("YDR419W",97).
component("YDR121W",83).
component("YDL102W",73).
component("YCR014C",65).
component("YBR278W",60).
component("YBL035C",46).
component("YPL072W",224).
component("YOR124C",217).
component("YNL186W",203).
component("YMR304W",195).
component("YMR223W",193).
component("YKR098C",172).
component("YJL197W",156).
component("YIL156W",149).
component("YFR010W",117).
component("YER151C",113).
component("YER144C",112).
component("YER098W",110).
...
component("U32_",34).
component("U30_",33).
component("YHR044C",141).
component("YHR043C",140).
component("YLR160C",181).
component("YLR158C",180).
component("YLR157C",179).
component("YLR155C",178).
component("YDR321W",91).
component("YGL037C",123).
component("U43_",36).
component("U42_",35).
component("U53_",40).
component("YHR144C",144).
component("YHR144C",145).
component("YBR153W",56).
component("YDL238C",78).
component("YNL141W",201).
component("U44_",37).
component("YBR111C",54).
component("YER005W",104).
component("YLR231C",183).
component("YLR134W",177).
component("YLR044C",174).
component("YGR087C",129).
component("YDR380W",93).
component("YDL080C",69).
component("YMR250W",194).
component("YKL184W",167).
component("YEL021W",102).
component("YKL211C",168).
component("YNR033W",210).
component("YKL211C",169).
component("YER090W",109).
component("YDR127W",87).
component("YPL281C",229).
component("YOR393W",223).
component("YMR323W",196).
component("YHR174W",146).
component("YGR254W",135).
component("YGL026C",122).
component("YNL316C",208).
component("YCR053W",68).
component("YDR127W",88).
component("YGL148W",125).
component("YFR055W",120).
component("YDR007W",79).
component("YOR095C",216).
component("YBR196C",58).
component("YPR060C",231).
component("YHR072W",142).
component("YGR264C",137).
component("YGR171C",132).
component("YGL245W",128).
component("YPR047W",230).
component("YLR060W",176).
component("YFL022C",115).
component("YER183C",114).
component("YDL141W",75).
component("YDL141W",76).
component("YPR145W",235).
component("YGR124W",131).
component("YJL087C",152).
component("YOL010W",211).
component("YPR138C",234).
component("YPL265W",228).
component("YOR348C",221).
component("YOL103W",214).
component("YOL020W",212).
component("YNL142W",202).
component("YMR202W",191).
component("YKR053C",171).
component("YKR039W",170).
component("YJR077C",159).
component("YJL134W",155).
component("YGR121C",130).
component("YGL186C",126).
component("YFL055W",116).
component("YER060W-A",108).
component("YER060W",107).
component("YER056C",106).
component("YDR536W",101).
component("YDR508C",100).
component("YDR497C",99).
