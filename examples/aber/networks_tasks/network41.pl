...
component("YNL280C",296).
component("YLR056W",245).
component("YMR083W",273).
component("YPL231W",328).
component("YGL001C",165).
component("YDR127W",121).
component("YJR139C",223).
component("YNL009W",287).
component("YLR174W",252).
component("YHR183W",200).
component("YGR256W",185).
component("YCL018W",89).
component("YJR078W",220).
component("YMR015C",271).
component("YDR402C",133).
component("YGL055W",168).
component("YJL026W",206).
component("YGR180C",182).
component("U68_",58).
component("U55_",55).
component("YER069W",150).
component("YOR323C",317).
component("YBR166C",83).
component("YNL280C",297).
component("YKL141W",230).
component("YOR375C",320).
component("YDL215C",112).
component("YAL062W",66).
component("U100_",20).
component("U56_",56).
component("YPL023C",322).
component("YGL125W",169).
component("YOR236W",315).
component("YMR145C",276).
component("YDL085W",101).
component("YBR046C",74).
component("YPL091W",325).
component("YNL052W",288).
component("YMR256C",282).
component("YLR395C",262).
component("YLR038C",243).
component("YIL111W",202).
component("YHR051W",194).
component("YGL191W",173).
component("YGL187C",172).
component("YDL067C",99).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",333).
component("YLL062C",240).
component("YDR410C",134).
component("YJR073C",218).
component("YOL096C",308).
component("YMR120C",275).
component("YJL130C",211).
component("YJL088W",208).
component("YPR074C",338).
component("YBR117C",80).
component("YCL009C",88).
component("YNL071W",289).
component("YNR019W",302).
component("YCR048W",96).
component("U48_",52).
component("YFL017C",157).
component("YPL231W",329).
component("YDL052C",98).
component("U8_",62).
component("YPL231W",330).
component("YLR299W",256).
component("YCR005C",93).
component("YML126C",267).
component("YDL182W",110).
component("YDL131W",106).
component("YNL117W",291).
component("YIR031C",205).
component("YOR321W",316).
component("YJR143C",224).
component("YGR199W",183).
component("YDL095W",103).
component("YDL093W",102).
component("YAL023C",65).
component("YMR261C",283).
component("YML100W",265).
component("YBR126C",81).
component("YLR209C",253).
component("YDR354W",130).
component("YFR047C",163).
component("U22_",43).
component("YDR399W",132).
component("YPR069C",337).
component("YDR127W",122).
component("YML082W",264).
component("YJR130C",222).
component("YDR035W",116).
component("YBR249C",85).
component("YHR137W",196).
component("YGL202W",174).
component("YLR027C",241).
component("YKL106W",228).
component("YOL140W",311).
component("YLR438W",263).
component("YDR111C",119).
component("U51_",53).
component("YJR148W",225).
component("YMR013C",270).
component("YCR036W",95).
component("YCL040W",92).
component("YJR105W",221).
component("YMR208W",278).
component("YHR025W",191).
component("YNR012W",300).
component("YFR019W",161).
component("YDR208W",127).
component("YDR127W",123).
component("YDR147W",126).
component("YER052C",146).
component("U19_",38).
component("U18_",35).
component("U76_",61).
component("YMR220W",279).
component("YDR226W",128).
component("YKL067W",227).
component("YDR454C",136).
component("YOL061W",307).
component("YKL181W",231).
component("YHL011C",187).
component("YER099C",153).
component("YBL068W",71).
component("YOR143C",314).
component("YLR328W",259).
component("U94_",63).
component("YBR029C",73).
component("YPR175W",341).
component("YPL167C",327).
component("YOR330C",318).
component("YOL115W",310).
component("YNL299W",298).
component("YNL262W",295).
component("YNL102W",290).
component("YJR043C",217).
component("YJR006W",216).
component("YJL090C",209).
component("YIL139C",203).
component("YEL055C",143).
component("YDR419W",135).
component("YDR121W",120).
component("YDL102W",104).
component("YCR014C",94).
component("YBR278W",86).
component("YBL035C",68).
component("YKL035W",226).
component("YHL012W",188).
component("YOL011W",305).
component("YMR008C",269).
component("YMR006C",268).
component("U105_",21).
component("YPL072W",324).
component("YOR124C",313).
component("YNL186W",294).
component("YMR304W",285).
component("YMR223W",280).
component("YKR098C",239).
component("YJL197W",215).
component("YIL156W",204).
component("YFR010W",160).
component("YER151C",155).
component("YER144C",154).
component("YER098W",152).
component("YDR069C",118).
component("YDL122W",105).
component("YBR058C",75).
component("YBL067C",70).
component("YFR025C",162).
component("U9_",64).
component("YJL155C",214).
component("U34_",48).
component("U33_",47).
component("U32_",46).
component("U30_",45).
component("U24_",44).
component("YHR044C",193).
component("YHR043C",192).
component("YLR286C",255).
component("YLR160C",251).
component("YLR158C",250).
component("YLR157C",249).
component("YLR155C",248).
component("YDR321W",129).
component("YGL037C",167).
component("U43_",50).
component("U42_",49).
component("YLR308W",258).
component("YLR307W",257).
component("U53_",54).
component("YLR028C",242).
component("YHR144C",197).
component("YHR144C",198).
component("YBR153W",82).
component("YDL238C",113).
component("YNL141W",292).
component("U44_",51).
component("YHR201C",201).
component("YBR111C",79).
component("YCL030C",91).
component("YER005W",145).
component("YLR231C",254).
component("YDR538W",141).
component("YLR134W",247).
component("YLR044C",244).
component("YGR087C",177).
component("YDR380W",131).
component("YDL080C",100).
component("YMR250W",281).
component("YKL184W",233).
component("YEL021W",142).
component("YKL211C",234).
component("YNR033W",303).
component("YKL211C",235).
component("YER090W",151).
component("YDR127W",124).
component("YPL281C",334).
component("YOR393W",321).
component("YMR323W",286).
component("YHR174W",199).
component("YGR254W",184).
component("YGL026C",166).
component("YGR155W",180).
component("YNL316C",299).
component("YCR053W",97).
component("YDR127W",125).
component("YGL148W",170).
component("YFR055W",164).
component("YJL121C",210).
component("YDR007W",114).
component("YOR095C",312).
component("YBR196C",84).
component("U14_",29).
component("YMR105C",274).
component("YKL127W",229).
component("YEL058W",144).
component("YPR060C",336).
component("YHR072W",195).
component("YJL153C",213).
component("YGR264C",186).
component("YGR171C",181).
component("YHR011W",189).
component("YDR023W",115).
component("YGL245W",175).
component("YPR047W",335).
component("YLR060W",246).
component("YFL022C",158).
component("YHR019C",190).
component("YPL160W",326).
component("YLR382C",261).
component("YPL040C",323).
component("YBL076C",72).
component("YER183C",156).
component("YDL141W",107).
component("YDL141W",108).
component("YDL141W",109).
component("YPR145W",340).
component("YGR124W",179).
component("YPL231W",331).
component("YNR016C",301).
component("YKL182W",232).
component("YGR037C",176).
component("YJL087C",207).
component("YOL010W",304).
component("YPR138C",339).
component("YPL265W",332).
component("YOR348C",319).
component("YOL103W",309).
component("YOL020W",306).
component("YNL142W",293).
component("YMR272C",284).
component("YMR202W",277).
component("YMR056C",272).
component("YML123C",266).
component("YLR348C",260).
component("YKR053C",238).
component("YKR039W",237).
component("YKL217W",236).
component("YJR077C",219).
component("YJL134W",212).
component("YGR121C",178).
component("YGL186C",171).
component("YFL055W",159).
component("YER060W-A",149).
component("YER060W",148).
component("YER056C",147).
component("YDR536W",140).
component("YDR508C",139).
component("YDR503C",138).
component("YDR497C",137).
component("YDR046C",117).
component("YDL210W",111).
component("YCL025C",90).
component("YBR291C",87).
component("YBR085W",78).
component("YBR069C",77).
component("YBR068C",76).
component("YBL042C",69).
component("YBL030C",67).
component("U6_",60).
component("U69_",59).
component("U5_",57).
component("U228_",42).
