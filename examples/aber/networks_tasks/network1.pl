...
component("YHL011C",51).
component("YER099C",43).
component("YBL068W",20).
component("U53_",19).
component("YHR144C",53).
component("YBR111C",23).
component("YLR231C",62).
component("YDR380W",39).
component("YDL080C",28).
component("YKL211C",58).
component("YKL211C",59).
component("YER090W",42).
