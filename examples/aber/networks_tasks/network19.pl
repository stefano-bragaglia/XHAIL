...
component("YNL280C",180).
component("YLR056W",155).
component("YGL001C",108).
component("YDR127W",76).
component("YNL009W",172).
component("YLR174W",157).
component("YHR183W",129).
component("YGR256W",120).
component("YCL018W",55).
component("YJR078W",141).
component("YMR015C",164).
component("YGL055W",111).
component("YOR323C",193).
component("YBR166C",51).
component("YNL280C",181).
component("YKL141W",146).
component("YOR375C",196).
component("YAL062W",39).
component("U100_",18).
component("YMR145C",165).
component("YDL085W",63).
component("YBR046C",44).
component("YDR410C",85).
component("YJL088W",134).
component("YPR074C",207).
component("YBR117C",49).
component("YNL071W",173).
component("YNR019W",184).
component("YCR048W",60).
component("U48_",33).
component("YPL231W",200).
component("YPL231W",201).
component("YLR299W",159).
component("YCR005C",57).
component("YNL117W",175).
component("YIR031C",132).
component("YOR321W",192).
component("YJR143C",144).
component("YGR199W",118).
component("YDL095W",65).
component("YDL093W",64).
component("YAL023C",38).
component("YDR354W",83).
component("YFR047C",106).
component("U22_",30).
component("YPR069C",206).
component("YDR127W",77).
component("YML082W",162).
component("YJR130C",143).
component("YDR035W",72).
component("YBR249C",53).
component("YHR137W",126).
component("YGL202W",114).
component("YLR027C",154).
component("YKL106W",145).
component("YLR438W",161).
component("U51_",34).
component("YMR013C",163).
component("YCR036W",59).
component("YJR105W",142).
component("YMR208W",167).
component("YHR025W",123).
component("YFR019W",105).
component("YDR208W",81).
component("YDR127W",78).
component("YER052C",92).
component("U19_",27).
component("YDR226W",82).
component("YDR454C",87).
component("YOL061W",188).
component("YKL181W",147).
component("YHL011C",122).
component("YER099C",98).
component("YBL068W",43).
component("YLR328W",160).
component("YPR175W",209).
component("YPL167C",199).
component("YOR330C",194).
component("YOL115W",189).
component("YNL299W",182).
component("YNL262W",179).
component("YNL102W",174).
component("YJR043C",139).
component("YJR006W",138).
component("YJL090C",135).
component("YIL139C",130).
component("YEL055C",90).
component("YDR419W",86).
component("YDR121W",75).
component("YDL102W",66).
component("YCR014C",58).
component("YBR278W",54).
component("YBL035C",40).
component("YPL072W",198).
component("YOR124C",191).
component("YNL186W",178).
component("YMR304W",170).
component("YMR223W",168).
component("YKR098C",153).
component("YJL197W",137).
component("YIL156W",131).
component("YFR010W",104).
component("YER151C",100).
component("YER144C",99).
component("YER098W",97).
component("YDR069C",74).
component("YDL122W",67).
component("YBR058C",45).
component("YBL067C",42).
component("U32_",32).
component("U30_",31).
component("YHR044C",125).
component("YHR043C",124).
component("YGL037C",110).
component("U53_",35).
component("YHR144C",127).
component("YBR153W",50).
component("YNL141W",176).
component("YBR111C",48).
component("YER005W",91).
component("YLR231C",158).
component("YDR380W",84).
component("YDL080C",62).
component("YMR250W",169).
component("YKL184W",148).
component("YKL211C",149).
component("YNR033W",185).
component("YKL211C",150).
component("YER090W",96).
component("YDR127W",79).
component("YPL281C",203).
component("YOR393W",197).
component("YMR323W",171).
component("YHR174W",128).
component("YGR254W",119).
component("YGL026C",109).
component("YNL316C",183).
component("YCR053W",61).
component("YDR127W",80).
component("YGL148W",112).
component("YFR055W",107).
component("YDR007W",71).
component("YOR095C",190).
component("YBR196C",52).
component("YPR060C",205).
component("YGR264C",121).
component("YGR171C",117).
component("YGL245W",115).
component("YPR047W",204).
component("YLR060W",156).
component("YFL022C",102).
component("YER183C",101).
component("YDL141W",68).
component("YDL141W",69).
component("YJL087C",133).
component("YOL010W",186).
component("YPR138C",208).
component("YPL265W",202).
component("YOR348C",195).
component("YOL020W",187).
component("YNL142W",177).
component("YMR202W",166).
component("YKR053C",152).
component("YKR039W",151).
component("YJR077C",140).
component("YJL134W",136).
component("YGR121C",116).
component("YGL186C",113).
component("YFL055W",103).
component("YER060W-A",95).
component("YER060W",94).
component("YER056C",93).
component("YDR536W",89).
component("YDR508C",88).
component("YDR046C",73).
component("YDL210W",70).
component("YCL025C",56).
component("YBR069C",47).
component("YBR068C",46).
component("YBL042C",41).
component("U6_",37).
component("U5_",36).
component("U228_",29).
component("U222_",28).
