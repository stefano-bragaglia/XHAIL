...
component("YNL280C",269).
component("YLR056W",223).
component("YMR083W",248).
component("YGL001C",151).
component("YDR127W",108).
component("YJR139C",204).
component("YNL009W",261).
component("YLR174W",230).
component("YHR183W",182).
component("YGR256W",168).
component("YCL018W",82).
component("YJR078W",201).
component("YMR015C",246).
component("YDR402C",120).
component("YGL055W",154).
component("YJL026W",187).
component("YGR180C",165).
component("YER069W",137).
component("YOR323C",290).
component("YBR166C",77).
component("YNL280C",270).
component("YKL141W",210).
component("YOR375C",293).
component("YDL215C",100).
component("YAL062W",60).
component("U100_",18).
component("U56_",52).
component("YPL023C",295).
component("YGL125W",155).
component("YOR236W",288).
component("YMR145C",251).
component("YDL085W",92).
component("YBR046C",68).
component("YPL273W",304).
component("YLL062C",219).
component("YDR410C",121).
component("YJR073C",199).
component("YOL096C",281).
component("YMR120C",250).
component("YJL130C",192).
component("YJL088W",189).
component("YPR074C",309).
component("YBR117C",74).
component("YCL009C",81).
component("YNL071W",262).
component("YNR019W",275).
component("YCR048W",88).
component("U48_",49).
component("YPL231W",300).
component("YDL052C",90).
component("U8_",56).
component("YPL231W",301).
component("YLR299W",233).
component("YCR005C",85).
component("YNL117W",264).
component("YIR031C",186).
component("YOR321W",289).
component("YJR143C",205).
component("YGR199W",166).
component("YDL095W",94).
component("YDL093W",93).
component("YAL023C",59).
component("YMR261C",257).
component("YML100W",241).
component("YBR126C",75).
component("YDR354W",117).
component("YFR047C",149).
component("U22_",40).
component("YDR399W",119).
component("YPR069C",308).
component("YDR127W",109).
component("YML082W",240).
component("YJR130C",203).
component("YDR035W",104).
component("YBR249C",79).
component("YHR137W",178).
component("YGL202W",158).
component("YLR027C",220).
component("YKL106W",208).
component("YOL140W",284).
component("YLR438W",239).
component("U51_",50).
component("YJR148W",206).
component("YMR013C",245).
component("YCR036W",87).
component("YCL040W",84).
component("YJR105W",202).
component("YMR208W",253).
component("YHR025W",174).
component("YNR012W",273).
component("YFR019W",147).
component("YDR208W",114).
component("YDR127W",110).
component("YDR147W",113).
component("YER052C",133).
component("U19_",35).
component("U18_",32).
component("U76_",55).
component("YMR220W",254).
component("YDR226W",115).
component("YDR454C",123).
component("YOL061W",280).
component("YKL181W",211).
component("YHL011C",170).
component("YER099C",140).
component("YBL068W",65).
component("YOR143C",287).
component("YLR328W",236).
component("U94_",57).
component("YBR029C",67).
component("YPR175W",312).
component("YPL167C",299).
component("YOR330C",291).
component("YOL115W",283).
component("YNL299W",271).
component("YNL262W",268).
component("YNL102W",263).
component("YJR043C",198).
component("YJR006W",197).
component("YJL090C",190).
component("YIL139C",184).
component("YEL055C",130).
component("YDR419W",122).
component("YDR121W",107).
component("YDL102W",95).
component("YCR014C",86).
component("YBR278W",80).
component("YBL035C",62).
component("YKL035W",207).
component("YHL012W",171).
component("YOL011W",278).
component("YMR008C",244).
component("YMR006C",243).
component("U105_",19).
component("YPL072W",297).
component("YOR124C",286).
component("YNL186W",267).
component("YMR304W",259).
component("YMR223W",255).
component("YKR098C",218).
component("YJL197W",196).
component("YIL156W",185).
component("YFR010W",146).
component("YER151C",142).
component("YER144C",141).
component("YER098W",139).
component("YDR069C",106).
component("YDL122W",96).
component("YBR058C",69).
component("YBL067C",64).
component("YFR025C",148).
component("U9_",58).
component("YJL155C",195).
component("U34_",45).
component("U33_",44).
component("U32_",43).
component("U30_",42).
component("U24_",41).
component("YHR044C",176).
component("YHR043C",175).
component("YLR286C",232).
component("YLR160C",229).
component("YLR158C",228).
component("YLR157C",227).
component("YLR155C",226).
component("YDR321W",116).
component("YGL037C",153).
component("U43_",47).
component("U42_",46).
component("YLR308W",235).
component("YLR307W",234).
component("U53_",51).
component("YLR028C",221).
component("YHR144C",179).
component("YHR144C",180).
component("YBR153W",76).
component("YDL238C",101).
component("YNL141W",265).
component("U44_",48).
component("YHR201C",183).
component("YBR111C",73).
component("YER005W",132).
component("YLR231C",231).
component("YDR538W",128).
component("YLR134W",225).
component("YLR044C",222).
component("YGR087C",161).
component("YDR380W",118).
component("YDL080C",91).
component("YMR250W",256).
component("YKL184W",213).
component("YEL021W",129).
component("YKL211C",214).
component("YNR033W",276).
component("YKL211C",215).
component("YER090W",138).
component("YDR127W",111).
component("YPL281C",305).
component("YOR393W",294).
component("YMR323W",260).
component("YHR174W",181).
component("YGR254W",167).
component("YGL026C",152).
component("YNL316C",272).
component("YCR053W",89).
component("YDR127W",112).
component("YGL148W",156).
component("YFR055W",150).
component("YJL121C",191).
component("YDR007W",102).
component("YOR095C",285).
component("YBR196C",78).
component("U14_",26).
component("YMR105C",249).
component("YKL127W",209).
component("YEL058W",131).
component("YPR060C",307).
component("YHR072W",177).
component("YJL153C",194).
component("YGR264C",169).
component("YGR171C",164).
component("YHR011W",172).
component("YDR023W",103).
component("YGL245W",159).
component("YPR047W",306).
component("YLR060W",224).
component("YFL022C",144).
component("YHR019C",173).
component("YPL160W",298).
component("YLR382C",238).
component("YPL040C",296).
component("YBL076C",66).
component("YER183C",143).
component("YDL141W",97).
component("YDL141W",98).
component("YPR145W",311).
component("YGR124W",163).
component("YPL231W",302).
component("YNR016C",274).
component("YKL182W",212).
component("YGR037C",160).
component("YJL087C",188).
component("YOL010W",277).
component("YPR138C",310).
component("YPL265W",303).
component("YOR348C",292).
component("YOL103W",282).
component("YOL020W",279).
component("YNL142W",266).
component("YMR272C",258).
component("YMR202W",252).
component("YMR056C",247).
component("YML123C",242).
component("YLR348C",237).
component("YKR053C",217).
component("YKR039W",216).
component("YJR077C",200).
component("YJL134W",193).
component("YGR121C",162).
component("YGL186C",157).
component("YFL055W",145).
component("YER060W-A",136).
component("YER060W",135).
component("YER056C",134).
component("YDR536W",127).
component("YDR508C",126).
component("YDR503C",125).
component("YDR497C",124).
component("YDR046C",105).
component("YDL210W",99).
component("YCL025C",83).
component("YBR085W",72).
component("YBR069C",71).
component("YBR068C",70).
component("YBL042C",63).
component("YBL030C",61).
component("U6_",54).
component("U5_",53).
component("U228_",39).
component("U222_",38).
