...
in_compartment(Experiment,"C00487",cytosol,Day) :-
  not exclude(721),
  Day >= 1,
  in_compartment(Experiment,"C00487",medium,Day),
  catalyst(721,Complex),
  not inhibited(Experiment,Complex,Day),
  not deleted(Experiment,Complex).
...
in_compartment(Experiment,"C00164",mitochondrion,Day) :-
  not exclude(1631),
  Day >= 1,
  in_compartment(Experiment,"C00164",cytosol,Day),
  catalyst(1631,Complex),
  not inhibited(Experiment,Complex,Day),
  not deleted(Experiment,Complex).
...
in_compartment(Experiment,"C04411",cytosol,Day) :-
  not exclude(1711),
  Day >= 1,
  in_compartment(Experiment,"C04411",mitochondrion,Day),
  catalyst(1711,Complex),
  not inhibited(Experiment,Complex,Day),
  not deleted(Experiment,Complex).
...
in_compartment(Experiment,"C00636",cytosol,Day) :-
  not exclude(8691),
  Day >= 1,
  in_compartment(Experiment,"C00275",cytosol,Day),
  catalyst(8691,Complex),
  not inhibited(Experiment,Complex,Day),
  not deleted(Experiment,Complex).
...
retractable_reaction(721).
retractable_reaction(722).
...
retractable_reaction(1631).
retractable_reaction(1632).
...
retractable_reaction(1711).
retractable_reaction(1712).
...
retractable_reaction(8691).
retractable_reaction(8692).
...
component("YGR060W",553).
component("YKR009C",764).
component("YMR083W",867).
component("YPL231W",1046).
component("YBR265W",295).
component("U46_",167).
component("YBR149W",276).
component("YBR149W",277).
component("YJR159W",727).
component("YGL001C",517).
component("YHR063C",614).
component("U45_",166).
component("YBR153W",278).
component("YML056C",846).
component("YLR432W",834).
component("YHR216W",639).
component("YAR075W",228).
component("YAR073W",227).
component("YCL030C",305).
component("YDR127W",394).
component("YJR139C",722).
component("YML075C",849).
component("YLR450W",837).
component("YOL126C",966).
component("YKL085W",737).
component("YDL078C",338).
component("YKL029C",732).
component("YOR136W",985).
component("YNL037C",901).
component("YNL009W",899).
component("YLR174W",803).
component("YDL066W",336).
component("YHR183W",633).
component("YGR256W",588).
component("YNL241C",917).
component("YOL059W",958).
component("YDL022W",327).
component("YCL018W",303).
component("YLR355C",828).
component("YIL074C",647).
component("YER081W",483).
component("YML054C",845).
component("YDL174C",361).
component("YIL155C",657).
component("YPR191W",1084).
component("YOR065W",975).
component("YJL166W",692).
component("YHR001W-A",600).
component("YGR183C",571).
component("YFR033C",513).
component("YEL024W",453).
component("YDR529C",443).
component("YBL045C",235).
component("Q0105",19).
component("YKR066C",769).
component("YGR088W",556).
component("YDR256C",411).
component("YKL026C",731).
component("YIR037W",668).
component("YBR244W",290).
component("YJR078W",713).
component("U58_",179).
component("YJR025C",705).
component("U107_",29).
component("YGR255C",587).
component("U108_",30).
component("YBL098W",240).
component("YMR015C",862).
component("YHR007C",601).
component("YDR402C",430).
component("YGL055W",527).
component("YGR175C",568).
component("YJR104C",716).
component("YHR008C",602).
component("YJL026W",671).
component("YIL066C",646).
component("YGR180C",570).
component("YER070W",481).
component("U37_",158).
component("U36_",157).
component("U35_",156).
component("YDR158W",402).
component("YJR009C",702).
component("YJL052W",673).
component("YGR192C",574).
component("YBR006W",245).
component("YPL276W",1057).
component("YPL275W",1056).
component("YOR388C",1019).
component("YOR374W",1016).
component("YER073W",482).
component("U68_",190).
component("YGL154C",535).
component("YBR115C",270).
component("U55_",176).
component("YER069W",479).
component("YOR323C",1006).
component("U2_",150).
component("YER178W",496).
component("YBR221C",288).
component("YIL125W",653).
component("YBR166C",281).
component("YNL280C",927).
component("YGL012W",521).
component("YKL182W",750).
component("U57_",178).
component("YKL216W",761).
component("YDR044W",378).
component("YER014W",464).
component("YKR009C",765).
component("YIL160C",659).
component("YGL205W",540).
component("YMR118C",872).
component("YLR164W",801).
component("YLL041C",776).
component("YKL148C",745).
component("YKL141W",743).
component("YJL045W",672).
component("YDR178W",404).
component("YJR051W",708).
component("YEL047C",457).
component("YDL171C",360).
component("YDL215C",365).
component("YOR375C",1017).
component("YDL215C",366).
component("YAL062W",225).
component("U99_",218).
component("U100_",22).
component("YBR035C",255).
component("YMR189W",879).
component("U56_",177).
component("YNR050C",942).
component("YKR080W",771).
component("YER023W",465).
component("YPL023C",1023).
component("YGL125W",532).
component("YOR236W",999).
component("YGR204W",578).
component("YBR084W",263).
component("YLR142W",794).
component("U65_",187).
component("U63_",185).
component("U62_",184).
component("YOR356W",1014).
component("YHR068W",615).
component("YKL150W",746).
component("YIL043C",643).
component("YHR042W",609).
component("YOR221C",997).
component("YMR145C",875).
component("YML120C",854).
component("YKL192C",754).
component("YKL055C",734).
component("YER061C",475).
component("YDL085W",340).
component("YBR046C",258).
component("YMR145C",876).
component("YML120C",855).
component("YKL192C",755).
component("YDL085W",341).
component("YGR234W",582).
component("YFR030W",512).
component("YPL017C",1022).
component("YFL018C",501).
component("YPL091W",1029).
component("YHR106W",624).
component("YDR353W",425).
component("YER042W",467).
component("YPR167C",1078).
component("YJR137C",721).
component("YNL052W",903).
component("YMR256C",887).
component("YLR395C",832).
component("YLR038C",783).
component("YIL111W",651).
component("YHR051W",613).
component("YGL191W",538).
component("YGL187C",537).
component("YDL067C",337).
component("Q0275",21).
component("Q0250",20).
component("Q0045",18).
component("YDR072C",387).
component("YPL266W",1053).
component("YML110C",853).
component("YBR034C",254).
component("YPL273W",1055).
component("YLL062C",779).
component("YDR410C",433).
component("YKR069W",770).
component("YOL096C",961).
component("U47_",168).
component("YER091C",487).
component("YJR073C",711).
component("YGR157W",565).
component("YML008C",838).
component("YDL033C",329).
component("YOL096C",962).
component("YLR172C",802).
component("YLR058C",786).
component("YBR263W",294).
component("YDR019C",374).
component("YBR176W",282).
component("YDR408C",432).
component("YMR120C",873).
component("YLR028C",781).
component("YBL013W",229).
component("YJL130C",684).
component("YJL088W",678).
component("YKL024C",730).
component("YPR074C",1070).
component("YBR117C",271).
component("YLR354C",827).
component("YGR043C",551).
component("YMR108W",870).
component("YCL009C",302).
component("YMR062C",865).
component("YNL071W",904).
component("YIL160C",660).
component("YNR019W",936).
component("YCR048W",322).
component("U48_",169).
component("YNL277W",925).
component("YMR062C",866).
component("YDR232W",407).
component("YFL017C",500).
component("YPL231W",1047).
component("YER061C",476).
component("U86_",208).
component("YPL001W",1021).
component("YDL052C",333).
component("U8_",211).
component("YDR148C",400).
component("YML042W",844).
component("YOR377W",1018).
component("YGR177C",569).
component("YPL231W",1048).
component("YGR147C",563).
component("YDL040C",330).
component("YPL028W",1024).
component("YLR195C",805).
component("YLR299W",815).
component("YGL017W",522).
component("YPR001W",1059).
component("YNR001C",932).
component("YCR005C",314).
component("YML126C",857).
component("YDL182W",362).
component("YDL131W",350).
component("YNL117W",908).
component("YIR031C",666).
component("YPR160W",1077).
component("YOR321W",1005).
component("YJR143C",723).
component("YGR199W",576).
component("YDL095W",345).
component("YDL093W",344).
component("YAL023C",221).
component("YLR258W",812).
component("YFR015C",509).
component("YPL227C",1044).
component("YOR103C",980).
component("YOR085W",977).
component("YMR149W",877).
component("YML019W",840).
component("YJL002C",669).
component("YEL002C",448).
component("YDL232W",367).
component("YCL043C",309).
component("YNL029C",900).
component("YIL085C",649).
component("YMR261C",888).
component("YML100W",851).
component("YBR126C",274).
component("YNL192W",915).
component("YBR038W",257).
component("YBR023C",252).
component("YEL011W",449).
component("YMR306W",897).
component("YLR342W",825).
component("YGR032W",549).
component("YPR183W",1081).
component("YLR209C",806).
component("U104_",26).
component("U103_",25).
component("YMR271C",890).
component("YML106W",852).
component("YOR209C",995).
component("YMR300C",895).
component("YER055C",471).
component("YDR354W",426).
component("YFR047C",514).
component("YJR133W",720).
component("U22_",144).
component("YLR209C",807).
component("YML022W",841).
component("YDR441C",436).
component("YDR399W",428).
component("YHR128W",626).
component("YPR176C",1080).
component("YPL172C",1037).
component("YNR041C",940).
component("YMR101C",868).
component("YDL090C",343).
component("YBR003W",244).
component("YBR002C",243).
component("YJL167W",693).
component("YJL167W",694).
component("YNL256W",920).
component("YPR069C",1068).
component("YDR127W",395).
component("YHR190W",634).
component("YLR146C",795).
component("YHR068W",616).
component("YLR303W",817).
component("YGR012W",547).
component("YML082W",850).
component("YJR130C",719).
component("YDR035W",376).
component("YBR249C",291).
component("YLR180W",804).
component("YDR502C",440).
component("YOR274W",1002).
component("YOL143C",969).
component("YBR256C",293).
component("YHR137W",627).
component("YGL202W",539).
component("YLR027C",780).
component("YKL106W",739).
component("YOL140W",968).
component("YLR438W",836).
component("YKL104C",738).
component("YGR019W",548).
component("YDR111C",392).
component("U64_",186).
component("U61_",183).
component("U51_",173).
component("YJR148W",724).
component("YHR208W",637).
component("YFL030W",503).
component("YOR184W",991).
component("YNR058W",945).
component("YIL116W",652).
component("YGL253W",545).
component("YFR053C",515).
component("YOL136C",967).
component("YIL107C",650).
component("YMR013C",861).
component("YMR205C",881).
component("YGR240C",583).
component("YOL016C",950).
component("YFR014C",508).
component("YLR240W",810).
component("YKL203C",757).
component("YJR066W",710).
component("YCR036W",321).
component("YGR194C",575).
component("YCL040W",308).
component("YJR105W",717).
component("U16_",89).
component("U15_",80).
component("YPL188W",1039).
component("YJR049C",707).
component("YEL041W",454).
component("U96_",216).
component("YKL001C",728).
component("YDR236C",409).
component("YML070W",848).
component("YFL053W",505).
component("YHL032C",598).
component("YLR133W",791).
component("YDR531W",445).
component("U83_",205).
component("U82_",204).
component("U81_",203).
component("YMR208W",882).
component("YPL203W",1040).
component("YOR061W",974).
component("YKL166C",748).
component("YJL164C",691).
component("YIL035C",642).
component("YHR205W",636).
component("YHR102W",623).
component("YGL019W",523).
component("YHR025W",608).
component("YOR347C",1012).
component("YAL038W",223).
component("YNR012W",934).
component("YPR121W",1074).
component("YPL258C",1050).
component("YOL055C",954).
component("YPL214C",1043).
component("U1_",122).
component("YDR009W",373).
component("YBR020W",251).
component("YNL267W",923).
component("YLR305C",819).
component("YFR019W",510).
component("YDR208W",405).
component("YDR127W",396).
component("U21_",135).
component("U20_",130).
component("YDR147W",399).
component("YDR300C",419).
component("YCR012W",315).
component("YER052C",469).
component("YER069W",480).
component("U19_",121).
component("U18_",110).
component("U17_",99).
component("U76_",199).
component("YMR220W",884).
component("YER170W",495).
component("YDR226W",406).
component("YKL067W",736).
component("YOL055C",955).
component("YDR454C",437).
component("YOL061W",959).
component("YKL181W",749).
component("YHL011C",595).
component("YER099C",489).
component("YBL068W",238).
component("YOR143C",986).
component("YNL256W",921).
component("YLR328W",823).
component("YBR018C",247).
component("YBR018C",248).
component("YDL055C",334).
component("YGR007W",546).
component("YGR202C",577).
component("YLR328W",824).
component("YKR002W",763).
component("YDL045C",331).
component("YDL103C",348).
component("U94_",215).
component("YJR010W",703).
component("YBR029C",253).
component("YCL050C",310).
component("YGL130W",533).
component("YDR530C",444).
component("YCL050C",311).
component("YPR190C",1083).
component("YPR187W",1082).
component("YPR110C",1072).
component("YPR010C",1061).
component("YOR341W",1011).
component("YOR340C",1010).
component("YOR224C",998).
component("YOR210W",996).
component("YOR207C",994).
component("YOR151C",987).
component("YOR116C",981).
component("YOL005C",947).
component("YNR003C",933).
component("YNL248C",919).
component("YNL151C",913).
component("YNL113W",907).
component("YKL144C",744).
component("YJR063W",709).
component("YJL148W",688).
component("YJL140W",687).
component("YIL021W",641).
component("YHR143W-A",628).
component("YGL070C",531).
component("YFL036W",504).
component("YDR404C",431).
component("YDR156W",401).
component("YDR045C",379).
component("YDL150W",358).
component("YDL140C",352).
component("YBR154C",280).
component("YPR175W",1079).
component("YPL167C",1036).
component("YOR330C",1007).
component("YOL115W",965).
component("YNL299W",929).
component("YNL262W",922).
component("YNL102W",906).
component("YJR043C",706).
component("YJR006W",701).
component("YJL090C",679).
component("YIL139C",655).
component("YEL055C",458).
component("YDR419W",434).
component("YDR121W",393).
component("YDL102W",347).
component("YCR014C",316).
component("YBR278W",296).
component("YBL035C",232).
component("YKL035W",733).
component("YHL012W",596).
component("YHR123W",625).
component("YPR113W",1073).
component("YBR243C",289).
component("YNL130C",909).
component("YDL142C",357).
component("YPL148C",1034).
component("YER026C",466).
component("YOR251C",1001).
component("YGR286C",592).
component("YJL068C",674).
component("YDR058C",384).
component("YNR034W",939).
component("YHR163W",631).
component("YGR248W",585).
component("YCR073W-A",324).
component("YDL086W",342).
component("YOL011W",949).
component("YMR008C",859).
component("YMR006C",858).
component("U105_",27).
component("U101_",23).
component("YJL068C",675).
component("YPL072W",1028).
component("YOR124C",982).
component("YNL186W",914).
component("YMR304W",896).
component("YMR223W",885).
component("YKR098C",774).
component("YJL197W",695).
component("YIL156W",658).
component("YFR010W",507).
component("YER151C",493).
component("YER144C",492).
component("YER098W",488).
component("YDR069C",386).
component("YDL122W",349).
component("YBR058C",259).
component("YBL067C",237).
component("YJR019C",704).
component("YOR040W",973).
component("YDR272W",414).
component("U84_",206).
component("YDR481C",438).
component("YLR377C",830).
component("YDR074W",388).
component("YFR025C",511).
component("YPL179W",1038).
component("YNR032W",937).
component("YML057W",847).
component("YML016C",839).
component("YLR433C",835).
component("YGR123C",559).
component("YER133W",491).
component("YER089C",485).
component("YDR436W",435).
component("YDR075W",389).
component("YDL188C",363).
component("YDL134C",351).
component("YDL047W",332).
component("YDL006W",325).
component("YBR125C",273).
component("YBL056W",236).
component("YPR073C",1069).
component("YHR215W",638).
component("YDL024C",328).
component("YBR093C",268).
component("YBR092C",267).
component("YIL053W",645).
component("YER062C",477).
component("YHR046C",612).
component("U9_",219).
component("YGR208W",581).
component("YPL228W",1045).
component("YMR180C",878).
component("YDL236W",368).
component("YJL155C",690).
component("U34_",155).
component("U33_",154).
component("U32_",153).
component("U31_",152).
...
component("U26_",146).
component("U24_",145).
component("YHR044C",611).
component("YHR043C",610).
component("YOL064C",960).
component("YPL268W",1054).
component("YOR360C",1015).
component("YGL248W",544).
component("YKR031C",766).
component("YPL206C",1041).
component("YGL027C",525).
component("YLR286C",814).
component("YJR153W",725).
component("YJL221C",700).
component("YJL216C",698).
component("YIL172C",664).
component("YGR292W",594).
component("YGR287C",593).
component("YBR299W",301).
component("YBR184W",283).
component("YIL162W",661).
component("YPR026W",1062).
component("YDR001C",371).
component("YBR001C",242).
component("YOR190W",992).
component("YLR300W",816).
component("YGR282C",591).
component("YDR261C",412).
component("YDR400W",429).
component("YML035C",842).
component("YJL070C",676).
component("YBR284W",297).
component("U106_",28).
component("U102_",24).
component("YER043C",468).
component("YNL045W",902).
component("YLR160C",800).
component("YLR158C",799).
component("YLR157C",798).
component("YLR155C",797).
component("YDR321W",420).
component("YGL037C",526).
component("U43_",164).
component("U42_",163).
component("YMR293C",894).
component("YDR242W",410).
component("YLR308W",822).
component("YLR307W",821).
component("YBR208C",285).
component("YMR281W",893).
component("U53_",174).
component("YLR420W",833).
component("YPL111W",1032).
component("YIR032C",667).
component("YIR029W",665).
component("YPR062W",1067).
component("YMR120C",874).
component("YLR028C",782).
component("YHR144C",629).
component("YHR144C",630).
component("YGR267C",590).
component("YCL030C",306).
component("YNL141W",910).
component("YBL033C",231).
component("YBR153W",279).
component("YDL238C",369).
component("YNL141W",911).
component("YLR245C",811).
component("YML035C",843).
component("YGR204W",579).
component("YBR084W",264).
component("YJL126W",682).
component("U44_",165).
component("YDL100C",346).
component("U40_",161).
component("U39_",159).
component("YMR267W",889).
component("YBR011C",246).
component("YHR201C",635).
component("YBR111C",269).
component("YBR252W",292).
component("YCL030C",307).
component("YEL042W",455).
component("YER005W",463).
component("YIL048W",644).
component("YER166W",494).
component("YDR093W",391).
component("YAL026C",222).
component("YBL099W",241).
component("U60_",182).
component("YLR231C",808).
component("U88_",209).
component("YDR538W",447).
component("YLR134W",792).
component("YLR044C",784).
component("YGR087C",555).
component("YDR380W",427).
component("YDL080C",339).
component("U98_",217).
component("YMR250W",886).
component("YKL184W",753).
component("YOR128C",983).
component("YEL021W",452).
component("YNR043W",941).
component("U93_",214).
component("YDR047W",381).
component("U54_",175).
component("YKL211C",759).
component("YKR097W",773).
component("YOL052C",953).
component("YGR170W",566).
component("YKL060C",735).
component("YDR294C",416).
component("YEL046C",456).
component("YNR033W",938).
component("YPR006C",1060).
component("YER065C",478).
component("YKL211C",760).
component("YER090W",486).
component("YDR127W",397).
component("YPL281C",1058).
component("YOR393W",1020).
component("YMR323W",898).
component("YHR174W",632).
component("YGR254W",586).
component("YPL262W",1051).
component("YGL026C",524).
component("YGR155W",564).
component("YLR304C",818).
component("YJL200C",696).
component("YGL009C",520).
component("YDR234W",408).
component("YNL316C",930).
component("YKL182W",751).
component("YPL212C",1042).
component("YNL292W",928).
component("YGL063W",530).
component("YFL001W",498).
component("YOR278W",1003).
component("U49_",170).
component("YCR053W",323).
component("YDR127W",398).
component("YGL148W",534).
component("YIL168W",663).
component("YIL167W",662).
component("YCL064C",312).
component("YCL064C",313).
component("YHR018C",604).
component("YLR359W",829).
component("YAL012W",220).
component("YFR055W",516).
component("YJL005W",670).
component("YOR176W",990).
component("YJL121C",681).
component("YBR019C",249).
component("YBR019C",250).
component("U59_",180).
component("YDR050C",382).
component("YIL020C",640).
component("YDR007W",372).
component("YOR095C",978).
component("YER003C",462).
component("YBR196C",284).
component("YGL001C",518).
component("YPL117C",1033).
component("U14_",73).
component("YOL056W",956).
component("YKL152C",747).
component("YDL021W",326).
component("YMR105C",869).
component("YKL127W",741).
component("YEL058W",459).
component("YMR278W",892).
component("YPR060C",1066).
component("YHR072W",617).
component("YJL153C",689).
component("YPL097W",1030).
component("YGR185C",572).
component("YGR264C",589).
component("YGR171C",567).
component("YHR011W",603).
component("YDR023W",375).
component("YPL104W",1031).
component("YLL018C",775).
component("YPR081C",1071).
component("YBR121C",272).
component("YHR020W",607).
component("YER087W",484).
component("YNL247W",918).
component("YOL033W",952).
component("YGL245W",543).
component("YOR168W",988).
component("YHR091C",619).
component("YDR341C",421).
component("YOL097C",963).
component("YDR268W",413).
component("YPR047W",1065).
component("YLR060W",787).
component("YFL022C",502).
component("YPR033C",1063).
component("YHR019C",605).
component("YCR024C",317).
component("YHR019C",606).
component("YKL194C",756).
component("YIL078W",648).
component("YPL160W",1035).
component("YLR382C",831).
component("YPL040C",1026).
component("YBL076C",239).
component("YNL073W",905).
component("YDR037W",377).
component("YOR335C",1008).
component("YGR094W",557).
component("YLR153C",796).
component("YAL054C",224).
component("YGR244C",584).
component("YPR035W",1064).
component("YIL145C",656).
component("U89_",210).
component("YOR241W",1000).
component("YMR113W",871).
component("YKL132C",742).
component("YOR339C",1009).
component("YMR022W",863).
component("YLR306W",820).
component("YKL210W",758).
component("YGR133W",562).
component("YGL058W",528).
component("YER100W",490).
component("YEL012W",450).
component("YDR177W",403).
component("YDR092W",390).
component("YDR059C",385).
component("YDR054C",383).
component("YDL064W",335).
component("YBR082C",262).
component("YJL101C",680).
component("U92_",213).
component("YAR015W",226).
component("YGL234W",541).
component("YER183C",497).
component("U90_",212).
component("YNR057C",944).
component("YDL141W",353).
component("YDL141W",354).
component("YGL234W",542).
component("YDL141W",355).
component("YJR103W",715).
component("YBL039C",233).
component("YGR204W",580).
component("YBR084W",265).
component("YNL220W",916).
component("YOL058W",957).
component("YBR208C",286).
component("YDL141W",356).
component("YHR074W",618).
component("YMR217W",883).
component("YPR145W",1076).
component("YGR124W",560).
component("YOR303W",1004).
component("YJR109C",718).
component("YJL130C",685).
component("YGL062W",529).
component("YBR218C",287).
component("YPL231W",1049).
component("YNR016C",935).
component("YKL182W",752).
component("YGR037C",550).
component("YOR005C",971).
component("YDL164C",359).
component("YJL087C",677).
component("YOL010W",948).
component("YPR138C",1075).
component("YPL265W",1052).
component("YPL057C",1027).
component("YPL036W",1025).
component("YOR348C",1013).
component("YOR192C",993).
component("YOR171C",989).
component("YOR130C",984).
component("YOR100C",979).
component("YOR071C",976).
component("YOR011W",972).
component("YOL156W",970).
component("YOL103W",964).
component("YOL020W",951).
...
component("YJL219W",699).
component("YJL214W",697).
component("YJL134W",686).
component("YJL129C",683).
component("YIL134W",654).
component("YHR096C",622).
component("YHR094C",621).
component("YHR092C",620).
component("YHL036W",599).
component("YHL016C",597).
component("YGR191W",573).
component("YGR125W",561).
component("YGR121C",558).
component("YGR065C",554).
component("YGR055W",552).
component("YGL186C",536).
component("YGL008C",519).
component("YFL055W",506).
component("YFL011W",499).
component("YER060W-A",474).
component("YER060W",473).
component("YER056C",472).
component("YER053C",470).
component("YEL069C",461).
component("YEL063C",460).
component("YEL017C-A",451).
component("YDR536W",446).
component("YDR508C",442).
component("YDR503C",441).
component("YDR497C",439).
component("YDR345C",424).
component("YDR343C",423).
component("YDR342C",422).
component("YDR297W",418).
component("YDR294C",417).
component("YDR284C",415).
component("YDR046C",380).
component("YDL245C",370).
component("YDL210W",364).
component("YCR032W",320).
component("YCR028C",319).
component("YCR024C-A",318).
component("YCL025C",304).
component("YBR298C",300).
component("YBR294W",299).
component("YBR291C",298).
component("YBR132C",275).
component("YBR085W",266).
component("YBR069C",261).
component("YBR068C",260).
component("YBR036C",256).
component("YBL042C",234).
component("YBL030C",230).
component("U85_",207).
component("U7_",202).
component("U79_",201).
component("U78_",200).
