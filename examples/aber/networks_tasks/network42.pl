...
component("YLR056W",267).
component("YMR083W",295).
component("YPL231W",365).
component("YGL001C",173).
component("YDR127W",126).
component("YJR139C",243).
component("YNL009W",310).
component("YLR174W",274).
component("YHR183W",212).
component("YGR256W",195).
component("YCL018W",91).
component("YJR078W",239).
component("YMR015C",293).
component("YDR402C",139).
component("YGL055W",177).
component("YJL026W",221).
component("YGR180C",192).
component("U68_",58).
component("U55_",55).
component("YER069W",157).
component("YOR323C",351).
component("YBR166C",85).
component("YNL280C",323).
component("YKL141W",250).
component("YOR375C",356).
component("YDL215C",116).
component("YAL062W",67).
component("U100_",20).
component("YMR189W",299).
component("U56_",56).
component("YPL023C",358).
component("YGL125W",179).
component("YOR236W",349).
component("YMR145C",298).
component("YDL085W",103).
component("YBR046C",75).
component("YPL091W",361).
component("YNL052W",311).
component("YMR256C",305).
component("YLR395C",284).
component("YLR038C",265).
component("YIL111W",217).
component("YHR051W",204).
component("YGL191W",183).
component("YGL187C",182).
component("YDL067C",101).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",370).
component("YLL062C",262).
component("YDR410C",141).
component("YJR073C",237).
component("YOL096C",336).
component("YMR120C",297).
component("YJL130C",226).
component("YJL088W",223).
component("YPR074C",376).
component("YBR117C",81).
component("YCL009C",90).
component("YNL071W",312).
component("YNR019W",329).
component("YCR048W",98).
component("U48_",52).
component("YFL017C",164).
component("YPL231W",366).
component("YDL052C",100).
component("U8_",63).
component("YPL231W",367).
component("YLR299W",278).
component("YCR005C",95).
component("YML126C",289).
component("YDL182W",114).
component("YDL131W",108).
component("YNL117W",315).
component("YIR031C",220).
component("YOR321W",350).
component("YJR143C",244).
component("YGR199W",193).
component("YDL095W",105).
component("YDL093W",104).
component("YAL023C",66).
component("YMR261C",306).
component("YML100W",287).
component("YBR126C",82).
component("YLR209C",275).
component("YDR354W",136).
component("YFR047C",171).
component("YJR133W",242).
component("U22_",43).
component("YDR399W",138).
component("YPR069C",375).
component("YDR127W",127).
component("YML082W",286).
component("YJR130C",241).
component("YDR035W",120).
component("YBR249C",87).
component("YHR137W",207).
component("YGL202W",184).
component("YLR027C",263).
component("YKL106W",248).
component("YOL140W",339).
component("YLR438W",285).
component("YDR111C",124).
component("U51_",53).
component("YJR148W",245).
component("YMR013C",292).
component("YCR036W",97).
component("YCL040W",94).
component("YJR105W",240).
component("YMR208W",301).
component("YPL203W",364).
component("YOR061W",340).
component("YKL166C",252).
component("YJL164C",232).
component("YIL035C",216).
component("YHR205W",214).
component("YHR102W",206).
component("YGL019W",174).
component("YHR025W",201).
component("YNR012W",327).
component("YFR019W",169).
component("YDR208W",133).
component("YDR127W",128).
component("YDR147W",131).
component("YER052C",153).
component("U19_",38).
component("U18_",35).
component("U76_",61).
component("YMR220W",302).
component("YDR226W",134).
component("YKL067W",247).
component("YDR454C",143).
component("YOL061W",335).
component("YKL181W",253).
component("YHL011C",197).
component("YER099C",160).
component("YBL068W",72).
component("YOR143C",344).
component("YLR328W",281).
component("U94_",64).
component("YBR029C",74).
component("YPR190C",382).
component("YPR187W",381).
component("YPR110C",377).
component("YPR010C",372).
component("YOR341W",354).
component("YOR340C",353).
component("YOR224C",348).
component("YOR210W",347).
component("YOR207C",346).
component("YOR151C",345).
component("YOR116C",342).
component("YOL005C",331).
component("YNR003C",326).
component("YNL248C",320).
component("YNL151C",318).
component("YNL113W",314).
component("YKL144C",251).
component("YJR063W",236).
component("YJL148W",229).
component("YJL140W",228).
component("YIL021W",215).
component("YHR143W-A",208).
component("YGL070C",178).
component("YFL036W",166).
component("YDR404C",140).
component("YDR156W",132).
component("YDR045C",121).
component("YDL150W",113).
component("YDL140C",109).
component("YBR154C",84).
component("YPR175W",380).
component("YPL167C",363).
component("YOR330C",352).
component("YOL115W",338).
component("YNL299W",324).
component("YNL262W",321).
component("YNL102W",313).
component("YJR043C",235).
component("YJR006W",234).
component("YJL090C",224).
component("YIL139C",218).
component("YEL055C",150).
component("YDR419W",142).
component("YDR121W",125).
component("YDL102W",106).
component("YCR014C",96).
component("YBR278W",88).
component("YBL035C",69).
component("YKL035W",246).
component("YHL012W",198).
component("YOL011W",333).
component("YMR008C",291).
component("YMR006C",290).
component("U105_",21).
component("YPL072W",360).
component("YOR124C",343).
component("YNL186W",319).
component("YMR304W",308).
component("YMR223W",303).
component("YKR098C",261).
component("YJL197W",233).
component("YIL156W",219).
component("YFR010W",168).
component("YER151C",162).
component("YER144C",161).
component("YER098W",159).
component("YDR069C",123).
component("YDL122W",107).
component("YBR058C",76).
component("YBL067C",71).
component("YFR025C",170).
component("U9_",65).
...
component("U30_",45).
component("U24_",44).
component("YHR044C",203).
component("YHR043C",202).
component("YLR286C",277).
component("YLR160C",273).
component("YLR158C",272).
component("YLR157C",271).
component("YLR155C",270).
component("YDR321W",135).
component("YGL037C",176).
component("U43_",50).
component("U42_",49).
component("YLR308W",280).
component("YLR307W",279).
component("U53_",54).
component("YLR028C",264).
component("YHR144C",209).
component("YHR144C",210).
component("YBR153W",83).
component("YDL238C",117).
component("YNL141W",316).
component("U44_",51).
component("YHR201C",213).
component("YBR111C",80).
component("YCL030C",93).
component("YER005W",152).
component("YLR231C",276).
component("YDR538W",148).
component("YLR134W",269).
component("YLR044C",266).
component("YGR087C",187).
component("YDR380W",137).
component("YDL080C",102).
component("YMR250W",304).
component("YKL184W",255).
component("YEL021W",149).
component("YKL211C",256).
component("YNR033W",330).
component("YKL211C",257).
component("YER090W",158).
component("YDR127W",129).
component("YPL281C",371).
component("YOR393W",357).
component("YMR323W",309).
component("YHR174W",211).
component("YGR254W",194).
component("YGL026C",175).
component("YGR155W",190).
component("YNL316C",325).
component("YCR053W",99).
component("YDR127W",130).
component("YGL148W",180).
component("YFR055W",172).
component("YJL121C",225).
component("YDR007W",118).
component("YOR095C",341).
component("YBR196C",86).
component("U14_",29).
component("YMR105C",296).
component("YKL127W",249).
component("YEL058W",151).
component("YPR060C",374).
component("YHR072W",205).
component("YJL153C",230).
component("YGR264C",196).
component("YGR171C",191).
component("YHR011W",199).
component("YDR023W",119).
component("YGL245W",185).
component("YPR047W",373).
component("YLR060W",268).
component("YFL022C",165).
component("YHR019C",200).
component("YPL160W",362).
component("YLR382C",283).
component("YPL040C",359).
component("YBL076C",73).
component("YER183C",163).
component("YDL141W",110).
component("YDL141W",111).
component("YDL141W",112).
component("YPR145W",379).
component("YGR124W",189).
component("YPL231W",368).
component("YNR016C",328).
component("YKL182W",254).
component("YGR037C",186).
component("YJL087C",222).
component("YOL010W",332).
component("YPR138C",378).
component("YPL265W",369).
component("YOR348C",355).
component("YOL103W",337).
component("YOL020W",334).
component("YNL142W",317).
component("YMR272C",307).
component("YMR202W",300).
component("YMR056C",294).
component("YML123C",288).
component("YLR348C",282).
component("YKR053C",260).
component("YKR039W",259).
component("YKL217W",258).
component("YJR077C",238).
component("YJL134W",227).
component("YGR121C",188).
component("YGL186C",181).
component("YFL055W",167).
component("YER060W-A",156).
component("YER060W",155).
component("YER056C",154).
component("YDR536W",147).
component("YDR508C",146).
component("YDR503C",145).
component("YDR497C",144).
component("YDR046C",122).
component("YDL210W",115).
component("YCL025C",92).
component("YBR291C",89).
component("YBR085W",79).
component("YBR069C",78).
component("YBR068C",77).
component("YBL042C",70).
component("YBL030C",68).
component("U7_",62).
component("U6_",60).
component("U69_",59).
component("U5_",57).
