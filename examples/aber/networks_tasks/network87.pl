...
component("YNL280C",517).
component("YLR056W",432).
component("YKR009C",421).
component("YMR083W",480).
component("YPL231W",582).
component("YJR159W",401).
component("YGL001C",280).
component("YML056C",466).
component("YLR432W",461).
component("YHR216W",348).
component("YAR075W",116).
component("YAR073W",115).
component("YCL030C",160).
component("YDR127W",212).
component("YJR139C",397).
component("YOR136W",548).
component("YNL009W",497).
component("YLR174W",444).
component("YDL066W",177).
component("YHR183W",344).
component("YGR256W",320).
component("YOL059W",537).
component("YDL022W",172).
component("YCL018W",158).
component("YLR355C",456).
component("YML054C",465).
component("YIL155C",357).
component("YEL024W",241).
component("YJR078W",393).
component("U58_",91).
component("YGR255C",319).
component("YMR015C",477).
component("YDR402C",229).
component("YGL055W",286).
component("YJL026W",365).
component("YIL066C",353).
component("YGR180C",311).
component("YER070W",256).
component("U36_",79).
component("U35_",78).
component("YJR009C",384).
component("YJL052W",366).
component("YGR192C",313).
component("YOR374W",567).
component("YER073W",257).
component("U68_",95).
component("YGL154C",291).
component("U55_",89).
component("YER069W",255).
component("YOR323C",560).
component("U2_",73).
component("YBR221C",150).
component("YBR166C",146).
component("YNL280C",518).
component("YER014W",245).
component("YKL141W",408).
component("YJR051W",388).
component("YOR375C",568).
component("YDL215C",197).
component("YAL062W",114).
component("U100_",20).
component("YBR035C",131).
component("YMR189W",485).
component("U56_",90).
component("YPL023C",571).
component("YGL125W",289).
...
component("YIL043C",351).
component("YHR042W",329).
component("YMR145C",484).
component("YML120C",471).
component("YKL192C",415).
component("YDL085W",180).
component("YBR046C",133).
component("YPL091W",574).
component("YER042W",246).
component("YNL052W",499).
component("YMR256C",492).
component("YLR395C",459).
component("YLR038C",430).
component("YIL111W",355).
component("YHR051W",333).
component("YGL191W",294).
component("YGL187C",293).
component("YDL067C",178).
component("Q0275",19).
component("Q0250",18).
component("YPL266W",588).
component("YPL273W",590).
component("YLL062C",427).
component("YDR410C",231).
component("YER091C",261).
component("YJR073C",391).
component("YDL033C",173).
component("YOL096C",539).
component("YLR172C",443).
component("YMR120C",483).
component("YBL013W",117).
component("YJL130C",374).
component("YJL088W",369).
component("YPR074C",600).
component("YBR117C",141).
component("YMR108W",482).
component("YCL009C",157).
component("YMR062C",479).
component("YNL071W",500).
component("YIL160C",359).
component("YNR019W",525).
component("YCR048W",169).
component("U48_",84).
component("YNL277W",516).
component("YFL017C",269).
component("YPL231W",583).
component("YER061C",252).
component("U86_",107).
component("YDL052C",175).
component("U8_",109).
component("YDR148C",218).
component("YOR377W",569).
component("YGR177C",310).
component("YPL231W",584).
component("YLR195C",445).
component("YLR299W",450).
component("YPR001W",592).
component("YNR001C",521).
component("YCR005C",165).
component("YML126C",473).
component("YDL182W",194).
component("YDL131W",186).
component("YNL117W",504).
component("YIR031C",363).
component("YOR321W",559).
component("YJR143C",398).
component("YGR199W",315).
component("YDL095W",182).
component("YDL093W",181).
component("YAL023C",113).
component("YPL227C",581).
component("YMR261C",493).
component("YML100W",470).
component("YBR126C",143).
component("YNL192W",511).
component("YBR038W",132).
component("YBR023C",129).
component("YLR209C",446).
component("U104_",23).
component("YDR354W",225).
component("YFR047C",277).
component("YJR133W",396).
component("U22_",68).
component("YDR399W",227).
component("YJL167W",381).
component("YNL256W",513).
component("YPR069C",599).
component("YDR127W",213).
component("YHR068W",335).
component("YLR303W",451).
component("YML082W",469).
component("YJR130C",395).
component("YDR035W",202).
component("YBR249C",151).
component("YBR256C",153).
component("YHR137W",339).
component("YGL202W",295).
component("YLR027C",428).
component("YKL106W",406).
component("YOL140W",542).
component("YLR438W",463).
component("YKL104C",405).
component("YDR111C",210).
component("U51_",87).
component("YJR148W",399).
component("YHR208W",347).
component("YOR184W",552).
component("YGL253W",299).
component("YFR053C",278).
component("YMR013C",476).
component("YLR240W",448).
component("YKL203C",417).
component("YJR066W",390).
component("YCR036W",168).
component("YGR194C",314).
component("YCL040W",162).
component("YJR105W",394).
component("U16_",46).
component("YKL001C",402).
component("YML070W",468).
component("YFL053W",272).
component("U82_",106).
component("U81_",105).
component("YMR208W",487).
component("YPL203W",580).
component("YOR061W",543).
component("YKL166C",411).
component("YJL164C",380).
component("YIL035C",350).
component("YHR205W",346).
component("YHR102W",337).
component("YGL019W",282).
component("YHR025W",328).
component("YNR012W",523).
component("YPR121W",602).
component("YPL258C",586).
component("YOL055C",535).
component("U1_",58).
component("YBR020W",128).
component("YFR019W",275).
component("YDR208W",220).
component("YDR127W",214).
component("U21_",65).
component("YDR147W",217).
component("YCR012W",166).
component("YER052C",248).
component("U19_",57).
component("U18_",53).
component("U17_",50).
component("U76_",102).
component("YMR220W",489).
component("YER170W",267).
component("YDR226W",221).
component("YKL067W",404).
component("YOL055C",536).
component("YDR454C",234).
component("YOL061W",538).
component("YKL181W",412).
component("YHL011C",323).
component("YER099C",263).
component("YBL068W",123).
component("YOR143C",549).
component("YNL256W",514).
component("YBR018C",126).
component("YDL055C",176).
component("YLR328W",454).
component("YDL103C",184).
component("U94_",111).
component("YJR010W",385).
component("YBR029C",130).
component("YPR190C",607).
component("YPR187W",606).
component("YPR110C",601).
component("YPR010C",594).
component("YOR341W",564).
component("YOR340C",563).
component("YOR224C",555).
component("YOR210W",554).
component("YOR207C",553).
component("YOR151C",550).
component("YOR116C",545).
component("YOL005C",530).
component("YNR003C",522).
component("YNL248C",512).
component("YNL151C",509).
component("YNL113W",503).
component("YKL144C",409).
component("YJR063W",389).
component("YJL148W",377).
component("YJL140W",376).
component("YIL021W",349).
...
component("YBR154C",145).
component("YPR175W",605).
component("YPL167C",578).
component("YOR330C",561).
component("YOL115W",541).
component("YNL299W",519).
component("YNL262W",515).
component("YNL102W",502).
component("YJR043C",387).
component("YJR006W",383).
component("YJL090C",370).
component("YIL139C",356).
component("YEL055C",242).
component("YDR419W",232).
component("YDR121W",211).
component("YDL102W",183).
component("YCR014C",167).
component("YBR278W",154).
component("YBL035C",119).
component("YKL035W",403).
component("YHL012W",324).
component("YHR123W",338).
component("YNL130C",505).
component("YPL148C",576).
component("YOR251C",557).
component("YGR286C",322).
component("YDR058C",206).
component("YOL011W",532).
component("YMR008C",475).
component("YMR006C",474).
component("U105_",24).
component("U101_",21).
component("YJL068C",367).
component("YPL072W",573).
component("YOR124C",546).
component("YNL186W",510).
component("YMR304W",495).
component("YMR223W",490).
component("YKR098C",426).
component("YJL197W",382).
component("YIL156W",358).
component("YFR010W",274).
component("YER151C",266).
component("YER144C",265).
component("YER098W",262).
component("YDR069C",207).
component("YDL122W",185).
component("YBR058C",134).
component("YBL067C",122).
component("YJR019C",386).
component("YDR074W",208).
component("YFR025C",276).
component("YPL179W",579).
component("YNR032W",526).
component("YML057W",467).
component("YML016C",464).
component("YLR433C",462).
component("YGR123C",305).
component("YER133W",264).
component("YER089C",259).
component("YDR436W",233).
component("YDR075W",209).
component("YDL188C",195).
component("YDL134C",187).
component("YDL047W",174).
component("YDL006W",171).
component("YBR125C",142).
component("YBL056W",121).
component("YIL053W",352).
component("YER062C",253).
component("YHR046C",332).
component("U9_",112).
component("YGR208W",317).
component("YJL155C",379).
component("U34_",77).
component("U33_",76).
component("U32_",75).
component("U30_",74).
...
component("U26_",70).
component("U24_",69).
component("YHR044C",331).
component("YHR043C",330).
component("YPL268W",589).
component("YOR360C",566).
component("YGL248W",298).
component("YKR031C",422).
component("YGL027C",284).
component("YLR286C",449).
component("YJR153W",400).
component("YBR184W",147).
component("YIL162W",360).
component("YPR026W",595).
component("YDR001C",199).
component("YBR001C",125).
component("YDR400W",228).
component("U102_",22).
component("YER043C",247).
component("YNL045W",498).
...
component("U43_",82).
component("U42_",81).
component("YLR308W",453).
component("YLR307W",452).
component("U53_",88).
component("YLR420W",460).
component("YIR032C",364).
component("YLR028C",429).
component("YHR144C",341).
component("YHR144C",342).
component("YNL141W",506).
component("YBR153W",144).
component("YDL238C",198).
component("YNL141W",507).
component("YBR084W",138).
component("YJL126W",372).
component("U44_",83).
component("YHR201C",345).
component("YBR111C",140).
component("YBR252W",152).
component("YCL030C",161).
component("YER005W",244).
component("YLR231C",447).
component("U88_",108).
component("YDR538W",239).
component("YLR134W",436).
component("YLR044C",431).
component("YGR087C",302).
component("YDR380W",226).
component("YDL080C",179).
component("YMR250W",491).
component("YKL184W",414).
component("YEL021W",240).
component("YNR043W",528).
component("YKL211C",418).
component("YKR097W",425).
component("YOL052C",534).
component("YDR294C",222).
component("YNR033W",527).
component("YPR006C",593).
component("YER065C",254).
component("YKL211C",419).
component("YER090W",260).
component("YDR127W",215).
component("YPL281C",591).
component("YOR393W",570).
component("YMR323W",496).
component("YHR174W",343).
component("YGR254W",318).
component("YGL026C",283).
component("YGR155W",308).
component("YNL316C",520).
component("YCR053W",170).
component("YDR127W",216).
component("YGL148W",290).
component("YIL168W",362).
component("YIL167W",361).
component("YCL064C",163).
component("YCL064C",164).
component("YLR359W",457).
component("YFR055W",279).
component("YJL121C",371).
component("YBR019C",127).
component("YDR007W",200).
component("YOR095C",544).
component("YBR196C",148).
component("YGL001C",281).
component("YPL117C",575).
component("U14_",39).
component("YMR105C",481).
component("YKL127W",407).
component("YEL058W",243).
component("YPR060C",598).
component("YHR072W",336).
component("YJL153C",378).
component("YGR264C",321).
component("YGR171C",309).
component("YHR011W",325).
component("YDR023W",201).
component("YHR020W",327).
component("YER087W",258).
component("YGL245W",297).
component("YOR168W",551).
component("YPR047W",597).
component("YLR060W",433).
component("YFL022C",270).
component("YPR033C",596).
component("YHR019C",326).
component("YKL194C",416).
component("YIL078W",354).
component("YPL160W",577).
component("YLR382C",458).
component("YPL040C",572).
component("YBL076C",124).
component("YNL073W",501).
component("YDR037W",203).
component("YOR335C",562).
component("YGR094W",303).
...
component("YMR217W",488).
component("YPR145W",604).
component("YGR124W",306).
component("YOR303W",558).
component("YGL062W",287).
component("YBR218C",149).
component("YPL231W",585).
component("YNR016C",524).
component("YKL182W",413).
component("YGR037C",300).
component("YJL087C",368).
component("YOL010W",531).
component("YPR138C",603).
component("YPL265W",587).
component("YOR348C",565).
component("YOR130C",547).
component("YOL103W",540).
component("YOL020W",533).
component("YNL142W",508).
component("YMR272C",494).
component("YMR202W",486).
component("YMR056C",478).
component("YML123C",472).
component("YLR348C",455).
component("YLR138W",437).
component("YLR100C",435).
component("YLR092W",434).
component("YKR053C",424).
component("YKR039W",423).
component("YKL217W",420).
component("YJR077C",392).
component("YJL134W",375).
component("YJL129C",373).
component("YGR191W",312).
component("YGR125W",307).
component("YGR121C",304).
component("YGR065C",301).
component("YGL186C",292).
component("YFL055W",273).
component("YER060W-A",251).
component("YER060W",250).
component("YER056C",249).
component("YDR536W",238).
component("YDR508C",237).
component("YDR503C",236).
component("YDR497C",235).
component("YDR294C",223).
component("YDR046C",205).
component("YDL210W",196).
component("YCL025C",159).
component("YBR294W",156).
component("YBR291C",155).
component("YBR085W",139).
component("YBR069C",136).
component("YBR068C",135).
component("YBL042C",120).
component("YBL030C",118).
component("U7_",104).
component("U79_",103).
component("U75_",101).
component("U74_",100).
