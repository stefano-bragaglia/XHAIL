...
component("YNL280C",415).
component("YLR056W",348).
component("YMR083W",387).
component("YPL231W",466).
component("YJR159W",322).
component("YGL001C",225).
component("YML056C",374).
component("YLR432W",370).
component("YHR216W",280).
component("YAR075W",92).
component("YAR073W",91).
component("YDR127W",170).
component("YJR139C",319).
component("YNL009W",402).
component("YLR174W",357).
component("YHR183W",276).
component("YGR256W",257).
component("YCL018W",125).
component("YJR078W",315).
component("U58_",74).
component("YGR255C",256).
component("YMR015C",384).
component("YDR402C",184).
component("YGL055W",230).
component("YJL026W",290).
component("YGR180C",250).
component("YJR009C",308).
component("YJL052W",291).
component("YGR192C",252).
component("YOR374W",455).
component("YER073W",205).
component("U68_",78).
component("U55_",72).
component("YER069W",204).
component("YOR323C",449).
component("U2_",60).
component("YBR166C",117).
component("YNL280C",416).
component("YKL141W",328).
component("YOR375C",456).
component("YDL215C",157).
component("YAL062W",90).
component("U100_",20).
component("YBR035C",103).
component("YMR189W",391).
component("U56_",73).
component("YPL023C",458).
component("YGL125W",233).
component("YOR236W",447).
component("YBR084W",108).
component("YLR142W",352).
component("U65_",77).
component("U62_",76).
component("YHR068W",267).
component("YMR145C",390).
component("YML120C",378).
component("YKL192C",334).
component("YDL085W",140).
component("YBR046C",104).
component("YPL091W",461).
component("YNL052W",403).
component("YMR256C",397).
component("YLR395C",368).
component("YLR038C",346).
component("YIL111W",284).
component("YHR051W",266).
component("YGL191W",237).
component("YGL187C",236).
component("YDL067C",138).
component("Q0275",19).
component("Q0250",18).
component("YPL273W",472).
component("YLL062C",343).
component("YDR410C",186).
component("YER091C",208).
component("YJR073C",313).
component("YOL096C",433).
component("YMR120C",389).
component("YBL013W",93).
component("YJL130C",298).
component("YJL088W",294).
component("YPR074C",478).
component("YBR117C",112).
component("YCL009C",124).
component("YMR062C",386).
component("YNL071W",404).
component("YNR019W",422).
component("YCR048W",133).
component("U48_",68).
component("YFL017C",215).
component("YPL231W",467).
component("YDL052C",137).
component("U8_",85).
component("YPL231W",468).
component("YLR299W",361).
component("YCR005C",130).
component("YML126C",380).
component("YDL182W",154).
component("YDL131W",146).
component("YNL117W",407).
component("YIR031C",288).
component("YOR321W",448).
component("YJR143C",320).
component("YGR199W",254).
component("YDL095W",142).
component("YDL093W",141).
component("YAL023C",89).
component("YMR261C",398).
component("YML100W",377).
component("YBR126C",114).
component("YLR209C",358).
component("YDR354W",181).
component("YFR047C",222).
component("YJR133W",318).
component("U22_",57).
component("YDR399W",183).
component("YJL167W",305).
component("YPR069C",477).
component("YDR127W",171).
component("YHR068W",268).
component("YLR303W",362).
component("YML082W",376).
component("YJR130C",317).
component("YDR035W",161).
component("YBR249C",120).
component("YBR256C",121).
component("YHR137W",271).
component("YGL202W",238).
component("YLR027C",344).
component("YKL106W",326).
component("YOL140W",436).
component("YLR438W",372).
component("YKL104C",325).
component("YDR111C",168).
component("U51_",70).
component("YJR148W",321).
component("YHR208W",279).
component("YGL253W",242).
component("YFR053C",223).
component("YMR013C",383).
component("YCR036W",132).
component("YGR194C",253).
component("YCL040W",128).
component("YJR105W",316).
component("U81_",83).
component("YMR208W",393).
component("YPL203W",465).
component("YOR061W",437).
component("YKL166C",330).
component("YJL164C",304).
component("YIL035C",282).
component("YHR205W",278).
component("YHR102W",270).
component("YGL019W",226).
component("YHR025W",263).
component("YNR012W",420).
component("YPR121W",480).
component("YPL258C",470).
...
component("YER052C",200).
component("U19_",47).
component("U18_",43).
component("U17_",40).
component("U76_",81).
component("YMR220W",394).
component("YDR226W",178).
component("YKL067W",324).
component("YOL055C",431).
component("YDR454C",189).
component("YOL061W",432).
component("YKL181W",331).
component("YHL011C",259).
component("YER099C",210).
component("YBL068W",99).
component("YOR143C",441).
component("YLR328W",365).
component("YDL103C",144).
component("U94_",87).
component("YJR010W",309).
component("YBR029C",102).
component("YPR190C",485).
component("YPR187W",484).
component("YPR110C",479).
component("YPR010C",474).
component("YOR341W",452).
component("YOR340C",451).
component("YOR224C",446).
component("YOR210W",445).
component("YOR207C",444).
component("YOR151C",442).
component("YOR116C",439).
component("YOL005C",426).
component("YNR003C",419).
component("YNL248C",413).
component("YNL151C",411).
component("YNL113W",406).
component("YKL144C",329).
component("YJR063W",312).
component("YJL148W",301).
component("YJL140W",300).
component("YIL021W",281).
component("YHR143W-A",272).
component("YGL070C",232).
component("YFL036W",217).
...
component("YPR175W",483).
component("YPL167C",463).
component("YOR330C",450).
component("YOL115W",435).
component("YNL299W",417).
component("YNL262W",414).
component("YNL102W",405).
component("YJR043C",311).
component("YJR006W",307).
component("YJL090C",295).
component("YIL139C",285).
component("YEL055C",196).
...
component("YKL035W",323).
component("YHL012W",260).
component("YDR058C",164).
component("YOL011W",428).
component("YMR008C",382).
component("YMR006C",381).
component("U105_",22).
component("U101_",21).
component("YJL068C",292).
component("YPL072W",460).
component("YOR124C",440).
component("YNL186W",412).
component("YMR304W",400).
component("YMR223W",395).
component("YKR098C",342).
component("YJL197W",306).
component("YIL156W",286).
component("YFR010W",219).
component("YER151C",213).
component("YER144C",212).
component("YER098W",209).
component("YDR069C",165).
component("YDL122W",145).
component("YBR058C",105).
component("YBL067C",98).
component("YJR019C",310).
component("YDR074W",166).
component("YFR025C",221).
component("YPL179W",464).
component("YNR032W",423).
component("YML057W",375).
component("YML016C",373).
component("YLR433C",371).
component("YGR123C",246).
component("YER133W",211).
component("YER089C",206).
component("YDR436W",188).
component("YDR075W",167).
component("YDL188C",155).
component("YDL134C",147).
component("YDL047W",136).
component("YDL006W",135).
component("YBR125C",113).
component("YBL056W",97).
component("U9_",88).
component("YJL155C",303).
component("U34_",64).
component("U33_",63).
component("U32_",62).
component("U30_",61).
component("U29_",59).
component("U24_",58).
component("YHR044C",265).
component("YHR043C",264).
component("YOR360C",454).
component("YGL248W",241).
component("YGL027C",228).
component("YLR286C",360).
component("YER043C",199).
component("YLR160C",356).
component("YLR158C",355).
component("YLR157C",354).
component("YLR155C",353).
component("YDR321W",180).
component("YGL037C",229).
component("U43_",66).
component("U42_",65).
component("YLR308W",364).
component("YLR307W",363).
component("U53_",71).
component("YLR420W",369).
component("YIR032C",289).
component("YLR028C",345).
component("YHR144C",273).
component("YHR144C",274).
component("YNL141W",408).
component("YBR153W",115).
component("YDL238C",158).
component("YNL141W",409).
component("YBR084W",109).
component("YJL126W",297).
component("U44_",67).
component("YHR201C",277).
component("YBR111C",111).
component("YCL030C",127).
component("YER005W",198).
component("YLR231C",359).
component("U88_",84).
component("YDR538W",194).
component("YLR134W",351).
component("YLR044C",347).
component("YGR087C",244).
component("YDR380W",182).
component("YDL080C",139).
component("YMR250W",396).
component("YKL184W",333).
component("YEL021W",195).
component("YKL211C",336).
component("YKR097W",341).
component("YNR033W",424).
component("YKL211C",337).
component("YER090W",207).
component("YDR127W",173).
component("YPL281C",473).
component("YOR393W",457).
component("YMR323W",401).
component("YHR174W",275).
component("YGR254W",255).
component("YGL026C",227).
component("YGR155W",248).
component("YNL316C",418).
component("YCR053W",134).
component("YDR127W",174).
component("YGL148W",234).
component("YIL167W",287).
component("YCL064C",129).
component("YFR055W",224).
component("YJL121C",296).
component("YBR019C",101).
component("YDR007W",159).
component("YOR095C",438).
component("YBR196C",118).
component("U14_",31).
component("YMR105C",388).
component("YKL127W",327).
component("YEL058W",197).
component("YPR060C",476).
component("YHR072W",269).
component("YJL153C",302).
component("YGR264C",258).
component("YGR171C",249).
component("YHR011W",261).
component("YDR023W",160).
component("YGL245W",240).
component("YOR168W",443).
component("YPR047W",475).
component("YLR060W",349).
component("YFL022C",216).
component("YHR019C",262).
component("YKL194C",335).
component("YIL078W",283).
component("YPL160W",462).
component("YLR382C",367).
component("YPL040C",459).
component("YBL076C",100).
component("YGL234W",239).
component("YER183C",214).
component("U90_",86).
component("YNR057C",425).
component("YDL141W",149).
component("YDL141W",150).
component("YDL141W",151).
component("YDL141W",152).
component("YPR145W",482).
component("YGR124W",247).
...
component("YJL087C",293).
component("YOL010W",427).
component("YPR138C",481).
component("YPL265W",471).
component("YOR348C",453).
component("YOL103W",434).
component("YOL020W",429).
component("YNL142W",410).
component("YMR272C",399).
component("YMR202W",392).
component("YMR056C",385).
component("YML123C",379).
component("YLR348C",366).
component("YLR100C",350).
component("YKR053C",340).
component("YKR039W",339).
component("YKL217W",338).
component("YJR077C",314).
component("YJL134W",299).
component("YGR191W",251).
component("YGR121C",245).
...
component("YDR497C",190).
component("YDR294C",179).
component("YDR046C",163).
component("YDL210W",156).
component("YCL025C",126).
component("YBR291C",123).
component("YBR085W",110).
component("YBR069C",107).
component("YBR068C",106).
component("YBL042C",96).
component("YBL030C",94).
component("U7_",82).
component("U6_",80).
component("U69_",79).
component("U5_",75).
